...
AMenuSystemCharacter::AMenuSystemCharacter():
	CreateSeesionCompleteDelegate(FOnCreateSessionCompleteDelegate::CreateUObject(this,&ThisClass::OnCreateSessionComplete)),
...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	OnlineSessionInterface->AddOnCreateSessionCompleteDelegate_Handle(CreateSeesionCompleteDelegate);
	...
	else
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(
				...
				15.f,
				FColor::Red,
				FString(TEXT("Faild to crate session!"))
			);
		}
	}
}
		...
		if (MatchType == FString("FreeForAll"))
		{
			if (GEngine) {
				GEngine->AddOnScreenDebugMessage(
					...
					FString::Printf(TEXT("JoinMatchType: %s"),*MatchType)
				);
			}
