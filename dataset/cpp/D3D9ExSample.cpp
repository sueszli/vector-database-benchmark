 ...
 HRESULT SetupDynamicDependencyToDirectXFrameworkPackage()
{
     ...
     // use powershell "get-appxpackage *directx* to find the PackageFamilyName details
     ...
     //MessageBox(NULL, L"Before TryCreatePackageDependency", L"D3D9Ex sample", MB_OK);

     // Create the "Install time" reference - ideally this is part of the app's installer
     ...
     //MessageBox(NULL, L"After TryCreatePackageDependency", L"D3D9Ex sample", MB_OK);

     // Parameters for the runtime reference 
     const INT32 rank = MDD_PACKAGE_DEPENDENCY_RANK_DEFAULT;
     const auto addOptions = MddAddPackageDependencyOptions::None;

     wil::unique_process_heap_string packageFullName;

     //MessageBox(NULL, L"Before AddPackageDependency", L"D3D9Ex sample", MB_OK);
     ...
     //MessageBox(NULL, L"After AddPackageDependency", L"D3D9Ex sample", MB_OK);
...
//--------------------------------------------------------------------------------------
 void CleanUpDynamicDependencyToDirectXFrameworkPackage()
 {
     ...
     // Remove the install time reference - this should be part of the app Installer
