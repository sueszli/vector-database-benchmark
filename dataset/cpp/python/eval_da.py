...
def eval_model(db: FeverDocDB, args) -> Model:
    ...
    model = archive.model
    #pdb.set_trace()
    #token_to_index = copy.deepcopy(model.vocab._token_to_index)
    #index_to_token = copy.deepcopy(model.vocab._index_to_token)
    #file = open('./vocab2.pkl', 'wb')	
    #pickle.dump (model.vocab,file) 
