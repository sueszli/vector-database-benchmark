...
if __name__ == '__main__':
    ...
    for index in range(len(URMs_train)):
        MultVAE_recommenders.append(
            MultVAERecommender(
                URM_train=URMs_train[index]
            )
        )

        MultVAE_recommenders[index].fit(
            epochs=23,
            learning_rate=0.0015961592417506301,
            l2_reg=0.0006490776439334211,
            dropout=0.5791277104923426,
            total_anneal_steps=146901,
            anneal_cap=0.3054246574668649,
            batch_size=256,
        )
