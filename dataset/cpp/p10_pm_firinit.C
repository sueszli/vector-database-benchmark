    ...
    const pm::PM_FLOW_MODE i_mode)
{
    ...
    FAPI_EXEC_HWP(l_rc, p10_pm_pba_firinit, i_target, i_mode);
    FAPI_TRY(l_rc);


    // Handle QME FIRs, Masks and actions
    FAPI_DBG("Calling QME firinit ...");
    FAPI_EXEC_HWP(l_rc, p10_pm_qme_firinit, i_target, i_mode);
    FAPI_TRY(l_rc);
