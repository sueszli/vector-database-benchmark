...
/**
 * $Id: a17172cfca62a117e48a2c323b8494a96eb599fd $
 ...
 */
RCSID("$Id: a17172cfca62a117e48a2c323b8494a96eb599fd $")
...
{
	if (fr_aka_sim_id_to_eap_type(id, len) == FR_EAP_METHOD_AKA_PRIME) return FR_EAP_METHOD_AKA_PRIME;
