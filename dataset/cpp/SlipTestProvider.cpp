...
SlipTestProvider::SlipTestProvider(Behaviour* manager) : BehaviourProvider(manager)
{
    ...
    m_slip_matrix[0][0] = 1.; m_slip_matrix[0][1] = 0.; m_slip_matrix[0][2] = 0.;
    m_slip_matrix[1][0] = 0.; m_slip_matrix[1][1] = 1.; m_slip_matrix[1][2] = 0.;
    m_slip_matrix[2][0] = 0.; m_slip_matrix[2][1] = 0.; m_slip_matrix[2][2] = 1.;
