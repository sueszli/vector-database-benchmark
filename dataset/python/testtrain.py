...
# 数据文件夹
#data_dir = "G:/Deeplearn/signal_and_system/data"
data_dir="G:/Deeplearn/OwnCollection/OwnCollection/vehicles/MiddleClose"
re_dir="G:/Deeplearn/OwnCollection/OwnCollection/non-vehicles/MiddleClose"
...
def read_data(data_dir,re_dir):
    ...
    for fname in os.listdir(data_dir):
        ...
        #data=cv2.xfeatures2d_SIFT(data)
        #data = np.array(data)
...
with tf.Session() as sess:
    ...
    if train:
        ...
        #fpaths, datas, labels = read_data(t_data_dir,t_re_dir)
        # label和名称的对照关系
        label_name_dict = {
            0: "负",
            1: "正"
