...
association	3.10.0	3.10.1	association_ruleset1	3.10 assoc play 1	Startround	default	0	Goround				01 1 2000	1 2000		
association	3.10.1	3.10.2	association_repeat	3.10 assoc repeat			0		associationrepeat			01 -1 2000	1 2000		
association	3.10.2	3.16	association_ruleset2	3.10 assoc play 2			0					01 -1 2000	1 2000		
...
movement	4.10.0	4.10.1	movement_play1	4.10 mov play 1	Startround	default	0	Goround				02 1 2000			
movement	4.10.1	4.10.2	movement_repeat	4.10 mov rule repeat			0		movementrepeat			02 -1 2000			
movement	4.10.2	4.12	movement_play2	4.10 mov play 2			0					02 -1 2000			
movement	4.12	4.13	movement_plateau1	4.12 mov plateau 1			0				plateau	02 2 0			
movement	4.13	4.14	movement_play3	4.13 mov play 3			0					02 -1 0			
movement	4.14	4.15	movement_plateau2	4.14 mov plateau 2			0				plateau	02 3 0			
movement	4.15	4.16	movement_play4	4.15 mov play 4			0					02 -1 0			
...
distance	5.10.0	5.10.1	distance_play1	5.10 distance play 1	Startround		0	Goround				03 1 2000			
distance	5.10.1	5.10.2	distance_repeat	5.10 distance repeat			0		distancerepeat			03 -1 2000			
distance	5.10.2	5.12	distance_play2	5.10 distance play 2			0					03 -1 2000			
distance	5.12	5.13	distance_plateau1	5.12 distance plateau 1			0				plateau	03 2 0			
distance	5.13	5.14	distance_play3	5.12 distance play 3			0					03 -1 0			
distance	5.14	5.15	distance_plateau2	5.14 distance plateau 2			0				plateau	03 3 0			
distance	5.15	5.16	distance_play4	5.14 distance play 4			0					03 -1 0			
...
prediction	6.43	6.44	prediction_profile1	6.43 prediction_profile1			1								
prediction	6.44	7.00	prediction_profile2	6.44 prediction_profile2			1								
...
custom	7.70	8.10	custom_reset	7.70 custom_reset			1				reset				
epilog	8.10	8.20	epilog_black	8.10 epilog_talk			1		epilog						
epilog	8.20	8.20	epilog_black	8.20 epilog_black			1								
joker	23	23	joker	joker			1				joker	01 -1 1000			
reset	123	123	reset	reset			1				reset				
