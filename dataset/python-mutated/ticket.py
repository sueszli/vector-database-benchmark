...
from tickets.models import Ticket, ApplyAssetTicket, ApplyLoginTicket, ApplyLoginAssetTicket, ApplyCommandTicket
from tickets.permissions.ticket import IsAssignee, IsApplicant
from ..const import TicketAction
__all__ = ['TicketViewSet', 'ApplyAssetTicketViewSet', 'ApplyLoginTicketViewSet', 'ApplyLoginAssetTicketViewSet', 'ApplyCommandTicketViewSet']

class TicketViewSet(CommonApiMixin, viewsets.ModelViewSet):
    serializer_class = serializers.TicketSerializer
    serializer_classes = {'approve': serializers.TicketApproveSerializer}
    model = Ticket
    perm_model = Ticket
    filterset_class = filters.TicketFilter
    search_fields = ['title', 'type', 'status']
    ordering = ('-date_created',)
    rbac_perms = {'open': 'tickets.view_ticket', 'bulk': 'tickets.change_ticket'}
...
class ApplyAssetTicketViewSet(TicketViewSet):
    ...
    serializer_classes = {'open': serializers.ApplyAssetSerializer, 'approve': serializers.ApproveAssetSerializer}
