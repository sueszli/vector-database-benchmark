...
def main():
    ...
    response = client.workspaces.begin_create_or_update(resource_group_name='rg', workspace_name='myWorkspace', parameters={'location': 'westus', 'properties': {'managedResourceGroupId': '/subscriptions/subid/resourceGroups/myManagedRG', 'parameters': {'customPrivateSubnetName': {'value': 'myPrivateSubnet'}, 'customPublicSubnetName': {'value': 'myPublicSubnet'}, 'customVirtualNetworkId': {'value': '/subscriptions/subid/resourceGroups/rg/providers/Microsoft.Network/virtualNetworks/myNetwork'}}}}).result()
    print(response)
