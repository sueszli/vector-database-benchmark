...
def reports_stream(marketplace_id):
    ...
    return stream
INPUT_DATES = {'YYYY-MM-DD': ['2017-01-13', '2017-12-12', '2017-12-17', '2011-12-13'], 'D.M.YY': ['13.1.17', '12.12.17', '17.12.17', '13.12.11'], 'YY/M/D': ['17/1/13', '17/12/12', '17/12/17', '11/12/13'], 'D/M/YY': ['13/1/17', '12/12/17', '17/12/17', '13/12/11'], 'M/D/YY': ['1/13/17', '12/12/17', '12/17/17', '12/13/11']}
