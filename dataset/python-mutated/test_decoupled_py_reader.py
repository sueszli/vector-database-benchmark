...
def simple_fc_net(places, use_legacy_py_reader, use_double_buffer):
    ...
    with base.unique_name.guard():
        with base.program_guard(main_prog, startup_prog):
            ...
            py_reader = base.io.PyReader(feed_list=[image, label], capacity=4, iterable=not use_legacy_py_reader, use_double_buffer=use_double_buffer)
            hidden = image
...
class TestBase(unittest.TestCase):
    ...
    def run_main(self, use_legacy_py_reader, places, use_double_buffer):
        ...
        with base.scope_guard(scope):
            ...
            py_reader.decorate_sample_list_generator(reader, places=ps if py_reader.iterable else None)
