...
from qtpy.QtWidgets import QAbstractItemView, QCheckBox, QComboBox, QDialog, QDialogButtonBox, QGroupBox, QGridLayout, QHBoxLayout, QLabel, QLineEdit, QSpinBox, QTableView, QVBoxLayout
...
class LSPServerEditor(QDialog, SpyderFontsMixin):
    ...
    DEFAULT_STDIO = False
    HOST_REGEX = re.compile('^\\w+([.]\\w+)*$')
    NON_EMPTY_REGEX = re.compile('^\\S+$')
