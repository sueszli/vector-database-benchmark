...
from samcli.lib.utils.resources import AWS_APIGATEWAY_RESTAPI, AWS_APIGATEWAY_V2_API, AWS_CLOUDFORMATION_STACK, AWS_LAMBDA_FUNCTION, AWS_LAMBDA_LAYERVERSION, AWS_SERVERLESS_API, AWS_SERVERLESS_APPLICATION, AWS_SERVERLESS_FUNCTION, AWS_SERVERLESS_HTTPAPI, AWS_SERVERLESS_LAYERVERSION, AWS_SERVERLESS_STATEMACHINE, AWS_STEPFUNCTIONS_STATEMACHINE, CODE_SYNCABLE_RESOURCES, SYNCABLE_STACK_RESOURCES
from samcli.yamlhelper import yaml_parse
if TYPE_CHECKING:
    from samcli.commands.sync.sync_context import SyncContext
LOG = logging.getLogger(__name__)
GENERAL_REMOVAL_MAP = {AWS_SERVERLESS_FUNCTION: ['CodeUri', 'ImageUri'], AWS_SERVERLESS_LAYERVERSION: ['ContentUri'], AWS_LAMBDA_LAYERVERSION: ['Content'], AWS_SERVERLESS_API: ['DefinitionUri'], AWS_APIGATEWAY_RESTAPI: ['BodyS3Location'], AWS_SERVERLESS_HTTPAPI: ['DefinitionUri'], AWS_APIGATEWAY_V2_API: ['BodyS3Location'], AWS_SERVERLESS_STATEMACHINE: ['DefinitionUri'], AWS_STEPFUNCTIONS_STATEMACHINE: ['DefinitionS3Location'], AWS_SERVERLESS_APPLICATION: ['Location'], AWS_CLOUDFORMATION_STACK: ['TemplateURL']}
LAMBDA_FUNCTION_REMOVAL_MAP = {AWS_LAMBDA_FUNCTION: {'Code': ['ImageUri', 'S3Bucket', 'S3Key', 'S3ObjectVersion']}}
