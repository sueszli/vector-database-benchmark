...
class NFBIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.nfb.ca/film/trafficopter/', 'info_dict': {'id': 'trafficopter', 'ext': 'mp4', 'title': 'Trafficopter', 'description': 'md5:060228455eb85cf88785c41656776bc0', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'Barrie Howells', 'release_year': 1972}}]
