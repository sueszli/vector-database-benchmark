import pytest
from telegram import ForceReply, InlineKeyboardButton, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove
...
class TestInlineKeyboardMarkupBase:
    inline_keyboard = [[InlineKeyboardButton(text='button1', callback_data='data1'), InlineKeyboardButton(text='button2', callback_data='data2')]]
...
class TestInlineKeyboardMarkupWithoutRequest(TestInlineKeyboardMarkupBase):
    ...
    async def test_expected_values_empty_switch(self, inline_keyboard_markup, bot, monkeypatch):
        ...
        async def make_assertion(url, data, reply_to_message_id=None, disable_notification=None, reply_markup=None, timeout=None, **kwargs):
...
class TestInlineKeyborardMarkupWithRequest(TestInlineKeyboardMarkupBase):
    ...
    async def test_send_message_with_inline_keyboard_markup(self, bot, chat_id, inline_keyboard_markup):
        message = await bot.send_message(chat_id, 'Testing InlineKeyboardMarkup', reply_markup=inline_keyboard_markup)
