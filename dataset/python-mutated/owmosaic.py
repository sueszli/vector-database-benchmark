...
from AnyQt.QtWidgets import QGraphicsScene, QGraphicsLineItem, QGraphicsItemGroup
...
from Orange.widgets.settings import Setting, DomainContextHandler, ContextSetting, SettingProvider
...
class OWMosaicDisplay(OWWidget):
    ...
    ATTR_NAME_OFFSET = 20
    ATTR_VAL_OFFSET = 3
    BLUE_COLORS = [QColor(255, 255, 255), QColor(210, 210, 255), QColor(110, 110, 255), QColor(0, 0, 255)]
    RED_COLORS = [QColor(255, 255, 255), QColor(255, 200, 200), QColor(255, 100, 100), QColor(255, 0, 0)]
    graph_name = 'canvas'
    ...
    class Warning(OWWidget.Warning):
        ...
        no_cont_selection_sql = Msg('Selection of numeric features on SQL is not supported')
