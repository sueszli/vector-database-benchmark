...
@testing.parameterize(*testing.product_dict([{'dtype': numpy.float16, 'forward_options': {'rtol': 0.005, 'atol': 0.005}, 'backward_options': {'eps': 0.1, 'rtol': 0.1, 'atol': 0.1}, 'double_backward_options': {'eps': 0.1, 'rtol': 0.1, 'atol': 0.1}}, {'dtype': numpy.float32, 'forward_options': {}, 'backward_options': {'eps': 0.001, 'rtol': 0.01, 'atol': 0.01}, 'double_backward_options': {'eps': 0.001, 'rtol': 0.001, 'atol': 0.001}}, {'dtype': numpy.float64, 'forward_options': {}, 'backward_options': {'eps': 0.001, 'rtol': 0.01, 'atol': 0.01}, 'double_backward_options': {'eps': 0.001, 'rtol': 0.001, 'atol': 0.001}}], testing.product({'shape': [(), (3,)], 'reduce': ['no']}) + testing.product({'shape': [(4, 10), (2, 5, 3, 3)], 'reduce': ['no', 'sum_along_second_axis']})))
