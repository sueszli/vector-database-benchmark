...
DESCRIBE_JOB_STEP_RUNNING_RETURN = {'ResponseMetadata': {'HTTPStatusCode': 200, 'RequestId': '8dee8db2-3719-11e6-9e20-35b2f861a2a6'}, 'Step': {'ActionOnFailure': 'CONTINUE', 'Config': {'Args': ['/usr/lib/spark/bin/run-example', 'SparkPi', '10'], 'Jar': 'command-runner.jar', 'Properties': {}}, 'Id': 's-VK57YR1Z9Z5N', 'Name': 'calculate_pi', 'Status': {'State': 'RUNNING', 'StateChangeReason': {}, 'Timeline': {'CreationDateTime': datetime(2016, 6, 20, 19, 0, 18, tzinfo=tzlocal()), 'StartDateTime': datetime(2016, 6, 20, 19, 2, 34, tzinfo=tzlocal())}}}}
DESCRIBE_JOB_STEP_CANCELLED_RETURN = {'ResponseMetadata': {'HTTPStatusCode': 200, 'RequestId': '8dee8db2-3719-11e6-9e20-35b2f861a2a6'}, 'Step': {'ActionOnFailure': 'CONTINUE', 'Config': {'Args': ['/usr/lib/spark/bin/run-example', 'SparkPi', '10'], 'Jar': 'command-runner.jar', 'Properties': {}}, 'Id': 's-VK57YR1Z9Z5N', 'Name': 'calculate_pi', 'Status': {'State': 'CANCELLED', 'StateChangeReason': {}, 'Timeline': {'CreationDateTime': datetime(2016, 6, 20, 19, 0, 18, tzinfo=tzlocal()), 'StartDateTime': datetime(2016, 6, 20, 19, 2, 34, tzinfo=tzlocal())}}}}
DESCRIBE_JOB_STEP_FAILED_RETURN = {'ResponseMetadata': {'HTTPStatusCode': 200, 'RequestId': '8dee8db2-3719-11e6-9e20-35b2f861a2a6'}, 'Step': {'ActionOnFailure': 'CONTINUE', 'Config': {'Args': ['/usr/lib/spark/bin/run-example', 'SparkPi', '10'], 'Jar': 'command-runner.jar', 'Properties': {}}, 'Id': 's-VK57YR1Z9Z5N', 'Name': 'calculate_pi', 'Status': {'State': 'FAILED', 'StateChangeReason': {}, 'FailureDetails': {'LogFile': 's3://fake-log-files/emr-logs/j-8989898989/steps/s-VK57YR1Z9Z5N', 'Reason': 'Unknown Error.'}, 'Timeline': {'CreationDateTime': datetime(2016, 6, 20, 19, 0, 18, tzinfo=tzlocal()), 'StartDateTime': datetime(2016, 6, 20, 19, 2, 34, tzinfo=tzlocal())}}}}
DESCRIBE_JOB_STEP_INTERRUPTED_RETURN = {'ResponseMetadata': {'HTTPStatusCode': 200, 'RequestId': '8dee8db2-3719-11e6-9e20-35b2f861a2a6'}, 'Step': {'ActionOnFailure': 'CONTINUE', 'Config': {'Args': ['/usr/lib/spark/bin/run-example', 'SparkPi', '10'], 'Jar': 'command-runner.jar', 'Properties': {}}, 'Id': 's-VK57YR1Z9Z5N', 'Name': 'calculate_pi', 'Status': {'State': 'INTERRUPTED', 'StateChangeReason': {}, 'Timeline': {'CreationDateTime': datetime(2016, 6, 20, 19, 0, 18, tzinfo=tzlocal()), 'StartDateTime': datetime(2016, 6, 20, 19, 2, 34, tzinfo=tzlocal())}}}}
