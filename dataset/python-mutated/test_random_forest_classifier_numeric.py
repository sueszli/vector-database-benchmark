...
@unittest.skipIf(not _HAS_SKLEARN, 'Missing sklearn. Skipping tests.')
class RandomForestBinaryClassifierBostonHousingScikitNumericTest(RandomForestClassificationBostonHousingScikitNumericTest):
...
@unittest.skipIf(not _HAS_SKLEARN, 'Missing sklearn. Skipping tests.')
class RandomForestMultiClassClassificationBostonHousingScikitNumericTest(RandomForestClassificationBostonHousingScikitNumericTest):
