...
class TestVersionRegistry:
    ...
    async def test_get_all_published_base_images(self, mocker, mock_dagger_client, fake_docker_credentials):
        ...
        published_images = await version_registry.VersionRegistry.get_all_published_base_images(mock_dagger_client, fake_docker_credentials, mocker.Mock())
        assert published_images == sample_published_images

    @pytest.mark.anyio
    async def test_load_with_mocks(self, mocker, mock_dagger_client, fake_docker_credentials, fake_changelog_entries, fake_published_images):
