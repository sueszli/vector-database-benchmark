...
from diffusers import AutoencoderKL, DDPMScheduler, DiffusionPipeline, DPMSolverMultistepScheduler, UNet2DConditionModel, utils
...
from modelscope.models.multi_modal.efficient_diffusion_tuning.sd_lora import LoRATuner
...
@MODELS.register_module(Tasks.efficient_diffusion_tuning, module_name=Models.efficient_diffusion_tuning)
