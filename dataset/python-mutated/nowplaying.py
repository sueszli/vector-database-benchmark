...
StatePlaybackStatusMapping = {State.stopped: aionp.PlaybackStatus.Stopped, State.paused: aionp.PlaybackStatus.Paused, State.playing: aionp.PlaybackStatus.Playing}
