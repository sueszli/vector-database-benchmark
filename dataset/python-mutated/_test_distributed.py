...
class DistributedMockup:
    ...
    default_train_config = {'task': 'train', 'pre_partition': True, 'machine_list_file': TESTS_DIR / 'mlist.txt', 'tree_learner': 'data', 'force_row_wise': True, 'verbose': 0, 'num_boost_round': 20, 'num_leaves': 15, 'num_threads': 2}
    default_predict_config = {'task': 'predict', 'data': TESTS_DIR / 'train.txt', 'input_model': TESTS_DIR / 'model0.txt', 'output_result': TESTS_DIR / 'predictions.txt'}
