...
class Migration(migrations.Migration):
    dependencies = [('channel', '0002_channel_default_country'), ('shipping', '0029_shippingzone_channels')]
    operations = [migrations.RunPython(set_default_country_for_channels, reverse_code=migrations.RunPython.noop), migrations.AlterField(model_name='channel', name='default_country', field=django_countries.fields.CountryField(max_length=2))]