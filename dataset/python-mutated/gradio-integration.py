...
app = GradioServer.options(ray_actor_options={'num_cpus': 4}).bind(gradio_summarizer_builder)
serve.run(app)
response = requests.post('http://127.0.0.1:8000/api/predict/', json={'data': [example_input]})
