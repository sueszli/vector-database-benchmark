...
vd.option('disp_menu_fmt', '| VisiData {vd.version} | Ctrl+H for help menu', 'right-side menu format string', max_help=0)
...
vd.menus = []
vd.addMenu(Menu('File'), Menu('Edit'), Menu('View'), Menu('Column'), Menu('Row'), Menu('Data'), Menu('Plot'), Menu('System'), Menu('Help'))
