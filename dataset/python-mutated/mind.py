...
from recommenders.datasets.download_utils import maybe_download, download_path, unzip_file
URL_MIND_LARGE_TRAIN = 'https://mind201910small.blob.core.windows.net/release/MINDlarge_train.zip'
URL_MIND_LARGE_VALID = 'https://mind201910small.blob.core.windows.net/release/MINDlarge_dev.zip'
URL_MIND_SMALL_TRAIN = 'https://mind201910small.blob.core.windows.net/release/MINDsmall_train.zip'
URL_MIND_SMALL_VALID = 'https://mind201910small.blob.core.windows.net/release/MINDsmall_dev.zip'
URL_MIND_DEMO_TRAIN = 'https://recodatasets.z20.web.core.windows.net/newsrec/MINDdemo_train.zip'
URL_MIND_DEMO_VALID = 'https://recodatasets.z20.web.core.windows.net/newsrec/MINDdemo_dev.zip'
URL_MIND_DEMO_UTILS = 'https://recodatasets.z20.web.core.windows.net/newsrec/MINDdemo_utils.zip'
URL_MIND = {'large': (URL_MIND_LARGE_TRAIN, URL_MIND_LARGE_VALID), 'small': (URL_MIND_SMALL_TRAIN, URL_MIND_SMALL_VALID), 'demo': (URL_MIND_DEMO_TRAIN, URL_MIND_DEMO_VALID)}
