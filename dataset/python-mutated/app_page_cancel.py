...
app = Dash(__name__, use_pages=True, pages_folder='', long_callback_manager=long_callback_manager)
app.layout = html.Div([dcc.Link('page1', '/'), dcc.Link('page2', '/2'), html.Button('Cancel', id='shared_cancel'), page_container])
register_page('one', '/', layout=html.Div([html.Button('start', id='start1'), html.Button('cancel1', id='cancel1'), html.Div('idle', id='progress1'), html.Div('initial', id='output1'), html.Div('no-cancel-btn', id='no-cancel-btn'), html.Div('no-cancel', id='no-cancel-output')]))
register_page('two', '/2', layout=html.Div([html.Button('start2', id='start2'), html.Button('cancel2', id='cancel2'), html.Div('idle', id='progress2'), html.Div('initial', id='output2')]))
