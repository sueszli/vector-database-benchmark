...
class netappCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_active_directory': ('parent', 'active_directory', 'active_directory_id'), 'create_kms_config': ('parent', 'kms_config_id', 'kms_config'), 'create_replication': ('parent', 'replication', 'replication_id'), 'create_snapshot': ('parent', 'snapshot', 'snapshot_id'), 'create_storage_pool': ('parent', 'storage_pool_id', 'storage_pool'), 'create_volume': ('parent', 'volume_id', 'volume'), 'delete_active_directory': ('name',), 'delete_kms_config': ('name',), 'delete_replication': ('name',), 'delete_snapshot': ('name',), 'delete_storage_pool': ('name',), 'delete_volume': ('name', 'force'), 'encrypt_volumes': ('name',), 'get_active_directory': ('name',), 'get_kms_config': ('name',), 'get_replication': ('name',), 'get_snapshot': ('name',), 'get_storage_pool': ('name',), 'get_volume': ('name',), 'list_active_directories': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_kms_configs': ('parent', 'page_size', 'page_token', 'order_by', 'filter'), 'list_replications': ('parent', 'page_size', 'page_token', 'order_by', 'filter'), 'list_snapshots': ('parent', 'page_size', 'page_token', 'order_by', 'filter'), 'list_storage_pools': ('parent', 'page_size', 'page_token', 'order_by', 'filter'), 'list_volumes': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'resume_replication': ('name',), 'reverse_replication_direction': ('name',), 'revert_volume': ('name', 'snapshot_id'), 'stop_replication': ('name', 'force'), 'update_active_directory': ('update_mask', 'active_directory'), 'update_kms_config': ('update_mask', 'kms_config'), 'update_replication': ('update_mask', 'replication'), 'update_snapshot': ('update_mask', 'snapshot'), 'update_storage_pool': ('update_mask', 'storage_pool'), 'update_volume': ('update_mask', 'volume'), 'verify_kms_config': ('name',)}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=netappCallTransformer()):
    if False:
        return 10
