...
class Reservation(proto.Message):
    """A reservation is a mechanism used to guarantee slots to
    users.
    ...
    class Autoscale(proto.Message):
        ...
        """
        current_slots: int = proto.Field(proto.INT64, number=1)
        max_slots: int = proto.Field(proto.INT64, number=2)
    name: str = proto.Field(proto.STRING, number=1)
    slot_capacity: int = proto.Field(proto.INT64, number=2)
    ignore_idle_slots: bool = proto.Field(proto.BOOL, number=4)
    autoscale: Autoscale = proto.Field(proto.MESSAGE, number=7, message=Autoscale)
    concurrency: int = proto.Field(proto.INT64, number=16)
    creation_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    multi_region_auxiliary: bool = proto.Field(proto.BOOL, number=14)
    edition: 'Edition' = proto.Field(proto.ENUM, number=17, enum='Edition')

class CapacityCommitment(proto.Message):
    """Capacity commitment is a way to purchase compute capacity for
    ...
    class State(proto.Enum):
        """Capacity commitment can either become ACTIVE right away or
        ...
        FAILED = 3
    name: str = proto.Field(proto.STRING, number=1)
    slot_count: int = proto.Field(proto.INT64, number=2)
    plan: CommitmentPlan = proto.Field(proto.ENUM, number=3, enum=CommitmentPlan)
    state: State = proto.Field(proto.ENUM, number=4, enum=State)
    commitment_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    commitment_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    failure_status: status_pb2.Status = proto.Field(proto.MESSAGE, number=7, message=status_pb2.Status)
    renewal_plan: CommitmentPlan = proto.Field(proto.ENUM, number=8, enum=CommitmentPlan)
    multi_region_auxiliary: bool = proto.Field(proto.BOOL, number=10)
    edition: 'Edition' = proto.Field(proto.ENUM, number=12, enum='Edition')
...
class CreateReservationRequest(proto.Message):
    ...
    reservation_id: str = proto.Field(proto.STRING, number=2)
    reservation: 'Reservation' = proto.Field(proto.MESSAGE, number=3, message='Reservation')
...
class ListReservationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    reservations: MutableSequence['Reservation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Reservation')
...
class UpdateReservationRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            be updated.
    """
    reservation: 'Reservation' = proto.Field(proto.MESSAGE, number=1, message='Reservation')
...
class CreateCapacityCommitmentRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    capacity_commitment: 'CapacityCommitment' = proto.Field(proto.MESSAGE, number=2, message='CapacityCommitment')
    enforce_single_admin_project_per_org: bool = proto.Field(proto.BOOL, number=4)
    capacity_commitment_id: str = proto.Field(proto.STRING, number=5)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    capacity_commitments: MutableSequence['CapacityCommitment'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CapacityCommitment')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateCapacityCommitmentRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            be updated.
    """
    capacity_commitment: 'CapacityCommitment' = proto.Field(proto.MESSAGE, number=1, message='CapacityCommitment')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class SplitCapacityCommitmentResponse(proto.Message):
    ...
    Attributes:
        ...
        second (google.cloud.bigquery_reservation_v1.types.CapacityCommitment):
            ...
            split.
    """
    first: 'CapacityCommitment' = proto.Field(proto.MESSAGE, number=1, message='CapacityCommitment')
    second: 'CapacityCommitment' = proto.Field(proto.MESSAGE, number=2, message='CapacityCommitment')
...
class MergeCapacityCommitmentsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    capacity_commitment_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class Assignment(proto.Message):
    ...
    class State(proto.Enum):
        ...
        ACTIVE = 2
    name: str = proto.Field(proto.STRING, number=1)
    assignee: str = proto.Field(proto.STRING, number=4)
    job_type: JobType = proto.Field(proto.ENUM, number=3, enum=JobType)
...
class CreateAssignmentRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    assignment: 'Assignment' = proto.Field(proto.MESSAGE, number=2, message='Assignment')
    assignment_id: str = proto.Field(proto.STRING, number=4)
...
class ListAssignmentsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    assignments: MutableSequence['Assignment'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Assignment')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class MoveAssignmentRequest(proto.Message):
    ...
    **Note**: "bigquery.reservationAssignments.create" and
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    destination_id: str = proto.Field(proto.STRING, number=3)
    assignment_id: str = proto.Field(proto.STRING, number=5)
...
class UpdateAssignmentRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            be updated.
    """
    assignment: 'Assignment' = proto.Field(proto.MESSAGE, number=1, message='Assignment')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class TableReference(proto.Message):
    ...
    dataset_id: str = proto.Field(proto.STRING, number=2)
    table_id: str = proto.Field(proto.STRING, number=3)
...
class BiReservation(proto.Message):
    ...
    size: int = proto.Field(proto.INT64, number=4)
    preferred_tables: MutableSequence['TableReference'] = proto.RepeatedField(proto.MESSAGE, number=5, message='TableReference')
...
class UpdateBiReservationRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            request.
    """
    bi_reservation: 'BiReservation' = proto.Field(proto.MESSAGE, number=1, message='BiReservation')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
