...
class KinjaEmbedIE(InfoExtractor):
    ...
    _COMMON_REGEX = '/\n        (?:\n            ajax/inset|\n            embed/video\n        )/iframe\\?.*?\\bid='
    _VALID_URL = '(?x)https?://%s%s\n        (?P<type>\n            fb|\n            imgur|\n            instagram|\n            jwp(?:layer)?-video|\n            kinjavideo|\n            mcp|\n            megaphone|\n            ooyala|\n            soundcloud(?:-playlist)?|\n            tumblr-post|\n            twitch-stream|\n            twitter|\n            ustream-channel|\n            vimeo|\n            vine|\n            youtube-(?:list|video)\n        )-(?P<id>[^&]+)' % (_DOMAIN_REGEX, _COMMON_REGEX)
    _EMBED_REGEX = [f"""(?x)<iframe[^>]+?src=(?P<q>["\\'])(?P<url>(?:(?:https?:)?//{_DOMAIN_REGEX})?{_COMMON_REGEX}(?:(?!\\1).)+)\\1"""]
    _TESTS = [{'url': 'https://kinja.com/ajax/inset/iframe?id=fb-10103303356633621', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=kinjavideo-100313', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=megaphone-PPY1300931075', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=ooyala-xzMXhleDpopuT0u1ijt_qZj3Va-34pEX%2FZTIxYmJjZDM2NWYzZDViZGRiOWJjYzc5', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=soundcloud-128574047', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=soundcloud-playlist-317413750', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=tumblr-post-160130699814-daydreams-at-midnight', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=twitch-stream-libratus_extra', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=twitter-1068875942473404422', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=ustream-channel-10414700', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=vimeo-120153502', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=vine-5BlvV5qqPrD', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=youtube-list-BCQ3KyrPjgA/PLE6509247C270A72E', 'only_matching': True}, {'url': 'https://kinja.com/ajax/inset/iframe?id=youtube-video-00QyL0AgPAE', 'only_matching': True}]
    _JWPLATFORM_PROVIDER = ('cdn.jwplayer.com/v2/media/', 'JWPlatform')
    _PROVIDER_MAP = {'fb': ('facebook.com/video.php?v=', 'Facebook'), 'imgur': ('imgur.com/', 'Imgur'), 'instagram': ('instagram.com/p/', 'Instagram'), 'jwplayer-video': _JWPLATFORM_PROVIDER, 'jwp-video': _JWPLATFORM_PROVIDER, 'megaphone': ('player.megaphone.fm/', 'Generic'), 'ooyala': ('player.ooyala.com/player.js?embedCode=', 'Ooyala'), 'soundcloud': ('api.soundcloud.com/tracks/', 'Soundcloud'), 'soundcloud-playlist': ('api.soundcloud.com/playlists/', 'SoundcloudPlaylist'), 'tumblr-post': ('%s.tumblr.com/post/%s', 'Tumblr'), 'twitch-stream': ('twitch.tv/', 'TwitchStream'), 'twitter': ('twitter.com/i/cards/tfw/v1/', 'TwitterCard'), 'ustream-channel': ('ustream.tv/embed/', 'Ustream'), 'vimeo': ('vimeo.com/', 'Vimeo'), 'vine': ('vine.co/v/', 'Vine'), 'youtube-list': ('youtube.com/embed/%s?list=%s', 'YoutubePlaylist'), 'youtube-video': ('youtube.com/embed/', 'Youtube')}
