...
class GrpcDeployment:
    ...
    async def Method2(self, user_message):
        ...
        user_response = serve_pb2.UserDefinedResponse(greeting=f'Method2 called model, {model}')
        return user_response
...
g2 = FruitMarket.options(name='grpc-deployment-model-composition').bind(orange_stand, apple_stand)