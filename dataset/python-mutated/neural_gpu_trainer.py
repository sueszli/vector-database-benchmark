...
tf.app.flags.DEFINE_integer('beam_size', 1, 'Beam size during decoding. If 0, no decoder, the non-extended Neural GPU.')
tf.app.flags.DEFINE_integer('max_target_vocab', 0, 'Maximal size of target vocabulary.')
...
tf.app.flags.DEFINE_bool('simple_tokenizer', False, 'If true, tokenize on spaces only, digits are 0.')
tf.app.flags.DEFINE_bool('normalize_digits', True, 'Whether to normalize digits with simple tokenizer.')
...
tf.app.flags.DEFINE_string('word_vector_file_en', '', 'Optional file with word vectors to start training.')
tf.app.flags.DEFINE_string('word_vector_file_fr', '', 'Optional file with word vectors to start training.')
