...
from ...operations._azure_bare_metal_storage_instances_operations import build_create_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
T = TypeVar('T')
...
class AzureBareMetalStorageInstancesOperations:
    ...
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances'}

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.AzureBareMetalStorageInstance']:
        if False:
            print('Hello World!')
        ...
        async def get_next(next_link=None):
            ...
            return pipeline_response
        return AsyncItemPaged(get_next, extract_data)
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances'}

    @distributed_trace_async
    async def get(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
        ...
        request = build_get_request(resource_group_name=resource_group_name, azure_bare_metal_storage_instance_name=azure_bare_metal_storage_instance_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances/{azureBareMetalStorageInstanceName}'}

    @overload
    async def create(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, request_body_parameters: _models.AzureBareMetalStorageInstance, *, content_type: str='application/json', **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
    ...
    @overload
    async def create(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, request_body_parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
        """Create an azure bare metal storage resource.
    ...
    @distributed_trace_async
    async def create(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, request_body_parameters: Union[_models.AzureBareMetalStorageInstance, IO], **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
        """Create an azure bare metal storage resource.
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances/{azureBareMetalStorageInstanceName}'}

    @overload
    async def update(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, tags_parameter: _models.Tags, *, content_type: str='application/json', **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
    ...
    @overload
    async def update(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, tags_parameter: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
        """Patches the Tags field of a Azure Bare Metal Storage instance.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, tags_parameter: Union[_models.Tags, IO], **kwargs: Any) -> _models.AzureBareMetalStorageInstance:
        """Patches the Tags field of a Azure Bare Metal Storage instance.
        ...
        request = build_update_request(resource_group_name=resource_group_name, azure_bare_metal_storage_instance_name=azure_bare_metal_storage_instance_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances/{azureBareMetalStorageInstanceName}'}

    @distributed_trace_async
    async def delete(self, resource_group_name: str, azure_bare_metal_storage_instance_name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, azure_bare_metal_storage_instance_name=azure_bare_metal_storage_instance_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalStorageInstances/{azureBareMetalStorageInstanceName}'}