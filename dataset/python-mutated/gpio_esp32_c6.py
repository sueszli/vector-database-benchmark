...
_ESP32C6_SPI_PSRAM_PINS = {24: 'SPICS0', 25: 'SPIQ', 26: 'SPIWP', 27: 'VDD_SPI', 28: 'SPIHD', 29: 'SPICLK', 30: 'SPID'}
...
def esp32_c6_validate_gpio_pin(value):
    ...
    if value in _ESP32C6_SPI_PSRAM_PINS:
        raise cv.Invalid(f'This pin cannot be used on ESP32-C6s and is already used by the SPI/PSRAM interface (function: {_ESP32C6_SPI_PSRAM_PINS[value]})')
    return value
