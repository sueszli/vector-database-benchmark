...
class TLS13(_GenericTLSSessionInheritance):
    ...
    name = 'TLS 1.3'
    fields_desc = [ByteEnumField('type', 23, _tls_type), _TLSVersionField('version', 771, _tls_version), _TLSLengthField('len', None), _TLSInnerPlaintextField('inner', TLSInnerPlaintext()), _TLSMACField('auth_tag', None)]
