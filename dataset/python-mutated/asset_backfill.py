...
from typing import TYPE_CHECKING, AbstractSet, Dict, Iterable, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Union, cast
import pendulum
from dagster import PartitionKeyRange, _check as check
from dagster._core.definitions.asset_daemon_context import build_run_requests, build_run_requests_with_backfill_policies
...
from dagster._core.errors import DagsterAssetBackfillDataLoadError, DagsterBackfillFailedError, DagsterDefinitionChangedDeserializationError, DagsterInvariantViolationError
from dagster._core.event_api import EventRecordsFilter
from dagster._core.events import DagsterEventType
from dagster._core.host_representation import ExternalExecutionPlan, ExternalJob
from dagster._core.instance import DagsterInstance, DynamicPartitionsStore
from dagster._core.storage.dagster_run import CANCELABLE_RUN_STATUSES, DagsterRunStatus, RunsFilter
from dagster._core.storage.tags import ASSET_PARTITION_RANGE_END_TAG, ASSET_PARTITION_RANGE_START_TAG, BACKFILL_ID_TAG, PARTITION_NAME_TAG
...
class PartitionedAssetBackfillStatus(NamedTuple('_PartitionedAssetBackfillStatus', [('asset_key', AssetKey), ('num_targeted_partitions', int), ('partitions_counts_by_status', Mapping[AssetBackfillStatus, int])])):
...
class UnpartitionedAssetBackfillStatus(NamedTuple('_UnpartitionedAssetBackfillStatus', [('asset_key', AssetKey), ('backfill_status', Optional[AssetBackfillStatus])])):
