...
class VineUserIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://vine.co/itsruthb', 'info_dict': {'id': 'itsruthb', 'title': 'Ruth B', 'description': '| Instagram/Twitter: itsruthb | still a lost boy from neverland'}, 'playlist_mincount': 611}, {'url': 'https://vine.co/u/942914934646415360', 'only_matching': True}]
