...
class ProviderOperationsMetadataOperations:
    ...
    async def get(self, resource_provider_namespace: str, expand: str='resourceTypes', **kwargs: Any) -> _models.ProviderOperationsMetadata:
        ...
        request = build_get_request(resource_provider_namespace=resource_provider_namespace, expand=expand, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
