...
def sample_create_connection_profile():
    ...
    request = datastream_v1alpha1.CreateConnectionProfileRequest(parent='parent_value', connection_profile_id='connection_profile_id_value', connection_profile=connection_profile)
