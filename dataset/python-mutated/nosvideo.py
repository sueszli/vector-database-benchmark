...
from ..utils import ExtractorError, urlencode_postdata, xpath_text, xpath_with_ns
...
class NosVideoIE(InfoExtractor):
    ...
    _FILE_DELETED_REGEX = '<b>File Not Found</b>'
    _TEST = {'url': 'http://nosvideo.com/?v=mu8fle7g7rpq', 'md5': '6124ed47130d8be3eacae635b071e6b6', 'info_dict': {'id': 'mu8fle7g7rpq', 'ext': 'mp4', 'title': 'big_buck_bunny_480p_surround-fix.avi.mp4', 'thumbnail': 're:^https?://.*\\.jpg$'}}
