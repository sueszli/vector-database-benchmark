...
import proto
__protobuf__ = proto.module(package='google.cloud.networkconnectivity.v1', manifest={'PolicyBasedRoute', 'ListPolicyBasedRoutesRequest', 'ListPolicyBasedRoutesResponse', 'GetPolicyBasedRouteRequest', 'CreatePolicyBasedRouteRequest', 'DeletePolicyBasedRouteRequest'})

class PolicyBasedRoute(proto.Message):
    """Policy Based Routes (PBR) are more powerful routes that
    ...
    class InterconnectAttachment(proto.Message):
        ...
        """
        region: str = proto.Field(proto.STRING, number=1)
    ...
    class Filter(proto.Message):
        ...
        class ProtocolVersion(proto.Enum):
            ...
            PROTOCOL_VERSION_UNSPECIFIED = 0
            IPV4 = 1
        ip_protocol: str = proto.Field(proto.STRING, number=1)
        src_range: str = proto.Field(proto.STRING, number=2)
        dest_range: str = proto.Field(proto.STRING, number=3)
        protocol_version: 'PolicyBasedRoute.Filter.ProtocolVersion' = proto.Field(proto.ENUM, number=6, enum='PolicyBasedRoute.Filter.ProtocolVersion')
    ...
    class Warnings(proto.Message):
        ...
        class Code(proto.Enum):
            """Warning code for Policy Based Routing. Expect to add values
            in the future.
            ...
            RESOURCE_NOT_ACTIVE = 1
            RESOURCE_BEING_MODIFIED = 2
        code: 'PolicyBasedRoute.Warnings.Code' = proto.Field(proto.ENUM, number=1, enum='PolicyBasedRoute.Warnings.Code')
        data: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
        warning_message: str = proto.Field(proto.STRING, number=3)
    virtual_machine: VirtualMachine = proto.Field(proto.MESSAGE, number=18, oneof='target', message=VirtualMachine)
    interconnect_attachment: InterconnectAttachment = proto.Field(proto.MESSAGE, number=9, oneof='target', message=InterconnectAttachment)
    next_hop_ilb_ip: str = proto.Field(proto.STRING, number=12, oneof='next_hop')
    next_hop_other_routes: OtherRoutes = proto.Field(proto.ENUM, number=21, oneof='next_hop', enum=OtherRoutes)
    ...
    network: str = proto.Field(proto.STRING, number=6)
    filter: Filter = proto.Field(proto.MESSAGE, number=10, message=Filter)
    priority: int = proto.Field(proto.INT32, number=11)
    warnings: MutableSequence[Warnings] = proto.RepeatedField(proto.MESSAGE, number=14, message=Warnings)
    self_link: str = proto.Field(proto.STRING, number=15)
    kind: str = proto.Field(proto.STRING, number=16)
...
class ListPolicyBasedRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    policy_based_routes: MutableSequence['PolicyBasedRoute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PolicyBasedRoute')
...
class CreatePolicyBasedRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    policy_based_route_id: str = proto.Field(proto.STRING, number=2)
    policy_based_route: 'PolicyBasedRoute' = proto.Field(proto.MESSAGE, number=3, message='PolicyBasedRoute')
