...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', help='Dataset to be trained and evaluated.', type=str, choices=['imdb'], default='imdb')
    parser.add_argument('-e', '--embedding_dim', help='The dimension of the Embedding layer.', type=int, default=512)
    parser.add_argument('-v', '--vocabulary_size', help='The number of the words to be considered in the dataset corpus.', type=int, default=6000)
    parser.add_argument('-s', '--sentence_length', help='The number of words in a data point.Entries of smaller length are padded.', type=int, default=600)
    parser.add_argument('-c', '--hidden_dim', help='The number of the CNN layer filters.', type=int, default=512)
    parser.add_argument('-b', '--batch_size', help='The size of each batch for training.', type=int, default=500)
    parser.add_argument('-p', '--epochs', help='The number of epochs for training.', type=int, default=55)
    args = parser.parse_args()
    run_model(args.dataset, args.embedding_dim, args.vocabulary_size, args.sentence_length, args.hidden_dim, args.batch_size, args.epochs)