...
from returns.primitives.laws import Law, Law1, Lawful, LawSpecDef, law_definition
...
class SwappableN(bimappable.BiMappableN[_FirstType, _SecondType, _ThirdType], Lawful['SwappableN[_FirstType, _SecondType, _ThirdType]']):
