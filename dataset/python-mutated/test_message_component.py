...
from sentry.integrations.discord.message_builder.base.component import DiscordComponentCustomIds as CustomIds
from sentry.integrations.discord.requests.base import DiscordMessageComponentTypes, DiscordRequestTypes
from sentry.integrations.discord.webhooks.message_component import ARCHIVE_UNTIL_ESCALATES, ASSIGNEE_UPDATED, MARKED_ONGOING, NO_IDENTITY, NOT_IN_ORG, RESOLVE_DIALOG_OPTIONS, RESOLVED, RESOLVED_IN_CURRENT_RELEASE, RESOLVED_IN_NEXT_RELEASE, UNRESOLVED
