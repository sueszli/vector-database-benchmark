...
if __name__ == '__main__':
    ...
    if args.dataset == 'activitynet':
        ...
        status_list = Parallel(n_jobs=args.n_jobs, backend='threading')((delayed(video_process)(video_file_path, args.dst_path, ext, args.fps, args.size) for video_file_path in video_file_paths))
    else:
        ...
        status_list = Parallel(n_jobs=args.n_jobs, backend='threading')((delayed(class_process)(class_dir_path, args.dst_path, ext, args.fps, args.size) for class_dir_path in class_dir_paths))