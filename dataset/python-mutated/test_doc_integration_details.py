...
class PutDocIntegrationDetailsTest(DocIntegrationDetailsTest):
    method = 'PUT'
    payload: dict[str, Any] = {'name': 'Enemy', 'author': 'Imagine Dragons', 'description': 'An opening theme song 👀', 'url': 'https://github.com/getsentry/sentry/', 'popularity': 5, 'resources': [{'title': 'Docs', 'url': 'https://github.com/getsentry/sentry/'}], 'features': [4, 5, 6], 'is_draft': False}
