...
from posthog.schema import ActionsNode, AggregationAxisFormat, BaseMathType, BreakdownAttributionType, BreakdownFilter, BreakdownType, ChartDisplayType, CohortPropertyFilter, CountPerActorMathType, ElementPropertyFilter, EntityType, EventPropertyFilter, EventsNode, FunnelConversionWindowTimeUnit, FunnelExclusion, FunnelPathType, FunnelVizType, GroupPropertyFilter, HogQLPropertyFilter, Key, PathCleaningFilter, PathType, PersonPropertyFilter, PropertyMathType, PropertyOperator, RetentionPeriod, RetentionType, SessionPropertyFilter, StepOrderValue, TrendsFilter, FunnelsFilter, RetentionFilter, PathsFilter, StickinessFilter
from posthog.test.base import BaseTest
insight_0 = {'events': [{'id': 'signed_up', 'type': 'events', 'order': 0}], 'actions': [], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'week', 'date_from': '-8w'}
insight_1 = {'events': [{'id': 'signed_up', 'type': 'events', 'order': 0}], 'actions': [], 'display': 'WorldMap', 'insight': 'TRENDS', 'breakdown': '$geoip_country_code', 'date_from': '-1m', 'breakdown_type': 'event'}
insight_2 = {'events': [{'id': 'signed_up', 'name': 'signed_up', 'type': 'events', 'order': 2, 'custom_name': 'Signed up'}, {'id': 'upgraded_plan', 'name': 'upgraded_plan', 'type': 'events', 'order': 4, 'custom_name': 'Upgraded plan'}], 'actions': [{'id': 1, 'name': 'Interacted with file', 'type': 'actions', 'order': 3}], 'display': 'FunnelViz', 'insight': 'FUNNELS', 'interval': 'day', 'date_from': '-1m', 'funnel_viz_type': 'steps', 'filter_test_accounts': True}
insight_3 = {'period': 'Week', 'display': 'ActionsTable', 'insight': 'RETENTION', 'properties': {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'key': 'email', 'type': 'person', 'value': 'is_set', 'operator': 'is_set'}]}]}, 'target_entity': {'id': 'signed_up', 'name': 'signed_up', 'type': 'events', 'order': 0}, 'retention_type': 'retention_first_time', 'total_intervals': 9, 'returning_entity': {'id': 1, 'name': 'Interacted with file', 'type': 'actions', 'order': 0}}
insight_4 = {'events': [], 'actions': [{'id': 1, 'math': 'total', 'name': 'Interacted with file', 'type': 'actions', 'order': 0}], 'compare': False, 'display': 'ActionsLineGraph', 'insight': 'LIFECYCLE', 'interval': 'day', 'shown_as': 'Lifecycle', 'date_from': '-8w', 'new_entity': [], 'properties': [], 'filter_test_accounts': True}
insight_5 = {'events': [{'id': 'uploaded_file', 'math': 'sum', 'name': 'uploaded_file', 'type': 'events', 'order': 0, 'custom_name': 'Uploaded bytes', 'math_property': 'file_size_b'}, {'id': 'deleted_file', 'math': 'sum', 'name': 'deleted_file', 'type': 'events', 'order': 1, 'custom_name': 'Deleted bytes', 'math_property': 'file_size_b'}], 'actions': [], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'week', 'date_from': '-8w', 'new_entity': [], 'properties': [], 'filter_test_accounts': True}
insight_6 = {'events': [{'id': 'paid_bill', 'math': 'sum', 'type': 'events', 'order': 0, 'math_property': 'amount_usd'}], 'actions': [], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'month', 'date_from': '-6m'}
insight_7 = {'events': [{'id': 'paid_bill', 'math': 'unique_group', 'name': 'paid_bill', 'type': 'events', 'order': 0, 'math_group_type_index': 0}], 'actions': [], 'compare': True, 'date_to': None, 'display': 'BoldNumber', 'insight': 'TRENDS', 'interval': 'day', 'date_from': '-30d', 'properties': [], 'filter_test_accounts': True}
insight_8 = {'events': [{'id': '$pageview', 'math': 'total', 'type': 'events', 'order': 0}], 'actions': [], 'display': 'ActionsTable', 'insight': 'TRENDS', 'interval': 'day', 'breakdown': '$current_url', 'date_from': '-6m', 'new_entity': [], 'properties': {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'key': '$current_url', 'type': 'event', 'value': '/files/', 'operator': 'not_icontains'}]}]}, 'breakdown_type': 'event'}
insight_9 = {'events': [{'id': '$pageview', 'name': '$pageview', 'type': 'events', 'order': 0, 'properties': [{'key': '$current_url', 'type': 'event', 'value': 'https://hedgebox.net/', 'operator': 'exact'}], 'custom_name': 'Viewed homepage'}, {'id': '$pageview', 'name': '$pageview', 'type': 'events', 'order': 1, 'properties': [{'key': '$current_url', 'type': 'event', 'value': 'https://hedgebox.net/signup/', 'operator': 'regex'}], 'custom_name': 'Viewed signup page'}, {'id': 'signed_up', 'name': 'signed_up', 'type': 'events', 'order': 2, 'custom_name': 'Signed up'}], 'actions': [], 'display': 'FunnelViz', 'insight': 'FUNNELS', 'interval': 'day', 'date_from': '-1m', 'funnel_viz_type': 'steps', 'filter_test_accounts': True}
insight_10 = {'date_to': None, 'insight': 'PATHS', 'date_from': '-30d', 'edge_limit': 50, 'properties': {'type': 'AND', 'values': []}, 'step_limit': 5, 'start_point': 'https://hedgebox.net/', 'funnel_filter': {}, 'exclude_events': [], 'path_groupings': ['/files/*'], 'include_event_types': ['$pageview'], 'local_path_cleaning_filters': []}
insight_11 = {'events': [{'id': 'uploaded_file', 'type': 'events', 'order': 0}, {'id': 'deleted_file', 'type': 'events', 'order': 2}, {'id': 'downloaded_file', 'type': 'events', 'order': 1}], 'actions': [], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'day', 'date_from': '-30d'}
insight_12 = {'events': [{'id': '$pageview', 'math': 'dau', 'type': 'events'}], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'day', 'date_from': '-30d', 'filter_test_accounts': True}
insight_13 = {'events': [{'id': '$pageview', 'math': 'dau', 'type': 'events'}], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'week', 'date_from': '-90d', 'filter_test_accounts': True}
insight_14 = {'period': 'Week', 'insight': 'RETENTION', 'target_entity': {'id': '$pageview', 'type': 'events'}, 'retention_type': 'retention_first_time', 'returning_entity': {'id': '$pageview', 'type': 'events'}, 'filter_test_accounts': True}
insight_15 = {'events': [{'id': '$pageview', 'type': 'events'}], 'insight': 'LIFECYCLE', 'interval': 'week', 'shown_as': 'Lifecycle', 'date_from': '-30d', 'entity_type': 'events', 'filter_test_accounts': True}
insight_16 = {'events': [{'id': '$pageview', 'math': 'dau', 'type': 'events'}], 'display': 'ActionsBarValue', 'insight': 'TRENDS', 'interval': 'day', 'breakdown': '$referring_domain', 'date_from': '-14d', 'breakdown_type': 'event', 'filter_test_accounts': True}
insight_17 = {'events': [{'id': '$pageview', 'type': 'events', 'order': 0, 'custom_name': 'First page view'}, {'id': '$pageview', 'type': 'events', 'order': 1, 'custom_name': 'Second page view'}, {'id': '$pageview', 'type': 'events', 'order': 2, 'custom_name': 'Third page view'}], 'layout': 'horizontal', 'display': 'FunnelViz', 'insight': 'FUNNELS', 'interval': 'day', 'breakdown': '$browser', 'exclusions': [], 'breakdown_type': 'event', 'funnel_viz_type': 'steps', 'filter_test_accounts': True}
insight_18 = {'actions': [{'id': 2760, 'math': 'total', 'name': 'Pageviews', 'type': 'actions', 'order': 0, 'properties': [{'key': '$browser', 'type': 'event', 'value': 'Chrome', 'operator': None}], 'math_property': None}], 'display': 'ActionsBar', 'insight': 'LIFECYCLE', 'interval': 'day', 'shown_as': 'Lifecycle'}
insight_19 = {'events': [{'id': 'created change', 'math': 'total', 'name': 'created change', 'type': 'events', 'order': 0, 'properties': [{'key': 'id', 'type': 'cohort', 'value': 2208, 'operator': None}], 'custom_name': None, 'math_property': None}], 'display': 'ActionsLineGraph', 'insight': 'LIFECYCLE', 'interval': 'day', 'shown_as': 'Lifecycle'}
insight_20 = {'events': [{'id': '$pageview', 'math': 'total', 'name': '$pageview', 'type': 'events', 'order': 0, 'properties': [], 'math_property': None}], 'display': 'ActionsLineGraph', 'insight': 'LIFECYCLE', 'interval': 'day', 'shown_as': 'Lifecycle', 'properties': [{'key': 'id', 'type': 'cohort', 'value': 929, 'operator': 'exact'}]}
insight_21 = {'actions': [{'id': 4317, 'math': 'total', 'name': 'Some name', 'type': 'actions', 'order': 0, 'properties': [], 'custom_name': None, 'math_property': None}], 'display': 'ActionsLineGraph', 'insight': 'LIFECYCLE', 'interval': 'day', 'shown_as': 'Lifecycle', 'properties': [{'key': 'id', 'type': 'precalculated-cohort', 'value': 760, 'operator': None}], 'funnel_window_days': 14}
insight_22 = {'actions': [{'id': '10184', 'math': None, 'name': 'Some name', 'type': 'actions', 'order': 0, 'properties': [], 'math_property': None}], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'day', 'breakdown_type': 'undefined'}
insight_23 = {'events': [{'id': '$pageview', 'name': '$pageview', 'type': 'events', 'order': 0}], 'display': 'ActionsLineGraph', 'insight': 'TRENDS', 'interval': 'day', 'shown_as': 'Volume', 'breakdown': False, 'properties': [{'key': '$current_url', 'type': 'event', 'value': 'https://example.com/', 'operator': 'icontains'}], 'breakdown_type': 'undefined'}
insight_24 = {'events': [{'id': '$pageview', 'math': None, 'name': '$pageview', 'type': 'events', 'order': 0, 'properties': [], 'math_property': None}], 'display': 'ActionsLineGrap[…]ccounts=false', 'insight': 'TRENDS', 'interval': 'day', 'date_from': '-90d'}
insight_25 = {'events': [{'id': '$pageview', 'math': None, 'name': '$pageview', 'type': 'events', 'order': 2, 'properties': [{'key': '$host', 'type': 'event', 'value': [None], 'operator': 'exact'}], 'math_property': None}], 'insight': 'TRENDS'}
insight_26 = {'events': [{'id': '$pageview', 'name': '$pageview', 'type': 'events'}], 'insight': 'TRENDS'}
insight_27 = {'actions': [{'id': None, 'math': None, 'name': None, 'type': 'actions', 'order': None, 'properties': [], 'math_property': None}], 'insight': 'TRENDS'}
insight_28 = {'events': [{'id': '$pageview', 'type': 'events'}], 'insight': 'TRENDS', 'breakdown': [None], 'breakdown_type': 'cohort'}
insight_29 = {'events': ['{EXAMPLE_VARIABLE}', {'id': '$pageview', 'math': 'dau', 'name': '$pageview', 'type': 'events', 'order': 1, 'properties': [{'key': '$current_url', 'type': 'event', 'value': 'posthog.com/signup$', 'operator': 'regex'}], 'custom_name': 'Views on signup page'}], 'insight': 'TRENDS'}
insight_30 = {'events': [{'id': '$pageview', 'name': '$pageview'}], 'insight': 'TRENDS', 'breakdown': '$geoip_country_code', 'breakdown_type': 'events', 'breakdown_group_type_index': 0}
insight_31 = {'events': [{'id': '$autocapture', 'math': 'total', 'name': '$autocapture', 'type': 'events', 'order': 0}], 'insight': 'STICKINESS', 'entity_type': 'events'}
insight_32 = {'events': [{'id': '$pageview', 'math': 'dau', 'name': '$pageview', 'type': 'events', 'order': None, 'properties': [], 'math_property': None}], 'insight': 'STICKINESS', 'interval': 'minute', 'shown_as': 'Stickiness', 'date_from': 'dStart'}
insight_33 = {'period': 'Week', 'display': 'ActionsTable', 'insight': 'RETENTION', 'properties': [{'key': 'id', 'type': 'precalculated-cohort', 'value': 71, 'operator': None}, {'key': 'id', 'type': 'static-cohort', 'value': 696, 'operator': None}], 'target_entity': {'id': 4912, 'math': None, 'name': None, 'type': 'actions', 'order': None, 'properties': [], 'custom_name': None, 'math_property': None}, 'retention_type': 'retention_first_time', 'total_intervals': 11, 'returning_entity': {'id': 3410, 'math': None, 'name': None, 'type': 'actions', 'order': None, 'properties': [], 'custom_name': None, 'math_property': None}}
test_insights = [insight_0, insight_1, insight_2, insight_3, insight_4, insight_5, insight_6, insight_7, insight_8, insight_9, insight_10, insight_11, insight_12, insight_13, insight_14, insight_15, insight_16, insight_17, insight_18, insight_19, insight_20, insight_21, insight_22, insight_23, insight_24, insight_25, insight_26, insight_27, insight_28, insight_29, insight_30, insight_31, insight_32, insight_33]
...
properties_2 = [{'key': 'account_id', 'type': 'event', 'value': ['some_id'], 'operator': 'exact'}, {'key': '$current_url', 'type': 'event', 'value': '/path', 'operator': 'not_icontains'}]
properties_3 = {}
properties_4 = {'type': 'AND', 'values': []}
properties_5 = {'type': 'AND', 'values': [{'type': 'AND', 'values': []}]}
properties_6 = {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'key': '$current_url', 'type': 'event', 'value': '?', 'operator': 'not_icontains'}, {'key': '$referring_domain', 'type': 'event', 'value': 'google', 'operator': 'icontains'}]}]}
properties_7 = {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'type': 'AND', 'values': []}, {'type': 'AND', 'values': []}]}, {'type': 'AND', 'values': [{'key': "dateDiff('minute', timestamp, now()) < 5", 'type': 'hogql', 'value': None}]}]}
properties_8 = {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'key': "dateDiff('minute', timestamp, now()) < 5", 'type': 'hogql', 'value': None}]}, {'type': 'AND', 'values': [{'key': "dateDiff('minute', timestamp, now()) < 5", 'type': 'hogql', 'value': None}]}]}
properties_9 = {'type': 'AND', 'values': [{'type': 'AND', 'values': [{'key': '$browser', 'value': ['Chrome'], 'operator': 'exact', 'type': 'event'}, {'key': '$browser', 'value': ['Chrome'], 'operator': 'exact', 'type': 'person'}, {'key': '$feature/hogql-insights', 'value': ['true'], 'operator': 'exact', 'type': 'event'}, {'key': 'site_url', 'value': ['http://localhost:8000'], 'operator': 'exact', 'type': 'group', 'group_type_index': 1}, {'key': 'id', 'value': 2, 'type': 'cohort'}, {'key': 'tag_name', 'value': ['elem'], 'operator': 'exact', 'type': 'element'}, {'key': '$session_duration', 'value': None, 'operator': 'gt', 'type': 'session'}, {'type': 'hogql', 'key': 'properties.name', 'value': None}]}, {'type': 'OR', 'values': [{}]}]}
...
test_properties = [properties_0, properties_1, properties_2, properties_3, properties_4, properties_5, properties_6, properties_7, properties_8, properties_9, properties_10, properties_11, properties_12, properties_13, properties_14]
