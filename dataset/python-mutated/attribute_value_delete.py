...
class AttributeValueDelete(ModelDeleteMutation, ModelWithExtRefMutation):
    ...
    class Arguments:
        ...
        external_reference = graphene.String(required=False, description=f'External ID of a value to delete. {ADDED_IN_310}')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.ATTRIBUTE_VALUE_DELETED, description='An attribute value was deleted.'), WebhookEventInfo(type=WebhookEventAsyncType.ATTRIBUTE_UPDATED, description='An attribute was updated.')]
