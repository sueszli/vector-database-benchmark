...
def mojo_model_test_regression():
    if False:
        while True:
            i = 10
    test(['Origin', 'Dest'], 'Distance', compare_output, 'Model Summary: ', 'ModelMetricsRegression: gbm', 'ModelMetricsRegressionGeneric: generic')

def mojo_model_test_binomial():
    if False:
        for i in range(10):
            print('nop')
    test(['Origin', 'Dest'], 'IsDepDelayed', compare_output, 'Model Summary: ', 'ModelMetricsBinomial: gbm', 'ModelMetricsBinomialGeneric: generic')

def mojo_model_test_multinomial():
    if False:
        print('Hello World!')
    test(['Origin', 'Distance'], 'Dest', compare_output, 'Model Summary: ', 'ModelMetricsMultinomial: gbm', 'ModelMetricsMultinomialGeneric: generic')
