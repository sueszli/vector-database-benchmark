...
class GBDTNode:
    ...
    NODE_TYPE_LEAF = 3
    type2typeid = {'indicator': NODE_TYPE_INDICATOR, 'integer': NODE_TYPE_INT, 'leaf': NODE_TYPE_LEAF}
    typeid2type = {NODE_TYPE_INDICATOR: 'indicator', NODE_TYPE_INT: 'integer', NODE_TYPE_LEAF: 'leaf'}
