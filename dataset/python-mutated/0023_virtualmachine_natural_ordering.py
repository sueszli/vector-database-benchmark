...
class Migration(migrations.Migration):
    dependencies = [('virtualization', '0022_vminterface_parent')]
    operations = [migrations.AlterModelOptions(name='virtualmachine', options={'ordering': ('_name', 'pk')}), migrations.AddField(model_name='virtualmachine', name='_name', field=utilities.fields.NaturalOrderingField('name', max_length=100, blank=True, naturalize_function=utilities.ordering.naturalize)), migrations.RunPython(code=naturalize_virtualmachines, reverse_code=migrations.RunPython.noop)]