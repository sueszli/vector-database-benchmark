...
from scapy.fields import BitFieldLenField, BitField, BitEnumField, ByteField, ShortField, XShortField, IPField, PacketListField, IntField, FieldLenField, BoundStrLenField
...
class PIMv2HelloLANPruneDelayValue(_PIMv2GenericHello):
    ...
    fields_desc = [BitField('t', 0, 1), BitField('propagation_delay', 500, 15), ShortField('override_interval', 2500)]
...
PIMv2_HELLO_CLASSES = {1: PIMv2HelloHoldtime, 2: PIMv2HelloLANPruneDelay, 19: PIMv2HelloDRPriority, 20: PIMv2HelloGenerationID, 21: PIMv2HelloStateRefresh, None: _PIMv2GenericHello}
