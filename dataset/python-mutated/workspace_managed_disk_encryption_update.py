...
def main():
    ...
    response = client.workspaces.begin_create_or_update(resource_group_name='rg', workspace_name='myWorkspace', parameters={'location': 'westus', 'properties': {'encryption': {'entities': {'managedDisk': {'keySource': 'Microsoft.Keyvault', 'keyVaultProperties': {'keyName': 'test-cmk-key', 'keyVaultUri': 'https://test-vault-name.vault.azure.net/', 'keyVersion': '00000000000000000000000000000000'}, 'rotationToLatestKeyVersionEnabled': True}}}, 'managedResourceGroupId': '/subscriptions/subid/resourceGroups/myManagedRG'}, 'tags': {'mytag1': 'myvalue1'}}).result()
    print(response)
