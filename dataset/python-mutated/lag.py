...
class Lag(TransformPrimitive):
    ...
    """
    name = 'lag'
    input_types = [[ColumnSchema(semantic_tags={'category'}), ColumnSchema(semantic_tags={'time_index'})], [ColumnSchema(semantic_tags={'numeric'}), ColumnSchema(semantic_tags={'time_index'})], [ColumnSchema(logical_type=Boolean), ColumnSchema(semantic_tags={'time_index'})], [ColumnSchema(logical_type=BooleanNullable), ColumnSchema(semantic_tags={'time_index'})]]
    return_type = None
