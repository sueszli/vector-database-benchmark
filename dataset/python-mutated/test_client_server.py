...
from bokeh.core.properties import AngleSpec, Any, Bytes, Dict, DistanceSpec, Instance, Int, Nullable, String
...
class TestClientServer:
    ...
    async def check_connect_session_fails(self, server, origin):
        with pytest.raises(HTTPError):
            ...
            await websocket_open(server.io_loop, ws_url(server), origin=origin, subprotocols=subprotocols)
