...
from xarray.tests import assert_array_equal, assert_identical, has_cftime, requires_cftime
from xarray.tests.test_coding_times import _ALL_CALENDARS, _NON_STANDARD_CALENDARS, _all_cftime_date_types
...
SEL_STRING_OR_LIST_TESTS = {'string': '0001', 'string-slice': slice('0001-01-01', '0001-12-30'), 'bool-list': [True, True, False, False]}
