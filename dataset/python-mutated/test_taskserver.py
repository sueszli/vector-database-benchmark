...
from golem.environments.environment import Environment as OldEnv, SupportStatus, UnsupportReason
from golem.envs import BenchmarkResult, EnvSupportStatus
from golem.envs import Environment as NewEnv
from golem.network.hyperdrive.client import HyperdriveClientOptions, HyperdriveClient, to_hyperg_peer
...
from golem.task.taskserver import logger, TaskServer, WaitingTaskFailure, WaitingTaskResult
...
from tests.golem.envs.localhost import LocalhostEnvironment, LocalhostConfig, LocalhostPrerequisites, LocalhostPayloadBuilder
...
class TaskServerTestBase(LogTestCase, testutils.DatabaseFixture, testutils.TestWithClient, TwistedAsyncioTestCase):
...
class TestTaskServer(TaskServerTestBase):
...
class TestRestoreResources(LogTestCase, testutils.DatabaseFixture, testutils.TestWithClient):
...
class TestNewTaskComputerIntegration(testutils.TestWithClient, testutils.DatabaseFixture, TwistedAsyncioTestCase):
