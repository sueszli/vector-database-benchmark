...
class sfp_torexits(SpiderFootPlugin):
    meta = {'name': 'TOR Exit Nodes', 'summary': 'Check if an IP adddress or netblock appears on the Tor Metrics exit node list.', 'flags': [], 'useCases': ['Investigate', 'Passive'], 'categories': ['Secondary Networks'], 'dataSource': {'website': 'https://metrics.torproject.org/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://metrics.torproject.org/rs.html#search/flag:exit'], 'favIcon': 'https://metrics.torproject.org/images/favicon.ico', 'logo': 'https://metrics.torproject.org/images/tor-metrics-white@2x.png', 'description': 'The relay search tool displays data about single relays and bridges in the Tor network.'}}
    opts = {'checkaffiliates': True, 'cacheperiod': 1, 'checknetblocks': True}
    optdescs = {'checkaffiliates': 'Apply checks to affiliates?', 'cacheperiod': 'Hours to cache list data before re-fetching.', 'checknetblocks': 'Report if any malicious IPs are found within owned netblocks?'}
    results = None
    errorState = False
