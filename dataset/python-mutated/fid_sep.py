...
if __name__ == '__main__':
    gpu_count = 1
    run(sample, get_cfg_defaults(), description='ALAE-fid', default_config='configs/experiment_celeba_sep.yaml', world_size=gpu_count, write_log='metrics/fid_score.txt')