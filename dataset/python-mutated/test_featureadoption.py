...
from sentry.signals import advanced_search, alert_rule_created, data_scrubber_enabled, event_processed, first_event_received, inbound_filter_toggled, issue_assigned, issue_resolved, member_joined, plugin_enabled, project_created, save_search_created, sso_enabled, user_feedback_received
