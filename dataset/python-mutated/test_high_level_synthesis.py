...
import numpy as np
from qiskit.circuit import QuantumCircuit, QuantumRegister, ClassicalRegister, Gate, Qubit, Clbit, Parameter, Operation, EquivalenceLibrary
from qiskit.circuit.library import SwapGate, CXGate, RZGate, PermutationGate, U3Gate, U2Gate, U1Gate, CU3Gate, CU1Gate
