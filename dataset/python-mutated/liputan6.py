...
class Liputan6IE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        json_data = self._search_json('window.kmklabs.gtm\\s*=', webpage, 'json_data', display_id)
        video_id = json_data['videos']['video_1']['video_id']
        return self.url_result(f'https://www.vidio.com/watch/{video_id}-{display_id}', ie=VidioIE, video_id=display_id)