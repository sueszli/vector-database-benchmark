...
if is_tf_available() and is_datasets_available() and is_faiss_available():
    ...
    from transformers import AutoConfig, RagConfig, RagRetriever, RagTokenizer, TFAutoModel, TFAutoModelForSeq2SeqLM, TFRagModel, TFRagSequenceForGeneration, TFRagTokenForGeneration
...
class TFRagTestMixin:
    ...
    all_generative_model_classes = (TFRagTokenForGeneration, TFRagSequenceForGeneration) if is_tf_available() and is_datasets_available() and is_faiss_available() else ()
