...
if __name__ == '__main__':
    warn('The file conf_afm.py will be removed in 2023. Its functionality ismoved to pdfminer/font_metrics.py. Feel free to create a GitHub issue if you disagree.', DeprecationWarning)
