...
flags.DEFINE_integer('num_train_episodes', 15000, 'Number of training episodes.')
flags.DEFINE_integer('eval_every', 1000, 'Episode frequency at which the agent is evaluated.')
