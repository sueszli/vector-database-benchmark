...
class sfp_quad9(SpiderFootPlugin):
    ...
    def handleEvent(self, event):
        ...
        if found:
            return
        evt = SpiderFootEvent(blacklist_type, f'Quad9 [{eventData}]\n<SFURL>https://quad9.net/result/?url={eventData}</SFURL>', self.__name__, event)
        self.notifyListeners(evt)
        evt = SpiderFootEvent(malicious_type, f'Quad9 [{eventData}]\n<SFURL>https://quad9.net/result/?url={eventData}</SFURL>', self.__name__, event)
        self.notifyListeners(evt)