...
class TestAddSmartArtBasicBendingProcess(TestCase):
    ...
    def test_add_smartart_basic_bending_process_003(self):
        ...
        layout: PageLayout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds SmartArt to a PDF.'))
        layout.add(SmartArt.basic_bending_process(['Lorem', 'Ipsum', 'Dolor', 'Sit', 'Amet']))
    ...
    def test_add_smartart_basic_bending_process_004(self):
        ...
        layout: PageLayout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds SmartArt to a PDF.'))
        layout.add(SmartArt.basic_bending_process(['Lorem', 'Ipsum', 'Dolor', 'Sit', 'Amet', 'Consectetur']))
    ...
    def test_add_smartart_basic_bending_process_005(self):
        ...
        layout: PageLayout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds SmartArt to a PDF.'))
        layout.add(SmartArt.basic_bending_process(['Lorem', 'Ipsum', 'Dolor', 'Sit', 'Amet', 'Consectetur', 'Adipiscing']))
    ...
    def test_add_smartart_basic_bending_process_006(self):
        ...
        layout: PageLayout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds SmartArt to a PDF.'))
        layout.add(SmartArt.basic_bending_process(['Lorem', 'Ipsum', 'Dolor', 'Sit', 'Amet', 'Consectetur', 'Adipiscing', 'Elit']))
