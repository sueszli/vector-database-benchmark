...
from paddle.distributed.auto_parallel.static.dist_context import set_default_distributed_context
from paddle.distributed.auto_parallel.static.utils import get_dist_attr, load_checkpoint_into_program, load_distributed_checkpoint, load_parameter_into_program, merge_and_slice_parameter, save_distributed_checkpoint
