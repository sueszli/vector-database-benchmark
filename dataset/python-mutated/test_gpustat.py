...
def remove_ansi_codes(s):
    ...
    return s
mock_gpu_handles = [types.SimpleNamespace(value='mock-handle-%d' % i, index=i) for i in range(3)]
...
MOCK_EXPECTED_OUTPUT_DEFAULT = os.linesep.join('[0] GeForce GTX TITAN 0 | 80°C,  76 % |  8000 / 12287 MB | user1(4000M) user2(4000M)\n[1] GeForce GTX TITAN 1 | 36°C,   0 % |  9000 / 12189 MB | user1(3000M) user3(6000M)\n[2] GeForce RTX 2       | 71°C,  ?? % |     0 / 12189 MB | (Not Supported)\n'.splitlines())
MOCK_EXPECTED_OUTPUT_FULL = os.linesep.join('[0] GeForce GTX TITAN 0 | 80°C,  16 %,  76 % (E:  88 %  D:  67 %),  125 / 250 W |  8000 / 12287 MB | user1:python/48448(4000M) user2:python/153223(4000M)\n[1] GeForce GTX TITAN 1 | 36°C,  53 %,   0 % (E:   0 %  D:   0 %),   ?? / 250 W |  9000 / 12189 MB | user1:torch/192453(3000M) user3:caffe/194826(6000M)\n[2] GeForce RTX 2       | 71°C, 100 %,  ?? % (E:  ?? %  D:  ?? %),  250 /  ?? W |     0 / 12189 MB | (Not Supported)\n'.splitlines())
MOCK_EXPECTED_OUTPUT_FULL_PROCESS = os.linesep.join('[0] GeForce GTX TITAN 0 | 80°C,  16 %,  76 % (E:  88 %  D:  67 %),  125 / 250 W |  8000 / 12287 MB | user1:python/48448(4000M) user2:python/153223(4000M)\n ├─  48448 (  85%,  257MB): python\n └─ 153223 (  15%,     0B): python\n[1] GeForce GTX TITAN 1 | 36°C,  53 %,   0 % (E:   0 %  D:   0 %),   ?? / 250 W |  9000 / 12189 MB | user1:torch/192453(3000M) user3:caffe/194826(6000M)\n ├─ 192453 ( 123%,   59MB): torch\n └─ 194826 (   0%, 1025MB): caffe\n[2] GeForce RTX 2       | 71°C, 100 %,  ?? % (E:  ?? %  D:  ?? %),  250 /  ?? W |     0 / 12189 MB | (Not Supported)\n'.splitlines())
MOCK_EXPECTED_OUTPUT_NO_PROCESSES = os.linesep.join('[0] GeForce GTX TITAN 0 | 80°C,  76 % |  8000 / 12287 MB\n[1] GeForce GTX TITAN 1 | 36°C,   0 % |  9000 / 12189 MB\n[2] GeForce RTX 2       | 71°C,  ?? % |     0 / 12189 MB\n'.splitlines())
