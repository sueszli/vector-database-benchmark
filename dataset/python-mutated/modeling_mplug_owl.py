...
from transformers.modeling_outputs import BaseModelOutput, BaseModelOutputWithPastAndCrossAttentions, BaseModelOutputWithPooling, BaseModelOutputWithPoolingAndCrossAttentions, CausalLMOutputWithCrossAttentions
...
from modelscope.models.multi_modal.mplug_owl.configuration_mplug_owl import MplugOwlConfig, MplugOwlVisionConfig, MplugOwlVisualAbstractorConfig
...
class MplugOwlPreTrainedModel(PreTrainedModel):
    ...
    _keys_to_ignore_on_load_missing = ['position_ids', 'language_model.encoder.embed_tokens.weight', 'language_model.decoder.embed_tokens.weight', 'language_model.lm_head.weight']
...
class MplugOwlModel(MplugOwlPreTrainedModel):
    """The mPLUG-Owl model is a multi-modal conversation model that support various modalities as input.
...
@MODELS.register_module(Tasks.multimodal_dialogue, module_name=Models.mplug_owl)
