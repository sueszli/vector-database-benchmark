...
class AreaEntry:
    ...
    aliases: set[str] = attr.ib(converter=attr.converters.default_if_none(factory=set))
    ...
    async def async_load(self) -> None:
        ...
        if data is not None:
            for area in data['areas']:
                ...
                areas[area['id']] = AreaEntry(aliases=set(area['aliases']), id=area['id'], name=area['name'], normalized_name=normalized_name, picture=area['picture'])
                self._normalized_name_area_idx[normalized_name] = area['id']
        self.areas = areas
