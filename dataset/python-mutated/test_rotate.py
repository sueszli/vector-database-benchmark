...
from sequences_test_utils import ArgData, ArgDesc, ArgCb, ParamsProvider, get_video_input_cases, sequence_suite_helper
...
io_types = [(dali.types.UINT8, dali.types.UINT8), (dali.types.UINT8, dali.types.FLOAT), (dali.types.FLOAT, dali.types.UINT8), (dali.types.FLOAT, dali.types.FLOAT)]
