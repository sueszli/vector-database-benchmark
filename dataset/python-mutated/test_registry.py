...
from orchestrator.assets.registry_entry import get_connector_type_from_registry_entry, get_registry_entry_write_path, get_registry_status_lists, metadata_to_registry_entry, safe_parse_metadata_definition
from orchestrator.assets.registry_report import all_destinations_dataframe, all_sources_dataframe, cloud_destinations_dataframe, cloud_sources_dataframe, oss_destinations_dataframe, oss_sources_dataframe
from orchestrator.models.metadata import LatestMetadataEntry, MetadataDefinition
from pydantic import ValidationError
VALID_METADATA_DICT = {'metadataSpecVersion': '1.0', 'data': {'name': 'Test', 'definitionId': str(UUID(int=1)), 'connectorType': 'source', 'dockerRepository': 'test_repo', 'dockerImageTag': 'test_tag', 'license': 'test_license', 'documentationUrl': 'https://test_documentation_url.com', 'githubIssueLabel': 'test_label', 'connectorSubtype': 'api', 'supportLevel': 'community', 'releaseStage': 'alpha', 'registries': {'oss': {'enabled': True}, 'cloud': {'enabled': True}}}}
