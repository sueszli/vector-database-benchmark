...
class ChakraComponent(Component):
    ...
    lib_dependencies: List[str] = ['@chakra-ui/system@2.5.7', 'framer-motion@10.16.4']
...
class ChakraColorModeProvider(Component):
    ...
    is_default = True
LiteralColorScheme = Literal['none', 'gray', 'red', 'orange', 'yellow', 'green', 'teal', 'blue', 'cyan', 'purple', 'pink', 'whiteAlpha', 'blackAlpha', 'linkedin', 'facebook', 'messenger', 'whatsapp', 'twitter', 'telegram']
LiteralVariant = Literal['solid', 'subtle', 'outline']
LiteralDividerVariant = Literal['solid', 'dashed']
LiteralTheme = Literal['light', 'dark']
LiteralTagColorScheme = Literal['gray', 'red', 'orange', 'yellow', 'green', 'teal', 'blue', 'cyan', 'purple', 'pink']
LiteralTagAlign = Literal['center', 'end', 'start']
LiteralTabsVariant = Literal['line', 'enclosed', 'enclosed-colored', 'soft-rounded', 'solid-rounded', 'unstyled']
...
LiteralLanguage = Literal['en', 'da', 'de', 'es', 'fr', 'ja', 'ko', 'pt_br', 'ru', 'zh_cn', 'ro', 'pl', 'ckb', 'lv', 'se', 'ua', 'he', 'it']
LiteralInputVariant = Literal['outline', 'filled', 'flushed', 'unstyled']
LiteralInputNumberMode = ['text', 'search', 'none', 'tel', 'url', 'email', 'numeric', 'decimal']
