...
from ..utils import clean_html, determine_ext, ExtractorError, filter_dict, GeoRestrictedError, int_or_none, join_nonempty, parse_duration, remove_start, strip_or_none, traverse_obj, try_get, unified_strdate, unified_timestamp, update_url_query, urljoin, xpath_text

class RaiBaseIE(InfoExtractor):
    _UUID_RE = '[\\da-f]{8}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{4}-[\\da-f]{12}'
    _GEO_COUNTRIES = ['IT']
    _GEO_BYPASS = False
...
class RaiPlayIE(RaiBaseIE):
    _VALID_URL = f'(?P<base>https?://(?:www\\.)?raiplay\\.it/.+?-(?P<id>{RaiBaseIE._UUID_RE}))\\.(?:html|json)'
    _TESTS = [{'url': 'https://www.raiplay.it/video/2014/04/Report-del-07042014-cb27157f-9dd0-4aee-b788-b1f67643a391.html', 'md5': '8970abf8caf8aef4696e7b1f2adfc696', 'info_dict': {'id': 'cb27157f-9dd0-4aee-b788-b1f67643a391', 'ext': 'mp4', 'title': 'Report del 07/04/2014', 'alt_title': 'St 2013/14 - Report - Espresso nel caffè - 07/04/2014', 'description': 'md5:d730c168a58f4bb35600fc2f881ec04e', 'thumbnail': 're:^https?://www\\.raiplay\\.it/.+\\.jpg', 'uploader': 'Rai 3', 'creator': 'Rai 3', 'duration': 6160, 'series': 'Report', 'season': '2013/14', 'subtitles': {'it': 'count:4'}, 'release_year': 2022, 'episode': 'Espresso nel caffè - 07/04/2014', 'timestamp': 1396919880, 'upload_date': '20140408', 'formats': 'count:4'}, 'params': {'skip_download': True}}, {'url': 'https://www.raiplay.it/video/2021/11/Blanca-S1E1-Senza-occhi-b1255a4a-8e72-4a2f-b9f3-fc1308e00736.html', 'md5': 'aeda7243115380b2dd5e881fd42d949a', 'info_dict': {'id': 'b1255a4a-8e72-4a2f-b9f3-fc1308e00736', 'ext': 'mp4', 'title': 'Blanca - S1E1 - Senza occhi', 'alt_title': 'St 1 Ep 1 - Blanca - Senza occhi', 'description': 'md5:75f95d5c030ec8bac263b1212322e28c', 'thumbnail': 're:^https://www\\.raiplay\\.it/dl/img/.+\\.jpg', 'uploader': 'Rai Premium', 'creator': 'Rai Fiction', 'duration': 6493, 'series': 'Blanca', 'season': 'Season 1', 'episode_number': 1, 'release_year': 2021, 'season_number': 1, 'episode': 'Senza occhi', 'timestamp': 1637318940, 'upload_date': '20211119', 'formats': 'count:12'}, 'params': {'skip_download': True}, 'expected_warnings': ['Video not available. Likely due to geo-restriction.']}, {'url': 'https://www.raiplay.it/video/2012/09/S1E11---Tutto-cio-che-luccica-0cab3323-732e-45d6-8e86-7704acab6598.html', 'md5': 'a634d20e8ab2d43724c273563f6bf87a', 'info_dict': {'id': '0cab3323-732e-45d6-8e86-7704acab6598', 'ext': 'mp4', 'title': 'Mia and Me - S1E11 - Tutto ciò che luccica', 'alt_title': 'St 1 Ep 11 - Mia and Me - Tutto ciò che luccica', 'description': 'md5:4969e594184b1920c4c1f2b704da9dea', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'Rai Gulp', 'series': 'Mia and Me', 'season': 'Season 1', 'episode_number': 11, 'release_year': 2015, 'season_number': 1, 'episode': 'Tutto ciò che luccica', 'timestamp': 1348495020, 'upload_date': '20120924'}}, {'url': 'http://www.raiplay.it/video/2016/11/gazebotraindesi-efebe701-969c-4593-92f3-285f0d1ce750.html?', 'only_matching': True}, {'url': 'https://www.raiplay.it/video/2020/12/Report---04-01-2021-2e90f1de-8eee-4de4-ac0e-78d21db5b600.html', 'only_matching': True}, {'url': 'https://www.raiplay.it/video/2021/06/Lo-straordinario-mondo-di-Zoey-S2E1-Lo-straordinario-ritorno-di-Zoey-3ba992de-2332-41ad-9214-73e32ab209f4.html', 'only_matching': True}]
...
class RaiPlayLiveIE(RaiPlayIE):
    ...
    _TESTS = [{'url': 'http://www.raiplay.it/dirette/rainews24', 'info_dict': {'id': 'd784ad40-e0ae-4a69-aa76-37519d238a9c', 'display_id': 'rainews24', 'ext': 'mp4', 'title': 're:^Diretta di Rai News 24 [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'description': 'md5:4d00bcf6dc98b27c6ec480de329d1497', 'uploader': 'Rai News 24', 'creator': 'Rai News 24', 'is_live': True, 'live_status': 'is_live', 'upload_date': '20090502', 'timestamp': 1241276220, 'formats': 'count:3'}, 'params': {'skip_download': True}}]

class RaiPlayPlaylistIE(InfoExtractor):
    _VALID_URL = '(?P<base>https?://(?:www\\.)?raiplay\\.it/programmi/(?P<id>[^/?#&]+))(?:/(?P<extra_id>[^?#&]+))?'
    _TESTS = [{'url': 'https://www.raiplay.it/programmi/nondirloalmiocapo/', 'info_dict': {'id': 'nondirloalmiocapo', 'title': 'Non dirlo al mio capo', 'description': 'md5:98ab6b98f7f44c2843fd7d6f045f153b'}, 'playlist_mincount': 30}, {'url': 'https://www.raiplay.it/programmi/nondirloalmiocapo/episodi/stagione-2/', 'info_dict': {'id': 'nondirloalmiocapo', 'title': 'Non dirlo al mio capo - Stagione 2', 'description': 'md5:98ab6b98f7f44c2843fd7d6f045f153b'}, 'playlist_count': 12}]
...
class RaiPlaySoundIE(RaiBaseIE):
    _VALID_URL = f'(?P<base>https?://(?:www\\.)?raiplaysound\\.it/.+?-(?P<id>{RaiBaseIE._UUID_RE}))\\.(?:html|json)'
    _TESTS = [{'url': 'https://www.raiplaysound.it/audio/2021/12/IL-RUGGITO-DEL-CONIGLIO-1ebae2a7-7cdb-42bb-842e-fe0d193e9707.html', 'md5': '8970abf8caf8aef4696e7b1f2adfc696', 'info_dict': {'id': '1ebae2a7-7cdb-42bb-842e-fe0d193e9707', 'ext': 'mp3', 'title': 'Il Ruggito del Coniglio del 10/12/2021', 'alt_title': 'md5:0e6476cd57858bb0f3fcc835d305b455', 'description': 'md5:2a17d2107e59a4a8faa0e18334139ee2', 'thumbnail': 're:^https?://.+\\.jpg$', 'uploader': 'rai radio 2', 'duration': 5685, 'series': 'Il Ruggito del Coniglio', 'episode': 'Il Ruggito del Coniglio del 10/12/2021', 'creator': 'rai radio 2', 'timestamp': 1638346620, 'upload_date': '20211201'}, 'params': {'skip_download': True}}]
...
class RaiPlaySoundLiveIE(RaiPlaySoundIE):
    ...
    _TESTS = [{'url': 'https://www.raiplaysound.it/radio2', 'info_dict': {'id': 'b00a50e6-f404-4af6-8f8c-ff3b9af73a44', 'display_id': 'radio2', 'ext': 'mp4', 'title': 're:Rai Radio 2 \\d+-\\d+-\\d+ \\d+:\\d+', 'thumbnail': 're:^https://www\\.raiplaysound\\.it/dl/img/.+\\.png', 'uploader': 'rai radio 2', 'series': 'Rai Radio 2', 'creator': 'raiplaysound', 'is_live': True, 'live_status': 'is_live'}, 'params': {'skip_download': True}}]
...
class RaiPlaySoundPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.raiplaysound.it/programmi/ilruggitodelconiglio', 'info_dict': {'id': 'ilruggitodelconiglio', 'title': 'Il Ruggito del Coniglio', 'description': 'md5:48cff6972435964284614d70474132e6'}, 'playlist_mincount': 65}, {'url': 'https://www.raiplaysound.it/programmi/ilruggitodelconiglio/puntate/prima-stagione-1995', 'info_dict': {'id': 'ilruggitodelconiglio_puntate_prima-stagione-1995', 'title': 'Prima Stagione 1995'}, 'playlist_count': 1}]
...
class RaiIE(RaiBaseIE):
    _VALID_URL = f'https?://[^/]+\\.(?:rai\\.(?:it|tv))/.+?-(?P<id>{RaiBaseIE._UUID_RE})(?:-.+?)?\\.html'
    _TESTS = [{'url': 'https://www.raisport.rai.it/dl/raiSport/media/rassegna-stampa-04a9f4bd-b563-40cf-82a6-aad3529cb4a9.html', 'info_dict': {'id': '04a9f4bd-b563-40cf-82a6-aad3529cb4a9', 'ext': 'mp4', 'title': 'TG PRIMO TEMPO', 'thumbnail': 're:^https?://.*\\.jpg', 'duration': 1758, 'upload_date': '20140612'}, 'params': {'skip_download': True}, 'expected_warnings': ['Video not available. Likely due to geo-restriction.']}, {'url': 'https://www.rai.it/dl/RaiTV/programmi/media/ContentItem-efb17665-691c-45d5-a60c-5301333cbb0c.html', 'info_dict': {'id': 'efb17665-691c-45d5-a60c-5301333cbb0c', 'ext': 'mp4', 'title': 'TG1 ore 20:00 del 03/11/2016', 'description': 'TG1 edizione integrale ore 20:00 del giorno 03/11/2016', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 2214, 'upload_date': '20161103'}, 'params': {'skip_download': True}}, {'url': 'http://www.rai.it/dl/RaiTV/programmi/media/ContentItem-b63a4089-ac28-48cf-bca5-9f5b5bc46df5.html', 'only_matching': True}]
...
class RaiNewsIE(RaiIE):
    _VALID_URL = f'https?://(www\\.)?rainews\\.it/(?!articoli)[^?#]+-(?P<id>{RaiBaseIE._UUID_RE})(?:-[^/?#]+)?\\.html'
    _EMBED_REGEX = [f'<iframe[^>]+data-src="(?P<url>/iframe/[^?#]+?{RaiBaseIE._UUID_RE}\\.html)']
    _TESTS = [{'url': 'https://www.rainews.it/rubriche/24mm/video/2022/05/24mm-del-29052022-12cf645d-1ffd-4220-b27c-07c226dbdecf.html', 'info_dict': {'id': '12cf645d-1ffd-4220-b27c-07c226dbdecf', 'ext': 'mp4', 'title': 'Puntata del 29/05/2022', 'duration': 1589, 'upload_date': '20220529', 'uploader': 'rainews'}, 'params': {'skip_download': True}}, {'url': 'https://www.rainews.it/dl/rainews/media/Weekend-al-cinema-da-Hollywood-arriva-il-thriller-di-Tate-Taylor-La-ragazza-del-treno-1632c009-c843-4836-bb65-80c33084a64b.html', 'info_dict': {'id': '1632c009-c843-4836-bb65-80c33084a64b', 'ext': 'mp4', 'title': 'Weekend al cinema, da Hollywood arriva il thriller di Tate Taylor "La ragazza del treno"', 'description': 'I film in uscita questa settimana.', 'thumbnail': 're:^https?://.*\\.png$', 'duration': 833, 'upload_date': '20161103'}, 'params': {'skip_download': True}, 'expected_warnings': ['unable to extract player_data']}, {'url': 'https://www.rainews.it/iframe/video/2022/07/euro2022-europei-calcio-femminile-italia-belgio-gol-0-1-video-4de06a69-de75-4e32-a657-02f0885f8118.html', 'only_matching': True}]
    _PLAYER_TAG = 'news'
...
class RaiCulturaIE(RaiNewsIE):
    _VALID_URL = f'https?://(www\\.)?raicultura\\.it/(?!articoli)[^?#]+-(?P<id>{RaiBaseIE._UUID_RE})(?:-[^/?#]+)?\\.html'
    _EMBED_REGEX = [f'<iframe[^>]+data-src="(?P<url>/iframe/[^?#]+?{RaiBaseIE._UUID_RE}\\.html)']
    _TESTS = [{'url': 'https://www.raicultura.it/letteratura/articoli/2018/12/Alberto-Asor-Rosa-Letteratura-e-potere-05ba8775-82b5-45c5-a89d-dd955fbde1fb.html', 'info_dict': {'id': '05ba8775-82b5-45c5-a89d-dd955fbde1fb', 'ext': 'mp4', 'title': 'Alberto Asor Rosa: Letteratura e potere', 'duration': 1756, 'upload_date': '20181206', 'uploader': 'raicultura', 'formats': 'count:2'}, 'params': {'skip_download': True}}]
    _PLAYER_TAG = 'cultura'

class RaiSudtirolIE(RaiBaseIE):
    _VALID_URL = 'https?://raisudtirol\\.rai\\.it/.+media=(?P<id>\\w+)'
    _TESTS = [{'url': 'https://raisudtirol.rai.it/la/index.php?media=Ptv1619729460', 'info_dict': {'id': 'Ptv1619729460', 'ext': 'mp4', 'title': "Euro: trasmisciun d'economia - 29-04-2021 20:51", 'series': "Euro: trasmisciun d'economia", 'upload_date': '20210429', 'thumbnail': 're:https://raisudtirol\\.rai\\.it/img/.+\\.jpg', 'uploader': 'raisudtirol', 'formats': 'count:1'}, 'params': {'skip_download': True}}, {'url': 'https://raisudtirol.rai.it/it/kidsplayer.php?lang=it&media=GUGGUG_P1.smil', 'info_dict': {'id': 'GUGGUG_P1', 'ext': 'mp4', 'title': 'GUGGUG! La Prospettiva - Die Perspektive', 'uploader': 'raisudtirol', 'formats': 'count:6'}, 'params': {'skip_download': True}}]
