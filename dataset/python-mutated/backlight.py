...
class Backlight(base.InLoopPollText):
    ...
    """
    filenames: dict = {}
    defaults = [('backlight_name', 'acpi_video0', 'ACPI name of a backlight device'), ('brightness_file', 'brightness', 'Name of file with the current brightness in /sys/class/backlight/backlight_name'), ('max_brightness_file', 'max_brightness', 'Name of file with the maximum brightness in /sys/class/backlight/backlight_name'), ('update_interval', 0.2, 'The delay in seconds between updates'), ('step', 10, 'Percent of backlight every scroll changed'), ('format', '{percent:2.0%}', 'Display format'), ('change_command', 'xbacklight -set {0}', 'Execute command to change value')]
