...
@MODELS.register_module(Tasks.shop_segmentation, module_name=Models.shop_segmentation)
class ShopSegmentation(TorchModel):
    ...
    def __init__(self, model_dir, device_id=0, *args, **kwargs):
        ...
        pretrained_params = torch.load('{}/{}'.format(model_dir, ModelFile.TORCH_MODEL_BIN_FILE), map_location='cpu')
    ...
    def forward(self, image):
        ...
        (image_tensor, ori_h, ori_w, crop_h, crop_w) = self.preprocess(image, size=1024)
