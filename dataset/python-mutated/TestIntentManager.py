...
mocked_intent_metadata = [{'id': 'um3_aa4_pla_smooth_normal', 'GUID': 'abcxyz', 'definition': 'ultimaker3', 'variant': 'AA 0.4', 'material_id': 'generic_pla', 'intent_category': 'smooth', 'quality_type': 'normal'}, {'id': 'um3_aa4_pla_strong_abnorm', 'GUID': 'defqrs', 'definition': 'ultimaker3', 'variant': 'AA 0.4', 'material_id': 'generic_pla', 'intent_category': 'strong', 'quality_type': 'abnorm'}]
mocked_qualitygroup_metadata = {'normal': QualityGroup('um3_aa4_pla_normal', 'normal'), 'abnorm': QualityGroup('um3_aa4_pla_abnorm', 'abnorm')}
