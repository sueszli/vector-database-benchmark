...
from AnyQt.QtCore import Qt, QSize, QMetaObject, QAbstractProxyModel, QItemSelectionModel, QItemSelection, QItemSelectionRange
...
from Orange.widgets.utils.itemselectionmodel import BlockSelectionModel, ranges, selection_blocks
...
if __name__ == '__main__':
    WidgetPreview(OWDataTable).run(insert_dataset=[(0, Table('iris')), (1, Table('brown-selected')), (2, Table('housing'))])