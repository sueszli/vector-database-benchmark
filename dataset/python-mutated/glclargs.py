...
class GamCLArgs:
    ...
    SERVICE_ACCOUNT_ONLY_ENTITY_SELECTORS = [ENTITY_SELECTOR_CSVDATAFILE, ENTITY_SELECTOR_CSVKMD, ENTITY_SELECTOR_CSVSUBKEY, ENTITY_SELECTOR_DATAFILE]
    ENTITY_LIST_SELECTORS = [ENTITY_SELECTOR_CSVKMD, ENTITY_SELECTOR_CSVSUBKEY, ENTITY_SELECTOR_CSV, ENTITY_SELECTOR_CSVFILE, ENTITY_SELECTOR_FILE, ENTITY_SELECTOR_CSVDATA]
    BASE_ENTITY_SELECTORS = [ENTITY_SELECTOR_ALL, ENTITY_SELECTOR_CSVDATAFILE, ENTITY_SELECTOR_CSVKMD, ENTITY_SELECTOR_CSVSUBKEY, ENTITY_SELECTOR_DATAFILE]
    BROWSER_ENTITY_SELECTORS = [ENTITY_SELECTOR_CSV, ENTITY_SELECTOR_CSVFILE, ENTITY_SELECTOR_FILE]
    CROS_ENTITY_SELECTORS = [ENTITY_SELECTOR_CROSCSV, ENTITY_SELECTOR_CROSCSV_SN, ENTITY_SELECTOR_CROSCSVFILE, ENTITY_SELECTOR_CROSCSVFILE_SN, ENTITY_SELECTOR_CROSFILE, ENTITY_SELECTOR_CROSFILE_SN]
    USER_ENTITY_SELECTORS = [ENTITY_SELECTOR_CSV, ENTITY_SELECTOR_CSVFILE, ENTITY_SELECTOR_FILE]
    CROS_CSVDATA_ENTITY_SELECTORS = [ENTITY_SELECTOR_CROSCSVDATA]
    USER_CSVDATA_ENTITY_SELECTORS = [ENTITY_SELECTOR_CSVDATA]
    CROS_ENTITY_SELECTOR_ALL_SUBTYPES = [ENTITY_CROS]
    USER_ENTITY_SELECTOR_ALL_SUBTYPES = [ENTITY_USERS, ENTITY_USERS_NS, ENTITY_USERS_NS_SUSP, ENTITY_USERS_SUSP]
    ...
    ALL_USERS_QUERY_MAP = {ENTITY_ALL_USERS: 'isSuspended=False', ENTITY_ALL_USERS_NS: 'isSuspended=False', ENTITY_ALL_USERS_NS_SUSP: None, ENTITY_ALL_USERS_SUSP: 'isSuspended=True'}
    ENTITY_SELECTOR_ALL_SUBTYPES_MAP = {ENTITY_CROS: ENTITY_ALL_CROS, ENTITY_USERS: ENTITY_ALL_USERS, ENTITY_USERS_NS: ENTITY_ALL_USERS_NS, ENTITY_USERS_NS_SUSP: ENTITY_ALL_USERS_NS_SUSP, ENTITY_USERS_SUSP: ENTITY_ALL_USERS_SUSP}
    CROS_ENTITY_SELECTOR_DATAFILE_CSVKMD_SUBTYPES = [ENTITY_CROS, ENTITY_CROS_OUS, ENTITY_CROS_OUS_AND_CHILDREN, ENTITY_CROS_SN]
    USER_ENTITY_SELECTOR_DATAFILE_CSVKMD_SUBTYPES = [ENTITY_USERS, ENTITY_CIGROUPS, ENTITY_CIGROUP_USERS, ENTITY_DOMAINS, ENTITY_DOMAINS_NS, ENTITY_DOMAINS_SUSP, ENTITY_GROUPS, ENTITY_GROUPS_INDE, ENTITY_GROUPS_NS, ENTITY_GROUPS_SUSP, ENTITY_GROUP_USERS, ENTITY_GROUP_USERS_NS, ENTITY_GROUP_USERS_SUSP, ENTITY_GROUP_USERS_SELECT, ENTITY_OUS, ENTITY_OUS_NS, ENTITY_OUS_SUSP, ENTITY_OUS_AND_CHILDREN, ENTITY_OUS_AND_CHILDREN_NS, ENTITY_OUS_AND_CHILDREN_SUSP, ENTITY_COURSEPARTICIPANTS, ENTITY_STUDENTS, ENTITY_TEACHERS]
    EXECUTE_CMD = 'execute'
    GAM_CMD = 'gam'
    ...
    GAM_META_COMMANDS = [SELECT_CMD, SHOWSECTIONS_CMD, SELECTFILTER_CMD, SELECTOUTPUTFILTER_CMD, SELECTINPUTFILTER_CMD, CONFIG_CMD, MULTIPROCESSEXIT_CMD, REDIRECT_CMD]
    ARG_3LO = '3lo'
    ARG_ACL = 'acl'
    ARG_ACLS = 'acls'
    ...
    ARGUMENT_ERROR_NAMES = {ARGUMENT_BLANK: ['Blank arguments', 'Blank argument'], ARGUMENT_DEPRECATED: ['Deprecated arguments', 'Deprecated argument'], ARGUMENT_EMPTY: ['Empty arguments', 'Empty argument'], ARGUMENT_EXTRANEOUS: ['Extra arguments', 'Extra argument'], ARGUMENT_INVALID: ['Invalid arguments', 'Invalid argument'], ARGUMENT_INVALID_CHOICE: ['Invalid choices', 'Invalid choice ({0})'], ARGUMENT_MISSING: ['Missing arguments', 'Missing argument']}
