...
fail_list = [[-2 ** 255 - 3], [2 ** 256 + 3], ['set', '_poz'], [['set', 'var_1', 0, 0]], ['with', 'var_1', 0, ['set', 1, 1]], ['break'], ['continue'], ['invalidllelement']]
...
valid_list = [['pass'], ['assert', ['slt', ['mload', 0], 300]], ['assert', ['sgt', ['mload', 0], -1]], ['assert', ['gt', 1, ['mload', 0]]], ['assert', ['ge', ['mload', 0], 0]]]
