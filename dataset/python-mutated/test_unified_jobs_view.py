...
TEST_STDOUTS.append({'description': 'uri appears twice in a multiline plain text document', 'uri': uri, 'text': 'hello world %s \n\nyoyo\n\nhello\n%s' % (uri, uri), 'occurrences': 2})
...
def negative_test_cases(job_factory):
    ...
    for e in TEST_STDOUTS:
        ...
        ret.append(e)
    return ret
formats = [('json', 'application/json'), ('ansi', 'text/plain'), ('txt', 'text/plain'), ('html', 'text/html')]
