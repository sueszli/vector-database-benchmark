...
class StopPoll(TelegramMethod[Poll]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], message_id: int, reply_markup: Optional[InlineKeyboardMarkup]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(chat_id=chat_id, message_id=message_id, reply_markup=reply_markup, **__pydantic_kwargs)