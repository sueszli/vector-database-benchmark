...
from typing import Any, Callable, Dict, List, NamedTuple, Optional, Set, Tuple, TYPE_CHECKING, Union
...
if TYPE_CHECKING:
    from torch._C._dynamo.eval_frame import reset_code, set_eval_frame, set_guard_error_hook, skip_code, unsupported
else:
...
DONT_WRAP_FILES = {inspect.getsourcefile(GraphModule), join(dirname(dirname(__file__)), 'onnx/_internal/fx/dynamo_graph_extractor.py')}
