...
class BrainPOPBaseIE(InfoExtractor):
    ...
    _ORIGIN = ''
    _LOGIN_ERRORS = {1502: 'The username and password you entered did not match.', 1503: 'Payment method is expired.', 1506: 'Your BrainPOP plan has expired.', 1507: 'Terms not accepted.', 1508: 'Account not activated.', 1512: 'The maximum number of devices permitted are logged in with your account right now.', 1513: 'You are trying to access your account from outside of its allowed IP range.', 1514: 'Individual accounts are not included in your plan. Try again with your shared username and password.', 1515: 'Account not activated.', 1523: "That username and password won't work on this BrainPOP site.", 1524: "You'll need to join a class before you can login.", 1526: 'Your account is locked. Reset your password, or ask a teacher or administrator for help.'}
...
class BrainPOPIE(BrainPOPBaseIE):
    ...
    _TESTS = [{'url': 'https://www.brainpop.com/health/conflictresolution/martinlutherkingjr/movie?ref=null', 'md5': '3ead374233ae74c7f1b0029a01c972f0', 'info_dict': {'id': '1f3259fa457292b4', 'ext': 'mp4', 'title': 'Martin Luther King, Jr.', 'display_id': 'martinlutherkingjr', 'description': 'md5:f403dbb2bf3ccc7cf4c59d9e43e3c349'}}, {'url': 'https://www.brainpop.com/science/space/bigbang/', 'md5': '9a1ff0e77444dd9e437354eb669c87ec', 'info_dict': {'id': 'acae52cd48c99acf', 'ext': 'mp4', 'title': 'Big Bang', 'display_id': 'bigbang', 'description': 'md5:3e53b766b0f116f631b13f4cae185d38'}, 'skip': 'Requires login'}]
...
class BrainPOPJrIE(BrainPOPLegacyBaseIE):
    ...
    _TESTS = [{'url': 'https://jr.brainpop.com/health/feelingsandsel/emotions/', 'md5': '04e0561bb21770f305a0ce6cf0d869ab', 'info_dict': {'id': '347', 'ext': 'mp4', 'title': 'Emotions', 'display_id': 'emotions'}}, {'url': 'https://jr.brainpop.com/science/habitats/arctichabitats/', 'md5': 'b0ed063bbd1910df00220ee29340f5d6', 'info_dict': {'id': '29', 'ext': 'mp4', 'title': 'Arctic Habitats', 'display_id': 'arctichabitats'}, 'skip': 'Requires login'}]
...
class BrainPOPIlIE(BrainPOPLegacyBaseIE):
    ...
    _TESTS = [{'url': 'https://il.brainpop.com/category_9/subcategory_150/subjects_3782/', 'md5': '9e4ea9dc60ecd385a6e5ca12ccf31641', 'info_dict': {'id': '3782', 'ext': 'mp4', 'title': 'md5:e993632fcda0545d9205602ec314ad67', 'display_id': 'subjects_3782', 'description': 'md5:4cc084a8012beb01f037724423a4d4ed'}}]