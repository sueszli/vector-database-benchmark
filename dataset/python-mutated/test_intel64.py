...
@testing.backend.inject_backend_tests(None, [{}, {'use_cuda': True}, {'use_ideep': 'always'}, {'use_chainerx': True, 'chainerx_device': 'native:0'}])
@testing.backend.inject_backend_tests(None, [{'use_ideep': 'always'}])
