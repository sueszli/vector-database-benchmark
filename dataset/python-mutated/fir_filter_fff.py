...
def main():
    ...
    parser.add_argument('-B', '--bandwidth', type=eng_float, default=1000, help='Filter bandwidth [default=%(default)r]')
    ...
    put = example_fir_filter_fff(args.nsamples, args.samplerate, args.bandwidth, args.transition, args.attenuation, args.decimation)
    put.run()
