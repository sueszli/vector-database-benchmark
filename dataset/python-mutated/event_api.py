...
RunStatusChangeEventType: TypeAlias = Literal[DagsterEventType.RUN_START, DagsterEventType.RUN_SUCCESS, DagsterEventType.RUN_FAILURE, DagsterEventType.RUN_ENQUEUED, DagsterEventType.RUN_STARTING, DagsterEventType.RUN_CANCELING, DagsterEventType.RUN_CANCELED]
AssetEventType: TypeAlias = Literal[DagsterEventType.ASSET_MATERIALIZATION, DagsterEventType.ASSET_OBSERVATION, DagsterEventType.ASSET_MATERIALIZATION_PLANNED]
...
@whitelist_for_serdes
class EventRecordsFilter(NamedTuple('_EventRecordsFilter', [('event_type', DagsterEventType), ('asset_key', Optional[AssetKey]), ('asset_partitions', Optional[Sequence[str]]), ('after_cursor', Optional[EventCursor]), ('before_cursor', Optional[EventCursor]), ('after_timestamp', Optional[float]), ('before_timestamp', Optional[float]), ('storage_ids', Optional[Sequence[int]]), ('tags', Optional[Mapping[str, Union[str, Sequence[str]]]])])):
...
@whitelist_for_serdes
class AssetRecordsFilter(NamedTuple('_AssetRecordsFilter', [('asset_key', PublicAttr[AssetKey]), ('asset_partitions', PublicAttr[Optional[Sequence[str]]]), ('after_timestamp', PublicAttr[Optional[float]]), ('before_timestamp', PublicAttr[Optional[float]]), ('after_storage_id', PublicAttr[Optional[int]]), ('before_storage_id', PublicAttr[Optional[int]]), ('storage_ids', PublicAttr[Optional[Sequence[int]]]), ('tags', PublicAttr[Optional[Mapping[str, Union[str, Sequence[str]]]]])])):
