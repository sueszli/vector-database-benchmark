...
class EnableServiceResponse(proto.Message):
    ...
    """
    service: resources.Service = proto.Field(proto.MESSAGE, number=1, message=resources.Service)
...
class DisableServiceRequest(proto.Message):
    ...
    class CheckIfServiceHasUsage(proto.Enum):
        ...
        CHECK = 2
    name: str = proto.Field(proto.STRING, number=1)
    disable_dependent_services: bool = proto.Field(proto.BOOL, number=2)
    check_if_service_has_usage: CheckIfServiceHasUsage = proto.Field(proto.ENUM, number=3, enum=CheckIfServiceHasUsage)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    services: MutableSequence[resources.Service] = proto.RepeatedField(proto.MESSAGE, number=1, message=resources.Service)
...
class BatchEnableServicesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    service_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class BatchEnableServicesResponse(proto.Message):
    ...
    class EnableFailure(proto.Message):
        ...
        """
        service_id: str = proto.Field(proto.STRING, number=1)
        error_message: str = proto.Field(proto.STRING, number=2)
    services: MutableSequence[resources.Service] = proto.RepeatedField(proto.MESSAGE, number=1, message=resources.Service)
    failures: MutableSequence[EnableFailure] = proto.RepeatedField(proto.MESSAGE, number=2, message=EnableFailure)
