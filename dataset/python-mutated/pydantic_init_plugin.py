...
_base_encoders: dict[Any, Callable[[Any], Any]] = {pydantic_v1.EmailStr: str, pydantic_v1.NameEmail: str, pydantic_v1.ByteSize: lambda val: val.real}
if pydantic_v2 is not None:
    _base_encoders.update({pydantic_v2.EmailStr: str, pydantic_v2.NameEmail: str, pydantic_v2.ByteSize: lambda val: val.real})
