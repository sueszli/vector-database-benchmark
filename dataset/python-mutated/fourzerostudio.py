...
class FourZeroStudioArchiveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://0000.studio/mumeijiten/broadcasts/1290f433-fce0-4909-a24a-5f7df09665dc/archive', 'info_dict': {'id': '1290f433-fce0-4909-a24a-5f7df09665dc', 'title': 'noteで『canape』様へのファンレターを執筆します。（数秘術その2）', 'timestamp': 1653802534, 'release_timestamp': 1653796604, 'thumbnails': 'count:1', 'comments': 'count:7', 'uploader': '『中崎雄心』の執務室。', 'uploader_id': 'mumeijiten'}}]
...
class FourZeroStudioClipIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://0000.studio/soeji/archive-clip/e46b0278-24cd-40a8-92e1-b8fc2b21f34f', 'info_dict': {'id': 'e46b0278-24cd-40a8-92e1-b8fc2b21f34f', 'title': 'わたベーさんからイラスト差し入れいただきました。ありがとうございました！', 'timestamp': 1652109105, 'like_count': 1, 'uploader': 'ソエジマケイタ', 'uploader_id': 'soeji'}}]
