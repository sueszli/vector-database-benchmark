...
from awx.main.models import Job, JobEvent, AdHocCommand, AdHocCommandEvent, Project, ProjectUpdate, ProjectUpdateEvent, InventoryUpdate, InventorySource, InventoryUpdateEvent, SystemJob, SystemJobEvent
