...
class DaumClipIE(DaumBaseIE):
    ...
    _TESTS = [{'url': 'http://tvpot.daum.net/clip/ClipView.do?clipid=52554690', 'info_dict': {'id': '52554690', 'ext': 'mp4', 'title': 'DOTA 2GETHER 시즌2 6회 - 2부', 'description': 'DOTA 2GETHER 시즌2 6회 - 2부', 'upload_date': '20130831', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'duration': 3868, 'view_count': int, 'uploader': 'GOMeXP', 'uploader_id': 6667, 'timestamp': 1377911092}}, {'url': 'http://m.tvpot.daum.net/clip/ClipView.tv?clipid=54999425', 'only_matching': True}]
...
class DaumUserIE(DaumListIE):
    ...
    _TESTS = [{'url': 'http://tvpot.daum.net/mypot/View.do?ownerid=o2scDLIVbHc0', 'info_dict': {'id': 'o2scDLIVbHc0', 'title': '마이 리틀 텔레비전'}, 'playlist_mincount': 213}, {'url': 'http://tvpot.daum.net/mypot/View.do?ownerid=o2scDLIVbHc0&clipid=73801156', 'info_dict': {'id': '73801156', 'ext': 'mp4', 'title': "[미공개] 김구라, 오만석이 부릅니다 '오케피' - 마이 리틀 텔레비전 20160116", 'upload_date': '20160117', 'description': 'md5:5e91d2d6747f53575badd24bd62b9f36'}, 'params': {'noplaylist': True, 'skip_download': True}}, {'note': 'Playlist url has ownerid and playlistid, playlistid takes precedence', 'url': 'http://tvpot.daum.net/mypot/View.do?ownerid=o2scDLIVbHc0&playlistid=6196631', 'info_dict': {'id': '6196631', 'title': '마이 리틀 텔레비전 - 20160109'}, 'playlist_count': 11}, {'url': 'http://tvpot.daum.net/mypot/Top.do?ownerid=o2scDLIVbHc0', 'only_matching': True}, {'url': 'http://m.tvpot.daum.net/mypot/Top.tv?ownerid=45x1okb1If50&playlistid=3569733', 'only_matching': True}]
