...
VALID_SPECS = (({'arg': {'type': 'int'}}, {'arg': 42}, 42), ({'arg': {'type': 'int'}}, {'arg': 18765432109876543210}, 18765432109876543210), ({'arg': {'type': 'list', 'elements': 'int'}}, {'arg': [42, 32]}, [42, 32]), ({'arg': {'type': 'int'}}, {'arg': '42'}, 42), ({'arg': {'type': 'list', 'elements': 'int'}}, {'arg': ['42', '32']}, [42, 32]), ({'arg': {'type': 'float'}}, {'arg': 42.0}, 42.0), ({'arg': {'type': 'list', 'elements': 'float'}}, {'arg': [42.1, 32.2]}, [42.1, 32.2]), ({'arg': {'type': 'float'}}, {'arg': 42}, 42.0), ({'arg': {'type': 'list', 'elements': 'float'}}, {'arg': [42, 32]}, [42.0, 32.0]), ({'arg': {'type': 'float'}}, {'arg': '42.0'}, 42.0), ({'arg': {'type': 'list', 'elements': 'float'}}, {'arg': ['42.1', '32.2']}, [42.1, 32.2]), ({'arg': {'type': 'float'}}, {'arg': '42'}, 42.0), ({'arg': {'type': 'list', 'elements': 'float'}}, {'arg': ['42', '32.2']}, [42.0, 32.2]), ({'arg': {'type': 'bool'}}, {'arg': True}, True), ({'arg': {'type': 'list', 'elements': 'bool'}}, {'arg': [True, 'true', 1, 'yes', False, 'false', 'no', 0]}, [True, True, True, True, False, False, False, False]), ({'arg': {'type': 'bool'}}, {'arg': 'yes'}, True), ({'arg': {'type': 'str'}}, {'arg': 42}, '42'), ({'arg': {'type': 'list', 'elements': 'str'}}, {'arg': ['42', '32']}, ['42', '32']), ({'arg': {'type': 'str'}}, {'arg': 42}, '42'), ({'arg': {'type': 'list', 'elements': 'str'}}, {'arg': [42, 32]}, ['42', '32']), ({'arg': {'required': True}}, {'arg': 42}, '42'), ({'arg': {'type': 'int'}}, {'arg': 1, 'invalid': True, '_ansible_ignore_unknown_opts': True}, 1))
INVALID_SPECS = (({'arg': {'type': 'int'}}, {'arg': 'wolf'}, 'is of type {0} and we were unable to convert to int: {0} cannot be converted to an int'.format(type('bad'))), ({'arg': {'type': 'list', 'elements': 'int'}}, {'arg': [1, 'bad']}, 'is of type {0} and we were unable to convert to int: {0} cannot be converted to an int'.format(type('int'))), ({'arg': {'type': 'int'}}, {'arg': 42.1}, "'float'> cannot be converted to an int"), ({'arg': {'type': 'list', 'elements': 'int'}}, {'arg': [42.1, 32, 2]}, "'float'> cannot be converted to an int"), ({'arg': {'type': MOCK_VALIDATOR_FAIL}}, {'arg': 'bad'}, 'bad conversion'), ({'arg': {'type': 'list', 'elements': MOCK_VALIDATOR_FAIL}}, {'arg': [1, 'bad']}, 'bad conversion'), ({'arg': {'type': 'int'}}, {'other': 'bad', '_ansible_module_name': 'ansible_unittest'}, 'Unsupported parameters for (ansible_unittest) module: other. Supported parameters include: arg.'), ({'arg': {'type': 'int', 'aliases': ['argument']}}, {'other': 'bad', '_ansible_module_name': 'ansible_unittest'}, 'Unsupported parameters for (ansible_unittest) module: other. Supported parameters include: arg (argument).'), ({'arg': {'required': True}}, {}, 'missing required arguments: arg'))
BASIC_AUTH_VALID_ARGS = [{'api_username': 'user1', 'api_password': 'password1', 'api_url': 'http://example.com', 'validate_certs': False}, {'api_username': 'user1', 'api_password': 'password1', 'api_url': 'http://example.com', 'validate_certs': True}]
RATE_LIMIT_VALID_ARGS = [{'rate': 1, 'rate_limit': 1}, {'rate': '1', 'rate_limit': 1}, {'rate': 1, 'rate_limit': '1'}, {'rate': '1', 'rate_limit': '1'}]
RETRY_VALID_ARGS = [{'retries': 1, 'retry_pause': 1.5}, {'retries': '1', 'retry_pause': '1.5'}, {'retries': 1, 'retry_pause': '1.5'}, {'retries': '1', 'retry_pause': 1.5}]
...
class TestComplexOptions:
    ...
    OPTIONS_PARAMS_LIST = (({'foobar': [{'foo': 'hello', 'bam': 'good'}, {'foo': 'test', 'bar': 'good'}]}, [{'foo': 'hello', 'bam': 'good', 'bam2': 'test', 'bar': None, 'baz': None, 'bam1': None, 'bam3': None, 'bam4': None, 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}, {'foo': 'test', 'bam': None, 'bam2': 'test', 'bar': 'good', 'baz': None, 'bam1': None, 'bam3': None, 'bam4': None, 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}]), ({'foobar': [{'dup': 'test', 'bar': 'good'}]}, [{'foo': 'test', 'dup': 'test', 'bam': None, 'bam2': 'test', 'bar': 'good', 'baz': None, 'bam1': None, 'bam3': None, 'bam4': None, 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}]), ({'foobar': [{'foo': 'bam2', 'bar': 'required_one_of'}]}, [{'bam': None, 'bam1': None, 'bam2': 'test', 'bam3': None, 'bam4': None, 'bar': 'required_one_of', 'baz': None, 'foo': 'bam2', 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}]), ({'foobar': [{'foo': 'required', 'bam': 'good', 'bam3': 'yes'}]}, [{'bam': 'good', 'bam1': None, 'bam2': 'test', 'bam3': True, 'bam4': None, 'bar': None, 'baz': None, 'foo': 'required', 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}]), ({'foobar': [{'foo': 'required', 'bar': 'good', 'baz': 'good', 'bam4': 'required_by', 'bam1': 'ok', 'bam3': 'yes'}]}, [{'bar': 'good', 'baz': 'good', 'bam1': 'ok', 'bam2': 'test', 'bam3': True, 'bam4': 'required_by', 'bam': None, 'foo': 'required', 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}]), ({'foobar': [{'foo': 'good', 'bam': 'required_one_of', 'bar1': [1, 'good', 'yes'], 'bar2': ['1', 1], 'bar3': ['1.3', 1.3, 1]}]}, [{'foo': 'good', 'bam1': None, 'bam2': 'test', 'bam3': None, 'bam4': None, 'bar': None, 'baz': None, 'bam': 'required_one_of', 'bar1': ['1', 'good', 'yes'], 'bar2': [1, 1], 'bar3': [1.3, 1.3, 1.0], 'bar4': None}]))
    OPTIONS_PARAMS_DICT = (({'foobar': {'foo': 'hello', 'bam': 'good'}}, {'foo': 'hello', 'bam': 'good', 'bam2': 'test', 'bar': None, 'baz': None, 'bam1': None, 'bam3': None, 'bam4': None, 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}), ({'foobar': {'dup': 'test', 'bar': 'good'}}, {'foo': 'test', 'dup': 'test', 'bam': None, 'bam2': 'test', 'bar': 'good', 'baz': None, 'bam1': None, 'bam3': None, 'bam4': None, 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}), ({'foobar': {'foo': 'bam2', 'bar': 'required_one_of'}}, {'bam': None, 'bam1': None, 'bam2': 'test', 'bam3': None, 'bam4': None, 'bar': 'required_one_of', 'baz': None, 'foo': 'bam2', 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}), ({'foobar': {'foo': 'required', 'bam': 'good', 'bam3': 'yes'}}, {'bam': 'good', 'bam1': None, 'bam2': 'test', 'bam3': True, 'bam4': None, 'bar': None, 'baz': None, 'foo': 'required', 'bar1': None, 'bar2': None, 'bar3': None, 'bar4': None}), ({'foobar': {'foo': 'required', 'bar': 'good', 'baz': 'good', 'bam4': 'required_by', 'bam1': 'ok', 'bam3': 'yes'}}, {'bar': 'good', 'baz': 'good', 'bam1': 'ok', 'bam2': 'test', 'bam3': True, 'bam4': 'required_by', 'bam': None, 'foo': 'required', 'bar1': None, 'bar3': None, 'bar2': None, 'bar4': None}), ({'foobar': {'foo': 'good', 'bam': 'required_one_of', 'bar1': [1, 'good', 'yes'], 'bar2': ['1', 1], 'bar3': ['1.3', 1.3, 1]}}, {'foo': 'good', 'bam1': None, 'bam2': 'test', 'bam3': None, 'bam4': None, 'bar': None, 'baz': None, 'bam': 'required_one_of', 'bar1': ['1', 'good', 'yes'], 'bar2': [1, 1], 'bar3': [1.3, 1.3, 1.0], 'bar4': None}))
    FAILING_PARAMS_LIST = (({'foobar': [{}]}, 'missing required arguments: foo found in foobar'), ({'foobar': [{'foo': 'hello', 'bam': 'good', 'invalid': 'bad'}]}, 'module: foobar.invalid. Supported parameters include'), ({'foobar': [{'foo': 'test', 'bam': 'bad', 'bam1': 'bad', 'baz': 'req_to'}]}, 'parameters are mutually exclusive: bam|bam1 found in foobar'), ({'foobar': [{'foo': 'hello', 'bar': 'bad'}]}, 'foo is hello but all of the following are missing: bam found in foobar'), ({'foobar': [{'foo': 'test'}]}, 'one of the following is required: bar, bam found in foobar'), ({'foobar': [{'foo': 'test', 'bar': 'required_one_of', 'bam1': 'bad'}]}, 'parameters are required together: bam1, baz found in foobar'), ({'foobar': [{'foo': 'test', 'bar': 'required_one_of', 'bam4': 'required_by'}]}, "missing parameter(s) required by 'bam4': bam1, bam3"))
    FAILING_PARAMS_DICT = (({'foobar': {}}, 'missing required arguments: foo found in foobar'), ({'foobar': {'foo': 'hello', 'bam': 'good', 'invalid': 'bad'}}, 'module: foobar.invalid. Supported parameters include'), ({'foobar': {'foo': 'test', 'bam': 'bad', 'bam1': 'bad', 'baz': 'req_to'}}, 'parameters are mutually exclusive: bam|bam1 found in foobar'), ({'foobar': {'foo': 'hello', 'bar': 'bad'}}, 'foo is hello but all of the following are missing: bam found in foobar'), ({'foobar': {'foo': 'test'}}, 'one of the following is required: bar, bam found in foobar'), ({'foobar': {'foo': 'test', 'bar': 'required_one_of', 'bam1': 'bad'}}, 'parameters are required together: bam1, baz found in foobar'), ({'foobar': {'foo': 'test', 'bar': 'required_one_of', 'bam4': 'required_by'}}, "missing parameter(s) required by 'bam4': bam1, bam3"))
