...
if TYPE_CHECKING:
    ...
    from xarray.namedarray._typing import _AttrsLike, _DimsLike, _DType, _Shape, duckarray
...
class CustomArrayIndexable(CustomArrayBase[_ShapeType_co, _DType_co], ExplicitlyIndexed, Generic[_ShapeType_co, _DType_co]):
