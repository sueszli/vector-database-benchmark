"""Generates SavedModel test data for Merger.
...
VALID_SAVED_MODEL_TYPES = {'split-standard': split_standard}
...
SAVED_MODEL_TYPES = flags.DEFINE_multi_string('saved_model_type', 'all', help=f'Type(s) of saved model to export. Valid types: all, {ALL_SAVED_MODEL_TYPES}')
