...
if is_torch_available():
    ...
    from transformers import FlavaForPreTraining, FlavaImageCodebook, FlavaImageModel, FlavaModel, FlavaMultimodalModel, FlavaTextModel
    from transformers.models.flava.modeling_flava import FLAVA_CODEBOOK_PRETRAINED_MODEL_ARCHIVE_LIST, FLAVA_PRETRAINED_MODEL_ARCHIVE_LIST
else:
    FlavaModel = None
