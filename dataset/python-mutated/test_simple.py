...
from ...common.db.packaging import FileFactory, JournalEntryFactory, ProjectFactory, ReleaseFactory
...
CONTENT_TYPE_PARAMS = [('text/html', None), ('application/vnd.pypi.simple.v1+html', None), ('application/vnd.pypi.simple.v1+json', 'json')]
