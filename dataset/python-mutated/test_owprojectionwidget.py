...
import numpy as np
from Orange.data import Table, ContinuousVariable, DiscreteVariable, StringVariable, Domain
from Orange.widgets.tests.base import WidgetTest, WidgetOutputsTestMixin, ProjectionWidgetTestMixin
from Orange.widgets.utils.colorpalettes import ContinuousPalettes, DiscretePalette
from Orange.widgets.visualize.utils.widget import OWDataProjectionWidget, OWProjectionWidgetBase
...
class TestOWDataProjectionWidget(WidgetTest, ProjectionWidgetTestMixin, WidgetOutputsTestMixin):
