...
class automlCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'batch_predict': ('name', 'input_config', 'output_config', 'params'), 'create_dataset': ('parent', 'dataset'), 'create_model': ('parent', 'model'), 'delete_dataset': ('name',), 'delete_model': ('name',), 'deploy_model': ('name', 'image_object_detection_model_deployment_metadata', 'image_classification_model_deployment_metadata'), 'export_data': ('name', 'output_config'), 'export_model': ('name', 'output_config'), 'get_annotation_spec': ('name',), 'get_dataset': ('name',), 'get_model': ('name',), 'get_model_evaluation': ('name',), 'import_data': ('name', 'input_config'), 'list_datasets': ('parent', 'filter', 'page_size', 'page_token'), 'list_model_evaluations': ('parent', 'filter', 'page_size', 'page_token'), 'list_models': ('parent', 'filter', 'page_size', 'page_token'), 'predict': ('name', 'payload', 'params'), 'undeploy_model': ('name',), 'update_dataset': ('dataset', 'update_mask'), 'update_model': ('model', 'update_mask')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=automlCallTransformer()):
    if False:
        while True:
            i = 10
