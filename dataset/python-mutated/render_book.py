...
from calibre.ebooks.oeb.base import EPUB, OEB_DOCS, OEB_STYLES, OPF, SMIL, XHTML, XHTML_NS, XLINK, XPath as _XPath, rewrite_links, urlunquote
...
from polyglot.binary import as_base64_unicode as encode_component, from_base64_bytes, from_base64_unicode as decode_component
