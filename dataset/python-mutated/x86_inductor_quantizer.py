...
from torch.ao.quantization.observer import HistogramObserver, MovingAveragePerChannelMinMaxObserver, PerChannelMinMaxObserver, PlaceholderObserver
from torch.ao.quantization.pt2e.graph_utils import find_sequential_partitions
from torch.ao.quantization.qconfig import _ObserverOrFakeQuantizeConstructor
from torch.ao.quantization.quantizer.quantizer import QuantizationAnnotation, QuantizationSpec, Quantizer, SharedQuantizationSpec
from torch.ao.quantization.quantizer.xnnpack_quantizer_utils import _is_annotated, get_bias_qspec, get_input_act_qspec, get_output_act_qspec, get_weight_qspec, OperatorConfig, OperatorPatternType, QuantizationConfig
from torch.fx import Node
from torch.fx.passes.utils.source_matcher_utils import get_source_partitions, SourcePartition
__all__ = ['X86InductorQuantizer', 'get_default_x86_inductor_quantization_config']

@dataclass
class _X86InductorQuantizationAnnotation(QuantizationAnnotation):
    _is_output_of_quantized_pattern: bool = False
quantizable_ops_pt2e: Set = {torch.ops.aten.max_pool2d.default, torch.ops.aten.cat.default, torch.ops.aten.avg_pool2d.default}
int8_in_int8_out_ops_pt2e: Set = {torch.ops.aten.max_pool2d.default, torch.ops.aten.cat.default, torch.ops.aten.avg_pool2d.default}
