...
RECIPIENT_STREAM = 2
SETTINGS_MAP = {'desktop_notifications': 'enable_stream_desktop_notifications', 'audible_notifications': 'enable_stream_sounds', 'push_notifications': 'enable_stream_push_notifications', 'email_notifications': 'enable_stream_email_notifications'}
...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0220_subscription_notification_settings')]
    operations = [migrations.RunPython(update_notification_settings, reverse_notification_settings, elidable=True)]