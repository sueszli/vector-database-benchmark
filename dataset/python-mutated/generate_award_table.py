...
AWARD_TYPES = {'a': lambda _: True, 'g': lambda award: award['award']['awardType'] == 'GLOBAL', 's': lambda award: award['award']['awardType'] == 'SUBREDDIT', 'm': lambda award: award['award']['awardType'] == 'MODERATOR'}
