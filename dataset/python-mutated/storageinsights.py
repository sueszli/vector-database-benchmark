...
class UpdateReportConfigRequest(proto.Message):
    ...
    report_config: 'ReportConfig' = proto.Field(proto.MESSAGE, number=2, message='ReportConfig')
...
class ReportDetail(proto.Message):
    """Message describing ReportDetail object. ReportDetail
    ...
    class Metrics(proto.Message):
        ...
        Attributes:
            processed_records_count (int):
                ...
                of the report.
        """
        processed_records_count: int = proto.Field(proto.INT64, number=1)
    name: str = proto.Field(proto.STRING, number=1)
    snapshot_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    report_path_prefix: str = proto.Field(proto.STRING, number=8)
    shards_count: int = proto.Field(proto.INT64, number=9)
    status: status_pb2.Status = proto.Field(proto.MESSAGE, number=4, message=status_pb2.Status)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    target_datetime: datetime_pb2.DateTime = proto.Field(proto.MESSAGE, number=6, message=datetime_pb2.DateTime)
    report_metrics: Metrics = proto.Field(proto.MESSAGE, number=7, message=Metrics)
...
class ListReportDetailsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    report_details: MutableSequence['ReportDetail'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReportDetail')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class FrequencyOptions(proto.Message):
    ...
    class Frequency(proto.Enum):
        """This ENUM specifies possible frequencies of report
        generation.
        ...
        DAILY = 1
        WEEKLY = 2
    frequency: Frequency = proto.Field(proto.ENUM, number=1, enum=Frequency)
    start_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=2, message=date_pb2.Date)
    end_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=3, message=date_pb2.Date)
...
class CSVOptions(proto.Message):
    ...
    Attributes:
        ...
        header_required (bool):
            ...
            report.
    """
    record_separator: str = proto.Field(proto.STRING, number=1)
    delimiter: str = proto.Field(proto.STRING, number=2)
    header_required: bool = proto.Field(proto.BOOL, number=3)
...
class CloudStorageDestinationOptions(proto.Message):
    ...
    """
    bucket: str = proto.Field(proto.STRING, number=1)
    destination_path: str = proto.Field(proto.STRING, number=2)
...
class ObjectMetadataReportOptions(proto.Message):
    ...
    """
    metadata_fields: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    storage_filters: 'CloudStorageFilters' = proto.Field(proto.MESSAGE, number=2, oneof='filter', message='CloudStorageFilters')
    storage_destination_options: 'CloudStorageDestinationOptions' = proto.Field(proto.MESSAGE, number=3, oneof='destination_options', message='CloudStorageDestinationOptions')
...
class ReportConfig(proto.Message):
    ...
    frequency_options: 'FrequencyOptions' = proto.Field(proto.MESSAGE, number=5, message='FrequencyOptions')
    csv_options: 'CSVOptions' = proto.Field(proto.MESSAGE, number=6, oneof='report_format', message='CSVOptions')
    parquet_options: 'ParquetOptions' = proto.Field(proto.MESSAGE, number=7, oneof='report_format', message='ParquetOptions')
    object_metadata_report_options: 'ObjectMetadataReportOptions' = proto.Field(proto.MESSAGE, number=8, oneof='report_kind', message='ObjectMetadataReportOptions')
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=10)
    display_name: str = proto.Field(proto.STRING, number=11)
