...
CHAR_OBJECTIVES = [{}, {'@architectures': 'spacy.PretrainCharacters.v1'}, {'@architectures': 'spacy.PretrainCharacters.v1', 'maxout_pieces': 5, 'hidden_size': 42, 'n_characters': 2}]
VECTOR_OBJECTIVES = [{'@architectures': 'spacy.PretrainVectors.v1', 'maxout_pieces': 3, 'hidden_size': 300, 'loss': 'cosine'}, {'@architectures': 'spacy.PretrainVectors.v1', 'maxout_pieces': 2, 'hidden_size': 200, 'loss': 'L2'}]
