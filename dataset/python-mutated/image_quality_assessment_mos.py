...
from modelscope.models.cv.image_quality_assessment_mos.censeo_ivqa_model import CenseoIVQAModel
...
@MODELS.register_module(Tasks.image_quality_assessment_mos, module_name=Models.image_quality_assessment_mos)
