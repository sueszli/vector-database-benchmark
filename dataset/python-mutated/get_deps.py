...
YamlLoader.add_multi_constructor('tag:yaml.org,2002:python/name:', lambda loader, suffix, node: None)
YamlLoader.add_multi_constructor('tag:yaml.org,2002:python/object/apply:', lambda loader, suffix, node: None)
NotFound = ()
