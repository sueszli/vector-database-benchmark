...
@pytest.mark.asyncio
@pytest.mark.parametrize('tutorialbar_course_page_link,tutorialbar_links,udemy_links', [('https://www.tutorialbar.com/all-courses/page/1/', ['https://www.tutorialbar.com/course_1', 'https://www.tutorialbar.com/course_2'], ['https://www.udemy.com/1?FREECOURSE', 'https://www.udemy.com/2?FREECOURSE']), ('https://www.tutorialbar.com/all-courses/page/1/', [], [])], ids=('List of courses', 'Empty courses'))
@mock.patch.object(TutorialBarScraper, 'gather_udemy_course_links')
@mock.patch.object(TutorialBarScraper, 'get_course_links')
async def test_run(mock_get_course_links, mock_gather_udemy_course_links, tutorialbar_course_page_link, tutorialbar_links, udemy_links):
