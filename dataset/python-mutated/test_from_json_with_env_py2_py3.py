...
def test_default_values(config, json_config_file_3):
    if False:
        while True:
            i = 10
    with open(json_config_file_3, 'w') as file:
        file.write(json.dumps({'section': {'defined_with_default': '${DEFINED:default}', 'undefined_with_default': '${UNDEFINED:default}', 'complex': '${DEFINED}/path/${DEFINED:default}/${UNDEFINED}/${UNDEFINED:default}'}}))
    config.from_json(json_config_file_3)
