...
class TestAESModeGCM:
    test_gcm = generate_aead_test(load_nist_vectors, os.path.join('ciphers', 'AES', 'GCM'), ['gcmDecrypt128.rsp', 'gcmDecrypt192.rsp', 'gcmDecrypt256.rsp', 'gcmEncryptExtIV128.rsp', 'gcmEncryptExtIV192.rsp', 'gcmEncryptExtIV256.rsp'], algorithms.AES, modes.GCM)
