...
from Orange.widgets.visualize.utils import CanvasText, CanvasRectangle, ViewWithPress, VizRankDialogAttrPair
...
class OWSieveDiagram(OWWidget):
    name = 'Sieve Diagram'
    description = 'Visualize the observed and expected frequencies for a combination of values.'
