...
def main():
    ...
    response = client.configurations.get_node(resource_group_name='TestResourceGroup', cluster_name='testcluster', configuration_name='array_nulls')
    print(response)
