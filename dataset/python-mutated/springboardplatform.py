...
from ..utils import ExtractorError, int_or_none, xpath_attr, xpath_text, xpath_element, unescapeHTML, unified_timestamp
...
class SpringboardPlatformIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe\\b[^>]+\\bsrc=(["\\\'])(?P<url>(?:https?:)?//cms\\.springboardplatform\\.com/embed_iframe/\\d+/video/\\d+.*?)\\1']
    _TESTS = [{'url': 'http://cms.springboardplatform.com/previews/159/video/981017/0/0/1', 'md5': '5c3cb7b5c55740d482561099e920f192', 'info_dict': {'id': '981017', 'ext': 'mp4', 'title': 'Redman "BUD like YOU" "Usher Good Kisser" REMIX', 'description': 'Redman "BUD like YOU" "Usher Good Kisser" REMIX', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1409132328, 'upload_date': '20140827', 'duration': 193}}, {'url': 'http://cms.springboardplatform.com/embed_iframe/159/video/981017/rab007/rapbasement.com/1/1', 'only_matching': True}, {'url': 'http://cms.springboardplatform.com/embed_iframe/20/video/1731611/ki055/kidzworld.com/10', 'only_matching': True}, {'url': 'http://cms.springboardplatform.com/xml_feeds_advanced/index/159/rss3/981017/0/0/1/', 'only_matching': True}]
