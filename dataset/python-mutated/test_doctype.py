...
from frappe.core.doctype.doctype.doctype import CannotIndexedError, DoctypeLinkError, HiddenAndMandatoryWithoutDefaultError, IllegalMandatoryError, InvalidFieldNameError, UniqueFieldnameError, WrongOptionsDoctypeLinkError, validate_links_table_fieldnames
