...
from torch.distributed._tensor.op_schema import DTensorSpec, OpSchema, OutputSharding, OutputSpecType, PlacementStrategy
from torch.distributed._tensor.placement_types import Placement, Replicate, Shard, TensorMeta
