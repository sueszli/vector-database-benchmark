...
from typing import Dict, Iterable, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Type, Union, cast
import pendulum
import dagster._check as check
from dagster._annotations import public
from dagster._core.errors import DagsterInvalidDefinitionError, DagsterInvalidInvocationError, DagsterUnknownPartitionError
from dagster._core.instance import DynamicPartitionsStore
from dagster._core.storage.tags import MULTIDIMENSIONAL_PARTITION_PREFIX, get_multidimensional_partition_tag
from .partition import DefaultPartitionsSubset, DynamicPartitionsDefinition, PartitionsDefinition, PartitionsSubset, StaticPartitionsDefinition
...
class PartitionDimensionKey(NamedTuple('_PartitionDimensionKey', [('dimension_name', str), ('partition_key', str)])):
...
class PartitionDimensionDefinition(NamedTuple('_PartitionDimensionDefinition', [('name', str), ('partitions_def', PartitionsDefinition)])):
...
ALLOWED_PARTITION_DIMENSION_TYPES = (StaticPartitionsDefinition, TimeWindowPartitionsDefinition, DynamicPartitionsDefinition)
