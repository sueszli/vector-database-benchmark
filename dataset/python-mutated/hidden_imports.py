...
SAM_CLI_HIDDEN_IMPORTS = list(samcli_modules) + ['cookiecutter.extensions', 'text_unidecode', 'samtranslator', 'pkg_resources.py2_warn', 'aws_lambda_builders.workflows', 'configparser', 'dateparser', 'jsonschema', 'cfnlint', 'networkx.generators']