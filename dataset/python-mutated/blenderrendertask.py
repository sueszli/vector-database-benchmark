...
from apps.blender.blenderenvironment import BlenderEnvironment, BlenderNVGPUEnvironment
...
class BlenderRenderTask(FrameRenderingTask):
    ...
    VERIFIER_CLASS = functools.partial(BlenderVerifier, docker_task_cls=DockerTaskThread)
    BLENDER_MIN_BOX = [8, 8]
