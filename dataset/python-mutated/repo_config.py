...
import yaml
from pydantic import BaseModel, Field, StrictInt, StrictStr, ValidationError, root_validator, validator
from pydantic.error_wrappers import ErrorWrapper
from pydantic.typing import Dict, Optional
from feast.errors import FeastFeatureServerTypeInvalidError, FeastFeatureServerTypeSetError, FeastOfflineStoreInvalidName, FeastOnlineStoreInvalidName, FeastProviderNotSetError, FeastRegistryNotSetError, FeastRegistryTypeInvalidError
from feast.importer import import_class
from feast.usage import log_exceptions
warnings.simplefilter('once', RuntimeWarning)
_logger = logging.getLogger(__name__)
REGISTRY_CLASS_FOR_TYPE = {'file': 'feast.infra.registry.registry.Registry', 'sql': 'feast.infra.registry.sql.SqlRegistry', 'snowflake.registry': 'feast.infra.registry.snowflake.SnowflakeRegistry'}
BATCH_ENGINE_CLASS_FOR_TYPE = {'local': 'feast.infra.materialization.local_engine.LocalMaterializationEngine', 'snowflake.engine': 'feast.infra.materialization.snowflake_engine.SnowflakeMaterializationEngine', 'lambda': 'feast.infra.materialization.aws_lambda.lambda_engine.LambdaMaterializationEngine', 'bytewax': 'feast.infra.materialization.contrib.bytewax.bytewax_materialization_engine.BytewaxMaterializationEngine', 'spark.engine': 'feast.infra.materialization.contrib.spark.spark_materialization_engine.SparkMaterializationEngine'}
ONLINE_STORE_CLASS_FOR_TYPE = {'sqlite': 'feast.infra.online_stores.sqlite.SqliteOnlineStore', 'datastore': 'feast.infra.online_stores.datastore.DatastoreOnlineStore', 'redis': 'feast.infra.online_stores.redis.RedisOnlineStore', 'dynamodb': 'feast.infra.online_stores.dynamodb.DynamoDBOnlineStore', 'snowflake.online': 'feast.infra.online_stores.snowflake.SnowflakeOnlineStore', 'bigtable': 'feast.infra.online_stores.bigtable.BigtableOnlineStore', 'postgres': 'feast.infra.online_stores.contrib.postgres.PostgreSQLOnlineStore', 'hbase': 'feast.infra.online_stores.contrib.hbase_online_store.hbase.HbaseOnlineStore', 'cassandra': 'feast.infra.online_stores.contrib.cassandra_online_store.cassandra_online_store.CassandraOnlineStore', 'mysql': 'feast.infra.online_stores.contrib.mysql_online_store.mysql.MySQLOnlineStore', 'rockset': 'feast.infra.online_stores.contrib.rockset_online_store.rockset.RocksetOnlineStore', 'hazelcast': 'feast.infra.online_stores.contrib.hazelcast_online_store.hazelcast_online_store.HazelcastOnlineStore'}
OFFLINE_STORE_CLASS_FOR_TYPE = {'file': 'feast.infra.offline_stores.file.FileOfflineStore', 'bigquery': 'feast.infra.offline_stores.bigquery.BigQueryOfflineStore', 'redshift': 'feast.infra.offline_stores.redshift.RedshiftOfflineStore', 'snowflake.offline': 'feast.infra.offline_stores.snowflake.SnowflakeOfflineStore', 'spark': 'feast.infra.offline_stores.contrib.spark_offline_store.spark.SparkOfflineStore', 'trino': 'feast.infra.offline_stores.contrib.trino_offline_store.trino.TrinoOfflineStore', 'postgres': 'feast.infra.offline_stores.contrib.postgres_offline_store.postgres.PostgreSQLOfflineStore', 'athena': 'feast.infra.offline_stores.contrib.athena_offline_store.athena.AthenaOfflineStore', 'mssql': 'feast.infra.offline_stores.contrib.mssql_offline_store.mssql.MsSqlServerOfflineStore'}
FEATURE_SERVER_CONFIG_CLASS_FOR_TYPE = {'aws_lambda': 'feast.infra.feature_servers.aws_lambda.config.AwsLambdaFeatureServerConfig', 'gcp_cloudrun': 'feast.infra.feature_servers.gcp_cloudrun.config.GcpCloudRunFeatureServerConfig', 'local': 'feast.infra.feature_servers.local_process.config.LocalFeatureServerConfig'}
FEATURE_SERVER_TYPE_FOR_PROVIDER = {'aws': 'aws_lambda', 'gcp': 'gcp_cloudrun', 'local': 'local'}
