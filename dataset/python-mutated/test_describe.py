...
testdata = [(pd.Series([1, 2]), {'is_unique': True, 'p_distinct': 1, 'p_unique': 1}), (pd.Series([np.nan]), {'is_unique': None, 'p_distinct': None, 'p_unique': None}), (pd.Series([1, 2, np.nan]), {'is_unique': True, 'p_distinct': 1, 'p_unique': 1}), (pd.Series([1, 2, 2]), {'is_unique': False, 'p_distinct': 2 / 3, 'p_unique': 1 / 3}), (pd.Series([1, np.nan, np.nan]), {'is_unique': True, 'p_distinct': 1, 'p_unique': 1}), (pd.Series([1, 2, 2, np.nan]), {'is_unique': False, 'p_distinct': 2 / 3, 'p_unique': 1 / 3}), (pd.Series([1, 2, 2, np.nan, np.nan]), {'is_unique': False, 'p_distinct': 2 / 3, 'p_unique': 1 / 3})]
