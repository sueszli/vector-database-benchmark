...
if is_flax_available():
    ...
    from transformers.models.distilbert.modeling_flax_distilbert import FlaxDistilBertForMaskedLM, FlaxDistilBertForMultipleChoice, FlaxDistilBertForQuestionAnswering, FlaxDistilBertForSequenceClassification, FlaxDistilBertForTokenClassification, FlaxDistilBertModel
...
class FlaxDistilBertModelTest(FlaxModelTesterMixin, unittest.TestCase):
    all_model_classes = (FlaxDistilBertModel, FlaxDistilBertForMaskedLM, FlaxDistilBertForMultipleChoice, FlaxDistilBertForQuestionAnswering, FlaxDistilBertForSequenceClassification, FlaxDistilBertForTokenClassification, FlaxDistilBertForQuestionAnswering) if is_flax_available() else ()
...
class FlaxDistilBertModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_no_head_absolute_embedding(self):
        ...
        expected_slice = np.array([[[-0.1639, 0.3299, 0.1648], [-0.1746, 0.3289, 0.171], [-0.1884, 0.3357, 0.181]]])
