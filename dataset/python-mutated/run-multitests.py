...
if os.name == 'nt':
    ...
    MICROPYTHON = os.getenv('MICROPY_MICROPYTHON', test_dir + '/../ports/windows/build-standard/micropython.exe')
else:
    CPYTHON3 = os.getenv('MICROPY_CPYTHON3', 'python3')
    MICROPYTHON = os.getenv('MICROPY_MICROPYTHON', test_dir + '/../ports/unix/build-standard/micropython')
...
IGNORE_OUTPUT_MATCHES = ('libusb: error ', 'hci_transport_h2_libusb.c', 'USB Path: ', 'hci_number_completed_packet', 'lld_pdu_get_tx_flush_nb HCI packet count mismatch (')
