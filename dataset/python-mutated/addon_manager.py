...
from .handler import HassioAPIError, async_create_backup, async_get_addon_discovery_info, async_get_addon_info, async_get_addon_store_info, async_install_addon, async_restart_addon, async_set_addon_options, async_start_addon, async_stop_addon, async_uninstall_addon, async_update_addon
...
class AddonManager:
    ...
    async def async_get_addon_discovery_info(self) -> dict:
        ...
        discovery_info = await async_get_addon_discovery_info(self._hass, self.addon_slug)
    ...
    async def async_get_addon_info(self) -> AddonInfo:
        ...
        if not addon_store_info['installed']:
            return AddonInfo(available=addon_store_info['available'], hostname=None, options={}, state=AddonState.NOT_INSTALLED, update_available=False, version=None)
        addon_info = await async_get_addon_info(self._hass, self.addon_slug)
        addon_state = self.async_get_addon_state(addon_info)
        return AddonInfo(available=addon_info['available'], hostname=addon_info['hostname'], options=addon_info['options'], state=addon_state, update_available=addon_info['update_available'], version=addon_info['version'])
    ...
    async def async_create_backup(self) -> None:
        ...
        await async_create_backup(self._hass, {'name': name, 'addons': [self.addon_slug]}, partial=True)
