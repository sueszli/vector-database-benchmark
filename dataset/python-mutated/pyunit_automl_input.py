...
def test_frames_can_be_passed_as_key():
    ...
    for kwargs in kw_args:
        ...
        h2o.remove(aml)
pu.run_tests([test_invalid_project_name, test_no_x_train_set_only, test_no_x_train_and_validation_sets, test_no_x_train_and_test_sets, test_no_x_train_and_validation_and_test_sets, test_no_x_y_as_idx_train_and_validation_and_test_sets, test_frames_can_be_passed_as_key])