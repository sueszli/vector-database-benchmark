...
from .ChildrenHavingMixins import ChildrenHavingConditionExpressionYesExpressionNoMixin, ChildrenHavingLeftRightMixin
from .ExpressionBases import ExpressionBase
from .NodeMakingHelpers import makeConstantReplacementNode, makeStatementExpressionOnlyReplacementNode, wrapExpressionWithNodeSideEffects, wrapExpressionWithSideEffects, wrapStatementWithSideEffects
...
class ExpressionConditional(ConditionalValueComputeMixin, ChildrenHavingConditionExpressionYesExpressionNoMixin, ExpressionBase):
...
class StatementConditional(ConditionalValueComputeMixin, StatementConditionalBase):
    ...
    named_children = ('condition', 'yes_branch|statements_or_none+setter', 'no_branch|statements_or_none+setter')
    checkers = {'yes_branch': checkStatementsSequenceOrNone, 'no_branch': checkStatementsSequenceOrNone}
