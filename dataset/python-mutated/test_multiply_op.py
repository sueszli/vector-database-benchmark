...
class TestElementwiseMulOpBase(TestCaseHelper):
    inputs = [{'x_shape': [1], 'y_shape': [1], 'axis': 0}, {'x_shape': [1024], 'y_shape': [1024], 'axis': 0}, {'x_shape': [512, 256], 'y_shape': [512, 256], 'axis': 0}, {'x_shape': [128, 64, 32], 'y_shape': [128, 64, 32], 'axis': 0}, {'x_shape': [16, 8, 4, 2], 'y_shape': [16, 8, 4, 2], 'axis': 0}, {'x_shape': [16, 8, 4, 2, 1], 'y_shape': [16, 8, 4, 2, 1], 'axis': 0}]
