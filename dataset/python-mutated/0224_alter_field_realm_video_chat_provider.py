...
VIDEO_CHAT_PROVIDERS = {'jitsi_meet': {'name': 'Jitsi', 'id': 1}, 'google_hangouts': {'name': 'Google Hangouts', 'id': 2}, 'zoom': {'name': 'Zoom', 'id': 3}}
...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [('zerver', '0223_rename_to_is_muted')]
    operations = [migrations.RenameField(model_name='realm', old_name='video_chat_provider', new_name='video_chat_provider_old'), migrations.AddField(model_name='realm', name='video_chat_provider', field=models.PositiveSmallIntegerField(default=VIDEO_CHAT_PROVIDERS['jitsi_meet']['id'])), migrations.RunPython(update_existing_video_chat_provider_values, reverse_code=reverse_code, elidable=True), migrations.RemoveField(model_name='realm', name='video_chat_provider_old')]