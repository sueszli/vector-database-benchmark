...
class TutorialBarScraper(BaseScraper):
    ...
    async def get_links(self):
        ...
        """
        self.current_page += 1
        course_links = await self.get_course_links(f'{self.DOMAIN}/all-courses/page/{self.current_page}/')
        logger.info(f'Page: {self.current_page} of {self.last_page} scraped from tutorialbar.com')
