...
class PipelineExecutor:
    ...
    async def __run_blocks(self, pipeline_run: PipelineRun, allow_blocks_to_fail: bool=False, global_vars: Dict=None):
        """
        ...
        while not pipeline_run.all_blocks_completed(allow_blocks_to_fail):
            executable_block_runs = pipeline_run.executable_block_runs(allow_blocks_to_fail=allow_blocks_to_fail)
