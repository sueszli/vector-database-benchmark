...
class MenuItemUpdate(MenuItemCreate):
    ...
    class Arguments:
        ...
        input = MenuItemInput(required=True, description='Fields required to update a menu item. Only one of `url`, `category`, `page`, `collection` is allowed per item.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.MENU_ITEM_UPDATED, description='A menu item was updated.')]
