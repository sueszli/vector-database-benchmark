...
MACROS = ['WIN32', '_WIN32', '_WINDOWS', ('NTDDI_VERSION', '0x06010000'), ('WINVER', '0x0601'), ('_WIN32_WINNT', '0x0601'), 'NDEBUG', '_NDEBUG', '_CRT_SECURE_NO_WARNINGS']
cefpython_app_MACROS = MACROS + ['BROWSER_PROCESS']
subprocess_MACROS = MACROS + ['RENDERER_PROCESS', 'UNICODE', '_UNICODE', 'NOMINMAX', 'WIN32_LEAN_AND_MEAN', ('_HAS_EXCEPTIONS', '0')]
COMPILER_ARGS = ['/EHsc']
subprocess_COMPILER_ARGS = ['/MT']
subprocess_LINKER_ARGS = ['/MANIFEST:NO', '/LARGEADDRESSAWARE']
FORCE_FLAG = False
