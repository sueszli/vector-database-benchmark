...
reduce_fns = {'sum': (fn.reductions.sum, np.sum), 'min': (fn.reductions.min, np.min), 'max': (fn.reductions.max, np.max), 'mean': (fn.reductions.mean, np.mean), 'mean_square': (fn.reductions.mean_square, np_mean_square), 'rms': (fn.reductions.rms, np_root_mean_square), 'std_dev': (fn.reductions.std_dev, np.std), 'variance': (fn.reductions.variance, np.var)}
