...
Registrable._registry[Activation] = {'relu': (torch.nn.ReLU, None), 'relu6': (torch.nn.ReLU6, None), 'elu': (torch.nn.ELU, None), 'gelu': (torch.nn.GELU, None), 'prelu': (torch.nn.PReLU, None), 'leaky_relu': (torch.nn.LeakyReLU, None), 'threshold': (torch.nn.Threshold, None), 'hardtanh': (torch.nn.Hardtanh, None), 'sigmoid': (torch.nn.Sigmoid, None), 'tanh': (torch.nn.Tanh, None), 'log_sigmoid': (torch.nn.LogSigmoid, None), 'softplus': (torch.nn.Softplus, None), 'softshrink': (torch.nn.Softshrink, None), 'softsign': (torch.nn.Softsign, None), 'tanhshrink': (torch.nn.Tanhshrink, None), 'selu': (torch.nn.SELU, None)}
