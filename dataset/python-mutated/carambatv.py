...
from ..utils import format_field, float_or_none, int_or_none, try_get
from .videomore import VideomoreIE

class CarambaTVIE(InfoExtractor):
    _VALID_URL = '(?:carambatv:|https?://video1\\.carambatv\\.ru/v/)(?P<id>\\d+)'
    _TESTS = [{'url': 'http://video1.carambatv.ru/v/191910501', 'md5': '2f4a81b7cfd5ab866ee2d7270cb34a2a', 'info_dict': {'id': '191910501', 'ext': 'mp4', 'title': '[BadComedian] - Разборка в Маниле (Абсолютный обзор)', 'thumbnail': 're:^https?://.*\\.jpg', 'duration': 2678.31}}, {'url': 'carambatv:191910501', 'only_matching': True}]
...
class CarambaTVPageIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://carambatv.ru/movie/bad-comedian/razborka-v-manile/', 'md5': 'a49fb0ec2ad66503eeb46aac237d3c86', 'info_dict': {'id': '475222', 'ext': 'flv', 'title': '[BadComedian] - Разборка в Маниле (Абсолютный обзор)', 'thumbnail': 're:^https?://.*\\.jpg', 'duration': int}, 'add_ie': [VideomoreIE.ie_key()]}
