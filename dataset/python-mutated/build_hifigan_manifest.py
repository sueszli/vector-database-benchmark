...
if __name__ == '__main__':
    '\n    usage:\n    python create_hifigan_manifest.py             --tsv /checkpoint/felixkreuk/datasets/vctk/manifests/vctk_16khz/valid.tsv             --km /checkpoint/felixkreuk/datasets/vctk/manifests/vctk_16khz/hubert_km_100/valid.km             --km_type hubert             > /checkpoint/felixkreuk/datasets/vctk/manifests/vctk_16khz/hubert_km_100/hifigan_valid_manifest.txt\n    '
    main()