...
SWINV2_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/swinv2-tiny-patch4-window8-256': 'https://huggingface.co/microsoft/swinv2-tiny-patch4-window8-256/resolve/main/config.json'}
