...
from prowler.providers.aws.services.directoryservice.directoryservice_service import Directory, DirectoryType, SnapshotLimit
...
class Test_directoryservice_directory_snapshots_limit:
    ...
    def test_no_directories(self):
        ...
        with mock.patch('prowler.providers.aws.services.directoryservice.directoryservice_service.DirectoryService', new=directoryservice_client):
            from prowler.providers.aws.services.directoryservice.directoryservice_directory_snapshots_limit.directoryservice_directory_snapshots_limit import directoryservice_directory_snapshots_limit
    ...
    def test_one_directory_snapshots_limit_reached(self):
        ...
        with mock.patch('prowler.providers.aws.services.directoryservice.directoryservice_service.DirectoryService', new=directoryservice_client):
            ...
            assert result[0].status_extended == f'Directory Service {directory_id} reached {manual_snapshots_limit} Snapshots limit.'
    ...
    def test_one_directory_snapshots_limit_over_threshold(self):
        ...
        with mock.patch('prowler.providers.aws.services.directoryservice.directoryservice_service.DirectoryService', new=directoryservice_client):
            ...
            assert result[0].region == AWS_REGION
            assert result[0].status == 'FAIL'
            assert result[0].status_extended == f'Directory Service {directory_id} is about to reach {manual_snapshots_limit} Snapshots which is the limit.'
    ...
    def test_one_directory_snapshots_limit_more_threshold(self):
        ...
        with mock.patch('prowler.providers.aws.services.directoryservice.directoryservice_service.DirectoryService', new=directoryservice_client):
            ...
            assert result[0].status_extended == f'Directory Service {directory_id} is using {manual_snapshots_current_count} out of {manual_snapshots_limit} from the Snapshots Limit.'