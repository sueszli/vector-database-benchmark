...
from nuitka.specs.HardImportSpecs import builtins_open_since_3_spec, ctypes_cdll_before_38_spec, ctypes_cdll_since_38_spec, importlib_metadata_backport_distribution_spec, importlib_metadata_backport_entry_points_spec, importlib_metadata_backport_metadata_spec, importlib_metadata_backport_version_spec, importlib_metadata_distribution_spec, importlib_metadata_entry_points_before_310_spec, importlib_metadata_entry_points_since_310_spec, importlib_metadata_metadata_spec, importlib_metadata_version_spec, importlib_resources_backport_files_spec, importlib_resources_backport_read_binary_spec, importlib_resources_backport_read_text_spec, importlib_resources_files_spec, importlib_resources_read_binary_spec, importlib_resources_read_text_spec, os_listdir_spec, os_path_abspath_spec, os_path_basename_spec, os_path_exists_spec, os_path_isabs_spec, os_path_isdir_spec, os_path_isfile_spec, os_uname_spec, pkg_resources_get_distribution_spec, pkg_resources_iter_entry_points_spec, pkg_resources_require_spec, pkg_resources_resource_stream_spec, pkg_resources_resource_string_spec, pkgutil_get_data_spec
from .ChildrenHavingMixins import ChildHavingDistMixin, ChildHavingDistributionNameMixin, ChildHavingPackageMixin, ChildHavingParamsTupleMixin, ChildHavingPathMixin, ChildHavingPathOptionalMixin, ChildHavingPMixin, ChildHavingRequirementsTupleMixin, ChildHavingSMixin, ChildrenHavingFileModeOptionalBufferingOptionalEncodingOptionalErrorsOptionalNewlineOptionalClosefdOptionalOpenerOptionalMixin, ChildrenHavingGroupNameOptionalMixin, ChildrenHavingNameModeOptionalHandleOptionalUseErrnoOptionalUseLasterrorOptionalMixin, ChildrenHavingNameModeOptionalHandleOptionalUseErrnoOptionalUseLasterrorOptionalWinmodeOptionalMixin, ChildrenHavingPackageOrRequirementResourceNameMixin, ChildrenHavingPackageResourceEncodingOptionalErrorsOptionalMixin, ChildrenHavingPackageResourceMixin
from .ExpressionBases import ExpressionBase
from .ExpressionShapeMixins import ExpressionBoolShapeExactMixin, ExpressionBytesShapeExactMixin, ExpressionDictShapeExactMixin, ExpressionStrShapeExactMixin
...
class ExpressionBuiltinsOpenCallBase(ChildrenHavingFileModeOptionalBufferingOptionalEncodingOptionalErrorsOptionalNewlineOptionalClosefdOptionalOpenerOptionalMixin, ExpressionBase):
    """Base class for BuiltinsOpenCall

    Generated boiler plate code.
    """
    named_children = ('file', 'mode|optional', 'buffering|optional', 'encoding|optional', 'errors|optional', 'newline|optional', 'closefd|optional', 'opener|optional')
    __slots__ = ('attempted',)
...
class ExpressionCtypesCdllSince38CallBase(ChildrenHavingNameModeOptionalHandleOptionalUseErrnoOptionalUseLasterrorOptionalWinmodeOptionalMixin, ExpressionBase):
    """Base class for CtypesCdllCall

    Generated boiler plate code.
    """
    python_version_spec = '>= 0x380'
    named_children = ('name', 'mode|optional', 'handle|optional', 'use_errno|optional', 'use_lasterror|optional', 'winmode|optional')
    __slots__ = ('attempted',)
...
class ExpressionCtypesCdllBefore38CallBase(ChildrenHavingNameModeOptionalHandleOptionalUseErrnoOptionalUseLasterrorOptionalMixin, ExpressionBase):
    """Base class for CtypesCdllCall

    Generated boiler plate code.
    """
    python_version_spec = '< 0x380'
    named_children = ('name', 'mode|optional', 'handle|optional', 'use_errno|optional', 'use_lasterror|optional')
    __slots__ = ('attempted',)
...
class ExpressionImportlibMetadataBackportDistributionRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataBackportDistributionRef] = importlib_metadata_backport_distribution_spec

class ExpressionImportlibMetadataBackportDistributionCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibMetadataBackportEntryPointsRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataBackportEntryPointsRef] = importlib_metadata_backport_entry_points_spec

class ExpressionImportlibMetadataBackportEntryPointsCallBase(ChildHavingParamsTupleMixin, ExpressionBase):
...
class ExpressionImportlibMetadataBackportMetadataRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataBackportMetadataRef] = importlib_metadata_backport_metadata_spec

class ExpressionImportlibMetadataBackportMetadataCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibMetadataBackportVersionRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataBackportVersionRef] = importlib_metadata_backport_version_spec

class ExpressionImportlibMetadataBackportVersionCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibMetadataDistributionRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataDistributionRef] = importlib_metadata_distribution_spec

class ExpressionImportlibMetadataDistributionCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibMetadataEntryPointsRef(ExpressionImportModuleNameHardExistsSpecificBase):
    ...
    def computeExpressionCall(self, call_node, call_args, call_kw, trace_collection):
        ...
        if python_version < 928:
            ...
            return (result, 'new_expression', "Call to 'importlib.metadata.entry_points' recognized.")
hard_import_node_classes[ExpressionImportlibMetadataEntryPointsRef] = importlib_metadata_entry_points_since_310_spec

class ExpressionImportlibMetadataEntryPointsSince310CallBase(ChildHavingParamsTupleMixin, ExpressionBase):
...
class ExpressionImportlibMetadataEntryPointsBefore310CallBase(ExpressionDictShapeExactMixin, ExpressionBase):
    """Base class for ImportlibMetadataEntryPointsCall
...
class ExpressionImportlibMetadataMetadataRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataMetadataRef] = importlib_metadata_metadata_spec

class ExpressionImportlibMetadataMetadataCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibMetadataVersionRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibMetadataVersionRef] = importlib_metadata_version_spec

class ExpressionImportlibMetadataVersionCallBase(ChildHavingDistributionNameMixin, ExpressionBase):
...
class ExpressionImportlibResourcesBackportFilesRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesBackportFilesRef] = importlib_resources_backport_files_spec

class ExpressionImportlibResourcesBackportFilesCallBase(ChildHavingPackageMixin, ExpressionBase):
...
class ExpressionImportlibResourcesBackportReadBinaryRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesBackportReadBinaryRef] = importlib_resources_backport_read_binary_spec

class ExpressionImportlibResourcesBackportReadBinaryCallBase(ExpressionBytesShapeExactMixin, ChildrenHavingPackageResourceMixin, ExpressionBase):
...
class ExpressionImportlibResourcesBackportReadTextRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesBackportReadTextRef] = importlib_resources_backport_read_text_spec

class ExpressionImportlibResourcesBackportReadTextCallBase(ExpressionStrShapeExactMixin, ChildrenHavingPackageResourceEncodingOptionalErrorsOptionalMixin, ExpressionBase):
    """Base class for ImportlibResourcesBackportReadTextCall

    Generated boiler plate code.
    """
    named_children = ('package', 'resource', 'encoding|optional', 'errors|optional')
    __slots__ = ('attempted',)
...
class ExpressionImportlibResourcesFilesRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesFilesRef] = importlib_resources_files_spec

class ExpressionImportlibResourcesFilesCallBase(ChildHavingPackageMixin, ExpressionBase):
...
class ExpressionImportlibResourcesReadBinaryRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesReadBinaryRef] = importlib_resources_read_binary_spec

class ExpressionImportlibResourcesReadBinaryCallBase(ExpressionBytesShapeExactMixin, ChildrenHavingPackageResourceMixin, ExpressionBase):
...
class ExpressionImportlibResourcesReadTextRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionImportlibResourcesReadTextRef] = importlib_resources_read_text_spec

class ExpressionImportlibResourcesReadTextCallBase(ExpressionStrShapeExactMixin, ChildrenHavingPackageResourceEncodingOptionalErrorsOptionalMixin, ExpressionBase):
...
class ExpressionOsPathIsabsCallBase(ExpressionBoolShapeExactMixin, ChildHavingSMixin, ExpressionBase):
...
class ExpressionPkgResourcesGetDistributionRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionPkgResourcesGetDistributionRef] = pkg_resources_get_distribution_spec

class ExpressionPkgResourcesGetDistributionCallBase(ChildHavingDistMixin, ExpressionBase):
...
class ExpressionPkgResourcesIterEntryPointsRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionPkgResourcesIterEntryPointsRef] = pkg_resources_iter_entry_points_spec

class ExpressionPkgResourcesIterEntryPointsCallBase(ChildrenHavingGroupNameOptionalMixin, ExpressionBase):
    """Base class for PkgResourcesIterEntryPointsCall

    Generated boiler plate code.
    """
    named_children = ('group', 'name|optional')
    __slots__ = ('attempted',)
...
class ExpressionPkgResourcesRequireRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
class ExpressionPkgResourcesRequireCallBase(ChildHavingRequirementsTupleMixin, ExpressionBase):
...
class ExpressionPkgResourcesResourceStreamRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionPkgResourcesResourceStreamRef] = pkg_resources_resource_stream_spec

class ExpressionPkgResourcesResourceStreamCallBase(ChildrenHavingPackageOrRequirementResourceNameMixin, ExpressionBase):
    """Base class for PkgResourcesResourceStreamCall

    Generated boiler plate code.
    """
    named_children = ('package_or_requirement', 'resource_name')
    __slots__ = ('attempted',)
...
class ExpressionPkgResourcesResourceStringRef(ExpressionImportModuleNameHardExistsSpecificBase):
...
hard_import_node_classes[ExpressionPkgResourcesResourceStringRef] = pkg_resources_resource_string_spec

class ExpressionPkgResourcesResourceStringCallBase(ChildrenHavingPackageOrRequirementResourceNameMixin, ExpressionBase):
...
class ExpressionPkgutilGetDataCallBase(ChildrenHavingPackageResourceMixin, ExpressionBase):
