...
from bokeh.models import Arc, Circle, ColumnDataSource, Plot, PolarTransform, Range1d, Ray, Text
...
plot.add_glyph(Circle(x=0, y=0, radius=1.0, fill_color='white', line_color='black'))
...
add_gauge(0.7, max_mph, 0.05, -1, 'blue', major_step, minor_step)
add_needle(55, 'kmh')
doc = Document()
doc.add_root(plot)
