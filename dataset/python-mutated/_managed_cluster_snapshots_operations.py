...
class ManagedClusterSnapshotsOperations:
    ...
    def list(self, **kwargs: Any) -> AsyncIterable['_models.ManagedClusterSnapshot']:
        if False:
            i = 10
            return i + 15
        'Gets a list of managed cluster snapshots in the specified subscription.\n\n        Gets a list of managed cluster snapshots in the specified subscription.\n\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: An iterator like instance of either ManagedClusterSnapshot or the result of\n         cls(response)\n        :rtype:\n         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.containerservice.v2023_03_02_preview.models.ManagedClusterSnapshot]\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
        _headers = kwargs.pop('headers', {}) or {}
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2023-03-02-preview'))
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ContainerService/managedclustersnapshots'}

    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.ManagedClusterSnapshot']:
        if False:
            for i in range(10):
                print('nop')
        ...
        async def get_next(next_link=None):
            ...
            return pipeline_response
        return AsyncItemPaged(get_next, extract_data)
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclustersnapshots'}
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ManagedClusterSnapshot:
        ...
        :rtype: ~azure.mgmt.containerservice.v2023_03_02_preview.models.ManagedClusterSnapshot
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclustersnapshots/{resourceName}'}

    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, parameters: _models.ManagedClusterSnapshot, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedClusterSnapshot:
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_03_02_preview.models.ManagedClusterSnapshot
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedClusterSnapshot:
        """Creates or updates a managed cluster snapshot.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, resource_name: str, parameters: Union[_models.ManagedClusterSnapshot, IO], **kwargs: Any) -> _models.ManagedClusterSnapshot:
        """Creates or updates a managed cluster snapshot.
        ...
        :type parameters:
         ~azure.mgmt.containerservice.v2023_03_02_preview.models.ManagedClusterSnapshot or IO
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclustersnapshots/{resourceName}'}

    @overload
    async def update_tags(self, resource_group_name: str, resource_name: str, parameters: _models.TagsObject, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedClusterSnapshot:
        ...
        :param parameters: Parameters supplied to the Update managed cluster snapshot Tags operation.
         Required.
        :type parameters: ~azure.mgmt.containerservice.v2023_03_02_preview.models.TagsObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def update_tags(self, resource_group_name: str, resource_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedClusterSnapshot:
        """Updates tags on a managed cluster snapshot.
    ...
    @distributed_trace_async
    async def update_tags(self, resource_group_name: str, resource_name: str, parameters: Union[_models.TagsObject, IO], **kwargs: Any) -> _models.ManagedClusterSnapshot:
        """Updates tags on a managed cluster snapshot.
        ...
        :type parameters: ~azure.mgmt.containerservice.v2023_03_02_preview.models.TagsObject or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    update_tags.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclustersnapshots/{resourceName}'}
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedclustersnapshots/{resourceName}'}