...
class SimplecastIE(SimplecastBaseIE):
    IE_NAME = 'simplecast'
    _VALID_URL = 'https?://(?:api\\.simplecast\\.com/episodes|player\\.simplecast\\.com)/(?P<id>%s)' % SimplecastBaseIE._UUID_REGEX
    _EMBED_REGEX = [f"""(?x)<iframe[^>]+src=["\\']\n        (?P<url>https?://(?:\n            embed\\.simplecast\\.com/[0-9a-f]{8}|\n            player\\.simplecast\\.com/{SimplecastBaseIE._UUID_REGEX}\n        ))"""]
    _COMMON_TEST_INFO = {'display_id': 'errant-signal-chris-franklin-new-wave-video-essays', 'id': 'b6dc49a2-9404-4853-9aa9-9cfc097be876', 'ext': 'mp3', 'title': 'Errant Signal - Chris Franklin & New Wave Video Essays', 'episode_number': 1, 'episode_id': 'b6dc49a2-9404-4853-9aa9-9cfc097be876', 'description': 'md5:34752789d3d2702e2d2c975fbd14f357', 'season_number': 1, 'season_id': 'e23df0da-bae4-4531-8bbf-71364a88dc13', 'series': 'The RE:BIND.io Podcast', 'duration': 5343, 'timestamp': 1580979475, 'upload_date': '20200206', 'webpage_url': 're:^https?://the-re-bind-io-podcast\\.simplecast\\.com/episodes/errant-signal-chris-franklin-new-wave-video-essays', 'channel_url': 're:^https?://the-re-bind-io-podcast\\.simplecast\\.com$'}
    _TESTS = [{'url': 'https://api.simplecast.com/episodes/b6dc49a2-9404-4853-9aa9-9cfc097be876', 'md5': '8c93be7be54251bf29ee97464eabe61c', 'info_dict': _COMMON_TEST_INFO}, {'url': 'https://player.simplecast.com/b6dc49a2-9404-4853-9aa9-9cfc097be876', 'only_matching': True}]
...
class SimplecastEpisodeIE(SimplecastBaseIE):
    ...
    _TEST = {'url': 'https://the-re-bind-io-podcast.simplecast.com/episodes/errant-signal-chris-franklin-new-wave-video-essays', 'md5': '8c93be7be54251bf29ee97464eabe61c', 'info_dict': SimplecastIE._COMMON_TEST_INFO}
...
class SimplecastPodcastIE(SimplecastBaseIE):
    ...
    _TESTS = [{'url': 'https://the-re-bind-io-podcast.simplecast.com', 'playlist_mincount': 33, 'info_dict': {'id': '07d28d26-7522-42eb-8c53-2bdcfc81c43c', 'title': 'The RE:BIND.io Podcast'}}, {'url': 'https://the-re-bind-io-podcast.simplecast.com/episodes', 'only_matching': True}]
