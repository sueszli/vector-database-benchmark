...
try:
    ...
    raise Exception(f'MMDet {version} version is not supported. The latest supported MMDet version with deeplake is 2.28.1.')
from mmdet.utils import build_dp, compat_cfg, find_latest_checkpoint, get_root_logger
from mmdet.core import DistEvalHook, EvalHook
from mmdet.core import build_optimizer
from mmcv.runner import DistSamplerSeedHook, EpochBasedRunner, Fp16OptimizerHook, OptimizerHook, build_runner
...
def get_bbox_format(bbox, bbox_info):
    ...
    if len(bbox_info) == 0 and np.mean(bbox) < 1:
        ...
        type = 'fractional'
    return (mode, type)
BBOX_FORMAT_TO_PASCAL_CONVERTER = {('LTWH', 'pixel'): coco_pixel_2_pascal_pixel, ('LTWH', 'fractional'): coco_frac_2_pascal_pixel, ('LTRB', 'pixel'): lambda x, y: x, ('LTRB', 'fractional'): pascal_frac_2_pascal_pixel, ('CCWH', 'pixel'): yolo_pixel_2_pascal_pixel, ('CCWH', 'fractional'): yolo_frac_2_pascal_pixel}
...
BBOX_FORMAT_TO_COCO_CONVERTER = {('LTWH', 'pixel'): lambda x, y: x, ('LTWH', 'fractional'): coco_frac_2_coco_pixel, ('LTRB', 'pixel'): pascal_pixel_2_coco_pixel, ('LTRB', 'fractional'): pascal_frac_2_coco_pixel, ('CCWH', 'pixel'): yolo_pixel_2_coco_pixel, ('CCWH', 'fractional'): yolo_frac_2_coco_pixel}
