...
from samcli.lib.hook.exceptions import InvalidHookWrapperException, InvalidHookPackageConfigException, HookPackageExecuteFunctionalityException
TEST_HOOK_PACKAGE_CONFIG = {'hook_name': 'my_test_hook_name', 'hook_use_case': 'IaC', 'description': 'testing', 'version': '1.0.0', 'hook_specification': '1.0.0', 'functionalities': {'prepare': {'entry_script': './prepare/main', 'parameters': [{'long_name': 'param1', 'short_name': 'p1', 'description': 'Parameter 1', 'mandatory': True, 'type': 'array'}, {'long_name': 'param2', 'short_name': 'p2', 'description': 'Parameter 2', 'mandatory': False, 'type': 'array'}]}}}
