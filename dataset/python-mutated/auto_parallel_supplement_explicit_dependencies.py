from paddle.distributed.auto_parallel.static.operators.common import is_amp_flag_sync_op, is_data_parallel_reduce_op, is_global_norm_sync_op
from paddle.distributed.auto_parallel.static.utils import OpRole, insert_dependencies_for_vars, is_comm_op
