...
class KinesisFirehoseDeliveryStreamProperties(TypedDict):
    ...
    AmazonopensearchserviceDestinationConfiguration: Optional[AmazonopensearchserviceDestinationConfiguration]
    Arn: Optional[str]
...
class KinesisFirehoseDeliveryStreamProvider(ResourceProvider[KinesisFirehoseDeliveryStreamProperties]):
