...
grid = ImageGrid(fig, 211, nrows_ncols=(1, 3), axes_pad=0.05, label_mode='1', share_all=True, cbar_location='top', cbar_mode='each', cbar_size='7%', cbar_pad='1%')
...
grid2 = ImageGrid(fig, 212, nrows_ncols=(1, 3), axes_pad=0.05, label_mode='1', share_all=True, cbar_location='right', cbar_mode='single', cbar_size='10%', cbar_pad=0.05)
