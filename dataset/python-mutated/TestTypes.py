...
class TestTypeIdentifiers(unittest.TestCase):
    TEST_DATA = [('char*', 'char__ptr'), ('char *', 'char__ptr'), ('char **', 'char__ptr__ptr'), ('_typedef', '_typedef'), ('__typedef', '__dundertypedef'), ('___typedef', '__dunder_typedef'), ('____typedef', '__dunder__dundertypedef'), ('_____typedef', '__dunder__dunder_typedef'), ('const __typedef', '__const___dundertypedef'), ('int[42]', 'int__lArr42__rArr'), ('int[:]', 'int__lArr__D__rArr'), ('int[:,:]', 'int__lArr__D__comma___D__rArr'), ('int[:,:,:]', 'int__lArr__D__comma___D__comma___D__rArr'), ('int[:,:,...]', 'int__lArr__D__comma___D__comma___EL__rArr'), ('std::vector', 'std__in_vector'), ('std::vector&&', 'std__in_vector__fwref'), ('const std::vector', '__const_std__in_vector'), ('const std::vector&', '__const_std__in_vector__ref'), ('const_std', 'const_std')]
