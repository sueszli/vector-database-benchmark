...
from scapy.fields import BitField, MayEnd, IPField, IntField, ShortField, StrField, XBitField
...
class LDPNotification(_LDP_Packet):
    ...
    fields_desc = [BitField('u', 0, 1), BitField('type', 1, 15), ShortField('len', None), IntField('id', 0), StatusTLVField('status', (0, 0, 0, 0, 0))]

class LDPHello(_LDP_Packet):
    name = 'LDPHello'
    fields_desc = [BitField('u', 0, 1), BitField('type', 256, 15), ShortField('len', None), IntField('id', 0), CommonHelloTLVField('params', [180, 0, 0])]

class LDPInit(_LDP_Packet):
    name = 'LDPInit'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 512, 15), ShortField('len', None), IntField('id', 0), CommonSessionTLVField('params', None)]

class LDPKeepAlive(_LDP_Packet):
    name = 'LDPKeepAlive'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 513, 15), ShortField('len', None), IntField('id', 0)]

class LDPAddress(_LDP_Packet):
    name = 'LDPAddress'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 768, 15), ShortField('len', None), IntField('id', 0), AddressTLVField('address', None)]

class LDPAddressWM(_LDP_Packet):
    name = 'LDPAddressWM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 769, 15), ShortField('len', None), IntField('id', 0), AddressTLVField('address', None)]

class LDPLabelMM(_LDP_Packet):
    name = 'LDPLabelMM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 1024, 15), ShortField('len', None), IntField('id', 0), MayEnd(FecTLVField('fec', None)), LabelTLVField('label', 0)]

class LDPLabelReqM(_LDP_Packet):
    name = 'LDPLabelReqM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 1025, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None)]

class LDPLabelARM(_LDP_Packet):
    name = 'LDPLabelARM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 1028, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), IntField('labelRMid', 0)]

class LDPLabelWM(_LDP_Packet):
    name = 'LDPLabelWM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 1026, 15), ShortField('len', None), IntField('id', 0), MayEnd(FecTLVField('fec', None)), LabelTLVField('label', 0)]

class LDPLabelRelM(_LDP_Packet):
    name = 'LDPLabelRelM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 1027, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), LabelTLVField('label', 0)]
