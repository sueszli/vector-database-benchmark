...
class ABCOTVSIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://abc7news.com/entertainment/east-bay-museum-celebrates-vintage-synthesizers/472581/', 'info_dict': {'id': '472548', 'display_id': 'east-bay-museum-celebrates-vintage-synthesizers', 'ext': 'mp4', 'title': 'East Bay museum celebrates synthesized music', 'description': 'md5:24ed2bd527096ec2a5c67b9d5a9005f3', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1421118520, 'upload_date': '20150113'}, 'params': {'skip_download': True}}, {'url': 'http://abc7news.com/472581', 'only_matching': True}, {'url': 'https://6abc.com/man-75-killed-after-being-struck-by-vehicle-in-chester/5725182/', 'only_matching': True}]
    _SITE_MAP = {'6abc': 'wpvi', 'abc11': 'wtvd', 'abc13': 'ktrk', 'abc30': 'kfsn', 'abc7': 'kabc', 'abc7chicago': 'wls', 'abc7news': 'kgo', 'abc7ny': 'wabc'}
...
class ABCOTVSClipsIE(InfoExtractor):
    ...
    _TEST = {'url': 'https://clips.abcotvs.com/kabc/video/214814', 'info_dict': {'id': '214814', 'ext': 'mp4', 'title': 'SpaceX launch pad explosion destroys rocket, satellite', 'description': 'md5:9f186e5ad8f490f65409965ee9c7be1b', 'upload_date': '20160901', 'timestamp': 1472756695}, 'params': {'skip_download': True}}
