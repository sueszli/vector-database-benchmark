...
from .errors import GrapheneDagsterTypeNotFoundError, GraphenePipelineNotFoundError, GraphenePythonError
...
class GrapheneDagsterTypeOrError(graphene.Union):
    ...
    class Meta:
        types = (GrapheneRegularDagsterType, GraphenePipelineNotFoundError, GrapheneDagsterTypeNotFoundError, GraphenePythonError)
        name = 'DagsterTypeOrError'
types = [GrapheneDagsterType, GrapheneDagsterTypeOrError, GrapheneListDagsterType, GrapheneNullableDagsterType, GrapheneRegularDagsterType, GrapheneWrappingDagsterType]