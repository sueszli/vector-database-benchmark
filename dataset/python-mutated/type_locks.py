...
from homeassistant.components.lock import DOMAIN, STATE_JAMMED, STATE_LOCKED, STATE_LOCKING, STATE_UNLOCKED, STATE_UNLOCKING
...
HASS_TO_HOMEKIT_CURRENT = {STATE_UNLOCKED: 0, STATE_UNLOCKING: 1, STATE_LOCKING: 0, STATE_LOCKED: 1, STATE_JAMMED: 2, STATE_UNKNOWN: 3}
HASS_TO_HOMEKIT_TARGET = {STATE_UNLOCKED: 0, STATE_UNLOCKING: 0, STATE_LOCKING: 1, STATE_LOCKED: 1}
VALID_TARGET_STATES = {STATE_LOCKING, STATE_UNLOCKING, STATE_LOCKED, STATE_UNLOCKED}
HOMEKIT_TO_HASS = {0: STATE_UNLOCKED, 1: STATE_LOCKED, 2: STATE_JAMMED, 3: STATE_UNKNOWN}
STATE_TO_SERVICE = {STATE_LOCKING: 'unlock', STATE_LOCKED: 'lock', STATE_UNLOCKING: 'lock', STATE_UNLOCKED: 'unlock'}
