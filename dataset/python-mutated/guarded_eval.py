...
from typing import Any, Callable, Dict, Set, Sequence, Tuple, NamedTuple, Type, Literal, Union, TYPE_CHECKING
import ast
import builtins
import collections
import operator
...
BINARY_OP_DUNDERS: Dict[Type[ast.operator], Tuple[str]] = {ast.Add: ('__add__',), ast.Sub: ('__sub__',), ast.Mult: ('__mul__',), ast.Div: ('__truediv__',), ast.FloorDiv: ('__floordiv__',), ast.Mod: ('__mod__',), ast.Pow: ('__pow__',), ast.LShift: ('__lshift__',), ast.RShift: ('__rshift__',), ast.BitOr: ('__or__',), ast.BitXor: ('__xor__',), ast.BitAnd: ('__and__',), ast.MatMult: ('__matmul__',)}
COMP_OP_DUNDERS: Dict[Type[ast.cmpop], Tuple[str, ...]] = {ast.Eq: ('__eq__',), ast.NotEq: ('__ne__', '__eq__'), ast.Lt: ('__lt__', '__gt__'), ast.LtE: ('__le__', '__ge__'), ast.Gt: ('__gt__', '__lt__'), ast.GtE: ('__ge__', '__le__'), ast.In: ('__contains__',)}
UNARY_OP_DUNDERS: Dict[Type[ast.unaryop], Tuple[str, ...]] = {ast.USub: ('__neg__',), ast.UAdd: ('__pos__',), ast.Invert: ('__invert__', '__inv__'), ast.Not: ('__not__',)}
...
SUPPORTED_EXTERNAL_GETITEM = {('pandas', 'core', 'indexing', '_iLocIndexer'), ('pandas', 'core', 'indexing', '_LocIndexer'), ('pandas', 'DataFrame'), ('pandas', 'Series'), ('numpy', 'ndarray'), ('numpy', 'void')}
