...
class BladeRF(Device):
    ...
    DEVICE_METHODS.update({Device.Command.SET_RF_GAIN.name: 'set_gain', Device.Command.SET_CHANNEL_INDEX.name: 'set_channel', Device.Command.SET_BIAS_TEE_ENABLED.name: 'set_bias_tee'})
    DATA_TYPE = np.int16
