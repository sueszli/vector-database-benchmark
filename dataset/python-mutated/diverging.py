...
"""
from .colorbrewer import BrBG, PRGn, PiYG, PuOr, RdBu, RdGy, RdYlBu, RdYlGn, Spectral, BrBG_r, PRGn_r, PiYG_r, PuOr_r, RdBu_r, RdGy_r, RdYlBu_r, RdYlGn_r, Spectral_r
from .cmocean import balance, delta, curl, oxy, balance_r, delta_r, curl_r, oxy_r
from .carto import Armyrose, Fall, Geyser, Temps, Tealrose, Tropic, Earth, Armyrose_r, Fall_r, Geyser_r, Temps_r, Tealrose_r, Tropic_r, Earth_r
from .plotlyjs import Picnic, Portland, Picnic_r, Portland_r
