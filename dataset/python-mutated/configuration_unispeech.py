...
UNISPEECH_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/unispeech-large-1500h-cv': 'https://huggingface.co/microsoft/unispeech-large-1500h-cv/resolve/main/config.json'}
