...
class Exploit(BTLEClient):
    __info__ = {'name': 'Bluetooth LE Scan', 'description': 'Scans for Bluetooth Low Energy devices.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'references': ('https://www.evilsocket.net/2017/09/23/This-is-not-a-post-about-BLE-introducing-BLEAH/',)}
