...
class MyTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            while True:
                i = 10
        fixtures = {'proc_iomem': ('fixtures/linux-proc/iomem', 'fixtures/linux-proc/iomem.json')}
    ...
    def test_proc_iomem(self):
        if False:
            ...
            return i + 15
        "\n        Test '/proc/iomem'\n        "
        self.assertEqual(jc.parsers.proc_iomem.parse(self.f_in['proc_iomem'], quiet=True), self.f_json['proc_iomem'])
