...
from label_utils import get_last_page_num_from_header, gh_get_labels, has_required_labels
from test_trymerge import mocked_gh_graphql
from trymerge import GitHubPR
release_notes_labels = ['release notes: nn']

class TestLabelUtils(TestCase):
    MOCK_HEADER_LINKS_TO_PAGE_NUMS = {1: {'link': "<https://api.github.com/dummy/labels?per_page=10&page=1>; rel='last'"}, 2: {'link': '<https://api.github.com/dummy/labels?per_page=1&page=2>;'}, 3: {'link': '<https://api.github.com/dummy/labels?per_page=1&page=2&page=3>;'}}
