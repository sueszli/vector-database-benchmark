...
from r2.lib.validator import nop, textresponse, validatedForm, VByName, VDecimal, VFloat, VInt, VLength, VModhash, VOneOf, VPrintable, VUser
from r2.models import Account, account_by_payingid, account_from_stripe_customer_id, accountid_from_subscription, admintools, append_random_bottlecap_phrase, cancel_subscription, Comment, creddits_lock, create_claimed_gold, create_gift_gold, create_gold_code, Email, get_discounted_price, has_prev_subscr_payments, Link, make_gold_message, NotFound, retrieve_gold_transaction, send_system_message, Thing, update_gold_transaction, generate_token
BLOB_TTL = 86400 * 30
...
class StripeController(GoldPaymentController):
    ...
    event_type_mappings = {'charge.succeeded': 'succeeded', 'charge.failed': 'failed', 'charge.refunded': 'refunded', 'charge.dispute.created': 'noop', 'charge.dispute.updated': 'noop', 'charge.dispute.closed': 'noop', 'charge.dispute.funds_withdrawn': 'noop', 'charge.updated': 'noop', 'customer.created': 'noop', 'customer.card.created': 'noop', 'customer.card.updated': 'noop', 'customer.card.deleted': 'noop', 'customer.source.updated': 'noop', 'transfer.created': 'noop', 'transfer.paid': 'noop', 'balance.available': 'noop', 'invoice.created': 'noop', 'invoice.updated': 'noop', 'invoice.payment_succeeded': 'noop', 'invoice.payment_failed': 'noop', 'invoiceitem.deleted': 'noop', 'customer.subscription.created': 'noop', 'customer.deleted': 'noop', 'customer.updated': 'noop', 'customer.subscription.deleted': 'deleted_subscription', 'customer.subscription.trial_will_end': 'noop', 'customer.subscription.updated': 'noop', 'review.opened': 'noop', 'dummy': 'noop'}
...
class CoinbaseController(GoldPaymentController):
    ...
    event_type_mappings = {'completed': 'succeeded', 'cancelled': 'cancelled', 'mispaid': 'noop', 'expired': 'noop', 'payout': 'noop'}
