...
def main():
    ...
    response = client.virtual_machine_extension_images.list_versions(location='aaaaaaaaaaaaaaaaaaaaaaaaaa', publisher_name='aaaaaaaaaaaaaaaaaaaa', type='aaaaaaaaaaaaaaaaaa')
    print(response)
