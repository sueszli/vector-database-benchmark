...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def test_create_file(self):
        ...
        chart.set_x_axis({'date_axis': True, 'min': int(worksheet._convert_date_time(date(2013, 1, 2))), 'max': int(worksheet._convert_date_time(date(2013, 1, 9))), 'num_format': 'dd/mm/yyyy', 'num_format_linked': True})
