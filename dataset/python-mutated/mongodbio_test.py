...
class _MockMongoClient:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if False:
            print('Hello World!')
        pass
OBJECT_IDS = [objectid.ObjectId.from_datetime(datetime.datetime(year=2020, month=i + 1, day=i + 1)) for i in range(5)]
INT_IDS = [n for n in range(5)]
STR_IDS_1 = [str(n) for n in range(5)]
STR_IDS_2 = [chr(97 + n) * 5 for n in range(5)]
STR_IDS_3 = [chr(65 + n) * 20 for n in range(5)]

@parameterized_class(('bucket_auto', '_ids', 'min_id', 'max_id'), [(None, OBJECT_IDS, _ObjectIdHelper.int_to_id(0), _ObjectIdHelper.int_to_id(2 ** 96 - 1)), (True, OBJECT_IDS, _ObjectIdHelper.int_to_id(0), _ObjectIdHelper.int_to_id(2 ** 96 - 1)), (None, INT_IDS, 0, 2 ** 96 - 1), (True, INT_IDS, 0, 2 ** 96 - 1), (None, STR_IDS_1, chr(0), chr(1114111)), (True, STR_IDS_1, chr(0), chr(1114111)), (None, STR_IDS_2, chr(0), chr(1114111)), (True, STR_IDS_2, chr(0), chr(1114111)), (None, STR_IDS_3, chr(0), chr(1114111)), (True, STR_IDS_3, chr(0), chr(1114111))])
