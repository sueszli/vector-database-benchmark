...
from modelscope.utils.input_output import call_pipeline_with_json, get_pipeline_information_by_pipeline, get_task_input_examples, pipeline_output_to_service_base64_output
...
if __name__ == '__main__':
    model_list = ['qwen/Qwen-7B-Chat-Int4', 'qwen/Qwen-14B-Chat-Int4', 'baichuan-inc/Baichuan2-7B-Chat-4bits', 'baichuan-inc/Baichuan2-13B-Chat-4bits', 'ZhipuAI/chatglm2-6b-int4']
