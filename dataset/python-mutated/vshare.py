...
class VShareIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=["\\\'](?P<url>(?:https?:)?//(?:www\\.)?vshare\\.io/v/[^/?#&]+)']
    _TESTS = [{'url': 'https://vshare.io/d/0f64ce6', 'md5': '17b39f55b5497ae8b59f5fbce8e35886', 'info_dict': {'id': '0f64ce6', 'title': 'vl14062007715967', 'ext': 'mp4'}}, {'url': 'https://vshare.io/v/0f64ce6/width-650/height-430/1', 'only_matching': True}]
