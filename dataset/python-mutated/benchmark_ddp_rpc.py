...
if __name__ == '__main__':
    ...
    parser.add_argument('--number-trainers', type=int, default=NUM_TRAINERS, help='Number of Trainer Nodes.')
    parser.add_argument('--number-ps', type=int, default=NUM_PS, help='Number of Parameter Servers.')
    parser.add_argument('--number-embeddings', type=int, default=NUM_EMBEDDINGS, help='Number of test embeddings to be generated.')
    parser.add_argument('--embedding-dim', type=int, default=EMBEDDING_DIM, help='Number of embedding dimensions.')
    parser.add_argument('--warmup-cycles', type=int, default=WARMUP_CYCLES, help='Number of cycles to warm-up each process before running the benchmark.')
    ...
    world_size = NUM_TRAINERS + NUM_PS + 1
