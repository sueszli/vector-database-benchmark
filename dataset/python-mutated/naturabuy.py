...
async def naturabuy(email, client, out):
    ...
    headers = {'User-Agent': random.choice(ua['browsers']['chrome']), 'Accept': '*/*', 'Accept-Language': 'fr,fr-FR;q=0.8,en-US;q=0.5,en;q=0.3', 'X-Requested-With': 'XMLHttpRequest', 'Content-Type': 'multipart/form-data; boundary=---------------------------', 'Origin': 'https://www.naturabuy.fr', 'DNT': '1', 'Connection': 'keep-alive'}
