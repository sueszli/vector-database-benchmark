...
full_combination = list(product(auto_request_id_values, request_id_init_values, request_id_set_values, request_id_req_values, request_id_header_name_values, HTTP_REQUESTS))
