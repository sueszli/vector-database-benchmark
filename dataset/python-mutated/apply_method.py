...
pruning_apply_methods = {'bypass': bypass, 'mul': mul_mask, 'add': add_mask, 'movement_mul': movement_mul_mask, 'movement_add': movement_add_mask, 'slim_mul': slim_mul_mask}
quant_apply_methods = {'bypass': bypass, 'clamp_round': ClampRound.apply, 'qat_clamp_round': QATClampRound.apply, 'dorefa_clamp_round_weight': DoferaGradClampRound.dorefa_clamp_round_weight, 'dorefa_clamp_round_output': DoferaGradClampRound.dorefa_clamp_round_output, 'lsq_clamp_round': lsq_clamp_round, 'bnn_clamp_round': BNNClampRound.apply, 'lsq_plus_clamp_round': lsq_plus_clamp_round}