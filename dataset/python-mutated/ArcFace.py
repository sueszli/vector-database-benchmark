...
if tf_version == 1:
    ...
    import keras
    from keras.layers import ZeroPadding2D, Input, Conv2D, BatchNormalization, PReLU, Add, Dropout, Flatten, Dense
else:
    from tensorflow.python.keras.engine import training
    from tensorflow import keras
    from tensorflow.keras.layers import ZeroPadding2D, Input, Conv2D, BatchNormalization, PReLU, Add, Dropout, Flatten, Dense
