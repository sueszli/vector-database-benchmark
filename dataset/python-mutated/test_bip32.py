...
class BIP32Tests(AsyncioTestCase):
    ...
    async def test_private_key_validation(self):
        ...
        private_key = PrivateKey(Ledger({'db': Database(':memory:'), 'headers': Headers(':memory:')}), unhexlify('2423f3dc6087d9683f73a684935abc0ccd8bc26370588f56653128c6a6f0bf7c'), b'abcd' * 8, 0, 1)
        ec_point = private_key.ec_point()
        self.assertEqual(ec_point[0], 30487144161998778625547553412379759661411261804838752332906558028921886299019)
        self.assertEqual(ec_point[1], 86198965946979720220333266272536217633917099472454294641561154971209433250106)
    ...
    async def test_from_extended_keys(self):
        ...
        self.assertIsInstance(from_extended_key_string(ledger, 'xprv9s21ZrQH143K2dyhK7SevfRG72bYDRNv25yKPWWm6dqApNxm1Zb1m5gGcBWYfbsPjTr2v5joit8Af2Zp5P6yz3jMbycrLrRMpeAJxR8qDg8'), PrivateKey)
        self.assertIsInstance(from_extended_key_string(ledger, 'xpub661MyMwAqRbcF84AR8yfHoMzf4S2ct6mPJtvBtvNeyN9hBHuZ6uGJszkTSn5fQUCdz3XU17eBzFeAUwV6fiW44g14WF52fYC5J483wqQ5ZP'), PublicKey)