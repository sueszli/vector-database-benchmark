...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$2:$A$5', 'values': '=Sheet1!$B$2:$B$5'})
        chart.add_series({'categories': '=Sheet1!$A$2:$A$5', 'values': '=Sheet1!$C$2:$C$5'})
        chart.add_series({'categories': '=Sheet1!$A$2:$A$5', 'values': '=Sheet1!$D$2:$D$5'})
