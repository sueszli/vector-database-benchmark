...
@slim.add_arg_scope
def basicblock(inputs, depth, depth_bottleneck, stride, rate=1, outputs_collections=None, scope=None):
    if False:
        for i in range(10):
            print('nop')
    ...
    with tf.variable_scope(scope, 'bottleneck_v1', [inputs]) as sc:
        ...
        residual = resnet_utils.conv2d_same(inputs, depth, 3, stride, rate=rate, scope='conv1')
        residual = resnet_utils.conv2d_same(residual, depth, 3, 1, rate=rate, scope='conv2')
