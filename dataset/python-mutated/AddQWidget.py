...
try:
    ...
    from PyQt5.QtWidgets import QWidget, QHBoxLayout, QLabel, QVBoxLayout, QApplication, QGraphicsView, QGraphicsScene
except ImportError:
    from PySide2.QtCore import Qt
    from PySide2.QtWidgets import QWidget, QHBoxLayout, QLabel, QVBoxLayout, QApplication, QGraphicsView, QGraphicsScene
