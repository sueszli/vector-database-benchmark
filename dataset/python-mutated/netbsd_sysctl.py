...
def __virtual__():
    ...
    return (False, 'The netbsd_sysctl execution module failed to load: only available on NetBSD.')
...
def show(config_file=False):
    ...
    roots = ('kern', 'vm', 'vfs', 'net', 'hw', 'machdep', 'user', 'ddb', 'proc', 'emul', 'security', 'init')
    cmd = 'sysctl -ae'
    ret = {}
