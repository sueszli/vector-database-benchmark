...
class ProductVariantDelete(ModelDeleteMutation, ModelWithExtRefMutation):
    ...
    class Arguments:
        id = graphene.ID(required=False, description='ID of a product variant to delete.')
        external_reference = graphene.String(required=False, description=f'External ID of a product variant to update. {ADDED_IN_310}')
        sku = graphene.String(required=False, description='SKU of a product variant to delete.' + ADDED_IN_38)
