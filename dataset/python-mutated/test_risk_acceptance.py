...
class RiskAcceptanceTestUI(DojoTestCase):
    ...
    data_risk_accceptance = {'name': 'Accept: Unit test', 'accepted_findings': [72808], 'recommendation': 'A', 'recommendation_details': 'recommendation 1', 'decision': 'A', 'decision_details': 'it has been decided!', 'accepted_by': 'pointy haired boss', 'owner': 1, 'expiration_date': '2021-07-15', 'reactivate_expired': True}
    data_remove_finding_from_ra = {'remove_finding': 'Remove', 'remove_finding_id': 666}
