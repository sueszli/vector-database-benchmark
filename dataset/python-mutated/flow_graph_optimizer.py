...
PyCmp_IS_NOT = 9
PyCmp_EXC_MATCH = 10
UNARY_OPS: Dict[str, object] = {'UNARY_INVERT': lambda v: ~v, 'UNARY_NEGATIVE': lambda v: -v, 'UNARY_POSITIVE': lambda v: +v}
BINARY_OPS: Dict[str, object] = {'BINARY_POWER': safe_power, 'BINARY_MULTIPLY': safe_multiply, 'BINARY_TRUE_DIVIDE': lambda left, right: left / right, 'BINARY_FLOOR_DIVIDE': lambda left, right: left // right, 'BINARY_MODULO': safe_mod, 'BINARY_ADD': lambda left, right: left + right, 'BINARY_SUBTRACT': lambda left, right: left - right, 'BINARY_SUBSCR': lambda left, right: left[right], 'BINARY_LSHIFT': safe_lshift, 'BINARY_RSHIFT': lambda left, right: left >> right, 'BINARY_AND': lambda left, right: left & right, 'BINARY_XOR': lambda left, right: left ^ right, 'BINARY_OR': lambda left, right: left | right}
