...
import pytest
from google.cloud.monitoring_v3.services.group_service import GroupServiceAsyncClient, GroupServiceClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(GroupServiceClient, 'grpc'), (GroupServiceAsyncClient, 'grpc_asyncio')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.GroupServiceGrpcTransport, 'grpc'), (transports.GroupServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
def test_group_service_client_get_transport_class():
    ...
    available_transports = [transports.GroupServiceGrpcTransport]
    assert transport in available_transports
    transport = GroupServiceClient.get_transport_class('grpc')
    assert transport == transports.GroupServiceGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(GroupServiceClient, transports.GroupServiceGrpcTransport, 'grpc'), (GroupServiceAsyncClient, transports.GroupServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(GroupServiceClient, transports.GroupServiceGrpcTransport, 'grpc', 'true'), (GroupServiceAsyncClient, transports.GroupServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'true'), (GroupServiceClient, transports.GroupServiceGrpcTransport, 'grpc', 'false'), (GroupServiceAsyncClient, transports.GroupServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'false')])
@mock.patch.object(GroupServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(GroupServiceClient))
@mock.patch.object(GroupServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(GroupServiceAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(GroupServiceClient, transports.GroupServiceGrpcTransport, 'grpc', grpc_helpers), (GroupServiceAsyncClient, transports.GroupServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_list_groups(request_type, transport: str='grpc'):
    if False:
        print('Hello World!')
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_groups), '__call__') as call:
        call.return_value = group_service.ListGroupsResponse(next_page_token='next_page_token_value')
...
def test_list_groups_empty_call():
    if False:
        for i in range(10):
            print('nop')
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.list_groups), '__call__') as call:
        client.list_groups()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
async def test_list_groups_async(transport: str='grpc_asyncio', request_type=group_service.ListGroupsRequest):
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_groups), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(group_service.ListGroupsResponse(next_page_token='next_page_token_value'))
...
def test_list_groups_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_groups(group_service.ListGroupsRequest(), name='name_value')
...
async def test_list_groups_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_groups(group_service.ListGroupsRequest(), name='name_value')

def test_list_groups_pager(transport_name: str='grpc'):
    if False:
        for i in range(10):
            print('nop')
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_groups), '__call__') as call:
        call.side_effect = (group_service.ListGroupsResponse(group=[group.Group(), group.Group(), group.Group()], next_page_token='abc'), group_service.ListGroupsResponse(group=[], next_page_token='def'), group_service.ListGroupsResponse(group=[group.Group()], next_page_token='ghi'), group_service.ListGroupsResponse(group=[group.Group(), group.Group()]), RuntimeError)
        metadata = ()
...
def test_get_group(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_group), '__call__') as call:
        call.return_value = group.Group(name='name_value', display_name='display_name_value', parent_name='parent_name_value', filter='filter_value', is_cluster=True)
...
async def test_get_group_async(transport: str='grpc_asyncio', request_type=group_service.GetGroupRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_group), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(group.Group(name='name_value', display_name='display_name_value', parent_name='parent_name_value', filter='filter_value', is_cluster=True))
...
def test_get_group_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_group(group_service.GetGroupRequest(), name='name_value')
...
async def test_get_group_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_group(group_service.GetGroupRequest(), name='name_value')
...
def test_create_group(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_group), '__call__') as call:
        call.return_value = gm_group.Group(name='name_value', display_name='display_name_value', parent_name='parent_name_value', filter='filter_value', is_cluster=True)
...
async def test_create_group_async(transport: str='grpc_asyncio', request_type=group_service.CreateGroupRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.create_group), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gm_group.Group(name='name_value', display_name='display_name_value', parent_name='parent_name_value', filter='filter_value', is_cluster=True))
...
def test_create_group_flattened():
    ...
    with mock.patch.object(type(client.transport.create_group), '__call__') as call:
        call.return_value = gm_group.Group()
        client.create_group(name='name_value', group=gm_group.Group(name='name_value'))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_create_group_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_group(group_service.CreateGroupRequest(), name='name_value', group=gm_group.Group(name='name_value'))
...
async def test_create_group_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_group), '__call__') as call:
        call.return_value = gm_group.Group()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gm_group.Group())
        response = await client.create_group(name='name_value', group=gm_group.Group(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_create_group_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_group(group_service.CreateGroupRequest(), name='name_value', group=gm_group.Group(name='name_value'))
...
def test_update_group_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_group(group_service.UpdateGroupRequest(), group=gm_group.Group(name='name_value'))
...
async def test_update_group_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_group(group_service.UpdateGroupRequest(), group=gm_group.Group(name='name_value'))
...
def test_delete_group_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_group(group_service.DeleteGroupRequest(), name='name_value')
...
async def test_delete_group_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_group(group_service.DeleteGroupRequest(), name='name_value')
...
def test_list_group_members(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_group_members), '__call__') as call:
        call.return_value = group_service.ListGroupMembersResponse(next_page_token='next_page_token_value', total_size=1086)
...
async def test_list_group_members_async(transport: str='grpc_asyncio', request_type=group_service.ListGroupMembersRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_group_members), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(group_service.ListGroupMembersResponse(next_page_token='next_page_token_value', total_size=1086))
...
def test_list_group_members_flattened_error():
    ...
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_group_members(group_service.ListGroupMembersRequest(), name='name_value')
...
async def test_list_group_members_flattened_error_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_group_members(group_service.ListGroupMembersRequest(), name='name_value')
...
def test_list_group_members_pager(transport_name: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_group_members), '__call__') as call:
        ...
        results = list(pager)
        assert len(results) == 6
        assert all((isinstance(i, monitored_resource_pb2.MonitoredResource) for i in results))
...
async def test_list_group_members_async_pager():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_group_members), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (group_service.ListGroupMembersResponse(members=[monitored_resource_pb2.MonitoredResource(), monitored_resource_pb2.MonitoredResource(), monitored_resource_pb2.MonitoredResource()], next_page_token='abc'), group_service.ListGroupMembersResponse(members=[], next_page_token='def'), group_service.ListGroupMembersResponse(members=[monitored_resource_pb2.MonitoredResource()], next_page_token='ghi'), group_service.ListGroupMembersResponse(members=[monitored_resource_pb2.MonitoredResource(), monitored_resource_pb2.MonitoredResource()]), RuntimeError)
        ...
        async for response in async_pager:
            responses.append(response)
        assert len(responses) == 6
        assert all((isinstance(i, monitored_resource_pb2.MonitoredResource) for i in responses))
...
def test_credentials_transport_error():
    if False:
        i = 10
        return i + 15
    transport = transports.GroupServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.GroupServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = GroupServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.GroupServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = GroupServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.GroupServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = GroupServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.GroupServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = GroupServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_group_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.GroupServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_group_service_base_transport():
    ...
    with mock.patch('google.cloud.monitoring_v3.services.group_service.transports.GroupServiceTransport.__init__') as Transport:
        ...
        transport = transports.GroupServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_groups', 'get_group', 'create_group', 'update_group', 'delete_group', 'list_group_members')
...
def test_group_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.monitoring_v3.services.group_service.transports.GroupServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.GroupServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.GroupServiceGrpcTransport, grpc_helpers), (transports.GroupServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_group_service_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='monitoring.googleapis.com'), transport=transport_name)
    assert client.transport._host == 'monitoring.googleapis.com:443'
...
def test_group_service_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='monitoring.googleapis.com:8000'), transport=transport_name)
...
def test_group_service_grpc_transport_channel():
    ...
    transport = transports.GroupServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_group_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.GroupServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_parse_group_path():
    if False:
        print('Hello World!')
    expected = {'project': 'whelk', 'group': 'octopus'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.GroupServiceTransport, '_prep_wrapped_messages') as prep:
        client = GroupServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = GroupServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(GroupServiceClient, transports.GroupServiceGrpcTransport), (GroupServiceAsyncClient, transports.GroupServiceGrpcAsyncIOTransport)])
