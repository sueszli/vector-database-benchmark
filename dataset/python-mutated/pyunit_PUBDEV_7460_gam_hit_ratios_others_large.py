...
def test_gam_model_predict():
    ...
    gam_multi = H2OGeneralizedAdditiveEstimator(family='multinomial', solver='IRLSM', lambda_search=True, nlambdas=8, gam_columns=['Slope'], scale=[0.0001], num_knots=[5], standardize=True)
    ...
    glm_multi = H2OGeneralizedLinearEstimator(family='multinomial', solver='IRLSM', lambda_search=True, standardize=True, nlambdas=8)
