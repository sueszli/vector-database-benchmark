...
from feast.protos.feast.serving.TransformationService_pb2 import DESCRIPTOR, TRANSFORMATION_SERVICE_TYPE_PYTHON, GetTransformationServiceInfoResponse, TransformFeaturesResponse, ValueType
from feast.protos.feast.serving.TransformationService_pb2_grpc import TransformationServiceServicer, add_TransformationServiceServicer_to_server
