...
class BlockDeviceMapping(AWSProperty):
    props = {'delete_on_termination': (boolean, False), 'device_name': (str, True), 'snapshot_id': (str, False), 'volume_id': (str, False), 'volume_size': (integer, False)}

class BlockDeviceMappingV2(AWSProperty):
    props = {'boot_index': (integer, False), 'delete_on_termination': (boolean, False), 'device_name': (str, False), 'device_type': (str, False), 'disk_bus': (str, False), 'ephemeral_format': (str, False), 'ephemeral_size': (integer, False), 'image_id': (str, False), 'snapshot_id': (str, False), 'swap_size': (integer, False), 'volume_id': (str, False), 'volume_size': (integer, False)}
