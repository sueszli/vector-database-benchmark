...
from statsmodels.distributions.copula.archimedean import ArchimedeanCopula, ClaytonCopula, FrankCopula, GumbelCopula, _debyem1_expansion
...
from statsmodels.distributions.copula.extreme_value import ExtremeValueCopula, copula_bv_ev
...
from statsmodels.distributions.tools import approx_copula_pdf, frequencies_fromdata
from statsmodels.tools.numdiff import approx_fprime_cs, approx_hess
uniform = stats.uniform
ev_list = [[trev.transform_bilogistic, 0.5, 0.9, (0.25, 0.05), 0.5], [trev.transform_tawn, 0.5, 0.9, (0.5, 0.5, 0.5), 0.4724570876035117], [trev.transform_tawn2, 0.5, 0.9, (0.25, 0.05), 0.464357480263932], [trev.transform_tawn2, 0.5, 0.9, (0.5, 0.25), 0.4916117128670654], [trev.transform_tawn2, 0.9, 0.5, (0.5, 0.25), 0.48340673415789], [trev.transform_hr, 0.5, 0.9, (2,), 0.4551235014298542], [trev.transform_joe, 0.5, 0.9, (0.5, 0.75, 1 / 0.25), 0.4543698299835434], [trev.transform_joe, 0.9, 0.5, (0.5, 0.75, 1 / 0.25), 0.4539773435983587], [trev.transform_tev, 0.5, 0.75, (0.8, 4), 0.456807960674953], [trev.transform_tev, 0.5, 0.9, (0.8, 4), 0.4911039761533587]]
ev_dep_list = [[trev.transform_tawn, 0.5, 0.9, (0.5, 0.5, 0.5), 0.4724570876035117, [0.8952847075210475, 0.8535533905932737, 0.8952847075210475]], [trev.transform_tawn, 0.5, 0.9, (0.5, 0.75, 0.25), 0.4724570876035117, [0.8753426223607659, 0.7672861240893745, 0.8182268471629245]], [trev.transform_tawn2, 0.4, 0.9, (0.3, 0.2), 0, [0.8968750000000001, 0.85, 0.8781249999999999]], [trev.transform_hr, 0.5, 0.9, (1 / 2,), 0.4551235014298542, [0.7774638908611127, 0.691462461274013, 0.7774638908611127]], [trev.transform_joe, 0.5, 0.9, (0.5, 0.75, 1 / 0.75), 0.0, [0.9139915932031195, 0.8803412942173715, 0.8993537417026507]]]
cop_list = [[tra.TransfFrank, [0.5, 0.9], (2,), 0.4710805107852225, 0.9257812360337806, FrankCopula], [tra.TransfGumbel, [0.5, 0.9], (2,), 0.4960348880595387, 0.3973548776136501, GumbelCopula], [tra.TransfClayton, [0.5, 0.9], (2,), 0.485954322440435, 0.8921974147432954, ClaytonCopula], [tra.TransfIndep, [0.5, 0.5], (), 0.25, 1, IndependenceCopula]]
copk_list = [[tra.TransfGumbel, [0.6, 0.5, 0.9], (2,), 0.4200146617837097, 0.7507987484870147, GumbelCopula], [tra.TransfClayton, [0.6, 0.5, 0.9], (2,), 0.4078289289864994, 1.430033358494079, ClaytonCopula], [tra.TransfFrank, [0.6, 0.5, 0.9], (2,), 0.3397845258821868, 1.123811705698149, FrankCopula], [tra.TransfGumbel, [0.6, 0.5, 0.9, 0.1], (2,), 0.08538643946528957, 0.05130542596740889, GumbelCopula], [tra.TransfClayton, [0.6, 0.5, 0.9, 0.1], (2,), 0.09758427058689817, 0.00428071573295176, ClaytonCopula], [tra.TransfFrank, [0.6, 0.5, 0.9, 0.1], (2,), 0.05456579067435671, 0.4089534511841545, FrankCopula], [tra.TransfIndep, [0.5, 0.5, 0.5, 0.5], (), 0.0625, 1, IndependenceCopula]]
cop_2d = [[tra.TransfFrank, (2,), FrankCopula], [tra.TransfGumbel, (2,), GumbelCopula]]
gev_list = [[trev.transform_tawn, 0.5, 0.9, (0.5, 0.75, 0.25), 0.4868879662205026, 0.464615422654154, 0.1897142141905908], [trev.transform_tawn2, 0.4, 0.9, (0.3, 0.2), 0.3838690483829361, 0.3989785485000293, 0.1084278364284748], [trev.transform_hr, 0.4, 0.9, (2,), 0.36459381872178737, 0.3487937249989757, 0.09305880295825367], [trev.transform_joe, 0.4, 0.9, (0.5, 0.75, 1 / 0.25), 0.3639112521665616, 0.3475263177955295, 0.09316705199822513]]
...
extrali = [[trev.transform_tawn, 0.5, 0.9, (0.8, 0.5, 0.75), 0.4724570876035117], [trev.transform_tawn, 0.5, 0.9, (0.5, 0.75, 0.5), 0.4724570876035117], [trev.transform_tawn, 0.6, 0.4, (0.2, 0.7, 0.6), 0.4724570876035117]]
...
class CheckCopula:
    ...
    copula = None
    dim = None
    u = np.array([[0.33706249, 0.6075078], [0.62232507, 0.06241089], [0.2001457, 0.54027684], [0.77166391, 0.40610225], [0.98534253, 0.99212789], [0.72755898, 0.25913165], [0.05943888, 0.61044613], [0.0962475, 0.67585563], [0.35496733, 0.79584436], [0.44513594, 0.23050014]])
    pdf_u = None
    cdf_u = None
...
class TestGaussianCopula(CheckCopula):
    ...
    dim = 2
    pdf_u = [1.03308741, 0.06507279, 0.72896012, 0.65389439, 16.45012399, 0.34813218, 0.06768115, 0.0816884, 0.40521741, 1.2672347]
    cdf_u = [0.31906854, 0.06230196, 0.19284669, 0.39952707, 0.98144792, 0.25677003, 0.05932818, 0.09605404, 0.35211017, 0.2088548]
...
class TestGaussianCopula3d(CheckRvsDim):
    copula = GaussianCopula(corr=[[1.0, 0.8, 0.1], [0.8, 1.0, 0.3], [0.1, 0.3, 1.0]], k_dim=3)
    dim = 3
    use_pdf = False
...
class TestStudentTCopula(CheckCopula):
    ...
    dim = 2
    pdf_u = [0.8303065, 0.1359839, 0.5157746, 0.4776421, 26.2173959, 0.3070661, 0.1349173, 0.1597064, 0.330323, 1.0482301]
    cdf_u = [0.31140349, 0.05942746, 0.18548601, 0.39143974, 0.98347259, 0.24894028, 0.05653947, 0.09210693, 0.34447385, 0.20429882]
...
class TestStudentTCopula3d(CheckRvsDim):
    copula = StudentTCopula(corr=[[1.0, 0.8, 0.1], [0.8, 1.0, 0.3], [0.1, 0.3, 1.0]], k_dim=3, df=10)
    dim = 3
    use_pdf = True
...
class TestClaytonCopula(CheckModernCopula):
    ...
    dim = 2
    pdf_u = [1.0119836, 0.2072728, 0.8148839, 0.9481976, 2.1419659, 0.6828507, 0.2040454, 0.2838497, 0.8197787, 1.109636]
    cdf_u = [0.28520375, 0.0610169, 0.17703377, 0.36848218, 0.97772088, 0.24082057, 0.05811908, 0.09343934, 0.33012582, 0.18738753]
...
class TestFrankCopula(CheckModernCopula):
    ...
    dim = 2
    pdf_u = [0.9646599, 0.5627195, 0.8941964, 0.8364614, 2.9570945, 0.6665601, 0.5779906, 0.5241333, 0.7156741, 1.1074024]
    cdf_u = [0.27467496, 0.05492539, 0.15995939, 0.36750702, 0.97782283, 0.23412757, 0.05196265, 0.08676979, 0.32803721, 0.1632073]
...
class TestGumbelCopula(CheckModernCopula):
    ...
    dim = 2
    pdf_u = [1.0391696, 0.6539579, 0.9878446, 0.8679504, 16.6030932, 0.7542073, 0.6668307, 0.6275887, 0.7477991, 1.1564864]
    cdf_u = [0.27194634, 0.0548438, 0.1566819, 0.3709842, 0.98176346, 0.23422865, 0.0518826, 0.08659615, 0.3308696, 0.15803914]
