...
from sslyze.plugins.plugin_base import ScanCommandResult, ScanCommandImplementation, ScanCommandExtraArgument, ScanJob, ScanCommandCliConnector, OptParseCliOption, ScanJobResult
from sslyze.plugins.session_resumption._resumption_with_id import resume_with_session_id, _ScanJobResultEnum, TlsResumptionSupportEnum, ServerOnlySupportsTls13
...
class _SessionResumptionSupportCliConnector(ScanCommandCliConnector[SessionResumptionSupportScanResult, SessionResumptionSupportExtraArgument]):
    _cli_option = 'resum'
...
class SessionResumptionSupportImplementation(ScanCommandImplementation[SessionResumptionSupportScanResult, SessionResumptionSupportExtraArgument]):
