...
class CoreQualityOfServiceSpec(object):
    ...
    attribute_map = {'queueing_budget': 'queueing_budget'}

    def __init__(self, queueing_budget=None):
        if False:
            while True:
                i = 10
        'CoreQualityOfServiceSpec - a model defined in Swagger'
    ...
    def to_dict(self):
        ...
        for (attr, _) in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreQualityOfServiceSpec, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreQualityOfServiceSpec):
            return False
