...
arrow.marshall(DF_DELTA_MSG.delta.new_element.arrow_data_frame, {'col1': [0, 1, 2], 'col2': [10, 11, 12]})
DF_DELTA_MSG.metadata.delta_path[:] = make_delta_path(RootContainer.MAIN, (), 0)
ADD_ROWS_MSG = ForwardMsg()
arrow.marshall(ADD_ROWS_MSG.delta.arrow_add_rows.data, {'col1': [3, 4, 5], 'col2': [13, 14, 15]})
