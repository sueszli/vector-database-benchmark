...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(convert_pages_html_to_json), migrations.RunPython(sanitize_pages_json), migrations.AlterField(model_name='page', name='content_json', field=SanitizedJSONField(blank=True, default=dict, sanitizer=clean_draft_js)), migrations.AlterField(model_name='pagetranslation', name='content_json', field=SanitizedJSONField(blank=True, default=dict, sanitizer=clean_draft_js))]