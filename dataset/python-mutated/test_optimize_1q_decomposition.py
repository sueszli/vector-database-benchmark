...
from qiskit.circuit.library.standard_gates import UGate, SXGate, PhaseGate, U3Gate, U2Gate, U1Gate, RZGate, RXGate, RYGate, HGate
...
u2_props = {(0,): InstructionProperties(error=0.0001)}
u3_props = {(0,): InstructionProperties(error=0.0002)}
target_u1_u2_u3 = Target()
target_u1_u2_u3.add_instruction(U1Gate(θ), u1_props, name='u1')
target_u1_u2_u3.add_instruction(U2Gate(θ, φ), u2_props, name='u2')
target_u1_u2_u3.add_instruction(U3Gate(θ, φ, λ), u3_props, name='u3')
rz_props = {(0,): InstructionProperties(duration=0, error=0)}
rx_props = {(0,): InstructionProperties(duration=5e-09, error=0.00025)}
target_rz_rx = Target()
target_rz_rx.add_instruction(RZGate(θ), rz_props, name='rz')
target_rz_rx.add_instruction(RXGate(θ), rx_props, name='rx')
rz_props = {(0,): InstructionProperties(duration=0, error=0)}
sx_props = {(0,): InstructionProperties(duration=5e-09, error=0.00025)}
target_rz_sx = Target()
target_rz_sx.add_instruction(RZGate(θ), rz_props, name='rz')
target_rz_sx.add_instruction(SXGate(), sx_props, name='sx')
rz_props = {(0,): InstructionProperties(duration=1e-09, error=0.0001)}
ry_props = {(0,): InstructionProperties(duration=5e-09, error=0.0002)}
u_props = {(0,): InstructionProperties(duration=9e-09, error=0.0005)}
...
target_rz_ry_u.add_instruction(UGate(θ, φ, λ), u_props, name='u')
h_props = {(0,): InstructionProperties(duration=3e-09, error=0.0003)}
...
target_rz_ry_u_noerror.add_instruction(UGate(θ, φ, λ), u_props, name='u')
