...
class CreateDataScanRequest(proto.Message):
    ...
    data_scan: 'DataScan' = proto.Field(proto.MESSAGE, number=2, message='DataScan')
    data_scan_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateDataScanRequest(proto.Message):
    ...
    Attributes:
        ...
        validate_only (bool):
            ...
            mutations. The default is ``false``.
    """
    data_scan: 'DataScan' = proto.Field(proto.MESSAGE, number=1, message='DataScan')
...
class GetDataScanRequest(proto.Message):
    ...
    class DataScanView(proto.Enum):
        ...
        FULL = 10
    name: str = proto.Field(proto.STRING, number=1)
    view: DataScanView = proto.Field(proto.ENUM, number=2, enum=DataScanView)
...
class ListDataScansResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    data_scans: MutableSequence['DataScan'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataScan')
...
class RunDataScanResponse(proto.Message):
    ...
    """
    job: 'DataScanJob' = proto.Field(proto.MESSAGE, number=1, message='DataScanJob')
...
class GetDataScanJobRequest(proto.Message):
    ...
    class DataScanJobView(proto.Enum):
        ...
        FULL = 10
    name: str = proto.Field(proto.STRING, number=1)
    view: DataScanJobView = proto.Field(proto.ENUM, number=2, enum=DataScanJobView)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    data_scan_jobs: MutableSequence['DataScanJob'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataScanJob')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class DataScan(proto.Message):
    ...
    class ExecutionSpec(proto.Message):
        ...
        """
        trigger: processing.Trigger = proto.Field(proto.MESSAGE, number=1, message=processing.Trigger)
        field: str = proto.Field(proto.STRING, number=100, oneof='incremental')
    ...
    class ExecutionStatus(proto.Message):
        ...
        """
        latest_job_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
        latest_job_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    name: str = proto.Field(proto.STRING, number=1)
    ...
    state: resources.State = proto.Field(proto.ENUM, number=6, enum=resources.State)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    data: processing.DataSource = proto.Field(proto.MESSAGE, number=9, message=processing.DataSource)
    execution_spec: ExecutionSpec = proto.Field(proto.MESSAGE, number=10, message=ExecutionSpec)
    execution_status: ExecutionStatus = proto.Field(proto.MESSAGE, number=11, message=ExecutionStatus)
    type_: 'DataScanType' = proto.Field(proto.ENUM, number=12, enum='DataScanType')
    data_quality_spec: data_quality.DataQualitySpec = proto.Field(proto.MESSAGE, number=100, oneof='spec', message=data_quality.DataQualitySpec)
    data_profile_spec: data_profile.DataProfileSpec = proto.Field(proto.MESSAGE, number=101, oneof='spec', message=data_profile.DataProfileSpec)
    data_quality_result: data_quality.DataQualityResult = proto.Field(proto.MESSAGE, number=200, oneof='result', message=data_quality.DataQualityResult)
    data_profile_result: data_profile.DataProfileResult = proto.Field(proto.MESSAGE, number=201, oneof='result', message=data_profile.DataProfileResult)
...
class DataScanJob(proto.Message):
    ...
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    state: State = proto.Field(proto.ENUM, number=5, enum=State)
    message: str = proto.Field(proto.STRING, number=6)
    type_: 'DataScanType' = proto.Field(proto.ENUM, number=7, enum='DataScanType')
    data_quality_spec: data_quality.DataQualitySpec = proto.Field(proto.MESSAGE, number=100, oneof='spec', message=data_quality.DataQualitySpec)
    data_profile_spec: data_profile.DataProfileSpec = proto.Field(proto.MESSAGE, number=101, oneof='spec', message=data_profile.DataProfileSpec)
    data_quality_result: data_quality.DataQualityResult = proto.Field(proto.MESSAGE, number=200, oneof='result', message=data_quality.DataQualityResult)
    data_profile_result: data_profile.DataProfileResult = proto.Field(proto.MESSAGE, number=201, oneof='result', message=data_profile.DataProfileResult)
