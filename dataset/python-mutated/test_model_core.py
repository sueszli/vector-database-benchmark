...
class TestFileLocation(object):
    ordered_locations1 = [FileLocation('features/alice.feature', 1), FileLocation('features/alice.feature', 5), FileLocation('features/alice.feature', 10), FileLocation('features/alice.feature', 11), FileLocation('features/alice.feature', 100)]
    ordered_locations2 = [FileLocation('features/alice.feature', 1), FileLocation('features/alice.feature', 10), FileLocation('features/bob.feature', 5), FileLocation('features/charly.feature', None), FileLocation('features/charly.feature', 0), FileLocation('features/charly.feature', 100)]
    same_locations = [(FileLocation('alice.feature'), FileLocation('alice.feature', None)), (FileLocation('alice.feature', 10), FileLocation('alice.feature', 10)), (FileLocation('features/bob.feature', 11), FileLocation('features/bob.feature', 11))]
