...
from dagster._cli.workspace.cli_target import get_external_repository_from_kwargs, get_workspace_from_kwargs, repository_target_argument
...
def successfully_load_repository_via_cli(cli_args, repo_assert_fn=None):
    ...
    return result
PYTHON_FILE_IN_NAMED_LOCATION_WORKSPACE = file_relative_path(__file__, 'hello_world_in_file/python_file_with_named_location_workspace.yaml')
