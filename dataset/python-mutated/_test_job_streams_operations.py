...
from ...operations._test_job_streams_operations import build_get_request, build_list_by_test_job_request
...
class TestJobStreamsOperations:
    ...
    async def get(self, resource_group_name: str, automation_account_name: str, runbook_name: str, job_stream_id: str, **kwargs: Any) -> _models.JobStream:
        ...
        request = build_get_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, runbook_name=runbook_name, job_stream_id=job_stream_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
