...
from impacket.dcerpc.v5.dtypes import NULL, DWORD, LPWSTR, ULONG, BOOL, LPBYTE, ULONGLONG, PGUID, USHORT, LPDWORD, WSTR, GUID, PBOOL, WIDESTR
...
SERVICE_START = 16
SERVICE_STOP = 32
SERVICE_USER_DEFINED_CTRL = 256
SERVICE_SET_STATUS = 32768
SC_MANAGER_LOCK = 8
...
ERVICE_ACCEPT_TRIGGEREVENT = 1024
...
SERVICE_CONFIG_RUNLEVEL_INFO = 10
SC_ACTION_NONE = 0
SC_ACTION_RESTART = 1
SC_ACTION_REBOOT = 2
...
SERVICE_STOP_CUSTOM = 536870912
SERVICE_STOP_PLANNED = 1073741824
SERVICE_STOP_UNPLANNED = 268435456
...
SERVICE_TRIGGER_TYPE_CUSTOM = 32
...
class SERVICE_STATUS(NDRSTRUCT):
    structure = (('dwServiceType', DWORD), ('dwCurrentState', DWORD), ('dwControlsAccepted', DWORD), ('dwWin32ExitCode', DWORD), ('dwServiceSpecificExitCode', DWORD), ('dwCheckPoint', DWORD), ('dwWaitHint', DWORD))

class QUERY_SERVICE_CONFIGW(NDRSTRUCT):
    structure = (('dwServiceType', DWORD), ('dwStartType', DWORD), ('dwErrorControl', DWORD), ('lpBinaryPathName', LPWSTR), ('lpLoadOrderGroup', LPWSTR), ('dwTagId', DWORD), ('lpDependencies', LPWSTR), ('lpServiceStartName', LPWSTR), ('lpDisplayName', LPWSTR))
...
class ENUM_SERVICE_STATUSW(NDRSTRUCT):
    structure = (('lpServiceName', LPWSTR), ('lpDisplayName', LPWSTR), ('ServiceStatus', SERVICE_STATUS))
...
class QUERY_SERVICE_LOCK_STATUSW(NDRSTRUCT):
    structure = (('fIsLocked', DWORD), ('lpLockOwner', LPWSTR), ('dwLockDuration', DWORD))
...
class SERVICE_FAILURE_ACTIONS_WOW64(NDRSTRUCT):
    structure = (('dwResetPeriod', DWORD), ('dwRebootMsgOffset', DWORD), ('dwCommandOffset', DWORD), ('cActions', DWORD), ('dwsaActionsOffset', DWORD))

class SC_ACTION(NDRSTRUCT):
    structure = (('Type', DWORD), ('Delay', DWORD))
...
class SERVICE_FAILURE_ACTIONSW(NDRSTRUCT):
    structure = (('dwResetPeriod', DWORD), ('lpRebootMsg', LPWSTR), ('lpCommand', LPWSTR), ('cActions', DWORD), ('lpsaActions', SC_ACTIONS))
...
class SERVICE_RPC_REQUIRED_PRIVILEGES_INFO(NDRSTRUCT):
    structure = (('cbRequiredPrivileges', DWORD), ('pRequiredPrivileges', LPBYTE))
...
class SERVICE_STATUS_PROCESS(NDRSTRUCT):
    structure = (('dwServiceType', DWORD), ('dwCurrentState', DWORD), ('dwControlsAccepted', DWORD), ('dwWin32ExitCode', DWORD), ('dwServiceSpecificExitCode', DWORD), ('dwCheckPoint', DWORD), ('dwWaitHint', DWORD), ('dwProcessId', DWORD), ('dwServiceFlags', DWORD))
...
class SERVICE_NOTIFY_STATUS_CHANGE_PARAMS_1(NDRSTRUCT):
    structure = (('ullThreadId', ULONGLONG), ('dwNotifyMask', DWORD), ('CallbackAddressArray', UCHAR_16), ('CallbackParamAddressArray', UCHAR_16), ('ServiceStatus', SERVICE_STATUS_PROCESS), ('dwNotificationStatus', DWORD), ('dwSequence', DWORD))

class SERVICE_NOTIFY_STATUS_CHANGE_PARAMS_2(NDRSTRUCT):
    structure = (('ullThreadId', ULONGLONG), ('dwNotifyMask', DWORD), ('CallbackAddressArray', UCHAR_16), ('CallbackParamAddressArray', UCHAR_16), ('ServiceStatus', SERVICE_STATUS_PROCESS), ('dwNotificationStatus', DWORD), ('dwSequence', DWORD), ('dwNotificationTriggered', DWORD), ('pszServiceNames', LPWSTR))
...
class SC_RPC_NOTIFY_PARAMS(NDRUNION):
    union = {1: ('pStatusChangeParam1', PSERVICE_NOTIFY_STATUS_CHANGE_PARAMS_1), 2: ('pStatusChangeParams', PSERVICE_NOTIFY_STATUS_CHANGE_PARAMS_2)}
...
class PSC_RPC_NOTIFY_PARAMS_LIST(NDRSTRUCT):
    structure = (('cElements', BOUNDED_DWORD_4K), ('NotifyParamsArray', SC_RPC_NOTIFY_PARAMS_ARRAY))

class SERVICE_CONTROL_STATUS_REASON_IN_PARAMSW(NDRSTRUCT):
    structure = (('dwReason', DWORD), ('pszComment', LPWSTR))

class SERVICE_TRIGGER_SPECIFIC_DATA_ITEM(NDRSTRUCT):
    structure = (('dwDataType', DWORD), ('cbData', DWORD), ('pData', LPBYTE))
...
class SERVICE_TRIGGER(NDRSTRUCT):
    structure = (('dwTriggerType', DWORD), ('dwAction', DWORD), ('pTriggerSubtype', PGUID), ('cDataItems', DWORD), ('pDataItems', PSERVICE_TRIGGER_SPECIFIC_DATA_ITEM))
...
class SERVICE_TRIGGER_INFO(NDRSTRUCT):
    structure = (('cTriggers', DWORD), ('pTriggers', PSERVICE_TRIGGER), ('pReserved', NDRPOINTERNULL))
...
class SERVICE_PREFERRED_NODE_INFO(NDRSTRUCT):
    structure = (('usPreferredNode', USHORT), ('fDelete', BOOL))
...
class RCloseServiceHandleResponse(NDRCALL):
    structure = (('hSCObject', SC_RPC_HANDLE), ('ErrorCode', DWORD))

class RControlService(NDRCALL):
    opnum = 1
    structure = (('hService', SC_RPC_HANDLE), ('dwControl', DWORD))

class RControlServiceResponse(NDRCALL):
    structure = (('lpServiceStatus', SERVICE_STATUS), ('ErrorCode', DWORD))
...
class RLockServiceDatabaseResponse(NDRCALL):
    structure = (('lpLock', SC_RPC_LOCK), ('ErrorCode', DWORD))

class RQueryServiceObjectSecurity(NDRCALL):
    opnum = 4
    structure = (('hService', SC_RPC_HANDLE), ('dwSecurityInformation', SECURITY_INFORMATION), ('cbBufSize', DWORD))

class RQueryServiceObjectSecurityResponse(NDRCALL):
    structure = (('lpSecurityDescriptor', BYTE_ARRAY), ('pcbBytesNeeded', BOUNDED_DWORD_256K), ('ErrorCode', DWORD))

class RSetServiceObjectSecurity(NDRCALL):
    opnum = 5
    structure = (('hService', SC_RPC_HANDLE), ('dwSecurityInformation', SECURITY_INFORMATION), ('lpSecurityDescriptor', LPBYTE), ('cbBufSize', DWORD))
...
class RSetServiceStatus(NDRCALL):
    opnum = 7
    structure = (('hServiceStatus', SC_RPC_HANDLE), ('lpServiceStatus', SERVICE_STATUS))
...
class RUnlockServiceDatabaseResponse(NDRCALL):
    structure = (('Lock', SC_RPC_LOCK), ('ErrorCode', DWORD))

class RNotifyBootConfigStatus(NDRCALL):
    opnum = 9
    structure = (('lpMachineName', SVCCTL_HANDLEW), ('BootAcceptable', DWORD))
...
class RChangeServiceConfigW(NDRCALL):
    opnum = 11
    structure = (('hService', SC_RPC_HANDLE), ('dwServiceType', DWORD), ('dwStartType', DWORD), ('dwErrorControl', DWORD), ('lpBinaryPathName', LPWSTR), ('lpLoadOrderGroup', LPWSTR), ('lpdwTagId', LPDWORD), ('lpDependencies', LPBYTE), ('dwDependSize', DWORD), ('lpServiceStartName', LPWSTR), ('lpPassword', LPBYTE), ('dwPwSize', DWORD), ('lpDisplayName', LPWSTR))

class RChangeServiceConfigWResponse(NDRCALL):
    structure = (('lpdwTagId', LPDWORD), ('ErrorCode', DWORD))
...
class RCreateServiceWResponse(NDRCALL):
    structure = (('lpdwTagId', LPWSTR), ('lpServiceHandle', SC_RPC_HANDLE), ('ErrorCode', DWORD))

class REnumDependentServicesW(NDRCALL):
    opnum = 13
    structure = (('hService', SC_RPC_HANDLE), ('dwServiceState', DWORD), ('cbBufSize', DWORD))

class REnumDependentServicesWResponse(NDRCALL):
    structure = (('lpServices', NDRUniConformantArray), ('pcbBytesNeeded', BOUNDED_DWORD_256K), ('lpServicesReturned', BOUNDED_DWORD_256K), ('ErrorCode', DWORD))

class REnumServicesStatusW(NDRCALL):
    opnum = 14
    structure = (('hSCManager', SC_RPC_HANDLE), ('dwServiceType', DWORD), ('dwServiceState', DWORD), ('cbBufSize', DWORD), ('lpResumeIndex', LPBOUNDED_DWORD_256K))

class REnumServicesStatusWResponse(NDRCALL):
    structure = (('lpBuffer', NDRUniConformantArray), ('pcbBytesNeeded', BOUNDED_DWORD_256K), ('lpServicesReturned', BOUNDED_DWORD_256K), ('lpResumeIndex', LPBOUNDED_DWORD_256K), ('ErrorCode', DWORD))

class ROpenSCManagerW(NDRCALL):
    opnum = 15
    structure = (('lpMachineName', SVCCTL_HANDLEW), ('lpDatabaseName', LPWSTR), ('dwDesiredAccess', DWORD))

class ROpenSCManagerWResponse(NDRCALL):
    structure = (('lpScHandle', SC_RPC_HANDLE), ('ErrorCode', DWORD))

class ROpenServiceW(NDRCALL):
    opnum = 16
    structure = (('hSCManager', SC_RPC_HANDLE), ('lpServiceName', WSTR), ('dwDesiredAccess', DWORD))

class ROpenServiceWResponse(NDRCALL):
    structure = (('lpServiceHandle', SC_RPC_HANDLE), ('ErrorCode', DWORD))

class RQueryServiceConfigW(NDRCALL):
    opnum = 17
    structure = (('hService', SC_RPC_HANDLE), ('cbBufSize', DWORD))

class RQueryServiceConfigWResponse(NDRCALL):
    structure = (('lpServiceConfig', QUERY_SERVICE_CONFIGW), ('pcbBytesNeeded', BOUNDED_DWORD_8K), ('ErrorCode', DWORD))

class RQueryServiceLockStatusW(NDRCALL):
    opnum = 18
    structure = (('hSCManager', SC_RPC_HANDLE), ('cbBufSize', DWORD))

class RQueryServiceLockStatusWResponse(NDRCALL):
    structure = (('lpLockStatus', QUERY_SERVICE_LOCK_STATUSW), ('pcbBytesNeeded', BOUNDED_DWORD_4K), ('ErrorCode', DWORD))

class RStartServiceW(NDRCALL):
    opnum = 19
    structure = (('hService', SC_RPC_HANDLE), ('argc', DWORD), ('argv', UNIQUE_STRING_PTRSW))
...
class RGetServiceDisplayNameW(NDRCALL):
    opnum = 20
    structure = (('hSCManager', SC_RPC_HANDLE), ('lpServiceName', WSTR), ('lpcchBuffer', DWORD))

class RGetServiceDisplayNameWResponse(NDRCALL):
    structure = (('lpDisplayName', WSTR), ('lpcchBuffer', DWORD), ('ErrorCode', DWORD))

class RGetServiceKeyNameW(NDRCALL):
    opnum = 21
    structure = (('hSCManager', SC_RPC_HANDLE), ('lpDisplayName', WSTR), ('lpcchBuffer', DWORD))
...
class REnumServiceGroupW(NDRCALL):
    opnum = 35
    structure = (('hSCManager', SC_RPC_HANDLE), ('dwServiceType', DWORD), ('dwServiceState', DWORD), ('cbBufSize', DWORD), ('lpResumeIndex', LPBOUNDED_DWORD_256K), ('pszGroupName', LPWSTR))

class REnumServiceGroupWResponse(NDRCALL):
    structure = (('lpBuffer', LPBYTE), ('pcbBytesNeeded', BOUNDED_DWORD_256K), ('lpServicesReturned', BOUNDED_DWORD_256K), ('lpResumeIndex', BOUNDED_DWORD_256K), ('ErrorCode', DWORD))

class RChangeServiceConfig2W(NDRCALL):
    opnum = 37
    structure = (('hService', SC_RPC_HANDLE), ('Info', SC_RPC_CONFIG_INFOW))
...
class RQueryServiceConfig2W(NDRCALL):
    opnum = 39
    structure = (('hService', SC_RPC_HANDLE), ('dwInfoLevel', DWORD), ('cbBufSize', DWORD))

class RQueryServiceConfig2WResponse(NDRCALL):
    structure = (('lpBuffer', NDRUniConformantArray), ('pcbBytesNeeded', BOUNDED_DWORD_8K), ('ErrorCode', DWORD))

class RQueryServiceStatusEx(NDRCALL):
    opnum = 40
    structure = (('hService', SC_RPC_HANDLE), ('InfoLevel', DWORD), ('cbBufSize', DWORD))
...
class REnumServicesStatusExW(NDRCALL):
    opnum = 42
    structure = (('hSCManager', SC_RPC_HANDLE), ('InfoLevel', DWORD), ('dwServiceType', DWORD), ('dwServiceState', DWORD), ('cbBufSize', DWORD), ('lpResumeIndex', LPBOUNDED_DWORD_256K), ('pszGroupName', LPWSTR))

class REnumServicesStatusExWResponse(NDRCALL):
    structure = (('lpBuffer', NDRUniConformantArray), ('pcbBytesNeeded', BOUNDED_DWORD_256K), ('lpServicesReturned', BOUNDED_DWORD_256K), ('lpResumeIndex', BOUNDED_DWORD_256K), ('ErrorCode', DWORD))
...
class RNotifyServiceStatusChange(NDRCALL):
    opnum = 47
    structure = (('hService', SC_RPC_HANDLE), ('NotifyParams', SC_RPC_NOTIFY_PARAMS), ('pClientProcessGuid', GUID))

class RNotifyServiceStatusChangeResponse(NDRCALL):
    structure = (('pSCMProcessGuid', GUID), ('pfCreateRemoteQueue', PBOOL), ('phNotify', SC_NOTIFY_RPC_HANDLE), ('ErrorCode', DWORD))
...
class RGetNotifyResultsResponse(NDRCALL):
    structure = (('ppNotifyParams', PSC_RPC_NOTIFY_PARAMS_LIST), ('ErrorCode', DWORD))
