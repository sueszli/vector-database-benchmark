...
from .const import CHAR_NAME, CHAR_PROGRAMMABLE_SWITCH_EVENT, CHAR_SERVICE_LABEL_INDEX, CHAR_SERVICE_LABEL_NAMESPACE, SERV_SERVICE_LABEL, SERV_STATELESS_PROGRAMMABLE_SWITCH
...
class DeviceTriggerAccessory(HomeAccessory):
    ...
    async def run(self) -> None:
        ...
        self._remove_triggers = await async_initialize_triggers(self.hass, self._device_triggers, self.async_trigger, 'homekit', self.display_name, _LOGGER.log)
