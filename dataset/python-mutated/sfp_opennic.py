...
class sfp_opennic(SpiderFootPlugin):
    meta = {'name': 'OpenNIC DNS', 'summary': 'Resolves host names in the OpenNIC alternative DNS system.', 'flags': [], 'useCases': ['Investigate', 'Footprint', 'Passive'], 'categories': ['DNS'], 'dataSource': {'website': 'https://www.opennic.org/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://wiki.opennic.org/', 'https://servers.opennic.org'], 'description': 'An organization of hobbyists who run an alternative DNS network, also provides access to domains not administered by ICANN.'}}
