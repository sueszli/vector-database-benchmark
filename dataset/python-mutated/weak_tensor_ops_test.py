...
_TF_UNARY_APIS_SPECIFIC_DTYPE = [math_ops.to_float, math_ops.to_double, math_ops.to_int32, math_ops.to_int64, math_ops.to_bfloat16, math_ops.to_complex64, math_ops.to_complex128]
_TF_UNARY_APIS_WITH_MULT_INPUT = [gen_array_ops.check_numerics, image_ops.random_brightness, image_ops.stateless_random_brightness, image_ops.adjust_brightness, clip_ops.clip_by_value, np_array_ops.expand_dims, np_array_ops.full_like, np_array_ops.moveaxis, np_array_ops.repeat, np_array_ops.reshape, np_array_ops.swapaxes, array_ops.reshape, array_ops.depth_to_space, array_ops.depth_to_space_v2, array_ops.expand_dims, array_ops.expand_dims_v2, array_ops.extract_image_patches, array_ops.extract_image_patches_v2, array_ops.space_to_depth, array_ops.space_to_depth_v2, math_ops.scalar_mul, math_ops.scalar_mul_v2]
_TF_UNARY_APIS_WITH_INT_INPUT = [gen_bitwise_ops.invert, np_math_ops.bitwise_not, np_array_ops.arange]
_TF_UNARY_APIS_WITH_2D_INPUT = [np_math_ops.trace, np_array_ops.diagonal, np_array_ops.flip, np_array_ops.fliplr, np_array_ops.flipud, np_array_ops.rot90, np_array_ops.triu, math_ops.trace, array_ops.matrix_diag, array_ops.matrix_diag_part, array_ops.matrix_transpose, array_ops.tensor_diag_part, array_ops.transpose, array_ops.transpose_v2]
...
class WeakTensorUnaryOpsTest(test_util.TensorFlowTestCase, parameterized.TestCase):
...
class WeakTensorBinaryOpsTest(test_util.TensorFlowTestCase, parameterized.TestCase):
...
class WeakTensorBinaryOpsTestSafeMode(test_util.TensorFlowTestCase, parameterized.TestCase):
