...
from modelscope.models.multi_modal.image_to_video.modules import AutoencoderKL, FrozenOpenCLIPVisualEmbedder, Img2VidSDUNet
...
@MODELS.register_module(Tasks.image_to_video, module_name=Models.image_to_video_model)
