...
functional_key_name_aliases: Dict[str, str] = {'ESC': 'ESCAPE', 'PGUP': 'PAGE_UP', 'PAGEUP': 'PAGE_UP', 'PGDN': 'PAGE_DOWN', 'PAGEDOWN': 'PAGE_DOWN', 'RETURN': 'ENTER', 'ARROWUP': 'UP', 'ARROWDOWN': 'DOWN', 'ARROWRIGHT': 'RIGHT', 'ARROWLEFT': 'LEFT', 'DEL': 'DELETE', 'KP_PLUS': 'KP_ADD', 'KP_MINUS': 'KP_SUBTRACT'}
character_key_name_aliases: Dict[str, str] = {'SPC': ' ', 'SPACE': ' ', 'STAR': '*', 'MULTIPLY': '*', 'PLUS': '+', 'MINUS': '-', 'BAR': '|', 'PIPE': '|', 'HYPHEN': '-', 'EQUAL': '=', 'UNDERSCORE': '_', 'COMMA': ',', 'PERIOD': '.', 'DOT': '.', 'SLASH': '/', 'BACKSLASH': '\\', 'TILDE': '~', 'GRAVE': '`', 'GRAVE_ACCENT': '`', 'APOSTROPHE': "'", 'SEMICOLON': ';', 'COLON': ':', 'LEFT_BRACKET': '[', 'RIGHT_BRACKET': ']'}
