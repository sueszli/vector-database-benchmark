...
class IncidentSubscriptionPermission(IncidentPermission):
    ...
    scope_map['DELETE'] = ['org:write', 'org:admin', 'project:read', 'project:write', 'project:admin']

@region_silo_endpoint
class OrganizationIncidentSubscriptionIndexEndpoint(IncidentEndpoint):
    publish_status = {'DELETE': ApiPublishStatus.UNKNOWN, 'POST': ApiPublishStatus.UNKNOWN}
