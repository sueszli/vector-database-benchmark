...
class ParamountNetworkIE(MTVServicesInfoExtractor):
    ...
    def _get_feed_query(self, uri):
        if False:
            while True:
                i = 10
        return {'arcEp': 'paramountnetwork.com', 'imageEp': 'paramountnetwork.com', 'mgid': uri}