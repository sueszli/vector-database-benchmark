...
async def test_unmount():
    ...
    expected = ['UnmountWidget#bar1-True-0', 'UnmountWidget#bar2-True-0', 'UnmountWidget#baz1-True-0', 'UnmountWidget#baz2-True-0', 'UnmountWidget#bar-True-0', 'UnmountWidget#baz-True-0', 'UnmountWidget#top-True-0', 'MyScreen#main']
