...
if __name__ == '__main__':
    ...
    assert num_nodes >= num_remote_nodes + 1, f'Expect {num_remote_nodes + 1}, but only {num_nodes} joined.'
    ...
    if os.environ.get('IS_SMOKE_TEST') != '1':
        result['perf_metrics'] = [{'perf_metric_name': 'avg_iteration_time', 'perf_metric_value': result['avg_iteration_time'], 'perf_metric_type': 'LATENCY'}]
    print('PASSED.')
