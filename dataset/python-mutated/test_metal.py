...
class TestMetalRewritePass(TestCase):
    ...
    def test_conv(self):
        ...
        pattern_count_map = {'Tensor = aten::conv2d': -1, 'metal_prepack::conv2d_prepack': 1, 'metal_prepack::conv2d_run': 1}
        ...
        data_shape = (batch_size, input_channels, height, width)
        pattern_count_map = {'Tensor = aten::conv2d': -1, 'metal_prepack::conv2d_prepack': 1, 'metal_prepack::conv2d_run': 1}
        TestMetalRewritePass.validate_transformed_module(Conv2DRelu(), pattern_count_map, data_shape)
        pattern_count_map['aten::relu'] = 1
        pattern_count_map['metal_prepack::conv2d_prepack'] = -1
        TestMetalRewritePass.validate_transformed_module(Conv2DRelu(), pattern_count_map, data_shape, prepack_removal=True)
        pattern_count_map['aten::relu'] = -1
        TestMetalRewritePass.validate_transformed_module(Conv2DRelu(), pattern_count_map, data_shape, prepack_removal=True, fuse_clamping_ops=True)
        ...
        pattern_count_map['metal_prepack::conv2d_prepack'] = -1
        TestMetalRewritePass.validate_transformed_module(Conv2DHardtanh(), pattern_count_map, data_shape, prepack_removal=True)
        pattern_count_map['aten::hardtanh'] = -1
        TestMetalRewritePass.validate_transformed_module(Conv2DRelu(), pattern_count_map, data_shape, prepack_removal=True, fuse_clamping_ops=True)
