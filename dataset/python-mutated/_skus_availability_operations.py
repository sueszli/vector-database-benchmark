...
from ...operations._skus_availability_operations import build_list_request
    ...
    def list(self, region_id: str, sku_id: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.SkuAvailability']:
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_request(region_id=region_id, subscription_id=self._config.subscription_id, sku_id=sku_id, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
