...
class GdbServer_x86_32(GdbServer):
    ...
    general_registers_order = ['EAX', 'ECX', 'EDX', 'EBX', 'ESP', 'EBP', 'ESI', 'EDI', 'EIP', 'EFLAGS', 'CS', 'SS', 'DS', 'ES', 'FS', 'GS']
    general_registers_size = {'EAX': 4, 'ECX': 4, 'EDX': 4, 'EBX': 4, 'ESP': 4, 'EBP': 4, 'ESI': 4, 'EDI': 4, 'EIP': 4, 'EFLAGS': 2, 'CS': 2, 'SS': 2, 'DS': 2, 'ES': 2, 'FS': 2, 'GS': 2}
    register_ignore = ['tf', 'i_f', 'nt', 'rf', 'vm', 'ac', 'vif', 'vip', 'i_d']
...
class GdbServer_msp430(GdbServer):
    ...
    general_registers_order = ['PC', 'SP', 'SR', 'R3', 'R4', 'R5', 'R6', 'R7', 'R8', 'R9', 'R10', 'R11', 'R12', 'R13', 'R14', 'R15']
    general_registers_size = {'PC': 2, 'SP': 2, 'SR': 2, 'R3': 2, 'R4': 2, 'R5': 2, 'R6': 2, 'R7': 2, 'R8': 2, 'R9': 2, 'R10': 2, 'R11': 2, 'R12': 2, 'R13': 2, 'R14': 2, 'R15': 2}
