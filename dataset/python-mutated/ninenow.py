...
from ..utils import ExtractorError, int_or_none, float_or_none, smuggle_url, str_or_none, try_get, unified_strdate, unified_timestamp

class NineNowIE(InfoExtractor):
    IE_NAME = '9now.com.au'
    _VALID_URL = 'https?://(?:www\\.)?9now\\.com\\.au/(?:[^/]+/){2}(?P<id>[^/?#]+)'
    _GEO_COUNTRIES = ['AU']
    _TESTS = [{'url': 'https://www.9now.com.au/afl-footy-show/2016/clip-ciql02091000g0hp5oktrnytc', 'md5': '17cf47d63ec9323e562c9957a968b565', 'info_dict': {'id': '16801', 'ext': 'mp4', 'title': "St. Kilda's Joey Montagna on the potential for a player's strike", 'description': 'Is a boycott of the NAB Cup "on the table"?', 'uploader_id': '4460760524001', 'upload_date': '20160713', 'timestamp': 1468421266}, 'skip': 'Only available in Australia'}, {'url': 'https://www.9now.com.au/afl-footy-show/2016/episode-19', 'only_matching': True}, {'url': 'https://www.9now.com.au/andrew-marrs-history-of-the-world/season-1/episode-1', 'only_matching': True}, {'url': 'https://www.9now.com.au/lego-masters/season-3/episode-3', 'info_dict': {'id': '6249614030001', 'title': 'Episode 3', 'ext': 'mp4', 'season_number': 3, 'episode_number': 3, 'description': 'In the first elimination of the competition, teams will have 10 hours to build a world inside a snow globe.', 'uploader_id': '4460760524001', 'timestamp': 1619002200, 'upload_date': '20210421'}, 'expected_warnings': ['Ignoring subtitle tracks'], 'params': {'skip_download': True}}]
