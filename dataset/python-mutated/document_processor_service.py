    ...
    class IndividualPageSelector(proto.Message):
        ...
        Attributes:
            pages (MutableSequence[int]):
                ...
                1).
        """
        pages: MutableSequence[int] = proto.RepeatedField(proto.INT32, number=1)
    individual_page_selector: IndividualPageSelector = proto.Field(proto.MESSAGE, number=5, oneof='page_range', message=IndividualPageSelector)
    from_start: int = proto.Field(proto.INT32, number=6, oneof='page_range')
    from_end: int = proto.Field(proto.INT32, number=7, oneof='page_range')
    ocr_config: document_io.OcrConfig = proto.Field(proto.MESSAGE, number=1, message=document_io.OcrConfig)
    schema_override: gcd_document_schema.DocumentSchema = proto.Field(proto.MESSAGE, number=8, message=gcd_document_schema.DocumentSchema)
...
class ProcessRequest(proto.Message):
    ...
    """
    inline_document: gcd_document.Document = proto.Field(proto.MESSAGE, number=4, oneof='source', message=gcd_document.Document)
    raw_document: document_io.RawDocument = proto.Field(proto.MESSAGE, number=5, oneof='source', message=document_io.RawDocument)
    gcs_document: document_io.GcsDocument = proto.Field(proto.MESSAGE, number=8, oneof='source', message=document_io.GcsDocument)
    name: str = proto.Field(proto.STRING, number=1)
    document: gcd_document.Document = proto.Field(proto.MESSAGE, number=2, message=gcd_document.Document)
    skip_human_review: bool = proto.Field(proto.BOOL, number=3)
    field_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=6, message=field_mask_pb2.FieldMask)
    process_options: 'ProcessOptions' = proto.Field(proto.MESSAGE, number=7, message='ProcessOptions')
...
class HumanReviewStatus(proto.Message):
    ...
    state_message: str = proto.Field(proto.STRING, number=2)
    human_review_operation: str = proto.Field(proto.STRING, number=3)
...
class ProcessResponse(proto.Message):
    ...
    Attributes:
        ...
        human_review_status (google.cloud.documentai_v1beta3.types.HumanReviewStatus):
            ...
            document.
    """
    document: gcd_document.Document = proto.Field(proto.MESSAGE, number=1, message=gcd_document.Document)
    human_review_operation: str = proto.Field(proto.STRING, number=2)
    human_review_status: 'HumanReviewStatus' = proto.Field(proto.MESSAGE, number=3, message='HumanReviewStatus')
...
class BatchProcessRequest(proto.Message):
    ...
    class BatchInputConfig(proto.Message):
        ...
        """
        gcs_source: str = proto.Field(proto.STRING, number=1)
    ...
    class BatchOutputConfig(proto.Message):
        ...
        Attributes:
            gcs_destination (str):
                ...
                processed documents.
        """
        gcs_destination: str = proto.Field(proto.STRING, number=1)
    name: str = proto.Field(proto.STRING, number=1)
    input_configs: MutableSequence[BatchInputConfig] = proto.RepeatedField(proto.MESSAGE, number=2, message=BatchInputConfig)
    output_config: BatchOutputConfig = proto.Field(proto.MESSAGE, number=3, message=BatchOutputConfig)
    input_documents: document_io.BatchDocumentsInputConfig = proto.Field(proto.MESSAGE, number=5, message=document_io.BatchDocumentsInputConfig)
    document_output_config: document_io.DocumentOutputConfig = proto.Field(proto.MESSAGE, number=6, message=document_io.DocumentOutputConfig)
    skip_human_review: bool = proto.Field(proto.BOOL, number=4)
    process_options: 'ProcessOptions' = proto.Field(proto.MESSAGE, number=7, message='ProcessOptions')
...
class BatchProcessMetadata(proto.Message):
    ...
    class IndividualProcessStatus(proto.Message):
        ...
        Attributes:
            ...
            human_review_status (google.cloud.documentai_v1beta3.types.HumanReviewStatus):
                ...
                document.
        """
        input_gcs_source: str = proto.Field(proto.STRING, number=1)
        status: status_pb2.Status = proto.Field(proto.MESSAGE, number=2, message=status_pb2.Status)
        output_gcs_destination: str = proto.Field(proto.STRING, number=3)
        human_review_operation: str = proto.Field(proto.STRING, number=4)
        human_review_status: 'HumanReviewStatus' = proto.Field(proto.MESSAGE, number=5, message='HumanReviewStatus')
    state: State = proto.Field(proto.ENUM, number=1, enum=State)
    state_message: str = proto.Field(proto.STRING, number=2)
    ...
    individual_process_statuses: MutableSequence[IndividualProcessStatus] = proto.RepeatedField(proto.MESSAGE, number=5, message=IndividualProcessStatus)
...
class FetchProcessorTypesResponse(proto.Message):
    ...
    """
    processor_types: MutableSequence[processor_type.ProcessorType] = proto.RepeatedField(proto.MESSAGE, number=1, message=processor_type.ProcessorType)
...
class ListProcessorsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    processors: MutableSequence[gcd_processor.Processor] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_processor.Processor)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListProcessorVersionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    processor_versions: MutableSequence[gcd_processor.ProcessorVersion] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_processor.ProcessorVersion)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class DeleteProcessorVersionMetadata(proto.Message):
    ...
    Attributes:
        common_metadata (google.cloud.documentai_v1beta3.types.CommonOperationMetadata):
            ...
            operation.
    """
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=1, message=operation_metadata.CommonOperationMetadata)
...
class CreateProcessorRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    processor: gcd_processor.Processor = proto.Field(proto.MESSAGE, number=2, message=gcd_processor.Processor)
...
class DeleteProcessorMetadata(proto.Message):
    ...
    Attributes:
        common_metadata (google.cloud.documentai_v1beta3.types.CommonOperationMetadata):
            ...
            operation.
    """
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=5, message=operation_metadata.CommonOperationMetadata)
...
class SetDefaultProcessorVersionRequest(proto.Message):
    ...
    """
    processor: str = proto.Field(proto.STRING, number=1)
    default_processor_version: str = proto.Field(proto.STRING, number=2)
    ...
    class InputData(proto.Message):
        ...
        Attributes:
            ...
            test_documents (google.cloud.documentai_v1beta3.types.BatchDocumentsInputConfig):
                ...
                version.
        """
        training_documents: document_io.BatchDocumentsInputConfig = proto.Field(proto.MESSAGE, number=3, message=document_io.BatchDocumentsInputConfig)
        test_documents: document_io.BatchDocumentsInputConfig = proto.Field(proto.MESSAGE, number=4, message=document_io.BatchDocumentsInputConfig)

    class CustomDocumentExtractionOptions(proto.Message):
        """Options to control the training of the Custom Document
        ...
        class TrainingMethod(proto.Enum):
            """Training Method for CDE. ``TRAINING_METHOD_UNSPECIFIED`` will fall
            back to ``MODEL_BASED``.
            ...
            MODEL_BASED = 1
            TEMPLATE_BASED = 2
        training_method: 'TrainProcessorVersionRequest.CustomDocumentExtractionOptions.TrainingMethod' = proto.Field(proto.ENUM, number=3, enum='TrainProcessorVersionRequest.CustomDocumentExtractionOptions.TrainingMethod')
    custom_document_extraction_options: CustomDocumentExtractionOptions = proto.Field(proto.MESSAGE, number=5, oneof='processor_flags', message=CustomDocumentExtractionOptions)
    parent: str = proto.Field(proto.STRING, number=1)
    processor_version: gcd_processor.ProcessorVersion = proto.Field(proto.MESSAGE, number=2, message=gcd_processor.ProcessorVersion)
    document_schema: gcd_document_schema.DocumentSchema = proto.Field(proto.MESSAGE, number=10, message=gcd_document_schema.DocumentSchema)
    input_data: InputData = proto.Field(proto.MESSAGE, number=4, message=InputData)
    base_processor_version: str = proto.Field(proto.STRING, number=8)
...
class TrainProcessorVersionResponse(proto.Message):
    ...
    """
    processor_version: str = proto.Field(proto.STRING, number=1)
...
class TrainProcessorVersionMetadata(proto.Message):
    ...
    class DatasetValidation(proto.Message):
        ...
        """
        document_error_count: int = proto.Field(proto.INT32, number=3)
        dataset_error_count: int = proto.Field(proto.INT32, number=4)
        document_errors: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=1, message=status_pb2.Status)
        dataset_errors: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=2, message=status_pb2.Status)
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=1, message=operation_metadata.CommonOperationMetadata)
    training_dataset_validation: DatasetValidation = proto.Field(proto.MESSAGE, number=2, message=DatasetValidation)
    test_dataset_validation: DatasetValidation = proto.Field(proto.MESSAGE, number=3, message=DatasetValidation)
...
class ReviewDocumentRequest(proto.Message):
    ...
    class Priority(proto.Enum):
        ...
        URGENT = 1
    inline_document: gcd_document.Document = proto.Field(proto.MESSAGE, number=4, oneof='source', message=gcd_document.Document)
    human_review_config: str = proto.Field(proto.STRING, number=1)
    document: gcd_document.Document = proto.Field(proto.MESSAGE, number=2, message=gcd_document.Document)
    enable_schema_validation: bool = proto.Field(proto.BOOL, number=3)
    priority: Priority = proto.Field(proto.ENUM, number=5, enum=Priority)
    document_schema: gcd_document_schema.DocumentSchema = proto.Field(proto.MESSAGE, number=6, message=gcd_document_schema.DocumentSchema)
...
class ReviewDocumentResponse(proto.Message):
    ...
    rejection_reason: str = proto.Field(proto.STRING, number=3)
...
class ReviewDocumentOperationMetadata(proto.Message):
    ...
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=5, message=operation_metadata.CommonOperationMetadata)
    question_id: str = proto.Field(proto.STRING, number=6)
...
class EvaluateProcessorVersionRequest(proto.Message):
    ...
    """
    processor_version: str = proto.Field(proto.STRING, number=1)
    evaluation_documents: document_io.BatchDocumentsInputConfig = proto.Field(proto.MESSAGE, number=3, message=document_io.BatchDocumentsInputConfig)
...
class EvaluateProcessorVersionResponse(proto.Message):
    ...
    """
    evaluation: str = proto.Field(proto.STRING, number=2)
...
class ListEvaluationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    evaluations: MutableSequence[gcd_evaluation.Evaluation] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_evaluation.Evaluation)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ImportProcessorVersionRequest(proto.Message):
    ...
    class ExternalProcessorVersionSource(proto.Message):
        ...
        """
        processor_version: str = proto.Field(proto.STRING, number=1)
        service_endpoint: str = proto.Field(proto.STRING, number=2)
    processor_version_source: str = proto.Field(proto.STRING, number=2, oneof='source')
    external_processor_version_source: ExternalProcessorVersionSource = proto.Field(proto.MESSAGE, number=3, oneof='source', message=ExternalProcessorVersionSource)
    parent: str = proto.Field(proto.STRING, number=1)
