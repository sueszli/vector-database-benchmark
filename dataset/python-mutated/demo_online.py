...
about = {'website': 'https://www.artic.edu', 'wikidata_id': 'Q239303', 'official_api_documentation': 'http://api.artic.edu/docs/', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
...
def request(query, params):
    ...
    args = urlencode({'q': query, 'page': params['pageno'], 'fields': 'id,title,artist_display,medium_display,image_id,date_display,dimensions,artist_titles', 'limit': page_size})
