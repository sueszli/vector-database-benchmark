...
AIRFLOW_STATES = dict(QUEUED='queued', RUNNING='running', SUCCESS='success', SHUTDOWN='shutdown', FAILED='failed', UP_FOR_RETRY='up_for_retry', UP_FOR_RESCHEDULE='up_for_reschedule', UPSTREAM_FAILED='upstream_failed', SKIPPED='skipped')
...
class ExternalTaskSensorDecorator(AirflowSensorDecorator):
    ...
    defaults = dict(**AirflowSensorDecorator.defaults, external_dag_id=None, external_task_ids=None, allowed_states=[AIRFLOW_STATES['SUCCESS']], failed_states=None, execution_delta=None, check_existence=True)
