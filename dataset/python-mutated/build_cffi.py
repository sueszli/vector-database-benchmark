...
with open(os.path.join(here, '_cffi.c')) as f:
    _cffi_c = f.read()
ffi.set_source('zmq.backend.cffi._cffi', libraries=cfg['libraries'], include_dirs=cfg['include_dirs'], library_dirs=cfg['library_dirs'], runtime_library_dirs=cfg['runtime_library_dirs'], source=_cffi_c)
