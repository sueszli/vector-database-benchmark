...
class Test_sagemaker_models_vpc_settings_configured:
    ...
    def test_no_models(self):
        ...
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_vpc_settings_configured.sagemaker_models_vpc_settings_configured import sagemaker_models_vpc_settings_configured
    ...
    def test_instance_vpc_settings_configured(self):
        ...
        sagemaker_client = mock.MagicMock
        sagemaker_client.sagemaker_models = []
        sagemaker_client.sagemaker_models.append(Model(name=test_notebook_instance, arn=notebook_instance_arn, region=AWS_REGION, vpc_config_subnets=[subnet_id]))
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_vpc_settings_configured.sagemaker_models_vpc_settings_configured import sagemaker_models_vpc_settings_configured
            check = sagemaker_models_vpc_settings_configured()
            result = check.execute()
    ...
    def test_instance_vpc_settings_not_configured(self):
        ...
        sagemaker_client = mock.MagicMock
        sagemaker_client.sagemaker_models = []
        sagemaker_client.sagemaker_models.append(Model(name=test_notebook_instance, arn=notebook_instance_arn, region=AWS_REGION))
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_vpc_settings_configured.sagemaker_models_vpc_settings_configured import sagemaker_models_vpc_settings_configured
            check = sagemaker_models_vpc_settings_configured()
            result = check.execute()
