...
from orangewidget.utils.visual_settings_dlg import VisualSettingsDialog, KeyType, ValueType
from Orange.data import Table, DiscreteVariable, ContinuousVariable, StringVariable, Variable
...
from Orange.widgets.visualize.utils.plotutils import AxisItem, HelpEventDelegate, PlotWidget
...
class OWBarPlot(OWWidget):
    ...
    class Information(OWWidget.Information):
        too_many_instances = Msg('Data has too many instances. Only first {} are shown.'.format(MAX_INSTANCES))
