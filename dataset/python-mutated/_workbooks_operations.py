...
from ...operations._workbooks_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_revision_get_request, build_revisions_list_request, build_update_request
T = TypeVar('T')
...
class WorkbooksOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.applicationinsights.v2021_08_01.aio.ApplicationInsightsManagementClient`'s
    ...
    @distributed_trace
    def list_by_subscription(self, category: Union[str, _models.CategoryType], tags: Optional[List[str]]=None, can_fetch_content: Optional[bool]=None, **kwargs: Any) -> AsyncIterable['_models.Workbook']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                ...
                return i + 15
            if not next_link:
                request = build_list_by_subscription_request(subscription_id=self._config.subscription_id, category=category, tags=tags, can_fetch_content=can_fetch_content, api_version=api_version, template_url=self.list_by_subscription.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, category: Union[str, _models.CategoryType], tags: Optional[List[str]]=None, source_id: Optional[str]=None, can_fetch_content: Optional[bool]=None, **kwargs: Any) -> AsyncIterable['_models.Workbook']:
        if False:
            i = 10
            return i + 15
    ...
    async def get(self, resource_group_name: str, resource_name: str, can_fetch_content: Optional[bool]=None, **kwargs: Any) -> _models.Workbook:
        ...
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, can_fetch_content=can_fetch_content, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: _models.Workbook, source_id: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.Workbook:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: IO, source_id: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.Workbook:
        """Create a new workbook.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: Union[_models.Workbook, IO], source_id: Optional[str]=None, **kwargs: Any) -> _models.Workbook:
        """Create a new workbook.
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, source_id: Optional[str]=None, workbook_update_parameters: Optional[_models.WorkbookUpdateParameters]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.Workbook:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, source_id: Optional[str]=None, workbook_update_parameters: Optional[IO]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.Workbook:
        """Updates a workbook that has already been added.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, resource_name: str, source_id: Optional[str]=None, workbook_update_parameters: Optional[Union[_models.WorkbookUpdateParameters, IO]]=None, **kwargs: Any) -> _models.Workbook:
        """Updates a workbook that has already been added.
        ...
        elif workbook_update_parameters is not None:
    ...
    @distributed_trace
    def revisions_list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> AsyncIterable['_models.Workbook']:
        if False:
            while True:
                i = 10
        ...
        def prepare_request(next_link=None):
            if False:
                for i in range(10):
                    print('nop')
            if not next_link:
                request = build_revisions_list_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.revisions_list.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
        ...
        async def get_next(next_link=None):
            ...
            return pipeline_response
        return AsyncItemPaged(get_next, extract_data)
    revisions_list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/workbooks/{resourceName}/revisions'}

    @distributed_trace_async
    async def revision_get(self, resource_group_name: str, resource_name: str, revision_id: str, **kwargs: Any) -> _models.Workbook:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2021-08-01'))
        cls: ClsType[_models.Workbook] = kwargs.pop('cls', None)
        request = build_revision_get_request(resource_group_name=resource_group_name, resource_name=resource_name, revision_id=revision_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.revision_get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
