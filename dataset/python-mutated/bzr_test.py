...
test_cases = ((['unknown:', '  new-file'], RepoStats(new=1)), (['added:', '  added-file'], RepoStats(staged=1)), (['modified:', '  modified-file'], RepoStats(changed=1)), (['removed:', '  removed-file'], RepoStats(changed=1)), (['missing:', '  missing-file'], RepoStats(changed=1)), (['renamed:', '  renamed-file'], RepoStats(changed=1)), (['kind changed:', '  kind-changed-file'], RepoStats(changed=1)))
