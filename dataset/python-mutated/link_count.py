...
import frappe
ignore_doctypes = {'DocType', 'Print Format', 'Role', 'Module Def', 'Communication', 'ToDo', 'Version', 'Error Log', 'Scheduled Job Log', 'Event Sync Log', 'Event Update Log', 'Access Log', 'View Log', 'Activity Log', 'Energy Point Log', 'Notification Log', 'Email Queue', 'DocShare', 'Document Follow', 'Console Log', 'User'}
