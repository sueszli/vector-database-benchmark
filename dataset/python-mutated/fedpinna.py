...
action_keys = {'w': 'top', 's': 'bottom', 'a': 'left', 'd': 'right', 'r': 'rotate', 'q': 'exit'}
action = ''
while action != 'exit':
    shape_selected = move_shape(current_position, previous_position, action, shape_selected, tetris_board)
