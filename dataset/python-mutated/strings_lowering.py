...
from cudf._lib.strings_udf import get_character_cases_table_ptr, get_character_flags_table_ptr, get_special_case_mapping_table_ptr
...
_concat_string_view = cuda.declare_device('concat', types.void(_UDF_STRING_PTR, _STR_VIEW_PTR, _STR_VIEW_PTR))
_string_view_replace = cuda.declare_device('replace', types.void(_UDF_STRING_PTR, _STR_VIEW_PTR, _STR_VIEW_PTR, _STR_VIEW_PTR))
...
_declare_bool_str_str_func = partial(_declare_binary_func, _STR_VIEW_PTR, _STR_VIEW_PTR, types.boolean)
_declare_size_type_str_str_func = partial(_declare_binary_func, _STR_VIEW_PTR, _STR_VIEW_PTR, size_type)
...
_declare_bool_str_int_func = partial(_declare_binary_func, _STR_VIEW_PTR, types.int64, types.boolean)
...
_string_view_count = cuda.declare_device('pycount', size_type(_STR_VIEW_PTR, _STR_VIEW_PTR))
...
def cast_udf_string_to_string_view(context, builder, fromty, toty, val):
    ...
    return result._getvalue()
_create_udf_string_from_string_view = cuda.declare_device('udf_string_from_string_view', types.void(_STR_VIEW_PTR, _UDF_STRING_PTR))
_create_string_view_from_udf_string = cuda.declare_device('string_view_from_udf_string', types.void(_UDF_STRING_PTR, _STR_VIEW_PTR))
...
create_masked_binary_string_func('MaskedType.startswith', startswith_impl, types.boolean)
