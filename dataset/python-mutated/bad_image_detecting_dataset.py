...
from modelscope.preprocessors.cv.bad_image_detecting_preprocessor import BadImageDetectingPreprocessor
...
class BadImageDetectingDataset(TorchCustomDataset):
    ...
    def __getitem__(self, index):
        ...
        return {'input': img['input'].squeeze(0), OutputKeys.LABEL: iterm_label}