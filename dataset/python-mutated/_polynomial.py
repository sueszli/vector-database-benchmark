...
from ._csr_polynomial_expansion import _calc_expanded_nnz, _calc_total_nnz, _csr_polynomial_expansion
...
class SplineTransformer(TransformerMixin, BaseEstimator):
    ...
    array([[0.5 , 0.5 , 0.  , 0.  ],
           ...
           [0.  , 0.  , 0.5 , 0.5 ]])
    """
    _parameter_constraints: dict = {'n_knots': [Interval(Integral, 2, None, closed='left')], 'degree': [Interval(Integral, 0, None, closed='left')], 'knots': [StrOptions({'uniform', 'quantile'}), 'array-like'], 'extrapolation': [StrOptions({'error', 'constant', 'linear', 'continue', 'periodic'})], 'include_bias': ['boolean'], 'order': [StrOptions({'C', 'F'})], 'sparse_output': ['boolean']}
