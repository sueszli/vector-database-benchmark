...
import argparse
import sys
DEFAULT_BLACKLIST = ['aiohttp', 'aiohttp_cors', 'colorful', 'py-spy', 'gpustat', 'opencensus', 'prometheus_client', 'smart_open', 'virtualenv', 'torch', 'tensorflow', 'jax']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--expected-python-version', type=str, help='Expected Python version in MAJOR.MINOR format, e.g. 3.11', default=None)
