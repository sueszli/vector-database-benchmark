...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-epochs', type=int, default=5, metavar='N', help='number of epochs to train (default: 10)')
    ...
    parser.add_argument('--num-workers', type=int, default=4, help='Number of Ray workers to use for training.')
    parser.add_argument('--data-dir', help='location of the training dataset in the local filesystem (will be downloaded if needed)')
    parser.add_argument('--address', required=False, type=str, default=None, help='Address of Ray cluster.')
    ...
    if args.address:
        ...
        ray.init()
    kwargs = {'data_dir': args.data_dir, 'seed': args.seed, 'use_cuda': args.use_cuda if args.use_cuda else False, 'batch_size': args.batch_size, 'use_adasum': args.use_adasum if args.use_adasum else False, 'lr': args.lr, 'momentum': args.momentum, 'num_epochs': args.num_epochs, 'log_interval': args.log_interval}
    main(num_workers=args.num_workers, use_gpu=args.use_cuda if args.use_cuda else False, kwargs=kwargs)