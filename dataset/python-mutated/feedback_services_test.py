...
class FeedbackThreadUnitTests(test_utils.GenericTestBase):
    ...
    EXPECTED_THREAD_DICT: ExpectedThreadDict = {'status': u'open', 'summary': None, 'original_author_id': None, 'subject': u'a subject'}
    EXPECTED_THREAD_DICT_VIEWER: ExpectedThreadViewerDict = {'status': u'open', 'summary': None, 'original_author_id': None, 'subject': u'a subject second'}
    USER_EMAIL: Final = 'user@example.com'
    USER_USERNAME: Final = 'user'
