...
from ray.serve.tests.common.remote_uris import TEST_DAG_PINNED_URI, TEST_DEPLOY_GROUP_PINNED_URI
from ray.serve.tests.common.utils import ping_fruit_stand, ping_grpc_another_method, ping_grpc_call_method, ping_grpc_healthz, ping_grpc_list_applications, ping_grpc_model_multiplexing, ping_grpc_streaming
from ray.serve.tests.conftest import check_ray_stop
from ray.tests.conftest import tmp_working_dir
...
k8sFNode = global_f.options(num_replicas=2, ray_actor_options={'num_cpus': 2, 'num_gpus': 1}).bind()
