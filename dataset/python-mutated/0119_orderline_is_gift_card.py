...
class Migration(migrations.Migration):
    dependencies = [('order', '0118_auto_20210913_0731'), ('product', '0148_producttype_type')]
    operations = [migrations.AddField(model_name='orderline', name='is_gift_card', field=models.BooleanField(null=True)), migrations.RunPython(set_is_gift_card_field, migrations.RunPython.noop), migrations.AlterField(model_name='orderline', name='is_gift_card', field=models.BooleanField())]