...
from transformers.testing_utils import require_essentia, require_librosa, require_onnx, require_scipy, require_torch, slow, torch_device
...
class Pop2PianoModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'automatic-speech-recognition': Pop2PianoForConditionalGeneration} if is_torch_available() else {}
