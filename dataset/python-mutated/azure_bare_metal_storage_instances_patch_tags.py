...
def main():
    ...
    response = client.azure_bare_metal_storage_instances.update(resource_group_name='myResourceGroup', azure_bare_metal_storage_instance_name='myABMSInstance', tags_parameter={'tags': {'testkey': 'testvalue'}})
    print(response)
