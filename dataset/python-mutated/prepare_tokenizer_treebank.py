...
def build_combined_hebrew_dataset(paths, model_type, dataset):
    ...
    if dataset == 'train':
        ...
        sents = read_sentences_from_conllu(conllu_file)
    return sents
COMBINED_FNS = {'en_combined': build_combined_english_dataset, 'es_combined': build_combined_spanish_dataset, 'fr_combined': build_combined_french_dataset, 'he_combined': build_combined_hebrew_dataset, 'it_combined': build_combined_italian_dataset}
COMBINED_EXTRA_FNS = {'en_combined': build_extra_combined_english_dataset, 'it_combined': build_extra_combined_italian_dataset}
