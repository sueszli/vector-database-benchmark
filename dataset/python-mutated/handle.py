...
result_to_handle_map = {'default': (default.handle_result, False), 'long_running_tests': (long_running_tests.handle_result, True), 'tune_tests': (tune_tests.handle_result, True), 'xgboost_tests': (xgboost_tests.handle_result, True)}
