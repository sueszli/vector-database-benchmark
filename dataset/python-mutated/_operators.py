...
_ONNX_NODE_REGISTRY = {'Abs': _convert_abs, 'Add': _convert_add, 'ArgMax': _convert_argmax, 'ArgMin': _convert_argmax, 'AveragePool': _convert_pool, 'BatchNormalization': _convert_bn, 'Clip': _convert_clip, 'Concat': _convert_concat, 'Conv': _convert_conv, 'ConvTranspose': _convert_conv, 'DepthToSpace': _convert_reorganize_data, 'Div': _convert_div, 'Elu': _convert_elu, 'Exp': _convert_exp, 'Flatten': _convert_flatten, 'Gemm': _convert_gemm, 'GlobalAveragePool': _convert_pool, 'GlobalMaxPool': _convert_pool, 'HardSigmoid': _convert_hardsigmoid, 'InstanceNormalization': _convert_instancenorm, 'LeakyRelu': _convert_leaky_relu, 'Log': _convert_log, 'LogSoftmax': _convert_softmax, 'LRN': _convert_lrn, 'LSTM': _convert_lstm, 'MatMul': _convert_matmul, 'Max': _convert_max, 'MaxPool': _convert_pool, 'Mean': _convert_mean, 'MeanVarianceNormalization': _convert_mvn, 'Min': _convert_min, 'Mul': _convert_mul, 'Neg': _convert_neg, 'Pad': _convert_pad, 'Pow': _convert_pow, 'PRelu': _convert_prelu, 'Reciprocal': _convert_reciprocal, 'ReduceL1': _convert_reduce, 'ReduceL2': _convert_reduce, 'ReduceLogSum': _convert_reduce, 'ReduceMax': _convert_reduce, 'ReduceMean': _convert_reduce, 'ReduceMin': _convert_reduce, 'ReduceProd': _convert_reduce, 'ReduceSum': _convert_reduce, 'ReduceSumSquare': _convert_reduce, 'Relu': _convert_relu, 'Reshape': _convert_reshape, 'Selu': _convert_selu, 'Sigmoid': _convert_sigmoid, 'Sign': _convert_sign, 'Slice': _convert_slice, 'Softmax': _convert_softmax, 'Softplus': _convert_softplus, 'Softsign': _convert_softsign, 'SpaceToDepth': _convert_reorganize_data, 'SpatialBN': _convert_bn, 'Split': _convert_split, 'Sqrt': _convert_sqrt, 'Squeeze': _convert_identity, 'Sub': _convert_sub, 'Sum': _convert_add, 'Tanh': _convert_tanh, 'ThresholdedRelu': _convert_thresholdedrelu, 'Transpose': _convert_transpose, 'Unsqueeze': _convert_identity, 'Upsample': _convert_upsample}
