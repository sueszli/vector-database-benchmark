...
class InputTextMessageContent(InputMessageContent):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, message_text: str, parse_mode: Optional[str]=UNSET_PARSE_MODE, entities: Optional[List[MessageEntity]]=None, disable_web_page_preview: Optional[bool]=UNSET_DISABLE_WEB_PAGE_PREVIEW, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(message_text=message_text, parse_mode=parse_mode, entities=entities, disable_web_page_preview=disable_web_page_preview, **__pydantic_kwargs)