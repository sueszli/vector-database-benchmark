...
class Authenticator(dns_common_lexicon.LexiconDNSAuthenticator):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._add_provider_option('token', f'User access token for DNSimple v2 API. (See {ACCOUNT_URL}.)', 'auth_token')
    ...
    def more_info(self) -> str:
        if False:
            print('Hello World!')
        return 'This plugin configures a DNS TXT record to respond to a dns-01 challenge using ' + 'the DNSimple API.'
