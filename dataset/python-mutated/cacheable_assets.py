...
class AssetsDefinitionCacheableData(NamedTuple('_AssetsDefinitionCacheableData', [('keys_by_input_name', Optional[Mapping[str, AssetKey]]), ('keys_by_output_name', Optional[Mapping[str, AssetKey]]), ('internal_asset_deps', Optional[Mapping[str, AbstractSet[AssetKey]]]), ('group_name', Optional[str]), ('metadata_by_output_name', Optional[Mapping[str, MetadataUserInput]]), ('key_prefix', Optional[CoercibleToAssetKeyPrefix]), ('can_subset', bool), ('extra_metadata', Optional[Mapping[Any, Any]]), ('freshness_policies_by_output_name', Optional[Mapping[str, FreshnessPolicy]]), ('auto_materialize_policies_by_output_name', Optional[Mapping[str, AutoMaterializePolicy]]), ('backfill_policy', Optional[BackfillPolicy])])):
