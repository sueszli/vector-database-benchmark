...
from zipline.utils.numpy_utils import datetime64ns_dtype, float64_dtype, int64_dtype, uint32_dtype, uint64_dtype
...
StockDividend = namedtuple('StockDividend', ['asset', 'payment_asset', 'ratio', 'pay_date'])
SQLITE_ADJUSTMENT_COLUMN_DTYPES = {'effective_date': any_integer, 'ratio': float64_dtype, 'sid': any_integer}
SQLITE_DIVIDEND_PAYOUT_COLUMN_DTYPES = {'sid': any_integer, 'ex_date': any_integer, 'declared_date': any_integer, 'record_date': any_integer, 'pay_date': any_integer, 'amount': float}
SQLITE_STOCK_DIVIDEND_PAYOUT_COLUMN_DTYPES = {'sid': any_integer, 'ex_date': any_integer, 'declared_date': any_integer, 'record_date': any_integer, 'pay_date': any_integer, 'payment_sid': any_integer, 'ratio': float}
...
class SQLiteAdjustmentReader(object):
    ...
    """
    _datetime_int_cols = {'splits': ('effective_date',), 'mergers': ('effective_date',), 'dividends': ('effective_date',), 'dividend_payouts': ('declared_date', 'ex_date', 'pay_date', 'record_date'), 'stock_dividend_payouts': ('declared_date', 'ex_date', 'pay_date', 'record_date')}
    _raw_table_dtypes = {'splits': specialize_any_integer(SQLITE_ADJUSTMENT_COLUMN_DTYPES), 'mergers': specialize_any_integer(SQLITE_ADJUSTMENT_COLUMN_DTYPES), 'dividends': specialize_any_integer(SQLITE_ADJUSTMENT_COLUMN_DTYPES), 'dividend_payouts': specialize_any_integer(SQLITE_DIVIDEND_PAYOUT_COLUMN_DTYPES), 'stock_dividend_payouts': specialize_any_integer(SQLITE_STOCK_DIVIDEND_PAYOUT_COLUMN_DTYPES)}
