...
COLLECTION_FORMAT_MAPPING = {'multi': {'style': 'form', 'explode': True}, 'csv': {'style': 'form', 'explode': False}, 'ssv': {'style': 'spaceDelimited', 'explode': False}, 'pipes': {'style': 'pipeDelimited', 'explode': False}}
