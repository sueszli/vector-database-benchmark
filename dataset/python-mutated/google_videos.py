...
from searx.utils import eval_xpath, eval_xpath_list, eval_xpath_getindex, extract_text
from searx.engines.google import fetch_traits
from searx.engines.google import get_google_info, time_range_dict, filter_mapping, suggestion_xpath, detect_google_sorry
from searx.enginelib.traits import EngineTraits
if TYPE_CHECKING:
    import logging
    logger: logging.Logger
traits: EngineTraits
about = {'website': 'https://www.google.com', 'wikidata_id': 'Q219885', 'official_api_documentation': 'https://developers.google.com/custom-search', 'use_official_api': False, 'require_api_key': False, 'results': 'HTML'}
