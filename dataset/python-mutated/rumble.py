...
from ..utils import ExtractorError, UnsupportedError, clean_html, determine_ext, format_field, get_element_by_class, int_or_none, join_nonempty, parse_count, parse_iso8601, traverse_obj, unescapeHTML

class RumbleEmbedIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?rumble\\.com/embed/(?:[0-9a-z]+\\.)?(?P<id>[0-9a-z]+)'
    _EMBED_REGEX = [f"""(?:<(?:script|iframe)[^>]+\\bsrc=|["\\']embedUrl["\\']\\s*:\\s*)["\\'](?P<url>{_VALID_URL})"""]
    _TESTS = [{'url': 'https://rumble.com/embed/v5pv5f', 'md5': '36a18a049856720189f30977ccbb2c34', 'info_dict': {'id': 'v5pv5f', 'ext': 'mp4', 'title': 'WMAR 2 News Latest Headlines | October 20, 6pm', 'timestamp': 1571611968, 'upload_date': '20191020', 'channel_url': 'https://rumble.com/c/WMAR', 'channel': 'WMAR', 'thumbnail': 'https://sp.rmbl.ws/s8/1/5/M/z/1/5Mz1a.qR4e-small-WMAR-2-News-Latest-Headline.jpg', 'duration': 234, 'uploader': 'WMAR', 'live_status': 'not_live'}}, {'url': 'https://rumble.com/embed/vslb7v', 'md5': '7418035de1a30a178b8af34dc2b6a52b', 'info_dict': {'id': 'vslb7v', 'ext': 'mp4', 'title': "Defense Sec. says US Commitment to NATO Defense 'Ironclad'", 'timestamp': 1645142135, 'upload_date': '20220217', 'channel_url': 'https://rumble.com/c/CyberTechNews', 'channel': 'CTNews', 'thumbnail': 'https://sp.rmbl.ws/s8/6/7/i/9/h/7i9hd.OvCc.jpg', 'duration': 901, 'uploader': 'CTNews', 'live_status': 'not_live'}}, {'url': 'https://rumble.com/embed/vunh1h', 'info_dict': {'id': 'vunh1h', 'ext': 'mp4', 'title': '‘Gideon, op zoek naar de waarheid’ including ENG SUBS', 'timestamp': 1647197663, 'upload_date': '20220313', 'channel_url': 'https://rumble.com/user/BLCKBX', 'channel': 'BLCKBX', 'thumbnail': 're:https://.+\\.jpg', 'duration': 5069, 'uploader': 'BLCKBX', 'live_status': 'not_live', 'subtitles': {'en': [{'url': 're:https://.+\\.vtt', 'name': 'English', 'ext': 'vtt'}]}}, 'params': {'skip_download': True}}, {'url': 'https://rumble.com/embed/v1essrt', 'info_dict': {'id': 'v1essrt', 'ext': 'mp4', 'title': 'startswith:lofi hip hop radio 📚 - beats to relax/study to', 'timestamp': 1661519399, 'upload_date': '20220826', 'channel_url': 'https://rumble.com/c/LofiGirl', 'channel': 'Lofi Girl', 'thumbnail': 're:https://.+\\.jpg', 'duration': None, 'uploader': 'Lofi Girl', 'live_status': 'is_live'}, 'params': {'skip_download': True}}, {'url': 'https://rumble.com/embed/v1amumr', 'info_dict': {'id': 'v1amumr', 'ext': 'mp4', 'fps': 60, 'title': 'Turning Point USA 2022 Student Action Summit DAY 1  - Rumble Exclusive Live', 'timestamp': 1658518457, 'upload_date': '20220722', 'channel_url': 'https://rumble.com/c/RumbleEvents', 'channel': 'Rumble Events', 'thumbnail': 're:https://.+\\.jpg', 'duration': 16427, 'uploader': 'Rumble Events', 'live_status': 'was_live'}, 'params': {'skip_download': True}}, {'url': 'https://rumble.com/embed/ufe9n.v5pv5f', 'only_matching': True}]
    _WEBPAGE_TESTS = [{'note': 'Rumble JS embed', 'url': 'https://therightscoop.com/what-does-9-plus-1-plus-1-equal-listen-to-this-audio-of-attempted-kavanaugh-assassins-call-and-youll-get-it', 'md5': '4701209ac99095592e73dbba21889690', 'info_dict': {'id': 'v15eqxl', 'ext': 'mp4', 'channel': 'Mr Producer Media', 'duration': 92, 'title': '911 Audio From The Man Who Wanted To Kill Supreme Court Justice Kavanaugh', 'channel_url': 'https://rumble.com/c/RichSementa', 'thumbnail': 'https://sp.rmbl.ws/s8/1/P/j/f/A/PjfAe.qR4e-small-911-Audio-From-The-Man-Who-.jpg', 'timestamp': 1654892716, 'uploader': 'Mr Producer Media', 'upload_date': '20220610', 'live_status': 'not_live'}}]
...
class RumbleChannelIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://rumble.com/c/Styxhexenhammer666', 'playlist_mincount': 1160, 'info_dict': {'id': 'Styxhexenhammer666'}}, {'url': 'https://rumble.com/user/goldenpoodleharleyeuna', 'playlist_mincount': 4, 'info_dict': {'id': 'goldenpoodleharleyeuna'}}]
