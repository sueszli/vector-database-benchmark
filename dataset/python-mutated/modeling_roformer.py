...
ROFORMER_PRETRAINED_MODEL_ARCHIVE_LIST = ['junnyu/roformer_chinese_small', 'junnyu/roformer_chinese_base', 'junnyu/roformer_chinese_char_small', 'junnyu/roformer_chinese_char_base', 'junnyu/roformer_small_discriminator', 'junnyu/roformer_small_generator']
