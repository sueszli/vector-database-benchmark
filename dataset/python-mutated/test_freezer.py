...
ibefore_workspace = {'session_name': 'sample workspace', 'start_directory': '~', 'windows': [{'shell_command': ['top'], 'window_name': 'editor', 'panes': [{'shell_command': ['vim']}, {'shell_command': ['cowsay "hey"']}], 'layout': 'main-vertical'}, {'window_name': 'logging', 'panes': [{'shell_command': ['tail -F /var/log/syslog']}]}, {'options': {'automatic-rename': True}, 'panes': [{'shell_command': ['htop']}]}]}
iafter_workspace = {'session_name': 'sample workspace', 'start_directory': '~', 'windows': [{'shell_command': 'top', 'window_name': 'editor', 'panes': ['vim', 'cowsay "hey"'], 'layout': 'main-vertical'}, {'window_name': 'logging', 'panes': ['tail -F /var/log/syslog']}, {'options': {'automatic-rename': True}, 'panes': ['htop']}]}
