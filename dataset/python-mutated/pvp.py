...
import numpy as np
from tasks.data_utils import InputExample, build_decoder_input, build_decoder_sample, build_input_from_ids, build_sample, num_special_tokens_to_add
...
class YahooPVP(PVP):
    VERBALIZER = {'1': [' Society'], '2': [' Science'], '3': [' Health'], '4': [' Education'], '5': [' Computer'], '6': [' Sports'], '7': [' Business'], '8': [' Entertainment'], '9': [' Relationship'], '10': [' Politics']}
...
class XStancePVP(PVP):
    VERBALIZERS = {'en': {'FAVOR': ['Yes'], 'AGAINST': ['No']}, 'de': {'FAVOR': ['Ja'], 'AGAINST': ['Nein']}, 'fr': {'FAVOR': ['Oui'], 'AGAINST': ['Non']}}
