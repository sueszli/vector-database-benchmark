...
if is_torch_available():
    import torch
    from transformers import AutoTokenizer, SwitchTransformersEncoderModel, SwitchTransformersForConditionalGeneration, SwitchTransformersModel, SwitchTransformersTop1Router
    from transformers.models.switch_transformers.modeling_switch_transformers import SWITCH_TRANSFORMERS_PRETRAINED_MODEL_ARCHIVE_LIST, load_balancing_loss_func, router_z_loss_func
...
class SwitchTransformerRouterTest(unittest.TestCase):
    ...
    """
    config = SwitchTransformersConfig(num_experts=2, hidden_size=8, d_ff=16, router_jitter_noise=0, expert_capacity=4)
