...
if __name__ == '__main__':
    ...
    parser.add_argument('--embedding_file', type=str, default=None, help='Path to file with embeddings.')
    parser.add_argument('--export_path', type=str, default=None, help='Where to export the module.')
    parser.add_argument('--num_oov_buckets', type=int, default='1', help='How many OOV buckets to add.')
    parser.add_argument('--num_lines_to_ignore', type=int, default='0', help='How many lines to ignore.')
    parser.add_argument('--num_lines_to_use', type=int, default=None, help='How many lines to use.')
