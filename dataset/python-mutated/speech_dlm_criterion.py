...
class SpeechDLMCriterionConfig(FairseqDataclass):
    ...
    main_and_cross_weights: Optional[str] = field(default='1,0', metadata={'help': 'Comma-separated list of weights of Main-channel vs Cross-channel Prediction Losses(default: 1,0)'})
    general_unit_loss_weight: float = field(default=0, metadata={'help': 'The weight of the General Prediction Loss (Next-step Unit Prediction Loss)(default: 0)'})
    edge_unit_loss_weight: float = field(default=1, metadata={'help': 'The weight of the Edge Unit Prediction Loss(default: 1)'})
    duration_loss_weight: float = field(default=1, metadata={'help': 'The weight of the Edge Unit Duration Prediction Loss(default: 1)'})
