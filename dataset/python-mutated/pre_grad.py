...
pattern_matcher_passes: List[PatternMatcherPass] = [normalization_pass, merge_getitem_cat_pass, merge_splits_pass, split_cat_pass, unbind_stack_pass, efficient_conv_bn_eval_pass]
