...
traits: EngineTraits
about = {'website': 'https://www.wikipedia.org/', 'wikidata_id': 'Q52', 'official_api_documentation': 'https://en.wikipedia.org/api/', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
...
wiki_lc_locale_variants = {'zh': ('zh-CN', 'zh-HK', 'zh-MO', 'zh-MY', 'zh-SG', 'zh-TW'), 'zh-classical': ('zh-classical',)}
...
wikipedia_script_variants = {'zh': ('zh_Hant', 'zh_Hans')}
...
lang_map.update({'be-tarask': 'bel', 'ak': 'aka', 'als': 'gsw', 'bat-smg': 'sgs', 'cbk-zam': 'cbk', 'fiu-vro': 'vro', 'map-bms': 'map', 'no': 'nb-NO', 'nrm': 'nrf', 'roa-rup': 'rup', 'nds-nl': 'nds', 'zh-min-nan': 'nan', 'zh-yue': 'yue', 'an': 'arg'})
