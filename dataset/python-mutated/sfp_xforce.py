...
class sfp_xforce(SpiderFootPlugin):
    meta = {'name': 'XForce Exchange', 'summary': 'Obtain IP reputation and passive DNS information from IBM X-Force Exchange.', 'flags': ['apikey'], 'useCases': ['Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'https://exchange.xforce.ibmcloud.com/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://api.xforce.ibmcloud.com/doc/', 'https://exchange.xforce.ibmcloud.com/faq'], 'apiKeyInstructions': ['Visit https://exchange.xforce.ibmcloud.com', 'Register a free account', 'Navigate to https://exchange.xforce.ibmcloud.com/settings', "Click on 'API Access'", "Provide an API name, and click 'Generate'", "The API key combination is listed under 'API Key' and 'API Password'"], 'favIcon': 'https://exchange.xforce.ibmcloud.com/images/shortcut-icons/apple-icon-57x57.png', 'logo': 'https://exchange.xforce.ibmcloud.com/images/shortcut-icons/apple-icon-57x57.png', 'description': 'IBM® X-Force Exchange is a cloud-based, threat intelligence sharing platform that you can use to rapidly research the latest global security threats, aggregate actionable intelligence, consult with experts and collaborate with peers. IBM X-Force Exchange, supported by human- and machine-generated intelligence, leverages the scale of IBM X-Force to help users stay ahead of emerging threats.'}}
    opts = {'xforce_api_key': '', 'xforce_api_key_password': '', 'age_limit_days': 30, 'netblocklookup': True, 'maxnetblock': 24, 'maxv6netblock': 120, 'subnetlookup': True, 'maxsubnet': 24, 'maxv6subnet': 120, 'maxcohost': 100, 'cohostsamedomain': False, 'checkaffiliates': True, 'verify': True}
    optdescs = {'xforce_api_key': 'X-Force Exchange API Key.', 'xforce_api_key_password': 'X-Force Exchange API Password.', 'age_limit_days': 'Ignore any records older than this many days. 0 = unlimited.', 'netblocklookup': 'Look up all IPs on netblocks deemed to be owned by your target for possible blacklisted hosts on the same target subdomain/domain?', 'maxnetblock': 'If looking up owned netblocks, the maximum netblock size to look up all IPs within (CIDR value, 24 = /24, 16 = /16, etc.)', 'maxv6netblock': 'If looking up owned netblocks, the maximum IPv6 netblock size to look up all IPs within (CIDR value, 24 = /24, 16 = /16, etc.)', 'subnetlookup': 'Look up all IPs on subnets which your target is a part of for blacklisting?', 'maxsubnet': 'If looking up subnets, the maximum subnet size to look up all the IPs within (CIDR value, 24 = /24, 16 = /16, etc.)', 'maxv6subnet': 'If looking up subnets, the maximum IPv6 subnet size to look up all the IPs within (CIDR value, 24 = /24, 16 = /16, etc.)', 'maxcohost': 'Stop reporting co-hosted sites after this many are found, as it would likely indicate web hosting.', 'cohostsamedomain': 'Treat co-hosted sites on the same target domain as co-hosting?', 'checkaffiliates': 'Apply checks to affiliates?', 'verify': 'Verify co-hosts are valid by checking if they still resolve to the shared IP.'}
    results = None
    errorState = False
    cohostcount = 0
