...
def main():
    ...
    response = client.gallery_images.begin_update(resource_group_name='test-rg', gallery_image_name='test-gallery-image', gallery_images={'tags': {'additionalProperties': 'sample'}}).result()
    print(response)
