...
from typing import TYPE_CHECKING, Any, Callable, Dict, FrozenSet, Generator, Iterable, Optional, Set, Union
...
class OpenTelemetryExtension(SchemaExtension):
    ...
    async def resolve(self, _next: Callable, root: Any, info: GraphQLResolveInfo, *args: str, **kwargs: Any) -> Any:
