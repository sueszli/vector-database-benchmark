...
class RMCDecouverteIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return self.url_result(smuggle_url(self.BRIGHTCOVE_URL_TEMPLATE % brightcove_id, {'geo_countries': ['FR']}), 'BrightcoveNew', brightcove_id)