...
class Monitor(TypedDict):
    ...
    id: str
    isEnabled: bool
    type: Literal['cardinality', 'column_count', 'custom', 'duration', 'freshness', 'iqr', 'kurtosis', 'lower_percentile', 'max', 'mean', 'median', 'min', 'monotonicity', 'nullness', 'range', 'row_count', 'skew', 'stddev', 'uniqueness', 'upper_percentile']
    updatedAt: datetime
