...
def main():
    ...
    response = client.service_topologies.create_or_update(resource_group_name='myResourceGroup', service_topology_name='myTopology', service_topology_info={'location': 'centralus', 'properties': {'artifactSourceId': 'Microsoft.DeploymentManager/artifactSources/myArtifactSource'}, 'tags': {}})
    print(response)
