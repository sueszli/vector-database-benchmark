...
RULE_1 = {'enabled': True, 'name': 'st2.test.rule1', 'pack': 'yoyohoneysingh', 'trigger': {'type': 'dummy_pack_1.st2.test.trigger1'}, 'criteria': {'k1': {'pattern': 't1_p_v', 'type': 'equals'}}, 'action': {'ref': 'sixpack.st2.test.action', 'parameters': {'ip2': '{{rule.k1}}', 'ip1': '{{trigger.t1_p}}'}}, 'id': '23', 'description': ''}
RULE_2 = {'enabled': True, 'name': 'st2.test.rule2', 'pack': 'yoyohoneysingh', 'trigger': {'type': 'dummy_pack_1.st2.test.trigger1'}, 'criteria': {'trigger.k1': {'pattern': 't1_p_v', 'type': 'equals'}}, 'action': {'ref': 'sixpack.st2.test.action', 'parameters': {'ip2': '{{rule.k1}}', 'ip1': '{{trigger.t1_p}}'}}, 'id': '23', 'description': ''}
RULE_3 = {'enabled': False, 'name': 'st2.test.rule3', 'pack': 'yoyohoneysingh', 'trigger': {'type': 'dummy_pack_1.st2.test.trigger1'}, 'criteria': {'trigger.k1': {'pattern': 't1_p_v', 'type': 'equals'}}, 'action': {'ref': 'sixpack.st2.test.action', 'parameters': {'ip2': '{{rule.k1}}', 'ip1': '{{trigger.t1_p}}'}}, 'id': '23', 'description': ''}
RULE_4 = {'enabled': True, 'name': 'st2.test.rule4', 'pack': 'yoyohoneysingh', 'trigger': {'type': 'dummy_pack_1.st2.test.trigger4'}, 'criteria': {'trigger.k1': {'pattern': 't2_p_v', 'type': 'equals'}}, 'action': {'ref': 'sixpack.st2.test.action', 'parameters': {'ip2': '{{rule.k1}}', 'ip1': '{{trigger.t1_p}}'}}, 'id': '23', 'description': ''}
...
class RuleMatcherTestCase(CleanDbTestCase):
    ...
    def _setup_sample_rule(self, rule):
        ...
        return rule_db
FIXTURES_TRIGGERS = {'triggertypes': ['triggertype1.yaml'], 'triggers': ['trigger1.yaml']}
