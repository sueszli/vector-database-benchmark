...
def test_binary_math_function(function):
    ...
    assembly = H2OAssembly(steps=[(function_name + '1', H2OBinaryOp(op=function, col='b', right=H2OCol('d'), new_col_name='n1', inplace=False)), (function_name + '2', H2OBinaryOp(op=function, col='b', right=5.0, new_col_name='n2', inplace=False)), (function_name + '3', H2OBinaryOp(op=function, col='b', left=5.0, new_col_name='n3', inplace=False))])
