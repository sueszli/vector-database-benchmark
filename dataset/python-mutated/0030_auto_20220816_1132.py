...
class Migration(migrations.Migration):
    dependencies = [('perms', '0029_auto_20220728_1728')]
    operations = [migrations.AddField(model_name='assetpermission', name='accounts', field=models.JSONField(default=list, verbose_name='Account')), migrations.RunPython(migrate_system_user_to_accounts), migrations.RemoveField(model_name='assetpermission', name='system_users')]