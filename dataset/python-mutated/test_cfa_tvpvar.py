...
results = {'invP': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_invP.csv'), header=None), 'posterior_mean': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_posterior_mean.csv'), header=None), 'state_variates': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_state_variates.csv'), header=None), 'beta': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_beta.csv'), header=None), 'v10': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_v10.csv'), header=None), 'S10': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_S10.csv'), header=None), 'Omega_11': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_Omega_11.csv'), header=None), 'vi0': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_vi0.csv'), header=None), 'Si0': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_Si0.csv'), header=None), 'Omega_22': pd.read_csv(os.path.join(results_path, 'cfa_tvpvar_Omega_22.csv'), header=None)}
