...
from .lineless_table_process import get_affine_transform, get_affine_transform_upper_left, load_lore_model, process_detect_output, process_logic_output
from .modules.lore_detector import LoreDetectModel
from .modules.lore_processor import LoreProcessModel
LOGGER = get_logger()

@MODELS.register_module(Tasks.lineless_table_recognition, Models.lineless_table_recognition)
