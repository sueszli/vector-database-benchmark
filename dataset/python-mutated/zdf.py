...
from ..utils import NO_DEFAULT, ExtractorError, determine_ext, extract_attributes, float_or_none, int_or_none, join_nonempty, merge_dicts, parse_codecs, qualities, traverse_obj, try_get, unified_timestamp, update_url_query, url_or_none, urljoin
...
class ZDFChannelIE(ZDFBaseIE):
    ...
    _TESTS = [{'url': 'https://www.zdf.de/sport/das-aktuelle-sportstudio', 'info_dict': {'id': 'das-aktuelle-sportstudio', 'title': 'das aktuelle sportstudio'}, 'playlist_mincount': 18}, {'url': 'https://www.zdf.de/dokumentation/planet-e', 'info_dict': {'id': 'planet-e', 'title': 'planet e.'}, 'playlist_mincount': 50}, {'url': 'https://www.zdf.de/gesellschaft/aktenzeichen-xy-ungeloest', 'info_dict': {'id': 'aktenzeichen-xy-ungeloest', 'title': 'Aktenzeichen XY... ungelöst', 'entries': "lambda x: not any('xy580-fall1-kindermoerder-gesucht-100' in e['url'] for e in x)"}, 'playlist_mincount': 2}, {'url': 'https://www.zdf.de/filme/taunuskrimi/', 'only_matching': True}]
