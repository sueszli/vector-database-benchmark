...
DOCUMENTS = [{'meta': {'name': 'name_1', 'year': '2020', 'month': '01'}, 'content': 'text_1', 'embedding': np.random.rand(768).astype(np.float32)}, {'meta': {'name': 'name_2', 'year': '2020', 'month': '02'}, 'content': 'text_2', 'embedding': np.random.rand(768).astype(np.float32)}, {'meta': {'name': 'name_3', 'year': '2020', 'month': '03'}, 'content': 'text_3', 'embedding': np.random.rand(768).astype(np.float64)}, {'meta': {'name': 'name_4', 'year': '2021', 'month': '01'}, 'content': 'text_4', 'embedding': np.random.rand(768).astype(np.float32)}, {'meta': {'name': 'name_5', 'year': '2021', 'month': '02'}, 'content': 'text_5', 'embedding': np.random.rand(768).astype(np.float32)}, {'meta': {'name': 'name_6', 'year': '2021', 'month': '03'}, 'content': 'text_6', 'embedding': np.random.rand(768).astype(np.float64)}]
