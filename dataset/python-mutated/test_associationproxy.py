...
class ScalarRemoveListObjectCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = True
    cascade_scalar_deletes = True
    uselist = True

class ScalarRemoveScalarObjectCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = True
    cascade_scalar_deletes = True
    uselist = False

class ScalarRemoveListScalarCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = False
    cascade_scalar_deletes = True
    uselist = True

class ScalarRemoveScalarScalarCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = False
    cascade_scalar_deletes = True
    uselist = False

class ScalarRemoveListObjectNoCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = True
    cascade_scalar_deletes = False
    uselist = True

class ScalarRemoveScalarObjectNoCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = True
    cascade_scalar_deletes = False
    uselist = False

class ScalarRemoveScalarObjectNoCascadeNoneAssign(ScalarRemoveScalarObjectNoCascade):
    create_on_none_assignment = True

class ScalarRemoveListScalarNoCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = False
    cascade_scalar_deletes = False
    uselist = True

class ScalarRemoveListScalarNoCascadeNoneAssign(ScalarRemoveScalarObjectNoCascade):
    create_on_none_assignment = True

class ScalarRemoveScalarScalarNoCascade(ScalarRemoveTest, fixtures.DeclarativeMappedTest):
    run_create_tables = None
    useobject = False
    cascade_scalar_deletes = False
    uselist = False
...
class MultiOwnerTest(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
