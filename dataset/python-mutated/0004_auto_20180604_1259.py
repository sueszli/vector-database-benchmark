...
class Migration(migrations.Migration):
    dependencies = [('projects', '0001_initial'), ('features', '0003_auto_20180601_1038')]
    operations = [migrations.RunPython(delete_existing_non_unique_features, reverse_migration), migrations.AlterUniqueTogether(name='feature', unique_together=set([('name', 'project')]))]