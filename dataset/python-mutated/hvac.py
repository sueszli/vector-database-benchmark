...
from ..const import REPORT_CONFIG_MAX_INT, REPORT_CONFIG_MIN_INT, REPORT_CONFIG_OP, SIGNAL_ATTR_UPDATED
...
class ThermostatClusterHandler(ClusterHandler):
    ...
    REPORT_CONFIG = (AttrReportConfig(attr='local_temperature', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='occupied_cooling_setpoint', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='occupied_heating_setpoint', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='unoccupied_cooling_setpoint', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='unoccupied_heating_setpoint', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='running_mode', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='running_state', config=REPORT_CONFIG_CLIMATE_DEMAND), AttrReportConfig(attr='system_mode', config=REPORT_CONFIG_CLIMATE), AttrReportConfig(attr='occupancy', config=REPORT_CONFIG_CLIMATE_DISCRETE), AttrReportConfig(attr='pi_cooling_demand', config=REPORT_CONFIG_CLIMATE_DEMAND), AttrReportConfig(attr='pi_heating_demand', config=REPORT_CONFIG_CLIMATE_DEMAND))
    ZCL_INIT_ATTRS: dict[str, bool] = {'abs_min_heat_setpoint_limit': True, 'abs_max_heat_setpoint_limit': True, 'abs_min_cool_setpoint_limit': True, 'abs_max_cool_setpoint_limit': True, 'ctrl_sequence_of_oper': False, 'max_cool_setpoint_limit': True, 'max_heat_setpoint_limit': True, 'min_cool_setpoint_limit': True, 'min_heat_setpoint_limit': True}
    ...
    async def async_set_heating_setpoint(self, temperature: int, is_away: bool=False) -> bool:
