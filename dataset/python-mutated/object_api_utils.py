...
from aim.web.api.runs.utils import ASYNC_SLEEP_INTERVAL, PROGRESS_KEY_SUFFIX, IndexRange, collect_streamable_data, get_run_props, get_run_params
        ...
        try:
            ...
            for key in list(self.trace_cache.keys()):
                ...
                if report_progress and time.time() - last_reported_progress_time > AIM_PROGRESS_REPORT_INTERVAL:
                    yield collect_streamable_data(encode_tree({f'progress_{progress_reports_sent}_{PROGRESS_KEY_SUFFIX}': run_info['progress']}))
