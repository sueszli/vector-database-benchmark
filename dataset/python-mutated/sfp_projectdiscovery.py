...
class sfp_projectdiscovery(SpiderFootPlugin):
    meta = {'name': 'ProjectDiscovery Chaos', 'summary': 'Search for hosts/subdomains using chaos.projectdiscovery.io', 'flags': ['apikey'], 'useCases': ['Passive', 'Footprint', 'Investigate'], 'categories': ['Passive DNS'], 'dataSource': {'website': 'https://chaos.projectdiscovery.io', 'model': 'PRIVATE_ONLY', 'references': ['https://chaos.projectdiscovery.io/#/docs', 'https://projectdiscovery.io/privacy', 'https://projectdiscovery.io/about'], 'apiKeyInstructions': ['Visit https://chaos.projectdiscovery.io/#/', 'Click the request access button', "Click the 'Early signup form' link or go to https://forms.gle/GP5nTamxJPfiMaBn9", "Click on 'Developer'", "The API key is listed under 'Your API Key'", 'You will receive your API key by email.'], 'logo': 'https://projectdiscovery.io/assets/img/logo.png', 'description': "Projectdiscovery Chaos actively collect and maintain internet-wide assets' data, this project is meant to enhance research and analyse changes around DNS for better insights. "}}
    opts = {'api_key': '', 'verify': True}
    optdescs = {'api_key': 'chaos.projectdiscovery.io API Key.', 'verify': 'Verify that any hostnames found on the target domain still resolve?'}
    results = None
    errorState = False
