...
class ExportConfigurationsOperations:
    ...
    async def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> List[_models.ApplicationInsightsComponentExportConfiguration]:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, export_properties: _models.ApplicationInsightsComponentExportRequest, *, content_type: str='application/json', **kwargs: Any) -> List[_models.ApplicationInsightsComponentExportConfiguration]:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, export_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> List[_models.ApplicationInsightsComponentExportConfiguration]:
        """Create a Continuous Export configuration of an Application Insights component.
    ...
    @distributed_trace_async
    async def create(self, resource_group_name: str, resource_name: str, export_properties: Union[_models.ApplicationInsightsComponentExportRequest, IO], **kwargs: Any) -> List[_models.ApplicationInsightsComponentExportConfiguration]:
        """Create a Continuous Export configuration of an Application Insights component.
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, resource_name: str, export_id: str, **kwargs: Any) -> _models.ApplicationInsightsComponentExportConfiguration:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, resource_name=resource_name, export_id=export_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, export_id: str, **kwargs: Any) -> _models.ApplicationInsightsComponentExportConfiguration:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[_models.ApplicationInsightsComponentExportConfiguration] = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, export_id=export_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, export_id: str, export_properties: _models.ApplicationInsightsComponentExportRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentExportConfiguration:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, export_id: str, export_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentExportConfiguration:
        """Update the Continuous Export configuration for this export id.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, resource_name: str, export_id: str, export_properties: Union[_models.ApplicationInsightsComponentExportRequest, IO], **kwargs: Any) -> _models.ApplicationInsightsComponentExportConfiguration:
        """Update the Continuous Export configuration for this export id.
