...
class executionsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'cancel_execution': ('name',), 'create_execution': ('parent', 'execution'), 'get_execution': ('name', 'view'), 'list_executions': ('parent', 'page_size', 'page_token', 'view')}
