...
from localstack.aws.api import CommonServiceException, HttpRequest, RequestContext, ServiceException, ServiceRequest, handler
...
MessageBodySystemAttributeMap = Dict[MessageSystemAttributeNameForSends, MessageSystemAttributeValue]
