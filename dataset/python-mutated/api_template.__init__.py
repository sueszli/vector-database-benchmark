...
try:
    ...
    _current_module.__path__ = [_module_util.get_parent_dir(summary)] + _current_module.__path__
...
_initializers = _KerasLazyLoader(globals(), submodule='initializers', name='initializers')
