...
TEST_MODELS = {'aliases': ['alias1.yaml', 'alias2.yaml', 'alias_with_undefined_jinja_in_ack_format.yaml'], 'actions': ['action3.yaml', 'action4.yaml']}
TEST_LOAD_MODELS = {'aliases': ['alias3.yaml']}
TEST_LOAD_MODELS_GENERIC = {'aliases': ['alias3.yaml'], 'runners': ['testrunner1.yaml']}

class ActionAliasControllerTestCase(FunctionalTest, APIControllerWithIncludeAndExcludeFilterTestCase):
