...
class RobustDPatch(EvasionAttack):
    ...
    | Paper link (physical-world patch from Lee & Kolter): https://arxiv.org/abs/1906.11897
    """
    attack_params = EvasionAttack.attack_params + ['patch_shape', 'learning_rate', 'max_iter', 'batch_size', 'patch_location', 'crop_range', 'brightness_range', 'rotation_weights', 'sample_size', 'targeted', 'summary_writer', 'verbose']
