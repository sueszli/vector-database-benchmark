...
def main():
    ...
    response = client.devices.begin_scan_for_updates(device_name='testedgedevice', resource_group_name='GroupForEdgeAutomation').result()
    print(response)
