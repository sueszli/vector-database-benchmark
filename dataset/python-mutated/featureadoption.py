...
from sentry.db.models import BaseManager, FlexibleForeignKey, JSONField, Model, region_silo_only_model, sane_repr
...
manager.add(70, 'delete_and_discard', 'Delete and Discard Future Events', 'web', prerequisite=['first_event'])
...
class FeatureAdoptionManager(BaseManager['FeatureAdoption']):
    cache_backend: FeatureAdoptionRedisBackend = cast(FeatureAdoptionRedisBackend, build_instance_from_options(settings.SENTRY_FEATURE_ADOPTION_CACHE_OPTIONS))
