...
DATA_SCHEMA = ['state', 'progress', 'total', 'ray_data_output_bytes', 'ray_data_spilled_bytes', 'ray_data_current_bytes']
RESPONSE_SCHEMA = ['dataset', 'start_time', 'end_time', 'operators'] + DATA_SCHEMA
OPERATOR_SCHEMA = ['operator'] + DATA_SCHEMA
