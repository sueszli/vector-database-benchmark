...
@PIPELINES.register_module(Tasks.auto_speech_recognition, module_name=Pipelines.ofa_asr)
class AutomaticSpeechRecognitionPipeline(Pipeline):
    ...
    def __init__(self, model: Union[Model, str], preprocessor: Optional[Preprocessor]=None, **kwargs):
        ...
        assert isinstance(model, str) or isinstance(model, Model), 'model must be a single str or OfaForAllTasks'
