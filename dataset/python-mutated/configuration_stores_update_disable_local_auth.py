...
def main():
    ...
    response = client.configuration_stores.begin_update(resource_group_name='myResourceGroup', config_store_name='contoso', config_store_update_parameters={'properties': {'disableLocalAuth': True}, 'sku': {'name': 'Standard'}}).result()
    print(response)
