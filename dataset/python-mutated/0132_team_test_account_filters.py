...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0131_add_plugins_updated_created_at')]
    operations = [migrations.AddField(model_name='team', name='test_account_filters', field=django.contrib.postgres.fields.jsonb.JSONField(default=list)), migrations.RunPython(forward, reverse, elidable=True)]