...
class TestWebClient(unittest.TestCase):
    ...
    def test_sync(self):
        ...
        self.assertIsNotNone(client.admin_conversations_setCustomRetention(channel_id=created_channel_id, duration_days=365))
        self.assertIsNotNone(client.admin_conversations_getCustomRetention(channel_id=created_channel_id))
        self.assertIsNotNone(client.admin_conversations_removeCustomRetention(channel_id=created_channel_id))
        time.sleep(2)
    ...
    async def test_async(self):
        ...
        self.assertIsNotNone(conv_creation)
        created_channel_id = conv_creation.data['channel_id']
        self.assertIsNotNone(await client.admin_conversations_setCustomRetention(channel_id=created_channel_id, duration_days=365))
        self.assertIsNotNone(await client.admin_conversations_getCustomRetention(channel_id=created_channel_id))
        self.assertIsNotNone(await client.admin_conversations_removeCustomRetention(channel_id=created_channel_id))
