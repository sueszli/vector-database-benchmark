...
class InlineQueryResultMpeg4Gif(InlineQueryResult):
    ...
    """
    __slots__ = ('reply_markup', 'thumbnail_mime_type', 'caption_entities', 'mpeg4_duration', 'mpeg4_width', 'title', 'caption', 'parse_mode', 'input_message_content', 'mpeg4_url', 'mpeg4_height', 'thumbnail_url')

    def __init__(self, id: str, mpeg4_url: str, thumbnail_url: str, mpeg4_width: Optional[int]=None, mpeg4_height: Optional[int]=None, title: Optional[str]=None, caption: Optional[str]=None, reply_markup: Optional[InlineKeyboardMarkup]=None, input_message_content: Optional['InputMessageContent']=None, mpeg4_duration: Optional[int]=None, parse_mode: ODVInput[str]=DEFAULT_NONE, caption_entities: Optional[Sequence[MessageEntity]]=None, thumbnail_mime_type: Optional[str]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            i = 10
            return i + 15
