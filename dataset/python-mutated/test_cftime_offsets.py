...
from xarray.coding.cftime_offsets import _MONTH_ABBREVIATIONS, BaseCFTimeOffset, Day, Hour, Microsecond, Millisecond, Minute, MonthBegin, MonthEnd, QuarterBegin, QuarterEnd, Second, Tick, YearBegin, YearEnd, _days_in_month, cftime_range, date_range, date_range_like, get_date_type, to_cftime_datetime, to_offset
...
_EQ_TESTS_A = [BaseCFTimeOffset(), YearBegin(), YearEnd(), YearBegin(month=2), YearEnd(month=2), QuarterBegin(), QuarterEnd(), QuarterBegin(month=2), QuarterEnd(month=2), MonthBegin(), MonthEnd(), Day(), Hour(), Minute(), Second(), Millisecond(), Microsecond()]
_EQ_TESTS_B = [BaseCFTimeOffset(n=2), YearBegin(n=2), YearEnd(n=2), YearBegin(n=2, month=2), YearEnd(n=2, month=2), QuarterBegin(n=2), QuarterEnd(n=2), QuarterBegin(n=2, month=2), QuarterEnd(n=2, month=2), MonthBegin(n=2), MonthEnd(n=2), Day(n=2), Hour(n=2), Minute(n=2), Second(n=2), Millisecond(n=2), Microsecond(n=2)]
...
def test_neq(a, b):
    if False:
        print('Hello World!')
    assert a != b
_EQ_TESTS_B_COPY = [BaseCFTimeOffset(n=2), YearBegin(n=2), YearEnd(n=2), YearBegin(n=2, month=2), YearEnd(n=2, month=2), QuarterBegin(n=2), QuarterEnd(n=2), QuarterBegin(n=2, month=2), QuarterEnd(n=2, month=2), MonthBegin(n=2), MonthEnd(n=2), Day(n=2), Hour(n=2), Minute(n=2), Second(n=2), Millisecond(n=2), Microsecond(n=2)]
...
_ADD_TESTS = [(Day(n=2), (1, 1, 3)), (Hour(n=2), (1, 1, 1, 2)), (Minute(n=2), (1, 1, 1, 0, 2)), (Second(n=2), (1, 1, 1, 0, 0, 2)), (Millisecond(n=2), (1, 1, 1, 0, 0, 0, 2000)), (Microsecond(n=2), (1, 1, 1, 0, 0, 0, 2))]
...
_CALENDAR_SPECIFIC_MONTH_END_TESTS = [('2M', 'noleap', [(2, 28), (4, 30), (6, 30), (8, 31), (10, 31), (12, 31)]), ('2M', 'all_leap', [(2, 29), (4, 30), (6, 30), (8, 31), (10, 31), (12, 31)]), ('2M', '360_day', [(2, 30), (4, 30), (6, 30), (8, 30), (10, 30), (12, 30)]), ('2M', 'standard', [(2, 29), (4, 30), (6, 30), (8, 31), (10, 31), (12, 31)]), ('2M', 'gregorian', [(2, 29), (4, 30), (6, 30), (8, 31), (10, 31), (12, 31)]), ('2M', 'julian', [(2, 29), (4, 30), (6, 30), (8, 31), (10, 31), (12, 31)])]
