...
path_uuid_pattern = re.compile('<\\w+:\\w+>', re.IGNORECASE)
uuid_pattern = re.compile('\\(\\(\\?P<.*>[^)]+\\)/\\)\\?', re.IGNORECASE)
uuid2_pattern = re.compile('\\(\\?P<.*>\\[\\/\\.\\]\\+\\)', re.IGNORECASE)
uuid3_pattern = re.compile('\\(\\?P<.*>\\[/\\.]\\+\\)')
...
def get_api_urls():
    ...
    return set(urls)
known_unauth_urls = ['/api/v1/authentication/passkeys/auth/', '/api/v1/prometheus/metrics/', '/api/v1/authentication/auth/', '/api/v1/settings/logo/', '/api/v1/settings/public/open/', '/api/v1/authentication/passkeys/login/', '/api/v1/authentication/tokens/', '/api/v1/authentication/mfa/challenge/', '/api/v1/authentication/password/reset-code/', '/api/v1/authentication/login-confirm-ticket/status/', '/api/v1/authentication/mfa/select/', '/api/v1/authentication/mfa/send-code/', '/api/v1/authentication/sso/login/']
known_error_urls = ['/api/v1/terminal/terminals/00000000-0000-0000-0000-000000000000/sessions/00000000-0000-0000-0000-000000000000/replay/download/', '/api/v1/terminal/sessions/00000000-0000-0000-0000-000000000000/replay/download/']
errors = {}
