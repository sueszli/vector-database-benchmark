...
_TYP_MAP = {'Program': SerializedProgram, 'CFGNode': SerializedCFGNode, 'Variable': SerializedVariable, 'Binding': SerializedBinding, 'Origin': SerializedOrigin, 'QueryStep': SerializedQueryStep, 'Query': SerializedQuery}
