...
from .bytecode_analysis import get_indexof, propagate_line_nums, remove_extra_line_nums, stacksize_analysis
...
def fix_extended_args(instructions: List[Instruction]) -> int:
    ...
    instructions[:] = output
    return added
_PYOPCODE_CACHES = {'BINARY_SUBSCR': 4, 'STORE_SUBSCR': 1, 'UNPACK_SEQUENCE': 1, 'STORE_ATTR': 4, 'LOAD_ATTR': 4, 'COMPARE_OP': 2, 'LOAD_GLOBAL': 5, 'BINARY_OP': 1, 'LOAD_METHOD': 10, 'PRECALL': 1, 'CALL': 4}
