...
class VidbitIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.vidbit.co/watch?v=jkL2yDOEq2', 'md5': '1a34b7f14defe3b8fafca9796892924d', 'info_dict': {'id': 'jkL2yDOEq2', 'ext': 'mp4', 'title': 'Intro to VidBit', 'description': 'md5:5e0d6142eec00b766cbf114bfd3d16b7', 'thumbnail': 're:https?://.*\\.jpg$', 'upload_date': '20160618', 'view_count': int, 'comment_count': int}}, {'url': 'http://www.vidbit.co/embed?v=jkL2yDOEq2&auto=0&water=0', 'only_matching': True}]
