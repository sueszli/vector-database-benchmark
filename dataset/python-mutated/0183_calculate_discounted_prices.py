...
BATCH_SIZE = 500
DiscountInfo = namedtuple('DiscountInfo', ['sale', 'channel_listings', 'product_ids', 'category_ids', 'collection_ids', 'variants_ids'])
...
class Migration(migrations.Migration):
    dependencies = [('product', '0182_productvariantchannellisting_discounted_price_amount')]
    operations = [migrations.RunPython(calculate_variants_discounted_price, migrations.RunPython.noop)]