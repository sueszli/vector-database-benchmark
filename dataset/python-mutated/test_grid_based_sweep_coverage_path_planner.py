import conftest
from PathPlanning.GridBasedSweepCPP import grid_based_sweep_coverage_path_planner
grid_based_sweep_coverage_path_planner.do_animation = False
RIGHT = grid_based_sweep_coverage_path_planner.SweepSearcher.MovingDirection.RIGHT
LEFT = grid_based_sweep_coverage_path_planner.SweepSearcher.MovingDirection.LEFT
UP = grid_based_sweep_coverage_path_planner.SweepSearcher.SweepDirection.UP
DOWN = grid_based_sweep_coverage_path_planner.SweepSearcher.SweepDirection.DOWN
