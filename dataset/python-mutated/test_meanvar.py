...
ignore_runtime_warnings = pytest.mark.filterwarnings('ignore', category=RuntimeWarning)
...
@testing.parameterize(*testing.product({'shape': [(3, 4, 5)], 'axis': [(0, 1), (0, -1), (1, 2), (1,)], 'keepdims': [True, False]}))
...
@testing.parameterize(*testing.product({'shape': [(3, 4, 5)], 'axis': [None, 0, 1, -1, (0, 1), (0, 2), (-1, -2), [0, 1]], 'keepdims': [True, False], 'overwrite_input': [True, False]}))
class TestNanMedian:
    zero_density = 0.25
...
@testing.parameterize(*testing.product({'shape': [(3, 4), (30, 40, 50)], 'axis': [None, 0, 1], 'keepdims': [True, False]}))
class TestNanMean:
...
@testing.parameterize(*testing.product({'shape': [(3, 4), (4, 3, 5)], 'axis': [None, 0, 1], 'keepdims': [True, False], 'ddof': [0, 1]}))
class TestNanVarStd:
...
@testing.parameterize(*testing.product({'params': [((), None), ((0,), None), ((0, 0), None), ((0, 0), 1), ((0, 0, 0), None), ((0, 0, 0), (0, 2))], 'func': ['mean', 'std', 'var']}))
