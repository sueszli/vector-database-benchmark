...
class ActiveDirectoryConnectorDNSDetails(_serialization.Model):
    ...
    """
    _validation = {'nameserver_ip_addresses': {'required': True}}
    _attribute_map = {'domain_name': {'key': 'domainName', 'type': 'str'}, 'nameserver_ip_addresses': {'key': 'nameserverIPAddresses', 'type': '[str]'}, 'replicas': {'key': 'replicas', 'type': 'int'}, 'prefer_k8_s_dns_for_ptr_lookups': {'key': 'preferK8sDnsForPtrLookups', 'type': 'bool'}}
...
class ActiveDirectoryConnectorDomainDetails(_serialization.Model):
    ...
    """
    _validation = {'realm': {'required': True}, 'domain_controllers': {'required': True}}
    _attribute_map = {'realm': {'key': 'realm', 'type': 'str'}, 'netbios_domain_name': {'key': 'netbiosDomainName', 'type': 'str'}, 'service_account_provisioning': {'key': 'serviceAccountProvisioning', 'type': 'str'}, 'ou_distinguished_name': {'key': 'ouDistinguishedName', 'type': 'str'}, 'domain_controllers': {'key': 'domainControllers', 'type': 'ActiveDirectoryDomainControllers'}}
...
class ActiveDirectoryConnectorListResult(_serialization.Model):
    ...
    _attribute_map = {'value': {'key': 'value', 'type': '[ActiveDirectoryConnectorResource]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class ActiveDirectoryConnectorProperties(_serialization.Model):
    ...
    """
    _validation = {'provisioning_state': {'readonly': True}, 'spec': {'required': True}}
    _attribute_map = {'domain_service_account_login_information': {'key': 'domainServiceAccountLoginInformation', 'type': 'BasicLoginInformation'}, 'provisioning_state': {'key': 'provisioningState', 'type': 'str'}, 'spec': {'key': 'spec', 'type': 'ActiveDirectoryConnectorSpec'}, 'status': {'key': 'status', 'type': 'ActiveDirectoryConnectorStatus'}}
...
class Resource(_serialization.Model):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}}
...
class ActiveDirectoryConnectorResource(ProxyResource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}, 'properties': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}, 'properties': {'key': 'properties', 'type': 'ActiveDirectoryConnectorProperties'}}
...
class ActiveDirectoryConnectorSpec(_serialization.Model):
    ...
    """
    _validation = {'active_directory': {'required': True}, 'dns': {'required': True}}
    _attribute_map = {'active_directory': {'key': 'activeDirectory', 'type': 'ActiveDirectoryConnectorDomainDetails'}, 'dns': {'key': 'dns', 'type': 'ActiveDirectoryConnectorDNSDetails'}}
...
class ActiveDirectoryConnectorStatus(_serialization.Model):
    ...
    :vartype state: str
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'last_update_time': {'key': 'lastUpdateTime', 'type': 'str'}, 'observed_generation': {'key': 'observedGeneration', 'type': 'int'}, 'state': {'key': 'state', 'type': 'str'}}
...
class ActiveDirectoryDomainController(_serialization.Model):
    ...
    """
    _validation = {'hostname': {'required': True}}
    _attribute_map = {'hostname': {'key': 'hostname', 'type': 'str'}}
...
class ActiveDirectoryDomainControllers(_serialization.Model):
    ...
    """
    _attribute_map = {'primary_domain_controller': {'key': 'primaryDomainController', 'type': 'ActiveDirectoryDomainController'}, 'secondary_domain_controllers': {'key': 'secondaryDomainControllers', 'type': '[ActiveDirectoryDomainController]'}}
...
class ActiveDirectoryInformation(_serialization.Model):
    ...
    """
    _attribute_map = {'keytab_information': {'key': 'keytabInformation', 'type': 'KeytabInformation'}}
...
class BasicLoginInformation(_serialization.Model):
    ...
    """
    _attribute_map = {'username': {'key': 'username', 'type': 'str'}, 'password': {'key': 'password', 'type': 'str'}}
...
class CommonSku(_serialization.Model):
    ...
    """
    _validation = {'name': {'required': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'dev': {'key': 'dev', 'type': 'bool'}, 'size': {'key': 'size', 'type': 'str'}, 'family': {'key': 'family', 'type': 'str'}, 'capacity': {'key': 'capacity', 'type': 'int'}}
...
class TrackedResource(Resource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}, 'location': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'location': {'key': 'location', 'type': 'str'}}
...
class DataControllerResource(TrackedResource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}, 'location': {'required': True}, 'properties': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'location': {'key': 'location', 'type': 'str'}, 'extended_location': {'key': 'extendedLocation', 'type': 'ExtendedLocation'}, 'properties': {'key': 'properties', 'type': 'DataControllerProperties'}}
...
class DataControllerUpdate(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.azurearcdata.models.DataControllerProperties
    """
    _attribute_map = {'tags': {'key': 'tags', 'type': '{str}'}, 'properties': {'key': 'properties', 'type': 'DataControllerProperties'}}
...
class ErrorResponse(_serialization.Model):
    ...
    """
    _attribute_map = {'error': {'key': 'error', 'type': 'ErrorResponseBody'}}
...
class ErrorResponseBody(_serialization.Model):
    ...
    """
    _attribute_map = {'code': {'key': 'code', 'type': 'str'}, 'message': {'key': 'message', 'type': 'str'}, 'target': {'key': 'target', 'type': 'str'}, 'details': {'key': 'details', 'type': '[ErrorResponseBody]'}}
...
class K8SResourceRequirements(_serialization.Model):
    ...
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'requests': {'key': 'requests', 'type': '{str}'}, 'limits': {'key': 'limits', 'type': '{str}'}}
...
class K8SScheduling(_serialization.Model):
    ...
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'default': {'key': 'default', 'type': 'K8SSchedulingOptions'}}
...
class K8SSchedulingOptions(_serialization.Model):
    ...
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'resources': {'key': 'resources', 'type': 'K8SResourceRequirements'}}
...
class KeytabInformation(_serialization.Model):
    ...
    :vartype keytab: str
    """
    _attribute_map = {'keytab': {'key': 'keytab', 'type': 'str'}}
...
class LogAnalyticsWorkspaceConfig(_serialization.Model):
    ...
    """
    _attribute_map = {'workspace_id': {'key': 'workspaceId', 'type': 'str'}, 'primary_key': {'key': 'primaryKey', 'type': 'str'}}
...
class OnPremiseProperty(_serialization.Model):
    ...
    """
    _validation = {'id': {'required': True}, 'public_signing_key': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'public_signing_key': {'key': 'publicSigningKey', 'type': 'str'}, 'signing_certificate_thumbprint': {'key': 'signingCertificateThumbprint', 'type': 'str'}}
...
class Operation(_serialization.Model):
    ...
    """
    _validation = {'name': {'required': True}, 'display': {'required': True}, 'origin': {'readonly': True}, 'is_data_action': {'required': True}, 'properties': {'readonly': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'display': {'key': 'display', 'type': 'OperationDisplay'}, 'origin': {'key': 'origin', 'type': 'str'}, 'is_data_action': {'key': 'isDataAction', 'type': 'bool'}, 'properties': {'key': 'properties', 'type': '{object}'}}
...
class OperationDisplay(_serialization.Model):
    ...
    """
    _validation = {'provider': {'required': True}, 'resource': {'required': True}, 'operation': {'required': True}, 'description': {'required': True}}
...
class OperationListResult(_serialization.Model):
    ...
    """
    _validation = {'value': {'readonly': True}, 'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[Operation]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class PageOfDataControllerResource(_serialization.Model):
    ...
    :vartype next_link: str
    """
    _attribute_map = {'value': {'key': 'value', 'type': '[DataControllerResource]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class PostgresInstanceListResult(_serialization.Model):
    ...
    """
    _validation = {'value': {'readonly': True}, 'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[PostgresInstance]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class PostgresInstanceProperties(_serialization.Model):
    ...
    """
    _validation = {'provisioning_state': {'readonly': True}}
    _attribute_map = {'data_controller_id': {'key': 'dataControllerId', 'type': 'str'}, 'admin': {'key': 'admin', 'type': 'str'}, 'basic_login_information': {'key': 'basicLoginInformation', 'type': 'BasicLoginInformation'}, 'k8_s_raw': {'key': 'k8sRaw', 'type': 'object'}, 'last_uploaded_date': {'key': 'lastUploadedDate', 'type': 'iso-8601'}, 'provisioning_state': {'key': 'provisioningState', 'type': 'str'}}
...
class PostgresInstanceSku(CommonSku):
    ...
    """
    _validation = {'name': {'required': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'dev': {'key': 'dev', 'type': 'bool'}, 'size': {'key': 'size', 'type': 'str'}, 'family': {'key': 'family', 'type': 'str'}, 'capacity': {'key': 'capacity', 'type': 'int'}, 'tier': {'key': 'tier', 'type': 'str'}}
...
class PostgresInstanceUpdate(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.azurearcdata.models.PostgresInstanceProperties
    """
    _attribute_map = {'tags': {'key': 'tags', 'type': '{str}'}, 'properties': {'key': 'properties', 'type': 'PostgresInstanceProperties'}}
...
class SqlManagedInstance(TrackedResource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}, 'location': {'required': True}, 'properties': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'location': {'key': 'location', 'type': 'str'}, 'properties': {'key': 'properties', 'type': 'SqlManagedInstanceProperties'}, 'extended_location': {'key': 'extendedLocation', 'type': 'ExtendedLocation'}, 'sku': {'key': 'sku', 'type': 'SqlManagedInstanceSku'}}
...
class SqlManagedInstanceK8SRaw(_serialization.Model):
    ...
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'spec': {'key': 'spec', 'type': 'SqlManagedInstanceK8SSpec'}}
...
class SqlManagedInstanceK8SSpec(_serialization.Model):
    ...
    :vartype replicas: int
    """
    _attribute_map = {'additional_properties': {'key': '', 'type': '{object}'}, 'scheduling': {'key': 'scheduling', 'type': 'K8SScheduling'}, 'replicas': {'key': 'replicas', 'type': 'int'}}
...
class SqlManagedInstanceListResult(_serialization.Model):
    ...
    """
    _validation = {'value': {'readonly': True}, 'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[SqlManagedInstance]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class SqlManagedInstanceSku(_serialization.Model):
    ...
    :vartype capacity: int
    """
    _validation = {'name': {'required': True, 'constant': True}}
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'tier': {'key': 'tier', 'type': 'str'}, 'dev': {'key': 'dev', 'type': 'bool'}, 'size': {'key': 'size', 'type': 'str'}, 'family': {'key': 'family', 'type': 'str'}, 'capacity': {'key': 'capacity', 'type': 'int'}}
    name = 'vCore'
...
class SqlServerInstance(TrackedResource):
    ...
    """
    _validation = {'id': {'readonly': True}, 'name': {'readonly': True}, 'type': {'readonly': True}, 'system_data': {'readonly': True}, 'location': {'required': True}}
    _attribute_map = {'id': {'key': 'id', 'type': 'str'}, 'name': {'key': 'name', 'type': 'str'}, 'type': {'key': 'type', 'type': 'str'}, 'system_data': {'key': 'systemData', 'type': 'SystemData'}, 'tags': {'key': 'tags', 'type': '{str}'}, 'location': {'key': 'location', 'type': 'str'}, 'properties': {'key': 'properties', 'type': 'SqlServerInstanceProperties'}}
...
class SqlServerInstanceListResult(_serialization.Model):
    ...
    """
    _validation = {'value': {'readonly': True}, 'next_link': {'readonly': True}}
    _attribute_map = {'value': {'key': 'value', 'type': '[SqlServerInstance]'}, 'next_link': {'key': 'nextLink', 'type': 'str'}}
...
class SystemData(_serialization.Model):
    ...
    """
    _attribute_map = {'created_by': {'key': 'createdBy', 'type': 'str'}, 'created_by_type': {'key': 'createdByType', 'type': 'str'}, 'created_at': {'key': 'createdAt', 'type': 'iso-8601'}, 'last_modified_by': {'key': 'lastModifiedBy', 'type': 'str'}, 'last_modified_by_type': {'key': 'lastModifiedByType', 'type': 'str'}, 'last_modified_at': {'key': 'lastModifiedAt', 'type': 'iso-8601'}}
...
class UploadServicePrincipal(_serialization.Model):
    ...
    """
    _attribute_map = {'client_id': {'key': 'clientId', 'type': 'str'}, 'tenant_id': {'key': 'tenantId', 'type': 'str'}, 'authority': {'key': 'authority', 'type': 'str'}, 'client_secret': {'key': 'clientSecret', 'type': 'str'}}
...
class UploadWatermark(_serialization.Model):
    ...
    """
    _attribute_map = {'metrics': {'key': 'metrics', 'type': 'iso-8601'}, 'logs': {'key': 'logs', 'type': 'iso-8601'}, 'usages': {'key': 'usages', 'type': 'iso-8601'}}
