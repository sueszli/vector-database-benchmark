...
if __name__ == '__main__':
    ...
    parser.add_argument('-all', action='store_true', help="Return all users, including those with no email addresses and disabled accounts. When used with -user it will return user's info even if the account is disabled")
