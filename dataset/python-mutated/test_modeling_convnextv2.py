...
class ConvNextV2ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    """
    all_model_classes = (ConvNextV2Model, ConvNextV2ForImageClassification, ConvNextV2Backbone) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': ConvNextV2Model, 'image-classification': ConvNextV2ForImageClassification} if is_torch_available() else {}
    fx_compatible = False
    test_pruning = False
