...
DISABLE_SSO_CHECK_SU_FORM_FOR_LOCAL_DEV = getattr(settings, 'DISABLE_SSO_CHECK_SU_FORM_FOR_LOCAL_DEV', False)
DISABLE_SU_FORM_U2F_CHECK_FOR_LOCAL = getattr(settings, 'DISABLE_SU_FORM_U2F_CHECK_FOR_LOCAL', False)

@control_silo_endpoint
class AuthIndexEndpoint(Endpoint):
    publish_status = {'DELETE': ApiPublishStatus.UNKNOWN, 'GET': ApiPublishStatus.UNKNOWN, 'PUT': ApiPublishStatus.UNKNOWN, 'POST': ApiPublishStatus.UNKNOWN}
