...
from sentry.db.models import BoundedPositiveIntegerField, FlexibleForeignKey, control_silo_only_model
...
class OrganizationIntegration(ReplicatedControlModel):
    ...
    status = BoundedPositiveIntegerField(default=ObjectStatus.ACTIVE, choices=ObjectStatus.as_choices())
    grace_period_end = models.DateTimeField(null=True, blank=True, db_index=True)
    objects: ClassVar[ControlOutboxProducingManager[OrganizationIntegration]] = ControlOutboxProducingManager()
