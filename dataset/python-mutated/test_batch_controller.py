...
from google.cloud.dataproc_v1.services.batch_controller import BatchControllerAsyncClient, BatchControllerClient, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert BatchControllerClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert BatchControllerClient._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BatchControllerClient._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BatchControllerClient._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert BatchControllerClient._get_default_mtls_endpoint(non_googleapi) == non_googleapi

@pytest.mark.parametrize('client_class,transport_name', [(BatchControllerClient, 'grpc'), (BatchControllerAsyncClient, 'grpc_asyncio'), (BatchControllerClient, 'rest')])
def test_batch_controller_client_from_service_account_info(client_class, transport_name):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.BatchControllerGrpcTransport, 'grpc'), (transports.BatchControllerGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.BatchControllerRestTransport, 'rest')])
def test_batch_controller_client_service_account_always_use_jwt(transport_class, transport_name):
    if False:
        i = 10
        return i + 15
...
@pytest.mark.parametrize('client_class,transport_name', [(BatchControllerClient, 'grpc'), (BatchControllerAsyncClient, 'grpc_asyncio'), (BatchControllerClient, 'rest')])
def test_batch_controller_client_from_service_account_file(client_class, transport_name):
    if False:
        for i in range(10):
            print('nop')
    creds = ga_credentials.AnonymousCredentials()
...
def test_batch_controller_client_get_transport_class():
    ...
    available_transports = [transports.BatchControllerGrpcTransport, transports.BatchControllerRestTransport]
    assert transport in available_transports
    transport = BatchControllerClient.get_transport_class('grpc')
    assert transport == transports.BatchControllerGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(BatchControllerClient, transports.BatchControllerGrpcTransport, 'grpc'), (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, 'grpc_asyncio'), (BatchControllerClient, transports.BatchControllerRestTransport, 'rest')])
@mock.patch.object(BatchControllerClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BatchControllerClient))
@mock.patch.object(BatchControllerAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BatchControllerAsyncClient))
def test_batch_controller_client_client_options(client_class, transport_class, transport_name):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize('client_class', [BatchControllerClient, BatchControllerAsyncClient])
@mock.patch.object(BatchControllerClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BatchControllerClient))
@mock.patch.object(BatchControllerAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BatchControllerAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(BatchControllerClient, transports.BatchControllerGrpcTransport, 'grpc'), (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, 'grpc_asyncio'), (BatchControllerClient, transports.BatchControllerRestTransport, 'rest')])
def test_batch_controller_client_client_options_scopes(client_class, transport_class, transport_name):
    if False:
        return 10
...
def test_batch_controller_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.dataproc_v1.services.batch_controller.transports.BatchControllerGrpcTransport.__init__') as grpc_transport:
        ...
        client = BatchControllerClient(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(BatchControllerClient, transports.BatchControllerGrpcTransport, 'grpc', grpc_helpers), (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
def test_batch_controller_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    if False:
        while True:
            i = 10
    options = client_options.ClientOptions(credentials_file='credentials.json')
...
def test_create_batch(request_type, transport: str='grpc'):
    if False:
        print('Hello World!')
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_batch_empty_call():
    if False:
        while True:
            i = 10
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.create_batch), '__call__') as call:
        client.create_batch()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
@pytest.mark.asyncio
async def test_create_batch_async(transport: str='grpc_asyncio', request_type=batches.CreateBatchRequest):
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_batch), '__call__') as call:
...
async def test_create_batch_field_headers_async():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = batches.CreateBatchRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_batch), '__call__') as call:
...
def test_create_batch_flattened():
    ...
    with mock.patch.object(type(client.transport.create_batch), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_batch(parent='parent_value', batch=batches.Batch(name='name_value'), batch_id='batch_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
...
def test_create_batch_flattened_error():
    ...
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_batch(batches.CreateBatchRequest(), parent='parent_value', batch=batches.Batch(name='name_value'), batch_id='batch_id_value')
...
async def test_create_batch_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_batch), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_batch(parent='parent_value', batch=batches.Batch(name='name_value'), batch_id='batch_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_batch_flattened_error_async():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_batch(batches.CreateBatchRequest(), parent='parent_value', batch=batches.Batch(name='name_value'), batch_id='batch_id_value')
...
def test_get_batch(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_batch), '__call__') as call:
        call.return_value = batches.Batch(name='name_value', uuid='uuid_value', state=batches.Batch.State.PENDING, state_message='state_message_value', creator='creator_value', operation='operation_value')
...
@pytest.mark.asyncio
async def test_get_batch_async(transport: str='grpc_asyncio', request_type=batches.GetBatchRequest):
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.get_batch), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(batches.Batch(name='name_value', uuid='uuid_value', state=batches.Batch.State.PENDING, state_message='state_message_value', creator='creator_value', operation='operation_value'))
...
def test_get_batch_flattened_error():
    ...
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_batch(batches.GetBatchRequest(), name='name_value')
...
async def test_get_batch_flattened_error_async():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_batch(batches.GetBatchRequest(), name='name_value')
...
def test_list_batches(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_batches), '__call__') as call:
        call.return_value = batches.ListBatchesResponse(next_page_token='next_page_token_value')
...
@pytest.mark.asyncio
async def test_list_batches_async(transport: str='grpc_asyncio', request_type=batches.ListBatchesRequest):
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_batches), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(batches.ListBatchesResponse(next_page_token='next_page_token_value'))
...
async def test_list_batches_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_batches), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(batches.ListBatchesResponse())
...
def test_list_batches_flattened_error():
    ...
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_batches(batches.ListBatchesRequest(), parent='parent_value')
...
async def test_list_batches_flattened_error_async():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_batches(batches.ListBatchesRequest(), parent='parent_value')

def test_list_batches_pager(transport_name: str='grpc'):
    if False:
        i = 10
        return i + 15
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_batches), '__call__') as call:
        call.side_effect = (batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch(), batches.Batch()], next_page_token='abc'), batches.ListBatchesResponse(batches=[], next_page_token='def'), batches.ListBatchesResponse(batches=[batches.Batch()], next_page_token='ghi'), batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch()]), RuntimeError)
        metadata = ()
...
async def test_list_batches_async_pager():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_batches), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch(), batches.Batch()], next_page_token='abc'), batches.ListBatchesResponse(batches=[], next_page_token='def'), batches.ListBatchesResponse(batches=[batches.Batch()], next_page_token='ghi'), batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch()]), RuntimeError)
...
@pytest.mark.asyncio
async def test_delete_batch_async(transport: str='grpc_asyncio', request_type=batches.DeleteBatchRequest):
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.delete_batch), '__call__') as call:
...
def test_delete_batch_flattened_error():
    ...
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_batch(batches.DeleteBatchRequest(), name='name_value')
...
async def test_delete_batch_flattened_error_async():
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_batch(batches.DeleteBatchRequest(), name='name_value')
...
def test_create_batch_rest(request_type):
    if False:
        i = 10
        return i + 15
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    ...
    for (field, value) in request_init['batch'].items():
        result = None
        is_repeated = False
...
def test_create_batch_rest_required_fields(request_type=batches.CreateBatchRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['parent'] = 'parent_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_batch._get_unset_required_fields(jsonified_request)
    assert not set(unset_fields) - set(('batch_id', 'request_id'))
    jsonified_request.update(unset_fields)
...
def test_create_batch_rest_unset_required_fields():
    if False:
        return 10
    transport = transports.BatchControllerRestTransport(credentials=ga_credentials.AnonymousCredentials)
    unset_fields = transport.create_batch._get_unset_required_fields({})
    assert set(unset_fields) == set(('batchId', 'requestId')) & set(('parent', 'batch'))
...
def test_create_batch_rest_interceptors(null_interceptor):
    if False:
        while True:
            i = 10
    transport = transports.BatchControllerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BatchControllerRestInterceptor())
    client = BatchControllerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.BatchControllerRestInterceptor, 'post_create_batch') as post, mock.patch.object(transports.BatchControllerRestInterceptor, 'pre_create_batch') as pre:
        ...
        client.create_batch(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_create_batch_rest_bad_request(transport: str='rest', request_type=batches.CreateBatchRequest):
    if False:
        i = 10
        return i + 15
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_batch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(parent='parent_value', batch=batches.Batch(name='name_value'), batch_id='batch_id_value')
        ...
        assert path_template.validate('%s/v1/{parent=projects/*/locations/*}/batches' % client.transport._host, args[1])
...
def test_get_batch_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = batches.Batch(name='name_value', uuid='uuid_value', state=batches.Batch.State.PENDING, state_message='state_message_value', creator='creator_value', operation='operation_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_batch_rest_required_fields(request_type=batches.GetBatchRequest):
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_batch_rest_interceptors(null_interceptor):
    ...
    transport = transports.BatchControllerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BatchControllerRestInterceptor())
    client = BatchControllerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, 'post_get_batch') as post, mock.patch.object(transports.BatchControllerRestInterceptor, 'pre_get_batch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_batch(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_get_batch_rest_bad_request(transport: str='rest', request_type=batches.GetBatchRequest):
    if False:
        i = 10
        return i + 15
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_get_batch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1/{name=projects/*/locations/*/batches/*}' % client.transport._host, args[1])
...
def test_list_batches_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = batches.ListBatchesResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_batches_rest_required_fields(request_type=batches.ListBatchesRequest):
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_batches._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['parent'] = 'parent_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_batches._get_unset_required_fields(jsonified_request)
...
def test_list_batches_rest_interceptors(null_interceptor):
    ...
    transport = transports.BatchControllerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BatchControllerRestInterceptor())
    client = BatchControllerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, 'post_list_batches') as post, mock.patch.object(transports.BatchControllerRestInterceptor, 'pre_list_batches') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = batches.ListBatchesResponse.to_json(batches.ListBatchesResponse())
        request = batches.ListBatchesRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
        post.return_value = batches.ListBatchesResponse()
        client.list_batches(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_list_batches_rest_bad_request(transport: str='rest', request_type=batches.ListBatchesRequest):
    if False:
        return 10
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'parent': 'projects/sample1/locations/sample2'}
...
def test_list_batches_rest_pager(transport: str='rest'):
    ...
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch(), batches.Batch()], next_page_token='abc'), batches.ListBatchesResponse(batches=[], next_page_token='def'), batches.ListBatchesResponse(batches=[batches.Batch()], next_page_token='ghi'), batches.ListBatchesResponse(batches=[batches.Batch(), batches.Batch()]))
...
def test_delete_batch_rest_required_fields(request_type=batches.DeleteBatchRequest):
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['name'] = 'name_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_batch._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_batch_rest_interceptors(null_interceptor):
    ...
    transport = transports.BatchControllerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BatchControllerRestInterceptor())
    client = BatchControllerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BatchControllerRestInterceptor, 'pre_delete_batch') as pre:
        pre.assert_not_called()
        ...
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
        client.delete_batch(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()

def test_delete_batch_rest_bad_request(transport: str='rest', request_type=batches.DeleteBatchRequest):
    if False:
        print('Hello World!')
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/locations/sample2/batches/sample3'}
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.BatchControllerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.BatchControllerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BatchControllerClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.BatchControllerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = BatchControllerClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.BatchControllerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BatchControllerClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.BatchControllerGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.BatchControllerGrpcTransport, transports.BatchControllerGrpcAsyncIOTransport, transports.BatchControllerRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = BatchControllerClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_batch_controller_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.BatchControllerTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')

def test_batch_controller_base_transport():
    if False:
        print('Hello World!')
    with mock.patch('google.cloud.dataproc_v1.services.batch_controller.transports.BatchControllerTransport.__init__') as Transport:
        Transport.return_value = None
        transport = transports.BatchControllerTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_batch', 'get_batch', 'list_batches', 'delete_batch', 'set_iam_policy', 'get_iam_policy', 'test_iam_permissions', 'get_operation', 'cancel_operation', 'delete_operation', 'list_operations')
...
def test_batch_controller_base_transport_with_credentials_file():
    if False:
        for i in range(10):
            print('nop')
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.dataproc_v1.services.batch_controller.transports.BatchControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BatchControllerTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_batch_controller_base_transport_with_adc():
    if False:
        i = 10
        return i + 15
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.dataproc_v1.services.batch_controller.transports.BatchControllerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class', [transports.BatchControllerGrpcTransport, transports.BatchControllerGrpcAsyncIOTransport])
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.BatchControllerGrpcTransport, grpc_helpers), (transports.BatchControllerGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_batch_controller_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.BatchControllerRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_batch_controller_host_no_port(transport_name):
    if False:
        return 10
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='dataproc.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('dataproc.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://dataproc.googleapis.com')
...
def test_batch_controller_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='dataproc.googleapis.com:8000'), transport=transport_name)
...
def test_batch_controller_client_transport_session_collision(transport_name):
    ...
    client1 = BatchControllerClient(credentials=creds1, transport=transport_name)
    client2 = BatchControllerClient(credentials=creds2, transport=transport_name)
...
def test_batch_controller_grpc_transport_channel():
    ...
    transport = transports.BatchControllerGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_batch_controller_grpc_asyncio_transport_channel():
    ...
    transport = transports.BatchControllerGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.BatchControllerGrpcTransport, transports.BatchControllerGrpcAsyncIOTransport])
def test_batch_controller_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        for i in range(10):
            print('nop')
...
def test_batch_controller_grpc_lro_async_client():
    if False:
        print('Hello World!')
    client = BatchControllerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_batch_path():
    ...
    location = 'clam'
    batch = 'whelk'
    expected = 'projects/{project}/locations/{location}/batches/{batch}'.format(project=project, location=location, batch=batch)
...
def test_parse_batch_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'octopus', 'location': 'oyster', 'batch': 'nudibranch'}
...
def test_parse_service_path():
    if False:
        print('Hello World!')
    expected = {'project': 'nautilus', 'location': 'scallop', 'service': 'abalone'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.BatchControllerTransport, '_prep_wrapped_messages') as prep:
        client = BatchControllerClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(BatchControllerClient, transports.BatchControllerGrpcTransport), (BatchControllerAsyncClient, transports.BatchControllerGrpcAsyncIOTransport)])
