...
import deepdiff
from typing import Dict, Final, List, Literal, Optional, Sequence, Tuple, Type, TypedDict, Union, cast, overload
MYPY = False
if MYPY:
...
(base_models, exp_models, stats_models, user_models) = models.Registry.import_models([models.Names.BASE_MODEL, models.Names.EXPLORATION, models.Names.STATISTICS, models.Names.USER])
datastore_services = models.Registry.import_datastore_services()
AcceptableActivityModelTypes = Union[user_models.CompletedActivitiesModel, user_models.IncompleteActivitiesModel]
