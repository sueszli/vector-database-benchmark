...
class SourceMapDebugEndpointTestCase(APITestCase):
    ...
    base_data = {'event_id': 'a' * 32, 'exception': {'values': [{'type': 'Error', 'stacktrace': {'frames': [{'abs_path': 'https://app.example.com/static/js/main.fa8fe19f.js', 'filename': '/static/js/main.fa8fe19f.js', 'lineno': 1, 'colno': 39, 'context_line': 'function foo() {'}]}}]}}
