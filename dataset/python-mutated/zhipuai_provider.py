...
class ZhipuAIProvider(BaseModelProvider):
    ...
    def get_model_parameter_rules(self, model_name: str, model_type: ModelType) -> ModelKwargsRules:
        ...
        return ModelKwargsRules(temperature=KwargRule[float](min=0.01, max=1, default=0.95, precision=2), top_p=KwargRule[float](min=0.1, max=0.9, default=0.8, precision=1), presence_penalty=KwargRule[float](enabled=False), frequency_penalty=KwargRule[float](enabled=False), max_tokens=KwargRule[int](enabled=False))
    ...
    def is_provider_credentials_valid_or_raise(cls, credentials: dict):
        ...
        try:
            ...
            llm = ZhipuAIChatLLM(temperature=0.01, **credential_kwargs)
