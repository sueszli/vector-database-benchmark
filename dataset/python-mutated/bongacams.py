...
class BongaCamsIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://de.bongacams.com/azumi-8', 'only_matching': True}, {'url': 'https://cn.bongacams.com/azumi-8', 'only_matching': True}, {'url': 'https://de.bongacams.net/claireashton', 'info_dict': {'id': 'claireashton', 'ext': 'mp4', 'title': 're:ClaireAshton \\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}', 'age_limit': 18, 'uploader_id': 'ClaireAshton', 'uploader': 'ClaireAshton', 'like_count': int, 'is_live': True}, 'params': {'skip_download': True}}]
