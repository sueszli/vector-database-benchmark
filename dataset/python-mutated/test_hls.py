...
from streamlink.stream.hls import M3U8, HLSPlaylist, HLSSegment, HLSStream, HLSStreamReader, M3U8Parser, MuxedHLSStream
...
class TestHlsPlaylistReloadTime(TestMixinStreamHLS, unittest.TestCase):
    segments = [Segment(0, duration=11), Segment(1, duration=7), Segment(2, duration=5), Segment(3, duration=3)]
