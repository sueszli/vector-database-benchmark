...
TEST_PARAMS = [('Conv3D_NDHWC_float_cpu', 'NDHWC', dtypes.float32, False, 'Conv3D'), ('Conv3D_NDHWC_half_cpu', 'NDHWC', dtypes.float16, False, 'Conv3D'), ('Conv3D_NDHWC_double_cpu', 'NDHWC', dtypes.float64, False, 'Conv3D'), ('Conv3D_NDHWC_bfloat16_cpu', 'NDHWC', dtypes.bfloat16, False, 'Conv3D'), ('Conv3D_NDHWC_float_gpu', 'NDHWC', dtypes.float32, True, 'Conv3D'), ('Conv3D_NDHWC_half_gpu', 'NDHWC', dtypes.float16, True, 'Conv3D'), ('Conv3D_NDHWC_double_gpu', 'NDHWC', dtypes.float64, True, 'Conv3D'), ('Conv3D_NDHWC_bfloat16_gpu', 'NDHWC', dtypes.bfloat16, True, 'Conv3D'), ('Conv3D_NCDHW_float_gpu', 'NCDHW', dtypes.float32, True, 'Conv3D'), ('Conv3D_NCDHW_half_gpu', 'NCDHW', dtypes.float16, True, 'Conv3D'), ('Conv3D_NCDHW_double_gpu', 'NCDHW', dtypes.float64, True, 'Conv3D'), ('Conv3D_NCDHW_bfloat16_gpu', 'NCDHW', dtypes.bfloat16, True, 'Conv3D'), ('Conv_NDHWC_float_cpu', 'NDHWC', dtypes.float32, False, 'Conv'), ('Conv_NDHWC_half_cpu', 'NDHWC', dtypes.float16, False, 'Conv'), ('Conv_NDHWC_double_cpu', 'NDHWC', dtypes.float64, False, 'Conv'), ('Conv_NDHWC_bfloat16_cpu', 'NDHWC', dtypes.bfloat16, False, 'Conv'), ('Conv_NDHWC_float_gpu', 'NDHWC', dtypes.float32, True, 'Conv'), ('Conv_NDHWC_half_gpu', 'NDHWC', dtypes.float16, True, 'Conv'), ('Conv_NDHWC_double_gpu', 'NDHWC', dtypes.float64, True, 'Conv'), ('Conv_NDHWC_bfloat16_gpu', 'NDHWC', dtypes.bfloat16, True, 'Conv'), ('Conv_NCDHW_float_gpu', 'NCDHW', dtypes.float32, True, 'Conv'), ('Conv_NCDHW_half_gpu', 'NCDHW', dtypes.float16, True, 'Conv'), ('Conv_NCDHW_double_gpu', 'NCDHW', dtypes.float64, True, 'Conv'), ('Conv_NCDHW_bfloat16_gpu', 'NCDHW', dtypes.bfloat16, True, 'Conv')]
DILATED_PARAMS = [('Conv3D_NDHWC_cpu', 'NDHWC', False, 'Conv3D'), ('Conv3D_NDHWC_gpu', 'NDHWC', True, 'Conv3D'), ('Conv3D_NCDHW_gpu', 'NCDHW', True, 'Conv3D'), ('Conv_NDHWC_cpu', 'NDHWC', False, 'Conv'), ('Conv_NDHWC_gpu', 'NDHWC', True, 'Conv'), ('Conv_NCDHW_gpu', 'NCDHW', True, 'Conv')]
...
@test_util.run_all_without_tensor_float_32('Tests Conv3d, which in some cases is implemented with a matmul. With TensorFloat-32, tests fail in some of those cases (and as of August 13 2020, only those cases)')
