...
from ..utils import determine_ext, bool_or_none, int_or_none, parse_qs, try_get, unified_timestamp, url_or_none
...
class RutubeTagsIE(RutubePlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://rutube.ru/tags/video/1800/', 'info_dict': {'id': '1800'}, 'playlist_mincount': 68}]
...
class RutubePersonIE(RutubePlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://rutube.ru/video/person/313878/', 'info_dict': {'id': '313878'}, 'playlist_mincount': 37}]
...
class RutubePlaylistIE(RutubePlaylistBaseIE):
    ...
    _TESTS = [{'url': 'https://rutube.ru/video/cecd58ed7d531fc0f3d795d51cee9026/?pl_id=3097&pl_type=tag', 'info_dict': {'id': '3097'}, 'playlist_count': 27}, {'url': 'https://rutube.ru/video/10b3a03fc01d5bbcc632a2f3514e8aab/?pl_id=4252&pl_type=source', 'only_matching': True}]
...
class RutubeChannelIE(RutubePlaylistBaseIE):
    ...
    _TESTS = [{'url': 'https://rutube.ru/channel/639184/videos/', 'info_dict': {'id': '639184'}, 'playlist_mincount': 133}]
    _PAGE_TEMPLATE = 'http://rutube.ru/api/video/person/%s/?page=%s&format=json'