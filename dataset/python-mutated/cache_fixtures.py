...
CACHE_CHAINS = [(_MEMORY, _LOCAL), (_MEMORY, _S3), (_MEMORY, _HUB_CLOUD), (_LOCAL, _S3), (_LOCAL, _HUB_CLOUD), (_MEMORY, _LOCAL, _S3), (_MEMORY, _LOCAL, _HUB_CLOUD)]
CACHE_CHAINS = list(map(lambda i: ','.join(i), CACHE_CHAINS))
enabled_cache_chains = pytest.mark.parametrize('cache_chain', CACHE_CHAINS, indirect=True)
