...
```
python3 -m benchmarks.layer_benchmark.rnn_benchmark     --benchmark_name=benchmark_lstm     --num_samples=2048     --batch_size=256     --jit_compile=True
```
"""
...
def benchmark_time_distributed(num_samples, batch_size, jit_compile=True):
    ...
    benchmark.benchmark_predict(num_samples=num_samples, batch_size=batch_size)
    benchmark.benchmark_train(num_samples=num_samples, batch_size=batch_size)
BENCHMARK_NAMES = {'benchmark_conv_lstm1d': benchmark_conv_lstm1d, 'benchmark_conv_lstm2d': benchmark_conv_lstm2d, 'benchmark_conv_lstm3d': benchmark_conv_lstm3d, 'benchmark_gru': benchmark_gru, 'benchmark_lstm': benchmark_lstm, 'benchmark_simple_rnn': benchmark_simple_rnn, 'benchmark_bidirectional': benchmark_bidirectional, 'benchmark_time_distributed': benchmark_time_distributed}
