...
if __name__ == '__main__':
    ...
    if args.ssl:
        ...
        server_context.load_cert_chain(pathlib.Path(__file__).parent.parent.parent / 'tests' / 'certs' / 'ssl_cert.pem', pathlib.Path(__file__).parent.parent.parent / 'tests' / 'certs' / 'ssl_key.pem')
