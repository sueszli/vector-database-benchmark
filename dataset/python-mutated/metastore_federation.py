...
import proto
__protobuf__ = proto.module(package='google.cloud.metastore.v1', manifest={'Federation', 'BackendMetastore', 'ListFederationsRequest', 'ListFederationsResponse', 'GetFederationRequest', 'CreateFederationRequest', 'UpdateFederationRequest', 'DeleteFederationRequest'})
...
class Federation(proto.Message):
    ...
    backend_metastores: MutableMapping[int, 'BackendMetastore'] = proto.MapField(proto.INT32, proto.MESSAGE, number=6, message='BackendMetastore')
    endpoint_uri: str = proto.Field(proto.STRING, number=7)
    state: State = proto.Field(proto.ENUM, number=8, enum=State)
    state_message: str = proto.Field(proto.STRING, number=9)
    uid: str = proto.Field(proto.STRING, number=10)
...
class BackendMetastore(proto.Message):
    ...
    class MetastoreType(proto.Enum):
        ...
        DATAPROC_METASTORE = 3
    name: str = proto.Field(proto.STRING, number=1)
    metastore_type: MetastoreType = proto.Field(proto.ENUM, number=2, enum=MetastoreType)
...
class ListFederationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    federations: MutableSequence['Federation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Federation')
...
class CreateFederationRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    federation_id: str = proto.Field(proto.STRING, number=2)
    federation: 'Federation' = proto.Field(proto.MESSAGE, number=3, message='Federation')
...
class UpdateFederationRequest(proto.Message):
    ...
    federation: 'Federation' = proto.Field(proto.MESSAGE, number=2, message='Federation')
