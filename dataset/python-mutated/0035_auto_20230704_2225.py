...
class Migration(migrations.Migration):
    dependencies = [('db', '0034_auto_20230628_1046')]
    operations = [migrations.AddField(model_name='workspace', name='organization_size', field=models.CharField(default='2-10', max_length=20)), migrations.RunPython(update_company_organization_size), migrations.AlterField(model_name='workspace', name='name', field=models.CharField(max_length=80, verbose_name='Workspace Name')), migrations.AlterField(model_name='workspace', name='slug', field=models.SlugField(max_length=48, unique=True)), migrations.RemoveField(model_name='workspace', name='company_size')]