...
class AsyncNamespace(base_namespace.BaseServerNamespace):
    ...
    async def emit(self, event, data=None, to=None, room=None, skip_sid=None, namespace=None, callback=None, ignore_queue=False):
        ...
        Note: this method is a coroutine.
        """
        return await self.server.emit(event, data=data, to=to, room=room, skip_sid=skip_sid, namespace=namespace or self.namespace, callback=callback, ignore_queue=ignore_queue)

    async def send(self, data, to=None, room=None, skip_sid=None, namespace=None, callback=None, ignore_queue=False):
        ...
        Note: this method is a coroutine.
        """
        return await self.server.send(data, to=to, room=room, skip_sid=skip_sid, namespace=namespace or self.namespace, callback=callback, ignore_queue=ignore_queue)

    async def call(self, event, data=None, to=None, sid=None, namespace=None, timeout=None, ignore_queue=False):
        ...
        associated with the class is used.
        """
        return await self.server.call(event, data=data, to=to, sid=sid, namespace=namespace or self.namespace, timeout=timeout, ignore_queue=ignore_queue)
    ...
    async def enter_room(self, sid, room, namespace=None):
        ...
        Note: this method is a coroutine.
        """
        return await self.server.enter_room(sid, room, namespace=namespace or self.namespace)
    ...
    async def leave_room(self, sid, room, namespace=None):
        ...
        Note: this method is a coroutine.
        """
        return await self.server.leave_room(sid, room, namespace=namespace or self.namespace)
    ...
    async def save_session(self, sid, session, namespace=None):
        ...
        Note: this method is a coroutine.
        """
        return await self.server.save_session(sid, session, namespace=namespace or self.namespace)
...
class AsyncClientNamespace(base_namespace.BaseClientNamespace):
    ...
    async def send(self, data, namespace=None, callback=None):
        ...
        Note: this method is a coroutine.
        """
        return await self.client.send(data, namespace=namespace or self.namespace, callback=callback)
    ...
    async def call(self, event, data=None, namespace=None, timeout=None):
        ...
        associated with the class is used.
        """
        return await self.client.call(event, data=data, namespace=namespace or self.namespace, timeout=timeout)
