...
pytestmark = [pytest.mark.slow_test, pytest.mark.skip_if_binaries_missing('docker')]
...
class TestVirtTest:
    ...
    Test virt routines
    """
    cpu_models = ['none', 'armv7l', 'armv7b', 'aarch64', 'i686', 'ppc64', 'ppc64le', 'riscv32', 'riscv64', 's390', 's390x', 'x86_64']
