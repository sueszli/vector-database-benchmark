...
class TestAsyncFineTunes:
    ...
    async def test_method_create(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.create(training_file='file-abc123')
        assert_matches_type(FineTune, fine_tune, path=['response'])

    @parametrize
    async def test_method_create_with_all_params(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.create(training_file='file-abc123', batch_size=0, classification_betas=[0.6, 1, 1.5, 2], classification_n_classes=0, classification_positive_class='string', compute_classification_metrics=True, hyperparameters={'n_epochs': 'auto'}, learning_rate_multiplier=0, model='curie', prompt_loss_weight=0, suffix='x', validation_file='file-abc123')
        assert_matches_type(FineTune, fine_tune, path=['response'])

    @parametrize
    async def test_raw_response_create(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tunes.with_raw_response.create(training_file='file-abc123')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        fine_tune = response.parse()
        assert_matches_type(FineTune, fine_tune, path=['response'])
    ...
    async def test_method_retrieve(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.retrieve('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert_matches_type(FineTune, fine_tune, path=['response'])

    @parametrize
    async def test_raw_response_retrieve(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tunes.with_raw_response.retrieve('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        fine_tune = response.parse()
        assert_matches_type(FineTune, fine_tune, path=['response'])
    ...
    async def test_method_cancel(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.cancel('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert_matches_type(FineTune, fine_tune, path=['response'])

    @parametrize
    async def test_raw_response_cancel(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tunes.with_raw_response.cancel('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        fine_tune = response.parse()
        assert_matches_type(FineTune, fine_tune, path=['response'])
    ...
    async def test_method_list_events_overload_1(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert_matches_type(FineTuneEventsListResponse, fine_tune, path=['response'])

    @pytest.mark.skip(reason='Prism chokes on this')
    @parametrize
    async def test_method_list_events_with_all_params_overload_1(self, client: AsyncOpenAI) -> None:
        fine_tune = await client.fine_tunes.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F', stream=False)
        assert_matches_type(FineTuneEventsListResponse, fine_tune, path=['response'])

    @pytest.mark.skip(reason='Prism chokes on this')
    @parametrize
    async def test_raw_response_list_events_overload_1(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tunes.with_raw_response.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        fine_tune = response.parse()
        assert_matches_type(FineTuneEventsListResponse, fine_tune, path=['response'])
    ...
    async def test_method_list_events_overload_2(self, client: AsyncOpenAI) -> None:
        await client.fine_tunes.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F', stream=True)

    @pytest.mark.skip(reason='Prism chokes on this')
    @parametrize
    async def test_raw_response_list_events_overload_2(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tunes.with_raw_response.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F', stream=True)
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        response.parse()