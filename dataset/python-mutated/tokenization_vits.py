...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'facebook/mms-tts-eng': 'https://huggingface.co/facebook/mms-tts-eng/resolve/main/vocab.json'}}
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {'facebook/mms-tts-eng': 4096}
