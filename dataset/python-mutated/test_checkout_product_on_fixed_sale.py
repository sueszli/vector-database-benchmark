...
@pytest.mark.e2e
def test_checkout_products_on_fixed_sale_core_1002(e2e_not_logged_api_client, e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts):
    if False:
        print('Hello World!')
    ...
    (sale_id, sale_discount_value) = prepare_sale_for_product(e2e_staff_api_client, channel_id, product_id, sale_discount_type='FIXED', sale_discount_value=3)
