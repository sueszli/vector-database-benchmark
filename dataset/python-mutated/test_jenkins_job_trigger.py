...
TEST_PARAMETERS = (pytest.param({'a_param': 'blip', 'another_param': '42'}, id='dict params'), pytest.param('{"second_param": "beep", "third_param": "153"}', id='string params'), pytest.param(['final_one', 'bop', 'real_final', 'eggs'], id='list params'))
