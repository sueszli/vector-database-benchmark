...
class wpwaCDM(FLRW):
    ...
    """
    wp = Parameter(default=-1.0, doc='Dark energy equation of state at the pivot redshift zp.', fvalidate='float')
    wa = Parameter(default=0.0, doc='Negative derivative of dark energy equation of state w.r.t. a.', fvalidate='float')
    zp = Parameter(default=0.0 * cu.redshift, doc='The pivot redshift, where w(z) = wp.', unit=cu.redshift)
