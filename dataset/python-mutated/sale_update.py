...
from ...utils import convert_migrated_sale_predicate_to_catalogue_info, create_catalogue_predicate, get_products_for_rule
...
class SaleUpdate(ModelMutation):
    ...
    class Meta:
        description = 'Updates a sale.' + DEPRECATED_IN_3X_MUTATION + ' Use `promotionUpdate` mutation instead.'
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.SALE_UPDATED, description='A sale was updated.'), WebhookEventInfo(type=WebhookEventAsyncType.SALE_TOGGLE, description='Optionally triggered when a sale is started or stopped.')]
