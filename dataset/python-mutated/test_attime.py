...
class ATTimeTimezoneTests(TestCase):
    ...
    MOCK_DATE = specified_tz.localize(datetime(2015, 1, 1, 11, 0))
...
class parseTimeReferenceTest(TestCase):
    zone = pytz.utc
    MOCK_DATE = zone.localize(datetime(2015, 1, 1, 11, 0))
...
@mock.patch('graphite.render.attime.datetime', mockDateTime(2010, 3, 30, 0, 0, 0))
...
@mock.patch('graphite.render.attime.datetime', mockDateTime(2016, 2, 29, 0, 0, 0))
...
@mock.patch('graphite.render.attime.datetime', mockDateTime(2013, 2, 28, 0, 0, 0))
...
class parseTimeReferenceTestNow(TestCase):
    zone = pytz.utc
    MOCK_DATE = zone.localize(datetime(2015, 1, 1, 11, 0))
    now = zone.localize(datetime(2015, 1, 1, 11, 0))
