...
from confirmation.models import Confirmation, confirmation_url, create_confirmation_link, generate_key
...
from zerver.models import EmailChangeStatus, UserProfile, get_realm, get_user, get_user_by_delivery_email, get_user_profile_by_id
