...
def evaluate(model_path: str, make_env: Callable, env_id: str, eval_episodes: int, run_name: str, Model: nn.Module, epsilon: float=0.05, capture_video: bool=True, seed=1):
    if False:
        i = 10
        return i + 15
...
if __name__ == '__main__':
    ...
    evaluate(model_path, make_env, 'CartPole-v1', eval_episodes=10, run_name=f'eval', Model=QNetwork, capture_video=False)