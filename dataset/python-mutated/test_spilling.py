...
from cudf.core.buffer import Buffer, acquire_spill_lock, as_buffer, get_spill_lock
from cudf.core.buffer.spill_manager import SpillManager, get_global_manager, get_rmm_memory_resource_stack, set_global_manager
from cudf.core.buffer.spillable_buffer import SpillableBuffer, SpillableBufferSlice, SpillLock
from cudf.testing._utils import assert_eq
if get_global_manager() is not None:
    pytest.skip('cannot test spilling when enabled globally, set `CUDF_SPILL=off`', allow_module_level=True)
