...
if is_flax_available():
    ...
    from transformers.models.blenderbot.modeling_flax_blenderbot import FlaxBlenderbotForConditionalGeneration, FlaxBlenderbotModel, shift_tokens_right

def prepare_blenderbot_inputs_dict(config, input_ids, decoder_input_ids=None, attention_mask=None, decoder_attention_mask=None, head_mask=None, decoder_head_mask=None, cross_attn_head_mask=None):
    if False:
        print('Hello World!')
...
class FlaxBlenderbotModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        config = BlenderbotConfig(vocab_size=self.vocab_size, d_model=self.hidden_size, encoder_layers=self.num_hidden_layers, decoder_layers=self.num_hidden_layers, encoder_attention_heads=self.num_attention_heads, decoder_attention_heads=self.num_attention_heads, encoder_ffn_dim=self.intermediate_size, decoder_ffn_dim=self.intermediate_size, dropout=self.hidden_dropout_prob, attention_dropout=self.attention_probs_dropout_prob, max_position_embeddings=self.max_position_embeddings, eos_token_id=self.eos_token_id, bos_token_id=self.bos_token_id, pad_token_id=self.pad_token_id, initializer_range=self.initializer_range, use_cache=False)
...
class BlenderbotHeadTests(unittest.TestCase):
    ...
    def _get_config_and_data(self):
        ...
        config = BlenderbotConfig(vocab_size=self.vocab_size, d_model=24, encoder_layers=2, decoder_layers=2, encoder_attention_heads=2, decoder_attention_heads=2, encoder_ffn_dim=32, decoder_ffn_dim=32, max_position_embeddings=48, eos_token_id=2, pad_token_id=1, bos_token_id=0)
    ...
    def test_lm_uneven_forward(self):
        if False:
            i = 10
            return i + 15
        config = BlenderbotConfig(vocab_size=self.vocab_size, d_model=14, encoder_layers=2, decoder_layers=2, encoder_attention_heads=2, decoder_attention_heads=2, encoder_ffn_dim=8, decoder_ffn_dim=8, max_position_embeddings=48)
        lm_model = FlaxBlenderbotForConditionalGeneration(config)
