...
class AttributeReorderValues(BaseMutation):
    ...
    class Arguments:
        attribute_id = graphene.Argument(graphene.ID, required=True, description='ID of an attribute.')
        moves = NonNullList(ReorderInput, required=True, description='The list of reordering operations for given attribute values.')
