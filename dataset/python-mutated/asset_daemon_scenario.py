...
from typing import Any, Callable, Iterable, NamedTuple, Optional, Sequence, Tuple, Type, Union
import dagster._check as check
import mock
import pendulum
from dagster import AssetExecutionContext, AssetKey, AssetsDefinition, AssetSpec, AutoMaterializePolicy, DagsterInstance, DagsterRunStatus, Definitions, MultiPartitionKey, RunRequest, RunsFilter, asset, materialize
from dagster._core.definitions.asset_daemon_context import AssetDaemonContext
from dagster._core.definitions.asset_daemon_cursor import AssetDaemonCursor
from dagster._core.definitions.asset_graph import AssetGraph
from dagster._core.definitions.auto_materialize_rule import AutoMaterializeRule
from dagster._core.definitions.auto_materialize_rule_evaluation import AutoMaterializeAssetEvaluation, AutoMaterializeRuleEvaluation, AutoMaterializeRuleEvaluationData
...
from dagster._daemon.asset_daemon import CURSOR_KEY, FIXED_AUTO_MATERIALIZATION_ORIGIN_ID, FIXED_AUTO_MATERIALIZATION_SELECTOR_ID, AssetDaemon, get_current_evaluation_id
...
class AssetSpecWithPartitionsDef(namedtuple('AssetSpecWithPartitionsDef', AssetSpec._fields + ('partitions_def',), defaults=(None,) * (1 + len(AssetSpec._fields)))):
    ...
