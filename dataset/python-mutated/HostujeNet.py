...
class HostujeNet(SimpleDownloader):
    ...
    __version__ = '0.06'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?hostuje\\.net/\\w+'
    ...
    NAME_PATTERN = '<input type="hidden" name="name" value="(?P<N>.+?)">'
    SIZE_PATTERN = '<b>Rozmiar:</b> (?P<S>[\\d.,]+) (?P<U>[\\w^_]+)<br>'
    OFFLINE_PATTERN = 'Podany plik nie został odnaleziony\\.\\.\\.'
