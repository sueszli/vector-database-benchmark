...
if __name__ == '__main__':
    ignore_list: typing.List[str] = ['append_cubic_bezier.py', 'barcode.py', 'color.py', 'font_type_1.py', 'heterogeneous_paragraph.py', 'low_level_tokenizer.py', 'lzw_decode.py', 'push_button.py', 'redacted_canvas_stream_processor.py', 'rubber_stamp_annotation.py', 'table.py', 'text_annotation.py', 'transformer.py', 'types.py']
