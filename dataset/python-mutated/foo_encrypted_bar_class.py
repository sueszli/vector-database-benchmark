...
class FOOEncryptedBarClass(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[FOOEncryptedBarClassArgs]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            for i in range(10):
                print('nop')
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, __props__=None):
        ...
        super(FOOEncryptedBarClass, __self__).__init__('foo-bar:submodule1:FOOEncryptedBarClass', resource_name, __props__, opts)

    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions]=None) -> 'FOOEncryptedBarClass':
        if False:
            i = 10
            return i + 15
