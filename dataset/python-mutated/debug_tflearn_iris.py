...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/tmp/iris_data', help='Directory to save the training and test data in.')
    parser.add_argument('--model_dir', type=str, default='', help='Directory to save the trained model in.')
    parser.add_argument('--train_steps', type=int, default=10, help='Number of steps to run training for.')
    parser.add_argument('--eval_steps', type=int, default=1, help='Number of steps to run evaluation foir.')
    ...
    parser.add_argument('--dump_root', type=str, default='', help='Optional custom root directory for temporary debug dump data')
