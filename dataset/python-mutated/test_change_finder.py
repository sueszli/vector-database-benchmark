...
watcher_configs = [{'index': 'index1', 'interval': 15}, {'index': 'index2', 'interval': 15}, {'index': 'index3', 'interval': 60}]
auditor_configs = [{'index': 'index1', 'support_auditor_indexes': [], 'support_watcher_indexes': []}, {'index': 'index2', 'support_auditor_indexes': [], 'support_watcher_indexes': []}, {'index': 'index3', 'support_auditor_indexes': [], 'support_watcher_indexes': []}]
auditor_configs_with_watcher_dependencies = [{'index': 'index1', 'support_auditor_indexes': [], 'support_watcher_indexes': ['index2']}, {'index': 'index2', 'support_auditor_indexes': ['index1'], 'support_watcher_indexes': []}, {'index': 'index3', 'support_auditor_indexes': [], 'support_watcher_indexes': ['index1']}]
