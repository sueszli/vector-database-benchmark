...
from samcli.lib.sync.flows.layer_sync_flow import LayerSyncFlow, LayerSyncFlowSkipBuildDirectory, LayerSyncFlowSkipBuildZipFile
...
from samcli.lib.sync.flows.zip_function_sync_flow import ZipFunctionSyncFlow, ZipFunctionSyncFlowSkipBuildDirectory, ZipFunctionSyncFlowSkipBuildZipFile
from samcli.lib.sync.sync_flow import SyncFlow
from samcli.lib.utils.boto_utils import get_boto_client_provider_with_config, get_boto_resource_provider_with_config, get_client_error_code
...
from samcli.lib.utils.resources import AWS_APIGATEWAY_RESTAPI, AWS_APIGATEWAY_V2_API, AWS_LAMBDA_FUNCTION, AWS_LAMBDA_LAYERVERSION, AWS_SERVERLESS_API, AWS_SERVERLESS_FUNCTION, AWS_SERVERLESS_HTTPAPI, AWS_SERVERLESS_LAYERVERSION, AWS_SERVERLESS_STATEMACHINE, AWS_STEPFUNCTIONS_STATEMACHINE
if TYPE_CHECKING:
...
class SyncCodeResources:
    ...
    """
    _accepted_resources = [AWS_SERVERLESS_FUNCTION, AWS_LAMBDA_FUNCTION, AWS_SERVERLESS_LAYERVERSION, AWS_LAMBDA_LAYERVERSION, AWS_SERVERLESS_API, AWS_APIGATEWAY_RESTAPI, AWS_SERVERLESS_HTTPAPI, AWS_APIGATEWAY_V2_API, AWS_SERVERLESS_STATEMACHINE, AWS_STEPFUNCTIONS_STATEMACHINE]
