...
class UploadStickerFile(TelegramMethod[File]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, user_id: int, sticker: InputFile, sticker_format: str, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(user_id=user_id, sticker=sticker, sticker_format=sticker_format, **__pydantic_kwargs)