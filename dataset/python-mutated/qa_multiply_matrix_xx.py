...
BLOCK_LOOKUP = {'float': {'src': blocks.vector_source_f, 'sink': blocks.vector_sink_f, 'mult': blocks.multiply_matrix_ff}, 'complex': {'src': blocks.vector_source_c, 'sink': blocks.vector_sink_c, 'mult': blocks.multiply_matrix_cc}}
