...
if __name__ == '__main__':
    ...
    parser.add_argument('--class-trainable', action='store_true', default=False, help='set to use the Trainable (class) API instead of functional one')
    parser.add_argument('--test', action='store_true', default=False, help='set to run both functional and Trainable APIs')
