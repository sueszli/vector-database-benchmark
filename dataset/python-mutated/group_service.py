...
__protobuf__ = proto.module(package='google.monitoring.v3', manifest={'ListGroupsRequest', 'ListGroupsResponse', 'GetGroupRequest', 'CreateGroupRequest', 'UpdateGroupRequest', 'DeleteGroupRequest', 'ListGroupMembersRequest', 'ListGroupMembersResponse'})
...
class ListGroupsRequest(proto.Message):
    ...
    children_of_group: str = proto.Field(proto.STRING, number=2, oneof='filter')
    ancestors_of_group: str = proto.Field(proto.STRING, number=3, oneof='filter')
    descendants_of_group: str = proto.Field(proto.STRING, number=4, oneof='filter')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    group: MutableSequence[gm_group.Group] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_group.Group)
...
class CreateGroupRequest(proto.Message):
    ...
    group: gm_group.Group = proto.Field(proto.MESSAGE, number=2, message=gm_group.Group)
...
class DeleteGroupRequest(proto.Message):
    """The ``DeleteGroup`` request. The default behavior is to be able to
    ...
    """
    name: str = proto.Field(proto.STRING, number=3)
    recursive: bool = proto.Field(proto.BOOL, number=4)
...
class ListGroupMembersRequest(proto.Message):
    ...
    interval: common.TimeInterval = proto.Field(proto.MESSAGE, number=6, message=common.TimeInterval)
...
class ListGroupMembersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    members: MutableSequence[monitored_resource_pb2.MonitoredResource] = proto.RepeatedField(proto.MESSAGE, number=1, message=monitored_resource_pb2.MonitoredResource)
    next_page_token: str = proto.Field(proto.STRING, number=2)
