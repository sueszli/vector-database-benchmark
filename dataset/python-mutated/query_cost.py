...
from graphql import GraphQLError, GraphQLInterfaceType, GraphQLObjectType, GraphQLSchema, get_named_type
...
CostAwareNode = Union[Field, FragmentDefinition, FragmentSpread, InlineFragment, OperationDefinition]
