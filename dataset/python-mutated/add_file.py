...
class GithubAddFileSchema(BaseModel):
    ...
    base_branch: str = Field(..., description='branch to interact with')
    file_name: str = Field(..., description='file name to be added to repository')
    folder_path: str = Field(..., description='folder path for the file to be stored')
    commit_message: str = Field(..., description='clear description of the contents of file')
