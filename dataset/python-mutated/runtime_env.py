...
from ray.core.generated.runtime_env_common_pb2 import RuntimeEnvConfig as ProtoRuntimeEnvConfig
...
OPTION_TO_VALIDATION_FN['config'] = RuntimeEnvConfig.parse_and_validate_runtime_env_config
...
class RuntimeEnv(dict):
    ...
    """
    known_fields: Set[str] = {'py_modules', 'java_jars', 'working_dir', 'conda', 'pip', 'container', 'excludes', 'env_vars', '_ray_release', '_ray_commit', '_inject_current_ray', 'config', 'docker', 'worker_process_setup_hook', '_nsight', 'mpi'}
    extensions_fields: Set[str] = {'_ray_release', '_ray_commit', '_inject_current_ray'}
