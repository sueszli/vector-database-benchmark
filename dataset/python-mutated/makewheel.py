...
MANYLINUX_LIBS = ['libgcc_s.so.1', 'libstdc++.so.6', 'libm.so.6', 'libdl.so.2', 'librt.so.1', 'libcrypt.so.1', 'libc.so.6', 'libnsl.so.1', 'libutil.so.1', 'libpthread.so.0', 'libresolv.so.2', 'libX11.so.6', 'libXext.so.6', 'libXrender.so.1', 'libICE.so.6', 'libSM.so.6', 'libGL.so.1', 'libgobject-2.0.so.0', 'libgthread-2.0.so.0', 'libglib-2.0.so.0', 'linux-vdso.so.1', 'linux-gate.so.1', 'ld-linux.so.2', 'libdrm.so.2', 'libEGL.so.1', 'libOpenGL.so.0', 'libGLX.so.0', 'libGLdispatch.so.0']
IGNORE_UNIX_DEPS_OF = ['panda3d_tools/pstats']
