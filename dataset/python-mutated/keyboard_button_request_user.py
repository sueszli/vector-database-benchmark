...
class KeyboardButtonRequestUser(TelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, request_id: int, user_is_bot: Optional[bool]=None, user_is_premium: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                print('Hello World!')
            super().__init__(request_id=request_id, user_is_bot=user_is_bot, user_is_premium=user_is_premium, **__pydantic_kwargs)