...
from unicorn.unicorn_const import UC_ARCH_X86, UC_MODE_64, UC_MODE_32, UC_PROT_NONE, UC_PROT_READ, UC_PROT_WRITE, UC_PROT_EXEC, UC_HOOK_MEM_READ_UNMAPPED, UC_HOOK_MEM_WRITE_UNMAPPED, UC_HOOK_MEM_FETCH_UNMAPPED, UC_HOOK_MEM_WRITE, UC_HOOK_INTR, UC_HOOK_INSN
