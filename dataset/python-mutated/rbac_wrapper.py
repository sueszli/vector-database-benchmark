...
if settings.IS_RBAC_INSTALLED:
    ...
    from rbac.permissions_calculator import RolePermissionData, get_roles_permission_data_for_environment, get_roles_permission_data_for_organisation, get_roles_permission_data_for_project
else:
    RolePermissionData = []
