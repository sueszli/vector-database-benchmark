...
class ProductVariantUpdate(ProductVariantCreate, ModelWithExtRefMutation):
    ...
    class Arguments:
        ...
        external_reference = graphene.String(required=False, description=f'External ID of a product variant to update. {ADDED_IN_310}')
        sku = graphene.String(required=False, description='SKU of a product variant to update.' + ADDED_IN_38)
        input = ProductVariantInput(required=True, description='Fields required to update a product variant.')
