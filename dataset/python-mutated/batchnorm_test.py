...
batchnorm_configs_short = cudnn_benchmark_configs(op_bench.config_list(attr_names=['M', 'N', 'K'], attrs=[[1, 256, 3136]], cross_product_configs={'device': ['cpu', 'cuda'], 'training': [True, False]}, tags=['short']))
batchnorm_configs_long = cudnn_benchmark_configs(op_bench.cross_product_configs(M=[2, 128], N=[8192, 2048], K=[1], device=['cpu', 'cuda'], training=[True, False], tags=['long']))
...
batchnorm1d_configs_short = cudnn_benchmark_configs(op_bench.config_list(attr_names=['N', 'C'], attrs=[[3136, 256]], cross_product_configs={'device': ['cpu', 'cuda'], 'training': [True, False]}, tags=['short']))
batchnorm1d_configs_long = cudnn_benchmark_configs(op_bench.cross_product_configs(N=[2, 128], C=[8192, 2048], device=['cpu', 'cuda'], training=[True, False], tags=['long']))
