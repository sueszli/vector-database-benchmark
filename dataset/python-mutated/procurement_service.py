...
__protobuf__ = proto.module(package='google.cloud.commerce.consumer.procurement.v1', manifest={'PlaceOrderRequest', 'PlaceOrderMetadata', 'GetOrderRequest', 'ListOrdersRequest', 'ListOrdersResponse'})
...
class PlaceOrderRequest(proto.Message):
    ...
    line_item_info: MutableSequence[order.LineItemInfo] = proto.RepeatedField(proto.MESSAGE, number=10, message=order.LineItemInfo)
    request_id: str = proto.Field(proto.STRING, number=7)
...
class ListOrdersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    orders: MutableSequence[order.Order] = proto.RepeatedField(proto.MESSAGE, number=1, message=order.Order)
