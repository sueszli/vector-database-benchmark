...
def get_vod_ad_tag_detail(project_id: str, location: str, session_id: str, ad_tag_detail_id: str) -> stitcher_v1.types.VodAdTagDetail:
    if False:
        return 10
    ...
    name = client.vod_ad_tag_detail_path(project_id, location, session_id, ad_tag_detail_id)
...
if __name__ == '__main__':
    ...
    get_vod_ad_tag_detail(args.project_id, args.location, args.session_id, args.ad_tag_detail_id)