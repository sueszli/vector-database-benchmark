...
from ray.data._internal.planner.exchange.split_repartition_task_scheduler import SplitRepartitionTaskScheduler
from ray.data._internal.stats import StatsDict
from ray.data.context import DataContext

def generate_repartition_fn(num_outputs: int, shuffle: bool) -> AllToAllTransformFn:
    if False:
        while True:
            i = 10
    ...
    def split_repartition_fn(refs: List[RefBundle], ctx: TaskContext) -> Tuple[List[RefBundle], StatsDict]:
        if False:
            print('Hello World!')
