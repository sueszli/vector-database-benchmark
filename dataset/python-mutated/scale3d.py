...
if TYPE_CHECKING:
    ...
    Scale3DArrayLike = Union[Scale3D, datatypes.Vec3D, float, Sequence[Scale3DLike]]
else:
    Scale3DLike = Any
...
class Scale3DType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            return 10
        pa.ExtensionType.__init__(self, pa.dense_union([pa.field('_null_markers', pa.null(), nullable=True, metadata={}), pa.field('ThreeD', pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 3), nullable=False, metadata={}), pa.field('Uniform', pa.float32(), nullable=False, metadata={})]), self._TYPE_NAME)
