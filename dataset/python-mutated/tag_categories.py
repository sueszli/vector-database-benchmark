...
from calibre.utils.icu import lower as icu_lower, primary_contains, primary_sort_key, strcmp
...
class TagCategories(QDialog, Ui_TagCategories):
    ...
    """
    category_icons = {'authors': QIcon.ic('user_profile.png'), 'series': QIcon.ic('series.png'), 'publisher': QIcon.ic('publisher.png'), 'tags': QIcon.ic('tags.png'), 'languages': QIcon.ic('languages.png')}
