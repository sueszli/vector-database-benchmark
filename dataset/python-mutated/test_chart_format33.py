...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        if False:
            return 10
        self.set_filename('chart_format33.xlsx')
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$1:$A$5', 'values': '=Sheet1!$B$1:$B$5', 'trendline': {'type': 'linear', 'display_equation': 1, 'label': {'fill': {'color': 'red'}}}})
