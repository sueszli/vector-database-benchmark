...
from returns.primitives.laws import Law, Law2, Law3, Lawful, LawSpecDef, law_definition
...
class FailableN(_container.ContainerN[_FirstType, _SecondType, _ThirdType], lashable.LashableN[_FirstType, _SecondType, _ThirdType], Lawful['FailableN[_FirstType, _SecondType, _ThirdType]']):
    """
...
class SingleFailableN(FailableN[_FirstType, _SecondType, _ThirdType]):
    """
    ...
    """
    __slots__ = ()
    _laws: ClassVar[Sequence[Law]] = (Law2(_SingleFailableLawSpec.map_short_circuit_law), Law2(_SingleFailableLawSpec.bind_short_circuit_law), Law2(_SingleFailableLawSpec.apply_short_circuit_law))
...
class DiverseFailableN(FailableN[_FirstType, _SecondType, _ThirdType], swappable.SwappableN[_FirstType, _SecondType, _ThirdType], Lawful['DiverseFailableN[_FirstType, _SecondType, _ThirdType]']):
    """
    ...
    """
    __slots__ = ()
    _laws: ClassVar[Sequence[Law]] = (Law3(_DiverseFailableLawSpec.map_short_circuit_law), Law3(_DiverseFailableLawSpec.bind_short_circuit_law), Law3(_DiverseFailableLawSpec.apply_short_circuit_law), Law3(_DiverseFailableLawSpec.alt_short_circuit_law))
