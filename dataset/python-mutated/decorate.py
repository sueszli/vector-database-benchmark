...
_DECORATORS = {'dataclasses.dataclass': decorate_dataclass, 'attr.s': decorate_attrs, 'attr.attrs': decorate_attrs, 'attr._make.attrs': decorate_attrs, 'attr.define': decorate_attrs}
_VALIDATORS = {'dataclasses.dataclass': check_class, 'attr.s': check_class, 'attr.attrs': check_class, 'attr._make.attrs': check_class, 'attr.define': check_class}