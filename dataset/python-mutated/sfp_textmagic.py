...
class sfp_textmagic(SpiderFootPlugin):
    meta = {'name': 'TextMagic', 'summary': 'Obtain phone number type from TextMagic API', 'flags': ['apikey'], 'useCases': ['Passive'], 'categories': ['Search Engines'], 'dataSource': {'website': 'https://www.textmagic.com/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://docs.textmagic.com/'], 'apiKeyInstructions': ['Visit https://textmagic.com', 'Register a free trial account', 'Visit https://my.textmagic.com/online/api/rest-api/keys', "Click on 'Add new API Key'", "Your API key will be listed beside 'The new API Key is'"], 'favIcon': 'https://www.textmagic.com/wp-content/themes/textmagic-genesis/assets/app/images/favicon.png', 'logo': 'https://www.textmagic.com/wp-content/uploads/2015/04/logo.png', 'description': 'TextMagic is a business text-messaging service for sending notifications, alerts, reminders, confirmations and SMS marketing campaigns.'}}
    opts = {'api_key_username': '', 'api_key': ''}
    optdescs = {'api_key_username': 'TextMagic API Username', 'api_key': 'TextMagic API Key'}
    errorState = False
