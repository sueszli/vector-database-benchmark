...
about = {'website': 'https://www.seznam.cz/', 'wikidata_id': 'Q3490485', 'official_api_documentation': 'https://api.sklik.cz/', 'use_official_api': False, 'require_api_key': False, 'results': 'HTML', 'language': 'cz'}
