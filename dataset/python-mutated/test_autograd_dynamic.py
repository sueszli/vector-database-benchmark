...
@utils.parameterize((utils.TEST_CASE_NAME, 'func', 'xs'), (('1d_in_1d_out', utils.square, np.array([2.0, 3.0])), ('single_in_single_out', utils.square, np.random.rand(6)), ('multi_in_single_out', paddle.matmul, (np.random.rand(4), np.random.rand(4)))))
...
@utils.place(config.DEVICES)
@utils.parameterize((utils.TEST_CASE_NAME, 'func', 'xs'), (('1d_in_1d_out', utils.square, np.array([[1.0, 2.0, 3.0], [3.0, 4.0, 3.0]])), ('multi_in_single_out', utils.square, np.random.rand(2, 3))))
