...
__protobuf__ = proto.module(package='google.cloud.retail.v2', manifest={'SearchRequest', 'SearchResponse', 'ExperimentInfo'})
...
class SearchRequest(proto.Message):
    ...
    class FacetSpec(proto.Message):
        ...
        class FacetKey(proto.Message):
            ...
            intervals: MutableSequence[common.Interval] = proto.RepeatedField(proto.MESSAGE, number=2, message=common.Interval)
            restricted_values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
            prefixes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=8)
            contains: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=9)
            case_insensitive: bool = proto.Field(proto.BOOL, number=10)
            order_by: str = proto.Field(proto.STRING, number=4)
            query: str = proto.Field(proto.STRING, number=5)
            return_min_max: bool = proto.Field(proto.BOOL, number=11)
        facet_key: 'SearchRequest.FacetSpec.FacetKey' = proto.Field(proto.MESSAGE, number=1, message='SearchRequest.FacetSpec.FacetKey')
        limit: int = proto.Field(proto.INT32, number=2)
        excluded_filter_keys: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
        enable_dynamic_position: bool = proto.Field(proto.BOOL, number=4)
    ...
    class DynamicFacetSpec(proto.Message):
        ...
        class Mode(proto.Enum):
            ...
            DISABLED = 1
            ENABLED = 2
        mode: 'SearchRequest.DynamicFacetSpec.Mode' = proto.Field(proto.ENUM, number=1, enum='SearchRequest.DynamicFacetSpec.Mode')
    ...
    class BoostSpec(proto.Message):
        ...
        class ConditionBoostSpec(proto.Message):
            ...
            """
            condition: str = proto.Field(proto.STRING, number=1)
            boost: float = proto.Field(proto.FLOAT, number=2)
        condition_boost_specs: MutableSequence['SearchRequest.BoostSpec.ConditionBoostSpec'] = proto.RepeatedField(proto.MESSAGE, number=1, message='SearchRequest.BoostSpec.ConditionBoostSpec')
        skip_boost_spec_validation: bool = proto.Field(proto.BOOL, number=2, optional=True)

    class QueryExpansionSpec(proto.Message):
        """Specification to determine under which conditions query
        ...
        class Condition(proto.Enum):
            ...
            DISABLED = 1
            AUTO = 3
        condition: 'SearchRequest.QueryExpansionSpec.Condition' = proto.Field(proto.ENUM, number=1, enum='SearchRequest.QueryExpansionSpec.Condition')
        pin_unexpanded_results: bool = proto.Field(proto.BOOL, number=2)
    ...
    class PersonalizationSpec(proto.Message):
        ...
        class Mode(proto.Enum):
            ...
            AUTO = 1
            DISABLED = 2
        mode: 'SearchRequest.PersonalizationSpec.Mode' = proto.Field(proto.ENUM, number=1, enum='SearchRequest.PersonalizationSpec.Mode')
    ...
    class SpellCorrectionSpec(proto.Message):
        ...
        class Mode(proto.Enum):
            """Enum describing under which mode spell correction should
            occur.
            ...
            SUGGESTION_ONLY = 1
            AUTO = 2
        mode: 'SearchRequest.SpellCorrectionSpec.Mode' = proto.Field(proto.ENUM, number=1, enum='SearchRequest.SpellCorrectionSpec.Mode')
    placement: str = proto.Field(proto.STRING, number=1)
    branch: str = proto.Field(proto.STRING, number=2)
    query: str = proto.Field(proto.STRING, number=3)
    visitor_id: str = proto.Field(proto.STRING, number=4)
    user_info: common.UserInfo = proto.Field(proto.MESSAGE, number=5, message=common.UserInfo)
    page_size: int = proto.Field(proto.INT32, number=7)
    page_token: str = proto.Field(proto.STRING, number=8)
    offset: int = proto.Field(proto.INT32, number=9)
    filter: str = proto.Field(proto.STRING, number=10)
    canonical_filter: str = proto.Field(proto.STRING, number=28)
    order_by: str = proto.Field(proto.STRING, number=11)
    facet_specs: MutableSequence[FacetSpec] = proto.RepeatedField(proto.MESSAGE, number=12, message=FacetSpec)
    dynamic_facet_spec: DynamicFacetSpec = proto.Field(proto.MESSAGE, number=21, message=DynamicFacetSpec)
    boost_spec: BoostSpec = proto.Field(proto.MESSAGE, number=13, message=BoostSpec)
    query_expansion_spec: QueryExpansionSpec = proto.Field(proto.MESSAGE, number=14, message=QueryExpansionSpec)
    variant_rollup_keys: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=17)
    page_categories: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=23)
    search_mode: SearchMode = proto.Field(proto.ENUM, number=31, enum=SearchMode)
    personalization_spec: PersonalizationSpec = proto.Field(proto.MESSAGE, number=32, message=PersonalizationSpec)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=34)
    spell_correction_spec: SpellCorrectionSpec = proto.Field(proto.MESSAGE, number=35, optional=True, message=SpellCorrectionSpec)
    entity: str = proto.Field(proto.STRING, number=38)
...
class SearchResponse(proto.Message):
    ...
    class SearchResult(proto.Message):
        ...
        product: gcr_product.Product = proto.Field(proto.MESSAGE, number=2, message=gcr_product.Product)
        matching_variant_count: int = proto.Field(proto.INT32, number=3)
        matching_variant_fields: MutableMapping[str, field_mask_pb2.FieldMask] = proto.MapField(proto.STRING, proto.MESSAGE, number=4, message=field_mask_pb2.FieldMask)
        variant_rollup_values: MutableMapping[str, struct_pb2.Value] = proto.MapField(proto.STRING, proto.MESSAGE, number=5, message=struct_pb2.Value)
        personal_labels: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
        ...
        class FacetValue(proto.Message):
            ...
            Attributes:
                ...
                max_value (float):
                    ...
                    is true.
            """
            value: str = proto.Field(proto.STRING, number=1, oneof='facet_value')
            interval: common.Interval = proto.Field(proto.MESSAGE, number=2, oneof='facet_value', message=common.Interval)
            count: int = proto.Field(proto.INT64, number=3)
            min_value: float = proto.Field(proto.DOUBLE, number=5)
            max_value: float = proto.Field(proto.DOUBLE, number=6)
        key: str = proto.Field(proto.STRING, number=1)
        values: MutableSequence['SearchResponse.Facet.FacetValue'] = proto.RepeatedField(proto.MESSAGE, number=2, message='SearchResponse.Facet.FacetValue')
        dynamic_facet: bool = proto.Field(proto.BOOL, number=3)
    ...
    class QueryExpansionInfo(proto.Message):
        ...
        Attributes:
            ...
            pinned_result_count (int):
                ...
                is set to true.
        """
        expanded_query: bool = proto.Field(proto.BOOL, number=1)
        pinned_result_count: int = proto.Field(proto.INT64, number=2)
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    results: MutableSequence[SearchResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=SearchResult)
    facets: MutableSequence[Facet] = proto.RepeatedField(proto.MESSAGE, number=2, message=Facet)
    total_size: int = proto.Field(proto.INT32, number=3)
    corrected_query: str = proto.Field(proto.STRING, number=4)
    attribution_token: str = proto.Field(proto.STRING, number=5)
    next_page_token: str = proto.Field(proto.STRING, number=6)
    query_expansion_info: QueryExpansionInfo = proto.Field(proto.MESSAGE, number=7, message=QueryExpansionInfo)
    redirect_uri: str = proto.Field(proto.STRING, number=10)
    applied_controls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=12)
    invalid_condition_boost_specs: MutableSequence['SearchRequest.BoostSpec.ConditionBoostSpec'] = proto.RepeatedField(proto.MESSAGE, number=14, message='SearchRequest.BoostSpec.ConditionBoostSpec')
    experiment_info: MutableSequence['ExperimentInfo'] = proto.RepeatedField(proto.MESSAGE, number=17, message='ExperimentInfo')
    ...
    class ServingConfigExperiment(proto.Message):
        ...
        Attributes:
            ...
            experiment_serving_config (str):
                ...
                ``projects/*/locations/*/catalogs/*/servingConfigs/*``.
        """
        original_serving_config: str = proto.Field(proto.STRING, number=1)
        experiment_serving_config: str = proto.Field(proto.STRING, number=2)
    serving_config_experiment: ServingConfigExperiment = proto.Field(proto.MESSAGE, number=2, oneof='experiment_metadata', message=ServingConfigExperiment)
    experiment: str = proto.Field(proto.STRING, number=1)
