...
@MODELS.register_module(Tasks.generative_multi_modal_embedding, module_name=Models.rleg)
class RLEGForMultiModalEmbedding(TorchModel):
    ...
    def __init__(self, model_dir, device_id=0, *args, **kwargs):
        ...
        self.img_preprocessor = T.Compose([T.Resize((224, 224)), T.ToTensor(), T.Normalize((0.48145466, 0.4578275, 0.40821073), (0.26862954, 0.26130258, 0.27577711))])
