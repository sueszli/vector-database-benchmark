...
from localstack.services.stepfunctions.asl.component.state.state_execution.state_task import lambda_eval_utils
...
class StateTaskServiceLambda(StateTaskServiceCallback):
    _SUPPORTED_API_PARAM_BINDINGS: Final[dict[str, set[str]]] = {'invoke': {'ClientContext', 'FunctionName', 'InvocationType', 'Qualifier', 'Payload', 'LogType'}}
