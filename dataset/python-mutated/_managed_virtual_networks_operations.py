...
def build_list_by_factory_request(resource_group_name: str, factory_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/managedVirtualNetworks')
...
def build_create_or_update_request(resource_group_name: str, factory_name: str, managed_virtual_network_name: str, subscription_id: str, *, if_match: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        while True:
            i = 10
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
    ...
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/managedVirtualNetworks/{managedVirtualNetworkName}')
...
def build_get_request(resource_group_name: str, factory_name: str, managed_virtual_network_name: str, subscription_id: str, *, if_none_match: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
...
class ManagedVirtualNetworksOperations:
    ...
    @distributed_trace
    def list_by_factory(self, resource_group_name: str, factory_name: str, **kwargs: Any) -> Iterable['_models.ManagedVirtualNetworkResource']:
        if False:
            while True:
                i = 10
    ...
    @overload
    def create_or_update(self, resource_group_name: str, factory_name: str, managed_virtual_network_name: str, managed_virtual_network: _models.ManagedVirtualNetworkResource, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedVirtualNetworkResource:
        if False:
            while True:
                i = 10
    ...
    @overload
    def create_or_update(self, resource_group_name: str, factory_name: str, managed_virtual_network_name: str, managed_virtual_network: IO, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ManagedVirtualNetworkResource:
        if False:
            print('Hello World!')
        'Creates or updates a managed Virtual Network.\n\n        :param resource_group_name: The resource group name. Required.\n        :type resource_group_name: str\n        :param factory_name: The factory name. Required.\n        :type factory_name: str\n        :param managed_virtual_network_name: Managed virtual network name. Required.\n        :type managed_virtual_network_name: str\n        :param managed_virtual_network: Managed Virtual Network resource definition. Required.\n        :type managed_virtual_network: IO\n        :param if_match: ETag of the managed Virtual Network entity. Should only be specified for\n         update, for which it should match existing entity or can be * for unconditional update. Default\n         value is None.\n        :type if_match: str\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: ManagedVirtualNetworkResource or the result of cls(response)\n        :rtype: ~azure.mgmt.datafactory.models.ManagedVirtualNetworkResource\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def create_or_update(self, resource_group_name: str, factory_name: str, managed_virtual_network_name: str, managed_virtual_network: Union[_models.ManagedVirtualNetworkResource, IO], if_match: Optional[str]=None, **kwargs: Any) -> _models.ManagedVirtualNetworkResource:
        if False:
            while True:
                i = 10
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/managedVirtualNetworks/{managedVirtualNetworkName}'}

    @distributed_trace
    def get(self, resource_group_name: str, factory_name: str, managed_virtual_network_name: str, if_none_match: Optional[str]=None, **kwargs: Any) -> _models.ManagedVirtualNetworkResource:
        if False:
            i = 10
            return i + 15
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/managedVirtualNetworks/{managedVirtualNetworkName}'}