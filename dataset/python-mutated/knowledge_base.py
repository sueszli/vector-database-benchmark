...
import proto
__protobuf__ = proto.module(package='google.cloud.dialogflow.v2', manifest={'KnowledgeBase', 'ListKnowledgeBasesRequest', 'ListKnowledgeBasesResponse', 'GetKnowledgeBaseRequest', 'CreateKnowledgeBaseRequest', 'DeleteKnowledgeBaseRequest', 'UpdateKnowledgeBaseRequest'})
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    knowledge_bases: MutableSequence['KnowledgeBase'] = proto.RepeatedField(proto.MESSAGE, number=1, message='KnowledgeBase')
...
class CreateKnowledgeBaseRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    knowledge_base: 'KnowledgeBase' = proto.Field(proto.MESSAGE, number=2, message='KnowledgeBase')
...
class UpdateKnowledgeBaseRequest(proto.Message):
    ...
    """
    knowledge_base: 'KnowledgeBase' = proto.Field(proto.MESSAGE, number=1, message='KnowledgeBase')
