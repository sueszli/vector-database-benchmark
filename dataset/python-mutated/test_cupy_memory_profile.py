...
@testing.parameterize({'unit': 'B'}, {'unit': 'KB'}, {'unit': 'MB'}, {'unit': 'GB'}, {'unit': 'TB'}, {'unit': 'PB'}, {'unit': 'EB'}, {'unit': 'ZB'}, {'unit': 'auto'}, {'unit': 'auto_foreach'})
@attr.gpu
...
@testing.parameterize({'unit': 'B', 'denomi': 1024 ** 0, 'bytes': -1}, {'unit': 'B', 'denomi': 1024 ** 0, 'bytes': 0}, {'unit': 'B', 'denomi': 1024 ** 0, 'bytes': 1}, {'unit': 'B', 'denomi': 1024 ** 0, 'bytes': 512}, {'unit': 'B', 'denomi': 1024 ** 0, 'bytes': 1023}, {'unit': 'KB', 'denomi': 1024 ** 1, 'bytes': 1024}, {'unit': 'KB', 'denomi': 1024 ** 1, 'bytes': 1024 ** 2 - 1}, {'unit': 'MB', 'denomi': 1024 ** 2, 'bytes': 1024 ** 2}, {'unit': 'GB', 'denomi': 1024 ** 3, 'bytes': 1024 ** 3}, {'unit': 'TB', 'denomi': 1024 ** 4, 'bytes': 1024 ** 4}, {'unit': 'PB', 'denomi': 1024 ** 5, 'bytes': 1024 ** 5}, {'unit': 'EB', 'denomi': 1024 ** 6, 'bytes': 1024 ** 6}, {'unit': 'ZB', 'denomi': 1024 ** 7, 'bytes': 1024 ** 7}, {'unit': 'ZB', 'denomi': 1024 ** 7, 'bytes': 1024 ** 8})
@attr.gpu
