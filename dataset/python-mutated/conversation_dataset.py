...
class InputConfig(proto.Message):
    """Represents the configuration of importing a set of
    ...
    """
    gcs_source: gcs.GcsSources = proto.Field(proto.MESSAGE, number=1, oneof='source', message=gcs.GcsSources)

class ConversationDataset(proto.Message):
    """Represents a conversation dataset that a user imports raw
    ...
    input_config: 'InputConfig' = proto.Field(proto.MESSAGE, number=5, message='InputConfig')
    conversation_info: 'ConversationInfo' = proto.Field(proto.MESSAGE, number=6, message='ConversationInfo')
    conversation_count: int = proto.Field(proto.INT64, number=7)
...
class CreateConversationDatasetRequest(proto.Message):
    ...
    conversation_dataset: 'ConversationDataset' = proto.Field(proto.MESSAGE, number=2, message='ConversationDataset')
...
class ListConversationDatasetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    conversation_datasets: MutableSequence['ConversationDataset'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ConversationDataset')
...
class ImportConversationDataRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    input_config: 'InputConfig' = proto.Field(proto.MESSAGE, number=2, message='InputConfig')
...
class ImportConversationDataOperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            server side.
    """
    conversation_dataset: str = proto.Field(proto.STRING, number=1)
    partial_failures: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=2, message=status_pb2.Status)
...
class ImportConversationDataOperationResponse(proto.Message):
    ...
    """
    conversation_dataset: str = proto.Field(proto.STRING, number=1)
    import_count: int = proto.Field(proto.INT32, number=3)
