...
register_jagged_func(torch.ops.aten.is_contiguous.memory_format, 'self: jt_all, memory_format: any?')(is_contiguous_general)
...
register_jagged_func([torch.ops.aten.ones_like.default, torch.ops.aten.zeros_like.default, torch.ops.aten.randn_like.default, torch.ops.aten.detach.default], 'self: jt')(jagged_unary_pointwise)
