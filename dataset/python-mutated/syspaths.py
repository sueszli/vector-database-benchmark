...
EXPECTED_VARIABLES = ('ROOT_DIR', 'CONFIG_DIR', 'CACHE_DIR', 'SOCK_DIR', 'SRV_ROOT_DIR', 'BASE_FILE_ROOTS_DIR', 'HOME_DIR', 'BASE_PILLAR_ROOTS_DIR', 'BASE_THORIUM_ROOTS_DIR', 'BASE_MASTER_ROOTS_DIR', 'LIB_STATE_DIR', 'LOGS_DIR', 'PIDFILE_DIR', 'SPM_PARENT_PATH', 'SPM_FORMULA_PATH', 'SPM_PILLAR_PATH', 'SPM_REACTOR_PATH', 'SHARE_DIR')
try:
    import salt._syspaths as __generated_syspaths
except ImportError:
    import types
...
def _get_windows_root_dir():
    if False:
        for i in range(10):
            print('nop')
    root_dir = salt.utils.win_reg.read_value(hive='HKLM', key='SOFTWARE\\Salt Project\\salt', vname='root_dir')
    if root_dir['success']:
        if root_dir['vdata']:
...
__all__ = ['ROOT_DIR', 'SHARE_DIR', 'CONFIG_DIR', 'CACHE_DIR', 'SOCK_DIR', 'SRV_ROOT_DIR', 'BASE_FILE_ROOTS_DIR', 'BASE_PILLAR_ROOTS_DIR', 'BASE_MASTER_ROOTS_DIR', 'BASE_THORIUM_ROOTS_DIR', 'LIB_STATE_DIR', 'LOGS_DIR', 'PIDFILE_DIR', 'INSTALL_DIR', 'CLOUD_DIR', 'BOOTSTRAP', 'SPM_PARENT_PATH', 'SPM_FORMULA_PATH', 'SPM_PILLAR_PATH', 'SPM_REACTOR_PATH']