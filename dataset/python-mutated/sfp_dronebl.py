...
class sfp_dronebl(SpiderFootPlugin):
    ...
    def producedEvents(self):
        if False:
            for i in range(10):
                print('nop')
        return ['BLACKLISTED_IPADDR', 'BLACKLISTED_AFFILIATE_IPADDR', 'BLACKLISTED_SUBNET', 'BLACKLISTED_NETBLOCK', 'MALICIOUS_IPADDR', 'MALICIOUS_AFFILIATE_IPADDR', 'MALICIOUS_NETBLOCK', 'MALICIOUS_SUBNET', 'VPN_HOST', 'PROXY_HOST']
    ...
    def handleEvent(self, event):
        ...
        for addr in addrs:
            ...
            for result in res:
                ...
                if k in ['127.0.0.3', '127.0.0.5', '127.0.0.6', '127.0.0.7', '127.0.0.13', '127.0.0.15', '127.0.0.16', '127.0.0.17', '127.0.0.18', '127.0.0.19']:
