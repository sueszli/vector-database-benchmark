...
from ..utils import ExtractorError, OnDemandPagedList, UnsupportedError, determine_ext, int_or_none, mimetype2ext, parse_qs, traverse_obj, try_get, url_or_none, urlhandle_detect_ext, urljoin

class LBRYBaseIE(InfoExtractor):
    _BASE_URL_REGEX = '(?x)(?:https?://(?:www\\.)?(?:lbry\\.tv|odysee\\.com)/|lbry://)'
    _CLAIM_ID_REGEX = '[0-9a-f]{1,40}'
...
class LBRYChannelIE(LBRYBaseIE):
    ...
    _VALID_URL = LBRYBaseIE._BASE_URL_REGEX + f'(?P<id>@{LBRYBaseIE._OPT_CLAIM_ID})/?(?:[?&]|$)'
    _TESTS = [{'url': 'https://lbry.tv/@LBRYFoundation:0', 'info_dict': {'id': '0ed629d2b9c601300cacf7eabe9da0be79010212', 'title': 'The LBRY Foundation', 'description': 'Channel for the LBRY Foundation. Follow for updates and news.'}, 'playlist_mincount': 29}, {'url': 'https://lbry.tv/@LBRYFoundation', 'only_matching': True}, {'url': 'lbry://@lbry#3f', 'only_matching': True}]
