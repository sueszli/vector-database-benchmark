...
def main():
    ...
    response = client.service_units.delete(resource_group_name='myResourceGroup', service_topology_name='myTopology', service_name='myService', service_unit_name='myServiceUnit')
    print(response)
