...
class HypothesisFixCharactersArguments(VisitorBasedCodemodCommand):
    ...
    METADATA_DEPENDENCIES = (cst.metadata.QualifiedNameProvider,)
    _replacements: ClassVar = {'whitelist_categories': 'categories', 'blacklist_categories': 'exclude_categories', 'whitelist_characters': 'include_characters', 'blacklist_characters': 'exclude_characters'}
