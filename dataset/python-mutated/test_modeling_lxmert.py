...
if is_torch_available():
    import torch
    from transformers import MODEL_FOR_PRETRAINING_MAPPING, MODEL_FOR_QUESTION_ANSWERING_MAPPING, LxmertForPreTraining, LxmertForQuestionAnswering, LxmertModel
...
class LxmertModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': LxmertModel, 'question-answering': LxmertForQuestionAnswering} if is_torch_available() else {}
    fx_compatible = True
