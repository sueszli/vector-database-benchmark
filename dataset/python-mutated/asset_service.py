...
class ExportAssetsRequest(proto.Message):
    ...
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    asset_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    content_type: 'ContentType' = proto.Field(proto.ENUM, number=4, enum='ContentType')
    output_config: 'OutputConfig' = proto.Field(proto.MESSAGE, number=5, message='OutputConfig')
    relationship_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
...
class ExportAssetsResponse(proto.Message):
    ...
    """
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    output_config: 'OutputConfig' = proto.Field(proto.MESSAGE, number=2, message='OutputConfig')
    output_result: 'OutputResult' = proto.Field(proto.MESSAGE, number=3, message='OutputResult')
...
class ListAssetsRequest(proto.Message):
    ...
    asset_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    content_type: 'ContentType' = proto.Field(proto.ENUM, number=4, enum='ContentType')
    page_size: int = proto.Field(proto.INT32, number=5)
    page_token: str = proto.Field(proto.STRING, number=6)
    relationship_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
...
class ListAssetsResponse(proto.Message):
    ...
    def raw_page(self):
        ...
        return self
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    assets: MutableSequence[gca_assets.Asset] = proto.RepeatedField(proto.MESSAGE, number=2, message=gca_assets.Asset)
...
class BatchGetAssetsHistoryRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    asset_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    content_type: 'ContentType' = proto.Field(proto.ENUM, number=3, enum='ContentType')
    read_time_window: gca_assets.TimeWindow = proto.Field(proto.MESSAGE, number=4, message=gca_assets.TimeWindow)
    relationship_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class BatchGetAssetsHistoryResponse(proto.Message):
    ...
    """
    assets: MutableSequence[gca_assets.TemporalAsset] = proto.RepeatedField(proto.MESSAGE, number=1, message=gca_assets.TemporalAsset)
...
class CreateFeedRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    feed_id: str = proto.Field(proto.STRING, number=2)
    feed: 'Feed' = proto.Field(proto.MESSAGE, number=3, message='Feed')
...
class ListFeedsResponse(proto.Message):
    ...
    Attributes:
        feeds (MutableSequence[google.cloud.asset_v1.types.Feed]):
            A list of feeds.
    """
    feeds: MutableSequence['Feed'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Feed')
...
class UpdateFeedRequest(proto.Message):
    ...
    """
    feed: 'Feed' = proto.Field(proto.MESSAGE, number=1, message='Feed')
...
class OutputConfig(proto.Message):
    ...
    Attributes:
        ...
        bigquery_destination (google.cloud.asset_v1.types.BigQueryDestination):
            ...
            This field is a member of `oneof`_ ``destination``.
    """
    gcs_destination: 'GcsDestination' = proto.Field(proto.MESSAGE, number=1, oneof='destination', message='GcsDestination')
    bigquery_destination: 'BigQueryDestination' = proto.Field(proto.MESSAGE, number=2, oneof='destination', message='BigQueryDestination')
...
class OutputResult(proto.Message):
    ...
    """
    gcs_result: 'GcsOutputResult' = proto.Field(proto.MESSAGE, number=1, oneof='result', message='GcsOutputResult')
...
class GcsOutputResult(proto.Message):
    ...
    """
    uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class GcsDestination(proto.Message):
    ...
    Attributes:
        ...
        uri_prefix (str):
            ...
            This field is a member of `oneof`_ ``object_uri``.
    """
    uri: str = proto.Field(proto.STRING, number=1, oneof='object_uri')
    uri_prefix: str = proto.Field(proto.STRING, number=2, oneof='object_uri')
...
class BigQueryDestination(proto.Message):
    ...
    Attributes:
        ...
        separate_tables_per_asset_type (bool):
            ...
            a table.
    """
    dataset: str = proto.Field(proto.STRING, number=1)
    table: str = proto.Field(proto.STRING, number=2)
    force: bool = proto.Field(proto.BOOL, number=3)
    partition_spec: 'PartitionSpec' = proto.Field(proto.MESSAGE, number=4, message='PartitionSpec')
    separate_tables_per_asset_type: bool = proto.Field(proto.BOOL, number=5)
...
class PartitionSpec(proto.Message):
    ...
    class PartitionKey(proto.Enum):
        """This enum is used to determine the partition key column when
        ...
        READ_TIME = 1
        REQUEST_TIME = 2
    partition_key: PartitionKey = proto.Field(proto.ENUM, number=1, enum=PartitionKey)
...
class FeedOutputConfig(proto.Message):
    ...
    Attributes:
        pubsub_destination (google.cloud.asset_v1.types.PubsubDestination):
            ...
            This field is a member of `oneof`_ ``destination``.
    """
    pubsub_destination: 'PubsubDestination' = proto.Field(proto.MESSAGE, number=1, oneof='destination', message='PubsubDestination')
...
class Feed(proto.Message):
    ...
    asset_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    content_type: 'ContentType' = proto.Field(proto.ENUM, number=4, enum='ContentType')
    feed_output_config: 'FeedOutputConfig' = proto.Field(proto.MESSAGE, number=5, message='FeedOutputConfig')
    condition: expr_pb2.Expr = proto.Field(proto.MESSAGE, number=6, message=expr_pb2.Expr)
    relationship_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
...
class SearchAllResourcesRequest(proto.Message):
    ...
    """
    scope: str = proto.Field(proto.STRING, number=1)
    query: str = proto.Field(proto.STRING, number=2)
    asset_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    ...
    read_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=8, message=field_mask_pb2.FieldMask)
...
class SearchAllResourcesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    results: MutableSequence[gca_assets.ResourceSearchResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=gca_assets.ResourceSearchResult)
...
class SearchAllIamPoliciesRequest(proto.Message):
    ...
    asset_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    order_by: str = proto.Field(proto.STRING, number=7)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    results: MutableSequence[gca_assets.IamPolicySearchResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=gca_assets.IamPolicySearchResult)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class IamPolicyAnalysisQuery(proto.Message):
    ...
    class ResourceSelector(proto.Message):
        ...
        """
        full_resource_name: str = proto.Field(proto.STRING, number=1)
    ...
    class IdentitySelector(proto.Message):
        ...
        """
        identity: str = proto.Field(proto.STRING, number=1)
    ...
    class AccessSelector(proto.Message):
        ...
        Attributes:
            ...
            permissions (MutableSequence[str]):
                ...
                result.
        """
        roles: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        permissions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    ...
    class Options(proto.Message):
        ...
        Attributes:
            ...
            analyze_service_account_impersonation (bool):
                ...
                Default is false.
        """
        expand_groups: bool = proto.Field(proto.BOOL, number=1)
        expand_roles: bool = proto.Field(proto.BOOL, number=2)
        expand_resources: bool = proto.Field(proto.BOOL, number=3)
        output_resource_edges: bool = proto.Field(proto.BOOL, number=4)
        output_group_edges: bool = proto.Field(proto.BOOL, number=5)
        analyze_service_account_impersonation: bool = proto.Field(proto.BOOL, number=6)
    ...
    class ConditionContext(proto.Message):
        ...
        """
        access_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, oneof='TimeContext', message=timestamp_pb2.Timestamp)
    scope: str = proto.Field(proto.STRING, number=1)
    resource_selector: ResourceSelector = proto.Field(proto.MESSAGE, number=2, message=ResourceSelector)
    identity_selector: IdentitySelector = proto.Field(proto.MESSAGE, number=3, message=IdentitySelector)
    access_selector: AccessSelector = proto.Field(proto.MESSAGE, number=4, message=AccessSelector)
    options: Options = proto.Field(proto.MESSAGE, number=5, message=Options)
    condition_context: ConditionContext = proto.Field(proto.MESSAGE, number=6, message=ConditionContext)
...
class AnalyzeIamPolicyRequest(proto.Message):
    ...
    Attributes:
        ...
        execution_timeout (google.protobuf.duration_pb2.Duration):
            ...
            Default is empty.
    """
    analysis_query: 'IamPolicyAnalysisQuery' = proto.Field(proto.MESSAGE, number=1, message='IamPolicyAnalysisQuery')
    saved_analysis_query: str = proto.Field(proto.STRING, number=3)
    execution_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
...
class AnalyzeIamPolicyResponse(proto.Message):
    ...
    class IamPolicyAnalysis(proto.Message):
        ...
        """
        analysis_query: 'IamPolicyAnalysisQuery' = proto.Field(proto.MESSAGE, number=1, message='IamPolicyAnalysisQuery')
        analysis_results: MutableSequence[gca_assets.IamPolicyAnalysisResult] = proto.RepeatedField(proto.MESSAGE, number=2, message=gca_assets.IamPolicyAnalysisResult)
        fully_explored: bool = proto.Field(proto.BOOL, number=3)
        non_critical_errors: MutableSequence[gca_assets.IamPolicyAnalysisState] = proto.RepeatedField(proto.MESSAGE, number=5, message=gca_assets.IamPolicyAnalysisState)
    main_analysis: IamPolicyAnalysis = proto.Field(proto.MESSAGE, number=1, message=IamPolicyAnalysis)
    service_account_impersonation_analysis: MutableSequence[IamPolicyAnalysis] = proto.RepeatedField(proto.MESSAGE, number=2, message=IamPolicyAnalysis)
    fully_explored: bool = proto.Field(proto.BOOL, number=3)
...
class IamPolicyAnalysisOutputConfig(proto.Message):
    ...
    class BigQueryDestination(proto.Message):
        ...
        class PartitionKey(proto.Enum):
            ...
            REQUEST_TIME = 1
        dataset: str = proto.Field(proto.STRING, number=1)
        table_prefix: str = proto.Field(proto.STRING, number=2)
        partition_key: 'IamPolicyAnalysisOutputConfig.BigQueryDestination.PartitionKey' = proto.Field(proto.ENUM, number=3, enum='IamPolicyAnalysisOutputConfig.BigQueryDestination.PartitionKey')
        write_disposition: str = proto.Field(proto.STRING, number=4)
    gcs_destination: GcsDestination = proto.Field(proto.MESSAGE, number=1, oneof='destination', message=GcsDestination)
    bigquery_destination: BigQueryDestination = proto.Field(proto.MESSAGE, number=2, oneof='destination', message=BigQueryDestination)
...
class AnalyzeIamPolicyLongrunningRequest(proto.Message):
    ...
    analysis_query: 'IamPolicyAnalysisQuery' = proto.Field(proto.MESSAGE, number=1, message='IamPolicyAnalysisQuery')
    saved_analysis_query: str = proto.Field(proto.STRING, number=3)
    output_config: 'IamPolicyAnalysisOutputConfig' = proto.Field(proto.MESSAGE, number=2, message='IamPolicyAnalysisOutputConfig')
...
class SavedQuery(proto.Message):
    ...
    class QueryContent(proto.Message):
        ...
        """
        iam_policy_analysis_query: 'IamPolicyAnalysisQuery' = proto.Field(proto.MESSAGE, number=1, oneof='query_content', message='IamPolicyAnalysisQuery')
    name: str = proto.Field(proto.STRING, number=1)
    ...
    creator: str = proto.Field(proto.STRING, number=4)
    last_update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    last_updater: str = proto.Field(proto.STRING, number=6)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=7)
    content: QueryContent = proto.Field(proto.MESSAGE, number=8, message=QueryContent)
...
class ListSavedQueriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    saved_queries: MutableSequence['SavedQuery'] = proto.RepeatedField(proto.MESSAGE, number=1, message='SavedQuery')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateSavedQueryRequest(proto.Message):
    ...
    """
    saved_query: 'SavedQuery' = proto.Field(proto.MESSAGE, number=1, message='SavedQuery')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class AnalyzeMoveRequest(proto.Message):
    ...
    class AnalysisView(proto.Enum):
        ...
        FULL = 1
        BASIC = 2
    resource: str = proto.Field(proto.STRING, number=1)
    destination_parent: str = proto.Field(proto.STRING, number=2)
    view: AnalysisView = proto.Field(proto.ENUM, number=3, enum=AnalysisView)
...
class AnalyzeMoveResponse(proto.Message):
    ...
    Attributes:
        move_analysis (MutableSequence[google.cloud.asset_v1.types.MoveAnalysis]):
            ...
            services.
    """
    move_analysis: MutableSequence['MoveAnalysis'] = proto.RepeatedField(proto.MESSAGE, number=1, message='MoveAnalysis')
...
class MoveAnalysis(proto.Message):
    ...
    analysis: 'MoveAnalysisResult' = proto.Field(proto.MESSAGE, number=2, oneof='result', message='MoveAnalysisResult')
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=3, oneof='result', message=status_pb2.Status)
...
class MoveAnalysisResult(proto.Message):
    ...
    """
    blockers: MutableSequence['MoveImpact'] = proto.RepeatedField(proto.MESSAGE, number=1, message='MoveImpact')
    warnings: MutableSequence['MoveImpact'] = proto.RepeatedField(proto.MESSAGE, number=2, message='MoveImpact')
...
class MoveImpact(proto.Message):
    ...
    Attributes:
        detail (str):
            ...
            message.
    """
    detail: str = proto.Field(proto.STRING, number=1)
...
class QueryAssetsOutputConfig(proto.Message):
    ...
    class BigQueryDestination(proto.Message):
        ...
        dataset: str = proto.Field(proto.STRING, number=1)
        table: str = proto.Field(proto.STRING, number=2)
        write_disposition: str = proto.Field(proto.STRING, number=3)
...
class QueryAssetsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    statement: str = proto.Field(proto.STRING, number=2, oneof='query')
    job_reference: str = proto.Field(proto.STRING, number=3, oneof='query')
    page_size: int = proto.Field(proto.INT32, number=4)
    page_token: str = proto.Field(proto.STRING, number=5)
    timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=6, message=duration_pb2.Duration)
    read_time_window: gca_assets.TimeWindow = proto.Field(proto.MESSAGE, number=7, oneof='time', message=gca_assets.TimeWindow)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, oneof='time', message=timestamp_pb2.Timestamp)
    output_config: 'QueryAssetsOutputConfig' = proto.Field(proto.MESSAGE, number=9, message='QueryAssetsOutputConfig')
...
class QueryAssetsResponse(proto.Message):
    ...
    Attributes:
        ...
        output_config (google.cloud.asset_v1.types.QueryAssetsOutputConfig):
            ...
            This field is a member of `oneof`_ ``response``.
    """
    job_reference: str = proto.Field(proto.STRING, number=1)
    done: bool = proto.Field(proto.BOOL, number=2)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=3, oneof='response', message=status_pb2.Status)
    query_result: 'QueryResult' = proto.Field(proto.MESSAGE, number=4, oneof='response', message='QueryResult')
    output_config: 'QueryAssetsOutputConfig' = proto.Field(proto.MESSAGE, number=5, oneof='response', message='QueryAssetsOutputConfig')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    rows: MutableSequence[struct_pb2.Struct] = proto.RepeatedField(proto.MESSAGE, number=1, message=struct_pb2.Struct)
    schema: 'TableSchema' = proto.Field(proto.MESSAGE, number=2, message='TableSchema')
    next_page_token: str = proto.Field(proto.STRING, number=3)
    total_rows: int = proto.Field(proto.INT64, number=4)
...
class TableSchema(proto.Message):
    ...
    """
    fields: MutableSequence['TableFieldSchema'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TableFieldSchema')
...
class TableFieldSchema(proto.Message):
    ...
    type_: str = proto.Field(proto.STRING, number=2)
    mode: str = proto.Field(proto.STRING, number=3)
    fields: MutableSequence['TableFieldSchema'] = proto.RepeatedField(proto.MESSAGE, number=4, message='TableFieldSchema')
...
class BatchGetEffectiveIamPoliciesRequest(proto.Message):
    ...
    """
    scope: str = proto.Field(proto.STRING, number=1)
    names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class BatchGetEffectiveIamPoliciesResponse(proto.Message):
    ...
    class EffectiveIamPolicy(proto.Message):
        ...
        class PolicyInfo(proto.Message):
            ...
            """
            attached_resource: str = proto.Field(proto.STRING, number=1)
            policy: policy_pb2.Policy = proto.Field(proto.MESSAGE, number=2, message=policy_pb2.Policy)
        full_resource_name: str = proto.Field(proto.STRING, number=1)
        policies: MutableSequence['BatchGetEffectiveIamPoliciesResponse.EffectiveIamPolicy.PolicyInfo'] = proto.RepeatedField(proto.MESSAGE, number=2, message='BatchGetEffectiveIamPoliciesResponse.EffectiveIamPolicy.PolicyInfo')
    policy_results: MutableSequence[EffectiveIamPolicy] = proto.RepeatedField(proto.MESSAGE, number=2, message=EffectiveIamPolicy)
...
class AnalyzerOrgPolicy(proto.Message):
    ...
    class Rule(proto.Message):
        ...
        class StringValues(proto.Message):
            ...
            """
            allowed_values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
            denied_values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        values: 'AnalyzerOrgPolicy.Rule.StringValues' = proto.Field(proto.MESSAGE, number=3, oneof='kind', message='AnalyzerOrgPolicy.Rule.StringValues')
        allow_all: bool = proto.Field(proto.BOOL, number=4, oneof='kind')
        deny_all: bool = proto.Field(proto.BOOL, number=5, oneof='kind')
        enforce: bool = proto.Field(proto.BOOL, number=6, oneof='kind')
        condition: expr_pb2.Expr = proto.Field(proto.MESSAGE, number=7, message=expr_pb2.Expr)
    attached_resource: str = proto.Field(proto.STRING, number=1)
    applied_resource: str = proto.Field(proto.STRING, number=5)
    rules: MutableSequence[Rule] = proto.RepeatedField(proto.MESSAGE, number=2, message=Rule)
    inherit_from_parent: bool = proto.Field(proto.BOOL, number=3)
    reset: bool = proto.Field(proto.BOOL, number=4)
...
class AnalyzerOrgPolicyConstraint(proto.Message):
    ...
    class Constraint(proto.Message):
        ...
        class ConstraintDefault(proto.Enum):
            """Specifies the default behavior in the absence of any ``Policy`` for
        ...
        class ListConstraint(proto.Message):
            """A ``Constraint`` that allows or disallows a list of string values,
            ...
            Attributes:
                ...
                supports_under (bool):
                    ...
                    'folders/123' folder.
            """
            supports_in: bool = proto.Field(proto.BOOL, number=1)
            supports_under: bool = proto.Field(proto.BOOL, number=2)
        ...
        constraint_default: 'AnalyzerOrgPolicyConstraint.Constraint.ConstraintDefault' = proto.Field(proto.ENUM, number=4, enum='AnalyzerOrgPolicyConstraint.Constraint.ConstraintDefault')
        list_constraint: 'AnalyzerOrgPolicyConstraint.Constraint.ListConstraint' = proto.Field(proto.MESSAGE, number=5, oneof='constraint_type', message='AnalyzerOrgPolicyConstraint.Constraint.ListConstraint')
        boolean_constraint: 'AnalyzerOrgPolicyConstraint.Constraint.BooleanConstraint' = proto.Field(proto.MESSAGE, number=6, oneof='constraint_type', message='AnalyzerOrgPolicyConstraint.Constraint.BooleanConstraint')
    ...
    class CustomConstraint(proto.Message):
        ...
        class ActionType(proto.Enum):
            ...
            DENY = 2
        name: str = proto.Field(proto.STRING, number=1)
        resource_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        method_types: MutableSequence['AnalyzerOrgPolicyConstraint.CustomConstraint.MethodType'] = proto.RepeatedField(proto.ENUM, number=3, enum='AnalyzerOrgPolicyConstraint.CustomConstraint.MethodType')
        condition: str = proto.Field(proto.STRING, number=4)
        action_type: 'AnalyzerOrgPolicyConstraint.CustomConstraint.ActionType' = proto.Field(proto.ENUM, number=5, enum='AnalyzerOrgPolicyConstraint.CustomConstraint.ActionType')
        display_name: str = proto.Field(proto.STRING, number=6)
        description: str = proto.Field(proto.STRING, number=7)
    google_defined_constraint: Constraint = proto.Field(proto.MESSAGE, number=1, oneof='constraint_definition', message=Constraint)
    custom_constraint: CustomConstraint = proto.Field(proto.MESSAGE, number=2, oneof='constraint_definition', message=CustomConstraint)
...
class AnalyzeOrgPoliciesRequest(proto.Message):
    ...
    """
    scope: str = proto.Field(proto.STRING, number=1)
    constraint: str = proto.Field(proto.STRING, number=2)
    filter: str = proto.Field(proto.STRING, number=3)
    page_size: int = proto.Field(proto.INT32, number=4, optional=True)
    page_token: str = proto.Field(proto.STRING, number=5)
...
class AnalyzeOrgPoliciesResponse(proto.Message):
    ...
    class OrgPolicyResult(proto.Message):
        ...
        """
        consolidated_policy: 'AnalyzerOrgPolicy' = proto.Field(proto.MESSAGE, number=1, message='AnalyzerOrgPolicy')
        policy_bundle: MutableSequence['AnalyzerOrgPolicy'] = proto.RepeatedField(proto.MESSAGE, number=2, message='AnalyzerOrgPolicy')
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    org_policy_results: MutableSequence[OrgPolicyResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=OrgPolicyResult)
    constraint: 'AnalyzerOrgPolicyConstraint' = proto.Field(proto.MESSAGE, number=2, message='AnalyzerOrgPolicyConstraint')
    next_page_token: str = proto.Field(proto.STRING, number=3)
...
class AnalyzeOrgPolicyGovernedContainersResponse(proto.Message):
    ...
    class GovernedContainer(proto.Message):
        ...
        consolidated_policy: 'AnalyzerOrgPolicy' = proto.Field(proto.MESSAGE, number=3, message='AnalyzerOrgPolicy')
        policy_bundle: MutableSequence['AnalyzerOrgPolicy'] = proto.RepeatedField(proto.MESSAGE, number=4, message='AnalyzerOrgPolicy')
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    governed_containers: MutableSequence[GovernedContainer] = proto.RepeatedField(proto.MESSAGE, number=1, message=GovernedContainer)
    constraint: 'AnalyzerOrgPolicyConstraint' = proto.Field(proto.MESSAGE, number=2, message='AnalyzerOrgPolicyConstraint')
    next_page_token: str = proto.Field(proto.STRING, number=3)
...
class AnalyzeOrgPolicyGovernedAssetsResponse(proto.Message):
    ...
    class GovernedResource(proto.Message):
        ...
        full_resource_name: str = proto.Field(proto.STRING, number=1)
        parent: str = proto.Field(proto.STRING, number=2)
        project: str = proto.Field(proto.STRING, number=5)
        folders: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
        organization: str = proto.Field(proto.STRING, number=7)
    ...
    class GovernedAsset(proto.Message):
        ...
        Attributes:
            ...
            policy_bundle (MutableSequence[google.cloud.asset_v1.types.AnalyzerOrgPolicy]):
                ...
                also appear in the list.
        """
        governed_resource: 'AnalyzeOrgPolicyGovernedAssetsResponse.GovernedResource' = proto.Field(proto.MESSAGE, number=1, oneof='governed_asset', message='AnalyzeOrgPolicyGovernedAssetsResponse.GovernedResource')
        governed_iam_policy: 'AnalyzeOrgPolicyGovernedAssetsResponse.GovernedIamPolicy' = proto.Field(proto.MESSAGE, number=2, oneof='governed_asset', message='AnalyzeOrgPolicyGovernedAssetsResponse.GovernedIamPolicy')
        consolidated_policy: 'AnalyzerOrgPolicy' = proto.Field(proto.MESSAGE, number=3, message='AnalyzerOrgPolicy')
        policy_bundle: MutableSequence['AnalyzerOrgPolicy'] = proto.RepeatedField(proto.MESSAGE, number=4, message='AnalyzerOrgPolicy')
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    governed_assets: MutableSequence[GovernedAsset] = proto.RepeatedField(proto.MESSAGE, number=1, message=GovernedAsset)
    constraint: 'AnalyzerOrgPolicyConstraint' = proto.Field(proto.MESSAGE, number=2, message='AnalyzerOrgPolicyConstraint')
    next_page_token: str = proto.Field(proto.STRING, number=3)
