...
class ResourceLinkingPair:
    ...
    tf_destination_value_extractor_from_link_field_value_function: Callable[[str], str] = _default_tf_destination_value_id_extractor
