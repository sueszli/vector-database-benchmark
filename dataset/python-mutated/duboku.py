...
from ..utils import clean_html, extract_attributes, ExtractorError, get_elements_by_class, int_or_none, js_to_json, smuggle_url, unescapeHTML
...
class DubokuIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://w.duboku.io/vodplay/1575-1-1.html', 'info_dict': {'id': '1575-1-1', 'ext': 'mp4', 'series': '白色月光', 'title': 'contains:白色月光', 'season_number': 1, 'episode_number': 1, 'season': 'Season 1', 'episode_id': '1', 'season_id': '1', 'episode': 'Episode 1'}, 'params': {'skip_download': 'm3u8 download'}}, {'url': 'https://w.duboku.io/vodplay/1588-1-1.html', 'info_dict': {'id': '1588-1-1', 'ext': 'mp4', 'series': '亲爱的自己', 'title': 'contains:第1集', 'season_number': 1, 'episode_number': 1, 'episode': 'Episode 1', 'season': 'Season 1', 'episode_id': '1', 'season_id': '1'}, 'params': {'skip_download': 'm3u8 download'}}]
    _PLAYER_DATA_PATTERN = 'player_data\\s*=\\s*(\\{\\s*(.*)})\\s*;?\\s*</script'
...
class DubokuPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://w.duboku.io/voddetail/1575.html', 'info_dict': {'id': 'startswith:1575', 'title': '白色月光'}, 'playlist_count': 12}, {'url': 'https://w.duboku.io/voddetail/1554.html', 'info_dict': {'id': 'startswith:1554', 'title': '以家人之名'}, 'playlist_mincount': 30}]
