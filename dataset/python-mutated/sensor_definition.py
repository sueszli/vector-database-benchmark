...
from typing import TYPE_CHECKING, Any, Callable, Dict, Iterable, Iterator, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Type, TypeVar, Union, cast
import pendulum
...
from dagster._core.errors import DagsterInvalidDefinitionError, DagsterInvalidInvocationError, DagsterInvalidSubsetError, DagsterInvariantViolationError
...
from .run_request import AddDynamicPartitionsRequest, DagsterRunReaction, DeleteDynamicPartitionsRequest, RunRequest, SensorResult, SkipReason
...
RawSensorEvaluationFunctionReturn = Union[Iterator[Union[SkipReason, RunRequest, DagsterRunReaction, SensorResult]], Sequence[RunRequest], SkipReason, RunRequest, DagsterRunReaction, SensorResult]
...
@whitelist_for_serdes(storage_field_names={'dagster_run_reactions': 'pipeline_run_reactions'})
class SensorExecutionData(NamedTuple('_SensorExecutionData', [('run_requests', Optional[Sequence[RunRequest]]), ('skip_message', Optional[str]), ('cursor', Optional[str]), ('dagster_run_reactions', Optional[Sequence[DagsterRunReaction]]), ('captured_log_key', Optional[Sequence[str]]), ('dynamic_partitions_requests', Optional[Sequence[Union[AddDynamicPartitionsRequest, DeleteDynamicPartitionsRequest]]]), ('asset_events', Sequence[Union[AssetMaterialization, AssetObservation, AssetCheckEvaluation]])])):
