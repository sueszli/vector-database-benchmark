...
def main():
    ...
    response = client.apps.begin_set_active_deployments(resource_group_name='myResourceGroup', service_name='myservice', app_name='myapp', active_deployment_collection={'activeDeploymentNames': ['default']}).result()
    print(response)
