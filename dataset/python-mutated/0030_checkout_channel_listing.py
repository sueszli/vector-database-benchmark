...
class Migration(migrations.Migration):
    dependencies = [('channel', '0001_initial'), ('checkout', '0029_auto_20200904_0529')]
    operations = [migrations.AddField(model_name='checkout', name='channel', field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='checkouts', to='channel.channel')), migrations.AlterField(model_name='checkout', name='currency', field=models.CharField(max_length=3)), migrations.RunPython(add_channel_slug), migrations.AlterField(model_name='checkout', name='channel', field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='checkouts', to='channel.channel'))]