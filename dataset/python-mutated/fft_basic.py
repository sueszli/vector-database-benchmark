...
class Fft(Benchmark):
    params = [[100, 256, 313, 512, 1000, 1024, 2048, 2048 * 2, 2048 * 4], ['real', 'cmplx'], ['scipy.fftpack', 'scipy.fft', 'numpy.fft']]
...
class NextFastLen(Benchmark):
    params = [[12, 13, 1021, 1024, 16381, 16384, 262139, 262144, 999983, 1048576]]
    param_names = ['size']
...
class RFft(Benchmark):
    params = [[100, 256, 313, 512, 1000, 1024, 2048, 2048 * 2, 2048 * 4], ['scipy.fftpack', 'scipy.fft', 'numpy.fft']]
...
class RealTransforms1D(Benchmark):
    params = [[75, 100, 135, 256, 313, 512, 675, 1024, 2025, 2048], ['I', 'II', 'III', 'IV'], ['scipy.fftpack', 'scipy.fft']]
    param_names = ['size', 'type', 'module']
...
class Fftn(Benchmark):
    params = [['100x100', '313x100', '1000x100', '256x256', '512x512'], ['real', 'cmplx'], ['scipy.fftpack', 'scipy.fft', 'numpy.fft']]
    param_names = ['size', 'type', 'module']
...
class RealTransformsND(Benchmark):
    params = [['75x75', '100x100', '135x135', '313x363', '1000x100', '256x256'], ['I', 'II', 'III', 'IV'], ['scipy.fftpack', 'scipy.fft']]
    param_names = ['size', 'type', 'module']
...
class FftBackends(Benchmark):
    params = [[100, 256, 313, 512, 1000, 1024, 2048, 2048 * 2, 2048 * 4], ['real', 'cmplx'], ['pocketfft', 'pyfftw', 'numpy', 'direct']]
...
class FftnBackends(Benchmark):
    params = [['100x100', '313x100', '1000x100', '256x256', '512x512'], ['real', 'cmplx'], ['pocketfft', 'pyfftw', 'numpy', 'direct']]
    param_names = ['size', 'type', 'backend']
...
class FftThreading(Benchmark):
    params = [['100x100', '1000x100', '256x256', '512x512'], [1, 8, 32, 100], ['workers', 'threading']]
