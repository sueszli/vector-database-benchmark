...
from ..utils import draft_order_complete, draft_order_create, draft_order_update, order_discount_add, order_lines_create

@pytest.mark.e2e
def test_order_products_on_promotion_and_manual_order_discount_CORE_2108(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_orders):
    if False:
        return 10
    ...
    undiscounted_unit_price = order_lines['order']['lines'][0]['undiscountedUnitPrice']['gross']['amount']
    ...
    manual_discount_input = {'valueType': 'FIXED', 'value': 2}
    discount_data = order_discount_add(e2e_staff_api_client, order_id, manual_discount_input)
