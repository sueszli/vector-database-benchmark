...
import tempfile
import unittest
from pyspark.install import install_spark, DEFAULT_HADOOP, DEFAULT_HIVE, UNSUPPORTED_COMBINATIONS, checked_versions, checked_package_name
...
if __name__ == '__main__':
    from pyspark.tests.test_install_spark import *
    try:
        import xmlrunner
