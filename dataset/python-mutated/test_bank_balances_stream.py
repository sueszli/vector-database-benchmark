...
def test_request_params(patch_base_class):
    if False:
        ...
        return i + 15
    stream = CashBalancesStream(**config())
    inputs = {'stream_slice': {'account_uuid': 'uuid', 'endDate': '2022-02-01', 'startDate': '2022-01-01'}, 'stream_state': {}}
    stream.intraday = False
    params = stream.request_params(**inputs)
    expected = {'endDate': '2022-02-01', 'startDate': '2022-01-01', 'intraday': False, 'actual': True, 'estimatedForecasts': False, 'confirmedForecasts': False, 'dateType': 'VALUE'}
