from typing import TYPE_CHECKING, Any, Dict, Iterable, List, Mapping, NamedTuple, Optional, Sequence, Type, Union
...
from .repository_definition import SINGLETON_REPOSITORY_NAME, PendingRepositoryDefinition, RepositoryDefinition
...
@deprecated(breaking_version='2.0', additional_warn_text="Instantiations can be removed. Since it's behavior is now the default, this class is now a no-op.")
