...
class HuffPostIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>https?://embed\\.live\\.huffingtonpost\\.com/.+?)\\1']
    _TEST = {'url': 'http://live.huffingtonpost.com/r/segment/legalese-it/52dd3e4b02a7602131000677', 'md5': '55f5e8981c1c80a64706a44b74833de8', 'info_dict': {'id': '52dd3e4b02a7602131000677', 'ext': 'mp4', 'title': 'Legalese It! with @MikeSacksHP', 'description': 'This week on Legalese It, Mike talks to David Bosco about his new book on the ICC, "Rough Justice," he also discusses the Virginia AG\'s historic stance on gay marriage, the execution of Edgar Tamayo, the ICC\'s delay of Kenya\'s President and more.  ', 'duration': 1549, 'upload_date': '20140124'}, 'params': {'skip_download': True}, 'expected_warnings': ['HTTP Error 404: Not Found']}
