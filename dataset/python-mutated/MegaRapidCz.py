...
class MegaRapidCz(SimpleDownloader):
    ...
    __version__ = '0.64'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?(share|mega)rapid\\.cz/soubor/\\d+/.+'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('MikyWoW', 'mikywow@seznam.cz'), ('zoidberg', 'zoidberg@mujmail.cz'), ('stickell', 'l.stickell@yahoo.it'), ('Walter Purcaro', 'vuolter@gmail.com')]
    NAME_PATTERN = '<h1.*?><span.*?>(?:<a.*?>)?(?P<N>.+?)'
    SIZE_PATTERN = '<td class="i">Velikost:</td>\\s*<td class="h"><strong>\\s*(?P<S>[\\d.,]+) (?P<U>[\\w^_]+)</strong></td>'
    OFFLINE_PATTERN = 'Nastala chyba 404|Soubor byl smazán'
    CHECK_TRAFFIC = True
    LINK_PREMIUM_PATTERN = '<a href="(.+?)" title="Stahnout">(.+?)</a>'
    ERR_LOGIN_PATTERN = '<div class="error_div"><strong>Stahování je přístupné pouze přihlášeným uživatelům'
    ERR_CREDIT_PATTERN = '<div class="error_div"><strong>Stahování zdarma je možné jen přes náš'
