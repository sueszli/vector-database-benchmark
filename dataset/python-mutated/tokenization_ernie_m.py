...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {'ernie-m-base': 514, 'ernie-m-large': 514}
PRETRAINED_INIT_CONFIGURATION = {'ernie-m-base': {'do_lower_case': False}, 'ernie-m-large': {'do_lower_case': False}}
