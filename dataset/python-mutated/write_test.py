...
class WriteTestSchema(BaseModel):
    test_description: str = Field(..., description='Description of the testing task')
    test_file_name: str = Field(..., description="Name of the file to write. Only include the file name. Don't include path.")
