...
from tribler.core.components.knowledge.community.knowledge_payload import RawStatementOperationMessage, RequestStatementOperationMessage, StatementOperation, StatementOperationMessage, StatementOperationSignature
from tribler.core.components.knowledge.community.knowledge_validator import validate_operation, validate_resource, validate_resource_type
...
REQUEST_INTERVAL = 5
CLEAR_ALL_REQUESTS_INTERVAL = 10 * 60
