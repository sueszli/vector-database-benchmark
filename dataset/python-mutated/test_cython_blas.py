import numpy as np
import pytest
from sklearn.utils._cython_blas import ColMajor, NoTrans, RowMajor, Trans, _asum_memview, _axpy_memview, _copy_memview, _dot_memview, _gemm_memview, _gemv_memview, _ger_memview, _nrm2_memview, _rot_memview, _rotg_memview, _scal_memview
...
RTOL = {np.float32: 1e-06, np.float64: 1e-12}
