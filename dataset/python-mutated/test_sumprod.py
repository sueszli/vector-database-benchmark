...
@testing.parameterize(*testing.product({'shape': [(10,), (10, 20), (10, 20, 30), (10, 20, 30, 40)], 'order': ('C', 'F'), 'backend': ('device', 'block')}))
...
@testing.parameterize(*testing.product({'shape': [(10,), (10, 20), (10, 20, 30), (10, 20, 30, 40)], 'order': ('C', 'F')}))
@pytest.mark.skipif(not cupy.cuda.cutensor.available, reason='The cuTENSOR routine is not enabled')
...
@testing.parameterize(*testing.product({'shape': [(2, 3, 4), (20, 30, 40)], 'axis': [0, 1], 'transpose_axes': [True, False], 'keepdims': [True, False], 'func': ['nansum', 'nanprod']}))
...
@testing.parameterize(*testing.product({'shape': [(2, 3, 4), (20, 30, 40)]}))
...
@testing.parameterize(*testing.product({'shape': [(2, 3, 4, 5), (20, 30, 40, 50)], 'axis': [(1, 3), (0, 2, 3)]}))
...
@testing.parameterize(*testing.product({'shape': [(20,), (7, 6), (3, 4, 5)], 'axis': [None, 0, 1, 2], 'func': ('nancumsum', 'nancumprod')}))
...
@testing.parameterize(*testing.product_dict(testing.product({'shape': [()], 'axis': [None, ()], 'spacing': [(), (1.2,)]}) + testing.product({'shape': [(33,)], 'axis': [None, 0, -1, (0,)], 'spacing': [(), (1.2,), 'sequence of int', 'arrays']}) + testing.product({'shape': [(10, 20), (10, 20, 30)], 'axis': [None, 0, -1, (0, -1), (1, 0)], 'spacing': [(), (1.2,), 'sequence of int', 'arrays', 'mixed']}), testing.product({'edge_order': [1, 2]})))
class TestGradient:
