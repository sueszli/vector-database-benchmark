...
import transformers
from transformers import AutoConfig, AutoModelForSeq2SeqLM, AutoTokenizer, DataCollatorForSeq2Seq, HfArgumentParser, MBart50Tokenizer, MBart50TokenizerFast, MBartTokenizer, MBartTokenizerFast, Seq2SeqTrainer, Seq2SeqTrainingArguments, set_seed
...
summarization_name_mapping = {'amazon_reviews_multi': ('review_body', 'review_title'), 'big_patent': ('description', 'abstract'), 'cnn_dailymail': ('article', 'highlights'), 'orange_sum': ('text', 'summary'), 'pn_summary': ('article', 'summary'), 'psc': ('extract_text', 'summary_text'), 'samsum': ('dialogue', 'summary'), 'thaisum': ('body', 'summary'), 'xglue': ('news_body', 'news_title'), 'xsum': ('document', 'summary'), 'wiki_summary': ('article', 'highlights'), 'multi_news': ('document', 'summary')}
