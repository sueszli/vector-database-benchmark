...
def test_calibrate_existing_model():
    ...
    model_int_calib = H2OGradientBoostingEstimator(ntrees=100, distribution='bernoulli', min_rows=10, max_depth=5, seed=42, calibrate_model=True, calibration_frame=calib, calibration_method='IsotonicRegression')
    ...
    model_man_calib = H2OGradientBoostingEstimator(ntrees=100, distribution='bernoulli', min_rows=10, max_depth=5, seed=42)
