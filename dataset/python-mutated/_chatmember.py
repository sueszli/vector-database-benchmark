...
class ChatMemberAdministrator(ChatMember):
    ...
    Attributes:
        ...
        custom_title (:obj:`str`): Optional. Custom title for this user.
    """
    __slots__ = ('can_be_edited', 'is_anonymous', 'can_manage_chat', 'can_delete_messages', 'can_manage_video_chats', 'can_restrict_members', 'can_promote_members', 'can_change_info', 'can_invite_users', 'can_post_messages', 'can_edit_messages', 'can_pin_messages', 'can_manage_topics', 'custom_title', 'can_post_stories', 'can_edit_stories', 'can_delete_stories')
...
class ChatMemberRestricted(ChatMember):
    ...
    """
    __slots__ = ('is_member', 'can_change_info', 'can_invite_users', 'can_pin_messages', 'can_send_messages', 'can_send_polls', 'can_send_other_messages', 'can_add_web_page_previews', 'can_manage_topics', 'until_date', 'can_send_audios', 'can_send_documents', 'can_send_photos', 'can_send_videos', 'can_send_video_notes', 'can_send_voice_notes')
