...
def main():
    ...
    response = client.files.read_write(group_name='DmsSdkRg', service_name='DmsSdkService', project_name='DmsSdkProject', file_name='x114d023d8')
    print(response)
