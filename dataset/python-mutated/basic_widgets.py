...
from qt.core import QAbstractItemView, QAction, QApplication, QComboBox, QDateTime, QDialog, QDialogButtonBox, QDoubleSpinBox, QGridLayout, QIcon, QKeySequence, QLabel, QLineEdit, QListWidgetItem, QMenu, QMessageBox, QPixmap, QPlainTextEdit, QSize, QSizePolicy, Qt, QToolButton, QUndoCommand, QUndoStack, QUrl, QVBoxLayout, QWidget, pyqtSignal
...
from calibre.utils.date import UNDEFINED_DATE, as_local_time, internal_iso_format_string, is_date_undefined, local_tz, parse_only_date, qt_from_dt, qt_to_dt, utcfromtimestamp
...
class IdentifiersEdit(QLineEdit, ToMetadataMixin, LineEditIndicators):
    LABEL = _('&Ids:')
    BASE_TT = _('Edit the identifiers for this book. For example: \n\n%s\n\nIf an identifier value contains a comma, you can use the | character to represent it.') % 'isbn:1565927249, doi:10.1000/182, amazon:1565927249'
