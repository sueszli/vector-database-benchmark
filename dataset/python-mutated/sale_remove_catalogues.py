...
from ...utils import CatalogueInfo, convert_catalogue_info_into_predicate, convert_migrated_sale_predicate_to_catalogue_info, subtract_catalogues_info
from .sale_base_catalogue import SaleBaseCatalogueMutation

class SaleRemoveCatalogues(SaleBaseCatalogueMutation):

    class Meta:
        description = 'Removes products, categories, collections from a sale.' + DEPRECATED_IN_3X_MUTATION + ' Use `promotionRuleUpdate` or `promotionRuleDelete` mutations instead.'
