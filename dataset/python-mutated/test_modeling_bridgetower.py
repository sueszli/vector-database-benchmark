...
import unittest
import numpy as np
from transformers import BridgeTowerConfig, BridgeTowerTextConfig, BridgeTowerVisionConfig, is_torch_available, is_vision_available
...
if is_torch_available():
    import torch
    from transformers import BridgeTowerForContrastiveLearning, BridgeTowerForImageAndTextRetrieval, BridgeTowerForMaskedLM, BridgeTowerModel
...
class BridgeTowerModelTrainingTest(unittest.TestCase):
    all_training_supported_model_classes = (BridgeTowerForImageAndTextRetrieval, BridgeTowerForMaskedLM, BridgeTowerForContrastiveLearning) if is_torch_available() else ()
