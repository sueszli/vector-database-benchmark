...
from Orange.classification import ThresholdLearner, CalibratedLearner, NaiveBayesLearner, ThresholdClassifier, CalibratedClassifier
from Orange.classification.base_classification import ModelClassification, LearnerClassification
...
from Orange.widgets.tests.base import WidgetTest, WidgetLearnerTestMixin, datasets
