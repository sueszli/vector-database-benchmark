...
from paddle.distributed.auto_parallel.static.utils import _copy_dist_attr_from_cpp, _copy_dist_attr_from_cpp_for_graph, _copy_dist_attr_to_cpp, _copy_dist_attr_to_cpp_for_graph
