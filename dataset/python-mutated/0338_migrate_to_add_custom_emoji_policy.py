...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0337_realm_add_custom_emoji_policy')]
    operations = [migrations.RunPython(migrate_to_add_custom_emoji_policy, reverse_code=reverse_migrate_to_add_custom_emoji_policy, elidable=True)]