...
from fixtures.page_objects.dashboard_detail import EDIT_WIDGET_BUTTON, WIDGET_DRAG_HANDLE, WIDGET_RESIZE_HANDLE, WIDGET_TITLE_FIELD, DashboardDetailPage
from sentry.models.dashboard import Dashboard
from sentry.models.dashboard_widget import DashboardWidget, DashboardWidgetDisplayTypes, DashboardWidgetQuery, DashboardWidgetTypes
from sentry.testutils.cases import AcceptanceTestCase
from sentry.testutils.helpers.datetime import before_now, iso_format
from sentry.testutils.silo import no_silo_test
FEATURE_NAMES = ['organizations:discover-basic', 'organizations:discover-query', 'organizations:dashboards-basic', 'organizations:global-views']
