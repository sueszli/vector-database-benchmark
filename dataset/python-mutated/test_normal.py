...
default_scale = {initializers.Normal: 0.05}
default_coeff = {initializers.HeNormal: math.sqrt(2)}
default_fan = {initializers.LeCunNormal: 'fan_in', initializers.GlorotNormal: 'fan_avg', initializers.HeNormal: 'fan_in'}

@testing.parameterize(*testing.product({'target,fan_option': [(initializers.Normal, None), (initializers.LeCunNormal, None), (initializers.GlorotNormal, None), (initializers.HeNormal, 'fan_in'), (initializers.HeNormal, 'fan_out')], 'shape,fans': [((2, 3), (3, 2)), ((2, 3, 4), (12, 8))], 'scale': [None, 7.3], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'rng_class': [None, numpy.random.RandomState]}))
