...
PARAMS_MAP = {'tiny': model_params.TINY_PARAMS, 'base': model_params.BASE_PARAMS, 'big': model_params.BIG_PARAMS}
DEFAULT_TRAIN_EPOCHS = 10
INF = 1000000000
BLEU_DIR = 'bleu'
TENSORS_TO_LOG = {'learning_rate': 'model/get_train_op/learning_rate/learning_rate', 'cross_entropy_loss': 'model/cross_entropy'}
