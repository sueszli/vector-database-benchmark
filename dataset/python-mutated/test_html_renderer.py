...
scatterplot_data = [{'rgb': [136, 45, 97], 'position': [-0.002, 0.002]}, {'rgb': [170, 57, 57], 'position': [-0.002, -0.002]}, {'rgb': [45, 136, 45], 'position': [0.002, -0.002]}, {'rgb': [123, 159, 53], 'position': [0.002, 0.002]}]
d = Deck(layers=[Layer('ScatterplotLayer', data=scatterplot_data, get_radius=100, picking_radius=5, pickable=True, get_color='rgb', get_position='position'), Layer('TextLayer', data=text_data, picking_radius=5, get_color=[255, 255, 255], pickable=True, font_size=72, get_position='position')])
