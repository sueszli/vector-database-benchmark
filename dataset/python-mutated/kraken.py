...
from freqtrade.exceptions import DDosProtection, InsufficientFundsError, InvalidOrderException, OperationalException, TemporaryError
...
class Kraken(Exchange):
    ...
    _ft_has: Dict = {'stoploss_on_exchange': True, 'stop_price_param': 'stopPrice', 'stop_price_prop': 'stopPrice', 'ohlcv_candle_limit': 720, 'ohlcv_has_history': False, 'trades_pagination': 'id', 'trades_pagination_arg': 'since', 'mark_ohlcv_timeframe': '4h'}
