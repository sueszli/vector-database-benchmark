...
def sample_create_private_connection():
    ...
    request = datastream_v1alpha1.CreatePrivateConnectionRequest(parent='parent_value', private_connection_id='private_connection_id_value', private_connection=private_connection)
