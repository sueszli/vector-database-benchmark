...
from modelscope.preprocessors.nlp import DocumentGroundedDialogRetrievalPreprocessor
...
class DocumentGroundedDialogRetrievalTest(unittest.TestCase):
    ...
    param = {'query': ['<last_turn>我想知道孩子如果出现阑尾炎的话会怎么样', '<last_turn>好像是从肚脐开始，然后到右下方<system>您可以描述一下孩子的情况吗？<user>我想知道孩子如果出现阑尾炎的话会怎么样？'], 'positive': ['阑尾炎', '肚脐开始'], 'negative': ['肠胃炎', '肚脐为止']}
