...
def upgrade():
    ...
    op.add_column(table, sa.Column('source_id', sa.UnicodeText, sa.ForeignKey('harvest_source.id')))
    op.add_column(table, sa.Column('package_id', sa.UnicodeText, sa.ForeignKey('package.id')))
