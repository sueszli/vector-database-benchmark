...
class PatchChecker(BaseChecker):
    ...
    msgs = {'C9999': ('Use of mock.patch is not allowed', 'patch-call', 'Use of mock.patch not allowed')}
...
class MocksUseSpecArg(BaseChecker):
    __implements__ = (IAstroidChecker,)
    name = 'mocks-use-spec'
    msgs = {'C9998': ('mock.Mock() must provide "spec=" argument', 'mock-missing-spec', 'mock.Mock() must provide "spec=" argument')}
