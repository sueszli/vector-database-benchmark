...
from ..utils import clean_html, ExtractorError, str_or_none, strip_or_none, unified_timestamp
...
class PacktPubIE(PacktPubBaseIE):
    ...
    _TESTS = [{'url': 'https://www.packtpub.com/mapt/video/web-development/9781787122215/20528/20530/Project+Intro', 'md5': '1e74bd6cfd45d7d07666f4684ef58f70', 'info_dict': {'id': '20530', 'ext': 'mp4', 'title': 'Project Intro', 'thumbnail': 're:(?i)^https?://.*\\.jpg', 'timestamp': 1490918400, 'upload_date': '20170331'}}, {'url': 'https://subscription.packtpub.com/video/web_development/9781787122215/20528/20530/project-intro', 'only_matching': True}, {'url': 'https://subscription.packtpub.com/video/programming/9781838988906/p1/video1_1/business-card-project', 'only_matching': True}]
...
class PacktPubCourseIE(PacktPubBaseIE):
    ...
    _TESTS = [{'url': 'https://www.packtpub.com/mapt/video/web-development/9781787122215', 'info_dict': {'id': '9781787122215', 'title': 'Learn Nodejs by building 12 projects [Video]', 'description': 'md5:489da8d953f416e51927b60a1c7db0aa'}, 'playlist_count': 90}, {'url': 'https://subscription.packtpub.com/video/web_development/9781787122215', 'only_matching': True}]
