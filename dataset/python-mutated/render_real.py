...
from ydata_profiling.report.formatters import fmt, fmt_bytesize, fmt_monotonic, fmt_numeric, fmt_percent
from ydata_profiling.report.presentation.core import Container, FrequencyTable, Image, Table, VariableInfo
...
def render_real(config: Settings, summary: dict) -> dict:
    ...
    template_variables['bottom'] = Container([statistics, hist, fq, evs], sequence_type='tabs', anchor_id=f'{varid}bottom')
