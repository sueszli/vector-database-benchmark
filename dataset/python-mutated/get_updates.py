...
class GetUpdates(TelegramMethod[List[Update]]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, offset: Optional[int]=None, limit: Optional[int]=None, timeout: Optional[int]=None, allowed_updates: Optional[List[str]]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(offset=offset, limit=limit, timeout=timeout, allowed_updates=allowed_updates, **__pydantic_kwargs)