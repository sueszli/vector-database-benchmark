...
from transformers.testing_utils import require_torch, require_torch_multi_accelerator, require_vision, slow, torch_device
...
class Blip2ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': Blip2Model, 'image-to-text': Blip2ForConditionalGeneration, 'visual-question-answering': Blip2ForConditionalGeneration} if is_torch_available() else {}
    fx_compatible = False
    test_head_masking = False
    test_pruning = False
    test_resize_embeddings = False
