...
ROLE_TABLES_PERM_DATA = {'role_name': 'override_me', 'database': [{'datasource_type': 'table', 'name': 'examples', 'schema': [{'name': '', 'datasources': ['birth_names']}]}]}
ROLE_ALL_PERM_DATA = {'role_name': 'override_me', 'database': [{'datasource_type': 'table', 'name': 'examples', 'schema': [{'name': '', 'datasources': ['birth_names']}]}]}
EXTEND_ROLE_REQUEST = '/superset/approve?datasource_type={}&datasource_id={}&created_by={}&role_to_extend={}'
GRANT_ROLE_REQUEST = '/superset/approve?datasource_type={}&datasource_id={}&created_by={}&role_to_grant={}'
