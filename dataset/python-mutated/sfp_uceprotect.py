...
class sfp_uceprotect(SpiderFootPlugin):
    meta = {'name': 'UCEPROTECT', 'summary': 'Check if a netblock or IP address is in the UCEPROTECT database.', 'flags': [], 'useCases': ['Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'http://www.uceprotect.net/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['http://www.uceprotect.net/en/index.php?m=3&s=3', 'http://www.uceprotect.net/en/index.php?m=6&s=0', 'http://www.uceprotect.net/en/index.php?m=6&s=11', 'http://www.uceprotect.net/en/index.php?m=13&s=0', 'http://www.uceprotect.net/en/rblcheck.php'], 'favIcon': 'https://www.uceprotect.net/favicon.ico', 'logo': 'https://www.uceprotect.net/en/logo.gif', 'description': 'UCEPROTECT is a DNS blacklisting service whose mission is to stop mail abuse globally.'}}
