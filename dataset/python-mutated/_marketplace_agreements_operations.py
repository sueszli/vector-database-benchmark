...
class MarketplaceAgreementsOperations:
    ...
    @overload
    async def create_or_update(self, body: Optional[_models.DatadogAgreementResource]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.DatadogAgreementResource:
    ...
    @overload
    async def create_or_update(self, body: Optional[IO]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.DatadogAgreementResource:
        """Create Datadog marketplace agreement in the subscription.
    ...
    async def create_or_update(self, body: Optional[Union[_models.DatadogAgreementResource, IO]]=None, **kwargs: Any) -> _models.DatadogAgreementResource:
        """Create Datadog marketplace agreement in the subscription.
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            _json = None
        request = build_create_or_update_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
