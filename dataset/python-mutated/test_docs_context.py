...
from samcli.commands.docs.command_context import DocsCommandContext, ERROR_MESSAGE, SUCCESS_MESSAGE, CommandImplementation
...
SUPPORTED_COMMANDS = ['config', 'build', 'local', 'local invoke', 'local start-api', 'local start-lambda', 'list', 'list stack-outputs', 'list endpoints', 'list resources', 'deploy', 'remote invoke', 'remote test-event delete', 'remote test-event get', 'remote test-event list', 'remote test-event put', 'package', 'delete', 'sync', 'publish', 'validate', 'init', 'logs', 'traces']
