...
from AnyQt.QtWidgets import QWidget, QLabel, QVBoxLayout, QHBoxLayout, QSizePolicy
...
class ConditionBox(QWidget):
    ...
    RowItems = namedtuple('RowItems', ('pre_label', 'left_combo', 'in_label', 'right_combo', 'remove_button'))
...
class OWMergeData(widget.OWWidget):
    ...
    class Warning(widget.OWWidget.Warning):
        ...
        nonunique_left = Msg('Some (unused) combinations of values in Data appear in multiple rows.')
        nonunique_right = Msg('Some (unused) combinations of values in Extra Data appear in multiple rows.')

    class Error(widget.OWWidget.Error):
        matching_numeric_with_nonnum = Msg('Numeric and non-numeric columns ({} and {}) cannot be matched.')
        ...
        nonunique_left = Msg('Some combinations of values in Data appear in multiple rows.\nEvery combination may appear at most once.')
        nonunique_right_matched = Msg('Some combinations of values in Extra Data appear in multiple rows.\nEvery matched combination may appear at most once.')
        nonunique_right = Msg('Some combinations of values in Extra Data appear in multiple rows.\nEvery combination may appear at most once.')
    ...
    _merge_methods = [_left_join_indices, _inner_join_indices, _outer_join_indices]
...
if __name__ == '__main__':
    WidgetPreview(OWMergeData).run(set_data=Orange.data.Table('tests/data-gender-region'), set_extra_data=Orange.data.Table('tests/data-regions'))