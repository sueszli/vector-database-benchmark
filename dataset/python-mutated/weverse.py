...
from ..utils import ExtractorError, UserNotLive, float_or_none, int_or_none, str_or_none, traverse_obj, try_call, update_url_query, url_or_none

class WeverseBaseIE(InfoExtractor):
    _NETRC_MACHINE = 'weverse'
    _ACCOUNT_API_BASE = 'https://accountapi.weverse.io/web/api/v2'
    _API_HEADERS = {'Referer': 'https://weverse.io/', 'WEV-device-Id': str(uuid.uuid4())}
...
class WeverseIE(WeverseBaseIE):
    ...
    _TESTS = [{'url': 'https://weverse.io/billlie/live/0-107323480', 'md5': '1fa849f00181eef9100d3c8254c47979', 'info_dict': {'id': '0-107323480', 'ext': 'mp4', 'title': '행복한 평이루💜', 'description': '', 'uploader': 'Billlie', 'uploader_id': '5ae14aed7b7cdc65fa87c41fe06cc936', 'channel': 'billlie', 'channel_id': '72', 'channel_url': 'https://weverse.io/billlie', 'creator': 'Billlie', 'timestamp': 1666262062, 'upload_date': '20221020', 'release_timestamp': 1666262058, 'release_date': '20221020', 'duration': 3102, 'thumbnail': 're:^https?://.*\\.jpe?g$', 'view_count': int, 'like_count': int, 'comment_count': int, 'availability': 'needs_auth', 'live_status': 'was_live'}}, {'url': 'https://weverse.io/lesserafim/live/2-102331763', 'md5': 'e46125c08b13a6c8c1f4565035cca987', 'info_dict': {'id': '2-102331763', 'ext': 'mp4', 'title': '🎂김채원 생신🎂', 'description': '🎂김채원 생신🎂', 'uploader': 'LE SSERAFIM ', 'uploader_id': 'd26ddc1e258488a0a2b795218d14d59d', 'channel': 'lesserafim', 'channel_id': '47', 'channel_url': 'https://weverse.io/lesserafim', 'creator': 'LE SSERAFIM', 'timestamp': 1659353400, 'upload_date': '20220801', 'release_timestamp': 1659353400, 'release_date': '20220801', 'duration': 3006, 'thumbnail': 're:^https?://.*\\.jpe?g$', 'view_count': int, 'like_count': int, 'comment_count': int, 'availability': 'needs_auth', 'live_status': 'was_live', 'subtitles': {'id_ID': 'count:2', 'en_US': 'count:2', 'es_ES': 'count:2', 'vi_VN': 'count:2', 'th_TH': 'count:2', 'zh_CN': 'count:2', 'zh_TW': 'count:2', 'ja_JP': 'count:2', 'ko_KR': 'count:2'}}}, {'url': 'https://weverse.io/treasure/live/2-117230416', 'info_dict': {'id': '2-117230416', 'ext': 'mp4', 'title': 're:스껄도려님 첫 스무살 생파🦋', 'description': '', 'uploader': 'TREASURE', 'uploader_id': '77eabbc449ca37f7970054a136f60082', 'channel': 'treasure', 'channel_id': '20', 'channel_url': 'https://weverse.io/treasure', 'creator': 'TREASURE', 'timestamp': 1680667651, 'upload_date': '20230405', 'release_timestamp': 1680667639, 'release_date': '20230405', 'thumbnail': 're:^https?://.*\\.jpe?g$', 'view_count': int, 'like_count': int, 'comment_count': int, 'availability': 'needs_auth', 'live_status': 'is_live'}, 'skip': 'Livestream has ended'}]
...
class WeverseMomentIE(WeverseBaseIE):
    ...
    _TESTS = [{'url': 'https://weverse.io/secretnumber/moment/66a07e164b56a696ee71c99315ffe27b/post/1-117229444', 'md5': '87733ac19a54081b7dfc2442036d282b', 'info_dict': {'id': '1-117229444', 'ext': 'mp4', 'title': '今日もめっちゃいい天気☀️🌤️', 'uploader': '레아', 'uploader_id': '66a07e164b56a696ee71c99315ffe27b', 'channel': 'secretnumber', 'channel_id': '56', 'creator': 'SECRET NUMBER', 'duration': 10, 'upload_date': '20230405', 'timestamp': 1680653968, 'thumbnail': 're:^https?://.*\\.jpe?g$', 'like_count': int, 'comment_count': int, 'availability': 'needs_auth'}, 'skip': 'Moment has expired'}]
...
class WeverseLiveTabIE(WeverseTabBaseIE):
    ...
    _TESTS = [{'url': 'https://weverse.io/billlie/live/', 'playlist_mincount': 55, 'info_dict': {'id': 'billlie-live', 'title': 'Billlie', 'thumbnail': 're:^https?://.*\\.jpe?g$'}}]
...
class WeverseMediaTabIE(WeverseTabBaseIE):
    ...
    _TESTS = [{'url': 'https://weverse.io/billlie/media/', 'playlist_mincount': 231, 'info_dict': {'id': 'billlie-media', 'title': 'Billlie', 'thumbnail': 're:^https?://.*\\.jpe?g$'}}, {'url': 'https://weverse.io/lesserafim/media/all', 'only_matching': True}, {'url': 'https://weverse.io/lesserafim/media/new', 'only_matching': True}]
