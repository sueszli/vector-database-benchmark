...
SCHEMA = [{'name': 'column_a', 'type': '3'}, {'name': 'column_b', 'type': '253'}, {'name': 'column_c', 'type': '10'}]
COLUMNS = ['column_a', 'column_b', 'column_c']
ROW = ['convert_type_return_value', 'convert_type_return_value', 'convert_type_return_value']
CURSOR_DESCRIPTION = [('column_a', '3', 0, 0, 0, 0, False), ('column_b', '253', 0, 0, 0, 0, False), ('column_c', '10', 0, 0, 0, 0, False)]
TMP_FILE_NAME = 'temp-file'
EMPTY_INPUT_DATA: list[str] = []
INPUT_DATA = [['101', 'school', '2015-01-01'], ['102', 'business', '2017-05-24'], ['103', 'non-profit', '2018-10-01']]
OUTPUT_DATA = json.dumps({'column_a': 'convert_type_return_value', 'column_b': 'convert_type_return_value', 'column_c': 'convert_type_return_value'}).encode('utf-8')
...
OUTPUT_DF_WITH_EXCLUDE_COLUMNS = pd.DataFrame([['convert_type_return_value'] * len(NEW_COLUMNS)] * 3, columns=NEW_COLUMNS)
