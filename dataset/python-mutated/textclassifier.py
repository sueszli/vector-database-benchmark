...
if __name__ == '__main__':
    ...
    parser.add_option('-e', '--embedding_dim', dest='embedding_dim', default='300')
    ...
    if options.action == 'train':
        ...
        if options.onYarn:
            ...
            sc = init_spark_on_yarn(hadoop_conf=hadoop_conf, conda_name=conda_env_name, num_executors=2, executor_cores=2, executor_memory='20g', driver_memory='10g')
        else:
