...
class GenerateDetailedCostReportOperationStatusOperations:
    ...
    async def get(self, operation_id: str, scope: str, **kwargs: Any) -> _models.GenerateDetailedCostReportOperationStatuses:
        ...
        request = build_get_request(operation_id=operation_id, scope=scope, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
