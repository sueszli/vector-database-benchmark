...
if __name__ == '__main__':
    ...
    for profiling_enabled in [False, True]:
        print('Profiling {}, tensor size {}x{}, use cuda: {}, use kineto: {}, with stacks: {}, use script: {}'.format('enabled' if profiling_enabled else 'disabled', args.profiling_tensor_size, args.profiling_tensor_size, args.with_cuda, args.use_kineto, args.with_stack, args.use_script))
        ...
        t = Timer('payload()', globals={'payload': payload}, timer=timeit.default_timer).blocked_autorange(min_run_time=args.timer_min_run_time)
        print(t)