...
class HealthStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary('/grpc.health.v1.Health/Check', request_serializer=health__pb2.HealthCheckRequest.SerializeToString, response_deserializer=health__pb2.HealthCheckResponse.FromString)
        self.Watch = channel.unary_stream('/grpc.health.v1.Health/Watch', request_serializer=health__pb2.HealthCheckRequest.SerializeToString, response_deserializer=health__pb2.HealthCheckResponse.FromString)
