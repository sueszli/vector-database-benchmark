...
def create_key_rotation_schedule(project_id: str, location_id: str, key_ring_id: str, key_id: str) -> kms.CryptoKey:
    if False:
        i = 10
        return i + 15
    ...
    key = {'purpose': purpose, 'version_template': {'algorithm': algorithm}, 'rotation_period': {'seconds': 60 * 60 * 24 * 30}, 'next_rotation_time': {'seconds': int(time.time()) + 60 * 60 * 24}}
