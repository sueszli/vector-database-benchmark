...
class Lead2OpportunityPartner(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        return result
    name = fields.Selection([('convert', 'Convert to opportunity'), ('merge', 'Merge with existing opportunities')], 'Conversion Action', required=True)
...
class Lead2OpportunityMassConvert(models.TransientModel):
    ...
    action = fields.Selection([('each_exist_or_create', 'Use existing partner or create'), ('nothing', 'Do not link to a customer')], 'Related Customer', required=True)
