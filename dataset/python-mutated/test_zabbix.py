...
DEFINED_PARAMS = {'name': 'beta', 'eventsource': 2, 'status': 0, 'filter': {'evaltype': 2, 'conditions': [{'conditiontype': 24, 'operator': 2, 'value': 'db'}]}, 'operations': [{'operationtype': 2}, {'operationtype': 4, 'opgroup': [{'groupid': {'query_object': 'hostgroup', 'query_name': 'Databases'}}]}], 'empty_list': []}
SUBSTITUTED_DEFINED_PARAMS = {'status': '0', 'filter': {'evaltype': '2', 'conditions': [{'operator': '2', 'conditiontype': '24', 'value': 'db'}]}, 'eventsource': '2', 'name': 'beta', 'operations': [{'operationtype': '2'}, {'opgroup': [{'groupid': '11'}], 'operationtype': '4'}], 'empty_list': []}
EXISTING_OBJECT_PARAMS = {'status': '0', 'operations': [{'operationtype': '2', 'esc_period': '0', 'evaltype': '0', 'opconditions': [], 'esc_step_to': '1', 'actionid': '23', 'esc_step_from': '1', 'operationid': '64'}, {'operationtype': '4', 'esc_period': '0', 'evaltype': '0', 'opconditions': [], 'esc_step_to': '1', 'actionid': '23', 'esc_step_from': '1', 'opgroup': [{'groupid': '11', 'operationid': '65'}], 'operationid': '65'}], 'def_shortdata': '', 'name': 'beta', 'esc_period': '0', 'def_longdata': '', 'filter': {'formula': '', 'evaltype': '2', 'conditions': [{'operator': '2', 'conditiontype': '24', 'formulaid': 'A', 'value': 'DIFFERENT VALUE HERE'}], 'eval_formula': 'A'}, 'eventsource': '2', 'actionid': '23', 'r_shortdata': '', 'r_longdata': '', 'recovery_msg': '0', 'empty_list': [{'dict_key': 'dic_val'}]}
DIFF_PARAMS_RESULT = {'filter': {'evaltype': '2', 'conditions': [{'operator': '2', 'conditiontype': '24', 'value': 'db'}]}, 'empty_list': []}
DIFF_PARAMS_RESULT_WITH_ROLLBACK = {'new': DIFF_PARAMS_RESULT, 'old': {'filter': {'formula': '', 'evaltype': '2', 'conditions': [{'operator': '2', 'conditiontype': '24', 'formulaid': 'A', 'value': 'DIFFERENT VALUE HERE'}], 'eval_formula': 'A'}, 'empty_list': [{'dict_key': 'dic_val'}]}}
