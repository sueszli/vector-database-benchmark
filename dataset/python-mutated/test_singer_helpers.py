...
basic_singer_catalog = {'streams': [{'type': 'SCHEMA', 'stream': 'users', 'schema': {'properties': {'id': {'type': 'integer'}, 'name': {'type': 'string'}, 'updated_at': {'type': 'string', 'format': 'date-time'}}}, 'key_properties': ['id'], 'bookmark_properties': ['updated_at']}]}
