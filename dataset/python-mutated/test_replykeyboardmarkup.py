...
class TestReplyKeyboardMarkupWithRequest(TestReplyKeyboardMarkupBase):
    ...
    async def test_send_message_with_reply_keyboard_markup(self, bot, chat_id, reply_keyboard_markup):
    ...
    async def test_send_message_with_data_markup(self, bot, chat_id):
        message = await bot.send_message(chat_id, 'text 2', reply_markup={'keyboard': [['1', '2']]})
