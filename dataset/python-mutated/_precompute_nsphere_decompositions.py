...
from skimage.morphology.footprints import _t_shaped_element_series, footprint_from_sequence
...
if __name__ == '__main__':
    precompute_decompositions(ndims=[2, 3], radius_max_per_ndim={2: 250, 3: 100}, strict_radius=False)