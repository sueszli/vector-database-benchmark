...
async def serve(q: Q):
    ...
    if not q.client.initialized:
        q.page['curve'] = ui.graphics_card(box='1 1 4 6', view_box='0 0 300 300', width='100%', height='100%', scene=g.scene(hilbert_curve=g.path(d=hilbert_curve, fill='none', stroke='#333')))
        q.page['form'] = ui.form_card(box='1 7 4 1', items=[ui.slider(name='depth', label='Play with this Hilbert curve!', min=1, max=6, value=5, trigger=True)])
