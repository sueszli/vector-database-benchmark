...
class XGBoostFrontendConfig(FrontendConfig):
    ...
    invalid_devices = ('tpu',)
    valid_dtypes = ['int8', 'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32', 'uint64', 'float16', 'float32', 'float64', 'bool']
    invalid_dtypes = ['bfloat16', 'complex64', 'complex128']
    valid_numeric_dtypes = ['int8', 'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32', 'uint64', 'float16', 'float32', 'float64']
