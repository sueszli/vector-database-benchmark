...
from dagster_pandas.constraints import ColumnConstraint, ColumnConstraintViolationException, ColumnDTypeInSetConstraint
...
CustomTripDataFrame = create_dagster_pandas_dataframe_type(name='CustomTripDataFrame', columns=[PandasColumn('amount_paid', constraints=[ColumnDTypeInSetConstraint({'int64'}), DivisibleByFiveConstraint()])])
