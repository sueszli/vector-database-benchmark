...
from localstack.aws.api.stepfunctions import Arn, DescribeMapRunOutput, LongArn, MapRunExecutionCounts, MapRunItemCounts, MapRunListItem, MapRunStatus, Timestamp
...
class MapRunRecord:
    ...
    map_state_machine_arn: Final[LongArn]
