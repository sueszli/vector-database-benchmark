...
from airflow.providers.google.cloud.operators.bigquery_dts import BigQueryCreateDataTransferOperator, BigQueryDataTransferServiceStartTransferRunsOperator, BigQueryDeleteDataTransferConfigOperator
PROJECT_ID = 'id'
TRANSFER_CONFIG = {'data_source_id': 'google_cloud_storage', 'destination_dataset_id': 'example_dataset', 'params': {}, 'display_name': 'example-transfer', 'disabled': False, 'data_refresh_window_days': 0, 'schedule': 'first sunday of quarter 00:00'}
...
transfer_config = TransferConfig(name=TRANSFER_CONFIG_NAME, params={'secret_access_key': 'AIRFLOW_KEY', 'access_key_id': 'AIRFLOW_KEY_ID'})
