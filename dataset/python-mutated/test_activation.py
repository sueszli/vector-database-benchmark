...
if platform.system() == 'Linux':
    ...
    plat = 'win'
    running_os = 'win'
suffixes = {'cmd.exe': '.bat', 'bash': '.sh', 'zsh': '.sh', 'tcsh': '.csh', 'xonsh': '.sh', 'fish': '.fish', 'powershell': '.ps1', 'nu': '.nu'}
...
paths = {'win': WindowsProfiles(), 'osx': {'zsh': '~/.zshrc', 'bash': '~/.bash_profile', 'xonsh': '~/.xonshrc', 'tcsh': '~/.tcshrc', 'fish': '~/.config/fish/config.fish', 'nu': '~/.config/nushell/config.nu'}, 'linux': {'zsh': '~/.zshrc', 'bash': '~/.bashrc', 'xonsh': '~/.xonshrc', 'tcsh': '~/.tcshrc', 'fish': '~/.config/fish/config.fish', 'nu': '~/.config/nushell/config.nu'}}
...
def write_script(interpreter, lines, path):
    ...
    if plat == 'win':
        ...
        with open(fname, 'w') as fo:
            fo.write('\n'.join(lines) + '\n')
    return fname
possible_interpreters = {'win': {'powershell', 'cmd.exe', 'bash', 'nu'}, 'unix': {'bash', 'zsh', 'fish', 'xonsh', 'tcsh', 'nu'}}
