...
@testing.combinations(('lazy', True), ('nonlazy', False), argnames='lazy_relationship', id_='ia')
@testing.combinations(('redefine', True), ('noredefine', False), argnames='redefine_colprop', id_='ia')
@testing.combinations(('unions', True), ('unions', False), ('joins', False), ('auto', False), ('none', False), argnames='with_polymorphic,include_base', id_='rr')
