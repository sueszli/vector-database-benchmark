...
import proto
__protobuf__ = proto.module(package='google.cloud.securesourcemanager.v1', manifest={'Instance', 'Repository', 'ListInstancesRequest', 'ListInstancesResponse', 'GetInstanceRequest', 'CreateInstanceRequest', 'DeleteInstanceRequest', 'OperationMetadata', 'ListRepositoriesRequest', 'ListRepositoriesResponse', 'GetRepositoryRequest', 'CreateRepositoryRequest', 'DeleteRepositoryRequest'})
...
class Instance(proto.Message):
    ...
    class HostConfig(proto.Message):
        ...
        """
        html: str = proto.Field(proto.STRING, number=1)
        api: str = proto.Field(proto.STRING, number=2)
        git_http: str = proto.Field(proto.STRING, number=3)
        git_ssh: str = proto.Field(proto.STRING, number=4)
    ...
    state_note: StateNote = proto.Field(proto.ENUM, number=10, enum=StateNote)
    kms_key: str = proto.Field(proto.STRING, number=11)
    host_config: HostConfig = proto.Field(proto.MESSAGE, number=9, message=HostConfig)
...
class Repository(proto.Message):
    ...
    class URIs(proto.Message):
        ...
        """
        html: str = proto.Field(proto.STRING, number=1)
        git_https: str = proto.Field(proto.STRING, number=2)
        api: str = proto.Field(proto.STRING, number=3)
    ...
    class InitialConfig(proto.Message):
        ...
        """
        default_branch: str = proto.Field(proto.STRING, number=1)
        gitignores: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        license_: str = proto.Field(proto.STRING, number=3)
        readme: str = proto.Field(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=2)
    instance: str = proto.Field(proto.STRING, number=3)
    uid: str = proto.Field(proto.STRING, number=4)
    ...
    uris: URIs = proto.Field(proto.MESSAGE, number=9, message=URIs)
    initial_config: InitialConfig = proto.Field(proto.MESSAGE, number=10, message=InitialConfig)
...
class CreateInstanceRequest(proto.Message):
    """CreateInstanceRequest is the request for creating an
    instance.
...
class DeleteInstanceRequest(proto.Message):
    """DeleteInstanceRequest is the request for deleting an
    instance.
...
class ListRepositoriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    repositories: MutableSequence['Repository'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Repository')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateRepositoryRequest(proto.Message):
    """CreateRepositoryRequest is the request for creating a
    repository.
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    repository: 'Repository' = proto.Field(proto.MESSAGE, number=2, message='Repository')
    repository_id: str = proto.Field(proto.STRING, number=3)

class DeleteRepositoryRequest(proto.Message):
    """DeleteRepositoryRequest is the request to delete a
    repository.
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    allow_missing: bool = proto.Field(proto.BOOL, number=2)
