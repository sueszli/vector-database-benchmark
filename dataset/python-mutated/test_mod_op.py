...
class TestModOpBase(TestCaseHelper):
    inputs = [{'x_shape': [32], 'y_shape': [32]}, {'x_shape': [32, 64], 'y_shape': [32, 64]}, {'x_shape': [2, 3, 4], 'y_shape': [2, 3, 4]}, {'x_shape': [16, 8, 4, 2], 'y_shape': [16, 8, 4, 2]}, {'x_shape': [16, 8, 4, 2, 1], 'y_shape': [16, 8, 4, 2, 1]}]
    dtypes = [{'x_dtype': 'float32', 'y_dtype': 'float32'}]
    attrs = [{'x_low': -100, 'x_high': 100, 'y_low': -100, 'y_high': 100}]
...
class TestModOpDtypeTest(TestModOpBase):
    ...
    def init_attrs(self):
        ...
        self.cls = TestModOp
        self.dtypes = [{'x_dtype': 'float16', 'y_dtype': 'float16', 'max_relative_error': 0.001}, {'x_dtype': 'int32', 'y_dtype': 'int32'}, {'x_dtype': 'int64', 'y_dtype': 'int64'}, {'x_dtype': 'float32', 'y_dtype': 'float32'}, {'x_dtype': 'float64', 'y_dtype': 'float64'}]
...
class TestModOpPolarityTest(TestModOpBase):
    ...
    def init_attrs(self):
        ...
        self.cls = TestModOp
        self.attrs = [{'x_low': -100, 'x_high': 100, 'y_low': -100, 'y_high': -1}, {'x_low': -100, 'x_high': 100, 'y_low': 1, 'y_high': 100}]
