...
__all__ = ['SpaceViewComponent', 'SpaceViewComponentArrayLike', 'SpaceViewComponentBatch', 'SpaceViewComponentLike', 'SpaceViewComponentType']
...
SpaceViewComponentArrayLike = Union[SpaceViewComponent, Sequence[SpaceViewComponentLike]]
