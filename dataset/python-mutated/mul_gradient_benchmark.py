...
if __name__ == '__main__':
    ...
    parser.add_argument('--inplace', action='store_true', help='Whether to perform the op in-place.')
    parser.add_argument('--allow-broadcast-fastpath', action='store_true', help='Whether the broadcast fastpath is enabled.')
