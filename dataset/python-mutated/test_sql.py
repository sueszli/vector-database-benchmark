...
from airflow.providers.openlineage.utils.sql import create_filter_clauses, create_information_schema_query, get_table_schemas
...
DB_TABLE_COLUMNS = [DbColumn(name='ID', type='int4', ordinal_position=1), DbColumn(name='AMOUNT_OFF', type='int4', ordinal_position=2), DbColumn(name='CUSTOMER_EMAIL', type='varchar', ordinal_position=3), DbColumn(name='STARTS_ON', type='timestamp', ordinal_position=4), DbColumn(name='ENDS_ON', type='timestamp', ordinal_position=5)]
DB_TABLE_SCHEMA = DbTableSchema(schema_name=DB_SCHEMA_NAME, table_name=DB_TABLE_NAME, columns=DB_TABLE_COLUMNS)
SCHEMA_FACET = SchemaDatasetFacet(fields=[SchemaField(name='ID', type='int4'), SchemaField(name='AMOUNT_OFF', type='int4'), SchemaField(name='CUSTOMER_EMAIL', type='varchar'), SchemaField(name='STARTS_ON', type='timestamp'), SchemaField(name='ENDS_ON', type='timestamp')])
