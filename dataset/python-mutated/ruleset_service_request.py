...
__protobuf__ = proto.module(package='google.cloud.contentwarehouse.v1', manifest={'CreateRuleSetRequest', 'GetRuleSetRequest', 'UpdateRuleSetRequest', 'DeleteRuleSetRequest', 'ListRuleSetsRequest', 'ListRuleSetsResponse'})
...
class CreateRuleSetRequest(proto.Message):
    ...
    rule_set: rule_engine.RuleSet = proto.Field(proto.MESSAGE, number=2, message=rule_engine.RuleSet)
...
class ListRuleSetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    rule_sets: MutableSequence[rule_engine.RuleSet] = proto.RepeatedField(proto.MESSAGE, number=1, message=rule_engine.RuleSet)
