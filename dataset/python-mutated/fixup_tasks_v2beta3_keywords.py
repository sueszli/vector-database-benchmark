...
class tasksCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'buffer_task': ('queue', 'task_id', 'body'), 'create_queue': ('parent', 'queue'), 'create_task': ('parent', 'task', 'response_view'), 'delete_queue': ('name',), 'delete_task': ('name',), 'get_iam_policy': ('resource', 'options'), 'get_queue': ('name', 'read_mask'), 'get_task': ('name', 'response_view'), 'list_queues': ('parent', 'filter', 'page_size', 'page_token', 'read_mask'), 'list_tasks': ('parent', 'response_view', 'page_size', 'page_token'), 'pause_queue': ('name',), 'purge_queue': ('name',), 'resume_queue': ('name',), 'run_task': ('name', 'response_view'), 'set_iam_policy': ('resource', 'policy', 'update_mask'), 'test_iam_permissions': ('resource', 'permissions'), 'update_queue': ('queue', 'update_mask')}
