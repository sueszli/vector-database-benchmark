...
def main():
    ...
    response = client.provider_share_subscriptions.get_by_share(resource_group_name='SampleResourceGroup', account_name='Account1', share_name='Share1', provider_share_subscription_id='4256e2cf-0f82-4865-961b-12f83333f487')
    print(response)
