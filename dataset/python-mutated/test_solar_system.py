...
from astropy.coordinates.solar_system import BODY_NAME_TO_KERNEL_SPEC, _get_apparent_body_position, get_body, get_body_barycentric, get_body_barycentric_posvel, get_moon, solar_system_ephemeris
...
KITT_PEAK = EarthLocation.from_geodetic(lon=-111.6 * u.deg, lat=31.963333333333342 * u.deg, height=2120 * u.m)
