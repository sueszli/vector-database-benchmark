...
class AbstractOnboardingTask(Model):
    ...
    STATUS_CHOICES = ((OnboardingTaskStatus.COMPLETE, 'complete'), (OnboardingTaskStatus.PENDING, 'pending'), (OnboardingTaskStatus.SKIPPED, 'skipped'))
...
class OrganizationOnboardingTask(AbstractOnboardingTask):
    ...
    REQUIRED_ONBOARDING_TASKS = frozenset([OnboardingTask.FIRST_PROJECT, OnboardingTask.FIRST_EVENT, OnboardingTask.INVITE_MEMBER, OnboardingTask.SECOND_PLATFORM, OnboardingTask.USER_CONTEXT, OnboardingTask.RELEASE_TRACKING, OnboardingTask.SOURCEMAPS, OnboardingTask.ISSUE_TRACKER, OnboardingTask.ALERT_RULE, OnboardingTask.FIRST_TRANSACTION, OnboardingTask.METRIC_ALERT, OnboardingTask.INTEGRATIONS, OnboardingTask.SESSION_REPLAY])
    SKIPPABLE_TASKS = frozenset([OnboardingTask.INVITE_MEMBER, OnboardingTask.SECOND_PLATFORM, OnboardingTask.USER_CONTEXT, OnboardingTask.RELEASE_TRACKING, OnboardingTask.SOURCEMAPS, OnboardingTask.USER_REPORTS, OnboardingTask.ISSUE_TRACKER, OnboardingTask.ALERT_RULE, OnboardingTask.FIRST_TRANSACTION, OnboardingTask.METRIC_ALERT, OnboardingTask.INTEGRATIONS, OnboardingTask.SESSION_REPLAY])
