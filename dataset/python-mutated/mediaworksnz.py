...
class MediaWorksNZVODIE(InfoExtractor):
    _VALID_URL_BASE_RE = 'https?://vodupload-api\\.mediaworks\\.nz/library/asset/published/'
    _VALID_URL_ID_RE = '(?P<id>[A-Za-z0-9-]+)'
    _VALID_URL = f'{_VALID_URL_BASE_RE}{_VALID_URL_ID_RE}'
    _TESTS = [{'url': 'https://vodupload-api.mediaworks.nz/library/asset/published/VID00359', 'info_dict': {'id': 'VID00359', 'ext': 'mp4', 'title': 'GRG Jacinda Ardern safe drug testing 1920x1080', 'description': 'md5:d4d7dc366742e86d8130b257dcb520ba', 'duration': 142.76, 'timestamp': 1604268608, 'upload_date': '20201101', 'thumbnail': 're:^https?://.*\\.jpg$', 'channel': 'George FM'}}, {'url': 'https://vodupload-api.mediaworks.nz/library/asset/published/VID02627', 'info_dict': {'id': 'VID02627', 'ext': 'mp3', 'title': "Tova O'Brien meets Ukraine President Volodymyr Zelensky", 'channel': 'Today FM', 'description': 'Watch in full the much anticipated interview of Volodymyr Zelensky', 'duration': 2061.16, 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20220822', 'timestamp': 1661152289}, 'params': {'format': 'ba[ext=mp3]'}}]
    _WEBPAGE_TESTS = [{'url': 'https://www.rova.nz/home/podcasts/socrates-walks-into-a-bar/the-trolley-problem---episode-1.html', 'info_dict': {'id': 'VID02494', 'ext': 'mp4', 'title': 'The Trolley Problem', 'duration': 2843.56, 'channel': 'Other', 'timestamp': 1658356489, 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'Socrates Walks Into A Bar Podcast Episode 1', 'upload_date': '20220720'}}]
