...
import cv2
import numpy as np
from opensfm import log, matching, multiview, pybundle, pygeometry, pymap, pysfm, reconstruction_helpers as helpers, rig, tracking, types
...
def pairwise_reconstructability(common_tracks: int, rotation_inliers: int) -> float:
    ...
    if outlier_ratio >= 0.3:
        ...
        return 0
TPairArguments = Tuple[str, str, np.ndarray, np.ndarray, pygeometry.Camera, pygeometry.Camera, float]
