...
def main():
    ...
    response = client.jobs.begin_create(resource_group_name='YourResourceGroupName', job_name='TestJobName1', job_resource={'identity': {'type': 'UserAssigned', 'userAssignedIdentities': {'/subscriptions/YourSubscriptionId/resourceGroups/YourResourceGroupName/providers/Microsoft.ManagedIdentity/userAssignedIdentities/testIdentity': {}}}, 'location': 'westus', 'properties': {'details': {'contactDetails': {'contactName': 'XXXX XXXX', 'emailList': ['xxxx@xxxx.xxx'], 'phone': '0000000000', 'phoneExtension': ''}, 'dataImportDetails': [{'accountDetails': {'dataAccountType': 'StorageAccount', 'storageAccountId': '/subscriptions/YourSubscriptionId/resourceGroups/YourResourceGroupName/providers/Microsoft.Storage/storageAccounts/YourStorageAccountName'}}], 'jobDetailsType': 'DataBox', 'shippingAddress': {'addressType': 'Commercial', 'city': 'XXXX XXXX', 'companyName': 'XXXX XXXX', 'country': 'XX', 'postalCode': '00000', 'stateOrProvince': 'XX', 'streetAddress1': 'XXXX XXXX', 'streetAddress2': 'XXXX XXXX'}}, 'transferType': 'ImportToAzure'}, 'sku': {'name': 'DataBox'}}).result()
    print(response)
