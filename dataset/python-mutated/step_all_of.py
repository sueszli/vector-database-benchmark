...
class StepAllOf(BaseModel):
    ...
    additional_output: Optional[Any] = Field(None, description='Output that the task step has produced. Any value is allowed.')
    ...
    __properties = ['task_id', 'step_id', 'name', 'status', 'output', 'additional_output', 'artifacts', 'is_last']
