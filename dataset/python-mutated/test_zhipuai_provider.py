...
VALIDATE_CREDENTIAL = {'api_key': 'valid_key'}
...
def test_is_provider_credentials_valid_or_raise_valid(mocker):
    if False:
        while True:
            i = 10
    mocker.patch('core.third_party.langchain.llms.zhipuai_llm.ZhipuAIChatLLM._generate', return_value=ChatResult(generations=[ChatGeneration(message=AIMessage(content='abc'))]))
