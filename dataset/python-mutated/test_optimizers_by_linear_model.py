...
_inject_backend_tests = backend.inject_backend_tests(['test_linear_model'], testing.product({'use_cuda': [False], 'use_ideep': ['never', 'always']}) + [{'use_cuda': True}] + [{'use_chainerx': True, 'chainerx_device': 'native:0'}, {'use_chainerx': True, 'chainerx_device': 'cuda:0'}])
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'use_placeholder': [False, True], 'loss_scaling': [False, 'static', 'dynamic']}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'use_placeholder': [False, True], 'loss_scaling': [False, 'static', 'dynamic'], 'amsgrad': [False, True], 'adabound': [False, True]}))
@_inject_backend_tests
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'use_placeholder': [False, True], 'eps_inside_sqrt': [False, True], 'loss_scaling': [False, 'static', 'dynamic']}))
@_inject_backend_tests
