...
from graphql.language import BooleanValueNode, DefinitionNode, FieldNode, FloatValueNode, FragmentDefinitionNode, FragmentSpreadNode, InlineFragmentNode, IntValueNode, ListValueNode, Node, ObjectValueNode, OperationDefinitionNode, StringValueNode, ValueNode
...
FieldArgumentType = Union[bool, int, float, str, List['FieldArgumentType'], Dict[str, 'FieldArgumentType']]
