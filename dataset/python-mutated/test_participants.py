...
from sentry.notifications.types import ActionTargetType, FallthroughChoiceType, NotificationSettingOptionValues, NotificationSettingTypes
from sentry.notifications.utils.participants import FALLTHROUGH_NOTIFICATION_LIMIT, get_fallthrough_recipients, get_owner_reason, get_owners, get_send_to
...
STACKTRACE = {'frames': [{'function': 'handledError', 'abs_path': 'Application.java', 'module': 'io.sentry.example.Application', 'in_app': True, 'lineno': 39, 'filename': 'Application.java'}]}
