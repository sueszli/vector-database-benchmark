...
from kams_erp.models.kamserp_config import SUBIEKT_DATABASE_CONNECTOR, SUBIEKT_DATABASE_USER, SUBIEKT_DATABASE_PASSWORD, SUBIEKT_DATABASE_ADDRESS, SUBIEKT_DATABASE_DATABASE_NAME, SUBIEKT_DATABASE_PORT, SUBIEKT_DATABASE_DRIVER, ODOO_DATABASE_ADDRESS, ODOO_PORT, ODOO_DATABASE_CONNECTOR
...
class InstallKamsERP_Configuration(object):
    ...
    def __init__(self):
        ...
        dbobject = DatabaseConnector(connector=SUBIEKT_DATABASE_CONNECTOR, user=SUBIEKT_DATABASE_USER, password=SUBIEKT_DATABASE_PASSWORD, host=SUBIEKT_DATABASE_ADDRESS + ':' + SUBIEKT_DATABASE_PORT, dbname=SUBIEKT_DATABASE_DATABASE_NAME, driver=SUBIEKT_DATABASE_DRIVER, charset=None)
