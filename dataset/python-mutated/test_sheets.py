...
_columns = [Mock(id='1101932201830276', title='id', type='TEXT_NUMBER'), Mock(id='5605531829200772', title='first_name', type='TEXT_NUMBER'), Mock(id='3353732015515524', title='last_name', type='TEXT_NUMBER')]
_cells = [Mock(column_id='1101932201830276', value='11'), Mock(column_id='5605531829200772', value='Leonardo'), Mock(column_id='3353732015515524', value='Dicaprio')]
