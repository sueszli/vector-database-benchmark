...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0126_fix_funnels_insights_links')]
    operations = [migrations.RunPython(adjust_teams_for_stricter_requirements, migrations.RunPython.noop, elidable=True)]