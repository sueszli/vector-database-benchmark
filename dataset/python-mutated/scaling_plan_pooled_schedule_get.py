...
def main():
    ...
    response = client.scaling_plan_pooled_schedules.get(resource_group_name='resourceGroup1', scaling_plan_name='scalingPlan1', scaling_plan_schedule_name='scalingPlanScheduleWeekdays1')
    print(response)
