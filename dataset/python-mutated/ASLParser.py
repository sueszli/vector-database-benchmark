...
class ASLParser(Parser):
    ...
    RULE_state_name = 6
    RULE_state_decl = 7
    RULE_state_decl_body = 8
    RULE_type_decl = 9
    RULE_next_decl = 10
    RULE_resource_decl = 11
    RULE_input_path_decl = 12
    RULE_result_decl = 13
    RULE_result_path_decl = 14
    RULE_output_path_decl = 15
    RULE_end_decl = 16
    RULE_default_decl = 17
    RULE_error_decl = 18
    RULE_cause_decl = 19
    RULE_seconds_decl = 20
    RULE_seconds_path_decl = 21
    RULE_timestamp_decl = 22
    RULE_timestamp_path_decl = 23
    RULE_items_path_decl = 24
    RULE_max_concurrency_decl = 25
    RULE_parameters_decl = 26
    RULE_timeout_seconds_decl = 27
    RULE_timeout_seconds_path_decl = 28
    RULE_heartbeat_seconds_decl = 29
    RULE_heartbeat_seconds_path_decl = 30
    RULE_payload_tmpl_decl = 31
    RULE_payload_binding = 32
    RULE_intrinsic_func = 33
    RULE_payload_arr_decl = 34
    RULE_payload_value_decl = 35
    RULE_payload_value_lit = 36
    RULE_result_selector_decl = 37
    RULE_state_type = 38
    RULE_choices_decl = 39
    RULE_choice_rule = 40
    RULE_comparison_variable_stmt = 41
    RULE_comparison_composite_stmt = 42
    RULE_comparison_composite = 43
    RULE_variable_decl = 44
    RULE_comparison_func = 45
    RULE_branches_decl = 46
    RULE_item_processor_decl = 47
    RULE_item_processor_item = 48
    RULE_processor_config_decl = 49
    RULE_processor_config_field = 50
    RULE_mode_decl = 51
    RULE_mode_type = 52
    RULE_execution_decl = 53
    RULE_execution_type = 54
    RULE_iterator_decl = 55
    RULE_iterator_decl_item = 56
    RULE_item_selector_decl = 57
    RULE_item_reader_decl = 58
    RULE_items_reader_field = 59
    RULE_reader_config_decl = 60
    RULE_reader_config_field = 61
    RULE_input_type_decl = 62
    RULE_csv_header_location_decl = 63
    RULE_csv_headers_decl = 64
    RULE_max_items_decl = 65
    RULE_max_items_path_decl = 66
    RULE_retry_decl = 67
    RULE_retrier_decl = 68
    RULE_retrier_stmt = 69
    RULE_error_equals_decl = 70
    RULE_interval_seconds_decl = 71
    RULE_max_attempts_decl = 72
    RULE_backoff_rate_decl = 73
    RULE_catch_decl = 74
    RULE_catcher_decl = 75
    RULE_catcher_stmt = 76
    RULE_comparison_op = 77
    RULE_choice_operator = 78
    RULE_states_error_name = 79
    RULE_error_name = 80
    RULE_json_obj_decl = 81
    RULE_json_binding = 82
    RULE_json_arr_decl = 83
    RULE_json_value_decl = 84
    RULE_keyword_or_string = 85
    ruleNames = ['program_decl', 'top_layer_stmt', 'startat_decl', 'comment_decl', 'state_stmt', 'states_decl', 'state_name', 'state_decl', 'state_decl_body', 'type_decl', 'next_decl', 'resource_decl', 'input_path_decl', 'result_decl', 'result_path_decl', 'output_path_decl', 'end_decl', 'default_decl', 'error_decl', 'cause_decl', 'seconds_decl', 'seconds_path_decl', 'timestamp_decl', 'timestamp_path_decl', 'items_path_decl', 'max_concurrency_decl', 'parameters_decl', 'timeout_seconds_decl', 'timeout_seconds_path_decl', 'heartbeat_seconds_decl', 'heartbeat_seconds_path_decl', 'payload_tmpl_decl', 'payload_binding', 'intrinsic_func', 'payload_arr_decl', 'payload_value_decl', 'payload_value_lit', 'result_selector_decl', 'state_type', 'choices_decl', 'choice_rule', 'comparison_variable_stmt', 'comparison_composite_stmt', 'comparison_composite', 'variable_decl', 'comparison_func', 'branches_decl', 'item_processor_decl', 'item_processor_item', 'processor_config_decl', 'processor_config_field', 'mode_decl', 'mode_type', 'execution_decl', 'execution_type', 'iterator_decl', 'iterator_decl_item', 'item_selector_decl', 'item_reader_decl', 'items_reader_field', 'reader_config_decl', 'reader_config_field', 'input_type_decl', 'csv_header_location_decl', 'csv_headers_decl', 'max_items_decl', 'max_items_path_decl', 'retry_decl', 'retrier_decl', 'retrier_stmt', 'error_equals_decl', 'interval_seconds_decl', 'max_attempts_decl', 'backoff_rate_decl', 'catch_decl', 'catcher_decl', 'catcher_stmt', 'comparison_op', 'choice_operator', 'states_error_name', 'error_name', 'json_obj_decl', 'json_binding', 'json_arr_decl', 'json_value_decl', 'keyword_or_string']
    EOF = Token.EOF
    COMMA = 1
    COLON = 2
    LBRACK = 3
    ...
    NOT = 36
    NUMERICEQUALS = 37
    NUMERICEQUALSPATH = 38
    NUMERICGREATERTHAN = 39
    NUMERICGREATERTHANPATH = 40
    NUMERICGREATERTHANEQUALS = 41
    NUMERICGREATERTHANEQUALSPATH = 42
    NUMERICLESSTHAN = 43
    NUMERICLESSTHANPATH = 44
    NUMERICLESSTHANEQUALS = 45
    NUMERICLESSTHANEQUALSPATH = 46
    OR = 47
    STRINGEQUALS = 48
    STRINGEQUALSPATH = 49
    STRINGGREATERTHAN = 50
    STRINGGREATERTHANPATH = 51
    STRINGGREATERTHANEQUALS = 52
    STRINGGREATERTHANEQUALSPATH = 53
    STRINGLESSTHAN = 54
    STRINGLESSTHANPATH = 55
    STRINGLESSTHANEQUALS = 56
    STRINGLESSTHANEQUALSPATH = 57
    STRINGMATCHES = 58
    TIMESTAMPEQUALS = 59
    TIMESTAMPEQUALSPATH = 60
    TIMESTAMPGREATERTHAN = 61
    TIMESTAMPGREATERTHANPATH = 62
    TIMESTAMPGREATERTHANEQUALS = 63
    TIMESTAMPGREATERTHANEQUALSPATH = 64
    TIMESTAMPLESSTHAN = 65
    TIMESTAMPLESSTHANPATH = 66
    TIMESTAMPLESSTHANEQUALS = 67
    TIMESTAMPLESSTHANEQUALSPATH = 68
    SECONDSPATH = 69
    SECONDS = 70
    TIMESTAMPPATH = 71
    TIMESTAMP = 72
    ...
    BACKOFFRATE = 110
    CATCH = 111
    ERRORNAMEStatesALL = 112
    ERRORNAMEStatesHeartbeatTimeout = 113
    ERRORNAMEStatesTimeout = 114
    ERRORNAMEStatesTaskFailed = 115
    ERRORNAMEStatesPermissions = 116
    ERRORNAMEStatesResultPathMatchFailure = 117
    ERRORNAMEStatesParameterPathFailure = 118
    ERRORNAMEStatesBranchFailed = 119
    ERRORNAMEStatesNoChoiceMatched = 120
    ERRORNAMEStatesIntrinsicFailure = 121
    ERRORNAMEStatesExceedToleratedFailureThreshold = 122
    ERRORNAMEStatesItemReaderFailed = 123
    ERRORNAMEStatesResultWriterFailed = 124
    ERRORNAMEStatesRuntime = 125
    STRINGDOLLAR = 126
    STRINGPATHCONTEXTOBJ = 127
    STRINGPATH = 128
    STRING = 129
    INT = 130
    NUMBER = 131
