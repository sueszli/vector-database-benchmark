...
g0 = p0.circle(x0, y0, radius=r0, fill_color=transform('radius', mapper), fill_alpha=0.6, line_color=None)
mapper.domain.append((g0, 'radius'))
p1 = figure(width=500, height=500, tooltips=tooltips, tools=tools)
(x1, y1, r1) = data_flat(1.0)
g1 = p1.circle(x1, y1, radius=r1, fill_color=transform('radius', mapper), fill_alpha=0.6, line_color=None)
mapper.domain.append((g1, 'radius'))
p2 = figure(width=500, height=500, tooltips=tooltips, tools=tools)
(x2, y2, r2) = data_flat(1.2)
g2 = p2.circle(x2, y2, radius=r2, fill_color=transform('radius', mapper), fill_alpha=0.6, line_color=None)
mapper.domain.append((g2, 'radius'))
p3 = figure(width=500, height=500, tooltips=tooltips, tools=tools)
(x3, y3, r3) = data_sloped()
g3 = p3.circle(x3, y3, radius=r3, fill_color=transform('radius', mapper), fill_alpha=0.6, line_color=None)
