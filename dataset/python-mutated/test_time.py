...
from mycroft.util.time import default_timezone, now_local, now_utc, to_utc, to_local, to_system
test_config = {'location': {'timezone': {'code': 'America/Chicago', 'name': 'Central Standard Time', 'dstOffset': 3600000, 'offset': -21600000}}}
