...
wpf_samples_folder = os.path.join(os.path.dirname(__file__), '..\\..\\apps\\WPF_samples')
if is_x64_Python():
...
winforms_folder = os.path.join(os.path.dirname(__file__), '..\\..\\apps\\WinForms_samples')
if is_x64_Python():
...
if sys.version_info[:2] >= (3, 6):
    qt_python_folder = os.path.join(os.path.dirname(__file__), '..\\..\\apps\\Qt_Python_samples')
