...
class FileCodePointer(NamedTuple('_FileCodePointer', [('python_file', str), ('fn_name', str), ('working_directory', Optional[str])]), CodePointer):
...
@whitelist_for_serdes
class ModuleCodePointer(NamedTuple('_ModuleCodePointer', [('module', str), ('fn_name', str), ('working_directory', Optional[str])]), CodePointer):
...
@whitelist_for_serdes
class PackageCodePointer(NamedTuple('_PackageCodePointer', [('module', str), ('attribute', str), ('working_directory', Optional[str])]), CodePointer):
...
@whitelist_for_serdes
class CustomPointer(NamedTuple('_CustomPointer', [('reconstructor_pointer', ModuleCodePointer), ('reconstructable_args', Sequence[object]), ('reconstructable_kwargs', Sequence[Sequence])]), CodePointer):
