...
__protobuf__ = proto.module(package='google.monitoring.v3', manifest={'ListUptimeCheckConfigsRequest', 'ListUptimeCheckConfigsResponse', 'GetUptimeCheckConfigRequest', 'CreateUptimeCheckConfigRequest', 'UpdateUptimeCheckConfigRequest', 'DeleteUptimeCheckConfigRequest', 'ListUptimeCheckIpsRequest', 'ListUptimeCheckIpsResponse'})
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    uptime_check_configs: MutableSequence[uptime.UptimeCheckConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=uptime.UptimeCheckConfig)
...
class CreateUptimeCheckConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    uptime_check_config: uptime.UptimeCheckConfig = proto.Field(proto.MESSAGE, number=2, message=uptime.UptimeCheckConfig)
...
class UpdateUptimeCheckConfigRequest(proto.Message):
    ...
    uptime_check_config: uptime.UptimeCheckConfig = proto.Field(proto.MESSAGE, number=3, message=uptime.UptimeCheckConfig)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    uptime_check_ips: MutableSequence[uptime.UptimeCheckIp] = proto.RepeatedField(proto.MESSAGE, number=1, message=uptime.UptimeCheckIp)
    next_page_token: str = proto.Field(proto.STRING, number=2)
