...
class JojIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe\\b[^>]+\\bsrc=(["\\\'])(?P<url>(?:https?:)?//media\\.joj\\.sk/embed/(?:(?!\\1).)+)\\1']
    _TESTS = [{'url': 'https://media.joj.sk/embed/a388ec4c-6019-4a4a-9312-b1bee194e932', 'info_dict': {'id': 'a388ec4c-6019-4a4a-9312-b1bee194e932', 'ext': 'mp4', 'title': 'NOVÉ BÝVANIE', 'thumbnail': 're:^https?://.*?$', 'duration': 3118}}, {'url': 'https://media.joj.sk/embed/CSM0Na0l0p1', 'info_dict': {'id': 'CSM0Na0l0p1', 'ext': 'mp4', 'height': 576, 'title': 'Extrémne rodiny 2 - POKRAČOVANIE (2012/04/09 21:30:00)', 'duration': 3937, 'thumbnail': 're:^https?://.*?$'}}, {'url': 'https://media.joj.sk/embed/9i1cxv', 'only_matching': True}, {'url': 'joj:a388ec4c-6019-4a4a-9312-b1bee194e932', 'only_matching': True}, {'url': 'joj:9i1cxv', 'only_matching': True}]
