...
class TestLinearShift(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extension = extensions.LinearShift('x', self.value_range, self.time_range, self.optimizer)
        self.interval = 2
    ...
    def test_basic(self):
        if False:
            return 10
        self.optimizer.x = 0
        extension = extensions.LinearShift('x', self.value_range, self.time_range)
    ...
    def test_with_optimizer(self):
        ...
        optimizer = mock.Mock()
        optimizer.x = 0
        extension = extensions.LinearShift('x', self.value_range, self.time_range, optimizer)
    ...
    def test_resume(self):
        ...
        new_extension = extensions.LinearShift('x', self.value_range, self.time_range, new_optimizer)
