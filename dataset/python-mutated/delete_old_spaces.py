...
if __name__ == '__main__':
    ...
    parser.add_argument('n_days', type=int, help='Spaces older than n_days will be automatically deleted')
    parser.add_argument('org_name', type=str, help='Name of the author/org to search in')
