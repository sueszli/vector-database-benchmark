...
import AnyQt.QtWebEngineWidgets
...
if __name__ == '__main__':
    ...
    parser.add_option('--url-prefix', dest='prefix', help='prefix to prepend to image urls')
    parser.add_option('--output', dest='output', help='path where widgets.json will be created')
