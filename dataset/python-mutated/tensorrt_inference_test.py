...
SINGLE_FEATURE_EXAMPLES = [np.array(1, dtype=np.float32), np.array(5, dtype=np.float32), np.array(-3, dtype=np.float32), np.array(10.0, dtype=np.float32)]
SINGLE_FEATURE_PREDICTIONS = [PredictionResult(ex, pred) for (ex, pred) in zip(SINGLE_FEATURE_EXAMPLES, [[np.array([example * 2.0 + 0.5], dtype=np.float32)] for example in SINGLE_FEATURE_EXAMPLES])]
...
TWO_FEATURES_EXAMPLES = [np.array([1, 5], dtype=np.float32), np.array([3, 10], dtype=np.float32), np.array([-14, 0], dtype=np.float32), np.array([0.5, 0.5], dtype=np.float32)]
TWO_FEATURES_PREDICTIONS = [PredictionResult(ex, pred) for (ex, pred) in zip(TWO_FEATURES_EXAMPLES, [[np.array([example[0] * 2.0 + example[1] * 3 + 0.5], dtype=np.float32)] for example in TWO_FEATURES_EXAMPLES])]
