...
_VALID_PLACEHOLDER_VARIANTS_ORDERED: list[PlaceholderVariant] = ['default', 'size', 'text']
_VALID_PLACEHOLDER_VARIANTS: set[PlaceholderVariant] = set(_VALID_PLACEHOLDER_VARIANTS_ORDERED)
_PLACEHOLDER_BACKGROUND_COLORS = ['#881177', '#aa3355', '#cc6666', '#ee9944', '#eedd00', '#99dd55', '#44dd88', '#22ccbb', '#00bbcc', '#0099cc', '#3366bb', '#663399']
