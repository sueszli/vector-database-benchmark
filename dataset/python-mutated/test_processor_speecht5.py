...
class SpeechT5ProcessorTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        feature_extractor_map = {'feature_size': 1, 'padding_value': 0.0, 'sampling_rate': 16000, 'do_normalize': False, 'num_mel_bins': 80, 'hop_length': 16, 'win_length': 64, 'win_function': 'hann_window', 'fmin': 80, 'fmax': 7600, 'mel_floor': 1e-10, 'reduction_factor': 2, 'return_attention_mask': True}
    ...
    def test_save_load_pretrained_additional_features(self):
        ...
        processor = SpeechT5Processor.from_pretrained(self.tmpdirname, bos_token='(BOS)', eos_token='(EOS)', do_normalize=False, padding_value=1.0)
