...
from readthedocs.core.unresolver import InvalidCustomDomainError, InvalidExternalDomainError, InvalidExternalVersionError, InvalidPathForVersionedProjectError, InvalidSchemeError, SuspiciousHostnameError, TranslationNotFoundError, TranslationWithoutVersionError, VersionNotFoundError, unresolve
from readthedocs.projects.models import Domain
from readthedocs.rtd_tests.tests.test_resolver import ResolverBase

@override_settings(PUBLIC_DOMAIN='readthedocs.io', RTD_EXTERNAL_VERSION_DOMAIN='dev.readthedocs.build')
@pytest.mark.proxito
