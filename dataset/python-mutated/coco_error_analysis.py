...
import fire
import numpy as np
COLOR_PALETTE = np.vstack([np.array([0.8, 0.8, 0.8]), np.array([0.6, 0.6, 0.6]), np.array([0.31, 0.51, 0.74]), np.array([0.75, 0.31, 0.3]), np.array([0.36, 0.9, 0.38]), np.array([0.5, 0.39, 0.64]), np.array([1, 0.6, 0])])
