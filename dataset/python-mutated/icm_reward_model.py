...
class ICMRewardModel(BaseRewardModel):
    ...
    Interface:
        ``estimate``, ``train``, ``collect_data``, ``clear_data``,             ``__init__``, ``_train``, ``load_state_dict``, ``state_dict``
    Config:
        == ====================  ========   =============  ====================================  =======================
        ...
        == ====================  ========   =============  ====================================  =======================
    """
    config = dict(type='icm', intrinsic_reward_type='add', learning_rate=0.001, obs_shape=6, action_shape=7, batch_size=64, hidden_size_list=[64, 64, 128], update_per_collect=100, reverse_scale=1, intrinsic_reward_weight=0.003, extrinsic_reward_norm=True, extrinsic_reward_norm_max=1, clear_buffer_per_iters=100)
