...
MB = 1024 * 1024
CONFIG_ATTRS = ('multipart_threshold', 'multipart_chunksize', 'max_concurrency', 'use_threads')
...
if __name__ == '__main__':
    try:
        ...
        print(error)
        print('To run this example, you must have valid credentials in a shared credential file or set in environment variables.')