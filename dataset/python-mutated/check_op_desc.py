...
DEF = 'def'
error = False
version_update_map = {INPUTS: {ADD: OpUpdateType.kNewInput}, OUTPUTS: {ADD: OpUpdateType.kNewOutput}, ATTRS: {ADD: OpUpdateType.kNewAttr, CHANGE: OpUpdateType.kModifyAttr}}
...
if len(sys.argv) == 3:
    ...
    with open(sys.argv[2], 'r') as f:
        new_op_desc = f.read()
    (desc_error_message, version_error_message) = compare_op_desc(origin_op_desc, new_op_desc)
    if error:
        print('-' * 30)
