...
class AppFeedbackReportServicesUnitTests(test_utils.GenericTestBase):
    ...
    ANDROID_REPORT_INFO: app_feedback_report_models.ReportInfoDict = {'user_feedback_selected_items': [], 'user_feedback_other_text_input': 'add an admin', 'event_logs': ['event1', 'event2'], 'logcat_logs': ['logcat1', 'logcat2'], 'package_version_code': 1, 'build_fingerprint': 'example_fingerprint_id', 'network_type': 'wifi', 'android_device_language_locale_code': 'en', 'entry_point_info': {'entry_point_name': 'crash'}, 'text_size': 'medium_text_size', 'only_allows_wifi_download_and_update': True, 'automatically_update_topics': False, 'account_is_profile_admin': False, 'is_curriculum_admin': False, 'language_locale_code': 'en'}
