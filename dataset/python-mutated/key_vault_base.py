...
class KeyVaultBase:
    ...
    host_alias_map = {'AzureChinaCloud': (AzureAuthorityHosts.AZURE_CHINA, '2016-10-01'), 'AzureGermanCloud': (AzureAuthorityHosts.AZURE_GERMANY, '2016-10-01'), 'AzureUSGovernment': (AzureAuthorityHosts.AZURE_GOVERNMENT, '2016-10-01'), 'AzureCloud': (AzureAuthorityHosts.AZURE_PUBLIC_CLOUD, '7.1')}
