    ...
    def sample_program_configs(self):
        ...
        for batch in [1, 2]:
            ...
            for reshape_shape in [[0, 0, 8, 40]]:
                for dim1 in [4096]:
                    for dim2 in [768]:
                        dics = [{'trans_x': False, 'trans_y': False}, {'shape': reshape_shape}, {'axis': [0, 2, 1, 3]}, {'trans_x': False, 'trans_y': False}, {'shape': reshape_shape}, {'axis': [0, 2, 1, 3]}, {'trans_x': False, 'trans_y': False}, {'shape': reshape_shape}, {'axis': [0, 2, 1, 3]}, {'trans_x': False, 'trans_y': True}, {'scale': 0.15811388194561005, 'bias': 0.0, 'bias_after_scale': True}, {'axis': -1, 'is_test': True}, {'trans_x': False, 'trans_y': False}, {'axis': [0, 2, 1, 3]}, {'shape': [0, 0, 320]}]
    ...
    def sample_predictor_configs(self, program_config) -> (paddle_infer.Config, List[int], float):
        ...
        def generate_dynamic_shape(attrs):
            if False:
                while True:
                    i = 10
            self.dynamic_shape.min_input_shape = {'input_data1': [1, 4096, 320], 'input_data2': [1, 768, 768]}
            self.dynamic_shape.max_input_shape = {'input_data1': [8, 4096, 320], 'input_data2': [8, 768, 768]}
            self.dynamic_shape.opt_input_shape = {'input_data1': [2, 4096, 320], 'input_data2': [2, 768, 768]}
        ...
        yield (self.create_inference_config(), (1, 4), (0.01, 0.001))
    ...
    def add_skip_trt_case(self):
        ...
        def teller1(program_config, predictor_config):
            ...
            if self.dynamic_shape.min_input_shape == {}:
                return True
            return False
        self.add_skip_case(teller1, SkipReasons.TRT_NOT_IMPLEMENTED, 'TThe cross attention trt oss plugin do not support static shape yet')
        ...
        def teller2(program_config, predictor_config):
            ...
            if self.trt_param.precision == paddle_infer.PrecisionType.Float32:
                return True
            return False
        self.add_skip_case(teller2, SkipReasons.TRT_NOT_IMPLEMENTED, 'The cross attention trt oss plugin do not support fp32 yet')
        ...
        def teller3(program_config, predictor_config):
            ...
            if self.trt_param.precision == paddle_infer.PrecisionType.Int8:
                return True
            return False
        self.add_skip_case(teller3, SkipReasons.TRT_NOT_IMPLEMENTED, 'The cross attention trt oss plugin do not support int8 yet.')
