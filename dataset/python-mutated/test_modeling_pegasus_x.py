...
class PegasusXModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'conversational': PegasusXForConditionalGeneration, 'feature-extraction': PegasusXModel, 'summarization': PegasusXForConditionalGeneration, 'text2text-generation': PegasusXForConditionalGeneration, 'translation': PegasusXForConditionalGeneration} if is_torch_available() else {}
