...
class Ui_DialogModulation(object):
    ...
    def setupUi(self, DialogModulation):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(':/icons/icons/modulation.svg'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.doubleSpinBoxCarrierPhase = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBoxGaussFilterWidth = QtWidgets.QDoubleSpinBox(self.scrollAreaWidgetContents_4)
        ...
        self.comboBoxModulationType = QtWidgets.QComboBox(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
