...
class SpeechUnitLanguageModelConfig(TransformerLanguageModelConfig):
    mask_unit_seg_prob: float = field(default=0.0, metadata={'help': 'probability to mask a segment of unit sequence'})
    mask_unit_seg_leng: int = field(default=5, metadata={'help': 'length of unit segment mask'})
    mask_unit_seg_type: MASKING_DISTRIBUTION_CHOICES = field(default='static', metadata={'help': 'how to choose unit mask length'})
    mask_dur_prob: float = field(default=0.0, metadata={'help': 'probability to mask entire duration sequence'})
    mask_dur_seg_prob: float = field(default=0.0, metadata={'help': 'probability to mask a segment of duration sequence'})
    mask_dur_seg_leng: int = field(default=5, metadata={'help': 'length of duration segment mask'})
    mask_dur_seg_type: MASKING_DISTRIBUTION_CHOICES = field(default='static', metadata={'help': 'how to choose duration mask length'})
    mask_f0_prob: float = field(default=0.0, metadata={'help': 'probability to mask entire duration sequence'})
    mask_f0_seg_prob: float = field(default=0.0, metadata={'help': 'probability to mask a segment of f0 sequence'})
    mask_f0_seg_leng: int = field(default=5, metadata={'help': 'length of f0 segment mask'})
    mask_f0_seg_type: MASKING_DISTRIBUTION_CHOICES = field(default='static', metadata={'help': 'how to choose f0 mask length'})
