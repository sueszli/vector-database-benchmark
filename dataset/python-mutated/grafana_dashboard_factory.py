...
from ray.dashboard.modules.metrics.dashboards.default_dashboard_panels import default_dashboard_config
from ray.dashboard.modules.metrics.dashboards.serve_dashboard_panels import serve_dashboard_config
from ray.dashboard.modules.metrics.dashboards.serve_deployment_dashboard_panels import serve_deployment_dashboard_config
from ray.dashboard.modules.metrics.dashboards.data_dashboard_panels import data_dashboard_config
...
TARGET_TEMPLATE = {'exemplar': True, 'expr': '0', 'interval': '', 'legendFormat': '', 'queryType': 'randomWalk', 'refId': 'A'}
PANEL_TEMPLATE = {'aliasColors': {}, 'bars': False, 'dashLength': 10, 'dashes': False, 'datasource': '${datasource}', 'description': '<Description>', 'fieldConfig': {'defaults': {}, 'overrides': []}, 'fill': 10, 'fillGradient': 0, 'gridPos': {'h': 8, 'w': 12, 'x': 0, 'y': 0}, 'hiddenSeries': False, 'id': 26, 'legend': {'alignAsTable': True, 'avg': False, 'current': True, 'hideEmpty': False, 'hideZero': True, 'max': False, 'min': False, 'rightSide': False, 'show': True, 'sort': 'current', 'sortDesc': True, 'total': False, 'values': True}, 'lines': True, 'linewidth': 1, 'nullPointMode': 'null', 'options': {'alertThreshold': True}, 'percentage': False, 'pluginVersion': '7.5.17', 'pointradius': 2, 'points': False, 'renderer': 'flot', 'seriesOverrides': [{'$$hashKey': 'object:2987', 'alias': 'MAX', 'dashes': True, 'color': '#1F60C4', 'fill': 0, 'stack': False}, {'$$hashKey': 'object:78', 'alias': '/FINISHED|FAILED|DEAD|REMOVED|Failed Nodes:/', 'hiddenSeries': True}, {'$$hashKey': 'object:2987', 'alias': 'MAX + PENDING', 'dashes': True, 'color': '#777777', 'fill': 0, 'stack': False}], 'spaceLength': 10, 'stack': True, 'steppedLine': False, 'targets': [], 'thresholds': [], 'timeFrom': None, 'timeRegions': [], 'timeShift': None, 'title': '<Title>', 'tooltip': {'shared': True, 'sort': 0, 'value_type': 'individual'}, 'type': 'graph', 'xaxis': {'buckets': None, 'mode': 'time', 'name': None, 'show': True, 'values': []}, 'yaxes': [{'$$hashKey': 'object:628', 'format': 'units', 'label': '', 'logBase': 1, 'max': None, 'min': '0', 'show': True}, {'$$hashKey': 'object:629', 'format': 'short', 'label': None, 'logBase': 1, 'max': None, 'min': None, 'show': True}], 'yaxis': {'align': False, 'alignLevel': None}}
