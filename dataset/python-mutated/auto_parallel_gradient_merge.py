...
from paddle.distributed.auto_parallel.static.utils import is_forward_op, is_optimize_op, naive_set_dist_op_attr_for_program_by_mesh_and_mapping, set_var_dist_attr
from paddle.distributed.fleet.meta_optimizers.common import OP_ROLE_KEY, OP_ROLE_VAR_KEY, OpRole
