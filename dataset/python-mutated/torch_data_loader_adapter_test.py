...
from keras.trainers.data_adapters.torch_data_loader_adapter import TorchDataLoaderAdapter

@pytest.mark.skipif(backend.backend() != 'torch', reason='Backend does not support TorchDataLoaderAdapter.')
