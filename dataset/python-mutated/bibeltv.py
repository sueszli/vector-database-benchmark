...
from ..utils import ExtractorError, clean_html, determine_ext, format_field, int_or_none, js_to_json, orderedSet, parse_iso8601, traverse_obj, url_or_none
...
class BibelTVVideoIE(BibelTVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.bibeltv.de/mediathek/videos/344436-alte-wege', 'md5': 'ec1c07efe54353780512e8a4103b612e', 'info_dict': {'id': '344436', 'ext': 'mp4', 'title': 'Alte Wege', 'description': 'md5:2f4eb7294c9797a47b8fd13cccca22e9', 'timestamp': 1677877071, 'duration': 150.0, 'upload_date': '20230303', 'thumbnail': 're:https://bibeltv\\.imgix\\.net/[\\w-]+\\.jpg', 'episode': 'Episode 1', 'episode_number': 1, 'view_count': int, 'like_count': int}, 'params': {'format': '6'}}]
...
class BibelTVSeriesIE(BibelTVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.bibeltv.de/mediathek/serien/333485-ein-wunder-fuer-jeden-tag', 'playlist_mincount': 400, 'info_dict': {'id': '333485', 'title': 'Ein Wunder für jeden Tag', 'description': 'Tägliche Kurzandacht mit Déborah Rosenkranz.'}}]
...
class BibelTVLiveIE(BibelTVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.bibeltv.de/livestreams/bibeltv/', 'info_dict': {'id': 'bibeltv', 'ext': 'mp4', 'title': 're:Bibel TV', 'live_status': 'is_live', 'thumbnail': 'https://streampreview.bibeltv.de/bibeltv.webp'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.bibeltv.de/livestreams/impuls/', 'only_matching': True}]
