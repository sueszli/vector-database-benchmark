...
class WrappedTensorOpDispatcher(dispatch.GlobalOpDispatcher):
    ...
    OPS_THAT_RETURN_UNTRACED_RESULTS = (array_ops.shape, array_ops.shape_v2, check_ops.assert_rank_at_least)
...
class RaggedTensorSupportedValuesTest(test_util.TensorFlowTestCase, parameterized.TestCase):
...
@test_util.run_all_in_graph_and_eager_modes
class RaggedTensorSpecSupportedValuesTest(test_util.TensorFlowTestCase, parameterized.TestCase):
