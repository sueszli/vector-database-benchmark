...
class Test_deeplearning_grid_search:
    ...
    min_runtime_per_iteration = 0
    model_run_time = 0.0
    allowed_runtime_diff = 0.05
    family = 'gaussian'
    training_metric = 'MSE'
    test_name = 'pyunit_deeplearning_gridsearch_over_all_params_large.py'
    sandbox_dir = ''
    x_indices = []
    y_index = 0
    training1_data = []
    ...
    exclude_parameter_lists = ['distribution', 'tweedie_power', 'validation_frame', 'response_column', 'overwrite_with_best_model', 'quantile_alpha', 'max_confusion_matrix_size', 'train_samples_per_iteration', 'replicate_training_data', 'sparse', 'initial_weights', 'class_sampling_factors', 'standardize', 'fold_column', 'weights_column', 'offset_column', 'score_each_iteration', 'seed', 'max_w2', 'initial_weight_scale', 'score_interval', 'score_training_samples', 'score_validation_samples', 'sparsity_beta', 'classification_stop', 'regression_stop', 'score_validation_sampling', 'force_load_balance', 'single_node_mode', 'col_major', 'average_activation', 'score_duty_cycle', 'max_after_balance_size', 'nesterov_accelerated_gradient', 'max_categorical_features', 'reproducible', 'missing_values_handling', 'initial_biases', 'stopping_rounds', 'stopping_tolerance', 'stopping_metric', 'target_ratio_comm_to_comp', 'stopping_metric', 'balance_classes']
