...
from modelscope.models.multi_modal.freeu import register_free_crossattn_upblock2d, register_free_upblock2d
...
@PIPELINES.register_module(Tasks.text_to_image_synthesis, module_name=Pipelines.freeu_stable_diffusion_text2image)
