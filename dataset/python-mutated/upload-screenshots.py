...
SCREENSHOTS_DIRECTORY = os.path.abspath(os.path.join(os.path.dirname(__file__), 'tests/functional/pageslayout/screenshots/en_US'))
SCREENSHOTS_GLOB = '*.png'
CANONICALIZATION_RULES = [('\\.png$', ''), ('-', ': '), ('_', ' ')]
