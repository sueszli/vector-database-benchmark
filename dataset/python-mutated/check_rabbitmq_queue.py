...
normal_queues = ['deferred_work', 'digest_emails', 'email_mirror', 'email_senders', 'embed_links', 'embedded_bots', 'invites', 'missedmessage_emails', 'missedmessage_mobile_notifications', 'outgoing_webhooks', 'user_activity', 'user_activity_interval', 'user_presence']
OK = 0
WARNING = 1
CRITICAL = 2
UNKNOWN = 3
states = {0: 'OK', 1: 'WARNING', 2: 'CRITICAL', 3: 'UNKNOWN'}
MAX_SECONDS_TO_CLEAR: DefaultDict[str, int] = defaultdict(lambda : 30, deferred_work=600, digest_emails=1200, missedmessage_mobile_notifications=120, embed_links=60)
CRITICAL_SECONDS_TO_CLEAR: DefaultDict[str, int] = defaultdict(lambda : 60, deferred_work=900, missedmessage_mobile_notifications=180, digest_emails=1800, embed_links=90)
