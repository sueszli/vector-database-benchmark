...
from google.cloud.contentwarehouse_v1.services.pipeline_service import PipelineServiceAsyncClient, PipelineServiceClient, transports
from google.cloud.contentwarehouse_v1.types import common, pipeline_service, pipelines
...
@pytest.mark.parametrize('client_class,transport_name', [(PipelineServiceClient, 'grpc'), (PipelineServiceAsyncClient, 'grpc_asyncio'), (PipelineServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.PipelineServiceGrpcTransport, 'grpc'), (transports.PipelineServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.PipelineServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(PipelineServiceClient, transports.PipelineServiceGrpcTransport, 'grpc'), (PipelineServiceAsyncClient, transports.PipelineServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (PipelineServiceClient, transports.PipelineServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class', [PipelineServiceClient, PipelineServiceAsyncClient])
@mock.patch.object(PipelineServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PipelineServiceClient))
@mock.patch.object(PipelineServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PipelineServiceAsyncClient))
...
def test_pipeline_service_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.contentwarehouse_v1.services.pipeline_service.transports.PipelineServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = PipelineServiceClient(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(PipelineServiceClient, transports.PipelineServiceGrpcTransport, 'grpc', grpc_helpers), (PipelineServiceAsyncClient, transports.PipelineServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
@pytest.mark.parametrize('request_type', [pipeline_service.RunPipelineRequest, dict])
def test_run_pipeline(request_type, transport: str='grpc'):
    if False:
        return 10
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_run_pipeline_empty_call():
    if False:
        while True:
            i = 10
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.run_pipeline), '__call__') as call:
        client.run_pipeline()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
async def test_run_pipeline_async(transport: str='grpc_asyncio', request_type=pipeline_service.RunPipelineRequest):
    client = PipelineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.run_pipeline), '__call__') as call:
...
async def test_run_pipeline_field_headers_async():
    client = PipelineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = pipeline_service.RunPipelineRequest()
    request.name = 'name_value'
    with mock.patch.object(type(client.transport.run_pipeline), '__call__') as call:
...
def test_run_pipeline_flattened():
    ...
    with mock.patch.object(type(client.transport.run_pipeline), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.run_pipeline(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_run_pipeline_flattened_error():
    ...
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.run_pipeline(pipeline_service.RunPipelineRequest(), name='name_value')
...
async def test_run_pipeline_flattened_async():
    ...
    with mock.patch.object(type(client.transport.run_pipeline), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.run_pipeline(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_run_pipeline_flattened_error_async():
    client = PipelineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.run_pipeline(pipeline_service.RunPipelineRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [pipeline_service.RunPipelineRequest, dict])
def test_run_pipeline_rest(request_type):
    if False:
        return 10
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_run_pipeline_rest_interceptors(null_interceptor):
    if False:
        print('Hello World!')
    transport = transports.PipelineServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PipelineServiceRestInterceptor())
    client = PipelineServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.PipelineServiceRestInterceptor, 'post_run_pipeline') as post, mock.patch.object(transports.PipelineServiceRestInterceptor, 'pre_run_pipeline') as pre:
...
def test_run_pipeline_rest_bad_request(transport: str='rest', request_type=pipeline_service.RunPipelineRequest):
    if False:
        for i in range(10):
            print('nop')
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_credentials_transport_error():
    if False:
        print('Hello World!')
    transport = transports.PipelineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.PipelineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PipelineServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.PipelineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = PipelineServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.PipelineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PipelineServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.PipelineServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.PipelineServiceGrpcTransport, transports.PipelineServiceGrpcAsyncIOTransport, transports.PipelineServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        i = 10
        return i + 15
    transport = PipelineServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_pipeline_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.PipelineServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_pipeline_service_base_transport():
    ...
    with mock.patch('google.cloud.contentwarehouse_v1.services.pipeline_service.transports.PipelineServiceTransport.__init__') as Transport:
        ...
        transport = transports.PipelineServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('run_pipeline', 'get_operation')
...
def test_pipeline_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.contentwarehouse_v1.services.pipeline_service.transports.PipelineServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.PipelineServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.PipelineServiceGrpcTransport, grpc_helpers), (transports.PipelineServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_pipeline_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.PipelineServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_pipeline_service_host_no_port(transport_name):
    if False:
        return 10
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='contentwarehouse.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('contentwarehouse.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://contentwarehouse.googleapis.com')
...
def test_pipeline_service_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='contentwarehouse.googleapis.com:8000'), transport=transport_name)
...
def test_pipeline_service_client_transport_session_collision(transport_name):
    ...
    client1 = PipelineServiceClient(credentials=creds1, transport=transport_name)
    client2 = PipelineServiceClient(credentials=creds2, transport=transport_name)
...
def test_pipeline_service_grpc_transport_channel():
    ...
    transport = transports.PipelineServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_pipeline_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.PipelineServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_pipeline_service_grpc_lro_async_client():
    if False:
        i = 10
        return i + 15
    client = PipelineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PipelineServiceTransport, '_prep_wrapped_messages') as prep:
        client = PipelineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(PipelineServiceClient, transports.PipelineServiceGrpcTransport), (PipelineServiceAsyncClient, transports.PipelineServiceGrpcAsyncIOTransport)])
