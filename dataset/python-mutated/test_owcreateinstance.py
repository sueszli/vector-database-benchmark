...
from AnyQt.QtWidgets import QWidget, QLineEdit, QStyleOptionViewItem, QMenu, QPushButton
from orangewidget.tests.base import GuiTest
from Orange.data import Table, ContinuousVariable, Domain, DiscreteVariable, TimeVariable
from Orange.widgets.data.owcreateinstance import OWCreateInstance, DiscreteVariableEditor, ContinuousVariableEditor, StringVariableEditor, TimeVariableEditor, VariableDelegate, VariableItemModel, ValueRole
