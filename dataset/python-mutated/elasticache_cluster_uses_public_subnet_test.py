...
from tests.providers.aws.services.elasticache.elasticache_service_test import AWS_REGION_AZ1, AWS_REGION_AZ2, ELASTICACHE_CLUSTER_ARN, ELASTICACHE_CLUSTER_NAME, ELASTICACHE_CLUSTER_TAGS, SUBNET_1, SUBNET_2, SUBNET_GROUP_NAME, mock_make_api_call
