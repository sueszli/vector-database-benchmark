...
class TestSqrtOp(OpTest):
    ...
    def prepare_inputs(self):
        if False:
            return 10
        self.x_np = self.random(shape=self.case['x_shape'], dtype=self.case['x_dtype'], low=0.01, high=10000)
...
class TestSqrtOpShape(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.cls = TestSqrtOp
        self.inputs = [{'x_shape': [1]}, {'x_shape': [1024]}, {'x_shape': [1, 2048]}, {'x_shape': [32, 64]}, {'x_shape': [16, 8, 4, 2]}, {'x_shape': [16, 8, 4, 2, 1]}]
