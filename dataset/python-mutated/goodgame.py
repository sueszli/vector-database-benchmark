...
@pluginmatcher(name='default', pattern=re.compile('https?://(?:www\\.)?goodgame\\.ru/(?P<name>(?!channel|player)[^/?]+)'))
@pluginmatcher(name='channel', pattern=re.compile('https?://(?:www\\.)?goodgame\\.ru/channel/(?P<channel>[^/?]+)'))
@pluginmatcher(name='player', pattern=re.compile('https?://(?:www\\.)?goodgame\\.ru/player\\?(?P<id>\\d+)$'))
