...
class RIP(Packet):
    name = 'RIP header'
    fields_desc = [ByteEnumField('cmd', 1, {1: 'req', 2: 'resp', 3: 'traceOn', 4: 'traceOff', 5: 'sun', 6: 'trigReq', 7: 'trigResp', 8: 'trigAck', 9: 'updateReq', 10: 'updateResp', 11: 'updateAck'}), ByteField('version', 1), ShortField('null', 0)]
