...
class DataTrainingArguments:
    ...
    train_split_name: str = field(default='train+validation', metadata={'help': "The name of the training data set split to use (via the datasets library). Defaults to 'train'"})
