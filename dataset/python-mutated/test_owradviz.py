...
from Orange.widgets.tests.base import WidgetTest, WidgetOutputsTestMixin, AnchorProjectionWidgetTestMixin, datasets
from Orange.widgets.visualize.owradviz import OWRadviz, RadvizVizRank

class TestOWRadviz(WidgetTest, AnchorProjectionWidgetTestMixin, WidgetOutputsTestMixin):
