...
if __name__ == '__main__':
    ...
    run_benchmark(size=4000, count=1000, compression=False)
    run_benchmark(size=30000, count=200, compression=False)
    run_benchmark(size=250000, count=100, compression=False)
    run_benchmark(size=2000000, count=20, compression=False)
    ...
    run_benchmark(size=4000, count=100, compression=True)
    run_benchmark(size=30000, count=20, compression=True)
    run_benchmark(size=250000, count=10, compression=True)