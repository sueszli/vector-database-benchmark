...
class TestSpiderFoot(unittest.TestCase):
    default_modules = ['sfp_binstring', 'sfp_company', 'sfp_cookie', 'sfp_countryname', 'sfp_creditcard', 'sfp_email', 'sfp_errors', 'sfp_ethereum', 'sfp_filemeta', 'sfp_hashes', 'sfp_iban', 'sfp_names', 'sfp_pageinfo', 'sfp_phone', 'sfp_webanalytics']
