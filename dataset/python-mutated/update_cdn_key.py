...
Cloud CDN key.
Example usage:
    python update_cdn_key.py --project_id <project-id> --location <location>         --cdn_key_id <cdn_key_id> --hostname <hostname>         --key_name <name> --private_key <key> [--is_cloud_cdn]
"""
import argparse
...
def update_cdn_key(project_id: str, location: str, cdn_key_id: str, hostname: str, key_name: str, private_key: str, is_cloud_cdn: bool) -> stitcher_v1.types.CdnKey:
    if False:
        while True:
            i = 10
    ...
    cdn_key = stitcher_v1.types.CdnKey(name=name, hostname=hostname)
    if is_cloud_cdn:
...
if __name__ == '__main__':
    ...
    update_cdn_key(args.project_id, args.location, args.cdn_key_id, args.hostname, args.key_name, args.private_key, args.is_cloud_cdn)