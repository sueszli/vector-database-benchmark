...
EMPTY_CARD_CACHE = b'<?xml version="1.0" encoding="UTF-8"?>\n<cache xmlns="http://www.kinoma.com/FskCache/1">\n</cache>\n'
EMPTY_EXT_CACHE = b'<?xml version="1.0" encoding="UTF-8"?>\n<cacheExt xmlns="http://www.sony.com/xmlns/product/prs/device/1">\n</cacheExt>\n'
MIME_MAP = {'lrf': 'application/x-sony-bbeb', 'lrx': 'application/x-sony-bbeb', 'rtf': 'application/rtf', 'pdf': 'application/pdf', 'txt': 'text/plain', 'epub': 'application/epub+zip'}
