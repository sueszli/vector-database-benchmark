...
class SpiegelIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        media_id = self._html_search_regex('(&#34;|["\\\'])mediaId\\1\\s*:\\s*(&#34;|["\\\'])(?P<id>(?:(?!\\2).)+)\\2', webpage, 'media id', group='id')
        return {'_type': 'url_transparent', 'id': video_id, 'display_id': video_id, 'url': 'jwplatform:%s' % media_id, 'title': self._og_search_title(webpage, default=None), 'ie_key': JWPlatformIE.ie_key()}