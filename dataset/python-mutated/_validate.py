...
from streamlink.plugin.api.validate._schemas import AllSchema, AnySchema, AttrSchema, GetItemSchema, ListSchema, NoneOrAllSchema, OptionalSchema, RegexSchema, TransformSchema, UnionGetSchema, UnionSchema, XmlElementSchema
