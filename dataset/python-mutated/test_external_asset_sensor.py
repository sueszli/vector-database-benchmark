from dagster import AssetKey, AssetMaterialization, DagsterInstance, SensorResult, build_sensor_context
from docs_snippets.concepts.assets.external_assets.external_asset_using_sensor import keep_external_asset_a_up_to_date
