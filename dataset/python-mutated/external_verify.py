...
class ExternalVerify(BaseMutation):
    ...
    is_valid = graphene.Boolean(required=True, default_value=False, description='Determine if authentication data is valid or not.')
    ...
    class Arguments:
        ...
        input = JSONString(required=True, description='The data required by plugin to proceed the verification.')
