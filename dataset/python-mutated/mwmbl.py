...
about = {'website': 'https://github.com/mwmbl/mwmbl', 'official_api_documentation': 'https://api.mwmbl.org/docs', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
paging = False
categories = ['general']
...
def response(resp):
    ...
    for result in json_results:
        ...
        results.append({'url': result['url'], 'title': ''.join(title_parts), 'content': result['extract'][0]['value']})
    return results