...
class LibgenIo(BaseDownloader):
    ...
    __version__ = '0.71'
    __status__ = 'testing'
    __pattern__ = '(?i)https?://([^/]+\\.)?(libgen\\.io|libgen\\.me|booksdescr\\.org|booksdl\\.org|booksdescr\\.com|lib1\\.org|library1\\.org|libgen\\.pw|gen\\.lib\\.rus\\.ec)/.*'
    __config__ = [('enabled', 'enabled', 'Activated', True), ('mirrors', 'string', 'Libgen mirror URL patterns (space-separated)', 'http://booksdl.org/{topiclong}/get.php?md5={md5} http://booksdl.org/get.php?md5={md5}'), ('query_api', 'bool', 'Query libgen API to fetch more book details', False), ('api_mirrors', 'string', 'API mirror URLs (space-separated)', 'http://libgen.io/json.php http://booksdescr.org/json.php'), ('api_fields', 'string', 'API fields to fetch', 'id,authorfamily1,authorname1,series1,extension,language,pages,isbn,year'), ('max_recursions', 'int', 'Maximum directories to recurse into', 100)]
