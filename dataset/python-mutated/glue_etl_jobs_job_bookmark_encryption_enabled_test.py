...
class Test_glue_etl_jobs_job_bookmark_encryption_enabled:
    ...
    def test_glue_no_jobs(self):
        ...
        with mock.patch('prowler.providers.aws.services.glue.glue_service.Glue', glue_client):
            from prowler.providers.aws.services.glue.glue_etl_jobs_job_bookmark_encryption_enabled.glue_etl_jobs_job_bookmark_encryption_enabled import glue_etl_jobs_job_bookmark_encryption_enabled
