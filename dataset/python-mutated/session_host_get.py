...
def main():
    ...
    response = client.session_hosts.get(resource_group_name='resourceGroup1', host_pool_name='hostPool1', session_host_name='sessionHost1.microsoft.com')
    print(response)
