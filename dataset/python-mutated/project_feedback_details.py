...
class ProjectFeedbackDetailsPermission(ProjectPermission):
    scope_map = {'GET': ['project:read', 'project:write', 'project:admin'], 'DELETE': ['project:read', 'project:write', 'project:admin']}

@region_silo_endpoint
class ProjectFeedbackDetailsEndpoint(ProjectFeedbackEndpoint):
    publish_status = {'GET': ApiPublishStatus.EXPERIMENTAL, 'DELETE': ApiPublishStatus.EXPERIMENTAL}
