...
CYRILLIC_REPLACE = ((re.compile('ong'), 'ung'), (re.compile('([zcs])i'), '\\1U'), (re.compile('([xqj])u'), '\\1v'), (re.compile('^wu(.?)$'), 'u\\1'), (re.compile('(.+)r(.?)$'), '\\1R\\2'), (re.compile('^zh'), 'Cr'), (re.compile('^ch'), 'C'), (re.compile('^j'), 'qZ'), (re.compile('^z'), 'qZ'), (re.compile('^x'), 's'), (re.compile('^sh'), 'S'), (re.compile('([^CSdst])uo'), '\\1o'), (re.compile('^y(.*)$'), 'I\\1'), (re.compile('Iai'), 'AI'), (re.compile('Ia'), 'A'), (re.compile('Ie'), 'E'), (re.compile('Ii'), 'i'), (re.compile('Iou'), 'V'), (re.compile('Iu'), 'v'), (re.compile('(.v)(\\d?)$'), '\\1I\\2'), (re.compile('Io'), 'O'), (re.compile('iu'), 'v'), (re.compile('ie'), 'E'), (re.compile('hui'), 'huei'), (re.compile('ui'), 'uI'), (re.compile('ai'), 'aI'), (re.compile('ei'), 'eI'), (re.compile('ia'), 'A'), (re.compile('(.*[^h])n([^g]?)$'), '\\1nM\\2'), (re.compile('(.*[^h])ng(.?)$'), '\\1n\\2'), (re.compile('^v(\\d?$)'), 'vI'))
CYRILLIC_TABLE = dict(zip(u'abwgdEOrZiIklmnopRstufhqcCSHTMUevAV', u'абвгдеёжзийклмнопрстуфхццчшщъьыэюяю'))
