...
ADHOC_FILTERS = [{'clause': 'WHERE', 'comparator': ['CA', 'FL'], 'expressionType': 'SIMPLE', 'operator': 'IN', 'subject': 'state'}]
SOURCE_FORM_DATA = {'metric': 'num_boys', 'y_axis_format': ',d', 'y_axis_bounds': [50, 100], 'metric_2': 'num_girls', 'y_axis_2_format': ',d', 'y_axis_2_bounds': [75, 150], 'viz_type': 'dual_line', 'adhoc_filters': ADHOC_FILTERS, 'x_axis_format': 'smart_date', 'color_scheme': 'bnbColors', 'yAxisIndex': 0}
TARGET_FORM_DATA = {'metrics': ['num_boys'], 'y_axis_format': ',d', 'y_axis_bounds': [50, 100], 'y_axis_bounds_secondary': [75, 150], 'metrics_b': ['num_girls'], 'y_axis_format_secondary': ',d', 'viz_type': 'mixed_timeseries', 'adhoc_filters': ADHOC_FILTERS, 'adhoc_filters_b': ADHOC_FILTERS, 'x_axis_time_format': 'smart_date', 'color_scheme': 'bnbColors', 'form_data_bak': SOURCE_FORM_DATA, 'yAxisIndex': 0, 'yAxisIndexB': 1, 'truncateYAxis': True}
...
def upgrade_downgrade(source, target) -> None:
    ...
    slc = Slice(viz_type=MigrateDualLine.source_viz_type, datasource_type='table', params=dumped_form_data, query_context=f'{{"form_data": {dumped_form_data}}}')
