...
class MobileViTV2ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    """
    all_model_classes = (MobileViTV2Model, MobileViTV2ForImageClassification, MobileViTV2ForSemanticSegmentation) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': MobileViTV2Model, 'image-classification': MobileViTV2ForImageClassification, 'image-segmentation': MobileViTV2ForSemanticSegmentation} if is_torch_available() else {}
    test_pruning = False
