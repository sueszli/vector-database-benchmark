...
def new_record(rtype, serial):
    ...
    nr['Rank'] = 240
    return nr
RECORD_TYPE_MAPPING = {0: 'ZERO', 1: 'A', 2: 'NS', 5: 'CNAME', 6: 'SOA', 12: 'PTR', 28: 'AAAA', 33: 'SRV'}
...
class DNS_RECORD(Structure):
    ...
    """
    structure = (('DataLength', '<H-Data'), ('Type', '<H'), ('Version', 'B=5'), ('Rank', 'B'), ('Flags', '<H=0'), ('Serial', '<L'), ('TtlSeconds', '>L'), ('Reserved', '<L=0'), ('TimeStamp', '<L=0'), ('Data', ':'))
...
class DNS_RPC_NODE(Structure):
    ...
    """
    structure = (('wLength', '>H'), ('wRecordCount', '>H'), ('dwFlags', '>L'), ('dwChildCount', '>L'), ('dnsNodeName', ':'))
...
class DNS_RPC_RECORD_SOA(Structure):
    ...
    """
    structure = (('dwSerialNo', '>L'), ('dwRefresh', '>L'), ('dwRetry', '>L'), ('dwExpire', '>L'), ('dwMinimumTtl', '>L'), ('namePrimaryServer', ':', DNS_COUNT_NAME), ('zoneAdminEmail', ':', DNS_COUNT_NAME))
...
class DNS_RPC_RECORD_SRV(Structure):
    ...
    """
    structure = (('wPriority', '>H'), ('wWeight', '>H'), ('wPort', '>H'), ('nameTarget', ':', DNS_COUNT_NAME))
