...
class EnterpriseEventDefinitionSerializer(TaggedItemSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'owner', 'description', 'tags', 'created_at', 'updated_at', 'updated_by', 'last_seen_at', 'last_updated_at', 'verified', 'verified_at', 'verified_by', 'is_action', 'action_id', 'is_calculating', 'last_calculated_at', 'created_by', 'post_to_slack')
        read_only_fields = ['id', 'name', 'created_at', 'updated_at', 'last_seen_at', 'last_updated_at', 'verified_at', 'verified_by', 'is_action', 'action_id', 'is_calculating', 'last_calculated_at', 'created_by']
