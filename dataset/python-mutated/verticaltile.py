...
class VerticalTile(_SimpleLayoutBase):
    ...
    """
    defaults = [('border_focus', '#FF0000', 'Border color(s) for the focused window.'), ('border_normal', '#FFFFFF', 'Border color(s) for un-focused windows.'), ('border_width', 1, 'Border width.'), ('single_border_width', None, 'Border width for single window.'), ('single_margin', None, 'Margin for single window.'), ('margin', 0, 'Border margin (int or list of ints [N E S W]).')]
    ratio = 0.75
    steps = 0.05
