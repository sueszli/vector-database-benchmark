...
VERBOSE_FEATURE_NAME = {'dots': 'Wildcard Matches (...)', 'equivalence': 'Helpful Features', 'metavar': 'Named Placeholders ($X)', 'misc': 'Others', 'metavar_equality': 'Reoccurring Expressions', 'concrete': 'Exact Matches', 'regexp': "Regular Expressions '=~/regexp/'", 'deep': 'Deep (Recursive) Matching'}
VERBOSE_SUBCATEGORY_NAME = {'stmt': 'Statement', 'stmts': 'Statements', 'call': 'Function Call', 'nested_stmts': 'Nested Statements', 'cond': 'Conditionals', 'arg': 'Argument', 'args': 'Arguments', 'import': 'Imports', 'string': 'Strings', 'expr': 'Expressions', 'var': 'Variables', 'naming_import': 'Import Renaming/Aliasing', 'constant_propagation': 'Constant Propagation', 'fieldname': 'Field Names', 'syntax': 'Single Statements', 'exprstmt': 'Expression and Statement', 'typed': 'Typed Metavariables', 'expr_operator': 'Deep Expression Operator', 'class_def': 'Class Definitions', 'anno': 'Annotations', 'func_def': 'Function Definitions', 'key_value': 'Object or Dictionary Key Value Pairs', 'typed_fieldaccess': 'Typed Metavariable Field Access', 'method_chaining': 'Method Chaining'}
LANGUAGE_EXCEPTIONS = {'java': ['naming_import', 'key_value'], 'c': ['naming_import', 'class_def', 'anno'], 'ruby': ['naming_import', 'typed', 'anno'], 'python': ['typed'], 'js': ['typed'], 'go': ['class_def', 'anno'], 'ocaml': ['anno', 'key_value']}
EXCLUDE = ['TODO', 'POLYGLOT', 'e2e', 'OTHER']
CHEATSHEET_ENTRIES = {'concrete': ['syntax'], 'dots': ['args', 'string', 'stmts', 'nested_stmts', 'method_chaining'], 'metavar': ['call', 'arg', 'stmt', 'cond', 'func_def', 'class_def', 'import', 'typed', 'anno', 'key_value', 'typed_fieldaccess'], 'regexp': ['string', 'fieldname'], 'metavar_equality': ['expr', 'stmt', 'var'], 'equivalence': ['naming_import', 'constant_propagation'], 'deep': ['exprstmt', 'expr_operator']}
ALPHA_FEATURES = {'concrete': ['syntax'], 'dots': ['args', 'string', 'stmts', 'nested_stmts'], 'metavar': ['call', 'arg'], 'metavar_equality': ['var'], 'deep': ['exprstmt']}
BETA_FEATURES = {'metavar': ['stmt', 'cond', 'import', 'class_def', 'func_def'], 'metavar_equality': ['stmt', 'expr']}
GA_FEATURES = {'metavar': ['typed', 'anno', 'key_value', 'ellipsis_args'], 'regexp': ['string'], 'equivalence': ['naming_import', 'constant_propagation'], 'deep': ['expr_operator']}
