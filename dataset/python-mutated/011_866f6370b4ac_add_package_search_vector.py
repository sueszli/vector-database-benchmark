...
def upgrade():
    ...
    if skip_based_on_legacy_engine_version(op, __name__):
        return
    op.create_table('package_search', sa.Column('package_id', sa.Integer, sa.ForeignKey('package.id'), primary_key=True), sa.Column('search_vector', sa.dialects.postgresql.TSVECTOR))
