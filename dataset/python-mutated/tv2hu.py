...
from ..utils import traverse_obj, UnsupportedError

class TV2HuIE(InfoExtractor):
    IE_NAME = 'tv2play.hu'
    _VALID_URL = 'https?://(?:www\\.)?tv2play\\.hu/(?!szalag/)(?P<id>[^#&?]+)'
    _TESTS = [{'url': 'https://tv2play.hu/mintaapak/mintaapak_213_epizod_resz', 'info_dict': {'id': '249240', 'ext': 'mp4', 'title': 'Mintaapák - 213. epizód', 'series': 'Mintaapák', 'duration': 2164, 'description': 'md5:7350147e75485a59598e806c47967b07', 'thumbnail': 're:^https?://.*\\.jpg$', 'release_date': '20210825', 'season_number': None, 'episode_number': 213}, 'params': {'skip_download': True}}, {'url': 'https://tv2play.hu/taxi_2', 'md5': '585e58e2e090f34603804bb2c48e98d8', 'info_dict': {'id': '199363', 'ext': 'mp4', 'title': 'Taxi 2', 'series': 'Taxi 2', 'duration': 5087, 'description': 'md5:47762155dc9a50241797ded101b1b08c', 'thumbnail': 're:^https?://.*\\.jpg$', 'release_date': '20210118', 'season_number': None, 'episode_number': None}, 'params': {'skip_download': True}}]
...
class TV2HuSeriesIE(InfoExtractor):
    ...
    _VALID_URL = 'https?://(?:www\\.)?tv2play\\.hu/szalag/(?P<id>[^#&?]+)'
    _TESTS = [{'url': 'https://tv2play.hu/szalag/59?rendezes=nepszeruseg', 'playlist_mincount': 284, 'info_dict': {'id': '59'}}]
