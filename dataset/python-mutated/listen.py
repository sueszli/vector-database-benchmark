...
group.add_argument('-a', '--add', nargs='+', metavar=('TRANSPORT', 'TRANSPORT_ARG1'), help='start listener')
group.add_argument('-A', '--add-no-pproxy', nargs='+', metavar=('TRANSPORT', 'TRANSPORT_ARG1'), help='start listener (ignore pproxy)')
group.add_argument('-r', '--remove', metavar='TRANSPORT', type=str, help='stop listener')
