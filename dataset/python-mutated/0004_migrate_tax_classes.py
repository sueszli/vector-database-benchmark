...
class Migration(migrations.Migration):
    dependencies = [('tax', '0003_add_manage_taxes_permission'), ('product', '0177_product_tax_class_producttype_tax_class')]
    operations = [migrations.RunPython(migrate_product_tax_codes, migrations.RunPython.noop), migrations.RunPython(migrate_products_with_disabled_taxes, migrations.RunPython.noop)]