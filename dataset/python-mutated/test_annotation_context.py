...
from rerun.datatypes import AnnotationInfo, AnnotationInfoLike, ClassDescription, ClassDescriptionArrayLike, ClassDescriptionMapElem, KeypointPair, KeypointPairLike, Rgba32, Utf8
ANNOTATION_INFO_INPUTS: list[AnnotationInfoLike] = [AnnotationInfo(1, 'label', Rgba32([1, 2, 3])), AnnotationInfo(1, color=Rgba32([1, 2, 3])), (1, 'label'), (1, 'label', [1, 2, 3])]
KEYPOINT_MAP_INPUTS: list[Sequence[AnnotationInfoLike] | None] = [None, [], [(1, 'label1'), (2, 'label2')], [(1, 'label1', [1, 2, 3]), (2, 'label2', [4, 5, 6])], [AnnotationInfo(1, 'label1', Rgba32([1, 2, 3])), AnnotationInfo(2, 'label2', Rgba32([4, 5, 6]))]]
KEYPOINT_CONNECTIONS_INPUTS: list[Sequence[KeypointPairLike] | None] = [None, [], [(1, 2)], [[1, 2]], [KeypointPair(1, 2)]]
