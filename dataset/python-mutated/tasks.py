...
_arg_help_connectors = "Comma-separated connectors' names without 'source-' prefix (ex.: -c github,google-ads,s3). The default is a list of all found connectors excluding the ones with `-singer` suffix."
