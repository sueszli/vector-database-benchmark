...
SCHEMA_FOR_STORY_ID = {'type': 'basestring', 'validators': [{'id': 'has_length', 'value': constants.STORY_ID_LENGTH}]}
...
class EditableStoryDataHandler(base.BaseHandler[EditableStoryDataHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    URL_PATH_ARGS_SCHEMAS = {'story_id': {'schema': SCHEMA_FOR_STORY_ID}}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'PUT': {'version': {'schema': {'type': 'int', 'validators': [{'id': 'is_at_least', 'min_value': 1}]}}, 'commit_message': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_COMMIT_MESSAGE_LENGTH}]}}, 'change_dicts': {'schema': {'type': 'list', 'items': {'type': 'object_dict', 'object_class': story_domain.StoryChange}}}}, 'DELETE': {}}
...
class StoryPublishHandler(base.BaseHandler[StoryPublishHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'story_id': {'schema': SCHEMA_FOR_STORY_ID}}
    HANDLER_ARGS_SCHEMAS = {'PUT': {'new_story_status_is_public': {'schema': {'type': 'bool'}}}}
