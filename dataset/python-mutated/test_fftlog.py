...
try:
    ...
    fhtoffset = None
atol = {cupy.float64: 1e-10, 'default': 1e-05}
rtol = {cupy.float64: 1e-10, 'default': 1e-05}

@testing.parameterize(*testing.product({'mu': [0.3, 0.5, -1.2], 'shape': [(9,), (10,), (10, 9), (8, 10)], 'offset': [0.0, 0.1, 'optimal'], 'bias': [0.0, 0.8, -0.5], 'function': ['fht', 'ifht']}))
class TestFftlog:
...
@testing.parameterize(*testing.product({'function': ['fht', 'ifht']}))
