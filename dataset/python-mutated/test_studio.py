...
from dvc.env import DVC_STUDIO_OFFLINE, DVC_STUDIO_REPO_URL, DVC_STUDIO_TOKEN, DVC_STUDIO_URL
...
ENV = {DVC_STUDIO_OFFLINE: True, DVC_STUDIO_REPO_URL: 'repo_url', DVC_STUDIO_TOKEN: 'token', DVC_STUDIO_URL: 'url'}
