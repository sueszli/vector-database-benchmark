...
def generate_data():
    ...
    for tsdata in [tsdata_train, tsdata_test]:
        tsdata.impute(mode='last').scale(standard_scaler, fit=tsdata is tsdata_train)
...
if __name__ == '__main__':
    ...
    forecaster = TCNForecaster(past_seq_len=look_back, future_seq_len=horizon, input_feature_num=321, output_feature_num=321, dummy_encoder=True, num_channels=[30] * 7, repo_initialization=False, kernel_size=3, dropout=0.1, lr=0.001, seed=1)
