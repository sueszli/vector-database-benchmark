...
class Migration(migrations.Migration):
    dependencies = [('playbooks_manager', '0015_dns_playbook'), ('visualizers_manager', '0021_alter_visualizerconfig_options'), ('analyzers_manager', '0030_alter_analyzerconfig_options'), ('connectors_manager', '0017_alter_connectorconfig_options')]
    operations = [migrations.AddField(model_name='visualizerconfig', name='playbook', field=models.ForeignKey(blank=True, null=True, on_delete=models.CASCADE, related_name='visualizers', to='playbooks_manager.playbookconfig')), migrations.RunPython(migrate, reverse_migrate), migrations.AlterField(model_name='visualizerconfig', name='playbook', field=models.ForeignKey(blank=False, null=False, on_delete=models.CASCADE, related_name='visualizers', to='playbooks_manager.playbookconfig')), migrations.RemoveField(model_name='visualizerconfig', name='analyzers'), migrations.RemoveField(model_name='visualizerconfig', name='connectors')]