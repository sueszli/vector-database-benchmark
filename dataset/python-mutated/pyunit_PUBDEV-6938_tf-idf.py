...
TESTS = [tf_idf_with_preprocessing_case_ins, tf_idf_with_preprocessing_case_sens, tf_idf_without_preprocessing_case_ins, tf_idf_without_preprocessing_case_sens]
