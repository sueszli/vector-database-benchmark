...
from torch.testing._internal.common_utils import instantiate_parametrized_tests, parametrize, run_tests, skipIfTorchDynamo, subtest, TEST_WITH_TORCHDYNAMO, TestCase, xpassIfTorchDynamo
...
class TestArgmax(TestCase):
    ...
    nan_arr = darr + [subtest(([0, 1, 2, 3, complex(0, np.nan)], 4), decorators=[xpassIfTorchDynamo]), subtest(([0, 1, 2, 3, complex(np.nan, 0)], 4), decorators=[xpassIfTorchDynamo]), subtest(([0, 1, 2, complex(np.nan, 0), 3], 3), decorators=[xpassIfTorchDynamo]), subtest(([0, 1, 2, complex(0, np.nan), 3], 3), decorators=[xpassIfTorchDynamo]), subtest(([complex(0, np.nan), 0, 1, 2, 3], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(np.nan, np.nan), 0, 1, 2, 3], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(np.nan, 0), complex(np.nan, 2), complex(np.nan, 1)], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(np.nan, np.nan), complex(np.nan, 2), complex(np.nan, 1)], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(np.nan, 0), complex(np.nan, 2), complex(np.nan, np.nan)], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(0, 0), complex(0, 2), complex(0, 1)], 1), decorators=[xpassIfTorchDynamo]), subtest(([complex(1, 0), complex(0, 2), complex(0, 1)], 0), decorators=[xpassIfTorchDynamo]), subtest(([complex(1, 0), complex(0, 2), complex(1, 1)], 2), decorators=[xpassIfTorchDynamo]), ([False, False, False, False, True], 4), ([False, False, False, True, False], 3), ([True, False, False, False, False], 0), ([True, False, True, False, False], 0)]
...
class TestArgmin(TestCase):
    ...
    darr += [(np.array(d[0], dtype=t), d[1]) for (d, t) in itertools.product(sg_data, (np.int8, np.int16, np.int32, np.int64, np.float32, np.float64))]
    darr += [(np.array(d[0], dtype=t), d[1]) for (d, t) in itertools.product((([0, 1, 2, 3, np.nan], 4), ([0, 1, 2, np.nan, 3], 3), ([np.nan, 0, 1, 2, 3], 0), ([np.nan, 0, np.nan, 2, 3], 0), ([1] * (2 * 5 - 1) + [np.nan], 2 * 5 - 1), ([1] * (4 * 5 - 1) + [np.nan], 4 * 5 - 1), ([1] * (8 * 5 - 1) + [np.nan], 8 * 5 - 1), ([1] * (16 * 5 - 1) + [np.nan], 16 * 5 - 1), ([1] * (32 * 5 - 1) + [np.nan], 32 * 5 - 1)), (np.float32, np.float64))]
    nan_arr = darr + [subtest(([0, 1, 2, 3, complex(0, np.nan)], 4), decorators=[xfail]), subtest(([0, 1, 2, 3, complex(np.nan, 0)], 4), decorators=[xfail]), subtest(([0, 1, 2, complex(np.nan, 0), 3], 3), decorators=[xfail]), subtest(([0, 1, 2, complex(0, np.nan), 3], 3), decorators=[xfail]), subtest(([complex(0, np.nan), 0, 1, 2, 3], 0), decorators=[xfail]), subtest(([complex(np.nan, np.nan), 0, 1, 2, 3], 0), decorators=[xfail]), subtest(([complex(np.nan, 0), complex(np.nan, 2), complex(np.nan, 1)], 0), decorators=[xfail]), subtest(([complex(np.nan, np.nan), complex(np.nan, 2), complex(np.nan, 1)], 0), decorators=[xfail]), subtest(([complex(np.nan, 0), complex(np.nan, 2), complex(np.nan, np.nan)], 0), decorators=[xfail]), subtest(([complex(0, 0), complex(0, 2), complex(0, 1)], 0), decorators=[xfail]), subtest(([complex(1, 0), complex(0, 2), complex(0, 1)], 2), decorators=[xfail]), subtest(([complex(1, 0), complex(0, 2), complex(1, 1)], 1), decorators=[xfail]), ([True, True, True, True, False], 4), ([True, True, True, False, True], 3), ([False, True, True, True, True], 0), ([False, True, False, True, True], 0)]
