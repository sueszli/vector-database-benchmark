...
RLIMITS_MAP = {'RLIMIT_AS': 'virtualmem', 'RLIMIT_CORE': 'coredumpsize', 'RLIMIT_CPU': 'cputime', 'RLIMIT_DATA': 'datasize', 'RLIMIT_FSIZE': 'filesize', 'RLIMIT_MEMLOCK': 'memlock', 'RLIMIT_MSGQUEUE': 'msgqueue', 'RLIMIT_NICE': 'nice', 'RLIMIT_NOFILE': 'openfiles', 'RLIMIT_NPROC': 'maxprocesses', 'RLIMIT_NPTS': 'pseudoterms', 'RLIMIT_RSS': 'rss', 'RLIMIT_RTPRIO': 'realtimeprio', 'RLIMIT_RTTIME': 'rtimesched', 'RLIMIT_SBSIZE': 'sockbufsize', 'RLIMIT_SIGPENDING': 'sigspending', 'RLIMIT_STACK': 'stack', 'RLIMIT_SWAP': 'swapuse'}
