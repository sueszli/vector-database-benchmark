...
@testing.unary_math_function_unittest(F.erfinv, func_expected=_erfinv_expected, make_data=make_data, forward_options={'atol': 0.001, 'rtol': 0.001}, backward_options={'eps': 1e-06}, double_backward_options={'eps': 1e-06})
