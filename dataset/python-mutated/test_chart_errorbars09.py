...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        if False:
            while True:
                i = 10
        self.set_filename('chart_errorbars09.xlsx')
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$1:$A$5', 'values': '=Sheet1!$B$1:$B$5', 'y_error_bars': {'type': 'custom', 'plus_values': [1, 2, 3], 'minus_values': [2, 4, 6]}})
