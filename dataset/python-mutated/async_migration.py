...
from posthog.models.async_migration import AsyncMigration, AsyncMigrationError, MigrationStatus, get_all_running_async_migrations
...
class AsyncMigrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'description', 'progress', 'status', 'current_operation_index', 'current_query_id', 'celery_task_id', 'started_at', 'finished_at', 'posthog_max_version', 'posthog_min_version', 'parameters', 'error_count', 'parameter_definitions', 'is_available']
        read_only_fields = ['id', 'name', 'description', 'progress', 'status', 'current_operation_index', 'current_query_id', 'celery_task_id', 'started_at', 'finished_at', 'posthog_max_version', 'posthog_min_version', 'error_count', 'parameter_definitions', 'is_available']
