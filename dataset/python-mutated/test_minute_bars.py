...
import os
from numpy import arange, array, int64, float64, full, nan, transpose, zeros
from numpy.testing import assert_almost_equal, assert_array_equal
from pandas import DataFrame, DatetimeIndex, Timestamp, Timedelta, NaT, date_range
from zipline.data.bar_reader import NoDataForSid, NoDataOnDate
from zipline.data.minute_bars import BcolzMinuteBarMetadata, BcolzMinuteBarWriter, BcolzMinuteBarReader, BcolzMinuteOverlappingData, US_EQUITIES_MINUTES_PER_DAY, BcolzMinuteWriterColumnMismatch, H5MinuteBarUpdateWriter, H5MinuteBarUpdateReader
from zipline.testing.fixtures import WithAssetFinder, WithInstanceTmpDir, WithTradingCalendars, ZiplineTestCase
TEST_CALENDAR_START = Timestamp('2014-06-02', tz='UTC')
TEST_CALENDAR_STOP = Timestamp('2015-12-31', tz='UTC')

class BcolzMinuteBarTestCase(WithTradingCalendars, WithAssetFinder, WithInstanceTmpDir, ZiplineTestCase):
