...
if TYPE_CHECKING:
    ...
    Mat3x3Like = Any
Mat3x3ArrayLike = Union[Mat3x3, Sequence[Mat3x3Like]]
...
class Mat3x3Type(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            return 10
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 9), self._TYPE_NAME)
