...
def build_get_by_id_request(approval_id: str, stage_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/providers/Microsoft.Authorization/roleAssignmentApprovals/{approvalId}/stages/{stageId}')
    path_format_arguments = {'approvalId': _SERIALIZER.url('approval_id', approval_id, 'str'), 'stageId': _SERIALIZER.url('stage_id', stage_id, 'str')}
...
class RoleAssignmentApprovalStepOperations:
    ...
    def get_by_id(self, approval_id: str, stage_id: str, **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        ...
        request = build_get_by_id_request(approval_id=approval_id, stage_id=stage_id, api_version=api_version, template_url=self.get_by_id.metadata['url'], headers=_headers, params=_params)
        ...
        return deserialized
    get_by_id.metadata = {'url': '/providers/Microsoft.Authorization/roleAssignmentApprovals/{approvalId}/stages/{stageId}'}

    @overload
    def patch(self, approval_id: str, stage_id: str, properties: _models.RoleAssignmentApprovalStepProperties, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            while True:
                i = 10
    ...
    @overload
    def patch(self, approval_id: str, stage_id: str, properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            print('Hello World!')
        'Record a decision.\n\n        :param approval_id: The id of the role assignment approval. Required.\n        :type approval_id: str\n        :param stage_id: The id of the role assignment approval stage. Required.\n        :type stage_id: str\n        :param properties: Role Assignment Approval stage properties to patch. Required.\n        :type properties: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: RoleAssignmentApprovalStep or the result of cls(response)\n        :rtype: ~azure.mgmt.authorization.v2021_01_01_preview.models.RoleAssignmentApprovalStep\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def patch(self, approval_id: str, stage_id: str, properties: Union[_models.RoleAssignmentApprovalStepProperties, IO], **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            return 10
        ...
        request = build_patch_request(approval_id=approval_id, stage_id=stage_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.patch.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    def put(self, approval_id: str, stage_id: str, properties: _models.RoleAssignmentApprovalStepProperties, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            while True:
                i = 10
    ...
    @overload
    def put(self, approval_id: str, stage_id: str, properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            i = 10
            return i + 15
        'Record a decision.\n\n        :param approval_id: The id of the role assignment approval. Required.\n        :type approval_id: str\n        :param stage_id: The id of the role assignment approval stage. Required.\n        :type stage_id: str\n        :param properties: Role Assignment Approval stage properties to put. Required.\n        :type properties: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: RoleAssignmentApprovalStep or the result of cls(response)\n        :rtype: ~azure.mgmt.authorization.v2021_01_01_preview.models.RoleAssignmentApprovalStep\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
    ...
    @distributed_trace
    def put(self, approval_id: str, stage_id: str, properties: Union[_models.RoleAssignmentApprovalStepProperties, IO], **kwargs: Any) -> _models.RoleAssignmentApprovalStep:
        if False:
            return 10
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, 'RoleAssignmentApprovalStepProperties')
        request = build_put_request(approval_id=approval_id, stage_id=stage_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.put.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
