...
try:
    ...
    text = str
__all__ = ['ExceptionInfo', 'TracebackInfo', 'Callpoint', 'ContextualExceptionInfo', 'ContextualTracebackInfo', 'ContextualCallpoint', 'print_exception', 'ParsedException']
...
_frame_re = re.compile('^File "(?P<filepath>.+)", line (?P<lineno>\\d+), in (?P<funcname>.+)$')
_se_frame_re = re.compile('^File "(?P<filepath>.+)", line (?P<lineno>\\d+)')
