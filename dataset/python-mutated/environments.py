...
import functools
import typing as t
from ..constants import CONTROLLER_PYTHON_VERSIONS, REMOTE_PROVIDERS, SECCOMP_CHOICES, SUPPORTED_PYTHON_VERSIONS
from ..util import REMOTE_ARCHITECTURES
from ..completion import docker_completion, network_completion, remote_completion, windows_completion, filter_completion
from ..cli.argparsing import CompositeAction, CompositeActionCompletionFinder
from ..cli.argparsing.actions import EnumAction
from ..cli.actions import DelegatedControllerAction, NetworkSshTargetAction, NetworkTargetAction, OriginControllerAction, PosixSshTargetAction, PosixTargetAction, SanityPythonTargetAction, UnitsPythonTargetAction, WindowsSshTargetAction, WindowsTargetAction
from ..cli.compat import TargetMode
from ..config import TerminateMode
from .completers import complete_choices, register_completer
from .converters import key_value_type
from .epilog import get_epilog
from ..ci import get_ci_provider
