...
def test_promotion_rule_delete(staff_api_client, permission_group_manage_discounts, promotion, count_queries):
    if False:
        return 10
    ...
    content = get_graphql_content(staff_api_client.post_graphql(PROMOTION_RULE_DELETE_MUTATION, variables))
