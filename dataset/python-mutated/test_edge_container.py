...
from google.cloud.edgecontainer_v1.services.edge_container import EdgeContainerAsyncClient, EdgeContainerClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(EdgeContainerClient, 'grpc'), (EdgeContainerAsyncClient, 'grpc_asyncio'), (EdgeContainerClient, 'rest')])
def test_edge_container_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        assert client.transport._host == ('edgecontainer.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://edgecontainer.googleapis.com')

@pytest.mark.parametrize('transport_class,transport_name', [(transports.EdgeContainerGrpcTransport, 'grpc'), (transports.EdgeContainerGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.EdgeContainerRestTransport, 'rest')])
...
def test_edge_container_client_get_transport_class():
    ...
    available_transports = [transports.EdgeContainerGrpcTransport, transports.EdgeContainerRestTransport]
    assert transport in available_transports
    transport = EdgeContainerClient.get_transport_class('grpc')
    assert transport == transports.EdgeContainerGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(EdgeContainerClient, transports.EdgeContainerGrpcTransport, 'grpc'), (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, 'grpc_asyncio'), (EdgeContainerClient, transports.EdgeContainerRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class', [EdgeContainerClient, EdgeContainerAsyncClient])
@mock.patch.object(EdgeContainerClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(EdgeContainerClient))
@mock.patch.object(EdgeContainerAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(EdgeContainerAsyncClient))
...
def test_edge_container_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerGrpcTransport.__init__') as grpc_transport:
        ...
        client = EdgeContainerClient(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(EdgeContainerClient, transports.EdgeContainerGrpcTransport, 'grpc', grpc_helpers), (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
def test_edge_container_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel') as create_channel:
        ...
        client = client_class(client_options=options, transport=transport_name)
        create_channel.assert_called_with('edgecontainer.googleapis.com:443', credentials=file_creds, credentials_file=None, quota_project_id=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=None, default_host='edgecontainer.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])
...
def test_list_clusters(request_type, transport: str='grpc'):
    if False:
        print('Hello World!')
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_clusters_empty_call():
    if False:
        while True:
            i = 10
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.list_clusters), '__call__') as call:
...
async def test_list_clusters_async(transport: str='grpc_asyncio', request_type=service.ListClustersRequest):
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_clusters), '__call__') as call:
...
def test_list_clusters_pager(transport_name: str='grpc'):
    if False:
        for i in range(10):
            print('nop')
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_clusters), '__call__') as call:
...
def test_get_cluster(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_cluster), '__call__') as call:
        call.return_value = resources.Cluster(name='name_value', default_max_pods_per_node=2634, endpoint='endpoint_value', cluster_ca_certificate='cluster_ca_certificate_value')
...
async def test_get_cluster_async(transport: str='grpc_asyncio', request_type=service.GetClusterRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_cluster), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Cluster(name='name_value', default_max_pods_per_node=2634, endpoint='endpoint_value', cluster_ca_certificate='cluster_ca_certificate_value'))
...
def test_create_cluster_flattened():
    ...
    with mock.patch.object(type(client.transport.create_cluster), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_cluster(parent='parent_value', cluster=resources.Cluster(name='name_value'), cluster_id='cluster_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_cluster_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_cluster(service.CreateClusterRequest(), parent='parent_value', cluster=resources.Cluster(name='name_value'), cluster_id='cluster_id_value')
...
async def test_create_cluster_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_cluster), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_cluster(parent='parent_value', cluster=resources.Cluster(name='name_value'), cluster_id='cluster_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_cluster_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_cluster(service.CreateClusterRequest(), parent='parent_value', cluster=resources.Cluster(name='name_value'), cluster_id='cluster_id_value')
...
def test_update_cluster_flattened():
    ...
    with mock.patch.object(type(client.transport.update_cluster), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_cluster(cluster=resources.Cluster(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].cluster
        mock_val = resources.Cluster(name='name_value')
...
def test_update_cluster_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_cluster(service.UpdateClusterRequest(), cluster=resources.Cluster(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_cluster_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_cluster), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_cluster(cluster=resources.Cluster(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].cluster
        mock_val = resources.Cluster(name='name_value')
...
async def test_update_cluster_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_cluster(service.UpdateClusterRequest(), cluster=resources.Cluster(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
@pytest.mark.parametrize('request_type', [service.GenerateAccessTokenRequest, dict])
def test_generate_access_token(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.generate_access_token), '__call__') as call:
        call.return_value = service.GenerateAccessTokenResponse(access_token='access_token_value')
...
async def test_generate_access_token_async(transport: str='grpc_asyncio', request_type=service.GenerateAccessTokenRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.generate_access_token), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.GenerateAccessTokenResponse(access_token='access_token_value'))
...
def test_generate_access_token_field_headers():
    ...
    with mock.patch.object(type(client.transport.generate_access_token), '__call__') as call:
        ...
        assert args[0] == request
    (_, _, kw) = call.mock_calls[0]
    assert ('x-goog-request-params', 'cluster=cluster_value') in kw['metadata']
...
def test_generate_access_token_flattened():
    ...
    with mock.patch.object(type(client.transport.generate_access_token), '__call__') as call:
        call.return_value = service.GenerateAccessTokenResponse()
        client.generate_access_token(cluster='cluster_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].cluster
...
def test_generate_access_token_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.generate_access_token(service.GenerateAccessTokenRequest(), cluster='cluster_value')
...
async def test_generate_access_token_flattened_async():
    ...
    with mock.patch.object(type(client.transport.generate_access_token), '__call__') as call:
        call.return_value = service.GenerateAccessTokenResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.GenerateAccessTokenResponse())
        response = await client.generate_access_token(cluster='cluster_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].cluster
        mock_val = 'cluster_value'
...
async def test_generate_access_token_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.generate_access_token(service.GenerateAccessTokenRequest(), cluster='cluster_value')

@pytest.mark.parametrize('request_type', [service.ListNodePoolsRequest, dict])
def test_list_node_pools(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_node_pools), '__call__') as call:
        call.return_value = service.ListNodePoolsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
async def test_list_node_pools_async(transport: str='grpc_asyncio', request_type=service.ListNodePoolsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_node_pools), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListNodePoolsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value']))
...
def test_list_node_pools_flattened():
    ...
    with mock.patch.object(type(client.transport.list_node_pools), '__call__') as call:
        call.return_value = service.ListNodePoolsResponse()
        client.list_node_pools(parent='parent_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_list_node_pools_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_node_pools(service.ListNodePoolsRequest(), parent='parent_value')
...
async def test_list_node_pools_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_node_pools), '__call__') as call:
        call.return_value = service.ListNodePoolsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListNodePoolsResponse())
        response = await client.list_node_pools(parent='parent_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_node_pools_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_node_pools(service.ListNodePoolsRequest(), parent='parent_value')
...
async def test_list_node_pools_async_pager():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_node_pools), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListNodePoolsResponse(node_pools=[resources.NodePool(), resources.NodePool(), resources.NodePool()], next_page_token='abc'), service.ListNodePoolsResponse(node_pools=[], next_page_token='def'), service.ListNodePoolsResponse(node_pools=[resources.NodePool()], next_page_token='ghi'), service.ListNodePoolsResponse(node_pools=[resources.NodePool(), resources.NodePool()]), RuntimeError)
...
@pytest.mark.parametrize('request_type', [service.GetNodePoolRequest, dict])
def test_get_node_pool(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_node_pool), '__call__') as call:
        call.return_value = resources.NodePool(name='name_value', node_location='node_location_value', node_count=1070, machine_filter='machine_filter_value')
...
async def test_get_node_pool_async(transport: str='grpc_asyncio', request_type=service.GetNodePoolRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_node_pool), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.NodePool(name='name_value', node_location='node_location_value', node_count=1070, machine_filter='machine_filter_value'))
...
def test_get_node_pool_flattened():
    ...
    with mock.patch.object(type(client.transport.get_node_pool), '__call__') as call:
        call.return_value = resources.NodePool()
        client.get_node_pool(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_get_node_pool_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_node_pool(service.GetNodePoolRequest(), name='name_value')
...
async def test_get_node_pool_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_node_pool), '__call__') as call:
        call.return_value = resources.NodePool()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.NodePool())
        response = await client.get_node_pool(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_get_node_pool_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_node_pool(service.GetNodePoolRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [service.CreateNodePoolRequest, dict])
...
def test_create_node_pool_flattened():
    ...
    with mock.patch.object(type(client.transport.create_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_node_pool(parent='parent_value', node_pool=resources.NodePool(name='name_value'), node_pool_id='node_pool_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_node_pool_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_node_pool(service.CreateNodePoolRequest(), parent='parent_value', node_pool=resources.NodePool(name='name_value'), node_pool_id='node_pool_id_value')
...
async def test_create_node_pool_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_node_pool(parent='parent_value', node_pool=resources.NodePool(name='name_value'), node_pool_id='node_pool_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_node_pool_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_node_pool(service.CreateNodePoolRequest(), parent='parent_value', node_pool=resources.NodePool(name='name_value'), node_pool_id='node_pool_id_value')

@pytest.mark.parametrize('request_type', [service.UpdateNodePoolRequest, dict])
...
def test_update_node_pool_field_headers():
    ...
    with mock.patch.object(type(client.transport.update_node_pool), '__call__') as call:
        ...
        assert args[0] == request
    (_, _, kw) = call.mock_calls[0]
    assert ('x-goog-request-params', 'node_pool.name=name_value') in kw['metadata']
...
def test_update_node_pool_flattened():
    ...
    with mock.patch.object(type(client.transport.update_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_node_pool(node_pool=resources.NodePool(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].node_pool
        mock_val = resources.NodePool(name='name_value')
...
def test_update_node_pool_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_node_pool(service.UpdateNodePoolRequest(), node_pool=resources.NodePool(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_node_pool_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_node_pool(node_pool=resources.NodePool(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].node_pool
        mock_val = resources.NodePool(name='name_value')
...
async def test_update_node_pool_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_node_pool(service.UpdateNodePoolRequest(), node_pool=resources.NodePool(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))

@pytest.mark.parametrize('request_type', [service.DeleteNodePoolRequest, dict])
...
def test_delete_node_pool_flattened():
    ...
    with mock.patch.object(type(client.transport.delete_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_node_pool(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_delete_node_pool_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_node_pool(service.DeleteNodePoolRequest(), name='name_value')
...
async def test_delete_node_pool_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_node_pool), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.delete_node_pool(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_delete_node_pool_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_node_pool(service.DeleteNodePoolRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [service.ListMachinesRequest, dict])
def test_list_machines(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_machines), '__call__') as call:
        call.return_value = service.ListMachinesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
async def test_list_machines_async(transport: str='grpc_asyncio', request_type=service.ListMachinesRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_machines), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListMachinesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value']))
...
def test_list_machines_flattened():
    ...
    with mock.patch.object(type(client.transport.list_machines), '__call__') as call:
        call.return_value = service.ListMachinesResponse()
        client.list_machines(parent='parent_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_list_machines_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_machines(service.ListMachinesRequest(), parent='parent_value')
...
async def test_list_machines_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_machines), '__call__') as call:
        call.return_value = service.ListMachinesResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListMachinesResponse())
        response = await client.list_machines(parent='parent_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_machines_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_machines(service.ListMachinesRequest(), parent='parent_value')
...
def test_list_machines_pager(transport_name: str='grpc'):
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_machines), '__call__') as call:
        call.side_effect = (service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine(), resources.Machine()], next_page_token='abc'), service.ListMachinesResponse(machines=[], next_page_token='def'), service.ListMachinesResponse(machines=[resources.Machine()], next_page_token='ghi'), service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine()]), RuntimeError)
        metadata = ()
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', ''),)),)
...
async def test_list_machines_async_pager():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_machines), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine(), resources.Machine()], next_page_token='abc'), service.ListMachinesResponse(machines=[], next_page_token='def'), service.ListMachinesResponse(machines=[resources.Machine()], next_page_token='ghi'), service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine()]), RuntimeError)
...
@pytest.mark.parametrize('request_type', [service.GetMachineRequest, dict])
def test_get_machine(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_machine), '__call__') as call:
        call.return_value = resources.Machine(name='name_value', hosted_node='hosted_node_value', zone='zone_value', disabled=True)
...
async def test_get_machine_async(transport: str='grpc_asyncio', request_type=service.GetMachineRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_machine), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Machine(name='name_value', hosted_node='hosted_node_value', zone='zone_value', disabled=True))
...
def test_get_machine_flattened():
    ...
    with mock.patch.object(type(client.transport.get_machine), '__call__') as call:
        call.return_value = resources.Machine()
        client.get_machine(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_get_machine_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_machine(service.GetMachineRequest(), name='name_value')
...
async def test_get_machine_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_machine), '__call__') as call:
        call.return_value = resources.Machine()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Machine())
        response = await client.get_machine(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_get_machine_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_machine(service.GetMachineRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [service.ListVpnConnectionsRequest, dict])
def test_list_vpn_connections(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__') as call:
        call.return_value = service.ListVpnConnectionsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
async def test_list_vpn_connections_async(transport: str='grpc_asyncio', request_type=service.ListVpnConnectionsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListVpnConnectionsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value']))
...
def test_list_vpn_connections_flattened():
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__') as call:
        call.return_value = service.ListVpnConnectionsResponse()
        client.list_vpn_connections(parent='parent_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_list_vpn_connections_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_vpn_connections(service.ListVpnConnectionsRequest(), parent='parent_value')
...
async def test_list_vpn_connections_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__') as call:
        call.return_value = service.ListVpnConnectionsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListVpnConnectionsResponse())
        response = await client.list_vpn_connections(parent='parent_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_vpn_connections_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_vpn_connections(service.ListVpnConnectionsRequest(), parent='parent_value')
...
def test_list_vpn_connections_pager(transport_name: str='grpc'):
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__') as call:
        call.side_effect = (service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection(), resources.VpnConnection()], next_page_token='abc'), service.ListVpnConnectionsResponse(vpn_connections=[], next_page_token='def'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection()], next_page_token='ghi'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection()]), RuntimeError)
        metadata = ()
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', ''),)),)
...
async def test_list_vpn_connections_async_pager():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_vpn_connections), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection(), resources.VpnConnection()], next_page_token='abc'), service.ListVpnConnectionsResponse(vpn_connections=[], next_page_token='def'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection()], next_page_token='ghi'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection()]), RuntimeError)
...
@pytest.mark.parametrize('request_type', [service.GetVpnConnectionRequest, dict])
def test_get_vpn_connection(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), '__call__') as call:
        call.return_value = resources.VpnConnection(name='name_value', nat_gateway_ip='nat_gateway_ip_value', bgp_routing_mode=resources.VpnConnection.BgpRoutingMode.REGIONAL, cluster='cluster_value', vpc='vpc_value', enable_high_availability=True)
...
async def test_get_vpn_connection_async(transport: str='grpc_asyncio', request_type=service.GetVpnConnectionRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_vpn_connection), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.VpnConnection(name='name_value', nat_gateway_ip='nat_gateway_ip_value', bgp_routing_mode=resources.VpnConnection.BgpRoutingMode.REGIONAL, cluster='cluster_value', vpc='vpc_value', enable_high_availability=True))
...
def test_get_vpn_connection_flattened():
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), '__call__') as call:
        call.return_value = resources.VpnConnection()
        client.get_vpn_connection(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_get_vpn_connection_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_vpn_connection(service.GetVpnConnectionRequest(), name='name_value')
...
async def test_get_vpn_connection_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_vpn_connection), '__call__') as call:
        call.return_value = resources.VpnConnection()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.VpnConnection())
        response = await client.get_vpn_connection(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_get_vpn_connection_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_vpn_connection(service.GetVpnConnectionRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [service.CreateVpnConnectionRequest, dict])
...
def test_create_vpn_connection_flattened():
    ...
    with mock.patch.object(type(client.transport.create_vpn_connection), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_vpn_connection(parent='parent_value', vpn_connection=resources.VpnConnection(name='name_value'), vpn_connection_id='vpn_connection_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_vpn_connection_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_vpn_connection(service.CreateVpnConnectionRequest(), parent='parent_value', vpn_connection=resources.VpnConnection(name='name_value'), vpn_connection_id='vpn_connection_id_value')
...
async def test_create_vpn_connection_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_vpn_connection), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_vpn_connection(parent='parent_value', vpn_connection=resources.VpnConnection(name='name_value'), vpn_connection_id='vpn_connection_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_vpn_connection_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_vpn_connection(service.CreateVpnConnectionRequest(), parent='parent_value', vpn_connection=resources.VpnConnection(name='name_value'), vpn_connection_id='vpn_connection_id_value')

@pytest.mark.parametrize('request_type', [service.DeleteVpnConnectionRequest, dict])
...
def test_delete_vpn_connection_flattened():
    ...
    with mock.patch.object(type(client.transport.delete_vpn_connection), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_vpn_connection(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_delete_vpn_connection_flattened_error():
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_vpn_connection(service.DeleteVpnConnectionRequest(), name='name_value')
...
async def test_delete_vpn_connection_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_vpn_connection), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.delete_vpn_connection(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_delete_vpn_connection_flattened_error_async():
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_vpn_connection(service.DeleteVpnConnectionRequest(), name='name_value')
...
def test_list_clusters_rest(request_type):
    if False:
        for i in range(10):
            print('nop')
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_list_clusters_rest_interceptors(null_interceptor):
    if False:
        for i in range(10):
            print('nop')
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_list_clusters') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_list_clusters') as pre:
...
def test_get_cluster_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = resources.Cluster(name='name_value', default_max_pods_per_node=2634, endpoint='endpoint_value', cluster_ca_certificate='cluster_ca_certificate_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_cluster_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_get_cluster') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_get_cluster') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_cluster_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_create_cluster') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_create_cluster') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2'}
        mock_args = dict(parent='parent_value', cluster=resources.Cluster(name='name_value'), cluster_id='cluster_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_update_cluster_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_update_cluster') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_update_cluster') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_cluster_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(cluster=resources.Cluster(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_delete_cluster_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_delete_cluster') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_delete_cluster') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_access_token_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.GenerateAccessTokenResponse(access_token='access_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_generate_access_token_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_generate_access_token') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_generate_access_token') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_generate_access_token_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(cluster='cluster_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = service.GenerateAccessTokenResponse.pb(return_value)
...
def test_list_node_pools_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.ListNodePoolsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_list_node_pools_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_list_node_pools') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_list_node_pools') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_node_pools_rest_pager(transport: str='rest'):
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (service.ListNodePoolsResponse(node_pools=[resources.NodePool(), resources.NodePool(), resources.NodePool()], next_page_token='abc'), service.ListNodePoolsResponse(node_pools=[], next_page_token='def'), service.ListNodePoolsResponse(node_pools=[resources.NodePool()], next_page_token='ghi'), service.ListNodePoolsResponse(node_pools=[resources.NodePool(), resources.NodePool()]))
        response = response + response
...
def test_get_node_pool_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = resources.NodePool(name='name_value', node_location='node_location_value', node_count=1070, machine_filter='machine_filter_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_node_pool_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_get_node_pool') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_get_node_pool') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_node_pool_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['node_pool'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_create_node_pool_rest_required_fields(request_type=service.CreateNodePoolRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            req.return_value = response_value
            response = client.create_node_pool(request)
            expected_params = [('nodePoolId', ''), ('$alt', 'json;enum-encoding=int')]
            actual_params = req.call_args.kwargs['params']
            assert expected_params == actual_params
...
def test_create_node_pool_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_create_node_pool') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_create_node_pool') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_node_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2/clusters/sample3'}
        mock_args = dict(parent='parent_value', node_pool=resources.NodePool(name='name_value'), node_pool_id='node_pool_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_update_node_pool_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_update_node_pool') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_update_node_pool') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_node_pool_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(node_pool=resources.NodePool(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_delete_node_pool_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_delete_node_pool') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_delete_node_pool') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_machines_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.ListMachinesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_list_machines_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_list_machines') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_list_machines') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_machines_rest_pager(transport: str='rest'):
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine(), resources.Machine()], next_page_token='abc'), service.ListMachinesResponse(machines=[], next_page_token='def'), service.ListMachinesResponse(machines=[resources.Machine()], next_page_token='ghi'), service.ListMachinesResponse(machines=[resources.Machine(), resources.Machine()]))
        response = response + response
...
def test_get_machine_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = resources.Machine(name='name_value', hosted_node='hosted_node_value', zone='zone_value', disabled=True)
        response_value = Response()
        response_value.status_code = 200
...
def test_get_machine_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_get_machine') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_get_machine') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_vpn_connections_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.ListVpnConnectionsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_list_vpn_connections_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_list_vpn_connections') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_list_vpn_connections') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_vpn_connections_rest_pager(transport: str='rest'):
    ...
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection(), resources.VpnConnection()], next_page_token='abc'), service.ListVpnConnectionsResponse(vpn_connections=[], next_page_token='def'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection()], next_page_token='ghi'), service.ListVpnConnectionsResponse(vpn_connections=[resources.VpnConnection(), resources.VpnConnection()]))
        response = response + response
...
def test_get_vpn_connection_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = resources.VpnConnection(name='name_value', nat_gateway_ip='nat_gateway_ip_value', bgp_routing_mode=resources.VpnConnection.BgpRoutingMode.REGIONAL, cluster='cluster_value', vpc='vpc_value', enable_high_availability=True)
        response_value = Response()
        response_value.status_code = 200
...
def test_get_vpn_connection_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_get_vpn_connection') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_get_vpn_connection') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_vpn_connection_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['vpn_connection'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_create_vpn_connection_rest_required_fields(request_type=service.CreateVpnConnectionRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            req.return_value = response_value
            response = client.create_vpn_connection(request)
            expected_params = [('vpnConnectionId', ''), ('$alt', 'json;enum-encoding=int')]
            actual_params = req.call_args.kwargs['params']
            assert expected_params == actual_params
...
def test_create_vpn_connection_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_create_vpn_connection') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_create_vpn_connection') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_vpn_connection_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2'}
        mock_args = dict(parent='parent_value', vpn_connection=resources.VpnConnection(name='name_value'), vpn_connection_id='vpn_connection_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_delete_vpn_connection_rest_interceptors(null_interceptor):
    ...
    transport = transports.EdgeContainerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.EdgeContainerRestInterceptor())
    client = EdgeContainerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.EdgeContainerRestInterceptor, 'post_delete_vpn_connection') as post, mock.patch.object(transports.EdgeContainerRestInterceptor, 'pre_delete_vpn_connection') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        print('Hello World!')
    transport = transports.EdgeContainerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.EdgeContainerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = EdgeContainerClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.EdgeContainerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = EdgeContainerClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = EdgeContainerClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.EdgeContainerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = EdgeContainerClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.EdgeContainerGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.EdgeContainerGrpcTransport, transports.EdgeContainerGrpcAsyncIOTransport, transports.EdgeContainerRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        for i in range(10):
            print('nop')
    transport = EdgeContainerClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        for i in range(10):
            print('nop')
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.EdgeContainerGrpcTransport)
...
def test_edge_container_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.EdgeContainerTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_edge_container_base_transport():
    ...
    with mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerTransport.__init__') as Transport:
        ...
        transport = transports.EdgeContainerTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_clusters', 'get_cluster', 'create_cluster', 'update_cluster', 'delete_cluster', 'generate_access_token', 'list_node_pools', 'get_node_pool', 'create_node_pool', 'update_node_pool', 'delete_node_pool', 'list_machines', 'get_machine', 'list_vpn_connections', 'get_vpn_connection', 'create_vpn_connection', 'delete_vpn_connection', 'get_location', 'list_locations', 'get_operation', 'cancel_operation', 'delete_operation', 'list_operations')
...
def test_edge_container_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.edgecontainer_v1.services.edge_container.transports.EdgeContainerTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.EdgeContainerTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.EdgeContainerGrpcTransport, grpc_helpers), (transports.EdgeContainerGrpcAsyncIOTransport, grpc_helpers_async)])
def test_edge_container_transport_create_channel(transport_class, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel', autospec=True) as create_channel:
        ...
        adc.return_value = (creds, None)
        transport_class(quota_project_id='octopus', scopes=['1', '2'])
        create_channel.assert_called_with('edgecontainer.googleapis.com:443', credentials=creds, credentials_file=None, quota_project_id='octopus', default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=['1', '2'], default_host='edgecontainer.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])
...
def test_edge_container_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.EdgeContainerRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_edge_container_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='edgecontainer.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('edgecontainer.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://edgecontainer.googleapis.com')
...
def test_edge_container_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='edgecontainer.googleapis.com:8000'), transport=transport_name)
    assert client.transport._host == ('edgecontainer.googleapis.com:8000' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://edgecontainer.googleapis.com:8000')
...
def test_edge_container_client_transport_session_collision(transport_name):
    ...
    client1 = EdgeContainerClient(credentials=creds1, transport=transport_name)
    client2 = EdgeContainerClient(credentials=creds2, transport=transport_name)
...
def test_edge_container_grpc_transport_channel():
    ...
    transport = transports.EdgeContainerGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_edge_container_grpc_asyncio_transport_channel():
    ...
    transport = transports.EdgeContainerGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_edge_container_grpc_lro_async_client():
    if False:
        while True:
            i = 10
    client = EdgeContainerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_parse_crypto_key_version_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'mussel', 'location': 'winkle', 'key_ring': 'nautilus', 'crypto_key': 'scallop', 'crypto_key_version': 'abalone'}
...
def test_parse_machine_path():
    if False:
        print('Hello World!')
    expected = {'project': 'octopus', 'location': 'oyster', 'machine': 'nudibranch'}
...
def test_parse_node_pool_path():
    if False:
        print('Hello World!')
    expected = {'project': 'scallop', 'location': 'abalone', 'cluster': 'squid', 'node_pool': 'clam'}
...
def test_parse_vpn_connection_path():
    if False:
        print('Hello World!')
    expected = {'project': 'nudibranch', 'location': 'cuttlefish', 'vpn_connection': 'mussel'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.EdgeContainerTransport, '_prep_wrapped_messages') as prep:
        client = EdgeContainerClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(EdgeContainerClient, transports.EdgeContainerGrpcTransport), (EdgeContainerAsyncClient, transports.EdgeContainerGrpcAsyncIOTransport)])
