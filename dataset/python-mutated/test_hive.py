...
if PY311:
    pytest.skip('The tests are skipped because Apache Hive provider is not supported on Python 3.11', allow_module_level=True)
import datetime
import itertools
...
from tests.providers.apache.hive import BaseMockConnectionCursor, InvalidHiveCliHook, MockHiveCliHook, MockHiveServer2Hook, MockSubProcess
