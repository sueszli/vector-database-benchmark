...
EVENTS = [EventLogEntry(run_id='1', error_info=None, level=20, user_message='foo', timestamp=1.0, dagster_event=DagsterEvent(event_type_value='STEP_START', job_name='foo')), EventLogEntry(run_id='1', error_info=None, level=20, user_message='bar', timestamp=2.0, dagster_event=None), EventLogEntry(run_id='1', error_info=None, level=20, user_message='baz', timestamp=3.0, dagster_event=DagsterEvent(event_type_value='STEP_SUCCESS', job_name='foo', event_specific_data=StepSuccessData(duration_ms=2.0)))]
