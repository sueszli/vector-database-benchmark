...
class MyTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            i = 10
            return i + 15
        fixtures = {'centos_7_7_foo': ('fixtures/centos-7.7/foo.out', 'fixtures/centos-7.7/foo.json')}
    ...
    def test_foo_centos_7_7(self):
        ...
        self.assertEqual(parse(self.f_in['centos_7_7_foo'], quiet=True), self.f_json['centos_7_7_foo'])
