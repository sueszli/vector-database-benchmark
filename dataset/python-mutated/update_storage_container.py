...
def main():
    ...
    response = client.storage_containers.begin_update(resource_group_name='test-rg', storage_container_name='Default_Container', storage_containers={'tags': {'additionalProperties': 'sample'}}).result()
    print(response)
