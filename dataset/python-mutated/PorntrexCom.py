...
class PorntrexCom(SimpleDownloader):
    ...
    __version__ = '0.01'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?porntrex\\.com/video/.+'
    __config__ = [('enabled', 'bool', 'Activated', True), ('chk_filesize', 'bool', 'Check file size', True), ('quality', '360p;480p;720p;1080p;1440p;2160p', 'Quality Setting', '1080p')]
    __description__ = 'Porntrex.com downloader plugin'
    __license__ = 'GPLv3'
    __authors__ = [('ondrej', 'git@ondrej.it')]
    NAME_PATTERN = '<p class="title-video">(?P<N>.+?)</p>'
    OFFLINE_PATTERN = '<title>page not found</title>'
    DISPOSITION = False
