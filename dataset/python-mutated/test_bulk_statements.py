...
@testing.combinations(('no_sentinel', False), ('w_sentinel', True), argnames='use_sentinel', id_='ia')
@testing.combinations(('nonrandom', False), ('random', True), argnames='randomize_returning', id_='ia')
class BulkDMLReturningJoinedInhTest(BulkDMLReturningInhTest, fixtures.DeclarativeMappedTest):
...
@testing.combinations(('nonrandom', False), ('random', True), argnames='randomize_returning', id_='ia')
class BulkDMLReturningSingleInhTest(BulkDMLReturningInhTest, fixtures.DeclarativeMappedTest):
    __requires__ = ('insert_returning', 'insert_executemany_returning')
    __backend__ = True
...
@testing.combinations(('nonrandom', False), ('random', True), argnames='randomize_returning', id_='ia')
class BulkDMLReturningConcreteInhTest(BulkDMLReturningInhTest, fixtures.DeclarativeMappedTest):
    __requires__ = ('insert_returning', 'insert_executemany_returning')
    __backend__ = True
