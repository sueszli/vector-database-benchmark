...
class KademliaDatagramBase:
    ...
    """
    required_fields = ['packet_type', 'rpc_id', 'node_id']
...
class RequestDatagram(KademliaDatagramBase):
    required_fields = ['packet_type', 'rpc_id', 'node_id', 'method', 'args']
...
class ResponseDatagram(KademliaDatagramBase):
    required_fields = ['packet_type', 'rpc_id', 'node_id', 'response']
...
class ErrorDatagram(KademliaDatagramBase):
    required_fields = ['packet_type', 'rpc_id', 'node_id', 'exception_type', 'response']
