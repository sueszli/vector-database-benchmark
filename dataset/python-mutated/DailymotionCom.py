...
class DailymotionCom(BaseDownloader):
    ...
    __version__ = '0.32'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?(?:dailymotion\\.com/.*video|dai\\.ly)/(?P<ID>[\\w^_]+)'
    __config__ = [('enabled', 'bool', 'Activated', True), ('quality', 'Lowest;LD 144p;LD 240p;SD 380p;HQ 480p;HD 720p;HD 1080p;Highest', 'Quality', 'Highest')]
    __description__ = 'Dailymotion.com downloader plugin'
    __license__ = 'GPLv3'
    __authors__ = [('Walter Purcaro', 'vuolter@gmail.com'), ('Synology PAT', 'pat@synology.com'), ('GammaC0de', 'nitzo2001[AT}yahoo[DOT]com')]
    STREAM_PATTERN = '\\"(?P<URL>https?:\\\\/\\\\/www.dailymotion.com\\\\/cdn\\\\/H264-(?P<QF_WIDTH>\\d+)x(?P<QF_HEIGHT>\\d+).*?)\\"'
