...
from AnyQt.QtWidgets import QSizePolicy, QWidget, QGridLayout, QLabel, QLineEdit, QVBoxLayout, QPushButton, QDoubleSpinBox, QCheckBox
...
class OWCurveFit(OWBaseLearner):
    ...
    class Warning(OWBaseLearner.Warning):
        ...
        unused_parameter = Msg("Unused parameter '{}' in 'Parameters' declaration.")
    ...
    class Error(OWBaseLearner.Error):
        ...
        parameter_in_attrs = Msg("Some parameters and features have the same name '{}'.")
