...
pu.run_tests([test_all_categoricals_are_encoded_by_default, test_columns_to_encode_can_be_specified_as_x, test_non_categorical_columns_are_ignored, test_te_model_does_nothing_if_there_is_no_categorical_column_to_encode, test_fold_column_is_not_encoded, test_columns_to_encode_can_be_listed_in_dedicated_param, test_columns_groups_are_encoded_as_a_single_interaction, columns_listed_in_columns_to_encode_should_not_be_ignored_in_x])