...
class Exploit(HTTPClient):
    __info__ = {'name': 'ZTE ZXV10 RCE', 'description': 'Exploits ZTE ZXV10 H108L remote code execution vulnerability that allows executing commands on operating system level.', 'authors': ('Anastasios Stasinopoulos', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://github.com/stasinopoulos/ZTExploit/',), 'devices': ('ZTE ZXV10 H108L',)}
