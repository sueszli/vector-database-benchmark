...
class WebReaderToolInput(BaseModel):
    ...
    summary: bool = Field(default=False, description="When the user's question requires extracting the summarizing content of the webpage, set it to true.")
    cursor: int = Field(default=0, description='Start reading from this character.Use when the first response was truncatedand you want to continue reading the page.The value cannot exceed 24000.')
...
class WebReaderTool(BaseTool):
    ...
    description: str = 'use this to read a website. If you can answer the question based on the information provided, there is no need to use.'
