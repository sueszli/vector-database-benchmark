...
add_short_configs = op_bench.config_list(attr_names=['M', 'N', 'K'], attrs=[[8, 16, 32], [16, 16, 64], [64, 64, 128]], cross_product_configs={'device': ['cpu', 'cuda'], 'dtype': [torch.float, torch.float64]}, tags=['short'])
