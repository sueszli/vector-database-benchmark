...
def test_tuning(training_data_filename: str) -> None:
    ...
    tuned_model = tuning.tuning(training_data=training_data_filename, project_id=_PROJECT_ID, location=_LOCATION, model_display_name='YOUR_TUNED_MODEL', train_steps=1, evaluation_dataset=training_data_filename, tensorboard_instance_name='python-docs-samples-test')
    try:
