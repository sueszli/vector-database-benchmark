...
if is_torch_available():
    import torch
    from transformers import ErnieMForInformationExtraction, ErnieMForMultipleChoice, ErnieMForQuestionAnswering, ErnieMForSequenceClassification, ErnieMForTokenClassification, ErnieMModel
...
class ErnieMModelTester:
    ...
    def get_config(self):
        if False:
            print('Hello World!')
        return ErnieMConfig(vocab_size=self.vocab_size, hidden_size=self.hidden_size, num_hidden_layers=self.num_hidden_layers, num_attention_heads=self.num_attention_heads, intermediate_size=self.intermediate_size, hidden_act=self.hidden_act, hidden_dropout_prob=self.hidden_dropout_prob, attention_probs_dropout_prob=self.attention_probs_dropout_prob, max_position_embeddings=self.max_position_embeddings, type_vocab_size=self.type_vocab_size, initializer_range=self.initializer_range)
    ...
    def create_and_check_for_question_answering(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            print('Hello World!')
    ...
    def create_and_check_for_information_extraction(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            return 10
    ...
    def create_and_check_for_sequence_classification(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            while True:
                i = 10
    ...
    def create_and_check_for_multiple_choice(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            i = 10
            return i + 15
...
class ErnieMModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (ErnieMModel, ErnieMForMultipleChoice, ErnieMForQuestionAnswering, ErnieMForSequenceClassification, ErnieMForTokenClassification) if is_torch_available() else ()
    all_generative_model_classes = ()
    pipeline_model_mapping = {'feature-extraction': ErnieMModel, 'question-answering': ErnieMForQuestionAnswering, 'text-classification': ErnieMForSequenceClassification, 'token-classification': ErnieMForTokenClassification, 'zero-shot': ErnieMForSequenceClassification} if is_torch_available() else {}
...
class ErnieMModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_model(self):
        ...
        expected_slice = torch.tensor([[[-0.0012, 0.1245, -0.0214], [-0.0742, 0.0244, -0.0771], [-0.0333, 0.1164, -0.1554]]])
