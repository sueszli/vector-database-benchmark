...
def main():
    ...
    response = client.storage_accounts.list_sas_tokens(resource_group_name='contosorg', account_name='contosoadla', storage_account_name='test_storage', container_name='test_container')
