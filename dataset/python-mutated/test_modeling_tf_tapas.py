...
if is_tf_available():
    ...
    from transformers import TFTapasForMaskedLM, TFTapasForQuestionAnswering, TFTapasForSequenceClassification, TFTapasModel
    from transformers.models.tapas.modeling_tf_tapas import IndexMap, ProductIndexMap, flatten, gather, range_index_map, reduce_max, reduce_mean, reduce_sum
...
class TFTapasModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFTapasModel, TFTapasForMaskedLM, TFTapasForSequenceClassification, TFTapasForQuestionAnswering) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFTapasModel, 'fill-mask': TFTapasForMaskedLM, 'text-classification': TFTapasForSequenceClassification, 'zero-shot': TFTapasForSequenceClassification} if is_tf_available() else {}
