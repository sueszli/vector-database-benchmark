from hamcrest import all_of, any_of, assert_that, calling, close_to, contains_exactly, equal_to, has_entries, has_key, has_length, has_properties, instance_of, is_, raises
