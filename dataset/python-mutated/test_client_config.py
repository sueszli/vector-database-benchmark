...
region_data = [Region('us', 1, 'http://us.testserver', RegionCategory.MULTI_TENANT), Region('eu', 2, 'http://eu.testserver', RegionCategory.MULTI_TENANT), Region('acme', 3, 'http://acme.testserver', RegionCategory.SINGLE_TENANT)]
