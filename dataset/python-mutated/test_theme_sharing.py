...
versions = ['0.1.0', '0.1.1', '0.1.2', '0.1.3', '0.4.4', '0.5.0', '0.7.0', '0.9.2', '0.9.3', '0.9.4', '0.9.5', '0.9.6', '0.9.7', '0.9.8', '2.2.0', '2.2.1', '2.2.10', '2.2.11', '2.2.12', '2.2.13', '2.2.14', '2.2.15', '2.2.2', '2.2.3', '2.2.4', '2.2.5', '2.2.6', '2.2.7', '2.2.8', '3.0.1', '3.0.10', '3.0.11', '3.0.12', '3.0.13', '3.0.14', '3.0.15', '3.0.16', '3.0.17', '3.0.18', '3.0.19', '3.0.2', '3.0.20', '3.0.20-dev0', '3.0.21', '3.0.22', '3.0.23', '3.0.23-dev1', '3.0.24', '3.0.25', '3.0.26', '3.0.3', '3.0.4', '3.0.5', '3.0.6', '3.0.7', '3.0.8', '3.0.9', '3.1.0', '3.1.1', '3.1.2', '3.1.3', '3.1.4', '3.1.5', '3.1.6', '3.1.7', '3.10.0', '3.10.1', '3.11.0', '3.12.0', '3.13.0', '3.13.1', '3.13.2', '3.14.0', '3.15.0', '3.16.0', '3.16.1', '3.16.2', '3.17.0', '3.17.1', '3.18.0', '3.18.1', '3.18.1-dev0', '3.18.2-dev0', '3.18.2', '3.19.0', '3.19.1', '3.20.0', '3.20.1', '3.3.1', '3.4.1', '3.8.1', '3.8.2', '3.9.1']
assets = [ThemeAsset(f'theme_schema@{version}') for version in versions]
dracula_gray = gr.themes.colors.Color(*['#6272a4', '#7280ad', '#818eb6', '#919cbf', '#a1aac8'][::-1] + ['#586794', '#4e5b83', '#455073', '#3b4462', '#313952', '#272e42'])
dracula_pink = gr.themes.Color(*['#ffd7ee', '#ff79c6', '#ff86cc', '#ff94d1', '#ffa1d7', '#ffafdd', '#ffbce3', '#ffc9e8'][::-1] + ['#e66db2', '#cc619e', '#b3558b'])
dracula_gray = gr.themes.colors.Color(*['#6272a4', '#7280ad', '#818eb6', '#919cbf', '#a1aac8'][::-1] + ['#586794', '#4e5b83', '#455073', '#3b4462', '#313952', '#272e42'])
dracula = gr.themes.Base(primary_hue=gr.themes.colors.pink, neutral_hue=dracula_gray, font=gr.themes.GoogleFont('Poppins')).set(body_background_fill=dracula_gray.c500, color_accent_soft=dracula_gray.c100, error_border_color='#fecaca', error_background_fill='#fee2e2', error_icon_color='#b91c1c', error_icon_color_dark='#ef4444', error_text_color='#ef4444', error_text_color_dark='#ef4444', background_fill_primary=dracula_gray.c500, background_fill_secondary=dracula_gray.c500, block_background_fill=dracula_gray.c300, body_text_color='#f8f8f2', body_text_color_dark='#f8f8f2', body_text_color_subdued='#f8f8f2', block_label_text_color='#f8f8f2', block_label_text_color_dark='#f8f8f2', table_even_background_fill=dracula_gray.c300, border_color_accent=dracula_gray.c200, block_info_text_color='#f8f8f2', block_info_text_color_dark='#f8f8f2', block_title_text_color='#f8f8f2', block_title_text_color_dark='#f8f8f2', checkbox_background_color_selected_dark='#ff79c6', checkbox_background_color_selected='#ff79c6', button_primary_background_fill_dark='#ff79c6', button_primary_background_fill=dracula_pink.c300, button_secondary_text_color='#f8f8f2', slider_color_dark='#ff79c6', slider_color=dracula_pink.c300, panel_background_fill='#31395294', block_background_fill_dark='#31395294')
