...
DIMENSION = 3
METRICS = {'euclidean': {}, 'manhattan': {}, 'minkowski': dict(p=3), 'chebyshev': {}}
DISCRETE_METRICS = ['hamming', 'canberra', 'braycurtis']
BOOLEAN_METRICS = ['jaccard', 'dice', 'rogerstanimoto', 'russellrao', 'sokalmichener', 'sokalsneath']
BALL_TREE_CLASSES = [BallTree64, BallTree32]
