...
flags.DEFINE_integer('save_every', int(10000.0), 'Episode frequency at which the DQN agent models are saved.')
...
flags.DEFINE_integer('eval_episodes', 1000, 'How many episodes to run per eval.')
flags.DEFINE_list('hidden_layers_sizes', [64, 64, 64], 'Number of hidden units in the Q-Network MLP.')
flags.DEFINE_integer('replay_buffer_capacity', int(100000.0), 'Size of the replay buffer.')
