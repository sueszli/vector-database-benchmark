...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [('zerver', '0418_archivedmessage_realm_message_realm')]
    operations = [migrations.RunPython(backfill_message_realm, reverse_code=migrations.RunPython.noop, elidable=True)]