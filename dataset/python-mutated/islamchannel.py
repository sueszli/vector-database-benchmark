...
class IslamChannelIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://watch.islamchannel.tv/watch/38604310', 'info_dict': {'id': '38604310', 'title': 'Omar - Young Omar', 'description': 'md5:5cc7ddecef064ea7afe52eb5e0e33b55', 'thumbnail': 're:https?://.+', 'ext': 'mp4'}}]
...
class IslamChannelSeriesIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://watch.islamchannel.tv/series/a6cccef3-3ef1-11eb-bc19-06b69c2357cd', 'info_dict': {'id': 'a6cccef3-3ef1-11eb-bc19-06b69c2357cd'}, 'playlist_mincount': 31}]
