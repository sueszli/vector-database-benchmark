...
def _faulty_tensorpipe_init_backend_handler(store, name, rank, world_size, rpc_backend_options):
    ...
    return agent
rpc.backend_registry.register_backend('FAULTY_TENSORPIPE', _faulty_tensorpipe_construct_rpc_backend_options_handler, _faulty_tensorpipe_init_backend_handler)