...
from modin.pandas.test.utils import axis_keys, axis_values, bool_arg_keys, bool_arg_values, create_test_dfs, default_to_pandas_ignore_string, df_equals, eval_general, generate_multiindex, modin_df_almost_equals_pandas, name_contains, numeric_dfs, test_data, test_data_diff_dtype, test_data_keys, test_data_large_categorical_dataframe, test_data_resample, test_data_values
from modin.test.test_utils import warns_that_defaulting_to_pandas
from modin.utils import get_current_execution, to_pandas
NPartitions.put(4)
matplotlib.use('Agg')
pytestmark = [pytest.mark.filterwarnings(default_to_pandas_ignore_string), pytest.mark.filterwarnings('ignore:.*bool is now deprecated and will be removed:FutureWarning'), pytest.mark.filterwarnings('ignore:first is deprecated and will be removed:FutureWarning'), pytest.mark.filterwarnings('ignore:last is deprecated and will be removed:FutureWarning')]
