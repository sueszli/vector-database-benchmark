...
import numpy as np
from sklearn.datasets import fetch_20newsgroups_vectorized, fetch_rcv1, load_digits, load_iris
...
if __name__ == '__main__':
    ...
    for penalty in penalties:
        for n_sample in n_samples:
            exp(solvers, penalty, single_target, n_samples=n_sample, n_jobs=1, dataset='rcv1', max_iter=10)
