...
class AntiCaptcha(BaseAddon):
    ...
    __version__ = '0.02'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('check_client', 'bool', "Don't use if client is connected", True), ('solve_image', 'bool', 'Solve image catcha', True), ('solve_recaptcha', 'bool', 'Solve ReCaptcha', True), ('solve_hcaptcha', 'bool', 'Solve HCaptcha', True), ('refund', 'bool', 'Request refund if result incorrect', False), ('passkey', 'password', 'API key', ''), ('timeout', 'int', 'Timeout in seconds (min 60, max 3999)', '900')]
    __description__ = 'Send captchas to anti-captcha.com'
    __license__ = 'GPLv3'
    __authors__ = [('GammaC0de', 'nitzo2001[AT]yahho[DOT]com')]
    TASK_TYPES = {'ReCaptcha': 'RecaptchaV2TaskProxyless', 'HCaptcha': 'HCaptchaTaskProxyless'}
