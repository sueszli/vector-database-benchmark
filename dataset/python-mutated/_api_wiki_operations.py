...
def build_get_entity_tag_request(resource_group_name: str, service_name: str, api_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default')
...
def build_delete_request(resource_group_name: str, service_name: str, api_id: str, subscription_id: str, *, if_match: str, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
    _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
...
class ApiWikiOperations:
    ...
    get_entity_tag.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default'}

    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, api_id: str, **kwargs: Any) -> _models.WikiContract:
        if False:
            while True:
                i = 10
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default'}

    @overload
    def create_or_update(self, resource_group_name: str, service_name: str, api_id: str, parameters: _models.WikiContract, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.WikiContract:
        if False:
            while True:
                i = 10
    ...
    @overload
    def create_or_update(self, resource_group_name: str, service_name: str, api_id: str, parameters: IO, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.WikiContract:
        if False:
            for i in range(10):
                print('nop')
    ...
    @distributed_trace
    def create_or_update(self, resource_group_name: str, service_name: str, api_id: str, parameters: Union[_models.WikiContract, IO], if_match: Optional[str]=None, **kwargs: Any) -> _models.WikiContract:
        if False:
            for i in range(10):
                print('nop')
        ...
        if cls:
            return cls(pipeline_response, deserialized, response_headers)
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default'}

    @overload
    def update(self, resource_group_name: str, service_name: str, api_id: str, if_match: str, parameters: _models.WikiUpdateContract, *, content_type: str='application/json', **kwargs: Any) -> _models.WikiContract:
        if False:
            return 10
    ...
    @overload
    def update(self, resource_group_name: str, service_name: str, api_id: str, if_match: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.WikiContract:
        if False:
            i = 10
            return i + 15
        'Updates the details of the Wiki for an API specified by its identifier.\n\n        :param resource_group_name: The name of the resource group. The name is case insensitive.\n         Required.\n        :type resource_group_name: str\n        :param service_name: The name of the API Management service. Required.\n        :type service_name: str\n        :param api_id: API identifier. Must be unique in the current API Management service instance.\n         Required.\n        :type api_id: str\n        :param if_match: ETag of the Entity. ETag should match the current entity state from the header\n         response of the GET request or it should be * for unconditional update. Required.\n        :type if_match: str\n        :param parameters: Wiki Update parameters. Required.\n        :type parameters: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: WikiContract or the result of cls(response)\n        :rtype: ~azure.mgmt.apimanagement.models.WikiContract\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
    ...
    @distributed_trace
    def update(self, resource_group_name: str, service_name: str, api_id: str, if_match: str, parameters: Union[_models.WikiUpdateContract, IO], **kwargs: Any) -> _models.WikiContract:
        if False:
            print('Hello World!')
        ...
        if cls:
            return cls(pipeline_response, deserialized, response_headers)
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default'}

    @distributed_trace
    def delete(self, resource_group_name: str, service_name: str, api_id: str, if_match: str, **kwargs: Any) -> None:
        if False:
            i = 10
            return i + 15
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, service_name=service_name, api_id=api_id, subscription_id=self._config.subscription_id, if_match=if_match, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/wikis/default'}