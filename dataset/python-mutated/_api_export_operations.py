...
def build_get_request(resource_group_name: str, service_name: str, api_id: str, subscription_id: str, *, format: Union[str, _models.ExportFormat], export: Union[str, _models.ExportApi], **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
...
class ApiExportOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, api_id: str, format: Union[str, _models.ExportFormat], export: Union[str, _models.ExportApi], **kwargs: Any) -> _models.ApiExportResult:
        if False:
            print('Hello World!')
        ...
        request = build_get_request(resource_group_name=resource_group_name, service_name=service_name, api_id=api_id, subscription_id=self._config.subscription_id, format=format, export=export, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
