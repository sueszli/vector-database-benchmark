...
from miasm.expression.expression import ExprId, ExprInt, ExprMem, ExprSlice, ExprCond, ExprLoc, ExprOp, ExprCompose, LocKey, Expr, TOK_EQUAL, TOK_INF_SIGNED, TOK_INF_UNSIGNED, TOK_INF_EQUAL_SIGNED, TOK_INF_EQUAL_UNSIGNED
...
class LLVMFunction(object):
    ...
    op_translate_with_suffix_size = {'bcdadd': 'bcdadd', 'bcdadd_cf': 'bcdadd_cf'}
