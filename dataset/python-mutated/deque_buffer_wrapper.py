...
class DequeBufferWrapper(object):
    ...
    def default_config(cls: type) -> EasyDict:
        ...
        return cfg
    config = dict(replay_buffer_size=10000, max_use=float('inf'), train_iter_per_log=100, priority=False, priority_IS_weight=False, priority_power_factor=0.6, IS_weight_power_factor=0.4, IS_weight_anneal_train_iter=int(100000.0), priority_max_limit=1000)
