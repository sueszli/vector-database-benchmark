...
Plotly_r = Plotly[::-1]
T10_r = T10[::-1]
from .colorbrewer import Set1, Pastel1, Dark2, Set2, Pastel2, Set3, Set1_r, Pastel1_r, Dark2_r, Set2_r, Pastel2_r, Set3_r
from .carto import Antique, Bold, Pastel, Prism, Safe, Vivid, Antique_r, Bold_r, Pastel_r, Prism_r, Safe_r, Vivid_r
__all__ = ['swatches']