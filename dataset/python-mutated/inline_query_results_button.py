...
class InlineQueryResultsButton(TelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, text: str, web_app: Optional[WebAppInfo]=None, start_parameter: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(text=text, web_app=web_app, start_parameter=start_parameter, **__pydantic_kwargs)