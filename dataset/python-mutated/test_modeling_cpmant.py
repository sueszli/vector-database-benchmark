...
if is_torch_available():
    import torch
    from transformers import CpmAntConfig, CpmAntForCausalLM, CpmAntModel, CpmAntTokenizer
...
class CpmAntModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': CpmAntModel, 'text-generation': CpmAntForCausalLM} if is_torch_available() else {}
    test_pruning = False
