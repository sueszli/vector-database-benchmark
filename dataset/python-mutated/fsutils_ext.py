...
from pupwinutils.security import getfileowneracls, kernel32, get_last_error, WinError, byref, cast, sizeof, addressof, WinDLL, create_string_buffer, Structure, _bit, BOOL, WORD, DWORD, LPCWSTR, LPVOID, PDWORD, POINTER, HANDLE, BYTE, ULONG
...
VS_FF_STR = {VS_FF_DEBUG: 'DEBUG', VS_FF_INFOINFERRED: 'INFOINFERRED', VS_FF_PATCHED: 'PATCHED', VS_FF_PRERELEASE: 'PRERELEASE', VS_FF_PRIVATEBUILD: 'PRIVATEBUILD', VS_FF_SPECIALBUILD: 'SPECIALBUILD'}
VFT_APP = 1
VFT_DLL = 2
VFT_DRV = 3
VFT_FONT = 4
...
VFT_UNKNOWN = 0
VFT_VXD = 5
VFT_STR = {VFT_APP: 'APP', VFT_DLL: 'DLL', VFT_DRV: 'DRV', VFT_FONT: 'FONT', VFT_STATIC_LIB: 'STATIC_LIB', VFT_UNKNOWN: 'UNKNOWN', VFT_VXD: 'VXD'}
VFT2_DRV_COMM = 10
VFT2_DRV_DISPLAY = 4
...
VFT2_UNKNOWN = 0
VFT2_DRV_STR = {VFT2_DRV_COMM: 'COMM', VFT2_DRV_DISPLAY: 'DISPLAY', VFT2_DRV_INSTALLABLE: 'INSTALLABLE', VFT2_DRV_KEYBOARD: 'KEYBOARD', VFT2_DRV_LANGUAGE: 'LANGUAGE', VFT2_DRV_MOUSE: 'MOUSE', VFT2_DRV_NETWORK: 'NETWORK', VFT2_DRV_PRINTER: 'PRINTER', VFT2_DRV_SOUND: 'SOUND', VFT2_DRV_SYSTEM: 'SYSTEM', VFT2_DRV_VERSIONED_PRINTER: 'VERSIONED_PRINTER', VFT2_UNKNOWN: 'UNKNOWN'}
VFT2_FONT_RASTER = 1
VFT2_FONT_TRUETYPE = 3
VFT2_FONT_VECTOR = 2
VFT2_FONT_STR = {VFT2_FONT_RASTER: 'RASTER', VFT2_FONT_TRUETYPE: 'TRUETYPE', VFT2_FONT_VECTOR: 'VECTOR'}
LOCALIZED_STRINGS = ('Comments', 'InternalName', 'ProductName', 'CompanyName', 'LegalCopyright', 'ProductVersion', 'FileDescription', 'LegalTrademarks', 'PrivateBuild', 'FileVersion', 'OriginalFilename', 'SpecialBuild')
...
TRUST_E_NOSIGNATURE = 2148204800
TRUST_E_FAIL = 2148204811
TRUST_E_EXPLICIT_DISTRUST = 2148204817
TRUST_E_SYSTEM_ERROR = 2148098049
TRUST_E_NO_SIGNER_CERT = 2148098050
TRUST_E_COUNTER_SIGNER = 2148098051
TRUST_E_CERT_SIGNATURE = 2148098052
TRUST_E_TIME_STAMP = 2148098053
TRUST_E_BAD_DIGEST = 2148098064
TRUST_E_BASIC_CONSTRAINTS = 2148098073
TRUST_E_FINANCIAL_CRITERIA = 2148098078
TRUST_E_PROVIDER_UNKNOWN = 2148204545
TRUST_E_ACTION_UNKNOWN = 2148204546
TRUST_E_SUBJECT_FORM_UNKNOWN = 2148204547
TRUST_E_SUBJECT_NOT_TRUSTED = 2148204548
TRUST_E_NOSIGNATURE = 2148204800
CERT_E_UNTRUSTEDROOT = 2148204809
CERT_E_CHAINING = 2148204810
TRUST_E_STR = {TRUST_E_NOSIGNATURE: 'NOSIGNATURE', TRUST_E_FAIL: 'FAIL', TRUST_E_EXPLICIT_DISTRUST: 'EXPLICIT_DISTRUST', TRUST_E_SYSTEM_ERROR: 'SYSTEM_ERROR', TRUST_E_NO_SIGNER_CERT: 'NO_SIGNER_CERT', TRUST_E_COUNTER_SIGNER: 'COUNTER_SIGNER', TRUST_E_CERT_SIGNATURE: 'CERT_SIGNATURE', TRUST_E_TIME_STAMP: 'TIME_STAMP', TRUST_E_BAD_DIGEST: 'BAD_DIGEST', TRUST_E_BASIC_CONSTRAINTS: 'BASIC_CONSTRAINTS', TRUST_E_FINANCIAL_CRITERIA: 'FINANCIAL_CRITERIA', TRUST_E_PROVIDER_UNKNOWN: 'PROVIDER_UNKNOWN', TRUST_E_ACTION_UNKNOWN: 'ACTION_UNKNOWN', TRUST_E_SUBJECT_FORM_UNKNOWN: 'SUBJECT_FORM_UNKNOWN', TRUST_E_SUBJECT_NOT_TRUSTED: 'SUBJECT_NOT_TRUSTED', TRUST_E_NOSIGNATURE: 'NOSIGNATURE', CERT_E_UNTRUSTEDROOT: 'UNTRUSTEDROOT', CERT_E_CHAINING: 'CHAINING'}
...
CryptQueryObject.argtypes = (DWORD, LPCWSTR, DWORD, DWORD, DWORD, PDWORD, PDWORD, PDWORD, LPVOID, POINTER(LPVOID), POINTER(LPVOID))
CryptMsgGetParam = crypt32.CryptMsgGetParam
CryptMsgGetParam.restype = BOOL
CryptMsgGetParam.argtypes = (LPVOID, DWORD, DWORD, LPVOID, PDWORD)
CertCloseStore = crypt32.CertCloseStore
CertCloseStore.restype = BOOL
CertCloseStore.argtypes = (LPVOID, DWORD)
CryptMsgClose = crypt32.CryptMsgClose
CryptMsgClose.restype = BOOL
CryptMsgClose.argtypes = (LPVOID,)
ver_lib = None
if hasattr(kernel32, 'GetFileVersionInfoSizeExW'):
    ver_lib = kernel32
else:
    try:
        ver_lib = WinDLL('Api-ms-win-core-version-l1-1-0', use_last_error=True)
    except WindowsError:
        pass
if ver_lib:
    ...
    GetFileVersionInfoSizeExW.argtypes = (DWORD, LPCWSTR, PDWORD)
    GetFileVersionInfoExW.restype = BOOL
    GetFileVersionInfoExW.argtypes = (DWORD, LPCWSTR, DWORD, DWORD, LPVOID)
    VerQueryValueW.restype = BOOL
    VerQueryValueW.argtypes = (LPVOID, LPCWSTR, POINTER(LPVOID), PDWORD)
WinVerifyTrust = wintrust.WinVerifyTrust
WinVerifyTrust.restype = ULONG
WinVerifyTrust.argtypes = (LPVOID, LPVOID, LPVOID)
...
class LANGANDCODEPAGE(Structure):
    _fields_ = (('wLanguage', WORD), ('wCodePage', WORD))

class WINTRUST_FILE_INFO(Structure):
    _fields_ = (('cbStruct', DWORD), ('pcwszFilePath', LPCWSTR), ('hFile', HANDLE), ('pgKnownSubject', LPVOID))
...
class WINTRUST_DATA(Structure):
    _fields_ = (('cbStruct', DWORD), ('pPolicyCallbackData', LPVOID), ('pSIPClientData', LPVOID), ('dwUIChoice', DWORD), ('fdwRevocationChecks', DWORD), ('dwUnionChoice', DWORD), ('pvInfo', LPVOID), ('dwStateAction', DWORD), ('hWVTStateData', HANDLE), ('pwszURLReference', LPCWSTR), ('dwProvFlags', DWORD), ('dwUIContext', DWORD), ('pSignatureSettings', LPVOID))
