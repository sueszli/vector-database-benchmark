...
names = [os.path.join(tmp_dir.name, 'dali_test_1C.wav'), os.path.join(tmp_dir.name, 'dali_test_2C.wav'), os.path.join(tmp_dir.name, 'dali_test_4C.wav')]
...
ref_text_non_ascii_literal = [u'dzień dobry', u'доброе утро', u'这是一个测试']
