...
class LightGlue(Module):
    default_conf: ClassVar[Dict[str, Any]] = {'name': 'lightglue', 'input_dim': 256, 'descriptor_dim': 256, 'n_layers': 9, 'num_heads': 4, 'flash': True, 'mp': False, 'depth_confidence': 0.95, 'width_confidence': 0.99, 'filter_threshold': 0.1, 'weights': None}
