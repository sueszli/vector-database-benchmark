...
import xmltodict
import yaml
XmlIndexesDict = Dict[str, Dict[str, List[Dict[str, Union[str, Dict[str, str], List[Dict[str, str]]]]]]]
YamlIndexesDict = Dict[str, List[Dict[str, Union[str, Dict[str, str], List[Dict[str, str]]]]]]
INDEX_YAML_PATH = os.path.join(os.getcwd(), 'index.yaml')
WEB_INF_INDEX_XML_PATH = os.path.join(os.getcwd(), os.pardir, 'cloud_datastore_emulator_cache', 'WEB-INF', 'appengine-generated', 'datastore-indexes-auto.xml')
