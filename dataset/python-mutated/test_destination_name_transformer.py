...
from normalization.transform_catalog.destination_name_transformer import DestinationNameTransformer, strip_accents, transform_standard_naming
...
@pytest.mark.parametrize('input_str, destination_type, expected', [('Hello World', 'Postgres', True), ('Hello World', 'BigQuery', False), ('Hello World', 'Snowflake', True), ('Hello World', 'Redshift', True), ('Hello World', 'MySQL', True), ('Hello World', 'MSSQL', True), ('Hello World', 'TiDB', True), ('Hello World', 'DuckDB', True), ('Groups', 'Postgres', False), ('Groups', 'BigQuery', True), ('Groups', 'Snowflake', False), ('Groups', 'Redshift', False), ('Groups', 'MySQL', True), ('Groups', 'MSSQL', False), ('Groups', 'TiDB', True), ('Groups', 'DuckDB', True), ('100x200', 'Postgres', True), ('100x200', 'BigQuery', False), ('100x200', 'Snowflake', True), ('100x200', 'Redshift', True), ('100x200', 'MySQL', True), ('100x200', 'MSSQL', True), ('100x200', 'TiDB', True), ('100x200', 'DuckDB', True), ('post.wall', 'Postgres', True), ('post.wall', 'BigQuery', False), ('post.wall', 'Snowflake', True), ('post.wall', 'Redshift', True), ('post.wall', 'MySQL', True), ('post.wall', 'MSSQL', True), ('post.wall', 'TiDB', True), ('post.wall', 'DuckDB', True)])
...
@pytest.mark.parametrize('input_str, expected', [('Hello World!', 'Hello World!'), ('àêî öÙ', 'aei oU')])
...
@pytest.mark.parametrize('input_str, expected', [('Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh', 'Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh'), ('Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh_Iii', 'Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh_Iii'), ('Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh_Iiii', 'Aaaa_Bbbb_Cccc_Dddd___e_Ffff_Gggg_Hhhh_Iiii'), ('Aaaa_Bbbb_Cccc_Dddd_Eeee_a_very_long_name_Ffff_Gggg_Hhhh_Iiii', 'Aaaa_Bbbb_Cccc_Dddd___e_Ffff_Gggg_Hhhh_Iiii'), ('Aaaa_Bbbb_Cccc_Dddd_Eeee_Ffff_Gggg_Hhhh_Iiii_Jjjj_Kkkk', 'Aaaa_Bbbb_Cccc_Dddd___g_Hhhh_Iiii_Jjjj_Kkkk'), ('ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz_0123456789', 'ABCDEFGHIJKLMNOPQRST__qrstuvwxyz_0123456789')])
