...
__all__ = ('U', 'I', 'NOT', 'Tuple', 'Dict', 'MagicType', 'BoundInt', 'BoundNumeric', 'Enum', 'numeric', 'h2oframe', 'pandas_dataframe', 'numpy_ndarray', 'scipy_sparse', 'assert_is_type', 'assert_matches', 'assert_satisfies', 'is_type')
_str_type = str
_int_type = int
_num_type = (int, float)
...
class _LazyClass(MagicType):
    ...
    def name(self, src=None):
        ...
        'Return string representing the name of this type.'
        return self._name
_enum_mangle_pattern = re.compile('[^a-z]+')
