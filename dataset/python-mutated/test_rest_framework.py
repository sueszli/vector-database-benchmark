...
from oauth2_provider.contrib.rest_framework import IsAuthenticatedOrTokenHasScope, OAuth2Authentication, TokenHasReadWriteScope, TokenHasResourceScope, TokenHasScope, TokenMatchesOASRequirements
...
class MethodScopeAltView(OAuth2View):
    ...
    required_alternate_scopes = {'GET': [['read']], 'POST': [['create']], 'PUT': [['update', 'put'], ['update', 'edit']], 'DELETE': [['delete'], ['deleter', 'write']]}
