...
from airflow.providers.google.cloud.links.vertex_ai import VertexAIPipelineJobLink, VertexAIPipelineJobListLink
...
class RunPipelineJobOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields = ['region', 'project_id', 'input_artifacts', 'impersonation_chain']
...
class GetPipelineJobOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields = ['region', 'pipeline_job_id', 'project_id', 'impersonation_chain']
    operator_extra_links = (VertexAIPipelineJobLink(),)
...
class ListPipelineJobOperator(GoogleCloudBaseOperator):
    ...
    operator_extra_links = [VertexAIPipelineJobListLink()]
...
class DeletePipelineJobOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields = ['region', 'project_id', 'pipeline_job_id', 'impersonation_chain']
