...
class stitcherCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_cdn_key': ('parent', 'cdn_key', 'cdn_key_id'), 'create_live_config': ('parent', 'live_config_id', 'live_config', 'request_id'), 'create_live_session': ('parent', 'live_session'), 'create_slate': ('parent', 'slate_id', 'slate', 'request_id'), 'create_vod_session': ('parent', 'vod_session'), 'delete_cdn_key': ('name',), 'delete_live_config': ('name',), 'delete_slate': ('name',), 'get_cdn_key': ('name',), 'get_live_ad_tag_detail': ('name',), 'get_live_config': ('name',), 'get_live_session': ('name',), 'get_slate': ('name',), 'get_vod_ad_tag_detail': ('name',), 'get_vod_session': ('name',), 'get_vod_stitch_detail': ('name',), 'list_cdn_keys': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_live_ad_tag_details': ('parent', 'page_size', 'page_token'), 'list_live_configs': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_slates': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_vod_ad_tag_details': ('parent', 'page_size', 'page_token'), 'list_vod_stitch_details': ('parent', 'page_size', 'page_token'), 'update_cdn_key': ('cdn_key', 'update_mask'), 'update_slate': ('slate', 'update_mask')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=stitcherCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
