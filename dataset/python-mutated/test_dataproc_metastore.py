...
TEST_METADATA_IMPORT: dict = {'name': 'test-metadata-import', 'database_dump': {'gcs_uri': 'gs://bucket_name/path_inside_bucket', 'database_type': 'MYSQL'}}
TEST_METADATA_IMPORT_ID: str = 'test-metadata-import-id'
TEST_SERVICE_TO_UPDATE = {'labels': {'first_key': 'first_value', 'second_key': 'second_value'}}
