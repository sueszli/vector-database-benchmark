...
import datetime
ua_win7_vtypes = {'_VOLUSER_ASSIST_TYPES': [72, {'Count': [4, ['unsigned int']], 'FocusCount': [8, ['unsigned int']], 'FocusTime': [12, ['unsigned int']], 'LastUpdated': [60, ['WinTimeStamp', dict(is_utc=True)]]}]}
ua_vtypes = {'_VOLUSER_ASSIST_TYPES': [16, {'ID': [0, ['unsigned int']], 'CountStartingAtFive': [4, ['unsigned int']], 'LastUpdated': [8, ['WinTimeStamp', dict(is_utc=True)]]}]}
