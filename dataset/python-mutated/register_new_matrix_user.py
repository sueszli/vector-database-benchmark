...
import requests
import yaml
_CONFLICTING_SHARED_SECRET_OPTS_ERROR = "Conflicting options 'registration_shared_secret' and 'registration_shared_secret_path'\nare both defined in config file.\n"
_NO_SHARED_SECRET_OPTS_ERROR = "No 'registration_shared_secret' or 'registration_shared_secret_path' defined in config.\n"
