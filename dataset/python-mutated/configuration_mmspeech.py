...
class MMSpeechConfig(PretrainedConfig):
    ...
    def __init__(self, vocab_size=59457, max_position_embeddings=1024, encoder_layers=4, encoder_ffn_dim=512 * 4, encoder_attention_heads=8, decoder_layers=4, decoder_ffn_dim=512 * 4, decoder_attention_heads=8, encoder_layerdrop=0.0, decoder_layerdrop=0.0, use_cache=True, is_encoder_decoder=True, activation_function='gelu', d_model=512, dropout=0.1, attention_dropout=0.0, activation_dropout=0.0, init_std=0.02, classifier_dropout=0.0, scale_embedding=False, pad_token_id=1, bos_token_id=0, decoder_start_token_id=0, eos_token_id=2, forced_eos_token_id=2, encoder_normalize_before=True, decoder_normalize_before=True, normformer=True, encoder_drop_path_rate=0.0, decoder_drop_path_rate=0.0, layernorm_embedding=True, patch_layernorm_embedding=True, resnet_type='resnet101', resnet_model_path=None, resnet_drop_path_rate=0.0, token_bucket_size=256, image_bucket_size=42, add_type_embedding=True, share_decoder_input_output_embed=True, attn_scale_factor=2.0, code_layernorm_embedding=False, code_image_size=128, entangle_position_embedding=False, interpolate_position=False, orig_patch_image_size=224, share_attn_bias=False, use_image_feature=True, disable_entangle=False, use_ofasys=False, vit_type='vit_base', vit_drop_path_rate=0.0, use_gamma_feature=False, gamma=1.0, exclude_mlp=True, temperature_init_value=None, remove_decoder_type_embedding=False, mlp_dim=512, required_seq_len_multiple=2, encoder_pos_conv_depth=5, encoder_conv_pos=95, encoder_conv_pos_groups=16, encoder_max_positions=100000, phone_vocab_size=141, audio_mask_prob=0.65, audio_mask_selection='static', audio_mask_other=0, audio_mask_length=10, audio_no_mask_overlap=False, audio_mask_min_space=1, audio_mask_channel_prob=0.0, audio_mask_channel_before=False, audio_mask_channel_selection='static', audio_mask_channel_other=0, audio_mask_channel_length=10, audio_no_mask_channel_overlap=False, audio_mask_channel_min_space=1, encoder_dropout_input=0.0, encoder_dropout_features=0.0, phone_dict_size=124, **kwargs):
        if False:
            for i in range(10):
                print('nop')
