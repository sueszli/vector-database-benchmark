...
Usage:
    python submit_job_to_cluster --project_id <PROJECT_ID> --region <REGION>         --cluster_name <CLUSTER_NAME> --job_file_path <GCS_JOB_FILE_PATH>
"""
import argparse
import os
import re
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_id', type=str, required=True, help='Project to use for creating resources.')
    parser.add_argument('--region', type=str, required=True, help='Region where the resources should live.')
    parser.add_argument('--cluster_name', type=str, required=True, help='Name to use for creating a cluster.')
