...
class EventsCustomMetricInfo(Model):
    ...
    """
    _attribute_map = {'name': {'key': 'name', 'type': 'str'}, 'value': {'key': 'value', 'type': 'float'}, 'value_sum': {'key': 'valueSum', 'type': 'float'}, 'value_count': {'key': 'valueCount', 'type': 'int'}, 'value_min': {'key': 'valueMin', 'type': 'float'}, 'value_max': {'key': 'valueMax', 'type': 'float'}, 'value_std_dev': {'key': 'valueStdDev', 'type': 'float'}}
