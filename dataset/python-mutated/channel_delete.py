...
class ChannelDeleteInput(BaseInputObjectType):
    channel_id = graphene.ID(required=True, description='ID of channel to migrate orders from origin channel.')
...
class ChannelDelete(ModelDeleteMutation):
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.CHANNEL_DELETED, description='A channel was deleted.')]
