...
from modelscope.models.cv.human3d_animation import projection, read_obj, render, rotate_x, rotate_y, translate
...
@PIPELINES.register_module(Tasks.human3d_render, module_name=Pipelines.human3d_render)
