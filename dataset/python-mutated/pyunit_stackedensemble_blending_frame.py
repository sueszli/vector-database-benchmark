...
pu.run_tests([test_passing_blending_frame_triggers_blending_mode, test_blending_mode_usually_performs_worse_than_CV_stacking_mode, test_training_frame_is_not_required_in_blending_mode])