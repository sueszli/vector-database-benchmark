...
FUNC_ARGS = {'airy_d': (1,), 'airy_D': (1,), 'beta_dd': (0.25, 0.75), 'erf_d': (1,), 'erf_D': (1 + 1j,), 'exprel_d': (1e-06,), 'gamma_d': (100,), 'gamma_D': (100 + 100j,), 'jv_dd': (1, 1), 'jv_dD': (1, 1 + 1j), 'loggamma_D': (20,), 'logit_d': (0.5,), 'psi_d': (1,), 'psi_D': (1,)}
