...
_query_types = ['domain', 'rrname-wildcard-left', 'rrname-wildcard-right', 'names', 'rdata-wildcard-left', 'rdata-wildcard-right']
_supported_rrtype = ['', 'A', 'AAAA', 'ALIAS', 'CNAME', 'MX', 'NS', 'PTR', 'SOA', 'SRV', 'TXT', 'ANY-DNSSEC']
