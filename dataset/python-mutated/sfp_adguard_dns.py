...
class sfp_adguard_dns(SpiderFootPlugin):
    ...
    def producedEvents(self):
        if False:
            while True:
                i = 10
        return ['BLACKLISTED_INTERNET_NAME', 'BLACKLISTED_AFFILIATE_INTERNET_NAME', 'BLACKLISTED_COHOST']
