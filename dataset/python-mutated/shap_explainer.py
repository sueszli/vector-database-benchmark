...
class _RegressionShapExplainers:
    ...
    """
    default_sklearn_shap_explainers = {'LGBMRegressor': _ShapMethod.TREE, 'CatBoostRegressor': _ShapMethod.TREE, 'XGBRegressor': _ShapMethod.TREE, 'GradientBoostingRegressor': _ShapMethod.TREE, 'DecisionTreeRegressor': _ShapMethod.TREE, 'ExtraTreeRegressor': _ShapMethod.TREE, 'AdaBoostRegressor': _ShapMethod.PERMUTATION, 'BaggingRegressor': _ShapMethod.PERMUTATION, 'ExtraTreesRegressor': _ShapMethod.PERMUTATION, 'HistGradientBoostingRegressor': _ShapMethod.PERMUTATION, 'RandomForestRegressor': _ShapMethod.PERMUTATION, 'RidgeCV': _ShapMethod.PERMUTATION, 'Ridge': _ShapMethod.PERMUTATION, 'LinearRegression': _ShapMethod.LINEAR, 'ARDRegression': _ShapMethod.LINEAR, 'MultiTaskElasticNet': _ShapMethod.LINEAR, 'MultiTaskElasticNetCV': _ShapMethod.LINEAR, 'MultiTaskLasso': _ShapMethod.LINEAR, 'MultiTaskLassoCV': _ShapMethod.LINEAR, 'PassiveAggressiveRegressor': _ShapMethod.LINEAR, 'PoissonRegressor': _ShapMethod.LINEAR, 'QuantileRegressor': _ShapMethod.LINEAR, 'RANSACRegressor': _ShapMethod.LINEAR, 'GammaRegressor': _ShapMethod.LINEAR, 'HuberRegressor': _ShapMethod.LINEAR, 'BayesianRidge': _ShapMethod.LINEAR, 'SGDRegressor': _ShapMethod.LINEAR, 'TheilSenRegressor': _ShapMethod.LINEAR, 'TweedieRegressor': _ShapMethod.LINEAR, 'GaussianProcessRegressor': _ShapMethod.PERMUTATION, 'KNeighborsRegressor': _ShapMethod.PERMUTATION, 'RadiusNeighborsRegressor': _ShapMethod.PERMUTATION, 'MLPRegressor': _ShapMethod.PERMUTATION}
