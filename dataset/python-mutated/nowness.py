...
class NownessIE(NownessBaseIE):
    ...
    _TESTS = [{'url': 'https://www.nowness.com/story/candor-the-art-of-gesticulation', 'md5': '068bc0202558c2e391924cb8cc470676', 'info_dict': {'id': '2520295746001', 'ext': 'mp4', 'title': 'Candor: The Art of Gesticulation', 'description': 'Candor: The Art of Gesticulation', 'thumbnail': 're:^https?://.*\\.jpg', 'timestamp': 1446745676, 'upload_date': '20151105', 'uploader_id': '2385340575001'}, 'add_ie': ['BrightcoveNew']}, {'url': 'https://cn.nowness.com/story/kasper-bjorke-ft-jaakko-eino-kalevi-tnr', 'md5': 'e79cf125e387216f86b2e0a5b5c63aa3', 'info_dict': {'id': '3716354522001', 'ext': 'mp4', 'title': 'Kasper Bjørke ft. Jaakko Eino Kalevi: TNR', 'description': 'Kasper Bjørke ft. Jaakko Eino Kalevi: TNR', 'thumbnail': 're:^https?://.*\\.jpg', 'timestamp': 1407315371, 'upload_date': '20140806', 'uploader_id': '2385340575001'}, 'add_ie': ['BrightcoveNew']}, {'url': 'https://www.nowness.com/series/nowness-picks/jean-luc-godard-supercut', 'md5': '9a5a6a8edf806407e411296ab6bc2a49', 'info_dict': {'id': '130020913', 'ext': 'mp4', 'title': 'Bleu, Blanc, Rouge - A Godard Supercut', 'description': 'md5:f0ea5f1857dffca02dbd37875d742cec', 'thumbnail': 're:^https?://.*\\.jpg', 'upload_date': '20150607', 'uploader': 'Cinema Sem Lei', 'uploader_id': 'cinemasemlei'}, 'add_ie': ['Vimeo']}]
...
class NownessPlaylistIE(NownessBaseIE):
    ...
    _TEST = {'url': 'https://www.nowness.com/playlist/3286/i-guess-thats-why-they-call-it-the-blues', 'info_dict': {'id': '3286'}, 'playlist_mincount': 8}
...
class NownessSeriesIE(NownessBaseIE):
    ...
    _TEST = {'url': 'https://www.nowness.com/series/60-seconds', 'info_dict': {'id': '60', 'title': '60 Seconds', 'description': 'One-minute wisdom in a new NOWNESS series'}, 'playlist_mincount': 4}
