"""Runs evaluation using OpenImages groundtruth and predictions.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Evaluate Open Images Visual Relationship Detection predictions.')
    parser.add_argument('--input_annotations_vrd', required=True, help='File with groundtruth vrd annotations.')
    parser.add_argument('--input_annotations_labels', required=True, help='File with groundtruth labels annotations')
    parser.add_argument('--input_predictions', required=True, help='File with detection predictions; NOTE: no postprocessing is\n      applied in the evaluation script.')
    parser.add_argument('--input_class_labelmap', required=True, help='OpenImages Challenge labelmap; note: it is expected to include\n      attributes.')
    parser.add_argument('--input_relationship_labelmap', required=True, help='OpenImages Challenge relationship labelmap.')
    parser.add_argument('--output_metrics', required=True, help='Output file with csv metrics')
