...
class TeleQuebecIE(TeleQuebecBaseIE):
    ...
    _TESTS = [{'url': 'http://zonevideo.telequebec.tv/media/37578/un-petit-choc-et-puis-repart/un-chef-a-la-cabane', 'info_dict': {'id': '6155972771001', 'ext': 'mp4', 'title': 'Un petit choc et puis repart!', 'description': 'md5:b04a7e6b3f74e32d7b294cffe8658374', 'timestamp': 1589262469, 'uploader_id': '6150020952001', 'upload_date': '20200512'}, 'add_ie': ['BrightcoveNew']}, {'url': 'https://zonevideo.telequebec.tv/media/55267/le-soleil/passe-partout', 'info_dict': {'id': '6167180337001', 'ext': 'mp4', 'title': 'Le soleil', 'description': 'md5:64289c922a8de2abbe99c354daffde02', 'uploader_id': '6150020952001', 'upload_date': '20200625', 'timestamp': 1593090307}, 'add_ie': ['BrightcoveNew']}, {'url': 'http://zonevideo.telequebec.tv/media/30261', 'only_matching': True}, {'url': 'https://coucou.telequebec.tv/videos/41788/idee-de-genie/l-heure-du-bain', 'only_matching': True}]
...
class TeleQuebecSquatIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://squat.telequebec.tv/videos/9314', 'info_dict': {'id': 'd59ae78112d542e793d83cc9d3a5b530', 'ext': 'mp4', 'title': 'Poupeflekta', 'description': 'md5:2f0718f8d2f8fece1646ee25fb7bce75', 'duration': 1351, 'timestamp': 1569057600, 'upload_date': '20190921', 'series': 'Miraculous : Les Aventures de Ladybug et Chat Noir', 'season': 'Saison 3', 'season_number': 3, 'episode_number': 57}, 'params': {'skip_download': True}}]
...
class TeleQuebecEmissionIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://lindicemcsween.telequebec.tv/emissions/100430013/des-soins-esthetiques-a-377-d-interets-annuels-ca-vous-tente', 'info_dict': {'id': '6154476028001', 'ext': 'mp4', 'title': 'Des soins esthétiques à 377 % d’intérêts annuels, ça vous tente?', 'description': 'md5:cb4d378e073fae6cce1f87c00f84ae9f', 'upload_date': '20200505', 'timestamp': 1588713424, 'uploader_id': '6150020952001'}}, {'url': 'http://bancpublic.telequebec.tv/emissions/emission-49/31986/jeunes-meres-sous-pression', 'only_matching': True}, {'url': 'http://www.telequebec.tv/masha-et-michka/epi059masha-et-michka-3-053-078', 'only_matching': True}, {'url': 'http://www.telequebec.tv/documentaire/bebes-sur-mesure/', 'only_matching': True}]
...
class TeleQuebecLiveIE(TeleQuebecBaseIE):
    ...
    _TEST = {'url': 'http://zonevideo.telequebec.tv/endirect/', 'info_dict': {'id': '6159095684001', 'ext': 'mp4', 'title': 're:^Télé-Québec [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'is_live': True, 'description': 'Canal principal de Télé-Québec', 'uploader_id': '6150020952001', 'timestamp': 1590439901, 'upload_date': '20200525'}, 'params': {'skip_download': True}}
...
class TeleQuebecVideoIE(TeleQuebecBaseIE):
    ...
    _TESTS = [{'url': 'https://video.telequebec.tv/player/31110/stream', 'info_dict': {'id': '6202570652001', 'ext': 'mp4', 'title': 'Le coût du véhicule le plus vendu au Canada / Tous les frais liés à la procréation assistée', 'description': 'md5:685a7e4c450ba777c60adb6e71e41526', 'upload_date': '20201019', 'timestamp': 1603115930, 'uploader_id': '6101674910001'}}, {'url': 'https://video.telequebec.tv/player-live/28527', 'only_matching': True}]
