...
class OrthogonalMatchingPursuit(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    array([-78.3854...])
    """
    _parameter_constraints: dict = {'n_nonzero_coefs': [Interval(Integral, 1, None, closed='left'), None], 'tol': [Interval(Real, 0, None, closed='left'), None], 'fit_intercept': ['boolean'], 'normalize': ['boolean', Hidden(StrOptions({'deprecated'}))], 'precompute': [StrOptions({'auto'}), 'boolean']}
...
class OrthogonalMatchingPursuitCV(RegressorMixin, LinearModel):
    ...
    array([-78.3854...])
    """
    _parameter_constraints: dict = {'copy': ['boolean'], 'fit_intercept': ['boolean'], 'normalize': ['boolean', Hidden(StrOptions({'deprecated'}))], 'max_iter': [Interval(Integral, 0, None, closed='left'), None], 'cv': ['cv_object'], 'n_jobs': [Integral, None], 'verbose': ['verbose']}
