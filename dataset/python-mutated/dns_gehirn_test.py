...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common_lexicon.BaseLexiconDNSAuthenticatorTest):
    ...
    def setUp(self):
        ...
        dns_test_common.write({'gehirn_api_token': API_TOKEN, 'gehirn_api_secret': API_SECRET}, path)
        self.config = mock.MagicMock(gehirn_credentials=path, gehirn_propagation_seconds=0)
