...
from airbyte_cdk.sources.streams.call_rate import APIBudget, CallRateLimitHit, FixedWindowCallRatePolicy, HttpRequestMatcher, MovingWindowCallRatePolicy, Rate, UnlimitedCallRatePolicy
...
class TestHttpRequestMatcher:
    try_all_types_of_requests = pytest.mark.parametrize('request_factory', [Request, lambda *args, **kwargs: Request(*args, **kwargs).prepare()])
