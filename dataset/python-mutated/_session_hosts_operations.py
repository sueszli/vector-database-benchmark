...
def build_get_request(resource_group_name: str, host_pool_name: str, session_host_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}')
...
def build_delete_request(resource_group_name: str, host_pool_name: str, session_host_name: str, subscription_id: str, *, force: Optional[bool]=None, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
    _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
...
def build_update_request(resource_group_name: str, host_pool_name: str, session_host_name: str, subscription_id: str, *, force: Optional[bool]=None, **kwargs: Any) -> HttpRequest:
    if False:
        for i in range(10):
            print('nop')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
...
def build_list_request(resource_group_name: str, host_pool_name: str, subscription_id: str, *, page_size: Optional[int]=None, is_descending: Optional[bool]=None, initial_skip: Optional[int]=None, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2023-09-05'))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts')
...
class SessionHostsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, host_pool_name: str, session_host_name: str, **kwargs: Any) -> _models.SessionHost:
        if False:
            while True:
                i = 10
        ...
        request = build_get_request(resource_group_name=resource_group_name, host_pool_name=host_pool_name, session_host_name=session_host_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, host_pool_name: str, session_host_name: str, force: Optional[bool]=None, **kwargs: Any) -> None:
        if False:
            for i in range(10):
                print('nop')
        ...
        request = build_delete_request(resource_group_name=resource_group_name, host_pool_name=host_pool_name, session_host_name=session_host_name, subscription_id=self._config.subscription_id, force=force, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    def update(self, resource_group_name: str, host_pool_name: str, session_host_name: str, force: Optional[bool]=None, session_host: Optional[_models.SessionHostPatch]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.SessionHost:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    def update(self, resource_group_name: str, host_pool_name: str, session_host_name: str, force: Optional[bool]=None, session_host: Optional[IO]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.SessionHost:
        if False:
            print('Hello World!')
        'Update a session host.\n\n        :param resource_group_name: The name of the resource group. The name is case insensitive.\n         Required.\n        :type resource_group_name: str\n        :param host_pool_name: The name of the host pool within the specified resource group. Required.\n        :type host_pool_name: str\n        :param session_host_name: The name of the session host within the specified host pool.\n         Required.\n        :type session_host_name: str\n        :param force: Force flag to update assign, unassign or reassign personal desktop. Default value\n         is None.\n        :type force: bool\n        :param session_host: Object containing SessionHost definitions. Default value is None.\n        :type session_host: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: SessionHost or the result of cls(response)\n        :rtype: ~azure.mgmt.desktopvirtualization.models.SessionHost\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def update(self, resource_group_name: str, host_pool_name: str, session_host_name: str, force: Optional[bool]=None, session_host: Optional[Union[_models.SessionHostPatch, IO]]=None, **kwargs: Any) -> _models.SessionHost:
        if False:
            for i in range(10):
                print('nop')
    ...
    @distributed_trace
    def list(self, resource_group_name: str, host_pool_name: str, page_size: Optional[int]=None, is_descending: Optional[bool]=None, initial_skip: Optional[int]=None, **kwargs: Any) -> Iterable['_models.SessionHost']:
        if False:
            for i in range(10):
                print('nop')
