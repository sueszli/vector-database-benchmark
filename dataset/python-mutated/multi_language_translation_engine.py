...
from shortGPT.audio.audio_utils import audioToText, get_asset_duration, run_background_audio_split, speedUpAudio
...
class MultiLanguageTranslationEngine(AbstractContentEngine):
    ...
    def _transcribe_audio(self):
        if False:
            print('Hello World!')
        cached_translation = CONTENT_DB.content_collection.find_one({'content_type': 'content_translation', 'src_url': self._db_src_url, 'ready_to_upload': True})
