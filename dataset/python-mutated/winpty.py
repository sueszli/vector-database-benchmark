...
from pupwinutils.security import CreateFile, ReadFile, WriteFile, CloseHandle, TerminateProcess, GENERIC_READ, GENERIC_WRITE, OPEN_EXISTING, INVALID_HANDLE_VALUE
from ctypes import c_int, c_uint, c_void_p, pointer, byref, c_ulonglong, CFUNCTYPE, WinError, get_last_error, create_string_buffer
from ctypes.wintypes import HANDLE, DWORD, LPCWSTR, HWND
import pupy
...
WINPTY_FLAG_CONERR = 1
WINPTY_FLAG_PLAIN_OUTPUT = 2
WINPTY_FLAG_COLOR_ESCAPES = 4
WINPTY_FLAG_ALLOW_CURPROC_DESKTOP_CREATION = 8
