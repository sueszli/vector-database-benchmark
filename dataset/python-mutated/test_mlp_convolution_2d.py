...
@testing.parameterize({'use_cudnn': 'always'}, {'use_cudnn': 'never'})
...
@testing.parameterize(*testing.product({'use_cudnn': ['always', 'never'], 'mlpconv_args': [((None, (96, 96, 96), 11), {'activation': functions.sigmoid}), (((96, 96, 96), 11), {'activation': functions.sigmoid})]}))
