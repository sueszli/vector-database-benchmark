...
class SymbolInMulOnce(Symbol):
    pass
Basic._constructor_postprocessor_mapping[SymbolInMulOnce] = {'Mul': [lambda x: x], 'Pow': [lambda x: x.base if isinstance(x.base, SymbolInMulOnce) else x], 'Add': [lambda x: x]}
...
class SymbolRemovesOtherSymbols(Symbol):
    pass
Basic._constructor_postprocessor_mapping[SymbolRemovesOtherSymbols] = {'Mul': [_postprocess_SymbolRemovesOtherSymbols]}
