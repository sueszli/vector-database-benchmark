...
def main():
    ...
    response = client.synchronization_settings.get(resource_group_name='SampleResourceGroup', account_name='Account1', share_name='Share1', synchronization_setting_name='SynchronizationSetting1')
    print(response)
