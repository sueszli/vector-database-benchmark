...
from yt_dlp.socks import SOCKS4_REPLY_VERSION, SOCKS4_VERSION, SOCKS5_USER_AUTH_SUCCESS, SOCKS5_USER_AUTH_VERSION, SOCKS5_VERSION, Socks5AddressType, Socks5Auth
SOCKS5_USER_AUTH_FAILURE = 1
...
CTX_MAP = {'http': HTTPSocksTestProxyContext}
