...
def main():
    ...
    response = client.storage_accounts.update(resource_group_name='contosorg', account_name='contosoadla', storage_account_name='test_storage')
    print(response)
