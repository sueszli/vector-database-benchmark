...
class Exploit(HTTPClient):
    __info__ = {'name': 'D-Link DIR-8XX Password Disclosure', 'description': 'Module exploits D-Link DIR-8XX password disclosure vulnerability, which allows retrieving administrative credentials.', 'authors': ('Hack2Win', 'Peter Geissler', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://blogs.securiteam.com/index.php/archives/3310', 'https://blogs.securiteam.com/index.php/archives/3364', 'https://embedi.com/blog/enlarge-your-botnet-top-d-link-routers-dir8xx-d-link-routers-cruisin-bruisin'), 'devices': ('D-Link DIR-8XX',)}
