...
df_a = vaex.from_arrays(a=np.array(['A', 'B', 'C']), x=np.array([0.0, 1.0, 2.0]), y=np.ma.array([0.0, 9.0, 2.0], mask=[False, True, False]), m=np.ma.array([1, 2, 3], mask=[False, True, False]))
df_b = vaex.from_arrays(b=np.array(['A', 'B', 'D']), x=np.array([2.0, 1.0, 0.0]), y=np.ma.array([9.0, 1.0, 2.0], mask=[True, False, False]), m=np.ma.array([3, 1, 2], mask=[True, False, False]))
df_dup = vaex.from_arrays(b=np.array(['A', 'B', 'A']), x=np.array([2.0, 1.0, 2.0]), y=np.ma.array([9.0, 1.0, 9.0], mask=[True, False, False]), m=np.ma.array([3, 1, 2], mask=[True, True, False]))
df_c = vaex.from_arrays(c=np.array(['B', 'C']), z1=np.array([-1.0, -2.0]), z2=np.array([True, False]))
df_d = vaex.from_arrays(a=np.array(['B', 'C', 'D']), x1=np.array(['dog', 'cat', 'mouse']), x2=np.array([3.1, 25, np.nan]))
df_e = vaex.from_arrays(a=np.array(['X', 'Y', 'Z']), x1=np.array(['dog', 'cat', 'mouse']), x2=np.array([3.1, 25, np.nan]))
df_dt1 = vaex.from_arrays(date=[np.datetime64('2009-10-12T03:00:00'), np.datetime64('2009-10-12T11:00:00'), np.datetime64('2009-10-12T12:00:00'), np.datetime64('2009-12-12T03:00:00')], value=[1, 2, 3, 4])
df_f = vaex.from_arrays(f=np.array(['B', 'C', None]), w1=np.array(['dog', 'cat', 'mouse']), w2=np.array([True, False, True]))
df_dt2 = vaex.from_arrays(date=[np.datetime64('2009-10-12T03:00:00'), np.datetime64('2009-10-12T11:00:00'), np.datetime64('2009-12-12T03:00:00')], value=[11, 22, 44])
