...
from ..utils import determine_ext, dict_get, ExtractorError, js_to_json, strip_jsonp, try_get, unified_strdate, update_url_query, urlhandle_detect_ext, url_or_none
...
class WDRIE(InfoExtractor):
    ...
    _GEO_COUNTRIES = ['DE']
    _TESTS = [{'url': 'http://deviceids-medp.wdr.de/ondemand/155/1557833.js', 'info_dict': {'id': 'mdb-1557833', 'ext': 'mp4', 'title': 'Biathlon-Staffel verpasst Podest bei Olympia-Generalprobe', 'upload_date': '20180112'}}]
...
class WDRPageIE(WDRIE):
    _MAUS_REGEX = 'https?://(?:www\\.)wdrmaus.de/(?:[^/]+/)*?(?P<maus_id>[^/?#.]+)(?:/?|/index\\.php5|\\.php5)$'
    _PAGE_REGEX = '/(?:mediathek/)?(?:[^/]+/)*(?P<display_id>[^/]+)\\.html'
    _VALID_URL = 'https?://(?:www\\d?\\.)?(?:(?:kinder\\.)?wdr\\d?|sportschau)\\.de' + _PAGE_REGEX + '|' + _MAUS_REGEX
    _TESTS = [{'url': 'http://www1.wdr.de/mediathek/video/sendungen/doku-am-freitag/video-geheimnis-aachener-dom-100.html', 'info_dict': {'id': 'mdb-1058683', 'ext': 'flv', 'display_id': 'doku-am-freitag/video-geheimnis-aachener-dom-100', 'title': 'Geheimnis Aachener Dom', 'alt_title': 'Doku am Freitag', 'upload_date': '20160304', 'description': 'md5:87be8ff14d8dfd7a7ee46f0299b52318', 'is_live': False, 'subtitles': {'de': [{'url': 'http://ondemand-ww.wdr.de/medp/fsk0/105/1058683/1058683_12220974.xml', 'ext': 'ttml'}]}}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'http://www1.wdr.de/mediathek/audio/wdr3/wdr3-gespraech-am-samstag/audio-schriftstellerin-juli-zeh-100.html', 'md5': 'f4c1f96d01cf285240f53ea4309663d8', 'info_dict': {'id': 'mdb-1072000', 'ext': 'mp3', 'display_id': 'wdr3-gespraech-am-samstag/audio-schriftstellerin-juli-zeh-100', 'title': 'Schriftstellerin Juli Zeh', 'alt_title': 'WDR 3 Gespräch am Samstag', 'upload_date': '20160312', 'description': 'md5:e127d320bc2b1f149be697ce044a3dd7', 'is_live': False, 'subtitles': {}}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'http://www1.wdr.de/mediathek/video/live/index.html', 'info_dict': {'id': 'mdb-2296252', 'ext': 'mp4', 'title': 're:^WDR Fernsehen im Livestream (?:\\(nur in Deutschland erreichbar\\) )?[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'alt_title': 'WDR Fernsehen Live', 'upload_date': '20201112', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'http://www1.wdr.de/mediathek/video/sendungen/aktuelle-stunde/aktuelle-stunde-120.html', 'playlist_mincount': 6, 'info_dict': {'id': 'aktuelle-stunde-120'}}, {'url': 'http://www.wdrmaus.de/aktuelle-sendung/index.php5', 'info_dict': {'id': 'mdb-2627637', 'ext': 'mp4', 'upload_date': 're:^[0-9]{8}$', 'title': 're:^Die Sendung (?:mit der Maus )?vom [0-9.]{10}$'}, 'skip': 'The id changes from week to week because of the new episode'}, {'url': 'http://www.wdrmaus.de/filme/sachgeschichten/achterbahn.php5', 'md5': '803138901f6368ee497b4d195bb164f2', 'info_dict': {'id': 'mdb-186083', 'ext': 'mp4', 'upload_date': '20130919', 'title': 'Sachgeschichte - Achterbahn '}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'http://www1.wdr.de/radio/player/radioplayer116~_layout-popupVersion.html', 'info_dict': {'id': 'mdb-869971', 'ext': 'mp4', 'title': 're:^COSMO Livestream [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'alt_title': 'COSMO Livestream', 'live_status': 'is_live', 'upload_date': '20160101'}, 'params': {'skip_download': True}}, {'url': 'http://www.sportschau.de/handballem2018/handball-nationalmannschaft-em-stolperstein-vorrunde-100.html', 'info_dict': {'id': 'mdb-1556012', 'ext': 'mp4', 'title': 'DHB-Vizepräsident Bob Hanning - "Die Weltspitze ist extrem breit"', 'upload_date': '20180111'}, 'params': {'skip_download': True}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'http://www.sportschau.de/handballem2018/audio-vorschau---die-handball-em-startet-mit-grossem-favoritenfeld-100.html', 'only_matching': True}, {'url': 'https://kinder.wdr.de/tv/die-sendung-mit-dem-elefanten/av/video-folge---astronaut-100.html', 'only_matching': True}, {'url': 'https://www1.wdr.de/mediathek/video/sendungen/rockpalast/video-baroness---freak-valley-festival--100.html', 'info_dict': {'id': 'mdb-2741028', 'ext': 'mp4', 'title': 'Baroness - Freak Valley Festival 2022', 'alt_title': 'Rockpalast', 'upload_date': '20220725'}}]
...
class WDRElefantIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.wdrmaus.de/elefantenseite/#elefantenkino_wippe', 'info_dict': {'title': 'Wippe', 'id': 'mdb-1198320', 'ext': 'mp4', 'age_limit': None, 'upload_date': '20071003'}}
...
class WDRMobileIE(InfoExtractor):
    ...
    IE_NAME = 'wdr:mobile'
    _WORKING = False
    _TEST = {'url': 'http://mobile-ondemand.wdr.de/CMS2010/mdb/ondemand/weltweit/fsk0/42/421735/421735_4283021.mp4', 'info_dict': {'title': '4283021', 'id': '421735', 'ext': 'mp4', 'age_limit': 0}, 'skip': 'Problems with loading data.'}
