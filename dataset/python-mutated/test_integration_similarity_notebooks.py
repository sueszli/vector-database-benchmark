...
def test_11_notebook_run(similarity_notebooks, tiny_ic_data_path):
    ...
    pm.execute_notebook(notebook_path, OUTPUT_NOTEBOOK, parameters=dict(PM_VERSION=pm.__version__, DATA_PATHS=[tiny_ic_data_path], REPS=1, IM_SIZES=[60, 70], LEARNING_RATES=[0.001, 0.0001]), kernel_name=KERNEL_NAME)
    nb_output = sb.read_notebook(OUTPUT_NOTEBOOK)
