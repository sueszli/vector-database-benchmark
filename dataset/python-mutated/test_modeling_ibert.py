...
if is_torch_available():
    ...
    from transformers import IBERT_PRETRAINED_MODEL_ARCHIVE_LIST, IBertForMaskedLM, IBertForMultipleChoice, IBertForQuestionAnswering, IBertForSequenceClassification, IBertForTokenClassification, IBertModel
    from transformers.models.ibert.modeling_ibert import IBertEmbeddings, IntGELU, IntLayerNorm, IntSoftmax, QuantAct, QuantEmbedding, QuantLinear, create_position_ids_from_input_ids
...
class IBertModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (IBertForMaskedLM, IBertModel, IBertForSequenceClassification, IBertForTokenClassification, IBertForMultipleChoice, IBertForQuestionAnswering) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': IBertModel, 'fill-mask': IBertForMaskedLM, 'question-answering': IBertForQuestionAnswering, 'text-classification': IBertForSequenceClassification, 'token-classification': IBertForTokenClassification, 'zero-shot': IBertForSequenceClassification} if is_torch_available() else {}
