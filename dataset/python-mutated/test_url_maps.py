...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.UrlMapsRestTransport, 'rest')])
...
def test_url_maps_client_get_transport_class():
    ...
    available_transports = [transports.UrlMapsRestTransport]
    assert transport in available_transports
    transport = UrlMapsClient.get_transport_class('rest')
    assert transport == transports.UrlMapsRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(UrlMapsClient, transports.UrlMapsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(UrlMapsClient, transports.UrlMapsRestTransport, 'rest', 'true'), (UrlMapsClient, transports.UrlMapsRestTransport, 'rest', 'false')])
@mock.patch.object(UrlMapsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(UrlMapsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(UrlMapsClient, transports.UrlMapsRestTransport, 'rest', None)])
...
def test_aggregated_list_rest(request_type):
    if False:
        i = 10
        return i + 15
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1'}
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.UrlMapsAggregatedList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value', unreachables=['unreachables_value'])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    if False:
        while True:
            i = 10
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_aggregated_list') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_aggregated_list') as pre:
...
def test_aggregated_list_rest_bad_request(transport: str='rest', request_type=compute.AggregatedListUrlMapsRequest):
    if False:
        while True:
            i = 10
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1'}
    request = request_type(**request_init)
...
def test_aggregated_list_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.aggregated_list(compute.AggregatedListUrlMapsRequest(), project='project_value')
...
def test_aggregated_list_rest_pager(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.UrlMapsAggregatedList(items={'a': compute.UrlMapsScopedList(), 'b': compute.UrlMapsScopedList(), 'c': compute.UrlMapsScopedList()}, next_page_token='abc'), compute.UrlMapsAggregatedList(items={}, next_page_token='def'), compute.UrlMapsAggregatedList(items={'g': compute.UrlMapsScopedList()}, next_page_token='ghi'), compute.UrlMapsAggregatedList(items={'h': compute.UrlMapsScopedList(), 'i': compute.UrlMapsScopedList()}))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_delete') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteUrlMapRequest(), project='project_value', url_map='url_map_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteUrlMapRequest(), project='project_value', url_map='url_map_value')
...
def test_get_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.UrlMap(creation_timestamp='creation_timestamp_value', default_service='default_service_value', description='description_value', fingerprint='fingerprint_value', id=205, kind='kind_value', name='name_value', region='region_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_get') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetUrlMapRequest(), project='project_value', url_map='url_map_value')
...
def test_insert_rest(request_type):
    ...
    for (field, value) in request_init['url_map_resource'].items():
        result = None
        is_repeated = False
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_insert') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1'}
        mock_args = dict(project='project_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertUrlMapRequest(), project='project_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertUrlMapRequest(), project='project_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_invalidate_cache_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['cache_invalidation_rule_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_invalidate_cache_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_invalidate_cache') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_invalidate_cache') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_invalidate_cache_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'url_map': 'sample2'}
        mock_args = dict(project='project_value', url_map='url_map_value', cache_invalidation_rule_resource=compute.CacheInvalidationRule(host='host_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_invalidate_cache_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.invalidate_cache(compute.InvalidateCacheUrlMapRequest(), project='project_value', url_map='url_map_value', cache_invalidation_rule_resource=compute.CacheInvalidationRule(host='host_value'))
...
def test_invalidate_cache_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.invalidate_cache_unary(compute.InvalidateCacheUrlMapRequest(), project='project_value', url_map='url_map_value', cache_invalidation_rule_resource=compute.CacheInvalidationRule(host='host_value'))
...
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.UrlMapList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_list') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListUrlMapsRequest(), project='project_value')
...
def test_list_rest_pager(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.UrlMapList(items=[compute.UrlMap(), compute.UrlMap(), compute.UrlMap()], next_page_token='abc'), compute.UrlMapList(items=[], next_page_token='def'), compute.UrlMapList(items=[compute.UrlMap()], next_page_token='ghi'), compute.UrlMapList(items=[compute.UrlMap(), compute.UrlMap()]))
        response = response + response
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_patch') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'url_map': 'sample2'}
        mock_args = dict(project='project_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchUrlMapRequest(), project='project_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchUrlMapRequest(), project='project_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_update_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_update') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_update') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update(compute.UpdateUrlMapRequest(), project='project_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_update_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_unary(compute.UpdateUrlMapRequest(), project='project_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_validate_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['url_maps_validate_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.UrlMapsRestInterceptor())
    client = UrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.UrlMapsRestInterceptor, 'post_validate') as post, mock.patch.object(transports.UrlMapsRestInterceptor, 'pre_validate') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.UrlMapsValidateResponse()
        sample_request = {'project': 'sample1', 'url_map': 'sample2'}
        mock_args = dict(project='project_value', url_map='url_map_value', url_maps_validate_request_resource=compute.UrlMapsValidateRequest(load_balancing_schemes=['load_balancing_schemes_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.UrlMapsValidateResponse.pb(return_value)
...
def test_validate_rest_flattened_error(transport: str='rest'):
    ...
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.validate(compute.ValidateUrlMapRequest(), project='project_value', url_map='url_map_value', url_maps_validate_request_resource=compute.UrlMapsValidateRequest(load_balancing_schemes=['load_balancing_schemes_value']))
...
def test_credentials_transport_error():
    ...
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = UrlMapsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = UrlMapsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.UrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = UrlMapsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_kind(transport_name):
    if False:
        print('Hello World!')
    transport = UrlMapsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_url_maps_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.UrlMapsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_url_maps_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport.__init__') as Transport:
        ...
        transport = transports.UrlMapsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('aggregated_list', 'delete', 'get', 'insert', 'invalidate_cache', 'list', 'patch', 'update', 'validate')
...
def test_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.url_maps.transports.UrlMapsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.UrlMapsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_url_maps_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.UrlMapsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_url_maps_host_no_port(transport_name):
    if False:
        return 10
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_url_maps_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_url_maps_client_transport_session_collision(transport_name):
    ...
    client1 = UrlMapsClient(credentials=creds1, transport=transport_name)
    client2 = UrlMapsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.UrlMapsTransport, '_prep_wrapped_messages') as prep:
        client = UrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(UrlMapsClient, transports.UrlMapsRestTransport)])
