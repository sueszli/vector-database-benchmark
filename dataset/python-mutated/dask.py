...
from .compat import DASK_INSTALLED, PANDAS_INSTALLED, SKLEARN_INSTALLED, Client, Future, LGBMNotFittedError, concat, dask_Array, dask_array_from_delayed, dask_bag_from_delayed, dask_DataFrame, dask_Series, default_client, delayed, pd_DataFrame, pd_Series, wait
from .sklearn import LGBMClassifier, LGBMModel, LGBMRanker, LGBMRegressor, _LGBM_ScikitCustomObjectiveFunction, _LGBM_ScikitEvalMetricType, _lgbmmodel_doc_custom_eval_note, _lgbmmodel_doc_fit, _lgbmmodel_doc_predict
...
class DaskLGBMClassifier(LGBMClassifier, _DaskLGBMModel):
    ...
    def fit(self, X: _DaskMatrixLike, y: _DaskCollection, sample_weight: Optional[_DaskVectorLike]=None, init_score: Optional[_DaskCollection]=None, eval_set: Optional[List[Tuple[_DaskMatrixLike, _DaskCollection]]]=None, eval_names: Optional[List[str]]=None, eval_sample_weight: Optional[List[_DaskVectorLike]]=None, eval_class_weight: Optional[List[Union[dict, str]]]=None, eval_init_score: Optional[List[_DaskCollection]]=None, eval_metric: Optional[_LGBM_ScikitEvalMetricType]=None, **kwargs: Any) -> 'DaskLGBMClassifier':
        ...
        return self
    _base_doc = _lgbmmodel_doc_fit.format(X_shape='Dask Array or Dask DataFrame of shape = [n_samples, n_features]', y_shape='Dask Array, Dask DataFrame or Dask Series of shape = [n_samples]', sample_weight_shape='Dask Array or Dask Series of shape = [n_samples] or None, optional (default=None)', init_score_shape='Dask Array or Dask Series of shape = [n_samples] or shape = [n_samples * n_classes] (for multi-class task), or Dask Array or Dask DataFrame of shape = [n_samples, n_classes] (for multi-class task), or None, optional (default=None)', group_shape='Dask Array or Dask Series or None, optional (default=None)', eval_sample_weight_shape='list of Dask Array or Dask Series, or None, optional (default=None)', eval_init_score_shape='list of Dask Array, Dask Series or Dask DataFrame (for multi-class task), or None, optional (default=None)', eval_group_shape='list of Dask Array or Dask Series, or None, optional (default=None)')
...
class DaskLGBMRanker(LGBMRanker, _DaskLGBMModel):
    ...
    _base_doc = _lgbmmodel_doc_fit.format(X_shape='Dask Array or Dask DataFrame of shape = [n_samples, n_features]', y_shape='Dask Array, Dask DataFrame or Dask Series of shape = [n_samples]', sample_weight_shape='Dask Array or Dask Series of shape = [n_samples] or None, optional (default=None)', init_score_shape='Dask Array or Dask Series of shape = [n_samples] or None, optional (default=None)', group_shape='Dask Array or Dask Series or None, optional (default=None)', eval_sample_weight_shape='list of Dask Array or Dask Series, or None, optional (default=None)', eval_init_score_shape='list of Dask Array or Dask Series, or None, optional (default=None)', eval_group_shape='list of Dask Array or Dask Series, or None, optional (default=None)')
    _base_doc = _base_doc[:_base_doc.find('eval_class_weight :')] + _base_doc[_base_doc.find('eval_init_score :'):]
    _base_doc = _base_doc[:_base_doc.find('feature_name :')] + 'eval_at : list or tuple of int, optional (default=(1, 2, 3, 4, 5))\n' + f"{' ':8}The evaluation positions of the specified metric.\n" + f"{' ':4}{_base_doc[_base_doc.find('feature_name :'):]}"
