...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0100_action_step_max_length')]
    operations = [migrations.AlterField(model_name='organizationmembership', name='level', field=models.PositiveSmallIntegerField(choices=[(1, 'member'), (8, 'administrator'), (15, 'owner')], default=1)), migrations.AddConstraint(model_name='organizationmembership', constraint=models.UniqueConstraint(condition=models.Q(level=15), fields=('organization_id',), name='only_one_owner_per_organization')), migrations.RunPython(make_first_administrators_owners, make_owners_administrators_again, elidable=True)]