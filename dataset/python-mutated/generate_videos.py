...
tf.app.flags.DEFINE_string('mode', 'single', 'single | multi. Single means generate imitation vidswhere query is being imitated by single sequence. Multimeans generate imitation vids where query is beingimitated by multiple.')
