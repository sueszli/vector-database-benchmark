...
async def google_auth_calendar(code: str=Query(...), state: str=Query(...)):
    ...
    params = {'client_id': client_id, 'client_secret': client_secret, 'redirect_uri': redirect_uri, 'scope': scope, 'grant_type': 'authorization_code', 'code': code, 'access_type': 'offline', 'approval_prompt': 'force'}
