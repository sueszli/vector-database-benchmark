...
class Canvas(app.Canvas):
    ...
    def __init__(self):
        if False:
            i = 10
            return i + 15
        app.Canvas.__init__(self, size=(512, 512), title='Colored instanced cube', keys='interactive')
        (V, I, _) = create_cube()
    ...
    def activate_zoom(self):
        ...
        projection = perspective(45.0, self.size[0] / float(self.size[1]), 2.0, 200.0)
