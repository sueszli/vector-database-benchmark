...
_IMAGE_DOWNLOAD_LINKS = {'train': 'http://images.cocodataset.org/zips/train2017.zip', 'validation': 'http://images.cocodataset.org/zips/val2017.zip', 'test': 'http://images.cocodataset.org/zips/test2017.zip'}
_SPLIT_SIZES = {'train': 118287, 'test': 40670, 'validation': 5000}
_ANNOTATION_DOWNLOAD_LINKS = {'train': 'https://sama-documentation-assets.s3.amazonaws.com/sama-coco/sama-coco-train.zip', 'validation': 'https://sama-documentation-assets.s3.amazonaws.com/sama-coco/sama-coco-val.zip'}
_ANNOTATION_PATHS = {'train': 'annotations/sama_coco_train.json', 'validation': 'annotations/sama_coco_validation.json'}
_TEST_INFO_DOWNLOAD_LINK = 'http://images.cocodataset.org/annotations/image_info_test2017.zip'
