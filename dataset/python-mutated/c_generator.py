...
from pegen.grammar import Alt, Cut, Forced, Gather, GrammarVisitor, Group, Lookahead, NamedItem, NameLeaf, NegativeLookahead, Opt, PositiveLookahead, Repeat0, Repeat1, Rhs, Rule, StringLeaf
from pegen.parser_generator import ParserGenerator
EXTENSION_PREFIX = '#include "pegen.h"\n\n#if defined(Py_DEBUG) && defined(Py_BUILD_CORE)\n#  define D(x) if (Py_DebugFlag) x;\n#else\n#  define D(x)\n#endif\n\n# define MAXSTACK 6000\n\n'
...
class NodeTypes(Enum):
    ...
    SOFT_KEYWORD = 5
    CUT_OPERATOR = 6
BASE_NODETYPES = {'NAME': NodeTypes.NAME_TOKEN, 'NUMBER': NodeTypes.NUMBER_TOKEN, 'STRING': NodeTypes.STRING_TOKEN, 'SOFT_KEYWORD': NodeTypes.SOFT_KEYWORD}
