...
from sentry.sentry_metrics.configuration import GENERIC_METRICS_SCHEMA_VALIDATION_RULES_OPTION_NAME, RELEASE_HEALTH_SCHEMA_VALIDATION_RULES_OPTION_NAME
...
good_sample_transactions_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=90)
bad_sample_transactions_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=90000000)
good_sample_spans_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=90)
bad_sample_spans_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=900000)
good_sample_release_health_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=90)
bad_sample_release_health_message = IngestMetric(org_id=1, project_id=2, name='metric_name', type='c', timestamp=1629360000, tags={'tag1': 'value1', 'tag2': 'value2'}, value=1, retention_days=9000000)
