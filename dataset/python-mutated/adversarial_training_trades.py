...
model = ResNet18()
opt = torch.optim.SGD(model.parameters(), lr=0.1, momentum=0.9, weight_decay=0.0002)
lr_scheduler = MultiStepLR(opt, milestones=[74, 89], gamma=0.1)
criterion = nn.CrossEntropyLoss()
classifier = PyTorchClassifier(model=model, clip_values=(min_pixel_value, max_pixel_value), loss=criterion, optimizer=opt, input_shape=(3, 32, 32), nb_classes=10)
