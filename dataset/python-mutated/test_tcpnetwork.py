...
from golem.network.transport.tcpnetwork import SafeProtocol, SocketAddress, MAX_MESSAGE_SIZE, TCPNetwork
...
class TestConformance(unittest.TestCase, testutils.PEP8MixIn):
    PEP8_FILES = ['golem/network/transport/tcpnetwork.py', 'golem/network/transport/tcpnetwork_helpers.py']
