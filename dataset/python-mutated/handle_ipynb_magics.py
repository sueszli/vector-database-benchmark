...
TRANSFORMED_MAGICS = frozenset(('get_ipython().run_cell_magic', 'get_ipython().system', 'get_ipython().getoutput', 'get_ipython().run_line_magic'))
TOKENS_TO_IGNORE = frozenset(('ENDMARKER', 'NL', 'NEWLINE', 'COMMENT', 'DEDENT', 'UNIMPORTANT_WS', 'ESCAPED_NL'))
PYTHON_CELL_MAGICS = frozenset(('capture', 'prun', 'pypy', 'python', 'python3', 'time', 'timeit'))
