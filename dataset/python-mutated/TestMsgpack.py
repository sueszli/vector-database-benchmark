...
class TestMsgpack:
    test_data = OrderedDict(sorted({'cmd': 'fileGet', 'bin': b'p\x81zDhL\xf0O\xd0\xaf', 'params': {'site': '1Site'}, 'utf8': b'\xc3\xa1rv\xc3\xadzt\xc5\xb1r\xc5\x91'.decode('utf8'), 'list': [b'p\x81zDhL\xf0O\xd0\xaf', b'p\x81zDhL\xf0O\xd0\xaf']}.items()))
