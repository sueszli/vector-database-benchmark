...
class RadioKapitalShowIE(RadioKapitalBaseIE):
    ...
    _TESTS = [{'url': 'https://radiokapital.pl/shows/wesz', 'info_dict': {'id': '100', 'title': 'WĘSZ', 'description': 'md5:3a557a1e0f31af612b0dcc85b1e0ca5c'}, 'playlist_mincount': 17}]
