...
class DevoloDeviceEntity(Entity):
    ...
    async def async_added_to_hass(self) -> None:
        ...
        assert self.device_info['name']
        self.subscriber = Subscriber(self.device_info['name'], callback=self.sync_callback)
        self._homecontrol.publisher.register(self._device_instance.uid, self.subscriber, self.sync_callback)

    async def async_will_remove_from_hass(self) -> None:
        """Call when entity is removed or disabled."""
        self._homecontrol.publisher.unregister(self._device_instance.uid, self.subscriber)
