...
from ...operations._credits_operations import build_get_request
...
class CreditsOperations:
    ...
    async def get(self, billing_account_id: str, billing_profile_id: str, **kwargs: Any) -> Optional[_models.CreditSummary]:
        ...
        request = build_get_request(billing_account_id=billing_account_id, billing_profile_id=billing_profile_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
