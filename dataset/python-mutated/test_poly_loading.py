...
class LoadBaseAndSubWEagerRelOpt(BaseAndSubFixture, fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
    use_options = True
...
class LoadBaseAndSubWEagerRelMapped(BaseAndSubFixture, fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
    use_options = False
...
class LoaderOptionsTest(fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
...
class NoBaseWPPlusAliasedTest(testing.AssertsExecutionResults, fixtures.TestBase):
    """test for #7799"""
...
class PolymorphicOnExprTest(testing.AssertsExecutionResults, fixtures.TestBase):
    """test for #8704"""
