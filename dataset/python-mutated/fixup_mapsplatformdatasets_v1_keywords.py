...
class mapsplatformdatasetsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_dataset': ('parent', 'dataset'), 'delete_dataset': ('name',), 'get_dataset': ('name',), 'list_datasets': ('parent', 'page_size', 'page_token'), 'update_dataset_metadata': ('dataset', 'update_mask')}
