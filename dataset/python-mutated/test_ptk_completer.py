...
EXPANSION_CASES = (('sanity', 6, dict(prefix='sanity', line='sanity', begidx=0, endidx=6, multiline_text='sanity', cursor_index=6)), ('gb ', 3, dict(prefix='', line='git branch ', begidx=11, endidx=11, multiline_text='git branch ', cursor_index=11)), ('gb ', 1, dict(prefix='g', line='gb ', begidx=0, endidx=1, multiline_text='gb ', cursor_index=1)), ('gb', 0, dict(prefix='', line='gb', begidx=0, endidx=0, multiline_text='gb', cursor_index=0)), (' gb ', 0, dict(prefix='', line=' gb ', begidx=0, endidx=0, multiline_text=' gb ', cursor_index=0)), ('gb --', 5, dict(prefix='--', line='git branch --', begidx=11, endidx=13, multiline_text='git branch --', cursor_index=13)), ('nice\ngb --', 10, dict(prefix='--', line='git branch --', begidx=11, endidx=13, multiline_text='nice\ngit branch --', cursor_index=18)), ('nice\n gb --', 11, dict(prefix='--', line=' git branch --', begidx=12, endidx=14, multiline_text='nice\n git branch --', cursor_index=19)), ('gb -- wow', 5, dict(prefix='--', line='git branch -- wow', begidx=11, endidx=13, multiline_text='git branch -- wow', cursor_index=13)), ('gb --wow', 5, dict(prefix='--', line='git branch --wow', begidx=11, endidx=13, multiline_text='git branch --wow', cursor_index=13)))
