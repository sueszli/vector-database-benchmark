...
if TYPE_CHECKING:
    ...
    UVec4DLike = Any
UVec4DArrayLike = Union[UVec4D, Sequence[UVec4DLike], npt.NDArray[Any], npt.ArrayLike, Sequence[Sequence[int]], Sequence[int]]
...
class UVec4DType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            return 10
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.uint32(), nullable=False, metadata={}), 4), self._TYPE_NAME)
