...
build_jobs = {}
packages = {'Windows amd64': {'fletd_asset': 'windows_amd64', 'fletd_exec': 'fletd.exe', 'flet_client_job': 'Build Flet for Windows', 'flet_client_artifact': 'flet_windows', 'flet_client_filename': 'flet-windows.zip', 'wheel_tags': ['py3-none-win_amd64'], 'file_suffix': 'py3-none-win_amd64'}, 'Windows x86': {'fletd_asset': 'windows_386', 'fletd_exec': 'fletd.exe', 'flet_client_job': 'Build Flet for Windows', 'flet_client_artifact': 'flet_windows', 'flet_client_filename': 'flet-windows.zip', 'wheel_tags': ['py3-none-win32'], 'file_suffix': 'py3-none-win32'}, 'Linux amd64 (Alpine)': {'fletd_asset': 'linux_amd64', 'fletd_exec': 'fletd', 'wheel_tags': ['py3-none-musllinux_1_2_x86_64'], 'file_suffix': 'py3-none-musllinux_1_2_x86_64'}, 'Linux amd64': {'fletd_asset': 'linux_amd64', 'fletd_exec': 'fletd', 'flet_client_job': 'Build Flet for Linux', 'flet_client_artifact': 'flet_linux_amd64', 'flet_client_filename': 'flet-linux-amd64.tar.gz', 'wheel_tags': ['py3-none-manylinux_2_17_x86_64', 'py3-none-manylinux2014_x86_64'], 'file_suffix': 'py3-none-manylinux_2_17_x86_64.manylinux2014_x86_64'}, 'Linux arm64': {'fletd_asset': 'linux_arm64', 'fletd_exec': 'fletd', 'flet_client_job': 'Build Flet for Linux ARM64', 'flet_client_artifact': 'flet_linux_arm64', 'flet_client_filename': 'flet-linux-arm64.tar.gz', 'wheel_tags': ['py3-none-manylinux_2_17_aarch64', 'py3-none-manylinux2014_aarch64'], 'file_suffix': 'py3-none-manylinux_2_17_aarch64.manylinux2014_aarch64'}, 'Linux arm': {'fletd_asset': 'linux_arm_7', 'fletd_exec': 'fletd', 'wheel_tags': ['py3-none-manylinux_2_17_armv7l', 'py3-none-manylinux2014_armv7l'], 'file_suffix': 'py3-none-manylinux_2_17_armv7l.manylinux2014_armv7l'}, 'macOS amd64': {'fletd_asset': 'darwin_amd64', 'fletd_exec': 'fletd', 'flet_client_job': 'Build Flet for macOS', 'flet_client_artifact': 'flet_macos', 'flet_client_filename': 'flet-macos-amd64.tar.gz', 'wheel_tags': ['py3-none-macosx_10_14_x86_64'], 'file_suffix': 'py3-none-macosx_10_14_x86_64'}, 'macOS arm64': {'fletd_asset': 'darwin_arm64', 'fletd_exec': 'fletd', 'flet_client_job': 'Build Flet for macOS', 'flet_client_artifact': 'flet_macos', 'flet_client_filename': 'flet-macos-amd64.tar.gz', 'wheel_tags': ['py3-none-macosx_12_0_arm64'], 'file_suffix': 'py3-none-macosx_12_0_arm64'}}
...
for (name, package) in packages.items():
    ...
    wheel_path = str(unpacked_whl.joinpath(f'flet-{package_version}.dist-info', 'WHEEL'))
    wheel_lines = []
    ...
    if flet_client_job:
        ...
        download_artifact_by_name(build_jobs[flet_client_job], flet_client_artifact, client_arch_path)
    ...
    record_path = str(unpacked_whl.joinpath(f'flet-{package_version}.dist-info', 'RECORD'))
