...
class GeneralTab(TabPanel):
    LOCALE_NAMES = twodict([('ar_SA', 'Arabic'), ('cs_CZ', 'Czech'), ('en_US', 'English'), ('fr_FR', 'French'), ('it_IT', 'Italian'), ('ja_JP', 'Japanese'), ('ko_KR', 'Korean'), ('pt_BR', 'Portuguese'), ('ru_RU', 'Russian'), ('es_ES', 'Spanish')])
    OUTPUT_TEMPLATES = ['Id', 'Title', 'Ext', 'Uploader', 'Resolution', 'Autonumber', '', 'View Count', 'Like Count', 'Dislike Count', 'Comment Count', 'Average Rating', 'Age Limit', 'Width', 'Height', 'Extractor', '', 'Playlist', 'Playlist Index']
    BUTTONS_SIZE = (30, -1)
...
class DownloadsTab(TabPanel):
    SUBS_LANG = twodict([('en', _('English')), ('fr', _('French')), ('de', _('German')), ('el', _('Greek')), ('he', _('Hebrew')), ('it', _('Italian')), ('pt', _('Portuguese')), ('ru', _('Russian')), ('es', _('Spanish')), ('sv', _('Swedish')), ('tr', _('Turkish'))])
    FILESIZES = twodict([('', 'Bytes'), ('k', 'Kilobytes'), ('m', 'Megabytes'), ('g', 'Gigabytes'), ('t', 'Terabytes'), ('p', 'Petabytes'), ('e', 'Exabytes'), ('z', 'Zettabytes'), ('y', 'Yottabytes')])
    SUBS_CHOICES = [_('None'), _('Automatic subtitles (YOUTUBE ONLY)'), _('All available subtitles'), _('Subtitles by language')]
