...
from ..utils import ExtractorError, RegexNotFoundError, UserNotLive, clean_html, determine_ext, float_or_none, int_or_none, mimetype2ext, parse_age_limit, parse_duration, remove_end, smuggle_url, traverse_obj, try_get, unescapeHTML, unified_timestamp, update_url_query, url_basename

class NBCIE(ThePlatformIE):
    _VALID_URL = 'https?(?P<permalink>://(?:www\\.)?nbc\\.com/(?:classic-tv/)?[^/]+/video/[^/]+/(?P<id>(?:NBCE|n)?\\d+))'
    _TESTS = [{'url': 'http://www.nbc.com/the-tonight-show/video/jimmy-fallon-surprises-fans-at-ben-jerrys/2848237', 'info_dict': {'id': '2848237', 'ext': 'mp4', 'title': "Jimmy Fallon Surprises Fans at Ben & Jerry's", 'description': 'Jimmy gives out free scoops of his new "Tonight Dough" ice cream flavor by surprising customers at the Ben & Jerry\'s scoop shop.', 'timestamp': 1424246400, 'upload_date': '20150218', 'uploader': 'NBCU-COM', 'episode': "Jimmy Fallon Surprises Fans at Ben & Jerry's", 'episode_number': 86, 'season': 'Season 2', 'season_number': 2, 'series': 'Tonight Show: Jimmy Fallon', 'duration': 237.0, 'chapters': 'count:1', 'tags': 'count:4', 'thumbnail': 're:https?://.+\\.jpg'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'http://www.nbc.com/saturday-night-live/video/star-wars-teaser/2832821', 'info_dict': {'id': '2832821', 'ext': 'mp4', 'title': 'Star Wars Teaser', 'description': 'md5:0b40f9cbde5b671a7ff62fceccc4f442', 'timestamp': 1417852800, 'upload_date': '20141206', 'uploader': 'NBCU-COM'}, 'skip': 'page not found'}, {'url': 'http://www.nbc.com/Kings/video/goliath/n1806', 'info_dict': {'id': '101528f5a9e8127b107e98c5e6ce4638', 'ext': 'mp4', 'title': 'Goliath', 'description': "When an unknown soldier saves the life of the King's son in battle, he's thrust into the limelight and politics of the kingdom.", 'timestamp': 1237100400, 'upload_date': '20090315', 'uploader': 'NBCU-COM'}, 'skip': 'page not found'}, {'url': 'https://www.nbc.com/the-golden-globe-awards/video/oprah-winfrey-receives-cecil-b-de-mille-award-at-the-2018-golden-globes/3646439', 'info_dict': {'id': '3646439', 'ext': 'mp4', 'title': 'Oprah Winfrey Receives Cecil B. de Mille Award at the 2018 Golden Globes', 'episode': 'Oprah Winfrey Receives Cecil B. de Mille Award at the 2018 Golden Globes', 'episode_number': 1, 'season': 'Season 75', 'season_number': 75, 'series': 'The Golden Globe Awards', 'description': 'Oprah Winfrey receives the Cecil B. de Mille Award at the 75th Annual Golden Globe Awards.', 'uploader': 'NBCU-COM', 'upload_date': '20180107', 'timestamp': 1515312000, 'duration': 570.0, 'tags': 'count:8', 'thumbnail': 're:https?://.+\\.jpg', 'chapters': 'count:1'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.nbc.com/quantum-leap/video/bens-first-leap-nbcs-quantum-leap/NBCE125189978', 'info_dict': {'id': 'NBCE125189978', 'ext': 'mp4', 'title': "Ben's First Leap | NBC's Quantum Leap", 'description': 'md5:a82762449b7ec4bb83291a7b355ebf8e', 'uploader': 'NBCU-COM', 'series': 'Quantum Leap', 'season': 'Season 1', 'season_number': 1, 'episode': "Ben's First Leap | NBC's Quantum Leap", 'episode_number': 1, 'duration': 170.171, 'chapters': [], 'timestamp': 1663956155, 'upload_date': '20220923', 'tags': 'count:10', 'age_limit': 0, 'thumbnail': 're:https?://.+\\.jpg'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.nbc.com/classic-tv/charles-in-charge/video/charles-in-charge-pilot/n3310', 'only_matching': True}, {'url': 'https://www.nbc.com/up-all-night/video/day-after-valentine%27s-day/n2189', 'only_matching': True}]
...
class NBCSportsVPlayerIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://(?:vplayer\\.nbcsports\\.com|(?:www\\.)?nbcsports\\.com/vplayer)/'
    _VALID_URL = _VALID_URL_BASE + '(?:[^/]+/)+(?P<id>[0-9a-zA-Z_]+)'
    _EMBED_REGEX = ['(?:iframe[^>]+|var video|div[^>]+data-(?:mpx-)?)[sS]rc\\s?=\\s?"(?P<url>%s[^\\"]+)' % _VALID_URL_BASE]
    _TESTS = [{'url': 'https://vplayer.nbcsports.com/p/BxmELC/nbcsports_embed/select/9CsDKds0kvHI', 'info_dict': {'id': '9CsDKds0kvHI', 'ext': 'mp4', 'description': 'md5:df390f70a9ba7c95ff1daace988f0d8d', 'title': 'Tyler Kalinoski hits buzzer-beater to lift Davidson', 'timestamp': 1426270238, 'upload_date': '20150313', 'uploader': 'NBCU-SPORTS', 'duration': 72.818, 'chapters': [], 'thumbnail': 're:^https?://.*\\.jpg$'}}, {'url': 'https://vplayer.nbcsports.com/p/BxmELC/nbcsports_embed/select/media/PEgOtlNcC_y2', 'only_matching': True}, {'url': 'https://www.nbcsports.com/vplayer/p/BxmELC/nbcsports/select/PHJSaFWbrTY9?form=html&autoPlay=true', 'only_matching': True}]
...
class NBCSportsIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.nbcsports.com/watch/nfl/profootballtalk/pft-pm/unpacking-addisons-reckless-driving-citation', 'info_dict': {'id': 'PHJSaFWbrTY9', 'ext': 'mp4', 'title': "Tom Izzo, Michigan St. has 'so much respect' for Duke", 'description': 'md5:ecb459c9d59e0766ac9c7d5d0eda8113', 'uploader': 'NBCU-SPORTS', 'upload_date': '20150330', 'timestamp': 1427726529, 'chapters': [], 'thumbnail': 'https://hdliveextra-a.akamaihd.net/HD/image_sports/NBCU_Sports_Group_-_nbcsports/253/303/izzodps.jpg', 'duration': 528.395}}, {'url': 'https://www.nbcsports.com/philadelphia/philadelphia-phillies/bruce-bochy-hector-neris-hes-idiot', 'only_matching': True}, {'url': 'https://www.nbcsports.com/boston/video/report-card-pats-secondary-no-match-josh-allen', 'only_matching': True}]
...
class NBCSportsStreamIE(AdobePassIE):
    ...
    _TEST = {'url': 'http://stream.nbcsports.com/nbcsn/generic?pid=206559', 'info_dict': {'id': '206559', 'ext': 'mp4', 'title': "Amgen Tour of California Women's Recap", 'description': 'md5:66520066b3b5281ada7698d0ea2aa894'}, 'params': {'skip_download': True}, 'skip': 'Requires Adobe Pass Authentication'}
...
class NBCOlympicsStreamIE(AdobePassIE):
    ...
    _TESTS = [{'note': 'Tokenized m3u8 source URL', 'url': 'https://stream.nbcolympics.com/womens-soccer-group-round-11', 'info_dict': {'id': '2019740', 'ext': 'mp4', 'title': "re:Women's Group Stage - Netherlands vs\\. Brazil [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$"}, 'params': {'skip_download': 'm3u8'}, 'skip': 'Livestream'}, {'note': 'Plain m3u8 source URL', 'url': 'https://stream.nbcolympics.com/gymnastics-event-finals-mens-floor-pommel-horse-womens-vault-bars', 'info_dict': {'id': '2021729', 'ext': 'mp4', 'title': 're:Event Finals: M Floor, W Vault, M Pommel, W Uneven Bars [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$'}, 'params': {'skip_download': 'm3u8'}, 'skip': 'Livestream'}]
...
class NBCStationsIE(InfoExtractor):
    _DOMAIN_RE = '|'.join(map(re.escape, ('nbcbayarea', 'nbcboston', 'nbcchicago', 'nbcconnecticut', 'nbcdfw', 'nbclosangeles', 'nbcmiami', 'nbcnewyork', 'nbcphiladelphia', 'nbcsandiego', 'nbcwashington', 'necn', 'telemundo52', 'telemundoarizona', 'telemundochicago', 'telemundonuevainglaterra')))
    _VALID_URL = f'https?://(?:www\\.)?(?P<site>{_DOMAIN_RE})\\.com/(?:[^/?#]+/)*(?P<id>[^/?#]+)/?(?:$|[#?])'
    _TESTS = [{'url': 'https://www.nbclosangeles.com/news/local/large-structure-fire-in-downtown-la-prompts-smoke-odor-advisory/2968618/', 'info_dict': {'id': '2968618', 'ext': 'mp4', 'title': 'Large Structure Fire in Downtown LA Prompts Smoke Odor Advisory', 'description': 'md5:417ed3c2d91fe9d301e6db7b0942f182', 'duration': 112.513, 'timestamp': 1661135892, 'upload_date': '20220822', 'uploader': 'NBC 4', 'channel_id': 'KNBC', 'channel': 'nbclosangeles'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.telemundoarizona.com/responde/huracan-complica-reembolso-para-televidente-de-tucson/2247002/', 'info_dict': {'id': '2247002', 'ext': 'mp4', 'title': 'Huracán complica que televidente de Tucson reciba  reembolso', 'description': 'md5:af298dc73aab74d4fca6abfb12acb6cf', 'duration': 172.406, 'timestamp': 1660886507, 'upload_date': '20220819', 'uploader': 'Telemundo Arizona', 'channel_id': 'KTAZ', 'channel': 'telemundoarizona'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.nbcboston.com/weather/video-weather/highs-near-freezing-in-boston-on-wednesday/2961135/', 'md5': '9bf8c41dc7abbb75b1a44f1491a4cc85', 'info_dict': {'id': '2961135', 'ext': 'mp4', 'title': 'Highs Near Freezing in Boston on Wednesday', 'description': 'md5:3ec486609a926c99f00a3512e6c0e85b', 'duration': 235.669, 'timestamp': 1675268656, 'upload_date': '20230201', 'uploader': '', 'channel_id': 'WBTS', 'channel': 'nbcboston'}}]
