...
from typing import TYPE_CHECKING, Any, Callable, Iterator, Mapping, NamedTuple, Optional, Sequence, Set, Union, cast, overload
import pendulum
...
from dagster._core.errors import DagsterInvalidDefinitionError, DagsterInvariantViolationError, RunStatusSensorExecutionError, user_code_error_boundary
...
from .sensor_definition import DagsterRunReaction, DefaultSensorStatus, RawSensorEvaluationFunctionReturn, RunRequest, SensorDefinition, SensorEvaluationContext, SensorResult, SensorType, SkipReason, get_context_param_name, get_or_create_sensor_context, validate_and_get_resource_dict
...
RunStatusSensorEvaluationFunction: TypeAlias = Union[Callable[..., RawSensorEvaluationFunctionReturn], Callable[..., RawSensorEvaluationFunctionReturn]]
RunFailureSensorEvaluationFn: TypeAlias = Union[Callable[..., RawSensorEvaluationFunctionReturn], Callable[..., RawSensorEvaluationFunctionReturn]]

@whitelist_for_serdes(old_storage_names={'PipelineSensorCursor'})
class RunStatusSensorCursor(NamedTuple('_RunStatusSensorCursor', [('record_id', int), ('update_timestamp', str)])):
