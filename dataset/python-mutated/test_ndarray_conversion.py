...
@testing.parameterize({'shape': ()}, {'shape': (1,)}, {'shape': (1, 1, 1)})
...
@testing.parameterize({'shape': (0,)}, {'shape': (2, 3)}, {'shape': (1, 0, 1)})
...
@testing.parameterize({'shape': ()}, {'shape': (1,)}, {'shape': (2, 3)}, {'shape': (2, 3), 'order': 'C'}, {'shape': (2, 3), 'order': 'F'})
