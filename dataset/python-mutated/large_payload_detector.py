...
from ..base import DetectorType, PerformanceDetector, fingerprint_http_spans, get_notification_attachment_body, get_span_duration, get_span_evidence_value
from ..performance_problem import PerformanceProblem
from ..types import Span
EXTENSION_REGEX = re.compile('\\.([a-zA-Z0-9]+)/?(?!/)(\\?.*)?$')
EXTENSION_ALLOW_LIST = ('JSON',)
MINIMUM_SPAN_DURATION = timedelta(milliseconds=100)
