...
def test_transform_can_override_blending_parameters():
    ...
    try:
        ...
        assert 'should have raised' not in str(ae)
pu.run_tests([test_transform_produces_the_same_result_as_predict_by_default, test_transform_can_be_applied_to_training_frame_with_special_flag, test_transform_can_override_noise, test_transform_can_override_blending_parameters])