...
class NoRecursive(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[NoRecursiveArgs]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            while True:
                i = 10
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, __props__=None):
        ...
        super(NoRecursive, __self__).__init__('example::NoRecursive', resource_name, __props__, opts)

    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions]=None) -> 'NoRecursive':
        if False:
            for i in range(10):
                print('nop')
