...
MSGS = {MSG_NONE: 'No messages', MSG_ITER: 'One line per iteration', MSG_INFO: 'Informational messages', MSG_VERS: 'Version info', MSG_EXIT: 'Exit reasons', MSG_ALL: 'All messages'}
INFEASIBLE = -1
LOCALMINIMUM = 0
FCONVERGED = 1
XCONVERGED = 2
