...
from zerver.models import GENERIC_INTERFACE, SLACK_INTERFACE, Realm, Service, UserProfile, get_client, get_user_profile_by_id
...
class SlackOutgoingWebhookService(OutgoingWebhookServiceInterface):
    ...
    def process_success(self, response_json: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        if 'text' in response_json:
            ...
            return success_data
        return None
AVAILABLE_OUTGOING_WEBHOOK_INTERFACES: Dict[str, Any] = {GENERIC_INTERFACE: GenericOutgoingWebhookService, SLACK_INTERFACE: SlackOutgoingWebhookService}
