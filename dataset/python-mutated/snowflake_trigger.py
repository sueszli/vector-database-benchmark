...
class SnowflakeSqlApiTrigger(BaseTrigger):
    ...
    async def run(self) -> AsyncIterator[TriggerEvent]:
        ...
        SnowflakeSqlApiHook(self.snowflake_conn_id, self.token_life_time, self.token_renewal_delta)
        try:
    ...
    async def get_query_status(self, query_id: str) -> dict[str, Any]:
        ...
        hook = SnowflakeSqlApiHook(self.snowflake_conn_id, self.token_life_time, self.token_renewal_delta)
