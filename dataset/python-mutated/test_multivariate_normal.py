...
@testing.parameterize(*testing.product({'shape': [(3, 2), (1,)], 'is_variable': [True, False], 'sample_shape': [(3, 2), ()], 'event_shape': [(3,)]}))
@testing.fix_random()
...
@testing.parameterize(*testing.product({'d': [3, 1, 0], 'lower': [True, False], 'dtype': [numpy.float32]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'d': [3, 5], 'lower': [True, False], 'dtype': [numpy.float32]}))
