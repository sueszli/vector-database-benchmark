...
from sentry.api.serializers.models.project import OrganizationProjectResponse, ProjectSummarySerializer
...
DATASETS = {'': discover, 'discover': discover, 'metricsEnhanced': metrics_enhanced_performance, 'metrics': metrics_performance}
