...
def test_gridsearch():
    ...
    hyper_parameters = {'lambda': [1, 2], 'subspaces': [{'scale': [[0.001], [0.0002]], 'bs': [[1], [0]], 'gam_columns': [[['c_0']], [['c_1']]]}, {'scale': [[0.001, 0.001, 0.001], [0.0002, 0.0002, 0.0002]], 'bs': [[2, 0, 1], [3, 2, 1]], 'gam_columns': [[['c_0'], ['c_1'], ['c_3', 'c_4', 'c_5']], [['c_1'], ['c_2'], ['c_4', 'c_5', 'c_6']]]}]}
    hyper_parameters2 = {'lambda': [1, 2], 'subspaces': [{'scale': [[0.001], [0.0002]], 'bs': [[1], [0]], 'gam_columns': [[['c_0']], [['c_1']]]}, {'scale': [[0.001, 0.001, 0.001], [0.0002, 0.0002, 0.0002]], 'bs': [[2, 0, 1], [3, 2, 1]], 'gam_columns': [['c_0', ['c_1'], ['c_3', 'c_4', 'c_5']], ['c_1', ['c_2'], ['c_4', 'c_5', 'c_6']]]}]}
    ...
    for index in range(0, len(h2o_model)):
        ...
        pyunit_utils.assertEqualCoeffDicts(model1Coef, model2Coef, tol=1e-06)
