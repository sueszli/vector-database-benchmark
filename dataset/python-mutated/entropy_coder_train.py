...
tf.app.flags.DEFINE_string('train_dir', None, 'Directory where to write event logs.')
tf.app.flags.DEFINE_integer('task', None, 'Task id of the replica running the training.')
...
tf.app.flags.DEFINE_string('input_config', None, 'Path to the training input config file.')
tf.app.flags.DEFINE_string('train_config', None, 'Path to the training experiment config file.')
