...
class TestBeamRowFromDict(unittest.TestCase):
    DICT_ROW = {'str': 'a', 'bool': True, 'bytes': b'a', 'int': 1, 'float': 0.1, 'numeric': decimal.Decimal('1.11'), 'timestamp': Timestamp(1000, 100)}
...
class TestBeamTypehintFromSchema(unittest.TestCase):
    EXPECTED_TYPEHINTS = [('str', str), ('bool', bool), ('bytes', bytes), ('int', np.int64), ('float', np.float64), ('numeric', decimal.Decimal), ('timestamp', Timestamp)]
