...
DEV_NULL = '/dev/null'
TEST_CASE_WEEKDAY_SENSOR_TRUE = {'with-string': 'Thursday', 'with-enum': WeekDay.THURSDAY, 'with-enum-set': {WeekDay.THURSDAY}, 'with-enum-list': [WeekDay.THURSDAY], 'with-enum-dict': {WeekDay.THURSDAY: 'some_value'}, 'with-enum-set-2-items': {WeekDay.THURSDAY, WeekDay.FRIDAY}, 'with-enum-list-2-items': [WeekDay.THURSDAY, WeekDay.FRIDAY], 'with-enum-dict-2-items': {WeekDay.THURSDAY: 'some_value', WeekDay.FRIDAY: 'some_value_2'}, 'with-string-set': {'Thursday'}, 'with-string-set-2-items': {'Thursday', 'Friday'}, 'with-set-mix-types': {'Thursday', WeekDay.FRIDAY}, 'with-list-mix-types': ['Thursday', WeekDay.FRIDAY], 'with-dict-mix-types': {'Thursday': 'some_value', WeekDay.FRIDAY: 'some_value_2'}}
