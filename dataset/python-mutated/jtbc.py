...
class JTBCProgramIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tv.jtbc.co.kr/replay/pr10010392/pm10032710', 'info_dict': {'_type': 'playlist', 'id': 'pr10010392'}, 'playlist_count': 398}, {'url': 'https://vod.jtbc.co.kr/program/pr10011491/replay', 'info_dict': {'_type': 'playlist', 'id': 'pr10011491'}, 'playlist_count': 59}]
