...
def main():
    ...
    response = client.desktops.get(resource_group_name='resourceGroup1', application_group_name='applicationGroup1', desktop_name='SessionDesktop')
    print(response)
