...
from ..utils import base_url, clean_html, determine_ext, extract_attributes, ExtractorError, get_element_by_class, JSON_LD_RE, merge_dicts, parse_duration, smuggle_url, try_get, url_or_none, url_basename, urljoin

class ITVIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?itv\\.com/hub/[^/]+/(?P<id>[0-9a-zA-Z]+)'
    _GEO_COUNTRIES = ['GB']
    _TESTS = [{'url': 'https://www.itv.com/hub/plebs/2a1873a0002', 'info_dict': {'id': '2a1873a0002', 'ext': 'mp4', 'title': 'Plebs - The Orgy', 'description': 'md5:4d7159af53ebd5b36e8b3ec82a41fdb4', 'series': 'Plebs', 'season_number': 1, 'episode_number': 1, 'thumbnail': 're:https?://hubimages\\.itv\\.com/episode/2_1873_0002'}, 'params': {'skip_download': True}}, {'url': 'https://www.itv.com/hub/the-jonathan-ross-show/2a1166a0209', 'info_dict': {'id': '2a1166a0209', 'ext': 'mp4', 'title': 'The Jonathan Ross Show - Series 17 - Episode 8', 'description': 'md5:3023dcdd375db1bc9967186cdb3f1399', 'series': 'The Jonathan Ross Show', 'episode_number': 8, 'season_number': 17, 'thumbnail': 're:https?://hubimages\\.itv\\.com/episode/2_1873_0002'}, 'params': {'skip_download': True}}, {'url': 'https://www.itv.com/hub/through-the-keyhole/2a2271a0033', 'only_matching': True}, {'url': 'https://www.itv.com/hub/james-martins-saturday-morning/2a5159a0034', 'only_matching': True}, {'url': 'https://www.itv.com/hub/whos-doing-the-dishes/2a2898a0024', 'only_matching': True}]
...
class ITVBTCCIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.itv.com/btcc/articles/btcc-2019-brands-hatch-gp-race-action', 'info_dict': {'id': 'btcc-2019-brands-hatch-gp-race-action', 'title': 'BTCC 2019: Brands Hatch GP race action'}, 'playlist_count': 12}, {'url': 'https://www.itv.com/news/2021-10-27/i-have-to-protect-the-country-says-rishi-sunak-as-uk-faces-interest-rate-hike', 'info_dict': {'id': 'i-have-to-protect-the-country-says-rishi-sunak-as-uk-faces-interest-rate-hike', 'title': 'md5:6ef054dd9f069330db3dcc66cb772d32'}, 'playlist_count': 4}]
