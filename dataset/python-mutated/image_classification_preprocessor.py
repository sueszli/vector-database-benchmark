...
INTERPOLATION_STYLE = {'bilinear': InterpolationMode('bilinear'), 'nearest': InterpolationMode('nearest'), 'bicubic': InterpolationMode('bicubic')}
INTERPOLATION_STYLE_CV2 = {'bilinear': cv2.INTER_LINEAR, 'nearest': cv2.INTER_NEAREST, 'bicubic': cv2.INTER_CUBIC}
...
@PREPROCESSORS.register_module(Fields.cv, module_name=Preprocessors.image_classification_preprocessor)
