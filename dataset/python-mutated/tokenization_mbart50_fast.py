...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'facebook/mbart-large-50-one-to-many-mmt': 'https://huggingface.co/facebook/mbart-large-50-one-to-many-mmt/resolve/main/sentencepiece.bpe.model'}, 'tokenizer_file': {'facebook/mbart-large-50-one-to-many-mmt': 'https://huggingface.co/facebook/mbart-large-50-one-to-many-mmt/resolve/main/tokenizer.json'}}
