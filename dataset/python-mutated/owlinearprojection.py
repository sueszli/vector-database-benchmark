...
Placement = Enum('Placement', dict(Circular=0, LDA=1, PCA=2), type=int, qualname='Placement')
...
class OWLinearProjection(OWAnchorProjectionWidget):
    ...
    Projection_name = {Placement.Circular: 'Circular Placement', Placement.LDA: 'Linear Discriminant Analysis', Placement.PCA: 'Principal Component Analysis'}
    settings_version = 6
...
if __name__ == '__main__':
    iris = Table('iris')
    WidgetPreview(OWLinearProjection).run(set_data=iris, set_subset_data=iris[::10])