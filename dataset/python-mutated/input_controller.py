...
character_keyboard_key_mapping = {'`': [KeyboardKey.KEY_GRAVE], '~': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_GRAVE], '1': [KeyboardKey.KEY_1], '!': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_1], '2': [KeyboardKey.KEY_2], '@': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_2], '3': [KeyboardKey.KEY_3], '#': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_3], '4': [KeyboardKey.KEY_4], '$': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_4], '5': [KeyboardKey.KEY_5], '%': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_5], '6': [KeyboardKey.KEY_6], '^': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_6], '7': [KeyboardKey.KEY_7], '&': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_7], '8': [KeyboardKey.KEY_8], '*': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_8], '9': [KeyboardKey.KEY_9], '(': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_9], '0': [KeyboardKey.KEY_0], ')': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_0], '-': [KeyboardKey.KEY_MINUS], '_': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_MINUS], '=': [KeyboardKey.KEY_EQUALS], '+': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_EQUALS], 'q': [KeyboardKey.KEY_Q], 'Q': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_Q], 'w': [KeyboardKey.KEY_W], 'W': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_W], 'e': [KeyboardKey.KEY_E], 'E': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_E], 'r': [KeyboardKey.KEY_R], 'R': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_R], 't': [KeyboardKey.KEY_T], 'T': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_T], 'y': [KeyboardKey.KEY_Y], 'Y': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_Y], 'u': [KeyboardKey.KEY_U], 'U': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_U], 'i': [KeyboardKey.KEY_I], 'I': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_I], 'o': [KeyboardKey.KEY_O], 'O': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_O], 'p': [KeyboardKey.KEY_P], 'P': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_P], '[': [KeyboardKey.KEY_LEFT_BRACKET], '{': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_LEFT_BRACKET], ']': [KeyboardKey.KEY_RIGHT_BRACKET], '}': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_RIGHT_BRACKET], '\n': [KeyboardKey.KEY_RETURN], 'a': [KeyboardKey.KEY_A], 'A': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_A], 's': [KeyboardKey.KEY_S], 'S': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_S], 'd': [KeyboardKey.KEY_D], 'D': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_D], 'f': [KeyboardKey.KEY_F], 'F': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_F], 'g': [KeyboardKey.KEY_G], 'G': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_G], 'h': [KeyboardKey.KEY_H], 'H': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_H], 'j': [KeyboardKey.KEY_J], 'J': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_J], 'k': [KeyboardKey.KEY_K], 'K': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_K], 'l': [KeyboardKey.KEY_L], 'L': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_L], ';': [KeyboardKey.KEY_SEMICOLON], ':': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_SEMICOLON], "'": [KeyboardKey.KEY_APOSTROPHE], '"': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_APOSTROPHE], 'z': [KeyboardKey.KEY_Z], 'Z': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_Z], 'x': [KeyboardKey.KEY_X], 'X': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_X], 'c': [KeyboardKey.KEY_C], 'C': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_C], 'v': [KeyboardKey.KEY_V], 'V': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_V], 'b': [KeyboardKey.KEY_B], 'B': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_B], 'n': [KeyboardKey.KEY_N], 'N': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_N], 'm': [KeyboardKey.KEY_M], 'M': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_M], ',': [KeyboardKey.KEY_COMMA], '<': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_COMMA], '.': [KeyboardKey.KEY_PERIOD], '>': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_PERIOD], '/': [KeyboardKey.KEY_SLASH], '?': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_SLASH], '\\': [KeyboardKey.KEY_BACKSLASH], '|': [KeyboardKey.KEY_LEFT_SHIFT, KeyboardKey.KEY_BACKSLASH], ' ': [KeyboardKey.KEY_SPACE]}
