...
class TaskReschedule(Base):
    ...
    __table_args__ = (Index('idx_task_reschedule_dag_task_run', dag_id, task_id, run_id, map_index, unique=False), ForeignKeyConstraint([dag_id, task_id, run_id, map_index], ['task_instance.dag_id', 'task_instance.task_id', 'task_instance.run_id', 'task_instance.map_index'], name='task_reschedule_ti_fkey', ondelete='CASCADE'), Index('idx_task_reschedule_dag_run', dag_id, run_id), ForeignKeyConstraint([dag_id, run_id], ['dag_run.dag_id', 'dag_run.run_id'], name='task_reschedule_dr_fkey', ondelete='CASCADE'))
