...
class CosmosClient(object):
    ...
    async def create_database(self, id: str, **kwargs: Any) -> DatabaseProxy:
        """
    ...
    @distributed_trace_async
    async def create_database_if_not_exists(self, id: str, **kwargs: Any) -> DatabaseProxy:
        """
        ...
        try:
            ...
            return await self.create_database(id, offer_throughput=offer_throughput, **kwargs)
    ...
    @distributed_trace_async
    async def delete_database(self, database: Union[str, DatabaseProxy, Dict[str, Any]], **kwargs: Any) -> None:
