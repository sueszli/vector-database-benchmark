...
from typing import Any, Dict, Generic, List, Mapping, NamedTuple, Optional, Sequence, Type, TypeVar, Union, cast
...
from dagster._core.definitions.time_window_partitions import TimeWindow, TimeWindowPartitionsDefinition
