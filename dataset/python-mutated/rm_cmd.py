...
from trashcli.trash_dirs_scanner import TrashDirsScanner, TopTrashDirRules, trash_dir_found

class RmFileSystemReader(ContentsOf, DirReader, TopTrashDirRules.Reader, Protocol):
    pass
