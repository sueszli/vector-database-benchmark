...
TEST_FIXTURES = {'workflows': ['sequential.yaml', 'join.yaml'], 'actions': ['sequential.yaml', 'join.yaml']}
...
@mock.patch.object(publishers.CUDPublisher, 'publish_create', mock.MagicMock(side_effect=mock_lv_ac_xport.MockLiveActionPublisher.publish_create))
