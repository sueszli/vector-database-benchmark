...
@PIPELINES.register_module(Tasks.speaker_diarization_semantic_speaker_turn_detection, module_name=Pipelines.speaker_diarization_semantic_speaker_turn_detection)
class SpeakerDiarizationSemanticSpeakerTurnDetectionPipeline(Pipeline):
    """The inference pipeline for Speaker Diarization Semantic Speaker-Turn Detection Task.
