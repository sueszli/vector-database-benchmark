...
class FakePolicy(Policy):
    config = dict(cuda=False, on_policy=False, forward_time=0.002, learn=dict(), collect=dict(n_sample=80, unroll_len=1, collector=dict(collect_print_freq=1000000)), eval=dict(), other=dict(replay_buffer=dict(replay_buffer_size=10000)))
