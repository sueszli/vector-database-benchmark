...
from transformers import AutoModelForCausalLM, AutoTokenizer, FalconConfig, is_torch_available, set_seed
...
if is_torch_available():
    import torch
    from transformers import FalconForCausalLM, FalconForQuestionAnswering, FalconForSequenceClassification, FalconForTokenClassification, FalconModel
...
class FalconModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (FalconModel, FalconForCausalLM, FalconForSequenceClassification, FalconForTokenClassification, FalconForQuestionAnswering) if is_torch_available() else ()
    all_generative_model_classes = (FalconForCausalLM,) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': FalconModel, 'question-answering': FalconForQuestionAnswering, 'text-classification': FalconForSequenceClassification, 'text-generation': FalconForCausalLM, 'token-classification': FalconForTokenClassification, 'zero-shot': FalconForSequenceClassification} if is_torch_available() else {}
