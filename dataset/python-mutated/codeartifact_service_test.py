...
from prowler.providers.aws.services.codeartifact.codeartifact_service import CodeArtifact, LatestPackageVersionStatus, OriginInformationValues, RestrictionValues
from prowler.providers.common.models import Audit_Metadata
AWS_REGION = 'eu-west-1'
AWS_ACCOUNT_NUMBER = '123456789012'
make_api_call = botocore.client.BaseClient._make_api_call
TEST_REPOSITORY_ARN = f'arn:aws:codebuild:{AWS_REGION}:{DEFAULT_ACCOUNT_ID}:repository/test-repository'
