...
TEST_HOOK_PACKAGE_CONFIG = {'hook_name': 'my_test_hook_name', 'hook_use_case': 'IaC', 'description': 'testing', 'version': '1.0.0', 'hook_specification': '1.0.0', 'functionalities': {'prepare': {'entry_method': {'module': 'x.y.z', 'method': 'my_method'}}}}
