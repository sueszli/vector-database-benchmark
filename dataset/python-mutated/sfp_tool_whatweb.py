...
class sfp_tool_whatweb(SpiderFootPlugin):
    meta = {'name': 'Tool - WhatWeb', 'summary': 'Identify what software is in use on the specified website.', 'flags': ['tool'], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Content Analysis'], 'toolDetails': {'name': 'WhatWeb', 'description': 'WhatWeb identifies websites. Its goal is to answer the question, "What is that Website?". WhatWeb recognises web technologies including content management systems (CMS), blogging platforms, statistic/analytics packages, JavaScript libraries, web servers, and embedded devices. WhatWeb has over 1800 plugins, each to recognise something different. WhatWeb also identifies version numbers, email addresses, account IDs, web framework modules, SQL errors, and more.', 'website': 'https://github.com/urbanadventurer/whatweb', 'repository': 'https://github.com/urbanadventurer/whatweb'}}
    opts = {'aggression': 1, 'ruby_path': 'ruby', 'whatweb_path': ''}
    optdescs = {'aggression': 'Set WhatWeb aggression level (1-4)', 'ruby_path': "Path to Ruby interpreter to use for WhatWeb. If just 'ruby' then it must be in your $PATH.", 'whatweb_path': 'Path to the whatweb executable file. Must be set.'}
    results = None
    errorState = False
