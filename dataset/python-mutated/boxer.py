...
from nltk.sem.drt import DRS, DrtApplicationExpression, DrtEqualityExpression, DrtNegatedExpression, DrtOrExpression, DrtParser, DrtProposition, DrtTokens, DrtVariableExpression
from nltk.sem.logic import ExpectedMoreTokensException, LogicalExpressionException, UnexpectedTokenException, Variable
...
if __name__ == '__main__':
    ...
    drs = Boxer(interpreter).interpret_multi(args[0].split('\\n'), question=options.question, verbose=options.verbose)
    if drs is None:
        print(None)
    else:
