...
import pytest
from google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service import StreamingVideoIntelligenceServiceAsyncClient, StreamingVideoIntelligenceServiceClient, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(StreamingVideoIntelligenceServiceClient, 'grpc'), (StreamingVideoIntelligenceServiceAsyncClient, 'grpc_asyncio')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.StreamingVideoIntelligenceServiceGrpcTransport, 'grpc'), (transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
def test_streaming_video_intelligence_service_client_get_transport_class():
    if False:
        while True:
            i = 10
    transport = StreamingVideoIntelligenceServiceClient.get_transport_class()
    ...
    assert transport == transports.StreamingVideoIntelligenceServiceGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(StreamingVideoIntelligenceServiceClient, transports.StreamingVideoIntelligenceServiceGrpcTransport, 'grpc'), (StreamingVideoIntelligenceServiceAsyncClient, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
@mock.patch.object(StreamingVideoIntelligenceServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(StreamingVideoIntelligenceServiceAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(StreamingVideoIntelligenceServiceClient, transports.StreamingVideoIntelligenceServiceGrpcTransport, 'grpc', grpc_helpers), (StreamingVideoIntelligenceServiceAsyncClient, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_streaming_video_intelligence_service_client_client_options_from_dict():
    if False:
        print('Hello World!')
    with mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.parametrize('request_type', [video_intelligence.StreamingAnnotateVideoRequest, dict])
...
async def test_streaming_annotate_video_async(transport: str='grpc_asyncio', request_type=video_intelligence.StreamingAnnotateVideoRequest):
    client = StreamingVideoIntelligenceServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    requests = [request]
    with mock.patch.object(type(client.transport.streaming_annotate_video), '__call__') as call:
...
def test_credentials_transport_error():
    if False:
        print('Hello World!')
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = StreamingVideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = StreamingVideoIntelligenceServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = StreamingVideoIntelligenceServiceClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = StreamingVideoIntelligenceServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_instance():
    if False:
        ...
        return i + 15
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    client = StreamingVideoIntelligenceServiceClient(transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.StreamingVideoIntelligenceServiceGrpcTransport, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = StreamingVideoIntelligenceServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
    assert transport.kind == transport_name

def test_transport_grpc_default():
    if False:
        print('Hello World!')
    client = StreamingVideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.StreamingVideoIntelligenceServiceGrpcTransport)

def test_streaming_video_intelligence_service_base_transport_error():
    if False:
        i = 10
        return i + 15
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.StreamingVideoIntelligenceServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')

def test_streaming_video_intelligence_service_base_transport():
    if False:
        return 10
    with mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport.__init__') as Transport:
        Transport.return_value = None
        transport = transports.StreamingVideoIntelligenceServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('streaming_annotate_video',)
...
def test_streaming_video_intelligence_service_base_transport_with_credentials_file():
    if False:
        for i in range(10):
            print('nop')
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.StreamingVideoIntelligenceServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
        load_creds.assert_called_once_with('credentials.json', scopes=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), quota_project_id='octopus')

def test_streaming_video_intelligence_service_base_transport_with_adc():
    if False:
        i = 10
        return i + 15
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.videointelligence_v1p3beta1.services.streaming_video_intelligence_service.transports.StreamingVideoIntelligenceServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.StreamingVideoIntelligenceServiceTransport()
        adc.assert_called_once()

def test_streaming_video_intelligence_service_auth_adc():
    if False:
        while True:
            i = 10
...
@pytest.mark.parametrize('transport_class', [transports.StreamingVideoIntelligenceServiceGrpcTransport, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport])
def test_streaming_video_intelligence_service_transport_auth_adc(transport_class):
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.StreamingVideoIntelligenceServiceGrpcTransport, grpc_helpers), (transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_streaming_video_intelligence_service_host_no_port(transport_name):
    if False:
        print('Hello World!')
    client = StreamingVideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='videointelligence.googleapis.com'), transport=transport_name)
    assert client.transport._host == 'videointelligence.googleapis.com:443'
...
def test_streaming_video_intelligence_service_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = StreamingVideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='videointelligence.googleapis.com:8000'), transport=transport_name)
...
def test_streaming_video_intelligence_service_grpc_transport_channel():
    ...
    transport = transports.StreamingVideoIntelligenceServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

def test_streaming_video_intelligence_service_grpc_asyncio_transport_channel():
    if False:
        i = 10
        return i + 15
    channel = aio.secure_channel('http://localhost/', grpc.local_channel_credentials())
    transport = transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_common_folder_path():
    ...
    actual = StreamingVideoIntelligenceServiceClient.common_folder_path(folder)
    assert expected == actual
...
def test_parse_common_folder_path():
    ...
    path = StreamingVideoIntelligenceServiceClient.common_folder_path(**expected)
    actual = StreamingVideoIntelligenceServiceClient.parse_common_folder_path(path)
    assert expected == actual
...
def test_common_project_path():
    ...
    actual = StreamingVideoIntelligenceServiceClient.common_project_path(project)
    assert expected == actual
...
def test_parse_common_project_path():
    ...
    path = StreamingVideoIntelligenceServiceClient.common_project_path(**expected)
    actual = StreamingVideoIntelligenceServiceClient.parse_common_project_path(path)
    assert expected == actual
...
def test_parse_common_location_path():
    ...
    path = StreamingVideoIntelligenceServiceClient.common_location_path(**expected)
    actual = StreamingVideoIntelligenceServiceClient.parse_common_location_path(path)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.StreamingVideoIntelligenceServiceTransport, '_prep_wrapped_messages') as prep:
        client = StreamingVideoIntelligenceServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = StreamingVideoIntelligenceServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(StreamingVideoIntelligenceServiceClient, transports.StreamingVideoIntelligenceServiceGrpcTransport), (StreamingVideoIntelligenceServiceAsyncClient, transports.StreamingVideoIntelligenceServiceGrpcAsyncIOTransport)])
