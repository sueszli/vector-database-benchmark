...
class TaskServerMessageHandlerTestBase(testutils.DatabaseFixture, testutils.TestWithClient):
...
class ForceGetTaskResultUploadTest(FileTransferTokenTests, FiletransfersTestBase):
...
class ForceGetTaskResultDownloadTest(FileTransferTokenTests, FiletransfersTestBase):
...
class SubtaskResultsVerifyTest(FileTransferTokenTestsBase, FiletransfersTestBase):
