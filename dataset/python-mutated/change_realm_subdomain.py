...
class Command(ZulipBaseCommand):
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument('--skip-redirect', action='store_true', help='Do not redirect the old name to the new one')
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        do_change_realm_subdomain(realm, new_subdomain, acting_user=None, add_deactivated_redirect=not options['skip_redirect'])
        print('Done!')