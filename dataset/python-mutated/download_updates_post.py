...
def main():
    ...
    response = client.devices.begin_download_updates(device_name='testedgedevice', resource_group_name='GroupForEdgeAutomation').result()
    print(response)
