...
class SetChatStickerSet(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], sticker_set_name: str, **__pydantic_kwargs: Any) -> None:
            if False:
                i = 10
                return i + 15
            super().__init__(chat_id=chat_id, sticker_set_name=sticker_set_name, **__pydantic_kwargs)