...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        if False:
            for i in range(10):
                print('nop')
        self.set_filename('chart_gridlines06.xlsx')
    ...
    def test_create_file(self):
        ...
        chart.set_x_axis({'major_gridlines': {'visible': 1}, 'minor_gridlines': {'visible': 1}})
        chart.set_y_axis({'major_gridlines': {'visible': 1}, 'minor_gridlines': {'visible': 1}})
