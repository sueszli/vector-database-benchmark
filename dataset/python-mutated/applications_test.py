...
try:
    ...
    PIL = None
MODEL_LIST = [(vgg16.VGG16, 512, vgg16), (vgg19.VGG19, 512, vgg19), (xception.Xception, 2048, xception), (inception_v3.InceptionV3, 2048, inception_v3), (inception_resnet_v2.InceptionResNetV2, 1536, inception_resnet_v2), (mobilenet.MobileNet, 1024, mobilenet), (mobilenet_v2.MobileNetV2, 1280, mobilenet_v2), (mobilenet_v3.MobileNetV3Small, 576, mobilenet_v3), (mobilenet_v3.MobileNetV3Large, 960, mobilenet_v3), (efficientnet.EfficientNetB0, 1280, efficientnet), (efficientnet.EfficientNetB1, 1280, efficientnet), (efficientnet.EfficientNetB2, 1408, efficientnet), (efficientnet.EfficientNetB3, 1536, efficientnet), (efficientnet.EfficientNetB4, 1792, efficientnet), (efficientnet.EfficientNetB5, 2048, efficientnet), (efficientnet.EfficientNetB6, 2304, efficientnet), (efficientnet.EfficientNetB7, 2560, efficientnet), (efficientnet_v2.EfficientNetV2B0, 1280, efficientnet_v2), (efficientnet_v2.EfficientNetV2B1, 1280, efficientnet_v2), (efficientnet_v2.EfficientNetV2B2, 1408, efficientnet_v2), (efficientnet_v2.EfficientNetV2B3, 1536, efficientnet_v2), (efficientnet_v2.EfficientNetV2S, 1280, efficientnet_v2), (efficientnet_v2.EfficientNetV2M, 1280, efficientnet_v2), (efficientnet_v2.EfficientNetV2L, 1280, efficientnet_v2), (densenet.DenseNet121, 1024, densenet), (densenet.DenseNet169, 1664, densenet), (densenet.DenseNet201, 1920, densenet), (convnext.ConvNeXtTiny, 768, convnext), (convnext.ConvNeXtSmall, 768, convnext), (convnext.ConvNeXtBase, 1024, convnext), (convnext.ConvNeXtLarge, 1536, convnext), (convnext.ConvNeXtXLarge, 2048, convnext), (nasnet.NASNetMobile, 1056, nasnet), (nasnet.NASNetLarge, 4032, nasnet), (resnet.ResNet50, 2048, resnet), (resnet.ResNet101, 2048, resnet), (resnet.ResNet152, 2048, resnet), (resnet_v2.ResNet50V2, 2048, resnet_v2), (resnet_v2.ResNet101V2, 2048, resnet_v2), (resnet_v2.ResNet152V2, 2048, resnet_v2)]
MODELS_UNSUPPORTED_CHANNELS_FIRST = ['ConvNeXt', 'DenseNet', 'NASNet']
test_parameters = [('{}_{}'.format(model[0].__name__, image_data_format), *model, image_data_format) for image_data_format in ['channels_first', 'channels_last'] for model in MODEL_LIST]
...
@pytest.mark.skipif(os.environ.get('SKIP_APPLICATIONS_TESTS'), reason='Env variable set to skip.')
