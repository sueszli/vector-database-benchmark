...
class TestAssembleWorksheet(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'containing', 'value': 'foo'})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'not containing', 'value': 'foo', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'begins with', 'value': 'b', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'ends with', 'value': 'b', 'format': None})
