...
@testing.parameterize(*testing.product({'func': ['bitwise_and', 'bitwise_or', 'bitwise_xor', 'left_shift', 'right_shift']}))
...
@testing.parameterize(*testing.product({'func': ['greater', 'greater_equal', 'less', 'less_equal', 'equal', 'not_equal', 'logical_and', 'logical_or', 'logical_xor', 'maximum', 'minimum', 'fmax', 'fmin']}))
...
@testing.parameterize(*testing.product({'func': ['sin', 'cos', 'tan', 'arcsin', 'arccos', 'arctan', 'sinh', 'cosh', 'tanh', 'arcsinh', 'arccosh', 'arctanh']}))
...
@testing.parameterize(*testing.product({'func': ['arctan2', 'hypot']}))
...
@testing.parameterize(*testing.product({'func': ['deg2rad', 'rad2deg', 'degrees', 'radians']}))
...
@testing.parameterize(*testing.product({'func': ['around', 'round', 'rint', 'floor', 'ceil', 'trunc', 'fix']}))
...
@testing.parameterize(*testing.product({'func': ['exp', 'expm1', 'exp2', 'log', 'log10', 'log2', 'log1p']}))
...
@testing.parameterize(*testing.product({'func': ['logaddexp', 'logaddexp2']}))
...
@testing.parameterize(*testing.product({'func': ['signbit', 'frexp']}))
...
@testing.parameterize(*testing.product({'func': ['copysign', 'nextafter']}))
...
@testing.parameterize(*testing.product({'func': ['reciprocal', 'negative', 'angle', 'conj', 'real', 'imag']}))
...
@testing.parameterize(*testing.product({'func': ['add', 'subtract', 'multiply', 'power']}))
...
@testing.parameterize(*testing.product({'func': ['divide', 'true_divide', 'floor_divide', 'fmod', 'remainder']}))
...
@testing.parameterize(*testing.product({'func': ['i0', 'sinc']}))
...
@testing.parameterize(*testing.product({'func': ['sum', 'prod', 'amax', 'amin', 'max', 'min']}))
...
@testing.parameterize(*testing.product({'func': ['all', 'any']}))
