...
from golem.envs import Environment, Prerequisites, Runtime
from golem.task.task_api import EnvironmentTaskApiService, TaskApiPayloadBuilder
...
class TestTaskApiService(TestCase):
    ...
    async def test_start(self):
        ...
        self.payload_builder.create_payload.assert_called_once_with(self.prereq, self.shared_dir, command, port)
        self.env.runtime.assert_called_once_with(self.payload_builder.create_payload.return_value)
