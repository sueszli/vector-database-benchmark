...
ax.add_artist(Arrow3D([7, 0], [5, 5], [6, 6], mutation_scale=10, lw=1.5, arrowstyle='-|>', color='black'))
ax.add_artist(Arrow3D([7, 7], [5, 0], [6, 6], mutation_scale=10, lw=1.5, arrowstyle='-|>', color='black'))
ax.add_artist(Arrow3D([7, 7], [5, 5], [6, 0], mutation_scale=10, lw=1.5, arrowstyle='-|>', color='black'))
ax.scatter([7], [5], [6], s=50, facecolor='black', edgecolor='black', linewidth=1.5)
ax.text(7.5, 5, 6, '(7.0, 5.0, 6.0)', color='black', size='small', ha='left', va='center')
...
ax.plot([7, 0], [5, 5], [6, 0], color='green', linewidth=1.5, linestyle='--', marker='o')
