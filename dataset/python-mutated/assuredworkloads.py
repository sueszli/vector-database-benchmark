...
class CreateWorkloadRequest(proto.Message):
    ...
    workload: 'Workload' = proto.Field(proto.MESSAGE, number=2, message='Workload')
    external_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateWorkloadRequest(proto.Message):
    ...
    """
    workload: 'Workload' = proto.Field(proto.MESSAGE, number=1, message='Workload')
...
class RestrictAllowedResourcesRequest(proto.Message):
    """Request for restricting list of available resources in
    ...
    restriction_type: RestrictionType = proto.Field(proto.ENUM, number=2, enum=RestrictionType)
...
class DeleteWorkloadRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    etag: str = proto.Field(proto.STRING, number=2)
...
class AnalyzeWorkloadMoveRequest(proto.Message):
    """A request to analyze a hypothetical move of a source project
    ...
    """
    source: str = proto.Field(proto.STRING, number=1, oneof='projectOrWorkloadResource')
    project: str = proto.Field(proto.STRING, number=3, oneof='projectOrWorkloadResource')
    target: str = proto.Field(proto.STRING, number=2)

class AnalyzeWorkloadMoveResponse(proto.Message):
    """A response that includes the analysis of the hypothetical
    resource move.
    ...
    """
    blockers: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class ListWorkloadsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    workloads: MutableSequence['Workload'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Workload')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class Workload(proto.Message):
    """An Workload object for managing highly regulated workloads of
    cloud customers.
    ...
    class ResourceInfo(proto.Message):
        ...
        class ResourceType(proto.Enum):
            ...
            ENCRYPTION_KEYS_PROJECT = 2
            KEYRING = 3
        resource_id: int = proto.Field(proto.INT64, number=1)
        resource_type: 'Workload.ResourceInfo.ResourceType' = proto.Field(proto.ENUM, number=2, enum='Workload.ResourceInfo.ResourceType')
    ...
    class KMSSettings(proto.Message):
        ...
        """
        next_rotation_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
        rotation_period: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    ...
    class IL4Settings(proto.Message):
        ...
        """
        kms_settings: 'Workload.KMSSettings' = proto.Field(proto.MESSAGE, number=1, message='Workload.KMSSettings')
    ...
    class ResourceSettings(proto.Message):
        ...
        """
        resource_id: str = proto.Field(proto.STRING, number=1)
        resource_type: 'Workload.ResourceInfo.ResourceType' = proto.Field(proto.ENUM, number=2, enum='Workload.ResourceInfo.ResourceType')
    ...
    class SaaEnrollmentResponse(proto.Message):
        ...
        class SetupError(proto.Enum):
            ...
            ERROR_NOT_ALL_SERVICES_ENROLLED = 3
            ERROR_SETUP_CHECK_FAILED = 4
        setup_status: 'Workload.SaaEnrollmentResponse.SetupState' = proto.Field(proto.ENUM, number=1, optional=True, enum='Workload.SaaEnrollmentResponse.SetupState')
        setup_errors: MutableSequence['Workload.SaaEnrollmentResponse.SetupError'] = proto.RepeatedField(proto.ENUM, number=2, enum='Workload.SaaEnrollmentResponse.SetupError')
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    resources: MutableSequence[ResourceInfo] = proto.RepeatedField(proto.MESSAGE, number=3, message=ResourceInfo)
    compliance_regime: ComplianceRegime = proto.Field(proto.ENUM, number=4, enum=ComplianceRegime)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    billing_account: str = proto.Field(proto.STRING, number=6)
    il4_settings: IL4Settings = proto.Field(proto.MESSAGE, number=7, oneof='compliance_regime_settings', message=IL4Settings)
    cjis_settings: CJISSettings = proto.Field(proto.MESSAGE, number=8, oneof='compliance_regime_settings', message=CJISSettings)
    fedramp_high_settings: FedrampHighSettings = proto.Field(proto.MESSAGE, number=11, oneof='compliance_regime_settings', message=FedrampHighSettings)
    fedramp_moderate_settings: FedrampModerateSettings = proto.Field(proto.MESSAGE, number=12, oneof='compliance_regime_settings', message=FedrampModerateSettings)
    ...
    provisioned_resources_parent: str = proto.Field(proto.STRING, number=13)
    kms_settings: KMSSettings = proto.Field(proto.MESSAGE, number=14, message=KMSSettings)
    resource_settings: MutableSequence[ResourceSettings] = proto.RepeatedField(proto.MESSAGE, number=15, message=ResourceSettings)
    kaj_enrollment_state: KajEnrollmentState = proto.Field(proto.ENUM, number=17, enum=KajEnrollmentState)
    enable_sovereign_controls: bool = proto.Field(proto.BOOL, number=18)
    saa_enrollment_response: SaaEnrollmentResponse = proto.Field(proto.MESSAGE, number=20, message=SaaEnrollmentResponse)
    compliant_but_disallowed_services: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=24)
...
class CreateWorkloadOperationMetadata(proto.Message):
    ...
    compliance_regime: 'Workload.ComplianceRegime' = proto.Field(proto.ENUM, number=4, enum='Workload.ComplianceRegime')
    resource_settings: MutableSequence['Workload.ResourceSettings'] = proto.RepeatedField(proto.MESSAGE, number=5, message='Workload.ResourceSettings')
