...
chunk_short_configs = op_bench.config_list(attr_names=['M', 'N', 'chunks'], attrs=[[8, 8, 2], [256, 512, 2], [512, 512, 2]], cross_product_configs={'device': ['cpu', 'cuda']}, tags=['short'])
chunks_long_configs = op_bench.cross_product_configs(M=[128, 1024], N=[128, 1024], chunks=[2, 4], device=['cpu', 'cuda'], tags=['long'])
