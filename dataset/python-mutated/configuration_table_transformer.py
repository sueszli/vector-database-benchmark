...
TABLE_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/table-transformer-detection': 'https://huggingface.co/microsoft/table-transformer-detection/resolve/main/config.json'}
