...
if is_tf_available():
    ...
    from transformers.models.gpt2.modeling_tf_gpt2 import TF_GPT2_PRETRAINED_MODEL_ARCHIVE_LIST, TFGPT2DoubleHeadsModel, TFGPT2ForSequenceClassification, TFGPT2LMHeadModel, TFGPT2Model
...
class TFGPT2ModelTest(TFModelTesterMixin, TFCoreModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFGPT2Model, TFGPT2LMHeadModel, TFGPT2ForSequenceClassification, TFGPT2DoubleHeadsModel) if is_tf_available() else ()
    all_generative_model_classes = (TFGPT2LMHeadModel,) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFGPT2Model, 'text-classification': TFGPT2ForSequenceClassification, 'text-generation': TFGPT2LMHeadModel, 'zero-shot': TFGPT2ForSequenceClassification} if is_tf_available() else {}
