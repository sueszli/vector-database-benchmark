...
class MRRMetric(TopKMetric):
    ...
    def __init__(self, topk: Iterable[int]=None, compute_on_call: bool=True, prefix: str=None, suffix: str=None):
        if False:
            i = 10
            return i + 15
        'Init MRRMetric'
        super().__init__(metric_name='mrr', metric_function=mrr, topk=topk, compute_on_call=compute_on_call, prefix=prefix, suffix=suffix)
__all__ = ['MRRMetric']