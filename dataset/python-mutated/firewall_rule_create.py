...
def main():
    ...
    response = client.firewall_rules.begin_create_or_update(resource_group_name='TestGroup', cluster_name='pgtestsvc4', firewall_rule_name='rule1', parameters={'properties': {'endIpAddress': '255.255.255.255', 'startIpAddress': '0.0.0.0'}}).result()
    print(response)
