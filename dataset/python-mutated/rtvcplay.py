...
from ..utils import clean_html, determine_ext, int_or_none, float_or_none, js_to_json, mimetype2ext, traverse_obj, urljoin, url_or_none

class RTVCPlayBaseIE(InfoExtractor):
    _BASE_VALID_URL = 'https?://(?:www\\.)?rtvcplay\\.co'
...
class RTVCPlayIE(RTVCPlayBaseIE):
    _VALID_URL = RTVCPlayBaseIE._BASE_VALID_URL + '/(?P<category>(?!embed)[^/]+)/(?:[^?#]+/)?(?P<id>[\\w-]+)'
    _TESTS = [{'url': 'https://www.rtvcplay.co/en-vivo/canal-institucional', 'info_dict': {'id': 'canal-institucional', 'title': 're:^Canal Institucional', 'description': 'md5:eff9e548394175928059320c006031ea', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}}, {'url': 'https://www.rtvcplay.co/en-vivo/senal-colombia', 'info_dict': {'id': 'senal-colombia', 'title': 're:^Señal Colombia', 'description': 'md5:799f16a401d97f40c33a2c6a3e2a507b', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}}, {'url': 'https://www.rtvcplay.co/en-vivo/radio-nacional', 'info_dict': {'id': 'radio-nacional', 'title': 're:^Radio Nacional', 'description': 'md5:5de009bc6a9fa79d2a6cf0b73f977d53', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}}, {'url': 'https://www.rtvcplay.co/peliculas-ficcion/senoritas', 'md5': '1288ee6f6d1330d880f98bff2ed710a3', 'info_dict': {'id': 'senoritas', 'title': 'Señoritas', 'description': 'md5:f095a2bb52cb6cf279daf6302f86fb32', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'ext': 'mp4'}}, {'url': 'https://www.rtvcplay.co/competencias-basicas-ciudadanas-y-socioemocionales/profe-en-tu-casa/james-regresa-clases-28022022', 'md5': 'f040a7380a269ad633cf837384d5e9fc', 'info_dict': {'id': 'james-regresa-clases-28022022', 'title': 'James regresa a clases - 28/02/2022', 'description': 'md5:c5dcdf757c7ab29305e8763c6007e675', 'ext': 'mp4'}}, {'url': 'https://www.rtvcplay.co/peliculas-documentales/llinas-el-cerebro-y-el-universo', 'info_dict': {'id': 'llinas-el-cerebro-y-el-universo', 'title': 'Llinás, el cerebro y el universo', 'description': 'md5:add875bf2309bb52b3e8b9b06116d9b0', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 3}, {'url': 'https://www.rtvcplay.co/competencias-basicas-ciudadanas-y-socioemocionales/profe-en-tu-casa', 'info_dict': {'id': 'profe-en-tu-casa', 'title': 'Profe en tu casa', 'description': 'md5:47dbe20e263194413b1db2a2805a4f2e', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 537}, {'url': 'https://www.rtvcplay.co/series-al-oido/relato-de-un-naufrago-una-travesia-del-periodismo-a-la-literatura', 'info_dict': {'id': 'relato-de-un-naufrago-una-travesia-del-periodismo-a-la-literatura', 'title': 'Relato de un náufrago: una travesía del periodismo a la literatura', 'description': 'md5:6da28fdca4a5a568ea47ef65ef775603', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 5}, {'url': 'https://www.rtvcplay.co/series-al-oido/diez-versiones', 'info_dict': {'id': 'diez-versiones', 'title': 'Diez versiones', 'description': 'md5:997471ed971cb3fd8e41969457675306', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 20}]
...
class RTVCPlayEmbedIE(RTVCPlayBaseIE):
    _VALID_URL = RTVCPlayBaseIE._BASE_VALID_URL + '/embed/(?P<id>[\\w-]+)'
    _TESTS = [{'url': 'https://www.rtvcplay.co/embed/72b0e699-248b-4929-a4a8-3782702fa7f9', 'md5': 'ed529aeaee7aa2a72afe91ac7d1177a8', 'info_dict': {'id': '72b0e699-248b-4929-a4a8-3782702fa7f9', 'title': 'Tráiler: Señoritas', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'ext': 'mp4'}}]
...
class RTVCKalturaIE(RTVCPlayBaseIE):
    ...
    _TESTS = [{'url': 'https://media.rtvc.gov.co/kalturartvc/indexSC.html', 'info_dict': {'id': 'indexSC', 'title': 're:^Señal Colombia', 'description': 'md5:799f16a401d97f40c33a2c6a3e2a507b', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}}]
