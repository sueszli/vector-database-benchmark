...
buckets = (('< 1 hour', timedelta(hours=1)), ('< 4 hour', timedelta(hours=4)), ('< 12 hour', timedelta(hours=12)), ('< 1 day', timedelta(days=1)), ('< 1 week', timedelta(weeks=1)), ('< 4 week', timedelta(weeks=4)), ('< 24 week', timedelta(weeks=24)), ('< 1 year', timedelta(weeks=52)))
OLDEST_LABEL = '> 1 year'
