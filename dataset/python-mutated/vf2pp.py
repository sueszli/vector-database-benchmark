...
_GraphParameters = collections.namedtuple('_GraphParameters', ['G1', 'G2', 'G1_labels', 'G2_labels', 'nodes_of_G1Labels', 'nodes_of_G2Labels', 'G2_nodes_of_degree'])
_StateParameters = collections.namedtuple('_StateParameters', ['mapping', 'reverse_mapping', 'T1', 'T1_in', 'T1_tilde', 'T1_tilde_in', 'T2', 'T2_in', 'T2_tilde', 'T2_tilde_in'])
