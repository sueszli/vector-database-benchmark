...
N = 40
df = pd.DataFrame({'a': np.random.randn(N).cumsum(), 'b': np.random.randint(100, size=(N,)), 'c': np.random.randint(100, size=(N,)), 'd': np.random.randint(100, size=(N,)), 'e': np.random.randint(100, size=(N,))})
ddf = dd.from_pandas(df, 3)
idx = pd.date_range('2016-01-01', freq='3s', periods=100).union(pd.date_range('2016-01-01', freq='5s', periods=100))[:N]
idx_constant_freq = pd.date_range('2016-01-01', freq='1s', periods=100)[:N]
ts_data = {'a': np.random.randn(N).cumsum(), 'b': np.random.randint(100, size=(N,)), 'c': np.random.randint(100, size=(N,)), 'd': np.random.randint(100, size=(N,)), 'e': np.random.randint(100, size=(N,))}
ts = pd.DataFrame(ts_data, index=idx)
...
rolling_method_args_check_less_precise = [('count', (), False), ('sum', (), False), ('mean', (), False), ('median', (), False), ('min', (), False), ('max', (), False), ('std', (), True), ('var', (), True), ('skew', (), True), ('kurt', (), True), ('quantile', (0.38,), False), ('apply', (mad,), False)]
