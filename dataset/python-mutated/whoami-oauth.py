...
def main():
    if False:
        return 10
    app = Application([(os.environ['JUPYTERHUB_SERVICE_PREFIX'], WhoAmIHandler), (url_path_join(os.environ['JUPYTERHUB_SERVICE_PREFIX'], 'oauth_callback'), HubOAuthCallbackHandler), ('.*', WhoAmIHandler)], cookie_secret=os.urandom(32))
