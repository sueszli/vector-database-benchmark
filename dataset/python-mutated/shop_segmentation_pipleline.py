...
@PIPELINES.register_module(Tasks.shop_segmentation, module_name=Pipelines.shop_segmentation)
class ShopSegmentationPipeline(Pipeline):
    ...
    def preprocess(self, input: Input) -> Dict[str, Any]:
        ...
        result = {'img': img_tensor, 'ori_h': ori_h, 'ori_w': ori_w, 'crop_h': crop_h, 'crop_w': crop_w}
        return result
