...
from modelscope.models.cv.image_instance_segmentation import CascadeMaskRCNNSwinModel, get_img_ins_seg_result
from modelscope.pipelines.base import Input, Pipeline
from modelscope.pipelines.builder import PIPELINES
from modelscope.preprocessors import ImageInstanceSegmentationPreprocessor, build_preprocessor, load_image
from modelscope.utils.config import Config
from modelscope.utils.constant import Fields, ModelFile, Tasks
from modelscope.utils.logger import get_logger
logger = get_logger()

@PIPELINES.register_module(Tasks.image_segmentation, module_name=Pipelines.image_instance_segmentation)
