...
import proto
__protobuf__ = proto.module(package='google.cloud.privatecatalog.v1beta1', manifest={'SearchCatalogsRequest', 'SearchCatalogsResponse', 'SearchProductsRequest', 'SearchProductsResponse', 'SearchVersionsRequest', 'SearchVersionsResponse', 'Catalog', 'Product', 'AssetReference', 'Inputs', 'GcsSource', 'GitSource', 'Version'})
...
class SearchCatalogsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    catalogs: MutableSequence['Catalog'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Catalog')
...
class SearchProductsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    products: MutableSequence['Product'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Product')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SearchVersionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    versions: MutableSequence['Version'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Version')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class Catalog(proto.Message):
    """The readonly representation of a catalog computed with a
...
class Product(proto.Message):
    """The readonly representation of a product computed with a
    given resource context.
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    asset_type: str = proto.Field(proto.STRING, number=2)
    display_metadata: struct_pb2.Struct = proto.Field(proto.MESSAGE, number=3, message=struct_pb2.Struct)
    icon_uri: str = proto.Field(proto.STRING, number=4)
    asset_references: MutableSequence['AssetReference'] = proto.RepeatedField(proto.MESSAGE, number=10, message='AssetReference')
...
class AssetReference(proto.Message):
    ...
    inputs: 'Inputs' = proto.Field(proto.MESSAGE, number=6, message='Inputs')
    validation_status: AssetValidationState = proto.Field(proto.ENUM, number=7, enum=AssetValidationState)
    validation_operation: operations_pb2.Operation = proto.Field(proto.MESSAGE, number=8, message=operations_pb2.Operation)
    asset: str = proto.Field(proto.STRING, number=10, oneof='source')
    gcs_path: str = proto.Field(proto.STRING, number=11, oneof='source')
    git_source: 'GitSource' = proto.Field(proto.MESSAGE, number=15, oneof='source', message='GitSource')
    gcs_source: 'GcsSource' = proto.Field(proto.MESSAGE, number=16, message='GcsSource')
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=12, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=13, message=timestamp_pb2.Timestamp)
    version: str = proto.Field(proto.STRING, number=14)
...
class Inputs(proto.Message):
    ...
    """
    parameters: struct_pb2.Struct = proto.Field(proto.MESSAGE, number=1, message=struct_pb2.Struct)
...
class GcsSource(proto.Message):
    ...
    """
    gcs_path: str = proto.Field(proto.STRING, number=1)
...
class GitSource(proto.Message):
    ...
    Attributes:
        ...
        tag (str):
            ...
            This field is a member of `oneof`_ ``ref``.
    """
    repo: str = proto.Field(proto.STRING, number=1)
    dir_: str = proto.Field(proto.STRING, number=2)
    commit: str = proto.Field(proto.STRING, number=3, oneof='ref')
    branch: str = proto.Field(proto.STRING, number=4, oneof='ref')
    tag: str = proto.Field(proto.STRING, number=5, oneof='ref')

class Version(proto.Message):
    """The consumer representation of a version which is a child resource
    ...
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=2)
    asset: struct_pb2.Struct = proto.Field(proto.MESSAGE, number=3, message=struct_pb2.Struct)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
