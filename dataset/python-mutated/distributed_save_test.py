...
class DistributedSaveTest(DistributedSaveTestBase, data_service_test_base.TestBase, parameterized.TestCase):
...
class LoadCheckpointTest(DistributedSaveTestBase, data_service_test_base.TestBase, checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
