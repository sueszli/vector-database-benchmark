...
qcat_configs_short = op_bench.config_list(attr_names=['M', 'N', 'K', 'L', 'dim'], attrs=[[256, 512, 1, 2, 0], [512, 512, 2, 1, 1]], cross_product_configs={'contig': ('all', 'one', 'none'), 'dtype': (torch.quint8, torch.qint8, torch.qint32)}, tags=['short'])
qcat_configs_long = op_bench.cross_product_configs(M=[128, 1024], N=[128, 1024], K=[1, 2], L=[5, 7], dim=[0, 1, 2], contig=['all', 'one', 'none'], dtype=[torch.quint8], tags=['long'])
