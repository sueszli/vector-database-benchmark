...
from ray.rllib.examples.policy.rock_paper_scissors_dummies import BeatLastHeuristic, AlwaysSameHeuristic
...
parser.add_argument('--stop-reward', type=float, default=1000.0, help='Reward at which we stop training.')
