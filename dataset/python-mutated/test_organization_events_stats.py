...
@region_silo_test
class OrganizationEventsStatsProfileFunctionDatasetEndpointTest(APITestCase, ProfilesSnubaTestCase, SearchIssueTestMixin):
    endpoint = 'sentry-api-0-organization-events-stats'
...
@region_silo_test
class OrganizationEventsStatsTopNEventsProfileFunctionDatasetEndpointTest(APITestCase, ProfilesSnubaTestCase, SearchIssueTestMixin):
    endpoint = 'sentry-api-0-organization-events-stats'
