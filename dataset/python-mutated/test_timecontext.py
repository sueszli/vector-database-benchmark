...
try:
    ...
    Py4JJavaError = None
pytestmark = pytest.mark.notimpl(['bigquery', 'clickhouse', 'datafusion', 'impala', 'mysql', 'postgres', 'sqlite', 'snowflake', 'polars', 'mssql', 'trino', 'druid', 'oracle'])
GROUP_BY_COL = 'month'
...
broken_pandas_grouped_rolling = pytest.mark.xfail(condition=vparse('1.4') <= vparse(pd.__version__) < vparse('1.4.2'), raises=ValueError, reason='https://github.com/pandas-dev/pandas/pull/44068')
