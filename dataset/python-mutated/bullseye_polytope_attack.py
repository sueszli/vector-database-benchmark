...
class BullseyePolytopeAttackPyTorch(PoisoningAttackWhiteBox):
    ...
    """
    attack_params = PoisoningAttackWhiteBox.attack_params + ['target', 'feature_layer', 'opt', 'max_iter', 'learning_rate', 'momentum', 'decay_iter', 'decay_coeff', 'epsilon', 'norm', 'dropout', 'endtoend', 'batch_size', 'verbose']
