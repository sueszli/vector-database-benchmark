...
class Migration(migrations.Migration):
    dependencies = [('django_celery_beat', '0018_improve_crontab_helptext'), ('analyzers_manager', '0033_analyzerconfig_update_schedule_and_more')]
    operations = [migrations.RunPython(migrate_config, reverse_migrate_config), migrations.RunPython(migrate_generic_tasks, reverse_migrate_generic_tasks)]