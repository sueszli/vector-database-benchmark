...
class UnibytesCom(SimpleDownloader):
    ...
    __version__ = '0.21'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?unibytes\\.com/[\\w\\- .]{11}B'
    ...
    INFO_PATTERN = '<span[^>]*?id="fileName".*?>(?P<N>.+?)</span>\\s*\\((?P<S>\\d.*?)\\)'
    WAIT_PATTERN = 'Wait for <span id="slowRest">(\\d+)</span> sec'
    LINK_FREE_PATTERN = '<a href="(.+?)">Download</a>'
