...
class SensorManager:
    ...
    async def async_update_data(self):
        ...
        try:
            async with asyncio.timeout(4):
                return await self.bridge.async_request_call(self.bridge.api.sensors.update)
    ...
    async def async_register_component(self, platform, async_add_entities):
        ...
        if len(self._component_add_entities) < len(self._enabled_platforms):
            ...
            return
        self.bridge.reset_jobs.append(self.coordinator.async_add_listener(self.async_update_items))
