...
from ctypes.wintypes import LPWSTR, DWORD, WCHAR, HANDLE, BOOL
...
class WIN32_FIND_STREAM_DATA(Structure):
    _fields_ = [('StreamSize', LARGE_INTEGER_UNION), ('cStreamName', WCHAR * (260 + 36 + 1))]
try:
    FindFirstStreamW = kernel32.FindFirstStreamW
    FindFirstStreamW.argtypes = [LPWSTR, DWORD, c_void_p, DWORD]
    FindFirstStreamW.restype = HANDLE
    FindNextStreamW = kernel32.FindNextStreamW
    FindNextStreamW.argtypes = [HANDLE, c_void_p]
