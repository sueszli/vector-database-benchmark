...
class OrganizationInviteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'target_email', 'first_name', 'emailing_attempt_made', 'is_expired', 'created_by', 'created_at', 'updated_at', 'message']
        read_only_fields = ['id', 'emailing_attempt_made', 'created_at', 'updated_at']
...
class OrganizationInviteViewSet(StructuredViewSetMixin, mixins.DestroyModelMixin, mixins.CreateModelMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
