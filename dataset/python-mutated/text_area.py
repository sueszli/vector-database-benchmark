...
class TextArea(FormField):
    ...
    def _get_content_box(self, available_space: Rectangle) -> Rectangle:
        ...
        return Rectangle(available_space.get_x(), available_space.get_y() + available_space.get_height() - line_height * self._number_of_lines, max(available_space.get_width(), Decimal(64)), line_height * self._number_of_lines)
