...
from coalib.misc.CachingUtilities import settings_changed, update_settings_db, get_settings_hash
from coalib.parsing.FilterHelper import apply_filters, collect_filters, InvalidFilterException
...
def do_nothing(*args):
    if False:
        ...
        return i + 15
    return True
STR_ENTER_LETTER = 'Enter letter (Ctrl-{} to exit): '.format('Z' if platform.system() == 'Windows' else 'D')
