...
UNIFIED_ORG_LOOKUPS = {'jobtemplate': 'project', 'inventorysource': 'inventory', 'project': None, 'workflowjobtemplate': None, 'job': 'project', 'inventoryupdate': 'inventory', 'projectupdate': 'project', 'workflowjob': 'workflow_job_template', 'adhoccommand': 'inventory'}
