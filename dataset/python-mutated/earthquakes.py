...
ax.coastlines()
scatter = ax.scatter([], [], s=[], transform=ccrs.PlateCarree(), linewidth=0.5, edgecolors=[], facecolors='None')
n = 50
R = np.zeros(n, dtype=[('position', float, (2,)), ('size', float, (1,)), ('growth', float, (1,)), ('color', float, (4,))])
