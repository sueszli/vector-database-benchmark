...
class CreateScanConfigRequest(proto.Message):
    ...
    scan_config: gcw_scan_config.ScanConfig = proto.Field(proto.MESSAGE, number=2, message=gcw_scan_config.ScanConfig)
...
class ListScanConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    scan_configs: MutableSequence[gcw_scan_config.ScanConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcw_scan_config.ScanConfig)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    scan_runs: MutableSequence[scan_run.ScanRun] = proto.RepeatedField(proto.MESSAGE, number=1, message=scan_run.ScanRun)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    crawled_urls: MutableSequence[crawled_url.CrawledUrl] = proto.RepeatedField(proto.MESSAGE, number=1, message=crawled_url.CrawledUrl)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListFindingsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    findings: MutableSequence[finding.Finding] = proto.RepeatedField(proto.MESSAGE, number=1, message=finding.Finding)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListFindingTypeStatsResponse(proto.Message):
    ...
    """
    finding_type_stats: MutableSequence[gcw_finding_type_stats.FindingTypeStats] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcw_finding_type_stats.FindingTypeStats)
