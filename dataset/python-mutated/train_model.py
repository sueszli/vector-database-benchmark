...
if __name__ == '__main__':
    ...
    parser.add_argument('--cloud-storage-path', required=True, help='Cloud Storage path to store the AI Platform dataset files.')
    parser.add_argument('--bigquery-dataset', required=True, help='BigQuery dataset ID for the images database.')
    parser.add_argument('--bigquery-table', default='wildlife_images_metadata', help='BigQuery table ID for the images database.')
    parser.add_argument('--ai-platform-name-prefix', default='wildlife_classifier', help='Name prefix for AI Platform resources.')
    parser.add_argument('--min-images-per-class', type=int, default=50, help='Minimum number of images required per class for training.')
    parser.add_argument('--max-images-per-class', type=int, default=80, help='Maximum number of images allowed per class for training.')
    parser.add_argument('--budget-milli-node-hours', type=int, default=8000, help='Training budget, see: https://cloud.google.com/automl/docs/reference/rpc/google.cloud.automl.v1#imageclassificationmodelmetadata')
