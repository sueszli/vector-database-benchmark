...
from nuitka.__past__ import PermissionError, basestring, raw_input
from nuitka.PythonVersions import python_version
from nuitka.Tracing import flushStandardOutputs, general, my_print, options_logger, printLine
from .Importing import importFromInlineCopy
from .ThreadedExecutor import RLock, getThreadIdent
from .Utils import isLinux, isMacOS, isWin32OrPosixWindows, isWin32Windows, raiseWindowsError
file_lock = RLock()
_lock_tracing = False
