...
mssql_temp_table_columns = Table('COLUMNS', ischema, Column('TABLE_SCHEMA', CoerceUnicode, key='table_schema'), Column('TABLE_NAME', CoerceUnicode, key='table_name'), Column('COLUMN_NAME', CoerceUnicode, key='column_name'), Column('IS_NULLABLE', Integer, key='is_nullable'), Column('DATA_TYPE', String, key='data_type'), Column('ORDINAL_POSITION', Integer, key='ordinal_position'), Column('CHARACTER_MAXIMUM_LENGTH', Integer, key='character_maximum_length'), Column('NUMERIC_PRECISION', Integer, key='numeric_precision'), Column('NUMERIC_SCALE', Integer, key='numeric_scale'), Column('COLUMN_DEFAULT', Integer, key='column_default'), Column('COLLATION_NAME', String, key='collation_name'), schema='tempdb.INFORMATION_SCHEMA')
...
sequences = Table('SEQUENCES', ischema, Column('SEQUENCE_CATALOG', CoerceUnicode, key='sequence_catalog'), Column('SEQUENCE_SCHEMA', CoerceUnicode, key='sequence_schema'), Column('SEQUENCE_NAME', CoerceUnicode, key='sequence_name'), schema='INFORMATION_SCHEMA')
...
identity_columns = Table('identity_columns', ischema, Column('object_id', Integer), Column('name', CoerceUnicode), Column('is_identity', Boolean), Column('seed_value', NumericSqlVariant), Column('increment_value', NumericSqlVariant), Column('last_value', NumericSqlVariant), Column('is_not_for_replication', Boolean), schema='sys')
...
extended_properties = Table('extended_properties', ischema, Column('class', Integer), Column('class_desc', CoerceUnicode), Column('major_id', Integer), Column('minor_id', Integer), Column('name', CoerceUnicode), Column('value', NVarcharSqlVariant), schema='sys')