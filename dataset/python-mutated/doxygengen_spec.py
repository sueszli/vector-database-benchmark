...
_inf_key_description_mapping_table = {'INF_VERSION': 'Version of INF file specification', 'FILE_GUID': 'Module Guid', 'MODULE_TYPE': 'Module Type', 'VERSION_STRING': 'Module Version', 'LIBRARY_CLASS': 'Produced Library Class', 'EFI_SPECIFICATION_VERSION': 'UEFI Specification Version', 'PI_SPECIFICATION_VERSION': 'PI Specification Version', 'ENTRY_POINT': 'Module Entry Point Function', 'CONSTRUCTOR': 'Library Constructor Function'}
_dec_key_description_mapping_table = {'DEC_SPECIFICATION': 'Version of DEC file specification', 'PACKAGE_GUID': 'Package Guid'}
...
class PackageDocumentAction(DoxygenAction):
    ...
    def __init__(self, doxPath, chmPath, outputPath, pObj, mode='html', log=None, arch=None, tooltag=None, macros=[], onlyInclude=False, verbose=False):
        if False:
            while True:
                i = 10
