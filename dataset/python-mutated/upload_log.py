...
def main():
    ...
    response = client.products.upload_log(resource_group='azurestack', registration_name='testregistration', product_name='Microsoft.OSTCExtensions.VMAccessForLinux.1.4.7.1')
    print(response)
