...
from airflow.providers.amazon.aws.operators.eks import EksCreateClusterOperator, EksCreateFargateProfileOperator, EksCreateNodegroupOperator, EksDeleteClusterOperator, EksDeleteFargateProfileOperator, EksDeleteNodegroupOperator, EksPodOperator
from airflow.providers.amazon.aws.triggers.eks import EksCreateFargateProfileTrigger, EksCreateNodegroupTrigger, EksDeleteFargateProfileTrigger
from airflow.providers.cncf.kubernetes.utils.pod_manager import OnFinishAction
from airflow.typing_compat import TypedDict
from tests.providers.amazon.aws.utils.eks_test_constants import NODEROLE_ARN, POD_EXECUTION_ROLE_ARN, RESOURCES_VPC_CONFIG, ROLE_ARN, SELECTORS, SUBNET_IDS, TASK_ID
...
CREATE_NODEGROUP_KWARGS = {'capacityType': 'ON_DEMAND', 'instanceTypes': 't3.large'}
