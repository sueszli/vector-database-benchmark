...
logger = get_logger()
base_search_fields = {'domain': fields.String(required=False, description='域名'), 'record': fields.String(description='解析值'), 'type': fields.String(description='解析类型'), 'ips': fields.String(description='IP'), 'source': fields.String(description='来源'), 'task_id': fields.String(description='来源任务 ID'), 'update_date__dgt': fields.String(description='更新时间大于'), 'update_date__dlt': fields.String(description='更新时间小于'), 'scope_id': fields.String(description='范围 ID')}
base_search_fields.update(base_query_fields)
add_domain_fields = ns.model('addAssetDomain', {'domain': fields.String(required=True, description='域名'), 'scope_id': fields.String(required=True, description='资产组范围ID'), 'policy_id': fields.String(description='策略 ID')})
...
delete_domain_fields = ns.model('deleteAssetDomain', {'_id': fields.List(fields.String(required=True, description='数据_id'))})
