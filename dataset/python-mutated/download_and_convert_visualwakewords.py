"""Downloads and converts VisualWakewords data to TFRecords of TF-Example protos.
...
tf.compat.v1.app.flags.DEFINE_string('coco_dirname', 'coco_dataset', 'A subdirectory in visualwakewords dataset directorycontaining the coco dataset')
