...
from torch._inductor.utils import add_scheduler_init_hook, run_and_get_code, run_and_get_triton_code
from torch._inductor.virtualized import V
from torch.fx.experimental.proxy_tensor import make_fx
from torch.nn import functional as F
from torch.testing import FileCheck, make_tensor
from torch.testing._internal.common_cuda import PLATFORM_SUPPORTS_FLASH_ATTENTION, SM80OrLater, TEST_CUDNN, with_tf32_off
from torch.testing._internal.common_device_type import _has_sufficient_memory
from torch.testing._internal.common_dtype import all_types
from torch.testing._internal.common_utils import DeterministicGuard, IS_CI, IS_FBCODE, IS_MACOS, IS_WINDOWS, IS_X86, skipIfRocm, TEST_WITH_ASAN, TestCase as TorchTestCase
...
requires_multigpu = functools.partial(unittest.skipIf, not HAS_MULTIGPU, 'requires multiple cuda devices')
skip_if_x86_mac = functools.partial(unittest.skipIf, IS_MACOS and IS_X86, 'Does not work on x86 Mac')
...
class SweepInputs2:
    input_gen_types1 = ['dense', 'transposed', 'strided', 'broadcast1', 'broadcast2', 'broadcast3', 'double', 'int']
