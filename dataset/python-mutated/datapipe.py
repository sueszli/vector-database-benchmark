...
from torch.utils.data.datapipes.utils.common import _deprecation_warning, _iter_deprecated_functional_names, _map_deprecated_functional_names
...
UNTRACABLE_DATAFRAME_PIPES = ['batch', 'groupby', '_dataframes_as_tuples', 'trace_as_dataframe']
