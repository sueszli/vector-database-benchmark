...
@testing.parameterize(*testing.product({'reduce': ['mean', 'no'], 'cache_score': [True, False], 'normalize': [True, False], 'weight_apply': [True, False], 'shape_ignore': ['special', ((2, 3), (0,)), ((2, 3, 2, 2), (0, 1, 0))], 'dtype': [numpy.float32], 'label_dtype': [numpy.int32]}) + testing.product({'reduce': ['mean', 'no'], 'cache_score': [False], 'normalize': [True], 'weight_apply': [True], 'shape_ignore': ['special', ((2, 3), (slice(None),)), ((2, 3, 2), (0,)), ((2, 3, 2, 2), (0, 1, 0))], 'dtype': [numpy.float16, numpy.float64], 'label_dtype': [numpy.int32]}) + testing.product({'reduce': ['mean', 'no'], 'cache_score': [False], 'normalize': [True], 'weight_apply': [True], 'shape_ignore': ['special', ((2, 3), (slice(None),)), ((2, 3, 2), (0,)), ((2, 3, 2, 2), (0, 1, 0))], 'dtype': [numpy.float32], 'label_dtype': [numpy.int8, numpy.int16, numpy.int64]}) + testing.product({'reduce': ['mean'], 'cache_score': [False], 'normalize': [False, True], 'weight_apply': [True], 'shape_ignore': [((300000, 2), None)], 'dtype': [numpy.float16], 'label_dtype': [numpy.int64]}))
@testing.parameterize(*testing.product({'enable_double_backprop': [False, True]}))
@testing.fix_random()
...
@testing.parameterize(*testing.product_dict([{'t_value': -2, 'valid': False}, {'t_value': 3, 'valid': False}, {'t_value': -1, 'valid': True}], [{'enable_double_backprop': True}, {'enable_double_backprop': False}]))
...
@testing.parameterize({'enable_double_backprop': True}, {'enable_double_backprop': False})
...
@testing.parameterize(*testing.product({'enable_double_backprop': [True, False]}))
...
@testing.parameterize(*testing.product({'ignore_label': [-2, 9], 'reduce': ['mean', 'no'], 'enable_double_backprop': [False, True], 'class_weight': [None, numpy.ones((3,), dtype=numpy.float32)]}))
...
@testing.parameterize(*testing.product({'shape_ignore': [(None, None), ((2, 3), (slice(None),)), ((2, 3, 2), (0,)), ((2, 3, 2, 2), (0, 1, 0))], 'normalize': [True, False], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'weight_apply': [False, True]}))
...
@testing.parameterize(*testing.product({'nb': [1, 2, 4], 'shape': [(3,), (3, 2), (3, 2, 2)], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'reduce': ['mean', 'no'], 'soft_target_loss': ['cross-entropy', 'kl-divergence']}))
...
@testing.parameterize(*testing.product({'nb': [1, 2, 4], 'shape': [(3,), (3, 2), (3, 2, 2)], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'reduce': ['mean', 'no'], 'soft_target_loss': ['kl-divergence']}))
...
@testing.parameterize(*testing.product({'nb': [1, 2, 4], 'shape': [(3,), (3, 2), (3, 2, 2)], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'reduce': ['mean', 'no'], 'soft_target_loss': ['cross-entropy']}))
