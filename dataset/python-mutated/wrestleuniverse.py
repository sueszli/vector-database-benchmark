...
from ..utils import ExtractorError, int_or_none, jwt_decode_hs256, traverse_obj, try_call, url_or_none, urlencode_postdata, variadic

class WrestleUniverseBaseIE(InfoExtractor):
    _NETRC_MACHINE = 'wrestleuniverse'
    _VALID_URL_TMPL = 'https?://(?:www\\.)?wrestle-universe\\.com/(?:(?P<lang>\\w{2})/)?%s/(?P<id>\\w+)'
    ...
    _LOGIN_HEADERS = {'Accept': '*/*', 'Content-Type': 'application/json', 'X-Client-Version': 'Chrome/JsCore/9.9.4/FirebaseCore-web', 'X-Firebase-gmpid': '1:307308870738:web:820f38fe5150c8976e338b', 'Referer': 'https://www.wrestle-universe.com/', 'Origin': 'https://www.wrestle-universe.com'}
...
class WrestleUniverseVODIE(WrestleUniverseBaseIE):
    ...
    _TESTS = [{'url': 'https://www.wrestle-universe.com/en/videos/dp8mpjmcKfxzUhEHM2uFws', 'info_dict': {'id': 'dp8mpjmcKfxzUhEHM2uFws', 'ext': 'mp4', 'title': 'The 3rd “Futari wa Princess” Max Heart Tournament', 'description': 'md5:318d5061e944797fbbb81d5c7dd00bf5', 'location': '埼玉・春日部ふれあいキューブ', 'channel': 'tjpw', 'duration': 7119, 'timestamp': 1674979200, 'upload_date': '20230129', 'thumbnail': 'https://image.asset.wrestle-universe.com/8FjD67P8rZc446RBQs5RBN/8FjD67P8rZc446RBQs5RBN', 'chapters': 'count:7', 'cast': 'count:21'}, 'params': {'skip_download': 'm3u8'}}]
