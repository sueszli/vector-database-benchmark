...
class network_servicesCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_endpoint_policy': ('parent', 'endpoint_policy_id', 'endpoint_policy'), 'create_gateway': ('parent', 'gateway_id', 'gateway'), 'create_grpc_route': ('parent', 'grpc_route_id', 'grpc_route'), 'create_http_route': ('parent', 'http_route_id', 'http_route'), 'create_mesh': ('parent', 'mesh_id', 'mesh'), 'create_service_binding': ('parent', 'service_binding_id', 'service_binding'), 'create_tcp_route': ('parent', 'tcp_route_id', 'tcp_route'), 'create_tls_route': ('parent', 'tls_route_id', 'tls_route'), 'delete_endpoint_policy': ('name',), 'delete_gateway': ('name',), 'delete_grpc_route': ('name',), 'delete_http_route': ('name',), 'delete_mesh': ('name',), 'delete_service_binding': ('name',), 'delete_tcp_route': ('name',), 'delete_tls_route': ('name',), 'get_endpoint_policy': ('name',), 'get_gateway': ('name',), 'get_grpc_route': ('name',), 'get_http_route': ('name',), 'get_mesh': ('name',), 'get_service_binding': ('name',), 'get_tcp_route': ('name',), 'get_tls_route': ('name',), 'list_endpoint_policies': ('parent', 'page_size', 'page_token'), 'list_gateways': ('parent', 'page_size', 'page_token'), 'list_grpc_routes': ('parent', 'page_size', 'page_token'), 'list_http_routes': ('parent', 'page_size', 'page_token'), 'list_meshes': ('parent', 'page_size', 'page_token'), 'list_service_bindings': ('parent', 'page_size', 'page_token'), 'list_tcp_routes': ('parent', 'page_size', 'page_token'), 'list_tls_routes': ('parent', 'page_size', 'page_token'), 'update_endpoint_policy': ('endpoint_policy', 'update_mask'), 'update_gateway': ('gateway', 'update_mask'), 'update_grpc_route': ('grpc_route', 'update_mask'), 'update_http_route': ('http_route', 'update_mask'), 'update_mesh': ('mesh', 'update_mask'), 'update_tcp_route': ('tcp_route', 'update_mask'), 'update_tls_route': ('tls_route', 'update_mask')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=network_servicesCallTransformer()):
    if False:
        print('Hello World!')
