...
class PatchDeployment(proto.Message):
    ...
    instance_filter: patch_jobs.PatchInstanceFilter = proto.Field(proto.MESSAGE, number=3, message=patch_jobs.PatchInstanceFilter)
    patch_config: patch_jobs.PatchConfig = proto.Field(proto.MESSAGE, number=4, message=patch_jobs.PatchConfig)
    duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=5, message=duration_pb2.Duration)
    one_time_schedule: 'OneTimeSchedule' = proto.Field(proto.MESSAGE, number=6, oneof='schedule', message='OneTimeSchedule')
    recurring_schedule: 'RecurringSchedule' = proto.Field(proto.MESSAGE, number=7, oneof='schedule', message='RecurringSchedule')
    ...
    last_execute_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
    rollout: patch_jobs.PatchRollout = proto.Field(proto.MESSAGE, number=11, message=patch_jobs.PatchRollout)
...
class OneTimeSchedule(proto.Message):
    ...
    Attributes:
        execute_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            time.
    """
    execute_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
...
class RecurringSchedule(proto.Message):
    ...
    class Frequency(proto.Enum):
        ...
        MONTHLY = 2
        DAILY = 3
    time_zone: datetime_pb2.TimeZone = proto.Field(proto.MESSAGE, number=1, message=datetime_pb2.TimeZone)
    ...
    time_of_day: timeofday_pb2.TimeOfDay = proto.Field(proto.MESSAGE, number=4, message=timeofday_pb2.TimeOfDay)
    frequency: Frequency = proto.Field(proto.ENUM, number=5, enum=Frequency)
    weekly: 'WeeklySchedule' = proto.Field(proto.MESSAGE, number=6, oneof='schedule_config', message='WeeklySchedule')
    monthly: 'MonthlySchedule' = proto.Field(proto.MESSAGE, number=7, oneof='schedule_config', message='MonthlySchedule')
    last_execute_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    next_execute_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
...
class WeeklySchedule(proto.Message):
    ...
    """
    day_of_week: dayofweek_pb2.DayOfWeek = proto.Field(proto.ENUM, number=1, enum=dayofweek_pb2.DayOfWeek)
...
class MonthlySchedule(proto.Message):
    ...
    Attributes:
        ...
        month_day (int):
            ...
            This field is a member of `oneof`_ ``day_of_month``.
    """
    week_day_of_month: 'WeekDayOfMonth' = proto.Field(proto.MESSAGE, number=1, oneof='day_of_month', message='WeekDayOfMonth')
    month_day: int = proto.Field(proto.INT32, number=2, oneof='day_of_month')

class WeekDayOfMonth(proto.Message):
    """Represents one week day in a month. An example is "the 4th
    Sunday".
    ...
    """
    week_ordinal: int = proto.Field(proto.INT32, number=1)
    day_of_week: dayofweek_pb2.DayOfWeek = proto.Field(proto.ENUM, number=2, enum=dayofweek_pb2.DayOfWeek)
    day_offset: int = proto.Field(proto.INT32, number=3)
...
class CreatePatchDeploymentRequest(proto.Message):
    ...
    patch_deployment_id: str = proto.Field(proto.STRING, number=2)
    patch_deployment: 'PatchDeployment' = proto.Field(proto.MESSAGE, number=3, message='PatchDeployment')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    patch_deployments: MutableSequence['PatchDeployment'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PatchDeployment')
...
class UpdatePatchDeploymentRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            updated.
    """
    patch_deployment: 'PatchDeployment' = proto.Field(proto.MESSAGE, number=1, message='PatchDeployment')
