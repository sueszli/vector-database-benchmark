...
def main():
    ...
    response = client.api_portals.validate_domain(resource_group_name='myResourceGroup', service_name='myservice', api_portal_name='default', validate_payload={'name': 'mydomain.io'})
    print(response)
