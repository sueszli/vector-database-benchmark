...
_VALID_RELAY_KEYS = ['IbXZDWy8DcGLVoT_Z6-ODALEnsyhKiC_i-0r3azaztQ', 'CZa3eDblYqBVoxK3O_4fr5WBbUmUVwc6FrRXbOQTPfk', 'gyKnK-__yfEOweJ95sB1JoqAh6VlS4c_uIwsrrQ4G7E', 'kSdr7ozq2T3gLg7FehJro2PH_NnNMJrrCslleKGZQd8']
...
invalid_payloads = [{'publicKey': _VALID_RELAY_KEYS[0], 'description': 'the description'}, {'publicKey': _VALID_RELAY_KEYS[0], 'name': '  ', 'description': 'the description'}, {'publicKey': _VALID_RELAY_KEYS[0], 'name': None, 'description': 'the description'}, {'publicKey': 'Bad Key', 'name': 'name', 'description': 'the description'}, {'name': 'name', 'description': 'the description'}, {'publicKey': None, 'name': 'name', 'description': 'the description'}, 'Bad input']
