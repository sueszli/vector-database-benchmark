...
def main():
    ...
    response = client.gateways.validate_domain(resource_group_name='myResourceGroup', service_name='myservice', gateway_name='default', validate_payload={'name': 'mydomain.io'})
    print(response)
