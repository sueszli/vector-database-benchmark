...
from ..utils import ExtractorError, float_or_none, int_or_none, jwt_decode_hs256, parse_age_limit, traverse_obj, try_call, try_get, unified_strdate
...
class VootIE(VootBaseIE):
    _VALID_URL = '(?x)\n                    (?:\n                        voot:|\n                        https?://(?:www\\.)?voot\\.com/?\n                        (?:\n                            movies?/[^/]+/|\n                            (?:shows|kids)/(?:[^/]+/){4}\n                        )\n                     )\n                    (?P<id>\\d{3,})\n                    '
    _TESTS = [{'url': 'https://www.voot.com/shows/ishq-ka-rang-safed/1/360558/is-this-the-end-of-kamini-/441353', 'info_dict': {'id': '441353', 'ext': 'mp4', 'title': 'Is this the end of Kamini?', 'description': 'md5:06291fbbbc4dcbe21235c40c262507c1', 'timestamp': 1472103000, 'upload_date': '20160825', 'series': 'Ishq Ka Rang Safed', 'season_number': 1, 'episode': 'Is this the end of Kamini?', 'episode_number': 340, 'release_date': '20160825', 'season': 'Season 1', 'age_limit': 13, 'duration': 1146.0}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.voot.com/kids/characters/mighty-cat-masked-niyander-e-/400478/school-bag-disappears/440925', 'only_matching': True}, {'url': 'https://www.voot.com/movies/pandavas-5/424627', 'only_matching': True}, {'url': 'https://www.voot.com/movie/fight-club/621842', 'only_matching': True}]
...
class VootSeriesIE(VootBaseIE):
    ...
    _TESTS = [{'url': 'https://www.voot.com/shows/chakravartin-ashoka-samrat/100002', 'playlist_mincount': 442, 'info_dict': {'id': '100002'}}, {'url': 'https://www.voot.com/shows/ishq-ka-rang-safed/100003', 'playlist_mincount': 341, 'info_dict': {'id': '100003'}}]
