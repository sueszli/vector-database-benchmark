...
from .models import AbstractApplication, get_access_token_model, get_application_model, get_grant_model, get_id_token_model, get_refresh_token_model
...
class OAuth2Validator(RequestValidator):
    oidc_claim_scope = {'sub': 'openid', 'name': 'profile', 'family_name': 'profile', 'given_name': 'profile', 'middle_name': 'profile', 'nickname': 'profile', 'preferred_username': 'profile', 'profile': 'profile', 'picture': 'profile', 'website': 'profile', 'gender': 'profile', 'birthdate': 'profile', 'zoneinfo': 'profile', 'locale': 'profile', 'updated_at': 'profile', 'email': 'email', 'email_verified': 'email', 'address': 'address', 'phone_number': 'phone', 'phone_number_verified': 'phone'}
