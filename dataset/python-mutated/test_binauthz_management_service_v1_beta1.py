...
from google.cloud.binaryauthorization_v1beta1.services.binauthz_management_service_v1_beta1 import BinauthzManagementServiceV1Beta1AsyncClient, BinauthzManagementServiceV1Beta1Client, pagers, transports
...
def test__get_default_mtls_endpoint():
    ...
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(None) is None
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(api_mtls_endpoint) == api_mtls_endpoint
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(sandbox_endpoint) == sandbox_mtls_endpoint
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(sandbox_mtls_endpoint) == sandbox_mtls_endpoint
    assert BinauthzManagementServiceV1Beta1Client._get_default_mtls_endpoint(non_googleapi) == non_googleapi

@pytest.mark.parametrize('client_class,transport_name', [(BinauthzManagementServiceV1Beta1Client, 'grpc'), (BinauthzManagementServiceV1Beta1AsyncClient, 'grpc_asyncio'), (BinauthzManagementServiceV1Beta1Client, 'rest')])
def test_binauthz_management_service_v1_beta1_client_from_service_account_info(client_class, transport_name):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.BinauthzManagementServiceV1Beta1GrpcTransport, 'grpc'), (transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, 'grpc_asyncio'), (transports.BinauthzManagementServiceV1Beta1RestTransport, 'rest')])
def test_binauthz_management_service_v1_beta1_client_service_account_always_use_jwt(transport_class, transport_name):
    if False:
        print('Hello World!')
...
@pytest.mark.parametrize('client_class,transport_name', [(BinauthzManagementServiceV1Beta1Client, 'grpc'), (BinauthzManagementServiceV1Beta1AsyncClient, 'grpc_asyncio'), (BinauthzManagementServiceV1Beta1Client, 'rest')])
def test_binauthz_management_service_v1_beta1_client_from_service_account_file(client_class, transport_name):
    if False:
        i = 10
        return i + 15
    creds = ga_credentials.AnonymousCredentials()
...
def test_binauthz_management_service_v1_beta1_client_get_transport_class():
    ...
    available_transports = [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1RestTransport]
...
@mock.patch.object(BinauthzManagementServiceV1Beta1Client, 'DEFAULT_ENDPOINT', modify_default_endpoint(BinauthzManagementServiceV1Beta1Client))
@mock.patch.object(BinauthzManagementServiceV1Beta1AsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BinauthzManagementServiceV1Beta1AsyncClient))
def test_binauthz_management_service_v1_beta1_client_client_options(client_class, transport_class, transport_name):
    if False:
        print('Hello World!')
    with mock.patch.object(BinauthzManagementServiceV1Beta1Client, 'get_transport_class') as gtc:
...
@pytest.mark.parametrize('client_class', [BinauthzManagementServiceV1Beta1Client, BinauthzManagementServiceV1Beta1AsyncClient])
@mock.patch.object(BinauthzManagementServiceV1Beta1Client, 'DEFAULT_ENDPOINT', modify_default_endpoint(BinauthzManagementServiceV1Beta1Client))
@mock.patch.object(BinauthzManagementServiceV1Beta1AsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BinauthzManagementServiceV1Beta1AsyncClient))
def test_binauthz_management_service_v1_beta1_client_get_mtls_endpoint_and_cert_source(client_class):
    if False:
        print('Hello World!')
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(BinauthzManagementServiceV1Beta1Client, transports.BinauthzManagementServiceV1Beta1GrpcTransport, 'grpc'), (BinauthzManagementServiceV1Beta1AsyncClient, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, 'grpc_asyncio'), (BinauthzManagementServiceV1Beta1Client, transports.BinauthzManagementServiceV1Beta1RestTransport, 'rest')])
def test_binauthz_management_service_v1_beta1_client_client_options_scopes(client_class, transport_class, transport_name):
    if False:
        for i in range(10):
            print('nop')
...
def test_binauthz_management_service_v1_beta1_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.binaryauthorization_v1beta1.services.binauthz_management_service_v1_beta1.transports.BinauthzManagementServiceV1Beta1GrpcTransport.__init__') as grpc_transport:
        ...
        client = BinauthzManagementServiceV1Beta1Client(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(BinauthzManagementServiceV1Beta1Client, transports.BinauthzManagementServiceV1Beta1GrpcTransport, 'grpc', grpc_helpers), (BinauthzManagementServiceV1Beta1AsyncClient, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
def test_binauthz_management_service_v1_beta1_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    if False:
        while True:
            i = 10
    options = client_options.ClientOptions(credentials_file='credentials.json')
...
def test_get_policy(request_type, transport: str='grpc'):
    if False:
        for i in range(10):
            print('nop')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_get_policy_empty_call():
    if False:
        return 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.get_policy), '__call__') as call:
        client.get_policy()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
async def test_get_policy_async(transport: str='grpc_asyncio', request_type=service.GetPolicyRequest):
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.get_policy), '__call__') as call:
...
def test_get_policy_field_headers():
    if False:
        while True:
            i = 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
...
async def test_get_policy_field_headers_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = service.GetPolicyRequest()
    request.name = 'name_value'
    with mock.patch.object(type(client.transport.get_policy), '__call__') as call:
...
def test_get_policy_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_policy(service.GetPolicyRequest(), name='name_value')
...
async def test_get_policy_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_policy(service.GetPolicyRequest(), name='name_value')
...
def test_update_policy_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_policy(service.UpdatePolicyRequest(), policy=resources.Policy(name='name_value'))
...
async def test_update_policy_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_policy), '__call__') as call:
        call.return_value = resources.Policy()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Policy())
        response = await client.update_policy(policy=resources.Policy(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].policy
        mock_val = resources.Policy(name='name_value')
...
async def test_update_policy_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_policy(service.UpdatePolicyRequest(), policy=resources.Policy(name='name_value'))
...
def test_create_attestor(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_attestor), '__call__') as call:
        call.return_value = resources.Attestor(name='name_value', description='description_value')
...
async def test_create_attestor_async(transport: str='grpc_asyncio', request_type=service.CreateAttestorRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.create_attestor), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Attestor(name='name_value', description='description_value'))
...
def test_create_attestor_flattened():
    ...
    with mock.patch.object(type(client.transport.create_attestor), '__call__') as call:
        call.return_value = resources.Attestor()
        client.create_attestor(parent='parent_value', attestor_id='attestor_id_value', attestor=resources.Attestor(name='name_value'))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
...
def test_create_attestor_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_attestor(service.CreateAttestorRequest(), parent='parent_value', attestor_id='attestor_id_value', attestor=resources.Attestor(name='name_value'))
...
async def test_create_attestor_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_attestor), '__call__') as call:
        call.return_value = resources.Attestor()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Attestor())
        response = await client.create_attestor(parent='parent_value', attestor_id='attestor_id_value', attestor=resources.Attestor(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_attestor_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_attestor(service.CreateAttestorRequest(), parent='parent_value', attestor_id='attestor_id_value', attestor=resources.Attestor(name='name_value'))
...
def test_get_attestor_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_attestor(service.GetAttestorRequest(), name='name_value')
...
async def test_get_attestor_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_attestor(service.GetAttestorRequest(), name='name_value')
...
def test_update_attestor_field_headers():
    ...
    with mock.patch.object(type(client.transport.update_attestor), '__call__') as call:
        ...
        assert args[0] == request
    (_, _, kw) = call.mock_calls[0]
    assert ('x-goog-request-params', 'attestor.name=name_value') in kw['metadata']
...
def test_update_attestor_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_attestor(service.UpdateAttestorRequest(), attestor=resources.Attestor(name='name_value'))
...
async def test_update_attestor_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_attestor), '__call__') as call:
        call.return_value = resources.Attestor()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Attestor())
        response = await client.update_attestor(attestor=resources.Attestor(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].attestor
        mock_val = resources.Attestor(name='name_value')
...
async def test_update_attestor_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_attestor(service.UpdateAttestorRequest(), attestor=resources.Attestor(name='name_value'))
...
def test_list_attestors(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_attestors), '__call__') as call:
        call.return_value = service.ListAttestorsResponse(next_page_token='next_page_token_value')
...
async def test_list_attestors_async(transport: str='grpc_asyncio', request_type=service.ListAttestorsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_attestors), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListAttestorsResponse(next_page_token='next_page_token_value'))
...
async def test_list_attestors_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_attestors), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListAttestorsResponse())
...
def test_list_attestors_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_attestors(service.ListAttestorsRequest(), parent='parent_value')
...
async def test_list_attestors_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_attestors(service.ListAttestorsRequest(), parent='parent_value')

def test_list_attestors_pager(transport_name: str='grpc'):
    if False:
        for i in range(10):
            print('nop')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_attestors), '__call__') as call:
        call.side_effect = (service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor(), resources.Attestor()], next_page_token='abc'), service.ListAttestorsResponse(attestors=[], next_page_token='def'), service.ListAttestorsResponse(attestors=[resources.Attestor()], next_page_token='ghi'), service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor()]), RuntimeError)
        metadata = ()
...
async def test_list_attestors_async_pager():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_attestors), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor(), resources.Attestor()], next_page_token='abc'), service.ListAttestorsResponse(attestors=[], next_page_token='def'), service.ListAttestorsResponse(attestors=[resources.Attestor()], next_page_token='ghi'), service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor()]), RuntimeError)
...
def test_delete_attestor_flattened_error():
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_attestor(service.DeleteAttestorRequest(), name='name_value')
...
async def test_delete_attestor_flattened_error_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_attestor(service.DeleteAttestorRequest(), name='name_value')
...
def test_get_policy_rest(request_type):
    if False:
        while True:
            i = 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_get_policy_rest_unset_required_fields():
    if False:
        while True:
            i = 10
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_get_policy_rest_interceptors(null_interceptor):
    if False:
        while True:
            i = 10
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_get_policy') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_get_policy') as pre:
...
def test_get_policy_rest_bad_request(transport: str='rest', request_type=service.GetPolicyRequest):
    if False:
        return 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/policy'}
...
def test_get_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate('%s/v1beta1/{name=projects/*/policy}' % client.transport._host, args[1])
...
def test_update_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_update_policy') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_update_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_policy_rest_bad_request(transport: str='rest', request_type=service.UpdatePolicyRequest):
    if False:
        for i in range(10):
            print('nop')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(policy=resources.Policy(name='name_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = resources.Policy.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1beta1/{policy.name=projects/*/policy}' % client.transport._host, args[1])
...
def test_create_attestor_rest(request_type):
    ...
    request_init['attestor'] = {'name': 'name_value', 'description': 'description_value', 'user_owned_drydock_note': {'note_reference': 'note_reference_value', 'public_keys': [{'comment': 'comment_value', 'id': 'id_value', 'ascii_armored_pgp_public_key': 'ascii_armored_pgp_public_key_value', 'pkix_public_key': {'public_key_pem': 'public_key_pem_value', 'signature_algorithm': 1}}], 'delegation_service_account_email': 'delegation_service_account_email_value'}, 'update_time': {'seconds': 751, 'nanos': 543}}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['attestor'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = resources.Attestor(name='name_value', description='description_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_create_attestor_rest_required_fields(request_type=service.CreateAttestorRequest):
    if False:
        while True:
            i = 10
    transport_class = transports.BinauthzManagementServiceV1Beta1RestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    ...
    with mock.patch.object(Session, 'request') as req:
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            req.return_value = response_value
            response = client.create_attestor(request)
            expected_params = [('attestorId', ''), ('$alt', 'json;enum-encoding=int')]
            actual_params = req.call_args.kwargs['params']
            assert expected_params == actual_params
...
def test_create_attestor_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('attestorId',)) & set(('parent', 'attestorId', 'attestor'))
...
def test_create_attestor_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_create_attestor') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_create_attestor') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_attestor(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_create_attestor_rest_bad_request(transport: str='rest', request_type=service.CreateAttestorRequest):
    if False:
        i = 10
        return i + 15
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(parent='parent_value', attestor_id='attestor_id_value', attestor=resources.Attestor(name='name_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = resources.Attestor.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1beta1/{parent=projects/*}/attestors' % client.transport._host, args[1])
...
def test_get_attestor_rest_required_fields(request_type=service.GetAttestorRequest):
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['name'] = 'name_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_attestor_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_get_attestor') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_get_attestor') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        pre.return_value = (request, metadata)
        post.return_value = resources.Attestor()
        client.get_attestor(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_get_attestor_rest_bad_request(transport: str='rest', request_type=service.GetAttestorRequest):
    if False:
        print('Hello World!')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/attestors/sample2'}
...
def test_get_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1beta1/{name=projects/*/attestors/*}' % client.transport._host, args[1])
...
def test_update_attestor_rest(request_type):
    ...
    request_init['attestor'] = {'name': 'projects/sample1/attestors/sample2', 'description': 'description_value', 'user_owned_drydock_note': {'note_reference': 'note_reference_value', 'public_keys': [{'comment': 'comment_value', 'id': 'id_value', 'ascii_armored_pgp_public_key': 'ascii_armored_pgp_public_key_value', 'pkix_public_key': {'public_key_pem': 'public_key_pem_value', 'signature_algorithm': 1}}], 'delegation_service_account_email': 'delegation_service_account_email_value'}, 'update_time': {'seconds': 751, 'nanos': 543}}
...
def test_update_attestor_rest_required_fields(request_type=service.UpdateAttestorRequest):
    if False:
        print('Hello World!')
    transport_class = transports.BinauthzManagementServiceV1Beta1RestTransport
    request_init = {}
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_update_attestor_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_update_attestor') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_update_attestor') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        pre.return_value = (request, metadata)
        post.return_value = resources.Attestor()
        client.update_attestor(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_update_attestor_rest_bad_request(transport: str='rest', request_type=service.UpdateAttestorRequest):
    if False:
        while True:
            i = 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_attestor_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(attestor=resources.Attestor(name='name_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = resources.Attestor.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1beta1/{attestor.name=projects/*/attestors/*}' % client.transport._host, args[1])
...
def test_list_attestors_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.ListAttestorsResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_attestors_rest_required_fields(request_type=service.ListAttestorsRequest):
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_attestors._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['parent'] = 'parent_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_attestors._get_unset_required_fields(jsonified_request)
...
def test_list_attestors_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'post_list_attestors') as post, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_list_attestors') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = service.ListAttestorsResponse.to_json(service.ListAttestorsResponse())
        request = service.ListAttestorsRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
        post.return_value = service.ListAttestorsResponse()
        client.list_attestors(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_list_attestors_rest_bad_request(transport: str='rest', request_type=service.ListAttestorsRequest):
    if False:
        for i in range(10):
            print('nop')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_attestors_rest_pager(transport: str='rest'):
    ...
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor(), resources.Attestor()], next_page_token='abc'), service.ListAttestorsResponse(attestors=[], next_page_token='def'), service.ListAttestorsResponse(attestors=[resources.Attestor()], next_page_token='ghi'), service.ListAttestorsResponse(attestors=[resources.Attestor(), resources.Attestor()]))
...
def test_delete_attestor_rest_required_fields(request_type=service.DeleteAttestorRequest):
    if False:
        i = 10
        return i + 15
    transport_class = transports.BinauthzManagementServiceV1Beta1RestTransport
    ...
    pb_request = request_type.pb(request)
    jsonified_request = json.loads(json_format.MessageToJson(pb_request, including_default_value_fields=False, use_integers_for_enums=False))
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
    jsonified_request['name'] = 'name_value'
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_attestor._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_attestor_rest_interceptors(null_interceptor):
    ...
    transport = transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BinauthzManagementServiceV1Beta1RestInterceptor())
    client = BinauthzManagementServiceV1Beta1Client(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BinauthzManagementServiceV1Beta1RestInterceptor, 'pre_delete_attestor') as pre:
        pre.assert_not_called()
        ...
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
        client.delete_attestor(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()

def test_delete_attestor_rest_bad_request(transport: str='rest', request_type=service.DeleteAttestorRequest):
    if False:
        for i in range(10):
            print('nop')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.BinauthzManagementServiceV1Beta1GrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.BinauthzManagementServiceV1Beta1GrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BinauthzManagementServiceV1Beta1Client(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.BinauthzManagementServiceV1Beta1GrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = BinauthzManagementServiceV1Beta1Client(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = BinauthzManagementServiceV1Beta1Client(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.BinauthzManagementServiceV1Beta1GrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BinauthzManagementServiceV1Beta1Client(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, transports.BinauthzManagementServiceV1Beta1RestTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = BinauthzManagementServiceV1Beta1Client.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        while True:
            i = 10
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.BinauthzManagementServiceV1Beta1GrpcTransport)

def test_binauthz_management_service_v1_beta1_base_transport_error():
    if False:
        print('Hello World!')
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.BinauthzManagementServiceV1Beta1Transport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')

def test_binauthz_management_service_v1_beta1_base_transport():
    if False:
        print('Hello World!')
    with mock.patch('google.cloud.binaryauthorization_v1beta1.services.binauthz_management_service_v1_beta1.transports.BinauthzManagementServiceV1Beta1Transport.__init__') as Transport:
        Transport.return_value = None
        transport = transports.BinauthzManagementServiceV1Beta1Transport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('get_policy', 'update_policy', 'create_attestor', 'get_attestor', 'update_attestor', 'list_attestors', 'delete_attestor')
...
def test_binauthz_management_service_v1_beta1_base_transport_with_credentials_file():
    if False:
        return 10
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.binaryauthorization_v1beta1.services.binauthz_management_service_v1_beta1.transports.BinauthzManagementServiceV1Beta1Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.BinauthzManagementServiceV1Beta1Transport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_binauthz_management_service_v1_beta1_base_transport_with_adc():
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.binaryauthorization_v1beta1.services.binauthz_management_service_v1_beta1.transports.BinauthzManagementServiceV1Beta1Transport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport])
...
@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, transports.BinauthzManagementServiceV1Beta1RestTransport])
def test_binauthz_management_service_v1_beta1_transport_auth_gdch_credentials(transport_class):
    if False:
        print('Hello World!')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.BinauthzManagementServiceV1Beta1GrpcTransport, grpc_helpers), (transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport, grpc_helpers_async)])
def test_binauthz_management_service_v1_beta1_transport_create_channel(transport_class, grpc_helpers):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport])
def test_binauthz_management_service_v1_beta1_grpc_transport_client_cert_source_for_mtls(transport_class):
    if False:
        i = 10
        return i + 15
...
def test_binauthz_management_service_v1_beta1_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.BinauthzManagementServiceV1Beta1RestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_binauthz_management_service_v1_beta1_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='binaryauthorization.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('binaryauthorization.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://binaryauthorization.googleapis.com')
...
def test_binauthz_management_service_v1_beta1_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='binaryauthorization.googleapis.com:8000'), transport=transport_name)
...
def test_binauthz_management_service_v1_beta1_client_transport_session_collision(transport_name):
    if False:
        for i in range(10):
            print('nop')
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = BinauthzManagementServiceV1Beta1Client(credentials=creds1, transport=transport_name)
    client2 = BinauthzManagementServiceV1Beta1Client(credentials=creds2, transport=transport_name)
...
def test_binauthz_management_service_v1_beta1_grpc_transport_channel():
    ...
    transport = transports.BinauthzManagementServiceV1Beta1GrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_binauthz_management_service_v1_beta1_grpc_asyncio_transport_channel():
    ...
    transport = transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport])
def test_binauthz_management_service_v1_beta1_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        print('Hello World!')
...
@pytest.mark.parametrize('transport_class', [transports.BinauthzManagementServiceV1Beta1GrpcTransport, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport])
def test_binauthz_management_service_v1_beta1_transport_channel_mtls_with_adc(transport_class):
    if False:
        for i in range(10):
            print('nop')
    mock_ssl_cred = mock.Mock()
...
def test_attestor_path():
    ...
    project = 'squid'
    attestor = 'clam'
    expected = 'projects/{project}/attestors/{attestor}'.format(project=project, attestor=attestor)
...
def test_parse_attestor_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'whelk', 'attestor': 'octopus'}
...
def test_common_billing_account_path():
    ...
    actual = BinauthzManagementServiceV1Beta1Client.common_billing_account_path(billing_account)
    assert expected == actual
...
def test_parse_common_billing_account_path():
    ...
    path = BinauthzManagementServiceV1Beta1Client.common_billing_account_path(**expected)
    actual = BinauthzManagementServiceV1Beta1Client.parse_common_billing_account_path(path)
    assert expected == actual
...
def test_common_organization_path():
    ...
    actual = BinauthzManagementServiceV1Beta1Client.common_organization_path(organization)
    assert expected == actual
...
def test_common_location_path():
    ...
    actual = BinauthzManagementServiceV1Beta1Client.common_location_path(project, location)
    assert expected == actual
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.BinauthzManagementServiceV1Beta1Transport, '_prep_wrapped_messages') as prep:
        client = BinauthzManagementServiceV1Beta1Client(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = BinauthzManagementServiceV1Beta1AsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(BinauthzManagementServiceV1Beta1Client, transports.BinauthzManagementServiceV1Beta1GrpcTransport), (BinauthzManagementServiceV1Beta1AsyncClient, transports.BinauthzManagementServiceV1Beta1GrpcAsyncIOTransport)])
