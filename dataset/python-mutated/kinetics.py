...
_INFO_VERSION_MAP = {'400': Kinetics400DatasetInfo, '600': Kinetics600DatasetInfo, '700': Kinetics700DatasetInfo, '700-2020': Kinetics7002020DatasetInfo}
_ANNOTATION_DOWNLOAD_LINKS = {'400': 'https://storage.googleapis.com/deepmind-media/Datasets/kinetics400.tar.gz', '600': 'https://storage.googleapis.com/deepmind-media/Datasets/kinetics600.tar.gz', '700': 'https://storage.googleapis.com/deepmind-media/Datasets/kinetics700.tar.gz', '700-2020': 'https://storage.googleapis.com/deepmind-media/Datasets/kinetics700_2020.tar.gz'}
_SPLIT_MAP = {'test': 'test', 'train': 'train', 'validation': 'validate'}