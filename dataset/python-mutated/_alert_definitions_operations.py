...
def build_get_request(scope: str, alert_definition_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/roleManagementAlertDefinitions/{alertDefinitionId}')
    path_format_arguments = {'scope': _SERIALIZER.url('scope', scope, 'str', skip_quote=True), 'alertDefinitionId': _SERIALIZER.url('alert_definition_id', alert_definition_id, 'str', skip_quote=True)}
...
class AlertDefinitionsOperations:
    ...
    def get(self, scope: str, alert_definition_id: str, **kwargs: Any) -> _models.AlertDefinition:
        ...
        request = build_get_request(scope=scope, alert_definition_id=alert_definition_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        ...
        return deserialized
    get.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/roleManagementAlertDefinitions/{alertDefinitionId}'}
