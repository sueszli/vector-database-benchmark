...
from pyoverkiz.enums import OverkizCommand, OverkizCommandParam, OverkizState, UIClass, UIWidget
from homeassistant.components.cover import ATTR_POSITION, CoverDeviceClass, CoverEntityFeature
from ..coordinator import OverkizDataUpdateCoordinator
from .generic_cover import COMMANDS_CLOSE_TILT, COMMANDS_OPEN_TILT, COMMANDS_STOP, OverkizGenericCover
...
class LowSpeedCover(VerticalCover):
    ...
    async def async_set_cover_position_low_speed(self, **kwargs: Any) -> None:
        ...
        await self.executor.async_execute_command(OverkizCommand.SET_CLOSURE_AND_LINEAR_SPEED, position, OverkizCommandParam.LOWSPEED)