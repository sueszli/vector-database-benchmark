...
class gke_multicloudCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_attached_cluster': ('parent', 'attached_cluster', 'attached_cluster_id', 'validate_only'), 'create_aws_cluster': ('parent', 'aws_cluster', 'aws_cluster_id', 'validate_only'), 'create_aws_node_pool': ('parent', 'aws_node_pool', 'aws_node_pool_id', 'validate_only'), 'create_azure_client': ('parent', 'azure_client', 'azure_client_id', 'validate_only'), 'create_azure_cluster': ('parent', 'azure_cluster', 'azure_cluster_id', 'validate_only'), 'create_azure_node_pool': ('parent', 'azure_node_pool', 'azure_node_pool_id', 'validate_only'), 'delete_attached_cluster': ('name', 'validate_only', 'allow_missing', 'ignore_errors', 'etag'), 'delete_aws_cluster': ('name', 'validate_only', 'allow_missing', 'etag'), 'delete_aws_node_pool': ('name', 'validate_only', 'allow_missing', 'etag'), 'delete_azure_client': ('name', 'allow_missing', 'validate_only'), 'delete_azure_cluster': ('name', 'allow_missing', 'validate_only', 'etag'), 'delete_azure_node_pool': ('name', 'validate_only', 'allow_missing', 'etag'), 'generate_attached_cluster_install_manifest': ('parent', 'attached_cluster_id', 'platform_version'), 'generate_aws_access_token': ('aws_cluster',), 'generate_azure_access_token': ('azure_cluster',), 'get_attached_cluster': ('name',), 'get_attached_server_config': ('name',), 'get_aws_cluster': ('name',), 'get_aws_node_pool': ('name',), 'get_aws_server_config': ('name',), 'get_azure_client': ('name',), 'get_azure_cluster': ('name',), 'get_azure_node_pool': ('name',), 'get_azure_server_config': ('name',), 'import_attached_cluster': ('parent', 'fleet_membership', 'platform_version', 'distribution', 'validate_only'), 'list_attached_clusters': ('parent', 'page_size', 'page_token'), 'list_aws_clusters': ('parent', 'page_size', 'page_token'), 'list_aws_node_pools': ('parent', 'page_size', 'page_token'), 'list_azure_clients': ('parent', 'page_size', 'page_token'), 'list_azure_clusters': ('parent', 'page_size', 'page_token'), 'list_azure_node_pools': ('parent', 'page_size', 'page_token'), 'update_attached_cluster': ('attached_cluster', 'update_mask', 'validate_only'), 'update_aws_cluster': ('aws_cluster', 'update_mask', 'validate_only'), 'update_aws_node_pool': ('aws_node_pool', 'update_mask', 'validate_only'), 'update_azure_cluster': ('azure_cluster', 'update_mask', 'validate_only'), 'update_azure_node_pool': ('azure_node_pool', 'update_mask', 'validate_only')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=gke_multicloudCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
