...
from numpy.testing import assert_, assert_equal, assert_almost_equal, assert_raises, assert_raises_regex, assert_array_equal, suppress_warnings
_ndat = np.array([[0.6244, np.nan, 0.2692, 0.0116, np.nan, 0.117], [0.5351, -0.9403, np.nan, 0.21, 0.4759, 0.2833], [np.nan, np.nan, np.nan, 0.1042, np.nan, -0.5954], [0.161, np.nan, np.nan, 0.1859, 0.3146, np.nan]])
_rdat = [np.array([0.6244, 0.2692, 0.0116, 0.117]), np.array([0.5351, -0.9403, 0.21, 0.4759, 0.2833]), np.array([0.1042, -0.5954]), np.array([0.161, 0.1859, 0.3146])]
_ndat_ones = np.array([[0.6244, 1.0, 0.2692, 0.0116, 1.0, 0.117], [0.5351, -0.9403, 1.0, 0.21, 0.4759, 0.2833], [1.0, 1.0, 1.0, 0.1042, 1.0, -0.5954], [0.161, 1.0, 1.0, 0.1859, 0.3146, 1.0]])
_ndat_zeros = np.array([[0.6244, 0.0, 0.2692, 0.0116, 0.0, 0.117], [0.5351, -0.9403, 0.0, 0.21, 0.4759, 0.2833], [0.0, 0.0, 0.0, 0.1042, 0.0, -0.5954], [0.161, 0.0, 0.0, 0.1859, 0.3146, 0.0]])
...
@pytest.mark.parametrize('dtype', np.typecodes['AllInteger'] + np.typecodes['AllFloat'] + 'O')
@pytest.mark.parametrize('mat', _TEST_ARRAYS.values(), ids=_TEST_ARRAYS.keys())
class TestNanFunctions_NumberTypes:
    nanfuncs = {np.nanmin: np.min, np.nanmax: np.max, np.nanargmin: np.argmin, np.nanargmax: np.argmax, np.nansum: np.sum, np.nanprod: np.prod, np.nancumsum: np.cumsum, np.nancumprod: np.cumprod, np.nanmean: np.mean, np.nanmedian: np.median, np.nanvar: np.var, np.nanstd: np.std}
