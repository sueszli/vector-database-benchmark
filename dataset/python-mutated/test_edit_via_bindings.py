...
@pytest.mark.parametrize('content,cursor_column,cursor_destination', [('', 0, 4), ('x', 0, 4), ('x', 1, 4), ('xxx', 3, 4), ('xxxx', 4, 8), ('xxxxx', 5, 8), ('xxxxxx', 6, 8), ('💩', 1, 3), ('💩💩', 2, 6)])
async def test_tab_with_spaces_goes_to_tab_stop(content, cursor_column, cursor_destination):
    app = TextAreaApp()
    async with app.run_test() as pilot:
        text_area = app.query_one(TextArea)
...
@pytest.mark.parametrize('key,selection', [('delete', Selection((1, 2), (3, 4))), ('delete', Selection((3, 4), (1, 2))), ('backspace', Selection((1, 2), (3, 4))), ('backspace', Selection((3, 4), (1, 2)))])
...
@pytest.mark.parametrize('selection,expected_result', [(Selection.cursor((0, 0)), ''), (Selection.cursor((0, 4)), ''), (Selection.cursor((0, 10)), ''), (Selection((0, 2), (0, 4)), ''), (Selection((0, 4), (0, 2)), '')])
...
@pytest.mark.parametrize('selection,expected_result', [(Selection.cursor((0, 0)), '345\n678\n9\n'), (Selection.cursor((0, 2)), '345\n678\n9\n'), (Selection.cursor((3, 1)), '012\n345\n678\n'), (Selection.cursor((4, 0)), '012\n345\n678\n9\n'), (Selection((1, 1), (1, 2)), '012\n678\n9\n'), (Selection((1, 2), (2, 1)), '012\n9\n'), (Selection((1, 2), (3, 0)), '012\n9\n'), (Selection((3, 0), (1, 2)), '012\n9\n'), (Selection((0, 0), (4, 0)), '')])
...
@pytest.mark.parametrize('selection,expected_result', [(Selection.cursor((0, 0)), ''), (Selection.cursor((0, 5)), '01234'), (Selection.cursor((0, 9)), '012345678'), (Selection.cursor((0, 10)), '0123456789'), (Selection((0, 0), (0, 9)), '012345678'), (Selection((0, 0), (0, 10)), '0123456789'), (Selection((0, 2), (0, 5)), '01234'), (Selection((0, 5), (0, 2)), '01')])
...
@pytest.mark.parametrize('selection,expected_result', [(Selection.cursor((0, 0)), '0123456789'), (Selection.cursor((0, 5)), '56789'), (Selection.cursor((0, 9)), '9'), (Selection.cursor((0, 10)), ''), (Selection((0, 0), (0, 9)), '9'), (Selection((0, 0), (0, 10)), ''), (Selection((0, 2), (0, 5)), '56789'), (Selection((0, 5), (0, 2)), '23456789')])
...
@pytest.mark.parametrize('selection,expected_result,final_selection', [(Selection.cursor((0, 0)), '\t012 \t 345\t6789', Selection.cursor((0, 0))), (Selection.cursor((0, 4)), '\t \t 345\t6789', Selection.cursor((0, 1))), (Selection.cursor((0, 5)), '\t\t 345\t6789', Selection.cursor((0, 1))), (Selection.cursor((0, 6)), '\t 345\t6789', Selection.cursor((0, 1))), (Selection.cursor((0, 15)), '\t012 \t 345\t', Selection.cursor((0, 11))), (Selection((0, 4), (0, 11)), '\t0126789', Selection.cursor((0, 4)))])
