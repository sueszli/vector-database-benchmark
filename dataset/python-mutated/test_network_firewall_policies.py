...
@pytest.mark.parametrize('client_class,transport_name', [(NetworkFirewallPoliciesClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.NetworkFirewallPoliciesRestTransport, 'rest')])
...
def test_network_firewall_policies_client_get_transport_class():
    ...
    available_transports = [transports.NetworkFirewallPoliciesRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(NetworkFirewallPoliciesClient, transports.NetworkFirewallPoliciesRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(NetworkFirewallPoliciesClient, transports.NetworkFirewallPoliciesRestTransport, 'rest', 'true'), (NetworkFirewallPoliciesClient, transports.NetworkFirewallPoliciesRestTransport, 'rest', 'false')])
@mock.patch.object(NetworkFirewallPoliciesClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(NetworkFirewallPoliciesClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(NetworkFirewallPoliciesClient, transports.NetworkFirewallPoliciesRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AddAssociationNetworkFirewallPolicyRequest, dict])
def test_add_association_rest(request_type):
    ...
    for (field, value) in request_init['firewall_policy_association_resource'].items():
        result = None
        is_repeated = False
...
def test_add_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('replaceExistingAssociation', 'requestId')) & set(('firewallPolicy', 'firewallPolicyAssociationResource', 'project'))

@pytest.mark.parametrize('null_interceptor', [True, False])
def test_add_association_rest_interceptors(null_interceptor):
    if False:
        return 10
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_add_association') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_add_association') as pre:
...
def test_add_association_rest_bad_request(transport: str='rest', request_type=compute.AddAssociationNetworkFirewallPolicyRequest):
    if False:
        for i in range(10):
            print('nop')
...
def test_add_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', firewall_policy='firewall_policy_value', firewall_policy_association_resource=compute.FirewallPolicyAssociation(attachment_target='attachment_target_value'))
        ...
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/addAssociation' % client.transport._host, args[1])
...
def test_add_association_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_association(compute.AddAssociationNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_association_resource=compute.FirewallPolicyAssociation(attachment_target='attachment_target_value'))
...
def test_add_association_unary_rest_bad_request(transport: str='rest', request_type=compute.AddAssociationNetworkFirewallPolicyRequest):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_add_association_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_association_unary(compute.AddAssociationNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_association_resource=compute.FirewallPolicyAssociation(attachment_target='attachment_target_value'))
...
@pytest.mark.parametrize('request_type', [compute.AddRuleNetworkFirewallPolicyRequest, dict])
def test_add_rule_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['firewall_policy_rule_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_add_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('maxPriority', 'minPriority', 'requestId')) & set(('firewallPolicy', 'firewallPolicyRuleResource', 'project'))
...
def test_add_rule_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_add_rule') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_add_rule') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_add_rule_rest_bad_request(transport: str='rest', request_type=compute.AddRuleNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_add_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'firewall_policy': 'sample2'}
        mock_args = dict(project='project_value', firewall_policy='firewall_policy_value', firewall_policy_rule_resource=compute.FirewallPolicyRule(action='action_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/addRule' % client.transport._host, args[1])
...
def test_add_rule_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_rule(compute.AddRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_rule_resource=compute.FirewallPolicyRule(action='action_value'))
...
def test_add_rule_unary_rest_bad_request(transport: str='rest', request_type=compute.AddRuleNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_add_rule_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_rule_unary(compute.AddRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_rule_resource=compute.FirewallPolicyRule(action='action_value'))
...
@pytest.mark.parametrize('request_type', [compute.CloneRulesNetworkFirewallPolicyRequest, dict])
...
def test_clone_rules_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId', 'sourceFirewallPolicy')) & set(('firewallPolicy', 'project'))
...
def test_clone_rules_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_clone_rules') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_clone_rules') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_clone_rules_rest_bad_request(transport: str='rest', request_type=compute.CloneRulesNetworkFirewallPolicyRequest):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_clone_rules_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'firewall_policy': 'sample2'}
        mock_args = dict(project='project_value', firewall_policy='firewall_policy_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/cloneRules' % client.transport._host, args[1])
...
def test_clone_rules_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.clone_rules(compute.CloneRulesNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
def test_clone_rules_unary_rest_bad_request(transport: str='rest', request_type=compute.CloneRulesNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_clone_rules_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.clone_rules_unary(compute.CloneRulesNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.DeleteNetworkFirewallPolicyRequest, dict])
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('firewallPolicy', 'project'))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_delete') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_bad_request(transport: str='rest', request_type=compute.DeleteNetworkFirewallPolicyRequest):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
def test_delete_unary_rest_bad_request(transport: str='rest', request_type=compute.DeleteNetworkFirewallPolicyRequest):
    if False:
        i = 10
        return i + 15
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.GetNetworkFirewallPolicyRequest, dict])
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('firewallPolicy', 'project'))
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_get') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_bad_request(transport: str='rest', request_type=compute.GetNetworkFirewallPolicyRequest):
    if False:
        print('Hello World!')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.GetAssociationNetworkFirewallPolicyRequest, dict])
def test_get_association_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.FirewallPolicyAssociation(attachment_target='attachment_target_value', display_name='display_name_value', firewall_policy_id='firewall_policy_id_value', name='name_value', short_name='short_name_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('name',)) & set(('firewallPolicy', 'project'))
...
def test_get_association_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_get_association') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_get_association') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_association_rest_bad_request(transport: str='rest', request_type=compute.GetAssociationNetworkFirewallPolicyRequest):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_get_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/getAssociation' % client.transport._host, args[1])
...
def test_get_association_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get_association(compute.GetAssociationNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.GetIamPolicyNetworkFirewallPolicyRequest, dict])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_get_iam_policy') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_get_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_bad_request(transport: str='rest', request_type=compute.GetIamPolicyNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'resource': 'sample2'}
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{resource}/getIamPolicy' % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get_iam_policy(compute.GetIamPolicyNetworkFirewallPolicyRequest(), project='project_value', resource='resource_value')
...
@pytest.mark.parametrize('request_type', [compute.GetRuleNetworkFirewallPolicyRequest, dict])
def test_get_rule_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.FirewallPolicyRule(action='action_value', description='description_value', direction='direction_value', disabled=True, enable_logging=True, kind='kind_value', priority=898, rule_name='rule_name_value', rule_tuple_count=1737, target_resources=['target_resources_value'], target_service_accounts=['target_service_accounts_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_get_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('priority',)) & set(('firewallPolicy', 'project'))
...
def test_get_rule_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_get_rule') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_get_rule') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rule_rest_bad_request(transport: str='rest', request_type=compute.GetRuleNetworkFirewallPolicyRequest):
    if False:
        for i in range(10):
            print('nop')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_get_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/getRule' % client.transport._host, args[1])
...
def test_get_rule_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get_rule(compute.GetRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.InsertNetworkFirewallPolicyRequest, dict])
def test_insert_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['firewall_policy_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('firewallPolicyResource', 'project'))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_insert') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str='rest', request_type=compute.InsertNetworkFirewallPolicyRequest):
    if False:
        for i in range(10):
            print('nop')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertNetworkFirewallPolicyRequest(), project='project_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
...
def test_insert_unary_rest_bad_request(transport: str='rest', request_type=compute.InsertNetworkFirewallPolicyRequest):
    if False:
        print('Hello World!')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1'}
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertNetworkFirewallPolicyRequest(), project='project_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
...
@pytest.mark.parametrize('request_type', [compute.ListNetworkFirewallPoliciesRequest, dict])
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.FirewallPolicyList(id='id_value', kind='kind_value', next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_list') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_bad_request(transport: str='rest', request_type=compute.ListNetworkFirewallPoliciesRequest):
    if False:
        for i in range(10):
            print('nop')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListNetworkFirewallPoliciesRequest(), project='project_value')
...
@pytest.mark.parametrize('request_type', [compute.PatchNetworkFirewallPolicyRequest, dict])
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('firewallPolicy', 'firewallPolicyResource', 'project'))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_patch') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_bad_request(transport: str='rest', request_type=compute.PatchNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'firewall_policy': 'sample2'}
        mock_args = dict(project='project_value', firewall_policy='firewall_policy_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
...
def test_patch_unary_rest_bad_request(transport: str='rest', request_type=compute.PatchNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_resource=compute.FirewallPolicy(associations=[compute.FirewallPolicyAssociation(attachment_target='attachment_target_value')]))
...
@pytest.mark.parametrize('request_type', [compute.PatchRuleNetworkFirewallPolicyRequest, dict])
...
def test_patch_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('priority', 'requestId')) & set(('firewallPolicy', 'firewallPolicyRuleResource', 'project'))
...
def test_patch_rule_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_patch_rule') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_patch_rule') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rule_rest_bad_request(transport: str='rest', request_type=compute.PatchRuleNetworkFirewallPolicyRequest):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_patch_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/patchRule' % client.transport._host, args[1])
...
def test_patch_rule_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_rule(compute.PatchRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_rule_resource=compute.FirewallPolicyRule(action='action_value'))
...
def test_patch_rule_unary_rest_bad_request(transport: str='rest', request_type=compute.PatchRuleNetworkFirewallPolicyRequest):
    if False:
        for i in range(10):
            print('nop')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_patch_rule_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_rule_unary(compute.PatchRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value', firewall_policy_rule_resource=compute.FirewallPolicyRule(action='action_value'))
...
@pytest.mark.parametrize('request_type', [compute.RemoveAssociationNetworkFirewallPolicyRequest, dict])
...
def test_remove_association_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('name', 'requestId')) & set(('firewallPolicy', 'project'))
...
def test_remove_association_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_remove_association') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_remove_association') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_association_rest_bad_request(transport: str='rest', request_type=compute.RemoveAssociationNetworkFirewallPolicyRequest):
    if False:
        i = 10
        return i + 15
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_remove_association_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/removeAssociation' % client.transport._host, args[1])
...
def test_remove_association_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.remove_association(compute.RemoveAssociationNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
def test_remove_association_unary_rest_bad_request(transport: str='rest', request_type=compute.RemoveAssociationNetworkFirewallPolicyRequest):
    if False:
        print('Hello World!')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_remove_association_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.remove_association_unary(compute.RemoveAssociationNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.RemoveRuleNetworkFirewallPolicyRequest, dict])
...
def test_remove_rule_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('priority', 'requestId')) & set(('firewallPolicy', 'project'))
...
def test_remove_rule_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_remove_rule') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_remove_rule') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_remove_rule_rest_bad_request(transport: str='rest', request_type=compute.RemoveRuleNetworkFirewallPolicyRequest):
    if False:
        print('Hello World!')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall_policy': 'sample2'}
...
def test_remove_rule_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/removeRule' % client.transport._host, args[1])
...
def test_remove_rule_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.remove_rule(compute.RemoveRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
def test_remove_rule_unary_rest_bad_request(transport: str='rest', request_type=compute.RemoveRuleNetworkFirewallPolicyRequest):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_remove_rule_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.remove_rule_unary(compute.RemoveRuleNetworkFirewallPolicyRequest(), project='project_value', firewall_policy='firewall_policy_value')
...
@pytest.mark.parametrize('request_type', [compute.SetIamPolicyNetworkFirewallPolicyRequest, dict])
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_set_iam_policy') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_set_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_bad_request(transport: str='rest', request_type=compute.SetIamPolicyNetworkFirewallPolicyRequest):
    if False:
        for i in range(10):
            print('nop')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{resource}/setIamPolicy' % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_iam_policy(compute.SetIamPolicyNetworkFirewallPolicyRequest(), project='project_value', resource='resource_value', global_set_policy_request_resource=compute.GlobalSetPolicyRequest(bindings=[compute.Binding(binding_id='binding_id_value')]))
...
@pytest.mark.parametrize('request_type', [compute.TestIamPermissionsNetworkFirewallPolicyRequest, dict])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.NetworkFirewallPoliciesRestInterceptor())
    client = NetworkFirewallPoliciesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'post_test_iam_permissions') as post, mock.patch.object(transports.NetworkFirewallPoliciesRestInterceptor, 'pre_test_iam_permissions') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_bad_request(transport: str='rest', request_type=compute.TestIamPermissionsNetworkFirewallPolicyRequest):
    if False:
        print('Hello World!')
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'resource': 'sample2'}
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewallPolicies/{resource}/testIamPermissions' % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened_error(transport: str='rest'):
    ...
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.test_iam_permissions(compute.TestIamPermissionsNetworkFirewallPolicyRequest(), project='project_value', resource='resource_value', test_permissions_request_resource=compute.TestPermissionsRequest(permissions=['permissions_value']))
...
def test_credentials_transport_error():
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = NetworkFirewallPoliciesClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = NetworkFirewallPoliciesClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.NetworkFirewallPoliciesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = NetworkFirewallPoliciesClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.NetworkFirewallPoliciesRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        for i in range(10):
            print('nop')
    transport = NetworkFirewallPoliciesClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_network_firewall_policies_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.NetworkFirewallPoliciesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_network_firewall_policies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport.__init__') as Transport:
        ...
        transport = transports.NetworkFirewallPoliciesTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('add_association', 'add_rule', 'clone_rules', 'delete', 'get', 'get_association', 'get_iam_policy', 'get_rule', 'insert', 'list', 'patch', 'patch_rule', 'remove_association', 'remove_rule', 'set_iam_policy', 'test_iam_permissions')
...
def test_network_firewall_policies_base_transport_with_credentials_file():
    if False:
        i = 10
        return i + 15
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.NetworkFirewallPoliciesTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_network_firewall_policies_base_transport_with_adc():
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.network_firewall_policies.transports.NetworkFirewallPoliciesTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_network_firewall_policies_host_no_port(transport_name):
    if False:
        return 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_network_firewall_policies_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_network_firewall_policies_client_transport_session_collision(transport_name):
    ...
    client1 = NetworkFirewallPoliciesClient(credentials=creds1, transport=transport_name)
    client2 = NetworkFirewallPoliciesClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.NetworkFirewallPoliciesTransport, '_prep_wrapped_messages') as prep:
        client = NetworkFirewallPoliciesClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(NetworkFirewallPoliciesClient, transports.NetworkFirewallPoliciesRestTransport)])
