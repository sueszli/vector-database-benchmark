...
if __name__ == '__main__':
    ...
    op.add_option('--n-population', dest='n_population', default=100000, type=int, help='Size of the population to sample from.')
    op.add_option('--n-step', dest='n_steps', default=5, type=int, help='Number of step interval between 0 and n_population.')
    default_algorithms = 'custom-tracking-selection,custom-auto,custom-reservoir-sampling,custom-pool,python-core-sample,numpy-permutation'
    op.add_option('--algorithm', dest='selected_algorithm', default=default_algorithms, type=str, help='Comma-separated list of transformer to benchmark. Default: %default. \nAvailable: %default')
    ...
    sampling_algorithm = {}
    sampling_algorithm['python-core-sample'] = lambda n_population, n_sample: random.sample(range(n_population), n_sample)
