...
class TestDot11ManagementBeaconFrames(unittest.TestCase):
    ...
    def setUp(self):
        if False:
            while True:
                i = 10
        self.rawframe = b'\x00\x00\x10\x00n\x00\x00\x00\x00\x02\x94\t\xa0\x00:\x00\xc0\x00:\x01\x00\x15\xafd\xac\xbd\x00\x189\xc1\xfc\xe2\x00\x189\xc1\xfc\xe2 ;\x0f\x00'
