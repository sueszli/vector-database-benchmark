...
class DatasetSplitType(proto.Enum):
    """Documents belonging to a dataset will be split into different
...
class UpdateDatasetRequest(proto.Message):
    ...
    """
    dataset: gcd_dataset.Dataset = proto.Field(proto.MESSAGE, number=1, message=gcd_dataset.Dataset)
...
class ImportDocumentsRequest(proto.Message):
    ...
    class BatchDocumentsImportConfig(proto.Message):
        ...
        class AutoSplitConfig(proto.Message):
            ...
            """
            training_split_ratio: float = proto.Field(proto.FLOAT, number=1)
        dataset_split: 'DatasetSplitType' = proto.Field(proto.ENUM, number=2, oneof='split_type_config', enum='DatasetSplitType')
        auto_split_config: 'ImportDocumentsRequest.BatchDocumentsImportConfig.AutoSplitConfig' = proto.Field(proto.MESSAGE, number=3, oneof='split_type_config', message='ImportDocumentsRequest.BatchDocumentsImportConfig.AutoSplitConfig')
        batch_input_config: document_io.BatchDocumentsInputConfig = proto.Field(proto.MESSAGE, number=1, message=document_io.BatchDocumentsInputConfig)
...
class ImportDocumentsMetadata(proto.Message):
    ...
    class IndividualImportStatus(proto.Message):
        ...
        output_document_id: gcd_dataset.DocumentId = proto.Field(proto.MESSAGE, number=4, message=gcd_dataset.DocumentId)
    ...
    class ImportConfigValidationResult(proto.Message):
        ...
        status: status_pb2.Status = proto.Field(proto.MESSAGE, number=2, message=status_pb2.Status)
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=1, message=operation_metadata.CommonOperationMetadata)
    individual_import_statuses: MutableSequence[IndividualImportStatus] = proto.RepeatedField(proto.MESSAGE, number=2, message=IndividualImportStatus)
    import_config_validation_results: MutableSequence[ImportConfigValidationResult] = proto.RepeatedField(proto.MESSAGE, number=4, message=ImportConfigValidationResult)
    total_document_count: int = proto.Field(proto.INT32, number=3)
...
class GetDocumentRequest(proto.Message):
    ...
    """
    dataset: str = proto.Field(proto.STRING, number=1)
    document_id: gcd_dataset.DocumentId = proto.Field(proto.MESSAGE, number=2, message=gcd_dataset.DocumentId)
    read_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=3, message=field_mask_pb2.FieldMask)
    page_range: 'DocumentPageRange' = proto.Field(proto.MESSAGE, number=4, message='DocumentPageRange')
...
class ListDocumentsRequest(proto.Message):
    ...
    return_total_size: bool = proto.Field(proto.BOOL, number=6)
    skip: int = proto.Field(proto.INT32, number=8)
...
class ListDocumentsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    document_metadata: MutableSequence['DocumentMetadata'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DocumentMetadata')
...
class BatchDeleteDocumentsRequest(proto.Message):
    ...
    """
    dataset: str = proto.Field(proto.STRING, number=1)
    dataset_documents: gcd_dataset.BatchDatasetDocuments = proto.Field(proto.MESSAGE, number=3, message=gcd_dataset.BatchDatasetDocuments)
...
class BatchDeleteDocumentsMetadata(proto.Message):
    ...
    class IndividualBatchDeleteStatus(proto.Message):
        """The status of each individual document in the batch delete
        process.
        ...
        Attributes:
            ...
            status (google.rpc.status_pb2.Status):
                ...
                storage.
        """
        document_id: gcd_dataset.DocumentId = proto.Field(proto.MESSAGE, number=1, message=gcd_dataset.DocumentId)
        status: status_pb2.Status = proto.Field(proto.MESSAGE, number=2, message=status_pb2.Status)
    common_metadata: operation_metadata.CommonOperationMetadata = proto.Field(proto.MESSAGE, number=1, message=operation_metadata.CommonOperationMetadata)
    individual_batch_delete_statuses: MutableSequence[IndividualBatchDeleteStatus] = proto.RepeatedField(proto.MESSAGE, number=2, message=IndividualBatchDeleteStatus)
    total_document_count: int = proto.Field(proto.INT32, number=3)
    error_document_count: int = proto.Field(proto.INT32, number=4)
...
class GetDatasetSchemaRequest(proto.Message):
    ...
    visible_fields_only: bool = proto.Field(proto.BOOL, number=2)
...
class UpdateDatasetSchemaRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            The update mask applies to the resource.
    """
    dataset_schema: gcd_dataset.DatasetSchema = proto.Field(proto.MESSAGE, number=1, message=gcd_dataset.DatasetSchema)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class DocumentMetadata(proto.Message):
    ...
    """
    document_id: gcd_dataset.DocumentId = proto.Field(proto.MESSAGE, number=1, message=gcd_dataset.DocumentId)
    page_count: int = proto.Field(proto.INT32, number=2)
    dataset_type: 'DatasetSplitType' = proto.Field(proto.ENUM, number=3, enum='DatasetSplitType')
    labeling_state: 'DocumentLabelingState' = proto.Field(proto.ENUM, number=5, enum='DocumentLabelingState')
