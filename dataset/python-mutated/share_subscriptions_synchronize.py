...
def main():
    ...
    response = client.share_subscriptions.begin_synchronize(resource_group_name='SampleResourceGroup', account_name='Account1', share_subscription_name='ShareSubscription1', synchronize={'synchronizationMode': 'Incremental'}).result()
    print(response)
