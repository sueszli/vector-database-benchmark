...
menu_card = page.add('template_example', ui.template_card(box='1 1 2 2', title='Surge-priced Menu', content=menu, data=dict(dishes=[dict(name='Spam', price='$2.00'), dict(name='Ham', price='$3.45'), dict(name='Eggs', price='$1.75')])))
page.save()
