...
class PageAttributeUnassign(BaseMutation):
    ...
    class Arguments:
        page_type_id = graphene.ID(required=True, description='ID of the page type from which the attributes should be unassign.')
        attribute_ids = NonNullList(graphene.ID, required=True, description='The IDs of the attributes to unassign.')
