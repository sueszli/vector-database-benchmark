...
from tests.testing_utils import start_persistent_process, read_until, kill_process, run_command, method_to_stack_name
...
REGULAR_STACK_FUNCTION_LIST = ['ApiGwFunction', 'SfnFunction']
REGULAR_STACK_APIGW_LIST = ['HelloWorldServerlessApi']
REGULAR_STACK_SFN_LIST = ['MyStateMachine']
...
NESTED_STACK_FUNCTION_LIST = ['ApiGwFunction', 'SfnFunction', 'ChildStack/ApiGwFunction', 'ChildStack/SfnFunction', 'ChildStack/GrandChildStack/ApiGwFunction', 'ChildStack/GrandChildStack/SfnFunction']
NESTED_STACK_APIGW_LIST = ['HelloWorldServerlessApi', 'ChildStack/HelloWorldServerlessApi', 'ChildStack/GrandChildStack/HelloWorldServerlessApi']
NESTED_STACK_SFN_LIST = ['MyStateMachine', 'ChildStack/MyStateMachine', 'ChildStack/GrandChildStack/MyStateMachine']
