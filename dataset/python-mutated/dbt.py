...
from airflow.providers.dbt.cloud.hooks.dbt import DbtCloudHook, DbtCloudJobRunException, DbtCloudJobRunStatus, JobRunInfo
...
class DbtCloudRunJobOperator(BaseOperator):
    ...
    """
    template_fields = ('dbt_cloud_conn_id', 'job_id', 'account_id', 'trigger_reason', 'steps_override', 'schema_override', 'additional_run_config')
...
class DbtCloudListJobsOperator(BaseOperator):
    ...
    """
    template_fields = ('account_id', 'project_id')
