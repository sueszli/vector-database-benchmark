...
class WorkItemConfigurationsOperations:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, work_item_configuration_properties: _models.WorkItemCreateConfiguration, *, content_type: str='application/json', **kwargs: Any) -> _models.WorkItemConfiguration:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, work_item_configuration_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.WorkItemConfiguration:
        """Create a work item configuration for an Application Insights component.
    ...
    async def create(self, resource_group_name: str, resource_name: str, work_item_configuration_properties: Union[_models.WorkItemCreateConfiguration, IO], **kwargs: Any) -> _models.WorkItemConfiguration:
        """Create a work item configuration for an Application Insights component.
    ...
    @distributed_trace_async
    async def get_default(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.WorkItemConfiguration:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[_models.WorkItemConfiguration] = kwargs.pop('cls', None)
        request = build_get_default_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_default.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, resource_name: str, work_item_config_id: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, resource_name=resource_name, work_item_config_id=work_item_config_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_item(self, resource_group_name: str, resource_name: str, work_item_config_id: str, **kwargs: Any) -> _models.WorkItemConfiguration:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[_models.WorkItemConfiguration] = kwargs.pop('cls', None)
        request = build_get_item_request(resource_group_name=resource_group_name, resource_name=resource_name, work_item_config_id=work_item_config_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_item.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_item(self, resource_group_name: str, resource_name: str, work_item_config_id: str, work_item_configuration_properties: _models.WorkItemCreateConfiguration, *, content_type: str='application/json', **kwargs: Any) -> _models.WorkItemConfiguration:
    ...
    @overload
    async def update_item(self, resource_group_name: str, resource_name: str, work_item_config_id: str, work_item_configuration_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.WorkItemConfiguration:
        """Update a work item configuration for an Application Insights component.
    ...
    @distributed_trace_async
    async def update_item(self, resource_group_name: str, resource_name: str, work_item_config_id: str, work_item_configuration_properties: Union[_models.WorkItemCreateConfiguration, IO], **kwargs: Any) -> _models.WorkItemConfiguration:
        """Update a work item configuration for an Application Insights component.
        ...
        if isinstance(work_item_configuration_properties, (IO, bytes)):
            ...
            _json = self._serialize.body(work_item_configuration_properties, 'WorkItemCreateConfiguration')
        request = build_update_item_request(resource_group_name=resource_group_name, resource_name=resource_name, work_item_config_id=work_item_config_id, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_item.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
