...
from celery.exceptions import CPendingDeprecationWarning, InvalidTaskError, NotRegistered, WorkerShutdown, WorkerTerminate
...
CONNECTION_RETRY = 'consumer: Connection to broker lost. Trying to re-establish the connection...'
CONNECTION_RETRY_STEP = 'Trying again {when}... ({retries}/{max_retries})'
CONNECTION_ERROR = 'consumer: Cannot connect to %s: %s.\n%s\n'
CONNECTION_FAILOVER = 'Will retry using next failover.'
UNKNOWN_FORMAT = 'Received and deleted unknown message.  Wrong destination?!?\n\nThe full contents of the message body was: %s\n'
UNKNOWN_TASK_ERROR = "Received unregistered task of type %s.\nThe message has been ignored and discarded.\n\nDid you remember to import the module containing this task?\nOr maybe you're using relative imports?\n\nPlease see\nhttps://docs.celeryq.dev/en/latest/internals/protocol.html\nfor more information.\n\nThe full contents of the message body was:\n%s\n\nThe full contents of the message headers:\n%s\n\nThe delivery info for this task is:\n%s\n"
INVALID_TASK_ERROR = 'Received invalid task message: %s\nThe message has been ignored and discarded.\n\nPlease ensure your message conforms to the task\nmessage protocol as described here:\nhttps://docs.celeryq.dev/en/latest/internals/protocol.html\n\nThe full contents of the message body was:\n%s\n'
MESSAGE_DECODE_ERROR = "Can't decode message body: %r [type:%r encoding:%r headers:%s]\n\nbody: %s\n"
MESSAGE_REPORT = 'body: {0}\n{{content_type:{1} content_encoding:{2}\n  delivery_info:{3} headers={4}}}\n'
TERMINATING_TASK_ON_RESTART_AFTER_A_CONNECTION_LOSS = 'Task %s cannot be acknowledged after a connection loss since late acknowledgement is enabled for it.\nTerminating it instead.\n'
