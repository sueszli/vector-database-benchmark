...
class OldLearnerDashboardRedirectPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerDashboardPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerDashboardTopicsAndStoriesProgressHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerCompletedChaptersCountHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerDashboardCollectionsProgressHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerDashboardExplorationsProgressHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class LearnerDashboardIdsHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
