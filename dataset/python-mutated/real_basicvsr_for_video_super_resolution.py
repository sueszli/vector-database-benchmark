...
from modelscope.models.cv.video_super_resolution.real_basicvsr_net import RealBasicVSRNet
...
@MODELS.register_module(Tasks.video_super_resolution, module_name=Models.real_basicvsr)
