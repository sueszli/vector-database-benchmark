...
def h2o_H2OFrame_scale():
    ...
    assert abs(frameMean[0, 0]) < 0.001 and abs(frameMean[0, 1]) < 0.001, 'h2o.H2OFrame.scale() command is not working.'
    assert abs(framesd[0] - 1) < 0.001 and abs(framesd[1] - 1) < 0.001, 'h2o.H2OFrame.scale() command is not working.'
