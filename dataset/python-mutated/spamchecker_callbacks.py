import inspect
import logging
from typing import TYPE_CHECKING, Any, Awaitable, Callable, Collection, List, Optional, Tuple, Union
...
CHECK_EVENT_FOR_SPAM_CALLBACK = Callable[['synapse.events.EventBase'], Awaitable[Union[str, Codes, Tuple[Codes, JsonDict], bool]]]
SHOULD_DROP_FEDERATED_EVENT_CALLBACK = Callable[['synapse.events.EventBase'], Awaitable[Union[bool, str]]]
USER_MAY_JOIN_ROOM_CALLBACK = Callable[[str, str, bool], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
USER_MAY_INVITE_CALLBACK = Callable[[str, str, str], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
USER_MAY_SEND_3PID_INVITE_CALLBACK = Callable[[str, str, str, str], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
USER_MAY_CREATE_ROOM_CALLBACK = Callable[[str], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
USER_MAY_CREATE_ROOM_ALIAS_CALLBACK = Callable[[str, RoomAlias], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
USER_MAY_PUBLISH_ROOM_CALLBACK = Callable[[str, str], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
CHECK_USERNAME_FOR_SPAM_CALLBACK = Callable[[UserProfile], Awaitable[bool]]
LEGACY_CHECK_REGISTRATION_FOR_SPAM_CALLBACK = Callable[[Optional[dict], Optional[str], Collection[Tuple[str, str]]], Awaitable[RegistrationBehaviour]]
CHECK_REGISTRATION_FOR_SPAM_CALLBACK = Callable[[Optional[dict], Optional[str], Collection[Tuple[str, str]], Optional[str]], Awaitable[RegistrationBehaviour]]
CHECK_MEDIA_FILE_FOR_SPAM_CALLBACK = Callable[[ReadableFileWrapper, FileInfo], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict], bool]]]
CHECK_LOGIN_FOR_SPAM_CALLBACK = Callable[[str, Optional[str], Optional[str], Collection[Tuple[Optional[str], str]], Optional[str]], Awaitable[Union[Literal['NOT_SPAM'], Codes, Tuple[Codes, JsonDict]]]]
...
class SpamCheckerModuleApiCallbacks:
    ...
    @trace
    async def check_event_for_spam(self, event: 'synapse.events.EventBase') -> Union[Tuple[Codes, JsonDict], str]:
        ...
        for callback in self._check_event_for_spam_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is False or res == self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting message as spam')
    ...
    async def should_drop_federated_event(self, event: 'synapse.events.EventBase') -> Union[bool, str]:
    ...
    async def user_may_join_room(self, user_id: str, room_id: str, is_invited: bool) -> Union[Tuple[Codes, JsonDict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_join_room_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is True or res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting join as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def user_may_invite(self, inviter_userid: str, invitee_userid: str, room_id: str) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_invite_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                res = await delay_cancellation(callback(inviter_userid, invitee_userid, room_id))
                if res is True or res is self.NOT_SPAM:
                    continue
                elif res is False:
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
                    ...
                    logger.warning('Module returned invalid value, rejecting invite as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def user_may_send_3pid_invite(self, inviter_userid: str, medium: str, address: str, room_id: str) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_send_3pid_invite_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                res = await delay_cancellation(callback(inviter_userid, medium, address, room_id))
                if res is True or res is self.NOT_SPAM:
                    continue
                elif res is False:
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
                    ...
                    logger.warning('Module returned invalid value, rejecting 3pid invite as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def user_may_create_room(self, userid: str) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_create_room_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is True or res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting room creation as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def user_may_create_room_alias(self, userid: str, room_alias: RoomAlias) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_create_room_alias_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is True or res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting room create as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def user_may_publish_room(self, userid: str, room_id: str) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._user_may_publish_room_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is True or res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting room publication as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM
    ...
    async def check_registration_for_spam(self, email_threepid: Optional[dict], username: Optional[str], request_info: Collection[Tuple[str, str]], auth_provider_id: Optional[str]=None) -> RegistrationBehaviour:
        ...
        for callback in self._check_registration_for_spam_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                behaviour = await delay_cancellation(callback(email_threepid, username, request_info, auth_provider_id))
    ...
    @trace
    async def check_media_file_for_spam(self, file_wrapper: ReadableFileWrapper, file_info: FileInfo) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        ...
        for callback in self._check_media_file_for_spam_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                ...
                if res is False or res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting media file as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM

    async def check_login_for_spam(self, user_id: str, device_id: Optional[str], initial_display_name: Optional[str], request_info: Collection[Tuple[Optional[str], str]], auth_provider_id: Optional[str]=None) -> Union[Tuple[Codes, dict], Literal['NOT_SPAM']]:
        """Checks if we should allow the given registration request.
        ...
        for callback in self._check_login_for_spam_callbacks:
            with Measure(self.clock, f'{callback.__module__}.{callback.__qualname__}'):
                res = await delay_cancellation(callback(user_id, device_id, initial_display_name, request_info, auth_provider_id))
                if res is self.NOT_SPAM:
                    ...
                    logger.warning('Module returned invalid value, rejecting login as spam')
                    return (synapse.api.errors.Codes.FORBIDDEN, {})
        return self.NOT_SPAM