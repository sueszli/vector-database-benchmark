...
class DatabaseAccountListKeysResult(Model):
    ...
    """
    _validation = {'primary_master_key': {'readonly': True}, 'secondary_master_key': {'readonly': True}, 'primary_readonly_master_key': {'readonly': True}, 'secondary_readonly_master_key': {'readonly': True}}
    _attribute_map = {'primary_master_key': {'key': 'primaryMasterKey', 'type': 'str'}, 'secondary_master_key': {'key': 'secondaryMasterKey', 'type': 'str'}, 'primary_readonly_master_key': {'key': 'properties.primaryReadonlyMasterKey', 'type': 'str'}, 'secondary_readonly_master_key': {'key': 'properties.secondaryReadonlyMasterKey', 'type': 'str'}}
