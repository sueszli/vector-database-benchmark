...
class RecoverySpider(Spider):
    name = 'RecoverySpider'
    custom_settings = {'SPIDER_MIDDLEWARES_BASE': {}, 'SPIDER_MIDDLEWARES': {RecoveryMiddleware: 10}}
...
class ProcessSpiderInputSpiderWithoutErrback(Spider):
    ...
    custom_settings = {'SPIDER_MIDDLEWARES': {FailProcessSpiderInputMiddleware: 8, LogExceptionMiddleware: 6}}
...
class GeneratorCallbackSpider(Spider):
    ...
    custom_settings = {'SPIDER_MIDDLEWARES': {LogExceptionMiddleware: 10}}
...
class GeneratorCallbackSpiderMiddlewareRightAfterSpider(GeneratorCallbackSpider):
    ...
    custom_settings = {'SPIDER_MIDDLEWARES': {LogExceptionMiddleware: 100000}}
...
class GeneratorOutputChainSpider(Spider):
    ...
    custom_settings = {'SPIDER_MIDDLEWARES': {GeneratorFailMiddleware: 10, GeneratorDoNothingAfterFailureMiddleware: 8, GeneratorRecoverMiddleware: 5, GeneratorDoNothingAfterRecoveryMiddleware: 3}}
...
class NotGeneratorOutputChainSpider(Spider):
    ...
    custom_settings = {'SPIDER_MIDDLEWARES': {NotGeneratorFailMiddleware: 10, NotGeneratorDoNothingAfterFailureMiddleware: 8, NotGeneratorRecoverMiddleware: 5, NotGeneratorDoNothingAfterRecoveryMiddleware: 3}}
