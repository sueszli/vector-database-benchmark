...
class TestJobs:
    ...
    def test_method_create(self, client: OpenAI) -> None:
        if False:
            return 10
        job = client.fine_tuning.jobs.create(model='gpt-3.5-turbo', training_file='file-abc123')
    ...
    def test_method_create_with_all_params(self, client: OpenAI) -> None:
        if False:
            for i in range(10):
                print('nop')
        job = client.fine_tuning.jobs.create(model='gpt-3.5-turbo', training_file='file-abc123', hyperparameters={'batch_size': 'auto', 'learning_rate_multiplier': 'auto', 'n_epochs': 'auto'}, suffix='x', validation_file='file-abc123')
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    def test_raw_response_create(self, client: OpenAI) -> None:
        if False:
            for i in range(10):
                print('nop')
        response = client.fine_tuning.jobs.with_raw_response.create(model='gpt-3.5-turbo', training_file='file-abc123')
    ...
    def test_raw_response_retrieve(self, client: OpenAI) -> None:
        if False:
            i = 10
            return i + 15
        response = client.fine_tuning.jobs.with_raw_response.retrieve('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    def test_method_list_with_all_params(self, client: OpenAI) -> None:
        if False:
            i = 10
            return i + 15
        job = client.fine_tuning.jobs.list(after='string', limit=0)
        assert_matches_type(SyncCursorPage[FineTuningJob], job, path=['response'])
    ...
    def test_raw_response_cancel(self, client: OpenAI) -> None:
        if False:
            print('Hello World!')
        response = client.fine_tuning.jobs.with_raw_response.cancel('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    def test_method_list_events(self, client: OpenAI) -> None:
        if False:
            i = 10
            return i + 15
        job = client.fine_tuning.jobs.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
    ...
    def test_method_list_events_with_all_params(self, client: OpenAI) -> None:
        if False:
            return 10
        job = client.fine_tuning.jobs.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F', after='string', limit=0)
        assert_matches_type(SyncCursorPage[FineTuningJobEvent], job, path=['response'])
    ...
    def test_raw_response_list_events(self, client: OpenAI) -> None:
        if False:
            return 10
        response = client.fine_tuning.jobs.with_raw_response.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(SyncCursorPage[FineTuningJobEvent], job, path=['response'])
...
class TestAsyncJobs:
    ...
    async def test_method_create(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.create(model='gpt-3.5-turbo', training_file='file-abc123')
        assert_matches_type(FineTuningJob, job, path=['response'])

    @parametrize
    async def test_method_create_with_all_params(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.create(model='gpt-3.5-turbo', training_file='file-abc123', hyperparameters={'batch_size': 'auto', 'learning_rate_multiplier': 'auto', 'n_epochs': 'auto'}, suffix='x', validation_file='file-abc123')
        assert_matches_type(FineTuningJob, job, path=['response'])

    @parametrize
    async def test_raw_response_create(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tuning.jobs.with_raw_response.create(model='gpt-3.5-turbo', training_file='file-abc123')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    async def test_method_retrieve(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.retrieve('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert_matches_type(FineTuningJob, job, path=['response'])

    @parametrize
    async def test_raw_response_retrieve(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tuning.jobs.with_raw_response.retrieve('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    async def test_method_list_with_all_params(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.list(after='string', limit=0)
        assert_matches_type(AsyncCursorPage[FineTuningJob], job, path=['response'])
    ...
    async def test_method_cancel(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.cancel('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert_matches_type(FineTuningJob, job, path=['response'])

    @parametrize
    async def test_raw_response_cancel(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tuning.jobs.with_raw_response.cancel('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(FineTuningJob, job, path=['response'])
    ...
    async def test_method_list_events(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
    ...
    async def test_method_list_events_with_all_params(self, client: AsyncOpenAI) -> None:
        job = await client.fine_tuning.jobs.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F', after='string', limit=0)
        assert_matches_type(AsyncCursorPage[FineTuningJobEvent], job, path=['response'])

    @parametrize
    async def test_raw_response_list_events(self, client: AsyncOpenAI) -> None:
        response = await client.fine_tuning.jobs.with_raw_response.list_events('ft-AF1WoRqd3aJAHsqc9NY7iL8F')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        job = response.parse()
        assert_matches_type(AsyncCursorPage[FineTuningJobEvent], job, path=['response'])