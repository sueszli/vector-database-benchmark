...
DISCORD = 'C:\\Users\\mike\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Discord Inc\\Discord.lnk'
VIEW_ISSUES_URL = 'https://github.com/MikeTheWatchGuy/PySimpleGUI/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc'
PULL_REQUEST_URL = 'https://github.com/MikeTheWatchGuy/PySimpleGUI/compare/master...Dev-latest'
ANNOUCEMENTS = 'https://github.com/MikeTheWatchGuy/PySimpleGUI/issues/142'
TRAFFIC = 'https://github.com/MikeTheWatchGuy/PySimpleGUI/graphs/traffic'
SEARCH = 'https://github.com/search?o=desc&q=pysimplegui&s=indexed&type=Code'
PYPI_STATS = 'https://pepy.tech/project/pysimplegui'
ICON_FILE = 'C:\\Python\\PycharmProjects\\GooeyGUI\\default_icon.ico'
