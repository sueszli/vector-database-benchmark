...
class WorkflowTemplate(proto.Message):
    ...
    version: int = proto.Field(proto.INT32, number=3)
    ...
    placement: 'WorkflowTemplatePlacement' = proto.Field(proto.MESSAGE, number=7, message='WorkflowTemplatePlacement')
    jobs: MutableSequence['OrderedJob'] = proto.RepeatedField(proto.MESSAGE, number=8, message='OrderedJob')
    parameters: MutableSequence['TemplateParameter'] = proto.RepeatedField(proto.MESSAGE, number=9, message='TemplateParameter')
    dag_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=10, message=duration_pb2.Duration)
...
class WorkflowTemplatePlacement(proto.Message):
    ...
    Attributes:
        ...
        cluster_selector (google.cloud.dataproc_v1.types.ClusterSelector):
            ...
            This field is a member of `oneof`_ ``placement``.
    """
    managed_cluster: 'ManagedCluster' = proto.Field(proto.MESSAGE, number=1, oneof='placement', message='ManagedCluster')
    cluster_selector: 'ClusterSelector' = proto.Field(proto.MESSAGE, number=2, oneof='placement', message='ClusterSelector')
...
class ManagedCluster(proto.Message):
    ...
    Attributes:
        ...
        labels (MutableMapping[str, str]):
            ...
            cluster.
    """
    cluster_name: str = proto.Field(proto.STRING, number=2)
    config: clusters.ClusterConfig = proto.Field(proto.MESSAGE, number=3, message=clusters.ClusterConfig)
...
class ClusterSelector(proto.Message):
    ...
    """
    zone: str = proto.Field(proto.STRING, number=1)
    cluster_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
...
class OrderedJob(proto.Message):
    ...
    Attributes:
        ...
        prerequisite_step_ids (MutableSequence[str]):
            ...
            workflow.
    """
    step_id: str = proto.Field(proto.STRING, number=1)
    hadoop_job: gcd_jobs.HadoopJob = proto.Field(proto.MESSAGE, number=2, oneof='job_type', message=gcd_jobs.HadoopJob)
    spark_job: gcd_jobs.SparkJob = proto.Field(proto.MESSAGE, number=3, oneof='job_type', message=gcd_jobs.SparkJob)
    pyspark_job: gcd_jobs.PySparkJob = proto.Field(proto.MESSAGE, number=4, oneof='job_type', message=gcd_jobs.PySparkJob)
    hive_job: gcd_jobs.HiveJob = proto.Field(proto.MESSAGE, number=5, oneof='job_type', message=gcd_jobs.HiveJob)
    pig_job: gcd_jobs.PigJob = proto.Field(proto.MESSAGE, number=6, oneof='job_type', message=gcd_jobs.PigJob)
    spark_r_job: gcd_jobs.SparkRJob = proto.Field(proto.MESSAGE, number=11, oneof='job_type', message=gcd_jobs.SparkRJob)
    spark_sql_job: gcd_jobs.SparkSqlJob = proto.Field(proto.MESSAGE, number=7, oneof='job_type', message=gcd_jobs.SparkSqlJob)
    presto_job: gcd_jobs.PrestoJob = proto.Field(proto.MESSAGE, number=12, oneof='job_type', message=gcd_jobs.PrestoJob)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=8)
    scheduling: gcd_jobs.JobScheduling = proto.Field(proto.MESSAGE, number=9, message=gcd_jobs.JobScheduling)
    prerequisite_step_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=10)

class TemplateParameter(proto.Message):
    """A configurable parameter that replaces one or more fields in
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    fields: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    validation: 'ParameterValidation' = proto.Field(proto.MESSAGE, number=4, message='ParameterValidation')
...
class ParameterValidation(proto.Message):
    ...
    Attributes:
        ...
        values (google.cloud.dataproc_v1.types.ValueValidation):
            ...
            This field is a member of `oneof`_ ``validation_type``.
    """
    regex: 'RegexValidation' = proto.Field(proto.MESSAGE, number=1, oneof='validation_type', message='RegexValidation')
    values: 'ValueValidation' = proto.Field(proto.MESSAGE, number=2, oneof='validation_type', message='ValueValidation')
...
class RegexValidation(proto.Message):
    ...
    """
    regexes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class ValueValidation(proto.Message):
    ...
    Attributes:
        values (MutableSequence[str]):
            ...
            parameter.
    """
    values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class WorkflowMetadata(proto.Message):
    ...
    class State(proto.Enum):
        ...
        RUNNING = 2
        DONE = 3
    template: str = proto.Field(proto.STRING, number=1)
    version: int = proto.Field(proto.INT32, number=2)
    create_cluster: 'ClusterOperation' = proto.Field(proto.MESSAGE, number=3, message='ClusterOperation')
    graph: 'WorkflowGraph' = proto.Field(proto.MESSAGE, number=4, message='WorkflowGraph')
    delete_cluster: 'ClusterOperation' = proto.Field(proto.MESSAGE, number=5, message='ClusterOperation')
    state: State = proto.Field(proto.ENUM, number=6, enum=State)
    cluster_name: str = proto.Field(proto.STRING, number=7)
    parameters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=8)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
    cluster_uuid: str = proto.Field(proto.STRING, number=11)
    dag_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=12, message=duration_pb2.Duration)
    dag_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=13, message=timestamp_pb2.Timestamp)
    dag_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=14, message=timestamp_pb2.Timestamp)
...
class ClusterOperation(proto.Message):
    ...
    """
    operation_id: str = proto.Field(proto.STRING, number=1)
    error: str = proto.Field(proto.STRING, number=2)
    done: bool = proto.Field(proto.BOOL, number=3)
...
class WorkflowGraph(proto.Message):
    ...
    """
    nodes: MutableSequence['WorkflowNode'] = proto.RepeatedField(proto.MESSAGE, number=1, message='WorkflowNode')
...
class WorkflowNode(proto.Message):
    ...
    class NodeState(proto.Enum):
        ...
        FAILED = 5
    step_id: str = proto.Field(proto.STRING, number=1)
    prerequisite_step_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    job_id: str = proto.Field(proto.STRING, number=3)
    state: NodeState = proto.Field(proto.ENUM, number=5, enum=NodeState)
    error: str = proto.Field(proto.STRING, number=6)
...
class CreateWorkflowTemplateRequest(proto.Message):
    ...
    template: 'WorkflowTemplate' = proto.Field(proto.MESSAGE, number=2, message='WorkflowTemplate')
...
class InstantiateWorkflowTemplateRequest(proto.Message):
    ...
    name: str = proto.Field(proto.STRING, number=1)
    version: int = proto.Field(proto.INT32, number=2)
    request_id: str = proto.Field(proto.STRING, number=5)
    parameters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
...
class UpdateWorkflowTemplateRequest(proto.Message):
    ...
    Attributes:
        template (google.cloud.dataproc_v1.types.WorkflowTemplate):
            ...
            version.
    """
    template: 'WorkflowTemplate' = proto.Field(proto.MESSAGE, number=1, message='WorkflowTemplate')
...
class ListWorkflowTemplatesResponse(proto.Message):
    """A response to a request to list workflow templates in a
    project.
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    templates: MutableSequence['WorkflowTemplate'] = proto.RepeatedField(proto.MESSAGE, number=1, message='WorkflowTemplate')
