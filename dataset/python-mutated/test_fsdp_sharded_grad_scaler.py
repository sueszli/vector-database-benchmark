...
from torch.testing._internal.common_fsdp import CUDAInitMode, DummyProcessGroup, FSDPInitMode, FSDPTest, NestedWrappedModule, NonUniformReqGradNWM, subtest_name
...
test_name_mapping = {str(CPUOffload(offload_params=True)): 'offload_true', str(CPUOffload(offload_params=False)): 'offload_false', str(ShardingStrategy.SHARD_GRAD_OP): 'shard_grad_op', 'enable_mixed_precision': 'mixed_precision', 'enable_use_orig_params': 'use_orig_params'}
