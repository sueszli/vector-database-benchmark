...
from scapy.fields import BitEnumField, BitField, ByteEnumField, ByteField, ConditionalField, IPField, IntField, MultipleTypeField, PacketField, PacketListField, ShortEnumField, ShortField, StrFixedLenField, StrLenField, ThreeBytesField, XBitField, XIntField, XShortField
from scapy.layers.inet6 import IP6Field
from scapy.packet import bind_layers, Packet, Raw
from scapy.volatile import RandIP, RandShort
from scapy.contrib import gtp
RATType = {1: 'UTRAN', 2: 'GERAN', 3: 'WLAN', 4: 'GAN', 5: 'HSPA Evolution', 6: 'EUTRAN', 7: 'Virtual', 8: 'EUTRAN-NB-IoT', 9: 'LTE-M', 10: 'NR'}
GTPmessageType = {1: 'echo_request', 2: 'echo_response', 3: 'version_not_supported', 32: 'create_session_req', 33: 'create_session_res', 36: 'delete_session_req', 37: 'delete_session_res', 34: 'modify_bearer_req', 35: 'modify_bearer_res', 40: 'remote_ue_report_notif', 41: 'remote_ue_report_ack', 38: 'change_notif_req', 39: 'change_notif_res', 164: 'resume_notif', 165: 'resume_ack', 64: 'modify_bearer_cmd', 65: 'modify_bearer_failure_indic', 66: 'delete_bearer_cmd', 67: 'delete_bearer_failure_indic', 68: 'bearer_resource_cmd', 69: 'bearer_resource_failure_indic', 70: 'downlink_data_notif_failure_indic', 71: 'trace_session_activation', 72: 'trace_session_deactivation', 73: 'stop_paging_indic', 95: 'create_bearer_req', 96: 'create_bearer_res', 97: 'update_bearer_req', 98: 'update_bearer_res', 99: 'delete_bearer_req', 100: 'delete_bearer_res', 101: 'delete_pdn_connection_set_req', 102: 'delete_pdn_connection_set_res', 103: 'pgw_downlink_triggering_notif', 104: 'pgw_downlink_triggering_ack', 128: 'identification_req', 129: 'identification_res', 130: 'context_req', 131: 'context_res', 132: 'context_ack', 133: 'forward_relocation_req', 134: 'forward_relocation_res', 135: 'forward_relocation_complete_notif', 136: 'forward_relocation_complete_ack', 137: 'forward_access_context_notif', 138: 'forward_access_context_ack', 139: 'relocation_cancel_req', 140: 'relocation_cancel_res', 141: 'configuration_transfer_tunnel', 152: 'ran_information_relay', 149: 'detach_notif', 150: 'detach_ack', 151: 'cs_paging_indic', 153: 'alert_mme_notif', 154: 'alert_mme_ack', 155: 'ue_activity_notif', 156: 'ue_activity_ack', 157: 'isr_status_indic', 158: 'ue_registration_query_req', 159: 'ue_registration_query_res', 162: 'suspend_notif', 163: 'suspend_ack', 160: 'create_forwarding_tunnel_req', 161: 'create_forwarding_tunnel_res', 166: 'create_indirect_data_forwarding_tunnel_req', 167: 'create_indirect_data_forwarding_tunnel_res', 168: 'delete_indirect_data_forwarding_tunnel_req', 169: 'delete_indirect_data_forwarding_tunnel_res', 170: 'realease_bearers_req', 171: 'realease_bearers_res', 176: 'downlink_data_notif', 177: 'downlink_data_notif_ack', 179: 'pgw_restart_notif', 180: 'pgw_restart_notif_ack', 200: 'update_pdn_connection_set_req', 201: 'update_pdn_connection_set_res', 211: 'modify_access_bearers_req', 212: 'modify_access_bearers_res', 231: 'mbms_session_start_req', 232: 'mbms_session_start_res', 233: 'mbms_session_update_req', 234: 'mbms_session_update_res', 235: 'mbms_session_stop_req', 236: 'mbms_session_stop_res'}
IEType = {1: 'IMSI', 2: 'Cause', 3: 'Recovery Restart', 71: 'APN', 72: 'AMBR', 73: 'EPS Bearer ID', 74: 'IP Address', 75: 'MEI', 76: 'MSISDN', 77: 'Indication', 78: 'Protocol Configuration Options', 79: 'PAA', 80: 'Bearer QoS', 82: 'RAT', 83: 'Serving Network', 84: 'Bearer TFT', 86: 'ULI', 87: 'F-TEID', 93: 'Bearer Context', 94: 'Charging ID', 95: 'Charging Characteristics', 97: 'Bearer Flags', 99: 'PDN Type', 107: 'MM Context (EPS Security Context and Quadruplets)', 109: 'PDN Connection', 114: 'UE Time zone', 126: 'Port Number', 127: 'APN Restriction', 128: 'Selection Mode', 132: 'FQ-CSID', 136: 'FQDN', 145: 'UCI', 161: 'Max MBR/APN-AMBR (MMBR)', 163: 'Additional Protocol Configuration Options', 170: 'ULI Timestamp', 172: 'RAN/NAS Cause', 197: 'Extended Protocol Configuration Options', 202: 'UP Function Selection Indication Flags', 255: 'Private Extension'}

class GTPHeader(gtp.GTPHeader):
    name = 'GTP v2 Header'
    fields_desc = [BitField('version', 2, 3), BitField('P', 1, 1), BitField('T', 1, 1), BitField('MP', 0, 1), BitField('SPARE1', 0, 1), BitField('SPARE2', 0, 1), ByteEnumField('gtp_type', None, GTPmessageType), ShortField('length', None), ConditionalField(XIntField('teid', 0), lambda pkt: pkt.T == 1), ThreeBytesField('seq', RandShort()), ConditionalField(BitField('msg_priority', 0, 4), lambda pkt: pkt.MP == 1), ConditionalField(MultipleTypeField([(BitField('SPARE3', 0, 4), lambda pkt: pkt.MP == 1)], ByteField('SPARE3', 0)), lambda pkt: pkt.MP in [0, 1])]

class IE_IP_Address(gtp.IE_Base):
    name = 'IE IP Address'
    fields_desc = [ByteEnumField('ietype', 74, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), ConditionalField(IPField('address', RandIP()), lambda pkt: pkt.length == 4), ConditionalField(IP6Field('address6', None), lambda pkt: pkt.length == 16)]
...
INTERFACE_TYPES = {0: 'S1-U eNodeB GTP-U interface', 1: 'S1-U SGW GTP-U interface', 2: 'S12 RNC GTP-U interface', 3: 'S12 SGW GTP-U interface', 4: 'S5/S8 SGW GTP-U interface', 5: 'S5/S8 PGW GTP-U interface', 6: 'S5/S8 SGW GTP-C interface', 7: 'S5/S8 PGW GTP-C interface', 8: 'S5/S8 SGW PMIPv6 interface', 9: 'S5/S8 PGW PMIPv6 interface', 10: 'S11 MME GTP-C interface', 11: 'S11/S4 SGW GTP-C interface', 12: 'S10 MME GTP-C interface', 13: 'S3 MME GTP-C interface', 14: 'S3 SGSN GTP-C interface', 15: 'S4 SGSN GTP-U interface', 16: 'S4 SGW GTP-U interface', 17: 'S4 SGSN GTP-C interface', 18: 'S16 SGSN GTP-C interface', 19: 'eNodeB GTP-U interface for DL data forwarding', 20: 'eNodeB GTP-U interface for UL data forwarding', 21: 'RNC GTP-U interface for data forwarding', 22: 'SGSN GTP-U interface for data forwarding', 23: 'SGW GTP-U interface for DL data forwarding', 24: 'Sm MBMS GW GTP-C interface', 25: 'Sn MBMS GW GTP-C interface', 26: 'Sm MME GTP-C interface', 27: 'Sn SGSN GTP-C interface', 28: 'SGW GTP-U interface for UL data forwarding', 29: 'Sn SGSN GTP-U interface', 30: 'S2b ePDG GTP-C interface', 31: 'S2b-U ePDG GTP-U interface', 32: 'S2b PGW GTP-C interface', 33: 'S2b-U PGW GTP-U interface', 34: 'S2a TWAN GTP-U interface', 35: 'S2a TWAN GTP-C interface', 36: 'S2a PGW GTP-C interface', 37: 'S2a PGW GTP-U interface'}

class IE_UCI(gtp.IE_Base):
    name = 'IE UCI'
    fields_desc = [ByteEnumField('ietype', 145, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), gtp.TBCDByteField('MCC', '', 2), gtp.TBCDByteField('MNC', '', 1), BitField('SPARE1', 0, 5), BitField('CSG_ID', 0, 27), BitField('AccessMode', 0, 2), BitField('SPARE2', 0, 4), BitField('LCSG', 0, 1), BitField('CMI', 0, 1)]
...
class IE_BearerFlags(gtp.IE_Base):
    ...
    fields_desc = [ByteEnumField('ietype', 97, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('SPARE', 0, 4), BitField('ASI', 0, 1), BitField('Vind', 0, 1), BitField('VB', 0, 1), BitField('PPC', 0, 1)]

class IE_MMContext_EPS(gtp.IE_Base):
    name = 'IE MM Context (EPS Security Context and Quadruplets)'
    fields_desc = [ByteEnumField('ietype', 107, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('Sec_Mode', 0, 3), BitField('Nhi', 0, 1), BitField('Drxi', 0, 1), BitField('Ksi', 0, 3), BitField('Num_quint', 0, 3), BitField('Num_Quad', 0, 3), BitField('Uambri', 0, 1), BitField('Osci', 0, 1), BitField('Sambri', 0, 1), BitField('Nas_algo', 0, 3), BitField('Nas_cipher', 0, 4), ThreeBytesField('Nas_dl_count', 0), ThreeBytesField('Nas_ul_count', 0), BitField('Kasme', 0, 256), ConditionalField(StrLenField('fields', '', length_from=lambda x: x.length - 41), lambda pkt: pkt.length > 40)]
...
class PCO_Secondary_NBNS(PCO_Option):
    ...
    fields_desc = [ByteEnumField('type', None, PCO_OPTION_TYPES), ByteField('length', None), IPField('address', RandIP())]
PCO_PROTOCOL_TYPES = {1: 'P-CSCF IPv6 Address Request', 2: 'IM CN Subsystem Signaling Flag', 3: 'DNS Server IPv6 Address Request', 5: 'MS Support of Network Requested Bearer Control indicator', 10: 'IP Allocation via NAS', 13: 'DNS Server IPv4 Address Request', 12: 'P-CSCF IPv4 Address Request', 16: 'IPv4 Link MTU Request', 18: 'P-CSCF Re-selection Support', 26: 'PDU session ID', 34: '5GSM Cause Value', 35: 'QoS Rules With Support Indicator', 36: 'QoS Flow Descriptions With Support Indicator', 27: 'S-NSSAI', 28: 'QoS Rules', 29: 'Session-AMBR', 31: 'QoS Flow Descriptions', 32801: 'IPCP', 49187: 'Password Authentication Protocol', 49699: 'Challenge Handshake Authentication Protocol'}
PCO_OPTION_CLASSES = {3: PCO_IPv4, 129: PCO_Primary_DNS, 130: PCO_Primary_NBNS, 131: PCO_Secondary_DNS, 132: PCO_Secondary_NBNS}
...
class PCO_SOF(PCO_Protocol):
    ...
    fields_desc = [ShortEnumField('type', None, PCO_PROTOCOL_TYPES), ByteField('length', None)]
...
class PCO_PPP_Auth(PCO_Protocol):
    ...
    fields_desc = [ByteField('Code', 0), ByteField('Identifier', 0), ShortField('length', None), ByteField('PeerID_length', 0), ConditionalField(StrFixedLenField('PeerID', '', length_from=lambda pkt: pkt.PeerID_length), lambda pkt: pkt.PeerID_length), ByteField('Password_length', 0), ConditionalField(StrFixedLenField('Password', '', length_from=lambda pkt: pkt.Password_length), lambda pkt: pkt.Password_length)]
...
class PCO_PPP_Challenge(PCO_Protocol):
    name = 'PPP Password Authentication Protocol'
    fields_desc = [ByteField('Code', 0), ByteField('Identifier', 0), ShortField('length', None), ByteField('value_size', 0), ConditionalField(StrFixedLenField('value', '', length_from=lambda pkt: pkt.value_size), lambda pkt: pkt.value_size), ConditionalField(StrFixedLenField('name', '', length_from=lambda pkt: pkt.length - pkt.value_size - 5), lambda pkt: pkt.length)]
...
PCO_PROTOCOL_CLASSES = {1: PCO_P_CSCF_IPv6_Address_Request, 2: PCO_IM_CN_Subsystem_Signaling_Flag, 3: PCO_DNS_Server_IPv6, 5: PCO_SOF, 10: PCO_IP_Allocation_via_NAS, 12: PCO_P_CSCF_IPv4_Address_Request, 13: PCO_DNS_Server_IPv4, 16: PCO_IPv4_Link_MTU_Request, 18: PCO_P_CSCF_Re_selection_Support, 26: PCO_PDU_Session_Id, 34: PCO_5GSM_Cause_Value, 35: PCO_QoS_Rules_With_Support_Indicator, 36: PCO_QoS_Flow_Descriptions_With_Support_Indicator, 27: PCO_S_Nssai, 28: PCO_Qos_Rules, 29: PCO_Session_AMBR, 31: PCO_QoS_Flow_Descriptions, 32801: PCO_IPCP, 49187: PCO_PasswordAuthentificationProtocol, 49699: PCO_ChallengeHandshakeAuthenticationProtocol}
...
class IE_PCO(gtp.IE_Base):
    ...
    fields_desc = [ByteEnumField('ietype', 78, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('Extension', 0, 1), BitField('SPARE', 0, 4), BitField('PPP', 0, 3), PacketListField('Protocols', None, PCO_protocol_dispatcher, length_from=lambda pkt: pkt.length - 1)]

class IE_EPCO(gtp.IE_Base):
    name = 'IE Extended Protocol Configuration Options'
    fields_desc = [ByteEnumField('ietype', 197, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('Extension', 0, 1), BitField('SPARE', 0, 4), BitField('PPP', 0, 3), PacketListField('Protocols', None, PCO_protocol_dispatcher, length_from=lambda pkt: pkt.length - 1)]

class IE_APCO(gtp.IE_Base):
    name = 'IE Additional Protocol Configuration Options'
    fields_desc = [ByteEnumField('ietype', 163, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('extension', 0, 1), BitField('SPARE', 0, 4), BitField('PPP', 0, 3), PacketListField('Protocols', None, PCO_protocol_dispatcher, length_from=lambda pkt: pkt.length - 1)]

class IE_PAA(gtp.IE_Base):
    name = 'IE PAA'
    fields_desc = [ByteEnumField('ietype', 79, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('SPARE', 0, 5), BitEnumField('PDN_type', None, 3, PDN_TYPES), ConditionalField(ByteField('ipv6_prefix_length', 8), lambda pkt: pkt.PDN_type in (2, 3)), ConditionalField(XBitField('ipv6', '2001:db8:0:42::', 128), lambda pkt: pkt.PDN_type in (2, 3)), ConditionalField(IPField('ipv4', 0), lambda pkt: pkt.PDN_type in (1, 3))]

class IE_Bearer_QoS(gtp.IE_Base):
    name = 'IE Bearer Quality of Service'
    fields_desc = [ByteEnumField('ietype', 80, IEType), ShortField('length', None), BitField('CR_flag', 0, 4), BitField('instance', 0, 4), BitField('SPARE1', 0, 1), BitField('PCI', 0, 1), BitField('PriorityLevel', 0, 4), BitField('SPARE2', 0, 1), BitField('PVI', 0, 1), ByteField('QCI', 0), BitField('MaxBitRateForUplink', 0, 40), BitField('MaxBitRateForDownlink', 0, 40), BitField('GuaranteedBitRateForUplink', 0, 40), BitField('GuaranteedBitRateForDownlink', 0, 40)]
...
class IE_PrivateExtension(gtp.IE_Base):
    ...
    fields_desc = [ByteEnumField('ietype', 255, IEType), ShortField('length', None), BitField('SPARE', 0, 4), BitField('instance', 0, 4), ShortEnumField('enterprisenum', None, IANA_ENTERPRISE_NUMBERS), StrLenField('proprietaryvalue', '', length_from=lambda x: x.length - 2)]
ietypecls = {1: IE_IMSI, 2: IE_Cause, 3: IE_RecoveryRestart, 71: IE_APN, 72: IE_AMBR, 73: IE_EPSBearerID, 74: IE_IP_Address, 75: IE_MEI, 76: IE_MSISDN, 77: IE_Indication, 78: IE_PCO, 79: IE_PAA, 80: IE_Bearer_QoS, 82: IE_RAT, 83: IE_ServingNetwork, 84: IE_BearerTFT, 86: IE_ULI, 87: IE_FTEID, 93: IE_BearerContext, 94: IE_ChargingID, 95: IE_ChargingCharacteristics, 97: IE_BearerFlags, 99: IE_PDN_type, 107: IE_MMContext_EPS, 109: IE_PDNConnection, 114: IE_UE_Timezone, 126: IE_Port_Number, 127: IE_APN_Restriction, 128: IE_SelectionMode, 132: IE_FQCSID, 136: IE_FQDN, 145: IE_UCI, 161: IE_MMBR, 163: IE_APCO, 170: IE_ULI_Timestamp, 172: IE_Ran_Nas_Cause, 197: IE_EPCO, 202: IE_UPF_SelInd_Flags, 255: IE_PrivateExtension}
