...
def main():
    ...
    response = client.runbook.create_or_update(resource_group_name='rg', automation_account_name='ContoseAutomationAccount', runbook_name='Get-AzureVMTutorial', parameters={'location': 'East US 2', 'name': 'Get-AzureVMTutorial', 'properties': {'description': 'Description of the Runbook', 'logActivityTrace': 1, 'logProgress': True, 'logVerbose': False, 'publishContentLink': {'contentHash': {'algorithm': 'SHA256', 'value': '115775B8FF2BE672D8A946BD0B489918C724DDE15A440373CA54461D53010A80'}, 'uri': 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/101-automation-runbook-getvms/Runbooks/Get-AzureVMTutorial.ps1'}, 'runbookType': 'PowerShellWorkflow'}, 'tags': {'tag01': 'value01', 'tag02': 'value02'}})
    print(response)
