...
from docker_tests.docker_tests_utils import display_dependency_conflict_message, docker_image, run_bash_in_docker, run_python_in_docker
...
class TestPythonPackages:
    ...
    def test_pip_dependencies_conflict(self):
        ...
        try:
            ...
            raise ex
    PACKAGE_IMPORTS = {'amazon': ['boto3', 'botocore', 'watchtower'], 'async': ['gevent', 'eventlet', 'greenlet'], 'azure': ['azure.batch', 'azure.cosmos', 'azure.datalake.store', 'azure.identity', 'azure.keyvault.secrets', 'azure.kusto.data', 'azure.mgmt.containerinstance', 'azure.mgmt.datalake.store', 'azure.mgmt.resource', 'azure.storage'], 'celery': ['celery', 'flower', 'vine'], 'cncf.kubernetes': ['kubernetes', 'cryptography'], 'dask': ['cloudpickle', 'distributed'], 'docker': ['docker'], 'elasticsearch': ['elasticsearch'], 'google': ['OpenSSL', 'googleapiclient', 'google.auth', 'google_auth_httplib2', 'google.cloud.automl', 'google.cloud.bigquery_datatransfer', 'google.cloud.bigtable', 'google.cloud.container', 'google.cloud.datacatalog', 'google.cloud.dataproc', 'google.cloud.dlp', 'google.cloud.kms', 'google.cloud.language', 'google.cloud.logging', 'google.cloud.memcache', 'google.cloud.monitoring', 'google.cloud.oslogin', 'google.cloud.pubsub', 'google.cloud.redis', 'google.cloud.secretmanager', 'google.cloud.spanner', 'google.cloud.speech', 'google.cloud.storage', 'google.cloud.tasks', 'google.cloud.texttospeech', 'google.cloud.translate', 'google.cloud.videointelligence', 'google.cloud.vision'], 'grpc': ['grpc', 'google.auth', 'google_auth_httplib2'], 'hashicorp': ['hvac'], 'ldap': ['ldap'], 'postgres': ['psycopg2'], 'pyodbc': ['pyodbc'], 'redis': ['redis'], 'sendgrid': ['sendgrid'], 'sftp/ssh': ['paramiko', 'sshtunnel'], 'slack': ['slack_sdk'], 'statsd': ['statsd'], 'virtualenv': ['virtualenv']}
