...
UPDATABLE_ROLES = [feconf.ROLE_ID_BLOG_ADMIN, feconf.ROLE_ID_CURRICULUM_ADMIN, feconf.ROLE_ID_COLLECTION_EDITOR, feconf.ROLE_ID_FULL_USER, feconf.ROLE_ID_VOICEOVER_ADMIN, feconf.ROLE_ID_MODERATOR, feconf.ROLE_ID_QUESTION_ADMIN, feconf.ROLE_ID_RELEASE_COORDINATOR, feconf.ROLE_ID_TOPIC_MANAGER, feconf.ROLE_ID_TRANSLATION_ADMIN, feconf.ROLE_ID_QUESTION_COORDINATOR, feconf.ROLE_ID_TRANSLATION_COORDINATOR]
VIEWABLE_ROLES = [feconf.ROLE_ID_BLOG_ADMIN, feconf.ROLE_ID_BLOG_POST_EDITOR, feconf.ROLE_ID_COLLECTION_EDITOR, feconf.ROLE_ID_CURRICULUM_ADMIN, feconf.ROLE_ID_MODERATOR, feconf.ROLE_ID_QUESTION_ADMIN, feconf.ROLE_ID_RELEASE_COORDINATOR, feconf.ROLE_ID_TOPIC_MANAGER, feconf.ROLE_ID_TRANSLATION_ADMIN, feconf.ROLE_ID_VOICEOVER_ADMIN, feconf.ROLE_ID_QUESTION_COORDINATOR, feconf.ROLE_ID_TRANSLATION_COORDINATOR]
HUMAN_READABLE_ROLES = {feconf.ROLE_ID_BLOG_ADMIN: 'blog admin', feconf.ROLE_ID_BLOG_POST_EDITOR: 'blog post editor', feconf.ROLE_ID_COLLECTION_EDITOR: 'collection editor', feconf.ROLE_ID_CURRICULUM_ADMIN: 'curriculum admin', feconf.ROLE_ID_FULL_USER: 'full user', feconf.ROLE_ID_GUEST: 'guest', feconf.ROLE_ID_MOBILE_LEARNER: 'mobile learner', feconf.ROLE_ID_MODERATOR: 'moderator', feconf.ROLE_ID_QUESTION_ADMIN: 'question admin', feconf.ROLE_ID_RELEASE_COORDINATOR: 'release coordinator', feconf.ROLE_ID_TOPIC_MANAGER: 'topic manager', feconf.ROLE_ID_TRANSLATION_ADMIN: 'translation admin', feconf.ROLE_ID_VOICEOVER_ADMIN: 'voiceover admin', feconf.ROLE_ID_QUESTION_COORDINATOR: 'question coordinator', feconf.ROLE_ID_TRANSLATION_COORDINATOR: 'translation coordinator'}
_ROLE_ACTIONS = {feconf.ROLE_ID_CURRICULUM_ADMIN: [ACTION_ACCEPT_ANY_SUGGESTION, ACTION_ACCESS_TOPICS_AND_SKILLS_DASHBOARD, ACTION_ACCESS_CLASSROOM_ADMIN_PAGE, ACTION_CHANGE_STORY_STATUS, ACTION_CHANGE_TOPIC_STATUS, ACTION_CREATE_NEW_SKILL, ACTION_CREATE_NEW_TOPIC, ACTION_DELETE_ANY_ACTIVITY, ACTION_DELETE_ANY_QUESTION, ACTION_DELETE_ANY_SKILL, ACTION_DELETE_TOPIC, ACTION_EDIT_ANY_ACTIVITY, ACTION_EDIT_ANY_QUESTION, ACTION_EDIT_ANY_STORY, ACTION_EDIT_ANY_SUBTOPIC_PAGE, ACTION_EDIT_ANY_TOPIC, ACTION_EDIT_SKILL, ACTION_EDIT_SKILL_DESCRIPTION, ACTION_EDIT_OWNED_TOPIC, ACTION_MANAGE_QUESTION_SKILL_STATUS, ACTION_MANAGE_TOPIC_RIGHTS, ACTION_MODIFY_CORE_ROLES_FOR_ANY_ACTIVITY, ACTION_PUBLISH_ANY_ACTIVITY, ACTION_PUBLISH_OWNED_SKILL, ACTION_VISIT_ANY_QUESTION_EDITOR_PAGE, ACTION_VISIT_ANY_TOPIC_EDITOR_PAGE], feconf.ROLE_ID_COLLECTION_EDITOR: [ACTION_CREATE_COLLECTION], feconf.ROLE_ID_FULL_USER: [ACTION_ACCESS_CREATOR_DASHBOARD, ACTION_ACCESS_LEARNER_DASHBOARD, ACTION_ACCESS_FEEDBACK_UPDATES, ACTION_ACCESS_LEARNER_GROUPS, ACTION_CREATE_EXPLORATION, ACTION_DELETE_OWNED_PRIVATE_ACTIVITY, ACTION_EDIT_OWNED_ACTIVITY, ACTION_FLAG_EXPLORATION, ACTION_MANAGE_ACCOUNT, ACTION_MODIFY_CORE_ROLES_FOR_OWNED_ACTIVITY, ACTION_PLAY_ANY_PUBLIC_ACTIVITY, ACTION_PUBLISH_OWNED_ACTIVITY, ACTION_RATE_ANY_PUBLIC_EXPLORATION, ACTION_SUBSCRIBE_TO_USERS, ACTION_SUGGEST_CHANGES], feconf.ROLE_ID_GUEST: [ACTION_PLAY_ANY_PUBLIC_ACTIVITY], feconf.ROLE_ID_MOBILE_LEARNER: [ACTION_PLAY_ANY_PUBLIC_ACTIVITY], feconf.ROLE_ID_MODERATOR: [ACTION_ACCESS_MODERATOR_PAGE, ACTION_DELETE_ANY_ACTIVITY, ACTION_DELETE_ANY_PUBLIC_ACTIVITY, ACTION_EDIT_ANY_ACTIVITY, ACTION_EDIT_ANY_PUBLIC_ACTIVITY, ACTION_PLAY_ANY_PRIVATE_ACTIVITY, ACTION_SEND_MODERATOR_EMAILS, ACTION_UNPUBLISH_ANY_PUBLIC_ACTIVITY, ACTION_MODIFY_CORE_ROLES_FOR_ANY_ACTIVITY], feconf.ROLE_ID_RELEASE_COORDINATOR: [ACTION_ACCESS_RELEASE_COORDINATOR_PAGE, ACTION_MANAGE_MEMCACHE, ACTION_RUN_ANY_JOB], feconf.ROLE_ID_TOPIC_MANAGER: [ACTION_ACCESS_TOPICS_AND_SKILLS_DASHBOARD, ACTION_DELETE_ANY_QUESTION, ACTION_EDIT_ANY_QUESTION, ACTION_EDIT_OWNED_STORY, ACTION_EDIT_OWNED_TOPIC, ACTION_EDIT_SKILL, ACTION_EDIT_ANY_SUBTOPIC_PAGE, ACTION_MANAGE_QUESTION_SKILL_STATUS, ACTION_VISIT_ANY_QUESTION_EDITOR_PAGE, ACTION_VISIT_ANY_TOPIC_EDITOR_PAGE], feconf.ROLE_ID_VOICEOVER_ADMIN: [ACTION_CAN_MANAGE_VOICE_ARTIST], feconf.ROLE_ID_QUESTION_ADMIN: [ACTION_ACCESS_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_MANAGE_QUESTION_CONTRIBUTOR_ROLES], feconf.ROLE_ID_TRANSLATION_ADMIN: [ACTION_ACCESS_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_MANAGE_TRANSLATION_CONTRIBUTOR_ROLES], feconf.ROLE_ID_TRANSLATION_COORDINATOR: [ACTION_ACCESS_NEW_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_ACCESS_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_MANAGE_TRANSLATION_CONTRIBUTOR_ROLES], feconf.ROLE_ID_BLOG_ADMIN: [ACTION_ACCESS_BLOG_ADMIN_PAGE, ACTION_ACCESS_BLOG_DASHBOARD, ACTION_DELETE_ANY_BLOG_POST, ACTION_EDIT_ANY_BLOG_POST, ACTION_MANAGE_BLOG_POST_EDITORS], feconf.ROLE_ID_BLOG_POST_EDITOR: [ACTION_ACCESS_BLOG_DASHBOARD], feconf.ROLE_ID_QUESTION_COORDINATOR: [ACTION_ACCESS_NEW_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_ACCESS_CONTRIBUTOR_DASHBOARD_ADMIN_PAGE, ACTION_MANAGE_QUESTION_CONTRIBUTOR_ROLES]}
