...
from airflow.providers.cncf.kubernetes.kubernetes_helper_functions import annotations_for_logging_task_metadata, annotations_to_key, create_pod_id
from airflow.providers.cncf.kubernetes.pod_generator import PodGenerator
from airflow.utils.log.logging_mixin import LoggingMixin
from airflow.utils.state import TaskInstanceState
try:
    from airflow.providers.cncf.kubernetes.executors.kubernetes_executor_types import ALL_NAMESPACES, POD_EXECUTOR_DONE_KEY
except ImportError:
    from airflow.kubernetes.kubernetes_executor_types import ALL_NAMESPACES, POD_EXECUTOR_DONE_KEY
if TYPE_CHECKING:
    from kubernetes.client import Configuration, models as k8s
    from airflow.providers.cncf.kubernetes.executors.kubernetes_executor_types import KubernetesJobType, KubernetesResultsType, KubernetesWatchType
T = TypeVar('T')
