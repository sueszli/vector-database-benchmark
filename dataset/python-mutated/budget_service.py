...
__protobuf__ = proto.module(package='google.cloud.billing.budgets.v1', manifest={'CreateBudgetRequest', 'UpdateBudgetRequest', 'GetBudgetRequest', 'ListBudgetsRequest', 'ListBudgetsResponse', 'DeleteBudgetRequest'})
...
class CreateBudgetRequest(proto.Message):
    ...
    budget: budget_model.Budget = proto.Field(proto.MESSAGE, number=2, message=budget_model.Budget)
...
class UpdateBudgetRequest(proto.Message):
    ...
    """
    budget: budget_model.Budget = proto.Field(proto.MESSAGE, number=1, message=budget_model.Budget)
...
class ListBudgetsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    scope: str = proto.Field(proto.STRING, number=4)
...
class ListBudgetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    budgets: MutableSequence[budget_model.Budget] = proto.RepeatedField(proto.MESSAGE, number=1, message=budget_model.Budget)
