...
class Migration(migrations.Migration):
    dependencies = [('product', '0172_merge_20220802_0817'), ('warehouse', '0031_create_default_warehouse')]
    operations = [migrations.RunPython(create_default_product_type, migrations.RunPython.noop), migrations.RunPython(create_default_category, migrations.RunPython.noop)]