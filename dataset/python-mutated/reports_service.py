...
import proto
__protobuf__ = proto.module(package='google.cloud.channel.v1', manifest={'RunReportJobRequest', 'RunReportJobResponse', 'FetchReportResultsRequest', 'FetchReportResultsResponse', 'ListReportsRequest', 'ListReportsResponse', 'ReportJob', 'ReportResultsMetadata', 'Column', 'DateRange', 'Row', 'ReportValue', 'ReportStatus', 'Report'})
...
class RunReportJobRequest(proto.Message):
    ...
    date_range: 'DateRange' = proto.Field(proto.MESSAGE, number=2, message='DateRange')
    filter: str = proto.Field(proto.STRING, number=3)
    language_code: str = proto.Field(proto.STRING, number=4)
...
class RunReportJobResponse(proto.Message):
    ...
    """
    report_job: 'ReportJob' = proto.Field(proto.MESSAGE, number=1, message='ReportJob')
    report_metadata: 'ReportResultsMetadata' = proto.Field(proto.MESSAGE, number=2, message='ReportResultsMetadata')
...
class FetchReportResultsRequest(proto.Message):
    ...
    Attributes:
        ...
        partition_keys (MutableSequence[str]):
            ...
            all partitions.
    """
    report_job: str = proto.Field(proto.STRING, number=1)
    page_size: int = proto.Field(proto.INT32, number=2)
    page_token: str = proto.Field(proto.STRING, number=3)
    partition_keys: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
...
class FetchReportResultsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    report_metadata: 'ReportResultsMetadata' = proto.Field(proto.MESSAGE, number=1, message='ReportResultsMetadata')
    rows: MutableSequence['Row'] = proto.RepeatedField(proto.MESSAGE, number=2, message='Row')
...
class ReportJob(proto.Message):
    """The result of a [RunReportJob][] operation. Contains the name to use
    in
    [FetchReportResultsRequest.report_job][google.cloud.channel.v1.FetchReportResultsRequest.report_job]
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    report_status: 'ReportStatus' = proto.Field(proto.MESSAGE, number=2, message='ReportStatus')
...
class ReportResultsMetadata(proto.Message):
    ...
    """
    report: 'Report' = proto.Field(proto.MESSAGE, number=1, message='Report')
    row_count: int = proto.Field(proto.INT64, number=2)
    date_range: 'DateRange' = proto.Field(proto.MESSAGE, number=3, message='DateRange')
    preceding_date_range: 'DateRange' = proto.Field(proto.MESSAGE, number=4, message='DateRange')
...
class Column(proto.Message):
    ...
    class DataType(proto.Enum):
        ...
        DATE = 5
        DATE_TIME = 6
    column_id: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    data_type: DataType = proto.Field(proto.ENUM, number=3, enum=DataType)
...
class DateRange(proto.Message):
    ...
    Attributes:
        ...
        invoice_end_date (google.type.date_pb2.Date):
            ...
            given month.
    """
    usage_start_date_time: datetime_pb2.DateTime = proto.Field(proto.MESSAGE, number=1, message=datetime_pb2.DateTime)
    usage_end_date_time: datetime_pb2.DateTime = proto.Field(proto.MESSAGE, number=2, message=datetime_pb2.DateTime)
    invoice_start_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=3, message=date_pb2.Date)
    invoice_end_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=4, message=date_pb2.Date)
...
class Row(proto.Message):
    ...
    Attributes:
        ...
        partition_key (str):
            ...
            partitioned.
    """
    values: MutableSequence['ReportValue'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReportValue')
    partition_key: str = proto.Field(proto.STRING, number=2)
...
class ReportValue(proto.Message):
    ...
    Attributes:
        ...
        date_time_value (google.type.datetime_pb2.DateTime):
            ...
            This field is a member of `oneof`_ ``value``.
    """
    string_value: str = proto.Field(proto.STRING, number=1, oneof='value')
    int_value: int = proto.Field(proto.INT64, number=2, oneof='value')
    decimal_value: decimal_pb2.Decimal = proto.Field(proto.MESSAGE, number=3, oneof='value', message=decimal_pb2.Decimal)
    money_value: money_pb2.Money = proto.Field(proto.MESSAGE, number=4, oneof='value', message=money_pb2.Money)
    date_value: date_pb2.Date = proto.Field(proto.MESSAGE, number=5, oneof='value', message=date_pb2.Date)
    date_time_value: datetime_pb2.DateTime = proto.Field(proto.MESSAGE, number=6, oneof='value', message=datetime_pb2.DateTime)
...
class Report(proto.Message):
    """The ID and description of a report that was used to generate
    ...
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    columns: MutableSequence['Column'] = proto.RepeatedField(proto.MESSAGE, number=3, message='Column')
