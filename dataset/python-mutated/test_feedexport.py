...
from scrapy.extensions.feedexport import IS_BOTO3_AVAILABLE, BlockingFeedStorage, FeedExporter, FeedSlot, FileFeedStorage, FTPFeedStorage, GCSFeedStorage, IFeedStorage, S3FeedStorage, StdoutFeedStorage
...
class FeedExporterSignalsTest(unittest.TestCase):
    items = [{'foo': 'bar1', 'egg': 'spam1'}, {'foo': 'bar2', 'egg': 'spam2', 'baz': 'quux2'}, {'foo': 'bar3', 'baz': 'quux3'}]
    with tempfile.NamedTemporaryFile(suffix='json') as tmp:
        settings = {'FEEDS': {f'file:///{tmp.name}': {'format': 'json'}}}
