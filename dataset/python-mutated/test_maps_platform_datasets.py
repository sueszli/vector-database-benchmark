...
from google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets import MapsPlatformDatasetsAsyncClient, MapsPlatformDatasetsClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(MapsPlatformDatasetsClient, 'grpc'), (MapsPlatformDatasetsAsyncClient, 'grpc_asyncio'), (MapsPlatformDatasetsClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.MapsPlatformDatasetsGrpcTransport, 'grpc'), (transports.MapsPlatformDatasetsGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.MapsPlatformDatasetsRestTransport, 'rest')])
...
def test_maps_platform_datasets_client_get_transport_class():
    ...
    available_transports = [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsRestTransport]
...
def test_maps_platform_datasets_client_client_options_from_dict():
    if False:
        i = 10
        return i + 15
    with mock.patch('google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport, 'grpc', grpc_helpers), (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_create_dataset(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
        call.return_value = gmm_dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[gmm_dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value')
...
async def test_create_dataset_async(transport: str='grpc_asyncio', request_type=maps_platform_datasets.CreateDatasetRequest):
    client = MapsPlatformDatasetsAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gmm_dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[gmm_dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value'))
...
def test_create_dataset_field_headers():
    if False:
        i = 10
        return i + 15
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_create_dataset_field_headers_async():
    client = MapsPlatformDatasetsAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = maps_platform_datasets.CreateDatasetRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
...
def test_get_dataset(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_dataset), '__call__') as call:
        call.return_value = dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value')
...
async def test_get_dataset_async(transport: str='grpc_asyncio', request_type=maps_platform_datasets.GetDatasetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_dataset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value'))
...
def test_list_datasets_pager(transport_name: str='grpc'):
    if False:
        i = 10
        return i + 15
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_datasets), '__call__') as call:
...
def test_create_dataset_rest(request_type):
    ...
    request_init['dataset'] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'version_id': 'version_id_value', 'usage': [1], 'local_file_source': {'filename': 'filename_value', 'file_format': 1}, 'gcs_source': {'input_uri': 'input_uri_value', 'file_format': 1}, 'status': {'state': 1, 'error_message': 'error_message_value'}, 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'version_create_time': {}, 'version_description': 'version_description_value'}
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = gmm_dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[gmm_dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value')
...
def test_create_dataset_rest_interceptors(null_interceptor):
    if False:
        while True:
            i = 10
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor())
    client = MapsPlatformDatasetsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'post_create_dataset') as post, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'pre_create_dataset') as pre:
...
def test_update_dataset_metadata_rest_interceptors(null_interceptor):
    ...
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor())
    client = MapsPlatformDatasetsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'post_update_dataset_metadata') as post, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'pre_update_dataset_metadata') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_dataset_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', version_id='version_id_value', usage=[dataset.Usage.USAGE_DATA_DRIVEN_STYLING], version_description='version_description_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_dataset_rest_interceptors(null_interceptor):
    ...
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor())
    client = MapsPlatformDatasetsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'post_get_dataset') as post, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'pre_get_dataset') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_datasets_rest_interceptors(null_interceptor):
    ...
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor())
    client = MapsPlatformDatasetsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'post_list_datasets') as post, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'pre_list_datasets') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_dataset_rest_interceptors(null_interceptor):
    ...
    transport = transports.MapsPlatformDatasetsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MapsPlatformDatasetsRestInterceptor())
    client = MapsPlatformDatasetsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MapsPlatformDatasetsRestInterceptor, 'pre_delete_dataset') as pre:
        pre.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        while True:
            i = 10
    transport = transports.MapsPlatformDatasetsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.MapsPlatformDatasetsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.MapsPlatformDatasetsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.MapsPlatformDatasetsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MapsPlatformDatasetsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.MapsPlatformDatasetsGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.MapsPlatformDatasetsGrpcTransport, transports.MapsPlatformDatasetsGrpcAsyncIOTransport, transports.MapsPlatformDatasetsRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = MapsPlatformDatasetsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        for i in range(10):
            print('nop')
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.MapsPlatformDatasetsGrpcTransport)
...
def test_maps_platform_datasets_base_transport():
    if False:
        for i in range(10):
            print('nop')
    with mock.patch('google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsTransport.__init__') as Transport:
        Transport.return_value = None
        transport = transports.MapsPlatformDatasetsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_dataset', 'update_dataset_metadata', 'get_dataset', 'list_datasets', 'delete_dataset')
...
def test_maps_platform_datasets_base_transport_with_credentials_file():
    if False:
        print('Hello World!')
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MapsPlatformDatasetsTransport(credentials_file='credentials.json', quota_project_id='octopus')
        load_creds.assert_called_once_with('credentials.json', scopes=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), quota_project_id='octopus')

def test_maps_platform_datasets_base_transport_with_adc():
    if False:
        print('Hello World!')
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.maps.mapsplatformdatasets_v1.services.maps_platform_datasets.transports.MapsPlatformDatasetsTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.MapsPlatformDatasetsGrpcTransport, grpc_helpers), (transports.MapsPlatformDatasetsGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_maps_platform_datasets_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='mapsplatformdatasets.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('mapsplatformdatasets.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://mapsplatformdatasets.googleapis.com')
...
def test_maps_platform_datasets_host_with_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='mapsplatformdatasets.googleapis.com:8000'), transport=transport_name)
...
def test_maps_platform_datasets_client_transport_session_collision(transport_name):
    ...
    client1 = MapsPlatformDatasetsClient(credentials=creds1, transport=transport_name)
    client2 = MapsPlatformDatasetsClient(credentials=creds2, transport=transport_name)
...
def test_maps_platform_datasets_grpc_transport_channel():
    ...
    transport = transports.MapsPlatformDatasetsGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_maps_platform_datasets_grpc_asyncio_transport_channel():
    ...
    transport = transports.MapsPlatformDatasetsGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MapsPlatformDatasetsTransport, '_prep_wrapped_messages') as prep:
        client = MapsPlatformDatasetsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = MapsPlatformDatasetsAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(MapsPlatformDatasetsClient, transports.MapsPlatformDatasetsGrpcTransport), (MapsPlatformDatasetsAsyncClient, transports.MapsPlatformDatasetsGrpcAsyncIOTransport)])
