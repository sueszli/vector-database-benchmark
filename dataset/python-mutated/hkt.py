...
_FunctionDefType = TypeVar('_FunctionDefType', bound=Callable, covariant=True)
...
class SupportsKindN(KindN[_InstanceType, _TypeArgType1, _TypeArgType2, _TypeArgType3]):
    ...
    __slots__ = ()
    __getattr__: None
SupportsKind1 = SupportsKindN[_InstanceType, _TypeArgType1, NoReturn, NoReturn]
SupportsKind2 = SupportsKindN[_InstanceType, _TypeArgType1, _TypeArgType2, NoReturn]
SupportsKind3 = SupportsKindN[_InstanceType, _TypeArgType1, _TypeArgType2, _TypeArgType3]
