...
from ray.autoscaler._private.vsphere.config import update_vsphere_configs, validate_frozen_vm_configs
from ray.autoscaler._private.vsphere.gpu_utils import split_vm_2_gpu_cards_map, GPUCard, set_gpu_placeholder
from ray.autoscaler._private.vsphere.utils import singleton_client
_CLUSTER_NAME = 'test'
_PROVIDER_CONFIG = {'vsphere_config': {'credentials': {'user': 'test@vsphere.local', 'password': 'test', 'server': '10.188.17.50'}, 'datacenter': 'test'}}
