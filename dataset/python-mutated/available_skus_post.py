...
def main():
    ...
    response = client.service.list_available_skus_by_resource_group(resource_group_name='YourResourceGroupName', location='westus', available_sku_request={'country': 'XX', 'location': 'westus', 'transferType': 'ImportToAzure'})
