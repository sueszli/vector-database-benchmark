...
class CriptTo(SimpleDecrypter):
    ...
    __version__ = '0.05'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?cript\\.to/folder/(?P<ID>\\w+)'
    ...
    CNL_LINK_PATTERN = 'data-cnl="(.+?)"'
    WEB_LINK_PATTERN = 'href="javascript:void\\(0\\);" onclick="popup\\(\\\'(.+?)\\\''
    DLC_LINK_PATTERN = 'onclick="popup\\(\\\'(https://cript\\.to/dlc/.+?)\\\''
