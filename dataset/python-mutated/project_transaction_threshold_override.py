...
from sentry.models.transaction_threshold import TRANSACTION_METRICS, ProjectTransactionThresholdOverride
...
class ProjectTransactionThresholdOverrideEndpoint(OrganizationEventsV2EndpointBase):
    publish_status = {'DELETE': ApiPublishStatus.UNKNOWN, 'GET': ApiPublishStatus.UNKNOWN, 'POST': ApiPublishStatus.UNKNOWN}
