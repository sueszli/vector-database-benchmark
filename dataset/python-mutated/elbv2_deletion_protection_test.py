...
class Test_elbv2_deletion_protection:
    ...
    def test_elb_no_balancers(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection import elbv2_deletion_protection
    ...
    def test_elbv2_without_deletion_protection(self):
        ...
        conn.modify_load_balancer_attributes(LoadBalancerArn=lb['LoadBalancerArn'], Attributes=[{'Key': 'deletion_protection.enabled', 'Value': 'false'}])
        from prowler.providers.aws.services.elbv2.elbv2_service import ELBv2
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection import elbv2_deletion_protection
            check = elbv2_deletion_protection()
            ...
            assert search('does not have deletion protection', result[0].status_extended)
    ...
    def test_elbv2_with_deletion_protection(self):
        ...
        conn.modify_load_balancer_attributes(LoadBalancerArn=lb['LoadBalancerArn'], Attributes=[{'Key': 'deletion_protection.enabled', 'Value': 'true'}])
        from prowler.providers.aws.services.elbv2.elbv2_service import ELBv2
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_deletion_protection.elbv2_deletion_protection import elbv2_deletion_protection
            check = elbv2_deletion_protection()
            ...
            assert search('has deletion protection enabled', result[0].status_extended)
            assert result[0].resource_id == 'my-lb'
            assert result[0].resource_arn == lb['LoadBalancerArn']