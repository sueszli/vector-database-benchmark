...
def test_stage3_bf16():
    ...
    o2_losses = train_mlp(mlp2, sharding_stage=3, use_pure_bf16=True, use_main_grad=True)
    ...
    o1_losses_grad_acc = train_mlp(mlp3, sharding_stage=3, use_pure_bf16=False, accumulate_grad=True)
    o2_losses_grad_acc = train_mlp(mlp4, sharding_stage=3, use_pure_bf16=True, use_main_grad=True, accumulate_grad=True)
