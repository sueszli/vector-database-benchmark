...
def test_rmdir_nested_dirs_with_files_failure_with_recurse(file, nested_dirs_with_files):
    if False:
        print('Hello World!')
    assert file.rmdir(nested_dirs_with_files, recurse=True) is False
    assert os.path.isdir(nested_dirs_with_files)

def test_rmdir_verbose_nested_dirs_with_files_failure_with_recurse(file, nested_dirs_with_files):
    if False:
        while True:
            i = 10
