...
from posthog.settings import CLICKHOUSE_CA, CLICKHOUSE_DATABASE, CLICKHOUSE_HOST, CLICKHOUSE_PASSWORD, CLICKHOUSE_SECURE, CLICKHOUSE_USER, CLICKHOUSE_VERIFY
REDIS_STATUS_TTL = 600
