...
class PoisoningAttackAdversarialEmbedding(PoisoningAttackTransformer):
    ...
    """
    attack_params = PoisoningAttackTransformer.attack_params + ['backdoor', 'feature_layer', 'target', 'pp_poison', 'discriminator_layer_1', 'discriminator_layer_2', 'regularization', 'learning_rate']
