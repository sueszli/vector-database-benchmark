...
from modelscope.models.cv.video_deinterlace.deinterlace_arch import DeinterlaceNet
...
@MODELS.register_module(Tasks.video_deinterlace, module_name=Models.video_deinterlace)
