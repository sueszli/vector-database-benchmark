...
class FilterParallelizationTest(test_base.DatasetTestBase, parameterized.TestCase):
...
class FilterCheckpointTest(checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
