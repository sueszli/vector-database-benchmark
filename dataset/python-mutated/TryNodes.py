...
class StatementTry(StatementTryBase):
    kind = 'STATEMENT_TRY'
    named_children = ('tried|statements+setter', 'except_handler|statements_or_none+setter', 'break_handler|statements_or_none+setter', 'continue_handler|statements_or_none+setter', 'return_handler|statements_or_none+setter')
