...
unit_with_physical_type_set = [(u.m, {'length'}), (u.kg * u.m / u.s, {'impulse', 'momentum'}), (u.Pa, {'energy density', 'pressure', 'stress'})]
...
equivalent_unit_pairs = [(u.m, u.m), (u.m, u.cm), (u.N, u.kg * u.m * u.s ** (-2)), (u.barn * u.Mpc, u.cm ** 3), (u.K, u.deg_C), (u.K, u.imperial.deg_R), (u.K, u.imperial.deg_F), (u.deg_C, u.imperial.deg_F), (u.m ** 18, u.pc ** 18)]
...
nonequivalent_unit_pairs = [(u.m, u.s), (u.m ** 18, u.m ** 19), (u.N, u.J), (u.barn, u.imperial.deg_F)]
...
physical_type_with_expected_str = [(length, 'length'), (speed, 'speed/velocity'), (pressure, 'energy density/pressure/stress'), (u.deg_C.physical_type, 'temperature'), ((u.J / u.K / u.kg).physical_type, 'specific entropy/specific heat capacity')]
physical_type_with_expected_repr = [(length, "PhysicalType('length')"), (speed, "PhysicalType({'speed', 'velocity'})"), (pressure, "PhysicalType({'energy density', 'pressure', 'stress'})"), (u.deg_C.physical_type, "PhysicalType('temperature')"), ((u.J / u.K / u.kg).physical_type, "PhysicalType({'specific entropy', 'specific heat capacity'})")]
