from typing import List, Dict, Optional, Tuple, Any, Union, Sequence, cast, NoReturn
from chalice.config import Config, DeployedResources
from chalice.deploy import models
from chalice.deploy.planner import Variable
from chalice.deploy.models import Instruction, StoreMultipleValue
...
class ResourceSweeper(object):
    specific_resources = ('s3_event', 'sns_event', 'sqs_event', 'kinesis_event', 'dynamodb_event', 'domain_name')
