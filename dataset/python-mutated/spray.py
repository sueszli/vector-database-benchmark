...
parser.add_argument('length', help='Length of byte sequence, when unspecified sprays until the end of vmmap which address belongs to', type=int, nargs='?', default=0)
parser.add_argument('--value', help="Value to spray memory with, when prefixed with '0x' treated as hex string encoded big-endian", type=str, required=False)
