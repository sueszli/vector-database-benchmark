...
class Migration(migrations.Migration):
    dependencies = [('attribute', '0024_merge_20221018_1100')]
    operations = [migrations.RunPython(propagate_names_for_plain_text_attribute_value_translations, migrations.RunPython.noop)]