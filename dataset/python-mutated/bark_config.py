...
class BarkConfig(BaseTTSConfig):
    ...
    TEXT_ENCODING_OFFSET: int = 10048
    SEMANTIC_PAD_TOKEN: int = 10000
    TEXT_PAD_TOKEN: int = 129595
    SEMANTIC_INFER_TOKEN: int = 129599
    COARSE_SEMANTIC_PAD_TOKEN: int = 12048
    COARSE_INFER_TOKEN: int = 12050
