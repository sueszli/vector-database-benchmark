...
class ASLIntrinsicParser(Parser):
    ...
    literalNames = ['<INVALID>', "'$.'", "'.'", "'*'", "','", "'('", "')'", "'['", "']'", "'<'", "'>'", "'@.'", "'@.length-'", "'&&'", "'||'", "'=='", "'='", "'true'", "'false'", "'States'", "'Format'", "'StringToJson'", "'JsonToString'", "'Array'", "'ArrayPartition'", "'ArrayContains'", "'ArrayRange'", "'ArrayGetItem'", "'ArrayLength'", "'ArrayUnique'", "'Base64Encode'", "'Base64Decode'", "'Hash'", "'JsonMerge'", "'MathRandom'", "'MathAdd'", "'StringSplit'", "'UUID'"]
    symbolicNames = ['<INVALID>', 'DOLLARDOT', 'DOT', 'STAR', 'COMMA', 'LPAREN', 'RPAREN', 'LBRACK', 'RBRACK', 'LDIAM', 'RDIAM', 'ATDOT', 'ATDOTLENGTHDASH', 'ANDAND', 'OROR', 'EQEQ', 'EQ', 'TRUE', 'FALSE', 'States', 'Format', 'StringToJson', 'JsonToString', 'Array', 'ArrayPartition', 'ArrayContains', 'ArrayRange', 'ArrayGetItem', 'ArrayLength', 'ArrayUnique', 'Base64Encode', 'Base64Decode', 'Hash', 'JsonMerge', 'MathRandom', 'MathAdd', 'StringSplit', 'UUID', 'STRING', 'INT', 'NUMBER', 'IDENTIFIER', 'WS']
    RULE_func_decl = 0
    ...
    RULE_identifier = 11
    ruleNames = ['func_decl', 'states_func_decl', 'state_fun_name', 'func_arg_list', 'func_arg', 'json_path', 'json_path_part', 'json_path_iden', 'json_path_iden_qual', 'json_path_qual', 'json_path_query', 'identifier']
    EOF = Token.EOF
    DOLLARDOT = 1
    DOT = 2
    STAR = 3
