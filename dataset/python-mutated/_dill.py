...
"""
__all__ = ['dump', 'dumps', 'load', 'loads', 'dump_session', 'load_session', 'Pickler', 'Unpickler', 'register', 'copy', 'pickle', 'pickles', 'check', 'HIGHEST_PROTOCOL', 'DEFAULT_PROTOCOL', 'PicklingError', 'UnpicklingError', 'HANDLE_FMODE', 'CONTENTS_FMODE', 'FILE_FMODE']
import logging
...
diff = None
_use_diff = False
PY3 = sys.hexversion >= 50331648
OLDER = PY3 and sys.hexversion < 50593792 or sys.hexversion < 34015921
OLD33 = sys.hexversion < 50528256
PY34 = 50593792 <= sys.hexversion < 50659328
if PY3:
    import builtins as __builtin__
    from pickle import _Pickler as StockPickler, Unpickler as StockUnpickler
    from _thread import LockType
    if sys.hexversion >= 50462960:
...
if PY3 and sys.hexversion < 50593792:
    GENERATOR_FAIL = True
else:
