...
num_epochs = 8
batch_size = 8
peft_config = AdaLoraConfig(init_r=12, target_r=8, beta1=0.85, beta2=0.85, tinit=200, tfinal=1000, deltaT=10, lora_alpha=32, lora_dropout=0.1, task_type=TaskType.SEQ_2_SEQ_LM, inference_mode=False)
...
for epoch in range(num_epochs):
    ...
    print(f'epoch={epoch!r}: train_ppl={train_ppl!r} train_epoch_loss={train_epoch_loss!r} eval_ppl={eval_ppl!r} eval_epoch_loss={eval_epoch_loss!r}')
correct = 0
total = 0
...
print(f'accuracy={accuracy!r} % on the evaluation dataset')
print(f'eval_preds[:10]={eval_preds[:10]!r}')
print(f"dataset['validation']['text_label'][:10]={dataset['validation']['text_label'][:10]!r}")
