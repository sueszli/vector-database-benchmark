...
from picard.util import IgnoreUpdatesContext, format_time, icontheme, restore_method, thread, throttle
from picard.util.preservedtags import PreservedTags
from picard.util.tags import display_tag_name
from picard.ui.colors import interface_colors
from picard.ui.edittagdialog import EditTagDialog, TagEditorDelegate
...
class MetadataBox(QtWidgets.QTableWidget):
    options = (Option('persist', 'metadatabox_header_state', QtCore.QByteArray()), BoolOption('persist', 'show_changes_first', False))
    COLUMN_ORIG = 1
    COLUMN_NEW = 2
