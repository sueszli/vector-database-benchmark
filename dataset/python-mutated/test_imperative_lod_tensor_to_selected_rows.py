...
class SimpleNet(paddle.nn.Layer):
    ...
    def __init__(self, hidden_size, vocab_size, num_steps=20, init_scale=0.1, is_sparse=False, dtype='float32'):
        ...
        self.embedding = paddle.nn.Embedding(vocab_size, hidden_size, sparse=is_sparse, weight_attr=base.ParamAttr(name='embedding_para', initializer=paddle.nn.initializer.Uniform(low=-init_scale, high=init_scale)))
    ...
    def forward(self, input, label):
        ...
        projection = paddle.matmul(x_emb, paddle.transpose(self.embedding.weight, perm=[1, 0]))
    ...
    def simple_net_float32(self, is_sparse, dtype):
        ...
        for place in places:
            ...
            for is_sort_sum_gradient in [True, False]:
                ...
                np.testing.assert_allclose(static_loss_value, dy_loss_value, rtol=0.001)
