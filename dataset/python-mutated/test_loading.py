...
from mmdet3d.datasets.pipelines import LoadAnnotations3D, LoadImageFromFileMono3D, LoadPointsFromFile, LoadPointsFromMultiSweeps, NormalizePointsColor, PointSegClassMapping
