...
class SsdMobilenetV2FeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):

    def _create_feature_extractor(self, depth_multiplier, pad_to_multiple, use_explicit_padding=False, num_layers=6, use_keras=False):
        if False:
            while True:
                i = 10
        ...
        min_depth = 32
        if use_keras:
            return ssd_mobilenet_v2_keras_feature_extractor.SSDMobileNetV2KerasFeatureExtractor(is_training=False, depth_multiplier=depth_multiplier, min_depth=min_depth, pad_to_multiple=pad_to_multiple, conv_hyperparams=self._build_conv_hyperparams(), freeze_batchnorm=False, inplace_batchnorm_update=False, use_explicit_padding=use_explicit_padding, num_layers=num_layers, name='MobilenetV2')
        else:
            return ssd_mobilenet_v2_feature_extractor.SSDMobileNetV2FeatureExtractor(False, depth_multiplier, min_depth, pad_to_multiple, self.conv_hyperparams_fn, use_explicit_padding=use_explicit_padding, num_layers=num_layers)
    ...
    def test_extract_features_returns_correct_shapes_128(self, use_keras):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 8, 8, 576), (2, 4, 4, 1280), (2, 2, 2, 512), (2, 1, 1, 256), (2, 1, 1, 256), (2, 1, 1, 128)]
    ...
    def test_extract_features_returns_correct_shapes_128_explicit_padding(self, use_keras):
        if False:
            i = 10
            return i + 15
        image_height = 128
    ...
    def test_extract_features_returns_correct_shapes_299(self, use_keras):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 19, 19, 576), (2, 10, 10, 1280), (2, 5, 5, 512), (2, 3, 3, 256), (2, 2, 2, 256), (2, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape, use_keras=use_keras)
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(self, use_keras):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 19, 19, 192), (2, 10, 10, 32), (2, 5, 5, 32), (2, 3, 3, 32), (2, 2, 2, 32), (2, 1, 1, 32)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape, use_keras=use_keras)
    ...
    def test_extract_features_returns_correct_shapes_with_pad_to_multiple(self, use_keras):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 32
        expected_feature_map_shape = [(2, 20, 20, 576), (2, 10, 10, 1280), (2, 5, 5, 512), (2, 3, 3, 256), (2, 2, 2, 256), (2, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape, use_keras=use_keras)
    ...
    def test_extract_features_with_fewer_layers(self, use_keras):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 8, 8, 576), (2, 4, 4, 1280), (2, 2, 2, 512), (2, 1, 1, 256)]
