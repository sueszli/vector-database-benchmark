...
_ESP32C3_SPI_PSRAM_PINS = {12: 'SPIHD', 13: 'SPIWP', 14: 'SPICS0', 15: 'SPICLK', 16: 'SPID', 17: 'SPIQ'}
...
def esp32_c3_validate_gpio_pin(value):
    ...
    if value in _ESP32C3_SPI_PSRAM_PINS:
        raise cv.Invalid(f'This pin cannot be used on ESP32-C3s and is already used by the SPI/PSRAM interface (function: {_ESP32C3_SPI_PSRAM_PINS[value]})')
    return value
