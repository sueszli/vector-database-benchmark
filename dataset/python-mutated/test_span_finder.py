...
SPANS_KEY = 'pytest'
TRAIN_DATA = [('Who is Shaka Khan?', {'spans': {SPANS_KEY: [(7, 17)]}}), ('I like London and Berlin.', {'spans': {SPANS_KEY: [(7, 13), (18, 24)]}})]
TRAIN_DATA_OVERLAPPING = [('Who is Shaka Khan?', {'spans': {SPANS_KEY: [(7, 17)]}}), ('I like London and Berlin', {'spans': {SPANS_KEY: [(7, 13), (18, 24), (7, 24)]}}), ('', {'spans': {SPANS_KEY: []}})]
