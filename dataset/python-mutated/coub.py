...
class CoubIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://coub.com/view/5u5n1', 'info_dict': {'id': '5u5n1', 'ext': 'mp4', 'title': 'The Matrix Moonwalk', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 4.6, 'timestamp': 1428527772, 'upload_date': '20150408', 'uploader': 'Artyom Loskutnikov', 'uploader_id': 'artyom.loskutnikov', 'view_count': int, 'like_count': int, 'repost_count': int, 'age_limit': 0}}, {'url': 'http://c-cdn.coub.com/fb-player.swf?bot_type=vk&coubID=7w5a4', 'only_matching': True}, {'url': 'coub:5u5n1', 'only_matching': True}, {'url': 'http://coub.com/view/237d5l5h', 'only_matching': True}]
