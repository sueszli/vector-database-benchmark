...
def view_grantable_roles(full_resource_name: str) -> None:
    if False:
        for i in range(10):
            print('nop')
    roles = service.roles().queryGrantableRoles(body={'fullResourceName': full_resource_name}).execute()
...
if __name__ == '__main__':
    ...
    parser.add_argument('full_resource_name', help='The full name of the resource to query grantable roles for.')
