...
from airflow.providers.google.cloud.hooks.cloud_storage_transfer_service import ACCESS_KEY_ID, AWS_ACCESS_KEY, AWS_S3_DATA_SOURCE, AWS_SECRET_ACCESS_KEY, BUCKET_NAME, GCS_DATA_SINK, INCLUDE_PREFIXES, OBJECT_CONDITIONS, OVERWRITE_OBJECTS_ALREADY_EXISTING_IN_SINK, PATH, PROJECT_ID, SCHEDULE, SCHEDULE_END_DATE, SCHEDULE_START_DATE, STATUS, TRANSFER_OPTIONS, TRANSFER_SPEC, CloudDataTransferServiceHook, GcpTransferJobsStatus
from airflow.providers.google.cloud.hooks.gcs import GCSHook, _parse_gcs_url, gcs_object_is_directory
from airflow.providers.google.cloud.triggers.cloud_storage_transfer_service import CloudStorageTransferServiceCreateJobsTrigger
try:
...
class S3ToGCSOperator(S3ListOperator):
    ...
    **Example**:
    ...
    """
    template_fields: Sequence[str] = ('bucket', 'prefix', 'delimiter', 'dest_gcs', 'google_impersonation_chain')
    ui_color = '#e09411'
