...
from samcli.lib.providers.provider import CORS_CREDENTIALS_HEADER, CORS_HEADERS_HEADER, CORS_MAX_AGE_HEADER, CORS_METHODS_HEADER, CORS_ORIGIN_HEADER, Cors, Stack
