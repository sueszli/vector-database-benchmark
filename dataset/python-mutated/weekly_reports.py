...
total_color = '\nlinear-gradient(\n    -45deg,\n    #ccc 25%,\n    transparent 25%,\n    transparent 50%,\n    #ccc 50%,\n    #ccc 75%,\n    transparent 75%,\n    transparent\n);\n'
other_color = '#f2f0fa'
group_status_to_color = {GroupHistoryStatus.UNRESOLVED: '#FAD473', GroupHistoryStatus.RESOLVED: '#8ACBBC', GroupHistoryStatus.SET_RESOLVED_IN_RELEASE: '#8ACBBC', GroupHistoryStatus.SET_RESOLVED_IN_COMMIT: '#8ACBBC', GroupHistoryStatus.SET_RESOLVED_IN_PULL_REQUEST: '#8ACBBC', GroupHistoryStatus.AUTO_RESOLVED: '#8ACBBC', GroupHistoryStatus.IGNORED: '#DBD6E1', GroupHistoryStatus.UNIGNORED: '#FAD473', GroupHistoryStatus.ASSIGNED: '#FAAAAC', GroupHistoryStatus.UNASSIGNED: '#FAD473', GroupHistoryStatus.REGRESSED: '#FAAAAC', GroupHistoryStatus.DELETED: '#DBD6E1', GroupHistoryStatus.DELETED_AND_DISCARDED: '#DBD6E1', GroupHistoryStatus.REVIEWED: '#FAD473', GroupHistoryStatus.NEW: '#FAD473', GroupHistoryStatus.ESCALATING: '#FAD473', GroupHistoryStatus.ARCHIVED_UNTIL_ESCALATING: '#FAD473', GroupHistoryStatus.ARCHIVED_FOREVER: '#FAD473', GroupHistoryStatus.ARCHIVED_UNTIL_CONDITION_MET: '#FAD473'}
