    ...
    def from_dict(cls, obj: dict) -> EnvsEnvIDBuildsBuildIDLogsPostRequest:
        ...
        for _key in obj.keys():
            if _key not in ['apiSecret', 'logs']:
                raise ValueError('Error due to additional fields (not defined in EnvsEnvIDBuildsBuildIDLogsPostRequest) in the input: ' + obj)
        _obj = EnvsEnvIDBuildsBuildIDLogsPostRequest.model_validate({'api_secret': obj.get('apiSecret'), 'logs': obj.get('logs')})
        return _obj