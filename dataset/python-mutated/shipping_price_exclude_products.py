...
class ShippingPriceExcludeProductsInput(BaseInputObjectType):
    products = NonNullList(graphene.ID, description='List of products which will be excluded.', required=True)
...
class ShippingPriceExcludeProducts(BaseMutation):
    ...
    class Arguments:
        ...
        input = ShippingPriceExcludeProductsInput(description='Exclude products input.', required=True)
