...
"""
from .BuiltinOperationNodeBasesGenerated import ExpressionStrOperationCapitalizeBase, ExpressionStrOperationCenter2Base, ExpressionStrOperationCenter3Base, ExpressionStrOperationCount2Base, ExpressionStrOperationCount3Base, ExpressionStrOperationCount4Base, ExpressionStrOperationDecode1Base, ExpressionStrOperationDecode2Base, ExpressionStrOperationDecode3Base, ExpressionStrOperationEncode1Base, ExpressionStrOperationEncode2Base, ExpressionStrOperationEncode3Base, ExpressionStrOperationEndswith2Base, ExpressionStrOperationEndswith3Base, ExpressionStrOperationEndswith4Base, ExpressionStrOperationExpandtabs1Base, ExpressionStrOperationExpandtabs2Base, ExpressionStrOperationFind2Base, ExpressionStrOperationFind3Base, ExpressionStrOperationFind4Base, ExpressionStrOperationFormatBase, ExpressionStrOperationIndex2Base, ExpressionStrOperationIndex3Base, ExpressionStrOperationIndex4Base, ExpressionStrOperationIsalnumBase, ExpressionStrOperationIsalphaBase, ExpressionStrOperationIsdigitBase, ExpressionStrOperationIslowerBase, ExpressionStrOperationIsspaceBase, ExpressionStrOperationIstitleBase, ExpressionStrOperationIsupperBase, ExpressionStrOperationJoinBase, ExpressionStrOperationLjust2Base, ExpressionStrOperationLjust3Base, ExpressionStrOperationLowerBase, ExpressionStrOperationLstrip1Base, ExpressionStrOperationLstrip2Base, ExpressionStrOperationPartitionBase, ExpressionStrOperationReplace3Base, ExpressionStrOperationReplace4Base, ExpressionStrOperationRfind2Base, ExpressionStrOperationRfind3Base, ExpressionStrOperationRfind4Base, ExpressionStrOperationRindex2Base, ExpressionStrOperationRindex3Base, ExpressionStrOperationRindex4Base, ExpressionStrOperationRjust2Base, ExpressionStrOperationRjust3Base, ExpressionStrOperationRpartitionBase, ExpressionStrOperationRsplit1Base, ExpressionStrOperationRsplit2Base, ExpressionStrOperationRsplit3Base, ExpressionStrOperationRstrip1Base, ExpressionStrOperationRstrip2Base, ExpressionStrOperationSplit1Base, ExpressionStrOperationSplit2Base, ExpressionStrOperationSplit3Base, ExpressionStrOperationSplitlines1Base, ExpressionStrOperationSplitlines2Base, ExpressionStrOperationStartswith2Base, ExpressionStrOperationStartswith3Base, ExpressionStrOperationStartswith4Base, ExpressionStrOperationStrip1Base, ExpressionStrOperationStrip2Base, ExpressionStrOperationSwapcaseBase, ExpressionStrOperationTitleBase, ExpressionStrOperationTranslateBase, ExpressionStrOperationUpperBase, ExpressionStrOperationZfillBase
from .ConstantRefNodes import makeConstantRefNode
from .ExpressionShapeMixins import ExpressionBytesShapeExactMixin, ExpressionStrOrUnicodeExactMixin, ExpressionStrShapeExactMixin
...
def getStrOperationClasses():
    ...
    return (cls for (kind, cls) in NodeCheckMetaClass.kinds.items() if kind.startswith('EXPRESSION_STR_OPERATION_'))
...
def makeExpressionStrOperationSplit3(str_arg, sep, maxsplit, source_ref):
    ...
    return ExpressionStrOperationSplit3(str_arg=str_arg, sep=sep, maxsplit=maxsplit, source_ref=source_ref)
...
def makeExpressionStrOperationRsplit3(str_arg, sep, maxsplit, source_ref):
    ...
    if sep is None:
        sep = makeConstantRefNode(constant=None, source_ref=source_ref)
    return ExpressionStrOperationRsplit3(str_arg=str_arg, sep=sep, maxsplit=maxsplit, source_ref=source_ref)
...
class ExpressionStrOperationEncodeMixin(ExpressionBytesShapeExactMixin if str is not bytes else ExpressionStrShapeExactMixin):
    __slots__ = ()
...
class ExpressionStrOperationEncode1(ExpressionStrOperationEncodeMixin, ExpressionStrOperationEncode1Base):
    kind = 'EXPRESSION_STR_OPERATION_ENCODE1'

class ExpressionStrOperationEncode2(ExpressionStrOperationEncodeMixin, ExpressionStrOperationEncode2Base):
...
def makeExpressionStrOperationEncode3(str_arg, encoding, errors, source_ref):
    ...
    return ExpressionStrOperationEncode3(str_arg=str_arg, encoding=encoding, errors=errors, source_ref=source_ref)

class ExpressionStrOperationEncode3(ExpressionStrOperationEncodeMixin, ExpressionStrOperationEncode3Base):
...
class ExpressionStrOperationDecode1(ExpressionStrOperationDecodeMixin, ExpressionStrOperationDecode1Base):
    kind = 'EXPRESSION_STR_OPERATION_DECODE1'

class ExpressionStrOperationDecode2(ExpressionStrOperationDecodeMixin, ExpressionStrOperationDecode2Base):
...
class ExpressionStrOperationDecode3(ExpressionStrOperationDecodeMixin, ExpressionStrOperationDecode3Base):
...
class ExpressionStrOperationFormat(ExpressionStrOperationFormatBase):
    ...
    def computeExpression(self, trace_collection):
        ...
        if str_arg.isCompileTimeConstant() and all((arg.isCompileTimeConstant() for arg in args)) and all((pair.isCompileTimeConstant() for pair in pairs)):
            return trace_collection.getCompileTimeComputationResult(node=self, computation=lambda : str.format(str_arg.getCompileTimeConstant(), *(arg.getCompileTimeConstant() for arg in args), **dict(((pair.getKeyCompileTimeConstant(), pair.getValueCompileTimeConstant()) for pair in pairs))), description="Built-in 'str.format' with constant values.", user_provided=str_arg.user_provided)
        trace_collection.onExceptionRaiseExit(BaseException)
        return (self, None, None)
