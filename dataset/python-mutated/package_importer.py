...
from ._importlib import _calc___package__, _normalize_line_endings, _normalize_path, _resolve_name, _sanity_check
...
IMPLICIT_IMPORT_ALLOWLIST: Iterable[str] = ['numpy', 'numpy.core', 'numpy.core._multiarray_umath', 'builtins']
