...
DEFAULT_CLASSIFICATION_LABEL_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_samples_per_class_classification, 'output_type': 'class_id'}]
DEFAULT_OBJECT_DETECTION_LABEL_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_samples_per_class_object_detection, 'output_type': 'class_id'}, {'name': 'Bounding Box Area (in pixels)', 'method': _get_bbox_area, 'output_type': 'numerical'}, {'name': 'Number of Bounding Boxes Per Image', 'method': _count_num_bboxes, 'output_type': 'numerical'}]
DEFAULT_SEMANTIC_SEGMENTATION_LABEL_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_samples_per_class_semantic_segmentation, 'output_type': 'class_id'}, {'name': 'Segment Area (in pixels)', 'method': _get_segment_area, 'output_type': 'numerical'}, {'name': 'Number of Classes Per Image', 'method': _count_classes_by_segment_in_image, 'output_type': 'numerical'}]
...
DEFAULT_CLASSIFICATION_PREDICTION_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_predicted_classes_per_image_classification, 'output_type': 'class_id'}]
DEFAULT_OBJECT_DETECTION_PREDICTION_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_predicted_classes_per_image_object_detection, 'output_type': 'class_id'}, {'name': 'Bounding Box Area (in pixels)', 'method': _get_predicted_bbox_area, 'output_type': 'numerical'}, {'name': 'Number of Bounding Boxes Per Image', 'method': _count_num_bboxes, 'output_type': 'numerical'}]
DEFAULT_SEMANTIC_SEGMENTATION_PREDICTION_PROPERTIES = [{'name': 'Samples Per Class', 'method': _get_predicted_classes_per_image_semantic_segmentation, 'output_type': 'class_id'}, {'name': 'Segment Area (in pixels)', 'method': _get_segment_pred_area, 'output_type': 'numerical'}, {'name': 'Number of Classes Per Image', 'method': _count_pred_classes_by_segment_in_image, 'output_type': 'numerical'}]
