...
import paddle
from paddle.distributed.auto_parallel.static.operators.common import ParallelMode, is_data_parallel_reduce_op, is_parameter_related
from paddle.distributed.auto_parallel.static.process_group import new_process_group
from paddle.distributed.auto_parallel.static.utils import _get_comm_group, get_logger, get_var_numel, insert_dependencies_for_vars, is_backward_op, is_dep_skip_op, is_forward_op, is_loss_grad_op, is_optimize_op, naive_set_dist_op_attr_for_program_by_mesh_and_mapping, set_var_dist_attr
...
_skip_ops = ['create_py_reader', 'create_double_buffer_reader', 'read', 'slice', 'split', 'assign', 'send_v2']
_supported_optimizer_type = ['adam', 'adamax', 'adamw', 'decayed_adagrad', 'momentum', 'dgc_momentum', 'lars_momentum', 'merged_momentum', 'lamb', 'sgd']
