...
from boltons.formatutils import get_format_args, split_format_str, tokenize_format_str, infer_positional_format_args, DeferredValue as DV
PFAT = namedtuple('PositionalFormatArgTest', 'fstr arg_vals res')
_PFATS = [PFAT('{} {} {}', ('hi', 'hello', 'bye'), 'hi hello bye'), PFAT('{:d} {}', (1, 2), '1 2'), PFAT('{!s} {!r}', ('str', 'repr'), "str 'repr'"), PFAT('{[hi]}, {.__name__!r}', ({'hi': 'hi'}, re), "hi, 're'"), PFAT('{{joek}} ({} {})', ('so', 'funny'), '{joek} (so funny)')]
...
_TEST_TMPLS = ['example 1: {hello}', 'example 2: {hello:*10}', 'example 3: {hello:*{width}}', 'example 4: {hello!r:{fchar}{width}}, {width}, yes', 'example 5: {0}, {1:d}, {2:f}, {1}', 'example 6: {}, {}, {}, {1}']
