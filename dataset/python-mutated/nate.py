...
class NateIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tv.nate.com/clip/1848976', 'info_dict': {'id': '1848976', 'ext': 'mp4', 'title': '[결승 오프닝 타이틀] 2018 LCK 서머 스플릿 결승전 kt Rolster VS Griffin', 'description': 'md5:e1b79a7dcf0d8d586443f11366f50e6f', 'thumbnail': 're:^https?://.*\\.jpg', 'upload_date': '20180908', 'age_limit': 15, 'duration': 73, 'uploader': '2018 LCK 서머 스플릿(롤챔스)', 'channel': '2018 LCK 서머 스플릿(롤챔스)', 'channel_id': '3606', 'uploader_id': '3606', 'tags': 'count:59'}, 'params': {'skip_download': True}}, {'url': 'https://tv.nate.com/clip/4300566', 'info_dict': {'id': '4300566', 'ext': 'mp4', 'title': '[심쿵엔딩] 이준호x이세영, 서로를 기억하며 끌어안는 두 사람!💕, MBC 211204 방송', 'description': 'md5:be1653502d9c13ce344ddf7828e089fa', 'thumbnail': 're:^https?://.*\\.jpg', 'upload_date': '20211204', 'age_limit': 15, 'duration': 201, 'uploader': '옷소매 붉은 끝동', 'channel': '옷소매 붉은 끝동', 'channel_id': '27987', 'uploader_id': '27987', 'tags': 'count:20'}, 'params': {'skip_download': True}}]
    _QUALITY = {'36': 2160, '35': 1080, '34': 720, '33': 480, '32': 360, '31': 270}
...
class NateProgramIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tv.nate.com/program/clips/27987', 'playlist_mincount': 191, 'info_dict': {'id': '27987'}}, {'url': 'https://tv.nate.com/program/clips/3606', 'playlist_mincount': 15, 'info_dict': {'id': '3606'}}]
