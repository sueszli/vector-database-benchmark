...
class MapleCodePrinter(CodePrinter):
    ...
    printmethod = '_maple'
    language = 'maple'
    _default_settings = {'order': None, 'full_prec': 'auto', 'human': True, 'inline': True, 'allow_unknown_functions': True}
