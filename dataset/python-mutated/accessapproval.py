...
class EnrollmentLevel(proto.Enum):
    """Represents the type of enrollment for a given service to
    Access Approval.
...
class AccessLocations(proto.Message):
    ...
    Attributes:
        ...
        principal_physical_location_country (str):
            ...
            -  ANY: Any location
    """
    principal_office_country: str = proto.Field(proto.STRING, number=1)
    principal_physical_location_country: str = proto.Field(proto.STRING, number=2)
...
class AccessReason(proto.Message):
    ...
    detail: str = proto.Field(proto.STRING, number=2)
...
class SignatureInfo(proto.Message):
    ...
    Attributes:
        ...
        customer_kms_key_version (str):
            ...
            This field is a member of `oneof`_ ``verification_info``.
    """
    signature: bytes = proto.Field(proto.BYTES, number=1)
    google_public_key_pem: str = proto.Field(proto.STRING, number=2, oneof='verification_info')
    customer_kms_key_version: str = proto.Field(proto.STRING, number=3, oneof='verification_info')
...
class ApproveDecision(proto.Message):
    ...
    """
    approve_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    invalidate_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    signature_info: 'SignatureInfo' = proto.Field(proto.MESSAGE, number=4, message='SignatureInfo')
    auto_approved: bool = proto.Field(proto.BOOL, number=5)
...
class DismissDecision(proto.Message):
    ...
    Attributes:
        ...
        implicit (bool):
            ...
            the exiration time).
    """
    dismiss_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    implicit: bool = proto.Field(proto.BOOL, number=2)
...
class ResourceProperties(proto.Message):
    ...
    """
    excludes_descendants: bool = proto.Field(proto.BOOL, number=1)
...
class ApprovalRequest(proto.Message):
    ...
    requested_resource_name: str = proto.Field(proto.STRING, number=2)
    requested_resource_properties: 'ResourceProperties' = proto.Field(proto.MESSAGE, number=9, message='ResourceProperties')
    requested_reason: 'AccessReason' = proto.Field(proto.MESSAGE, number=3, message='AccessReason')
    requested_locations: 'AccessLocations' = proto.Field(proto.MESSAGE, number=4, message='AccessLocations')
    request_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    requested_expiration: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    approve: 'ApproveDecision' = proto.Field(proto.MESSAGE, number=7, oneof='decision', message='ApproveDecision')
    dismiss: 'DismissDecision' = proto.Field(proto.MESSAGE, number=8, oneof='decision', message='DismissDecision')
...
class EnrolledService(proto.Message):
    ...
    """
    cloud_product: str = proto.Field(proto.STRING, number=1)
    enrollment_level: 'EnrollmentLevel' = proto.Field(proto.ENUM, number=2, enum='EnrollmentLevel')
...
class AccessApprovalSettings(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    notification_emails: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    enrolled_services: MutableSequence['EnrolledService'] = proto.RepeatedField(proto.MESSAGE, number=3, message='EnrolledService')
    enrolled_ancestor: bool = proto.Field(proto.BOOL, number=4)
    active_key_version: str = proto.Field(proto.STRING, number=6)
    ancestor_has_active_key_version: bool = proto.Field(proto.BOOL, number=7)
    invalid_key_version: bool = proto.Field(proto.BOOL, number=8)
...
class AccessApprovalServiceAccount(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    account_email: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    approval_requests: MutableSequence['ApprovalRequest'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ApprovalRequest')
...
class UpdateAccessApprovalSettingsMessage(proto.Message):
    ...
    """
    settings: 'AccessApprovalSettings' = proto.Field(proto.MESSAGE, number=1, message='AccessApprovalSettings')
