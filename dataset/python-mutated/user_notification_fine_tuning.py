...
from sentry.notifications.types import FineTuningAPIKey, NotificationScopeEnum, NotificationSettingEnum, NotificationSettingsOptionEnum
from sentry.notifications.utils.legacy_mappings import get_option_value_from_int, get_type_from_fine_tuning_key
from sentry.services.hybrid_cloud.user.service import user_service
from sentry.types.integrations import ExternalProviders
INVALID_EMAIL_MSG = 'Invalid email value(s) provided. Email values must be verified emails for the given user.'
INVALID_USER_MSG = 'User does not belong to at least one of the requested organizations (org_id: %s).'
