...
class Migration(migrations.Migration):
    dependencies = [('assets', '0044_platform')]
    operations = [migrations.RenameField(model_name='asset', old_name='platform', new_name='_platform'), migrations.AddField(model_name='asset', name='platform', field=models.ForeignKey(default='', on_delete=django.db.models.deletion.PROTECT, related_name='assets', to='assets.Platform', verbose_name='Platform')), migrations.RunPython(migrate_platform_to_asset_type), migrations.RemoveField(model_name='asset', name='_platform')]