...
from typing import TYPE_CHECKING, AbstractSet, Any, Callable, Dict, Iterable, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Union, cast
import dagster._check as check
from dagster._core.definitions.asset_check_spec import AssetCheckKey, AssetCheckSpec
from dagster._core.definitions.asset_checks import AssetChecksDefinition
from dagster._core.definitions.hook_definition import HookDefinition
from dagster._core.definitions.metadata import ArbitraryMetadataMapping, RawMetadataValue
from dagster._core.selector.subset_selector import AssetSelectionData
from ..errors import DagsterInvalidSubsetError, DagsterInvariantViolationError
...
class AssetOutputInfo(NamedTuple('_AssetOutputInfo', [('key', AssetKey), ('partitions_fn', Callable[['OutputContext'], Optional[AbstractSet[str]]]), ('partitions_def', Optional['PartitionsDefinition']), ('is_required', bool), ('code_version', Optional[str])])):
...
class AssetLayer(NamedTuple):
    ...
    check_names_by_asset_key_by_node_handle: Mapping[NodeHandle, Mapping[AssetKey, AbstractSet[str]]]
