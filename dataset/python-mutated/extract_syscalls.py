...
ARCH_TABLES = [('i386', 'arch/x86/entry/syscalls/syscall_32.tbl'), ('amd64', 'arch/x86/entry/syscalls/syscall_64.tbl'), ('armv7', 'arch/arm/tools/syscall.tbl')]
...
__ARM_NR_BASE = 983040
ADDITIONAL_SYSCALLS = {'armv7': [('sys_ARM_NR_breakpoint', __ARM_NR_BASE + 1), ('sys_ARM_NR_cacheflush', __ARM_NR_BASE + 2), ('sys_ARM_NR_usr26', __ARM_NR_BASE + 3), ('sys_ARM_NR_usr32', __ARM_NR_BASE + 4), ('sys_ARM_NR_set_tls', __ARM_NR_BASE + 5)]}
...
if __name__ == '__main__':
    ...
    for (march, larch) in UNISTD:
        ...
        try:
            ...
            process = subprocess.Popen(['cpp', '-E', tmp_path], stdout=subprocess.PIPE, encoding='utf-8')
