...
p4change = {3: p4_describe_3, 2: p4_describe_2, 5: p4_describe_4}
...
class TestP4Poller(changesource.ChangeSourceMixin, MasterRunProcessMixin, config.ConfigErrorsMixin, TestReactorMixin, unittest.TestCase):
