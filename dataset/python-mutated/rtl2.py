...
class RTL2IE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.rtl2.de/sendung/grip-das-motormagazin/folge/folge-203-0', 'info_dict': {'id': 'folge-203-0', 'ext': 'f4v', 'title': 'GRIP sucht den Sommerkönig', 'description': 'md5:e3adbb940fd3c6e76fa341b8748b562f'}, 'params': {'skip_download': True}, 'expected_warnings': ['Unable to download f4m manifest', 'Failed to download m3u8 information']}, {'url': 'http://www.rtl2.de/sendung/koeln-50667/video/5512-anna/21040-anna-erwischt-alex/', 'info_dict': {'id': 'anna-erwischt-alex', 'ext': 'mp4', 'title': 'Anna erwischt Alex!', 'description': 'Anna nimmt ihrem Vater nicht ab, dass er nicht spielt. Und tatsächlich erwischt sie ihn auf frischer Tat.'}, 'params': {'skip_download': True}, 'expected_warnings': ['Unable to download f4m manifest', 'Failed to download m3u8 information']}]
...
class RTL2YouSeriesIE(RTL2YouBaseIE):
    ...
    _TEST = {'url': 'http://you.rtl2.de/videos/115/dragon-ball', 'info_dict': {'id': '115'}, 'playlist_mincount': 5}
