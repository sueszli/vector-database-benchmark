...
RE_CPYTHON_PATHS = re.compile('(Include|Objects|Modules|Python|cpython).*\\.[c|h]$')
SYMBOL_IGNORELIST = {'PyObject_Call', 'call_function', 'classmethoddescr_call', 'cmpwrapper_call', 'do_call_core', 'fast_function', 'function_call', 'function_code_fastcall', 'instance_call', 'instancemethod_call', 'instancemethod_call', 'methoddescr_call', 'proxy_call', 'slot_tp_call', 'trace_call_function', 'type_call', 'weakref_call', 'wrap_call', 'wrapper_call', 'wrapperdescr_call'}
