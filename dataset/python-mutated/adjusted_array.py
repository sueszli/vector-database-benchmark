...
from zipline.utils.numpy_utils import datetime64ns_dtype, float64_dtype, int64_dtype, uint8_dtype
...
CONCRETE_WINDOW_TYPES = {float64_dtype: Float64Window, int64_dtype: Int64Window, uint8_dtype: UInt8Window}
...
_merge_methods = {'append': partial(_merge_simple, front_idx=0, back_idx=1), 'prepend': partial(_merge_simple, front_idx=1, back_idx=0)}
...
class AdjustedArray(object):
    ...
    """
    __slots__ = ('_data', '_view_kwargs', 'adjustments', 'missing_value', '_invalidated', '__weakref__')
