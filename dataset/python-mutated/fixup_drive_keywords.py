...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=driveCallTransformer()):
    if False:
        i = 10
        return i + 15
