...
class ProjectDynamicSamplingRateEndpoint(ProjectEndpoint):
    ...
    def get(self, request: Request, project: Project) -> Response:
        ...
        try:
            ...
            return Response({'sampleRate': sample_rate}, status=status.HTTP_200_OK)
        except Exception:
            return Response({'detail': 'Unable to fetch project sample rate'}, status=status.HTTP_400_BAD_REQUEST)