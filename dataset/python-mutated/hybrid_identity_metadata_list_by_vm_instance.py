...
def main():
    ...
    response = client.vm_instance_hybrid_identity_metadata.list(resource_uri='subscriptions/fd3c3665-1729-4b7b-9a38-238e83b0f98b/resourceGroups/testrg/providers/Microsoft.HybridCompute/machines/DemoVM')
