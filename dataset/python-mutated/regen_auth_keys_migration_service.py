...
def main():
    ...
    response = client.sql_migration_services.regenerate_auth_keys(resource_group_name='testrg', sql_migration_service_name='service1', parameters={'keyName': 'authKey1'})
    print(response)
