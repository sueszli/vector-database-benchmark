...
class SportBoxIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+src="(?P<url>https?://(?:news\\.sportbox|matchtv)\\.ru/vdl/player[^"]+)"']
    _TESTS = [{'url': 'http://news.sportbox.ru/vdl/player/ci/211355', 'info_dict': {'id': '109158', 'ext': 'mp4', 'title': 'В Новороссийске прошел детский турнир «Поле славы боевой»', 'description': 'В Новороссийске прошел детский турнир «Поле славы боевой»', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 292, 'view_count': int, 'timestamp': 1426237001, 'upload_date': '20150313'}, 'params': {'skip_download': True}}, {'url': 'http://news.sportbox.ru/vdl/player?nid=370908&only_player=1&autostart=false&playeri=2&height=340&width=580', 'only_matching': True}, {'url': 'https://news.sportbox.ru/vdl/player/media/193095', 'only_matching': True}, {'url': 'https://news.sportbox.ru/vdl/player/media/109158', 'only_matching': True}, {'url': 'https://matchtv.ru/vdl/player/media/109158', 'only_matching': True}]
