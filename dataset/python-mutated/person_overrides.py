...
from posthog.hogql.database.models import Table, StringDatabaseField, DateTimeDatabaseField, IntegerDatabaseField, FieldOrTable
from posthog.hogql.errors import HogQLException
from posthog.schema import HogQLQueryModifiers
PERSON_OVERRIDES_FIELDS: Dict[str, FieldOrTable] = {'team_id': IntegerDatabaseField(name='team_id'), 'old_person_id': StringDatabaseField(name='old_person_id'), 'override_person_id': StringDatabaseField(name='override_person_id'), 'oldest_event': DateTimeDatabaseField(name='oldest_event'), 'merged_at': DateTimeDatabaseField(name='merged_at'), 'created_at': DateTimeDatabaseField(name='created_at')}
...
class RawPersonOverridesTable(Table):
    fields: Dict[str, FieldOrTable] = {**PERSON_OVERRIDES_FIELDS, 'version': IntegerDatabaseField(name='version')}
