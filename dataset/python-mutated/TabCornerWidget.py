...
try:
    ...
    from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QHBoxLayout, QSpacerItem, QSizePolicy, QTabWidget
except ImportError:
    from PySide2.QtCore import Signal as pyqtSignal, Qt
    from PySide2.QtWidgets import QApplication, QWidget, QPushButton, QHBoxLayout, QSpacerItem, QSizePolicy, QTabWidget
