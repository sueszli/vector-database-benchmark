...
from qiskit.providers.fake_provider import FakeProvider, FakeKolkata, FakeWashington, FakeKolkataV2, FakeWashingtonV2
from qiskit.visualization import plot_gate_map, plot_coupling_map, plot_circuit_layout, plot_error_map
...
class TestGateMap(QiskitVisualizationTestCase):
    ...
    backends = list(filter(lambda x: not x.configuration().simulator and x.configuration().num_qubits in range(5, 21), FakeProvider().backends()))
