...
class deployCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'abandon_release': ('name',), 'advance_rollout': ('name', 'phase_id'), 'approve_rollout': ('name', 'approved'), 'cancel_automation_run': ('name',), 'cancel_rollout': ('name',), 'create_automation': ('parent', 'automation_id', 'automation', 'request_id', 'validate_only'), 'create_delivery_pipeline': ('parent', 'delivery_pipeline_id', 'delivery_pipeline', 'request_id', 'validate_only'), 'create_release': ('parent', 'release_id', 'release', 'request_id', 'validate_only'), 'create_rollout': ('parent', 'rollout_id', 'rollout', 'request_id', 'validate_only', 'starting_phase_id'), 'create_target': ('parent', 'target_id', 'target', 'request_id', 'validate_only'), 'delete_automation': ('name', 'request_id', 'allow_missing', 'validate_only', 'etag'), 'delete_delivery_pipeline': ('name', 'request_id', 'allow_missing', 'validate_only', 'force', 'etag'), 'delete_target': ('name', 'request_id', 'allow_missing', 'validate_only', 'etag'), 'get_automation': ('name',), 'get_automation_run': ('name',), 'get_config': ('name',), 'get_delivery_pipeline': ('name',), 'get_job_run': ('name',), 'get_release': ('name',), 'get_rollout': ('name',), 'get_target': ('name',), 'ignore_job': ('rollout', 'phase_id', 'job_id'), 'list_automation_runs': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_automations': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_delivery_pipelines': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_job_runs': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_releases': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_rollouts': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_targets': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'retry_job': ('rollout', 'phase_id', 'job_id'), 'rollback_target': ('name', 'target_id', 'rollout_id', 'release_id', 'rollout_to_roll_back', 'rollback_config', 'validate_only'), 'terminate_job_run': ('name',), 'update_automation': ('update_mask', 'automation', 'request_id', 'allow_missing', 'validate_only'), 'update_delivery_pipeline': ('update_mask', 'delivery_pipeline', 'request_id', 'allow_missing', 'validate_only'), 'update_target': ('update_mask', 'target', 'request_id', 'allow_missing', 'validate_only')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=deployCallTransformer()):
    if False:
        i = 10
        return i + 15
