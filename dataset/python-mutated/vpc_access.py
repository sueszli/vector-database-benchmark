...
import proto
__protobuf__ = proto.module(package='google.cloud.vpcaccess.v1', manifest={'Connector', 'CreateConnectorRequest', 'GetConnectorRequest', 'ListConnectorsRequest', 'ListConnectorsResponse', 'DeleteConnectorRequest', 'OperationMetadata'})
...
class Connector(proto.Message):
    ...
    min_throughput: int = proto.Field(proto.INT32, number=5)
    max_throughput: int = proto.Field(proto.INT32, number=6)
    connected_projects: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
    subnet: Subnet = proto.Field(proto.MESSAGE, number=8, message=Subnet)
    machine_type: str = proto.Field(proto.STRING, number=10)
    min_instances: int = proto.Field(proto.INT32, number=11)
    max_instances: int = proto.Field(proto.INT32, number=12)
...
class CreateConnectorRequest(proto.Message):
    ...
    connector_id: str = proto.Field(proto.STRING, number=2)
    connector: 'Connector' = proto.Field(proto.MESSAGE, number=3, message='Connector')
...
class ListConnectorsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    connectors: MutableSequence['Connector'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Connector')
...
class OperationMetadata(proto.Message):
    ...
    """
    method: str = proto.Field(proto.STRING, number=1)
    ...
    target: str = proto.Field(proto.STRING, number=5)
