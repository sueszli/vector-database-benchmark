...
from modelscope.models.cv.language_guided_video_summarization.summarizer import extract_video_features, video_features_to_txt
from modelscope.models.cv.video_summarization import summary_format
from modelscope.models.cv.video_summarization.summarizer import generate_summary, get_change_points
...
@PIPELINES.register_module(Tasks.language_guided_video_summarization, module_name=Pipelines.language_guided_video_summarization)
