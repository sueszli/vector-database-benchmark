...
class AlignTTSArgs(Coqpit):
    ...
    encoder_params: dict = field(default_factory=lambda : {'hidden_channels_ffn': 1024, 'num_heads': 2, 'num_layers': 6, 'dropout_p': 0.1})
    decoder_type: str = 'fftransformer'
    decoder_params: dict = field(default_factory=lambda : {'hidden_channels_ffn': 1024, 'num_heads': 2, 'num_layers': 6, 'dropout_p': 0.1})
