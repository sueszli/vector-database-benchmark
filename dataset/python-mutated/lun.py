...
import proto
__protobuf__ = proto.module(package='google.cloud.baremetalsolution.v2', manifest={'Lun', 'GetLunRequest', 'ListLunsRequest', 'ListLunsResponse', 'EvictLunRequest'})
...
class Lun(proto.Message):
    ...
    class MultiprotocolType(proto.Enum):
        """Display the operating systems present for the LUN
        multiprotocol type.
    ...
    id: str = proto.Field(proto.STRING, number=10)
    state: State = proto.Field(proto.ENUM, number=2, enum=State)
    size_gb: int = proto.Field(proto.INT64, number=3)
    multiprotocol_type: MultiprotocolType = proto.Field(proto.ENUM, number=4, enum=MultiprotocolType)
    storage_volume: str = proto.Field(proto.STRING, number=5)
    shareable: bool = proto.Field(proto.BOOL, number=6)
    boot_lun: bool = proto.Field(proto.BOOL, number=7)
    storage_type: StorageType = proto.Field(proto.ENUM, number=8, enum=StorageType)
    wwid: str = proto.Field(proto.STRING, number=9)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=11, message=timestamp_pb2.Timestamp)
    instances: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=12)
...
class ListLunsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    luns: MutableSequence['Lun'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Lun')
