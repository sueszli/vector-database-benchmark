...
try:
    ...
    from PyQt5.QtWidgets import QApplication, QGridLayout, QProgressBar, QSlider, QStyleOptionProgressBar, QWidget
except ImportError:
    from PySide2.QtCore import QRect, Qt, QRectF, QLineF
    from PySide2.QtGui import QColor, QPainter, QPen, QTransform, QPainterPath
    from PySide2.QtWidgets import QApplication, QProgressBar, QStyleOptionProgressBar, QWidget, QSlider, QGridLayout
