...
if __name__ == '__main__':
    ...
    parser.add_argument('--convert_tokenizer', type=bool, default=False, help='Whether or not the tokenizer should be converted along with the model.')
    parser.add_argument('--whisper_version', type=int, default=2, help='Version of the whisper release')
    parser.add_argument('--multilingual', type=bool, default='store_true', help='Whether or not the model is multilingual or english only')
    ...
    if args.convert_tokenizer:
        try:
            ...
            convert_tiktoken_to_hf(args.pytorch_dump_folder_path, args.multilingual, NUM_LANGUAGES_PER_RELEASE[args.whisper_version])
