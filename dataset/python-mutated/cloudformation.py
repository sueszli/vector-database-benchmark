...
class InitFile(AWSProperty):
    ...
    Export:
    """
    props = {'content': (str, False), 'mode': (str, False), 'owner': (str, False), 'encoding': (encoding, False), 'group': (str, False), 'source': (str, False), 'authentication': (str, False), 'context': (InitFileContext, False)}
...
class InitService(AWSProperty):
    ...
    Export:
    """
    props = {'ensureRunning': (boolean, False), 'enabled': (boolean, False), 'files': (list, False), 'packages': (dict, False), 'sources': (list, False), 'commands': (list, False)}
...
class InitConfig(AWSProperty):
    ...
    Export:
    """
    props = {'groups': (dict, False), 'users': (dict, False), 'sources': (dict, False), 'packages': (dict, False), 'files': (dict, False), 'commands': (dict, False), 'services': (dict, False)}
...
class AuthenticationBlock(AWSProperty):
    ...
    Export:
    """
    props = {'accessKeyId': (str, False), 'buckets': ([str], False), 'password': (str, False), 'secretKey': (str, False), 'type': (validate_authentication_type, False), 'uris': ([str], False), 'username': (str, False), 'roleName': (str, False)}
