...
_iterate_map: dict[type[flow.Flow], Callable[[Any], TEventGenerator]] = {http.HTTPFlow: _iterate_http, tcp.TCPFlow: _iterate_tcp, udp.UDPFlow: _iterate_udp, dns.DNSFlow: _iterate_dns}
