...
from zerver.lib.validator import check_dict_only, check_external_account_url_pattern, check_required_string
...
class ExternalAccount:
    ...
    hint: str
    url_pattern: str
DEFAULT_EXTERNAL_ACCOUNTS = {'twitter': ExternalAccount(text='Twitter', url_pattern='https://twitter.com/%(username)s', name=gettext_lazy('Twitter username'), hint=''), 'github': ExternalAccount(text='GitHub', url_pattern='https://github.com/%(username)s', name=gettext_lazy('GitHub username'), hint='')}
