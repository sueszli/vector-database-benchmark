...
def main():
    ...
    response = client.app_service_environments.list_worker_pool_instance_metric_definitions(resource_group_name='test-rg', name='test-ase', worker_pool_name='0', instance='10.8.0.7')
