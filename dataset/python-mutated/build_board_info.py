...
from shared_bindings_matrix import SUPPORTED_PORTS, support_matrix_by_board, get_board_mapping
LANGUAGE_ALLOW_LIST = set(['ID', 'de_DE', 'en_GB', 'en_US', 'en_x_pirate', 'es', 'fil', 'fr', 'it_IT', 'ja', 'nl', 'pl', 'pt_BR', 'ru', 'sv', 'tr', 'zh_Latn_pinyin'])
