...
class sfp_tool_onesixtyone(SpiderFootPlugin):
    meta = {'name': 'Tool - onesixtyone', 'summary': 'Fast scanner to find publicly exposed SNMP services.', 'flags': ['tool'], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Crawling and Scanning'], 'toolDetails': {'name': 'onesixtyone', 'description': 'onesixtyone is a fast scanner for finding publicly exposed SNMP services.', 'website': 'https://github.com/trailofbits/onesixtyone', 'repository': 'https://github.com/trailofbits/onesixtyone'}}
    opts = {'onesixtyone_path': '', 'communities': '1234,2read,4changes,CISCO,IBM,OrigEquipMfr,SNMP,SUN,access,admin,agent,all,cisco,community,default,enable,field,guest,hello,ibm,manager,mngt,monitor,netman,network,none,openview,pass,password,private,proxy,public,read,read-only,read-write,root,router,secret,security,snmp,snmpd,solaris,sun,switch,system,tech,test,world,write', 'netblockscan': True, 'netblockscanmax': 24}
    optdescs = {'onesixtyone_path': 'The path to your onesixtyone binary. Must be set.', 'communities': 'Comma-separated list of SNMP communities to try.', 'netblockscan': 'Scan all IPs within identified owned netblocks?', 'netblockscanmax': 'Maximum netblock/subnet size to scan IPs within (CIDR value, 24 = /24, 16 = /16, etc.)'}
    results = None
    errorState = False
