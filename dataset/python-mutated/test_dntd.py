...
def dntd_val():
    ...
    (ori_loss, ori_td_err) = dist_nstep_td_error(dist_nstep_td_data(ori_dist, ori_next_n_dist, ori_action, ori_next_n_action, ori_reward, ori_done, ori_weight), gamma, v_min, v_max, n_atom, T)
