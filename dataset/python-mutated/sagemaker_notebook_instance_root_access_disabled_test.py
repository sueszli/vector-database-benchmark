...
class Test_sagemaker_notebook_instance_root_access_disabled:
    ...
    def test_no_instances(self):
        ...
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_notebook_instance_root_access_disabled.sagemaker_notebook_instance_root_access_disabled import sagemaker_notebook_instance_root_access_disabled
    ...
    def test_instance_root_access_disabled(self):
        ...
        sagemaker_client = mock.MagicMock
        sagemaker_client.sagemaker_notebook_instances = []
        sagemaker_client.sagemaker_notebook_instances.append(NotebookInstance(name=test_notebook_instance, arn=notebook_instance_arn, region=AWS_REGION, root_access=False))
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_notebook_instance_root_access_disabled.sagemaker_notebook_instance_root_access_disabled import sagemaker_notebook_instance_root_access_disabled
            check = sagemaker_notebook_instance_root_access_disabled()
            result = check.execute()
