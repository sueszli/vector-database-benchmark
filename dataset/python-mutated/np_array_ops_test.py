...
class StringArrayTest(test.TestCase, parameterized.TestCase):
    StringParameters = parameterized.named_parameters(('str_u8', 'abcde🀅', 'U8', b'abcde\xf0\x9f\x80\x85'), ('str_s8', 'abcde🀅', 'S8', b'abcde\xf0\x9f\x80\x85'), ('str_none', 'abcde🀅', None, b'abcde\xf0\x9f\x80\x85'), ('zstr_u8', '\x00abcde🀅', 'U8', b'\x00abcde\xf0\x9f\x80\x85'), ('zstr_s8', '\x00abcde🀅', 'S8', b'\x00abcde\xf0\x9f\x80\x85'), ('zstr_none', '\x00abcde🀅', None, b'\x00abcde\xf0\x9f\x80\x85'), ('bytes_u8', b'abcdef', 'U8', b'abcdef'), ('bytes_s8', b'abcdef', 'S8', b'abcdef'), ('bytes_none', b'abcdef', None, b'abcdef'), ('zbytes_u8', b'\x00abcdef', 'U8', b'\x00abcdef'), ('zbytes_s8', b'\x00abcdef', 'S8', b'\x00abcdef'), ('zbytes_none', b'\x00abcdef', None, b'\x00abcdef'))
