...
class ProgressBar(BaseLogger):
    ...
    """
    _events_order: List[Union[Events, CallableEventWithFilter]] = [Events.STARTED, Events.EPOCH_STARTED, Events.ITERATION_STARTED, Events.ITERATION_COMPLETED, Events.EPOCH_COMPLETED, Events.COMPLETED]
