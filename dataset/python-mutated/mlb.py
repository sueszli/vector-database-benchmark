...
class MLBVideoIE(MLBBaseIE):
    ...
    _TEST = {'url': 'https://www.mlb.com/mariners/video/ackley-s-spectacular-catch-c34698933', 'md5': '632358dacfceec06bad823b83d21df2d', 'info_dict': {'id': 'c04a8863-f569-42e6-9f87-992393657614', 'ext': 'mp4', 'title': "Ackley's spectacular catch", 'description': 'md5:7f5a981eb4f3cbc8daf2aeffa2215bf0', 'duration': 66, 'timestamp': 1405995000, 'upload_date': '20140722', 'thumbnail': 're:^https?://.+'}}
...
class MLBTVIE(InfoExtractor):
    ...
    _NETRC_MACHINE = 'mlb'
    _TESTS = [{'url': 'https://www.mlb.com/tv/g661581/vee2eff5f-a7df-4c20-bdb4-7b926fa12638', 'info_dict': {'id': '661581', 'ext': 'mp4', 'title': '2022-07-02 - St. Louis Cardinals @ Philadelphia Phillies'}, 'params': {'skip_download': True}}]
    _access_token = None
...
class MLBArticleIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.mlb.com/news/manny-machado-robs-guillermo-heredia-reacts', 'info_dict': {'id': '36db7394-343c-4ea3-b8ca-ead2e61bca9a', 'title': "Machado's grab draws hilarious irate reaction", 'modified_timestamp': 1650130737, 'description': 'md5:a19d4eb0487b2cb304e9a176f6b67676', 'modified_date': '20220416'}, 'playlist_count': 2}]
