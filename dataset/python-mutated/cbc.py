...
from ..utils import ExtractorError, int_or_none, join_nonempty, js_to_json, orderedSet, parse_iso8601, smuggle_url, strip_or_none, traverse_obj, try_get

class CBCIE(InfoExtractor):
    IE_NAME = 'cbc.ca'
    _VALID_URL = 'https?://(?:www\\.)?cbc\\.ca/(?!player/)(?:[^/]+/)+(?P<id>[^/?#]+)'
    _TESTS = [{'url': 'http://www.cbc.ca/22minutes/videos/clips-season-23/don-cherry-play-offs', 'md5': '97e24d09672fc4cf56256d6faa6c25bc', 'info_dict': {'id': '2682904050', 'ext': 'mp4', 'title': 'Don Cherry – All-Stars', 'description': 'Don Cherry has a bee in his bonnet about AHL player John Scott because that guy’s got heart.', 'timestamp': 1454463000, 'upload_date': '20160203', 'uploader': 'CBCC-NEW'}, 'skip': 'Geo-restricted to Canada'}, {'url': 'http://www.cbc.ca/22minutes/videos/22-minutes-update/22-minutes-update-episode-4', 'md5': '162adfa070274b144f4fdc3c3b8207db', 'info_dict': {'id': '2414435309', 'ext': 'mp4', 'title': '22 Minutes Update: What Not To Wear Quebec', 'description': "This week's latest Canadian top political story is What Not To Wear Quebec.", 'upload_date': '20131025', 'uploader': 'CBCC-NEW', 'timestamp': 1382717907}, 'skip': 'No longer available'}, {'url': 'http://www.cbc.ca/archives/entry/1978-robin-williams-freestyles-on-90-minutes-live', 'md5': '0274a90b51a9b4971fe005c63f592f12', 'info_dict': {'id': '2487345465', 'ext': 'mp4', 'title': 'Robin Williams freestyles on 90 Minutes Live', 'description': 'Wacky American comedian Robin Williams shows off his infamous "freestyle" comedic talents while being interviewed on CBC\'s 90 Minutes Live.', 'upload_date': '19780210', 'uploader': 'CBCC-NEW', 'timestamp': 255977160}, 'skip': '404 Not Found'}, {'url': 'http://www.cbc.ca/natureofthings/blog/birds-eye-view-from-vancouvers-burrard-street-bridge-how-we-got-the-shot', 'playlist': [{'md5': '377572d0b49c4ce0c9ad77470e0b96b4', 'info_dict': {'id': '2680832926', 'ext': 'mp4', 'title': "An Eagle's-Eye View Off Burrard Bridge", 'description': "Hercules the eagle flies from Vancouver's Burrard Bridge down to a nearby park with a mini-camera strapped to his back.", 'upload_date': '20160201', 'timestamp': 1454342820, 'uploader': 'CBCC-NEW'}}, {'md5': '415a0e3f586113894174dfb31aa5bb1a', 'info_dict': {'id': '2658915080', 'ext': 'mp4', 'title': 'Fly like an eagle!', 'description': "Eagle equipped with a mini camera flies from the world's tallest tower", 'upload_date': '20150315', 'timestamp': 1426443984, 'uploader': 'CBCC-NEW'}}], 'skip': 'Geo-restricted to Canada'}, {'url': 'http://www.cbc.ca/news/canada/calgary/dog-indoor-exercise-winter-1.3928238', 'info_dict': {'title': 'Keep Rover active during the deep freeze with doggie pushups and other fun indoor tasks', 'id': 'dog-indoor-exercise-winter-1.3928238', 'description': 'md5:c18552e41726ee95bd75210d1ca9194c'}, 'playlist_mincount': 6}]
...
class CBCPlayerPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.cbc.ca/player/news/TV%20Shows/The%20National/Latest%20Broadcast', 'playlist_mincount': 25, 'info_dict': {'id': 'news/tv shows/the national/latest broadcast'}}, {'url': 'https://www.cbc.ca/player/news/Canada/North', 'playlist_mincount': 25, 'info_dict': {'id': 'news/canada/north'}}]
...
class CBCGemIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://gem.cbc.ca/media/schitts-creek/s06e01', 'md5': '93dbb31c74a8e45b378cf13bd3f6f11e', 'info_dict': {'id': 'schitts-creek/s06e01', 'ext': 'mp4', 'title': 'Smoke Signals', 'description': 'md5:929868d20021c924020641769eb3e7f1', 'thumbnail': 'https://images.radio-canada.ca/v1/synps-cbc/episode/perso/cbc_schitts_creek_season_06e01_thumbnail_v01.jpg?im=Resize=(Size)', 'duration': 1314, 'categories': ['comedy'], 'series': "Schitt's Creek", 'season': 'Season 6', 'season_number': 6, 'episode': 'Smoke Signals', 'episode_number': 1, 'episode_id': 'schitts-creek/s06e01'}, 'params': {'format': 'bv'}, 'skip': 'Geo-restricted to Canada'}, {'url': 'https://gem.cbc.ca/media/schitts-creek/s01e01', 'md5': '297a9600f554f2258aed01514226a697', 'info_dict': {'id': 'schitts-creek/s01e01', 'ext': 'mp4', 'title': 'The Cup Runneth Over', 'description': 'md5:9bca14ea49ab808097530eb05a29e797', 'thumbnail': 'https://images.radio-canada.ca/v1/synps-cbc/episode/perso/cbc_schitts_creek_season_01e01_thumbnail_v01.jpg?im=Resize=(Size)', 'series': "Schitt's Creek", 'season_number': 1, 'season': 'Season 1', 'episode_number': 1, 'episode': 'The Cup Runneth Over', 'episode_id': 'schitts-creek/s01e01', 'duration': 1309, 'categories': ['comedy']}, 'params': {'format': 'bv'}, 'skip': 'Geo-restricted to Canada'}, {'url': 'https://gem.cbc.ca/nadiyas-family-favourites/s01e01', 'only_matching': True}]
    _GEO_COUNTRIES = ['CA']
...
class CBCGemPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://gem.cbc.ca/media/schitts-creek/s06', 'playlist_count': 16, 'info_dict': {'id': 'schitts-creek/s06', 'title': 'Season 6', 'description': 'md5:6a92104a56cbeb5818cc47884d4326a2', 'series': "Schitt's Creek", 'season_number': 6, 'season': 'Season 6', 'thumbnail': 'https://images.radio-canada.ca/v1/synps-cbc/season/perso/cbc_schitts_creek_season_06_carousel_v03.jpg?impolicy=ott&im=Resize=(_Size_)&quality=75'}}, {'url': 'https://gem.cbc.ca/schitts-creek/s06', 'only_matching': True}]
...
class CBCGemLiveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://gem.cbc.ca/live/920604739687', 'info_dict': {'title': 'Ottawa', 'description': 'The live TV channel and local programming from Ottawa', 'thumbnail': 'https://thumbnails.cbc.ca/maven_legacy/thumbnails/CBC_OTT_VMS/Live_Channel_Static_Images/Ottawa_2880x1620.jpg', 'is_live': True, 'id': 'AyqZwxRqh8EH', 'ext': 'mp4', 'timestamp': 1492106160, 'upload_date': '20170413', 'uploader': 'CBCC-NEW'}, 'skip': 'Live might have ended'}, {'url': 'https://gem.cbc.ca/live/44', 'info_dict': {'id': '44', 'ext': 'mp4', 'is_live': True, 'title': 're:^Ottawa [0-9\\-: ]+', 'description': 'The live TV channel and local programming from Ottawa', 'live_status': 'is_live', 'thumbnail': 're:https://images.gem.cbc.ca/v1/cbc-gem/live/.*'}, 'params': {'skip_download': True}, 'skip': 'Live might have ended'}, {'url': 'https://gem.cbc.ca/live-event/10835', 'info_dict': {'id': '10835', 'ext': 'mp4', 'is_live': True, 'title': 're:^The National \\| Biden’s trip wraps up, Paltrow testifies, Bird flu [0-9\\-: ]+', 'description': 'March 24, 2023 | President Biden’s Ottawa visit ends with big pledges from both countries. Plus, Gwyneth Paltrow testifies in her ski collision trial.', 'live_status': 'is_live', 'thumbnail': 're:https://images.gem.cbc.ca/v1/cbc-gem/live/.*', 'timestamp': 1679706000, 'upload_date': '20230325'}, 'params': {'skip_download': True}, 'skip': 'Live might have ended'}]
