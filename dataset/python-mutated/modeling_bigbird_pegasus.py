...
BIGBIRD_PEGASUS_PRETRAINED_MODEL_ARCHIVE_LIST = ['google/bigbird-pegasus-large-arxiv', 'google/bigbird-pegasus-large-pubmed', 'google/bigbird-pegasus-large-bigpatent']
