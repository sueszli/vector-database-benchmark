...
class privatecatalogCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'search_catalogs': ('resource', 'query', 'page_size', 'page_token'), 'search_products': ('resource', 'query', 'page_size', 'page_token'), 'search_versions': ('resource', 'query', 'page_size', 'page_token')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=privatecatalogCallTransformer()):
    if False:
        print('Hello World!')
