...
class RoombaVacuumCarpetBoost(RoombaVacuum):
    ...
    async def async_set_fan_speed(self, fan_speed, **kwargs):
        ...
        if fan_speed == FAN_SPEED_AUTOMATIC:
            ...
            return
        await self.hass.async_add_executor_job(self.vacuum.set_preference, 'carpetBoost', str(carpet_boost))
        await self.hass.async_add_executor_job(self.vacuum.set_preference, 'vacHigh', str(high_perf))