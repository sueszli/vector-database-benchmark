...
from .validators.elasticache import validate_cache_cluster, validate_network_port, validate_node_group_id, validate_replication_group
...
class CloudWatchLogsDestinationDetails(AWSProperty):
    ...
    """
    props: PropsDictType = {'LogGroup': (str, True)}
...
class KinesisFirehoseDestinationDetails(AWSProperty):
    ...
    """
    props: PropsDictType = {'DeliveryStream': (str, True)}
...
class DestinationDetails(AWSProperty):
    ...
    """
    props: PropsDictType = {'CloudWatchLogsDetails': (CloudWatchLogsDestinationDetails, False), 'KinesisFirehoseDetails': (KinesisFirehoseDestinationDetails, False)}
...
class LogDeliveryConfigurationRequest(AWSProperty):
    ...
    """
    props: PropsDictType = {'DestinationDetails': (DestinationDetails, True), 'DestinationType': (str, True), 'LogFormat': (str, True), 'LogType': (str, True)}
...
class GlobalReplicationGroupMember(AWSProperty):
    ...
    """
    props: PropsDictType = {'ReplicationGroupId': (str, False), 'ReplicationGroupRegion': (str, False), 'Role': (str, False)}
...
class ReshardingConfiguration(AWSProperty):
    ...
    """
    props: PropsDictType = {'NodeGroupId': (str, False), 'PreferredAvailabilityZones': ([str], False)}
...
class RegionalConfiguration(AWSProperty):
    ...
    """
    props: PropsDictType = {'ReplicationGroupId': (str, False), 'ReplicationGroupRegion': (str, False), 'ReshardingConfigurations': ([ReshardingConfiguration], False)}
...
class NodeGroupConfiguration(AWSProperty):
    ...
    """
    props: PropsDictType = {'NodeGroupId': (validate_node_group_id, False), 'PrimaryAvailabilityZone': (str, False), 'ReplicaAvailabilityZones': ([str], False), 'ReplicaCount': (integer, False), 'Slots': (str, False)}
...
class SecurityGroup(AWSObject):
    ...
    props: PropsDictType = {'Description': (str, True), 'Tags': (Tags, False)}
...
class SecurityGroupIngress(AWSObject):
    ...
    props: PropsDictType = {'CacheSecurityGroupName': (str, True), 'EC2SecurityGroupName': (str, True), 'EC2SecurityGroupOwnerId': (str, False)}
...
class SubnetGroup(AWSObject):
    ...
    props: PropsDictType = {'CacheSubnetGroupName': (str, False), 'Description': (str, True), 'SubnetIds': ([str], True), 'Tags': (Tags, False)}
...
class AuthenticationMode(AWSProperty):
    ...
    """
    props: PropsDictType = {'Passwords': ([str], False), 'Type': (str, True)}
...
class User(AWSObject):
    ...
    props: PropsDictType = {'AccessString': (str, False), 'AuthenticationMode': (AuthenticationMode, False), 'Engine': (str, True), 'NoPasswordRequired': (boolean, False), 'Passwords': ([str], False), 'Tags': (Tags, False), 'UserId': (str, True), 'UserName': (str, True)}
...
class UserGroup(AWSObject):
    ...
    props: PropsDictType = {'Engine': (str, True), 'Tags': (Tags, False), 'UserGroupId': (str, True), 'UserIds': ([str], True)}