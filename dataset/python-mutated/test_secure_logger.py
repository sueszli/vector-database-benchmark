...
class MockSource(Source):
    ...
    def check(self, **kwargs):
        if False:
            ...
            return i + 15
        pass
spec_with_airbyte_secrets = {'type': 'object', 'required': ['api_token'], 'additionalProperties': False, 'properties': {SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': True}, NOT_SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': False}}}
spec_with_airbyte_secrets_config = {SECRET_PROPERTY: I_AM_A_SECRET_VALUE, NOT_SECRET_PROPERTY: NOT_A_SECRET_VALUE}
spec_with_multiple_airbyte_secrets = {'type': 'object', 'required': ['api_token'], 'additionalProperties': True, 'properties': {SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': True}, ANOTHER_SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': True}, NOT_SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': False}, ANOTHER_NOT_SECRET_PROPERTY: {'type': 'string'}}}
spec_with_multiple_airbyte_secrets_config = {SECRET_PROPERTY: I_AM_A_SECRET_VALUE, NOT_SECRET_PROPERTY: NOT_A_SECRET_VALUE, ANOTHER_SECRET_PROPERTY: ANOTHER_SECRET_VALUE, ANOTHER_NOT_SECRET_PROPERTY: ANOTHER_NOT_SECRET_VALUE}
spec_with_airbyte_secrets_not_string = {'type': 'object', 'required': ['api_token'], 'additionalProperties': True, 'properties': {SECRET_PROPERTY: {'type': 'string', 'airbyte_secret': True}, ANOTHER_SECRET_PROPERTY: {'type': 'integer', 'airbyte_secret': True}}}
spec_with_airbyte_secrets_not_string_config = {SECRET_PROPERTY: I_AM_A_SECRET_VALUE, ANOTHER_SECRET_PROPERTY: SECRET_INTEGER_VALUE}
