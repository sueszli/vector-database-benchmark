...
class DebugIncidentActivityEmailView(View):
    ...
    def get(self, request: HttpRequest) -> HttpResponse:
        ...
        incident = Incident(id=2, identifier=123, organization=organization, title='Something broke')
        activity = IncidentActivity(incident=incident, user=user, type=IncidentActivityType.COMMENT.value, comment='hi')
