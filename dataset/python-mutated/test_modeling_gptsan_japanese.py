import unittest
import numpy as np
from transformers import GPTSanJapaneseConfig, GPTSanJapaneseForConditionalGeneration, GPTSanJapaneseModel, GPTSanJapaneseTokenizer, is_torch_available
...
class GPTSanJapaneseTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'conversational': GPTSanJapaneseForConditionalGeneration, 'feature-extraction': GPTSanJapaneseForConditionalGeneration, 'summarization': GPTSanJapaneseForConditionalGeneration, 'text2text-generation': GPTSanJapaneseForConditionalGeneration, 'translation': GPTSanJapaneseForConditionalGeneration} if is_torch_available() else {}
    fx_compatible = False
