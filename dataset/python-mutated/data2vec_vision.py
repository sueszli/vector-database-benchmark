...
class Data2VecVisionConfig(FairseqDataclass):
    layer_scale_init_value: float = field(default=0.0001, metadata={'help': 'rescale layer outputs, 0 to disable'})
    num_mask_patches: int = field(default=75, metadata={'help': 'number of the visual tokens/patches need be masked'})
    ...
    ema_transformer_only: bool = field(default=True, metadata={'help': 'whether to momentum update only the transformer layers'})
