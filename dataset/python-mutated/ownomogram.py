...
import numpy as np
from AnyQt.QtWidgets import QGraphicsView, QGraphicsScene, QGraphicsItem, QGraphicsSimpleTextItem, QGraphicsTextItem, QGraphicsLineItem, QGraphicsWidget, QGraphicsRectItem, QGraphicsEllipseItem, QGraphicsLinearLayout, QGridLayout, QLabel, QFrame, QSizePolicy, QFormLayout
...
from Orange.data import Table, Domain, DiscreteVariable, ContinuousVariable, Variable
...
class OWNomogram(OWWidget):
    name = 'Nomogram'
    description = ' Nomograms for Visualization of Naive Bayesian and Logistic Regression Classifiers.'
    ...
    class Error(OWWidget.Error):
        invalid_classifier = Msg('Nomogram accepts only Naive Bayes and Logistic Regression classifiers.')
