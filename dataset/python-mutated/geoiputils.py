...
PARSERS: Dict[str, List[Tuple[Callable, List[str], Dict[str, Any]]]] = {'GeoLite2-City-CSV.zip': [(unzip_all, ['GeoLite2-City-CSV.zip'], {'cond': lambda fdesc: fdesc.filename.endswith('.csv')})], 'GeoLite2-Country-CSV.zip': [(unzip_all, ['GeoLite2-Country-CSV.zip'], {'cond': lambda fdesc: fdesc.filename.endswith('.csv')})], 'GeoLite2-ASN-CSV.zip': [(unzip_all, ['GeoLite2-ASN-CSV.zip'], {'cond': lambda fdesc: fdesc.filename.endswith('.csv')})], 'GeoLite2-City.tar.gz': [(gunzip, ['GeoLite2-City.tar.gz'], {}), (untar_all, ['GeoLite2-City.tar'], {'cond': lambda fdesc: fdesc.name.endswith('.mmdb')})], 'GeoLite2-Country.tar.gz': [(gunzip, ['GeoLite2-Country.tar.gz'], {}), (untar_all, ['GeoLite2-Country.tar'], {'cond': lambda fdesc: fdesc.name.endswith('.mmdb')})], 'GeoLite2-ASN.tar.gz': [(gunzip, ['GeoLite2-ASN.tar.gz'], {}), (untar_all, ['GeoLite2-ASN.tar'], {'cond': lambda fdesc: fdesc.name.endswith('.mmdb')})], 'GeoLite2-dumps.tar.gz': [(gunzip, ['GeoLite2-dumps.tar.gz'], {}), (untar_all, ['GeoLite2-dumps.tar'], {'cond': lambda fdesc: fdesc.name.endswith('.csv')})], 'BGP.raw': [(bgp_raw_to_csv, ['BGP.raw', 'BGP.csv'], {})]}
