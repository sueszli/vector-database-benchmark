...
from prowler.providers.aws.services.directoryservice.directoryservice_service import AuthenticationProtocol
    ...
    def execute(self):
        ...
        for directory in directoryservice_client.directories.values():
            if directory.radius_settings:
                ...
                if directory.radius_settings.authentication_protocol == AuthenticationProtocol.MS_CHAPv2:
                    report.status = 'PASS'
