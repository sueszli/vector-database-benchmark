...
import transformers
from transformers import AutoConfig, AutoModelForSequenceClassification, AutoTokenizer, DataCollatorWithPadding, EvalPrediction, HfArgumentParser, Trainer, TrainingArguments, default_data_collator, set_seed
...
class DataTrainingArguments:
    ...
    text_column_names: Optional[str] = field(default=None, metadata={'help': 'The name of the text column in the input dataset or a CSV/JSON file. If not specified, will use the "sentence" column for single/multi-label classifcation task.'})
    ...
    label_column_name: Optional[str] = field(default=None, metadata={'help': 'The name of the label column in the input dataset or a CSV/JSON file. If not specified, will use the "label" column for single/multi-label classifcation task'})
