...
from mypy.nodes import ARG_NAMED, ARG_POS, MDEF, AssignmentStmt, CallExpr, Context, DictExpr, EnumCallExpr, Expression, ListExpr, MemberExpr, NameExpr, RefExpr, StrExpr, SymbolTableNode, TupleExpr, TypeInfo, Var, is_StrExpr_list
...
ENUM_SPECIAL_PROPS: Final = frozenset(('name', 'value', '_name_', '_value_', *ENUM_REMOVED_PROPS, '__module__', '__annotations__', '__doc__', '__slots__', '__dict__'))
