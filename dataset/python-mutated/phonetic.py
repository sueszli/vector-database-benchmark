...
class Editex(_Base):
    ...
    """
    groups: tuple[frozenset[str], ...] = (frozenset('AEIOUY'), frozenset('BP'), frozenset('CKQ'), frozenset('DT'), frozenset('LR'), frozenset('MN'), frozenset('GJ'), frozenset('FPV'), frozenset('SXZ'), frozenset('CSZ'))
    ungrouped = frozenset('HW')
