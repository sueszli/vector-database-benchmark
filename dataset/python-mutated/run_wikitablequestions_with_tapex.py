...
import transformers
from transformers import AutoConfig, BartForConditionalGeneration, DataCollatorForSeq2Seq, HfArgumentParser, Seq2SeqTrainer, Seq2SeqTrainingArguments, TapexTokenizer, set_seed
...
class ModelArguments:
    ...
    tokenizer_name: Optional[str] = field(default=None, metadata={'help': 'Pretrained tokenizer name or path if not the same as model_name. By default we use BART-large tokenizer for TAPEX-large.'})
...
class DataTrainingArguments:
    ...
    """
    dataset_name: Optional[str] = field(default='wikitablequestions', metadata={'help': 'The name of the dataset to use (via the datasets library).'})
