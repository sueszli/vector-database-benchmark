...
from azure.ai.language.questionanswering._operations._operations import build_question_answering_get_answers_from_text_request as build_get_answers_from_text_request
