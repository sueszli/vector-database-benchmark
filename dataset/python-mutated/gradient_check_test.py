...
if workspace.has_gpu_support and workspace.NumGpuDevices() > 0:
    ...
    gpu_device_checker = device_checker.DeviceChecker(0.01, [_gpu_dev_option])
    device_checker = device_checker.DeviceChecker(0.01, [_gpu_dev_option, cpu_device_option])
    gpu_gradient_checkers = [gradient_checker.GradientChecker(0.005, 0.05, _gpu_dev_option, 'gpu_checker_ws')]
    gradient_checkers = [gradient_checker.GradientChecker(0.005, 0.05, _gpu_dev_option, 'gpu_checker_ws'), gradient_checker.GradientChecker(0.01, 0.05, cpu_device_option, 'cpu_checker_ws')]
