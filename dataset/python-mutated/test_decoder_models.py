...
PEFT_DECODER_MODELS_TO_TEST = ['hf-internal-testing/tiny-random-OPTForCausalLM', 'hf-internal-testing/tiny-random-GPTNeoXForCausalLM', 'hf-internal-testing/tiny-random-GPT2LMHeadModel', 'hf-internal-testing/tiny-random-BloomForCausalLM', 'hf-internal-testing/tiny-random-gpt_neo', 'hf-internal-testing/tiny-random-GPTJForCausalLM', 'hf-internal-testing/tiny-random-GPTBigCodeForCausalLM', 'HuggingFaceM4/tiny-random-LlamaForCausalLM']
FULL_GRID = {'model_ids': PEFT_DECODER_MODELS_TO_TEST, 'task_type': 'CAUSAL_LM'}
