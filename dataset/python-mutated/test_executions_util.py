...
TEST_FIXTURES = {'liveactions': ['liveaction1.yaml', 'parentliveaction.yaml', 'childliveaction.yaml', 'successful_liveaction.yaml'], 'actions': ['local.yaml'], 'executions': ['execution1.yaml'], 'runners': ['run-local.yaml'], 'triggertypes': ['triggertype2.yaml'], 'rules': ['rule3.yaml'], 'triggers': ['trigger2.yaml'], 'triggerinstances': ['trigger_instance_1.yaml']}
