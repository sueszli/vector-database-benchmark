...
Example usage:
    python create_asset.py --project_id <project-id> --location <location>         --asset_id <asset-id> --asset_uri <asset-uri>
"""
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--location', help='The location in which to create the asset.', default='us-central1')
    parser.add_argument('--asset_id', help='The user-defined asset ID.', required=True)
    parser.add_argument('--asset_uri', help="The asset URI (e.g., 'gs://my-bucket/my-video.mp4').", required=True)
    args = parser.parse_args()
    create_asset(args.project_id, args.location, args.asset_id, args.asset_uri)