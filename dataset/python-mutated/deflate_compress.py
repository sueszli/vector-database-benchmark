...
def compress_error(data, *args):
    ...
    try:
        ...
        print('ValueError')
PATTERNS_RAW = ((b'0', b'3\x00\x00'), (b'a', b'K\x04\x00'), (b'0' * 100, b'3\xa0\x03\x00\x00'), (bytes(range(64)), b'c`dbfaec\xe7\xe0\xe4\xe2\xe6\xe1\xe5\xe3\x17\x10\x14\x12\x16\x11\x15\x13\x97\x90\x94\x92\x96\x91\x95\x93WPTRVQUS\xd7\xd0\xd4\xd2\xd6\xd1\xd5\xd370426153\xb7\xb0\xb4\xb2\xb6\xb1\xb5\xb3\x07\x00'))
...
check_header('ZLIB(9)', compress(unpacked, deflate.ZLIB, 9), b'\x18\x95' + packed + b'\x06,\x02\x15')
check_header('ZLIB(15)', compress(unpacked, deflate.ZLIB, 15), b'x\x9c' + packed + b'\x06,\x02\x15')
check_header('GZIP', compress(unpacked, deflate.GZIP, 9), b'\x1f\x8b\x08\x00\x00\x00\x00\x00\x04\x03' + packed + b'\x86\xa6\x106\x05\x00\x00\x00')
