...
DATASET_GENERATORS = {'perturbed_logarithm': generate_perturbed_logarithm_dataset, 'logistic': generate_logistic_dataset, 'pathological': generate_pathological_dataset}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--iterations', type=int, required=True, help='Number of iterations to average timings over for each problem size')
    parser.add_argument('--log_min_problem_size', type=int, required=True, help='Base 10 logarithm of the minimum problem size')
    parser.add_argument('--log_max_problem_size', type=int, required=True, help='Base 10 logarithm of the maximum problem size')
