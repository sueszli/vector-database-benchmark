...
from sentry.db.models import BoundedPositiveIntegerField, FlexibleForeignKey, ParanoidManager, ParanoidModel, control_silo_only_model
...
class SentryAppInstallation(ReplicatedControlModel, ParanoidModel):
    ...
    objects: ClassVar[SentryAppInstallationForProviderManager] = SentryAppInstallationForProviderManager()
