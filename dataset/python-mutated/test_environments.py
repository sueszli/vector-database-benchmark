...
def connector_context(dagger_client):
    if False:
        i = 10
        return i + 15
    context = ConnectorContext(pipeline_name='test', connector='source-faker', git_branch='test', git_revision='test', report_output_prefix='test', is_local=True, use_remote_secrets=True)
