...
from pip._internal.metadata.pkg_resources import Distribution, Environment, InMemoryMetadata
...
class _MockWorkingSet(List[mock.Mock]):
    ...
    def require(self, name: str) -> None:
        if False:
            print('Hello World!')
        pass
workingset = _MockWorkingSet((mock.Mock(test_name='global', project_name='global'), mock.Mock(test_name='editable', project_name='editable'), mock.Mock(test_name='normal', project_name='normal'), mock.Mock(test_name='user', project_name='user')))
workingset_stdlib = _MockWorkingSet((mock.Mock(test_name='normal', project_name='argparse'), mock.Mock(test_name='normal', project_name='wsgiref')))
