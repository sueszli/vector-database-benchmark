...
import csv
import operator
sg.SetOptions(background_color='LightGrey', element_background_color='LightGrey')
...
def table_example():
    ...
    (b, v) = window.Read()
slayout = [[sg.Text('      Load AFL (csv) file to display sorted results.', font=('Calibri', 16, 'bold')), sg.ReadButton('Load File', font=('Calibri', 16, 'bold'), button_color=('Red', 'White'), size=(10, 1))]]
