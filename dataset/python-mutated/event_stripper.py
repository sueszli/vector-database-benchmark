...
class Allow(Enum):
    ...
    def with_explanation(self, explanation: str) -> 'Allow':
        ...
        self.explanation = explanation
        return self
EVENT_DATA_ALLOWLIST = {'type': Allow.SIMPLE_TYPE, 'datetime': Allow.SIMPLE_TYPE, 'timestamp': Allow.SIMPLE_TYPE, 'platform': Allow.SIMPLE_TYPE, 'sdk': {'name': Allow.SIMPLE_TYPE, 'version': Allow.SIMPLE_TYPE, 'integrations': Allow.NEVER.with_explanation('Users can add their own integrations.')}, 'exception': {'values': {'stacktrace': {'frames': {'filename': Allow.SIMPLE_TYPE.with_explanation("We overwrite the filename for SDK frames and it's acceptable to keep it for system library frames."), 'function': Allow.SIMPLE_TYPE, 'raw_function': Allow.SIMPLE_TYPE, 'module': Allow.SIMPLE_TYPE, 'abs_path': Allow.SIMPLE_TYPE, 'in_app': Allow.SIMPLE_TYPE, 'instruction_addr': Allow.SIMPLE_TYPE, 'addr_mode': Allow.SIMPLE_TYPE, 'symbol': Allow.SIMPLE_TYPE, 'symbol_addr': Allow.SIMPLE_TYPE, 'image_addr': Allow.SIMPLE_TYPE, 'package': Allow.SIMPLE_TYPE, 'platform': Allow.SIMPLE_TYPE}}, 'value': Allow.NEVER.with_explanation('The exception value could contain PII.'), 'type': Allow.SIMPLE_TYPE, 'mechanism': {'handled': Allow.SIMPLE_TYPE, 'type': Allow.SIMPLE_TYPE, 'meta': {'signal': {'number': Allow.SIMPLE_TYPE, 'code': Allow.SIMPLE_TYPE, 'name': Allow.SIMPLE_TYPE, 'code_name': Allow.SIMPLE_TYPE}, 'mach_exception': {'exception': Allow.SIMPLE_TYPE, 'code': Allow.SIMPLE_TYPE, 'subcode': Allow.SIMPLE_TYPE, 'name': Allow.SIMPLE_TYPE}}}}}, 'contexts': {'device': {'family': Allow.SIMPLE_TYPE, 'model': Allow.SIMPLE_TYPE, 'arch': Allow.SIMPLE_TYPE, 'simulator': Allow.SIMPLE_TYPE}, 'os': {'name': Allow.SIMPLE_TYPE, 'version': Allow.SIMPLE_TYPE, 'build': Allow.SIMPLE_TYPE}}}
