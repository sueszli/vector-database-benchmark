from qt.core import Qt, QDialog, QColor, QDialogButtonBox, QHeaderView, QGridLayout, QTableWidget, QTableWidgetItem, QVBoxLayout, QToolButton, QIcon, QAbstractItemView, QComboBox
