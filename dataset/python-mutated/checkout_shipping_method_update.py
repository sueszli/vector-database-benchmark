...
from ....checkout.utils import delete_external_shipping_id, get_checkout_metadata, invalidate_checkout_prices, is_shipping_required, set_external_shipping_id
...
class CheckoutShippingMethodUpdate(BaseMutation):
    ...
    class Arguments:
        ...
        shipping_method_id = graphene.ID(required=False, default_value=None, description='Shipping method.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventSyncType.SHIPPING_LIST_METHODS_FOR_CHECKOUT, description='Triggered when updating the checkout shipping method with the external one.'), WebhookEventInfo(type=WebhookEventAsyncType.CHECKOUT_UPDATED, description='A checkout was updated.')]
