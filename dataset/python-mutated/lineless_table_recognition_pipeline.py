...
from modelscope.models.cv.table_recognition.lineless_table_process import get_affine_transform_upper_left
...
@PIPELINES.register_module(Tasks.lineless_table_recognition, module_name=Pipelines.lineless_table_recognition)
class LinelessTableRecognitionPipeline(Pipeline):
    """ Lineless Table Recognition Pipeline.
