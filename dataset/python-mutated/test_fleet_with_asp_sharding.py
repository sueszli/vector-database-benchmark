...
class TestFleetWithASPSharding(unittest.TestCase):
    ...
    def net(self, main_prog, startup_prog):
        ...
        with base.program_guard(main_prog, startup_prog):
            ...
            prediction = paddle.static.nn.fc(x=fc_4, size=2, activation='softmax')
            ...
            dist_strategy.sharding_configs = {'sharding_segment_strategy': 'segment_broadcast_MB', 'segment_broadcast_MB': 32, 'segment_anchors': None, 'sharding_degree': 8, 'mp_degree': 1, 'hybrid_dp': False, 'gradient_merge_acc_step': 1}
    ...
    def test_with_asp_sharding(self):
        ...
        if paddle.base.is_compiled_with_cuda():
            place = base.CUDAPlace(int(os.environ.get('FLAGS_selected_gpus', 0)))
        else:
            place = base.CPUPlace()
