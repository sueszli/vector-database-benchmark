...
class StreamcloudIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://streamcloud.eu/skp9j99s4bpz/youtube-dl_test_video_____________-BaW_jenozKc.mp4.html', 'md5': '6bea4c7fa5daaacc2a946b7146286686', 'info_dict': {'id': 'skp9j99s4bpz', 'ext': 'mp4', 'title': "youtube-dl test video  '/\\ ä ↭"}, 'skip': 'Only available from the EU'}, {'url': 'http://streamcloud.eu/ua8cmfh1nbe6/NSHIP-148--KUC-NG--H264-.mp4.html', 'only_matching': True}]
