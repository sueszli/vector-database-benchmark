...
import re
import yaml
from op_gen import PD_MANUAL_OP_LIST, OpCompatParser, OpInfoParser, check_need_update_ops, to_pascal_case, update_ops
...
INPUT_TYPE_MAP = {'paddle::dialect::DenseTensorType': 'pir::Value', 'paddle::dialect::SelectedRowsType': 'pir::Value', 'pir::VectorType<paddle::dialect::DenseTensorType>': 'std::vector<pir::Value>'}
OPTIONAL_INPUT_TYPE_MAP = {'paddle::dialect::DenseTensorType': 'paddle::optional<pir::Value>', 'paddle::dialect::SelectedRowsType': 'paddle::optional<pir::Value>', 'pir::VectorType<paddle::dialect::DenseTensorType>': 'paddle::optional<std::vector<pir::Value>>'}
OUTPUT_TYPE_MAP = {'paddle::dialect::DenseTensorType': 'pir::OpResult', 'paddle::dialect::SelectedRowsType': 'pir::OpResult', 'pir::VectorType<paddle::dialect::DenseTensorType>': 'std::vector<pir::OpResult>'}
OPTIONAL_OUTPUT_TYPE_MAP = {'paddle::dialect::DenseTensorType': 'paddle::optional<pir::OpResult>', 'paddle::dialect::SelectedRowsType': 'paddle::optional<pir::OpResult>', 'pir::VectorType<paddle::dialect::DenseTensorType>': 'paddle::optional<std::vector<pir::OpResult>>'}
...
if __name__ == '__main__':
    ...
    code_gen = CodeGen()
    code_gen.gen_h_and_cpp_file(op_yaml_files, op_compat_yaml_file, namespaces, api_def_h_file, api_def_cc_file)