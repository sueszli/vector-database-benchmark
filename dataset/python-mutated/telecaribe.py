...
class TelecaribePlayIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.play.telecaribe.co/breicok', 'info_dict': {'id': 'breicok', 'title': 'Breicok'}, 'playlist_count': 7}, {'url': 'https://www.play.telecaribe.co/si-fue-gol-de-yepes', 'info_dict': {'id': 'si-fue-gol-de-yepes', 'title': 'Sí Fue Gol de Yepes'}, 'playlist_count': 6}, {'url': 'https://www.play.telecaribe.co/ciudad-futura', 'info_dict': {'id': 'ciudad-futura', 'title': 'Ciudad Futura'}, 'playlist_count': 10}, {'url': 'https://www.play.telecaribe.co/live', 'info_dict': {'id': 'live', 'title': 're:^Señal en vivo', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}}, {'url': 'https://www.play.telecaribe.co/liveplus', 'info_dict': {'id': 'liveplus', 'title': 're:^Señal en vivo Plus', 'live_status': 'is_live', 'ext': 'mp4'}, 'params': {'skip_download': 'Livestream'}, 'skip': 'Geo-restricted to Colombia'}]
