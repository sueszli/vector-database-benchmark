...
from ctypes import c_void_p, byref, Structure, HRESULT, POINTER, WinError, get_last_error, create_string_buffer
from ctypes.wintypes import HANDLE, DWORD, SHORT, BOOL
from pupwinutils.security import CloseHandle, CreatePipe, TerminateProcess, WaitForSingleObject, ReadFile, WriteFile, start_proc_with_token, kernel32, StartupInfoAttribute, GetExitCodeProcess, impersonate_token, CreateFile, PROC_THREAD_ATTRIBUTE_PSEUDOCONSOLE, S_OK, INVALID_HANDLE_VALUE, WAIT_OBJECT_0, WAIT_TIMEOUT, STILL_ACTIVE, INVALID_HANDLE, GENERIC_READ, OPEN_EXISTING
...
class ConPTY(object):
    __slots__ = ('_closed', '_conout_pipe', '_conin_pipe', '_pty', '_lpInfo', '_reader')
