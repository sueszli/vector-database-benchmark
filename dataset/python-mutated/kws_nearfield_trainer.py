...
from modelscope.msdatasets.dataset_cls.custom_datasets.audio.kws_nearfield_dataset import kws_nearfield_dataset
...
from .kws_utils.model_utils import average_model, convert_to_kaldi, count_parameters
logger = get_logger()
