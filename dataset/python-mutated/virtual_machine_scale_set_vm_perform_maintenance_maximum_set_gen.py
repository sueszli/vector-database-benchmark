...
def main():
    ...
    client.virtual_machine_scale_set_vms.begin_perform_maintenance(resource_group_name='rgcompute', vm_scale_set_name='aaaaaaaaaaaaaa', instance_id='aaaaaaaaaaaa').result()
