...
from connexion.security import ApiKeySecurityHandler, OAuthSecurityHandler, SecurityHandlerFactory
TEST_FOLDER = pathlib.Path(__file__).parent
DEFINITIONS = {'new_stack': {'required': ['image_version', 'keep_stacks', 'new_traffic', 'senza_yaml'], 'type': 'object', 'properties': {'keep_stacks': {'type': 'integer', 'description': 'Number of older stacks to keep'}, 'image_version': {'type': 'string', 'description': 'Docker image version to deploy'}, 'senza_yaml': {'type': 'string', 'description': 'YAML to provide to senza'}, 'new_traffic': {'type': 'integer', 'description': 'Percentage of the traffic'}}}, 'composed': {'required': ['test'], 'type': 'object', 'properties': {'test': {'schema': {'$ref': '#/definitions/new_stack'}}}}, 'problem': {'not': 'defined'}}
PARAMETER_DEFINITIONS = {'myparam': {'in': 'path', 'type': 'integer'}}
OPERATION1 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'new_stack', 'required': True, 'schema': {'$ref': '#/definitions/new_stack'}}], 'responses': {201: {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, 400: {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, 401: {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION2 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'new_stack', 'required': True, 'schema': {'$ref': '#/definitions/new_stack'}}, {'in': 'body', 'name': 'new_stack', 'required': True, 'schema': {'$ref': '#/definitions/new_stack'}}], 'responses': {201: {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, 400: {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, 401: {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION3 = {'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'$ref': '#/parameters/myparam'}]}
OPERATION4 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'new_stack', 'required': True, 'schema': {'$ref': '#/definitions/new_stack'}}, {'in': 'query', 'name': 'stack_version', 'default': 'one', 'type': 'number'}], 'responses': {201: {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, 400: {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, 401: {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'summary': 'Create new stack'}
OPERATION5 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'new_stack', 'required': True, 'type': 'integer', 'default': 'stack'}], 'responses': {'201': {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, '400': {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, '401': {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION6 = {'operationId': 'fakeapi.hello.schema', 'parameters': [{'type': 'object', 'in': 'body', 'name': 'new_stack', 'default': {'keep_stack': 1, 'image_version': 1, 'senza_yaml': 'senza.yaml', 'new_traffic': 100}, 'schema': {'$ref': '#/definitions/new_stack'}}], 'responses': {}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION7 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'new_stack', 'required': True, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/new_stack'}}}], 'responses': {'201': {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, '400': {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, '401': {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION8 = {'description': 'Adds a new stack to be created by lizzy and returns the information needed to keep track of deployment', 'operationId': 'fakeapi.hello.post_greeting', 'parameters': [{'in': 'body', 'name': 'test', 'required': True, 'schema': {'$ref': '#/definitions/composed'}}], 'responses': {'201': {'description': "Stack to be created. The CloudFormation Stack creation can still fail if it's rejected by senza or AWS CF.", 'schema': {'$ref': '#/definitions/new_stack'}}, '400': {'description': 'Stack was not created because request was invalid', 'schema': {'$ref': '#/definitions/problem'}}, '401': {'description': 'Stack was not created because the access token was not provided or was not valid for this operation', 'schema': {'$ref': '#/definitions/problem'}}}, 'security': [{'oauth': ['uid']}], 'summary': 'Create new stack'}
OPERATION9 = {'description': 'operation secured with 2 api keys', 'operationId': 'fakeapi.hello.post_greeting', 'responses': {'200': {'description': 'OK'}}, 'security': [{'key1': [], 'key2': []}]}
OPERATION10 = {'description': 'operation secured with 2 oauth schemes combined using logical AND', 'operationId': 'fakeapi.hello.post_greeting', 'responses': {'200': {'description': 'OK'}}, 'security': [{'oauth_1': ['uid'], 'oauth_2': ['uid']}]}
OPERATION11 = {'description': 'operation secured with an oauth schemes with 2 possible scopes (in OR)', 'operationId': 'fakeapi.hello.post_greeting', 'responses': {'200': {'description': 'OK'}}, 'security': [{'oauth': ['myscope']}, {'oauth': ['myscope2']}]}
SECURITY_DEFINITIONS_REMOTE = {'oauth': {'type': 'oauth2', 'flow': 'password', 'x-tokenInfoUrl': 'https://oauth.example/token_info', 'scopes': {'myscope': 'can do stuff'}}}
SECURITY_DEFINITIONS_LOCAL = {'oauth': {'type': 'oauth2', 'flow': 'password', 'x-tokenInfoFunc': 'math.ceil', 'scopes': {'myscope': 'can do stuff', 'myscope2': 'can do other stuff'}}}
SECURITY_DEFINITIONS_BOTH = {'oauth': {'type': 'oauth2', 'flow': 'password', 'x-tokenInfoFunc': 'math.ceil', 'x-tokenInfoUrl': 'https://oauth.example/token_info', 'scopes': {'myscope': 'can do stuff'}}}
SECURITY_DEFINITIONS_WO_INFO = {'oauth': {'type': 'oauth2', 'flow': 'password', 'scopes': {'myscope': 'can do stuff'}}}
SECURITY_DEFINITIONS_2_KEYS = {'key1': {'type': 'apiKey', 'in': 'header', 'name': 'X-Auth-1', 'x-apikeyInfoFunc': 'math.ceil'}, 'key2': {'type': 'apiKey', 'in': 'header', 'name': 'X-Auth-2', 'x-apikeyInfoFunc': 'math.ceil'}}
SECURITY_DEFINITIONS_2_OAUTH = {'oauth_1': {'type': 'oauth2', 'flow': 'password', 'x-tokenInfoFunc': 'math.ceil', 'scopes': {'myscope': 'can do stuff'}}, 'oauth_2': {'type': 'oauth2', 'flow': 'password', 'x-tokenInfoFunc': 'math.ceil', 'scopes': {'myscope': 'can do stuff'}}}
