...
import torch
from nni.compression.pruning import LevelPruner, L1NormPruner, L2NormPruner, FPGMPruner, SlimPruner, TaylorPruner, MovementPruner, LinearPruner, AGPPruner
...
pruner_dict: Dict[str, Type[Pruner]] = {'level': LevelPruner, 'l1': L1NormPruner, 'l2': L2NormPruner, 'fpgm': FPGMPruner, 'slim': SlimPruner, 'taylor': TaylorPruner, 'mvp': MovementPruner, 'linear': LinearPruner, 'agp': AGPPruner}
