...
from ..utils import get_element_by_attribute, clean_html

class TechTalksIE(InfoExtractor):
    _VALID_URL = 'https?://techtalks\\.tv/talks/(?:[^/]+/)?(?P<id>\\d+)'
    _TESTS = [{'url': 'http://techtalks.tv/talks/learning-topic-models-going-beyond-svd/57758/', 'info_dict': {'id': '57758', 'title': 'Learning Topic Models --- Going beyond SVD'}, 'playlist': [{'info_dict': {'id': '57758', 'ext': 'flv', 'title': 'Learning Topic Models --- Going beyond SVD'}}, {'info_dict': {'id': '57758-slides', 'ext': 'flv', 'title': 'Learning Topic Models --- Going beyond SVD'}}], 'params': {'skip_download': True}}, {'url': 'http://techtalks.tv/talks/57758', 'only_matching': True}]
