...
def test_check_success(target):
    ...
    route_mock.return_value = 'TEST<input type="text" name="szUsername" size=16 value="admin"><input type="password" name="szPassword" size=16 maxlength="16" value="admin">TEST'
    exploit = Exploit()
