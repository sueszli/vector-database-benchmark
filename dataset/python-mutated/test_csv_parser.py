...
from airbyte_cdk.sources.file_based.config.csv_format import DEFAULT_FALSE_VALUES, DEFAULT_TRUE_VALUES, CsvFormat, CsvHeaderAutogenerated, CsvHeaderUserProvided, InferenceType
...
PROPERTY_TYPES = {'col1': 'null', 'col2': 'boolean', 'col3': 'integer', 'col4': 'number', 'col5': 'string', 'col6': 'object', 'col7': 'array', 'col8': 'array', 'col9': 'array', 'col10': 'string'}
