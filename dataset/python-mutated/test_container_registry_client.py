...
from azure.containerregistry import RepositoryProperties, ArtifactManifestProperties, ArtifactManifestOrder, ArtifactTagProperties, ArtifactTagOrder, ArtifactArchitecture, ArtifactOperatingSystem, ContainerRegistryClient, DigestValidationError
