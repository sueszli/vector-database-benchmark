...
class Gaussian2D(Fittable2DModel):
    ...
    theta = Parameter(default=0.0, description='Rotation angle either as a float (in radians) or a |Quantity| angle (optional)')
...
class Voigt1D(Fittable1DModel):
    ...
    fwhm_L = Parameter(default=2 / np.pi, description='The Lorentzian full width at half maximum')
    fwhm_G = Parameter(default=np.log(2), description='The Gaussian full width at half maximum')
...
class AiryDisk2D(Fittable2DModel):
    ...
    x_0 = Parameter(default=0, description='X position of the peak')
    y_0 = Parameter(default=0, description='Y position of the peak')
    radius = Parameter(default=1, description='The radius of the Airy disk (radius of first zero crossing)')
    _rz = None
    _j1 = None
