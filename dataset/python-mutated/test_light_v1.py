...
GROUP_RESPONSE = {'1': {'name': 'Group 1', 'lights': ['1', '2'], 'type': 'LightGroup', 'action': {'on': True, 'bri': 254, 'hue': 10000, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}, '2': {'name': 'Group 2', 'lights': ['3', '4', '5'], 'type': 'LightGroup', 'action': {'on': True, 'bri': 153, 'hue': 4345, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}}
LIGHT_1_CAPABILITIES = {'certified': True, 'control': {'mindimlevel': 5000, 'maxlumen': 600, 'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]], 'ct': {'min': 153, 'max': 500}}, 'streaming': {'renderer': True, 'proxy': False}}
LIGHT_1_ON = {'state': {'on': True, 'bri': 144, 'hue': 13088, 'sat': 212, 'xy': [0.5128, 0.4147], 'ct': 467, 'alert': 'none', 'effect': 'none', 'colormode': 'xy', 'reachable': True}, 'capabilities': LIGHT_1_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 1', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '456'}
LIGHT_1_OFF = {'state': {'on': False, 'bri': 0, 'hue': 0, 'sat': 0, 'xy': [0, 0], 'ct': 0, 'alert': 'none', 'effect': 'none', 'colormode': 'xy', 'reachable': True}, 'capabilities': LIGHT_1_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 1', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '456'}
LIGHT_2_CAPABILITIES = {'certified': True, 'control': {'mindimlevel': 5000, 'maxlumen': 600, 'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}, 'streaming': {'renderer': True, 'proxy': False}}
LIGHT_2_OFF = {'state': {'on': False, 'bri': 0, 'hue': 0, 'sat': 0, 'xy': [0, 0], 'ct': 0, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': LIGHT_2_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 2', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '123'}
LIGHT_2_ON = {'state': {'on': True, 'bri': 100, 'hue': 13088, 'sat': 210, 'xy': [0.5, 0.4], 'ct': 420, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': LIGHT_2_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 2 new', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '123'}
LIGHT_RESPONSE = {'1': LIGHT_1_ON, '2': LIGHT_2_OFF}
LIGHT_RAW = {'capabilities': {'control': {'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}}, 'swversion': '66009461'}
LIGHT_GAMUT = color.GamutType(color.XYPoint(0.704, 0.296), color.XYPoint(0.2151, 0.7106), color.XYPoint(0.138, 0.08))
LIGHT_GAMUT_TYPE = 'A'
...
async def test_not_load_groups_if_old_bridge(hass: HomeAssistant, mock_bridge_v1) -> None:
...
async def test_lights_color_mode(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    assert lamp_1.attributes['supported_color_modes'] == [ColorMode.COLOR_TEMP, ColorMode.HS]
    ...
    mock_bridge_v1.mock_group_responses.append({})
    await hass.services.async_call('light', 'turn_on', {'entity_id': 'light.hue_lamp_2'}, blocking=True)
...
async def test_groups(hass: HomeAssistant, entity_registry: er.EntityRegistry, mock_bridge_v1) -> None:
    """Test the update_lights function with some lights."""
    mock_bridge_v1.mock_light_responses.append({})
    mock_bridge_v1.mock_group_responses.append(GROUP_RESPONSE)
    await setup_bridge(hass, mock_bridge_v1)
...
async def test_new_group_discovered(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    new_group_response['3'] = {'name': 'Group 3', 'lights': ['3', '4', '5'], 'type': 'LightGroup', 'action': {'on': True, 'bri': 153, 'hue': 4345, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}
    mock_bridge_v1.mock_light_responses.append({})
    mock_bridge_v1.mock_group_responses.append(new_group_response)
    await hass.services.async_call('light', 'turn_on', {'entity_id': 'light.group_1'}, blocking=True)
    assert len(mock_bridge_v1.mock_requests) == 4
...
async def test_new_light_discovered(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    new_light_response['3'] = {'state': {'on': False, 'bri': 0, 'hue': 0, 'sat': 0, 'xy': [0, 0], 'ct': 0, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': LIGHT_1_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 3', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '789'}
    mock_bridge_v1.mock_light_responses.append(new_light_response)
    await hass.services.async_call('light', 'turn_on', {'entity_id': 'light.hue_lamp_1'}, blocking=True)
    assert len(mock_bridge_v1.mock_requests) == 4
    assert len(hass.states.async_all()) == 3
...
async def test_other_group_update(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    updated_group_response['2'] = {'name': 'Group 2 new', 'lights': ['3', '4', '5'], 'type': 'LightGroup', 'action': {'on': False, 'bri': 0, 'hue': 0, 'sat': 0, 'effect': 'none', 'xy': [0, 0], 'ct': 0, 'alert': 'none', 'colormode': 'ct'}, 'state': {'any_on': False, 'all_on': False}}
    mock_bridge_v1.mock_light_responses.append({})
...
async def test_other_light_update(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    updated_light_response['2'] = {'state': {'on': True, 'bri': 100, 'hue': 13088, 'sat': 210, 'xy': [0.5, 0.4], 'ct': 420, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': LIGHT_2_CAPABILITIES, 'type': 'Extended color light', 'name': 'Hue Lamp 2 new', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '123'}
...
async def test_light_turn_on_service(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    mock_bridge_v1.mock_light_responses.append(updated_light_response)
    await hass.services.async_call('light', 'turn_on', {'entity_id': 'light.hue_lamp_2', 'brightness': 100, 'color_temp': 300}, blocking=True)
    assert len(mock_bridge_v1.mock_requests) == 4
    assert mock_bridge_v1.mock_requests[2]['json'] == {'bri': 100, 'on': True, 'ct': 300, 'alert': 'none'}
    assert len(hass.states.async_all()) == 2
    light = hass.states.get('light.hue_lamp_2')
    assert light is not None
    assert light.state == 'on'
    await hass.services.async_call('light', 'turn_on', {'entity_id': 'light.hue_lamp_2', 'rgb_color': [0, 0, 255]}, blocking=True)
    assert len(mock_bridge_v1.mock_requests) == 5
    assert mock_bridge_v1.mock_requests[4]['json'] == {'on': True, 'xy': (0.138, 0.08), 'alert': 'none'}
...
async def test_light_turn_off_service(hass: HomeAssistant, mock_bridge_v1) -> None:
    ...
    mock_bridge_v1.mock_light_responses.append(updated_light_response)
    await hass.services.async_call('light', 'turn_off', {'entity_id': 'light.hue_lamp_1'}, blocking=True)
    assert len(mock_bridge_v1.mock_requests) == 4
...
async def test_group_features(hass: HomeAssistant, entity_registry: er.EntityRegistry, device_registry: dr.DeviceRegistry, mock_bridge_v1) -> None:
    """Test group features."""
    color_temp_type = 'Color temperature light'
    extended_color_type = 'Extended color light'
    group_response = {'1': {'name': 'Group 1', 'lights': ['1', '2'], 'type': 'LightGroup', 'action': {'on': True, 'bri': 254, 'hue': 10000, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}, '2': {'name': 'Living Room', 'lights': ['2', '3'], 'type': 'Room', 'action': {'on': True, 'bri': 153, 'hue': 4345, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}, '3': {'name': 'Dining Room', 'lights': ['4'], 'type': 'Room', 'action': {'on': True, 'bri': 153, 'hue': 4345, 'sat': 254, 'effect': 'none', 'xy': [0.5, 0.5], 'ct': 250, 'alert': 'select', 'colormode': 'ct'}, 'state': {'any_on': True, 'all_on': False}}}
    light_1 = {'state': {'on': True, 'bri': 144, 'ct': 467, 'alert': 'none', 'effect': 'none', 'reachable': True}, 'capabilities': {'control': {'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}}, 'type': color_temp_type, 'name': 'Hue Lamp 1', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '456'}
    light_2 = {'state': {'on': False, 'bri': 0, 'ct': 0, 'alert': 'none', 'effect': 'none', 'colormode': 'xy', 'reachable': True}, 'capabilities': {'control': {'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}}, 'type': color_temp_type, 'name': 'Hue Lamp 2', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '4567'}
    light_3 = {'state': {'on': False, 'bri': 0, 'hue': 0, 'sat': 0, 'xy': [0, 0], 'ct': 0, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': {'control': {'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}}, 'type': extended_color_type, 'name': 'Hue Lamp 3', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '123'}
    light_4 = {'state': {'on': True, 'bri': 100, 'hue': 13088, 'sat': 210, 'xy': [0.5, 0.4], 'ct': 420, 'alert': 'none', 'effect': 'none', 'colormode': 'hs', 'reachable': True}, 'capabilities': {'control': {'colorgamuttype': 'A', 'colorgamut': [[0.704, 0.296], [0.2151, 0.7106], [0.138, 0.08]]}}, 'type': extended_color_type, 'name': 'Hue Lamp 4', 'modelid': 'LCT001', 'swversion': '66009461', 'manufacturername': 'Philips', 'uniqueid': '1234'}
    light_response = {'1': light_1, '2': light_2, '3': light_3, '4': light_4}
    mock_bridge_v1.mock_light_responses.append(light_response)
    mock_bridge_v1.mock_group_responses.append(group_response)
    await setup_bridge(hass, mock_bridge_v1)
    assert len(mock_bridge_v1.mock_requests) == 2
