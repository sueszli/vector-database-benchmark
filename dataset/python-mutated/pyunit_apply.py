...
OPS_VEC_TO_SCALAR = {'mean': [lambda x: x.mean(), [0, 1], None, None], 'median': [lambda x: x.median(), [0], None, h2o_to_float], 'max': [lambda x: x.max(), [0, 1], None, h2o_to_float], 'min': [lambda x: x.min(), [0, 1], None, h2o_to_float], 'sd': [lambda x: x.sd(), [0], lambda x: x.std(), None], 'nacnt': [lambda x: x.nacnt(), [0], lambda x: sum(x.isnull()), None]}
OPS_VEC_TO_VEC = {'adhoc-fce': [lambda col: (col * col - col * 5 * col).abs() - 3.14, [0], None, None], 'abs': [lambda col: col.abs(), [0], None, None], 'cos': [lambda col: col.cos(), [0], lambda col: np.cos(col), None], 'sin': [lambda col: col.sin(), [0], lambda col: np.sin(col), None], 'cosh': [lambda col: col.cosh(), [0], lambda col: np.cosh(col), None], 'exp': [lambda col: col.exp(), [0], lambda col: np.exp(col), None], 'sqrt': [lambda col: col.sqrt(), [0], lambda col: np.sqrt(col), h2o_to_float], 'tan': [lambda col: col.tan(), [0], lambda col: np.tan(col), None], 'tanh': [lambda col: col.tanh(), [0], lambda col: np.tanh(col), h2o_to_float], 'ceil': [lambda col: col.ceil(), [0], lambda col: np.ceil(col), h2o_to_float], 'floor': [lambda col: col.floor(), [0], lambda col: np.floor(col), h2o_to_float], 'log': [lambda col: col.log(), [], lambda col: np.log(col), None], 'select': [lambda x: x['PSA'], [1], None, None], 'select2': [lambda x: x['PSA'] > x['VOL'], [1], None, pd_to_int], 'select3': [lambda x: 1 if x['PSA'] > x['VOL'] else 0, [], None, None]}
