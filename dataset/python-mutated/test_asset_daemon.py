...
from dagster._core.scheduler.instigation import InstigatorTick, InstigatorType, TickData, TickStatus
from dagster._daemon.asset_daemon import FIXED_AUTO_MATERIALIZATION_INSTIGATOR_NAME, FIXED_AUTO_MATERIALIZATION_ORIGIN_ID, FIXED_AUTO_MATERIALIZATION_SELECTOR_ID, set_auto_materialize_paused
from dagster_tests.definitions_tests.auto_materialize_tests.asset_daemon_scenario import AssetDaemonScenario
from .updated_scenarios.asset_daemon_scenario_states import two_assets_in_sequence, two_partitions_def
...
daemon_scenario = AssetDaemonScenario(id='simple_daemon_scenario', initial_state=two_assets_in_sequence.with_asset_properties(partitions_def=two_partitions_def).with_all_eager(2), execution_fn=lambda state: state.evaluate_tick())
