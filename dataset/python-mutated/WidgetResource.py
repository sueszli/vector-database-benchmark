...
class WidgetResource(GenericResource):
    ...
    async def collection(self, query, meta, user, **kwargs):
        ...
        collection = await asyncio.gather(*[widget.to_dict_async(include_content=True, include_outputs=include_outputs) for widget in pipeline.widgets_by_uuid.values()])
