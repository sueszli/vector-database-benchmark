...
class Exploit(HTTPClient):
    __info__ = {'name': 'Zyxel Eir D1000 RCE', 'description': 'Module exploits Remote Command Execution vulnerability in Zyxel/Eir D1000 devices. If the target is vulnerable it allows to execute commands on operating system level.', 'authors': ('kenzo', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://devicereversing.wordpress.com/2016/11/07/eirs-d1000-modem-is-wide-open-to-being-hacked/', 'https://isc.sans.edu/forums/diary/Port+7547+SOAP+Remote+Code+Execution+Attack+Against+DSL+Modems/21759', 'https://broadband-forum.org/technical/download/TR-064.pdf'), 'devices': ('Zyxel EIR D1000',)}
