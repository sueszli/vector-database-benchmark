...
EVERYTHING_DISTRIBUTION = {'namespace': 'myNamespace', 'name': 'myName', 'step': 'myStep', 'attempted': {'distribution': {'sum': 12, 'count': 5, 'min': 0, 'max': 6}}, 'committed': {'distribution': {'sum': 12, 'count': 5, 'min': 0, 'max': 6}}, 'labels': {'pcollection': 'myCollection', 'myCustomKey': 'myCustomValue'}}
EVERYTHING_COUNTER = {'namespace': 'myNamespace', 'name': 'myName', 'step': 'myStep', 'attempted': {'counter': 42}, 'committed': {'counter': 42}, 'labels': {'pcollection': 'myCollection', 'myCustomKey': 'myCustomValue'}}
