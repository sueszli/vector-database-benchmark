...
class DiscoverConnectionProfileRequest(proto.Message):
    ...
    connection_profile: datastream_resources.ConnectionProfile = proto.Field(proto.MESSAGE, number=200, oneof='target', message=datastream_resources.ConnectionProfile)
    connection_profile_name: str = proto.Field(proto.STRING, number=201, oneof='target')
    recursive: bool = proto.Field(proto.BOOL, number=3, oneof='depth')
    recursion_depth: int = proto.Field(proto.INT32, number=4, oneof='depth')
    oracle_rdbms: datastream_resources.OracleRdbms = proto.Field(proto.MESSAGE, number=100, oneof='data_object', message=datastream_resources.OracleRdbms)
    mysql_rdbms: datastream_resources.MysqlRdbms = proto.Field(proto.MESSAGE, number=101, oneof='data_object', message=datastream_resources.MysqlRdbms)
...
class FetchErrorsRequest(proto.Message):
    ...
    Attributes:
        stream (str):
            ...
            fetch any errors.
    """
    stream: str = proto.Field(proto.STRING, number=1)
...
class FetchErrorsResponse(proto.Message):
    ...
    """
    errors: MutableSequence[datastream_resources.Error] = proto.RepeatedField(proto.MESSAGE, number=1, message=datastream_resources.Error)
...
class ListConnectionProfilesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    connection_profiles: MutableSequence[datastream_resources.ConnectionProfile] = proto.RepeatedField(proto.MESSAGE, number=1, message=datastream_resources.ConnectionProfile)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateConnectionProfileRequest(proto.Message):
    ...
    connection_profile: datastream_resources.ConnectionProfile = proto.Field(proto.MESSAGE, number=3, message=datastream_resources.ConnectionProfile)
...
class UpdateConnectionProfileRequest(proto.Message):
    ...
    connection_profile: datastream_resources.ConnectionProfile = proto.Field(proto.MESSAGE, number=2, message=datastream_resources.ConnectionProfile)
...
class ListStreamsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    streams: MutableSequence[datastream_resources.Stream] = proto.RepeatedField(proto.MESSAGE, number=1, message=datastream_resources.Stream)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateStreamRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    stream_id: str = proto.Field(proto.STRING, number=2)
    stream: datastream_resources.Stream = proto.Field(proto.MESSAGE, number=3, message=datastream_resources.Stream)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdateStreamRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    stream: datastream_resources.Stream = proto.Field(proto.MESSAGE, number=2, message=datastream_resources.Stream)
    request_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
    force: bool = proto.Field(proto.BOOL, number=5)
...
class OperationMetadata(proto.Message):
    ...
    validation_result: datastream_resources.ValidationResult = proto.Field(proto.MESSAGE, number=8, message=datastream_resources.ValidationResult)
...
class CreatePrivateConnectionRequest(proto.Message):
    ...
    private_connection: datastream_resources.PrivateConnection = proto.Field(proto.MESSAGE, number=3, message=datastream_resources.PrivateConnection)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListPrivateConnectionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    private_connections: MutableSequence[datastream_resources.PrivateConnection] = proto.RepeatedField(proto.MESSAGE, number=1, message=datastream_resources.PrivateConnection)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    route_id: str = proto.Field(proto.STRING, number=2)
    route: datastream_resources.Route = proto.Field(proto.MESSAGE, number=3, message=datastream_resources.Route)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    routes: MutableSequence[datastream_resources.Route] = proto.RepeatedField(proto.MESSAGE, number=1, message=datastream_resources.Route)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
