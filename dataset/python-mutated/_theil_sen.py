...
class TheilSenRegressor(RegressorMixin, LinearModel):
    ...
    array([-31.5871...])
    """
    _parameter_constraints: dict = {'fit_intercept': ['boolean'], 'copy_X': ['boolean'], 'max_subpopulation': [Interval(Real, 1, None, closed='left')], 'n_subsamples': [None, Integral], 'max_iter': [Interval(Integral, 0, None, closed='left')], 'tol': [Interval(Real, 0.0, None, closed='left')], 'random_state': ['random_state'], 'n_jobs': [None, Integral], 'verbose': ['verbose']}
