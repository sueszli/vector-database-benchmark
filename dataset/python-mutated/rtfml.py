...
TAGS = {'b': '\\b', 'del': '\\deleted', 'h1': '\\s1 \\afs32', 'h2': '\\s2 \\afs28', 'h3': '\\s3 \\afs28', 'h4': '\\s4 \\afs23', 'h5': '\\s5 \\afs23', 'h6': '\\s6 \\afs21', 'i': '\\i', 'li': '\t', 'p': '\t', 'sub': '\\sub', 'sup': '\\super', 'u': '\\ul'}
SINGLE_TAGS = {'br': '\n{\\line }\n'}
STYLES = [('font-weight', {'bold': '\\b', 'bolder': '\\b'}), ('font-style', {'italic': '\\i'}), ('text-align', {'center': '\\qc', 'left': '\\ql', 'right': '\\qr'}), ('text-decoration', {'line-through': '\\strike', 'underline': '\\ul'})]
