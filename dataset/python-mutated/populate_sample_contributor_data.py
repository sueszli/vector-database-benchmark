...
FIREBASE_AUTH_EMULATOR_HOST: Final = '%s:%s' % (FIREBASE_HOST, feconf.FIREBASE_EMULATOR_PORT)
FIREBASE_SIGN_IN_URL: Final = 'http://%s/identitytoolkit.googleapis.com/v1/accounts:signInWithPassword' % FIREBASE_AUTH_EMULATOR_HOST
FIREBASE_SIGN_UP_URL: Final = 'http://%s/identitytoolkit.googleapis.com/v1/accounts:signUp' % FIREBASE_AUTH_EMULATOR_HOST
SUPER_ADMIN_EMAIL: Final = feconf.ADMIN_EMAIL_ADDRESS
SUPER_ADMIN_USERNAME: Final = 'a'
SUPER_ADMIN_ROLES: Final = [feconf.ROLE_ID_CURRICULUM_ADMIN, feconf.ROLE_ID_TRANSLATION_ADMIN, feconf.ROLE_ID_QUESTION_ADMIN]
