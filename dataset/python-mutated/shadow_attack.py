...
from art.estimators.certification.randomized_smoothing import TensorFlowV2RandomizedSmoothing, PyTorchRandomizedSmoothing
...
class ShadowAttack(EvasionAttack):
    ...
    | Paper link: https://arxiv.org/abs/2003.08937
    """
    attack_params = EvasionAttack.attack_params + ['sigma', 'nb_steps', 'learning_rate', 'lambda_tv', 'lambda_c', 'lambda_s', 'batch_size', 'targeted', 'verbose']
