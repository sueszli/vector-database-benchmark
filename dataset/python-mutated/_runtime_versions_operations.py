...
class RuntimeVersionsOperations:
    ...
    def list_runtime_versions(self, **kwargs: Any) -> _models.AvailableRuntimeVersions:
        ...
        request = build_list_runtime_versions_request(api_version=api_version, template_url=self.list_runtime_versions.metadata['url'], headers=_headers, params=_params)
