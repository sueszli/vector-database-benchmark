...
OPEN_POLICY = {'Version': '2012-10-17', 'Statement': [{'Effect': 'Allow', 'Action': '*', 'Resource': '*'}]}
EC2_POLICY = {'Version': '2012-10-17', 'Statement': [{'Effect': 'Allow', 'Action': 'ec2:*', 'Resource': '*'}]}
ROLE_CONF = {'account_number': '012345678910', 'technology': 'iamrole', 'region': 'universal', 'name': 'roleNumber', 'InlinePolicies': {'ThePolicy': OPEN_POLICY}, 'Arn': ARN_PREFIX + ':iam::012345678910:role/roleNumber'}
