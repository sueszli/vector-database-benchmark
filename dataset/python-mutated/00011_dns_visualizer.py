...
visualizers = {'DNS': {'disabled': False, 'description': 'Visualize information about DNS resolvers and DNS malicious detectors', 'python_module': 'dns.DNS', 'analyzers': ['Classic_DNS', 'CloudFlare_DNS', 'DNS0_EU', 'Google_DNS', 'Quad9_DNS', 'CloudFlare_Malicious_Detector', 'DNS0_EU_Malicious_Detector', 'GoogleSafebrowsing', 'GoogleWebRisk', 'Quad9_Malicious_Detector'], 'connectors': [], 'params': {}, 'secrets': {}}}
...
class Migration(migrations.Migration):
    dependencies = [('visualizers_manager', '00010_remove_runtime_configuration')]
    operations = [migrations.RunPython(create_configurations, reverse_dns_visualizer)]