...
class source_contextCallTransformer(cst.CSTTransformer):
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=source_contextCallTransformer()):
    if False:
        print('Hello World!')
