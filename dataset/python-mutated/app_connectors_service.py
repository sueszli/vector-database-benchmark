...
__protobuf__ = proto.module(package='google.cloud.beyondcorp.appconnectors.v1', manifest={'ListAppConnectorsRequest', 'ListAppConnectorsResponse', 'GetAppConnectorRequest', 'CreateAppConnectorRequest', 'UpdateAppConnectorRequest', 'DeleteAppConnectorRequest', 'ReportStatusRequest', 'AppConnector', 'AppConnectorOperationMetadata'})
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    app_connectors: MutableSequence['AppConnector'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AppConnector')
...
class CreateAppConnectorRequest(proto.Message):
    ...
    app_connector: 'AppConnector' = proto.Field(proto.MESSAGE, number=3, message='AppConnector')
...
class UpdateAppConnectorRequest(proto.Message):
    ...
    app_connector: 'AppConnector' = proto.Field(proto.MESSAGE, number=2, message='AppConnector')
...
class ReportStatusRequest(proto.Message):
    ...
    Attributes:
        ...
        validate_only (bool):
            ...
            resource in any way.
    """
    app_connector: str = proto.Field(proto.STRING, number=1)
    resource_info: gcba_resource_info.ResourceInfo = proto.Field(proto.MESSAGE, number=2, message=gcba_resource_info.ResourceInfo)
    request_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class AppConnector(proto.Message):
    ...
    class PrincipalInfo(proto.Message):
        ...
        service_account: 'AppConnector.PrincipalInfo.ServiceAccount' = proto.Field(proto.MESSAGE, number=1, oneof='type', message='AppConnector.PrincipalInfo.ServiceAccount')
    name: str = proto.Field(proto.STRING, number=1)
    ...
    principal_info: PrincipalInfo = proto.Field(proto.MESSAGE, number=8, message=PrincipalInfo)
    resource_info: gcba_resource_info.ResourceInfo = proto.Field(proto.MESSAGE, number=11, message=gcba_resource_info.ResourceInfo)
