...
_EXPERIMENT_PARAMS = {'smoke_test': {'data': 'https://air-example-data-2.s3.us-west-2.amazonaws.com/10G-xgboost-data.parquet/8034b2644a1d426d9be3bbfa78673dfa_000000.parquet', 'num_workers': 1, 'cpus_per_worker': 1}, '10G': {'data': 's3://air-example-data-2/10G-xgboost-data.parquet/', 'num_workers': 1, 'cpus_per_worker': 12}, '100G': {'data': 's3://air-example-data-2/100G-xgboost-data.parquet/', 'num_workers': 10, 'cpus_per_worker': 12}}
