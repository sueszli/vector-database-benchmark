...
from Orange.data import Table, Variable, ContinuousVariable, StringVariable, DiscreteVariable, Domain, TimeVariable
from Orange.preprocess import discretize
from Orange.widgets.data import owselectrows
from Orange.widgets.data.owselectrows import OWSelectRows, FilterDiscreteType, SelectRowsContextHandler, DateTimeWidget
...
CFValues = {FilterContinuous.Equal: ['5.4'], FilterContinuous.NotEqual: ['5.4'], FilterContinuous.Less: ['5.4'], FilterContinuous.LessEqual: ['5.4'], FilterContinuous.Greater: ['5.4'], FilterContinuous.GreaterEqual: ['5.4'], FilterContinuous.Between: ['5.4', '6.0'], FilterContinuous.Outside: ['5.4', '6.0'], FilterContinuous.IsDefined: []}
SFValues = {FilterString.Equal: ['aardwark'], FilterString.NotEqual: ['aardwark'], FilterString.Less: ['aardwark'], FilterString.LessEqual: ['aardwark'], FilterString.Greater: ['aardwark'], FilterString.GreaterEqual: ['aardwark'], FilterString.Between: ['aardwark', 'cat'], FilterString.Outside: ['aardwark'], FilterString.Contains: ['aa'], FilterString.NotContain: ['bb'], FilterString.StartsWith: ['aa'], FilterString.NotStartsWith: ['bb'], FilterString.EndsWith: ['ark'], FilterString.NotEndsWith: ['zz'], FilterString.IsDefined: [], FilterString.NotIsDefined: []}
DFValues = {FilterDiscreteType.Equal: [0], FilterDiscreteType.NotEqual: [0], FilterDiscreteType.In: [0, 1], FilterDiscreteType.IsDefined: []}
TFValues = {FilterContinuous.Equal: [QDate(2013, 5, 5)], FilterContinuous.NotEqual: [QDate(2013, 5, 5)], FilterContinuous.Less: [QDate(2013, 5, 5)], FilterContinuous.LessEqual: [QDate(2013, 5, 5)], FilterContinuous.Greater: [QDate(2013, 5, 5)], FilterContinuous.GreaterEqual: [QDate(2013, 5, 5)], FilterContinuous.Between: [QDate(2013, 5, 5), QDate(2015, 5, 5)], FilterContinuous.Outside: [QDate(2013, 5, 5), QDate(2015, 5, 5)], FilterContinuous.IsDefined: []}
