...
test_resample_cases = [create_transaction_counts(big=3, med=4, small=2), create_transaction_counts(big=6, med=0, small=2), create_transaction_counts(big=3, med=0, small=4), create_transaction_counts(big=3, med=100, small=3), create_transaction_counts(big=3, med=100, small=30), create_transaction_counts(big=30, med=10, small=30), create_transaction_counts(big=30, med=3, small=5)]
sample_rates = [0.01, 0.1, 0.5, 0.9, 0.99, 1.0]
excluded_transactions = [(0, None), (3, None), (0, -3), (3, -3)]
