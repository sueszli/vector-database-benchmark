...
NUM_SAMPLES = 100
LEARNING_RATES = [0.001, 0.01, 5 * 0.01, 0.1]
LOSSES = ['bpr', 'hinge', 'adaptive_hinge', 'pointwise']
BATCH_SIZE = [8, 16, 32, 256]
EMBEDDING_DIM = [8, 16, 32, 64, 128, 256]
N_ITER = list(range(5, 20))
L2 = [1e-06, 1e-05, 0.0001, 0.001, 0.01, 0.0]
...
if __name__ == '__main__':
    ...
    validation = validation.to_sequence(max_sequence_length=max_sequence_length, min_sequence_length=min_sequence_length, step_size=step_size)
    mode = sys.argv[1]
