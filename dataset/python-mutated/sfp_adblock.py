...
class sfp_adblock(SpiderFootPlugin):
    ...
    opts = {'blocklist': 'https://easylist-downloads.adblockplus.org/easylist.txt', 'cacheperiod': 24}
    optdescs = {'blocklist': 'AdBlockPlus block list.', 'cacheperiod': 'Hours to cache list data before re-fetching.'}
    results = None
    rules = None
    errorState = False
