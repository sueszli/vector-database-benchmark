...
clone_supports_filter = False if 'NO_USE_CLONE_FILTER' in os.environ else _git_version() >= (2, 27, 0)
...
def matching_submodules(s):
    ...
    return [s]
PORT_DEPS = {'atmel-samd': ['extmod/ulab/', 'lib/adafruit_floppy/', 'lib/mp3/', 'lib/protomatter/', 'lib/quirc/', 'lib/tinyusb/', 'lib/tlsf', 'data/nvm.toml/'], 'broadcom': ['extmod/ulab/', 'lib/tlsf', 'lib/tinyusb/'], 'cxd56': ['extmod/ulab/', 'lib/tlsf', 'lib/tinyusb/'], 'espressif': ['extmod/ulab/', 'lib/certificates/', 'lib/protomatter/', 'lib/quirc/', 'lib/tlsf', 'lib/tinyusb/'], 'litex': ['extmod/ulab/', 'lib/tinyusb/', 'lib/tlsf'], 'mimxrt10xx': ['extmod/ulab/', 'lib/tinyusb/', 'lib/tlsf', 'data/nvm.toml/'], 'nrf': ['extmod/ulab/', 'lib/mp3/', 'lib/protomatter/', 'lib/tinyusb/', 'lib/tlsf', 'data/nvm.toml/'], 'raspberrypi': ['extmod/ulab/', 'lib/adafruit_floppy/', 'lib/mbedtls/', 'lib/mp3/', 'lib/certificates/', 'lib/protomatter/', 'lib/quirc/', 'lib/tinyusb/', 'lib/tlsf', 'data/nvm.toml/'], 'silabs': ['extmod/ulab/', 'data/nvm.toml/', 'lib/tlsf'], 'stm': ['extmod/ulab/', 'lib/mp3/', 'lib/protomatter/', 'lib/tinyusb/', 'lib/tlsf', 'data/nvm.toml/']}
