...
about = {'website': 'https://www.wolframalpha.com/', 'wikidata_id': 'Q207006', 'official_api_documentation': 'https://products.wolframalpha.com/api/', 'use_official_api': False, 'require_api_key': False, 'results': 'JSON'}
url = 'https://www.wolframalpha.com/'
search_url = url + 'input/json.jsp?async=false&banners=raw&debuggingdata=false&format=image,plaintext,imagemap,minput,moutput&formattimeout=2&{query}&output=JSON&parsetimeout=2&proxycode={token}&scantimeout=0.5&sponsorcategories=true&statemethod=deploybutton'
