...
register_distributed_operator_impl_container(DistributedFusedAttention('fused_attention'))
...
class DistributedFusedAttentionImpl(DistributedOperatorImpl):
    ...
    def backward(ctx, *args, **kwargs):
        ...
        new_op._set_attr('ring_id', int(group.id))
register_distributed_operator_impl('fused_attention', DistributedFusedAttentionImpl('tensor_parallel'))