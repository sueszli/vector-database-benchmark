...
class BeamJobRunHandler(base.BaseHandler[BeamJobRunHandlerNormalizedPayloadDict, BeamJobRunHandlerNormalizedRequestDict]):
    """Handler for managing the execution of Apache Beam jobs."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'PUT': {'job_name': {'schema': {'type': 'unicode'}}}, 'DELETE': {'job_id': {'schema': {'type': 'unicode', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': '[A-Za-z0-9]{22}'}]}}}}
...
class BeamJobRunResultHandler(base.BaseHandler[Dict[str, str], BeamJobRunResultHandlerNormalizedRequestDict]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'job_id': {'schema': {'type': 'unicode', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': '[A-Za-z0-9]{22}'}]}}}}
