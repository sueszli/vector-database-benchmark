...
class MindsIE(MindsBaseIE):
    IE_NAME = 'minds'
    _VALID_URL = MindsBaseIE._VALID_URL_BASE + '(?:media|newsfeed|archive/view)/(?P<id>[0-9]+)'
    _TESTS = [{'url': 'https://www.minds.com/media/100000000000086822', 'md5': '215a658184a419764852239d4970b045', 'info_dict': {'id': '100000000000086822', 'ext': 'mp4', 'title': 'Minds intro sequence', 'thumbnail': 're:https?://.+\\.png', 'uploader_id': 'ottman', 'upload_date': '20130524', 'timestamp': 1369404826, 'uploader': 'Bill Ottman', 'view_count': int, 'like_count': int, 'dislike_count': int, 'tags': ['animation'], 'comment_count': int, 'license': 'attribution-cc'}}, {'url': 'https://www.minds.com/newsfeed/798025111988506624', 'md5': 'b2733a74af78d7fd3f541c4cbbaa5950', 'info_dict': {'id': '798022190320226304', 'ext': 'mp4', 'title': '798022190320226304', 'uploader': 'ColinFlaherty', 'upload_date': '20180111', 'timestamp': 1515639316, 'uploader_id': 'ColinFlaherty'}}, {'url': 'https://www.minds.com/archive/view/715172106794442752', 'only_matching': True}, {'url': 'https://www.minds.com/newsfeed/1197131838022602752', 'only_matching': True}]
...
class MindsChannelIE(MindsFeedBaseIE):
    ...
    _VALID_URL = MindsBaseIE._VALID_URL_BASE + '(?!(?:newsfeed|media|api|archive|groups)/)(?P<id>[^/?&#]+)'
    _FEED_PATH = 'channel'
    _TEST = {'url': 'https://www.minds.com/ottman', 'info_dict': {'id': 'ottman', 'title': 'Bill Ottman', 'description': 'Co-creator & CEO @minds'}, 'playlist_mincount': 54}

class MindsGroupIE(MindsFeedBaseIE):
    _FEED_TYPE = 'group'
    IE_NAME = 'minds:' + _FEED_TYPE
    _VALID_URL = MindsBaseIE._VALID_URL_BASE + 'groups/profile/(?P<id>[0-9]+)'
    _FEED_PATH = 'groups/group'
    _TEST = {'url': 'https://www.minds.com/groups/profile/785582576369672204/feed/videos', 'info_dict': {'id': '785582576369672204', 'title': 'Cooking Videos'}, 'playlist_mincount': 1}