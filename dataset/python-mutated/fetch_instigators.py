...
if TYPE_CHECKING:
    ...
    from ..schema.instigation import GrapheneInstigationEventConnection, GrapheneInstigationState, GrapheneInstigationStateNotFoundError, GrapheneInstigationStates
