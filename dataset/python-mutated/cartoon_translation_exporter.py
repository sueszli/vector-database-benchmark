...
if version.parse(tf.__version__) < version.parse('2'):
    ...
    logger.info(f'TensorFlow version {_tf_version} found, TF2.x is not supported by CartoonTranslationExporter.')
tf.logging.set_verbosity(tf.logging.INFO)

@EXPORTERS.register_module(module_name='cartoon-translation')
