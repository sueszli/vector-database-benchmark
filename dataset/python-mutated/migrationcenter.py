...
import proto
__protobuf__ = proto.module(package='google.cloud.migrationcenter.v1', manifest={'AssetView', 'OperatingSystemFamily', 'ImportJobFormat', 'ImportJobView', 'ErrorFrameView', 'PersistentDiskType', 'LicenseType', 'SizingOptimizationStrategy', 'CommitmentPlan', 'ComputeMigrationTargetProduct', 'ReportView', 'Asset', 'PreferenceSet', 'ImportJob', 'ImportDataFile', 'Group', 'ErrorFrame', 'Source', 'ReportConfig', 'Report', 'OperationMetadata', 'ListAssetsRequest', 'ListAssetsResponse', 'GetAssetRequest', 'UpdateAssetRequest', 'BatchUpdateAssetsRequest', 'BatchUpdateAssetsResponse', 'DeleteAssetRequest', 'BatchDeleteAssetsRequest', 'ReportAssetFramesRequest', 'ReportAssetFramesResponse', 'AggregateAssetsValuesRequest', 'AggregateAssetsValuesResponse', 'CreateImportJobRequest', 'ListImportJobsRequest', 'ListImportJobsResponse', 'GetImportJobRequest', 'DeleteImportJobRequest', 'UpdateImportJobRequest', 'ValidateImportJobRequest', 'RunImportJobRequest', 'GetImportDataFileRequest', 'ListImportDataFilesRequest', 'ListImportDataFilesResponse', 'CreateImportDataFileRequest', 'DeleteImportDataFileRequest', 'ListGroupsRequest', 'ListGroupsResponse', 'GetGroupRequest', 'CreateGroupRequest', 'UpdateGroupRequest', 'DeleteGroupRequest', 'AddAssetsToGroupRequest', 'RemoveAssetsFromGroupRequest', 'ListErrorFramesRequest', 'ListErrorFramesResponse', 'GetErrorFrameRequest', 'ListSourcesRequest', 'ListSourcesResponse', 'GetSourceRequest', 'CreateSourceRequest', 'UpdateSourceRequest', 'DeleteSourceRequest', 'ListPreferenceSetsRequest', 'ListPreferenceSetsResponse', 'GetPreferenceSetRequest', 'CreatePreferenceSetRequest', 'UpdatePreferenceSetRequest', 'DeletePreferenceSetRequest', 'GetSettingsRequest', 'UpdateSettingsRequest', 'CreateReportConfigRequest', 'DeleteReportConfigRequest', 'GetReportRequest', 'ListReportsRequest', 'ListReportsResponse', 'DeleteReportRequest', 'GetReportConfigRequest', 'ListReportConfigsRequest', 'ListReportConfigsResponse', 'CreateReportRequest', 'Frames', 'AssetFrame', 'MachineDetails', 'MachineArchitectureDetails', 'BiosDetails', 'MachineNetworkDetails', 'NetworkAdapterList', 'NetworkAdapterDetails', 'NetworkAddressList', 'NetworkAddress', 'MachineDiskDetails', 'DiskEntryList', 'DiskEntry', 'DiskPartitionList', 'DiskPartition', 'VmwareDiskConfig', 'GuestOsDetails', 'GuestConfigDetails', 'FstabEntryList', 'FstabEntry', 'HostsEntryList', 'HostsEntry', 'NfsExportList', 'NfsExport', 'GuestRuntimeDetails', 'RunningServiceList', 'RunningService', 'RunningProcessList', 'RunningProcess', 'RuntimeNetworkInfo', 'NetworkConnectionList', 'NetworkConnection', 'GuestInstalledApplicationList', 'GuestInstalledApplication', 'OpenFileList', 'OpenFileDetails', 'PlatformDetails', 'VmwarePlatformDetails', 'AwsEc2PlatformDetails', 'AzureVmPlatformDetails', 'GenericPlatformDetails', 'PhysicalPlatformDetails', 'MemoryUsageSample', 'CpuUsageSample', 'NetworkUsageSample', 'DiskUsageSample', 'PerformanceSample', 'AssetPerformanceData', 'DailyResourceUsageAggregation', 'InsightList', 'Insight', 'GenericInsight', 'MigrationInsight', 'ComputeEngineMigrationTarget', 'ComputeEngineShapeDescriptor', 'ComputeStorageDescriptor', 'FitDescriptor', 'Aggregation', 'AggregationResult', 'FileValidationReport', 'ValidationReport', 'ExecutionReport', 'ImportError', 'ImportRowError', 'UploadFileInfo', 'AssetList', 'FrameViolationEntry', 'VirtualMachinePreferences', 'ComputeEnginePreferences', 'MachinePreferences', 'MachineSeries', 'VmwareEnginePreferences', 'SoleTenancyPreferences', 'SoleTenantNodeType', 'RegionPreferences', 'Settings', 'ReportSummary'})
...
class Asset(proto.Message):
    ...
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    attributes: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    machine_details: 'MachineDetails' = proto.Field(proto.MESSAGE, number=6, oneof='AssetDetails', message='MachineDetails')
    insight_list: 'InsightList' = proto.Field(proto.MESSAGE, number=20, message='InsightList')
    performance_data: 'AssetPerformanceData' = proto.Field(proto.MESSAGE, number=21, message='AssetPerformanceData')
    sources: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=22)
    assigned_groups: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=23)
...
class PreferenceSet(proto.Message):
    ...
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    display_name: str = proto.Field(proto.STRING, number=4)
    description: str = proto.Field(proto.STRING, number=5)
    virtual_machine_preferences: 'VirtualMachinePreferences' = proto.Field(proto.MESSAGE, number=6, message='VirtualMachinePreferences')
...
class ImportJob(proto.Message):
    ...
    class ImportJobState(proto.Enum):
        ...
        IMPORT_JOB_STATE_READY = 7
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    ...
    complete_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    state: ImportJobState = proto.Field(proto.ENUM, number=6, enum=ImportJobState)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=7)
    asset_source: str = proto.Field(proto.STRING, number=8)
    validation_report: 'ValidationReport' = proto.Field(proto.MESSAGE, number=10, oneof='report', message='ValidationReport')
    execution_report: 'ExecutionReport' = proto.Field(proto.MESSAGE, number=11, oneof='report', message='ExecutionReport')
...
class ImportDataFile(proto.Message):
    ...
    class State(proto.Enum):
        ...
        ACTIVE = 2
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=6)
    format_: 'ImportJobFormat' = proto.Field(proto.ENUM, number=2, enum='ImportJobFormat')
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    state: State = proto.Field(proto.ENUM, number=4, enum=State)
    upload_file_info: 'UploadFileInfo' = proto.Field(proto.MESSAGE, number=5, oneof='file_info', message='UploadFileInfo')
...
class Group(proto.Message):
    ...
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    display_name: str = proto.Field(proto.STRING, number=5)
...
class ErrorFrame(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    violations: MutableSequence['FrameViolationEntry'] = proto.RepeatedField(proto.MESSAGE, number=2, message='FrameViolationEntry')
    original_frame: 'AssetFrame' = proto.Field(proto.MESSAGE, number=3, message='AssetFrame')
    ingestion_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
...
class Source(proto.Message):
    ...
    display_name: str = proto.Field(proto.STRING, number=4)
    description: str = proto.Field(proto.STRING, number=5)
    type_: SourceType = proto.Field(proto.ENUM, number=6, enum=SourceType)
    priority: int = proto.Field(proto.INT32, number=7)
    managed: bool = proto.Field(proto.BOOL, number=8)
    pending_frame_count: int = proto.Field(proto.INT32, number=9)
    error_frame_count: int = proto.Field(proto.INT32, number=10)
    state: State = proto.Field(proto.ENUM, number=11, enum=State)
...
class ReportConfig(proto.Message):
    ...
    class GroupPreferenceSetAssignment(proto.Message):
        ...
        """
        group: str = proto.Field(proto.STRING, number=1)
        preference_set: str = proto.Field(proto.STRING, number=2)
    name: str = proto.Field(proto.STRING, number=1)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    display_name: str = proto.Field(proto.STRING, number=4)
    description: str = proto.Field(proto.STRING, number=5)
    group_preferenceset_assignments: MutableSequence[GroupPreferenceSetAssignment] = proto.RepeatedField(proto.MESSAGE, number=6, message=GroupPreferenceSetAssignment)
...
class Report(proto.Message):
    ...
    display_name: str = proto.Field(proto.STRING, number=4)
    description: str = proto.Field(proto.STRING, number=5)
    type_: Type = proto.Field(proto.ENUM, number=6, enum=Type)
    state: State = proto.Field(proto.ENUM, number=7, enum=State)
    summary: 'ReportSummary' = proto.Field(proto.MESSAGE, number=8, message='ReportSummary')
...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        ...
        api_version (str):
            ...
            operation.
    """
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    target: str = proto.Field(proto.STRING, number=3)
    verb: str = proto.Field(proto.STRING, number=4)
    status_message: str = proto.Field(proto.STRING, number=5)
    requested_cancellation: bool = proto.Field(proto.BOOL, number=6)
    api_version: str = proto.Field(proto.STRING, number=7)
...
class ListAssetsRequest(proto.Message):
    ...
    view: 'AssetView' = proto.Field(proto.ENUM, number=6, enum='AssetView')
...
class ListAssetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    assets: MutableSequence['Asset'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Asset')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class GetAssetRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'AssetView' = proto.Field(proto.ENUM, number=2, enum='AssetView')
...
class UpdateAssetRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    asset: 'Asset' = proto.Field(proto.MESSAGE, number=2, message='Asset')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class BatchUpdateAssetsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    requests: MutableSequence['UpdateAssetRequest'] = proto.RepeatedField(proto.MESSAGE, number=2, message='UpdateAssetRequest')
...
class DeleteAssetRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    request_id: str = proto.Field(proto.STRING, number=2)
...
class BatchDeleteAssetsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    allow_missing: bool = proto.Field(proto.BOOL, number=3)
...
class ReportAssetFramesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    frames: 'Frames' = proto.Field(proto.MESSAGE, number=2, message='Frames')
    source: str = proto.Field(proto.STRING, number=3)
...
class AggregateAssetsValuesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    aggregations: MutableSequence['Aggregation'] = proto.RepeatedField(proto.MESSAGE, number=2, message='Aggregation')
    filter: str = proto.Field(proto.STRING, number=3)
...
class AggregateAssetsValuesResponse(proto.Message):
    ...
    """
    results: MutableSequence['AggregationResult'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AggregationResult')
...
class CreateImportJobRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    import_job_id: str = proto.Field(proto.STRING, number=2)
    import_job: 'ImportJob' = proto.Field(proto.MESSAGE, number=3, message='ImportJob')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListImportJobsRequest(proto.Message):
    ...
    filter: str = proto.Field(proto.STRING, number=4)
    order_by: str = proto.Field(proto.STRING, number=5)
    view: 'ImportJobView' = proto.Field(proto.ENUM, number=6, enum='ImportJobView')
...
class ListImportJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    import_jobs: MutableSequence['ImportJob'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ImportJob')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class GetImportJobRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'ImportJobView' = proto.Field(proto.ENUM, number=2, enum='ImportJobView')
...
class DeleteImportJobRequest(proto.Message):
    ...
    name: str = proto.Field(proto.STRING, number=1)
    request_id: str = proto.Field(proto.STRING, number=2)
    force: bool = proto.Field(proto.BOOL, number=3)
...
class UpdateImportJobRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    import_job: 'ImportJob' = proto.Field(proto.MESSAGE, number=2, message='ImportJob')
    request_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    import_data_files: MutableSequence['ImportDataFile'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ImportDataFile')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateImportDataFileRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    import_data_file_id: str = proto.Field(proto.STRING, number=2)
    import_data_file: 'ImportDataFile' = proto.Field(proto.MESSAGE, number=3, message='ImportDataFile')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListGroupsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    groups: MutableSequence['Group'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Group')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateGroupRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    group_id: str = proto.Field(proto.STRING, number=2)
    group: 'Group' = proto.Field(proto.MESSAGE, number=3, message='Group')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdateGroupRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    group: 'Group' = proto.Field(proto.MESSAGE, number=2, message='Group')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class AddAssetsToGroupRequest(proto.Message):
    ...
    group: str = proto.Field(proto.STRING, number=1)
    request_id: str = proto.Field(proto.STRING, number=2)
    assets: 'AssetList' = proto.Field(proto.MESSAGE, number=3, message='AssetList')
    allow_existing: bool = proto.Field(proto.BOOL, number=4)
...
class RemoveAssetsFromGroupRequest(proto.Message):
    ...
    request_id: str = proto.Field(proto.STRING, number=2)
    assets: 'AssetList' = proto.Field(proto.MESSAGE, number=3, message='AssetList')
    allow_missing: bool = proto.Field(proto.BOOL, number=4)
...
class ListErrorFramesRequest(proto.Message):
    ...
    page_size: int = proto.Field(proto.INT32, number=2)
    page_token: str = proto.Field(proto.STRING, number=3)
    view: 'ErrorFrameView' = proto.Field(proto.ENUM, number=4, enum='ErrorFrameView')
...
class ListErrorFramesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    error_frames: MutableSequence['ErrorFrame'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ErrorFrame')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class GetErrorFrameRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'ErrorFrameView' = proto.Field(proto.ENUM, number=2, enum='ErrorFrameView')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    sources: MutableSequence['Source'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Source')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateSourceRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    source_id: str = proto.Field(proto.STRING, number=2)
    source: 'Source' = proto.Field(proto.MESSAGE, number=3, message='Source')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdateSourceRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    source: 'Source' = proto.Field(proto.MESSAGE, number=2, message='Source')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class ListPreferenceSetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    preference_sets: MutableSequence['PreferenceSet'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PreferenceSet')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreatePreferenceSetRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    preference_set_id: str = proto.Field(proto.STRING, number=2)
    preference_set: 'PreferenceSet' = proto.Field(proto.MESSAGE, number=3, message='PreferenceSet')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdatePreferenceSetRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    preference_set: 'PreferenceSet' = proto.Field(proto.MESSAGE, number=2, message='PreferenceSet')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class CreateReportConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    report_config_id: str = proto.Field(proto.STRING, number=2)
    report_config: 'ReportConfig' = proto.Field(proto.MESSAGE, number=3, message='ReportConfig')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class GetReportRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'ReportView' = proto.Field(proto.ENUM, number=6, enum='ReportView')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    reports: MutableSequence['Report'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Report')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class ListReportConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    report_configs: MutableSequence['ReportConfig'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReportConfig')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateReportRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    report_id: str = proto.Field(proto.STRING, number=2)
    report: 'Report' = proto.Field(proto.MESSAGE, number=3, message='Report')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class Frames(proto.Message):
    ...
    """
    frames_data: MutableSequence['AssetFrame'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AssetFrame')
...
class AssetFrame(proto.Message):
    ...
    """
    machine_details: 'MachineDetails' = proto.Field(proto.MESSAGE, number=1, oneof='FrameData', message='MachineDetails')
    report_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=11)
    attributes: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=12)
    performance_samples: MutableSequence['PerformanceSample'] = proto.RepeatedField(proto.MESSAGE, number=13, message='PerformanceSample')
    trace_token: str = proto.Field(proto.STRING, number=14)
...
class MachineDetails(proto.Message):
    ...
    class PowerState(proto.Enum):
        ...
        DELETING = 5
        DELETED = 6
    uuid: str = proto.Field(proto.STRING, number=1)
    machine_name: str = proto.Field(proto.STRING, number=2)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    core_count: int = proto.Field(proto.INT32, number=4)
    memory_mb: int = proto.Field(proto.INT32, number=5)
    power_state: PowerState = proto.Field(proto.ENUM, number=6, enum=PowerState)
    architecture: 'MachineArchitectureDetails' = proto.Field(proto.MESSAGE, number=7, message='MachineArchitectureDetails')
    guest_os: 'GuestOsDetails' = proto.Field(proto.MESSAGE, number=8, message='GuestOsDetails')
    network: 'MachineNetworkDetails' = proto.Field(proto.MESSAGE, number=9, message='MachineNetworkDetails')
    disks: 'MachineDiskDetails' = proto.Field(proto.MESSAGE, number=10, message='MachineDiskDetails')
    platform: 'PlatformDetails' = proto.Field(proto.MESSAGE, number=11, message='PlatformDetails')
...
class MachineArchitectureDetails(proto.Message):
    ...
    class CpuHyperThreading(proto.Enum):
        ...
        DISABLED = 1
        ENABLED = 2
    cpu_architecture: str = proto.Field(proto.STRING, number=1)
    cpu_name: str = proto.Field(proto.STRING, number=2)
    vendor: str = proto.Field(proto.STRING, number=3)
    cpu_thread_count: int = proto.Field(proto.INT32, number=4)
    cpu_socket_count: int = proto.Field(proto.INT32, number=5)
    bios: 'BiosDetails' = proto.Field(proto.MESSAGE, number=6, message='BiosDetails')
    firmware_type: FirmwareType = proto.Field(proto.ENUM, number=7, enum=FirmwareType)
    hyperthreading: CpuHyperThreading = proto.Field(proto.ENUM, number=8, enum=CpuHyperThreading)
...
class BiosDetails(proto.Message):
    ...
    Attributes:
        ...
        smbios_uuid (str):
            SMBIOS UUID.
    """
    bios_name: str = proto.Field(proto.STRING, number=1)
    id: str = proto.Field(proto.STRING, number=2)
    manufacturer: str = proto.Field(proto.STRING, number=3)
    version: str = proto.Field(proto.STRING, number=4)
    release_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=5, message=date_pb2.Date)
    smbios_uuid: str = proto.Field(proto.STRING, number=6)
...
class MachineNetworkDetails(proto.Message):
    ...
    """
    primary_ip_address: str = proto.Field(proto.STRING, number=1)
    public_ip_address: str = proto.Field(proto.STRING, number=2)
    primary_mac_address: str = proto.Field(proto.STRING, number=3)
    adapters: 'NetworkAdapterList' = proto.Field(proto.MESSAGE, number=4, message='NetworkAdapterList')
...
class NetworkAdapterList(proto.Message):
    ...
    """
    entries: MutableSequence['NetworkAdapterDetails'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NetworkAdapterDetails')
...
class NetworkAdapterDetails(proto.Message):
    ...
    Attributes:
        ...
        addresses (google.cloud.migrationcenter_v1.types.NetworkAddressList):
            NetworkAddressList
    """
    adapter_type: str = proto.Field(proto.STRING, number=1)
    mac_address: str = proto.Field(proto.STRING, number=2)
    addresses: 'NetworkAddressList' = proto.Field(proto.MESSAGE, number=3, message='NetworkAddressList')
...
class NetworkAddressList(proto.Message):
    ...
    """
    entries: MutableSequence['NetworkAddress'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NetworkAddress')
...
class NetworkAddress(proto.Message):
    ...
    class AddressAssignment(proto.Enum):
        ...
        ADDRESS_ASSIGNMENT_STATIC = 1
        ADDRESS_ASSIGNMENT_DHCP = 2
    ip_address: str = proto.Field(proto.STRING, number=1)
    subnet_mask: str = proto.Field(proto.STRING, number=2)
    bcast: str = proto.Field(proto.STRING, number=3)
    fqdn: str = proto.Field(proto.STRING, number=4)
    assignment: AddressAssignment = proto.Field(proto.ENUM, number=5, enum=AddressAssignment)
...
class MachineDiskDetails(proto.Message):
    ...
    Attributes:
        ...
        disks (google.cloud.migrationcenter_v1.types.DiskEntryList):
            List of disks.
    """
    total_capacity_bytes: int = proto.Field(proto.INT64, number=1)
    total_free_bytes: int = proto.Field(proto.INT64, number=2)
    disks: 'DiskEntryList' = proto.Field(proto.MESSAGE, number=3, message='DiskEntryList')
...
class DiskEntryList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.DiskEntry]):
            Disk entries.
    """
    entries: MutableSequence['DiskEntry'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DiskEntry')
...
class DiskEntry(proto.Message):
    ...
    class InterfaceType(proto.Enum):
        ...
        FC = 6
        ISCSI = 7
    capacity_bytes: int = proto.Field(proto.INT64, number=1)
    free_bytes: int = proto.Field(proto.INT64, number=2)
    disk_label: str = proto.Field(proto.STRING, number=3)
    disk_label_type: str = proto.Field(proto.STRING, number=4)
    interface_type: InterfaceType = proto.Field(proto.ENUM, number=5, enum=InterfaceType)
    partitions: 'DiskPartitionList' = proto.Field(proto.MESSAGE, number=6, message='DiskPartitionList')
    hw_address: str = proto.Field(proto.STRING, number=7)
    vmware: 'VmwareDiskConfig' = proto.Field(proto.MESSAGE, number=20, oneof='platform_specific', message='VmwareDiskConfig')
...
class DiskPartitionList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.DiskPartition]):
            Partition entries.
    """
    entries: MutableSequence['DiskPartition'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DiskPartition')
...
class DiskPartition(proto.Message):
    ...
    file_system: str = proto.Field(proto.STRING, number=2)
    mount_point: str = proto.Field(proto.STRING, number=3)
    capacity_bytes: int = proto.Field(proto.INT64, number=4)
    free_bytes: int = proto.Field(proto.INT64, number=5)
    uuid: str = proto.Field(proto.STRING, number=6)
    sub_partitions: 'DiskPartitionList' = proto.Field(proto.MESSAGE, number=7, message='DiskPartitionList')
...
class VmwareDiskConfig(proto.Message):
    ...
    class RdmCompatibility(proto.Enum):
        ...
        PHYSICAL_COMPATIBILITY = 1
        VIRTUAL_COMPATIBILITY = 2
    backing_type: BackingType = proto.Field(proto.ENUM, number=1, enum=BackingType)
    shared: bool = proto.Field(proto.BOOL, number=2)
    vmdk_mode: VmdkMode = proto.Field(proto.ENUM, number=3, enum=VmdkMode)
    rdm_compatibility: RdmCompatibility = proto.Field(proto.ENUM, number=4, enum=RdmCompatibility)
...
class GuestOsDetails(proto.Message):
    ...
    Attributes:
        ...
        runtime (google.cloud.migrationcenter_v1.types.GuestRuntimeDetails):
            Runtime information.
    """
    os_name: str = proto.Field(proto.STRING, number=1)
    family: 'OperatingSystemFamily' = proto.Field(proto.ENUM, number=2, enum='OperatingSystemFamily')
    version: str = proto.Field(proto.STRING, number=3)
    config: 'GuestConfigDetails' = proto.Field(proto.MESSAGE, number=4, message='GuestConfigDetails')
    runtime: 'GuestRuntimeDetails' = proto.Field(proto.MESSAGE, number=5, message='GuestRuntimeDetails')
...
class GuestConfigDetails(proto.Message):
    ...
    class SeLinuxMode(proto.Enum):
        ...
        SE_LINUX_MODE_PERMISSIVE = 2
        SE_LINUX_MODE_ENFORCING = 3
    issue: str = proto.Field(proto.STRING, number=1)
    fstab: 'FstabEntryList' = proto.Field(proto.MESSAGE, number=2, message='FstabEntryList')
    hosts: 'HostsEntryList' = proto.Field(proto.MESSAGE, number=3, message='HostsEntryList')
    nfs_exports: 'NfsExportList' = proto.Field(proto.MESSAGE, number=4, message='NfsExportList')
    selinux_mode: SeLinuxMode = proto.Field(proto.ENUM, number=5, enum=SeLinuxMode)
...
class FstabEntryList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.FstabEntry]):
            Fstab entries.
    """
    entries: MutableSequence['FstabEntry'] = proto.RepeatedField(proto.MESSAGE, number=1, message='FstabEntry')
...
class FstabEntry(proto.Message):
    ...
    Attributes:
        ...
        passno (int):
            ...
            reboot time.
    """
    spec: str = proto.Field(proto.STRING, number=1)
    file: str = proto.Field(proto.STRING, number=2)
    vfstype: str = proto.Field(proto.STRING, number=3)
    mntops: str = proto.Field(proto.STRING, number=4)
    freq: int = proto.Field(proto.INT32, number=5)
    passno: int = proto.Field(proto.INT32, number=6)
...
class HostsEntryList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.HostsEntry]):
            Hosts entries.
    """
    entries: MutableSequence['HostsEntry'] = proto.RepeatedField(proto.MESSAGE, number=1, message='HostsEntry')
...
class HostsEntry(proto.Message):
    ...
    """
    ip: str = proto.Field(proto.STRING, number=1)
    host_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class NfsExportList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.NfsExport]):
            NFS export entries.
    """
    entries: MutableSequence['NfsExport'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NfsExport')
...
class NfsExport(proto.Message):
    ...
    Attributes:
        ...
        hosts (MutableSequence[str]):
            ...
            being shared.
    """
    export_directory: str = proto.Field(proto.STRING, number=1)
    hosts: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class GuestRuntimeDetails(proto.Message):
    ...
    """
    services: 'RunningServiceList' = proto.Field(proto.MESSAGE, number=1, message='RunningServiceList')
    processes: 'RunningProcessList' = proto.Field(proto.MESSAGE, number=2, message='RunningProcessList')
    network: 'RuntimeNetworkInfo' = proto.Field(proto.MESSAGE, number=3, message='RuntimeNetworkInfo')
    last_boot_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    domain: str = proto.Field(proto.STRING, number=5)
    machine_name: str = proto.Field(proto.STRING, number=6)
    installed_apps: 'GuestInstalledApplicationList' = proto.Field(proto.MESSAGE, number=7, message='GuestInstalledApplicationList')
    open_file_list: 'OpenFileList' = proto.Field(proto.MESSAGE, number=8, message='OpenFileList')
...
class RunningServiceList(proto.Message):
    ...
    """
    entries: MutableSequence['RunningService'] = proto.RepeatedField(proto.MESSAGE, number=1, message='RunningService')
...
class RunningService(proto.Message):
    ...
    class StartMode(proto.Enum):
        ...
        MANUAL = 4
        DISABLED = 5
    service_name: str = proto.Field(proto.STRING, number=1)
    state: State = proto.Field(proto.ENUM, number=2, enum=State)
    start_mode: StartMode = proto.Field(proto.ENUM, number=3, enum=StartMode)
    exe_path: str = proto.Field(proto.STRING, number=4)
    cmdline: str = proto.Field(proto.STRING, number=5)
    pid: int = proto.Field(proto.INT64, number=6)
...
class RunningProcessList(proto.Message):
    ...
    """
    entries: MutableSequence['RunningProcess'] = proto.RepeatedField(proto.MESSAGE, number=1, message='RunningProcess')
...
class RunningProcess(proto.Message):
    ...
    """
    pid: int = proto.Field(proto.INT64, number=1)
    exe_path: str = proto.Field(proto.STRING, number=2)
    cmdline: str = proto.Field(proto.STRING, number=3)
    user: str = proto.Field(proto.STRING, number=4)
    attributes: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=100)
...
class RuntimeNetworkInfo(proto.Message):
    ...
    Attributes:
        ...
        connections (google.cloud.migrationcenter_v1.types.NetworkConnectionList):
            Network connections.
    """
    scan_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    connections: 'NetworkConnectionList' = proto.Field(proto.MESSAGE, number=2, message='NetworkConnectionList')
...
class NetworkConnectionList(proto.Message):
    ...
    """
    entries: MutableSequence['NetworkConnection'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NetworkConnection')
...
class NetworkConnection(proto.Message):
    ...
    class State(proto.Enum):
        ...
        CLOSING = 4
        CLOSED = 5
    protocol: str = proto.Field(proto.STRING, number=1)
    local_ip_address: str = proto.Field(proto.STRING, number=2)
    local_port: int = proto.Field(proto.INT32, number=3)
    remote_ip_address: str = proto.Field(proto.STRING, number=4)
    remote_port: int = proto.Field(proto.INT32, number=5)
    state: State = proto.Field(proto.ENUM, number=6, enum=State)
    pid: int = proto.Field(proto.INT64, number=7)
    process_name: str = proto.Field(proto.STRING, number=8)
...
class GuestInstalledApplicationList(proto.Message):
    ...
    Attributes:
        entries (MutableSequence[google.cloud.migrationcenter_v1.types.GuestInstalledApplication]):
            Application entries.
    """
    entries: MutableSequence['GuestInstalledApplication'] = proto.RepeatedField(proto.MESSAGE, number=1, message='GuestInstalledApplication')
...
class GuestInstalledApplication(proto.Message):
    ...
    """
    application_name: str = proto.Field(proto.STRING, number=1)
    vendor: str = proto.Field(proto.STRING, number=2)
    install_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    path: str = proto.Field(proto.STRING, number=4)
    version: str = proto.Field(proto.STRING, number=5)
...
class OpenFileList(proto.Message):
    ...
    """
    entries: MutableSequence['OpenFileDetails'] = proto.RepeatedField(proto.MESSAGE, number=1, message='OpenFileDetails')
...
class OpenFileDetails(proto.Message):
    ...
    """
    command: str = proto.Field(proto.STRING, number=1)
    user: str = proto.Field(proto.STRING, number=2)
    file_type: str = proto.Field(proto.STRING, number=3)
    file_path: str = proto.Field(proto.STRING, number=4)
...
class PlatformDetails(proto.Message):
    ...
    Attributes:
        ...
        physical_details (google.cloud.migrationcenter_v1.types.PhysicalPlatformDetails):
            ...
            This field is a member of `oneof`_ ``vendor_details``.
    """
    vmware_details: 'VmwarePlatformDetails' = proto.Field(proto.MESSAGE, number=1, oneof='vendor_details', message='VmwarePlatformDetails')
    aws_ec2_details: 'AwsEc2PlatformDetails' = proto.Field(proto.MESSAGE, number=2, oneof='vendor_details', message='AwsEc2PlatformDetails')
    azure_vm_details: 'AzureVmPlatformDetails' = proto.Field(proto.MESSAGE, number=3, oneof='vendor_details', message='AzureVmPlatformDetails')
    generic_details: 'GenericPlatformDetails' = proto.Field(proto.MESSAGE, number=4, oneof='vendor_details', message='GenericPlatformDetails')
    physical_details: 'PhysicalPlatformDetails' = proto.Field(proto.MESSAGE, number=5, oneof='vendor_details', message='PhysicalPlatformDetails')
...
class VmwarePlatformDetails(proto.Message):
    ...
    Attributes:
        ...
        vcenter_vm_id (str):
            vCenter VM ID.
    """
    vcenter_version: str = proto.Field(proto.STRING, number=1)
    esx_version: str = proto.Field(proto.STRING, number=2)
    osid: str = proto.Field(proto.STRING, number=3)
    vcenter_folder: str = proto.Field(proto.STRING, number=4)
    vcenter_uri: str = proto.Field(proto.STRING, number=5)
    vcenter_vm_id: str = proto.Field(proto.STRING, number=6)
...
class AwsEc2PlatformDetails(proto.Message):
    ...
    Attributes:
        ...
        location (str):
            ...
            format.
    """
    machine_type_label: str = proto.Field(proto.STRING, number=1)
    location: str = proto.Field(proto.STRING, number=2)
...
class AzureVmPlatformDetails(proto.Message):
    ...
    machine_type_label: str = proto.Field(proto.STRING, number=1)
    location: str = proto.Field(proto.STRING, number=2)
    provisioning_state: str = proto.Field(proto.STRING, number=3)
...
class GenericPlatformDetails(proto.Message):
    ...
    """
    location: str = proto.Field(proto.STRING, number=1)
...
class MemoryUsageSample(proto.Message):
    ...
    Attributes:
        utilized_percentage (float):
            ...
            interval [0, 100].
    """
    utilized_percentage: float = proto.Field(proto.FLOAT, number=1)
...
class NetworkUsageSample(proto.Message):
    ...
    Attributes:
        ...
        average_egress_bps (float):
            ...
            short window. Must be non-negative.
    """
    average_ingress_bps: float = proto.Field(proto.FLOAT, number=1)
    average_egress_bps: float = proto.Field(proto.FLOAT, number=2)
...
class DiskUsageSample(proto.Message):
    ...
    """
    average_iops: float = proto.Field(proto.FLOAT, number=1)
...
class PerformanceSample(proto.Message):
    ...
    Attributes:
        ...
        disk (google.cloud.migrationcenter_v1.types.DiskUsageSample):
            Disk usage sample.
    """
    sample_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    memory: 'MemoryUsageSample' = proto.Field(proto.MESSAGE, number=2, message='MemoryUsageSample')
    cpu: 'CpuUsageSample' = proto.Field(proto.MESSAGE, number=3, message='CpuUsageSample')
    network: 'NetworkUsageSample' = proto.Field(proto.MESSAGE, number=4, message='NetworkUsageSample')
    disk: 'DiskUsageSample' = proto.Field(proto.MESSAGE, number=5, message='DiskUsageSample')
...
class AssetPerformanceData(proto.Message):
    ...
    """
    daily_resource_usage_aggregations: MutableSequence['DailyResourceUsageAggregation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DailyResourceUsageAggregation')
...
class DailyResourceUsageAggregation(proto.Message):
    ...
    class Stats(proto.Message):
        ...
        Attributes:
            ...
            peak (float):
                Peak usage value.
        """
        average: float = proto.Field(proto.FLOAT, number=1)
        median: float = proto.Field(proto.FLOAT, number=2)
        nintey_fifth_percentile: float = proto.Field(proto.FLOAT, number=3)
        peak: float = proto.Field(proto.FLOAT, number=4)
    ...
    class CPU(proto.Message):
        ...
        """
        utilization_percentage: 'DailyResourceUsageAggregation.Stats' = proto.Field(proto.MESSAGE, number=1, message='DailyResourceUsageAggregation.Stats')
    ...
    class Network(proto.Message):
        ...
        """
        ingress_bps: 'DailyResourceUsageAggregation.Stats' = proto.Field(proto.MESSAGE, number=1, message='DailyResourceUsageAggregation.Stats')
        egress_bps: 'DailyResourceUsageAggregation.Stats' = proto.Field(proto.MESSAGE, number=2, message='DailyResourceUsageAggregation.Stats')
    ...
    class Disk(proto.Message):
        ...
        """
        iops: 'DailyResourceUsageAggregation.Stats' = proto.Field(proto.MESSAGE, number=1, message='DailyResourceUsageAggregation.Stats')
    date: date_pb2.Date = proto.Field(proto.MESSAGE, number=1, message=date_pb2.Date)
    cpu: CPU = proto.Field(proto.MESSAGE, number=2, message=CPU)
    memory: Memory = proto.Field(proto.MESSAGE, number=3, message=Memory)
    network: Network = proto.Field(proto.MESSAGE, number=4, message=Network)
    disk: Disk = proto.Field(proto.MESSAGE, number=5, message=Disk)
...
class InsightList(proto.Message):
    ...
    """
    insights: MutableSequence['Insight'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Insight')
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
...
class Insight(proto.Message):
    ...
    Attributes:
        ...
        generic_insight (google.cloud.migrationcenter_v1.types.GenericInsight):
            ...
            This field is a member of `oneof`_ ``insight``.
    """
    migration_insight: 'MigrationInsight' = proto.Field(proto.MESSAGE, number=1, oneof='insight', message='MigrationInsight')
    generic_insight: 'GenericInsight' = proto.Field(proto.MESSAGE, number=2, oneof='insight', message='GenericInsight')
...
class GenericInsight(proto.Message):
    ...
    Attributes:
        ...
        additional_information (MutableSequence[str]):
            ...
            style links.
    """
    message_id: int = proto.Field(proto.INT64, number=1)
    default_message: str = proto.Field(proto.STRING, number=2)
    additional_information: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class MigrationInsight(proto.Message):
    ...
    """
    fit: 'FitDescriptor' = proto.Field(proto.MESSAGE, number=1, message='FitDescriptor')
    compute_engine_target: 'ComputeEngineMigrationTarget' = proto.Field(proto.MESSAGE, number=10, oneof='migration_target', message='ComputeEngineMigrationTarget')
...
class ComputeEngineMigrationTarget(proto.Message):
    ...
    Attributes:
        shape (google.cloud.migrationcenter_v1.types.ComputeEngineShapeDescriptor):
            ...
            migration target.
    """
    shape: 'ComputeEngineShapeDescriptor' = proto.Field(proto.MESSAGE, number=1, message='ComputeEngineShapeDescriptor')
...
class ComputeEngineShapeDescriptor(proto.Message):
    ...
    """
    memory_mb: int = proto.Field(proto.INT32, number=1)
    physical_core_count: int = proto.Field(proto.INT32, number=2)
    logical_core_count: int = proto.Field(proto.INT32, number=3)
    series: str = proto.Field(proto.STRING, number=4)
    machine_type: str = proto.Field(proto.STRING, number=5)
    storage: MutableSequence['ComputeStorageDescriptor'] = proto.RepeatedField(proto.MESSAGE, number=6, message='ComputeStorageDescriptor')
...
class ComputeStorageDescriptor(proto.Message):
    ...
    Attributes:
        ...
        size_gb (int):
            Disk size in GiB.
    """
    type_: 'PersistentDiskType' = proto.Field(proto.ENUM, number=1, enum='PersistentDiskType')
    size_gb: int = proto.Field(proto.INT32, number=2)
...
class FitDescriptor(proto.Message):
    ...
    class FitLevel(proto.Enum):
        ...
        NO_FIT = 2
        REQUIRES_EFFORT = 3
    fit_level: FitLevel = proto.Field(proto.ENUM, number=1, enum=FitLevel)
...
class Aggregation(proto.Message):
    ...
    class Histogram(proto.Message):
        ...
        """
        lower_bounds: MutableSequence[float] = proto.RepeatedField(proto.DOUBLE, number=1)

    class Frequency(proto.Message):
        """Frequency distribution of all field values."""
    field: str = proto.Field(proto.STRING, number=1)
    count: Count = proto.Field(proto.MESSAGE, number=2, oneof='aggregation_function', message=Count)
    sum: Sum = proto.Field(proto.MESSAGE, number=3, oneof='aggregation_function', message=Sum)
    histogram: Histogram = proto.Field(proto.MESSAGE, number=4, oneof='aggregation_function', message=Histogram)
    frequency: Frequency = proto.Field(proto.MESSAGE, number=5, oneof='aggregation_function', message=Frequency)
...
class AggregationResult(proto.Message):
    ...
    class Count(proto.Message):
        ...
        """
        value: int = proto.Field(proto.INT64, number=1)
    ...
    class Sum(proto.Message):
        ...
        """
        value: float = proto.Field(proto.DOUBLE, number=1)
    ...
    class Histogram(proto.Message):
        ...
        class Bucket(proto.Message):
            ...
            """
            lower_bound: float = proto.Field(proto.DOUBLE, number=1)
            upper_bound: float = proto.Field(proto.DOUBLE, number=2)
            count: int = proto.Field(proto.INT64, number=3)
        buckets: MutableSequence['AggregationResult.Histogram.Bucket'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AggregationResult.Histogram.Bucket')
    ...
    class Frequency(proto.Message):
        ...
        """
        values: MutableMapping[str, int] = proto.MapField(proto.STRING, proto.INT64, number=1)
    field: str = proto.Field(proto.STRING, number=1)
    count: Count = proto.Field(proto.MESSAGE, number=2, oneof='result', message=Count)
    sum: Sum = proto.Field(proto.MESSAGE, number=3, oneof='result', message=Sum)
    histogram: Histogram = proto.Field(proto.MESSAGE, number=4, oneof='result', message=Histogram)
    frequency: Frequency = proto.Field(proto.MESSAGE, number=5, oneof='result', message=Frequency)
...
class FileValidationReport(proto.Message):
    ...
    """
    file_name: str = proto.Field(proto.STRING, number=1)
    row_errors: MutableSequence['ImportRowError'] = proto.RepeatedField(proto.MESSAGE, number=2, message='ImportRowError')
    partial_report: bool = proto.Field(proto.BOOL, number=3)
    file_errors: MutableSequence['ImportError'] = proto.RepeatedField(proto.MESSAGE, number=4, message='ImportError')
...
class ValidationReport(proto.Message):
    ...
    """
    file_validations: MutableSequence['FileValidationReport'] = proto.RepeatedField(proto.MESSAGE, number=1, message='FileValidationReport')
    job_errors: MutableSequence['ImportError'] = proto.RepeatedField(proto.MESSAGE, number=2, message='ImportError')
...
class ExecutionReport(proto.Message):
    ...
    Attributes:
        ...
        total_rows_count (int):
            ...
            import job.
    """
    frames_reported: int = proto.Field(proto.INT32, number=1)
    execution_errors: 'ValidationReport' = proto.Field(proto.MESSAGE, number=2, message='ValidationReport')
    total_rows_count: int = proto.Field(proto.INT32, number=3)
...
class ImportError(proto.Message):
    ...
    class Severity(proto.Enum):
        ...
        WARNING = 2
        INFO = 3
    error_details: str = proto.Field(proto.STRING, number=1)
    severity: Severity = proto.Field(proto.ENUM, number=2, enum=Severity)
...
class ImportRowError(proto.Message):
    ...
    """
    row_number: int = proto.Field(proto.INT32, number=1)
    vm_name: str = proto.Field(proto.STRING, number=2)
    vm_uuid: str = proto.Field(proto.STRING, number=3)
    errors: MutableSequence['ImportError'] = proto.RepeatedField(proto.MESSAGE, number=4, message='ImportError')
...
class UploadFileInfo(proto.Message):
    ...
    Attributes:
        ...
        uri_expiration_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            URI.
    """
    signed_uri: str = proto.Field(proto.STRING, number=1)
    headers: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
    uri_expiration_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
...
class AssetList(proto.Message):
    ...
    """
    asset_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class FrameViolationEntry(proto.Message):
    ...
    """
    field: str = proto.Field(proto.STRING, number=1)
    violation: str = proto.Field(proto.STRING, number=2)
...
class VirtualMachinePreferences(proto.Message):
    ...
    Attributes:
        ...
        sole_tenancy_preferences (google.cloud.migrationcenter_v1.types.SoleTenancyPreferences):
            ...
            virtual machines.
    """
    target_product: 'ComputeMigrationTargetProduct' = proto.Field(proto.ENUM, number=2, enum='ComputeMigrationTargetProduct')
    region_preferences: 'RegionPreferences' = proto.Field(proto.MESSAGE, number=3, message='RegionPreferences')
    commitment_plan: 'CommitmentPlan' = proto.Field(proto.ENUM, number=4, enum='CommitmentPlan')
    sizing_optimization_strategy: 'SizingOptimizationStrategy' = proto.Field(proto.ENUM, number=5, enum='SizingOptimizationStrategy')
    compute_engine_preferences: 'ComputeEnginePreferences' = proto.Field(proto.MESSAGE, number=6, message='ComputeEnginePreferences')
    vmware_engine_preferences: 'VmwareEnginePreferences' = proto.Field(proto.MESSAGE, number=7, message='VmwareEnginePreferences')
    sole_tenancy_preferences: 'SoleTenancyPreferences' = proto.Field(proto.MESSAGE, number=8, message='SoleTenancyPreferences')
...
class ComputeEnginePreferences(proto.Message):
    ...
    """
    machine_preferences: 'MachinePreferences' = proto.Field(proto.MESSAGE, number=2, message='MachinePreferences')
    license_type: 'LicenseType' = proto.Field(proto.ENUM, number=3, enum='LicenseType')
...
class MachinePreferences(proto.Message):
    ...
    """
    allowed_machine_series: MutableSequence['MachineSeries'] = proto.RepeatedField(proto.MESSAGE, number=1, message='MachineSeries')
...
class MachineSeries(proto.Message):
    ...
    """
    code: str = proto.Field(proto.STRING, number=1)
...
class VmwareEnginePreferences(proto.Message):
    ...
    class CommitmentPlan(proto.Enum):
        ...
        COMMITMENT_1_YEAR_UPFRONT_PAYMENT = 4
        COMMITMENT_3_YEAR_UPFRONT_PAYMENT = 5
    cpu_overcommit_ratio: float = proto.Field(proto.DOUBLE, number=1)
    memory_overcommit_ratio: float = proto.Field(proto.DOUBLE, number=2)
    storage_deduplication_compression_ratio: float = proto.Field(proto.DOUBLE, number=3)
    commitment_plan: CommitmentPlan = proto.Field(proto.ENUM, number=4, enum=CommitmentPlan)
...
class SoleTenancyPreferences(proto.Message):
    ...
    class CommitmentPlan(proto.Enum):
        ...
        COMMITMENT_3_YEAR = 3
    cpu_overcommit_ratio: float = proto.Field(proto.DOUBLE, number=1)
    host_maintenance_policy: HostMaintenancePolicy = proto.Field(proto.ENUM, number=2, enum=HostMaintenancePolicy)
    commitment_plan: CommitmentPlan = proto.Field(proto.ENUM, number=3, enum=CommitmentPlan)
    node_types: MutableSequence['SoleTenantNodeType'] = proto.RepeatedField(proto.MESSAGE, number=4, message='SoleTenantNodeType')
...
class SoleTenantNodeType(proto.Message):
    ...
    """
    node_name: str = proto.Field(proto.STRING, number=1)
...
class RegionPreferences(proto.Message):
    ...
    """
    preferred_regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class ReportSummary(proto.Message):
    ...
    class ChartData(proto.Message):
        ...
        class DataPoint(proto.Message):
            ...
            """
            label: str = proto.Field(proto.STRING, number=1)
            value: float = proto.Field(proto.DOUBLE, number=2)
        data_points: MutableSequence['ReportSummary.ChartData.DataPoint'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReportSummary.ChartData.DataPoint')

    class UtilizationChartData(proto.Message):
        """Utilization Chart is a specific type of visualization which
        ...
        Attributes:
            ...
            free (int):
                ...
                bucket.
        """
        used: int = proto.Field(proto.INT64, number=1)
        free: int = proto.Field(proto.INT64, number=2)

    class HistogramChartData(proto.Message):
        """A Histogram Chart shows a distribution of values into
        ...
        class Bucket(proto.Message):
            ...
            Attributes:
                ...
                count (int):
                    Count of items in the bucket.
            """
            lower_bound: int = proto.Field(proto.INT64, number=1)
            upper_bound: int = proto.Field(proto.INT64, number=2)
            count: int = proto.Field(proto.INT64, number=3)
        buckets: MutableSequence['ReportSummary.HistogramChartData.Bucket'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReportSummary.HistogramChartData.Bucket')
    ...
    class AssetAggregateStats(proto.Message):
        ...
        Attributes:
            ...
            storage_bytes_histogram (google.cloud.migrationcenter_v1.types.ReportSummary.HistogramChartData):
                ...
                sizes.
        """
        total_memory_bytes: int = proto.Field(proto.INT64, number=1)
        total_storage_bytes: int = proto.Field(proto.INT64, number=2)
        total_cores: int = proto.Field(proto.INT64, number=3)
        total_assets: int = proto.Field(proto.INT64, number=4)
        memory_utilization_chart: 'ReportSummary.UtilizationChartData' = proto.Field(proto.MESSAGE, number=5, message='ReportSummary.UtilizationChartData')
        storage_utilization_chart: 'ReportSummary.UtilizationChartData' = proto.Field(proto.MESSAGE, number=6, message='ReportSummary.UtilizationChartData')
        operating_system: 'ReportSummary.ChartData' = proto.Field(proto.MESSAGE, number=7, message='ReportSummary.ChartData')
        core_count_histogram: 'ReportSummary.HistogramChartData' = proto.Field(proto.MESSAGE, number=8, message='ReportSummary.HistogramChartData')
        memory_bytes_histogram: 'ReportSummary.HistogramChartData' = proto.Field(proto.MESSAGE, number=9, message='ReportSummary.HistogramChartData')
        storage_bytes_histogram: 'ReportSummary.HistogramChartData' = proto.Field(proto.MESSAGE, number=10, message='ReportSummary.HistogramChartData')

    class MachineSeriesAllocation(proto.Message):
        """Represents a data point tracking the count of assets
        ...
        Attributes:
            ...
            allocated_asset_count (int):
                ...
                series.
        """
        machine_series: 'MachineSeries' = proto.Field(proto.MESSAGE, number=1, message='MachineSeries')
        allocated_asset_count: int = proto.Field(proto.INT64, number=2)

    class ComputeEngineFinding(proto.Message):
        """A set of findings that applies to assets destined for Compute
        Engine.
        ...
        """
        allocated_regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        allocated_asset_count: int = proto.Field(proto.INT64, number=2)
        machine_series_allocations: MutableSequence['ReportSummary.MachineSeriesAllocation'] = proto.RepeatedField(proto.MESSAGE, number=3, message='ReportSummary.MachineSeriesAllocation')
    ...
    class VmwareEngineFinding(proto.Message):
        """A set of findings that applies to assets destined for VMWare
        Engine.
        ...
        allocated_regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        allocated_asset_count: int = proto.Field(proto.INT64, number=2)
        node_allocations: MutableSequence['ReportSummary.VmwareNodeAllocation'] = proto.RepeatedField(proto.MESSAGE, number=3, message='ReportSummary.VmwareNodeAllocation')
    ...
    class VmwareNodeAllocation(proto.Message):
        ...
        """
        vmware_node: 'ReportSummary.VmwareNode' = proto.Field(proto.MESSAGE, number=1, message='ReportSummary.VmwareNode')
        node_count: int = proto.Field(proto.INT64, number=2)
        allocated_asset_count: int = proto.Field(proto.INT64, number=3)
    ...
    class SoleTenantFinding(proto.Message):
        """A set of findings that applies to assets destined for
        Sole-Tenant nodes.
        ...
        allocated_regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        allocated_asset_count: int = proto.Field(proto.INT64, number=2)
        node_allocations: MutableSequence['ReportSummary.SoleTenantNodeAllocation'] = proto.RepeatedField(proto.MESSAGE, number=3, message='ReportSummary.SoleTenantNodeAllocation')

    class SoleTenantNodeAllocation(proto.Message):
        """Represents the assets allocated to a specific Sole-Tenant
        node type.
        ...
        Attributes:
            ...
            allocated_asset_count (int):
                Count of assets allocated to these nodes
        """
        node: 'SoleTenantNodeType' = proto.Field(proto.MESSAGE, number=1, message='SoleTenantNodeType')
        node_count: int = proto.Field(proto.INT64, number=2)
        allocated_asset_count: int = proto.Field(proto.INT64, number=3)
    ...
    class GroupPreferenceSetFinding(proto.Message):
        ...
        machine_preferences: 'VirtualMachinePreferences' = proto.Field(proto.MESSAGE, number=3, message='VirtualMachinePreferences')
        monthly_cost_total: money_pb2.Money = proto.Field(proto.MESSAGE, number=4, message=money_pb2.Money)
        monthly_cost_compute: money_pb2.Money = proto.Field(proto.MESSAGE, number=5, message=money_pb2.Money)
        monthly_cost_os_license: money_pb2.Money = proto.Field(proto.MESSAGE, number=6, message=money_pb2.Money)
        monthly_cost_network_egress: money_pb2.Money = proto.Field(proto.MESSAGE, number=7, message=money_pb2.Money)
        monthly_cost_storage: money_pb2.Money = proto.Field(proto.MESSAGE, number=8, message=money_pb2.Money)
        monthly_cost_other: money_pb2.Money = proto.Field(proto.MESSAGE, number=9, message=money_pb2.Money)
        compute_engine_finding: 'ReportSummary.ComputeEngineFinding' = proto.Field(proto.MESSAGE, number=10, message='ReportSummary.ComputeEngineFinding')
        vmware_engine_finding: 'ReportSummary.VmwareEngineFinding' = proto.Field(proto.MESSAGE, number=11, message='ReportSummary.VmwareEngineFinding')
        sole_tenant_finding: 'ReportSummary.SoleTenantFinding' = proto.Field(proto.MESSAGE, number=12, message='ReportSummary.SoleTenantFinding')
    ...
    class GroupFinding(proto.Message):
        ...
        display_name: str = proto.Field(proto.STRING, number=1)
        description: str = proto.Field(proto.STRING, number=2)
        asset_aggregate_stats: 'ReportSummary.AssetAggregateStats' = proto.Field(proto.MESSAGE, number=3, message='ReportSummary.AssetAggregateStats')
        overlapping_asset_count: int = proto.Field(proto.INT64, number=4)
        preference_set_findings: MutableSequence['ReportSummary.GroupPreferenceSetFinding'] = proto.RepeatedField(proto.MESSAGE, number=5, message='ReportSummary.GroupPreferenceSetFinding')
    all_assets_stats: AssetAggregateStats = proto.Field(proto.MESSAGE, number=1, message=AssetAggregateStats)
    group_findings: MutableSequence[GroupFinding] = proto.RepeatedField(proto.MESSAGE, number=2, message=GroupFinding)
