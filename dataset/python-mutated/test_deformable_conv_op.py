...
def deform_conv2d_wrapper(x, offset, weight, mask=None, stride=1, padding=0, dilation=1, deformable_groups=1, groups=1, im2col_step=1):
    if False:
        return 10
    return paddle.vision.ops.deform_conv2d(x, offset, weight, None, stride, padding, dilation, deformable_groups, groups, mask)
...
class TestModulatedDeformableConvOp(OpTest):
    ...
    def test_check_grad(self):
        if False:
            for i in range(10):
                print('nop')
        self.check_grad({'Input', 'Offset', 'Mask', 'Filter'}, 'Output', max_relative_error=0.05)
...
class TestModulatedDeformableConvInvalidInput(unittest.TestCase):
    ...
    def test_error(self):
        ...
        def test_invalid_input():
            ...
            paddle.enable_static()
            input = [1, 3, 32, 32]
            offset = paddle.static.data(name='offset', shape=[None, 3, 32, 32], dtype='float32')
            mask = paddle.static.data(name='mask', shape=[None, 3, 32, 32], dtype='float32')
            loss = paddle.static.nn.common.deformable_conv(input, offset, mask, num_filters=4, filter_size=1)
        ...
        def test_invalid_offset():
            if False:
                print('Hello World!')
            paddle.enable_static()
            input = paddle.static.data(name='input', shape=[None, 3, 32, 32], dtype='int32')
            offset = paddle.static.data(name='offset', shape=[None, 3, 32, 32], dtype='float32')
            mask = paddle.static.data(name='mask', shape=[None, 3, 32, 32], dtype='float32')
            loss = paddle.static.nn.common.deformable_conv(input, offset, mask, num_filters=4, filter_size=1)
        ...
        def test_invalid_filter():
            if False:
                return 10
            paddle.enable_static()
            input = paddle.static.data(name='input_filter', shape=[None, 3, 32, 32], dtype='float32')
            offset = paddle.static.data(name='offset_filter', shape=[None, 3, 32, 32], dtype='float32')
            mask = paddle.static.data(name='mask_filter', shape=[None, 3, 32, 32], dtype='float32')
            loss = paddle.static.nn.common.deformable_conv(input, offset, mask, num_filters=4, filter_size=0)
        ...
        def test_invalid_groups():
            if False:
                print('Hello World!')
            paddle.enable_static()
            input = paddle.static.data(name='input_groups', shape=[1, 1, 1, 1], dtype='float32')
            offset = paddle.static.data(name='offset_groups', shape=[1, 1], dtype='float32')
            mask = paddle.static.data(name='mask_groups', shape=[1], dtype='float32')
            paddle.static.nn.deform_conv2d(input, offset, mask, 1, 1, padding=1, groups=0)
    ...
    def test_api(self):
        ...
        def test_deform_conv2d_v1():
            if False:
                print('Hello World!')
            paddle.enable_static()
            input = paddle.static.data(name='input_v1', shape=[None, 3, 32, 32], dtype='float32')
            offset = paddle.static.data(name='offset_v1', shape=[None, 4, 32, 32], dtype='float32')
            out = paddle.static.nn.deform_conv2d(input, offset, None, num_filters=4, filter_size=1)
        ...
        def test_deform_conv2d_v2():
            if False:
                while True:
                    i = 10
            paddle.enable_static()
            input = paddle.static.data(name='input_v2', shape=[None, 3, 32, 32], dtype='float32')
            offset = paddle.static.data(name='offset_v2', shape=[None, 4, 32, 32], dtype='float32')
            mask = paddle.static.data(name='mask_v2', shape=[None, 2, 32, 32], dtype='float32')
            out = paddle.static.nn.deform_conv2d(input, offset, mask, num_filters=4, filter_size=1)
            assert out.shape == (-1, 4, 32, 32)
