...
from ...utils import convert_catalogue_info_into_predicate, get_product_ids_for_predicate
...
class SaleBaseCatalogueMutation(BaseMutation):
    ...
    class Arguments:
        ...
        input = CatalogueInput(required=True, description='Fields required to modify catalogue IDs of sale.')
