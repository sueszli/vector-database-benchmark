...
MASK2FORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {'facebook/mask2former-swin-small-coco-instance': 'https://huggingface.co/facebook/mask2former-swin-small-coco-instance/blob/main/config.json'}
