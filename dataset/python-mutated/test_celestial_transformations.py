...
from astropy.coordinates import CartesianDifferential, CartesianRepresentation, EarthLocation, SkyCoord, galactocentric_frame_defaults
from astropy.coordinates.builtin_frames import CIRS, FK4, FK5, GCRS, HCRS, ICRS, LSR, FK4NoETerms, Galactic, GalacticLSR, Galactocentric, Supergalactic
from astropy.coordinates.distances import Distance
from astropy.tests.helper import assert_quantity_allclose as assert_allclose
from astropy.time import Time
from astropy.units import allclose
m31_sys = [ICRS, FK5, FK4, Galactic]
m31_coo = [(10.6847929, 41.269065), (10.6847929, 41.269065), (10.0004738, 40.9952444), (121.174405, -21.572936)]
m31_dist = Distance(770, u.kpc)
convert_precision = 1 * u.arcsec
roundtrip_precision = 0.0001 * u.degree
dist_precision = 1e-09 * u.kpc
m31_params = []
