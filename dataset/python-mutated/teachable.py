...
from ..utils import clean_html, ExtractorError, int_or_none, get_element_by_class, strip_or_none, urlencode_postdata, urljoin

class TeachableBaseIE(InfoExtractor):
    _NETRC_MACHINE = 'teachable'
    _URL_PREFIX = 'teachable:'
    _SITES = {'v1.upskillcourses.com': 'upskill', 'gns3.teachable.com': 'gns3', 'academyhacker.com': 'academyhacker', 'stackskills.com': 'stackskills', 'market.saleshacker.com': 'saleshacker', 'learnability.org': 'learnability', 'edurila.com': 'edurila', 'courses.workitdaily.com': 'workitdaily'}
...
class TeachableIE(TeachableBaseIE):
    ...
    _TESTS = [{'url': 'https://gns3.teachable.com/courses/gns3-certified-associate/lectures/6842364', 'info_dict': {'id': 'untlgzk1v7', 'ext': 'bin', 'title': 'Overview', 'description': 'md5:071463ff08b86c208811130ea1c2464c', 'duration': 736.4, 'timestamp': 1542315762, 'upload_date': '20181115', 'chapter': 'Welcome', 'chapter_number': 1}, 'params': {'skip_download': True}}, {'url': 'http://v1.upskillcourses.com/courses/119763/lectures/1747100', 'only_matching': True}, {'url': 'https://gns3.teachable.com/courses/423415/lectures/6885939', 'only_matching': True}, {'url': 'teachable:https://v1.upskillcourses.com/courses/essential-web-developer-course/lectures/1747100', 'only_matching': True}]
...
class TeachableCourseIE(TeachableBaseIE):
    ...
    _TESTS = [{'url': 'http://v1.upskillcourses.com/courses/essential-web-developer-course/', 'info_dict': {'id': 'essential-web-developer-course', 'title': 'The Essential Web Developer Course (Free)'}, 'playlist_count': 192}, {'url': 'http://v1.upskillcourses.com/courses/119763/', 'only_matching': True}, {'url': 'http://v1.upskillcourses.com/courses/enrolled/119763', 'only_matching': True}, {'url': 'https://gns3.teachable.com/courses/enrolled/423415', 'only_matching': True}, {'url': 'teachable:https://learn.vrdev.school/p/gear-vr-developer-mini', 'only_matching': True}, {'url': 'teachable:https://filmsimplified.com/p/davinci-resolve-15-crash-course', 'only_matching': True}]
