...
workspace.GlobalInit(['caffe2', '--glow_global_fp16=1', '--glow_global_fused_scale_offset_fp16=1', '--glow_global_force_sls_fp16_accum=1'])
GLOW_MATMUL_ATOL = 1e-05
GLOW_MATMUL_RTOL = 0.001
