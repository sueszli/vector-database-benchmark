...
class MissingDataDiscreteHMM(TorchDistribution):
    ...
    """
    arg_constraints = {'initial_logits': constraints.real_vector, 'transition_logits': constraints.independent(constraints.real, 2), 'observation_logits': constraints.independent(constraints.real, 2)}
