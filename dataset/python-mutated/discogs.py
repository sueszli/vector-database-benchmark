...
class DiscogsReleasePlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.discogs.com/release/1-The-Persuader-Stockholm', 'info_dict': {'id': 'release1', 'title': 'Stockholm'}, 'playlist_mincount': 7}, {'url': 'https://www.discogs.com/master/113-Vince-Watson-Moments-In-Time', 'info_dict': {'id': 'master113', 'title': 'Moments In Time'}, 'playlist_mincount': 53}]
