...
def create_with_subnet(project_id: str, zone: str, instance_name: str, network_link: str, subnet_link: str) -> compute_v1.Instance:
    if False:
        print('Hello World!')
    ...
    instance = create_instance(project_id, zone, instance_name, disks, network_link=network_link, subnetwork_link=subnet_link)
    return instance