...
app.layout = html.Div([dcc.Input(id='input', value='AAA'), html.Button(id='run-button', children='Run'), html.Div(id='status', children='Finished'), html.Div(id='result', children='No results')])
