...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_name', type=str, default='', help='Checkpoint filename. Note, if using Checkpoint V2 format, file_name is the shared prefix between all files in the checkpoint.')
    parser.add_argument('--tensor_name', type=str, default='', help='Name of the tensor to inspect')
    parser.add_argument('--count_exclude_pattern', type=str, default='', help='Pattern to exclude tensors, e.g., from optimizers, when counting.')
    parser.add_argument('--all_tensors', nargs='?', const=True, type='bool', default=False, help='If True, print the names and values of all the tensors.')
    parser.add_argument('--all_tensor_names', nargs='?', const=True, type='bool', default=False, help='If True, print the names of all the tensors.')
    parser.add_argument('--printoptions', nargs='*', type=parse_numpy_printoption, help="Argument for numpy.set_printoptions(), in the form 'k=v'.")
