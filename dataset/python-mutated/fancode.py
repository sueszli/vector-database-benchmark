...
from ..utils import parse_iso8601, ExtractorError, try_get, mimetype2ext

class FancodeVodIE(InfoExtractor):
    IE_NAME = 'fancode:vod'
    _VALID_URL = 'https?://(?:www\\.)?fancode\\.com/video/(?P<id>[0-9]+)\\b'
    _TESTS = [{'url': 'https://fancode.com/video/15043/match-preview-pbks-vs-mi', 'params': {'skip_download': True}, 'info_dict': {'id': '6249806281001', 'ext': 'mp4', 'title': 'Match Preview: PBKS vs MI', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1619081590, 'view_count': int, 'like_count': int, 'upload_date': '20210422', 'uploader_id': '6008340455001'}}, {'url': 'https://fancode.com/video/15043', 'only_matching': True}]
    _ACCESS_TOKEN = None
    _NETRC_MACHINE = 'fancode'
    _LOGIN_HINT = 'Use "--username refresh --password <refresh_token>" to login using a refresh token'
    headers = {'content-type': 'application/json', 'origin': 'https://fancode.com', 'referer': 'https://fancode.com'}
...
class FancodeLiveIE(FancodeVodIE):
    ...
    _TESTS = [{'url': 'https://fancode.com/match/35328/cricket-fancode-ecs-hungary-2021-bub-vs-blb?slug=commentary', 'info_dict': {'id': '35328', 'ext': 'mp4', 'title': 'BUB vs BLB', 'timestamp': 1624863600, 'is_live': True, 'upload_date': '20210628'}, 'skip': 'Ended'}, {'url': 'https://fancode.com/match/35328/', 'only_matching': True}, {'url': 'https://fancode.com/match/35567?slug=scorecard', 'only_matching': True}]
