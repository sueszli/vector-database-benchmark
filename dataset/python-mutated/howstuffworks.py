...
from ..utils import find_xpath_attr, int_or_none, js_to_json, unescapeHTML, determine_ext
...
class HowStuffWorksIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.stufftoblowyourmind.com/videos/optical-illusions-video.htm', 'md5': '76646a5acc0c92bf7cd66751ca5db94d', 'info_dict': {'id': '855410', 'ext': 'mp4', 'title': 'Your Trickster Brain: Optical Illusions -- Science on the Web', 'description': 'md5:e374ff9561f6833ad076a8cc0a5ab2fb'}}, {'url': 'http://shows.howstuffworks.com/more-shows/why-does-balloon-stick-to-hair-video.htm', 'only_matching': True}]
