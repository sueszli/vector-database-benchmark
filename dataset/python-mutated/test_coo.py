...
@testing.parameterize(*testing.product({'dtype': '?fdFD'}))
class TestCooMatrix:
...
@testing.parameterize(*testing.product({'make_method': ['_make', '_make_unordered', '_make_empty', '_make_duplicate', '_make_shape'], 'dtype': 'fdFD'}))
@testing.with_requires('scipy')
