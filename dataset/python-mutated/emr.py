...
from airflow.providers.amazon.aws.triggers.emr import EmrContainerTrigger, EmrStepSensorTrigger, EmrTerminateJobFlowTrigger
...
class EmrJobFlowSensor(EmrBaseSensor):
    ...
    template_ext: Sequence[str] = ()
    operator_extra_links = (EmrClusterLink(), EmrLogsLink())
