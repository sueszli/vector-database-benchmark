...
from qt.core import QAbstractListModel, QAbstractTableModel, QCursor, QDialog, QDialogButtonBox, QFrame, QIcon, QLabel, QMenu, QScrollArea, Qt, QVBoxLayout, QWidget, pyqtSignal
