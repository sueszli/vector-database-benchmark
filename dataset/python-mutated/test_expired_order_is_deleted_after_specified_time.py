...
@pytest.mark.e2e
def test_expired_order_is_deleted_after_specified_time_CORE_0216(e2e_staff_api_client, e2e_app_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_payments, permission_handle_checkouts):
    if False:
        return 10
    ...
    channel_update_input = {'orderSettings': {'allowUnpaidOrders': True, 'automaticallyFulfillNonShippableGiftCard': True, 'automaticallyConfirmAllNewOrders': True, 'expireOrdersAfter': expire_order_after_in_minutes, 'deleteExpiredOrdersAfter': delete_expired_order_after_in_days}}
    ...
    expired_orders_settings = order_data['order']['channel']['orderSettings']['expireOrdersAfter']
    delete_expired_orders_settings = order_data['order']['channel']['orderSettings']['deleteExpiredOrdersAfter']
