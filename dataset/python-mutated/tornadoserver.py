...
DEFAULT_CERTS: dict[str, typing.Any] = {'certfile': os.path.join(CERTS_PATH, 'server.crt'), 'keyfile': os.path.join(CERTS_PATH, 'server.key'), 'cert_reqs': ssl.CERT_OPTIONAL, 'ca_certs': os.path.join(CERTS_PATH, 'cacert.pem'), 'alpn_protocols': ALPN_PROTOCOLS}
