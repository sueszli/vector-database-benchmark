...
from .facelib.align_trans import get_f5p, get_reference_facial_points, warp_and_crop_face, warp_and_crop_face_enhance
...
@MODELS.register_module(Tasks.image_face_fusion, module_name=Models.image_face_fusion)
