...
AnomalyDetectorEnvPreparer = functools.partial(PowerShellPreparer, 'anomaly_detector', anomaly_detector_endpoint='https://fake_ad_resource.cognitiveservices.azure.com/', anomaly_detector_key='00000000000000000000000000000000')
