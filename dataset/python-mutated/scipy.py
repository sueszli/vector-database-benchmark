...
class ScipyFrontendConfig(FrontendConfig):
    ...
    valid_dtypes = ['int8', 'int16', 'int32', 'int64', 'uint8', 'float16', 'float32', 'float64', 'complex64', 'complex128', 'bool']
    invalid_dtypes = ['uint16', 'uint32', 'uint64', 'bfloat16']
    valid_numeric_dtypes = ['int8', 'int16', 'int32', 'int64', 'uint8', 'float16', 'float32', 'float64', 'complex64', 'complex128']
    invalid_numeric_dtypes = ['uint16', 'uint32', 'uint64', 'bfloat16']
    valid_int_dtypes = ['int8', 'int16', 'int32', 'int64', 'uint8']
    invalid_int_dtypes = ['uint16', 'uint32', 'uint64']
    valid_uint_dtypes = ['uint8']
    invalid_uint_dtypes = ['uint16', 'uint32', 'uint64']
