...
def build_get_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.BotService/listQnAMakerEndpointKeys')
...
class QnAMakerEndpointKeysOperations:
    ...
    @overload
    def get(self, parameters: _models.QnAMakerEndpointKeysRequestBody, *, content_type: str='application/json', **kwargs: Any) -> _models.QnAMakerEndpointKeysResponse:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    def get(self, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.QnAMakerEndpointKeysResponse:
        if False:
            return 10
        'Lists the QnA Maker endpoint keys.\n\n        :param parameters: The request body parameters to provide for the check name availability\n         request. Required.\n        :type parameters: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: QnAMakerEndpointKeysResponse or the result of cls(response)\n        :rtype: ~azure.mgmt.botservice.models.QnAMakerEndpointKeysResponse\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def get(self, parameters: Union[_models.QnAMakerEndpointKeysRequestBody, IO], **kwargs: Any) -> _models.QnAMakerEndpointKeysResponse:
        if False:
            return 10
        "Lists the QnA Maker endpoint keys.\n\n        :param parameters: The request body parameters to provide for the check name availability\n         request. Is either a model type or a IO type. Required.\n        :type parameters: ~azure.mgmt.botservice.models.QnAMakerEndpointKeysRequestBody or IO\n        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.\n         Default value is None.\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: QnAMakerEndpointKeysResponse or the result of cls(response)\n        :rtype: ~azure.mgmt.botservice.models.QnAMakerEndpointKeysResponse\n        :raises ~azure.core.exceptions.HttpResponseError:\n        "
        ...
        request = build_get_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.get.metadata['url'], headers=_headers, params=_params)
