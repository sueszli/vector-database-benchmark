...
parser.add_argument('count', nargs='?', default=64, help='Leak size in bytes')
parser.add_argument('--max-distance', type=int, default=0, help='Max acceptable distance between memory page boundary and leaked pointer')
parser.add_argument('--point-to', type=str, default=None, help='Mapping name of the page that you want the pointers point to')
parser.add_argument('--max-ptrs', type=int, default=0, help='Stop search after find n pointers, default 0')
parser.add_argument('--flags', type=str, default=None, help='flags of the page that you want the pointers point to. [e.g. rwx]')
