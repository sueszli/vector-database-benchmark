...
from AnyQt.QtWidgets import QGraphicsWidget, QGraphicsGridLayout, QGraphicsRectItem, QStyleOptionGraphicsItem, QSizePolicy, QWidget, QVBoxLayout, QGraphicsSimpleTextItem, QWIDGETSIZE_MAX, QGraphicsSceneHelpEvent, QToolTip, QApplication
...
class OWSilhouettePlot(widget.OWWidget):
    ...
    description = 'Visually assess cluster quality and the degree of cluster membership.'
    ...
    replaces = ['orangecontrib.prototypes.widgets.owsilhouetteplot.OWSilhouettePlot', 'Orange.widgets.unsupervised.owsilhouetteplot.OWSilhouettePlot']
    ...
    Distances = [('Euclidean', Orange.distance.Euclidean), ('Manhattan', Orange.distance.Manhattan), ('Cosine', Orange.distance.Cosine)]
    graph_name = 'scene'
    ...
    class Warning(widget.OWWidget.Warning):
        missing_cluster_assignment = Msg('{} instance{s} omitted (missing cluster assignment)')
