...
if __name__ == '__main__':
    bench_parameters = dict(input_data_size=int(20000000.0), output_data_size=int(100000.0), n_jobs=2, verbose=10)
    ...
    high_variance = np.random.normal(loc=1e-06, scale=0.001, size=5000)
