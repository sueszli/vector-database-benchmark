...
if __name__ == '__main__':
    ...
    parser.add_argument('--no-black-binary', help='do not use pre-compiled binaries from pip for black.', action='store_true')
    ...
    for package in args.packages:
        ...
        if version == '':
            raise RuntimeError('Package {package_name} did not have a version specified. Please specify a version to produce a consistent linting experience.')
