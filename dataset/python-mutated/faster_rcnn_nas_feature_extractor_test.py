...
class FasterRcnnNASFeatureExtractorTest(tf.test.TestCase):
    ...
    def _build_feature_extractor(self, first_stage_features_stride):
        if False:
            i = 10
            return i + 15
        return frcnn_nas.FasterRCNNNASFeatureExtractor(is_training=False, first_stage_features_stride=first_stage_features_stride, batch_norm_trainable=False, reuse_weights=None, weight_decay=0.0)
