...
class DuplicateBlogTitleErrorTests(base_validation_errors_test.AuditErrorsTestBase):
...
class DuplicateBlogUrlErrorTests(base_validation_errors_test.AuditErrorsTestBase):
...
class DuplicateBlogAuthorModelErrorTests(base_validation_errors_test.AuditErrorsTestBase):
...
class InconsistentLastUpdatedTimestampsErrorTests(base_validation_errors_test.AuditErrorsTestBase):
...
class InconsistentPublishLastUpdatedTimestampsErrorTests(base_validation_errors_test.AuditErrorsTestBase):
...
class ModelMutatedDuringJobErrorTests(base_validation_errors_test.AuditErrorsTestBase):
