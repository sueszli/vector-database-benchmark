...
from ..utils import try_get, int_or_none, url_or_none, float_or_none, unified_timestamp

class BannedVideoIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?banned\\.video/watch\\?id=(?P<id>[0-f]{24})'
    _TESTS = [{'url': 'https://banned.video/watch?id=5e7a859644e02200c6ef5f11', 'md5': '14b6e81d41beaaee2215cd75c6ed56e4', 'info_dict': {'id': '5e7a859644e02200c6ef5f11', 'ext': 'mp4', 'title': 'China Discovers Origin of Corona Virus: Issues Emergency Statement', 'thumbnail': 're:^https?://(?:www\\.)?assets\\.infowarsmedia.com/images/', 'description': 'md5:560d96f02abbebe6c6b78b47465f6b28', 'upload_date': '20200324', 'timestamp': 1585087895}}]
    ...
    _GRAPHQL_QUERIES = {'GetVideoAndComments': _GRAPHQL_GETMETADATA_QUERY, 'GetCommentReplies': _GRAPHQL_GETCOMMENTSREPLIES_QUERY}
