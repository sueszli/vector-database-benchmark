...
class SuperResK3K3(SuperResKXKX):
    ...
    def __init__(self, in_channels=None, out_channels=None, stride=None, bottleneck_channels=None, sub_layers=None, no_create=False, **kwargs):
        if False:
            print('Hello World!')
        super(SuperResK3K3, self).__init__(in_channels=in_channels, out_channels=out_channels, stride=stride, bottleneck_channels=bottleneck_channels, sub_layers=sub_layers, kernel_size=3, no_create=no_create, **kwargs)
...
class SuperResK5K5(SuperResKXKX):
    ...
    def __init__(self, in_channels=None, out_channels=None, stride=None, bottleneck_channels=None, sub_layers=None, no_create=False, **kwargs):
        if False:
            print('Hello World!')
        super(SuperResK5K5, self).__init__(in_channels=in_channels, out_channels=out_channels, stride=stride, bottleneck_channels=bottleneck_channels, sub_layers=sub_layers, kernel_size=5, no_create=no_create, **kwargs)
...
class SuperResK7K7(SuperResKXKX):
    ...
    def __init__(self, in_channels=None, out_channels=None, stride=None, bottleneck_channels=None, sub_layers=None, no_create=False, **kwargs):
        if False:
            while True:
                i = 10
        super(SuperResK7K7, self).__init__(in_channels=in_channels, out_channels=out_channels, stride=stride, bottleneck_channels=bottleneck_channels, sub_layers=sub_layers, kernel_size=7, no_create=no_create, **kwargs)

def register_netblocks_dict(netblocks_dict: dict):
    if False:
        for i in range(10):
            print('nop')
    this_py_file_netblocks_dict = {'SuperResK3K3': SuperResK3K3, 'SuperResK5K5': SuperResK5K5, 'SuperResK7K7': SuperResK7K7}
