...
from tests.aws.services.lambda_.test_lambda import JAVA_TEST_RUNTIMES, NODE_TEST_RUNTIMES, PYTHON_TEST_RUNTIMES, TEST_LAMBDA_JAVA_MULTIPLE_HANDLERS, TEST_LAMBDA_JAVA_WITH_LIB, TEST_LAMBDA_NODEJS_ES6, TEST_LAMBDA_PYTHON, TEST_LAMBDA_PYTHON_VERSION, THIS_FOLDER, read_streams
