...
if __name__ == '__main__':
    ...
    fun(data)
    if args.inputs == '':
        fun.dump(args.dir + '/add_demo_f32_without_data.mge', arg_names=['data'], no_assert=True)
    else:
        fun.dump(args.dir + '/add_demo_f32_with_data.mge', arg_names=['data'], input_data=[args.inputs], no_assert=True)