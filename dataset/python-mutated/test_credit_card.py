...
class TestCreditCardProvider:
    ...
    mastercard_pattern: Pattern = re.compile('(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}')
    visa_pattern: Pattern = re.compile('4[0-9]{12}([0-9]{3}){0,2}')
    discover_pattern: Pattern = re.compile('6(?:011|5[0-9]{2})[0-9]{12}')
    diners_club_pattern: Pattern = re.compile('3(?:0[0-5]|[68][0-9])[0-9]{11}')
    jcb_pattern: Pattern = re.compile('(?:2131|1800|35\\d{3})\\d{11}')
...
class TestRuRu:
    ...
    visa_pattern: Pattern = re.compile('4[0-9]{15}')
    mastercard_pattern: Pattern = re.compile('(?:5[1-5][0-9]{2}|222[1-9]|22[3-9][0-9]|2[3-6][0-9]{2}|27[01][0-9]|2720)[0-9]{12}')
    mir_pattern: Pattern = re.compile('220[0-4][0-9]{12}')
    maestro_pattern: Pattern = re.compile('(?:50|5[6-9]|6[0-9])[0-9]{14}')
    amex_pattern: Pattern = re.compile('3[4|7][0-9]{13}')
    unionpay_pattern: Pattern = re.compile('(?:62|81)[0-9]{14}')
...
class TestPtPt:
    ...
    visa_pattern: Pattern = re.compile('4[0-9]{15}')
    mastercard_pattern: Pattern = re.compile('5[1-5][0-9]{14}')
    maestro_pattern: Pattern = re.compile('(50|67)[0-9]{14}')
