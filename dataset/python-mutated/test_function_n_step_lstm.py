...
@testing.parameterize(*testing.product_dict([{'n_layers': 1, 'hidden_size': 2, 'input_size': 1, 'batches': (1, 1, 1)}, {'n_layers': 2, 'hidden_size': 2, 'input_size': 3, 'batches': (3, 2, 1)}, {'n_layers': 4, 'hidden_size': 6, 'input_size': 3, 'batches': (5, 3, 1)}, {'n_layers': 5, 'hidden_size': 10, 'input_size': 6, 'batches': (6, 5, 3)}]))
@testing.fix_random()
...
@testing.parameterize(*testing.product({'use_cudnn': ['always', 'auto', 'never']}))
@attr.cudnn
