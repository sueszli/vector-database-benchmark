...
_VTP_VLANINFO_TLV_TYPE = {1: 'Source-Routing Ring Number', 2: 'Source-Routing Bridge Number', 3: 'Spanning-Tree Protocol Type', 4: 'Parent VLAN', 5: 'Translationally Bridged VLANs', 6: 'Pruning', 7: 'Bridge Type', 8: 'Max ARE Hop Count', 9: 'Max STE Hop Count', 10: 'Backup CRF Mode'}
...
class VTP(Packet):
    ...
    def post_build(self, p, pay):
        ...
        if self.domnamelen is None:
            ...
            p = p[:3] + chb(domnamelen & 255) + p[4:]
        p += pay
        return p
bind_layers(SNAP, VTP, code=8195)
