...
from ..utils import parse_duration, parse_filesize, extract_attributes, int_or_none, js_to_json

class VuploadIE(InfoExtractor):
    _VALID_URL = 'https://vupload\\.com/v/(?P<id>[a-z0-9]+)'
    _TESTS = [{'url': 'https://vupload.com/v/u28d0pl2tphy', 'md5': '9b42a4a193cca64d80248e58527d83c8', 'info_dict': {'id': 'u28d0pl2tphy', 'ext': 'mp4', 'description': 'md5:e9e6c0045c78cbf0d5bb19a55ce199fb', 'title': 'md5:e9e6c0045c78cbf0d5bb19a55ce199fb'}}]
