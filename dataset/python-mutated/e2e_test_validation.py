...
NULLABLE_ONLINE_STORE_CONFIGS: List[IntegrationTestRepoConfig] = [IntegrationTestRepoConfig(provider='local', offline_store_creator=FileDataSourceCreator, online_store=None), IntegrationTestRepoConfig(provider='local', offline_store_creator=FileParquetDatasetSourceCreator, online_store=None)]
if os.getenv('FEAST_IS_LOCAL_TEST', 'False') != 'True':
    NULLABLE_ONLINE_STORE_CONFIGS.extend([IntegrationTestRepoConfig(provider='gcp', offline_store_creator=BigQueryDataSourceCreator, online_store=None), IntegrationTestRepoConfig(provider='aws', offline_store_creator=RedshiftDataSourceCreator, online_store=None)])
