...
from typing import TYPE_CHECKING, Any, Callable, Dict, Generic, List, Mapping, NamedTuple, Optional, Tuple, TypeVar, Union, cast
from typing_extensions import Annotated, Protocol, get_origin
from strawberry.annotation import StrawberryAnnotation
from strawberry.arguments import StrawberryArgument
from strawberry.exceptions import ConflictingArgumentsError, MissingArgumentsAnnotationsError
...
class StrawberryResolver(Generic[T]):
    RESERVED_PARAMSPEC: Tuple[ReservedParameterSpecification, ...] = (SELF_PARAMSPEC, CLS_PARAMSPEC, ROOT_PARAMSPEC, INFO_PARAMSPEC, PARENT_PARAMSPEC)
