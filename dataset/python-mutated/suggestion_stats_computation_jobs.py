...
import result
from typing import Dict, Iterable, Iterator, List, Optional, Set, Tuple, Type, TypedDict, Union
MYPY = False
if MYPY:
...
class AuditGenerateContributionStatsJob(GenerateContributionStatsJob):
