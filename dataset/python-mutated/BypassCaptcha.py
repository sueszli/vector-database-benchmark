...
class BypassCaptcha(BaseAddon):
    ...
    __version__ = '0.14'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('passkey', 'password', 'Access key', ''), ('check_client', 'bool', "Don't use if client is connected", True)]
    __description__ = 'Send captchas to BypassCaptcha.com'
    __license__ = 'GPLv3'
    __authors__ = [('RaNaN', 'RaNaN@pyload.net'), ('Godofdream', 'soilfcition@gmail.com'), ('zoidberg', 'zoidberg@mujmail.cz')]
