...
def gen_build_workflows_tree():
    ...
    return rc
YAML_SOURCES = [File('header-section.yml'), File('commands.yml'), File('nightly-binary-build-defaults.yml'), Header('Build parameters'), File('build-parameters/pytorch-build-params.yml'), File('build-parameters/binary-build-params.yml'), Header('Job specs'), File('job-specs/binary-job-specs.yml'), File('job-specs/job-specs-custom.yml'), File('job-specs/binary_update_htmls.yml'), File('job-specs/binary-build-tests.yml'), File('job-specs/docker_jobs.yml'), Header('Workflows'), Treegen(gen_build_workflows_tree, 0)]
