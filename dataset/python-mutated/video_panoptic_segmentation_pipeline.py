...
from modelscope.models.cv.video_panoptic_segmentation.video_k_net import VideoKNet
...
@PIPELINES.register_module(Tasks.video_panoptic_segmentation, module_name=Pipelines.video_panoptic_segmentation)
