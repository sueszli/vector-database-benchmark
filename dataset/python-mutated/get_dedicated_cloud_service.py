...
def main():
    ...
    response = client.dedicated_cloud_services.get(resource_group_name='myResourceGroup', dedicated_cloud_service_name='myService')
    print(response)
