...
from zerver.lib.sessions import delete_all_deactivated_user_sessions, delete_all_user_sessions, delete_realm_user_sessions
from zerver.models import UserProfile

class Command(ZulipBaseCommand):
    help = 'Log out all users from active browser sessions.\n\nDoes not disable API keys, and thus will not log users out of the\nmobile apps.\n'
