from redash.query_runner import TYPE_BOOLEAN, TYPE_DATE, TYPE_DATETIME, TYPE_FLOAT, TYPE_INTEGER, TYPE_STRING, BaseQueryRunner, register
...
try:
    ...
    enabled = False
TYPES_MAP = {'boolean': TYPE_BOOLEAN, 'datetime': TYPE_DATETIME, 'date': TYPE_DATE, 'dynamic': TYPE_STRING, 'guid': TYPE_STRING, 'int': TYPE_INTEGER, 'long': TYPE_INTEGER, 'real': TYPE_FLOAT, 'string': TYPE_STRING, 'timespan': TYPE_STRING, 'decimal': TYPE_FLOAT}
