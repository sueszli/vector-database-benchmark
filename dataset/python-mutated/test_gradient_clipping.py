...
class TestGradientClipping(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.norm = math.sqrt(sum([np.square(param.grad).sum() for param in self.target.params()]))
    ...
    def test_clipping(self, backend_config0, backend_config1, backend_config2):
        if False:
            print('Hello World!')
        self.check_clipping([backend_config0, backend_config1, backend_config2], 0.5)

    def test_clipping_2(self, backend_config0, backend_config1, backend_config2):
        if False:
            return 10
        self.check_clipping([backend_config0, backend_config1, backend_config2], 2.0)
