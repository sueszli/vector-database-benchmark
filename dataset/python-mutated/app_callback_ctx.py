...
app.layout = html.Div([html.Button(id={'type': 'run-button', 'index': 0}, children='Run 1'), html.Button(id={'type': 'run-button', 'index': 1}, children='Run 2'), html.Button(id={'type': 'run-button', 'index': 2}, children='Run 3'), html.Div(id='result', children='No results'), html.Div(id='running')])
