...
class _CSVDatasink(BlockBasedFileDatasink):
    ...
    def __init__(self, path: str, *, arrow_csv_args_fn: Callable[[], Dict[str, Any]]=lambda : {}, arrow_csv_args: Optional[Dict[str, Any]]=None, file_format='csv', **file_datasink_kwargs):
        if False:
            i = 10
            return i + 15
