...
class GenerateDetailedCostReportOperationResultsOperations:
    ...
    async def _get_initial(self, operation_id: str, scope: str, **kwargs: Any) -> Optional[_models.GenerateDetailedCostReportOperationResult]:
        ...
        request = build_get_request(operation_id=operation_id, scope=scope, api_version=api_version, template_url=self._get_initial.metadata['url'], headers=_headers, params=_params)
    ...
    async def begin_get(self, operation_id: str, scope: str, **kwargs: Any) -> AsyncLROPoller[_models.GenerateDetailedCostReportOperationResult]:
        ...
        if cont_token is None:
            raw_result = await self._get_initial(operation_id=operation_id, scope=scope, api_version=api_version, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
