...
import cython
cython.declare(Naming=object, Options=object, PyrexTypes=object, TypeSlots=object, error=object, warning=object, py_object_type=object, UtilityCode=object, EncodedString=object, re=object)
...
TOTAL_ORDERING = {('__lt__', '__gt__'): (True, '&&', True), ('__lt__', '__le__'): (False, '||', False), ('__lt__', '__ge__'): (True, '', None), ('__le__', '__ge__'): (True, '||', False), ('__le__', '__lt__'): (False, '&&', True), ('__le__', '__gt__'): (True, '', None), ('__gt__', '__lt__'): (True, '&&', True), ('__gt__', '__ge__'): (False, '||', False), ('__gt__', '__le__'): (True, '', None), ('__ge__', '__le__'): (True, '||', False), ('__ge__', '__gt__'): (False, '&&', True), ('__ge__', '__lt__'): (True, '', None)}
