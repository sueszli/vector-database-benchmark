...
@pluginmatcher(re.compile('https?://(?:[\\w-]+\\.)?delfi\\.(?P<tld>lt|lv|ee)'))
class Delfi(Plugin):
    _api = {'lt': 'https://g2.dcdn.lt/vfe/data.php', 'lv': 'https://g.delphi.lv/vfe/data.php', 'ee': 'https://g4.nh.ee/vfe/data.php'}
