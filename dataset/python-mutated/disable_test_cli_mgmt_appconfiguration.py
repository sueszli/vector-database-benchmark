...
class MgmtAppConfigurationTest(AzureMgmtTestCase):
    ...
    def setUp(self):
        ...
        self.mgmt_client = self.create_mgmt_client(AppConfigurationManagementClient)
        if self.is_live:
    ...
    def test_appconfiguration(self, resource_group):
        ...
        result = self.mgmt_client.private_endpoint_connections.begin_create_or_update(resource_group.name, CONFIGURATION_STORE_NAME, PRIVATE_ENDPOINT_CONNECTION_NAME, BODY)
