...
class ChatAdministratorRights(TelegramObject):
    ...
    Attributes:
        ...
        can_manage_topics (:obj:`bool`): Optional. :obj:`True`, if the user is allowed
            ...
            .. versionadded:: 20.0
    """
    __slots__ = ('is_anonymous', 'can_manage_chat', 'can_delete_messages', 'can_manage_video_chats', 'can_restrict_members', 'can_promote_members', 'can_change_info', 'can_invite_users', 'can_post_messages', 'can_edit_messages', 'can_pin_messages', 'can_manage_topics', 'can_post_stories', 'can_edit_stories', 'can_delete_stories')
