...
def build_list_request(scope: str, schedule_definition_id: str, *, filter: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    ...
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances')
...
def build_get_by_id_request(scope: str, schedule_definition_id: str, id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2021-12-01-preview'))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}')
...
class ScopeAccessReviewInstancesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, schedule_definition_id: str, filter: Optional[str]=None, **kwargs: Any) -> Iterable['_models.AccessReviewInstance']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(scope=scope, schedule_definition_id=schedule_definition_id, filter=filter, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    list.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances'}

    @distributed_trace
    def get_by_id(self, scope: str, schedule_definition_id: str, id: str, **kwargs: Any) -> _models.AccessReviewInstance:
        if False:
            i = 10
            return i + 15
        ...
        request = build_get_by_id_request(scope=scope, schedule_definition_id=schedule_definition_id, id=id, api_version=api_version, template_url=self.get_by_id.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        return deserialized
    get_by_id.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}'}

    @overload
    def create(self, scope: str, schedule_definition_id: str, id: str, properties: _models.AccessReviewInstanceProperties, *, content_type: str='application/json', **kwargs: Any) -> _models.AccessReviewInstance:
        if False:
            i = 10
            return i + 15
    ...
    @overload
    def create(self, scope: str, schedule_definition_id: str, id: str, properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AccessReviewInstance:
        if False:
            while True:
                i = 10
    ...
    @distributed_trace
    def create(self, scope: str, schedule_definition_id: str, id: str, properties: Union[_models.AccessReviewInstanceProperties, IO], **kwargs: Any) -> _models.AccessReviewInstance:
        if False:
            i = 10
            return i + 15
        ...
        request = build_create_request(scope=scope, schedule_definition_id=schedule_definition_id, id=id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    create.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/accessReviewScheduleDefinitions/{scheduleDefinitionId}/instances/{id}'}