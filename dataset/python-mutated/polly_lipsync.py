...
GITHUB_URL = 'https://raw.githubusercontent.com/awsdocs/aws-doc-sdk-examples/awsdocs/polly-examples/python/example_code/polly/'
...
class PollyMouth:
    ...
    along with it.
    """
    lips = {'p': {'name': '.media/lips_m.png'}, 't': {'name': '.media/lips_c.png'}, 'S': {'name': '.media/lips_ch.png'}, 'T': {'name': '.media/lips_th.png'}, 'f': {'name': '.media/lips_f.png'}, 'k': {'name': '.media/lips_c.png'}, 'i': {'name': '.media/lips_e.png'}, 'r': {'name': '.media/lips_r.png'}, 's': {'name': '.media/lips_c.png'}, 'u': {'name': '.media/lips_w.png'}, '@': {'name': '.media/lips_u.png'}, 'a': {'name': '.media/lips_a.png'}, 'e': {'name': '.media/lips_a.png'}, 'E': {'name': '.media/lips_u.png'}, 'o': {'name': '.media/lips_o.png'}, 'O': {'name': '.media/lips_u.png'}, 'sil': {'name': '.media/lips_sil.png'}}
