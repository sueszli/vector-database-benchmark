...
pyunit_utils.run_tests([test_tree_based_model_early_stopping_warnings(H2OGradientBoostingEstimator), test_tree_based_model_early_stopping_warnings(H2ORandomForestEstimator), test_tree_based_model_early_stopping_warnings(H2OXGBoostEstimator)])