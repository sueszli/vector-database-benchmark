...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_describe_db_cluster_parameters', 0), ('TESTERROR-stub_modify_db_cluster_parameter_group', 1), ('TESTERROR-stub_describe_db_cluster_parameters', 2)])
def test_set_user_parameters_error(mock_mgr, caplog, error, stop_on_index):
    if False:
        for i in range(10):
            print('nop')
