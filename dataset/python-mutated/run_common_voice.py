...
import transformers
from transformers import HfArgumentParser, Trainer, TrainingArguments, Wav2Vec2CTCTokenizer, Wav2Vec2FeatureExtractor, Wav2Vec2ForCTC, Wav2Vec2Processor, is_apex_available, set_seed
...
class DataTrainingArguments:
    ...
    train_split_name: Optional[str] = field(default='train+validation', metadata={'help': "The name of the training data set split to use (via the datasets library). Defaults to 'train'"})
    ...
    chars_to_ignore: List[str] = list_field(default=[',', '?', '.', '!', '-', ';', ':', '""', '%', "'", '"', '�'], metadata={'help': 'A list of characters to remove from the transcripts.'})
