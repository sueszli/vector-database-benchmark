...
class LaiFeng:
    ...
    async def get_ws_info(url):
        ...
        args = {'name': 'enter', 'args': [{'token': imk.replace('%3D', '='), 'yktk': '', 'uid': '2082628924', 'isPushHis': '1', 'roomid': rid, 'endpointtype': 'ct_,dt_1_1003|0|_{}|CTaXF+oKpB4CAatxtZHBQchJ'.format(time.time() * 1000.0)}]}
    ...
    def decode_msg(message):
        ...
        if type_ == '5':
            ...
            args = data['args']
            for arg in args:
                if name == 'enterMessage':
                    msg['name'] = 'SYS'
                    msg['content'] = arg['body']['n'] + ' 进入频道'
                    msg['msg_type'] = 'danmaku'
                elif name == 'globalHornMessage':
                    msg['name'] = 'SYS'
