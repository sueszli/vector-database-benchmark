...
from apps.storage.utils import get_bucket_key, get_worker_bucket_key
...
FILE_LIMITS = {PLAN_STARTER: {'files': 10, 'size': 10}, PLAN_PRO: {'files': 25, 'size': 50}, PLAN_BUSINESS: {'files': 50, 'size': 100}}
