...
@testing.parameterize(*testing.product_dict([{'c_dim': 2, 'num_c': 1, 'batch_size': 3}, {'c_dim': 0, 'num_c': 4, 'batch_size': 5}, {'c_dim': 12, 'num_c': 1, 'batch_size': 0}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
@testing.fix_random()
