...
urlpatterns = [re_path('^/enforced$', RateLimitEnforcedEndpoint.as_view(), name='enforced-endpoint'), re_path('^/unenforced$', RateLimitUnenforcedEndpoint.as_view(), name='unenforced-endpoint')]
