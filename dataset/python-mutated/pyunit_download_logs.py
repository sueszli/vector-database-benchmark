...
import zipfile
import shutil
log_level_suffixes = ['-1-trace.log', '-2-debug.log', '-3-info.log', '-4-warn.log', '-5-error.log', '-6-fatal.log', '-httpd.log']
log_level_suffixes_positions = {'TRACE': 0, 'DEBUG': 1, 'INFO': 2, 'WARN': 3, 'ERROR': 4, 'FATAL': 5, 'HTTPD': 6}
