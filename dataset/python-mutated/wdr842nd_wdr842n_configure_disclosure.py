...
class Exploit(HTTPClient):
    __info__ = {'name': 'TP-Link WDR842ND configure Disclosure', 'description': 'Module exploits TP-Link WDR842ND configure disclosure vulnerability which allows fetching configure.', 'authors': ('qingdaoxiaoge <qdpp007[at]outlook.com>', 'VegetableCat <yes-reply[at]linux.com>'), 'references': ('http://cb.drops.wiki/bugs/wooyun-2015-0110062.html',), 'devices': ('TP-Link WDR842ND',)}
