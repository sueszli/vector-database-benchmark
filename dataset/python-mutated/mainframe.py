...
class MainFrame(wx.Frame):
    ...
    SUCC_REPORT_MSG = _('Successfully downloaded {0} URL(s) in {1} day(s) {2} hour(s) {3} minute(s) {4} second(s)')
    ...
    OPEN_DIR_ERR = _("Unable to open directory: '{dir}'. The specified path does not exist")
    SHUTDOWN_ERR = _('Error while shutting down. Make sure you typed the correct password')
    ...
    STATUSLIST_COLUMNS = {'filename': (0, VIDEO_LABEL, 150, True), 'extension': (1, EXTENSION_LABEL, 60, False), 'filesize': (2, SIZE_LABEL, 80, False), 'percent': (3, PERCENT_LABEL, 65, False), 'eta': (4, ETA_LABEL, 45, False), 'speed': (5, SPEED_LABEL, 90, False), 'status': (6, STATUS_LABEL, 160, False)}
