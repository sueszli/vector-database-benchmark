...
class MixchIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://mixch.tv/u/16236849/live', 'skip': "don't know if this live persists", 'info_dict': {'id': '16236849', 'title': '24配信シェア⭕️投票🙏💦', 'comment_count': 13145, 'view_count': 28348, 'timestamp': 1636189377, 'uploader': '🦥伊咲👶🏻#フレアワ', 'uploader_id': '16236849'}}, {'url': 'https://mixch.tv/u/16137876/live', 'only_matching': True}]
...
class MixchArchiveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://mixch.tv/archive/421', 'skip': 'paid video, no DRM. expires at Jan 23', 'info_dict': {'id': '421', 'title': '96NEKO SHOW TIME'}}]
