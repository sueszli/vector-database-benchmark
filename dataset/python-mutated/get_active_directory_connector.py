...
def main():
    ...
    response = client.active_directory_connectors.get(resource_group_name='testrg', data_controller_name='testdataController', active_directory_connector_name='testADConnector')
    print(response)
