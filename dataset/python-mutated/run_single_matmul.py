...
_SPLIT_K = flags.DEFINE_integer('split_k', 1, 'Number of splits for contracting dimension')
_LHS_LAYOUT = flags.DEFINE_enum_class('lhs_layout', MatrixLayout.ROW_MAJOR, MatrixLayout, 'Layout to use for LHS')
_RHS_LAYOUT = flags.DEFINE_enum_class('rhs_layout', MatrixLayout.ROW_MAJOR, MatrixLayout, 'Layout to use for RHS')
_RESULT_LAYOUT = flags.DEFINE_enum_class('result_layout', MatrixLayout.ROW_MAJOR, MatrixLayout, 'Layout to use for the result')
_NUM_STAGES = flags.DEFINE_integer('num_stages', 1, 'Number of pipelining stages')
_NUM_WARPS = flags.DEFINE_integer('num_warps', 4, 'Number of warps to allocate in a given block')
