...
color_dict = {'light_default_icon': ('#000000', '#ffffff'), 'light_plus_icon': ('#474747', '#e0e0e0'), 'dark_icon': ('#c4c4c4', '#2d2d2d'), 'red_icon': ('#2d2d2d', '#ffe8e8'), 'monokai_icon': ('#d3b774', '#474747'), 'night_blue_icon': ('#ededed', '#6b9dc2')}
