...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Util to produce transitive dependencies for custom build')
    parser.add_argument('--op-dependency', help='input yaml file of op dependency graph - can be omitted for custom build with static dispatch')
    parser.add_argument('--root-ops', required=True, help='input yaml file of root (directly used) operators')
