...
class Small(IntEnum):
    ...
    three = 3
    four = 4
AssertionOperator = Enum('AssertionOperator', {'equal': '==', '==': '==', '<': '<', '>': '>', '<=': '<=', '>=': '>='})
...
@library(converters={CustomType: CustomType.parse, CustomType2: CustomType2, A: A.not_used_converter_should_not_be_documented}, auto_keywords=True)
