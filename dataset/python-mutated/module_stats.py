...
def _receptive_field_fallback(module, inputs, outputs):
    ...
    return (rf, stride)
_iter_list = [('flops_num', _calc_flops_dict, None), (('receptive_field', 'stride'), _calc_receptive_field_dict, _receptive_field_fallback)]
...
hook_modules = [M.conv._ConvNd, M.Linear, M.BatchMatMulActivation, M.batchnorm._BatchNorm, M.LayerNorm, M.GroupNorm, M.InstanceNorm, M.pooling._PoolNd, M.adaptive_pooling._AdaptivePoolNd]
