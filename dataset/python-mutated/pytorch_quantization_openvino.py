...
def finetune_pet_dataset(model_ft):
    ...
    model = Trainer.compile(model_ft, loss_ft, optimizer_ft, metrics=[MulticlassAccuracy(37)])
...
if __name__ == '__main__':
    ...
    q_model = InferenceOptimizer.quantize(model, accelerator='openvino', calib_dataloader=DataLoader(train_dataset, batch_size=32))
