...
from modelscope.models.cv.image_colorization import DynamicUnetDeep, DynamicUnetWide, NormType
...
@PIPELINES.register_module(Tasks.image_colorization, module_name=Pipelines.image_colorization)
