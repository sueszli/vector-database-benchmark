...
@parameterized.parameters({'use_depthwise': False, 'use_keras': True}, {'use_depthwise': True, 'use_keras': True}, {'use_depthwise': False, 'use_keras': False}, {'use_depthwise': True, 'use_keras': False})
class SsdMobilenetV2FpnFeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
