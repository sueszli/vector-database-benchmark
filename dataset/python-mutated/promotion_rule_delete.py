...
class PromotionRuleDelete(ModelDeleteMutation):
    ...
    class Arguments:
        id = graphene.ID(required=True, description='The ID of the promotion to remove.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.PROMOTION_RULE_DELETED, description='A promotion rule was deleted.')]
