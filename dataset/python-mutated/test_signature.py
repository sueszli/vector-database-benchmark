...
def kwonly_args(a, *, b, c=10):
    ...
    return b
renamed = old_name
functions = [foo, bariza, complex_function_name, FunCTIonWithCAPItals, _name_with_underscore_, __double_underscore__, old_name, renamed, kwonly_args]
ids = ['foo', 'bariza', 'complex_function_name', 'FunCTIonWithCAPItals', '_name_with_underscore_', '__double_underscore__', 'old_name', 'renamed', 'kwonly_args']
names = ['foo', 'bariza', 'complex_function_name', 'FunCTIonWithCAPItals', '_name_with_underscore_', '__double_underscore__', 'old_name', 'old_name', 'kwonly_args']
arguments = [[], ['a', 'b', 'c'], ['a', 'b', 'c'], ['a', 'b', 'c'], ['fo', 'bar'], ['man', 'o'], ['verylongvariablename'], ['verylongvariablename'], ['a', 'b', 'c']]
vararg_names = [None, None, None, None, 'baz', 'men', None, None, None]
kw_wc_names = [None, None, None, 'kwargs', None, 'oo', None, None, None]
pos_arguments = [[], ['a', 'b', 'c'], [], ['a', 'b'], ['fo', 'bar'], ['man', 'o'], ['verylongvariablename'], ['verylongvariablename'], ['a']]
