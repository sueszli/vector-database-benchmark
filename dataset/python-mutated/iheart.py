...
class IHeartRadioIE(IHeartRadioBaseIE):
    ...
    _TEST = {'url': 'https://www.iheart.com/podcast/105-behind-the-bastards-29236323/episode/part-one-alexander-lukashenko-the-dictator-70346499/?embed=true', 'md5': 'c8609c92c8688dcb69d8541042b8abca', 'info_dict': {'id': '70346499', 'ext': 'mp3', 'title': 'Part One: Alexander Lukashenko: The Dictator of Belarus', 'description': 'md5:96cc7297b3a5a9ebae28643801c96fae', 'timestamp': 1597741200, 'upload_date': '20200818'}}
...
class IHeartRadioPodcastIE(IHeartRadioBaseIE):
    ...
    _TESTS = [{'url': 'https://www.iheart.com/podcast/1119-it-could-happen-here-30717896/', 'info_dict': {'id': '30717896', 'title': 'It Could Happen Here', 'description': 'md5:5842117412a967eb0b01f8088eb663e2'}, 'playlist_mincount': 11}, {'url': 'https://www.iheartpodcastnetwork.com/podcast/105-stuff-you-should-know-26940277', 'only_matching': True}]
