...
class MultiplyBoolean(TransformPrimitive):
    ...
    input_types = [[ColumnSchema(logical_type=BooleanNullable), ColumnSchema(logical_type=BooleanNullable)], [ColumnSchema(logical_type=Boolean), ColumnSchema(logical_type=Boolean)], [ColumnSchema(logical_type=Boolean), ColumnSchema(logical_type=BooleanNullable)], [ColumnSchema(logical_type=BooleanNullable), ColumnSchema(logical_type=Boolean)]]
