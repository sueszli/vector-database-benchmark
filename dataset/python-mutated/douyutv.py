...
from ..utils import ExtractorError, UserNotLive, determine_ext, int_or_none, js_to_json, parse_resolution, str_or_none, traverse_obj, unescapeHTML, url_or_none, urlencode_postdata, urljoin
...
class DouyuTVIE(DouyuBaseIE):
    ...
    _TESTS = [{'url': 'https://www.douyu.com/pigff', 'info_dict': {'id': '24422', 'display_id': 'pigff', 'ext': 'mp4', 'title': 're:^【PIGFF】.* [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'description': '≥15级牌子看鱼吧置顶帖进粉丝vx群', 'thumbnail': str, 'uploader': 'pigff', 'is_live': True, 'live_status': 'is_live'}, 'params': {'skip_download': True}}, {'url': 'http://www.douyutv.com/85982', 'info_dict': {'id': '85982', 'display_id': '85982', 'ext': 'flv', 'title': 're:^小漠从零单排记！——CSOL2躲猫猫 [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'description': 'md5:746a2f7a253966a06755a912f0acc0d2', 'thumbnail': 're:^https?://.*\\.png', 'uploader': 'douyu小漠', 'is_live': True}, 'params': {'skip_download': True}, 'skip': 'Room not found'}, {'url': 'http://www.douyutv.com/17732', 'info_dict': {'id': '17732', 'display_id': '17732', 'ext': 'flv', 'title': 're:^清晨醒脑！根本停不下来！ [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'description': 're:.*m7show@163\\.com.*', 'thumbnail': 're:^https?://.*\\.png', 'uploader': '7师傅', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'https://www.douyu.com/topic/ydxc?rid=6560603', 'info_dict': {'id': '6560603', 'display_id': '6560603', 'ext': 'flv', 'title': 're:^阿余：新年快乐恭喜发财！ [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'description': 're:.*直播时间.*', 'thumbnail': 're:^https?://.*\\.png', 'uploader': '阿涛皎月Carry', 'live_status': 'is_live'}, 'params': {'skip_download': True}}, {'url': 'http://www.douyu.com/xiaocang', 'only_matching': True}, {'url': 'http://www.douyu.com/t/lpl', 'only_matching': True}]
...
class DouyuShowIE(DouyuBaseIE):
    ...
    _TESTS = [{'url': 'https://v.douyu.com/show/mPyq7oVNe5Yv1gLY', 'info_dict': {'id': 'mPyq7oVNe5Yv1gLY', 'ext': 'mp4', 'title': '四川人小时候的味道“蒜苗回锅肉”，传统菜不能丢，要常做来吃', 'duration': 633, 'thumbnail': str, 'uploader': '美食作家王刚V', 'uploader_id': 'OVAO4NVx1m7Q', 'timestamp': 1661850002, 'upload_date': '20220830', 'view_count': int, 'tags': ['美食', '美食综合']}}, {'url': 'https://vmobile.douyu.com/show/rjNBdvnVXNzvE2yw', 'only_matching': True}]
    _FORMATS = {'super': '原画', 'high': '超清', 'normal': '高清'}
    _QUALITIES = {'super': -1, 'high': -2, 'normal': -3}
    _RESOLUTIONS = {'super': '1920x1080', 'high': '1280x720', 'normal': '852x480'}
