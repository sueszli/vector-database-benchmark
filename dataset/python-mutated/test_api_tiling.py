...
compressions_paremetrized = pytest.mark.parametrize('compression', [{'sample_compression': None}, {'sample_compression': 'png'}, {'chunk_compression': 'png'}, {'sample_compression': 'lz4'}, {'chunk_compression': 'lz4'}])
