...
class BotCommandScopeChatMember(BotCommandScope):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, type: Literal[BotCommandScopeType.CHAT_MEMBER]=BotCommandScopeType.CHAT_MEMBER, chat_id: Union[int, str], user_id: int, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
