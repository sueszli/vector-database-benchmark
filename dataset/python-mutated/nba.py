...
from ..utils import int_or_none, merge_dicts, OnDemandPagedList, parse_duration, parse_iso8601, parse_qs, try_get, update_url_query, urljoin
...
class NBAWatchBaseIE(NBACVPBaseIE):
    _VALID_URL_BASE = 'https?://(?:(?:www\\.)?nba\\.com(?:/watch)?|watch\\.nba\\.com)/'
...
class NBAWatchEmbedIE(NBAWatchBaseIE):
    ...
    _VALID_URL = NBAWatchBaseIE._VALID_URL_BASE + 'embed\\?.*?\\bid=(?P<id>\\d+)'
    _TESTS = [{'url': 'http://watch.nba.com/embed?id=659395', 'md5': 'b7e3f9946595f4ca0a13903ce5edd120', 'info_dict': {'id': '659395', 'ext': 'mp4', 'title': 'Mix clip: More than 7 points of  Joe Ingles, Luc Mbah a Moute, Blake Griffin and 6 more in Utah Jazz vs. the Clippers, 4/15/2017', 'description': 'Mix clip: More than 7 points of  Joe Ingles, Luc Mbah a Moute, Blake Griffin and 6 more in Utah Jazz vs. the Clippers, 4/15/2017', 'timestamp': 1492228800, 'upload_date': '20170415'}}]
...
class NBAWatchIE(NBAWatchBaseIE):
    IE_NAME = 'nba:watch'
    _VALID_URL = NBAWatchBaseIE._VALID_URL_BASE + '(?:nba/)?video/(?P<id>.+?(?=/index\\.html)|(?:[^/]+/)*[^/?#&]+)'
    _TESTS = [{'url': 'http://www.nba.com/video/games/nets/2012/12/04/0021200253-okc-bkn-recap.nba/index.html', 'md5': '9d902940d2a127af3f7f9d2f3dc79c96', 'info_dict': {'id': '70946', 'ext': 'mp4', 'title': 'Thunder vs. Nets', 'description': 'Kevin Durant scores 32 points and dishes out six assists as the Thunder beat the Nets in Brooklyn.', 'duration': 181, 'timestamp': 1354597200, 'upload_date': '20121204'}}, {'url': 'http://www.nba.com/video/games/hornets/2014/12/05/0021400276-nyk-cha-play5.nba/', 'only_matching': True}, {'url': 'http://watch.nba.com/video/channels/playoffs/2015/05/20/0041400301-cle-atl-recap.nba', 'md5': 'b2b39b81cf28615ae0c3360a3f9668c4', 'info_dict': {'id': '330865', 'ext': 'mp4', 'title': 'Hawks vs. Cavaliers Game 1', 'description': 'md5:8094c3498d35a9bd6b1a8c396a071b4d', 'duration': 228, 'timestamp': 1432094400, 'upload_date': '20150521'}}, {'url': 'http://watch.nba.com/nba/video/channels/nba_tv/2015/06/11/YT_go_big_go_home_Game4_061115', 'only_matching': True}, {'url': 'https://watch.nba.com/video/teams/cavaliers/2012/10/15/sloan121015mov-2249106', 'only_matching': True}, {'url': 'https://watch.nba.com/video/top-100-dunks-from-the-2019-20-season?plsrc=nba&collection=2019-20-season-highlights', 'only_matching': True}]
...
class NBAWatchCollectionIE(NBAWatchBaseIE):
    ...
    _VALID_URL = NBAWatchBaseIE._VALID_URL_BASE + 'list/collection/(?P<id>[^/?#&]+)'
    _TESTS = [{'url': 'https://watch.nba.com/list/collection/season-preview-2020', 'info_dict': {'id': 'season-preview-2020'}, 'playlist_mincount': 43}]
    _PAGE_SIZE = 100
...
class NBAIE(NBABaseIE):
    ...
    _TESTS = [{'url': 'https://www.nba.com/bulls/video/teams/bulls/2020/12/04/3478774/1607105587854-20201204schedulereleasefinaldrupal-3478774', 'info_dict': {'id': '45039', 'ext': 'mp4', 'title': 'AND WE BACK.', 'description': 'Part 1 of our 2020-21 schedule is here! Watch our games on NBC Sports Chicago.', 'duration': 94, 'timestamp': 1607112000, 'upload_date': '20201218'}}, {'url': 'https://www.nba.com/bucks/play#/video/teams%2Fbucks%2F2020%2F12%2F17%2F64860%2F1608252863446-Op_Dream_16x9-64860', 'only_matching': True}, {'url': 'https://www.nba.com/bucks/play#/video/wsc%2Fteams%2F2787C911AA1ACD154B5377F7577CCC7134B2A4B0', 'only_matching': True}]
    _CONTENT_ID_REGEX = 'videoID'
...
class NBAChannelIE(NBABaseIE):
    ...
    _TESTS = [{'url': 'https://www.nba.com/blazers/video/channel/summer_league', 'info_dict': {'title': 'Summer League'}, 'playlist_mincount': 138}, {'url': 'https://www.nba.com/bucks/play#/series/On%20This%20Date', 'only_matching': True}]
