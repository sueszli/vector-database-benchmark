...
_LAYER_REGISTERY = {'convolution': _convolution, 'pooling': _pooling, 'activation': _identity, 'innerProduct': _inner_product, 'embedding': _embedding, 'batchnorm': _identity, 'mvn': _identity, 'l2normalize': _identity, 'softmax': _identity, 'lrn': _identity, 'crop': _crop, 'padding': _padding, 'upsample': _upsample, 'unary': _identity, 'add': _add, 'multiply': _add, 'average': _add, 'scale': _add, 'bias': _add, 'max': _add, 'min': _add, 'dot': _dot, 'reduce': _reduce, 'loadConstant': _load_constant, 'reshape': _reshape, 'flatten': _flatten, 'permute': _permute, 'concat': _concat, 'split': _split, 'sequenceRepeat': _sequence_repeat, 'reorganizeData': _reorganize_data, 'slice': _slice, 'simpleRecurrent': _simple_recurrent, 'gru': _gru, 'uniDirectionalLSTM': _uni_directional_lstm, 'biDirectionalLSTM': _bi_directional_lstm}
