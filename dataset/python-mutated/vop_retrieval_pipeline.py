...
from modelscope.models.cv.vop_retrieval import LengthAdaptiveTokenizer, VoP, init_transform_dict, load_data, load_frames_from_video
...
@PIPELINES.register_module(Tasks.vop_retrieval, module_name=Pipelines.vop_retrieval)
