...
class SetMyShortDescription(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, short_description: Optional[str]=None, language_code: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                print('Hello World!')
            super().__init__(short_description=short_description, language_code=language_code, **__pydantic_kwargs)