    ...
    def __repr__(self):
        if False:
            while True:
                i = 10
        return self.name
result_dist_pairs = [('default channel', DummyDistribution('A', source='pyodide')), ('default channel', DummyDistribution('B', source='pyodide', direct_url={'url': 'http://some.pkg.src/a/b/c.whl'}, installer='pip')), ('http://some.pkg.src/a/b/c.whl', DummyDistribution('C', source='http://some.pkg.src/a/b/c.whl')), ('http://some.pkg.src/a/b/c.whl', DummyDistribution('D', source='http://some.pkg.src/a/b/c.whl', direct_url={'url': 'http://a.b.c/x/y/z.whl'}, installer='pip')), ('http://a.b.c/x/y/z.whl', DummyDistribution('E', direct_url={'url': 'http://a.b.c/x/y/z.whl'}, installer='pip')), ('pip (index unknown)', DummyDistribution('F', installer='pip')), ('other (index unknown)', DummyDistribution('G', installer='other')), ('Unknown', DummyDistribution('H-H'))]
