...
class YibaishiwuCom(SimpleDownloader):
    ...
    __version__ = '0.19'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?(?:u\\.)?115\\.com/file/(?P<ID>\\w+)'
    ...
    NAME_PATTERN = "file_name: \\'(?P<N>.+?)\\'"
    SIZE_PATTERN = "file_size: \\'(?P<S>.+?)\\'"
    OFFLINE_PATTERN = '<h3><i style="color:red;">哎呀！提取码不存在！不妨搜搜看吧！</i></h3>'
    LINK_FREE_PATTERN = '(/\\?ct=(pickcode|download)[^"\\\']+)'
