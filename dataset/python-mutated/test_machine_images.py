...
from google.cloud.compute_v1.services.machine_images import MachineImagesClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(MachineImagesClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.MachineImagesRestTransport, 'rest')])
...
def test_machine_images_client_get_transport_class():
    ...
    available_transports = [transports.MachineImagesRestTransport]
    assert transport in available_transports
    transport = MachineImagesClient.get_transport_class('rest')
    assert transport == transports.MachineImagesRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(MachineImagesClient, transports.MachineImagesRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(MachineImagesClient, transports.MachineImagesRestTransport, 'rest', 'true'), (MachineImagesClient, transports.MachineImagesRestTransport, 'rest', 'false')])
@mock.patch.object(MachineImagesClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(MachineImagesClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(MachineImagesClient, transports.MachineImagesRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.DeleteMachineImageRequest, dict])
def test_delete_rest(request_type):
    if False:
        while True:
            i = 10
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_delete_rest_interceptors(null_interceptor):
    if False:
        print('Hello World!')
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_delete') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.DeleteMachineImageRequest.pb(compute.DeleteMachineImageRequest())
...
def test_delete_rest_bad_request(transport: str='rest', request_type=compute.DeleteMachineImageRequest):
    if False:
        for i in range(10):
            print('nop')
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'machine_image': 'sample2'}
    request = request_type(**request_init)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', machine_image='machine_image_value')
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteMachineImageRequest(), project='project_value', machine_image='machine_image_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteMachineImageRequest(), project='project_value', machine_image='machine_image_value')
...
@pytest.mark.parametrize('request_type', [compute.GetMachineImageRequest, dict])
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_get') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetMachineImageRequest(), project='project_value', machine_image='machine_image_value')
...
@pytest.mark.parametrize('request_type', [compute.GetIamPolicyMachineImageRequest, dict])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_get_iam_policy') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_get_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.GetIamPolicyMachineImageRequest.pb(compute.GetIamPolicyMachineImageRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
...
def test_get_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get_iam_policy(compute.GetIamPolicyMachineImageRequest(), project='project_value', resource='resource_value')
...
@pytest.mark.parametrize('request_type', [compute.InsertMachineImageRequest, dict])
def test_insert_rest(request_type):
    ...
    for (field, value) in request_init['machine_image_resource'].items():
        result = None
        is_repeated = False
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_insert') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.InsertMachineImageRequest.pb(compute.InsertMachineImageRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
...
def test_insert_rest_bad_request(transport: str='rest', request_type=compute.InsertMachineImageRequest):
    if False:
        i = 10
        return i + 15
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', machine_image_resource=compute.MachineImage(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertMachineImageRequest(), project='project_value', machine_image_resource=compute.MachineImage(creation_timestamp='creation_timestamp_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertMachineImageRequest(), project='project_value', machine_image_resource=compute.MachineImage(creation_timestamp='creation_timestamp_value'))
...
@pytest.mark.parametrize('request_type', [compute.ListMachineImagesRequest, dict])
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.MachineImageList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_list') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.ListMachineImagesRequest.pb(compute.ListMachineImagesRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListMachineImagesRequest(), project='project_value')
...
@pytest.mark.parametrize('request_type', [compute.SetIamPolicyMachineImageRequest, dict])
def test_set_iam_policy_rest(request_type):
    ...
    test_field = compute.SetIamPolicyMachineImageRequest.meta.fields['global_set_policy_request_resource']
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_set_iam_policy') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_set_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.SetIamPolicyMachineImageRequest.pb(compute.SetIamPolicyMachineImageRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
...
def test_set_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_iam_policy(compute.SetIamPolicyMachineImageRequest(), project='project_value', resource='resource_value', global_set_policy_request_resource=compute.GlobalSetPolicyRequest(bindings=[compute.Binding(binding_id='binding_id_value')]))
...
@pytest.mark.parametrize('request_type', [compute.TestIamPermissionsMachineImageRequest, dict])
def test_test_iam_permissions_rest(request_type):
    ...
    test_field = compute.TestIamPermissionsMachineImageRequest.meta.fields['test_permissions_request_resource']
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.MachineImagesRestInterceptor())
    client = MachineImagesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.MachineImagesRestInterceptor, 'post_test_iam_permissions') as post, mock.patch.object(transports.MachineImagesRestInterceptor, 'pre_test_iam_permissions') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.TestIamPermissionsMachineImageRequest.pb(compute.TestIamPermissionsMachineImageRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
...
def test_test_iam_permissions_rest_flattened_error(transport: str='rest'):
    ...
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.test_iam_permissions(compute.TestIamPermissionsMachineImageRequest(), project='project_value', resource='resource_value', test_permissions_request_resource=compute.TestPermissionsRequest(permissions=['permissions_value']))
...
def test_credentials_transport_error():
    ...
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MachineImagesClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = MachineImagesClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = MachineImagesClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.MachineImagesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MachineImagesClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.MachineImagesRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = MachineImagesClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_machine_images_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.MachineImagesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_machine_images_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.machine_images.transports.MachineImagesTransport.__init__') as Transport:
        ...
        transport = transports.MachineImagesTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('delete', 'get', 'get_iam_policy', 'insert', 'list', 'set_iam_policy', 'test_iam_permissions')
...
def test_machine_images_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.machine_images.transports.MachineImagesTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.MachineImagesTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_machine_images_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.MachineImagesRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_machine_images_host_no_port(transport_name):
    if False:
        return 10
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_machine_images_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_machine_images_client_transport_session_collision(transport_name):
    ...
    client1 = MachineImagesClient(credentials=creds1, transport=transport_name)
    client2 = MachineImagesClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MachineImagesTransport, '_prep_wrapped_messages') as prep:
        client = MachineImagesClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(MachineImagesClient, transports.MachineImagesRestTransport)])
