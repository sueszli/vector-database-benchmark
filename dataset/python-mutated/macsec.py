...
class MACsec(Packet):
    ...
    fields_desc = [BitField('Ver', 0, 1), BitField('ES', 0, 1), BitField('SC', 0, 1), BitField('SCB', 0, 1), BitField('E', 0, 1), BitField('C', 0, 1), BitField('AN', 0, 2), BitField('reserved', 0, 2), BitField('SL', 0, 6), IntField('PN', 1), ConditionalField(PacketField('SCI', None, MACsecSCI), lambda pkt: pkt.SC), ConditionalField(XShortEnumField('type', None, ETHER_TYPES), lambda pkt: 'type' in pkt.fields)]
