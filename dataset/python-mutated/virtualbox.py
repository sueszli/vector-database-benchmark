...
from golem.docker.config import CONSTRAINT_KEYS, DOCKER_VM_NAME, GetConfigFunction
...
class VirtualBoxHypervisor(DockerMachineHypervisor):
    ...
    power_down_states = ['Saved', 'Aborted']
    running_states = ['Running', 'FirstOnline', 'LastOnline']
