...
__protobuf__ = proto.module(package='google.cloud.speech.v1', manifest={'CreatePhraseSetRequest', 'UpdatePhraseSetRequest', 'GetPhraseSetRequest', 'ListPhraseSetRequest', 'ListPhraseSetResponse', 'DeletePhraseSetRequest', 'CreateCustomClassRequest', 'UpdateCustomClassRequest', 'GetCustomClassRequest', 'ListCustomClassesRequest', 'ListCustomClassesResponse', 'DeleteCustomClassRequest'})
...
class CreatePhraseSetRequest(proto.Message):
    ...
    phrase_set_id: str = proto.Field(proto.STRING, number=2)
    phrase_set: resource.PhraseSet = proto.Field(proto.MESSAGE, number=3, message=resource.PhraseSet)
...
class UpdatePhraseSetRequest(proto.Message):
    ...
    """
    phrase_set: resource.PhraseSet = proto.Field(proto.MESSAGE, number=1, message=resource.PhraseSet)
...
class ListPhraseSetResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    phrase_sets: MutableSequence[resource.PhraseSet] = proto.RepeatedField(proto.MESSAGE, number=1, message=resource.PhraseSet)
...
class CreateCustomClassRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    custom_class_id: str = proto.Field(proto.STRING, number=2)
    custom_class: resource.CustomClass = proto.Field(proto.MESSAGE, number=3, message=resource.CustomClass)
...
class UpdateCustomClassRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            The list of fields to be updated.
    """
    custom_class: resource.CustomClass = proto.Field(proto.MESSAGE, number=1, message=resource.CustomClass)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class ListCustomClassesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    custom_classes: MutableSequence[resource.CustomClass] = proto.RepeatedField(proto.MESSAGE, number=1, message=resource.CustomClass)
    next_page_token: str = proto.Field(proto.STRING, number=2)
