...
class HiddenTriggerBackdoor(PoisoningAttackWhiteBox):
    ...
    | Paper link: https://arxiv.org/abs/1910.00033
    """
    attack_params = PoisoningAttackWhiteBox.attack_params + ['target', 'backdoor', 'feature_layer', 'source', 'eps', 'learning_rate', 'decay_coeff', 'decay_iter', 'stopping_tol', 'max_iter', 'poison_percent', 'batch_size', 'verbose', 'print_iter']
