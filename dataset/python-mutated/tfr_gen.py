...
_ATTRIBUTE_TYPES = (TFRTypes.I1, TFRTypes.I32, TFRTypes.I64, TFRTypes.F32, TFRTypes.INDEX, TFRTypes.ATTR)
_ATTRIBUTE_RENAMES = {'Mean': {'axis': 'reduction_indices'}, 'Split': {'axis': 'split_dim'}, 'SplitV': {'axis': 'split_dim'}}
...
_PY_TYPE_TO_TFR = {bool: TFRTypes.I1, int: TFRTypes.I64, float: TFRTypes.F32}
_TF_DTYPE_TO_TFR = {'bool': TFRTypes.I1, 'int64': TFRTypes.I64, 'int32': TFRTypes.I32, 'int16': TFRTypes.I16, 'int8': TFRTypes.I8, 'float32': TFRTypes.F32}
_AG_FIXED_RETURN_TYPE = {'for_stmt': type(None), 'if_stmt': type(None), 'Undefined': TFRTypes.AG_UNDEFINED_VAL}
QN = qual_names.QN
AG_MODULE = api._TRANSPILER.get_extra_locals()['ag__']
TFR_BUILTINS = {'_tfr_quant_act_range': (TFRTypes.TENSOR, TFRTypes.TENSOR), '_tfr_quant_rescale': TFRTypes.TENSOR, '_tfr_quant_raw_data': lambda input_type: input_type, '_tfr_quant_qparam': (TFRTypes.TENSOR, TFRTypes.TENSOR), '_tfr_quant_scale_factor': TFRTypes.TENSOR}
