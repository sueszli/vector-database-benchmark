...
class JustPremium(BaseAddon):
    ...
    __version__ = '0.27'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('excluded', 'str', 'Exclude hosters (comma separated)', ''), ('included', 'str', 'Include hosters (comma separated)', '')]
    __description__ = 'Remove not-premium links from added urls'
    __license__ = 'GPLv3'
    __authors__ = [('mazleu', 'mazleica@gmail.com'), ('Walter Purcaro', 'vuolter@gmail.com'), ('immenz', 'immenz@gmx.net')]
