...
if is_torch_available():
    import torch
    from transformers import LukeForEntityClassification, LukeForEntityPairClassification, LukeForEntitySpanClassification, LukeForMaskedLM, LukeForMultipleChoice, LukeForQuestionAnswering, LukeForSequenceClassification, LukeForTokenClassification, LukeModel, LukeTokenizer
...
class LukeModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (LukeModel, LukeForMaskedLM, LukeForEntityClassification, LukeForEntityPairClassification, LukeForEntitySpanClassification, LukeForQuestionAnswering, LukeForSequenceClassification, LukeForTokenClassification, LukeForMultipleChoice) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': LukeModel, 'fill-mask': LukeForMaskedLM, 'question-answering': LukeForQuestionAnswering, 'text-classification': LukeForSequenceClassification, 'token-classification': LukeForTokenClassification, 'zero-shot': LukeForSequenceClassification} if is_torch_available() else {}
    test_pruning = False
