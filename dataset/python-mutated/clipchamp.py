...
class ClipchampIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://clipchamp.com/watch/gRXZ4ZhdDaU', 'info_dict': {'id': 'gRXZ4ZhdDaU', 'ext': 'mp4', 'title': 'Untitled video', 'uploader': 'Alexander Schwartz', 'timestamp': 1680805580, 'upload_date': '20230406', 'thumbnail': 're:^https?://.+\\.jpg'}, 'params': {'skip_download': 'm3u8'}}]
