...
def save_train_test_docs(processed_location: ProcessedLocation, t_train: str, t_test: str) -> None:
    if False:
        return 10
...
if __name__ == '__main__':
    raw_location = RawLocation(url='https://drive.google.com/uc?id=1jI1cmxqnwsmC-vbl8dNY6b4aNBtBbKy3', zip_path='Twitter.zip', path_train='Data/train/en', path_test='Data/test/en')
    processed_location = ProcessedLocation(path_train='Data/train/en.txt', path_test='Data/test/en.txt')
