...
auditor_configs = [{'type': 'MockAuditor1', 'index': 'index1', 'applies': True}, {'type': 'MockAuditor2', 'index': 'index2', 'applies': False}]
for config in auditor_configs:
    auditor = type(config['type'], (MockAuditor,), {'applies': config['applies']})
