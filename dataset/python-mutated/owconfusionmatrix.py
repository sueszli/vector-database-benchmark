...
import unicodedata
from AnyQt.QtWidgets import QTableView, QHeaderView, QStyledItemDelegate, QSizePolicy
...
class OWConfusionMatrix(widget.OWWidget):
    ...
    description = 'Display a confusion matrix constructed from the results of classifier evaluations.'
    ...
    quantities = ['Number of instances', 'Proportion of predicted', 'Proportion of actual', 'Sum of probabilities']
    qu_tooltips = ['Number of correctly and incorrectly classified instances', 'Proportion of predicted', 'Proportion of actual', 'Number of instances, distributed across columns according to predicted probabilities']
    settings_version = 1
    ...
    UserAdviceMessages = [widget.Message('Clicking on cells or in headers outputs the corresponding data instances', 'click_cell')]
