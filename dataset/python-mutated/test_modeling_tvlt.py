...
from transformers import TvltConfig, is_datasets_available, is_speech_available, is_torch_available, is_vision_available
...
class TvltModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TvltModel, TvltForPreTraining, TvltForAudioVisualClassification) if is_torch_available() else ()
