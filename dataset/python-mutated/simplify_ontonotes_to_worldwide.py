...
WORLDWIDE_ENTITY_MAPPING = {'CARDINAL': None, 'ORDINAL': None, 'PERCENT': None, 'QUANTITY': None, 'TIME': None, 'DATE': 'Date', 'EVENT': 'Misc', 'FAC': 'Facility', 'GPE': 'Location', 'LANGUAGE': 'NORP', 'LAW': 'Misc', 'LOC': 'Location', 'MONEY': 'Money', 'NORP': 'NORP', 'ORG': 'Organization', 'PERSON': 'Person', 'PRODUCT': 'Product', 'WORK_OF_ART': 'Misc', 'Date': 'Date', 'Facility': 'Facility', 'Location': 'Location', 'Misc': 'Misc', 'Money': 'Money', 'Organization': 'Organization', 'Person': 'Person', 'Product': 'Product'}
