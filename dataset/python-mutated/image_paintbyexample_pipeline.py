...
from modelscope.models.cv.image_paintbyexample import StablediffusionPaintbyexample
...
@PIPELINES.register_module(Tasks.image_paintbyexample, module_name=Pipelines.image_paintbyexample)
