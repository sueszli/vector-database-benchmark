...
def build_create_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.AzureStack/generateDeploymentLicense')
...
class DeploymentLicenseOperations:
    ...
    @overload
    def create(self, deployment_license_request: _models.DeploymentLicenseRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.DeploymentLicenseResponse:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    def create(self, deployment_license_request: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.DeploymentLicenseResponse:
        if False:
            i = 10
            return i + 15
    ...
    @distributed_trace
    def create(self, deployment_license_request: Union[_models.DeploymentLicenseRequest, IO], **kwargs: Any) -> _models.DeploymentLicenseResponse:
        if False:
            while True:
                i = 10
        ...
        request = build_create_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
