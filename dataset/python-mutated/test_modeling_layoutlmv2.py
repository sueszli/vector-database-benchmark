...
if is_torch_available():
    import torch
    from transformers import LayoutLMv2Config, LayoutLMv2ForQuestionAnswering, LayoutLMv2ForSequenceClassification, LayoutLMv2ForTokenClassification, LayoutLMv2Model
...
class LayoutLMv2ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (LayoutLMv2Model, LayoutLMv2ForSequenceClassification, LayoutLMv2ForTokenClassification, LayoutLMv2ForQuestionAnswering) if is_torch_available() else ()
    pipeline_model_mapping = {'document-question-answering': LayoutLMv2ForQuestionAnswering, 'feature-extraction': LayoutLMv2Model} if is_torch_available() else {}
