...
class merchant_inventoriesCallTransformer(cst.CSTTransformer):
    CTRL_PARAMS: Tuple[str] = ('retry', 'timeout', 'metadata')
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'delete_local_inventory': ('name',), 'delete_regional_inventory': ('name',), 'insert_local_inventory': ('parent', 'local_inventory'), 'insert_regional_inventory': ('parent', 'regional_inventory'), 'list_local_inventories': ('parent', 'page_size', 'page_token'), 'list_regional_inventories': ('parent', 'page_size', 'page_token')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=merchant_inventoriesCallTransformer()):
    if False:
        print('Hello World!')
