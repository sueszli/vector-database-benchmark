...
qmethods_configs_short = op_bench.config_list(attr_names=['M', 'N'], attrs=[[32, 32]], cross_product_configs={'dtype': [torch.quint8], 'contig': [False, True]}, tags=['short'])
qmethods_configs_long = op_bench.cross_product_configs(M=[256, 1024], N=[256, 1024], dtype=[torch.qint8, torch.qint32], contig=[False, True], tags=['long'])
...
op_bench.generate_pt_test(qmethods_configs_short + qmethods_configs_long, QMethodTensorInputCopyBenchmark)
