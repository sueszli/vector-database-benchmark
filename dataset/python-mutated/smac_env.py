...
SUPPORT_MAPS = ['SMAC_Maps_two_player/3s5z.SC2Map', 'SMAC_Maps_two_player/3m.SC2Map', 'GBU_Maps/infestor_viper.sc2map']
...
class SMACEnv(SC2Env, BaseEnv):
    ...
    config = dict(two_player=False, mirror_opponent=False, reward_type='original', save_replay_episodes=None, difficulty=7, reward_death_value=10, reward_win=200, obs_alone=False, game_steps_per_episode=None, reward_only_positive=True, death_mask=False, special_global_state=False, add_center_xy=True, independent_obs=False, state_agent_id=True)
