...
ALLOWED_AGGREGATE_COLUMNS = {'transaction.duration', 'measurements.lcp', 'measurements.cls', 'measurements.fcp', 'measurements.fid', 'measurements.inp', 'spans.browser', 'spans.http', 'spans.db', 'spans.resource'}
...
@region_silo_endpoint
class OrganizationEventsFacetsPerformanceHistogramEndpoint(OrganizationEventsFacetsPerformanceEndpointBase):
    publish_status = {'GET': ApiPublishStatus.UNKNOWN}
