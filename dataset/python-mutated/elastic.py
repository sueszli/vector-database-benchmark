...
class ElasticDBActive(ElasticDB, DBActive):
    nested_fields = ['ports', 'ports.scripts', 'ports.scripts.http-app', 'ports.scripts.http-headers', 'ports.scripts.ssl-cert', 'ports.scripts.ssl-ja3-client', 'ports.scripts.ssl-ja3-server', 'tags']
    mappings = [_create_mappings(nested_fields, [('nested', nested_fields), ('ip', DBActive.ipaddr_fields), ('date', DBActive.datetime_fields), ('geo_point', ['infos.coordinates'])])]
    index_hosts = 0
