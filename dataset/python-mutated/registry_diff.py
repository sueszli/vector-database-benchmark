...
FeastObjectProto = TypeVar('FeastObjectProto', DataSourceProto, EntityProto, FeatureViewProto, FeatureServiceProto, OnDemandFeatureViewProto, RequestFeatureViewProto, StreamFeatureViewProto, ValidationReferenceProto)
