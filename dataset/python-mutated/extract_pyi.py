...
TYPE_MODULE_IMPORTS_IGNORE = frozenset({'array', 'bool', 'buffer', 'bytearray', 'bytes', 'dict', 'file', 'float', 'int', 'list', 'range', 'set', 'slice', 'str', 'struct_time', 'tuple'})
AVAILABLE_TYPE_MODULE_IMPORTS = {'types': frozenset(types.__all__), 'typing': frozenset(typing.__all__) - set(['Counter', 'Match']), 'circuitpython_typing': frozenset(circuitpython_typing.__all__), 'circuitpython_typing.socket': frozenset(circuitpython_typing.socket.__all__)}
