...
class ListServicesRequest(proto.Message):
    ...
    Attributes:
        ...
        consumer_id (str):
            ...
            -  project:<project_id>
    """
    producer_project_id: str = proto.Field(proto.STRING, number=1)
    page_size: int = proto.Field(proto.INT32, number=5)
    page_token: str = proto.Field(proto.STRING, number=6)
    consumer_id: str = proto.Field(proto.STRING, number=7)
...
class ListServicesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    services: MutableSequence[resources.ManagedService] = proto.RepeatedField(proto.MESSAGE, number=1, message=resources.ManagedService)
...
class CreateServiceRequest(proto.Message):
    ...
    Attributes:
        service (google.cloud.servicemanagement_v1.types.ManagedService):
            ...
            resource.
    """
    service: resources.ManagedService = proto.Field(proto.MESSAGE, number=1, message=resources.ManagedService)
...
class GetServiceConfigRequest(proto.Message):
    ...
    view: ConfigView = proto.Field(proto.ENUM, number=3, enum=ConfigView)
...
class ListServiceConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    service_configs: MutableSequence[service_pb2.Service] = proto.RepeatedField(proto.MESSAGE, number=1, message=service_pb2.Service)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateServiceConfigRequest(proto.Message):
    ...
    """
    service_name: str = proto.Field(proto.STRING, number=1)
    service_config: service_pb2.Service = proto.Field(proto.MESSAGE, number=2, message=service_pb2.Service)
...
class SubmitConfigSourceRequest(proto.Message):
    ...
    """
    service_name: str = proto.Field(proto.STRING, number=1)
    config_source: resources.ConfigSource = proto.Field(proto.MESSAGE, number=2, message=resources.ConfigSource)
...
class SubmitConfigSourceResponse(proto.Message):
    ...
    """
    service_config: service_pb2.Service = proto.Field(proto.MESSAGE, number=1, message=service_pb2.Service)
...
class CreateServiceRolloutRequest(proto.Message):
    ...
    """
    service_name: str = proto.Field(proto.STRING, number=1)
    rollout: resources.Rollout = proto.Field(proto.MESSAGE, number=2, message=resources.Rollout)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    rollouts: MutableSequence[resources.Rollout] = proto.RepeatedField(proto.MESSAGE, number=1, message=resources.Rollout)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class GenerateConfigReportRequest(proto.Message):
    ...
    Attributes:
        ...
        old_config (google.protobuf.any_pb2.Any):
            ...
            and [google.api.Service][google.api.Service]
    """
    new_config: any_pb2.Any = proto.Field(proto.MESSAGE, number=1, message=any_pb2.Any)
    old_config: any_pb2.Any = proto.Field(proto.MESSAGE, number=2, message=any_pb2.Any)
...
class GenerateConfigReportResponse(proto.Message):
    ...
    change_reports: MutableSequence[resources.ChangeReport] = proto.RepeatedField(proto.MESSAGE, number=3, message=resources.ChangeReport)
    diagnostics: MutableSequence[resources.Diagnostic] = proto.RepeatedField(proto.MESSAGE, number=4, message=resources.Diagnostic)
