...
option_github_token = click.option('--github-token', type=str, help=textwrap.dedent('\n        Github token used to authenticate.\n        You can omit it if you have the ``GITHUB_TOKEN`` env variable set\n        Can be generated with:\n        https://github.com/settings/tokens/new?description=Write%20issues&scopes=repo'), envvar='GITHUB_TOKEN')
...
option_labels = click.option('--labels', type=str, default='AIP-47', help='Label to filter the issues on (coma-separated)')
