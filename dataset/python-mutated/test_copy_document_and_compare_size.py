...
class TestCopyDocumentAndCompareSize(TestCase):
    """
    ...
    def _test_list_of_documents(self, documents: typing.List[Path]):
        ...
        avg_ratio_per_document: float = sum(self.FILESIZE_INFORMATION.values()) / len(self.FILESIZE_INFORMATION)
        ...
        print('TestCopyDocumentAndCompareSize: ')
        print('    count:')
