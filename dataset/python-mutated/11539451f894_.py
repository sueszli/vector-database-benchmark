...
def upgrade():
    if False:
        return 10
    op.add_column('jupyter_image_builds', sa.Column('image_tag', sa.Integer(), nullable=True))
    op.create_index(op.f('ix_jupyter_image_builds_image_tag'), 'jupyter_image_builds', ['image_tag'], unique=False)
