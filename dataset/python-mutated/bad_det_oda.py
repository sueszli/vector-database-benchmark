...
class BadDetObjectDisappearanceAttack(PoisoningAttackObjectDetector):
    ...
    | Paper link: https://arxiv.org/abs/2205.14497
    """
    attack_params = PoisoningAttackObjectDetector.attack_params + ['backdoor', 'class_source', 'percent_poison', 'channels_first', 'verbose']
    _estimator_requirements = ()

    def __init__(self, backdoor: PoisoningAttackBackdoor, class_source: int=0, percent_poison: float=0.3, channels_first: bool=False, verbose: bool=False) -> None:
        if False:
            return 10
