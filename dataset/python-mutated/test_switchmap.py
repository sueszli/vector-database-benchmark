...
class TestSwitchMap(unittest.TestCase):
    ...
    def test_switch_map(self):
        ...
        assert results.messages == [on_next(320, (0, 'a')), on_next(340, (1, 'a')), on_next(360, (2, 'a')), on_next(380, (3, 'a')), on_next(420, (0, 'b')), on_next(440, (1, 'b')), on_next(460, (2, 'b')), on_next(480, (3, 'b')), on_next(520, (0, 'c')), on_next(540, (1, 'c')), on_next(560, (2, 'c'))]
    ...
    def test_switch_map_inner_completes(self):
        ...
        def create():
            ...
            return xs.pipe(ops.switch_map(create_inner))
        results = scheduler.start(create)
        assert results.messages == [on_next(320, (0, 'd')), on_next(350, (0, 'f')), on_next(370, (1, 'f')), on_completed(540)]
