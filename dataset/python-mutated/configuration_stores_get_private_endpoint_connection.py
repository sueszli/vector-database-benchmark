...
def main():
    ...
    response = client.private_endpoint_connections.get(resource_group_name='myResourceGroup', config_store_name='contoso', private_endpoint_connection_name='myConnection')
    print(response)
