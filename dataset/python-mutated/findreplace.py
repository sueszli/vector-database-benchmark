...
from qtpy.QtWidgets import QAction, QGridLayout, QHBoxLayout, QLabel, QLineEdit, QToolButton, QSizePolicy, QSpacerItem, QWidget
...
class FindReplace(QWidget):
    """Find widget"""
    TOOLTIP = {'regexp_error': _('Regular expression error'), 'no_matches': _('No matches')}
