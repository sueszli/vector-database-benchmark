import pyxel
from .settings import EDITOR_IMAGE, MUSIC_FIELD_BACKGROUND_COLOR, MUSIC_FIELD_CURSOR_EDIT_COLOR, MUSIC_FIELD_CURSOR_PLAY_COLOR, MUSIC_FIELD_CURSOR_SELECT_COLOR, MUSIC_FIELD_SOUND_NORMAL_COLOR, MUSIC_FIELD_SOUND_SELECT_COLOR, TEXT_LABEL_COLOR
