...
@get('/greet', exception_handlers={ValidationException: router_handler_exception_handler})
async def greet(name: str) -> str:
    return f'hello {name}'
app = Litestar(route_handlers=[index, greet], exception_handlers={HTTPException: app_exception_handler})