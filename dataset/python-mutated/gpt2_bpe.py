...
class GPT2BPEConfig(FairseqDataclass):
    gpt2_encoder_json: str = field(default=DEFAULT_ENCODER_JSON, metadata={'help': 'path to encoder.json'})
    gpt2_vocab_bpe: str = field(default=DEFAULT_VOCAB_BPE, metadata={'help': 'path to vocab.bpe'})
