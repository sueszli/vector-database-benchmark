...
class SessionRecordingPlaylistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'short_id', 'name', 'derived_name', 'description', 'pinned', 'created_at', 'created_by', 'deleted', 'filters', 'last_modified_at', 'last_modified_by']
        read_only_fields = ['id', 'short_id', 'team', 'created_at', 'created_by', 'last_modified_at', 'last_modified_by']
