...
class RDSDBClusterTestCase(SecurityMonkeyTestCase):
    ...
    def test_check_internet_accessible(self):
        ...
        rds_instance = {'vpc_security_groups': [{'VpcSecurityGroupId': 'sg-12345678'}], 'port': 3306}
        from security_monkey.watchers.rds.rds_db_cluster import RDSClusterItem
        item = RDSClusterItem(account='TEST_ACCOUNT', name='MyRDSDbCluster', arn=ARN_PREFIX + ':rds:' + AWS_DEFAULT_REGION + ':012345678910:db/MyDBCluster', config=rds_instance)
