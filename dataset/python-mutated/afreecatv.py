...
from ..utils import ExtractorError, OnDemandPagedList, date_from_str, determine_ext, int_or_none, qualities, traverse_obj, unified_strdate, unified_timestamp, update_url_query, url_or_none, urlencode_postdata, xpath_text
...
class AfreecaTVLiveIE(AfreecaTVIE):
    ...
    _TESTS = [{'url': 'https://play.afreecatv.com/pyh3646/237852185', 'info_dict': {'id': '237852185', 'ext': 'mp4', 'title': '【 우루과이 오늘은 무슨일이? 】', 'uploader': '박진우[JINU]', 'uploader_id': 'pyh3646', 'timestamp': 1640661495, 'is_live': True}, 'skip': 'Livestream has ended'}, {'url': 'http://play.afreeca.com/pyh3646/237852185', 'only_matching': True}, {'url': 'http://play.afreeca.com/pyh3646', 'only_matching': True}]
...
class AfreecaTVUserIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://bj.afreecatv.com/ryuryu24/vods/review', 'info_dict': {'_type': 'playlist', 'id': 'ryuryu24', 'title': 'ryuryu24 - review'}, 'playlist_count': 218}, {'url': 'https://bj.afreecatv.com/parang1995/vods/highlight', 'info_dict': {'_type': 'playlist', 'id': 'parang1995', 'title': 'parang1995 - highlight'}, 'playlist_count': 997}, {'url': 'https://bj.afreecatv.com/ryuryu24/vods', 'info_dict': {'_type': 'playlist', 'id': 'ryuryu24', 'title': 'ryuryu24 - all'}, 'playlist_count': 221}, {'url': 'https://bj.afreecatv.com/ryuryu24/vods/balloonclip', 'info_dict': {'_type': 'playlist', 'id': 'ryuryu24', 'title': 'ryuryu24 - balloonclip'}, 'playlist_count': 0}]
    _PER_PAGE = 60
