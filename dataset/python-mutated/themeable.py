...
class rect(legend_key, legend_background, panel_background, panel_border, plot_background, strip_background):
    """
...
class axis_ticks_length_major(axis_ticks_length_major_x, axis_ticks_length_major_y):
    """
...
class axis_ticks_length_minor(axis_ticks_length_minor_x, axis_ticks_length_minor_y):
    """
