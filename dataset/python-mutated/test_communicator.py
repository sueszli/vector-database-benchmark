...
from chainermn.communicators.non_cuda_aware_communicator import NonCudaAwareCommunicator
...
cpu_params = [Param(p) for p in [{'communicator_class': NaiveCommunicator, 'multi_node': True}]]
gpu_params = [Param(p) for p in [{'communicator_class': NaiveCommunicator, 'multi_node': True}, {'communicator_class': NaiveCommunicator, 'model_dtype': np.float16, 'multi_node': True}, {'communicator_class': FlatCommunicator, 'multi_node': True}, {'communicator_class': FlatCommunicator, 'model_dtype': np.float16, 'multi_node': True}, {'communicator_class': NonCudaAwareCommunicator, 'multi_node': True}, {'communicator_class': NonCudaAwareCommunicator, 'model_dtype': np.float16, 'multi_node': False}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'allreduce_grad_dtype': np.float16}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float16, 'allreduce_grad_dtype': np.float16}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float64, 'allreduce_grad_dtype': np.float64}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float16, 'allreduce_grad_dtype': np.float16}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float16, 'allreduce_grad_dtype': np.float32}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float32, 'allreduce_grad_dtype': np.float32}, {'communicator_class': PureNcclCommunicator, 'multi_node': True, 'nccl1': False, 'model_dtype': np.float32, 'allreduce_grad_dtype': np.float16}]]
gpu_mixed_dtype_params = [Param(p) for p in [{'communicator_class': NonCudaAwareCommunicator, 'multi_node': True}, {'communicator_class': NaiveCommunicator, 'multi_node': True}, {'communicator_class': FlatCommunicator, 'multi_node': True}]]
for global_dtype in [np.float32, np.float16, chainer.mixed16, None]:
    for allreduce_dtype in [np.float32, np.float16, None]:
        ...
        for batched_copy in [True, False]:
            gpu_mixed_dtype_params.append(Param({'communicator_class': PureNcclCommunicator, 'multi_node': True, 'global_dtype': global_dtype, 'allreduce_grad_dtype': allreduce_dtype, 'batched_copy': batched_copy}))
