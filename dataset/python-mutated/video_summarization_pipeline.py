...
from modelscope.models.cv.video_summarization import PGLVideoSummarization, summary_format
...
@PIPELINES.register_module(Tasks.video_summarization, module_name=Pipelines.video_summarization)
