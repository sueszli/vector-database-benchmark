...
from redash.query_runner import TYPE_BOOLEAN, TYPE_DATE, TYPE_FLOAT, TYPE_INTEGER, TYPE_STRING, BaseHTTPQueryRunner, register
from redash.utils import json_dumps, json_loads
logger = logging.getLogger(__name__)
ELASTICSEARCH_TYPES_MAPPING = {'integer': TYPE_INTEGER, 'long': TYPE_INTEGER, 'float': TYPE_FLOAT, 'double': TYPE_FLOAT, 'boolean': TYPE_BOOLEAN, 'string': TYPE_STRING, 'date': TYPE_DATE, 'object': TYPE_STRING}
TYPES_MAP = {str: TYPE_STRING, int: TYPE_INTEGER, float: TYPE_FLOAT, bool: TYPE_BOOLEAN}
