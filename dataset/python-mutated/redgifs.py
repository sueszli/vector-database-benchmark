...
from ..utils import ExtractorError, int_or_none, qualities, try_get, OnDemandPagedList

class RedGifsBaseInfoExtractor(InfoExtractor):
    _FORMATS = {'gif': 250, 'sd': 480, 'hd': None}
    _API_HEADERS = {'referer': 'https://www.redgifs.com/', 'origin': 'https://www.redgifs.com', 'content-type': 'application/json'}
...
class RedGifsSearchIE(RedGifsBaseInfoExtractor):
    ...
    _PAGE_SIZE = 80
    _TESTS = [{'url': 'https://www.redgifs.com/browse?tags=Lesbian', 'info_dict': {'id': 'tags=Lesbian', 'title': 'Lesbian', 'description': 'RedGifs search for Lesbian, ordered by trending'}, 'playlist_mincount': 100}, {'url': 'https://www.redgifs.com/browse?type=g&order=latest&tags=Lesbian', 'info_dict': {'id': 'type=g&order=latest&tags=Lesbian', 'title': 'Lesbian', 'description': 'RedGifs search for Lesbian, ordered by latest'}, 'playlist_mincount': 100}, {'url': 'https://www.redgifs.com/browse?type=g&order=latest&tags=Lesbian&page=2', 'info_dict': {'id': 'type=g&order=latest&tags=Lesbian&page=2', 'title': 'Lesbian', 'description': 'RedGifs search for Lesbian, ordered by latest'}, 'playlist_count': 80}]
