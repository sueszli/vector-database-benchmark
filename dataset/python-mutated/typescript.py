...
from strawberry.codegen.types import GraphQLEnum, GraphQLList, GraphQLObjectType, GraphQLOptional, GraphQLScalar, GraphQLUnion
if TYPE_CHECKING:
...
class TypeScriptPlugin(QueryCodegenPlugin):
    SCALARS_TO_TS_TYPE = {'ID': 'string', 'Int': 'number', 'String': 'string', 'Float': 'number', 'Boolean': 'boolean', 'UUID': 'string', 'Date': 'string', 'DateTime': 'string', 'Time': 'string', 'Decimal': 'string', str: 'string', float: 'number'}
