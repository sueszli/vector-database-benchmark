...
from paddle.distributed.auto_parallel.static.utils import update_op_dims_mapping_by_default_dist_impl, update_op_dims_mapping_by_elementwise_like_dist_impl
