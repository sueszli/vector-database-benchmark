...
class RZXGate(Gate):
    ...
    **Examples:**
    ...
    def _define(self):
        ...
        rules = [(HGate(), [q[1]], []), (CXGate(), [q[0], q[1]], []), (RZGate(theta), [q[1]], []), (CXGate(), [q[0], q[1]], []), (HGate(), [q[1]], [])]
    ...
    def __array__(self, dtype=None):
        ...
        return numpy.array([[cos, 0, -isin, 0], [0, cos, 0, isin], [-isin, 0, cos, 0], [0, isin, 0, cos]], dtype=dtype)
