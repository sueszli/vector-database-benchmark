...
class CreateProductRequest(proto.Message):
    ...
    product_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateProductRequest(proto.Message):
    ...
    """
    product: gcr_product.Product = proto.Field(proto.MESSAGE, number=1, message=gcr_product.Product)
...
class ListProductsRequest(proto.Message):
    ...
    read_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=5, message=field_mask_pb2.FieldMask)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    products: MutableSequence[gcr_product.Product] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcr_product.Product)
...
class SetInventoryRequest(proto.Message):
    ...
    """
    inventory: gcr_product.Product = proto.Field(proto.MESSAGE, number=1, message=gcr_product.Product)
    set_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    set_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
...
class SetInventoryResponse(proto.Message):
    """Response of the SetInventoryRequest. Currently empty because there
...
class AddFulfillmentPlacesRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            [Product][google.cloud.retail.v2.Product] is not found.
    """
    product: str = proto.Field(proto.STRING, number=1)
    type_: str = proto.Field(proto.STRING, number=2)
    place_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    add_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    allow_missing: bool = proto.Field(proto.BOOL, number=5)

class AddFulfillmentPlacesMetadata(proto.Message):
    """Metadata related to the progress of the AddFulfillmentPlaces
...
class AddLocalInventoriesRequest(proto.Message):
    ...
    """
    product: str = proto.Field(proto.STRING, number=1)
    local_inventories: MutableSequence[common.LocalInventory] = proto.RepeatedField(proto.MESSAGE, number=2, message=common.LocalInventory)
    add_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=4, message=field_mask_pb2.FieldMask)
    add_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    allow_missing: bool = proto.Field(proto.BOOL, number=6)

class AddLocalInventoriesMetadata(proto.Message):
    """Metadata related to the progress of the AddLocalInventories
    operation. Currently empty because there is no meaningful metadata
    populated from the
    [ProductService.AddLocalInventories][google.cloud.retail.v2.ProductService.AddLocalInventories]
    method.
...
class RemoveLocalInventoriesRequest(proto.Message):
    ...
    """
    product: str = proto.Field(proto.STRING, number=1)
    place_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    remove_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    allow_missing: bool = proto.Field(proto.BOOL, number=3)

class RemoveLocalInventoriesMetadata(proto.Message):
    """Metadata related to the progress of the RemoveLocalInventories
    operation. Currently empty because there is no meaningful metadata
    populated from the
    [ProductService.RemoveLocalInventories][google.cloud.retail.v2.ProductService.RemoveLocalInventories]
    method.
...
class RemoveFulfillmentPlacesRequest(proto.Message):
    ...
    type_: str = proto.Field(proto.STRING, number=2)
    place_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    remove_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    allow_missing: bool = proto.Field(proto.BOOL, number=5)

class RemoveFulfillmentPlacesMetadata(proto.Message):
    """Metadata related to the progress of the RemoveFulfillmentPlaces
    operation. Currently empty because there is no meaningful metadata
    populated from the
    [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2.ProductService.RemoveFulfillmentPlaces]
    method.
...
class RemoveFulfillmentPlacesResponse(proto.Message):
    """Response of the RemoveFulfillmentPlacesRequest. Currently empty
