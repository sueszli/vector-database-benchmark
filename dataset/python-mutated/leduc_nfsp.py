...
flags.DEFINE_string('evaluation_metric', 'nash_conv', "Choose from 'exploitability', 'nash_conv'.")
flags.DEFINE_bool('use_checkpoints', True, 'Save/load neural network weights.')
flags.DEFINE_string('checkpoint_dir', '/tmp/nfsp_test', 'Directory to save/load the agent.')
