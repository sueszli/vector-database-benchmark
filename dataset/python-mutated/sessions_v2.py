...
GROUPBY_MAP = {'project': SimpleGroupBy('project_id', 'project'), 'environment': SimpleGroupBy('environment'), 'release': SimpleGroupBy('release'), 'session.status': SessionStatusGroupBy()}
