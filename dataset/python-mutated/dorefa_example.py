...
def training_model(model: torch.nn.Module, optimizer: Union[Optimizer, List[Optimizer]], training_step: _TRAINING_STEP, scheduler: Union[None, SCHEDULER, List[SCHEDULER]]=None, max_steps: Union[int, None]=None, max_epochs: Union[int, None]=None):
    if False:
        print('Hello World!')
    model.train()
...
def main():
    ...
    configure_list = [{'op_names': ['conv1', 'conv2', 'fc1', 'fc2'], 'target_names': ['_input_', 'weight'], 'quant_dtype': 'int8', 'quant_scheme': 'affine', 'granularity': 'default'}, {'op_names': ['relu1', 'relu2', 'relu3'], 'target_names': ['_output_'], 'quant_dtype': 'int8', 'quant_scheme': 'affine', 'granularity': 'default'}]
