...
from ray.tune.search.sample import Categorical, Domain, Float, Integer, LogUniform, Quantized, Uniform
...
SPACE_ERROR_MESSAGE = 'Space must be either a HEBO DesignSpace objector a dictionary with ONLY tune search spaces.'
