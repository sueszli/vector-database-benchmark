...
class Test_opensearch_service_domains_https_communications_enforced:
    ...
    def test_no_domains(self):
        ...
        with mock.patch('prowler.providers.aws.services.opensearch.opensearch_service.OpenSearchService', opensearch_client):
            from prowler.providers.aws.services.opensearch.opensearch_service_domains_https_communications_enforced.opensearch_service_domains_https_communications_enforced import opensearch_service_domains_https_communications_enforced
    ...
    def test_no_https_enabled(self):
        ...
        opensearch_client = mock.MagicMock
        opensearch_client.opensearch_domains = []
        opensearch_client.opensearch_domains.append(OpenSearchDomain(name=domain_name, region=AWS_REGION, arn=domain_arn, enforce_https=False))
        ...
        with mock.patch('prowler.providers.aws.services.opensearch.opensearch_service.OpenSearchService', opensearch_client):
            ...
            assert search('does not have enforce HTTPS enabled', result[0].status_extended)
    ...
    def test_https_enabled(self):
        ...
        opensearch_client = mock.MagicMock
        opensearch_client.opensearch_domains = []
        opensearch_client.opensearch_domains.append(OpenSearchDomain(name=domain_name, region=AWS_REGION, arn=domain_arn, enforce_https=True))
        opensearch_client.opensearch_domains[0].logging = []
        with mock.patch('prowler.providers.aws.services.opensearch.opensearch_service.OpenSearchService', opensearch_client):
            from prowler.providers.aws.services.opensearch.opensearch_service_domains_https_communications_enforced.opensearch_service_domains_https_communications_enforced import opensearch_service_domains_https_communications_enforced
            check = opensearch_service_domains_https_communications_enforced()
