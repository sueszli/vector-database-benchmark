...
__all__ = ['LunaView', 'I18NView', 'KokoView', 'WsView', 'redirect_format_api', 'redirect_old_apps_view', 'UIView', 'ResourceDownload']
...
class I18NView(View):
    ...
    def get(self, request, lang):
        ...
        return response
api_url_pattern = re.compile('^/api/(?P<app>\\w+)/(?P<version>v\\d)/(?P<extra>.*)$')
