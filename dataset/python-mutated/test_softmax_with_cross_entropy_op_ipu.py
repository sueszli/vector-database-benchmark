...
class TestCase4(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            while True:
                i = 10
        self.attrs = {'soft_label': False, 'return_softmax': True, 'ignore_index': 1}
...
class TestCase5(TestCase4):
    ...
    def set_op_attrs(self):
        if False:
            while True:
                i = 10
        self.attrs = {'soft_label': False, 'return_softmax': True, 'ignore_index': 1, 'axis': 1}
...
class TestCase6(TestCase4):
    ...
    def set_op_attrs(self):
        if False:
            for i in range(10):
                print('nop')
        self.attrs = {'soft_label': False, 'return_softmax': True, 'ignore_index': 1, 'axis': 2}
