...
class resourcesettingsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'get_setting': ('name', 'view'), 'list_settings': ('parent', 'page_size', 'page_token', 'view'), 'update_setting': ('setting',)}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=resourcesettingsCallTransformer()):
    if False:
        i = 10
        return i + 15
