...
@parameterized_class(('template',), [(Path('template.yml'),), (Path('nested-templates/template-parent.yaml'),)])
...
@parameterized_class(('template',), [(Path('layers', 'layer-template.yml'),), (Path('nested-templates', 'layer-template-parent.yaml'),), (Path('layers', 'some-dir', 'layer-template-parent.yaml'),)])
@skipIf(SKIP_LAYERS_TESTS, 'Skip layers tests in Appveyor only')
