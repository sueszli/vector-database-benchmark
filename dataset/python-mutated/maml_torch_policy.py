...
try:
    ...
    raise ImportError('The MAML and MB-MPO algorithms require the `higher` module to be installed! However, there was no installation found. You can install it via `pip install higher`.')
