...
class StrmlabsCall:
    ALERT = 'ALERTS'
    DONATION = 'DONATIONS'
STRMLABS_CALLS = (StrmlabsCall.ALERT, StrmlabsCall.DONATION)
...
class StrmlabsAlert:
    ...
    DONATION = 'donation'
    HOST = 'host'
STRMLABS_ALERTS = (StrmlabsAlert.FOLLOW, StrmlabsAlert.SUBSCRIPTION, StrmlabsAlert.DONATION, StrmlabsAlert.HOST)
