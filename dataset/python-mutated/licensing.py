...
class Licenser(object):
    ...
    UNLICENSED_DATA = dict(subscription_name=None, sku=None, support_level=None, instance_count=0, license_date=0, license_type='UNLICENSED', product_name='Red Hat Ansible Automation Platform', valid_key=False)
