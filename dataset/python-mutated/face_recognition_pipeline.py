...
@PIPELINES.register_module(Tasks.face_recognition, module_name=Pipelines.face_recognition)
class FaceRecognitionPipeline(FaceProcessingBasePipeline):
    ...
    def __init__(self, model: str, **kwargs):
        ...
        face_model.load_state_dict(torch.load(osp.join(model, ModelFile.TORCH_MODEL_BIN_FILE), map_location=device))
