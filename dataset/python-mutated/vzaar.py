...
from ..utils import int_or_none, float_or_none, unified_timestamp, url_or_none

class VzaarIE(InfoExtractor):
    _VALID_URL = 'https?://(?:(?:www|view)\\.)?vzaar\\.com/(?:videos/)?(?P<id>\\d+)'
    _EMBED_REGEX = ['<iframe[^>]+src=["\\\'](?P<url>(?:https?:)?//(?:view\\.vzaar\\.com)/[0-9]+)']
    _TESTS = [{'url': 'https://vzaar.com/videos/1152805', 'md5': 'bde5ddfeb104a6c56a93a06b04901dbf', 'info_dict': {'id': '1152805', 'ext': 'mp4', 'title': 'sample video (public)'}}, {'url': 'https://view.vzaar.com/27272/player', 'md5': '3b50012ac9bbce7f445550d54e0508f2', 'info_dict': {'id': '27272', 'ext': 'mp3', 'title': 'MP3'}}, {'url': 'https://view.vzaar.com/11379930/player', 'info_dict': {'id': '11379930', 'ext': 'mp4', 'title': 'Videoaula'}, 'params': {'skip_download': True}}, {'url': 'https://view.vzaar.com/20313539/download', 'only_matching': True}]
