...
if __name__ == '__main__':
    ...
    parser.add_argument('--metadata-path', action='store', required=True, help='Path to the workflow action metadata file')
    parser.add_argument('--output-path', action='store', required=False, help='Output directory for the generated image')
    parser.add_argument('--print-source', action='store_true', default=False, help='Print graphviz source code to the stdout')
    args = parser.parse_args()
    main(metadata_path=args.metadata_path, output_path=args.output_path, print_source=args.print_source)