...
about = {'website': 'https://www.opensemanticsearch.org/', 'wikidata_id': None, 'official_api_documentation': 'https://www.opensemanticsearch.org/dev', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
