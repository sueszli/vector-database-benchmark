...
parser = argparse.ArgumentParser(description="Dump ROP gadgets with Jon Salwan's ROPgadget tool.", epilog="Example: rop --grep 'pop rdi' -- --nojop")
...
@pwndbg.commands.ArgparsedCommand(parser, aliases=['ropgadget'], category=CommandCategory.INTEGRATIONS)
