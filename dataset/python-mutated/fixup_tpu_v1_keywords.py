...
class tpuCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_node': ('parent', 'node', 'node_id'), 'delete_node': ('name',), 'get_accelerator_type': ('name',), 'get_node': ('name',), 'get_tensor_flow_version': ('name',), 'list_accelerator_types': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_nodes': ('parent', 'page_size', 'page_token'), 'list_tensor_flow_versions': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'reimage_node': ('name', 'tensorflow_version'), 'start_node': ('name',), 'stop_node': ('name',)}
