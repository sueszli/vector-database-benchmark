...
@pytest.mark.parametrize('cursor_start,cursor_destination', [((0, 0), (0, 4)), ((0, 2), (0, 0)), ((0, 4), (0, 0)), ((0, 5), (0, 4)), ((0, 9), (0, 4)), ((0, 15), (0, 4))])
...
async def test_cursor_page_up():
    ...
    async with app.run_test() as pilot:
        ...
        assert text_area.selection == Selection.cursor((100 - app.console.height + 1, 1))
