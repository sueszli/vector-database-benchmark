...
class ProjectBreakpoints(object):
    ...
    def _SignToLine(self, file_name, bp):
        ...
        return
_extended_breakpoint_properties = [{'prop': 'condition', 'msg': 'Enter condition expression'}, {'prop': 'hitCondition', 'msg': 'Enter hit count expression'}, {'prop': 'logMessage', 'msg': 'Enter log expression (to make log point)'}]
