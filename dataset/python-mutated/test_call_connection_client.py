...
from azure.communication.callautomation import CommunicationUserIdentifier, CallConnectionClient, CallParticipant, TransferCallResult
...
class TestCallConnectionClient(unittest.TestCase):
    ...
    call_participant = {'identifier': {'rawId': communication_user_id, 'communicationUser': {'id': communication_user_id}}, 'isMuted': False}
