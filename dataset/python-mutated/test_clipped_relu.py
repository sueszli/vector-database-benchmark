...
@testing.fix_random()
@testing.inject_backend_tests(None, [{}, {'use_cuda': True, 'use_cudnn': 'never'}, {'use_cuda': True, 'use_cudnn': 'always'}, {'use_chainerx': True, 'chainerx_device': 'native:0'}, {'use_chainerx': True, 'chainerx_device': 'cuda:0'}])
