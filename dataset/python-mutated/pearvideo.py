...
from ..utils import qualities, unified_timestamp, traverse_obj

class PearVideoIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?pearvideo\\.com/video_(?P<id>\\d+)'
    _TEST = {'url': 'http://www.pearvideo.com/video_1076290', 'info_dict': {'id': '1076290', 'ext': 'mp4', 'title': '小浣熊在主人家玻璃上滚石头：没砸', 'description': 'md5:01d576b747de71be0ee85eb7cac25f9d', 'timestamp': 1494275280, 'upload_date': '20170508'}}
