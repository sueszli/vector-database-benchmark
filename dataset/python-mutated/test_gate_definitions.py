...
from qiskit.circuit.library import HGate, CHGate, IGate, RGate, RXGate, CRXGate, RYGate, CRYGate, RZGate, CRZGate, SGate, SdgGate, CSwapGate, TGate, TdgGate, U1Gate, CU1Gate, U2Gate, U3Gate, CU3Gate, XGate, CXGate, ECRGate, CCXGate, YGate, CYGate, ZGate, CZGate, RYYGate, PhaseGate, CPhaseGate, UGate, CUGate, SXGate, SXdgGate, CSXGate, RVGate, XXMinusYYGate
...
class TestGateEquivalenceEqual(QiskitTestCase):
    ...
    exclude = {'ControlledGate', 'DiagonalGate', 'UCGate', 'MCGupDiag', 'MCU1Gate', 'UnitaryGate', 'HamiltonianGate', 'MCPhaseGate', 'UCPauliRotGate', 'SingleQubitUnitary', 'MCXGate', 'VariadicZeroParamGate', 'ClassicalFunction', 'ClassicalElement', 'StatePreparation', 'LinearFunction', 'PermutationGate', 'Commuting2qBlock', 'PauliEvolutionGate', 'SingletonGate', 'SingletonControlledGate', '_U0Gate', '_DefinedGate', '_SingletonGateOverrides', '_SingletonControlledGateOverrides'}
