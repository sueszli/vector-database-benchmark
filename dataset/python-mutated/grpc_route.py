...
import proto
__protobuf__ = proto.module(package='google.cloud.networkservices.v1', manifest={'GrpcRoute', 'ListGrpcRoutesRequest', 'ListGrpcRoutesResponse', 'GetGrpcRouteRequest', 'CreateGrpcRouteRequest', 'UpdateGrpcRouteRequest', 'DeleteGrpcRouteRequest'})

class GrpcRoute(proto.Message):
    """GrpcRoute is the resource defining how gRPC traffic routed by
    ...
    class MethodMatch(proto.Message):
        ...
        class Type(proto.Enum):
            ...
            EXACT = 1
            REGULAR_EXPRESSION = 2
        type_: 'GrpcRoute.MethodMatch.Type' = proto.Field(proto.ENUM, number=1, enum='GrpcRoute.MethodMatch.Type')
        grpc_service: str = proto.Field(proto.STRING, number=2)
        grpc_method: str = proto.Field(proto.STRING, number=3)
        case_sensitive: bool = proto.Field(proto.BOOL, number=4, optional=True)
    ...
    class HeaderMatch(proto.Message):
        ...
        class Type(proto.Enum):
            ...
            EXACT = 1
            REGULAR_EXPRESSION = 2
        type_: 'GrpcRoute.HeaderMatch.Type' = proto.Field(proto.ENUM, number=1, enum='GrpcRoute.HeaderMatch.Type')
        key: str = proto.Field(proto.STRING, number=2)
        value: str = proto.Field(proto.STRING, number=3)

    class RouteMatch(proto.Message):
        """Criteria for matching traffic. A RouteMatch will be
        ...
        Attributes:
            ...
            headers (MutableSequence[google.cloud.network_services_v1.types.GrpcRoute.HeaderMatch]):
                ...
                to match.
        """
        method: 'GrpcRoute.MethodMatch' = proto.Field(proto.MESSAGE, number=1, optional=True, message='GrpcRoute.MethodMatch')
        headers: MutableSequence['GrpcRoute.HeaderMatch'] = proto.RepeatedField(proto.MESSAGE, number=2, message='GrpcRoute.HeaderMatch')
    ...
    class Destination(proto.Message):
        ...
        """
        service_name: str = proto.Field(proto.STRING, number=1, oneof='destination_type')
        weight: int = proto.Field(proto.INT32, number=2, optional=True)
    ...
    class FaultInjectionPolicy(proto.Message):
        ...
        class Delay(proto.Message):
            ...
            """
            fixed_delay: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=1, optional=True, message=duration_pb2.Duration)
        ...
        class Abort(proto.Message):
            ...
            Attributes:
                ...
                percentage (int):
                    ...
                    This field is a member of `oneof`_ ``_percentage``.
            """
            http_status: int = proto.Field(proto.INT32, number=1, optional=True)
            percentage: int = proto.Field(proto.INT32, number=2, optional=True)
        delay: 'GrpcRoute.FaultInjectionPolicy.Delay' = proto.Field(proto.MESSAGE, number=1, optional=True, message='GrpcRoute.FaultInjectionPolicy.Delay')
        abort: 'GrpcRoute.FaultInjectionPolicy.Abort' = proto.Field(proto.MESSAGE, number=2, optional=True, message='GrpcRoute.FaultInjectionPolicy.Abort')
    ...
    class RetryPolicy(proto.Message):
        ...
        num_retries: int = proto.Field(proto.UINT32, number=2)
    ...
    class RouteAction(proto.Message):
        ...
        """
        destinations: MutableSequence['GrpcRoute.Destination'] = proto.RepeatedField(proto.MESSAGE, number=1, message='GrpcRoute.Destination')
        fault_injection_policy: 'GrpcRoute.FaultInjectionPolicy' = proto.Field(proto.MESSAGE, number=3, message='GrpcRoute.FaultInjectionPolicy')
        timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=7, message=duration_pb2.Duration)
        retry_policy: 'GrpcRoute.RetryPolicy' = proto.Field(proto.MESSAGE, number=8, message='GrpcRoute.RetryPolicy')
    ...
    class RouteRule(proto.Message):
        ...
        """
        matches: MutableSequence['GrpcRoute.RouteMatch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='GrpcRoute.RouteMatch')
        action: 'GrpcRoute.RouteAction' = proto.Field(proto.MESSAGE, number=2, message='GrpcRoute.RouteAction')
    name: str = proto.Field(proto.STRING, number=1)
    self_link: str = proto.Field(proto.STRING, number=12)
    ...
    hostnames: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    meshes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=9)
    gateways: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=10)
    rules: MutableSequence[RouteRule] = proto.RepeatedField(proto.MESSAGE, number=7, message=RouteRule)
...
class ListGrpcRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    grpc_routes: MutableSequence['GrpcRoute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='GrpcRoute')
...
class CreateGrpcRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    grpc_route_id: str = proto.Field(proto.STRING, number=2)
    grpc_route: 'GrpcRoute' = proto.Field(proto.MESSAGE, number=3, message='GrpcRoute')
...
class UpdateGrpcRouteRequest(proto.Message):
    ...
    grpc_route: 'GrpcRoute' = proto.Field(proto.MESSAGE, number=2, message='GrpcRoute')
