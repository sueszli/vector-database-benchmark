...
class RSA_AESTransport(BasePupyTransport):
    ...
    rsa_key_size = 4096
    aes_size = 256
    __slots__ = ('aes_size', 'key_size', '_iv_enc', '_iv_dec', 'enc_cipher', 'dec_cipher', 'aes_key', 'size_to_read', 'first_block', 'buffer')
...
class RSA_AESServer(RSA_AESTransport):
    __slots__ = ('privkey', 'privkey_path', 'pk', 'post_handshake_callbacks')
    privkey = None
    privkey_path = None
