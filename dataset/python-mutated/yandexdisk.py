...
class YandexDiskIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://yadi.sk/i/VdOeDou8eZs6Y', 'md5': 'a4a8d52958c8fddcf9845935070402ae', 'info_dict': {'id': 'VdOeDou8eZs6Y', 'ext': 'mp4', 'title': '4.mp4', 'duration': 168.6, 'uploader': 'y.botova', 'uploader_id': '300043621', 'view_count': int}, 'expected_warnings': ['Unable to download JSON metadata']}, {'url': 'https://yadi.sk/d/h3WAXvDS3Li3Ce', 'only_matching': True}, {'url': 'https://yadi.sk/public?hash=5DZ296JK9GWCLp02f6jrObjnctjRxMs8L6%2B%2FuhNqk38%3D', 'only_matching': True}]
