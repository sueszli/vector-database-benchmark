...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_processes', type=int, default=1, help='The number of processes in distributed training.')
    parser.add_argument('--use_ipex', action='store_true', default=False, help='use intel pytorch extension')
