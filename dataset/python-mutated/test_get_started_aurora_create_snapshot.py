...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_create_db_cluster_snapshot', 0), ('TESTERROR-stub_describe_db_cluster_snapshots', 1)])
def test_create_snapshot_error(mock_mgr, caplog, error, stop_on_index):
    if False:
        return 10
