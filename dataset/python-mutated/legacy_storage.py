...
from .event_log.base import AssetRecord, EventLogConnection, EventLogRecord, EventLogStorage, EventRecordsFilter, EventRecordsResult
...
if TYPE_CHECKING:
    ...
    from dagster._core.storage.dagster_run import DagsterRun, DagsterRunStatsSnapshot, JobBucket, RunPartitionData, RunRecord, RunsFilter, TagBucket
