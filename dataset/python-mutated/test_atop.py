...
from dask.blockwise import _BLOCKWISE_DEFAULT_PREFIX, Blockwise, _unique_dep, index_subs, optimize_blockwise, rewrite_blockwise
from dask.highlevelgraph import HighLevelGraph
from dask.utils_test import dec, hlg_layer_topological, inc
(a, b, c, d, e, f, g) = ('a', 'b', 'c', 'd', 'e', 'f', 'g')
(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9) = (f'{_BLOCKWISE_DEFAULT_PREFIX}{i}' for i in range(10))
(i, j, k) = ('i', 'j', 'k')
