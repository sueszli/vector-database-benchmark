...
class PostDocIntegrationsTest(DocIntegrationsTest):
    method = 'POST'
    payload: dict[str, Any] = {'name': 'Enemy', 'author': 'Imagine Dragons', 'description': 'An opening theme song 👀', 'url': 'https://github.com/getsentry/sentry/', 'popularity': 5, 'resources': [{'title': 'Docs', 'url': 'https://github.com/getsentry/sentry/'}], 'features': [1, 2, 3]}
