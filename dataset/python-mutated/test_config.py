...
class TestBaseConfig:
    EXPECTED_SCHEMA = {'properties': {'choice': {'oneOf': [{'properties': {'count': {'title': 'Count', 'type': 'integer'}, 'name': {'title': 'Name', 'type': 'string'}, 'selected_strategy': {'const': 'option1', 'title': 'Selected Strategy', 'type': 'string', 'default': 'option1'}}, 'required': ['name', 'count'], 'title': 'Choice1', 'type': 'object'}, {'properties': {'selected_strategy': {'const': 'option2', 'title': 'Selected Strategy', 'type': 'string', 'default': 'option2'}, 'sequence': {'items': {'type': 'string'}, 'title': 'Sequence', 'type': 'array'}}, 'required': ['sequence'], 'title': 'Choice2', 'type': 'object'}], 'title': 'Choice'}, 'items': {'items': {'properties': {'field1': {'title': 'Field1', 'type': 'string'}, 'field2': {'title': 'Field2', 'type': 'integer'}}, 'required': ['field1', 'field2'], 'title': 'InnerClass', 'type': 'object'}, 'title': 'Items', 'type': 'array'}}, 'required': ['items', 'choice'], 'title': 'Some Source', 'type': 'object'}
