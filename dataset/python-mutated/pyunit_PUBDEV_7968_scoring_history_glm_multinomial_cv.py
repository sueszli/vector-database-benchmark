...
def test_glm_scoring_history_multinomial():
    if False:
        print('Hello World!')
    col_list_compare = ['iterations', 'objective', 'negative_log_likelihood', 'training_logloss', 'validation_logloss', 'training_classification_error', 'validation_classification_error']
    ...
    h2o_model_score_each_cv = glm(family='multinomial', score_each_iteration=True, nfolds=2, seed=1234, fold_assignment='modulo')
    ...
    h2o_model_cv_4th = glm(family='multinomial', score_iteration_interval=3, nfolds=2, fold_assignment='modulo', seed=1234)
