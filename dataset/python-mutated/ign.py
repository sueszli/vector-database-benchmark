...
from ..utils import ExtractorError, determine_ext, error_to_compat_str, extract_attributes, int_or_none, merge_dicts, parse_iso8601, strip_or_none, traverse_obj, url_or_none, urljoin
...
class IGNVideoIE(IGNBaseIE):
    ...
    _TESTS = [{'url': 'http://me.ign.com/en/videos/112203/video/how-hitman-aims-to-be-different-than-every-other-s', 'md5': 'dd9aca7ed2657c4e118d8b261e5e9de1', 'info_dict': {'id': 'e9be7ea899a9bbfc0674accc22a36cc8', 'ext': 'mp4', 'title': 'How Hitman Aims to Be Different Than Every Other Stealth Game - NYCC 2015', 'description': 'Taking out assassination targets in Hitman has never been more stylish.', 'timestamp': 1444665600, 'upload_date': '20151012', 'display_id': '112203', 'thumbnail': 'https://sm.ign.com/ign_me/video/h/how-hitman/how-hitman-aims-to-be-different-than-every-other-s_8z14.jpg', 'duration': 298, 'tags': 'count:13'}, 'expected_warnings': ['HTTP Error 400: Bad Request']}, {'url': 'http://me.ign.com/ar/angry-birds-2/106533/video/lrd-ldyy-lwl-lfylm-angry-birds', 'only_matching': True}, {'url': 'https://me.ign.com/ar/ratchet-clank-rift-apart/144327/trailer/embed', 'only_matching': True}, {'url': 'http://adria.ign.com/sherlock-season-4/9687/trailer/embed', 'only_matching': True}, {'url': 'https://kr.ign.com/bic-2018/3307/trailer/embed', 'only_matching': True}]
