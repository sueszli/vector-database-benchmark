...
BLENDERBOT_SMALL_PRETRAINED_CONFIG_ARCHIVE_MAP = {'facebook/blenderbot_small-90M': 'https://huggingface.co/facebook/blenderbot_small-90M/resolve/main/config.json'}
