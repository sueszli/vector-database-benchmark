...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=fleetengineCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
