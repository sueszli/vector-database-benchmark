...
class CreateNamespaceRequest(proto.Message):
    ...
    namespace_id: str = proto.Field(proto.STRING, number=2)
    namespace: gcs_namespace.Namespace = proto.Field(proto.MESSAGE, number=3, message=gcs_namespace.Namespace)
...
class ListNamespacesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    namespaces: MutableSequence[gcs_namespace.Namespace] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_namespace.Namespace)
...
class UpdateNamespaceRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            this request.
    """
    namespace: gcs_namespace.Namespace = proto.Field(proto.MESSAGE, number=1, message=gcs_namespace.Namespace)
...
class CreateServiceRequest(proto.Message):
    ...
    service: gcs_service.Service = proto.Field(proto.MESSAGE, number=3, message=gcs_service.Service)
...
class ListServicesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    services: MutableSequence[gcs_service.Service] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_service.Service)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateServiceRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            this request.
    """
    service: gcs_service.Service = proto.Field(proto.MESSAGE, number=1, message=gcs_service.Service)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class CreateEndpointRequest(proto.Message):
    ...
    endpoint: gcs_endpoint.Endpoint = proto.Field(proto.MESSAGE, number=3, message=gcs_endpoint.Endpoint)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    endpoints: MutableSequence[gcs_endpoint.Endpoint] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_endpoint.Endpoint)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateEndpointRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            this request.
    """
    endpoint: gcs_endpoint.Endpoint = proto.Field(proto.MESSAGE, number=1, message=gcs_endpoint.Endpoint)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
