...
from spack.util.module_cmd import get_path_args_from_module_line, get_path_from_module_contents, module, path_from_modules
pytestmark = pytest.mark.not_on_windows('Tests fail on Windows')
test_module_lines = ['prepend-path LD_LIBRARY_PATH /path/to/lib', 'setenv MOD_DIR /path/to', 'setenv LDFLAGS -Wl,-rpath/path/to/lib', 'setenv LDFLAGS -L/path/to/lib', 'prepend-path PATH /path/to/bin']
