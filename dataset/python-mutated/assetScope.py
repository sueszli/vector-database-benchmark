...
logger = get_logger()
base_fields = {'name': fields.String(description='资产组名称'), 'scope': fields.String(description='资产范围'), 'black_scope': fields.String(description='资产黑名单'), 'scope_type': fields.String(description='资产范围类别')}
add_asset_scope_fields = ns.model('addAssetScope', base_fields)
base_fields.update({'_id': fields.String(description='资产范围 ID')})
...
delete_task_get_fields = ns.model('DeleteScopeByID', {'scope': fields.String(description='删除资产范围', required=True), 'scope_id': fields.String(description='资产范围id', required=True)})
delete_task_post_fields = ns.model('DeleteScope', {'scope_id': fields.List(fields.String(description='删除资产范围', required=True), required=True)})
...
add_scope_fields = ns.model('AddScope', {'scope': fields.String(description='添加资产范围'), 'scope_id': fields.String(description='添加资产范围')})
