...
class AssetIn(NamedTuple('_AssetIn', [('key', PublicAttr[Optional[AssetKey]]), ('metadata', PublicAttr[Optional[ArbitraryMetadataMapping]]), ('key_prefix', PublicAttr[Optional[Sequence[str]]]), ('input_manager_key', PublicAttr[Optional[str]]), ('partition_mapping', PublicAttr[Optional[PartitionMapping]]), ('dagster_type', PublicAttr[Union[DagsterType, Type[NoValueSentinel]]])])):
