...
class TopRatedExplorationDisplayableSummariesTest(test_utils.GenericTestBase):
...
class RecentlyPublishedExplorationDisplayableSummariesTest(test_utils.GenericTestBase):
