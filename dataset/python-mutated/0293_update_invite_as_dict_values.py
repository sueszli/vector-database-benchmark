...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0292_update_default_value_of_invited_as')]
    operations = [migrations.RunPython(update_invite_as_dict_values, reverse_code=migrations.RunPython.noop, elidable=True)]