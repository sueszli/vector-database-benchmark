...
from modelscope.models.multi_modal.soonet import SimpleTokenizer, decode_video, load_clip
...
@PIPELINES.register_module(Tasks.video_temporal_grounding, module_name=Pipelines.soonet_video_temporal_grounding)
