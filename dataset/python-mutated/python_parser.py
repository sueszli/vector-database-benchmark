...
import re
from typing import IO, TYPE_CHECKING, DefaultDict, Literal, cast
import warnings
import numpy as np
...
from pandas.core.dtypes.common import is_bool_dtype, is_integer, is_numeric_dtype
...
if TYPE_CHECKING:
    from pandas._typing import ArrayLike, ReadCsvBuffer, Scalar
