...
class ExtensionTypeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    class ExtensionTypeWithName(extension_type.ExtensionType):
        __name__ = 'tf.__test__.ExtensionTypeWithName'
        x: typing.Tuple[tensor.Tensor, int]
        y: tensor.Tensor
...
@test_util.run_all_in_graph_and_eager_modes
class ExtensionTypeSpecTest(test_util.TensorFlowTestCase, parameterized.TestCase):
...
@test_util.run_all_in_graph_and_eager_modes
class AnonymousExtensionTypeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
