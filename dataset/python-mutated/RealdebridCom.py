...
class RealdebridCom(MultiDownloader):
    ...
    __version__ = '0.81'
    __status__ = 'testing'
    __pattern__ = 'https?://((?:www\\.|s\\d+\\.)?real-debrid\\.com/dl?/|[\\w^_]\\.rdb\\.so/d/)[\\w^_]+'
    __config__ = [('use_premium', 'bool', 'Use premium account if available', True), ('fallback', 'bool', 'Fallback to free download if premium fails', False), ('revert_failed', 'bool', 'Revert to standard download if fails', True), ('chk_filesize', 'bool', 'Check file size', True), ('max_wait', 'int', 'Reconnect if waiting time is greater than minutes', 10)]
    __description__ = 'Real-Debrid.com multi-downloader plugin'
    __license__ = 'GPLv3'
    __authors__ = [('Devirex Hazzard', 'naibaf_11@yahoo.de'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
