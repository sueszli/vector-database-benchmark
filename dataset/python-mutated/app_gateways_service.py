...
import proto
__protobuf__ = proto.module(package='google.cloud.beyondcorp.appgateways.v1', manifest={'ListAppGatewaysRequest', 'ListAppGatewaysResponse', 'GetAppGatewayRequest', 'CreateAppGatewayRequest', 'DeleteAppGatewayRequest', 'AppGateway', 'AppGatewayOperationMetadata'})
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    app_gateways: MutableSequence['AppGateway'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AppGateway')
...
class CreateAppGatewayRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    app_gateway_id: str = proto.Field(proto.STRING, number=2)
    app_gateway: 'AppGateway' = proto.Field(proto.MESSAGE, number=3, message='AppGateway')
...
class AppGateway(proto.Message):
    ...
    class AllocatedConnection(proto.Message):
        ...
        Attributes:
            ...
            ingress_port (int):
                ...
                connection
        """
        psc_uri: str = proto.Field(proto.STRING, number=1)
        ingress_port: int = proto.Field(proto.INT32, number=2)
    name: str = proto.Field(proto.STRING, number=1)
    ...
    uri: str = proto.Field(proto.STRING, number=9)
    allocated_connections: MutableSequence[AllocatedConnection] = proto.RepeatedField(proto.MESSAGE, number=10, message=AllocatedConnection)
    host_type: HostType = proto.Field(proto.ENUM, number=11, enum=HostType)
