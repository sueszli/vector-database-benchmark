...
from modelscope.models.cv.image_to_image_generation.models.clip import VisionTransformer
...
@PIPELINES.register_module(Tasks.image_to_image_generation, module_name=Pipelines.image_to_image_generation)
