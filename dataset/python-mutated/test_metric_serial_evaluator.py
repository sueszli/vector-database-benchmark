...
fake_cls_config = dict(exp_name='fake_config_for_test_metric_serial_evaluator', policy=dict(on_policy=False, cuda=False, eval=dict(batch_size=1, evaluator=dict(eval_freq=1, multi_gpu=False, stop_value=dict(acc=75.0)))), env=dict())
