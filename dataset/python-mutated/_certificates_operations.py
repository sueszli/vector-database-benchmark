...
class CertificatesOperations:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, name: str, certificate_envelope: _models.Certificate, *, content_type: str='application/json', **kwargs: Any) -> _models.Certificate:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, name: str, certificate_envelope: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Certificate:
        """Create or update a certificate.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, name: str, certificate_envelope: Union[_models.Certificate, IO], **kwargs: Any) -> _models.Certificate:
        """Create or update a certificate.
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2016_03_01.models.Certificate or IO
        ...
        request = build_create_or_update_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update(self, resource_group_name: str, name: str, certificate_envelope: _models.CertificatePatchResource, *, content_type: str='application/json', **kwargs: Any) -> _models.Certificate:
        """Create or update a certificate.
    ...
    @overload
    async def update(self, resource_group_name: str, name: str, certificate_envelope: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Certificate:
        """Create or update a certificate.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, name: str, certificate_envelope: Union[_models.CertificatePatchResource, IO], **kwargs: Any) -> _models.Certificate:
        """Create or update a certificate.
        ...
        :type certificate_envelope: ~azure.mgmt.web.v2016_03_01.models.CertificatePatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
