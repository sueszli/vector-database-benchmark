...
class LocalStackCliGroup(click.Group):
    ...
    """
    advanced_commands = ['aws', 'dns', 'extensions', 'license', 'login', 'logout', 'pod', 'state']
...
_click_format_option = click.option('-f', '--format', 'format_', type=click.Choice(['table', 'plain', 'dict', 'json']), default='table', help='The formatting style for the command output.')
