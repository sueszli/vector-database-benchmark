...
field_map = {'Contact': ['first_name', 'last_name', 'address', 'phone', 'mobile_no', 'email_id', 'is_primary_contact'], 'Address': ['address_line1', 'address_line2', 'city', 'state', 'pincode', 'country', 'is_primary_address']}
