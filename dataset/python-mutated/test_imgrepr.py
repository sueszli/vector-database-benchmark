...
import cv2
import numpy as np
from apps.rendering.resources.imgrepr import EXRImgRepr, ImgRepr, load_img, OpenCVImgRepr, OpenCVError
from golem.testutils import TempDirFixture, PEP8MixIn
from golem.tools.assertlogs import LogTestCase
from tests.apps.rendering.resources.imghelper import get_exr_img_repr, get_test_exr, make_test_img
...
class TestImgRepr(unittest.TestCase, PEP8MixIn):
    PEP8_FILES = ['apps/rendering/resources/imgrepr.py']
