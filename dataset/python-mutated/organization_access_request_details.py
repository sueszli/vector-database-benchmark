...
class AccessRequestPermission(OrganizationPermission):
    scope_map = {'GET': ['org:read', 'org:write', 'org:admin', 'team:read', 'team:write', 'team:admin', 'member:read', 'member:write', 'member:admin'], 'POST': [], 'PUT': ['org:write', 'org:admin', 'team:write', 'team:admin', 'member:write', 'member:admin'], 'DELETE': []}
