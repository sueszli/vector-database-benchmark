...
PLY_FORMAT_TO_PLY_READER = {'ascii': ply_readers.PlyASCIIReader, 'ascii_with_normals': ply_readers.PlyASCIIWithNormalsReader, 'binary_little_endian': ply_readers.PlyBinReader, 'binary_big_endian': ply_readers.PlyBinReader}
