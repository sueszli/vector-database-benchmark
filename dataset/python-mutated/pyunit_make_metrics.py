...
base_metric_methods = ['aic', 'loglikelihood', 'auc', 'gini', 'logloss', 'mae', 'mean_per_class_error', 'mean_residual_deviance', 'mse', 'nobs', 'aucpr', 'pr_auc', 'r2', 'rmse', 'rmsle', 'residual_deviance', 'residual_degrees_of_freedom', 'null_deviance', 'null_degrees_of_freedom']
...
pyunit_utils.run_tests([suite_model_metrics()])