...
@parameterized_class([{'batch_typehint': pd.DataFrame, 'element_typehint': row_type.RowTypeConstraint.from_fields([('foo', int), ('bar', float), ('baz', str)]), 'match_index': False, 'batch': pd.DataFrame({'foo': pd.Series(range(100), dtype='int64'), 'bar': pd.Series([i / 100 for i in range(100)], dtype='float64'), 'baz': pd.Series([str(i) for i in range(100)], dtype=pd.StringDtype())})}, {'batch_typehint': pd.DataFrame, 'element_typehint': row_type.RowTypeConstraint.from_fields([('an_index', int), ('foo', int), ('bar', float), ('baz', str)], field_options={'an_index': [('beam:dataframe:index', None)]}), 'match_index': True, 'batch': pd.DataFrame({'foo': pd.Series(range(100), dtype='int64'), 'bar': pd.Series([i / 100 for i in range(100)], dtype='float64'), 'baz': pd.Series([str(i) for i in range(100)], dtype=pd.StringDtype())}).set_index(pd.Index(range(123, 223), dtype='int64', name='an_index'))}, {'batch_typehint': pd.DataFrame, 'element_typehint': row_type.RowTypeConstraint.from_fields([('an_index', int), ('another_index', int), ('foo', int), ('bar', float), ('baz', str)], field_options={'an_index': [('beam:dataframe:index', None)], 'another_index': [('beam:dataframe:index', None)]}), 'match_index': True, 'batch': pd.DataFrame({'foo': pd.Series(range(100), dtype='int64'), 'bar': pd.Series([i / 100 for i in range(100)], dtype='float64'), 'baz': pd.Series([str(i) for i in range(100)], dtype=pd.StringDtype())}).set_index([pd.Index(range(123, 223), dtype='int64', name='an_index'), pd.Index(range(475, 575), dtype='int64', name='another_index')])}, {'batch_typehint': pd.Series, 'element_typehint': int, 'match_index': False, 'batch': pd.Series(range(500))}, {'batch_typehint': pd.Series, 'element_typehint': str, 'batch': pd.Series(['foo', 'bar', 'baz', 'def', 'ghi', 'abc'] * 10, dtype=pd.StringDtype())}, {'batch_typehint': pd.Series, 'element_typehint': Optional[np.int64], 'batch': pd.Series((i if i % 11 else None for i in range(500)), dtype=pd.Int64Dtype())}, {'batch_typehint': pd.Series, 'element_typehint': Optional[str], 'batch': pd.Series(['foo', None, 'bar', 'baz', None, 'def', 'ghi'] * 10, dtype=pd.StringDtype())}])
