...
class GraphQLWSHandler(BaseGraphQLWSHandler):
    ...
    def __init__(self, schema: BaseSchema, debug: bool, keep_alive: bool, keep_alive_interval: float, get_context: Callable, get_root_value: Callable, request: web.Request):
        if False:
            for i in range(10):
                print('nop')
