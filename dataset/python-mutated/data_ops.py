...
from modelscope.models.science.unifold.config import N_EXTRA_MSA, N_MSA, N_RES, N_TPL
...
protein: TorchDict
MSA_FEATURE_NAMES = ['msa', 'deletion_matrix', 'msa_mask', 'msa_row_mask', 'bert_mask', 'true_msa', 'msa_chains']
