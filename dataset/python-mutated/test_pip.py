...
def test_pip_install_successful(tmp_path: Path, tmp_venv: VirtualEnv, fixture_dir: FixtureDirGetter) -> None:
    if False:
        return 10
...
def test_pip_install_with_keyboard_interrupt(tmp_path: Path, tmp_venv: VirtualEnv, fixture_dir: FixtureDirGetter, mocker: MockerFixture) -> None:
    if False:
        return 10
    file_path = fixture_dir('distributions/demo-0.1.0-py2.py3-none-any.whl')
