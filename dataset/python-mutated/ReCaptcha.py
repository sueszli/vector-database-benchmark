...
class ReCaptcha(CaptchaService):
    ...
    __license__ = 'GPLv3'
    __authors__ = [('Walter Purcaro', 'vuolter@gmail.com'), ('zapp-brannigan', 'fuerst.reinje@web.de'), ('Arno-Nymous', None), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
    KEY_V2_PATTERN = '(?:data-sitekey=["\\\']|["\\\']sitekey["\\\']\\s*:\\s*["\\\'])((?:[\\w\\-]|%[0-9a-fA-F]{2})+)'
    KEY_FORMAT_V2_PATTERN = '^6L[\\w-]{6}AAAAA[\\w-]{27}$'
    INVISIBLE_V2_PATTERN = 'data-size\\s*=\\s*(["\\\'])\\s*invisible\\s*\\1'
    STOKEN_V2_PATTERN = 'data-stoken=["\\\']([\\w\\-]+)'
    RECAPTCHA_INTERACTIVE_SIG = '661a94a7eeb590d8d0f20d8d6e7aefa474918af01cc573da7101bc53df6ebd4ccf62df44c0bf3171' + 'fa389cf9ed8e9bb9b684621e2a1d1a3bd5bd1d5450ba5350d26f63c119477fcc3f53c5a4e784a5b9' + '7a013cbc4e802325df4a693de112bc8fe72e8d64ec6e14d14b907290c0db04e139283733a7981daf' + 'b05a00785d1ed32c9dcd2ae9aa10f2c058ecb7667c3d000adfc1372d6a161e348ba1170e4211737f' + '1f54518bf9f50197bba1bb336ceb17be220245f1554dfad7af1e2b996d65419d259e98a1f468dfc2' + 'ce492fa359f7489184786ea9d02f595101910d711d2c93978a81e9a573a27720f2e81c5d636b2483' + '0c85257db01aeaf58474b00190fb702f'
