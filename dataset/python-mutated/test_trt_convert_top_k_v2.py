                    ...
                    for axis in [-1, 1, 0, 2, 3]:
                        for largest in [True, False]:
                            for sort in [True, False]:
                                ...
                                ops_config = [{'op_type': 'top_k_v2', 'op_inputs': {'X': ['input_data']}, 'op_outputs': {'Out': ['output_data'], 'Indices': ['indices_data']}, 'op_attrs': dics[0], 'outputs_dtype': {'indices_data': np.int32}}]
