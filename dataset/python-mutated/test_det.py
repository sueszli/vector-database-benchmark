...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'batched': [True, False]}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'shape': [(s, s) for s in six.moves.range(1, 5)]}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'shape': [(w, s, s) for s in six.moves.range(1, 5) for w in six.moves.range(1, 5)]}))
