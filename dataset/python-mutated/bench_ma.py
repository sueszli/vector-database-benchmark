...
class MACreation(Benchmark):
    ...
    params = [[10, 100, 1000], [True, False, None]]
...
class Concatenate(Benchmark):
    param_names = ['mode', 'n']
    params = [['ndarray', 'unmasked', 'ndarray+masked', 'unmasked+masked', 'masked'], [2, 100, 2000]]
...
class MAFunctions1v(Benchmark):
    ...
    params = [['np', 'np.ma'], ['sin', 'log', 'sqrt'], ['small', 'big']]
...
class MAMethod0v(Benchmark):
    ...
    params = [['ravel', 'transpose', 'compressed', 'conjugate'], ['small', 'big']]
...
class MAFunctions2v(Benchmark):
    param_names = ['mtype', 'func', 'msize']
    params = [['np', 'np.ma'], ['multiply', 'divide', 'power'], ['small', 'big']]
...
class MAMethodSetItem(Benchmark):
    ...
    params = [[0, (0, 0), (-1, 0)], [17, np.ma.masked], ['small', 'big']]
