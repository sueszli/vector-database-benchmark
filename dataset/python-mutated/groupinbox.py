...
from sentry.models.grouphistory import GroupHistoryStatus, bulk_record_group_history, record_group_history
from sentry.types.activity import ActivityType
INBOX_REASON_DETAILS = {'type': ['object', 'null'], 'properties': {'until': {'type': ['string', 'null'], 'format': 'date-time'}, 'count': {'type': ['integer', 'null']}, 'window': {'type': ['integer', 'null']}, 'user_count': {'type': ['integer', 'null']}, 'user_window': {'type': ['integer', 'null']}}, 'required': [], 'additionalProperties': False}
