...
def upgrade():
    ...
    op.create_table('concurrency_limit', sa.Column('id', prefect.server.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False), sa.Column('created', prefect.server.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False), sa.Column('updated', prefect.server.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False), sa.Column('tag', sa.String(), nullable=False), sa.Column('concurrency_limit', sa.Integer(), nullable=False), sa.Column('active_slots', prefect.server.utilities.database.JSON(astext_type=Text()), server_default='[]', nullable=False), sa.PrimaryKeyConstraint('id', name=op.f('pk_concurrency_limit')))
    ...
    op.create_table('flow_run_state', sa.Column('id', prefect.server.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False), sa.Column('created', prefect.server.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False), sa.Column('updated', prefect.server.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False), sa.Column('type', sa.Enum('SCHEDULED', 'PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='state_type'), nullable=False), sa.Column('timestamp', prefect.server.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False), sa.Column('name', sa.String(), nullable=False), sa.Column('message', sa.String(), nullable=True), sa.Column('state_details', prefect.server.utilities.database.Pydantic(prefect.server.schemas.states.StateDetails), server_default='{}', nullable=False), sa.Column('data', prefect.server.utilities.database.Pydantic(DataDocument), nullable=True), sa.Column('flow_run_id', prefect.server.utilities.database.UUID(), nullable=False), sa.ForeignKeyConstraint(['flow_run_id'], ['flow_run.id'], name=op.f('fk_flow_run_state__flow_run_id__flow_run'), ondelete='cascade'), sa.PrimaryKeyConstraint('id', name=op.f('pk_flow_run_state')))
