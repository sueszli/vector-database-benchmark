...
NUMPY_DTYPE_TO_TYPESTR: Dict = {np.dtype('float32'): '<f4', np.dtype('int32'): '<i4', np.dtype('uint32'): '<u4', np.dtype('float16'): '<f2', np.dtype('int16'): '<u2', np.dtype('uint16'): '<u2', np.dtype('uint8'): '|u1', np.dtype('int8'): '|i1'}
...
_LAS_HEADER_FILED_NAME_TO_PARSER = {'DEFAULT_VERSION': _default_version_parser, 'version': _default_version_parser, 'creation_date': _creation_date_parser, 'global_encoding': _global_encoding_parser}
