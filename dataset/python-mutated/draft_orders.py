...
from ...core.mutations import BaseBulkWithRestrictedChannelAccessMutation, ModelBulkDeleteMutation
from ...core.types import NonNullList, OrderError
from ..types import Order, OrderLine

class DraftOrderBulkDelete(ModelBulkDeleteMutation, BaseBulkWithRestrictedChannelAccessMutation):

    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of draft order IDs to delete.')
...
class DraftOrderLinesBulkDelete(ModelBulkDeleteMutation, BaseBulkWithRestrictedChannelAccessMutation):

    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of order lines IDs to delete.')
