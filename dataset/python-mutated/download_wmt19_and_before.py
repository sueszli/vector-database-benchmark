...
def tmx2raw(tmx, debug):
    ...
    call(cmd, debug)
    return to_file
CZENG16_REGEX = re.compile('.*?data.plaintext-format/0[0-9]train$')
WMT19_WIKITITLES_REGEX = re.compile('.*?wikititles-v1.(\\w\\w)-en.tsv.gz')
TSV_REGEX = re.compile('.*?(\\w\\w)-(\\w\\w).tsv$')
...
def extract_czeng17(extract_folder, debug=False):
    ...
    if not os.path.exists(script_path):
        ...
        extract_to = extract_file(f'{download_to}/convert_czeng16_to_17.pl.zip', extract_folder, get_extract_name=get_extract_name, debug=debug)
    return script_path
wmt13_es_en = DLDataset(name='wmt13_es-en', train_urls=['http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz', 'http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz', 'http://www.statmt.org/wmt13/training-parallel-un.tgz', 'http://www.statmt.org/wmt13/training-parallel-nc-v8.tgz'], valid_urls=[('http://www.statmt.org/wmt13/dev.tgz', 'wmt13_dev.tgz')], test_urls=[('http://www.statmt.org/wmt13/test.tgz', 'wmt13_test.tgz')], train_files_patterns=[('*/europarl-v7.{src}-{tgt}.{lang}', ['es-en']), ('*commoncrawl.{src}-{tgt}.{lang}', ['es-en']), ('*/news-commentary-v8.{src}-{tgt}.{lang}', ['es-en']), ('un/*undoc.2000.{src}-{tgt}.{lang}', ['es-en'])], valid_files_patterns=[('dev/newstest2012.{lang}', ['es-en'])], test_files_patterns=[('test/newstest*.{lang}', ['es-en'])])
wmt14_de_fr_en = DLDataset(name='wmt14_de_fr_en', train_urls=['http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz', 'http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz', 'http://www.statmt.org/wmt13/training-parallel-un.tgz', 'http://www.statmt.org/wmt14/training-parallel-nc-v9.tgz', ('http://www.statmt.org/wmt10/training-giga-fren.tar', 'training-giga-fren.gz.tar')], valid_urls=[('http://www.statmt.org/wmt14/dev.tgz', 'wmt14_dev.tgz')], test_urls=[('http://www.statmt.org/wmt14/test-full.tgz', 'wmt14_test_full.tgz')], train_files_patterns=[('*/europarl-v7.{src}-{tgt}.{lang}', ['fr-en', 'de-en']), ('*commoncrawl.{src}-{tgt}.{lang}', ['fr-en', 'de-en']), ('*/*news-commentary-v9.{src}-{tgt}.{lang}', ['fr-en', 'de-en']), ('un/undoc.2000.{src}-{tgt}.{lang}', ['fr-en']), ('*giga-{src}{tgt}*{lang}', ['fr-en'])], valid_files_patterns=[('dev/newstest2013.{lang}', ['fr-en', 'de-en'])], test_files_patterns=[('test-full/newstest*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['en-de', 'de-en', 'fr-en', 'en-fr'])])
wmt16_ro_en = DLDataset(name='wmt16_ro-en', train_urls=[('http://data.statmt.org/wmt16/translation-task/training-parallel-ep-v8.tgz', 'wmt16_training-parallel-ep-v8.tgz'), ('http://opus.nlpl.eu/download.php?f=SETIMES/v2/tmx/en-ro.tmx.gz', 'en-ro.tmx.gz')], valid_urls=[('http://data.statmt.org/wmt16/translation-task/dev-romanian-updated.tgz', 'wmt16_dev.tgz')], test_urls=[('http://data.statmt.org/wmt16/translation-task/test.tgz', 'wmt16_test.tgz')], train_files_patterns=[('*/*europarl-v8.{src}-{tgt}.{lang}', ['ro-en']), ('bitext.{lang}', ['ro-en'])], valid_files_patterns=[('dev/newsdev2016*{src}{tgt}*.{lang}', ['ro-en', 'ro-en'])], test_files_patterns=[('test/newstest*{src}{tgt}*.{lang}', ['ro-en', 'en-ro'])])
cwmt_wmt_instruction = 'cwmt download instruction at: http://nlp.nju.edu.cn/cwmt-wmt'
wmt17_fi_lv_tr_zh_en_manual_downloads = [(('http://nlp.nju.edu.cn/cwmt-wmt/CASIA2015.zip', 'CASIA2015.zip'), cwmt_wmt_instruction), (('http://nlp.nju.edu.cn/cwmt-wmt/CASICT2011.zip', 'CASICT2011.zip'), cwmt_wmt_instruction), (('http://nlp.nju.edu.cn/cwmt-wmt/CASICT2015.zip', 'CASICT2015.zip'), cwmt_wmt_instruction), (('http://nlp.nju.edu.cn/cwmt-wmt/Datum2015.zip', 'Datum2015.zip'), cwmt_wmt_instruction), (('http://nlp.nju.edu.cn/cwmt-wmt/Datum2017.zip', 'Datum2017.zip'), cwmt_wmt_instruction), (('http://nlp.nju.edu.cn/cwmt-wmt/NEU2017.zip', 'NEU2017.zip'), cwmt_wmt_instruction)]
wmt17_fi_lv_tr_zh_en = DLDataset(name='wmt17_fi_lv_tr_zh_en', train_urls=[('http://data.statmt.org/wmt17/translation-task/training-parallel-ep-v8.tgz', 'wmt17_training-parallel-ep-v8.tgz'), 'http://data.statmt.org/wmt17/translation-task/training-parallel-nc-v12.tgz', 'http://www.statmt.org/wmt15/wiki-titles.tgz', ('http://opus.nlpl.eu/download.php?f=SETIMES/v2/tmx/en-tr.tmx.gz', 'en-tr.tmx.gz'), ('http://data.statmt.org/wmt17/translation-task/rapid2016.tgz', 'wmt17_rapid2016.tgz'), 'http://data.statmt.org/wmt17/translation-task/leta.v1.tgz', 'http://data.statmt.org/wmt17/translation-task/dcep.lv-en.v1.tgz', 'http://data.statmt.org/wmt17/translation-task/books.lv-en.v1.tgz', (('https://stuncorpusprod.blob.core.windows.net/corpusfiles/UNv1.0.en-zh.tar.gz.00', 'https://stuncorpusprod.blob.core.windows.net/corpusfiles/UNv1.0.en-zh.tar.gz.01'), 'UNv1.0.en-zh.tar.gz'), ('http://nlp.nju.edu.cn/cwmt-wmt/CASIA2015.zip', 'CASIA2015.zip'), ('http://nlp.nju.edu.cn/cwmt-wmt/CASICT2011.zip', 'CASICT2011.zip'), ('http://nlp.nju.edu.cn/cwmt-wmt/CASICT2015.zip', 'CASICT2015.zip'), ('http://nlp.nju.edu.cn/cwmt-wmt/Datum2015.zip', 'Datum2015.zip'), ('http://nlp.nju.edu.cn/cwmt-wmt/Datum2017.zip', 'Datum2017.zip'), ('http://nlp.nju.edu.cn/cwmt-wmt/NEU2017.zip', 'NEU2017.zip')], valid_urls=[('http://data.statmt.org/wmt17/translation-task/dev.tgz', 'wmt17_dev.tgz')], test_urls=[('http://data.statmt.org/wmt17/translation-task/test-update-1.tgz', 'wmt17_test_zh_en.tgz'), ('http://data.statmt.org/wmt17/translation-task/test.tgz', 'wmt17_test_others.tgz')], train_files_patterns=[('casict*/cas*{src:ch}{tgt:en}.txt', ['zh-en', 'zh-en']), ('casia*/cas*{src:ch}{tgt:en}.txt', ['zh-en', 'zh-en']), ('dataum*/Book*{src:cn}{tgt:en}.txt', ['zh-en', 'zh-en']), ('neu*/NEU*{src:cn}{tgt:en}.txt', ['zh-en', 'zh-en']), ('*/*UNv1.0.en-zh.{src:zh}{tgt:en}', ['zh-en']), ('training/*news-commentary-v12.{src}-{tgt}.{lang}', ['zh-en']), ('*/*europarl-v8.{src}-{tgt}.{lang}', ['fi-en', 'lv-en']), ('wiki/fi-en/titles.{src}-{tgt}.{lang}', ['fi-en']), ('rapid2016.{tgt}-{src}.{lang}', ['fi-en', 'lv-en']), ('*/leta.{lang}', ['lv-en']), ('*/dcep.{lang}', ['lv-en']), ('*/farewell.{lang}', ['lv-en']), ('bitext.{lang}', ['tr-en'])], valid_files_patterns=[('dev/newsdev2017*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['fi-en', 'lv-en', 'tr-en', 'zh-en', 'en-fi', 'en-lv', 'en-tr', 'en-zh']), ('dev/newstest2016*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['fi-en', 'tr-en', 'en-fi', 'en-tr'])], test_files_patterns=[('test/newstest2017-{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['fi-en', 'lv-en', 'tr-en', 'en-fi', 'en-lv', 'en-tr']), ('newstest2017-{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['zh-en', 'en-zh'])])
czeng_instruction = 'download instruction at: http://ufal.mff.cuni.cz/czeng/czeng16'
wmt18_cs_et_en_manual_downloads = []
wmt18_cs_et_en = DLDataset(name='wmt18_cs_et_en', train_urls=['http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz', 'http://data.statmt.org/wmt18/translation-task/training-parallel-ep-v8.tgz', 'https://s3.amazonaws.com/web-language-models/paracrawl/release1/paracrawl-release1.en-cs.zipporah0-dedup-clean.tgz', 'https://s3.amazonaws.com/web-language-models/paracrawl/release1/paracrawl-release1.en-et.zipporah0-dedup-clean.tgz', 'http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz', 'http://data.statmt.org/wmt18/translation-task/training-parallel-nc-v13.tgz', ('http://data.statmt.org/wmt18/translation-task/rapid2016.tgz', 'wmt18_rapid2016.tgz')], valid_urls=[('http://data.statmt.org/wmt18/translation-task/dev.tgz', 'wmt18_dev.tgz')], test_urls=[('http://data.statmt.org/wmt18/translation-task/test.tgz', 'wmt18_test.tgz')], train_files_patterns=[('*/*europarl-v8.{src}-{tgt}.{lang}', ['et-en']), ('*paracrawl-release1.{tgt}-{src}.zipporah0-dedup-clean.{lang}', ['et-en']), ('rapid2016.{tgt}-{src}.{lang}', ['et-en'])], valid_files_patterns=[('dev/newsdev2018*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['et-en'])], test_files_patterns=[('test/newstest2018-{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['et-en'])])
ru_en_yandex_instruction = 'Yandex Corpus download instruction at: https://translate.yandex.ru/corpus?lang=en'
wmt19_ru_gu_kk_lt_manual_downloads = [(('https://translate.yandex.ru/corpus?lang=en', 'wmt19_1mcorpus.zip'), ru_en_yandex_instruction)]
wmt19_ru_gu_kk_lt = DLDataset(name='wmt19_ru_gu_kk_lt', train_urls=['http://www.statmt.org/europarl/v9/training/europarl-v9.lt-en.tsv.gz', 'https://s3.amazonaws.com/web-language-models/paracrawl/release3/en-lt.bicleaner07.tmx.gz', 'https://s3.amazonaws.com/web-language-models/paracrawl/release1/paracrawl-release1.en-ru.zipporah0-dedup-clean.tgz', 'http://www.statmt.org/wmt13/training-parallel-commoncrawl.tgz', 'http://data.statmt.org/news-commentary/v14/training/news-commentary-v14-wmt19.en-kk.tsv.gz', 'http://data.statmt.org/news-commentary/v14/training/news-commentary-v14.en-ru.tsv.gz', 'http://data.statmt.org/wikititles/v1/wikititles-v1.kk-en.tsv.gz', 'http://data.statmt.org/wikititles/v1/wikititles-v1.ru-en.tsv.gz', 'http://data.statmt.org/wikititles/v1/wikititles-v1.kk-en.tsv.gz', 'http://data.statmt.org/wikititles/v1/wikititles-v1.lt-en.tsv.gz', 'http://data.statmt.org/wikititles/v1/wikititles-v1.gu-en.tsv.gz', (('https://stuncorpusprod.blob.core.windows.net/corpusfiles/UNv1.0.en-ru.tar.gz.00', 'https://stuncorpusprod.blob.core.windows.net/corpusfiles/UNv1.0.en-ru.tar.gz.01', 'https://stuncorpusprod.blob.core.windows.net/corpusfiles/UNv1.0.en-ru.tar.gz.02'), 'wmt19_UNv1.0.en-ru.tar.gz'), 'https://tilde-model.s3-eu-west-1.amazonaws.com/rapid2016.en-lt.tmx.zip', ('https://translate.yandex.ru/corpus?lang=en', 'wmt19_1mcorpus.zip')], valid_urls=[('http://data.statmt.org/wmt19/translation-task/dev.tgz', 'wmt19_dev.tgz')], test_urls=[('http://data.statmt.org/wmt19/translation-task/test.tgz', 'wmt19_test.tgz')], train_files_patterns=[('*europarl-v9.{src}-{tgt}.tsv.{lang}', ['lt-en']), ('*paracrawl-release1.{tgt}-{src}.zipporah0-dedup-clean.{lang}', ['ru-en']), ('bitext.{lang}', ['lt-en']), ('*commoncrawl.{src}-{tgt}.{lang}', ['ru-en']), ('*news-commentary-v14-wmt19.{tgt}-{src}.tsv.{lang}', ['kk-en']), ('*news-commentary-v14.{tgt}-{src}.tsv.{lang}', ['ru-en']), ('corpus.{tgt}_{src}.1m.{lang}', ['ru-en']), ('wikititles_v1_wikititles-v1.{src}-{tgt}.tsv.{lang}', ['ru-en', 'kk-en', 'lt-en', 'gu-en']), ('*/UNv1.0.{tgt}-{src}.{lang}', ['ru-en']), ('bitext.{lang}', ['lt-en'])], valid_files_patterns=[('dev/newsdev2019*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['gu-en', 'kk-en', 'lt-en']), ('dev/newstest2018*{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['ru-en'])], test_files_patterns=[('sgm/newstest2019-{src}{tgt}-{src:src}{tgt:ref}.{lang}', ['ru-en', 'gu-en', 'kk-en', 'lt-en', 'en-ru', 'en-gu', 'en-kk', 'en-lt'])])
if __name__ == '__main__':
    dl_folder = f'{to_data_path}/downloads'
    extract_folder = f'{to_data_path}/extracted'
    urls = [url for dataset in [wmt13_es_en, wmt14_de_fr_en, wmt16_ro_en, wmt18_cs_et_en, wmt19_ru_gu_kk_lt] for urls in [dataset.train_urls, dataset.valid_urls, dataset.test_urls] for url in urls]
    urls = set(urls)
    download_multi(dl_folder, extract_folder, urls, num_processes=8, debug=True)
    to_manually_download_urls = wmt17_fi_lv_tr_zh_en_manual_downloads + wmt18_cs_et_en_manual_downloads + wmt19_ru_gu_kk_lt_manual_downloads
    to_be_manually_dowloaded = check_need_manual_downalod(dl_folder, to_manually_download_urls)
    ...
    work_on_wmt(['es_XX-en_XX'], wmt13_es_en)
    work_on_wmt(['fr_XX-en_XX', 'en_XX-fr_XX'], wmt14_de_fr_en)
    work_on_wmt(['ro_RO-en_XX', 'en_XX-ro_XX'], wmt16_ro_en)
    work_on_wmt(['lv_LV-en_XX', 'fi_FI-en_XX', 'tr_TR-en_XX', 'en_XX-lv_LV', 'en_XX-fi_FI', 'en_XX-tr_TR'], wmt17_fi_lv_tr_zh_en)
    work_on_wmt(['et_EE-en_XX'], wmt18_cs_et_en)
    work_on_wmt(['gu_IN-en_XX', 'kk_KZ-en_XX', 'lt_LT-en_XX', 'en_XX-gu_IN', 'en_XX-kk_KZ', 'en_XX-lt_LT'], wmt19_ru_gu_kk_lt)
    not_matching = check_wmt_test_bleu(f'{to_data_path}/raw', [('wmt13', ['es_XX-en_XX']), ('wmt14/full', ['fr_XX-en_XX']), ('wmt16', ['ro_RO-en_XX']), ('wmt17', ['lv_LV-en_XX', 'fi_FI-en_XX', 'tr_TR-en_XX']), ('wmt18', ['cs_CZ-en_XX', 'et_EE-en_XX']), ('wmt19', ['gu_IN-en_XX', 'kk_KZ-en_XX', 'lt_LT-en_XX'])])
