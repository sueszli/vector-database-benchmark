...
class DWIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.dw.com/en/intelligent-light/av-19112290', 'md5': 'fb9dfd9520811d3ece80f04befd73428', 'info_dict': {'id': '19112290', 'ext': 'mp4', 'title': 'Intelligent light', 'description': 'md5:90e00d5881719f2a6a5827cb74985af1', 'upload_date': '20160605'}}, {'url': 'http://www.dw.com/en/worldlink-my-business/av-19111941', 'md5': '2814c9a1321c3a51f8a7aeb067a360dd', 'info_dict': {'id': '19111941', 'ext': 'mp3', 'title': 'WorldLink: My business', 'description': 'md5:bc9ca6e4e063361e21c920c53af12405', 'upload_date': '20160311'}}, {'url': 'http://www.dw.com/en/documentaries-welcome-to-the-90s-2016-05-21/e-19220158-9798', 'md5': '56b6214ef463bfb9a3b71aeb886f3cf1', 'info_dict': {'id': '19274438', 'ext': 'mp4', 'title': 'Welcome to the 90s – Hip Hop', 'description': 'Welcome to the 90s - The Golden Decade of Hip Hop', 'upload_date': '20160521'}, 'skip': 'Video removed'}]
...
class DWArticleIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.dw.com/en/no-hope-limited-options-for-refugees-in-idomeni/a-19111009', 'md5': '8ca657f9d068bbef74d6fc38b97fc869', 'info_dict': {'id': '19105868', 'ext': 'mp4', 'title': 'The harsh life of refugees in Idomeni', 'description': 'md5:196015cc7e48ebf474db9399420043c7', 'upload_date': '20160310'}}
