...
class CodersTest(unittest.TestCase):
    test_values_deterministic: List[Any] = [None, 1, -1, 1.5, b'str\x00str', 'unicode\x00ā', (), (1, 2, 3), [], [1, 2, 3], True, False]
    test_values = test_values_deterministic + [{}, {'a': 'b'}, {0: {}, 1: len}, set(), {'a', 'b'}, len]
