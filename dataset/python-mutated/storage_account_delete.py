...
def main():
    ...
    response = client.storage_accounts.begin_delete(device_name='testedgedevice', storage_account_name='storageaccount1', resource_group_name='GroupForEdgeAutomation').result()
    print(response)
