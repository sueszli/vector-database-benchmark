...
from ssshare.shadowsocks.obfsplugin import plain
from ssshare.shadowsocks.common import to_bytes, to_str, ord
from ssshare.shadowsocks import lru_cache

def create_tls_ticket_auth_obfs(method):
    if False:
        return 10
    return tls_ticket_auth(method)
obfs_map = {'tls1.2_ticket_auth': (create_tls_ticket_auth_obfs,), 'tls1.2_ticket_auth_compatible': (create_tls_ticket_auth_obfs,), 'tls1.2_ticket_fastauth': (create_tls_ticket_auth_obfs,), 'tls1.2_ticket_fastauth_compatible': (create_tls_ticket_auth_obfs,)}
