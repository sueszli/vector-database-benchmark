...
from localstack.aws.api.stepfunctions import DescribeExecutionOutput, ExecutionStatus, HistoryEventType, TaskFailedEventDetails
...
class StateTaskServiceSfn(StateTaskServiceCallback):
    _SUPPORTED_API_PARAM_BINDINGS: Final[dict[str, set[str]]] = {'startexecution': {'Input', 'Name', 'StateMachineArn'}}
    _SFN_TO_BOTO_PARAM_NORMALISERS = {'startexecution': {'Input': 'input', 'Name': 'name', 'StateMachineArn': 'stateMachineArn'}}
    _BOTO_TO_SFN_RESPONSE_BINDINGS = {'startexecution': ['StartDate', 'ExecutionArn'], 'describeexecution': ['ExecutionArn', 'Input', ['InputDetails', ['Included']], 'Name', 'Output', ['OutputDetails', ['Included']], 'StartDate', 'StateMachineArn', 'Status', 'StopDate', 'Error', 'Cause']}
