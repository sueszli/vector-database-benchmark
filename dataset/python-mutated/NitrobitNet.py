...
class NitrobitNet(SimpleDownloader):
    ...
    __version__ = '0.02'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?nitrobit.net/(?:view|watch)/(?P<ID>\\w+)'
    ...
    LOGIN_PREMIUM = True
    URL_REPLACEMENTS = [(__pattern__ + '.*', 'http://www.nitrobit.net/view/\\g<ID>')]
    NAME_PATTERN = '<b>שם הקובץ: </b><span title="(?P<N>.+?)"'
    SIZE_PATTERN = '<b>גודל הקובץ: </b><span dir="ltr" style="text-align: left;">(?P<S>[\\d.,]+) (?P<U>[\\w^_]+)</span>'
    DL_LIMIT_PATTERN = 'daily downloadlimit reached|הורדת קובץ זה תעבור על המכסה היומית'
