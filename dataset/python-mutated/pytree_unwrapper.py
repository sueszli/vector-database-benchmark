...
def UnwrapPyTree(tree):
    ...
    return llines
_WHITESPACE_TOKENS = frozenset([grammar_token.NEWLINE, grammar_token.DEDENT, grammar_token.INDENT, grammar_token.ENDMARKER])
...
class PyTreeUnwrapper(pytree_visitor.PyTreeVisitor):
  ...
  """
    ...
    _STMT_TYPES = frozenset({'if_stmt', 'while_stmt', 'for_stmt', 'try_stmt', 'expect_clause', 'with_stmt', 'match_stmt', 'case_block', 'funcdef', 'classdef'})
