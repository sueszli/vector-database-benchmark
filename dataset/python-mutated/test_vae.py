...
@testing.parameterize(*testing.product({'wrap_m': [True, False], 'wrap_v': [True, False], 'reduce': ['no', 'sum', 'mean']}))
...
@testing.parameterize(*testing.product({'wrap_x': [True, False], 'wrap_y': [True, False], 'reduce': ['no', 'sum', 'mean']}))
...
@testing.parameterize(*testing.product({'wrap_x': [True, False], 'wrap_m': [True, False], 'wrap_v': [True, False], 'reduce': ['no', 'sum', 'mean']}))
