...
def main():
    ...
    response = client.farm_beats_models.create_or_update(resource_group_name='examples-rg', farm_beats_resource_name='examples-farmbeatsResourceName', body={'location': 'eastus2', 'tags': {'key1': 'value1', 'key2': 'value2'}})
    print(response)
