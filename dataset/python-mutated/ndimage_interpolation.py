...
try:
    from scipy.ndimage import geometric_transform, affine_transform, rotate, zoom, shift, map_coordinates
except ImportError:
    pass
...
class NdimageInterpolation(Benchmark):
    ...
    params = [[(64, 64), (512, 512), (2048, 2048), (16, 16, 16), (128, 128, 128)], [0, 1, 3, 5], ['mirror', 'constant']]
