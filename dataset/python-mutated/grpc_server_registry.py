...
from dagster._core.host_representation.origin import CodeLocationOrigin, ManagedGrpcPythonEnvCodeLocationOrigin
...
class GrpcServerEndpoint(NamedTuple('_GrpcServerEndpoint', [('server_id', str), ('host', str), ('port', Optional[int]), ('socket', Optional[str])])):
