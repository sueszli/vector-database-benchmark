...
class ListAudienceListsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    audience_lists: MutableSequence['AudienceList'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AudienceList')
    next_page_token: str = proto.Field(proto.STRING, number=2, optional=True)
...
class CreateAudienceListRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    audience_list: 'AudienceList' = proto.Field(proto.MESSAGE, number=2, message='AudienceList')

class AudienceList(proto.Message):
    """An audience list is a list of users in an audience at the
    ...
    class State(proto.Enum):
        ...
        FAILED = 3
    name: str = proto.Field(proto.STRING, number=1)
    audience: str = proto.Field(proto.STRING, number=2)
    audience_display_name: str = proto.Field(proto.STRING, number=3)
    dimensions: MutableSequence['AudienceDimension'] = proto.RepeatedField(proto.MESSAGE, number=4, message='AudienceDimension')
    state: State = proto.Field(proto.ENUM, number=5, optional=True, enum=State)
    begin_creating_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, optional=True, message=timestamp_pb2.Timestamp)
    creation_quota_tokens_charged: int = proto.Field(proto.INT32, number=7)
    row_count: int = proto.Field(proto.INT32, number=8, optional=True)
...
class QueryAudienceListRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    offset: int = proto.Field(proto.INT64, number=2)
    limit: int = proto.Field(proto.INT64, number=3)
...
class QueryAudienceListResponse(proto.Message):
    ...
    Attributes:
        ...
        row_count (int):
            ...
            This field is a member of `oneof`_ ``_row_count``.
    """
    audience_list: 'AudienceList' = proto.Field(proto.MESSAGE, number=1, optional=True, message='AudienceList')
    audience_rows: MutableSequence['AudienceRow'] = proto.RepeatedField(proto.MESSAGE, number=2, message='AudienceRow')
    row_count: int = proto.Field(proto.INT32, number=3, optional=True)

class SheetExportAudienceListRequest(proto.Message):
    """A request to export users in an audience list to a Google
    Sheet.
...
class SheetExportAudienceListResponse(proto.Message):
    """The created Google Sheet with the list of users in an
    audience list.
    ...
    Attributes:
        ...
        audience_list (google.analytics.data_v1alpha.types.AudienceList):
            ...
            This field is a member of `oneof`_ ``_audience_list``.
    """
    spreadsheet_uri: str = proto.Field(proto.STRING, number=1, optional=True)
    spreadsheet_id: str = proto.Field(proto.STRING, number=2, optional=True)
    row_count: int = proto.Field(proto.INT32, number=3, optional=True)
    audience_list: 'AudienceList' = proto.Field(proto.MESSAGE, number=4, optional=True, message='AudienceList')
...
class AudienceRow(proto.Message):
    ...
    """
    dimension_values: MutableSequence['AudienceDimensionValue'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AudienceDimensionValue')

class AudienceDimension(proto.Message):
    """An audience dimension is a user attribute. Specific user attributed
    ...
    """
    dimension_name: str = proto.Field(proto.STRING, number=1)
...
class AudienceDimensionValue(proto.Message):
    ...
    """
    value: str = proto.Field(proto.STRING, number=1, oneof='one_value')
...
class RunFunnelReportRequest(proto.Message):
    ...
    class FunnelVisualizationType(proto.Enum):
        """Controls the dimensions present in the funnel visualization
        sub report response.
    ...
    date_ranges: MutableSequence[data.DateRange] = proto.RepeatedField(proto.MESSAGE, number=2, message=data.DateRange)
    funnel: data.Funnel = proto.Field(proto.MESSAGE, number=3, message=data.Funnel)
    funnel_breakdown: data.FunnelBreakdown = proto.Field(proto.MESSAGE, number=4, message=data.FunnelBreakdown)
    funnel_next_action: data.FunnelNextAction = proto.Field(proto.MESSAGE, number=5, message=data.FunnelNextAction)
    funnel_visualization_type: FunnelVisualizationType = proto.Field(proto.ENUM, number=6, enum=FunnelVisualizationType)
    segments: MutableSequence[data.Segment] = proto.RepeatedField(proto.MESSAGE, number=7, message=data.Segment)
    limit: int = proto.Field(proto.INT64, number=9)
    dimension_filter: data.FilterExpression = proto.Field(proto.MESSAGE, number=10, message=data.FilterExpression)
    return_property_quota: bool = proto.Field(proto.BOOL, number=12)

class RunFunnelReportResponse(proto.Message):
    """The funnel report response contains two sub reports. The two
    ...
    """
    funnel_table: data.FunnelSubReport = proto.Field(proto.MESSAGE, number=1, message=data.FunnelSubReport)
    funnel_visualization: data.FunnelSubReport = proto.Field(proto.MESSAGE, number=2, message=data.FunnelSubReport)
    property_quota: data.PropertyQuota = proto.Field(proto.MESSAGE, number=3, message=data.PropertyQuota)
    kind: str = proto.Field(proto.STRING, number=4)
