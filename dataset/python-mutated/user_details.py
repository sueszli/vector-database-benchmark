...
class UserOptionsSerializer(serializers.Serializer):
    ...
    stacktraceOrder = serializers.ChoiceField(choices=(('-1', _('Default (let Sentry decide)')), ('1', _('Most recent call last')), ('2', _('Most recent call first'))), required=False)
    ...
    theme = serializers.ChoiceField(choices=(('light', _('Light')), ('dark', _('Dark')), ('system', _('Default to system'))), required=False)
    defaultIssueEvent = serializers.ChoiceField(choices=(('recommended', _('Recommended')), ('latest', _('Latest')), ('oldest', _('Oldest'))), required=False)
