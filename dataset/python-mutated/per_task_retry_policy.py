...
You can run this example like this:
    ...
    .. code:: console
            ...
            $ luigi --module examples.per_task_retry_policy examples.PerTaskRetryPolicy --worker-keep-alive             --local-scheduler --scheduler-retry-delay 5  --logging-conf-file test/testconfig/logging.cfg
