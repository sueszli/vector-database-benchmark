...
FIXTURES_1 = {'runners': ['testrunner1.yaml', 'testrunner2.yaml'], 'actions': ['action1.yaml', 'a2.yaml', 'a2_default_value.yaml'], 'triggertypes': ['triggertype1.yaml'], 'triggers': ['trigger1.yaml'], 'traces': ['trace_for_test_enforce.yaml', 'trace_for_test_enforce_2.yaml', 'trace_for_test_enforce_3.yaml']}
FIXTURES_2 = {'rules': ['rule1.yaml', 'rule2.yaml', 'rule_use_none_filter.yaml', 'rule_none_no_use_none_filter.yaml', 'rule_action_default_value.yaml', 'rule_action_default_value_overridden.yaml', 'rule_action_default_value_render_fail.yaml']}
...
MOCK_TRIGGER_INSTANCE_PAYLOAD = {'k1': 'v1', 'k2': 'v2', 'k3': 3, 'k4': True, 'k5': {'foo': 'bar'}, 'k6': [1, 3]}
