...
from airflow.providers.google.cloud.operators.cloud_composer import CloudComposerCreateEnvironmentOperator, CloudComposerDeleteEnvironmentOperator, CloudComposerGetEnvironmentOperator, CloudComposerListEnvironmentsOperator, CloudComposerListImageVersionsOperator, CloudComposerUpdateEnvironmentOperator
...
TEST_ENVIRONMENT = {'name': TEST_ENVIRONMENT_ID, 'config': {'node_count': 3, 'software_config': {'image_version': 'composer-1.17.7-airflow-2.1.4'}}}
TEST_UPDATE_MASK = {'paths': ['labels.label1']}
TEST_UPDATED_ENVIRONMENT = {'labels': {'label1': 'testing'}}
TEST_RETRY = DEFAULT
TEST_TIMEOUT = None
