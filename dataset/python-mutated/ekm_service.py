...
class ListEkmConnectionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    ekm_connections: MutableSequence['EkmConnection'] = proto.RepeatedField(proto.MESSAGE, number=1, message='EkmConnection')
...
class CreateEkmConnectionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    ekm_connection_id: str = proto.Field(proto.STRING, number=2)
    ekm_connection: 'EkmConnection' = proto.Field(proto.MESSAGE, number=3, message='EkmConnection')
...
class UpdateEkmConnectionRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            this request.
    """
    ekm_connection: 'EkmConnection' = proto.Field(proto.MESSAGE, number=1, message='EkmConnection')
...
class UpdateEkmConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            this request.
    """
    ekm_config: 'EkmConfig' = proto.Field(proto.MESSAGE, number=1, message='EkmConfig')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class Certificate(proto.Message):
    ...
    Attributes:
        ...
        sha256_fingerprint (str):
            ...
            [parsed][google.cloud.kms.v1.Certificate.parsed] is true.
    """
    raw_der: bytes = proto.Field(proto.BYTES, number=1)
    parsed: bool = proto.Field(proto.BOOL, number=2)
    issuer: str = proto.Field(proto.STRING, number=3)
    subject: str = proto.Field(proto.STRING, number=4)
    subject_alternative_dns_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    not_before_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    not_after_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    serial_number: str = proto.Field(proto.STRING, number=8)
    sha256_fingerprint: str = proto.Field(proto.STRING, number=9)
...
class EkmConnection(proto.Message):
    ...
    class ServiceResolver(proto.Message):
        ...
        """
        service_directory_service: str = proto.Field(proto.STRING, number=1)
        endpoint_filter: str = proto.Field(proto.STRING, number=2)
        hostname: str = proto.Field(proto.STRING, number=3)
        server_certificates: MutableSequence['Certificate'] = proto.RepeatedField(proto.MESSAGE, number=4, message='Certificate')
    name: str = proto.Field(proto.STRING, number=1)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    service_resolvers: MutableSequence[ServiceResolver] = proto.RepeatedField(proto.MESSAGE, number=3, message=ServiceResolver)
    etag: str = proto.Field(proto.STRING, number=5)
    key_management_mode: KeyManagementMode = proto.Field(proto.ENUM, number=6, enum=KeyManagementMode)
    crypto_space_path: str = proto.Field(proto.STRING, number=7)

class EkmConfig(proto.Message):
    """An [EkmConfig][google.cloud.kms.v1.EkmConfig] is a singleton
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    default_ekm_connection: str = proto.Field(proto.STRING, number=2)
