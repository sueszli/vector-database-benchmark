...
FAIL_ON_WINDOWS = pytest.mark.xfail(sys.platform == 'win32', raises=(SpecTokenizationError, spack.spec.InvalidHashError), reason='Unix style path on Windows')
FAIL_ON_UNIX = pytest.mark.xfail(sys.platform != 'win32', raises=SpecTokenizationError, reason='Windows style path on Unix')
