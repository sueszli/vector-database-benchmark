...
from sympy.polys.numberfields.minpoly import minimal_polynomial, _choose_factor, _minpoly_op_algebraic_element, _separate_sq, _minpoly_groebner
...
def test_minimal_polynomial():
    ...
    ex = sqrt(5) * sqrt(I) / (5 * sqrt(1 + 125 * I)) + 25 * sqrt(5) / (I ** Q(5, 2) * (1 + 125 * I) ** Q(3, 2)) + 3125 * sqrt(5) / (I ** Q(11, 2) * (1 + 125 * I) ** Q(3, 2)) + 5 * I * sqrt(1 - I / 125)
    ...
    assert minimal_polynomial(TribonacciConstant, x, domain=QQ.algebraic_field(cbrt(19 - 3 * sqrt(33)))) == 48 * x - 19 * (19 - 3 * sqrt(33)) ** Rational(2, 3) - 3 * sqrt(33) * (19 - 3 * sqrt(33)) ** Rational(2, 3) - 16 * (19 - 3 * sqrt(33)) ** Rational(1, 3) - 16
...
def test_minpoly_fraction_field_slow():
    if False:
        while True:
            i = 10
    assert minimal_polynomial(minimal_polynomial(sqrt(x ** Rational(1, 5) - 1), y).subs(y, sqrt(x ** Rational(1, 5) - 1)), z) == z
