...
import proto
__protobuf__ = proto.module(package='google.cloud.ids.v1', manifest={'Endpoint', 'ListEndpointsRequest', 'ListEndpointsResponse', 'GetEndpointRequest', 'CreateEndpointRequest', 'DeleteEndpointRequest', 'OperationMetadata'})
...
class Endpoint(proto.Message):
    ...
    endpoint_forwarding_rule: str = proto.Field(proto.STRING, number=6)
    endpoint_ip: str = proto.Field(proto.STRING, number=7)
    description: str = proto.Field(proto.STRING, number=8)
    severity: Severity = proto.Field(proto.ENUM, number=9, enum=Severity)
    state: State = proto.Field(proto.ENUM, number=12, enum=State)
    traffic_logs: bool = proto.Field(proto.BOOL, number=13)
...
class ListEndpointsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    endpoints: MutableSequence['Endpoint'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Endpoint')
...
class CreateEndpointRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    endpoint_id: str = proto.Field(proto.STRING, number=2)
    endpoint: 'Endpoint' = proto.Field(proto.MESSAGE, number=3, message='Endpoint')
