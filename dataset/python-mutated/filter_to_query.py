...
from posthog.schema import ActionsNode, BreakdownFilter, ChartDisplayType, DateRange, EventsNode, FunnelExclusion, FunnelsFilter, FunnelsQuery, LifecycleFilter, LifecycleQuery, PathsFilter, PathsQuery, PropertyGroupFilter, RetentionFilter, RetentionQuery, StickinessFilter, StickinessQuery, TrendsFilter, TrendsQuery
...
insight_to_query_type = {'TRENDS': TrendsQuery, 'FUNNELS': FunnelsQuery, 'RETENTION': RetentionQuery, 'PATHS': PathsQuery, 'LIFECYCLE': LifecycleQuery, 'STICKINESS': StickinessQuery}
