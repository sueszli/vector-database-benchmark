...
ops_modules = {'nvidia.dali.ops': nvidia.dali.ops, 'nvidia.dali.plugin.numba.experimental': nvidia.dali.plugin.numba.experimental}
exclude_ops_members = {'nvidia.dali.ops': ['PythonFunctionBase']}
fn_modules = {'nvidia.dali.fn': nvidia.dali.fn, 'nvidia.dali.plugin.pytorch.fn': nvidia.dali.plugin.pytorch.fn, 'nvidia.dali.plugin.numba.fn.experimental': nvidia.dali.plugin.numba.fn.experimental}
exclude_fn_members = {}
mod_aditional_doc = {'nvidia.dali.fn.transforms': 'All operators in this module support only CPU device as they are meant ' + 'to be provided as an input to named keyword operator arguments. Check for more details the relevant ' + ':ref:`pipeline documentation section<Processing Graph Structure>`.'}
