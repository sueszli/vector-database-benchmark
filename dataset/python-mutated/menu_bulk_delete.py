...
class MenuBulkDelete(ModelBulkDeleteMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of menu IDs to delete.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.MENU_DELETED, description='A menu was deleted.')]
