...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0325_alter_realmplayground_unique_together')]
    operations = [migrations.RunPython(delete_re2_invalid, reverse_code=migrations.RunPython.noop, elidable=True)]