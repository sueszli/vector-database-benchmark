...
import asyncio
import logging
from homeassistant.components.vacuum import ATTR_STATUS, STATE_CLEANING, STATE_DOCKED, STATE_ERROR, STATE_RETURNING, StateVacuumEntity, VacuumEntityFeature
...
SUPPORT_IROBOT = VacuumEntityFeature.BATTERY | VacuumEntityFeature.PAUSE | VacuumEntityFeature.RETURN_HOME | VacuumEntityFeature.SEND_COMMAND | VacuumEntityFeature.START | VacuumEntityFeature.STATE | VacuumEntityFeature.STOP | VacuumEntityFeature.LOCATE
STATE_MAP = {'': STATE_IDLE, 'charge': STATE_DOCKED, 'evac': STATE_RETURNING, 'hmMidMsn': STATE_CLEANING, 'hmPostMsn': STATE_RETURNING, 'hmUsrDock': STATE_RETURNING, 'pause': STATE_PAUSED, 'run': STATE_CLEANING, 'stop': STATE_IDLE, 'stuck': STATE_ERROR}
...
class IRobotVacuum(IRobotEntity, StateVacuumEntity):
    ...
    async def async_send_command(self, command, params=None, **kwargs):
        ...
        await self.hass.async_add_executor_job(self.vacuum.send_command, command, params)