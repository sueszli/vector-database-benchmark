...
class OldContributorDashboardRedirectPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class OldCreatorDashboardRedirectPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class CreatorDashboardPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class CreatorDashboardHandler(base.BaseHandler[CreatorDashboardHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Provides data for the user's creator dashboard page."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'POST': {'display_preference': {'schema': {'type': 'basestring', 'choices': constants.ALLOWED_CREATOR_DASHBOARD_DISPLAY_PREFS.values()}}}}
...
class NewExplorationHandler(base.BaseHandler[NewExplorationHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Creates a new exploration."""
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'title': {'schema': {'type': 'basestring'}, 'default_value': feconf.DEFAULT_EXPLORATION_TITLE}}}
...
class UploadExplorationHandler(base.BaseHandler[Dict[str, str], UploadExplorationHandlerNormalizedRequestDict]):
    """Uploads a new exploration."""
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'yaml_file': {'schema': {'type': 'basestring'}}}}
