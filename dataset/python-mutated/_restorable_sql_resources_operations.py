...
def build_list_request(location: str, instance_id: str, subscription_id: str, *, restore_location: Optional[str]=None, restore_timestamp_in_utc: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableSqlResources')
...
class RestorableSqlResourcesOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, restore_location: Optional[str]=None, restore_timestamp_in_utc: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableSqlResourcesGetResult']:
        if False:
            for i in range(10):
                print('nop')
