...
try:
    ...
    from PyQt5.QtWidgets import QApplication, QSlider, QWidget, QVBoxLayout, QPlainTextEdit, QHBoxLayout, QGroupBox
except ImportError:
    from PySide2.QtCore import Signal as pyqtSignal, QTimer, Qt
    from PySide2.QtWidgets import QApplication, QSlider, QWidget, QVBoxLayout, QPlainTextEdit, QHBoxLayout, QGroupBox
