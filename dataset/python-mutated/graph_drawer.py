...
try:
    ...
    HAS_PYDOT = False
_COLOR_MAP = {'placeholder': '"AliceBlue"', 'call_module': 'LemonChiffon1', 'get_param': 'Yellow2', 'get_attr': 'LightGrey', 'output': 'PowderBlue'}
_HASH_COLOR_MAP = ['CadetBlue1', 'Coral', 'DarkOliveGreen1', 'DarkSeaGreen1', 'GhostWhite', 'Khaki1', 'LavenderBlush1', 'LightSkyBlue', 'MistyRose1', 'MistyRose2', 'PaleTurquoise2', 'PeachPuff1', 'Salmon', 'Thistle1', 'Thistle3', 'Wheat1']
_WEIGHT_TEMPLATE = {'shape': 'record', 'fillcolor': 'Salmon', 'style': '"filled,rounded"', 'fontcolor': '#000000'}
if HAS_PYDOT:
