...
__all__ = ['PytorchModelHandlerTensor', 'PytorchModelHandlerKeyedTensor']
TensorInferenceFn = Callable[[Sequence[torch.Tensor], torch.nn.Module, torch.device, Optional[Dict[str, Any]], Optional[str]], Iterable[PredictionResult]]
KeyedTensorInferenceFn = Callable[[Sequence[Dict[str, torch.Tensor]], torch.nn.Module, torch.device, Optional[Dict[str, Any]], Optional[str]], Iterable[PredictionResult]]
...
class PytorchModelHandlerKeyedTensor(ModelHandler[Dict[str, torch.Tensor], PredictionResult, torch.nn.Module]):
