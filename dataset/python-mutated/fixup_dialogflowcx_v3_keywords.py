...
class dialogflowcxCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'batch_delete_test_cases': ('parent', 'names'), 'batch_run_test_cases': ('parent', 'test_cases', 'environment'), 'calculate_coverage': ('agent', 'type_'), 'compare_versions': ('base_version', 'target_version', 'language_code'), 'create_agent': ('parent', 'agent'), 'create_entity_type': ('parent', 'entity_type', 'language_code'), 'create_environment': ('parent', 'environment'), 'create_experiment': ('parent', 'experiment'), 'create_flow': ('parent', 'flow', 'language_code'), 'create_intent': ('parent', 'intent', 'language_code'), 'create_page': ('parent', 'page', 'language_code'), 'create_security_settings': ('parent', 'security_settings'), 'create_session_entity_type': ('parent', 'session_entity_type'), 'create_test_case': ('parent', 'test_case'), 'create_transition_route_group': ('parent', 'transition_route_group', 'language_code'), 'create_version': ('parent', 'version'), 'create_webhook': ('parent', 'webhook'), 'delete_agent': ('name',), 'delete_entity_type': ('name', 'force'), 'delete_environment': ('name',), 'delete_experiment': ('name',), 'delete_flow': ('name', 'force'), 'delete_intent': ('name',), 'delete_page': ('name', 'force'), 'delete_security_settings': ('name',), 'delete_session_entity_type': ('name',), 'delete_transition_route_group': ('name', 'force'), 'delete_version': ('name',), 'delete_webhook': ('name', 'force'), 'deploy_flow': ('environment', 'flow_version'), 'detect_intent': ('session', 'query_input', 'query_params', 'output_audio_config'), 'export_agent': ('name', 'agent_uri', 'data_format', 'environment', 'git_destination', 'include_bigquery_export_settings'), 'export_flow': ('name', 'flow_uri', 'include_referenced_flows'), 'export_intents': ('parent', 'intents', 'intents_uri', 'intents_content_inline', 'data_format'), 'export_test_cases': ('parent', 'gcs_uri', 'data_format', 'filter'), 'fulfill_intent': ('match_intent_request', 'match', 'output_audio_config'), 'get_agent': ('name',), 'get_agent_validation_result': ('name', 'language_code'), 'get_changelog': ('name',), 'get_deployment': ('name',), 'get_entity_type': ('name', 'language_code'), 'get_environment': ('name',), 'get_experiment': ('name',), 'get_flow': ('name', 'language_code'), 'get_flow_validation_result': ('name', 'language_code'), 'get_generative_settings': ('name', 'language_code'), 'get_intent': ('name', 'language_code'), 'get_page': ('name', 'language_code'), 'get_security_settings': ('name',), 'get_session_entity_type': ('name',), 'get_test_case': ('name',), 'get_test_case_result': ('name',), 'get_transition_route_group': ('name', 'language_code'), 'get_version': ('name',), 'get_webhook': ('name',), 'import_flow': ('parent', 'flow_uri', 'flow_content', 'import_option', 'flow_import_strategy'), 'import_intents': ('parent', 'intents_uri', 'intents_content', 'merge_option'), 'import_test_cases': ('parent', 'gcs_uri', 'content'), 'list_agents': ('parent', 'page_size', 'page_token'), 'list_changelogs': ('parent', 'filter', 'page_size', 'page_token'), 'list_continuous_test_results': ('parent', 'page_size', 'page_token'), 'list_deployments': ('parent', 'page_size', 'page_token'), 'list_entity_types': ('parent', 'language_code', 'page_size', 'page_token'), 'list_environments': ('parent', 'page_size', 'page_token'), 'list_experiments': ('parent', 'page_size', 'page_token'), 'list_flows': ('parent', 'page_size', 'page_token', 'language_code'), 'list_intents': ('parent', 'language_code', 'intent_view', 'page_size', 'page_token'), 'list_pages': ('parent', 'language_code', 'page_size', 'page_token'), 'list_security_settings': ('parent', 'page_size', 'page_token'), 'list_session_entity_types': ('parent', 'page_size', 'page_token'), 'list_test_case_results': ('parent', 'page_size', 'page_token', 'filter'), 'list_test_cases': ('parent', 'page_size', 'page_token', 'view'), 'list_transition_route_groups': ('parent', 'page_size', 'page_token', 'language_code'), 'list_versions': ('parent', 'page_size', 'page_token'), 'list_webhooks': ('parent', 'page_size', 'page_token'), 'load_version': ('name', 'allow_override_agent_resources'), 'lookup_environment_history': ('name', 'page_size', 'page_token'), 'match_intent': ('session', 'query_input', 'query_params', 'persist_parameter_changes'), 'restore_agent': ('name', 'agent_uri', 'agent_content', 'git_source', 'restore_option'), 'run_continuous_test': ('environment',), 'run_test_case': ('name', 'environment'), 'start_experiment': ('name',), 'stop_experiment': ('name',), 'streaming_detect_intent': ('query_input', 'session', 'query_params', 'output_audio_config', 'enable_partial_response', 'enable_debugging_info'), 'train_flow': ('name',), 'update_agent': ('agent', 'update_mask'), 'update_entity_type': ('entity_type', 'language_code', 'update_mask'), 'update_environment': ('environment', 'update_mask'), 'update_experiment': ('experiment', 'update_mask'), 'update_flow': ('flow', 'update_mask', 'language_code'), 'update_generative_settings': ('generative_settings', 'update_mask'), 'update_intent': ('intent', 'language_code', 'update_mask'), 'update_page': ('page', 'language_code', 'update_mask'), 'update_security_settings': ('security_settings', 'update_mask'), 'update_session_entity_type': ('session_entity_type', 'update_mask'), 'update_test_case': ('test_case', 'update_mask'), 'update_transition_route_group': ('transition_route_group', 'update_mask', 'language_code'), 'update_version': ('version', 'update_mask'), 'update_webhook': ('webhook', 'update_mask'), 'validate_agent': ('name', 'language_code'), 'validate_flow': ('name', 'language_code')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=dialogflowcxCallTransformer()):
    if False:
        while True:
            i = 10
