...
if __name__ == '__main__':
    ...
    parser.add_argument('--worker-process-setup-hook', type=str)
    args = parser.parse_args()
    if args.worker_process_setup_hook:
        ray.init(runtime_env={'worker_process_setup_hook': lambda : print(args.worker_process_setup_hook)})
    ...
    if args.conflict == 'pip':
        ...
        ray.init(runtime_env={'env_vars': {'C': '1'}})
        print(ray._private.worker.global_worker.runtime_env)