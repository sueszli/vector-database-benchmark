...
class ThemedWidget(object):
    ...
    """
    pixmap_themes = ['arc', 'blue', 'clearlooks', 'elegance', 'kroc', 'plastik', 'radiance', 'ubuntu', 'winxpblue']
    PACKAGES = {'keramik_alt': 'keramik', 'scidblue': 'scid', 'scidgreen': 'scid', 'scidgrey': 'scid', 'scidmint': 'scid', 'scidpink': 'scid', 'scidpurple': 'scid', 'scidsand': 'scid'}
    _EXCLUDED = {'scid'}
