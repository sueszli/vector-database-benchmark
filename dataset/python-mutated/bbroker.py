...
class BackBroker(bt.BrokerBase):
    ...
    """
    params = (('cash', 10000.0), ('checksubmit', True), ('eosbar', False), ('filler', None), ('slip_perc', 0.0), ('slip_fixed', 0.0), ('slip_open', False), ('slip_match', True), ('slip_limit', True), ('slip_out', False), ('coc', False), ('coo', False), ('int2pnl', True), ('shortcash', True), ('fundstartval', 100.0), ('fundmode', False))
