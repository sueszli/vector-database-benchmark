...
parser.add_argument(u'-c', u'--config', help=u'Configuration file', required=True)
SIMPLE_Q = u'SELECT id, r.extras, rr.extras revision FROM resource r JOIN resource_revision rr USING(id, revision_id) WHERE r.extras != rr.extras'
