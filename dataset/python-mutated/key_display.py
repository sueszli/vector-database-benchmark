...
class KeyDisplayApp(App):
    ...
    BINDINGS = [Binding('question_mark', 'question', 'Question'), Binding('ctrl+q', 'quit', 'Quit app'), Binding('escape', 'escape', 'Escape'), Binding('a', 'a', 'Letter A')]
    ...
    def get_key_display(self, key: str) -> str:
        if False:
            while True:
                i = 10
        key_display_replacements = {'escape': 'Escape!', 'ctrl+q': '^q'}
