...
if __name__ == '__main__':
    ...
    download_lsun(lsun_dir=args.out_dir, category=args.category, dset=args.dset, tag=args.tag, overwrite=args.overwrite)
    manifest_file = ingest_lsun(lsun_dir=args.out_dir, category=args.category, dset=args.dset, lbl_map=dict(zip(categories, range(len(categories)))), overwrite=args.overwrite, png_conv=args.png)