...
def main():
    ...
    response = client.clusters.begin_update(resource_group_name='TestGroup', cluster_name='testcluster', parameters={'properties': {'nodeStorageQuotaInMb': 2097152}}).result()
    print(response)
