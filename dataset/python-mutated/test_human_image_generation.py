...
class HumanImageGenerationTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.input = {'source_img_path': 'data/test/images/human_image_generation_source_img.jpg', 'target_pose_path': 'data/test/images/human_image_generation_target_pose.txt'}
    ...
    def test_run_modelhub(self):
        if False:
            while True:
                i = 10
        human_image_generation = pipeline(Tasks.human_image_generation, model=self.model_id, revision='v1.0.1')
