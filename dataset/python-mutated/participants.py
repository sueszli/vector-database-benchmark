...
from typing import TYPE_CHECKING, Any, Iterable, List, Mapping, MutableMapping, Optional, Sequence, Tuple, Union
...
from sentry.notifications.helpers import get_values_by_provider_by_type, should_use_notifications_v2, transform_to_notification_settings_by_recipient
from sentry.notifications.notify import notification_providers
from sentry.notifications.types import NOTIFICATION_SETTING_TYPES, ActionTargetType, FallthroughChoiceType, GroupSubscriptionReason, NotificationSettingEnum, NotificationSettingOptionValues, NotificationSettingsOptionEnum, NotificationSettingTypes
...
AVAILABLE_PROVIDERS = {ExternalProviders.EMAIL, ExternalProviders.SLACK}
