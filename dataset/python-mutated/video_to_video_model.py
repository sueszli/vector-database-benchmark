...
from modelscope.models.multi_modal.video_to_video.modules import AutoencoderKL, FrozenOpenCLIPEmbedder, Vid2VidSDUNet, get_first_stage_encoding
...
@MODELS.register_module(Tasks.video_to_video, module_name=Models.video_to_video_model)
