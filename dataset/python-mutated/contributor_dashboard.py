...
from typing import Dict, List, Optional, OrderedDict, Sequence, Tuple, TypedDict, Union
ListOfContributorDashboardStatsTypes = Sequence[Union[suggestion_registry.TranslationContributionStats, suggestion_registry.TranslationReviewStats, suggestion_registry.QuestionContributionStats, suggestion_registry.QuestionReviewStats]]
ListOfContributorDashboardStatsDictTypes = Sequence[Union[suggestion_registry.TranslationContributionStatsFrontendDict, suggestion_registry.TranslationReviewStatsFrontendDict, suggestion_registry.QuestionContributionStatsFrontendDict, suggestion_registry.QuestionReviewStatsFrontendDict]]
...
class ContributorDashboardPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class ContributionOpportunitiesHandler(base.BaseHandler[Dict[str, str], ContributionOpportunitiesHandlerNormalizedRequestDict]):
    """Provides data for opportunities available in different categories."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'opportunity_type': {'schema': {'type': 'basestring'}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'cursor': {'schema': {'type': 'basestring'}, 'default_value': None}, 'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}, 'topic_name': {'schema': {'type': 'basestring'}, 'default_value': None}}}
...
class ReviewableOpportunitiesHandler(base.BaseHandler[Dict[str, str], ReviewableOpportunitiesHandlerNormalizedRequestDict]):
    """Provides opportunities that have translation suggestions in review."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'topic_name': {'schema': {'type': 'basestring'}, 'default_value': None}, 'language_code': {'schema': {'type': 'basestring'}, 'default_value': None}}}
...
class LessonsPinningHandler(base.BaseHandler[LessonsPinningHandlerNormalizedRequestDict, Dict[str, str]]):
    """Handler for pinning & unpinning lessons."""
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'PUT': {'language_code': {'schema': {'type': 'basestring'}}, 'topic_id': {'schema': {'type': 'basestring'}}, 'opportunity_id': {'schema': {'type': 'basestring'}, 'default_value': None}}}
...
class TranslatableTextHandler(base.BaseHandler[Dict[str, str], TranslatableTextHandlerNormalizedRequestDict]):
    """Provides lessons content which can be translated in a given language."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}}, 'exp_id': {'schema': {'type': 'basestring'}}}}
...
class MachineTranslationStateTextsHandler(base.BaseHandler[Dict[str, str], MachineTranslationStateTextsHandlerNormalizedRequestDict]):
    """Provides a machine translation of exploration content."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'exp_id': {'schema': {'type': 'basestring'}}, 'state_name': {'schema': {'type': 'basestring'}}, 'content_ids': {'schema': {'type': 'basestring'}}, 'target_language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}, {'id': 'is_valid_audio_language_code'}]}}}}
...
class UserContributionRightsDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class FeaturedTranslationLanguagesHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class TranslatableTopicNamesHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class TranslationPreferenceHandler(base.BaseHandler[TranslationPreferenceHandlerNormalizedRequestDict, Dict[str, str]]):
    """Provides the preferred translation language in the
    contributor dashboard page.
    """
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'POST': {'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}}}}
...
class ContributorStatsSummariesHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    """Returns contribution statistics for the supplied contribution type."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'username': {'schema': {'type': 'basestring'}}, 'contribution_type': {'schema': {'type': 'basestring'}}, 'contribution_subtype': {'schema': {'type': 'basestring'}}}
    HANDLER_ARGS_SCHEMAS: Dict[str, Dict[str, str]] = {'GET': {}}
...
class ContributorCertificateHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    """Returns contributor certificate."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'username': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_USERNAME_LENGTH}]}}, 'suggestion_type': {'schema': {'type': 'basestring', 'choices': feconf.SUGGESTION_TYPE_CHOICES}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'from_date': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.DATE_REGEX}]}}, 'to_date': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.DATE_REGEX}]}}, 'language': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}}}
...
class ContributorAllStatsSummariesHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
