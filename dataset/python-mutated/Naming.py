...
interned_prefixes = {'str': pyrex_prefix + 'n_', 'int': pyrex_prefix + 'int_', 'float': pyrex_prefix + 'float_', 'tuple': pyrex_prefix + 'tuple_', 'codeobj': pyrex_prefix + 'codeobj_', 'slice': pyrex_prefix + 'slice_', 'ustring': pyrex_prefix + 'ustring_', 'umethod': pyrex_prefix + 'umethod_'}
...
used_types_and_macros = [(cyfunction_type_cname, '__Pyx_CyFunction_USED'), (fusedfunction_type_cname, '__Pyx_FusedFunction_USED'), ('__pyx_GeneratorType', '__Pyx_Generator_USED'), ('__pyx_IterableCoroutineType', '__Pyx_IterableCoroutine_USED'), ('__pyx_CoroutineAwaitType', '__Pyx_Coroutine_USED'), ('__pyx_CoroutineType', '__Pyx_Coroutine_USED')]