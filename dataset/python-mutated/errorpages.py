...
DEFAULT_FORMAT = 'auto'
FALLBACK_TEXT = 'The application encountered an unexpected error and could not continue.'
FALLBACK_STATUS = 500
...
MIME_BY_CONFIG = {'text': 'text/plain', 'json': 'application/json', 'html': 'text/html'}
CONFIG_BY_MIME = {v: k for (k, v) in MIME_BY_CONFIG.items()}
RENDERERS_BY_CONTENT_TYPE = {'text/plain': TextRenderer, 'application/json': JSONRenderer, 'multipart/form-data': HTMLRenderer, 'text/html': HTMLRenderer}
RESPONSE_MAPPING = {'json': 'json', 'text': 'text', 'html': 'html', 'JSONResponse': 'json', 'text/plain': 'text', 'text/html': 'html', 'application/json': 'json'}
