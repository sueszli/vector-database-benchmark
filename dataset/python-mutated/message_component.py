...
from sentry.integrations.discord.message_builder.base.component.select_menu import DiscordSelectMenu, DiscordSelectMenuOption
...
RESOLVE_DIALOG_OPTIONS = [DiscordSelectMenuOption('Immediately', 'immediately'), DiscordSelectMenuOption('In the next release', 'inNextRelease'), DiscordSelectMenuOption('In the current release', 'inCurrentRelease')]
