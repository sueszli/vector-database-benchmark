...
class RoleAssignmentsOperations:
    ...
    @distributed_trace
    def list_for_resource(self, resource_group_name: str, resource_provider_namespace: str, parent_resource_path: str, resource_type: str, resource_name: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.RoleAssignment']:
        if False:
            while True:
                i = 10
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2018-01-01-preview'))
    ...
    @distributed_trace
    def list_for_resource_group(self, resource_group_name: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.RoleAssignment']:
        if False:
            print('Hello World!')
        ...
        def prepare_request(next_link=None):
            if False:
                print('Hello World!')
            if not next_link:
                request = build_list_for_resource_group_request(resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, filter=filter, api_version=api_version, template_url=self.list_for_resource_group.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    async def delete(self, scope: str, role_assignment_name: str, **kwargs: Any) -> Optional[_models.RoleAssignment]:
        ...
        request = build_delete_request(scope=scope, role_assignment_name=role_assignment_name, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create(self, scope: str, role_assignment_name: str, parameters: _models.RoleAssignmentCreateParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignment:
    ...
    @overload
    async def create(self, scope: str, role_assignment_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignment:
        """Creates a role assignment.
    ...
    @distributed_trace_async
    async def create(self, scope: str, role_assignment_name: str, parameters: Union[_models.RoleAssignmentCreateParameters, IO], **kwargs: Any) -> _models.RoleAssignment:
        """Creates a role assignment.
        ...
        request = build_create_request(scope=scope, role_assignment_name=role_assignment_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get(self, scope: str, role_assignment_name: str, **kwargs: Any) -> _models.RoleAssignment:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2018-01-01-preview'))
        cls: ClsType[_models.RoleAssignment] = kwargs.pop('cls', None)
        request = build_get_request(scope=scope, role_assignment_name=role_assignment_name, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete_by_id(self, role_id: str, **kwargs: Any) -> Optional[_models.RoleAssignment]:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2018-01-01-preview'))
        cls: ClsType[Optional[_models.RoleAssignment]] = kwargs.pop('cls', None)
        request = build_delete_by_id_request(role_id=role_id, api_version=api_version, template_url=self.delete_by_id.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_by_id(self, role_id: str, parameters: _models.RoleAssignmentCreateParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignment:
    ...
    @overload
    async def create_by_id(self, role_id: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleAssignment:
        """Creates a role assignment by ID.
    ...
    @distributed_trace_async
    async def create_by_id(self, role_id: str, parameters: Union[_models.RoleAssignmentCreateParameters, IO], **kwargs: Any) -> _models.RoleAssignment:
        """Creates a role assignment by ID.
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, 'RoleAssignmentCreateParameters')
        request = build_create_by_id_request(role_id=role_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_by_id.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_for_scope(self, scope: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.RoleAssignment']:
        if False:
            i = 10
            return i + 15
