...
class PRoutesCommand:
    ...
    parser.add_argument('-g', '--glob', action='store', dest='glob', default='', help='Display routes matching glob pattern')
    parser.add_argument('-f', '--format', action='store', dest='format', default='', help='Choose which columns to display, this will override the format key in the [proutes] ini section')
