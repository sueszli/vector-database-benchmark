...
gym_pybullet_drones_env_info = {'takeoff-aviary-v0': {'observation_space': gym_pybullet_drones_observation_space(12, minimum=-1, maximum=1), 'action_space': gym_pybullet_drones_action_space(drone_num=1, minimum=-1, maximum=1), 'reward_space': gym_pybullet_drones_reward_space()}, 'flythrugate-aviary-v0': {'observation_space': gym_pybullet_drones_observation_space(12, minimum=-1, maximum=1), 'action_space': gym_pybullet_drones_action_space(drone_num=1, minimum=-1, maximum=1), 'reward_space': gym_pybullet_drones_reward_space()}}
action_type = {'PID': ActionType.PID, 'DYN': ActionType.DYN, 'VEL': ActionType.VEL, 'RPM': ActionType.RPM, 'TUN': ActionType.TUN, 'ONE_D_DYN': ActionType.ONE_D_DYN, 'ONE_D_PID': ActionType.ONE_D_PID, 'ONE_D_RPM': ActionType.ONE_D_RPM}
...
class GymPybulletDronesEnv(BaseEnv):
    ...
    def default_config(cls: type) -> EasyDict:
        ...
        return cfg
    config = {'num_drones': 1, 'print_debug_info': False, 'output_folder': './results', 'plot_observation': False, 'freq': 240, 'aggregate_phy_steps': 1, 'gui': False, 'record': False, 'action_type': 'RPM'}
