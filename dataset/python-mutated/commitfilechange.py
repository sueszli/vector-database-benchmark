...
from sentry.db.models import BaseManager, BoundedBigIntegerField, FlexibleForeignKey, Model, region_silo_only_model, sane_repr
...
post_save.connect(lambda instance, **kwargs: process_resource_change(instance, **kwargs), sender=CommitFileChange, weak=False)