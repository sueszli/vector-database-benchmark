...
def transcribe_model_selection_v2(project_id: str, model: str, audio_file: str) -> cloud_speech.RecognizeResponse:
    if False:
        i = 10
        return i + 15
    ...
    with open(audio_file, 'rb') as f:
        content = f.read()
    config = cloud_speech.RecognitionConfig(auto_decoding_config=cloud_speech.AutoDetectDecodingConfig(), language_codes=['en-US'], model=model)
