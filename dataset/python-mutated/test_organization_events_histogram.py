...
HistogramSpec = namedtuple('HistogramSpec', ['start', 'end', 'fields', 'tags'], defaults=[None, None, [], {}])
...
class OrganizationEventsMetricsEnhancedPerformanceHistogramEndpointTest(MetricsEnhancedPerformanceTestCase):
...
@region_silo_test
class OrganizationEventsMetricsEnhancedPerformanceHistogramEndpointTestWithMetricLayer(OrganizationEventsMetricsEnhancedPerformanceHistogramEndpointTest):
