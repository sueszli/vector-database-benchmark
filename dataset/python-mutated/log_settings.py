...
DEFAULT_LOGTYPES_RETENTION = {'Error Log': 30, 'Activity Log': 90, 'Email Queue': 30, 'Scheduled Job Log': 90, 'Route History': 90, 'Submission Queue': 30, 'Prepared Report': 30, 'Webhook Request Log': 30, 'Integration Request': 90, 'Unhandled Email': 30, 'Reminder': 30}
...
LOG_DOCTYPES = ['Scheduled Job Log', 'Activity Log', 'Route History', 'Email Queue', 'Email Queue Recipient', 'Error Log']
