...
BAD_TYPES = {'GLVULKANPROCNV', 'GLvdpauSurfaceNV', 'GLhalfNV', 'struct _cl_event', 'struct _cl_context', 'GLDEBUGPROCAMD', 'GLDEBUGPROCKHR', 'GLDEBUGPROCARB', 'GLDEBUGPROC', 'GLsync'}
BAD_COMMANDS = {'glAttachObjectARB', 'glDetachObjectARB'}
...
FRAMEBUFFER_EXT_FUNCTIONS = {'glBindFramebuffer', 'glBindRenderbuffer', 'glDeleteFramebuffers', 'glDeleteRenderbuffers', 'glFramebufferRenderbuffer', 'glFramebufferTexture2D', 'glGenFramebuffers', 'glGenRenderbuffers', 'glRenderbufferStorage'}
GL_FEATURES = ['GL_VERSION_1_0', 'GL_VERSION_1_1', 'GL_VERSION_1_2', 'GL_VERSION_1_3', 'GL_VERSION_1_4', 'GL_VERSION_1_5', 'GL_VERSION_2_0', 'GL_VERSION_2_1', 'GL_VERSION_3_0']
GLES_FEATURES = ['GL_ES_VERSION_2_0', 'GL_ES_VERSION_3_0']
