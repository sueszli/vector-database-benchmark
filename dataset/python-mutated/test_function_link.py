...
_inject_backend_tests = testing.inject_backend_tests(None, [{}, {'use_ideep': 'always'}, {'use_cuda': True}, {'use_cuda': True, 'cuda_device': 1}, {'use_chainerx': True, 'chainerx_device': 'native:0'}, {'use_chainerx': True, 'chainerx_device': 'cuda:0'}, {'use_chainerx': True, 'chainerx_device': 'cuda:1'}])
...
@testing.parameterize(*testing.product({'shape': [(3, 2), (2,), (1,), (), (2, 0, 3)]}))
...
@testing.parameterize(*testing.product({'shape': [(3, 2), (2,), (1,), ()]}))
@_inject_backend_tests
...
@_inject_backend_tests
@pytest.mark.xfail(strict=True, raises=testing.FunctionTestError)
class TestFunctionTestIncorrectDoubleBackwardNoneGrads(testing.FunctionTestCase):
    skip_forward_test = True
    skip_backward_test = True
...
@testing.parameterize(*testing.product({'shape': [(3, 2), (2,), (1, 2)], 'contiguous': [None, 'C'], 'check_on': ['forward_input', 'backward_retained_input']}))
@_inject_backend_tests
...
@_inject_backend_tests
class TestLinkInitializersCorrect(DotLinkTestBase, testing.LinkInitializersTestCase):
    pass
...
@testing.parameterize(*testing.product({'invalid_forward_backward_initializer': [chainer.Variable(numpy.array([1])), chainer.Parameter(numpy.array([1]))]}))
@_inject_backend_tests
@pytest.mark.xfail(strict=True, raises=TypeError)
class TestLinkIncorrectForwardBackwardInitializers(DotLinkTestBase, testing.LinkTestCase):
...
@_inject_backend_tests
@pytest.mark.xfail(strict=True, raises=testing.LinkTestError)
class TestLinkIncorrectBackwardInitializers(DotLinkTestBase, testing.LinkInitializersTestCase):
...
@testing.parameterize(*testing.product({'invalid_initializer': [chainer.Variable(numpy.array([1])), chainer.Parameter(numpy.array([1]))]}))
@_inject_backend_tests
@pytest.mark.xfail(strict=True, raises=TypeError)
class TestLinkIncorrectInitializers(DotLinkTestBase, testing.LinkInitializersTestCase):
...
@testing.parameterize(*testing.product({'contiguous': [None, 'C'], 'check_on': ['forward_input', 'backward_retained_input']}))
@_inject_backend_tests
@pytest.mark.xfail(strict=True, raises=_ContiguousnessMatched)
