...
from sentry.api.endpoints.organization_events_facets_performance import OrganizationEventsFacetsPerformanceEndpointBase, query_facet_performance, query_tag_data
...
class OrganizationEventsFacetsStatsPerformanceEndpoint(OrganizationEventsFacetsPerformanceEndpointBase):
