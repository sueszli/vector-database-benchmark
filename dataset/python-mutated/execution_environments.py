...
from awxkit.api.pages import Credential, Organization
...
class ExecutionEnvironment(HasCreate, HasCopy, base.Base):
    ...
    def payload(self, name='', image=None, organization=None, credential=None, pull='', **kwargs):
        ...
        return payload
page.register_page([resources.execution_environment, (resources.execution_environments, 'post'), (resources.organization_execution_environments, 'post')], ExecutionEnvironment)
