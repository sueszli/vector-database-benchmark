...
from virtualenv.seed.wheels.periodic_update import NewVersion, UpdateLog, do_update, dump_datetime, load_datetime, manual_upgrade, periodic_update, release_date_for_wheel_path, trigger_update
...
_UPDATE_YES = {'never_started': UpdateLog(started=None, completed=None, versions=[], periodic=False), 'started_1_hour': UpdateLog(started=_UP_NOW - timedelta(hours=1, microseconds=1), completed=None, versions=[], periodic=False), 'completed_two_week': UpdateLog(started=_UP_NOW - timedelta(days=14, microseconds=2), completed=_UP_NOW - timedelta(days=14, microseconds=1), versions=[], periodic=False)}
