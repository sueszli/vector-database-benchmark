...
class RtmpIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {'id': video_id, 'title': title, 'formats': [{'url': url, 'ext': 'flv', 'format_id': urllib.parse.urlparse(url).scheme}]}

class MmsIE(InfoExtractor):
    IE_DESC = False
    _VALID_URL = '(?i)mms://.+'
    _TEST = {'url': 'mms://kentro.kaist.ac.kr/200907/MilesReid(0709).wmv', 'info_dict': {'id': 'MilesReid(0709)', 'ext': 'wmv', 'title': 'MilesReid(0709)'}, 'params': {'skip_download': True}}
...
class ViewSourceIE(InfoExtractor):
    ...
    _TEST = {'url': 'view-source:https://www.youtube.com/watch?v=BaW_jenozKc', 'only_matching': True}
