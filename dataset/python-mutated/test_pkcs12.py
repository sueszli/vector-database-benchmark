...
from cryptography.hazmat.primitives.serialization.pkcs12 import PBES, PKCS12Certificate, PKCS12KeyAndCertificates, load_key_and_certificates, load_pkcs12, serialize_key_and_certificates
...
class TestPKCS12Creation:
    ...
    @pytest.mark.parametrize(('enc_alg', 'enc_alg_der'), [(PBES.PBESv2SHA256AndAES256CBC, [b'\x06\t*\x86H\x86\xf7\r\x01\x05\r', b'\x06\t`\x86H\x01e\x03\x04\x01*']), (PBES.PBESv1SHA1And3KeyTripleDESCBC, [b'\x06\n*\x86H\x86\xf7\r\x01\x0c\x01\x03']), (None, [])])
