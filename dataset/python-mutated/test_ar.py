...
from statsmodels.tsa.deterministic import DeterministicProcess, Seasonality, TimeTrend
...
attributes = ['bse', 'cov_params', 'df_model', 'df_resid', 'fittedvalues', 'llf', 'nobs', 'params', 'resid', 'scale', 'tvalues', 'use_t']
...
params = product([0, 1, 3, [1, 3]], ['n', 'c', 't', 'ct'], [True, False], [0, 2], [None, 11], ['none', 'drop'], [True, False], [None, 12])
params = list(params)
...
param_fmt = 'lags: {0}, trend: {1}, seasonal: {2}, nexog: {3}, periods: {4}, missing: {5}, pandas: {6}, hold_back{7}'
...
params = product([0, 3, [1, 3]], ['c'], [True, False], [0], [None, 11], ['drop'], [True, False], [None, 12])
params = list(params)
params = [param for param in params if param[0] or param[1] != 'n' or param[2] or param[3]]
params = [param for param in params if not param[2] or (param[2] and (param[4] or param[6]))]
param_fmt = 'lags: {0}, trend: {1}, seasonal: {2}, nexog: {3}, periods: {4}, missing: {5}, pandas: {6}, hold_back: {7}'
