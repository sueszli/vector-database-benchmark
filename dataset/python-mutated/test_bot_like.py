...
from .test_variables import TEST_CAPTION_ITEM, TEST_COMMENT_ITEM, TEST_FOLLOWER_ITEM, TEST_FOLLOWING_ITEM, TEST_PHOTO_ITEM, TEST_SEARCH_USERNAME_ITEM, TEST_TIMELINE_PHOTO_ITEM, TEST_USERNAME_INFO_ITEM
try:
