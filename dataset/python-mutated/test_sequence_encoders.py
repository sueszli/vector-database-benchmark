...
encoder_parameters = {'vocab': [str(i) for i in range(TEST_VOCAB_SIZE)], 'embedding_size': TEST_EMBEDDING_SIZE, 'hidden_size': TEST_HIDDEN_SIZE, 'num_filters': TEST_NUM_FILTERS, 'num_layers': 1, 'max_sequence_length': SEQ_SIZE, 'state_size': TEST_STATE_SIZE, 'cell_type': 'rnn', 'should_embed': True, 'dropout': 0.0, 'norm': None, 'reduce_output': None}
