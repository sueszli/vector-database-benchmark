...
from azure.ai.generative.index._documents import DocumentChunksIterator
...
from azure.ai.generative.index._utils.logging import _logger_factory, enable_appinsights_logging, enable_stdout_logging, get_logger, safe_mlflow_start_run, track_activity
...
if __name__ == '__main__':
    ...
    parser.add_argument('--verbosity', type=int, default=2, choices=[0, 1, 2], help='0: Aggregate Source/Document Info, 1: Source Ids logged as processed, 2: Document Ids logged as processed.')
