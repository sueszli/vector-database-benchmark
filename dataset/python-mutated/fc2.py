...
from ..utils import ExtractorError, WebSocketsWrapper, js_to_json, traverse_obj, update_url_query, urlencode_postdata, urljoin

class FC2IE(InfoExtractor):
    _VALID_URL = '^(?:https?://video\\.fc2\\.com/(?:[^/]+/)*content/|fc2:)(?P<id>[^/]+)'
    IE_NAME = 'fc2'
    _NETRC_MACHINE = 'fc2'
    _TESTS = [{'url': 'http://video.fc2.com/en/content/20121103kUan1KHs', 'md5': 'a6ebe8ebe0396518689d963774a54eb7', 'info_dict': {'id': '20121103kUan1KHs', 'ext': 'flv', 'title': 'Boxing again with Puff'}}, {'url': 'http://video.fc2.com/en/content/20150125cEva0hDn/', 'info_dict': {'id': '20150125cEva0hDn', 'ext': 'mp4'}, 'params': {'username': 'ytdl@yt-dl.org', 'password': '(snip)'}, 'skip': 'requires actual password'}, {'url': 'http://video.fc2.com/en/a/content/20130926eZpARwsF', 'only_matching': True}]
...
class FC2EmbedIE(InfoExtractor):
    ...
    IE_NAME = 'fc2:embed'
    _TEST = {'url': 'http://video.fc2.com/flv2.swf?t=201404182936758512407645&i=20130316kwishtfitaknmcgd76kjd864hso93htfjcnaogz629mcgfs6rbfk0hsycma7shkf85937cbchfygd74&i=201403223kCqB3Ez&d=2625&sj=11&lang=ja&rel=1&from=11&cmt=1&tk=TlRBM09EQTNNekU9&tl=プリズン･ブレイク%20S1-01%20マイケル%20【吹替】', 'md5': 'b8aae5334cb691bdb1193a88a6ab5d5a', 'info_dict': {'id': '201403223kCqB3Ez', 'ext': 'flv', 'title': 'プリズン･ブレイク S1-01 マイケル 【吹替】', 'thumbnail': 're:^https?://.*\\.jpg$'}}
...
class FC2LiveIE(InfoExtractor):
    ...
    IE_NAME = 'fc2:live'
    _TESTS = [{'url': 'https://live.fc2.com/57892267/', 'info_dict': {'id': '57892267', 'title': 'どこまで・・・', 'uploader': 'あつあげ', 'uploader_id': '57892267', 'thumbnail': 're:https?://.+fc2.+'}, 'skip': 'livestream'}]
