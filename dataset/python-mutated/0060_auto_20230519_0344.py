...
class Migration(migrations.Migration):
    dependencies = [('company', '0059_supplierpart_pack_units'), ('part', '0111_auto_20230521_1350')]
    operations = [migrations.RunPython(code=update_supplier_part_units, reverse_code=reverse_pack_quantity)]