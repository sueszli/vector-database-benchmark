...
class TestCalculateShards(unittest.TestCase):
    tests: List[TestRun] = [TestRun('super_long_test'), TestRun('long_test1'), TestRun('long_test2'), TestRun('normal_test1'), TestRun('normal_test2'), TestRun('normal_test3'), TestRun('short_test1'), TestRun('short_test2'), TestRun('short_test3'), TestRun('short_test4'), TestRun('short_test5')]
    test_times: Dict[str, float] = {'super_long_test': 55, 'long_test1': 22, 'long_test2': 18, 'normal_test1': 9, 'normal_test2': 7, 'normal_test3': 5, 'short_test1': 1, 'short_test2': 0.6, 'short_test3': 0.4, 'short_test4': 0.3, 'short_test5': 0.01}
