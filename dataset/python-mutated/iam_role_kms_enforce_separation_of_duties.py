        ...
        for project in cloudresourcemanager_client.project_ids:
            ...
            for binding in cloudresourcemanager_client.bindings:
                if binding.project_id == project:
                    ...
                    if 'roles/cloudkms.cryptoKeyEncrypterDecrypter' in binding.role or 'roles/cloudkms.cryptoKeyEncrypter' in binding.role or 'roles/cloudkms.cryptoKeyDecrypter' in binding.role:
