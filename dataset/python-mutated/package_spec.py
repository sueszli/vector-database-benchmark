...
from .utils import BuildkiteLeafStep, BuildkiteTopLevelStep, GroupStep, is_command_step, is_feature_branch, message_contains
_CORE_PACKAGES = ['python_modules/dagster', 'python_modules/dagit', 'python_modules/dagster-graphql', 'js_modules/dagster-ui']
_INFRASTRUCTURE_PACKAGES = ['.buildkite/dagster-buildkite', 'python_modules/automation', 'python_modules/dagster-test', 'python_modules/docs/dagster-ui-screenshot']
...
def _infer_package_type(directory: str) -> str:
    ...
    if directory in _CORE_PACKAGES:
        ...
        return 'unknown'
_PACKAGE_TYPE_TO_EMOJI_MAP: Mapping[str, str] = {'core': ':dagster:', 'example': ':large_blue_diamond:', 'extension': ':electric_plug:', 'infrastructure': ':gear:', 'unknown': ':grey_question:'}
PytestExtraCommandsFunction: TypeAlias = Callable[[AvailablePythonVersion, Optional[str]], List[str]]
...
class PackageSpec:
    ...
    unsupported_python_versions: Optional[Union[List[AvailablePythonVersion], UnsupportedVersionsFunction]] = None
