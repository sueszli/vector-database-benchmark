...
colors = [cmap20c(0), cmap20c(1), cmap20c(2), cmap20c(10), cmap20c(9), cmap20c(8), cmap20c(4), cmap20c(5), cmap20c(6), cmap20b(15), cmap20b(14), cmap20b(13)]
...
for i in range(250):
    ...
    ellipse = Ellipse(p, width=2 * w, height=h, zorder=10, facecolor=color, edgecolor='none', alpha=0.5)
