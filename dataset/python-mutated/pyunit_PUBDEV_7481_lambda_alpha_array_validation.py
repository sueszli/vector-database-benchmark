...
def glm_alpha_array_lambda_null():
    ...
    mLVal = glm(family='binomial', alpha=[0.1, 0.5, 0.9], Lambda=[0.9, 0.5, 0.1], solver='COORDINATE_DESCENT')
    ...
    for l in range(0, len(rVal['lambdas'])):
        ...
        pyunit_utils.assertEqualCoeffDicts(csVal, mVal.coef(), tol=0.001)
        pyunit_utils.assertEqualCoeffDicts(cs_normVal, mVal.coef_norm(), 0.001)
        ...
        pyunit_utils.assertEqualRegPaths(regKeys, rVal, l, mrVal, tol=1e-05)
