...
from typing import Any, Callable, ClassVar, Dict, Iterator, List, Literal, Optional, Sequence, Set, Tuple, Type, TypeVar, Union, overload
...
_re_segment_template = re.compile('(.*?)\\$(\\w+)(?:%([\\w.]+))?\\$')
