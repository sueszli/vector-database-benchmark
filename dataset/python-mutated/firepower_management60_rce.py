...
class Exploit(HTTPClient, SSHClient):
    __info__ = {'name': 'Cisco Firepower Management 6.0 RCE', 'description': 'Module exploits Cisco Firepower Management 6.0 Remote Code Execution vulnerability. If the target is vulnerable, it is create backdoor account and authenticate through SSH service.', 'authors': ('Matt', 'sinn3r', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-6433', 'https://blog.korelogic.com/blog/2016/10/10/virtual_appliance_spelunking'), 'devices': ('Cisco Firepower Management Console 6.0',)}
