...
class ThreeSpeakUserIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://3speak.tv/user/theycallmedan', 'info_dict': {'id': 'theycallmedan'}, 'playlist_mincount': 115}]
