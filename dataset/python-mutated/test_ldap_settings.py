...
class Test_OpenLDAP(LDAP_TestCase, TestCase):
    ...
    DOCUMENT_GROUP_MAPPINGS = [{'doctype': 'LDAP Group Mapping', 'ldap_group': 'Administrators', 'erpnext_role': 'System Manager'}, {'doctype': 'LDAP Group Mapping', 'ldap_group': 'Users', 'erpnext_role': 'Blogger'}, {'doctype': 'LDAP Group Mapping', 'ldap_group': 'Group3', 'erpnext_role': 'Accounts User'}]
    LDAP_USERNAME_FIELD = 'uid'
    LDAP_SCHEMA = OFFLINE_SLAPD_2_4
    LDAP_LDIF_JSON = 'test_data_ldif_openldap.json'
    TEST_VALUES_LDAP_COMPLEX_SEARCH_STRING = ['(uid={0})', '(&(objectclass=posixaccount)(uid={0}))', '(&(description=*ACCESS:test1*)(uid={0}))', '(&(objectclass=posixaccount)(description=*ACCESS:test3*)(uid={0}))']
...
class Test_ActiveDirectory(LDAP_TestCase, TestCase):
    ...
    DOCUMENT_GROUP_MAPPINGS = [{'doctype': 'LDAP Group Mapping', 'ldap_group': 'Domain Administrators', 'erpnext_role': 'System Manager'}, {'doctype': 'LDAP Group Mapping', 'ldap_group': 'Domain Users', 'erpnext_role': 'Blogger'}, {'doctype': 'LDAP Group Mapping', 'ldap_group': 'Enterprise Administrators', 'erpnext_role': 'Accounts User'}]
    LDAP_USERNAME_FIELD = 'samaccountname'
    LDAP_SCHEMA = OFFLINE_AD_2012_R2
    LDAP_LDIF_JSON = 'test_data_ldif_activedirectory.json'
    TEST_VALUES_LDAP_COMPLEX_SEARCH_STRING = ['(samaccountname={0})', '(&(objectclass=user)(samaccountname={0}))', '(&(description=*ACCESS:test1*)(samaccountname={0}))', '(&(objectclass=user)(description=*ACCESS:test3*)(samaccountname={0}))']