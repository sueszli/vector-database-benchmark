...
datasets = {'cuio_dataset': Dataset('https://data.rapids.ai/cudf/benchmark/avro_json_datasets.zip', 'cudf/benchmarks/cuio_data/')}
...
parser.add_argument('-d', nargs=1, help='path where downloaded dataset from given url will be unzipped')
parser.add_argument('--datasets', nargs='+', help='Currently supported datasets are: ' + ', '.join(list(datasets.keys())))
