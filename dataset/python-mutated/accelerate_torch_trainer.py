...
if __name__ == '__main__':
    config = {'lr': 2e-05, 'num_epochs': 3, 'seed': 42, 'train_batch_size': 16, 'eval_batch_size': 32}
    ...
    trainer = TorchTrainer(train_func, train_loop_config=config, datasets=ray_datasets, dataset_config=DataConfig(datasets_to_split=['train', 'validation']), scaling_config=ScalingConfig(num_workers=4, use_gpu=True))
    result = trainer.fit()