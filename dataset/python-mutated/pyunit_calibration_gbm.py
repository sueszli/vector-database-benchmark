...
def calibration_test():
    ...
    model = H2OGradientBoostingEstimator(ntrees=100, distribution='bernoulli', min_rows=10, max_depth=5, weights_column='Weights', calibrate_model=True, calibration_frame=calib)
    ...
    manual_calib_model = H2OGeneralizedLinearEstimator(family='binomial', weights_column='weights', lambda_=0, intercept=True)
