...
from ..utils import ExtractorError, int_or_none, js_to_json, parse_count, parse_duration, traverse_obj, try_get, unified_timestamp

class DaftsexIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?daft\\.sex/watch/(?P<id>-?\\d+_\\d+)'
    _TESTS = [{'url': 'https://daft.sex/watch/-35370899_456246186', 'md5': '64c04ef7b4c7b04b308f3b0c78efe7cd', 'info_dict': {'id': '-35370899_456246186', 'ext': 'mp4', 'title': 'just relaxing', 'description': 'just relaxing – Watch video Watch video in high quality', 'upload_date': '20201113', 'timestamp': 1605261911, 'thumbnail': 're:^https?://.*\\.jpg$', 'age_limit': 18, 'duration': 15.0, 'view_count': int}}, {'url': 'https://daft.sex/watch/-156601359_456242791', 'info_dict': {'id': '-156601359_456242791', 'ext': 'mp4', 'title': 'Skye Blue - Dinner And A Show', 'description': 'Skye Blue - Dinner And A Show - Watch video Watch video in high quality', 'upload_date': '20200916', 'timestamp': 1600250735, 'thumbnail': 'https://psv153-1.crazycloud.ru/videos/-156601359/456242791/thumb.jpg?extra=i3D32KaBbBFf9TqDRMAVmQ'}, 'skip': 'deleted / private'}]
