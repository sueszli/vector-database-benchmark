...
class ResourceChangesOperations:
    """ResourceChangesOperations async operations.

    You should not instantiate this class directly. Instead, you should create a Client instance that
    instantiates it for you and attaches it as an attribute.

    :ivar models: Alias to model classes used in this operation group.
    :type models: ~Microsoft.ChangeAnalysis.models
    ...
    def list(self, resource_id: str, start_time: datetime.datetime, end_time: datetime.datetime, skip_token: Optional[str]=None, **kwargs) -> AsyncIterable['_models.ChangeList']:
        if False:
            print('Hello World!')
    ...
    list.metadata = {'url': '/{resourceId}/providers/Microsoft.ChangeAnalysis/resourceChanges'}