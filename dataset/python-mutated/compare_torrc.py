...
if __name__ == '__main__':
    ...
    if 3 in server_versions and 3 in backup_versions:
        ...
        sys.exit(0)
    print('The Tor configuration on the app server offers version {} services.'.format(strset(server_versions)))
    print('The Tor configuration in this backup offers version {} services.'.format(strset(backup_versions)))
