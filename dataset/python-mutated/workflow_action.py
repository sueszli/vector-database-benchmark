...
from frappe.model.workflow import apply_workflow, get_workflow_name, get_workflow_state_field, has_approval_access, is_transition_condition_satisfied, send_email_alert
...
class WorkflowAction(Document):
    ...
    if TYPE_CHECKING:
        ...
        from frappe.workflow.doctype.workflow_action_permitted_role.workflow_action_permitted_role import WorkflowActionPermittedRole
