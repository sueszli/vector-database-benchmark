...
class AdversarialPatchTensorFlowV2(EvasionAttack):
    ...
    | Paper link: https://arxiv.org/abs/1712.09665
    """
    attack_params = EvasionAttack.attack_params + ['rotation_max', 'scale_min', 'scale_max', 'learning_rate', 'max_iter', 'batch_size', 'patch_shape', 'optimizer', 'targeted', 'summary_writer', 'verbose']
