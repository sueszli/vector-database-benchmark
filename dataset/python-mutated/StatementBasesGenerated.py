...
from .Checkers import checkStatementsSequence, checkStatementsSequenceOrNone, convertNoneConstantToNone
...
class StatementChildrenHavingConditionYesBranchOptionalStatementsOrNoneNoBranchOptionalStatementsOrNoneMixin(StatementBase):
    __slots__ = ()
...
class StatementChildrenHavingExceptionTypeExceptionValueOptionalExceptionTraceOptionalExceptionCauseOptionalOperationPostInitMixin(StatementBase):
    __slots__ = ()
...
StatementSpecialUnpackCheckFromIteratedBase = StatementChildHavingIteratedLengthOperationCountMixin
...
StatementLocalsDictSyncBase = StatementChildHavingLocalsArgOperationPostInitLocalsScopeMixin
...
StatementAssignmentVariableNameBase = StatementChildHavingSourcePostInitProviderVariableNameMixin
...
class StatementChildHavingSourcePostInitVariableVariableVersionMixin(StatementBase):
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        'Collect variable reads and writes of child nodes.'
        self.subnode_source.collectVariableAccesses(emit_read, emit_write)
StatementAssignmentVariableConstantImmutableBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableConstantImmutableTrustedBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableConstantMutableBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableConstantMutableTrustedBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableFromTempVariableBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableFromVariableBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableGenericBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableHardValueBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin
StatementAssignmentVariableIteratorBase = StatementChildHavingSourcePostInitVariableVariableVersionMixin

class StatementChildHavingSourceOperationPostInitLocalsScopeVariableNameMixin(StatementBase):
    __slots__ = ()
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        'Collect variable reads and writes of child nodes.'
        self.subnode_source.collectVariableAccesses(emit_read, emit_write)
StatementLocalsDictOperationSetBase = StatementChildHavingSourceOperationPostInitLocalsScopeVariableNameMixin
...
class StatementChildrenHavingSourceExpressionOperationAttributeNameMixin(StatementBase):
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        self.subnode_source.collectVariableAccesses(emit_read, emit_write)
        self.subnode_expression.collectVariableAccesses(emit_read, emit_write)
StatementAssignmentAttributeBase = StatementChildrenHavingSourceExpressionOperationAttributeNameMixin

class StatementChildrenHavingSourceExpressionLowerOptionalUpperOptionalMixin(StatementBase):
    __slots__ = ()
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        if subnode_upper is not None:
            self.subnode_upper.collectVariableAccesses(emit_read, emit_write)
StatementAssignmentSliceBase = StatementChildrenHavingSourceExpressionLowerOptionalUpperOptionalMixin
...
StatementAssignmentSubscriptBase = StatementChildrenHavingSourceSubscribedSubscriptOperationMixin

class StatementChildrenHavingSourceCodeGlobalsArgAutoNoneLocalsArgAutoNoneOperationMixin(StatementBase):
    __slots__ = ()
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        if subnode_locals_arg is not None:
            self.subnode_locals_arg.collectVariableAccesses(emit_read, emit_write)
StatementExecBase = StatementChildrenHavingSourceCodeGlobalsArgAutoNoneLocalsArgAutoNoneOperationMixin
...
class StatementChildrenHavingTriedStatementsExceptHandlerOptionalStatementsOrNoneBreakHandlerOptionalStatementsOrNoneContinueHandlerOptionalStatementsOrNoneReturnHandlerOptionalStatementsOrNonePostInitMixin(StatementBase):
    __slots__ = ()
...
StatementDictOperationSetKeyValueBase = StatementChildrenHavingValueDictArgKeyOperationMixin