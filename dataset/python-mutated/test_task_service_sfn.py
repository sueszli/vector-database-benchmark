...
class TestTaskServiceSfn:
    ...
    def test_start_execution_no_such_arn(self, aws_client, create_iam_role_for_sfn, create_state_machine, sfn_snapshot):
        if False:
            return 10
        ...
        exec_input = json.dumps({'StateMachineArn': f'{state_machine_arn_target}{random_arn_part}', 'Input': None, 'Name': 'TestStartTarget'})
