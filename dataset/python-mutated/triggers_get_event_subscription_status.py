...
def main():
    ...
    response = client.triggers.get_event_subscription_status(resource_group_name='exampleResourceGroup', factory_name='exampleFactoryName', trigger_name='exampleTrigger')
    print(response)
