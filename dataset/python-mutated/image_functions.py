...
__all__ = ['numpy_grayscale_to_heatmap_figure', 'ensure_image', 'apply_heatmap_image_properties', 'draw_bboxes', 'prepare_thumbnail', 'crop_image', 'draw_image', 'draw_masks', 'random_color_dict']
