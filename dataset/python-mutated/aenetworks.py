...
from ..utils import ExtractorError, GeoRestrictedError, int_or_none, remove_start, traverse_obj, update_url_query, urlencode_postdata

class AENetworksBaseIE(ThePlatformIE):
    _BASE_URL_REGEX = '(?x)https?://\n        (?:(?:www|play|watch)\\.)?\n        (?P<domain>\n            (?:history(?:vault)?|aetv|mylifetime|lifetimemovieclub)\\.com|\n            fyi\\.tv\n        )/'
    _THEPLATFORM_KEY = '43jXaGRQud'
    _THEPLATFORM_SECRET = 'S10BPXHMlb'
    _DOMAIN_MAP = {'history.com': ('HISTORY', 'history'), 'aetv.com': ('AETV', 'aetv'), 'mylifetime.com': ('LIFETIME', 'lifetime'), 'lifetimemovieclub.com': ('LIFETIMEMOVIECLUB', 'lmc'), 'fyi.tv': ('FYI', 'fyi'), 'historyvault.com': (None, 'historyvault'), 'biography.com': (None, 'biography')}
...
class AENetworksCollectionIE(AENetworksListBaseIE):
    ...
    _VALID_URL = AENetworksBaseIE._BASE_URL_REGEX + '(?:[^/]+/)*(?:list|collections)/(?P<id>[^/?#&]+)/?(?:[?#&]|$)'
    _TESTS = [{'url': 'https://watch.historyvault.com/list/america-the-story-of-us', 'info_dict': {'id': '282', 'title': 'America The Story of Us'}, 'playlist_mincount': 12}, {'url': 'https://watch.historyvault.com/shows/america-the-story-of-us-2/season-1/list/america-the-story-of-us', 'only_matching': True}, {'url': 'https://www.historyvault.com/collections/mysteryquest', 'only_matching': True}]
    _RESOURCE = 'list'
    _ITEMS_KEY = 'items'
...
class AENetworksShowIE(AENetworksListBaseIE):
    ...
    _VALID_URL = AENetworksBaseIE._BASE_URL_REGEX + 'shows/(?P<id>[^/?#&]+)/?(?:[?#&]|$)'
    _TESTS = [{'url': 'http://www.history.com/shows/ancient-aliens', 'info_dict': {'id': 'SERIES1574', 'title': 'Ancient Aliens', 'description': 'md5:3f6d74daf2672ff3ae29ed732e37ea7f'}, 'playlist_mincount': 150}]
    _RESOURCE = 'series'
    _ITEMS_KEY = 'episodes'
...
class HistoryTopicIE(AENetworksBaseIE):
    ...
    _TESTS = [{'url': 'https://www.history.com/topics/valentines-day/history-of-valentines-day-video', 'info_dict': {'id': '40700995724', 'ext': 'mp4', 'title': 'History of Valentine’s Day', 'description': 'md5:7b57ea4829b391995b405fa60bd7b5f7', 'timestamp': 1375819729, 'upload_date': '20130806', 'uploader': 'AENE-NEW'}, 'params': {'skip_download': True}, 'add_ie': ['ThePlatform']}]
...
class BiographyIE(AENetworksBaseIE):
    ...
    _TESTS = [{'url': 'https://www.biography.com/video/vincent-van-gogh-full-episode-2075049808', 'info_dict': {'id': '30322987', 'ext': 'mp4', 'title': 'Vincent Van Gogh - Full Episode', 'description': 'A full biography about the most influential 20th century painter, Vincent Van Gogh.', 'timestamp': 1311970571, 'upload_date': '20110729', 'uploader': 'AENE-NEW'}, 'params': {'skip_download': True}, 'add_ie': ['ThePlatform'], 'skip': '404 Not Found'}]
