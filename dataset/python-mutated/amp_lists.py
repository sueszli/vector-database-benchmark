...
from ..fp16_lists import black_list as black_list_fp16, gray_list as gray_list_fp16, white_list as white_list_fp16
...
(_, _, _sys_unsupported_bf16_list) = core.op_supported_infos('CPU', core.VarDesc.VarType.BF16)
