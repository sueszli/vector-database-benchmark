...
class RoPEScalingConfig(schema_utils.BaseMarshmallowConfig):
    ...
    type: Optional[str] = schema_utils.StringOptions(options=['linear', 'dynamic'], default=None, allow_none=True, description='Currently supports two strategies: linear and dynamic scaling.')
    factor: Optional[float] = schema_utils.FloatRange(default=None, allow_none=True, min=1.0, min_inclusive=False, description='The scaling factor for RoPE embeddings.')
