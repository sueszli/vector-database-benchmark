...
from .operations import AttachedNetworksOperations, CatalogDevBoxDefinitionsOperations, CatalogsOperations, CheckNameAvailabilityOperations, CustomizationTasksOperations, DevBoxDefinitionsOperations, DevCentersOperations, EnvironmentDefinitionsOperations, EnvironmentTypesOperations, GalleriesOperations, ImageVersionsOperations, ImagesOperations, NetworkConnectionsOperations, OperationStatusesOperations, Operations, PoolsOperations, ProjectAllowedEnvironmentTypesOperations, ProjectEnvironmentTypesOperations, ProjectsOperations, SchedulesOperations, SkusOperations, UsagesOperations
if TYPE_CHECKING:
    from azure.core.credentials import TokenCredential

class DevCenterMgmtClient:
