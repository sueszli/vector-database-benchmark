...
from ..utils import determine_ext, float_or_none, int_or_none, js_to_json, mimetype2ext, parse_iso8601, remove_start
...
class NYTimesIE(NYTimesBaseIE):
    ...
    _EMBED_REGEX = ['<iframe[^>]+src=(["\\\'])(?P<url>(?:https?:)?//graphics8\\.nytimes\\.com/bcvideo/[^/]+/iframe/embed\\.html.+?)\\1>']
    _TESTS = [{'url': 'http://www.nytimes.com/video/opinion/100000002847155/verbatim-what-is-a-photocopier.html?playlistId=100000001150263', 'md5': 'd665342765db043f7e225cff19df0f2d', 'info_dict': {'id': '100000002847155', 'ext': 'mov', 'title': 'Verbatim: What Is a Photocopier?', 'description': 'md5:93603dada88ddbda9395632fdc5da260', 'timestamp': 1398631707, 'upload_date': '20140427', 'uploader': 'Brett Weiner', 'duration': 419}}, {'url': 'http://www.nytimes.com/video/travel/100000003550828/36-hours-in-dubai.html', 'only_matching': True}]
...
class NYTimesCookingIE(NYTimesBaseIE):
    ...
    _TESTS = [{'url': 'https://cooking.nytimes.com/recipes/1017817-cranberry-curd-tart', 'md5': 'dab81fa2eaeb3f9ed47498bdcfcdc1d3', 'info_dict': {'id': '100000004756089', 'ext': 'mov', 'timestamp': 1479383008, 'uploader': 'By SHAW LASH, ADAM SAEWITZ and JAMES HERRON', 'title': 'Cranberry Tart', 'upload_date': '20161117', 'description': 'If you are a fan of lemon curd or the classic French tarte au citron, you will love this cranberry version.'}}, {'url': 'https://cooking.nytimes.com/guides/13-how-to-cook-a-turkey', 'md5': '4b2e8c70530a89b8d905a2b572316eb8', 'info_dict': {'id': '100000003951728', 'ext': 'mov', 'timestamp': 1445509539, 'description': 'Turkey guide', 'upload_date': '20151022', 'title': 'Turkey'}}]
