...
ALREADY_ON_MAJOR_VERSION_EXCEPTIONS = [('airbyte/source-prestashop', '1.0.0'), ('airbyte/source-onesignal', '1.0.0'), ('airbyte/source-yandex-metrica', '1.0.0'), ('airbyte/destination-meilisearch', '1.0.0'), ('airbyte/destination-csv', '1.0.0'), ('airbyte/source-metabase', '1.0.0'), ('airbyte/source-typeform', '1.0.0'), ('airbyte/source-recharge', '1.0.0'), ('airbyte/source-pipedrive', '1.0.0'), ('airbyte/source-paypal-transaction', '2.0.0')]
...
def validate_metadata_base_images_in_dockerhub(metadata_definition: ConnectorMetadataDefinitionV0, validator_opts: ValidatorOptions) -> ValidationResult:
    ...
    return (True, None)
PRE_UPLOAD_VALIDATORS = [validate_all_tags_are_keyvalue_pairs, validate_at_least_one_language_tag, validate_major_version_bump_has_breaking_change_entry, validate_docs_path_exists, validate_metadata_base_images_in_dockerhub]
