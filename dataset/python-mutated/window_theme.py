...
class WindowTheme_Dark(WindowTheme):
    name = 'dark'
    colors = {'primaryColor': '#448aff', 'primaryLightColor': '#83b9ff', 'secondaryColor': '#1E242A', 'secondaryLightColor': '#272d32', 'secondaryDarkColor': '#0C1116', 'primaryTextColor': '#E9E9E9', 'secondaryTextColor': '#9F9F9F', 'danger': '#dc3545', 'warning': '#ffc107', 'success': '#17a2b8'}

class WindowTheme_Light(WindowTheme):
    name = 'light'
    colors = {'primaryColor': '#448aff', 'primaryLightColor': '#508AD8', 'secondaryColor': '#FFFFFF', 'secondaryLightColor': '#E8EAEC', 'secondaryDarkColor': '#ECEDEF', 'primaryTextColor': '#1A1A1A', 'secondaryTextColor': '#6E6E6E', 'danger': '#dc3545', 'warning': '#ffc107', 'success': '#17a2b8'}

class WindowTheme_Plain(WindowTheme):
    name = 'plain'
    colors = {'primaryColor': None, 'primaryLightColor': None, 'secondaryColor': None, 'secondaryLightColor': None, 'secondaryDarkColor': None, 'primaryTextColor': None, 'secondaryTextColor': None, 'danger': None, 'warning': None, 'success': None}
