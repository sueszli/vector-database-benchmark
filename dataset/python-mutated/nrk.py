...
@pluginmatcher(re.compile('https?://(?:tv|radio)\\.nrk\\.no/(program|direkte|serie|podkast)(?:/.+)?/([^/]+)'))
class NRK(Plugin):
    ...
    _MAP_MANIFEST_TYPE = {'direkte': 'channel', 'serie': 'program', 'program': 'program', 'podkast': 'podcast'}
