...
class ArtifactSourcesOperations:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, artifact_source_name: str, artifact_source_info: Optional[_models.ArtifactSource]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ArtifactSource:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, artifact_source_name: str, artifact_source_info: Optional[IO]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ArtifactSource:
        """Creates or updates an artifact source.
    ...
    async def create_or_update(self, resource_group_name: str, artifact_source_name: str, artifact_source_info: Optional[Union[_models.ArtifactSource, IO]]=None, **kwargs: Any) -> _models.ArtifactSource:
        """Creates or updates an artifact source.
        ...
        elif artifact_source_info is not None:
            _json = self._serialize.body(artifact_source_info, 'ArtifactSource')
        else:
            _json = None
        request = build_create_or_update_request(resource_group_name=resource_group_name, artifact_source_name=artifact_source_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
    ...
    async def get(self, resource_group_name: str, artifact_source_name: str, **kwargs: Any) -> _models.ArtifactSource:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, artifact_source_name=artifact_source_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, artifact_source_name: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, artifact_source_name=artifact_source_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
