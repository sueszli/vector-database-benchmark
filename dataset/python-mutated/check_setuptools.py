...
if __name__ == '__main__':
    ...
    try:
        ...
        print('Exception extracting setuptools version from requirements.txt: %s' % e, file=sys.stderr)
        sys.exit(1)
    if not version:
        print('Unable to find setuptools in requirements.txt', file=sys.stderr)
        sys.exit(1)
