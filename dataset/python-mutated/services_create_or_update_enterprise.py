...
def main():
    ...
    response = client.services.begin_create_or_update(resource_group_name='myResourceGroup', service_name='myservice', resource={'location': 'eastus', 'properties': {}, 'sku': {'name': 'E0', 'tier': 'Enterprise'}, 'tags': {'key1': 'value1'}}).result()
    print(response)
