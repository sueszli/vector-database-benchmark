...
def _getitem(obj, key):
    ...
    return obj[key]
UNSAFE_ATTRIBUTES = {'gi_frame', 'gi_code', 'gi_yieldfrom', 'cr_frame', 'cr_code', 'cr_origin', 'cr_await', 'ag_code', 'ag_frame', 'tb_frame', 'tb_next', 'format', 'format_map', 'f_back', 'f_builtins', 'f_code', 'f_globals', 'f_locals', 'f_trace'}
