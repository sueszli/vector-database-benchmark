import pytest
from returns.context import RequiresContextFutureResult, RequiresContextIOResult, RequiresContextResult
...
@pytest.mark.anyio()
@pytest.mark.parametrize('container', [FutureResult.from_value(1), FutureResult.from_failure(1), RequiresContextFutureResult.from_value(1), RequiresContextFutureResult.from_failure(1)])
