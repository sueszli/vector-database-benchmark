...
class ClientConnectorService(proto.Message):
    ...
    class Ingress(proto.Message):
        ...
        class Config(proto.Message):
            ...
            class DestinationRoute(proto.Message):
                ...
                netmask: str = proto.Field(proto.STRING, number=2)
            transport_protocol: 'ClientConnectorService.Ingress.Config.TransportProtocol' = proto.Field(proto.ENUM, number=1, enum='ClientConnectorService.Ingress.Config.TransportProtocol')
            destination_routes: MutableSequence['ClientConnectorService.Ingress.Config.DestinationRoute'] = proto.RepeatedField(proto.MESSAGE, number=2, message='ClientConnectorService.Ingress.Config.DestinationRoute')
        config: 'ClientConnectorService.Ingress.Config' = proto.Field(proto.MESSAGE, number=1, oneof='ingress_config', message='ClientConnectorService.Ingress.Config')

    class Egress(proto.Message):
        """The details of the egress info. One of the following options
        should be set.
        ...
        class PeeredVpc(proto.Message):
            ...
            """
            network_vpc: str = proto.Field(proto.STRING, number=1)
        peered_vpc: 'ClientConnectorService.Egress.PeeredVpc' = proto.Field(proto.MESSAGE, number=1, oneof='destination_type', message='ClientConnectorService.Egress.PeeredVpc')
    ...
    ingress: Ingress = proto.Field(proto.MESSAGE, number=6, message=Ingress)
    egress: Egress = proto.Field(proto.MESSAGE, number=7, message=Egress)
...
class ListClientConnectorServicesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    client_connector_services: MutableSequence['ClientConnectorService'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ClientConnectorService')
...
class CreateClientConnectorServiceRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    client_connector_service_id: str = proto.Field(proto.STRING, number=2)
    client_connector_service: 'ClientConnectorService' = proto.Field(proto.MESSAGE, number=3, message='ClientConnectorService')
...
class UpdateClientConnectorServiceRequest(proto.Message):
    ...
    client_connector_service: 'ClientConnectorService' = proto.Field(proto.MESSAGE, number=2, message='ClientConnectorService')
    request_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
    allow_missing: bool = proto.Field(proto.BOOL, number=5)
