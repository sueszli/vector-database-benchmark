...
import pytest
from dagster import AssetIn, AssetKey, DailyPartitionsDefinition, DynamicPartitionsDefinition, EnvVar, IOManagerDefinition, MetadataValue, MultiPartitionKey, MultiPartitionsDefinition, Out, StaticPartitionsDefinition, TableColumn, TableSchema, TimeWindowPartitionMapping, asset, build_input_context, build_output_context, fs_io_manager, instance_for_test, job, materialize, op
from dagster._core.storage.db_io_manager import TableSlice
from dagster_snowflake import build_snowflake_io_manager
from dagster_snowflake.resources import SnowflakeResource
from dagster_snowflake_pyspark import SnowflakePySparkIOManager, SnowflakePySparkTypeHandler, snowflake_pyspark_io_manager
...
SHARED_BUILDKITE_SNOWFLAKE_CONF: Mapping[str, Any] = {'account': os.getenv('SNOWFLAKE_ACCOUNT', ''), 'user': 'BUILDKITE', 'password': os.getenv('SNOWFLAKE_BUILDKITE_PASSWORD', ''), 'warehouse': 'BUILDKITE'}
DATABASE = 'TEST_SNOWFLAKE_IO_MANAGER'
SCHEMA = 'SNOWFLAKE_IO_MANAGER_SCHEMA'
pythonic_snowflake_io_manager = SnowflakePySparkIOManager(database=DATABASE, account=EnvVar('SNOWFLAKE_ACCOUNT'), user='BUILDKITE', password=EnvVar('SNOWFLAKE_BUILDKITE_PASSWORD'), warehouse='BUILDKITE')
old_snowflake_io_manager = snowflake_pyspark_io_manager.configured({**SHARED_BUILDKITE_SNOWFLAKE_CONF, 'database': DATABASE})
