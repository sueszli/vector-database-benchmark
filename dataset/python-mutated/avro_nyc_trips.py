...
SCHEMA = {'fields': [{'name': 'service', 'type': 'string'}, {'name': 'day', 'type': 'string'}, {'name': 'total_price', 'type': 'double'}, {'name': 'total_driver_pay', 'type': 'double'}, {'name': 'total_trip_miles', 'type': 'double'}, {'name': 'total_trip_minutes', 'type': 'double'}, {'name': 'total_number_of_trips', 'type': 'long'}, {'name': 'price_per_trip', 'type': 'double'}, {'name': 'price_per_mile', 'type': 'double'}, {'name': 'price_per_minute', 'type': 'double'}, {'name': 'driver_pay_per_trip', 'type': 'double'}, {'name': 'driver_pay_per_mile', 'type': 'double'}, {'name': 'driver_pay_per_minute', 'type': 'double'}, {'name': 'miles_per_hour', 'type': 'double'}], 'name': 'nyc_trip_prices', 'type': 'record'}
