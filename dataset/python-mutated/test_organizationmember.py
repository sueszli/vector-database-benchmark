...
class MockOrganizationRoles:
    TEST_ORG_ROLES = [{'id': 'alice', 'name': 'Alice', 'scopes': ['project:read', 'project:write']}, {'id': 'bob', 'name': 'Bob', 'scopes': ['project:read']}, {'id': 'carol', 'name': 'Carol', 'scopes': ['project:write']}]
    TEST_TEAM_ROLES = [{'id': 'alice', 'name': 'Alice'}, {'id': 'bob', 'name': 'Bob'}, {'id': 'carol', 'name': 'Carol'}]
