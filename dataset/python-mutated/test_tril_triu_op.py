...
cases = {'success': {(2, 2, 3, 4, 5): [-100, -3, -1, 0, 2, 4, 100], (10, 10, 1, 1): [-100, -1, 0, 1, 100]}, 'diagonal: TypeError': {(20, 20): ['2020', [20], {20: 20}, (20, 20), 20.2]}, 'input: ValueError': {(2020,): [None]}}
    ...
    for _op_type in ['tril', 'triu']:
        for (_expected, _params) in cases.items():
            for (_Xshape, _diaglist) in _params.items():
                [case_generator(_op_type, _Xshape, _diagonal, _expected, dtype) for _diagonal in _diaglist]
