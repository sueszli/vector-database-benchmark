...
__all__ = ['AssetPermissionUserRelationViewSet', 'AssetPermissionUserGroupRelationViewSet', 'AssetPermissionAssetRelationViewSet', 'AssetPermissionNodeRelationViewSet', 'AssetPermissionAllAssetListApi', 'AssetPermissionAllUserListApi', 'AssetPermissionAccountListApi']
...
class AssetPermissionUserRelationViewSet(RelationMixin):
    ...
    filterset_fields = ['id', 'user', 'assetpermission']
...
class AssetPermissionUserGroupRelationViewSet(RelationMixin):
    ...
    filterset_fields = ['id', 'usergroup', 'assetpermission']
...
class AssetPermissionAssetRelationViewSet(RelationMixin):
    ...
    filterset_fields = ['id', 'asset', 'assetpermission']
...
class AssetPermissionNodeRelationViewSet(RelationMixin):
    ...
    filterset_fields = ['id', 'node', 'assetpermission']
