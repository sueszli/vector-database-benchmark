...
from paddle.nn import BatchNorm2D, Conv2D, LeakyReLU, Linear, MaxPool2D, PReLU, ReLU, Sequential, Sigmoid, Softmax
...
class TestImperativeQatMatmul(unittest.TestCase):
    ...
    def func_qat(self):
        ...
        optimizer = Momentum(learning_rate=0.1, parameters=lenet.parameters(), momentum=0.9)
