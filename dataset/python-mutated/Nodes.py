...
from .Symtab import ModuleScope, LocalScope, ClosureScope, PropertyScope, StructOrUnionScope, PyClassScope, CppClassScope, TemplateScope, GeneratorExpressionScope, CppScopedEnumScope, punycodify_name
...
utility_code_for_cimports = {'cpython.array': lambda : UtilityCode.load_cached('ArrayAPI', 'arrayarray.h'), 'cpython.array.array': lambda : UtilityCode.load_cached('ArrayAPI', 'arrayarray.h'), 'cython.view': cython_view_utility_code}
utility_code_for_imports = {'asyncio': ('__Pyx_patch_asyncio', 'PatchAsyncIO', 'Coroutine.c'), 'inspect': ('__Pyx_patch_inspect', 'PatchInspect', 'Coroutine.c')}
