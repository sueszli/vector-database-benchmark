...
@pytest.mark.parametrize('callback_props', [dict(merge_duplicate_headers=True)])
def test_szng003_b_on_prop_change(test, fixed_columns, fixed_rows, merge_duplicate_headers, callback_props):
    if False:
        print('Hello World!')
