...
def build_list_request(**kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/providers/Microsoft.ApiManagement/operations')
...
class ApiManagementOperationsOperations:
    ...
    list.metadata = {'url': '/providers/Microsoft.ApiManagement/operations'}