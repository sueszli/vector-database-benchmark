...
from torchvision.models.detection import faster_rcnn, image_list, keypoint_rcnn, mask_rcnn, roi_heads, rpn, transform
...
TestModels = type('TestModels', (pytorch_test_common.ExportTestCase,), dict(test_models.TestModels.__dict__, is_script_test_enabled=False, is_script=False, exportTest=exportTest))
TestModels_new_jit_API = type('TestModels_new_jit_API', (pytorch_test_common.ExportTestCase,), dict(TestModels.__dict__, exportTest=exportTest, is_script_test_enabled=True, is_script=True, onnx_shape_inference=True))
