...
class Exploit(HTTPClient):
    __info__ = {'name': 'IPFire Oinkcode RCE', 'description': 'Module exploits IPFire < 2.19 Core Update 110 Remote Code Execution vulnerability which allows executing command on operating system level.', 'authors': ('0x09AL', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/42149/',), 'devices': ('IPFire < 2.19 Core Update 110',)}
