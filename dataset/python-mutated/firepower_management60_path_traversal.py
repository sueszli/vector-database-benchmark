...
class Exploit(HTTPClient):
    __info__ = {'name': 'Cisco Firepower Management 6.0 Path Traversal', 'description': 'Module exploits Cisco Firepower Management 6.0 Path Traversal vulnerability. If the target is vulnerable, it is possible to retrieve content of the arbitrary files.', 'authors': ('Matt', 'sinn3r', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-6435', 'https://blog.korelogic.com/blog/2016/10/10/virtual_appliance_spelunking'), 'devices': ('Cisco Firepower Management Console 6.0',)}
