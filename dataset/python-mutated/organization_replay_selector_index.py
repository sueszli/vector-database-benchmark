...
from snuba_sdk import Column, Condition, Entity, Function, Granularity, Identifier, Lambda, Limit, Offset, Op, Query
...
query_config: dict[str, FieldProtocol] = {'count_dead_clicks': IntegerColumnField('count_dead_clicks', parse_int, IntegerScalar), 'count_rage_clicks': IntegerColumnField('count_rage_clicks', parse_int, IntegerScalar)}
sort_config = {'count_dead_clicks': Column('count_dead_clicks'), 'count_rage_clicks': Column('count_rage_clicks')}