...
from ..utils import ExtractorError, clean_html, dict_get, int_or_none, join_nonempty, merge_dicts, parse_duration, traverse_obj, try_get, unified_timestamp, update_url_query

class NaverBaseIE(InfoExtractor):
    _CAPTION_EXT_RE = '\\.(?:ttml|vtt)'
...
class NaverLiveIE(InfoExtractor):
    ...
    _GEO_BYPASS = False
    _TESTS = [{'url': 'https://tv.naver.com/l/52010', 'info_dict': {'id': '52010', 'ext': 'mp4', 'title': '[LIVE] 뉴스특보 : "수도권 거리두기, 2주간 2단계로 조정"', 'description': 'md5:df7f0c237a5ed5e786ce5c91efbeaab3', 'channel_id': 'NTV-ytnnews24-0', 'start_time': 1597026780000}}, {'url': 'https://tv.naver.com/l/51549', 'info_dict': {'id': '51549', 'ext': 'mp4', 'title': '연합뉴스TV - 코로나19 뉴스특보', 'description': 'md5:c655e82091bc21e413f549c0eaccc481', 'channel_id': 'NTV-yonhapnewstv-0', 'start_time': 1596406380000}}, {'url': 'https://tv.naver.com/l/54887', 'only_matching': True}]
...
class NaverNowIE(NaverBaseIE):
    ...
    _TESTS = [{'url': 'https://now.naver.com/s/now.4759?shareReplayId=26331132#replay=', 'md5': 'e05854162c21c221481de16b2944a0bc', 'info_dict': {'id': '4759-26331132', 'title': '아이키X노제\r\n💖꽁냥꽁냥💖(1)', 'ext': 'mp4', 'thumbnail': 're:^https?://.*\\.jpg', 'timestamp': 1650369600, 'upload_date': '20220419', 'uploader_id': 'now', 'view_count': int, 'uploader_url': 'https://now.naver.com/show/4759', 'uploader': '아이키의 떰즈업'}, 'params': {'noplaylist': True}}, {'url': 'https://now.naver.com/s/now.4759?shareHightlight=26601461#highlight=', 'md5': '9f6118e398aa0f22b2152f554ea7851b', 'info_dict': {'id': '4759-26601461', 'title': '아이키: 나 리정한테 흔들렸어,,, 질투 폭발하는 노제 여보😾 [아이키의 떰즈업]ㅣ네이버 NOW.', 'ext': 'mp4', 'thumbnail': 're:^https?://.*\\.jpg', 'upload_date': '20220504', 'timestamp': 1651648311, 'uploader_id': 'now', 'view_count': int, 'uploader_url': 'https://now.naver.com/show/4759', 'uploader': '아이키의 떰즈업'}, 'params': {'noplaylist': True}}, {'url': 'https://now.naver.com/s/now.4759', 'info_dict': {'id': '4759', 'title': '아이키의 떰즈업'}, 'playlist_mincount': 101}, {'url': 'https://now.naver.com/s/now.4759?shareReplayId=26331132#replay', 'info_dict': {'id': '4759', 'title': '아이키의 떰즈업'}, 'playlist_mincount': 101}, {'url': 'https://now.naver.com/s/now.4759?shareHightlight=26601461#highlight=', 'info_dict': {'id': '4759', 'title': '아이키의 떰즈업'}, 'playlist_mincount': 101}, {'url': 'https://now.naver.com/s/now.kihyunplay?shareReplayId=30573291#replay', 'only_matching': True}]
