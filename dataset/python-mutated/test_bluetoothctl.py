...
import re
import unittest
from jc.parsers.bluetoothctl import _controller_head_pattern, _controller_line_pattern, _device_head_pattern, _device_line_pattern, _parse_controller, _parse_device, Controller, Device, parse
