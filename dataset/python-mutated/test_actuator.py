...
import pytest
from sympy import S, Matrix, Symbol, SympifyError, sqrt
from sympy.physics.mechanics import ActuatorBase, Force, ForceActuator, KanesMethod, LinearDamper, LinearPathway, LinearSpring, Particle, PinJoint, Point, ReferenceFrame, RigidBody, TorqueActuator, Vector, dynamicsymbols
...
class TestForcedMassSpringDamperModel:
    """A single degree of freedom translational forced mass-spring-damper.
