...
import proto
__protobuf__ = proto.module(package='google.cloud.baremetalsolution.v2', manifest={'NfsShare', 'GetNfsShareRequest', 'ListNfsSharesRequest', 'ListNfsSharesResponse', 'UpdateNfsShareRequest', 'RenameNfsShareRequest', 'CreateNfsShareRequest', 'DeleteNfsShareRequest'})
...
class NfsShare(proto.Message):
    ...
    class AllowedClient(proto.Message):
        ...
        share_ip: str = proto.Field(proto.STRING, number=2)
        allowed_clients_cidr: str = proto.Field(proto.STRING, number=3)
        mount_permissions: 'NfsShare.MountPermissions' = proto.Field(proto.ENUM, number=4, enum='NfsShare.MountPermissions')
        allow_dev: bool = proto.Field(proto.BOOL, number=5)
        allow_suid: bool = proto.Field(proto.BOOL, number=6)
        no_root_squash: bool = proto.Field(proto.BOOL, number=7)
        nfs_path: str = proto.Field(proto.STRING, number=8)
    name: str = proto.Field(proto.STRING, number=1)
    nfs_share_id: str = proto.Field(proto.STRING, number=2)
    id: str = proto.Field(proto.STRING, number=8)
    state: State = proto.Field(proto.ENUM, number=3, enum=State)
    volume: str = proto.Field(proto.STRING, number=4)
    allowed_clients: MutableSequence[AllowedClient] = proto.RepeatedField(proto.MESSAGE, number=5, message=AllowedClient)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
    requested_size_gib: int = proto.Field(proto.INT64, number=7)
    storage_type: StorageType = proto.Field(proto.ENUM, number=9, enum=StorageType)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    nfs_shares: MutableSequence['NfsShare'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NfsShare')
...
class UpdateNfsShareRequest(proto.Message):
    ...
    """
    nfs_share: 'NfsShare' = proto.Field(proto.MESSAGE, number=1, message='NfsShare')
...
class RenameNfsShareRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    new_nfsshare_id: str = proto.Field(proto.STRING, number=2)
...
class CreateNfsShareRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    nfs_share: 'NfsShare' = proto.Field(proto.MESSAGE, number=2, message='NfsShare')
