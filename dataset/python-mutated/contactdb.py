...
CTYPES = {'buddy': '好友', 'group': '群', 'discuss': '讨论组', 'group-member': '成员', 'discuss-member': '成员'}
...
for cls in [Buddy, Group, Discuss, GroupMember, DiscussMember]:
    ...
    cls.fields = [row.strip().split(None, 1)[0] for row in cls.columns.strip().split('\n')]
...
if __name__ == '__main__':
    db = ContactDB()
    db.Update('buddy', [['qq1', 'uin1', 'nick昵称1', 'mark备注1', 'name名称1'], ['qq2', 'uin2', 'nick昵称2', 'mark备注2', 'name名称2']])
    bl = db.List('buddy')
    print((bl, bl[0].__dict__))
    print(db.List('buddy', 'nick=nick昵称2'))
    print(db.List('buddy', 'name名称1'))
    db.Update('group', [['123456', 'uin849384', '昵称1', '备注1', '名称1', 'gcode1'], ['456789', 'uin823484', '昵称2', '备注2', '名称2', 'gcode2']])
    print(db.List('group', '12345'))
    g = db.List('group', '123456')[0]
    db.Update(g, [['123456', 'uin849384', '昵称1', '备注1', '名片1', '名称1', 123456, 78944, '成员', 2, 0, 100, 'tucao', 100], ['123456', 'uin845684', '昵称2', '备注2', '名片2', '名称2', 123456, 78944, '成员', 2, 0, 100, 'tucao', 100]])
