...
def main():
    ...
    response = client.static_sites.get_build_database_connection_with_details(resource_group_name='rg', name='testStaticSite0', environment_name='default', database_connection_name='default')
    print(response)
