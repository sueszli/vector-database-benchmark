...
class CommandSet(Dmenu):
    ...
    """
    defaults = [('commands', None, 'dictionary of commands where key is runable command'), ('pre_commands', None, 'list of commands to be executed before getting dmenu answer')]
