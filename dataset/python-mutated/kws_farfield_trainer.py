...
from modelscope.msdatasets.dataset_cls.custom_datasets.audio import KWSDataLoader, KWSDataset
...
from modelscope.utils.torch_utils import get_dist_info, get_local_rank, init_dist, is_master
logger = get_logger()
...
class KWSFarfieldTrainer(BaseTrainer):
    ...
    conf_keys = (BASETRAIN_CONF_EASY, FINETUNE_CONF_EASY, BASETRAIN_CONF_NORMAL, FINETUNE_CONF_NORMAL, BASETRAIN_CONF_HARD, FINETUNE_CONF_HARD)
