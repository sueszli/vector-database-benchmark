...
class PReLUTest(testing.TestCase):
    ...
    def test_prelu(self):
        if False:
            while True:
                i = 10
        self.run_layer_test(prelu.PReLU, init_kwargs={'alpha_initializer': 'zeros', 'alpha_regularizer': 'L1', 'alpha_constraint': 'MaxNorm', 'shared_axes': 1}, input_shape=(2, 3, 4), supports_masking=True)
    ...
    def test_prelu_correctness(self):
        ...
        prelu_layer = prelu.PReLU(alpha_initializer='glorot_uniform', alpha_regularizer='l1', alpha_constraint='non_neg', shared_axes=(1, 2))
