...
ALL_PROCESSORS = [processors.aggregate_repeated_calls, processors.group_library_frames_processor, processors.merge_consecutive_self_time, processors.remove_importlib, processors.remove_tracebackhide, processors.remove_unnecessary_self_time_nodes, processors.remove_irrelevant_nodes]
