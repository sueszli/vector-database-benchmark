...
class AndroidPhoneNotify(Notifier):
    ...
    def send(self, event, msg, key):
        if False:
            print('Hello World!')
        self.load('http://www.notifymyandroid.com/publicapi/notify', get={'apikey': key, 'application': 'pyLoad', 'event': event, 'description': msg})