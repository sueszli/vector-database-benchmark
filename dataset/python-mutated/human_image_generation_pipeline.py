...
from modelscope.models.cv.human_image_generation import human_image_generation_infer
...
@PIPELINES.register_module(Tasks.human_image_generation, module_name=Pipelines.human_image_generation)
class FreqHPTForHumanImageGenerationPipeline(Pipeline):
    ...
    def forward(self, input: Dict[str, Any]) -> Dict[str, Any]:
        if False:
            return 10
        human_image_generation = human_image_generation_infer.infer(self.model, input['source_img_path'], input['target_pose_path'], self.device)
