...
_ALL_INPUT_TYPES = [constant_op.constant(True, dtype=dtypes.bool), constant_op.constant(1, dtype=dtypes.uint8), constant_op.constant(1, dtype=dtypes.uint16), constant_op.constant(1, dtype=dtypes.uint32), constant_op.constant(1, dtype=dtypes.uint64), constant_op.constant(1, dtype=dtypes.int8), constant_op.constant(1, dtype=dtypes.int16), constant_op.constant(1, dtype=dtypes.int32), constant_op.constant(1, dtype=dtypes.int64), constant_op.constant(1, dtype=dtypes.bfloat16), constant_op.constant(1, dtype=dtypes.float16), constant_op.constant(1, dtype=dtypes.float32), constant_op.constant(1, dtype=dtypes.float64), constant_op.constant(1, dtype=dtypes.complex64), constant_op.constant(1, dtype=dtypes.complex128), constant_op.constant(1), np.array(True, dtype=np.bool_), np.array(1, dtype=np.uint8), np.array(1, dtype=np.uint16), np.array(1, dtype=np.uint32), np.array(1, dtype=np.uint64), np.array(1, dtype=np.int8), np.array(1, dtype=np.int16), np.array(1, dtype=np.int32), np.array(1, dtype=np.int64), np.array(1, dtype=np.float16), np.array(1, dtype=np.float32), np.array(1, dtype=np.float64), np.array(1, dtype=np.complex64), np.array(1, dtype=np.complex128), np.array(1), np.uint8(1), np.uint16(1), np.uint32(1), np.uint64(1), np.int8(1), np.int16(1), np.int32(1), np.int64(1), np.float16(1), np.float32(1), np.float64(1), np.complex64(1), np.complex128(1), np.int_(), 1, 1.0, 1j]
