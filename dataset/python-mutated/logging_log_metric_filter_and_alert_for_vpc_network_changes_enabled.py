...
class logging_log_metric_filter_and_alert_for_vpc_network_changes_enabled(Check):
    ...
    def execute(self) -> Check_Report_GCP:
        ...
        for metric in logging_client.metrics:
            if 'resource.type="gce_network" AND (protoPayload.methodName:"compute.networks.insert" OR protoPayload.methodName:"compute.networks.patch" OR protoPayload.methodName:"compute.networks.delete" OR protoPayload.methodName:"compute.networks.removePeering" OR protoPayload.methodName:"compute.networks.addPeering")' in metric.filter:
