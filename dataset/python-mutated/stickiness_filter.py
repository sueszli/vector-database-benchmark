...
from .mixins.common import ClientQueryIdMixin, CompareMixin, EntitiesMixin, EntityIdMixin, EntityMathMixin, EntityOrderMixin, EntityTypeMixin, FilterTestAccountsMixin, InsightMixin, LimitMixin, OffsetMixin, SampleMixin, SearchMixin, ShownAsMixin
...
class StickinessFilter(TotalIntervalsDerivedMixin, EntitiesMixin, EntityIdMixin, EntityTypeMixin, EntityOrderMixin, EntityMathMixin, SelectedIntervalMixin, SearchMixin, PropertyMixin, FilterTestAccountsMixin, OffsetMixin, CompareMixin, ShownAsMixin, InsightMixin, SimplifyFilterMixin, LimitMixin, ClientQueryIdMixin, SampleMixin, BaseFilter):
