...
class DynamoDBToS3Operator(AwsToAwsBaseOperator):
    ...
    """
    template_fields: Sequence[str] = (*AwsToAwsBaseOperator.template_fields, 'dynamodb_table_name', 's3_bucket_name', 'file_size', 'dynamodb_scan_kwargs', 's3_key_prefix', 'process_func', 'export_time', 'export_format', 'check_interval', 'max_attempts')
    template_fields_renderers = {'dynamodb_scan_kwargs': 'json'}
