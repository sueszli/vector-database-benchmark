...
class EditForumTopic(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], message_thread_id: int, name: Optional[str]=None, icon_custom_emoji_id: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(chat_id=chat_id, message_thread_id=message_thread_id, name=name, icon_custom_emoji_id=icon_custom_emoji_id, **__pydantic_kwargs)