...
class Migration(migrations.Migration):
    dependencies = [('wagtailcore', '0080_generic_workflowstate')]
    operations = [migrations.RunPython(populate_workflowstate_content_type, empty_workflowstate_content_type)]