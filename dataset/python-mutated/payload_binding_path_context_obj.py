...
from localstack.services.stepfunctions.asl.component.common.payload.payloadvalue.payloadbinding.payload_binding import PayloadBinding
...
class PayloadBindingPathContextObj(PayloadBinding):
    ...
    def _eval_val(self, env: Environment) -> Any:
        ...
        if self.path_context_obj.endswith('Task.Token'):
            ...
            value = JSONPathUtils.extract_json(self.path_context_obj, env.context_object_manager.context_object)
        return value