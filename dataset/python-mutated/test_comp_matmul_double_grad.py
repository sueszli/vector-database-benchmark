...
@param.parameterized_class(('primal0', 'primal1', 'primal2', 'trans_0', 'trans_1', 'dtype'), [(np.random.rand(2, 3, 4), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), False, False, np.float16), (np.random.rand(2, 4, 3), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), True, False, np.float16), (np.random.rand(2, 3, 4), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), False, True, np.float16), (np.random.rand(2, 4, 3), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), True, True, np.float16), (np.random.rand(2, 1, 5, 2), np.random.rand(1, 3, 2, 4), np.random.rand(2, 3, 5, 4), False, False, np.float16), (np.random.rand(2, 3, 4), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), False, False, np.float32), (np.random.rand(2, 4, 3), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), True, False, np.float32), (np.random.rand(2, 3, 4), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), False, True, np.float32), (np.random.rand(2, 4, 3), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), True, True, np.float32), (np.random.rand(2, 1, 5, 2), np.random.rand(1, 3, 2, 4), np.random.rand(2, 3, 5, 4), False, False, np.float32), (np.random.rand(2, 3, 4), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), False, False, np.float64), (np.random.rand(2, 4, 3), np.random.rand(2, 4, 5), np.random.rand(2, 3, 5), True, False, np.float64), (np.random.rand(2, 3, 4), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), False, True, np.float64), (np.random.rand(2, 4, 3), np.random.rand(2, 5, 4), np.random.rand(2, 3, 5), True, True, np.float64), (np.random.rand(2, 1, 5, 2), np.random.rand(1, 3, 2, 4), np.random.rand(2, 3, 5, 4), False, False, np.float64)])
