...
class SkyBaseIE(InfoExtractor):
    ...
    _SDC_EL_REGEX = '(?s)(<div[^>]+data-(?:component-name|fn)="sdc-(?:articl|sit)e-video"[^>]*>)'
...
class SkySportsNewsIE(SkyBaseIE):
    ...
    _TEST = {'url': 'http://www.skysports.com/golf/news/12176/10871916/dustin-johnson-ready-to-conquer-players-championship-at-tpc-sawgrass', 'info_dict': {'id': '10871916', 'title': 'Dustin Johnson ready to conquer Players Championship at TPC Sawgrass', 'description': 'Dustin Johnson is confident he can continue his dominant form in 2017 by adding the Players Championship to his list of victories.'}, 'playlist_count': 2}
