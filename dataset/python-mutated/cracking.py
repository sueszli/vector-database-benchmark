...
def extract_text_document_title(text: str, file_name: str) -> Tuple[str, str]:
    ...
    if file_extension == '.md':
        ...
        return (f'Title: {title}', title)
file_extension_loaders = {'.txt': TextFileIOLoader, '.md': TextFileIOLoader, '.html': UnstructuredHTMLFileIOLoader, '.htm': UnstructuredHTMLFileIOLoader, '.py': TextFileIOLoader, '.pdf': PDFFileLoader, '.ppt': TikaLoader, '.pptx': TikaLoader, '.doc': TikaLoader, '.docx': TikaLoader, '.xls': TikaLoader, '.xlsx': TikaLoader}
