...
class DetachTab(RemoteCommand):
    ...
    desc = 'Detach the specified tabs and either move them into a new OS window or add them to the OS window containing the tab specified by :option:`kitten @ detach-tab --target-tab`'
