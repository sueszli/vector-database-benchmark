...
def list_job_templates(project_id: str, location: str) -> pagers.ListJobTemplatesPager:
    if False:
        print('Hello World!')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--location', help='The location of the templates.', required=True)
