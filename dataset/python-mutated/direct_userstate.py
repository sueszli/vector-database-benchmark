...
class ReadModifyWriteRuntimeState(DirectRuntimeState, userstate.ReadModifyWriteRuntimeState):
...
class CombiningValueRuntimeState(DirectRuntimeState, userstate.CombiningValueRuntimeState):
