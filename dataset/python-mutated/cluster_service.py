...
class UpgradeResourceType(proto.Enum):
    """UpgradeResourceType is the resource type that is upgrading.
...
class LinuxNodeConfig(proto.Message):
    ...
    class CgroupMode(proto.Enum):
        ...
        CGROUP_MODE_V1 = 1
        CGROUP_MODE_V2 = 2
    sysctls: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
    cgroup_mode: CgroupMode = proto.Field(proto.ENUM, number=2, enum=CgroupMode)
...
class WindowsNodeConfig(proto.Message):
    ...
    class OSVersion(proto.Enum):
        ...
        OS_VERSION_LTSC2019 = 1
        OS_VERSION_LTSC2022 = 2
    os_version: OSVersion = proto.Field(proto.ENUM, number=1, enum=OSVersion)
...
class NodeKubeletConfig(proto.Message):
    ...
    """
    cpu_manager_policy: str = proto.Field(proto.STRING, number=1)
    cpu_cfs_quota: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=2, message=wrappers_pb2.BoolValue)
    cpu_cfs_quota_period: str = proto.Field(proto.STRING, number=3)
    pod_pids_limit: int = proto.Field(proto.INT64, number=4)
    insecure_kubelet_readonly_port_enabled: bool = proto.Field(proto.BOOL, number=7, optional=True)
...
class NodeConfig(proto.Message):
    ...
    Attributes:
        ...
        enable_confidential_storage (bool):
            ...
            for private preview.
    """
    machine_type: str = proto.Field(proto.STRING, number=1)
    disk_size_gb: int = proto.Field(proto.INT32, number=2)
    oauth_scopes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    service_account: str = proto.Field(proto.STRING, number=9)
    metadata: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    image_type: str = proto.Field(proto.STRING, number=5)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
    local_ssd_count: int = proto.Field(proto.INT32, number=7)
    tags: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=8)
    preemptible: bool = proto.Field(proto.BOOL, number=10)
    accelerators: MutableSequence['AcceleratorConfig'] = proto.RepeatedField(proto.MESSAGE, number=11, message='AcceleratorConfig')
    sandbox_config: 'SandboxConfig' = proto.Field(proto.MESSAGE, number=17, message='SandboxConfig')
    node_group: str = proto.Field(proto.STRING, number=18)
    reservation_affinity: 'ReservationAffinity' = proto.Field(proto.MESSAGE, number=19, message='ReservationAffinity')
    disk_type: str = proto.Field(proto.STRING, number=12)
    min_cpu_platform: str = proto.Field(proto.STRING, number=13)
    workload_metadata_config: 'WorkloadMetadataConfig' = proto.Field(proto.MESSAGE, number=14, message='WorkloadMetadataConfig')
    taints: MutableSequence['NodeTaint'] = proto.RepeatedField(proto.MESSAGE, number=15, message='NodeTaint')
    boot_disk_kms_key: str = proto.Field(proto.STRING, number=23)
    shielded_instance_config: 'ShieldedInstanceConfig' = proto.Field(proto.MESSAGE, number=20, message='ShieldedInstanceConfig')
    linux_node_config: 'LinuxNodeConfig' = proto.Field(proto.MESSAGE, number=21, message='LinuxNodeConfig')
    kubelet_config: 'NodeKubeletConfig' = proto.Field(proto.MESSAGE, number=22, message='NodeKubeletConfig')
    ephemeral_storage_config: 'EphemeralStorageConfig' = proto.Field(proto.MESSAGE, number=24, message='EphemeralStorageConfig')
    gcfs_config: 'GcfsConfig' = proto.Field(proto.MESSAGE, number=25, message='GcfsConfig')
    advanced_machine_features: 'AdvancedMachineFeatures' = proto.Field(proto.MESSAGE, number=26, message='AdvancedMachineFeatures')
    gvnic: 'VirtualNIC' = proto.Field(proto.MESSAGE, number=29, message='VirtualNIC')
    spot: bool = proto.Field(proto.BOOL, number=32)
    confidential_nodes: 'ConfidentialNodes' = proto.Field(proto.MESSAGE, number=35, message='ConfidentialNodes')
    fast_socket: 'FastSocket' = proto.Field(proto.MESSAGE, number=36, optional=True, message='FastSocket')
    resource_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=37)
    logging_config: 'NodePoolLoggingConfig' = proto.Field(proto.MESSAGE, number=38, message='NodePoolLoggingConfig')
    windows_node_config: 'WindowsNodeConfig' = proto.Field(proto.MESSAGE, number=39, message='WindowsNodeConfig')
    local_nvme_ssd_block_config: 'LocalNvmeSsdBlockConfig' = proto.Field(proto.MESSAGE, number=40, message='LocalNvmeSsdBlockConfig')
    ephemeral_storage_local_ssd_config: 'EphemeralStorageLocalSsdConfig' = proto.Field(proto.MESSAGE, number=41, message='EphemeralStorageLocalSsdConfig')
    sole_tenant_config: 'SoleTenantConfig' = proto.Field(proto.MESSAGE, number=42, message='SoleTenantConfig')
    host_maintenance_policy: 'HostMaintenancePolicy' = proto.Field(proto.MESSAGE, number=44, message='HostMaintenancePolicy')
    resource_manager_tags: 'ResourceManagerTags' = proto.Field(proto.MESSAGE, number=45, message='ResourceManagerTags')
    enable_confidential_storage: bool = proto.Field(proto.BOOL, number=46)
...
class NodeNetworkConfig(proto.Message):
    ...
    class NetworkPerformanceConfig(proto.Message):
        ...
        class Tier(proto.Enum):
            ...
            TIER_UNSPECIFIED = 0
            TIER_1 = 1
        total_egress_bandwidth_tier: 'NodeNetworkConfig.NetworkPerformanceConfig.Tier' = proto.Field(proto.ENUM, number=1, optional=True, enum='NodeNetworkConfig.NetworkPerformanceConfig.Tier')
        external_ip_egress_bandwidth_tier: 'NodeNetworkConfig.NetworkPerformanceConfig.Tier' = proto.Field(proto.ENUM, number=2, optional=True, enum='NodeNetworkConfig.NetworkPerformanceConfig.Tier')
    create_pod_range: bool = proto.Field(proto.BOOL, number=4)
    pod_range: str = proto.Field(proto.STRING, number=5)
    pod_ipv4_cidr_block: str = proto.Field(proto.STRING, number=6)
    enable_private_nodes: bool = proto.Field(proto.BOOL, number=9, optional=True)
    network_performance_config: NetworkPerformanceConfig = proto.Field(proto.MESSAGE, number=11, optional=True, message=NetworkPerformanceConfig)
    pod_cidr_overprovision_config: 'PodCIDROverprovisionConfig' = proto.Field(proto.MESSAGE, number=13, message='PodCIDROverprovisionConfig')
    additional_node_network_configs: MutableSequence['AdditionalNodeNetworkConfig'] = proto.RepeatedField(proto.MESSAGE, number=14, message='AdditionalNodeNetworkConfig')
    additional_pod_network_configs: MutableSequence['AdditionalPodNetworkConfig'] = proto.RepeatedField(proto.MESSAGE, number=15, message='AdditionalPodNetworkConfig')
    pod_ipv4_range_utilization: float = proto.Field(proto.DOUBLE, number=16)

class AdditionalNodeNetworkConfig(proto.Message):
    """AdditionalNodeNetworkConfig is the configuration for
    ...
    Attributes:
        ...
        subnetwork (str):
            ...
            interface belongs
    """
    network: str = proto.Field(proto.STRING, number=1)
    subnetwork: str = proto.Field(proto.STRING, number=2)

class AdditionalPodNetworkConfig(proto.Message):
    """AdditionalPodNetworkConfig is the configuration for
    ...
    """
    subnetwork: str = proto.Field(proto.STRING, number=1)
    secondary_pod_range: str = proto.Field(proto.STRING, number=2)
    max_pods_per_node: 'MaxPodsConstraint' = proto.Field(proto.MESSAGE, number=3, optional=True, message='MaxPodsConstraint')
...
class ShieldedInstanceConfig(proto.Message):
    ...
    Attributes:
        ...
        enable_integrity_monitoring (bool):
            ...
            is created.
    """
    enable_secure_boot: bool = proto.Field(proto.BOOL, number=1)
    enable_integrity_monitoring: bool = proto.Field(proto.BOOL, number=2)

class SandboxConfig(proto.Message):
    """SandboxConfig contains configurations of the sandbox to use
    for the node.
    ...
    class Type(proto.Enum):
        ...
        UNSPECIFIED = 0
        GVISOR = 1
    sandbox_type: str = proto.Field(proto.STRING, number=1)
    type_: Type = proto.Field(proto.ENUM, number=2, enum=Type)

class EphemeralStorageConfig(proto.Message):
    """EphemeralStorageConfig contains configuration for the
    ...
    Attributes:
        local_ssd_count (int):
            ...
            2. For Gen3 machines which dictate a specific number of
               ...
               for more info.
    """
    local_ssd_count: int = proto.Field(proto.INT32, number=1)

class LocalNvmeSsdBlockConfig(proto.Message):
    """LocalNvmeSsdBlockConfig contains configuration for using
...
class EphemeralStorageLocalSsdConfig(proto.Message):
    """EphemeralStorageLocalSsdConfig contains configuration for the
...
class GcfsConfig(proto.Message):
    """GcfsConfig contains configurations of Google Container File
    System.
...
class ReservationAffinity(proto.Message):
    """`ReservationAffinity <https://cloud.google.com/compute/docs/instances/reserving-zonal-resources>`__
    ...
    class Type(proto.Enum):
        """Indicates whether to consume capacity from a reservation or
        not.
        ...
        ANY_RESERVATION = 2
        SPECIFIC_RESERVATION = 3
    consume_reservation_type: Type = proto.Field(proto.ENUM, number=1, enum=Type)
    key: str = proto.Field(proto.STRING, number=2)
    values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)

class SoleTenantConfig(proto.Message):
    """SoleTenantConfig contains the NodeAffinities to specify what
    ...
    class NodeAffinity(proto.Message):
        ...
        class Operator(proto.Enum):
            """Operator allows user to specify affinity or anti-affinity for
            ...
            IN = 1
            NOT_IN = 2
        key: str = proto.Field(proto.STRING, number=1)
        operator: 'SoleTenantConfig.NodeAffinity.Operator' = proto.Field(proto.ENUM, number=2, enum='SoleTenantConfig.NodeAffinity.Operator')
        values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    node_affinities: MutableSequence[NodeAffinity] = proto.RepeatedField(proto.MESSAGE, number=1, message=NodeAffinity)

class HostMaintenancePolicy(proto.Message):
    """HostMaintenancePolicy contains the maintenance policy for the
    ...
    class MaintenanceInterval(proto.Enum):
        """Allows selecting how infrastructure upgrades should be
    ...
    class OpportunisticMaintenanceStrategy(proto.Message):
        ...
        """
        node_idle_time_window: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=1, optional=True, message=duration_pb2.Duration)
        maintenance_availability_window: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, optional=True, message=duration_pb2.Duration)
        min_nodes_per_pool: int = proto.Field(proto.INT64, number=3, optional=True)
    maintenance_interval: MaintenanceInterval = proto.Field(proto.ENUM, number=1, optional=True, enum=MaintenanceInterval)
    opportunistic_maintenance_strategy: OpportunisticMaintenanceStrategy = proto.Field(proto.MESSAGE, number=2, oneof='maintenance_strategy', message=OpportunisticMaintenanceStrategy)

class NodeTaint(proto.Message):
    """Kubernetes taint is composed of three fields: key, value, and
    ...
    class Effect(proto.Enum):
        ...
        NO_EXECUTE = 3
    key: str = proto.Field(proto.STRING, number=1)
    value: str = proto.Field(proto.STRING, number=2)
    effect: Effect = proto.Field(proto.ENUM, number=3, enum=Effect)
...
class NodeTaints(proto.Message):
    ...
    Attributes:
        taints (MutableSequence[google.cloud.container_v1beta1.types.NodeTaint]):
            List of node taints.
    """
    taints: MutableSequence['NodeTaint'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NodeTaint')
...
class NodeLabels(proto.Message):
    ...
    """
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
...
class NetworkTags(proto.Message):
    ...
    """
    tags: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class MasterAuth(proto.Message):
    ...
    """
    username: str = proto.Field(proto.STRING, number=1)
    password: str = proto.Field(proto.STRING, number=2)
    client_certificate_config: 'ClientCertificateConfig' = proto.Field(proto.MESSAGE, number=3, message='ClientCertificateConfig')
    cluster_ca_certificate: str = proto.Field(proto.STRING, number=100)
    client_certificate: str = proto.Field(proto.STRING, number=101)
    client_key: str = proto.Field(proto.STRING, number=102)
...
class ClientCertificateConfig(proto.Message):
    ...
    """
    issue_client_certificate: bool = proto.Field(proto.BOOL, number=1)

class AddonsConfig(proto.Message):
    """Configuration for the addons that can be automatically spun
    ...
    Attributes:
        ...
        gcs_fuse_csi_driver_config (google.cloud.container_v1beta1.types.GcsFuseCsiDriverConfig):
            ...
            driver.
    """
    http_load_balancing: 'HttpLoadBalancing' = proto.Field(proto.MESSAGE, number=1, message='HttpLoadBalancing')
    horizontal_pod_autoscaling: 'HorizontalPodAutoscaling' = proto.Field(proto.MESSAGE, number=2, message='HorizontalPodAutoscaling')
    kubernetes_dashboard: 'KubernetesDashboard' = proto.Field(proto.MESSAGE, number=3, message='KubernetesDashboard')
    network_policy_config: 'NetworkPolicyConfig' = proto.Field(proto.MESSAGE, number=4, message='NetworkPolicyConfig')
    istio_config: 'IstioConfig' = proto.Field(proto.MESSAGE, number=5, message='IstioConfig')
    cloud_run_config: 'CloudRunConfig' = proto.Field(proto.MESSAGE, number=7, message='CloudRunConfig')
    dns_cache_config: 'DnsCacheConfig' = proto.Field(proto.MESSAGE, number=8, message='DnsCacheConfig')
    config_connector_config: 'ConfigConnectorConfig' = proto.Field(proto.MESSAGE, number=10, message='ConfigConnectorConfig')
    gce_persistent_disk_csi_driver_config: 'GcePersistentDiskCsiDriverConfig' = proto.Field(proto.MESSAGE, number=11, message='GcePersistentDiskCsiDriverConfig')
    kalm_config: 'KalmConfig' = proto.Field(proto.MESSAGE, number=12, message='KalmConfig')
    gcp_filestore_csi_driver_config: 'GcpFilestoreCsiDriverConfig' = proto.Field(proto.MESSAGE, number=14, message='GcpFilestoreCsiDriverConfig')
    gke_backup_agent_config: 'GkeBackupAgentConfig' = proto.Field(proto.MESSAGE, number=16, message='GkeBackupAgentConfig')
    gcs_fuse_csi_driver_config: 'GcsFuseCsiDriverConfig' = proto.Field(proto.MESSAGE, number=17, message='GcsFuseCsiDriverConfig')

class HttpLoadBalancing(proto.Message):
    """Configuration options for the HTTP (L7) load balancing
    ...
    Attributes:
        disabled (bool):
            ...
            balancers.
    """
    disabled: bool = proto.Field(proto.BOOL, number=1)

class HorizontalPodAutoscaling(proto.Message):
    """Configuration options for the horizontal pod autoscaling
...
class PrivateClusterConfig(proto.Message):
    ...
    """
    enable_private_nodes: bool = proto.Field(proto.BOOL, number=1)
    enable_private_endpoint: bool = proto.Field(proto.BOOL, number=2)
    master_ipv4_cidr_block: str = proto.Field(proto.STRING, number=3)
    private_endpoint: str = proto.Field(proto.STRING, number=4)
    public_endpoint: str = proto.Field(proto.STRING, number=5)
    peering_name: str = proto.Field(proto.STRING, number=7)
    master_global_access_config: 'PrivateClusterMasterGlobalAccessConfig' = proto.Field(proto.MESSAGE, number=8, message='PrivateClusterMasterGlobalAccessConfig')
    private_endpoint_subnetwork: str = proto.Field(proto.STRING, number=10)
...
class IstioConfig(proto.Message):
    ...
    class IstioAuthMode(proto.Enum):
        ...
        AUTH_MUTUAL_TLS = 1
    disabled: bool = proto.Field(proto.BOOL, number=1)
    auth: IstioAuthMode = proto.Field(proto.ENUM, number=2, enum=IstioAuthMode)
...
class CloudRunConfig(proto.Message):
    ...
    class LoadBalancerType(proto.Enum):
        ...
        LOAD_BALANCER_TYPE_INTERNAL = 2
    disabled: bool = proto.Field(proto.BOOL, number=1)
    load_balancer_type: LoadBalancerType = proto.Field(proto.ENUM, number=3, enum=LoadBalancerType)
...
class MasterAuthorizedNetworksConfig(proto.Message):
    ...
    class CidrBlock(proto.Message):
        ...
        """
        display_name: str = proto.Field(proto.STRING, number=1)
        cidr_block: str = proto.Field(proto.STRING, number=2)
    enabled: bool = proto.Field(proto.BOOL, number=1)
    cidr_blocks: MutableSequence[CidrBlock] = proto.RepeatedField(proto.MESSAGE, number=2, message=CidrBlock)
    gcp_public_cidrs_access_enabled: bool = proto.Field(proto.BOOL, number=3, optional=True)
...
class NetworkPolicy(proto.Message):
    ...
    class Provider(proto.Enum):
        ...
        PROVIDER_UNSPECIFIED = 0
        CALICO = 1
    provider: Provider = proto.Field(proto.ENUM, number=1, enum=Provider)
    enabled: bool = proto.Field(proto.BOOL, number=2)
...
class PodCIDROverprovisionConfig(proto.Message):
    ...
    Attributes:
        disable (bool):
            ...
            enabled by default.
    """
    disable: bool = proto.Field(proto.BOOL, number=1)
...
class IPAllocationPolicy(proto.Message):
    ...
    class IPv6AccessType(proto.Enum):
        ...
        INTERNAL = 1
        EXTERNAL = 2
    use_ip_aliases: bool = proto.Field(proto.BOOL, number=1)
    create_subnetwork: bool = proto.Field(proto.BOOL, number=2)
    subnetwork_name: str = proto.Field(proto.STRING, number=3)
    cluster_ipv4_cidr: str = proto.Field(proto.STRING, number=4)
    node_ipv4_cidr: str = proto.Field(proto.STRING, number=5)
    services_ipv4_cidr: str = proto.Field(proto.STRING, number=6)
    cluster_secondary_range_name: str = proto.Field(proto.STRING, number=7)
    services_secondary_range_name: str = proto.Field(proto.STRING, number=8)
    cluster_ipv4_cidr_block: str = proto.Field(proto.STRING, number=9)
    node_ipv4_cidr_block: str = proto.Field(proto.STRING, number=10)
    services_ipv4_cidr_block: str = proto.Field(proto.STRING, number=11)
    allow_route_overlap: bool = proto.Field(proto.BOOL, number=12)
    tpu_ipv4_cidr_block: str = proto.Field(proto.STRING, number=13)
    use_routes: bool = proto.Field(proto.BOOL, number=15)
    stack_type: StackType = proto.Field(proto.ENUM, number=16, enum=StackType)
    ipv6_access_type: IPv6AccessType = proto.Field(proto.ENUM, number=17, enum=IPv6AccessType)
    pod_cidr_overprovision_config: 'PodCIDROverprovisionConfig' = proto.Field(proto.MESSAGE, number=21, message='PodCIDROverprovisionConfig')
    subnet_ipv6_cidr_block: str = proto.Field(proto.STRING, number=22)
    services_ipv6_cidr_block: str = proto.Field(proto.STRING, number=23)
    additional_pod_ranges_config: 'AdditionalPodRangesConfig' = proto.Field(proto.MESSAGE, number=24, message='AdditionalPodRangesConfig')
    default_pod_ipv4_range_utilization: float = proto.Field(proto.DOUBLE, number=25)
...
class BinaryAuthorization(proto.Message):
    ...
    enabled: bool = proto.Field(proto.BOOL, number=1)
    evaluation_mode: EvaluationMode = proto.Field(proto.ENUM, number=2, enum=EvaluationMode)
    policy_bindings: MutableSequence[PolicyBinding] = proto.RepeatedField(proto.MESSAGE, number=5, message=PolicyBinding)
...
class AuthenticatorGroupsConfig(proto.Message):
    """Configuration for returning group information from
    authenticators.
    ...
    """
    enabled: bool = proto.Field(proto.BOOL, number=1)
    security_group: str = proto.Field(proto.STRING, number=2)
...
class ClusterTelemetry(proto.Message):
    ...
    class Type(proto.Enum):
        ...
        ENABLED = 2
        SYSTEM_ONLY = 3
    type_: Type = proto.Field(proto.ENUM, number=1, enum=Type)
...
class Cluster(proto.Message):
    ...
    initial_node_count: int = proto.Field(proto.INT32, number=3)
    node_config: 'NodeConfig' = proto.Field(proto.MESSAGE, number=4, message='NodeConfig')
    master_auth: 'MasterAuth' = proto.Field(proto.MESSAGE, number=5, message='MasterAuth')
    logging_service: str = proto.Field(proto.STRING, number=6)
    monitoring_service: str = proto.Field(proto.STRING, number=7)
    network: str = proto.Field(proto.STRING, number=8)
    cluster_ipv4_cidr: str = proto.Field(proto.STRING, number=9)
    addons_config: 'AddonsConfig' = proto.Field(proto.MESSAGE, number=10, message='AddonsConfig')
    subnetwork: str = proto.Field(proto.STRING, number=11)
    node_pools: MutableSequence['NodePool'] = proto.RepeatedField(proto.MESSAGE, number=12, message='NodePool')
    locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=13)
    enable_kubernetes_alpha: bool = proto.Field(proto.BOOL, number=14)
    enable_k8s_beta_apis: 'K8sBetaAPIConfig' = proto.Field(proto.MESSAGE, number=143, message='K8sBetaAPIConfig')
    resource_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=15)
    label_fingerprint: str = proto.Field(proto.STRING, number=16)
    legacy_abac: 'LegacyAbac' = proto.Field(proto.MESSAGE, number=18, message='LegacyAbac')
    network_policy: 'NetworkPolicy' = proto.Field(proto.MESSAGE, number=19, message='NetworkPolicy')
    ip_allocation_policy: 'IPAllocationPolicy' = proto.Field(proto.MESSAGE, number=20, message='IPAllocationPolicy')
    master_authorized_networks_config: 'MasterAuthorizedNetworksConfig' = proto.Field(proto.MESSAGE, number=22, message='MasterAuthorizedNetworksConfig')
    maintenance_policy: 'MaintenancePolicy' = proto.Field(proto.MESSAGE, number=23, message='MaintenancePolicy')
    binary_authorization: 'BinaryAuthorization' = proto.Field(proto.MESSAGE, number=24, message='BinaryAuthorization')
    pod_security_policy_config: 'PodSecurityPolicyConfig' = proto.Field(proto.MESSAGE, number=25, message='PodSecurityPolicyConfig')
    autoscaling: 'ClusterAutoscaling' = proto.Field(proto.MESSAGE, number=26, message='ClusterAutoscaling')
    network_config: 'NetworkConfig' = proto.Field(proto.MESSAGE, number=27, message='NetworkConfig')
    private_cluster: bool = proto.Field(proto.BOOL, number=28)
    master_ipv4_cidr_block: str = proto.Field(proto.STRING, number=29)
    default_max_pods_constraint: 'MaxPodsConstraint' = proto.Field(proto.MESSAGE, number=30, message='MaxPodsConstraint')
    resource_usage_export_config: 'ResourceUsageExportConfig' = proto.Field(proto.MESSAGE, number=33, message='ResourceUsageExportConfig')
    authenticator_groups_config: 'AuthenticatorGroupsConfig' = proto.Field(proto.MESSAGE, number=34, message='AuthenticatorGroupsConfig')
    private_cluster_config: 'PrivateClusterConfig' = proto.Field(proto.MESSAGE, number=37, message='PrivateClusterConfig')
    vertical_pod_autoscaling: 'VerticalPodAutoscaling' = proto.Field(proto.MESSAGE, number=39, message='VerticalPodAutoscaling')
    shielded_nodes: 'ShieldedNodes' = proto.Field(proto.MESSAGE, number=40, message='ShieldedNodes')
    release_channel: 'ReleaseChannel' = proto.Field(proto.MESSAGE, number=41, message='ReleaseChannel')
    workload_identity_config: 'WorkloadIdentityConfig' = proto.Field(proto.MESSAGE, number=43, message='WorkloadIdentityConfig')
    workload_certificates: 'WorkloadCertificates' = proto.Field(proto.MESSAGE, number=52, message='WorkloadCertificates')
    mesh_certificates: 'MeshCertificates' = proto.Field(proto.MESSAGE, number=67, message='MeshCertificates')
    workload_alts_config: 'WorkloadALTSConfig' = proto.Field(proto.MESSAGE, number=53, message='WorkloadALTSConfig')
    cost_management_config: 'CostManagementConfig' = proto.Field(proto.MESSAGE, number=45, message='CostManagementConfig')
    cluster_telemetry: 'ClusterTelemetry' = proto.Field(proto.MESSAGE, number=46, message='ClusterTelemetry')
    tpu_config: 'TpuConfig' = proto.Field(proto.MESSAGE, number=47, message='TpuConfig')
    notification_config: 'NotificationConfig' = proto.Field(proto.MESSAGE, number=49, message='NotificationConfig')
    confidential_nodes: 'ConfidentialNodes' = proto.Field(proto.MESSAGE, number=50, message='ConfidentialNodes')
    identity_service_config: 'IdentityServiceConfig' = proto.Field(proto.MESSAGE, number=54, message='IdentityServiceConfig')
    self_link: str = proto.Field(proto.STRING, number=100)
    zone: str = proto.Field(proto.STRING, number=101)
    endpoint: str = proto.Field(proto.STRING, number=102)
    initial_cluster_version: str = proto.Field(proto.STRING, number=103)
    current_master_version: str = proto.Field(proto.STRING, number=104)
    current_node_version: str = proto.Field(proto.STRING, number=105)
    create_time: str = proto.Field(proto.STRING, number=106)
    status: Status = proto.Field(proto.ENUM, number=107, enum=Status)
    status_message: str = proto.Field(proto.STRING, number=108)
    node_ipv4_cidr_size: int = proto.Field(proto.INT32, number=109)
    services_ipv4_cidr: str = proto.Field(proto.STRING, number=110)
    instance_group_urls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=111)
    current_node_count: int = proto.Field(proto.INT32, number=112)
    expire_time: str = proto.Field(proto.STRING, number=113)
    location: str = proto.Field(proto.STRING, number=114)
    enable_tpu: bool = proto.Field(proto.BOOL, number=115)
    tpu_ipv4_cidr_block: str = proto.Field(proto.STRING, number=116)
    database_encryption: 'DatabaseEncryption' = proto.Field(proto.MESSAGE, number=38, message='DatabaseEncryption')
    conditions: MutableSequence['StatusCondition'] = proto.RepeatedField(proto.MESSAGE, number=118, message='StatusCondition')
    master: 'Master' = proto.Field(proto.MESSAGE, number=124, message='Master')
    autopilot: 'Autopilot' = proto.Field(proto.MESSAGE, number=128, message='Autopilot')
    id: str = proto.Field(proto.STRING, number=129)
    node_pool_defaults: 'NodePoolDefaults' = proto.Field(proto.MESSAGE, number=131, optional=True, message='NodePoolDefaults')
    logging_config: 'LoggingConfig' = proto.Field(proto.MESSAGE, number=132, message='LoggingConfig')
    monitoring_config: 'MonitoringConfig' = proto.Field(proto.MESSAGE, number=133, message='MonitoringConfig')
    node_pool_auto_config: 'NodePoolAutoConfig' = proto.Field(proto.MESSAGE, number=136, message='NodePoolAutoConfig')
    protect_config: 'ProtectConfig' = proto.Field(proto.MESSAGE, number=137, optional=True, message='ProtectConfig')
    etag: str = proto.Field(proto.STRING, number=139)
    fleet: 'Fleet' = proto.Field(proto.MESSAGE, number=140, message='Fleet')
    security_posture_config: 'SecurityPostureConfig' = proto.Field(proto.MESSAGE, number=145, message='SecurityPostureConfig')
    enterprise_config: 'EnterpriseConfig' = proto.Field(proto.MESSAGE, number=149, message='EnterpriseConfig')
...
class K8sBetaAPIConfig(proto.Message):
    ...
    """
    enabled_apis: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class WorkloadConfig(proto.Message):
    ...
    class Mode(proto.Enum):
        ...
        BASELINE = 2
        RESTRICTED = 3
    audit_mode: Mode = proto.Field(proto.ENUM, number=1, optional=True, enum=Mode)

class ProtectConfig(proto.Message):
    """ProtectConfig defines the flags needed to enable/disable
    ...
    class WorkloadVulnerabilityMode(proto.Enum):
        """WorkloadVulnerabilityMode defines mode to perform
        ...
        DISABLED = 1
        BASIC = 2
    workload_config: 'WorkloadConfig' = proto.Field(proto.MESSAGE, number=1, optional=True, message='WorkloadConfig')
    workload_vulnerability_mode: WorkloadVulnerabilityMode = proto.Field(proto.ENUM, number=2, optional=True, enum=WorkloadVulnerabilityMode)

class SecurityPostureConfig(proto.Message):
    """SecurityPostureConfig defines the flags needed to
    ...
    class Mode(proto.Enum):
        """Mode defines enablement mode for GKE Security posture
        features.
    ...
    class VulnerabilityMode(proto.Enum):
        ...
        VULNERABILITY_BASIC = 2
        VULNERABILITY_ENTERPRISE = 3
    mode: Mode = proto.Field(proto.ENUM, number=1, optional=True, enum=Mode)
    vulnerability_mode: VulnerabilityMode = proto.Field(proto.ENUM, number=2, optional=True, enum=VulnerabilityMode)
...
class NodePoolDefaults(proto.Message):
    ...
    Attributes:
        node_config_defaults (google.cloud.container_v1beta1.types.NodeConfigDefaults):
            ...
            defaults.
    """
    node_config_defaults: 'NodeConfigDefaults' = proto.Field(proto.MESSAGE, number=1, message='NodeConfigDefaults')
...
class NodeConfigDefaults(proto.Message):
    ...
    Attributes:
        ...
        host_maintenance_policy (google.cloud.container_v1beta1.types.HostMaintenancePolicy):
            ...
            hosts.
    """
    gcfs_config: 'GcfsConfig' = proto.Field(proto.MESSAGE, number=1, message='GcfsConfig')
    logging_config: 'NodePoolLoggingConfig' = proto.Field(proto.MESSAGE, number=3, message='NodePoolLoggingConfig')
    host_maintenance_policy: 'HostMaintenancePolicy' = proto.Field(proto.MESSAGE, number=5, message='HostMaintenancePolicy')

class NodePoolAutoConfig(proto.Message):
    """node pool configs that apply to all auto-provisioned node
    ...
    Attributes:
        ...
        resource_manager_tags (google.cloud.container_v1beta1.types.ResourceManagerTags):
            ...
            Policies.
    """
    network_tags: 'NetworkTags' = proto.Field(proto.MESSAGE, number=1, message='NetworkTags')
    resource_manager_tags: 'ResourceManagerTags' = proto.Field(proto.MESSAGE, number=2, message='ResourceManagerTags')

class ClusterUpdate(proto.Message):
    """ClusterUpdate describes an update to the cluster. Exactly one
    ...
    """
    desired_node_version: str = proto.Field(proto.STRING, number=4)
    desired_monitoring_service: str = proto.Field(proto.STRING, number=5)
    desired_addons_config: 'AddonsConfig' = proto.Field(proto.MESSAGE, number=6, message='AddonsConfig')
    desired_node_pool_id: str = proto.Field(proto.STRING, number=7)
    desired_image_type: str = proto.Field(proto.STRING, number=8)
    desired_node_pool_autoscaling: 'NodePoolAutoscaling' = proto.Field(proto.MESSAGE, number=9, message='NodePoolAutoscaling')
    desired_locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=10)
    desired_master_authorized_networks_config: 'MasterAuthorizedNetworksConfig' = proto.Field(proto.MESSAGE, number=12, message='MasterAuthorizedNetworksConfig')
    desired_pod_security_policy_config: 'PodSecurityPolicyConfig' = proto.Field(proto.MESSAGE, number=14, message='PodSecurityPolicyConfig')
    desired_cluster_autoscaling: 'ClusterAutoscaling' = proto.Field(proto.MESSAGE, number=15, message='ClusterAutoscaling')
    desired_binary_authorization: 'BinaryAuthorization' = proto.Field(proto.MESSAGE, number=16, message='BinaryAuthorization')
    desired_logging_service: str = proto.Field(proto.STRING, number=19)
    desired_resource_usage_export_config: 'ResourceUsageExportConfig' = proto.Field(proto.MESSAGE, number=21, message='ResourceUsageExportConfig')
    desired_vertical_pod_autoscaling: 'VerticalPodAutoscaling' = proto.Field(proto.MESSAGE, number=22, message='VerticalPodAutoscaling')
    desired_private_cluster_config: 'PrivateClusterConfig' = proto.Field(proto.MESSAGE, number=25, message='PrivateClusterConfig')
    desired_intra_node_visibility_config: 'IntraNodeVisibilityConfig' = proto.Field(proto.MESSAGE, number=26, message='IntraNodeVisibilityConfig')
    desired_default_snat_status: 'DefaultSnatStatus' = proto.Field(proto.MESSAGE, number=28, message='DefaultSnatStatus')
    desired_cluster_telemetry: 'ClusterTelemetry' = proto.Field(proto.MESSAGE, number=30, message='ClusterTelemetry')
    desired_release_channel: 'ReleaseChannel' = proto.Field(proto.MESSAGE, number=31, message='ReleaseChannel')
    desired_tpu_config: 'TpuConfig' = proto.Field(proto.MESSAGE, number=38, message='TpuConfig')
    desired_l4ilb_subsetting_config: 'ILBSubsettingConfig' = proto.Field(proto.MESSAGE, number=39, message='ILBSubsettingConfig')
    desired_datapath_provider: 'DatapathProvider' = proto.Field(proto.ENUM, number=50, enum='DatapathProvider')
    desired_private_ipv6_google_access: 'PrivateIPv6GoogleAccess' = proto.Field(proto.ENUM, number=51, enum='PrivateIPv6GoogleAccess')
    desired_notification_config: 'NotificationConfig' = proto.Field(proto.MESSAGE, number=55, message='NotificationConfig')
    desired_master_version: str = proto.Field(proto.STRING, number=100)
    desired_gcfs_config: 'GcfsConfig' = proto.Field(proto.MESSAGE, number=109, message='GcfsConfig')
    desired_database_encryption: 'DatabaseEncryption' = proto.Field(proto.MESSAGE, number=46, message='DatabaseEncryption')
    desired_workload_identity_config: 'WorkloadIdentityConfig' = proto.Field(proto.MESSAGE, number=47, message='WorkloadIdentityConfig')
    desired_workload_certificates: 'WorkloadCertificates' = proto.Field(proto.MESSAGE, number=61, message='WorkloadCertificates')
    desired_mesh_certificates: 'MeshCertificates' = proto.Field(proto.MESSAGE, number=67, message='MeshCertificates')
    desired_workload_alts_config: 'WorkloadALTSConfig' = proto.Field(proto.MESSAGE, number=62, message='WorkloadALTSConfig')
    desired_shielded_nodes: 'ShieldedNodes' = proto.Field(proto.MESSAGE, number=48, message='ShieldedNodes')
    desired_cost_management_config: 'CostManagementConfig' = proto.Field(proto.MESSAGE, number=49, message='CostManagementConfig')
    desired_master: 'Master' = proto.Field(proto.MESSAGE, number=52, message='Master')
    desired_dns_config: 'DNSConfig' = proto.Field(proto.MESSAGE, number=53, message='DNSConfig')
    desired_service_external_ips_config: 'ServiceExternalIPsConfig' = proto.Field(proto.MESSAGE, number=60, message='ServiceExternalIPsConfig')
    desired_authenticator_groups_config: 'AuthenticatorGroupsConfig' = proto.Field(proto.MESSAGE, number=63, message='AuthenticatorGroupsConfig')
    desired_logging_config: 'LoggingConfig' = proto.Field(proto.MESSAGE, number=64, message='LoggingConfig')
    desired_monitoring_config: 'MonitoringConfig' = proto.Field(proto.MESSAGE, number=65, message='MonitoringConfig')
    desired_identity_service_config: 'IdentityServiceConfig' = proto.Field(proto.MESSAGE, number=66, message='IdentityServiceConfig')
    desired_enable_private_endpoint: bool = proto.Field(proto.BOOL, number=71, optional=True)
    desired_node_pool_auto_config_network_tags: 'NetworkTags' = proto.Field(proto.MESSAGE, number=110, message='NetworkTags')
    desired_protect_config: 'ProtectConfig' = proto.Field(proto.MESSAGE, number=112, optional=True, message='ProtectConfig')
    desired_gateway_api_config: 'GatewayAPIConfig' = proto.Field(proto.MESSAGE, number=114, message='GatewayAPIConfig')
    etag: str = proto.Field(proto.STRING, number=115)
    desired_node_pool_logging_config: 'NodePoolLoggingConfig' = proto.Field(proto.MESSAGE, number=116, message='NodePoolLoggingConfig')
    desired_fleet: 'Fleet' = proto.Field(proto.MESSAGE, number=117, message='Fleet')
    desired_stack_type: 'StackType' = proto.Field(proto.ENUM, number=119, enum='StackType')
    additional_pod_ranges_config: 'AdditionalPodRangesConfig' = proto.Field(proto.MESSAGE, number=120, message='AdditionalPodRangesConfig')
    removed_additional_pod_ranges_config: 'AdditionalPodRangesConfig' = proto.Field(proto.MESSAGE, number=121, message='AdditionalPodRangesConfig')
    enable_k8s_beta_apis: 'K8sBetaAPIConfig' = proto.Field(proto.MESSAGE, number=122, message='K8sBetaAPIConfig')
    desired_security_posture_config: 'SecurityPostureConfig' = proto.Field(proto.MESSAGE, number=124, message='SecurityPostureConfig')
    desired_network_performance_config: 'NetworkConfig.ClusterNetworkPerformanceConfig' = proto.Field(proto.MESSAGE, number=125, message='NetworkConfig.ClusterNetworkPerformanceConfig')
    desired_enable_fqdn_network_policy: bool = proto.Field(proto.BOOL, number=126, optional=True)
    desired_autopilot_workload_policy_config: 'WorkloadPolicyConfig' = proto.Field(proto.MESSAGE, number=128, message='WorkloadPolicyConfig')
    desired_k8s_beta_apis: 'K8sBetaAPIConfig' = proto.Field(proto.MESSAGE, number=131, message='K8sBetaAPIConfig')
    desired_host_maintenance_policy: 'HostMaintenancePolicy' = proto.Field(proto.MESSAGE, number=132, message='HostMaintenancePolicy')
    desired_node_pool_auto_config_resource_manager_tags: 'ResourceManagerTags' = proto.Field(proto.MESSAGE, number=136, message='ResourceManagerTags')
    desired_in_transit_encryption_config: 'InTransitEncryptionConfig' = proto.Field(proto.ENUM, number=137, optional=True, enum='InTransitEncryptionConfig')
...
class AdditionalPodRangesConfig(proto.Message):
    ...
    Attributes:
        ...
        pod_range_info (MutableSequence[google.cloud.container_v1beta1.types.RangeInfo]):
            ...
            range.
    """
    pod_range_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    pod_range_info: MutableSequence['RangeInfo'] = proto.RepeatedField(proto.MESSAGE, number=2, message='RangeInfo')

class RangeInfo(proto.Message):
    """RangeInfo contains the range name and the range utilization
    by this cluster.
    ...
    """
    range_name: str = proto.Field(proto.STRING, number=1)
    utilization: float = proto.Field(proto.DOUBLE, number=2)

class Operation(proto.Message):
    """This operation resource represents operations that may have
    ...
    class Type(proto.Enum):
        ...
        FLEET_FEATURE_UPGRADE = 19
    name: str = proto.Field(proto.STRING, number=1)
    zone: str = proto.Field(proto.STRING, number=2)
    operation_type: Type = proto.Field(proto.ENUM, number=3, enum=Type)
    status: Status = proto.Field(proto.ENUM, number=4, enum=Status)
    detail: str = proto.Field(proto.STRING, number=8)
    status_message: str = proto.Field(proto.STRING, number=5)
    self_link: str = proto.Field(proto.STRING, number=6)
    target_link: str = proto.Field(proto.STRING, number=7)
    location: str = proto.Field(proto.STRING, number=9)
    start_time: str = proto.Field(proto.STRING, number=10)
    end_time: str = proto.Field(proto.STRING, number=11)
    progress: 'OperationProgress' = proto.Field(proto.MESSAGE, number=12, message='OperationProgress')
    cluster_conditions: MutableSequence['StatusCondition'] = proto.RepeatedField(proto.MESSAGE, number=13, message='StatusCondition')
    nodepool_conditions: MutableSequence['StatusCondition'] = proto.RepeatedField(proto.MESSAGE, number=14, message='StatusCondition')
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=15, message=status_pb2.Status)
...
class OperationProgress(proto.Message):
    ...
    class Metric(proto.Message):
        ...
        """
        name: str = proto.Field(proto.STRING, number=1)
        int_value: int = proto.Field(proto.INT64, number=2, oneof='value')
        double_value: float = proto.Field(proto.DOUBLE, number=3, oneof='value')
        string_value: str = proto.Field(proto.STRING, number=4, oneof='value')
    name: str = proto.Field(proto.STRING, number=1)
    status: 'Operation.Status' = proto.Field(proto.ENUM, number=2, enum='Operation.Status')
    metrics: MutableSequence[Metric] = proto.RepeatedField(proto.MESSAGE, number=3, message=Metric)
    stages: MutableSequence['OperationProgress'] = proto.RepeatedField(proto.MESSAGE, number=4, message='OperationProgress')
...
class CreateClusterRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster: 'Cluster' = proto.Field(proto.MESSAGE, number=3, message='Cluster')
    parent: str = proto.Field(proto.STRING, number=5)
...
class GetClusterRequest(proto.Message):
    ...
    project_id: str = proto.Field(proto.STRING, number=1)
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=5)
...
class UpdateClusterRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    update: 'ClusterUpdate' = proto.Field(proto.MESSAGE, number=4, message='ClusterUpdate')
    name: str = proto.Field(proto.STRING, number=5)
...
class UpdateNodePoolRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    node_pool_id: str = proto.Field(proto.STRING, number=4)
    node_version: str = proto.Field(proto.STRING, number=5)
    image_type: str = proto.Field(proto.STRING, number=6)
    locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=13)
    workload_metadata_config: 'WorkloadMetadataConfig' = proto.Field(proto.MESSAGE, number=14, message='WorkloadMetadataConfig')
    name: str = proto.Field(proto.STRING, number=8)
    upgrade_settings: 'NodePool.UpgradeSettings' = proto.Field(proto.MESSAGE, number=15, message='NodePool.UpgradeSettings')
    tags: 'NetworkTags' = proto.Field(proto.MESSAGE, number=16, message='NetworkTags')
    taints: 'NodeTaints' = proto.Field(proto.MESSAGE, number=17, message='NodeTaints')
    labels: 'NodeLabels' = proto.Field(proto.MESSAGE, number=18, message='NodeLabels')
    linux_node_config: 'LinuxNodeConfig' = proto.Field(proto.MESSAGE, number=19, message='LinuxNodeConfig')
    kubelet_config: 'NodeKubeletConfig' = proto.Field(proto.MESSAGE, number=20, message='NodeKubeletConfig')
    node_network_config: 'NodeNetworkConfig' = proto.Field(proto.MESSAGE, number=21, message='NodeNetworkConfig')
    gcfs_config: 'GcfsConfig' = proto.Field(proto.MESSAGE, number=22, message='GcfsConfig')
    confidential_nodes: 'ConfidentialNodes' = proto.Field(proto.MESSAGE, number=23, message='ConfidentialNodes')
    gvnic: 'VirtualNIC' = proto.Field(proto.MESSAGE, number=29, message='VirtualNIC')
    etag: str = proto.Field(proto.STRING, number=30)
    fast_socket: 'FastSocket' = proto.Field(proto.MESSAGE, number=31, message='FastSocket')
    logging_config: 'NodePoolLoggingConfig' = proto.Field(proto.MESSAGE, number=32, message='NodePoolLoggingConfig')
    resource_labels: 'ResourceLabels' = proto.Field(proto.MESSAGE, number=33, message='ResourceLabels')
    windows_node_config: 'WindowsNodeConfig' = proto.Field(proto.MESSAGE, number=34, message='WindowsNodeConfig')
    machine_type: str = proto.Field(proto.STRING, number=36)
    disk_type: str = proto.Field(proto.STRING, number=37)
    disk_size_gb: int = proto.Field(proto.INT64, number=38)
    resource_manager_tags: 'ResourceManagerTags' = proto.Field(proto.MESSAGE, number=39, message='ResourceManagerTags')

class SetNodePoolAutoscalingRequest(proto.Message):
    """SetNodePoolAutoscalingRequest sets the autoscaler settings of
    a node pool.
    ...
    cluster_id: str = proto.Field(proto.STRING, number=3)
    node_pool_id: str = proto.Field(proto.STRING, number=4)
    autoscaling: 'NodePoolAutoscaling' = proto.Field(proto.MESSAGE, number=5, message='NodePoolAutoscaling')
    name: str = proto.Field(proto.STRING, number=6)

class SetLoggingServiceRequest(proto.Message):
    """SetLoggingServiceRequest sets the logging service of a
    cluster.
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    logging_service: str = proto.Field(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=5)

class SetMonitoringServiceRequest(proto.Message):
    """SetMonitoringServiceRequest sets the monitoring service of a
    cluster.
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    monitoring_service: str = proto.Field(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=6)
...
class SetAddonsConfigRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    addons_config: 'AddonsConfig' = proto.Field(proto.MESSAGE, number=4, message='AddonsConfig')
    name: str = proto.Field(proto.STRING, number=6)
...
class SetLocationsRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=6)
...
class UpdateMasterRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    master_version: str = proto.Field(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=7)
...
class SetMasterAuthRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    action: Action = proto.Field(proto.ENUM, number=4, enum=Action)
    update: 'MasterAuth' = proto.Field(proto.MESSAGE, number=5, message='MasterAuth')
    name: str = proto.Field(proto.STRING, number=7)
...
class DeleteClusterRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=4)
...
class ListClustersRequest(proto.Message):
    ...
    project_id: str = proto.Field(proto.STRING, number=1)
    zone: str = proto.Field(proto.STRING, number=2)
    parent: str = proto.Field(proto.STRING, number=4)
...
class ListClustersResponse(proto.Message):
    ...
    """
    clusters: MutableSequence['Cluster'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Cluster')
    missing_zones: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class GetOperationRequest(proto.Message):
    ...
    project_id: str = proto.Field(proto.STRING, number=1)
    zone: str = proto.Field(proto.STRING, number=2)
    operation_id: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=5)
...
class ListOperationsResponse(proto.Message):
    """ListOperationsResponse is the result of
    ...
    """
    operations: MutableSequence['Operation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Operation')
    missing_zones: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class ServerConfig(proto.Message):
    ...
    class ReleaseChannelConfig(proto.Message):
        """ReleaseChannelConfig exposes configuration for a release
        channel.
        ...
        class AvailableVersion(proto.Message):
            ...
            """
            version: str = proto.Field(proto.STRING, number=1)
            reason: str = proto.Field(proto.STRING, number=2)
        channel: 'ReleaseChannel.Channel' = proto.Field(proto.ENUM, number=1, enum='ReleaseChannel.Channel')
        default_version: str = proto.Field(proto.STRING, number=2)
        available_versions: MutableSequence['ServerConfig.ReleaseChannelConfig.AvailableVersion'] = proto.RepeatedField(proto.MESSAGE, number=3, message='ServerConfig.ReleaseChannelConfig.AvailableVersion')
        valid_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    default_cluster_version: str = proto.Field(proto.STRING, number=1)
    valid_node_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    default_image_type: str = proto.Field(proto.STRING, number=4)
    valid_image_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    valid_master_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    channels: MutableSequence[ReleaseChannelConfig] = proto.RepeatedField(proto.MESSAGE, number=9, message=ReleaseChannelConfig)
    windows_version_maps: MutableMapping[str, 'WindowsVersions'] = proto.MapField(proto.STRING, proto.MESSAGE, number=10, message='WindowsVersions')
...
class BestEffortProvisioning(proto.Message):
    ...
    """
    enabled: bool = proto.Field(proto.BOOL, number=1)
    min_provision_nodes: int = proto.Field(proto.INT32, number=2)
...
class WindowsVersions(proto.Message):
    ...
    class WindowsVersion(proto.Message):
        ...
        """
        image_type: str = proto.Field(proto.STRING, number=1)
        os_version: str = proto.Field(proto.STRING, number=2)
        support_end_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=3, message=date_pb2.Date)
    windows_versions: MutableSequence[WindowsVersion] = proto.RepeatedField(proto.MESSAGE, number=1, message=WindowsVersion)
...
class CreateNodePoolRequest(proto.Message):
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    node_pool: 'NodePool' = proto.Field(proto.MESSAGE, number=4, message='NodePool')
    parent: str = proto.Field(proto.STRING, number=6)
...
class BlueGreenSettings(proto.Message):
    ...
    class StandardRolloutPolicy(proto.Message):
        ...
        """
        batch_percentage: float = proto.Field(proto.FLOAT, number=1, oneof='update_batch_size')
        batch_node_count: int = proto.Field(proto.INT32, number=2, oneof='update_batch_size')
        batch_soak_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, optional=True, message=duration_pb2.Duration)
    standard_rollout_policy: StandardRolloutPolicy = proto.Field(proto.MESSAGE, number=1, oneof='rollout_policy', message=StandardRolloutPolicy)
    node_pool_soak_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, optional=True, message=duration_pb2.Duration)

class NodePool(proto.Message):
    """NodePool contains the name and configuration for a cluster's
    ...
    class UpgradeSettings(proto.Message):
        ...
        """
        max_surge: int = proto.Field(proto.INT32, number=1)
        max_unavailable: int = proto.Field(proto.INT32, number=2)
        strategy: 'NodePoolUpdateStrategy' = proto.Field(proto.ENUM, number=3, optional=True, enum='NodePoolUpdateStrategy')
        blue_green_settings: 'BlueGreenSettings' = proto.Field(proto.MESSAGE, number=4, optional=True, message='BlueGreenSettings')

    class UpdateInfo(proto.Message):
        """UpdateInfo contains resource (instance groups, etc), status
        ...
        class BlueGreenInfo(proto.Message):
            ...
            class Phase(proto.Enum):
                """Phase represents the different stages blue-green upgrade is
                running in.
                ...
                DELETING_BLUE_POOL = 6
                ROLLBACK_STARTED = 7
            phase: 'NodePool.UpdateInfo.BlueGreenInfo.Phase' = proto.Field(proto.ENUM, number=1, enum='NodePool.UpdateInfo.BlueGreenInfo.Phase')
            blue_instance_group_urls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
            green_instance_group_urls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
            blue_pool_deletion_start_time: str = proto.Field(proto.STRING, number=4)
            green_pool_version: str = proto.Field(proto.STRING, number=5)
        blue_green_info: 'NodePool.UpdateInfo.BlueGreenInfo' = proto.Field(proto.MESSAGE, number=1, message='NodePool.UpdateInfo.BlueGreenInfo')
    ...
    class PlacementPolicy(proto.Message):
        ...
        class Type(proto.Enum):
            ...
            TYPE_UNSPECIFIED = 0
            COMPACT = 1
        type_: 'NodePool.PlacementPolicy.Type' = proto.Field(proto.ENUM, number=1, enum='NodePool.PlacementPolicy.Type')
        tpu_topology: str = proto.Field(proto.STRING, number=2)
        policy_name: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=1)
    config: 'NodeConfig' = proto.Field(proto.MESSAGE, number=2, message='NodeConfig')
    initial_node_count: int = proto.Field(proto.INT32, number=3)
    locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=13)
    network_config: 'NodeNetworkConfig' = proto.Field(proto.MESSAGE, number=14, message='NodeNetworkConfig')
    self_link: str = proto.Field(proto.STRING, number=100)
    version: str = proto.Field(proto.STRING, number=101)
    instance_group_urls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=102)
    status: Status = proto.Field(proto.ENUM, number=103, enum=Status)
    status_message: str = proto.Field(proto.STRING, number=104)
    autoscaling: 'NodePoolAutoscaling' = proto.Field(proto.MESSAGE, number=4, message='NodePoolAutoscaling')
    management: 'NodeManagement' = proto.Field(proto.MESSAGE, number=5, message='NodeManagement')
    max_pods_constraint: 'MaxPodsConstraint' = proto.Field(proto.MESSAGE, number=6, message='MaxPodsConstraint')
    conditions: MutableSequence['StatusCondition'] = proto.RepeatedField(proto.MESSAGE, number=105, message='StatusCondition')
    pod_ipv4_cidr_size: int = proto.Field(proto.INT32, number=7)
    upgrade_settings: UpgradeSettings = proto.Field(proto.MESSAGE, number=107, message=UpgradeSettings)
    placement_policy: PlacementPolicy = proto.Field(proto.MESSAGE, number=108, message=PlacementPolicy)
    update_info: UpdateInfo = proto.Field(proto.MESSAGE, number=109, message=UpdateInfo)
    etag: str = proto.Field(proto.STRING, number=110)
    best_effort_provisioning: 'BestEffortProvisioning' = proto.Field(proto.MESSAGE, number=113, message='BestEffortProvisioning')
...
class NodeManagement(proto.Message):
    ...
    Attributes:
        ...
        upgrade_options (google.cloud.container_v1beta1.types.AutoUpgradeOptions):
            ...
            pool.
    """
    auto_upgrade: bool = proto.Field(proto.BOOL, number=1)
    auto_repair: bool = proto.Field(proto.BOOL, number=2)
    upgrade_options: 'AutoUpgradeOptions' = proto.Field(proto.MESSAGE, number=10, message='AutoUpgradeOptions')

class AutoUpgradeOptions(proto.Message):
    """AutoUpgradeOptions defines the set of options for the user to
    ...
    """
    auto_upgrade_start_time: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=2)

class MaintenancePolicy(proto.Message):
    """MaintenancePolicy defines the maintenance policy to be used
    for the cluster.
    ...
    Attributes:
        ...
        resource_version (str):
            ...
            policy.
    """
    window: 'MaintenanceWindow' = proto.Field(proto.MESSAGE, number=1, message='MaintenanceWindow')
    resource_version: str = proto.Field(proto.STRING, number=3)

class MaintenanceWindow(proto.Message):
    """MaintenanceWindow defines the maintenance window to be used
    for the cluster.
    ...
    Attributes:
        ...
        maintenance_exclusions (MutableMapping[str, google.cloud.container_v1beta1.types.TimeWindow]):
            ...
            these windows.
    """
    daily_maintenance_window: 'DailyMaintenanceWindow' = proto.Field(proto.MESSAGE, number=2, oneof='policy', message='DailyMaintenanceWindow')
    recurring_window: 'RecurringTimeWindow' = proto.Field(proto.MESSAGE, number=3, oneof='policy', message='RecurringTimeWindow')
    maintenance_exclusions: MutableMapping[str, 'TimeWindow'] = proto.MapField(proto.STRING, proto.MESSAGE, number=4, message='TimeWindow')
...
class TimeWindow(proto.Message):
    ...
    """
    maintenance_exclusion_options: 'MaintenanceExclusionOptions' = proto.Field(proto.MESSAGE, number=3, oneof='options', message='MaintenanceExclusionOptions')
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
...
class MaintenanceExclusionOptions(proto.Message):
    ...
    class Scope(proto.Enum):
        ...
        NO_MINOR_UPGRADES = 1
        NO_MINOR_OR_NODE_UPGRADES = 2
    scope: Scope = proto.Field(proto.ENUM, number=1, enum=Scope)
...
class RecurringTimeWindow(proto.Message):
    ...
    """
    window: 'TimeWindow' = proto.Field(proto.MESSAGE, number=1, message='TimeWindow')
    recurrence: str = proto.Field(proto.STRING, number=2)
...
class DailyMaintenanceWindow(proto.Message):
    ...
    """
    start_time: str = proto.Field(proto.STRING, number=2)
    duration: str = proto.Field(proto.STRING, number=3)

class SetNodePoolManagementRequest(proto.Message):
    """SetNodePoolManagementRequest sets the node management
...
class SetNodePoolSizeRequest(proto.Message):
    ...
    cluster_id: str = proto.Field(proto.STRING, number=3)
    node_pool_id: str = proto.Field(proto.STRING, number=4)
    node_count: int = proto.Field(proto.INT32, number=5)
    name: str = proto.Field(proto.STRING, number=7)

class CompleteNodePoolUpgradeRequest(proto.Message):
    """CompleteNodePoolUpgradeRequest sets the name of target node
...
class RollbackNodePoolUpgradeRequest(proto.Message):
    """RollbackNodePoolUpgradeRequest rollbacks the previously
    ...
    node_pool_id: str = proto.Field(proto.STRING, number=4)
    name: str = proto.Field(proto.STRING, number=6)
    respect_pdb: bool = proto.Field(proto.BOOL, number=7)
...
class ListNodePoolsResponse(proto.Message):
    ...
    """
    node_pools: MutableSequence['NodePool'] = proto.RepeatedField(proto.MESSAGE, number=1, message='NodePool')
...
class ClusterAutoscaling(proto.Message):
    ...
    class AutoscalingProfile(proto.Enum):
        ...
        OPTIMIZE_UTILIZATION = 1
        BALANCED = 2
    enable_node_autoprovisioning: bool = proto.Field(proto.BOOL, number=1)
    resource_limits: MutableSequence['ResourceLimit'] = proto.RepeatedField(proto.MESSAGE, number=2, message='ResourceLimit')
    autoscaling_profile: AutoscalingProfile = proto.Field(proto.ENUM, number=3, enum=AutoscalingProfile)
    ...
    autoprovisioning_locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class AutoprovisioningNodePoolDefaults(proto.Message):
    ...
    Attributes:
        ...
        insecure_kubelet_readonly_port_enabled (bool):
            ...
            This field is a member of `oneof`_ ``_insecure_kubelet_readonly_port_enabled``.
    """
    oauth_scopes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    service_account: str = proto.Field(proto.STRING, number=2)
    upgrade_settings: 'NodePool.UpgradeSettings' = proto.Field(proto.MESSAGE, number=3, message='NodePool.UpgradeSettings')
    management: 'NodeManagement' = proto.Field(proto.MESSAGE, number=4, message='NodeManagement')
    min_cpu_platform: str = proto.Field(proto.STRING, number=5)
    disk_size_gb: int = proto.Field(proto.INT32, number=6)
    disk_type: str = proto.Field(proto.STRING, number=7)
    shielded_instance_config: 'ShieldedInstanceConfig' = proto.Field(proto.MESSAGE, number=8, message='ShieldedInstanceConfig')
    boot_disk_kms_key: str = proto.Field(proto.STRING, number=9)
    image_type: str = proto.Field(proto.STRING, number=10)
    insecure_kubelet_readonly_port_enabled: bool = proto.Field(proto.BOOL, number=13, optional=True)

class ResourceLimit(proto.Message):
    """Contains information about amount of some resource in the
    ...
    Attributes:
        ...
        maximum (int):
            ...
            cluster.
    """
    resource_type: str = proto.Field(proto.STRING, number=1)
    minimum: int = proto.Field(proto.INT64, number=2)
    maximum: int = proto.Field(proto.INT64, number=3)
...
class NodePoolAutoscaling(proto.Message):
    ...
    class LocationPolicy(proto.Enum):
        ...
        ANY = 2
    enabled: bool = proto.Field(proto.BOOL, number=1)
    min_node_count: int = proto.Field(proto.INT32, number=2)
    max_node_count: int = proto.Field(proto.INT32, number=3)
    autoprovisioned: bool = proto.Field(proto.BOOL, number=4)
    location_policy: LocationPolicy = proto.Field(proto.ENUM, number=5, enum=LocationPolicy)
    total_min_node_count: int = proto.Field(proto.INT32, number=6)
    total_max_node_count: int = proto.Field(proto.INT32, number=7)

class SetLabelsRequest(proto.Message):
    """SetLabelsRequest sets the Google Cloud Platform labels on a
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    resource_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    label_fingerprint: str = proto.Field(proto.STRING, number=5)
    name: str = proto.Field(proto.STRING, number=7)

class SetLegacyAbacRequest(proto.Message):
    """SetLegacyAbacRequest enables or disables the ABAC
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    enabled: bool = proto.Field(proto.BOOL, number=4)
    name: str = proto.Field(proto.STRING, number=6)

class StartIPRotationRequest(proto.Message):
    """StartIPRotationRequest creates a new IP for the cluster and
    ...
    cluster_id: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=6)
    rotate_credentials: bool = proto.Field(proto.BOOL, number=7)

class CompleteIPRotationRequest(proto.Message):
    """CompleteIPRotationRequest moves the cluster master back into
    single-IP mode.
...
class AcceleratorConfig(proto.Message):
    ...
    """
    accelerator_count: int = proto.Field(proto.INT64, number=1)
    accelerator_type: str = proto.Field(proto.STRING, number=2)
    gpu_partition_size: str = proto.Field(proto.STRING, number=3)
    max_time_shared_clients_per_gpu: int = proto.Field(proto.INT64, number=4)
    gpu_sharing_config: 'GPUSharingConfig' = proto.Field(proto.MESSAGE, number=5, optional=True, message='GPUSharingConfig')
    gpu_driver_installation_config: 'GPUDriverInstallationConfig' = proto.Field(proto.MESSAGE, number=6, optional=True, message='GPUDriverInstallationConfig')

class GPUSharingConfig(proto.Message):
    """GPUSharingConfig represents the GPU sharing configuration for
    ...
    class GPUSharingStrategy(proto.Enum):
        ...
        GPU_SHARING_STRATEGY_UNSPECIFIED = 0
        TIME_SHARING = 1
    max_shared_clients_per_gpu: int = proto.Field(proto.INT64, number=1)
    gpu_sharing_strategy: GPUSharingStrategy = proto.Field(proto.ENUM, number=2, optional=True, enum=GPUSharingStrategy)

class GPUDriverInstallationConfig(proto.Message):
    """GPUDriverInstallationConfig specifies the version of GPU
    ...
    class GPUDriverVersion(proto.Enum):
        ...
        DEFAULT = 2
        LATEST = 3
    gpu_driver_version: GPUDriverVersion = proto.Field(proto.ENUM, number=1, optional=True, enum=GPUDriverVersion)
...
class WorkloadMetadataConfig(proto.Message):
    """WorkloadMetadataConfig defines the metadata configuration to
    ...
    class Mode(proto.Enum):
        ...
        GCE_METADATA = 1
        GKE_METADATA = 2
    node_metadata: NodeMetadata = proto.Field(proto.ENUM, number=1, enum=NodeMetadata)
    mode: Mode = proto.Field(proto.ENUM, number=2, enum=Mode)

class SetNetworkPolicyRequest(proto.Message):
    """SetNetworkPolicyRequest enables/disables network policy for a
    cluster.
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    network_policy: 'NetworkPolicy' = proto.Field(proto.MESSAGE, number=4, message='NetworkPolicy')
    name: str = proto.Field(proto.STRING, number=6)

class SetMaintenancePolicyRequest(proto.Message):
    """SetMaintenancePolicyRequest sets the maintenance policy for a
    cluster.
    ...
    zone: str = proto.Field(proto.STRING, number=2)
    cluster_id: str = proto.Field(proto.STRING, number=3)
    maintenance_policy: 'MaintenancePolicy' = proto.Field(proto.MESSAGE, number=4, message='MaintenancePolicy')
    name: str = proto.Field(proto.STRING, number=5)

class ListLocationsRequest(proto.Message):
    """ListLocationsRequest is used to request the locations that
    offer GKE.
...
class ListLocationsResponse(proto.Message):
    """ListLocationsResponse returns the list of all GKE locations
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    locations: MutableSequence['Location'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Location')
...
class Location(proto.Message):
    ...
    class LocationType(proto.Enum):
        ...
        ZONE = 1
        REGION = 2
    type_: LocationType = proto.Field(proto.ENUM, number=1, enum=LocationType)
    name: str = proto.Field(proto.STRING, number=2)
    recommended: bool = proto.Field(proto.BOOL, number=3)

class StatusCondition(proto.Message):
    """StatusCondition describes why a cluster or a node pool has a
    ...
    canonical_code: code_pb2.Code = proto.Field(proto.ENUM, number=3, enum=code_pb2.Code)
...
class NetworkConfig(proto.Message):
    ...
    class ClusterNetworkPerformanceConfig(proto.Message):
        ...
        class Tier(proto.Enum):
            ...
            TIER_UNSPECIFIED = 0
            TIER_1 = 1
        total_egress_bandwidth_tier: 'NetworkConfig.ClusterNetworkPerformanceConfig.Tier' = proto.Field(proto.ENUM, number=1, optional=True, enum='NetworkConfig.ClusterNetworkPerformanceConfig.Tier')
    network: str = proto.Field(proto.STRING, number=1)
    subnetwork: str = proto.Field(proto.STRING, number=2)
    enable_intra_node_visibility: bool = proto.Field(proto.BOOL, number=5)
    default_snat_status: 'DefaultSnatStatus' = proto.Field(proto.MESSAGE, number=7, message='DefaultSnatStatus')
    enable_l4ilb_subsetting: bool = proto.Field(proto.BOOL, number=10)
    datapath_provider: 'DatapathProvider' = proto.Field(proto.ENUM, number=11, enum='DatapathProvider')
    private_ipv6_google_access: 'PrivateIPv6GoogleAccess' = proto.Field(proto.ENUM, number=12, enum='PrivateIPv6GoogleAccess')
    dns_config: 'DNSConfig' = proto.Field(proto.MESSAGE, number=13, message='DNSConfig')
    service_external_ips_config: 'ServiceExternalIPsConfig' = proto.Field(proto.MESSAGE, number=15, message='ServiceExternalIPsConfig')
    gateway_api_config: 'GatewayAPIConfig' = proto.Field(proto.MESSAGE, number=16, message='GatewayAPIConfig')
    enable_multi_networking: bool = proto.Field(proto.BOOL, number=17)
    network_performance_config: ClusterNetworkPerformanceConfig = proto.Field(proto.MESSAGE, number=18, message=ClusterNetworkPerformanceConfig)
    enable_fqdn_network_policy: bool = proto.Field(proto.BOOL, number=19, optional=True)
    in_transit_encryption_config: 'InTransitEncryptionConfig' = proto.Field(proto.ENUM, number=20, optional=True, enum='InTransitEncryptionConfig')

class GatewayAPIConfig(proto.Message):
    """GatewayAPIConfig contains the desired config of Gateway API
    on this cluster.
    ...
    class Channel(proto.Enum):
        """Channel describes if/how Gateway API should be installed and
        ...
        CHANNEL_EXPERIMENTAL = 3
        CHANNEL_STANDARD = 4
    channel: Channel = proto.Field(proto.ENUM, number=1, enum=Channel)
...
class ListUsableSubnetworksRequest(proto.Message):
    """ListUsableSubnetworksRequest requests the list of usable
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    filter: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    subnetworks: MutableSequence['UsableSubnetwork'] = proto.RepeatedField(proto.MESSAGE, number=1, message='UsableSubnetwork')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UsableSubnetworkSecondaryRange(proto.Message):
    ...
    class Status(proto.Enum):
        ...
        IN_USE_MANAGED_POD = 4
    range_name: str = proto.Field(proto.STRING, number=1)
    ip_cidr_range: str = proto.Field(proto.STRING, number=2)
    status: Status = proto.Field(proto.ENUM, number=3, enum=Status)

class UsableSubnetwork(proto.Message):
    """UsableSubnetwork resource returns the subnetwork name, its
    ...
    """
    subnetwork: str = proto.Field(proto.STRING, number=1)
    network: str = proto.Field(proto.STRING, number=2)
    ip_cidr_range: str = proto.Field(proto.STRING, number=3)
    secondary_ip_ranges: MutableSequence['UsableSubnetworkSecondaryRange'] = proto.RepeatedField(proto.MESSAGE, number=4, message='UsableSubnetworkSecondaryRange')
    status_message: str = proto.Field(proto.STRING, number=5)

class VerticalPodAutoscaling(proto.Message):
    """VerticalPodAutoscaling contains global, per-cluster
...
class DefaultSnatStatus(proto.Message):
    """DefaultSnatStatus contains the desired state of whether
...
class IntraNodeVisibilityConfig(proto.Message):
    """IntraNodeVisibilityConfig contains the desired config of the
...
class ILBSubsettingConfig(proto.Message):
    """ILBSubsettingConfig contains the desired config of L4
...
class DNSConfig(proto.Message):
    """DNSConfig contains the desired set of options for configuring
    clusterDNS.
    ...
    class DNSScope(proto.Enum):
        """DNSScope lists the various scopes of access to cluster DNS
        records.
        ...
        CLUSTER_SCOPE = 1
        VPC_SCOPE = 2
    cluster_dns: Provider = proto.Field(proto.ENUM, number=1, enum=Provider)
    cluster_dns_scope: DNSScope = proto.Field(proto.ENUM, number=2, enum=DNSScope)
    cluster_dns_domain: str = proto.Field(proto.STRING, number=3)
...
class MaxPodsConstraint(proto.Message):
    ...
    Attributes:
        max_pods_per_node (int):
            ...
            per node.
    """
    max_pods_per_node: int = proto.Field(proto.INT64, number=1)
...
class WorkloadIdentityConfig(proto.Message):
    ...
    Attributes:
        ...
        identity_provider (str):
            ...
            provider.
    """
    identity_namespace: str = proto.Field(proto.STRING, number=1)
    workload_pool: str = proto.Field(proto.STRING, number=2)
    identity_provider: str = proto.Field(proto.STRING, number=3)

class WorkloadALTSConfig(proto.Message):
    """Configuration for direct-path (via ALTS) with workload
    identity.
    ...
    Attributes:
        enable_alts (google.protobuf.wrappers_pb2.BoolValue):
            ...
            must be non-empty).
    """
    enable_alts: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=1, message=wrappers_pb2.BoolValue)
...
class WorkloadCertificates(proto.Message):
    ...
    Attributes:
        enable_certificates (google.protobuf.wrappers_pb2.BoolValue):
            ...
            must be non-empty).
    """
    enable_certificates: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=1, message=wrappers_pb2.BoolValue)
...
class DatabaseEncryption(proto.Message):
    ...
    class State(proto.Enum):
        ...
        ENCRYPTED = 1
        DECRYPTED = 2
    key_name: str = proto.Field(proto.STRING, number=1)
    state: State = proto.Field(proto.ENUM, number=2, enum=State)
...
class ResourceUsageExportConfig(proto.Message):
    ...
    class BigQueryDestination(proto.Message):
        """Parameters for using BigQuery as the destination of resource
        usage export.
        ...
        """
        dataset_id: str = proto.Field(proto.STRING, number=1)
    ...
    class ConsumptionMeteringConfig(proto.Message):
        ...
        """
        enabled: bool = proto.Field(proto.BOOL, number=1)
    bigquery_destination: BigQueryDestination = proto.Field(proto.MESSAGE, number=1, message=BigQueryDestination)
    enable_network_egress_metering: bool = proto.Field(proto.BOOL, number=2)
    consumption_metering_config: ConsumptionMeteringConfig = proto.Field(proto.MESSAGE, number=3, message=ConsumptionMeteringConfig)
...
class GetOpenIDConfigRequest(proto.Message):
    """GetOpenIDConfigRequest gets the OIDC discovery document for
...
class GetOpenIDConfigResponse(proto.Message):
    ...
    """
    issuer: str = proto.Field(proto.STRING, number=1)
    jwks_uri: str = proto.Field(proto.STRING, number=2)
    response_types_supported: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    subject_types_supported: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    id_token_signing_alg_values_supported: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    claims_supported: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    grant_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)

class GetJSONWebKeysRequest(proto.Message):
    """GetJSONWebKeysRequest gets the public component of the keys used by
...
class Jwk(proto.Message):
    ...
    Attributes:
        ...
        crv (str):
            Used for ECDSA keys.
    """
    kty: str = proto.Field(proto.STRING, number=1)
    alg: str = proto.Field(proto.STRING, number=2)
    use: str = proto.Field(proto.STRING, number=3)
    kid: str = proto.Field(proto.STRING, number=4)
    n: str = proto.Field(proto.STRING, number=5)
    e: str = proto.Field(proto.STRING, number=6)
    x: str = proto.Field(proto.STRING, number=7)
    y: str = proto.Field(proto.STRING, number=8)
    crv: str = proto.Field(proto.STRING, number=9)
...
class GetJSONWebKeysResponse(proto.Message):
    ...
    """
    keys: MutableSequence['Jwk'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Jwk')

class CheckAutopilotCompatibilityRequest(proto.Message):
    """CheckAutopilotCompatibilityRequest requests getting the
...
class AutopilotCompatibilityIssue(proto.Message):
    """AutopilotCompatibilityIssue contains information about a
    ...
    class IssueType(proto.Enum):
        ...
        ADDITIONAL_CONFIG_REQUIRED = 2
        PASSED_WITH_OPTIONAL_CONFIG = 3
    last_observation: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    constraint_type: str = proto.Field(proto.STRING, number=2)
    incompatibility_type: IssueType = proto.Field(proto.ENUM, number=3, enum=IssueType)
    subjects: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    documentation_url: str = proto.Field(proto.STRING, number=5)
    description: str = proto.Field(proto.STRING, number=6)

class CheckAutopilotCompatibilityResponse(proto.Message):
    """CheckAutopilotCompatibilityResponse has a list of
    ...
    Attributes:
        ...
        summary (str):
            ...
            response.
    """
    issues: MutableSequence['AutopilotCompatibilityIssue'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AutopilotCompatibilityIssue')
    summary: str = proto.Field(proto.STRING, number=2)
...
class TpuConfig(proto.Message):
    ...
    """
    enabled: bool = proto.Field(proto.BOOL, number=1)
    use_service_networking: bool = proto.Field(proto.BOOL, number=2)
    ipv4_cidr_block: str = proto.Field(proto.STRING, number=3)

class Master(proto.Message):
    """Master is the configuration for components on master."""

class Autopilot(proto.Message):
    """Autopilot is the configuration for Autopilot settings on the
    cluster.
    ...
    """
    enabled: bool = proto.Field(proto.BOOL, number=1)
    workload_policy_config: 'WorkloadPolicyConfig' = proto.Field(proto.MESSAGE, number=2, message='WorkloadPolicyConfig')

class WorkloadPolicyConfig(proto.Message):
    """WorkloadPolicyConfig is the configuration of workload policy
    ...
    """
    allow_net_admin: bool = proto.Field(proto.BOOL, number=1, optional=True)
...
class NotificationConfig(proto.Message):
    ...
    class EventType(proto.Enum):
        """Types of notifications currently supported. Can be used to
    ...
    class PubSub(proto.Message):
        ...
        """
        enabled: bool = proto.Field(proto.BOOL, number=1)
        topic: str = proto.Field(proto.STRING, number=2)
        filter: 'NotificationConfig.Filter' = proto.Field(proto.MESSAGE, number=3, message='NotificationConfig.Filter')

    class Filter(proto.Message):
        """Allows filtering to one or more specific event types. If
        ...
        """
        event_type: MutableSequence['NotificationConfig.EventType'] = proto.RepeatedField(proto.ENUM, number=1, enum='NotificationConfig.EventType')
    pubsub: PubSub = proto.Field(proto.MESSAGE, number=1, message=PubSub)

class ConfidentialNodes(proto.Message):
    """ConfidentialNodes is configuration for the confidential nodes
...
class UpgradeEvent(proto.Message):
    """UpgradeEvent is a notification sent to customers by the
    ...
    Attributes:
        ...
        resource (str):
            ...
            of the node pool.
    """
    resource_type: 'UpgradeResourceType' = proto.Field(proto.ENUM, number=1, enum='UpgradeResourceType')
    operation: str = proto.Field(proto.STRING, number=2)
    operation_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    current_version: str = proto.Field(proto.STRING, number=4)
    target_version: str = proto.Field(proto.STRING, number=5)
    resource: str = proto.Field(proto.STRING, number=6)

class UpgradeAvailableEvent(proto.Message):
    """UpgradeAvailableEvent is a notification sent to customers
    ...
    """
    version: str = proto.Field(proto.STRING, number=1)
    resource_type: 'UpgradeResourceType' = proto.Field(proto.ENUM, number=2, enum='UpgradeResourceType')
    release_channel: 'ReleaseChannel' = proto.Field(proto.MESSAGE, number=3, message='ReleaseChannel')
    resource: str = proto.Field(proto.STRING, number=4)
    windows_versions: 'WindowsVersions' = proto.Field(proto.MESSAGE, number=5, message='WindowsVersions')

class SecurityBulletinEvent(proto.Message):
    """SecurityBulletinEvent is a notification sent to customers
    ...
    Attributes:
        ...
        manual_steps_required (bool):
            ...
            their clusters safe.
    """
    resource_type_affected: str = proto.Field(proto.STRING, number=1)
    bulletin_id: str = proto.Field(proto.STRING, number=2)
    cve_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    severity: str = proto.Field(proto.STRING, number=4)
    bulletin_uri: str = proto.Field(proto.STRING, number=5)
    brief_description: str = proto.Field(proto.STRING, number=6)
    affected_supported_minors: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
    patched_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=8)
    suggested_upgrade_target: str = proto.Field(proto.STRING, number=9)
    manual_steps_required: bool = proto.Field(proto.BOOL, number=10)

class IdentityServiceConfig(proto.Message):
    """IdentityServiceConfig is configuration for Identity Service
...
class LoggingConfig(proto.Message):
    ...
    """
    component_config: 'LoggingComponentConfig' = proto.Field(proto.MESSAGE, number=1, message='LoggingComponentConfig')

class LoggingComponentConfig(proto.Message):
    """LoggingComponentConfig is cluster logging component
    configuration.
    ...
    class Component(proto.Enum):
        ...
        SCHEDULER = 4
        CONTROLLER_MANAGER = 5
    enable_components: MutableSequence[Component] = proto.RepeatedField(proto.ENUM, number=1, enum=Component)
...
class MonitoringConfig(proto.Message):
    ...
    """
    component_config: 'MonitoringComponentConfig' = proto.Field(proto.MESSAGE, number=1, message='MonitoringComponentConfig')
    managed_prometheus_config: 'ManagedPrometheusConfig' = proto.Field(proto.MESSAGE, number=2, message='ManagedPrometheusConfig')
    advanced_datapath_observability_config: 'AdvancedDatapathObservabilityConfig' = proto.Field(proto.MESSAGE, number=3, message='AdvancedDatapathObservabilityConfig')

class AdvancedDatapathObservabilityConfig(proto.Message):
    """AdvancedDatapathObservabilityConfig specifies configuration
    ...
    class RelayMode(proto.Enum):
        ...
        INTERNAL_VPC_LB = 3
        EXTERNAL_LB = 4
    enable_metrics: bool = proto.Field(proto.BOOL, number=1)
    relay_mode: RelayMode = proto.Field(proto.ENUM, number=2, enum=RelayMode)
...
class NodePoolLoggingConfig(proto.Message):
    ...
    """
    variant_config: 'LoggingVariantConfig' = proto.Field(proto.MESSAGE, number=1, message='LoggingVariantConfig')
...
class LoggingVariantConfig(proto.Message):
    ...
    class Variant(proto.Enum):
        ...
        DEFAULT = 1
        MAX_THROUGHPUT = 2
    variant: Variant = proto.Field(proto.ENUM, number=1, enum=Variant)

class MonitoringComponentConfig(proto.Message):
    """MonitoringComponentConfig is cluster monitoring component
    configuration.
...
class Fleet(proto.Message):
    ...
    membership: str = proto.Field(proto.STRING, number=2)
    pre_registered: bool = proto.Field(proto.BOOL, number=3)

class ResourceManagerTags(proto.Message):
    """A map of resource manager tag keys and values to be attached
    ...
    """
    tags: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
...
class EnterpriseConfig(proto.Message):
    ...
    class ClusterTier(proto.Enum):
        ...
        STANDARD = 1
        ENTERPRISE = 2
    cluster_tier: ClusterTier = proto.Field(proto.ENUM, number=1, enum=ClusterTier)
