...
if is_torch_available():
    ...
    from transformers import MODEL_MAPPING, Data2VecVisionForImageClassification, Data2VecVisionForSemanticSegmentation, Data2VecVisionModel
...
class Data2VecVisionModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    """
    all_model_classes = (Data2VecVisionModel, Data2VecVisionForImageClassification, Data2VecVisionForSemanticSegmentation) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': Data2VecVisionModel, 'image-classification': Data2VecVisionForImageClassification, 'image-segmentation': Data2VecVisionForSemanticSegmentation} if is_torch_available() else {}
    test_pruning = False
    ...
    @unittest.skip(reason="Data2VecVision has some layers using `add_module` which doesn't work well with `nn.DataParallel`")
