...
def main(cfg, seed=0, max_train_iter=int(100000000.0), max_env_step=int(100000000.0)):
    if False:
        print('Hello World!')
    cfg = compile_config(cfg, BaseEnvManager, PPGOffPolicy, BaseLearner, SampleSerialCollector, InteractionSerialEvaluator, {'policy': AdvancedReplayBuffer, 'value': AdvancedReplayBuffer}, save_cfg=True)
