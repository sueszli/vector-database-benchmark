...
from .processor import MetaProcessor, VideoProcessor, TextProcessor, Aligner, MMAttentionMask2DProcessor
...
class COINActionSegmentationMetaProcessor(MetaProcessor):
    split_map = {'train': 'training', 'valid': 'testing', 'test': 'testing'}
