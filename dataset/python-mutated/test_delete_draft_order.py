...
from .utils import draft_order_create, draft_order_delete, draft_order_update, order_lines_create, order_query

@pytest.mark.e2e
def test_delete_draft_order_CORE_0205(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders):
    if False:
        print('Hello World!')
