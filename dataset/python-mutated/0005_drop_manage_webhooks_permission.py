...
class Migration(migrations.Migration):
    dependencies = [('webhook', '0004_mount_app'), ('account', '0045_auto_20200427_0425')]
    run_before = [('account', '0072_group')]
    operations = [migrations.RunPython(change_webhook_permission_to_app_permission), migrations.AlterModelOptions(name='webhook', options={})]