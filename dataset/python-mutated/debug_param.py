...
if os.getenv('MEGENGINE_CONV_EXECUTION_STRATEGY') != None:
    get_logger().warning('Environment variable `MEGENGINE_CONV_EXECUTION_STRATEGY` is deprecated, please use `MEGENGINE_EXECUTION_STRATEGY`')
_valid_string_option = {'REPRODUCIBLE': Strategy.REPRODUCIBLE, 'HEURISTIC': Strategy.HEURISTIC, 'PROFILE': Strategy.PROFILE}
