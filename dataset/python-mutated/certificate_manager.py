...
class ListCertificatesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    certificates: MutableSequence['Certificate'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Certificate')
...
class CreateCertificateRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    certificate_id: str = proto.Field(proto.STRING, number=2)
    certificate: 'Certificate' = proto.Field(proto.MESSAGE, number=3, message='Certificate')
...
class UpdateCertificateRequest(proto.Message):
    ...
    """
    certificate: 'Certificate' = proto.Field(proto.MESSAGE, number=1, message='Certificate')
...
class ListCertificateMapsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    certificate_maps: MutableSequence['CertificateMap'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CertificateMap')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateCertificateMapRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    certificate_map_id: str = proto.Field(proto.STRING, number=2)
    certificate_map: 'CertificateMap' = proto.Field(proto.MESSAGE, number=3, message='CertificateMap')
...
class UpdateCertificateMapRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask.
    """
    certificate_map: 'CertificateMap' = proto.Field(proto.MESSAGE, number=1, message='CertificateMap')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class ListCertificateMapEntriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    certificate_map_entries: MutableSequence['CertificateMapEntry'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CertificateMapEntry')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateCertificateMapEntryRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    certificate_map_entry_id: str = proto.Field(proto.STRING, number=2)
    certificate_map_entry: 'CertificateMapEntry' = proto.Field(proto.MESSAGE, number=3, message='CertificateMapEntry')
...
class UpdateCertificateMapEntryRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask.
    """
    certificate_map_entry: 'CertificateMapEntry' = proto.Field(proto.MESSAGE, number=1, message='CertificateMapEntry')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    dns_authorizations: MutableSequence['DnsAuthorization'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DnsAuthorization')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateDnsAuthorizationRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    dns_authorization_id: str = proto.Field(proto.STRING, number=2)
    dns_authorization: 'DnsAuthorization' = proto.Field(proto.MESSAGE, number=3, message='DnsAuthorization')
...
class UpdateDnsAuthorizationRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask.
    """
    dns_authorization: 'DnsAuthorization' = proto.Field(proto.MESSAGE, number=1, message='DnsAuthorization')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class Certificate(proto.Message):
    ...
    class SelfManagedCertificate(proto.Message):
        ...
        """
        pem_certificate: str = proto.Field(proto.STRING, number=1)
        pem_private_key: str = proto.Field(proto.STRING, number=2)
    ...
    class ManagedCertificate(proto.Message):
        ...
        class ProvisioningIssue(proto.Message):
            ...
            class Reason(proto.Enum):
                ...
                AUTHORIZATION_ISSUE = 1
                RATE_LIMITED = 2
            reason: 'Certificate.ManagedCertificate.ProvisioningIssue.Reason' = proto.Field(proto.ENUM, number=1, enum='Certificate.ManagedCertificate.ProvisioningIssue.Reason')
            details: str = proto.Field(proto.STRING, number=2)

        class AuthorizationAttemptInfo(proto.Message):
            """State of the latest attempt to authorize a domain for
            ...
            class FailureReason(proto.Enum):
                """Reason for failure of the authorization attempt for the
                domain.
                ...
                CAA = 2
                RATE_LIMITED = 3
            domain: str = proto.Field(proto.STRING, number=1)
            state: 'Certificate.ManagedCertificate.AuthorizationAttemptInfo.State' = proto.Field(proto.ENUM, number=2, enum='Certificate.ManagedCertificate.AuthorizationAttemptInfo.State')
            failure_reason: 'Certificate.ManagedCertificate.AuthorizationAttemptInfo.FailureReason' = proto.Field(proto.ENUM, number=3, enum='Certificate.ManagedCertificate.AuthorizationAttemptInfo.FailureReason')
            details: str = proto.Field(proto.STRING, number=4)
        domains: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        dns_authorizations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        issuance_config: str = proto.Field(proto.STRING, number=6)
        state: 'Certificate.ManagedCertificate.State' = proto.Field(proto.ENUM, number=4, enum='Certificate.ManagedCertificate.State')
        provisioning_issue: 'Certificate.ManagedCertificate.ProvisioningIssue' = proto.Field(proto.MESSAGE, number=3, message='Certificate.ManagedCertificate.ProvisioningIssue')
        authorization_attempt_info: MutableSequence['Certificate.ManagedCertificate.AuthorizationAttemptInfo'] = proto.RepeatedField(proto.MESSAGE, number=5, message='Certificate.ManagedCertificate.AuthorizationAttemptInfo')
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=8)
    ...
    self_managed: SelfManagedCertificate = proto.Field(proto.MESSAGE, number=5, oneof='type', message=SelfManagedCertificate)
    managed: ManagedCertificate = proto.Field(proto.MESSAGE, number=11, oneof='type', message=ManagedCertificate)
    san_dnsnames: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    pem_certificate: str = proto.Field(proto.STRING, number=9)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    scope: Scope = proto.Field(proto.ENUM, number=12, enum=Scope)
...
class CertificateMap(proto.Message):
    ...
    class GclbTarget(proto.Message):
        ...
        class IpConfig(proto.Message):
            """Defines IP configuration where this Certificate Map is
            serving.
            ...
            ports: MutableSequence[int] = proto.RepeatedField(proto.UINT32, number=3)
        target_https_proxy: str = proto.Field(proto.STRING, number=1, oneof='target_proxy')
        target_ssl_proxy: str = proto.Field(proto.STRING, number=3, oneof='target_proxy')
        ip_configs: MutableSequence['CertificateMap.GclbTarget.IpConfig'] = proto.RepeatedField(proto.MESSAGE, number=2, message='CertificateMap.GclbTarget.IpConfig')
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=5)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=3)
    gclb_targets: MutableSequence[GclbTarget] = proto.RepeatedField(proto.MESSAGE, number=4, message=GclbTarget)
...
class CertificateMapEntry(proto.Message):
    ...
    class Matcher(proto.Enum):
        """Defines predefined cases other than SNI-hostname match when
        ...
        PRIMARY = 1
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=9)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    hostname: str = proto.Field(proto.STRING, number=5, oneof='match')
    matcher: Matcher = proto.Field(proto.ENUM, number=10, oneof='match', enum=Matcher)
    certificates: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
    state: 'ServingState' = proto.Field(proto.ENUM, number=8, enum='ServingState')
...
class DnsAuthorization(proto.Message):
    ...
    class DnsResourceRecord(proto.Message):
        """The structure describing the DNS Resource Record that needs
        ...
        data: str = proto.Field(proto.STRING, number=3)
    name: str = proto.Field(proto.STRING, number=1)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    description: str = proto.Field(proto.STRING, number=5)
    domain: str = proto.Field(proto.STRING, number=6)
    dns_resource_record: DnsResourceRecord = proto.Field(proto.MESSAGE, number=10, message=DnsResourceRecord)
