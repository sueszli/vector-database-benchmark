...
class Migration(migrations.Migration):
    dependencies = [('app', '0017_app_audience'), ('channel', '0005_channel_allocation_strategy'), ('site', '0034_sitesettings_limit_quantity_per_checkout'), ('tax', '0001_initial'), ('plugins', '0010_auto_20220104_1239'), ('webhook', '0008_webhook_subscription_query')]
    operations = [migrations.RunPython(add_tax_configuration_for_channels, migrations.RunPython.noop), migrations.RunPython(populate_tax_calculation_strategy, migrations.RunPython.noop)]