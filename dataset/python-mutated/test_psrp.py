...
DUMMY_STACKTRACE = ['at Invoke-Foo, C:\\module.psm1: line 113', 'at Invoke-Bar, C:\\module.psm1: line 125']
...
@patch(f'{PsrpHook.__module__}.{PsrpHook.__name__}.get_connection', new=lambda _, conn_id: Connection(conn_id=conn_id, login='username', password='password', host='remote_host'))
