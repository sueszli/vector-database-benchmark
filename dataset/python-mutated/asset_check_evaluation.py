...
class AssetCheckEvaluationPlanned(NamedTuple('_AssetCheckEvaluationPlanned', [('asset_key', AssetKey), ('check_name', str)])):
...
@whitelist_for_serdes
class AssetCheckEvaluationTargetMaterializationData(NamedTuple('_AssetCheckEvaluationTargetMaterializationData', [('storage_id', int), ('run_id', str), ('timestamp', float)])):
...
class AssetCheckEvaluation(NamedTuple('_AssetCheckEvaluation', [('asset_key', AssetKey), ('check_name', str), ('passed', bool), ('metadata', Mapping[str, MetadataValue]), ('target_materialization_data', Optional[AssetCheckEvaluationTargetMaterializationData]), ('severity', AssetCheckSeverity)])):
