...
app = typer.Typer()
PROJECT_NAME_DEFAULT = typer.Argument(..., help='Mage project path')
PIPELINE_NAME_DEFAULT = typer.Argument(..., help='Mage pipeline uuid')
BLOCK_NAME_DEFAULT = typer.Argument(..., help='Mage block uuid in the pipeline')
PRINT_BLOCK_DOC_DEFAULT = typer.Option(False, help='specify if block documentation should be printed.')
