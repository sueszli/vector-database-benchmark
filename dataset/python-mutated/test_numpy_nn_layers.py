...
@unittest.skipIf(not _is_macos() or _macos_version() < MIN_MACOS_VERSION_REQUIRED, 'macOS 10.13+ is required. Skipping tests.')
...
@unittest.skipIf(not _is_macos() or _macos_version() < LAYERS_10_15_MACOS_VERSION, 'macOS 10.15+ required. Skipping tests.')
...
@pytest.mark.slow
@unittest.skipUnless(_is_macos() and _macos_version() >= LAYERS_11_0_MACOS_VERSION, 'Only supported on macOS 10.16+')
