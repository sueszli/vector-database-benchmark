MANIFEST = {'name': 'Reto #15', 'language': 'python', 'author': 'Joaquín Gutiérrez Pedrosa', 'github': 'https://github.com/percevaq'}
import sys
WELLCOME = "\n*******************************************************************************\n                  _                                      \n              ___| |_ __ _ _ __  __      ____ _ _ __ ___ \n             / __| __/ _` | '__| \\ \\ /\\ / / _` | '__/ __|\n             \\__ \\ || (_| | |     \\ V  V / (_| | |  \\__ \\ \n             |___/\\__\\__,_|_|      \\_/\\_/ \\__,_|_|  |___/\n\n*******************************************************************************\nAyuda: escriba /q para salir del programa\n\n"
TRANSLITERATION = {'a': 'aurek', 'b': 'besh', 'c': 'cesh', 'ch': 'cherek', 'd': 'dorn', 'e': 'esk', 'eo': 'eorek', 'f': 'forn', 'g': 'gesh', 'h': 'heth', 'i': 'isk', 'j': 'jenth', 'k': 'krill', 'kh': 'khesh', 'l': 'lesh', 'm': 'mern', 'n': 'nern', 'ng': 'ngorn', 'o': 'orn', 'oo': 'oorek', 'p': 'peh', 'q': 'qek', 'r': 'resh', 's': 'senth', 'sh': 'shen', 't': 'teth', 'th': 'thesh', 'u': 'ush', 'v': 'vorn', 'w': 'wesk', 'x': 'xesh', 'y': 'yirt', 'z': 'zerek'}
...
def translate(_word='percevaq', _language='A'):
    ...
    if _language == 'a':
        ...
        return translation
print(WELLCOME)
word = input('¿Que quieres traducir?: ').lower()
if '/q' in word:
    sys.exit(1)
language = input('Idioma "S" para español / "A" para Aurebesh: ').lower()
