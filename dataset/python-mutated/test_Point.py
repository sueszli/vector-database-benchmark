...
angles = [((1, 0), (0, 1), 90), ((0, 1), (1, 0), -90), ((-1, 0), (-1, 0), 0), ((0, -1), (0, 1), 180)]
...
inits = [(QtCore.QSizeF(1, 0), (1.0, 0.0)), ((0, -1), (0.0, -1.0)), ([1, 1], (1.0, 1.0))]
...
lengths = [((0, 1), 1), ((1, 0), 1), ((0, 0), 0), ((1, 1), math.sqrt(2)), ((-1, -1), math.sqrt(2))]
...
min_max = [((0, 1), 0, 1), ((1, 0), 0, 1), ((-math.inf, 0), -math.inf, 0), ((0, math.inf), 0, math.inf)]
