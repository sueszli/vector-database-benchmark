...
@parameterized_class([{'combiner': counters.Counter.SUM}, {'combiner': counters.Counter.MEAN}, {'combiner': counters.Counter.BEAM_DISTRIBUTION}, {'combiner': counters.Counter.DATAFLOW_DISTRIBUTION}])
