...
class KhanAcademyBaseIE(InfoExtractor):
    _VALID_URL_TEMPL = 'https?://(?:www\\.)?khanacademy\\.org/(?P<id>(?:[^/]+/){%s}%s[^?#/&]+)'
...
class KhanAcademyIE(KhanAcademyBaseIE):
    ...
    _TEST = {'url': 'https://www.khanacademy.org/computing/computer-science/cryptography/crypt/v/one-time-pad', 'md5': '9c84b7b06f9ebb80d22a5c8dedefb9a0', 'info_dict': {'id': 'FlIG3TvQCBQ', 'ext': 'mp4', 'title': 'The one-time pad', 'description': 'The perfect cipher', 'duration': 176, 'uploader': 'Brit Cruise', 'uploader_id': 'khanacademy', 'upload_date': '20120411', 'timestamp': 1334170113, 'license': 'cc-by-nc-sa'}, 'add_ie': ['Youtube']}
...
class KhanAcademyUnitIE(KhanAcademyBaseIE):
    ...
    _TEST = {'url': 'https://www.khanacademy.org/computing/computer-science/cryptography', 'info_dict': {'id': 'cryptography', 'title': 'Cryptography', 'description': 'How have humans protected their secret messages through history? What has changed today?'}, 'playlist_mincount': 31}
