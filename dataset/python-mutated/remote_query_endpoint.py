...
class RemoteQueryEndpoint(MetadataEndpointBase):
    ...
    @docs(tags=['Metadata'], summary='Perform a search for a given query.', responses={200: {'schema': schema(RemoteSearchResponse={'request_uuid': String(), 'peers': List(String())})}, 'examples': {'Success': {'request_uuid': '268560c0-3f28-4e6e-9d85-d5ccb0269693', 'peers': ['50e9a2ce646c373985a8e827e328830e053025c6', '107c84e5d9636c17b46c88c3ddb54842d80081b0']}}})
    ...
    async def get_channels_peers(self, _):
        ...
        with db_session:
            for (id_tuple, peers) in mapping._channels_dict.items():
                ...
                chan_dict = {'channel_name': chan.title if chan else None, 'channel_pk': hexlify(channel_pk), 'channel_id': channel_id, 'peers': peers_list}
