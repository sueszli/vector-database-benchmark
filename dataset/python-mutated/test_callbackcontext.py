import pytest
from telegram import Bot, CallbackQuery, Chat, InlineKeyboardButton, InlineKeyboardMarkup, Message, Update, User
...
class TestCallbackContext:
    ...
    async def test_drop_callback_data(self, bot, monkeypatch, chat_id):
        ...
        callback_context = CallbackContext.from_update(update, app)
        async with app:
            await app.bot.send_message(chat_id=chat_id, text='test', reply_markup=InlineKeyboardMarkup.from_button(InlineKeyboardButton('test', callback_data='callback_data')))
        ...
        callback_query = CallbackQuery(id='1', from_user=None, chat_instance=None, data=callback_data)
