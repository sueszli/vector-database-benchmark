...
def create_windows_instance(project_id: str, zone: str, instance_name: str, machine_type: str, source_image_family: str='windows-2022', network_link: str='global/networks/default', subnetwork_link: str | None=None) -> compute_v1.Instance:
    if False:
        while True:
            i = 10
    ...
    base_image = get_image_from_family(project='windows-cloud', family=source_image_family)
    disk_type = f'zones/{zone}/diskTypes/pd-standard'
    disks = [disk_from_image(disk_type, 100, True, base_image.self_link, True)]
    instance = create_instance(project_id, zone, instance_name, disks, machine_type=machine_type, network_link=network_link, subnetwork_link=subnetwork_link, external_access=True)
    return instance