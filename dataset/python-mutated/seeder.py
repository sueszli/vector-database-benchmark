...
UNLIMITED = -1
_creator = 'TU Delft'
_dht_routers = [('router.utorrent.com', 6881), ('router.utorrent.com', 6881), ('router.bittorrent.com', 6881), ('dht.transmissionbt.com', 6881), ('dht.aelitis.com', 6881), ('router.bitcomet.com', 6881)]
_port_range = (6881, 7000)
_log_statistics_interval_in_sec = 10
_add_torrent_delay_in_sec = 1
_ignore_glob = ['*DS_Store', '*.torrent', 'thumbnail.png', 'description.md']
