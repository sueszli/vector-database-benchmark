...
class IOResultLikeN(io.IOLikeN[_FirstType, _SecondType, _ThirdType], result.ResultLikeN[_FirstType, _SecondType, _ThirdType]):
    """
...
class IOResultBasedN(IOResultLikeN[_FirstType, _SecondType, _ThirdType], io.IOBasedN[_FirstType, _SecondType, _ThirdType], result.UnwrappableResult[_FirstType, _SecondType, _ThirdType, 'IO[_FirstType]', 'IO[_SecondType]']):
    """
