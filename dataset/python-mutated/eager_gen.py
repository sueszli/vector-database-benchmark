import argparse
import yaml
inplace_out_type_map = {'Tensor': 'Tensor&', 'std::vector<Tensor>': 'std::vector<Tensor>&'}
inplace_optional_out_type_map = {'Tensor': 'paddle::optional<Tensor>&', 'std::vector<Tensor>': 'paddle::optional<std::vector<Tensor>>&'}
