import random
import time
from dagster import AssetCheckResult, AssetCheckSeverity, AssetCheckSpec, AssetKey, AssetOut, AssetSelection, DailyPartitionsDefinition, In, MetadataValue, Nothing, Output, asset, asset_check, define_asset_job, graph_asset, multi_asset, op
...
def downstream_asset():
    if False:
        while True:
            i = 10
    return 1
just_checks_job = define_asset_job(name='just_checks_job', selection=AssetSelection.checks_for_assets(checked_asset))
