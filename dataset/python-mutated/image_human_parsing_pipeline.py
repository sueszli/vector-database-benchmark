...
from modelscope.models.cv.image_human_parsing import M2FP, center_to_target_size_test
...
@PIPELINES.register_module(Tasks.image_segmentation, module_name=Pipelines.image_human_parsing)
