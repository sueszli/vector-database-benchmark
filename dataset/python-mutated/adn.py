...
from ..utils import ass_subtitles_timecode, bytes_to_intlist, bytes_to_long, ExtractorError, float_or_none, int_or_none, intlist_to_bytes, long_to_bytes, pkcs1pad, strip_or_none, try_get, unified_strdate, urlencode_postdata

class ADNIE(InfoExtractor):
    IE_DESC = 'Animation Digital Network'
    _VALID_URL = 'https?://(?:www\\.)?(?:animation|anime)digitalnetwork\\.fr/video/[^/]+/(?P<id>\\d+)'
    _TESTS = [{'url': 'https://animationdigitalnetwork.fr/video/fruits-basket/9841-episode-1-a-ce-soir', 'md5': '1c9ef066ceb302c86f80c2b371615261', 'info_dict': {'id': '9841', 'ext': 'mp4', 'title': 'Fruits Basket - Episode 1', 'description': 'md5:14be2f72c3c96809b0ca424b0097d336', 'series': 'Fruits Basket', 'duration': 1437, 'release_date': '20190405', 'comment_count': int, 'average_rating': float, 'season_number': 1, 'episode': 'À ce soir !', 'episode_number': 1}, 'skip': 'Only available in region (FR, ...)'}, {'url': 'http://animedigitalnetwork.fr/video/blue-exorcist-kyoto-saga/7778-episode-1-debut-des-hostilites', 'only_matching': True}]
    ...
    _RSA_KEY = (, 65537)
    _POS_ALIGN_MAP = {'start': 1, 'end': 3}
    _LINE_ALIGN_MAP = {'middle': 8, 'end': 4}
