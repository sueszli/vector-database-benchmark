"""Saves out a .wav file with synthesized conversational data and labels.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_url', type=str, default='https://storage.googleapis.com/download.tensorflow.org/data/speech_commands_v0.01.tar.gz', help='Location of speech training data')
    parser.add_argument('--data_dir', type=str, default='/tmp/speech_dataset', help='      Where to download the speech training data to.\n      ')
    parser.add_argument('--background_dir', type=str, default='', help='      Path to a directory of .wav files to mix in as background noise during training.\n      ')
    ...
    parser.add_argument('--window_stride_ms', type=float, default=10.0, help='How long the stride is between spectrogram timeslices')
    ...
    parser.add_argument('--output_audio_file', type=str, default='/tmp/speech_commands_train/streaming_test.wav', help='File to save the generated test audio to.')
    parser.add_argument('--output_labels_file', type=str, default='/tmp/speech_commands_train/streaming_test_labels.txt', help='File to save the generated test labels to.')
    parser.add_argument('--test_duration_seconds', type=int, default=600, help='How long the generated test audio file should be.')
    parser.add_argument('--word_gap_ms', type=int, default=2000, help='How long the average gap should be between words.')
    parser.add_argument('--unknown_percentage', type=int, default=30, help='What percentage of words should be unknown.')
