...
import sys
import pytest
FILESYSTEM_ENCODING = str(sys.getfilesystemencoding() or sys.getdefaultencoding())
...
class TestBadSpellings(object):
    ...
    BAD_SPELLINGS = {'licence': 'license', 'organisation': 'organization'}
...
class TestImportStar(object):
    ...
    IMPORT_STAR_BLACKLIST_FILES = ['ckan/plugins/__init__.py']
...
class TestActionAuth(object):
    ...
    ACTION_NO_AUTH_BLACKLIST = ['create: follow_dataset', 'create: follow_group', 'create: follow_user', 'delete: unfollow_dataset', 'delete: unfollow_group', 'delete: unfollow_user', 'get: roles_show', 'update: task_status_update_many', 'update: term_translation_update_many']
    AUTH_NO_ACTION_BLACKLIST = ['create: file_upload', 'delete: revision_delete', 'delete: revision_undelete', 'get: group_list_available', 'get: sysadmin', 'get: request_reset', 'get: user_reset', 'update: group_change_state', 'update: group_edit_permissions', 'update: package_change_state', 'update: revision_change_state']
...
class TestBadExceptions(object):
    ...
    NASTY_EXCEPTION_BLACKLIST_FILES = ['ckan/lib/mailer.py', 'ckan/logic/action/create.py', 'ckan/logic/action/delete.py', 'ckan/logic/action/get.py', 'ckan/logic/action/update.py', 'ckan/logic/auth/create.py', 'ckan/logic/auth/delete.py', 'ckan/logic/auth/get.py', 'ckan/authz.py', 'ckanext/datastore/logic/action.py']
