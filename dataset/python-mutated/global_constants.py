...
ALL_INTEGRATIONS = sorted([*TESTABLE_INTEGRATIONS, *OTHER_INTEGRATIONS])
AUTOCOMPLETE_INTEGRATIONS = sorted(['all-testable', 'all', *ALL_INTEGRATIONS])
...
PIP_VERSION = '23.3.1'
REGULAR_DOC_PACKAGES = ['apache-airflow', 'docker-stack', 'helm-chart', 'apache-airflow-providers']
...
class SelectiveUnitTestTypes(Enum):
    ...
    WWW = 'WWW'
ALLOWED_TEST_TYPE_CHOICES = ['All', 'Default', *all_selective_test_types(), 'All-Postgres', 'All-MySQL', 'All-Quarantined']
ALLOWED_PARALLEL_TEST_TYPE_CHOICES = [*all_selective_test_types()]
...
ALLOWED_HELM_TEST_PACKAGES = ['all', *all_helm_test_packages()]
...
COMMITTERS = ['BasPH', 'Fokko', 'KevinYang21', 'Taragolis', 'XD-DENG', 'aijamalnk', 'alexvanboxel', 'amoghrajesh', 'aoen', 'artwr', 'ashb', 'bbovenzi', 'bolkedebruin', 'criccomini', 'dimberman', 'dstandish', 'eladkal', 'ephraimbuddy', 'feluelle', 'feng-tao', 'ferruzzi', 'houqp', 'hussein-awala', 'jedcunningham', 'jgao54', 'jghoman', 'jhtimmins', 'jmcarp', 'josh-fell', 'jscheffl', 'kaxil', 'leahecole', 'malthe', 'mik-laj', 'milton0825', 'mistercrunch', 'mobuchowski', 'msumit', 'o-nikolas', 'pankajastro', 'pankajkoti', 'phanikumv', 'pierrejeambrun', 'pingzh', 'potiuk', 'r39132', 'ryanahamilton', 'ryw', 'saguziel', 'sekikn', 'turbaszek', 'uranusjr', 'vikramkoka', 'vincbeck', 'xinbinhuang', 'yuqian90', 'zhongjiajie']
...
DEFAULT_EXTRAS = ['aiobotocore', 'amazon', 'async', 'celery', 'cncf.kubernetes', 'daskexecutor', 'docker', 'elasticsearch', 'ftp', 'google', 'google_auth', 'grpc', 'hashicorp', 'http', 'ldap', 'microsoft.azure', 'mysql', 'odbc', 'openlineage', 'pandas', 'postgres', 'redis', 'sendgrid', 'sftp', 'slack', 'snowflake', 'ssh', 'statsd', 'virtualenv']
