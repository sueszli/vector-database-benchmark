...
from sentry.loader.browsersdkversion import get_all_browser_sdk_version_versions, get_highest_browser_sdk_version, match_selected_version_to_browser_sdk_version
from sentry.testutils.cases import TestCase
MOCK_VERSIONS = ['4.0.0-rc.1', '4.6.4', '4.7.4-beta1', '5.0.0', '5.0.1', '5.0.2-beta1', '5.1.1', '5.10.1']
