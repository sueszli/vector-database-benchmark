...
@place(DEVICES)
@parameterize_cls((TEST_CASE_NAME, 'params'), [('params', (('params_not_iterable', 0.3, 1.2, -1.2, 2.3, 3.4), ('params_not_iterable_and_broadcast_for_value', 0.3, 1.2, -1.2, 2.3, np.array([[0.1, 1.2], [1.2, 3.4]], dtype=default_dtype)), ('params_tuple_0305', (0.3, 0.5), 0.7, -1.2, 2.3, 3.4), ('params_tuple_03050104', ((0.3, 0.5), (0.1, 0.4)), 0.7, -1.2, 2.3, 3.4)))])
...
@place(DEVICES)
@parameterize_cls((TEST_CASE_NAME, 'loc', 'scale', 'shape', 'expected_shape'), [('params_1d', [0.1], [1.2], [100], [100, 1]), ('params_2d', [0.3], [1.2, 2.3], [100], [100, 2])])
