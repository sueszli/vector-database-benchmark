...
class LineStrip2DType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            i = 10
            return i + 15
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 2), nullable=False, metadata={})), self._TYPE_NAME)
