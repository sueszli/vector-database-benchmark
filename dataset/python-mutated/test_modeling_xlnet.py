...
if is_torch_available():
    import torch
    from transformers import XLNetForMultipleChoice, XLNetForQuestionAnswering, XLNetForQuestionAnsweringSimple, XLNetForSequenceClassification, XLNetForTokenClassification, XLNetLMHeadModel, XLNetModel
...
class XLNetModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (XLNetModel, XLNetLMHeadModel, XLNetForTokenClassification, XLNetForSequenceClassification, XLNetForQuestionAnswering, XLNetForQuestionAnsweringSimple, XLNetForMultipleChoice) if is_torch_available() else ()
    all_generative_model_classes = (XLNetLMHeadModel,) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': XLNetModel, 'question-answering': XLNetForQuestionAnsweringSimple, 'text-classification': XLNetForSequenceClassification, 'text-generation': XLNetLMHeadModel, 'token-classification': XLNetForTokenClassification, 'zero-shot': XLNetForSequenceClassification} if is_torch_available() else {}
    fx_compatible = False
    test_pruning = False
