...
class AzureAppConfiguration(AzureAppConfigurationOperationsMixin):
    ...
    def __init__(self, credential: AzureKeyCredential, endpoint: str, sync_token: Optional[str]=None, **kwargs: Any) -> None:
        if False:
            print('Hello World!')
        _endpoint = '{endpoint}'
        self._config = AzureAppConfigurationConfiguration(credential=credential, endpoint=endpoint, sync_token=sync_token, **kwargs)
