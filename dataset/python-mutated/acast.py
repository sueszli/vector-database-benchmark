...
class ACastChannelIE(ACastBaseIE):
    ...
    _VALID_URL = '(?x)\n                    https?://\n                        (?:\n                            (?:www\\.)?acast\\.com/|\n                            play\\.acast\\.com/s/\n                        )\n                        (?P<id>[^/#?]+)\n                    '
    _TESTS = [{'url': 'https://www.acast.com/todayinfocus', 'info_dict': {'id': '4efc5294-5385-4847-98bd-519799ce5786', 'title': 'Today in Focus', 'description': 'md5:c09ce28c91002ce4ffce71d6504abaae'}, 'playlist_mincount': 200}, {'url': 'http://play.acast.com/s/ft-banking-weekly', 'only_matching': True}]
