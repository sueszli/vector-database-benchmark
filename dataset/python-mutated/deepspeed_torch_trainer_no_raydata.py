...
if __name__ == '__main__':
    ...
    training_config = {'seed': 42, 'num_epochs': 3, 'eval_batch_size': 32, 'deepspeed_config': deepspeed_config}
    trainer = TorchTrainer(train_func, train_loop_config=training_config, scaling_config=ScalingConfig(num_workers=4, use_gpu=True))
    result = trainer.fit()
