...
MVP_PRETRAINED_MODEL_ARCHIVE_LIST = ['RUCAIBox/mvp', 'RUCAIBox/mvp-data-to-text', 'RUCAIBox/mvp-open-dialog', 'RUCAIBox/mvp-question-answering', 'RUCAIBox/mvp-question-generation', 'RUCAIBox/mvp-story', 'RUCAIBox/mvp-summarization', 'RUCAIBox/mvp-task-dialog', 'RUCAIBox/mtl-data-to-text', 'RUCAIBox/mtl-multi-task', 'RUCAIBox/mtl-open-dialog', 'RUCAIBox/mtl-question-answering', 'RUCAIBox/mtl-question-generation', 'RUCAIBox/mtl-story', 'RUCAIBox/mtl-summarization']
