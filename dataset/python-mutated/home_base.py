...
class FreeboxHomeEntity(Entity):
    ...
    async def async_update_signal(self):
        ...
        if self._sub_node is None:
            ...
            self._attr_name = self._node['label'].strip() + ' ' + self._sub_node['label'].strip()
    ...
    async def set_home_endpoint_value(self, command_id: Any, value=None) -> bool:
        ...
        if command_id is None:
            ...
            return False
        await self._router.home.set_home_endpoint_value(self._id, command_id, {'value': value})
        return True
    ...
    async def async_added_to_hass(self):
        ...
        self.remove_signal_update(async_dispatcher_connect(self._hass, self._router.signal_home_device_update, self.async_update_signal))
