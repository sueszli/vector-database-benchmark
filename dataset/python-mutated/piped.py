...
about = {'website': 'https://github.com/TeamPiped/Piped/', 'wikidata_id': 'Q107565255', 'official_api_documentation': 'https://docs.piped.video/docs/api-documentation/', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
categories = []
paging = True
