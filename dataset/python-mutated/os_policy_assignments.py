...
class OSPolicyAssignment(proto.Message):
    ...
    class InstanceFilter(proto.Message):
        ...
        class Inventory(proto.Message):
            ...
            """
            os_short_name: str = proto.Field(proto.STRING, number=1)
            os_version: str = proto.Field(proto.STRING, number=2)
        all_: bool = proto.Field(proto.BOOL, number=1)
        inclusion_labels: MutableSequence['OSPolicyAssignment.LabelSet'] = proto.RepeatedField(proto.MESSAGE, number=2, message='OSPolicyAssignment.LabelSet')
        exclusion_labels: MutableSequence['OSPolicyAssignment.LabelSet'] = proto.RepeatedField(proto.MESSAGE, number=3, message='OSPolicyAssignment.LabelSet')
        inventories: MutableSequence['OSPolicyAssignment.InstanceFilter.Inventory'] = proto.RepeatedField(proto.MESSAGE, number=4, message='OSPolicyAssignment.InstanceFilter.Inventory')
    ...
    class Rollout(proto.Message):
        ...
        """
        disruption_budget: osconfig_common.FixedOrPercent = proto.Field(proto.MESSAGE, number=1, message=osconfig_common.FixedOrPercent)
        min_wait_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    name: str = proto.Field(proto.STRING, number=1)
    description: str = proto.Field(proto.STRING, number=2)
    os_policies: MutableSequence[os_policy.OSPolicy] = proto.RepeatedField(proto.MESSAGE, number=3, message=os_policy.OSPolicy)
    instance_filter: InstanceFilter = proto.Field(proto.MESSAGE, number=4, message=InstanceFilter)
    rollout: Rollout = proto.Field(proto.MESSAGE, number=5, message=Rollout)
    revision_id: str = proto.Field(proto.STRING, number=6)
    revision_create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    etag: str = proto.Field(proto.STRING, number=8)
    rollout_state: RolloutState = proto.Field(proto.ENUM, number=9, enum=RolloutState)
    baseline: bool = proto.Field(proto.BOOL, number=10)
    deleted: bool = proto.Field(proto.BOOL, number=11)
    reconciling: bool = proto.Field(proto.BOOL, number=12)
    uid: str = proto.Field(proto.STRING, number=13)

class OSPolicyAssignmentOperationMetadata(proto.Message):
    """OS policy assignment operation metadata provided by OS policy
    ...
    class RolloutState(proto.Enum):
        ...
        CANCELLED = 3
        SUCCEEDED = 4
    os_policy_assignment: str = proto.Field(proto.STRING, number=1)
    api_method: APIMethod = proto.Field(proto.ENUM, number=2, enum=APIMethod)
    rollout_state: RolloutState = proto.Field(proto.ENUM, number=3, enum=RolloutState)
    rollout_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    rollout_update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
...
class CreateOSPolicyAssignmentRequest(proto.Message):
    ...
    os_policy_assignment: 'OSPolicyAssignment' = proto.Field(proto.MESSAGE, number=2, message='OSPolicyAssignment')
    os_policy_assignment_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateOSPolicyAssignmentRequest(proto.Message):
    ...
    """
    os_policy_assignment: 'OSPolicyAssignment' = proto.Field(proto.MESSAGE, number=1, message='OSPolicyAssignment')
...
class ListOSPolicyAssignmentsRequest(proto.Message):
    """A request message to list OS policy assignments for a parent
    resource
...
class ListOSPolicyAssignmentsResponse(proto.Message):
    """A response message for listing all assignments under given
    parent.
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    os_policy_assignments: MutableSequence['OSPolicyAssignment'] = proto.RepeatedField(proto.MESSAGE, number=1, message='OSPolicyAssignment')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class ListOSPolicyAssignmentRevisionsRequest(proto.Message):
    """A request message to list revisions for a OS policy
    assignment
...
class ListOSPolicyAssignmentRevisionsResponse(proto.Message):
    """A response message for listing all revisions for a OS policy
    assignment.
