...
class RunQueueConfig(NamedTuple('_RunQueueConfig', [('max_concurrent_runs', int), ('tag_concurrency_limits', Sequence[Mapping[str, Any]]), ('max_user_code_failure_retries', int), ('user_code_failure_retry_delay', int)])):
