...
class IviIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<embed[^>]+?src=(["\\\'])(?P<url>https?://(?:www\\.)?ivi\\.ru/video/player.+?)\\1']
    _GEO_BYPASS = False
    _GEO_COUNTRIES = ['RU']
    _LIGHT_KEY = b"\xf1\x022\xb7\xbc\\z\xe8\xf7\x96\xc13+'\xa1\x8c"
    _LIGHT_URL = 'https://api.ivi.ru/light/'
    _TESTS = [{'url': 'http://www.ivi.ru/watch/53141', 'md5': '6ff5be2254e796ed346251d117196cf4', 'info_dict': {'id': '53141', 'ext': 'mp4', 'title': 'Иван Васильевич меняет профессию', 'description': 'md5:b924063ea1677c8fe343d8a72ac2195f', 'duration': 5498, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'skip': 'Only works from Russia'}, {'url': 'http://www.ivi.ru/watch/dvoe_iz_lartsa/9549', 'md5': '221f56b35e3ed815fde2df71032f4b3e', 'info_dict': {'id': '9549', 'ext': 'mp4', 'title': 'Двое из ларца - Дело Гольдберга (1 часть)', 'series': 'Двое из ларца', 'season': 'Сезон 1', 'season_number': 1, 'episode': 'Дело Гольдберга (1 часть)', 'episode_number': 1, 'duration': 2655, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'skip': 'Only works from Russia'}, {'url': 'http://www.ivi.ru/watch/146500', 'md5': 'd63d35cdbfa1ea61a5eafec7cc523e1e', 'info_dict': {'id': '146500', 'ext': 'mp4', 'title': 'Кукла', 'description': 'md5:ffca9372399976a2d260a407cc74cce6', 'duration': 5599, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'skip': 'Only works from Russia'}, {'url': 'https://www.ivi.tv/watch/33560/', 'only_matching': True}]
    _KNOWN_FORMATS = ('MP4-low-mobile', 'MP4-mobile', 'FLV-lo', 'MP4-lo', 'FLV-hi', 'MP4-hi', 'MP4-SHQ', 'MP4-HD720', 'MP4-HD1080')
...
class IviCompilationIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.ivi.ru/watch/dvoe_iz_lartsa', 'info_dict': {'id': 'dvoe_iz_lartsa', 'title': 'Двое из ларца (2006 - 2008)'}, 'playlist_mincount': 24}, {'url': 'http://www.ivi.ru/watch/dvoe_iz_lartsa/season1', 'info_dict': {'id': 'dvoe_iz_lartsa/season1', 'title': 'Двое из ларца (2006 - 2008) 1 сезон'}, 'playlist_mincount': 12}]
