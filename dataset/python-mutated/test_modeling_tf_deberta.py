...
if is_tf_available():
    ...
    from transformers import TFDebertaForMaskedLM, TFDebertaForQuestionAnswering, TFDebertaForSequenceClassification, TFDebertaForTokenClassification, TFDebertaModel
...
class TFDebertaModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFDebertaModel, TFDebertaForMaskedLM, TFDebertaForQuestionAnswering, TFDebertaForSequenceClassification, TFDebertaForTokenClassification) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFDebertaModel, 'fill-mask': TFDebertaForMaskedLM, 'question-answering': TFDebertaForQuestionAnswering, 'text-classification': TFDebertaForSequenceClassification, 'token-classification': TFDebertaForTokenClassification, 'zero-shot': TFDebertaForSequenceClassification} if is_tf_available() else {}
