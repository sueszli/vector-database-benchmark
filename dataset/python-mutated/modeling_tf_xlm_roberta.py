...
TF_XLM_ROBERTA_PRETRAINED_MODEL_ARCHIVE_LIST = ['xlm-roberta-base', 'xlm-roberta-large', 'joeddav/xlm-roberta-large-xnli', 'cardiffnlp/twitter-xlm-roberta-base-sentiment']
