...
class Test_elbv2_insecure_ssl_ciphers:
    ...
    def test_elb_no_balancers(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers import elbv2_insecure_ssl_ciphers
    ...
    def test_elbv2_listener_with_secure_policy(self):
        ...
        response = conn.create_listener(LoadBalancerArn=lb['LoadBalancerArn'], Protocol='HTTPS', Port=443, SslPolicy='ELBSecurityPolicy-TLS-1-2-2017-01', DefaultActions=[{'Type': 'forward', 'TargetGroupArn': target_group_arn}])
        from prowler.providers.aws.services.elbv2.elbv2_service import ELBv2
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers import elbv2_insecure_ssl_ciphers
            check = elbv2_insecure_ssl_ciphers()
    ...
    def test_elbv2_with_HTTPS_listener(self):
        ...
        target_group = response.get('TargetGroups')[0]
        target_group_arn = target_group['TargetGroupArn']
        response = conn.create_listener(LoadBalancerArn=lb['LoadBalancerArn'], Protocol='HTTPS', SslPolicy='ELBSecurityPolicy-TLS-1-1-2017-01', DefaultActions=[{'Type': 'forward', 'TargetGroupArn': target_group_arn}])
        from prowler.providers.aws.services.elbv2.elbv2_service import ELBv2
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers.elbv2_client', new=ELBv2(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.elbv2.elbv2_insecure_ssl_ciphers.elbv2_insecure_ssl_ciphers import elbv2_insecure_ssl_ciphers
            check = elbv2_insecure_ssl_ciphers()
