...
from mypy.semanal import SemanticAnalyzer, apply_semantic_analyzer_patches, remove_imported_names_from_symtable
from mypy.semanal_classprop import add_type_promotion, calculate_class_abstract_status, calculate_class_vars, check_protocol_status
...
CORE_WARMUP: Final = 2
core_modules: Final = ['typing', '_collections_abc', 'builtins', 'abc', 'collections', 'collections.abc']
