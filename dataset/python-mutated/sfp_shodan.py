...
class sfp_shodan(SpiderFootPlugin):
    meta = {'name': 'SHODAN', 'summary': 'Obtain information from SHODAN about identified IP addresses.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Search Engines'], 'dataSource': {'website': 'https://www.shodan.io/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://developer.shodan.io/api', 'https://developer.shodan.io/apps'], 'apiKeyInstructions': ['Visit https://shodan.io', 'Register a free account', 'Navigate to https://account.shodan.io/', "The API key is listed under 'API Key'"], 'favIcon': 'https://static.shodan.io/shodan/img/favicon.png', 'logo': 'https://static.shodan.io/developer/img/logo.png', 'description': "Shodan is the world's first search engine for Internet-connected devices.\nUse Shodan to discover which of your devices are connected to the Internet, where they are located and who is using them.Keep track of all the computers on your network that are directly accessible from the Internet. Shodan lets you understand your digital footprint."}}
    opts = {'api_key': '', 'netblocklookup': True, 'maxnetblock': 24}
    optdescs = {'api_key': 'SHODAN API Key.', 'netblocklookup': 'Look up all IPs on netblocks deemed to be owned by your target for possible hosts on the same target subdomain/domain?', 'maxnetblock': 'If looking up owned netblocks, the maximum netblock size to look up all IPs within (CIDR value, 24 = /24, 16 = /16, etc.)'}
    results = None
    errorState = False
