...
if __name__ == '__main__':
    ...
    for key in sorted(ALL_DEPENDENCIES.keys()):
        ...
        unique_sorted_dependencies[key]['cross-providers-deps'] = sorted(set(ALL_DEPENDENCIES[key]['cross-providers-deps']))
    ...
    if new_dependencies != old_dependencies:
        ...
        if os.environ.get('CI'):
            ...
            console.print(f'[yellow]You will need to run breeze locally and commit {DEPENDENCIES_JSON_FILE_PATH.relative_to(AIRFLOW_SOURCES_ROOT)}!\n')
            console.print()
        else:
            console.print()
            console.print(f'[yellow]Regenerated new dependencies. Please commit {DEPENDENCIES_JSON_FILE_PATH.relative_to(AIRFLOW_SOURCES_ROOT)}!\n')
            console.print(f'[info]Written {DEPENDENCIES_JSON_FILE_PATH}')
            console.print()
    else:
        console.print(f'[green]No need to regenerate dependencies!\n[/]The {DEPENDENCIES_JSON_FILE_PATH.relative_to(AIRFLOW_SOURCES_ROOT)} is up to date!\n')