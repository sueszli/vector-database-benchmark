...
from sentry.issues.grouptype import FeedbackGroup, GroupCategory, PerformanceDurationRegressionGroupType, PerformanceNPlusOneGroupType, ProfileFileIOGroupType
from sentry.issues.ingest import save_issue_occurrence
from sentry.models.activity import Activity, ActivityIntegration
from sentry.models.group import Group, GroupStatus
from sentry.models.groupassignee import GroupAssignee
from sentry.models.groupinbox import GroupInbox, GroupInboxReason
from sentry.models.groupowner import ASSIGNEE_EXISTS_DURATION, ASSIGNEE_EXISTS_KEY, ISSUE_OWNERS_DEBOUNCE_DURATION, ISSUE_OWNERS_DEBOUNCE_KEY, GroupOwner, GroupOwnerType
...
from sentry.tasks.post_process import ISSUE_OWNERS_PER_PROJECT_PER_MIN_RATELIMIT, feedback_filter_decorator, post_process_group, process_event
...
class ProcessCommitsTestMixin(BasePostProgressGroupMixin):
    github_blame_return_value = {'commitId': 'asdfwreqr', 'committedDate': datetime.now(timezone.utc) - timedelta(days=2), 'commitMessage': 'placeholder commit message', 'commitAuthorName': '', 'commitAuthorEmail': 'admin@localhost'}
...
class PostProcessGroupErrorTest(TestCase, AssignmentTestMixin, ProcessCommitsTestMixin, CorePostProcessGroupTestMixin, DeriveCodeMappingsProcessGroupTestMixin, InboxTestMixin, ResourceChangeBoundsTestMixin, RuleProcessorTestMixin, ServiceHooksTestMixin, SnoozeTestMixin, SnoozeTestSkipSnoozeMixin, SDKCrashMonitoringTestMixin, ReplayLinkageTestMixin):
...
@region_silo_test(stable=True)
class PostProcessGroupPerformanceTest(TestCase, SnubaTestCase, PerfIssueTransactionTestMixin, CorePostProcessGroupTestMixin, InboxTestMixin, RuleProcessorTestMixin, SnoozeTestMixin, SnoozeTestSkipSnoozeMixin, PerformanceIssueTestCase):
...
@region_silo_test
class PostProcessGroupAggregateEventTest(TestCase, SnubaTestCase, PerfIssueTransactionTestMixin, CorePostProcessGroupTestMixin, SnoozeTestSkipSnoozeMixin, PerformanceIssueTestCase):
...
@region_silo_test(stable=True)
class PostProcessGroupGenericTest(TestCase, SnubaTestCase, OccurrenceTestMixin, CorePostProcessGroupTestMixin, InboxTestMixin, RuleProcessorTestMixin, SnoozeTestMixin):
...
@region_silo_test(stable=True)
class PostProcessGroupFeedbackTest(TestCase, SnubaTestCase, OccurrenceTestMixin, CorePostProcessGroupTestMixin, InboxTestMixin, RuleProcessorTestMixin, SnoozeTestMixin):
