...
from nvidia.dali._utils.external_source_impl import get_callback_from_source as _get_callback_from_source, accepted_arg_count as _accepted_arg_count, SourceKind as _SourceKind
