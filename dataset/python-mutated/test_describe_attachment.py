...
class MockManager:
    ...
    def setup_stubs(self, error, stop_on, stubber):
        ...
        with self.stub_runner(error, stop_on) as runner:
            runner.add(stubber.stub_describe_attachment, self.attachment_id, self.file_name)
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_describe_attachment', 0)])
