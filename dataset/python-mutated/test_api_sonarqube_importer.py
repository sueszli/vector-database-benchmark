...
class TestSonarqubeImporterNoSQToolConfig(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_product.json']
...
class TestSonarqubeImporterOneSQToolConfig(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_product.json']
...
class TestSonarqubeImporterMultipleSQToolConfig(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_toolConfig2.json', 'unit_sonarqube_product.json']
...
class TestSonarqubeImporterOneSQConfigNoKey(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_toolConfig2.json', 'unit_sonarqube_product.json', 'unit_sonarqube_sqcNoKey.json']
...
class TestSonarqubeImporterOneSQConfigWithKey(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_toolConfig2.json', 'unit_sonarqube_product.json', 'unit_sonarqube_sqcWithKey.json']
...
class TestSonarqubeImporterMultipleSQConfigs(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_toolConfig2.json', 'unit_sonarqube_product.json', 'unit_sonarqube_sqcNoKey.json', 'unit_sonarqube_sqcWithKey.json']
...
class TestSonarqubeImporterTwoIssuesNoHotspots(DojoTestCase):
    fixtures = ['unit_sonarqube_toolType.json', 'unit_sonarqube_toolConfig1.json', 'unit_sonarqube_sqcWithKey.json', 'unit_sonarqube_product.json']
