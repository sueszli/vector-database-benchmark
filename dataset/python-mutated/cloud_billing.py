...
import proto
__protobuf__ = proto.module(package='google.cloud.billing.v1', manifest={'BillingAccount', 'ProjectBillingInfo', 'GetBillingAccountRequest', 'ListBillingAccountsRequest', 'ListBillingAccountsResponse', 'CreateBillingAccountRequest', 'UpdateBillingAccountRequest', 'ListProjectBillingInfoRequest', 'ListProjectBillingInfoResponse', 'GetProjectBillingInfoRequest', 'UpdateProjectBillingInfoRequest'})
...
class BillingAccount(proto.Message):
    ...
    open_: bool = proto.Field(proto.BOOL, number=2)
    display_name: str = proto.Field(proto.STRING, number=3)
    master_billing_account: str = proto.Field(proto.STRING, number=4)
...
class ProjectBillingInfo(proto.Message):
    ...
    billing_account_name: str = proto.Field(proto.STRING, number=3)
    billing_enabled: bool = proto.Field(proto.BOOL, number=4)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    billing_accounts: MutableSequence['BillingAccount'] = proto.RepeatedField(proto.MESSAGE, number=1, message='BillingAccount')
...
class CreateBillingAccountRequest(proto.Message):
    ...
    Attributes:
        billing_account (google.cloud.billing_v1.types.BillingAccount):
            ...
            billing account.
    """
    billing_account: 'BillingAccount' = proto.Field(proto.MESSAGE, number=1, message='BillingAccount')
...
class UpdateBillingAccountRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    account: 'BillingAccount' = proto.Field(proto.MESSAGE, number=2, message='BillingAccount')
...
class ListProjectBillingInfoResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    project_billing_info: MutableSequence['ProjectBillingInfo'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ProjectBillingInfo')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateProjectBillingInfoRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    project_billing_info: 'ProjectBillingInfo' = proto.Field(proto.MESSAGE, number=2, message='ProjectBillingInfo')
