...
HParams = namedtuple('HParams', 'mode, min_lr, lr, batch_size, enc_layers, enc_timesteps, dec_timesteps, min_input_len, num_hidden, emb_dim, max_grad_norm, num_softmax_samples')
