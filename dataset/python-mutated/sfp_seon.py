...
class sfp_seon(SpiderFootPlugin):
    meta = {'name': 'Seon', 'summary': 'Queries seon.io to gather intelligence about IP Addresses, email addresses, and phone numbers', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Real World'], 'dataSource': {'website': 'https://seon.io/', 'model': 'COMMERCIAL_ONLY', 'references': ['https://docs.seon.io/api-reference'], 'apiKeyInstructions': ['Visit https://seon.io/', 'Register an account', 'Visit https://docs.seon.io/api-reference', "Your API key is listed under 'License key'"], 'favIcon': 'https://seon.io/assets/favicons/favicon-16x16.png', 'logo': 'https://seon.io/assets/favicons/apple-touch-icon-152.png', 'description': 'SEON Fraud Prevention tools help organisations reduce the costs and resources lost to fraud. Spot fake accounts, slash manual reviews and cut chargebacks now.'}}
    opts = {'api_key': '', 'fraud_threshold': 80}
    optdescs = {'api_key': 'seon.io API Key', 'fraud_threshold': 'Minimum fraud score for target to be marked as malicious (0-100)'}
    results = None
