...
class Migration(migrations.Migration):
    dependencies = [('product', '0177_product_tax_class_producttype_tax_class')]
    operations = [migrations.RunPython(set_description_plaintext_if_description_exists, migrations.RunPython.noop)]