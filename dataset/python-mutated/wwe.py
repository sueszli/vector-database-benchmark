...
class WWEBaseIE(InfoExtractor):
    _SUBTITLE_LANGS = {'English': 'en', 'Deutsch': 'de'}
...
class WWEIE(WWEBaseIE):
    ...
    _TESTS = [{'url': 'https://www.wwe.com/videos/daniel-bryan-vs-andrade-cien-almas-smackdown-live-sept-4-2018', 'md5': '92811c6a14bfc206f7a6a9c5d9140184', 'info_dict': {'id': '40048199', 'ext': 'mp4', 'title': 'Daniel Bryan vs. Andrade "Cien" Almas: SmackDown LIVE, Sept. 4, 2018', 'description': 'md5:2d7424dbc6755c61a0e649d2a8677f67', 'thumbnail': 're:^https?://.*\\.jpg$'}}, {'url': 'https://de.wwe.com/videos/gran-metalik-vs-tony-nese-wwe-205-live-sept-4-2018', 'only_matching': True}]
...
class WWEPlaylistIE(WWEBaseIE):
    _VALID_URL = 'https?://(?:[^/]+\\.)?wwe\\.com/(?:[^/]+/)*(?P<id>[^/?#&]+)'
    _TESTS = [{'url': 'https://www.wwe.com/shows/raw/2018-11-12', 'info_dict': {'id': '2018-11-12'}, 'playlist_mincount': 11}, {'url': 'http://www.wwe.com/article/walk-the-prank-wwe-edition', 'only_matching': True}, {'url': 'https://www.wwe.com/shows/wwenxt/article/matt-riddle-interview', 'only_matching': True}]
