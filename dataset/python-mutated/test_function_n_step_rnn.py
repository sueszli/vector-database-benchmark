...
@testing.parameterize(*testing.product_dict([{'n_layers': 1, 'hidden_size': 2, 'input_size': 1, 'batches': (1, 1, 1), 'activation': 'relu'}, {'n_layers': 1, 'hidden_size': 2, 'input_size': 1, 'batches': (1, 1, 1), 'activation': 'tanh'}, {'n_layers': 2, 'hidden_size': 2, 'input_size': 3, 'batches': (3, 2, 1), 'activation': 'relu'}, {'n_layers': 2, 'hidden_size': 2, 'input_size': 3, 'batches': (3, 2, 1), 'activation': 'tanh'}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
@testing.fix_random()
...
@testing.parameterize(*testing.product_dict([{'n_layers': 1, 'hidden_size': 2, 'input_size': 1, 'batches': (1, 1, 1), 'activation': 'relu'}, {'n_layers': 1, 'hidden_size': 2, 'input_size': 1, 'batches': (1, 1, 1), 'activation': 'tanh'}, {'n_layers': 2, 'hidden_size': 2, 'input_size': 3, 'batches': (3, 2, 1), 'activation': 'relu'}, {'n_layers': 2, 'hidden_size': 2, 'input_size': 3, 'batches': (3, 2, 1), 'activation': 'tanh'}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
@testing.fix_random()
@backend.inject_backend_tests(None, testing.product({'use_chainerx': [True], 'chainerx_device': ['native:0', 'cuda:0']}) + testing.product({'use_cuda': [False], 'use_ideep': ['never', 'always']}) + testing.product([[{'use_cuda': True}], testing.product({'use_cudnn': ['always'], 'cudnn_deterministic': [True, False], 'autotune': [True, False]})]))
