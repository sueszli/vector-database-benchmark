...
class CodeGeeXForCodeTranslation(TorchModel):
    ...
    def forward(self, input: Dict[str, str]) -> Dict[str, str]:
        ...
        for prompt in [prompt]:
            ...
            token_stream = get_token_stream(model, tokenizer, seq_length, out_seq_length, [copy.deepcopy(tokens) for _ in range(micro_batch_size)], micro_batch_size=micro_batch_size, bad_ids=bad_ids, greedy=True)
