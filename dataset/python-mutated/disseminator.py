...
class Service(TinyTriblerService):
    ...
    async def on_tribler_started(self):
        ...
        await self.create_channel(gigachannel_component.community, gigachannel_manager_component.gigachannel_manager)
if __name__ == '__main__':
    _arguments = parse_args()
    print(f'Arguments: {_arguments}')
    setup_logger(_arguments.verbosity)
    service = Service(source_dir=Path(_arguments.source), state_dir=Path(_arguments.tribler_dir), testnet=_arguments.testnet)
