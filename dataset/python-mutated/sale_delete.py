...
from ...utils import convert_migrated_sale_predicate_to_catalogue_info, get_products_for_rule
...
class SaleDelete(ModelDeleteMutation):
    ...
    class Meta:
        description = 'Deletes a sale.' + DEPRECATED_IN_3X_MUTATION + ' Use `promotionDelete` mutation instead.'
