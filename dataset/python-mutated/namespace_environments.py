...
from app.apis.namespace_environment_image_builds import DeleteProjectEnvironmentImageBuilds
...
@api.route('/in-use/<string:project_uuid>/<string:environment_uuid>')
@api.param('project_uuid', 'UUID of the project')
@api.param('environment_uuid', 'UUID of the environment')
