...
TEST_ENTRY_PATH: str = f'projects/{TEST_PROJECT_ID}/locations/{TEST_LOCATION}/entryGroups/{TEST_ENTRY_GROUP_ID}/entries/{TEST_ENTRY_ID}'
...
TEST_TAG_PATH: str = f'projects/{TEST_PROJECT_ID}/locations/{TEST_LOCATION}/entryGroups/{TEST_ENTRY_GROUP_ID}/entries/{TEST_ENTRY_ID}/tags/{TEST_TAG_ID}'
TEST_ENTRY: Entry = Entry(name=TEST_ENTRY_PATH)
TEST_ENTRY_DICT: dict = {'description': '', 'display_name': '', 'linked_resource': '', 'fully_qualified_name': '', 'labels': {}, 'name': TEST_ENTRY_PATH}
...
TEST_TAG_TEMPLATE_DICT: dict = {'display_name': '', 'fields': {}, 'is_publicly_readable': False, 'name': TEST_TAG_TEMPLATE_PATH}
TEST_TAG_TEMPLATE_FIELD: TagTemplateField = TagTemplateField(name=TEST_TAG_TEMPLATE_FIELD_ID)
TEST_TAG_TEMPLATE_FIELD_DICT: dict = {'description': '', 'display_name': '', 'is_required': False, 'name': TEST_TAG_TEMPLATE_FIELD_ID, 'order': 0}
...
TEST_TAG_TEMPLATE_FIELD_LINK = 'projects/{project_id}/locations/{location}/tagTemplates/{tag_template_id}    /fields/{tag_template_field_id}'
