...
from modelscope.models.nlp.unite.translation_evaluation import combine_input_sentences
from modelscope.preprocessors import Preprocessor
from modelscope.preprocessors.builder import PREPROCESSORS
from modelscope.utils.constant import Fields, ModeKeys
from .transformers_tokenizer import NLPTokenizer

@PREPROCESSORS.register_module(Fields.nlp, module_name=Preprocessors.translation_evaluation)
class TranslationEvaluationTransformersPreprocessor(Preprocessor):
    """The tokenizer preprocessor used for translation evaluation.
    """
