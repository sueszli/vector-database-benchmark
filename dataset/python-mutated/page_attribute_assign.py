...
class PageAttributeAssign(BaseMutation):
    ...
    class Arguments:
        page_type_id = graphene.ID(required=True, description='ID of the page type to assign the attributes into.')
        attribute_ids = NonNullList(graphene.ID, required=True, description='The IDs of the attributes to assign.')
