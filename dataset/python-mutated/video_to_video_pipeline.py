...
@PIPELINES.register_module(Tasks.video_to_video, module_name=Pipelines.video_to_video_pipeline)
class VideoToVideoPipeline(Pipeline):
    """ Video To Video Pipeline, generating super-resolution videos based on input
    video and text
