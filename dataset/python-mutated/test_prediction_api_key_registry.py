...
from google.cloud.recommendationengine_v1beta1.services.prediction_api_key_registry import PredictionApiKeyRegistryAsyncClient, PredictionApiKeyRegistryClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(PredictionApiKeyRegistryClient, 'grpc'), (PredictionApiKeyRegistryAsyncClient, 'grpc_asyncio'), (PredictionApiKeyRegistryClient, 'rest')])
def test_prediction_api_key_registry_client_from_service_account_info(client_class, transport_name):
    ...
    with mock.patch.object(service_account.Credentials, 'from_service_account_info') as factory:
        ...
        assert client.transport._host == ('recommendationengine.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://recommendationengine.googleapis.com')

@pytest.mark.parametrize('transport_class,transport_name', [(transports.PredictionApiKeyRegistryGrpcTransport, 'grpc'), (transports.PredictionApiKeyRegistryGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.PredictionApiKeyRegistryRestTransport, 'rest')])
...
def test_prediction_api_key_registry_client_get_transport_class():
    ...
    available_transports = [transports.PredictionApiKeyRegistryGrpcTransport, transports.PredictionApiKeyRegistryRestTransport]
...
@pytest.mark.parametrize('client_class', [PredictionApiKeyRegistryClient, PredictionApiKeyRegistryAsyncClient])
@mock.patch.object(PredictionApiKeyRegistryClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PredictionApiKeyRegistryClient))
@mock.patch.object(PredictionApiKeyRegistryAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PredictionApiKeyRegistryAsyncClient))
...
def test_prediction_api_key_registry_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_api_key_registry.transports.PredictionApiKeyRegistryGrpcTransport.__init__') as grpc_transport:
        ...
        client = PredictionApiKeyRegistryClient(client_options={'api_endpoint': 'squid.clam.whelk'})
...
def test_prediction_api_key_registry_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel') as create_channel:
        ...
        client = client_class(client_options=options, transport=transport_name)
        create_channel.assert_called_with('recommendationengine.googleapis.com:443', credentials=file_creds, credentials_file=None, quota_project_id=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=None, default_host='recommendationengine.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])

@pytest.mark.parametrize('request_type', [prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest, dict])
def test_create_prediction_api_key_registration(request_type, transport: str='grpc'):
    if False:
        while True:
            i = 10
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_prediction_api_key_registration_empty_call():
    if False:
        for i in range(10):
            print('nop')
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.create_prediction_api_key_registration), '__call__') as call:
...
async def test_create_prediction_api_key_registration_async(transport: str='grpc_asyncio', request_type=prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest):
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_prediction_api_key_registration), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))
...
def test_create_prediction_api_key_registration_field_headers():
    if False:
        while True:
            i = 10
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_create_prediction_api_key_registration_field_headers_async():
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_prediction_api_key_registration), '__call__') as call:
...
def test_create_prediction_api_key_registration_flattened():
    ...
    with mock.patch.object(type(client.transport.create_prediction_api_key_registration), '__call__') as call:
        call.return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration()
        client.create_prediction_api_key_registration(parent='parent_value', prediction_api_key_registration=prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
...
def test_create_prediction_api_key_registration_flattened_error():
    ...
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_prediction_api_key_registration(prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest(), parent='parent_value', prediction_api_key_registration=prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))
...
async def test_create_prediction_api_key_registration_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_prediction_api_key_registration), '__call__') as call:
        call.return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(prediction_apikey_registry_service.PredictionApiKeyRegistration())
        response = await client.create_prediction_api_key_registration(parent='parent_value', prediction_api_key_registration=prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_prediction_api_key_registration_flattened_error_async():
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_prediction_api_key_registration(prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest(), parent='parent_value', prediction_api_key_registration=prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))

@pytest.mark.parametrize('request_type', [prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest, dict])
def test_list_prediction_api_key_registrations(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_prediction_api_key_registrations), '__call__') as call:
        call.return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(next_page_token='next_page_token_value')
...
async def test_list_prediction_api_key_registrations_async(transport: str='grpc_asyncio', request_type=prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_prediction_api_key_registrations), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(next_page_token='next_page_token_value'))
...
def test_list_prediction_api_key_registrations_flattened_error():
    ...
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_prediction_api_key_registrations(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsRequest(), parent='parent_value')
...
async def test_list_prediction_api_key_registrations_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_prediction_api_key_registrations), '__call__') as call:
        call.return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse())
        response = await client.list_prediction_api_key_registrations(parent='parent_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_list_prediction_api_key_registrations_pager(transport_name: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_prediction_api_key_registrations), '__call__') as call:
        ...
        assert all((isinstance(i, prediction_apikey_registry_service.PredictionApiKeyRegistration) for i in results))
...
async def test_list_prediction_api_key_registrations_async_pager():
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_prediction_api_key_registrations), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration()], next_page_token='abc'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[], next_page_token='def'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration()], next_page_token='ghi'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration()]), RuntimeError)
        ...
        assert all((isinstance(i, prediction_apikey_registry_service.PredictionApiKeyRegistration) for i in responses))
...
@pytest.mark.parametrize('request_type', [prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest, dict])
...
def test_delete_prediction_api_key_registration_flattened_error():
    ...
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_prediction_api_key_registration(prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest(), name='name_value')
...
async def test_delete_prediction_api_key_registration_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_prediction_api_key_registration), '__call__') as call:
        call.return_value = None
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.delete_prediction_api_key_registration(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_delete_prediction_api_key_registration_flattened_error_async():
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_prediction_api_key_registration(prediction_apikey_registry_service.DeletePredictionApiKeyRegistrationRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [prediction_apikey_registry_service.CreatePredictionApiKeyRegistrationRequest, dict])
def test_create_prediction_api_key_registration_rest(request_type):
    if False:
        print('Hello World!')
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'parent': 'projects/sample1/locations/sample2/catalogs/sample3/eventStores/sample4'}
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value')
...
def test_create_prediction_api_key_registration_rest_interceptors(null_interceptor):
    if False:
        for i in range(10):
            print('nop')
    transport = transports.PredictionApiKeyRegistryRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PredictionApiKeyRegistryRestInterceptor())
    client = PredictionApiKeyRegistryClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, 'post_create_prediction_api_key_registration') as post, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, 'pre_create_prediction_api_key_registration') as pre:
...
def test_create_prediction_api_key_registration_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(parent='parent_value', prediction_api_key_registration=prediction_apikey_registry_service.PredictionApiKeyRegistration(api_key='api_key_value'))
...
def test_list_prediction_api_key_registrations_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_prediction_api_key_registrations_rest_interceptors(null_interceptor):
    ...
    transport = transports.PredictionApiKeyRegistryRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PredictionApiKeyRegistryRestInterceptor())
    client = PredictionApiKeyRegistryClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, 'post_list_prediction_api_key_registrations') as post, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, 'pre_list_prediction_api_key_registrations') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_prediction_api_key_registrations_rest_pager(transport: str='rest'):
    ...
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration()], next_page_token='abc'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[], next_page_token='def'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration()], next_page_token='ghi'), prediction_apikey_registry_service.ListPredictionApiKeyRegistrationsResponse(prediction_api_key_registrations=[prediction_apikey_registry_service.PredictionApiKeyRegistration(), prediction_apikey_registry_service.PredictionApiKeyRegistration()]))
...
def test_delete_prediction_api_key_registration_rest_interceptors(null_interceptor):
    ...
    transport = transports.PredictionApiKeyRegistryRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PredictionApiKeyRegistryRestInterceptor())
    client = PredictionApiKeyRegistryClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PredictionApiKeyRegistryRestInterceptor, 'pre_delete_prediction_api_key_registration') as pre:
        pre.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.PredictionApiKeyRegistryGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.PredictionApiKeyRegistryGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionApiKeyRegistryClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.PredictionApiKeyRegistryGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = PredictionApiKeyRegistryClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = PredictionApiKeyRegistryClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.PredictionApiKeyRegistryGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionApiKeyRegistryClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.PredictionApiKeyRegistryGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.PredictionApiKeyRegistryGrpcTransport, transports.PredictionApiKeyRegistryGrpcAsyncIOTransport, transports.PredictionApiKeyRegistryRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        print('Hello World!')
    transport = PredictionApiKeyRegistryClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        return 10
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.PredictionApiKeyRegistryGrpcTransport)

def test_prediction_api_key_registry_base_transport_error():
    if False:
        return 10
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.PredictionApiKeyRegistryTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_prediction_api_key_registry_base_transport():
    ...
    with mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_api_key_registry.transports.PredictionApiKeyRegistryTransport.__init__') as Transport:
        ...
        transport = transports.PredictionApiKeyRegistryTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_prediction_api_key_registration', 'list_prediction_api_key_registrations', 'delete_prediction_api_key_registration')
...
def test_prediction_api_key_registry_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.recommendationengine_v1beta1.services.prediction_api_key_registry.transports.PredictionApiKeyRegistryTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.PredictionApiKeyRegistryTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.PredictionApiKeyRegistryGrpcTransport, grpc_helpers), (transports.PredictionApiKeyRegistryGrpcAsyncIOTransport, grpc_helpers_async)])
...
@pytest.mark.parametrize('transport_class', [transports.PredictionApiKeyRegistryGrpcTransport, transports.PredictionApiKeyRegistryGrpcAsyncIOTransport])
def test_prediction_api_key_registry_grpc_transport_client_cert_source_for_mtls(transport_class):
    if False:
        for i in range(10):
            print('nop')
...
def test_prediction_api_key_registry_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.PredictionApiKeyRegistryRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_prediction_api_key_registry_host_no_port(transport_name):
    if False:
        return 10
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='recommendationengine.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('recommendationengine.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://recommendationengine.googleapis.com')
...
def test_prediction_api_key_registry_host_with_port(transport_name):
    if False:
        return 10
    client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='recommendationengine.googleapis.com:8000'), transport=transport_name)
    assert client.transport._host == ('recommendationengine.googleapis.com:8000' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://recommendationengine.googleapis.com:8000')
...
def test_prediction_api_key_registry_client_transport_session_collision(transport_name):
    ...
    client1 = PredictionApiKeyRegistryClient(credentials=creds1, transport=transport_name)
    client2 = PredictionApiKeyRegistryClient(credentials=creds2, transport=transport_name)
...
def test_prediction_api_key_registry_grpc_transport_channel():
    ...
    transport = transports.PredictionApiKeyRegistryGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_prediction_api_key_registry_grpc_asyncio_transport_channel():
    ...
    transport = transports.PredictionApiKeyRegistryGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.PredictionApiKeyRegistryGrpcTransport, transports.PredictionApiKeyRegistryGrpcAsyncIOTransport])
def test_prediction_api_key_registry_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        while True:
            i = 10
...
def test_parse_event_store_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'oyster', 'location': 'nudibranch', 'catalog': 'cuttlefish', 'event_store': 'mussel'}
...
def test_parse_prediction_api_key_registration_path():
    if False:
        while True:
            i = 10
    expected = {'project': 'clam', 'location': 'whelk', 'catalog': 'octopus', 'event_store': 'oyster', 'prediction_api_key_registration': 'nudibranch'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PredictionApiKeyRegistryTransport, '_prep_wrapped_messages') as prep:
        client = PredictionApiKeyRegistryClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = PredictionApiKeyRegistryAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(PredictionApiKeyRegistryClient, transports.PredictionApiKeyRegistryGrpcTransport), (PredictionApiKeyRegistryAsyncClient, transports.PredictionApiKeyRegistryGrpcAsyncIOTransport)])
