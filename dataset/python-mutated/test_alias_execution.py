...
TEST_MODELS = {'aliases': ['alias1.yaml', 'alias2.yaml', 'alias_with_undefined_jinja_in_ack_format.yaml', 'alias_with_immutable_list_param.yaml', 'alias_with_immutable_list_param_str_cast.yaml', 'alias4.yaml', 'alias5.yaml', 'alias_fixes1.yaml', 'alias_fixes2.yaml', 'alias_match_multiple.yaml'], 'actions': ['action1.yaml', 'action2.yaml', 'action3.yaml', 'action4.yaml'], 'runners': ['runner1.yaml']}
TEST_LOAD_MODELS = {'aliases': ['alias3.yaml']}
EXECUTION = ActionExecutionDB(id='54e657d60640fd16887d6855', status=LIVEACTION_STATUS_SUCCEEDED, result={})
