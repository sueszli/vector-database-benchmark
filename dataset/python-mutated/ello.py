...
async def ello(email, client, out):
    ...
    def get_random_string(length):
        ...
        return result_str
    headers = {'User-Agent': random.choice(ua['browsers']['firefox']), 'Accept': 'application/json', 'Accept-Language': 'en,en-US;q=0.5', 'Referer': 'https://ello.co/join', 'Content-Type': 'application/json', 'Origin': 'https://ello.co', 'DNT': '1', 'Connection': 'keep-alive', 'TE': 'Trailers'}
    data = '{"email":"' + email + '"}'
    try:
