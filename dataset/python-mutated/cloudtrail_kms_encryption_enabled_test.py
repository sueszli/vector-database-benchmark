...
class Test_cloudtrail_kms_encryption_enabled:
    ...
    def test_no_trails(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.cloudtrail.cloudtrail_kms_encryption_enabled.cloudtrail_kms_encryption_enabled.cloudtrail_client', new=Cloudtrail(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.cloudtrail.cloudtrail_kms_encryption_enabled.cloudtrail_kms_encryption_enabled import cloudtrail_kms_encryption_enabled
    ...
    def test_trail_no_kms(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.cloudtrail.cloudtrail_kms_encryption_enabled.cloudtrail_kms_encryption_enabled.cloudtrail_client', new=Cloudtrail(self.set_mocked_audit_info())):
            ...
            assert search('has encryption disabled', result[0].status_extended)
    ...
    def test_trail_kms(self):
        ...
        trail_us = cloudtrail_client_us_east_1.create_trail(Name=trail_name_us, S3BucketName=bucket_name_us, IsMultiRegionTrail=False, KmsKeyId=key_arn)
        from prowler.providers.aws.services.cloudtrail.cloudtrail_service import Cloudtrail
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=self.set_mocked_audit_info()), mock.patch('prowler.providers.aws.services.cloudtrail.cloudtrail_kms_encryption_enabled.cloudtrail_kms_encryption_enabled.cloudtrail_client', new=Cloudtrail(self.set_mocked_audit_info())):
            from prowler.providers.aws.services.cloudtrail.cloudtrail_kms_encryption_enabled.cloudtrail_kms_encryption_enabled import cloudtrail_kms_encryption_enabled
            check = cloudtrail_kms_encryption_enabled()
            ...
            assert search('has encryption enabled', result[0].status_extended)
            assert result[0].resource_id == trail_name_us
            assert result[0].resource_arn == trail_us['TrailARN']
            assert result[0].resource_tags == []
            assert result[0].region == 'us-east-1'