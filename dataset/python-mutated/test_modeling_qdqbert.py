...
if is_torch_available():
    import torch
    from transformers import QDQBertForMaskedLM, QDQBertForMultipleChoice, QDQBertForNextSentencePrediction, QDQBertForQuestionAnswering, QDQBertForSequenceClassification, QDQBertForTokenClassification, QDQBertLMHeadModel, QDQBertModel
...
class QDQBertModelTester:
    ...
    def get_config(self):
        if False:
            while True:
                i = 10
        return QDQBertConfig(vocab_size=self.vocab_size, hidden_size=self.hidden_size, num_hidden_layers=self.num_hidden_layers, num_attention_heads=self.num_attention_heads, intermediate_size=self.intermediate_size, hidden_act=self.hidden_act, hidden_dropout_prob=self.hidden_dropout_prob, attention_probs_dropout_prob=self.attention_probs_dropout_prob, max_position_embeddings=self.max_position_embeddings, type_vocab_size=self.type_vocab_size, is_decoder=False, initializer_range=self.initializer_range)
...
class QDQBertModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (QDQBertModel, QDQBertForMaskedLM, QDQBertForMultipleChoice, QDQBertForNextSentencePrediction, QDQBertForQuestionAnswering, QDQBertForSequenceClassification, QDQBertForTokenClassification, QDQBertLMHeadModel) if is_torch_available() else ()
    all_generative_model_classes = (QDQBertLMHeadModel,) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': QDQBertModel, 'fill-mask': QDQBertForMaskedLM, 'question-answering': QDQBertForQuestionAnswering, 'text-classification': QDQBertForSequenceClassification, 'text-generation': QDQBertLMHeadModel, 'token-classification': QDQBertForTokenClassification, 'zero-shot': QDQBertForSequenceClassification} if is_torch_available() else {}
