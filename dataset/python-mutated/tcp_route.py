...
import proto
__protobuf__ = proto.module(package='google.cloud.networkservices.v1', manifest={'TcpRoute', 'ListTcpRoutesRequest', 'ListTcpRoutesResponse', 'GetTcpRouteRequest', 'CreateTcpRouteRequest', 'UpdateTcpRouteRequest', 'DeleteTcpRouteRequest'})

class TcpRoute(proto.Message):
    """TcpRoute is the resource defining how TCP traffic should be
    ...
    class RouteRule(proto.Message):
        ...
        """
        matches: MutableSequence['TcpRoute.RouteMatch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TcpRoute.RouteMatch')
        action: 'TcpRoute.RouteAction' = proto.Field(proto.MESSAGE, number=2, message='TcpRoute.RouteAction')

    class RouteMatch(proto.Message):
        """RouteMatch defines the predicate used to match requests to a
        ...
        port: str = proto.Field(proto.STRING, number=2)
    ...
    class RouteAction(proto.Message):
        ...
        """
        destinations: MutableSequence['TcpRoute.RouteDestination'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TcpRoute.RouteDestination')
        original_destination: bool = proto.Field(proto.BOOL, number=3)
    ...
    rules: MutableSequence[RouteRule] = proto.RepeatedField(proto.MESSAGE, number=5, message=RouteRule)
...
class ListTcpRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    tcp_routes: MutableSequence['TcpRoute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TcpRoute')
...
class CreateTcpRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    tcp_route_id: str = proto.Field(proto.STRING, number=2)
    tcp_route: 'TcpRoute' = proto.Field(proto.MESSAGE, number=3, message='TcpRoute')
...
class UpdateTcpRouteRequest(proto.Message):
    ...
    tcp_route: 'TcpRoute' = proto.Field(proto.MESSAGE, number=2, message='TcpRoute')
