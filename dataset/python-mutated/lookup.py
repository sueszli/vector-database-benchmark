...
from qt.core import QAbstractItemView, QApplication, QCheckBox, QComboBox, QDialog, QDialogButtonBox, QFormLayout, QHBoxLayout, QIcon, QLabel, QLineEdit, QListWidget, QListWidgetItem, QPalette, QPushButton, QSize, Qt, QTimer, QUrl, QVBoxLayout, QWidget, pyqtSignal
...
def google_dictionary(word):
    ...
    if lang:
        ans += f'#dobc={lang}'
    return ans
vprefs.defaults['lookup_locations'] = [{'name': 'Google dictionary', 'url': 'https://www.google.com/search?q=define:{word}', 'special_processor': 'google_dictionary', 'langs': []}, {'name': 'Google search', 'url': 'https://www.google.com/search?q={word}', 'langs': []}, {'name': 'Wordnik', 'url': 'https://www.wordnik.com/words/{word}', 'langs': ['eng']}]
