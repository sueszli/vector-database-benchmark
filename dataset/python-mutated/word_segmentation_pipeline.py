...
from modelscope.preprocessors import Preprocessor, TokenClassificationTransformersPreprocessor, WordSegmentationPreprocessorThai
...
@PIPELINES.register_module(Tasks.word_segmentation, module_name=Pipelines.word_segmentation)
...
@PIPELINES.register_module(Tasks.word_segmentation, module_name=Pipelines.multilingual_word_segmentation)
...
@PIPELINES.register_module(Tasks.word_segmentation, module_name=Pipelines.word_segmentation_thai)
