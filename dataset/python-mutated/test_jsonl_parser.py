...
JSONL_CONTENT_WITHOUT_MULTILINE_JSON_OBJECTS = [b'{"a": 1, "b": "1"}', b'{"a": 2, "b": "2"}']
JSONL_CONTENT_WITH_MULTILINE_JSON_OBJECTS = [b'{', b'  "a": 1,', b'  "b": "1"', b'}', b'{', b'  "a": 2,', b'  "b": "2"', b'}']
INVALID_JSON_CONTENT = [b'{', b'  "a": 1,', b'  "b": "1"', b'{', b'  "a": 2,', b'  "b": "2"', b'}']
