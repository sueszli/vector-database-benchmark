import logging
from redash.query_runner import TYPE_BOOLEAN, TYPE_DATETIME, TYPE_FLOAT, TYPE_INTEGER, TYPE_STRING, BaseQueryRunner, register
...
try:
    ...
    enabled = False
TD_TYPES_MAPPING = {'bigint': TYPE_INTEGER, 'tinyint': TYPE_INTEGER, 'smallint': TYPE_INTEGER, 'int': TYPE_INTEGER, 'integer': TYPE_INTEGER, 'long': TYPE_INTEGER, 'double': TYPE_FLOAT, 'decimal': TYPE_FLOAT, 'float': TYPE_FLOAT, 'real': TYPE_FLOAT, 'boolean': TYPE_BOOLEAN, 'timestamp': TYPE_DATETIME, 'date': TYPE_DATETIME, 'char': TYPE_STRING, 'string': TYPE_STRING, 'varchar': TYPE_STRING}
