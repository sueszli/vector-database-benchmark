...
class TridiagonalSolveOpTest(test.TestCase):
    ...
    class TridiagonalSolveBenchmark(test.Benchmark):
        sizes = [(100000, 1, 1), (1000000, 1, 1), (10000000, 1, 1), (100000, 10, 1), (100000, 100, 1), (10000, 1, 10), (10000, 1, 100)]
    ...
    for (name, fun) in dict(TridiagonalSolveOpTest.__dict__).items():
        ...
        def decor(test_fun, pivoting):
            ...
            def wrapped(instance):
                ...
                test_fun(instance)
            return wrapped
        setattr(TridiagonalSolveOpTest, name + '_pivoting', decor(fun, pivoting=True))
        if not hasattr(fun, FLAG_REQUIRES_PIVOTING):
            setattr(TridiagonalSolveOpTest, name + '_noPivoting', decor(fun, pivoting=False))
    test.main()