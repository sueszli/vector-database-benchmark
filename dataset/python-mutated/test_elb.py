...
INTERNET_ELB = {'Arn': ARN_PREFIX + ':elasticloadbalancing:' + AWS_DEFAULT_REGION + ':012345678901:loadbalancer/MyELB', 'Attributes': {'ConnectionDraining': {'Enabled': False, 'Timeout': 300}, 'CrossZoneLoadBalancing': {'Enabled': False}, 'ConnectionSettings': {'IdleTimeout': 60}, 'AccessLog': {'S3BucketPrefix': 'test', 'Enabled': True, 'EmitInterval': 5, 'S3BucketName': 'some-log-bucket'}}, 'AvailabilityZones': [AWS_DEFAULT_REGION], 'BackendServerDescriptions': [], 'CanonicalHostedZoneNameID': 'Z3DZXE0Q79N41H', 'CreatedTime': '2015-07-07 19:15:06.490000+00:00', 'DNSName': 'MyELB-1885487881.' + AWS_DEFAULT_REGION + '.elb.amazonaws.com', 'HealthCheck': {'HealthyThreshold': 2, 'Interval': 30, 'Target': 'HTTP:5050/health', 'Timeout': 5, 'UnhealthyThreshold': 2}, 'Instances': [], 'ListenerDescriptions': [{'InstancePort': 80, 'PolicyNames': [], 'LoadBalancerPort': 80, 'Protocol': 'HTTP', 'InstanceProtocol': 'HTTP'}, {'InstancePort': 2181, 'PolicyNames': [], 'LoadBalancerPort': 2181, 'Protocol': 'TCP', 'InstanceProtocol': 'TCP'}, {'InstancePort': 5050, 'PolicyNames': [], 'LoadBalancerPort': 5050, 'Protocol': 'HTTP', 'InstanceProtocol': 'HTTP'}, {'InstancePort': 8080, 'PolicyNames': [], 'LoadBalancerPort': 8080, 'Protocol': 'HTTP', 'InstanceProtocol': 'HTTP'}, {'InstancePort': 8181, 'PolicyNames': [], 'LoadBalancerPort': 8181, 'Protocol': 'HTTP', 'InstanceProtocol': 'HTTP'}, {'InstancePort': 80, 'Protocol': 'HTTPS', 'InstanceProtocol': 'HTTP', 'LoadBalancerPort': 443, 'PolicyNames': ['ELBSecurityPolicy-2016-08'], 'SSLCertificateId': ARN_PREFIX + ':iam::012345678901:server-certificate/somecert-20170511-20180511'}], 'LoadBalancerName': 'MyELB', 'Policies': {'LBCookieStickinessPolicies': [], 'AppCookieStickinessPolicies': [], 'OtherPolicies': ['ELBSecurityPolicy-2016-08']}, 'PolicyDescriptions': {'ELBSecurityPolicy-2016-08': {'reference_security_policy': 'ELBSecurityPolicy-2016-08', 'supported_ciphers': ['AES128-GCM-SHA256', 'AES128-SHA', 'AES128-SHA256', 'AES256-GCM-SHA384', 'AES256-SHA', 'AES256-SHA256', 'ECDHE-ECDSA-AES128-GCM-SHA256', 'ECDHE-ECDSA-AES128-SHA', 'ECDHE-ECDSA-AES128-SHA256', 'ECDHE-ECDSA-AES256-GCM-SHA384', 'ECDHE-ECDSA-AES256-SHA', 'ECDHE-ECDSA-AES256-SHA384', 'ECDHE-RSA-AES128-GCM-SHA256', 'ECDHE-RSA-AES128-SHA', 'ECDHE-RSA-AES128-SHA256', 'ECDHE-RSA-AES256-GCM-SHA384', 'ECDHE-RSA-AES256-SHA', 'ECDHE-RSA-AES256-SHA384'], 'type': 'SSLNegotiationPolicyType', 'server_defined_cipher_order': True, 'protocols': {'tlsv1': True, 'tlsv1_1': True, 'tlsv1_2': True, 'sslv3': True, 'sslv2': False}}}, 'Region': AWS_DEFAULT_REGION, 'Scheme': 'internet-facing', 'SecurityGroups': ['sg-12345678'], 'SourceSecurityGroup': {'OwnerAlias': '012345678901', 'GroupName': 'MySG'}, 'Subnets': ['subnet-19999999'], 'Tags': [{'Value': ARN_PREFIX + ':cloudformation:' + AWS_DEFAULT_REGION + ':012345678901:stack/STACK/xxxxxxxxxxxxxxxxxxx', 'Key': 'aws:cloudformation:stack-id'}], 'VPCId': 'vpc-49999999', '_version': 2}
INTERNET_SG = {'id': 'sg-12345678', 'name': 'INTERNETSG', 'rules': [{'cidr_ip': '0.0.0.0/0', 'rule_type': 'ingress', 'port': 80}]}
INTERNAL_SG = {'id': 'sg-87654321', 'name': 'INTERNALSG', 'rules': [{'cidr_ip': '10.0.0.0/8', 'rule_type': 'ingress'}]}
