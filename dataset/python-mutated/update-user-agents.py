...
MAPPING: Mapping[str, Sequence[Union[str, int]]] = {'ANDROID': ('android', 'standard', 'sample_user_agents', 'chrome', 0), 'CHROME': ('chrome', 'windows', 'sample_user_agents', 'standard', 0), 'CHROME_OS': ('chrome-os', 'standard', 'sample_user_agents', 'x86_64', 0), 'FIREFOX': ('firefox', 'standard', 'sample_user_agents', 'windows', 0), 'IE_11': ('internet-explorer', 'internet-explorer-windows-10', 'sample_user_agents', 'standard', 0), 'IPHONE': ('ios', 'standard', 'sample_user_agents', 'safari', 0), 'OPERA': ('opera', 'standard', 'sample_user_agents', 'windows', 0), 'SAFARI': ('safari', 'macos', 'sample_user_agents', 'standard', 0)}
