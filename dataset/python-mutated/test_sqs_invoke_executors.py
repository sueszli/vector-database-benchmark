...
from samcli.lib.remote_invoke.sqs_invoke_executors import RemoteInvokeOutputFormat, SqsSendMessageExecutor, ParamValidationError, InvalidResourceBotoParameterException, ErrorBotoApiCallException, ClientError, SqsSendMessageTextOutput, get_queue_url_from_arn
...
@parameterized_class('output', [[RemoteInvokeOutputFormat.TEXT], [RemoteInvokeOutputFormat.JSON]])
