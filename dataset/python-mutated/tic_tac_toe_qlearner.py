...
FLAGS = flags.FLAGS
flags.DEFINE_integer('num_episodes', int(50000.0), 'Number of train episodes.')
flags.DEFINE_boolean('interactive_play', True, 'Whether to run an interactive play with the agent after training.')
