...
@testing.parameterize(*testing.product({'hidden_none': [True, False], 'activation': ['tanh', 'relu']}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float32, numpy.float64], 'initialW': ['zero', 'random'], 'initial_bias': ['zero', 'random'], 'activation_type': ['tanh', 'relu'], 'use_bi_direction': [True, False]}))
