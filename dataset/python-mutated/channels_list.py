...
from PyQt5.QtWidgets import QMenu, QHBoxLayout, QLabel, QVBoxLayout, QGridLayout, QLineEdit, QPushButton, QAbstractItemView, QComboBox, QCheckBox, QToolTip
...
from .util import WindowModalDialog, Buttons, OkButton, CancelButton, EnterButton, WaitingDialog, MONOSPACE_FONT, ColorScheme
...
class ChannelsList(MyTreeView):
    ...
    headers = {Columns.SHORT_CHANID: _('Short Channel ID'), Columns.LONG_CHANID: _('Channel ID'), Columns.NODE_ALIAS: _('Node alias'), Columns.FEATURES: '', Columns.CAPACITY: _('Capacity'), Columns.LOCAL_BALANCE: _('Can send'), Columns.REMOTE_BALANCE: _('Can receive'), Columns.CHANNEL_STATUS: _('Status')}
    filter_columns = [Columns.SHORT_CHANID, Columns.LONG_CHANID, Columns.NODE_ALIAS, Columns.CHANNEL_STATUS]
