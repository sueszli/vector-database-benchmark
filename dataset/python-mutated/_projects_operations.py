...
class ProjectsOperations:
    ...
    def list(self, group_name: str, service_name: str, **kwargs: Any) -> AsyncIterable['_models.Project']:
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_request(group_name=group_name, service_name=service_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, parameters: _models.Project, *, content_type: str='application/json', **kwargs: Any) -> _models.Project:
    ...
    @overload
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Project:
        """Create or update project.
    ...
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, parameters: Union[_models.Project, IO], **kwargs: Any) -> _models.Project:
        """Create or update project.
    ...
    async def get(self, group_name: str, service_name: str, project_name: str, **kwargs: Any) -> _models.Project:
        ...
        api_version: Literal['2022-03-30-preview'] = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.Project] = kwargs.pop('cls', None)
        request = build_get_request(group_name=group_name, service_name=service_name, project_name=project_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def delete(self, group_name: str, service_name: str, project_name: str, delete_running_tasks: Optional[bool]=None, **kwargs: Any) -> None:
        """Delete project.
        ...
        request = build_delete_request(group_name=group_name, service_name=service_name, project_name=project_name, subscription_id=self._config.subscription_id, delete_running_tasks=delete_running_tasks, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def update(self, group_name: str, service_name: str, project_name: str, parameters: _models.Project, *, content_type: str='application/json', **kwargs: Any) -> _models.Project:
        """Update project.
    ...
    @overload
    async def update(self, group_name: str, service_name: str, project_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Project:
        """Update project.
    ...
    @distributed_trace_async
    async def update(self, group_name: str, service_name: str, project_name: str, parameters: Union[_models.Project, IO], **kwargs: Any) -> _models.Project:
        """Update project.
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            _json = self._serialize.body(parameters, 'Project')
        request = build_update_request(group_name=group_name, service_name=service_name, project_name=project_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
