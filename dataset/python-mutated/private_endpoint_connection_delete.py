...
def main():
    ...
    client.private_endpoint_connections.begin_delete(resource_group_name='myResourceGroup', registry_name='myRegistry', private_endpoint_connection_name='myConnection').result()
