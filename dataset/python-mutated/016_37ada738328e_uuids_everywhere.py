...
branch_labels = None
depends_on = None
foreign_keys = [('package_tag', 'package_id'), ('package_tag', 'tag_id'), ('package_extra', 'package_id'), ('package_resource', 'package_id'), ('package_tag_revision', 'package_id'), ('package_tag_revision', 'tag_id'), ('package_extra_revision', 'package_id'), ('package_resource_revision', 'package_id'), ('rating', 'package_id'), ('package_search', 'package_id'), ('package_role', 'package_id'), ('package_group', 'package_id')]
ids = ['package', 'package_tag', 'package_extra', 'package_resource', 'package_revision', 'package_tag_revision', 'package_extra_revision', 'package_resource_revision', 'tag']
continuity = ['package_revision', 'package_tag_revision', 'package_extra_revision', 'package_resource_revision']
sequences = ['package_id_seq', 'package_extra_id_seq', 'package_resource_id_seq', 'package_tag_id_seq', 'tag_id_seq']
combined_primary_keys = ['package_extra_revision', 'package_revision', 'package_tag_revision']
