...
class bigquery_biglakeCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'check_lock': ('name',), 'create_catalog': ('parent', 'catalog', 'catalog_id'), 'create_database': ('parent', 'database', 'database_id'), 'create_lock': ('parent', 'lock'), 'create_table': ('parent', 'table', 'table_id'), 'delete_catalog': ('name',), 'delete_database': ('name',), 'delete_lock': ('name',), 'delete_table': ('name',), 'get_catalog': ('name',), 'get_database': ('name',), 'get_table': ('name',), 'list_catalogs': ('parent', 'page_size', 'page_token'), 'list_databases': ('parent', 'page_size', 'page_token'), 'list_locks': ('parent', 'page_size', 'page_token'), 'list_tables': ('parent', 'page_size', 'page_token', 'view'), 'rename_table': ('name', 'new_name'), 'update_database': ('database', 'update_mask'), 'update_table': ('table', 'update_mask')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=bigquery_biglakeCallTransformer()):
    if False:
        return 10
