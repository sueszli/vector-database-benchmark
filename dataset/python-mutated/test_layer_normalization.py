...
@testing.parameterize(*testing.product({'batchsize': [1, 5], 'size': [10, 20], 'dtype': [numpy.float32]}))
...
@testing.parameterize(*testing.product({'size': [3, 50]}))
...
@testing.parameterize(*testing.product({'shape': [(2, 4, 3), (2, 5, 3, 4)]}))
