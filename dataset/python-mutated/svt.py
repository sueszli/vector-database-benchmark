...
from ..utils import determine_ext, dict_get, int_or_none, str_or_none, strip_or_none, traverse_obj, try_get, unified_timestamp
...
class SVTIE(SVTBaseIE):
    ...
    _EMBED_REGEX = ['(?:<iframe src|href)="(?P<url>%s[^"]*)"' % _VALID_URL]
    _TEST = {'url': 'http://www.svt.se/wd?widgetId=23991&sectionId=541&articleId=2900353&type=embed&contextSectionId=123&autostart=false', 'md5': '33e9a5d8f646523ce0868ecfb0eed77d', 'info_dict': {'id': '2900353', 'ext': 'mp4', 'title': 'Stjärnorna skojar till det - under SVT-intervjun', 'duration': 27, 'age_limit': 0}}
...
class SVTPlayBaseIE(SVTBaseIE):
    _SVTPLAY_RE = 'root\\s*\\[\\s*(["\\\'])_*svtplay\\1\\s*\\]\\s*=\\s*(?P<json>{.+?})\\s*;\\s*\\n'

class SVTPlayIE(SVTPlayBaseIE):
    IE_DESC = 'SVT Play and Öppet arkiv'
    _VALID_URL = '(?x)\n                    (?:\n                        (?:\n                            svt:|\n                            https?://(?:www\\.)?svt\\.se/barnkanalen/barnplay/[^/]+/\n                        )\n                        (?P<svt_id>[^/?#&]+)|\n                        https?://(?:www\\.)?(?:svtplay|oppetarkiv)\\.se/(?:video|klipp|kanaler)/(?P<id>[^/?#&]+)\n                        (?:.*?(?:modalId|id)=(?P<modal_id>[\\da-zA-Z-]+))?\n                    )\n                    '
    _TESTS = [{'url': 'https://www.svtplay.se/video/30479064', 'md5': '2382036fd6f8c994856c323fe51c426e', 'info_dict': {'id': '8zVbDPA', 'ext': 'mp4', 'title': 'Designdrömmar i Stenungsund', 'timestamp': 1615770000, 'upload_date': '20210315', 'duration': 3519, 'thumbnail': 're:^https?://(?:.*[\\.-]jpg|www.svtstatic.se/image/.*)$', 'age_limit': 0, 'subtitles': {'sv': [{'ext': 'vtt'}]}}, 'params': {'skip_download': 'm3u8'}, 'skip': 'Episode is no longer available'}, {'url': 'https://www.svtplay.se/video/emBxBQj', 'md5': '2382036fd6f8c994856c323fe51c426e', 'info_dict': {'id': 'eyBd9aj', 'ext': 'mp4', 'title': '1. Farlig kryssning', 'timestamp': 1491019200, 'upload_date': '20170401', 'duration': 2566, 'thumbnail': 're:^https?://(?:.*[\\.-]jpg|www.svtstatic.se/image/.*)$', 'age_limit': 0, 'episode': '1. Farlig kryssning', 'series': 'Rederiet', 'subtitles': {'sv': 'count:3'}}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.svtplay.se/video/jz2rYz7/anders-hansen-moter/james-fallon?info=visa', 'info_dict': {'id': 'jvXAGVb', 'ext': 'mp4', 'title': 'James Fallon', 'timestamp': 1673917200, 'upload_date': '20230117', 'duration': 1081, 'thumbnail': 're:^https?://(?:.*[\\.-]jpg|www.svtstatic.se/image/.*)$', 'age_limit': 0, 'episode': 'James Fallon', 'series': 'Anders Hansen möter...'}, 'params': {'skip_download': 'dash'}}, {'url': 'https://www.svtplay.se/video/30479064/husdrommar/husdrommar-sasong-8-designdrommar-i-stenungsund?modalId=8zVbDPA', 'only_matching': True}, {'url': 'https://www.svtplay.se/video/30684086/rapport/rapport-24-apr-18-00-7?id=e72gVpa', 'only_matching': True}, {'url': 'http://www.oppetarkiv.se/video/5219710/trollflojten', 'only_matching': True}, {'url': 'http://www.svtplay.se/klipp/9023742/stopptid-om-bjorn-borg', 'only_matching': True}, {'url': 'https://www.svtplay.se/kanaler/svt1', 'only_matching': True}, {'url': 'svt:1376446-003A', 'only_matching': True}, {'url': 'svt:14278044', 'only_matching': True}, {'url': 'https://www.svt.se/barnkanalen/barnplay/kar/eWv5MLX/', 'only_matching': True}, {'url': 'svt:eWv5MLX', 'only_matching': True}]
