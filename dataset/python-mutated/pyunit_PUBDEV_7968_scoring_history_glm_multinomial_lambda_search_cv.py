...
def test_glm_scoring_history_multinomial():
    ...
    h2o_model_score_each_cv = glm(family='multinomial', score_each_iteration=True, lambda_search=True, nlambdas=10, nfolds=2, fold_assignment='modulo')
    ...
    h2o_model_cv = glm(family='multinomial', score_iteration_interval=1, lambda_search=True, nlambdas=10, nfolds=2, fold_assignment='modulo')
    ...
    h2o_model_4th_cv = glm(family='multinomial', score_iteration_interval=4, lambda_search=True, nlambdas=10, nfolds=2, fold_assignment='modulo')
