...
router.register('actions-alt', ActionViewSet, basename='actions-alt')
router.register('names', ActionNamesViewSet, basename='names')
router.register('mapping', ActionViewSetWithMapping, basename='mapping')
