...
public_modules = ['vispy', 'vispy.color', 'vispy.geometry', 'vispy.gloo', 'vispy.io', 'vispy.plot', 'vispy.scene', 'vispy.util', 'vispy.visuals']
...
def _func_name(func, cls=None):
    ...
    return '.'.join(parts)
docstring_ignores = ['vispy.scene.visuals']
error_ignores = {'GL01', 'EX01', 'EX02', 'ES01', 'SA01', 'YD01', 'SA04', 'PR04', 'RT02'}
error_ignores_specific = {}
subclass_name_ignores = ((vispy.scene.cameras.magnify.MagnifyCamera, {'MagnifyTransform', 'Magnify1DTransform'}),)
