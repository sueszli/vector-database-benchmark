...
EXCLUDED_DIRS = [os.path.join('tests', 'integration', 'cloud', 'helpers'), os.path.join('tests', 'integration', 'files'), os.path.join('tests', 'kitchen', 'tests'), os.path.join('tests', 'perf'), os.path.join('tests', 'pkg'), os.path.join('tests', 'support'), os.path.join('tests', 'unit', 'files'), os.path.join('tests', 'unit', 'modules', 'inspectlib'), os.path.join('tests', 'unit', 'modules', 'nxos'), os.path.join('tests', 'unit', 'modules', 'zypp'), os.path.join('tests', 'unit', 'setup'), os.path.join('tests', 'unit', 'templates', 'files')]
INCLUDED_DIRS = [os.path.join('tests', 'kitchen', 'tests', '*', 'tests', '*')]
EXCLUDED_FILES = [os.path.join('tests', 'buildpackage.py'), os.path.join('tests', 'committer_parser.py'), os.path.join('tests', 'consist.py'), os.path.join('tests', 'eventlisten.py'), os.path.join('tests', 'jenkins.py'), os.path.join('tests', 'minionswarm.py'), os.path.join('tests', 'modparser.py'), os.path.join('tests', 'packdump.py'), os.path.join('tests', 'runtests.py'), os.path.join('tests', 'salt-tcpdump.py'), os.path.join('tests', 'saltsh.py'), os.path.join('tests', 'unit', 'test_pytest_pass_fail.py'), os.path.join('tests', 'unit', 'transport', 'mixins.py'), os.path.join('tests', 'unit', 'utils', 'scheduler', 'base.py'), os.path.join('tests', 'virtualname.py'), os.path.join('tests', 'wheeltest.py'), os.path.join('tests', 'zypp_plugin.py'), os.path.join('tests', 'pytests', 'functional', 'cache', 'helpers.py'), os.path.join('tests', 'pytests', 'unit', 'states', 'virt', 'helpers.py')]
