...
from modelscope.models.cv.body_3d_keypoints.cannonical_pose.body_3d_pose import KeypointsTypes
...
@PIPELINES.register_module(Tasks.body_3d_keypoints, module_name=Pipelines.body_3d_keypoints)
