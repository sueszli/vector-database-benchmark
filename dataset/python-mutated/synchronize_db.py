...
submodules = ('test_paddle', 'test_tensorflow', 'test_torch', 'test_jax', 'test_numpy', 'test_functional', 'test_experimental', 'test_stateful', 'test_misc', 'test_scipy', 'test_pandas', 'test_mindspore', 'test_onnx', 'test_sklearn', 'test_xgboost', 'test_torchvision')
db_dict = {'test_functional/test_core': ['core', 10], 'test_experimental/test_core': ['exp_core', 11], 'test_functional/test_nn': ['nn', 12], 'test_experimental/test_nn': ['exp_nn', 13], 'test_stateful': ['stateful', 14], 'test_torch': ['torch', 15], 'test_jax': ['jax', 16], 'test_tensorflow': ['tensorflow', 17], 'test_numpy': ['numpy', 18], 'test_misc': ['misc', 19], 'test_paddle': ['paddle', 20], 'test_scipy': ['scipy', 21], 'test_pandas': ['pandas', 22], 'test_mindspore': ['mindspore', 23], 'test_onnx': ['onnx', 24], 'test_sklearn': ['sklearn', 25], 'test_xgboost': ['xgboost', 26], 'test_torchvision': ['torchvision', 27]}
