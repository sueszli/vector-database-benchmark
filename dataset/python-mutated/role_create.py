...
def main():
    ...
    response = client.roles.begin_create(resource_group_name='TestGroup', cluster_name='pgtestsvc4', role_name='role1', parameters={'properties': {'password': 'password'}}).result()
    print(response)
