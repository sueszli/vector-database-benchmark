...
def inspect_bigquery_send_to_scc(project: str, info_types: List[str], max_findings: int=100) -> None:
    if False:
        while True:
            i = 10
    ...
    storage_config = {'big_query_options': {'table_reference': {'project_id': 'bigquery-public-data', 'dataset_id': 'usa_names', 'table_id': 'usa_1910_current'}}}
...
if __name__ == '__main__':
    ...
    inspect_bigquery_send_to_scc(args.project, args.info_types, args.max_findings)