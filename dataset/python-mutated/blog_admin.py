...
class BlogAdminHandler(base.BaseHandler[BlogAdminHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'POST': {'action': {'schema': {'type': 'basestring', 'choices': ['save_platform_parameters']}}, 'new_platform_parameter_values': {'schema': {'type': 'object_dict', 'validation_method': validation_method.validate_platform_params_values_for_blog_admin}, 'default_value': None}}}
...
class BlogAdminRolesHandler(base.BaseHandler[BlogAdminRolesHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'role': {'schema': {'type': 'basestring', 'choices': [BLOG_ADMIN, BLOG_POST_EDITOR]}}, 'username': {'schema': {'type': 'basestring'}}}, 'PUT': {'username': {'schema': {'type': 'basestring'}}}}
