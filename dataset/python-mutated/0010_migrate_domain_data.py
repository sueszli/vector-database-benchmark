...
class Migration(migrations.Migration):
    dependencies = [('projects', '0009_add_domain_field')]
    operations = [migrations.RunPython(migrate_url), migrations.AlterField(model_name='domain', name='domain', field=models.CharField(unique=True, max_length=255, verbose_name='Domain', validators=[readthedocs.projects.validators.DomainNameValidator()]))]