...
tqdm = get_tqdm()
PUNCTUATION = '!"#%&\'()*+, -./:;<=>?@[\\]^_`{|}~'
MONEY_WORDS = {'million', 'billion', 'trillion', 'millions', 'billions', 'trillions', 'hundred', 'hundreds', 'lakh', 'crore', 'tens', 'of', 'ten', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'couple'}
LABEL_TRANSLATION = {'Date': None, 'Misc': 'MISC', 'Product': 'MISC', 'NORP': 'MISC', 'Facility': 'LOC', 'Location': 'LOC', 'Person': 'PER', 'Organization': 'ORG'}
