...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [('zerver', '0256_userprofile_stream_set_recipient_column_values')]
    operations = [migrations.RunPython(fix_has_link, reverse_code=migrations.RunPython.noop, elidable=True)]