...
if __name__ == '__main__':
    ...
    parser.add_argument('--ops-spec', type=str, default='[{"op": "map_batches", "batch_size": 1024, "batch_format": "pandas"}]')
    ...
    for trial in range(args.num_trials):
        ...
        ds = make_ds(args.num_tasks, args.num_blocks_per_task, args.block_size, args.data_format, args.num_columns, ops_spec, target_max_block_size)
