...
filter_data = {'insight': INSIGHT_FUNNELS, 'funnel_viz_type': FunnelVizType.TRENDS, 'interval': 'day', 'date_from': '2021-05-01 00:00:00', 'date_to': '2021-05-07 23:59:59', 'funnel_window_days': 14, 'funnel_from_step': 0, 'entrance_period_start': '2021-05-01 00:00:00', 'drop_off': False, 'events': [{'id': 'step one', 'order': 0}, {'id': 'step two', 'order': 1}, {'id': 'step three', 'order': 2}], 'include_recordings': 'true'}
