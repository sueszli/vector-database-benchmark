...
from ..utils import determine_ext, int_or_none, NO_DEFAULT, str_to_int

class XNXXIE(InfoExtractor):
    _VALID_URL = 'https?://(?:video|www)\\.xnxx3?\\.com/video-?(?P<id>[0-9a-z]+)/'
    _TESTS = [{'url': 'http://www.xnxx.com/video-55awb78/skyrim_test_video', 'md5': '7583e96c15c0f21e9da3453d9920fbba', 'info_dict': {'id': '55awb78', 'ext': 'mp4', 'title': 'Skyrim Test Video', 'thumbnail': 're:^https?://.*\\.jpg', 'duration': 469, 'view_count': int, 'age_limit': 18}}, {'url': 'http://video.xnxx.com/video1135332/lida_naked_funny_actress_5_', 'only_matching': True}, {'url': 'http://www.xnxx.com/video-55awb78/', 'only_matching': True}, {'url': 'http://www.xnxx3.com/video-55awb78/', 'only_matching': True}]
