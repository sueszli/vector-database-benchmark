...
class OWMultiplier(widget.OWWidget):
    ...
    def __init__(self):
        ...
        self.n = None
        self.product = 0
        gui.radioButtonsInBox(self.controlArea, self, 'factor', ('None', 'Double', 'Triple', 'Quadruple'), box='Multiply', callback=self.do_multiply)
        self.result = gui.label(self.controlArea, self, 'The product is %(product)i', box='Result')
        self.result.hide()
