...
class GigapetaCom(SimpleDownloader):
    ...
    __version__ = '0.09'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?gigapeta\\.com/dl/\\w+'
    ...
    NAME_PATTERN = '<img src=".*" alt="file" />-->\\s*(?P<N>.*?)\\s*</td>'
    SIZE_PATTERN = '<th>\\s*Size\\s*</th>\\s*<td>\\s*(?P<S>.*?)\\s*</td>'
    OFFLINE_PATTERN = '<div id="page_error">'
    DOWNLOAD_PATTERN = '"All threads for IP'
