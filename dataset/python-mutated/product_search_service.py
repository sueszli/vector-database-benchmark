...
class Product(proto.Message):
    ...
    product_category: str = proto.Field(proto.STRING, number=4)
    product_labels: MutableSequence[KeyValue] = proto.RepeatedField(proto.MESSAGE, number=5, message=KeyValue)

class ProductSet(proto.Message):
    """A ProductSet contains Products. A ProductSet can contain a
    ...
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    index_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    index_error: status_pb2.Status = proto.Field(proto.MESSAGE, number=4, message=status_pb2.Status)
...
class ReferenceImage(proto.Message):
    ...
    bounding_polys: MutableSequence[geometry.BoundingPoly] = proto.RepeatedField(proto.MESSAGE, number=3, message=geometry.BoundingPoly)
...
class CreateProductRequest(proto.Message):
    ...
    product: 'Product' = proto.Field(proto.MESSAGE, number=2, message='Product')
...
class UpdateProductRequest(proto.Message):
    ...
    """
    product: 'Product' = proto.Field(proto.MESSAGE, number=1, message='Product')
...
class CreateProductSetRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    product_set: 'ProductSet' = proto.Field(proto.MESSAGE, number=2, message='ProductSet')
    product_set_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    product_sets: MutableSequence['ProductSet'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ProductSet')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateProductSetRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            ``display_name``.
    """
    product_set: 'ProductSet' = proto.Field(proto.MESSAGE, number=1, message='ProductSet')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class CreateReferenceImageRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    reference_image: 'ReferenceImage' = proto.Field(proto.MESSAGE, number=2, message='ReferenceImage')
    reference_image_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    reference_images: MutableSequence['ReferenceImage'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReferenceImage')
    page_size: int = proto.Field(proto.INT32, number=2)
...
class AddProductToProductSetRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    product: str = proto.Field(proto.STRING, number=2)
...
class ImportProductSetsGcsSource(proto.Message):
    ...
    Attributes:
        csv_file_uri (str):
            ...
            polygons.
    """
    csv_file_uri: str = proto.Field(proto.STRING, number=1)
...
class ImportProductSetsInputConfig(proto.Message):
    ...
    """
    gcs_source: 'ImportProductSetsGcsSource' = proto.Field(proto.MESSAGE, number=1, oneof='source', message='ImportProductSetsGcsSource')
...
class ImportProductSetsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    input_config: 'ImportProductSetsInputConfig' = proto.Field(proto.MESSAGE, number=2, message='ImportProductSetsInputConfig')
...
class ImportProductSetsResponse(proto.Message):
    ...
    """
    reference_images: MutableSequence['ReferenceImage'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReferenceImage')
    statuses: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=2, message=status_pb2.Status)
...
class BatchOperationMetadata(proto.Message):
    ...
    class State(proto.Enum):
        """Enumerates the possible states that the batch request can be
        in.
