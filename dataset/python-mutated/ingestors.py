...
from .importers import UnlabeledImageDatasetImporter, LabeledImageDatasetImporter, UnlabeledVideoDatasetImporter, LabeledVideoDatasetImporter
...
class UnlabeledImageDatasetIngestor(UnlabeledImageDatasetImporter, ImageIngestor):
...
class UnlabeledVideoDatasetIngestor(UnlabeledVideoDatasetImporter, VideoIngestor):
