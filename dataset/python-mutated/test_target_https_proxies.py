...
@pytest.mark.parametrize('client_class,transport_name', [(TargetHttpsProxiesClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.TargetHttpsProxiesRestTransport, 'rest')])
...
def test_target_https_proxies_client_get_transport_class():
    ...
    available_transports = [transports.TargetHttpsProxiesRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(TargetHttpsProxiesClient, transports.TargetHttpsProxiesRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(TargetHttpsProxiesClient, transports.TargetHttpsProxiesRestTransport, 'rest', 'true'), (TargetHttpsProxiesClient, transports.TargetHttpsProxiesRestTransport, 'rest', 'false')])
@mock.patch.object(TargetHttpsProxiesClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(TargetHttpsProxiesClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(TargetHttpsProxiesClient, transports.TargetHttpsProxiesRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AggregatedListTargetHttpsProxiesRequest, dict])
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.TargetHttpsProxyAggregatedList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value', unreachables=['unreachables_value'])
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.TargetHttpsProxyAggregatedList.pb(return_value)
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    if False:
        i = 10
        return i + 15
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_aggregated_list') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_aggregated_list') as pre:
...
def test_aggregated_list_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.aggregated_list(compute.AggregatedListTargetHttpsProxiesRequest(), project='project_value')
...
@pytest.mark.parametrize('request_type', [compute.DeleteTargetHttpsProxyRequest, dict])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_delete') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value')
...
@pytest.mark.parametrize('request_type', [compute.GetTargetHttpsProxyRequest, dict])
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_get') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value')
...
@pytest.mark.parametrize('request_type', [compute.InsertTargetHttpsProxyRequest, dict])
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_insert') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1'}
        mock_args = dict(project='project_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertTargetHttpsProxyRequest(), project='project_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertTargetHttpsProxyRequest(), project='project_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
...
@pytest.mark.parametrize('request_type', [compute.ListTargetHttpsProxiesRequest, dict])
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_list') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListTargetHttpsProxiesRequest(), project='project_value')
...
@pytest.mark.parametrize('request_type', [compute.PatchTargetHttpsProxyRequest, dict])
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_patch') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxy_resource=compute.TargetHttpsProxy(authorization_policy='authorization_policy_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetCertificateMapTargetHttpsProxyRequest, dict])
def test_set_certificate_map_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['target_https_proxies_set_certificate_map_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_set_certificate_map_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('project', 'targetHttpsProxiesSetCertificateMapRequestResource', 'targetHttpsProxy'))
...
def test_set_certificate_map_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_set_certificate_map') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_set_certificate_map') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_certificate_map_rest_bad_request(transport: str='rest', request_type=compute.SetCertificateMapTargetHttpsProxyRequest):
    if False:
        while True:
            i = 10
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_set_certificate_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_certificate_map_request_resource=compute.TargetHttpsProxiesSetCertificateMapRequest(certificate_map='certificate_map_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/targetHttpsProxies/{target_https_proxy}/setCertificateMap' % client.transport._host, args[1])
...
def test_set_certificate_map_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_certificate_map(compute.SetCertificateMapTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_certificate_map_request_resource=compute.TargetHttpsProxiesSetCertificateMapRequest(certificate_map='certificate_map_value'))
...
def test_set_certificate_map_unary_rest_bad_request(transport: str='rest', request_type=compute.SetCertificateMapTargetHttpsProxyRequest):
    if False:
        print('Hello World!')
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'target_https_proxy': 'sample2'}
...
def test_set_certificate_map_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_certificate_map_unary(compute.SetCertificateMapTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_certificate_map_request_resource=compute.TargetHttpsProxiesSetCertificateMapRequest(certificate_map='certificate_map_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetQuicOverrideTargetHttpsProxyRequest, dict])
def test_set_quic_override_rest(request_type):
    if False:
        return 10
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'target_https_proxy': 'sample2'}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['target_https_proxies_set_quic_override_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_set_quic_override_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_set_quic_override') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_set_quic_override') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        pre.return_value = (request, metadata)
        post.return_value = compute.Operation()
        client.set_quic_override(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()
...
def test_set_quic_override_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_quic_override_request_resource=compute.TargetHttpsProxiesSetQuicOverrideRequest(quic_override='quic_override_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_set_quic_override_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_quic_override(compute.SetQuicOverrideTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_quic_override_request_resource=compute.TargetHttpsProxiesSetQuicOverrideRequest(quic_override='quic_override_value'))

def test_set_quic_override_rest_error():
    if False:
        i = 10
        return i + 15
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_set_quic_override_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_quic_override_unary(compute.SetQuicOverrideTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_quic_override_request_resource=compute.TargetHttpsProxiesSetQuicOverrideRequest(quic_override='quic_override_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetSslCertificatesTargetHttpsProxyRequest, dict])
def test_set_ssl_certificates_rest(request_type):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'target_https_proxy': 'sample2'}
    request_init['target_https_proxies_set_ssl_certificates_request_resource'] = {'ssl_certificates': ['ssl_certificates_value1', 'ssl_certificates_value2']}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['target_https_proxies_set_ssl_certificates_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_set_ssl_certificates_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_set_ssl_certificates') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_set_ssl_certificates') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_ssl_certificates_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_ssl_certificates_request_resource=compute.TargetHttpsProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_set_ssl_certificates_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_ssl_certificates(compute.SetSslCertificatesTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_ssl_certificates_request_resource=compute.TargetHttpsProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value']))
...
def test_set_ssl_certificates_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_ssl_certificates_unary(compute.SetSslCertificatesTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', target_https_proxies_set_ssl_certificates_request_resource=compute.TargetHttpsProxiesSetSslCertificatesRequest(ssl_certificates=['ssl_certificates_value']))
...
@pytest.mark.parametrize('request_type', [compute.SetSslPolicyTargetHttpsProxyRequest, dict])
...
def test_set_ssl_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_set_ssl_policy') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_set_ssl_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_ssl_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', ssl_policy_reference_resource=compute.SslPolicyReference(ssl_policy='ssl_policy_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_set_ssl_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_ssl_policy(compute.SetSslPolicyTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', ssl_policy_reference_resource=compute.SslPolicyReference(ssl_policy='ssl_policy_value'))
...
def test_set_ssl_policy_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_ssl_policy_unary(compute.SetSslPolicyTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', ssl_policy_reference_resource=compute.SslPolicyReference(ssl_policy='ssl_policy_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetUrlMapTargetHttpsProxyRequest, dict])
...
def test_set_url_map_rest_interceptors(null_interceptor):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.TargetHttpsProxiesRestInterceptor())
    client = TargetHttpsProxiesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'post_set_url_map') as post, mock.patch.object(transports.TargetHttpsProxiesRestInterceptor, 'pre_set_url_map') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_url_map_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'target_https_proxy': 'sample2'}
        mock_args = dict(project='project_value', target_https_proxy='target_https_proxy_value', url_map_reference_resource=compute.UrlMapReference(url_map='url_map_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_set_url_map_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_url_map(compute.SetUrlMapTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', url_map_reference_resource=compute.UrlMapReference(url_map='url_map_value'))
...
def test_set_url_map_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_url_map_unary(compute.SetUrlMapTargetHttpsProxyRequest(), project='project_value', target_https_proxy='target_https_proxy_value', url_map_reference_resource=compute.UrlMapReference(url_map='url_map_value'))
...
def test_credentials_transport_error():
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = TargetHttpsProxiesClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = TargetHttpsProxiesClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.TargetHttpsProxiesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = TargetHttpsProxiesClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.TargetHttpsProxiesRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        i = 10
        return i + 15
    transport = TargetHttpsProxiesClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_target_https_proxies_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.target_https_proxies.transports.TargetHttpsProxiesTransport.__init__') as Transport:
        ...
        transport = transports.TargetHttpsProxiesTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('aggregated_list', 'delete', 'get', 'insert', 'list', 'patch', 'set_certificate_map', 'set_quic_override', 'set_ssl_certificates', 'set_ssl_policy', 'set_url_map')
...
def test_target_https_proxies_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.target_https_proxies.transports.TargetHttpsProxiesTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.TargetHttpsProxiesTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_target_https_proxies_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_target_https_proxies_host_with_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
@pytest.mark.parametrize('transport_name', ['rest'])
def test_target_https_proxies_client_transport_session_collision(transport_name):
    if False:
        return 10
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = TargetHttpsProxiesClient(credentials=creds1, transport=transport_name)
    client2 = TargetHttpsProxiesClient(credentials=creds2, transport=transport_name)
    ...
    assert session1 != session2
    session1 = client1.transport.set_quic_override._session
    session2 = client2.transport.set_quic_override._session
    assert session1 != session2
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.TargetHttpsProxiesTransport, '_prep_wrapped_messages') as prep:
        client = TargetHttpsProxiesClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(TargetHttpsProxiesClient, transports.TargetHttpsProxiesRestTransport)])
