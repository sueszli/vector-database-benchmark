...
class ChannelDeactivate(BaseMutation):
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.CHANNEL_STATUS_CHANGED, description='A channel was deactivated.')]
    ...
    def clean_channel_availability(cls, channel):
        ...
        if channel.is_active is False:
            raise ValidationError({'id': ValidationError('This channel is already deactivated.', code=ChannelErrorCode.INVALID.value)})
