...
class XGBoostTrainer(GBDTTrainer):
    ...
    _default_ray_params: Dict[str, Any] = {'num_actors': 1, 'cpus_per_actor': 1, 'gpus_per_actor': 0}
    ...
    def get_model(checkpoint: Checkpoint) -> xgboost.Booster:
        ...
        with checkpoint.as_directory() as checkpoint_path:
            ...
            booster.load_model(os.path.join(checkpoint_path, XGBoostCheckpoint.MODEL_FILENAME))
            return booster
