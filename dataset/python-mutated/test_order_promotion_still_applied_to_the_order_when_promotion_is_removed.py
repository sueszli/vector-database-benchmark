...
from ...promotions.utils import create_promotion, create_promotion_rule, delete_promotion, promotion_query
from ...shop.utils.preparing_shop import prepare_shop
from ...utils import assign_permissions
from ..utils import draft_order_complete, draft_order_create, draft_order_update, order_lines_create

@pytest.mark.e2e
def test_order_promotion_still_applied_to_the_order_when_promotion_is_removed_CORE_2115(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_orders):
    if False:
        while True:
            i = 10
