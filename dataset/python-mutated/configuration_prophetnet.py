...
PROPHETNET_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/prophetnet-large-uncased': 'https://huggingface.co/microsoft/prophetnet-large-uncased/resolve/main/config.json'}
