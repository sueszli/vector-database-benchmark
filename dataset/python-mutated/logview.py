...
from picard.config import IntOption, get_config
from picard.util import reconnect, wildcards_to_regex_pattern
from picard.ui import FONT_FAMILY_MONOSPACE, PicardDialog
...
class LogView(LogViewCommon):
    options = [IntOption('setting', 'log_verbosity', logging.WARNING)]
