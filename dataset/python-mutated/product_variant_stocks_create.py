...
class ProductVariantStocksCreate(BaseMutation):
    ...
    class Arguments:
        variant_id = graphene.ID(required=True, description='ID of a product variant for which stocks will be created.')
        stocks = NonNullList(StockInput, required=True, description='Input list of stocks to create.')
