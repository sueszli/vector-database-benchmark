...
warnings.warn("Bio.Blast.ParseBlastTable.py has been deprecated, and will be removed in a future version of Biopython.  To parse tabular output from BLAST programs, please use the Bio.Align module:\n\nfrom Bio import Align\nalignments = Align.parse('myblastoutputfile.txt', 'tabular')\n\nand iterate over the alignments.", BiopythonDeprecationWarning)
...
class BlastTableReader:
    ...
    reader_keywords = {'BLASTP': 'version', 'Iteration': 'iteration', 'Query': 'query', 'Database': 'database', 'Fields': 'fields'}
