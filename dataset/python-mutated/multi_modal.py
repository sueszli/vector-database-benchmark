...
from modelscope.pipelines.cv.cmdssl_video_embedding_pipeline import VCenterCrop, VCompose, VNormalize, VRescale, VToTensor
from modelscope.preprocessors import load_image
from modelscope.utils.config import Config
from modelscope.utils.constant import Fields, Invoke, ModeKeys, ModelFile, Tasks
from .base import Preprocessor
from .builder import PREPROCESSORS
from .ofa import *
from .ofa.utils.collate import collate_fn
from .ofa.utils.constant import OFA_TASK_KEY_MAPPING
__all__ = ['DiffusionImageGenerationPreprocessor', 'OfaPreprocessor', 'MPlugPreprocessor', 'HiTeAPreprocessor', 'MplugOwlPreprocessor']
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.ofa_tasks_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.clip_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.mplug_tasks_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.vldoc_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.hitea_tasks_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.mplug_owl_preprocessor)
...
@PREPROCESSORS.register_module(Fields.multi_modal, module_name=Preprocessors.image_captioning_clip_interrogator_preprocessor)
