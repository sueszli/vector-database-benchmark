...
from modelscope.models.cv.body_2d_keypoints.hrnet_v2 import PoseHighResolutionNetV2
...
@PIPELINES.register_module(Tasks.body_2d_keypoints, module_name=Pipelines.body_2d_keypoints)
