...
def main():
    ...
    response = client.shares.create(resource_group_name='SampleResourceGroup', account_name='Account1', share_name='Share1', share={'properties': {'description': 'share description', 'shareKind': 'CopyBased', 'terms': 'Confidential'}})
    print(response)
