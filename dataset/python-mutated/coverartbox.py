...
from picard.coverart.image import CoverArtImage, CoverArtImageError, CoverArtImageIOError
from picard.file import File
from picard.track import Track
from picard.util import imageinfo, normpath
...
HTML_IMG_SRC_REGEX = re.compile('<img .*?src="(.*?)"', re.UNICODE)
