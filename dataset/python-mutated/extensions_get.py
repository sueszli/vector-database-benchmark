...
def main():
    ...
    response = client.extensions.get(resource_group_name='examples-rg', farm_beats_resource_name='examples-farmbeatsResourceName', extension_id='provider.extension')
    print(response)
