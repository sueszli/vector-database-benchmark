...
class ChatMemberOwner(ChatMember):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, status: Literal[ChatMemberStatus.CREATOR]=ChatMemberStatus.CREATOR, user: User, is_anonymous: bool, custom_title: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(status=status, user=user, is_anonymous=is_anonymous, custom_title=custom_title, **__pydantic_kwargs)