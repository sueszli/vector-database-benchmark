...
from ..utils import format_field, float_or_none, int_or_none, parse_iso8601, remove_start
...
class ArnesIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://video.arnes.si/watch/a1qrWTOQfVoU?t=10', 'md5': '4d0f4d0a03571b33e1efac25fd4a065d', 'info_dict': {'id': 'a1qrWTOQfVoU', 'ext': 'mp4', 'title': 'Linearna neodvisnost, definicija', 'description': 'Linearna neodvisnost, definicija', 'license': 'PRIVATE', 'creator': 'Polona Oblak', 'timestamp': 1585063725, 'upload_date': '20200324', 'channel': 'Polona Oblak', 'channel_id': 'q6pc04hw24cj', 'channel_url': 'https://video.arnes.si/?channel=q6pc04hw24cj', 'duration': 596.75, 'view_count': int, 'tags': ['linearna_algebra'], 'start_time': 10}}, {'url': 'https://video.arnes.si/api/asset/s1YjnV7hadlC/play.mp4', 'only_matching': True}, {'url': 'https://video.arnes.si/embed/s1YjnV7hadlC', 'only_matching': True}, {'url': 'https://video.arnes.si/en/watch/s1YjnV7hadlC', 'only_matching': True}, {'url': 'https://video.arnes.si/embed/s1YjnV7hadlC?t=123&hideRelated=1', 'only_matching': True}, {'url': 'https://video.arnes.si/api/public/video/s1YjnV7hadlC', 'only_matching': True}]
