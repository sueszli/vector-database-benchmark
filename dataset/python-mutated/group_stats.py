...
class GroupStatsEndpoint(GroupEndpoint, EnvironmentMixin, StatsMixin):
    ...
    def get(self, request: Request, group) -> Response:
        ...
        data = tsdb.backend.get_range(model=TSDBModel.group, keys=[group.id], **self._parse_args(request, environment_id), tenant_ids={'organization_id': group.project.organization_id})[group.id]
