...
from api.models import AlbumDate, AlbumPlace, AlbumThing, AlbumUser, Face, File, Person, Photo, User
from api.serializers.album_date import AlbumDateSerializer, IncompleteAlbumDateSerializer
from api.serializers.album_place import AlbumPlaceListSerializer, AlbumPlaceSerializer, GroupedPlacePhotosSerializer
from api.serializers.album_thing import AlbumThingListSerializer, AlbumThingSerializer, GroupedThingPhotosSerializer
...
from api.views.pagination import RegularResultsSetPagination, StandardResultsSetPagination

@extend_schema(deprecated=True, description='This endpoint is deprecated. Use /api/persons instead.')
