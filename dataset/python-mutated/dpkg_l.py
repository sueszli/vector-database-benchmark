...
def _process(proc_data):
    ...
    desired_map = {'u': 'unknown', 'i': 'install', 'r': 'remove', 'p': 'purge', 'h': 'hold'}
    status_map = {'n': 'not installed', 'i': 'installed', 'c': 'config-files', 'u': 'unpacked', 'f': 'failed config', 'h': 'half installed', 'w': 'trigger await', 't': 'trigger pending'}
    err_map = {'r': 'reinstall required'}
