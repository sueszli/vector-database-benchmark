...
if gpu_enabled:
    if dnn_enabled():
        ...
        raise ImportError('cuDNN not available: %s\nSee http://lasagne.readthedocs.org            /en/latest/user/installation.html#cudnn            ' % dnn_enabled.msg)
else:
...
__all__ = ['Pool2DDNNLayer', 'MaxPool2DDNNLayer', 'Pool3DDNNLayer', 'MaxPool3DDNNLayer', 'Conv2DDNNLayer', 'Conv3DDNNLayer', 'SpatialPyramidPoolingDNNLayer', 'BatchNormDNNLayer', 'batch_norm_dnn']
