...
class AutoCheckpointTestMul(AutoCheckPointACLBase):
    ...
    def test_multiple(self):
        ...
        (compiled1, data_loader1, optimizer1, loss1, image1, label1) = self._init_env(exe, main_prog1, startup_prog1)
        (compiled2, data_loader2, optimizer2, loss2, image2, label2) = self._init_env(exe, main_prog2, startup_prog2)
        o = None
        epochs = []
