...
import proto
__protobuf__ = proto.module(package='google.cloud.filestore.v1', manifest={'NetworkConfig', 'FileShareConfig', 'NfsExportOptions', 'Instance', 'CreateInstanceRequest', 'GetInstanceRequest', 'UpdateInstanceRequest', 'RestoreInstanceRequest', 'RevertInstanceRequest', 'DeleteInstanceRequest', 'ListInstancesRequest', 'ListInstancesResponse', 'Snapshot', 'CreateSnapshotRequest', 'GetSnapshotRequest', 'DeleteSnapshotRequest', 'UpdateSnapshotRequest', 'ListSnapshotsRequest', 'ListSnapshotsResponse', 'Backup', 'CreateBackupRequest', 'DeleteBackupRequest', 'UpdateBackupRequest', 'GetBackupRequest', 'ListBackupsRequest', 'ListBackupsResponse'})
...
class NetworkConfig(proto.Message):
    ...
    modes: MutableSequence[AddressMode] = proto.RepeatedField(proto.ENUM, number=3, enum=AddressMode)
    reserved_ip_range: str = proto.Field(proto.STRING, number=4)
    ip_addresses: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    connect_mode: ConnectMode = proto.Field(proto.ENUM, number=6, enum=ConnectMode)
...
class FileShareConfig(proto.Message):
    ...
    capacity_gb: int = proto.Field(proto.INT64, number=2)
    source_backup: str = proto.Field(proto.STRING, number=8, oneof='source')
    nfs_export_options: MutableSequence['NfsExportOptions'] = proto.RepeatedField(proto.MESSAGE, number=7, message='NfsExportOptions')
...
class NfsExportOptions(proto.Message):
    ...
    class SquashMode(proto.Enum):
        ...
        NO_ROOT_SQUASH = 1
        ROOT_SQUASH = 2
    ip_ranges: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    access_mode: AccessMode = proto.Field(proto.ENUM, number=2, enum=AccessMode)
    squash_mode: SquashMode = proto.Field(proto.ENUM, number=3, enum=SquashMode)
    anon_uid: int = proto.Field(proto.INT64, number=4)
    anon_gid: int = proto.Field(proto.INT64, number=5)
...
class Instance(proto.Message):
    ...
    class SuspensionReason(proto.Enum):
        """SuspensionReason contains the possible reasons for a
        suspension.
    ...
    status_message: str = proto.Field(proto.STRING, number=6)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    tier: Tier = proto.Field(proto.ENUM, number=8, enum=Tier)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=9)
    file_shares: MutableSequence['FileShareConfig'] = proto.RepeatedField(proto.MESSAGE, number=10, message='FileShareConfig')
    networks: MutableSequence['NetworkConfig'] = proto.RepeatedField(proto.MESSAGE, number=11, message='NetworkConfig')
    etag: str = proto.Field(proto.STRING, number=12)
    satisfies_pzs: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=13, message=wrappers_pb2.BoolValue)
    satisfies_pzi: bool = proto.Field(proto.BOOL, number=18)
    kms_key_name: str = proto.Field(proto.STRING, number=14)
    suspension_reasons: MutableSequence[SuspensionReason] = proto.RepeatedField(proto.ENUM, number=15, enum=SuspensionReason)
...
class RestoreInstanceRequest(proto.Message):
    """RestoreInstanceRequest restores an existing instance's file
    share from a backup.
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    file_share: str = proto.Field(proto.STRING, number=2)
    source_backup: str = proto.Field(proto.STRING, number=3, oneof='source')

class RevertInstanceRequest(proto.Message):
    """RevertInstanceRequest reverts the given instance's file share
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    target_snapshot_id: str = proto.Field(proto.STRING, number=2)
...
class Snapshot(proto.Message):
    ...
    filesystem_used_bytes: int = proto.Field(proto.INT64, number=6)
...
class CreateSnapshotRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    snapshot_id: str = proto.Field(proto.STRING, number=2)
    snapshot: 'Snapshot' = proto.Field(proto.MESSAGE, number=3, message='Snapshot')
...
class UpdateSnapshotRequest(proto.Message):
    """UpdateSnapshotRequest updates description and/or labels for a
    snapshot.
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    snapshot: 'Snapshot' = proto.Field(proto.MESSAGE, number=2, message='Snapshot')
...
class ListSnapshotsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    snapshots: MutableSequence['Snapshot'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Snapshot')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class Backup(proto.Message):
    ...
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    capacity_gb: int = proto.Field(proto.INT64, number=6)
    storage_bytes: int = proto.Field(proto.INT64, number=7)
    source_instance: str = proto.Field(proto.STRING, number=8)
    source_file_share: str = proto.Field(proto.STRING, number=9)
    source_instance_tier: 'Instance.Tier' = proto.Field(proto.ENUM, number=10, enum='Instance.Tier')
    download_bytes: int = proto.Field(proto.INT64, number=11)
    satisfies_pzs: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=12, message=wrappers_pb2.BoolValue)
    satisfies_pzi: bool = proto.Field(proto.BOOL, number=14)
    kms_key: str = proto.Field(proto.STRING, number=13)
...
class CreateBackupRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    backup: 'Backup' = proto.Field(proto.MESSAGE, number=2, message='Backup')
    backup_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateBackupRequest(proto.Message):
    """UpdateBackupRequest updates description and/or labels for a
    backup.
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            one path must be supplied in this field.
    """
    backup: 'Backup' = proto.Field(proto.MESSAGE, number=1, message='Backup')
...
class ListBackupsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    backups: MutableSequence['Backup'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Backup')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
