...
gen_array_ops.check_numerics = weak_tensor_unary_op_wrapper(gen_array_ops.check_numerics)
...
image_ops.stateless_random_brightness = weak_tensor_unary_op_wrapper(image_ops.stateless_random_brightness)
...
special_math_ops.fresnel_cos = weak_tensor_unary_op_wrapper(special_math_ops.fresnel_cos)
special_math_ops.fresnel_sin = weak_tensor_unary_op_wrapper(special_math_ops.fresnel_sin)
...
math_ops.reduce_euclidean_norm = weak_tensor_unary_op_wrapper(math_ops.reduce_euclidean_norm)
...
array_ops.extract_image_patches = weak_tensor_unary_op_wrapper(array_ops.extract_image_patches)
array_ops.extract_image_patches_v2 = weak_tensor_unary_op_wrapper(array_ops.extract_image_patches_v2)
...
np_array_ops.ascontiguousarray = weak_tensor_unary_op_wrapper(np_array_ops.ascontiguousarray)
...
gen_math_ops.maximum = weak_tensor_binary_op_wrapper(gen_math_ops.maximum, special_handling='comparison-method')
gen_math_ops.minimum = weak_tensor_binary_op_wrapper(gen_math_ops.minimum, special_handling='comparison-method')
gen_math_ops.equal = weak_tensor_binary_op_wrapper(gen_math_ops.equal, special_handling='comparison-method')
math_ops.maximum = weak_tensor_binary_op_wrapper(math_ops.maximum, special_handling='comparison-method')
math_ops.minimum = weak_tensor_binary_op_wrapper(math_ops.minimum, special_handling='comparison-method')
ResourceVariable.assign = weak_tensor_binary_op_wrapper(ResourceVariable.assign, special_handling='variable_method')
ResourceVariable.assign_add = weak_tensor_binary_op_wrapper(ResourceVariable.assign_add, special_handling='variable_method')
ResourceVariable.assign_sub = weak_tensor_binary_op_wrapper(ResourceVariable.assign_sub, special_handling='variable_method')
ops.convert_to_tensor_or_composite = weak_tensor_unary_op_wrapper(ops.convert_to_tensor_or_composite)
constant_op.constant = weak_tensor_binary_op_wrapper(constant_op.constant, y_arg_name='dtype', special_handling='constant')
