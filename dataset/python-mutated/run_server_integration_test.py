...
if __name__ == '__main__':
    ...
    parser.add_argument('--typeshed-path', help='Path to zip containing typeshed.', type=os.path.abspath)
    parser.add_argument('--debug', action='store_true', default=False)
    arguments: Namespace = parser.parse_args()
    sys.exit(run(arguments.repository_location, None if arguments.typeshed_path is None else pathlib.Path(arguments.typeshed_path), arguments.debug))