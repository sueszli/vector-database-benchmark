...
class BlogDashboardPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class BlogDashboardDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'POST': {}, 'PUT': {'displayed_author_name': {'schema': {'type': 'basestring'}, 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_AUTHOR_NAME_LENGTH}]}, 'author_bio': {'schema': {'type': 'basestring'}, 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_CHARS_IN_AUTHOR_BIO}]}}}
...
class BlogPostHandler(base.BaseHandler[BlogPostHandlerNormalizedPayloadDict, BlogPostHandlerNormalizedRequestDict]):
    """Handler for blog dashboard editor"""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'blog_post_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.BLOG_POST_ID_LENGTH}, {'id': 'has_length_at_least', 'min_value': constants.BLOG_POST_ID_LENGTH}]}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'PUT': {'new_publish_status': {'schema': {'type': 'bool'}}, 'change_dict': {'schema': {'type': 'object_dict', 'validation_method': validation_method.validate_change_dict_for_blog_post}}}, 'POST': {'thumbnail_filename': {'schema': {'type': 'basestring'}}, 'image': {'schema': {'type': 'basestring'}}}, 'DELETE': {}}
...
class BlogPostTitleHandler(base.BaseHandler[BlogPostTitleHandlerNormalizedDict, BlogPostTitleHandlerNormalizedDict]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'blog_post_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.BLOG_POST_ID_LENGTH}, {'id': 'has_length_at_least', 'min_value': constants.BLOG_POST_ID_LENGTH}]}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'title': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_CHARS_IN_BLOG_POST_TITLE}]}}}}
