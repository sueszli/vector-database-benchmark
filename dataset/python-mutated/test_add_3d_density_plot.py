...
class TestAdd3DDensityPlot(TestCase):
    ...
    DENSITY_PLOT: Chart = Chart(_create_plot_001(), width=Decimal(64), height=Decimal(64))
    ...
    def test_add_orderedlist_of_3d_density_plots(self):
        ...
        layout.add(OrderedList().add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT))
    ...
    def test_add_unorderedlist_of_3d_density_plots(self):
        ...
        layout.add(UnorderedList().add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT))
    ...
    def test_add_table_of_3d_density_plots(self):
        ...
        layout.add(FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=2).add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT).add(TestAdd3DDensityPlot.DENSITY_PLOT))
