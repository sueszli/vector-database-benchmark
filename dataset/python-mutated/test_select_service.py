...
class MockManager:
    ...
    def __init__(self, stub_runner, scenario_data, input_mocker):
        ...
        self.support_services = [{'name': f'Service-{i}', 'code': f'service-code-{i}', 'categories': [{'name': f'Category-{j}'} for j in range(4)]} for i in range(1)]
        self.scenario_args = []
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_describe_services', 0)])
