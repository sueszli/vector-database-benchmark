...
def build_list_by_service_request(resource_group_name: str, service_name: str, subscription_id: str, *, scope: Optional[Union[str, _models.PolicyScopeContract]]=None, **kwargs: Any) -> HttpRequest:
    if False:
        for i in range(10):
            print('nop')
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyDescriptions')
...
class PolicyDescriptionOperations:
    ...
    @distributed_trace
    def list_by_service(self, resource_group_name: str, service_name: str, scope: Optional[Union[str, _models.PolicyScopeContract]]=None, **kwargs: Any) -> _models.PolicyDescriptionCollection:
        if False:
            while True:
                i = 10
        ...
        request = build_list_by_service_request(resource_group_name=resource_group_name, service_name=service_name, subscription_id=self._config.subscription_id, scope=scope, api_version=api_version, template_url=self.list_by_service.metadata['url'], headers=_headers, params=_params)
