...
from prowler.providers.gcp.services.iam.accessapproval_client import accessapproval_client
    ...
    def execute(self) -> Check_Report_GCP:
        ...
        for project_id in accessapproval_client.project_ids:
            ...
            if project_id not in accessapproval_client.settings:
                report.status = 'FAIL'
                report.status_extended = f'Project {project_id} does not have Access Approval enabled.'
