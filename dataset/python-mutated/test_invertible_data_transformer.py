    ...
    class DataTransformerMock(InvertibleDataTransformer):
        ...
        def ts_transform(series: TimeSeries, params: Mapping[str, Any], **kwargs) -> TimeSeries:
            ...
            if not mask_components and 'component_mask' in kwargs:
                vals = TestInvertibleDataTransformer.DataTransformerMock.apply_component_mask(series, kwargs['component_mask'], return_ts=False)
            else:
            ...
            if not mask_components and 'component_mask' in kwargs:
                vals = TestInvertibleDataTransformer.DataTransformerMock.unapply_component_mask(series, vals, kwargs['component_mask'])
