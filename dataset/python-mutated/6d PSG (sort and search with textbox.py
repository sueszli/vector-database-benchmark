...
column1 = [[sg.ReadButton('Original list', size=(11, 1))], [sg.ReadButton('Default sort', size=(11, 1))], [sg.ReadButton('Sort: selection', size=(11, 1))], [sg.ReadButton('Sort: quick', size=(11, 1))]]
layout = [[sg.Text('Search and Sort Demo', font=('Calibri', 20, 'bold'))], [sg.Text('', size=(14, 11), relief=sg.RELIEF_SOLID, font=('Calibri', 12), background_color='White', key='_display_'), sg.Column(column1)], [sg.Text('_' * 35, font=('Calibri', 16))], [sg.InputText(size=(10, 1), key='_linear_'), sg.Text('   '), sg.InputText(size=(11, 1), key='_binary_')], [sg.ReadButton('Linear Search', size=(11, 1)), sg.Text(' '), sg.ReadButton('Binary Search', size=(11, 1))]]
