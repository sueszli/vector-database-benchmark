...
class RadioFranceBaseIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://(?:www\\.)?radiofrance\\.fr'
    _STATIONS_RE = '|'.join(map(re.escape, ('franceculture', 'franceinfo', 'franceinter', 'francemusique', 'fip', 'mouv')))
...
class RadioFrancePodcastIE(RadioFrancePlaylistBase):
    _VALID_URL = f'(?x)\n        {RadioFranceBaseIE._VALID_URL_BASE}\n        /(?:{RadioFranceBaseIE._STATIONS_RE})\n        /podcasts/(?P<id>[\\w-]+)/?(?:[?#]|$)\n    '
    _TESTS = [{'url': 'https://www.radiofrance.fr/franceinfo/podcasts/le-billet-vert', 'info_dict': {'id': 'eaf6ef81-a980-4f1c-a7d1-8a75ecd54b17', 'display_id': 'le-billet-vert', 'title': 'Le billet sciences', 'description': 'md5:eb1007b34b0c0a680daaa71525bbd4c1', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 11}, {'url': 'https://www.radiofrance.fr/franceinter/podcasts/jean-marie-le-pen-l-obsession-nationale', 'info_dict': {'id': '566fd524-3074-4fbc-ac69-8696f2152a54', 'display_id': 'jean-marie-le-pen-l-obsession-nationale', 'title': "Jean-Marie Le Pen, l'obsession nationale", 'description': 'md5:a07c0cfb894f6d07a62d0ad12c4b7d73', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_count': 7}, {'url': 'https://www.radiofrance.fr/franceculture/podcasts/serie-thomas-grjebine', 'info_dict': {'id': '63c1ddc9-9f15-457a-98b2-411bac63f48d', 'display_id': 'serie-thomas-grjebine', 'title': 'Thomas Grjebine'}, 'playlist_count': 1}, {'url': 'https://www.radiofrance.fr/fip/podcasts/certains-l-aiment-fip', 'info_dict': {'id': '143dff38-e956-4a5d-8576-1c0b7242b99e', 'display_id': 'certains-l-aiment-fip', 'title': 'Certains l’aiment Fip', 'description': 'md5:ff974672ba00d4fd5be80fb001c5b27e', 'thumbnail': 're:^https?://.*\\.(?:jpg|png)'}, 'playlist_mincount': 321}, {'url': 'https://www.radiofrance.fr/franceinter/podcasts/le-7-9', 'only_matching': True}, {'url': 'https://www.radiofrance.fr/mouv/podcasts/dirty-mix', 'only_matching': True}]
