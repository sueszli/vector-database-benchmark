...
from AnyQt.QtCore import Qt, QItemSelection, QItemSelectionModel, QT_VERSION_INFO
...
from Orange.widgets.data.owrank import OWRank, ProblemType, CLS_SCORES, REG_SCORES, RankTableModel
