...
from samcli.hook_packages.terraform.hooks.prepare.constants import REMOTE_DUMMY_VALUE, TF_AWS_API_GATEWAY_AUTHORIZER, TF_AWS_API_GATEWAY_INTEGRATION, TF_AWS_API_GATEWAY_INTEGRATION_RESPONSE, TF_AWS_API_GATEWAY_METHOD, TF_AWS_API_GATEWAY_RESOURCE, TF_AWS_API_GATEWAY_REST_API, TF_AWS_API_GATEWAY_STAGE, TF_AWS_API_GATEWAY_V2_API, TF_AWS_API_GATEWAY_V2_AUTHORIZER, TF_AWS_API_GATEWAY_V2_INTEGRATION, TF_AWS_API_GATEWAY_V2_ROUTE, TF_AWS_API_GATEWAY_V2_STAGE, TF_AWS_LAMBDA_FUNCTION, TF_AWS_LAMBDA_LAYER_VERSION
from samcli.hook_packages.terraform.hooks.prepare.resource_linking import _resolve_resource_attribute
from samcli.hook_packages.terraform.hooks.prepare.resources.internal import INTERNAL_API_GATEWAY_INTEGRATION, INTERNAL_API_GATEWAY_INTEGRATION_RESPONSE
from samcli.hook_packages.terraform.hooks.prepare.types import PropertyBuilder, PropertyBuilderMapping, ResourceTranslator, TFResource
...
AWS_LAMBDA_FUNCTION_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'FunctionName': _get_property_extractor('function_name'), 'Architectures': _get_property_extractor('architectures'), 'Environment': _build_lambda_function_environment_property, 'Code': _build_code_property, 'Handler': _get_property_extractor('handler'), 'PackageType': _get_property_extractor('package_type'), 'Runtime': _get_property_extractor('runtime'), 'Layers': _get_property_extractor('layers'), 'Timeout': _get_property_extractor('timeout'), 'MemorySize': _get_property_extractor('memory_size'), 'ImageConfig': _build_lambda_function_image_config_property}
AWS_LAMBDA_LAYER_VERSION_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'LayerName': _get_property_extractor('layer_name'), 'CompatibleRuntimes': _get_property_extractor('compatible_runtimes'), 'CompatibleArchitectures': _get_property_extractor('compatible_architectures'), 'Content': _build_code_property}
AWS_API_GATEWAY_REST_API_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'Name': _get_property_extractor('name'), 'Body': _get_json_body, 'Parameters': _get_property_extractor('parameters'), 'BinaryMediaTypes': _get_property_extractor('binary_media_types')}
AWS_API_GATEWAY_STAGE_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'RestApiId': _get_property_extractor('rest_api_id'), 'StageName': _get_property_extractor('stage_name'), 'Variables': _get_property_extractor('variables')}
AWS_API_GATEWAY_RESOURCE_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'RestApiId': _get_property_extractor('rest_api_id'), 'ParentId': _get_property_extractor('parent_id'), 'PathPart': _get_property_extractor('path_part')}
AWS_API_GATEWAY_METHOD_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'RestApiId': _get_property_extractor('rest_api_id'), 'ResourceId': _get_property_extractor('resource_id'), 'HttpMethod': _get_property_extractor('http_method'), 'OperationName': _get_property_extractor('operation_name'), 'AuthorizerId': _get_property_extractor('authorizer_id'), 'AuthorizationType': _get_property_extractor('authorization')}
AWS_API_GATEWAY_INTEGRATION_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'RestApiId': _get_property_extractor('rest_api_id'), 'ResourceId': _get_property_extractor('resource_id'), 'HttpMethod': _get_property_extractor('http_method'), 'Uri': _get_property_extractor('uri'), 'Type': _get_property_extractor('type'), 'ContentHandling': _get_property_extractor('content_handling'), 'ConnectionType': _get_property_extractor('connection_type')}
AWS_API_GATEWAY_AUTHORIZER_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'Name': _get_property_extractor('name'), 'RestApiId': _get_property_extractor('rest_api_id'), 'AuthorizerUri': _get_property_extractor('authorizer_uri'), 'IdentitySource': _get_property_extractor('identity_source'), 'Type': _get_property_extractor('type'), 'IdentityValidationExpression': _get_property_extractor('identity_validation_expression')}
AWS_API_GATEWAY_INTEGRATION_RESPONSE_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'RestApiId': _get_property_extractor('rest_api_id'), 'ResourceId': _get_property_extractor('resource_id'), 'HttpMethod': _get_property_extractor('http_method'), 'ResponseParameters': _get_property_extractor('response_parameters')}
AWS_API_GATEWAY_V2_API_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'Name': _get_property_extractor('name'), 'Body': _get_json_body, 'Target': _get_property_extractor('target'), 'ProtocolType': _get_property_extractor('protocol_type'), 'RouteKey': _get_property_extractor('route_key'), 'CorsConfiguration': _get_cors_v2_api}
AWS_API_GATEWAY_V2_ROUTE_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'ApiId': _get_property_extractor('api_id'), 'RouteKey': _get_property_extractor('route_key'), 'Target': _get_property_extractor('target'), 'OperationName': _get_property_extractor('operation_name')}
AWS_API_GATEWAY_V2_STAGE_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'ApiId': _get_property_extractor('api_id'), 'StageName': _get_property_extractor('name'), 'StageVariables': _get_property_extractor('stage_variables')}
AWS_API_GATEWAY_V2_INTEGRATION_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'ApiId': _get_property_extractor('api_id'), 'IntegrationType': _get_property_extractor('integration_type'), 'IntegrationMethod': _get_property_extractor('integration_method'), 'IntegrationUri': _get_property_extractor('integration_uri'), 'PayloadFormatVersion': _get_property_extractor('payload_format_version')}
AWS_API_GATEWAY_V2_AUTHORIZER_PROPERTY_BUILDER_MAPPING: PropertyBuilderMapping = {'ApiId': _get_property_extractor('api_id'), 'AuthorizerType': _get_property_extractor('authorizer_type'), 'AuthorizerUri': _get_property_extractor('authorizer_uri'), 'Name': _get_property_extractor('name'), 'AuthorizerPayloadFormatVersion': _get_property_extractor('authorizer_payload_format_version'), 'IdentitySource': _get_property_extractor('identity_sources'), 'EnableSimpleResponses': _get_property_extractor('enable_simple_responses')}
RESOURCE_TRANSLATOR_MAPPING: Dict[str, ResourceTranslator] = {TF_AWS_LAMBDA_FUNCTION: ResourceTranslator(CFN_AWS_LAMBDA_FUNCTION, AWS_LAMBDA_FUNCTION_PROPERTY_BUILDER_MAPPING), TF_AWS_LAMBDA_LAYER_VERSION: ResourceTranslator(CFN_AWS_LAMBDA_LAYER_VERSION, AWS_LAMBDA_LAYER_VERSION_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_REST_API: ResourceTranslator(CFN_AWS_APIGATEWAY_RESTAPI, AWS_API_GATEWAY_REST_API_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_STAGE: ResourceTranslator(CFN_AWS_APIGATEWAY_STAGE, AWS_API_GATEWAY_STAGE_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_RESOURCE: ResourceTranslator(CFN_AWS_APIGATEWAY_RESOURCE, AWS_API_GATEWAY_RESOURCE_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_METHOD: ResourceTranslator(CFN_AWS_APIGATEWAY_METHOD, AWS_API_GATEWAY_METHOD_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_INTEGRATION: ResourceTranslator(INTERNAL_API_GATEWAY_INTEGRATION, AWS_API_GATEWAY_INTEGRATION_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_AUTHORIZER: ResourceTranslator(CFN_AWS_APIGATEWAY_AUTHORIZER, AWS_API_GATEWAY_AUTHORIZER_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_INTEGRATION_RESPONSE: ResourceTranslator(INTERNAL_API_GATEWAY_INTEGRATION_RESPONSE, AWS_API_GATEWAY_INTEGRATION_RESPONSE_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_V2_API: ResourceTranslator(CFN_AWS_APIGATEWAY_V2_API, AWS_API_GATEWAY_V2_API_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_V2_ROUTE: ResourceTranslator(CFN_AWS_APIGATEWAY_V2_ROUTE, AWS_API_GATEWAY_V2_ROUTE_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_V2_STAGE: ResourceTranslator(CFN_AWS_APIGATEWAY_V2_STAGE, AWS_API_GATEWAY_V2_STAGE_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_V2_INTEGRATION: ResourceTranslator(CFN_AWS_APIGATEWAY_V2_INTEGRATION, AWS_API_GATEWAY_V2_INTEGRATION_PROPERTY_BUILDER_MAPPING), TF_AWS_API_GATEWAY_V2_AUTHORIZER: ResourceTranslator(CFN_AWS_APIGATEWAY_V2_AUTHORIZER, AWS_API_GATEWAY_V2_AUTHORIZER_PROPERTY_BUILDER_MAPPING)}