...
class stat_sina(stat):
    ...
    DEFAULT_PARAMS = {'geom': 'sina', 'position': 'dodge', 'na_rm': False, 'binwidth': None, 'bins': None, 'method': 'density', 'bw': 'nrd0', 'maxwidth': None, 'adjust': 1, 'bin_limit': 1, 'random_state': None, 'scale': 'area'}
    CREATES = {'scaled'}
