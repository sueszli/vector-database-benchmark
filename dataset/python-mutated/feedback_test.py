...
EXPECTED_THREAD_KEYS: Final = ['status', 'original_author_username', 'state_name', 'summary', 'thread_id', 'subject', 'last_updated_msecs', 'message_count', 'last_nonempty_message_text', 'last_nonempty_message_author']
EXPECTED_MESSAGE_KEYS: Final = ['author_username', 'created_on_msecs', 'entity_type', 'message_id', 'entity_id', 'text', 'updated_status', 'updated_subject']
