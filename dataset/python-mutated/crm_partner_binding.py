...
class PartnerBinding(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        return res
    action = fields.Selection([('exist', 'Link to an existing customer'), ('create', 'Create a new customer'), ('nothing', 'Do not link to a customer')], 'Related Customer', required=True)
