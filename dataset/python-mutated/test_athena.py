...
import pytest
from openlineage.client.facet import SchemaDatasetFacet, SchemaField, SqlJobFacet, SymlinksDatasetFacet, SymlinksDatasetFacetIdentifiers
...
MOCK_DATA = {'task_id': 'test_athena_operator', 'query': 'SELECT * FROM TEST_TABLE', 'database': 'TEST_DATABASE', 'catalog': 'AwsDataCatalog', 'outputLocation': 's3://test_s3_bucket/', 'client_request_token': 'eac427d0-1c6d-4dfb-96aa-2835d3ac6595', 'workgroup': 'primary'}
