...
class TestFleet1(unittest.TestCase):
    ...
    def test_pslib_1(self):
        ...
        with base.program_guard(train_program, startup_program):
            ...
            bow = paddle.static.nn.data_norm(input=bow, epsilon=0.0001, name='norm')
        ...
        try:
            ...
            adam = fleet.distributed_optimizer(adam, strategy={'embedding': {'sparse_accessor_class': 'DownpourSparseValueAccessor'}})
