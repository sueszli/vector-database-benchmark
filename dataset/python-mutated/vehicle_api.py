...
__protobuf__ = proto.module(package='maps.fleetengine.v1', manifest={'CreateVehicleRequest', 'GetVehicleRequest', 'UpdateVehicleRequest', 'UpdateVehicleLocationRequest', 'UpdateVehicleAttributesRequest', 'UpdateVehicleAttributesResponse', 'SearchVehiclesRequest', 'SearchVehiclesResponse', 'ListVehiclesRequest', 'ListVehiclesResponse', 'Waypoint', 'VehicleMatch', 'VehicleAttributeList'})
...
class CreateVehicleRequest(proto.Message):
    ...
    """
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=1, message=mf_header.RequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    vehicle_id: str = proto.Field(proto.STRING, number=4)
    vehicle: mf_vehicles.Vehicle = proto.Field(proto.MESSAGE, number=5, message=mf_vehicles.Vehicle)
...
class GetVehicleRequest(proto.Message):
    ...
    current_route_segment_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    waypoints_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
...
class UpdateVehicleRequest(proto.Message):
    ...
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=1, message=mf_header.RequestHeader)
    name: str = proto.Field(proto.STRING, number=3)
    vehicle: mf_vehicles.Vehicle = proto.Field(proto.MESSAGE, number=4, message=mf_vehicles.Vehicle)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=5, message=field_mask_pb2.FieldMask)
...
class UpdateVehicleLocationRequest(proto.Message):
    ...
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=1, message=mf_header.RequestHeader)
    name: str = proto.Field(proto.STRING, number=3)
    current_location: fleetengine.VehicleLocation = proto.Field(proto.MESSAGE, number=4, message=fleetengine.VehicleLocation)
    current_state: mf_vehicles.VehicleState = proto.Field(proto.ENUM, number=5, enum=mf_vehicles.VehicleState)
...
class UpdateVehicleAttributesRequest(proto.Message):
    ...
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=1, message=mf_header.RequestHeader)
    name: str = proto.Field(proto.STRING, number=3)
    attributes: MutableSequence[fleetengine.VehicleAttribute] = proto.RepeatedField(proto.MESSAGE, number=4, message=fleetengine.VehicleAttribute)
...
class UpdateVehicleAttributesResponse(proto.Message):
    ...
    """
    attributes: MutableSequence[fleetengine.VehicleAttribute] = proto.RepeatedField(proto.MESSAGE, number=1, message=fleetengine.VehicleAttribute)
...
class SearchVehiclesRequest(proto.Message):
    ...
    class CurrentTripsPresent(proto.Enum):
        """Specifies the types of restrictions on a vehicle's current
        trips.
    ...
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=1, message=mf_header.RequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    pickup_point: fleetengine.TerminalLocation = proto.Field(proto.MESSAGE, number=4, message=fleetengine.TerminalLocation)
    dropoff_point: fleetengine.TerminalLocation = proto.Field(proto.MESSAGE, number=5, message=fleetengine.TerminalLocation)
    pickup_radius_meters: int = proto.Field(proto.INT32, number=6)
    count: int = proto.Field(proto.INT32, number=7)
    minimum_capacity: int = proto.Field(proto.INT32, number=8)
    trip_types: MutableSequence[fleetengine.TripType] = proto.RepeatedField(proto.ENUM, number=9, enum=fleetengine.TripType)
    maximum_staleness: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=10, message=duration_pb2.Duration)
    vehicle_types: MutableSequence[mf_vehicles.Vehicle.VehicleType] = proto.RepeatedField(proto.MESSAGE, number=14, message=mf_vehicles.Vehicle.VehicleType)
    required_attributes: MutableSequence[fleetengine.VehicleAttribute] = proto.RepeatedField(proto.MESSAGE, number=12, message=fleetengine.VehicleAttribute)
    required_one_of_attributes: MutableSequence['VehicleAttributeList'] = proto.RepeatedField(proto.MESSAGE, number=15, message='VehicleAttributeList')
    ...
    order_by: VehicleMatchOrder = proto.Field(proto.ENUM, number=13, enum=VehicleMatchOrder)
    include_back_to_back: bool = proto.Field(proto.BOOL, number=18)
    trip_id: str = proto.Field(proto.STRING, number=19)
    current_trips_present: CurrentTripsPresent = proto.Field(proto.ENUM, number=21, enum=CurrentTripsPresent)
    filter: str = proto.Field(proto.STRING, number=22)
...
class SearchVehiclesResponse(proto.Message):
    ...
    """
    matches: MutableSequence['VehicleMatch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='VehicleMatch')
...
class ListVehiclesRequest(proto.Message):
    ...
    """
    header: mf_header.RequestHeader = proto.Field(proto.MESSAGE, number=12, message=mf_header.RequestHeader)
    ...
    minimum_capacity: wrappers_pb2.Int32Value = proto.Field(proto.MESSAGE, number=6, message=wrappers_pb2.Int32Value)
    trip_types: MutableSequence[fleetengine.TripType] = proto.RepeatedField(proto.ENUM, number=7, enum=fleetengine.TripType)
    maximum_staleness: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=8, message=duration_pb2.Duration)
    vehicle_type_categories: MutableSequence[mf_vehicles.Vehicle.VehicleType.Category] = proto.RepeatedField(proto.ENUM, number=9, enum=mf_vehicles.Vehicle.VehicleType.Category)
    required_attributes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=10)
    required_one_of_attributes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=13)
    required_one_of_attribute_sets: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=15)
    vehicle_state: mf_vehicles.VehicleState = proto.Field(proto.ENUM, number=11, enum=mf_vehicles.VehicleState)
    on_trip_only: bool = proto.Field(proto.BOOL, number=14)
    filter: str = proto.Field(proto.STRING, number=16)
    viewport: ggt_viewport.Viewport = proto.Field(proto.MESSAGE, number=17, message=ggt_viewport.Viewport)
...
class ListVehiclesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    vehicles: MutableSequence[mf_vehicles.Vehicle] = proto.RepeatedField(proto.MESSAGE, number=1, message=mf_vehicles.Vehicle)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    total_size: int = proto.Field(proto.INT64, number=3)
...
class Waypoint(proto.Message):
    ...
    """
    lat_lng: latlng_pb2.LatLng = proto.Field(proto.MESSAGE, number=1, message=latlng_pb2.LatLng)
    eta: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)

class VehicleMatch(proto.Message):
    """Contains the vehicle and related estimates for a vehicle that match
    ...
    class VehicleMatchType(proto.Enum):
        ...
        CARPOOL = 3
        CARPOOL_BACK_TO_BACK = 4
    vehicle: mf_vehicles.Vehicle = proto.Field(proto.MESSAGE, number=1, message=mf_vehicles.Vehicle)
    vehicle_pickup_eta: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    vehicle_pickup_distance_meters: wrappers_pb2.Int32Value = proto.Field(proto.MESSAGE, number=3, message=wrappers_pb2.Int32Value)
    vehicle_pickup_straight_line_distance_meters: wrappers_pb2.Int32Value = proto.Field(proto.MESSAGE, number=11, message=wrappers_pb2.Int32Value)
    vehicle_dropoff_eta: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    vehicle_pickup_to_dropoff_distance_meters: wrappers_pb2.Int32Value = proto.Field(proto.MESSAGE, number=5, message=wrappers_pb2.Int32Value)
    trip_type: fleetengine.TripType = proto.Field(proto.ENUM, number=6, enum=fleetengine.TripType)
    vehicle_trips_waypoints: MutableSequence['Waypoint'] = proto.RepeatedField(proto.MESSAGE, number=7, message='Waypoint')
    vehicle_match_type: VehicleMatchType = proto.Field(proto.ENUM, number=8, enum=VehicleMatchType)
    requested_ordered_by: 'SearchVehiclesRequest.VehicleMatchOrder' = proto.Field(proto.ENUM, number=9, enum='SearchVehiclesRequest.VehicleMatchOrder')
    ordered_by: 'SearchVehiclesRequest.VehicleMatchOrder' = proto.Field(proto.ENUM, number=10, enum='SearchVehiclesRequest.VehicleMatchOrder')
