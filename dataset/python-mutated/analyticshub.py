...
class DataExchange(proto.Message):
    ...
    primary_contact: str = proto.Field(proto.STRING, number=4)
    documentation: str = proto.Field(proto.STRING, number=5)
    listing_count: int = proto.Field(proto.INT32, number=6)
    icon: bytes = proto.Field(proto.BYTES, number=7)
    sharing_environment_config: 'SharingEnvironmentConfig' = proto.Field(proto.MESSAGE, number=8, message='SharingEnvironmentConfig')

class SharingEnvironmentConfig(proto.Message):
    """Sharing environment is a behavior model for sharing data
    ...
    class DefaultExchangeConfig(proto.Message):
        """Default Analytics Hub data exchange, used for secured data
        sharing.
    ...
    class DcrExchangeConfig(proto.Message):
        ...
        """
    default_exchange_config: DefaultExchangeConfig = proto.Field(proto.MESSAGE, number=1, oneof='environment', message=DefaultExchangeConfig)
    dcr_exchange_config: DcrExchangeConfig = proto.Field(proto.MESSAGE, number=2, oneof='environment', message=DcrExchangeConfig)
...
class DataProvider(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    primary_contact: str = proto.Field(proto.STRING, number=2)
...
class DestinationDatasetReference(proto.Message):
    """Contains the reference that identifies a destination bigquery
    dataset.
    ...
    project_id: str = proto.Field(proto.STRING, number=2)
...
class DestinationDataset(proto.Message):
    ...
    """
    dataset_reference: 'DestinationDatasetReference' = proto.Field(proto.MESSAGE, number=1, message='DestinationDatasetReference')
    friendly_name: wrappers_pb2.StringValue = proto.Field(proto.MESSAGE, number=2, message=wrappers_pb2.StringValue)
    description: wrappers_pb2.StringValue = proto.Field(proto.MESSAGE, number=3, message=wrappers_pb2.StringValue)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    location: str = proto.Field(proto.STRING, number=5)

class Listing(proto.Message):
    """A listing is what gets published into a data exchange that a
    ...
    class BigQueryDatasetSource(proto.Message):
        """A reference to a shared dataset. It is an existing BigQuery dataset
    ...
    class RestrictedExportConfig(proto.Message):
        """Restricted export config, used to configure restricted export
        on linked dataset.
        ...
        Attributes:
            ...
            restrict_query_result (bool):
                ...
                table.
        """
        enabled: bool = proto.Field(proto.BOOL, number=3)
        restrict_direct_table_access: bool = proto.Field(proto.BOOL, number=1)
        restrict_query_result: bool = proto.Field(proto.BOOL, number=2)
    bigquery_dataset: BigQueryDatasetSource = proto.Field(proto.MESSAGE, number=6, oneof='source', message=BigQueryDatasetSource)
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    primary_contact: str = proto.Field(proto.STRING, number=4)
    ...
    icon: bytes = proto.Field(proto.BYTES, number=8)
    data_provider: 'DataProvider' = proto.Field(proto.MESSAGE, number=9, message='DataProvider')
    categories: MutableSequence[Category] = proto.RepeatedField(proto.ENUM, number=10, enum=Category)
    publisher: 'Publisher' = proto.Field(proto.MESSAGE, number=11, message='Publisher')
    request_access: str = proto.Field(proto.STRING, number=12)
    restricted_export_config: RestrictedExportConfig = proto.Field(proto.MESSAGE, number=13, message=RestrictedExportConfig)

class Subscription(proto.Message):
    """A subscription represents a subscribers' access to a
    ...
    class LinkedResource(proto.Message):
        ...
        """
        linked_dataset: str = proto.Field(proto.STRING, number=1, oneof='reference')
    listing: str = proto.Field(proto.STRING, number=5, oneof='resource_name')
    data_exchange: str = proto.Field(proto.STRING, number=6, oneof='resource_name')
    name: str = proto.Field(proto.STRING, number=1)
    creation_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    last_modify_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    organization_id: str = proto.Field(proto.STRING, number=4)
    organization_display_name: str = proto.Field(proto.STRING, number=10)
    state: State = proto.Field(proto.ENUM, number=7, enum=State)
    linked_dataset_map: MutableMapping[str, LinkedResource] = proto.MapField(proto.STRING, proto.MESSAGE, number=8, message=LinkedResource)
    subscriber_contact: str = proto.Field(proto.STRING, number=9)
...
class ListDataExchangesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    data_exchanges: MutableSequence['DataExchange'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataExchange')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class ListOrgDataExchangesRequest(proto.Message):
    """Message for requesting the list of data exchanges from
    ...
    Attributes:
        ...
        page_token (str):
            ...
            request the next page of results.
    """
    organization: str = proto.Field(proto.STRING, number=1)
    page_size: int = proto.Field(proto.INT32, number=2)
    page_token: str = proto.Field(proto.STRING, number=3)

class ListOrgDataExchangesResponse(proto.Message):
    """Message for response to listing data exchanges in an
...
class CreateDataExchangeRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    data_exchange_id: str = proto.Field(proto.STRING, number=2)
    data_exchange: 'DataExchange' = proto.Field(proto.MESSAGE, number=3, message='DataExchange')
...
class UpdateDataExchangeRequest(proto.Message):
    ...
    data_exchange: 'DataExchange' = proto.Field(proto.MESSAGE, number=2, message='DataExchange')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    listings: MutableSequence['Listing'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Listing')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateListingRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    listing_id: str = proto.Field(proto.STRING, number=2)
    listing: 'Listing' = proto.Field(proto.MESSAGE, number=3, message='Listing')
...
class UpdateListingRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    listing: 'Listing' = proto.Field(proto.MESSAGE, number=2, message='Listing')
...
class SubscribeListingRequest(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            ``projects/myproject/locations/US/dataExchanges/123/listings/456``.
    """
    destination_dataset: 'DestinationDataset' = proto.Field(proto.MESSAGE, number=3, oneof='destination', message='DestinationDataset')
    name: str = proto.Field(proto.STRING, number=1)
...
class SubscribeDataExchangeRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    destination: str = proto.Field(proto.STRING, number=2)
    subscription: str = proto.Field(proto.STRING, number=4)
    subscriber_contact: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    subscriptions: MutableSequence['Subscription'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Subscription')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListSharedResourceSubscriptionsRequest(proto.Message):
    ...
    include_deleted_subscriptions: bool = proto.Field(proto.BOOL, number=2)
    page_size: int = proto.Field(proto.INT32, number=3)
    page_token: str = proto.Field(proto.STRING, number=4)
...
class ListSharedResourceSubscriptionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    shared_resource_subscriptions: MutableSequence['Subscription'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Subscription')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class OperationMetadata(proto.Message):
    """Represents the metadata of a long-running operation in
    Analytics Hub.
