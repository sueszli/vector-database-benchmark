...
def app():
    ...
    put_text('If 2 datasets have the same statistics, they should be similar right? Not quite so. Two datasets with the same mean, standard deviation, and correlation could be very different.\n\nTo test this idea, choose a starting shape and a target shape. The starting shape will transform into the target shape while keeping the same statistics.')
