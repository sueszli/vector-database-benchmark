...
def main():
    ...
    response = client.communication_services.check_name_availability(name_availability_parameters={'name': 'MyCommunicationService', 'type': 'Microsoft.Communication/CommunicationServices'})
    print(response)
