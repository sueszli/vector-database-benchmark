...
class DataTrainingArguments:
    ...
    max_seq_length: Optional[int] = field(default=72, metadata={'help': 'The maximum total input sequence length after tokenization. Sequences longer than this will be truncated, sequences shorter will be padded.'})
