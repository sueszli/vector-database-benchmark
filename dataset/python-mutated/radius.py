...
class _RadiusAttrHexStringVal(_SpecificRadiusAttr):
    ...
    def __init__(self, _pkt='', post_transform=None, _internal=0, _underlayer=None, **fields):
        ...
        if len(name_parts) < 2:
            raise Scapy_Exception('Invalid class name: {}'.format(self.__class__.__name__))
        self.name = name_parts[1].replace('_', '-')
    fields_desc = [ByteEnumField('type', 24, _radius_attribute_types), FieldLenField('len', None, 'value', 'B', adjust=lambda p, x: len(p.value) + 2), XStrLenField('value', '', length_from=lambda p: p.len - 2 if p.len else 0)]
...
class RadiusAttr_Message_Authenticator(_RadiusAttrHexStringVal):
    """RFC 2869"""
    val = 80
    fields_desc = [ByteEnumField('type', 24, _radius_attribute_types), FieldLenField('len', 18, 'value', 'B'), XStrFixedLenField('value', '\x00' * 16, length=16)]
...
class RadiusAttr_PMIP6_Visited_IPv4_Gateway(_RadiusAttrIPv4AddrVal):
    """RFC 6572"""
    val = 162
_radius_attrs_values = {6: {1: 'Login', 2: 'Framed', 3: 'Callback Login', 4: 'Callback Framed', 5: 'Outbound', 6: 'Administrative', 7: 'NAS Prompt', 8: 'Authenticate Only', 9: 'Callback NAS Prompt', 10: 'Call Check', 11: 'Callback Administrative', 12: 'Voice', 13: 'Fax', 14: 'Modem Relay', 15: 'IAPP-Register', 16: 'IAPP-AP-Check', 17: 'Authorize Only', 18: 'Framed-Management', 19: 'Additional-Authorization'}, 7: {1: 'PPP', 2: 'SLIP', 3: 'AppleTalk Remote Access Protocol (ARAP)', 4: 'Gandalf proprietary SingleLink/MultiLink protocol', 5: 'Xylogics proprietary IPX/SLIP', 6: 'X.75 Synchronous', 7: 'GPRS PDP Context'}, 10: {0: 'None', 1: 'Send routing packets', 2: 'Listen for routing packets', 3: 'Send and Listen'}, 13: {0: 'None', 1: 'VJ TCP/IP header compression', 2: 'IPX header compression', 3: 'Stac-LZS compression'}, 15: {0: 'Telnet', 1: 'Rlogin', 2: 'TCP Clear', 3: 'PortMaster (proprietary)', 4: 'LAT', 5: 'X25-PAD', 6: 'X25-T3POS', 7: 'Unassigned', 8: 'TCP Clear Quiet (suppresses any NAS-generated connect string)'}, 29: {0: 'Default', 1: 'RADIUS-Request'}, 40: {1: 'Start', 2: 'Stop', 3: 'Interim-Update', 4: 'Unassigned', 5: 'Unassigned', 6: 'Unassigned', 7: 'Accounting-On', 8: 'Accounting-Off', 9: 'Tunnel-Start', 10: 'Tunnel-Stop', 11: 'Tunnel-Reject', 12: 'Tunnel-Link-Start', 13: 'Tunnel-Link-Stop', 14: 'Tunnel-Link-Reject', 15: 'Failed'}, 45: {1: 'RADIUS', 2: 'Local', 3: 'Remote', 4: 'Diameter'}, 49: {1: 'User Request', 2: 'Lost Carrier', 3: 'Lost Service', 4: 'Idle Timeout', 5: 'Session Timeout', 6: 'Admin Reset', 7: 'Admin Reboot', 8: 'Port Error', 9: 'NAS Error', 10: 'NAS Request', 11: 'NAS Reboot', 12: 'Port Unneeded', 13: 'Port Preempted', 14: 'Port Suspended', 15: 'Service Unavailable', 16: 'Callback', 17: 'User Error', 18: 'Host Request', 19: 'Supplicant Restart', 20: 'Reauthentication Failure', 21: 'Port Reinitialized', 22: 'Port Administratively Disabled', 23: 'Lost Power'}, 61: {0: 'Async', 1: 'Sync', 2: 'ISDN Sync', 3: 'ISDN Async V.120', 4: 'ISDN Async V.110', 5: 'Virtual', 6: 'PIAFS', 7: 'HDLC Clear Channel', 8: 'X.25', 9: 'X.75', 10: 'G.3 Fax', 11: 'SDSL - Symmetric DSL', 12: 'ADSL-CAP - Asymmetric DSL, Carrierless Amplitude Phase Modulation', 13: 'ADSL-DMT - Asymmetric DSL, Discrete Multi-Tone', 14: 'IDSL - ISDN Digital Subscriber Line', 15: 'Ethernet', 16: 'xDSL - Digital Subscriber Line of unknown type', 17: 'Cable', 18: 'Wireles - Other', 19: 'Wireless - IEEE 802.11', 20: 'Token-Ring', 21: 'FDDI', 22: 'Wireless - CDMA2000', 23: 'Wireless - UMTS', 24: 'Wireless - 1X-EV', 25: 'IAPP', 26: 'FTTP - Fiber to the Premises', 27: 'Wireless - IEEE 802.16', 28: 'Wireless - IEEE 802.20', 29: 'Wireless - IEEE 802.22', 30: 'PPPoA - PPP over ATM', 31: 'PPPoEoA - PPP over Ethernet over ATM', 32: 'PPPoEoE - PPP over Ethernet over Ethernet', 33: 'PPPoEoVLAN - PPP over Ethernet over VLAN', 34: 'PPPoEoQinQ - PPP over Ethernet over IEEE 802.1QinQ', 35: 'xPON - Passive Optical Network', 36: 'Wireless - XGP', 37: 'WiMAX Pre-Release 8 IWK Function', 38: 'WIMAX-WIFI-IWK: WiMAX WIFI Interworking', 39: 'WIMAX-SFF: Signaling Forwarding Function for LTE/3GPP2', 40: 'WIMAX-HA-LMA: WiMAX HA and or LMA function', 41: 'WIMAX-DHCP: WIMAX DHCP service', 42: 'WIMAX-LBS: WiMAX location based service', 43: 'WIMAX-WVS: WiMAX voice service'}, 64: {1: 'Point-to-Point Tunneling Protocol (PPTP)', 2: 'Layer Two Forwarding (L2F)', 3: 'Layer Two Tunneling Protocol (L2TP)', 4: 'Ascend Tunnel Management Protocol (ATMP)', 5: 'Virtual Tunneling Protocol (VTP)', 6: 'IP Authentication Header in the Tunnel-mode (AH)', 7: 'IP-in-IP Encapsulation (IP-IP)', 8: 'Minimal IP-in-IP Encapsulation (MIN-IP-IP)', 9: 'IP Encapsulating Security Payload in the Tunnel-mode (ESP)', 10: 'Generic Route Encapsulation (GRE)', 11: 'Bay Dial Virtual Services (DVS)', 12: 'IP-in-IP Tunneling', 13: 'Virtual LANs (VLAN)'}, 65: {1: 'IPv4 (IP version 4)', 2: 'IPv6 (IP version 6)', 3: 'NSAP', 4: 'HDLC (8-bit multidrop)', 5: 'BBN 1822', 6: '802', 7: 'E.163 (POTS)', 8: 'E.164 (SMDS, Frame Relay, ATM)', 9: 'F.69 (Telex)', 10: 'X.121 (X.25, Frame Relay)', 11: 'IPX', 12: 'Appletalk', 13: 'Decnet IV', 14: 'Banyan Vine', 15: 'E.164 with NSAP format subaddress'}, 72: {1: 'Only allow access to default zone', 2: 'Use zone filter inclusively', 3: 'Not used', 4: 'Use zone filter exclusively'}, 76: {0: 'No Echo', 1: 'Echo'}, 101: {201: 'Residual Session Context Removed', 202: 'Invalid EAP Packet (Ignored)', 401: 'Unsupported Attribute', 402: 'Missing Attribute', 403: 'NAS Identification Mismatch', 404: 'Invalid Request', 405: 'Unsupported Service', 406: 'Unsupported Extension', 407: 'Invalid Attribute Value', 501: 'Administratively Prohibited', 502: 'Request Not Routable (Proxy)', 503: 'Session Context Not Found', 504: 'Session Context Not Removable', 505: 'Other Proxy Processing Error', 506: 'Resources Unavailable', 507: 'Request Initiated', 508: 'Multiple Session Selection Unsupported', 509: 'Location-Info-Required', 601: 'Response Too Big'}, 126: {48: 'TADIG', 49: 'REALM', 50: 'E212', 51: 'ICC', 255: 'Reserved'}, 129: {0: 'Retransmission allowed'}, 131: {1: 'CIVIC_LOCATION', 2: 'GEO_LOCATION', 4: 'USERS_LOCATION', 8: 'NAS_LOCATION'}, 133: {1: 'SNMP', 2: 'Web-based', 3: 'NETCONF', 4: 'FTP', 5: 'TFTP', 6: 'SFTP', 7: 'RCP', 8: 'SCP'}, 134: {1: 'No-Protection', 2: 'Integrity-Protection', 3: 'Integrity-Confidentiality-Protection'}}
...
class Radius(Packet):
    ...
    """
    name = 'RADIUS'
    fields_desc = [ByteEnumField('code', 1, _packet_codes), ByteField('id', 0), FieldLenField('len', None, 'attributes', 'H', adjust=lambda pkt, x: len(pkt.attributes) + 20), XStrFixedLenField('authenticator', '', 16), PacketListField('attributes', [], RadiusAttribute, length_from=lambda pkt: pkt.len - 20)]
