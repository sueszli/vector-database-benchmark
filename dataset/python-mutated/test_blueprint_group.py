...
async def test_multiple_nested_bp_group():
    ...
    await app._startup()
    routes = [route.path for route in app.router.routes]
    assert routes == ['group-a/bp1', 'group-a/bp2', 'group-b/bp1', 'group-b/bp2']
    names = [route.name for route in app.router.routes]
    assert names == ['PropTest.group-a_bp1.route1', 'PropTest.group-a_bp2.route2', 'PropTest.group-b_bp1.route1', 'PropTest.group-b_bp2.route2']