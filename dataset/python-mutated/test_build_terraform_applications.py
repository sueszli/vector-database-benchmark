...
class TestBuildTerraformApplicationsWithZipBasedLambdaFunctionAndLocalBackendWithOverride(BuildTerraformApplicationIntegBase):
    function_identifier = 'function9'
    override = True
    terraform_application = Path('terraform/zip_based_lambda_functions_local_backend') if not IS_WINDOWS else Path('terraform/zip_based_lambda_functions_local_backend_windows')
...
class TestBuildTerraformApplicationsWithZipBasedLambdaFunctionAndS3BackendWithOverride(BuildTerraformApplicationS3BackendIntegBase):
    function_identifier = 'function9'
    override = True
    s3_backend = True
...
@skipIf(not RUN_BY_CANARY and (not CI_OVERRIDE), 'Skip Terraform test cases unless running in CI')
class TestBuildTerraformApplicationsWithImageBasedLambdaFunctionAndS3Backend(BuildTerraformApplicationS3BackendIntegBase):
    function_identifier = 'aws_lambda_function.function_with_non_image_uri'
    s3_backend = True
