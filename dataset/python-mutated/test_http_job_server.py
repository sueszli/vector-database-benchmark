...
import yaml
import ray
from ray._private.test_utils import chdir, format_web_url, wait_for_condition, wait_until_server_available
...
async def test_job_head_choose_job_agent():
    with set_env_var('CANDIDATE_AGENT_NUMBER', '2'):
        ...
        agent_1 = ('node1', dict(ipAddress='1.1.1.1', httpPort=1, grpcPort=1, httpAddress='1.1.1.1:1'))
        agent_2 = ('node2', dict(ipAddress='2.2.2.2', httpPort=2, grpcPort=2, httpAddress='2.2.2.2:2'))
        agent_3 = ('node3', dict(ipAddress='3.3.3.3', httpPort=3, grpcPort=3, httpAddress='3.3.3.3:3'))
        add_agent(agent_1)
