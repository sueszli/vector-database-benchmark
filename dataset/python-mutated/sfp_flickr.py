...
class sfp_flickr(SpiderFootPlugin):
    ...
    opts = {'pause': 1, 'per_page': 100, 'maxpages': 20, 'dns_resolve': True}
    optdescs = {'pause': 'Number of seconds to pause between fetches.', 'per_page': 'Maximum number of results per page.', 'maxpages': 'Maximum number of pages of results to fetch.', 'dns_resolve': 'DNS resolve each identified domain.'}
    results = None
