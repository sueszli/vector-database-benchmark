...
from awx.main.models import Credential, Group, Host, Instance, InstanceGroup, Inventory, InventorySource, JobTemplate, NotificationTemplate, Organization, Project, User, WorkflowJobTemplate
