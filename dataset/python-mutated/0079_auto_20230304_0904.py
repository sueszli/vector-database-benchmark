...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(update_purchase_order_price, reverse_code=migrations.RunPython.noop), migrations.RunPython(update_sales_order_price, reverse_code=migrations.RunPython.noop)]