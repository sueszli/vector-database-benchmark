...
def build_list_request(location: str, instance_id: str, subscription_id: str, *, restorable_gremlin_database_rid: Optional[str]=None, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        return 10
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGraphs')
    ...
    if restorable_gremlin_database_rid is not None:
        _params['restorableGremlinDatabaseRid'] = _SERIALIZER.query('restorable_gremlin_database_rid', restorable_gremlin_database_rid, 'str')
...
class RestorableGremlinGraphsOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, restorable_gremlin_database_rid: Optional[str]=None, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableGremlinGraphGetResult']:
        if False:
            for i in range(10):
                print('nop')
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGraphs'}