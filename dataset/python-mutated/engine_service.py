...
class CreateEngineRequest(proto.Message):
    ...
    engine: gcd_engine.Engine = proto.Field(proto.MESSAGE, number=2, message=gcd_engine.Engine)
    engine_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    engines: MutableSequence[gcd_engine.Engine] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_engine.Engine)
...
class UpdateEngineRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            INVALID_ARGUMENT error is returned.
    """
    engine: gcd_engine.Engine = proto.Field(proto.MESSAGE, number=1, message=gcd_engine.Engine)
...
class TuneEngineRequest(proto.Message):
    """Request to manually start a tuning process now (instead of
...
class TuneEngineMetadata(proto.Message):
    ...
    Attributes:
        engine (str):
            ...
            ``projects/{project_number}/locations/{location_id}/collections/{collection_id}/engines/{engine_id}``
    """
    engine: str = proto.Field(proto.STRING, number=1)
