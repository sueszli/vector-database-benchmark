...
PERMISSIONS_TESTS_PARAMS = [('/resetpassword/form?pk={user.id}', (permissions.ACTION_CAN_READ, permissions.RESOURCE_PASSWORD), 'Reset Password Form'), ('/resetmypassword/form', (permissions.ACTION_CAN_READ, permissions.RESOURCE_MY_PASSWORD), 'Reset Password Form'), ('/users/userinfo/', (permissions.ACTION_CAN_READ, permissions.RESOURCE_MY_PROFILE), 'Your user information'), ('/userinfoeditview/form', (permissions.ACTION_CAN_EDIT, permissions.RESOURCE_MY_PROFILE), 'Edit User'), ('/users/add', (permissions.ACTION_CAN_CREATE, permissions.RESOURCE_USER), 'Add User'), ('/users/list/', (permissions.ACTION_CAN_READ, permissions.RESOURCE_USER), 'List Users'), ('/users/show/{user.id}', (permissions.ACTION_CAN_READ, permissions.RESOURCE_USER), 'Show User'), ('/users/edit/{user.id}', (permissions.ACTION_CAN_EDIT, permissions.RESOURCE_USER), 'Edit User')]
