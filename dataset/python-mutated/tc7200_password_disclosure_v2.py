...
class Exploit(HTTPClient):
    __info__ = {'name': 'Technicolor TC7200 Password Disclosure V2', 'description': "Module exploits Technicolor TC7200 password disclosure vulnerability which allows fetching administration's password.", 'authors': ('Gergely Eberhardt (@ebux25) from SEARCH-LAB Ltd. (www.search-lab.hu)', '0BuRner', 'Bastian Germann'), 'references': ('https://www.exploit-db.com/exploits/40157/', 'http://www.search-lab.hu/advisories/secadv-20160720'), 'devices': ('Technicolor TC7200',)}
