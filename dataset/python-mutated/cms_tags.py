...
class PageUrl(AsTag):
    name = 'page_url'
    options = Options(Argument('page_lookup'), Argument('lang', required=False, default=None), Argument('site', required=False, default=None), 'as', Argument('varname', required=False, resolve=False))
...
class Placeholder(Tag):
    ...
    """
    name = 'placeholder'
    options = PlaceholderOptions(Argument('name', resolve=False), MultiValueArgument('extra_bits', required=False, resolve=False), blocks=[('endplaceholder', 'nodelist')])
...
class RenderPluginBlock(InclusionTag):
    ...
    options = Options(Argument('plugin'), blocks=[('endrender_plugin_block', 'nodelist')])
...
class PageAttribute(AsTag):
    ...
    """
    name = 'page_attribute'
    options = Options(Argument('name', resolve=False), Argument('page_lookup', required=False, default=None), 'as', Argument('varname', required=False, resolve=False))
    valid_attributes = ['title', 'slug', 'meta_description', 'page_title', 'menu_title', 'changed_date', 'changed_by']
...
class CMSToolbar(RenderBlock):
    name = 'cms_toolbar'
    options = Options(Argument('name', required=False), parser_class=SekizaiParser)
...
class CMSEditableObject(InclusionTag):
    ...
    name = 'render_model'
    options = Options(Argument('instance'), Argument('attribute'), Argument('edit_fields', default=None, required=False), Argument('language', default=None, required=False), Argument('filters', default=None, required=False), Argument('view_url', default=None, required=False), Argument('view_method', default=None, required=False), 'as', Argument('varname', required=False, resolve=False))
...
class CMSEditableObjectIcon(CMSEditableObject):
    ...
    options = Options(Argument('instance'), Argument('edit_fields', default=None, required=False), Argument('language', default=None, required=False), Argument('view_url', default=None, required=False), Argument('view_method', default=None, required=False), 'as', Argument('varname', required=False, resolve=False))
...
class CMSEditableObjectAdd(CMSEditableObject):
    ...
    options = Options(Argument('instance'), Argument('language', default=None, required=False), Argument('view_url', default=None, required=False), Argument('view_method', default=None, required=False), 'as', Argument('varname', required=False, resolve=False))
...
class CMSEditableObjectAddBlock(CMSEditableObject):
    ...
    options = Options(Argument('instance'), Argument('language', default=None, required=False), Argument('view_url', default=None, required=False), Argument('view_method', default=None, required=False), 'as', Argument('varname', required=False, resolve=False), blocks=[('endrender_model_add_block', 'nodelist')])
...
class CMSEditableObjectBlock(CMSEditableObject):
    ...
    options = Options(Argument('instance'), Argument('edit_fields', default=None, required=False), Argument('language', default=None, required=False), Argument('view_url', default=None, required=False), Argument('view_method', default=None, required=False), 'as', Argument('varname', required=False, resolve=False), blocks=[('endrender_model_block', 'nodelist')])
...
class StaticPlaceholderNode(Tag):
    ...
    options = PlaceholderOptions(Argument('code', required=True), MultiValueArgument('extra_bits', required=False, resolve=False), blocks=[('endstatic_placeholder', 'nodelist')])
...
class RenderPlaceholder(AsTag):
    ...
    options = Options(Argument('placeholder'), Argument('width', default=None, required=False), 'language', Argument('language', default=None, required=False), 'as', Argument('varname', required=False, resolve=False))
...
class CMSAdminURL(AsTag):
    name = 'cms_admin_url'
    options = Options(Argument('viewname'), MultiValueArgumentBeforeKeywordArgument('args', required=False), MultiKeywordArgument('kwargs', required=False), 'as', Argument('varname', resolve=False, required=False))
...
register.simple_tag(_show_placeholder_by_id, takes_context=True, name='show_placeholder')
register.simple_tag(_show_placeholder_by_id, takes_context=True, name='show_placeholder_by_id')
register.simple_tag(_show_uncached_placeholder_by_id, takes_context=True, name='show_uncached_placeholder')
register.simple_tag(_show_uncached_placeholder_by_id, takes_context=True, name='show_uncached_placeholder_by_id')
