...
def prepare_voucher(e2e_staff_api_client, channel_id, voucher_code, voucher_discount_type, voucher_discount_value, voucher_type, end_date):
    if False:
        while True:
            i = 10
    input = {'code': voucher_code, 'discountValueType': voucher_discount_type, 'type': voucher_type, 'usageLimit': 1, 'singleUse': True, 'startDate': '2023-10-01T18:26:00+02:00', 'endDate': end_date}
...
@pytest.mark.e2e
def test_checkout_unable_to_use_expired_voucher_CORE_0921(e2e_logged_api_client, e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_checkouts):
    if False:
        return 10
    ...
    (voucher_code, voucher_id) = prepare_voucher(e2e_staff_api_client, channel_id, voucher_code='fixed_voucher', voucher_discount_type='FIXED', voucher_discount_value=15, voucher_type='ENTIRE_ORDER', end_date=date_in_the_past)
