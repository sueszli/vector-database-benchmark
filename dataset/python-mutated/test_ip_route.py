...
class MyTests(unittest.TestCase):
    with open(os.path.join(THIS_DIR, os.pardir, 'tests/fixtures/ubuntu-18.04/ip_route.out'), 'r', encoding='utf-8') as f:
    ...
    with open(os.path.join(THIS_DIR, os.pardir, 'tests/fixtures/ubuntu-18.04/ip_route.json'), 'r', encoding='utf-8') as f:
    ...
    def test_ip_route_ubuntu_18_4(self):
        ...
        self.assertEqual(jc.parsers.ip_route.parse(self.ubuntu_18_4_ip_route, quiet=True), self.ubuntu_18_4_ip_route_json)
