...
class TFMarianModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'conversational': TFMarianMTModel, 'feature-extraction': TFMarianModel, 'summarization': TFMarianMTModel, 'text2text-generation': TFMarianMTModel, 'translation': TFMarianMTModel} if is_tf_available() else {}
...
class AbstractMarianIntegrationTest(unittest.TestCase):
    ...
    def translate_src_text(self, **tokenizer_kwargs):
        ...
        generated_ids = self.model.generate(model_inputs.input_ids, attention_mask=model_inputs.attention_mask, num_beams=2, max_length=128)
