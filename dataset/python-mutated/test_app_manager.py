...
from golem.apps import AppDefinition, load_app_from_json_file, load_apps_from_dir
from golem.testutils import TempDirFixture, DatabaseFixture
ROOT_PATH = 'golem.apps.manager'
APP_DEF = AppDefinition(name='test_app', requestor_env='test_env', requestor_prereq={'key1': 'value', 'key2': [1, 2, 3]}, max_benchmark_score=1.0)
APP_ID = APP_DEF.id
