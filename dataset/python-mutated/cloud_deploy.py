...
import proto
__protobuf__ = proto.module(package='google.cloud.deploy.v1', manifest={'SkaffoldSupportState', 'BackoffMode', 'RepairState', 'DeliveryPipeline', 'SerialPipeline', 'Stage', 'DeployParameters', 'Strategy', 'Predeploy', 'Postdeploy', 'Standard', 'Canary', 'CanaryDeployment', 'CustomCanaryDeployment', 'KubernetesConfig', 'CloudRunConfig', 'RuntimeConfig', 'PipelineReadyCondition', 'TargetsPresentCondition', 'TargetsTypeCondition', 'PipelineCondition', 'ListDeliveryPipelinesRequest', 'ListDeliveryPipelinesResponse', 'GetDeliveryPipelineRequest', 'CreateDeliveryPipelineRequest', 'UpdateDeliveryPipelineRequest', 'DeleteDeliveryPipelineRequest', 'RollbackTargetConfig', 'RollbackTargetRequest', 'RollbackTargetResponse', 'Target', 'ExecutionConfig', 'DefaultPool', 'PrivatePool', 'GkeCluster', 'AnthosCluster', 'CloudRunLocation', 'MultiTarget', 'ListTargetsRequest', 'ListTargetsResponse', 'GetTargetRequest', 'CreateTargetRequest', 'UpdateTargetRequest', 'DeleteTargetRequest', 'TargetAttribute', 'Release', 'BuildArtifact', 'TargetArtifact', 'DeployArtifact', 'CloudRunRenderMetadata', 'RenderMetadata', 'ListReleasesRequest', 'ListReleasesResponse', 'GetReleaseRequest', 'CreateReleaseRequest', 'Rollout', 'Metadata', 'DeployJobRunMetadata', 'CloudRunMetadata', 'AutomationRolloutMetadata', 'Phase', 'DeploymentJobs', 'ChildRolloutJobs', 'Job', 'DeployJob', 'VerifyJob', 'PredeployJob', 'PostdeployJob', 'CreateChildRolloutJob', 'AdvanceChildRolloutJob', 'ListRolloutsRequest', 'ListRolloutsResponse', 'GetRolloutRequest', 'CreateRolloutRequest', 'OperationMetadata', 'ApproveRolloutRequest', 'ApproveRolloutResponse', 'AdvanceRolloutRequest', 'AdvanceRolloutResponse', 'CancelRolloutRequest', 'CancelRolloutResponse', 'IgnoreJobRequest', 'IgnoreJobResponse', 'RetryJobRequest', 'RetryJobResponse', 'AbandonReleaseRequest', 'AbandonReleaseResponse', 'JobRun', 'DeployJobRun', 'VerifyJobRun', 'PredeployJobRun', 'PostdeployJobRun', 'CreateChildRolloutJobRun', 'AdvanceChildRolloutJobRun', 'ListJobRunsRequest', 'ListJobRunsResponse', 'GetJobRunRequest', 'TerminateJobRunRequest', 'TerminateJobRunResponse', 'Config', 'SkaffoldVersion', 'GetConfigRequest', 'Automation', 'AutomationResourceSelector', 'AutomationRule', 'PromoteReleaseRule', 'AdvanceRolloutRule', 'RepairRolloutRule', 'RepairMode', 'Retry', 'Rollback', 'AutomationRuleCondition', 'CreateAutomationRequest', 'UpdateAutomationRequest', 'DeleteAutomationRequest', 'ListAutomationsRequest', 'ListAutomationsResponse', 'GetAutomationRequest', 'AutomationRun', 'PromoteReleaseOperation', 'AdvanceRolloutOperation', 'RepairRolloutOperation', 'RepairPhase', 'RetryPhase', 'RetryAttempt', 'RollbackAttempt', 'ListAutomationRunsRequest', 'ListAutomationRunsResponse', 'GetAutomationRunRequest', 'CancelAutomationRunRequest', 'CancelAutomationRunResponse'})
...
class DeliveryPipeline(proto.Message):
    ...
    uid: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    serial_pipeline: 'SerialPipeline' = proto.Field(proto.MESSAGE, number=8, oneof='pipeline', message='SerialPipeline')
    condition: 'PipelineCondition' = proto.Field(proto.MESSAGE, number=11, message='PipelineCondition')
    etag: str = proto.Field(proto.STRING, number=10)
    suspended: bool = proto.Field(proto.BOOL, number=12)
...
class SerialPipeline(proto.Message):
    ...
    """
    stages: MutableSequence['Stage'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Stage')
...
class Stage(proto.Message):
    ...
    """
    target_id: str = proto.Field(proto.STRING, number=1)
    profiles: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    strategy: 'Strategy' = proto.Field(proto.MESSAGE, number=5, message='Strategy')
    deploy_parameters: MutableSequence['DeployParameters'] = proto.RepeatedField(proto.MESSAGE, number=6, message='DeployParameters')
...
class DeployParameters(proto.Message):
    ...
    """
    values: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
    match_target_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
...
class Strategy(proto.Message):
    ...
    Attributes:
        ...
        canary (google.cloud.deploy_v1.types.Canary):
            ...
            This field is a member of `oneof`_ ``deployment_strategy``.
    """
    standard: 'Standard' = proto.Field(proto.MESSAGE, number=1, oneof='deployment_strategy', message='Standard')
    canary: 'Canary' = proto.Field(proto.MESSAGE, number=2, oneof='deployment_strategy', message='Canary')
...
class Predeploy(proto.Message):
    ...
    Attributes:
        actions (MutableSequence[str]):
            ...
            predeploy job.
    """
    actions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class Standard(proto.Message):
    ...
    Attributes:
        ...
        postdeploy (google.cloud.deploy_v1.types.Postdeploy):
            ...
            will not be present.
    """
    verify: bool = proto.Field(proto.BOOL, number=1)
    predeploy: 'Predeploy' = proto.Field(proto.MESSAGE, number=2, message='Predeploy')
    postdeploy: 'Postdeploy' = proto.Field(proto.MESSAGE, number=3, message='Postdeploy')
...
class Canary(proto.Message):
    ...
    Attributes:
        ...
        custom_canary_deployment (google.cloud.deploy_v1.types.CustomCanaryDeployment):
            ...
            This field is a member of `oneof`_ ``mode``.
    """
    runtime_config: 'RuntimeConfig' = proto.Field(proto.MESSAGE, number=1, message='RuntimeConfig')
    canary_deployment: 'CanaryDeployment' = proto.Field(proto.MESSAGE, number=2, oneof='mode', message='CanaryDeployment')
    custom_canary_deployment: 'CustomCanaryDeployment' = proto.Field(proto.MESSAGE, number=3, oneof='mode', message='CustomCanaryDeployment')
...
class CanaryDeployment(proto.Message):
    ...
    Attributes:
        ...
        postdeploy (google.cloud.deploy_v1.types.Postdeploy):
            ...
            this phase.
    """
    percentages: MutableSequence[int] = proto.RepeatedField(proto.INT32, number=1)
    verify: bool = proto.Field(proto.BOOL, number=2)
    predeploy: 'Predeploy' = proto.Field(proto.MESSAGE, number=3, message='Predeploy')
    postdeploy: 'Postdeploy' = proto.Field(proto.MESSAGE, number=4, message='Postdeploy')
...
class CustomCanaryDeployment(proto.Message):
    ...
    class PhaseConfig(proto.Message):
        """PhaseConfig represents the configuration for a phase in the
        ...
        """
        phase_id: str = proto.Field(proto.STRING, number=1)
        percentage: int = proto.Field(proto.INT32, number=2)
        profiles: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
        verify: bool = proto.Field(proto.BOOL, number=4)
        predeploy: 'Predeploy' = proto.Field(proto.MESSAGE, number=5, message='Predeploy')
        postdeploy: 'Postdeploy' = proto.Field(proto.MESSAGE, number=6, message='Postdeploy')
    phase_configs: MutableSequence[PhaseConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=PhaseConfig)
    ...
    class GatewayServiceMesh(proto.Message):
        ...
        Attributes:
            ...
            route_update_wait_time (google.protobuf.duration_pb2.Duration):
                ...
                is no wait time.
        """
        http_route: str = proto.Field(proto.STRING, number=1)
        service: str = proto.Field(proto.STRING, number=2)
        deployment: str = proto.Field(proto.STRING, number=3)
        route_update_wait_time: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=4, message=duration_pb2.Duration)
    ...
    class ServiceNetworking(proto.Message):
        ...
        Attributes:
            ...
            disable_pod_overprovisioning (bool):
                ...
                cluster.
        """
        service: str = proto.Field(proto.STRING, number=1)
        deployment: str = proto.Field(proto.STRING, number=2)
        disable_pod_overprovisioning: bool = proto.Field(proto.BOOL, number=3)
    gateway_service_mesh: GatewayServiceMesh = proto.Field(proto.MESSAGE, number=1, oneof='service_definition', message=GatewayServiceMesh)
    service_networking: ServiceNetworking = proto.Field(proto.MESSAGE, number=2, oneof='service_definition', message=ServiceNetworking)
...
class CloudRunConfig(proto.Message):
    ...
    """
    automatic_traffic_control: bool = proto.Field(proto.BOOL, number=1)
...
class RuntimeConfig(proto.Message):
    ...
    Attributes:
        ...
        cloud_run (google.cloud.deploy_v1.types.CloudRunConfig):
            ...
            This field is a member of `oneof`_ ``runtime_config``.
    """
    kubernetes: 'KubernetesConfig' = proto.Field(proto.MESSAGE, number=1, oneof='runtime_config', message='KubernetesConfig')
    cloud_run: 'CloudRunConfig' = proto.Field(proto.MESSAGE, number=2, oneof='runtime_config', message='CloudRunConfig')
...
class PipelineReadyCondition(proto.Message):
    ...
    """
    status: bool = proto.Field(proto.BOOL, number=3)
...
class TargetsPresentCondition(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            Last time the condition was updated.
    """
    status: bool = proto.Field(proto.BOOL, number=1)
    missing_targets: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
...
class TargetsTypeCondition(proto.Message):
    ...
    """
    status: bool = proto.Field(proto.BOOL, number=1)
    error_details: str = proto.Field(proto.STRING, number=2)
...
class PipelineCondition(proto.Message):
    ...
    """
    pipeline_ready_condition: 'PipelineReadyCondition' = proto.Field(proto.MESSAGE, number=1, message='PipelineReadyCondition')
    targets_present_condition: 'TargetsPresentCondition' = proto.Field(proto.MESSAGE, number=3, message='TargetsPresentCondition')
    targets_type_condition: 'TargetsTypeCondition' = proto.Field(proto.MESSAGE, number=4, message='TargetsTypeCondition')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    delivery_pipelines: MutableSequence['DeliveryPipeline'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DeliveryPipeline')
...
class CreateDeliveryPipelineRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    delivery_pipeline_id: str = proto.Field(proto.STRING, number=2)
    delivery_pipeline: 'DeliveryPipeline' = proto.Field(proto.MESSAGE, number=3, message='DeliveryPipeline')
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
...
class UpdateDeliveryPipelineRequest(proto.Message):
    ...
    delivery_pipeline: 'DeliveryPipeline' = proto.Field(proto.MESSAGE, number=2, message='DeliveryPipeline')
...
class DeleteDeliveryPipelineRequest(proto.Message):
    ...
    validate_only: bool = proto.Field(proto.BOOL, number=4)
    force: bool = proto.Field(proto.BOOL, number=6)
    etag: str = proto.Field(proto.STRING, number=5)
...
class RollbackTargetConfig(proto.Message):
    ...
    """
    rollout: 'Rollout' = proto.Field(proto.MESSAGE, number=1, message='Rollout')
    starting_phase_id: str = proto.Field(proto.STRING, number=2)
...
class RollbackTargetRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    target_id: str = proto.Field(proto.STRING, number=2)
    rollout_id: str = proto.Field(proto.STRING, number=3)
    release_id: str = proto.Field(proto.STRING, number=4)
    rollout_to_roll_back: str = proto.Field(proto.STRING, number=5)
    rollback_config: 'RollbackTargetConfig' = proto.Field(proto.MESSAGE, number=6, message='RollbackTargetConfig')
    validate_only: bool = proto.Field(proto.BOOL, number=7)
...
class RollbackTargetResponse(proto.Message):
    ...
    Attributes:
        rollback_config (google.cloud.deploy_v1.types.RollbackTargetConfig):
            ...
            created.
    """
    rollback_config: 'RollbackTargetConfig' = proto.Field(proto.MESSAGE, number=1, message='RollbackTargetConfig')
...
class Target(proto.Message):
    ...
    name: str = proto.Field(proto.STRING, number=1)
    target_id: str = proto.Field(proto.STRING, number=2)
    uid: str = proto.Field(proto.STRING, number=3)
    description: str = proto.Field(proto.STRING, number=4)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
    require_approval: bool = proto.Field(proto.BOOL, number=13)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    gke: 'GkeCluster' = proto.Field(proto.MESSAGE, number=15, oneof='deployment_target', message='GkeCluster')
    anthos_cluster: 'AnthosCluster' = proto.Field(proto.MESSAGE, number=17, oneof='deployment_target', message='AnthosCluster')
    run: 'CloudRunLocation' = proto.Field(proto.MESSAGE, number=18, oneof='deployment_target', message='CloudRunLocation')
    multi_target: 'MultiTarget' = proto.Field(proto.MESSAGE, number=19, oneof='deployment_target', message='MultiTarget')
    etag: str = proto.Field(proto.STRING, number=12)
    execution_configs: MutableSequence['ExecutionConfig'] = proto.RepeatedField(proto.MESSAGE, number=16, message='ExecutionConfig')
    deploy_parameters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=20)
...
class ExecutionConfig(proto.Message):
    ...
    class ExecutionEnvironmentUsage(proto.Enum):
        ...
        PREDEPLOY = 4
        POSTDEPLOY = 5
    usages: MutableSequence[ExecutionEnvironmentUsage] = proto.RepeatedField(proto.ENUM, number=1, enum=ExecutionEnvironmentUsage)
    default_pool: 'DefaultPool' = proto.Field(proto.MESSAGE, number=2, oneof='execution_environment', message='DefaultPool')
    private_pool: 'PrivatePool' = proto.Field(proto.MESSAGE, number=3, oneof='execution_environment', message='PrivatePool')
    worker_pool: str = proto.Field(proto.STRING, number=4)
    service_account: str = proto.Field(proto.STRING, number=5)
    artifact_storage: str = proto.Field(proto.STRING, number=6)
    execution_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=7, message=duration_pb2.Duration)
...
class DefaultPool(proto.Message):
    ...
    Attributes:
        ...
        artifact_storage (str):
            ...
            same region will be used.
    """
    service_account: str = proto.Field(proto.STRING, number=1)
    artifact_storage: str = proto.Field(proto.STRING, number=2)
...
class PrivatePool(proto.Message):
    ...
    Attributes:
        ...
        artifact_storage (str):
            ...
            same region will be used.
    """
    worker_pool: str = proto.Field(proto.STRING, number=1)
    service_account: str = proto.Field(proto.STRING, number=2)
    artifact_storage: str = proto.Field(proto.STRING, number=3)
...
class GkeCluster(proto.Message):
    ...
    """
    cluster: str = proto.Field(proto.STRING, number=1)
    internal_ip: bool = proto.Field(proto.BOOL, number=2)
...
class AnthosCluster(proto.Message):
    ...
    """
    membership: str = proto.Field(proto.STRING, number=1)
...
class MultiTarget(proto.Message):
    ...
    """
    target_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
...
class ListTargetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    targets: MutableSequence['Target'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Target')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateTargetRequest(proto.Message):
    ...
    parent: str = proto.Field(proto.STRING, number=1)
    target_id: str = proto.Field(proto.STRING, number=2)
    target: 'Target' = proto.Field(proto.MESSAGE, number=3, message='Target')
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
...
class UpdateTargetRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    target: 'Target' = proto.Field(proto.MESSAGE, number=2, message='Target')
    request_id: str = proto.Field(proto.STRING, number=3)
    allow_missing: bool = proto.Field(proto.BOOL, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
...
class TargetAttribute(proto.Message):
    """Contains criteria for selecting Targets. Attributes provided
    ...
    Attributes:
        ...
        labels (MutableMapping[str, str]):
            Target labels.
    """
    id: str = proto.Field(proto.STRING, number=1)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
...
class Release(proto.Message):
    ...
    class TargetRender(proto.Message):
        ...
        class FailureCause(proto.Enum):
            ...
            VERIFICATION_CONFIG_NOT_FOUND = 4
            CUSTOM_ACTION_NOT_FOUND = 5
        rendering_build: str = proto.Field(proto.STRING, number=1)
        rendering_state: 'Release.TargetRender.TargetRenderState' = proto.Field(proto.ENUM, number=2, enum='Release.TargetRender.TargetRenderState')
        metadata: 'RenderMetadata' = proto.Field(proto.MESSAGE, number=6, message='RenderMetadata')
        failure_cause: 'Release.TargetRender.FailureCause' = proto.Field(proto.ENUM, number=4, enum='Release.TargetRender.FailureCause')
        failure_message: str = proto.Field(proto.STRING, number=5)

    class ReleaseReadyCondition(proto.Message):
        """ReleaseReadyCondition contains information around the status
    ...
    class SkaffoldSupportedCondition(proto.Message):
        """SkaffoldSupportedCondition contains information about when
        ...
        """
        status: bool = proto.Field(proto.BOOL, number=1)
        skaffold_support_state: 'SkaffoldSupportState' = proto.Field(proto.ENUM, number=2, enum='SkaffoldSupportState')
        maintenance_mode_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
        support_expiration_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)

    class ReleaseCondition(proto.Message):
        """ReleaseCondition contains all conditions relevant to a
        Release.
        ...
        """
        release_ready_condition: 'Release.ReleaseReadyCondition' = proto.Field(proto.MESSAGE, number=1, message='Release.ReleaseReadyCondition')
        skaffold_supported_condition: 'Release.SkaffoldSupportedCondition' = proto.Field(proto.MESSAGE, number=2, message='Release.SkaffoldSupportedCondition')
    name: str = proto.Field(proto.STRING, number=1)
    uid: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    abandoned: bool = proto.Field(proto.BOOL, number=23)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    render_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    render_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    skaffold_config_uri: str = proto.Field(proto.STRING, number=17)
    skaffold_config_path: str = proto.Field(proto.STRING, number=9)
    build_artifacts: MutableSequence['BuildArtifact'] = proto.RepeatedField(proto.MESSAGE, number=10, message='BuildArtifact')
    delivery_pipeline_snapshot: 'DeliveryPipeline' = proto.Field(proto.MESSAGE, number=11, message='DeliveryPipeline')
    target_snapshots: MutableSequence['Target'] = proto.RepeatedField(proto.MESSAGE, number=12, message='Target')
    render_state: RenderState = proto.Field(proto.ENUM, number=13, enum=RenderState)
    etag: str = proto.Field(proto.STRING, number=16)
    skaffold_version: str = proto.Field(proto.STRING, number=19)
    target_artifacts: MutableMapping[str, 'TargetArtifact'] = proto.MapField(proto.STRING, proto.MESSAGE, number=20, message='TargetArtifact')
    target_renders: MutableMapping[str, TargetRender] = proto.MapField(proto.STRING, proto.MESSAGE, number=22, message=TargetRender)
    condition: ReleaseCondition = proto.Field(proto.MESSAGE, number=24, message=ReleaseCondition)
    deploy_parameters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=25)
...
class BuildArtifact(proto.Message):
    ...
    """
    image: str = proto.Field(proto.STRING, number=3)
    tag: str = proto.Field(proto.STRING, number=2)
...
class TargetArtifact(proto.Message):
    ...
    class PhaseArtifact(proto.Message):
        """Contains the paths to the artifacts, relative to the URI, for
        a phase.
        ...
        """
        skaffold_config_path: str = proto.Field(proto.STRING, number=1)
        manifest_path: str = proto.Field(proto.STRING, number=3)
        job_manifests_path: str = proto.Field(proto.STRING, number=4)
    artifact_uri: str = proto.Field(proto.STRING, number=4, oneof='uri')
    skaffold_config_path: str = proto.Field(proto.STRING, number=2)
    manifest_path: str = proto.Field(proto.STRING, number=3)
    phase_artifacts: MutableMapping[str, PhaseArtifact] = proto.MapField(proto.STRING, proto.MESSAGE, number=5, message=PhaseArtifact)
...
class DeployArtifact(proto.Message):
    ...
    Attributes:
        ...
        manifest_paths (MutableSequence[str]):
            ...
            the URI.
    """
    artifact_uri: str = proto.Field(proto.STRING, number=1)
    manifest_paths: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class RenderMetadata(proto.Message):
    ...
    """
    cloud_run: 'CloudRunRenderMetadata' = proto.Field(proto.MESSAGE, number=1, message='CloudRunRenderMetadata')
...
class ListReleasesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    releases: MutableSequence['Release'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Release')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateReleaseRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    release_id: str = proto.Field(proto.STRING, number=2)
    release: 'Release' = proto.Field(proto.MESSAGE, number=3, message='Release')
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
...
class Rollout(proto.Message):
    ...
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    approve_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    enqueue_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    deploy_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    deploy_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
    target_id: str = proto.Field(proto.STRING, number=18)
    approval_state: ApprovalState = proto.Field(proto.ENUM, number=12, enum=ApprovalState)
    state: State = proto.Field(proto.ENUM, number=13, enum=State)
    failure_reason: str = proto.Field(proto.STRING, number=14)
    deploying_build: str = proto.Field(proto.STRING, number=17)
    etag: str = proto.Field(proto.STRING, number=16)
    deploy_failure_cause: FailureCause = proto.Field(proto.ENUM, number=19, enum=FailureCause)
    phases: MutableSequence['Phase'] = proto.RepeatedField(proto.MESSAGE, number=23, message='Phase')
    metadata: 'Metadata' = proto.Field(proto.MESSAGE, number=24, message='Metadata')
    controller_rollout: str = proto.Field(proto.STRING, number=25)
    rollback_of_rollout: str = proto.Field(proto.STRING, number=26)
    rolled_back_by_rollouts: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=27)
...
class Metadata(proto.Message):
    ...
    """
    cloud_run: 'CloudRunMetadata' = proto.Field(proto.MESSAGE, number=1, message='CloudRunMetadata')
    automation: 'AutomationRolloutMetadata' = proto.Field(proto.MESSAGE, number=2, message='AutomationRolloutMetadata')
...
class CloudRunMetadata(proto.Message):
    ...
    """
    service: str = proto.Field(proto.STRING, number=1)
    service_urls: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    revision: str = proto.Field(proto.STRING, number=3)
    job: str = proto.Field(proto.STRING, number=4)
...
class AutomationRolloutMetadata(proto.Message):
    ...
    """
    promote_automation_run: str = proto.Field(proto.STRING, number=1)
    advance_automation_runs: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    repair_automation_runs: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class Phase(proto.Message):
    ...
    class State(proto.Enum):
        ...
        SKIPPED = 6
    id: str = proto.Field(proto.STRING, number=1)
    state: State = proto.Field(proto.ENUM, number=3, enum=State)
    skip_message: str = proto.Field(proto.STRING, number=6)
    deployment_jobs: 'DeploymentJobs' = proto.Field(proto.MESSAGE, number=4, oneof='jobs', message='DeploymentJobs')
    child_rollout_jobs: 'ChildRolloutJobs' = proto.Field(proto.MESSAGE, number=5, oneof='jobs', message='ChildRolloutJobs')
...
class DeploymentJobs(proto.Message):
    ...
    """
    deploy_job: 'Job' = proto.Field(proto.MESSAGE, number=1, message='Job')
    verify_job: 'Job' = proto.Field(proto.MESSAGE, number=2, message='Job')
    predeploy_job: 'Job' = proto.Field(proto.MESSAGE, number=3, message='Job')
    postdeploy_job: 'Job' = proto.Field(proto.MESSAGE, number=4, message='Job')
...
class ChildRolloutJobs(proto.Message):
    ...
    """
    create_rollout_jobs: MutableSequence['Job'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Job')
    advance_rollout_jobs: MutableSequence['Job'] = proto.RepeatedField(proto.MESSAGE, number=2, message='Job')
...
class Job(proto.Message):
    ...
    skip_message: str = proto.Field(proto.STRING, number=8)
    job_run: str = proto.Field(proto.STRING, number=3)
    deploy_job: 'DeployJob' = proto.Field(proto.MESSAGE, number=4, oneof='job_type', message='DeployJob')
    verify_job: 'VerifyJob' = proto.Field(proto.MESSAGE, number=5, oneof='job_type', message='VerifyJob')
    predeploy_job: 'PredeployJob' = proto.Field(proto.MESSAGE, number=9, oneof='job_type', message='PredeployJob')
    postdeploy_job: 'PostdeployJob' = proto.Field(proto.MESSAGE, number=10, oneof='job_type', message='PostdeployJob')
    create_child_rollout_job: 'CreateChildRolloutJob' = proto.Field(proto.MESSAGE, number=6, oneof='job_type', message='CreateChildRolloutJob')
    advance_child_rollout_job: 'AdvanceChildRolloutJob' = proto.Field(proto.MESSAGE, number=7, oneof='job_type', message='AdvanceChildRolloutJob')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    rollouts: MutableSequence['Rollout'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Rollout')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateRolloutRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    rollout_id: str = proto.Field(proto.STRING, number=2)
    rollout: 'Rollout' = proto.Field(proto.MESSAGE, number=3, message='Rollout')
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
    starting_phase_id: str = proto.Field(proto.STRING, number=7)
...
class ApproveRolloutRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    approved: bool = proto.Field(proto.BOOL, number=2)
...
class AdvanceRolloutRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    phase_id: str = proto.Field(proto.STRING, number=2)
...
class IgnoreJobRequest(proto.Message):
    ...
    """
    rollout: str = proto.Field(proto.STRING, number=1)
    phase_id: str = proto.Field(proto.STRING, number=2)
    job_id: str = proto.Field(proto.STRING, number=3)
...
class JobRun(proto.Message):
    ...
    name: str = proto.Field(proto.STRING, number=1)
    uid: str = proto.Field(proto.STRING, number=2)
    phase_id: str = proto.Field(proto.STRING, number=3)
    job_id: str = proto.Field(proto.STRING, number=4)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    state: State = proto.Field(proto.ENUM, number=8, enum=State)
    deploy_job_run: 'DeployJobRun' = proto.Field(proto.MESSAGE, number=9, oneof='job_run', message='DeployJobRun')
    verify_job_run: 'VerifyJobRun' = proto.Field(proto.MESSAGE, number=10, oneof='job_run', message='VerifyJobRun')
    predeploy_job_run: 'PredeployJobRun' = proto.Field(proto.MESSAGE, number=14, oneof='job_run', message='PredeployJobRun')
    postdeploy_job_run: 'PostdeployJobRun' = proto.Field(proto.MESSAGE, number=15, oneof='job_run', message='PostdeployJobRun')
    create_child_rollout_job_run: 'CreateChildRolloutJobRun' = proto.Field(proto.MESSAGE, number=12, oneof='job_run', message='CreateChildRolloutJobRun')
    advance_child_rollout_job_run: 'AdvanceChildRolloutJobRun' = proto.Field(proto.MESSAGE, number=13, oneof='job_run', message='AdvanceChildRolloutJobRun')
    etag: str = proto.Field(proto.STRING, number=11)
...
class DeployJobRun(proto.Message):
    ...
    class FailureCause(proto.Enum):
        ...
        MISSING_RESOURCES_FOR_CANARY = 4
        CLOUD_BUILD_REQUEST_FAILED = 5
    build: str = proto.Field(proto.STRING, number=1)
    failure_cause: FailureCause = proto.Field(proto.ENUM, number=2, enum=FailureCause)
    failure_message: str = proto.Field(proto.STRING, number=3)
    metadata: 'DeployJobRunMetadata' = proto.Field(proto.MESSAGE, number=4, message='DeployJobRunMetadata')
    artifact: 'DeployArtifact' = proto.Field(proto.MESSAGE, number=5, message='DeployArtifact')
...
class VerifyJobRun(proto.Message):
    ...
    class FailureCause(proto.Enum):
        ...
        CLOUD_BUILD_REQUEST_FAILED = 5
    build: str = proto.Field(proto.STRING, number=1)
    artifact_uri: str = proto.Field(proto.STRING, number=2)
    event_log_path: str = proto.Field(proto.STRING, number=3)
    failure_cause: FailureCause = proto.Field(proto.ENUM, number=4, enum=FailureCause)
    failure_message: str = proto.Field(proto.STRING, number=5)
...
class CreateChildRolloutJobRun(proto.Message):
    ...
    """
    rollout: str = proto.Field(proto.STRING, number=1)
    rollout_phase_id: str = proto.Field(proto.STRING, number=2)
...
class ListJobRunsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    job_runs: MutableSequence['JobRun'] = proto.RepeatedField(proto.MESSAGE, number=1, message='JobRun')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class Config(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    supported_versions: MutableSequence['SkaffoldVersion'] = proto.RepeatedField(proto.MESSAGE, number=2, message='SkaffoldVersion')
    default_skaffold_version: str = proto.Field(proto.STRING, number=3)
...
class SkaffoldVersion(proto.Message):
    ...
    maintenance_mode_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    support_expiration_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    support_end_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=2, message=date_pb2.Date)
...
class Automation(proto.Message):
    ...
    uid: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=7)
    etag: str = proto.Field(proto.STRING, number=8)
    suspended: bool = proto.Field(proto.BOOL, number=9)
    service_account: str = proto.Field(proto.STRING, number=10)
    selector: 'AutomationResourceSelector' = proto.Field(proto.MESSAGE, number=11, message='AutomationResourceSelector')
    rules: MutableSequence['AutomationRule'] = proto.RepeatedField(proto.MESSAGE, number=14, message='AutomationRule')
...
class AutomationResourceSelector(proto.Message):
    ...
    """
    targets: MutableSequence['TargetAttribute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TargetAttribute')
...
class AutomationRule(proto.Message):
    ...
    Attributes:
        ...
        repair_rollout_rule (google.cloud.deploy_v1.types.RepairRolloutRule):
            ...
            This field is a member of `oneof`_ ``rule``.
    """
    promote_release_rule: 'PromoteReleaseRule' = proto.Field(proto.MESSAGE, number=1, oneof='rule', message='PromoteReleaseRule')
    advance_rollout_rule: 'AdvanceRolloutRule' = proto.Field(proto.MESSAGE, number=2, oneof='rule', message='AdvanceRolloutRule')
    repair_rollout_rule: 'RepairRolloutRule' = proto.Field(proto.MESSAGE, number=3, oneof='rule', message='RepairRolloutRule')

class PromoteReleaseRule(proto.Message):
    """``PromoteRelease`` rule will automatically promote a release from
    ...
    """
    id: str = proto.Field(proto.STRING, number=1)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    destination_target_id: str = proto.Field(proto.STRING, number=7)
    condition: 'AutomationRuleCondition' = proto.Field(proto.MESSAGE, number=5, message='AutomationRuleCondition')
    destination_phase: str = proto.Field(proto.STRING, number=8)
...
class AdvanceRolloutRule(proto.Message):
    ...
    """
    id: str = proto.Field(proto.STRING, number=1)
    source_phases: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, message=duration_pb2.Duration)
    condition: 'AutomationRuleCondition' = proto.Field(proto.MESSAGE, number=5, message='AutomationRuleCondition')
...
class RepairRolloutRule(proto.Message):
    ...
    """
    id: str = proto.Field(proto.STRING, number=1)
    source_phases: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    jobs: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    repair_modes: MutableSequence['RepairMode'] = proto.RepeatedField(proto.MESSAGE, number=4, message='RepairMode')
    condition: 'AutomationRuleCondition' = proto.Field(proto.MESSAGE, number=6, message='AutomationRuleCondition')
...
class RepairMode(proto.Message):
    ...
    Attributes:
        ...
        rollback (google.cloud.deploy_v1.types.Rollback):
            ...
            This field is a member of `oneof`_ ``mode``.
    """
    retry: 'Retry' = proto.Field(proto.MESSAGE, number=1, oneof='mode', message='Retry')
    rollback: 'Rollback' = proto.Field(proto.MESSAGE, number=2, oneof='mode', message='Rollback')
...
class Retry(proto.Message):
    ...
    Attributes:
        ...
        backoff_mode (google.cloud.deploy_v1.types.BackoffMode):
            ...
            is 0.
    """
    attempts: int = proto.Field(proto.INT64, number=1)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    backoff_mode: 'BackoffMode' = proto.Field(proto.ENUM, number=3, enum='BackoffMode')
...
class Rollback(proto.Message):
    ...
    Attributes:
        destination_phase (str):
            ...
            unspecified, the ``Rollout`` will start in the stable phase.
    """
    destination_phase: str = proto.Field(proto.STRING, number=1)
...
class AutomationRuleCondition(proto.Message):
    ...
    Attributes:
        targets_present_condition (google.cloud.deploy_v1.types.TargetsPresentCondition):
            ...
            in the rule.
    """
    targets_present_condition: 'TargetsPresentCondition' = proto.Field(proto.MESSAGE, number=1, message='TargetsPresentCondition')
...
class CreateAutomationRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    automation_id: str = proto.Field(proto.STRING, number=2)
    automation: 'Automation' = proto.Field(proto.MESSAGE, number=3, message='Automation')
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
...
class UpdateAutomationRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    automation: 'Automation' = proto.Field(proto.MESSAGE, number=2, message='Automation')
    request_id: str = proto.Field(proto.STRING, number=3)
    allow_missing: bool = proto.Field(proto.BOOL, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    automations: MutableSequence['Automation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Automation')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class AutomationRun(proto.Message):
    ...
    etag: str = proto.Field(proto.STRING, number=4)
    service_account: str = proto.Field(proto.STRING, number=5)
    automation_snapshot: 'Automation' = proto.Field(proto.MESSAGE, number=6, message='Automation')
    target_id: str = proto.Field(proto.STRING, number=7)
    state: State = proto.Field(proto.ENUM, number=8, enum=State)
    state_description: str = proto.Field(proto.STRING, number=9)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=11, message=timestamp_pb2.Timestamp)
    rule_id: str = proto.Field(proto.STRING, number=12)
    automation_id: str = proto.Field(proto.STRING, number=15)
    promote_release_operation: 'PromoteReleaseOperation' = proto.Field(proto.MESSAGE, number=13, oneof='operation', message='PromoteReleaseOperation')
    advance_rollout_operation: 'AdvanceRolloutOperation' = proto.Field(proto.MESSAGE, number=14, oneof='operation', message='AdvanceRolloutOperation')
    repair_rollout_operation: 'RepairRolloutOperation' = proto.Field(proto.MESSAGE, number=17, oneof='operation', message='RepairRolloutOperation')
    wait_until_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=16, message=timestamp_pb2.Timestamp)
...
class PromoteReleaseOperation(proto.Message):
    ...
    target_id: str = proto.Field(proto.STRING, number=1)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    rollout: str = proto.Field(proto.STRING, number=3)
    phase: str = proto.Field(proto.STRING, number=4)
...
class AdvanceRolloutOperation(proto.Message):
    ...
    Attributes:
        ...
        destination_phase (str):
            ...
            will be advanced to.
    """
    source_phase: str = proto.Field(proto.STRING, number=5)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    rollout: str = proto.Field(proto.STRING, number=3)
    destination_phase: str = proto.Field(proto.STRING, number=4)
...
class RepairRolloutOperation(proto.Message):
    ...
    """
    rollout: str = proto.Field(proto.STRING, number=1)
    current_repair_mode_index: int = proto.Field(proto.INT64, number=2)
    repair_phases: MutableSequence['RepairPhase'] = proto.RepeatedField(proto.MESSAGE, number=3, message='RepairPhase')
...
class RepairPhase(proto.Message):
    ...
    Attributes:
        ...
        rollback (google.cloud.deploy_v1.types.RollbackAttempt):
            ...
            This field is a member of `oneof`_ ``repair_phase``.
    """
    retry: 'RetryPhase' = proto.Field(proto.MESSAGE, number=1, oneof='repair_phase', message='RetryPhase')
    rollback: 'RollbackAttempt' = proto.Field(proto.MESSAGE, number=2, oneof='repair_phase', message='RollbackAttempt')
...
class RetryPhase(proto.Message):
    ...
    """
    total_attempts: int = proto.Field(proto.INT64, number=1)
    backoff_mode: 'BackoffMode' = proto.Field(proto.ENUM, number=2, enum='BackoffMode')
    phase_id: str = proto.Field(proto.STRING, number=3)
    job_id: str = proto.Field(proto.STRING, number=4)
    attempts: MutableSequence['RetryAttempt'] = proto.RepeatedField(proto.MESSAGE, number=5, message='RetryAttempt')
...
class RetryAttempt(proto.Message):
    ...
    Attributes:
        ...
        state_desc (str):
            ...
            Retry.
    """
    attempt: int = proto.Field(proto.INT64, number=1)
    wait: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    state: 'RepairState' = proto.Field(proto.ENUM, number=5, enum='RepairState')
    state_desc: str = proto.Field(proto.STRING, number=6)
...
class RollbackAttempt(proto.Message):
    ...
    destination_phase: str = proto.Field(proto.STRING, number=1)
    rollout_id: str = proto.Field(proto.STRING, number=2)
    state: 'RepairState' = proto.Field(proto.ENUM, number=3, enum='RepairState')
    state_desc: str = proto.Field(proto.STRING, number=4)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    automation_runs: MutableSequence['AutomationRun'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AutomationRun')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
