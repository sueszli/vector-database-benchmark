...
from zipline.data.bar_reader import NoDataAfterDate, NoDataBeforeDate, NoDataForSid, NoDataOnDate
...
DEFAULT_SCALING_FACTORS = {OPEN: 1000, HIGH: 1000, LOW: 1000, CLOSE: 1000, VOLUME: 1}
