...
from coremltools.models.neural_network.quantization_utils import _convert_array_to_nbit_quantized_bytes, quantize_weights
...
@unittest.skipIf(not _is_macos() or _macos_version() < LAYERS_10_15_MACOS_VERSION, 'Only supported on macOS 10.15+')
...
@unittest.skipUnless(_is_macos() and _macos_version() >= LAYERS_10_14_MACOS_VERSION, 'Only supported on macOS 10.14+')
...
@unittest.skipUnless(_is_macos() and _macos_version() >= LAYERS_10_15_MACOS_VERSION, 'Only supported on macOS 10.15+')
...
@unittest.skipIf(not _is_macos() or _macos_version() < (10, 13), 'Only supported on macOS 10.13+')
