...
class MNIST(paddle.nn.Layer):
    ...
    def __init__(self):
        ...
        self._fc = Linear(self.pool_2_shape, 10, weight_attr=paddle.ParamAttr(initializer=paddle.nn.initializer.Normal(mean=0.0, std=scale)))
...
class TestImperativeMnist(unittest.TestCase):
    ...
    def test_mnist_float32(self):
        ...
        for (key, value) in static_param_value.items():
            np.testing.assert_allclose(value, dy_param_value[key], rtol=1e-05, atol=1e-05)
