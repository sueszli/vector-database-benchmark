...
import boto3
from anyscale.sdk.anyscale_client.models.create_cluster_environment import CreateClusterEnvironment
from anyscale.sdk.anyscale_client.sdk import AnyscaleSDK
from ray_release.bazel import bazel_runfile
from ray_release.byod.build import build_champagne_image
from ray_release.logger import logger
from ray_release.configs.global_config import init_global_config
CHAMPAGNE_IMAGE_TYPES = [('py38', 'cpu', 'ray-champagne-cpu'), ('py38', 'gpu', 'ray-champagne-gpu')]
ANYSCALE_SECRET_ARM = 'arn:aws:secretsmanager:us-west-2:029272617770:secret:release-automation'
ANYSCALE_SECRETS = {'anyscale-staging-token20231008005227440600000001-JTgxb0': 'https://console.anyscale-staging.com', 'anyscale-demos-FaVACh': 'https://console.anyscale.com'}
CONFIG_CHOICES = click.Choice([x.name for x in (Path(__file__).parent.parent / 'configs').glob('*.yaml')])
