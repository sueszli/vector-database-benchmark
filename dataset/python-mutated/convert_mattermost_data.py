...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument('--mask', dest='masking_content', action='store_true', help='Mask the content for privacy during QA.')
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        do_convert_data(mattermost_data_dir=data_dir, output_dir=output_dir, masking_content=options.get('masking_content', False))