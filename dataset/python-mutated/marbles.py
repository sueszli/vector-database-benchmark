...
class MarblesContext(NamedTuple):
    start: Callable[[Union[Observable[Any], Callable[[], Observable[Any]]]], List[Recorded[Any]]]
    cold: Callable[[str, Optional[Dict[Union[str, float], Any]], Optional[Exception]], Observable[Any]]
    hot: Callable[[str, Optional[Dict[Union[str, float], Any]], Optional[Exception]], Observable[Any]]
    exp: Callable[[str, Optional[Dict[Union[str, float], Any]], Optional[Exception]], List[Recorded[Any]]]
