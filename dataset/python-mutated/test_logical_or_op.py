...
class TestLogicalOrCaseWithBroadcast(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.cls = TestLogicalOrOp
        self.inputs = [{'x_shape': [1], 'y_shape': [1]}, {'x_shape': [1024], 'y_shape': [1]}, {'x_shape': [512, 256], 'y_shape': [512, 1]}, {'x_shape': [128, 64, 32], 'y_shape': [128, 64, 1]}, {'x_shape': [16, 1, 1, 2], 'y_shape': [16, 8, 4, 2]}, {'x_shape': [16, 1, 1, 2, 1], 'y_shape': [16, 8, 4, 2, 1]}]
        self.dtypes = [{'x_dtype': 'bool', 'y_dtype': 'bool'}, {'x_dtype': 'int8', 'y_dtype': 'int8'}, {'x_dtype': 'int16', 'y_dtype': 'int16'}, {'x_dtype': 'int32', 'y_dtype': 'int32'}, {'x_dtype': 'int64', 'y_dtype': 'int64'}, {'x_dtype': 'float32', 'y_dtype': 'float32'}, {'x_dtype': 'float64', 'y_dtype': 'float64'}]
        self.attrs = [{'axis': -1}]
