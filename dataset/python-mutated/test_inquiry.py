...
SCHEMA_DEFAULT = {'title': 'response_data', 'type': 'object', 'properties': {'continue': {'type': 'boolean', 'description': 'Would you like to continue the workflow?', 'required': True}}}
RESPONSE_DEFAULT = {'continue': True}
SCHEMA_MULTIPLE = {'title': 'response_data', 'type': 'object', 'properties': {'name': {'type': 'string', 'description': 'What is your name?', 'required': True}, 'pin': {'type': 'integer', 'description': 'What is your PIN?', 'required': True}, 'paradox': {'type': 'boolean', 'description': 'This statement is False.', 'required': True}}}
RESPONSE_MULTIPLE = {'name': 'matt', 'pin': 1234, 'paradox': True}
RESPONSE_BAD = {'foo': 'bar'}
INQUIRY_1 = {'id': 'abcdef', 'schema': SCHEMA_DEFAULT, 'roles': [], 'users': [], 'route': '', 'ttl': 1440}
INQUIRY_MULTIPLE = {'id': 'beef', 'schema': SCHEMA_MULTIPLE, 'roles': [], 'users': [], 'route': '', 'ttl': 1440}
