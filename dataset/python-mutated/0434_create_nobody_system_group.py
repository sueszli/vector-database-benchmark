...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0433_preregistrationrealm')]
    operations = [migrations.RunPython(create_nobody_system_user_group_for_existing_realms, reverse_code=delete_nobody_system_user_groups, elidable=True)]