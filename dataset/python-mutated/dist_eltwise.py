...
from ..utils import compute_compatible_dim_mapping, compute_compatible_dims_mapping, get_dist_tensor_spec
from .common import DistributedOperatorImpl, DistributedOperatorImplContainer, get_default_distributed_operator_impl, is_elementwise_op, is_parameter_related, register_distributed_operator_impl, register_distributed_operator_impl_container, update_op_dims_mapping
...
class DistributedElementwise(DistributedOperatorImplContainer):
    ...
    def mapping_to_dist_operator_impl(dist_op, original_op_dist_attr):
        ...
        return False
register_distributed_operator_impl_container(DistributedElementwise('elementwise'))
...
register_distributed_operator_impl('elementwise', DistributedElementwiseImpl0('replicate_parallel'))