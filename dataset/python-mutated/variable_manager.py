...
from mage_ai.data_preparation.models.variable import VARIABLE_DIR, Variable, VariableType
...
class VariableManager:
    ...
    async def add_variable_async(self, pipeline_uuid: str, block_uuid: str, variable_uuid: str, data: Any, partition: str=None, variable_type: VariableType=None, clean_block_uuid: bool=True) -> None:
        if type(data) is pd.DataFrame:
            variable_type = VariableType.DATAFRAME
        elif is_spark_dataframe(data):
            variable_type = VariableType.SPARK_DATAFRAME
