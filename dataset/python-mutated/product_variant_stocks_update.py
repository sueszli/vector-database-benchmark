...
class ProductVariantStocksUpdate(ProductVariantStocksCreate):
    ...
    class Arguments:
        variant_id = graphene.ID(required=False, description='ID of a product variant for which stocks will be updated.')
        sku = graphene.String(required=False, description='SKU of product variant for which stocks will be updated.')
        stocks = NonNullList(StockInput, required=True, description='Input list of stocks to create or update.')
