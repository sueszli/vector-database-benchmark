...
def local_csvs(tmp_path, partitioned_data_pandas):
    ...
    return local_dir
LOCAL_DATASET_DEFINITION = ['pandas.CSVDataSet', 'kedro.extras.datasets.pandas.CSVDataSet', CSVDataSet, {'type': 'pandas.CSVDataSet', 'save_args': {'index': False}}, {'type': CSVDataSet}]
...
S3_DATASET_DEFINITION = ['pandas.CSVDataSet', 'kedro.extras.datasets.pandas.CSVDataSet', CSVDataSet, {'type': 'pandas.CSVDataSet', 'save_args': {'index': False}}, {'type': CSVDataSet}]
