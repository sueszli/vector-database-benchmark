...
PLUGINS_ID_TO_SKIP = ['mirumee.webhooks', 'mirumee.payments.dummy', 'mirumee.payments.dummy_credit_card', 'mirumee.invoicing']
...
class Migration(migrations.Migration):
    dependencies = [('channel', '0001_initial'), ('plugins', '0007_add_user_emails_configuration')]
    operations = [migrations.AlterField(model_name='pluginconfiguration', name='identifier', field=models.CharField(max_length=128)), migrations.AddField(model_name='pluginconfiguration', name='channel', field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='channel.channel')), migrations.AlterUniqueTogether(name='pluginconfiguration', unique_together={('identifier', 'channel')}), migrations.RunPython(move_company_address_to_avatax_configuration), migrations.RunPython(populate_plugin_configurations_for_channels)]