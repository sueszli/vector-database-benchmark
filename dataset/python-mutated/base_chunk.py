...
import warnings
import deeplake
from deeplake.compression import BYTE_COMPRESSION, IMAGE_COMPRESSION, VIDEO_COMPRESSION, get_compression_type
...
from deeplake.core.serialize import deserialize_chunk, infer_chunk_num_bytes, infer_header_num_bytes, serialize_chunk, serialize_linked_tiled_sample, serialize_numpy_and_base_types, serialize_sample_object, serialize_text, serialize_tensor, serialize_partial_sample_object, get_header_from_url, serialize_text_sample_object, serialize_polygons
from deeplake.core.storage.deeplake_memory_object import DeepLakeMemoryObject
from deeplake.core.tiling.sample_tiles import SampleTiles
from deeplake.util.exceptions import ReadSampleFromChunkError, TensorInvalidSampleShapeError, EmptyTensorError
from deeplake.core.polygon import Polygons
from functools import reduce, wraps
from operator import mul
InputSample = Union[Sample, np.ndarray, int, float, bool, dict, list, str, np.integer, np.floating, np.bool_]
