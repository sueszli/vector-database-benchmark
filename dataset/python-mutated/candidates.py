...
from pdm.models.requirements import FileRequirement, Requirement, VcsRequirement, _egg_info_re, filter_requirements_with_extras
from pdm.models.setup import Setup
from pdm.models.specifiers import PySpecSet
from pdm.utils import cd, convert_hashes, create_tracked_tempdir, get_rev_from_url, normalize_name, path_to_url, url_without_fragments
if TYPE_CHECKING:
...
class Candidate:
    ...
    """
    __slots__ = ('req', 'name', 'version', 'link', 'summary', 'hashes', '_prepared', '_requires_python', '_preferred')
