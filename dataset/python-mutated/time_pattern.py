...
class TimePattern:
    ...
    def __call__(self, value):
        ...
        return value
TRIGGER_SCHEMA = vol.All(cv.TRIGGER_BASE_SCHEMA.extend({vol.Required(CONF_PLATFORM): 'time_pattern', CONF_HOURS: TimePattern(maximum=23), CONF_MINUTES: TimePattern(maximum=59), CONF_SECONDS: TimePattern(maximum=59)}), cv.has_at_least_one_key(CONF_HOURS, CONF_MINUTES, CONF_SECONDS))
