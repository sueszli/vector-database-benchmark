...
from dagster import AssetIn, AssetKey, DailyPartitionsDefinition, Definitions, IdentityPartitionMapping, SourceAsset, StaticPartitionMapping, StaticPartitionsDefinition, asset
...
partitioned_source = SourceAsset('partitioned_source', partitions_def=DailyPartitionsDefinition(start_date='2022-01-01'))
...
def partitioned_observable_source2():
    if False:
        while True:
            i = 10
    pass
partitioned_defs = Definitions(assets=[partitioned_source, downstream_of_partitioned_source, partitioned_observable_source1, partitioned_observable_source2])
...
def other_static_partitioned_asset():
    if False:
        while True:
            i = 10
    pass
different_partitions_defs = Definitions(assets=[static_partitioned_asset, other_static_partitioned_asset, downstream_of_partitioned_source, partitioned_source])
...
def static_partitioned_multi_run_backfill_asset():
    if False:
        ...
        return i + 15
    pass
backfill_assets_defs = Definitions(assets=[static_partitioned_single_run_backfill_asset, non_partitioned_single_run_backfill_asset, static_partitioned_multi_run_backfill_asset])
