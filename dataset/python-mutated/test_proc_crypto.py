...
class MyTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            return 10
        fixtures = {'proc_crypto': ('fixtures/linux-proc/crypto', 'fixtures/linux-proc/crypto.json')}
    ...
    def test_proc_crypto(self):
        if False:
            ...
            return i + 15
        "\n        Test '/proc/crypto'\n        "
        self.assertEqual(jc.parsers.proc_crypto.parse(self.f_in['proc_crypto'], quiet=True), self.f_json['proc_crypto'])
