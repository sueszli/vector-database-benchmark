...
import proto
__protobuf__ = proto.module(package='google.cloud.kms.inventory.v1', manifest={'GetProtectedResourcesSummaryRequest', 'ProtectedResourcesSummary', 'SearchProtectedResourcesRequest', 'SearchProtectedResourcesResponse', 'ProtectedResource'})
...
class ProtectedResourcesSummary(proto.Message):
    """Aggregate information about the resources protected by a
    ...
    resource_count: int = proto.Field(proto.INT64, number=1)
    project_count: int = proto.Field(proto.INT32, number=2)
    resource_types: MutableMapping[str, int] = proto.MapField(proto.STRING, proto.INT64, number=3)
    cloud_products: MutableMapping[str, int] = proto.MapField(proto.STRING, proto.INT64, number=6)
    locations: MutableMapping[str, int] = proto.MapField(proto.STRING, proto.INT64, number=4)
...
class SearchProtectedResourcesRequest(proto.Message):
    ...
    """
    scope: str = proto.Field(proto.STRING, number=2)
    crypto_key: str = proto.Field(proto.STRING, number=1)
    page_size: int = proto.Field(proto.INT32, number=3)
    page_token: str = proto.Field(proto.STRING, number=4)
    resource_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class SearchProtectedResourcesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    protected_resources: MutableSequence['ProtectedResource'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ProtectedResource')
...
class ProtectedResource(proto.Message):
    ...
    project_id: str = proto.Field(proto.STRING, number=9)
    cloud_product: str = proto.Field(proto.STRING, number=8)
    resource_type: str = proto.Field(proto.STRING, number=3)
    location: str = proto.Field(proto.STRING, number=4)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    crypto_key_version: str = proto.Field(proto.STRING, number=6)
    crypto_key_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=10)
