...
class RestorableMongodbResourcesOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, restore_location: Optional[str]=None, restore_timestamp_in_utc: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableMongodbResourcesGetResult']:
        if False:
            while True:
                i = 10
