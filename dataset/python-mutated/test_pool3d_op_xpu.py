...
class XPUTestPool3DOp(XPUOpTestWrapper):
    ...
    class TestPool3D_Op(XPUOpTest):
        ...
        def setUp(self):
            ...
            self.attrs = {'strides': self.strides, 'paddings': self.paddings, 'ksize': self.ksize, 'pooling_type': self.pool_type, 'global_pooling': self.global_pool, 'ceil_mode': self.ceil_mode, 'data_format': self.data_format, 'exclusive': self.exclusive, 'adaptive': self.adaptive, 'padding_algorithm': self.padding_algorithm}
