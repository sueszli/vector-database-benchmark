...
python -m apache_beam.testing.load_tests.co_group_by_key_test     --test-pipeline-options="
...
./gradlew -PloadTest.args="
    ...
    --co_input_options='{
      ...
      "key_size": 1,
      "value_size": 1}'
    --runner=DirectRunner" -PloadTest.mainClass=apache_beam.testing.load_tests.co_group_by_key_test -Prunner=DirectRunner :sdks:python:apache_beam:testing:load_tests:run
"""
import json
import logging
