...
from haystack.environment import HAYSTACK_REMOTE_API_BACKOFF_SEC, HAYSTACK_REMOTE_API_MAX_RETRIES, HAYSTACK_REMOTE_API_TIMEOUT_SEC
...
COHERE_EMBEDDING_MODELS = ['small', 'large', 'multilingual-22-12', 'embed-english-v2.0', 'embed-english-light-v2.0', 'embed-multilingual-v2.0']
...
_EMBEDDING_ENCODERS: Dict[str, Callable] = {'farm': _DefaultEmbeddingEncoder, 'transformers': _DefaultEmbeddingEncoder, 'sentence_transformers': _SentenceTransformersEmbeddingEncoder, 'retribert': _RetribertEmbeddingEncoder, 'openai': _OpenAIEmbeddingEncoder, 'cohere': _CohereEmbeddingEncoder}