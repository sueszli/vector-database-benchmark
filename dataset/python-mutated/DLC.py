...
class DLC(BaseContainer):
    ...
    __license__ = 'GPLv3'
    __authors__ = [('RaNaN', 'RaNaN@pyload.net'), ('spoob', 'spoob@pyload.net'), ('mkaay', 'mkaay@mkaay.de'), ('Schnusch', 'Schnusch@users.noreply.github.com'), ('Walter Purcaro', 'vuolter@gmail.com'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
