...
from caffe2.python.optimizer import build_sgd, build_multi_precision_sgd, build_ftrl, build_gftrl, build_wngrad, build_adagrad, build_adadelta, build_adam, build_yellowfin, build_rms_prop, build_storm, build_decay_adagrad, add_weight_decay, SgdOptimizer
