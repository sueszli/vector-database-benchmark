...
class AttestationManagementClient:
    ...
    def __init__(self, credential: 'AsyncTokenCredential', subscription_id: str, base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        if False:
            while True:
                i = 10
        self._config = AttestationManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.attestation_providers = AttestationProvidersOperations(self._client, self._config, self._serialize, self._deserialize)
