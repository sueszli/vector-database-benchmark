...
@region_silo_test
class OrganizationEventsStatsMetricsEnhancedPerformanceEndpointTest(MetricsEnhancedPerformanceTestCase):
    endpoint = 'sentry-api-0-organization-events-stats'
    METRIC_STRINGS = ['foo_transaction', 'd:transactions/measurements.datacenter_memory@pebibyte']
...
class OrganizationEventsStatsMetricsEnhancedPerformanceEndpointTestWithMetricLayer(OrganizationEventsStatsMetricsEnhancedPerformanceEndpointTest):
...
@region_silo_test
class OrganizationEventsStatsMetricsEnhancedPerformanceEndpointTestWithOnDemand(MetricsEnhancedPerformanceTestCase):
    endpoint = 'sentry-api-0-organization-events-stats'
