...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry, async_add_entities: AddEntitiesCallback) -> None:
    ...
    hass.data[DATA_REMOVE_DISCOVER_COMPONENT.format(binary_sensor.DOMAIN)] = async_dispatcher_connect(hass, TASMOTA_DISCOVERY_ENTITY_NEW.format(binary_sensor.DOMAIN), async_discover)

class TasmotaBinarySensor(TasmotaAvailability, TasmotaDiscoveryUpdate, BinarySensorEntity):
