...
if is_tf_available():
    ...
    from transformers.models.albert.modeling_tf_albert import TF_ALBERT_PRETRAINED_MODEL_ARCHIVE_LIST, TFAlbertForMaskedLM, TFAlbertForMultipleChoice, TFAlbertForPreTraining, TFAlbertForQuestionAnswering, TFAlbertForSequenceClassification, TFAlbertForTokenClassification, TFAlbertModel
...
class TFAlbertModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFAlbertModel, TFAlbertForPreTraining, TFAlbertForMaskedLM, TFAlbertForSequenceClassification, TFAlbertForQuestionAnswering, TFAlbertForTokenClassification, TFAlbertForMultipleChoice) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFAlbertModel, 'fill-mask': TFAlbertForMaskedLM, 'question-answering': TFAlbertForQuestionAnswering, 'text-classification': TFAlbertForSequenceClassification, 'token-classification': TFAlbertForTokenClassification, 'zero-shot': TFAlbertForSequenceClassification} if is_tf_available() else {}
...
class TFAlbertModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_masked_lm(self):
        ...
        expected_slice = tf.constant([[[4.595668, 0.74462754, -1.818147], [4.5954347, 0.7454184, -1.8188258], [4.5954905, 0.7448235, -1.8182316]]])
