...
class AWAANLiveIE(AWAANBaseIE):
    ...
    _TEST = {'url': 'http://awaan.ae/live/6/dubai-tv', 'info_dict': {'id': '6', 'ext': 'mp4', 'title': 're:Dubai Al Oula [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'upload_date': '20150107', 'timestamp': 1420588800, 'uploader_id': '71'}, 'params': {'skip_download': True}}
...
class AWAANSeasonIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://dcndigital.ae/#/program/205024/%D9%85%D8%AD%D8%A7%D8%B6%D8%B1%D8%A7%D8%AA-%D8%A7%D9%84%D8%B4%D9%8A%D8%AE-%D8%A7%D9%84%D8%B4%D8%B9%D8%B1%D8%A7%D9%88%D9%8A', 'info_dict': {'id': '7910', 'title': 'محاضرات الشيخ الشعراوي'}, 'playlist_mincount': 27}
