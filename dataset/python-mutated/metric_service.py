...
class ListMonitoredResourceDescriptorsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    resource_descriptors: MutableSequence[monitored_resource_pb2.MonitoredResourceDescriptor] = proto.RepeatedField(proto.MESSAGE, number=1, message=monitored_resource_pb2.MonitoredResourceDescriptor)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    metric_descriptors: MutableSequence[metric_pb2.MetricDescriptor] = proto.RepeatedField(proto.MESSAGE, number=1, message=metric_pb2.MetricDescriptor)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateMetricDescriptorRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=3)
    metric_descriptor: metric_pb2.MetricDescriptor = proto.Field(proto.MESSAGE, number=2, message=metric_pb2.MetricDescriptor)
...
class ListTimeSeriesRequest(proto.Message):
    ...
    class TimeSeriesView(proto.Enum):
        ...
        FULL = 0
        HEADERS = 1
    name: str = proto.Field(proto.STRING, number=10)
    filter: str = proto.Field(proto.STRING, number=2)
    interval: common.TimeInterval = proto.Field(proto.MESSAGE, number=4, message=common.TimeInterval)
    aggregation: common.Aggregation = proto.Field(proto.MESSAGE, number=5, message=common.Aggregation)
    secondary_aggregation: common.Aggregation = proto.Field(proto.MESSAGE, number=11, message=common.Aggregation)
    order_by: str = proto.Field(proto.STRING, number=6)
    view: TimeSeriesView = proto.Field(proto.ENUM, number=7, enum=TimeSeriesView)
...
class ListTimeSeriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    time_series: MutableSequence[gm_metric.TimeSeries] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_metric.TimeSeries)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    execution_errors: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=3, message=status_pb2.Status)
    unit: str = proto.Field(proto.STRING, number=5)
...
class CreateTimeSeriesRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=3)
    time_series: MutableSequence[gm_metric.TimeSeries] = proto.RepeatedField(proto.MESSAGE, number=2, message=gm_metric.TimeSeries)
...
class CreateTimeSeriesError(proto.Message):
    ...
    Attributes:
        ...
        status (google.rpc.status_pb2.Status):
            ...
            ``time_series``.
    """
    time_series: gm_metric.TimeSeries = proto.Field(proto.MESSAGE, number=1, message=gm_metric.TimeSeries)
...
class CreateTimeSeriesSummary(proto.Message):
    """Summary of the result of a failed request to write data to a
    time series.
    ...
    class Error(proto.Message):
        ...
        Attributes:
            ...
            point_count (int):
                ...
                ``status``.
        """
        status: status_pb2.Status = proto.Field(proto.MESSAGE, number=1, message=status_pb2.Status)
        point_count: int = proto.Field(proto.INT32, number=2)
    total_point_count: int = proto.Field(proto.INT32, number=1)
    success_point_count: int = proto.Field(proto.INT32, number=2)
    errors: MutableSequence[Error] = proto.RepeatedField(proto.MESSAGE, number=3, message=Error)
...
class QueryTimeSeriesRequest(proto.Message):
    ...
    query: str = proto.Field(proto.STRING, number=7)
    page_size: int = proto.Field(proto.INT32, number=9)
    page_token: str = proto.Field(proto.STRING, number=10)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    time_series_descriptor: gm_metric.TimeSeriesDescriptor = proto.Field(proto.MESSAGE, number=8, message=gm_metric.TimeSeriesDescriptor)
    time_series_data: MutableSequence[gm_metric.TimeSeriesData] = proto.RepeatedField(proto.MESSAGE, number=9, message=gm_metric.TimeSeriesData)
    next_page_token: str = proto.Field(proto.STRING, number=10)
    partial_errors: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=11, message=status_pb2.Status)

class QueryErrorList(proto.Message):
    """This is an error detail intended to be used with INVALID_ARGUMENT
    errors.
    ...
    """
    errors: MutableSequence[gm_metric.QueryError] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_metric.QueryError)
    error_summary: str = proto.Field(proto.STRING, number=2)
