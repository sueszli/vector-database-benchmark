...
class Migration(migrations.Migration):
    dependencies = [('visualizers_manager', '0012_alter_visualizerconfig_disabled_in_organizations_and_more'), ('api_app', '0027_parameter')]
    operations = [migrations.RunPython(migrate, reverse_migrate), migrations.RemoveField(model_name='visualizerconfig', name='params'), migrations.RemoveField(model_name='visualizerconfig', name='secrets')]