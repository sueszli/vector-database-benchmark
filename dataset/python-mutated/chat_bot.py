...
class ChatBot(Thread, BaseAddon):
    ...
    SHORTCUT_COMMANDS = {'a': 'add', 'c': 'collector', 'ca': 'captcha', 'f': 'freespace', 'h': 'help', 'i': 'info', 'l': 'getLog', 'm': 'more', 'p': 'packinfo', 'q': 'queue', 'r': 'restart', 'rf': 'restartfile', 'rp': 'restartpackage', 's': 'status'}
