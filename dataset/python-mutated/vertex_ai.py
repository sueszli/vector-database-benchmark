...
VERTEX_AI_MODEL_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/models/{model_id}/deploy?project={project_id}'
...
VERTEX_AI_TRAINING_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/training/{training_id}/cpu?project={project_id}'
VERTEX_AI_TRAINING_PIPELINES_LINK = VERTEX_AI_BASE_LINK + '/training/training-pipelines?project={project_id}'
VERTEX_AI_DATASET_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/datasets/{dataset_id}/analyze?project={project_id}'
VERTEX_AI_DATASET_LIST_LINK = VERTEX_AI_BASE_LINK + '/datasets?project={project_id}'
VERTEX_AI_HYPERPARAMETER_TUNING_JOB_LIST_LINK = VERTEX_AI_BASE_LINK + '/training/hyperparameter-tuning-jobs?project={project_id}'
VERTEX_AI_BATCH_PREDICTION_JOB_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/batch-predictions/{batch_prediction_job_id}?project={project_id}'
VERTEX_AI_BATCH_PREDICTION_JOB_LIST_LINK = VERTEX_AI_BASE_LINK + '/batch-predictions?project={project_id}'
VERTEX_AI_ENDPOINT_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/endpoints/{endpoint_id}?project={project_id}'
VERTEX_AI_ENDPOINT_LIST_LINK = VERTEX_AI_BASE_LINK + '/endpoints?project={project_id}'
VERTEX_AI_PIPELINE_JOB_LINK = VERTEX_AI_BASE_LINK + '/locations/{region}/pipelines/runs/{pipeline_id}?project={project_id}'
