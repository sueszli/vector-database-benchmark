...
ax = X.plot.scatter(x='feature 1', y='feature 2', c=y, colormap='viridis', colorbar=False)
...
X.plot.scatter(x='feature 1', y='feature 2', c=y, ax=axs[0, 0], colormap='viridis', colorbar=False)
...
for (ax, multiplier) in zip(axs.ravel()[1:], multipliers):
    (X_resampled, y_resampled) = make_imbalance(X, y, sampling_strategy=ratio_func, **{'multiplier': multiplier, 'minority_class': 1})
    X_resampled.plot.scatter(x='feature 1', y='feature 2', c=y_resampled, ax=ax, colormap='viridis', colorbar=False)
