...
from modelscope.outputs import AttentionTokenClassificationModelOutput, ModelOutputBase, OutputKeys
from modelscope.utils import logger as logging
from modelscope.utils.constant import Tasks
from modelscope.utils.hub import parse_label_mapping
logger = logging.get_logger()

@HEADS.register_module(Tasks.speaker_diarization_semantic_speaker_turn_detection, module_name=Heads.token_classification)
...
@MODELS.register_module(Tasks.speaker_diarization_semantic_speaker_turn_detection, module_name=TaskModels.token_classification)
...
@MODELS.register_module(Tasks.speaker_diarization_semantic_speaker_turn_detection, module_name=Models.bert)
