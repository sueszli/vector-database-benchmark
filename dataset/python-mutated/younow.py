...
class YouNowLiveIE(InfoExtractor):
    ...
    _TEST = {'url': 'https://www.younow.com/AmandaPadeezy', 'info_dict': {'id': 'AmandaPadeezy', 'ext': 'mp4', 'is_live': True, 'title': 'March 26, 2017', 'thumbnail': 're:^https?://.*\\.jpg$', 'tags': ['girls'], 'categories': ['girls'], 'uploader': 'AmandaPadeezy', 'uploader_id': '6716501', 'uploader_url': 'https://www.younow.com/AmandaPadeezy', 'creator': 'AmandaPadeezy'}, 'skip': True}
...
class YouNowChannelIE(InfoExtractor):
    ...
    _TEST = {'url': 'https://www.younow.com/its_Kateee_/channel', 'info_dict': {'id': '14629760', 'title': 'its_Kateee_ moments'}, 'playlist_mincount': 8}
...
class YouNowMomentIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?younow\\.com/[^/]+/(?P<id>[^/?#&]+)'
    _TEST = {'url': 'https://www.younow.com/GABO.../20712117/36319236/3b316doc/m', 'md5': 'a30c70eadb9fb39a1aa3c8c0d22a0807', 'info_dict': {'id': '20712117', 'ext': 'mp4', 'title': 'YouNow capture', 'view_count': int, 'like_count': int, 'timestamp': 1490432040, 'upload_date': '20170325', 'uploader': 'GABO...', 'uploader_id': 35917228}}
