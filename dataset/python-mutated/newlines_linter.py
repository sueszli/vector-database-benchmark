...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='native functions linter', fromfile_prefix_chars='@')
    parser.add_argument('--verbose', action='store_true', help='location of native_functions.yaml')
