...
class HacsAppdaemonRepository(HacsRepository):
    ...
    async def validate_repository(self):
        ...
        try:
            ...
            raise HacsException(f"{self.string} Repository structure for {self.ref.replace('tags/', '')} is not compliant") from None
        ...
        self.content.objects = await self.repository_object.get_contents(self.content.path.remote, self.ref)
