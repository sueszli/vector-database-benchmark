...
class OnetMVPIE(OnetBaseIE):
    ...
    _TEST = {'url': 'onetmvp:381027.1509591944', 'only_matching': True}
...
class OnetIE(OnetBaseIE):
    ...
    IE_NAME = 'onet.tv'
    _TESTS = [{'url': 'http://onet.tv/k/openerfestival/open-er-festival-2016-najdziwniejsze-wymagania-gwiazd/qbpyqc', 'md5': '436102770fb095c75b8bb0392d3da9ff', 'info_dict': {'id': 'qbpyqc', 'display_id': 'open-er-festival-2016-najdziwniejsze-wymagania-gwiazd', 'ext': 'mp4', 'title': "Open'er Festival 2016: najdziwniejsze wymagania gwiazd", 'description': 'Trzy samochody, których nigdy nie użyto, prywatne spa, hotel dekorowany czarnym suknem czy nielegalne używki. Organizatorzy koncertów i festiwali muszą stawać przed nie lada wyzwaniem zapraszając gwia...', 'upload_date': '20160705', 'timestamp': 1467721580}}, {'url': 'https://onet100.vod.pl/k/openerfestival/open-er-festival-2016-najdziwniejsze-wymagania-gwiazd/qbpyqc', 'only_matching': True}]
...
class OnetChannelIE(OnetBaseIE):
    ...
    _TESTS = [{'url': 'http://onet.tv/k/openerfestival', 'info_dict': {'id': 'openerfestival', 'title': "Open'er Festival", 'description': "Tak było na Open'er Festival 2016! Oglądaj nasze reportaże i wywiady z artystami."}, 'playlist_mincount': 35}, {'url': 'https://onet100.vod.pl/k/openerfestival', 'only_matching': True}]
