...
def GetAllProperties(obj, make_tag_names=True):
    ...
    for (tag, val) in data:
        ...
        ret.append((name, val))
    return ret
_MapiTypeMap = {float: mapitags.PT_DOUBLE, int: mapitags.PT_I4, bytes: mapitags.PT_STRING8, str: mapitags.PT_UNICODE, type(None): mapitags.PT_UNSPECIFIED, bool: mapitags.PT_BOOLEAN}
