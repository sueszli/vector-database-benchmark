...
class Campaigns(BingAdsCampaignManagementStream):
    ...
    additional_fields: Iterable[str] = ['AdScheduleUseSearcherTimeZone', 'BidStrategyId', 'CpvCpmBiddingScheme', 'DynamicDescriptionSetting', 'DynamicFeedSetting', 'MaxConversionValueBiddingScheme', 'MultimediaAdsBidAdjustment', 'TargetImpressionShareBiddingScheme', 'TargetSetting', 'VerifiedTrackingSetting']
    campaign_types: Iterable[str] = ['Audience', 'DynamicSearchAds', 'Search', 'Shopping']
    parent_key_to_foreign_key_map = {'AccountId': 'account_id', 'CustomerId': 'customer_id'}
...
class Ads(BingAdsCampaignManagementStream):
    ...
    ad_types: Iterable[str] = ['Text', 'Image', 'Product', 'AppInstall', 'ExpandedText', 'DynamicSearch', 'ResponsiveAd', 'ResponsiveSearch']
