...
class ForumTopic(TelegramObject):
    ...
    def __init__(self, message_thread_id: int, name: str, icon_color: int, icon_custom_emoji_id: Optional[str]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            while True:
                i = 10
...
class ForumTopicCreated(TelegramObject):
    ...
    def __init__(self, name: str, icon_color: int, icon_custom_emoji_id: Optional[str]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            i = 10
            return i + 15
        super().__init__(api_kwargs=api_kwargs)
