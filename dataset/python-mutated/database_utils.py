...
TEXT_SEARCH_LANGUAGE_MAPPING: dict[str, str] = {'ar': 'arabic', 'hy': 'armenian', 'eu': 'basque', 'ca': 'catalan', 'da': 'danish', 'nl': 'dutch', 'en': 'english', 'fi': 'finnish', 'fr': 'french', 'de': 'german', 'el': 'greek', 'ga': 'irish', 'hi': 'hindi', 'hu': 'hungarian', 'id': 'indonesian', 'it': 'italian', 'lt': 'lithuanian', 'ne': 'nepali', 'no': 'norwegian', 'pt': 'portuguese', 'ro': 'romanian', 'ru': 'russian', 'sr': 'serbian', 'ta': 'tamil', 'es': 'spanish', 'sv': 'swedish', 'tr': 'turkish', 'yi': 'yiddish'}
