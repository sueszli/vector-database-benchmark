...
class RaggedTensorValue:
  ...
  """
    ...
    row_splits = property(lambda self: self._row_splits, doc='The split indices for the ragged tensor value.')
    values = property(lambda self: self._values, doc='The concatenated values for all rows in this tensor.')
    dtype = property(lambda self: self._values.dtype, doc='The numpy dtype of values in this tensor.')
