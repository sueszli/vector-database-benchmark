...
@override_settings(WAGTAILFRONTENDCACHE={'varnish': {'BACKEND': 'wagtail.contrib.frontend_cache.backends.HTTPBackend', 'LOCATION': 'http://localhost:8000'}}, WAGTAILAPI_BASE_URL='http://api.example.com')
