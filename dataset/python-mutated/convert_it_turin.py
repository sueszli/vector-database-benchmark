...
UNKNOWN_SPLITS = set()
BIWORD_SPLITS = {'offertogli': ('offerto', 'gli'), 'offertegli': ('offerte', 'gli'), 'formatasi': ('formata', 'si'), 'formatosi': ('formato', 'si'), 'multiplexarlo': ('multiplexar', 'lo'), 'esibirsi': ('esibir', 'si'), 'pagarne': ('pagar', 'ne'), 'recarsi': ('recar', 'si'), 'trarne': ('trar', 'ne'), 'esserci': ('esser', 'ci'), 'aprirne': ('aprir', 'ne'), 'farle': ('far', 'le'), 'disporne': ('dispor', 'ne'), 'andargli': ('andar', 'gli'), 'CONSIDERARSI': ('CONSIDERAR', 'SI'), 'conferitegli': ('conferite', 'gli'), 'formatasi': ('formata', 'si'), 'formatosi': ('formato', 'si'), 'Formatisi': ('Formati', 'si'), 'multiplexarlo': ('multiplexar', 'lo'), 'esibirsi': ('esibir', 'si'), 'pagarne': ('pagar', 'ne'), 'recarsi': ('recar', 'si'), 'trarne': ('trar', 'ne'), 'temerne': ('temer', 'ne'), 'esserci': ('esser', 'ci'), 'esservi': ('esser', 'vi'), 'restituirne': ('restituir', 'ne'), 'col': ('con', 'il'), 'cogli': ('con', 'gli'), 'dirgli': ('dir', 'gli'), 'opporgli': ('oppor', 'gli'), 'eccolo': ('ecco', 'lo'), 'Eccolo': ('Ecco', 'lo'), 'Eccole': ('Ecco', 'le'), 'farci': ('far', 'ci'), 'farli': ('far', 'li'), 'farne': ('far', 'ne'), 'farsi': ('far', 'si'), 'farvi': ('far', 'vi'), 'Connettiti': ('Connetti', 'ti'), 'APPLICARSI': ('APPLICAR', 'SI'), 'assicurati': ('assicura', 'ti'), 'Fatti': ('Fai', 'te'), 'ai': ('a', 'i'), 'Ai': ('A', 'i'), 'AI': ('A', 'I'), 'al': ('a', 'il'), 'Al': ('A', 'il'), 'AL': ('A', 'IL'), 'coi': ('con', 'i'), 'colla': ('con', 'la'), 'colle': ('con', 'le'), 'dal': ('da', 'il'), 'Dal': ('Da', 'il'), 'DAL': ('DA', 'IL'), 'dei': ('di', 'i'), 'Dei': ('Di', 'i'), 'DEI': ('DI', 'I'), 'del': ('di', 'il'), 'Del': ('Di', 'il'), 'DEL': ('DI', 'IL'), 'nei': ('in', 'i'), 'NEI': ('IN', 'I'), 'nel': ('in', 'il'), 'Nel': ('In', 'il'), 'NEL': ('IN', 'IL'), 'pel': ('per', 'il'), 'sui': ('su', 'i'), 'Sui': ('Su', 'i'), 'sul': ('su', 'il'), 'Sul': ('Su', 'il'), ',': (',', ','), '.': ('.', '.'), '"': ('"', '"'), '-': ('-', '-'), '-LRB-': ('-LRB-', '-LRB-'), 'garantirne': ('garantir', 'ne'), 'aprirvi': ('aprir', 'vi'), 'esimersi': ('esimer', 'si'), 'opporsi': ('oppor', 'si')}
