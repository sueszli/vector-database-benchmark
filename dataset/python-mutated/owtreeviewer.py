...
import numpy as np
from AnyQt.QtWidgets import QGraphicsRectItem, QGraphicsTextItem, QSizePolicy, QStyle, QLabel, QComboBox
...
class OWTreeGraph(OWTreeViewer2D):
    ...
    replaces = ['Orange.widgets.classify.owclassificationtreegraph.OWClassificationTreeGraph', 'Orange.widgets.classify.owregressiontreegraph.OWRegressionTreeGraph']
