...
from typing import Collection, Dict, List, Mapping, NamedTuple, Optional, Sequence, Tuple, Type, Union, cast
import dagster._check as check
from dagster._annotations import PublicAttr, experimental, public
from dagster._core.definitions.multi_dimensional_partitions import MultiPartitionKey, MultiPartitionsDefinition
from dagster._core.definitions.partition import PartitionsDefinition, PartitionsSubset, StaticPartitionsDefinition
...
@whitelist_for_serdes
class SpecificPartitionsPartitionMapping(PartitionMapping, NamedTuple('_SpecificPartitionsPartitionMapping', [('partition_keys', PublicAttr[Sequence[str]])])):
...
@experimental
@whitelist_for_serdes
class MultiToSingleDimensionPartitionMapping(BaseMultiPartitionMapping, PartitionMapping, NamedTuple('_MultiToSingleDimensionPartitionMapping', [('partition_dimension_name', Optional[str])])):
...
@whitelist_for_serdes
class DimensionPartitionMapping(NamedTuple('_DimensionPartitionMapping', [('dimension_name', str), ('partition_mapping', PartitionMapping)])):
...
@experimental
@whitelist_for_serdes
class MultiPartitionMapping(BaseMultiPartitionMapping, PartitionMapping, NamedTuple('_MultiPartitionMapping', [('downstream_mappings_by_upstream_dimension', Mapping[str, DimensionPartitionMapping])])):
...
@whitelist_for_serdes
class StaticPartitionMapping(PartitionMapping, NamedTuple('_StaticPartitionMapping', [('downstream_partition_keys_by_upstream_partition_key', PublicAttr[Mapping[str, Union[str, Collection[str]]]])])):
...
class InferSingleToMultiDimensionDepsResult(NamedTuple('_InferSingleToMultiDimensionDepsResult', [('can_infer', bool), ('inference_failure_reason', Optional[str]), ('dimension_dependency', Optional[DimensionDependency])])):
