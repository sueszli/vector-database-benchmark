...
from ..utils import MONTH_NAMES, clean_html, get_element_by_class, get_element_by_id, int_or_none, js_to_json, qualities, unified_strdate

class MyVideoGeIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?myvideo\\.ge/v/(?P<id>[0-9]+)'
    _TEST = {'url': 'https://www.myvideo.ge/v/3941048', 'md5': '8c192a7d2b15454ba4f29dc9c9a52ea9', 'info_dict': {'id': '3941048', 'ext': 'mp4', 'title': 'The best prikol', 'upload_date': '20200611', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'chixa33', 'description': 'md5:5b067801318e33c2e6eea4ab90b1fdd3'}}
