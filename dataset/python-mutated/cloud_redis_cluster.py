...
import proto
__protobuf__ = proto.module(package='google.cloud.redis.cluster.v1', manifest={'AuthorizationMode', 'TransitEncryptionMode', 'CreateClusterRequest', 'ListClustersRequest', 'ListClustersResponse', 'UpdateClusterRequest', 'GetClusterRequest', 'DeleteClusterRequest', 'Cluster', 'PscConfig', 'DiscoveryEndpoint', 'PscConnection', 'OperationMetadata'})
...
class UpdateClusterRequest(proto.Message):
    ...
    cluster: 'Cluster' = proto.Field(proto.MESSAGE, number=2, message='Cluster')
...
class Cluster(proto.Message):
    ...
    class StateInfo(proto.Message):
        """Represents additional information about the state of the
        cluster.
        ...
        class UpdateInfo(proto.Message):
            ...
            """
            target_shard_count: int = proto.Field(proto.INT32, number=1, optional=True)
            target_replica_count: int = proto.Field(proto.INT32, number=2, optional=True)
        update_info: 'Cluster.StateInfo.UpdateInfo' = proto.Field(proto.MESSAGE, number=1, oneof='info', message='Cluster.StateInfo.UpdateInfo')
    name: str = proto.Field(proto.STRING, number=1)
    ...
    uid: str = proto.Field(proto.STRING, number=5)
    replica_count: int = proto.Field(proto.INT32, number=8, optional=True)
    authorization_mode: 'AuthorizationMode' = proto.Field(proto.ENUM, number=11, enum='AuthorizationMode')
    transit_encryption_mode: 'TransitEncryptionMode' = proto.Field(proto.ENUM, number=12, enum='TransitEncryptionMode')
    size_gb: int = proto.Field(proto.INT32, number=13, optional=True)
    shard_count: int = proto.Field(proto.INT32, number=14, optional=True)
    psc_configs: MutableSequence['PscConfig'] = proto.RepeatedField(proto.MESSAGE, number=15, message='PscConfig')
    discovery_endpoints: MutableSequence['DiscoveryEndpoint'] = proto.RepeatedField(proto.MESSAGE, number=16, message='DiscoveryEndpoint')
    psc_connections: MutableSequence['PscConnection'] = proto.RepeatedField(proto.MESSAGE, number=17, message='PscConnection')
    state_info: StateInfo = proto.Field(proto.MESSAGE, number=18, message=StateInfo)
...
class DiscoveryEndpoint(proto.Message):
    """Endpoints on each network, for Redis clients to connect to
    the cluster.
    ...
    """
    address: str = proto.Field(proto.STRING, number=1)
    port: int = proto.Field(proto.INT32, number=2)
    psc_config: 'PscConfig' = proto.Field(proto.MESSAGE, number=3, message='PscConfig')
...
class PscConnection(proto.Message):
    ...
    """
    psc_connection_id: str = proto.Field(proto.STRING, number=1)
    address: str = proto.Field(proto.STRING, number=2)
    forwarding_rule: str = proto.Field(proto.STRING, number=3)
    project_id: str = proto.Field(proto.STRING, number=4)
    network: str = proto.Field(proto.STRING, number=5)
