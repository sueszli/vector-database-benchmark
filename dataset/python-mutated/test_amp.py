...
class AddErrorsCommand(BaseCommand):
    ...
    errors: Dict[Type[Exception], bytes] = {OtherInheritedError: b'OTHER_INHERITED_ERROR'}
...
class ListOfUnicodeTests(TestCase, ListOfTestsMixin):
    ...
    strings = {b'empty': b'', b'single': b'\x00\x03foo', b'multiple': b'\x00\x03\xe2\x98\x83\x00\x05Hello\x00\x05world'}
    objects = {'empty': [], 'single': ['foo'], 'multiple': ['☃', 'Hello', 'world']}
