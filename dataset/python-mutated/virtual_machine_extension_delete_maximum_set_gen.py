...
def main():
    ...
    client.virtual_machine_extensions.begin_delete(resource_group_name='rgcompute', vm_name='aaaaaaaaaaaaa', vm_extension_name='aaaaaaaaaaaaaaaaaaaaaaaaaaaaa').result()
