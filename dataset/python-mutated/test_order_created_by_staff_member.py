...
@pytest.mark.e2e
def test_order_created_by_staff_member_CORE_0201(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders):
    if False:
        for i in range(10):
            print('nop')
    ...
    input = {'userEmail': 'test_user@test.com', 'shippingAddress': DEFAULT_ADDRESS, 'billingAddress': DEFAULT_ADDRESS}
