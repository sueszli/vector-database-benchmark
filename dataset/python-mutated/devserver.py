...
_DEV_METRICS_INDEXER_ARGS = ['--processes', '1', '--auto-offset-reset', 'latest', '--no-strict-offset-reset']
_DEFAULT_DAEMONS = {'worker': ['sentry', 'run', 'worker', '-c', '1', '--autoreload'], 'celery-beat': ['sentry', 'run', 'cron', '--autoreload'], 'server': ['sentry', 'run', 'web']}
_SUBSCRIPTION_RESULTS_CONSUMERS = ['events-subscription-results', 'transactions-subscription-results', 'generic-metrics-subscription-results', 'sessions-subscription-results', 'metrics-subscription-results']
