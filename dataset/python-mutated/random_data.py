...
from ...attribute.models import AssignedProductAttributeValue, AssignedVariantAttribute, AssignedVariantAttributeValue, Attribute, AttributePage, AttributeProduct, AttributeValue, AttributeVariant
...
from ...discount.models import Promotion, PromotionRule, Voucher, VoucherChannelListing, VoucherCode
...
from ...permission.enums import AccountPermissions, CheckoutPermissions, GiftcardPermissions, OrderPermissions, get_permissions
from ...permission.models import Permission
from ...plugins.manager import get_plugins_manager
from ...product.models import Category, Collection, CollectionChannelListing, CollectionProduct, Product, ProductChannelListing, ProductMedia, ProductType, ProductVariant, ProductVariantChannelListing, VariantMedia
from ...product.search import update_products_search_vector
from ...product.tasks import update_products_discounted_prices_of_promotion_task
from ...shipping.models import ShippingMethod, ShippingMethodChannelListing, ShippingMethodType, ShippingZone
...
IMAGES_MAPPING = {126: ['saleor-headless-omnichannel-book.png'], 127: ['saleor-white-plimsolls-1.png', 'saleor-white-plimsolls-2.png', 'saleor-white-plimsolls-3.png', 'saleor-white-plimsolls-4.png'], 128: ['saleor-blue-plimsolls-1.png', 'saleor-blue-plimsolls-2.png', 'saleor-blue-plimsolls-3.png', 'saleor-blue-plimsolls-4.png'], 129: ['saleor-dash-force-1.png', 'saleor-dash-force-2.png'], 130: ['saleor-pauls-blanace-420-1.png', 'saleor-pauls-blanace-420-2.png'], 131: ['saleor-grey-hoodie.png'], 132: ['saleor-blue-hoodie.png'], 133: ['saleor-white-hoodie.png'], 134: ['saleor-ascii-shirt-front.png', 'saleor-ascii-shirt-back.png'], 135: ['saleor-team-tee-front.png', 'saleor-team-tee-front.png'], 136: ['saleor-polo-shirt-front.png', 'saleor-polo-shirt-back.png'], 137: ['saleor-blue-polygon-tee-front.png', 'saleor-blue-polygon-tee-back.png'], 138: ['saleor-dark-polygon-tee-front.png', 'saleor-dark-polygon-tee-back.png'], 141: ['saleor-beanie-1.png', 'saleor-beanie-2.png'], 143: ['saleor-neck-warmer.png'], 144: ['saleor-sunnies.png'], 145: ['saleor-battle-tested-book.png'], 146: ['saleor-enterprise-cloud-book.png'], 147: ['saleor-own-your-stack-and-data-book.png'], 150: ['saleor-mighty-mug.png'], 151: ['saleor-cushion-blue.png'], 152: ['saleor-apple-drink.png'], 153: ['saleor-bean-drink.png'], 154: ['saleor-banana-drink.png'], 155: ['saleor-carrot-drink.png'], 156: ['saleor-sunnies-dark.png'], 157: ['saleor-monospace-white-tee-front.png', 'saleor-monospace-white-tee-back.png'], 160: ['saleor-gift-100.png'], 161: ['saleor-white-cubes-tee-front.png', 'saleor-white-cubes-tee-back.png'], 162: ['saleor-white-parrot-cushion.png'], 163: ['saleor-gift-500.png'], 164: ['saleor-gift-50.png']}
