...
from ...operations._views_operations import build_create_or_update_by_scope_request, build_create_or_update_request, build_delete_by_scope_request, build_delete_request, build_get_by_scope_request, build_get_request, build_list_by_scope_request, build_list_request
T = TypeVar('T')
...
class ViewsOperations:
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
        ...
        def prepare_request(next_link=None):
            if False:
                for i in range(10):
                    print('nop')
            if not next_link:
                request = build_list_by_scope_request(scope=scope, api_version=api_version, template_url=self.list_by_scope.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    async def get(self, view_name: str, **kwargs: Any) -> _models.View:
        ...
        request = build_get_request(view_name=view_name, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update(self, view_name: str, parameters: _models.View, *, content_type: str='application/json', **kwargs: Any) -> _models.View:
    ...
    @overload
    async def create_or_update(self, view_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.View:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @distributed_trace_async
    async def create_or_update(self, view_name: str, parameters: Union[_models.View, IO], **kwargs: Any) -> _models.View:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
        ...
        request = build_create_or_update_request(view_name=view_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete(self, view_name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(view_name=view_name, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get_by_scope(self, scope: str, view_name: str, **kwargs: Any) -> _models.View:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.View] = kwargs.pop('cls', None)
        request = build_get_by_scope_request(scope=scope, view_name=view_name, api_version=api_version, template_url=self.get_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update_by_scope(self, scope: str, view_name: str, parameters: _models.View, *, content_type: str='application/json', **kwargs: Any) -> _models.View:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @overload
    async def create_or_update_by_scope(self, scope: str, view_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.View:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @distributed_trace_async
    async def create_or_update_by_scope(self, scope: str, view_name: str, parameters: Union[_models.View, IO], **kwargs: Any) -> _models.View:
        """The operation to create or update a view. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, 'View')
        request = build_create_or_update_by_scope_request(scope=scope, view_name=view_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete_by_scope(self, scope: str, view_name: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_by_scope_request(scope=scope, view_name=view_name, api_version=api_version, template_url=self.delete_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
