...
from .._models import ChatThreadProperties, ChatParticipant, CreateChatThreadResult
...
class ChatClient(object):
    ...
    async def create_chat_thread(self, topic: str, **kwargs) -> CreateChatThreadResult:
        ...
        create_chat_thread_result = await self._client.chat.create_chat_thread(create_chat_thread_request=create_thread_request, repeatability_request_id=idempotency_token, **kwargs)
        errors = None
        ...
        chat_thread = ChatThreadProperties._from_generated(create_chat_thread_result.chat_thread)
