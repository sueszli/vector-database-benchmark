...
def process_ptb3_revised(paths, dataset_name, *args):
    ...
    write_dataset(datasets, output_dir, dataset_name)
DATASET_MAPPING = {'da_arboretum': process_arboretum, 'en_ptb3-revised': process_ptb3_revised, 'id_icon': process_id_icon, 'it_turin': process_it_turin, 'it_vit': process_it_vit, 'ja_alt': process_ja_alt, 'pt_cintil': process_pt_cintil, 'tr_starlang': process_starlang, 'vi_vlsp09': process_vlsp09, 'vi_vlsp21': process_vlsp21, 'vi_vlsp22': process_vlsp22, 'zh-hans_ctb-51': process_ctb_51, 'zh-hans_ctb-90': process_ctb_90}
