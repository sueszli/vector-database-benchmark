...
import subprocess
import string
from ctypes import ARRAY, c_char, c_uint16, c_uint32, c_uint8, Structure, sizeof
from importlib.machinery import SourceFileLoader
from SingleSign import single_sign_gen_pub_key
PUB_KEY_TYPE = {'RSA': 1, 'ECC': 2, 'DSA': 3}
SIGN_TYPE_SCHEME = {'RSA_PKCS1': 1, 'RSA_PSS': 2, 'ECC': 3, 'DSA': 4}
HASH_TYPE_VALUE = {'SHA2_256': 1, 'SHA2_384': 2, 'SHA2_512': 3, 'SM3_256': 4}
HASH_VAL_STRING = dict(map(reversed, HASH_TYPE_VALUE.items()))
AUTH_TYPE_HASH_VALUE = {'SHA2_256': 1, 'SHA2_384': 2, 'SHA2_512': 3, 'SM3_256': 4, 'RSA2048SHA256': 1, 'RSA3072SHA384': 2}
HASH_DIGEST_SIZE = {'SHA2_256': 32, 'SHA2_384': 48, 'SHA2_512': 64, 'SM3_256': 32}

class PUB_KEY_HDR(Structure):
    _pack_ = 1
    _fields_ = [('Identifier', ARRAY(c_char, 4)), ('KeySize', c_uint16), ('KeyType', c_uint8), ('Reserved', ARRAY(c_uint8, 1)), ('KeyData', ARRAY(c_uint8, 0))]
...
class SIGNATURE_HDR(Structure):
    _pack_ = 1
    _fields_ = [('Identifier', ARRAY(c_char, 4)), ('SigSize', c_uint16), ('SigType', c_uint8), ('HashAlg', c_uint8), ('Signature', ARRAY(c_uint8, 0))]
...
class LZ_HEADER(Structure):
    _pack_ = 1
    _fields_ = [('signature', ARRAY(c_char, 4)), ('compressed_len', c_uint32), ('length', c_uint32), ('version', c_uint16), ('svn', c_uint8), ('attribute', c_uint8)]
    _compress_alg = {b'LZDM': 'Dummy', b'LZ4 ': 'Lz4', b'LZMA': 'Lzma'}
