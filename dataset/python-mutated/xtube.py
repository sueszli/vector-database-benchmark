...
from ..utils import int_or_none, js_to_json, orderedSet, parse_duration, str_to_int, url_or_none

class XTubeIE(InfoExtractor):
    _VALID_URL = '(?x)\n                        (?:\n                            xtube:|\n                            https?://(?:www\\.)?xtube\\.com/(?:watch\\.php\\?.*\\bv=|video-watch/(?:embedded/)?(?P<display_id>[^/]+)-)\n                        )\n                        (?P<id>[^/?&#]+)\n                    '
    _TESTS = [{'url': 'http://www.xtube.com/watch.php?v=kVTUy_G222_', 'md5': '092fbdd3cbe292c920ef6fc6a8a9cdab', 'info_dict': {'id': 'kVTUy_G222_', 'ext': 'mp4', 'title': 'strange erotica', 'description': 'contains:an ET kind of thing', 'uploader': 'greenshowers', 'duration': 450, 'view_count': int, 'comment_count': int, 'age_limit': 18}}, {'url': 'http://www.xtube.com/video-watch/strange-erotica-625837', 'only_matching': True}, {'url': 'xtube:625837', 'only_matching': True}, {'url': 'xtube:kVTUy_G222_', 'only_matching': True}, {'url': 'https://www.xtube.com/video-watch/embedded/milf-tara-and-teen-shared-and-cum-covered-extreme-bukkake-32203482?embedsize=big', 'only_matching': True}]
...
class XTubeUserIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.xtube.com/profile/greenshowers-4056496', 'info_dict': {'id': 'greenshowers-4056496', 'age_limit': 18}, 'playlist_mincount': 154}
