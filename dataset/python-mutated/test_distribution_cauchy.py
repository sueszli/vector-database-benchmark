...
@place(DEVICES)
@parameterize_cls((TEST_CASE_NAME, 'loc', 'scale', 'default_dtype', 'expected_dtype'), [('params_0d_32_1', paddle.full((), 0.1), paddle.full((), 1.2), 'float32', 'float32'), ('params_0d_32_2', paddle.full((), -1.2), paddle.full((), 2.3), 'float32', 'float32'), ('params_0d_64_1', paddle.full((), 0.1, dtype='float64'), paddle.full((), 1.2, dtype='float64'), 'float64', 'float64'), ('params_0d_64_2', paddle.full((), -1.2, dtype='float64'), paddle.full((), 2.3, dtype='float64'), 'float64', 'float64'), ('params_float_1', 0.1, 1.2, 'float64', 'float32'), ('params_float_2', -1.2, 2.3, 'float64', 'float32'), ('params_tensor_32_1', paddle.to_tensor(0.1), paddle.to_tensor(1.2), 'float32', 'float32'), ('params_tensor_32_2', paddle.to_tensor(-1.2), paddle.to_tensor(2.3), 'float32', 'float32'), ('params_tensor_64_1', paddle.to_tensor(0.1, dtype='float64'), paddle.to_tensor(1.2, dtype='float64'), 'float64', 'float64'), ('params_tensor_64_2', paddle.to_tensor(-1.2, dtype='float64'), paddle.to_tensor(2.3, dtype='float64'), 'float64', 'float64'), ('params_tensor_list', paddle.to_tensor([0.1]), paddle.to_tensor([1.2]), 'float32', 'float32'), ('params_tensor_tuple', paddle.to_tensor((0.1,)), paddle.to_tensor((1.2,)), 'float32', 'float32'), ('params_0d_1d_1', paddle.full((), 0.1), paddle.full((1,), 1.2), 'float32', 'float32'), ('params_0d_1d_2', paddle.full((), 0.1), paddle.to_tensor(1.2), 'float32', 'float32'), ('params_1d_0d_1', paddle.full((1,), 0.1), paddle.full((), 1.2), 'float32', 'float32'), ('params_1d_0d_2', paddle.to_tensor(0.1), paddle.full((), 1.2), 'float32', 'float32'), ('params_0d_3d', paddle.full((), 0.1), paddle.to_tensor([1.1, 2.2, 3.3]), 'float32', 'float32'), ('params_3d_0d', paddle.to_tensor([0.1, -0.2, 0.3]), paddle.full((), 1.2), 'float32', 'float32'), ('params_1d_3d', paddle.full((1,), 0.1), paddle.to_tensor([1.1, 2.2, 3.3]), 'float32', 'float32'), ('params_3d_1d', paddle.to_tensor([0.1, -0.2, 0.3]), paddle.full((1,), 1.2), 'float32', 'float32'), ('params_3d_3d', paddle.to_tensor([0.1, -0.2, 0.3]), paddle.to_tensor([1.1, 2.2, 3.3]), 'float32', 'float32')])
...
@place(DEVICES)
@parameterize_cls((TEST_CASE_NAME, 'loc', 'scale', 'default_dtype', 'expected_dtype', 'shape', 'expected_shape'), [('params_0d_0d_sample_1d', paddle.full((), 0.1), paddle.full((), 1.2), 'float32', 'float32', [100], [100]), ('params_0d_0d_sample_2d', paddle.full((), 0.1), paddle.full((), 1.2), 'float32', 'float32', [100, 1], [100, 1]), ('params_0d_0d_sample_3d', paddle.full((), 0.1), paddle.full((), 1.2), 'float32', 'float32', [100, 2, 3], [100, 2, 3]), ('params_1d_1d_sample_1d_float', 0.1, 1.2, 'float64', 'float32', paddle.to_tensor([100]), [100]), ('params_1d_1d_sample_1d_32', paddle.to_tensor([0.1]), paddle.to_tensor([1.2]), 'float32', 'float32', paddle.to_tensor([100]), [100, 1]), ('params_1d_1d_sample_1d_64', paddle.to_tensor([0.1], dtype='float64'), paddle.to_tensor([1.2], dtype='float64'), 'float64', 'float64', paddle.to_tensor([100]), [100, 1]), ('params_1d_1d_sample_2d', paddle.to_tensor([0.1]), paddle.to_tensor([1.2]), 'float32', 'float32', [100, 2], [100, 2, 1]), ('params_1d_1d_sample_3d', paddle.to_tensor([0.1]), paddle.to_tensor([1.2]), 'float32', 'float32', [100, 2, 3], [100, 2, 3, 1]), ('params_0d_1d_sample_1d', paddle.full((), 0.3), paddle.to_tensor([1.2]), 'float32', 'float32', [100], [100, 1]), ('params_1d_0d_sample_1d', paddle.to_tensor([0.3]), paddle.full((), 1.2), 'float32', 'float32', [100], [100, 1]), ('params_0d_1d_sample_2d', paddle.full((), 0.3), paddle.to_tensor([1.2]), 'float32', 'float32', [100, 2], [100, 2, 1]), ('params_1d_0d_sample_2d', paddle.to_tensor([0.3]), paddle.full((), 1.2), 'float32', 'float32', [100, 2], [100, 2, 1]), ('params_1d_2d_sample_1d', paddle.to_tensor([0.3]), paddle.to_tensor((1.2, 2.3)), 'float32', 'float32', [100], [100, 2]), ('params_2d_1d_sample_1d', paddle.to_tensor((0.3, -0.3)), paddle.to_tensor([1.2]), 'float32', 'float32', [100], [100, 2]), ('params_2d_2d_sample_1d', paddle.to_tensor((0.3, -0.3)), paddle.to_tensor((1.2, 2.3)), 'float32', 'float32', [100], [100, 2]), ('params_2d_2d_sample_2d', paddle.to_tensor((0.3, -0.3)), paddle.to_tensor((1.2, 2.3)), 'float32', 'float32', [100, 1], [100, 1, 2]), ('params_1d_2d_sample_3d', paddle.to_tensor([0.3]), paddle.to_tensor((1.2, 2.3)), 'float32', 'float32', [100, 1, 2], [100, 1, 2, 2])])
