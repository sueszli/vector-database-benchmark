...
class StoryChange(change_domain.BaseChange):
    ...
    """
    STORY_PROPERTIES: List[str] = [STORY_PROPERTY_TITLE, STORY_PROPERTY_THUMBNAIL_BG_COLOR, STORY_PROPERTY_THUMBNAIL_FILENAME, STORY_PROPERTY_DESCRIPTION, STORY_PROPERTY_NOTES, STORY_PROPERTY_LANGUAGE_CODE, STORY_PROPERTY_URL_FRAGMENT, STORY_PROPERTY_META_TAG_CONTENT]
    STORY_NODE_PROPERTIES: List[str] = [STORY_NODE_PROPERTY_DESTINATION_NODE_IDS, STORY_NODE_PROPERTY_ACQUIRED_SKILL_IDS, STORY_NODE_PROPERTY_PREREQUISITE_SKILL_IDS, STORY_NODE_PROPERTY_OUTLINE, STORY_NODE_PROPERTY_EXPLORATION_ID, STORY_NODE_PROPERTY_TITLE, STORY_NODE_PROPERTY_DESCRIPTION, STORY_NODE_PROPERTY_THUMBNAIL_BG_COLOR, STORY_NODE_PROPERTY_THUMBNAIL_FILENAME, STORY_NODE_PROPERTY_STATUS, STORY_NODE_PROPERTY_PLANNED_PUBLICATION_DATE, STORY_NODE_PROPERTY_LAST_MODIFIED, STORY_NODE_PROPERTY_FIRST_PUBLICATION_DATE, STORY_NODE_PROPERTY_UNPUBLISHING_REASON]
    STORY_CONTENTS_PROPERTIES: List[str] = [INITIAL_NODE_ID, NODE]
    ALLOWED_COMMANDS: List[feconf.ValidCmdDict] = [{'name': CMD_UPDATE_STORY_PROPERTY, 'required_attribute_names': ['property_name', 'new_value', 'old_value'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {'property_name': STORY_PROPERTIES}, 'deprecated_values': {}}, {'name': CMD_UPDATE_STORY_NODE_PROPERTY, 'required_attribute_names': ['node_id', 'property_name', 'new_value', 'old_value'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {'property_name': STORY_NODE_PROPERTIES}, 'deprecated_values': {}}, {'name': CMD_UPDATE_STORY_CONTENTS_PROPERTY, 'required_attribute_names': ['property_name', 'new_value', 'old_value'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {'property_name': STORY_CONTENTS_PROPERTIES}, 'deprecated_values': {}}, {'name': CMD_ADD_STORY_NODE, 'required_attribute_names': ['node_id', 'title'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}, {'name': CMD_DELETE_STORY_NODE, 'required_attribute_names': ['node_id'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}, {'name': CMD_UPDATE_STORY_NODE_OUTLINE_STATUS, 'required_attribute_names': ['node_id', 'old_value', 'new_value'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}, {'name': CMD_CREATE_NEW, 'required_attribute_names': ['title'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}, {'name': CMD_MIGRATE_SCHEMA_TO_LATEST_VERSION, 'required_attribute_names': ['from_version', 'to_version'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}]
