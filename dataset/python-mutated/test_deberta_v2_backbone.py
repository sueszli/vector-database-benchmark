...
from modelscope.models.nlp.deberta_v2 import DebertaV2ForMaskedLM, DebertaV2Model
...
class DebertaV2BackboneTest(unittest.TestCase):
    ...
    def test_load_model(self):
        ...
        model = Model.from_pretrained('damo/nlp_debertav2_fill-mask_chinese-lite', task=Tasks.backbone)
