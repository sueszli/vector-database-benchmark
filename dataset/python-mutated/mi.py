...
class MiTTS(TTS):
    ...
    def __init__(self, mina_service: MiNAService, device_id: str, config: Config) -> None:
        if False:
            i = 10
            return i + 15
    ...
    async def say(self, text: str) -> None:
        if not self.config.use_command:
            ...
            await miio_command(self.miio_service, self.config.mi_did, f'{self.config.tts_command} {text}')
