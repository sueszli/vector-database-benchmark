...
_DESTINATION_ELEMENT_PAIRS = [('project1:dataset1.table1', {'name': 'beam', 'language': 'py'}), ('project1:dataset1.table1', {'name': 'beam', 'language': 'java'}), ('project1:dataset1.table1', {'name': 'beam', 'language': 'go'}), ('project1:dataset1.table1', {'name': 'flink', 'language': 'java'}), ('project1:dataset1.table1', {'name': 'flink', 'language': 'scala'}), ('project1:dataset1.table3', {'name': 'spark', 'language': 'scala'}), ('project1:dataset1.table1', {'name': 'spark', 'language': 'py'}), ('project1:dataset1.table1', {'name': 'spark', 'language': 'scala'}), ('project1:dataset1.table2', {'name': 'beam', 'foundation': 'apache'}), ('project1:dataset1.table2', {'name': 'flink', 'foundation': 'apache'}), ('project1:dataset1.table2', {'name': 'spark', 'foundation': 'apache'})]
...
_ELEMENTS_SCHEMA = bigquery.WriteToBigQuery.get_dict_table_schema(bigquery_api.TableSchema(fields=[bigquery_api.TableFieldSchema(name='name', type='STRING', mode='REQUIRED'), bigquery_api.TableFieldSchema(name='language', type='STRING'), bigquery_api.TableFieldSchema(name='foundation', type='STRING')]))
...
class TestPartitionFiles(unittest.TestCase):
    _ELEMENTS = [('destination0', [('file0', 50), ('file1', 50), ('file2', 50), ('file3', 50)]), ('destination1', [('file0', 50), ('file1', 50)])]
...
class BigQueryFileLoadsIT(unittest.TestCase):
    ...
    BIG_QUERY_SCHEMA = '{"fields": [{"name": "name","type": "STRING"},{"name": "language","type": "STRING"}]}'
    BIG_QUERY_SCHEMA_2 = '{"fields": [{"name": "name","type": "STRING"},{"name": "foundation","type": "STRING"}]}'
    BIG_QUERY_STREAMING_SCHEMA = {'fields': [{'name': 'Integr', 'type': 'INTEGER', 'mode': 'NULLABLE'}]}
