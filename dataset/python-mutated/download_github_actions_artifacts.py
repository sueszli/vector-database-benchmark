...
if __name__ == '__main__':
    print('Starting script for download GitHub Actions artifacts for Build Wheels workflow')
    (github_token, repo_url, rc_tag, release_commit, artifacts_dir, rc_number, skip_prompts) = parse_arguments()
    try:
        workflow_id = get_build_wheels_workflow_id(repo_url, github_token)
        run_id = get_last_run_id(workflow_id, repo_url, rc_tag, release_commit, github_token)
