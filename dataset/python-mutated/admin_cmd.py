...
class AdminCmdStore(FilteringWorkerStore, ClientIpWorkerStore, DeviceWorkerStore, TagsWorkerStore, DeviceInboxWorkerStore, AccountDataWorkerStore, PushRulesWorkerStore, ApplicationServiceTransactionWorkerStore, ApplicationServiceWorkerStore, RoomMemberWorkerStore, RelationsWorkerStore, EventFederationWorkerStore, EventPushActionsWorkerStore, StateGroupWorkerStore, SignatureWorkerStore, UserErasureWorkerStore, ReceiptsWorkerStore, StreamWorkerStore, EventsWorkerStore, RegistrationWorkerStore, RoomWorkerStore, ProfileWorkerStore, MediaRepositoryStore):
...
async def export_data_command(hs: HomeServer, args: argparse.Namespace) -> None:
    ...
    res = await hs.get_admin_handler().export_user_data(user_id, FileExfiltrationWriter(user_id, directory=directory))
    print(res)
