...
import attr
from attr._make import NOTHING, Factory, _add_repr, _is_slot_cls, _make_init, fields, make_class
...
HashCSlotsCached = simple_class(hash=None, eq=True, frozen=True, slots=True, cache_hash=True)
HashCFrozenNotSlotsCached = simple_class(frozen=True, slots=False, hash=True, cache_hash=True)
