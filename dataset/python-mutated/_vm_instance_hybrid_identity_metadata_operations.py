...
def build_get_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata/default')
...
def build_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2023-10-01'))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata')
    path_format_arguments = {'resourceUri': _SERIALIZER.url('resource_uri', resource_uri, 'str', skip_quote=True)}
    _url: str = _url.format(**path_format_arguments)
    _params['api-version'] = _SERIALIZER.query('api_version', api_version, 'str')
    _headers['Accept'] = _SERIALIZER.header('accept', accept, 'str')
...
class VmInstanceHybridIdentityMetadataOperations:
    ...
    def get(self, resource_uri: str, **kwargs: Any) -> _models.VmInstanceHybridIdentityMetadata:
        ...
        return deserialized
    get.metadata = {'url': '/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata/default'}
    ...
    list.metadata = {'url': '/{resourceUri}/providers/Microsoft.ConnectedVMwarevSphere/virtualMachineInstances/default/hybridIdentityMetadata'}