...
CONDITIONAL_DETR_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/conditional-detr-resnet-50': 'https://huggingface.co/microsoft/conditional-detr-resnet-50/resolve/main/config.json'}
