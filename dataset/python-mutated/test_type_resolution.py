...
from returns.context import Reader, RequiresContext, RequiresContextFutureResult, RequiresContextIOResult, RequiresContextResult, RequiresContextResultE
...
_all_containers: Sequence[Type[Lawful]] = (Maybe, Result, IO, IOResult, Future, FutureResult, RequiresContext, RequiresContextResult, RequiresContextIOResult, RequiresContextFutureResult, ResultE, Reader, RequiresContextResultE)
