...
__protobuf__ = proto.module(package='google.cloud.dialogflow.v2', manifest={'Participant', 'Message', 'CreateParticipantRequest', 'GetParticipantRequest', 'ListParticipantsRequest', 'ListParticipantsResponse', 'UpdateParticipantRequest', 'AnalyzeContentRequest', 'DtmfParameters', 'AnalyzeContentResponse', 'StreamingAnalyzeContentRequest', 'StreamingAnalyzeContentResponse', 'SuggestArticlesRequest', 'SuggestArticlesResponse', 'SuggestFaqAnswersRequest', 'SuggestFaqAnswersResponse', 'SuggestSmartRepliesRequest', 'SuggestSmartRepliesResponse', 'OutputAudio', 'AutomatedAgentReply', 'ArticleAnswer', 'FaqAnswer', 'SmartReplyAnswer', 'IntentSuggestion', 'DialogflowAssistAnswer', 'SuggestionResult', 'InputTextConfig', 'AnnotatedMessagePart', 'MessageAnnotation', 'SuggestionInput', 'AssistQueryParameters'})
...
class Participant(proto.Message):
    ...
    role: Role = proto.Field(proto.ENUM, number=2, enum=Role)
    sip_recording_media_label: str = proto.Field(proto.STRING, number=6)
    obfuscated_external_user_id: str = proto.Field(proto.STRING, number=7)
    documents_metadata_filters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=8)
...
class Message(proto.Message):
    ...
    participant: str = proto.Field(proto.STRING, number=4)
    participant_role: 'Participant.Role' = proto.Field(proto.ENUM, number=5, enum='Participant.Role')
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    send_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    message_annotation: 'MessageAnnotation' = proto.Field(proto.MESSAGE, number=7, message='MessageAnnotation')
    sentiment_analysis: session.SentimentAnalysisResult = proto.Field(proto.MESSAGE, number=8, message=session.SentimentAnalysisResult)
...
class CreateParticipantRequest(proto.Message):
    ...
    participant: 'Participant' = proto.Field(proto.MESSAGE, number=2, message='Participant')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    participants: MutableSequence['Participant'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Participant')
...
class UpdateParticipantRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            update.
    """
    participant: 'Participant' = proto.Field(proto.MESSAGE, number=1, message='Participant')
...
class AnalyzeContentRequest(proto.Message):
    ...
    """
    participant: str = proto.Field(proto.STRING, number=1)
    text_input: session.TextInput = proto.Field(proto.MESSAGE, number=6, oneof='input', message=session.TextInput)
    event_input: session.EventInput = proto.Field(proto.MESSAGE, number=8, oneof='input', message=session.EventInput)
    suggestion_input: 'SuggestionInput' = proto.Field(proto.MESSAGE, number=12, oneof='input', message='SuggestionInput')
    reply_audio_config: gcd_audio_config.OutputAudioConfig = proto.Field(proto.MESSAGE, number=5, message=gcd_audio_config.OutputAudioConfig)
    query_params: session.QueryParameters = proto.Field(proto.MESSAGE, number=9, message=session.QueryParameters)
    assist_query_params: 'AssistQueryParameters' = proto.Field(proto.MESSAGE, number=14, message='AssistQueryParameters')
    cx_parameters: struct_pb2.Struct = proto.Field(proto.MESSAGE, number=18, message=struct_pb2.Struct)
    request_id: str = proto.Field(proto.STRING, number=11)

class DtmfParameters(proto.Message):
    """The message in the response that indicates the parameters of
    DTMF.
    ...
    Attributes:
        accepts_dtmf_input (bool):
            ...
            in the next request.
    """
    accepts_dtmf_input: bool = proto.Field(proto.BOOL, number=1)
...
class AnalyzeContentResponse(proto.Message):
    ...
    """
    reply_text: str = proto.Field(proto.STRING, number=1)
    reply_audio: 'OutputAudio' = proto.Field(proto.MESSAGE, number=2, message='OutputAudio')
    automated_agent_reply: 'AutomatedAgentReply' = proto.Field(proto.MESSAGE, number=3, message='AutomatedAgentReply')
    message: 'Message' = proto.Field(proto.MESSAGE, number=5, message='Message')
    human_agent_suggestion_results: MutableSequence['SuggestionResult'] = proto.RepeatedField(proto.MESSAGE, number=6, message='SuggestionResult')
...
class StreamingAnalyzeContentRequest(proto.Message):
    ...
    """
    participant: str = proto.Field(proto.STRING, number=1)
    audio_config: gcd_audio_config.InputAudioConfig = proto.Field(proto.MESSAGE, number=2, oneof='config', message=gcd_audio_config.InputAudioConfig)
    text_config: 'InputTextConfig' = proto.Field(proto.MESSAGE, number=3, oneof='config', message='InputTextConfig')
    reply_audio_config: gcd_audio_config.OutputAudioConfig = proto.Field(proto.MESSAGE, number=4, message=gcd_audio_config.OutputAudioConfig)
    input_audio: bytes = proto.Field(proto.BYTES, number=5, oneof='input')
    input_text: str = proto.Field(proto.STRING, number=6, oneof='input')
    input_dtmf: gcd_audio_config.TelephonyDtmfEvents = proto.Field(proto.MESSAGE, number=9, oneof='input', message=gcd_audio_config.TelephonyDtmfEvents)
    query_params: session.QueryParameters = proto.Field(proto.MESSAGE, number=7, message=session.QueryParameters)
    assist_query_params: 'AssistQueryParameters' = proto.Field(proto.MESSAGE, number=8, message='AssistQueryParameters')
    cx_parameters: struct_pb2.Struct = proto.Field(proto.MESSAGE, number=13, message=struct_pb2.Struct)
    enable_extended_streaming: bool = proto.Field(proto.BOOL, number=11)
    enable_partial_automated_agent_reply: bool = proto.Field(proto.BOOL, number=12)
    enable_debugging_info: bool = proto.Field(proto.BOOL, number=19)
...
class StreamingAnalyzeContentResponse(proto.Message):
    ...
    Attributes:
        ...
        debugging_info (google.cloud.dialogflow_v2.types.CloudConversationDebuggingInfo):
            ...
            set to true.
    """
    recognition_result: session.StreamingRecognitionResult = proto.Field(proto.MESSAGE, number=1, message=session.StreamingRecognitionResult)
    reply_text: str = proto.Field(proto.STRING, number=2)
    reply_audio: 'OutputAudio' = proto.Field(proto.MESSAGE, number=3, message='OutputAudio')
    automated_agent_reply: 'AutomatedAgentReply' = proto.Field(proto.MESSAGE, number=4, message='AutomatedAgentReply')
    message: 'Message' = proto.Field(proto.MESSAGE, number=6, message='Message')
    human_agent_suggestion_results: MutableSequence['SuggestionResult'] = proto.RepeatedField(proto.MESSAGE, number=7, message='SuggestionResult')
    ...
    debugging_info: session.CloudConversationDebuggingInfo = proto.Field(proto.MESSAGE, number=11, message=session.CloudConversationDebuggingInfo)
...
class SuggestArticlesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    latest_message: str = proto.Field(proto.STRING, number=2)
    context_size: int = proto.Field(proto.INT32, number=3)
    assist_query_params: 'AssistQueryParameters' = proto.Field(proto.MESSAGE, number=4, message='AssistQueryParameters')
...
class SuggestArticlesResponse(proto.Message):
    ...
    Attributes:
        ...
        context_size (int):
            ...
            the conversation.
    """
    article_answers: MutableSequence['ArticleAnswer'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ArticleAnswer')
    latest_message: str = proto.Field(proto.STRING, number=2)
    context_size: int = proto.Field(proto.INT32, number=3)
...
class SuggestFaqAnswersResponse(proto.Message):
    ...
    Attributes:
        ...
        context_size (int):
            ...
            the conversation.
    """
    faq_answers: MutableSequence['FaqAnswer'] = proto.RepeatedField(proto.MESSAGE, number=1, message='FaqAnswer')
    latest_message: str = proto.Field(proto.STRING, number=2)
    context_size: int = proto.Field(proto.INT32, number=3)
...
class SuggestSmartRepliesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    current_text_input: session.TextInput = proto.Field(proto.MESSAGE, number=4, message=session.TextInput)
    latest_message: str = proto.Field(proto.STRING, number=2)
    context_size: int = proto.Field(proto.INT32, number=3)
...
class SuggestSmartRepliesResponse(proto.Message):
    ...
    Attributes:
        ...
        context_size (int):
            ...
            the conversation.
    """
    smart_reply_answers: MutableSequence['SmartReplyAnswer'] = proto.RepeatedField(proto.MESSAGE, number=1, message='SmartReplyAnswer')
    latest_message: str = proto.Field(proto.STRING, number=2)
    context_size: int = proto.Field(proto.INT32, number=3)

class OutputAudio(proto.Message):
    """Represents the natural language speech audio to be played to
    the end user.
    ...
    """
    config: gcd_audio_config.OutputAudioConfig = proto.Field(proto.MESSAGE, number=1, message=gcd_audio_config.OutputAudioConfig)
    audio: bytes = proto.Field(proto.BYTES, number=2)
...
class AutomatedAgentReply(proto.Message):
    ...
    class AutomatedAgentReplyType(proto.Enum):
        ...
        PARTIAL = 1
        FINAL = 2
    detect_intent_response: session.DetectIntentResponse = proto.Field(proto.MESSAGE, number=1, message=session.DetectIntentResponse)
    automated_agent_reply_type: AutomatedAgentReplyType = proto.Field(proto.ENUM, number=7, enum=AutomatedAgentReplyType)
    allow_cancellation: bool = proto.Field(proto.BOOL, number=8)
    cx_current_page: str = proto.Field(proto.STRING, number=11)
...
class ArticleAnswer(proto.Message):
    ...
    snippets: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    confidence: float = proto.Field(proto.FLOAT, number=4)
    metadata: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    answer_record: str = proto.Field(proto.STRING, number=6)
...
class FaqAnswer(proto.Message):
    ...
    Attributes:
        ...
        answer_record (str):
            ...
            ID>/answerRecords/<Answer Record ID>".
    """
    answer: str = proto.Field(proto.STRING, number=1)
    confidence: float = proto.Field(proto.FLOAT, number=2)
    question: str = proto.Field(proto.STRING, number=3)
    source: str = proto.Field(proto.STRING, number=4)
    metadata: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    answer_record: str = proto.Field(proto.STRING, number=6)
...
class SmartReplyAnswer(proto.Message):
    ...
    Attributes:
        ...
        answer_record (str):
            ...
            ID>/answerRecords/<Answer Record ID>".
    """
    reply: str = proto.Field(proto.STRING, number=1)
    confidence: float = proto.Field(proto.FLOAT, number=2)
    answer_record: str = proto.Field(proto.STRING, number=3)
...
class IntentSuggestion(proto.Message):
    ...
    intent_v2: str = proto.Field(proto.STRING, number=2, oneof='intent')
...
class DialogflowAssistAnswer(proto.Message):
    ...
    Attributes:
        ...
        answer_record (str):
            ...
            ID>/answerRecords/<Answer Record ID>".
    """
    query_result: session.QueryResult = proto.Field(proto.MESSAGE, number=1, oneof='result', message=session.QueryResult)
    intent_suggestion: 'IntentSuggestion' = proto.Field(proto.MESSAGE, number=5, oneof='result', message='IntentSuggestion')
    answer_record: str = proto.Field(proto.STRING, number=2)

class SuggestionResult(proto.Message):
    """One response of different type of suggestion response which is used
    in the response of
    [Participants.AnalyzeContent][google.cloud.dialogflow.v2.Participants.AnalyzeContent]
    and
    [Participants.AnalyzeContent][google.cloud.dialogflow.v2.Participants.AnalyzeContent],
    ...
    Attributes:
        ...
        suggest_smart_replies_response (google.cloud.dialogflow_v2.types.SuggestSmartRepliesResponse):
            ...
            This field is a member of `oneof`_ ``suggestion_response``.
    """
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=1, oneof='suggestion_response', message=status_pb2.Status)
    suggest_articles_response: 'SuggestArticlesResponse' = proto.Field(proto.MESSAGE, number=2, oneof='suggestion_response', message='SuggestArticlesResponse')
    suggest_faq_answers_response: 'SuggestFaqAnswersResponse' = proto.Field(proto.MESSAGE, number=3, oneof='suggestion_response', message='SuggestFaqAnswersResponse')
    suggest_smart_replies_response: 'SuggestSmartRepliesResponse' = proto.Field(proto.MESSAGE, number=4, oneof='suggestion_response', message='SuggestSmartRepliesResponse')
...
class AnnotatedMessagePart(proto.Message):
    """Represents a part of a message possibly annotated with an
    ...
    """
    text: str = proto.Field(proto.STRING, number=1)
    entity_type: str = proto.Field(proto.STRING, number=2)
    formatted_value: struct_pb2.Value = proto.Field(proto.MESSAGE, number=3, message=struct_pb2.Value)
...
class MessageAnnotation(proto.Message):
    ...
    Attributes:
        ...
        contain_entities (bool):
            ...
            entities.
    """
    parts: MutableSequence['AnnotatedMessagePart'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AnnotatedMessagePart')
    contain_entities: bool = proto.Field(proto.BOOL, number=2)
...
class SuggestionInput(proto.Message):
    ...
    """
    answer_record: str = proto.Field(proto.STRING, number=1)
...
class AssistQueryParameters(proto.Message):
    ...
    """
    documents_metadata_filters: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
