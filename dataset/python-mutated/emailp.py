...
class EmailAccounts(QAbstractTableModel):
    ...
    def setData(self, index, value, role):
        ...
        if col == 3:
            ...
            self.accounts[account][0] = re.sub(',+', ',', re.sub('\\s+', ',', as_unicode(value or '').upper()))
        elif col == 0:
