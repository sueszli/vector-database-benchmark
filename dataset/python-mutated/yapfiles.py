...
class YapFilesIE(InfoExtractor):
    _YAPFILES_URL = '//(?:(?:www|api)\\.)?yapfiles\\.ru/get_player/*\\?.*?\\bv=(?P<id>\\w+)'
    _VALID_URL = 'https?:%s' % _YAPFILES_URL
    _EMBED_REGEX = [f"""<iframe\\b[^>]+\\bsrc=(["\\'])(?P<url>(?:https?:)?{_YAPFILES_URL}.*?)\\1"""]
    _TESTS = [{'url': 'http://www.yapfiles.ru/get_player/?v=vMDE1NjcyNDUt0413', 'md5': '2db19e2bfa2450568868548a1aa1956c', 'info_dict': {'id': 'vMDE1NjcyNDUt0413', 'ext': 'mp4', 'title': 'Самый худший пароль WIFI', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 72}}, {'url': 'https://api.yapfiles.ru/get_player/?uid=video_player_1872528&plroll=1&adv=1&v=vMDE4NzI1Mjgt690b', 'only_matching': True}]
