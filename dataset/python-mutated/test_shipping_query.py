...
class TestInlineQuery:
    ...
    def test_answer_alias(self):
        if False:
            print('Hello World!')
        shipping_query = ShippingQuery(id='id', from_user=User(id=42, is_bot=False, first_name='name'), invoice_payload='payload', shipping_address=ShippingAddress(country_code='foo', state='foo', city='foo', street_line1='foo', street_line2='foo', post_code='foo'))
