...
import base64
from azure.security.attestation import AttestationAdministrationClient, AttestationType, AttestationClient, CertificateModification, AttestationPolicyToken
