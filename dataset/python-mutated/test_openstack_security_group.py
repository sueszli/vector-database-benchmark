...
INTERNET_SG_EGRESS = {'id': 'sg-12345678', 'name': 'INTERNETSG', 'rules': [{'cidr_ip': None, 'rule_type': 'egress', 'from_port': 80, 'to_port': 80, 'ip_protocol': 'TCP'}]}
INTERNET_SG_INGRESS = {'id': 'sg-12345679', 'name': 'INTERNETSG', 'rules': [{'cidr_ip': '0.0.0.0/0', 'rule_type': 'ingress', 'from_port': 80, 'to_port': 80, 'ip_protocol': 'TCP'}]}
INTERNAL_SG = {'id': 'sg-87654321', 'name': 'INTERNALSG', 'rules': [{'cidr_ip': '10.0.0.0/8', 'rule_type': 'ingress', 'from_port': 80, 'to_port': 80, 'ip_protocol': 'TCP'}]}
