...
import argparse
from network.lib.utils import parse_transports_args, create_client_transport_info_for_addr, parse_host
from network.lib.base_launcher import BaseLauncher, LauncherArgumentParser, LauncherError
from network.lib.proxies import find_proxies_for_transport, connect_client_with_proxy_info
...
class AutoProxyLauncher(BaseLauncher):
    ...
    __slots__ = ('arg_parser', 'args', 'hosts', 'connect_on_bind_payload', 'opt_args')
