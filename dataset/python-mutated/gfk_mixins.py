import graphene
from dcim.graphql.types import InterfaceType, LocationType, RackType, RegionType, SiteGroupType, SiteType
...
class IPAddressAssignmentType(graphene.Union):
    ...
    class Meta:
        types = (InterfaceType, FHRPGroupType, VMInterfaceType)
...
class L2VPNAssignmentType(graphene.Union):
    ...
    class Meta:
        types = (InterfaceType, VLANType, VMInterfaceType)
...
class VLANGroupScopeType(graphene.Union):
    ...
    class Meta:
        types = (ClusterType, ClusterGroupType, LocationType, RackType, RegionType, SiteType, SiteGroupType)
