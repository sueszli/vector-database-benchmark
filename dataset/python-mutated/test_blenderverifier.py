...
from tests.golem.verifier.test_utils.helpers import find_crop_files_in_path, are_pixels_equal, find_fragments_in_path
logger = logging.getLogger(__name__)

@pytest.mark.slow
@pytest.mark.skipif(not is_linux(), reason='Docker is only available on Linux buildbots')
