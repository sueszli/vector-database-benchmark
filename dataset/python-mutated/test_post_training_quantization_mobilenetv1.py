...
class TestPostTrainingAvgONNXFormatForMobilenetv1TensorRT(TestPostTrainingQuantization):
...
class TestPostTrainingKLONNXFormatForMobilenetv1MKLDNN(TestPostTrainingQuantization):
...
class TestPostTrainingAvgONNXFormatForMobilenetv1ARMCPU(TestPostTrainingQuantization):
