...
class _geom_stripes(geom):
    DEFAULT_AES = {}
    REQUIRED_AES = set()
    DEFAULT_PARAMS = {'stat': 'identity', 'position': 'identity', 'na_rm': False, 'color': None, 'fill': ('#AAAAAA', '#CCCCCC'), 'linetype': 'solid', 'size': 1, 'alpha': 0.5, 'direction': 'vertical', 'extend': (0, 1), 'fill_range': 'auto'}
