...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='This python script ensures that a requested python version is present in the hostedtoolcache on azure devops agents. It does this by retrieving new versions of python from the gh-actions python manifest.')
    parser.add_argument('version_spec', nargs='?', help='The version specifier passed in to the UsePythonVersion extended task.')
    parser.add_argument('--installer_folder', dest='installer_folder', help='The folder where the found installer will be extracted into and run from.')
