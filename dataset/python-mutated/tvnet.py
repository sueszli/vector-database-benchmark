...
class TVNetIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://de.tvnet.gov.vn/video/109788/vtv1---bac-tuyet-tai-lao-cai-va-ha-giang/tin-nong-24h', 'md5': 'b4d7abe0252c9b47774760b7519c7558', 'info_dict': {'id': '109788', 'ext': 'mp4', 'title': 'VTV1 - Bắc tuyết tại Lào Cai và Hà Giang', 'thumbnail': 're:(?i)https?://.*\\.(?:jpg|png)', 'is_live': False, 'view_count': int}}, {'url': 'http://vn.tvnet.gov.vn/radio/27017/vov1---ban-tin-chieu-10062018/doi-song-va-xa-hoi', 'md5': 'b5875ce9b0a2eecde029216d0e6db2ae', 'info_dict': {'id': '27017', 'ext': 'm4a', 'title': 'VOV1 - Bản tin chiều (10/06/2018)', 'thumbnail': 're:(?i)https?://.*\\.(?:jpg|png)', 'is_live': False}}, {'url': 'http://us.tvnet.gov.vn/video/118023/129999/ngay-0705', 'info_dict': {'id': '129999', 'ext': 'mp4', 'title': 'VTV1 - Quốc hội với cử tri (11/06/2018)', 'thumbnail': 're:(?i)https?://.*\\.(?:jpg|png)', 'is_live': False}, 'params': {'skip_download': True}}, {'url': 'http://us.tvnet.gov.vn/kenh-truyen-hinh/1011/vtv1', 'info_dict': {'id': '1011', 'ext': 'mp4', 'title': 're:^VTV1 \\| LiveTV [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'thumbnail': 're:(?i)https?://.*\\.(?:jpg|png)', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'http://vn.tvnet.gov.vn/kenh-truyen-hinh/1014', 'info_dict': {'id': '1014', 'ext': 'm4a', 'title': 're:VOV1 \\| LiveTV [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'thumbnail': 're:(?i)https?://.*\\.(?:jpg|png)', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'http://us.tvnet.gov.vn/phim/6136/25510/vtv3---ca-mot-doi-an-oan-tap-1-50/phim-truyen-hinh', 'only_matching': True}]
