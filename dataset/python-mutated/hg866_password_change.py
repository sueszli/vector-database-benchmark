...
class Exploit(HTTPClient):
    __info__ = {'name': 'Huawei HG866 Password Change', 'description': 'Module exploits password change vulnerability in Huawei HG866 devices. If the target is vulnerable it allows to change administration password.', 'authors': ('hkm', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/19185/',), 'devices': ('Huawei HG866',)}
