...
class Ingress:
    ...
    def __init__(self, ver_25_handle: DeploymentHandle, ver_26_handle: DeploymentHandle):
        if False:
            print('Hello World!')
...
ver_25 = requests_version.options(name='25', ray_actor_options={'runtime_env': {'pip': ['requests==2.25.1']}}).bind()
ver_26 = requests_version.options(name='26', ray_actor_options={'runtime_env': {'pip': ['requests==2.26.0']}}).bind()
