...
from kafka.codec import gzip_encode, snappy_encode, lz4_encode, lz4_encode_old_kafka, gzip_decode, snappy_decode, lz4_decode, lz4_decode_old_kafka
...
class LegacyRecordBatch(ABCRecordBatch, LegacyRecordBase):
    __slots__ = ('_buffer', '_magic', '_offset', '_crc', '_timestamp', '_attributes', '_decompressed')
