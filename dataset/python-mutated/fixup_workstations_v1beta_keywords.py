...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=workstationsCallTransformer()):
    if False:
        while True:
            i = 10
