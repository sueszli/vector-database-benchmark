...
envelope = synthio.Envelope(attack_time=0.1, decay_time=0.05, release_time=0.2, attack_level=0.8, sustain_level=0.8)
...
def synthesize(synth):
    if False:
        while True:
            i = 10
    n = synthio.Note(frequency=440, waveform=sine, envelope=envelope)
    print(synth, n)
    synth.press((n,))
