...
DATA_DESCRIPTOR_SIG = pack(b'<L', 134695760)
LocalHeader = namedtuple('LocalHeader', 'signature min_version flags compression_method mod_time mod_date crc32 compressed_size uncompressed_size filename_length extra_length filename extra')
if hasattr(sys, 'getwindowsversion'):
    windows_reserved_filenames = ('CON', 'PRN', 'AUX', 'CLOCK$', 'NULCOM0', 'COM1', 'COM2', 'COM3', 'COM4', 'COM5', 'COM6', 'COM7', 'COM8', 'COM9LPT0', 'LPT1', 'LPT2', 'LPT3', 'LPT4', 'LPT5', 'LPT6', 'LPT7', 'LPT8', 'LPT9')
