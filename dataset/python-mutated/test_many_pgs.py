...
print(f'Success! Started {MAX_PLACEMENT_GROUPS} pgs in {end_time - start_time}s. ({rate} pgs/s)')
results = {'pgs_per_second': rate, 'num_pgs': MAX_PLACEMENT_GROUPS, 'time': end_time - start_time, 'success': '1', '_peak_memory': round(used_gb, 2), '_peak_process_memory': usage}
if not is_smoke_test:
    results['perf_metrics'] = [{'perf_metric_name': 'pgs_per_second', 'perf_metric_value': rate, 'perf_metric_type': 'THROUGHPUT'}]
