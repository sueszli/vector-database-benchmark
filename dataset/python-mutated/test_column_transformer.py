...
from sklearn.tests.metadata_routing_common import ConsumingTransformer, _Registry, check_recorded_metadata
from sklearn.utils._testing import assert_allclose_dense_sparse, assert_almost_equal, assert_array_equal
