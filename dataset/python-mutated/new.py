...
class NewCommand(Command):
    ...
    options = [option('name', None, 'Set the resulting package name.', flag=False), option('src', None, 'Use the src layout for the project.'), option('readme', None, 'Specify the readme file format. One of md (default) or rst', flag=False)]
