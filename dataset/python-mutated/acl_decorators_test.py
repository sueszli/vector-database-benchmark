...
class OppiaMLAccessDecoratorTest(test_utils.GenericTestBase):
    ...
    class MockHandler(base.OppiaMLVMHandler[MockHandlerNormalizedPayloadDict, Dict[str, str]]):
        REQUIRE_PAYLOAD_CSRF_CHECK = False
        GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
        URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
        HANDLER_ARGS_SCHEMAS = {'POST': {'vm_id': {'schema': {'type': 'basestring'}}, 'message': {'schema': {'type': 'basestring'}}, 'signature': {'schema': {'type': 'basestring'}}}}
