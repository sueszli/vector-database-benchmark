...
try:
    from ray.train.huggingface.accelerate._accelerate_utils import AccelerateConfigWrapper, AccelerateDefaultNamespace, launch_command, load_accelerate_config
...
ACCELERATE_TRAINER_DEPRECATION_MESSAGE = 'The AccelerateTrainer will be hard deprecated in Ray 2.8. Use TorchTrainer instead. See https://docs.ray.io/en/releases-2.7.0/train/huggingface-accelerate.html#acceleratetrainer-migration-guide for more details.'
