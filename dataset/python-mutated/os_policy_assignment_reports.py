...
import proto
__protobuf__ = proto.module(package='google.cloud.osconfig.v1', manifest={'GetOSPolicyAssignmentReportRequest', 'ListOSPolicyAssignmentReportsRequest', 'ListOSPolicyAssignmentReportsResponse', 'OSPolicyAssignmentReport'})
...
class ListOSPolicyAssignmentReportsResponse(proto.Message):
    """A response message for listing OS Policy assignment reports
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    os_policy_assignment_reports: MutableSequence['OSPolicyAssignmentReport'] = proto.RepeatedField(proto.MESSAGE, number=1, message='OSPolicyAssignmentReport')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class OSPolicyAssignmentReport(proto.Message):
    """A report of the OS policy assignment status for a given
    instance.
        ...
        class OSPolicyResourceCompliance(proto.Message):
            ...
            class OSPolicyResourceConfigStep(proto.Message):
                ...
                class Type(proto.Enum):
                    ...
                    DESIRED_STATE_ENFORCEMENT = 3
                    DESIRED_STATE_CHECK_POST_ENFORCEMENT = 4
                type_: 'OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep.Type' = proto.Field(proto.ENUM, number=1, enum='OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep.Type')
            ...
            class ExecResourceOutput(proto.Message):
                ...
                """
                enforcement_output: bytes = proto.Field(proto.BYTES, number=2)
            os_policy_resource_id: str = proto.Field(proto.STRING, number=1)
            config_steps: MutableSequence['OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep'] = proto.RepeatedField(proto.MESSAGE, number=2, message='OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep')
            compliance_state: 'OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ComplianceState' = proto.Field(proto.ENUM, number=3, enum='OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ComplianceState')
            compliance_state_reason: str = proto.Field(proto.STRING, number=4)
            exec_resource_output: 'OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutput' = proto.Field(proto.MESSAGE, number=5, oneof='output', message='OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutput')
        os_policy_id: str = proto.Field(proto.STRING, number=1)
        compliance_state: 'OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState' = proto.Field(proto.ENUM, number=2, enum='OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState')
        compliance_state_reason: str = proto.Field(proto.STRING, number=3)
        os_policy_resource_compliances: MutableSequence['OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance'] = proto.RepeatedField(proto.MESSAGE, number=4, message='OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance')
    name: str = proto.Field(proto.STRING, number=1)
    instance: str = proto.Field(proto.STRING, number=2)
    os_policy_assignment: str = proto.Field(proto.STRING, number=3)
    os_policy_compliances: MutableSequence[OSPolicyCompliance] = proto.RepeatedField(proto.MESSAGE, number=4, message=OSPolicyCompliance)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    last_run_id: str = proto.Field(proto.STRING, number=6)
