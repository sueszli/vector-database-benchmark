...
class TCN(Model):
    ...
    def __init__(self, d_feat=6, n_chans=128, kernel_size=5, num_layers=5, dropout=0.5, n_epochs=200, lr=0.0001, metric='', batch_size=2000, early_stop=20, loss='mse', optimizer='adam', GPU=0, seed=None, **kwargs):
        if False:
            while True:
                i = 10
        ...
        self.seed = seed
        self.logger.info('TCN parameters setting:\nd_feat : {}\nn_chans : {}\nkernel_size : {}\nnum_layers : {}\ndropout : {}\nn_epochs : {}\nlr : {}\nmetric : {}\nbatch_size : {}\nearly_stop : {}\noptimizer : {}\nloss_type : {}\nvisible_GPU : {}\nuse_GPU : {}\nseed : {}'.format(d_feat, n_chans, kernel_size, num_layers, dropout, n_epochs, lr, metric, batch_size, early_stop, optimizer.lower(), loss, GPU, self.use_gpu, seed))
