...
@testing.parameterize(*testing.product({'stream': ('null', 'new'), 'ver': (2, 3)}))
...
@testing.parameterize({'shape': (10,), 'slices': (slice(0, None),)}, {'shape': (10,), 'slices': (slice(2, None),)}, {'shape': (10, 10), 'slices': (slice(0, None), slice(0, None))}, {'shape': (10, 10), 'slices': (slice(0, None), slice(2, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(0, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(2, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(4, None))})
@pytest.mark.skipif(cupy.cuda.runtime.is_hip, reason='HIP does not support this')
...
test_cases = [{'shape': (10,), 'slices': (slice(0, None),)}, {'shape': (10,), 'slices': (slice(2, None),)}, {'shape': (10, 10), 'slices': (slice(0, None), slice(0, None))}, {'shape': (10, 10), 'slices': (slice(0, None), slice(2, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(0, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(2, None))}, {'shape': (10, 10), 'slices': (slice(2, None), slice(4, None))}]
test_streams = ('null', 'new')
test_cases_with_stream = [{'stream': s, **t} for t in test_cases for s in test_streams]
...
@testing.parameterize(*testing.product({'stream': ('null', 'new', 'ptds')}))
@pytest.mark.skipif(cupy.cuda.runtime.is_hip, reason='HIP does not support this')
