...
class ToypicsIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://videos.toypics.net/view/514/chancebulged,-2-1/', 'md5': '16e806ad6d6f58079d210fe30985e08b', 'info_dict': {'id': '514', 'ext': 'mp4', 'title': "Chance-Bulge'd, 2", 'age_limit': 18, 'uploader': 'kidsune'}}
...
class ToypicsUserIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://videos.toypics.net/Mikey', 'info_dict': {'id': 'Mikey'}, 'playlist_mincount': 19}
