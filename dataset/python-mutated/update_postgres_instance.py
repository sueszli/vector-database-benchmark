...
def main():
    ...
    response = client.postgres_instances.update(resource_group_name='testrg', postgres_instance_name='testpostgresInstance', parameters={'tags': {'mytag': 'myval'}})
    print(response)
