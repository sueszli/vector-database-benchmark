...
def wait_until_finish(client: JobSubmissionClient, job_id: str, timeout_s: int=10 * 60, retry_interval_s: int=1) -> Optional[JobStatus]:
    if False:
        for i in range(10):
            print('nop')
...
if __name__ == '__main__':
    ...
    for num_gpus in [0, 0.1]:
        job_id = client.submit_job(entrypoint='python jobs_check_cuda_available.py', runtime_env={'working_dir': args.working_dir}, entrypoint_num_gpus=num_gpus)
        timeout_s = 10 * 60
