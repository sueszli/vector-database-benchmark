...
pos['Reshevsky, Samuel H'] += (0.05, -0.1)
...
font['color'] = 'r'
ax.text(0.8, 0.1, 'edge width = # games played', horizontalalignment='center', transform=ax.transAxes, fontdict=font)
ax.text(0.8, 0.06, 'node size = # games won', horizontalalignment='center', transform=ax.transAxes, fontdict=font)
ax.margins(0.1, 0.05)
fig.tight_layout()
plt.axis('off')
plt.show()