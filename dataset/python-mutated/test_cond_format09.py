...
class TestAssembleWorksheet(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.conditional_format('A1:A4', {'type': 'no_blanks', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'errors', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'no_errors', 'format': None})
