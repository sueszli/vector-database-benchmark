...
from airflow.providers.databricks.operators.databricks import DatabricksCreateJobsOperator, DatabricksRunNowDeferrableOperator, DatabricksRunNowOperator, DatabricksSubmitRunDeferrableOperator, DatabricksSubmitRunOperator
...
SPARK_SUBMIT_TASK = {'parameters': ['--class', 'org.apache.spark.examples.SparkPi', 'dbfs:/path/to/examples.jar', '10']}
...
DBT_TASK = {'commands': ['dbt deps', 'dbt seed', 'dbt run'], 'schema': 'jaffle_shop', 'warehouse_id': '123456789abcdef0'}
...
JOB_CLUSTERS = [{'job_cluster_key': 'auto_scaling_cluster', 'new_cluster': {'spark_version': '7.3.x-scala2.12', 'node_type_id': 'i3.xlarge', 'spark_conf': {'spark.speculation': True}, 'aws_attributes': {'availability': 'SPOT', 'zone_id': 'us-west-2a'}, 'autoscale': {'min_workers': 2, 'max_workers': 16}}}]
EMAIL_NOTIFICATIONS = {'on_start': ['user.name@databricks.com'], 'on_success': ['user.name@databricks.com'], 'on_failure': ['user.name@databricks.com'], 'no_alert_for_skipped_runs': False}
WEBHOOK_NOTIFICATIONS = {'on_start': [{'id': '03dd86e4-57ef-4818-a950-78e41a1d71ab'}, {'id': '0481e838-0a59-4eff-9541-a4ca6f149574'}], 'on_success': [{'id': '03dd86e4-57ef-4818-a950-78e41a1d71ab'}], 'on_failure': [{'id': '0481e838-0a59-4eff-9541-a4ca6f149574'}]}
TIMEOUT_SECONDS = 86400
SCHEDULE = {'quartz_cron_expression': '20 30 * * * ?', 'timezone_id': 'Europe/London', 'pause_status': 'PAUSED'}
MAX_CONCURRENT_RUNS = 10
GIT_SOURCE = {'git_url': 'https://github.com/databricks/databricks-cli', 'git_branch': 'main', 'git_provider': 'gitHub'}
ACCESS_CONTROL_LIST = [{'user_name': 'jsmith@example.com', 'permission_level': 'CAN_MANAGE'}]
