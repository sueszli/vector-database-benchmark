...
class CoreConjunctionExpression(object):
    ...
    swagger_types = {'operator': 'ConjunctionExpressionLogicalOperator', 'left_expression': 'CoreBooleanExpression', 'right_expression': 'CoreBooleanExpression'}
    attribute_map = {'operator': 'operator', 'left_expression': 'left_expression', 'right_expression': 'right_expression'}

    def __init__(self, operator=None, left_expression=None, right_expression=None):
        if False:
            print('Hello World!')
        'CoreConjunctionExpression - a model defined in Swagger'
        self._operator = None
