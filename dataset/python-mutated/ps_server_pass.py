import logging
import paddle
from paddle.optimizer.lr import ExponentialDecay, InverseTimeDecay, LRScheduler, NaturalExpDecay, NoamDecay, exponential_decay, inverse_time_decay, noam_decay
