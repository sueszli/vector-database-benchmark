...
def test_regression_logit_transform():
    ...
    try:
        ...
        if 'Metalearner transform is supported only for classification' not in str(e):
            assert False, 'Should have failed with metalearner transform in the error message'
pu.run_tests([test_binomial_no_transform, test_binomial_logit_transform, test_multinomial_no_transform, test_multinomial_logit_transform, test_regression_no_transform, test_regression_logit_transform])