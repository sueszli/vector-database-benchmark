...
class Test_glue_development_endpoints_s3_encryption_enabled:
    ...
    def test_glue_no_endpoints(self):
        ...
        with mock.patch('prowler.providers.aws.services.glue.glue_service.Glue', glue_client):
            from prowler.providers.aws.services.glue.glue_development_endpoints_s3_encryption_enabled.glue_development_endpoints_s3_encryption_enabled import glue_development_endpoints_s3_encryption_enabled
    ...
    def test_glue_encrypted_endpoint(self):
        if False:
            ...
            return i + 15
        glue_client = mock.MagicMock
        glue_client.dev_endpoints = [DevEndpoint(name='test', security='sec_config', region=AWS_REGION, arn='arn_test')]
