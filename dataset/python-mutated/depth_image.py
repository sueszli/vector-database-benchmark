...
class DepthImage(DepthImageExt, Archetype):
    ...
    **Archetype**: A depth image.
    ...
    def __init__(self: Any, data: datatypes.TensorDataLike, *, meter: components.DepthMeterLike | None=None, draw_order: components.DrawOrderLike | None=None):
        if False:
            while True:
                i = 10
    ...
    def __attrs_clear__(self) -> None:
        ...
        self.__attrs_init__(data=None, meter=None, draw_order=None)
    ...
    def _clear(cls) -> DepthImage:
        ...
        return inst
    data: components.TensorDataBatch = field(metadata={'component': 'required'}, converter=DepthImageExt.data__field_converter_override)
    meter: components.DepthMeterBatch | None = field(metadata={'component': 'optional'}, default=None, converter=components.DepthMeterBatch._optional)
