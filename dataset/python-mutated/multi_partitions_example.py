import wandb
from dagster import AssetIn, DailyPartitionsDefinition, MultiPartitionsDefinition, StaticPartitionsDefinition, asset
partitions_def = MultiPartitionsDefinition({'date': DailyPartitionsDefinition(start_date='2023-01-01', end_date='2023-01-05'), 'color': StaticPartitionsDefinition(['red', 'yellow', 'blue'])})
