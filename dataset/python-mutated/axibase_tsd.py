...
import logging
import uuid
from redash.query_runner import TYPE_DATE, TYPE_DATETIME, TYPE_FLOAT, TYPE_INTEGER, TYPE_STRING, BaseQueryRunner, InterruptException, JobTimeoutException, register
...
try:
    ...
    enabled = False
types_map = {'long': TYPE_INTEGER, 'bigint': TYPE_INTEGER, 'integer': TYPE_INTEGER, 'smallint': TYPE_INTEGER, 'float': TYPE_FLOAT, 'double': TYPE_FLOAT, 'decimal': TYPE_FLOAT, 'string': TYPE_STRING, 'date': TYPE_DATE, 'xsd:dateTimeStamp': TYPE_DATETIME}
