...
class QoSFilterRule(StrLenField):
    pass
...
class AVP_Unknown(AVP_Generic):
    ...
    name = 'AVP Unknown'
    fields_desc = [IntField('avpCode', None), AVPFlags('avpFlags', None, 8, AVP_Flags_List), I3FieldLenField('avpLen', None, length_of='val', adjust=lambda pkt, x: x + 8 + ((pkt.avpFlags & 128) >> 5)), ConditionalField(AVPVendor('avpVnd', 0), lambda pkt: pkt.avpFlags & 128), StrLenField('val', None, length_from=lambda pkt: pkt.avpLen - 8 - ((pkt.avpFlags & 128) >> 5))]
...
class AVP_0_6(AVP_FL_NV):
    name = 'Service-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'Unknown', 1: 'Login', 2: 'Framed', 3: 'Callback-Login', 4: 'Callback-Framed', 5: 'Outbound', 6: 'Administrative', 7: 'NAS-Prompt', 8: 'Authenticate-Only', 9: 'Callback-NAS-Prompt', 10: 'Call Check', 11: 'Callback Administrative', 12: 'Voice', 13: 'Fax', 14: 'Modem Relay', 15: 'IAPP-Register', 16: 'IAPP-AP-Check', 17: 'Authorize Only', 18: 'Framed-Management'})]

class AVP_0_7(AVP_FL_NV):
    name = 'Framed-Protocol'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'PPP', 2: 'SLIP', 3: 'ARAP', 4: 'Gandalf', 5: 'Xylogics', 6: 'X.75', 7: 'GPRS PDP Context', 255: 'Ascend-ARA', 256: 'MPP', 257: 'EURAW', 258: 'EUUI', 259: 'X25', 260: 'COMB', 261: 'FR'})]

class AVP_0_10(AVP_FL_NV):
    name = 'Framed-Routing'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'None', 1: 'Send routing packets', 2: 'Listen for routing packets', 3: 'Send and Listen    '})]

class AVP_0_13(AVP_FL_NV):
    name = 'Framed-Compression'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'None', 2: 'IPX header compression', 3: 'Stac-LZS compression'})]

class AVP_0_15(AVP_FL_NV):
    name = 'Login-Service'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'Telnet', 1: 'Rlogin', 2: 'TCP-Clear', 3: 'PortMaster', 4: 'LAT', 5: 'X25-PAD', 6: 'X25-T3POS', 7: 'Unassigned'})]

class AVP_0_45(AVP_FL_NV):
    name = 'Acct-Authentic'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'None', 1: 'RADIUS', 2: 'Local', 3: 'Remote', 4: 'Diameter'})]

class AVP_0_61(AVP_FL_NV):
    name = 'NAS-Port-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'Async', 1: 'Sync', 2: 'ISDN-Sync', 3: 'ISDN-Async-v120', 4: 'ISDN-Async-v110', 5: 'Virtual', 6: 'PIAFS', 7: 'HDLC-Clear-Channel', 8: 'X25', 9: 'X75', 10: 'G.3 Fax', 11: 'SDSL - Symmetric DSL', 14: 'IDSL - ISDN Digital Subscriber Line', 15: 'Ethernet', 16: 'xDSL - Digital Subscriber Line of unknown type', 17: 'Cable', 18: 'Wireless - Other', 19: 'Wireless - IEEE 802.11', 20: 'Token-Ring', 21: 'FDDI', 22: 'Wireless - CDMA2000', 23: 'Wireless - UMTS', 24: 'Wireless - 1X-EV', 25: 'IAPP', 26: 'FTTP - Fiber to the Premises', 27: 'Wireless - IEEE 802.16', 28: 'Wireless - IEEE 802.20', 29: 'Wireless - IEEE 802.22', 30: 'PPPoA - PPP over ATM', 31: 'PPPoEoA - PPP over Ethernet over ATM', 32: 'PPPoEoE - PPP over Ethernet over Ethernet', 33: 'PPPoEoVLAN - PPP over Ethernet over VLAN', 34: 'PPPoEoQinQ - PPP over Ethernet over IEEE 802.1QinQ', 35: 'xPON - Passive Optical Network', 36: 'Wireless - XGP'})]

class AVP_0_64(AVP_FL_NV):
    name = 'Tunnel-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'PPTP', 2: 'L2F', 3: 'L2TP', 4: 'ATMP', 5: 'VTP', 6: 'AH', 7: 'IP-IP-Encap', 8: 'MIN-IP-IP', 9: 'ESP', 10: 'GRE', 11: 'DVS', 12: 'IP-in-IP Tunneling', 13: 'VLAN'})]

class AVP_0_65(AVP_FL_NV):
    name = 'Tunnel-Medium-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'IPv4', 2: 'IPv6', 3: 'NSAP', 4: 'HDLC', 5: 'BBN', 6: 'IEEE-802', 7: 'E-163', 8: 'E-164', 9: 'F-69', 10: 'X-121', 11: 'IPX', 12: 'Appletalk-802', 13: 'Decnet4', 14: 'Vines', 15: 'E-164-NSAP'})]

class AVP_0_72(AVP_FL_NV):
    name = 'ARAP-Zone-Access'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'Only allow access to default zone', 2: 'Use zone filter inclusively', 3: 'Use zone filter exclusively'})]

class AVP_0_76(AVP_FL_NV):
    name = 'Prompt'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'No Echo', 1: 'Echo'})]

class AVP_0_261(AVP_FL_NV):
    name = 'Redirect-Host-Usage'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: "Don't Care", 1: 'All Session', 2: 'All Realm', 3: 'Realm and Application', 4: 'All Application', 5: 'All Host', 6: 'ALL_USER'})]

class AVP_0_271(AVP_FL_NV):
    name = 'Session-Server-Failover'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'REFUSE_SERVICE', 1: 'TRY_AGAIN', 2: 'ALLOW_SERVICE', 3: 'TRY_AGAIN_ALLOW_SERVICE'})]
...
class AVP_0_274(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'AUTHENTICATE_ONLY', 2: 'AUTHORIZE_ONLY', 3: 'AUTHORIZE_AUTHENTICATE'})]
...
class AVP_0_295(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'DIAMETER_LOGOUT', 2: 'DIAMETER_SERVICE_NOT_PROVIDED', 3: 'DIAMETER_BAD_ANSWER', 4: 'DIAMETER_ADMINISTRATIVE', 5: 'DIAMETER_LINK_BROKEN', 6: 'DIAMETER_AUTH_EXPIRED', 7: 'DIAMETER_USER_MOVED', 8: 'DIAMETER_SESSION_TIMEOUT'})]

class AVP_0_345(AVP_FL_NV):
    name = 'MIP-Algorithm-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {2: 'HMAC-SHA-1'})]

class AVP_0_346(AVP_FL_NV):
    name = 'MIP-Replay-Mode'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'None', 2: 'Timestamps', 3: 'Nonces'})]

class AVP_0_375(AVP_FL_NV):
    name = 'SIP-Server-Assignment-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'NO_ASSIGNMENT', 1: 'REGISTRATION', 2: 'RE_REGISTRATION', 3: 'UNREGISTERED_USER', 4: 'TIMEOUT_DEREGISTRATION', 5: 'USER_DEREGISTRATION', 6: 'TIMEOUT_DEREGISTRATION_STORE_SERVER_NAME', 7: 'USER_DEREGISTRATION_STORE_SERVER_NAME', 8: 'ADMINISTRATIVE_DEREGISTRATION', 9: 'AUTHENTICATION_FAILURE', 10: 'AUTHENTICATION_TIMEOUT', 11: 'DEREGISTRATION_TOO_MUCH_DATA'})]

class AVP_0_377(AVP_FL_NV):
    name = 'SIP-Authentication-Scheme'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'DIGEST'})]

class AVP_0_384(AVP_FL_NV):
    name = 'SIP-Reason-Code'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'PERMANENT_TERMINATION', 1: 'NEW_SIP_SERVER_ASSIGNED', 2: 'SIP_SERVER_CHANGE', 3: 'REMOVE_SIP_SERVER'})]

class AVP_0_387(AVP_FL_NV):
    name = 'SIP-User-Authorization-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'REGISTRATION', 1: 'DEREGISTRATION', 2: 'REGISTRATION_AND_CAPABILITIES'})]

class AVP_0_392(AVP_FL_NV):
    name = 'SIP-User-Data-Already-Available'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'USER_DATA_NOT_AVAILABLE', 1: 'USER_DATA_ALREADY_AVAILABLE'})]

class AVP_0_403(AVP_FL_NV):
    name = 'CHAP-Algorithm'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {5: 'CHAP with MD5'})]

class AVP_0_406(AVP_FL_NV):
    name = 'Accounting-Auth-Method'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'PAP', 2: 'CHAP', 3: 'MS-CHAP-1', 4: 'MS-CHAP-2', 5: 'EAP', 6: 'Undefined', 7: 'None'})]

class AVP_0_416(AVP_FL_NV):
    name = 'CC-Request-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'INITIAL_REQUEST', 2: 'UPDATE_REQUEST', 3: 'TERMINATION_REQUEST', 4: 'EVENT_REQUEST'})]
...
class AVP_0_422(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'ENOUGH_CREDIT', 1: 'NO_CREDIT'})]
...
class AVP_0_427(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'TERMINATE', 1: 'CONTINUE', 2: 'RETRY_AND_TERMINATE'})]

class AVP_0_428(AVP_FL_NV):
    name = 'Direct-Debiting-Failure-Handling'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'TERMINATE_OR_BUFFER', 1: 'CONTINUE'})]
...
class AVP_0_436(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'DIRECT_DEBITING', 1: 'REFUND_ACCOUNT', 2: 'CHECK_BALANCE', 3: 'PRICE_ENQUIRY'})]
...
class AVP_0_450(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'END_USER_E164', 1: 'END_USER_IMSI', 2: 'END_USER_SIP_URI', 3: 'END_USER_NAI', 4: 'END_USER_PRIVATE'})]

class AVP_0_452(AVP_FL_NV):
    name = 'Tariff-Change-Usage'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'UNIT_BEFORE_TARIFF_CHANGE', 1: 'UNIT_AFTER_TARIFF_CHANGE', 2: 'UNIT_INDETERMINATE'})]

class AVP_0_454(AVP_FL_NV):
    name = 'CC-Unit-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'TIME', 1: 'MONEY', 2: 'TOTAL-OCTETS', 3: 'INPUT-OCTETS', 4: 'OUTPUT-OCTETS', 5: 'SERVICE-SPECIFIC-UNITS'})]

class AVP_0_455(AVP_FL_NV):
    name = 'Multiple-Services-Indicator'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'MULTIPLE_SERVICES_NOT_SUPPORTED', 1: 'MULTIPLE_SERVICES_SUPPORTED'})]

class AVP_0_459(AVP_FL_NV):
    name = 'User-Equipment-Info-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'IMEISV', 1: 'MAC', 2: 'EUI64', 3: 'MODIFIED_EUI64'})]

class AVP_0_480(AVP_FL_NV):
    name = 'Accounting-Record-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'Event Record', 2: 'Start Record', 3: 'Interim Record', 4: 'Stop Record'})]

class AVP_0_483(AVP_FL_NV):
    name = 'Accounting-Realtime-Required'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'Reserved', 1: 'DELIVER_AND_GRANT', 2: 'GRANT_AND_STORE', 3: 'GRANT_AND_LOSE'})]

class AVP_0_494(AVP_FL_NV):
    name = 'MIP6-Auth-Mode'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'Reserved', 1: 'IP6_AUTH_MN_AAA'})]

class AVP_0_513(AVP_FL_NV):
    name = 'Protocol'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {1: 'ICMP', 2: 'IGMP', 4: 'IPv4', 6: 'TCP', 17: 'UDP', 132: 'SCTP'})]

class AVP_0_514(AVP_FL_NV):
    name = 'Direction'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'IN', 1: 'OUT', 2: 'BOTH'})]

class AVP_0_517(AVP_FL_NV):
    name = 'Negated'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'False', 1: 'True'})]
...
class AVP_0_535(AVP_FL_NV):
    ...
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'CS0', 8: 'CS1', 10: 'AF11', 12: 'AF12', 14: 'AF13', 16: 'CS2', 18: 'AF21', 20: 'AF22', 22: 'AF23', 24: 'CS3', 26: 'AF31', 28: 'AF32', 30: 'AF33', 32: 'CS4', 34: 'AF41', 36: 'AF42', 38: 'AF43', 40: 'CS5', 46: 'EF_PHB', 48: 'CS6', 56: 'CS7'})]

class AVP_0_536(AVP_FL_NV):
    name = 'Fragmentation-Flag'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: "Don't Fragment", 1: 'More Fragments'})]

class AVP_0_538(AVP_FL_NV):
    name = 'IP-Option-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'end_of_list', 1: 'nop', 2: 'security', 3: 'loose_source_route', 4: 'timestamp', 5: 'extended_security', 6: 'commercial_security', 7: 'record_route', 8: 'stream_id', 9: 'strict_source_route', 10: 'experimental_measurement', 11: 'mtu_probe', 12: 'mtu_reply', 13: 'flow_control', 14: 'access_control', 15: 'encode', 16: 'imi_traffic_descriptor', 17: 'extended_IP', 18: 'traceroute', 19: 'address_extension', 20: 'router_alert', 21: 'selective_directed_broadcast_mode', 23: 'dynamic_packet_state', 24: 'upstream_multicast_packet', 25: 'quick_start', 30: 'rfc4727_experiment'})]

class AVP_0_541(AVP_FL_NV):
    name = 'TCP-Option-Type'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'EOL', 1: 'NOP', 2: 'MSS', 3: 'WScale', 4: 'SAckOK', 5: 'SAck', 8: 'Timestamp', 14: 'AltChkSum', 15: 'AltChkSumOpt', 25: 'Mood'})]

class AVP_0_546(AVP_FL_NV):
    name = 'ICMP-Type-Number'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'echo-reply', 3: 'dest-unreach', 4: 'source-quench', 5: 'redirect', 8: 'echo-request', 9: 'router-advertisement', 10: 'router-solicitation', 11: 'time-exceeded', 12: 'parameter-problem', 13: 'timestamp-request', 14: 'timestamp-reply', 15: 'information-request', 16: 'information-response', 17: 'address-mask-request', 18: 'address-mask-reply'})]

class AVP_0_547(AVP_FL_NV):
    name = 'ICMP-Code'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'TBD'})]

class AVP_0_570(AVP_FL_NV):
    name = 'Timezone-Flag'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'UTC', 1: 'LOCAL', 2: 'OFFSET'})]

class AVP_0_575(AVP_FL_NV):
    name = 'QoS-Semantics'
    avpLen = 12
    fields_desc = [AVP_FL_NV, Enumerated('val', None, {0: 'QoS_Desired', 1: 'QoS_Available', 2: 'QoS_Delivered', 3: 'Minimum_QoS', 4: 'QoS_Authorized'})]

class AVP_10415_500(AVP_FL_V):
    name = 'Abort-Cause'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'BEARER_RELEASED', 1: 'INSUFFICIENT_SERVER_RESOURCES', 2: 'INSUFFICIENT_BEARER_RESOURCES'})]

class AVP_10415_511(AVP_FL_V):
    name = 'Flow-Status'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ENABLED-UPLINK', 1: 'ENABLED-DOWNLINK', 2: 'ENABLED', 3: 'DISABLED', 4: 'REMOVED'})]
...
class AVP_10415_513(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'CHARGING_CORRELATION_EXCHANGE', 2: 'INDICATION_OF_LOSS_OF_BEARER', 3: 'INDICATION_OF_RECOVERY_OF_BEARER', 4: 'INDICATION_OF_RELEASE_OF_BEARER', 6: 'IP-CAN_CHANGE', 7: 'INDICATION_OF_OUT_OF_CREDIT', 8: 'INDICATION_OF_SUCCESSFUL_RESOURCES_ALLOCATION', 9: 'INDICATION_OF_FAILED_RESOURCES_ALLOCATION', 10: 'INDICATION_OF_LIMITED_PCC_DEPLOYMENT', 11: 'USAGE_REPORT', 12: 'ACCESS_NETWORK_INFO_REPORT'})]

class AVP_10415_520(AVP_FL_V):
    name = 'Media-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'AUDIO', 1: 'VIDEO', 2: 'DATA', 3: 'APPLICATION', 4: 'CONTROL', 5: 'TEXT', 6: 'MESSAGE', 4294967295: 'OTHER'})]

class AVP_10415_523(AVP_FL_V):
    name = 'SIP-Forking-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SINGLE_DIALOGUE', 1: 'SEVERAL_DIALOGUES'})]

class AVP_10415_527(AVP_FL_V):
    name = 'Service-Info-Status'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'FINAL_SERVICE_INFORMATION', 1: 'PRELIMINARY_SERVICE_INFORMATION'})]

class AVP_10415_529(AVP_FL_V):
    name = 'AF-Signalling-Protocol'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NO_INFORMATION', 1: 'SIP'})]
...
class AVP_10415_536(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'USER_LOCATION', 1: 'MS_TIME_ZONE'})]

class AVP_10415_614(AVP_FL_V):
    name = 'Server-Assignment-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NO_ASSIGNMENT', 1: 'REGISTRATION', 2: 'RE_REGISTRATION', 3: 'UNREGISTERED_USER', 4: 'TIMEOUT_DEREGISTRATION', 5: 'USER_DEREGISTRATION', 6: 'TIMEOUT_DEREGISTRATION_STORE_SERVER_NAME', 7: 'USER_DEREGISTRATION_STORE_SERVER_NAME', 8: 'ADMINISTRATIVE_DEREGISTRATION', 9: 'AUTHENTICATION_FAILURE', 10: 'AUTHENTICATION_TIMEOUT', 11: 'DEREGISTRATION_TOO_MUCH_DATA', 12: 'AAA_USER_DATA_REQUEST', 13: 'PGW_UPDATE'})]

class AVP_10415_616(AVP_FL_V):
    name = 'Reason-Code'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'PERMANENT_TERMINATION', 1: 'NEW_SERVER_ASSIGNED', 2: 'SERVER_CHANGE', 3: 'REMOVE_S-CSCF'})]

class AVP_10415_623(AVP_FL_V):
    name = 'User-Authorization-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'REGISTRATION', 1: 'DE_REGISTRATION', 2: 'REGISTRATION_AND_CAPABILITIES'})]

class AVP_10415_624(AVP_FL_V):
    name = 'User-Data-Already-Available'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'USER_DATA_NOT_AVAILABLE', 1: 'USER_DATA_ALREADY_AVAILABLE'})]

class AVP_10415_633(AVP_FL_V):
    name = 'Originating-Request'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ORIGINATING'})]
...
class AVP_10415_648(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOT_MULTIPLE_REGISTRATION', 1: 'MULTIPLE_REGISTRATION'})]

class AVP_10415_650(AVP_FL_V):
    name = 'Session-Priority'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'PRIORITY-0', 1: 'PRIORITY-1', 2: 'PRIORITY-2', 3: 'PRIORITY-3', 4: 'PRIORITY-4'})]

class AVP_10415_652(AVP_FL_V):
    name = 'Priviledged-Sender-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOT_PRIVILEDGED_SENDER', 1: 'PRIVILEDGED_SENDER'})]

class AVP_10415_703(AVP_FL_V):
    name = 'Data-Reference'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'RepositoryData', 1: 'Undefined', 2: 'Undefined', 3: 'Undefined', 4: 'Undefined', 5: 'Undefined', 6: 'Undefined', 7: 'Undefined', 8: 'Undefined', 9: 'Undefined', 10: 'IMSPublicIdentity', 11: 'IMSUserState', 12: 'S-CSCFName', 13: 'InitialFilterCriteria', 14: 'LocationInformation', 15: 'UserState', 16: 'ChargingInformation', 17: 'MSISDN', 18: 'PSIActivation', 19: 'DSAI', 20: 'Reserved', 21: 'ServiceLevelTraceInfo', 22: 'IPAddressSecureBindingInformation', 23: 'ServicePriorityLevel', 24: 'SMSRegistrationInfo', 25: 'UEReachabilityForIP', 26: 'TADSinformation', 27: 'STN-SR', 28: 'UE-SRVCC-Capability', 29: 'ExtendedPriority', 30: 'CSRN', 31: 'ReferenceLocationInformation'})]

class AVP_10415_705(AVP_FL_V):
    name = 'Subs-Req-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Subscribe', 1: 'Unsubscribe'})]

class AVP_10415_706(AVP_FL_V):
    name = 'Requested-Domain'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CS-Domain', 1: 'PS-Domain'})]

class AVP_10415_707(AVP_FL_V):
    name = 'Current-Location'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DoNotNeedInitiateActiveLocationRetrieval', 1: 'InitiateActiveLocationRetrieval'})]

class AVP_10415_708(AVP_FL_V):
    name = 'Identity-Set'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ALL_IDENTITIES', 1: 'REGISTERED_IDENTITIES', 2: 'IMPLICIT_IDENTITIES', 3: 'ALIAS_IDENTITIES'})]
...
class AVP_10415_712(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ONE_TIME_NOTIFICATION_REQUESTED'})]

class AVP_10415_714(AVP_FL_V):
    name = 'Serving-Node-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ONLY_SERVING_NODES_REQUIRED'})]
...
class AVP_10415_718(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ONLY_LOCAL_TIME_ZONE_REQUESTED', 1: 'LOCAL_TIME_ZONE_WITH_LOCATION_INFO_REQUESTED'})]
...
class AVP_10415_862(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'S-CSCF', 1: 'P-CSCF', 2: 'I-CSCF', 5: 'BGCF', 6: 'AS', 7: 'IBCF', 8: 'S-GW', 9: 'P-GW', 10: 'HSGW', 11: 'E-CSCF ', 12: 'MME ', 13: 'TRF', 14: 'TF', 15: 'ATCF', 16: 'Proxy Function', 17: 'ePDG'})]
...
class AVP_10415_867(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: "'Append' ", 1: "'Overwrite' "})]

class AVP_10415_870(AVP_FL_V):
    name = 'Trigger-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'CHANGE_IN_SGSN_IP_ADDRESS ', 2: 'CHANGE_IN_QOS', 3: 'CHANGE_IN_LOCATION', 4: 'CHANGE_IN_RAT', 5: 'CHANGE_IN_UE_TIMEZONE', 10: 'CHANGEINQOS_TRAFFIC_CLASS', 11: 'CHANGEINQOS_RELIABILITY_CLASS', 12: 'CHANGEINQOS_DELAY_CLASS', 13: 'CHANGEINQOS_PEAK_THROUGHPUT', 14: 'CHANGEINQOS_PRECEDENCE_CLASS', 15: 'CHANGEINQOS_MEAN_THROUGHPUT', 16: 'CHANGEINQOS_MAXIMUM_BIT_RATE_FOR_UPLINK', 17: 'CHANGEINQOS_MAXIMUM_BIT_RATE_FOR_DOWNLINK', 18: 'CHANGEINQOS_RESIDUAL_BER', 19: 'CHANGEINQOS_SDU_ERROR_RATIO', 20: 'CHANGEINQOS_TRANSFER_DELAY', 21: 'CHANGEINQOS_TRAFFIC_HANDLING_PRIORITY', 22: 'CHANGEINQOS_GUARANTEED_BIT_RATE_FOR_UPLINK', 23: 'CHANGEINQOS_GUARANTEED_BIT_RATE_FOR_DOWNLINK', 24: 'CHANGEINQOS_APN_AGGREGATE_MAXIMUM_BIT_RATE', 30: 'CHANGEINLOCATION_MCC', 31: 'CHANGEINLOCATION_MNC', 32: 'CHANGEINLOCATION_RAC', 33: 'CHANGEINLOCATION_LAC', 34: 'CHANGEINLOCATION_CellId', 35: 'CHANGEINLOCATION_TAC', 36: 'CHANGEINLOCATION_ECGI', 40: 'CHANGE_IN_MEDIA_COMPOSITION', 50: 'CHANGE_IN_PARTICIPANTS_NMB', 51: 'CHANGE_IN_ THRSHLD_OF_PARTICIPANTS_NMB', 52: 'CHANGE_IN_USER_PARTICIPATING_TYPE', 60: 'CHANGE_IN_SERVICE_CONDITION', 61: 'CHANGE_IN_SERVING_NODE', 70: 'CHANGE_IN_USER_CSG_INFORMATION', 71: 'CHANGE_IN_HYBRID_SUBSCRIBED_USER_CSG_INFORMATION', 72: 'CHANGE_IN_HYBRID_UNSUBSCRIBED_USER_CSG_INFORMATION', 73: 'CHANGE_OF_UE_PRESENCE_IN_PRESENCE_REPORTING_AREA'})]

class AVP_10415_872(AVP_FL_V):
    name = 'Reporting-Reason'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'THRESHOLD', 1: 'QHT', 2: 'FINAL', 3: 'QUOTA_EXHAUSTED', 4: 'VALIDITY_TIME', 5: 'OTHER_QUOTA_TYPE', 6: 'RATING_CONDITION_CHANGE', 7: 'FORCED_REAUTHORISATION', 8: 'POOL_EXHAUSTED'})]
...
class AVP_10415_884(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '1 to 1 PoC session', 1: 'Chat PoC group session', 2: 'Pre-arranged PoC group session', 3: 'Ad-hoc PoC group session'})]

class AVP_10415_899(AVP_FL_V):
    name = 'Address-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'e-mail address', 1: 'MSISDN', 2: 'IPv4 Address', 3: 'IPv6 Address', 4: 'Numeric Shortcode', 5: 'Alphanumeric Shortcode', 6: 'Other', 7: 'IMSI'})]

class AVP_10415_902(AVP_FL_V):
    name = 'MBMS-StartStop-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'START', 1: 'STOP', 2: 'UPDATE'})]

class AVP_10415_906(AVP_FL_V):
    name = 'MBMS-Service-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'MULTICAST', 1: 'BROADCAST'})]

class AVP_10415_907(AVP_FL_V):
    name = 'MBMS-2G-3G-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '2G', 1: '3G', 2: '2G-AND-3G'})]

class AVP_10415_921(AVP_FL_V):
    name = 'CN-IP-Multicast-Distribution'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NO-IP-MULTICAST', 1: 'IP-MULTICAST'})]
...
class AVP_10415_1011(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SERVICE_IDENTIFIER_LEVEL', 1: 'RATING_GROUP_LEVEL', 2: 'SPONSORED_CONNECTIVITY_LEVEL'})]

class AVP_10415_1015(AVP_FL_V):
    name = 'PDP-Session-Operation'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'PDP-SESSION-TERMINATION'})]
...
class AVP_10415_1023(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'UE_ONLY', 1: 'RESERVED', 2: 'UE_NW'})]
...
class AVP_10415_1027(AVP_FL_V):
    name = 'IP-CAN-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '3GPP-GPRS', 1: 'DOCSIS', 2: 'xDSL', 3: 'WiMAX', 4: '3GPP2', 5: '3GPP-EPS', 6: 'Non-3GPP-EPS'})]

class AVP_10415_1028(AVP_FL_V):
    name = 'QoS-Class-Identifier'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'QCI_1', 2: 'QCI_2', 3: 'QCI_3', 4: 'QCI_4', 5: 'QCI_5', 6: 'QCI_6', 7: 'QCI_7', 8: 'QCI_8', 9: 'QCI_9'})]

class AVP_10415_1032(AVP_FL_V):
    name = 'RAT-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'WLAN', 1: 'VIRTUAL', 1000: 'UTRAN', 1001: 'GERAN', 1002: 'GAN', 1003: 'HSPA_EVOLUTION', 1004: 'EUTRAN', 2000: 'CDMA2000_1X', 2001: 'HRPD', 2002: 'UMB', 2003: 'EHRPD'})]

class AVP_10415_1045(AVP_FL_V):
    name = 'Session-Release-Cause'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'UNSPECIFIED_REASON', 1: 'UE_SUBSCRIPTION_REASON', 2: 'INSUFFICIENT_SERVER_RESOURCES'})]

class AVP_10415_1047(AVP_FL_V):
    name = 'Pre-emption-Capability'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'PRE-EMPTION_CAPABILITY_ENABLED', 1: 'PRE-EMPTION_CAPABILITY_DISABLED'})]

class AVP_10415_1048(AVP_FL_V):
    name = 'Pre-emption-Vulnerability'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'PRE-EMPTION_VULNERABILITY_ENABLED', 1: 'PRE-EMPTION_VULNERABILITY_DISABLED'})]

class AVP_10415_1062(AVP_FL_V):
    name = 'Packet-Filter-Operation'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DELETION', 1: 'ADDITION', 2: 'MODIFICATION'})]

class AVP_10415_1063(AVP_FL_V):
    name = 'Resource-Allocation-Notification'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ENABLE_NOTIFICATION'})]
...
class AVP_10415_1069(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'USAGE_MONITORING_REPORT_REQUIRED'})]

class AVP_10415_1070(AVP_FL_V):
    name = 'Usage-Monitoring-Support'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'USAGE_MONITORING_DISABLED'})]

class AVP_10415_1071(AVP_FL_V):
    name = 'CSG-Information-Reporting'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CHANGE_CSG_CELL', 1: 'CHANGE_CSG_SUBSCRIBED_HYBRID_CELL', 2: 'CHANGE_CSG_UNSUBSCRIBED_HYBRID_CELL'})]

class AVP_10415_1072(AVP_FL_V):
    name = 'Packet-Filter-Usage'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'SEND_TO_UE'})]

class AVP_10415_1073(AVP_FL_V):
    name = 'Charging-Correlation-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CHARGING_IDENTIFIER_REQUIRED'})]
...
class AVP_10415_1099(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'VIDEO_PS2CS_CONT_CANDIDATE'})]

class AVP_10415_1204(AVP_FL_V):
    name = 'Type-Number'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'TBC'})]

class AVP_10415_1208(AVP_FL_V):
    name = 'Addressee-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'TO ', 1: 'CC ', 2: 'BCC'})]

class AVP_10415_1209(AVP_FL_V):
    name = 'Priority'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Low', 1: 'Normal', 2: 'High'})]

class AVP_10415_1211(AVP_FL_V):
    name = 'Message-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'm-send-req', 2: 'm-send-conf', 3: 'm-notification-ind ', 4: 'm-notifyresp-ind ', 5: 'm-retrieve-conf ', 6: 'm-acknowledge-ind ', 7: 'm-delivery-ind ', 8: 'm-read-rec-ind ', 9: 'm-read-orig-ind', 10: 'm-forward-req ', 11: 'm-forward-conf ', 12: 'm-mbox-store-conf', 13: 'm-mbox-view-conf ', 14: 'm-mbox-upload-conf ', 15: 'm-mbox-delete-conf '})]
...
class AVP_10415_1216(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'No', 1: 'Yes'})]

class AVP_10415_1217(AVP_FL_V):
    name = 'Adaptations'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Yes', 1: 'No'})]

class AVP_10415_1220(AVP_FL_V):
    name = 'Content-Class'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'text ', 1: 'image-basic ', 2: 'image-rich ', 3: 'video-basic', 4: 'video-rich ', 5: 'megapixel ', 6: 'content-basic ', 7: 'content-rich '})]
...
class AVP_10415_1224(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Forwarding not pending', 1: 'Forwarding pending', 2: 'NOT_SUPPORTED'})]

class AVP_10415_1225(AVP_FL_V):
    name = 'MBMS-User-Service-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'DOWNLOAD', 2: 'STREAMING'})]

class AVP_10415_1247(AVP_FL_V):
    name = 'PDP-Context-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Primary', 1: 'Secondary'})]
...
class AVP_10415_1254(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'Moderator', 2: 'Dispatcher', 3: 'Session-Owner', 4: 'Session-Participant'})]

class AVP_10415_1259(AVP_FL_V):
    name = 'Participant-Access-Priority'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {1: 'Pre-emptive priority: ', 2: 'High priority: Lower than Pre-emptive priority', 3: 'Normal priority: Normal level. Lower than High priority', 4: 'Low priority: Lowest level priority'})]

class AVP_10415_1261(AVP_FL_V):
    name = 'PoC-Change-Condition'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ServiceChange', 1: 'VolumeLimit', 2: 'TimeLimit', 3: 'NumberofTalkBurstLimit', 4: 'NumberofActiveParticipants'})]

class AVP_10415_1268(AVP_FL_V):
    name = 'Envelope-Reporting'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DO_NOT_REPORT_ENVELOPES', 1: 'REPORT_ENVELOPES', 2: 'REPORT_ENVELOPES_WITH_VOLUME', 3: 'REPORT_ENVELOPES_WITH_EVENTS', 4: 'REPORT_ENVELOPES_WITH_VOLUME_AND_EVENTS'})]
...
class AVP_10415_1277(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Pre-established', 1: 'On-demand'})]

class AVP_10415_1279(AVP_FL_V):
    name = 'User-Participating-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Normal', 1: 'NW PoC Box', 2: 'UE PoC Box'})]
...
class AVP_10415_1420(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'MME_UPDATE_PROCEDURE', 1: 'SGSN_UPDATE_PROCEDURE', 2: 'SUBSCRIPTION_WITHDRAWAL', 3: 'UPDATE_PROCEDURE_IWF', 4: 'INITIAL_ATTACH_PROCEDURE'})]
...
class AVP_10415_1428(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ALL_APN_CONFIGURATIONS_INCLUDED'})]

class AVP_10415_1432(AVP_FL_V):
    name = 'VPLMN-Dynamic-Address-Allowed'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOTALLOWED', 1: 'ALLOWED'})]
...
class AVP_10415_1438(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'STATIC', 1: 'DYNAMIC'})]
...
class AVP_10415_1457(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Roaming-Restricted-Due-To-Unsupported-Feature'})]

class AVP_10415_1462(AVP_FL_V):
    name = 'Trace-Depth'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Minimum', 1: 'Medium', 2: 'Maximum', 3: 'MinimumWithoutVendorSpecificExtension', 4: 'MediumWithoutVendorSpecificExtension', 5: 'MaximumWithoutVendorSpecificExtension'})]

class AVP_10415_1468(AVP_FL_V):
    name = 'Complete-Data-List-Included-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ALL_PDP_CONTEXTS_INCLUDED'})]

class AVP_10415_1478(AVP_FL_V):
    name = 'Notification-To-UE-User'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOTIFY_LOCATION_ALLOWED', 1: 'NOTIFYANDVERIFY_LOCATION_ALLOWED_IF_NO_RESPONSE', 2: 'NOTIFYANDVERIFY_LOCATION_NOT_ALLOWED_IF_NO_RESPONSE', 3: 'LOCATION_NOT_ALLOWED'})]

class AVP_10415_1481(AVP_FL_V):
    name = 'GMLC-Restriction'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'GMLC_LIST', 1: 'HOME_COUNTRY'})]

class AVP_10415_1482(AVP_FL_V):
    name = 'PLMN-Client'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'BROADCAST_SERVICE', 1: 'O_AND_M_HPLMN', 2: 'O_AND_M_VPLMN', 3: 'ANONYMOUS_LOCATION', 4: 'TARGET_UE_SUBSCRIBED_SERVICE'})]

class AVP_10415_1491(AVP_FL_V):
    name = 'ICS-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'FALSE', 1: 'TRUE'})]

class AVP_10415_1492(AVP_FL_V):
    name = 'IMS-Voice-Over-PS-Sessions-Supported'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOT_SUPPORTED', 1: 'SUPPORTED'})]
...
class AVP_10415_1499(AVP_FL_V):
    name = 'User-State'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DETACHED', 1: 'ATTACHED_NOT_REACHABLE_FOR_PAGING', 2: 'ATTACHED_REACHABLE_FOR_PAGING', 3: 'CONNECTED_NOT_REACHABLE_FOR_PAGING', 4: 'CONNECTED_REACHABLE_FOR_PAGING', 5: 'NETWORK_DETERMINED_NOT_REACHABLE'})]

class AVP_10415_1501(AVP_FL_V):
    name = 'Non-3GPP-IP-Access'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NON_3GPP_SUBSCRIPTION_ALLOWED', 1: 'NON_3GPP_SUBSCRIPTION_BARRED'})]
...
class AVP_10415_1503(AVP_FL_V):
    name = 'AN-Trusted'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'TRUSTED', 1: 'UNTRUSTED'})]
...
class AVP_10415_1519(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'BBF'})]

class AVP_10415_1610(AVP_FL_V):
    name = 'Current-Location-Retrieved'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ACTIVE-LOCATION-RETRIEVAL'})]
...
class AVP_10415_1614(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'GPRS_DATA_SUBSCRIBED', 1: 'NO_GPRS_DATA_SUBSCRIBED', 2: 'ODB-ALL-APN', 3: 'ODB-HPLMN-APN', 4: 'ODB-VPLMN-APN'})]
...
class AVP_10415_1617(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'LIPA-NOTALLOWED', 1: 'LIPA-ALLOWED'})]
...
class AVP_10415_1623(AVP_FL_V):
    name = 'Job-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Immediate-MDT-only', 1: 'Logged-MDT-only', 2: 'Trace-only', 3: 'Immediate-MDT-and-Trace', 4: 'RLF-reports-only'})]

class AVP_10415_1627(AVP_FL_V):
    name = 'Report-Interval'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'UMTS_250_ms', 1: 'UMTS_500_ms', 2: 'UMTS_1000_ms', 3: 'UMTS_2000_ms', 4: 'UMTS_3000_ms', 5: 'UMTS_4000_ms', 6: 'UMTS_6000_ms', 7: 'UMTS_8000_ms', 8: 'UMTS_12000_ms', 9: 'UMTS_16000_ms', 10: 'UMTS_20000_ms', 11: 'UMTS_24000_ms', 12: 'UMTS_28000_ms', 13: 'UMTS_32000_ms', 14: 'UMTS_64000_ms', 15: 'LTE_120_ms', 16: 'LTE_240_ms', 17: 'LTE_480_ms', 18: 'LTE_640_ms', 19: 'LTE_1024_ms', 20: 'LTE_2048_ms', 21: 'LTE_5120_ms', 22: 'LTE_10240_ms', 23: 'LTE_60000_ms', 24: 'LTE_360000_ms', 25: 'LTE_720000_ms', 26: 'LTE_1800000_ms', 27: 'LTE_3600000_ms'})]

class AVP_10415_1628(AVP_FL_V):
    name = 'Report-Amount'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '1', 1: '2', 2: '4', 3: '8', 4: '16', 5: '32', 6: '64', 7: 'infinity'})]

class AVP_10415_1631(AVP_FL_V):
    name = 'Logging-Interval'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '1.28', 1: '2.56', 2: '5.12', 3: '10.24', 4: '20.48', 5: '30.72', 6: '40.96', 7: '61.44'})]

class AVP_10415_1632(AVP_FL_V):
    name = 'Logging-Duration'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '600_sec', 1: '1200_sec', 2: '2400_sec', 3: '3600_sec', 4: '5400_sec', 5: '7200_sec'})]

class AVP_10415_1633(AVP_FL_V):
    name = 'Relay-Node-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOT_RELAY_NODE', 1: 'RELAY_NODE'})]
...
class AVP_10415_1636(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'VSRVCC_SUBSCRIBED'})]

class AVP_10415_1648(AVP_FL_V):
    name = 'SMS-Register-Request'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SMS_REGISTRATION_REQUIRED', 1: 'SMS_REGISTRATION_NOT_PREFERRED', 2: 'NO_PREFERENCE'})]

class AVP_10415_1650(AVP_FL_V):
    name = 'Daylight-Saving-Time'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NO_ADJUSTMENT', 1: 'PLUS_ONE_HOUR_ADJUSTMENT', 2: 'PLUS_TWO_HOURS_ADJUSTMENT'})]

class AVP_10415_2006(AVP_FL_V):
    name = 'Interface-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Unknown', 1: 'MOBILE_ORIGINATING', 2: 'MOBILE_TERMINATING', 3: 'APPLICATION_ORIGINATING', 4: 'APPLICATION_TERMINATION'})]

class AVP_10415_2007(AVP_FL_V):
    name = 'SM-Message-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SUBMISSION'})]
...
class AVP_10415_2016(AVP_FL_V):
    name = 'SMS-Node'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SMS Router', 1: 'IP-SM-GW', 2: 'SMS Router and IP-SM-GW', 3: 'SMS-SC'})]

class AVP_10415_2025(AVP_FL_V):
    name = 'PoC-Event-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Normal;', 1: 'Instant Ppersonal Aalert event;', 2: 'PoC Group Advertisement event;', 3: 'Early Ssession Setting-up event;', 4: 'PoC Talk Burst'})]

class AVP_10415_2029(AVP_FL_V):
    name = 'SM-Service-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'VAS4SMS Short Message content processing', 1: 'VAS4SMS Short Message forwarding', 2: 'VAS4SMS Short Message Forwarding multiple subscriptions ', 3: 'VAS4SMS Short Message filtering ', 4: 'VAS4SMS Short Message receipt', 5: 'VAS4SMS Short Message Network Storage ', 6: 'VAS4SMS Short Message to multiple destinations', 7: 'VAS4SMS Short Message Virtual Private Network (VPN)', 8: 'VAS4SMS Short Message Auto Reply', 9: 'VAS4SMS Short Message Personal Signature', 10: 'VAS4SMS Short Message Deferred Delivery '})]

class AVP_10415_2033(AVP_FL_V):
    name = 'Subscriber-Role'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Originating', 1: 'Terminating'})]

class AVP_10415_2036(AVP_FL_V):
    name = 'SDP-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SDP Offer', 1: 'SDP Answer'})]

class AVP_10415_2047(AVP_FL_V):
    name = 'Serving-Node-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'SGSN', 1: 'PMIPSGW', 2: 'GTPSGW', 3: 'ePDG', 4: 'hSGW', 5: 'MME', 6: 'TWAN'})]

class AVP_10415_2049(AVP_FL_V):
    name = 'Participant-Action-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CREATE_CONF', 1: 'JOIN_CONF', 2: 'INVITE_INTO_CONF', 3: 'QUIT_CONF'})]
...
class AVP_10415_2065(AVP_FL_V):
    name = 'SGW-Change'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ACR_Start_NOT_due_to_SGW_Change'})]

class AVP_10415_2066(AVP_FL_V):
    name = 'Charging-Characteristics-Selection-Mode'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Serving-Node-Supplied', 1: 'Subscription-specific', 2: 'APN-specific', 3: 'Home-Default', 4: 'Roaming-Default', 5: 'Visiting-Default'})]
...
class AVP_10415_2118(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'UNKNOWN', 1: 'USAGE', 2: 'COMMUNICATION-ATTEMPT-CHARGE', 3: 'SETUP-CHARGE', 4: 'ADD-ON-CHARGE'})]
...
class AVP_10415_2204(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ESTABLISHMENT', 1: 'TERMINATION'})]

class AVP_10415_2206(AVP_FL_V):
    name = 'DRA-Deployment'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DRA_Deployed'})]

class AVP_10415_2208(AVP_FL_V):
    name = 'DRA-Binding'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'DRA_BINDING_DELETION'})]
...
class AVP_10415_2308(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Authenticated', 1: 'Unauthenticated'})]
...
class AVP_10415_2312(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NON_BINDING', 1: 'BINDING'})]
...
class AVP_10415_2317(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Closed mode', 1: 'Hybrid Mode'})]

class AVP_10415_2318(AVP_FL_V):
    name = 'CSG-Membership-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Not CSG member', 1: 'CSG Member  '})]

class AVP_10415_2322(AVP_FL_V):
    name = 'IMS-Emergency-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Non Emergency', 1: 'Emergency'})]

class AVP_10415_2323(AVP_FL_V):
    name = 'MBMS-Charged-Party'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Content Provider', 1: 'Subscriber'})]

class AVP_10415_2500(AVP_FL_V):
    name = 'SLg-Location-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CURRENT_LOCATION', 1: 'CURRENT_OR_LAST_KNOWN_LOCATION', 2: 'INITIAL_LOCATION', 3: 'ACTIVATE_DEFERRED_LOCATION', 4: 'CANCEL_DEFERRED_LOCATION', 5: 'NOTIFICATION_VERIFICATION_ONLY'})]

class AVP_10415_2507(AVP_FL_V):
    name = 'Vertical-Requested'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'VERTICAL_COORDINATE_IS_NOT REQUESTED', 1: 'VERTICAL_COORDINATE_IS_REQUESTED'})]
...
class AVP_10415_2509(AVP_FL_V):
    name = 'Response-Time'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'LOW_DELAY', 1: 'DELAY_TOLERANT'})]

class AVP_10415_2512(AVP_FL_V):
    name = 'LCS-Privacy-Check'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ALLOWED_WITHOUT_NOTIFICATION', 1: 'ALLOWED_WITH_NOTIFICATION', 2: 'ALLOWED_IF_NO_RESPONSE', 3: 'RESTRICTED_IF_NO_RESPONSE', 4: 'NOT_ALLOWED'})]

class AVP_10415_2513(AVP_FL_V):
    name = 'Accuracy-Fulfilment-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'REQUESTED_ACCURACY_FULFILLED', 1: 'REQUESTED_ACCURACY_NOT_FULFILLED'})]

class AVP_10415_2518(AVP_FL_V):
    name = 'Location-Event'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'EMERGENCY_CALL_ORIGINATION', 1: 'EMERGENCY_CALL_RELEASE', 2: 'MO_LR', 3: 'EMERGENCY_CALL_HANDOVER'})]
...
class AVP_10415_2523(AVP_FL_V):
    name = 'LCS-QoS-Class'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'ASSURED', 1: 'BEST EFFORT'})]
...
class AVP_10415_2551(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NOT_PRIORITIZED', 1: 'PRIORITIZED'})]

class AVP_10415_2602(AVP_FL_V):
    name = 'Low-Priority-Indicator'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'NO'})]

class AVP_10415_2604(AVP_FL_V):
    name = 'Local-GW-Inserted-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Local GW Not Inserted', 1: 'Local GW Inserted'})]

class AVP_10415_2605(AVP_FL_V):
    name = 'Transcoder-Inserted-Indication'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Transcoder Not Inserted', 1: 'Transcoder Inserted'})]

class AVP_10415_2702(AVP_FL_V):
    name = 'AS-Code'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: '4xx;', 1: '5xx;', 2: 'Timeout'})]

class AVP_10415_2704(AVP_FL_V):
    name = 'NNI-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'non-roaming', 1: 'roaming without loopback', 2: 'roaming with loopback'})]

class AVP_10415_2706(AVP_FL_V):
    name = 'Relationship-Mode'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'trusted', 1: 'non-trusted'})]

class AVP_10415_2707(AVP_FL_V):
    name = 'Session-Direction'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'inbound'})]
...
class AVP_10415_2717(AVP_FL_V):
    name = 'TAD-Identifier'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'CS', 1: 'PS'})]

class AVP_10415_2809(AVP_FL_V):
    name = 'Mute-Notification'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'MUTE_REQUIRED'})]

class AVP_10415_2811(AVP_FL_V):
    name = 'AN-GW-Status'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'AN_GW_FAILED'})]
...
class AVP_10415_3407(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Not DeviceTrigger ', 1: 'Device Trigger'})]
...
class AVP_10415_3421(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'The Serving Network has been selected by the UE', 1: 'The Serving Network has been selected by the network'})]

class AVP_10415_3428(AVP_FL_V):
    name = 'Coverage-Status'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Out of coverage', 1: 'In coverage'})]

class AVP_10415_3438(AVP_FL_V):
    name = 'Role-Of-ProSe-Function'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'HPLMN', 1: 'VPLMN'})]

class AVP_10415_3442(AVP_FL_V):
    name = 'ProSe-Direct-Discovery-Model'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Model A', 1: 'Model B'})]

class AVP_10415_3443(AVP_FL_V):
    name = 'ProSe-Event-Type'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Announcing', 1: 'Monitoring', 2: 'Match Report'})]
...
class AVP_10415_3448(AVP_FL_V):
    ...
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Reserved', 1: '50 m', 2: '100 m', 3: '200 m', 4: '500 m', 5: '1000 m'})]

class AVP_10415_3449(AVP_FL_V):
    name = 'ProSe-Reason-For-Cancellation'
    avpLen = 16
    fields_desc = [AVP_FL_V, Enumerated('val', None, {0: 'Proximity Alert sent', 1: 'Time expired with no renewal'})]
