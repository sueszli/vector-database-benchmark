...
__protobuf__ = proto.module(package='google.cloud.contentwarehouse.v1', manifest={'ListLinkedTargetsResponse', 'ListLinkedTargetsRequest', 'ListLinkedSourcesResponse', 'ListLinkedSourcesRequest', 'DocumentLink', 'CreateDocumentLinkRequest', 'DeleteDocumentLinkRequest'})
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    document_links: MutableSequence['DocumentLink'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DocumentLink')
...
class ListLinkedTargetsRequest(proto.Message):
    ...
    request_metadata: common.RequestMetadata = proto.Field(proto.MESSAGE, number=2, message=common.RequestMetadata)
...
class DocumentLink(proto.Message):
    ...
    source_document_reference: document.DocumentReference = proto.Field(proto.MESSAGE, number=2, message=document.DocumentReference)
    target_document_reference: document.DocumentReference = proto.Field(proto.MESSAGE, number=3, message=document.DocumentReference)
...
class CreateDocumentLinkRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    document_link: 'DocumentLink' = proto.Field(proto.MESSAGE, number=2, message='DocumentLink')
