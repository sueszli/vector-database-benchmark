...
def main():
    ...
    response = client.share_subscriptions.list_synchronizations(resource_group_name='SampleResourceGroup', account_name='Account1', share_subscription_name='ShareSub1')
