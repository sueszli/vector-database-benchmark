...
@testing.parameterize({'gru': links.StatelessGRU, 'state': 'random', 'in_size': 3, 'out_size': 5}, {'gru': links.StatelessGRU, 'state': 'random', 'out_size': 5}, {'gru': links.GRU, 'state': 'random', 'in_size': 3, 'out_size': 5}, {'gru': links.GRU, 'state': 'zero', 'in_size': 3, 'out_size': 5}, {'gru': links.StatefulGRU, 'state': 'random', 'in_size': 3, 'out_size': 5}, {'gru': links.StatefulGRU, 'state': 'zero', 'in_size': 3, 'out_size': 5})
...
@testing.parameterize(*testing.product({'link_array_module': ['to_cpu', 'to_gpu'], 'state_array_module': ['to_cpu', 'to_gpu'], 'gru': [links.GRU, links.StatefulGRU]}))
...
@testing.parameterize({'gru': links.GRU}, {'gru': links.StatefulGRU})
