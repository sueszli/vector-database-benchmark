...
from sentry.db.models import BaseManager, BoundedPositiveIntegerField, FlexibleForeignKey, Model, control_silo_only_model, sane_repr
...
class ApiApplication(Model):
    ...
    status = BoundedPositiveIntegerField(default=0, choices=((ApiApplicationStatus.active, _('Active')), (ApiApplicationStatus.inactive, _('Inactive'))), db_index=True)
