...
class FrontendMastersBaseIE(InfoExtractor):
    ...
    _QUALITIES = {'low': {'width': 480, 'height': 360}, 'mid': {'width': 1280, 'height': 720}, 'high': {'width': 1920, 'height': 1080}}
...
class FrontendMastersIE(FrontendMastersBaseIE):
    ...
    _TESTS = [{'url': 'https://api.frontendmasters.com/v1/kabuki/video/a2qogef6ba', 'md5': '7f161159710d6b7016a4f4af6fcb05e2', 'info_dict': {'id': 'a2qogef6ba', 'ext': 'mp4', 'title': 'a2qogef6ba'}, 'skip': 'Requires FrontendMasters account credentials'}, {'url': 'frontendmasters:a2qogef6ba', 'only_matching': True}]
...
class FrontendMastersLessonIE(FrontendMastersPageBaseIE):
    ...
    _TEST = {'url': 'https://frontendmasters.com/courses/web-development/tools', 'info_dict': {'id': 'a2qogef6ba', 'display_id': 'tools', 'ext': 'mp4', 'title': 'Tools', 'description': 'md5:82c1ea6472e88ed5acd1829fe992e4f7', 'thumbnail': 're:^https?://.*\\.jpg$', 'chapter': 'Introduction', 'chapter_number': 1}, 'params': {'skip_download': True}, 'skip': 'Requires FrontendMasters account credentials'}
...
class FrontendMastersCourseIE(FrontendMastersPageBaseIE):
    ...
    _TEST = {'url': 'https://frontendmasters.com/courses/web-development/', 'info_dict': {'id': 'web-development', 'title': 'Introduction to Web Development', 'description': 'md5:9317e6e842098bf725d62360e52d49a6'}, 'playlist_count': 81, 'skip': 'Requires FrontendMasters account credentials'}
