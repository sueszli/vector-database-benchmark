...
class DJVUInput(InputFormatPlugin):
    ...
    def convert(self, stream, options, file_ext, log, accelerators):
        ...
        if not raw_text:
            raise ValueError('The DJVU file contains no text, only images, probably page scans. calibre only supports conversion of DJVU files with actual text in them.')
