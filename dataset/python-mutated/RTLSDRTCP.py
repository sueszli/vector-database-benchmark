...
class RTLSDRTCP(Device):
    MAXDATASIZE = 65536
    ENDIAN = 'big'
    RTL_TCP_CONSTS = ['NULL', 'centerFreq', 'sampleRate', 'tunerGainMode', 'tunerGain', 'freqCorrection', 'tunerIFGain', 'testMode', 'agcMode', 'directSampling', 'offsetTuning', 'rtlXtalFreq', 'tunerXtalFreq', 'gainByIndex', 'bandwidth', 'biasTee']
    DATA_TYPE = np.uint8
