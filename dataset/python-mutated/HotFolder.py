...
class HotFolder(BaseAddon):
    ...
    __version__ = '0.27'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('folder', 'folder', 'Folder to watch', 'watchdir'), ('watchfile', 'bool', 'Watch link file', False), ('delete', 'bool', 'Delete added containers', False), ('file', 'str', 'Link file', 'links.txt'), ('interval', 'int', 'File / folder check interval in seconds (minimum 20)', 60), ('enable_extension_filter', 'bool', 'Extension filter', False), ('extension_filter', 'str', 'Extensions to look for (comma separated)', 'dlc'), ('add_to', 'Packages;Queue', 'Add files to', 'Queue')]
    __description__ = 'Observe folder and file for changes and add container and links'
    __license__ = 'GPLv3'
    __authors__ = [('RaNaN', 'RaNaN@pyload.de'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
