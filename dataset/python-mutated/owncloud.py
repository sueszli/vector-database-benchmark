...
class OwnCloudIE(InfoExtractor):
    _INSTANCES_RE = '|'.join(('(?:[^\\.]+\\.)?sciebo\\.de', 'cloud\\.uni-koblenz-landau\\.de'))
    _VALID_URL = f'https?://(?:{_INSTANCES_RE})/s/(?P<id>[\\w.-]+)'
    _TESTS = [{'url': 'https://ruhr-uni-bochum.sciebo.de/s/wWhqZzh9jTumVFN', 'info_dict': {'id': 'wWhqZzh9jTumVFN', 'ext': 'mp4', 'title': 'CmvpJST.mp4'}}, {'url': 'https://ruhr-uni-bochum.sciebo.de/s/WNDuFu0XuFtmm3f', 'info_dict': {'id': 'WNDuFu0XuFtmm3f', 'ext': 'mp4', 'title': 'CmvpJST.mp4'}, 'params': {'videopassword': '12345'}}]
