...
__all__ = ('HtmlDecoration', 'MarkdownDecoration', 'TextDecoration', 'html_decoration', 'markdown_decoration', 'add_surrogates', 'remove_surrogates')
...
class MarkdownDecoration(TextDecoration):
    MARKDOWN_QUOTE_PATTERN: Pattern[str] = re.compile('([_*\\[\\]()~`>#+\\-=|{}.!\\\\])')
