...
class TusfilesNetFolder(XFSDecrypter):
    ...
    __version__ = '0.17'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?tusfiles\\.net/go/(?P<ID>\\w+)'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('Walter Purcaro', 'vuolter@gmail.com'), ('stickell', 'l.stickell@yahoo.it')]
    PLUGIN_DOMAIN = 'tusfiles.net'
    PAGES_PATTERN = '>\\((\\d+) \\w+\\)<'
    URL_REPLACEMENTS = [(__pattern__ + '.*', 'https://www.tusfiles.net/go/\\g<ID>/')]
