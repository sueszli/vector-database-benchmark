...
import pytest
from google.maps.fleetengine_v1.services.vehicle_service import VehicleServiceAsyncClient, VehicleServiceClient, pagers, transports
from google.maps.fleetengine_v1.types import fleetengine, header, traffic, vehicle_api, vehicles
...
@pytest.mark.parametrize('client_class,transport_name', [(VehicleServiceClient, 'grpc'), (VehicleServiceAsyncClient, 'grpc_asyncio')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.VehicleServiceGrpcTransport, 'grpc'), (transports.VehicleServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
def test_vehicle_service_client_get_transport_class():
    ...
    available_transports = [transports.VehicleServiceGrpcTransport]
    assert transport in available_transports
    transport = VehicleServiceClient.get_transport_class('grpc')
    assert transport == transports.VehicleServiceGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(VehicleServiceClient, transports.VehicleServiceGrpcTransport, 'grpc'), (VehicleServiceAsyncClient, transports.VehicleServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
@pytest.mark.parametrize('client_class', [VehicleServiceClient, VehicleServiceAsyncClient])
@mock.patch.object(VehicleServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(VehicleServiceClient))
@mock.patch.object(VehicleServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(VehicleServiceAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(VehicleServiceClient, transports.VehicleServiceGrpcTransport, 'grpc', grpc_helpers), (VehicleServiceAsyncClient, transports.VehicleServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_vehicle_service_client_client_options_from_dict():
    ...
    with mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = VehicleServiceClient(client_options={'api_endpoint': 'squid.clam.whelk'})
...
def test_create_vehicle_empty_call():
    if False:
        return 10
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.create_vehicle), '__call__') as call:
...
async def test_create_vehicle_async(transport: str='grpc_asyncio', request_type=vehicle_api.CreateVehicleRequest):
    client = VehicleServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_vehicle), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(vehicles.Vehicle(name='name_value', vehicle_state=vehicles.VehicleState.OFFLINE, supported_trip_types=[fleetengine.TripType.SHARED], current_trips=['current_trips_value'], maximum_capacity=1707, current_route_segment='current_route_segment_value', back_to_back_enabled=True, navigation_status=fleetengine.NavigationStatus.NO_GUIDANCE))
...
def test_create_vehicle_routing_parameters():
    if False:
        for i in range(10):
            print('nop')
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
@pytest.mark.parametrize('request_type', [vehicle_api.GetVehicleRequest, dict])
...
@pytest.mark.parametrize('request_type', [vehicle_api.UpdateVehicleRequest, dict])
...
@pytest.mark.parametrize('request_type', [vehicle_api.UpdateVehicleLocationRequest, dict])
def test_update_vehicle_location(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.update_vehicle_location), '__call__') as call:
        call.return_value = fleetengine.VehicleLocation(location_sensor=fleetengine.LocationSensor.GPS, raw_location_sensor=fleetengine.LocationSensor.GPS, supplemental_location_sensor=fleetengine.LocationSensor.GPS, road_snapped=True)
...
async def test_update_vehicle_location_async(transport: str='grpc_asyncio', request_type=vehicle_api.UpdateVehicleLocationRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.update_vehicle_location), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(fleetengine.VehicleLocation(location_sensor=fleetengine.LocationSensor.GPS, raw_location_sensor=fleetengine.LocationSensor.GPS, supplemental_location_sensor=fleetengine.LocationSensor.GPS, road_snapped=True))
...
@pytest.mark.parametrize('request_type', [vehicle_api.UpdateVehicleAttributesRequest, dict])
...
@pytest.mark.parametrize('request_type', [vehicle_api.ListVehiclesRequest, dict])
def test_list_vehicles(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_vehicles), '__call__') as call:
        call.return_value = vehicle_api.ListVehiclesResponse(next_page_token='next_page_token_value', total_size=1086)
...
async def test_list_vehicles_async(transport: str='grpc_asyncio', request_type=vehicle_api.ListVehiclesRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_vehicles), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(vehicle_api.ListVehiclesResponse(next_page_token='next_page_token_value', total_size=1086))
...
def test_list_vehicles_pager(transport_name: str='grpc'):
    if False:
        return 10
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_vehicles), '__call__') as call:
        call.side_effect = (vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle(), vehicles.Vehicle(), vehicles.Vehicle()], next_page_token='abc'), vehicle_api.ListVehiclesResponse(vehicles=[], next_page_token='def'), vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle()], next_page_token='ghi'), vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle(), vehicles.Vehicle()]), RuntimeError)
        metadata = ()
...
async def test_list_vehicles_async_pager():
    client = VehicleServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_vehicles), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle(), vehicles.Vehicle(), vehicles.Vehicle()], next_page_token='abc'), vehicle_api.ListVehiclesResponse(vehicles=[], next_page_token='def'), vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle()], next_page_token='ghi'), vehicle_api.ListVehiclesResponse(vehicles=[vehicles.Vehicle(), vehicles.Vehicle()]), RuntimeError)
...
@pytest.mark.parametrize('request_type', [vehicle_api.SearchVehiclesRequest, dict])
...
def test_credentials_transport_error():
    if False:
        for i in range(10):
            print('nop')
    transport = transports.VehicleServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.VehicleServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = VehicleServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.VehicleServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = VehicleServiceClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = VehicleServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.VehicleServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = VehicleServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.VehicleServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    if False:
        print('Hello World!')
    transport = VehicleServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        ...
        return i + 15
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.VehicleServiceGrpcTransport)

def test_vehicle_service_base_transport_error():
    if False:
        print('Hello World!')
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.VehicleServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_vehicle_service_base_transport():
    ...
    with mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceTransport.__init__') as Transport:
        ...
        transport = transports.VehicleServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_vehicle', 'get_vehicle', 'update_vehicle', 'update_vehicle_location', 'update_vehicle_attributes', 'list_vehicles', 'search_vehicles', 'search_fuzzed_vehicles')
...
def test_vehicle_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.maps.fleetengine_v1.services.vehicle_service.transports.VehicleServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.VehicleServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.VehicleServiceGrpcTransport, grpc_helpers), (transports.VehicleServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_vehicle_service_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='fleetengine.googleapis.com'), transport=transport_name)
    assert client.transport._host == 'fleetengine.googleapis.com:443'
...
def test_vehicle_service_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='fleetengine.googleapis.com:8000'), transport=transport_name)
...
def test_vehicle_service_grpc_transport_channel():
    ...
    transport = transports.VehicleServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_vehicle_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.VehicleServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.VehicleServiceGrpcTransport, transports.VehicleServiceGrpcAsyncIOTransport])
def test_vehicle_service_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        while True:
            i = 10
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.VehicleServiceTransport, '_prep_wrapped_messages') as prep:
        client = VehicleServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = VehicleServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(VehicleServiceClient, transports.VehicleServiceGrpcTransport), (VehicleServiceAsyncClient, transports.VehicleServiceGrpcAsyncIOTransport)])
