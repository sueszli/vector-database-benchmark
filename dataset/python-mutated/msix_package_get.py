...
def main():
    ...
    response = client.msix_packages.get(resource_group_name='resourceGroup1', host_pool_name='hostpool1', msix_package_full_name='packagefullname')
    print(response)
