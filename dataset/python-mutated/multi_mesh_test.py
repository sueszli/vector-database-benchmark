...
_ONE_D_CPU_MESH = Mesh([_MESH_DIM_X], _DEVICES_IDS, np.ravel(_DEVICES_IDS).tolist(), test_util.create_device_list((2,), 'CPU'))
_ONE_D_GPU_MESH = Mesh([_MESH_DIM_X], _DEVICES_IDS, np.ravel(_DEVICES_IDS).tolist(), test_util.create_device_list((2,), 'GPU'))
_ONE_D_TPU_MESH = Mesh([_MESH_DIM_X], _DEVICES_IDS, np.ravel(_DEVICES_IDS).tolist(), test_util.create_device_list((2,), 'TPU'))
_ONE_D_CPU_MESH_Y = Mesh([_MESH_DIM_Y], _DEVICES_IDS, np.ravel(_DEVICES_IDS).tolist(), test_util.create_device_list((2,), 'CPU'))
_OTHER_CPU_MESH = Mesh([_MESH_DIM_X], _DEVICES_IDS[:1], np.ravel(_DEVICES_IDS[:1]).tolist(), test_util.create_device_list((1,), 'CPU'))
