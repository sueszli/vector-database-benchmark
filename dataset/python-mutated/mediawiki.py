...
traits: EngineTraits
about = {'website': None, 'wikidata_id': None, 'official_api_documentation': 'https://www.mediawiki.org/w/api.php?action=help&modules=query', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
categories = ['general']
paging = True
number_of_results = 5
