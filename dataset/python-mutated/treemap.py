...
p = figure(width=w, height=h, tooltips='@City', toolbar_location=None, x_axis_location=None, y_axis_location=None)
p.x_range.range_padding = p.y_range.range_padding = 0
p.grid.grid_line_color = None
p.block('x', 'y', 'dx', 'dy', source=blocks, line_width=1, line_color='white', fill_alpha=0.8, fill_color=factor_cmap('Region', 'MediumContrast4', regions))
p.text('x', 'y', x_offset=2, text='Region', source=blocks_by_region, text_font_size='18pt', text_color='white')
blocks['ytop'] = blocks.y + blocks.dy
p.text('x', 'ytop', x_offset=2, y_offset=2, text='City', source=blocks, text_font_size='6pt', text_baseline='top', text_color=factor_cmap('Region', ('black', 'white', 'black', 'white'), regions))
show(p)