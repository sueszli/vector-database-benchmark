...
from sympy.stats.rv import ProductPSpace, NamedArgsMixin, Distribution, ProductDomain, RandomSymbol, random_symbols, SingleDomain, _symbol_converter
...
class SampleJointPymc:
    ...
    def _sample_pymc(cls, dist, size, seed):
        ...
        return samples.reshape(size + sample_shape[dist.__class__.__name__](dist))
_get_sample_class_jrv = {'scipy': SampleJointScipy, 'pymc3': SampleJointPymc, 'pymc': SampleJointPymc, 'numpy': SampleJointNumpy}
