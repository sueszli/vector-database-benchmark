...
def make_leaky_relu_tests(options):
    ...
    test_parameters = [{'input_shape': [[], [1], [5], [1, 10, 10, 3], [3, 3, 3, 3]], 'alpha': [0.1, 1.0, 2.0, -0.1, -1.0, -2.0], 'fully_quantize': [False, True], 'input_range': [(-3, 10)], 'quant_16x8': [False, True]}]
    ...
    def build_inputs(parameters, sess, inputs, outputs):
        ...
        input_values = create_tensor_data(np.float32, parameters['input_shape'], min_value=-3, max_value=10)
