...
(univar_noexo_data_with_index_index_plus_return_type, ids_univar_noexo_data_with_index_index) = _get_univar_noexo_data_with_index_index()
...
(univar_noexo_data_with_index_column_plus_return_type, ids_univar_noexo_data_with_index_column) = _get_univar_noexo_data_with_index_column()
...
def test_ts_indices_univar_noexo_index_column(data, model, expected_return_index_type):
    ...
    _check_model_creation_and_indices(exp, model=model, expected_return_index_type=expected_return_index_type)
(univar_exo_data_with_index_index_plus_return_type, ids_univar_exo_data_with_index_index) = _get_univar_exo_data_with_index_index()
...
def test_ts_indices_univar_exo_index_index(data, model, expected_return_index_type):
    ...
    _check_model_creation_and_indices(exp, model=model, expected_return_index_type=expected_return_index_type)
(univar_exo_data_with_index_column_plus_return_type, ids_univar_exo_data_with_index_column) = _get_univar_exo_data_with_index_column()
