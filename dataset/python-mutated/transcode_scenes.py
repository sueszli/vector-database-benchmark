...
if __name__ == '__main__':
    ...
    parser.add_argument('--main_data', type=str, default=None, help='Path to root data directory')
    parser.add_argument('--resolution', type=str, default=None, help="one of '4K', '1080p', '720p', or '540p'")
    parser.add_argument('--codec', type=str, default=None, help="one of 'h264' or 'hevc'")
    parser.add_argument('--crf', type=str, default=None, help='crf value passed to ffmpeg')
    parser.add_argument('--keyint', type=str, default=None, help='keyframe interval')
