...
class PrintAspectActionTest(unittest.TestCase):
    ...
    def test_is_applicable(self):
        ...
        self.assertEqual('There is no aspect associated with the result.', self.uut.is_applicable(Result('o', 'm'), None, None))
    ...
    def test_apply(self):
        ...
        with retrieve_stdout() as stdout:
            ...
            self.assertEqual(stdout.getvalue(), type(self.test_aspect).__qualname__ + '\n' + type(self.test_aspect).docs.definition + '\n')