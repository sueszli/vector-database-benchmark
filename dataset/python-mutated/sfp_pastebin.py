...
class sfp_pastebin(SpiderFootPlugin):
    meta = {'name': 'PasteBin', 'summary': 'PasteBin search (via Google Search API) to identify related content.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Leaks, Dumps and Breaches'], 'dataSource': {'website': 'https://pastebin.com/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://pastebin.com/doc_api', 'https://pastebin.com/faq'], 'apiKeyInstructions': ['Visit https://developers.google.com/custom-search/v1/introduction', 'Register a free Google account', "Click on 'Get A Key'", 'Connect a Project', "The API Key will be listed under 'YOUR API KEY'"], 'favIcon': 'https://pastebin.com/favicon.ico', 'logo': 'https://pastebin.com/favicon.ico', 'description': 'Pastebin is a website where you can store any text online for easy sharing. The website is mainly used by programmers to store pieces of source code or configuration information, but anyone is more than welcome to paste any type of text. The idea behind the site is to make it more convenient for people to share large amounts of text online.'}}
    opts = {'api_key': '', 'cse_id': '013611106330597893267:tfgl3wxdtbp'}
    optdescs = {'api_key': 'Google API Key for PasteBin search.', 'cse_id': 'Google Custom Search Engine ID.'}
