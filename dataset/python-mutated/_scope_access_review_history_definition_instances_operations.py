...
def build_list_request(scope: str, history_definition_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances')
...
class ScopeAccessReviewHistoryDefinitionInstancesOperations:
    ...
    @distributed_trace
    def list(self, scope: str, history_definition_id: str, **kwargs: Any) -> Iterable['_models.AccessReviewHistoryInstance']:
        if False:
            i = 10
            return i + 15
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_request(scope=scope, history_definition_id=history_definition_id, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    list.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances'}