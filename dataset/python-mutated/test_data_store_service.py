...
from google.cloud.discoveryengine_v1alpha.services.data_store_service import DataStoreServiceAsyncClient, DataStoreServiceClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(DataStoreServiceClient, 'grpc'), (DataStoreServiceAsyncClient, 'grpc_asyncio'), (DataStoreServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.DataStoreServiceGrpcTransport, 'grpc'), (transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.DataStoreServiceRestTransport, 'rest')])
...
def test_data_store_service_client_get_transport_class():
    ...
    available_transports = [transports.DataStoreServiceGrpcTransport, transports.DataStoreServiceRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(DataStoreServiceClient, transports.DataStoreServiceGrpcTransport, 'grpc'), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (DataStoreServiceClient, transports.DataStoreServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(DataStoreServiceClient, transports.DataStoreServiceGrpcTransport, 'grpc', 'true'), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'true'), (DataStoreServiceClient, transports.DataStoreServiceGrpcTransport, 'grpc', 'false'), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'false'), (DataStoreServiceClient, transports.DataStoreServiceRestTransport, 'rest', 'true'), (DataStoreServiceClient, transports.DataStoreServiceRestTransport, 'rest', 'false')])
@mock.patch.object(DataStoreServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(DataStoreServiceClient))
@mock.patch.object(DataStoreServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(DataStoreServiceAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(DataStoreServiceClient, transports.DataStoreServiceGrpcTransport, 'grpc', grpc_helpers), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async), (DataStoreServiceClient, transports.DataStoreServiceRestTransport, 'rest', None)])
...
def test_data_store_service_client_client_options_from_dict():
    if False:
        i = 10
        return i + 15
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(DataStoreServiceClient, transports.DataStoreServiceGrpcTransport, 'grpc', grpc_helpers), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
@pytest.mark.parametrize('request_type', [data_store_service.CreateDataStoreRequest, dict])
...
async def test_create_data_store_async(transport: str='grpc_asyncio', request_type=data_store_service.CreateDataStoreRequest):
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_data_store), '__call__') as call:
...
def test_create_data_store_field_headers():
    if False:
        i = 10
        return i + 15
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_create_data_store_field_headers_async():
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = data_store_service.CreateDataStoreRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_data_store), '__call__') as call:
...
def test_create_data_store_flattened():
    ...
    with mock.patch.object(type(client.transport.create_data_store), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_data_store(parent='parent_value', data_store=gcd_data_store.DataStore(name='name_value'), data_store_id='data_store_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
...
def test_create_data_store_flattened_error():
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_data_store(data_store_service.CreateDataStoreRequest(), parent='parent_value', data_store=gcd_data_store.DataStore(name='name_value'), data_store_id='data_store_id_value')
...
async def test_create_data_store_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_data_store), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_data_store(parent='parent_value', data_store=gcd_data_store.DataStore(name='name_value'), data_store_id='data_store_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_data_store_flattened_error_async():
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_data_store(data_store_service.CreateDataStoreRequest(), parent='parent_value', data_store=gcd_data_store.DataStore(name='name_value'), data_store_id='data_store_id_value')

@pytest.mark.parametrize('request_type', [data_store_service.GetDataStoreRequest, dict])
def test_get_data_store(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_data_store), '__call__') as call:
        call.return_value = data_store.DataStore(name='name_value', display_name='display_name_value', industry_vertical=common.IndustryVertical.GENERIC, solution_types=[common.SolutionType.SOLUTION_TYPE_RECOMMENDATION], default_schema_id='default_schema_id_value', content_config=data_store.DataStore.ContentConfig.NO_CONTENT)
...
async def test_get_data_store_async(transport: str='grpc_asyncio', request_type=data_store_service.GetDataStoreRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_data_store), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_store.DataStore(name='name_value', display_name='display_name_value', industry_vertical=common.IndustryVertical.GENERIC, solution_types=[common.SolutionType.SOLUTION_TYPE_RECOMMENDATION], default_schema_id='default_schema_id_value', content_config=data_store.DataStore.ContentConfig.NO_CONTENT))
...
def test_get_data_store_flattened():
    ...
    with mock.patch.object(type(client.transport.get_data_store), '__call__') as call:
        call.return_value = data_store.DataStore()
        client.get_data_store(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_get_data_store_flattened_error():
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_data_store(data_store_service.GetDataStoreRequest(), name='name_value')
...
async def test_get_data_store_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_data_store), '__call__') as call:
        call.return_value = data_store.DataStore()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_store.DataStore())
        response = await client.get_data_store(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_get_data_store_flattened_error_async():
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_data_store(data_store_service.GetDataStoreRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [data_store_service.ListDataStoresRequest, dict])
def test_list_data_stores(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_data_stores), '__call__') as call:
        call.return_value = data_store_service.ListDataStoresResponse(next_page_token='next_page_token_value')
...
async def test_list_data_stores_async(transport: str='grpc_asyncio', request_type=data_store_service.ListDataStoresRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_data_stores), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_store_service.ListDataStoresResponse(next_page_token='next_page_token_value'))
...
def test_list_data_stores_flattened():
    ...
    with mock.patch.object(type(client.transport.list_data_stores), '__call__') as call:
        call.return_value = data_store_service.ListDataStoresResponse()
        client.list_data_stores(parent='parent_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_list_data_stores_flattened_error():
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_data_stores(data_store_service.ListDataStoresRequest(), parent='parent_value')
...
async def test_list_data_stores_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_data_stores), '__call__') as call:
        call.return_value = data_store_service.ListDataStoresResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_store_service.ListDataStoresResponse())
        response = await client.list_data_stores(parent='parent_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
@pytest.mark.parametrize('request_type', [data_store_service.DeleteDataStoreRequest, dict])
...
def test_delete_data_store_flattened():
    ...
    with mock.patch.object(type(client.transport.delete_data_store), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.delete_data_store(name='name_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_delete_data_store_flattened_error():
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_data_store(data_store_service.DeleteDataStoreRequest(), name='name_value')
...
async def test_delete_data_store_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_data_store), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.delete_data_store(name='name_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_delete_data_store_flattened_error_async():
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_data_store(data_store_service.DeleteDataStoreRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [data_store_service.UpdateDataStoreRequest, dict])
def test_update_data_store(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.update_data_store), '__call__') as call:
        call.return_value = gcd_data_store.DataStore(name='name_value', display_name='display_name_value', industry_vertical=common.IndustryVertical.GENERIC, solution_types=[common.SolutionType.SOLUTION_TYPE_RECOMMENDATION], default_schema_id='default_schema_id_value', content_config=gcd_data_store.DataStore.ContentConfig.NO_CONTENT)
...
def test_update_data_store_field_headers():
    ...
    with mock.patch.object(type(client.transport.update_data_store), '__call__') as call:
        ...
        assert args[0] == request
    (_, _, kw) = call.mock_calls[0]
    assert ('x-goog-request-params', 'data_store.name=name_value') in kw['metadata']
...
def test_update_data_store_flattened():
    ...
    with mock.patch.object(type(client.transport.update_data_store), '__call__') as call:
        call.return_value = gcd_data_store.DataStore()
        client.update_data_store(data_store=gcd_data_store.DataStore(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].data_store
        mock_val = gcd_data_store.DataStore(name='name_value')
...
def test_update_data_store_flattened_error():
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_data_store(data_store_service.UpdateDataStoreRequest(), data_store=gcd_data_store.DataStore(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_data_store_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_data_store), '__call__') as call:
        call.return_value = gcd_data_store.DataStore()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_data_store.DataStore())
        response = await client.update_data_store(data_store=gcd_data_store.DataStore(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].data_store
        mock_val = gcd_data_store.DataStore(name='name_value')
...
async def test_update_data_store_flattened_error_async():
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_data_store(data_store_service.UpdateDataStoreRequest(), data_store=gcd_data_store.DataStore(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
def test_create_data_store_rest(request_type):
    ...
    for (field, value) in request_init['data_store'].items():
        result = None
        is_repeated = False
...
def test_create_data_store_rest_required_fields(request_type=data_store_service.CreateDataStoreRequest):
    ...
    with mock.patch.object(Session, 'request') as req:
        with mock.patch.object(path_template, 'transcode') as transcode:
            ...
            req.return_value = response_value
            response = client.create_data_store(request)
            expected_params = [('dataStoreId', ''), ('$alt', 'json;enum-encoding=int')]
...
def test_create_data_store_rest_interceptors(null_interceptor):
    if False:
        print('Hello World!')
    transport = transports.DataStoreServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DataStoreServiceRestInterceptor())
    client = DataStoreServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.DataStoreServiceRestInterceptor, 'post_create_data_store') as post, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'pre_create_data_store') as pre:
...
def test_create_data_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(parent='parent_value', data_store=gcd_data_store.DataStore(name='name_value'), data_store_id='data_store_id_value')
        ...
        assert path_template.validate('%s/v1alpha/{parent=projects/*/locations/*}/dataStores' % client.transport._host, args[1])
...
def test_get_data_store_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = data_store.DataStore(name='name_value', display_name='display_name_value', industry_vertical=common.IndustryVertical.GENERIC, solution_types=[common.SolutionType.SOLUTION_TYPE_RECOMMENDATION], default_schema_id='default_schema_id_value', content_config=data_store.DataStore.ContentConfig.NO_CONTENT)
        response_value = Response()
        response_value.status_code = 200
...
def test_get_data_store_rest_interceptors(null_interceptor):
    ...
    transport = transports.DataStoreServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DataStoreServiceRestInterceptor())
    client = DataStoreServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'post_get_data_store') as post, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'pre_get_data_store') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_data_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1alpha/{name=projects/*/locations/*/dataStores/*}' % client.transport._host, args[1])
...
def test_list_data_stores_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = data_store_service.ListDataStoresResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_data_stores_rest_interceptors(null_interceptor):
    ...
    transport = transports.DataStoreServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DataStoreServiceRestInterceptor())
    client = DataStoreServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'post_list_data_stores') as post, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'pre_list_data_stores') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_data_stores_rest_pager(transport: str='rest'):
    ...
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (data_store_service.ListDataStoresResponse(data_stores=[data_store.DataStore(), data_store.DataStore(), data_store.DataStore()], next_page_token='abc'), data_store_service.ListDataStoresResponse(data_stores=[], next_page_token='def'), data_store_service.ListDataStoresResponse(data_stores=[data_store.DataStore()], next_page_token='ghi'), data_store_service.ListDataStoresResponse(data_stores=[data_store.DataStore(), data_store.DataStore()]))
...
def test_delete_data_store_rest_interceptors(null_interceptor):
    ...
    transport = transports.DataStoreServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DataStoreServiceRestInterceptor())
    client = DataStoreServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.DataStoreServiceRestInterceptor, 'post_delete_data_store') as post, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'pre_delete_data_store') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_data_store_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = gcd_data_store.DataStore(name='name_value', display_name='display_name_value', industry_vertical=common.IndustryVertical.GENERIC, solution_types=[common.SolutionType.SOLUTION_TYPE_RECOMMENDATION], default_schema_id='default_schema_id_value', content_config=gcd_data_store.DataStore.ContentConfig.NO_CONTENT)
        response_value = Response()
        response_value.status_code = 200
...
def test_update_data_store_rest_interceptors(null_interceptor):
    ...
    transport = transports.DataStoreServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DataStoreServiceRestInterceptor())
    client = DataStoreServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'post_update_data_store') as post, mock.patch.object(transports.DataStoreServiceRestInterceptor, 'pre_update_data_store') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_data_store_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(data_store=gcd_data_store.DataStore(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = gcd_data_store.DataStore.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/v1alpha/{data_store.name=projects/*/locations/*/dataStores/*}' % client.transport._host, args[1])
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.DataStoreServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.DataStoreServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DataStoreServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.DataStoreServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = DataStoreServiceClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.DataStoreServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DataStoreServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.DataStoreServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.DataStoreServiceGrpcTransport, transports.DataStoreServiceGrpcAsyncIOTransport, transports.DataStoreServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = DataStoreServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        for i in range(10):
            print('nop')
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.DataStoreServiceGrpcTransport)
...
def test_data_store_service_base_transport():
    if False:
        print('Hello World!')
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceTransport.__init__') as Transport:
        Transport.return_value = None
        transport = transports.DataStoreServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_data_store', 'get_data_store', 'list_data_stores', 'delete_data_store', 'update_data_store', 'get_operation', 'list_operations')
...
def test_data_store_service_base_transport_with_credentials_file():
    if False:
        return 10
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.DataStoreServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_data_store_service_base_transport_with_adc():
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.discoveryengine_v1alpha.services.data_store_service.transports.DataStoreServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.DataStoreServiceGrpcTransport, grpc_helpers), (transports.DataStoreServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_data_store_service_host_no_port(transport_name):
    if False:
        return 10
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='discoveryengine.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('discoveryengine.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://discoveryengine.googleapis.com')
...
def test_data_store_service_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='discoveryengine.googleapis.com:8000'), transport=transport_name)
...
def test_data_store_service_client_transport_session_collision(transport_name):
    ...
    client1 = DataStoreServiceClient(credentials=creds1, transport=transport_name)
    client2 = DataStoreServiceClient(credentials=creds2, transport=transport_name)
...
def test_data_store_service_grpc_transport_channel():
    ...
    transport = transports.DataStoreServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_data_store_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.DataStoreServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_data_store_service_grpc_lro_async_client():
    if False:
        return 10
    client = DataStoreServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_parse_data_store_path():
    if False:
        for i in range(10):
            print('nop')
    expected = {'project': 'nautilus', 'location': 'scallop', 'data_store': 'abalone'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DataStoreServiceTransport, '_prep_wrapped_messages') as prep:
        client = DataStoreServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(DataStoreServiceClient, transports.DataStoreServiceGrpcTransport), (DataStoreServiceAsyncClient, transports.DataStoreServiceGrpcAsyncIOTransport)])
