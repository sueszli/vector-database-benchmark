...
DEPLOYMENT_NO_RBAC_NO_SA_KIND_NAME_TUPLES = [('Secret', 'test-rbac-postgresql'), ('Secret', 'test-rbac-metadata'), ('Secret', 'test-rbac-pgbouncer-config'), ('Secret', 'test-rbac-pgbouncer-stats'), ('ConfigMap', 'test-rbac-config'), ('ConfigMap', 'test-rbac-statsd'), ('Service', 'test-rbac-postgresql-hl'), ('Service', 'test-rbac-postgresql'), ('Service', 'test-rbac-statsd'), ('Service', 'test-rbac-webserver'), ('Service', 'test-rbac-flower'), ('Service', 'test-rbac-pgbouncer'), ('Service', 'test-rbac-redis'), ('Service', 'test-rbac-worker'), ('Deployment', 'test-rbac-scheduler'), ('Deployment', 'test-rbac-statsd'), ('Deployment', 'test-rbac-webserver'), ('Deployment', 'test-rbac-flower'), ('Deployment', 'test-rbac-pgbouncer'), ('StatefulSet', 'test-rbac-postgresql'), ('StatefulSet', 'test-rbac-redis'), ('StatefulSet', 'test-rbac-worker'), ('Secret', 'test-rbac-broker-url'), ('Secret', 'test-rbac-fernet-key'), ('Secret', 'test-rbac-redis-password'), ('Secret', 'test-rbac-webserver-secret-key'), ('Job', 'test-rbac-create-user'), ('Job', 'test-rbac-run-airflow-migrations'), ('CronJob', 'test-rbac-cleanup')]
RBAC_ENABLED_KIND_NAME_TUPLES = [('Role', 'test-rbac-pod-launcher-role'), ('Role', 'test-rbac-cleanup-role'), ('Role', 'test-rbac-pod-log-reader-role'), ('RoleBinding', 'test-rbac-pod-launcher-rolebinding'), ('RoleBinding', 'test-rbac-pod-log-reader-rolebinding'), ('RoleBinding', 'test-rbac-cleanup-rolebinding')]
SERVICE_ACCOUNT_NAME_TUPLES = [('ServiceAccount', 'test-rbac-cleanup'), ('ServiceAccount', 'test-rbac-scheduler'), ('ServiceAccount', 'test-rbac-webserver'), ('ServiceAccount', 'test-rbac-worker'), ('ServiceAccount', 'test-rbac-triggerer'), ('ServiceAccount', 'test-rbac-pgbouncer'), ('ServiceAccount', 'test-rbac-flower'), ('ServiceAccount', 'test-rbac-statsd'), ('ServiceAccount', 'test-rbac-create-user-job'), ('ServiceAccount', 'test-rbac-migrate-database-job'), ('ServiceAccount', 'test-rbac-redis')]
CUSTOM_SERVICE_ACCOUNT_NAMES = (CUSTOM_SCHEDULER_NAME, CUSTOM_WEBSERVER_NAME, CUSTOM_WORKER_NAME, CUSTOM_TRIGGERER_NAME, CUSTOM_CLEANUP_NAME, CUSTOM_FLOWER_NAME, CUSTOM_PGBOUNCER_NAME, CUSTOM_STATSD_NAME, CUSTOM_CREATE_USER_JOBS_NAME, CUSTOM_MIGRATE_DATABASE_JOBS_NAME, CUSTOM_REDIS_NAME, CUSTOM_POSTGRESQL_NAME) = ('TestScheduler', 'TestWebserver', 'TestWorker', 'TestTriggerer', 'TestCleanup', 'TestFlower', 'TestPGBouncer', 'TestStatsd', 'TestCreateUserJob', 'TestMigrateDatabaseJob', 'TestRedis', 'TestPostgresql')
