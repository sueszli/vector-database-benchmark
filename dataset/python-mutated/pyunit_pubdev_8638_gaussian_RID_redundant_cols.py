...
def test_gaussian_rid_redundant_cols():
    ...
    my_x = ['dup_enum', 'dup_num1', 'dup_num2', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'C9', 'C10', 'C11', 'C12', 'C15', 'C16', 'C17', 'C18', 'C19', 'C20']
    ...
    cols2Compare = ['DFBETA_dup_enum.1', 'DFBETA_dup_enum.2', 'DFBETA_dup_enum.3', 'DFBETA_dup_enum.4', 'DFBETA_C2.1', 'DFBETA_C2.2', 'DFBETA_C2.3', 'DFBETA_dup_num1', 'DFBETA_dup_num2', 'DFBETA_C3', 'DFBETA_C4', 'DFBETA_C5', 'DFBETA_C6', 'DFBETA_C7', 'DFBETA_C8', 'DFBETA_C9', 'DFBETA_C10', 'DFBETA_C11', 'DFBETA_C12', 'DFBETA_C15', 'DFBETA_C16', 'DFBETA_C17', 'DFBETA_C18', 'DFBETA_C19', 'DFBETA_C20', 'DFBETA_Intercept']
