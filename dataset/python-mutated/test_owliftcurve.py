...
from Orange.widgets.evaluate.owliftcurve import OWLiftCurve, cumulative_gains, cumulative_gains_from_results, CurveTypes, precision_recall_from_results, points_from_results, compute_area
from Orange.tests import test_filename
OK_SKLEARN = pkg_resources.parse_version(sklearn.__version__) >= pkg_resources.parse_version('1.1.1')
