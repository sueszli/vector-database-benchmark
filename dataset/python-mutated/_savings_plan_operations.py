...
from ...operations._savings_plan_operations import build_get_request, build_list_all_request, build_list_request, build_update_request, build_validate_update_request
...
class SavingsPlanOperations:
    ...
    def list(self, savings_plan_order_id: str, **kwargs: Any) -> AsyncIterable['_models.SavingsPlanModel']:
        ...
        api_version: Literal['2022-11-01'] = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_request(savings_plan_order_id=savings_plan_order_id, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def list_all(self, filter: Optional[str]=None, orderby: Optional[str]=None, refresh_summary: Optional[str]=None, skiptoken: Optional[float]=None, selected_state: Optional[str]=None, take: Optional[float]=None, **kwargs: Any) -> AsyncIterable['_models.SavingsPlanModel']:
        if False:
            i = 10
            return i + 15
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_all_request(filter=filter, orderby=orderby, refresh_summary=refresh_summary, skiptoken=skiptoken, selected_state=selected_state, take=take, api_version=api_version, template_url=self.list_all.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    async def get(self, savings_plan_order_id: str, savings_plan_id: str, **kwargs: Any) -> _models.SavingsPlanModel:
        ...
        request = build_get_request(savings_plan_order_id=savings_plan_order_id, savings_plan_id=savings_plan_id, expand=self._config.expand, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    get.metadata = {'url': '/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}'}

    @overload
    async def update(self, savings_plan_order_id: str, savings_plan_id: str, body: _models.SavingsPlanUpdateRequest, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.SavingsPlanModel]:
        """Update savings plan.
    ...
    @overload
    async def update(self, savings_plan_order_id: str, savings_plan_id: str, body: IO, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.SavingsPlanModel]:
        """Update savings plan.
    ...
    @distributed_trace_async
    async def update(self, savings_plan_order_id: str, savings_plan_id: str, body: Union[_models.SavingsPlanUpdateRequest, IO], **kwargs: Any) -> Optional[_models.SavingsPlanModel]:
        """Update savings plan.
        ...
        request = build_update_request(savings_plan_order_id=savings_plan_order_id, savings_plan_id=savings_plan_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    update.metadata = {'url': '/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}'}

    @overload
    async def validate_update(self, savings_plan_order_id: str, savings_plan_id: str, body: _models.SavingsPlanUpdateValidateRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.SavingsPlanValidateResponse:
    ...
    @overload
    async def validate_update(self, savings_plan_order_id: str, savings_plan_id: str, body: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.SavingsPlanValidateResponse:
        """Validate savings plan patch.
    ...
    @distributed_trace_async
    async def validate_update(self, savings_plan_order_id: str, savings_plan_id: str, body: Union[_models.SavingsPlanUpdateValidateRequest, IO], **kwargs: Any) -> _models.SavingsPlanValidateResponse:
        """Validate savings plan patch.
        ...
        request = build_validate_update_request(savings_plan_order_id=savings_plan_order_id, savings_plan_id=savings_plan_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    validate_update.metadata = {'url': '/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}/validate'}