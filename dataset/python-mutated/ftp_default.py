...
class Exploit(FTPClient):
    __info__ = {'name': 'FTP Default Creds', 'description': 'Module performs dictionary attack with default credentials against FTP service.If valid credentials are found, the are displayed to the user.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'devices': ('Multiple devices',)}
