...
TEST_FLAT_SCHEMA = {'arg_required_no_default': {'description': 'Foo', 'required': True, 'type': 'string', 'secret': False}, 'arg_optional_no_type_secret': {'description': 'Bar', 'secret': True}, 'arg_optional_type_array': {'description': 'Whos the fairest?', 'type': 'array'}, 'arg_optional_type_object': {'description': 'Whos the fairest of them?', 'type': 'object'}}
TEST_FLAT_SECRET_PARAMS = {'arg_optional_no_type_secret': None}
TEST_NO_SECRETS_SCHEMA = {'arg_required_no_default': {'description': 'Foo', 'required': True, 'type': 'string', 'secret': False}}
TEST_NO_SECRETS_SECRET_PARAMS = {}
TEST_NESTED_OBJECTS_SCHEMA = {'arg_string': {'description': 'Junk', 'type': 'string'}, 'arg_optional_object': {'description': 'Mirror', 'type': 'object', 'properties': {'arg_nested_object': {'description': 'Mirror mirror', 'type': 'object', 'properties': {'arg_double_nested_secret': {'description': 'Deep, deep down', 'type': 'string', 'secret': True}}}, 'arg_nested_secret': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}
TEST_NESTED_OBJECTS_SECRET_PARAMS = {'arg_optional_object': {'arg_nested_secret': 'string', 'arg_nested_object': {'arg_double_nested_secret': 'string'}}}
TEST_ARRAY_SCHEMA = {'arg_optional_array': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'down', 'type': 'string', 'secret': True}}}
TEST_ARRAY_SECRET_PARAMS = {'arg_optional_array': ['string']}
TEST_ROOT_ARRAY_SCHEMA = {'description': 'Mirror', 'type': 'array', 'items': {'description': 'down', 'type': 'object', 'properties': {'secret_field_in_object': {'type': 'string', 'secret': True}}}}
TEST_ROOT_ARRAY_SECRET_PARAMS = [{'secret_field_in_object': 'string'}]
TEST_ROOT_OBJECT_SCHEMA = {'description': 'root', 'type': 'object', 'properties': {'arg_level_one': {'description': 'down', 'type': 'object', 'properties': {'secret_field_in_object': {'type': 'string', 'secret': True}}}}}
TEST_ROOT_OBJECT_SECRET_PARAMS = {'arg_level_one': {'secret_field_in_object': 'string'}}
TEST_NESTED_ARRAYS_SCHEMA = {'arg_optional_array': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}, 'arg_optional_double_array': {'description': 'Mirror', 'type': 'array', 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}}, 'arg_optional_tripple_array': {'description': 'Mirror', 'type': 'array', 'items': {'type': 'array', 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}, 'arg_optional_quad_array': {'description': 'Mirror', 'type': 'array', 'items': {'type': 'array', 'items': {'type': 'array', 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}}}
TEST_NESTED_ARRAYS_SECRET_PARAMS = {'arg_optional_array': ['string'], 'arg_optional_double_array': [['string']], 'arg_optional_tripple_array': [[['string']]], 'arg_optional_quad_array': [[[['string']]]]}
TEST_NESTED_OBJECT_WITH_ARRAY_SCHEMA = {'arg_optional_object_with_array': {'description': 'Mirror', 'type': 'object', 'properties': {'arg_nested_array': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}}
TEST_NESTED_OBJECT_WITH_ARRAY_SECRET_PARAMS = {'arg_optional_object_with_array': {'arg_nested_array': ['string']}}
TEST_NESTED_OBJECT_WITH_DOUBLE_ARRAY_SCHEMA = {'arg_optional_object_with_double_array': {'description': 'Mirror', 'type': 'object', 'properties': {'arg_double_nested_array': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}}}
TEST_NESTED_OBJECT_WITH_DOUBLE_ARRAY_SECRET_PARAMS = {'arg_optional_object_with_double_array': {'arg_double_nested_array': [['string']]}}
TEST_NESTED_ARRAY_WITH_OBJECT_SCHEMA = {'arg_optional_array_with_object': {'description': 'Mirror', 'type': 'array', 'items': {'description': 'Mirror', 'type': 'object', 'properties': {'arg_nested_secret': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}}
TEST_NESTED_ARRAY_WITH_OBJECT_SECRET_PARAMS = {'arg_optional_array_with_object': [{'arg_nested_secret': 'string'}]}
TEST_SECRET_ARRAY_SCHEMA = {'arg_secret_array': {'description': 'Mirror', 'type': 'array', 'secret': True}}
TEST_SECRET_ARRAY_SECRET_PARAMS = {'arg_secret_array': 'array'}
TEST_SECRET_OBJECT_SCHEMA = {'arg_secret_object': {'type': 'object', 'secret': True}}
TEST_SECRET_OBJECT_SECRET_PARAMS = {'arg_secret_object': 'object'}
TEST_SECRET_ROOT_ARRAY_SCHEMA = {'description': 'secret array', 'type': 'array', 'secret': True, 'items': {'description': 'down', 'type': 'object', 'properties': {'secret_field_in_object': {'type': 'string', 'secret': True}}}}
TEST_SECRET_ROOT_ARRAY_SECRET_PARAMS = 'array'
TEST_SECRET_ROOT_OBJECT_SCHEMA = {'description': 'secret object', 'type': 'object', 'secret': True, 'proeprteis': {'arg_level_one': {'description': 'down', 'type': 'object', 'properties': {'secret_field_in_object': {'type': 'string', 'secret': True}}}}}
TEST_SECRET_ROOT_OBJECT_SECRET_PARAMS = 'object'
TEST_SECRET_NESTED_OBJECTS_SCHEMA = {'arg_object': {'description': 'Mirror', 'type': 'object', 'properties': {'arg_nested_object': {'description': 'Mirror mirror', 'type': 'object', 'secret': True, 'properties': {'arg_double_nested_secret': {'description': 'Deep, deep down', 'type': 'string', 'secret': True}}}, 'arg_nested_secret': {'description': 'Deep down', 'type': 'string', 'secret': True}}}, 'arg_secret_object': {'description': 'Mirror', 'type': 'object', 'secret': True, 'properties': {'arg_nested_object': {'description': 'Mirror mirror', 'type': 'object', 'secret': True, 'properties': {'arg_double_nested_secret': {'description': 'Deep, deep down', 'type': 'string', 'secret': True}}}, 'arg_nested_secret': {'description': 'Deep down', 'type': 'string', 'secret': True}}}}
TEST_SECRET_NESTED_OBJECTS_SECRET_PARAMS = {'arg_object': {'arg_nested_secret': 'string', 'arg_nested_object': 'object'}, 'arg_secret_object': 'object'}
TEST_SECRET_NESTED_ARRAYS_SCHEMA = {'arg_optional_array': {'description': 'Mirror', 'type': 'array', 'secret': True, 'items': {'description': 'Deep down', 'type': 'string'}}, 'arg_optional_double_array': {'description': 'Mirror', 'type': 'array', 'secret': True, 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string'}}}, 'arg_optional_tripple_array': {'description': 'Mirror', 'type': 'array', 'items': {'type': 'array', 'secret': True, 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string'}}}}, 'arg_optional_quad_array': {'description': 'Mirror', 'type': 'array', 'items': {'type': 'array', 'items': {'type': 'array', 'secret': True, 'items': {'type': 'array', 'items': {'description': 'Deep down', 'type': 'string'}}}}}}
TEST_SECRET_NESTED_ARRAYS_SECRET_PARAMS = {'arg_optional_array': 'array', 'arg_optional_double_array': 'array', 'arg_optional_tripple_array': ['array'], 'arg_optional_quad_array': [['array']]}
