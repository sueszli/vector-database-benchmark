...
from .._generated.models import AddChatParticipantsRequest, SendReadReceiptRequest, SendChatMessageRequest, SendTypingNotificationRequest, UpdateChatMessageRequest, UpdateChatThreadRequest, SendChatMessageResult, ChatMessageType, ChatError
...
class ChatThreadClient(object):
    ...
    async def update_topic(self, topic: str=None, **kwargs) -> None:
        ...
        return await self._client.chat_thread.update_chat_thread_properties(chat_thread_id=self._thread_id, update_chat_thread_request=update_topic_request, **kwargs)
    ...
    async def send_read_receipt(self, message_id: str, **kwargs) -> None:
        ...
        return await self._client.chat_thread.send_chat_read_receipt(self._thread_id, send_read_receipt_request=post_read_receipt_request, **kwargs)
    ...
    async def send_typing_notification(self, *, sender_display_name: Optional[str]=None, **kwargs) -> None:
        ...
        return await self._client.chat_thread.send_typing_notification(chat_thread_id=self._thread_id, send_typing_notification_request=send_typing_notification_request, **kwargs)
    ...
    async def send_message(self, content: str, *, metadata: Dict[str, str]=None, **kwargs) -> SendChatMessageResult:
        ...
        send_chat_message_result = await self._client.chat_thread.send_chat_message(chat_thread_id=self._thread_id, send_chat_message_request=create_message_request, **kwargs)
    ...
    @distributed_trace_async
    async def update_message(self, message_id: str, content: str=None, *, metadata: Dict[str, str]=None, **kwargs) -> None:
        """Updates a message.
        ...
        return await self._client.chat_thread.update_chat_message(chat_thread_id=self._thread_id, chat_message_id=message_id, update_chat_message_request=update_message_request, **kwargs)
    ...
    async def delete_message(self, message_id: str, **kwargs) -> None:
        ...
        if not message_id:
            raise ValueError('message_id cannot be None.')
        return await self._client.chat_thread.delete_chat_message(chat_thread_id=self._thread_id, chat_message_id=message_id, **kwargs)
    ...
    @distributed_trace_async
    async def add_participants(self, thread_participants: List[ChatParticipant], **kwargs) -> List[Tuple[ChatParticipant, ChatError]]:
        ...
        if thread_participants:
            ...
            add_chat_participants_result = await self._client.chat_thread.add_chat_participants(chat_thread_id=self._thread_id, add_chat_participants_request=add_thread_participants_request, **kwargs)
    ...
    async def remove_participant(self, identifier: CommunicationIdentifier, **kwargs) -> None:
        ...
        return await self._client.chat_thread.remove_chat_participant(chat_thread_id=self._thread_id, participant_communication_identifier=serialize_identifier(identifier), **kwargs)
