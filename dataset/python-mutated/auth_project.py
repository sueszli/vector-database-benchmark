...
class ProjectAuthorizer:
    ...
    async def __call__(self, request: Request) -> None:
        ...
        if current_project is None:
            ...
            current_project = schemas.CurrentProjectContext(projectId=current_project['projectId'], projectKey=current_project['projectKey'], platform=current_project['platform'])
