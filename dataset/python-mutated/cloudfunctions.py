...
from google.cloud.functions_v1.types import CloudFunction, EventTrigger, GenerateUploadUrlRequest, UpdateFunctionRequest
...
PACKAGE_JSON = {'dependencies': {'@sentry/node': '^6.11.0', '@sentry/tracing': '^6.11.0', 'node-fetch': '^2.6.1'}}
