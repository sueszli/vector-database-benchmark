...
from ..utils import merge_dicts, parse_iso8601, parse_duration, parse_resolution, try_get, url_basename
...
class MicrosoftStreamIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://web.microsoftstream.com/video/6e51d928-4f46-4f1c-b141-369925e37b62?list=user&userId=f5491e02-e8fe-4e34-b67c-ec2e79a6ecc0', 'only_matching': True}, {'url': 'https://msit.microsoftstream.com/video/b60f5987-aabd-4e1c-a42f-c559d138f2ca', 'only_matching': True}]
