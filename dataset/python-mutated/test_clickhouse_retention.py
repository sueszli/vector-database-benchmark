...
from posthog.test.base import APIBaseTest, ClickhouseTestMixin, also_test_with_materialized_columns, snapshot_clickhouse_queries
...
class PropertyFilter(TypedDict):
    key: str
    value: str
    operator: Literal['not_icontains']
    type: Literal['person']
...
class RetentionRequest:
    ...
    retention_type: Literal['retention_first_time', 'retention']
