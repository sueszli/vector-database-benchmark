...
X = np.array([[-4.61611719, -6.00099547], [4.10469096, 5.32782448], [0.0, -0.5], [-6.17289014, -4.6984743], [1.3109306, -6.93271427], [-5.03823144, 3.10584743], [-2.87600388, 6.74310541], [5.21301203, 4.26386883]])
y = np.array(g(X) > 0, dtype=int)
kernel = C(0.1, (1e-05, np.inf)) * DotProduct(sigma_0=0.1) ** 2
