...
if is_torch_available():
    import torch
    from transformers import XmodConfig, XmodForCausalLM, XmodForMaskedLM, XmodForMultipleChoice, XmodForQuestionAnswering, XmodForSequenceClassification, XmodForTokenClassification, XmodModel
...
class XmodModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (XmodForCausalLM, XmodForMaskedLM, XmodModel, XmodForSequenceClassification, XmodForTokenClassification, XmodForMultipleChoice, XmodForQuestionAnswering) if is_torch_available() else ()
    all_generative_model_classes = (XmodForCausalLM,) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': XmodModel, 'fill-mask': XmodForMaskedLM, 'question-answering': XmodForQuestionAnswering, 'text-classification': XmodForSequenceClassification, 'text-generation': XmodForCausalLM, 'token-classification': XmodForTokenClassification, 'zero-shot': XmodForSequenceClassification} if is_torch_available() else {}
