...
@unittest.skipIf(not paddle.base.core.is_compiled_with_cuda() or not paddle.base.core.is_bfloat16_supported(paddle.base.core.CUDAPlace(0)), 'core is not complied with CUDA and not support the bfloat16')
