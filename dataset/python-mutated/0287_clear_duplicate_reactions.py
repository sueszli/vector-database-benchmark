...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0286_merge_0260_0285')]
    operations = [migrations.RunPython(clear_duplicate_reactions, reverse_code=migrations.RunPython.noop, elidable=True)]