...
from airflow_breeze.global_constants import ALLOWED_CELERY_BROKERS, ALLOWED_PACKAGE_FORMATS, APACHE_AIRFLOW_GITHUB_REPOSITORY, FLOWER_HOST_PORT, MIN_DOCKER_COMPOSE_VERSION, MIN_DOCKER_VERSION, MOUNT_ALL, MOUNT_REMOVE, MOUNT_SELECTED, MSSQL_HOST_PORT, MYSQL_HOST_PORT, POSTGRES_HOST_PORT, REDIS_HOST_PORT, SSH_PORT, WEBSERVER_HOST_PORT
from airflow_breeze.utils.console import Output, get_console
from airflow_breeze.utils.run_utils import RunCommandResult, check_if_buildx_plugin_installed, commit_sha, run_command
if TYPE_CHECKING:
    from airflow_breeze.params.build_ci_params import BuildCiParams
    from airflow_breeze.params.common_build_params import CommonBuildParams
    from airflow_breeze.params.shell_params import ShellParams
VOLUMES_FOR_SELECTED_MOUNTS = [('.bash_aliases', '/root/.bash_aliases'), ('.bash_history', '/root/.bash_history'), ('.build', '/opt/airflow/.build'), ('.dockerignore', '/opt/airflow/.dockerignore'), ('.github', '/opt/airflow/.github'), ('.inputrc', '/root/.inputrc'), ('.rat-excludes', '/opt/airflow/.rat-excludes'), ('BREEZE.rst', '/opt/airflow/BREEZE.rst'), ('LICENSE', '/opt/airflow/LICENSE'), ('MANIFEST.in', '/opt/airflow/MANIFEST.in'), ('NOTICE', '/opt/airflow/NOTICE'), ('RELEASE_NOTES.rst', '/opt/airflow/RELEASE_NOTES.rst'), ('airflow', '/opt/airflow/airflow'), ('constraints', '/opt/airflow/constraints'), ('provider_packages', '/opt/airflow/provider_packages'), ('dags', '/opt/airflow/dags'), ('dev', '/opt/airflow/dev'), ('docs', '/opt/airflow/docs'), ('generated', '/opt/airflow/generated'), ('hooks', '/opt/airflow/hooks'), ('images', '/opt/airflow/images'), ('logs', '/root/airflow/logs'), ('pyproject.toml', '/opt/airflow/pyproject.toml'), ('scripts', '/opt/airflow/scripts'), ('scripts/docker/entrypoint_ci.sh', '/entrypoint'), ('setup.cfg', '/opt/airflow/setup.cfg'), ('setup.py', '/opt/airflow/setup.py'), ('tests', '/opt/airflow/tests'), ('helm_tests', '/opt/airflow/helm_tests'), ('kubernetes_tests', '/opt/airflow/kubernetes_tests'), ('docker_tests', '/opt/airflow/docker_tests'), ('chart', '/opt/airflow/chart')]
