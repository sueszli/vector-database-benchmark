...
def main():
    ...
    response = client.data_controllers.begin_patch_data_controller(resource_group_name='testrg', data_controller_name='testdataController1', data_controller_resource={'tags': {'mytag': 'myval'}}).result()
    print(response)
