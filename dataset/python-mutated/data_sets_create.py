...
def main():
    ...
    response = client.data_sets.create(resource_group_name='SampleResourceGroup', account_name='Account1', share_name='Share1', data_set_name='Dataset1', data_set={'kind': 'Blob', 'properties': {'containerName': 'C1', 'filePath': 'file21', 'resourceGroup': 'SampleResourceGroup', 'storageAccountName': 'storage2', 'subscriptionId': '433a8dfd-e5d5-4e77-ad86-90acdc75eb1a'}})
    print(response)
