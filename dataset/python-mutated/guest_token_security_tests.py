...
from tests.integration_tests.fixtures.birth_names_dashboard import load_birth_names_dashboard_with_slices_class_scope, load_birth_names_data
from tests.integration_tests.fixtures.world_bank_dashboard import load_world_bank_dashboard_with_slices, load_world_bank_dashboard_with_slices_class_scope, load_world_bank_data

@patch.dict('superset.extensions.feature_flag_manager._feature_flags', EMBEDDED_SUPERSET=True)
...
@patch.dict('superset.extensions.feature_flag_manager._feature_flags', EMBEDDED_SUPERSET=True)
@pytest.mark.usefixtures('create_dataset', 'load_birth_names_dashboard_with_slices_class_scope', 'load_world_bank_dashboard_with_slices_class_scope')
