...
class Caller:
    ...
    async def run_benchmark(self) -> Tuple[float, float]:
        return await run_throughput_benchmark(fn=self._do_single_batch, multiplier=self._batch_size, num_trials=self._num_trials, trial_runtime=self._trial_runtime)
