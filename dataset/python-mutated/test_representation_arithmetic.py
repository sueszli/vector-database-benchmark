...
@pytest.mark.parametrize('op,args', [(operator.neg, ()), (operator.pos, ()), (operator.mul, (-8.0,)), (operator.truediv, ([4.0, 8.0] * u.s,))], scope='class')
