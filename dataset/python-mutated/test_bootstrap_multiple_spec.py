...
SPECS = [pytest.param([{'specification': 'swagger_greeting.yaml', 'name': 'greeting'}, {'specification': 'swagger_bye.yaml', 'name': 'bye'}], id='swagger'), pytest.param([{'specification': 'openapi_greeting.yaml', 'name': 'greeting'}, {'specification': 'openapi_bye.yaml', 'name': 'bye'}], id='openapi')]
