...
np.random.seed(2023)
paddle.seed(2023)
EPS = {'float32': np.finfo('float32').eps, 'float64': np.finfo('float64').eps}
...
@place(DEVICES)
@parameterize_cls((TEST_CASE_NAME, 'probs', 'default_dtype', 'expected_dtype'), [('probs_00_32', paddle.full((), 0.0), 'float32', 'float32'), ('probs_03_32', paddle.full((), 0.3), 'float32', 'float32'), ('probs_10_32', paddle.full((), 1.0), 'float32', 'float32'), ('probs_00_64', paddle.full((), 0.0, dtype='float64'), 'float64', 'float64'), ('probs_03_64', paddle.full((), 0.3, dtype='float64'), 'float64', 'float64'), ('probs_10_64', paddle.full((), 1.0, dtype='float64'), 'float64', 'float64'), ('probs_00', 0.0, 'float64', 'float32'), ('probs_03', 0.3, 'float64', 'float32'), ('probs_10', 1.0, 'float64', 'float32'), ('probs_tensor_03_32', paddle.to_tensor([0.3]), 'float32', 'float32'), ('probs_tensor_03_64', paddle.to_tensor([0.3], dtype='float64'), 'float64', 'float64'), ('probs_tensor_03_list_32', paddle.to_tensor([0.3]), 'float32', 'float32'), ('probs_tensor_03_list_64', paddle.to_tensor([0.3], dtype='float64'), 'float64', 'float64'), ('probs_tensor_0305', paddle.to_tensor((0.3, 0.5)), 'float32', 'float32'), ('probs_tensor_03050104', paddle.to_tensor(((0.3, 0.5), (0.1, 0.4))), 'float32', 'float32')])
