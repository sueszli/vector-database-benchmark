...
class TestAddEurion(TestCase):
    ...
    def _create_disconnectedshape(self):
        if False:
            return 10
        return DisconnectedShape(LineArtFactory.EURion(Rectangle(Decimal(0), Decimal(0), Decimal(200), Decimal(200))), stroke_color=HexColor('56cbf9'), line_width=Decimal(3))
    ...
    def test_add_eurion_001(self):
        ...
        layout.add(self.get_test_header(test_description='This test creates a PDF with an EURion shape in it.'))
