...
class DatabricksReposCreateOperator(BaseOperator):
    ...
    __git_providers__ = {'github.com': 'gitHub', 'dev.azure.com': 'azureDevOpsServices', 'gitlab.com': 'gitLab', 'bitbucket.org': 'bitbucketCloud'}
    __aws_code_commit_regexp__ = re.compile('^git-codecommit\\.[^.]+\\.amazonaws.com$')
    __repos_path_regexp__ = re.compile('/Repos/[^/]+/[^/]+/?$')
