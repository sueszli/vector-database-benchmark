...
class Migration(migrations.Migration):
    dependencies = [('account', '0078_add_group_channels_conf')]
    operations = [migrations.RunPython(create_full_channel_access_group_for_openid, reverse_code=migrations.RunPython.noop)]