...
def _shape_and_dtypes(shapes, dtypes):
    ...
    for shape in shapes:
        for dtype in _valid_dtypes_for_shape(shape, dtypes):
            yield (shape, dtype)
OpRecord = collections.namedtuple('OpRecord', ['name', 'nargs', 'dtypes', 'shapes', 'rng_factory', 'diff_modes', 'test_name', 'check_dtypes', 'tolerance', 'inexact', 'check_incomplete_shape'])
...
JAX_ONE_TO_ONE_OP_RECORDS = [op_record('abs', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('add', 2, all_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('ceil', 1, float_dtypes, all_shapes, jtu.rand_default, []), op_record('conj', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('equal', 2, all_dtypes, all_shapes, jtu.rand_some_equal, []), op_record('exp', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('fabs', 1, float_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('float_power', 2, inexact_dtypes, all_shapes, partial(jtu.rand_default, scale=1), ['rev'], tolerance={onp.float32: 0.001, onp.float64: 1e-12, onp.complex64: 0.0002, onp.complex128: 1e-12}, check_dtypes=False), op_record('floor', 1, float_dtypes, all_shapes, jtu.rand_default, []), op_record('greater', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_equal, []), op_record('greater_equal', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_equal, []), op_record('less', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_equal, []), op_record('less_equal', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_equal, []), op_record('log', 1, number_dtypes, all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('logical_and', 2, all_dtypes, all_shapes, jtu.rand_bool, []), op_record('logical_not', 1, all_dtypes, all_shapes, jtu.rand_bool, []), op_record('logical_or', 2, all_dtypes, all_shapes, jtu.rand_bool, []), op_record('logical_xor', 2, all_dtypes, all_shapes, jtu.rand_bool, []), op_record('maximum', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_inf, []), op_record('minimum', 2, minus(all_dtypes, complex_dtypes), all_shapes, jtu.rand_some_inf, []), op_record('multiply', 2, all_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('negative', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('nextafter', 2, [f for f in float_dtypes if f not in (tnp.bfloat16, onp.float16)], all_shapes, jtu.rand_default, ['rev'], inexact=True, tolerance=0), op_record('not_equal', 2, all_dtypes, all_shapes, jtu.rand_some_equal, ['rev']), op_record('array_equal', 2, number_dtypes, all_shapes, jtu.rand_some_equal, ['rev']), op_record('reciprocal', 1, inexact_dtypes, all_shapes, jtu.rand_default, []), op_record('subtract', 2, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('signbit', 1, default_dtypes + bool_dtypes, all_shapes, jtu.rand_some_inf_and_nan, ['rev']), op_record('sin', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('cos', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('tan', 1, number_dtypes, all_shapes, partial(jtu.rand_uniform, -1.5, 1.5), ['rev'], tolerance={onp.complex64: 3e-05, onp.complex128: 4e-14}, inexact=True), op_record('sinh', 1, minus(number_dtypes, [onp.float16]), all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('cosh', 1, minus(number_dtypes, [onp.float16]), all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('tanh', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev'], tolerance={onp.float64: 1e-07, onp.complex128: 1e-07}, inexact=True), op_record('arcsin', 1, minus(float_dtypes, [onp.float16]), all_shapes, jtu.rand_small, ['rev'], inexact=True), op_record('arccos', 1, minus(float_dtypes, [onp.float16]), all_shapes, jtu.rand_small, ['rev'], inexact=True), op_record('arctan', 1, minus(float_dtypes, [onp.float16]), all_shapes, jtu.rand_small, ['rev'], inexact=True), op_record('arctan2', 2, minus(float_dtypes, [onp.float16]), all_shapes, jtu.rand_small, ['rev'], inexact=True), op_record('arcsinh', 1, minus(number_dtypes, [onp.float16]), all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('arccosh', 1, minus(number_dtypes, [onp.float16]), all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('arctanh', 1, minus(number_dtypes, [onp.float16]), all_shapes, jtu.rand_small, ['rev'], inexact=True)]
JAX_COMPOUND_OP_RECORDS = [op_record('angle', 1, number_dtypes, all_shapes, jtu.rand_default, [], check_dtypes=False, inexact=True), op_record('atleast_1d', 1, default_dtypes, all_shapes, jtu.rand_default, []), op_record('atleast_2d', 1, default_dtypes, all_shapes, jtu.rand_default, []), op_record('atleast_3d', 1, default_dtypes, all_shapes, jtu.rand_default, []), op_record('cbrt', 1, default_dtypes, all_shapes, jtu.rand_default, ['rev'], inexact=True), op_record('conjugate', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('deg2rad', 1, float_dtypes, all_shapes, jtu.rand_default, []), op_record('divide', 2, number_dtypes, all_shapes, jtu.rand_nonzero, ['rev'], inexact=six.PY3), op_record('divmod', 2, minus(int_dtypes + float_dtypes, [onp.float16]), all_shapes, jtu.rand_nonzero, []), op_record('exp2', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev'], tolerance={onp.float16: 0.01}, inexact=True), op_record('expm1', 1, number_dtypes, all_shapes, jtu.rand_positive, [], test_name='expm1_large', tolerance={onp.float64: 1e-08}, inexact=True), op_record('expm1', 1, number_dtypes, all_shapes, jtu.rand_small_positive, [], tolerance={onp.float64: 1e-08}, inexact=True), op_record('fix', 1, float_dtypes, all_shapes, jtu.rand_default, []), op_record('floor_divide', 2, minus(number_dtypes, complex_dtypes), all_shapes, jtu.rand_nonzero, ['rev']), op_record('heaviside', 2, default_dtypes, all_shapes, jtu.rand_default, [], inexact=True), op_record('hypot', 2, default_dtypes, all_shapes, jtu.rand_default, [], inexact=True), op_record('kron', 2, number_dtypes, nonempty_shapes, jtu.rand_default, [], check_incomplete_shape=False), op_record('outer', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('imag', 1, number_dtypes, all_shapes, jtu.rand_some_inf, []), op_record('iscomplex', 1, number_dtypes, all_shapes, jtu.rand_some_inf, []), op_record('isfinite', 1, minus(inexact_dtypes, complex_dtypes), all_shapes, jtu.rand_some_inf_and_nan, []), op_record('isinf', 1, minus(inexact_dtypes, complex_dtypes), all_shapes, jtu.rand_some_inf_and_nan, []), op_record('isnan', 1, minus(inexact_dtypes, complex_dtypes), all_shapes, jtu.rand_some_inf_and_nan, []), op_record('isneginf', 1, float_dtypes, all_shapes, jtu.rand_some_inf_and_nan, []), op_record('isposinf', 1, float_dtypes, all_shapes, jtu.rand_some_inf_and_nan, []), op_record('isreal', 1, number_dtypes, all_shapes, jtu.rand_some_inf, []), op_record('isrealobj', 1, number_dtypes, all_shapes, jtu.rand_some_inf, []), op_record('log2', 1, number_dtypes, all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('log10', 1, number_dtypes, all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('log1p', 1, number_dtypes, all_shapes, jtu.rand_positive, [], test_name='log1p_large', tolerance={onp.float64: 1e-12}, inexact=True), op_record('log1p', 1, number_dtypes, all_shapes, jtu.rand_small_positive, [], tolerance={onp.float64: 1e-12}, inexact=True), op_record('logaddexp', 2, float_dtypes, all_shapes, jtu.rand_some_inf_and_nan, ['rev'], tolerance={onp.float64: 1e-12}, inexact=True), op_record('logaddexp2', 2, float_dtypes, all_shapes, jtu.rand_some_inf_and_nan, ['rev'], tolerance={onp.float16: 0.01}, inexact=True), op_record('polyval', 2, number_dtypes, nonempty_nonscalar_array_shapes, jtu.rand_default, [], check_dtypes=False, tolerance={onp.float16: 0.01, onp.float64: 1e-12}, check_incomplete_shape=False), op_record('positive', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('power', 2, number_dtypes, all_shapes, jtu.rand_positive, ['rev'], tolerance={onp.complex128: 1e-14}), op_record('rad2deg', 1, float_dtypes, all_shapes, jtu.rand_default, [], tolerance={onp.float64: 5e-06}), op_record('ravel', 1, all_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('real', 1, number_dtypes, all_shapes, jtu.rand_some_inf, []), op_record('remainder', 2, minus(default_dtypes, [onp.float16]), all_shapes, jtu.rand_nonzero, [], tolerance={onp.float16: 0.01}), op_record('mod', 2, minus(default_dtypes, [onp.float16]), all_shapes, jtu.rand_nonzero, []), op_record('sinc', 1, [t for t in number_dtypes if t != tnp.bfloat16], all_shapes, jtu.rand_default, ['rev'], tolerance={onp.complex64: 1e-05}, inexact=True, check_dtypes=False), op_record('square', 1, number_dtypes, all_shapes, jtu.rand_default, ['rev']), op_record('sqrt', 1, number_dtypes, all_shapes, jtu.rand_positive, ['rev'], inexact=True), op_record('transpose', 1, all_dtypes, all_shapes, jtu.rand_default, ['rev'], check_dtypes=False), op_record('true_divide', 2, all_dtypes, all_shapes, jtu.rand_nonzero, ['rev'], inexact=True), op_record('diff', 1, number_dtypes, nonzerodim_shapes, jtu.rand_default, ['rev'], check_incomplete_shape=False)]
JAX_BITWISE_OP_RECORDS = [op_record('bitwise_and', 2, int_dtypes + unsigned_dtypes, all_shapes, jtu.rand_default, []), op_record('bitwise_not', 1, int_dtypes + unsigned_dtypes, all_shapes, jtu.rand_default, []), op_record('bitwise_or', 2, int_dtypes + unsigned_dtypes, all_shapes, jtu.rand_default, []), op_record('bitwise_xor', 2, int_dtypes + unsigned_dtypes, all_shapes, jtu.rand_default, [])]
JAX_REDUCER_RECORDS = [op_record('mean', 1, number_dtypes, nonempty_shapes, jtu.rand_default, [], inexact=True), op_record('prod', 1, all_dtypes, all_shapes, jtu.rand_small_positive, []), op_record('sum', 1, all_dtypes, all_shapes, jtu.rand_default, []), op_record('nanmean', 1, minus(inexact_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_some_nan, [], inexact=True), op_record('nanprod', 1, minus(inexact_dtypes, complex_dtypes), all_shapes, jtu.rand_some_nan, []), op_record('nansum', 1, minus(number_dtypes, complex_dtypes), all_shapes, jtu.rand_some_nan, [])]
JAX_REDUCER_NO_DTYPE_RECORDS = [op_record('all', 1, all_dtypes, all_shapes, jtu.rand_some_zero, []), op_record('any', 1, all_dtypes, all_shapes, jtu.rand_some_zero, []), op_record('max', 1, minus(all_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_default, []), op_record('min', 1, minus(all_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_default, []), op_record('var', 1, all_dtypes, nonempty_shapes, jtu.rand_default, [], inexact=True), op_record('std', 1, all_dtypes, nonempty_shapes, jtu.rand_default, [], inexact=True)]
JAX_ARGMINMAX_RECORDS = [op_record('argmin', 1, minus(all_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_some_equal, []), op_record('argmax', 1, minus(all_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_some_equal, [])]
JAX_OPERATOR_OVERLOADS = [op_record('__add__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__sub__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__mul__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__eq__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__ne__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__lt__', 2, default_dtypes, all_shapes, jtu.rand_default, []), op_record('__gt__', 2, default_dtypes, all_shapes, jtu.rand_default, []), op_record('__ge__', 2, default_dtypes, all_shapes, jtu.rand_default, []), op_record('__pos__', 1, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__neg__', 1, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__pow__', 2, inexact_dtypes, all_shapes, jtu.rand_positive, [], tolerance={onp.float32: 0.0002, onp.complex64: 0.0002, onp.complex128: 1e-14}), op_record('__mod__', 2, minus(default_dtypes, [onp.float16]), all_shapes, jtu.rand_nonzero, [], tolerance={onp.float16: 0.1}), op_record('__floordiv__', 2, default_dtypes, all_shapes, jtu.rand_nonzero, []), op_record('__truediv__', 2, number_dtypes, all_shapes, jtu.rand_nonzero, [], inexact=True), op_record('__abs__', 1, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__invert__', 1, int_dtypes, all_shapes, jtu.rand_default, [])]
JAX_RIGHT_OPERATOR_OVERLOADS = [op_record('__radd__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__rsub__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__rmul__', 2, number_dtypes, all_shapes, jtu.rand_default, []), op_record('__rpow__', 2, inexact_dtypes, all_shapes, jtu.rand_positive, [], tolerance={onp.float32: 0.0002, onp.complex64: 0.001}), op_record('__rmod__', 2, minus(default_dtypes, [onp.float16]), all_shapes, jtu.rand_nonzero, [], tolerance={onp.float16: 0.1}), op_record('__rfloordiv__', 2, default_dtypes, all_shapes, jtu.rand_nonzero, []), op_record('__rtruediv__', 2, number_dtypes, all_shapes, jtu.rand_nonzero, [], inexact=True)]
numpy_version = tuple(map(int, onp.version.version.split('.')))
if numpy_version >= (1, 15):
    JAX_COMPOUND_OP_RECORDS += [op_record('isclose', 2, [t for t in all_dtypes if t != tnp.bfloat16], all_shapes, jtu.rand_small_positive, []), op_record('gcd', 2, int_dtypes, all_shapes, jtu.rand_default, []), op_record('lcm', 2, int_dtypes, all_shapes, jtu.rand_default, [])]
    JAX_REDUCER_NO_DTYPE_RECORDS += [op_record('ptp', 1, minus(number_dtypes, complex_dtypes), nonempty_shapes, jtu.rand_default, [])]
if six.PY2:
    JAX_OPERATOR_OVERLOADS += [op_record('__div__', 2, number_dtypes, all_shapes, jtu.rand_nonzero, [])]
    JAX_RIGHT_OPERATOR_OVERLOADS += [op_record('__rdiv__', 2, number_dtypes, all_shapes, jtu.rand_nonzero, [])]
...
GradTestSpec = collections.namedtuple('GradTestSpec', ['op', 'nargs', 'order', 'rng_factory', 'dtypes', 'name', 'tol'])
...
GRAD_TEST_RECORDS = [grad_test_spec(tnp.arcsinh, nargs=1, order=2, rng_factory=jtu.rand_positive, dtypes=[onp.float64, onp.complex64], tol=0.0001), grad_test_spec(tnp.arccosh, nargs=1, order=2, rng_factory=jtu.rand_positive, dtypes=[onp.float64, onp.complex64], tol=0.0001), grad_test_spec(tnp.arctanh, nargs=1, order=2, rng_factory=partial(jtu.rand_uniform, -0.9, 0.9), dtypes=[onp.float64, onp.complex64], tol=0.0001)]
GradSpecialValuesTestSpec = collections.namedtuple('GradSpecialValuesTestSpec', ['op', 'values', 'order'])
GRAD_SPECIAL_VALUE_TEST_RECORDS = [GradSpecialValuesTestSpec(tnp.arcsinh, [0.0, 1000.0], 2), GradSpecialValuesTestSpec(tnp.arccosh, [1000.0], 2), GradSpecialValuesTestSpec(tnp.arctanh, [0.0], 2)]
