...
def calibration_test():
    ...
    model = H2OXGBoostEstimator(ntrees=100, distribution='bernoulli', min_rows=10, max_depth=5, weights_column='Weights', calibrate_model=True, calibration_frame=calib, calibration_method='IsotonicRegression')
    ...
    assert pyunit_utils.test_java_scoring(model, train, preds_train, 1e-06)
