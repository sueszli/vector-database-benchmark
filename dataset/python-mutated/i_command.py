...
@click.command(name='i', help='for a file as input')
...
@click.argument('input', default=None if sys.stdin.isatty() else '-', type=click.File('rb'))
@click.argument('output', default=None if sys.stdin.isatty() else '-', type=click.File('wb', lazy=True))
