...
from airbyte_protocol.models import AirbyteMessage, AirbyteRecordMessage, AirbyteStream, ConfiguredAirbyteCatalog, ConfiguredAirbyteStream, SyncMode, Type
...
class ReadTestConfigWithIgnoreFields(ConnectionTestConfig):
    ignored_fields: Dict[str, List[IgnoredFieldsConfiguration]] = {'test_stream': [IgnoredFieldsConfiguration(name='ignore_me', bypass_reason='test'), IgnoredFieldsConfiguration(name='ignore_me_too', bypass_reason='test')]}
