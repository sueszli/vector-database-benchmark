...
@PIPELINES.register_module(Tasks.portrait_matting, module_name=Pipelines.portrait_matting)
@PIPELINES.register_module(Tasks.universal_matting, module_name=Pipelines.universal_matting)
        ...
        with device_placement(self.framework, self.device_name):
            ...
            with self._session.as_default():
                ...
                with tf.gfile.FastGFile(model_path, 'rb') as f:
                    ...
                    self.output = self._session.graph.get_tensor_by_name('output_png:0')
