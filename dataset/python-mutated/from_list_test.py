...
class FromListRandomAccessTest(test_base.DatasetTestBase, parameterized.TestCase):
...
class FromListCheckpointTest(checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
