...
PRETRAINED_VOCAB_FILES_MAP = {'artists_file': {'jukebox': 'https://huggingface.co/ArthurZ/jukebox/blob/main/artists.json'}, 'genres_file': {'jukebox': 'https://huggingface.co/ArthurZ/jukebox/blob/main/genres.json'}, 'lyrics_file': {'jukebox': 'https://huggingface.co/ArthurZ/jukebox/blob/main/lyrics.json'}}
PRETRAINED_LYRIC_TOKENS_SIZES = {'jukebox': 512}
