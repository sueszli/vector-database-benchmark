...
if psutil.version_info >= (2, 0):
    ...
    try:
        ...
        users = lambda : (_ for _ in ()).throw(NotImplementedError('Your psutil version is too old'))
    ...
    class Process(psutil.Process):
        ...
        def rlimit(self, *args, **kwargs):
            ...
            if psutil.version_info >= (1, 1, 0):
                ...
                pass
    _PROCESS_FUNCTION_MAP = {'children': 'get_children', 'connections': 'get_connections', 'cpu_percent': 'get_cpu_percent', 'cpu_times': 'get_cpu_times', 'io_counters': 'get_io_counters', 'memory_info': 'get_memory_info', 'memory_info_ex': 'get_ext_memory_info', 'memory_maps': 'get_memory_maps', 'memory_percent': 'get_memory_percent', 'num_ctx_switches': 'get_num_ctx_switches', 'num_fds': 'get_num_fds', 'num_threads': 'get_num_threads', 'open_files': 'get_open_files', 'threads': 'get_threads', 'cwd': 'getcwd'}
