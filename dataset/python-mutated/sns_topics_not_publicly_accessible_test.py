...
test_policy_restricted = {'Statement': [{'Effect': 'Allow', 'Principal': {'AWS': f'{AWS_ACCOUNT_NUMBER}'}, 'Action': ['sns:Publish'], 'Resource': f'arn:aws:sns:{AWS_REGION}:{AWS_ACCOUNT_NUMBER}:{topic_name}'}]}
test_policy_restricted_condition = {'Statement': [{'Effect': 'Allow', 'Principal': {'AWS': '*'}, 'Action': ['sns:Publish'], 'Resource': f'arn:aws:sns:{AWS_REGION}:{AWS_ACCOUNT_NUMBER}:{topic_name}', 'Condition': {'StringEquals': {'aws:SourceAccount': AWS_ACCOUNT_NUMBER}}}]}
test_policy_restricted_default_condition = {'Statement': [{'Effect': 'Allow', 'Principal': {'AWS': '*'}, 'Action': ['sns:Publish'], 'Resource': f'arn:aws:sns:{AWS_REGION}:{AWS_ACCOUNT_NUMBER}:{topic_name}', 'Condition': {'StringEquals': {'aws:SourceOwner': AWS_ACCOUNT_NUMBER}}}]}
test_policy_not_restricted = {'Statement': [{'Effect': 'Allow', 'Principal': {'AWS': '*'}, 'Action': ['sns:Publish'], 'Resource': f'arn:aws:sns:{AWS_REGION}:{AWS_ACCOUNT_NUMBER}:{topic_name}'}]}
