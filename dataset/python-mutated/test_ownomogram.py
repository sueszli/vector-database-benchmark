...
from Orange.classification import NaiveBayesLearner, LogisticRegressionLearner, MajorityLearner
...
from Orange.widgets.visualize.ownomogram import OWNomogram, DiscreteFeatureItem, ContinuousFeatureItem, ProbabilitiesDotItem, MovableToolTip
