...
class GailRewardModel(BaseRewardModel):
    ...
    Config:
        ...
        == ====================  ========   =============  =================================== =======================
    """
    config = dict(type='gail', learning_rate=0.001, update_per_collect=100, batch_size=64, input_size=4, target_new_data_count=64, hidden_size=128, collect_count=100000, clear_buffer_per_iters=1)
