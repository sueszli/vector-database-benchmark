...
try:
    ...
    from cassandra.connection import ConnectionException, ConnectionShutdown, OperationTimedOut
    from cassandra.policies import DCAwareRoundRobinPolicy, ExponentialReconnectionPolicy, HostDistance, HostFilterPolicy, IdentityTranslator, LoadBalancingPolicy, NoSpeculativeExecutionPlan, NoSpeculativeExecutionPolicy, RetryPolicy, RoundRobinPolicy, SimpleConvictionPolicy, TokenAwarePolicy, WhiteListRoundRobinPolicy
    from cassandra.query import dict_factory
    HAS_DRIVER = True
    LOAD_BALANCING_POLICY_MAP = {'HostDistance': HostDistance, 'LoadBalancingPolicy': LoadBalancingPolicy, 'RoundRobinPolicy': RoundRobinPolicy, 'DCAwareRoundRobinPolicy': DCAwareRoundRobinPolicy, 'WhiteListRoundRobinPolicy': WhiteListRoundRobinPolicy, 'TokenAwarePolicy': TokenAwarePolicy, 'HostFilterPolicy': HostFilterPolicy, 'SimpleConvictionPolicy': SimpleConvictionPolicy, 'ExponentialReconnectionPolicy': ExponentialReconnectionPolicy, 'RetryPolicy': RetryPolicy, 'IdentityTranslator': IdentityTranslator, 'NoSpeculativeExecutionPlan': NoSpeculativeExecutionPlan, 'NoSpeculativeExecutionPolicy': NoSpeculativeExecutionPolicy}
except ImportError:
    pass
