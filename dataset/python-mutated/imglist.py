...
from PyQt5.QtCore import QAbstractListModel, QModelIndex, Qt, QRectF, QRect, QSize, QSortFilterProxyModel
from PyQt5.QtGui import QImage, QColor, QBrush, QPainter, QTextOption, QFontMetrics, QPalette
from PyQt5.QtWidgets import QAbstractItemDelegate, QListView, QFrame
...
T = TypeVar('T')
COLORS = {'yellow': '#b58900', 'orange': '#cb4b16', 'red': '#dc322f', 'magenta': '#d33682', 'violet': '#6c71c4', 'blue': '#268bd2', 'cyan': '#2aa198', 'green': '#859900'}
