...
class StockPosition(Position):
    __repr_properties__ = ('order_book_id', 'direction', 'quantity', 'market_value', 'trading_pnl', 'position_pnl', 'last_price')
...
class FuturePosition(Position):
    __repr_properties__ = ('order_book_id', 'direction', 'old_quantity', 'quantity', 'margin', 'market_value', 'trading_pnl', 'position_pnl', 'last_price')
...
class StockPositionProxy(PositionProxy):
    __repr_properties__ = ('order_book_id', 'quantity', 'avg_price', 'market_value')
    __instrument_types__ = INST_TYPE_IN_STOCK_ACCOUNT
...
class FuturePositionProxy(PositionProxy):
    __repr_properties__ = ('order_book_id', 'buy_quantity', 'sell_quantity', 'buy_market_value', 'sell_market_value', 'buy_margin', 'sell_margin')
    __instrument_types__ = [INSTRUMENT_TYPE.FUTURE]
