...
if __name__ == '__main__':
    ...
    freeze_graph(graph_path='graph.proto', is_binary_graph=True, checkpoint_path='model.ckpt', output_path='frozen_graph.pb', end_node_names='output/bias_add')
    convert_model_to_onnx(frozen_graph_path='frozen_graph.pb', end_node_names='output/bias_add', onnx_output_path='mnist.onnx')