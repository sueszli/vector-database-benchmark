...
if __name__ == '__main__':
    ...
    runner = RecSysRunner()
    runner.train(model=model, optimizer=optimizer, engine=engine, hparams=hparams, loaders=loaders, num_epochs=15, verbose=True, timeit=False, callbacks=callbacks, logdir='./logs_macridvae')