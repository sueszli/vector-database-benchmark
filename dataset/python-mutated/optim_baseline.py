...
OPTIMIZERS = {'LBFGS': lambda p: torch.optim.LBFGS(p, 1.0), 'LBFGS_with_line_search': lambda p: torch.optim.LBFGS(p, 1.0, line_search_fn='strong_wolfe'), 'Adam': lambda p: torch.optim.Adam(p, 1.0), 'Adam_with_weight_decay': lambda p: torch.optim.Adam(p, 1.0, weight_decay=0.01), 'Adam_with_weight_decay_and_amsgrad': lambda p: torch.optim.Adam(p, 1.0, weight_decay=1e-06, amsgrad=True), 'AdamW': lambda p: torch.optim.AdamW(p, 1.0), 'AdamW_without_weight_decay': lambda p: torch.optim.AdamW(p, 1.0, weight_decay=0), 'AdamW_with_amsgrad': lambda p: torch.optim.AdamW(p, 1.0, amsgrad=True), 'Adagrad': lambda p: torch.optim.Adagrad(p, 1.0), 'Adagrad_with_weight_decay': lambda p: torch.optim.Adagrad(p, 1.0, weight_decay=0.01), 'Adagrad_with_weight_decay_and_lr_decay': lambda p: torch.optim.Adagrad(p, 1.0, weight_decay=1e-06, lr_decay=0.001), 'RMSprop': lambda p: torch.optim.RMSprop(p, 0.1), 'RMSprop_with_weight_decay': lambda p: torch.optim.RMSprop(p, 0.1, weight_decay=0.01), 'RMSprop_with_weight_decay_and_centered': lambda p: torch.optim.RMSprop(p, 0.1, weight_decay=1e-06, centered=True), 'RMSprop_with_weight_decay_and_centered_and_momentum': lambda p: torch.optim.RMSprop(p, 0.1, weight_decay=1e-06, centered=True, momentum=0.9), 'SGD': lambda p: torch.optim.SGD(p, 0.1), 'SGD_with_weight_decay': lambda p: torch.optim.SGD(p, 0.1, weight_decay=0.01), 'SGD_with_weight_decay_and_momentum': lambda p: torch.optim.SGD(p, 0.1, momentum=0.9, weight_decay=0.01), 'SGD_with_weight_decay_and_nesterov_momentum': lambda p: torch.optim.SGD(p, 0.1, momentum=0.9, weight_decay=1e-06, nesterov=True)}
