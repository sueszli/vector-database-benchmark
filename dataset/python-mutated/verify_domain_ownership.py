...
def main():
    ...
    response = client.app_service_certificate_orders.verify_domain_ownership(resource_group_name='testrg123', certificate_order_name='SampleCertificateOrderName')
    print(response)
