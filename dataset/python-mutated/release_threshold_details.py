...
from sentry.models.release_threshold.constants import THRESHOLD_TYPE_STR_TO_INT, TRIGGER_TYPE_STRING_TO_INT, ReleaseThresholdType
...
class ReleaseThresholdDetailsEndpoint(ProjectEndpoint):
    ...
    publish_status = {'DELETE': ApiPublishStatus.EXPERIMENTAL, 'GET': ApiPublishStatus.EXPERIMENTAL, 'PUT': ApiPublishStatus.EXPERIMENTAL}
