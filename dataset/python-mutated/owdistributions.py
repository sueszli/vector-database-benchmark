...
from AnyQt.QtGui import QColor, QPen, QBrush, QPainter, QPalette, QPolygonF, QFontMetrics
...
from Orange.preprocess.discretize import decimal_binnings, time_binnings, short_time_units
from Orange.statistics import distribution, contingency
from Orange.widgets import gui, settings
from Orange.widgets.utils.annotated_data import create_groups_table, create_annotated_table, ANNOTATED_DATA_SIGNAL_NAME
...
class OWDistributions(OWWidget):
    ...
    graph_name = 'plot'
    Fitters = (('None', None, (), ()), ('Normal', norm, ('loc', 'scale'), ('μ', 'σ')), ('Beta', beta, ('a', 'b', 'loc', 'scale'), ('α', 'β', '-loc', '-scale')), ('Gamma', gamma, ('a', 'loc', 'scale'), ('α', 'β', '-loc', '-scale')), ('Rayleigh', rayleigh, ('loc', 'scale'), ('-loc', 'σ')), ('Pareto', pareto, ('b', 'loc', 'scale'), ('α', '-loc', '-scale')), ('Exponential', expon, ('loc', 'scale'), ('-loc', 'λ')), ('Kernel density', AshCurve, ('a',), ('',)))
