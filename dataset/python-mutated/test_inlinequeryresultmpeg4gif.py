import pytest
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, InlineQueryResultMpeg4Gif, InlineQueryResultVoice, InputTextMessageContent, MessageEntity
...
class TestInlineQueryResultMpeg4GifWithoutRequest(TestInlineQueryResultMpeg4GifBase):
    ...
    def test_expected_values(self, inline_query_result_mpeg4_gif):
        ...
        assert inline_query_result_mpeg4_gif.input_message_content.to_dict() == self.input_message_content.to_dict()
    ...
    def test_to_dict(self, inline_query_result_mpeg4_gif):
        ...
        assert inline_query_result_mpeg4_gif_dict['mpeg4_url'] == inline_query_result_mpeg4_gif.mpeg4_url
        assert inline_query_result_mpeg4_gif_dict['mpeg4_width'] == inline_query_result_mpeg4_gif.mpeg4_width
        assert inline_query_result_mpeg4_gif_dict['mpeg4_height'] == inline_query_result_mpeg4_gif.mpeg4_height
        assert inline_query_result_mpeg4_gif_dict['mpeg4_duration'] == inline_query_result_mpeg4_gif.mpeg4_duration
        assert inline_query_result_mpeg4_gif_dict['thumbnail_url'] == inline_query_result_mpeg4_gif.thumbnail_url
        assert inline_query_result_mpeg4_gif_dict['thumbnail_mime_type'] == inline_query_result_mpeg4_gif.thumbnail_mime_type
        assert inline_query_result_mpeg4_gif_dict['title'] == inline_query_result_mpeg4_gif.title
        assert inline_query_result_mpeg4_gif_dict['caption'] == inline_query_result_mpeg4_gif.caption
        assert inline_query_result_mpeg4_gif_dict['parse_mode'] == inline_query_result_mpeg4_gif.parse_mode
        assert inline_query_result_mpeg4_gif_dict['caption_entities'] == [ce.to_dict() for ce in inline_query_result_mpeg4_gif.caption_entities]
        assert inline_query_result_mpeg4_gif_dict['input_message_content'] == inline_query_result_mpeg4_gif.input_message_content.to_dict()
        assert inline_query_result_mpeg4_gif_dict['reply_markup'] == inline_query_result_mpeg4_gif.reply_markup.to_dict()
