...
def main():
    ...
    keep_list = ('gcc', 'ipython-notebook')
    _keep = {}
    ...
    keep.update(_keep)
    additional_records = {'python-3.6.2-hda45abc_19.tar.bz2': {'build': 'hda45abc_19', 'build_number': 19, 'depends': ['libffi 3.2.*', 'libgcc-ng >=7.2.0', 'libstdcxx-ng >=7.2.0', 'ncurses 6.0.*', 'openssl 1.0.*', 'readline 7.*', 'sqlite >=3.20.1,<4.0a0', 'tk 8.6.*', 'xz >=5.2.3,<6.0a0', 'zlib >=1.2.11,<1.3.0a0'], 'license': 'PSF', 'md5': 'bdc6db1adbe7268e3ecbae13ec02066a', 'name': 'python', 'sha256': '0b77f7c1f88f9b9dff2d25ab2c65b76ea37eb2fbc3eeab59e74a47b7a61ab20a', 'size': 28300090, 'subdir': 'linux-64', 'timestamp': 1507190714033, 'version': '3.6.2'}, 'sqlite-3.20.1-haaaaaaa_4.tar.bz2': {'build': 'haaaaaaa_4', 'build_number': 4, 'depends': ['libedit', 'libgcc-ng >=7.2.0', 'jinja2 2.9.6'], 'license': 'Public-Domain (http://www.sqlite.org/copyright.html)', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'sqlite', 'sha256': 'deadbeefabd915d2f13da177a29e264e59a0ae3c6fd2a31267dcc6a8deadbeef', 'size': 1540584, 'subdir': 'linux-64', 'timestamp': 1505666646842, 'version': '3.20.1'}, 'python-digest-1.1.1-py2_0.tar.bz2': {'build': 'py2_0', 'build_number': 0, 'depends': ['python >=2,<3', 'cryptography <2.2'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'python-digest', 'noarch': 'python', 'sha256': 'deadbeefabd915d2f13da177a29e264e59a0ae3c6fd2a31267dcc6a8deadbeef', 'size': 123, 'subdir': 'noarch', 'version': '1.1.1'}, 'python-digest-1.1.1-py3_0.tar.bz2': {'build': 'py3_0', 'build_number': 0, 'depends': ['python >=3,<4', 'cryptography <2.2'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'python-digest', 'noarch': 'python', 'sha256': 'deadbeefabd915d2f13da177a29e264e59a0ae3c6fd2a31267dcc6a8deadbeef', 'size': 123, 'subdir': 'noarch', 'version': '1.1.1'}, 'r-graphviz-8.9.10-r_0.tar.bz2': {'build': 'r_0', 'build_number': 0, 'depends': ['r', 'graphviz'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'r-graphviz', 'noarch': 'generic', 'sha256': 'deadbeefabd915d2f13da177a29e264e59a0ae3c6fd2a31267dcc6a8deadbeef', 'size': 123, 'subdir': 'noarch', 'version': '8.9.10'}, 'r-http-cookies-8.9.10-r_0.tar.bz2': {'build': 'r_0', 'build_number': 0, 'depends': ['r'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'r-http-cookies', 'noarch': 'generic', 'size': 123, 'subdir': 'noarch', 'version': '8.9.10'}, 'rpy4-4.5.6-0.tar.bz2': {'build': '0', 'build_number': 0, 'depends': ['r', 'python'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'rpy4', 'namespace': 'python', 'noarch': 'generic', 'size': 123, 'subdir': 'noarch', 'version': '4.5.6'}, 'uses-rpy4-4.5.6-0.tar.bz2': {'build': '0', 'build_number': 0, 'depends': ['python', 'rpy4'], 'license': 'Proprietary', 'md5': 'deadbeefdd677bc3ed98ddd4deadbeef', 'name': 'uses-rpy4', 'noarch': 'generic', 'size': 123, 'subdir': 'noarch', 'version': '4.5.6'}}
    ...
    python_362_records = tuple((info for info in _keep.values() if info['name'] == 'python' and info['version'] == '3.6.2'))
