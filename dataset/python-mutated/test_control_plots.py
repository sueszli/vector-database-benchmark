...
from sympy.physics.control.control_plots import pole_zero_numerical_data, pole_zero_plot, step_response_numerical_data, step_response_plot, impulse_response_numerical_data, impulse_response_plot, ramp_response_numerical_data, ramp_response_plot, bode_magnitude_numerical_data, bode_phase_numerical_data, bode_plot
...
def check_point_accuracy(a, b):
    if False:
        while True:
            i = 10
    return all((isclose(*_, rel_tol=0.1, abs_tol=1e-06) for _ in zip(a, b)))
