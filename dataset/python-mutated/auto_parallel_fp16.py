...
from paddle.distributed.auto_parallel.static.utils import is_backward_op, is_forward_op, naive_set_dist_op_attr_for_program_by_mesh_and_mapping, set_var_dist_attr
...
__amp_skip_ops__ = ['create_py_reader', 'create_double_buffer_reader', 'while', 'cast']
