...
class Exploit(HTTPClient):
    __info__ = {'name': 'Netsys Multi RCE', 'description': 'Exploits Netsys multiple remote command execution vulnerabilities that allows executing commands on operating system level.', 'authors': ('admin <admin[at]bbs.00wz.top>', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('http://bbs.00wz.top/forum.php?mod=viewthread&tid=12630',), 'devices': ('Multiple Netsys',)}
