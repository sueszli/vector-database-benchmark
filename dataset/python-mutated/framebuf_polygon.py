...
col = 255
col_fill = 153
poly = array('h', (0, 20, 3, 20, 3, 10, 6, 17, 9, 10, 9, 20, 12, 20, 12, 3, 9, 3, 6, 10, 3, 3, 0, 3))
poly_reversed = bytes((0, 3, 3, 3, 6, 10, 9, 3, 12, 3, 12, 20, 9, 20, 9, 10, 6, 17, 3, 10, 3, 20, 0, 20))
fbuf.fill(0)
...
print_buffer(buf, w, h)
print()
for (x, y) in ((-8, -8), (24, -6), (20, 12), (-2, 10)):
    fbuf.fill(0)
...
fbuf.fill(0)
fbuf.poly(0, 0, t1, 255, False)
fbuf.poly(0, 0, t2, 255, False)
print_buffer(buf, w, h)
fbuf.fill(0)
fbuf.poly(0, 0, t1, 255, True)
fbuf.poly(0, 0, t2, 255, True)
print_buffer(buf, w, h)