...
class MigrateSkillJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[skill_migration_jobs.MigrateSkillJob] = skill_migration_jobs.MigrateSkillJob
...
class AuditSkillMigrationJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[skill_migration_jobs.AuditSkillMigrationJob] = skill_migration_jobs.AuditSkillMigrationJob
    SKILL_1_ID: Final = 'skill_1'
