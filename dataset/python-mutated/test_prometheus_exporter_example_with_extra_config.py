...
def test_prometheus_exporter_with_extra_config_example() -> None:
    ...
    with TestClient(app) as client:
        ...
        assert 'litestar_requests_in_progress{app_name="litestar-example",location="earth",method="GET",path="/custom-path",status_code="200",version_no="v2.0"} 1.0' in metrics