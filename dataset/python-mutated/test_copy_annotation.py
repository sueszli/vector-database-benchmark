...
class TestCopyCircleAnnotation(TestCase):
    ...
    def test_create_empty_document(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test creates an empty PDF. A later test will copy an annotation (from another document) to it.'))
