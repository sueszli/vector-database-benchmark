...
class EmailRegistrationsOperations:
    ...
    @overload
    async def activate_email(self, location: str, email_registration: _models.EmailRegistration, *, content_type: str='application/json', **kwargs: Any) -> _models.EmailRegistration:
    ...
    @overload
    async def activate_email(self, location: str, email_registration: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.EmailRegistration:
        """Activates the tenant and email combination using email code received.
    ...
    async def activate_email(self, location: str, email_registration: Union[_models.EmailRegistration, IO], **kwargs: Any) -> _models.EmailRegistration:
        """Activates the tenant and email combination using email code received.
        ...
        request = build_activate_email_request(location=location, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.activate_email.metadata['url'], headers=_headers, params=_params)
    ...
    async def register_email(self, location: str, **kwargs: Any) -> _models.EmailRegistration:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_register_email_request(location=location, api_version=api_version, template_url=self.register_email.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
