...
class KickIE(KickBaseIE):
    ...
    _TESTS = [{'url': 'https://kick.com/yuppy', 'info_dict': {'id': '6cde1-kickrp-joe-flemmingskick-info-heremust-knowmust-see21', 'ext': 'mp4', 'title': str, 'description': str, 'channel': 'yuppy', 'channel_id': '33538', 'uploader': 'Yuppy', 'uploader_id': '33793', 'upload_date': str, 'live_status': 'is_live', 'timestamp': int, 'thumbnail': 're:^https?://.*\\.jpg', 'categories': list}, 'skip': 'livestream'}, {'url': 'https://kick.com/kmack710', 'only_matching': True}]
