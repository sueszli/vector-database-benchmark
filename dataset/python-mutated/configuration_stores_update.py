...
def main():
    ...
    response = client.configuration_stores.begin_update(resource_group_name='myResourceGroup', config_store_name='contoso', config_store_update_parameters={'sku': {'name': 'Standard'}, 'tags': {'Category': 'Marketing'}}).result()
    print(response)
