...
class sfp_tool_nuclei(SpiderFootPlugin):
    meta = {'name': 'Tool - Nuclei', 'summary': 'Fast and customisable vulnerability scanner.', 'flags': ['tool', 'slow', 'invasive'], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Crawling and Scanning'], 'toolDetails': {'name': 'Nuclei', 'description': 'Fast and customisable vulnerability scanner based on simple YAML based DSL.', 'website': 'https://nuclei.projectdiscovery.io/', 'repository': 'https://github.com/projectdiscovery/nuclei'}}
    opts = {'nuclei_path': '', 'template_path': '', 'netblockscan': True, 'netblockscanmax': 24}
    optdescs = {'nuclei_path': 'The path to your nuclei binary. Must be set.', 'template_path': 'The path to your nuclei templates. Must be set.', 'netblockscan': 'Check all IPs within identified owned netblocks?', 'netblockscanmax': 'Maximum netblock/subnet size to scan IPs within (CIDR value, 24 = /24, 16 = /16, etc.)'}
    results = None
    errorState = False
