...
SIMPLE_ARGS = [('foo "bar baz"', ['foo', 'bar baz']), ('foo "bar baz"ext', ['foo', 'bar bazext']), ('foo="bar baz"', ['foo=bar baz']), ("foo 'bar baz'", ['foo', 'bar baz']), ("foo 'bar baz'ext", ['foo', 'bar bazext']), ("foo='bar baz'", ['foo=bar baz']), ('foo=\\"bar baz\\"', ['foo="bar', 'baz"']), ('foo="bar baz\\"', ['foo="bar baz\\"']), ("foo='bar baz' quuc", ['foo=bar baz', 'quuc']), ("foo='bar baz\\' quuc", ['foo=bar baz\\', 'quuc']), ('foo=\\"bar baz\\\' quuc', ['foo="bar', "baz'", 'quuc']), ('foo=\\\\\\"bar baz\\"', ['foo=\\"bar', 'baz"']), ('foo=\\\\"bar baz\\"', ['foo=\\\\"bar baz\\"'])]
NEWLINE_ARGS = [('foo\n"bar\nbaz"', ['foo', 'bar\nbaz'])]
INI_CONFIG_NEWLINE_ARGS = [('foo\\\n    "bar\\\n    baz"', ['foobarbaz']), ('foo\\\n    "bar \\\n    baz"', ['foobar baz']), ('foo \\\n    "bar\\\n    baz"', ['foo', 'barbaz']), ('foo \\\n    "bar \\\n    baz"', ['foo', 'bar baz']), ('foo \\\n    \\"bar \\\n    baz"', ['foo', '"bar', 'baz"']), ('foo \\\n    bar \\\n    baz', ['foo', 'bar', 'baz'])]
WINDOWS_PATH_ARGS = [("SPECIAL:\\foo\\bar --quuz='baz atan'", ['SPECIAL:\\foo\\bar', '--quuz=baz atan']), ("X:\\\\foo\\\\bar --quuz='baz atan'", ['X:\\foo\\bar', '--quuz=baz atan']), ("/foo/bar --quuz='baz atan'", ['/foo/bar', '--quuz=baz atan']), ('cc --arg "C:\\\\Users\\""', ['cc', '--arg', 'C:\\Users"']), ('cc --arg "C:\\\\Users\\"', ['cc', '--arg', '"C:\\\\Users\\"']), ('cc --arg "C:\\\\Users"', ['cc', '--arg', 'C:\\Users']), ('cc --arg \\"C:\\\\Users"', ['cc', '--arg', '\\"C:\\\\Users"']), ('cc --arg "C:\\\\Users\\ "', ['cc', '--arg', 'C:\\Users\\ ']), ('cc --arg "C:\\\\Users\\\\"', ['cc', '--arg', 'C:\\Users\\']), ('cc --arg "C:\\\\Users\\\\ "', ['cc', '--arg', 'C:\\Users\\ ']), ('cc --arg C:\\\\Users\\\\ --arg2 "SPECIAL:\\Temp\\f o o" --arg3="\\\\FOO\\share\\Path name" --arg4 SPECIAL:\\Temp\\ '[:-1], ['cc', '--arg', 'C:\\Users\\', '--arg2', 'SPECIAL:\\Temp\\f o o', '--arg3=\\FOO\\share\\Path name', '--arg4', 'SPECIAL:\\Temp\\'])]
WACKY_SLASH_ARGS = [('\\\\\\', ['\\\\\\']), (" \\'\\'\\ '", [" \\'\\'\\ '"]), ("\\'\\'\\ ", ["'' "]), ("\\'\\ \\\\", ["' \\"]), ("\\'\\ ", ["' "]), ('"\\\'\\"', ['"\\\'\\"']), ("'\\' \\\\", ['\\', '\\']), ('"\\\\" \\\\', ['\\', '\\'])]
