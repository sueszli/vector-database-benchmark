...
SNIPPED_RE = re.compile('(?P<before>^(?P<indent> *)```\\s*python\\n)(?P<code>.*?)(?P<after>^(?P=indent)```\\s*$)', re.DOTALL | re.MULTILINE)
KNOWN_FORMATTING_VIOLATIONS = ['avoidable-escaped-quote', 'bad-quotes-docstring', 'bad-quotes-inline-string', 'bad-quotes-multiline-string', 'explicit-string-concatenation', 'indent-with-spaces', 'indentation-with-invalid-multiple', 'line-too-long', 'missing-trailing-comma', 'missing-whitespace', 'missing-whitespace-after-keyword', 'missing-whitespace-around-arithmetic-operator', 'missing-whitespace-around-bitwise-or-shift-operator', 'missing-whitespace-around-modulo-operator', 'missing-whitespace-around-operator', 'missing-whitespace-around-parameter-equals', 'multi-line-implicit-string-concatenation', 'multiple-leading-hashes-for-block-comment', 'multiple-spaces-after-comma', 'multiple-spaces-after-keyword', 'multiple-spaces-after-operator', 'multiple-spaces-before-keyword', 'multiple-spaces-before-operator', 'multiple-statements-on-one-line-colon', 'multiple-statements-on-one-line-semicolon', 'no-blank-line-before-function', 'no-indented-block-comment', 'no-return-argument-annotation-in-stub', 'no-space-after-block-comment', 'no-space-after-inline-comment', 'non-empty-stub-body', 'one-blank-line-after-class', 'over-indentation', 'over-indented', 'pass-statement-stub-body', 'prohibited-trailing-comma', 'shebang-leading-whitespace', 'surrounding-whitespace', 'tab-indentation', 'too-few-spaces-before-inline-comment', 'too-many-boolean-expressions', 'trailing-comma-on-bare-tuple', 'triple-single-quotes', 'under-indentation', 'unexpected-indentation-comment', 'unexpected-spaces-around-keyword-parameter-equals', 'unicode-kind-prefix', 'unnecessary-class-parentheses', 'unnecessary-escaped-quote', 'useless-semicolon', 'whitespace-after-open-bracket', 'whitespace-before-close-bracket', 'whitespace-before-parameters', 'whitespace-before-punctuation']
KNOWN_PARSE_ERRORS = ['blank-line-with-whitespace', 'indentation-with-invalid-multiple-comment', 'missing-newline-at-end-of-file', 'mixed-spaces-and-tabs', 'no-indented-block', 'non-pep695-type-alias', 'syntax-error', 'tab-after-comma', 'tab-after-keyword', 'tab-after-operator', 'tab-before-keyword', 'tab-before-operator', 'trailing-whitespace', 'unexpected-indentation']
