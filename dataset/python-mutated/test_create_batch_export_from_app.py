...
def postgres_plugin(organization) -> typing.Generator[Plugin, None, None]:
    ...
    yield plugin
    plugin.delete()
test_snowflake_config = {'account': 'snowflake-account', 'username': 'test-user', 'password': 'test-password', 'warehouse': 'test-warehouse', 'database': 'test-db', 'dbschema': 'test-schema', 'table': 'test-table', 'role': 'test-role'}
test_s3_config = {'awsAccessKey': 'access-key', 'awsSecretAccessKey': 'secret-access-key', 's3BucketName': 'test-bucket', 'awsRegion': 'eu-central-1', 'prefix': 'posthog/', 'compression': 'gzip', 'eventsToIgnore': '$feature_flag_called'}
test_bigquery_config = {'tableId': 'my_table_id', 'datasetId': 'my_dataset_id', 'googleCloudKeyJson': {'type': 'service_accout', 'project_id': 'my_project_id', 'private_key_id': 'my_private_key_id', 'private_key': '-----BEGIN PRIVATE KEY-----Wow much private, such key-----END PRIVATE KEY-----', 'client_email': 'email@google.com', 'client_id': 'client_id', 'auth_uri': 'https://accouts.google.com/o/oauth2/auth', 'token_uri': 'https://oauth2.googleapis.com/token', 'auth_provider_x509_cert_url': 'https://www.googleapis.com/oauth2/v1/certs', 'client_x509_cert_url': 'https://www.googleapis.com/robot/v1/metadata'}, 'exportEventsToIgnore': '$feature_flag_called,$pageleave,$pageview,$rageclick,$identify'}
test_postgres_config = {'host': 'localhost', 'port': '5432', 'dbName': 'dev', 'tableName': 'posthog_event', 'dbPassword': 'password', 'dbUsername': 'username', 'databaseUrl': '', 'eventsToIgnore': '$feature_flag_called', 'hasSelfSignedCert': 'Yes'}
test_postgres_config_with_database_url = {'port': '54322', 'dbName': 'prod', 'host': 'localhost', 'tableName': 'posthog_event', 'dbPassword': 'password_in_url', 'dbUsername': 'username_in_url', 'databaseUrl': 'postgres://username_in_url:password_in_url@localhost:54322/prod', 'eventsToIgnore': '$feature_flag_called,$pageleave,$pageview,$rageclick,$identify', 'hasSelfSignedCert': 'Yes'}
PluginConfigParams = collections.namedtuple('PluginConfigParams', ('plugin_type', 'disabled', 'database_url'), defaults=(False, False))
...
@async_to_sync
async def wait_for_workflow_executions(temporal: temporalio.client.Client, query: str, timeout: int=30, sleep: int=1):
