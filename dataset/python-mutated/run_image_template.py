...
def main():
    ...
    response = client.virtual_machine_image_templates.begin_run(resource_group_name='myResourceGroup', image_template_name='myImageTemplate').result()
    print(response)
