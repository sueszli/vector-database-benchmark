...
class ASTFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    ...
    def test_integration(self):
        if False:
            while True:
                i = 10
        EXPECTED_INPUT_VALUES = torch.tensor([-0.9894, -1.2776, -0.9066, -1.2776, -0.9349, -1.2609, -1.0386, -1.2776, -1.1561, -1.2776, -1.2052, -1.2723, -1.219, -1.2132, -1.2776, -1.1133, -1.1953, -1.1343, -1.1584, -1.2203, -1.177, -1.2474, -1.2381, -1.1936, -0.927, -0.8317, -0.8049, -0.7706, -0.7565, -0.7869])
...
class ASTFeatureExtractionWithoutTorchaudioTest(ASTFeatureExtractionTest):
    ...
    def test_using_audio_utils(self):
        ...
        from transformers.models.audio_spectrogram_transformer.feature_extraction_audio_spectrogram_transformer import is_speech_available
