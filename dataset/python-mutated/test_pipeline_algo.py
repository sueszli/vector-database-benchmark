...
import numpy as np
from numpy import array, arange, full_like, float64, nan, uint32
from numpy.testing import assert_almost_equal
import pandas as pd
from pandas import concat, DataFrame, date_range, read_csv, Series, Timestamp
from six import iteritems, itervalues
from trading_calendars import get_calendar
from zipline.api import attach_pipeline, pipeline_output, get_datetime
from zipline.errors import AttachPipelineAfterInitialize, PipelineOutputDuringInitialize, NoSuchPipeline, DuplicatePipelineName
...
from zipline.testing.fixtures import WithMakeAlgo, WithAdjustmentReader, WithBcolzEquityDailyBarReaderFromCSVs, ZiplineTestCase
from zipline.utils.pandas_utils import normalize_date
TEST_RESOURCE_PATH = join(dirname(dirname(realpath(__file__))), 'resources', 'pipeline_inputs')
...
class PipelineAlgorithmTestCase(WithMakeAlgo, WithBcolzEquityDailyBarReaderFromCSVs, WithAdjustmentReader, ZiplineTestCase):
    AAPL = 1
    MSFT = 2
    BRK_A = 3
