...
from sentry.notifications.helpers import should_use_notifications_v2, transform_to_notification_settings_by_recipient, where_should_be_participating
from sentry.notifications.types import GroupSubscriptionReason, NotificationSettingEnum, NotificationSettingsOptionEnum, NotificationSettingTypes
...
class GroupSubscription(Model):
    ...
    class Meta:
        ...
        constraints = [models.CheckConstraint(check=models.Q(team_id__isnull=False, user_id__isnull=True) | models.Q(team_id__isnull=True, user_id__isnull=False), name='subscription_team_or_user_check')]
