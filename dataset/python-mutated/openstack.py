...
from salt.exceptions import SaltCloudConfigError, SaltCloudExecutionFailure, SaltCloudExecutionTimeout, SaltCloudSystemExit
...
try:
    ...
    HAS_SHADE = (Version(shade.__version__) >= Version('1.19.0'), 'Please install newer version of shade: >= 1.19.0')
except ImportError:
