...
from PyQt5.QtGui import QColor, QGuiApplication, QKeyEvent, QKeySequence, QMouseEvent, QPainter, QPainterPath, QPalette, QTextLayout
from PyQt5.QtWidgets import QLineEdit, QStyle, QStyleOptionFrame
from tribler.gui.defs import EDIT_TAG_BACKGROUND_COLOR, EDIT_TAG_BORDER_COLOR, EDIT_TAG_TEXT_COLOR, TAG_HEIGHT, TAG_TEXT_HORIZONTAL_PADDING
