...
from airflow_breeze.global_constants import ALL_INTEGRATIONS, ALLOWED_BACKENDS, ALLOWED_CONSTRAINTS_MODES_CI, ALLOWED_INSTALLATION_PACKAGE_FORMATS, ALLOWED_MSSQL_VERSIONS, ALLOWED_MYSQL_VERSIONS, ALLOWED_POSTGRES_VERSIONS, ALLOWED_PYTHON_MAJOR_MINOR_VERSIONS, APACHE_AIRFLOW_GITHUB_REPOSITORY, DEFAULT_CELERY_BROKER, DOCKER_DEFAULT_PLATFORM, MOUNT_ALL, MOUNT_REMOVE, MOUNT_SELECTED, MOUNT_SKIP, START_AIRFLOW_DEFAULT_ALLOWED_EXECUTORS, TESTABLE_INTEGRATIONS, get_airflow_version
from airflow_breeze.utils.console import get_console
from airflow_breeze.utils.path_utils import AIRFLOW_SOURCES_ROOT, BUILD_CACHE_DIR, MSSQL_TMP_DIR_NAME, SCRIPTS_CI_DIR
...
class ShellParams:
    ...
    default_constraints_branch: str = os.environ.get('DEFAULT_CONSTRAINTS_BRANCH', DEFAULT_AIRFLOW_CONSTRAINTS_BRANCH)
