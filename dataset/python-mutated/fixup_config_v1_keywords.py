...
class configCallTransformer(cst.CSTTransformer):
    CTRL_PARAMS: Tuple[str] = ('retry', 'timeout', 'metadata')
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_deployment': ('parent', 'deployment_id', 'deployment', 'request_id'), 'delete_deployment': ('name', 'request_id', 'force', 'delete_policy'), 'delete_statefile': ('name', 'lock_id'), 'export_deployment_statefile': ('parent', 'draft'), 'export_lock_info': ('name',), 'export_revision_statefile': ('parent',), 'get_deployment': ('name',), 'get_resource': ('name',), 'get_revision': ('name',), 'import_statefile': ('parent', 'lock_id', 'skip_draft'), 'list_deployments': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_resources': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_revisions': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'lock_deployment': ('name',), 'unlock_deployment': ('name', 'lock_id'), 'update_deployment': ('deployment', 'update_mask', 'request_id')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=configCallTransformer()):
    if False:
        print('Hello World!')
