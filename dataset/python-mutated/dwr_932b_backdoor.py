...
class Exploit(UDPClient, TelnetClient):
    __info__ = {'name': 'D-Link DWR-932B', 'description': 'Module exploits D-Link DWR-932B backdoor vulnerability which allows executing command on operating system level with root privileges.', 'authors': ('Pierre Kim @PierreKimSec', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://pierrekim.github.io/advisories/2016-dlink-0x00.txt',), 'devices': ('D-Link DWR-932B',)}
