...
class Dmenu(base.RunCommand):
    ...
    """
    defaults = [('dmenu_font', None, "override the default 'font' and 'fontsize' options for dmenu"), ('dmenu_command', 'dmenu', 'the dmenu command to be launched'), ('dmenu_bottom', False, 'dmenu appears at the bottom of the screen'), ('dmenu_ignorecase', False, 'dmenu matches menu items case insensitively'), ('dmenu_lines', None, 'dmenu lists items vertically, with the given number of lines'), ('dmenu_prompt', None, 'defines the prompt to be displayed to the left of the input field'), ('dmenu_height', None, 'defines the height (only supported by some dmenu forks)')]
...
class DmenuRun(Dmenu):
    ...
    """
    defaults = [('dmenu_command', 'dmenu_run', 'the dmenu command to be launched')]
