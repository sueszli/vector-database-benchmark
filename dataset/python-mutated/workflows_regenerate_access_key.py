...
def main():
    ...
    response = client.workflows.regenerate_access_key(resource_group_name='testResourceGroup', name='test-name', workflow_name='testWorkflowName', key_type={'keyType': 'Primary'})
    print(response)
