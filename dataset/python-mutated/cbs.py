...
from ..utils import ExtractorError, extract_attributes, get_element_html_by_id, int_or_none, find_xpath_attr, smuggle_url, xpath_element, xpath_text, update_url_query, url_or_none
...
class CBSIE(CBSBaseIE):
    ...
    _TESTS = [{'url': 'https://www.cbs.com/shows/video/xrUyNLtl9wd8D_RWWAg9NU2F_V6QpB3R/', 'info_dict': {'id': 'xrUyNLtl9wd8D_RWWAg9NU2F_V6QpB3R', 'ext': 'mp4', 'title': 'Tough As Nails - Dreams Never Die', 'description': 'md5:a3535a62531cdd52b0364248a2c1ae33', 'duration': 2588, 'timestamp': 1639015200, 'upload_date': '20211209', 'uploader': 'CBSI-NEW'}, 'params': {'skip_download': True}, 'skip': 'Subscription required'}, {'url': 'https://www.cbs.com/shows/video/sZH1MGgomIosZgxGJ1l263MFq16oMtW1/', 'info_dict': {'id': 'sZH1MGgomIosZgxGJ1l263MFq16oMtW1', 'title': 'The Late Show - 3/16/22 (Michael Buble, Rose Matafeo)', 'timestamp': 1647488100, 'description': 'md5:d0e6ec23c544b7fa8e39a8e6844d2439', 'uploader': 'CBSI-NEW', 'upload_date': '20220317'}, 'params': {'ignore_no_formats_error': True, 'skip_download': True}, 'expected_warnings': ['This content expired on', 'No video formats found', 'Requested format is not available'], 'skip': '404 Not Found'}, {'url': 'http://colbertlateshow.com/video/8GmB0oY0McANFvp2aEffk9jZZZ2YyXxy/the-colbeard/', 'only_matching': True}, {'url': 'http://www.colbertlateshow.com/podcasts/dYSwjqPs_X1tvbV_P2FcPWRa_qT6akTC/in-the-bad-room-with-stephen/', 'only_matching': True}]
