...
EVENT1 = SyncEvent(dbx_path='/d0/file1.txt', direction=SyncDirection.Up, status=SyncStatus.Syncing, local_path='/d0/file1.txt', dbx_path_lower='/d0/file1.txt', change_type=ChangeType.Added, completed=0, size=10, item_type=ItemType.File, sync_time=datetime.today())
EVENT2 = SyncEvent(dbx_path='/d0/file2.txt', direction=SyncDirection.Up, status=SyncStatus.Syncing, local_path='/d0/file2.txt', dbx_path_lower='/d0/file2.txt', change_type=ChangeType.Added, completed=0, size=10, item_type=ItemType.File, sync_time=datetime.today())
EVENT2_FAILED = SyncEvent(dbx_path='/d0/file2.txt', direction=SyncDirection.Up, status=SyncStatus.Failed, local_path='/d0/file2.txt', dbx_path_lower='/d0/file2.txt', change_type=ChangeType.Added, completed=0, size=10, item_type=ItemType.File, sync_time=datetime.today())
