...
parser = argparse.ArgumentParser(description='Load Paddle Model File and Running at CINN')
parser.add_argument('--path', help='The path to load the paddle model', type=str, required=True)
parser.add_argument('-m', '--model_filename', help='The filename of model file, default "__model__"', type=str, default='__model__')
parser.add_argument('-p', '--params_filename', help='The filename of model parameter file, default None, in which each parameter will saved in each file', type=str, default=None)
parser.add_argument('-cuda', '--enable_cuda', help='Whether enable CUDA, default True', type=bool, default=True)
