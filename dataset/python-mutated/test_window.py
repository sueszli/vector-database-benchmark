...
@testing.parameterize(*testing.product({'m': [0, 1, -1, 1024], 'name': ['bartlett', 'blackman', 'hamming', 'hanning']}))
...
@testing.parameterize(*testing.product({'m': [10, 30, 1024], 'beta': [-3.4, 0, 5, 6, 8.6], 'name': ['kaiser']}))
