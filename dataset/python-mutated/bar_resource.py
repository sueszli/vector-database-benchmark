...
class BarResource(pulumi.ComponentResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[BarResourceArgs]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            i = 10
            return i + 15
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, foo: Optional[pulumi.Input['Resource']]=None, __props__=None):
        ...
        super(BarResource, __self__).__init__('bar::BarResource', resource_name, __props__, opts, remote=True)
