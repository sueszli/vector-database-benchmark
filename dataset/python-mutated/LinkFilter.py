...
class LinkFilter(BaseAddon):
    ...
    __version__ = '0.16'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('filter', 'str', 'Filter links containing (comma separated)', ''), ('list_type', 'listed;unlisted', 'Allow only links that are', 'unlisted'), ('filter_all', 'bool', 'Filter all link plugin types (also crypters, containers...)', False)]
