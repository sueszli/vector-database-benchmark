...
@testing.parameterize(*testing.product({'shape': [(7,), (2, 3), (4, 3, 2)], 'n_vals': [0, 1, 3, 15]}))
...
@testing.parameterize(*testing.product({'shape': [(7,), (2, 3), (4, 3, 2)]}))
...
@testing.parameterize(*testing.product({'shape': [(7,), (2, 3), (4, 3, 2)], 'mode': ['raise', 'wrap', 'clip'], 'n_vals': [0, 1, 3, 4, 5]}))
...
@testing.parameterize(*testing.product({'shape': [(7,), (2, 3)]}))
...
@testing.parameterize(*testing.product({'shape': [(0,), (1,), (2, 3), (2, 3, 4)]}))
...
@testing.parameterize(*testing.product({'shape': [(0,), (1,), (2, 3), (2, 3, 4)], 'values_shape': [(2,), (3, 1), (5,)]}))
...
@testing.parameterize(*testing.product({'shape': [(3, 3), (2, 2, 2), (3, 5), (5, 3)], 'val': [1, 0, (2,), (2, 2)], 'wrap': [True, False]}))
...
@testing.parameterize(*testing.product({'n': [2, 4, -3, 0], 'ndim': [2, 3, 1, 0, -2]}))
...
@testing.parameterize(*testing.product({'n': [-3, 0], 'ndim': [1, 0, -2]}))
...
@testing.parameterize(*testing.product({'shape': [(3, 3), (0, 0), (2, 2, 2)]}))
...
@testing.parameterize(*testing.product({'shape': [(3, 5), (3, 3, 4), (5,), (0,), (-1,)]}))
