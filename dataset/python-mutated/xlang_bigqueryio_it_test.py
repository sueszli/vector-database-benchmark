...
class BigQueryXlangStorageWriteIT(unittest.TestCase):
    ...
    ELEMENTS = [{'int': 1, 'float': 0.1, 'numeric': Decimal('1.11'), 'str': 'a', 'bool': True, 'bytes': b'a', 'timestamp': Timestamp(1000, 100)}, {'int': 2, 'float': 0.2, 'numeric': Decimal('2.22'), 'str': 'b', 'bool': False, 'bytes': b'b', 'timestamp': Timestamp(2000, 200)}, {'int': 3, 'float': 0.3, 'numeric': Decimal('3.33'), 'str': 'c', 'bool': True, 'bytes': b'd', 'timestamp': Timestamp(3000, 300)}, {'int': 4, 'float': 0.4, 'numeric': Decimal('4.44'), 'str': 'd', 'bool': False, 'bytes': b'd', 'timestamp': Timestamp(4000, 400)}]
    ALL_TYPES_SCHEMA = 'int:INTEGER,float:FLOAT,numeric:NUMERIC,str:STRING,bool:BOOLEAN,bytes:BYTES,timestamp:TIMESTAMP'
