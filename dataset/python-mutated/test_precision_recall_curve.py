...
def _test_distrib_compute(device):
    ...
    def get_test_cases():
        if False:
            return 10
        test_cases = [(torch.randint(0, 2, size=(10,)), torch.randint(0, 2, size=(10,)), 1), (torch.randint(0, 2, size=(10, 1)), torch.randint(0, 2, size=(10, 1)), 1), (torch.randint(0, 2, size=(50,)), torch.randint(0, 2, size=(50,)), 16), (torch.randint(0, 2, size=(50, 1)), torch.randint(0, 2, size=(50, 1)), 16)]
        return test_cases
    for i in range(3):
