...
import pygame as pg
import time
from pygame._sdl2 import get_audio_device_names, AudioDevice, AUDIO_F32, AUDIO_ALLOW_FORMAT_CHANGE
...
audio = AudioDevice(devicename=names[0], iscapture=True, frequency=44100, audioformat=AUDIO_F32, numchannels=2, chunksize=512, allowed_changes=AUDIO_ALLOW_FORMAT_CHANGE, callback=callback)
audio.pause(0)
print(audio)
