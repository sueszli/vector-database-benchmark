    ...
    def execute(self):
        ...
        for directory in directoryservice_client.directories.values():
            ...
            if directory.event_topics:
                report.status = 'PASS'
                report.status_extended = f'Directory Service {directory.id} have SNS messaging enabled.'
            else:
                report.status = 'FAIL'
                report.status_extended = f'Directory Service {directory.id} have SNS messaging disabled.'
