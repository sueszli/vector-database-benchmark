...
class AutoShardDatasetTest(tf_record_test_base.TFRecordTestBase, parameterized.TestCase):
...
class AutoShardWithRebatchDatasetTest(tf_record_test_base.TFRecordTestBase, parameterized.TestCase):
...
class AutoShardDatasetCheckpointTest(tf_record_test_base.TFRecordTestBase, checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
