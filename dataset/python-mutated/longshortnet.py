...
from modelscope.models.cv.stream_yolo.utils import postprocess, timestamp_format
from modelscope.preprocessors import LoadImage
from modelscope.utils.config import Config
from modelscope.utils.constant import ModelFile, Tasks
from .exp.longshortnet_base import LongShortNetExp

@MODELS.register_module(group_key=Tasks.video_object_detection, module_name=Models.longshortnet)
