...
class CreateFindingRequest(proto.Message):
    ...
    finding_id: str = proto.Field(proto.STRING, number=2)
    finding: gcs_finding.Finding = proto.Field(proto.MESSAGE, number=3, message=gcs_finding.Finding)
...
class CreateNotificationConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    config_id: str = proto.Field(proto.STRING, number=2)
    notification_config: gcs_notification_config.NotificationConfig = proto.Field(proto.MESSAGE, number=3, message=gcs_notification_config.NotificationConfig)
...
class CreateSourceRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    source: gcs_source.Source = proto.Field(proto.MESSAGE, number=2, message=gcs_source.Source)
...
class GroupAssetsRequest(proto.Message):
    ...
    group_by: str = proto.Field(proto.STRING, number=3)
    compare_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=4, message=duration_pb2.Duration)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    page_token: str = proto.Field(proto.STRING, number=7)
...
class GroupAssetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    group_by_results: MutableSequence['GroupResult'] = proto.RepeatedField(proto.MESSAGE, number=1, message='GroupResult')
    ...
    total_size: int = proto.Field(proto.INT32, number=4)
...
class GroupFindingsRequest(proto.Message):
    ...
    filter: str = proto.Field(proto.STRING, number=2)
    group_by: str = proto.Field(proto.STRING, number=3)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    compare_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=5, message=duration_pb2.Duration)
    page_token: str = proto.Field(proto.STRING, number=7)
    page_size: int = proto.Field(proto.INT32, number=8)
...
class GroupResult(proto.Message):
    """Result containing the properties and count of a groupBy
    request.
    ...
    Attributes:
        ...
        count (int):
            ...
            properties.
    """
    properties: MutableMapping[str, struct_pb2.Value] = proto.MapField(proto.STRING, proto.MESSAGE, number=1, message=struct_pb2.Value)
    count: int = proto.Field(proto.INT64, number=2)
...
class ListNotificationConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    notification_configs: MutableSequence[gcs_notification_config.NotificationConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_notification_config.NotificationConfig)
...
class ListSourcesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    sources: MutableSequence[gcs_source.Source] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_source.Source)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListAssetsRequest(proto.Message):
    ...
    parent: str = proto.Field(proto.STRING, number=1)
    filter: str = proto.Field(proto.STRING, number=2)
    order_by: str = proto.Field(proto.STRING, number=3)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    compare_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=5, message=duration_pb2.Duration)
    field_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=7, message=field_mask_pb2.FieldMask)
    page_token: str = proto.Field(proto.STRING, number=8)
    page_size: int = proto.Field(proto.INT32, number=9)
...
class ListAssetsResponse(proto.Message):
    ...
    class ListAssetsResult(proto.Message):
        ...
        class StateChange(proto.Enum):
            ...
            REMOVED = 2
            ACTIVE = 3
        asset: gcs_asset.Asset = proto.Field(proto.MESSAGE, number=1, message=gcs_asset.Asset)
        state_change: 'ListAssetsResponse.ListAssetsResult.StateChange' = proto.Field(proto.ENUM, number=2, enum='ListAssetsResponse.ListAssetsResult.StateChange')
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    list_assets_results: MutableSequence[ListAssetsResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=ListAssetsResult)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    next_page_token: str = proto.Field(proto.STRING, number=3)
    total_size: int = proto.Field(proto.INT32, number=4)
...
class ListFindingsResponse(proto.Message):
    ...
    class ListFindingsResult(proto.Message):
        ...
        class Resource(proto.Message):
            ...
            """
            name: str = proto.Field(proto.STRING, number=1)
            project_name: str = proto.Field(proto.STRING, number=2)
            project_display_name: str = proto.Field(proto.STRING, number=3)
            parent_name: str = proto.Field(proto.STRING, number=4)
            parent_display_name: str = proto.Field(proto.STRING, number=5)
            folders: MutableSequence[folder.Folder] = proto.RepeatedField(proto.MESSAGE, number=10, message=folder.Folder)
        finding: gcs_finding.Finding = proto.Field(proto.MESSAGE, number=1, message=gcs_finding.Finding)
        state_change: 'ListFindingsResponse.ListFindingsResult.StateChange' = proto.Field(proto.ENUM, number=2, enum='ListFindingsResponse.ListFindingsResult.StateChange')
        resource: 'ListFindingsResponse.ListFindingsResult.Resource' = proto.Field(proto.MESSAGE, number=3, message='ListFindingsResponse.ListFindingsResult.Resource')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    list_findings_results: MutableSequence[ListFindingsResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=ListFindingsResult)
    read_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    next_page_token: str = proto.Field(proto.STRING, number=3)
    total_size: int = proto.Field(proto.INT32, number=4)
...
class SetFindingStateRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    state: gcs_finding.Finding.State = proto.Field(proto.ENUM, number=2, enum=gcs_finding.Finding.State)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)

class RunAssetDiscoveryRequest(proto.Message):
    """Request message for running asset discovery for an
    organization.
...
class UpdateNotificationConfigRequest(proto.Message):
    ...
    """
    notification_config: gcs_notification_config.NotificationConfig = proto.Field(proto.MESSAGE, number=1, message=gcs_notification_config.NotificationConfig)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class UpdateOrganizationSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            If empty all mutable fields will be updated.
    """
    organization_settings: gcs_organization_settings.OrganizationSettings = proto.Field(proto.MESSAGE, number=1, message=gcs_organization_settings.OrganizationSettings)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class UpdateSourceRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            If empty all mutable fields will be updated.
    """
    source: gcs_source.Source = proto.Field(proto.MESSAGE, number=1, message=gcs_source.Source)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class UpdateSecurityMarksRequest(proto.Message):
    ...
    Attributes:
        ...
        start_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            preceding this time.
    """
    security_marks: gcs_security_marks.SecurityMarks = proto.Field(proto.MESSAGE, number=1, message=gcs_security_marks.SecurityMarks)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
