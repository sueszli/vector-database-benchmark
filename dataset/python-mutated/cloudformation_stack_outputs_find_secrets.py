...
from prowler.providers.aws.services.cloudformation.cloudformation_client import cloudformation_client
    ...
    def execute(self):
        ...
        for stack in cloudformation_client.stacks:
            ...
            if stack.outputs:
                ...
                if secrets.json():
                    report.status = 'FAIL'
                    report.status_extended = f'Potential secret found in Stack {stack.name} Outputs.'
