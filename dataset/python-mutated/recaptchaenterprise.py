...
import proto
__protobuf__ = proto.module(package='google.cloud.recaptchaenterprise.v1', manifest={'CreateAssessmentRequest', 'TransactionEvent', 'AnnotateAssessmentRequest', 'AnnotateAssessmentResponse', 'EndpointVerificationInfo', 'AccountVerificationInfo', 'PrivatePasswordLeakVerification', 'Assessment', 'Event', 'TransactionData', 'RiskAnalysis', 'TokenProperties', 'FraudPreventionAssessment', 'FraudSignals', 'AccountDefenderAssessment', 'CreateKeyRequest', 'ListKeysRequest', 'ListKeysResponse', 'RetrieveLegacySecretKeyRequest', 'GetKeyRequest', 'UpdateKeyRequest', 'DeleteKeyRequest', 'CreateFirewallPolicyRequest', 'ListFirewallPoliciesRequest', 'ListFirewallPoliciesResponse', 'GetFirewallPolicyRequest', 'UpdateFirewallPolicyRequest', 'DeleteFirewallPolicyRequest', 'MigrateKeyRequest', 'GetMetricsRequest', 'Metrics', 'RetrieveLegacySecretKeyResponse', 'Key', 'TestingOptions', 'WebKeySettings', 'AndroidKeySettings', 'IOSKeySettings', 'AppleDeveloperId', 'ScoreDistribution', 'ScoreMetrics', 'ChallengeMetrics', 'FirewallPolicyAssessment', 'FirewallAction', 'FirewallPolicy', 'ListRelatedAccountGroupMembershipsRequest', 'ListRelatedAccountGroupMembershipsResponse', 'ListRelatedAccountGroupsRequest', 'ListRelatedAccountGroupsResponse', 'SearchRelatedAccountGroupMembershipsRequest', 'SearchRelatedAccountGroupMembershipsResponse', 'RelatedAccountGroupMembership', 'RelatedAccountGroup', 'WafSettings'})
...
class CreateAssessmentRequest(proto.Message):
    ...
    assessment: 'Assessment' = proto.Field(proto.MESSAGE, number=2, message='Assessment')
...
class TransactionEvent(proto.Message):
    ...
    class TransactionEventType(proto.Enum):
        ...
        REFUND = 17
        REFUND_REVERSE = 18
    event_type: TransactionEventType = proto.Field(proto.ENUM, number=1, enum=TransactionEventType)
    reason: str = proto.Field(proto.STRING, number=2)
    value: float = proto.Field(proto.DOUBLE, number=3)
...
class AnnotateAssessmentRequest(proto.Message):
    ...
    class Reason(proto.Enum):
        """Enum that represents potential reasons for annotating an
        assessment.
    ...
    annotation: Annotation = proto.Field(proto.ENUM, number=2, enum=Annotation)
    reasons: MutableSequence[Reason] = proto.RepeatedField(proto.ENUM, number=3, enum=Reason)
    hashed_account_id: bytes = proto.Field(proto.BYTES, number=4)
    transaction_event: 'TransactionEvent' = proto.Field(proto.MESSAGE, number=5, message='TransactionEvent')
...
class EndpointVerificationInfo(proto.Message):
    ...
    """
    email_address: str = proto.Field(proto.STRING, number=1, oneof='endpoint')
    phone_number: str = proto.Field(proto.STRING, number=2, oneof='endpoint')
    request_token: str = proto.Field(proto.STRING, number=3)
    last_verification_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
...
class AccountVerificationInfo(proto.Message):
    ...
    class Result(proto.Enum):
        """Result of the account verification as contained in the
        ...
        ERROR_VERIFICATION_BYPASSED = 8
        ERROR_VERDICT_MISMATCH = 9
    endpoints: MutableSequence['EndpointVerificationInfo'] = proto.RepeatedField(proto.MESSAGE, number=1, message='EndpointVerificationInfo')
    language_code: str = proto.Field(proto.STRING, number=3)
    latest_verification_result: Result = proto.Field(proto.ENUM, number=7, enum=Result)
    username: str = proto.Field(proto.STRING, number=2)
...
class PrivatePasswordLeakVerification(proto.Message):
    ...
    """
    lookup_hash_prefix: bytes = proto.Field(proto.BYTES, number=1)
    encrypted_user_credentials_hash: bytes = proto.Field(proto.BYTES, number=2)
    encrypted_leak_match_prefixes: MutableSequence[bytes] = proto.RepeatedField(proto.BYTES, number=3)
    reencrypted_user_credentials_hash: bytes = proto.Field(proto.BYTES, number=4)
...
class Assessment(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    event: 'Event' = proto.Field(proto.MESSAGE, number=2, message='Event')
    risk_analysis: 'RiskAnalysis' = proto.Field(proto.MESSAGE, number=3, message='RiskAnalysis')
    token_properties: 'TokenProperties' = proto.Field(proto.MESSAGE, number=4, message='TokenProperties')
    account_verification: 'AccountVerificationInfo' = proto.Field(proto.MESSAGE, number=5, message='AccountVerificationInfo')
    account_defender_assessment: 'AccountDefenderAssessment' = proto.Field(proto.MESSAGE, number=6, message='AccountDefenderAssessment')
    private_password_leak_verification: 'PrivatePasswordLeakVerification' = proto.Field(proto.MESSAGE, number=8, message='PrivatePasswordLeakVerification')
    firewall_policy_assessment: 'FirewallPolicyAssessment' = proto.Field(proto.MESSAGE, number=10, message='FirewallPolicyAssessment')
    fraud_prevention_assessment: 'FraudPreventionAssessment' = proto.Field(proto.MESSAGE, number=11, message='FraudPreventionAssessment')
    fraud_signals: 'FraudSignals' = proto.Field(proto.MESSAGE, number=13, message='FraudSignals')
...
class Event(proto.Message):
    ...
    Attributes:
        ...
        transaction_data (google.cloud.recaptchaenterprise_v1.types.TransactionData):
            ...
            the response.
    """
    token: str = proto.Field(proto.STRING, number=1)
    site_key: str = proto.Field(proto.STRING, number=2)
    user_agent: str = proto.Field(proto.STRING, number=3)
    user_ip_address: str = proto.Field(proto.STRING, number=4)
    expected_action: str = proto.Field(proto.STRING, number=5)
    hashed_account_id: bytes = proto.Field(proto.BYTES, number=6)
    express: bool = proto.Field(proto.BOOL, number=14)
    requested_uri: str = proto.Field(proto.STRING, number=8)
    waf_token_assessment: bool = proto.Field(proto.BOOL, number=9)
    ja3: str = proto.Field(proto.STRING, number=10)
    headers: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=11)
    firewall_policy_evaluation: bool = proto.Field(proto.BOOL, number=12)
    transaction_data: 'TransactionData' = proto.Field(proto.MESSAGE, number=13, message='TransactionData')
...
class TransactionData(proto.Message):
    ...
    class Address(proto.Message):
        ...
        Attributes:
            ...
            postal_code (str):
                ...
                address.
        """
        recipient: str = proto.Field(proto.STRING, number=1)
        address: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        locality: str = proto.Field(proto.STRING, number=3)
        administrative_area: str = proto.Field(proto.STRING, number=4)
        region_code: str = proto.Field(proto.STRING, number=5)
        postal_code: str = proto.Field(proto.STRING, number=6)
    ...
    class User(proto.Message):
        ...
        Attributes:
            ...
            phone_verified (bool):
                ...
                similar).
        """
        account_id: str = proto.Field(proto.STRING, number=6)
        creation_ms: int = proto.Field(proto.INT64, number=1)
        email: str = proto.Field(proto.STRING, number=2)
        email_verified: bool = proto.Field(proto.BOOL, number=3)
        phone_number: str = proto.Field(proto.STRING, number=4)
        phone_verified: bool = proto.Field(proto.BOOL, number=5)
    ...
    class Item(proto.Message):
        ...
        quantity: int = proto.Field(proto.INT64, number=3)
        merchant_account_id: str = proto.Field(proto.STRING, number=4)
    ...
    class GatewayInfo(proto.Message):
        ...
        """
        name: str = proto.Field(proto.STRING, number=1)
        gateway_response_code: str = proto.Field(proto.STRING, number=2)
        avs_response_code: str = proto.Field(proto.STRING, number=3)
        cvv_response_code: str = proto.Field(proto.STRING, number=4)
    transaction_id: str = proto.Field(proto.STRING, number=11, optional=True)
    payment_method: str = proto.Field(proto.STRING, number=1)
    card_bin: str = proto.Field(proto.STRING, number=2)
    card_last_four: str = proto.Field(proto.STRING, number=3)
    currency_code: str = proto.Field(proto.STRING, number=4)
    value: float = proto.Field(proto.DOUBLE, number=5)
    shipping_value: float = proto.Field(proto.DOUBLE, number=12)
    shipping_address: Address = proto.Field(proto.MESSAGE, number=6, message=Address)
    billing_address: Address = proto.Field(proto.MESSAGE, number=7, message=Address)
    user: User = proto.Field(proto.MESSAGE, number=8, message=User)
    merchants: MutableSequence[User] = proto.RepeatedField(proto.MESSAGE, number=13, message=User)
    items: MutableSequence[Item] = proto.RepeatedField(proto.MESSAGE, number=14, message=Item)
    gateway_info: GatewayInfo = proto.Field(proto.MESSAGE, number=10, message=GatewayInfo)
...
class RiskAnalysis(proto.Message):
    ...
    class ClassificationReason(proto.Enum):
        ...
        SUSPECTED_CARDING = 6
        SUSPECTED_CHARGEBACK = 7
    score: float = proto.Field(proto.FLOAT, number=1)
    reasons: MutableSequence[ClassificationReason] = proto.RepeatedField(proto.ENUM, number=2, enum=ClassificationReason)
    extended_verdict_reasons: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class TokenProperties(proto.Message):
    ...
    class InvalidReason(proto.Enum):
        ...
        MISSING = 5
        BROWSER_ERROR = 6
    valid: bool = proto.Field(proto.BOOL, number=1)
    invalid_reason: InvalidReason = proto.Field(proto.ENUM, number=2, enum=InvalidReason)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    hostname: str = proto.Field(proto.STRING, number=4)
    android_package_name: str = proto.Field(proto.STRING, number=8)
    ios_bundle_id: str = proto.Field(proto.STRING, number=9)
    action: str = proto.Field(proto.STRING, number=5)
...
class FraudPreventionAssessment(proto.Message):
    ...
    class StolenInstrumentVerdict(proto.Message):
        """Information about stolen instrument fraud, where the user is
        ...
        """
        risk: float = proto.Field(proto.FLOAT, number=1)

    class CardTestingVerdict(proto.Message):
        """Information about card testing fraud, where an adversary is
    ...
    class BehavioralTrustVerdict(proto.Message):
        ...
        Attributes:
            trust (float):
                ...
                1.0 (highest).
        """
        trust: float = proto.Field(proto.FLOAT, number=1)
    transaction_risk: float = proto.Field(proto.FLOAT, number=1)
    stolen_instrument_verdict: StolenInstrumentVerdict = proto.Field(proto.MESSAGE, number=2, message=StolenInstrumentVerdict)
    card_testing_verdict: CardTestingVerdict = proto.Field(proto.MESSAGE, number=3, message=CardTestingVerdict)
    behavioral_trust_verdict: BehavioralTrustVerdict = proto.Field(proto.MESSAGE, number=4, message=BehavioralTrustVerdict)
...
class FraudSignals(proto.Message):
    ...
    class UserSignals(proto.Message):
        ...
        Attributes:
            ...
            synthetic_risk (float):
                ...
                shipping address.
        """
        active_days_lower_bound: int = proto.Field(proto.INT32, number=1)
        synthetic_risk: float = proto.Field(proto.FLOAT, number=2)
    ...
    class CardSignals(proto.Message):
        ...
        class CardLabel(proto.Enum):
            """Risk labels describing the card being assessed, such as its
            funding mechanism.
            ...
            VIRTUAL = 2
            UNEXPECTED_LOCATION = 3
        card_labels: MutableSequence['FraudSignals.CardSignals.CardLabel'] = proto.RepeatedField(proto.ENUM, number=1, enum='FraudSignals.CardSignals.CardLabel')
    user_signals: UserSignals = proto.Field(proto.MESSAGE, number=1, message=UserSignals)
    card_signals: CardSignals = proto.Field(proto.MESSAGE, number=2, message=CardSignals)
...
class AccountDefenderAssessment(proto.Message):
    ...
    class AccountDefenderLabel(proto.Enum):
        ...
        SUSPICIOUS_ACCOUNT_CREATION = 3
        RELATED_ACCOUNTS_NUMBER_HIGH = 4
    labels: MutableSequence[AccountDefenderLabel] = proto.RepeatedField(proto.ENUM, number=1, enum=AccountDefenderLabel)
...
class CreateKeyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    key: 'Key' = proto.Field(proto.MESSAGE, number=2, message='Key')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    keys: MutableSequence['Key'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Key')
...
class UpdateKeyRequest(proto.Message):
    ...
    """
    key: 'Key' = proto.Field(proto.MESSAGE, number=1, message='Key')
...
class CreateFirewallPolicyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    firewall_policy: 'FirewallPolicy' = proto.Field(proto.MESSAGE, number=2, message='FirewallPolicy')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    firewall_policies: MutableSequence['FirewallPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='FirewallPolicy')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateFirewallPolicyRequest(proto.Message):
    ...
    """
    firewall_policy: 'FirewallPolicy' = proto.Field(proto.MESSAGE, number=1, message='FirewallPolicy')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class MigrateKeyRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    skip_billing_check: bool = proto.Field(proto.BOOL, number=2)
...
class Metrics(proto.Message):
    ...
    score_metrics: MutableSequence['ScoreMetrics'] = proto.RepeatedField(proto.MESSAGE, number=2, message='ScoreMetrics')
    challenge_metrics: MutableSequence['ChallengeMetrics'] = proto.RepeatedField(proto.MESSAGE, number=3, message='ChallengeMetrics')
...
class RetrieveLegacySecretKeyResponse(proto.Message):
    ...
    Attributes:
        legacy_secret_key (str):
            ...
            security purposes.
    """
    legacy_secret_key: str = proto.Field(proto.STRING, number=1)
...
class Key(proto.Message):
    ...
    web_settings: 'WebKeySettings' = proto.Field(proto.MESSAGE, number=3, oneof='platform_settings', message='WebKeySettings')
    android_settings: 'AndroidKeySettings' = proto.Field(proto.MESSAGE, number=4, oneof='platform_settings', message='AndroidKeySettings')
    ios_settings: 'IOSKeySettings' = proto.Field(proto.MESSAGE, number=5, oneof='platform_settings', message='IOSKeySettings')
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=6)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    testing_options: 'TestingOptions' = proto.Field(proto.MESSAGE, number=9, message='TestingOptions')
    waf_settings: 'WafSettings' = proto.Field(proto.MESSAGE, number=10, message='WafSettings')
...
class TestingOptions(proto.Message):
    ...
    class TestingChallenge(proto.Enum):
        ...
        NOCAPTCHA = 1
        UNSOLVABLE_CHALLENGE = 2
    testing_score: float = proto.Field(proto.FLOAT, number=1)
    testing_challenge: TestingChallenge = proto.Field(proto.ENUM, number=2, enum=TestingChallenge)
...
class WebKeySettings(proto.Message):
    ...
    class ChallengeSecurityPreference(proto.Enum):
        ...
        BALANCE = 2
        SECURITY = 3
    allow_all_domains: bool = proto.Field(proto.BOOL, number=3)
    allowed_domains: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    allow_amp_traffic: bool = proto.Field(proto.BOOL, number=2)
    integration_type: IntegrationType = proto.Field(proto.ENUM, number=4, enum=IntegrationType)
    challenge_security_preference: ChallengeSecurityPreference = proto.Field(proto.ENUM, number=5, enum=ChallengeSecurityPreference)
...
class AndroidKeySettings(proto.Message):
    ...
    Attributes:
        ...
        support_non_google_app_store_distribution (bool):
            ...
            Play Store.
    """
    allow_all_package_names: bool = proto.Field(proto.BOOL, number=2)
    allowed_package_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    support_non_google_app_store_distribution: bool = proto.Field(proto.BOOL, number=3)
...
class IOSKeySettings(proto.Message):
    ...
    """
    allow_all_bundle_ids: bool = proto.Field(proto.BOOL, number=2)
    allowed_bundle_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    apple_developer_id: 'AppleDeveloperId' = proto.Field(proto.MESSAGE, number=3, message='AppleDeveloperId')
...
class AppleDeveloperId(proto.Message):
    ...
    """
    private_key: str = proto.Field(proto.STRING, number=1)
    key_id: str = proto.Field(proto.STRING, number=2)
    team_id: str = proto.Field(proto.STRING, number=3)
...
class ScoreDistribution(proto.Message):
    ...
    Attributes:
        score_buckets (MutableMapping[int, int]):
            ...
            (ie. 10).
    """
    score_buckets: MutableMapping[int, int] = proto.MapField(proto.INT32, proto.INT64, number=1)
...
class ScoreMetrics(proto.Message):
    ...
    """
    overall_metrics: 'ScoreDistribution' = proto.Field(proto.MESSAGE, number=1, message='ScoreDistribution')
    action_metrics: MutableMapping[str, 'ScoreDistribution'] = proto.MapField(proto.STRING, proto.MESSAGE, number=2, message='ScoreDistribution')
...
class ChallengeMetrics(proto.Message):
    ...
    Attributes:
        ...
        passed_count (int):
            ...
            verification.
    """
    pageload_count: int = proto.Field(proto.INT64, number=1)
    nocaptcha_count: int = proto.Field(proto.INT64, number=2)
    failed_count: int = proto.Field(proto.INT64, number=3)
    passed_count: int = proto.Field(proto.INT64, number=4)
...
class FirewallPolicyAssessment(proto.Message):
    ...
    firewall_policy: 'FirewallPolicy' = proto.Field(proto.MESSAGE, number=8, message='FirewallPolicy')
...
class FirewallAction(proto.Message):
    ...
    class BlockAction(proto.Message):
        """A block action serves an HTTP error code a prevents the
        request from hitting the backend.

        """

    class RedirectAction(proto.Message):
        """A redirect action returns a 307 (temporary redirect)
    ...
    class SubstituteAction(proto.Message):
        """A substitute action transparently serves a different page
        ...
        """
        path: str = proto.Field(proto.STRING, number=1)

    class SetHeaderAction(proto.Message):
        """A set header action sets a header and forwards the request to
    ...
    allow: AllowAction = proto.Field(proto.MESSAGE, number=1, oneof='firewall_action_oneof', message=AllowAction)
    block: BlockAction = proto.Field(proto.MESSAGE, number=2, oneof='firewall_action_oneof', message=BlockAction)
    redirect: RedirectAction = proto.Field(proto.MESSAGE, number=5, oneof='firewall_action_oneof', message=RedirectAction)
    substitute: SubstituteAction = proto.Field(proto.MESSAGE, number=3, oneof='firewall_action_oneof', message=SubstituteAction)
    set_header: SetHeaderAction = proto.Field(proto.MESSAGE, number=4, oneof='firewall_action_oneof', message=SetHeaderAction)
...
class FirewallPolicy(proto.Message):
    ...
    condition: str = proto.Field(proto.STRING, number=5)
    actions: MutableSequence['FirewallAction'] = proto.RepeatedField(proto.MESSAGE, number=6, message='FirewallAction')
...
class ListRelatedAccountGroupMembershipsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    related_account_group_memberships: MutableSequence['RelatedAccountGroupMembership'] = proto.RepeatedField(proto.MESSAGE, number=1, message='RelatedAccountGroupMembership')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    related_account_groups: MutableSequence['RelatedAccountGroup'] = proto.RepeatedField(proto.MESSAGE, number=1, message='RelatedAccountGroup')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SearchRelatedAccountGroupMembershipsRequest(proto.Message):
    ...
    hashed_account_id: bytes = proto.Field(proto.BYTES, number=2)
...
class WafSettings(proto.Message):
    ...
    class WafService(proto.Enum):
        ...
        CA = 1
        FASTLY = 3
    waf_service: WafService = proto.Field(proto.ENUM, number=1, enum=WafService)
    waf_feature: WafFeature = proto.Field(proto.ENUM, number=2, enum=WafFeature)
