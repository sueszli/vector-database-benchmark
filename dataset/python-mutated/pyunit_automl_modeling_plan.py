...
def test_exclude_algos_is_applied_on_top_of_modeling_plan():
    ...
    assert len(models.base) == 3
    assert len(models.se) == 0
pu.run_tests([test_bad_modeling_plan_using_full_syntax, test_bad_modeling_plan_using_simplified_syntax, test_modeling_plan_using_full_syntax, test_modeling_plan_using_simplified_syntax, test_modeling_plan_using_minimal_syntax, test_modeling_steps, test_exclude_algos_is_applied_on_top_of_modeling_plan])