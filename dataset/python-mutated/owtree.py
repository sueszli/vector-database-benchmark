...
class OWTreeLearner(OWBaseLearner):
    ...
    icon = 'icons/Tree.svg'
    replaces = ['Orange.widgets.classify.owclassificationtree.OWClassificationTree', 'Orange.widgets.regression.owregressiontree.OWRegressionTree', 'Orange.widgets.classify.owclassificationtree.OWTreeLearner', 'Orange.widgets.regression.owregressiontree.OWTreeLearner']
    priority = 30
    ...
    spin_boxes = (('Min. number of instances in leaves: ', 'limit_min_leaf', 'min_leaf', 1, 1000), ('Do not split subsets smaller than: ', 'limit_min_internal', 'min_internal', 1, 1000), ('Limit the maximal tree depth to: ', 'limit_depth', 'max_depth', 1, 1000))
    classification_spin_boxes = (('Stop when majority reaches [%]: ', 'limit_majority', 'sufficient_majority', 51, 100),)
