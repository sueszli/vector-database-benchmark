...
from ...operations._consumer_source_data_sets_operations import build_list_by_share_subscription_request
...
class ConsumerSourceDataSetsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`consumer_source_data_sets` attribute.
    """
    models = _models
    ...
    @distributed_trace
    def list_by_share_subscription(self, resource_group_name: str, account_name: str, share_subscription_name: str, skip_token: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.ConsumerSourceDataSet']:
        if False:
            print('Hello World!')
        'Get source dataSets of a shareSubscription.\n\n        Get source dataSets of a shareSubscription.\n\n        :param resource_group_name: The resource group name. Required.\n        :type resource_group_name: str\n        :param account_name: The name of the share account. Required.\n        :type account_name: str\n        :param share_subscription_name: The name of the shareSubscription. Required.\n        :type share_subscription_name: str\n        :param skip_token: Continuation token. Default value is None.\n        :type skip_token: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: An iterator like instance of either ConsumerSourceDataSet or the result of\n         cls(response)\n        :rtype:\n         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.datashare.models.ConsumerSourceDataSet]\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
