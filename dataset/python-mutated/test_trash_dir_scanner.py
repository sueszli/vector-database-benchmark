...
class TestTrashDirScanner(unittest.TestCase):
    ...
    def test_scan_trash_dirs(self):
        ...
        scanner = TrashDirsScanner(user_info_provider, volumes_listing=volumes_listing, top_trash_dir_rules=Mock(), dir_checker=dir_checker)
        ...
        self.assertEqual([(trash_dir_found, ('/home/user/.local/share/Trash', '/')), (trash_dir_found, ('/vol/.Trash-123', '/vol')), (trash_dir_found, ('/vol2/.Trash-123', '/vol2'))], result)