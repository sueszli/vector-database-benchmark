...
class LaXarxaMesIE(InfoExtractor):
    ...
    _TOKEN = None
    _TESTS = [{'url': 'https://www.laxarxames.cat/player/3459421', 'md5': '0966f46c34275934c19af78f3df6e2bc', 'info_dict': {'id': '6339612436112', 'ext': 'mp4', 'title': 'Resum | UA Horta — UD Viladecans', 'timestamp': 1697905186, 'thumbnail': 're:https?://.*\\.jpg', 'description': '', 'upload_date': '20231021', 'duration': 129.44, 'tags': ['ott', 'esports', '23-24', ' futbol', ' futbol-partits', 'elit', 'resum'], 'uploader_id': '5779379807001'}, 'skip': 'Requires login'}]
