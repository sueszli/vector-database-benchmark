...
class OpenRecIE(OpenRecBaseIE):
    ...
    _TESTS = [{'url': 'https://www.openrec.tv/live/2p8v31qe4zy', 'only_matching': True}, {'url': 'https://www.openrec.tv/live/wez93eqvjzl', 'only_matching': True}]
...
class OpenRecCaptureIE(OpenRecBaseIE):
    ...
    _TESTS = [{'url': 'https://www.openrec.tv/capture/l9nk2x4gn14', 'only_matching': True}, {'url': 'https://www.openrec.tv/capture/mldjr82p7qk', 'info_dict': {'id': 'mldjr82p7qk', 'title': 'たいじの恥ずかしい英語力', 'uploader': 'たいちゃんねる', 'uploader_id': 'Yaritaiji', 'upload_date': '20210803'}}]
...
class OpenRecMovieIE(OpenRecBaseIE):
    ...
    _TESTS = [{'url': 'https://www.openrec.tv/movie/nqz5xl5km8v', 'info_dict': {'id': 'nqz5xl5km8v', 'title': '限定コミュニティ(Discord)参加方法ご説明動画', 'description': 'md5:ebd563e5f5b060cda2f02bf26b14d87f', 'thumbnail': 're:https://.+', 'uploader': 'タイキとカズヒロ', 'uploader_id': 'taiki_to_kazuhiro', 'timestamp': 1638856800}}]
