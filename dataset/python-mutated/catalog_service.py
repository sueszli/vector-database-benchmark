    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    catalogs: MutableSequence[gcr_catalog.Catalog] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcr_catalog.Catalog)
...
class UpdateCatalogRequest(proto.Message):
    ...
    """
    catalog: gcr_catalog.Catalog = proto.Field(proto.MESSAGE, number=1, message=gcr_catalog.Catalog)
...
class SetDefaultBranchRequest(proto.Message):
    ...
    """
    catalog: str = proto.Field(proto.STRING, number=1)
    branch_id: str = proto.Field(proto.STRING, number=2)
    note: str = proto.Field(proto.STRING, number=3)
    force: bool = proto.Field(proto.BOOL, number=4)

class GetDefaultBranchRequest(proto.Message):
    """Request message to show which branch is currently the default
    branch.
...
class GetDefaultBranchResponse(proto.Message):
    ...
    """
    branch: str = proto.Field(proto.STRING, number=1)
    set_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
    note: str = proto.Field(proto.STRING, number=3)
...
class UpdateCompletionConfigRequest(proto.Message):
    ...
    """
    completion_config: gcr_catalog.CompletionConfig = proto.Field(proto.MESSAGE, number=1, message=gcr_catalog.CompletionConfig)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class UpdateAttributesConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            If not set, all supported fields are updated.
    """
    attributes_config: gcr_catalog.AttributesConfig = proto.Field(proto.MESSAGE, number=1, message=gcr_catalog.AttributesConfig)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class AddCatalogAttributeRequest(proto.Message):
    ...
    Attributes:
        ...
        catalog_attribute (google.cloud.retail_v2.types.CatalogAttribute):
            ...
            to add.
    """
    attributes_config: str = proto.Field(proto.STRING, number=1)
    catalog_attribute: gcr_catalog.CatalogAttribute = proto.Field(proto.MESSAGE, number=2, message=gcr_catalog.CatalogAttribute)
