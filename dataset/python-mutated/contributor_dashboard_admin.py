...
class ContributorDashboardAdminPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class ContributionRightsHandler(base.BaseHandler[ContributionRightsHandlerNormalizedPayloadDict, ContributionRightsHandlerNormalizedRequestDict]):
    """Handles contribution rights of a user on contributor dashboard page."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'category': {'schema': {'type': 'basestring', 'choices': constants.CONTRIBUTION_RIGHT_CATEGORIES}}}
    HANDLER_ARGS_SCHEMAS = {'POST': {'username': {'schema': {'type': 'basestring'}}, 'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}}, 'DELETE': {'username': {'schema': {'type': 'basestring'}}, 'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}}}
...
class ContributorUsersListHandler(base.BaseHandler[Dict[str, str], ContributorUsersListHandlerNormalizedRequestDict]):
    """Handler to show users with contribution rights."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'category': {'schema': {'type': 'basestring', 'choices': constants.CONTRIBUTION_RIGHT_CATEGORIES}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}}}
...
class ContributionRightsDataHandler(base.BaseHandler[Dict[str, str], ContributionRightsDataHandlerNormalizedRequestDict]):
    """Handler to show the contribution rights of a user."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'username': {'schema': {'type': 'basestring'}}}}
...
class TranslationContributionStatsHandler(base.BaseHandler[Dict[str, str], TranslationContributionStatsHandlerNormalizedRequestDict]):
...
class ContributorDashboardAdminStatsHandler(base.BaseHandler[Dict[str, str], ContributorDashboardAdminStatsHandlerNormalizedPayloadDict]):
    """Return Contributor Admin Dashboard Stats for supplied parameters.
    """
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'contribution_type': {'schema': {'type': 'basestring'}, 'choices': [feconf.CONTRIBUTION_TYPE_TRANSLATION, feconf.CONTRIBUTION_TYPE_QUESTION]}, 'contribution_subtype': {'schema': {'type': 'basestring'}, 'choices': [feconf.CONTRIBUTION_SUBTYPE_SUBMISSION, feconf.CONTRIBUTION_SUBTYPE_REVIEW, feconf.CONTRIBUTION_SUBTYPE_COORDINATE]}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'page_size': {'schema': {'type': 'int', 'validators': [{'id': 'is_at_least', 'min_value': 0}]}, 'default_value': 20}, 'offset': {'schema': {'type': 'int', 'validators': [{'id': 'is_at_least', 'min_value': 0}]}}, 'language_code': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_supported_audio_language_code'}]}, 'default_value': None}, 'sort_by': {'schema': {'type': 'basestring', 'choices': constants.CD_ADMIN_STATS_SORT_OPTIONS}, 'default_value': None}, 'topic_ids': {'schema': {'type': 'custom', 'obj_type': 'JsonEncodedInString'}, 'default_value': None}, 'max_days_since_last_activity': {'schema': {'type': 'int', 'validators': [{'id': 'is_at_least', 'min_value': 0}]}, 'default_value': None}}}
...
class CommunityContributionStatsHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
