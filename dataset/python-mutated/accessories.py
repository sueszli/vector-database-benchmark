...
from homeassistant.core import CALLBACK_TYPE, Context, HomeAssistant, State, callback as ha_callback, split_entity_id
from homeassistant.helpers.dispatcher import async_dispatcher_send
from homeassistant.helpers.event import EventStateChangedData, async_track_state_change_event
from homeassistant.helpers.typing import EventType
from homeassistant.util.decorator import Registry
from .const import ATTR_DISPLAY_NAME, ATTR_INTEGRATION, ATTR_VALUE, BRIDGE_MODEL, BRIDGE_SERIAL_NUMBER, CHAR_BATTERY_LEVEL, CHAR_CHARGING_STATE, CHAR_HARDWARE_REVISION, CHAR_STATUS_LOW_BATTERY, CONF_FEATURE_LIST, CONF_LINKED_BATTERY_CHARGING_SENSOR, CONF_LINKED_BATTERY_SENSOR, CONF_LOW_BATTERY_THRESHOLD, DEFAULT_LOW_BATTERY_THRESHOLD, EVENT_HOMEKIT_CHANGED, HK_CHARGING, HK_NOT_CHARGABLE, HK_NOT_CHARGING, MANUFACTURER, MAX_MANUFACTURER_LENGTH, MAX_MODEL_LENGTH, MAX_SERIAL_LENGTH, MAX_VERSION_LENGTH, SERV_ACCESSORY_INFO, SERV_BATTERY_SERVICE, TYPE_FAUCET, TYPE_OUTLET, TYPE_SHOWER, TYPE_SPRINKLER, TYPE_SWITCH, TYPE_VALVE
...
SWITCH_TYPES = {TYPE_FAUCET: 'Valve', TYPE_OUTLET: 'Outlet', TYPE_SHOWER: 'Valve', TYPE_SPRINKLER: 'Valve', TYPE_SWITCH: 'Switch', TYPE_VALVE: 'Valve'}
...
class HomeAccessory(Accessory):
    ...
    async def run(self) -> None:
        ...
        self._update_available_from_state(state)
        self._subscriptions.append(async_track_state_change_event(self.hass, [self.entity_id], self.async_update_event_state_callback))
        ...
        if self.linked_battery_charging_sensor:
            ...
            self._subscriptions.append(async_track_state_change_event(self.hass, [self.linked_battery_charging_sensor], self.async_update_linked_battery_charging_callback))
