...
class CTkTextbox(CTkBaseClass):
    ...
    _valid_tk_text_attributes = {'autoseparators', 'cursor', 'exportselection', 'insertborderwidth', 'insertofftime', 'insertontime', 'insertwidth', 'maxundo', 'padx', 'pady', 'selectborderwidth', 'spacing1', 'spacing2', 'spacing3', 'state', 'tabs', 'takefocus', 'undo', 'wrap', 'xscrollcommand', 'yscrollcommand'}
