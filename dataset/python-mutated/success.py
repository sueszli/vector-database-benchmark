...
from pydantic import UUID1, AwareDatetime, BaseModel, ConfigDict, DirectoryPath, FilePath, FutureDate, FutureDatetime, ImportString, Json, NaiveDatetime, NegativeFloat, NegativeInt, NonNegativeFloat, NonNegativeInt, NonPositiveFloat, NonPositiveInt, PastDate, PastDatetime, PositiveFloat, PositiveInt, StrictBool, StrictBytes, StrictFloat, StrictInt, StrictStr, UrlConstraints, WrapValidator, create_model, field_validator, root_validator, validate_call
...
m = Model.model_validate({'age': 2, 'first_name': b'Woof', 'last_name': b'Woof', 'signup_ts': '2017-06-07 00:00', 'list_of_ints': [1, '2', b'3']})
