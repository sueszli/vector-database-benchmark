...
from freqtrade.data.btanalysis import delete_backtest_result, get_backtest_result, get_backtest_resultlist, load_and_merge_backtest_result, update_backtest_metadata
from freqtrade.enums import BacktestState
from freqtrade.exceptions import DependencyException, OperationalException
from freqtrade.exchange.common import remove_exchange_credentials
from freqtrade.misc import deep_merge_dicts, is_file_in_dir
from freqtrade.rpc.api_server.api_schemas import BacktestHistoryEntry, BacktestMetadataUpdate, BacktestRequest, BacktestResponse
...
async def api_start_backtest(bt_settings: BacktestRequest, background_tasks: BackgroundTasks, config=Depends(get_config)):
    ...
    return {'status': 'running', 'running': True, 'progress': 0, 'step': str(BacktestState.STARTUP), 'status_msg': 'Backtest started'}
