...
from Orange.widgets.tests.base import WidgetTest, WidgetOutputsTestMixin, datasets, AnchorProjectionWidgetTestMixin
from Orange.widgets.tests.utils import simulate
from Orange.widgets.visualize.owlinearprojection import OWLinearProjection, LinearProjectionVizRank, Placement
from Orange.widgets.visualize.utils import run_vizrank

class TestOWLinearProjection(WidgetTest, AnchorProjectionWidgetTestMixin, WidgetOutputsTestMixin):
