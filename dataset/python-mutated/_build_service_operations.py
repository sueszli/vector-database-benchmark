...
class BuildServiceOperations:
    ...
    def get_build_service(self, resource_group_name: str, service_name: str, build_service_name: str, **kwargs: Any) -> _models.BuildService:
        ...
        return deserialized
    get_build_service.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}'}
    ...
    def list_builds(self, resource_group_name: str, service_name: str, build_service_name: str, **kwargs: Any) -> Iterable['_models.Build']:
        ...
        def get_next(next_link=None):
            ...
            return pipeline_response
        return ItemPaged(get_next, extract_data)
    list_builds.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds'}
    ...
    def get_build(self, resource_group_name: str, service_name: str, build_service_name: str, build_name: str, **kwargs: Any) -> _models.Build:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_build.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds/{buildName}'}
    ...
    def create_or_update_build(self, resource_group_name: str, service_name: str, build_service_name: str, build_name: str, build: Union[_models.Build, IO], **kwargs: Any) -> _models.Build:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    create_or_update_build.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds/{buildName}'}
    ...
    def list_build_results(self, resource_group_name: str, service_name: str, build_service_name: str, build_name: str, **kwargs: Any) -> Iterable['_models.BuildResult']:
        ...
        def get_next(next_link=None):
            ...
            return pipeline_response
        return ItemPaged(get_next, extract_data)
    list_build_results.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds/{buildName}/results'}
    ...
    def get_build_result(self, resource_group_name: str, service_name: str, build_service_name: str, build_name: str, build_result_name: str, **kwargs: Any) -> _models.BuildResult:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_build_result.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds/{buildName}/results/{buildResultName}'}
    ...
    def get_build_result_log(self, resource_group_name: str, service_name: str, build_service_name: str, build_name: str, build_result_name: str, **kwargs: Any) -> _models.BuildResultLog:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_build_result_log.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/builds/{buildName}/results/{buildResultName}/getLogFileUrl'}
    ...
    def get_resource_upload_url(self, resource_group_name: str, service_name: str, build_service_name: str, **kwargs: Any) -> _models.ResourceUploadDefinition:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_resource_upload_url.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/getResourceUploadUrl'}
    ...
    def list_supported_buildpacks(self, resource_group_name: str, service_name: str, build_service_name: str, **kwargs: Any) -> _models.SupportedBuildpacksCollection:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    list_supported_buildpacks.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/supportedBuildpacks'}
    ...
    def get_supported_buildpack(self, resource_group_name: str, service_name: str, build_service_name: str, buildpack_name: str, **kwargs: Any) -> _models.SupportedBuildpackResource:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_supported_buildpack.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/supportedBuildpacks/{buildpackName}'}
    ...
    def list_supported_stacks(self, resource_group_name: str, service_name: str, build_service_name: str, **kwargs: Any) -> _models.SupportedStacksCollection:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    list_supported_stacks.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/supportedStacks'}
    ...
    def get_supported_stack(self, resource_group_name: str, service_name: str, build_service_name: str, stack_name: str, **kwargs: Any) -> _models.SupportedStackResource:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get_supported_stack.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/buildServices/{buildServiceName}/supportedStacks/{stackName}'}