...
__version__ = '1.6.0'
if False:
    from typing import Any, Callable, Dict, Iterable, Optional, Sequence, TextIO, Tuple, Type, TypedDict, Union
    VersionDict = TypedDict('VersionDict', {'major': str, 'minor': str, 'build_number': str})
    InfoDict = TypedDict('InfoDict', {'id': str, 'version': str, 'version_parts': VersionDict, 'like': str, 'codename': str})
_UNIXCONFDIR = os.environ.get('UNIXCONFDIR', '/etc')
_UNIXUSRLIBDIR = os.environ.get('UNIXUSRLIBDIR', '/usr/lib')
_OS_RELEASE_BASENAME = 'os-release'
NORMALIZED_OS_ID = {'ol': 'oracle', 'opensuse-leap': 'opensuse'}
NORMALIZED_LSB_ID = {'enterpriseenterpriseas': 'oracle', 'enterpriseenterpriseserver': 'oracle', 'redhatenterpriseworkstation': 'rhel', 'redhatenterpriseserver': 'rhel', 'redhatenterprisecomputenode': 'rhel'}
...
_DISTRO_RELEASE_IGNORE_BASENAMES = ('debian_version', 'lsb-release', 'oem-release', _OS_RELEASE_BASENAME, 'system-release', 'plesk-release', 'iredmail-release')
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            try:
                ...
                basenames = ['SuSE-release', 'arch-release', 'base-release', 'centos-release', 'fedora-release', 'gentoo-release', 'mageia-release', 'mandrake-release', 'mandriva-release', 'mandrivalinux-release', 'manjaro-release', 'oracle-release', 'redhat-release', 'rocky-release', 'sl-release', 'slackware-version']
