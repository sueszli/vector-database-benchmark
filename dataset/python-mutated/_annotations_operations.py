...
from ...operations._annotations_operations import build_create_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class AnnotationsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, resource_name: str, start: str, end: str, **kwargs: Any) -> AsyncIterable['_models.Annotation']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                ...
                return i + 15
            if not next_link:
                request = build_list_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, start=start, end=end, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, annotation_properties: _models.Annotation, *, content_type: str='application/json', **kwargs: Any) -> List[_models.Annotation]:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, annotation_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> List[_models.Annotation]:
        """Create an Annotation of an Application Insights component.
    ...
    async def create(self, resource_group_name: str, resource_name: str, annotation_properties: Union[_models.Annotation, IO], **kwargs: Any) -> List[_models.Annotation]:
        """Create an Annotation of an Application Insights component.
    ...
    async def delete(self, resource_group_name: str, resource_name: str, annotation_id: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, resource_name=resource_name, annotation_id=annotation_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, annotation_id: str, **kwargs: Any) -> List[_models.Annotation]:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[List[_models.Annotation]] = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, annotation_id=annotation_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
