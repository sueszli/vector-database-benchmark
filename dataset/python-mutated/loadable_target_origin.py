...
class LoadableTargetOrigin(NamedTuple('LoadableTargetOrigin', [('executable_path', Optional[str]), ('python_file', Optional[str]), ('module_name', Optional[str]), ('working_directory', Optional[str]), ('attribute', Optional[str]), ('package_name', Optional[str])])):
