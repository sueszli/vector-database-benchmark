...
from dagster._config import FIELD_NO_DEFAULT_PROVIDED, Array, ConfigEnumValueSnap, ConfigFieldSnap, ConfigSchemaSnapshot, ConfigType, ConfigTypeKind, ConfigTypeSnap, Enum, EnumValue, Field, Map, Noneable, Permissive, ScalarUnion, Selector, Shape, get_builtin_scalar_by_name
from dagster._core.definitions.asset_check_spec import AssetCheckKey
from dagster._core.definitions.events import AssetKey
from dagster._core.definitions.job_definition import JobDefinition
from dagster._core.definitions.metadata import MetadataFieldSerializer, MetadataValue, RawMetadataValue, normalize_metadata
...
@whitelist_for_serdes(storage_name='PipelineSnapshot', serializer=JobSnapshotSerializer, skip_when_empty_fields={'metadata'}, field_serializers={'metadata': MetadataFieldSerializer}, storage_field_names={'node_defs_snapshot': 'solid_definitions_snapshot'})
class JobSnapshot(NamedTuple('_JobSnapshot', [('name', str), ('description', Optional[str]), ('tags', Mapping[str, Any]), ('config_schema_snapshot', ConfigSchemaSnapshot), ('dagster_type_namespace_snapshot', DagsterTypeNamespaceSnapshot), ('node_defs_snapshot', NodeDefsSnapshot), ('dep_structure_snapshot', DependencyStructureSnapshot), ('mode_def_snaps', Sequence[ModeDefSnap]), ('lineage_snapshot', Optional['JobLineageSnapshot']), ('graph_def_name', str), ('metadata', Mapping[str, MetadataValue])])):
...
@whitelist_for_serdes(storage_name='PipelineSnapshotLineage', storage_field_names={'op_selection': 'solid_selection', 'resolved_op_selection': 'solids_to_execute'})
class JobLineageSnapshot(NamedTuple('_JobLineageSnapshot', [('parent_snapshot_id', str), ('op_selection', Optional[Sequence[str]]), ('resolved_op_selection', Optional[AbstractSet[str]]), ('asset_selection', Optional[AbstractSet[AssetKey]]), ('asset_check_selection', Optional[AbstractSet[AssetCheckKey]])])):
