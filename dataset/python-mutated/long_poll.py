...
LISTEN_FOR_CHANGE_REQUEST_TIMEOUT_S = (float(os.environ.get('LISTEN_FOR_CHANGE_REQUEST_TIMEOUT_S_LOWER_BOUND', '30')), float(os.environ.get('LISTEN_FOR_CHANGE_REQUEST_TIMEOUT_S_UPPER_BOUND', '60')))
