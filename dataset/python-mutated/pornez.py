...
from ..utils import clean_html, int_or_none, get_element_by_class, urljoin

class PornezIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?pornez\\.net/(?:video(?P<id>\\w+)|watch)/'
    _TESTS = [{'url': 'https://pornez.net/video344819/mistresst-funny_penis_names-wmv/', 'info_dict': {'id': '344819', 'ext': 'mp4', 'title': 'mistresst funny_penis_names wmv', 'thumbnail': 're:^https?://.*\\.jpg$', 'age_limit': 18}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://pornez.net/watch/leana+lovings+stiff+for+stepdaughter/', 'info_dict': {'id': '156161', 'ext': 'mp4', 'title': 'Watch leana lovings stiff for stepdaughter porn video.', 'age_limit': 18}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://pornez.net/videovzs27fj/tutor4k-e14-blue-wave-1080p-nbq-tutor4k-e14-blue-wave/', 'only_matching': True}]
