...
class ReplyKeyboardRemove(MutableTelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, remove_keyboard: Literal[True]=True, selective: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(remove_keyboard=remove_keyboard, selective=selective, **__pydantic_kwargs)