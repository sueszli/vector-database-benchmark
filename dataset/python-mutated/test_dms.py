...
class TestDmsCreateTaskOperator:
    TASK_DATA = {'replication_task_id': 'task_id', 'source_endpoint_arn': 'source_endpoint', 'target_endpoint_arn': 'target_endpoint', 'replication_instance_arn': 'replication_arn', 'table_mappings': {'rules': [{'rule-type': 'selection', 'rule-id': '1', 'rule-name': '1', 'object-locator': {'schema-name': 'test', 'table-name': '%'}, 'rule-action': 'include'}]}}
...
class TestDmsDeleteTaskOperator:
    TASK_DATA = {'replication_task_id': 'task_id', 'source_endpoint_arn': 'source_endpoint', 'target_endpoint_arn': 'target_endpoint', 'replication_instance_arn': 'replication_arn', 'migration_type': 'full-load', 'table_mappings': {}}
...
class TestDmsDescribeTasksOperator:
    ...
    MOCK_DATA = {'replication_task_id': 'test_task', 'source_endpoint_arn': 'source-endpoint-arn', 'target_endpoint_arn': 'target-endpoint-arn', 'replication_instance_arn': 'replication-instance-arn', 'migration_type': 'full-load', 'table_mappings': {}}
    MOCK_RESPONSE = [{'ReplicationTaskIdentifier': MOCK_DATA['replication_task_id'], 'SourceEndpointArn': MOCK_DATA['source_endpoint_arn'], 'TargetEndpointArn': MOCK_DATA['target_endpoint_arn'], 'ReplicationInstanceArn': MOCK_DATA['replication_instance_arn'], 'MigrationType': MOCK_DATA['migration_type'], 'TableMappings': json.dumps(MOCK_DATA['table_mappings']), 'ReplicationTaskArn': TASK_ARN, 'Status': 'creating'}]
