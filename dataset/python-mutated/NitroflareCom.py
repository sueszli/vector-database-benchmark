...
class NitroflareCom(SimpleDownloader):
    ...
    __version__ = '0.42'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?(?:nitro\\.download|nitroflare\\.com)/view/(?P<ID>[\\w^_]+)'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('sahil', 'sahilshekhawat01@gmail.com'), ('Walter Purcaro', 'vuolter@gmail.com'), ('Stickell', 'l.stickell@yahoo.it'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
    INFO_PATTERN = 'title="(?P<N>.+?)".+>(?P<S>[\\d.,]+) (?P<U>[\\w^_]+)'
    LINK_PATTERN = '(https?://[\\w\\-]+\\.nitroflare\\.com/.+?)"'
    DIRECT_LINK = False
    DISPOSITION = False
    PREMIUM_ONLY_PATTERN = 'This file is available with Premium only'
    DL_LIMIT_PATTERN = 'You have to wait \\d+ minutes to download your next file.'
    URL_REPLACEMENTS = [('nitro\\.download', 'nitroflare.com')]
