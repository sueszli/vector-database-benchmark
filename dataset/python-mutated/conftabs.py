...
from qtpy.QtWidgets import QComboBox, QGroupBox, QGridLayout, QLabel, QMessageBox, QPushButton, QVBoxLayout, QFileDialog
from spyder.config.base import _
from spyder.config.snippets import SNIPPETS
from spyder.plugins.completion.providers.snippets.widgets import SnippetModelsProxy, SnippetTable, SUPPORTED_LANGUAGES_PY, PYTHON_POS
