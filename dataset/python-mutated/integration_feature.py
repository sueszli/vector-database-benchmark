...
from sentry.db.models import BoundedBigIntegerField, BoundedPositiveIntegerField, Model, control_silo_only_model
...
class IntegrationTypes(Enum):
    SENTRY_APP = 0
    DOC_INTEGRATION = 1
INTEGRATION_MODELS_BY_TYPE = {IntegrationTypes.SENTRY_APP.value: SentryApp, IntegrationTypes.DOC_INTEGRATION.value: DocIntegration}
...
class IntegrationFeature(Model):
    ...
    target_type = BoundedPositiveIntegerField(default=0, choices=((IntegrationTypes.SENTRY_APP, 'sentry_app'), (IntegrationTypes.DOC_INTEGRATION, 'doc_integration')))
