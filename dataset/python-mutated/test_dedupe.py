...
import numpy
import dedupe
DATA = {100: {'name': 'Bob', 'age': '50'}, 105: {'name': 'Charlie', 'age': '75'}, 110: {'name': 'Meredith', 'age': '40'}, 115: {'name': 'Sue', 'age': '10'}, 120: {'name': 'Jimmy', 'age': '20'}, 125: {'name': 'Jimbo', 'age': '21'}, 130: {'name': 'Willy', 'age': '35'}, 135: {'name': 'William', 'age': '35'}, 140: {'name': 'Martha', 'age': '19'}, 145: {'name': 'Kyle', 'age': '27'}}
DATA_SAMPLE = (({'age': '27', 'name': 'Kyle'}, {'age': '50', 'name': 'Bob'}), ({'age': '27', 'name': 'Kyle'}, {'age': '35', 'name': 'William'}), ({'age': '10', 'name': 'Sue'}, {'age': '35', 'name': 'William'}), ({'age': '27', 'name': 'Kyle'}, {'age': '20', 'name': 'Jimmy'}), ({'age': '75', 'name': 'Charlie'}, {'age': '21', 'name': 'Jimbo'}))
