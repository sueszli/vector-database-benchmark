...
RESOURCE_LABELS = list(({'project_id': PROJECT, 'zone': zone, 'instance_id': instance_id} for (zone, instance_id) in zip(INSTANCE_ZONES, INSTANCE_IDS)))
METRIC_KIND = 'GAUGE'
VALUE_TYPE = 'DOUBLE'
TIMESTAMPS = ['2016-04-06T22:05:00.042Z', '2016-04-06T22:05:01.042Z', '2016-04-06T22:05:02.042Z']
