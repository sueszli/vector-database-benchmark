...
class TestSessionsTimelineQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_formal_sessions_for_person(self):
        if False:
            i = 10
            return i + 15
        persons = journeys_for(team=self.team, events_by_person={'person1': [{'event_uuid': '6e6e645b-2936-4613-b409-b33f4d9a0f18', 'event': '$pageview', 'timestamp': '2023-10-01 12:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'c15119f2-b243-4547-ab46-1b29a0435948', 'event': 'user signed up', 'timestamp': '2023-10-01 13:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'b826a13e-aae3-4766-b407-0d3a582140e4', 'event': '$pageview', 'timestamp': '2023-10-01 14:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'e1208e6b-8101-4dde-ba21-c47781bb5bad', 'event': '$pageview', 'timestamp': '2023-10-01 17:00:00', 'properties': {'$session_id': 's2'}}], 'person2': [{'event_uuid': '605f6843-bf83-4d7b-b9a0-4d6f7f57415f', 'event': '$pageview', 'timestamp': '2023-10-01 13:30:00', 'properties': {'$session_id': 's3'}}, {'event_uuid': '04dde300-a6c3-4372-9366-80472c2d02b1', 'event': 'did important thing', 'timestamp': '2023-10-02 02:00:00', 'properties': {'$session_id': 's3'}}]})
        person_1_uuid = str(persons['person1'].uuid)
        runner = self._create_runner(SessionsTimelineQuery(before='2023-10-02T06:00:00Z', after='2023-10-01T06:00:00Z', personId=person_1_uuid))
        response = runner.calculate()
    ...
    def test_formal_session_with_recording(self):
        if False:
            i = 10
            return i + 15
        journeys_for(team=self.team, events_by_person={'person1': [{'event_uuid': '6e6e645b-2936-4613-b409-b33f4d9a0f18', 'event': '$pageview', 'timestamp': '2023-10-01 12:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'c15119f2-b243-4547-ab46-1b29a0435948', 'event': 'user signed up', 'timestamp': '2023-10-01 13:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'e1208e6b-8101-4dde-ba21-c47781bb5bad', 'event': '$pageview', 'timestamp': '2023-10-01 17:00:00', 'properties': {'$session_id': 's2'}}]})
        produce_replay_summary(team_id=self.team.pk, session_id='s1', distinct_id='person1', first_timestamp='2023-10-01 12:30:00', last_timestamp='2023-10-01 12:39:00')
        runner = self._create_runner(SessionsTimelineQuery(before='2023-10-02T06:00:00Z', after='2023-10-01T06:00:00Z'))
        response = runner.calculate()
    ...
    def test_before_and_after(self):
        ...
        response = runner.calculate()
        assert response.results == [TimelineEntry(sessionId='s1', events=[EventType(id='c15119f2-b243-4547-ab46-1b29a0435948', distinct_id='person1', event='user signed up', timestamp='2023-10-01T13:00:00+00:00', properties={'$session_id': 's1'}, elements=[])], recording_duration_s=None)]
    ...
    def test_before_and_after_defaults(self):
        if False:
            while True:
                i = 10
        journeys_for(team=self.team, events_by_person={'person1': [{'event_uuid': '6e6e645b-2936-4613-b409-b33f4d9a0f18', 'event': '$pageview', 'timestamp': '2023-09-29 23:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'c15119f2-b243-4547-ab46-1b29a0435948', 'event': 'user signed up', 'timestamp': '2023-10-01 13:00:00', 'properties': {'$session_id': 's1'}}, {'event_uuid': 'e1208e6b-8101-4dde-ba21-c47781bb5bad', 'event': '$pageview', 'timestamp': '2023-10-01 17:00:00', 'properties': {'$session_id': 's2'}}]})
