...
class ForecastOperations:
    ...
    @overload
    async def usage(self, scope: str, parameters: _models.ForecastDefinition, filter: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.ForecastResult]:
    ...
    @overload
    async def usage(self, scope: str, parameters: IO, filter: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.ForecastResult]:
        """Lists the forecast charges for scope defined.
    ...
    async def usage(self, scope: str, parameters: Union[_models.ForecastDefinition, IO], filter: Optional[str]=None, **kwargs: Any) -> Optional[_models.ForecastResult]:
        """Lists the forecast charges for scope defined.
        ...
        request = build_usage_request(scope=scope, filter=filter, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.usage.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def external_cloud_provider_usage(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: _models.ForecastDefinition, filter: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ForecastResult:
    ...
    @overload
    async def external_cloud_provider_usage(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: IO, filter: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ForecastResult:
        """Lists the forecast charges for external cloud provider type defined.
    ...
    @distributed_trace_async
    async def external_cloud_provider_usage(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: Union[_models.ForecastDefinition, IO], filter: Optional[str]=None, **kwargs: Any) -> _models.ForecastResult:
        """Lists the forecast charges for external cloud provider type defined.
