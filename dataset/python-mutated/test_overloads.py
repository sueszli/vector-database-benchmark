...
engine_execution_options = {'compiled_cache': 'Optional[CompiledCacheType]', 'logging_token': 'str', 'isolation_level': 'IsolationLevel', 'insertmanyvalues_page_size': 'int', 'schema_translate_map': 'Optional[SchemaTranslateMapType]', 'opt': 'Any'}
core_execution_options = {**engine_execution_options, 'no_parameters': 'bool', 'stream_results': 'bool', 'max_row_buffer': 'int', 'yield_per': 'int'}
orm_dql_execution_options = {**core_execution_options, 'populate_existing': 'bool', 'autoflush': 'bool'}
orm_dml_execution_options = {'synchronize_session': 'SynchronizeSessionArgument', 'dml_strategy': 'DMLStrategyArgument', 'is_delete_using': 'bool', 'is_update_from': 'bool', 'render_nulls': 'bool'}
orm_execution_options = {**orm_dql_execution_options, **orm_dml_execution_options}
