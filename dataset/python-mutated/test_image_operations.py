...
from wagtail.images.exceptions import InvalidFilterSpecError, UnknownOutputImageFormatError
from wagtail.images.image_operations import TransformOperation
from wagtail.images.models import Filter, Image
from wagtail.images.tests.utils import get_test_image_file, get_test_image_file_avif, get_test_image_file_jpeg, get_test_image_file_tiff, get_test_image_file_webp
...
class TestFillOperation(ImageTransformOperationTestCase):
    ...
    filter_spec_tests = [('fill-800x600', {'width': 800, 'height': 600, 'crop_closeness': 0}), ('hello-800x600', {'width': 800, 'height': 600, 'crop_closeness': 0}), ('fill-800x600-c0', {'width': 800, 'height': 600, 'crop_closeness': 0}), ('fill-800x600-c100', {'width': 800, 'height': 600, 'crop_closeness': 1}), ('fill-800x600-c50', {'width': 800, 'height': 600, 'crop_closeness': 0.5}), ('fill-800x600-c1000', {'width': 800, 'height': 600, 'crop_closeness': 1}), ('fill-800000x100', {'width': 800000, 'height': 100, 'crop_closeness': 0})]
    filter_spec_error_tests = ['fill', 'fill-800', 'fill-abc', 'fill-800xabc', 'fill-800x600-', 'fill-800x600x10', 'fill-800x600-d100']
    run_tests = [('fill-800x600', {'width': 1000, 'height': 1000}, [('crop', (0, 125, 1000, 875)), ('resize', (800, 600))]), ('fill-200x200', {'width': 539, 'height': 720}, [('crop', (0, 90, 539, 630)), ('resize', (200, 200))]), ('fill-800x600-c100', {'width': 1000, 'height': 1000}, [('crop', (0, 125, 1000, 875)), ('resize', (800, 600))]), ('fill-80x60', {'width': 1000, 'height': 1000, 'focal_point_x': 1000, 'focal_point_y': 500, 'focal_point_width': 0, 'focal_point_height': 0}, [('crop', (0, 125, 1000, 875)), ('resize', (80, 60))]), ('fill-80x60-c100', {'width': 1000, 'height': 1000, 'focal_point_x': 1000, 'focal_point_y': 500, 'focal_point_width': 0, 'focal_point_height': 0}, [('crop', (920, 470, 1000, 530))]), ('fill-100x60-c100', {'width': 2000, 'height': 1000, 'focal_point_x': 2000, 'focal_point_y': 500, 'focal_point_width': 0, 'focal_point_height': 0}, [('crop', (1900, 470, 2000, 530))]), ('fill-50x50-c100', {'width': 2000, 'height': 1000, 'focal_point_x': 1000, 'focal_point_y': 500, 'focal_point_width': 100, 'focal_point_height': 20}, [('crop', (950, 450, 1050, 550)), ('resize', (50, 50))]), ('fill-1000x800', {'width': 100, 'height': 100}, [('crop', (0, 10, 100, 90))]), ('fill-1000x800-c100', {'width': 1500, 'height': 1000, 'focal_point_x': 750, 'focal_point_y': 500, 'focal_point_width': 0, 'focal_point_height': 0}, [('crop', (250, 100, 1250, 900))]), ('fill-1500x1500-c100', {'width': 1500, 'height': 1500, 'focal_point_x': 750, 'focal_point_y': 750, 'focal_point_width': 1500, 'focal_point_height': 1500}, [('crop', (0, 0, 1500, 1500))]), ('fill-100x100', {'width': 1, 'height': 1}, [('crop', (0, 0, 1, 1))]), ('fill-100x150', {'width': 1, 'height': 1}, [('crop', (0, 0, 1, 1))]), ('fill-150x100', {'width': 1, 'height': 1}, [('crop', (0, 0, 1, 1))])]
...
class TestMinMaxOperation(ImageTransformOperationTestCase):
    ...
    filter_spec_tests = [('min-800x600', {'method': 'min', 'width': 800, 'height': 600}), ('max-800x600', {'method': 'max', 'width': 800, 'height': 600})]
    filter_spec_error_tests = ['min', 'min-800', 'min-abc', 'min-800xabc', 'min-800x600-', 'min-800x600-c100', 'min-800x600x10']
    run_tests = [('min-800x600', {'width': 1000, 'height': 1000}, [('resize', (800, 800))]), ('max-800x600', {'width': 1000, 'height': 1000}, [('resize', (600, 600))]), ('max-400x400', {'width': 1000, 'height': 1}, [('resize', (400, 1))]), ('max-400x400', {'width': 1, 'height': 1000}, [('resize', (1, 400))])]
...
class TestWidthHeightOperation(ImageTransformOperationTestCase):
    ...
    filter_spec_tests = [('width-800', {'method': 'width', 'size': 800}), ('height-600', {'method': 'height', 'size': 600})]
    filter_spec_error_tests = ['width', 'width-800x600', 'width-abc', 'width-800-c100']
    run_tests = [('width-400', {'width': 1000, 'height': 500}, [('resize', (400, 200))]), ('height-400', {'width': 1000, 'height': 500}, [('resize', (800, 400))]), ('width-400', {'width': 1000, 'height': 1}, [('resize', (400, 1))]), ('height-400', {'width': 1, 'height': 800}, [('resize', (1, 400))])]
...
class TestScaleOperation(ImageTransformOperationTestCase):
    ...
    filter_spec_tests = [('scale-100', {'method': 'scale', 'percent': 100}), ('scale-50', {'method': 'scale', 'percent': 50})]
    filter_spec_error_tests = ['scale', 'scale-800x600', 'scale-abc', 'scale-800-c100']
    run_tests = [('scale-100', {'width': 1000, 'height': 500}, [('resize', (1000, 500))]), ('scale-50', {'width': 1000, 'height': 500}, [('resize', (500, 250))]), ('scale-83.0322', {'width': 1000, 'height': 500}, [('resize', (int(1000 * 0.830322), int(500 * 0.830322)))]), ('scale-50', {'width': 1000, 'height': 1}, [('resize', (500, 1))]), ('scale-50', {'width': 1, 'height': 500}, [('resize', (1, 250))])]
