...
__all__ = ['ChangeSecretAutomationViewSet', 'ChangeSecretRecordViewSet', 'ChangSecretExecutionViewSet', 'ChangSecretAssetsListApi', 'ChangSecretRemoveAssetApi', 'ChangSecretAddAssetApi', 'ChangSecretNodeAddRemoveApi']
...
class ChangeSecretRecordViewSet(mixins.ListModelMixin, OrgGenericViewSet):
    ...
    rbac_perms = {'execute': 'accounts.add_changesecretexecution'}
...
class ChangSecretExecutionViewSet(AutomationExecutionViewSet):
    rbac_perms = (('list', 'accounts.view_changesecretexecution'), ('retrieve', 'accounts.view_changesecretexecution'), ('create', 'accounts.add_changesecretexecution'))
    tp = AutomationTypes.change_secret
