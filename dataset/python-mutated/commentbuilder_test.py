...
CommentTreeElement = namedtuple('CommentTreeElement', ['id', 'score', 'children'])
TREE = [CommentTreeElement(id=100, score=100, children=[CommentTreeElement(id=101, score=90, children=[]), CommentTreeElement(id=102, score=80, children=[CommentTreeElement(id=104, score=95, children=[]), CommentTreeElement(id=105, score=85, children=[]), CommentTreeElement(id=106, score=75, children=[])]), CommentTreeElement(id=103, score=70, children=[])]), CommentTreeElement(id=107, score=60, children=[]), CommentTreeElement(id=108, score=55, children=[CommentTreeElement(id=110, score=110, children=[])]), CommentTreeElement(id=109, score=50, children=[])]
DISTINGUISHES = {104: 'yes'}
AUTHOR_IDS = {100: 'a', 101: 'b', 102: 'c', 103: 'd', 104: 'e', 105: 'f', 106: 'g', 107: 'h', 108: 'i', 109: 'j', 110: 'k'}
...
def make_comment_scores():
    ...
    return scores_by_id
FakeComment = namedtuple('Comment', ['parent_id', 'author_id', 'distinguished'])
