...
DEFAULT_PARSER_CONFIGURATION = BulkLoadParserConfiguration(namedGraphUri='http://aws.amazon.com/neptune/vocab/v01/DefaultNamedGraph', baseUri='http://aws.amazon.com/neptune/default', allowEmptyStrings=False)
