...
about = {'website': 'https://news.yahoo.com', 'wikidata_id': 'Q3044717', 'official_api_documentation': 'https://developer.yahoo.com/api/', 'use_official_api': False, 'require_api_key': False, 'results': 'HTML'}
...
AGO_RE = re.compile('([0-9]+)\\s*(year|month|week|day|minute|hour)')
AGO_TIMEDELTA = {'minute': timedelta(minutes=1), 'hour': timedelta(hours=1), 'day': timedelta(days=1), 'week': timedelta(days=7), 'month': timedelta(days=30), 'year': timedelta(days=365)}
