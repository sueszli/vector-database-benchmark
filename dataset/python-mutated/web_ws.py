...
class WebSocketResponse(StreamResponse):
    __slots__ = ('_protocols', '_ws_protocol', '_writer', '_reader', '_closed', '_closing', '_conn_lost', '_close_code', '_loop', '_waiting', '_exception', '_timeout', '_receive_timeout', '_autoclose', '_autoping', '_heartbeat', '_heartbeat_cb', '_pong_heartbeat', '_pong_response_cb', '_compress', '_max_msg_size')
