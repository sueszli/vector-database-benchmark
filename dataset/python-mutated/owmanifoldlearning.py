...
from Orange.projection import MDS, Isomap, LocallyLinearEmbedding, SpectralEmbedding, TSNE
...
class TSNEParametersEditor(ManifoldParametersEditor):
    ...
    metric_values = [('euclidean', 'Euclidean'), ('manhattan', 'Manhattan'), ('chebyshev', 'Chebyshev'), ('jaccard', 'Jaccard')]
...
class LocallyLinearEmbeddingParametersEditor(ManifoldParametersEditor):
    ...
    method_values = (('standard', 'Standard'), ('modified', 'Modified'), ('hessian', 'Hessian eigenmap'), ('ltsa', 'Local'))
...
class SpectralEmbeddingParametersEditor(ManifoldParametersEditor):
    ...
    affinity_values = (('nearest_neighbors', 'Nearest neighbors'), ('rbf', 'RBF kernel'))
...
class OWManifoldLearning(OWWidget):
    ...
    class Error(OWWidget.Error):
        n_neighbors_too_small = Msg('For chosen method and components, neighbors must be greater than {}')
        manifold_error = Msg('{}')
