...
@unittest.skipIf(not core.is_compiled_with_cuda() or not core.is_float16_supported(core.CUDAPlace(0)), 'core is not compiled with CUDA or not support the float16')
