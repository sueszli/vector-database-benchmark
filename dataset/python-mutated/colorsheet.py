...
class ColorSheet(Sheet):
    rowtype = 'colors'
    columns = [ItemColumn('fg', 0, type=int), ItemColumn('bg', 1, type=int), ItemColumn('pairnum', 2), ItemColumn('name', 3)]
    colorizers = [RowColorizer(7, None, lambda s, c, r, v: r and r[3])]
