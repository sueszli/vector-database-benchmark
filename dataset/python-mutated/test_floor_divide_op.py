...
class TestFloorDivideDtype(TestFloorDivideShape):
    ...
    def init_attrs(self):
        ...
        self.dtypes = [{'x_dtype': 'int8', 'y_dtype': 'int8'}, {'x_dtype': 'int16', 'y_dtype': 'int16'}, {'x_dtype': 'int32', 'y_dtype': 'int32'}, {'x_dtype': 'int64', 'y_dtype': 'int64'}, {'x_dtype': 'float16', 'y_dtype': 'float16', 'max_relative_error': 1}, {'x_dtype': 'float32', 'y_dtype': 'float32'}, {'x_dtype': 'float64', 'y_dtype': 'float64'}]
...
class TestFloorDivideUINT(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.cls = TestFloorDivideOp
        self.inputs = [{'x_shape': [1024], 'y_shape': [1024]}]
        self.dtypes = [{'x_dtype': 'uint8', 'y_dtype': 'uint8'}]
        self.attrs = [{'x_low': 1, 'x_high': 10, 'y_low': 1, 'y_high': 10}]
