...
GROUP_OWNER_TYPE = {GroupOwnerType.SUSPECT_COMMIT: 'suspectCommit', GroupOwnerType.OWNERSHIP_RULE: 'ownershipRule', GroupOwnerType.CODEOWNERS: 'codeowners'}
...
class GroupOwner(Model):
    ...
    type = models.PositiveSmallIntegerField(choices=((GroupOwnerType.SUSPECT_COMMIT, 'Suspect Commit'), (GroupOwnerType.OWNERSHIP_RULE, 'Ownership Rule'), (GroupOwnerType.CODEOWNERS, 'Codeowners')))
