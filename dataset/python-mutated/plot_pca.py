...
def plot_pca_illustration():
    ...
    axes[0].arrow(pca.mean_[0], pca.mean_[1], S[0] * pca.components_[0, 0], S[0] * pca.components_[0, 1], width=0.1, head_width=0.3, color='k')
    axes[0].arrow(pca.mean_[0], pca.mean_[1], S[1] * pca.components_[1, 0], S[1] * pca.components_[1, 1], width=0.1, head_width=0.3, color='k')
    axes[0].text(-1.5, -0.5, 'Component 2', size=14)
