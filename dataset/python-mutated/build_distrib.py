...
PYTHON_SEARCH_PATHS = dict(WINDOWS=['C:\\Python??*\\', 'C:\\Pythons\\Python*\\', '%LOCALAPPDATA%\\Programs\\Python\\Python*\\', 'C:\\Program Files\\Python*\\', 'C:\\Program Files (x86)\\Python*\\'], LINUX=['%PYENV_ROOT%/versions/*/bin'], MAC=['%PYENV_ROOT%/versions/*/bin', '/usr/local/bin'])
