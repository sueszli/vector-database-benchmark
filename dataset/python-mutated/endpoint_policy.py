...
__protobuf__ = proto.module(package='google.cloud.networkservices.v1', manifest={'EndpointPolicy', 'ListEndpointPoliciesRequest', 'ListEndpointPoliciesResponse', 'GetEndpointPolicyRequest', 'CreateEndpointPolicyRequest', 'UpdateEndpointPolicyRequest', 'DeleteEndpointPolicyRequest'})

class EndpointPolicy(proto.Message):
    """EndpointPolicy is a resource that helps apply desired
    ...
    type_: EndpointPolicyType = proto.Field(proto.ENUM, number=5, enum=EndpointPolicyType)
    authorization_policy: str = proto.Field(proto.STRING, number=7)
    endpoint_matcher: common.EndpointMatcher = proto.Field(proto.MESSAGE, number=9, message=common.EndpointMatcher)
    traffic_port_selector: common.TrafficPortSelector = proto.Field(proto.MESSAGE, number=10, message=common.TrafficPortSelector)
    description: str = proto.Field(proto.STRING, number=11)
    server_tls_policy: str = proto.Field(proto.STRING, number=12)
    client_tls_policy: str = proto.Field(proto.STRING, number=13)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    endpoint_policies: MutableSequence['EndpointPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='EndpointPolicy')
...
class CreateEndpointPolicyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    endpoint_policy_id: str = proto.Field(proto.STRING, number=2)
    endpoint_policy: 'EndpointPolicy' = proto.Field(proto.MESSAGE, number=3, message='EndpointPolicy')
...
class UpdateEndpointPolicyRequest(proto.Message):
    ...
    endpoint_policy: 'EndpointPolicy' = proto.Field(proto.MESSAGE, number=2, message='EndpointPolicy')
