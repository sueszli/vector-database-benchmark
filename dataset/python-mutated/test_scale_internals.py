...
import pandas as pd
import pytest
from plotnine import aes, annotate, element_text, expand_limits, facet_wrap, geom_bar, geom_col, geom_point, ggplot, lims, theme
from plotnine.exceptions import PlotnineError, PlotnineWarning
from plotnine.scales import scale_color, scale_color_manual, scale_identity, scale_manual, scale_xy
from plotnine.scales.scale_alpha import scale_alpha_continuous, scale_alpha_discrete
from plotnine.scales.scale_linetype import scale_linetype_continuous, scale_linetype_discrete
from plotnine.scales.scale_manual import _scale_manual
from plotnine.scales.scale_shape import scale_shape_continuous, scale_shape_discrete
from plotnine.scales.scale_size import scale_size_area, scale_size_continuous, scale_size_discrete, scale_size_radius
from plotnine.scales.scale_xy import scale_x_continuous, scale_x_discrete, scale_x_log10, scale_y_continuous
...
data = pd.DataFrame({'x': range(4), 'y': range(4), 'w': list('wxyz'), 'z': list('abcd')})
