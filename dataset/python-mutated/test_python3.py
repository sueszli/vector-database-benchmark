...
from pythonforandroid.recipes.python3 import NDK_API_LOWER_THAN_SUPPORTED_MESSAGE
...
class TestPython3Recipe(RecipeCtx, unittest.TestCase):
    ...
    """
    recipe_name = 'python3'
    expected_compiler = f'/opt/android/android-ndk/toolchains/llvm/prebuilt/{build_platform}/bin/clang'
