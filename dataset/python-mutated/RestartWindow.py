...
try:
    ...
    from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QLineEdit, QMessageBox, QApplication
except ImportError:
    from PySide2.QtCore import Signal as pyqtSignal
    from PySide2.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QLineEdit, QMessageBox, QApplication
