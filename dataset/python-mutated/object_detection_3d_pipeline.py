...
from modelscope.models.cv.object_detection_3d.depe.result_vis import plot_result
...
@PIPELINES.register_module(Tasks.object_detection_3d, module_name=Pipelines.object_detection_3d_depe)
