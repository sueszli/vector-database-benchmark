...
class Exploit(SSHClient):
    __info__ = {'name': 'SSH Default Creds', 'description': 'Module performs bruteforce attack against SSH service. If valid credentials are found, they are displayed to the user.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'devices': ('Multiple devices',)}
