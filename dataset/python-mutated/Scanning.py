...
def get_lexicon():
    ...
    return lexicon
py_reserved_words = ['global', 'nonlocal', 'def', 'class', 'print', 'del', 'pass', 'break', 'continue', 'return', 'raise', 'import', 'exec', 'try', 'except', 'finally', 'while', 'if', 'elif', 'else', 'for', 'in', 'assert', 'and', 'or', 'not', 'is', 'lambda', 'from', 'yield', 'with']
