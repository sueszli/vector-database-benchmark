...
_SEARCH_SPACE = {'x1': optuna.distributions.IntDistribution(0, 10), 'x2': optuna.distributions.IntDistribution(1, 10, log=True), 'x3': optuna.distributions.FloatDistribution(0, 10), 'x4': optuna.distributions.FloatDistribution(1, 10, log=True), 'x5': optuna.distributions.FloatDistribution(1, 10, step=3), 'x6': optuna.distributions.CategoricalDistribution([1, 4, 7, 10])}
