...
class H2OSingleDecisionTreeEstimator(H2OEstimator):
    ...
    def __init__(self, model_id=None, training_frame=None, ignored_columns=None, ignore_const_cols=True, categorical_encoding='auto', response_column=None, max_depth=20):
        if False:
            i = 10
            return i + 15
