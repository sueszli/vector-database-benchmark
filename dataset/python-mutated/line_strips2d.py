...
class LineStrips2D(Archetype):
    ...
    **Archetype**: 2D line strips with positions and optional colors, radii, labels, etc.
    ...
    def __init__(self: Any, strips: components.LineStrip2DArrayLike, *, radii: components.RadiusArrayLike | None=None, colors: datatypes.Rgba32ArrayLike | None=None, labels: datatypes.Utf8ArrayLike | None=None, draw_order: components.DrawOrderLike | None=None, class_ids: datatypes.ClassIdArrayLike | None=None, instance_keys: components.InstanceKeyArrayLike | None=None):
        if False:
            for i in range(10):
                print('nop')
        ...
        with catch_and_log_exceptions(context=self.__class__.__name__):
            self.__attrs_init__(strips=strips, radii=radii, colors=colors, labels=labels, draw_order=draw_order, class_ids=class_ids, instance_keys=instance_keys)
            return
    ...
    def __attrs_clear__(self) -> None:
        ...
        self.__attrs_init__(strips=None, radii=None, colors=None, labels=None, draw_order=None, class_ids=None, instance_keys=None)
    ...
    def _clear(cls) -> LineStrips2D:
        ...
        return inst
    strips: components.LineStrip2DBatch = field(metadata={'component': 'required'}, converter=components.LineStrip2DBatch._required)
