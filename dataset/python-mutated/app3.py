...
app = Dash(__name__)
app.layout = html.Div([dcc.Input(id='input', value='initial value'), html.Button(id='run-button', children='Run'), html.Button(id='cancel-button', children='Cancel'), html.Div(id='status', children='Finished'), html.Div(id='result', children='No results')])
