...
class UserAgentSwitcher(BaseAddon):
    ...
    __version__ = '0.18'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', True), ('connecttimeout', 'int', 'Max timeout for link connection in seconds', 60), ('maxredirs', 'int', 'Maximum number of redirects to follow', 10), ('useragent', 'str', 'Custom user-agent string', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:87.0) Gecko/20100101 Firefox/87.0')]
