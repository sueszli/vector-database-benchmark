...
class TvigleIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>(?:https?:)?//cloud\\.tvigle\\.ru/video/.+?)\\1']
    _GEO_BYPASS = False
    _GEO_COUNTRIES = ['RU']
    _TESTS = [{'url': 'http://www.tvigle.ru/video/sokrat/', 'info_dict': {'id': '1848932', 'display_id': 'sokrat', 'ext': 'mp4', 'title': 'Сократ', 'description': 'md5:d6b92ffb7217b4b8ebad2e7665253c17', 'duration': 6586, 'age_limit': 12}, 'skip': 'georestricted'}, {'url': 'http://www.tvigle.ru/video/vladimir-vysotskii/vedushchii-teleprogrammy-60-minut-ssha-o-vladimire-vysotskom/', 'info_dict': {'id': '5142516', 'ext': 'flv', 'title': 'Ведущий телепрограммы «60 минут» (США) о Владимире Высоцком', 'description': 'md5:027f7dc872948f14c96d19b4178428a4', 'duration': 186.08, 'age_limit': 0}, 'skip': 'georestricted'}, {'url': 'https://cloud.tvigle.ru/video/5267604/', 'only_matching': True}]
