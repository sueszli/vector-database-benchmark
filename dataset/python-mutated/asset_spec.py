...
@experimental
class AssetSpec(NamedTuple('_AssetSpec', [('key', PublicAttr[AssetKey]), ('deps', PublicAttr[Iterable['AssetDep']]), ('description', PublicAttr[Optional[str]]), ('metadata', PublicAttr[Optional[Mapping[str, Any]]]), ('group_name', PublicAttr[Optional[str]]), ('skippable', PublicAttr[bool]), ('code_version', PublicAttr[Optional[str]]), ('freshness_policy', PublicAttr[Optional[FreshnessPolicy]]), ('auto_materialize_policy', PublicAttr[Optional[AutoMaterializePolicy]])])):
