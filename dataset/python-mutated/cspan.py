...
from ..utils import determine_ext, ExtractorError, extract_attributes, find_xpath_attr, get_element_by_attribute, get_element_by_class, int_or_none, join_nonempty, js_to_json, merge_dicts, parse_iso8601, parse_qs, smuggle_url, str_to_int, unescapeHTML
...
class CSpanIE(InfoExtractor):
    ...
    IE_DESC = 'C-SPAN'
    _TESTS = [{'url': 'http://www.c-span.org/video/?313572-1/HolderonV', 'md5': '94b29a4f131ff03d23471dd6f60b6a1d', 'info_dict': {'id': '315139', 'title': 'Attorney General Eric Holder on Voting Rights Act Decision'}, 'playlist_mincount': 2, 'skip': 'Regularly fails on travis, for unknown reasons'}, {'url': 'http://www.c-span.org/video/?c4486943/cspan-international-health-care-models', 'info_dict': {'id': 'c4486943', 'ext': 'mp4', 'title': 'CSPAN - International Health Care Models', 'description': 'md5:7a985a2d595dba00af3d9c9f0783c967'}}, {'url': 'http://www.c-span.org/video/?318608-1/gm-ignition-switch-recall', 'info_dict': {'id': '342759', 'title': 'General Motors Ignition Switch Recall'}, 'playlist_mincount': 6}, {'url': 'http://www.c-span.org/video/?104517-1/immigration-reforms-needed-protect-skilled-american-workers', 'info_dict': {'id': 'judiciary031715', 'ext': 'mp4', 'title': 'Immigration Reforms Needed to Protect Skilled American Workers'}, 'params': {'skip_download': True}}, {'url': 'https://www.c-span.org/video/?114917-1/armed-services', 'info_dict': {'id': '58428542', 'ext': 'flv', 'title': 'USHR07 Armed Services Committee', 'description': 'hsas00-2118-20150204-1000et-07\n\n\nUSHR07 Armed Services Committee', 'timestamp': 1423060374, 'upload_date': '20150204', 'uploader': 'HouseCommittee', 'uploader_id': '12987475'}}, {'url': 'https://www.c-span.org/video/?437336-1/judiciary-antitrust-competition-policy-consumer-rights', 'only_matching': True}]
...
class CSpanCongressIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.c-span.org/congress/?chamber=house&date=2017-12-13&t=1513208380', 'info_dict': {'id': 'house_2017-12-13', 'title': 'Congressional Chronicle - Members of Congress, Hearings and More', 'description': 'md5:54c264b7a8f219937987610243305a84', 'thumbnail': 're:https://ximage.c-spanvideo.org/.+', 'ext': 'mp4'}}]
