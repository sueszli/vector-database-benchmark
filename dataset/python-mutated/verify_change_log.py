...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Verifies latest version is updated in change log, Called from DevOps YAML Pipeline')
    ...
    parser.add_argument('--service', help='Name of service directory (under sdk/) to build.Example: --service applicationinsights')
    parser.add_argument('--pkgfilter', default='', dest='package_filter_string', help='An additional string used to filter the set of artifacts by a simple CONTAINS clause.')
    ...
    if args.service:
        ...
        target_dir = root_dir
    targeted_packages = discover_targeted_packages(args.glob_string, target_dir, args.package_filter_string, 'Docs')
