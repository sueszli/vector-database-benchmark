...
class CorePromiseAttribute(object):
    ...
    swagger_types = {'string_value': 'str', 'int_value': 'int'}
    attribute_map = {'string_value': 'string_value', 'int_value': 'int_value'}

    def __init__(self, string_value=None, int_value=None):
        if False:
            return 10
        'CorePromiseAttribute - a model defined in Swagger'
