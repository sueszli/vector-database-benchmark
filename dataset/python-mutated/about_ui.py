...
class AboutWindow_Ui(QWidget):
    ...
    def __init__(self, persepolis_setting):
        ...
        self.telegram_label.setTextInteractionFlags(Qt.TextBrowserInteraction)
        ...
        self.twitter_label.setTextInteractionFlags(Qt.TextBrowserInteraction)
        ...
        self.site2_label.setText(QCoreApplication.translate('about_ui_tr', '<a href=https://persepolisdm.github.io>https://persepolisdm.github.io</a>', "TRANSLATORS NOTE: YOU REALLY DON'T NEED TO TRANSLATE THIS PART!"))
        self.telegram_label.setText(QCoreApplication.translate('about_ui_tr', '<a href=https://telegram.me/persepolisdm>https://telegram.me/persepolisdm</a>', "TRANSLATORS NOTE: YOU REALLY DON'T NEED TO TRANSLATE THIS PART!"))
        self.twitter_label.setText(QCoreApplication.translate('about_ui_tr', '<a href=https://twitter.com/persepolisdm>https://twitter.com/persepolisdm</a>', "TRANSLATORS NOTE: YOU REALLY DON'T NEED TO TRANSLATE THIS PART!"))
        self.developers_title_label.setText(QCoreApplication.translate('about_ui_tr', 'Developers:'))
        self.name_label.setText(QCoreApplication.translate('about_ui_tr', '\nAliReza AmirSamimi\nMohammadreza Abdollahzadeh\nSadegh Alirezaie\nMostafa Asadi\nMohammadAmin Vahedinia\nJafar Akhondali\nH.Rostami\nEhsan Titish', "TRANSLATORS NOTE: YOU REALLY DON'T NEED TO TRANSLATE THIS PART!"))
