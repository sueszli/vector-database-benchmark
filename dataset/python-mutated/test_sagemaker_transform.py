...
EXPECTED_INTEGER_FIELDS: list[list[str]] = [['Transform', 'TransformResources', 'InstanceCount'], ['Transform', 'MaxConcurrentTransforms'], ['Transform', 'MaxPayloadInMB']]
CREATE_TRANSFORM_PARAMS: dict = {'TransformJobName': 'job_name', 'ModelName': 'model_name', 'MaxConcurrentTransforms': '12', 'MaxPayloadInMB': '6', 'BatchStrategy': 'MultiRecord', 'TransformInput': {'DataSource': {'S3DataSource': {'S3DataType': 'S3Prefix', 'S3Uri': 's3_uri'}}}, 'TransformOutput': {'S3OutputPath': 'output_path'}, 'TransformResources': {'InstanceType': 'ml.m4.xlarge', 'InstanceCount': '3'}}
CREATE_TRANSFORM_PARAMS_INTEGER_FIELDS: dict = {'TransformJobName': 'job_name', 'ModelName': 'model_name', 'MaxConcurrentTransforms': 12, 'MaxPayloadInMB': 6, 'BatchStrategy': 'MultiRecord', 'TransformInput': {'DataSource': {'S3DataSource': {'S3DataType': 'S3Prefix', 'S3Uri': 's3_uri'}}}, 'TransformOutput': {'S3OutputPath': 'output_path'}, 'TransformResources': {'InstanceType': 'ml.m4.xlarge', 'InstanceCount': 3}}
CREATE_MODEL_PARAMS: dict = {'ModelName': 'model_name', 'PrimaryContainer': {'Image': 'test_image', 'ModelDataUrl': 'output_path'}, 'ExecutionRoleArn': 'arn:aws:iam:role/test-role'}
