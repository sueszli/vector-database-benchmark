...
from ..utils import ExtractorError, float_or_none, parse_duration, parse_qs, str_to_int, urlencode_postdata
...
class PandoraTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://jp.channel.pandora.tv/channel/video.ptv?c1=&prgid=53294230&ch_userid=mikakim&ref=main&lot=cate_01_2', 'info_dict': {'id': '53294230', 'ext': 'flv', 'title': '頭を撫でてくれる？', 'description': '頭を撫でてくれる？', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 39, 'upload_date': '20151218', 'uploader': 'カワイイ動物まとめ', 'uploader_id': 'mikakim', 'view_count': int, 'like_count': int}}, {'url': 'http://channel.pandora.tv/channel/video.ptv?ch_userid=gogoucc&prgid=54721744', 'info_dict': {'id': '54721744', 'ext': 'flv', 'title': '[HD] JAPAN COUNTDOWN 170423', 'description': '[HD] JAPAN COUNTDOWN 170423', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 1704.9, 'upload_date': '20170423', 'uploader': 'GOGO_UCC', 'uploader_id': 'gogoucc', 'view_count': int, 'like_count': int}, 'params': {'skip_download': True}}, {'url': 'http://www.pandora.tv/view/mikakim/53294230#36797454_new', 'only_matching': True}, {'url': 'http://m.pandora.tv/?c=view&ch_userid=mikakim&prgid=54600346', 'only_matching': True}]
