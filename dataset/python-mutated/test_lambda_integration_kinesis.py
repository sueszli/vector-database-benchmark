...
from localstack.testing.aws.lambda_utils import _await_event_source_mapping_enabled, _await_event_source_mapping_state, _get_lambda_invocation_events, lambda_role, s3_lambda_permission
...
TEST_LAMBDA_PARALLEL_FILE = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'functions', 'lambda_parallel.py')
