...
if __name__ == '__main__':
    ...
    def BO_func(alpha):
        ...
        recommenders = []
        for index in range(len(URMs_train)):
            recommender = GeneralizedMergedHybridRecommender(URM_train=URMs_train[index], recommenders=[IALS_recommenders[index], SLIM_recommenders[index]], verbose=False)
    ...
    recommender = GeneralizedMergedHybridRecommender(URM_train=URMs_train[0], recommenders=[IALS_recommenders[0], SLIM_recommenders[0]], verbose=False)
    recommender.fit()
