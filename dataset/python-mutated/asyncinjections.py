...
@inject
async def async_injection(resource1: object=Provide[Container.resource1], resource2: object=Provide[Container.resource2]):
    return (resource1, resource2)

@inject
async def async_injection_with_closing(resource1: object=Closing[Provide[Container.resource1]], resource2: object=Closing[Provide[Container.resource2]]):
    return (resource1, resource2)