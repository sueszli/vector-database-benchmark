...
class DscNodeOperations:
    ...
    async def delete(self, resource_group_name: str, automation_account_name: str, node_id: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, node_id=node_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, automation_account_name: str, node_id: str, **kwargs: Any) -> _models.DscNode:
        ...
        request = build_get_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, node_id=node_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def update(self, resource_group_name: str, automation_account_name: str, node_id: str, dsc_node_update_parameters: _models.DscNodeUpdateParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.DscNode:
        """Update the dsc node.
    ...
    @overload
    async def update(self, resource_group_name: str, automation_account_name: str, node_id: str, dsc_node_update_parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.DscNode:
        """Update the dsc node.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, automation_account_name: str, node_id: str, dsc_node_update_parameters: Union[_models.DscNodeUpdateParameters, IO], **kwargs: Any) -> _models.DscNode:
        """Update the dsc node.
        ...
        request = build_update_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, node_id=node_id, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace
    def list_by_automation_account(self, resource_group_name: str, automation_account_name: str, filter: Optional[str]=None, skip: Optional[int]=None, top: Optional[int]=None, inlinecount: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.DscNode']:
        if False:
            i = 10
            return i + 15
