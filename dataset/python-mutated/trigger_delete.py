...
def main():
    ...
    response = client.triggers.begin_delete(device_name='testedgedevice', name='trigger1', resource_group_name='GroupForEdgeAutomation').result()
    print(response)
