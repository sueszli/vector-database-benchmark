...
@PIPELINES.register_module(Tasks.animal_recognition, module_name=Pipelines.animal_recognition)
class AnimalRecognitionPipeline(Pipeline):
    ...
    def __init__(self, model: str, **kwargs):
        ...
        src_params = torch.load(osp.join(self.local_path, ModelFile.TORCH_MODEL_FILE), Devices.cpu)
