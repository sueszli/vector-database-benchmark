...
class TestAddSmartArtHorizontalProcess(TestCase):

    def test_add_smartart_horizontal_process(self):
        if False:
            i = 10
            return i + 15
        ...
        layout.add(SmartArt.horizontal_process(['Lorem', 'Ipsum', 'Dolor', 'Sit']))
