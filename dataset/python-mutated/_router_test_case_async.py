...
from azure.communication.jobrouter.models import RouterJobStatus, CancelJobOptions, CompleteJobOptions, CloseJobOptions
        ...
        try:
            async with router_client:
                ...
                if router_job.status == RouterJobStatus.PENDING_CLASSIFICATION:
                    await router_client.cancel_job(job_id, CancelJobOptions(disposition_code='JobCancelledAsPartOfTestCleanUp'))
