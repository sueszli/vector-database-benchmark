...
class AutoscalingPolicy(proto.Message):
    ...
    basic_algorithm: 'BasicAutoscalingAlgorithm' = proto.Field(proto.MESSAGE, number=3, oneof='algorithm', message='BasicAutoscalingAlgorithm')
    worker_config: 'InstanceGroupAutoscalingPolicyConfig' = proto.Field(proto.MESSAGE, number=4, message='InstanceGroupAutoscalingPolicyConfig')
    secondary_worker_config: 'InstanceGroupAutoscalingPolicyConfig' = proto.Field(proto.MESSAGE, number=5, message='InstanceGroupAutoscalingPolicyConfig')
...
class BasicAutoscalingAlgorithm(proto.Message):
    ...
    """
    yarn_config: 'BasicYarnAutoscalingConfig' = proto.Field(proto.MESSAGE, number=1, oneof='config', message='BasicYarnAutoscalingConfig')
    cooldown_period: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
...
class BasicYarnAutoscalingConfig(proto.Message):
    ...
    Attributes:
        ...
        scale_down_min_worker_fraction (float):
            ...
            Bounds: [0.0, 1.0]. Default: 0.0.
    """
    graceful_decommission_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=5, message=duration_pb2.Duration)
    scale_up_factor: float = proto.Field(proto.DOUBLE, number=1)
    scale_down_factor: float = proto.Field(proto.DOUBLE, number=2)
    scale_up_min_worker_fraction: float = proto.Field(proto.DOUBLE, number=3)
    scale_down_min_worker_fraction: float = proto.Field(proto.DOUBLE, number=4)

class InstanceGroupAutoscalingPolicyConfig(proto.Message):
    """Configuration for the size bounds of an instance group,
    ...
    """
    min_instances: int = proto.Field(proto.INT32, number=1)
    max_instances: int = proto.Field(proto.INT32, number=2)
    weight: int = proto.Field(proto.INT32, number=3)
...
class CreateAutoscalingPolicyRequest(proto.Message):
    ...
    policy: 'AutoscalingPolicy' = proto.Field(proto.MESSAGE, number=2, message='AutoscalingPolicy')
...
class UpdateAutoscalingPolicyRequest(proto.Message):
    ...
    """
    policy: 'AutoscalingPolicy' = proto.Field(proto.MESSAGE, number=1, message='AutoscalingPolicy')
...
class ListAutoscalingPoliciesResponse(proto.Message):
    """A response to a request to list autoscaling policies in a
    project.
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    policies: MutableSequence['AutoscalingPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AutoscalingPolicy')
