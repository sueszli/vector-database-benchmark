...
class sfp_tool_wafw00f(SpiderFootPlugin):
    meta = {'name': 'Tool - WAFW00F', 'summary': 'Identify what web application firewall (WAF) is in use on the specified website.', 'flags': ['tool'], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Crawling and Scanning'], 'toolDetails': {'name': 'WAFW00F', 'description': 'WAFW00F allows one to identify and fingerprint Web Application Firewall (WAF) products protecting a website.', 'website': 'https://github.com/EnableSecurity/wafw00f', 'repository': 'https://github.com/EnableSecurity/wafw00f'}}
    opts = {'python_path': 'python3', 'wafw00f_path': ''}
    optdescs = {'python_path': "Path to Python 3 interpreter to use for wafw00f. If just 'python3' then it must be in your $PATH.", 'wafw00f_path': 'Path to the wafw00f executable file. Must be set.'}
    results = None
    errorState = False
