...
class RegistryManagementNonWorkspaceOperations:
    ...
    async def registry_management_non_workspace(self, registry_name: str, **kwargs: Any) -> '_models.RegistryDiscoveryDto':
        ...
        request = build_registry_management_non_workspace_request(registry_name=registry_name, template_url=self.registry_management_non_workspace.metadata['url'])
        ...
        return deserialized
    registry_management_non_workspace.metadata = {'url': '/registrymanagement/v1.0/registries/{registryName}/discovery'}