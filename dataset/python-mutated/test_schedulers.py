...
from snorkel.classification.training.schedulers import SequentialScheduler, ShuffledScheduler
dataset1 = DictDataset('d1', 'train', X_dict={'data': [0, 1, 2, 3, 4]}, Y_dict={'labels': torch.LongTensor([1, 1, 1, 1, 1])})
dataset2 = DictDataset('d2', 'train', X_dict={'data': [5, 6, 7, 8, 9]}, Y_dict={'labels': torch.LongTensor([2, 2, 2, 2, 2])})
