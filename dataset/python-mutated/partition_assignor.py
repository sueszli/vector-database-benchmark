...
from faust.types.assignor import HostToPartitionMap, PartitionAssignorT, TopicToPartitionMap
...
__all__ = ['MemberAssignmentMapping', 'MemberMetadataMapping', 'MemberSubscriptionMapping', 'ClientMetadataMapping', 'ClientAssignmentMapping', 'CopartitionedGroups', 'PartitionAssignor']
