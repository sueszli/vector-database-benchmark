...
class OrganizationEventsMetricsEnhancedPerformanceEndpointTest(MetricsEnhancedPerformanceTestCase):
    ...
    METRIC_STRINGS = ['foo_transaction', 'bar_transaction', 'baz_transaction', 'staging', 'measurement_rating', 'good', 'meh', 'd:transactions/measurements.something_custom@millisecond', 'd:transactions/measurements.runtime@hour', 'd:transactions/measurements.bytes_transfered@byte', 'd:transactions/measurements.datacenter_memory@petabyte', 'd:transactions/measurements.custom.kilobyte@kilobyte', 'd:transactions/measurements.longtaskcount@none', 'd:transactions/measurements.percent@ratio', 'd:transactions/measurements.custom_type@somethingcustom']
