...
if is_tf_available():
    ...
    from transformers.models.ctrl.modeling_tf_ctrl import TF_CTRL_PRETRAINED_MODEL_ARCHIVE_LIST, TFCTRLForSequenceClassification, TFCTRLLMHeadModel, TFCTRLModel
...
class TFCTRLModelTester(object):
    ...
    def prepare_config_and_inputs(self):
        ...
        config = CTRLConfig(vocab_size=self.vocab_size, n_embd=self.hidden_size, n_layer=self.num_hidden_layers, n_head=self.num_attention_heads, dff=self.intermediate_size, n_positions=self.max_position_embeddings, pad_token_id=self.pad_token_id)
