...
from ...operations._provider_share_subscriptions_operations import build_adjust_request, build_get_by_share_request, build_list_by_share_request, build_reinstate_request, build_revoke_request
...
class ProviderShareSubscriptionsOperations:
    ...
    @overload
    async def adjust(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: _models.ProviderShareSubscription, *, content_type: str='application/json', **kwargs: Any) -> _models.ProviderShareSubscription:
    ...
    @overload
    async def adjust(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ProviderShareSubscription:
        """Adjust the expiration date of a share subscription in a provider share.
    ...
    async def adjust(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: Union[_models.ProviderShareSubscription, IO], **kwargs: Any) -> _models.ProviderShareSubscription:
        """Adjust the expiration date of a share subscription in a provider share.
        ...
        request = build_adjust_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, provider_share_subscription_id=provider_share_subscription_id, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.adjust.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def reinstate(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: _models.ProviderShareSubscription, *, content_type: str='application/json', **kwargs: Any) -> _models.ProviderShareSubscription:
    ...
    @overload
    async def reinstate(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ProviderShareSubscription:
        """Reinstate share subscription in a provider share.
    ...
    @distributed_trace_async
    async def reinstate(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, provider_share_subscription: Union[_models.ProviderShareSubscription, IO], **kwargs: Any) -> _models.ProviderShareSubscription:
        """Reinstate share subscription in a provider share.
    ...
    async def _revoke_initial(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, **kwargs: Any) -> _models.ProviderShareSubscription:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_revoke_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, provider_share_subscription_id=provider_share_subscription_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self._revoke_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def begin_revoke(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, **kwargs: Any) -> AsyncLROPoller[_models.ProviderShareSubscription]:
        ...
        if cont_token is None:
            raw_result = await self._revoke_initial(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, provider_share_subscription_id=provider_share_subscription_id, api_version=api_version, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
    ...
    @distributed_trace_async
    async def get_by_share(self, resource_group_name: str, account_name: str, share_name: str, provider_share_subscription_id: str, **kwargs: Any) -> _models.ProviderShareSubscription:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_by_share_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, provider_share_subscription_id=provider_share_subscription_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_by_share.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace
    def list_by_share(self, resource_group_name: str, account_name: str, share_name: str, skip_token: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.ProviderShareSubscription']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                for i in range(10):
                    print('nop')
            if not next_link:
                request = build_list_by_share_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, subscription_id=self._config.subscription_id, skip_token=skip_token, api_version=api_version, template_url=self.list_by_share.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
