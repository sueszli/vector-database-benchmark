...
def PlayerList(season='2015', AllTime=False, league='NBA'):
    ...
    if AllTime:
        ...
        _values = _pull.json()['resultSets'][0]['rowSet']
        return [dict(zip(_headers, value)) for value in _values]
__all__ = ['demographics', 'career_stats', 'general_splits', 'game_logs', 'shot_dashboard', 'rebound_dashboard', 'passing_dashboard', 'defense_dashboard', 'shot_log', 'rebound_log', 'shot_chart']