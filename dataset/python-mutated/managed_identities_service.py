...
__protobuf__ = proto.module(package='google.cloud.managedidentities.v1', manifest={'OpMetadata', 'CreateMicrosoftAdDomainRequest', 'ResetAdminPasswordRequest', 'ResetAdminPasswordResponse', 'ListDomainsRequest', 'ListDomainsResponse', 'GetDomainRequest', 'UpdateDomainRequest', 'DeleteDomainRequest', 'AttachTrustRequest', 'ReconfigureTrustRequest', 'DetachTrustRequest', 'ValidateTrustRequest'})
...
class OpMetadata(proto.Message):
    ...
    requested_cancellation: bool = proto.Field(proto.BOOL, number=5)
    api_version: str = proto.Field(proto.STRING, number=6)
...
class CreateMicrosoftAdDomainRequest(proto.Message):
    ...
    domain_name: str = proto.Field(proto.STRING, number=2)
    domain: resource.Domain = proto.Field(proto.MESSAGE, number=3, message=resource.Domain)
...
class ResetAdminPasswordResponse(proto.Message):
    ...
    Attributes:
        password (str):
            ...
            more information.
    """
    password: str = proto.Field(proto.STRING, number=1)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    domains: MutableSequence[resource.Domain] = proto.RepeatedField(proto.MESSAGE, number=1, message=resource.Domain)
...
class UpdateDomainRequest(proto.Message):
    ...
    domain: resource.Domain = proto.Field(proto.MESSAGE, number=2, message=resource.Domain)
...
class AttachTrustRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    trust: resource.Trust = proto.Field(proto.MESSAGE, number=2, message=resource.Trust)
...
class ReconfigureTrustRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    target_domain_name: str = proto.Field(proto.STRING, number=2)
    target_dns_ip_addresses: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
