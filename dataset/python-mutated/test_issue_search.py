import unittest
import pytest
from sentry.api.event_search import AggregateFilter, AggregateKey, SearchFilter, SearchKey, SearchValue
from sentry.api.issue_search import convert_actor_or_none_value, convert_category_value, convert_device_class_value, convert_first_release_value, convert_query_values, convert_release_value, convert_type_value, convert_user_value, parse_search_query, value_converters
