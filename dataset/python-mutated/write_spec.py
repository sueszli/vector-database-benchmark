...
class WriteSpecSchema(BaseModel):
    task_description: str = Field(..., description='Specification task description.')
    spec_file_name: str = Field(..., description="Name of the file to write. Only include the file name. Don't include path.")
