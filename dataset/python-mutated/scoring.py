...
if __name__ == '__main__':
    demo_voter = Voter('abc', num_votes=10, num_good_votes=2, num_prompts=10, num_good_prompts=2, num_rankings=10, num_good_rankings=2, voting_points=6, prompt_points=0, ranking_points=0)
    new_vote = 3
