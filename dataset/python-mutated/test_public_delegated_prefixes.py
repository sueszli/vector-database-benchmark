...
@pytest.mark.parametrize('client_class,transport_name', [(PublicDelegatedPrefixesClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.PublicDelegatedPrefixesRestTransport, 'rest')])
...
def test_public_delegated_prefixes_client_get_transport_class():
    ...
    available_transports = [transports.PublicDelegatedPrefixesRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(PublicDelegatedPrefixesClient, transports.PublicDelegatedPrefixesRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(PublicDelegatedPrefixesClient, transports.PublicDelegatedPrefixesRestTransport, 'rest', 'true'), (PublicDelegatedPrefixesClient, transports.PublicDelegatedPrefixesRestTransport, 'rest', 'false')])
@mock.patch.object(PublicDelegatedPrefixesClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PublicDelegatedPrefixesClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(PublicDelegatedPrefixesClient, transports.PublicDelegatedPrefixesRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AggregatedListPublicDelegatedPrefixesRequest, dict])
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.PublicDelegatedPrefixAggregatedList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value', unreachables=['unreachables_value'])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_aggregated_list') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_aggregated_list') as pre:
...
def test_aggregated_list_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.aggregated_list(compute.AggregatedListPublicDelegatedPrefixesRequest(), project='project_value')
...
def test_aggregated_list_rest_pager(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.PublicDelegatedPrefixAggregatedList(items={'a': compute.PublicDelegatedPrefixesScopedList(), 'b': compute.PublicDelegatedPrefixesScopedList(), 'c': compute.PublicDelegatedPrefixesScopedList()}, next_page_token='abc'), compute.PublicDelegatedPrefixAggregatedList(items={}, next_page_token='def'), compute.PublicDelegatedPrefixAggregatedList(items={'g': compute.PublicDelegatedPrefixesScopedList()}, next_page_token='ghi'), compute.PublicDelegatedPrefixAggregatedList(items={'h': compute.PublicDelegatedPrefixesScopedList(), 'i': compute.PublicDelegatedPrefixesScopedList()}))
...
@pytest.mark.parametrize('request_type', [compute.DeletePublicDelegatedPrefixeRequest, dict])
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor())
    client = PublicDelegatedPrefixesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_delete') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeletePublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeletePublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value')
...
@pytest.mark.parametrize('request_type', [compute.GetPublicDelegatedPrefixeRequest, dict])
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor())
    client = PublicDelegatedPrefixesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_get') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetPublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value')
...
@pytest.mark.parametrize('request_type', [compute.InsertPublicDelegatedPrefixeRequest, dict])
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor())
    client = PublicDelegatedPrefixesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_insert') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', region='region_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertPublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertPublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
...
@pytest.mark.parametrize('request_type', [compute.ListPublicDelegatedPrefixesRequest, dict])
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor())
    client = PublicDelegatedPrefixesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_list') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListPublicDelegatedPrefixesRequest(), project='project_value', region='region_value')
...
@pytest.mark.parametrize('request_type', [compute.PatchPublicDelegatedPrefixeRequest, dict])
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PublicDelegatedPrefixesRestInterceptor())
    client = PublicDelegatedPrefixesClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'post_patch') as post, mock.patch.object(transports.PublicDelegatedPrefixesRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'region': 'sample2', 'public_delegated_prefix': 'sample3'}
        mock_args = dict(project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchPublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchPublicDelegatedPrefixeRequest(), project='project_value', region='region_value', public_delegated_prefix='public_delegated_prefix_value', public_delegated_prefix_resource=compute.PublicDelegatedPrefix(creation_timestamp='creation_timestamp_value'))
...
def test_credentials_transport_error():
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PublicDelegatedPrefixesClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = PublicDelegatedPrefixesClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.PublicDelegatedPrefixesRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PublicDelegatedPrefixesClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.PublicDelegatedPrefixesRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = PublicDelegatedPrefixesClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_public_delegated_prefixes_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.PublicDelegatedPrefixesTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_public_delegated_prefixes_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport.__init__') as Transport:
        ...
        transport = transports.PublicDelegatedPrefixesTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('aggregated_list', 'delete', 'get', 'insert', 'list', 'patch')
...
def test_public_delegated_prefixes_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.public_delegated_prefixes.transports.PublicDelegatedPrefixesTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.PublicDelegatedPrefixesTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_public_delegated_prefixes_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_public_delegated_prefixes_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_public_delegated_prefixes_client_transport_session_collision(transport_name):
    ...
    client1 = PublicDelegatedPrefixesClient(credentials=creds1, transport=transport_name)
    client2 = PublicDelegatedPrefixesClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PublicDelegatedPrefixesTransport, '_prep_wrapped_messages') as prep:
        client = PublicDelegatedPrefixesClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(PublicDelegatedPrefixesClient, transports.PublicDelegatedPrefixesRestTransport)])
