...
class AbemaTV(Plugin):
    ...
    SECRETKEY = b'v+Gjs=25Aw5erR!J8ZuvRrCx*rGswhB&qdHd_SYerEWdU&a?3DzN9B' + b'Rbp5KwY4hEmcj5#fykMjJ=AuWz5GSMY-d@H7DMEh3M@9n2G552Us$$' + b'k9cD=3TxwWe86!x#Zyhe'
    _USER_SCHEMA = validate.Schema({'profile': {'userId': str}, 'token': str})
    _CHANNEL_SCHEMA = validate.Schema({'channels': [{'id': str, 'name': str, 'playback': {validate.optional('dash'): str, 'hls': str}}]})
