...
def upgrade():
    ...
    op.add_column('package_revision', sa.Column('private', sa.Boolean, server_default='FALSE'))
    op.add_column('group', sa.Column('is_organization', sa.Boolean, server_default='FALSE'))
    op.add_column('group_revision', sa.Column('is_organization', sa.Boolean, server_default='FALSE'))
