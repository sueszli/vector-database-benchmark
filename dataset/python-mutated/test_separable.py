...
from astropy.modeling.separable import _arith_oper, _cdot, _coord_matrix, _cstack, is_separable, separability_matrix
...
cm_4d_expected = (np.array([False, False, True, True]), np.array([[True, True, False, False], [True, True, False, False], [False, False, True, False], [False, False, False, True]]))
compound_models = {'cm1': (map3 & sh1 | rot & sh1 | sh1 & sh2 & sh1, (np.array([False, False, True]), np.array([[True, False], [True, False], [False, True]]))), 'cm2': (sh1 & sh2 | rot | map1 | p2 & p22, (np.array([False, False]), np.array([[True, True], [True, True]]))), 'cm3': (map2 | rot & scl1, (np.array([False, False, True]), np.array([[True, False], [True, False], [False, True]]))), 'cm4': (sh1 & sh2 | map2 | rot & scl1, (np.array([False, False, True]), np.array([[True, False], [True, False], [False, True]]))), 'cm5': (map3 | sh1 & sh2 | scl1 & scl2, (np.array([False, False]), np.array([[True], [True]]))), 'cm7': (map2 | p2 & sh1, (np.array([False, True]), np.array([[True, False], [False, True]]))), 'cm8': (rot & (sh1 & sh2), cm_4d_expected), 'cm9': (rot & sh1 & sh2, cm_4d_expected), 'cm10': (rot & sh1 & sh2, cm_4d_expected), 'cm11': (rot & sh1 & (scl1 & scl2), (np.array([False, False, True, True, True]), np.array([[True, True, False, False, False], [True, True, False, False, False], [False, False, True, False, False], [False, False, False, True, False], [False, False, False, False, True]])))}
