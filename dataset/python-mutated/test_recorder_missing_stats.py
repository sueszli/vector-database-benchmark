...
from homeassistant.components.recorder.statistics import get_latest_short_term_statistics_with_session, statistics_during_period
...
POWER_SENSOR_ATTRIBUTES = {'device_class': 'energy', 'state_class': 'measurement', 'unit_of_measurement': 'kWh'}
