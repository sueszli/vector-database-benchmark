...
class Command(BaseCommand):
    ...
    API provides.
    """
    help = "Retrieves the data of a project from readthedocs.org's API and puts it into the local database. This is mostly useful for debugging issues with projects on the live site."
