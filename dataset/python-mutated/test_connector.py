...
class TestAirbyteSpec:
    VALID_SPEC = {'documentationUrl': 'https://google.com', 'connectionSpecification': {'type': 'object', 'required': ['api_token'], 'additionalProperties': False, 'properties': {'api_token': {'type': 'string'}}}}
...
class TestConnectorSpec:
    CONNECTION_SPECIFICATION = {'type': 'object', 'required': ['api_token'], 'additionalProperties': False, 'properties': {'api_token': {'type': 'string'}}}
