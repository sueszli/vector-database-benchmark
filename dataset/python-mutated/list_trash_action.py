...
from trashcli.trash_dirs_scanner import trash_dir_skipped_because_parent_is_symlink
from trashcli.trash_dirs_scanner import trash_dir_skipped_because_parent_not_sticky

class ListTrashArgs(NamedTuple('ListTrashArgs', [('trash_dirs', List[str]), ('attribute_to_print', str), ('show_files', bool), ('all_users', bool)])):
    pass
