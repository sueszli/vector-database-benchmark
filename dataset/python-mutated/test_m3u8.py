...
import pytest
from streamlink.stream.hls import M3U8, ByteRange, DateRange, ExtInf, HLSPlaylist, HLSSegment, M3U8Parser, Media, Resolution, StreamInfo, parse_m3u8, parse_tag
...
@pytest.mark.parametrize(('string', 'log', 'expected'), [(None, False, None), ('', True, None), ('deadbeef', True, None), ('0xnothex', True, None), ('0xdeadbeef', False, b'\xde\xad\xbe\xef'), ('0XDEADBEEF', False, b'\xde\xad\xbe\xef'), ('0xdeadbee', False, b'\r\xea\xdb\xee')])
