...
class ArtifactRetrievalService(beam_artifact_api_pb2_grpc.ArtifactRetrievalServiceServicer):
...
class ArtifactStagingService(beam_artifact_api_pb2_grpc.ArtifactStagingServiceServicer):
