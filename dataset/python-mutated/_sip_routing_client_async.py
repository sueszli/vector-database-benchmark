...
class SipRoutingClient(object):
    ...
    async def get_trunk(self, trunk_fqdn, **kwargs):
    ...
    @distributed_trace_async
    async def set_trunk(self, trunk, **kwargs):
    ...
    @distributed_trace_async
    async def delete_trunk(self, trunk_fqdn, **kwargs):
        """Deletes SIP trunk.
    ...
    @distributed_trace_async
    async def set_trunks(self, trunks, **kwargs):
    ...
    @distributed_trace_async
    async def set_routes(self, routes, **kwargs):
    ...
    async def _update_trunks_(self, trunks, **kwargs):
