...
class Migration(migrations.Migration):
    dependencies = [('payment', '0028_drop_searchable_key'), ('channel', '0003_alter_channel_default_country')]
    operations = [migrations.AlterModelOptions(name='payment', options={'ordering': ('pk',), 'permissions': (('handle_payments', 'Handle payments'),)}), migrations.RunPython(assing_permissions, migrations.RunPython.noop)]