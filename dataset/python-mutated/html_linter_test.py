...
INVALID_STYLE_INDENTATION_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_style_indentation.html')
INVALID_INDENTATION_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_indentation.html')
INVALID_QUOTES_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_quotes.html')
INVALID_ALIGNMENT_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_alignment_of_tags.html')
INVALID_MISSING_HTML_TAG_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_missing_html_tag.html')
INVALID_TAG_MISMATCH_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_tag_mismatch.html')
INVALID_MISMATCH_INDENTATION_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_mismatch_indentation.html')
INVALID_MISMATCHED_TAGS_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_mismatched_tags.html')
INVALID_SPACE_AROUND_ATTRIBUTE_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_space_around_attribute.html')
INVALID_SPACE_AROUND_INNERHTML_ATTRIBUTE_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_space_around_innerhtml_attribute.html')
INVALID_SPACE_AROUND_DUPLICATE_ATTRIBUTE_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_space_around_duplicate_attribute.html')
