...
import proto
__protobuf__ = proto.module(package='google.cloud.networkservices.v1', manifest={'TlsRoute', 'ListTlsRoutesRequest', 'ListTlsRoutesResponse', 'GetTlsRouteRequest', 'CreateTlsRouteRequest', 'UpdateTlsRouteRequest', 'DeleteTlsRouteRequest'})

class TlsRoute(proto.Message):
    """TlsRoute defines how traffic should be routed based on SNI
    ...
    class RouteRule(proto.Message):
        ...
        """
        matches: MutableSequence['TlsRoute.RouteMatch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TlsRoute.RouteMatch')
        action: 'TlsRoute.RouteAction' = proto.Field(proto.MESSAGE, number=2, message='TlsRoute.RouteAction')
    ...
    class RouteMatch(proto.Message):
        ...
        Attributes:
            ...
            alpn (MutableSequence[str]):
                ...
                matches can be set.
        """
        sni_host: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        alpn: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    ...
    class RouteAction(proto.Message):
        ...
        """
        destinations: MutableSequence['TlsRoute.RouteDestination'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TlsRoute.RouteDestination')
    ...
    self_link: str = proto.Field(proto.STRING, number=8)
    ...
    meshes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    gateways: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
...
class ListTlsRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    tls_routes: MutableSequence['TlsRoute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TlsRoute')
...
class CreateTlsRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    tls_route_id: str = proto.Field(proto.STRING, number=2)
    tls_route: 'TlsRoute' = proto.Field(proto.MESSAGE, number=3, message='TlsRoute')
...
class UpdateTlsRouteRequest(proto.Message):
    ...
    tls_route: 'TlsRoute' = proto.Field(proto.MESSAGE, number=2, message='TlsRoute')
