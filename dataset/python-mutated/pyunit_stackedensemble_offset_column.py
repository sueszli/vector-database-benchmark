...
def test_offset_column_has_to_be_same_in_each_base_model():
    ...
    try:
        ...
        pass
pu.run_tests([test_offset_column_is_propagated_to_metalearner, test_offset_column_is_inherited_from_base_models, test_offset_column_has_to_be_same_in_each_base_model])