...
from ..utils import int_or_none, js_to_json, strip_or_none, try_get, unescapeHTML, unified_timestamp

class WatchBoxIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?watchbox\\.de/(?P<kind>serien|filme)/(?:[^/]+/)*[^/]+-(?P<id>\\d+)'
    _TESTS = [{'url': 'https://www.watchbox.de/filme/free-jimmy-12325.html', 'info_dict': {'id': '341368', 'ext': 'mp4', 'title': 'Free Jimmy', 'description': 'md5:bcd8bafbbf9dc0ef98063d344d7cc5f6', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 4890, 'age_limit': 16, 'release_year': 2009}, 'params': {'skip_download': True}, 'expected_warnings': ['Failed to download m3u8 information']}, {'url': 'https://www.watchbox.de/serien/ugly-americans-12231/staffel-1/date-in-der-hoelle-328286.html', 'info_dict': {'id': '328286', 'ext': 'mp4', 'title': 'S01 E01 - Date in der Hölle', 'description': 'md5:2f31c74a8186899f33cb5114491dae2b', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 1291, 'age_limit': 12, 'release_year': 2010, 'series': 'Ugly Americans', 'season_number': 1, 'episode': 'Date in der Hölle', 'episode_number': 1}, 'params': {'skip_download': True}, 'expected_warnings': ['Failed to download m3u8 information']}, {'url': 'https://www.watchbox.de/serien/ugly-americans-12231/staffel-2/der-ring-des-powers-328270', 'only_matching': True}]
