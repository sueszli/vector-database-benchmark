...
from torch._export.passes.replace_view_ops_with_view_copy_ops_pass import is_view_op, get_view_copy_of_view_op
from torch._export.passes.functionalize_side_effectful_ops_pass import _FunctionalizeSideEffectfulOpsPass
