...
class XPUTestSigmoidCrossEntropyWithLogitsOp(XPUOpTestWrapper):
    ...
    class TestSigmoidCrossEntropyWithLogitsOp2(TestSigmoidCrossEntropyWithLogitsOp):
    ...
    class TestSigmoidCrossEntropyWithLogitsOp6(TestSigmoidCrossEntropyWithLogitsOp):
        """Test sigmoid_cross_entropy_with_logit_op with binary label"""
    ...
    class TestSigmoidCrossEntropyWithLogitsOp7(TestSigmoidCrossEntropyWithLogitsOp):
        """Test sigmoid_cross_entropy_with_logit_op with binary label"""
