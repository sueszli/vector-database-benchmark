...
class RequestHandler(BaseProtocol):
    ...
    async def _handle_request(self, request: BaseRequest, start_time: float, request_handler: Callable[[BaseRequest], Awaitable[StreamResponse]]) -> Tuple[StreamResponse, bool]:
    ...
    async def start(self) -> None:
        ...
        while not self._force_close:
            ...
            try:
                task = self._loop.create_task(self._handle_request(request, start, request_handler))
                try:
