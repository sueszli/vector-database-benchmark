...
class TestBf16(TestOneDNNElementwiseSubOp):
    ...
    def test_check_grad_normal(self):
        if False:
            print('Hello World!')
        self.check_grad_with_place(core.CPUPlace(), ['X', 'Y'], 'Out', user_defined_grads=[self.x, -self.x], user_defined_grad_outputs=[self.x_bf16])

    def test_check_grad_ignore_x(self):
        if False:
            print('Hello World!')
        self.check_grad_with_place(core.CPUPlace(), ['Y'], 'Out', user_defined_grads=[-self.y], user_defined_grad_outputs=[self.y_bf16])

    def test_check_grad_ignore_y(self):
        if False:
            i = 10
            return i + 15
        self.check_grad_with_place(core.CPUPlace(), ['X'], 'Out', user_defined_grads=[self.x], user_defined_grad_outputs=[self.x_bf16])
...
class TestBf16Broadcasting(TestBf16):
    ...
    def test_check_grad_normal(self):
        if False:
            i = 10
            return i + 15
        self.check_grad_with_place(core.CPUPlace(), ['X', 'Y'], 'Out', user_defined_grads=[self.x, self.compute_reduced_gradients(self.x)], user_defined_grad_outputs=[self.x_bf16])

    def test_check_grad_ignore_x(self):
        if False:
            print('Hello World!')
        self.check_grad_with_place(core.CPUPlace(), ['Y'], 'Out', user_defined_grads=[self.compute_reduced_gradients(self.x)], user_defined_grad_outputs=[self.x_bf16])
