...
from ...image_utils import ChannelDimension, ImageInput, PILImageResampling, get_image_size, infer_channel_dimension_format, is_scaled_image, make_list_of_images, to_numpy_array, valid_images
from ...utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, TensorType, is_torch_available, is_torch_tensor, logging
...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, task_inputs: Optional[List[str]]=None, segmentation_maps: Optional[ImageInput]=None, instance_id_to_semantic_id: Optional[Dict[int, int]]=None, do_resize: Optional[bool]=None, size: Optional[Dict[str, int]]=None, resample: PILImageResampling=None, do_rescale: Optional[bool]=None, rescale_factor: Optional[float]=None, do_normalize: Optional[bool]=None, image_mean: Optional[Union[float, List[float]]]=None, image_std: Optional[Union[float, List[float]]]=None, ignore_index: Optional[int]=None, do_reduce_labels: Optional[bool]=None, return_tensors: Optional[Union[str, TensorType]]=None, data_format: Union[str, ChannelDimension]=ChannelDimension.FIRST, input_data_format: Optional[Union[str, ChannelDimension]]=None, **kwargs) -> BatchFeature:
        ...
        if 'reduce_labels' in kwargs:
            warnings.warn('The `reduce_labels` argument is deprecated and will be removed in a v4.27. Please use `do_reduce_labels` instead.', FutureWarning)
            if do_reduce_labels is not None:
                raise ValueError('You cannot use both `reduce_labels` and `do_reduce_labels` arguments. Please use `do_reduce_labels` instead.')
            do_reduce_labels = kwargs.pop('reduce_labels')
        ...
        encoded_inputs = self.encode_inputs(images, task_inputs, segmentation_maps, instance_id_to_semantic_id, ignore_index, do_reduce_labels, return_tensors, input_data_format=input_data_format)
