...
WHITELIST_PATHS = ['/acme/acme/', '/certbot-ci/', '/certbot-compatibility-test/']
...
class ForbidStandardOsModule(BaseChecker):
    ...
    msgs = {'E5001': ('Forbidden use of os module, certbot.compat.os must be used instead', 'os-module-forbidden', 'Some methods from the standard os module cannot be used for security reasons on Windows: the safe wrapper certbot.compat.os must be used instead in Certbot.')}
    priority = -1
