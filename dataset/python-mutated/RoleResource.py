...
RoleResource.register_collective_loader('permissions', load=__load_permissions, select=__select_permissions)
RoleResource.register_collective_loader('role_permissions', load=__load_role_permissions, select=__select_role_permissions)
RoleResource.register_collective_loader('users', load=__load_users, select=__select_users)
RoleResource.register_collective_loader('user', load=__load_users_created_role, select=__find_user_created_role)