...
INVALID_IMPORT_FILEPATH = os.path.join(LINTER_TESTS_DIR, 'invalid_import_order.py')
INVALID_PYCODESTYLE_FILEPATH = os.path.join(LINTER_TESTS_DIR, 'invalid_pycodestyle_error.py')
INVALID_PYTHON3_FILEPATH = os.path.join(LINTER_TESTS_DIR, 'invalid_python_three.py')
INVALID_DOCSTRING_FILEPATH = os.path.join(LINTER_TESTS_DIR, 'invalid_docstring.py')
