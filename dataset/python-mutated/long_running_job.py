...
class LongRunningJob(models.Model):
    ...
    result = models.JSONField(default=get_default_longrunningjob_result, blank=False, null=False)
    started_by = models.ForeignKey(User, on_delete=models.SET(get_deleted_user), default=None)