...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='make_pins', usage='%(prog)s [options]', description='Parse a CSV file with pin data and store as corresponding C source and header files.')
    parser.add_argument('-s', '--source_file', dest='source_file', action='store', help='Name of the output source file', default='pins.c')
    parser.add_argument('-e', '--header_file', dest='header_file', action='store', help='Name of the output header file', default='pin_functions.h')
    parser.add_argument('csv_file', action='store', help='Name of the input csv file')
    parser.add_argument('fcn_csv', action='store', help='Name of the csv file with pin functions')
