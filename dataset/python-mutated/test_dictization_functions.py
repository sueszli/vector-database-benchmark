...
from ckan.lib.navl.dictization_functions import validate, Invalid, check_dict, resolve_string_key, DataError, check_string_key, filter_glob_match, update_merge_dict, update_merge_string_key, flatten_schema, get_all_key_combinations, make_full_schema, flatten_dict, unflatten, missing, augment_data, _validate
from ckan.lib.navl.validators import empty, unicode_safe, not_empty, ignore_missing, default, convert_int, ignore
...
class TestMergeStringKey(object):
    ...
    def test_dict_expected(self):
        ...
        assert de.value.error == 'Expected dict for a__0'
schema = {'__after': [identity_converter], '__extra': [identity_converter], '__junk': [identity_converter], '0': [identity_converter], '1': [identity_converter], '2': {'__before': [identity_converter], '__after': [identity_converter], '20': [identity_converter], '22': [identity_converter], '21': {'210': [identity_converter]}}, '3': {'30': [identity_converter]}}
data = {('0',): '0 value', ('2', 0, '20'): '20 value 0', ('2', 0, '21', 0, '210'): '210 value 0,0', ('2', 1, '20'): '20 value 1', ('2', 1, '22'): '22 value 1', ('2', 1, '21', 0, '210'): '210 value 1,0', ('2', 1, '21', 1, '210'): '210 value 1,1', ('2', 1, '21', 3, '210'): '210 value 1,3', ('4', 1, '30'): '30 value 1', ('4',): '4 value'}
