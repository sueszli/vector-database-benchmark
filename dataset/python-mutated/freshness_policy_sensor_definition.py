...
from dagster._core.errors import DagsterInvalidDefinitionError, DagsterInvalidInvocationError, FreshnessPolicySensorExecutionError, user_code_error_boundary
from dagster._core.instance import DagsterInstance
from dagster._serdes import serialize_value, whitelist_for_serdes
from dagster._serdes.errors import DeserializationError
from dagster._serdes.serdes import deserialize_value
from dagster._seven import JSONDecodeError
from .sensor_definition import DefaultSensorStatus, SensorDefinition, SensorEvaluationContext, SensorType, SkipReason, get_context_param_name, get_sensor_context_from_args_or_kwargs, validate_and_get_resource_dict

@whitelist_for_serdes
class FreshnessPolicySensorCursor(NamedTuple('_FreshnessPolicySensorCursor', [('minutes_late_by_key_str', Mapping[str, Optional[float]])])):
...
class FreshnessPolicySensorContext(NamedTuple('_FreshnessPolicySensorContext', [('sensor_name', PublicAttr[str]), ('asset_key', PublicAttr[AssetKey]), ('freshness_policy', PublicAttr[FreshnessPolicy]), ('minutes_overdue', PublicAttr[Optional[float]]), ('previous_minutes_overdue', PublicAttr[Optional[float]]), ('instance', PublicAttr[DagsterInstance]), ('resources', Resources)])):
