...
class ServiceTopologiesOperations:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, service_topology_name: str, service_topology_info: _models.ServiceTopologyResource, *, content_type: str='application/json', **kwargs: Any) -> _models.ServiceTopologyResource:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, service_topology_name: str, service_topology_info: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ServiceTopologyResource:
        """Creates or updates a service topology.
    ...
    async def create_or_update(self, resource_group_name: str, service_topology_name: str, service_topology_info: Union[_models.ServiceTopologyResource, IO], **kwargs: Any) -> _models.ServiceTopologyResource:
        """Creates or updates a service topology.
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, service_topology_name: str, **kwargs: Any) -> _models.ServiceTopologyResource:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, service_topology_name=service_topology_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, service_topology_name: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, service_topology_name=service_topology_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def list(self, resource_group_name: str, **kwargs: Any) -> List[_models.ServiceTopologyResource]:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeploymentManager/serviceTopologies'}