...
from ..utils import ExtractorError, int_or_none, parse_age_limit, parse_duration, traverse_obj, try_get, unified_timestamp, url_or_none

class FOXIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?fox(?:sports)?\\.com/(?:watch|replay)/(?P<id>[\\da-fA-F]+)'
    _TESTS = [{'url': 'https://www.fox.com/watch/4b765a60490325103ea69888fb2bd4e8/', 'md5': 'ebd296fcc41dd4b19f8115d8461a3165', 'info_dict': {'id': '4b765a60490325103ea69888fb2bd4e8', 'ext': 'mp4', 'title': 'Aftermath: Bruce Wayne Develops Into The Dark Knight', 'description': 'md5:549cd9c70d413adb32ce2a779b53b486', 'duration': 102, 'timestamp': 1504291893, 'upload_date': '20170901', 'creator': 'FOX', 'series': 'Gotham', 'age_limit': 14, 'episode': 'Aftermath: Bruce Wayne Develops Into The Dark Knight', 'thumbnail': 're:^https?://.*\\.jpg$'}, 'params': {'skip_download': True}}, {'url': 'https://www.fox.com/watch/087036ca7f33c8eb79b08152b4dd75c1/', 'only_matching': True}, {'url': 'https://www.fox.com/watch/b057484dade738d1f373b3e46216fa2c/', 'only_matching': True}, {'url': 'https://www.foxsports.com/replay/561f3e071347a24e5e877abc56b22e89', 'only_matching': True}]
    _GEO_BYPASS = False
