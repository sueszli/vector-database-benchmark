...
if __name__ == '__main__':
    ...
    parser.add_argument('--storage-url', default=f'sqlite:///test_upgrade_assets/{optuna.__version__}.db')
    ...
    try:
        optuna.create_study(storage=args.storage_url, study_name='multi_empty', directions=['minimize', 'minimize'])
        study = optuna.create_study(storage=args.storage_url, study_name='multi', directions=['minimize', 'minimize'])
        study.set_user_attr('d', 3)
