...
class SafelinkingNet(BaseDecrypter):
    ...
    __version__ = '0.22'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?safelinking\\.net/(?P<TYPE>[pd]/)?(?P<ID>\\w{7})'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('quareevo', 'quareevo@arcor.de'), ('tbsn', 'tbsnpy_github@gmx.de'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
