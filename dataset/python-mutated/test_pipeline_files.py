...
from scrapy.pipelines.files import FilesPipeline, FSFilesStore, FTPFilesStore, GCSFilesStore, S3FilesStore
from scrapy.settings import Settings
from scrapy.utils.test import assert_gcs_environ, get_crawler, get_ftp_content_and_delete, get_gcs_content_and_delete, skip_if_no_boto
...
class FilesPipelineTestCaseCustomSettings(unittest.TestCase):
    ...
    file_cls_attr_settings_map = {('EXPIRES', 'FILES_EXPIRES', 'expires'), ('FILES_URLS_FIELD', 'FILES_URLS_FIELD', 'files_urls_field'), ('FILES_RESULT_FIELD', 'FILES_RESULT_FIELD', 'files_result_field')}
