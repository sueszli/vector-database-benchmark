...
root_config = lambda : {'common': {'interval': None, 'watcher': 'auto'}, 'ext': {'test': {'theme': 'default', 'colorscheme': 'default'}}}
colors_config = lambda : {'colors': {'c1': 1, 'c2': 2}, 'gradients': {}}
colorscheme_config = lambda : {'groups': {'g': {'fg': 'c1', 'bg': 'c2', 'attrs': []}}}
theme_config = lambda : {'segment_data': {'s': {'before': 'b'}}, 'segments': {'left': [{'type': 'string', 'name': 's', 'contents': 't', 'highlight_groups': ['g']}], 'right': []}}
top_theme_config = lambda : {'dividers': {'left': {'hard': '#>', 'soft': '|>'}, 'right': {'hard': '<#', 'soft': '<|'}}, 'spaces': 0}
main_tree = lambda : {'1/config': root_config(), '1/colors': colors_config(), '1/colorschemes/default': colorscheme_config(), '1/themes/test/default': theme_config(), '1/themes/' + UT: top_theme_config(), '1/themes/other1': mdc(top_theme_config(), {'dividers': {'left': {'hard': '!>'}}}), '1/themes/other2': mdc(top_theme_config(), {'dividers': {'left': {'hard': '>>'}}})}
