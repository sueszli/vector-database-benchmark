...
class TestConcat(TestCaffeFunctionBaseMock):
    ...
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Concat', 'bottom': ['x', 'y'], 'top': ['z'], 'concat_param': {'axis': 2}}]}
...
class TestConvolution(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Convolution', 'bottom': ['x'], 'top': ['y'], 'convolution_param': {'kernel_size': [2], 'stride': [3], 'pad': [4], 'group': 3, 'bias_term': True}, 'blobs': [{'num': 6, 'channels': 4, 'data': list(range(96))}, {'data': list(range(6))}]}]}
...
class TestDeconvolution(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Deconvolution', 'bottom': ['x'], 'top': ['y'], 'convolution_param': {'kernel_size': [2], 'stride': [3], 'pad': [4], 'group': 3, 'bias_term': True}, 'blobs': [{'num': 6, 'channels': 4, 'data': list(range(96))}, {'data': list(range(12))}]}]}
...
class TestDropout(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Dropout', 'bottom': ['x'], 'top': ['y'], 'dropout_param': {'dropout_ratio': 0.25}}]}
...
class TestInnerProduct(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'InnerProduct', 'bottom': ['x'], 'top': ['y'], 'inner_product_param': {'bias_term': True, 'axis': 1}, 'blobs': [{'shape': {'dim': [2, 3]}, 'data': list(range(6))}, {'shape': {'dim': [2]}, 'data': list(range(2))}]}]}
...
class TestInnerProductDim4(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'InnerProduct', 'bottom': ['x'], 'top': ['y'], 'inner_product_param': {'bias_term': False, 'axis': 1}, 'blobs': [{'shape': {'dim': [4, 5, 2, 3]}, 'data': list(range(6))}]}]}
...
class TestInnerProductInvalidDim(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'InnerProduct', 'blobs': [{'shape': {'dim': [2, 3, 4, 5, 6]}}]}]}
...
class TestInnerProductNonDefaultAxis(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'InnerProduct', 'inner_product_param': {'axis': 0}}]}
...
class TestLRN(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'LRN', 'bottom': ['x'], 'top': ['y'], 'lrn_param': {'local_size': 4, 'alpha': 0.5, 'beta': 0.25, 'norm_region': 0, 'k': 0.5}}]}
...
class TestLRNWithinChannel(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'LRN', 'lrn_param': {'norm_region': 1}}]}
...
class TestMaxPooling(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Pooling', 'bottom': ['x'], 'top': ['y'], 'pooling_param': {'pool': 0, 'kernel_h': 2, 'kernel_w': 3, 'stride_h': 4, 'stride_w': 5, 'pad_h': 6, 'pad_w': 7}}]}
...
class TestAveragePooling(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Pooling', 'bottom': ['x'], 'top': ['y'], 'pooling_param': {'pool': 1, 'kernel_size': 2, 'stride': 4, 'pad': 6}}]}
...
class TestGlobalPooling(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3, 4)]
    out_shapes = [(3, 2, 3, 4)]
    data = {'layer': [{'name': 'l1', 'type': 'Pooling', 'bottom': ['x'], 'top': ['y'], 'pooling_param': {'pool': 0, 'global_pooling': True}}]}
...
class TestStochasticPooling(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'Pooling', 'pooling_param': {'pool': 2}}]}
...
class TestReLU(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'ReLU', 'bottom': ['x'], 'top': ['y'], 'relu_param': {'negative_slope': 0}}]}
...
class TestLeakyReLU(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'ReLU', 'bottom': ['x'], 'top': ['y'], 'relu_param': {'negative_slope': 0.5}}]}
...
class TestReshape(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [(3, 6)]
    data = {'layer': [{'name': 'l1', 'type': 'Reshape', 'bottom': ['x'], 'top': ['y'], 'reshape_param': {'shape': {'dim': [3, 6]}}}]}
...
class TestBatchNorm(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'BatchNorm', 'bottom': ['x'], 'top': ['y'], 'blobs': [{'shape': {'dim': [3]}, 'data': list(six.moves.range(3))}, {'shape': {'dim': [3]}, 'data': list(six.moves.range(3))}], 'batch_norm_param': {'use_global_stats': False}}]}
...
class TestBatchNormUsingGlobalStats(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'BatchNorm', 'bottom': ['x'], 'top': ['y'], 'blobs': [{'shape': {'dim': [3]}, 'data': list(six.moves.range(3))}, {'shape': {'dim': [3]}, 'data': list(six.moves.range(3))}], 'batch_norm_param': {'use_global_stats': True}}]}
...
class TestEltwiseProd(TestCaffeFunctionBaseMock):
    ...
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Eltwise', 'bottom': ['x1', 'x2', 'x3'], 'top': ['y'], 'eltwise_param': {'operation': 0}}]}
...
class TestEltwiseSum(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Eltwise', 'bottom': ['x1', 'x2', 'x3'], 'top': ['y'], 'eltwise_param': {'operation': 1}}]}
...
class TestEltwiseSumCoeff(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Eltwise', 'bottom': ['x1', 'x2', 'x3'], 'top': ['y'], 'eltwise_param': {'operation': 1, 'coeff': list(six.moves.range(3))}}]}
...
class TestEltwiseSumInvalidCoeff(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Eltwise', 'bottom': ['x1', 'x2', 'x3'], 'top': ['y'], 'eltwise_param': {'operation': 1, 'coeff': list(six.moves.range(2))}}]}
...
class TestEltwiseMax(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Eltwise', 'bottom': ['x1', 'x2', 'x3'], 'top': ['y'], 'eltwise_param': {'operation': 2}}]}
...
class TestScale(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Scale', 'bottom': ['x', 'y'], 'top': ['z'], 'scale_param': {'axis': 0}}]}
...
class TestScaleOneBottom(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Scale', 'bottom': ['x'], 'top': ['y'], 'blobs': [{'shape': {'dim': [2, 3]}, 'data': list(six.moves.range(6))}], 'scale_param': {'axis': 0}}]}
...
class TestScaleWithBias(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3), (2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Scale', 'bottom': ['x', 'y'], 'top': ['z'], 'blobs': [{'shape': {'dim': [2, 3]}, 'data': list(six.moves.range(6))}], 'scale_param': {'axis': 0, 'bias_term': True}}]}
...
class TestScaleOneBottomWithBias(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Scale', 'bottom': ['x'], 'top': ['y'], 'blobs': [{'shape': {'dim': [2, 3]}, 'data': list(six.moves.range(6))}, {'shape': {'dim': [2, 3]}, 'data': list(six.moves.range(6))}], 'scale_param': {'axis': 0, 'bias_term': True}}]}
...
class TestSlice(TestCaffeFunctionBaseMock):
    ...
    data = {'layer': [{'name': 'l1', 'type': 'Slice', 'bottom': ['x'], 'top': ['y1', 'y2'], 'slice_param': {'axis': 1}}]}
...
class TestSliceNoAxis(TestCaffeFunctionBaseMock):
    ...
    data = {'layer': [{'name': 'l1', 'type': 'Slice', 'bottom': ['x'], 'top': ['y1', 'y2'], 'slice_param': {'slice_dim': 0}}]}
...
class TestSliceNoAxisNoSliceDim(TestCaffeFunctionBaseMock):
    ...
    data = {'layer': [{'name': 'l1', 'type': 'Slice', 'bottom': ['x'], 'top': ['y1', 'y2']}]}
...
class TestSliceSlicePoint(TestCaffeFunctionBaseMock):
    ...
    data = {'layer': [{'name': 'l1', 'type': 'Slice', 'bottom': ['x'], 'top': ['y1', 'y2', 'y3'], 'slice_param': {'axis': 1, 'slice_point': [3, 5]}}]}
...
class TestSigmoid(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Sigmoid', 'bottom': ['x'], 'top': ['y']}]}
...
class TestSoftmax(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Softmax', 'bottom': ['x'], 'top': ['y']}]}
...
class TestSoftmaxCaffeEngine(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Softmax', 'softmax_param': {'engine': 1}, 'bottom': ['x'], 'top': ['y']}]}
...
class TestSoftmaxcuDnnEngine(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(2, 3)]
    out_shapes = [(2, 3)]
    data = {'layer': [{'name': 'l1', 'type': 'Softmax', 'softmax_param': {'engine': 2}, 'bottom': ['x'], 'top': ['y']}]}
...
class TestSoftmaxInvalidAxis(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'Softmax', 'softmax_param': {'axis': 0}}]}
...
class TestSoftmaxWithLoss(TestCaffeFunctionBaseMock):
    ...
    in_shapes = [(3, 2, 3)]
    out_shapes = [()]
    data = {'layer': [{'name': 'l1', 'type': 'SoftmaxWithLoss', 'bottom': ['x'], 'top': ['y']}]}
...
class TestSoftmaxWithLossInvalidAxis(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'SoftmaxWithLoss', 'softmax_param': {'axis': 0}}]}
...
class TestSplit(TestCaffeFunctionBase):
    data = {'layer': [{'name': 'l1', 'type': 'Split', 'bottom': ['x'], 'top': ['y', 'z']}]}
