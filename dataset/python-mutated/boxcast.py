...
class BoxCastVideoIE(InfoExtractor):
    _VALID_URL = '(?x)\n        https?://boxcast\\.tv/(?:\n            view-embed/|\n            channel/\\w+\\?(?:[^#]+&)?b=|\n            video-portal/(?:\\w+/){2}\n        )(?P<id>[\\w-]+)'
    _EMBED_REGEX = ['<iframe[^>]+src=["\\\'](?P<url>https?://boxcast\\.tv/view-embed/[\\w-]+)']
    _TESTS = [{'url': 'https://boxcast.tv/view-embed/in-the-midst-of-darkness-light-prevails-an-interdisciplinary-symposium-ozmq5eclj50ujl4bmpwx', 'info_dict': {'id': 'da1eqqgkacngd5djlqld', 'ext': 'mp4', 'thumbnail': 're:https?://uploads\\.boxcast\\.com/(?:[\\w+-]+/){3}.+\\.png$', 'title': 'In the Midst of Darkness Light Prevails: An Interdisciplinary Symposium', 'release_timestamp': 1670686812, 'release_date': '20221210', 'uploader_id': 're8w0v8hohhvpqtbskpe', 'uploader': "Children's Health Defense"}}, {'url': 'https://boxcast.tv/video-portal/vctwevwntun3o0ikq7af/rvyblnn0fxbfjx5nwxhl/otbpltj2kzkveo2qz3ad', 'info_dict': {'id': 'otbpltj2kzkveo2qz3ad', 'ext': 'mp4', 'uploader_id': 'vctwevwntun3o0ikq7af', 'uploader': 'Legacy Christian Church', 'title': "The Quest | 1: Beginner's Bay | Jamie Schools", 'thumbnail': 're:https?://uploads.boxcast.com/(?:[\\w-]+/){3}.+\\.jpg'}}, {'url': 'https://boxcast.tv/channel/z03fqwaeaby5lnaawox2?b=ssihlw5gvfij2by8tkev', 'info_dict': {'id': 'ssihlw5gvfij2by8tkev', 'ext': 'mp4', 'thumbnail': 're:https?://uploads.boxcast.com/(?:[\\w-]+/){3}.+\\.jpg$', 'release_date': '20230101', 'uploader_id': 'ds25vaazhlu4ygcvffid', 'release_timestamp': 1672543201, 'uploader': 'Lighthouse Ministries International  - Beltsville, Maryland', 'description': 'md5:ac23e3d01b0b0be592e8f7fe0ec3a340', 'title': "New Year's Eve CROSSOVER Service at LHMI | December 31, 2022"}}]
    _WEBPAGE_TESTS = [{'url': 'https://childrenshealthdefense.eu/live-stream/', 'info_dict': {'id': 'da1eqqgkacngd5djlqld', 'ext': 'mp4', 'thumbnail': 're:https?://uploads\\.boxcast\\.com/(?:[\\w+-]+/){3}.+\\.png$', 'title': 'In the Midst of Darkness Light Prevails: An Interdisciplinary Symposium', 'release_timestamp': 1670686812, 'release_date': '20221210', 'uploader_id': 're8w0v8hohhvpqtbskpe', 'uploader': "Children's Health Defense"}}]
