...
json2pony_columns = {'category': 'tags', 'name': 'title', 'size': 'size', 'infohash': 'infohash', 'date': 'torrent_date', 'created': 'torrent_date', 'status': 'status', 'torrents': 'num_entries', 'votes': 'votes', 'subscribed': 'subscribed', 'health': 'HEALTH'}
metadata_type_to_search_scope = {'': frozenset((REGULAR_TORRENT, CHANNEL_TORRENT, COLLECTION_NODE)), 'channel': frozenset((CHANNEL_TORRENT, COLLECTION_NODE)), 'torrent': frozenset((REGULAR_TORRENT,)), str(CHANNEL_TORRENT): frozenset((CHANNEL_TORRENT,)), str(REGULAR_TORRENT): frozenset((REGULAR_TORRENT,)), str(COLLECTION_NODE): frozenset((COLLECTION_NODE,))}
