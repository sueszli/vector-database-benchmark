...
from babel.messages.extract import DEFAULT_KEYWORDS, extract, extract_javascript, extract_python
from babel.messages.mofile import write_mo
from babel.messages.pofile import read_po, write_po
from babel.util import pathmatch
from jinja2.ext import babel_extract as extract_jinja2
ROOT = os.path.realpath(os.path.join(os.path.abspath(__file__), '..', '..'))
TEX_DELIMITERS = {'variable_start_string': '<%=', 'variable_end_string': '%>', 'block_start_string': '<%', 'block_end_string': '%>'}
METHOD_MAP = [('**.py', extract_python), ('**/templates/latex/**.tex_t', extract_jinja2), ('**/templates/latex/**.sty_t', extract_jinja2), ('**/themes/**.html', extract_jinja2), ('**/themes/**.xml', extract_jinja2), ('**.js', extract_javascript), ('**.js_t', extract_javascript)]
OPTIONS_MAP = {'**.py': {'encoding': 'utf-8'}, '**/templates/latex/**.tex_t': TEX_DELIMITERS.copy(), '**/templates/latex/**.sty_t': TEX_DELIMITERS.copy(), '**/themes/**.html': {'encoding': 'utf-8', 'ignore_tags': 'script,style', 'include_attrs': 'alt title summary'}}
