...
from ignite.handlers.state_param_scheduler import ExpStateScheduler, LambdaStateScheduler, MultiStepStateScheduler, PiecewiseLinearStateScheduler, StepStateScheduler
...
config3 = (PiecewiseLinearStateScheduler, {'param_name': 'linear_scheduled_param', 'milestones_values': [(3, 12), (5, 10)], 'create_new': True})
config4 = (ExpStateScheduler, {'param_name': 'exp_scheduled_param', 'initial_value': 10, 'gamma': 0.99, 'create_new': True})
config5 = (MultiStepStateScheduler, {'param_name': 'multistep_scheduled_param', 'initial_value': 10, 'gamma': 0.99, 'milestones': [3, 6], 'create_new': True})
...
config6 = (LambdaStateScheduler, {'param_name': 'custom_scheduled_param', 'lambda_obj': LambdaState(initial_value=10, gamma=0.99), 'create_new': True})
config7 = (StepStateScheduler, {'param_name': 'step_scheduled_param', 'initial_value': 10, 'gamma': 0.99, 'step_size': 5, 'create_new': True})
