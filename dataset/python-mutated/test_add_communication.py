...
class MockManager:
    ...
    def setup_stubs(self, error, stop_on, stubber):
        ...
        with self.stub_runner(error, stop_on) as runner:
            runner.add(stubber.stub_add_communication_to_case, self.attachment_set_id, self.case_id)
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_add_communication', 0)])
