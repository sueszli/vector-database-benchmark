...
from ..utils import ExtractorError, clean_html, get_element_by_class, int_or_none, join_nonempty, parse_duration, traverse_obj, unescapeHTML, unified_timestamp, url_or_none, urljoin

class NhkBaseIE(InfoExtractor):
    _API_URL_TEMPLATE = 'https://nwapi.nhk.jp/nhkworld/%sod%slist/v7b/%s/%s/%s/all%s.json'
    _BASE_URL_REGEX = 'https?://www3\\.nhk\\.or\\.jp/nhkworld/(?P<lang>[a-z]{2})/ondemand'
    _TYPE_REGEX = '/(?P<type>video|audio)/'
...
class NhkVodProgramIE(NhkBaseIE):
    _VALID_URL = f'{NhkBaseIE._BASE_URL_REGEX}/program{NhkBaseIE._TYPE_REGEX}(?P<id>\\w+)(?:.+?\\btype=(?P<episode_type>clip|(?:radio|tv)Episode))?'
    _TESTS = [{'url': 'https://www3.nhk.or.jp/nhkworld/en/ondemand/program/video/sumo', 'info_dict': {'id': 'sumo', 'title': 'GRAND SUMO Highlights', 'description': 'md5:fc20d02dc6ce85e4b72e0273aa52fdbf'}, 'playlist_mincount': 0}, {'url': 'https://www3.nhk.or.jp/nhkworld/en/ondemand/program/video/japanrailway', 'info_dict': {'id': 'japanrailway', 'title': 'Japan Railway Journal', 'description': 'md5:ea39d93af7d05835baadf10d1aae0e3f'}, 'playlist_mincount': 12}, {'url': 'https://www3.nhk.or.jp/nhkworld/en/ondemand/program/video/japanrailway/?type=clip', 'info_dict': {'id': 'japanrailway', 'title': 'Japan Railway Journal', 'description': 'md5:ea39d93af7d05835baadf10d1aae0e3f'}, 'playlist_mincount': 5}, {'url': 'https://www3.nhk.or.jp/nhkworld/en/ondemand/program/video/10yearshayaomiyazaki/', 'only_matching': True}, {'url': 'https://www3.nhk.or.jp/nhkworld/en/ondemand/program/audio/listener/', 'only_matching': True}]
...
class NhkForSchoolBangumiIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www2.nhk.or.jp/school/movie/bangumi.cgi?das_id=D0005150191_00000', 'info_dict': {'id': 'D0005150191_00003', 'title': 'にている かな', 'duration': 599.999, 'timestamp': 1396414800, 'upload_date': '20140402', 'ext': 'mp4', 'chapters': 'count:12'}, 'params': {'skip_download': True}}]
...
class NhkForSchoolSubjectIE(InfoExtractor):
    ...
    KNOWN_SUBJECTS = ('rika', 'syakai', 'kokugo', 'sansuu', 'seikatsu', 'doutoku', 'ongaku', 'taiiku', 'zukou', 'gijutsu', 'katei', 'sougou', 'eigo', 'tokkatsu', 'tokushi', 'sonota')
    _VALID_URL = 'https?://www\\.nhk\\.or\\.jp/school/(?P<id>%s)/?(?:[\\?#].*)?$' % '|'.join((re.escape(s) for s in KNOWN_SUBJECTS))
    _TESTS = [{'url': 'https://www.nhk.or.jp/school/sougou/', 'info_dict': {'id': 'sougou', 'title': '総合的な学習の時間'}, 'playlist_mincount': 16}, {'url': 'https://www.nhk.or.jp/school/rika/', 'info_dict': {'id': 'rika', 'title': '理科'}, 'playlist_mincount': 15}]
...
class NhkForSchoolProgramListIE(InfoExtractor):
    _VALID_URL = 'https?://www\\.nhk\\.or\\.jp/school/(?P<id>(?:%s)/[a-zA-Z0-9_-]+)' % '|'.join((re.escape(s) for s in NhkForSchoolSubjectIE.KNOWN_SUBJECTS))
    _TESTS = [{'url': 'https://www.nhk.or.jp/school/sougou/q/', 'info_dict': {'id': 'sougou/q', 'title': 'Ｑ～こどものための哲学'}, 'playlist_mincount': 20}]
...
class NhkRadiruIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.nhk.or.jp/radio/player/ondemand.html?p=0449_01_3853544', 'skip': 'Episode expired on 2023-04-16', 'info_dict': {'channel': 'NHK-FM', 'uploader': 'NHK-FM', 'description': 'md5:94b08bdeadde81a97df4ec882acce3e9', 'ext': 'm4a', 'id': '0449_01_3853544', 'series': 'ジャズ・トゥナイト', 'thumbnail': 'https://www.nhk.or.jp/prog/img/449/g449.jpg', 'timestamp': 1680969600, 'title': 'ジャズ・トゥナイト\u3000ＮＥＷジャズ特集', 'upload_date': '20230408', 'release_timestamp': 1680962400, 'release_date': '20230408', 'was_live': True}}, {'url': 'https://www.nhk.or.jp/radio/ondemand/detail.html?p=0458_01', 'info_dict': {'id': '0458_01', 'title': 'ベストオブクラシック', 'description': '世界中の上質な演奏会をじっくり堪能する本格派クラシック番組。', 'channel': 'NHK-FM', 'uploader': 'NHK-FM', 'thumbnail': 'https://www.nhk.or.jp/prog/img/458/g458.jpg'}, 'playlist_mincount': 3}, {'url': 'https://www.nhk.or.jp/radio/player/ondemand.html?p=F300_06_3738470', 'note': 'Expires on 2024-03-31', 'info_dict': {'id': 'F300_06_3738470', 'ext': 'm4a', 'title': '有島武郎「一房のぶどう」', 'description': '朗読：川野一宇（ラジオ深夜便アンカー）\r\n\r\n（2016年12月8日放送「ラジオ深夜便『アンカー朗読シリーズ』」より）', 'channel': 'NHKラジオ第1、NHK-FM', 'uploader': 'NHKラジオ第1、NHK-FM', 'timestamp': 1635757200, 'thumbnail': 'https://www.nhk.or.jp/radioondemand/json/F300/img/corner/box_109_thumbnail.jpg', 'release_date': '20161207', 'series': 'らじる文庫 by ラジオ深夜便 ', 'release_timestamp': 1481126700, 'upload_date': '20211101'}}, {'url': 'https://www.nhk.or.jp/radio/player/ondemand.html?p=F261_01_3855109', 'skip': 'Expires on 2023-04-17', 'info_dict': {'id': 'F261_01_3855109', 'ext': 'm4a', 'channel': 'NHKラジオ第1', 'uploader': 'NHKラジオ第1', 'timestamp': 1681635900, 'release_date': '20230416', 'series': 'NHKラジオニュース', 'title': '午後６時のNHKニュース', 'thumbnail': 'https://www.nhk.or.jp/radioondemand/json/F261/img/RADIONEWS_640.jpg', 'upload_date': '20230416', 'release_timestamp': 1681635600}}]
...
class NhkRadioNewsPageIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.nhk.or.jp/radionews/', 'playlist_mincount': 5, 'info_dict': {'id': 'F261_01', 'thumbnail': 'https://www.nhk.or.jp/radioondemand/json/F261/img/RADIONEWS_640.jpg', 'description': 'md5:bf2c5b397e44bc7eb26de98d8f15d79d', 'channel': 'NHKラジオ第1', 'uploader': 'NHKラジオ第1', 'title': 'NHKラジオニュース'}}]
...
class NhkRadiruLiveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.nhk.or.jp/radio/player/?ch=r1', 'info_dict': {'id': 'r1-tokyo', 'title': 're:^ＮＨＫネットラジオ第1 東京.+$', 'ext': 'm4a', 'thumbnail': 'https://www.nhk.or.jp/common/img/media/r1-200x200.png', 'live_status': 'is_live'}}, {'url': 'https://www.nhk.or.jp/radio/player/?ch=r2', 'params': {'extractor_args': {'nhkradirulive': {'area': ['fukuoka']}}}, 'info_dict': {'id': 'r2-fukuoka', 'title': 're:^ＮＨＫネットラジオ第2 福岡.+$', 'ext': 'm4a', 'thumbnail': 'https://www.nhk.or.jp/common/img/media/r2-200x200.png', 'live_status': 'is_live'}}, {'url': 'https://www.nhk.or.jp/radio/player/?ch=fm', 'params': {'extractor_args': {'nhkradirulive': {'area': ['sapporo']}}}, 'info_dict': {'id': 'fm-sapporo', 'title': 're:^ＮＨＫネットラジオＦＭ 札幌.+$', 'ext': 'm4a', 'thumbnail': 'https://www.nhk.or.jp/common/img/media/fm-200x200.png', 'live_status': 'is_live'}}]
