...
async def test_args_injection():
    ...
    class ContainerWithArgs(BaseContainer):
        client = providers.Factory(Client, BaseContainer.resource1, BaseContainer.resource2)
        service = providers.Factory(Service, client)
...
async def test_args_kwargs_injection():
    ...
    class ContainerWithArgsAndKwArgs(BaseContainer):
        client = providers.Factory(Client, BaseContainer.resource1, resource2=BaseContainer.resource2)
...
async def test_injection_error():
    ...
    class Container(containers.DeclarativeContainer):
        ...
        client = providers.Factory(Client, resource1=resource_with_error, resource2=None)
    container = Container()
...
async def test_injection_runtime_error_async_provides():
    ...
    class Container(BaseContainer):
        client = providers.Factory(create_client, resource1=BaseContainer.resource1, resource2=None)
    container = Container()
    with raises(Exception, match='Something went wrong'):
        await container.client()
...
async def test_attributes_injection():
    ...
    class ContainerWithAttributes(BaseContainer):
        client = providers.Factory(Client, BaseContainer.resource1, resource2=None)
        client.add_attributes(resource2=BaseContainer.resource2)
        service = providers.Factory(Service, client=None)
...
async def test_attributes_injection_attribute_error():
    ...
    class Container(BaseContainer):
        client = providers.Factory(ClientWithException, resource1=BaseContainer.resource1, resource2=BaseContainer.resource2)
...
async def test_attributes_injection_runtime_error():
    ...
    class Container(containers.DeclarativeContainer):
        resource = providers.Resource(init_resource)
        client = providers.Factory(Client, resource1=None, resource2=None)
