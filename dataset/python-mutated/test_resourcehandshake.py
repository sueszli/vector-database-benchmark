...
from golem.appconfig import DEFAULT_HYPERDRIVE_RPC_PORT, DEFAULT_HYPERDRIVE_RPC_ADDRESS
...
from golem.resource.resourcehandshake import ResourceHandshake, ResourceHandshakeSessionMixin
