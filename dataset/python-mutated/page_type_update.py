...
class PageTypeUpdateInput(PageTypeCreateInput):
    remove_attributes = NonNullList(graphene.ID, description='List of attribute IDs to be assigned to the page type.')
...
class PageTypeUpdate(PageTypeMixin, ModelMutation):
    ...
    class Arguments:
        ...
        input = PageTypeUpdateInput(description='Fields required to update page type.', required=True)
