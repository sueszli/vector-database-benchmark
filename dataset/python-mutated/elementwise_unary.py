...
class clip(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(x=ScalarOrTensorInputType(), alpha=FloatInputType(const=True), beta=FloatInputType(const=True))
...
class threshold(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(x=ScalarOrTensorInputType(), alpha=FloatInputType(const=True))
...
class cast(Operation):
    ...
    """
    input_spec = InputSpec(x=ScalarOrTensorInputType(), dtype=StringInputType(const=True))
