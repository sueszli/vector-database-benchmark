...
from modelscope.models.audio.sv.DTDNN_layers import BasicResBlock, CAMDenseTDNNBlock, DenseLayer, StatsPool, TDNNLayer, TransitLayer, get_nonlinear
...
@MODELS.register_module(Tasks.speaker_verification, module_name=Models.campplus_sv)
