...
import tomli
from dagster._core.host_representation.origin import CodeLocationOrigin, GrpcServerCodeLocationOrigin, ManagedGrpcPythonEnvCodeLocationOrigin
from .load import location_origin_from_module_name, location_origin_from_package_name, location_origin_from_python_file, location_origins_from_yaml_paths
...
class CompositeTarget(NamedTuple('CompositeTarget', [('targets', Sequence[WorkspaceLoadTarget])]), WorkspaceLoadTarget):
...
class WorkspaceFileTarget(NamedTuple('WorkspaceFileTarget', [('paths', Sequence[str])]), WorkspaceLoadTarget):
...
class PythonFileTarget(NamedTuple('PythonFileTarget', [('python_file', str), ('attribute', Optional[str]), ('working_directory', Optional[str]), ('location_name', Optional[str])]), WorkspaceLoadTarget):
...
class ModuleTarget(NamedTuple('ModuleTarget', [('module_name', str), ('attribute', Optional[str]), ('working_directory', Optional[str]), ('location_name', Optional[str])]), WorkspaceLoadTarget):
...
class PackageTarget(NamedTuple('ModuleTarget', [('package_name', str), ('attribute', Optional[str]), ('working_directory', Optional[str]), ('location_name', Optional[str])]), WorkspaceLoadTarget):
...
class GrpcServerTarget(NamedTuple('ModuleTarget', [('host', str), ('port', Optional[int]), ('socket', Optional[str]), ('location_name', Optional[str])]), WorkspaceLoadTarget):
