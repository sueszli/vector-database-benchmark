...
class WeChatLiving(BaseWeChatAPI):
    ...
    def create(self, anchor_userid: str, theme: str, living_start: int, living_duration: int, type: int=0, description: str=None, agentid: int=None, remind_time: int=0, activity_cover_mediaid: str=None, activity_share_mediaid: str=None, activity_detail: Dict=None):
        if False:
            for i in range(10):
                print('nop')
        ...
        data = optionaldict(anchor_userid=anchor_userid, theme=theme, living_start=living_start, living_duration=living_duration, type=type, description=description, agentid=agentid, remind_time=remind_time, activity_cover_mediaid=activity_cover_mediaid, activity_share_mediaid=activity_share_mediaid, activity_detail=activity_detail)
        return self._post('living/create', data=data)

    def modify(self, livingid: str, theme: str=None, living_start: int=None, living_duration: int=None, type: int=None, description: str=None, remind_time: int=0):
        if False:
            print('Hello World!')
        ...
        data = optionaldict(livingid=livingid, theme=theme, living_start=living_start, living_duration=living_duration, type=type, description=description, remind_time=remind_time)
    ...
    def cancel(self, livingid: str):
        ...
        data = optionaldict(livingid=livingid)
    ...
    def get_living_code(self, livingid: str, openid: str):
        ...
        data = optionaldict(livingid=livingid, openid=openid)
    ...
    def get_watch_stat(self, livingid: str, next_key: str='0'):
        ...
        data = optionaldict(livingid=livingid, next_key=next_key)
    ...
    def get_living_share_info(self, ww_share_code: str):
        ...
        data = optionaldict(ww_share_code=ww_share_code)
