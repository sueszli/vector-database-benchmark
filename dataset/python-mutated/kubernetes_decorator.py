...
from metaflow.metaflow_config import DATASTORE_LOCAL_DIR, KUBERNETES_CONTAINER_IMAGE, KUBERNETES_CONTAINER_REGISTRY, KUBERNETES_FETCH_EC2_METADATA, KUBERNETES_IMAGE_PULL_POLICY, KUBERNETES_GPU_VENDOR, KUBERNETES_NAMESPACE, KUBERNETES_NODE_SELECTOR, KUBERNETES_PERSISTENT_VOLUME_CLAIMS, KUBERNETES_TOLERATIONS, KUBERNETES_SERVICE_ACCOUNT
...
class KubernetesDecorator(StepDecorator):
    ...
    """
    name = 'kubernetes'
    defaults = {'cpu': '1', 'memory': '4096', 'disk': '10240', 'image': None, 'image_pull_policy': None, 'service_account': None, 'secrets': None, 'node_selector': None, 'namespace': None, 'gpu': None, 'gpu_vendor': None, 'tolerations': None, 'use_tmpfs': None, 'tmpfs_tempdir': True, 'tmpfs_size': None, 'tmpfs_path': '/metaflow_temp', 'persistent_volume_claims': None}
    package_url = None
    package_sha = None
    run_time_limit = None
