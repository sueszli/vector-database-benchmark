...
@unittest.skipIf(not core.is_compiled_with_cuda() or core.is_compiled_with_rocm(), 'core is not compiled with CUDA')
...
create_test_act_fp16_class(TestExpFp32_Prim, check_prim=True, enable_cinn=True, check_prim_pir=True)
create_test_act_fp16_class(TestExpm1)
create_test_act_fp16_class(TestSigmoid, check_prim=True, enable_cinn=True, check_pir=True)
create_test_act_fp16_class(TestSilu, check_prim=True, enable_cinn=True, check_prim_pir=True)
create_test_act_fp16_class(TestLogSigmoid)
create_test_act_fp16_class(TestTanh, check_prim=True, check_prim_pir=True, enable_cinn=True)
...
create_test_act_fp16_class(TestSqrt, check_prim=True, enable_cinn=True, check_pir=True, check_prim_pir=True)
create_test_act_fp16_class(TestSqrtComp, check_prim=True, enable_cinn=True, check_pir=True, check_prim_pir=True)
create_test_act_fp16_class(TestAbs, check_prim=True, enable_cinn=True, check_pir=True)
create_test_act_fp16_class(TestCeil, grad_check=False, check_pir=True)
create_test_act_fp16_class(TestFloor, check_prim=True, grad_check=False, enable_cinn=True, check_pir=True)
...
create_test_act_fp16_class(TestRelu, check_prim=True, enable_cinn=True, check_pir=True, check_prim_pir=True)
create_test_act_fp16_class(TestGelu, check_prim=True, check_prim_pir=True, check_pir=True, enable_cinn=True, rev_comp_rtol=0.001, rev_comp_atol=0.001, cinn_rtol=0.001, cinn_atol=0.001)
...
create_test_act_fp16_class(TestLeakyRelu, check_prim=True, enable_cinn=True, check_pir=True)
create_test_act_fp16_class(TestLeakyReluAlpha1, check_prim=True, enable_cinn=True)
create_test_act_fp16_class(TestLeakyReluAlpha2, check_prim=True, enable_cinn=True)
create_test_act_fp16_class(TestLeakyReluAlpha3, check_prim=True, enable_cinn=True)
create_test_act_fp16_class(TestLeakyRelu_ZeroDim, check_prim=True)
create_test_act_fp16_class(TestRsqrt, check_prim=True, enable_cinn=True, check_pir=True, check_prim_pir=True)
...
create_test_act_bf16_class(TestSqrt, check_prim=True, check_pir=True, check_prim_pir=True)
create_test_act_bf16_class(TestSqrtComp, check_prim=True, check_pir=True, check_prim_pir=True)
...
create_test_act_bf16_class(TestFloor, grad_check=False, check_prim=True, check_pir=True)
...
create_test_act_bf16_class(TestRelu, check_prim=True, check_pir=True, check_prim_pir=True)
create_test_act_bf16_class(TestGelu, check_prim=True, check_pir=True, rev_comp_rtol=0.01, rev_comp_atol=0.01, cinn_rtol=0.01, cinn_atol=0.01)
...
create_test_act_bf16_class(TestRsqrt, check_prim=True, check_pir=True, check_prim_pir=True)
