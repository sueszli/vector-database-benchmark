...
import sys
ops_modules = {'nvidia.dali.ops': nvidia.dali.ops, 'nvidia.dali.plugin.pytorch': nvidia.dali.plugin.pytorch, 'nvidia.dali.plugin.numba.experimental': nvidia.dali.plugin.numba.experimental}
module_mapping = {'nvidia.dali.plugin.pytorch': 'nvidia.dali.plugin.pytorch.fn', 'nvidia.dali.plugin.numba.experimental': 'nvidia.dali.plugin.numba.fn.experimental'}
removed_ops = ['Compose']
cpu_ops = ops.cpu_ops()
gpu_ops = ops.gpu_ops()
