...
from .utils import ANGLE_TO_RADIANS, LENGTH_UNITS, LENGTHS_TO_PIXELS, check_var_function, safe_urljoin
from .validation.properties import PROPERTIES
ZERO_PIXELS = Dimension(0, 'px')
FONT_SIZE_KEYWORDS = OrderedDict(((name, INITIAL_VALUES['font_size'] * a / b) for (name, a, b) in (('xx-small', 3, 5), ('x-small', 3, 4), ('small', 8, 9), ('medium', 1, 1), ('large', 6, 5), ('x-large', 3, 2), ('xx-large', 2, 1))))
BORDER_WIDTH_KEYWORDS = {'thin': 1, 'medium': 3, 'thick': 5}
assert INITIAL_VALUES['border_top_width'] == BORDER_WIDTH_KEYWORDS['medium']
FONT_WEIGHT_RELATIVE = dict(bolder={100: 400, 200: 400, 300: 400, 400: 700, 500: 700, 600: 900, 700: 900, 800: 900, 900: 900}, lighter={100: 100, 200: 100, 300: 100, 400: 100, 500: 100, 600: 400, 700: 400, 800: 700, 900: 700})
PAGE_SIZES = {'a10': (Dimension(26, 'mm'), Dimension(37, 'mm')), 'a9': (Dimension(37, 'mm'), Dimension(52, 'mm')), 'a8': (Dimension(52, 'mm'), Dimension(74, 'mm')), 'a7': (Dimension(74, 'mm'), Dimension(105, 'mm')), 'a6': (Dimension(105, 'mm'), Dimension(148, 'mm')), 'a5': (Dimension(148, 'mm'), Dimension(210, 'mm')), 'a4': (Dimension(210, 'mm'), Dimension(297, 'mm')), 'a3': (Dimension(297, 'mm'), Dimension(420, 'mm')), 'a2': (Dimension(420, 'mm'), Dimension(594, 'mm')), 'a1': (Dimension(594, 'mm'), Dimension(841, 'mm')), 'a0': (Dimension(841, 'mm'), Dimension(1189, 'mm')), 'b10': (Dimension(31, 'mm'), Dimension(44, 'mm')), 'b9': (Dimension(44, 'mm'), Dimension(62, 'mm')), 'b8': (Dimension(62, 'mm'), Dimension(88, 'mm')), 'b7': (Dimension(88, 'mm'), Dimension(125, 'mm')), 'b6': (Dimension(125, 'mm'), Dimension(176, 'mm')), 'b5': (Dimension(176, 'mm'), Dimension(250, 'mm')), 'b4': (Dimension(250, 'mm'), Dimension(353, 'mm')), 'b3': (Dimension(353, 'mm'), Dimension(500, 'mm')), 'b2': (Dimension(500, 'mm'), Dimension(707, 'mm')), 'b1': (Dimension(707, 'mm'), Dimension(1000, 'mm')), 'b0': (Dimension(1000, 'mm'), Dimension(1414, 'mm')), 'c10': (Dimension(28, 'mm'), Dimension(40, 'mm')), 'c9': (Dimension(40, 'mm'), Dimension(57, 'mm')), 'c8': (Dimension(57, 'mm'), Dimension(81, 'mm')), 'c7': (Dimension(81, 'mm'), Dimension(114, 'mm')), 'c6': (Dimension(114, 'mm'), Dimension(162, 'mm')), 'c5': (Dimension(162, 'mm'), Dimension(229, 'mm')), 'c4': (Dimension(229, 'mm'), Dimension(324, 'mm')), 'c3': (Dimension(324, 'mm'), Dimension(458, 'mm')), 'c2': (Dimension(458, 'mm'), Dimension(648, 'mm')), 'c1': (Dimension(648, 'mm'), Dimension(917, 'mm')), 'c0': (Dimension(917, 'mm'), Dimension(1297, 'mm')), 'jis-b10': (Dimension(32, 'mm'), Dimension(45, 'mm')), 'jis-b9': (Dimension(45, 'mm'), Dimension(64, 'mm')), 'jis-b8': (Dimension(64, 'mm'), Dimension(91, 'mm')), 'jis-b7': (Dimension(91, 'mm'), Dimension(128, 'mm')), 'jis-b6': (Dimension(128, 'mm'), Dimension(182, 'mm')), 'jis-b5': (Dimension(182, 'mm'), Dimension(257, 'mm')), 'jis-b4': (Dimension(257, 'mm'), Dimension(364, 'mm')), 'jis-b3': (Dimension(364, 'mm'), Dimension(515, 'mm')), 'jis-b2': (Dimension(515, 'mm'), Dimension(728, 'mm')), 'jis-b1': (Dimension(728, 'mm'), Dimension(1030, 'mm')), 'jis-b0': (Dimension(1030, 'mm'), Dimension(1456, 'mm')), 'letter': (Dimension(8.5, 'in'), Dimension(11, 'in')), 'legal': (Dimension(8.5, 'in'), Dimension(14, 'in')), 'ledger': (Dimension(11, 'in'), Dimension(17, 'in'))}
for (w, h) in PAGE_SIZES.values():
    assert w.value < h.value
INITIAL_PAGE_SIZE = PAGE_SIZES['a4']
INITIAL_VALUES['size'] = tuple((d.value * LENGTHS_TO_PIXELS[d.unit] for d in INITIAL_PAGE_SIZE))
