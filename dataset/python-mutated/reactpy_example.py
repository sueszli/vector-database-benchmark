...
from docs_app.examples import SOURCE_DIR, get_example_files_by_name, get_normalized_example_name
...
class WidgetExample(SphinxDirective):
    ...
    _next_id = 0
    option_spec: ClassVar[dict[str, Any]] = {'result-is-default-tab': directives.flag, 'activate-button': directives.flag}
