...
class WxPandaShell(WxAppShell):
    ...
    MENU_TEXTS: dict[int, tuple[str, str | None]] = {ID_FOUR_VIEW: ('Four Views', None), ID_TOP_VIEW: ('Top View', None), ID_FRONT_VIEW: ('Front View', None), ID_LEFT_VIEW: ('Left View', None), ID_PERSP_VIEW: ('Persp View', None)}
