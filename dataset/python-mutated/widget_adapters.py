...
class WidgetAdapter(Adapter):
    ...
    def js_args(self, widget):
        if False:
            for i in range(10):
                print('nop')
        return [widget.render('__NAME__', None, attrs={'id': '__ID__'}), widget.id_for_label('__ID__')]
    ...
    def media(self):
        if False:
            i = 10
            return i + 15
        return forms.Media(js=[versioned_static('wagtailadmin/js/telepath/widgets.js')])
