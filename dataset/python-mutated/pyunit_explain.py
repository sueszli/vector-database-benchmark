...
pyunit_utils.run_tests([test_get_xy, test_varimp, test_explanation_single_model_regression, test_explanation_automl_regression, test_explanation_list_of_models_regression, test_explanation_single_model_binomial_classification, test_explanation_automl_binomial_classification, test_explanation_list_of_models_binomial_classification, test_explanation_single_model_multinomial_classification, test_explanation_automl_multinomial_classification, test_explanation_list_of_models_multinomial_classification, test_learning_curve_for_algos_not_present_in_automl, test_explanation_timeseries, test_explanation_automl_pareto_front, test_explanation_grid_pareto_front, test_explanation_some_dataframe_pareto_front, test_pareto_front_corner_cases, test_pd_plot_row_value, test_fairness_plots, test_shap_plots_with_background_frame, test_include_exclude_validation])