...
@testing.parameterize(*testing.product({'dtype': [numpy.float32, numpy.int32]}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float32, numpy.int32], 'label_dtype': [numpy.float32, numpy.int32]}))
@unittest.skipUnless(image_dataset.available, 'image_dataset is not available')
