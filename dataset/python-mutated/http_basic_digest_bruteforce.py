...
class Exploit(HTTPClient):
    __info__ = {'name': 'HTTP Basic/Digest Bruteforce', 'description': 'Module performs bruteforce attack against HTTP Basic/Digest Auth service. If valid credentials are found, they are displayed to the user.', 'authors': ('Marcin Bury <marcin[at]threat9.com>', 'Alexander Yakovlev <https://github.com/toxydose>'), 'devices': ('Multiple devices',)}
