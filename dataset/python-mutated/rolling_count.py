...
from featuretools.primitives.standard.transform.time_series.utils import apply_rolling_agg_to_series
...
class RollingCount(TransformPrimitive):
    ...
    def get_function(self):
        ...
        def rolling_count(datetime):
            ...
            return apply_rolling_agg_to_series(x, lambda series: series.count(), self.window_length, self.gap, self.min_periods, ignore_window_nans=True)
