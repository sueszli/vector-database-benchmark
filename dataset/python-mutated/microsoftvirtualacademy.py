...
class MicrosoftVirtualAcademyIE(MicrosoftVirtualAcademyBaseIE):
    ...
    _VALID_URL = '(?:%s:|https?://(?:mva\\.microsoft|(?:www\\.)?microsoftvirtualacademy)\\.com/[^/]+/training-courses/[^/?#&]+-)(?P<course_id>\\d+)(?::|\\?l=)(?P<id>[\\da-zA-Z]+_\\d+)' % IE_NAME
    _TESTS = [{'url': 'https://mva.microsoft.com/en-US/training-courses/microsoft-azure-fundamentals-virtual-machines-11788?l=gfVXISmEB_6804984382', 'md5': '7826c44fc31678b12ad8db11f6b5abb9', 'info_dict': {'id': 'gfVXISmEB_6804984382', 'ext': 'mp4', 'title': 'Course Introduction', 'formats': 'mincount:3', 'subtitles': {'en': [{'ext': 'ttml'}]}}}, {'url': 'mva:11788:gfVXISmEB_6804984382', 'only_matching': True}]
...
class MicrosoftVirtualAcademyCourseIE(MicrosoftVirtualAcademyBaseIE):
    ...
    _VALID_URL = '(?:%s:|https?://(?:mva\\.microsoft|(?:www\\.)?microsoftvirtualacademy)\\.com/[^/]+/training-courses/(?P<display_id>[^/?#&]+)-)(?P<id>\\d+)' % IE_NAME
    _TESTS = [{'url': 'https://mva.microsoft.com/en-US/training-courses/microsoft-azure-fundamentals-virtual-machines-11788', 'info_dict': {'id': '11788', 'title': 'Microsoft Azure Fundamentals: Virtual Machines'}, 'playlist_count': 36}, {'url': 'https://mva.microsoft.com/en-US/training-courses/developing-windows-10-games-with-construct-2-16335', 'info_dict': {'id': '16335', 'title': 'Developing Windows 10 Games with Construct 2'}, 'playlist_count': 10}, {'url': 'https://www.microsoftvirtualacademy.com/en-US/training-courses/microsoft-azure-fundamentals-virtual-machines-11788', 'only_matching': True}, {'url': 'mva:course:11788', 'only_matching': True}]
