...
def spalde(x, tck):
    ...
    if parametric:
        ...
        raise TypeError('Unknown error')
_surfit_cache = {'tx': array([], float), 'ty': array([], float), 'wrk': array([], float), 'iwrk': array([], dfitpack_int)}
