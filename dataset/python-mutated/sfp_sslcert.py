...
class sfp_sslcert(SpiderFootPlugin):
    meta = {'name': 'SSL Certificate Analyzer', 'summary': "Gather information about SSL certificates used by the target's HTTPS sites.", 'flags': [], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Crawling and Scanning']}
    opts = {'tryhttp': True, 'verify': True, 'ssltimeout': 10, 'certexpiringdays': 30}
    optdescs = {'tryhttp': 'Also try to HTTPS-connect to HTTP sites and hostnames.', 'verify': 'Verify certificate subject alternative names resolve.', 'ssltimeout': 'Seconds before giving up trying to HTTPS connect.', 'certexpiringdays': 'Number of days in the future a certificate expires to consider it as expiring.'}
    results = None
