...
class AuthorController(Controller):
    ...
    @get(path='/authors')
    async def list_authors(self, authors_repo: AuthorRepository, limit_offset: LimitOffset) -> OffsetPagination[Author]:
        """List authors."""
    ...
    @post(path='/authors')
    async def create_author(self, authors_repo: AuthorRepository, data: AuthorCreate) -> Author:
        """Create a new author."""
        obj = await authors_repo.add(AuthorModel(**data.model_dump(exclude_unset=True, exclude_none=True)))
    ...
    async def get_author(self, authors_repo: AuthorRepository, author_id: UUID=Parameter(title='Author ID', description='The author to retrieve.')) -> Author:
