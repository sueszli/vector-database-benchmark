...
class PresentationWithChart(BaseCase):
    ...
    def test_seleniumbase_chart(self):
        ...
        self.add_slide('<p><b>The End</b></p>', image='https://seleniumbase.io/cdn/img/sb_logo_g.png')
