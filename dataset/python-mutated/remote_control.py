...
from typing import TYPE_CHECKING, Any, Dict, FrozenSet, Iterable, Iterator, List, Optional, Sequence, Tuple, Union, cast
from .cli import parse_args
from .cli_stub import RCOptions
from .constants import RC_ENCRYPTION_PROTOCOL_VERSION, appname, version
from .fast_data_types import AES256GCMDecrypt, AES256GCMEncrypt, EllipticCurveKey, get_boss, get_options, read_command_response, send_data_to_peer
...
cli_msg = 'Control {appname} by sending it commands. Set the :opt:`allow_remote_control` option in :file:`kitty.conf` or use a password, for this to work.'.format(appname=appname)
