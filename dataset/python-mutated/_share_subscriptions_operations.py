...
from ...operations._share_subscriptions_operations import build_cancel_synchronization_request, build_create_request, build_delete_request, build_get_request, build_list_by_account_request, build_list_source_share_synchronization_settings_request, build_list_synchronization_details_request, build_list_synchronizations_request, build_synchronize_request
...
class ShareSubscriptionsOperations:
    ...
    async def _cancel_synchronization_initial(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription_synchronization: Union[_models.ShareSubscriptionSynchronization, IO], **kwargs: Any) -> _models.ShareSubscriptionSynchronization:
        ...
        request = build_cancel_synchronization_request(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self._cancel_synchronization_initial.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def begin_cancel_synchronization(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription_synchronization: _models.ShareSubscriptionSynchronization, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
    ...
    @overload
    async def begin_cancel_synchronization(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription_synchronization: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
        """Request cancellation of a data share snapshot.
    ...
    async def begin_cancel_synchronization(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription_synchronization: Union[_models.ShareSubscriptionSynchronization, IO], **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
        """Request cancellation of a data share snapshot.
        ...
        if cont_token is None:
            raw_result = await self._cancel_synchronization_initial(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, share_subscription_synchronization=share_subscription_synchronization, api_version=api_version, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
        ...
        def get_long_running_output(pipeline_response):
            ...
            return deserialized
        if polling is True:
            polling_method = cast(AsyncPollingMethod, AsyncARMPolling(lro_delay, lro_options={'final-state-via': 'azure-async-operation'}, **kwargs))
    ...
    async def _synchronize_initial(self, resource_group_name: str, account_name: str, share_subscription_name: str, synchronize: Union[_models.Synchronize, IO], **kwargs: Any) -> _models.ShareSubscriptionSynchronization:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        ...
        request = build_synchronize_request(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self._synchronize_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def begin_synchronize(self, resource_group_name: str, account_name: str, share_subscription_name: str, synchronize: _models.Synchronize, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
    ...
    @overload
    async def begin_synchronize(self, resource_group_name: str, account_name: str, share_subscription_name: str, synchronize: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
        """Initiate an asynchronous data share job.
    ...
    @distributed_trace_async
    async def begin_synchronize(self, resource_group_name: str, account_name: str, share_subscription_name: str, synchronize: Union[_models.Synchronize, IO], **kwargs: Any) -> AsyncLROPoller[_models.ShareSubscriptionSynchronization]:
        """Initiate an asynchronous data share job.
        ...
        cont_token = kwargs.pop('continuation_token', None)
        if cont_token is None:
            raw_result = await self._synchronize_initial(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, synchronize=synchronize, api_version=api_version, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
        kwargs.pop('error_map', None)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, account_name: str, share_subscription_name: str, **kwargs: Any) -> _models.ShareSubscription:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def create(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription: _models.ShareSubscription, *, content_type: str='application/json', **kwargs: Any) -> _models.ShareSubscription:
    ...
    @overload
    async def create(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ShareSubscription:
        """Create shareSubscription in an account.
    ...
    @distributed_trace_async
    async def create(self, resource_group_name: str, account_name: str, share_subscription_name: str, share_subscription: Union[_models.ShareSubscription, IO], **kwargs: Any) -> _models.ShareSubscription:
        """Create shareSubscription in an account.
        ...
        request = build_create_request(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def _delete_initial(self, resource_group_name: str, account_name: str, share_subscription_name: str, **kwargs: Any) -> Optional[_models.OperationResponse]:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = kwargs.pop('headers', {}) or {}
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self._delete_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def begin_delete(self, resource_group_name: str, account_name: str, share_subscription_name: str, **kwargs: Any) -> AsyncLROPoller[_models.OperationResponse]:
        ...
        cont_token = kwargs.pop('continuation_token', None)
        if cont_token is None:
            raw_result = await self._delete_initial(resource_group_name=resource_group_name, account_name=account_name, share_subscription_name=share_subscription_name, api_version=api_version, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
        kwargs.pop('error_map', None)
