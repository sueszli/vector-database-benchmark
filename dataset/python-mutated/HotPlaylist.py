...
try:
    ...
    from PyQt5.QtWidgets import QAbstractSlider, QApplication, QListWidget, QListWidgetItem
except ImportError:
    from PySide2.QtCore import QTimer, QUrl
    from PySide2.QtNetwork import QNetworkAccessManager, QNetworkRequest
    from PySide2.QtSvg import QSvgWidget
    from PySide2.QtWidgets import QAbstractSlider, QApplication, QListWidget, QListWidgetItem
