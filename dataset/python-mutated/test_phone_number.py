...
class TestArAe:
    ...
    cellphone_pattern: str = '(?:\\+|00)971\\s?5[024568]\\s?\\d{3}\\s?\\d{4}|05[024568]\\s?\\d{3}\\s?\\d{4}'
    telephone_pattern: str = '(?:\\+|00)971\\s?[1234679]\\s?\\d{3}\\s?\\d{4}|0[1234679]\\s?\\d{3}\\s?\\d{4}'
    toll_pattern: str = '200\\d{4}|600\\d{6}|800\\d{3,7}'
    service_phone_pattern: str = '9(?:9(?:9|8|7|6|1)|01|22)'
