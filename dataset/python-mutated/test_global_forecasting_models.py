...
try:
    import torch
    from darts.models import BlockRNNModel, DLinearModel, NBEATSModel, NLinearModel, RNNModel, TCNModel, TFTModel, TiDEModel, TransformerModel
    from darts.models.forecasting.torch_forecasting_model import DualCovariatesTorchModel, MixedCovariatesTorchModel, PastCovariatesTorchModel
...
if TORCH_AVAILABLE:
    IN_LEN = 24
    OUT_LEN = 12
    models_cls_kwargs_errs = [(BlockRNNModel, {'model': 'RNN', 'hidden_dim': 10, 'n_rnn_layers': 1, 'batch_size': 32, 'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 180.0), (RNNModel, {'model': 'RNN', 'hidden_dim': 10, 'batch_size': 32, 'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 180.0), (RNNModel, {'training_length': 12, 'n_epochs': 10, 'likelihood': GaussianLikelihood(), 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 80.0), (TCNModel, {'n_epochs': 10, 'batch_size': 32, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 240.0), (TransformerModel, {'d_model': 16, 'nhead': 2, 'num_encoder_layers': 2, 'num_decoder_layers': 2, 'dim_feedforward': 16, 'batch_size': 32, 'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 180.0), (NBEATSModel, {'num_stacks': 4, 'num_blocks': 1, 'num_layers': 2, 'layer_widths': 12, 'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 180.0), (TFTModel, {'hidden_size': 16, 'lstm_layers': 1, 'num_attention_heads': 4, 'add_relative_index': True, 'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 100.0), (NLinearModel, {'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 100), (DLinearModel, {'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 100), (TiDEModel, {'n_epochs': 10, 'pl_trainer_kwargs': tfm_kwargs['pl_trainer_kwargs']}, 100)]
