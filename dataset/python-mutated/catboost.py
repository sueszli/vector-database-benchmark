...
class CatBoostModel(state.HasState):
    ...
    prediction_type = traitlets.Enum(values=['Probability', 'Class', 'RawFormulaVal'], default_value='Probability', help='The form of the predictions. Can be "RawFormulaVal", "Probability" or "Class".')
    ...
    ctr_merge_policy = traitlets.Enum(values=['FailIfCtrsIntersects', 'LeaveMostDiversifiedTable', 'IntersectingCountersAverage'], default_value='IntersectingCountersAverage', help='Strategy for summing up models. Only used when training in batches. See the CatBoost documentation for more info.')
