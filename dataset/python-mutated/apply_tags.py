...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--tags-dir', required=True, type=Path, help='Directory with saved tags file')
    arg_parser.add_argument('--platform', required=True, type=str, choices=['x86_64', 'aarch64', 'arm64'], help='Image platform')
    ...
    apply_tags(args.short_image_name, args.registry, args.owner, args.tags_dir, args.platform)