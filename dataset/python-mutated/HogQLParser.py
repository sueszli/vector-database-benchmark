...
class HogQLParser(Parser):
    ...
    literalNames = ['<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', "'false'", "'true'", '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', '<INVALID>', "'->'", "'*'", "'`'", "'\\'", "':'", "','", "'||'", "'-'", "'$'", "'.'", "'=='", "'='", "'>='", "'>'", "'#'", "'~*'", "'=~*'", "'{'", "'['", "'('", "'<='", "'<'", '<INVALID>', "'!~*'", "'!~'", "'??'", "'%'", "'+'", "'?'", '\'"\'', "'''", "'~'", "'=~'", "'}'", "']'", "')'", "';'", "'/'", "'_'"]
    symbolicNames = ['<INVALID>', 'ADD', 'AFTER', 'ALIAS', 'ALL', 'ALTER', 'AND', 'ANTI', 'ANY', 'ARRAY', 'AS', 'ASCENDING', 'ASOF', 'AST', 'ASYNC', 'ATTACH', 'BETWEEN', 'BOTH', 'BY', 'CASE', 'CAST', 'CHECK', 'CLEAR', 'CLUSTER', 'CODEC', 'COHORT', 'COLLATE', 'COLUMN', 'COMMENT', 'CONSTRAINT', 'CREATE', 'CROSS', 'CUBE', 'CURRENT', 'DATABASE', 'DATABASES', 'DATE', 'DAY', 'DEDUPLICATE', 'DEFAULT', 'DELAY', 'DELETE', 'DESC', 'DESCENDING', 'DESCRIBE', 'DETACH', 'DICTIONARIES', 'DICTIONARY', 'DISK', 'DISTINCT', 'DISTRIBUTED', 'DROP', 'ELSE', 'END', 'ENGINE', 'EVENTS', 'EXISTS', 'EXPLAIN', 'EXPRESSION', 'EXTRACT', 'FETCHES', 'FINAL', 'FIRST', 'FLUSH', 'FOLLOWING', 'FOR', 'FORMAT', 'FREEZE', 'FROM', 'FULL', 'FUNCTION', 'GLOBAL', 'GRANULARITY', 'GROUP', 'HAVING', 'HIERARCHICAL', 'HOUR', 'ID', 'IF', 'ILIKE', 'IN', 'INDEX', 'INF', 'INJECTIVE', 'INNER', 'INSERT', 'INTERVAL', 'INTO', 'IS', 'IS_OBJECT_ID', 'JOIN', 'KEY', 'KILL', 'LAST', 'LAYOUT', 'LEADING', 'LEFT', 'LIFETIME', 'LIKE', 'LIMIT', 'LIVE', 'LOCAL', 'LOGS', 'MATERIALIZE', 'MATERIALIZED', 'MAX', 'MERGES', 'MIN', 'MINUTE', 'MODIFY', 'MONTH', 'MOVE', 'MUTATION', 'NAN_SQL', 'NO', 'NOT', 'NULL_SQL', 'NULLS', 'OFFSET', 'ON', 'OPTIMIZE', 'OR', 'ORDER', 'OUTER', 'OUTFILE', 'OVER', 'PARTITION', 'POPULATE', 'PRECEDING', 'PREWHERE', 'PRIMARY', 'PROJECTION', 'QUARTER', 'RANGE', 'RELOAD', 'REMOVE', 'RENAME', 'REPLACE', 'REPLICA', 'REPLICATED', 'RIGHT', 'ROLLUP', 'ROW', 'ROWS', 'SAMPLE', 'SECOND', 'SELECT', 'SEMI', 'SENDS', 'SET', 'SETTINGS', 'SHOW', 'SOURCE', 'START', 'STOP', 'SUBSTRING', 'SYNC', 'SYNTAX', 'SYSTEM', 'TABLE', 'TABLES', 'TEMPORARY', 'TEST', 'THEN', 'TIES', 'TIMEOUT', 'TIMESTAMP', 'TO', 'TOP', 'TOTALS', 'TRAILING', 'TRIM', 'TRUNCATE', 'TTL', 'TYPE', 'UNBOUNDED', 'UNION', 'UPDATE', 'USE', 'USING', 'UUID', 'VALUES', 'VIEW', 'VOLUME', 'WATCH', 'WEEK', 'WHEN', 'WHERE', 'WINDOW', 'WITH', 'YEAR', 'JSON_FALSE', 'JSON_TRUE', 'ESCAPE_CHAR_SINGLE', 'ESCAPE_CHAR_DOUBLE', 'IDENTIFIER', 'FLOATING_LITERAL', 'OCTAL_LITERAL', 'DECIMAL_LITERAL', 'HEXADECIMAL_LITERAL', 'STRING_LITERAL', 'ARROW', 'ASTERISK', 'BACKQUOTE', 'BACKSLASH', 'COLON', 'COMMA', 'CONCAT', 'DASH', 'DOLLAR', 'DOT', 'EQ_DOUBLE', 'EQ_SINGLE', 'GT_EQ', 'GT', 'HASH', 'IREGEX_SINGLE', 'IREGEX_DOUBLE', 'LBRACE', 'LBRACKET', 'LPAREN', 'LT_EQ', 'LT', 'NOT_EQ', 'NOT_IREGEX', 'NOT_REGEX', 'NULLISH', 'PERCENT', 'PLUS', 'QUERY', 'QUOTE_DOUBLE', 'QUOTE_SINGLE', 'REGEX_SINGLE', 'REGEX_DOUBLE', 'RBRACE', 'RBRACKET', 'RPAREN', 'SEMICOLON', 'SLASH', 'UNDERSCORE', 'MULTI_LINE_COMMENT', 'SINGLE_LINE_COMMENT', 'WHITESPACE']
    RULE_select = 0
    ...
    RULE_enumValue = 60
    RULE_placeholder = 61
    ruleNames = ['select', 'selectUnionStmt', 'selectStmtWithParens', 'selectStmt', 'withClause', 'topClause', 'fromClause', 'arrayJoinClause', 'windowClause', 'prewhereClause', 'whereClause', 'groupByClause', 'havingClause', 'orderByClause', 'projectionOrderByClause', 'limitAndOffsetClause', 'offsetOnlyClause', 'settingsClause', 'joinExpr', 'joinOp', 'joinOpCross', 'joinConstraintClause', 'sampleClause', 'orderExprList', 'orderExpr', 'ratioExpr', 'settingExprList', 'settingExpr', 'windowExpr', 'winPartitionByClause', 'winOrderByClause', 'winFrameClause', 'winFrameExtend', 'winFrameBound', 'expr', 'columnTypeExpr', 'columnExprList', 'columnExpr', 'columnArgList', 'columnArgExpr', 'columnLambdaExpr', 'hogqlxTagElement', 'hogqlxTagAttribute', 'withExprList', 'withExpr', 'columnIdentifier', 'nestedIdentifier', 'tableExpr', 'tableFunctionExpr', 'tableIdentifier', 'tableArgList', 'databaseIdentifier', 'floatingLiteral', 'numberLiteral', 'literal', 'interval', 'keyword', 'keywordForAlias', 'alias', 'identifier', 'enumValue', 'placeholder']
    EOF = Token.EOF
    ADD = 1
    AFTER = 2
    ALIAS = 3
