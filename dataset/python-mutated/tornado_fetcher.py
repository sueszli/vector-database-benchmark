...
fetcher_output = {'status_code': int, 'orig_url': str, 'url': str, 'headers': dict, 'content': str, 'cookies': dict}

class Fetcher(object):
    user_agent = 'pyspider/%s (+http://pyspider.org/)' % pyspider.__version__
    default_options = {'method': 'GET', 'headers': {}, 'use_gzip': True, 'timeout': 120, 'connect_timeout': 20}
