...
_PG_CONFIG = {'host': config('pg_host'), 'database': config('pg_dbname'), 'user': config('pg_user'), 'password': config('pg_password'), 'port': config('pg_port', cast=int), 'application_name': config('APP_NAME', default='PY')}
