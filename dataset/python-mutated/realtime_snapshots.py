...
PUBLISHED_REALTIME_SUBSCRIPTIONS_COUNTER = Counter('realtime_snapshots_published_subscription_counter', 'When the API is serving snapshot requests and wants to receive snapshots via a redis subscription.', labelnames=['team_id', 'session_id', 'attempt_count'])
REALTIME_SUBSCRIPTIONS_LOADED_COUNTER = Counter('realtime_snapshots_loaded_counter', 'When the API is serving snapshot requests successfully loads snapshots from realtime channel.', labelnames=['attempt_count'])
