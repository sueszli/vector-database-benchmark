...
CMD_MIGRATE_SUBTOPIC_PAGE_CONTENTS_SCHEMA_TO_LATEST_VERSION: Final = 'migrate_subtopic_page_contents_schema_to_latest_version'
...
class SubtopicPageChange(change_domain.BaseChange):
    ...
    """
    SUBTOPIC_PAGE_PROPERTIES: List[str] = [SUBTOPIC_PAGE_PROPERTY_PAGE_CONTENTS_HTML, SUBTOPIC_PAGE_PROPERTY_PAGE_CONTENTS_AUDIO, SUBTOPIC_PAGE_PROPERTY_PAGE_WRITTEN_TRANSLATIONS]
    ALLOWED_COMMANDS: List[feconf.ValidCmdDict] = [{'name': CMD_CREATE_NEW, 'required_attribute_names': ['topic_id', 'subtopic_id'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}, {'name': CMD_UPDATE_SUBTOPIC_PAGE_PROPERTY, 'required_attribute_names': ['property_name', 'new_value', 'old_value', 'subtopic_id'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {'property_name': SUBTOPIC_PAGE_PROPERTIES}, 'deprecated_values': {}}, {'name': CMD_MIGRATE_SUBTOPIC_PAGE_CONTENTS_SCHEMA_TO_LATEST_VERSION, 'required_attribute_names': ['from_version', 'to_version'], 'optional_attribute_names': [], 'user_id_attribute_names': [], 'allowed_values': {}, 'deprecated_values': {}}]
AllowedUpdateSubtopicPagePropertyCmdTypes = Union[state_domain.SubtitledHtmlDict, state_domain.RecordedVoiceoversDict, translation_domain.WrittenTranslationsDict]
