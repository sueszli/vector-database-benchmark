...
from wagtail.test.testapp.models import FeatureCompleteToy, JSONStreamModel, SearchTestModel, VariousOnDeleteModel
...
class TestListFilter(WagtailTestUtils, TestCase):
    cases = {'list': ('feature_complete_toy', 'release_date', 'Release date'), 'dict': ('fctoy_alt1', 'name__icontains', 'Name contains'), 'filterset_class': ('fctoy-alt2', 'release_date__year__lte', 'Release date year is less than or equal to')}
...
class TestSearchIndexView(WagtailTestUtils, TestCase):
    url_name = 'index'
    cases = {'default': ('feature_complete_toy', 'release_date'), None: ('fctoy-alt2', 'release_date__year__lte')}
