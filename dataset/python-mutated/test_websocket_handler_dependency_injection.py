...
class FirstController(Controller):
    path = test_path
    dependencies = {'first': Provide(controller_first_dependency, sync_to_thread=True), 'second': Provide(controller_second_dependency)}

    @websocket(path='/{path_param:str}', dependencies={'first': Provide(local_method_first_dependency, sync_to_thread=False)})
