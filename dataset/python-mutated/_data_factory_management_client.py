...
class DataFactoryManagementClient:
    ...
    def __init__(self, credential: 'AsyncTokenCredential', subscription_id: str, base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        ...
        self.credential_operations = CredentialOperationsOperations(self._client, self._config, self._serialize, self._deserialize)
