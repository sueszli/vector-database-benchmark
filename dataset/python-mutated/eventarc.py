    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    triggers: MutableSequence[gce_trigger.Trigger] = proto.RepeatedField(proto.MESSAGE, number=1, message=gce_trigger.Trigger)
...
class CreateTriggerRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    trigger: gce_trigger.Trigger = proto.Field(proto.MESSAGE, number=2, message=gce_trigger.Trigger)
    trigger_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateTriggerRequest(proto.Message):
    ...
    Attributes:
        ...
        validate_only (bool):
            ...
            preview the review, but do not post it.
    """
    trigger: gce_trigger.Trigger = proto.Field(proto.MESSAGE, number=1, message=gce_trigger.Trigger)
...
class ListChannelsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    channels: MutableSequence[gce_channel.Channel] = proto.RepeatedField(proto.MESSAGE, number=1, message=gce_channel.Channel)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateChannelRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    channel: gce_channel.Channel = proto.Field(proto.MESSAGE, number=2, message=gce_channel.Channel)
    channel_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateChannelRequest(proto.Message):
    ...
    Attributes:
        ...
        validate_only (bool):
            ...
            preview the review, but do not post it.
    """
    channel: gce_channel.Channel = proto.Field(proto.MESSAGE, number=1, message=gce_channel.Channel)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class ListProvidersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    providers: MutableSequence[discovery.Provider] = proto.RepeatedField(proto.MESSAGE, number=1, message=discovery.Provider)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class ListChannelConnectionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    channel_connections: MutableSequence[gce_channel_connection.ChannelConnection] = proto.RepeatedField(proto.MESSAGE, number=1, message=gce_channel_connection.ChannelConnection)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateChannelConnectionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    channel_connection: gce_channel_connection.ChannelConnection = proto.Field(proto.MESSAGE, number=2, message=gce_channel_connection.ChannelConnection)
    channel_connection_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateGoogleChannelConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            provide a field mask of "*".
    """
    google_channel_config: gce_google_channel_config.GoogleChannelConfig = proto.Field(proto.MESSAGE, number=1, message=gce_google_channel_config.GoogleChannelConfig)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
