...
from transformers import WEIGHTS_NAME, AdamW, BertConfig, BertForQuestionAnswering, BertTokenizer, get_linear_schedule_with_warmup, squad_convert_examples_to_features
...
MODEL_CLASSES = {'bert': (BertConfig, BertForQuestionAnswering, BertTokenizer), 'masked_bert': (MaskedBertConfig, MaskedBertForQuestionAnswering, BertTokenizer)}
