...
trig_ufuncs = ['sin', 'cos', 'tan', 'arcsin', 'arccos', 'arctan', 'arctan2', 'hypot', 'sinh', 'cosh', 'tanh', 'arcsinh', 'arccosh', 'arctanh', 'deg2rad', 'rad2deg']
math_ops = ['add', 'subtract', 'multiply', 'logaddexp', 'logaddexp2', 'true_divide', 'floor_divide', 'negative', 'positive', 'power', 'remainder', 'fmod', 'divmod', 'absolute', 'fabs', 'rint', 'exp', 'exp2', 'log', 'log2', 'log10', 'expm1', 'log1p', 'sqrt', 'square', 'cbrt', 'reciprocal', 'divide', 'mod']
supported_ufuncs = trig_ufuncs + math_ops
alias_ufuncs = {'divide': 'true_divide', 'mod': 'remainder'}
