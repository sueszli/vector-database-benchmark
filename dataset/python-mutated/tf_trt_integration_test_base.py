...
TfTrtIntegrationTestParams = collections.namedtuple('TfTrtIntegrationTestParams', ['graph_fn', 'input_specs', 'output_specs', 'input_dims', 'expected_output_dims'])
RunParams = collections.namedtuple('RunParams', ['convert_online', 'precision_mode', 'dynamic_engine', 'use_calibration', 'test_name', 'is_v2', 'dynamic_shape'])
FP32 = 'FP32'
FP16 = 'FP16'
INT8 = 'INT8'
