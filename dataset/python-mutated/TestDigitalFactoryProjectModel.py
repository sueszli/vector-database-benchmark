...
project_1 = DigitalFactoryProjectResponse(library_project_id='omg', display_name='zomg', username='nope', organization_shared=True)
project_2 = DigitalFactoryProjectResponse(library_project_id='omg2', display_name='zomg2', username='nope', organization_shared=False)
