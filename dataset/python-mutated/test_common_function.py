...
import pytest
import torch
from ding.envs.common.common_function import sqrt_one_hot, div_one_hot, div_func, clip_one_hot, reorder_one_hot, reorder_one_hot_array, reorder_boolean_vector, batch_binary_encode, get_postion_vector, affine_transform, save_frames_as_gif
VALUES = [2, 3, 5, 7, 11]
