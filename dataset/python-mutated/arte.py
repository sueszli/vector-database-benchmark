...
from ..utils import ExtractorError, GeoRestrictedError, int_or_none, parse_iso8601, parse_qs, strip_or_none, traverse_obj, url_or_none
...
class ArteTVIE(ArteTVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.arte.tv/en/videos/088501-000-A/mexico-stealing-petrol-to-survive/', 'only_matching': True}, {'url': 'https://www.arte.tv/pl/videos/100103-000-A/usa-dyskryminacja-na-porodowce/', 'info_dict': {'id': '100103-000-A', 'title': 'USA: Dyskryminacja na porodówce', 'description': 'md5:242017b7cce59ffae340a54baefcafb1', 'alt_title': 'ARTE Reportage', 'upload_date': '20201103', 'duration': 554, 'thumbnail': 're:https://api-cdn\\.arte\\.tv/.+940x530', 'timestamp': 1604417980, 'ext': 'mp4'}, 'params': {'skip_download': 'm3u8'}}, {'note': 'No alt_title', 'url': 'https://www.arte.tv/fr/videos/110371-000-A/la-chaleur-supplice-des-arbres-de-rue/', 'only_matching': True}, {'url': 'https://api.arte.tv/api/player/v2/config/de/100605-013-A', 'only_matching': True}, {'url': 'https://api.arte.tv/api/player/v2/config/de/LIVE', 'only_matching': True}, {'url': 'https://www.arte.tv/de/videos/110203-006-A/zaz/', 'only_matching': True}, {'note': 'age-restricted', 'url': 'https://www.arte.tv/de/videos/006785-000-A/the-element-of-crime/', 'info_dict': {'id': '006785-000-A', 'description': 'md5:c2f94fdfefc8a280e4dab68ab96ab0ba', 'title': 'The Element of Crime', 'timestamp': 1696111200, 'duration': 5849, 'thumbnail': 'https://api-cdn.arte.tv/img/v2/image/q82dTTfyuCXupPsGxXsd7B/940x530', 'upload_date': '20230930', 'ext': 'mp4'}}]
    _GEO_BYPASS = True
    _LANG_MAP = {'fr': 'F', 'de': 'A', 'en': 'E[ANG]', 'es': 'E[ESP]', 'it': 'E[ITA]', 'pl': 'E[POL]', 'mul': 'EU'}
    _VERSION_CODE_RE = re.compile('(?x)\n        V\n        (?P<original_voice>O?)\n        (?P<vlang>[FA]|E\\[[A-Z]+\\]|EU)?\n        (?P<audio_desc>AUD|)\n        (?:\n            (?P<has_sub>-ST)\n            (?P<sdh_sub>M?)\n            (?P<sub_lang>[FA]|E\\[[A-Z]+\\]|EU)\n        )?\n    ')
    _COUNTRIES_MAP = {'DE_FR': ('BL', 'DE', 'FR', 'GF', 'GP', 'MF', 'MQ', 'NC', 'PF', 'PM', 'RE', 'WF', 'YT'), 'EUR_DE_FR': ('AT', 'BL', 'CH', 'DE', 'FR', 'GF', 'GP', 'LI', 'MC', 'MF', 'MQ', 'NC', 'PF', 'PM', 'RE', 'WF', 'YT'), 'SAT': ('AD', 'AT', 'AX', 'BG', 'BL', 'CH', 'CY', 'CZ', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GF', 'GR', 'HR', 'HU', 'IE', 'IS', 'IT', 'KN', 'LI', 'LT', 'LU', 'LV', 'MC', 'MF', 'MQ', 'MT', 'NC', 'NL', 'NO', 'PF', 'PL', 'PM', 'PT', 'RE', 'RO', 'SE', 'SI', 'SK', 'SM', 'VA', 'WF', 'YT')}
...
class ArteTVEmbedIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<(?:iframe|script)[^>]+src=(["\\\'])(?P<url>(?:https?:)?//(?:www\\.)?arte\\.tv/player/v\\d+/index\\.php\\?.*?\\bjson_url=.+?)\\1']
    _TESTS = [{'url': 'https://www.arte.tv/player/v5/index.php?json_url=https%3A%2F%2Fapi.arte.tv%2Fapi%2Fplayer%2Fv2%2Fconfig%2Fde%2F100605-013-A&lang=de&autoplay=true&mute=0100605-013-A', 'info_dict': {'id': '100605-013-A', 'ext': 'mp4', 'title': 'United we Stream November Lockdown Edition #13', 'description': 'md5:be40b667f45189632b78c1425c7c2ce1', 'upload_date': '20201116'}, 'skip': 'No video available'}, {'url': 'https://www.arte.tv/player/v3/index.php?json_url=https://api.arte.tv/api/player/v2/config/de/100605-013-A', 'only_matching': True}]
...
class ArteTVPlaylistIE(ArteTVBaseIE):
    _VALID_URL = 'https?://(?:www\\.)?arte\\.tv/(?P<lang>%s)/videos/(?P<id>RC-\\d{6})' % ArteTVBaseIE._ARTE_LANGUAGES
    _TESTS = [{'url': 'https://www.arte.tv/en/videos/RC-016954/earn-a-living/', 'only_matching': True}, {'url': 'https://www.arte.tv/pl/videos/RC-014123/arte-reportage/', 'playlist_mincount': 100, 'info_dict': {'description': 'md5:84e7bf1feda248bc325ebfac818c476e', 'id': 'RC-014123', 'title': 'ARTE Reportage - najlepsze reportaże'}}]
...
class ArteTVCategoryIE(ArteTVBaseIE):
    _VALID_URL = 'https?://(?:www\\.)?arte\\.tv/(?P<lang>%s)/videos/(?P<id>[\\w-]+(?:/[\\w-]+)*)/?\\s*$' % ArteTVBaseIE._ARTE_LANGUAGES
    _TESTS = [{'url': 'https://www.arte.tv/en/videos/politics-and-society/', 'info_dict': {'id': 'politics-and-society', 'title': 'Politics and society', 'description': 'Investigative documentary series, geopolitical analysis, and international commentary'}, 'playlist_mincount': 13}]
