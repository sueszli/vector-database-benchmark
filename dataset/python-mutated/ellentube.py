...
class EllenTubeIE(EllenTubeBaseIE):
    ...
    _TESTS = [{'url': 'https://api-prod.ellentube.com/ellenapi/api/item/0822171c-3829-43bf-b99f-d77358ae75e3', 'md5': '2fabc277131bddafdd120e0fc0f974c9', 'info_dict': {'id': '0822171c-3829-43bf-b99f-d77358ae75e3', 'ext': 'mp4', 'title': 'Ellen Meets Las Vegas Survivors Jesus Campos and Stephen Schuck', 'description': 'md5:76e3355e2242a78ad9e3858e5616923f', 'thumbnail': 're:^https?://.+?', 'duration': 514, 'timestamp': 1508505120, 'upload_date': '20171020', 'view_count': int, 'like_count': int}}, {'url': 'ellentube:734a3353-f697-4e79-9ca9-bfc3002dc1e0', 'only_matching': True}]
...
class EllenTubeVideoIE(EllenTubeBaseIE):
    ...
    _TEST = {'url': 'https://www.ellentube.com/video/ellen-meets-las-vegas-survivors-jesus-campos-and-stephen-schuck.html', 'only_matching': True}
