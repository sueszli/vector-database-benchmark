...
class ExportsOperations:
    ...
    async def list(self, scope: str, expand: Optional[str]=None, **kwargs: Any) -> _models.ExportListResult:
        ...
        request = build_list_request(scope=scope, expand=expand, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    async def get(self, scope: str, export_name: str, expand: Optional[str]=None, **kwargs: Any) -> _models.Export:
        ...
        request = build_get_request(scope=scope, export_name=export_name, expand=expand, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update(self, scope: str, export_name: str, parameters: _models.Export, *, content_type: str='application/json', **kwargs: Any) -> _models.Export:
    ...
    @overload
    async def create_or_update(self, scope: str, export_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Export:
        """The operation to create or update a export. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
    ...
    @distributed_trace_async
    async def create_or_update(self, scope: str, export_name: str, parameters: Union[_models.Export, IO], **kwargs: Any) -> _models.Export:
        """The operation to create or update a export. Update operation requires latest eTag to be set in
        the request. You may obtain the latest eTag by performing a get operation. Create operation
        does not require eTag.
        ...
        request = build_create_or_update_request(scope=scope, export_name=export_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete(self, scope: str, export_name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(scope=scope, export_name=export_name, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def execute(self, scope: str, export_name: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_execute_request(scope=scope, export_name=export_name, api_version=api_version, template_url=self.execute.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_execution_history(self, scope: str, export_name: str, **kwargs: Any) -> _models.ExportExecutionListResult:
        ...
        request = build_get_execution_history_request(scope=scope, export_name=export_name, api_version=api_version, template_url=self.get_execution_history.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
