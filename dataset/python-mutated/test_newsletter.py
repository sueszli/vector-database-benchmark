...
import frappe
from frappe.email.doctype.newsletter.exceptions import NewsletterAlreadySentError, NoRecipientFoundError
from frappe.email.doctype.newsletter.newsletter import Newsletter, confirmed_unsubscribe, send_scheduled_email
from frappe.email.queue import flush
from frappe.tests.utils import FrappeTestCase
from frappe.utils import add_days, getdate
emails = ['test_subscriber1@example.com', 'test_subscriber2@example.com', 'test_subscriber3@example.com', 'test1@example.com']
newsletters = []
