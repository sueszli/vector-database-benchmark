...
def main():
    ...
    response = client.virtual_machines.begin_start(resource_group_name='myResourceGroup', referer='https://management.azure.com/', virtual_machine_name='myVirtualMachine').result()
    print(response)
