...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_1_path', type=str, default='test_images/image_1.jpg', help='\n      Path to test image 1.\n      ')
    parser.add_argument('--image_2_path', type=str, default='test_images/image_2.jpg', help='\n      Path to test image 2.\n      ')
    parser.add_argument('--features_1_path', type=str, default='test_features/image_1.delf', help='\n      Path to DELF features from image 1.\n      ')
    parser.add_argument('--features_2_path', type=str, default='test_features/image_2.delf', help='\n      Path to DELF features from image 2.\n      ')
    parser.add_argument('--output_image', type=str, default='test_match.png', help='\n      Path where an image showing the matches will be saved.\n      ')
