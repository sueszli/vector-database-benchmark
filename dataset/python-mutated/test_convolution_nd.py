...
@testing.parameterize(*testing.product({'dims': [(3, 4), (3, 4, 3)], 'dtype': [numpy.float32], 'in_channels': [4, None, 'omit'], 'groups': [1, 2]}) + testing.product({'dims': [(5,)], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'in_channels': [4, None, 'omit'], 'groups': [1, 2]}))
...
@testing.parameterize(*testing.product({'dims': [(3, 4), (3, 4, 3)], 'dtype': [numpy.float32]}) + testing.product({'dims': [(5,)], 'dtype': [numpy.float16, numpy.float32, numpy.float64]}))
