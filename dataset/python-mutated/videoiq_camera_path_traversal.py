...
class Exploit(HTTPClient):
    __info__ = {'name': 'Avigilon VideoIQ Camera Path Traversal', 'description': 'Module exploits Avigilon VideoIQ Camera Path Traversal vulnerability. If target is vulnerable it is possible to read file from file system.', 'authors': ('Yakir Wizman', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/40284/',), 'devices': ('VideoIQ Camera',)}
