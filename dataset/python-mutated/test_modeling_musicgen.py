...
import unittest
import numpy as np
from transformers import EncodecConfig, MusicgenConfig, MusicgenDecoderConfig, MusicgenProcessor, PretrainedConfig, T5Config
from transformers.testing_utils import is_torch_available, require_torch, require_torch_fp16, slow, torch_device
...
if is_torch_available():
    import torch
    from transformers import MusicgenForCausalLM, MusicgenForConditionalGeneration, MusicgenModel, set_seed
    from transformers.generation import GreedySearchDecoderOnlyOutput, GreedySearchEncoderDecoderOutput, InfNanRemoveLogitsProcessor, LogitsProcessorList, SampleDecoderOnlyOutput, SampleEncoderDecoderOutput
...
class MusicgenDecoderTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    greedy_sample_model_classes = (MusicgenForCausalLM,) if is_torch_available() else ()
