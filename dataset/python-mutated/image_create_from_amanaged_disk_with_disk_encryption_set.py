...
def main():
    ...
    response = client.images.begin_create_or_update(resource_group_name='myResourceGroup', image_name='myImage', parameters={'location': 'West US', 'properties': {'storageProfile': {'osDisk': {'diskEncryptionSet': {'id': '/subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/diskEncryptionSets/{existing-diskEncryptionSet-name}'}, 'osState': 'Generalized', 'osType': 'Linux', 'snapshot': {'id': 'subscriptions/{subscription-id}/resourceGroups/myResourceGroup/providers/Microsoft.Compute/snapshots/mySnapshot'}}}}}).result()
    print(response)
