...
def train_experiment(engine=None):
    ...
    with TemporaryDirectory() as logdir:
        ...
        runner = CustomRunner()
        runner.train(engine=engine, model=model, optimizer=optimizer, loaders=loaders, logdir=logdir, num_epochs=1, verbose=False, valid_loader='valid', valid_metric='loss', minimize_valid_metric=True)
