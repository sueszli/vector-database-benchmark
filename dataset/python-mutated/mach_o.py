...
"""
import time
from macholib.ptypes import Structure, p_int32, p_int64, p_long, p_short, p_uint8, p_uint32, p_uint64, p_ulong, pypackable
_CPU_ARCH_ABI64 = 16777216
CPU_TYPE_NAMES = {-1: 'ANY', 1: 'VAX', 6: 'MC680x0', 7: 'i386', _CPU_ARCH_ABI64 | 7: 'x86_64', 8: 'MIPS', 10: 'MC98000', 11: 'HPPA', 12: 'ARM', _CPU_ARCH_ABI64 | 12: 'ARM64', 13: 'MC88000', 14: 'SPARC', 15: 'i860', 16: 'Alpha', 18: 'PowerPC', _CPU_ARCH_ABI64 | 18: 'PowerPC64'}
INTEL64_SUBTYPE = {3: 'CPU_SUBTYPE_X86_64_ALL', 4: 'CPU_SUBTYPE_X86_ARCH1', 8: 'CPU_SUBTYPE_X86_64_H'}
INTEL_SUBTYPE = {0: 'CPU_SUBTYPE_INTEL_MODEL_ALL', 1: 'CPU_THREADTYPE_INTEL_HTT', 3: 'CPU_SUBTYPE_I386_ALL', 4: 'CPU_SUBTYPE_486', 5: 'CPU_SUBTYPE_586', 8: 'CPU_SUBTYPE_PENTIUM_3', 9: 'CPU_SUBTYPE_PENTIUM_M', 10: 'CPU_SUBTYPE_PENTIUM_4', 11: 'CPU_SUBTYPE_ITANIUM', 12: 'CPU_SUBTYPE_XEON', 34: 'CPU_SUBTYPE_XEON_MP', 42: 'CPU_SUBTYPE_PENTIUM_4_M', 43: 'CPU_SUBTYPE_ITANIUM_2', 38: 'CPU_SUBTYPE_PENTPRO', 40: 'CPU_SUBTYPE_PENTIUM_3_M', 52: 'CPU_SUBTYPE_PENTIUM_3_XEON', 102: 'CPU_SUBTYPE_PENTII_M3', 132: 'CPU_SUBTYPE_486SX', 166: 'CPU_SUBTYPE_PENTII_M5', 199: 'CPU_SUBTYPE_CELERON', 231: 'CPU_SUBTYPE_CELERON_MOBILE'}
MC680_SUBTYPE = {1: 'CPU_SUBTYPE_MC680x0_ALL', 2: 'CPU_SUBTYPE_MC68040', 3: 'CPU_SUBTYPE_MC68030_ONLY'}
MIPS_SUBTYPE = {0: 'CPU_SUBTYPE_MIPS_ALL', 1: 'CPU_SUBTYPE_MIPS_R2300', 2: 'CPU_SUBTYPE_MIPS_R2600', 3: 'CPU_SUBTYPE_MIPS_R2800', 4: 'CPU_SUBTYPE_MIPS_R2000a', 5: 'CPU_SUBTYPE_MIPS_R2000', 6: 'CPU_SUBTYPE_MIPS_R3000a', 7: 'CPU_SUBTYPE_MIPS_R3000'}
...
MC88_SUBTYPE = {0: 'CPU_SUBTYPE_MC88000_ALL', 1: 'CPU_SUBTYPE_MC88100', 2: 'CPU_SUBTYPE_MC88110'}
SPARC_SUBTYPE = {0: 'CPU_SUBTYPE_SPARC_ALL'}
I860_SUBTYPE = {0: 'CPU_SUBTYPE_I860_ALL', 1: 'CPU_SUBTYPE_I860_860'}
POWERPC_SUBTYPE = {0: 'CPU_SUBTYPE_POWERPC_ALL', 1: 'CPU_SUBTYPE_POWERPC_601', 2: 'CPU_SUBTYPE_POWERPC_602', 3: 'CPU_SUBTYPE_POWERPC_603', 4: 'CPU_SUBTYPE_POWERPC_603e', 5: 'CPU_SUBTYPE_POWERPC_603ev', 6: 'CPU_SUBTYPE_POWERPC_604', 7: 'CPU_SUBTYPE_POWERPC_604e', 8: 'CPU_SUBTYPE_POWERPC_620', 9: 'CPU_SUBTYPE_POWERPC_750', 10: 'CPU_SUBTYPE_POWERPC_7400', 11: 'CPU_SUBTYPE_POWERPC_7450', 100: 'CPU_SUBTYPE_POWERPC_970'}
ARM_SUBTYPE = {0: 'CPU_SUBTYPE_ARM_ALL12', 5: 'CPU_SUBTYPE_ARM_V4T', 6: 'CPU_SUBTYPE_ARM_V6', 7: 'CPU_SUBTYPE_ARM_V5TEJ', 8: 'CPU_SUBTYPE_ARM_XSCALE', 9: 'CPU_SUBTYPE_ARM_V7', 10: 'CPU_SUBTYPE_ARM_V7F', 11: 'CPU_SUBTYPE_ARM_V7S', 12: 'CPU_SUBTYPE_ARM_V7K', 13: 'CPU_SUBTYPE_ARM_V8', 14: 'CPU_SUBTYPE_ARM_V6M', 15: 'CPU_SUBTYPE_ARM_V7M', 16: 'CPU_SUBTYPE_ARM_V7EM', 17: 'CPU_SUBTYPE_ARM_V8M'}
ARM64_SUBTYPE = {0: 'CPU_SUBTYPE_ARM64_ALL', 1: 'CPU_SUBTYPE_ARM64_V8', 2: 'CPU_SUBTYPE_ARM64E'}
VAX_SUBTYPE = {0: 'CPU_SUBTYPE_VAX_ALL', 1: 'CPU_SUBTYPE_VAX780', 2: 'CPU_SUBTYPE_VAX785', 3: 'CPU_SUBTYPE_VAX750', 4: 'CPU_SUBTYPE_VAX730', 5: 'CPU_SUBTYPE_UVAXI', 6: 'CPU_SUBTYPE_UVAXII', 7: 'CPU_SUBTYPE_VAX8200', 8: 'CPU_SUBTYPE_VAX8500', 9: 'CPU_SUBTYPE_VAX8600', 10: 'CPU_SUBTYPE_VAX8650', 11: 'CPU_SUBTYPE_VAX8800', 12: 'CPU_SUBTYPE_UVAXIII'}
...
(MH_OBJECT, MH_EXECUTE, MH_FVMLIB, MH_CORE, MH_PRELOAD, MH_DYLIB, MH_DYLINKER, MH_BUNDLE, MH_DYLIB_STUB, MH_DSYM) = range(1, 11)
MH_FILESET = 12
(MH_NOUNDEFS, MH_INCRLINK, MH_DYLDLINK, MH_BINDATLOAD, MH_PREBOUND, MH_SPLIT_SEGS, MH_LAZY_INIT, MH_TWOLEVEL, MH_FORCE_FLAT, MH_NOMULTIDEFS, MH_NOFIXPREBINDING, MH_PREBINDABLE, MH_ALLMODSBOUND, MH_SUBSECTIONS_VIA_SYMBOLS, MH_CANONICAL, MH_WEAK_DEFINES, MH_BINDS_TO_WEAK, MH_ALLOW_STACK_EXECUTION, MH_ROOT_SAFE, MH_SETUID_SAFE, MH_NO_REEXPORTED_DYLIBS, MH_PIE, MH_DEAD_STRIPPABLE_DYLIB, MH_HAS_TLV_DESCRIPTORS, MH_NO_HEAP_EXECUTION, MH_APP_EXTENSION_SAFE) = map(1 .__lshift__, range(26))
MH_MAGIC = 4277009102
MH_CIGAM = 3472551422
...
class mach_header(Structure):
    _fields_ = (('magic', p_uint32), ('cputype', cpu_type_t), ('cpusubtype', cpu_subtype_t), ('filetype', p_uint32), ('ncmds', p_uint32), ('sizeofcmds', p_uint32), ('flags', p_uint32))
...
(LC_SEGMENT, LC_SYMTAB, LC_SYMSEG, LC_THREAD, LC_UNIXTHREAD, LC_LOADFVMLIB, LC_IDFVMLIB, LC_IDENT, LC_FVMFILE, LC_PREPAGE, LC_DYSYMTAB, LC_LOAD_DYLIB, LC_ID_DYLIB, LC_LOAD_DYLINKER, LC_ID_DYLINKER, LC_PREBOUND_DYLIB, LC_ROUTINES, LC_SUB_FRAMEWORK, LC_SUB_UMBRELLA, LC_SUB_CLIENT, LC_SUB_LIBRARY, LC_TWOLEVEL_HINTS, LC_PREBIND_CKSUM) = range(1, 24)
LC_LOAD_WEAK_DYLIB = LC_REQ_DYLD | 24
LC_SEGMENT_64 = 25
LC_ROUTINES_64 = 26
LC_UUID = 27
LC_RPATH = 28 | LC_REQ_DYLD
LC_CODE_SIGNATURE = 29
LC_CODE_SEGMENT_SPLIT_INFO = 30
LC_REEXPORT_DYLIB = 31 | LC_REQ_DYLD
LC_LAZY_LOAD_DYLIB = 32
LC_ENCRYPTION_INFO = 33
LC_DYLD_INFO = 34
LC_DYLD_INFO_ONLY = 34 | LC_REQ_DYLD
LC_LOAD_UPWARD_DYLIB = 35 | LC_REQ_DYLD
LC_VERSION_MIN_MACOSX = 36
LC_VERSION_MIN_IPHONEOS = 37
LC_FUNCTION_STARTS = 38
LC_DYLD_ENVIRONMENT = 39
LC_MAIN = 40 | LC_REQ_DYLD
LC_DATA_IN_CODE = 41
...
LC_NOTE = 49
LC_BUILD_VERSION = 50
LC_DYLD_EXPORTS_TRIE = 51 | LC_REQ_DYLD
LC_DYLD_CHAINED_FIXUPS = 52 | LC_REQ_DYLD
LC_FILESET_ENTRY = 53 | LC_REQ_DYLD
...
class segment_command(Structure):
    _fields_ = (('segname', p_str16), ('vmaddr', p_uint32), ('vmsize', p_uint32), ('fileoff', p_uint32), ('filesize', p_uint32), ('maxprot', vm_prot_t), ('initprot', vm_prot_t), ('nsects', p_uint32), ('flags', p_uint32))
...
class segment_command_64(Structure):
    _fields_ = (('segname', p_str16), ('vmaddr', p_uint64), ('vmsize', p_uint64), ('fileoff', p_uint64), ('filesize', p_uint64), ('maxprot', vm_prot_t), ('initprot', vm_prot_t), ('nsects', p_uint32), ('flags', p_uint32))
...
class section(Structure):
    _fields_ = (('sectname', p_str16), ('segname', p_str16), ('addr', p_uint32), ('size', p_uint32), ('offset', p_uint32), ('align', p_uint32), ('reloff', p_uint32), ('nreloc', p_uint32), ('flags', p_uint32), ('reserved1', p_uint32), ('reserved2', p_uint32))
...
class section_64(Structure):
    _fields_ = (('sectname', p_str16), ('segname', p_str16), ('addr', p_uint64), ('size', p_uint64), ('offset', p_uint32), ('align', p_uint32), ('reloff', p_uint32), ('nreloc', p_uint32), ('flags', p_uint32), ('reserved1', p_uint32), ('reserved2', p_uint32), ('reserved3', p_uint32))
...
FLAG_SECTION_ATTRIBUTES = {S_ATTR_PURE_INSTRUCTIONS: 'S_ATTR_PURE_INSTRUCTIONS', S_ATTR_NO_TOC: 'S_ATTR_NO_TOC', S_ATTR_STRIP_STATIC_SYMS: 'S_ATTR_STRIP_STATIC_SYMS', S_ATTR_NO_DEAD_STRIP: 'S_ATTR_NO_DEAD_STRIP', S_ATTR_LIVE_SUPPORT: 'S_ATTR_LIVE_SUPPORT', S_ATTR_SELF_MODIFYING_CODE: 'S_ATTR_SELF_MODIFYING_CODE', S_ATTR_DEBUG: 'S_ATTR_DEBUG', S_ATTR_SOME_INSTRUCTIONS: 'S_ATTR_SOME_INSTRUCTIONS', S_ATTR_EXT_RELOC: 'S_ATTR_EXT_RELOC', S_ATTR_LOC_RELOC: 'S_ATTR_LOC_RELOC'}
...
class fvmlib(Structure):
    _fields_ = (('name', lc_str), ('minor_version', mach_version_helper), ('header_addr', p_uint32))
...
class dylib(Structure):
    _fields_ = (('name', lc_str), ('timestamp', mach_timestamp_helper), ('current_version', mach_version_helper), ('compatibility_version', mach_version_helper))
...
class routines_command(Structure):
    _fields_ = (('init_address', p_uint32), ('init_module', p_uint32), ('reserved1', p_uint32), ('reserved2', p_uint32), ('reserved3', p_uint32), ('reserved4', p_uint32), ('reserved5', p_uint32), ('reserved6', p_uint32))
...
class routines_command_64(Structure):
    _fields_ = (('init_address', p_uint64), ('init_module', p_uint64), ('reserved1', p_uint64), ('reserved2', p_uint64), ('reserved3', p_uint64), ('reserved4', p_uint64), ('reserved5', p_uint64), ('reserved6', p_uint64))
...
class symtab_command(Structure):
    _fields_ = (('symoff', p_uint32), ('nsyms', p_uint32), ('stroff', p_uint32), ('strsize', p_uint32))
...
class dysymtab_command(Structure):
    ...
    def describe(self):
        ...
        return dys
INDIRECT_SYMBOL_LOCAL = 2147483648
INDIRECT_SYMBOL_ABS = 1073741824

class dylib_table_of_contents(Structure):
    _fields_ = (('symbol_index', p_uint32), ('module_index', p_uint32))

class dylib_module(Structure):
    _fields_ = (('module_name', p_uint32), ('iextdefsym', p_uint32), ('nextdefsym', p_uint32), ('irefsym', p_uint32), ('nrefsym', p_uint32), ('ilocalsym', p_uint32), ('nlocalsym', p_uint32), ('iextrel', p_uint32), ('nextrel', p_uint32), ('iinit_iterm', p_uint32), ('ninit_nterm', p_uint32), ('objc_module_info_addr', p_uint32), ('objc_module_info_size', p_uint32))

class dylib_module_64(Structure):
    _fields_ = (('module_name', p_uint32), ('iextdefsym', p_uint32), ('nextdefsym', p_uint32), ('irefsym', p_uint32), ('nrefsym', p_uint32), ('ilocalsym', p_uint32), ('nlocalsym', p_uint32), ('iextrel', p_uint32), ('nextrel', p_uint32), ('iinit_iterm', p_uint32), ('ninit_nterm', p_uint32), ('objc_module_info_size', p_uint32), ('objc_module_info_addr', p_uint64))

class dylib_reference(Structure):
    _fields_ = (('isym_flags', p_uint32),)
...
class twolevel_hint(Structure):
    _fields_ = (('isub_image_itoc', p_uint32),)
...
class version_min_command(Structure):
    _fields_ = (('version', p_uint32), ('sdk', p_uint32))
...
class build_version_command(Structure):
    _fields_ = (('platform', p_uint32), ('minos', p_uint32), ('sdk', p_uint32), ('ntools', p_uint32))
...
DATA_IN_CODE_KINDS = {DICE_KIND_DATA: 'DICE_KIND_DATA', DICE_KIND_JUMP_TABLE8: 'DICE_KIND_JUMP_TABLE8', DICE_KIND_JUMP_TABLE16: 'DICE_KIND_JUMP_TABLE16', DICE_KIND_JUMP_TABLE32: 'DICE_KIND_JUMP_TABLE32', DICE_KIND_ABS_JUMP_TABLE32: 'DICE_KIND_ABS_JUMP_TABLE32'}

class tlv_descriptor(Structure):
    _fields_ = (('thunk', p_long), ('key', p_ulong), ('offset', p_ulong))
...
class encryption_info_command_64(Structure):
    _fields_ = (('cryptoff', p_uint32), ('cryptsize', p_uint32), ('cryptid', p_uint32), ('pad', p_uint32))
...
class dyld_info_command(Structure):
    _fields_ = (('rebase_off', p_uint32), ('rebase_size', p_uint32), ('bind_off', p_uint32), ('bind_size', p_uint32), ('weak_bind_off', p_uint32), ('weak_bind_size', p_uint32), ('lazy_bind_off', p_uint32), ('lazy_bind_size', p_uint32), ('export_off', p_uint32), ('export_size', p_uint32))
...
MAX_LIBRARY_ORDINAL = 253
DYNAMIC_LOOKUP_ORDINAL = 254
EXECUTABLE_ORDINAL = 255
N_NO_DEAD_STRIP = 32
N_DESC_DISCARDED = 32
N_WEAK_REF = 64
N_WEAK_DEF = 128
...
class fat_arch(Structure):
    _fields_ = (('cputype', cpu_type_t), ('cpusubtype', cpu_subtype_t), ('offset', p_uint32), ('size', p_uint32), ('align', p_uint32))

class fat_arch64(Structure):
    _fields_ = (('cputype', cpu_type_t), ('cpusubtype', cpu_subtype_t), ('offset', p_uint64), ('size', p_uint64), ('align', p_uint32), ('reserved', p_uint32))
REBASE_TYPE_POINTER = 1
REBASE_TYPE_TEXT_ABSOLUTE32 = 2
REBASE_TYPE_TEXT_PCREL32 = 3
REBASE_OPCODE_MASK = 240
REBASE_IMMEDIATE_MASK = 15
...
BIND_OPCODE_MASK = 240
BIND_IMMEDIATE_MASK = 15
BIND_OPCODE_DONE = 0
...
EXPORT_SYMBOL_FLAGS_KIND_MASK = 3
EXPORT_SYMBOL_FLAGS_KIND_REGULAR = 0
EXPORT_SYMBOL_FLAGS_KIND_THREAD_LOCAL = 1
EXPORT_SYMBOL_FLAGS_WEAK_DEFINITION = 4
...
PLATFORM_NAMES = {PLATFORM_MACOS: 'macOS', PLATFORM_IOS: 'iOS', PLATFORM_TVOS: 'tvOS', PLATFORM_WATCHOS: 'watchOS', PLATFORM_BRIDGEOS: 'bridgeOS', PLATFORM_MACCATALYST: 'catalyst', PLATFORM_IOSSIMULATOR: 'iOS simulator', PLATFORM_TVOSSIMULATOR: 'tvOS simulator', PLATFORM_WATCHOSSIMULATOR: 'watchOS simulator'}
TOOL_CLANG = 1
TOOL_SWIFT = 2
TOOL_LD = 3
