...
try:
    ...
    raise ImportError('vault package is not installed in your environment. `pip install dynaconf[vault]` or disable the vault loader with export VAULT_ENABLED_FOR_DYNACONF=false')
IDENTIFIER = 'vault'
