...
class GronkhFeedIE(InfoExtractor):
    ...
    IE_NAME = 'gronkh:feed'
    _TESTS = [{'url': 'https://gronkh.tv/feed', 'info_dict': {'id': 'feed'}, 'playlist_count': 16}, {'url': 'https://gronkh.tv', 'only_matching': True}]
...
class GronkhVodsIE(InfoExtractor):
    ...
    IE_NAME = 'gronkh:vods'
    _TESTS = [{'url': 'https://gronkh.tv/vods/streams', 'info_dict': {'id': 'vods'}, 'playlist_mincount': 150}]
    _PER_PAGE = 25
