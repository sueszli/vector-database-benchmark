...
class geom_boxplot(geom):
    ...
    """
    DEFAULT_AES = {'alpha': 1, 'color': '#333333', 'fill': 'white', 'linetype': 'solid', 'shape': 'o', 'size': 0.5, 'weight': 1}
    REQUIRED_AES = {'x', 'lower', 'upper', 'middle', 'ymin', 'ymax'}
    DEFAULT_PARAMS = {'stat': 'boxplot', 'position': 'dodge2', 'na_rm': False, 'width': None, 'outlier_alpha': 1, 'outlier_color': None, 'outlier_shape': 'o', 'outlier_size': 1.5, 'outlier_stroke': 0.5, 'notch': False, 'varwidth': False, 'notchwidth': 0.5, 'fatten': 2}
