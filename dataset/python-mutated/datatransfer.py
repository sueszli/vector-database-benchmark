...
class DataSourceParameter(proto.Message):
    ...
    class Type(proto.Enum):
        ...
        PLUS_PAGE = 6
        LIST = 7
    param_id: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    type_: Type = proto.Field(proto.ENUM, number=4, enum=Type)
    required: bool = proto.Field(proto.BOOL, number=5)
    repeated: bool = proto.Field(proto.BOOL, number=6)
    validation_regex: str = proto.Field(proto.STRING, number=7)
    allowed_values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=8)
    min_value: wrappers_pb2.DoubleValue = proto.Field(proto.MESSAGE, number=9, message=wrappers_pb2.DoubleValue)
    max_value: wrappers_pb2.DoubleValue = proto.Field(proto.MESSAGE, number=10, message=wrappers_pb2.DoubleValue)
    fields: MutableSequence['DataSourceParameter'] = proto.RepeatedField(proto.MESSAGE, number=11, message='DataSourceParameter')
    validation_description: str = proto.Field(proto.STRING, number=12)
    validation_help_url: str = proto.Field(proto.STRING, number=13)
    immutable: bool = proto.Field(proto.BOOL, number=14)
    recurse: bool = proto.Field(proto.BOOL, number=15)
    deprecated: bool = proto.Field(proto.BOOL, number=20)
...
class DataSource(proto.Message):
    ...
    data_source_id: str = proto.Field(proto.STRING, number=2)
    display_name: str = proto.Field(proto.STRING, number=3)
    description: str = proto.Field(proto.STRING, number=4)
    client_id: str = proto.Field(proto.STRING, number=5)
    scopes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    transfer_type: transfer.TransferType = proto.Field(proto.ENUM, number=7, enum=transfer.TransferType)
    supports_multiple_transfers: bool = proto.Field(proto.BOOL, number=8)
    update_deadline_seconds: int = proto.Field(proto.INT32, number=9)
    default_schedule: str = proto.Field(proto.STRING, number=10)
    supports_custom_schedule: bool = proto.Field(proto.BOOL, number=11)
    parameters: MutableSequence['DataSourceParameter'] = proto.RepeatedField(proto.MESSAGE, number=12, message='DataSourceParameter')
    help_url: str = proto.Field(proto.STRING, number=13)
    authorization_type: AuthorizationType = proto.Field(proto.ENUM, number=14, enum=AuthorizationType)
    data_refresh_type: DataRefreshType = proto.Field(proto.ENUM, number=15, enum=DataRefreshType)
    default_data_refresh_window_days: int = proto.Field(proto.INT32, number=16)
    manual_runs_disabled: bool = proto.Field(proto.BOOL, number=17)
    minimum_schedule_interval: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=18, message=duration_pb2.Duration)
...
class ListDataSourcesRequest(proto.Message):
    """Request to list supported data sources and their data
    transfer settings.
...
class ListDataSourcesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    data_sources: MutableSequence['DataSource'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataSource')
...
class CreateTransferConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    transfer_config: transfer.TransferConfig = proto.Field(proto.MESSAGE, number=2, message=transfer.TransferConfig)
    authorization_code: str = proto.Field(proto.STRING, number=3)
    version_info: str = proto.Field(proto.STRING, number=5)
    service_account_name: str = proto.Field(proto.STRING, number=6)

class UpdateTransferConfigRequest(proto.Message):
    """A request to update a transfer configuration. To update the
    ...
    Attributes:
        ...
        service_account_name (str):
            ...
            accounts <https://cloud.google.com/bigquery-transfer/docs/use-service-accounts>`__.
    """
    transfer_config: transfer.TransferConfig = proto.Field(proto.MESSAGE, number=1, message=transfer.TransferConfig)
    authorization_code: str = proto.Field(proto.STRING, number=3)
...
class DeleteTransferConfigRequest(proto.Message):
    """A request to delete data transfer information. All associated
...
class ListTransferConfigsRequest(proto.Message):
    """A request to list data transfers configured for a BigQuery
    project.
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    data_source_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    page_token: str = proto.Field(proto.STRING, number=3)
    page_size: int = proto.Field(proto.INT32, number=4)
...
class ListTransferConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    transfer_configs: MutableSequence[transfer.TransferConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=transfer.TransferConfig)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class ListTransferRunsRequest(proto.Message):
    ...
    class RunAttempt(proto.Enum):
        ...
        LATEST = 1
    parent: str = proto.Field(proto.STRING, number=1)
    states: MutableSequence[transfer.TransferState] = proto.RepeatedField(proto.ENUM, number=2, enum=transfer.TransferState)
    page_token: str = proto.Field(proto.STRING, number=3)
    page_size: int = proto.Field(proto.INT32, number=4)
    run_attempt: RunAttempt = proto.Field(proto.ENUM, number=5, enum=RunAttempt)
...
class ListTransferRunsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    transfer_runs: MutableSequence[transfer.TransferRun] = proto.RepeatedField(proto.MESSAGE, number=1, message=transfer.TransferRun)
    next_page_token: str = proto.Field(proto.STRING, number=2)

class ListTransferLogsRequest(proto.Message):
    """A request to get user facing log messages associated with
    data transfer run.
    ...
    message_types: MutableSequence[transfer.TransferMessage.MessageSeverity] = proto.RepeatedField(proto.ENUM, number=6, enum=transfer.TransferMessage.MessageSeverity)
...
class ListTransferLogsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    transfer_messages: MutableSequence[transfer.TransferMessage] = proto.RepeatedField(proto.MESSAGE, number=1, message=transfer.TransferMessage)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CheckValidCredsResponse(proto.Message):
    """A response indicating whether the credentials exist and are
    valid.
    ...
    """
    has_valid_creds: bool = proto.Field(proto.BOOL, number=1)
...
class ScheduleTransferRunsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
...
class ScheduleTransferRunsResponse(proto.Message):
    ...
    """
    runs: MutableSequence[transfer.TransferRun] = proto.RepeatedField(proto.MESSAGE, number=1, message=transfer.TransferRun)
...
class StartManualTransferRunsRequest(proto.Message):
    ...
    parent: str = proto.Field(proto.STRING, number=1)
    requested_time_range: TimeRange = proto.Field(proto.MESSAGE, number=3, oneof='time', message=TimeRange)
    requested_run_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, oneof='time', message=timestamp_pb2.Timestamp)
