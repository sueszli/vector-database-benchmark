...
@pytest.mark.skipif(cupy.cuda.runtime.is_hip and int(str(cupy.cuda.runtime.runtimeGetVersion())[:3]) < 403, reason='HIP<4.3 not supported ')
...
@testing.with_requires('numpy>=1.17.0')
@testing.fix_random()
class TestStandardExponential(InvalidOutsMixin, common_distributions.StandardExponential, GeneratorTestCase):
    pass

@testing.parameterize(*common_distributions.gamma_params)
@testing.fix_random()
class TestGamma(common_distributions.Gamma, GeneratorTestCase):
    pass

@testing.parameterize(*common_distributions.standard_gamma_params)
@testing.fix_random()
class TestStandardGamma(common_distributions.StandardGamma, GeneratorTestCase):
    pass
...
@testing.fix_random()
class TestStandardNormal(common_distributions.StandardNormal, GeneratorTestCase):
    pass
...
@testing.with_requires('numpy>=1.17.0')
@testing.fix_random()
class TestHypergeometric(common_distributions.Hypergeometric, GeneratorTestCase):
    pass
