...
api_ret = dict(description='{\n    "context": "See deployment or stage description",\n    "provisioned_by": "Salt boto_apigateway.present State"\n}', createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), id='vni0vq8wzi', name='unit test api')
no_apis_ret = {'items': []}
apis_ret = {'items': [api_ret]}
mock_model_ret = dict(contentType='application/json', description='mock model', id='123abc', name='mock model', schema='{\n    "$schema": "http://json-schema.org/draft-04/schema#",\n    "properties": {\n        "field": {\n            "type": "string"\n        }\n    }\n}')
...
resources_ret = {'items': [dict(id='bgk0rk8rqb', path='/'), dict(id='9waiaz', parentId='bgk0rk8rqb', path='/users', pathPart='users', resourceMethods={'POST': {}})]}
no_resources_ret = {'items': []}
stage1_deployment1_ret = dict(cacheClusterEnabled=False, cacheClusterSize=0.5, cacheClusterStatus='NOT_AVAILABLE', createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), deploymentId='kobnrb', description='{\n    "current_deployment_label": {\n        "api_name": "unit test api",\n        "swagger_file": "temp-swagger-sample.yaml",\n        "swagger_file_md5sum": "4fb17e43bab3a96e7f2410a1597cd0a5",\n        "swagger_info_object": {\n            "description": "salt boto apigateway unit test service",\n            "title": "salt boto apigateway unit test service",\n            "version": "0.0.0"\n        }\n    }\n}', lastUpdatedDate=datetime.datetime(2015, 11, 17, 16, 33, 50), methodSettings=dict(), stageName='test', variables=dict())
stage1_deployment1_vars_ret = dict(cacheClusterEnabled=False, cacheClusterSize=0.5, cacheClusterStatus='NOT_AVAILABLE', createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), deploymentId='kobnrb', description='{\n    "current_deployment_label": {\n        "api_name": "unit test api",\n        "swagger_file": "temp-swagger-sample.yaml",\n        "swagger_file_md5sum": "4fb17e43bab3a96e7f2410a1597cd0a5",\n        "swagger_info_object": {\n            "description": "salt boto apigateway unit test service",\n            "title": "salt boto apigateway unit test service",\n            "version": "0.0.0"\n        }\n    }\n}', lastUpdatedDate=datetime.datetime(2015, 11, 17, 16, 33, 50), methodSettings=dict(), stageName='test', variables={'var1': 'val1'})
stage1_deployment2_ret = dict(cacheClusterEnabled=False, cacheClusterSize=0.5, cacheClusterStatus='NOT_AVAILABLE', createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), deploymentId='kobnrc', description='{\n    "current_deployment_label": {\n        "api_name": "unit test api",\n        "swagger_file": "temp-swagger-sample.yaml",\n        "swagger_file_md5sum": "5fd538c4336ed5c54b4bf39ddf97c661",\n        "swagger_info_object": {\n            "description": "salt boto apigateway unit test service",\n            "title": "salt boto apigateway unit test service",\n            "version": "0.0.2"\n        }\n    }\n}', lastUpdatedDate=datetime.datetime(2015, 11, 17, 16, 33, 50), methodSettings=dict(), stageName='test', variables=dict())
stage2_ret = dict(cacheClusterEnabled=False, cacheClusterSize=0.5, cacheClusterStatus='NOT_AVAILABLE', createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), deploymentId='kobnrb', description='{\n    "current_deployment_label": {\n        "api_name": "unit test api",\n        "swagger_file": "temp-swagger-sample.yaml",\n        "swagger_file_md5sum": "4fb17e43bab3a96e7f2410a1597cd0a5",\n        "swagger_info_object": {\n            "description": "salt boto apigateway unit test service",\n            "title": "salt boto apigateway unit test service",\n            "version": "0.0.0"\n        }\n    }\n}', lastUpdatedDate=datetime.datetime(2015, 11, 17, 16, 33, 50), methodSettings=dict(), stageName='dev', variables=dict())
stages_stage2_ret = {'item': [stage2_ret]}
no_stages_ret = {'item': []}
deployment1_ret = dict(createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), description='{\n    "api_name": "unit test api",\n    "swagger_file": "temp-swagger-sample.yaml",\n    "swagger_file_md5sum": "55a948ff90ad80ff747ec91657c7a299",\n    "swagger_info_object": {\n        "description": "salt boto apigateway unit test service",\n        "title": "salt boto apigateway unit test service",\n        "version": "0.0.0"\n    }\n}', id='kobnrb')
deployment2_ret = dict(createdDate=datetime.datetime(2015, 11, 17, 16, 33, 50), description='{\n    "api_name": "unit test api",\n    "swagger_file": "temp-swagger-sample.yaml",\n    "swagger_file_md5sum": "5fd538c4336ed5c54b4bf39ddf97c661",\n    "swagger_info_object": {\n        "description": "salt boto apigateway unit test service",\n        "title": "salt boto apigateway unit test service",\n        "version": "0.0.2"\n    }\n}', id='kobnrc')
deployments_ret = {'items': [deployment1_ret, deployment2_ret]}
function_ret = dict(FunctionName='unit_test_api_users_post', Runtime='python2.7', Role=None, Handler='handler', Description='abcdefg', Timeout=5, MemorySize=128, CodeSha256='abcdef', CodeSize=199, FunctionArn='arn:lambda:us-east-1:1234:Something', LastModified='yes')
method_integration_response_200_ret = dict(responseParameters={'method.response.header.Access-Control-Allow-Origin': '*'}, responseTemplates={}, selectionPattern='.*', statusCode='200')
method_integration_ret = dict(cacheKeyParameters={}, cacheNamespace='9waiaz', credentials='arn:aws:iam::1234:role/apigatewayrole', httpMethod='POST', integrationResponses={'200': method_integration_response_200_ret}, requestParameters={}, requestTemplates={'application/json': '#set($inputRoot = $input.path(\'$\')){"header-params" : {#set ($map = $input.params().header)#foreach( $param in $map.entrySet() )"$param.key" : "$param.value" #if( $foreach.hasNext ), #end#end},"query-params" : {#set ($map = $input.params().querystring)#foreach( $param in $map.entrySet() )"$param.key" : "$param.value" #if( $foreach.hasNext ), #end#end},"path-params" : {#set ($map = $input.params().path)#foreach( $param in $map.entrySet() )"$param.key" : "$param.value" #if( $foreach.hasNext ), #end#end},"body-params" : $input.json(\'$\')}'}, type='AWS', uri='arn:aws:apigateway:us-west-2:lambda:path/2015-03-31/functions/arn:aws:lambda:us-west-2:1234567:function:unit_test_api_api_users_post/invocations')
method_response_200_ret = dict(responseModels={'application/json': 'User'}, responseParameters={'method.response.header.Access-Control-Allow-Origin': False}, statusCode='200')
method_ret = dict(apiKeyRequired=False, authorizationType='None', httpMethod='POST', methodIntegration=method_integration_ret, methodResponses={'200': method_response_200_ret}, requestModels={'application/json': 'User'}, requestParameters={})
...
class TempSwaggerFile:
    _tmp_swagger_dict = {'info': {'version': '0.0.0', 'description': 'salt boto apigateway unit test service', 'title': 'salt boto apigateway unit test service'}, 'paths': {'/users': {'post': {'responses': {'200': {'headers': {'Access-Control-Allow-Origin': {'type': 'string'}}, 'description': 'The username of the new user', 'schema': {'$ref': '#/definitions/User'}}}, 'parameters': [{'in': 'body', 'description': 'New user details.', 'name': 'NewUser', 'schema': {'$ref': '#/definitions/User'}}], 'produces': ['application/json'], 'description': 'Creates a new user.', 'tags': ['Auth'], 'consumes': ['application/json'], 'summary': 'Registers a new user'}}}, 'schemes': ['https'], 'produces': ['application/json'], 'basePath': '/api', 'host': 'rm06h9oac4.execute-api.us-west-2.amazonaws.com', 'definitions': {'User': {'properties': {'username': {'type': 'string', 'description': 'A unique username for the user'}, 'password': {'type': 'string', 'description': 'A password for the new user'}}}, 'Error': {'properties': {'fields': {'type': 'string'}, 'message': {'type': 'string'}, 'code': {'type': 'integer', 'format': 'int32'}}}}, 'swagger': '2.0'}
...
@pytest.mark.skipif(_has_required_boto() is False, reason='The boto3 module must be greater than or equal to version {}'.format(required_boto3_version))
...
@pytest.mark.skipif(HAS_BOTO is False, reason='The boto module must be installed.')
@pytest.mark.skipif(_has_required_boto() is False, reason='The boto3 module must be greater than or equal to version {}'.format(required_boto3_version))
@pytest.mark.skipif(_has_required_botocore() is False, reason='The botocore module must be greater than or equal to version {}'.format(required_botocore_version))
