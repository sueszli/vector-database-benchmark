...
from PyQt5.QtCore import QAbstractListModel, QModelIndex, Qt, QSize, QPoint, QRect
from PyQt5.QtGui import QPalette, QPen, QFont, QFontMetrics
from PyQt5.QtWidgets import QStyledItemDelegate, QListView, QSizePolicy, QFrame, QApplication, QWidget
