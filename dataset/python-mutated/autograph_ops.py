...
py_builtins.print_registry.register(tensor_util.tf_type_classes, _tf_py_func_print)
py_builtins.sorted_registry.register(tensor_util.tf_type_classes, _tf_sorted)