...
from ...operations._invitations_operations import build_create_request, build_delete_request, build_get_request, build_list_by_share_request
...
class InvitationsOperations:
    ...
    async def get(self, resource_group_name: str, account_name: str, share_name: str, invitation_name: str, **kwargs: Any) -> _models.Invitation:
        ...
        request = build_get_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, invitation_name=invitation_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def create(self, resource_group_name: str, account_name: str, share_name: str, invitation_name: str, invitation: _models.Invitation, *, content_type: str='application/json', **kwargs: Any) -> _models.Invitation:
    ...
    @overload
    async def create(self, resource_group_name: str, account_name: str, share_name: str, invitation_name: str, invitation: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.Invitation:
        """Sends a new invitation to a recipient to access a share.
    ...
    @distributed_trace_async
    async def create(self, resource_group_name: str, account_name: str, share_name: str, invitation_name: str, invitation: Union[_models.Invitation, IO], **kwargs: Any) -> _models.Invitation:
        """Sends a new invitation to a recipient to access a share.
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, account_name: str, share_name: str, invitation_name: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, account_name=account_name, share_name=share_name, invitation_name=invitation_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
