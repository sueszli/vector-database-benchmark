...
debug = 0
debugsym = None
ignored_files = {'trio': 'too many non standard macros', 'trio.c': 'too many non standard macros', 'trionan.c': 'too many non standard macros', 'triostr.c': 'too many non standard macros', 'acconfig.h': 'generated portability layer', 'config.h': 'generated portability layer', 'libxml.h': 'internal only', 'testOOM.c': 'out of memory tester', 'testOOMlib.h': 'out of memory tester', 'testOOMlib.c': 'out of memory tester', 'rngparser.c': 'not yet integrated', 'rngparser.h': 'not yet integrated', 'elfgcchack.h': 'not a normal header', 'testHTML.c': 'test tool', 'testReader.c': 'test tool', 'testSchemas.c': 'test tool', 'testXPath.c': 'test tool', 'testAutomata.c': 'test tool', 'testModule.c': 'test tool', 'testRegexp.c': 'test tool', 'testThreads.c': 'test tool', 'testC14N.c': 'test tool', 'testRelax.c': 'test tool', 'testThreadsWin32.c': 'test tool', 'testSAX.c': 'test tool', 'testURI.c': 'test tool', 'testapi.c': 'generated regression tests', 'runtest.c': 'regression tests program', 'runsuite.c': 'regression tests program', 'tst.c': 'not part of the library', 'test.c': 'not part of the library', 'testdso.c': 'test for dynamid shared libraries', 'testrecurse.c': 'test for entities recursions', 'xzlib.h': 'Internal API only 2.8.0', 'buf.h': 'Internal API only 2.9.0', 'enc.h': 'Internal API only 2.9.0', '/save.h': 'Internal API only 2.9.0', 'timsort.h': 'Internal header only for xpath.c 2.9.0'}
ignored_words = {'WINAPI': (0, 'Windows keyword'), 'LIBXML_DLL_IMPORT': (0, 'Special macro to flag external keywords'), 'XMLPUBVAR': (0, 'Special macro for extern vars for win32'), 'XSLTPUBVAR': (0, 'Special macro for extern vars for win32'), 'EXSLTPUBVAR': (0, 'Special macro for extern vars for win32'), 'XMLPUBFUN': (0, 'Special macro for extern funcs for win32'), 'XSLTPUBFUN': (0, 'Special macro for extern funcs for win32'), 'EXSLTPUBFUN': (0, 'Special macro for extern funcs for win32'), 'XMLCALL': (0, 'Special macro for win32 calls'), 'XSLTCALL': (0, 'Special macro for win32 calls'), 'XMLCDECL': (0, 'Special macro for win32 calls'), 'EXSLTCALL': (0, 'Special macro for win32 calls'), '__declspec': (3, 'Windows keyword'), '__stdcall': (0, 'Windows keyword'), 'ATTRIBUTE_UNUSED': (0, 'macro keyword'), 'LIBEXSLT_PUBLIC': (0, 'macro keyword'), 'X_IN_Y': (5, 'macro function builder'), 'ATTRIBUTE_ALLOC_SIZE': (3, 'macro for gcc checking extension'), 'ATTRIBUTE_PRINTF': (5, 'macro for gcc printf args checking extension'), 'LIBXML_ATTR_FORMAT': (5, 'macro for gcc printf args checking extension'), 'LIBXML_ATTR_ALLOC_SIZE': (3, 'macro for gcc checking extension')}
