...
flags.DEFINE_integer('meta_learner_training_epochs', 1, 'Number of meta_learner_training_epochs')
flags.DEFINE_integer('num_tasks', 1, 'Number tasks to train meta learner.')
flags.DEFINE_integer('random_seed', 2, 'Random seed.')
flags.DEFINE_integer('checkpoint_interval', 50, 'Checkpoint every checkpoint_interval.')
...
flags.DEFINE_bool('use_infostate_representation', True, 'Use infostate representation as extra input to meta network.')
