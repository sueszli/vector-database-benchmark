...
class MockManager:
    ...
    def __init__(self, stub_runner, scenario_data, input_mocker):
        ...
        self.communications = [{'body': f'Communication-{i}', 'caseId': f'test-case-{i}', 'timeCreated': f'test-time{i}', 'attachmentSet': []} for i in range(1, 4)]
    ...
    def setup_stubs(self, error, stop_on, stubber):
        ...
        with self.stub_runner(error, stop_on) as runner:
            runner.add(stubber.stub_describe_communications, self.case_id, self.communications)
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_describe_communications', 0)])
