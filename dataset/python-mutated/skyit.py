...
class SkyItVideoIE(SkyItPlayerIE):
    ...
    _TESTS = [{'url': 'https://video.sky.it/news/mondo/video/uomo-ucciso-da-uno-squalo-in-australia-631227', 'md5': '5b858a62d9ffe2ab77b397553024184a', 'info_dict': {'id': '631227', 'ext': 'mp4', 'title': 'Uomo ucciso da uno squalo in Australia', 'timestamp': 1606036192, 'upload_date': '20201122', 'duration': 26, 'thumbnail': 'https://video.sky.it/captures/thumbs/631227/631227_thumb_880x494.jpg'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://xfactor.sky.it/video/x-factor-2020-replay-audizioni-1-615820', 'only_matching': True}, {'url': 'https://masterchef.sky.it/video/masterchef-9-cosa-e-successo-nella-prima-puntata-562831', 'only_matching': True}]
...
class SkyItVideoLiveIE(SkyItPlayerIE):
    ...
    _TEST = {'url': 'https://video.sky.it/diretta/tg24', 'info_dict': {'id': '1', 'ext': 'mp4', 'title': 're:Diretta TG24 \\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}', 'description': 're:(?:Clicca play e )?[Gg]uarda la diretta streaming di SkyTg24, segui con Sky tutti gli appuntamenti e gli speciali di Tg24\\.', 'live_status': 'is_live'}, 'params': {'skip_download': True}}
...
class SkyItArteIE(SkyItIE):
    ...
    _TESTS = [{'url': 'https://arte.sky.it/video/oliviero-toscani-torino-galleria-mazzoleni-788962', 'md5': '515aee97b87d7a018b6c80727d3e7e17', 'info_dict': {'id': '788962', 'ext': 'mp4', 'title': 'La fotografia di Oliviero Toscani conquista Torino', 'upload_date': '20221102', 'timestamp': 1667399996, 'duration': 12, 'thumbnail': 'https://videoplatform.sky.it/still/2022/11/02/1667396388552_oliviero-toscani-torino-galleria-mazzoleni_videostill_1.jpg'}, 'params': {'skip_download': 'm3u8'}}]
    _DOMAIN = 'skyarte'
    _VIDEO_ID_REGEX = '"embedUrl"\\s*:\\s*"(?:https:)?//player\\.sky\\.it/player/external\\.html\\?[^"]*\\bid=(\\d+)'

class CieloTVItIE(SkyItIE):
    IE_NAME = 'cielotv.it'
    _VALID_URL = 'https?://(?:www\\.)?cielotv\\.it/video/(?P<id>[^.]+)\\.html'
    _TESTS = [{'url': 'https://www.cielotv.it/video/Il-lunedi-e-sempre-un-dramma.html', 'md5': 'c4deed77552ba901c2a0d9258320304b', 'info_dict': {'id': '499240', 'ext': 'mp4', 'title': 'Il lunedì è sempre un dramma', 'upload_date': '20190329', 'timestamp': 1553862178, 'duration': 30, 'thumbnail': 'https://videoplatform.sky.it/still/2019/03/29/1553858575610_lunedi_dramma_mant_videostill_1.jpg'}, 'params': {'skip_download': 'm3u8'}}]
    _DOMAIN = 'cielo'
    _VIDEO_ID_REGEX = 'videoId\\s*=\\s*"(\\d+)"'

class TV8ItIE(SkyItVideoIE):
    IE_NAME = 'tv8.it'
    _VALID_URL = 'https?://(?:www\\.)?tv8\\.it/(?:show)?video/[0-9a-z-]+-(?P<id>\\d+)'
    _TESTS = [{'url': 'https://www.tv8.it/video/ogni-mattina-ucciso-asino-di-andrea-lo-cicero-630529', 'md5': '9ab906a3f75ea342ed928442f9dabd21', 'info_dict': {'id': '630529', 'ext': 'mp4', 'title': 'Ogni mattina - Ucciso asino di Andrea Lo Cicero', 'timestamp': 1605721374, 'upload_date': '20201118', 'duration': 114, 'thumbnail': 'https://videoplatform.sky.it/still/2020/11/18/1605717753954_ogni-mattina-ucciso-asino-di-andrea-lo-cicero_videostill_1.jpg'}, 'params': {'skip_download': 'm3u8'}}]
    _DOMAIN = 'mtv8'