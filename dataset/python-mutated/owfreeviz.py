...
class OWFreeViz(OWAnchorProjectionWidget, ConcurrentWidgetMixin):
    ...
    class Error(OWAnchorProjectionWidget.Error):
        ...
        not_enough_class_vars = widget.Msg('Target variable must have at least two unique values.')
        features_exceeds_instances = widget.Msg('Number of features exceeds the number of instances.')
    ...
    class Warning(OWAnchorProjectionWidget.Warning):
        removed_features = widget.Msg('Categorical features with more than two values are not shown.')
