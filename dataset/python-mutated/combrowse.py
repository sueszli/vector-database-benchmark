...
class HLITypeLibFunction(HLICOM):
    funckinds = {pythoncom.FUNC_VIRTUAL: 'Virtual', pythoncom.FUNC_PUREVIRTUAL: 'Pure Virtual', pythoncom.FUNC_STATIC: 'Static', pythoncom.FUNC_DISPATCH: 'Dispatch'}
    invokekinds = {pythoncom.INVOKE_FUNC: 'Function', pythoncom.INVOKE_PROPERTYGET: 'Property Get', pythoncom.INVOKE_PROPERTYPUT: 'Property Put', pythoncom.INVOKE_PROPERTYPUTREF: 'Property Put by reference'}
    funcflags = [(pythoncom.FUNCFLAG_FRESTRICTED, 'Restricted'), (pythoncom.FUNCFLAG_FSOURCE, 'Source'), (pythoncom.FUNCFLAG_FBINDABLE, 'Bindable'), (pythoncom.FUNCFLAG_FREQUESTEDIT, 'Request Edit'), (pythoncom.FUNCFLAG_FDISPLAYBIND, 'Display Bind'), (pythoncom.FUNCFLAG_FDEFAULTBIND, 'Default Bind'), (pythoncom.FUNCFLAG_FHIDDEN, 'Hidden'), (pythoncom.FUNCFLAG_FUSESGETLASTERROR, 'Uses GetLastError')]
    ...
    type_flags = [(pythoncom.VT_VECTOR, 'Vector'), (pythoncom.VT_ARRAY, 'Array'), (pythoncom.VT_BYREF, 'ByRef'), (pythoncom.VT_RESERVED, 'Reserved')]
    ...
    def GetSubList(self):
        ...
        return ret
HLITypeKinds = {pythoncom.TKIND_ENUM: (HLITypeLibEnum, 'Enumeration'), pythoncom.TKIND_RECORD: (HLITypeLibEntry, 'Record'), pythoncom.TKIND_MODULE: (HLITypeLibEnum, 'Module'), pythoncom.TKIND_INTERFACE: (HLITypeLibMethod, 'Interface'), pythoncom.TKIND_DISPATCH: (HLITypeLibMethod, 'Dispatch'), pythoncom.TKIND_COCLASS: (HLICoClass, 'CoClass'), pythoncom.TKIND_ALIAS: (HLITypeLibEntry, 'Alias'), pythoncom.TKIND_UNION: (HLITypeLibEntry, 'Union')}
