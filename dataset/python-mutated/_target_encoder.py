...
class TargetEncoder(OneToOneFeatureMixin, _BaseEncoder):
    ...
    [array([20..., 80..., 43...])]
    """
    _parameter_constraints: dict = {'categories': [StrOptions({'auto'}), list], 'target_type': [StrOptions({'auto', 'continuous', 'binary', 'multiclass'})], 'smooth': [StrOptions({'auto'}), Interval(Real, 0, None, closed='left')], 'cv': [Interval(Integral, 2, None, closed='left')], 'shuffle': ['boolean'], 'random_state': ['random_state']}
