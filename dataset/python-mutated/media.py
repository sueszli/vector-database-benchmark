...
REAL_TIME_FORMATS = ['alsa', 'android_camera', 'avfoundation', 'bktr', 'decklink', 'dshow', 'fbdev', 'gdigrab', 'iec61883', 'jack', 'kmsgrab', 'openal', 'oss', 'pulse', 'sndio', 'rtsp', 'v4l2', 'vfwcap', 'x11grab']
...
class PlayerStreamTrack(MediaStreamTrack):
    ...
    async def recv(self) -> Union[Frame, Packet]:
        ...
        if self._player is not None and self._player._throttle_playback and (data_time is not None):
