...
def generate(args):
    ...
    collect_demo_data(config, collect_count=main_config.policy.other.replay_buffer.replay_buffer_size, seed=args.seed, expert_data_path=main_config.policy.learn.save_path, state_dict=state_dict)
