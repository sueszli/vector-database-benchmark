...
from qtpy.QtWidgets import QDialog, QDialogButtonBox, QFrame, QGridLayout, QHBoxLayout, QListView, QListWidget, QListWidgetItem, QPushButton, QScrollArea, QStackedWidget, QVBoxLayout, QWidget
...
from spyder.utils.stylesheet import AppStyle, MAC, PREFERENCES_TABBAR_STYLESHEET, WIN
...
class ConfigDialog(QDialog, SpyderFontsMixin):
    ...
    ITEMS_PADDING = AppStyle.MarginSize if MAC or WIN else 2 * AppStyle.MarginSize
