...
def sample_analyze_orchestration_direct_target():
    ...
    with client:
        ...
        result = client.analyze_conversation(task={'kind': 'Conversation', 'analysisInput': {'conversationItem': {'participantId': '1', 'id': '1', 'modality': 'text', 'language': 'en', 'text': query}, 'isLoggingEnabled': False}, 'parameters': {'projectName': project_name, 'deploymentName': deployment_name, 'directTarget': qna_app, 'targetProjectParameters': {'ChitChat-QnA': {'targetProjectKind': 'QuestionAnswering', 'callingOptions': {'question': query}}}}})
