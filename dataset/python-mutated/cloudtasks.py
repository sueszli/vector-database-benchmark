...
class ListQueuesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    queues: MutableSequence[gct_queue.Queue] = proto.RepeatedField(proto.MESSAGE, number=1, message=gct_queue.Queue)
...
class GetQueueRequest(proto.Message):
    ...
    read_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class CreateQueueRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    queue: gct_queue.Queue = proto.Field(proto.MESSAGE, number=2, message=gct_queue.Queue)
...
class UpdateQueueRequest(proto.Message):
    ...
    """
    queue: gct_queue.Queue = proto.Field(proto.MESSAGE, number=1, message=gct_queue.Queue)
...
class ListTasksRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    response_view: gct_task.Task.View = proto.Field(proto.ENUM, number=2, enum=gct_task.Task.View)
    page_size: int = proto.Field(proto.INT32, number=3)
    page_token: str = proto.Field(proto.STRING, number=4)
...
class ListTasksResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    tasks: MutableSequence[gct_task.Task] = proto.RepeatedField(proto.MESSAGE, number=1, message=gct_task.Task)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class BufferTaskRequest(proto.Message):
    ...
    """
    queue: str = proto.Field(proto.STRING, number=1)
    task_id: str = proto.Field(proto.STRING, number=2)
    body: httpbody_pb2.HttpBody = proto.Field(proto.MESSAGE, number=3, message=httpbody_pb2.HttpBody)
...
class BufferTaskResponse(proto.Message):
    ...
    Attributes:
        task (google.cloud.tasks_v2beta3.types.Task):
            The created task.
    """
    task: gct_task.Task = proto.Field(proto.MESSAGE, number=1, message=gct_task.Task)
