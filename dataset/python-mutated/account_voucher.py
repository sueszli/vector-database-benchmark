...
class AccountVoucher(models.Model):
    ...
    date = fields.Date('Bill Date', readonly=True, index=True, states={'draft': [('readonly', False)]}, copy=False, default=fields.Date.context_today)
    account_date = fields.Date('Accounting Date', readonly=True, index=True, states={'draft': [('readonly', False)]}, help='Effective date for accounting entries', copy=False, default=fields.Date.context_today)
    ...
    line_ids = fields.One2many('account.voucher.line', 'voucher_id', 'Voucher Lines', readonly=True, copy=True, states={'draft': [('readonly', False)]})
    ...
    state = fields.Selection([('draft', 'Draft'), ('cancel', 'Cancelled'), ('proforma', 'Pro-forma'), ('posted', 'Posted')], 'Status', readonly=True, track_visibility='onchange', copy=False, default='draft', help=" * The 'Draft' status is used when a user is encoding a new and unconfirmed Voucher.\n * The 'Pro-forma' status is used when the voucher does not have a voucher number.\n * The 'Posted' status is used when user create voucher,a voucher number is generated and voucher entries are created in account.\n * The 'Cancelled' status is used when user cancel voucher.")
    reference = fields.Char('Bill Reference', readonly=True, states={'draft': [('readonly', False)]}, help='The partner reference of this document.', copy=False)
    ...
    pay_now = fields.Selection([('pay_now', 'Pay Directly'), ('pay_later', 'Pay Later')], 'Payment', index=True, readonly=True, states={'draft': [('readonly', False)]}, default='pay_later')
...
class AccountVoucherLine(models.Model):
    ...
    sequence = fields.Integer(default=10, help='Gives the sequence of this line when displaying the voucher.')
    ...
    quantity = fields.Float(digits=dp.get_precision('Product Unit of Measure'), required=True, default=1)
