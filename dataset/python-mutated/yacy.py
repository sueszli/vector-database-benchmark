...
about = {'website': 'https://yacy.net/', 'wikidata_id': 'Q1759675', 'official_api_documentation': 'https://wiki.yacy.net/index.php/Dev:API', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
categories = ['general']
paging = True
...
base_url = 'https://yacy.searchlab.eu'
search_url = '/yacysearch.json?{query}&startRecord={offset}&maximumRecords={limit}&contentdom={search_type}&resource={resource}'
