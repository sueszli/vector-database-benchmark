...
class Migration(migrations.Migration):
    dependencies = [('api', '0008_remove_image_path')]
    ...
    operations = [migrations.AddField(model_name='Photo', name='aspect_ratio', field=models.FloatField(blank=True, null=True)), migrations.RunPython(forwards_func)]