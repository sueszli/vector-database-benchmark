...
from coremltools.converters.mil.mil import get_new_symbol, get_new_variadic_symbol, SYMBOL, VALUE, NONE
...
class band_part(Operation):
    ...
    """
    input_spec = InputSpec(x=TensorInputType(), lower=IntInputType(const=True, default=-1), upper=IntInputType(const=True, default=-1))
...
class cumsum(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), axis=IntInputType(const=True, default=0), exclusive=BoolInputType(const=True, default=False), reverse=BoolInputType(const=True, default=False))
...
class fill(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(shape=IntTensorInputType(), value=ScalarOrTensorInputType(const=True, default=0.0))
...
class non_maximum_suppression(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(boxes=TensorInputType(), scores=TensorInputType(), iou_threshold=FloatInputType(const=True), score_threshold=FloatInputType(const=True), max_boxes=IntInputType(const=True), per_class_suppression=BoolInputType(const=True, default=False))
...
class one_hot(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(indices=IntTensorInputType(), one_hot_vector_size=IntInputType(), axis=IntInputType(const=True, default=-1), on_value=IntOrFloatInputType(const=True, default=1), off_value=IntOrFloatInputType(const=True, default=0))
...
class pad(Operation):
    ...
    * constant_val: const<T> (Optional)
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), pad=IntTensorInputType(), mode=StringInputType(const=True, default='constant'), constant_val=FloatInputType(const=True, default=0.0))
...
class range_1d(Operation):
    ...
    T: fp32
    """
    input_spec = InputSpec(end=IntOrFloatInputType(), start=IntOrFloatInputType(), step=IntOrFloatInputType())
...
class argsort(Operation):
    ...
    * ascending: const<bool> (Optional)
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), axis=IntInputType(const=True, default=-1), ascending=BoolInputType(const=True, default=False))
...
class topk(Operation):
    ...
    * ascending: const<bool> (Optional)
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), k=IntInputType(const=True, default=1), axis=IntInputType(const=True, default=-1), ascending=BoolInputType(const=True, default=False))
...
class flatten(Operation):
    ...
    * axis: const<f32>  (Optional)
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), axis=IntInputType(const=True, default=1))
...
class split(Operation):
    ...
    * axis: const<i32> (Required)
    ...
    T: fp32
    """
    input_spec = InputSpec(x=TensorInputType(), num_splits=IntInputType(const=True, optional=True), split_sizes=IntTensorInputType(const=True, optional=True), axis=IntInputType(const=True))
