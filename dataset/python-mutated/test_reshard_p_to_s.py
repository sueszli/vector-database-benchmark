...
class TestReshardSToR(test_base.CommunicationTestDistBase):
    ...
    def setUp(self):
        ...
        self._default_envs = {'shape': '(10, 20)', 'dtype': 'float32', 'seeds': '2023'}
        self._changeable_envs = {'shard': ['0', '1'], 'backend': ['gpu']}
    ...
    def test_reshard_p_to_s(self):
        ...
        for envs in envs_list:
            self.run_test_case('reshard_p_to_s.py', user_defined_envs=envs)
