...
class ChatMemberBanned(ChatMember):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, status: Literal[ChatMemberStatus.KICKED]=ChatMemberStatus.KICKED, user: User, until_date: DateTime, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
