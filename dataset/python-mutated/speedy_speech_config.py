...
class SpeedySpeechConfig(BaseTTSConfig):
    ...
    d_vector_dim: int = 0
    optimizer: str = 'Adam'
    optimizer_params: dict = field(default_factory=lambda : {'betas': [0.9, 0.998], 'weight_decay': 1e-06})
    ...
    test_sentences: List[str] = field(default_factory=lambda : ["It took me quite a long time to develop a voice, and now that I have it I'm not going to be silent.", 'Be a voice, not an echo.', "I'm sorry Dave. I'm afraid I can't do that.", "This cake is great. It's so delicious and moist.", 'Prior to November 22, 1963.'])
