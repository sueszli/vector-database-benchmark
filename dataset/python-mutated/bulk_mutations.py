...
from ..utils import convert_migrated_sale_predicate_to_catalogue_info, get_variants_for_predicate

class SaleBulkDelete(ModelBulkDeleteMutation):

    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of sale IDs to delete.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.SALE_DELETED, description='A sale was deleted.')]
...
class VoucherBulkDelete(ModelBulkDeleteMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of voucher IDs to delete.')
    ...
    class Meta:
        ...
        error_type_class = DiscountError
        error_type_field = 'discount_errors'
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.VOUCHER_DELETED, description='A voucher was deleted.')]
