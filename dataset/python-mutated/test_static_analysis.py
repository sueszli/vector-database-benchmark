...
result_var_type3 = {'a': {NodeVarType.INT}, 'b': {NodeVarType.FLOAT}, 'c': {NodeVarType.FLOAT}, 'd': {NodeVarType.FLOAT}, 'e': {NodeVarType.BOOLEAN}, 'f': {NodeVarType.INT}, 'g': {NodeVarType.STRING}, 'h': {NodeVarType.NONE}, 'i': {NodeVarType.BOOLEAN}, 'j': {NodeVarType.UNKNOWN}, 'k': {NodeVarType.FLOAT}, 'l': {NodeVarType.PADDLE_RETURN_TYPES}}
...
def func_to_test4():
    ...
    with base.dygraph.guard():
        ...
        d = (c + 1) * 0.3
result_var_type4 = {'a': {NodeVarType.NUMPY_NDARRAY}, 'b': {NodeVarType.NUMPY_NDARRAY}, 'c': {NodeVarType.TENSOR}, 'd': {NodeVarType.TENSOR}}
...
result_var_type5 = {'a': {NodeVarType.INT}, 'b': {NodeVarType.FLOAT, NodeVarType.BOOLEAN}, 'c': {NodeVarType.UNKNOWN}, 'd': {NodeVarType.PADDLE_RETURN_TYPES}, 'inner_int_func': {NodeVarType.INT}, 'inner_bool_float_func': {NodeVarType.FLOAT, NodeVarType.BOOLEAN}, 'inner_unknown_func': {NodeVarType.UNKNOWN}}
...
def func_to_test6(x, y=1):
    ...
    while x < 10:
        ...
        x = x + y
    return i
result_var_type6 = {'i': {NodeVarType.INT}, 'x': {NodeVarType.INT}, 'y': {NodeVarType.INT}, 'add': {NodeVarType.INT}}
...
result_var_type7 = {'a': {NodeVarType.BOOLEAN}, 'b': {NodeVarType.FLOAT}, 'c': {NodeVarType.TENSOR}, 'd': {NodeVarType.STRING}, 'e': {NodeVarType.PADDLE_RETURN_TYPES}, 'f': {NodeVarType.PADDLE_RETURN_TYPES}, 'g': {NodeVarType.TENSOR}}
test_funcs = [func_to_test1, func_to_test2, func_to_test3, func_to_test4, func_to_test5, func_to_test6, func_to_test7]
result_var_type = [result_var_type1, result_var_type2, result_var_type3, result_var_type4, result_var_type5, result_var_type6, result_var_type7]
