...
class WebSiteManagementClientOperationsMixin(WebSiteManagementClientMixinABC):
    ...
    async def get_publishing_user(self, **kwargs: Any) -> _models.User:
        ...
        request = build_get_publishing_user_request(api_version=api_version, template_url=self.get_publishing_user.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def update_publishing_user(self, user_details: _models.User, *, content_type: str='application/json', **kwargs: Any) -> _models.User:
    ...
    @overload
    async def update_publishing_user(self, user_details: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.User:
        """Updates publishing user.
    ...
    async def update_publishing_user(self, user_details: Union[_models.User, IO], **kwargs: Any) -> _models.User:
        ...
        :type user_details: ~azure.mgmt.web.v2016_03_01.models.User or IO
        ...
        request = build_update_publishing_user_request(api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_publishing_user.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get_source_control(self, source_control_type: str, **kwargs: Any) -> _models.SourceControl:
        ...
        request = build_get_source_control_request(source_control_type=source_control_type, api_version=api_version, template_url=self.get_source_control.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_source_control(self, source_control_type: str, request_message: _models.SourceControl, *, content_type: str='application/json', **kwargs: Any) -> _models.SourceControl:
    ...
    @overload
    async def update_source_control(self, source_control_type: str, request_message: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.SourceControl:
        """Updates source control token.
    ...
    @distributed_trace_async
    async def update_source_control(self, source_control_type: str, request_message: Union[_models.SourceControl, IO], **kwargs: Any) -> _models.SourceControl:
        """Updates source control token.
        ...
        :param request_message: Source control token information. Is either a SourceControl type or a
         IO type. Required.
        :type request_message: ~azure.mgmt.web.v2016_03_01.models.SourceControl or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        request = build_update_source_control_request(source_control_type=source_control_type, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_source_control.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def check_name_availability(self, name: str, type: Union[str, _models.CheckNameResourceTypes], is_fqdn: Optional[bool]=None, **kwargs: Any) -> _models.ResourceNameAvailability:
        ...
        request = build_check_name_availability_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, template_url=self.check_name_availability.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get_subscription_deployment_locations(self, **kwargs: Any) -> _models.DeploymentLocations:
        ...
        request = build_get_subscription_deployment_locations_request(subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_subscription_deployment_locations.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def verify_hosting_environment_vnet(self, parameters: _models.VnetParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetValidationFailureDetails:
    ...
    @overload
    async def verify_hosting_environment_vnet(self, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetValidationFailureDetails:
        """Verifies if this VNET is compatible with an App Service Environment by analyzing the Network
        Security Group rules.
    ...
    @distributed_trace_async
    async def verify_hosting_environment_vnet(self, parameters: Union[_models.VnetParameters, IO], **kwargs: Any) -> _models.VnetValidationFailureDetails:
        """Verifies if this VNET is compatible with an App Service Environment by analyzing the Network
        Security Group rules.
        ...
        :type parameters: ~azure.mgmt.web.v2016_03_01.models.VnetParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        request = build_verify_hosting_environment_vnet_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.verify_hosting_environment_vnet.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def move(self, resource_group_name: str, move_resource_envelope: _models.CsmMoveResourceEnvelope, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def move(self, resource_group_name: str, move_resource_envelope: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Move resources between resource groups.
    ...
    @distributed_trace_async
    async def move(self, resource_group_name: str, move_resource_envelope: Union[_models.CsmMoveResourceEnvelope, IO], **kwargs: Any) -> None:
        """Move resources between resource groups.
        ...
        :type move_resource_envelope: ~azure.mgmt.web.v2016_03_01.models.CsmMoveResourceEnvelope or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        request = build_move_request(resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.move.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def validate(self, resource_group_name: str, validate_request: _models.ValidateRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.ValidateResponse:
    ...
    @overload
    async def validate(self, resource_group_name: str, validate_request: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ValidateResponse:
        """Validate if a resource can be created.
    ...
    @distributed_trace_async
    async def validate(self, resource_group_name: str, validate_request: Union[_models.ValidateRequest, IO], **kwargs: Any) -> _models.ValidateResponse:
        """Validate if a resource can be created.
        ...
        :type validate_request: ~azure.mgmt.web.v2016_03_01.models.ValidateRequest or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        request = build_validate_request(resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def validate_move(self, resource_group_name: str, move_resource_envelope: _models.CsmMoveResourceEnvelope, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def validate_move(self, resource_group_name: str, move_resource_envelope: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Validate whether a resource can be moved.
    ...
    @distributed_trace_async
    async def validate_move(self, resource_group_name: str, move_resource_envelope: Union[_models.CsmMoveResourceEnvelope, IO], **kwargs: Any) -> None:
        """Validate whether a resource can be moved.
        ...
        if isinstance(move_resource_envelope, (IO, bytes)):
            ...
            _json = self._serialize.body(move_resource_envelope, 'CsmMoveResourceEnvelope')
        request = build_validate_move_request(resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate_move.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
