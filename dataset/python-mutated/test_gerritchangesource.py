...
class TestGerritChangeSource(MasterRunProcessMixin, changesource.ChangeSourceMixin, TestReactorMixin, unittest.TestCase):
    ...
    comment_added_event = {'type': 'comment-added', 'author': {'name': 'author author', 'email': 'author@example.com', 'username': 'author'}, 'approvals': [{'type': 'Code-Review', 'description': 'Code-Review', 'value': '0'}], 'comment': 'Patch Set 1:\n\ntest comment', 'patchSet': {'number': 1, 'revision': '29b73c3eb1aeaa9e6c7da520a940d60810e883db', 'parents': ['7e563631188dcadf32aad0d8647c818834921a1e'], 'ref': 'refs/changes/21/4321/1', 'uploader': {'name': 'uploader uploader', 'email': 'uploader@example.com', 'username': 'uploader'}, 'createdOn': 1627214047, 'author': {'name': 'author author', 'email': 'author@example.com', 'username': 'author'}, 'kind': 'REWORK', 'sizeInsertions': 1, 'sizeDeletions': 0}, 'change': {'project': 'test', 'branch': 'master', 'id': 'I21234123412341234123412341234', 'number': 4321, 'subject': 'change subject', 'owner': {'name': 'owner owner', 'email': 'owner@example.com', 'username': 'owner'}, 'url': 'http://example.com/c/test/+/4321', 'commitMessage': 'test1\n\nChange-Id: I21234123412341234123412341234\n', 'createdOn': 1627214047, 'status': 'NEW'}, 'project': 'test', 'refName': 'refs/heads/master', 'changeKey': {'id': 'I21234123412341234123412341234'}, 'eventCreatedOn': 1627214102}
    expected_change_comment_added = {'category': 'comment-added', 'files': ['unknown'], 'repository': 'ssh://someuser@somehost:29418/test', 'author': 'owner owner <owner@example.com>', 'committer': None, 'comments': 'change subject', 'project': 'test', 'branch': 'refs/changes/21/4321/1', 'revlink': 'http://example.com/c/test/+/4321', 'codebase': None, 'revision': '29b73c3eb1aeaa9e6c7da520a940d60810e883db', 'src': None, 'when_timestamp': None}
    ...
    def test_malformed_events_ignored(self):
        ...
        self.assertEqual(len(self.master.data.updates.changesAdded), 0)
    change_merged_event = {'type': 'change-merged', 'change': {'branch': 'br', 'project': 'pr', 'number': '4321', 'owner': {'name': 'Chuck', 'email': 'chuck@norris.com'}, 'url': 'http://buildbot.net', 'subject': 'fix 1234'}, 'patchSet': {'revision': 'abcdefj', 'number': '13'}}
    ...
    query_files_success_line1 = {'patchSets': [{'number': 1, 'files': [{'file': '/COMMIT_MSG', 'type': 'ADDED', 'insertions': 13, 'deletions': 0}]}, {'number': 13, 'files': [{'file': '/COMMIT_MSG', 'type': 'ADDED', 'insertions': 13, 'deletions': 0}, {'file': 'file1', 'type': 'MODIFIED', 'insertions': 7, 'deletions': 0}, {'file': 'file2', 'type': 'MODIFIED', 'insertions': 2, 'deletions': -2}]}]}
    query_files_success_line2 = {'type': 'stats', 'rowCount': 1}
    query_files_success = '\n'.join([json.dumps(query_files_success_line1), json.dumps(query_files_success_line2)]).encode('utf8')
...
class TestGerritEventLogPoller(changesource.ChangeSourceMixin, TestReactorMixin, unittest.TestCase):
    ...
    change_revision_dict = {'/COMMIT_MSG': {'status': 'A', 'lines_inserted': 9, 'size_delta': 1, 'size': 1}, 'file1': {'lines_inserted': 9, 'lines_deleted': 2, 'size_delta': 1, 'size': 1}}
