...
@pytest.mark.e2e
def test_checkout_use_fixed_voucher_core_0901(e2e_not_logged_api_client, e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts):
    if False:
        print('Hello World!')
    ...
    voucher_code = prepare_fixed_voucher(e2e_staff_api_client, channel_id, voucher_code='FIXED_VOUCHER', voucher_discount_type='FIXED', voucher_discount_value=10, voucher_type='ENTIRE_ORDER')
    ...
    assert order_line['unitPrice']['gross']['amount'] == float(product_variant_price) - discount_value / 2
