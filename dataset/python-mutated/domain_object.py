...
from .base import ActiveRecordMixin, TextSearchMixin, DictMixin, NameMixin, DebugMixin
T = TypeVar('T')
...
class DomainObject(ActiveRecordMixin, DictMixin, NameMixin, TextSearchMixin, DebugMixin):
