...
def main():
    ...
    response = client.farm_beats_models.begin_update(resource_group_name='examples-rg', farm_beats_resource_name='examples-farmBeatsResourceName', body={'tags': {'key1': 'value1', 'key2': 'value2'}}).result()
    print(response)
