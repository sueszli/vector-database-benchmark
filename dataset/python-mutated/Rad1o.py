...
class Rad1o(Device):
    ...
    DEVICE_METHODS.update({Device.Command.SET_FREQUENCY.name: 'set_freq', Device.Command.SET_BANDWIDTH.name: 'set_baseband_filter_bandwidth'})
    DATA_TYPE = np.int8
    ...
    def __init__(self, center_freq, sample_rate, bandwidth, gain, if_gain=1, baseband_gain=1, resume_on_full_receive_buffer=False):
        ...
        self.success = 0
        self.error_codes = {0: 'Rad1o_SUCCESS', 1: 'Rad1o_TRUE', 1337: 'TIMEOUT ERROR', -2: 'Rad1o_ERROR_INVALID_PARAM', -5: 'Rad1o_ERROR_NOT_FOUND', -6: 'Rad1o_ERROR_BUSY', -11: 'Rad1o_ERROR_NO_MEM', -1000: 'Rad1o_ERROR_LIBUSB', -1001: 'Rad1o_ERROR_THREAD', -1002: 'Rad1o_ERROR_STREAMING_THREAD_ERR', -1003: 'Rad1o_ERROR_STREAMING_STOPPED', -1004: 'Rad1o_ERROR_STREAMING_EXIT_CALLED', -4242: 'Rad1o NOT OPEN', -9999: 'Rad1o_ERROR_OTHER'}
