...
class ProSiebenSat1IE(ProSiebenSat1BaseIE):
    ...
    _TESTS = [{'url': 'http://www.prosieben.de/tv/circus-halligalli/videos/218-staffel-2-episode-18-jahresrueckblick-ganze-folge', 'info_dict': {'id': '2104602', 'ext': 'mp4', 'title': 'CIRCUS HALLIGALLI - Episode 18 - Staffel 2', 'description': 'md5:8733c81b702ea472e069bc48bb658fc1', 'upload_date': '20131231', 'duration': 5845.04, 'series': 'CIRCUS HALLIGALLI', 'season_number': 2, 'episode': 'Episode 18 - Staffel 2', 'episode_number': 18}}, {'url': 'http://www.prosieben.de/videokatalog/Gesellschaft/Leben/Trends/video-Lady-Umstyling-f%C3%BCr-Audrina-Rebekka-Audrina-Fergen-billig-aussehen-Battal-Modica-700544.html', 'info_dict': {'id': '2570327', 'ext': 'mp4', 'title': 'Lady-Umstyling für Audrina', 'description': 'md5:4c16d0c17a3461a0d43ea4084e96319d', 'upload_date': '20131014', 'duration': 606.76}, 'params': {'skip_download': True}, 'skip': 'Seems to be broken'}, {'url': 'http://www.prosiebenmaxx.de/tv/experience/video/144-countdown-fuer-die-autowerkstatt-ganze-folge', 'info_dict': {'id': '2429369', 'ext': 'mp4', 'title': 'Countdown für die Autowerkstatt', 'description': 'md5:809fc051a457b5d8666013bc40698817', 'upload_date': '20140223', 'duration': 2595.04}, 'params': {'skip_download': True}, 'skip': 'This video is unavailable'}, {'url': 'http://www.sixx.de/stars-style/video/sexy-laufen-in-ugg-boots-clip', 'info_dict': {'id': '2904997', 'ext': 'mp4', 'title': 'Sexy laufen in Ugg Boots', 'description': 'md5:edf42b8bd5bc4e5da4db4222c5acb7d6', 'upload_date': '20140122', 'duration': 245.32}, 'params': {'skip_download': True}, 'skip': 'This video is unavailable'}, {'url': 'http://www.sat1.de/film/der-ruecktritt/video/im-interview-kai-wiesinger-clip', 'info_dict': {'id': '2906572', 'ext': 'mp4', 'title': 'Im Interview: Kai Wiesinger', 'description': 'md5:e4e5370652ec63b95023e914190b4eb9', 'upload_date': '20140203', 'duration': 522.56}, 'params': {'skip_download': True}, 'skip': 'This video is unavailable'}, {'url': 'http://www.kabeleins.de/tv/rosins-restaurants/videos/jagd-auf-fertigkost-im-elsthal-teil-2-ganze-folge', 'info_dict': {'id': '2992323', 'ext': 'mp4', 'title': 'Jagd auf Fertigkost im Elsthal - Teil 2', 'description': 'md5:2669cde3febe9bce13904f701e774eb6', 'upload_date': '20141014', 'duration': 2410.44}, 'params': {'skip_download': True}, 'skip': 'This video is unavailable'}, {'url': 'http://www.ran.de/fussball/bundesliga/video/schalke-toennies-moechte-raul-zurueck-ganze-folge', 'info_dict': {'id': '3004256', 'ext': 'mp4', 'title': 'Schalke: Tönnies möchte Raul zurück', 'description': 'md5:4b5b271d9bcde223b54390754c8ece3f', 'upload_date': '20140226', 'duration': 228.96}, 'params': {'skip_download': True}, 'skip': 'This video is unavailable'}, {'url': 'http://www.the-voice-of-germany.de/video/31-andreas-kuemmert-rocket-man-clip', 'info_dict': {'id': '2572814', 'ext': 'mp4', 'title': 'The Voice of Germany - Andreas Kümmert: Rocket Man', 'description': 'md5:6ddb02b0781c6adf778afea606652e38', 'timestamp': 1382041620, 'upload_date': '20131017', 'duration': 469.88}, 'params': {'skip_download': True}}, {'url': 'http://www.fem.com/videos/beauty-lifestyle/kurztrips-zum-valentinstag', 'info_dict': {'id': '2156342', 'ext': 'mp4', 'title': 'Kurztrips zum Valentinstag', 'description': 'Romantischer Kurztrip zum Valentinstag? Nina Heinemann verrät, was sich hier wirklich lohnt.', 'duration': 307.24}, 'params': {'skip_download': True}}, {'url': 'http://www.prosieben.de/tv/joko-gegen-klaas/videos/playlists/episode-8-ganze-folge-playlist', 'info_dict': {'id': '439664', 'title': 'Episode 8 - Ganze Folge - Playlist', 'description': 'md5:63b8963e71f481782aeea877658dec84'}, 'playlist_count': 2, 'skip': 'This video is unavailable'}, {'url': 'http://www.prosieben.de/stars/oscar-award/videos/jetzt-erst-enthuellt-das-geheimnis-von-emma-stones-oscar-robe-clip', 'info_dict': {'id': '4895826', 'ext': 'mp4', 'title': 'Jetzt erst enthüllt: Das Geheimnis von Emma Stones Oscar-Robe', 'description': 'md5:e5ace2bc43fadf7b63adc6187e9450b9', 'upload_date': '20170302'}, 'params': {'skip_download': True}, 'skip': 'geo restricted to Germany'}, {'url': 'http://www.kabeleinsdoku.de/tv/mayday-alarm-im-cockpit/video/102-notlandung-im-hudson-river-ganze-folge', 'only_matching': True}, {'url': 'http://www.sat1gold.de/tv/edel-starck/video/11-staffel-1-episode-1-partner-wider-willen-ganze-folge', 'only_matching': True}, {'url': 'https://www.galileo.tv/video/diese-emojis-werden-oft-missverstanden', 'only_matching': True}, {'url': 'http://www.sat1gold.de/tv/edel-starck/playlist/die-gesamte-1-staffel', 'only_matching': True}, {'url': 'http://www.advopedia.de/videos/lenssen-klaert-auf/lenssen-klaert-auf-folge-8-staffel-3-feiertage-und-freie-tage', 'only_matching': True}]
    _TOKEN = 'prosieben'
    ...
    _CLIPID_REGEXES = ['"clip_id"\\s*:\\s+"(\\d+)"', 'clipid: "(\\d+)"', 'clip[iI]d=(\\d+)', 'clip[iI][dD]\\s*=\\s*["\\\'](\\d+)', "'itemImageUrl'\\s*:\\s*'/dynamic/thumbnails/full/\\d+/(\\d+)", 'proMamsId&quot;\\s*:\\s*&quot;(\\d+)', 'proMamsId"\\s*:\\s*"(\\d+)']
    _TITLE_REGEXES = ['<h2 class="subtitle" itemprop="name">\\s*(.+?)</h2>', '<header class="clearfix">\\s*<h3>(.+?)</h3>', '<!-- start video -->\\s*<h1>(.+?)</h1>', '<h1 class="att-name">\\s*(.+?)</h1>', '<header class="module_header">\\s*<h2>([^<]+)</h2>\\s*</header>', '<h2 class="video-title" itemprop="name">\\s*(.+?)</h2>', '<div[^>]+id="veeseoTitle"[^>]*>(.+?)</div>', '<h2[^>]+class="subtitle"[^>]*>([^<]+)</h2>']
    _DESCRIPTION_REGEXES = ['<p itemprop="description">\\s*(.+?)</p>', '<div class="videoDecription">\\s*<p><strong>Beschreibung</strong>: (.+?)</p>', '<div class="g-plusone" data-size="medium"></div>\\s*</div>\\s*</header>\\s*(.+?)\\s*<footer>', '<p class="att-description">\\s*(.+?)\\s*</p>', '<p class="video-description" itemprop="description">\\s*(.+?)</p>', '<div[^>]+id="veeseoDescription"[^>]*>(.+?)</div>']
    _UPLOAD_DATE_REGEXES = ['<span>\\s*(\\d{2}\\.\\d{2}\\.\\d{4} \\d{2}:\\d{2}) \\|\\s*<span itemprop="duration"', '<footer>\\s*(\\d{2}\\.\\d{2}\\.\\d{4}) \\d{2}:\\d{2} Uhr', '<span style="padding-left: 4px;line-height:20px; color:#404040">(\\d{2}\\.\\d{2}\\.\\d{4})</span>', '(\\d{2}\\.\\d{2}\\.\\d{4}) \\| \\d{2}:\\d{2} Min<br/>']
    _PAGE_TYPE_REGEXES = ['<meta name="page_type" content="([^"]+)">', "'itemType'\\s*:\\s*'([^']*)'"]
    _PLAYLIST_ID_REGEXES = ['content[iI]d=(\\d+)', "'itemId'\\s*:\\s*'([^']*)'"]
    _PLAYLIST_CLIP_REGEXES = ['(?s)data-qvt=.+?<a href="([^"]+)"']
