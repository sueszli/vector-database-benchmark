...
task_data = {'name': '自动化测试', 'target': '目标：1， PoC：0', 'start_time': '-', 'status': 'waiting', 'type': 'risk_cruising', 'task_tag': 'risk_cruising', 'options': {'site_identify': True, 'site_capture': True, 'file_leak': False, 'site_spider': True, 'policy_name': '站点', 'related_scope_id': '', 'npoc_service_detection': False, 'poc_config': [], 'brute_config': []}, 'cruising_target': ['https://www.baidu.com']}
