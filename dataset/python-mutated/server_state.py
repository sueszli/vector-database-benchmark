...
class ServerState:
    ...
    opened_documents: Dict[Path, OpenedDocumentState] = dataclasses.field(default_factory=dict)
    diagnostics: Dict[Path, List[lsp.Diagnostic]] = dataclasses.field(default_factory=dict)
    status_tracker: Final[DaemonStatusTracker] = dataclasses.field(default_factory=DaemonStatusTracker)