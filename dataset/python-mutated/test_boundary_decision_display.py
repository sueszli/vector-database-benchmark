...
from sklearn.datasets import load_diabetes, load_iris, make_classification, make_multilabel_classification
...
(X, y) = make_classification(n_informative=1, n_redundant=1, n_clusters_per_class=1, n_features=2, random_state=42)
