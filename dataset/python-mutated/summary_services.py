...
DisplayableSummaryDictsType = Union[DisplayableCollectionSummaryDict, DisplayableExplorationSummaryDict]
_LIBRARY_INDEX_GROUPS: List[LibraryIndexGroupDict] = [{'header_i18n_id': 'I18N_LIBRARY_GROUPS_MATHEMATICS_&_STATISTICS', 'search_categories': ['Mathematics', 'Algebra', 'Arithmetic', 'Calculus', 'Combinatorics', 'Geometry', 'Graph Theory', 'Logic', 'Probability', 'Statistics', 'Trigonometry']}, {'header_i18n_id': 'I18N_LIBRARY_GROUPS_COMPUTING', 'search_categories': ['Algorithms', 'Computing', 'Programming']}, {'header_i18n_id': 'I18N_LIBRARY_GROUPS_SCIENCE', 'search_categories': ['Astronomy', 'Biology', 'Chemistry', 'Engineering', 'Environment', 'Medicine', 'Physics']}, {'header_i18n_id': 'I18N_LIBRARY_GROUPS_HUMANITIES', 'search_categories': ['Architecture', 'Art', 'Music', 'Philosophy', 'Poetry']}, {'header_i18n_id': 'I18N_LIBRARY_GROUPS_LANGUAGES', 'search_categories': ['Languages', 'Reading', 'English', 'Latin', 'Spanish', 'Gaulish']}, {'header_i18n_id': 'I18N_LIBRARY_GROUPS_SOCIAL_SCIENCE', 'search_categories': ['Business', 'Economics', 'Geography', 'Government', 'History', 'Law']}]
