...
class HackRF(Device):
    ...
    DEVICE_METHODS.update({Device.Command.SET_FREQUENCY.name: 'set_freq', Device.Command.SET_BANDWIDTH.name: 'set_baseband_filter_bandwidth', Device.Command.SET_BIAS_TEE_ENABLED.name: 'set_bias_tee'})
    DATA_TYPE = np.int8
