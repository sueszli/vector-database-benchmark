...
MULTIAPI_VERSION_NAMESPACE = ['azure.mgmt.storage', 'azure.mgmt.web', 'azure.mgmt.network', 'azure.mgmt.compute', 'azure.mgmt.containerregistry', 'azure.mgmt.containerservice', 'azure.mgmt.dns', 'azure.mgmt.eventhub', 'azure.mgmt.resource.resources', 'azure.mgmt.resource.features', 'azure.mgmt.resource.links', 'azure.mgmt.resource.locks', 'azure.mgmt.resource.policy', 'azure.mgmt.resource.subscriptions']
