...
class TestBase(IPUOpTest):
    ...
    def set_op_attrs(self):
        if False:
            while True:
                i = 10
        self.attrs = {'scale': 1.0, 'bias': 0.0, 'bias_after_scale': True}
...
class TestCase1(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            i = 10
            return i + 15
        self.attrs = {'scale': 5.0, 'bias': 0.0, 'bias_after_scale': True}
...
class TestCase2(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            i = 10
            return i + 15
        self.attrs = {'scale': 1.0, 'bias': 0.5, 'bias_after_scale': True}
...
class TestCase3(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            print('Hello World!')
        self.attrs = {'scale': 5.0, 'bias': 0.7, 'bias_after_scale': True}
...
class TestCase4(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            i = 10
            return i + 15
        self.attrs = {'scale': 1.0, 'bias': 0.0, 'bias_after_scale': False}
...
class TestCase5(TestBase):
    ...
    def set_op_attrs(self):
        if False:
            return 10
        self.attrs = {'bias': 0.0, 'bias_after_scale': True}
