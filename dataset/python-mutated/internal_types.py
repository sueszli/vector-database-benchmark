...
__all__ = ('ControllerRouterHandler', 'PathParameterDefinition', 'PathParameterDefinition', 'ReservedKwargs', 'ResponseType', 'RouteHandlerMapItem', 'RouteHandlerType')
if TYPE_CHECKING:
...
def __getattr__(name: str) -> Any:
    ...
    if name == 'LitestarType':
        warn_deprecation('2.2.1', 'LitestarType', 'import', removal_in='3.0.0', alternative='Litestar')
