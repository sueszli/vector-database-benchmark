...
if airflow_version >= '2.0.0':
    MOCK_DAGSTER_CONNECTION = Connection(conn_type='dagster', host='prod', password='test-token', description='test-org')
else:
    MOCK_DAGSTER_CONNECTION = Connection(conn_type='dagster', host='prod', password='test-token')
