...
from qt.core import QAbstractTextDocumentLayout, QApplication, QComboBox, QDate, QDateTime, QDateTimeEdit, QDialog, QDoubleSpinBox, QEvent, QFont, QFontInfo, QIcon, QKeySequence, QLineEdit, QLocale, QMenu, QPalette, QSize, QSpinBox, QStyle, QStyledItemDelegate, QStyleOptionComboBox, QStyleOptionSpinBox, QStyleOptionViewItem, Qt, QTextDocument, QUrl
...
from calibre.gui2.widgets2 import DateTimeEdit as DateTimeEditBase, RatingEditor, populate_standard_spinbox_context_menu
