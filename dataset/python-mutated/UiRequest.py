...
status_texts = {200: '200 OK', 206: '206 Partial Content', 400: '400 Bad Request', 403: '403 Forbidden', 404: '404 Not Found', 500: '500 Internal Server Error'}
content_types = {'asc': 'application/pgp-keys', 'css': 'text/css', 'gpg': 'application/pgp-encrypted', 'html': 'text/html', 'js': 'application/javascript', 'json': 'application/json', 'oga': 'audio/ogg', 'ogg': 'application/ogg', 'ogv': 'video/ogg', 'sig': 'application/pgp-signature', 'txt': 'text/plain', 'webmanifest': 'application/manifest+json', 'wasm': 'application/wasm', 'webp': 'image/webp'}
