...
class JPEG2000ImageTransformer(Transformer):
    ...
    def can_be_transformed(self, object: typing.Union[io.BufferedIOBase, io.RawIOBase, io.BytesIO, AnyPDFType]) -> bool:
        ...
        return isinstance(object, dict) and object.get('Type', None) in ['XObject', None] and (object.get('Subtype', None) == 'Image') and ('Filter' in object) and (object['Filter'] == 'JPXDecode' or (isinstance(object['Filter'], list) and object['Filter'][0] == 'JPXDecode'))
    ...
    def transform(self, object_to_transform: typing.Union[io.BufferedIOBase, io.RawIOBase, AnyPDFType], parent_object: typing.Any, context: typing.Optional[ReadTransformerState]=None, event_listeners: typing.List[EventListener]=[]) -> typing.Any:
        ...
        try:
            ...
            logger.debug('Unable to read jpeg2000 image. Constructing empty image of same dimensions.')
