...
class SqueezeBertModelTester(object):
    ...
    def get_config(self):
        if False:
            while True:
                i = 10
        return SqueezeBertConfig(embedding_size=self.hidden_size, vocab_size=self.vocab_size, hidden_size=self.hidden_size, num_hidden_layers=self.num_hidden_layers, num_attention_heads=self.num_attention_heads, intermediate_size=self.intermediate_size, hidden_act=self.hidden_act, attention_probs_dropout_prob=self.hidden_dropout_prob, attention_dropout=self.attention_probs_dropout_prob, max_position_embeddings=self.max_position_embeddings, initializer_range=self.initializer_range, q_groups=self.q_groups, k_groups=self.k_groups, v_groups=self.v_groups, post_attention_groups=self.post_attention_groups, intermediate_groups=self.intermediate_groups, output_groups=self.output_groups)

    def create_and_check_squeezebert_model(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            for i in range(10):
                print('nop')
    ...
    def create_and_check_squeezebert_for_masked_lm(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            while True:
                i = 10
    ...
    def create_and_check_squeezebert_for_question_answering(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            i = 10
            return i + 15
    ...
    def create_and_check_squeezebert_for_sequence_classification(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            return 10
    ...
    def create_and_check_squeezebert_for_token_classification(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            print('Hello World!')
        config.num_labels = self.num_labels
    ...
    def create_and_check_squeezebert_for_multiple_choice(self, config, input_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            for i in range(10):
                print('nop')
