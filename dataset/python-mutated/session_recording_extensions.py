...
SNAPSHOT_PERSIST_TIME_HISTOGRAM = Histogram('snapshot_persist_time_seconds', 'We persist recording snapshots from S3 or from ClickHouse, how long does that take?', labelnames=['source'])
