...
__protobuf__ = proto.module(package='google.cloud.notebooks.v1', manifest={'ListRuntimesRequest', 'ListRuntimesResponse', 'GetRuntimeRequest', 'CreateRuntimeRequest', 'DeleteRuntimeRequest', 'StartRuntimeRequest', 'StopRuntimeRequest', 'SwitchRuntimeRequest', 'ResetRuntimeRequest', 'UpgradeRuntimeRequest', 'ReportRuntimeEventRequest', 'UpdateRuntimeRequest', 'RefreshRuntimeTokenInternalRequest', 'RefreshRuntimeTokenInternalResponse', 'DiagnoseRuntimeRequest'})
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    runtimes: MutableSequence[gcn_runtime.Runtime] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcn_runtime.Runtime)
...
class CreateRuntimeRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    runtime_id: str = proto.Field(proto.STRING, number=2)
    runtime: gcn_runtime.Runtime = proto.Field(proto.MESSAGE, number=3, message=gcn_runtime.Runtime)
...
class SwitchRuntimeRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    machine_type: str = proto.Field(proto.STRING, number=2)
    accelerator_config: gcn_runtime.RuntimeAcceleratorConfig = proto.Field(proto.MESSAGE, number=3, message=gcn_runtime.RuntimeAcceleratorConfig)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpgradeRuntimeRequest(proto.Message):
    """Request for upgrading a Managed Notebook Runtime to the latest
...
class ReportRuntimeEventRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    vm_id: str = proto.Field(proto.STRING, number=2)
    event: gcn_event.Event = proto.Field(proto.MESSAGE, number=3, message=gcn_event.Event)
...
class UpdateRuntimeRequest(proto.Message):
    ...
    Attributes:
        ...
        request_id (str):
            Idempotent request UUID.
    """
    runtime: gcn_runtime.Runtime = proto.Field(proto.MESSAGE, number=1, message=gcn_runtime.Runtime)
...
class DiagnoseRuntimeRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    diagnostic_config: gcn_diagnostic_config.DiagnosticConfig = proto.Field(proto.MESSAGE, number=2, message=gcn_diagnostic_config.DiagnosticConfig)
