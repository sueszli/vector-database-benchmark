...
from typing import Any, Callable, Mapping, MutableMapping, Optional, Protocol, Sequence, Set, Tuple, cast
...
def package_relative_path(abs_path: str | None, package: str | None) -> str | None:
    ...
    return None
PLATFORM_FRAME_MUNGER: Mapping[str, SdkFrameMunger] = {'java': SdkFrameMunger(java_frame_munger), 'cocoa': SdkFrameMunger(cocoa_frame_munger), 'other': SdkFrameMunger(flutter_frame_munger, True, {'sentry.dart.flutter'})}
