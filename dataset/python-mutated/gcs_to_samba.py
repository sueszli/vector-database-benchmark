...
class GCSToSambaOperator(BaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('source_bucket', 'source_object', 'destination_path', 'impersonation_chain')
    ui_color = '#f0eee4'

    def __init__(self, *, source_bucket: str, source_object: str, destination_path: str, keep_directory_structure: bool=True, move_object: bool=False, gcp_conn_id: str='google_cloud_default', samba_conn_id: str='samba_default', impersonation_chain: str | Sequence[str] | None=None, **kwargs) -> None:
        if False:
            i = 10
            return i + 15
    ...
    def _copy_single_object(self, gcs_hook: GCSHook, samba_hook: SambaHook, source_object: str, destination_path: str) -> None:
        if False:
            for i in range(10):
                print('nop')
