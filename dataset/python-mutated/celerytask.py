...
celery.conf.update(task_acks_late=False, worker_prefetch_multiplier=1, broker_transport_options={'max_retries': 3, 'interval_start': 0, 'interval_step': 0.2, 'interval_max': 0.5})
