...
from wagtail.admin.localization import WAGTAILADMIN_PROVIDED_LANGUAGES, get_available_admin_languages, get_available_admin_time_zones
...
class TestAccountManagementForAdminOnlyUser(WagtailTestUtils, TestCase, TestAccountSectionUtilsMixin):
    """
