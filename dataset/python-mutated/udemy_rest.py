...
class UdemyActions:
    ...
    MY_COURSES = 'https://www.udemy.com/api-2.0/users/me/subscribed-courses/?ordering=-last_accessed&fields[course]=@min,enrollment_time,published_title,&fields[user]=@min'
    ...
    HEADERS = {'origin': 'https://www.udemy.com', 'accept': 'application/json, text/plain, */*', 'accept-encoding': 'gzip, deflate, br', 'content-type': 'application/json;charset=UTF-8', 'x-requested-with': 'XMLHttpRequest', 'x-checkout-version': '2', 'referer': 'https://www.udemy.com/'}
