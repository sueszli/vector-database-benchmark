...
class CTkEntry(CTkBaseClass):
    ...
    _valid_tk_entry_attributes = {'exportselection', 'insertborderwidth', 'insertofftime', 'insertontime', 'insertwidth', 'justify', 'selectborderwidth', 'show', 'takefocus', 'validate', 'validatecommand', 'xscrollcommand'}
