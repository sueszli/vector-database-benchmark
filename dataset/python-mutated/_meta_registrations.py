...
from torch._decomp import _add_op_to_registry, _convert_out_params, global_decomposition_table, meta_table
from torch._ops import OpOverload
from torch._prims import _elementwise_meta, ELEMENTWISE_PRIM_TYPE_PROMOTION_KIND
from torch._prims_common import corresponding_complex_dtype, corresponding_real_dtype, elementwise_dtypes, ELEMENTWISE_TYPE_PROMOTION_KIND, IntLike, make_contiguous_strides_for, TensorLike
from torch._prims_common.wrappers import _maybe_resize_out, _resize_output_check, _safe_copy_out, out_wrapper
...
_create_binary_float_meta_func([aten.special_chebyshev_polynomial_t.default, aten.special_chebyshev_polynomial_t.out, aten.special_chebyshev_polynomial_t.n_scalar_out])
_create_binary_float_meta_func([aten.special_chebyshev_polynomial_u.default, aten.special_chebyshev_polynomial_u.out, aten.special_chebyshev_polynomial_u.n_scalar_out])
_create_binary_float_meta_func([aten.special_hermite_polynomial_h.default, aten.special_hermite_polynomial_h.out, aten.special_hermite_polynomial_h.n_scalar_out])
_create_binary_float_meta_func([aten.special_hermite_polynomial_he.default, aten.special_hermite_polynomial_he.out, aten.special_hermite_polynomial_he.n_scalar_out])
_create_binary_float_meta_func([aten.special_laguerre_polynomial_l.default, aten.special_laguerre_polynomial_l.out, aten.special_laguerre_polynomial_l.n_scalar_out])
import torch._refs
