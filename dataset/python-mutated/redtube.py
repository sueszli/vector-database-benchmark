...
from ..utils import determine_ext, ExtractorError, int_or_none, merge_dicts, str_to_int, unified_strdate, url_or_none

class RedTubeIE(InfoExtractor):
    _VALID_URL = 'https?://(?:(?:\\w+\\.)?redtube\\.com/|embed\\.redtube\\.com/\\?.*?\\bid=)(?P<id>[0-9]+)'
    _EMBED_REGEX = ['<iframe[^>]+?src=["\\\'](?P<url>(?:https?:)?//embed\\.redtube\\.com/\\?.*?\\bid=\\d+)']
    _TESTS = [{'url': 'https://www.redtube.com/38864951', 'md5': '4fba70cbca3aefd25767ab4b523c9878', 'info_dict': {'id': '38864951', 'ext': 'mp4', 'title': 'Public Sex on the Balcony in Freezing Paris! Amateur Couple LeoLulu', 'description': 'Watch video Public Sex on the Balcony in Freezing Paris! Amateur Couple LeoLulu on Redtube, home of free Blowjob porn videos and Blonde sex movies online. Video length: (10:46) - Uploaded by leolulu - Verified User - Starring Pornstar: Leolulu', 'upload_date': '20210111', 'timestamp': 1610343109, 'duration': 646, 'view_count': int, 'age_limit': 18, 'thumbnail': 're:https://\\wi-ph\\.rdtcdn\\.com/videos/.+/.+\\.jpg'}}, {'url': 'http://embed.redtube.com/?bgcolor=000000&id=1443286', 'only_matching': True}, {'url': 'http://it.redtube.com/66418', 'only_matching': True}]
