...
def main():
    ...
    response = client.private_endpoint_connections.get(resource_group_name='myResourceGroup', registry_name='myRegistry', private_endpoint_connection_name='myConnection')
    print(response)
