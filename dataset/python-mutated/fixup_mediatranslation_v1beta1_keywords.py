...
class mediatranslationCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'streaming_translate_speech': ('streaming_config', 'audio_content')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=mediatranslationCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
