...
class Test_cloudformation_stacks_termination_protection_enabled:
    ...
    def test_no_stacks(self):
        ...
        with mock.patch('prowler.providers.aws.services.cloudformation.cloudformation_service.CloudFormation', new=cloudformation_client):
            from prowler.providers.aws.services.cloudformation.cloudformation_stacks_termination_protection_enabled.cloudformation_stacks_termination_protection_enabled import cloudformation_stacks_termination_protection_enabled
    ...
    def test_stack_termination_protection_enabled(self):
        ...
        with mock.patch('prowler.providers.aws.services.cloudformation.cloudformation_service.CloudFormation', cloudformation_client):
            ...
            assert result[0].status_extended == f'CloudFormation {stack_name} has termination protection enabled.'
    ...
    def test_stack_termination_protection_disabled(self):
        ...
        with mock.patch('prowler.providers.aws.services.cloudformation.cloudformation_service.CloudFormation', cloudformation_client):
            ...
            assert result[0].status_extended == f'CloudFormation {stack_name} has termination protection disabled.'
            assert result[0].resource_id == 'Test-Stack'
            assert result[0].resource_arn == 'arn:aws:cloudformation:eu-west-1:123456789012:stack/Test-Stack/796c8d26-b390-41d7-a23c-0702c4e78b60'
            assert result[0].region == AWS_REGION
            assert result[0].resource_tags == []