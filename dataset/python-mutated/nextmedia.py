...
class NextMediaIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://hk.apple.nextmedia.com/realtime/news/20141108/53109199', 'md5': 'dff9fad7009311c421176d1ac90bfe4f', 'info_dict': {'id': '53109199', 'ext': 'mp4', 'title': '【佔領金鐘】50外國領事議員撐場 讚學生勇敢香港有希望', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:28222b9912b6665a21011b034c70fcc7', 'timestamp': 1415456273, 'upload_date': '20141108'}}]
    _URL_PATTERN = "\\{ url: \\'(.+)\\' \\}"
...
class NextMediaActionNewsIE(NextMediaIE):
    ...
    _TESTS = [{'url': 'http://hk.dv.nextmedia.com/actionnews/hit/20150121/19009428/20061460', 'md5': '05fce8ffeed7a5e00665d4b7cf0f9201', 'info_dict': {'id': '19009428', 'ext': 'mp4', 'title': '【壹週刊】細10年男友偷食\u300050歲邵美琪再失戀', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:cd802fad1f40fd9ea178c1e2af02d659', 'timestamp': 1421791200, 'upload_date': '20150120'}}]
...
class AppleDailyIE(NextMediaIE):
    ...
    _TESTS = [{'url': 'http://ent.appledaily.com.tw/enews/article/entertainment/20150128/36354694', 'md5': 'a843ab23d150977cc55ef94f1e2c1e4d', 'info_dict': {'id': '36354694', 'ext': 'mp4', 'title': '周亭羽走過摩鐵陰霾2男陪吃 九把刀孤寒看醫生', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:2acd430e59956dc47cd7f67cb3c003f4', 'upload_date': '20150128'}}, {'url': 'http://www.appledaily.com.tw/realtimenews/article/strange/20150128/550549/%E4%B8%8D%E6%BB%BF%E8%A2%AB%E8%B8%A9%E8%85%B3%E3%80%80%E5%B1%B1%E6%9D%B1%E5%85%A9%E5%A4%A7%E5%AA%BD%E4%B8%80%E8%B7%AF%E6%89%93%E4%B8%8B%E8%BB%8A', 'md5': '86b4e9132d158279c7883822d94ccc49', 'info_dict': {'id': '550549', 'ext': 'mp4', 'title': '不滿被踩腳\u3000山東兩大媽一路打下車', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:175b4260c1d7c085993474217e4ab1b4', 'upload_date': '20150128'}}, {'url': 'http://www.appledaily.com.tw/animation/realtimenews/new/20150128/5003671', 'md5': '03df296d95dedc2d5886debbb80cb43f', 'info_dict': {'id': '5003671', 'ext': 'mp4', 'title': '20正妹熱舞\u3000《刀龍傳說Online》火辣上市', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:23c0aac567dc08c9c16a3161a2c2e3cd', 'upload_date': '20150128'}, 'skip': 'redirect to http://www.appledaily.com.tw/animation/'}, {'url': 'http://www.appledaily.com.tw/animation/realtimenews/new/20150128/5003673/', 'md5': 'b06182cd386ea7bc6115ec7ff0f72aeb', 'info_dict': {'id': '5003673', 'ext': 'mp4', 'title': '半夜尿尿\u3000好像會看到___', 'description': 'md5:61d2da7fe117fede148706cdb85ac066', 'upload_date': '20150128'}, 'expected_warnings': ['video thumbnail'], 'skip': 'redirect to http://www.appledaily.com.tw/animation/'}, {'url': 'http://www.appledaily.com.tw/appledaily/article/supplement/20140417/35770334/', 'md5': 'eaa20e6b9df418c912d7f5dec2ba734d', 'info_dict': {'id': '35770334', 'ext': 'mp4', 'title': '咖啡占卜測 XU裝熟指數', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:7b859991a6a4fedbdf3dd3b66545c748', 'upload_date': '20140417'}}, {'url': 'http://www.appledaily.com.tw/actionnews/appledaily/7/20161003/960588/', 'only_matching': True}, {'url': 'http://ent.appledaily.com.tw/section/article/headline/20150128/36354694', 'only_matching': True}]
    _URL_PATTERN = "\\{url: \\'(.+)\\'\\}"
...
class NextTVIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.nexttv.com.tw/news/realtime/politics/11779671', 'info_dict': {'id': '11779671', 'ext': 'mp4', 'title': '「超收稅」近4千億！\u3000藍議員籲發消費券', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1484825400, 'upload_date': '20170119', 'view_count': int}}
