...
import six
__all__ = ['main']
cfg.CONF.register_cli_opt(cfg.StrOpt('spec-file', short='f', required=False, default='st2common/st2common/openapi.yaml'))
cfg.CONF.register_cli_opt(cfg.BoolOpt('validate-defs', short='-d', required=False, default=False))
