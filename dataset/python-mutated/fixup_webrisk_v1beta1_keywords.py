...
class webriskCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'compute_threat_list_diff': ('threat_type', 'constraints', 'version_token'), 'search_hashes': ('threat_types', 'hash_prefix'), 'search_uris': ('uri', 'threat_types')}
