...
def main():
    ...
    response = client.private_endpoint_connections.get_by_host_pool(resource_group_name='resourceGroup1', host_pool_name='hostPool1', private_endpoint_connection_name='hostPool1.377103f1-5179-4bdf-8556-4cdd3207cc5b')
    print(response)
