...
class ScoringHistory:
    _default_metrics_ = dict(binomial='logloss', multinomial='classification_error', regression='rmse')
    _allowed_metrics_ = dict(binomial=['logloss', 'auc', 'classification_error', 'rmse'], multinomial=['logloss', 'classification_error', 'rmse'], regression=['rmse', 'deviance', 'mae'])
...
class ScoringHistoryGLM(ScoringHistory):
    _default_metrics_ = {}
    _allowed_metrics_ = dict(binomial=['logloss', 'auc', 'classification_error', 'rmse', 'objective', 'negative_log_likelihood'])
