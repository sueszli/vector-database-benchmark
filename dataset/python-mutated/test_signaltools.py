...
@testing.parameterize(*testing.product({'size1': [(10,), (5, 10), (10, 3), (3, 4, 10)], 'size2': [3, 4, 5, 10], 'mode': ['full', 'same', 'valid']}))
...
class TestConvolveCorrelate:
    ...
    tols = {np.float32: 1e-05, np.complex64: 1e-05, np.float16: 0.001, 'default': 1e-10}
...
class TestFFTConvolve:
    ...
    tols = {np.float32: 0.001, np.complex64: 0.001, np.float16: 0.001, 'default': 1e-08}
...
@testing.parameterize(*testing.product({'size1': [(10,), (5, 10), (10, 3), (3, 10, 15)], 'size2': [3, 4, 5, 10, None], 'mode': ['full', 'same', 'valid']}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'size1': [(5, 10), (10, 7)], 'size2': [(3, 2), (3, 3), (2, 2), (10, 10), (11, 11)], 'mode': ['full', 'same', 'valid'], 'boundary': ['fill'], 'fillvalue': [0, 1, -1]}) + testing.product({'size1': [(5, 10), (10, 7)], 'size2': [(3, 2), (3, 3), (2, 2), (10, 10), (11, 11)], 'mode': ['full', 'same', 'valid'], 'boundary': ['wrap', 'symm'], 'fillvalue': [0]}))
@testing.with_requires('scipy')
class TestConvolveCorrelate2D:
    ...
    tols = {np.float32: 0.0005, np.complex64: 0.0005, np.float16: 0.001, 'default': 1e-10}
...
@testing.parameterize(*testing.product({'im': [(10,), (5, 10), (10, 3), (3, 4, 10)], 'mysize': [3, 4, (3, 4, 5)], 'noise': [False, True]}))
@testing.with_requires('scipy')
class TestWiener:
    tols = {np.float32: 1e-05, np.complex64: 1e-05, np.float16: 0.001, 'default': 1e-10}
...
@testing.parameterize(*testing.product({'a': [(10,), (5, 10), (10, 3), (3, 4, 10)], 'domain': [3, 4, (3, 3, 5)], 'rank': [0, 1, 2]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'volume': [(10,), (5, 10), (10, 5), (5, 6, 10)], 'kernel_size': [3, 4, (3, 3, 5)]}))
class TestMedFilt:
...
@testing.parameterize(*testing.product({'input': [(5, 10), (10, 5)], 'kernel_size': [3, 4, (3, 5)]}))
class TestMedFilt2d:
