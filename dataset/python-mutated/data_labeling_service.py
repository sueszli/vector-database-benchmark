...
class CreateDatasetRequest(proto.Message):
    ...
    dataset: gcd_dataset.Dataset = proto.Field(proto.MESSAGE, number=2, message=gcd_dataset.Dataset)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    datasets: MutableSequence[gcd_dataset.Dataset] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_dataset.Dataset)
...
class ImportDataRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    input_config: gcd_dataset.InputConfig = proto.Field(proto.MESSAGE, number=2, message=gcd_dataset.InputConfig)
    user_email_address: str = proto.Field(proto.STRING, number=3)
...
class ExportDataRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    annotated_dataset: str = proto.Field(proto.STRING, number=2)
    filter: str = proto.Field(proto.STRING, number=3)
    output_config: gcd_dataset.OutputConfig = proto.Field(proto.MESSAGE, number=4, message=gcd_dataset.OutputConfig)
    user_email_address: str = proto.Field(proto.STRING, number=5)
...
class ListDataItemsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    data_items: MutableSequence[gcd_dataset.DataItem] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_dataset.DataItem)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    annotated_datasets: MutableSequence[gcd_dataset.AnnotatedDataset] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_dataset.AnnotatedDataset)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class LabelImageRequest(proto.Message):
    ...
    class Feature(proto.Enum):
        ...
        POLYLINE = 4
        SEGMENTATION = 5
    image_classification_config: human_annotation_config.ImageClassificationConfig = proto.Field(proto.MESSAGE, number=4, oneof='request_config', message=human_annotation_config.ImageClassificationConfig)
    bounding_poly_config: human_annotation_config.BoundingPolyConfig = proto.Field(proto.MESSAGE, number=5, oneof='request_config', message=human_annotation_config.BoundingPolyConfig)
    polyline_config: human_annotation_config.PolylineConfig = proto.Field(proto.MESSAGE, number=6, oneof='request_config', message=human_annotation_config.PolylineConfig)
    segmentation_config: human_annotation_config.SegmentationConfig = proto.Field(proto.MESSAGE, number=7, oneof='request_config', message=human_annotation_config.SegmentationConfig)
    parent: str = proto.Field(proto.STRING, number=1)
    basic_config: human_annotation_config.HumanAnnotationConfig = proto.Field(proto.MESSAGE, number=2, message=human_annotation_config.HumanAnnotationConfig)
    feature: Feature = proto.Field(proto.ENUM, number=3, enum=Feature)
...
class LabelVideoRequest(proto.Message):
    ...
    class Feature(proto.Enum):
        ...
        OBJECT_TRACKING = 3
        EVENT = 4
    video_classification_config: human_annotation_config.VideoClassificationConfig = proto.Field(proto.MESSAGE, number=4, oneof='request_config', message=human_annotation_config.VideoClassificationConfig)
    object_detection_config: human_annotation_config.ObjectDetectionConfig = proto.Field(proto.MESSAGE, number=5, oneof='request_config', message=human_annotation_config.ObjectDetectionConfig)
    object_tracking_config: human_annotation_config.ObjectTrackingConfig = proto.Field(proto.MESSAGE, number=6, oneof='request_config', message=human_annotation_config.ObjectTrackingConfig)
    event_config: human_annotation_config.EventConfig = proto.Field(proto.MESSAGE, number=7, oneof='request_config', message=human_annotation_config.EventConfig)
    parent: str = proto.Field(proto.STRING, number=1)
    basic_config: human_annotation_config.HumanAnnotationConfig = proto.Field(proto.MESSAGE, number=2, message=human_annotation_config.HumanAnnotationConfig)
    feature: Feature = proto.Field(proto.ENUM, number=3, enum=Feature)
...
class LabelTextRequest(proto.Message):
    ...
    class Feature(proto.Enum):
        ...
        TEXT_CLASSIFICATION = 1
        TEXT_ENTITY_EXTRACTION = 2
    text_classification_config: human_annotation_config.TextClassificationConfig = proto.Field(proto.MESSAGE, number=4, oneof='request_config', message=human_annotation_config.TextClassificationConfig)
    text_entity_extraction_config: human_annotation_config.TextEntityExtractionConfig = proto.Field(proto.MESSAGE, number=5, oneof='request_config', message=human_annotation_config.TextEntityExtractionConfig)
    parent: str = proto.Field(proto.STRING, number=1)
    basic_config: human_annotation_config.HumanAnnotationConfig = proto.Field(proto.MESSAGE, number=2, message=human_annotation_config.HumanAnnotationConfig)
    feature: Feature = proto.Field(proto.ENUM, number=6, enum=Feature)
...
class ListExamplesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    examples: MutableSequence[gcd_dataset.Example] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_dataset.Example)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateAnnotationSpecSetRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    annotation_spec_set: gcd_annotation_spec_set.AnnotationSpecSet = proto.Field(proto.MESSAGE, number=2, message=gcd_annotation_spec_set.AnnotationSpecSet)
...
class ListAnnotationSpecSetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    annotation_spec_sets: MutableSequence[gcd_annotation_spec_set.AnnotationSpecSet] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_annotation_spec_set.AnnotationSpecSet)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateInstructionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    instruction: gcd_instruction.Instruction = proto.Field(proto.MESSAGE, number=2, message=gcd_instruction.Instruction)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    instructions: MutableSequence[gcd_instruction.Instruction] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_instruction.Instruction)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SearchEvaluationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    evaluations: MutableSequence[evaluation.Evaluation] = proto.RepeatedField(proto.MESSAGE, number=1, message=evaluation.Evaluation)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SearchExampleComparisonsResponse(proto.Message):
    ...
    class ExampleComparison(proto.Message):
        """Example comparisons comparing ground truth output and
        ...
        """
        ground_truth_example: gcd_dataset.Example = proto.Field(proto.MESSAGE, number=1, message=gcd_dataset.Example)
        model_created_examples: MutableSequence[gcd_dataset.Example] = proto.RepeatedField(proto.MESSAGE, number=2, message=gcd_dataset.Example)
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    example_comparisons: MutableSequence[ExampleComparison] = proto.RepeatedField(proto.MESSAGE, number=1, message=ExampleComparison)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateEvaluationJobRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    job: gcd_evaluation_job.EvaluationJob = proto.Field(proto.MESSAGE, number=2, message=gcd_evaluation_job.EvaluationJob)
...
class UpdateEvaluationJobRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            them with commas.
    """
    evaluation_job: gcd_evaluation_job.EvaluationJob = proto.Field(proto.MESSAGE, number=1, message=gcd_evaluation_job.EvaluationJob)
...
class ListEvaluationJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    evaluation_jobs: MutableSequence[gcd_evaluation_job.EvaluationJob] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_evaluation_job.EvaluationJob)
    next_page_token: str = proto.Field(proto.STRING, number=2)
