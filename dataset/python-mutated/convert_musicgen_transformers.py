...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='small', type=str, help="Checkpoint size of the MusicGen model you'd like to convert. Can be one of: `['small', 'medium', 'large']` for the mono checkpoints, or `['facebook/musicgen-stereo-small', 'facebook/musicgen-stereo-medium', 'facebook/musicgen-stereo-large']` for the stereo checkpoints.")
