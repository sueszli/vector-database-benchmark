...
AUGMENTATION_PIPELINE_OPS = [False, True, [{'type': 'random_blur'}, {'type': 'random_rotate'}]]
IMAGE_ENCODER = [{'type': 'stacked_cnn'}, {'type': 'alexnet', 'use_pretrained': False, 'model_cache_dir': os.path.join(os.getcwd(), 'tv_cache')}]
IMAGE_PREPROCESSING = [{'standardize_image': None, 'width': 300, 'height': 300}, {'standardize_image': IMAGENET1K, 'width': 300, 'height': 300}]
