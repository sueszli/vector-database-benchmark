...
class TestGoogleProviderProjectStructure(ExampleCoverageTest, AssetsCoverageTest):
    ...
    DEPRECATED_CLASSES = {'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceS3ToGCSOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceGCSToGCSOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitHadoopJobOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocScaleClusterOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitSparkJobOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitSparkSqlJobOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitHiveJobOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitPigJobOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocSubmitPySparkJobOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineManageModelOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineManageVersionOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineCreateModelOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineCreateVersionOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineDeleteModelOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineDeleteVersionOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineGetModelOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineListVersionsOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineSetDefaultVersionOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineStartBatchPredictionJobOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineStartTrainingJobOperator', 'airflow.providers.google.cloud.operators.dataflow.DataflowCreateJavaJobOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryPatchDatasetOperator', 'airflow.providers.google.cloud.operators.dataflow.DataflowCreatePythonJobOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryExecuteQueryOperator', 'airflow.providers.google.marketing_platform.operators.GoogleDisplayVideo360CreateQueryOperator', 'airflow.providers.google.marketing_platform.operators.GoogleDisplayVideo360RunQueryOperator', 'airflow.providers.google.marketing_platform.operators.GoogleDisplayVideo360DownloadReportV2Operator', 'airflow.providers.google.marketing_platform.sensors.GoogleDisplayVideo360RunQuerySensor'}
    BASE_CLASSES = {'airflow.providers.google.cloud.operators.compute.ComputeEngineBaseOperator', 'airflow.providers.google.cloud.transfers.bigquery_to_sql.BigQueryToSqlBaseOperator', 'airflow.providers.google.cloud.operators.cloud_sql.CloudSQLBaseOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocJobBaseOperator', 'airflow.providers.google.cloud.operators.vertex_ai.custom_job.CustomTrainingJobBaseOperator', 'airflow.providers.google.cloud.operators.cloud_base.GoogleCloudBaseOperator'}
    MISSING_EXAMPLES_FOR_CLASSES = {'airflow.providers.google.cloud.operators.mlengine.MLEngineTrainingCancelJobOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPRedactImageOperator', 'airflow.providers.google.cloud.transfers.cassandra_to_gcs.CassandraToGCSOperator', 'airflow.providers.google.cloud.transfers.adls_to_gcs.ADLSToGCSOperator', 'airflow.providers.google.cloud.transfers.sql_to_gcs.BaseSQLToGCSOperator', 'airflow.providers.google.cloud.operators.vertex_ai.endpoint_service.GetEndpointOperator', 'airflow.providers.google.cloud.operators.vertex_ai.auto_ml.AutoMLTrainingJobBaseOperator', 'airflow.providers.google.cloud.operators.vertex_ai.endpoint_service.UpdateEndpointOperator', 'airflow.providers.google.cloud.operators.vertex_ai.batch_prediction_job.GetBatchPredictionJobOperator'}
    ASSETS_NOT_REQUIRED = {'airflow.providers.google.cloud.operators.automl.AutoMLDeleteDatasetOperator', 'airflow.providers.google.cloud.operators.automl.AutoMLDeleteModelOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryCheckOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryDeleteDatasetOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryDeleteTableOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryIntervalCheckOperator', 'airflow.providers.google.cloud.operators.bigquery.BigQueryValueCheckOperator', 'airflow.providers.google.cloud.operators.bigquery_dts.BigQueryDeleteDataTransferConfigOperator', 'airflow.providers.google.cloud.operators.bigtable.BigtableDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.bigtable.BigtableDeleteTableOperator', 'airflow.providers.google.cloud.operators.cloud_build.CloudBuildDeleteBuildTriggerOperator', 'airflow.providers.google.cloud.operators.cloud_memorystore.CloudMemorystoreDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.cloud_memorystore.CloudMemorystoreMemcachedDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.cloud_sql.CloudSQLBaseOperator', 'airflow.providers.google.cloud.operators.cloud_sql.CloudSQLDeleteInstanceDatabaseOperator', 'airflow.providers.google.cloud.operators.cloud_sql.CloudSQLDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceDeleteJobOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceGetOperationOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceListOperationsOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServicePauseOperationOperator', 'airflow.providers.google.cloud.operators.cloud_storage_transfer_service.CloudDataTransferServiceResumeOperationOperator', 'airflow.providers.google.cloud.operators.compute.ComputeEngineBaseOperator', 'airflow.providers.google.cloud.operators.datacatalog.CloudDataCatalogDeleteEntryGroupOperator', 'airflow.providers.google.cloud.operators.datacatalog.CloudDataCatalogDeleteEntryOperator', 'airflow.providers.google.cloud.operators.datacatalog.CloudDataCatalogDeleteTagOperator', 'airflow.providers.google.cloud.operators.datacatalog.CloudDataCatalogDeleteTagTemplateFieldOperator', 'airflow.providers.google.cloud.operators.datacatalog.CloudDataCatalogDeleteTagTemplateOperator', 'airflow.providers.google.cloud.operators.datafusion.CloudDataFusionDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.datafusion.CloudDataFusionDeletePipelineOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocDeleteBatchOperator', 'airflow.providers.google.cloud.operators.dataproc.DataprocDeleteClusterOperator', 'airflow.providers.google.cloud.operators.dataproc_metastore.DataprocMetastoreDeleteBackupOperator', 'airflow.providers.google.cloud.operators.dataproc_metastore.DataprocMetastoreDeleteServiceOperator', 'airflow.providers.google.cloud.operators.datastore.CloudDatastoreBeginTransactionOperator', 'airflow.providers.google.cloud.operators.datastore.CloudDatastoreDeleteOperationOperator', 'airflow.providers.google.cloud.operators.datastore.CloudDatastoreGetOperationOperator', 'airflow.providers.google.cloud.operators.datastore.CloudDatastoreRollbackOperator', 'airflow.providers.google.cloud.operators.datastore.CloudDatastoreRunQueryOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeidentifyContentOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeleteDLPJobOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeleteDeidentifyTemplateOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeleteInspectTemplateOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeleteJobTriggerOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPDeleteStoredInfoTypeOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPInspectContentOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPRedactImageOperator', 'airflow.providers.google.cloud.operators.dlp.CloudDLPReidentifyContentOperator', 'airflow.providers.google.cloud.operators.functions.CloudFunctionDeleteFunctionOperator', 'airflow.providers.google.cloud.operators.gcs.GCSDeleteBucketOperator', 'airflow.providers.google.cloud.operators.gcs.GCSDeleteObjectsOperator', 'airflow.providers.google.cloud.operators.kubernetes_engine.GKEDeleteClusterOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineDeleteModelOperator', 'airflow.providers.google.cloud.operators.mlengine.MLEngineDeleteVersionOperator', 'airflow.providers.google.cloud.operators.pubsub.PubSubDeleteSubscriptionOperator', 'airflow.providers.google.cloud.operators.pubsub.PubSubDeleteTopicOperator', 'airflow.providers.google.cloud.operators.spanner.SpannerDeleteDatabaseInstanceOperator', 'airflow.providers.google.cloud.operators.spanner.SpannerDeleteInstanceOperator', 'airflow.providers.google.cloud.operators.stackdriver.StackdriverDeleteAlertOperator', 'airflow.providers.google.cloud.operators.stackdriver.StackdriverDeleteNotificationChannelOperator', 'airflow.providers.google.cloud.operators.tasks.CloudTasksQueueDeleteOperator', 'airflow.providers.google.cloud.operators.tasks.CloudTasksTaskDeleteOperator', 'airflow.providers.google.cloud.operators.translate.CloudTranslateTextOperator', 'airflow.providers.google.cloud.operators.translate_speech.CloudTranslateSpeechOperator', 'airflow.providers.google.cloud.operators.vision.CloudVisionDeleteProductOperator', 'airflow.providers.google.cloud.operators.vision.CloudVisionDeleteProductSetOperator', 'airflow.providers.google.cloud.operators.vision.CloudVisionDeleteReferenceImageOperator', 'airflow.providers.google.cloud.operators.workflows.WorkflowsDeleteWorkflowOperator', 'airflow.providers.google.marketing_platform.sensors.campaign_manager.GoogleCampaignManagerReportSensor', 'airflow.providers.google.marketing_platform.sensors.display_video.GoogleDisplayVideo360GetSDFDownloadOperationSensor', 'airflow.providers.google.marketing_platform.sensors.display_video.GoogleDisplayVideo360ReportSensor', 'airflow.providers.google.marketing_platform.sensors.search_ads.GoogleSearchAdsReportSensor'}
...
class TestAmazonProviderProjectStructure(ExampleCoverageTest):
    ...
    BASE_CLASSES = {'airflow.providers.amazon.aws.operators.base_aws.AwsBaseOperator', 'airflow.providers.amazon.aws.operators.rds.RdsBaseOperator', 'airflow.providers.amazon.aws.operators.sagemaker.SageMakerBaseOperator', 'airflow.providers.amazon.aws.sensors.base_aws.AwsBaseSensor', 'airflow.providers.amazon.aws.sensors.dms.DmsTaskBaseSensor', 'airflow.providers.amazon.aws.sensors.emr.EmrBaseSensor', 'airflow.providers.amazon.aws.sensors.rds.RdsBaseSensor', 'airflow.providers.amazon.aws.sensors.sagemaker.SageMakerBaseSensor', 'airflow.providers.amazon.aws.operators.appflow.AppflowBaseOperator', 'airflow.providers.amazon.aws.operators.ecs.EcsBaseOperator', 'airflow.providers.amazon.aws.sensors.ecs.EcsBaseSensor', 'airflow.providers.amazon.aws.sensors.eks.EksBaseSensor', 'airflow.providers.amazon.aws.transfers.base.AwsToAwsBaseOperator'}
    MISSING_EXAMPLES_FOR_CLASSES = {'airflow.providers.amazon.aws.transfers.exasol_to_s3.ExasolToS3Operator', 'airflow.providers.amazon.aws.sensors.glue_catalog_partition.GlueCatalogPartitionSensor'}
    DEPRECATED_CLASSES = {'airflow.providers.amazon.aws.operators.lambda_function.AwsLambdaInvokeFunctionOperator'}

class TestElasticsearchProviderProjectStructure(ExampleCoverageTest):
    PROVIDER = 'elasticsearch'
    CLASS_DIRS = {'hooks'}
    CLASS_SUFFIXES = ['Hook']
    DEPRECATED_CLASSES = {'airflow.providers.elasticsearch.hooks.elasticsearch.ElasticsearchHook'}

class TestCncfProviderProjectStructure(ExampleCoverageTest):
    PROVIDER = 'cncf'
    CLASS_DIRS = ProjectStructureTest.CLASS_DIRS
    DEPRECATED_CLASSES = {'airflow.providers.cncf.kubernetes.operators.kubernetes_pod', 'airflow.providers.cncf.kubernetes.triggers.kubernetes_pod'}
...
class TestSlackProviderProjectStructure(ExampleCoverageTest):
    PROVIDER = 'slack'
    CLASS_DIRS = ProjectStructureTest.CLASS_DIRS
    BASE_CLASSES = {'airflow.providers.slack.transfers.base_sql_to_slack.BaseSqlToSlackOperator', 'airflow.providers.slack.operators.slack.SlackAPIOperator'}
    MISSING_EXAMPLES_FOR_CLASSES = set()
    DEPRECATED_CLASSES = {'airflow.providers.slack.notifications.slack_notifier.py.', 'airflow.providers.slack.transfers.sql_to_slack.SqlToSlackOperator'}
