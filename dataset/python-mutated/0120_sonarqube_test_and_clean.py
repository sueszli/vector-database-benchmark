...
class Migration(migrations.Migration):
    dependencies = [('dojo', '0119_default_group_is_staff')]
    operations = [migrations.RunPython(sq_clean), migrations.AddField(model_name='test', name='sonarqube_config', field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dojo.sonarqube_product', verbose_name='SonarQube Config')), migrations.AlterField(model_name='sonarqube_product', name='sonarqube_tool_config', field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dojo.tool_configuration', verbose_name='SonarQube Configuration'))]