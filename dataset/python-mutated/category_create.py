...
from ....core.types import BaseInputObjectType, NonNullList, ProductError, SeoInput, Upload
...
class CategoryInput(BaseInputObjectType):
    ...
    metadata = NonNullList(MetadataInput, description='Fields required to update the category metadata.' + ADDED_IN_38, required=False)
    private_metadata = NonNullList(MetadataInput, description='Fields required to update the category private metadata.' + ADDED_IN_38, required=False)
