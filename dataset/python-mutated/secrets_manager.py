...
DEFAULT_MASK_KEY_PATTERNS = ['password', 'host', 'user', '_key', '_id', 'token', 'secret', 'bucket', 'role_arn', 'service_account_info', 'account_id', 'api', 'domain_url', 'client_id', 'access', 'jwt', 'base_url', 'key', 'credentials', '_sid', 'survey_', 'appid', 'apikey', 'api_key']
