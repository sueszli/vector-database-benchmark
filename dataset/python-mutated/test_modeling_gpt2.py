...
if is_torch_available():
    import torch
    from transformers import GPT2_PRETRAINED_MODEL_ARCHIVE_LIST, GPT2DoubleHeadsModel, GPT2ForQuestionAnswering, GPT2ForSequenceClassification, GPT2ForTokenClassification, GPT2LMHeadModel, GPT2Model, GPT2Tokenizer
...
class GPT2ModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (GPT2Model, GPT2LMHeadModel, GPT2DoubleHeadsModel, GPT2ForQuestionAnswering, GPT2ForSequenceClassification, GPT2ForTokenClassification) if is_torch_available() else ()
    all_generative_model_classes = (GPT2LMHeadModel, GPT2DoubleHeadsModel) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': GPT2Model, 'question-answering': GPT2ForQuestionAnswering, 'text-classification': GPT2ForSequenceClassification, 'text-generation': GPT2LMHeadModel, 'token-classification': GPT2ForTokenClassification, 'zero-shot': GPT2ForSequenceClassification} if is_torch_available() else {}
