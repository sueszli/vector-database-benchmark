...
import sys
from qt.core import QAction, QApplication, QCheckBox, QDialog, QDialogButtonBox, QGridLayout, QIcon, QKeySequence, QLabel, QPainter, QPlainTextEdit, QSize, QSizePolicy, Qt, QTextBrowser, QTextDocument, QVBoxLayout, QWidget, pyqtSignal
...
if __name__ == '__main__':
    ...
    for author in sorted(merged):
        ...
        lines.append('</ol>')
    print(question_dialog(None, 'title', 'msg <a href="http://google.com">goog</a> ', det_msg='\n'.join(lines), show_copy_button=True))