...
if __name__ == '__main__':
    ...
    for index in range(len(URMs_train)):
        SVD_recommenders.append(PureSVDRecommender(URM_train=URMs_train[index], verbose=True))
    ...
    recommender = GeneralizedMergedHybridRecommender(URM_train=URMs_train[0], recommenders=[SVD_recommenders[0], SLIM_recommenders[0]], verbose=False)
    recommender.fit()
