...
from ..utils import urlencode_postdata, urljoin, int_or_none, clean_html, ExtractorError
...
class AluraIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://cursos.alura.com.br/course/clojure-mutabilidade-com-atoms-e-refs/task/60095', 'info_dict': {'id': '60095', 'ext': 'mp4', 'title': 'Referências, ref-set e alter'}, 'skip': 'Requires alura account credentials'}, {'url': 'https://cursos.alura.com.br/course/clojure-mutabilidade-com-atoms-e-refs/task/60098', 'only_matching': True}, {'url': 'https://cursos.alura.com.br/course/fundamentos-market-digital/task/55219', 'only_matching': True}]
...
class AluraCourseIE(AluraIE):
    ...
    _TESTS = [{'url': 'https://cursos.alura.com.br/course/clojure-mutabilidade-com-atoms-e-refs', 'only_matching': True}]
