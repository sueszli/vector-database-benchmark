...
PROJECTION_TABLES = [('sharded_events', True), ('sharded_session_recording_events', True), ('person', False), ('person_distinct_id2', False)]
INDEX_TABLES = [('sharded_events', True), ('events_dead_letter_queue', False)]

class Migration(AsyncMigrationDefinition):
    description = 'Create projections and indexes on max(_timestamp) to speed up queries. Requires ClickHouse 22.3 or above'
