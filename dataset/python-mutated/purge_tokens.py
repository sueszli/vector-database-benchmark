...
def _register_cli_opts():
    if False:
        return 10
    cli_opts = [cfg.StrOpt('timestamp', default=None, help='Will delete tokens whose expiry is older than ' + 'this UTC timestamp. ' + 'Example value: 2015-03-13T19:01:27.255542Z')]
