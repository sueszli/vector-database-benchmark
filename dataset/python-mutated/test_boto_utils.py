...
from samcli.lib.utils.boto_utils import get_boto_config_with_user_agent, get_boto_client_provider_with_config, get_boto_resource_provider_with_config, get_boto_resource_provider_from_session_with_config, get_boto_client_provider_from_session_with_config, get_client_error_code
TEST_VERSION = '1.0.0'
