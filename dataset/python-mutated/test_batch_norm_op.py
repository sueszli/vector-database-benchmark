...
from op_test import OpTest, _set_use_system_allocator, convert_float_to_uint16, convert_uint16_to_float
import paddle
...
class TestBatchNormOpFreezeStatsAndScaleBiasTraining(TestBatchNormOpFreezeStatsTraining):
