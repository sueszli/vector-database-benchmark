...
class LocalPackageList(PackageList):
    PACKAGE_CATEGORIES = {'installed': {'plugin': catalog.i18nc('@label', 'Installed Plugins'), 'material': catalog.i18nc('@label', 'Installed Materials')}, 'bundled': {'plugin': catalog.i18nc('@label', 'Bundled Plugins'), 'material': catalog.i18nc('@label', 'Bundled Materials')}}
