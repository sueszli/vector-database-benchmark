...
class VimeoCom(SimpleDownloader):
    ...
    NAME_PATTERN = '<title>(?P<N>.+?) on Vimeo<'
    OFFLINE_PATTERN = 'class="exception_header"'
    TEMP_OFFLINE_PATTERN = 'Please try again in a few minutes.<'
    URL_REPLACEMENTS = [(__pattern__ + '.*', 'https://vimeo.com/\\g<ID>')]
