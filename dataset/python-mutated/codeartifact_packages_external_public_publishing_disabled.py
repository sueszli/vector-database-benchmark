...
from prowler.providers.aws.services.codeartifact.codeartifact_client import codeartifact_client
from prowler.providers.aws.services.codeartifact.codeartifact_service import OriginInformationValues, RestrictionValues
    ...
    def execute(self):
        ...
        for repository in codeartifact_client.repositories.values():
            for package in repository.packages:
                ...
                if package.latest_version.origin.origin_type in (OriginInformationValues.INTERNAL, OriginInformationValues.UNKNOWN):
                    if package.origin_configuration.restrictions.upstream == RestrictionValues.ALLOW:
                        report.status = 'FAIL'
