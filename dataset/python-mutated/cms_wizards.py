...
cms_page_wizard = CMSPageWizard(title=_('New page'), weight=100, form=CreateCMSPageForm, model=Page, description=_('Create a new page next to the current page.'))
cms_subpage_wizard = CMSSubPageWizard(title=_('New sub page'), weight=110, form=CreateCMSSubPageForm, model=Page, description=_('Create a page below the current page.'))
