...
class MyviEmbedIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.myvi.tv/embed/ccdqic3wgkqwpb36x9sxg43t4r', 'info_dict': {'id': 'b3ea0663-3234-469d-873e-7fecf36b31d1', 'ext': 'mp4', 'title': 'Твоя (original song).mp4', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 277}, 'params': {'skip_download': True}}, {'url': 'https://www.myvi.tv/idmi6o?v=ccdqic3wgkqwpb36x9sxg43t4r#watch', 'only_matching': True}]
