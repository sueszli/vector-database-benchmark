...
class Migration(migrations.Migration):
    ...
    operations = [migrations.AlterField(model_name='address', name='phone', field=phonenumber_field.modelfields.PhoneNumberField(blank=True, default='', max_length=128, verbose_name='phone number')), migrations.RunPython(convert_phone_number_to_phonenumberfield, migrations.RunPython.noop)]