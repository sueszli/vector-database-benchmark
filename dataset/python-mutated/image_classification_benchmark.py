...
python3 -m model_benchmark.image_classification_benchmark     --model="EfficientNetV2B0"     --epochs=2     --batch_size=32     --mixed_precision_policy="mixed_float16"
"""
import time
import numpy as np
...
flags.DEFINE_string('mixed_precision_policy', 'mixed_float16', "The global precision policy to use, e.g., 'mixed_float16' or 'float32'.")
FLAGS = flags.FLAGS
BATCH_SIZE = 32
IMAGE_SIZE = (224, 224)
CHANNELS = 3
MODEL_MAP = {'EfficientNetV2B0': keras.applications.EfficientNetV2B0, 'Xception': keras.applications.Xception, 'ResNet50V2': keras.applications.ResNet50V2}
