...
from calibre.utils.icu import collation_order, lower as icu_lower, sort_key, upper as icu_upper
from polyglot.builtins import iteritems, native_string_type
CATEGORY_SORTS = ('name', 'popularity', 'rating')

class Tag:
    __slots__ = ('name', 'original_name', 'id', 'count', 'state', 'is_hierarchical', 'is_editable', 'is_searchable', 'id_set', 'avg_rating', 'sort', 'use_sort_as_name', 'category', 'search_expression', 'original_categories')
