...
from scipy.optimize._zeros_py import _scalar_optimization_initialize, _chandrupatla_iv, _scalar_optimization_loop, _ECONVERGED, _ESIGNERR, _ECONVERR, _EVALUEERR, _ECALLBACK, _EINPROGRESS
