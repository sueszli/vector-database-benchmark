...
class Ui_MetadataOptionsPage(object):
    ...
    def setupUi(self, MetadataOptionsPage):
        ...
        MetadataOptionsPage.setTabOrder(self.convert_punctuation, self.track_ars)
        MetadataOptionsPage.setTabOrder(self.track_ars, self.release_ars)
        MetadataOptionsPage.setTabOrder(self.release_ars, self.guess_tracknumber_and_title)
