...
def test_order_is_expired_after_specific_time_CORE_0214(e2e_staff_api_client, e2e_app_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_payments, permission_handle_checkouts):
    ...
    channel_update_input = {'orderSettings': {'allowUnpaidOrders': True, 'automaticallyFulfillNonShippableGiftCard': True, 'automaticallyConfirmAllNewOrders': True, 'expireOrdersAfter': expire_order_after_in_minutes}}
