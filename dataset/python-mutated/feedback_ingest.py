...
from sentry.api.authentication import ApiKeyAuthentication, DSNAuthentication, OrgAuthTokenAuthentication, UserAuthTokenAuthentication
...
class FeedbackIngestEndpoint(Endpoint):
    ...
    authentication_classes = (DSNAuthentication, UserAuthTokenAuthentication, OrgAuthTokenAuthentication, ApiKeyAuthentication)
