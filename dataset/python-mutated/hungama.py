...
class HungamaIE(HungamaBaseIE):
    ...
    _TESTS = [{'url': 'http://www.hungama.com/video/krishna-chants/39349649/', 'md5': '687c5f1e9f832f3b59f44ed0eb1f120a', 'info_dict': {'id': '39349649', 'ext': 'mp4', 'title': 'Krishna Chants', 'description': ' ', 'upload_date': '20180829', 'duration': 264, 'timestamp': 1535500800, 'view_count': int, 'thumbnail': 'https://images1.hungama.com/tr:n-a_169_m/c/1/0dc/2ca/39349649/39349649_350x197.jpg?v=8', 'tags': 'count:6'}}, {'url': 'https://un.hungama.com/short-film/adira/102524179/', 'md5': '2278463f5dc9db9054d0c02602d44666', 'info_dict': {'id': '102524179', 'ext': 'mp4', 'title': 'Adira', 'description': 'md5:df20cd4d41eabb33634f06de1025a4b4', 'upload_date': '20230417', 'timestamp': 1681689600, 'view_count': int, 'thumbnail': 'https://images1.hungama.com/tr:n-a_23_m/c/1/197/ac9/102524179/102524179_350x525.jpg?v=1', 'tags': 'count:7'}}, {'url': 'https://www.hungama.com/movie/kahaani-2/44129919/', 'only_matching': True}, {'url': 'https://www.hungama.com/tv-show/padded-ki-pushup/season-1/44139461/episode/ep-02-training-sasu-pathlaag-karing/44139503/', 'only_matching': True}]
...
class HungamaAlbumPlaylistIE(HungamaBaseIE):
    ...
    _TESTS = [{'url': 'https://www.hungama.com/album/bhuj-the-pride-of-india/69481490/', 'playlist_mincount': 7, 'info_dict': {'id': '69481490'}}, {'url': 'https://www.hungama.com/playlists/hindi-jan-to-june-2021/123063/', 'playlist_mincount': 33, 'info_dict': {'id': '123063'}}, {'url': 'https://un.hungama.com/album/what-jhumka-%3F-from-rocky-aur-rani-kii-prem-kahaani/103891805/', 'playlist_mincount': 1, 'info_dict': {'id': '103891805'}}]
