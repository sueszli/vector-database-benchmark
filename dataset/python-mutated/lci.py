...
class LCIIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        wat_id = self._search_regex('watId["\\\']?\\s*:\\s*["\\\']?(\\d+)', webpage, 'wat id')
