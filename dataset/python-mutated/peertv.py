...
class PeerTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.peer.tv/de/841', 'info_dict': {'id': '841', 'ext': 'mp4', 'title': 'Die Brunnenburg', 'description': 'md5:4395f6142b090338340ab88a3aae24ed'}}, {'url': 'https://www.peer.tv/it/404', 'info_dict': {'id': '404', 'ext': 'mp4', 'title': 'Cascate di ghiaccio in Val Gardena', 'description': 'md5:e8e5907f236171842674e8090e3577b8'}}]
