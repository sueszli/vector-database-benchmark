...
from golem.task.taskbase import Task, TaskEventListener, AcceptClientVerdict, TaskResult
from golem.task.taskclient import TaskClient
from golem.task.taskmanager import TaskManager, logger
from golem.task.taskstate import SubtaskStatus, SubtaskState, TaskState, TaskStatus, TaskOp, SubtaskOp, OtherOp
...
class TestTaskManager(LogTestCase, TestDatabaseWithReactor, testutils.PEP8MixIn):
    PEP8_FILES = ['golem/task/taskmanager.py']
