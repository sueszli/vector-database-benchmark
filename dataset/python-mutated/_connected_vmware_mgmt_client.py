...
class ConnectedVMwareMgmtClient:
    ...
    def __init__(self, credential: 'TokenCredential', subscription_id: str, base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        if False:
            for i in range(10):
                print('nop')
        self._config = ConnectedVMwareMgmtClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
    ...
    def __enter__(self) -> 'ConnectedVMwareMgmtClient':
        if False:
            for i in range(10):
                print('nop')
