...
def test_gamma_dispersion_factor():
    ...
    model_pearson = H2OGeneralizedLinearEstimator(family='gamma', lambda_=0, compute_p_values=True, dispersion_parameter_method='pearson')
    ...
    assert abs(true_dispersion_factor - dispersion_factor_estimated) <= abs(R_dispersion_factor - true_dispersion_factor), 'H2O dispersion parameter estimate {0} is worse than that of R {1}.  True dispersion parameter is {2}'.format(dispersion_factor_estimated, R_dispersion_factor, true_dispersion_factor)
    assert abs(true_dispersion_factor - dispersion_factor_estimated) <= abs(dispersion_factor_estimated_pearson - true_dispersion_factor), 'H2O dispersion parameter ml estimate {0} is worse than that of H2O dispersion parameter pearson estimate {1}.  True dispersion parameter is {2}'.format(dispersion_factor_estimated, dispersion_factor_estimated_pearson, true_dispersion_factor)
