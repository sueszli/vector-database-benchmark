...
import proto
__protobuf__ = proto.module(package='google.cloud.assuredworkloads.v1beta1', manifest={'CreateWorkloadRequest', 'UpdateWorkloadRequest', 'DeleteWorkloadRequest', 'GetWorkloadRequest', 'ListWorkloadsRequest', 'ListWorkloadsResponse', 'Workload', 'CreateWorkloadOperationMetadata'})
...
class UpdateWorkloadRequest(proto.Message):
    ...
    update_mask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class Workload(proto.Message):
    ...
    class ResourceInfo(proto.Message):
        ...
        resource_type = proto.Field(proto.ENUM, number=2, enum='Workload.ResourceInfo.ResourceType')
    ...
    class KMSSettings(proto.Message):
        ...
        """
        next_rotation_time = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
        rotation_period = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    ...
    class IL4Settings(proto.Message):
        ...
        """
        kms_settings = proto.Field(proto.MESSAGE, number=1, message='Workload.KMSSettings')
    ...
    class SaaEnrollmentResponse(proto.Message):
        ...
        setup_status = proto.Field(proto.ENUM, number=1, optional=True, enum='Workload.SaaEnrollmentResponse.SetupState')
        setup_errors = proto.RepeatedField(proto.ENUM, number=2, enum='Workload.SaaEnrollmentResponse.SetupError')
    name = proto.Field(proto.STRING, number=1)
    ...
    il4_settings = proto.Field(proto.MESSAGE, number=7, oneof='compliance_regime_settings', message=IL4Settings)
    cjis_settings = proto.Field(proto.MESSAGE, number=8, oneof='compliance_regime_settings', message=CJISSettings)
    fedramp_high_settings = proto.Field(proto.MESSAGE, number=11, oneof='compliance_regime_settings', message=FedrampHighSettings)
    fedramp_moderate_settings = proto.Field(proto.MESSAGE, number=12, oneof='compliance_regime_settings', message=FedrampModerateSettings)
    ...
    resource_settings = proto.RepeatedField(proto.MESSAGE, number=15, message=ResourceSettings)
    ...
    saa_enrollment_response = proto.Field(proto.MESSAGE, number=20, message=SaaEnrollmentResponse)
...
class CreateWorkloadOperationMetadata(proto.Message):
    ...
    compliance_regime = proto.Field(proto.ENUM, number=4, enum='Workload.ComplianceRegime')
    resource_settings = proto.RepeatedField(proto.MESSAGE, number=5, message='Workload.ResourceSettings')
