...
@PREPROCESSORS.register_module(Fields.nlp, module_name=Preprocessors.thai_ner_tokenizer)
...
@PREPROCESSORS.register_module(Fields.nlp, module_name=Preprocessors.thai_wseg_tokenizer)
class WordSegmentationPreprocessorThai(TokenClassificationTransformersPreprocessor):
