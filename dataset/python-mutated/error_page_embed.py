...
DEFAULT_OPTIONS: dict[str, Any] = {'title': DEFAULT_TITLE, 'subtitle': DEFAULT_SUBTITLE, 'subtitle2': DEFAULT_SUBTITLE2, 'labelName': DEFAULT_NAME_LABEL, 'labelEmail': DEFAULT_EMAIL_LABEL, 'labelComments': DEFAULT_COMMENTS_LABEL, 'labelClose': DEFAULT_CLOSE_LABEL, 'labelSubmit': DEFAULT_SUBMIT_LABEL, 'errorGeneric': GENERIC_ERROR, 'errorFormEntry': FORM_ERROR, 'successMessage': SENT_MESSAGE}

class UserReportForm(forms.ModelForm):
    name = forms.CharField(max_length=128, widget=forms.TextInput(attrs={'placeholder': _('Jane Bloggs')}))
