...
class ProactiveDetectionConfigurationsOperations:
    ...
    async def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> List[_models.ApplicationInsightsComponentProactiveDetectionConfiguration]:
        ...
        cls: ClsType[List[_models.ApplicationInsightsComponentProactiveDetectionConfiguration]] = kwargs.pop('cls', None)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, configuration_id: str, **kwargs: Any) -> _models.ApplicationInsightsComponentProactiveDetectionConfiguration:
        ...
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, configuration_id=configuration_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, configuration_id: str, proactive_detection_properties: _models.ApplicationInsightsComponentProactiveDetectionConfiguration, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentProactiveDetectionConfiguration:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, configuration_id: str, proactive_detection_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentProactiveDetectionConfiguration:
        """Update the ProactiveDetection configuration for this configuration id.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, resource_name: str, configuration_id: str, proactive_detection_properties: Union[_models.ApplicationInsightsComponentProactiveDetectionConfiguration, IO], **kwargs: Any) -> _models.ApplicationInsightsComponentProactiveDetectionConfiguration:
        """Update the ProactiveDetection configuration for this configuration id.
