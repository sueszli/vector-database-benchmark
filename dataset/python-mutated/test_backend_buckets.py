...
@pytest.mark.parametrize('client_class,transport_name', [(BackendBucketsClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.BackendBucketsRestTransport, 'rest')])
...
def test_backend_buckets_client_get_transport_class():
    ...
    available_transports = [transports.BackendBucketsRestTransport]
    assert transport in available_transports
    transport = BackendBucketsClient.get_transport_class('rest')
    assert transport == transports.BackendBucketsRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(BackendBucketsClient, transports.BackendBucketsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(BackendBucketsClient, transports.BackendBucketsRestTransport, 'rest', 'true'), (BackendBucketsClient, transports.BackendBucketsRestTransport, 'rest', 'false')])
@mock.patch.object(BackendBucketsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(BackendBucketsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(BackendBucketsClient, transports.BackendBucketsRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AddSignedUrlKeyBackendBucketRequest, dict])
...
def test_add_signed_url_key_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_add_signed_url_key') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_add_signed_url_key') as pre:
...
def test_add_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', backend_bucket='backend_bucket_value', signed_url_key_resource=compute.SignedUrlKey(key_name='key_name_value'))
...
def test_add_signed_url_key_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_signed_url_key(compute.AddSignedUrlKeyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', signed_url_key_resource=compute.SignedUrlKey(key_name='key_name_value'))
...
def test_add_signed_url_key_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.add_signed_url_key_unary(compute.AddSignedUrlKeyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', signed_url_key_resource=compute.SignedUrlKey(key_name='key_name_value'))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_delete') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'backend_bucket': 'sample2'}
        mock_args = dict(project='project_value', backend_bucket='backend_bucket_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value')
...
@pytest.mark.parametrize('request_type', [compute.DeleteSignedUrlKeyBackendBucketRequest, dict])
...
def test_delete_signed_url_key_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'backend_bucket': 'sample2'}
        mock_args = dict(project='project_value', backend_bucket='backend_bucket_value', key_name='key_name_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_delete_signed_url_key_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_signed_url_key(compute.DeleteSignedUrlKeyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', key_name='key_name_value')
...
def test_delete_signed_url_key_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_signed_url_key_unary(compute.DeleteSignedUrlKeyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', key_name='key_name_value')
...
def test_get_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.BackendBucket(bucket_name='bucket_name_value', compression_mode='compression_mode_value', creation_timestamp='creation_timestamp_value', custom_response_headers=['custom_response_headers_value'], description='description_value', edge_security_policy='edge_security_policy_value', enable_cdn=True, id=205, kind='kind_value', name='name_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_get') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value')
...
def test_insert_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['backend_bucket_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_insert') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertBackendBucketRequest(), project='project_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertBackendBucketRequest(), project='project_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.BackendBucketList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_list') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListBackendBucketsRequest(), project='project_value')
...
def test_list_rest_pager(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.BackendBucketList(items=[compute.BackendBucket(), compute.BackendBucket(), compute.BackendBucket()], next_page_token='abc'), compute.BackendBucketList(items=[], next_page_token='def'), compute.BackendBucketList(items=[compute.BackendBucket()], next_page_token='ghi'), compute.BackendBucketList(items=[compute.BackendBucket(), compute.BackendBucket()]))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_patch') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'backend_bucket': 'sample2'}
        mock_args = dict(project='project_value', backend_bucket='backend_bucket_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetEdgeSecurityPolicyBackendBucketRequest, dict])
...
def test_set_edge_security_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'backend_bucket': 'sample2'}
        mock_args = dict(project='project_value', backend_bucket='backend_bucket_value', security_policy_reference_resource=compute.SecurityPolicyReference(security_policy='security_policy_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_set_edge_security_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_edge_security_policy(compute.SetEdgeSecurityPolicyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', security_policy_reference_resource=compute.SecurityPolicyReference(security_policy='security_policy_value'))
...
def test_set_edge_security_policy_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_edge_security_policy_unary(compute.SetEdgeSecurityPolicyBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', security_policy_reference_resource=compute.SecurityPolicyReference(security_policy='security_policy_value'))
...
def test_update_rest_interceptors(null_interceptor):
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.BackendBucketsRestInterceptor())
    client = BackendBucketsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.BackendBucketsRestInterceptor, 'post_update') as post, mock.patch.object(transports.BackendBucketsRestInterceptor, 'pre_update') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update(compute.UpdateBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
def test_update_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_unary(compute.UpdateBackendBucketRequest(), project='project_value', backend_bucket='backend_bucket_value', backend_bucket_resource=compute.BackendBucket(bucket_name='bucket_name_value'))
...
def test_credentials_transport_error():
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BackendBucketsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.BackendBucketsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = BackendBucketsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_kind(transport_name):
    if False:
        print('Hello World!')
    transport = BackendBucketsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_backend_buckets_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport.__init__') as Transport:
        ...
        transport = transports.BackendBucketsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('add_signed_url_key', 'delete', 'delete_signed_url_key', 'get', 'insert', 'list', 'patch', 'set_edge_security_policy', 'update')
...
def test_backend_buckets_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.backend_buckets.transports.BackendBucketsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.BackendBucketsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_backend_buckets_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_backend_buckets_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_backend_buckets_client_transport_session_collision(transport_name):
    ...
    client1 = BackendBucketsClient(credentials=creds1, transport=transport_name)
    client2 = BackendBucketsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.BackendBucketsTransport, '_prep_wrapped_messages') as prep:
        client = BackendBucketsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(BackendBucketsClient, transports.BackendBucketsRestTransport)])
