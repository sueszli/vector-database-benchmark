...
class schedulerCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_job': ('parent', 'job'), 'delete_job': ('name',), 'get_job': ('name',), 'list_jobs': ('parent', 'page_size', 'page_token'), 'pause_job': ('name',), 'resume_job': ('name',), 'run_job': ('name',), 'update_job': ('job', 'update_mask')}
