...
class ZFeatureMap(PauliFeatureMap):
    ...
    def __init__(self, feature_dimension: int, reps: int=2, data_map_func: Optional[Callable[[np.ndarray], float]]=None, parameter_prefix: str='x', insert_barriers: bool=False, name: str='ZFeatureMap') -> None:
        if False:
            print('Hello World!')
        ...
        super().__init__(feature_dimension=feature_dimension, paulis=['Z'], reps=reps, data_map_func=data_map_func, parameter_prefix=parameter_prefix, insert_barriers=insert_barriers, name=name)