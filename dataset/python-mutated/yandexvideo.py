...
from ..utils import determine_ext, extract_attributes, int_or_none, lowercase_escape, parse_qs, traverse_obj, try_get, url_or_none

class YandexVideoIE(InfoExtractor):
    _VALID_URL = '(?x)\n                    https?://\n                        (?:\n                            yandex\\.ru(?:/(?:portal/(?:video|efir)|efir))?/?\\?.*?stream_id=|\n                            frontend\\.vh\\.yandex\\.ru/player/\n                        )\n                        (?P<id>(?:[\\da-f]{32}|[\\w-]{12}))\n                    '
    _TESTS = [{'url': 'https://yandex.ru/portal/video?stream_id=4dbb36ec4e0526d58f9f2dc8f0ecf374', 'info_dict': {'id': '4dbb36ec4e0526d58f9f2dc8f0ecf374', 'ext': 'mp4', 'title': 'Русский Вудсток - главный рок-фест в истории СССР / вДудь', 'description': 'md5:7d6b8d4bc4a3b9a56499916c1ea5b5fa', 'thumbnail': 're:^https?://', 'timestamp': 1549972939, 'duration': 5575, 'age_limit': 18, 'upload_date': '20190212', 'view_count': int, 'like_count': int, 'dislike_count': int}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://yandex.ru/portal/efir?stream_id=4dbb262b4fe5cf15a215de4f34eee34d&from=morda', 'only_matching': True}, {'url': 'https://yandex.ru/?stream_id=4dbb262b4fe5cf15a215de4f34eee34d', 'only_matching': True}, {'url': 'https://frontend.vh.yandex.ru/player/4dbb262b4fe5cf15a215de4f34eee34d?from=morda', 'only_matching': True}, {'url': 'https://yandex.ru/portal/video?stream_id=45b11db6e4b68797919c93751a938cee', 'only_matching': True}, {'url': 'https://yandex.ru/?stream_channel=1538487871&stream_id=4132a07f71fb0396be93d74b3477131d', 'only_matching': True}, {'url': 'https://yandex.ru/portal/video?from=morda&stream_id=485a92d94518d73a9d0ff778e13505f8', 'only_matching': True}, {'url': 'https://yandex.ru/efir?stream_active=watching&stream_id=v7a2dZ-v5mSI&from_block=efir_newtab', 'only_matching': True}]
...
class YandexVideoPreviewIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://yandex.ru/video/preview/?filmId=10682852472978372885&text=summer', 'info_dict': {'id': '1352565459459', 'ext': 'mp4', 'like_count': int, 'upload_date': '20191202', 'age_limit': 0, 'duration': 196, 'thumbnail': 'https://i.mycdn.me/videoPreview?id=544866765315&type=37&idx=13&tkn=TY5qjLYZHxpmcnK8U2LgzYkgmaU&fn=external_8', 'uploader_id': '481054701571', 'title': 'LOFT - summer, summer, summer HD', 'uploader': 'АРТЁМ КУДРОВ'}}, {'url': 'https://yandex.ru/video/preview/?filmId=4479424425337895262&source=main_redirect&text=видео&utm_source=main_stripe_big', 'only_matching': True}, {'url': 'https://yandex.ru/video/preview/5275069442094787341', 'only_matching': True}, {'url': 'https://yandex.ru/
извержение вулкана из спичек: зрелищный опыт', 'description': 'md5:053ad3c61b5596d510c9a199dc8ee633', 'thumbnail': 're:^https://avatars\\.dzeninfra\\.ru/', 'uploader': 'TechInsider', 'timestamp': 1611378221, 'upload_date': '20210123'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://dzen.ru/video/watch/6002240ff8b1af50bb2da5e3', 'info_dict': {'id': '6002240ff8b1af50bb2da5e3', 'ext': 'mp4', 'title': 'Извержение вулкана из спичек: зрелищный опыт', 'description': 'md5:053ad3c61b5596d510c9a199dc8ee633', 'thumbnail': 're:^https://avatars.dzeninfra.ru/', 'uploader': 'TechInsider', 'upload_date': '20210123', 'timestamp': 1611378221}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://zen.yandex.ru/media/id/606fd806cc13cb3c58c05cf5/novyi-samsung-fold-3-moskvich-barahlit-612f93b7f8d48e7e945792a2?from=channel&rid=2286618386.482.1630817595976.42360', 'only_matching': True}, {'url': 'https://dzen.ru/media/id/606fd806cc13cb3c58c05cf5/novyi-samsung-fold-3-moskvich-barahlit-612f93b7f8d48e7e945792a2?from=channel&rid=2286618386.482.1630817595976.42360', 'only_matching': True}]
...
class ZenYandexChannelIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://zen.yandex.ru/tok_media', 'info_dict': {'id': 'tok_media', 'title': 'СПЕКТР', 'description': 'md5:a9e5b3c247b7fe29fd21371a428bcf56'}, 'playlist_mincount': 169, 'skip': 'The page does not exist'}, {'url': 'https://dzen.ru/tok_media', 'info_dict': {'id': 'tok_media', 'title': 'СПЕКТР', 'description': 'md5:a9e5b3c247b7fe29fd21371a428bcf56'}, 'playlist_mincount': 169, 'skip': 'The page does not exist'}, {'url': 'https://zen.yandex.ru/id/606fd806cc13cb3c58c05cf5', 'info_dict': {'id': '606fd806cc13cb3c58c05cf5', 'description': 'md5:517b7c97d8ca92e940f5af65448fd928', 'title': 'AcademeG DailyStream'}, 'playlist_mincount': 657}, {'url': 'https://zen.yandex.ru/jony_me', 'info_dict': {'id': 'jony_me', 'description': 'md5:ce0a5cad2752ab58701b5497835b2cc5', 'title': 'JONY '}, 'playlist_count': 18}, {'url': 'https://zen.yandex.ru/tatyanareva', 'info_dict': {'id': 'tatyanareva', 'description': 'md5:40a1e51f174369ec3ba9d657734ac31f', 'title': 'Татьяна Рева', 'entries': 'maxcount:200'}, 'playlist_mincount': 46}, {'url': 'https://dzen.ru/id/606fd806cc13cb3c58c05cf5', 'info_dict': {'id': '606fd806cc13cb3c58c05cf5', 'title': 'AcademeG DailyStream', 'description': 'md5:517b7c97d8ca92e940f5af65448fd928'}, 'playlist_mincount': 657}]
