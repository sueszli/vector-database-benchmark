...
CONTRIBUTION = {'commit_hash': COMMIT_HASH, 'commit_timestamp': COMMIT_TIMESTAMP, 'contributor': {'commit_author_name': COMMIT_AUTHOR_NAME, 'commit_author_email': COMMIT_AUTHOR_EMAIL}}
