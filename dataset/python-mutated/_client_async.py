...
from .._generated.models import AttestationResult as GeneratedAttestationResult, RuntimeData, InitTimeData, DataType, AttestSgxEnclaveRequest, AttestOpenEnclaveRequest
...
class AttestationClient(object):
    ...
    @distributed_trace_async
    async def attest_sgx_enclave(self, quote: bytes, *, inittime_json: bytes=None, inittime_data: bytes=None, runtime_json: bytes=None, runtime_data: bytes=None, **kwargs: Any) -> Tuple[AttestationResult, AttestationToken]:
        ...
        request = AttestSgxEnclaveRequest(quote=quote, init_time_data=inittime, runtime_data=runtime, draft_policy_for_attestation=kwargs.pop('draft_policy', None))
    ...
    @distributed_trace_async
    async def attest_open_enclave(self, report: bytes, *, inittime_json: bytes=None, inittime_data: bytes=None, runtime_json: bytes=None, runtime_data: bytes=None, **kwargs: Any) -> Tuple[AttestationResult, AttestationToken]:
        ...
        if inittime_json:
            inittime = InitTimeData(data=inittime_data, data_type=DataType.JSON)
        request = AttestOpenEnclaveRequest(report=report, init_time_data=inittime, runtime_data=runtime, draft_policy_for_attestation=kwargs.pop('draft_policy', None))
        options = merge_validation_args(self._config._kwargs, kwargs)
    ...
    async def _get_signers(self, **kwargs: Any):
        """Returns the set of signing certificates used to sign attestation tokens."""
