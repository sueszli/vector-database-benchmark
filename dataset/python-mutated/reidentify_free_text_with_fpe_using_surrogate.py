...
if __name__ == '__main__':
    ...
    parser.add_argument('input_str', help="The string to re-identify. Example: string = 'My SSN is 372819127'")
    ...
    reidentify_free_text_with_fpe_using_surrogate(args.project, args.input_str, args.alphabet, args.surrogate_type, args.unwrapped_key)