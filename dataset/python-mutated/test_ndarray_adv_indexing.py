...
@testing.parameterize(*testing.product({'shape': [(4, 4, 4)], 'indexes': perm(([1, 0], slice(None))) + perm(([1, 0], Ellipsis)) + perm(([1, 2], None, slice(None))) + perm(([1, 0], 1, slice(None))) + perm(([1, 2], slice(0, 2), slice(None))) + perm((1, [1, 2], 1)) + perm(([[1, -1], [0, 3]], slice(None), slice(None))) + perm(([1, 0], [3, 2], slice(None))) + perm((slice(0, 3, 2), [1, 2], [1, 0])) + perm(([1, 0], [2, 1], [3, 1])) + perm(([1, 0], 1, [3, 1])) + perm(([1, 2], [[1, 0], [0, 1], [-1, 1]], slice(None))) + perm((None, [1, 2], [1, 0])) + perm((numpy.array(0), numpy.array(-1))) + perm((numpy.array(0), None)) + perm((1, numpy.array(2), slice(None)))}))
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': [[]]}, {'shape': (2, 3, 4), 'indexes': [[[]]]}, {'shape': (2, 3, 4), 'indexes': [[[[]]]]}, {'shape': (2, 3, 4, 5), 'indexes': [[[[]]]]}, {'shape': (2, 3, 4, 5), 'indexes': [[[[[]]]]]}, {'shape': (2, 3, 4), 'indexes': [[1]]}, {'shape': (2, 3, 4), 'indexes': [[1, 1]]}, {'shape': (2, 3, 4), 'indexes': [[1], [1]]})
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': [[1, 1], 1]}, {'shape': (2, 3, 4), 'indexes': [[1], slice(1, 2)]}, {'shape': (2, 3, 4), 'indexes': [[[1]], slice(1, 2)]})
...
@testing.parameterize({'shape': (2, 3, 4), 'transpose': (1, 2, 0), 'indexes': (slice(None), [1, 0])}, {'shape': (2, 3, 4), 'transpose': (1, 0, 2), 'indexes': (None, [1, 2], [0, -1])})
...
@testing.parameterize({'shape': (0,), 'indexes': ([False],)}, {'shape': (2, 3, 4), 'indexes': (slice(None), numpy.random.choice([False, True], (3, 1)))}, {'shape': (2, 3, 4), 'indexes': numpy.random.choice([False, True], (1, 3))}, _ids=False)
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': [1, [1, [1]]]})
@testing.with_requires('numpy>=1.24')
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': numpy.array(-1), 'value': 1}, {'shape': (2, 3, 4), 'indexes': numpy.array([1, 0]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': [1, 0], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [1, -1], 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), [1, 2]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), [[1, 2], [0, -1]]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), slice(None), [[1, 2], [0, -1]]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), slice(1, 2), [[1, 2], [0, -1]]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (None, [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (None, [1, -1], None), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (None, None, None, [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(0, 1), None, [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(0, 1), slice(1, 2), [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(0, 1), None, slice(1, 2), [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': numpy.array([True, False]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (1, numpy.array([True, False, True])), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (numpy.array([True, False]), 1), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), numpy.array([True, False, True])), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), 2, numpy.array([True, False, True, False])), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), 2, False), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), slice(None), numpy.random.choice([False, True], (4,))), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (numpy.random.choice([False, True], (2, 3)),), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), numpy.random.choice([False, True], (3, 4))), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (numpy.random.choice([False, True], (2, 3, 4)),), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (1, None, numpy.array([True, False, True])), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], [1, -1], [2, 1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], 1), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], slice(None), [1, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], 1, 2), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([1, 0], slice(None), [[2, 0], [3, 1]]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], None, [1, 0]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], slice(0, 2), [1, 0]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([0, -1], None, slice(0, 2), [1, 0]), 'value': 1}, {'shape': (1, 1, 2, 3, 4), 'indexes': (None, slice(None), slice(None), [1, 0], [2, -1], 1), 'value': 1}, {'shape': (1, 1, 2, 3, 4), 'indexes': (None, slice(None), 0, [1, 0], slice(0, 2, 2), [2, -1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), [0, -1], [[1, 0], [0, 1], [-1, 1]]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': [], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [], 'value': numpy.array([1, 1, 1, 1])}, {'shape': (2, 3, 4), 'indexes': [], 'value': numpy.random.uniform(size=(3, 4))}, {'shape': (2, 3, 4), 'indexes': numpy.array([], dtype=numpy.int32), 'value': 1}, {'shape': (2, 3, 4), 'indexes': numpy.array([[]], dtype=numpy.int32), 'value': numpy.random.uniform(size=(3, 4))}, {'shape': (2, 3, 4), 'indexes': (slice(None), []), 'value': 1}, {'shape': (2, 3, 4), 'indexes': ([], []), 'value': 1}, {'shape': (2, 3, 4), 'indexes': numpy.array([], dtype=numpy.bool_), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), numpy.array([], dtype=numpy.bool_)), 'value': 1}, {'shape': (2, 3, 4), 'indexes': numpy.array([[], []], dtype=numpy.bool_), 'value': numpy.random.uniform(size=(4,))}, {'shape': (2, 3, 4), 'indexes': numpy.empty((0, 0, 4), bool), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (True, [True, False]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (False, [True, False]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (True, [[1]], slice(1, 2)), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (False, [[1]], slice(1, 2)), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (True, [[1]], slice(1, 2), True), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (True, [[1]], slice(1, 2), False), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (Ellipsis, [[1, 1, -3], [0, 2, 2]], [True, False, True, True]), 'value': [[1, 2, 3], [4, 5, 6]]}, {'shape': (2, 3, 4), 'indexes': (numpy.empty((0, 3), bool), numpy.empty(0, bool)), 'value': 1}, {'shape': (), 'indexes': Ellipsis, 'value': 1}, {'shape': (), 'indexes': (), 'value': 1}, {'shape': (), 'indexes': None, 'value': 1}, {'shape': (), 'indexes': True, 'value': 1}, {'shape': (), 'indexes': (True,), 'value': 1}, {'shape': (), 'indexes': (False, True, True), 'value': 1}, {'shape': (), 'indexes': numpy.ones((), dtype=numpy.bool_), 'value': 1}, {'shape': (), 'indexes': numpy.zeros((), dtype=numpy.bool_), 'value': 1}, {'shape': (0,), 'indexes': None, 'value': 1}, {'shape': (0,), 'indexes': (), 'value': 1}, {'shape': (0,), 'indexes': True, 'value': 1}, {'shape': (0,), 'indexes': (True,), 'value': 1}, {'shape': (0,), 'indexes': (False, True, True), 'value': 1}, {'shape': (0,), 'indexes': numpy.ones((), dtype=numpy.bool_), 'value': 1}, {'shape': (0,), 'indexes': numpy.zeros((), dtype=numpy.bool_), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (1, Ellipsis, 2), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (Ellipsis, numpy.array(False)), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (Ellipsis, numpy.ones((3, 4), bool)), 'value': 1}, {'shape': (3, 4, 5), 'indexes': (slice(None), [0, 1], Ellipsis, [0, 1]), 'value': 1}, {'shape': (2, 3, 4), 'indexes': (slice(None), [1, 0], Ellipsis, numpy.ones((5, 2), int)), 'value': 1}, _ids=False)
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': [[]], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[[]]], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[[[]]]], 'value': 1}, {'shape': (2, 3, 4, 5), 'indexes': [[[[]]]], 'value': 1}, {'shape': (2, 3, 4, 5), 'indexes': [[[[[]]]]], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[1]], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[1, 0]], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[1], [0]], 'value': 1})
@testing.with_requires('numpy>=1.23')
...
@testing.parameterize({'shape': (), 'indexes': numpy.array([True]), 'value': 1}, {'shape': (), 'indexes': numpy.array([False, True, True]), 'value': 1}, {'shape': (0,), 'indexes': numpy.array([True]), 'value': 1}, {'shape': (0,), 'indexes': numpy.array([False, True, True]), 'value': 1})
...
@testing.parameterize({'shape': (2, 3, 4), 'indexes': [[1, 0], 2], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[1], slice(1, 2)], 'value': 1}, {'shape': (2, 3, 4), 'indexes': [[[1]], slice(1, 2)], 'value': 1})
@testing.with_requires('numpy>=1.24')
