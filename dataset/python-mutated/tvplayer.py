...
from ..utils import extract_attributes, try_get, urlencode_postdata, ExtractorError

class TVPlayerIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?tvplayer\\.com/watch/(?P<id>[^/?#]+)'
    _TEST = {'url': 'http://tvplayer.com/watch/bbcone', 'info_dict': {'id': '89', 'ext': 'mp4', 'title': 're:^BBC One [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$'}, 'params': {'skip_download': True}}
