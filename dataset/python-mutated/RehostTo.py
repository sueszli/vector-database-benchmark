...
class RehostTo(MultiDownloader):
    ...
    def handle_premium(self, pyfile):
        if False:
            return 10
        self.download('http://rehost.to/process_download.php', get={'user': 'cookie', 'pass': self.account.get_data('session'), 'dl': pyfile.url}, disposition=True)