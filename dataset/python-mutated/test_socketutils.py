...
import socket
import threading
from boltons.socketutils import BufferedSocket, NetstringSocket, ConnectionClosed, NetstringMessageTooLong, MessageTooLong, Timeout
import pytest
pytestmark = pytest.mark.skipif(getattr(socket, 'socketpair', None) is None, reason='no socketpair (likely Py2 on Windows)')
...
def test_buffers():
    ...
    return
IS_PYPY_2 = '__pypy__' in sys.builtin_module_names and sys.version_info[0] == 2
