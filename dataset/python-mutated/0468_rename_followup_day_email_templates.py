...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0467_rename_extradata_realmauditlog_extra_data_json')]
    operations = [migrations.RunPython(update_for_followup_day_email_templates_rename, reverse_code=revert_followup_day_email_templates_rename)]