...
class MDS(BaseEstimator):
    ...
    """
    _parameter_constraints: dict = {'n_components': [Interval(Integral, 1, None, closed='left')], 'metric': ['boolean'], 'n_init': [Interval(Integral, 1, None, closed='left')], 'max_iter': [Interval(Integral, 1, None, closed='left')], 'verbose': ['verbose'], 'eps': [Interval(Real, 0.0, None, closed='left')], 'n_jobs': [None, Integral], 'random_state': ['random_state'], 'dissimilarity': [StrOptions({'euclidean', 'precomputed'})], 'normalized_stress': ['boolean', StrOptions({'auto'}), Hidden(StrOptions({'warn'}))]}
