...
from robot.result import Break, Continue, Error, ExecutionResultBuilder, For, ForIteration, If, IfBranch, Keyword, Result, ResultVisitor, Return, TestCase, TestSuite, Try, TryBranch, Var, While, WhileIteration
...
class NoSlotsIterations(Iterations):
    keyword_class = NoSlotsKeyword
NoSlotsKeyword.body_class = NoSlotsVar.body_class = NoSlotsReturn.body_class = NoSlotsBreak.body_class = NoSlotsContinue.body_class = NoSlotsError.body_class = NoSlotsBody
