...
TYPE_KEY = 'type'
WAVEFORMS = {analog.GR_CONST_WAVE: 'Constant', analog.GR_SIN_WAVE: 'Complex Sinusoid', analog.GR_GAUSSIAN: 'Gaussian Noise', analog.GR_UNIFORM: 'Uniform Noise', '2tone': 'Two Tone', 'sweep': 'Sweep'}
