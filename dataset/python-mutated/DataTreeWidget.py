...
d = {'a list': [1, 2, 3, 4, 5, 6, {'nested1': 'aaaaa', 'nested2': 'bbbbb'}, 'seven'], 'a dict': {'x': 1, 'y': 2, 'z': 'three'}, 'an array': np.random.randint(10, size=(40, 10)), 'a traceback': some_func1(), 'a function': some_func1, 'a class': pg.DataTreeWidget}
