...
def test_check_success(mocked_shell, target):
    ...
    route_mock.return_value = "<HTML><HEAD><script>top.location.href='/Main_Login.asp';</script>\n</HEAD></HTML>\n"
    exploit = Exploit()
...
def test_execute(udp_target):
    if False:
        while True:
            i = 10
    infosvr_mock = udp_target.get_command_mock(re.compile(b'^\x0c\x153\x00.{508}$'))
