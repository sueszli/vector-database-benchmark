...
def main():
    ...
    response = client.sql_resources.begin_create_update_sql_stored_procedure(resource_group_name='rg1', account_name='ddb1', database_name='databaseName', container_name='containerName', stored_procedure_name='storedProcedureName', create_update_sql_stored_procedure_parameters={'properties': {'options': {}, 'resource': {'body': 'body', 'id': 'storedProcedureName'}}}).result()
    print(response)
