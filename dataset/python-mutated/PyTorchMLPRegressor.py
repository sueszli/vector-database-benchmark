...
class PyTorchMLPRegressor(BasePyTorchRegressor):
    ...
    def fit(self, data_dictionary: Dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        if trainer is None:
            trainer = PyTorchModelTrainer(model=model, optimizer=optimizer, criterion=criterion, device=self.device, data_convertor=self.data_convertor, tb_logger=self.tb_logger, **self.trainer_kwargs)
