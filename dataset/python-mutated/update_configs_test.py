...
import github
INVALID_FECONF_CONFIG_PATH: Final = os.path.join(os.getcwd(), 'core', 'tests', 'release_sources', 'invalid_feconf_updates.config')
VALID_FECONF_CONFIG_PATH: Final = os.path.join(os.getcwd(), 'core', 'tests', 'release_sources', 'valid_feconf_updates.config')
FECONF_CONFIG_PATH_WITH_EXTRA_LINE: Final = os.path.join(os.getcwd(), 'core', 'tests', 'release_sources', 'feconf_updates_with_extra_line.config')
MOCK_LOCAL_FECONF_PATH: Final = os.path.join(os.getcwd(), 'core', 'tests', 'release_sources', 'feconf.txt')
MOCK_REQUESTER = github.Requester.Requester(login_or_token=None, password=None, jwt=None, app_auth=None, base_url='https://github.com', timeout=0, user_agent='user', per_page=0, verify=False, retry=None, pool_size=None)
