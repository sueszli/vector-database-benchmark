...
class VimmIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.vimm.tv/c/calimeatwagon', 'info_dict': {'id': 'calimeatwagon', 'ext': 'mp4', 'title': 're:^calimeatwagon [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}$', 'live_status': 'is_live'}, 'skip': 'Live'}, {'url': 'https://www.vimm.tv/octaafradio', 'only_matching': True}]
...
class VimmRecordingIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.vimm.tv/c/kaldewei?v=2JZsrPTFxsSz', 'md5': '15122ee95baa32a548e4a3e120b598f1', 'info_dict': {'id': '2JZsrPTFxsSz', 'ext': 'mp4', 'title': 'VIMM - [DE/GER] Kaldewei Live - In Farbe und Bunt', 'uploader_id': 'kaldewei'}}]
