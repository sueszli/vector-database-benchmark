...
class PromotionEventInterface(graphene.Interface):
    ...
    type = PromotionEventsEnum(description='Promotion event type.', resolver=resolve_event_type, required=True)
    created_by = PermissionsField(UserOrApp, description='User or App that created the promotion event. ', permissions=[AccountPermissions.MANAGE_STAFF, AppPermission.MANAGE_APPS, AuthorizationFilters.OWNER])
...
class PromotionCreatedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        description = 'History log of the promotion created event.' + ADDED_IN_317 + PREVIEW_FEATURE
...
class PromotionUpdatedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        description = 'History log of the promotion updated event.' + ADDED_IN_317 + PREVIEW_FEATURE
        interfaces = [relay.Node, PromotionEventInterface]
        model = models.PromotionEvent
        doc_category = DOC_CATEGORY_DISCOUNTS
...
class PromotionStartedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        description = 'History log of the promotion started event.' + ADDED_IN_317 + PREVIEW_FEATURE
        interfaces = [relay.Node, PromotionEventInterface]
        model = models.PromotionEvent
        doc_category = DOC_CATEGORY_DISCOUNTS
...
class PromotionEndedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        description = 'History log of the promotion ended event.' + ADDED_IN_317 + PREVIEW_FEATURE
        interfaces = [relay.Node, PromotionEventInterface]
        model = models.PromotionEvent
        doc_category = DOC_CATEGORY_DISCOUNTS
...
class PromotionRuleEventInterface(graphene.Interface):
    ...
    class Meta:
        description = 'History log of the promotion event related to rule.' + ADDED_IN_317 + PREVIEW_FEATURE
        interfaces = [relay.Node]
        model = models.PromotionEvent
        doc_category = DOC_CATEGORY_DISCOUNTS
    rule_id = graphene.String(description='The rule ID associated with the promotion event.')
...
class PromotionRuleCreatedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        description = 'History log of the promotion rule created event.' + ADDED_IN_317 + PREVIEW_FEATURE
...
class PromotionRuleDeletedEvent(ModelObjectType[models.PromotionEvent]):
    ...
    class Meta:
        ...
        model = models.PromotionEvent
        doc_category = DOC_CATEGORY_DISCOUNTS
PROMOTION_EVENT_MAP = {events.PROMOTION_CREATED: PromotionCreatedEvent, events.PROMOTION_UPDATED: PromotionUpdatedEvent, events.PROMOTION_STARTED: PromotionStartedEvent, events.PROMOTION_ENDED: PromotionEndedEvent, events.RULE_CREATED: PromotionRuleCreatedEvent, events.RULE_UPDATED: PromotionRuleUpdatedEvent, events.RULE_DELETED: PromotionRuleDeletedEvent}
