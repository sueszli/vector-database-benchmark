...
finite_space = {'x': {'_type': 'choice', '_value': ['a', 'b']}, 'y': {'_type': 'quniform', '_value': [0, 1, 0.6]}, 'z': {'_type': 'normal', '_value': [1, 0]}}
infinite_space = {'x': {'_type': 'choice', '_value': ['a', 'b']}, 'y': {'_type': 'uniform', '_value': [0, 1]}}
nested_space = {'outer': {'_type': 'choice', '_value': [{'_name': 'A', 'x': {'_type': 'choice', '_value': ['a', 'b']}}, {'_name': 'B', 'y': {'_type': 'uniform', '_value': [0, 1]}}]}}
