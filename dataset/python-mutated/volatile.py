...
from typing import List, TypeVar, Generic, Set, Union, Any, Dict, Optional, Tuple, cast
...
class RandUUID(RandField[uuid.UUID]):
    ...
    _REG = re.compile('^{0}-?{1}-?{1}-?{2}{2}-?{2}{2}{2}{2}{2}{2}$'.format(_BASE.format(8), _BASE.format(4), _BASE.format(2)), re.I)
    VERSIONS = [1, 3, 4, 5]
...
class _AutoTime(_RandNumeral[_T], Generic[_T]):
