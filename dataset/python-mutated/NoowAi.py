...
class NoowAi(AsyncGeneratorProvider):
    ...
    async def create_async_generator(cls, model: str, messages: Messages, proxy: str=None, **kwargs) -> AsyncResult:
        ...
        async with ClientSession(headers=headers) as session:
            data = {'botId': 'default', 'customId': 'd49bc3670c3d858458576d75c8ea0f5d', 'session': 'N/A', 'chatId': random_string(), 'contextId': 25, 'messages': messages, 'newMessage': messages[-1]['content'], 'stream': True}
