...
class sfp_archiveorg(SpiderFootPlugin):
    meta = {'name': 'Archive.org', 'summary': 'Identifies historic versions of interesting files/pages from the Wayback Machine.', 'flags': ['slow'], 'useCases': ['Footprint', 'Passive'], 'categories': ['Search Engines'], 'dataSource': {'website': 'https://archive.org/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://archive.org/projects/', 'https://archive.org/services/docs/api/'], 'favIcon': 'https://archive.org/images/glogo.jpg', 'logo': 'https://archive.org/images/glogo.jpg', 'description': 'Internet Archive is a non-profit library of millions of free books, movies, software, music, websites, and more.\nThe Internet Archive, a 501(c)(3) non-profit, is building a digital library of Internet sites and other cultural artifacts in digital form. Like a paper library, we provide free access to researchers, historians, scholars, the print disabled, and the general public. Our mission is to provide Universal Access to All Knowledge.\nWe began in 1996 by archiving the Internet itself, a medium that was just beginning to grow in use. Like newspapers, the content published on the web was ephemeral - but unlike newspapers, no one was saving it. Today we have 20+ years of web history accessible through the Wayback Machine and we work with 625+ library and other partners through our Archive-It program to identify important web pages.'}}
    opts = {'farback': '30,60,90', 'intfiles': True, 'passwordpages': True, 'formpages': False, 'flashpages': False, 'javapages': False, 'staticpages': False, 'uploadpages': False, 'webframeworkpages': False, 'javascriptpages': False}
    optdescs = {'farback': 'Number of days back to look for older versions of files/pages in the Wayback Machine snapshots. Comma-separate the values, so for example 30,60,90 means to look for snapshots 30 days, 60 days and 90 days back.', 'intfiles': 'Query the Wayback Machine for historic versions of Interesting Files.', 'passwordpages': 'Query the Wayback Machine for historic versions of URLs with passwords.', 'formpages': 'Query the Wayback Machine for historic versions of URLs with forms.', 'uploadpages': 'Query the Wayback Machine for historic versions of URLs accepting uploads.', 'flashpages': 'Query the Wayback Machine for historic versions of URLs containing Flash.', 'javapages': 'Query the Wayback Machine for historic versions of URLs using Java Applets.', 'staticpages': 'Query the Wayback Machine for historic versions of purely static URLs.', 'webframeworkpages': 'Query the Wayback Machine for historic versions of URLs using Javascript frameworks.', 'javascriptpages': 'Query the Wayback Machine for historic versions of URLs using Javascript.'}
    results = None
    foundDates = list()
    errorState = False
