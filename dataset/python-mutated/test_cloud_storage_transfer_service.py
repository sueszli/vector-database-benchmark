...
from airflow.providers.google.cloud.hooks.cloud_storage_transfer_service import ACCESS_KEY_ID, AWS_ACCESS_KEY, AWS_S3_DATA_SOURCE, BUCKET_NAME, FILTER_JOB_NAMES, GCS_DATA_SINK, GCS_DATA_SOURCE, HTTP_DATA_SOURCE, LIST_URL, NAME, PATH, SCHEDULE, SCHEDULE_END_DATE, SCHEDULE_START_DATE, SECRET_ACCESS_KEY, START_TIME_OF_DAY, STATUS, TRANSFER_SPEC
...
SCHEDULE_NATIVE = {SCHEDULE_START_DATE: NATIVE_DATE, SCHEDULE_END_DATE: NATIVE_DATE, START_TIME_OF_DAY: NATIVE_TIME}
SCHEDULE_DICT = {SCHEDULE_START_DATE: {'day': 15, 'month': 10, 'year': 2018}, SCHEDULE_END_DATE: {'day': 15, 'month': 10, 'year': 2018}, START_TIME_OF_DAY: {'hours': 11, 'minutes': 42, 'seconds': 43}}
...
VALID_TRANSFER_JOB_BASE: dict = {NAME: JOB_NAME, DESCRIPTION: DESCRIPTION, STATUS: 'ENABLED', SCHEDULE: SCHEDULE_DICT, TRANSFER_SPEC: {GCS_DATA_SINK: {BUCKET_NAME: GCS_BUCKET_NAME, PATH: DESTINATION_PATH}}}
...
VALID_TRANSFER_JOB_GCS = {NAME: JOB_NAME, DESCRIPTION: DESCRIPTION, STATUS: 'ENABLED', SCHEDULE: SCHEDULE_NATIVE, TRANSFER_SPEC: {GCS_DATA_SOURCE: {BUCKET_NAME: GCS_BUCKET_NAME, PATH: SOURCE_PATH}, GCS_DATA_SINK: {BUCKET_NAME: GCS_BUCKET_NAME, PATH: DESTINATION_PATH}}}
VALID_TRANSFER_JOB_RAW: dict = {DESCRIPTION: DESCRIPTION, STATUS: 'ENABLED', SCHEDULE: SCHEDULE_DICT, TRANSFER_SPEC: {GCS_DATA_SINK: {BUCKET_NAME: GCS_BUCKET_NAME, PATH: DESTINATION_PATH}}}
