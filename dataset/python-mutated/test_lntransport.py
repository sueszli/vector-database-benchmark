...
class TestLNTransport(ElectrumTestCase):
    ...
    async def test_loop(self):
        ...
        messages_sent_by_client = [b'hello from client', b'long data from client ' + bytes(range(256)) * 100 + b'... client done', b'client is running out of things to say']
        messages_sent_by_server = [b'hello from server', b'hello2 from server', b'long data from server ' + bytes(range(256)) * 100 + b'... server done']
