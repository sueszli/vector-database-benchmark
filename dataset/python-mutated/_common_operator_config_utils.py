...
from .backend_config import BackendPatternConfig, DTypeConfig, DTypeWithConstraints, ObservationType
from ..fuser_method_mappings import _sequential_wrapper2, fuse_conv_bn, fuse_conv_bn_relu, fuse_linear_bn, fuse_convtranspose_bn
__all__: List[str] = []
_ConvMetadata = namedtuple('_ConvMetadata', ['root', 'transpose', 'bn', 'reference', 'transpose_reference', 'fused_conv_relu', 'fused_conv_bn', 'fused_conv_bn_relu', 'qat', 'relu_qat', 'bn_qat', 'bn_relu_qat', 'func', 'func_transpose'])
_Conv1dMetadata = _ConvMetadata(nn.Conv1d, nn.ConvTranspose1d, nn.BatchNorm1d, nnqr.Conv1d, nnqr.ConvTranspose1d, nni.ConvReLU1d, nni.ConvBn1d, nni.ConvBnReLU1d, nnqat.Conv1d, nniqat.ConvReLU1d, nniqat.ConvBn1d, nniqat.ConvBnReLU1d, F.conv1d, F.conv_transpose1d)
_Conv2dMetadata = _ConvMetadata(nn.Conv2d, nn.ConvTranspose2d, nn.BatchNorm2d, nnqr.Conv2d, nnqr.ConvTranspose2d, nni.ConvReLU2d, nni.ConvBn2d, nni.ConvBnReLU2d, nnqat.Conv2d, nniqat.ConvReLU2d, nniqat.ConvBn2d, nniqat.ConvBnReLU2d, F.conv2d, F.conv_transpose2d)
_Conv3dMetadata = _ConvMetadata(nn.Conv3d, nn.ConvTranspose3d, nn.BatchNorm3d, nnqr.Conv3d, nnqr.ConvTranspose3d, nni.ConvReLU3d, nni.ConvBn3d, nni.ConvBnReLU3d, nnqat.Conv3d, nniqat.ConvReLU3d, nniqat.ConvBn3d, nniqat.ConvBnReLU3d, F.conv3d, F.conv_transpose3d)
_FIXED_QPARAM_OP_0TO1_CONSTRAINTS = DTypeWithConstraints(dtype=torch.quint8, quant_min_lower_bound=0, quant_max_upper_bound=255, scale_exact_match=1.0 / 256.0, zero_point_exact_match=0)
_FIXED_QPARAM_OP_NEG1TO1_CONSTRAINTS = DTypeWithConstraints(dtype=torch.quint8, quant_min_lower_bound=0, quant_max_upper_bound=255, scale_exact_match=2.0 / 256.0, zero_point_exact_match=128)
_FIXED_QPARAMS_OP_TO_CONSTRAINTS: Dict[Union[Callable, str], DTypeWithConstraints] = {torch.nn.Hardsigmoid: _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, torch.nn.functional.hardsigmoid: _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, 'hardsigmoid': _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, 'hardsigmoid_': _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, torch.nn.Sigmoid: _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, torch.sigmoid: _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, 'sigmoid': _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, 'sigmoid_': _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, torch.nn.Softmax: _FIXED_QPARAM_OP_0TO1_CONSTRAINTS, torch.nn.Tanh: _FIXED_QPARAM_OP_NEG1TO1_CONSTRAINTS, torch.tanh: _FIXED_QPARAM_OP_NEG1TO1_CONSTRAINTS, 'tanh': _FIXED_QPARAM_OP_NEG1TO1_CONSTRAINTS, 'tanh_': _FIXED_QPARAM_OP_NEG1TO1_CONSTRAINTS}
