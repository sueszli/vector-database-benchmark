...
class PostgreSQLStorage(SessionStorage):
    ...
    理论上符合 `PEP-249 <https://www.python.org/dev/peps/pep-0249/#connection-objects>`_ 的库都可以使用，    测试时使用的是 ``psycopg2``。
    ...
    def set(self, id, value):
        ...
        self.conn.cursor().execute('INSERT INTO WeRoBot (id, value) values (%s, %s) ON CONFLICT (id) DO UPDATE SET value = %s;', (id, value, value))
        self.conn.commit()
