...
from ._operators import _convert_abs, _convert_relu, _convert_sqrt, _convert_exp, _convert_elu, _convert_selu, _convert_sigmoid, _convert_sign, _convert_prelu, _convert_upsample, _convert_softsign, _convert_softplus, _convert_log, _convert_neg, _convert_reciprocal, _convert_hardsigmoid, _convert_reorganize_data, _add_pool, _get_pool_params, _add_conv, _get_conv_params, _convert_thresholdedrelu, _convert_leaky_relu, _convert_lrn
...
_ONNX_NODE_REGISTRY_ND = {'Abs': _convert_abs, 'Acos': _convert_acos, 'Acosh': _convert_acosh, 'Add': _convert_add, 'And': _convert_logical, 'ArgMax': _convert_argmax, 'ArgMin': _convert_argmin, 'Asin': _convert_asin, 'Asinh': _convert_asinh, 'Atan': _convert_atan, 'Atanh': _convert_atanh, 'AveragePool': _convert_pool, 'BatchNormalization': _convert_bn, 'Cast': _convert_cast, 'Ceil': _convert_ceil, 'Clip': _convert_clip, 'Concat': _convert_concat, 'Constant': _convert_constant, 'ConstantOfShape': _convert_constant_of_shape, 'Conv': _convert_conv, 'ConvTranspose': _convert_conv, 'Cos': _convert_cos, 'Cosh': _convert_cosh, 'DepthToSpace': _convert_reorganize_data, 'Div': _convert_div, 'Elu': _convert_elu, 'Equal': _convert_equal, 'Erf': _convert_erf, 'Exp': _convert_exp, 'Expand': _convert_expand, 'Flatten': _convert_flatten, 'Floor': _convert_floor, 'Gather': _convert_gather, 'Gemm': _convert_gemm, 'Greater': _convert_greater, 'GRU': _convert_gru, 'GlobalAveragePool': _convert_pool, 'GlobalMaxPool': _convert_pool, 'HardSigmoid': _convert_hardsigmoid, 'Identity': _convert_identity, 'InstanceNormalization': _convert_instancenorm, 'LeakyRelu': _convert_leaky_relu, 'Log': _convert_log, 'LogSoftmax': _convert_softmax, 'LRN': _convert_lrn, 'Less': _convert_less, 'LSTM': _convert_lstm, 'MatMul': _convert_matmul, 'Max': _convert_max, 'MaxPool': _convert_pool, 'Mean': _convert_mean, 'Min': _convert_min, 'Mod': _convert_mod, 'Mul': _convert_mul, 'Neg': _convert_neg, 'NonZero': _convert_nonzero, 'Not': _convert_logical, 'Or': _convert_logical, 'Pad': _convert_pad, 'Pow': _convert_pow, 'PRelu': _convert_prelu, 'RandomNormal': _convert_randomnormal, 'RandomNormalLike': _convert_randomnormallike, 'RandomUniform': _convert_randomuniform, 'RandomUniformLike': _convert_randomuniformlike, 'Reciprocal': _convert_reciprocal, 'ReduceL1': _convert_reduce, 'ReduceL2': _convert_reduce, 'ReduceLogSum': _convert_reduce, 'ReduceLogSumExp': _convert_reduce, 'ReduceMax': _convert_reduce, 'ReduceMean': _convert_reduce, 'ReduceMin': _convert_reduce, 'ReduceProd': _convert_reduce, 'ReduceSum': _convert_reduce, 'ReduceSumSquare': _convert_reduce, 'Relu': _convert_relu, 'Reshape': _convert_reshape, 'Resize': _convert_resize, 'ReverseSequence': _convert_reverse_sequence, 'RoiAlign': _convert_roialign, 'Round': _convert_round, 'Scatter': _convert_scatter, 'Selu': _convert_selu, 'Sigmoid': _convert_sigmoid, 'Sign': _convert_sign, 'Size': _convert_size, 'Slice': _convert_slice, 'Softmax': _convert_softmax, 'Softplus': _convert_softplus, 'Softsign': _convert_softsign, 'SpaceToDepth': _convert_reorganize_data, 'Split': _convert_split, 'Shape': _convert_shape, 'Sqrt': _convert_sqrt, 'Squeeze': _convert_squeeze, 'Sub': _convert_sub, 'Sum': _convert_add, 'Tanh': _convert_tanh, 'ThresholdedRelu': _convert_thresholdedrelu, 'Tile': _convert_tile, 'TopK': _convert_topk, 'Transpose': _convert_transpose, 'Unsqueeze': _convert_unsqueeze, 'Upsample': _convert_upsample, 'Xor': _convert_logical, 'Where': _convert_where}
