...
class Ifd(dict):
    ...
    size = property(lambda obj: {'ifd': struct.calcsize('=H' + len(obj) * 'HHLL' + 'L'), 'data': reduce(int.__add__, [t.calcsize() for t in dict.values(obj)])}, None, None, 'return ifd-packed size and data-packed size')
