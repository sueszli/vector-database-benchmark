...
INVALID_SORTED_DEPENDENCIES_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_sorted_dependencies.ts')
INVALID_CONSTANT_IN_TS_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_constant_in_ts_file.ts')
INVALID_CONSTANT_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid.constants.ts')
INVALID_CONSTANT_AJS_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid.constants.ajs.ts')
VALID_IGNORED_SERVICE_PATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_ignored.service.ts')
VALID_UNLISTED_SERVICE_PATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_unlisted.service.ts')
