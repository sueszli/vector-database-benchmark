...
class TestMatmulV2ScaleFusePass(PassAutoScanTest):
    ...
    def sample_predictor_configs(self, program_config):
        ...
        yield (config, ['matmul_v2'], (1e-05, 1e-05))
    ...
    def sample_program_config(self, draw):
        ...
        matmul_v2_op = OpConfig('matmul_v2', inputs={'X': ['matmul_x'], 'Y': ['matmul_y']}, outputs={'Out': ['matmul_out']}, trans_x=transpose_X, trans_y=transpose_Y)
    ...
    def test(self):
        if False:
            i = 10
            return i + 15
        self.run_and_statis(quant=False, max_examples=100, passes=['matmul_v2_scale_fuse_pass'])
