...
__all__ = ['PipelineOptions', 'StandardOptions', 'TypeOptions', 'DirectOptions', 'GoogleCloudOptions', 'AzureOptions', 'HadoopFileSystemOptions', 'WorkerOptions', 'DebugOptions', 'ProfilingOptions', 'SetupOptions', 'TestOptions', 'S3Options']
...
additional_type_checks = {'ptransform_fn': additional_option_ptransform_fn}
