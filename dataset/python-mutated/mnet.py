...
class MnetIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.mnet.com/tv/vod/171008', 'info_dict': {'id': '171008', 'title': 'SS_이해인@히든박스', 'description': 'md5:b9efa592c3918b615ba69fe9f8a05c55', 'duration': 88, 'upload_date': '20151231', 'timestamp': 1451564040, 'age_limit': 0, 'thumbnails': 'mincount:5', 'thumbnail': 're:^https?://.*\\.jpg$', 'ext': 'flv'}, 'params': {'skip_download': True}}, {'url': 'http://mnet.interest.me/tv/vod/172790', 'only_matching': True}, {'url': 'http://www.mnet.com/tv/vod/vod_view.asp?clip_id=172790&tabMenu=', 'only_matching': True}]
