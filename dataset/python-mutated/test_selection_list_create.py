...
class SelectionListApp(App[None]):
    ...
    def compose(self) -> ComposeResult:
        if False:
            for i in range(10):
                print('nop')
        yield SelectionList[int](('0', 0), ('1', 1, False), ('2', 2, True), Selection('3', 3, id='3'), Selection('4', 4, True, id='4'))
...
async def test_add_later() -> None:
    ...
    async with SelectionListApp().run_test() as pilot:
        ...
        selections.add_options([Selection('7', 7), Selection('8', 8, True), ('9', 9), ('10', 10, True)])
