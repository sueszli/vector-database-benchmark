...
class MyTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            return 10
        fixtures = {'proc_net_arp': ('fixtures/linux-proc/net_arp', 'fixtures/linux-proc/net_arp.json')}
    ...
    def test_proc_net_arp(self):
        if False:
            print('Hello World!')
        "\n        Test '/proc/net/arp'\n        "
        self.assertEqual(jc.parsers.proc_net_arp.parse(self.f_in['proc_net_arp'], quiet=True), self.f_json['proc_net_arp'])
