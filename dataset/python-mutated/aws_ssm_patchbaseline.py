...
class SSMPatchBaselineProvider(ResourceProvider[SSMPatchBaselineProperties]):
    ...
    def create(self, request: ResourceRequest[SSMPatchBaselineProperties]) -> ProgressEvent[SSMPatchBaselineProperties]:
        if False:
            return 10
        '\n        Create a new resource.\n\n        Primary identifier fields:\n          - /properties/Id\n\n        Required properties:\n          - Name\n\n        Create-only properties:\n          - /properties/OperatingSystem\n\n        Read-only properties:\n          - /properties/Id\n\n\n\n        '
        model = request.desired_state
        ssm = request.aws_client_factory.ssm
        params = util.select_attributes(model=model, params=['OperatingSystem', 'Name', 'GlobalFilters', 'ApprovalRules', 'ApprovedPatches', 'ApprovedPatchesComplianceLevel', 'ApprovedPatchesEnableNonSecurity', 'RejectedPatches', 'RejectedPatchesAction', 'Description', 'Sources', 'ClientToken', 'Tags'])
        response = ssm.create_patch_baseline(**params)
        model['Id'] = response['BaselineId']
        return ProgressEvent(status=OperationStatus.SUCCESS, resource_model=model, custom_context=request.custom_context)

    def read(self, request: ResourceRequest[SSMPatchBaselineProperties]) -> ProgressEvent[SSMPatchBaselineProperties]:
        if False:
            return 10
        '\n        Fetch resource information\n\n\n        '
        raise NotImplementedError

    def delete(self, request: ResourceRequest[SSMPatchBaselineProperties]) -> ProgressEvent[SSMPatchBaselineProperties]:
        if False:
            i = 10
            return i + 15
        '\n        Delete a resource\n\n\n        '
    ...
    def update(self, request: ResourceRequest[SSMPatchBaselineProperties]) -> ProgressEvent[SSMPatchBaselineProperties]:
        if False:
            i = 10
            return i + 15
        '\n        Update a resource\n\n\n        '
