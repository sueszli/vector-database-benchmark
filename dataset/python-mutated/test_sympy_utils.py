...
from torch.testing._internal.common_utils import TEST_Z3, instantiate_parametrized_tests, parametrize, run_tests, TestCase
...
CONSTANTS = [-1, 0, 1, 2, 3, 4, 5, 8, 16, 32, 64, 100, 101, 2 ** 24, 2 ** 32, 2 ** 37 - 1, sys.maxsize - 1, sys.maxsize]
