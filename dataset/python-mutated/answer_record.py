...
__protobuf__ = proto.module(package='google.cloud.dialogflow.v2', manifest={'AnswerRecord', 'ListAnswerRecordsRequest', 'ListAnswerRecordsResponse', 'UpdateAnswerRecordRequest', 'AnswerFeedback', 'AgentAssistantFeedback', 'AgentAssistantRecord'})

class AnswerRecord(proto.Message):
    """Answer records are records to manage answer history and feedbacks
    for Dialogflow.
    ...
    answer_feedback: 'AnswerFeedback' = proto.Field(proto.MESSAGE, number=2, message='AnswerFeedback')
    agent_assistant_record: 'AgentAssistantRecord' = proto.Field(proto.MESSAGE, number=4, oneof='record', message='AgentAssistantRecord')
...
class ListAnswerRecordsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    answer_records: MutableSequence['AnswerRecord'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AnswerRecord')
...
class UpdateAnswerRecordRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            get updated.
    """
    answer_record: 'AnswerRecord' = proto.Field(proto.MESSAGE, number=1, message='AnswerRecord')
...
class AnswerFeedback(proto.Message):
    """Represents feedback the customer has about the quality &
    ...
    class CorrectnessLevel(proto.Enum):
        ...
        PARTIALLY_CORRECT = 2
        FULLY_CORRECT = 3
    correctness_level: CorrectnessLevel = proto.Field(proto.ENUM, number=1, enum=CorrectnessLevel)
    agent_assistant_detail_feedback: 'AgentAssistantFeedback' = proto.Field(proto.MESSAGE, number=2, oneof='detail_feedback', message='AgentAssistantFeedback')
    clicked: bool = proto.Field(proto.BOOL, number=3)
    click_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
    displayed: bool = proto.Field(proto.BOOL, number=4)
    display_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
...
class AgentAssistantFeedback(proto.Message):
    ...
    class SummarizationFeedback(proto.Message):
        ...
        summary_text: str = proto.Field(proto.STRING, number=3)
    ...
    class KnowledgeSearchFeedback(proto.Message):
        ...
        Attributes:
            ...
            clicked_uris (MutableSequence[str]):
                ...
                will be updated to be true.
        """
        answer_copied: bool = proto.Field(proto.BOOL, number=1)
        clicked_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    answer_relevance: AnswerRelevance = proto.Field(proto.ENUM, number=1, enum=AnswerRelevance)
    document_correctness: DocumentCorrectness = proto.Field(proto.ENUM, number=2, enum=DocumentCorrectness)
    document_efficiency: DocumentEfficiency = proto.Field(proto.ENUM, number=3, enum=DocumentEfficiency)
    summarization_feedback: SummarizationFeedback = proto.Field(proto.MESSAGE, number=4, message=SummarizationFeedback)
    knowledge_search_feedback: KnowledgeSearchFeedback = proto.Field(proto.MESSAGE, number=5, message=KnowledgeSearchFeedback)
...
class AgentAssistantRecord(proto.Message):
    ...
    Attributes:
        ...
        dialogflow_assist_answer (google.cloud.dialogflow_v2.types.DialogflowAssistAnswer):
            ...
            This field is a member of `oneof`_ ``answer``.
    """
    article_suggestion_answer: participant.ArticleAnswer = proto.Field(proto.MESSAGE, number=5, oneof='answer', message=participant.ArticleAnswer)
    faq_answer: participant.FaqAnswer = proto.Field(proto.MESSAGE, number=6, oneof='answer', message=participant.FaqAnswer)
    dialogflow_assist_answer: participant.DialogflowAssistAnswer = proto.Field(proto.MESSAGE, number=7, oneof='answer', message=participant.DialogflowAssistAnswer)
