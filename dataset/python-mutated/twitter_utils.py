...
if sys.version_info > (3,):
    unicode = str
CHAR_RANGES = [range(0, 4351), range(8192, 8205), range(8208, 8223), range(8242, 8247)]
...
URL_REGEXP = re.compile("(^(?!(https?://|www\\.)?\\.|ftps?://|([0-9]+\\.){{1,3}}\\d+)(?:https?://|www\\.)*^(?!.*@)(?:[\\w+-_]+[.])(?:{0}\\b(?:[:0-9]))(?:[\\w+\\/]?[a-z0-9!\\*\\'\\(\\);:&=\\+\\$/%#\\[\\]\\-_\\.,~?])*)".format('\\b|'.join(TLDS)), re.U | re.I | re.X)
