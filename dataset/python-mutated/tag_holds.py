...
import proto
__protobuf__ = proto.module(package='google.cloud.resourcemanager.v3', manifest={'TagHold', 'CreateTagHoldRequest', 'CreateTagHoldMetadata', 'DeleteTagHoldRequest', 'DeleteTagHoldMetadata', 'ListTagHoldsRequest', 'ListTagHoldsResponse'})
...
class TagHold(proto.Message):
    ...
    holder: str = proto.Field(proto.STRING, number=2)
    origin: str = proto.Field(proto.STRING, number=3)
    help_link: str = proto.Field(proto.STRING, number=4)
...
class CreateTagHoldRequest(proto.Message):
    ...
    tag_hold: 'TagHold' = proto.Field(proto.MESSAGE, number=2, message='TagHold')
...
class ListTagHoldsRequest(proto.Message):
    """The request message for listing the TagHolds under a
    TagValue.
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    tag_holds: MutableSequence['TagHold'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TagHold')
