...
branch_labels = None
depends_on = None
indexes = (('idx_uor_id', 'user_object_role', ['id']), ('idx_uor_user_id', 'user_object_role', ['user_id']), ('idx_uor_context', 'user_object_role', ['context']), ('idx_uor_role', 'user_object_role', ['role']), ('idx_uor_user_id_role', 'user_object_role', ['user_id', 'role']), ('idx_ra_role', 'role_action', ['role']), ('idx_ra_action', 'role_action', ['action']), ('idx_ra_role_action', 'role_action', ['action', 'role']))
