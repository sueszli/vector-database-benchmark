...
from typing import Any, Callable, Deque, Dict, Iterable, List, Mapping, Optional, Sequence, Set, Tuple, TypedDict, TypeVar, cast
import sentry_sdk
...
SnubaTransaction = TypedDict('SnubaTransaction', {'id': str, 'transaction.status': int, 'transaction.op': str, 'transaction.duration': int, 'transaction': str, 'timestamp': str, 'trace.span': str, 'trace.parent_span': str, 'root': str, 'project.id': int, 'project': str, 'issue.ids': List[int]})
SnubaError = TypedDict('SnubaError', {'id': str, 'timestamp': str, 'trace.span': str, 'transaction': str, 'issue.id': int, 'title': str, 'tags[level]': str, 'project.id': int, 'project': str})
...
LightResponse = TypedDict('LightResponse', {'event_id': str, 'span_id': str, 'transaction': str, 'transaction.duration': int, 'transaction.op': str, 'project_id': int, 'project_slug': str, 'parent_span_id': Optional[str], 'parent_event_id': Optional[str], 'generation': Optional[int], 'errors': List[TraceError], 'performance_issues': List[TracePerformanceIssue]})
FullResponse = TypedDict('FullResponse', {'event_id': str, 'span_id': str, 'transaction': str, 'transaction.duration': int, 'transaction.op': str, 'project_id': int, 'project_slug': str, 'parent_span_id': Optional[str], 'parent_event_id': Optional[str], 'profile_id': Optional[str], 'generation': Optional[int], 'errors': List[TraceError], 'performance_issues': List[TracePerformanceIssue], 'timestamp': str, 'start_timestamp': str, 'children': List[Any], 'measurements': Dict[str, int], 'tags': List[Tuple[str, str]], '_meta': Dict[str, Any], 'transaction.status': str})
