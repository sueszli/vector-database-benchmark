...
from ..utils import ExtractorError, OnDemandPagedList, int_or_none, jwt_decode_hs256, mimetype2ext, qualities, traverse_obj, try_call, unified_timestamp
...
class IwaraUserIE(IwaraBaseIE):
    ...
    IE_NAME = 'iwara:user'
    _PER_PAGE = 32
    _TESTS = [{'url': 'https://iwara.tv/profile/user792540/videos', 'info_dict': {'id': 'user792540', 'title': 'Lyu ya'}, 'playlist_mincount': 70}, {'url': 'https://iwara.tv/profile/theblackbirdcalls/videos', 'info_dict': {'id': 'theblackbirdcalls', 'title': 'TheBlackbirdCalls'}, 'playlist_mincount': 723}, {'url': 'https://iwara.tv/profile/user792540', 'only_matching': True}, {'url': 'https://iwara.tv/profile/theblackbirdcalls', 'only_matching': True}, {'url': 'https://www.iwara.tv/profile/lumymmd', 'info_dict': {'id': 'lumymmd', 'title': 'Lumy MMD'}, 'playlist_mincount': 1}]
...
class IwaraPlaylistIE(IwaraBaseIE):
    ...
    _PER_PAGE = 32
    _TESTS = [{'url': 'https://iwara.tv/playlist/458e5486-36a4-4ac0-b233-7e9eef01025f', 'info_dict': {'id': '458e5486-36a4-4ac0-b233-7e9eef01025f'}, 'playlist_mincount': 3}]
