...
if pg.Qt.QT_LIB == 'PySide6' and tuple(map(int, pg.Qt.PySide6.__version__.split('.'))) > (6, 4) and (tuple(map(int, version('matplotlib').split('.'))) < (3, 6, 2)):
    pytest.skip('matplotlib + PySide6 6.4 bug', allow_module_level=True)
