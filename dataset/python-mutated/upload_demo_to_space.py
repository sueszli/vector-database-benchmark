...
if __name__ == '__main__':
    ...
    parser.add_argument('space_id', type=str, help='Name of the space to upload the demo to')
    ...
    new_space = upload_demo_to_space(args.demo_name, args.space_id, args.hf_token, args.gradio_version)
    print(new_space)