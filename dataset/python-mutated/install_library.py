...
_cudnn_records.append(__make_cudnn_record('10.2', '8.7.0', 'cudnn-linux-x86_64-8.7.0.84_cuda10-archive.tar.xz', 'cudnn-windows-x86_64-8.7.0.84_cuda10-archive.zip'))
...
_nccl_records.append(_make_nccl_record('12.x', '2.16.2', '2.16.2', 'nccl_2.16.2-1+cuda12.0_x86_64.txz'))
_nccl_records.append(_make_nccl_record('11.x', '2.16.2', '2.16.2', 'nccl_2.16.2-1+cuda11.8_x86_64.txz'))
_nccl_records.append(_make_nccl_record('11.1', '2.8.4', '2.8', 'nccl_2.8.4-1+cuda11.1_x86_64.txz'))
_nccl_records.append(_make_nccl_record('11.0', '2.16.2', '2.16.2', 'nccl_2.16.2-1+cuda11.0_x86_64.txz'))
_nccl_records.append(_make_nccl_record('10.2', '2.15.5', '2.15.5', 'nccl_2.15.5-1+cuda10.2_x86_64.txz'))
