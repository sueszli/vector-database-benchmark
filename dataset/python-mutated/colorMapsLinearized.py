...
name_list = ('warm', 'neutral', 'cool', 'green', 'amber', 'blue', 'red', 'pink', 'lavender', (0.5, 0.2, 0.1, 0.8))
ramp_list = [pg.colormap.makeMonochrome(name) for name in name_list]
cm_list = []
cm = pg.ColorMap(None, [QtGui.QColor(0, 0, 0), QtGui.QColor(10, 10, 10), QtGui.QColor(127, 127, 127), QtGui.QColor(240, 240, 240), QtGui.QColor(255, 255, 255)])
