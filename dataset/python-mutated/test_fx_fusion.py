...
import torch
from torch._inductor.fx_passes.pre_grad import linear_permute_fusion, linear_transpose, permute_linear_fusion, permute_matmul_fusion, sink_cat_after_pointwise, transpose_linear, transpose_matmul
