...
class Alsace20TVIE(Alsace20TVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.alsace20.tv/VOD/Actu/JT/Votre-JT-jeudi-3-fevrier-lyNHCXpYJh.html', 'info_dict': {'id': 'lyNHCXpYJh', 'ext': 'mp4', 'description': 'md5:fc0bc4a0692d3d2dba4524053de4c7b7', 'title': 'Votre JT du jeudi 3 février', 'upload_date': '20220203', 'thumbnail': 're:https?://.+\\.jpg', 'duration': 1073, 'view_count': int}}]
...
class Alsace20TVEmbedIE(Alsace20TVBaseIE):
    ...
    _TESTS = [{'url': 'https://www.alsace20.tv/emb/lyNHCXpYJh', 'info_dict': {'id': 'lyNHCXpYJh', 'ext': 'mp4', 'title': 'Votre JT du jeudi 3 février', 'upload_date': '20220203', 'thumbnail': 're:https?://.+\\.jpg', 'view_count': int}, 'params': {'format': 'bestvideo'}}]
