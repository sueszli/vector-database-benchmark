...
class ExampleTests(TestCase):
    ...
    exportdb_not_supported_rewrite_cases = [(name, rewrite_case) for (name, case) in filter_examples_by_support_level(SupportLevel.NOT_SUPPORTED_YET).items() for rewrite_case in get_rewrite_cases(case)]
