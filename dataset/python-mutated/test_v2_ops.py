...
from coremltools.converters.mil.frontend.tensorflow2.test.testing_utils import make_tf2_graph as make_tf_graph, run_compare_tf2 as run_compare_tf
...
from coremltools.converters.mil.frontend.tensorflow.test.test_ops import TestActivationElu, TestActivationLeakyReLU, TestActivationReLU, TestActivationReLU6, TestActivationSelu, TestActivationSigmoid, TestActivationSoftmax, TestActivationSoftPlus, TestActivationSoftSign, TestAddN, TestBroadcastTo, TestBatchToSpaceND, TestCond, TestConcat, TestConv, TestConv3d, TestDepthwiseConv, TestElementWiseBinary, TestIsFinite, TestLinear, TestNormalization, TestPad, TestPack, TestPooling1d, TestPooling2d, TestPooling3d, TestSeparableConv, TestSpaceToBatchND, TestTensorArray, TestWhileLoop, TestReshape, TestSelect, TestSlice, TestZerosLike
del TestWhileLoop.test_nested_while_body
