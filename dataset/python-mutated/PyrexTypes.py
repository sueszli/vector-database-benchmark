...
class PyObjectType(PyrexType):
    ...
    def nullcheck_string(self, cname):
        if False:
            ...
            return i + 15
        return cname
builtin_types_that_cannot_create_refcycles = frozenset({'object', 'bool', 'int', 'long', 'float', 'complex', 'bytearray', 'bytes', 'unicode', 'str', 'basestring'})
...
complex_ops = {(1, '-'): 'neg', (1, 'zero'): 'is_zero', (2, '+'): 'sum', (2, '-'): 'diff', (2, '*'): 'prod', (2, '/'): 'quot', (2, '**'): 'pow', (2, '=='): 'eq'}
...
builtin_cpp_conversions = {'std::pair': 2, 'std::vector': 1, 'std::list': 1, 'std::set': 1, 'std::unordered_set': 1, 'std::map': 2, 'std::unordered_map': 2, 'std::complex': 1}
...
rank_to_type_name = ('char', 'short', 'int', 'long', 'PY_LONG_LONG', 'float', 'double', 'long double')
...
cy_numeric_type = FusedType([c_short_type, c_int_type, c_long_type, c_float_type, c_double_type, c_float_complex_type, c_double_complex_type], name='numeric')
...
modifiers_and_name_to_type = {(0, 0, 'char'): c_uchar_type, (1, 0, 'char'): c_char_type, (2, 0, 'char'): c_schar_type, (0, -1, 'int'): c_ushort_type, (0, 0, 'int'): c_uint_type, (0, 1, 'int'): c_ulong_type, (0, 2, 'int'): c_ulonglong_type, (1, -1, 'int'): c_short_type, (1, 0, 'int'): c_int_type, (1, 1, 'int'): c_long_type, (1, 2, 'int'): c_longlong_type, (2, -1, 'int'): c_sshort_type, (2, 0, 'int'): c_sint_type, (2, 1, 'int'): c_slong_type, (2, 2, 'int'): c_slonglong_type, (1, 0, 'float'): c_float_type, (1, 0, 'double'): c_double_type, (1, 1, 'double'): c_longdouble_type, (1, 0, 'complex'): c_double_complex_type, (1, 0, 'floatcomplex'): c_float_complex_type, (1, 0, 'doublecomplex'): c_double_complex_type, (1, 1, 'doublecomplex'): c_longdouble_complex_type, (1, 0, 'void'): c_void_type, (1, 0, 'Py_tss_t'): c_pytss_t_type, (1, 0, 'bint'): c_bint_type, (0, 0, 'Py_UNICODE'): c_py_unicode_type, (0, 0, 'Py_UCS4'): c_py_ucs4_type, (2, 0, 'Py_hash_t'): c_py_hash_t_type, (2, 0, 'Py_ssize_t'): c_py_ssize_t_type, (2, 0, 'ssize_t'): c_ssize_t_type, (0, 0, 'size_t'): c_size_t_type, (2, 0, 'ptrdiff_t'): c_ptrdiff_t_type, (1, 0, 'object'): py_object_type}
...
_special_type_characters = {'__': '__dunder', 'const ': '__const_', ' ': '__space_', '*': '__ptr', '&': '__ref', '&&': '__fwref', '[': '__lArr', ']': '__rArr', '<': '__lAng', '>': '__rAng', '(': '__lParen', ')': '__rParen', ',': '__comma_', '...': '__EL', '::': '__in_', ':': '__D'}
_escape_special_type_characters = partial(re.compile(' ?(%s) ?' % '|'.join((re.escape(s) for s in sorted(_special_type_characters, reverse=True)))).sub, lambda match: _special_type_characters[match.group(1)])
