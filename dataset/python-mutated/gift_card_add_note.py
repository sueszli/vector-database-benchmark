...
class GiftCardAddNote(BaseMutation):
    ...
    class Arguments:
        id = graphene.ID(required=True, description='ID of the gift card to add a note for.')
        input = GiftCardAddNoteInput(required=True, description='Fields required to create a note for the gift card.')
