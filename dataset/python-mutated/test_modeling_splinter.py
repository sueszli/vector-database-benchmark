...
class SplinterModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (SplinterModel, SplinterForQuestionAnswering, SplinterForPreTraining) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': SplinterModel, 'question-answering': SplinterForQuestionAnswering} if is_torch_available() else {}
