...
class ColorClusterHandler(ClusterHandler):
    ...
    REPORT_CONFIG = (AttrReportConfig(attr='current_x', config=REPORT_CONFIG_DEFAULT), AttrReportConfig(attr='current_y', config=REPORT_CONFIG_DEFAULT), AttrReportConfig(attr='current_hue', config=REPORT_CONFIG_DEFAULT), AttrReportConfig(attr='current_saturation', config=REPORT_CONFIG_DEFAULT), AttrReportConfig(attr='color_temperature', config=REPORT_CONFIG_DEFAULT))
    MAX_MIREDS: int = 500
    MIN_MIREDS: int = 153
    ZCL_INIT_ATTRS = {'color_mode': False, 'color_temp_physical_min': True, 'color_temp_physical_max': True, 'color_capabilities': True, 'color_loop_active': False, 'enhanced_current_hue': False, 'start_up_color_temperature': True, 'options': True}
