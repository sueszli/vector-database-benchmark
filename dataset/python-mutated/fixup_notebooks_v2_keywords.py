...
class notebooksCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'check_instance_upgradability': ('notebook_instance',), 'create_instance': ('parent', 'instance_id', 'instance', 'request_id'), 'delete_instance': ('name', 'request_id'), 'diagnose_instance': ('name', 'diagnostic_config', 'timeout_minutes'), 'get_instance': ('name',), 'list_instances': ('parent', 'page_size', 'page_token', 'order_by', 'filter'), 'reset_instance': ('name',), 'rollback_instance': ('name', 'target_snapshot', 'revision_id'), 'start_instance': ('name',), 'stop_instance': ('name',), 'update_instance': ('instance', 'update_mask', 'request_id'), 'upgrade_instance': ('name',)}
