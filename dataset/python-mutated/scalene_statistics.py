...
class ScaleneStatistics:
    ...
    def build_function_stats(self, filename: Filename):
        ...
        return fn_stats
    payload_contents = ['max_footprint', 'max_footprint_loc', 'current_footprint', 'elapsed_time', 'alloc_samples', 'stacks', 'total_cpu_samples', 'cpu_samples_c', 'cpu_samples_python', 'bytei_map', 'cpu_samples', 'cpu_utilization', 'core_utilization', 'memory_malloc_samples', 'memory_python_samples', 'memory_free_samples', 'memcpy_samples', 'memory_max_footprint', 'per_line_footprint_samples', 'total_memory_free_samples', 'total_memory_malloc_samples', 'memory_footprint_samples', 'function_map', 'firstline_map', 'gpu_samples', 'total_gpu_samples', 'memory_malloc_count', 'memory_free_count']
