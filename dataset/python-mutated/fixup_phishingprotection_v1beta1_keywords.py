...
class phishingprotectionCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'report_phishing': ('parent', 'uri')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=phishingprotectionCallTransformer()):
    if False:
        while True:
            i = 10
