...
tests = {'Vanilla': ({'optimizer': optim.SGD(0.01), 'nu': 0.5}, {'learning_rate': 'constant', 'eta0': 0.01, 'nu': 0.5}), 'No intercept': ({'optimizer': optim.SGD(0.01), 'nu': 0.5, 'intercept_lr': 0.0}, {'learning_rate': 'constant', 'eta0': 0.01, 'nu': 0.5, 'fit_intercept': False})}
