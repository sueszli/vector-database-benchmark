...
experiment_source_association = sa.Table('experiments_sources', Base.metadata, sa.Column('experiment_id', sa.Integer, sa.ForeignKey('experiment.experiment_id')), sa.Column('source_id', sa.Integer, sa.ForeignKey('source.source_id')))
experiment_repository_association = sa.Table('experiments_repositories', Base.metadata, sa.Column('experiment_id', sa.Integer, sa.ForeignKey('experiment.experiment_id')), sa.Column('repository_id', sa.Integer, sa.ForeignKey('repository.repository_id')))
experiment_dependency_association = sa.Table('experiments_dependencies', Base.metadata, sa.Column('experiment_id', sa.Integer, sa.ForeignKey('experiment.experiment_id')), sa.Column('dependency_id', sa.Integer, sa.ForeignKey('dependency.dependency_id')))
...
class Experiment(Base):
    ...
    repositories = sa.orm.relationship('Repository', secondary=experiment_repository_association, backref='experiments')
...
run_resource_association = sa.Table('runs_resources', Base.metadata, sa.Column('run_id', sa.String(24), sa.ForeignKey('run.run_id')), sa.Column('resource_id', sa.Integer, sa.ForeignKey('resource.resource_id')))
...
class Run(Base):
    ...
    status = sa.Column(sa.Enum('RUNNING', 'COMPLETED', 'INTERRUPTED', 'TIMEOUT', 'FAILED', name='status_enum'))
