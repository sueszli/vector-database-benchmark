...
class InlineQueryResultGif(InlineQueryResult):
    ...
    """
    __slots__ = ('reply_markup', 'gif_height', 'thumbnail_mime_type', 'caption_entities', 'gif_width', 'title', 'caption', 'parse_mode', 'gif_duration', 'input_message_content', 'gif_url', 'thumbnail_url')

    def __init__(self, id: str, gif_url: str, thumbnail_url: str, gif_width: Optional[int]=None, gif_height: Optional[int]=None, title: Optional[str]=None, caption: Optional[str]=None, reply_markup: Optional[InlineKeyboardMarkup]=None, input_message_content: Optional['InputMessageContent']=None, gif_duration: Optional[int]=None, parse_mode: ODVInput[str]=DEFAULT_NONE, caption_entities: Optional[Sequence[MessageEntity]]=None, thumbnail_mime_type: Optional[str]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            print('Hello World!')
