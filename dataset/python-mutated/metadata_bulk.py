...
from qt.core import QComboBox, QCompleter, QDateTime, QDialog, QDialogButtonBox, QFont, QGridLayout, QInputDialog, QLabel, QLineEdit, QProgressBar, QSize, Qt, QVBoxLayout, pyqtSignal
...
class MetadataBulkDialog(QDialog, Ui_MetadataBulkDialog):
    s_r_functions = {'': lambda x: x, _('Lower Case'): lambda x: icu_lower(x), _('Upper Case'): lambda x: icu_upper(x), _('Title Case'): lambda x: titlecase(x), _('Capitalize'): lambda x: capitalize(x)}
    s_r_match_modes = [_('Character match'), _('Regular expression')]
    s_r_replace_modes = [_('Replace field'), _('Prepend to field'), _('Append to field')]
