...
from airbyte_cdk.sources.file_based.schema_helpers import ComparableType, SchemaType, conforms_to_schema, merge_schemas, type_mapping_to_jsonschema
COMPLETE_CONFORMING_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_EXTRA_COLUMN_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}, 'column_x': 'extra'}
CONFORMING_WITH_MISSING_COLUMN_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2]}
CONFORMING_WITH_NARROWER_TYPE_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': True, 'number_field': True, 'string_field': True, 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_WIDER_TYPE_RECORD = {'null_field': 'not None', 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_NON_OBJECT_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': 'not an object'}
NONCONFORMING_NON_ARRAY_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': 'not an array', 'object_field': {'col': 'val'}}
CONFORMING_MIXED_TYPE_NARROWER_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_MIXED_TYPE_WIDER_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
CONFORMING_MIXED_TYPE_WITHIN_TYPE_RANGE_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'val1', 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_INVALID_ARRAY_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': ['this should not be an array'], 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
NONCONFORMING_TOO_WIDE_ARRAY_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'okay', 'array_field': ['val1', 'val2'], 'object_field': {'col': 'val'}}
CONFORMING_NARROWER_ARRAY_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': 'okay', 'array_field': [1, 2], 'object_field': {'col': 'val'}}
NONCONFORMING_INVALID_OBJECT_RECORD = {'null_field': None, 'boolean_field': True, 'integer_field': 1, 'number_field': 1.5, 'string_field': {'this': 'should not be an object'}, 'array_field': [1.1, 2.2], 'object_field': {'col': 'val'}}
SCHEMA = {'type': 'object', 'properties': {'null_field': {'type': 'null'}, 'boolean_field': {'type': 'boolean'}, 'integer_field': {'type': 'integer'}, 'number_field': {'type': 'number'}, 'string_field': {'type': 'string'}, 'array_field': {'type': 'array', 'items': {'type': 'number'}}, 'object_field': {'type': 'object'}}}
