...
class Dog(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[DogArgs]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            while True:
                i = 10
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, __props__=None):
        ...
        super(Dog, __self__).__init__('example::Dog', resource_name, __props__, opts)

    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions]=None) -> 'Dog':
        if False:
            return 10
