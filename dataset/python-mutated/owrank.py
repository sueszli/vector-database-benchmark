...
from AnyQt.QtCore import QItemSelection, QItemSelectionModel, QItemSelectionRange, Qt, pyqtSignal as Signal
from AnyQt.QtWidgets import QButtonGroup, QCheckBox, QGridLayout, QHeaderView, QItemDelegate, QRadioButton, QStackedWidget, QTableView
...
CLS_SCORES = [ScoreMeta('Information Gain', 'Info. gain', score.InfoGain, ProblemType.CLASSIFICATION, False), ScoreMeta('Information Gain Ratio', 'Gain ratio', score.GainRatio, ProblemType.CLASSIFICATION, True), ScoreMeta('Gini Decrease', 'Gini', score.Gini, ProblemType.CLASSIFICATION, True), ScoreMeta('ANOVA', 'ANOVA', score.ANOVA, ProblemType.CLASSIFICATION, False), ScoreMeta('χ²', 'χ²', score.Chi2, ProblemType.CLASSIFICATION, False), ScoreMeta('ReliefF', 'ReliefF', score.ReliefF, ProblemType.CLASSIFICATION, False), ScoreMeta('FCBF', 'FCBF', score.FCBF, ProblemType.CLASSIFICATION, False)]
REG_SCORES = [ScoreMeta('Univariate Regression', 'Univar. reg.', score.UnivariateLinearRegression, ProblemType.REGRESSION, True), ScoreMeta('RReliefF', 'RReliefF', score.RReliefF, ProblemType.REGRESSION, True)]
...
if __name__ == '__main__':
    ...
    previewer.send_signals(set_learner=(RandomForestLearner(), (3, 'Learner', None)))
    previewer.run()
