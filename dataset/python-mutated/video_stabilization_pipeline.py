...
from modelscope.models.cv.video_stabilization.DUTRAFTStabilizer import DUTRAFTStabilizer
...
@PIPELINES.register_module(Tasks.video_stabilization, module_name=Pipelines.video_stabilization)
