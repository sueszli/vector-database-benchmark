...
plane = scene.visuals.Volume(vol, parent=view.scene, raycasting_mode='plane', method='mip', plane_thickness=3.0, plane_position=(128, 60, 64), plane_normal=(1, 0, 0))
volume = scene.visuals.Volume(vol, parent=view.scene, raycasting_mode='volume', method='mip')
