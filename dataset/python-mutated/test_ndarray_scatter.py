...
@testing.parameterize({'shape': (2, 3, 4), 'slices': numpy.array(-1), 'value': 1}, {'shape': (2, 3, 4), 'slices': numpy.array([1, 0]), 'value': 1}, {'shape': (2, 3, 4), 'slices': (slice(None), [1, 2]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(None), [[1, 2], [0, -1]]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(None), slice(None), [[1, 2], [0, 3]]), 'value': 1}, {'shape': (2, 3), 'slices': ([1, 1], slice(None)), 'value': 1}, {'shape': (2, 3), 'slices': ([1, 0, 1], slice(None)), 'value': 1}, {'shape': (2, 3), 'slices': (slice(1, 2), [1, 0, 1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(None), slice(1, 2), [[1, 3], [0, 2]]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (None, [1, -1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (None, [1, -1], None), 'value': 1}, {'shape': (3, 4, 5), 'slices': (None, None, None, [1, -1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(0, 1), None, [1, -1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(0, 1), slice(1, 2), [1, -1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(0, 1), None, slice(1, 2), [1, -1]), 'value': 1}, {'shape': (3, 4, 5), 'slices': (slice(None), [[1, 2], [0, -1]]), 'value': numpy.arange(3 * 2 * 2 * 5).reshape(3, 2, 2, 5)}, {'shape': (2, 3, 4), 'slices': ([1, 0], [2, 1]), 'value': numpy.arange(2 * 4).reshape(2, 4)}, {'shape': (2, 3, 4), 'slices': ([1, 0], slice(None), [2, 1]), 'value': numpy.arange(2 * 3).reshape(2, 3)}, {'shape': (2, 3, 4), 'slices': ([1, 0], slice(None), [[2, 0], [3, 1]]), 'value': numpy.arange(2 * 2 * 3).reshape(2, 2, 3)}, {'shape': (1, 1, 2, 3, 4), 'slices': (None, slice(None), 0, [1, 0], slice(0, 2, 2), [2, -1]), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([1, 1], [1, 1]), 'value': numpy.arange(2 * 4).reshape(2, 4)}, {'shape': (2, 3, 4), 'slices': ([1, 1], slice(None), [[2, 2], [3, 1]]), 'value': numpy.arange(2 * 2 * 3).reshape(2, 2, 3)}, {'shape': (2, 3, 4), 'slices': ([1, 1], 1, [[2, 2], [3, 1]]), 'value': numpy.arange(2 * 2).reshape(2, 2)}, {'shape': (3, 4, 5), 'slices': (numpy.random.choice([False, True], (3, 4, 5)),), 'value': 1}, {'shape': (3, 4, 5), 'slices': (numpy.random.choice([False, True], (3,)),), 'value': numpy.arange(4 * 5).reshape(4, 5)}, {'shape': (3, 4, 5), 'slices': (slice(None), numpy.array([True, False, False, True])), 'value': numpy.arange(3 * 2 * 5).reshape(3, 2, 5)}, {'shape': (2, 3, 4), 'slices': [], 'value': 1}, {'shape': (2, 3, 4), 'slices': [], 'value': numpy.array([1, 1, 1, 1])}, {'shape': (2, 3, 4), 'slices': [], 'value': numpy.random.uniform(size=(3, 4))}, {'shape': (2, 3, 4), 'slices': numpy.array([], dtype=numpy.int32), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([],), 'value': 1}, {'shape': (2, 3, 4), 'slices': numpy.array([[]], dtype=numpy.int32), 'value': numpy.random.uniform(size=(3, 4))}, {'shape': (2, 3, 4), 'slices': ([[]],), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([[[]]],), 'value': 1}, {'shape': (2, 3, 4, 5), 'slices': ([[[]]],), 'value': 1}, {'shape': (2, 3, 4, 5), 'slices': ([[[[]]]],), 'value': 1}, {'shape': (2, 3, 4), 'slices': (slice(None), []), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([], []), 'value': 1}, {'shape': (2, 3, 4), 'slices': numpy.array([], dtype=numpy.bool_), 'value': 1}, {'shape': (2, 3, 4), 'slices': (slice(None), numpy.array([], dtype=numpy.bool_)), 'value': 1}, {'shape': (2, 3, 4), 'slices': numpy.array([[], []], dtype=numpy.bool_), 'value': numpy.random.uniform(size=(4,))}, {'shape': (2, 3, 4), 'slices': [1], 'value': 1}, {'shape': (2, 3, 4), 'slices': [1, 1], 'value': numpy.arange(2 * 3 * 4).reshape(2, 3, 4)}, {'shape': (2, 3, 4), 'slices': ([1],), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([1, 1],), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([1], [1]), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([1, 1], 1), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([1], slice(1, 2)), 'value': 1}, {'shape': (2, 3, 4), 'slices': ([[1]], slice(1, 2)), 'value': 1}, _ids=False)
