...
from webauthn.helpers.structs import AttestationFormat, AuthenticationCredential, AuthenticatorAssertionResponse, AuthenticatorAttestationResponse, PublicKeyCredentialType, RegistrationCredential
