...
from Orange.classification import OneClassSVMLearner, EllipticEnvelopeLearner, LocalOutlierFactorLearner, IsolationForestLearner
...
class LocalOutlierFactorEditor(ParametersEditor):
    METRICS = ('euclidean', 'manhattan', 'cosine', 'jaccard', 'hamming', 'minkowski')
...
class OWOutliers(OWWidget, ConcurrentWidgetMixin):
    ...
    METHODS = (OneClassSVMLearner, EllipticEnvelopeLearner, LocalOutlierFactorLearner, IsolationForestLearner)
