...
sparse_configs_short = op_bench.config_list(attr_names=['M', 'SL', 'SBS', 'ZPB'], attrs=[[(32, 16), 0.3, (4, 1), 2], [(32, 16), 0.6, (1, 4), 4], [(17, 23), 0.9, (1, 1), 1]], tags=('short',))
sparse_configs_long = op_bench.cross_product_configs(M=((128, 128), (255, 324)), SL=(0.0, 1.0, 0.3, 0.6, 0.9, 0.99), SBS=((1, 4), (1, 8), (4, 1), (8, 1)), ZPB=(0, 1, 2, 3, 4, None), tags=('long',))
