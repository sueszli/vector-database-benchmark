...
class RecurbateIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://recurbate.com/play.php?video=39161415', 'md5': 'dd2b4ec57aa3e3572cb5cf0997fca99f', 'info_dict': {'id': '39161415', 'ext': 'mp4', 'description': 'md5:db48d09e4d93fc715f47fd3d6b7edd51', 'title': 'Performer zsnicole33 show on 2022-10-25 20:23, Chaturbate Archive – Recurbate', 'age_limit': 18}, 'skip': 'Website require membership.'}]
