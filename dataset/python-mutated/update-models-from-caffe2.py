...
from caffe2.python.models.download import deleteDirectory, downloadFromURLToFile, getURLFromName
...
model_mapping = {'bvlc_alexnet': 'bvlc_alexnet', 'bvlc_googlenet': 'bvlc_googlenet', 'bvlc_reference_caffenet': 'bvlc_reference_caffenet', 'bvlc_reference_rcnn_ilsvrc13': 'bvlc_reference_rcnn_ilsvrc13', 'densenet121': 'densenet121', 'inception_v1': 'inception_v1', 'inception_v2': 'inception_v2', 'resnet50': 'resnet50', 'shufflenet': 'shufflenet', 'squeezenet': 'squeezenet_old', 'vgg19': 'vgg19', 'zfnet512': 'zfnet512'}
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Update the ONNX models.')
    parser.add_argument('-v', action='store_true', default=False, help='verbose')
    parser.add_argument('--local-dir', type=str, default=os.path.expanduser('~'), help='local dir to store Caffe2 and ONNX models')
    parser.add_argument('--no-cache', action='store_true', default=False, help='whether use local ONNX models')
    parser.add_argument('--clean-test-data', action='store_true', default=False, help='remove the old test data')
    parser.add_argument('--add-test-data', type=int, default=0, help='add new test data')
    parser.add_argument('--only-local', action='store_true', default=False, help='no upload including backup')
