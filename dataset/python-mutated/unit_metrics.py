...
UNIT_CONNECTIONS_ACCEPTED_TOTAL = Gauge('unit_connections_accepted_total', '', multiprocess_mode='livesum')
UNIT_CONNECTIONS_ACTIVE = Gauge('unit_connections_active', '', multiprocess_mode='livesum')
UNIT_CONNECTIONS_CLOSED = Gauge('unit_connections_closed', '', multiprocess_mode='livesum')
UNIT_CONNECTIONS_IDLE = Gauge('unit_connections_idle', '', multiprocess_mode='livesum')
UNIT_CONNECTIONS_TOTAL = Gauge('unit_requests_total', '', multiprocess_mode='livesum')
UNIT_PROCESSES_RUNNING_GAUGE = Gauge('unit_application_processes_running', '', multiprocess_mode='livesum', labelnames=['application'])
UNIT_PROCESSES_STARTING_GAUGE = Gauge('unit_application_processes_starting', '', multiprocess_mode='livesum', labelnames=['application'])
UNIT_PROCESSES_IDLE_GAUGE = Gauge('unit_application_processes_idle', '', multiprocess_mode='livesum', labelnames=['application'])
UNIT_REQUESTS_ACTIVE_GAUGE = Gauge('unit_application_requests_active', '', multiprocess_mode='livesum', labelnames=['application'])
