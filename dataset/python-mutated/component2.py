...
class Component2(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[Component2Args]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            i = 10
            return i + 15
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, __props__=None):
        ...
        super(Component2, __self__).__init__('example:mod:Component2', resource_name, __props__, opts)

    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions]=None) -> 'Component2':
        if False:
            print('Hello World!')
