...
class TestIBMModel3(unittest.TestCase):
    ...
    def test_prob_t_a_given_s(self):
        ...
        distortion_table[1][1][5][6] = 0.97
        distortion_table[2][4][5][6] = 0.97
        distortion_table[3][0][5][6] = 0.97
        distortion_table[4][2][5][6] = 0.97
        distortion_table[5][5][5][6] = 0.97
        distortion_table[6][5][5][6] = 0.97
        ...
        probabilities = {'p1': 0.167, 'translation_table': translation_table, 'distortion_table': distortion_table, 'fertility_table': fertility_table, 'alignment_table': None}
