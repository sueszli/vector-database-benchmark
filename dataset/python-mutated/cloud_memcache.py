...
class Instance(proto.Message):
    ...
    class NodeConfig(proto.Message):
        ...
        Attributes:
            ...
            memory_size_mb (int):
                ...
                Memcached node.
        """
        cpu_count: int = proto.Field(proto.INT32, number=1)
        memory_size_mb: int = proto.Field(proto.INT32, number=2)
    ...
    class Node(proto.Message):
        ...
        class State(proto.Enum):
            ...
            DELETING = 3
            UPDATING = 4
        node_id: str = proto.Field(proto.STRING, number=1)
        zone: str = proto.Field(proto.STRING, number=2)
        state: 'Instance.Node.State' = proto.Field(proto.ENUM, number=3, enum='Instance.Node.State')
        host: str = proto.Field(proto.STRING, number=4)
        port: int = proto.Field(proto.INT32, number=5)
        parameters: 'MemcacheParameters' = proto.Field(proto.MESSAGE, number=6, message='MemcacheParameters')
    ...
    class InstanceMessage(proto.Message):
        ...
        class Code(proto.Enum):
            ...
            CODE_UNSPECIFIED = 0
            ZONE_DISTRIBUTION_UNBALANCED = 1
        code: 'Instance.InstanceMessage.Code' = proto.Field(proto.ENUM, number=1, enum='Instance.InstanceMessage.Code')
    ...
    authorized_network: str = proto.Field(proto.STRING, number=4)
    zones: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    node_count: int = proto.Field(proto.INT32, number=6)
    node_config: NodeConfig = proto.Field(proto.MESSAGE, number=7, message=NodeConfig)
    memcache_version: 'MemcacheVersion' = proto.Field(proto.ENUM, number=9, enum='MemcacheVersion')
    parameters: 'MemcacheParameters' = proto.Field(proto.MESSAGE, number=11, message='MemcacheParameters')
    memcache_nodes: MutableSequence[Node] = proto.RepeatedField(proto.MESSAGE, number=12, message=Node)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=13, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=14, message=timestamp_pb2.Timestamp)
    state: State = proto.Field(proto.ENUM, number=15, enum=State)
    memcache_full_version: str = proto.Field(proto.STRING, number=18)
    instance_messages: MutableSequence[InstanceMessage] = proto.RepeatedField(proto.MESSAGE, number=19, message=InstanceMessage)
    discovery_endpoint: str = proto.Field(proto.STRING, number=20)
    maintenance_policy: 'MaintenancePolicy' = proto.Field(proto.MESSAGE, number=21, message='MaintenancePolicy')
    maintenance_schedule: 'MaintenanceSchedule' = proto.Field(proto.MESSAGE, number=22, message='MaintenanceSchedule')
...
class MaintenanceSchedule(proto.Message):
    ...
    schedule_deadline_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
...
class RescheduleMaintenanceRequest(proto.Message):
    ...
    class RescheduleType(proto.Enum):
        ...
        NEXT_AVAILABLE_WINDOW = 2
        SPECIFIC_TIME = 3
    instance: str = proto.Field(proto.STRING, number=1)
...
class ApplyParametersRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    node_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    apply_all: bool = proto.Field(proto.BOOL, number=3)
...
class UpdateParametersRequest(proto.Message):
    ...
    parameters: 'MemcacheParameters' = proto.Field(proto.MESSAGE, number=3, message='MemcacheParameters')
...
class MemcacheParameters(proto.Message):
    ...
    params: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=3)
