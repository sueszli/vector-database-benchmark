...
from ...operations._attestation_providers_operations import build_create_request, build_delete_request, build_get_default_by_location_request, build_get_request, build_list_by_resource_group_request, build_list_default_request, build_list_request, build_update_request
...
class AttestationProvidersOperations:
    ...
    async def get(self, resource_group_name: str, provider_name: str, **kwargs: Any) -> _models.AttestationProvider:
        ...
        request = build_get_request(resource_group_name=resource_group_name, provider_name=provider_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def create(self, resource_group_name: str, provider_name: str, creation_params: _models.AttestationServiceCreationParams, *, content_type: str='application/json', **kwargs: Any) -> _models.AttestationProvider:
    ...
    @overload
    async def create(self, resource_group_name: str, provider_name: str, creation_params: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AttestationProvider:
        """Creates a new Attestation Provider.
    ...
    @distributed_trace_async
    async def create(self, resource_group_name: str, provider_name: str, creation_params: Union[_models.AttestationServiceCreationParams, IO], **kwargs: Any) -> _models.AttestationProvider:
        """Creates a new Attestation Provider.
        ...
        request = build_create_request(resource_group_name=resource_group_name, provider_name=provider_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def update(self, resource_group_name: str, provider_name: str, update_params: _models.AttestationServicePatchParams, *, content_type: str='application/json', **kwargs: Any) -> _models.AttestationProvider:
    ...
    @overload
    async def update(self, resource_group_name: str, provider_name: str, update_params: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AttestationProvider:
        """Updates the Attestation Provider.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, provider_name: str, update_params: Union[_models.AttestationServicePatchParams, IO], **kwargs: Any) -> _models.AttestationProvider:
        """Updates the Attestation Provider.
        ...
        request = build_update_request(resource_group_name=resource_group_name, provider_name=provider_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def delete(self, resource_group_name: str, provider_name: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, provider_name=provider_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> _models.AttestationProviderListResult:
    ...
    async def list_default(self, **kwargs: Any) -> _models.AttestationProviderListResult:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_list_default_request(subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_default.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def get_default_by_location(self, location: str, **kwargs: Any) -> _models.AttestationProvider:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_default_by_location_request(location=location, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_default_by_location.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
