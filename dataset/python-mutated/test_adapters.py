...
from airbyte_cdk.sources.streams.concurrent.adapters import AvailabilityStrategyFacade, StreamAvailabilityStrategy, StreamFacade, StreamPartition, StreamPartitionGenerator
