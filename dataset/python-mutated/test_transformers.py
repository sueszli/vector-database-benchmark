...
from torch.testing._internal.common_utils import TEST_FAIRSEQ, run_tests, parametrize, freeze_rng_state, TEST_WITH_CROSSREF, slowTest, set_default_dtype, gradcheck, make_tensor, NOTEST_CPU
from torch.testing._internal.common_methods_invocations import wrapper_set_seed
from torch.testing._internal.common_cuda import SM80OrLater, PLATFORM_SUPPORTS_FLASH_ATTENTION, PLATFORM_SUPPORTS_MEM_EFF_ATTENTION, PLATFORM_SUPPORTS_FUSED_ATTENTION
if TEST_FAIRSEQ:
...
default_atol = {torch.float16: 0.001, torch.bfloat16: 0.001, torch.float32: 1e-05}
default_rtol = {torch.float16: 0.001, torch.bfloat16: 0.016, torch.float32: 1.3e-06}
