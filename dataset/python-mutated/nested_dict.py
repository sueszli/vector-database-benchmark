...
import itertools
from typing import AbstractSet, Any, Dict, Generic, Iterable, Iterator, Mapping, MutableMapping, Optional, Sequence, Tuple, TypeVar, Union
from ray.rllib.utils.annotations import ExperimentalAPI
SeqStrType = Union[str, Sequence[str]]
T = TypeVar('T')
_NestedDictType = Dict[str, Any]
_NestedMappingType = Mapping[SeqStrType, Any]
NestedDictInputType = Union[Iterable[Tuple[SeqStrType, T]], _NestedMappingType, 'NestedDict[T]']
