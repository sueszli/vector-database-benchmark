...
class NTVRuIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.ntv.ru/novosti/863142/', 'md5': 'ba7ea172a91cb83eb734cad18c10e723', 'info_dict': {'id': '746000', 'ext': 'mp4', 'title': 'Командующий Черноморским флотом провел переговоры в штабе ВМС Украины', 'description': 'Командующий Черноморским флотом провел переговоры в штабе ВМС Украины', 'thumbnail': 're:^http://.*\\.jpg', 'duration': 136, 'view_count': int}}, {'url': 'http://www.ntv.ru/video/novosti/750370/', 'md5': 'adecff79691b4d71e25220a191477124', 'info_dict': {'id': '750370', 'ext': 'mp4', 'title': 'Родные пассажиров пропавшего Boeing не верят в трагический исход', 'description': 'Родные пассажиров пропавшего Boeing не верят в трагический исход', 'thumbnail': 're:^http://.*\\.jpg', 'duration': 172, 'view_count': int}}, {'url': 'http://www.ntv.ru/peredacha/segodnya/m23700/o232416', 'md5': '82dbd49b38e3af1d00df16acbeab260c', 'info_dict': {'id': '747480', 'ext': 'mp4', 'title': '«Сегодня». 21\xa0марта 2014\xa0года. 16:00', 'description': '«Сегодня». 21\xa0марта 2014\xa0года. 16:00', 'thumbnail': 're:^http://.*\\.jpg', 'duration': 1496, 'view_count': int}}, {'url': 'https://www.ntv.ru/kino/Koma_film/m70281/o336036/video/', 'md5': 'e9c7cde24d9d3eaed545911a04e6d4f4', 'info_dict': {'id': '1126480', 'ext': 'mp4', 'title': 'Остросюжетный фильм «Кома»', 'description': 'Остросюжетный фильм «Кома»', 'thumbnail': 're:^http://.*\\.jpg', 'duration': 5592, 'view_count': int}}, {'url': 'http://www.ntv.ru/serial/Delo_vrachey/m31760/o233916/', 'md5': '9320cd0e23f3ea59c330dc744e06ff3b', 'info_dict': {'id': '751482', 'ext': 'mp4', 'title': '«Дело врачей»: «Деревце жизни»', 'description': '«Дело врачей»: «Деревце жизни»', 'thumbnail': 're:^http://.*\\.jpg', 'duration': 2590, 'view_count': int}}, {'url': 'https://www.ntv.ru/video/1797442', 'only_matching': True}]
    _VIDEO_ID_REGEXES = ['<meta property="og:url" content="http://www\\.ntv\\.ru/video/(\\d+)', '<video embed=[^>]+><id>(\\d+)</id>', '<video restriction[^>]+><key>(\\d+)</key>']
