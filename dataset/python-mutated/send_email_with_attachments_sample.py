...
class EmailWithAttachmentSample(object):
    ...
    def send_email_with_attachment(self):
        ...
        message = {'content': {'subject': 'This is the subject', 'plainText': 'This is the body', 'html': 'html><h1>This is the body</h1></html>'}, 'recipients': {'to': [{'address': self.recipient_address, 'displayName': 'Customer Name'}]}, 'senderAddress': self.sender_address, 'attachments': [{'name': 'attachment.txt', 'contentType': 'text/plain', 'contentInBase64': file_bytes_b64.decode()}]}
        try:
