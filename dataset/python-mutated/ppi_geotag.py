...
def _FlagsList(myfields):
    ...
    for (i, value) in myfields.items():
        flags[i] = value
    return flags
_hcsi_gps_flags = _FlagsList({0: 'No Fix Available', 1: 'GPS', 2: 'Differential GPS', 3: 'Pulse Per Second', 4: 'Real Time Kinematic', 5: 'Float Real Time Kinematic', 6: 'Estimated (Dead Reckoning)', 7: 'Manual Input', 8: 'Simulation'})
_hcsi_vector_char_flags = _FlagsList({0: 'Antenna', 1: 'Direction of Travel', 2: 'Front of Vehicle', 3: 'Angle of Arrival', 4: 'Transmitter Position', 8: 'GPS Derived', 9: 'INS Derived', 10: 'Compass Derived', 11: 'Accelerometer Derived', 12: 'Human Derived'})
_hcsi_antenna_flags = _FlagsList({1: 'Horizontal Polarization', 2: 'Vertical Polarization', 3: 'Circular Polarization Left', 4: 'Circular Polarization Right', 16: 'Electronically Steerable', 17: 'Mechanically Steerable'})
_COMMON_GEOTAG_HEADERS = [ByteField('geotag_ver', CURR_GEOTAG_VER), ByteField('geotag_pad', 0), LEShortField('geotag_len', None)]
_COMMON_GEOTAG_FOOTER = [HCSIDescField('DescString', None), XLEIntField('AppId', None), HCSIAppField('AppData', None), HCSINullField('Extended')]
...
class PPI_Geotag_GPS(HCSIPacket):
    name = 'PPI GPS'
    hcsi_fields = [FlagsField('GPSFlags', None, -32, _hcsi_gps_flags), Fixed3_7Field('Latitude', None), Fixed3_7Field('Longitude', None), Fixed6_4Field('Altitude', None), Fixed6_4Field('Altitude_g', None), GPSTime_Field('GPSTime', None), NSCounter_Field('FractionalTime', None), Fixed3_6Field('eph', None), Fixed3_6Field('epv', None), NSCounter_Field('ept', None)] + _hcsi_null_range(10, 28)

class PPI_Geotag_Vector(HCSIPacket):
    name = 'PPI Vector'
    hcsi_fields = [VectorFlags_Field('VectorFlags', None), FlagsField('VectorChars', None, -32, _hcsi_vector_char_flags), Fixed3_6Field('Pitch', None), Fixed3_6Field('Roll', None), Fixed3_6Field('Heading', None), Fixed6_4Field('Off_X', None), Fixed6_4Field('Off_Y', None), Fixed6_4Field('Off_Z', None)] + _hcsi_null_range(8, 16) + [Fixed3_6Field('Err_Rot', None), Fixed6_4Field('Err_Off', None)] + _hcsi_null_range(18, 28)
...
class PPI_Geotag_Sensor(HCSIPacket):
    name = 'PPI Sensor'
    hcsi_fields = [LEShortEnumField('SensorType', None, sensor_types), SignedByteField('ScaleFactor', None), Fixed6_4Field('Val_X', None), Fixed6_4Field('Val_Y', None), Fixed6_4Field('Val_Z', None), Fixed6_4Field('Val_T', None), Fixed6_4Field('Val_E', None)] + _hcsi_null_range(7, 28)

class PPI_Geotag_Antenna(HCSIPacket):
    name = 'PPI Antenna'
    hcsi_fields = [FlagsField('AntennaFlags', None, -32, _hcsi_antenna_flags), ByteField('Gain', None), Fixed3_6Field('HorizBw', None), Fixed3_6Field('VertBw', None), Fixed3_6Field('PrecisionGain', None), XLEShortField('BeamID', None)] + _hcsi_null_range(6, 26) + [HCSIDescField('SerialNumber', None), HCSIDescField('ModelName', None)]
