...
import transformers
from transformers import WEIGHTS_NAME, AdamW, AlbertConfig, AlbertTokenizer, BertConfig, BertTokenizer, get_linear_schedule_with_warmup
...
MODEL_CLASSES = {'bert': (BertConfig, BertForSequenceClassificationWithPabee, BertTokenizer), 'albert': (AlbertConfig, AlbertForSequenceClassificationWithPabee, AlbertTokenizer)}
