...
class IEventSystem_Query(DCOMCALL):
    opnum = 7
    structure = (('progID', BSTR), ('queryCriteria', BSTR))

class IEventSystem_QueryResponse(DCOMANSWER):
    structure = (('errorIndex', INT), ('ppInterface', PMInterfacePointer), ('ErrorCode', error_status_t))

class IEventSystem_Store(DCOMCALL):
    opnum = 8
    structure = (('progID', BSTR), ('pInterface', PMInterfacePointer))
...
class IEventSystem_RemoveResponse(DCOMANSWER):
    structure = (('errorIndex', INT), ('ErrorCode', error_status_t))
...
class IEventSystem_get_EventObjectChangeEventClassIDResponse(DCOMANSWER):
    structure = (('pbstrEventClassID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSystem_QuerySResponse(DCOMANSWER):
    structure = (('pInterface', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEventClass_get_EventClassNameResponse(DCOMANSWER):
    structure = (('pbstrEventClassName', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass_get_OwnerSIDResponse(DCOMANSWER):
    structure = (('pbstrOwnerSID', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass_get_FiringInterfaceIDResponse(DCOMANSWER):
    structure = (('pbstrFiringInterfaceID', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass_get_DescriptionResponse(DCOMANSWER):
    structure = (('pbstrDescription', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass_get_TypeLibResponse(DCOMANSWER):
    structure = (('pbstrTypeLib', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass2_get_PublisherIDResponse(DCOMANSWER):
    structure = (('pbstrSubscriptionID', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass2_get_MultiInterfacePublisherFilterCLSIDResponse(DCOMANSWER):
    structure = (('pbstrPubFilCLSID', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass2_get_AllowInprocActivationResponse(DCOMANSWER):
    structure = (('pfAllowInprocActivation', BOOLEAN), ('ErrorCode', error_status_t))
...
class IEventClass2_get_FireInParallelResponse(DCOMANSWER):
    structure = (('pfFireInParallel', BOOLEAN), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_SubscriptionNameResponse(DCOMANSWER):
    structure = (('pbstrSubscriptionName', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_PublisherIDResponse(DCOMANSWER):
    structure = (('pbstrPublisherID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_MethodNameResponse(DCOMANSWER):
    structure = (('pbstrMethodName', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_SubscriberCLSIDResponse(DCOMANSWER):
    structure = (('pbstrSubscriberCLSID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_SubscriberInterfaceResponse(DCOMANSWER):
    structure = (('ppSubscriberInterface', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_PerUserResponse(DCOMANSWER):
    structure = (('pfPerUser', BOOLEAN), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_EnabledResponse(DCOMANSWER):
    structure = (('pfEnabled', BOOLEAN), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_MachineNameResponse(DCOMANSWER):
    structure = (('pbstrMachineName', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription_GetPublisherPropertyResponse(DCOMANSWER):
    structure = (('propertyValue', VARIANT), ('ErrorCode', error_status_t))

class IEventSubscription_PutPublisherProperty(DCOMCALL):
    opnum = 32
    structure = (('bstrPropertyName', BSTR), ('propertyValue', VARIANT))
...
class IEventSubscription_GetPublisherPropertyCollectionResponse(DCOMANSWER):
    structure = (('collection', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEventSubscription_get_InterfaceIDResponse(DCOMANSWER):
    structure = (('pbstrInterfaceID', BSTR), ('ErrorCode', error_status_t))
...
class IEnumEventObject_CloneResponse(DCOMANSWER):
    structure = (('ppInterface', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEnumEventObject_NextResponse(DCOMANSWER):
    structure = (('ppInterface', OBJECT_ARRAY), ('cRetElem', ULONG), ('ErrorCode', error_status_t))
...
class IEventObjectCollection_get__NewEnumResponse(DCOMANSWER):
    structure = (('ppUnkEnum', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEventObjectCollection_get_ItemResponse(DCOMANSWER):
    structure = (('pItem', VARIANT), ('ErrorCode', error_status_t))
...
class IEventObjectCollection_get_NewEnumResponse(DCOMANSWER):
    structure = (('ppEnum', PMInterfacePointer), ('ErrorCode', error_status_t))
...
class IEventObjectCollection_get_CountResponse(DCOMANSWER):
    structure = (('pCount', LONG), ('ErrorCode', error_status_t))

class IEventObjectCollection_Add(DCOMCALL):
    opnum = 11
    structure = (('item', VARIANT), ('objectID', BSTR))
...
class IEventClass3_get_EventClassPartitionIDResponse(DCOMANSWER):
    structure = (('pbstrEventClassPartitionID', BSTR), ('ErrorCode', error_status_t))
...
class IEventClass3_get_EventClassApplicationIDResponse(DCOMANSWER):
    structure = (('pbstrEventClassApplicationID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription2_get_FilterCriteriaResponse(DCOMANSWER):
    structure = (('pbstrFilterCriteria', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription2_get_SubscriberMonikerResponse(DCOMANSWER):
    structure = (('pbstrMoniker', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription3_get_SubscriberPartitionIDResponse(DCOMANSWER):
    structure = (('pbstrSubscriberPartitionID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSubscription3_get_SubscriberApplicationIDResponse(DCOMANSWER):
    structure = (('pbstrSubscriberApplicationID', BSTR), ('ErrorCode', error_status_t))
...
class IEventSystem2_GetVersionResponse(DCOMANSWER):
    structure = (('pnVersion', INT), ('ErrorCode', error_status_t))
