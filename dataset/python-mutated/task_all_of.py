...
class TaskAllOf(BaseModel):
    ...
    artifacts: conlist(Artifact) = Field(..., description='A list of artifacts that the task has produced.')
    ...
    def from_dict(cls, obj: dict) -> TaskAllOf:
        ...
        _obj = TaskAllOf.parse_obj({'task_id': obj.get('task_id'), 'artifacts': [Artifact.from_dict(_item) for _item in obj.get('artifacts')] if obj.get('artifacts') is not None else None})
        return _obj