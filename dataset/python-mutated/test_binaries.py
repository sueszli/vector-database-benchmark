...
from tests.utils import create_dummy_data, create_laser_data_and_config_json, generate_main, preprocess_lm_data, preprocess_summarization_data, preprocess_translation_data, train_language_model, train_translation_model
try:
    import transformers
...
class TestActivationCheckpointing(unittest.TestCase):
    base_flags = ['--encoder-layers', '2', '--decoder-layers', '2', '--encoder-embed-dim', '8', '--decoder-embed-dim', '8', '--restore-file', 'x.pt', '--log-format', 'json', '--log-interval', '1', '--max-update', '2']
