...
from kivy.properties import StringProperty, ListProperty, BooleanProperty, ObjectProperty, NumericProperty, AliasProperty
import collections.abc
from os import listdir
from os.path import basename, join, sep, normpath, expanduser, altsep, splitdrive, realpath, getsize, isdir, abspath, isfile, dirname
...
if __name__ == '__main__':
    ...
    import textwrap
    import sys
    root = Builder.load_string(textwrap.dedent("    BoxLayout:\n        orientation: 'vertical'\n\n        BoxLayout:\n            size_hint_y: None\n            height: sp(52)\n\n            Button:\n                text: 'Icon View'\n                on_press: fc.view_mode = 'icon'\n            Button:\n                text: 'List View'\n                on_press: fc.view_mode = 'list'\n\n        FileChooser:\n            id: fc\n\n            FileChooserIconLayout\n            FileChooserListLayout\n    "))
