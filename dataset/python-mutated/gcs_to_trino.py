...
class GCSToTrinoOperator(BaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('source_bucket', 'source_object', 'trino_table')

    def __init__(self, *, source_bucket: str, source_object: str, trino_table: str, trino_conn_id: str='trino_default', gcp_conn_id: str='google_cloud_default', schema_fields: Iterable[str] | None=None, schema_object: str | None=None, impersonation_chain: str | Sequence[str] | None=None, **kwargs) -> None:
        if False:
            print('Hello World!')
