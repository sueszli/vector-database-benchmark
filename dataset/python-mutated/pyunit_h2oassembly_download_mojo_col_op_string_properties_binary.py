...
def test_binary_string_properties_function(function, **params):
    if False:
        return 10
    values = [[12.5, '++&&texTtextText&+', 14, 'fsadf'], [12.2, '  fTFsaf   ', 24, 'fdsfsda'], [2.23, '      fd9af ', 34, 'fdsfsd'], [3.31, '+&texttext&&++', 34, ''], [4.31, '3fdsf3', 34, 'fdsa'], [1.13, '+texTText++', 34, 'h'], [52.4, '33  ', 34, '33'], [62.5, 's', 34, 's'], [82.6, '&&texTtexttext&', 34, 'text'], [12.8, 'ttaatt', 34, 'ttaa'], [35.9, 'asttatta', 34, 'atta'], [32.3, '', 34, 'd']]
    frame = h2o.H2OFrame(python_obj=values, column_names=['a', 'sl', 'c', 'sr'], column_types=['numeric', 'string', 'numeric', 'string'])
    assembly = H2OAssembly(steps=[('col_op_' + function.__name__, H2OBinaryOp(op=function, col='sl', right=H2OCol('sr'), new_col_name='n', inplace=False, **params))])
