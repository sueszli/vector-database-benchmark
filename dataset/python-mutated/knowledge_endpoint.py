...
class KnowledgeEndpoint(RESTEndpoint):
    ...
    @docs(tags=['General'], summary='Get tag suggestions for a torrent with a particular infohash.', responses={200: {'schema': schema(SuggestedTagsResponse={'suggestions': List(String)})}, HTTP_BAD_REQUEST: {'schema': HandledErrorSchema, 'example': {'error': 'Invalid infohash'}}}, description='This endpoint updates a particular torrent with the provided tags.')
