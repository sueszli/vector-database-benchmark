...
class tpuCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_node': ('parent', 'node', 'node_id'), 'delete_node': ('name',), 'generate_service_identity': ('parent',), 'get_accelerator_type': ('name',), 'get_guest_attributes': ('name', 'query_path', 'worker_ids'), 'get_node': ('name',), 'get_runtime_version': ('name',), 'list_accelerator_types': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_nodes': ('parent', 'page_size', 'page_token'), 'list_runtime_versions': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'start_node': ('name',), 'stop_node': ('name',), 'update_node': ('update_mask', 'node')}
