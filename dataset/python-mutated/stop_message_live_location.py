...
class StopMessageLiveLocation(TelegramMethod[Union[Message, bool]]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Optional[Union[int, str]]=None, message_id: Optional[int]=None, inline_message_id: Optional[str]=None, reply_markup: Optional[InlineKeyboardMarkup]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, reply_markup=reply_markup, **__pydantic_kwargs)