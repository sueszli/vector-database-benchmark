...
__protobuf__ = proto.module(package='google.cloud.support.v2', manifest={'GetCaseRequest', 'CreateCaseRequest', 'ListCasesRequest', 'ListCasesResponse', 'SearchCasesRequest', 'SearchCasesResponse', 'EscalateCaseRequest', 'UpdateCaseRequest', 'CloseCaseRequest', 'SearchCaseClassificationsRequest', 'SearchCaseClassificationsResponse'})
...
class CreateCaseRequest(proto.Message):
    ...
    case: gcs_case.Case = proto.Field(proto.MESSAGE, number=2, message=gcs_case.Case)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    cases: MutableSequence[gcs_case.Case] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_case.Case)
...
class SearchCasesRequest(proto.Message):
    ...
    query: str = proto.Field(proto.STRING, number=1)
...
class EscalateCaseRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    escalation: gcs_escalation.Escalation = proto.Field(proto.MESSAGE, number=2, message=gcs_escalation.Escalation)
...
class UpdateCaseRequest(proto.Message):
    ...
    """
    case: gcs_case.Case = proto.Field(proto.MESSAGE, number=1, message=gcs_case.Case)
...
class SearchCaseClassificationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    case_classifications: MutableSequence[gcs_case.CaseClassification] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_case.CaseClassification)
    next_page_token: str = proto.Field(proto.STRING, number=2)
