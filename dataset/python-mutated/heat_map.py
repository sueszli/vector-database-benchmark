...
from folium.utilities import if_pandas_df_convert_to_numpy, none_max, none_min, parse_options, validate_location
...
class HeatMap(JSCSSMixin, Layer):
    ...
    default_js = [('leaflet-heat.js', 'https://cdn.jsdelivr.net/gh/python-visualization/folium@main/folium/templates/leaflet_heat.min.js')]
