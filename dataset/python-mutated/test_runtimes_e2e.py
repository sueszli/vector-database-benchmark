...
from tests.end_to_end.test_stages import DefaultInitStage, PackageDownloadZipFunctionStage, DefaultDeleteStage, EndToEndBaseStage, DefaultSyncStage, BaseValidator
...
@parameterized_class(('runtime', 'dependency_manager'), [('go1.x', 'mod'), ('python3.7', 'pip')])
