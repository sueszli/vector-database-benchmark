...
from ..utils import encode_data_uri, ExtractorError, int_or_none, float_or_none, join_nonempty, mimetype2ext, str_or_none

class UstreamIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?(?:ustream\\.tv|video\\.ibm\\.com)/(?P<type>recorded|embed|embed/recorded)/(?P<id>\\d+)'
    IE_NAME = 'ustream'
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>https?://(?:www\\.)?(?:ustream\\.tv|video\\.ibm\\.com)/embed/.+?)\\1']
    _TESTS = [{'url': 'http://www.ustream.tv/recorded/20274954', 'md5': '088f151799e8f572f84eb62f17d73e5c', 'info_dict': {'id': '20274954', 'ext': 'flv', 'title': 'Young Americans for Liberty February 7, 2012 2:28 AM', 'description': 'Young Americans for Liberty February 7, 2012 2:28 AM', 'timestamp': 1328577035, 'upload_date': '20120207', 'uploader': 'yaliberty', 'uploader_id': '6780869'}}, {'url': 'http://www.ustream.tv/embed/recorded/59307601?ub=ff0000&lc=ff0000&oc=ffffff&uc=ffffff&v=3&wmode=direct', 'md5': '5a2abf40babeac9812ed20ae12d34e10', 'info_dict': {'id': '59307601', 'ext': 'flv', 'title': '-CG11- Canada Games Figure Skating', 'uploader': 'sportscanadatv'}, 'skip': 'This Pro Broadcaster has chosen to remove this video from the ustream.tv site.'}, {'url': 'http://www.ustream.tv/embed/10299409', 'info_dict': {'id': '10299409'}, 'playlist_count': 3}, {'url': 'http://www.ustream.tv/recorded/91343263', 'info_dict': {'id': '91343263', 'ext': 'mp4', 'title': 'GitHub Universe - General Session - Day 1', 'upload_date': '20160914', 'description': 'GitHub Universe - General Session - Day 1', 'timestamp': 1473872730, 'uploader': 'wa0dnskeqkr', 'uploader_id': '38977840'}, 'params': {'skip_download': True}}, {'url': 'https://video.ibm.com/embed/recorded/128240221?&autoplay=true&controls=true&volume=100', 'only_matching': True}]
...
class UstreamChannelIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.ustream.tv/channel/channeljapan', 'info_dict': {'id': '10874166'}, 'playlist_mincount': 17}
