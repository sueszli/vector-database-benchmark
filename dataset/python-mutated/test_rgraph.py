...
class TestRGraph(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.clf = RGraph(n_nonzero=100, transition_steps=20, gamma=50, blocksize_test_data=20, tau=1, preprocessing=True, active_support=False, gamma_nz=False, maxiter_lasso=100, contamination=self.contamination, algorithm='lasso_lars', verbose=0)
    ...
    def test_parameters(self):
        ...
        assert hasattr(self.clf, 'transition_matrix_') and self.clf.transition_matrix_ is not None
