...
class Command(BaseCommand):
    ...
    """
    help = 'Add instance to the database. When no options are provided, values from Django settings will be used to register the current system, as well as the default queues if needed (only used or enabled for Kubernetes installs). Override with `--hostname`.'
