...
variablePattern = re.compile('[\\t\\s]*0[xX][a-fA-F0-9]+$')
SkuIdPattern = re.compile('^[a-zA-Z_][a-zA-Z0-9_]*$')
Pattern = re.compile('^[1-9]\\d*|0$')
HexPattern = re.compile('0[xX][0-9a-fA-F]+$')
...
class DscBuildData(PlatformBuildClassObject):
    _PROPERTY_ = {TAB_DSC_DEFINES_PLATFORM_NAME: '_PlatformName', TAB_DSC_DEFINES_PLATFORM_GUID: '_Guid', TAB_DSC_DEFINES_PLATFORM_VERSION: '_Version', TAB_DSC_DEFINES_DSC_SPECIFICATION: '_DscSpecification', TAB_DSC_DEFINES_SKUID_IDENTIFIER: '_SkuName', TAB_DSC_DEFINES_BUILD_NUMBER: '_BuildNumber', TAB_DSC_DEFINES_MAKEFILE_NAME: '_MakefileName', TAB_DSC_DEFINES_BS_BASE_ADDRESS: '_BsBaseAddress', TAB_DSC_DEFINES_RT_BASE_ADDRESS: '_RtBaseAddress'}
