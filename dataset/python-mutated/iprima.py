...
from ..utils import determine_ext, js_to_json, urlencode_postdata, ExtractorError, parse_qs, traverse_obj
...
class IPrimaIE(InfoExtractor):
    ...
    access_token = None
    _TESTS = [{'url': 'https://prima.iprima.cz/particka/92-epizoda', 'info_dict': {'id': 'p51388', 'ext': 'mp4', 'title': 'Partička (92)', 'description': 'md5:859d53beae4609e6dd7796413f1b6cac', 'upload_date': '20201103', 'timestamp': 1604437480}, 'params': {'skip_download': True}}, {'url': 'http://play.iprima.cz/particka/particka-92', 'only_matching': True}, {'url': 'http://play.iprima.cz/closer-nove-pripady/closer-nove-pripady-iv-1', 'only_matching': True}, {'url': 'https://prima.iprima.cz/my-little-pony/mapa-znameni-2-2', 'only_matching': True}, {'url': 'https://prima.iprima.cz/porady/jak-se-stavi-sen/rodina-rathousova-praha', 'only_matching': True}, {'url': 'http://www.iprima.cz/filmy/desne-rande', 'only_matching': True}, {'url': 'https://zoom.iprima.cz/10-nejvetsich-tajemstvi-zahad/posvatna-mista-a-stavby', 'only_matching': True}, {'url': 'https://krimi.iprima.cz/mraz-0/sebevrazdy', 'only_matching': True}, {'url': 'https://cool.iprima.cz/derava-silnice-nevadi', 'only_matching': True}, {'url': 'https://love.iprima.cz/laska-az-za-hrob/slib-dany-bratrovi', 'only_matching': True}]
...
class IPrimaCNNIE(InfoExtractor):
    _VALID_URL = 'https?://cnn\\.iprima\\.cz/(?:[^/]+/)*(?P<id>[^/?#&]+)'
    _GEO_BYPASS = False
    _TESTS = [{'url': 'https://cnn.iprima.cz/porady/strunc/24072020-koronaviru-mam-plne-zuby-strasit-druhou-vlnou-je-absurdni-rika-senatorka-dernerova', 'info_dict': {'id': 'p716177', 'ext': 'mp4', 'title': 'md5:277c6b1ed0577e51b40ddd35602ff43e'}, 'params': {'skip_download': 'm3u8'}}]
