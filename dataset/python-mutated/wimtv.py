...
from ..utils import determine_ext, parse_duration, urlencode_postdata, ExtractorError
...
class WimTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://platform.wim.tv/embed/?vod=db29fb32-bade-47b6-a3a6-cb69fe80267a', 'md5': 'db29fb32-bade-47b6-a3a6-cb69fe80267a', 'info_dict': {'id': 'db29fb32-bade-47b6-a3a6-cb69fe80267a', 'ext': 'mp4', 'title': 'AMA SUPERCROSS 2020 - R2 ST. LOUIS', 'duration': 6481, 'thumbnail': 're:https?://.+?/thumbnail/.+?/720$'}, 'params': {'skip_download': True}}, {'url': 'https://platform.wim.tv/embed/?live=28e22c22-49db-40f3-8c37-8cbb0ff44556&autostart=true', 'info_dict': {'id': '28e22c22-49db-40f3-8c37-8cbb0ff44556', 'ext': 'mp4', 'title': 'Streaming MSmotorTV', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'https://platform.wim.tv/#/webtv/automotornews/vod/422492b6-539e-474d-9c6b-68c9d5893365', 'only_matching': True}, {'url': 'https://platform.wim.tv/#/webtv/renzoarborechannel/cast/f47e0d15-5b45-455e-bf0d-dba8ffa96365', 'only_matching': True}]
