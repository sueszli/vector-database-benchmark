...
class TestElementwiseApiForSemiAutoParallel:
    ...
    def test_add_x_shard(self):
        if False:
            while True:
                i = 10
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.add)

    def test_sub_x_shard(self):
        if False:
            print('Hello World!')
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.subtract)

    def test_add_x_shard_broadcast(self):
        if False:
            i = 10
            return i + 15
        self.test_binary_body(x_shape=[8, 16], y_shape=[2, 8, 16], out_shape=[2, 8, 16], x_specs=['x', None], y_specs=[None, None, None], binary_func=paddle.add)
    ...
    def test_add_x_y_shard(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, 'x'], binary_func=paddle.add)
    ...
    def test_add_x_y_shard_broadcast(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[4, 16, 32], y_shape=[16, 32], out_shape=[4, 16, 32], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.add)
    ...
    def test_sub_x_y_shard_broadcast(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[4, 16, 32], y_shape=[16, 32], out_shape=[4, 16, 32], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.subtract)

    def test_square_x_shard(self):
        if False:
            i = 10
            return i + 15
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.square)

    def test_relu_x_shard(self):
        if False:
            while True:
                i = 10
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=F.relu)

    def test_maximum_x_shard(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.maximum)

    def test_maximum_x_shard_broadcast(self):
        if False:
            while True:
                i = 10
        self.test_binary_body(x_shape=[16, 32], y_shape=[2, 16, 32], out_shape=[2, 16, 32], x_specs=['x', None], y_specs=[None, None, None], binary_func=paddle.maximum)
    ...
    def test_maximum_x_y_shard(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, 'x'], binary_func=paddle.maximum)

    def test_maximum_x_y_shard_broadcast(self):
        if False:
            while True:
                i = 10
        self.test_binary_body(x_shape=[4, 16, 32], y_shape=[16, 32], out_shape=[4, 16, 32], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.maximum)

    def test_multiply_x_shard(self):
        if False:
            print('Hello World!')
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.multiply)

    def test_multiply_x_shard_broadcast(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_binary_body(x_shape=[16, 32], y_shape=[2, 16, 32], out_shape=[2, 16, 32], x_specs=['x', None], y_specs=[None, None, None], binary_func=paddle.multiply)
    ...
    def test_multiply_x_y_shard(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, 'x'], binary_func=paddle.multiply)

    def test_multiply_x_y_shard_broadcast(self):
        if False:
            i = 10
            return i + 15
        self.test_binary_body(x_shape=[4, 6, 8], y_shape=[6, 8], out_shape=[4, 6, 8], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.multiply)

    def test_divide_x_shard(self):
        if False:
            print('Hello World!')
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.divide)

    def test_divide_x_shard_broadcast(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_binary_body(x_shape=[16, 32], y_shape=[2, 16, 32], out_shape=[2, 16, 32], x_specs=['x', None], y_specs=[None, None, None], binary_func=paddle.divide)
    ...
    def test_divide_x_y_shard(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, 'x'], binary_func=paddle.divide)

    def test_divide_x_y_shard_broadcast(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_binary_body(x_shape=[2, 4, 6], y_shape=[4, 6], out_shape=[2, 4, 6], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.divide)
    ...
    def test_elementwise_pow_x_shard(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, None], binary_func=paddle.pow)

    def test_elementwise_pow_x_shard_broadcast(self):
        if False:
            i = 10
            return i + 15
        self.test_binary_body(x_shape=[16, 32], y_shape=[2, 16, 32], out_shape=[2, 16, 32], x_specs=['x', None], y_specs=[None, None, None], binary_func=paddle.pow)
    ...
    def test_elementwise_pow_x_y_shard(self):
        ...
        if self._backend == 'cpu':
            return
        self.test_binary_body(x_shape=[16, 32], y_shape=[16, 32], out_shape=[16, 32], x_specs=['x', None], y_specs=[None, 'x'], binary_func=paddle.pow)

    def test_elementwise_pow_x_y_shard_broadcast(self):
        if False:
            return 10
        self.test_binary_body(x_shape=[4, 6, 8], y_shape=[6, 8], out_shape=[4, 6, 8], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.pow)
    ...
    def test_equal_x_y_shard_broadcast(self):
        if False:
            i = 10
            return i + 15
        self.test_binary_body(x_shape=[2, 6, 4], y_shape=[6, 4], out_shape=[2, 6, 4], x_specs=['x', None, None], y_specs=[None, None], binary_func=paddle.equal)

    def test_exp_x_shard(self):
        if False:
            for i in range(10):
                print('nop')
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.exp)

    def test_rsqrt_x_shard(self):
        if False:
            return 10
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.rsqrt)

    def test_silu_x_shard(self):
        if False:
            i = 10
            return i + 15
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.nn.functional.silu)

    def test_sin_x_shard(self):
        if False:
            print('Hello World!')
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.sin)

    def test_cos_x_shard(self):
        if False:
            i = 10
            return i + 15
        self.test_unary_body(x_shape=[4, 16], out_shape=[4, 16], x_specs=['x', None], unary_func=paddle.cos)
