...
from modelscope.models.cv.image_instance_segmentation import MaskDINOSwinModel, get_maskdino_ins_seg_result
...
@PIPELINES.register_module(Tasks.image_segmentation, module_name=Pipelines.maskdino_instance_segmentation)
