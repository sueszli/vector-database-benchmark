...
DECORATORS = [pytest.mark.xfail_browsers(node='No supported matplotlib backends on node'), pytest.mark.skip_refcount_check, pytest.mark.skip_pyproxy_check, pytest.mark.driver_timeout(60)]
