...
StatusPolicy.allow_actions([constants.LIST], scopes=[OauthScope.CLIENT_PRIVATE, OauthScope.CLIENT_PUBLIC])
StatusPolicy.allow_read(StatusPresenter.default_attributes + ['active_pipeline_run_count', 'last_scheduler_activity', 'last_user_request'], scopes=[OauthScope.CLIENT_PRIVATE, OauthScope.CLIENT_PUBLIC], on_action=[constants.LIST])