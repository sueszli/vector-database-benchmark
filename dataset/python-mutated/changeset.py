...
versionlabels = {'versionadded': _('New in version %s'), 'versionchanged': _('Changed in version %s'), 'deprecated': _('Deprecated since version %s')}
versionlabel_classes = {'versionadded': 'added', 'versionchanged': 'changed', 'deprecated': 'deprecated'}
...
class ChangeSetDomain(Domain):
    ...
    name = 'changeset'
    label = 'changeset'
    initial_data: dict[str, Any] = {'changes': {}}
