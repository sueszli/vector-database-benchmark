...
@testing.parameterize(*testing.product({'f': ['all', 'any'], 'x': [numpy.arange(24).reshape(2, 3, 4) - 10, numpy.zeros((2, 3, 4)), numpy.ones((2, 3, 4)), numpy.zeros((0, 3, 4)), numpy.ones((0, 3, 4))], 'axis': [None, (0, 1, 2), 0, 1, 2, (0, 1)], 'keepdims': [False, True]}))
class TestAllAny:
...
@testing.parameterize(*testing.product({'f': ['all', 'any'], 'x': [numpy.array([[[numpy.nan]]]), numpy.array([[[numpy.nan, 0]]]), numpy.array([[[numpy.nan, 1]]]), numpy.array([[[numpy.nan, 0, 1]]])], 'axis': [None, (0, 1, 2), 0, 1, 2, (0, 1)], 'keepdims': [False, True]}))
...
@testing.parameterize(*testing.product({'f': ['in1d', 'isin'], 'shape_x': [(0,), (3,), (2, 3), (2, 1, 3), (2, 0, 1), (2, 0, 1, 1)], 'shape_y': [(0,), (3,), (2, 3), (2, 1, 3), (2, 0, 1), (2, 0, 1, 1)], 'assume_unique': [False, True], 'invert': [False, True]}))
class TestIn1DIsIn:
