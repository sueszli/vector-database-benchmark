...
def import_gam_mojo_regression(family):
    ...
    test = train.drop('W')
    print(train)
    h2o_model = H2OGeneralizedAdditiveEstimator(family=family, gam_columns=['X3'], weights_column='W', lambda_=0, bs=[2], tweedie_variance_power=1.5, tweedie_link_power=0)
