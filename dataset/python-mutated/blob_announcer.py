...
class BlobAnnouncer:
    announcements_sent_metric = Counter('announcements_sent', 'Number of announcements sent and their respective status.', namespace='dht_node', labelnames=('peers', 'error'))
    announcement_queue_size_metric = Gauge('announcement_queue_size', 'Number of hashes waiting to be announced.', namespace='dht_node', labelnames=('scope',))
