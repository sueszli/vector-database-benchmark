...
from astropy.nddata.nduncertainty import IncompatibleUncertaintiesException, InverseVariance, MissingDataAssociationException, NDUncertainty, StdDevUncertainty, UnknownUncertainty, VarianceUncertainty, _move_preserved_axes_first, _unravel_preserved_axes
...
class FakeUncertainty(NDUncertainty):
    ...
    def _propagate_divide(self, data, final_data):
        if False:
            print('Hello World!')
        pass
uncertainty_types_to_be_tested = [FakeUncertainty, StdDevUncertainty, VarianceUncertainty, InverseVariance, UnknownUncertainty]
uncertainty_types_with_conversion_support = (StdDevUncertainty, VarianceUncertainty, InverseVariance)
