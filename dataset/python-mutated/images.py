...
import httpx
from ..types import ImagesResponse, image_edit_params, image_generate_params, image_create_variation_params
...
class AsyncImages(AsyncAPIResource):
    ...
    async def create_variation(self, *, image: FileTypes, model: Union[str, Literal['dall-e-2'], None] | NotGiven=NOT_GIVEN, n: Optional[int] | NotGiven=NOT_GIVEN, response_format: Optional[Literal['url', 'b64_json']] | NotGiven=NOT_GIVEN, size: Optional[Literal['256x256', '512x512', '1024x1024']] | NotGiven=NOT_GIVEN, user: str | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> ImagesResponse:
        ...
        if files:
            extra_headers = {'Content-Type': 'multipart/form-data', **(extra_headers or {})}
        return await self._post('/images/variations', body=maybe_transform(body, image_create_variation_params.ImageCreateVariationParams), files=files, options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=ImagesResponse)
    ...
    async def edit(self, *, image: FileTypes, prompt: str, mask: FileTypes | NotGiven=NOT_GIVEN, model: Union[str, Literal['dall-e-2'], None] | NotGiven=NOT_GIVEN, n: Optional[int] | NotGiven=NOT_GIVEN, response_format: Optional[Literal['url', 'b64_json']] | NotGiven=NOT_GIVEN, size: Optional[Literal['256x256', '512x512', '1024x1024']] | NotGiven=NOT_GIVEN, user: str | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> ImagesResponse:
        ...
        if files:
            extra_headers = {'Content-Type': 'multipart/form-data', **(extra_headers or {})}
        return await self._post('/images/edits', body=maybe_transform(body, image_edit_params.ImageEditParams), files=files, options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=ImagesResponse)
    ...
    async def generate(self, *, prompt: str, model: Union[str, Literal['dall-e-2', 'dall-e-3'], None] | NotGiven=NOT_GIVEN, n: Optional[int] | NotGiven=NOT_GIVEN, quality: Literal['standard', 'hd'] | NotGiven=NOT_GIVEN, response_format: Optional[Literal['url', 'b64_json']] | NotGiven=NOT_GIVEN, size: Optional[Literal['256x256', '512x512', '1024x1024', '1792x1024', '1024x1792']] | NotGiven=NOT_GIVEN, style: Optional[Literal['vivid', 'natural']] | NotGiven=NOT_GIVEN, user: str | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> ImagesResponse:
        ...
        Args:
          ...
          timeout: Override the client-level default timeout for this request, in seconds
        """
        return await self._post('/images/generations', body=maybe_transform({'prompt': prompt, 'model': model, 'n': n, 'quality': quality, 'response_format': response_format, 'size': size, 'style': style, 'user': user}, image_generate_params.ImageGenerateParams), options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=ImagesResponse)
