...
class ConversableAgent(Agent):
    ...
    async def a_send(self, message: Union[Dict, str], recipient: Agent, request_reply: Optional[bool]=None, silent: Optional[bool]=False) -> bool:
    ...
    async def a_receive(self, message: Union[Dict, str], sender: Agent, request_reply: Optional[bool]=None, silent: Optional[bool]=False):
    ...
    async def a_initiate_chat(self, recipient: 'ConversableAgent', clear_history: Optional[bool]=True, silent: Optional[bool]=False, **context):
    ...
    async def a_generate_reply(self, messages: Optional[List[Dict]]=None, sender: Optional[Agent]=None, exclude: Optional[List[Callable]]=None) -> Union[str, Dict, None]:
