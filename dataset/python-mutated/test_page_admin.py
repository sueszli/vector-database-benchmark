...
from cms.test_utils.testcases import URL_CMS_PAGE, URL_CMS_PAGE_ADD, URL_CMS_PAGE_ADVANCED_CHANGE, URL_CMS_PAGE_CHANGE, URL_CMS_PAGE_MOVE, CMSTestCase
...
class PageTestBase(CMSTestCase):
    ...
    """
    placeholderconf = {'body': {'limits': {'global': 2, 'TextPlugin': 1}}}
