...
from golem.environments.environment import Environment, UnsupportReason, SupportStatus
from golem.environments.environmentsmanager import EnvironmentsManager as OldEnvManager
...
class TestCompTaskKeeper(LogTestCase, PEP8MixIn, TempDirFixture):
    PEP8_FILES = ['golem/task/taskkeeper.py']
