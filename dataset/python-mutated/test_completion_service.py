...
from google.cloud.retail_v2.services.completion_service import CompletionServiceAsyncClient, CompletionServiceClient, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(CompletionServiceClient, 'grpc'), (CompletionServiceAsyncClient, 'grpc_asyncio'), (CompletionServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.CompletionServiceGrpcTransport, 'grpc'), (transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.CompletionServiceRestTransport, 'rest')])
...
def test_completion_service_client_get_transport_class():
    ...
    available_transports = [transports.CompletionServiceGrpcTransport, transports.CompletionServiceRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(CompletionServiceClient, transports.CompletionServiceGrpcTransport, 'grpc'), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (CompletionServiceClient, transports.CompletionServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(CompletionServiceClient, transports.CompletionServiceGrpcTransport, 'grpc', 'true'), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'true'), (CompletionServiceClient, transports.CompletionServiceGrpcTransport, 'grpc', 'false'), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'false'), (CompletionServiceClient, transports.CompletionServiceRestTransport, 'rest', 'true'), (CompletionServiceClient, transports.CompletionServiceRestTransport, 'rest', 'false')])
@mock.patch.object(CompletionServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(CompletionServiceClient))
@mock.patch.object(CompletionServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(CompletionServiceAsyncClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(CompletionServiceClient, transports.CompletionServiceGrpcTransport, 'grpc', grpc_helpers), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async), (CompletionServiceClient, transports.CompletionServiceRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(CompletionServiceClient, transports.CompletionServiceGrpcTransport, 'grpc', grpc_helpers), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
@pytest.mark.parametrize('request_type', [completion_service.CompleteQueryRequest, dict])
def test_complete_query(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.complete_query), '__call__') as call:
        call.return_value = completion_service.CompleteQueryResponse(attribution_token='attribution_token_value')
...
async def test_complete_query_async(transport: str='grpc_asyncio', request_type=completion_service.CompleteQueryRequest):
    client = CompletionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.complete_query), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(completion_service.CompleteQueryResponse(attribution_token='attribution_token_value'))
...
async def test_complete_query_field_headers_async():
    client = CompletionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = completion_service.CompleteQueryRequest()
    request.catalog = 'catalog_value'
    with mock.patch.object(type(client.transport.complete_query), '__call__') as call:
...
@pytest.mark.parametrize('request_type', [import_config.ImportCompletionDataRequest, dict])
...
def test_complete_query_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = completion_service.CompleteQueryResponse(attribution_token='attribution_token_value')
...
def test_complete_query_rest_interceptors(null_interceptor):
    if False:
        i = 10
        return i + 15
    transport = transports.CompletionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CompletionServiceRestInterceptor())
    client = CompletionServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CompletionServiceRestInterceptor, 'post_complete_query') as post, mock.patch.object(transports.CompletionServiceRestInterceptor, 'pre_complete_query') as pre:
...
def test_import_completion_data_rest_interceptors(null_interceptor):
    ...
    transport = transports.CompletionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CompletionServiceRestInterceptor())
    client = CompletionServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CompletionServiceRestInterceptor, 'post_import_completion_data') as post, mock.patch.object(transports.CompletionServiceRestInterceptor, 'pre_import_completion_data') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        while True:
            i = 10
    transport = transports.CompletionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.CompletionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CompletionServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.CompletionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.CompletionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CompletionServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.CompletionServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.CompletionServiceGrpcTransport, transports.CompletionServiceGrpcAsyncIOTransport, transports.CompletionServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = CompletionServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_completion_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2.services.completion_service.transports.CompletionServiceTransport.__init__') as Transport:
        ...
        transport = transports.CompletionServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('complete_query', 'import_completion_data', 'get_operation', 'list_operations')
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.CompletionServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.CompletionServiceGrpcTransport, grpc_helpers), (transports.CompletionServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_completion_service_host_no_port(transport_name):
    if False:
        while True:
            i = 10
    client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='retail.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('retail.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://retail.googleapis.com')
...
def test_completion_service_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='retail.googleapis.com:8000'), transport=transport_name)
...
def test_completion_service_client_transport_session_collision(transport_name):
    ...
    client1 = CompletionServiceClient(credentials=creds1, transport=transport_name)
    client2 = CompletionServiceClient(credentials=creds2, transport=transport_name)
...
def test_completion_service_grpc_transport_channel():
    ...
    transport = transports.CompletionServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_completion_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.CompletionServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_completion_service_grpc_lro_async_client():
    if False:
        for i in range(10):
            print('nop')
    client = CompletionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.CompletionServiceTransport, '_prep_wrapped_messages') as prep:
        client = CompletionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(CompletionServiceClient, transports.CompletionServiceGrpcTransport), (CompletionServiceAsyncClient, transports.CompletionServiceGrpcAsyncIOTransport)])
