...
SIMPLIFY_TYPE = {type(None): type(None), bool: bool, float: float, int: int, str: str, list: list, tuple: list, dict: dict, DogmaticDict: dict, DogmaticList: list}
if opt.has_numpy:
    ...
    NP_INTS = ['int8', 'int16', 'int32', 'int64', 'uint', 'uint8', 'uint16', 'uint32', 'uint64']
    for npi in NP_INTS:
        if hasattr(np, npi):
