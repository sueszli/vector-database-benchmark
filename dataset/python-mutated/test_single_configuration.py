...
if __name__ == '__main__':
    args = parse_args()
    metrics_actor = ray.get_actor(args.metrics_actor_name, args.metrics_actor_namespace)
    sys.exit(main(metrics_actor, args.test_name, args.num_runs, args.num_tasks_or_actors_per_run, args.num_cpus_in_cluster, args.num_gpus_in_cluster, args.library_to_import, args.with_actors, args.with_gpu, args.with_runtime_env))