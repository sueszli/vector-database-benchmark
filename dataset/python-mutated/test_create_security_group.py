...
class MockManager:
    ...
    def __init__(self, stub_runner, scenario_data, input_mocker):
        ...
        self.group = {'id': 'test-group-id', 'group_name': 'test_group_name', 'ip_permissions': []}
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_create_security_group', 0), ('TESTERROR-stub_authorize_security_group_ingress', 2), ('TESTERROR-stub_describe_security_groups', 3)])
def test_create_security_group_error(mock_mgr, caplog, error, stop_on_index):
    if False:
        while True:
            i = 10
