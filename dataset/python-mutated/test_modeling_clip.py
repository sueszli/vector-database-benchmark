...
if is_torch_available():
    ...
    from transformers import CLIPModel, CLIPTextModel, CLIPTextModelWithProjection, CLIPVisionModel, CLIPVisionModelWithProjection
...
class CLIPModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference(self):
        ...
        image = prepare_img()
        inputs = processor(text=['a photo of a cat', 'a photo of a dog'], images=image, padding=True, return_tensors='pt').to(torch_device)
        with torch.no_grad():
