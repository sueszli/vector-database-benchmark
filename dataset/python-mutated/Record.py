...
class Record:
    ...
    INTERNAL_FORMAT = ' ' * GB_INTERNAL_INDENT + '%-' + str(GB_BASE_INDENT - GB_INTERNAL_INDENT) + 's'
    OTHER_INTERNAL_FORMAT = ' ' * GB_OTHER_INTERNAL_INDENT + '%-' + str(GB_BASE_INDENT - GB_OTHER_INTERNAL_INDENT) + 's'
    BASE_FEATURE_FORMAT = '%-' + str(GB_FEATURE_INDENT) + 's'
    INTERNAL_FEATURE_FORMAT = ' ' * GB_FEATURE_INTERNAL_INDENT + '%-' + str(GB_FEATURE_INDENT - GB_FEATURE_INTERNAL_INDENT) + 's'
