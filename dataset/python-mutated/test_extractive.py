...
example_documents = [[Document(content='Angela Merkel was the chancellor of Germany.'), Document(content='Olaf Scholz is the chancellor of Germany'), Document(content='Jerry is the head of the department.')]] * 2
