...
class Exploit(HTTPClient):
    __info__ = {'name': 'Zyxel P660HN-T v2 RCE', 'description': 'Module exploits Remote Command Execution vulnerability in Zyxel P660HN-T V2 devices. If the target is vulnerable it allows to execute commands on operating system level.', 'authors': ('Pedro Ribeiro <pedrib[at]gmail.com>', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('http://seclists.org/fulldisclosure/2017/Jan/40', 'https://raw.githubusercontent.com/pedrib/PoC/master/advisories/zyxel_trueonline.txt', 'https://blogs.securiteam.com/index.php/archives/2910'), 'devices': ('Zyxel P660HN-T v2',)}
