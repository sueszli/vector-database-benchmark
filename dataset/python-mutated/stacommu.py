...
class StacommuBaseIE(WrestleUniverseBaseIE):
    ...
    _LOGIN_HEADERS = {'Accept': '*/*', 'Content-Type': 'application/json', 'X-Client-Version': 'Chrome/JsCore/9.9.4/FirebaseCore-web', 'Referer': 'https://www.stacommu.jp/', 'Origin': 'https://www.stacommu.jp'}
...
class TheaterComplexTownBaseIE(StacommuBaseIE):
    ...
    _LOGIN_HEADERS = {'Accept': '*/*', 'Content-Type': 'application/json', 'X-Client-Version': 'Chrome/JsCore/9.23.0/FirebaseCore-web', 'Referer': 'https://www.theater-complex.town/', 'Origin': 'https://www.theater-complex.town'}
...
class TheaterComplexTownVODIE(TheaterComplexTownBaseIE):
    ...
    _TESTS = [{'url': 'https://www.theater-complex.town/videos/episodes/hoxqidYNoAn7bP92DN6p78', 'info_dict': {'id': 'hoxqidYNoAn7bP92DN6p78', 'ext': 'mp4', 'title': '演劇ドラフトグランプリ2023\u3000劇団『恋のぼり』〜劇団名決定秘話ラジオ', 'description': 'md5:a7e2e9cf570379ea67fb630f345ff65d', 'cast': ['玉城 裕規', '石川 凌雅'], 'thumbnail': 'https://image.theater-complex.town/5URnXX6KCeDysuFrPkP38o/5URnXX6KCeDysuFrPkP38o', 'upload_date': '20231103', 'timestamp': 1699016400, 'duration': 868}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.theater-complex.town/en/videos/episodes/6QT7XYwM9dJz5Gf9VB6K5y', 'only_matching': True}]
    _API_PATH = 'videoEpisodes'
...
class TheaterComplexTownPPVIE(TheaterComplexTownBaseIE):
    ...
    _TESTS = [{'url': 'https://www.theater-complex.town/ppv/wytW3X7khrjJBUpKuV3jen', 'info_dict': {'id': 'wytW3X7khrjJBUpKuV3jen', 'ext': 'mp4', 'title': 'BREAK FREE STARS\u300011月5日（日）12:30千秋楽公演', 'thumbnail': 'https://image.theater-complex.town/5GWEB31JcTUfjtgdeV5t6o/5GWEB31JcTUfjtgdeV5t6o', 'upload_date': '20231105', 'timestamp': 1699155000, 'duration': 8378}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.theater-complex.town/en/ppv/wytW3X7khrjJBUpKuV3jen', 'only_matching': True}]
    _API_PATH = 'events'
