...
class FieldPanel(Panel):
    ...
    class BoundPanel(Panel.BoundPanel):
        ...
        default_field_icons = {'DateField': 'date', 'TimeField': 'time', 'DateTimeField': 'date', 'URLField': 'link-external', 'TaggableManager': 'tag', 'EmailField': 'mail', 'TextField': 'pilcrow', 'RichTextField': 'pilcrow', 'FloatField': 'decimal', 'DecimalField': 'decimal', 'BooleanField': 'tick-inverse'}
