...
class DeezerPlaylistIE(DeezerBaseInfoExtractor):
    ...
    _TEST = {'url': 'http://www.deezer.com/playlist/176747451', 'info_dict': {'id': '176747451', 'title': 'Best!', 'uploader': 'anonymous', 'thumbnail': 're:^https?://(e-)?cdns-images\\.dzcdn\\.net/images/cover/.*\\.jpg$'}, 'playlist_count': 29}
...
class DeezerAlbumIE(DeezerBaseInfoExtractor):
    ...
    _TEST = {'url': 'https://www.deezer.com/fr/album/67505622', 'info_dict': {'id': '67505622', 'title': 'Last Week', 'uploader': 'Home Brew', 'thumbnail': 're:^https?://(e-)?cdns-images\\.dzcdn\\.net/images/cover/.*\\.jpg$'}, 'playlist_count': 7}
