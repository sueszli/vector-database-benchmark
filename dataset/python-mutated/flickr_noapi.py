...
about = {'website': 'https://www.flickr.com', 'wikidata_id': 'Q103204', 'official_api_documentation': 'https://secure.flickr.com/services/api/flickr.photos.search.html', 'use_official_api': False, 'require_api_key': False, 'results': 'HTML'}
categories = ['images']
paging = True
time_range_support = True
safesearch = False
time_range_dict = {'day': 60 * 60 * 24, 'week': 60 * 60 * 24 * 7, 'month': 60 * 60 * 24 * 7 * 4, 'year': 60 * 60 * 24 * 7 * 52}
...
modelexport_re = re.compile('^\\s*modelExport:\\s*({.*}),$', re.M)
