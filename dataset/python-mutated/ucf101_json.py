...
if __name__ == '__main__':
    ...
    parser.add_argument('dir_path', default=None, type=Path, help='Directory path including classInd.txt, trainlist0-.txt, testlist0-.txt')
    ...
    parser.add_argument('dst_path', default=None, type=Path, help='Directory path of dst json file.')
    ...
    for split_index in range(1, 4):
        ...
        convert_ucf101_csv_to_json(label_csv_path, train_csv_path, val_csv_path, args.video_path, dst_json_path)