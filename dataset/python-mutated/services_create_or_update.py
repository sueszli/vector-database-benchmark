...
def main():
    ...
    response = client.services.begin_create_or_update(group_name='DmsSdkRg', service_name='DmsSdkService', parameters={'location': 'southcentralus', 'properties': {'virtualSubnetId': '/subscriptions/fc04246f-04c5-437e-ac5e-206a19e7193f/resourceGroups/DmsSdkTestNetwork/providers/Microsoft.Network/virtualNetworks/DmsSdkTestNetwork/subnets/default'}, 'sku': {'name': 'Basic_1vCore'}}).result()
    print(response)
