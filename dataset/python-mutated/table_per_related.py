...
session.add_all([Customer(name='customer 1', addresses=[Customer.Address(street='123 anywhere street', city='New York', zip='10110'), Customer.Address(street='40 main street', city='San Francisco', zip='95732')]), Supplier(company_name='Ace Hammers', addresses=[Supplier.Address(street='2569 west elm', city='Detroit', zip='56785')])])
session.commit()
