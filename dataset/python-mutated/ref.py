...
class InstanceRef(NamedTuple('_InstanceRef', [('local_artifact_storage_data', ConfigurableClassData), ('compute_logs_data', ConfigurableClassData), ('scheduler_data', Optional[ConfigurableClassData]), ('run_coordinator_data', Optional[ConfigurableClassData]), ('run_launcher_data', Optional[ConfigurableClassData]), ('settings', Mapping[str, object]), ('run_storage_data', Optional[ConfigurableClassData]), ('event_storage_data', Optional[ConfigurableClassData]), ('schedule_storage_data', Optional[ConfigurableClassData]), ('custom_instance_class_data', Optional[ConfigurableClassData]), ('storage_data', Optional[ConfigurableClassData]), ('secrets_loader_data', Optional[ConfigurableClassData])])):
