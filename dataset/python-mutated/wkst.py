...
from impacket.dcerpc.v5.dtypes import NULL, WSTR, ULONG, LPWSTR, LONG, LARGE_INTEGER, WIDESTR, RPC_UNICODE_STRING, LPULONG, LPLONG
...
class WKSTA_INFO_100(NDRSTRUCT):
    structure = (('wki100_platform_id', ULONG), ('wki100_computername', LPWSTR), ('wki100_langroup', LPWSTR), ('wki100_ver_major', ULONG), ('wki100_ver_minor', ULONG))

class LPWKSTA_INFO_100(NDRPOINTER):
    referent = (('Data', WKSTA_INFO_100),)

class WKSTA_INFO_101(NDRSTRUCT):
    structure = (('wki101_platform_id', ULONG), ('wki101_computername', LPWSTR), ('wki101_langroup', LPWSTR), ('wki101_ver_major', ULONG), ('wki101_ver_minor', ULONG), ('wki101_lanroot', LPWSTR))

class LPWKSTA_INFO_101(NDRPOINTER):
    referent = (('Data', WKSTA_INFO_101),)

class WKSTA_INFO_102(NDRSTRUCT):
    structure = (('wki102_platform_id', ULONG), ('wki102_computername', LPWSTR), ('wki102_langroup', LPWSTR), ('wki102_ver_major', ULONG), ('wki102_ver_minor', ULONG), ('wki102_lanroot', LPWSTR), ('wki102_logged_on_users', ULONG))
...
class WKSTA_INFO(NDRUNION):
    commonHdr = (('tag', ULONG),)
    union = {100: ('WkstaInfo100', LPWKSTA_INFO_100), 101: ('WkstaInfo101', LPWKSTA_INFO_101), 102: ('WkstaInfo102', LPWKSTA_INFO_102), 502: ('WkstaInfo502', LPWKSTA_INFO_502), 1013: ('WkstaInfo1013', LPWKSTA_INFO_1013), 1018: ('WkstaInfo1018', LPWKSTA_INFO_1018), 1046: ('WkstaInfo1046', LPWKSTA_INFO_1046)}

class LPWKSTA_INFO(NDRPOINTER):
    referent = (('Data', WKSTA_INFO),)

class WKSTA_TRANSPORT_INFO_0(NDRSTRUCT):
    structure = (('wkti0_quality_of_service', ULONG), ('wkti0_number_of_vcs', ULONG), ('wkti0_transport_name', LPWSTR), ('wkti0_transport_address', LPWSTR), ('wkti0_wan_ish', ULONG))

class WKSTA_USER_INFO_0(NDRSTRUCT):
    structure = (('wkui0_username', LPWSTR),)

class WKSTA_USER_INFO_1(NDRSTRUCT):
    structure = (('wkui1_username', LPWSTR), ('wkui1_logon_domain', LPWSTR), ('wkui1_oth_domains', LPWSTR), ('wkui1_logon_server', LPWSTR))
...
class WKSTA_USER_INFO_0_CONTAINER(NDRSTRUCT):
    structure = (('EntriesRead', ULONG), ('Buffer', LPWKSTA_USER_INFO_0_ARRAY))
...
class WKSTA_USER_INFO_1_CONTAINER(NDRSTRUCT):
    structure = (('EntriesRead', ULONG), ('Buffer', LPWKSTA_USER_INFO_1_ARRAY))
...
class WKSTA_USER_ENUM_UNION(NDRUNION):
    commonHdr = (('tag', ULONG),)
    union = {0: ('Level0', LPWKSTA_USER_INFO_0_CONTAINER), 1: ('Level1', LPWKSTA_USER_INFO_1_CONTAINER)}

class WKSTA_USER_ENUM_STRUCT(NDRSTRUCT):
    structure = (('Level', ULONG), ('WkstaUserInfo', WKSTA_USER_ENUM_UNION))
...
class WKSTA_TRANSPORT_INFO_0_CONTAINER(NDRSTRUCT):
    structure = (('EntriesRead', ULONG), ('Buffer', LPWKSTA_TRANSPORT_INFO_0_ARRAY))
...
class WKSTA_TRANSPORT_ENUM_UNION(NDRUNION):
    commonHdr = (('tag', ULONG),)
    union = {0: ('Level0', LPWKSTA_TRANSPORT_INFO_0_CONTAINER)}

class WKSTA_TRANSPORT_ENUM_STRUCT(NDRSTRUCT):
    structure = (('Level', ULONG), ('WkstaTransportInfo', WKSTA_TRANSPORT_ENUM_UNION))
...
class JOINPR_USER_PASSWORD(NDRSTRUCT):
    structure = (('Obfuscator', CHAR_ARRAY), ('Buffer', WCHAR_ARRAY))
...
class NET_COMPUTER_NAME_ARRAY(NDRSTRUCT):
    structure = (('EntriesRead', ULONG), ('ComputerNames', PUNICODE_STRING_ARRAY))

class PNET_COMPUTER_NAME_ARRAY(NDRPOINTER):
    referent = (('Data', NET_COMPUTER_NAME_ARRAY),)

class USE_INFO_0(NDRSTRUCT):
    structure = (('ui0_local', LPWSTR), ('ui0_remote', LPWSTR))

class LPUSE_INFO_0(NDRPOINTER):
    referent = (('Data', USE_INFO_0),)

class USE_INFO_1(NDRSTRUCT):
    structure = (('ui1_local', LPWSTR), ('ui1_remote', LPWSTR), ('ui1_password', LPWSTR), ('ui1_status', ULONG), ('ui1_asg_type', ULONG), ('ui1_refcount', ULONG), ('ui1_usecount', ULONG))

class LPUSE_INFO_1(NDRPOINTER):
    referent = (('Data', USE_INFO_1),)

class USE_INFO_2(NDRSTRUCT):
    structure = (('ui2_useinfo', USE_INFO_1), ('ui2_username', LPWSTR), ('ui2_domainname', LPWSTR))

class LPUSE_INFO_2(NDRPOINTER):
    referent = (('Data', USE_INFO_2),)

class USE_INFO_3(NDRSTRUCT):
    structure = (('ui3_ui2', USE_INFO_2), ('ui3_flags', ULONG))
...
class USE_ENUM_UNION(NDRUNION):
    commonHdr = (('tag', ULONG),)
    union = {0: ('Level0', LPUSE_INFO_0_CONTAINER), 1: ('Level1', LPUSE_INFO_1_CONTAINER), 2: ('Level2', LPUSE_INFO_2_CONTAINER)}

class USE_ENUM_STRUCT(NDRSTRUCT):
    structure = (('Level', ULONG), ('UseInfo', USE_ENUM_UNION))

class NetrWkstaGetInfo(NDRCALL):
    opnum = 0
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('Level', ULONG))

class NetrWkstaGetInfoResponse(NDRCALL):
    structure = (('WkstaInfo', WKSTA_INFO), ('ErrorCode', ULONG))

class NetrWkstaSetInfo(NDRCALL):
    opnum = 1
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('Level', ULONG), ('WkstaInfo', WKSTA_INFO), ('ErrorParameter', LPULONG))

class NetrWkstaSetInfoResponse(NDRCALL):
    structure = (('ErrorParameter', LPULONG), ('ErrorCode', ULONG))

class NetrWkstaUserEnum(NDRCALL):
    opnum = 2
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('UserInfo', WKSTA_USER_ENUM_STRUCT), ('PreferredMaximumLength', ULONG), ('ResumeHandle', LPULONG))

class NetrWkstaUserEnumResponse(NDRCALL):
    structure = (('UserInfo', WKSTA_USER_ENUM_STRUCT), ('TotalEntries', ULONG), ('ResumeHandle', ULONG), ('ErrorCode', ULONG))

class NetrWkstaTransportEnum(NDRCALL):
    opnum = 5
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('TransportInfo', WKSTA_TRANSPORT_ENUM_STRUCT), ('PreferredMaximumLength', ULONG), ('ResumeHandle', LPULONG))

class NetrWkstaTransportEnumResponse(NDRCALL):
    structure = (('TransportInfo', WKSTA_TRANSPORT_ENUM_STRUCT), ('TotalEntries', ULONG), ('ResumeHandle', ULONG), ('ErrorCode', ULONG))

class NetrWkstaTransportAdd(NDRCALL):
    opnum = 6
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('Level', ULONG), ('TransportInfo', WKSTA_TRANSPORT_INFO_0), ('ErrorParameter', LPULONG))
...
class NetrUseAdd(NDRCALL):
    opnum = 8
    structure = (('ServerName', LPWKSSVC_IMPERSONATE_HANDLE), ('Level', ULONG), ('InfoStruct', USE_INFO), ('ErrorParameter', LPULONG))
...
class NetrUseGetInfo(NDRCALL):
    opnum = 9
    structure = (('ServerName', LPWKSSVC_IMPERSONATE_HANDLE), ('UseName', WSTR), ('Level', ULONG))

class NetrUseGetInfoResponse(NDRCALL):
    structure = (('InfoStruct', USE_INFO), ('ErrorCode', ULONG))

class NetrUseDel(NDRCALL):
    opnum = 10
    structure = (('ServerName', LPWKSSVC_IMPERSONATE_HANDLE), ('UseName', WSTR), ('ForceLevel', ULONG))
...
class NetrUseEnum(NDRCALL):
    opnum = 11
    structure = (('ServerName', LPWKSSVC_IMPERSONATE_HANDLE), ('InfoStruct', USE_ENUM_STRUCT), ('PreferredMaximumLength', ULONG), ('ResumeHandle', LPULONG))

class NetrUseEnumResponse(NDRCALL):
    structure = (('InfoStruct', USE_ENUM_STRUCT), ('TotalEntries', ULONG), ('ResumeHandle', LPULONG), ('ErrorCode', ULONG))

class NetrWorkstationStatisticsGet(NDRCALL):
    opnum = 13
    structure = (('ServerName', LPWKSSVC_IDENTIFY_HANDLE), ('ServiceName', LPWSTR), ('Level', ULONG), ('Options', ULONG))

class NetrWorkstationStatisticsGetResponse(NDRCALL):
    structure = (('Buffer', LPSTAT_WORKSTATION_0), ('ErrorCode', ULONG))

class NetrGetJoinInformation(NDRCALL):
    opnum = 20
    structure = (('ServerName', LPWKSSVC_IMPERSONATE_HANDLE), ('NameBuffer', LPWSTR))

class NetrGetJoinInformationResponse(NDRCALL):
    structure = (('NameBuffer', LPWSTR), ('BufferType', NETSETUP_JOIN_STATUS), ('ErrorCode', ULONG))

class NetrJoinDomain2(NDRCALL):
    opnum = 22
    structure = (('ServerName', LPWSTR), ('DomainNameParam', WSTR), ('MachineAccountOU', LPWSTR), ('AccountName', LPWSTR), ('Password', PJOINPR_ENCRYPTED_USER_PASSWORD), ('Options', ULONG))
...
class NetrUnjoinDomain2(NDRCALL):
    opnum = 23
    structure = (('ServerName', LPWSTR), ('AccountName', LPWSTR), ('Password', PJOINPR_ENCRYPTED_USER_PASSWORD), ('Options', ULONG))
...
class NetrRenameMachineInDomain2(NDRCALL):
    opnum = 24
    structure = (('ServerName', LPWSTR), ('MachineName', LPWSTR), ('AccountName', LPWSTR), ('Password', PJOINPR_ENCRYPTED_USER_PASSWORD), ('Options', ULONG))
...
class NetrValidateName2(NDRCALL):
    opnum = 25
    structure = (('ServerName', LPWSTR), ('NameToValidate', WSTR), ('AccountName', LPWSTR), ('Password', PJOINPR_ENCRYPTED_USER_PASSWORD), ('NameType', NETSETUP_NAME_TYPE))
...
class NetrGetJoinableOUs2(NDRCALL):
    opnum = 26
    structure = (('ServerName', LPWSTR), ('DomainNameParam', WSTR), ('AccountName', LPWSTR), ('Password', PJOINPR_ENCRYPTED_USER_PASSWORD), ('OUCount', ULONG))

class NetrGetJoinableOUs2Response(NDRCALL):
    structure = (('OUCount', LPLONG), ('OUs', PUNICODE_STRING_ARRAY), ('ErrorCode', ULONG))

class NetrAddAlternateComputerName(NDRCALL):
    opnum = 27
    structure = (('ServerName', LPWSTR), ('AlternateName', LPWSTR), ('DomainAccount', LPWSTR), ('EncryptedPassword', PJOINPR_ENCRYPTED_USER_PASSWORD), ('Reserved', ULONG))
...
class NetrSetPrimaryComputerName(NDRCALL):
    opnum = 29
    structure = (('ServerName', LPWSTR), ('PrimaryName', LPWSTR), ('DomainAccount', LPWSTR), ('EncryptedPassword', PJOINPR_ENCRYPTED_USER_PASSWORD), ('Reserved', ULONG))
