...
SCHEMA_FOR_QUESTION_ID = {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}
...
class QuestionSkillLinkHandler(base.BaseHandler[QuestionSkillLinkHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    HANDLER_ARGS_SCHEMAS = {'PUT': {'skill_ids_task_list': {'schema': {'type': 'list', 'items': {'type': 'dict', 'properties': [{'name': 'id', 'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}, {'name': 'task', 'schema': {'type': 'unicode', 'choices': ['remove', 'add', 'update_difficulty']}}, {'name': 'difficulty', 'schema': {'type': 'float', 'validators': [{'id': 'is_at_least', 'min_value': 0}, {'id': 'is_at_most', 'max_value': 1}]}}]}}}}}
...
class EditableQuestionDataHandler(base.BaseHandler[EditableQuestionDataHandlerNormalizedPayloadDict, Dict[str, str]]):
    """A data handler for questions which supports writing."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'question_id': {'schema': SCHEMA_FOR_QUESTION_ID}}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'PUT': {'version': {'schema': {'type': 'int'}}, 'commit_message': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_COMMIT_MESSAGE_LENGTH}]}}, 'change_list': {'schema': {'type': 'list', 'items': {'type': 'object_dict', 'object_class': question_domain.QuestionChange}}}}, 'DELETE': {}}
