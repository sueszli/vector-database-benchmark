...
if is_torch_available():
    import torch
    from transformers import MarkupLMForQuestionAnswering, MarkupLMForSequenceClassification, MarkupLMForTokenClassification, MarkupLMModel
...
class MarkupLMModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (MarkupLMModel, MarkupLMForSequenceClassification, MarkupLMForTokenClassification, MarkupLMForQuestionAnswering) if is_torch_available() else None
    pipeline_model_mapping = {'feature-extraction': MarkupLMModel, 'question-answering': MarkupLMForQuestionAnswering, 'text-classification': MarkupLMForSequenceClassification, 'token-classification': MarkupLMForTokenClassification, 'zero-shot': MarkupLMForSequenceClassification} if is_torch_available() else {}
