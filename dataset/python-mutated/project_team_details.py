...
class ProjectTeamsPermission(ProjectPermission):
    scope_map = {'POST': ['project:write', 'project:admin'], 'DELETE': ['project:write', 'project:admin']}

@extend_schema(tags=['Projects'])
@region_silo_endpoint
class ProjectTeamDetailsEndpoint(ProjectEndpoint):
    publish_status = {'DELETE': ApiPublishStatus.PUBLIC, 'POST': ApiPublishStatus.PUBLIC}
