...
cache = '_pr_cache.txt'
releases = OrderedDict([('0.4', '2011-12-03 14:31:32 -0800'), ('0.5', '2012-02-26 21:00:51 -0800'), ('0.6', '2012-06-24 21:37:05 -0700'), ('0.7', '2012-09-29 18:08:49 -0700'), ('0.8', '2013-03-04 20:46:09 +0100')])
month_duration = 24
...
for (version, date) in releases.items():
    ...
    ax.text(date, 1, version, color='r', va='bottom', ha='center', transform=mixed_transform)
