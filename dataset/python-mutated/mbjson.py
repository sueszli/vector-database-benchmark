...
from picard.const import ALIAS_TYPE_ARTIST_NAME_ID, ALIAS_TYPE_LEGAL_NAME_ID, RELEASE_FORMATS
from picard.util import format_time, linear_combination_of_weights, parse_amazon_url, translate_from_sortname
from picard.util.script_detector_weighted import detect_script_weighted
_ARTIST_REL_TYPES = {'arranger': 'arranger', 'audio': 'engineer', 'chorus master': 'performer:chorus master', 'composer': 'composer', 'concertmaster': 'performer:concertmaster', 'conductor': 'conductor', 'engineer': 'engineer', 'instrument arranger': 'arranger', 'librettist': 'lyricist', 'live sound': 'engineer', 'lyricist': 'lyricist', 'mix-DJ': 'djmixer', 'mix': 'mixer', 'orchestrator': 'arranger', 'performing orchestra': 'performer:orchestra', 'producer': 'producer', 'remixer': 'remixer', 'sound': 'engineer', 'audio director': 'director', 'video director': 'director', 'vocal arranger': 'arranger', 'writer': 'writer'}
_TRACK_TO_METADATA = {'number': '~musicbrainz_tracknumber', 'position': 'tracknumber', 'title': 'title'}
_MEDIUM_TO_METADATA = {'format': 'media', 'position': 'discnumber', 'title': 'discsubtitle'}
_RECORDING_TO_METADATA = {'disambiguation': '~recordingcomment', 'first-release-date': '~recording_firstreleasedate', 'title': 'title'}
_RELEASE_TO_METADATA = {'annotation': '~releaseannotation', 'asin': 'asin', 'barcode': 'barcode', 'country': 'releasecountry', 'date': 'date', 'disambiguation': '~releasecomment', 'title': 'album'}
_ARTIST_TO_METADATA = {'gender': 'gender', 'name': 'name', 'type': 'type'}
_RELEASE_GROUP_TO_METADATA = {'disambiguation': '~releasegroupcomment', 'first-release-date': '~releasegroup_firstreleasedate', 'title': '~releasegroup'}
...
class RelFunc(SimpleNamespace):
    ...
    func = None
_RELATIONS_TO_METADATA_TARGET_TYPE_FUNC = {'artist': RelFunc(func=_relations_to_metadata_target_type_artist), 'series': RelFunc(func=_relations_to_metadata_target_type_series, clear_metadata_first=True), 'url': RelFunc(func=_relations_to_metadata_target_type_url), 'work': RelFunc(func=_relations_to_metadata_target_type_work)}
