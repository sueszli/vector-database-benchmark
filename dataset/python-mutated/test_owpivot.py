...
from Orange.data import Table, Domain, ContinuousVariable as Cv, StringVariable as sv, DiscreteVariable as Dv, TimeVariable as Tv
...
_MockCount = Function(Pivot.Count.value, 'Count', Mock(side_effect=Pivot.Count.func))
_MockSum = Function(Pivot.Sum.value, 'Sum', Mock(side_effect=Pivot.Sum.func))
