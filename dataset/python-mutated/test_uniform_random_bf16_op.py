...
class TestUniformRandomOpBF16AttrTensorInt32(TestUniformRandomOpBF16AttrTensorList):
...
class TestUniformRandomOpBF16SelectedRowsWithDiagInit(TestUniformRandomOpBF16SelectedRows):
...
class TestUniformRandomOpBF16SelectedRowsShapeTensorList(TestUniformRandomOpBF16SelectedRowsShapeTensor):
