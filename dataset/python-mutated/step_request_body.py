...
class StepRequestBody(BaseModel):
    ...
    additional_input: Optional[Any] = Field(None, description='Input parameters for the task step. Any value is allowed.')
    ...
    def from_dict(cls, obj: dict) -> StepRequestBody:
        ...
        _obj = StepRequestBody.parse_obj({'input': obj.get('input'), 'additional_input': obj.get('additional_input')})
        return _obj