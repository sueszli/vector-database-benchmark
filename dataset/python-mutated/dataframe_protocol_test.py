...
xfail_memory_bug = pytest.mark.xfail(reason='Erroneous due to bug where memory is released prematurely - see https://github.com/vaexio/vaex/pull/2150#issuecomment-1263336551')
