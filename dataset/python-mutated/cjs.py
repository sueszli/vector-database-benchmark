...
if __name__ == '__main__':
    ...
    parser.add_argument('--tmc', action='store_true', help="Use Tensor Monte Carlo instead of exact enumeration to estimate the marginal likelihood. You probably don't want to do this, except to see that TMC makes Monte Carlo gradient estimation feasible even with very large numbers of non-reparametrized variables.")
