...
class CVXOPT(ConicSolver):
    ...
    STATUS_MAP = {'optimal': s.OPTIMAL, 'feasible': s.OPTIMAL_INACCURATE, 'infeasible problem': s.INFEASIBLE, 'primal infeasible': s.INFEASIBLE, 'LP relaxation is primal infeasible': s.INFEASIBLE, 'LP relaxation is dual infeasible': s.UNBOUNDED, 'unbounded': s.UNBOUNDED, 'dual infeasible': s.UNBOUNDED, 'unknown': s.SOLVER_ERROR, 'undefined': s.SOLVER_ERROR, 'solver_error': s.SOLVER_ERROR}
