import copy
from torch.testing._internal.common_utils import TestCase, run_tests, parametrize, subtest, instantiate_parametrized_tests, IS_FBCODE, freeze_rng_state, skipIfTorchDynamo, IS_WINDOWS, IS_MACOS, IS_ARM64
import torch
...
import functorch
from functorch import grad, vjp, vmap, jacrev, jacfwd, grad_and_value, hessian, jvp, make_functional, make_functional_with_buffers, combine_state_for_ensemble, make_fx
from torch._functorch.make_functional import functional_init, functional_init_with_buffers
...
class TestCompileTransforms(TestCase):
    ...
    def test_grad_deprecated_api(self, device):
        ...
        self.assertEqual(actual, expected)
only_for = ('cpu', 'cuda')
instantiate_device_type_tests(TestGradTransform, globals(), only_for=only_for)
instantiate_device_type_tests(TestVmapOfGrad, globals(), only_for=only_for)
instantiate_device_type_tests(TestJac, globals(), only_for=only_for)
instantiate_device_type_tests(TestJvp, globals(), only_for=only_for)
instantiate_device_type_tests(TestLinearize, globals(), only_for=only_for)
instantiate_device_type_tests(TestVmapJvpInplaceView, globals(), only_for=only_for)
instantiate_device_type_tests(TestHessian, globals(), only_for=only_for)
instantiate_device_type_tests(TestComposability, globals(), only_for=only_for)
instantiate_device_type_tests(TestExamplesCorrectness, globals(), only_for=only_for)
instantiate_device_type_tests(TestHigherOrderOperatorInteraction, globals(), only_for=only_for)
instantiate_device_type_tests(TestFunctionalize, globals(), only_for=only_for)
instantiate_device_type_tests(TestAutogradFunction, globals(), only_for=only_for)
instantiate_device_type_tests(TestAutogradFunctionVmapAPI, globals(), only_for=only_for)
instantiate_device_type_tests(TestHelpers, globals(), only_for=only_for)
instantiate_parametrized_tests(TestMakeFunctional)
instantiate_device_type_tests(TestCompileTransforms, globals(), only_for=only_for)
