...
class sfp_spamhaus(SpiderFootPlugin):
    meta = {'name': 'Spamhaus Zen', 'summary': 'Check if a netblock or IP address is in the Spamhaus Zen database.', 'flags': [], 'useCases': ['Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'https://www.spamhaus.org/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://www.spamhaus.org/zen/', 'https://www.spamhaus.org/organization/dnsblusage/', 'https://www.spamhaus.org/datafeed/', 'https://www.spamhaus.org/whitepapers/dnsbl_function/', 'https://www.spamhaus.org/faq/section/DNSBL%20Usage'], 'favIcon': 'https://www.spamhaus.org/favicon.ico', 'logo': 'https://www.spamhaus.org/images/sh_logo1.jpg', 'description': "The Spamhaus Project is an international nonprofit organization that tracks spam and related cyber threats such as phishing, malware and botnets, provides realtime actionable and highly accurate threat intelligence to the Internet's major networks, corporations and security vendors, and works with law enforcement agencies to identify and pursue spam and malware sources worldwide. ZEN is the combination of all Spamhaus IP-based DNSBLs into one single powerful and comprehensive blocklist to make querying faster and simpler. It contains the SBL, SBLCSS, XBL and PBL blocklists."}}
    ...
    results = None
    errorState = False
    checks = {'127.0.0.2': 'Spamhaus (Zen) - Spammer', '127.0.0.3': 'Spamhaus (Zen) - Spammer', '127.0.0.4': 'Spamhaus (Zen) - Proxies, Trojans, etc.', '127.0.0.5': 'Spamhaus (Zen) - Proxies, Trojans, etc.', '127.0.0.6': 'Spamhaus (Zen) - Proxies, Trojans, etc.', '127.0.0.7': 'Spamhaus (Zen) - Proxies, Trojans, etc.', '127.0.0.10': 'Spamhaus (Zen) - Potential Spammer', '127.0.0.11': 'Spamhaus (Zen) - Potential Spammer'}
