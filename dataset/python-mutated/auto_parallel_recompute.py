import logging
import paddle
from paddle.base.backward import ProgramStats, _append_grad_suffix_, _find_op_path_, _get_no_grad_set_name, _rename_arg_
from paddle.distributed.fleet.meta_optimizers.common import OP_ROLE_KEY, OpRole
from paddle.framework import core
from paddle.utils import unique_name
from ..auto_parallel.static.dist_attribute import OperatorDistAttr
from ..auto_parallel.static.utils import get_loss_op, insert_dependencies_for_two_ops, is_backward_op, is_recompute_exclude_op, is_recompute_op, naive_set_dist_op_attr_for_program_by_mesh_and_mapping, set_dist_op_desc_original_id, set_var_dist_attr
