...
parser.add_argument('--tests-passed', help='If --tests-passed is true, then the original issue is closed if the issue exists. If tests-passed is false, then the an issue is updated or created.')
parser.add_argument('--auto-close', help='If --auto-close is false, then issues will not auto close even if the tests pass.', default='true')
