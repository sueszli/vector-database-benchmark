...
class RCSEmbedsIE(RCSBaseIE):
    _VALID_URL = '(?x)\n                    https?://(?P<vid>video)\\.\n                    (?P<cdn>\n                    (?:\n                        rcs|\n                        (?:corriere\\w+\\.)?corriere|\n                        (?:gazzanet\\.)?gazzetta\n                    )\\.it)\n                    /video-embed/(?P<id>[^/=&\\?]+?)(?:$|\\?)'
    _EMBED_REGEX = ['(?x)\n            (?:\n                data-frame-src=|\n                <iframe[^\\n]+src=\n            )\n            (["\'])\n                (?P<url>(?:https?:)?//video\\.\n                    (?:\n                        rcs|\n                        (?:corriere\\w+\\.)?corriere|\n                        (?:gazzanet\\.)?gazzetta\n                    )\n                \\.it/video-embed/.+?)\n            \\1']
    _TESTS = [{'url': 'https://video.rcs.it/video-embed/iodonna-0001585037', 'md5': '0faca97df525032bb9847f690bc3720c', 'info_dict': {'id': 'iodonna-0001585037', 'ext': 'mp4', 'title': 'Sky Arte racconta Madonna nella serie "Artist to icon"', 'description': 'md5:65b09633df9ffee57f48b39e34c9e067', 'uploader': 'rcs.it'}}, {'url': 'https://video.gazzanet.gazzetta.it/video-embed/gazzanet-mo05-0000260789', 'only_matching': True}, {'url': 'https://video.gazzetta.it/video-embed/49612410-00ca-11eb-bcd8-30d4253e0140', 'only_matching': True}]
    _WEBPAGE_TESTS = [{'url': 'https://www.iodonna.it/video-iodonna/personaggi-video/monica-bellucci-piu-del-lavoro-oggi-per-me-sono-importanti-lamicizia-e-la-famiglia/', 'info_dict': {'id': 'iodonna-0002033648', 'ext': 'mp4', 'title': "Monica Bellucci: «Più del lavoro, oggi per me sono importanti l'amicizia e la famiglia»", 'description': 'md5:daea6d9837351e56b1ab615c06bebac1', 'uploader': 'rcs.it'}}]
