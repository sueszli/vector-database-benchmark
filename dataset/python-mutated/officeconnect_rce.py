...
class Exploit(HTTPClient):
    __info__ = {'name': '3Com OfficeConnect RCE', 'description': 'Module exploits 3Com OfficeConnect remote command execution vulnerability which allows executing command on operating system level.', 'authors': ('Andrea Fabizi', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/9862/',), 'devices': ('3Com OfficeConnect',)}
