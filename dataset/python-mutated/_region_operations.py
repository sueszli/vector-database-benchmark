...
def build_list_by_service_request(resource_group_name: str, service_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/regions')
...
class RegionOperations:
    ...
    @distributed_trace
    def list_by_service(self, resource_group_name: str, service_name: str, **kwargs: Any) -> Iterable['_models.RegionContract']:
        if False:
            for i in range(10):
                print('nop')
        'Lists all azure regions in which the service exists.\n\n        :param resource_group_name: The name of the resource group. The name is case insensitive.\n         Required.\n        :type resource_group_name: str\n        :param service_name: The name of the API Management service. Required.\n        :type service_name: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: An iterator like instance of either RegionContract or the result of cls(response)\n        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.RegionContract]\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
