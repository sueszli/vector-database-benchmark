...
from strawberry.codegen.types import GraphQLBoolValue, GraphQLEnumValue, GraphQLField, GraphQLFieldSelection, GraphQLFragmentSpread, GraphQLFragmentType, GraphQLInlineFragment, GraphQLIntValue, GraphQLList, GraphQLListValue, GraphQLObjectType, GraphQLObjectValue, GraphQLOptional, GraphQLStringValue, GraphQLVariableReference
if TYPE_CHECKING:
    from strawberry.codegen.types import GraphQLArgument, GraphQLArgumentValue, GraphQLDirective, GraphQLOperation, GraphQLSelection, GraphQLType
