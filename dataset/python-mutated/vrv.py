...
from ..utils import ExtractorError, float_or_none, int_or_none, join_nonempty, traverse_obj
...
class VRVIE(VRVBaseIE):
    ...
    _TESTS = [{'url': 'https://vrv.co/watch/GR9PNZ396/Hidden-America-with-Jonah-Ray:BOSTON-WHERE-THE-PAST-IS-THE-PRESENT', 'info_dict': {'id': 'GR9PNZ396', 'ext': 'mp4', 'title': 'BOSTON: WHERE THE PAST IS THE PRESENT', 'description': 'md5:4ec8844ac262ca2df9e67c0983c6b83f', 'uploader_id': 'seeso'}, 'params': {'skip_download': True}}, {'url': 'https://vrv.co/watch/G6NQXZ1J6/Lily-CAT', 'info_dict': {'id': 'G6NQXZ1J6', 'title': 'Lily C.A.T', 'description': 'md5:988b031e7809a6aeb60968be4af7db07'}, 'playlist_count': 2}]
    _NETRC_MACHINE = 'vrv'
...
class VRVSeriesIE(VRVBaseIE):
    ...
    _TEST = {'url': 'https://vrv.co/series/G68VXG3G6/The-Perfect-Insider', 'info_dict': {'id': 'G68VXG3G6'}, 'playlist_mincount': 11}
