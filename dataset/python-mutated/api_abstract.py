...
common_rules = (verify_that('price', pre_check=True).deprecated('please use price_or_style instead.').is_greater_than(0), verify_that('style', pre_check=True).deprecated('please use price_or_style instead.').is_instance_of((*ALL_ORDER_STYPES, type(None))), verify_that('price_or_style', pre_check=True).is_instance_of((int, float, type(None), tuple, *ALL_ORDER_STYPES)))
PRICE_OR_STYLE_TYPE = Union[int, float, OrderStyle, None]
TUPLE_PRICE_OR_STYLE_TYPE = Union[float, OrderStyle, None, Tuple, Tuple[PRICE_OR_STYLE_TYPE], Tuple[PRICE_OR_STYLE_TYPE, PRICE_OR_STYLE_TYPE]]
...
@apply_rules(verify_that('amount').is_number(), *common_rules)
...
@export_as_api
@ExecutionContext.enforce_phase(EXECUTION_PHASE.OPEN_AUCTION, EXECUTION_PHASE.ON_BAR, EXECUTION_PHASE.ON_TICK, EXECUTION_PHASE.SCHEDULED, EXECUTION_PHASE.GLOBAL)
@apply_rules(verify_that('cash_amount').is_number(), *common_rules)
@instype_singledispatch
...
@export_as_api
@ExecutionContext.enforce_phase(EXECUTION_PHASE.OPEN_AUCTION, EXECUTION_PHASE.ON_BAR, EXECUTION_PHASE.ON_TICK, EXECUTION_PHASE.SCHEDULED, EXECUTION_PHASE.GLOBAL)
@apply_rules(verify_that('percent', pre_check=True).is_number().is_greater_or_equal_than(-1).is_less_or_equal_than(1), *common_rules)
@instype_singledispatch
...
@export_as_api
@ExecutionContext.enforce_phase(EXECUTION_PHASE.OPEN_AUCTION, EXECUTION_PHASE.ON_BAR, EXECUTION_PHASE.ON_TICK, EXECUTION_PHASE.SCHEDULED, EXECUTION_PHASE.GLOBAL)
@apply_rules(verify_that('percent', pre_check=True).is_number().is_greater_or_equal_than(0).is_less_or_equal_than(1), *common_rules)
@instype_singledispatch
...
@export_as_api
@ExecutionContext.enforce_phase(EXECUTION_PHASE.OPEN_AUCTION, EXECUTION_PHASE.ON_BAR, EXECUTION_PHASE.ON_TICK, EXECUTION_PHASE.SCHEDULED, EXECUTION_PHASE.GLOBAL)
@apply_rules(verify_that('amount', pre_check=True).is_number().is_greater_or_equal_than(0), *common_rules)
@instype_singledispatch
...
@export_as_api
@ExecutionContext.enforce_phase(EXECUTION_PHASE.ON_BAR, EXECUTION_PHASE.ON_TICK, EXECUTION_PHASE.SCHEDULED, EXECUTION_PHASE.GLOBAL)
