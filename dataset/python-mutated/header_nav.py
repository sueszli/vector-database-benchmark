...
async def init(q: Q) -> None:
    q.page['meta'] = ui.meta_card(box='', layouts=[ui.layout(breakpoint='xs', min_height='100vh', zones=[ui.zone('header'), ui.zone('content', zones=[ui.zone('horizontal', direction=ui.ZoneDirection.ROW), ui.zone('vertical'), ui.zone('grid', direction=ui.ZoneDirection.ROW, wrap='stretch', justify='center')])])])
    q.page['header'] = ui.header_card(box='header', title='My app', subtitle="Let's conquer the world", image='https://wave.h2o.ai/img/h2o-logo.svg', secondary_items=[ui.tabs(name='tabs', value=f"#{q.args['#']}" if q.args['#'] else '#page1', link=True, items=[ui.tab(name='#page1', label='Home'), ui.tab(name='#page2', label='Charts'), ui.tab(name='#page3', label='Grid'), ui.tab(name='#page4', label='Form')])], items=[ui.persona(title='John Doe', subtitle='Developer', size='xs', image='https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&h=750&w=1260')])
    if q.args['#'] is None:
        await page1(q)
