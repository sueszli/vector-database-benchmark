...
if __name__ == '__main__':
    ...
    (res_ccf.ccf100, res_ccf.lags100, res_ccf.bounds100) = mlab.crosscorr(x100[4:], x100[:-4], [], 2, nout=3)
    (res_ccf.ccf1000, res_ccf.lags1000, res_ccf.bounds1000) = mlab.crosscorr(x1000[4:], x1000[:-4], [], 2, nout=3)
