...
import proto
__protobuf__ = proto.module(package='google.cloud.resourcemanager.v3', manifest={'TagValue', 'ListTagValuesRequest', 'ListTagValuesResponse', 'GetTagValueRequest', 'GetNamespacedTagValueRequest', 'CreateTagValueRequest', 'CreateTagValueMetadata', 'UpdateTagValueRequest', 'UpdateTagValueMetadata', 'DeleteTagValueRequest', 'DeleteTagValueMetadata'})

class TagValue(proto.Message):
    """A TagValue is a child of a particular TagKey. This is used to
...
class ListTagValuesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    tag_values: MutableSequence['TagValue'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TagValue')
...
class GetNamespacedTagValueRequest(proto.Message):
    """The request message for getting a TagValue by its namespaced
    name.
...
class CreateTagValueRequest(proto.Message):
    ...
    """
    tag_value: 'TagValue' = proto.Field(proto.MESSAGE, number=1, message='TagValue')
