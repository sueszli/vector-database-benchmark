...
bash_vtypes_32 = {'_hist_entry': [12, {'line': [0, ['pointer', ['String', dict(length=1024)]]], 'timestamp': [4, ['pointer', ['String', dict(length=1024)]]], 'data': [8, ['pointer', ['void']]]}]}
bash_vtypes_64 = {'_hist_entry': [24, {'line': [0, ['pointer', ['String', dict(length=1024)]]], 'timestamp': [8, ['pointer', ['String', dict(length=1024)]]], 'data': [16, ['pointer', ['void']]]}]}
