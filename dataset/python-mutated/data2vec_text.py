...
class Data2VecTextConfig(FairseqDataclass):
    ...
    load_checkpoint_heads: bool = field(default=False, metadata={'help': '(re-)register and load heads when loading checkpoints'})
    ...
    ema_transformer_layers_only: bool = field(default=True, metadata={'help': 'whether to momentum update only the transformer layers'})
