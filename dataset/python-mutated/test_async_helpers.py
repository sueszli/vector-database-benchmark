...
from synapse.logging.context import SENTINEL_CONTEXT, LoggingContext, PreserveLoggingContext, current_context, make_deferred_yieldable
from synapse.util.async_helpers import AwakenableSleeper, ObservableDeferred, concurrently_execute, delay_cancellation, stop_cancellation, timeout_deferred
...
@parameterized_class(('wrapper',), [('stop_cancellation',), ('delay_cancellation',)])
