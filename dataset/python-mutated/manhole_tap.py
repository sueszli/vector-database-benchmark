...
class Options(usage.Options):
    optParameters = [['telnetPort', 't', None, 'strports description of the address on which to listen for telnet connections'], ['sshPort', 's', None, 'strports description of the address on which to listen for ssh connections'], ['passwd', 'p', '/etc/passwd', 'name of a passwd(5)-format username/password file'], ['sshKeyDir', None, '<USER DATA DIR>', 'Directory where the autogenerated SSH key is kept.'], ['sshKeyName', None, 'server.key', 'Filename of the autogenerated SSH key.'], ['sshKeySize', None, 4096, 'Size of the automatically generated SSH key.']]
