...
class Migration(migrations.Migration):
    dependencies = [('order', '0144_rewrite_fulfillmentline_orderline_relation')]
    operations = [migrations.RunPython(rewrite_order_events_parameters, migrations.RunPython.noop)]