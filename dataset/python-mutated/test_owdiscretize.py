...
from Orange.widgets.data.owdiscretize import OWDiscretize, IncreasingNumbersListValidator, VarHint, Methods, DefaultKey, _fixed_width_discretization, _fixed_time_width_discretization, _custom_discretization, variable_key, Options, DefaultHint, _mdl_discretization, ListViewSearch, format_desc, DefaultDiscModel, DiscDomainModel, DiscDesc
