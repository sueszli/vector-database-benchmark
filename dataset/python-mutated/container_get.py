...
def main():
    ...
    response = client.containers.get(device_name='testedgedevice', storage_account_name='storageaccount1', container_name='blobcontainer1', resource_group_name='GroupForEdgeAutomation')
    print(response)
