...
class JableIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://jable.tv/videos/pppd-812/', 'md5': 'f1537283a9bc073c31ff86ca35d9b2a6', 'info_dict': {'id': 'pppd-812', 'ext': 'mp4', 'title': 'PPPD-812 只要表現好巨乳女教師吉根柚莉愛就獎勵學生們在白虎穴內射出精液', 'description': 'md5:5b6d4199a854f62c5e56e26ccad19967', 'thumbnail': 're:^https?://.*\\.jpg$', 'age_limit': 18, 'like_count': int, 'view_count': int}}, {'url': 'https://jable.tv/videos/apak-220/', 'md5': '71f9239d69ced58ab74a816908847cc1', 'info_dict': {'id': 'apak-220', 'ext': 'mp4', 'title': 'md5:5c3861b7cf80112a6e2b70bccf170824', 'description': '', 'thumbnail': 're:^https?://.*\\.jpg$', 'age_limit': 18, 'like_count': int, 'view_count': int, 'upload_date': '20220319'}}]
...
class JablePlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://jable.tv/models/kaede-karen/', 'info_dict': {'id': 'kaede-karen', 'title': '楓カレン'}, 'playlist_count': 34}, {'url': 'https://jable.tv/categories/roleplay/', 'only_matching': True}, {'url': 'https://jable.tv/tags/girl/', 'only_matching': True}]
