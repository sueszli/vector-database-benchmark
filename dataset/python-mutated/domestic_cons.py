...
CLOSE_LOC = 5
PRE_SETTLE_LOC = 11
FUTURE_SYMBOL_PATTERN = re.compile('(^[A-Za-z]{1,2})[0-9]+')
DATE_PATTERN = re.compile('^([0-9]{4})[-/]?([0-9]{2})[-/]?([0-9]{2})')
SIM_HAEDERS = {'User-Agent': 'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)'}
DCE_HEADERS = {'cache-control': 'no-cache', 'postman-token': '153f42ca-148a-8f03-3302-8172cc4a5185'}
