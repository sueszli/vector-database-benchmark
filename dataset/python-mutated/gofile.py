...
class GofileIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://gofile.io/d/AMZyDw', 'info_dict': {'id': 'AMZyDw'}, 'playlist_mincount': 2, 'playlist': [{'info_dict': {'id': 'de571ac1-5edc-42e2-8ec2-bdac83ad4a31', 'filesize': 928116, 'ext': 'mp4', 'title': 'nuuh', 'release_timestamp': 1638338704, 'release_date': '20211201'}}]}, {'url': 'https://gofile.io/d/is8lKr', 'info_dict': {'id': 'TMjXd9', 'ext': 'mp4'}, 'playlist_count': 0, 'skip': 'No video/audio found at provided URL.'}, {'url': 'https://gofile.io/d/TMjXd9', 'info_dict': {'id': 'TMjXd9'}, 'playlist_count': 1}, {'url': 'https://gofile.io/d/gqOtRf', 'info_dict': {'id': 'gqOtRf'}, 'playlist_mincount': 1, 'params': {'videopassword': 'password'}}]
    _TOKEN = None
