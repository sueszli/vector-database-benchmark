...
class Slice(Base):
    ...
    params = Column(Text)
VALID_RENDERERS = ('Table With Subtotal', 'Table With Subtotal Heatmap', 'Table With Subtotal Col Heatmap', 'Table With Subtotal Row Heatmap', 'Table With Subtotal Barchart', 'Table With Subtotal Col Barchart', 'Table With Subtotal Row Barchart')
