...
BOT_INDEX = 1
BOT_NAME = '图灵机器人'
TULING_ERROR_CODE_LIST = (5000, 6000, 4000, 4001, 4002, 4003, 4005, 4007, 4100, 4200, 4300, 4400, 4500, 4600, 4602, 7002, 8008, 0)
...
def get_tuling123(text, userId):
    ...
    try:
        ...
        content = {'perception': {'inputText': {'text': text}}, 'userInfo': {'apiKey': apiKey, 'userId': userId}}
