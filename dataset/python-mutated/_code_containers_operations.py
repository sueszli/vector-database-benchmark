...
class CodeContainersOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> AsyncIterable['_models.CodeContainerResourceArmPaginatedResult']:
        if False:
            i = 10
            return i + 15
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, workspace_name: str, name: str, **kwargs: Any) -> '_models.CodeContainerData':
        """Get container.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, workspace_name: str, name: str, body: '_models.CodeContainerData', **kwargs: Any) -> '_models.CodeContainerData':
