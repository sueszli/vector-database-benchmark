...
__protobuf__ = proto.module(package='google.cloud.talent.v4beta1', manifest={'CreateTenantRequest', 'GetTenantRequest', 'UpdateTenantRequest', 'DeleteTenantRequest', 'ListTenantsRequest', 'ListTenantsResponse'})
...
class CreateTenantRequest(proto.Message):
    ...
    tenant: gct_tenant.Tenant = proto.Field(proto.MESSAGE, number=2, message=gct_tenant.Tenant)
...
class UpdateTenantRequest(proto.Message):
    ...
    """
    tenant: gct_tenant.Tenant = proto.Field(proto.MESSAGE, number=1, message=gct_tenant.Tenant)
...
class ListTenantsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    tenants: MutableSequence[gct_tenant.Tenant] = proto.RepeatedField(proto.MESSAGE, number=1, message=gct_tenant.Tenant)
