...
class sfp_stevenblack_hosts(SpiderFootPlugin):
    meta = {'name': 'Steven Black Hosts', 'summary': 'Check if a domain is malicious (malware or adware) according to Steven Black Hosts list.', 'flags': [], 'useCases': ['Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'https://github.com/StevenBlack/hosts', 'model': 'FREE_NOAUTH_UNLIMITED', 'description': 'Consolidating and extending hosts files (for malware and adware)from several well-curated sources.'}}
