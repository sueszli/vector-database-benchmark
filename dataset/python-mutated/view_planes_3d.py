...
def annotate_axes(ax, text, fontsize=18):
    if False:
        while True:
            i = 10
    ax.text(x=0.5, y=0.5, z=0.5, s=text, va='center', ha='center', fontsize=fontsize, color='black')
views = [('XY', (90, -90, 0)), ('XZ', (0, -90, 0)), ('YZ', (0, 0, 0)), ('-XY', (-90, 90, 0)), ('-XZ', (0, 90, 0)), ('-YZ', (0, 180, 0))]
layout = [['XY', '.', 'L', '.'], ['XZ', 'YZ', '-XZ', '-YZ'], ['.', '.', '-XY', '.']]
(fig, axd) = plt.subplot_mosaic(layout, subplot_kw={'projection': '3d'}, figsize=(12, 8.5))
