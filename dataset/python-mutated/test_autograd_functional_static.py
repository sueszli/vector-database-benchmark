...
def make_tensors(inps):
    ...
    return xs
all_data_shapes = {'A': [[1.0, 2.0]], 'B': [[1.0, 2.0], [2.0, 1.0]], 'C': [[2.0, 2.0], [2.0, 1.0]], 'D': [[[2.0, 2.0], [2.0, 1.0]], [[1.0, 2.0], [2.0, 1.0]]], 'E': [[[3.0, 4.0], [2.0, 3.0]], [[2.0, 1.0], [1.0, 3.0]]]}
