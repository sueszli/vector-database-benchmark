...
class AudiusIE(AudiusBaseIE):
    ...
    IE_DESC = 'Audius.co'
    _TESTS = [{'url': 'https://audius.co/test_acc/t%D0%B5%D0%B5%D0%B5est-1.%5E_%7B%7D/%22%3C%3E.%E2%84%96~%60-198631', 'md5': '92c35d3e754d5a0f17eef396b0d33582', 'info_dict': {'id': 'xd8gY', 'title': 'Tеееest/ 1.!@#$%^&*()_+=[]{};\'\\":<>,.?/№~`', 'ext': 'mp3', 'description': 'Description', 'duration': 30, 'track': 'Tеееest/ 1.!@#$%^&*()_+=[]{};\'\\":<>,.?/№~`', 'artist': 'test', 'genre': 'Electronic', 'thumbnail': 're:https?://.*\\.jpg', 'view_count': int, 'like_count': int, 'repost_count': int}}, {'url': 'https://audius.co/voltra/radar-103692', 'md5': '491898a0a8de39f20c5d6a8a80ab5132', 'info_dict': {'id': 'KKdy2', 'title': 'RADAR', 'ext': 'mp3', 'duration': 318, 'track': 'RADAR', 'artist': 'voltra', 'genre': 'Trance', 'thumbnail': 're:https?://.*\\.jpg', 'view_count': int, 'like_count': int, 'repost_count': int}}]
    _ARTWORK_MAP = {'150x150': 150, '480x480': 480, '1000x1000': 1000}
...
class AudiusTrackIE(AudiusIE):
    ...
    _TESTS = [{'url': 'audius:9RWlo', 'only_matching': True}, {'url': 'audius:http://discoveryprovider.audius.prod-us-west-2.staked.cloud/v1/tracks/9RWlo', 'only_matching': True}]
...
class AudiusPlaylistIE(AudiusBaseIE):
    ...
    _TEST = {'url': 'https://audius.co/test_acc/playlist/test-playlist-22910', 'info_dict': {'id': 'DNvjN', 'title': 'test playlist', 'description': 'Test description\n\nlol'}, 'playlist_count': 175}
...
class AudiusProfileIE(AudiusPlaylistIE):
    ...
    _TEST = {'url': 'https://audius.co/pzl/', 'info_dict': {'id': 'ezRo7', 'description': 'TAMALE\n\nContact: officialpzl@gmail.com', 'title': 'pzl'}, 'playlist_count': 24}
