...
from homeassistant.const import ATTR_ENTITY_ID, ATTR_SUPPORTED_FEATURES, ATTR_TEMPERATURE, PERCENTAGE, UnitOfTemperature
from homeassistant.core import State, callback
from homeassistant.util.enum import try_parse_enum
from homeassistant.util.percentage import ordered_list_item_to_percentage, percentage_to_ordered_list_item
from .accessories import TYPES, HomeAccessory
from .const import CHAR_ACTIVE, CHAR_COOLING_THRESHOLD_TEMPERATURE, CHAR_CURRENT_FAN_STATE, CHAR_CURRENT_HEATING_COOLING, CHAR_CURRENT_HUMIDITY, CHAR_CURRENT_TEMPERATURE, CHAR_HEATING_THRESHOLD_TEMPERATURE, CHAR_ROTATION_SPEED, CHAR_SWING_MODE, CHAR_TARGET_FAN_STATE, CHAR_TARGET_HEATING_COOLING, CHAR_TARGET_HUMIDITY, CHAR_TARGET_TEMPERATURE, CHAR_TEMP_DISPLAY_UNITS, DEFAULT_MAX_TEMP_WATER_HEATER, DEFAULT_MIN_TEMP_WATER_HEATER, PROP_MAX_VALUE, PROP_MIN_STEP, PROP_MIN_VALUE, SERV_FANV2, SERV_THERMOSTAT
from .util import temperature_to_homekit, temperature_to_states
_LOGGER = logging.getLogger(__name__)
DEFAULT_HVAC_MODES = [HVACMode.HEAT, HVACMode.COOL, HVACMode.HEAT_COOL, HVACMode.OFF]
...
HC_HEAT_COOL_COOL = 2
HC_HEAT_COOL_AUTO = 3
HC_HEAT_COOL_PREFER_HEAT = [HC_HEAT_COOL_AUTO, HC_HEAT_COOL_HEAT, HC_HEAT_COOL_COOL, HC_HEAT_COOL_OFF]
HC_HEAT_COOL_PREFER_COOL = [HC_HEAT_COOL_AUTO, HC_HEAT_COOL_COOL, HC_HEAT_COOL_HEAT, HC_HEAT_COOL_OFF]
...
HC_HASS_TO_HOMEKIT = {HVACMode.OFF: HC_HEAT_COOL_OFF, HVACMode.HEAT: HC_HEAT_COOL_HEAT, HVACMode.COOL: HC_HEAT_COOL_COOL, HVACMode.AUTO: HC_HEAT_COOL_AUTO, HVACMode.HEAT_COOL: HC_HEAT_COOL_AUTO, HVACMode.DRY: HC_HEAT_COOL_COOL, HVACMode.FAN_ONLY: HC_HEAT_COOL_COOL}
HC_HOMEKIT_TO_HASS = {c: s for (s, c) in HC_HASS_TO_HOMEKIT.items()}
HC_HASS_TO_HOMEKIT_ACTION = {HVACAction.OFF: HC_HEAT_COOL_OFF, HVACAction.IDLE: HC_HEAT_COOL_OFF, HVACAction.HEATING: HC_HEAT_COOL_HEAT, HVACAction.COOLING: HC_HEAT_COOL_COOL, HVACAction.DRYING: HC_HEAT_COOL_COOL, HVACAction.FAN: HC_HEAT_COOL_COOL}
FAN_STATE_INACTIVE = 0
FAN_STATE_IDLE = 1
FAN_STATE_ACTIVE = 2
HC_HASS_TO_HOMEKIT_FAN_STATE = {HVACAction.OFF: FAN_STATE_INACTIVE, HVACAction.IDLE: FAN_STATE_IDLE, HVACAction.HEATING: FAN_STATE_ACTIVE, HVACAction.COOLING: FAN_STATE_ACTIVE, HVACAction.DRYING: FAN_STATE_ACTIVE, HVACAction.FAN: FAN_STATE_ACTIVE}
