...
class ProductMediaReorder(BaseMutation):
    ...
    class Arguments:
        product_id = graphene.ID(required=True, description='ID of product that media order will be altered.')
        media_ids = NonNullList(graphene.ID, required=True, description='IDs of a product media in the desired order.')
