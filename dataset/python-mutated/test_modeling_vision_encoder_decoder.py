...
from transformers.testing_utils import require_levenshtein, require_nltk, require_sentencepiece, require_torch, require_vision, slow, to_2tuple, torch_device
...
if is_torch_available():
    import numpy as np
    import torch
    from transformers import AutoTokenizer, BartForCausalLM, BertLMHeadModel, DeiTModel, SwinModel, TrOCRForCausalLM, VisionEncoderDecoderConfig, VisionEncoderDecoderModel, ViTModel
