...
import numpy as np
from AnyQt.QtWidgets import QGroupBox, QRadioButton, QPushButton, QHBoxLayout, QGridLayout, QVBoxLayout, QStackedWidget, QComboBox, QWidget, QButtonGroup, QStyledItemDelegate, QListView, QLabel
...
StateRole = DisplayMethodRole + 244
...
METHODS = OrderedDict([(Method.AsAboveSoBelow, AsDefault), (Method.Leave, impute.DoNotImpute), (Method.Average, impute.Average), (Method.AsValue, impute.AsValue), (Method.Model, impute.Model), (Method.Random, impute.Random), (Method.Drop, impute.DropInstances), (Method.Default, impute.Default)])
...
class OWImpute(OWWidget):
    ...
    _default_method_index = settings.Setting(int(Method.Leave))
