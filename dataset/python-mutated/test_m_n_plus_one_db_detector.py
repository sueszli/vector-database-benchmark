...
from sentry.utils.performance_issues.detectors.mn_plus_one_db_span_detector import MNPlusOneDBSpanDetector
from sentry.utils.performance_issues.performance_detection import _detect_performance_problems, get_detection_settings, run_detector_on_data
