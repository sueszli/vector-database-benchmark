...
def build_list_request(location: str, instance_id: str, subscription_id: str, *, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableTables')
...
class RestorableTablesOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableTableGetResult']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(location=location, instance_id=instance_id, subscription_id=self._config.subscription_id, start_time=start_time, end_time=end_time, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableTables'}