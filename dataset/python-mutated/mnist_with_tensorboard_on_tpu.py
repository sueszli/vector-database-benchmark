...
def run(train_batch_size, val_batch_size, epochs, lr, momentum, log_interval, log_dir):
    ...
    trainer = create_supervised_trainer(model, optimizer, criterion, device=device, output_transform=lambda x, y, y_pred, loss: [loss.item()])
