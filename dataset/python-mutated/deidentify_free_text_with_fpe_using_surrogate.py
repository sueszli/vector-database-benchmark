...
if __name__ == '__main__':
    ...
    parser.add_argument('--info_type', help='String representing info types to look for. A full list of info categories and types is available from the API. Examples include "FIRST_NAME", "LAST_NAME", "EMAIL_ADDRESS". ')
    parser.add_argument('project', help='The Google Cloud project id to use as a parent resource.')
    parser.add_argument('input_str', help="The string to deidentify. Example: string = 'My SSN is 372819127'")
    parser.add_argument('unwrapped_key', help='The base64-encoded AES-256 key to use.')
    ...
    deidentify_free_text_with_fpe_using_surrogate(args.project, args.input_str, alphabet=args.alphabet, info_type=args.info_type, surrogate_type=args.surrogate_type, unwrapped_key=args.unwrapped_key)