...
class SurveyMailComposeMessage(models.TransientModel):
    ...
    multi_email = fields.Text(string='List of emails', help='This list of emails of recipients will not be converted in contacts.        Emails must be separated by commas, semicolons or newline.')
