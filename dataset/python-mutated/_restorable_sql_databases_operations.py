...
def build_list_request(location: str, instance_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableSqlDatabases')
...
class RestorableSqlDatabasesOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, **kwargs: Any) -> Iterable['_models.RestorableSqlDatabaseGetResult']:
        if False:
            print('Hello World!')
