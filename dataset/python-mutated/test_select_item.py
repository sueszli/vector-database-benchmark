...
@testing.parameterize(*testing.product_dict([{'in_shape': (10, 5), 'out_shape': (10,)}, {'in_shape': (0, 5), 'out_shape': (0,)}, {'in_shape': (1, 33), 'out_shape': (1,)}, {'in_shape': (10, 5), 'out_shape': (10,)}, {'in_shape': (10, 5), 'out_shape': (10,)}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
...
@testing.parameterize({'t_value': -1, 'valid': False}, {'t_value': 3, 'valid': False}, {'t_value': 0, 'valid': True})
