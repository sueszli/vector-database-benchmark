...
class TestConstructor(SafeConstructor):
    ...
    def construct_yaml_unsafe(self, node):
        ...
        return value
TestConstructor.add_constructor('!unsafe', TestConstructor.construct_yaml_unsafe)
TestConstructor.add_constructor('!vault', TestConstructor.construct_yaml_str)
TestConstructor.add_constructor('!vault-encrypted', TestConstructor.construct_yaml_str)
