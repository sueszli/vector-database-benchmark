...
from AnyQt.QtWidgets import QCheckBox, QSizePolicy, QGraphicsRectItem, QGraphicsSceneMouseEvent, QApplication, QWidget, QComboBox
import pyqtgraph as pg
from orangewidget.utils.listview import ListViewSearch
from orangewidget.utils.visual_settings_dlg import KeyType, ValueType, VisualSettingsDialog
...
class OWViolinPlot(OWWidget):
    ...
    orientation_index = Setting(1)
    kernel_index = Setting(0)
