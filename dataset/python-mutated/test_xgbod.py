...
class TestXGBOD(unittest.TestCase):
    ...
    def test_parameters(self):
        if False:
            for i in range(10):
                print('nop')
        assert hasattr(self.clf, 'clf_') and self.clf.decision_scores_ is not None
        assert hasattr(self.clf, '_scalar') and self.clf.labels_ is not None
        assert hasattr(self.clf, 'n_detector_') and self.clf.labels_ is not None
        assert hasattr(self.clf, 'X_train_add_') and self.clf.labels_ is not None
