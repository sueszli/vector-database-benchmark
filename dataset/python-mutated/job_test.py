...
output_uri_for_preset_batch_mode = f'gs://{output_bucket_name}/test-output-preset-batch-mode/'
...
output_uri_for_animated_overlay = f'gs://{output_bucket_name}/test-output-animated-overlay/'
...
output_uri_for_set_number_spritesheet = f'gs://{output_bucket_name}/{output_dir_for_set_number_spritesheet}'
output_dir_for_periodic_spritesheet = 'test-output-periodic-spritesheet/'
output_uri_for_periodic_spritesheet = f'gs://{output_bucket_name}/{output_dir_for_periodic_spritesheet}'
