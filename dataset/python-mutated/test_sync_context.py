...
from samcli.commands.sync.sync_context import SyncState, ResourceSyncState, datetime, _sync_state_to_toml_document, HASH, SYNC_TIME, SYNC_STATE, DEPENDENCY_LAYER, RESOURCE_SYNC_STATES, LATEST_INFRA_SYNC_TIME, _toml_document_to_sync_state, SyncContext
...
@parameterized_class([{'dependency_layer': True, 'skip_deploy_sync': True}, {'dependency_layer': False, 'skip_deploy_sync': False}])
