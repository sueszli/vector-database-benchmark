...
if __name__ == '__main__':
    ...
    with tempfile.TemporaryDirectory() as local_path:
        ...
        put_local_file_to_remote(os.path.join(local_path, 'categorical_sizes.pkl'), os.path.join(args.output_folder, 'meta/categorical_sizes.pkl'), over_write=True)
        with open(os.path.join(local_path, 'cross_sizes.pkl'), 'wb') as f:
            pickle.dump(cross_sizes_dict, f)
        put_local_file_to_remote(os.path.join(local_path, 'cross_sizes.pkl'), os.path.join(args.output_folder, 'meta/cross_sizes.pkl'), over_write=True)
    if args.days == 24:
