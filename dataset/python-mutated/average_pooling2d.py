...
class AveragePooling2D(BasePooling):
    ...
    def __init__(self, pool_size, strides=None, padding='valid', data_format='channels_last', name=None, **kwargs):
        if False:
            while True:
                i = 10
        super().__init__(pool_size, strides, pool_dimensions=2, pool_mode='average', padding=padding, data_format=data_format, name=name, **kwargs)