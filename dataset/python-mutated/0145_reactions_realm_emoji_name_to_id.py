...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0144_remove_realm_create_generic_bot_by_admins_only')]
    operations = [migrations.RunPython(realm_emoji_name_to_id, reverse_code=reversal, elidable=True)]