...
if os.name == 'nt':
    ...
    class Console(ConsoleBase):
        fncodes = {';': '\x1bOP', '<': '\x1bOQ', '=': '\x1bOR', '>': '\x1bOS', '?': '\x1b[15~', '@': '\x1b[17~', 'A': '\x1b[18~', 'B': '\x1b[19~', 'C': '\x1b[20~', 'D': '\x1b[21~'}
        navcodes = {'H': '\x1b[A', 'P': '\x1b[B', 'K': '\x1b[D', 'M': '\x1b[C', 'G': '\x1b[H', 'O': '\x1b[F', 'R': '\x1b[2~', 'S': '\x1b[3~', 'I': '\x1b[5~', 'Q': '\x1b[6~'}
...
class DebugIO(Transform):
    ...
    def tx(self, text):
        ...
        sys.stderr.flush()
        return text
EOL_TRANSFORMATIONS = {'crlf': CRLF, 'cr': CR, 'lf': LF}
TRANSFORMATIONS = {'direct': Transform, 'default': NoTerminal, 'nocontrol': NoControls, 'printable': Printable, 'colorize': Colorize, 'debug': DebugIO}
