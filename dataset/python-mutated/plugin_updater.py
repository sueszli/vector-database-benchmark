...
import re
import traceback
from qt.core import QAbstractItemView, QAbstractTableModel, QAction, QBrush, QComboBox, QDialog, QDialogButtonBox, QFont, QFrame, QHBoxLayout, QIcon, QLabel, QLineEdit, QModelIndex, QSize, QSortFilterProxyModel, Qt, QTableView, QUrl, QVBoxLayout
