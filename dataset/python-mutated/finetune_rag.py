...
from transformers import AutoConfig, AutoTokenizer, BartForConditionalGeneration, BatchEncoding, RagConfig, RagSequenceForGeneration, RagTokenForGeneration, RagTokenizer, T5ForConditionalGeneration
from transformers import logging as transformers_logging
from transformers.integrations import is_ray_available
if is_ray_available():
    import ray
    from distributed_ray_retriever import RagRayDistributedRetriever, RayRetriever
from callbacks_rag import get_checkpoint_callback, get_early_stopping_callback, Seq2SeqLoggingCallback
from distributed_pytorch_retriever import RagPyTorchDistributedRetriever
from utils_rag import calculate_exact_match, flatten_list, get_git_info, is_rag_model, lmap, pickle_save, save_git_info, save_json, set_extra_model_params, Seq2SeqDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--profile', action='store_true', help='If True, use pytorch_lightning.profiler.AdvancedProfiler to profile the Trainer.')
