...
from typing import TYPE_CHECKING, Any, Dict, Iterable, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Type, Union, cast
import pendulum
from typing_extensions import Final
from dagster import StaticPartitionsDefinition, _check as check
from dagster._config.pythonic_config import ConfigurableIOManagerFactoryResourceDefinition, ConfigurableResourceFactoryResourceDefinition, ResourceWithKeyMapping
from dagster._config.snap import ConfigFieldSnap, ConfigSchemaSnapshot, snap_from_config_type
from dagster._core.definitions import JobDefinition, PartitionsDefinition, RepositoryDefinition, ScheduleDefinition, SourceAsset
from dagster._core.definitions.asset_check_spec import AssetCheckKey
from dagster._core.definitions.asset_sensor_definition import AssetSensorDefinition
from dagster._core.definitions.asset_spec import SYSTEM_METADATA_KEY_ASSET_EXECUTION_TYPE, AssetExecutionType
...
from dagster._core.definitions.dependency import GraphNode, Node, NodeHandle, NodeOutputHandle, OpNode
from dagster._core.definitions.events import AssetKey
from dagster._core.definitions.freshness_policy import FreshnessPolicy
from dagster._core.definitions.metadata import MetadataFieldSerializer, MetadataMapping, MetadataUserInput, MetadataValue, TextMetadataValue, normalize_metadata
from dagster._core.definitions.multi_dimensional_partitions import MultiPartitionsDefinition
from dagster._core.definitions.op_definition import OpDefinition
from dagster._core.definitions.partition import DynamicPartitionsDefinition, ScheduleType
from dagster._core.definitions.partition_mapping import PartitionMapping, get_builtin_partition_mapping_types
from dagster._core.definitions.resource_definition import ResourceDefinition
from dagster._core.definitions.schedule_definition import DefaultScheduleStatus
from dagster._core.definitions.sensor_definition import DefaultSensorStatus, SensorDefinition, SensorType
...
class ExternalRepositoryData(NamedTuple('_ExternalRepositoryData', [('name', str), ('external_schedule_datas', Sequence['ExternalScheduleData']), ('external_partition_set_datas', Sequence['ExternalPartitionSetData']), ('external_sensor_datas', Sequence['ExternalSensorData']), ('external_asset_graph_data', Sequence['ExternalAssetNode']), ('external_job_datas', Optional[Sequence['ExternalJobData']]), ('external_job_refs', Optional[Sequence['ExternalJobRef']]), ('external_resource_data', Optional[Sequence['ExternalResourceData']]), ('external_asset_checks', Optional[Sequence['ExternalAssetCheck']]), ('metadata', Optional[MetadataMapping]), ('utilized_env_vars', Optional[Mapping[str, Sequence['EnvVarConsumer']]])])):
...
@whitelist_for_serdes(storage_name='ExternalPipelineSubsetResult', storage_field_names={'external_job_data': 'external_pipeline_data'})
class ExternalJobSubsetResult(NamedTuple('_ExternalJobSubsetResult', [('success', bool), ('error', Optional[SerializableErrorInfo]), ('external_job_data', Optional['ExternalJobData'])])):
...
@whitelist_for_serdes(storage_name='ExternalPipelineData', storage_field_names={'job_snapshot': 'pipeline_snapshot', 'parent_job_snapshot': 'parent_pipeline_snapshot'}, old_fields={'is_job': True})
class ExternalJobData(NamedTuple('_ExternalJobData', [('name', str), ('job_snapshot', JobSnapshot), ('active_presets', Sequence['ExternalPresetData']), ('parent_job_snapshot', Optional[JobSnapshot])])):
...
class ExternalJobRef(NamedTuple('_ExternalJobRef', [('name', str), ('snapshot_id', str), ('active_presets', Sequence['ExternalPresetData']), ('parent_snapshot_id', Optional[str])])):
...
class ExternalPresetData(NamedTuple('_ExternalPresetData', [('name', str), ('run_config', Mapping[str, object]), ('op_selection', Optional[Sequence[str]]), ('mode', str), ('tags', Mapping[str, str])])):
...
@whitelist_for_serdes(storage_field_names={'job_name': 'pipeline_name', 'op_selection': 'solid_selection'}, skip_when_empty_fields={'default_status'})
class ExternalScheduleData(NamedTuple('_ExternalScheduleData', [('name', str), ('cron_schedule', Union[str, Sequence[str]]), ('job_name', str), ('op_selection', Optional[Sequence[str]]), ('mode', Optional[str]), ('environment_vars', Optional[Mapping[str, str]]), ('partition_set_name', Optional[str]), ('execution_timezone', Optional[str]), ('description', Optional[str]), ('default_status', Optional[DefaultScheduleStatus])])):
...
@whitelist_for_serdes
class ExternalScheduleExecutionErrorData(NamedTuple('_ExternalScheduleExecutionErrorData', [('error', Optional[SerializableErrorInfo])])):
...
@whitelist_for_serdes(storage_field_names={'job_name': 'pipeline_name', 'op_selection': 'solid_selection'})
class ExternalTargetData(NamedTuple('_ExternalTargetData', [('job_name', str), ('mode', str), ('op_selection', Optional[Sequence[str]])])):
...
@whitelist_for_serdes
class ExternalSensorMetadata(NamedTuple('_ExternalSensorMetadata', [('asset_keys', Optional[Sequence[AssetKey]])])):
...
@whitelist_for_serdes(storage_field_names={'job_name': 'pipeline_name', 'op_selection': 'solid_selection'}, skip_when_empty_fields={'default_status', 'sensor_type'})
class ExternalSensorData(NamedTuple('_ExternalSensorData', [('name', str), ('job_name', Optional[str]), ('op_selection', Optional[Sequence[str]]), ('mode', Optional[str]), ('min_interval', Optional[int]), ('description', Optional[str]), ('target_dict', Mapping[str, ExternalTargetData]), ('metadata', Optional[ExternalSensorMetadata]), ('default_status', Optional[DefaultSensorStatus]), ('sensor_type', Optional[SensorType])])):
...
@whitelist_for_serdes
class ExternalRepositoryErrorData(NamedTuple('_ExternalRepositoryErrorData', [('error', Optional[SerializableErrorInfo])])):
...
@whitelist_for_serdes
class ExternalSensorExecutionErrorData(NamedTuple('_ExternalSensorExecutionErrorData', [('error', Optional[SerializableErrorInfo])])):
...
@whitelist_for_serdes
class ExternalExecutionParamsData(NamedTuple('_ExternalExecutionParamsData', [('run_config', Mapping[str, object]), ('tags', Mapping[str, str])])):
...
@whitelist_for_serdes
class ExternalExecutionParamsErrorData(NamedTuple('_ExternalExecutionParamsErrorData', [('error', Optional[SerializableErrorInfo])])):
...
@whitelist_for_serdes
class ExternalTimeWindowPartitionsDefinitionData(ExternalPartitionsDefinitionData, NamedTuple('_ExternalTimeWindowPartitionsDefinitionData', [('start', float), ('timezone', Optional[str]), ('fmt', str), ('end_offset', int), ('end', Optional[float]), ('cron_schedule', Optional[str]), ('schedule_type', Optional[ScheduleType]), ('minute_offset', Optional[int]), ('hour_offset', Optional[int]), ('day_offset', Optional[int])])):
...
@whitelist_for_serdes
class ExternalStaticPartitionsDefinitionData(ExternalPartitionsDefinitionData, NamedTuple('_ExternalStaticPartitionsDefinitionData', [('partition_keys', Sequence[str])])):
...
@whitelist_for_serdes
class ExternalPartitionDimensionDefinition(NamedTuple('_ExternalPartitionDimensionDefinition', [('name', str), ('external_partitions_def_data', ExternalPartitionsDefinitionData)])):
...
@whitelist_for_serdes
class ExternalMultiPartitionsDefinitionData(ExternalPartitionsDefinitionData, NamedTuple('_ExternalMultiPartitionsDefinitionData', [('external_partition_dimension_definitions', Sequence[ExternalPartitionDimensionDefinition])])):
...
@whitelist_for_serdes
class ExternalDynamicPartitionsDefinitionData(ExternalPartitionsDefinitionData, NamedTuple('_ExternalDynamicPartitionsDefinitionData', [('name', str)])):
...
@whitelist_for_serdes(storage_field_names={'job_name': 'pipeline_name', 'op_selection': 'solid_selection'})
class ExternalPartitionSetData(NamedTuple('_ExternalPartitionSetData', [('name', str), ('job_name', str), ('op_selection', Optional[Sequence[str]]), ('mode', Optional[str]), ('external_partitions_data', Optional[ExternalPartitionsDefinitionData])])):
...
@whitelist_for_serdes
class ExternalPartitionNamesData(NamedTuple('_ExternalPartitionNamesData', [('partition_names', Sequence[str])])):
...
@whitelist_for_serdes
class ExternalPartitionConfigData(NamedTuple('_ExternalPartitionConfigData', [('name', str), ('run_config', Mapping[str, object])])):
...
@whitelist_for_serdes
class ExternalPartitionTagsData(NamedTuple('_ExternalPartitionTagsData', [('name', str), ('tags', Mapping[str, object])])):
...
@whitelist_for_serdes
class ExternalPartitionExecutionParamData(NamedTuple('_ExternalPartitionExecutionParamData', [('name', str), ('tags', Mapping[str, object]), ('run_config', Mapping[str, object])])):
...
@whitelist_for_serdes
class ExternalPartitionSetExecutionParamData(NamedTuple('_ExternalPartitionSetExecutionParamData', [('partition_data', Sequence[ExternalPartitionExecutionParamData])])):
...
@whitelist_for_serdes
class ExternalPartitionExecutionErrorData(NamedTuple('_ExternalPartitionExecutionErrorData', [('error', Optional[SerializableErrorInfo])])):
...
@whitelist_for_serdes
class ExternalAssetDependency(NamedTuple('_ExternalAssetDependency', [('upstream_asset_key', AssetKey), ('input_name', Optional[str]), ('output_name', Optional[str]), ('partition_mapping', Optional[PartitionMapping])])):
...
@whitelist_for_serdes
class ExternalAssetDependedBy(NamedTuple('_ExternalAssetDependedBy', [('downstream_asset_key', AssetKey), ('input_name', Optional[str]), ('output_name', Optional[str])])):
    """A definition of a directed edge in the logical asset graph.
...
@whitelist_for_serdes
class ExternalResourceData(NamedTuple('_ExternalResourceData', [('name', str), ('resource_snapshot', ResourceDefSnap), ('configured_values', Dict[str, ExternalResourceValue]), ('config_field_snaps', List[ConfigFieldSnap]), ('config_schema_snap', ConfigSchemaSnapshot), ('nested_resources', Dict[str, NestedResource]), ('parent_resources', Dict[str, str]), ('resource_type', str), ('is_top_level', bool), ('asset_keys_using', List[AssetKey]), ('job_ops_using', List[ResourceJobUsageEntry]), ('dagster_maintained', bool), ('schedules_using', List[str]), ('sensors_using', List[str])])):
...
@whitelist_for_serdes
class ExternalAssetCheck(NamedTuple('_ExternalAssetCheck', [('name', str), ('asset_key', AssetKey), ('description', Optional[str]), ('atomic_execution_unit_id', Optional[str])])):
...
@whitelist_for_serdes(storage_field_names={'metadata': 'metadata_entries'}, field_serializers={'metadata': MetadataFieldSerializer})
class ExternalAssetNode(NamedTuple('_ExternalAssetNode', [('asset_key', AssetKey), ('dependencies', Sequence[ExternalAssetDependency]), ('depended_by', Sequence[ExternalAssetDependedBy]), ('compute_kind', Optional[str]), ('op_name', Optional[str]), ('op_names', Optional[Sequence[str]]), ('code_version', Optional[str]), ('node_definition_name', Optional[str]), ('graph_name', Optional[str]), ('op_description', Optional[str]), ('job_names', Sequence[str]), ('partitions_def_data', Optional[ExternalPartitionsDefinitionData]), ('output_name', Optional[str]), ('output_description', Optional[str]), ('metadata', Mapping[str, MetadataValue]), ('group_name', Optional[str]), ('freshness_policy', Optional[FreshnessPolicy]), ('is_source', bool), ('is_observable', bool), ('atomic_execution_unit_id', Optional[str]), ('required_top_level_resources', Optional[Sequence[str]]), ('auto_materialize_policy', Optional[AutoMaterializePolicy]), ('backfill_policy', Optional[BackfillPolicy]), ('auto_observe_interval_minutes', Optional[float])])):
