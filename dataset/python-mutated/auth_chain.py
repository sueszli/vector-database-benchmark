...
import hashlib
import bisect
import ssshare.shadowsocks
from ssshare.shadowsocks import common, lru_cache, encrypt
...
obfs_map = {'auth_chain_a': (create_auth_chain_a,), 'auth_chain_b': (create_auth_chain_b,)}
