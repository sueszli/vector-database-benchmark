...
class VoiceArtistTest(BaseVoiceArtistControllerTests):
    ...
    EXP_ID: Final = 'exp1'
    RECORDED_VOICEOVERS: Final = {'voiceovers_mapping': {'ca_placeholder_2': {}, 'content_0': {'en': {'filename': 'testFile.mp3', 'file_size_bytes': 12200, 'needs_update': False, 'duration_secs': 4.5}}, 'default_outcome_1': {}}}
...
class VoiceArtistAutosaveTest(BaseVoiceArtistControllerTests):
    ...
    RECORDED_VOICEOVERS: Final = {'voiceovers_mapping': {'ca_placeholder_2': {}, 'content_0': {'en': {'filename': 'testFile.mp3', 'file_size_bytes': 12200, 'needs_update': False, 'duration_secs': 4.5}}, 'default_outcome_1': {}}}
    VALID_DRAFT_CHANGELIST: Final = [{'cmd': 'edit_state_property', 'state_name': feconf.DEFAULT_INIT_STATE_NAME, 'property_name': 'recorded_voiceovers', 'old_value': None, 'new_value': RECORDED_VOICEOVERS}]
    INVALID_DRAFT_CHANGELIST: Final = [{'cmd': 'edit_exploration_property', 'property_name': 'title', 'old_value': None, 'new_value': 'New title'}]
