...
class HalvingGridSearchCV(BaseSuccessiveHalving):
    ...
    _parameter_constraints: dict = {**BaseSuccessiveHalving._parameter_constraints, 'param_grid': [dict, list]}
...
class HalvingRandomSearchCV(BaseSuccessiveHalving):
    ...
    _parameter_constraints: dict = {**BaseSuccessiveHalving._parameter_constraints, 'param_distributions': [dict, list], 'n_candidates': [Interval(Integral, 0, None, closed='neither'), StrOptions({'exhaust'})]}
