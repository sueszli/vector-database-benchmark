...
from searx.engines.google import fetch_traits as _fetch_traits
...
traits: EngineTraits
about = {'website': 'https://news.google.com', 'wikidata_id': 'Q12020', 'official_api_documentation': 'https://developers.google.com/custom-search', 'use_official_api': False, 'require_api_key': False, 'results': 'HTML'}
categories = ['news']
paging = False
