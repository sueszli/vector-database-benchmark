...
from modelscope.models.multi_modal.videocomposer.annotator.sketch import pidinet_bsd, sketch_simplification_gan
...
from modelscope.models.multi_modal.videocomposer.diffusion import GaussianDiffusion, beta_schedule
from modelscope.models.multi_modal.videocomposer.ops.utils import get_first_stage_encoding, make_masked_images, prepare_model_kwargs, save_with_model_kwargs
...
from modelscope.models.multi_modal.videocomposer.utils.utils import find_free_port, setup_seed, to_device
...
@MODELS.register_module(Tasks.text_to_video_synthesis, module_name=Models.videocomposer)
