...
class MockHandler(SimpleHTTPRequestHandler):
    ...
    def set_common_headers(self):
        ...
        self.end_headers()
    rtm_start_success = {'ok': True, 'url': 'ws://localhost:8765', 'self': {'id': 'U01234ABC', 'name': 'robotoverlord'}, 'team': {'domain': 'exampledomain', 'id': 'T123450FP', 'name': 'ExampleName'}}
    rtm_start_failure = {'ok': False, 'error': 'invalid_auth'}
