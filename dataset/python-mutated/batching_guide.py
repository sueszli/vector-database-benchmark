...
@serve.deployment(user_config={'max_batch_size': 10, 'batch_wait_timeout_s': 0.5})
class Model:
...
class StreamingResponder:
    ...
    async def generate_numbers(self, max_list: List[str]) -> AsyncGenerator[List[Union[int, StopIteration]], None]:
