...
if TYPE_CHECKING:
    ...
    from .._generated.models import PhoneNumberCapabilities, PhoneNumberCountry, PhoneNumberOffering, PhoneNumberLocality, PhoneNumberSearchResult, PurchasedPhoneNumber
...
class PhoneNumbersClient(object):
    ...
    async def begin_purchase_phone_numbers(self, search_id, **kwargs):
        ...
        return await self._phone_number_client.phone_numbers.begin_purchase_phone_numbers(body=purchase_request, polling_interval=polling_interval, **kwargs)

    @distributed_trace_async
    async def begin_release_phone_number(self, phone_number, **kwargs):
        ...
        """
        polling_interval = kwargs.pop('polling_interval', _DEFAULT_POLLING_INTERVAL_IN_SECONDS)
        return await self._phone_number_client.phone_numbers.begin_release_phone_number(phone_number, polling_interval=polling_interval, **kwargs)

    @distributed_trace_async
    async def begin_search_available_phone_numbers(self, country_code, phone_number_type, assignment_type, capabilities, **kwargs):
        ...
        polling_interval = kwargs.pop('polling_interval', _DEFAULT_POLLING_INTERVAL_IN_SECONDS)
        return await self._phone_number_client.phone_numbers.begin_search_available_phone_numbers(country_code, search_request, polling_interval=polling_interval, **kwargs)

    @distributed_trace_async
    async def begin_update_phone_number_capabilities(self, phone_number, sms=None, calling=None, **kwargs):
        ...
        return await self._phone_number_client.phone_numbers.begin_update_capabilities(phone_number, body=capabilities_request, polling_interval=polling_interval, **kwargs)

    @distributed_trace_async
    async def get_purchased_phone_number(self, phone_number, **kwargs):
