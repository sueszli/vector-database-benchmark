...
class MockManager:
    ...
    def setup_stubs(self, error, stop_on, stubber):
        ...
        with self.stub_runner(error, stop_on) as runner:
            ...
            runner.add(stubber.stub_describe_db_clusters, self.cluster['DBClusterIdentifier'], error_code='DBClusterNotFoundFault')
...
@pytest.mark.parametrize('error, stop_on_index', [('TESTERROR-stub_delete_db_instance', 0), ('TESTERROR-stub_delete_db_cluster', 1), ('TESTERROR-stub_describe_db_instances', 2), ('TESTERROR-stub_describe_db_clusters', 3)])
