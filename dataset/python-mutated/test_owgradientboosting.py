...
try:
    ...
    CatGBRegressor = None
from Orange.widgets.model.owgradientboosting import OWGradientBoosting, LearnerItemModel, GBLearnerEditor, XGBLearnerEditor, XGBRFLearnerEditor, CatGBLearnerEditor, BaseEditor
from Orange.widgets.settings import SettingProvider
from Orange.widgets.tests.base import WidgetTest, ParameterMapping, WidgetLearnerTestMixin, datasets, simulate, GuiTest
