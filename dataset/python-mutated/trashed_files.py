...
class NonTrashinfoFileFound(NamedTuple('NonTrashinfoFileFound', [('path', str)])):
    pass

class TrashedFileFound(NamedTuple('TrashedFileFound', [('trashed_file', TrashedFile)])):
    pass

class NonParsableTrashInfo(NamedTuple('NonParsableTrashInfo', [('path', str), ('reason', Exception)])):
    pass

class IOErrorReadingTrashInfo(NamedTuple('IOErrorReadingTrashInfo', [('path', str), ('error', str)])):
    pass
Event = Union[NonTrashinfoFileFound, TrashedFileFound, NonParsableTrashInfo, IOErrorReadingTrashInfo]