...
FLAGS = flags.FLAGS
flags.DEFINE_string('checkpoint_dir', '/tmp/skat_dqn/', 'Directory to save/load the agent.')
...
flags.DEFINE_integer('num_eval_games', 1000, 'How many games to play during each evaluation.')
...
flags.DEFINE_bool('randomize_positions', True, 'Randomize the position of each agent before every game.')
