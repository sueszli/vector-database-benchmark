...
class BasicTemplateContinuousFutureWithExtendedMarketAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self._continuousContract = self.AddFuture(Futures.Indices.SP500EMini, dataNormalizationMode=DataNormalizationMode.BackwardsRatio, dataMappingMode=DataMappingMode.LastTradingDay, contractDepthOffset=0, extendedMarketHours=True)
