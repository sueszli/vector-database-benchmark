...
class build_ext(_build_ext, object):
    user_options = _build_ext.user_options + [('cython-cplus', None, 'generate C++ source files'), ('cython-create-listing', None, 'write errors to a listing file'), ('cython-line-directives', None, 'emit source line directives'), ('cython-include-dirs=', None, 'path to the Cython include files' + _build_ext.sep_by), ('cython-c-in-temp', None, 'put generated C files in temp directory'), ('cython-gen-pxi', None, 'generate .pxi file for public declarations'), ('cython-directives=', None, 'compiler directive overrides'), ('cython-gdb', None, 'generate debug information for cygdb'), ('cython-compile-time-env', None, 'cython compile time environment')]
    boolean_options = _build_ext.boolean_options + ['cython-cplus', 'cython-create-listing', 'cython-line-directives', 'cython-c-in-temp', 'cython-gdb']
