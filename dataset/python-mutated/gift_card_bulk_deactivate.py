...
class GiftCardBulkDeactivate(BaseBulkMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of gift card IDs to deactivate.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.GIFT_CARD_STATUS_CHANGED, description='A gift card was deactivated.')]
