...
labels = ['gender', 'smile', 'attractive', 'wavy-hair', 'young', 'big lips', 'big nose', 'chubby', 'glasses']
...
if __name__ == '__main__':
    gpu_count = 1
    run(sample, get_cfg_defaults(), description='ALAE-interactive', default_config='configs/ffhq.yaml', world_size=gpu_count, write_log=False)