...
class DelightfulTTSConfig(BaseTTSConfig):
    ...
    optimizer: str = 'AdamW'
    optimizer_params: dict = field(default_factory=lambda : {'betas': [0.8, 0.99], 'eps': 1e-09, 'weight_decay': 0.01})
    ...
    multi_scale_stft_loss_params: dict = field(default_factory=lambda : {'n_ffts': [1024, 2048, 512], 'hop_lengths': [120, 240, 50], 'win_lengths': [600, 1200, 240]})
    ...
    test_sentences: List[List[str]] = field(default_factory=lambda : [["It took me quite a long time to develop a voice, and now that I have it I'm not going to be silent."], ['Be a voice, not an echo.'], ["I'm sorry Dave. I'm afraid I can't do that."], ["This cake is great. It's so delicious and moist."], ['Prior to November 22, 1963.']])
