...
from calibre.ebooks.metadata.opf3 import CALIBRE_PREFIX, Author, XPath, apply_metadata, ensure_is_only_raster_cover, ensure_prefix, expand_prefix, parse_prefixes, read_authors, read_book_producers, read_comments, read_identifiers, read_languages, read_last_modified, read_link_maps, read_metadata, read_prefixes, read_pubdate, read_publisher, read_raster_cover, read_rating, read_refines, read_series, read_tags, read_timestamp, read_title, read_title_sort, read_user_categories, read_user_metadata, reserved_prefixes, set_application_id, set_authors, set_book_producers, set_comments, set_identifiers, set_languages, set_link_maps, set_pubdate, set_publisher, set_rating, set_series, set_tags, set_timestamp, set_title, set_user_categories, set_user_metadata
