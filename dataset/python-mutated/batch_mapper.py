...
if TYPE_CHECKING:
    import pandas
BATCH_MAPPER_DEPRECATION_MESSAGE = 'The BatchMapper preprocessor is deprecated as of Ray 2.7. Instead, transform your Ray Dataset directly using `map_batches`.'
