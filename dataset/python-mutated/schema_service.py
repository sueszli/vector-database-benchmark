...
__protobuf__ = proto.module(package='google.cloud.discoveryengine.v1beta', manifest={'GetSchemaRequest', 'ListSchemasRequest', 'ListSchemasResponse', 'CreateSchemaRequest', 'UpdateSchemaRequest', 'DeleteSchemaRequest', 'CreateSchemaMetadata', 'UpdateSchemaMetadata', 'DeleteSchemaMetadata'})
...
class ListSchemasResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    schemas: MutableSequence[gcd_schema.Schema] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_schema.Schema)
...
class CreateSchemaRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    schema: gcd_schema.Schema = proto.Field(proto.MESSAGE, number=2, message=gcd_schema.Schema)
...
class UpdateSchemaRequest(proto.Message):
    ...
    """
    schema: gcd_schema.Schema = proto.Field(proto.MESSAGE, number=1, message=gcd_schema.Schema)
