...
class Mode(CtrlNode):
    ...
    nodeName = 'ModeFilter'
    uiTemplate = [('window', 'intSpin', {'value': 500, 'min': 1, 'max': 1000000})]
...
class Denoise(CtrlNode):
    ...
    uiTemplate = [('radius', 'intSpin', {'value': 2, 'min': 0, 'max': 1000000}), ('threshold', 'doubleSpin', {'value': 4.0, 'min': 0, 'max': 1000})]
...
class Gaussian(CtrlNode):
    ...
    uiTemplate = [('sigma', 'doubleSpin', {'min': 0, 'max': 1000000})]
