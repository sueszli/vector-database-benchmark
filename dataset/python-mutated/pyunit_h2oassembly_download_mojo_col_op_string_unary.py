...
def test_unary_string_function(function, **params):
    if False:
        while True:
            i = 10
    values = [[12.5, '++&&texTtextText&+', 14], [12.2, '  fTFsaf   ', 24], [2.23, '      fd9af ', 34], [3.31, '+&texttext&&++', 34], [4.31, '3fdsf3', 34], [1.13, '+texTText++', 34], [52.4, '33  ', 34], [62.5, 's', 34], [82.6, '&&texTtexttext&', 34], [12.8, 'ttaatt', 34], [35.9, 'asttatta', 34], [32.3, '', 34]]
