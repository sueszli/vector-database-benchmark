...
import pytest
from azure.confidentialledger.receipt._receipt_verification import verify_receipt
from azure.confidentialledger.receipt._receipt_models import LeafComponents, ProofElement
from ._shared.receipt_constants import get_test_valid_receipt_1_dict, get_test_valid_receipt_2_dict, get_test_valid_service_certificate_2, get_test_valid_service_certificate_1
from ._shared.claims_constants import get_test_application_claims_with_claim_digest_dict, get_test_application_claims_with_ledger_entry_dict

@pytest.mark.parametrize('input_receipt,input_service_cert', [[get_test_valid_receipt_1_dict(), get_test_valid_service_certificate_1()], [get_test_valid_receipt_2_dict(), get_test_valid_service_certificate_2()]])
...
@pytest.mark.parametrize('input_leaf_components', [None, LeafComponents(claimsDigest='invalid_claims_digest', commitEvidence='invalid_commit_evidence', writeSetDigest='invalid_write_set_digest'), LeafComponents(claimsDigest=get_test_valid_receipt_1_dict()['leaf_components']['claims_digest'], commitEvidence='invalid_commit_evidence', writeSetDigest='invalid_write_set_digest'), LeafComponents(claimsDigest='invalid_claims_digest', commitEvidence='invalid_commit_evidence', writeSetDigest=get_test_valid_receipt_1_dict()['leaf_components']['write_set_digest'])])
def test_receipt_verification_with_invalid_leaf_components_throws_exception(input_leaf_components):
    if False:
        while True:
            i = 10
...
@pytest.mark.parametrize('input_node_id', [None, 'invalid_node_id', get_test_valid_receipt_2_dict()['nodeId']])
...
@pytest.mark.parametrize('input_proof_list', [None, [ProofElement()], [ProofElement(right='invalid_node_hash')], [ProofElement(right='invalid_node_hash')], [ProofElement(left='invalid_node_hash', right='invalid_node_hash')]])
def test_receipt_verification_with_invalid_proof_list_throws_exception(input_proof_list):
    if False:
        while True:
            i = 10
    receipt = get_test_valid_receipt_1_dict()
...
def test_receipt_verification_with_invalid_service_endorsements_throws_exception(input_endorsements_list):
    if False:
        i = 10
        return i + 15
    receipt = get_test_valid_receipt_1_dict()
...
def test_receipt_verification_with_invalid_service_cert_throws_exception(input_service_cert):
    if False:
        print('Hello World!')
    with pytest.raises(ValueError):
...
def test_receipt_verification_with_unknown_service_cert_throws_exception(input_service_cert):
    if False:
        while True:
            i = 10
    with pytest.raises(ValueError):
...
def test_receipt_verification_with_unknown_service_endorsements_throws_exception(input_endorsements_list):
    if False:
        return 10
    receipt = get_test_valid_receipt_1_dict()
    receipt['service_endorsements'] = input_endorsements_list
...
def test_receipt_verification_with_unknown_leaf_components_throws_exception(input_leaf_components):
    if False:
        while True:
            i = 10
    receipt = get_test_valid_receipt_1_dict()
...
def test_receipt_verification_with_unknown_proof_list_throws_exception(input_proof_list):
    if False:
        for i in range(10):
            print('nop')
    receipt = get_test_valid_receipt_1_dict()
...
def test_receipt_verification_with_valid_application_claims_returns_successfully(input_receipt, input_service_cert, input_claims):
    ...
    try:
        ...
        pytest.fail(f'verify_receipt threw an exception with a valid receipt, service certificate, and application claims {e}')

@pytest.mark.parametrize('input_receipt,input_service_cert,input_claims', [[get_test_valid_receipt_1_dict(), get_test_valid_service_certificate_1(), get_test_application_claims_with_claim_digest_dict()], [get_test_valid_receipt_2_dict(), get_test_valid_service_certificate_2(), get_test_application_claims_with_ledger_entry_dict()]])
def test_receipt_verification_with_invalid_application_claims_throws_exception(input_receipt, input_service_cert, input_claims):
    if False:
        return 10
    with pytest.raises(ValueError):
        verify_receipt(input_receipt, input_service_cert, application_claims=input_claims)