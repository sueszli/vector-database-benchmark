...
error_msg = ("Error: you're not authenticated or your session has expired.", 'You\'re not authenticated or your session has expired. Please use "login" command for authentication.')
