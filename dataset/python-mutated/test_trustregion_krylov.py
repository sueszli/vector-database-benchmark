...
KrylovQP = get_trlib_quadratic_subproblem(tol_rel_i=1e-08, tol_rel_b=1e-06)
KrylovQP_disp = get_trlib_quadratic_subproblem(tol_rel_i=1e-08, tol_rel_b=1e-06, disp=True)
