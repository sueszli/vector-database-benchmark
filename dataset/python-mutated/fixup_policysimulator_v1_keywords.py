...
class policysimulatorCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_replay': ('parent', 'replay'), 'get_replay': ('name',), 'list_replay_results': ('parent', 'page_size', 'page_token')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=policysimulatorCallTransformer()):
    if False:
        print('Hello World!')
