...
EXPECTED_CAPTIONS = ['a red apple is sitting on a pile of hay', 'a white car parked in a parking lot', 'a cat laying in the grass', 'a blurry photo of a blurry shot of a black object', 'a city with a large building and a clock tower']
