...
comment = f'Merging this PR would result in {pr_passed}/{pr_total} ({passing_percentage:.2f}%) Pandas tests passing, {rate_change_type} in the test pass rate by {pass_rate_change:.2f}%. Trunk stats: {main_passed}/{main_total}.'
