...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='sam_vit_h_4b8939', choices=choices, type=str, help='Path to hf config.json of model to convert')
    ...
    parser.add_argument('--model_hub_id', default='ybelkada/segment-anything', choices=choices, type=str, help='Path to hf config.json of model to convert')
