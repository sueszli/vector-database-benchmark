...
from sentry.api.helpers.group_index import ValidationError, build_query_params_from_request, calculate_stats_period, delete_groups, get_by_short_id, track_slo_response, update_groups
...
class OrganizationGroupIndexEndpoint(OrganizationEventsEndpointBase):
    ...
    rate_limits = {'GET': {RateLimitCategory.IP: RateLimit(10, 1), RateLimitCategory.USER: RateLimit(10, 1), RateLimitCategory.ORGANIZATION: RateLimit(10, 1)}, 'PUT': {RateLimitCategory.IP: RateLimit(5, 5), RateLimitCategory.USER: RateLimit(5, 5), RateLimitCategory.ORGANIZATION: RateLimit(5, 5)}, 'DELETE': {RateLimitCategory.IP: RateLimit(5, 5), RateLimitCategory.USER: RateLimit(5, 5), RateLimitCategory.ORGANIZATION: RateLimit(5, 5)}}
