...
import toml
matcher = re.compile('farm-haystack\\[(.+)\\]')
parser = argparse.ArgumentParser(prog='pyproject_to_requirements.py', description='Convert pyproject.toml to requirements.txt')
