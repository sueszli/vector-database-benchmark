...
class my_top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        parser.add_argument('-F', '--filename', default='audio.dat', help='read input from FILENAME default=%(default)r')
        parser.add_argument('-r', '--sample-rate', type=eng_float, default=48000, help='set sample rate (default=%(default)r)')
