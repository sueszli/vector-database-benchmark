...
import pytest
from fixtures.sdk_crash_detection.crash_event import IN_APP_FRAME, get_crash_event, get_crash_event_with_frames, get_sentry_frame
...
class PerformanceEventTestMixin(BaseSDKCrashDetectionMixin, SnubaTestCase, PerfIssueTransactionTestMixin):
...
@region_silo_test
class SDKCrashDetectionTest(TestCase, CococaSDKTestMixin, CococaSDKFunctionTestMixin, CococaSDKFilenameTestMixin, CococaSDKFramesTestMixin, PerformanceEventTestMixin, SDKCrashReportTestMixin):
