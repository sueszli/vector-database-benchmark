...
from accelerate.commands.launch import ComputeEnvironment, _validate_launch_command, launch_command_parser, prepare_deepspeed_cmd_env, prepare_multi_gpu_env, prepare_simple_launcher_cmd_env
from accelerate.utils import is_deepspeed_available
from packaging.version import Version
if Version(accelerate.__version__) < Version('0.17.0.dev0'):
    raise ImportError(f'AccelerateTrainer requires accelerate>=0.17.0, got {accelerate.__version__}')
