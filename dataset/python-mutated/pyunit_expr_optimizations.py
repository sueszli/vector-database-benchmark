...
__TESTS__ = [test_fold_optimization_append_expr, test_fold_optimization_cbind_expr, test_fold_optimization_append, test_fold_optimization_cbind, test_fold_optimization_rbind_expr, test_skip_optimization_expr, test_skip_optimization_expr_negative, test_skip_optimization]
