...
from polars.datatypes import FLOAT_DTYPES, INTEGER_DTYPES, Date, Datetime, Float64, List, Object, Struct, Time
...
if TYPE_CHECKING:
    ...
    from polars.type_aliases import ColumnFormatDict, ColumnTotalsDefinition, ConditionalFormatDict, OneOrMoreDataTypes, PolarsDataType, RowTotalsDefinition
...
_XL_DEFAULT_DTYPE_FORMATS_: dict[PolarsDataType, str] = {Datetime: 'yyyy-mm-dd hh:mm:ss', Date: 'yyyy-mm-dd;@', Time: 'hh:mm:ss;@'}
