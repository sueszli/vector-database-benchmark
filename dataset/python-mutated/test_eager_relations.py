...
class CyclicalInheritingEagerTestThree(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
    run_create_tables = None
...
class LoadFromJoinedInhWUnion(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    """test for #6595"""
    __dialect__ = 'default'
    run_create_tables = None
...
class EnsureColumnsAddedTest(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
    run_create_tables = None
