...
class TestFindTests(unittest.TestCase):
    ONE_DISABLED_ONE_ENABLED_TEST = {'fake_unittests': {'FakeTest': {'Test1': None, 'DISABLED_Test2': None}}}
    ONE_FAILED_ONE_PASSED_TEST = {'fake_unittests': {'FakeTest': {'FailedTest': None, 'Test': 1}}}
    ONE_TEST = {'fake_unittests': {'FakeTest': {'TestSomething': None}}}
    MULTIPLE_BINARIES_MULTIPLE_TESTS_ONE_FAILURE = {'fake_unittests': {'FakeTest': {'TestSomething': None, 'TestSomethingElse': 2}, 'SomeOtherTest': {'YetAnotherTest': 3}}, 'fake_tests': {'Foo': {'Bar': 4, 'Baz': 4}}}
