...
@pytest.mark.e2e
def test_order_with_the_same_variant_in_multiple_lines_and_overwrite_prices_core_0213(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders):
    if False:
        i = 10
        return i + 15
    ...
    (_product_id, product_variant_id, product_variant_price) = prepare_product(e2e_staff_api_client, warehouse_id, channel_id, variant_price=10)
    ...
    new_price = 9.99
    lines = [{'variantId': product_variant_id, 'quantity': 1, 'price': new_price}, {'variantId': product_variant_id, 'quantity': 1, 'forceNewLine': True}]
    ...
    first_product_variant_price = first_line_product_variant['unitPrice']['gross']['amount']
    assert first_product_variant_price == product_variant_price
    second_product_variant_price = second_line_product_variant['unitPrice']['gross']['amount']
