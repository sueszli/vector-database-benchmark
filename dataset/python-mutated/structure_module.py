...
from modelscope.models.science.unifold.data.residue_constants import restype_atom14_mask, restype_atom14_rigid_group_positions, restype_atom14_to_rigid_group, restype_rigid_group_default_frame
