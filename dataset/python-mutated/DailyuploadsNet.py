...
class DailyuploadsNet(SimpleDownloader):
    ...
    __version__ = '0.01'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?dailyuploads\\.net/\\w+'
    ...
    NAME_PATTERN = '<b>Filename:</b></td><td nowrap>(?P<N>.+?)</td>'
    SIZE_PATTERN = '<b>Size:</b></td><td>.+?<small>\\((?P<S>[\\d.,]+) (?P<U>bytes)\\)</small>'
    OFFLINE_PATTERN = '>File Not Found</'
    LINK_FREE_PATTERN = '<a href="(https?://down\\d+.dailyuploads.net(?::\\d+)?/.+?)">'
