...
file = '{}\\custom_relu_for_model_jit\\custom_relu_for_model_jit.pyd'.format(get_build_directory())
...
custom_module = load(name='custom_relu_for_model_jit', sources=source_files, extra_include_paths=paddle_includes, extra_cxx_cflags=extra_cc_args, extra_cuda_cflags=extra_nvcc_args, verbose=True)
