...
import unittest
import numpy as np
from utils import check_output, check_output_allclose, extra_cc_args, extra_nvcc_args, paddle_includes
import paddle
...
if os.name == 'nt' and os.path.isfile(file):
    cmd = f'del {file}'
    run_cmd(cmd, True)
custom_inplace = load(name='custom_inplace', sources=['custom_inplace.cc'], extra_include_paths=paddle_includes, extra_cxx_cflags=extra_cc_args, extra_cuda_cflags=extra_nvcc_args, verbose=True)
