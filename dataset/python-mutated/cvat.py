...
class CVATImageDatasetImporter(foud.LabeledImageDatasetImporter, foud.ImportPathsMixin):
...
class CVATVideoDatasetImporter(foud.LabeledVideoDatasetImporter, foud.ImportPathsMixin):
...
class CVATImageDatasetExporter(foud.LabeledImageDatasetExporter, foud.ExportPathsMixin):
...
class CVATVideoDatasetExporter(foud.LabeledVideoDatasetExporter, foud.ExportPathsMixin):
