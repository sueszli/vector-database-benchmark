...
from samcli.hook_packages.terraform.hooks.prepare.resources.apigw import _unsupported_reference_field, RESTAPITranslationValidator, _create_gateway_method_integration, _get_reference_from_string_or_intrinsic, _gateway_method_integration_identifier, _find_gateway_integration, add_integrations_to_methods, add_integration_responses_to_methods, _create_gateway_method_integration_response
