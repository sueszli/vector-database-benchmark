...
app.layout = html.Div([html.Div(id='output'), html.Button('click', id='click'), dcc.Store(data='stored', id='stored')])

@callback(Output('output', 'children'), State('stored', 'data'), Input('click', 'n_clicks'), background=True, prevent_initial_call=True)
