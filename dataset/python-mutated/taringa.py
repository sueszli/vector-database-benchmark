...
async def taringa(email, client, out):
    ...
    headers = {'User-Agent': random.choice(ua['browsers']['chrome']), 'Accept': '*/*', 'Accept-Language': 'fr,fr-FR;q=0.8,en-US;q=0.5,en;q=0.3', 'Content-Type': 'application/json; charset=utf-8', 'Origin': 'https://www.taringa.net', 'DNT': '1', 'Connection': 'keep-alive', 'TE': 'Trailers'}
    data = '{"email":"' + email + '"}'
