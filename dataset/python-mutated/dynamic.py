...
example_info = [{'name': 'name', 'label': '姓名', 'required': False, 'default': '广州老广', 'type': 'str'}, {'name': 'age', 'label': '年龄', 'required': False, 'default': 18, 'type': 'int'}]
type_field_map = {'str': serializers.CharField, 'password': serializers.CharField, 'int': serializers.IntegerField, 'bool': serializers.BooleanField, 'text': serializers.CharField, 'choice': serializers.ChoiceField, 'list': serializers.ListField}
