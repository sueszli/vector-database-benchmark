...
from readthedocs.projects.constants import DOWNLOADABLE_MEDIA_TYPES, MEDIA_TYPE_HTMLZIP, MKDOCS, PRIVATE, PUBLIC, SPHINX, SPHINX_HTMLDIR, SPHINX_SINGLEHTML
from readthedocs.projects.models import Domain, Feature, HTMLFile, Project
from readthedocs.redirects.models import Redirect
from readthedocs.rtd_tests.storage import BuildMediaFileSystemStorageTest, StaticFileSystemStorageTest
from readthedocs.subscriptions.constants import TYPE_AUDIT_PAGEVIEWS, TYPE_CNAME
from readthedocs.subscriptions.products import RTDProductFeature
from .base import BaseDocServing

@override_settings(PYTHON_MEDIA=False, PUBLIC_DOMAIN='dev.readthedocs.io', RTD_EXTERNAL_VERSION_DOMAIN='dev.readthedocs.build')
...
@override_settings(PUBLIC_DOMAIN='dev.readthedocs.io', RTD_EXTERNAL_VERSION_DOMAIN='dev.readthedocs.build')
...
@override_settings(PYTHON_MEDIA=False, PUBLIC_DOMAIN='readthedocs.io')
@mock.patch('readthedocs.proxito.views.mixins.build_media_storage', new=BuildMediaFileSystemStorageTest())
@mock.patch('readthedocs.proxito.views.serve.build_media_storage', new=BuildMediaFileSystemStorageTest())
...
@override_settings(ALLOW_PRIVATE_REPOS=True, PUBLIC_DOMAIN='dev.readthedocs.io', PUBLIC_DOMAIN_USES_HTTPS=True, RTD_DEFAULT_FEATURES=dict([RTDProductFeature(type=TYPE_CNAME).to_item()]))
@mock.patch('readthedocs.proxito.views.mixins.staticfiles_storage', new=StaticFileSystemStorageTest())
