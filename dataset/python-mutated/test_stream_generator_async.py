import requests
from azure.core.pipeline.transport import AsyncHttpTransport, AsyncioRequestsTransportResponse, AioHttpTransport
...
async def test_response_streaming_error_behavior(http_response):
    ...
    response = AsyncioRequestsTransportResponse(req_request, req_response, block_size)

    async def mock_run(self, *args, **kwargs):
        return PipelineResponse(None, requests.Response(), None)
