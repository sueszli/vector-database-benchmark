...
DOUBLE_TYPE = {'torch': torch.float64, 'np': np.float64, 'tf2': tf.float64, 'jax': jnp.float64}
FLOAT_TYPE = {'torch': torch.float32, 'np': np.float32, 'tf2': tf.float32, 'jax': jnp.float32}
