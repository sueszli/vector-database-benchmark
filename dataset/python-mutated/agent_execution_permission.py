...
class AgentExecutionPermission(DBBaseModel):
    ...
    def __repr__(self):
        ...
        return f'AgentExecutionPermission(id={self.id}, agent_execution_id={self.agent_execution_id}, agent_id={self.agent_id}, status={self.status}, tool_name={self.tool_name}, question={self.question}, response={self.user_feedback})'