...
class ThisOldHouseIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.thisoldhouse.com/furniture/21017078/how-to-build-a-storage-bench', 'info_dict': {'id': '5dcdddf673c3f956ef5db202', 'ext': 'mp4', 'title': 'How to Build a Storage Bench', 'description': "In the workshop, Tom Silva and Kevin O'Connor build a storage bench for an entryway.", 'timestamp': 1442548800, 'upload_date': '20150918', 'duration': 674, 'view_count': int, 'average_rating': 0, 'thumbnail': 're:^https?://.*\\.jpg\\?\\d+$', 'display_id': 'how-to-build-a-storage-bench'}, 'params': {'skip_download': True}}, {'url': 'https://www.thisoldhouse.com/watch/arlington-arts-crafts-arts-and-crafts-class-begins', 'only_matching': True}, {'url': 'https://www.thisoldhouse.com/tv-episode/ask-toh-shelf-rough-electric', 'only_matching': True}, {'url': 'https://www.thisoldhouse.com/how-to/how-to-build-storage-bench', 'only_matching': True}, {'url': 'https://www.thisoldhouse.com/21113884/s41-e13-paradise-lost', 'only_matching': True}, {'url': 'https://www.thisoldhouse.com/21083431/seaside-transformation-the-westerly-project', 'only_matching': True}]
