...
class DownloaderSlotsSettingsTestSpider(MetaSpider):
    ...
    custom_settings = {'DOWNLOAD_DELAY': 1, 'RANDOMIZE_DOWNLOAD_DELAY': False, 'DOWNLOAD_SLOTS': {'quotes.toscrape.com': {'concurrency': 1, 'delay': 2, 'randomize_delay': False}, 'books.toscrape.com': {'delay': 3, 'randomize_delay': False}}}
