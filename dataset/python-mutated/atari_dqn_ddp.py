...
from ding.framework.middleware import OffPolicyLearner, StepCollector, interaction_evaluator, data_pusher, eps_greedy_handler, CkptSaver, nstep_reward_enhancer, online_logger, ddp_termination_checker
...
def main():
    ...
    with DistContext():
        ...
        with task.start(async_mode=False, ctx=OnlineRLContext()):
            ...
            task.use(ddp_termination_checker(max_env_step=int(10000000.0), rank=rank))
            task.run()
