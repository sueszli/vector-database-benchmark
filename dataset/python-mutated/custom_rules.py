...
from sentry.models.dynamicsampling import CUSTOM_RULE_DATE_FORMAT, CustomDynamicSamplingRule, TooManyRules
...
class CustomRulePermission(BasePermission):
    scope_map = {'GET': ['org:read', 'org:write', 'org:admin', 'project:read', 'project:write', 'project:admin'], 'POST': ['org:read', 'org:write', 'org:admin', 'project:read', 'project:write', 'project:admin']}

@region_silo_endpoint
class CustomRulesEndpoint(OrganizationEndpoint):
    permission_classes = (CustomRulePermission,)
    owner = ApiOwner.TELEMETRY_EXPERIENCE
    publish_status = {'POST': ApiPublishStatus.EXPERIMENTAL, 'GET': ApiPublishStatus.EXPERIMENTAL}
