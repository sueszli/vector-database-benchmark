...
class MultiplyNumericBoolean(TransformPrimitive):
    ...
    input_types = [[ColumnSchema(semantic_tags={'numeric'}), ColumnSchema(logical_type=Boolean)], [ColumnSchema(semantic_tags={'numeric'}), ColumnSchema(logical_type=BooleanNullable)], [ColumnSchema(logical_type=Boolean), ColumnSchema(semantic_tags={'numeric'})], [ColumnSchema(logical_type=BooleanNullable), ColumnSchema(semantic_tags={'numeric'})]]
