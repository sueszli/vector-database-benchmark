...
from modelscope.models.cv.video_deinterlace.UNet_for_video_deinterlace import UNetForVideoDeinterlace
...
@PIPELINES.register_module(Tasks.video_deinterlace, module_name=Pipelines.video_deinterlace)
