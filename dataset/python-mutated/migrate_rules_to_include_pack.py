...
class Migration(object):
    ...
    class RuleDB(stormbase.StormFoundationDB, stormbase.TagsMixin, stormbase.ContentPackResourceMixin):
        ...
        enabled = me.BooleanField(required=True, default=True, help_text='Flag indicating whether the rule is enabled.')
