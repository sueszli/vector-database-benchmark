...
class BadStringsConstantsDict(TypedDict):
    ...
    message: str
    excluded_files: Tuple[str, ...]
EXCLUDED_PATHS: Final = ('third_party/*', 'build/*', '.git/*', '*.pyc', 'CHANGELOG', 'integrations/*', 'integrations_dev/*', '*.svg', '*.gif', '*.png', '*.webp', '*.zip', '*.ico', '*.jpg', '*.min.js', 'backend_prod_files/*', 'assets/scripts/*', 'core/domain/proto/*.py', 'core/tests/data/*', 'core/tests/build_sources/*', '*.mp3', '*.mp4', 'node_modules/*', 'typings/*', 'local_compiled_js/*', 'webpack_bundles/*', 'core/tests/services_sources/*', 'core/tests/release_sources/tmp_unzip.zip', 'scripts/linters/test_files/*', 'proto_files/*', 'core/tests/release_sources/tmp_unzip.tar.gz', 'core/templates/combined-tests.spec.ts', 'core/templates/css/oppia-material.css', 'core/templates/google-analytics.initializer.ts', 'extensions/classifiers/proto/*', '%s/*' % js_ts_linter.COMPILED_TYPESCRIPT_TMP_PATH)
GENERATED_FILE_PATHS: Final = ('core/templates/expressions/parser.js',)
CONFIG_FILE_PATHS: Final = ('core/tests/.browserstack.env.example', 'core/tests/wdio.conf.js', 'core/tests/karma.conf.ts', 'core/templates/mathjaxConfig.ts', 'assets/constants.ts', 'assets/rich_text_components_definitions.ts', 'webpack.config.ts', 'webpack.dev.config.ts', 'webpack.prod.config.ts')
BAD_STRINGS_CONSTANTS: Dict[str, BadStringsConstantsDict] = {'"DEV_MODE": false': {'message': 'Please set the DEV_MODE variable in constants.ts to true before committing.', 'excluded_files': ()}, '"EMULATOR_MODE": false': {'message': 'Please set the EMULATOR_MODE variable in constants.ts to true before committing.', 'excluded_files': ()}}
BAD_PATTERNS: Dict[str, BadPatternsDict] = {'\t': {'message': 'Please use spaces instead of tabs.', 'excluded_files': ('Makefile',), 'excluded_dirs': ('assets/i18n/', 'core/tests/build_sources/assets/')}, '\r': {'message': 'Please make sure all files only have LF endings (no CRLF).', 'excluded_files': (), 'excluded_dirs': ()}, '<<<<<<<': {'message': 'Please fully resolve existing merge conflicts.', 'excluded_files': (), 'excluded_dirs': ()}, '>>>>>>>': {'message': 'Please fully resolve existing merge conflicts.', 'excluded_files': (), 'excluded_dirs': ()}, 'glyphicon': {'message': 'Please use equivalent material-icons instead of glyphicons.', 'excluded_files': (), 'excluded_dirs': ()}}
BAD_PATTERNS_REGEXP: List[BadPatternRegexpDict] = [{'regexp': re.compile('TODO[^\\(]*[^\\)][^:]*[^A-Z]+[^\\w]*$'), 'message': 'Please link TODO comments to an issue in the format TODO(#issuenum): XXX. ', 'excluded_files': (), 'excluded_dirs': ()}]
MANDATORY_PATTERNS_REGEXP: List[MandatoryPatternsRegexpDict] = [{'regexp': re.compile('Copyright \\d{4} The Oppia Authors\\. All Rights Reserved\\.'), 'message': 'Please ensure this file should contain a proper copyright notice.', 'included_types': ('.py', '.js', '.sh', '.ts'), 'excluded_files': GENERATED_FILE_PATHS + CONFIG_FILE_PATHS + ('__init__.py',), 'excluded_dirs': EXCLUDED_PATHS}, {'regexp': re.compile('from __future__ import annotations'), 'message': 'Please ensure this file should contain annotations future import.', 'included_types': ('.py',), 'excluded_files': GENERATED_FILE_PATHS + CONFIG_FILE_PATHS + ('__init__.py',), 'excluded_dirs': EXCLUDED_PATHS}]
MANDATORY_PATTERNS_JS_REGEXP: List[MandatoryPatternsRegexpDict] = [{'regexp': re.compile('^\\s\\*\\s@fileoverview\\s[a-zA-Z0-9_]+'), 'message': 'Please ensure this file should contain a file overview i.e. a short description of the file.', 'included_types': ('.js', '.ts'), 'excluded_files': GENERATED_FILE_PATHS + CONFIG_FILE_PATHS, 'excluded_dirs': EXCLUDED_PATHS}]
BAD_LINE_PATTERNS_HTML_REGEXP: List[BadPatternRegexpDict] = [{'regexp': re.compile('text\\/ng-template'), 'message': 'The directives must be directly referenced.', 'excluded_files': (), 'excluded_dirs': ('extensions/answer_summarizers/', 'extensions/classifiers/', 'extensions/objects/', 'extensions/value_generators/')}, {'regexp': re.compile('[ \\t]+$'), 'message': 'There should not be any trailing whitespaces.', 'excluded_files': (), 'excluded_dirs': ()}, {'regexp': re.compile('\\$parent'), 'message': 'Please do not access parent properties ' + 'using $parent. Use the scope object ' + 'for this purpose.', 'excluded_files': (), 'excluded_dirs': ()}, {'regexp': re.compile('\\s+style\\s*=\\s*'), 'message': 'Please do not use inline styling.', 'excluded_files': (), 'excluded_dirs': ()}]
BAD_PATTERNS_PYTHON_REGEXP: List[BadPatternRegexpDict] = [{'regexp': re.compile('__author__'), 'message': 'Please remove author tags from this file.', 'excluded_files': (), 'excluded_dirs': ()}, {'regexp': re.compile('ndb\\.'), 'message': 'Please use datastore_services instead of ndb, for example:\n\ndatastore_services = models.Registry.import_datastore_services()\n\nclass SampleModel(datastore_services.Model):\n    ...\n', 'excluded_files': (), 'excluded_dirs': ('core/platform',)}, {'regexp': re.compile('\\Wprint\\('), 'message': 'Please do not use print statement.', 'excluded_files': ('core/tests/test_utils.py', 'core/tests/performance_framework/perf_domain.py', 'core/tests/test_utils_test.py'), 'excluded_dirs': ('scripts/',)}, {'regexp': re.compile('# pylint:\\s*disable=[A-Z][0-9]{4}'), 'message': 'Please remove pylint exclusion if it is unnecessary, or make it human readable with a sentence instead of an id. The id-to-message list can be seen here->http://pylint-messages.wikidot.com/all-codes', 'excluded_files': (), 'excluded_dirs': ()}, {'regexp': re.compile('urlretrieve\\('), 'message': 'Please use scripts.common.url_retrieve instead of urllib.request.urlretrieve.', 'excluded_files': (), 'excluded_dirs': ('assets/', 'core/', 'data/', 'extensions/', 'jobs/')}]
BAD_PATTERNS_MAP: Dict[str, List[BadPatternRegexpDict]] = {'.html': BAD_LINE_PATTERNS_HTML_REGEXP, '.py': BAD_PATTERNS_PYTHON_REGEXP}
