...
tf.app.flags.DEFINE_string('data_folder', 'DAVIS2017/', 'Folder containing the DAVIS 2017 data')
tf.app.flags.DEFINE_string('imageset', 'val', 'Which subset to use, either train or val')
tf.app.flags.DEFINE_string('output_dir', './tfrecord', 'Path to save converted TFRecords of TensorFlow examples.')
