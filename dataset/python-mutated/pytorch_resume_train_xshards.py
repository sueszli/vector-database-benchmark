...
train_stats = est.fit(train_data, epochs=2, batch_size=10240, feature_cols=get_feature_cols(), label_cols=get_label_cols(), validation_data=test_data, callbacks=callbacks)
print('Train results:')
