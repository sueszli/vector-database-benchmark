...
import sys
import numpy as np
from numpy.testing import assert_array_equal, assert_allclose, assert_equal, assert_, suppress_warnings
import pytest
from pytest import raises as assert_raises
from scipy.cluster.vq import kmeans, kmeans2, py_vq, vq, whiten, ClusterError, _krandinit
from scipy.cluster import _vq
from scipy.conftest import array_api_compatible, skip_if_array_api, skip_if_array_api_gpu
from scipy.sparse._sputils import matrix
from scipy._lib._array_api import SCIPY_ARRAY_API, copy, cov, xp_assert_close, xp_assert_equal
...
CODET1 = np.array([[3.0, 3.0], [6.2, 4.0], [5.8, 1.8]])
CODET2 = np.array([[11.0 / 3, 8.0 / 3], [6.75, 4.25], [6.25, 1.75]])
