...
@parameterized_class(('template_path',), [('/testdata/start_api/cdk/template-rest-api.yaml',), ('/testdata/start_api/cdk/template-open-api.yaml',), ('/testdata/start_api/cdk/template-http-api.yaml',)])
