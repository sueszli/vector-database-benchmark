...
from sentry.apidocs.constants import RESPONSE_BAD_REQUEST, RESPONSE_FORBIDDEN, RESPONSE_NOT_FOUND, RESPONSE_UNAUTHORIZED
from sentry.apidocs.parameters import GlobalParams, OrganizationParams
from sentry.apidocs.utils import inline_sentry_response_serializer
from sentry.db.models.query import in_iexact
from sentry.models.environment import Environment
from sentry.models.organization import Organization
from sentry.monitors.models import Monitor, MonitorEnvironment, MonitorLimitsExceeded, MonitorObjectStatus, MonitorStatus, MonitorType
...
DEFAULT_ORDERING = [MonitorStatus.ERROR, MonitorStatus.TIMEOUT, MonitorStatus.MISSED_CHECKIN, MonitorStatus.OK, MonitorStatus.ACTIVE, MonitorStatus.DISABLED]
MONITOR_ENVIRONMENT_ORDERING = Case(*[When(status=s, then=Value(i)) for (i, s) in enumerate(DEFAULT_ORDERING)], output_field=IntegerField())
