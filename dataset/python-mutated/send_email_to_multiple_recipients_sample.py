...
class EmailMultipleRecipientSample(object):
    ...
    def send_email_to_multiple_recipients(self):
        ...
        message = {'content': {'subject': 'This is the subject', 'plainText': 'This is the body', 'html': 'html><h1>This is the body</h1></html>'}, 'recipients': {'to': [{'address': self.recipient_address, 'displayName': 'Customer Name'}, {'address': self.second_recipient_address, 'displayName': 'Customer Name 2'}], 'cc': [{'address': self.recipient_address, 'displayName': 'Customer Name'}, {'address': self.second_recipient_address, 'displayName': 'Customer Name 2'}], 'bcc': [{'address': self.recipient_address, 'displayName': 'Customer Name'}, {'address': self.second_recipient_address, 'displayName': 'Customer Name 2'}]}, 'senderAddress': self.sender_address}
        try:
