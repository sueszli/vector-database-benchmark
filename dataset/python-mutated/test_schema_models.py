...
class TestSchemaWithFewNullables:
    EXPECTED_SCHEMA = {'type': 'object', 'properties': {'name': {'type': ['null', 'string']}, 'optional_item': {'oneOf': [{'type': 'null'}, {'type': 'object', 'properties': {'field1': {'type': ['null', 'string']}, 'field2': {'type': 'integer'}}}]}, 'items': {'type': 'array', 'items': {'type': 'object', 'properties': {'field1': {'type': ['null', 'string']}, 'field2': {'type': 'integer'}}}}}}
...
class TestSchemaWithAllOptional:
    EXPECTED_SCHEMA = {'type': 'object', 'properties': {'object_id': {'type': ['null', 'integer']}, 'item': {'oneOf': [{'type': 'null'}, {'type': 'object', 'properties': {'field1': {'type': ['null', 'string']}, 'field2': {'type': 'integer'}}}]}}}
