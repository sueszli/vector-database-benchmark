...
from .utils import execute_docker_build, execute_docker_push, execute_docker_tag, python_version_image_tag
...
class DagsterDockerImage(NamedTuple('_DagsterDockerImage', [('image', str), ('images_path', str), ('build_cm', Callable)])):
