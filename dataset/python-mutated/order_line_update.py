...
from ....order.utils import change_order_line_quantity, invalidate_order_prices, recalculate_order_weight
...
class OrderLineUpdate(EditableOrderValidationMixin, ModelWithRestrictedChannelAccessMutation):
    ...
    class Arguments:
        ...
        input = OrderLineInput(required=True, description='Fields required to update an order line.')
