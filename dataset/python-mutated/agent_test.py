...
async def test_create_task(agent):
    task_request = TaskRequestBody(input='test_input', additional_input={'input': 'additional_test_input'})
...
async def test_create_and_execute_step(agent):
    task_request = TaskRequestBody(input='test_input', additional_input={'input': 'additional_test_input'})
    task = await agent.create_task(task_request)
    step_request = StepRequestBody(input='step_input', additional_input={'input': 'additional_test_input'})
