...
def upgrade():
    ...
    if skip_based_on_legacy_engine_version(op, __name__):
        return
    op.create_index('idx_activity_user_id', 'activity', ['user_id', 'timestamp'])
    op.create_index('idx_activity_object_id', 'activity', ['object_id', 'timestamp'])
    op.create_index('idx_activity_detail_activity_id', 'activity_detail', ['activity_id'])
