...
def upgrade() -> None:
    if False:
        i = 10
        return i + 15
    op.create_table('events', sa.Column('created_at', sa.DateTime(), nullable=True), sa.Column('updated_at', sa.DateTime(), nullable=True), sa.Column('id', sa.Integer(), nullable=False), sa.Column('event_name', sa.String(), nullable=False), sa.Column('event_value', sa.Integer(), nullable=False), sa.Column('event_property', postgresql.JSONB(astext_type=sa.Text()), nullable=True), sa.Column('agent_id', sa.Integer(), nullable=True), sa.Column('org_id', sa.Integer(), nullable=True), sa.PrimaryKeyConstraint('id'))
