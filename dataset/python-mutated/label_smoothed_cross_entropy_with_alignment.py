...
@dataclass
class LabelSmoothedCrossEntropyCriterionWithAlignmentConfig(LabelSmoothedCrossEntropyCriterionConfig):
    alignment_lambda: float = field(default=0.05, metadata={'help': 'weight for the alignment loss'})

@register_criterion('label_smoothed_cross_entropy_with_alignment', dataclass=LabelSmoothedCrossEntropyCriterionWithAlignmentConfig)
