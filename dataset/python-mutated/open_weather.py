...
class OpenWeather(GenPollUrl):
    ...
    """
    symbols = {'Unknown': '✨', '01d': '☀️', '01n': '🌕', '02d': '🌤️', '02n': '☁️', '03d': '🌥️', '03n': '☁️', '04d': '☁️', '04n': '☁️', '09d': '🌧️', '09n': '🌧️', '10d': '⛈', '10n': '⛈', '11d': '🌩', '11n': '🌩', '13d': '❄️', '13n': '❄️', '50d': '🌫', '50n': '🌫'}
    defaults: list[tuple[str, Any, str]] = [('app_key', DEFAULT_APP_ID, 'Open Weather access key. A default is provided, but\n            for prolonged use obtaining your own is suggested:\n            https://home.openweathermap.org/users/sign_up'), ('cityid', None, 'City ID. Can be looked up on e.g.:\n            https://openweathermap.org/find\n            Takes precedence over location and coordinates.\n            Note that this is not equal to a WOEID.'), ('location', None, 'Name of the city. Country name can be appended\n            like cambridge,NZ. Takes precedence over zip-code.'), ('zip', None, 'Zip code (USA) or "zip code,country code" for\n            other countries. E.g. 12345,NZ. Takes precedence over\n            coordinates.'), ('coordinates', None, 'Dictionary containing latitude and longitude\n               Example: coordinates={"longitude": "77.22",\n                                     "latitude": "28.67"}'), ('format', '{location_city}: {main_temp} °{units_temperature} {humidity}% {weather_details}', 'Display format'), ('metric', True, 'True to use metric/C, False to use imperial/F'), ('dateformat', '%Y-%m-%d ', 'Format for dates, defaults to ISO.\n            For details see: https://docs.python.org/3/library/time.html#time.strftime'), ('timeformat', '%H:%M', 'Format for times, defaults to ISO.\n            For details see: https://docs.python.org/3/library/time.html#time.strftime'), ('language', 'en', 'Language of response. List of languages supported can\n         be seen at: https://openweathermap.org/current under\n         Multilingual support'), ('weather_symbols', dict(), 'Dictionary of weather symbols. Can be used to override default symbols.')]
