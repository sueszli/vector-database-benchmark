...
import numpy as np
from torch.testing._internal.autograd_function_db import sample_inputs_numpy_cube, sample_inputs_numpy_mul, sample_inputs_numpy_sort, sample_inputs_numpy_take
