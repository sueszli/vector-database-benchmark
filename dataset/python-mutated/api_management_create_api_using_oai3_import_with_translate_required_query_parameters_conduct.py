...
def main():
    ...
    response = client.api.begin_create_or_update(resource_group_name='rg1', service_name='apimService1', api_id='petstore', parameters={'properties': {'format': 'openapi-link', 'path': 'petstore', 'translateRequiredQueryParameters': 'template', 'value': 'https://raw.githubusercontent.com/OAI/OpenAPI-Specification/master/examples/v3.0/petstore.yaml'}}).result()
    print(response)
