...
from mage_ai.data_preparation.models.block.data_integration.utils import discover, get_selected_streams, update_metadata_in_stream

class IntegrationSourcePresenter(BasePresenter):
    default_attributes = ['name', 'templates', 'uuid']
    ...
    def present(self, **kwargs):
        ...
        return self.model
IntegrationSourcePresenter.register_format(constants.CREATE, ['error_message', 'streams', 'success'])
IntegrationSourcePresenter.register_format(constants.UPDATE, ['selected_streams', 'streams', 'uuid'])