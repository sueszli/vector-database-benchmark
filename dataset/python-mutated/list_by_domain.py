...
def main():
    ...
    response = client.sender_usernames.list_by_domains(resource_group_name='contosoResourceGroup', email_service_name='contosoEmailService', domain_name='contoso.com')
