...
@pytest.mark.parametrize('client_class,transport_name', [(MetricServiceClient, 'grpc'), (MetricServiceAsyncClient, 'grpc_asyncio')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.MetricServiceGrpcTransport, 'grpc'), (transports.MetricServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
def test_metric_service_client_get_transport_class():
    ...
    available_transports = [transports.MetricServiceGrpcTransport]
    assert transport in available_transports
    transport = MetricServiceClient.get_transport_class('grpc')
    assert transport == transports.MetricServiceGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(MetricServiceClient, transports.MetricServiceGrpcTransport, 'grpc'), (MetricServiceAsyncClient, transports.MetricServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(MetricServiceClient, transports.MetricServiceGrpcTransport, 'grpc', grpc_helpers), (MetricServiceAsyncClient, transports.MetricServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
@pytest.mark.parametrize('request_type', [metric_service.ListMonitoredResourceDescriptorsRequest, dict])
def test_list_monitored_resource_descriptors(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_monitored_resource_descriptors), '__call__') as call:
        call.return_value = metric_service.ListMonitoredResourceDescriptorsResponse(next_page_token='next_page_token_value')
...
async def test_list_monitored_resource_descriptors_async(transport: str='grpc_asyncio', request_type=metric_service.ListMonitoredResourceDescriptorsRequest):
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_monitored_resource_descriptors), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_service.ListMonitoredResourceDescriptorsResponse(next_page_token='next_page_token_value'))
...
def test_list_monitored_resource_descriptors_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_monitored_resource_descriptors(metric_service.ListMonitoredResourceDescriptorsRequest(), name='name_value')
...
@pytest.mark.parametrize('request_type', [metric_service.GetMonitoredResourceDescriptorRequest, dict])
def test_get_monitored_resource_descriptor(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_monitored_resource_descriptor), '__call__') as call:
        call.return_value = monitored_resource_pb2.MonitoredResourceDescriptor(name='name_value', type='type_value', display_name='display_name_value', description='description_value', launch_stage=launch_stage_pb2.LaunchStage.UNIMPLEMENTED)
...
async def test_get_monitored_resource_descriptor_async(transport: str='grpc_asyncio', request_type=metric_service.GetMonitoredResourceDescriptorRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_monitored_resource_descriptor), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(monitored_resource_pb2.MonitoredResourceDescriptor(name='name_value', type='type_value', display_name='display_name_value', description='description_value', launch_stage=launch_stage_pb2.LaunchStage.UNIMPLEMENTED))
...
def test_get_monitored_resource_descriptor_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_monitored_resource_descriptor(metric_service.GetMonitoredResourceDescriptorRequest(), name='name_value')
...
async def test_get_monitored_resource_descriptor_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_monitored_resource_descriptor(metric_service.GetMonitoredResourceDescriptorRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [metric_service.ListMetricDescriptorsRequest, dict])
def test_list_metric_descriptors(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_metric_descriptors), '__call__') as call:
        call.return_value = metric_service.ListMetricDescriptorsResponse(next_page_token='next_page_token_value')
...
async def test_list_metric_descriptors_async(transport: str='grpc_asyncio', request_type=metric_service.ListMetricDescriptorsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_metric_descriptors), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_service.ListMetricDescriptorsResponse(next_page_token='next_page_token_value'))
...
def test_list_metric_descriptors_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_metric_descriptors(metric_service.ListMetricDescriptorsRequest(), name='name_value')
...
async def test_list_metric_descriptors_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_metric_descriptors(metric_service.ListMetricDescriptorsRequest(), name='name_value')
...
def test_list_metric_descriptors_pager(transport_name: str='grpc'):
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_metric_descriptors), '__call__') as call:
        call.side_effect = (metric_service.ListMetricDescriptorsResponse(metric_descriptors=[metric_pb2.MetricDescriptor(), metric_pb2.MetricDescriptor(), metric_pb2.MetricDescriptor()], next_page_token='abc'), metric_service.ListMetricDescriptorsResponse(metric_descriptors=[], next_page_token='def'), metric_service.ListMetricDescriptorsResponse(metric_descriptors=[metric_pb2.MetricDescriptor()], next_page_token='ghi'), metric_service.ListMetricDescriptorsResponse(metric_descriptors=[metric_pb2.MetricDescriptor(), metric_pb2.MetricDescriptor()]), RuntimeError)
        metadata = ()
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('name', ''),)),)
...
@pytest.mark.parametrize('request_type', [metric_service.GetMetricDescriptorRequest, dict])
...
async def test_get_metric_descriptor_async(transport: str='grpc_asyncio', request_type=metric_service.GetMetricDescriptorRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_metric_descriptor), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_pb2.MetricDescriptor(name='name_value', type='type_value', metric_kind=metric_pb2.MetricDescriptor.MetricKind.GAUGE, value_type=metric_pb2.MetricDescriptor.ValueType.BOOL, unit='unit_value', description='description_value', display_name='display_name_value', launch_stage=launch_stage_pb2.LaunchStage.UNIMPLEMENTED, monitored_resource_types=['monitored_resource_types_value']))
...
def test_get_metric_descriptor_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_metric_descriptor(metric_service.GetMetricDescriptorRequest(), name='name_value')
...
async def test_get_metric_descriptor_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_metric_descriptor(metric_service.GetMetricDescriptorRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [metric_service.CreateMetricDescriptorRequest, dict])
...
def test_create_metric_descriptor_flattened():
    ...
    with mock.patch.object(type(client.transport.create_metric_descriptor), '__call__') as call:
        call.return_value = metric_pb2.MetricDescriptor()
        client.create_metric_descriptor(name='name_value', metric_descriptor=metric_pb2.MetricDescriptor(name='name_value'))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_create_metric_descriptor_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_metric_descriptor(metric_service.CreateMetricDescriptorRequest(), name='name_value', metric_descriptor=metric_pb2.MetricDescriptor(name='name_value'))
...
async def test_create_metric_descriptor_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_metric_descriptor), '__call__') as call:
        call.return_value = metric_pb2.MetricDescriptor()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_pb2.MetricDescriptor())
        response = await client.create_metric_descriptor(name='name_value', metric_descriptor=metric_pb2.MetricDescriptor(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_create_metric_descriptor_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_metric_descriptor(metric_service.CreateMetricDescriptorRequest(), name='name_value', metric_descriptor=metric_pb2.MetricDescriptor(name='name_value'))

@pytest.mark.parametrize('request_type', [metric_service.DeleteMetricDescriptorRequest, dict])
...
def test_delete_metric_descriptor_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_metric_descriptor(metric_service.DeleteMetricDescriptorRequest(), name='name_value')
...
async def test_delete_metric_descriptor_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_metric_descriptor(metric_service.DeleteMetricDescriptorRequest(), name='name_value')
...
def test_list_time_series(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_time_series), '__call__') as call:
        call.return_value = metric_service.ListTimeSeriesResponse(next_page_token='next_page_token_value', unit='unit_value')
...
async def test_list_time_series_async(transport: str='grpc_asyncio', request_type=metric_service.ListTimeSeriesRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_time_series), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_service.ListTimeSeriesResponse(next_page_token='next_page_token_value', unit='unit_value'))
...
def test_list_time_series_flattened():
    ...
    with mock.patch.object(type(client.transport.list_time_series), '__call__') as call:
        call.return_value = metric_service.ListTimeSeriesResponse()
        client.list_time_series(name='name_value', filter='filter_value', interval=common.TimeInterval(end_time=timestamp_pb2.Timestamp(seconds=751)), view=metric_service.ListTimeSeriesRequest.TimeSeriesView.HEADERS)
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_list_time_series_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_time_series(metric_service.ListTimeSeriesRequest(), name='name_value', filter='filter_value', interval=common.TimeInterval(end_time=timestamp_pb2.Timestamp(seconds=751)), view=metric_service.ListTimeSeriesRequest.TimeSeriesView.HEADERS)
...
async def test_list_time_series_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_time_series), '__call__') as call:
        call.return_value = metric_service.ListTimeSeriesResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(metric_service.ListTimeSeriesResponse())
        response = await client.list_time_series(name='name_value', filter='filter_value', interval=common.TimeInterval(end_time=timestamp_pb2.Timestamp(seconds=751)), view=metric_service.ListTimeSeriesRequest.TimeSeriesView.HEADERS)
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_list_time_series_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_time_series(metric_service.ListTimeSeriesRequest(), name='name_value', filter='filter_value', interval=common.TimeInterval(end_time=timestamp_pb2.Timestamp(seconds=751)), view=metric_service.ListTimeSeriesRequest.TimeSeriesView.HEADERS)
...
@pytest.mark.parametrize('request_type', [metric_service.CreateTimeSeriesRequest, dict])
...
def test_create_time_series_flattened():
    ...
    with mock.patch.object(type(client.transport.create_time_series), '__call__') as call:
        call.return_value = None
        client.create_time_series(name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_create_time_series_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_time_series(metric_service.CreateTimeSeriesRequest(), name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
...
async def test_create_time_series_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_time_series), '__call__') as call:
        call.return_value = None
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.create_time_series(name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_create_time_series_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_time_series(metric_service.CreateTimeSeriesRequest(), name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
...
def test_create_service_time_series_flattened():
    ...
    with mock.patch.object(type(client.transport.create_service_time_series), '__call__') as call:
        call.return_value = None
        client.create_service_time_series(name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
def test_create_service_time_series_flattened_error():
    ...
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_service_time_series(metric_service.CreateTimeSeriesRequest(), name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
...
async def test_create_service_time_series_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_service_time_series), '__call__') as call:
        call.return_value = None
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(None)
        response = await client.create_service_time_series(name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_create_service_time_series_flattened_error_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_service_time_series(metric_service.CreateTimeSeriesRequest(), name='name_value', time_series=[gm_metric.TimeSeries(metric=metric_pb2.Metric(type='type_value'))])

def test_credentials_transport_error():
    if False:
        for i in range(10):
            print('nop')
    transport = transports.MetricServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.MetricServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MetricServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.MetricServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.MetricServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MetricServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.MetricServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = MetricServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_metric_service_base_transport():
    ...
    with mock.patch('google.cloud.monitoring_v3.services.metric_service.transports.MetricServiceTransport.__init__') as Transport:
        ...
        transport = transports.MetricServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_monitored_resource_descriptors', 'get_monitored_resource_descriptor', 'list_metric_descriptors', 'get_metric_descriptor', 'create_metric_descriptor', 'delete_metric_descriptor', 'list_time_series', 'create_time_series', 'create_service_time_series')
...
def test_metric_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.monitoring_v3.services.metric_service.transports.MetricServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.MetricServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.MetricServiceGrpcTransport, grpc_helpers), (transports.MetricServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_metric_service_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='monitoring.googleapis.com'), transport=transport_name)
    assert client.transport._host == 'monitoring.googleapis.com:443'
...
def test_metric_service_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='monitoring.googleapis.com:8000'), transport=transport_name)
...
def test_metric_service_grpc_transport_channel():
    ...
    transport = transports.MetricServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_metric_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.MetricServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_parse_monitored_resource_descriptor_path():
    if False:
        while True:
            i = 10
    expected = {'project': 'cuttlefish', 'monitored_resource_descriptor': 'mussel'}
...
def test_parse_time_series_path():
    if False:
        print('Hello World!')
    expected = {'project': 'scallop', 'time_series': 'abalone'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MetricServiceTransport, '_prep_wrapped_messages') as prep:
        client = MetricServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = MetricServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(MetricServiceClient, transports.MetricServiceGrpcTransport), (MetricServiceAsyncClient, transports.MetricServiceGrpcAsyncIOTransport)])
