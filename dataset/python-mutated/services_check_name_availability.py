...
def main():
    ...
    response = client.services.check_name_availability(location='eastus', parameters={'name': 'DmsSdkService', 'type': 'services'})
    print(response)
