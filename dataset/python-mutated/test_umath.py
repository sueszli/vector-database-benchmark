...
import numpy as np
from numpy.testing import assert_, assert_equal, assert_raises, assert_raises_regex, assert_array_equal, assert_almost_equal, assert_array_almost_equal, assert_array_max_ulp, assert_allclose, assert_no_warnings, suppress_warnings, _gen_alignment_data, assert_array_almost_equal_nulp, IS_WASM, IS_MUSL, IS_PYPY
...
avx_ufuncs = {'sqrt': [1, 0.0, 100.0], 'absolute': [0, -100.0, 100.0], 'reciprocal': [1, 1.0, 100.0], 'square': [1, -100.0, 100.0], 'rint': [0, -100.0, 100.0], 'floor': [0, -100.0, 100.0], 'ceil': [0, -100.0, 100.0], 'trunc': [0, -100.0, 100.0]}
...
class TestBitwiseUFuncs:
    ...
    bitwise_bits = [2, *_all_ints_bits, max(_all_ints_bits) + 1]
