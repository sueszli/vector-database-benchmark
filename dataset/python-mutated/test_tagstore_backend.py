...
from sentry.search.events.constants import RELEASE_STAGE_ALIAS, SEMVER_ALIAS, SEMVER_BUILD_ALIAS, SEMVER_PACKAGE_ALIAS
from sentry.tagstore.exceptions import GroupTagKeyNotFound, GroupTagValueNotFound, TagKeyNotFound, TagValueNotFound
...
exception = {'values': [{'type': 'ValidationError', 'value': 'Bad request', 'stacktrace': {'frames': [{'function': '?', 'filename': 'http://localhost:1337/error.js', 'lineno': 29, 'colno': 3, 'in_app': False}]}}]}
