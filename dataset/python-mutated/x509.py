...
class RSAPrivateKey(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_enum_INTEGER('version', 0, ['two-prime', 'multi']), ASN1F_INTEGER('modulus', 10), ASN1F_INTEGER('publicExponent', 3), ASN1F_INTEGER('privateExponent', 3), ASN1F_INTEGER('prime1', 2), ASN1F_INTEGER('prime2', 5), ASN1F_INTEGER('exponent1', 0), ASN1F_INTEGER('exponent2', 3), ASN1F_INTEGER('coefficient', 1), ASN1F_optional(ASN1F_SEQUENCE_OF('otherPrimeInfos', None, RSAOtherPrimeInfo)))
...
class ECSpecifiedDomain(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_enum_INTEGER('version', 1, {1: 'ecpVer1'}), ASN1F_PACKET('fieldID', ECFieldID(), ECFieldID), ASN1F_PACKET('curve', ECCurve(), ECCurve), ASN1F_STRING('base', ''), ASN1F_INTEGER('order', 0), ASN1F_optional(ASN1F_INTEGER('cofactor', None)))

class ECParameters(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('curve', ASN1_OID('ansip384r1'), ASN1F_OID, ASN1F_NULL, ECSpecifiedDomain)
...
class ECDSAPrivateKey(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_enum_INTEGER('version', 1, {1: 'ecPrivkeyVer1'}), ASN1F_STRING('privateKey', ''), ASN1F_optional(ASN1F_PACKET('parameters', None, ECParameters, explicit_tag=160)), ASN1F_optional(ASN1F_PACKET('publicKey', None, ECDSAPublicKey, explicit_tag=161)))
...
class X509_OtherName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('type_id', '0'), ASN1F_CHOICE('value', None, ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING, explicit_tag=160))
...
_default_directoryName = [X509_RDN(), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Name'))])]
...
class X509_EDIPartyName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_X509_DirectoryString('nameAssigner', None, explicit_tag=160)), ASN1F_X509_DirectoryString('partyName', None, explicit_tag=161))
...
class X509_GeneralName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('generalName', X509_DirectoryName(), ASN1F_PACKET('otherName', None, X509_OtherName, implicit_tag=160), ASN1F_PACKET('rfc822Name', None, X509_RFC822Name, implicit_tag=129), ASN1F_PACKET('dNSName', None, X509_DNSName, implicit_tag=130), ASN1F_PACKET('x400Address', None, X509_X400Address, explicit_tag=163), ASN1F_PACKET('directoryName', None, X509_DirectoryName, explicit_tag=164), ASN1F_PACKET('ediPartyName', None, X509_EDIPartyName, explicit_tag=165), ASN1F_PACKET('uniformResourceIdentifier', None, X509_URI, implicit_tag=134), ASN1F_PACKET('ipAddress', None, X509_IPAddress, implicit_tag=135), ASN1F_PACKET('registeredID', None, X509_RegisteredID, implicit_tag=136))

class X509_ExtAuthorityKeyIdentifier(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_STRING('keyIdentifier', b'\xff' * 20, implicit_tag=128)), ASN1F_optional(ASN1F_SEQUENCE_OF('authorityCertIssuer', None, X509_GeneralName, implicit_tag=161)), ASN1F_optional(ASN1F_INTEGER('authorityCertSerialNumber', None, implicit_tag=130)))
...
class X509_ExtFullName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('fullName', [X509_GeneralName()], X509_GeneralName, implicit_tag=160)

class X509_ExtNameRelativeToCRLIssuer(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_PACKET('nameRelativeToCRLIssuer', X509_RDN(), X509_RDN, implicit_tag=161)
...
class X509_ExtDistributionPoint(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_PACKET('distributionPoint', X509_ExtDistributionPointName(), X509_ExtDistributionPointName, explicit_tag=160)), ASN1F_optional(ASN1F_FLAGS('reasons', None, _reasons_mapping, implicit_tag=129)), ASN1F_optional(ASN1F_SEQUENCE_OF('cRLIssuer', None, X509_GeneralName, implicit_tag=162)))
...
class X509_ExtPrivateKeyUsagePeriod(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_GENERALIZED_TIME('notBefore', str(GeneralizedTime(-600)), implicit_tag=128)), ASN1F_optional(ASN1F_GENERALIZED_TIME('notAfter', str(GeneralizedTime(+86400)), implicit_tag=129)))
...
class X509_ExtIssuingDistributionPoint(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_PACKET('distributionPoint', X509_ExtDistributionPointName(), X509_ExtDistributionPointName, explicit_tag=160)), ASN1F_BOOLEAN('onlyContainsUserCerts', False, implicit_tag=129), ASN1F_BOOLEAN('onlyContainsCACerts', False, implicit_tag=130), ASN1F_optional(ASN1F_FLAGS('onlySomeReasons', None, _reasons_mapping, implicit_tag=131)), ASN1F_BOOLEAN('indirectCRL', False, implicit_tag=132), ASN1F_BOOLEAN('onlyContainsAttributeCerts', False, implicit_tag=133))
...
class X509_ExtGeneralSubtree(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_PACKET('base', X509_GeneralName(), X509_GeneralName), ASN1F_optional(ASN1F_INTEGER('minimum', None, implicit_tag=128)), ASN1F_optional(ASN1F_INTEGER('maximum', None, implicit_tag=129)))

class X509_ExtNameConstraints(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_SEQUENCE_OF('permittedSubtrees', None, X509_ExtGeneralSubtree, implicit_tag=160)), ASN1F_optional(ASN1F_SEQUENCE_OF('excludedSubtrees', None, X509_ExtGeneralSubtree, implicit_tag=161)))

class X509_ExtPolicyConstraints(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_INTEGER('requireExplicitPolicy', None, implicit_tag=128)), ASN1F_optional(ASN1F_INTEGER('inhibitPolicyMapping', None, implicit_tag=129)))
...
class X509_ExtUserNotice(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_PACKET('noticeRef', None, X509_ExtNoticeReference)), ASN1F_optional(ASN1F_CHOICE('explicitText', ASN1_UTF8_STRING('Dummy ExplicitText'), ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING)))
...
class RSAPrivateKey_OpenSSL(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_enum_INTEGER('version', 0, ['v1', 'v2']), ASN1F_PACKET('privateKeyAlgorithm', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier), ASN1F_PACKET('privateKey', RSAPrivateKey(), RSAPrivateKey, explicit_tag=4), ASN1F_optional(ASN1F_PACKET('parameters', None, ECParameters, explicit_tag=160)), ASN1F_optional(ASN1F_PACKET('publicKey', None, ECDSAPublicKey, explicit_tag=161)))
...
_default_issuer = [X509_RDN(), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Issuer'))])]
_default_subject = [X509_RDN(), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]), X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Subject'))])]
...
class X509_TBSCertificate(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_enum_INTEGER('version', 2, ['v1', 'v2', 'v3'], explicit_tag=160)), ASN1F_INTEGER('serialNumber', 1), ASN1F_PACKET('signature', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier), ASN1F_SEQUENCE_OF('issuer', _default_issuer, X509_RDN), ASN1F_PACKET('validity', X509_Validity(), X509_Validity), ASN1F_SEQUENCE_OF('subject', _default_subject, X509_RDN), ASN1F_PACKET('subjectPublicKeyInfo', X509_SubjectPublicKeyInfo(), X509_SubjectPublicKeyInfo), ASN1F_optional(ASN1F_BIT_STRING('issuerUniqueID', None, implicit_tag=129)), ASN1F_optional(ASN1F_BIT_STRING('subjectUniqueID', None, implicit_tag=130)), ASN1F_optional(ASN1F_SEQUENCE_OF('extensions', [X509_Extension()], X509_Extension, explicit_tag=163)))
...
class X509_TBSCertList(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_enum_INTEGER('version', 1, ['v1', 'v2'])), ASN1F_PACKET('signature', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier), ASN1F_SEQUENCE_OF('issuer', _default_issuer, X509_RDN), ASN1F_UTC_TIME('this_update', str(ZuluTime(-1))), ASN1F_optional(ASN1F_UTC_TIME('next_update', None)), ASN1F_optional(ASN1F_SEQUENCE_OF('revokedCertificates', None, X509_RevokedCertificate)), ASN1F_optional(ASN1F_SEQUENCE_OF('crlExtensions', None, X509_Extension, explicit_tag=160)))
...
class OCSP_RevokedInfo(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_GENERALIZED_TIME('revocationTime', ''), ASN1F_optional(ASN1F_PACKET('revocationReason', None, X509_ExtReasonCode, explicit_tag=128)))
...
class OCSP_CertStatus(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('certStatus', None, ASN1F_PACKET('good', OCSP_GoodInfo(), OCSP_GoodInfo, implicit_tag=128), ASN1F_PACKET('revoked', OCSP_RevokedInfo(), OCSP_RevokedInfo, implicit_tag=161), ASN1F_PACKET('unknown', OCSP_UnknownInfo(), OCSP_UnknownInfo, implicit_tag=130))

class OCSP_SingleResponse(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_PACKET('certID', OCSP_CertID(), OCSP_CertID), ASN1F_PACKET('certStatus', OCSP_CertStatus(), OCSP_CertStatus), ASN1F_GENERALIZED_TIME('thisUpdate', ''), ASN1F_optional(ASN1F_GENERALIZED_TIME('nextUpdate', '', explicit_tag=160)), ASN1F_optional(ASN1F_SEQUENCE_OF('singleExtensions', None, X509_Extension, explicit_tag=161)))
...
class OCSP_ResponderID(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('responderID', None, ASN1F_PACKET('byName', OCSP_ByName(), OCSP_ByName, explicit_tag=161), ASN1F_PACKET('byKey', OCSP_ByKey(), OCSP_ByKey, explicit_tag=162))

class OCSP_ResponseData(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_enum_INTEGER('version', 0, {0: 'v1'}, explicit_tag=128)), ASN1F_PACKET('responderID', OCSP_ResponderID(), OCSP_ResponderID), ASN1F_GENERALIZED_TIME('producedAt', str(GeneralizedTime())), ASN1F_SEQUENCE_OF('responses', [], OCSP_SingleResponse), ASN1F_optional(ASN1F_SEQUENCE_OF('responseExtensions', None, X509_Extension, explicit_tag=161)))
...
class OCSP_ResponseBytes(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('responseType', '1.3.6.1.5.5.7.48.1.1'), ASN1F_OCSP_BasicResponse(explicit_tag=4))
...
class OCSP_Response(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_ENUMERATED('responseStatus', 0, _responseStatus_mapping), ASN1F_optional(ASN1F_PACKET('responseBytes', None, OCSP_ResponseBytes, explicit_tag=160)))