...
class MappingSubclass(configtypes.MappingType):
    ...
    MAPPING = {'one': (1, 'one doc'), 'two': (2, 'two doc'), 'three': (3, None)}

class TestMappingType:
    TESTS = {'one': 1, 'two': 2, 'ONE': 1}
...
class TestBool:
    TESTS = {'1': True, 'yes': True, 'YES': True, 'true': True, 'TrUe': True, 'on': True, '0': False, 'no': False, 'NO': False, 'false': False, 'FaLsE': False, 'off': False}
...
class TestFont:
    TESTS = {'"Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, -1, -1, 'Foobar Neue'), 'inconsolatazi4': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, -1, -1, 'inconsolatazi4'), 'Terminus (TTF)': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, -1, -1, 'Terminus (TTF)'), '10pt "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, 10, None, 'Foobar Neue'), '10PT "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, 10, None, 'Foobar Neue'), '10px "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, None, 10, 'Foobar Neue'), '10PX "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Normal, None, 10, 'Foobar Neue'), 'bold "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Bold, -1, -1, 'Foobar Neue'), 'italic "Foobar Neue"': FontDesc(QFont.Style.StyleItalic, QFont.Weight.Normal, -1, -1, 'Foobar Neue'), 'oblique "Foobar Neue"': FontDesc(QFont.Style.StyleOblique, QFont.Weight.Normal, -1, -1, 'Foobar Neue'), 'normal bold "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Bold, -1, -1, 'Foobar Neue'), 'bold italic "Foobar Neue"': FontDesc(QFont.Style.StyleItalic, QFont.Weight.Bold, -1, -1, 'Foobar Neue'), 'bold 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Bold, 10, None, 'Foobar Neue'), 'italic 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleItalic, QFont.Weight.Normal, 10, None, 'Foobar Neue'), 'oblique 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleOblique, QFont.Weight.Normal, 10, None, 'Foobar Neue'), 'normal bold 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, QFont.Weight.Bold, 10, None, 'Foobar Neue'), 'bold italic 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleItalic, QFont.Weight.Bold, 10, None, 'Foobar Neue'), 'normal 300 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, 37, 10, None, 'Foobar Neue'), 'normal 800 10pt "Foobar Neue"': FontDesc(QFont.Style.StyleNormal, 99, 10, None, 'Foobar Neue')}
...
class TestFontFamily:
    ...
    INVALID = ['10pt "Foobar Neue"', '10PT "Foobar Neue"', '10px "Foobar Neue"', '10PX "Foobar Neue"', 'bold "Foobar Neue"', 'italic "Foobar Neue"', 'oblique "Foobar Neue"', 'normal bold "Foobar Neue"', 'bold italic "Foobar Neue"', 'bold 10pt "Foobar Neue"', 'italic 10pt "Foobar Neue"', 'oblique 10pt "Foobar Neue"', 'normal bold 10pt "Foobar Neue"', 'bold italic 10pt "Foobar Neue"']
...
class TestUrl:
    TESTS = {'http://qutebrowser.org/': QUrl('http://qutebrowser.org/'), 'http://heise.de/': QUrl('http://heise.de/')}
...
class TestConfirmQuit:
    TESTS = [['multiple-tabs', 'downloads'], ['downloads', 'multiple-tabs'], ['downloads', None, 'multiple-tabs']]
