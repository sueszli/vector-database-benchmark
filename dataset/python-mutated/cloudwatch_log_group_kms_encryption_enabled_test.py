...
class Test_cloudwatch_log_group_kms_encryption_enabled:
    ...
    def test_cloudwatch_no_log_groups(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=current_audit_info), mock.patch('prowler.providers.aws.services.cloudwatch.cloudwatch_log_group_kms_encryption_enabled.cloudwatch_log_group_kms_encryption_enabled.logs_client', new=Logs(current_audit_info)):
            from prowler.providers.aws.services.cloudwatch.cloudwatch_log_group_kms_encryption_enabled.cloudwatch_log_group_kms_encryption_enabled import cloudwatch_log_group_kms_encryption_enabled
    ...
    def test_cloudwatch_log_group_without_kms_key(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=current_audit_info), mock.patch('prowler.providers.aws.services.cloudwatch.cloudwatch_log_group_kms_encryption_enabled.cloudwatch_log_group_kms_encryption_enabled.logs_client', new=Logs(current_audit_info)):
            ...
            assert result[0].status_extended == 'Log Group test does not have AWS KMS keys associated.'
    ...
    def test_cloudwatch_log_group_with_kms_key(self):
        ...
        with mock.patch('prowler.providers.aws.lib.audit_info.audit_info.current_audit_info', new=current_audit_info), mock.patch('prowler.providers.aws.services.cloudwatch.cloudwatch_log_group_kms_encryption_enabled.cloudwatch_log_group_kms_encryption_enabled.logs_client', new=Logs(current_audit_info)):
            ...
            assert result[0].status_extended == 'Log Group test does have AWS KMS key test_kms_id associated.'
            assert result[0].resource_id == 'test'