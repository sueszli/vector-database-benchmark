...
class appstream_fleet_session_idle_disconnect_timeout(Check):
    ...
    def execute(self):
        ...
        max_idle_disconnect_timeout_in_seconds = appstream_client.audit_config.get('max_idle_disconnect_timeout_in_seconds', 600)
        findings = []
        for fleet in appstream_client.fleets:
            ...
            if fleet.idle_disconnect_timeout_in_seconds and fleet.idle_disconnect_timeout_in_seconds <= max_idle_disconnect_timeout_in_seconds:
                report.status = 'PASS'
