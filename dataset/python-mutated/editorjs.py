...
ITEM_TYPE_TO_CLEAN_FUNC_MAP = {'list': lambda *params: clean_list_item(*params), 'image': lambda *params: clean_image_item(*params), 'embed': lambda *params: clean_embed_item(*params)}
