...
class ComponentsOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.ApplicationInsightsComponent']:
        if False:
            return 10
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ApplicationInsightsComponent:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, insight_properties: _models.ApplicationInsightsComponent, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponent:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, insight_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponent:
        """Creates (or updates) an Application Insights component. Note: You cannot specify a different
        value for InstrumentationKey nor AppId in the Put operation.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, resource_name: str, insight_properties: Union[_models.ApplicationInsightsComponent, IO], **kwargs: Any) -> _models.ApplicationInsightsComponent:
        """Creates (or updates) an Application Insights component. Note: You cannot specify a different
        value for InstrumentationKey nor AppId in the Put operation.
    ...
    @overload
    async def update_tags(self, resource_group_name: str, resource_name: str, component_tags: _models.TagsResource, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponent:
        ...
        :type component_tags: ~azure.mgmt.applicationinsights.v2015_05_01.models.TagsResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def update_tags(self, resource_group_name: str, resource_name: str, component_tags: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponent:
        """Updates an existing component's tags. To update other fields use the CreateOrUpdate method.
    ...
    @distributed_trace_async
    async def update_tags(self, resource_group_name: str, resource_name: str, component_tags: Union[_models.TagsResource, IO], **kwargs: Any) -> _models.ApplicationInsightsComponent:
        """Updates an existing component's tags. To update other fields use the CreateOrUpdate method.
        ...
        request = build_update_tags_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_tags.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def purge(self, resource_group_name: str, resource_name: str, body: _models.ComponentPurgeBody, *, content_type: str='application/json', **kwargs: Any) -> _models.ComponentPurgeResponse:
        ...
        :param body: Describes the body of a request to purge data in a single table of an Application
         Insights component. Required.
        :type body: ~azure.mgmt.applicationinsights.v2015_05_01.models.ComponentPurgeBody
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def purge(self, resource_group_name: str, resource_name: str, body: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ComponentPurgeResponse:
        """Purges data in an Application Insights component by a set of user-defined filters.
    ...
    @distributed_trace_async
    async def purge(self, resource_group_name: str, resource_name: str, body: Union[_models.ComponentPurgeBody, IO], **kwargs: Any) -> _models.ComponentPurgeResponse:
        """Purges data in an Application Insights component by a set of user-defined filters.
        ...
        request = build_purge_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.purge.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_purge_status(self, resource_group_name: str, resource_name: str, purge_id: str, **kwargs: Any) -> _models.ComponentPurgeStatusResponse:
        ...
        request = build_get_purge_status_request(resource_group_name=resource_group_name, resource_name=resource_name, purge_id=purge_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_purge_status.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
