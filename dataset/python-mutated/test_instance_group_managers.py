...
@pytest.mark.parametrize('client_class,transport_name', [(InstanceGroupManagersClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.InstanceGroupManagersRestTransport, 'rest')])
...
def test_instance_group_managers_client_get_transport_class():
    ...
    available_transports = [transports.InstanceGroupManagersRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(InstanceGroupManagersClient, transports.InstanceGroupManagersRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(InstanceGroupManagersClient, transports.InstanceGroupManagersRestTransport, 'rest', 'true'), (InstanceGroupManagersClient, transports.InstanceGroupManagersRestTransport, 'rest', 'false')])
@mock.patch.object(InstanceGroupManagersClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(InstanceGroupManagersClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(InstanceGroupManagersClient, transports.InstanceGroupManagersRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AbandonInstancesInstanceGroupManagerRequest, dict])
def test_abandon_instances_rest(request_type):
    ...
    for (field, value) in request_init['instance_group_managers_abandon_instances_request_resource'].items():
        result = None
        is_repeated = False
...
def test_abandon_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersAbandonInstancesRequestResource', 'project', 'zone'))
...
def test_abandon_instances_rest_interceptors(null_interceptor):
    if False:
        for i in range(10):
            print('nop')
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_abandon_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_abandon_instances') as pre:
...
def test_abandon_instances_rest_bad_request(transport: str='rest', request_type=compute.AbandonInstancesInstanceGroupManagerRequest):
    if False:
        return 10
...
def test_abandon_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_abandon_instances_request_resource=compute.InstanceGroupManagersAbandonInstancesRequest(instances=['instances_value']))
        ...
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/abandonInstances' % client.transport._host, args[1])
...
def test_abandon_instances_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.abandon_instances(compute.AbandonInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_abandon_instances_request_resource=compute.InstanceGroupManagersAbandonInstancesRequest(instances=['instances_value']))
...
def test_abandon_instances_unary_rest_bad_request(transport: str='rest', request_type=compute.AbandonInstancesInstanceGroupManagerRequest):
    if False:
        print('Hello World!')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
def test_abandon_instances_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.abandon_instances_unary(compute.AbandonInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_abandon_instances_request_resource=compute.InstanceGroupManagersAbandonInstancesRequest(instances=['instances_value']))
...
@pytest.mark.parametrize('request_type', [compute.AggregatedListInstanceGroupManagersRequest, dict])
def test_aggregated_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.InstanceGroupManagerAggregatedList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value', unreachables=['unreachables_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_aggregated_list') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_aggregated_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagerAggregatedList.to_json(compute.InstanceGroupManagerAggregatedList())
...
def test_aggregated_list_rest_bad_request(transport: str='rest', request_type=compute.AggregatedListInstanceGroupManagersRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_aggregated_list_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.aggregated_list(compute.AggregatedListInstanceGroupManagersRequest(), project='project_value')
...
def test_aggregated_list_rest_pager(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.InstanceGroupManagerAggregatedList(items={'a': compute.InstanceGroupManagersScopedList(), 'b': compute.InstanceGroupManagersScopedList(), 'c': compute.InstanceGroupManagersScopedList()}, next_page_token='abc'), compute.InstanceGroupManagerAggregatedList(items={}, next_page_token='def'), compute.InstanceGroupManagerAggregatedList(items={'g': compute.InstanceGroupManagersScopedList()}, next_page_token='ghi'), compute.InstanceGroupManagerAggregatedList(items={'h': compute.InstanceGroupManagersScopedList(), 'i': compute.InstanceGroupManagersScopedList()}))
...
@pytest.mark.parametrize('request_type', [compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest, dict])
def test_apply_updates_to_instances_rest(request_type):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_apply_updates_request_resource'] = {'all_instances': True, 'instances': ['instances_value1', 'instances_value2'], 'minimal_action': 'minimal_action_value', 'most_disruptive_allowed_action': 'most_disruptive_allowed_action_value'}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_apply_updates_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_apply_updates_to_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('instanceGroupManager', 'instanceGroupManagersApplyUpdatesRequestResource', 'project', 'zone'))
...
def test_apply_updates_to_instances_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_apply_updates_to_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_apply_updates_to_instances') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_apply_updates_to_instances_rest_bad_request(transport: str='rest', request_type=compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_apply_updates_to_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_apply_updates_request_resource=compute.InstanceGroupManagersApplyUpdatesRequest(all_instances=True))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/applyUpdatesToInstances' % client.transport._host, args[1])
...
def test_apply_updates_to_instances_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.apply_updates_to_instances(compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_apply_updates_request_resource=compute.InstanceGroupManagersApplyUpdatesRequest(all_instances=True))
...
def test_apply_updates_to_instances_unary_rest_bad_request(transport: str='rest', request_type=compute.ApplyUpdatesToInstancesInstanceGroupManagerRequest):
    if False:
        return 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
@pytest.mark.parametrize('request_type', [compute.CreateInstancesInstanceGroupManagerRequest, dict])
def test_create_instances_rest(request_type):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_create_instances_request_resource'] = {'instances': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'metadata': {}}, 'status': 'status_value'}]}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_create_instances_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_create_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersCreateInstancesRequestResource', 'project', 'zone'))
...
def test_create_instances_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_create_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_create_instances') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_instances_rest_bad_request(transport: str='rest', request_type=compute.CreateInstancesInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_create_instances_request_resource=compute.InstanceGroupManagersCreateInstancesRequest(instances=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/createInstances' % client.transport._host, args[1])
...
@pytest.mark.parametrize('request_type', [compute.DeleteInstanceGroupManagerRequest, dict])
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'project', 'zone'))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_delete') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}' % client.transport._host, args[1])
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
@pytest.mark.parametrize('request_type', [compute.DeleteInstancesInstanceGroupManagerRequest, dict])
def test_delete_instances_rest(request_type):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_delete_instances_request_resource'] = {'instances': ['instances_value1', 'instances_value2'], 'skip_instances_on_validation_error': True}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_delete_instances_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_delete_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersDeleteInstancesRequestResource', 'project', 'zone'))
...
def test_delete_instances_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_delete_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_delete_instances') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_instances_rest_bad_request(transport: str='rest', request_type=compute.DeleteInstancesInstanceGroupManagerRequest):
    if False:
        return 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
def test_delete_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_delete_instances_request_resource=compute.InstanceGroupManagersDeleteInstancesRequest(instances=['instances_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deleteInstances' % client.transport._host, args[1])
...
def test_delete_instances_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_instances(compute.DeleteInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_delete_instances_request_resource=compute.InstanceGroupManagersDeleteInstancesRequest(instances=['instances_value']))
...
def test_delete_instances_unary_rest_bad_request(transport: str='rest', request_type=compute.DeleteInstancesInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
@pytest.mark.parametrize('request_type', [compute.DeletePerInstanceConfigsInstanceGroupManagerRequest, dict])
def test_delete_per_instance_configs_rest(request_type):
    ...
    test_field = compute.DeletePerInstanceConfigsInstanceGroupManagerRequest.meta.fields['instance_group_managers_delete_per_instance_configs_req_resource']
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_delete_per_instance_configs_req_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_delete_per_instance_configs_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('instanceGroupManager', 'instanceGroupManagersDeletePerInstanceConfigsReqResource', 'project', 'zone'))
...
def test_delete_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_delete_per_instance_configs') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_delete_per_instance_configs') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_per_instance_configs_rest_bad_request(transport: str='rest', request_type=compute.DeletePerInstanceConfigsInstanceGroupManagerRequest):
    if False:
        for i in range(10):
            print('nop')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_delete_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_delete_per_instance_configs_req_resource=compute.InstanceGroupManagersDeletePerInstanceConfigsReq(names=['names_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/deletePerInstanceConfigs' % client.transport._host, args[1])
...
@pytest.mark.parametrize('request_type', [compute.GetInstanceGroupManagerRequest, dict])
...
def test_get_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('instanceGroupManager', 'project', 'zone'))
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_get') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_bad_request(transport: str='rest', request_type=compute.GetInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
@pytest.mark.parametrize('request_type', [compute.InsertInstanceGroupManagerRequest, dict])
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManagerResource', 'project', 'zone'))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_insert') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str='rest', request_type=compute.InsertInstanceGroupManagerRequest):
    if False:
        print('Hello World!')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2'}
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
...
@pytest.mark.parametrize('request_type', [compute.ListInstanceGroupManagersRequest, dict])
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.InstanceGroupManagerList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_list') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagerList.to_json(compute.InstanceGroupManagerList())
...
def test_list_rest_bad_request(transport: str='rest', request_type=compute.ListInstanceGroupManagersRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListInstanceGroupManagersRequest(), project='project_value', zone='zone_value')
...
@pytest.mark.parametrize('request_type', [compute.ListErrorsInstanceGroupManagersRequest, dict])
def test_list_errors_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.InstanceGroupManagersListErrorsResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_errors_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_list_errors') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_list_errors') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagersListErrorsResponse.to_json(compute.InstanceGroupManagersListErrorsResponse())
...
def test_list_errors_rest_bad_request(transport: str='rest', request_type=compute.ListErrorsInstanceGroupManagersRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_errors_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listErrors' % client.transport._host, args[1])
...
def test_list_errors_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list_errors(compute.ListErrorsInstanceGroupManagersRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
@pytest.mark.parametrize('request_type', [compute.ListManagedInstancesInstanceGroupManagersRequest, dict])
def test_list_managed_instances_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.InstanceGroupManagersListManagedInstancesResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_managed_instances_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_list_managed_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_list_managed_instances') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagersListManagedInstancesResponse.to_json(compute.InstanceGroupManagersListManagedInstancesResponse())
...
def test_list_managed_instances_rest_bad_request(transport: str='rest', request_type=compute.ListManagedInstancesInstanceGroupManagersRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_managed_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listManagedInstances' % client.transport._host, args[1])
...
def test_list_managed_instances_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list_managed_instances(compute.ListManagedInstancesInstanceGroupManagersRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
def test_list_managed_instances_rest_pager(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.InstanceGroupManagersListManagedInstancesResponse(managed_instances=[compute.ManagedInstance(), compute.ManagedInstance(), compute.ManagedInstance()], next_page_token='abc'), compute.InstanceGroupManagersListManagedInstancesResponse(managed_instances=[], next_page_token='def'), compute.InstanceGroupManagersListManagedInstancesResponse(managed_instances=[compute.ManagedInstance()], next_page_token='ghi'), compute.InstanceGroupManagersListManagedInstancesResponse(managed_instances=[compute.ManagedInstance(), compute.ManagedInstance()]))
        response = response + response
...
@pytest.mark.parametrize('request_type', [compute.ListPerInstanceConfigsInstanceGroupManagersRequest, dict])
def test_list_per_instance_configs_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.InstanceGroupManagersListPerInstanceConfigsResp(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_list_per_instance_configs') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_list_per_instance_configs') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.InstanceGroupManagersListPerInstanceConfigsResp.to_json(compute.InstanceGroupManagersListPerInstanceConfigsResp())
...
def test_list_per_instance_configs_rest_bad_request(transport: str='rest', request_type=compute.ListPerInstanceConfigsInstanceGroupManagersRequest):
    if False:
        print('Hello World!')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
def test_list_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/listPerInstanceConfigs' % client.transport._host, args[1])
...
def test_list_per_instance_configs_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list_per_instance_configs(compute.ListPerInstanceConfigsInstanceGroupManagersRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value')
...
def test_list_per_instance_configs_rest_pager(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.InstanceGroupManagersListPerInstanceConfigsResp(items=[compute.PerInstanceConfig(), compute.PerInstanceConfig(), compute.PerInstanceConfig()], next_page_token='abc'), compute.InstanceGroupManagersListPerInstanceConfigsResp(items=[], next_page_token='def'), compute.InstanceGroupManagersListPerInstanceConfigsResp(items=[compute.PerInstanceConfig()], next_page_token='ghi'), compute.InstanceGroupManagersListPerInstanceConfigsResp(items=[compute.PerInstanceConfig(), compute.PerInstanceConfig()]))
        response = response + response
...
@pytest.mark.parametrize('request_type', [compute.PatchInstanceGroupManagerRequest, dict])
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagerResource', 'project', 'zone'))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_patch') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_bad_request(transport: str='rest', request_type=compute.PatchInstanceGroupManagerRequest):
    if False:
        print('Hello World!')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
...
def test_patch_unary_rest_bad_request(transport: str='rest', request_type=compute.PatchInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_manager_resource=compute.InstanceGroupManager(auto_healing_policies=[compute.InstanceGroupManagerAutoHealingPolicy(health_check='health_check_value')]))
...
@pytest.mark.parametrize('request_type', [compute.PatchPerInstanceConfigsInstanceGroupManagerRequest, dict])
def test_patch_per_instance_configs_rest(request_type):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_patch_per_instance_configs_req_resource'] = {'per_instance_configs': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'metadata': {}}, 'status': 'status_value'}]}
    test_field = compute.PatchPerInstanceConfigsInstanceGroupManagerRequest.meta.fields['instance_group_managers_patch_per_instance_configs_req_resource']
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_patch_per_instance_configs_req_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_patch_per_instance_configs_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersPatchPerInstanceConfigsReqResource', 'project', 'zone'))
...
def test_patch_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_patch_per_instance_configs') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_patch_per_instance_configs') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_per_instance_configs_rest_bad_request(transport: str='rest', request_type=compute.PatchPerInstanceConfigsInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_patch_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_patch_per_instance_configs_req_resource=compute.InstanceGroupManagersPatchPerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/patchPerInstanceConfigs' % client.transport._host, args[1])
...
def test_patch_per_instance_configs_unary_rest_bad_request(transport: str='rest', request_type=compute.PatchPerInstanceConfigsInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_patch_per_instance_configs_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_per_instance_configs_unary(compute.PatchPerInstanceConfigsInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_patch_per_instance_configs_req_resource=compute.InstanceGroupManagersPatchPerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]))
...
@pytest.mark.parametrize('request_type', [compute.RecreateInstancesInstanceGroupManagerRequest, dict])
def test_recreate_instances_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_recreate_instances_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_recreate_instances_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersRecreateInstancesRequestResource', 'project', 'zone'))
...
def test_recreate_instances_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_recreate_instances') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_recreate_instances') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_recreate_instances_rest_bad_request(transport: str='rest', request_type=compute.RecreateInstancesInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_recreate_instances_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_recreate_instances_request_resource=compute.InstanceGroupManagersRecreateInstancesRequest(instances=['instances_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/recreateInstances' % client.transport._host, args[1])
...
def test_recreate_instances_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.recreate_instances(compute.RecreateInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_recreate_instances_request_resource=compute.InstanceGroupManagersRecreateInstancesRequest(instances=['instances_value']))
...
def test_recreate_instances_unary_rest_bad_request(transport: str='rest', request_type=compute.RecreateInstancesInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_recreate_instances_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.recreate_instances_unary(compute.RecreateInstancesInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_recreate_instances_request_resource=compute.InstanceGroupManagersRecreateInstancesRequest(instances=['instances_value']))
...
@pytest.mark.parametrize('request_type', [compute.ResizeInstanceGroupManagerRequest, dict])
...
def test_resize_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId', 'size')) & set(('instanceGroupManager', 'project', 'size', 'zone'))
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_resize') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_resize') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_resize_rest_bad_request(transport: str='rest', request_type=compute.ResizeInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', size=443)
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resize' % client.transport._host, args[1])
...
def test_resize_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.resize(compute.ResizeInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', size=443)
...
def test_resize_unary_rest_bad_request(transport: str='rest', request_type=compute.ResizeInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_resize_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.resize_unary(compute.ResizeInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', size=443)
...
@pytest.mark.parametrize('request_type', [compute.SetInstanceTemplateInstanceGroupManagerRequest, dict])
def test_set_instance_template_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_set_instance_template_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_set_instance_template_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersSetInstanceTemplateRequestResource', 'project', 'zone'))
...
def test_set_instance_template_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_set_instance_template') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_set_instance_template') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_instance_template_rest_bad_request(transport: str='rest', request_type=compute.SetInstanceTemplateInstanceGroupManagerRequest):
    if False:
        return 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
...
def test_set_instance_template_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_instance_template_request_resource=compute.InstanceGroupManagersSetInstanceTemplateRequest(instance_template='instance_template_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setInstanceTemplate' % client.transport._host, args[1])
...
def test_set_instance_template_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_instance_template(compute.SetInstanceTemplateInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_instance_template_request_resource=compute.InstanceGroupManagersSetInstanceTemplateRequest(instance_template='instance_template_value'))
...
def test_set_instance_template_unary_rest_bad_request(transport: str='rest', request_type=compute.SetInstanceTemplateInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_set_instance_template_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_instance_template_unary(compute.SetInstanceTemplateInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_instance_template_request_resource=compute.InstanceGroupManagersSetInstanceTemplateRequest(instance_template='instance_template_value'))
...
@pytest.mark.parametrize('request_type', [compute.SetTargetPoolsInstanceGroupManagerRequest, dict])
def test_set_target_pools_rest(request_type):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_set_target_pools_request_resource'] = {'fingerprint': 'fingerprint_value', 'target_pools': ['target_pools_value1', 'target_pools_value2']}
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_set_target_pools_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_set_target_pools_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersSetTargetPoolsRequestResource', 'project', 'zone'))
...
def test_set_target_pools_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_set_target_pools') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_set_target_pools') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_target_pools_rest_bad_request(transport: str='rest', request_type=compute.SetTargetPoolsInstanceGroupManagerRequest):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_set_target_pools_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_target_pools_request_resource=compute.InstanceGroupManagersSetTargetPoolsRequest(fingerprint='fingerprint_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/setTargetPools' % client.transport._host, args[1])
...
def test_set_target_pools_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_target_pools(compute.SetTargetPoolsInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_target_pools_request_resource=compute.InstanceGroupManagersSetTargetPoolsRequest(fingerprint='fingerprint_value'))
...
def test_set_target_pools_unary_rest_bad_request(transport: str='rest', request_type=compute.SetTargetPoolsInstanceGroupManagerRequest):
    if False:
        for i in range(10):
            print('nop')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_set_target_pools_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_target_pools_unary(compute.SetTargetPoolsInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_set_target_pools_request_resource=compute.InstanceGroupManagersSetTargetPoolsRequest(fingerprint='fingerprint_value'))
...
@pytest.mark.parametrize('request_type', [compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest, dict])
def test_update_per_instance_configs_rest(request_type):
    if False:
        return 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
    request_init['instance_group_managers_update_per_instance_configs_req_resource'] = {'per_instance_configs': [{'fingerprint': 'fingerprint_value', 'name': 'name_value', 'preserved_state': {'disks': {}, 'metadata': {}}, 'status': 'status_value'}]}
    test_field = compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest.meta.fields['instance_group_managers_update_per_instance_configs_req_resource']
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['instance_group_managers_update_per_instance_configs_req_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_update_per_instance_configs_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('instanceGroupManager', 'instanceGroupManagersUpdatePerInstanceConfigsReqResource', 'project', 'zone'))
...
def test_update_per_instance_configs_rest_interceptors(null_interceptor):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.InstanceGroupManagersRestInterceptor())
    client = InstanceGroupManagersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'post_update_per_instance_configs') as post, mock.patch.object(transports.InstanceGroupManagersRestInterceptor, 'pre_update_per_instance_configs') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_per_instance_configs_rest_bad_request(transport: str='rest', request_type=compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest):
    if False:
        for i in range(10):
            print('nop')
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_per_instance_configs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'instance_group_manager': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_update_per_instance_configs_req_resource=compute.InstanceGroupManagersUpdatePerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/updatePerInstanceConfigs' % client.transport._host, args[1])
...
def test_update_per_instance_configs_unary_rest_bad_request(transport: str='rest', request_type=compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_per_instance_configs_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_per_instance_configs_unary(compute.UpdatePerInstanceConfigsInstanceGroupManagerRequest(), project='project_value', zone='zone_value', instance_group_manager='instance_group_manager_value', instance_group_managers_update_per_instance_configs_req_resource=compute.InstanceGroupManagersUpdatePerInstanceConfigsReq(per_instance_configs=[compute.PerInstanceConfig(fingerprint='fingerprint_value')]))
...
def test_credentials_transport_error():
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = InstanceGroupManagersClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = InstanceGroupManagersClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.InstanceGroupManagersRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = InstanceGroupManagersClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.InstanceGroupManagersRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        for i in range(10):
            print('nop')
    transport = InstanceGroupManagersClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_instance_group_managers_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.instance_group_managers.transports.InstanceGroupManagersTransport.__init__') as Transport:
        ...
        transport = transports.InstanceGroupManagersTransport(credentials=ga_credentials.AnonymousCredentials())
...
def test_instance_group_managers_base_transport_with_credentials_file():
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.instance_group_managers.transports.InstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.InstanceGroupManagersTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_instance_group_managers_base_transport_with_adc():
    if False:
        return 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.compute_v1.services.instance_group_managers.transports.InstanceGroupManagersTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
def test_instance_group_managers_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_instance_group_managers_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_instance_group_managers_client_transport_session_collision(transport_name):
    ...
    client1 = InstanceGroupManagersClient(credentials=creds1, transport=transport_name)
    client2 = InstanceGroupManagersClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.InstanceGroupManagersTransport, '_prep_wrapped_messages') as prep:
        client = InstanceGroupManagersClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(InstanceGroupManagersClient, transports.InstanceGroupManagersRestTransport)])
