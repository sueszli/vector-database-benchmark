...
from tribler.core.components.database.db.layers.knowledge_data_access_layer import KnowledgeDataAccessLayer, ResourceType, SHOW_THRESHOLD
...
from tribler.core.components.metadata_store.remote_query_community.tests.test_remote_query_community import BasicRemoteQueryCommunity
