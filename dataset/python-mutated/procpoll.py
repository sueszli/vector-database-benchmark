...
if __name__ == '__main__':
    import subprocess
    p1 = subprocess.Popen(['bash', '-c', 'for ((i=0;i<10;i++)); do echo "first $i"; sleep 1; done'], bufsize=1, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    p2 = subprocess.Popen(['bash', '-c', 'for ((i=0;i<5;i++)); do echo "second $i"; sleep 2; done'], bufsize=1, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
