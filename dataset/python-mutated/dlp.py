...
class CloudDLPCancelDLPJobOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('dlp_job_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPCreateDeidentifyTemplateOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('organization_id', 'project_id', 'deidentify_template', 'template_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPCreateDLPJobOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'inspect_job', 'risk_job', 'job_id', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPJobDetailsLink(),)
...
class CloudDLPCreateInspectTemplateOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('organization_id', 'project_id', 'inspect_template', 'template_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPCreateJobTriggerOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'job_trigger', 'trigger_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPCreateStoredInfoTypeOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('organization_id', 'project_id', 'config', 'stored_info_type_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPDeidentifyContentOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'deidentify_config', 'inspect_config', 'item', 'inspect_template_name', 'deidentify_template_name', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPDeleteDeidentifyTemplateOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('template_id', 'organization_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPDeleteJobTriggerOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('job_trigger_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPDeleteStoredInfoTypeOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('stored_info_type_id', 'organization_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPInspectContentOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'inspect_config', 'item', 'inspect_template_name', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPListDeidentifyTemplatesOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('organization_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPDeidentifyTemplatesListLink(),)
...
class CloudDLPListInfoTypesOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('language_code', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPRedactImageOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'inspect_config', 'image_redaction_configs', 'include_findings', 'byte_item', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPReidentifyContentOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('project_id', 'reidentify_config', 'inspect_config', 'item', 'inspect_template_name', 'reidentify_template_name', 'gcp_conn_id', 'impersonation_chain')
...
class CloudDLPUpdateDeidentifyTemplateOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('template_id', 'organization_id', 'project_id', 'deidentify_template', 'update_mask', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPDeidentifyTemplateDetailsLink(),)
...
class CloudDLPUpdateInspectTemplateOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('template_id', 'organization_id', 'project_id', 'inspect_template', 'update_mask', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPInspectTemplateDetailsLink(),)
...
class CloudDLPUpdateJobTriggerOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('job_trigger_id', 'project_id', 'job_trigger', 'update_mask', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPJobTriggerDetailsLink(),)
...
class CloudDLPUpdateStoredInfoTypeOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('stored_info_type_id', 'organization_id', 'project_id', 'config', 'update_mask', 'gcp_conn_id', 'impersonation_chain')
    operator_extra_links = (CloudDLPInfoTypeDetailsLink(),)
