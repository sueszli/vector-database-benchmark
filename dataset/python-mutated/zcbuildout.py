...
HR = '{}\n'.format('-' * 80)
RE_F = re.S | re.M | re.U
BASE_STATUS = {'status': None, 'logs': [], 'comment': '', 'out': None, 'logs_by_level': {}, 'outlog': None, 'outlog_by_level': None}
_URL_VERSIONS = {1: 'http://downloads.buildout.org/1/bootstrap.py', 2: 'http://downloads.buildout.org/2/bootstrap.py'}
DEFAULT_VER = 2
