...
class Migration(migrations.Migration):
    ...
    """
    atomic = False
    dependencies = [('zerver', '0382_create_role_based_system_groups')]
    operations = [migrations.RunPython(revoke_invitations, reverse_code=migrations.RunPython.noop, elidable=True)]