...
flags.DEFINE_integer('buffer_size', -1, 'A reservoir buffer size. A non-positive size implies an effectively infinite buffer.')
...
flags.DEFINE_integer('num_hidden_factors', 8, 'The number of factors in each hidden layer in the regret model.')
flags.DEFINE_boolean('use_skip_connections', True, 'Whether or not to use skip connections in the regret model.')
flags.DEFINE_integer('num_epochs', 200, 'The number of epochs to run between each iterations to update the regret models.')
