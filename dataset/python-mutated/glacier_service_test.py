...
TEST_VAULT_ARN = f'arn:aws:glacier:{AWS_REGION}:{DEFAULT_ACCOUNT_ID}:vaults/examplevault'
vault_json_policy = {'Version': '2012-10-17', 'Statement': [{'Sid': 'cross-account-upload', 'Principal': {'AWS': [f'arn:aws:iam::{DEFAULT_ACCOUNT_ID}:root']}, 'Effect': 'Allow', 'Action': ['glacier:UploadArchive', 'glacier:InitiateMultipartUpload', 'glacier:AbortMultipartUpload', 'glacier:CompleteMultipartUpload'], 'Resource': [TEST_VAULT_ARN]}]}
