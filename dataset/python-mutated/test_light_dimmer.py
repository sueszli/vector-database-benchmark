...
def pywemo_model():
    ...
    return 'Dimmer'
test_async_update_locked_multiple_updates = entity_test_helpers.test_async_update_locked_multiple_updates
test_async_update_locked_multiple_callbacks = entity_test_helpers.test_async_update_locked_multiple_callbacks
test_async_update_locked_callback_and_update = entity_test_helpers.test_async_update_locked_callback_and_update

async def test_available_after_update(hass: HomeAssistant, pywemo_registry, pywemo_device, wemo_entity) -> None:
...
async def test_turn_on_brightness(hass: HomeAssistant, pywemo_device, wemo_entity) -> None:
    ...
    await hass.services.async_call(LIGHT_DOMAIN, SERVICE_TURN_ON, {ATTR_ENTITY_ID: [wemo_entity.entity_id], ATTR_BRIGHTNESS: 204}, blocking=True)
...
async def test_light_registry_state_callback(hass: HomeAssistant, pywemo_registry, pywemo_device, wemo_entity) -> None:
...
async def test_light_update_entity(hass: HomeAssistant, pywemo_registry, pywemo_device, wemo_entity) -> None:
