...
class Code(Component):
    ...
    """
    languages = ['python', 'markdown', 'json', 'html', 'css', 'javascript', 'typescript', 'yaml', 'dockerfile', 'shell', 'r', None]
    EVENTS = [Events.change, Events.input, Events.focus, Events.blur]

    def __init__(self, value: str | tuple[str] | None=None, language: Literal['python', 'markdown', 'json', 'html', 'css', 'javascript', 'typescript', 'yaml', 'dockerfile', 'shell', 'r'] | None=None, *, every: float | None=None, lines: int=5, label: str | None=None, interactive: bool | None=None, show_label: bool | None=None, container: bool=True, scale: int | None=None, min_width: int=160, visible: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True):
        if False:
            return 10
        ...
        self.lines = lines
        super().__init__(label=label, every=every, interactive=interactive, show_label=show_label, container=container, scale=scale, min_width=min_width, visible=visible, elem_id=elem_id, elem_classes=elem_classes, render=render, value=value)
