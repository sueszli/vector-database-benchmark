...
class Automaton:
    ...
    field_func = {0: lambda n, m, s: np.maximum(0, 1 - (n - m) ** 2 / (9 * s ** 2)) ** 4 * 2 - 1, 1: lambda n, m, s: np.exp(-(n - m) ** 2 / (2 * s ** 2)) * 2 - 1, 2: lambda n, m, s: (np.abs(n - m) <= s) * 2 - 1}
...
class Analyzer:
    STAT_NAMES = {'p_m': 'Param m', 'p_s': 'Param s', 'n': 'Gen (#)', 't': 'Time (s)', 'm': 'Mass (mg)', 'g': 'Growth (mg/s)', 'r': 'Gyradius (mm)', 'd': 'Mass-growth distance (mm)', 's': 'Speed (mm/s)', 'w': 'Angular speed (deg/s)', 'm_a': 'Mass asymmetry (mg)'}
    STAT_HEADERS = ['p_m', 'p_s', 'n', 't', 'm', 'g', 'r', 'd', 's', 'w', 'm_a']
    SEGMENT_LEN = 20
...
class Lenia:
    ...
    ANIMAL_KEY_LIST = {'1': 'O2(a)', '2': 'OG2', '3': 'OV2', '4': 'P4(a)', '5': '2S1:5', '6': '2S2:2', '7': '2P6,2,1', '8': '2PG1:2', '9': '3H3', '0': '~gldr', 's+1': '3G2:4', 's+2': '3GG2', 's+3': 'K5(4,1)', 's+4': 'K7(4,3)', 's+5': 'K9(5,4)', 's+6': '3R5', 's+7': '4R6', 's+8': '2D10', 's+9': '4F12', 's+0': '~ggun', 'c+1': '4Q(5,5,5,5):3', 'c+2': '3G7', 'c+3': '3EC', 'c+4': 'K4(2,2):3', 'c+5': '2L5', 'c+6': '3B7,1:6', 'c+7': '3R6:4', 'c+8': '4F7', 'c+9': '', 'c+0': 'bbug'}
