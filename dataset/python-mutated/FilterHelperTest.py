import unittest
from coalib.parsing.FilterHelper import apply_filter, apply_filters, is_valid_filter, _filter_section_bears
...
from coalib.parsing.FilterHelper import collect_filters, _apply_section_filter
