...
workflowNames = ['pull', 'trunk', 'Lint', 'linux-binary-libtorch-pre-cxx11', 'android-tests', 'windows-binary-wheel', 'periodic', 'docker-release-builds', 'nightly', 'pr-labels', 'Close stale pull requests', 'Update S3 HTML indices for download.pytorch.org', 'Create Release']
