...
pu.run_tests([test_stacked_ensembles_are_trained_after_max_models, test_stacked_ensembles_are_trained_with_blending_frame_even_if_nfolds_eq_0, test_optional_SEs_trained_in_non_reproducible_mode, test_optional_SEs_not_trained_in_reproducible_mode])