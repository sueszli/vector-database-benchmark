...
class PartitionPackage:
    ...
    package_dir: str
    partitions: int
INTEGRATION_TEST_PACKAGES = {'github.com/pulumi/pulumi/pkg/v3/cmd/pulumi', 'github.com/pulumi/pulumi/pkg/v3/codegen/testing/utils', 'github.com/pulumi/pulumi/pkg/v3/graph/dotconv', 'github.com/pulumi/pulumi/pkg/v3/testing/integration', 'github.com/pulumi/pulumi/sdk/v3/go/auto', 'github.com/pulumi/pulumi/sdk/v3/go/auto/debug', 'github.com/pulumi/pulumi/sdk/v3/go/auto/optdestroy', 'github.com/pulumi/pulumi/sdk/v3/go/auto/optremove', 'github.com/pulumi/pulumi/sdk/v3/go/common/constant', 'github.com/pulumi/pulumi/sdk/v3/go/common/util/retry', 'github.com/pulumi/pulumi/sdk/v3/nodejs/npm'}
...
CODEGEN_TEST_PACKAGES = {'github.com/pulumi/pulumi/pkg/v3/codegen/docs', 'github.com/pulumi/pulumi/pkg/v3/codegen/dotnet', 'github.com/pulumi/pulumi/pkg/v3/codegen/go', 'github.com/pulumi/pulumi/pkg/v3/codegen/nodejs', 'github.com/pulumi/pulumi/pkg/v3/codegen/python'}
...
class MakefileTest(TypedDict):
    ...
    run: str
    eta: int
MAKEFILE_INTEGRATION_TESTS: List[MakefileTest] = [{'name': 'sdk/nodejs test_auto', 'run': 'cd sdk/nodejs && ../../scripts/retry make test_auto', 'eta': 3}, {'name': 'sdk/nodejs unit_tests', 'run': 'cd sdk/nodejs && ../../scripts/retry make unit_tests', 'eta': 4}, {'name': 'sdk/python test_auto', 'run': 'cd sdk/python && ../../scripts/retry make test_auto', 'eta': 6}, {'name': 'sdk/python test_fast', 'run': 'cd sdk/python && ../../scripts/retry make test_fast', 'eta': 3}]
MAKEFILE_UNIT_TESTS: List[MakefileTest] = [{'name': 'sdk/nodejs sxs_tests', 'run': 'cd sdk/nodejs && ../../scripts/retry make sxs_tests', 'eta': 3}]
ALL_PLATFORMS = ['ubuntu-latest', 'windows-latest', 'macos-latest']
MINIMUM_SUPPORTED_VERSION_SET = {'name': 'minimum', 'dotnet': '6', 'go': '1.20.x', 'nodejs': '16.x', 'python': '3.8.x'}
CURRENT_VERSION_SET = {'name': 'current', 'dotnet': '8', 'go': '1.21.x', 'nodejs': '20.x', 'python': '3.11.x'}
...
class TestSuite(TypedDict):
    ...
    name: str
    command: str
Matrix = TypedDict('Matrix', {'test-suite': List[TestSuite], 'platform': List[str], 'version-set': VersionSet})
