...
from torch._prims_common import ELEMENTWISE_TYPE_PROMOTION_KIND, wrappers as _prims_common_wrappers
...
_SCALAR_TYPE_TENSOR_DTYPE_MAP: Mapping[type, torch.dtype] = {bool: torch.bool, int: torch.int64, float: torch.float32, complex: torch.complex32}
