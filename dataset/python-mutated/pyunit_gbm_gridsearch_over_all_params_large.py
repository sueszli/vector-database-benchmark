...
class Test_gbm_grid_search:
    ...
    training1_filenames = ['smalldata/gridsearch/gaussian_training1_set.csv', 'smalldata/gridsearch/multinomial_training1_set.csv']
    ...
    scale_model = 1
    families = ['gaussian', 'multinomial']
    family = 'gaussian'
    training_metric = 'MSE'
    test_name = 'pyunit_gbm_gridsearch_over_all_params_large.py'
    sandbox_dir = ''
    x_indices = []
    y_index = 0
    training1_data = []
    ...
    exclude_parameter_lists = ['distribution', 'tweedie_power', 'validation_frame', 'response_column', 'sample_rate_per_class', 'r2_stopping']
    exclude_parameter_lists.extend(['class_sampling_factors', 'fold_column', 'weights_column', 'offset_column', 'build_tree_one_node', 'score_each_iteration', 'score_tree_interval', 'nbins_top_level'])
    ...
    params_zero_positive = ['max_runtime_secs', 'stopping_rounds', 'ntrees', 'stopping_tolerance', 'min_split_improvement']
