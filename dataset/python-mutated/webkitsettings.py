...
class WebKitSettings(websettings.AbstractSettings):
    ...
    _ATTRIBUTES = {'content.images': Attr(QWebSettings.WebAttribute.AutoLoadImages), 'content.javascript.enabled': Attr(QWebSettings.WebAttribute.JavascriptEnabled), 'content.javascript.can_open_tabs_automatically': Attr(QWebSettings.WebAttribute.JavascriptCanOpenWindows), 'content.javascript.can_close_tabs': Attr(QWebSettings.WebAttribute.JavascriptCanCloseWindows), 'content.javascript.clipboard': Attr(QWebSettings.WebAttribute.JavascriptCanAccessClipboard, converter=lambda val: val != 'none'), 'content.plugins': Attr(QWebSettings.WebAttribute.PluginsEnabled), 'content.webgl': Attr(QWebSettings.WebAttribute.WebGLEnabled), 'content.hyperlink_auditing': Attr(QWebSettings.WebAttribute.HyperlinkAuditingEnabled), 'content.local_content_can_access_remote_urls': Attr(QWebSettings.WebAttribute.LocalContentCanAccessRemoteUrls), 'content.local_content_can_access_file_urls': Attr(QWebSettings.WebAttribute.LocalContentCanAccessFileUrls), 'content.dns_prefetch': Attr(QWebSettings.WebAttribute.DnsPrefetchEnabled), 'content.frame_flattening': Attr(QWebSettings.WebAttribute.FrameFlatteningEnabled), 'content.cache.appcache': Attr(QWebSettings.WebAttribute.OfflineWebApplicationCacheEnabled), 'content.local_storage': Attr(QWebSettings.WebAttribute.LocalStorageEnabled, QWebSettings.WebAttribute.OfflineStorageDatabaseEnabled), 'content.print_element_backgrounds': Attr(QWebSettings.WebAttribute.PrintElementBackgrounds), 'content.xss_auditing': Attr(QWebSettings.WebAttribute.XSSAuditingEnabled), 'content.site_specific_quirks.enabled': Attr(QWebSettings.WebAttribute.SiteSpecificQuirksEnabled), 'input.spatial_navigation': Attr(QWebSettings.WebAttribute.SpatialNavigationEnabled), 'input.links_included_in_focus_chain': Attr(QWebSettings.WebAttribute.LinksIncludedInFocusChain), 'zoom.text_only': Attr(QWebSettings.WebAttribute.ZoomTextOnly), 'scrolling.smooth': Attr(QWebSettings.WebAttribute.ScrollAnimatorEnabled)}
    _FONT_SIZES = {'fonts.web.size.minimum': QWebSettings.FontSize.MinimumFontSize, 'fonts.web.size.minimum_logical': QWebSettings.FontSize.MinimumLogicalFontSize, 'fonts.web.size.default': QWebSettings.FontSize.DefaultFontSize, 'fonts.web.size.default_fixed': QWebSettings.FontSize.DefaultFixedFontSize}
    _FONT_FAMILIES = {'fonts.web.family.standard': QWebSettings.FontFamily.StandardFont, 'fonts.web.family.fixed': QWebSettings.FontFamily.FixedFont, 'fonts.web.family.serif': QWebSettings.FontFamily.SerifFont, 'fonts.web.family.sans_serif': QWebSettings.FontFamily.SansSerifFont, 'fonts.web.family.cursive': QWebSettings.FontFamily.CursiveFont, 'fonts.web.family.fantasy': QWebSettings.FontFamily.FantasyFont}
    _FONT_TO_QFONT = {QWebSettings.FontFamily.StandardFont: QFont.StyleHint.Serif, QWebSettings.FontFamily.FixedFont: QFont.StyleHint.Monospace, QWebSettings.FontFamily.SerifFont: QFont.StyleHint.Serif, QWebSettings.FontFamily.SansSerifFont: QFont.StyleHint.SansSerif, QWebSettings.FontFamily.CursiveFont: QFont.StyleHint.Cursive, QWebSettings.FontFamily.FantasyFont: QFont.StyleHint.Fantasy}
