...
render_utils_cuda = load(name='render_utils_cuda', sources=[os.path.join(parent_dir, path) for path in ['ops/4knerf/render_utils.cpp', 'ops/4knerf/render_utils_kernel.cu']], verbose=True)
