...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        for distname in targetdist:
            ...
            quant = 0.1
            crit = distfn.ppf(1 - quant * float(rind), *par_est, loc=loc_est, scale=scale_est)
    ...
    for (ii, di) in enumerate(res_sort):
        ...
        if distname in right_all:
            ...
            ri = ''
            rind = 1
        print('%s ks-stat = %f, ks-pval = %f tail_prob = %f)' % (distname, ks_stat, ks_pval, tail_prob))
