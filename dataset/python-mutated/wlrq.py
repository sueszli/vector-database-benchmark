...
class WlrQError(QtileError):
    pass
ModMasks = {'shift': KeyboardModifier.SHIFT, 'lock': KeyboardModifier.CAPS, 'control': KeyboardModifier.CTRL, 'mod1': KeyboardModifier.ALT, 'mod2': KeyboardModifier.MOD2, 'mod3': KeyboardModifier.MOD3, 'mod4': KeyboardModifier.LOGO, 'mod5': KeyboardModifier.MOD5}
_KEY_MAX = 767
BTN_LEFT = 272
BTN_MIDDLE = 274
BTN_RIGHT = 273
...
BTN_SIDE = 275
BTN_EXTRA = 276
buttons = [BTN_LEFT, BTN_MIDDLE, BTN_RIGHT, SCROLL_UP, SCROLL_DOWN, SCROLL_LEFT, SCROLL_RIGHT, BTN_SIDE, BTN_EXTRA]
