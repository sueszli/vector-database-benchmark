...
CONDITIONAL_DETR_PRETRAINED_MODEL_ARCHIVE_LIST = ['microsoft/conditional-detr-resnet-50']
...
class ConditionalDetrEncoder(ConditionalDetrPreTrainedModel):
    ...
    def forward(self, inputs_embeds=None, attention_mask=None, object_queries=None, output_attentions=None, output_hidden_states=None, return_dict=None, **kwargs):
        if False:
            i = 10
            return i + 15
