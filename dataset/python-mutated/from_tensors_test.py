...
class FromTensorsCheckpointTest(checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
...
class FromTensorsRandomAccessTest(test_base.DatasetTestBase, parameterized.TestCase):
