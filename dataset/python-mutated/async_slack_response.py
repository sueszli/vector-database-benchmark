...
class AsyncSlackResponse:
    ...
    def __init__(self, *, client, http_verb: str, api_url: str, req_args: dict, data: Union[dict, bytes], headers: dict, status_code: int):
        if False:
            for i in range(10):
                print('nop')
    ...
    async def __anext__(self):
        ...
        if _next_cursor_is_present(self.data):
            ...
            response = await self._client._request(http_verb=self.http_verb, api_url=self.api_url, req_args=self.req_args)
