...
class ImagesPipelineTestCaseCustomSettings(unittest.TestCase):
    skip = skip_pillow
    img_cls_attribute_names = [('EXPIRES', 'IMAGES_EXPIRES'), ('MIN_WIDTH', 'IMAGES_MIN_WIDTH'), ('MIN_HEIGHT', 'IMAGES_MIN_HEIGHT'), ('IMAGES_URLS_FIELD', 'IMAGES_URLS_FIELD'), ('IMAGES_RESULT_FIELD', 'IMAGES_RESULT_FIELD'), ('THUMBS', 'IMAGES_THUMBS')]
    default_pipeline_settings = dict(MIN_WIDTH=0, MIN_HEIGHT=0, EXPIRES=90, THUMBS={}, IMAGES_URLS_FIELD='image_urls', IMAGES_RESULT_FIELD='images')
