...
class TestSamFunctionProvider_search_layer(TestCase):
    root_stack_template = {'Resources': {'LayerStack': {'Type': 'AWS::Serverless::Application', 'Properties': {'Location': 'child_layer/template.yaml'}}, 'FunctionStack': {'Type': 'AWS::Serverless::Application', 'Properties': {'Location': 'child_function/template.yaml', 'Parameters': {'Layer': {'Fn::GetAtt': ['LayerStack', 'Outputs.LayerName']}}}}}}
    layer_stack_template = {'Resources': {'SamLayer': {'Type': 'AWS::Serverless::LayerVersion', 'Properties': {'LayerName': 'SamLayer', 'Description': 'Sam', 'ContentUri': 'layer/', 'CompatibleRuntimes': ['python3.7']}}}, 'Outputs': {'LayerName': {'Description': 'The name of the layer', 'Value': {'Ref': 'SamLayer'}}}}
    function_stack_template = {'Parameters': {'Layer': {'Type': 'String'}}, 'Resources': {'SamFunctions': {'Type': 'AWS::Serverless::Function', 'Properties': {'FunctionName': 'SamFunc1', 'CodeUri': '/usr/foo/bar', 'Runtime': 'nodejs4.3', 'Handler': 'index.handler', 'Layers': {'Ref': 'Layer'}}}}}
