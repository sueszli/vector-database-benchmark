...
qarithmetic_binary_configs = op_bench.cross_product_configs(N=(2, 8, 64, 512), dtype=(torch.quint8, torch.qint8, torch.qint32), contig=(False, True), tags=('short',))
qarithmetic_binary_ops = op_bench.op_list(attrs=(('add', ops.quantized.add), ('add_relu', ops.quantized.add_relu), ('mul', ops.quantized.mul)), attr_names=('op_name', 'op_func'))
qarithmetic_binary_scalar_ops = op_bench.op_list(attrs=(('add_scalar', ops.quantized.add_scalar), ('mul_scalar', ops.quantized.mul_scalar)), attr_names=('op_name', 'op_func'))
...
op_bench.generate_pt_tests_from_op_list(qarithmetic_binary_ops, qarithmetic_binary_configs, QFunctionalBenchmark)
...
op_bench.generate_pt_tests_from_op_list(qarithmetic_binary_scalar_ops, qarithmetic_binary_configs, QFunctionalScalarBenchmark)
