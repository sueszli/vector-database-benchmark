...
class GBDTTrainer(BaseTrainer):
    ...
    """
    _scaling_config_allowed_keys = BaseTrainer._scaling_config_allowed_keys + ['num_workers', 'resources_per_worker', 'use_gpu', 'placement_strategy']
    _handles_checkpoint_freq = True
    _handles_checkpoint_at_end = True
    _dmatrix_cls: type
    _ray_params_cls: type
    _tune_callback_checkpoint_cls: type
    _default_ray_params: Dict[str, Any] = {'checkpoint_frequency': 1, 'checkpoint_at_end': True}
