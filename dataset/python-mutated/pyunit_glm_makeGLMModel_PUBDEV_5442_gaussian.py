...
def test_makeGLMModel():
    ...
    try:
        ...
        print(ex)
        temp = str(ex)
        assert 'Server error java.lang.IllegalArgumentException:' in temp and 'model coefficient length 9 is different from coefficient provided by user ' in temp, 'Wrong exception was received.'
