...
class KwOnlyNotOk:
    ...
    def __init__(self, arg, *, kwo, another):
        if False:
            print('Hello World!')
        pass
ROBOT_LIBRARY_CONVERTERS = {Number: string_to_int, bool: parse_bool, String: int_to_string_with_lib, UsDate: UsDate.from_string, FiDate: FiDate.from_string, ClassAsConverter: ClassAsConverter, ClassWithHintsAsConverter: ClassWithHintsAsConverter, AcceptSubscriptedGenerics: AcceptSubscriptedGenerics, OnlyVarArg: OnlyVarArg, Strict: None, Invalid: 666, TooFewArgs: TooFewArgs, TooManyArgs: TooManyArgs, NoPositionalArg: NoPositionalArg, KwOnlyNotOk: KwOnlyNotOk, 'Bad': int}
