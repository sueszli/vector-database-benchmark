...
(exp_models, opportunity_models, story_models, topic_models, skill_models, question_models) = models.Registry.import_models([models.Names.EXPLORATION, models.Names.OPPORTUNITY, models.Names.STORY, models.Names.TOPIC, models.Names.SKILL, models.Names.QUESTION])
datastore_services = models.Registry.import_datastore_services()

class DeleteSkillOpportunityModelJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[opportunity_management_jobs.DeleteSkillOpportunityModelJob] = opportunity_management_jobs.DeleteSkillOpportunityModelJob
...
class GenerateSkillOpportunityModelJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[opportunity_management_jobs.GenerateSkillOpportunityModelJob] = opportunity_management_jobs.GenerateSkillOpportunityModelJob
...
class DeleteExplorationOpportunitySummariesJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[opportunity_management_jobs.DeleteExplorationOpportunitySummariesJob] = opportunity_management_jobs.DeleteExplorationOpportunitySummariesJob
...
class GenerateExplorationOpportunitySummariesJobTests(job_test_utils.JobTestBase):
    JOB_CLASS: Type[opportunity_management_jobs.GenerateExplorationOpportunitySummariesJob] = opportunity_management_jobs.GenerateExplorationOpportunitySummariesJob
