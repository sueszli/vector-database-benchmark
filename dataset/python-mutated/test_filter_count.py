...
from cleanlab.count import get_confident_thresholds, estimate_py_and_noise_matrices_from_probabilities
...
pred_probs_ = np.array([[0.9, 0.1, 0], [0.6, 0.2, 0.2], [0.1, 0, 0.9], [0.1, 0.8, 0.1], [0.1, 0.8, 0.1], [0.1, 0.8, 0.1], [0.1, 0.8, 0.1], [0.1, 0.8, 0.1], [0.1, 0.8, 0.1], [0.1, 0.1, 0.8]])
