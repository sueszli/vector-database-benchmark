...
class Migration(migrations.Migration):
    dependencies = [('api_app', '0022_single_playbook_post_migration'), ('analyzers_manager', '00012_remove_parent_playbook'), ('connectors_manager', '0010_remove_parent_playbook'), ('visualizers_manager', '0009_remove_parent_playbook')]
    operations = [migrations.AddField(model_name='job', name='runtime_configuration', field=models.JSONField(blank=False, default=default_runtime, null=False, validators=[validate_runtime_configuration])), migrations.RunPython(migrate_runtime_config, reverse_migrate_runtime_config)]