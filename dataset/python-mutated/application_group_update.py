...
def main():
    ...
    response = client.application_groups.update(resource_group_name='resourceGroup1', application_group_name='applicationGroup1')
    print(response)
