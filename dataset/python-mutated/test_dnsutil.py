...
mock_hosts_file_rtn = {'::1': ['localhost'], '255.255.255.255': ['broadcasthost'], '127.0.0.1': ['localhost'], 'fe80::1%lo0': ['localhost']}
mock_soa_zone = salt.utils.stringutils.to_str('$TTL 3D\n@               IN      SOA     land-5.com. root.land-5.com. (\n199609203       ; Serial\n28800   ; Refresh\n7200    ; Retry\n604800  ; Expire\n86400)  ; Minimum TTL\nNS      land-5.com.\n\n1                       PTR     localhost.')
