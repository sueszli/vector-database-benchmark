...
__protobuf__ = proto.module(package='google.cloud.networkmanagement.v1', manifest={'ListConnectivityTestsRequest', 'ListConnectivityTestsResponse', 'GetConnectivityTestRequest', 'CreateConnectivityTestRequest', 'UpdateConnectivityTestRequest', 'DeleteConnectivityTestRequest', 'RerunConnectivityTestRequest', 'OperationMetadata'})
...
class ListConnectivityTestsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    resources: MutableSequence[connectivity_test.ConnectivityTest] = proto.RepeatedField(proto.MESSAGE, number=1, message=connectivity_test.ConnectivityTest)
...
class CreateConnectivityTestRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    test_id: str = proto.Field(proto.STRING, number=2)
    resource: connectivity_test.ConnectivityTest = proto.Field(proto.MESSAGE, number=3, message=connectivity_test.ConnectivityTest)
...
class UpdateConnectivityTestRequest(proto.Message):
    ...
    resource: connectivity_test.ConnectivityTest = proto.Field(proto.MESSAGE, number=2, message=connectivity_test.ConnectivityTest)
