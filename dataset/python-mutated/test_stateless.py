...
from torch.testing._internal.common_utils import run_tests, TestCase, parametrize, instantiate_parametrized_tests, subtest
...
instantiate_parametrized_tests(TestStatelessFunctionalAPI)
