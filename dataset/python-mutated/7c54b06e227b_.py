...
from sqlalchemy import Column, Boolean, Integer, String, JSON, ForeignKey, Text, BigInteger, DateTime, Unicode, text, Table
...
issue_item_association = Table('issue_item_association', Base.metadata, Column('super_issue_id', Integer, ForeignKey('itemaudit.id'), primary_key=True), Column('sub_item_id', Integer, ForeignKey('item.id'), primary_key=True))
