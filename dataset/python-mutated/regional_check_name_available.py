...
def main():
    ...
    response = client.operations.regional_check_name_availability(location='westus', check_name_availability_parameters={'name': 'contoso', 'type': 'Microsoft.AppConfiguration/configurationStores'})
    print(response)
