...
from . import configuration as configuration_module, find_directories, frontend_configuration, identifiers
...
class BaseArguments:
    ...
    python_version: configuration_module.PythonVersion = configuration_module.PythonVersion(major=3)
    shared_memory: configuration_module.SharedMemory = configuration_module.SharedMemory()
    remote_logging: Optional[RemoteLogging] = None
    search_paths: Sequence[search_path.Element] = dataclasses.field(default_factory=list)
