    ...
    Attributes:
        ...
        switch_inline_query_chosen_chat (:obj:`telegram.SwitchInlineQueryChosenChat`): Optional.
            ...
            Caution:
                ...
                client is released after April 20th 2023.
    """
    __slots__ = ('callback_game', 'url', 'switch_inline_query_current_chat', 'callback_data', 'pay', 'switch_inline_query', 'text', 'login_url', 'web_app', 'switch_inline_query_chosen_chat')
