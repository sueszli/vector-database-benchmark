...
from .operations import AlertProcessingRulesOperations, AlertsOperations, Operations, PrometheusRuleGroupsOperations, SmartGroupsOperations
if TYPE_CHECKING:
...
class AlertsManagementClient:
    ...
    def __init__(self, credential: 'AsyncTokenCredential', subscription_id: str, base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        ...
        self.prometheus_rule_groups = PrometheusRuleGroupsOperations(self._client, self._config, self._serialize, self._deserialize)
