...
from woodwork.logical_types import Boolean, BooleanNullable, Datetime, Double, NaturalLanguage, Ordinal
from featuretools.entityset.entityset import EntitySet
from featuretools.feature_discovery.feature_discovery import _get_features, _get_matching_features, _index_column_set, generate_features_from_primitives, schema_to_features
...
from featuretools.primitives import Absolute, AddNumeric, Count, DateFirstEvent, Equal, Lag, MultiplyNumericBoolean, NumUnique, TransformPrimitive
from featuretools.primitives.utils import get_transform_primitives
from featuretools.synthesis import dfs
from featuretools.tests.testing_utils.generate_fake_dataframe import generate_fake_dataframe
DEFAULT_LT_FOR_TAG = {'category': Ordinal, 'numeric': Double, 'time_index': Datetime}
