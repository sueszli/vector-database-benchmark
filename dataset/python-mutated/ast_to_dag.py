...
class AstInterpreter:
    ...
    standard_extension = {'u1': std.U1Gate, 'u2': std.U2Gate, 'u3': std.U3Gate, 'u': std.UGate, 'p': std.PhaseGate, 'x': std.XGate, 'y': std.YGate, 'z': std.ZGate, 't': std.TGate, 'tdg': std.TdgGate, 's': std.SGate, 'sdg': std.SdgGate, 'sx': std.SXGate, 'sxdg': std.SXdgGate, 'swap': std.SwapGate, 'rx': std.RXGate, 'rxx': std.RXXGate, 'ry': std.RYGate, 'rz': std.RZGate, 'rzz': std.RZZGate, 'id': std.IGate, 'h': std.HGate, 'cx': std.CXGate, 'cy': std.CYGate, 'cz': std.CZGate, 'ch': std.CHGate, 'crx': std.CRXGate, 'cry': std.CRYGate, 'crz': std.CRZGate, 'csx': std.CSXGate, 'cu1': std.CU1Gate, 'cp': std.CPhaseGate, 'cu': std.CUGate, 'cu3': std.CU3Gate, 'ccx': std.CCXGate, 'cswap': std.CSwapGate, 'delay': Delay, 'rccx': std.RCCXGate, 'rc3x': std.RC3XGate, 'c3x': std.C3XGate, 'c3sqrtx': std.C3SXGate, 'c4x': std.C4XGate}
