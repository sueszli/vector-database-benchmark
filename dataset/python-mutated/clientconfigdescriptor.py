...
class ConfigApprover(object):
    """Change specific config description option from strings to the right
       ...
       """
    to_int_opt = {'seed_port', 'num_cores', 'opt_peer_num', 'p2p_session_timeout', 'task_session_timeout', 'pings_interval', 'max_results_sending_delay'}
    to_big_int_opt = {'min_price', 'max_price'}
    to_float_opt = {'getting_peers_interval', 'getting_tasks_interval', 'computing_trust', 'requesting_trust'}
