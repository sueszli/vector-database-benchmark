...
from airflow.providers.dbt.cloud.operators.dbt import DbtCloudGetJobRunArtifactOperator, DbtCloudListJobsOperator, DbtCloudRunJobOperator
...
DEFAULT_ACCOUNT_JOB_RUN_RESPONSE = {'data': {'id': RUN_ID, 'href': EXPECTED_JOB_RUN_OP_EXTRA_LINK.format(account_id=DEFAULT_ACCOUNT_ID, project_id=PROJECT_ID, run_id=RUN_ID)}}
EXPLICIT_ACCOUNT_JOB_RUN_RESPONSE = {'data': {'id': RUN_ID, 'href': EXPECTED_JOB_RUN_OP_EXTRA_LINK.format(account_id=ACCOUNT_ID, project_id=PROJECT_ID, run_id=RUN_ID)}}
