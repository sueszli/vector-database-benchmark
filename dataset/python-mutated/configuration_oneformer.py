...
ONEFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {'shi-labs/oneformer_ade20k_swin_tiny': 'https://huggingface.co/shi-labs/oneformer_ade20k_swin_tiny/blob/main/config.json'}
