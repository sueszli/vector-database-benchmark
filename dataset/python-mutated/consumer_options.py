...
config_defaults = (('workers', 1), ('worker_type', WORKER_THREAD), ('initial_delay', 0.1), ('backoff', 1.15), ('max_delay', 10.0), ('check_worker_health', True), ('health_check_interval', 10), ('scheduler_interval', 1), ('periodic', True), ('logfile', None), ('verbose', None), ('simple_log', None), ('flush_locks', False), ('extra_locks', None))
