...
class NumberPlane(Axes):
    default_axis_config: dict = dict(stroke_color=WHITE, stroke_width=2, include_ticks=False, include_tip=False, line_to_number_buff=SMALL_BUFF, line_to_number_direction=DL)
    default_y_axis_config: dict = dict(line_to_number_direction=DL)
