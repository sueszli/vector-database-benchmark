...
class TestPSMinimize(unittest.TestCase):
    ...
    def gen_sparse_config(self):
        ...
        sparse_config['sparse_accessor_class'] = 'DownpourCtrDymfAccessor'
        sparse_config['sparse_learning_rate'] = 0.05
        sparse_config['sparse_initial_g2sum'] = 3
        sparse_config['sparse_initial_range'] = 0.02
        sparse_config['sparse_weight_bounds'] = [-10.0, 10.0]
        sparse_config['sparse_embedx_dim'] = 8
        ...
        sparse_config['embed_sparse_optimizer'] = 'adagrad'
        sparse_config['embed_sparse_learning_rate'] = 0.05
        sparse_config['embed_sparse_initial_range'] = 0
        sparse_config['embed_sparse_beta1_decay_rate'] = 0.9
        sparse_config['embed_sparse_beta2_decay_rate'] = 0.999
        sparse_config['embed_sparse_weight_bounds'] = [-10.0, 10.0]
        sparse_config['embedx_sparse_optimizer'] = 'adagrad'
        sparse_config['embedx_sparse_learning_rate'] = 0.05
        sparse_config['embedx_sparse_initial_range'] = 0.02
        sparse_config['embedx_sparse_beta1_decay_rate'] = 0.9
        sparse_config['embedx_sparse_beta2_decay_rate'] = 0.999
