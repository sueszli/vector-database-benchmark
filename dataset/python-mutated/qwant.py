...
traits: EngineTraits
about = {'website': 'https://www.qwant.com/', 'wikidata_id': 'Q14657870', 'official_api_documentation': None, 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
categories = []
paging = True
qwant_categ = None
'One of ``web-lite`` (or ``web``), ``news``, ``images`` or ``videos``'
safesearch = True
qwant_news_locales = ['ca_ad', 'ca_es', 'ca_fr', 'co_fr', 'de_at', 'de_ch', 'de_de', 'en_au', 'en_ca', 'en_gb', 'en_ie', 'en_my', 'en_nz', 'en_us', 'es_ad', 'es_ar', 'es_cl', 'es_co', 'es_es', 'es_mx', 'es_pe', 'eu_es', 'eu_fr', 'fc_ca', 'fr_ad', 'fr_be', 'fr_ca', 'fr_ch', 'fr_fr', 'it_ch', 'it_it', 'nl_be', 'nl_nl', 'pt_ad', 'pt_pt']
