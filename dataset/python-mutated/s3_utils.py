...
BOTO3_ERR_MSG = 'The boto3 library is required to read and write from URLs and S3.\nInstall via pip:\n    pip install boto3\nInstall via conda:\n    conda install -c conda-forge boto3'
BOTOCORE_ERR_MSG = 'The botocore library is required to read and write from URLs and S3.\nInstall via pip:\n    pip install botocore\nInstall via conda:\n    conda install -c conda-forge botocore'
SMART_OPEN_ERR_MSG = "The smart_open library is required to read and write from URLs and S3.\nInstall via pip:\n    pip install 'smart-open>=5.0.0'\nInstall via conda:\n    conda install -c conda-forge 'smart_open>=5.0.0'"