...
flags.DEFINE_integer('num_predict', default=None, help='Number of tokens to predict in partial prediction.')
flags.DEFINE_integer('perm_size', 0, help='Window size of permutation.')
flags.DEFINE_float('leak_ratio', default=0.1, help='Percent of masked tokens that are leaked.')
flags.DEFINE_enum('sample_strategy', default='token_span', enum_values=['single_token', 'whole_word', 'token_span', 'word_span'], help='Stragey used to sample prediction targets.')
flags.DEFINE_integer('max_num_tokens', default=5, help='Maximum number of tokens to sample in a span.Effective when token_span strategy is used.')
flags.DEFINE_integer('min_num_tokens', default=1, help='Minimum number of tokens to sample in a span.Effective when token_span strategy is used.')
flags.DEFINE_integer('max_num_words', default=5, help='Maximum number of whole words to sample in a span.Effective when word_span strategy is used.')
flags.DEFINE_integer('min_num_words', default=1, help='Minimum number of whole words to sample in a span.Effective when word_span strategy is used.')
FLAGS = flags.FLAGS
