...
RESULTS_TO_FETCH = {'^microbenchmark.aws \\(.+\\)$': 'microbenchmark.json', '^many_actors.aws \\(.+\\)$': 'benchmarks/many_actors.json', '^many_nodes.aws \\(.+\\)$': 'benchmarks/many_nodes.json', '^many_pgs.aws \\(.+\\)$': 'benchmarks/many_pgs.json', '^many_tasks.aws \\(.+\\)$': 'benchmarks/many_tasks.json', '^object_store.aws \\(.+\\)$': 'scalability/object_store.json', '^single_node.aws \\(.+\\)$': 'scalability/single_node.json', '^stress_test_dead_actors.aws \\(.+\\)$': 'stress_tests/stress_test_dead_actors.json', '^stress_test_many_tasks.aws \\(.+\\)$': 'stress_tests/stress_test_many_tasks.json', '^stress_test_placement_group.aws \\(.+\\)$': 'stress_tests/stress_test_placement_group.json'}
