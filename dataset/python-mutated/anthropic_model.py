...
class AnthropicModel(BaseLLM):
    ...
    def _init_client(self) -> Any:
        ...
        return AnthropicLLM(model=self.name, streaming=self.streaming, callbacks=self.callbacks, default_request_timeout=60, **self.credentials, **provider_model_kwargs)
