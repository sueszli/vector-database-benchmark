...
from transformers.testing_utils import require_essentia, require_librosa, require_pretty_midi, require_scipy, require_torch
from transformers.tokenization_utils import BatchEncoding
from transformers.utils.import_utils import is_essentia_available, is_librosa_available, is_pretty_midi_available, is_scipy_available, is_torch_available
requirements_available = is_torch_available() and is_essentia_available() and is_scipy_available() and is_librosa_available() and is_pretty_midi_available()
if requirements_available:
    import pretty_midi
    from transformers import Pop2PianoFeatureExtractor, Pop2PianoForConditionalGeneration, Pop2PianoProcessor, Pop2PianoTokenizer
