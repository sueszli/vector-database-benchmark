...
flags.DEFINE_integer('eval_batch_size', default=64, help='batch size for evaluation')
...
flags.DEFINE_bool('use_bert_format', default=False, help='Whether to use BERT format to arrange input data.')
FLAGS = flags.FLAGS
