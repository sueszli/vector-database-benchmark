...
class SourceControlSyncJobOperations:
    ...
    @overload
    async def create(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, parameters: _models.SourceControlSyncJobCreateParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.SourceControlSyncJob:
    ...
    @overload
    async def create(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.SourceControlSyncJob:
        """Creates the sync job for a source control.
    ...
    async def create(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, parameters: Union[_models.SourceControlSyncJobCreateParameters, IO], **kwargs: Any) -> _models.SourceControlSyncJob:
        """Creates the sync job for a source control.
        ...
        :type parameters: ~azure.mgmt.automation.models.SourceControlSyncJobCreateParameters or IO
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, **kwargs: Any) -> _models.SourceControlSyncJobById:
        ...
        request = build_get_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, source_control_name=source_control_name, source_control_sync_job_id=source_control_sync_job_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace
    def list_by_automation_account(self, resource_group_name: str, automation_account_name: str, source_control_name: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.SourceControlSyncJob']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_by_automation_account_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, source_control_name=source_control_name, subscription_id=self._config.subscription_id, filter=filter, api_version=api_version, template_url=self.list_by_automation_account.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
