...
class ParameterServerStrategyTest(ParameterServerStrategyTestBase, strategy_test_lib.DistributionTestBase, strategy_test_lib.TwoDeviceDistributionTestBase, parameterized.TestCase):
...
class ParameterServerStrategyWithChiefTest(ParameterServerStrategyTestBase, parameterized.TestCase):
...
class CentralStorageStrategyTest(strategy_test_lib.DistributionTestBase, parameterized.TestCase):
