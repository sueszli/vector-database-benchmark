...
from airflow.providers.google.cloud.operators.vertex_ai.auto_ml import CreateAutoMLForecastingTrainingJobOperator, CreateAutoMLImageTrainingJobOperator, CreateAutoMLTabularTrainingJobOperator, CreateAutoMLTextTrainingJobOperator, CreateAutoMLVideoTrainingJobOperator, DeleteAutoMLTrainingJobOperator, ListAutoMLTrainingJobOperator
from airflow.providers.google.cloud.operators.vertex_ai.batch_prediction_job import CreateBatchPredictionJobOperator, DeleteBatchPredictionJobOperator, ListBatchPredictionJobsOperator
from airflow.providers.google.cloud.operators.vertex_ai.custom_job import CreateCustomContainerTrainingJobOperator, CreateCustomPythonPackageTrainingJobOperator, CreateCustomTrainingJobOperator, DeleteCustomTrainingJobOperator, ListCustomTrainingJobOperator
from airflow.providers.google.cloud.operators.vertex_ai.dataset import CreateDatasetOperator, DeleteDatasetOperator, ExportDataOperator, ImportDataOperator, ListDatasetsOperator, UpdateDatasetOperator
from airflow.providers.google.cloud.operators.vertex_ai.endpoint_service import CreateEndpointOperator, DeleteEndpointOperator, DeployModelOperator, ListEndpointsOperator, UndeployModelOperator
from airflow.providers.google.cloud.operators.vertex_ai.hyperparameter_tuning_job import CreateHyperparameterTuningJobOperator, DeleteHyperparameterTuningJobOperator, GetHyperparameterTuningJobOperator, ListHyperparameterTuningJobOperator
from airflow.providers.google.cloud.operators.vertex_ai.model_service import AddVersionAliasesOnModelOperator, DeleteModelOperator, DeleteModelVersionOperator, DeleteVersionAliasesOnModelOperator, ExportModelOperator, GetModelOperator, ListModelsOperator, ListModelVersionsOperator, SetDefaultVersionOnModelOperator, UploadModelOperator
from airflow.providers.google.cloud.operators.vertex_ai.pipeline_job import DeletePipelineJobOperator, GetPipelineJobOperator, ListPipelineJobOperator, RunPipelineJobOperator
...
TEST_DATASET = {'display_name': 'test-dataset-name', 'metadata_schema_uri': 'gs://google-cloud-aiplatform/schema/dataset/metadata/image_1.0.0.yaml', 'metadata': 'test-image-dataset'}
TEST_DATASET_ID = 'test-dataset-id'
TEST_EXPORT_CONFIG = {'annotationsFilter': 'test-filter', 'gcs_destination': {'output_uri_prefix': 'airflow-system-tests-data'}}
TEST_IMPORT_CONFIG = [{'data_item_labels': {'test-labels-name': 'test-labels-value'}, 'import_schema_uri': 'test-shema-uri', 'gcs_source': {'uris': ['test-string']}}, {}]
...
TEST_ENDPOINT = {'display_name': 'endpoint_test'}
TEST_ENDPOINT_ID = '1234567890'
TEST_DEPLOYED_MODEL = {'model': f'projects/{GCP_PROJECT}/locations/{GCP_LOCATION}/models/test_model_id', 'display_name': 'temp_endpoint_test', 'dedicated_resources': {'min_replica_count': 1, 'max_replica_count': 1}}
TEST_DEPLOYED_MODEL_ID = 'test_deployed_model_id'
TEST_HYPERPARAMETER_TUNING_JOB_ID = 'test_hyperparameter_tuning_job_id'
TEST_OUTPUT_CONFIG = {'artifact_destination': {'output_uri_prefix': 'gcs_destination_output_uri_prefix'}, 'export_format_id': 'tf-saved-model'}
