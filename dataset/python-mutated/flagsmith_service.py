...
ENVIRONMENT_JSON_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data/environment.json')
KEEP_ENVIRONMENT_FIELDS = ('name', 'feature_states', 'use_identity_composite_key_for_hashing')
KEEP_PROJECT_FIELDS = ('name', 'organisation', 'hide_disabled_flags')
KEEP_ORGANISATION_FIELDS = ('name', 'feature_analytics', 'stop_serving_flags', 'persist_trait_data')
