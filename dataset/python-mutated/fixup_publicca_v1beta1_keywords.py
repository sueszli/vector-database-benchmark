...
class publiccaCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_external_account_key': ('parent', 'external_account_key')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=publiccaCallTransformer()):
    if False:
        i = 10
        return i + 15
