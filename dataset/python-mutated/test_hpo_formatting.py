...
user_space = {'pool': {'_type': 'choice', '_value': ['max', 'min', 'avg']}, 'kernel': {'_type': 'randint', '_value': [2, 8]}, 'D': {'_type': 'choice', '_value': [{'_name': 'UNIFORM', 'dropout': {'_type': 'uniform', '_value': [0.5, 0.9]}, 'hidden': {'_type': 'quniform', '_value': [100, 1000, 3]}, 'U_lr': {'_type': 'loguniform', '_value': [0.0001, 0.1]}, 'U_batch': {'_type': 'qloguniform', '_value': [16.0, 128.0, 0.725]}}, {'_name': 'NORMAL', 'dropout': {'_type': 'normal', '_value': [0.7, 0.2]}, 'hidden': {'_type': 'qnormal', '_value': [500, 200, 3]}, 'N_lr': {'_type': 'lognormal', '_value': [-6, 3]}, 'N_batch': {'_type': 'qlognormal', '_value': [3.5, 1.2, 0.725]}}, {'_name': 'EMPTY'}]}, 'not_nested': {'_type': 'choice', '_value': [{'x': 0, 'y': 0}, {'x': 1, 'y': 2}]}}
...
internal_params_1 = {('pool',): 0, ('kernel',): 5, ('D',): 0, ('D', 0, 'dropout'): 0.7, ('D', 0, 'hidden'): 100.1, ('D', 0, 'U_lr'): -4.6, ('D', 0, 'U_batch'): 4.0, ('not_nested',): 0}
user_params_1 = {'pool': 'max', 'kernel': 7, 'D': {'_name': 'UNIFORM', 'dropout': 0.7, 'hidden': 100.0, 'U_lr': exp(-4.6), 'U_batch': 54.375}, 'not_nested': {'x': 0, 'y': 0}}
...
internal_params_2 = {('pool',): 2, ('kernel',): 0, ('D',): 1, ('D', 1, 'dropout'): 0.7, ('D', 1, 'hidden'): 100.1, ('D', 1, 'N_lr'): -4.6, ('D', 1, 'N_batch'): 4.0, ('not_nested',): 1}
user_params_2 = {'pool': 'avg', 'kernel': 2, 'D': {'_name': 'NORMAL', 'dropout': 0.7, 'hidden': 99.0, 'N_lr': exp(-4.6), 'N_batch': 54.375}, 'not_nested': {'x': 1, 'y': 2}}
...
internal_params_3 = {('pool',): 1, ('kernel',): 1, ('D',): 2, ('not_nested',): 1}
user_params_3 = {'pool': 'min', 'kernel': 3, 'D': {'_name': 'EMPTY'}, 'not_nested': {'x': 1, 'y': 2}}
