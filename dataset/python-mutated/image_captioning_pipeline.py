...
from modelscope.models.multi_modal import CLIP_Interrogator, MPlugForAllTasks, OfaForAllTasks
from modelscope.pipelines.base import Model, Pipeline
from modelscope.pipelines.builder import PIPELINES
from modelscope.pipelines.util import batch_process
from modelscope.preprocessors import ImageCaptioningClipInterrogatorPreprocessor, MPlugPreprocessor, OfaPreprocessor, Preprocessor, load_image
from modelscope.utils.constant import ModelFile, Tasks
from modelscope.utils.logger import get_logger
logger = get_logger()

@PIPELINES.register_module(Tasks.image_captioning, module_name=Pipelines.image_captioning)
