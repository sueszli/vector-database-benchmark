...
__protobuf__ = proto.module(package='google.cloud.gkemulticloud.v1', manifest={'GenerateAttachedClusterInstallManifestRequest', 'GenerateAttachedClusterInstallManifestResponse', 'CreateAttachedClusterRequest', 'ImportAttachedClusterRequest', 'UpdateAttachedClusterRequest', 'GetAttachedClusterRequest', 'ListAttachedClustersRequest', 'ListAttachedClustersResponse', 'DeleteAttachedClusterRequest', 'GetAttachedServerConfigRequest'})
...
class GenerateAttachedClusterInstallManifestRequest(proto.Message):
    ...
    attached_cluster_id: str = proto.Field(proto.STRING, number=2)
    platform_version: str = proto.Field(proto.STRING, number=3)
...
class GenerateAttachedClusterInstallManifestResponse(proto.Message):
    ...
    Attributes:
        manifest (str):
            ...
            attached.
    """
    manifest: str = proto.Field(proto.STRING, number=1)
...
class CreateAttachedClusterRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    attached_cluster: attached_resources.AttachedCluster = proto.Field(proto.MESSAGE, number=2, message=attached_resources.AttachedCluster)
    attached_cluster_id: str = proto.Field(proto.STRING, number=3)
...
class ImportAttachedClusterRequest(proto.Message):
    ...
    fleet_membership: str = proto.Field(proto.STRING, number=3)
    platform_version: str = proto.Field(proto.STRING, number=4)
    distribution: str = proto.Field(proto.STRING, number=5)
...
class UpdateAttachedClusterRequest(proto.Message):
    ...
    """
    attached_cluster: attached_resources.AttachedCluster = proto.Field(proto.MESSAGE, number=1, message=attached_resources.AttachedCluster)
    validate_only: bool = proto.Field(proto.BOOL, number=2)
...
class ListAttachedClustersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    attached_clusters: MutableSequence[attached_resources.AttachedCluster] = proto.RepeatedField(proto.MESSAGE, number=1, message=attached_resources.AttachedCluster)
...
class DeleteAttachedClusterRequest(proto.Message):
    ...
    ignore_errors: bool = proto.Field(proto.BOOL, number=5)
    etag: str = proto.Field(proto.STRING, number=4)

class GetAttachedServerConfigRequest(proto.Message):
    """GetAttachedServerConfigRequest gets the server config for
    attached clusters.
