...
from art.attacks.evasion.graphite.utils import convert_to_network, get_transform_params, add_noise, get_transformed_images, run_predictions, score_fn
if TYPE_CHECKING:
...
class GRAPHITEBlackbox(EvasionAttack):
    ...
    | Original github link: https://github.com/ryan-feng/GRAPHITE
    """
    attack_params = EvasionAttack.attack_params + ['noise_size', 'net_size', 'heat_patch_size', 'heat_patch_stride', 'heatmap_mode', 'tr_lo', 'tr_hi', 'num_xforms_mask', 'max_mask_size', 'rotation_range', 'beta', 'eta', 'num_xforms_boost', 'num_boost_queries', 'dist_range', 'gamma_range', 'crop_percent_range', 'off_x_range', 'off_y_range', 'blur_kernels', 'batch_size']
