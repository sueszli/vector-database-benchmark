...
from spyder.widgets.collectionseditor import CollectionsEditor, CollectionsEditorTableView, CollectionsEditorWidget, CollectionsModel, LARGE_NROWS, natsort, RemoteCollectionsEditorTableView, ROWS_TO_LOAD
from spyder.plugins.variableexplorer.widgets.tests.test_dataframeeditor import generate_pandas_indexes
