...
class CollectionUpdate(CollectionCreate):
    ...
    class Arguments:
        ...
        input = CollectionInput(required=True, description='Fields required to update a collection.')
    ...
    def construct_instance(cls, instance, cleaned_data):
        ...
        if 'background_image' in cleaned_data and instance.background_image:
            ...
            thumbnail_models.Thumbnail.objects.filter(collection_id=instance.id).delete()
