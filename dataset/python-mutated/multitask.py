...
class MultiTaskPredictor(Predictor):
    ...
    """
    _WRONG_READER_ERROR = 'MultitaskPredictor is designed to work with MultiTaskDatasetReader. ' + 'If you have a different DatasetReader, you have to write your own ' + 'Predictor, but you can use MultiTaskPredictor as a starting point.'
    _WRONG_FIELD_ERROR = 'MultiTaskPredictor expects instances that have a MetadataField ' + "with the name 'task', containing the name of the task the instance is for."
