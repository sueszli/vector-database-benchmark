...
app.layout = html.Div([html.Button(id={'type': 'run-button', 'index': 0}, children='Run 1'), html.Button(id={'type': 'run-button', 'index': 1}, children='Run 2'), html.Button(id={'type': 'run-button', 'index': 2}, children='Run 3'), html.Div(id='result', children='No results')])
app.test_lock = lock = long_callback_manager.test_lock

@callback(Output('result', 'children'), [Input({'type': 'run-button', 'index': ALL}, 'n_clicks')], background=True, prevent_initial_call=True)
