...
class ERes2Net(nn.Module):
    ...
    def __init__(self, block=BasicBlockRes2Net, block_fuse=BasicBlockRes2Net_diff_AFF, num_blocks=[3, 4, 6, 3], m_channels=32, feat_dim=80, embed_dim=192, pooling_func='TSTP', two_emb_layer=False):
        if False:
            i = 10
            return i + 15
...
class SpeakerVerificationERes2Net(TorchModel):
    """Enhanced Res2Net architecture with local and global feature fusion. ERes2Net is mainly composed
    ...
    def __init__(self, model_dir, model_config: Dict[str, Any], *args, **kwargs):
        ...
        self.feature_dim = 80
        self.embedding_model = ERes2Net(embed_dim=self.embed_dim, m_channels=self.m_channels)
