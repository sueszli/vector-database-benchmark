...
class TestCSVExporterURLSanitization(APIBaseTest):
    ...
    error_test_cases = [('changing scheme', 'https://localhost:8000', 'http://localhost:8000/some/location'), ('changing port', 'https://localhost:8000', 'https://localhost:8123/some/location'), ('changing port and url', 'https://something.posthog.com:8000', 'https://localhost:8123/some/location'), ('changing domain', 'https://app.posthog.com', 'https://google.com/some/location')]
