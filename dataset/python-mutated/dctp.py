...
class DctpTvIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.dctp.tv/filme/videoinstallation-fuer-eine-kaufhausfassade/', 'md5': '3ffbd1556c3fe210724d7088fad723e3', 'info_dict': {'id': '95eaa4f33dad413aa17b4ee613cccc6c', 'display_id': 'videoinstallation-fuer-eine-kaufhausfassade', 'ext': 'm4v', 'title': 'Videoinstallation für eine Kaufhausfassade', 'description': 'Kurzfilm', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 71.24, 'timestamp': 1302172322, 'upload_date': '20110407'}}, {'url': 'http://www.dctp.tv/filme/sind-youtuber-die-besseren-lehrer/', 'only_matching': True}]
