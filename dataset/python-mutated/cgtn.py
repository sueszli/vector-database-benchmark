...
class CGTNIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://news.cgtn.com/news/2021-03-09/Up-and-Out-of-Poverty-Ep-1-A-solemn-promise-YuOUaOzGQU/index.html', 'info_dict': {'id': 'YuOUaOzGQU', 'ext': 'mp4', 'title': 'Up and Out of Poverty Ep. 1: A solemn promise', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1615295940, 'upload_date': '20210309'}, 'params': {'skip_download': True}}, {'url': 'https://news.cgtn.com/news/2021-06-06/China-Indonesia-vow-to-further-deepen-maritime-cooperation-10REvJCewCY/index.html', 'info_dict': {'id': '10REvJCewCY', 'ext': 'mp4', 'title': 'China, Indonesia vow to further deepen maritime cooperation', 'thumbnail': 're:^https?://.*\\.png$', 'description': 'China and Indonesia vowed to upgrade their cooperation into the maritime sector and also for political security, economy, and cultural and people-to-people exchanges.', 'author': 'CGTN', 'category': 'China', 'timestamp': 1622950200, 'upload_date': '20210606'}, 'params': {'skip_download': False}}]
