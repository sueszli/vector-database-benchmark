...
TRAFFIC_CONSTANTS = {0: 1, 1: 0.92, 2: 0.88, 3: 0.86, 4: 0.81, 5: 0.69, 6: 0.65}
SLEEP_INGEST = 0.001
SLEEP_PERSIST = 0.001
...
longitudinal_job = longitudinal.to_job(name='longitudinal_no_schedule', description='Demo job that simulates updating tables of users and video views and training a video recommendation model. The growth of execution-time and data-throughput followsa sigmoidal curve.', resource_defs={'io_manager': fs_io_manager})