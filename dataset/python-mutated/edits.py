...
class AsyncEdits(AsyncAPIResource):
    ...
    async def create(self, *, instruction: str, model: Union[str, Literal['text-davinci-edit-001', 'code-davinci-edit-001']], input: Optional[str] | NotGiven=NOT_GIVEN, n: Optional[int] | NotGiven=NOT_GIVEN, temperature: Optional[float] | NotGiven=NOT_GIVEN, top_p: Optional[float] | NotGiven=NOT_GIVEN, extra_headers: Headers | None=None, extra_query: Query | None=None, extra_body: Body | None=None, timeout: float | httpx.Timeout | None | NotGiven=NOT_GIVEN) -> Edit:
        ...
        Args:
          ...
          timeout: Override the client-level default timeout for this request, in seconds
        """
        return await self._post('/edits', body=maybe_transform({'instruction': instruction, 'model': model, 'input': input, 'n': n, 'temperature': temperature, 'top_p': top_p}, edit_create_params.EditCreateParams), options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout), cast_to=Edit)
