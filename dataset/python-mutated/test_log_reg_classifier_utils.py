...
from snips_nlu.constants import INTENTS, LANGUAGE_EN, UTTERANCES, LANGUAGE, NOISE
from snips_nlu.dataset import validate_and_format_dataset, Dataset
from snips_nlu.intent_classifier.log_reg_classifier_utils import add_unknown_word_to_utterances, build_training_data, generate_noise_utterances, generate_smart_noise, get_noise_it, remove_builtin_slots, text_to_utterance
from snips_nlu.pipeline.configs import IntentClassifierDataAugmentationConfig, LogRegIntentClassifierConfig
from snips_nlu.tests.test_log_reg_intent_classifier import get_mocked_augment_utterances
