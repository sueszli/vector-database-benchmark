...
option_github_token = click.option('--github-token', type=str, required=True, help=textwrap.dedent('\n        GitHub token used to authenticate.\n        You can set omit it if you have GITHUB_TOKEN env variable set\n        Can be generated with:\n        https://github.com/settings/tokens/new?description=Read%20sssues&scopes=repo:status'), envvar='GITHUB_TOKEN')
option_excluded_pr_list = click.option('--excluded-pr-list', type=str, default='', help='Coma-separated list of PRs to exclude from the issue.')
...
option_is_helm_chart = click.option('--is-helm-chart', is_flag=True, help='Whether the release is for helm chart or not.')
