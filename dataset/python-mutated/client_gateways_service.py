...
import proto
__protobuf__ = proto.module(package='google.cloud.beyondcorp.clientgateways.v1', manifest={'ClientGateway', 'ListClientGatewaysRequest', 'ListClientGatewaysResponse', 'GetClientGatewayRequest', 'CreateClientGatewayRequest', 'DeleteClientGatewayRequest', 'ClientGatewayOperationMetadata'})
...
class ClientGateway(proto.Message):
    ...
    id: str = proto.Field(proto.STRING, number=5)
    client_connector_service: str = proto.Field(proto.STRING, number=6)
...
class ListClientGatewaysResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    client_gateways: MutableSequence['ClientGateway'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ClientGateway')
...
class CreateClientGatewayRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    client_gateway_id: str = proto.Field(proto.STRING, number=2)
    client_gateway: 'ClientGateway' = proto.Field(proto.MESSAGE, number=3, message='ClientGateway')
