...
def build_list_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents')
...
class GuestAgentsOperations:
    ...
    list.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents'}