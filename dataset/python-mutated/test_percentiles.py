...
try:
    ...
    crick = None
percentile_internal_methods = pytest.mark.parametrize('internal_method', [pytest.param('tdigest', marks=pytest.mark.skipif(not crick, reason='Requires crick')), 'dask'])
