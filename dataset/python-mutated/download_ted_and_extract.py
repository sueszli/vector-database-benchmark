...
if __name__ == '__main__':
    ...
    parser.add_argument('--direction-list', type=str, default='bn_IN-en_XX,he_IL-en_XX,fa_IR-en_XX,id_ID-en_XX,sv_SE-en_XX,pt_XX-en_XX,ka_GE-en_XX,ka_GE-en_XX,th_TH-en_XX,mr_IN-en_XX,hr_HR-en_XX,uk_UA-en_XX,az_AZ-en_XX,mk_MK-en_XX,gl_ES-en_XX,sl_SI-en_XX,mn_MN-en_XX,', required=False)
    ...
    for (src_lang, trg_lang) in directions:
        ...
        extra_bitex(extract_to, src_lang, trg_lang, target_token=args.target_token, output_data_path=output_path)