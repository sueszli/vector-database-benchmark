...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0174_userprofile_delivery_email')]
    operations = [migrations.RunPython(change_realm_audit_log_event_type_tense, reverse_code=migrations.RunPython.noop, elidable=True)]