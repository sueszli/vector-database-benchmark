...
class LumniIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        video_id = self._html_search_regex('<div[^>]+data-factoryid\\s*=\\s*["\\\']([^"\\\']+)', webpage, 'video id')
