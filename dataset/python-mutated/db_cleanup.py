...
config_list: list[_TableConfig] = [_TableConfig(table_name='job', recency_column_name='latest_heartbeat'), _TableConfig(table_name='dag', recency_column_name='last_parsed_time'), _TableConfig(table_name='dag_run', recency_column_name='start_date', extra_columns=['dag_id', 'external_trigger'], keep_last=True, keep_last_filters=[column('external_trigger') == false()], keep_last_group_by=['dag_id']), _TableConfig(table_name='dataset_event', recency_column_name='timestamp'), _TableConfig(table_name='import_error', recency_column_name='timestamp'), _TableConfig(table_name='log', recency_column_name='dttm'), _TableConfig(table_name='sla_miss', recency_column_name='timestamp'), _TableConfig(table_name='task_fail', recency_column_name='start_date'), _TableConfig(table_name='task_instance', recency_column_name='start_date'), _TableConfig(table_name='task_reschedule', recency_column_name='start_date'), _TableConfig(table_name='xcom', recency_column_name='timestamp'), _TableConfig(table_name='callback_request', recency_column_name='created_at'), _TableConfig(table_name='celery_taskmeta', recency_column_name='date_done'), _TableConfig(table_name='celery_tasksetmeta', recency_column_name='date_done'), _TableConfig(table_name='trigger', recency_column_name='created_date')]
