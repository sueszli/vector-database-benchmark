...
from modelscope.models.cv.product_retrieval_embedding.item_detection import YOLOXONNX
from modelscope.models.cv.product_retrieval_embedding.item_embedding import preprocess, resnet50_embed
...
@MODELS.register_module(Tasks.product_retrieval_embedding, module_name=Models.product_retrieval_embedding)
