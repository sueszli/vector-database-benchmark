...
def_unit(['foz', 'fluid_oz', 'fluid_ounce'], cup / 8, namespace=_ns, doc='U.S. fluid ounce')
def_unit(['tbsp', 'tablespoon'], foz / 2, namespace=_ns, doc='U.S. customary tablespoon')
def_unit(['tsp', 'teaspoon'], tbsp / 3, namespace=_ns, doc='U.S. customary teaspoon')
def_unit(['oz', 'ounce'], 28.349523125 * si.g, namespace=_ns, doc='International avoirdupois ounce: mass')
def_unit(['lb', 'lbm', 'pound'], 16 * oz, namespace=_ns, doc='International avoirdupois pound: mass')
def_unit(['st', 'stone'], 14 * lb, namespace=_ns, doc='International avoirdupois stone: mass')
...
def_unit(['kn', 'kt', 'knot', 'NMPH'], nmi / si.h, namespace=_ns, doc='nautical unit of speed: 1 nmi per hour')
...
def_unit(['cal', 'calorie'], 4.184 * si.J, namespace=_ns, doc='Thermochemical calorie: pre-SI metric unit of energy')
def_unit(['kcal', 'Cal', 'Calorie', 'kilocal', 'kilocalorie'], 1000 * cal, namespace=_ns, doc='Calorie: colloquial definition of Calorie')
def_unit('psi', lbf * inch ** (-2), namespace=_ns, doc='Pound per square inch: pressure')
def_unit(['hp', 'horsepower'], si.W / 0.00134102209, namespace=_ns, doc='Electrical horsepower')
def_unit(['deg_F', 'Fahrenheit'], namespace=_ns, doc='Degrees Fahrenheit', format={'latex': '{}^{\\circ}F', 'unicode': '°F'})
