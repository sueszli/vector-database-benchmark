...
(user_models, suggestion_models, feedback_models) = models.Registry.import_models([models.Names.USER, models.Names.SUGGESTION, models.Names.FEEDBACK])
...
class CreationButtonsTests(test_utils.GenericTestBase):
    with utils.open_file(os.path.join(feconf.SAMPLE_EXPLORATIONS_DIR, 'welcome', 'welcome.yaml'), 'rb', encoding=None) as f:
        raw_yaml = f.read()
