...
class ExportWithRobustScaler(ExportJIT):
    ...
    def unscale(self, data):
        ...
        return data_unscale
SCALE_JIT_HELPER_MAP = {StandardScaler: ExportWithStandardScaler, MaxAbsScaler: ExporWithMaxAbsScaler, MinMaxScaler: ExportWithMinMaxScaler, RobustScaler: ExportWithRobustScaler}
