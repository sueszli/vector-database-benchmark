...
parser.add_argument('-b', '--batch_size', default=13, type=int, metavar='N', help='batch size (default: 13)')
...
parser.add_argument('--nhwc', action='store_true', help='Use args.nhwc data instead of default NCHW')
parser.add_argument('-i', '--iters', default=-1, type=int, metavar='N', help='Number of iterations to run (default: -1 - whole data set)')
parser.add_argument('-e', '--epochs', default=1, type=int, metavar='N', help='Number of epochs to run (default: 1)')
parser.add_argument('--framework', type=str)
args = parser.parse_args()
print(f'Framework: {args.framework}, GPUs: {args.gpus}, batch: {args.batch_size}, workers: {args.workers}, prefetch depth: {args.prefetch}, loging interval: {args.print_freq}, fp16: {args.fp16}, args.nhwc: {args.nhwc}')
...
Iterators = {'mxnet': [import_mxnet], 'pytorch': [import_pytorch], 'tf': [import_tf], 'paddle': [import_paddle]}
