...
class TestSf(unittest.TestCase):
    ...
    """
    default_types = ['']
    default_modules = ['sfp_base64', 'sfp_bitcoin', 'sfp_company', 'sfp_cookie', 'sfp_countryname', 'sfp_creditcard', 'sfp_email', 'sfp_errors', 'sfp_ethereum', 'sfp_filemeta', 'sfp_hashes', 'sfp_iban', 'sfp_names', 'sfp_pageinfo', 'sfp_phone', 'sfp_strangeheaders', 'sfp_webframework', 'sfp_webserver', 'sfp_webanalytics']
