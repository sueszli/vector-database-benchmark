...
import proto
__protobuf__ = proto.module(package='google.cloud.vmmigration.v1', manifest={'UtilizationReportView', 'MigratingVmView', 'ComputeEngineDiskType', 'ComputeEngineLicenseType', 'ComputeEngineBootOption', 'ReplicationCycle', 'CycleStep', 'InitializingReplicationStep', 'ReplicatingStep', 'PostProcessingStep', 'ReplicationSync', 'MigratingVm', 'CloneJob', 'CloneStep', 'AdaptingOSStep', 'PreparingVMDisksStep', 'InstantiatingMigratedVMStep', 'CutoverJob', 'CutoverStep', 'ShuttingDownSourceVMStep', 'CreateCloneJobRequest', 'CancelCloneJobRequest', 'CancelCloneJobResponse', 'ListCloneJobsRequest', 'ListCloneJobsResponse', 'GetCloneJobRequest', 'Source', 'VmwareSourceDetails', 'AwsSourceDetails', 'DatacenterConnector', 'UpgradeStatus', 'AvailableUpdates', 'ApplianceVersion', 'ListSourcesRequest', 'ListSourcesResponse', 'GetSourceRequest', 'CreateSourceRequest', 'UpdateSourceRequest', 'DeleteSourceRequest', 'FetchInventoryRequest', 'VmwareVmDetails', 'AwsVmDetails', 'AwsSecurityGroup', 'VmwareVmsDetails', 'AwsVmsDetails', 'FetchInventoryResponse', 'UtilizationReport', 'VmUtilizationInfo', 'VmUtilizationMetrics', 'ListUtilizationReportsRequest', 'ListUtilizationReportsResponse', 'GetUtilizationReportRequest', 'CreateUtilizationReportRequest', 'DeleteUtilizationReportRequest', 'ListDatacenterConnectorsResponse', 'GetDatacenterConnectorRequest', 'CreateDatacenterConnectorRequest', 'DeleteDatacenterConnectorRequest', 'UpgradeApplianceRequest', 'UpgradeApplianceResponse', 'ListDatacenterConnectorsRequest', 'ComputeEngineTargetDefaults', 'ComputeEngineTargetDetails', 'NetworkInterface', 'AppliedLicense', 'SchedulingNodeAffinity', 'ComputeScheduling', 'SchedulePolicy', 'CreateMigratingVmRequest', 'ListMigratingVmsRequest', 'ListMigratingVmsResponse', 'GetMigratingVmRequest', 'UpdateMigratingVmRequest', 'DeleteMigratingVmRequest', 'StartMigrationRequest', 'StartMigrationResponse', 'PauseMigrationRequest', 'PauseMigrationResponse', 'ResumeMigrationRequest', 'ResumeMigrationResponse', 'FinalizeMigrationRequest', 'FinalizeMigrationResponse', 'TargetProject', 'GetTargetProjectRequest', 'ListTargetProjectsRequest', 'ListTargetProjectsResponse', 'CreateTargetProjectRequest', 'UpdateTargetProjectRequest', 'DeleteTargetProjectRequest', 'Group', 'ListGroupsRequest', 'ListGroupsResponse', 'GetGroupRequest', 'CreateGroupRequest', 'UpdateGroupRequest', 'DeleteGroupRequest', 'AddGroupMigrationRequest', 'AddGroupMigrationResponse', 'RemoveGroupMigrationRequest', 'RemoveGroupMigrationResponse', 'CreateCutoverJobRequest', 'CancelCutoverJobRequest', 'CancelCutoverJobResponse', 'ListCutoverJobsRequest', 'ListCutoverJobsResponse', 'GetCutoverJobRequest', 'OperationMetadata', 'MigrationError', 'AwsSourceVmDetails', 'ListReplicationCyclesRequest', 'ListReplicationCyclesResponse', 'GetReplicationCycleRequest'})
...
class ReplicationCycle(proto.Message):
    """ReplicationCycle contains information about the current
    ...
    class State(proto.Enum):
        ...
        FAILED = 3
        SUCCEEDED = 4
    name: str = proto.Field(proto.STRING, number=13)
    cycle_number: int = proto.Field(proto.INT32, number=10)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    total_pause_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=7, message=duration_pb2.Duration)
    progress_percent: int = proto.Field(proto.INT32, number=5)
    steps: MutableSequence['CycleStep'] = proto.RepeatedField(proto.MESSAGE, number=9, message='CycleStep')
    state: State = proto.Field(proto.ENUM, number=11, enum=State)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=12, message=status_pb2.Status)
...
class CycleStep(proto.Message):
    ...
    """
    initializing_replication: 'InitializingReplicationStep' = proto.Field(proto.MESSAGE, number=3, oneof='step', message='InitializingReplicationStep')
    replicating: 'ReplicatingStep' = proto.Field(proto.MESSAGE, number=4, oneof='step', message='ReplicatingStep')
    post_processing: 'PostProcessingStep' = proto.Field(proto.MESSAGE, number=5, oneof='step', message='PostProcessingStep')
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
...
class ReplicatingStep(proto.Message):
    ...
    """
    total_bytes: int = proto.Field(proto.INT64, number=1)
    replicated_bytes: int = proto.Field(proto.INT64, number=2)
    last_two_minutes_average_bytes_per_second: int = proto.Field(proto.INT64, number=3)
    last_thirty_minutes_average_bytes_per_second: int = proto.Field(proto.INT64, number=4)

class PostProcessingStep(proto.Message):
    """PostProcessingStep contains specific step details."""

class ReplicationSync(proto.Message):
    """ReplicationSync contain information about the last replica
    sync to the cloud.
    ...
    """
    last_sync_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)

class MigratingVm(proto.Message):
    """MigratingVm describes the VM that will be migrated from a
    ...
    class State(proto.Enum):
        ...
        FINALIZED = 12
        ERROR = 13
    compute_engine_target_defaults: 'ComputeEngineTargetDefaults' = proto.Field(proto.MESSAGE, number=26, oneof='target_vm_defaults', message='ComputeEngineTargetDefaults')
    aws_source_vm_details: 'AwsSourceVmDetails' = proto.Field(proto.MESSAGE, number=29, oneof='source_vm_details', message='AwsSourceVmDetails')
    name: str = proto.Field(proto.STRING, number=1)
    source_vm_id: str = proto.Field(proto.STRING, number=2)
    display_name: str = proto.Field(proto.STRING, number=18)
    description: str = proto.Field(proto.STRING, number=3)
    policy: 'SchedulePolicy' = proto.Field(proto.MESSAGE, number=8, message='SchedulePolicy')
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
    last_sync: 'ReplicationSync' = proto.Field(proto.MESSAGE, number=11, message='ReplicationSync')
    state: State = proto.Field(proto.ENUM, number=23, enum=State)
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=22, message=timestamp_pb2.Timestamp)
    current_sync_info: 'ReplicationCycle' = proto.Field(proto.MESSAGE, number=13, message='ReplicationCycle')
    group: str = proto.Field(proto.STRING, number=15)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=16)
    recent_clone_jobs: MutableSequence['CloneJob'] = proto.RepeatedField(proto.MESSAGE, number=17, message='CloneJob')
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=19, message=status_pb2.Status)
    recent_cutover_jobs: MutableSequence['CutoverJob'] = proto.RepeatedField(proto.MESSAGE, number=20, message='CutoverJob')
...
class CloneJob(proto.Message):
    ...
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=22, message=timestamp_pb2.Timestamp)
    name: str = proto.Field(proto.STRING, number=3)
    state: State = proto.Field(proto.ENUM, number=12, enum=State)
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=14, message=timestamp_pb2.Timestamp)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=17, message=status_pb2.Status)
    steps: MutableSequence['CloneStep'] = proto.RepeatedField(proto.MESSAGE, number=23, message='CloneStep')
...
class CloneStep(proto.Message):
    ...
    """
    adapting_os: 'AdaptingOSStep' = proto.Field(proto.MESSAGE, number=3, oneof='step', message='AdaptingOSStep')
    preparing_vm_disks: 'PreparingVMDisksStep' = proto.Field(proto.MESSAGE, number=4, oneof='step', message='PreparingVMDisksStep')
    instantiating_migrated_vm: 'InstantiatingMigratedVMStep' = proto.Field(proto.MESSAGE, number=5, oneof='step', message='InstantiatingMigratedVMStep')
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
...
class CutoverJob(proto.Message):
    ...
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=16, message=timestamp_pb2.Timestamp)
    name: str = proto.Field(proto.STRING, number=3)
    state: State = proto.Field(proto.ENUM, number=5, enum=State)
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    progress_percent: int = proto.Field(proto.INT32, number=13)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=9, message=status_pb2.Status)
    state_message: str = proto.Field(proto.STRING, number=10)
    steps: MutableSequence['CutoverStep'] = proto.RepeatedField(proto.MESSAGE, number=17, message='CutoverStep')

class CutoverStep(proto.Message):
    """CutoverStep holds information about the cutover step
    progress.
    ...
    Attributes:
        ...
        end_time (google.protobuf.timestamp_pb2.Timestamp):
            The time the step has ended.
    """
    previous_replication_cycle: 'ReplicationCycle' = proto.Field(proto.MESSAGE, number=3, oneof='step', message='ReplicationCycle')
    shutting_down_source_vm: 'ShuttingDownSourceVMStep' = proto.Field(proto.MESSAGE, number=4, oneof='step', message='ShuttingDownSourceVMStep')
    final_sync: 'ReplicationCycle' = proto.Field(proto.MESSAGE, number=5, oneof='step', message='ReplicationCycle')
    preparing_vm_disks: 'PreparingVMDisksStep' = proto.Field(proto.MESSAGE, number=6, oneof='step', message='PreparingVMDisksStep')
    instantiating_migrated_vm: 'InstantiatingMigratedVMStep' = proto.Field(proto.MESSAGE, number=7, oneof='step', message='InstantiatingMigratedVMStep')
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
...
class CreateCloneJobRequest(proto.Message):
    ...
    clone_job_id: str = proto.Field(proto.STRING, number=2)
    clone_job: 'CloneJob' = proto.Field(proto.MESSAGE, number=3, message='CloneJob')
...
class ListCloneJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    clone_jobs: MutableSequence['CloneJob'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CloneJob')
...
class Source(proto.Message):
    """Source message describes a specific vm migration Source
    ...
    """
    vmware: 'VmwareSourceDetails' = proto.Field(proto.MESSAGE, number=10, oneof='source_details', message='VmwareSourceDetails')
    aws: 'AwsSourceDetails' = proto.Field(proto.MESSAGE, number=12, oneof='source_details', message='AwsSourceDetails')
    name: str = proto.Field(proto.STRING, number=1)
...
class VmwareSourceDetails(proto.Message):
    """VmwareSourceDetails message describes a specific source
    ...
    vcenter_ip: str = proto.Field(proto.STRING, number=3)
    thumbprint: str = proto.Field(proto.STRING, number=4)

class AwsSourceDetails(proto.Message):
    """AwsSourceDetails message describes a specific source details
    ...
    class AccessKeyCredentials(proto.Message):
        """Message describing AWS Credentials using access key id and
        secret.
        ...
        """
        access_key_id: str = proto.Field(proto.STRING, number=1)
        secret_access_key: str = proto.Field(proto.STRING, number=2)
    ...
    access_key_creds: AccessKeyCredentials = proto.Field(proto.MESSAGE, number=11, oneof='credentials_type', message=AccessKeyCredentials)
    aws_region: str = proto.Field(proto.STRING, number=3)
    state: State = proto.Field(proto.ENUM, number=4, enum=State)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=5, message=status_pb2.Status)
    inventory_tag_list: MutableSequence[Tag] = proto.RepeatedField(proto.MESSAGE, number=10, message=Tag)
    inventory_security_group_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=7)
    migration_resources_user_tags: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=8)
    public_ip: str = proto.Field(proto.STRING, number=9)

class DatacenterConnector(proto.Message):
    """DatacenterConnector message describes a connector between the
    ...
    name: str = proto.Field(proto.STRING, number=3)
    registration_id: str = proto.Field(proto.STRING, number=12)
    service_account: str = proto.Field(proto.STRING, number=5)
    version: str = proto.Field(proto.STRING, number=6)
    bucket: str = proto.Field(proto.STRING, number=10)
    state: State = proto.Field(proto.ENUM, number=7, enum=State)
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=11, message=status_pb2.Status)
    appliance_infrastructure_version: str = proto.Field(proto.STRING, number=13)
    appliance_software_version: str = proto.Field(proto.STRING, number=14)
    available_versions: 'AvailableUpdates' = proto.Field(proto.MESSAGE, number=15, message='AvailableUpdates')
    upgrade_status: 'UpgradeStatus' = proto.Field(proto.MESSAGE, number=16, message='UpgradeStatus')

class UpgradeStatus(proto.Message):
    """UpgradeStatus contains information about upgradeAppliance
    operation.
    ...
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=3, message=status_pb2.Status)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    previous_version: str = proto.Field(proto.STRING, number=5)
...
class AvailableUpdates(proto.Message):
    ...
    """
    new_deployable_appliance: 'ApplianceVersion' = proto.Field(proto.MESSAGE, number=1, message='ApplianceVersion')
    in_place_update: 'ApplianceVersion' = proto.Field(proto.MESSAGE, number=2, message='ApplianceVersion')
...
class ApplianceVersion(proto.Message):
    ...
    """
    version: str = proto.Field(proto.STRING, number=1)
    uri: str = proto.Field(proto.STRING, number=2)
    critical: bool = proto.Field(proto.BOOL, number=3)
    release_notes_uri: str = proto.Field(proto.STRING, number=4)
...
class FetchInventoryRequest(proto.Message):
    ...
    """
    source: str = proto.Field(proto.STRING, number=1)
    force_refresh: bool = proto.Field(proto.BOOL, number=2)
...
class VmwareVmDetails(proto.Message):
    ...
    class BootOption(proto.Enum):
        ...
        EFI = 1
        BIOS = 2
    vm_id: str = proto.Field(proto.STRING, number=1)
    datacenter_id: str = proto.Field(proto.STRING, number=2)
    datacenter_description: str = proto.Field(proto.STRING, number=3)
    uuid: str = proto.Field(proto.STRING, number=4)
    display_name: str = proto.Field(proto.STRING, number=5)
    power_state: PowerState = proto.Field(proto.ENUM, number=6, enum=PowerState)
    cpu_count: int = proto.Field(proto.INT32, number=7)
    memory_mb: int = proto.Field(proto.INT32, number=8)
    disk_count: int = proto.Field(proto.INT32, number=9)
    committed_storage_mb: int = proto.Field(proto.INT64, number=12)
    guest_description: str = proto.Field(proto.STRING, number=11)
    boot_option: BootOption = proto.Field(proto.ENUM, number=13, enum=BootOption)
...
class AwsVmDetails(proto.Message):
    ...
    source_id: str = proto.Field(proto.STRING, number=3)
    source_description: str = proto.Field(proto.STRING, number=4)
    power_state: PowerState = proto.Field(proto.ENUM, number=5, enum=PowerState)
    cpu_count: int = proto.Field(proto.INT32, number=6)
    memory_mb: int = proto.Field(proto.INT32, number=7)
    disk_count: int = proto.Field(proto.INT32, number=8)
    committed_storage_mb: int = proto.Field(proto.INT64, number=9)
    os_description: str = proto.Field(proto.STRING, number=10)
    boot_option: BootOption = proto.Field(proto.ENUM, number=11, enum=BootOption)
    instance_type: str = proto.Field(proto.STRING, number=12)
    vpc_id: str = proto.Field(proto.STRING, number=13)
    security_groups: MutableSequence['AwsSecurityGroup'] = proto.RepeatedField(proto.MESSAGE, number=14, message='AwsSecurityGroup')
    tags: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=15)
    zone: str = proto.Field(proto.STRING, number=16)
    virtualization_type: VmVirtualizationType = proto.Field(proto.ENUM, number=17, enum=VmVirtualizationType)
    architecture: VmArchitecture = proto.Field(proto.ENUM, number=18, enum=VmArchitecture)
...
class VmwareVmsDetails(proto.Message):
    ...
    """
    details: MutableSequence['VmwareVmDetails'] = proto.RepeatedField(proto.MESSAGE, number=1, message='VmwareVmDetails')
...
class AwsVmsDetails(proto.Message):
    ...
    """
    details: MutableSequence['AwsVmDetails'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AwsVmDetails')
...
class FetchInventoryResponse(proto.Message):
    ...
    Attributes:
        ...
        update_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            cache).
    """
    vmware_vms: 'VmwareVmsDetails' = proto.Field(proto.MESSAGE, number=1, oneof='SourceVms', message='VmwareVmsDetails')
    aws_vms: 'AwsVmsDetails' = proto.Field(proto.MESSAGE, number=3, oneof='SourceVms', message='AwsVmsDetails')
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)

class UtilizationReport(proto.Message):
    """Utilization report details the utilization (CPU, memory,
    ...
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    error: status_pb2.Status = proto.Field(proto.MESSAGE, number=5, message=status_pb2.Status)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    time_frame: TimeFrame = proto.Field(proto.ENUM, number=7, enum=TimeFrame)
    frame_end_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    vm_count: int = proto.Field(proto.INT32, number=9)
    vms: MutableSequence['VmUtilizationInfo'] = proto.RepeatedField(proto.MESSAGE, number=10, message='VmUtilizationInfo')
...
class VmUtilizationInfo(proto.Message):
    ...
    """
    vmware_vm_details: 'VmwareVmDetails' = proto.Field(proto.MESSAGE, number=1, oneof='VmDetails', message='VmwareVmDetails')
    vm_id: str = proto.Field(proto.STRING, number=3)
    utilization: 'VmUtilizationMetrics' = proto.Field(proto.MESSAGE, number=2, message='VmUtilizationMetrics')
...
class VmUtilizationMetrics(proto.Message):
    ...
    Attributes:
        ...
        network_throughput_average_kbps (int):
            ...
            per second.
    """
    cpu_max_percent: int = proto.Field(proto.INT32, number=9)
    cpu_average_percent: int = proto.Field(proto.INT32, number=10)
    memory_max_percent: int = proto.Field(proto.INT32, number=11)
    memory_average_percent: int = proto.Field(proto.INT32, number=12)
    disk_io_rate_max_kbps: int = proto.Field(proto.INT64, number=13)
    disk_io_rate_average_kbps: int = proto.Field(proto.INT64, number=14)
    network_throughput_max_kbps: int = proto.Field(proto.INT64, number=15)
    network_throughput_average_kbps: int = proto.Field(proto.INT64, number=16)
...
class ListUtilizationReportsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    view: 'UtilizationReportView' = proto.Field(proto.ENUM, number=2, enum='UtilizationReportView')
    ...
    order_by: str = proto.Field(proto.STRING, number=6)
...
class ListUtilizationReportsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    utilization_reports: MutableSequence['UtilizationReport'] = proto.RepeatedField(proto.MESSAGE, number=1, message='UtilizationReport')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateUtilizationReportRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    utilization_report: 'UtilizationReport' = proto.Field(proto.MESSAGE, number=2, message='UtilizationReport')
    utilization_report_id: str = proto.Field(proto.STRING, number=3)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListDatacenterConnectorsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    datacenter_connectors: MutableSequence['DatacenterConnector'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DatacenterConnector')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateDatacenterConnectorRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    datacenter_connector_id: str = proto.Field(proto.STRING, number=2)
    datacenter_connector: 'DatacenterConnector' = proto.Field(proto.MESSAGE, number=3, message='DatacenterConnector')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpgradeApplianceRequest(proto.Message):
    ...
    Attributes:
        ...
        request_id (str):
            ...
            (00000000-0000-0000-0000-000000000000).
    """
    datacenter_connector: str = proto.Field(proto.STRING, number=1)
    request_id: str = proto.Field(proto.STRING, number=2)
...
class ComputeEngineTargetDefaults(proto.Message):
    """ComputeEngineTargetDefaults is a collection of details for
    ...
    """
    vm_name: str = proto.Field(proto.STRING, number=1)
    target_project: str = proto.Field(proto.STRING, number=2)
    zone: str = proto.Field(proto.STRING, number=3)
    machine_type_series: str = proto.Field(proto.STRING, number=4)
    machine_type: str = proto.Field(proto.STRING, number=5)
    network_tags: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    network_interfaces: MutableSequence['NetworkInterface'] = proto.RepeatedField(proto.MESSAGE, number=7, message='NetworkInterface')
    service_account: str = proto.Field(proto.STRING, number=8)
    disk_type: 'ComputeEngineDiskType' = proto.Field(proto.ENUM, number=9, enum='ComputeEngineDiskType')
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=10)
    license_type: 'ComputeEngineLicenseType' = proto.Field(proto.ENUM, number=11, enum='ComputeEngineLicenseType')
    applied_license: 'AppliedLicense' = proto.Field(proto.MESSAGE, number=12, message='AppliedLicense')
    compute_scheduling: 'ComputeScheduling' = proto.Field(proto.MESSAGE, number=13, message='ComputeScheduling')
    secure_boot: bool = proto.Field(proto.BOOL, number=14)
    boot_option: 'ComputeEngineBootOption' = proto.Field(proto.ENUM, number=15, enum='ComputeEngineBootOption')
    metadata: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=16)
    additional_licenses: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=17)
    hostname: str = proto.Field(proto.STRING, number=18)

class ComputeEngineTargetDetails(proto.Message):
    """ComputeEngineTargetDetails is a collection of details for
    creating a VM in a target Compute Engine project.
...
class NetworkInterface(proto.Message):
    ...
    internal_ip: str = proto.Field(proto.STRING, number=3)
    external_ip: str = proto.Field(proto.STRING, number=4)

class AppliedLicense(proto.Message):
    """AppliedLicense holds the license data returned by adaptation
    module report.
    ...
    os_license: str = proto.Field(proto.STRING, number=2)
...
class SchedulingNodeAffinity(proto.Message):
    ...
    class Operator(proto.Enum):
        """Possible types of node selection operators. Valid operators are IN
        ...
        NOT_IN = 2
    key: str = proto.Field(proto.STRING, number=1)
    operator: Operator = proto.Field(proto.ENUM, number=2, enum=Operator)
    values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)

class ComputeScheduling(proto.Message):
    """Scheduling information for VM on maintenance/restart
    ...
    class RestartType(proto.Enum):
        ...
        AUTOMATIC_RESTART = 1
        NO_AUTOMATIC_RESTART = 2
    on_host_maintenance: OnHostMaintenance = proto.Field(proto.ENUM, number=1, enum=OnHostMaintenance)
    restart_type: RestartType = proto.Field(proto.ENUM, number=5, enum=RestartType)
    node_affinities: MutableSequence['SchedulingNodeAffinity'] = proto.RepeatedField(proto.MESSAGE, number=3, message='SchedulingNodeAffinity')
    min_node_cpus: int = proto.Field(proto.INT32, number=4)
...
class SchedulePolicy(proto.Message):
    ...
    """
    idle_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=1, message=duration_pb2.Duration)
    skip_os_adaptation: bool = proto.Field(proto.BOOL, number=2)
...
class CreateMigratingVmRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    migrating_vm_id: str = proto.Field(proto.STRING, number=2)
    migrating_vm: 'MigratingVm' = proto.Field(proto.MESSAGE, number=3, message='MigratingVm')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListMigratingVmsRequest(proto.Message):
    ...
    filter: str = proto.Field(proto.STRING, number=4)
    order_by: str = proto.Field(proto.STRING, number=5)
    view: 'MigratingVmView' = proto.Field(proto.ENUM, number=6, enum='MigratingVmView')
...
class ListMigratingVmsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    migrating_vms: MutableSequence['MigratingVm'] = proto.RepeatedField(proto.MESSAGE, number=1, message='MigratingVm')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class GetMigratingVmRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'MigratingVmView' = proto.Field(proto.ENUM, number=2, enum='MigratingVmView')
...
class UpdateMigratingVmRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    migrating_vm: 'MigratingVm' = proto.Field(proto.MESSAGE, number=2, message='MigratingVm')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class StartMigrationRequest(proto.Message):
    ...
    Attributes:
        migrating_vm (str):
            Required. The name of the MigratingVm.
    """
    migrating_vm: str = proto.Field(proto.STRING, number=1)
...
class TargetProject(proto.Message):
    """TargetProject message represents a target Compute Engine
...
class ListTargetProjectsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    target_projects: MutableSequence['TargetProject'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TargetProject')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateTargetProjectRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    target_project_id: str = proto.Field(proto.STRING, number=2)
    target_project: 'TargetProject' = proto.Field(proto.MESSAGE, number=3, message='TargetProject')
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdateTargetProjectRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    target_project: 'TargetProject' = proto.Field(proto.MESSAGE, number=2, message='TargetProject')
    request_id: str = proto.Field(proto.STRING, number=3)
...
class Group(proto.Message):
    """Describes message for 'Group' resource. The Group is a
...
class AddGroupMigrationRequest(proto.Message):
    ...
    migrating_vm: str = proto.Field(proto.STRING, number=2)
...
class CreateCutoverJobRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    cutover_job_id: str = proto.Field(proto.STRING, number=2)
    cutover_job: 'CutoverJob' = proto.Field(proto.MESSAGE, number=3, message='CutoverJob')
    request_id: str = proto.Field(proto.STRING, number=4)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    cutover_jobs: MutableSequence['CutoverJob'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CutoverJob')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class MigrationError(proto.Message):
    """Represents migration resource error information that can be
    ...
    class ErrorCode(proto.Enum):
        ...
        UTILIZATION_REPORT_ERROR = 8
        APPLIANCE_UPGRADE_ERROR = 9
    code: ErrorCode = proto.Field(proto.ENUM, number=1, enum=ErrorCode)
    error_message: error_details_pb2.LocalizedMessage = proto.Field(proto.MESSAGE, number=2, message=error_details_pb2.LocalizedMessage)
    action_item: error_details_pb2.LocalizedMessage = proto.Field(proto.MESSAGE, number=3, message=error_details_pb2.LocalizedMessage)
    help_links: MutableSequence[error_details_pb2.Help.Link] = proto.RepeatedField(proto.MESSAGE, number=4, message=error_details_pb2.Help.Link)
    error_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
...
class AwsSourceVmDetails(proto.Message):
    ...
    class Firmware(proto.Enum):
        ...
        EFI = 1
        BIOS = 2
    firmware: Firmware = proto.Field(proto.ENUM, number=1, enum=Firmware)
    committed_storage_bytes: int = proto.Field(proto.INT64, number=2)
...
class ListReplicationCyclesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    replication_cycles: MutableSequence['ReplicationCycle'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ReplicationCycle')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
