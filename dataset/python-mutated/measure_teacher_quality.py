...
if __name__ == '__main__':
    ...
    parser.add_argument('--phn_dir', default='/checkpoint/wnhsu/data/librispeech/960h/fa/raw_phn/phone_frame_align_v1')
    parser.add_argument('--phn_sets', default=['dev-clean', 'dev-other'], type=str, nargs='+')
    parser.add_argument('--pad_len', default=0, type=int, help='padding for hypotheses')
    parser.add_argument('--upsample', default=1, type=int, help='upsample factor for hypotheses')
    ...
    if args.ref_lab_dir and args.ref_lab_name:
        main_lab_lab(args.tsv_dir, args.lab_dir, args.lab_name, args.lab_sets, args.ref_lab_dir, args.ref_lab_name, args.pad_len, args.upsample, args.verbose)
    else:
        main_phn_lab(args.tsv_dir, args.lab_dir, args.lab_name, args.lab_sets, args.phn_dir, args.phn_sets, args.pad_len, args.upsample, args.verbose)