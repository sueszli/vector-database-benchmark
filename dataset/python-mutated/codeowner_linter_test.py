...
VALID_CODEOWNER_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_codeowners')
VALID_CODEOWNER_FILEPATH_WITH_DIRECTORY: Final = os.path.join(LINTER_TESTS_DIR, 'valid_codeowner_file_with_directory')
INVALID_DUPLICATE_CODEOWNER_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_duplicate_pattern_codeowner')
INVALID_MISSING_IMPORTANT_PATTERN_CODEOWNER_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_missing_important_pattern_codeowner')
INVALID_MISSING_CODEOWNER_NAME_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_missing_codeowner_name')
INVALID_INLINE_COMMENT_CODEOWNER_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_inline_comment_codeowner_filepath')
INVALID_FULL_FILEPATH_CODEOWNER_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_path_codeowner')
INVALID_WILDCARD_IN_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_wildcard_used_codeowner')
INVALID_FILEPATH_MISSING_FROM_DIRECTORY: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_file_path_missing_codeowner')
INVALID_FILEPATH_WITH_BLANKET_CODEOWNER_ONLY: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_file_path_with_blanket_codeowner_only')
CODEOWNER_IMPORTANT_PATHS: Final = ['/dependencies.json', '/package.json', '/yarn.lock', '/scripts/install_third_party_libs.py', '/.github/CODEOWNERS', '/.github/stale.yml']
