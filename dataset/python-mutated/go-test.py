...
import uuid
import threading
cover_packages = ['github.com/pulumi/pulumi/pkg/v3/...', 'github.com/pulumi/pulumi/sdk/v3/...', 'github.com/pulumi/pulumi/sdk/go/pulumi-language-go/v3/...', 'github.com/pulumi/pulumi/sdk/nodejs/cmd/pulumi-language-nodejs/v3/...', 'github.com/pulumi/pulumi/sdk/python/cmd/pulumi-language-python/v3/...']
...
if shutil.which('gotestsum') is not None:
    ...
    args = ['gotestsum', '--jsonfile', json_file, '--rerun-fails=1', '--packages', pkgs, '--'] + opts
else:
    args = ['go', 'test'] + args
if not dryrun:
