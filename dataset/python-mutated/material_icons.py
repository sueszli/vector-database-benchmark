...
about = {'website': 'https://fonts.google.com/icons', 'wikidata_id': 'Q107315222', 'official_api_documentation': None, 'use_official_api': False, 'require_api_key': False, 'results': 'JSON'}
search_url = 'https://fonts.google.com/metadata/icons?key=material_symbols&incomplete=true'
result_url = 'https://fonts.google.com/icons?icon.query={query}&selected=Material+Symbols+Outlined:{icon_name}:FILL@0{fill};wght@400;GRAD@0;opsz@24'
img_src_url = 'https://fonts.gstatic.com/s/i/short-term/release/materialsymbolsoutlined/{icon_name}/{svg_type}/24px.svg'
filled_regex = '(fill)(ed)?'
