...
@pytest.mark.e2e
def test_should_create_account_without_email_confirmation_core_1502(e2e_not_logged_api_client, e2e_staff_api_client, permission_manage_channels, permission_manage_settings):
    if False:
        for i in range(10):
            print('nop')
    ...
    input = {'enableAccountConfirmationByEmail': False}
