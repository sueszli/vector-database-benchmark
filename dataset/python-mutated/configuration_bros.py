...
BROS_PRETRAINED_CONFIG_ARCHIVE_MAP = {'jinho8345/bros-base-uncased': 'https://huggingface.co/jinho8345/bros-base-uncased/blob/main/config.json', 'jinho8345/bros-large-uncased': 'https://huggingface.co/jinho8345/bros-large-uncased/blob/main/config.json'}
