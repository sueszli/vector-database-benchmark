...
class DownloadScheduler(BaseAddon):
    ...
    __version__ = '0.30'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('timetable', 'str', 'List time periods as hh:mm full or number(kB/s)', '0:00 full, 7:00 250, 10:00 0, 17:00 150'), ('abort', 'bool', 'Abort active downloads when start period with speed 0', False)]
