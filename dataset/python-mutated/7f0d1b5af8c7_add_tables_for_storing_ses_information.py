...
SESEmailStatuses = sa.Enum('Accepted', 'Delivered', 'Soft Bounced', 'Bounced', 'Complained', name='ses_email_statuses')
SESEventTypes = sa.Enum('Delivery', 'Bounce', 'Complaint', name='ses_event_types')
EmailFailureTypes = sa.Enum('spam complaint', 'hard bounce', 'soft bounce', name='accounts_email_failure_types')
