...
class SquareAnnotation(Annotation):
    ...
    def __init__(self, bounding_box: Rectangle, fill_color: typing.Optional[Color]=None, stroke_color: typing.Optional[Color]=None, rectangle_difference: typing.Optional[typing.Tuple[Decimal, Decimal, Decimal, Decimal]]=None):
        if False:
            i = 10
            return i + 15
        super(SquareAnnotation, self).__init__(bounding_box=bounding_box, color=stroke_color)
