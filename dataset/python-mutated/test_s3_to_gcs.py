...
PARAMETRIZED_OBJECT_PATHS = ('apply_gcs_prefix, s3_prefix, s3_object, gcs_destination, gcs_object', [(False, '', MOCK_FILE_1, GCS_PATH_PREFIX, GCS_PREFIX + MOCK_FILE_1), (False, S3_PREFIX, MOCK_FILE_1, GCS_PATH_PREFIX, GCS_PREFIX + S3_PREFIX + MOCK_FILE_1), (False, '', MOCK_FILE_1, GCS_BUCKET_URI, MOCK_FILE_1), (False, S3_PREFIX, MOCK_FILE_1, GCS_BUCKET_URI, S3_PREFIX + MOCK_FILE_1), (True, '', MOCK_FILE_1, GCS_PATH_PREFIX, GCS_PREFIX + MOCK_FILE_1), (True, S3_PREFIX, MOCK_FILE_1, GCS_PATH_PREFIX, GCS_PREFIX + MOCK_FILE_1), (True, '', MOCK_FILE_1, GCS_BUCKET_URI, MOCK_FILE_1), (True, S3_PREFIX, MOCK_FILE_1, GCS_BUCKET_URI, MOCK_FILE_1)])
