...
def build_get_metrics_for_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignmentsUsageMetrics')
...
class RoleAssignmentMetricsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.authorization.v2019_08_01_preview.AuthorizationManagementClient`'s
        :attr:`role_assignment_metrics` attribute.
    """
    models = _models
    ...
    def get_metrics_for_subscription(self, **kwargs: Any) -> _models.RoleAssignmentMetricsResult:
        ...
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2019-08-01-preview'))
        cls: ClsType[_models.RoleAssignmentMetricsResult] = kwargs.pop('cls', None)
        request = build_get_metrics_for_subscription_request(subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_metrics_for_subscription.metadata['url'], headers=_headers, params=_params)
        ...
        return deserialized
    get_metrics_for_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/roleAssignmentsUsageMetrics'}