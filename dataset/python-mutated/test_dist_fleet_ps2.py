...
class TestPSPassWithBow(unittest.TestCase):
    ...
    def test(self):
        ...
        configs = {}
        configs['__emb__'] = {'table_parameters.__emb__.enable_sparse_table_cache': True, 'table_parameters.__emb__.shard_merge_rate': 1, 'table_parameters.__emb__.accessor.embed_sgd_param.name': 'SparseNaiveSGDRule', 'table_parameters.__emb__.accessor.embedx_sgd_param.name': 'SparseAdamSGDRule'}
