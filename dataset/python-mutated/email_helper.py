...
def weekly_report2(recipients, data):
    ...
    for i in data['issues_breakdown_by_day']:
        data['b_tr_d'] += f'''<td title="{i['day_long']}" style="font-size:14px;color:#333333;padding:10px 0 0;width:14%;border-right:10px solid #fff;font-weight:300;margin:0;text-align:center">\n            {i['day_short']}\n          </td>'''
        ...
        data['b_tr_u'] += f'<td valign="bottom" style="font-size:0;font-weight:300;padding:0;width:14%;border-right:10px solid #fff;height:110px;margin:0;text-align:left">\n            <table style="width:100%;font-weight:300;margin-bottom:0;border-collapse:collapse">\n                <tbody>{sup_partition}</tbody>\n            </table>\n          </td>'
