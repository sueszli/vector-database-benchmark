...
TEST_DATABASES = [dict(connector_type='bigquery', class_name='BigQuery', module_path='mage_ai.io.bigquery'), dict(connector_type='clickhouse', class_name='ClickHouse', module_path='mage_ai.io.clickhouse'), dict(connector_type='duckdb', class_name='DuckDB', module_path='mage_ai.io.duckdb'), dict(connector_type='mssql', class_name='MSSQL', module_path='mage_ai.io.mssql'), dict(connector_type='mysql', class_name='MySQL', module_path='mage_ai.io.mysql'), dict(connector_type='redshift', class_name='Redshift', module_path='mage_ai.io.redshift'), dict(connector_type='snowflake', class_name='Snowflake', module_path='mage_ai.io.snowflake'), dict(connector_type='trino', class_name='Trino', module_path='mage_ai.io.trino')]
