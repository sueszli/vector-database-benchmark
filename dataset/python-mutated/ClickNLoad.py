...
class ClickNLoad(BaseAddon):
    ...
    __version__ = '0.62'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', True), ('port', 'int', 'Port', 9666), ('extern', 'bool', 'Listen for external connections', True), ('dest', 'queue;collector', 'Add packages to', 'collector')]
    __description__ = "Click'n'Load support"
    __license__ = 'GPLv3'
    __authors__ = [('RaNaN', 'RaNaN@pyload.de'), ('Walter Purcaro', 'vuolter@gmail.com'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
