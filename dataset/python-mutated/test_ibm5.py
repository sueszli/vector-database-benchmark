...
class TestIBMModel5(unittest.TestCase):
    ...
    def test_prob_t_a_given_s(self):
        ...
        head_vacancy_table[1 - 0][6][3] = 0.97
        head_vacancy_table[3 - 0][5][4] = 0.97
        head_vacancy_table[1 - 2][4][4] = 0.97
        head_vacancy_table[2 - 0][2][1] = 0.97
        non_head_vacancy_table = defaultdict(lambda : defaultdict(lambda : defaultdict(float)))
        non_head_vacancy_table[1 - 0][1][0] = 0.96
        ...
        probabilities = {'p1': 0.167, 'translation_table': translation_table, 'fertility_table': fertility_table, 'head_vacancy_table': head_vacancy_table, 'non_head_vacancy_table': non_head_vacancy_table, 'head_distortion_table': None, 'non_head_distortion_table': None, 'alignment_table': None}
