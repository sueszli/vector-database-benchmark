...
try:
    ...
    from airflow.providers.cncf.kubernetes.executors.kubernetes_executor import KubernetesExecutor, PodReconciliationError
    from airflow.providers.cncf.kubernetes.executors.kubernetes_executor_types import POD_EXECUTOR_DONE_KEY
    from airflow.providers.cncf.kubernetes.executors.kubernetes_executor_utils import AirflowKubernetesScheduler, KubernetesJobWatcher, ResourceVersion, create_pod_id, get_base_pod_from_template
    from airflow.providers.cncf.kubernetes.kubernetes_helper_functions import annotations_for_logging_task_metadata, annotations_to_key, get_logs_task_metadata
