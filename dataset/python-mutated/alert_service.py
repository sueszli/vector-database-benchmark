...
__protobuf__ = proto.module(package='google.monitoring.v3', manifest={'CreateAlertPolicyRequest', 'GetAlertPolicyRequest', 'ListAlertPoliciesRequest', 'ListAlertPoliciesResponse', 'UpdateAlertPolicyRequest', 'DeleteAlertPolicyRequest'})
...
class CreateAlertPolicyRequest(proto.Message):
    ...
    alert_policy: alert.AlertPolicy = proto.Field(proto.MESSAGE, number=2, message=alert.AlertPolicy)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    alert_policies: MutableSequence[alert.AlertPolicy] = proto.RepeatedField(proto.MESSAGE, number=3, message=alert.AlertPolicy)
...
class UpdateAlertPolicyRequest(proto.Message):
    ...
    alert_policy: alert.AlertPolicy = proto.Field(proto.MESSAGE, number=3, message=alert.AlertPolicy)
