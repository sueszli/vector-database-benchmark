...
from ..utils import ExtractorError, int_or_none, remove_end, strip_or_none, traverse_obj, try_get, smuggle_url, unified_timestamp, unsmuggle_url, url_or_none
...
class ViuIE(ViuBaseIE):
    ...
    _TESTS = [{'url': 'https://www.viu.com/en/media/1116705532?containerId=playlist-22168059', 'info_dict': {'id': '1116705532', 'ext': 'mp4', 'title': 'Citizen Khan - Ep 1', 'description': 'md5:d7ea1604f49e5ba79c212c551ce2110e'}, 'params': {'skip_download': 'm3u8 download'}, 'skip': 'Geo-restricted to India'}, {'url': 'https://www.viu.com/en/media/1130599965', 'info_dict': {'id': '1130599965', 'ext': 'mp4', 'title': 'Jealousy Incarnate - Episode 1', 'description': 'md5:d3d82375cab969415d2720b6894361e9'}, 'params': {'skip_download': 'm3u8 download'}, 'skip': 'Geo-restricted to Indonesia'}, {'url': 'https://india.viu.com/en/media/1126286865', 'only_matching': True}]
...
class ViuPlaylistIE(ViuBaseIE):
    ...
    _TEST = {'url': 'https://www.viu.com/en/listing/playlist-22461380', 'info_dict': {'id': '22461380', 'title': 'The Good Wife'}, 'playlist_count': 16, 'skip': 'Geo-restricted to Indonesia'}
...
class ViuOTTIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.viu.com/ott/sg/en-us/vod/3421/The%20Prime%20Minister%20and%20I', 'info_dict': {'id': '3421', 'ext': 'mp4', 'title': 'A New Beginning', 'description': 'md5:1e7486a619b6399b25ba6a41c0fe5b2c'}, 'params': {'skip_download': 'm3u8 download', 'noplaylist': True}, 'skip': 'Geo-restricted to Singapore'}, {'url': 'https://www.viu.com/ott/hk/zh-hk/vod/430078/%E7%AC%AC%E5%85%AD%E6%84%9F-3', 'info_dict': {'id': '430078', 'ext': 'mp4', 'title': '大韓民國的1%', 'description': 'md5:74d6db47ddd9ddb9c89a05739103ccdb', 'episode_number': 1, 'duration': 6614, 'episode': '大韓民國的1%', 'series': '第六感 3', 'thumbnail': 'https://d2anahhhmp1ffz.cloudfront.net/1313295781/d2b14f48d008ef2f3a9200c98d8e9b63967b9cc2'}, 'params': {'skip_download': 'm3u8 download', 'noplaylist': True}, 'skip': 'Geo-restricted to Hong Kong'}, {'url': 'https://www.viu.com/ott/hk/zh-hk/vod/444666/%E6%88%91%E7%9A%84%E5%AE%A4%E5%8F%8B%E6%98%AF%E4%B9%9D%E5%B0%BE%E7%8B%90', 'playlist_count': 16, 'info_dict': {'id': '23807', 'title': '我的室友是九尾狐', 'description': 'md5:b42c95f2b4a316cdd6ae14ca695f33b9'}, 'params': {'skip_download': 'm3u8 download', 'noplaylist': False}, 'skip': 'Geo-restricted to Hong Kong'}]
    _AREA_ID = {'HK': 1, 'SG': 2, 'TH': 4, 'PH': 5}
    _LANGUAGE_FLAG = {'zh-hk': 1, 'zh-cn': 2, 'en-us': 3}
    _user_token = None
    _auth_codes = {}
...
class ViuOTTIndonesiaBaseIE(InfoExtractor):
    _BASE_QUERY = {'ver': 1.0, 'fmt': 'json', 'aver': 5.0, 'appver': 2.0, 'appid': 'viu_desktop', 'platform': 'desktop'}
    _DEVICE_ID = str(uuid.uuid4())
    _SESSION_ID = str(uuid.uuid4())
    _TOKEN = None
    _HEADERS = {'x-session-id': _SESSION_ID, 'x-client': 'browser'}
    _AGE_RATINGS_MAPPER = {'ADULTS': 18, 'teens': 13}
