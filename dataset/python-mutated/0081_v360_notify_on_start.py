...
class Migration(migrations.Migration):
    dependencies = [('main', '0080_v360_replace_job_origin')]
    operations = [migrations.AddField(model_name='organization', name='notification_templates_started', field=models.ManyToManyField(blank=True, related_name='organization_notification_templates_for_started', to='main.NotificationTemplate')), migrations.AddField(model_name='unifiedjobtemplate', name='notification_templates_started', field=models.ManyToManyField(blank=True, related_name='unifiedjobtemplate_notification_templates_for_started', to='main.NotificationTemplate')), migrations.RunPython(forwards_split_unified_job_template_any, None), migrations.RunPython(forwards_split_organization_any, None), migrations.RemoveField(model_name='organization', name='notification_templates_any'), migrations.RemoveField(model_name='unifiedjobtemplate', name='notification_templates_any')]