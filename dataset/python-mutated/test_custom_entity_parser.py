...
from snips_nlu.entity_parser.custom_entity_parser import CustomEntityParserUsage, _compute_char_shifts, _create_custom_entity_parser_configuration
from snips_nlu.preprocessing import tokenize
from snips_nlu.tests.utils import FixtureTest
DATASET = validate_and_format_dataset({'intents': {}, 'entities': {'dummy_entity_1': {'data': [{'value': 'dummy_entity_1', 'synonyms': ['dummy_1']}], 'use_synonyms': True, 'automatically_extensible': True, 'matching_strictness': 1.0, 'license_info': {'filename': 'LICENSE', 'content': 'some license content here'}}, 'dummy_entity_2': {'data': [{'value': 'dummy_entity_2', 'synonyms': ['dummy_2']}], 'use_synonyms': True, 'automatically_extensible': True, 'matching_strictness': 1.0}}, 'language': 'en'})
