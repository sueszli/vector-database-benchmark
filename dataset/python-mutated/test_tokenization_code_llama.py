...
from transformers import SPIECE_UNDERLINE, AddedToken, CodeLlamaTokenizer, CodeLlamaTokenizerFast, is_torch_available
...
class CodeLlamaTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    ...
    def test_save_pretrained(self):
        if False:
            i = 10
            return i + 15
        self.tokenizers_list = [(self.rust_tokenizer_class, 'hf-internal-testing/llama-code-tokenizer', {}), (self.tokenizer_class, 'hf-internal-testing/llama-code-tokenizer', {}), (self.tokenizer_class, 'codellama/CodeLlama-34b-Instruct-hf', {}), (self.rust_tokenizer_class, 'codellama/CodeLlama-34b-Instruct-hf', {})]
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(expected_encoding=expected_encoding, model_name='hf-internal-testing/llama-code-tokenizer', revision='6eb30c03ab6a9e2cdef4d523024909ec815ddb75', padding=False)
...
class LlamaIntegrationTest(unittest.TestCase):
    ...
    def test_fast_special_tokens(self):
        ...
        fast_tokenizer = CodeLlamaTokenizerFast.from_pretrained('hf-internal-testing/llama-tokenizer', add_eos_token=True, add_bos_token=False)
        fast = fast_tokenizer.encode('A sample test', add_special_tokens=True)
        assert fast == [319, 4559, 1243, 2]
        slow_tokenzier = CodeLlamaTokenizer.from_pretrained('hf-internal-testing/llama-tokenizer', add_eos_token=True, add_bos_token=False)
