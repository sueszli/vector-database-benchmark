...
@MODELS.register_module(Tasks.speaker_verification, module_name=Models.eres2net_aug_sv)
class SpeakerVerificationERes2Net(TorchModel):
    """Enhanced Res2Net_aug architecture with local and global feature fusion.
