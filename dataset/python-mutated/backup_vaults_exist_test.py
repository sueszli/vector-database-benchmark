...
class Test_backup_vaults_exist:
    ...
    def test_no_backup_vaults(self):
        ...
        with mock.patch('prowler.providers.aws.services.backup.backup_service.Backup', new=backup_client):
            from prowler.providers.aws.services.backup.backup_vaults_exist.backup_vaults_exist import backup_vaults_exist
    ...
    def test_one_backup_vault(self):
        ...
        with mock.patch('prowler.providers.aws.services.backup.backup_service.Backup', new=backup_client):
            ...
            assert result[0].status_extended == f'At least one backup vault exists: {result[0].resource_id}.'
