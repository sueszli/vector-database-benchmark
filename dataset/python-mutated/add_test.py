...
add_long_configs = op_bench.cross_product_configs(M=[8, 64, 128], N=range(2, 10, 3), K=[2 ** x for x in range(0, 3)], dtype=['int', 'float'], tags=['long'])
add_short_configs = op_bench.config_list(attrs=[[8, 16, 32, 'int'], [16, 16, 64, 'float'], [64, 64, 128, 'int']], attr_names=['M', 'N', 'K', 'dtype'], tags=['short'])
