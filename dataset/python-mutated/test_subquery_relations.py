...
class EagerTest(_fixtures.FixtureTest, testing.AssertsCompiledSQL):
    ...
    _pathing_runs = [('lazyload', 'lazyload', 'lazyload', 15), ('subqueryload', 'lazyload', 'lazyload', 12), ('subqueryload', 'subqueryload', 'lazyload', 8), ('joinedload', 'subqueryload', 'lazyload', 7), ('lazyload', 'lazyload', 'subqueryload', 12), ('subqueryload', 'subqueryload', 'subqueryload', 4), ('subqueryload', 'subqueryload', 'joinedload', 3)]
...
class CyclicalInheritingEagerTestTwo(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
...
class SubqueryloadDistinctTest(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
    run_inserts = 'once'
    run_deletes = None
