...
class FeatureCollisionAttack(PoisoningAttackWhiteBox):
    ...
    """
    attack_params = PoisoningAttackWhiteBox.attack_params + ['target', 'feature_layer', 'learning_rate', 'decay_coeff', 'stopping_tol', 'obj_threshold', 'num_old_obj', 'max_iter', 'similarity_coeff', 'watermark', 'verbose']
