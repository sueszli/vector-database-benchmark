...
if __name__ == '__main__':
    ...
    if args.directions:
        ...
        raw_files = itertools.chain(glob.glob(f'{raw_data}/train*'), glob.glob(f'{raw_data}/valid*'), glob.glob(f'{raw_data}/test*'))
    ...
    for direction in directions:
        ...
        if org_size == 0:
            ...
            continue
        real_data_situation.append((direction, new_size, org_size, org_size - new_size, (org_size - new_size) / org_size * 100))
