...
import numpy as np
from AnyQt.QtGui import QIcon, QPen, QBrush, QPainter, QPixmap, QCursor, QFont, QKeySequence, QPalette
from AnyQt.QtWidgets import QSizePolicy, QAction, QUndoCommand, QUndoStack, QGridLayout, QFormLayout, QToolButton, QActionGroup
...
class OWPaintData(OWWidget):
    ...
    class Information(OWWidget.Information):
        use_first_two = Msg('Paint Data uses data from the first two attributes.')
