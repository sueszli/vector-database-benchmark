...
import proto
__protobuf__ = proto.module(package='google.cloud.networksecurity.v1', manifest={'AuthorizationPolicy', 'ListAuthorizationPoliciesRequest', 'ListAuthorizationPoliciesResponse', 'GetAuthorizationPolicyRequest', 'CreateAuthorizationPolicyRequest', 'UpdateAuthorizationPolicyRequest', 'DeleteAuthorizationPolicyRequest'})
...
class AuthorizationPolicy(proto.Message):
    ...
    class Rule(proto.Message):
        ...
        class Source(proto.Message):
            ...
            """
            principals: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
            ip_blocks: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        ...
        class Destination(proto.Message):
            ...
            class HttpHeaderMatch(proto.Message):
                ...
                """
                regex_match: str = proto.Field(proto.STRING, number=2, oneof='type')
                header_name: str = proto.Field(proto.STRING, number=1)
            hosts: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
            ports: MutableSequence[int] = proto.RepeatedField(proto.UINT32, number=2)
            methods: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
            http_header_match: 'AuthorizationPolicy.Rule.Destination.HttpHeaderMatch' = proto.Field(proto.MESSAGE, number=5, message='AuthorizationPolicy.Rule.Destination.HttpHeaderMatch')
        sources: MutableSequence['AuthorizationPolicy.Rule.Source'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AuthorizationPolicy.Rule.Source')
        destinations: MutableSequence['AuthorizationPolicy.Rule.Destination'] = proto.RepeatedField(proto.MESSAGE, number=2, message='AuthorizationPolicy.Rule.Destination')
    ...
    action: Action = proto.Field(proto.ENUM, number=6, enum=Action)
    rules: MutableSequence[Rule] = proto.RepeatedField(proto.MESSAGE, number=7, message=Rule)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    authorization_policies: MutableSequence['AuthorizationPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AuthorizationPolicy')
...
class CreateAuthorizationPolicyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    authorization_policy_id: str = proto.Field(proto.STRING, number=2)
    authorization_policy: 'AuthorizationPolicy' = proto.Field(proto.MESSAGE, number=3, message='AuthorizationPolicy')
...
class UpdateAuthorizationPolicyRequest(proto.Message):
    ...
    authorization_policy: 'AuthorizationPolicy' = proto.Field(proto.MESSAGE, number=2, message='AuthorizationPolicy')
