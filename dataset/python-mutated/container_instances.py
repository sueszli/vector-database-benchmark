...
from azure.mgmt.containerinstance.models import Container, ContainerGroup, ContainerGroupSubnetId, ContainerPort, EnvironmentVariable, IpAddress, ResourceRequests, ResourceRequirements, Volume as _AzureVolume, VolumeMount
