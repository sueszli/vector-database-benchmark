...
import proto
__protobuf__ = proto.module(package='google.cloud.certificatemanager.v1', manifest={'ListCertificateIssuanceConfigsRequest', 'ListCertificateIssuanceConfigsResponse', 'GetCertificateIssuanceConfigRequest', 'CreateCertificateIssuanceConfigRequest', 'DeleteCertificateIssuanceConfigRequest', 'CertificateIssuanceConfig'})
...
class ListCertificateIssuanceConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    certificate_issuance_configs: MutableSequence['CertificateIssuanceConfig'] = proto.RepeatedField(proto.MESSAGE, number=1, message='CertificateIssuanceConfig')
...
class CreateCertificateIssuanceConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    certificate_issuance_config_id: str = proto.Field(proto.STRING, number=2)
    certificate_issuance_config: 'CertificateIssuanceConfig' = proto.Field(proto.MESSAGE, number=3, message='CertificateIssuanceConfig')
...
class CertificateIssuanceConfig(proto.Message):
    ...
    class CertificateAuthorityConfig(proto.Message):
        """The CA that issues the workload certificate. It includes CA
        ...
        class CertificateAuthorityServiceConfig(proto.Message):
            ...
            """
            ca_pool: str = proto.Field(proto.STRING, number=1)
        certificate_authority_service_config: 'CertificateIssuanceConfig.CertificateAuthorityConfig.CertificateAuthorityServiceConfig' = proto.Field(proto.MESSAGE, number=1, oneof='kind', message='CertificateIssuanceConfig.CertificateAuthorityConfig.CertificateAuthorityServiceConfig')
    name: str = proto.Field(proto.STRING, number=1)
    ...
    certificate_authority_config: CertificateAuthorityConfig = proto.Field(proto.MESSAGE, number=6, message=CertificateAuthorityConfig)
    lifetime: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=7, message=duration_pb2.Duration)
    rotation_window_percentage: int = proto.Field(proto.INT32, number=8)
    key_algorithm: KeyAlgorithm = proto.Field(proto.ENUM, number=9, enum=KeyAlgorithm)
