...
def _get_comments(group_tasks):
    ...
    return comments
_ORDERED_STATUSES = ('already_done', 'completed', 'ever_failed', 'failed', 'scheduling_error', 'still_pending', 'still_pending_ext', 'run_by_other_worker', 'upstream_failure', 'upstream_missing_dependency', 'upstream_run_by_other_worker', 'upstream_scheduling_error', 'not_run')
_PENDING_SUB_STATUSES = set(_ORDERED_STATUSES[_ORDERED_STATUSES.index('still_pending_ext'):])
_COMMENTS = {('already_done', 'complete ones were encountered'), ('completed', 'ran successfully'), ('failed', 'failed'), ('scheduling_error', 'failed scheduling'), ('still_pending', 'were left pending, among these'), ('still_pending_ext', 'were missing external dependencies'), ('run_by_other_worker', 'were being run by another worker'), ('upstream_failure', 'had failed dependencies'), ('upstream_missing_dependency', 'had missing dependencies'), ('upstream_run_by_other_worker', 'had dependencies that were being run by other worker'), ('upstream_scheduling_error', 'had dependencies whose scheduling failed'), ('not_run', 'was not granted run permission by the scheduler')}
