...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='generates images for the README.md banner')
    parser.add_argument('-c', '--classifiers', type=str, metavar='PATH', default='classifiers.png', help='path to save the classifiers banner image')
    parser.add_argument('-r', '--regressors', type=str, metavar='PATH', default='regressors.png', help='path to save the regressors banner image')
    parser.add_argument('-C', '--clusterers', type=str, metavar='PATH', default='clusterers.png', help='path to save the clusterers banner image')
    parser.add_argument('-b', '--banner', type=str, metavar='PATH', default='', help='make full banner image and save to disk')
    parser.add_argument('-y', '--yb', action='store_true', help='replace middle image of banner with logo')
