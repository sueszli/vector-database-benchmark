...
from .reductions import _apply_reduction, NATIVE_REDUCE_FNS, TORCH_REDUCE_FNS, TENSOR_REDUCE_FNS
from .unary import _apply_native_unary, NATIVE_UNARY_FNS, NATIVE_INPLACE_UNARY_FNS
__all__ = []
...
_function_fn_apply_map = {(tuple(NATIVE_REDUCE_FNS), tuple(TORCH_REDUCE_FNS), tuple(TENSOR_REDUCE_FNS)): _apply_reduction}
