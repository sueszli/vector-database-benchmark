...
async def test_tree_node_selected_message() -> None:
    ...
    async with TreeApp().run_test() as pilot:
        ...
        await pilot.pause()
        assert pilot.app.messages == [('NodeExpanded', 'test-tree'), ('NodeSelected', 'test-tree')]
...
async def test_tree_node_collapsed_message() -> None:
    ...
    async with TreeApp().run_test() as pilot:
        ...
        await pilot.pause()
        assert pilot.app.messages == [('NodeExpanded', 'test-tree'), ('NodeCollapsed', 'test-tree')]
...
async def test_tree_node_highlighted_message() -> None:
    ...
    async with TreeApp().run_test() as pilot:
        ...
        await pilot.pause()
        assert pilot.app.messages == [('NodeExpanded', 'test-tree'), ('NodeSelected', 'test-tree'), ('NodeHighlighted', 'test-tree')]