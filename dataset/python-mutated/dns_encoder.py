__all__ = ('DnsEncoder', 'Huffman')
IS_END = '\x00'
FREEDNS = ('100mountain.com', '10x.es', '120v.ac', '1337.cx', '24-7.ro', '2fine.de', '2p.fm', '3dxtras.com', '3trust.com', '404.mn', '4040.idv.tw', '4twenty.us', '688.org', '69.mu', 'abuser.eu', 'agropeople.ru', 'aintno.info', 'allisons.org', 'allowed.org', 'americajhon.com.pe', 'ananda.net.ve', 'antongorbunov.com', 'asenov.ru', 'asianfreshproduce.com', 'ask2ask.com', 'astrabus.ru', 'auraria.org', 'australia.ai', 'awiki.org', 'b33r.us', 'bad.mn', 'bandweite.de', 'beerprojects.com', 'benjamin.it', 'bigbox.info', 'birdriver.org', 'biz.tm', 'blinklab.com', 'blizzie.net', 'bloom.us', 'bot.nu', 'boxathome.net', 'ccmissoula.com', 'celebsplay.com', 'chickenkiller.com', 'cloudwatch.net', 'cnstefancelmare.ro', 'computersforpeace.net', 'crabdance.com', 'crackedsidewalks.com', 'crazycat.ro', 'csproject.org', 'custom-gaming.net', 'd-n-s.name', 'd-n-s.org.uk', 'dalk.ru', 'darksair.org', 'digitalgroupe.com', 'dmtr.ru', 'dnet.hu', 'dob.jp', 'dp76.com', 'drunkensailor.org', 'dyn.mk', 'e-data.com.tr', 'e-m-a-i-l.org', 'elchemi.com', 'endlessmovie.com', 'enemyterritory.org', 'epicgamer.org', 'erke.biz.tr', 'erki.net', 'eva.hk', 'everton.com', 'evils.in', 'evs.net.br', 'ezxdev.org', 'fairuse.org', 'farted.net', 'fedea.com.ar', 'fin-tech.com', 'fivepals.com', 'forss.to', 'fr.to', 'ftp.sh', 'galipan.net.ve', 'gerastar.ru', 'ghostnation.org', 'giveawaylisting.com', 'good-newz.org', 'good.one.pl', 'gtk.cl', 'gurcanozturk.com', 'h-o-s-t.name', 'h0stname.net', 'h4ck.me', 'hackquest.com', 'hamshack.info', 'happyforever.com', 'hbmc.net', 'hiddencorner.org', 'hijaxdesigns.com', 'hin.tw', 'hitremixes.com', 'hmail.us', 'hmao.pro', 'home.kg', 'homelinuxserver.org', 'homeplex.org', 'host2go.net', 'hpc.tw', 'hs.vc', 'iceblaze.com', 'ig42.org', 'ignorelist.com', 'iiiii.info', 'iminecraft.se', 'inet2.org', 'inflict.us', 'info.gf', 'info.tm', 'innograph.co.id', 'inovasi.co.id', 'iu4ever.org', 'ivi.pl', 'jedimasters.net', 'jesus.si', 'joe.dj', 'joiavip.com.br', 'jumpingcrab.com', 'jundy.org', 'k22.su', 'kalbas.com.vn', 'kck-saratov.ru', 'kein.hk', 'kir22.ru', 'ko.tl', 'kyrgyzstan.kg', 'l5.ca', 'lanas.cl', 'lee.mx', 'lex.mn', 'linkin.tw', 'lovethosetrains.com', 'madhacker.biz', 'make.com.ar', 'malam.or.id', 'mcsoft.org', 'mikata.ru', 'mindhackers.org', 'mine.bz', 'minecraftnoob.com', 'minecraftr.us', 'mm.my', 'mooo.com', 'mooo.info', 'morganisageek.org', 'mwop.net', 'my.to', 'mycloud.bz', 'mylogisoft.com', 'mysaol.com', 'n-e-t.name', 'nard.ca', 'nav.co.id', 'nedvighimost-sochi.ru', 'netlord.de', 'notici.as', 'now.im', 'oganilirkab.go.id', 'ohbah.com', 'patelmortgage.com', 'photo-cult.com', 'photo-frame.com', 'php-dev.net', 'pii.at', 'pixelfucker.com', 'playminecraft.ml', 'polissya.eu', 'port0.org', 'portalindustries.org', 'possessed.us', 'priamaakcia.sk', 'privatedns.org', 'privateimport.jp', 'procare.co.id', 'prostore.ru', 'psybnc.org', 'punked.us', 'qc.to', 'qlbv.vn', 'r-o-o-t.net', 'radiogirl.fm', 'raspberryip.com', 'reason.org.nz', 'richlorenz.com', 'ro.lt', 'root.sx', 'routemehome.com', 'ruok.org', 'rwbcode.com', 'sadayuki.jp', 'sales-people.ru', 'scay.net', 'scottlewisonline.com', 'sdp-mos.ru', 'servernux.com', 'serverpit.com', 'shen.cl', 'shop.tm', 'sly.io', 'smelly.cc', 'soon.it', 'spacetechnology.net', 'spelar.se', 'stfu-kthx.net', 'stocktester.ru', 'strangled.net', 'stroyexpert.org', 'suka.se', 'sumibi.org', 'surak.kz', 'surfnet.ca', 't28.net', 'takeshi.cnt.br', 'technopagans.com', 'thehomeserver.net', 'tru.io', 'tuck.tw', 'twilightparadox.com', 'tzafrir.org.il', 'u888.cn', 'ufodns.com', 'ugo.si', 'uk.ms', 'uk.to', 'undo.it', 'us.to', 'vankin.de', 'vctel.com', 've3.info', 'verymad.net', 'violates.me', 'vxe6.net', 'webs.vc', 'wiki.gd', 'wildsurf.net', 'winkel.com.ar', 'womenclothingtoday.com', 'xpresit.net', 'xxxxx.tw', 'yngling.com', 'yourspecialtee.com', 'z0d.eu', 'z86.ru', 'zanity.net')
...
class Huffman(object):
    __slots__ = ('encoding_table', 'decoding_tree', 'decoding_table')
...
class TmpResult(object):
    __slots__ = ('encoded_tables', 'encoded', 'rest', 'table_id')
...
if __name__ == '__main__':
    ...
    class CTDictBuilder(object):
        __slots__ = ('terms', 'generic', 'tlds', 'cdns', 'freedns')
