...
SCHEMA_WS_SETUP_MFA = vol.All(websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend({vol.Required('type'): WS_TYPE_SETUP_MFA, vol.Exclusive('mfa_module_id', 'module_or_flow_id'): str, vol.Exclusive('flow_id', 'module_or_flow_id'): str, vol.Optional('user_input'): object}), cv.has_at_least_one_key('mfa_module_id', 'flow_id'))
WS_TYPE_DEPOSE_MFA = 'auth/depose_mfa'
SCHEMA_WS_DEPOSE_MFA = websocket_api.BASE_COMMAND_MESSAGE_SCHEMA.extend({vol.Required('type'): WS_TYPE_DEPOSE_MFA, vol.Required('mfa_module_id'): str})
...
async def async_setup(hass: HomeAssistant) -> None:
    ...
    websocket_api.async_register_command(hass, WS_TYPE_SETUP_MFA, websocket_setup_mfa, SCHEMA_WS_SETUP_MFA)
    websocket_api.async_register_command(hass, WS_TYPE_DEPOSE_MFA, websocket_depose_mfa, SCHEMA_WS_DEPOSE_MFA)
