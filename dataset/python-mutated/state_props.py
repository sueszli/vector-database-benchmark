...
from localstack.services.stepfunctions.asl.component.state.state_execution.state_map.item_reader.reader_config.max_items_decl import MaxItemsDecl
...
class StateProps(TypedProps):
    _UNIQUE_SUBINSTANCES: Final[set[type]] = {Resource, WaitFunction, Timeout, Heartbeat, MaxItemsDecl}
    name: str
