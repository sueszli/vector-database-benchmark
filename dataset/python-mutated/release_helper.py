...
LINKIFY_ISSUE_REFS_RE = re.compile('#(\\d+)')
...
def create_short_lived_branch(release_type: ReleaseType, version: str) -> None:
    ...
    pause()
    set_release_stage(ReleaseStage.SHORT_LIVED_BRANCH_CREATED)
STEPS = (ensure_no_release_blockers, check_state_of_open_pulls, create_changelog, review_changelog, run_prepare_release_workflow, create_short_lived_branch)
