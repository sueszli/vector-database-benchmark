...
from samcli.lib.cli_validation.remote_invoke_options_validations import event_and_event_file_options_validation, stack_name_or_resource_id_atleast_one_option_validation
