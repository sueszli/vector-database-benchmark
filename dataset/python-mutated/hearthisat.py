...
from ..utils import determine_ext, KNOWN_EXTENSIONS, str_to_int
...
class HearThisAtIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://hearthis.at/moofi/dr-kreep', 'md5': 'ab6ec33c8fed6556029337c7885eb4e0', 'info_dict': {'id': '150939', 'ext': 'wav', 'title': 'Moofi - Dr. Kreep', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1421564134, 'description': 'md5:1adb0667b01499f9d27e97ddfd53852a', 'upload_date': '20150118', 'view_count': int, 'duration': 71, 'genre': 'Experimental'}}, {'url': 'https://hearthis.at/twitchsf/dj-jim-hopkins-totally-bitchin-80s-dance-mix/', 'md5': '5980ceb7c461605d30f1f039df160c6e', 'info_dict': {'id': '811296', 'ext': 'mp3', 'title': "TwitchSF - DJ Jim Hopkins -  Totally Bitchin' 80's Dance Mix!", 'description': 'md5:ef26815ca8f483272a87b137ff175be2', 'upload_date': '20160328', 'timestamp': 1459186146, 'thumbnail': 're:^https?://.*\\.jpg$', 'view_count': int, 'duration': 4360, 'genre': 'Dance'}}]
