...
class CommunicationNetworkTraversalOperations:
    ...
    async def issue_relay_configuration(self, id: Optional[str]=None, route_type: Optional[Union[str, '_models.RouteType']]=None, ttl: Optional[int]=172800, **kwargs: Any) -> '_models.CommunicationRelayConfiguration':
        ...
        api_version = kwargs.pop('api_version', '2022-03-01-preview')
        ...
        if _body is not None:
            ...
            _json = None
        request = build_issue_relay_configuration_request(api_version=api_version, content_type=content_type, json=_json, template_url=self.issue_relay_configuration.metadata['url'])
        ...
        return deserialized
    issue_relay_configuration.metadata = {'url': '/networkTraversal/:issueRelayConfiguration'}