...
if __name__ == '__main__':
    ...
    parser.add_argument('--empty', action='store_true', help="Don't plot any content, just test creating and destroying figures")
    parser.add_argument('--interactive', action='store_true', help='Turn on interactive mode to actually open windows.  Only works with some GUI backends.')
