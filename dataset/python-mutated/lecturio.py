...
from ..utils import clean_html, determine_ext, ExtractorError, float_or_none, int_or_none, str_or_none, url_or_none, urlencode_postdata, urljoin
...
class LecturioIE(LecturioBaseIE):
    ...
    _TESTS = [{'url': 'https://app.lecturio.com/medical-courses/important-concepts-and-terms-introduction-to-microbiology.lecture#tab/videos', 'md5': '9a42cf1d8282a6311bf7211bbde26fde', 'info_dict': {'id': '39634', 'ext': 'mp4', 'title': 'Important Concepts and Terms — Introduction to Microbiology'}, 'skip': 'Requires lecturio account credentials'}, {'url': 'https://www.lecturio.de/jura/oeffentliches-recht-staatsexamen.vortrag', 'only_matching': True}, {'url': 'https://www.lecturio.de/jura/oeffentliches-recht-at-1-staatsexamen/oeffentliches-recht-staatsexamen.vortrag', 'only_matching': True}, {'url': 'https://app.lecturio.com/#/lecture/c/6434/39634', 'only_matching': True}]
    _CC_LANGS = {'Arabic': 'ar', 'Bulgarian': 'bg', 'German': 'de', 'English': 'en', 'Spanish': 'es', 'Persian': 'fa', 'French': 'fr', 'Japanese': 'ja', 'Polish': 'pl', 'Pashto': 'ps', 'Russian': 'ru'}
...
class LecturioCourseIE(LecturioBaseIE):
    ...
    _TESTS = [{'url': 'https://app.lecturio.com/medical-courses/microbiology-introduction.course#/', 'info_dict': {'id': 'microbiology-introduction', 'title': 'Microbiology: Introduction', 'description': 'md5:13da8500c25880c6016ae1e6d78c386a'}, 'playlist_count': 45, 'skip': 'Requires lecturio account credentials'}, {'url': 'https://app.lecturio.com/#/course/c/6434', 'only_matching': True}]
...
class LecturioDeCourseIE(LecturioBaseIE):
    ...
    _TEST = {'url': 'https://www.lecturio.de/jura/grundrechte.kurs', 'only_matching': True}
