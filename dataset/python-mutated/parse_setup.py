...
def _parse_setup_cfg(path: str) -> Dict[str, Any]:
    ...
    return result
setup_kwargs = {}
SUPPORTED_ARGS = ('name', 'version', 'description', 'license', 'author', 'author_email', 'maintainer', 'maintainer_email', 'keywords', 'classifiers', 'url', 'download_url', 'project_urls', 'python_requires', 'install_requires', 'extras_require', 'entry_points', 'package_dir')
