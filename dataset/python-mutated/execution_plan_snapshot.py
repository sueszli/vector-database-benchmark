...
from dagster._core.execution.plan.inputs import StepInput, StepInputSourceUnion, UnresolvedCollectStepInput, UnresolvedMappedStepInput
...
from dagster._core.execution.plan.step import ExecutionStep, IExecutionStep, StepKind, UnresolvedCollectExecutionStep, UnresolvedMappedExecutionStep
...
@whitelist_for_serdes(storage_field_names={'job_snapshot_id': 'pipeline_snapshot_id'}, skip_when_empty_fields={'repository_load_data'})
class ExecutionPlanSnapshot(NamedTuple('_ExecutionPlanSnapshot', [('steps', Sequence['ExecutionStepSnap']), ('artifacts_persisted', bool), ('job_snapshot_id', str), ('step_keys_to_execute', Sequence[str]), ('initial_known_state', Optional[KnownExecutionState]), ('snapshot_version', Optional[int]), ('executor_name', Optional[str]), ('repository_load_data', Optional[RepositoryLoadData])])):
...
class ExecutionStepSnap(NamedTuple('_ExecutionStepSnap', [('key', str), ('inputs', Sequence['ExecutionStepInputSnap']), ('outputs', Sequence['ExecutionStepOutputSnap']), ('node_handle_id', str), ('kind', StepKind), ('metadata_items', Sequence['ExecutionPlanMetadataItemSnap']), ('tags', Optional[Mapping[str, str]]), ('step_handle', Optional[StepHandleUnion])])):
...
@whitelist_for_serdes
class ExecutionStepInputSnap(NamedTuple('_ExecutionStepInputSnap', [('name', str), ('dagster_type_key', str), ('upstream_output_handles', Sequence[StepOutputHandle]), ('source', Optional[StepInputSourceUnion])])):
...
class ExecutionStepOutputSnap(NamedTuple('_ExecutionStepOutputSnap', [('name', str), ('dagster_type_key', str), ('node_handle', Optional[NodeHandle]), ('properties', Optional[StepOutputProperties])])):
...
@whitelist_for_serdes
class ExecutionPlanMetadataItemSnap(NamedTuple('_ExecutionPlanMetadataItemSnap', [('key', str), ('value', str)])):
