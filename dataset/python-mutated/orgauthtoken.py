...
from sentry.db.models import ArrayField, BaseManager, FlexibleForeignKey, control_silo_only_model, sane_repr
...
class OrgAuthToken(ReplicatedControlModel):
    ...
    scope_list = ArrayField(models.TextField(), validators=[validate_scope_list])
    ...
    project_last_used_id = HybridCloudForeignKey('sentry.Project', null=True, blank=True, on_delete='SET_NULL')
