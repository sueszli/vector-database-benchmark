...
class AsyncConnectionErrorRetryHandler(AsyncRetryHandler):
    ...
    def __init__(self, max_retry_count: int=1, interval_calculator: RetryIntervalCalculator=default_interval_calculator, error_types: List[Type[Exception]]=[ServerConnectionError, ServerDisconnectedError, ClientOSError]):
        if False:
            while True:
                i = 10
