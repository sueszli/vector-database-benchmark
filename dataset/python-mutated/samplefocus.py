...
class SampleFocusIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://samplefocus.com/samples/lil-peep-sad-emo-guitar', 'md5': '48c8d62d60be467293912e0e619a5120', 'info_dict': {'id': '40316', 'display_id': 'lil-peep-sad-emo-guitar', 'ext': 'mp3', 'title': 'Lil Peep Sad Emo Guitar', 'thumbnail': 're:^https?://.+\\.png', 'license': 'Standard License', 'uploader': 'CapsCtrl', 'uploader_id': 'capsctrl', 'like_count': int, 'comment_count': int, 'categories': ['Samples', 'Guitar', 'Electric guitar']}}, {'url': 'https://samplefocus.com/samples/dababy-style-bass-808', 'only_matching': True}, {'url': 'https://samplefocus.com/samples/young-chop-kick', 'only_matching': True}]
