...
class Modulator(object):
    ...
    MODULATION_TYPES_VERBOSE = {'ASK': 'Amplitude Shift Keying (ASK)', 'FSK': 'Frequency Shift Keying (FSK)', 'PSK': 'Phase Shift Keying (PSK)', 'OQPSK': 'Offset Quadrature Phase Shift Keying (OQPSK)', 'GFSK': 'Gaussian Frequeny Shift Keying (GFSK)'}
