...
class CamdemyIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.camdemy.com/media/5181/', 'md5': '5a5562b6a98b37873119102e052e311b', 'info_dict': {'id': '5181', 'ext': 'mp4', 'title': 'Ch1-1 Introduction, Signals (02-23-2012)', 'thumbnail': 're:^https?://.*\\.jpg$', 'creator': 'ss11spring', 'duration': 1591, 'upload_date': '20130114', 'view_count': int}}, {'url': 'http://www.camdemy.com/media/13885', 'md5': '4576a3bb2581f86c61044822adbd1249', 'info_dict': {'id': '13885', 'ext': 'mp4', 'title': 'EverCam + Camdemy QuickStart', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'md5:2a9f989c2b153a2342acee579c6e7db6', 'creator': 'evercam', 'duration': 318}}, {'url': 'http://www.camdemy.com/media/14842', 'info_dict': {'id': '2vsYQzNIsJo', 'ext': 'mp4', 'title': 'Excel 2013 Tutorial - How to add Password Protection', 'description': 'Excel 2013 Tutorial for Beginners - How to add Password Protection', 'upload_date': '20130211', 'uploader': 'Hun Kim', 'uploader_id': 'hunkimtutorials'}, 'params': {'skip_download': True}}]
...
class CamdemyFolderIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.camdemy.com/folder/450', 'info_dict': {'id': '450', 'title': '信號與系統 2012 & 2011 (Signals and Systems)'}, 'playlist_mincount': 145}, {'url': 'http://www.camdemy.com/folder/853', 'info_dict': {'id': '853', 'title': '科學計算 - 使用 Matlab'}, 'playlist_mincount': 20}, {'url': 'http://www.camdemy.com/folder/853/?displayMode=defaultOrderByOrg', 'info_dict': {'id': '853', 'title': '科學計算 - 使用 Matlab'}, 'playlist_mincount': 20}]
