import pyxel
from .settings import EDITOR_IMAGE, MAX_SOUND_LENGTH, SOUND_FIELD_CURSOR_EDIT_COLOR, SOUND_FIELD_CURSOR_SELECT_COLOR, SOUND_FIELD_DATA_NORMAL_COLOR, SOUND_FIELD_DATA_SELECT_COLOR, TEXT_LABEL_COLOR
