...
@testing.parameterize(*testing.product({'in_shape': [(2,), (2, 5)], 'pool_size': [3], 'out_size': [4], 'initial_bias': ['random', 'scalar', None], 'batchsize': [7]}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'initializer': ['Initializer', 'scalar', 'ndarray', 'callable']}))
