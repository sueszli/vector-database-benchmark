...
from ....order.utils import delete_order_line, invalidate_order_prices, recalculate_order_weight
...
class OrderLineDelete(EditableOrderValidationMixin, BaseMutation):
    ...
    order_line = graphene.Field(OrderLine, description='An order line that was deleted.')
