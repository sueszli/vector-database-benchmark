...
import dataclasses
import os, sys
module_mapping = {'gpt-4': {'config_name': 'GPT4ConfigClass', 'module_name': 'chatgpt_api', 'class_name': 'ChatGPTAPI'}, 'gpt-4-turbo': {'config_name': 'GPT4Turbo', 'module_name': 'chatgpt_api', 'class_name': 'ChatGPTAPI'}, 'gpt-3.5-turbo-16k': {'config_name': 'GPT35Turbo16kConfigClass', 'module_name': 'chatgpt_api', 'class_name': 'ChatGPTAPI'}, 'gpt4all': {'config_name': 'GPT4ALLConfigClass', 'module_name': 'gpt4all_api', 'class_name': 'GPT4ALLAPI'}, 'titan': {'config_name': 'TitanConfigClass', 'module_name': 'titan_api', 'class_name': 'TitanAPI'}, 'azure-gpt-3.5': {'config_name': 'AzureGPT35ConfigClass', 'module_name': 'azure_api', 'class_name': 'AzureGPTAPI'}}
