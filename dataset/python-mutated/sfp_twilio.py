...
class sfp_twilio(SpiderFootPlugin):
    meta = {'name': 'Twilio', 'summary': 'Obtain information from Twilio about phone numbers. Ensure you have the Caller Name add-on installed in Twilio.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Search Engines'], 'dataSource': {'website': 'https://www.twilio.com/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://www.twilio.com/docs/all', 'https://www.twilio.com/blog/what-does-twilio-do'], 'apiKeyInstructions': ['Visit https://www.twilio.com', 'Register a free account', 'Navigate to https://www.twilio.com/console', "The API key combination is listed under 'Account SID' and 'Auth Token'"], 'favIcon': 'https://www.datasource.com/favicon.ico', 'logo': 'https://www.datasource.com/logo.gif', 'description': 'Twilio is a cloud communications platform as a service company based in San Francisco, California. Twilio allows software developers to programmatically make and receive phone calls, send and receive text messages, and perform other communication functions using its web service APIs.'}}
    opts = {'api_key_account_sid': '', 'api_key_auth_token': ''}
    optdescs = {'api_key_account_sid': 'Twilio Account SID', 'api_key_auth_token': 'Twilio Auth Token'}
    results = None
    errorState = False
