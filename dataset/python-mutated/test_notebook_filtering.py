...
PLAYLIST_CONTENT = lambda : {'type': 'ph-recording-playlist', 'attrs': {'filters': '{"specific_filters": "in here"}'}}
FEATURE_FLAG_CONTENT = lambda id: {'type': 'ph-feature-flag', 'attrs': {'id': id or 1}}
...
RECORDING_COMMENT_CONTENT = lambda id, text: {'type': 'paragraph', 'content': [{'type': 'ph-replay-timestamp', 'attrs': {'playbackTime': 0, 'sessionRecordingId': id or 'session_recording_id'}}, {'text': text or 'what the person typed', 'type': 'text'}]}
QUERY_CONTENT = lambda id: {'type': 'ph-query', 'attrs': {'query': {'kind': 'SavedInsightNode', 'shortId': id or 'insight_short_id'}}}
