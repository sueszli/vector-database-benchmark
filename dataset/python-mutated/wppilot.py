...
from ..utils import try_get, ExtractorError
import json
import random
import re
...
class WPPilotBaseIE(InfoExtractor):
    ...
    _HEADERS_WEB = {'Content-Type': 'application/json; charset=UTF-8', 'Referer': 'https://pilot.wp.pl/tv/'}
...
class WPPilotIE(WPPilotBaseIE):
    ...
    IE_NAME = 'wppilot'
    _TESTS = [{'url': 'https://pilot.wp.pl/tv/#telewizja-wp-hd', 'info_dict': {'id': '158', 'ext': 'mp4', 'title': 'Telewizja WP HD'}, 'params': {'format': 'bestvideo'}}, {'url': 'https://pilot.wp.pl/tv/#radio-nowy-swiat', 'info_dict': {'id': '238', 'ext': 'm4a', 'title': 'Radio Nowy Świat'}, 'params': {'format': 'bestaudio'}}, {'url': 'wppilot:9', 'only_matching': True}]
...
class WPPilotChannelsIE(WPPilotBaseIE):
    ...
    _TESTS = [{'url': 'wppilot:', 'info_dict': {'id': 'wppilot', 'title': 'WP Pilot'}, 'playlist_mincount': 100}, {'url': 'https://pilot.wp.pl/', 'only_matching': True}]
