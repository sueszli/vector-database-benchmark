...
def __virtual__():
    ...
    return (False, 'The esxi execution module failed to load: only available on proxy minions.')
...
def _deprecation_message(function):
    ...
    def wrapped(*args, **kwargs):
        if False:
            print('Hello World!')
        salt.utils.versions.warn_until(3008, "The 'esxi' functionality in Salt has been deprecated and its functionality will be removed in version 3008 in favor of the saltext.vmware Salt Extension. (https://github.com/saltstack/salt-ext-modules-vmware)", category=FutureWarning)
