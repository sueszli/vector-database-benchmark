...
def main():
    ...
    response = client.clusters.begin_update(resource_group_name='TestGroup', cluster_name='testcluster', parameters={'properties': {'maintenanceWindow': {'customWindow': 'Enabled', 'dayOfWeek': 0, 'startHour': 8, 'startMinute': 0}}}).result()
    print(response)
