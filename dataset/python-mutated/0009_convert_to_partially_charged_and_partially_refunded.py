...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(convert_charged_to_paritally_charged_and_partially_refunded, convert_paritally_charged_and_partially_refunded_to_charged)]