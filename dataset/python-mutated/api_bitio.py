...
class BitioReposSheet(Sheet):
    rowtype = 'repos'
    columns = [AttrColumn('name'), AttrColumn('creator'), AttrColumn('owner'), AttrColumn('bytes', type=int, width=0), AttrColumn('collaborators'), AttrColumn('description'), AttrColumn('documentation'), AttrColumn('endpoints'), AttrColumn('is_private'), AttrColumn('license'), AttrColumn('query_count'), AttrColumn('stars'), AttrColumn('tables'), AttrColumn('url'), AttrColumn('watchers')]
    defer = True
...
class BitioRepoSheet(Sheet):
    rowtype = 'tables'
    columns = [AttrColumn('url'), AttrColumn('current_name'), AttrColumn('description'), AttrColumn('columns'), AttrColumn('num_records', type=int), AttrColumn('bytes', type=int), AttrColumn('repo'), AttrColumn('documentation')]
