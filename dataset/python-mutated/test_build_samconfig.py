...
configs = {'.toml': 'samconfig/samconfig.toml', '.yaml': 'samconfig/samconfig.yaml', '.yml': 'samconfig/samconfig.yml', '.json': 'samconfig/samconfig.json', '.jpeg': 'samconfig/samconfig.jpeg'}
...
@parameterized_class([{'extensions': ['.toml', '.yaml', '.yml']}, {'extensions': ['.yaml', '.yml']}])
