...
class SsdInceptionV3FeatureExtractorTest(ssd_feature_extractor_test.SsdFeatureExtractorTestBase):
    ...
    def _create_feature_extractor(self, depth_multiplier, pad_to_multiple, use_explicit_padding=False, num_layers=6, is_training=True):
        ...
        min_depth = 32
        return ssd_inception_v3_feature_extractor.SSDInceptionV3FeatureExtractor(is_training, depth_multiplier, min_depth, pad_to_multiple, self.conv_hyperparams_fn, num_layers=num_layers, override_base_feature_extractor_hyperparams=True)
    ...
    def test_extract_features_returns_correct_shapes_128(self):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 13, 13, 288), (2, 6, 6, 768), (2, 2, 2, 2048), (2, 1, 1, 512), (2, 1, 1, 256), (2, 1, 1, 128)]
    ...
    def test_extract_features_returns_correct_shapes_299(self):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 35, 35, 288), (2, 17, 17, 768), (2, 8, 8, 2048), (2, 4, 4, 512), (2, 2, 2, 256), (2, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape)
    ...
    def test_extract_features_returns_correct_shapes_enforcing_min_depth(self):
        ...
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 35, 35, 128), (2, 17, 17, 128), (2, 8, 8, 192), (2, 4, 4, 32), (2, 2, 2, 32), (2, 1, 1, 32)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape)
    ...
    def test_extract_features_returns_correct_shapes_with_pad_to_multiple(self):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 32
        expected_feature_map_shape = [(2, 37, 37, 288), (2, 18, 18, 768), (2, 8, 8, 2048), (2, 4, 4, 512), (2, 2, 2, 256), (2, 1, 1, 128)]
        self.check_extract_features_returns_correct_shape(2, image_height, image_width, depth_multiplier, pad_to_multiple, expected_feature_map_shape)
    ...
    def test_extract_features_with_fewer_layers(self):
        ...
        depth_multiplier = 1.0
        pad_to_multiple = 1
        expected_feature_map_shape = [(2, 13, 13, 288), (2, 6, 6, 768), (2, 2, 2, 2048), (2, 1, 1, 512)]
