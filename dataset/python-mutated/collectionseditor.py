...
from qtpy.QtCore import QAbstractTableModel, QItemSelectionModel, QModelIndex, Qt, Signal, Slot
from qtpy.QtGui import QColor, QKeySequence
from qtpy.QtWidgets import QApplication, QHBoxLayout, QHeaderView, QInputDialog, QLineEdit, QMenu, QMessageBox, QPushButton, QTableView, QVBoxLayout, QWidget
from spyder_kernels.utils.lazymodules import FakeObject, numpy as np, pandas as pd, PIL
from spyder_kernels.utils.misc import fix_reference_name
from spyder_kernels.utils.nsview import display_to_value, get_human_readable_type, get_numeric_numpy_types, get_numpy_type_string, get_object_attrs, get_size, get_type_string, sort_against, try_to_eval, unsorted_unique, value_to_display
from spyder.api.config.fonts import SpyderFontsMixin, SpyderFontType
from spyder.api.config.mixins import SpyderConfigurationAccessor
from spyder.api.widgets.toolbars import SpyderToolbar
from spyder.config.base import _, running_under_pytest
from spyder.py3compat import is_binary_string, to_text_string, is_type_text_string
from spyder.utils.icon_manager import ima
from spyder.utils.misc import getcwd_or_home
from spyder.utils.qthelpers import add_actions, create_action, MENU_SEPARATOR, mimedata2url
from spyder.utils.stringmatching import get_search_scores, get_search_regex
from spyder.plugins.variableexplorer.widgets.collectionsdelegate import CollectionsDelegate
...
MAX_SERIALIZED_LENGHT = 1000000.0
LARGE_NROWS = 100
ROWS_TO_LOAD = 50
