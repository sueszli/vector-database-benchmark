...
class EulerAngleRotation(_EulerRotation, Model):
    ...
    n_inputs = 2
    n_outputs = 2
    phi = Parameter(default=0, getter=_to_orig_unit, setter=_to_radian, description='1st Euler angle (Quantity or value in deg)')
    theta = Parameter(default=0, getter=_to_orig_unit, setter=_to_radian, description='2nd Euler angle (Quantity or value in deg)')
    psi = Parameter(default=0, getter=_to_orig_unit, setter=_to_radian, description='3rd Euler angle (Quantity or value in deg)')
...
class Rotation2D(Model):
    ...
    n_outputs = 2
    _separable = False
    angle = Parameter(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='Angle of rotation (Quantity or value in deg)')
