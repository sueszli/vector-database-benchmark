...
@pytest.mark.skipif(NO_MYSQL, reason='Please install MySQL bindings and a MySQL Server before running MySQL integration tests.')
class MysqlGrantsStateTest(ModuleCase, SaltReturnAssertsMixin):
    ...
    table1 = 'foo'
    table2 = "foo `'%_bar"
    users = {'user1': {'name': 'foo', 'pwd': 'bar'}, 'user2': {'name': 'user ";--,?:&/\\', 'pwd': '";--(),?:@=&/\\'}, 'user3': {'name': 'user( @ )=foobar', 'pwd': 'æ¨\x99æ¨\x99'}, 'user4': {'name': 'user æ¨\x99', 'pwd': 'æ¨\x99æ¨\x99'}}
