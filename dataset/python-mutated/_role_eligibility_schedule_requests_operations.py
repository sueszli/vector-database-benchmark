...
def build_create_request(scope: str, role_eligibility_schedule_request_name: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/roleEligibilityScheduleRequests/{roleEligibilityScheduleRequestName}')
    path_format_arguments = {'scope': _SERIALIZER.url('scope', scope, 'str', skip_quote=True), 'roleEligibilityScheduleRequestName': _SERIALIZER.url('role_eligibility_schedule_request_name', role_eligibility_schedule_request_name, 'str')}
...
def build_cancel_request(scope: str, role_eligibility_schedule_request_name: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2020-10-01'))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/roleEligibilityScheduleRequests/{roleEligibilityScheduleRequestName}/cancel')
    path_format_arguments = {'scope': _SERIALIZER.url('scope', scope, 'str', skip_quote=True), 'roleEligibilityScheduleRequestName': _SERIALIZER.url('role_eligibility_schedule_request_name', role_eligibility_schedule_request_name, 'str')}
    _url: str = _format_url_section(_url, **path_format_arguments)
    _params['api-version'] = _SERIALIZER.query('api_version', api_version, 'str')
    _headers['Accept'] = _SERIALIZER.header('accept', accept, 'str')
...
def build_validate_request(scope: str, role_eligibility_schedule_request_name: str, **kwargs: Any) -> HttpRequest:
    ...
    content_type: Optional[str] = kwargs.pop('content_type', _headers.pop('Content-Type', None))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/roleEligibilityScheduleRequests/{roleEligibilityScheduleRequestName}/validate')
    path_format_arguments = {'scope': _SERIALIZER.url('scope', scope, 'str', skip_quote=True), 'roleEligibilityScheduleRequestName': _SERIALIZER.url('role_eligibility_schedule_request_name', role_eligibility_schedule_request_name, 'str')}
    _url: str = _format_url_section(_url, **path_format_arguments)
    _params['api-version'] = _SERIALIZER.query('api_version', api_version, 'str')
    if content_type is not None:
...
class RoleEligibilityScheduleRequestsOperations:
    ...
    @overload
    def create(self, scope: str, role_eligibility_schedule_request_name: str, parameters: _models.RoleEligibilityScheduleRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    def create(self, scope: str, role_eligibility_schedule_request_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            i = 10
            return i + 15
    ...
    @distributed_trace
    def create(self, scope: str, role_eligibility_schedule_request_name: str, parameters: Union[_models.RoleEligibilityScheduleRequest, IO], **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            while True:
                i = 10
        ...
        request = build_create_request(scope=scope, role_eligibility_schedule_request_name=role_eligibility_schedule_request_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def get(self, scope: str, role_eligibility_schedule_request_name: str, **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            print('Hello World!')
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._api_version or '2020-10-01'))
        cls: ClsType[_models.RoleEligibilityScheduleRequest] = kwargs.pop('cls', None)
        request = build_get_request(scope=scope, role_eligibility_schedule_request_name=role_eligibility_schedule_request_name, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_for_scope(self, scope: str, filter: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RoleEligibilityScheduleRequest']:
        if False:
            i = 10
            return i + 15
    ...
    @distributed_trace
    def cancel(self, scope: str, role_eligibility_schedule_request_name: str, **kwargs: Any) -> None:
        if False:
            while True:
                i = 10
        ...
        request = build_cancel_request(scope=scope, role_eligibility_schedule_request_name=role_eligibility_schedule_request_name, api_version=api_version, template_url=self.cancel.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    def validate(self, scope: str, role_eligibility_schedule_request_name: str, parameters: _models.RoleEligibilityScheduleRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            print('Hello World!')
    ...
    @overload
    def validate(self, scope: str, role_eligibility_schedule_request_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            print('Hello World!')
        'Validates a new role eligibility schedule request.\n\n        :param scope: The scope of the role eligibility request to validate. Required.\n        :type scope: str\n        :param role_eligibility_schedule_request_name: The name of the role eligibility request to\n         validate. Required.\n        :type role_eligibility_schedule_request_name: str\n        :param parameters: Parameters for the role eligibility schedule request. Required.\n        :type parameters: IO\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: RoleEligibilityScheduleRequest or the result of cls(response)\n        :rtype: ~azure.mgmt.authorization.v2020_10_01.models.RoleEligibilityScheduleRequest\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def validate(self, scope: str, role_eligibility_schedule_request_name: str, parameters: Union[_models.RoleEligibilityScheduleRequest, IO], **kwargs: Any) -> _models.RoleEligibilityScheduleRequest:
        if False:
            for i in range(10):
                print('nop')
        "Validates a new role eligibility schedule request.\n\n        :param scope: The scope of the role eligibility request to validate. Required.\n        :type scope: str\n        :param role_eligibility_schedule_request_name: The name of the role eligibility request to\n         validate. Required.\n        :type role_eligibility_schedule_request_name: str\n        :param parameters: Parameters for the role eligibility schedule request. Is either a\n         RoleEligibilityScheduleRequest type or a IO type. Required.\n        :type parameters: ~azure.mgmt.authorization.v2020_10_01.models.RoleEligibilityScheduleRequest\n         or IO\n        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.\n         Default value is None.\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: RoleEligibilityScheduleRequest or the result of cls(response)\n        :rtype: ~azure.mgmt.authorization.v2020_10_01.models.RoleEligibilityScheduleRequest\n        :raises ~azure.core.exceptions.HttpResponseError:\n        "
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, 'RoleEligibilityScheduleRequest')
        request = build_validate_request(scope=scope, role_eligibility_schedule_request_name=role_eligibility_schedule_request_name, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    validate.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/roleEligibilityScheduleRequests/{roleEligibilityScheduleRequestName}/validate'}