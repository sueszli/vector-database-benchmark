...
from dvc.dvcfile import LOCK_FILE, PROJECT_FILE, ParametrizedDumpError, SingleStageFile, load_file
from dvc.stage.exceptions import StageFileDoesNotExistError
from dvc.stage.loader import StageNotFound
from dvc.utils.strictyaml import YAMLValidationError
STAGE_EXAMPLE = {'stage1': {'cmd': 'cp foo bar', 'desc': 'stage desc', 'meta': {'key1': 'value1', 'key2': 'value2'}, 'deps': ['foo'], 'outs': [{'bar': {'desc': 'bar desc', 'meta': {'key': 'value'}}}]}}
