...
_ITEMS_TO_DESCRIPTIONS = {'image': 'A color image of varying height and width.', 'labels_class': 'A semantic segmentation label whose size matches image.Its values range from 0 (background) to num_classes.'}
DatasetDescriptor = collections.namedtuple('DatasetDescriptor', ['splits_to_sizes', 'num_classes', 'ignore_label'])
_DAVIS_2016_INFORMATION = DatasetDescriptor(splits_to_sizes={'train': [30, 1830], 'val': [20, 1376]}, num_classes=2, ignore_label=255)
_DAVIS_2017_INFORMATION = DatasetDescriptor(splits_to_sizes={'train': [60, 4219], 'val': [30, 2023], 'test-dev': [30, 2037]}, num_classes=None, ignore_label=255)
_YOUTUBE_VOS_2018_INFORMATION = DatasetDescriptor(splits_to_sizes={'train': [None, None], 'val': [None, None]}, num_classes=None, ignore_label=255)
_DATASETS_INFORMATION = {'davis_2016': _DAVIS_2016_INFORMATION, 'davis_2017': _DAVIS_2017_INFORMATION, 'youtube_vos_2018': _YOUTUBE_VOS_2018_INFORMATION}
_FILE_PATTERN = '%s-*'
