...
__protobuf__ = proto.module(package='google.cloud.contentwarehouse.v1', manifest={'CreateSynonymSetRequest', 'GetSynonymSetRequest', 'ListSynonymSetsRequest', 'ListSynonymSetsResponse', 'UpdateSynonymSetRequest', 'DeleteSynonymSetRequest'})
...
class CreateSynonymSetRequest(proto.Message):
    ...
    synonym_set: synonymset.SynonymSet = proto.Field(proto.MESSAGE, number=2, message=synonymset.SynonymSet)
...
class ListSynonymSetsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    synonym_sets: MutableSequence[synonymset.SynonymSet] = proto.RepeatedField(proto.MESSAGE, number=1, message=synonymset.SynonymSet)
