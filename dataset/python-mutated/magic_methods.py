...
INPLACE_BINARY_OPS_TO_MAGIC_NAMES: dict[BinaryOp, tuple[str, BinaryOp]] = {operator.iadd: ('__iadd__', operator.add), operator.iand: ('__iand__', operator.and_), operator.iconcat: ('__iconcat__', operator.concat), operator.ifloordiv: ('__ifloordiv__', operator.floordiv), operator.ilshift: ('__ilshift__', operator.lshift), operator.imatmul: ('__imatmul__', operator.matmul), operator.imod: ('__imod__', operator.mod), operator.imul: ('__imul__', operator.mul), operator.ior: ('__ior__', operator.or_), operator.ipow: ('__ipow__', operator.pow), operator.irshift: ('__irshift__', operator.rshift), operator.isub: ('__isub__', operator.sub), operator.itruediv: ('__itruediv__', operator.truediv), operator.ixor: ('__ixor__', operator.xor)}
NON_INPLACE_BINARY_OPS_TO_MAGIC_NAMES: dict[BinaryOp, tuple[str, str | None]] = {operator.add: ('__add__', '__radd__'), operator.and_: ('__and__', '__rand__'), operator.contains: ('__contains__', None), operator.delitem: ('__delitem__', None), operator.eq: ('__eq__', '__eq__'), operator.floordiv: ('__floordiv__', '__rfloordiv__'), operator.ge: ('__ge__', '__le__'), operator.getitem: ('__getitem__', None), operator.gt: ('__gt__', '__lt__'), operator.le: ('__le__', '__ge__'), operator.lshift: ('__lshift__', '__rlshift__'), operator.lt: ('__lt__', '__gt__'), operator.matmul: ('__matmul__', '__rmatmul__'), operator.mod: ('__mod__', '__rmod__'), operator.mul: ('__mul__', '__rmul__'), operator.ne: ('__ne__', '__ne__'), operator.or_: ('__or__', '__ror__'), operator.pow: ('__pow__', '__rpow__'), operator.rshift: ('__rshift__', '__rrshift__'), operator.sub: ('__sub__', '__rsub__'), operator.truediv: ('__truediv__', '__rtruediv__'), operator.xor: ('__xor__', '__rxor__')}
UNARY_OPS_TO_MAGIC_NAMES: dict[UnaryOp, str] = {operator.neg: '__neg__', operator.invert: '__invert__', operator.pos: '__pos__', operator.abs: '__abs__', operator.index: '__index__', operator.inv: '__inv__', operator.invert: '__invert__', operator.not_: '__not__', operator.pos: '__pos__', operator.truth: '__bool__', bool: '__bool__', abs: '__abs__', float: '__float__', len: '__len__', int: '__int__'}
