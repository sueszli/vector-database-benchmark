...
class merchant_reportsCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'search': ('parent', 'query', 'page_size', 'page_token')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=merchant_reportsCallTransformer()):
    if False:
        while True:
            i = 10
