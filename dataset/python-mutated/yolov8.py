...
def download_yolov8n_model(destination_path: Optional[str]=None):
    ...
    if not path.exists(destination_path):
        urllib.request.urlretrieve(Yolov8TestConstants.YOLOV8N_MODEL_URL, destination_path)
...
def download_yolov8s_model(destination_path: Optional[str]=None):
    ...
    Path(destination_path).parent.mkdir(parents=True, exist_ok=True)
    if not path.exists(destination_path):
        urllib.request.urlretrieve(Yolov8TestConstants.YOLOV8S_MODEL_URL, destination_path)
...
def download_yolov8m_model(destination_path: Optional[str]=None):
    ...
    Path(destination_path).parent.mkdir(parents=True, exist_ok=True)
    if not path.exists(destination_path):
        urllib.request.urlretrieve(Yolov8TestConstants.YOLOV8M_MODEL_URL, destination_path)
...
def download_yolov8l_model(destination_path: Optional[str]=None):
    ...
    Path(destination_path).parent.mkdir(parents=True, exist_ok=True)
    if not path.exists(destination_path):
        urllib.request.urlretrieve(Yolov8TestConstants.YOLOV8L_MODEL_URL, destination_path)
...
def download_yolov8x_model(destination_path: Optional[str]=None):
    ...
    Path(destination_path).parent.mkdir(parents=True, exist_ok=True)
    if not path.exists(destination_path):
        urllib.request.urlretrieve(Yolov8TestConstants.YOLOV8X_MODEL_URL, destination_path)