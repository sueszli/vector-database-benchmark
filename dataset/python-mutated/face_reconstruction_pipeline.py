...
from modelscope.models.cv.face_reconstruction.utils import align_for_lm, align_img, draw_line, enlarged_bbox, image_warp_grid1, load_lm3d, mesh_to_string, read_obj, resize_on_long_side, spread_flow, write_obj
...
@PIPELINES.register_module(Tasks.face_reconstruction, module_name=Pipelines.face_reconstruction)
