...
class test_random_gam_gridsearch_specific:
    ...
    hyper_parameters = {'lambda': [1, 2], 'subspaces': [{'scale': [[0.001], [0.0002]], 'bs': [[1], [0]], 'gam_columns': [[['c_0']], [['c_1']]], 'bs': [[2], [0]]}, {'scale': [[0.001, 0.001, 0.001], [0.0002, 0.0002, 0.0002]], 'bs': [[0, 3, 1], [2, 0, 1]], 'gam_columns': [[['c_0'], ['c_1'], ['c_3', 'c_4', 'c_5']], [['c_1'], ['c_2'], ['c_4', 'c_5', 'c_6']]]}]}
    manual_gam_models = []
    num_grid_models = 0
                ...
                for scale in subspace['scale']:
                    for gam_columns in subspace['gam_columns']:
                        for bsVal in subspace['bs']:
                            ...
                            self.manual_gam_models.append(H2OGeneralizedAdditiveEstimator(family='binomial', gam_columns=gam_columns, scale=scale, bs=bsVal, lambda_=lambda_, seed=1))
