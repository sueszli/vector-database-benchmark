...
logger = get_logger()
test_fofa_fields = ns.model('taskFofaTest', {'query': fields.String(required=True, description='Fofa 查询语句')})
...
add_fofa_fields = ns.model('addTaskFofa', {'query': fields.String(required=True, description='Fofa 查询语句'), 'name': fields.String(required=True, description='任务名'), 'policy_id': fields.String(description='策略 ID')})
