...
try:
    ...
    from PyQt5.Qt import QPoint, QPolygon, QSplitter, QFrame, QGridLayout, QLabel, QComboBox, QSpinBox, QPalette, QStackedWidget, QVBoxLayout, QPushButton, QColorDialog, QPen, QLinearGradient, QConicalGradient, QRadialGradient, QBrush, QRect, QPainterPath, QFileDialog
except ImportError:
    ...
    from PySide2.Qt import QPoint, QPolygon, QSplitter, QFrame, QGridLayout, QLabel, QComboBox, QSpinBox, QPalette, QStackedWidget, QVBoxLayout, QPushButton, QColorDialog, QPen, QLinearGradient, QConicalGradient, QRadialGradient, QBrush, QRect, QPainterPath, QFileDialog
