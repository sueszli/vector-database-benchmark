...
def tes_gam_mSpline_coeffs():
    ...
    buildModelCheckCoeff(train1, train2, predict_frame, predictors, [frameKnots1.key, frameKnots2.key, frameKnots3.key], 'C21', gamX, [3, 4, 5], 'gaussian')
    ...
    frameKnots3 = h2o.H2OFrame(python_obj=knots3)
    buildModelCheckCoeff(train1, train2, predict_frame, predictors, [frameKnots1.key, frameKnots2.key, frameKnots3.key], 'C21', gamX, [2, 3, 4], 'binomial')
    ...
    h2o_model = H2OGeneralizedAdditiveEstimator(family='fractionalbinomial', gam_columns=['C11', 'C12', 'C13'], scale=[1, 1, 1], num_knots=[5, 5, 5], standardize=True, solver='irlsm', bs=[3, 3, 3])
