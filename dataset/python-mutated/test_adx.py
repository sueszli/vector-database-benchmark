...
MOCK_DATA = {'task_id': 'test_azure_data_explorer_query_operator', 'query': 'Logs | schema', 'database': 'Database', 'options': {'option1': 'option_value'}}
MOCK_RESULT = KustoResultTable(json_table={'TableName': 'getschema', 'TableId': 1, 'TableKind': 'PrimaryResult', 'Columns': [{'ColumnName': 'Source', 'ColumnType': 'string', 'DataType': 'System.String'}, {'ColumnName': 'Timestamp', 'ColumnType': 'datetime', 'DataType': 'System.DateTime'}], 'Rows': [['hi', '2017-01-01T01:01:01.0000003Z'], ['hello', '2017-01-01T01:01:01.0000003Z']]})
