...
XLM_ROBERTA_XL_PRETRAINED_MODEL_ARCHIVE_LIST = ['facebook/xlm-roberta-xl', 'facebook/xlm-roberta-xxl']
...
@add_start_docstrings('The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.', XLM_ROBERTA_XL_START_DOCSTRING)
...
@add_start_docstrings('XLM-RoBERTa-xlarge Model with a `language modeling` head on top for CLM fine-tuning.', XLM_ROBERTA_XL_START_DOCSTRING)
