...
class OverTheAirFlickeringPyTorch(EvasionAttack):
    ...
    | Paper link: https://arxiv.org/abs/2002.05123
    """
    attack_params = EvasionAttack.attack_params + ['eps_step', 'max_iter', 'beta_0', 'beta_1', 'beta_2', 'loss_margin', 'batch_size', 'start_frame_index', 'num_frames', 'round_samples', 'targeted', 'verbose']
