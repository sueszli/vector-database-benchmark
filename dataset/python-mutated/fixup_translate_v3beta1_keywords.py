...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=translateCallTransformer()):
    if False:
        i = 10
        return i + 15
