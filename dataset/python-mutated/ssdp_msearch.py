...
class Exploit(UDPClient):
    __info__ = {'name': 'SSDP M-SEARCH Info Discovery', 'description': 'Sends M-SEARCH request to target and retrieve information from UPnP enabled systems.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'references': ('http://www.upnp-hacks.org/upnp.html',)}
