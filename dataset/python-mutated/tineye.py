...
about = {'website': 'https://tineye.com', 'wikidata_id': 'Q2382535', 'official_api_documentation': 'https://api.tineye.com/python/docs/', 'use_official_api': False, 'require_api_key': False, 'results': 'JSON'}
...
FORMAT_NOT_SUPPORTED = gettext('Could not read that image url. This may be due to an unsupported file format. TinEye only supports images that are JPEG, PNG, GIF, BMP, TIFF or WebP.')
'TinEye error message'
NO_SIGNATURE_ERROR = gettext('The image is too simple to find matches. TinEye requires a basic level of visual detail to successfully identify matches.')
'TinEye error message'
