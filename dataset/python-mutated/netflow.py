...
from scapy.fields import BitEnumField, BitField, ByteEnumField, ByteField, ConditionalField, Field, FieldLenField, FlagsField, IPField, IntField, LongField, MACField, PacketListField, SecondsIntField, ShortEnumField, ShortField, StrField, StrFixedLenField, StrLenField, ThreeBytesField, UTCTimeField, XByteField, XShortField
...
for port in [2055, 2056, 9995, 9996, 6343]:
...
class NetflowRecordV1(Packet):
    ...
    fields_desc = [IPField('ipsrc', '0.0.0.0'), IPField('ipdst', '0.0.0.0'), IPField('nexthop', '0.0.0.0'), ShortField('inputIfIndex', 0), ShortField('outpuIfIndex', 0), IntField('dpkts', 0), IntField('dbytes', 0), IntField('starttime', 0), IntField('endtime', 0), ShortField('srcport', 0), ShortField('dstport', 0), ShortField('padding', 0), ByteField('proto', 0), ByteField('tos', 0), IntField('padding1', 0), IntField('padding2', 0)]
...
class NetflowHeaderV5(Packet):
    ...
    fields_desc = [ShortField('count', None), IntField('sysUptime', 0), UTCTimeField('unixSecs', 0), UTCTimeField('unixNanoSeconds', 0, use_nano=True), IntField('flowSequence', 0), ByteField('engineType', 0), ByteField('engineID', 0), ShortField('samplingInterval', 0)]
...
class NetflowRecordV5(Packet):
    ...
    fields_desc = [IPField('src', '127.0.0.1'), IPField('dst', '127.0.0.1'), IPField('nexthop', '0.0.0.0'), ShortField('input', 0), ShortField('output', 0), IntField('dpkts', 1), IntField('dOctets', 60), IntField('first', 0), IntField('last', 0), ShortField('srcport', 0), ShortField('dstport', 0), ByteField('pad1', 0), FlagsField('tcpFlags', 2, 8, 'FSRPAUEC'), ByteEnumField('prot', socket.IPPROTO_TCP, IP_PROTOS), ByteField('tos', 0), ShortField('src_as', 0), ShortField('dst_as', 0), ByteField('src_mask', 0), ByteField('dst_mask', 0), ShortField('pad2', 0)]
...
class N9UTCTimeField(UTCTimeField, _AdjustableNetflowField):
    ...
    def __init__(self, name, default, *args, **kargs):
        ...
        _AdjustableNetflowField.__init__(self, name, default, length)
NetflowV9TemplateFieldDecoders = {4: (ByteEnumField, [IP_PROTOS]), 5: XByteField, 6: ByteField, 7: ShortField, 8: IPField, 9: ByteField, 11: ShortField, 12: IPField, 13: ByteField, 15: IPField, 16: ShortOrInt, 17: ShortOrInt, 18: IPField, 21: (SecondsIntField, [True]), 22: (SecondsIntField, [True]), 27: IP6Field, 28: IP6Field, 29: ByteField, 30: ByteField, 31: ThreeBytesField, 32: XShortField, 33: ByteField, 34: IntField, 35: XByteField, 36: ShortField, 37: ShortField, 38: ByteField, 39: ByteField, 46: (ByteEnumField, [{0: 'UNKNOWN', 1: 'TE-MIDPT', 2: 'ATOM', 3: 'VPN', 4: 'BGP', 5: 'LDP'}]), 47: IPField, 48: ByteField, 49: ByteField, 50: IntField, 55: XByteField, 56: MACField, 57: MACField, 58: ShortField, 59: ShortField, 60: ByteField, 61: (ByteEnumField, [{0: 'Ingress flow', 1: 'Egress flow'}]), 62: IP6Field, 63: IP6Field, 130: IPField, 131: IP6Field, 150: N9UTCTimeField, 151: N9UTCTimeField, 152: (N9UTCTimeField, [True]), 153: (N9UTCTimeField, [True]), 154: (N9UTCTimeField, [False, True]), 155: (N9UTCTimeField, [False, True]), 156: (N9UTCTimeField, [False, False, True]), 157: (N9UTCTimeField, [False, False, True]), 158: (N9SecondsIntField, [False, True]), 159: (N9SecondsIntField, [False, True]), 160: (N9UTCTimeField, [True]), 161: (N9SecondsIntField, [True]), 162: (N9SecondsIntField, [False, True]), 195: XByteField, 211: IPField, 212: IP6Field, 225: IPField, 226: IPField, 258: (N9SecondsIntField, [True]), 260: N9SecondsIntField, 261: N9SecondsIntField, 264: N9SecondsIntField, 265: N9SecondsIntField, 268: (N9UTCTimeField, [False, True]), 269: (N9UTCTimeField, [True]), 270: (N9UTCTimeField, [False, False, True]), 271: (N9UTCTimeField, [False, True]), 272: (N9UTCTimeField, [True]), 273: (N9UTCTimeField, [False, False, True]), 279: N9SecondsIntField, 281: IP6Field, 282: IP6Field, 322: N9UTCTimeField, 323: (N9UTCTimeField, [True]), 324: (N9UTCTimeField, [False, True]), 325: (N9UTCTimeField, [False, False, True]), 365: MACField, 366: IPField, 367: MACField, 380: IPField, 381: IPField, 382: IP6Field, 383: IP6Field, 403: IPField, 404: IP6Field, 414: MACField, 415: MACField, 432: IPField, 24632: IPField, 24633: IPField, 40001: IPField, 40002: IPField, 114 + NTOP_BASE: IPField, 116 + NTOP_BASE: IPField, 143 + NTOP_BASE: IPField, 145 + NTOP_BASE: IPField, 353 + NTOP_BASE: MACField, 396 + NTOP_BASE: IP6Field, 397 + NTOP_BASE: IP6Field, 471 + NTOP_BASE: IPField}
...
class NetflowTemplateV9(Packet):
    ...
    fields_desc = [ShortField('templateID', 255), FieldLenField('fieldCount', None, count_of='template_fields'), PacketListField('template_fields', [], NetflowTemplateFieldV9, count_from=lambda pkt: pkt.fieldCount)]
...
class NetflowOptionsFlowsetOptionV9(Packet):
    ...
    fields_desc = [BitField('enterpriseBit', 0, 1), BitEnumField('optionFieldType', None, 15, NetflowV910TemplateFieldTypes), ShortField('optionFieldlength', 0), ConditionalField(ShortField('enterpriseNumber', 0), lambda p: p.enterpriseBit)]
...
class NetflowOptionsFlowsetV9(Packet):
    ...
    fields_desc = [ShortField('flowSetID', 1), ShortField('length', None), ShortField('templateID', 255), FieldLenField('option_scope_length', None, length_of='scopes'), FieldLenField('option_field_length', None, length_of='options'), PacketListField('scopes', [], NetflowOptionsFlowsetScopeV9, length_from=lambda pkt: pkt.option_scope_length), PacketListField('options', [], NetflowOptionsFlowsetOptionV9, length_from=lambda pkt: pkt.option_field_length), StrLenField('pad', None, length_from=lambda pkt: pkt.length - pkt.option_scope_length - pkt.option_field_length - 10)]
...
class NetflowOptionsFlowset10(NetflowOptionsFlowsetV9):
    ...
    fields_desc = [ShortField('flowSetID', 3), ShortField('length', None), ShortField('templateID', 255), FieldLenField('field_count', None, count_of='options', adjust=lambda pkt, x: x + pkt.get_field('scope_field_count').i2m(pkt, None)), FieldLenField('scope_field_count', None, count_of='scopes'), PacketListField('scopes', [], NetflowOptionsFlowsetScopeV9, count_from=lambda pkt: pkt.scope_field_count), PacketListField('options', [], NetflowOptionsFlowsetOptionV9, count_from=lambda pkt: pkt.field_count - pkt.scope_field_count), StrLenField('pad', None, length_from=lambda pkt: pkt.length - pkt.scope_field_count * 4 - 10)]
