...
jwt_auth = JWTAuth[User](retrieve_user_handler=retrieve_user_handler, token_secret=environ.get('JWT_SECRET', 'abcd123'), exclude=['/login', '/schema'])
...
app = Litestar(route_handlers=[login_handler, some_route_handler], on_app_init=[jwt_auth.on_app_init], openapi_config=openapi_config)