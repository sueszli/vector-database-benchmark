...
PEGASUS_X_PRETRAINED_CONFIG_ARCHIVE_MAP = {'google/pegasus-x-base': 'https://huggingface.co/google/pegasus-x-base/resolve/main/config.json', 'google/pegasus-x-large': 'https://huggingface.co/google/pegasus-x-large/resolve/main/config.json'}
