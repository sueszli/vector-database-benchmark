...
def main():
    ...
    response = client.sql_managed_instances.begin_delete(resource_group_name='testrg', sql_managed_instance_name='testsqlManagedInstance').result()
    print(response)
