...
class YouTube(Directive):
    ...
    option_spec = {'width': directives.unchanged, 'height': directives.unchanged, 'aspect': directives.unchanged}
...
_NODE_VISITORS = {'html': (visit_youtube_node, depart_youtube_node), 'latex': (unsupported_visit_youtube, None), 'man': (unsupported_visit_youtube, None), 'texinfo': (unsupported_visit_youtube, None), 'text': (unsupported_visit_youtube, None)}
