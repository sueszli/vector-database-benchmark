...
class TestCallbackQueryWithoutRequest(TestCallbackQueryBase):
    ...
    async def test_answer(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.answer, Bot.answer_callback_query, ['callback_query_id'], [])
        assert await check_shortcut_call(callback_query.answer, callback_query.get_bot(), 'answer_callback_query')
    ...
    async def test_edit_message_text(self, monkeypatch, callback_query):
        ...
        async def make_assertion(*_, **kwargs):
            ...
            return ids and text
        assert check_shortcut_signature(CallbackQuery.edit_message_text, Bot.edit_message_text, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.edit_message_text, callback_query.get_bot(), 'edit_message_text', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.edit_message_text, callback_query.get_bot())
    ...
    async def test_edit_message_caption(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.edit_message_caption, Bot.edit_message_caption, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.edit_message_caption, callback_query.get_bot(), 'edit_message_caption', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.edit_message_caption, callback_query.get_bot())
    ...
    async def test_edit_message_reply_markup(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.edit_message_reply_markup, Bot.edit_message_reply_markup, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.edit_message_reply_markup, callback_query.get_bot(), 'edit_message_reply_markup', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.edit_message_reply_markup, callback_query.get_bot())
    ...
    async def test_edit_message_media(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.edit_message_media, Bot.edit_message_media, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.edit_message_media, callback_query.get_bot(), 'edit_message_media', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.edit_message_media, callback_query.get_bot())
    ...
    async def test_edit_message_live_location(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.edit_message_live_location, Bot.edit_message_live_location, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.edit_message_live_location, callback_query.get_bot(), 'edit_message_live_location', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.edit_message_live_location, callback_query.get_bot())
    ...
    async def test_stop_message_live_location(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.stop_message_live_location, Bot.stop_message_live_location, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.stop_message_live_location, callback_query.get_bot(), 'stop_message_live_location', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.stop_message_live_location, callback_query.get_bot())
    ...
    async def test_set_game_score(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.set_game_score, Bot.set_game_score, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.set_game_score, callback_query.get_bot(), 'set_game_score', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.set_game_score, callback_query.get_bot())
    ...
    async def test_get_game_high_scores(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.get_game_high_scores, Bot.get_game_high_scores, ['inline_message_id', 'message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.get_game_high_scores, callback_query.get_bot(), 'get_game_high_scores', skip_params=self.skip_params(callback_query), shortcut_kwargs=self.shortcut_kwargs(callback_query))
        assert await check_defaults_handling(callback_query.get_game_high_scores, callback_query.get_bot())
    ...
    async def test_delete_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.delete_message, Bot.delete_message, ['message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.delete_message, callback_query.get_bot(), 'delete_message')
        assert await check_defaults_handling(callback_query.delete_message, callback_query.get_bot())
    ...
    async def test_pin_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.pin_message, Bot.pin_chat_message, ['message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.pin_message, callback_query.get_bot(), 'pin_chat_message')
    ...
    async def test_unpin_message(self, monkeypatch, callback_query):
        ...
        async def make_assertion(*args, **kwargs):
            return kwargs['chat_id'] == callback_query.message.chat_id
        assert check_shortcut_signature(CallbackQuery.unpin_message, Bot.unpin_chat_message, ['message_id', 'chat_id'], [])
        assert await check_shortcut_call(callback_query.unpin_message, callback_query.get_bot(), 'unpin_chat_message', shortcut_kwargs=['message_id', 'chat_id'])
        assert await check_defaults_handling(callback_query.unpin_message, callback_query.get_bot())
    ...
    async def test_copy_message(self, monkeypatch, callback_query):
        ...
        assert check_shortcut_signature(CallbackQuery.copy_message, Bot.copy_message, ['message_id', 'from_chat_id'], [])
        assert await check_shortcut_call(callback_query.copy_message, callback_query.get_bot(), 'copy_message')
