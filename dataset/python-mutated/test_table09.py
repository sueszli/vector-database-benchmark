...
class TestAssembleTable(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.add_table('B2:K8', {'total_row': 1, 'columns': [{'total_string': 'Total'}, {}, {'total_function': 'average'}, {'total_function': 'count'}, {'total_function': 'count_nums'}, {'total_function': 'max'}, {'total_function': 'min'}, {'total_function': 'sum'}, {'total_function': 'stdDev'}, {'total_function': 'var'}]})
