...
@pytest.mark.parametrize('csv_file,img_count,anom_count', [('test/test_csvs/test_no_s3.csv', 15, 33)])
...
@pytest.mark.parametrize('csv_file,img_count,lbl_count', [('test/test_csvs/test_s3_supplied.csv', 15, 33)])
