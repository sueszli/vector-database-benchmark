...
from modelscope.models.cv.video_panoptic_segmentation.backbone.swin_transformer import SwinTransformerDIY
from modelscope.models.cv.video_panoptic_segmentation.head.semantic_fpn_wrapper import SemanticFPNWrapper
...
@MODELS.register_module(Tasks.video_instance_segmentation, module_name=Models.video_instance_segmentation)
