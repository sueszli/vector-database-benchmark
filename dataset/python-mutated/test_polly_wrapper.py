...
def test_list_lexicons(make_stubber, error_code):
    ...
    if error_code is None:
        ...
        assert exc_info.value.response['Error']['Code'] == error_code
voice_metadata = [{'Gender': 'Female', 'Id': 'Kimberly', 'LanguageCode': 'en-US', 'LanguageName': 'US English', 'Name': 'Kimberly', 'SupportedEngines': ['neural', 'standard']}, {'Gender': 'Male', 'Id': 'Jan-ID', 'LanguageCode': 'pl-PL', 'LanguageName': 'Polish', 'Name': 'Jan', 'SupportedEngines': ['standard']}, {'Gender': 'Female', 'Id': 'Liv', 'LanguageCode': 'nb-NO', 'LanguageName': 'Norwegian', 'Name': 'Liv', 'SupportedEngines': ['standard']}, {'Gender': 'Male', 'Id': 'Joey', 'LanguageCode': 'en-US', 'LanguageName': 'US English', 'Name': 'Joey', 'SupportedEngines': ['neural', 'standard']}]
