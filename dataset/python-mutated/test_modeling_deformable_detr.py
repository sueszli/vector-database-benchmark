...
from transformers.testing_utils import require_timm, require_torch, require_torch_accelerator, require_vision, slow, torch_device
...
class DeformableDetrModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': DeformableDetrModel, 'object-detection': DeformableDetrForObjectDetection} if is_torch_available() else {}
