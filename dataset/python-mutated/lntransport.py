...
from .lnutil import get_ecdh, privkey_to_pubkey, LightningPeerConnectionClosed, HandshakeFailed, LNPeerAddr
from . import ecc
...
class LNTransport(LNTransportBase):
    ...
    async def handshake(self):
        ...
        if len(rspns) != 50:
            raise HandshakeFailed(f'Lightning handshake act 1 response has bad length, are you sure this is the right pubkey? {self.peer_addr}')
