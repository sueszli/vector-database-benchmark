...
class EasyCVFace2DKeypointsPipelineTest(unittest.TestCase):
    ...
    def test_human_wholebody_keypoint(self):
        ...
        human_wholebody_keypoint_pipeline = pipeline(task=Tasks.human_wholebody_keypoint, model=model_id)
        ...
        human_wholebody_keypoint_pipeline.predict_op.show_result(img_path, output_keypoints, output_pose, scale=1, save_path='human_wholebody_keypoint_ret.jpg')
