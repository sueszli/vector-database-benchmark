...
MYPY_0_782_WHL = 'https://files.pythonhosted.org/packages/9d/65/b96e844150ce18b9892b155b780248955ded13a2581d31872e7daa90a503/mypy-0.782-py3-none-any.whl'
MYPY_0_782_REQS = {'typed-ast<1.5.0,>=1.4.0', 'typing-extensions>=3.7.4', 'mypy-extensions<0.5.0,>=0.4.3', 'psutil>=4.0; extra == "dmypy"'}
