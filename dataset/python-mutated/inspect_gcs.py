...
def inspect_gcs_file(project: str, bucket: str, filename: str, topic_id: str, subscription_id: str, info_types: List[str], custom_dictionaries: List[str]=None, custom_regexes: List[str]=None, min_likelihood: Optional[str]=None, max_findings: Optional[int]=None, timeout: int=300) -> None:
    if False:
        i = 10
        return i + 15
...
if __name__ == '__main__':
    ...
    parser.add_argument('filename', help='The name of the file in the bucket, including the path, e.g. "images/myfile.png". Wildcards are permitted.')
    ...
    inspect_gcs_file(args.project, args.bucket, args.filename, args.topic_id, args.subscription_id, args.info_types, custom_dictionaries=args.custom_dictionaries, custom_regexes=args.custom_regexes, min_likelihood=args.min_likelihood, max_findings=args.max_findings, timeout=args.timeout)