...
from hypothesis import HealthCheck, Phase, Verbosity, assume, example, given, settings, strategies as st
...
base_settings = settings(database=None, deadline=None, suppress_health_check=list(HealthCheck), max_examples=10, verbosity=Verbosity.normal, phases=(Phase.explicit, Phase.generate))
