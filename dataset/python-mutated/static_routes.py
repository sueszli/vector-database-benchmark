...
from ansible_collections.vyos.vyos.plugins.module_utils.network.vyos.argspec.static_routes.static_routes import Static_routesArgs
from ansible_collections.vyos.vyos.plugins.module_utils.network.vyos.utils.utils import get_route_type
