        ...
        while True:
            ...
            for (env_id, timestep) in timesteps.items():
                ...
                if timestep.done:
                    ...
                    info = {'reward0': timestep.info[0]['eval_episode_return'], 'reward1': timestep.info[1]['eval_episode_return'], 'time': self._env_info[env_id]['time'], 'step': self._env_info[env_id]['step']}
                    collected_episode += 1
