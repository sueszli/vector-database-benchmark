...
_QuantizationComponent = quant_opts_pb2.QuantizationComponentSpec.QuantizationComponent
_TensorType = quant_opts_pb2.QuantizationComponentSpec.TensorType
_TensorShape = Sequence[Union[int, None]]
_PER_CHANNEL_QUANTIZED_OPS = ('UniformQuantizedConvolution', 'UniformQuantizedConvolutionHybrid', 'UniformQuantizedDotHybrid')
_DebuggerOptions = quant_opts_pb2.DebuggerOptions
_SUFFIXES = ('/filter1', '/filter2')
_PER_CHANNEL_OP_NAMES = (f'{op}{suffix}' for (op, suffix) in itertools.product(_PER_CHANNEL_QUANTIZED_OPS, _SUFFIXES))
