...
class PlaywireIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<script[^>]+data-config=(["\\\'])(?P<url>(?:https?:)?//config\\.playwire\\.com/.+?)\\1']
    _TESTS = [{'url': 'http://config.playwire.com/14907/videos/v2/3353705/player.json', 'md5': 'e6398701e3595888125729eaa2329ed9', 'info_dict': {'id': '3353705', 'ext': 'mp4', 'title': 'S04_RM_UCL_Rus', 'thumbnail': 're:^https?://.*\\.png$', 'duration': 145.94}}, {'url': 'http://config.playwire.com/21772/videos/v2/4840492/zeus.json', 'info_dict': {'id': '4840492', 'ext': 'mp4', 'title': 'ITV EL SHOW FULL'}, 'params': {'skip_download': True}}, {'url': 'http://cdn.playwire.com/11625/embed/85228.html', 'only_matching': True}, {'url': 'http://config.playwire.com/12421/videos/v2/3389892/zeus.json', 'only_matching': True}, {'url': 'http://cdn.playwire.com/v2/12342/config/1532636.json', 'only_matching': True}]
