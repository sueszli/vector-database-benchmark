...
class Exploit(FTPClient):
    __info__ = {'name': 'FTP Bruteforce', 'description': 'Module performs bruteforce attack against FTP service.If valid credentials are found, the are displayed to the user.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'devices': ('Multiple devices',)}
