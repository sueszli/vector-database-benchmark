...
class VectorGridProtobuf(JSCSSMixin, Layer):
    ...
    default_js = [('vectorGrid', 'https://unpkg.com/leaflet.vectorgrid@latest/dist/Leaflet.VectorGrid.bundled.js')]

    def __init__(self, url: str, name: Optional[str]=None, options: Union[str, dict, None]=None, overlay: bool=True, control: bool=True, show: bool=True):
        if False:
            return 10
