...
pytestmark = [pytest.mark.never(['mysql', 'sqlite', 'mssql'], reason='No struct support'), pytest.mark.notyet(['impala']), pytest.mark.notimpl(['datafusion', 'druid', 'oracle', 'flink'])]
...
_STRUCT_LITERAL = ibis.struct(_SIMPLE_DICT, type='struct<a: int64, b: string, c: float64>')
