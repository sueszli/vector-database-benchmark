...
class _VectorLayerEditor(ipywidgets.VBox):
    """Widget for displaying and editing layer visualization properties."""
    _POINT_SHAPES = ['circle', 'square', 'diamond', 'cross', 'plus', 'pentagram', 'hexagram', 'triangle', 'triangle_up', 'triangle_down', 'triangle_left', 'triangle_right', 'pentagon', 'hexagon', 'star5', 'star6']
