...
from modelscope.pipelines.cv.ocr_utils.model_resnet18_half import CardDetectionCorrectionModel
from modelscope.pipelines.cv.ocr_utils.table_process import bbox_decode, bbox_post_process, decode_by_ind, get_affine_transform, nms
from modelscope.preprocessors import load_image
from modelscope.preprocessors.image import LoadImage
from modelscope.utils.config import Config
from modelscope.utils.constant import ModelFile, Tasks
from modelscope.utils.device import create_device, device_placement, verify_device
from modelscope.utils.logger import get_logger
logger = get_logger()

@PIPELINES.register_module(Tasks.card_detection_correction, module_name=Pipelines.card_detection_correction)
