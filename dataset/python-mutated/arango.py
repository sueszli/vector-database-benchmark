import logging
from redash.query_runner import TYPE_BOOLEAN, TYPE_FLOAT, TYPE_STRING, BaseQueryRunner, register
...
try:
    ...
    enabled = False
_TYPE_MAPPINGS = {'boolean': TYPE_BOOLEAN, 'number': TYPE_FLOAT, 'string': TYPE_STRING, 'array': TYPE_STRING, 'object': TYPE_STRING}
