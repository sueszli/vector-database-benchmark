...
from localstack.services.cloudformation.deployment_utils import check_not_found_exception, convert_data_types, fix_account_id_in_arns, fix_boto_parameters_based_on_report, log_not_available_message, remove_none_values
...
try:
    from localstack_ext.services.cloudformation.resource_provider import CloudFormationResourceProviderPluginExt
    PRO_RESOURCE_PROVIDERS = True
except ImportError:
    pass
if TYPE_CHECKING:
    from localstack.services.cloudformation.engine.types import FuncDetails, FuncDetailsValue, ResourceDefinition
LOG = logging.getLogger(__name__)
Properties = TypeVar('Properties')
PUBLIC_REGISTRY: dict[str, Type[ResourceProvider]] = {}
PROVIDER_DEFAULTS = {'AWS::ApiGateway::Account': 'ResourceProvider', 'AWS::ApiGateway::ApiKey': 'ResourceProvider', 'AWS::ApiGateway::BasePathMapping': 'ResourceProvider', 'AWS::ApiGateway::Deployment': 'ResourceProvider', 'AWS::ApiGateway::DomainName': 'ResourceProvider', 'AWS::ApiGateway::GatewayResponse': 'ResourceProvider', 'AWS::ApiGateway::Method': 'ResourceProvider', 'AWS::ApiGateway::Model': 'ResourceProvider', 'AWS::ApiGateway::RequestValidator': 'ResourceProvider', 'AWS::ApiGateway::Resource': 'ResourceProvider', 'AWS::ApiGateway::RestApi': 'ResourceProvider', 'AWS::ApiGateway::Stage': 'ResourceProvider', 'AWS::ApiGateway::UsagePlan': 'ResourceProvider', 'AWS::ApiGateway::UsagePlanKey': 'ResourceProvider', 'AWS::CertificateManager::Certificate': 'ResourceProvider', 'AWS::CloudWatch::Alarm': 'ResourceProvider', 'AWS::CloudWatch::CompositeAlarm': 'ResourceProvider', 'AWS::DynamoDB::Table': 'ResourceProvider', 'AWS::EC2::DHCPOptions': 'ResourceProvider', 'AWS::EC2::Instance': 'ResourceProvider', 'AWS::EC2::InternetGateway': 'ResourceProvider', 'AWS::EC2::NatGateway': 'ResourceProvider', 'AWS::EC2::NetworkAcl': 'ResourceProvider', 'AWS::EC2::Route': 'ResourceProvider', 'AWS::EC2::RouteTable': 'ResourceProvider', 'AWS::EC2::SecurityGroup': 'ResourceProvider', 'AWS::EC2::Subnet': 'ResourceProvider', 'AWS::EC2::SubnetRouteTableAssociation': 'ResourceProvider', 'AWS::EC2::VPC': 'ResourceProvider', 'AWS::EC2::VPCGatewayAttachment': 'ResourceProvider', 'AWS::ECR::Repository': 'ResourceProvider', 'AWS::EKS::Nodegroup': 'ResourceProvider', 'AWS::ElasticBeanstalk::Application': 'ResourceProvider', 'AWS::ElasticBeanstalk::ApplicationVersion': 'ResourceProvider', 'AWS::ElasticBeanstalk::ConfigurationTemplate': 'ResourceProvider', 'AWS::ElasticBeanstalk::Environment': 'ResourceProvider', 'AWS::Events::Connection': 'ResourceProvider', 'AWS::Events::EventBus': 'ResourceProvider', 'AWS::Events::EventBusPolicy': 'ResourceProvider', 'AWS::Events::Rule': 'ResourceProvider', 'AWS::IAM::AccessKey': 'ResourceProvider', 'AWS::IAM::Group': 'ResourceProvider', 'AWS::IAM::InstanceProfile': 'ResourceProvider', 'AWS::IAM::ManagedPolicy': 'ResourceProvider', 'AWS::IAM::Policy': 'ResourceProvider', 'AWS::IAM::Role': 'ResourceProvider', 'AWS::IAM::ServiceLinkedRole': 'ResourceProvider', 'AWS::IAM::User': 'ResourceProvider', 'AWS::KMS::Alias': 'ResourceProvider', 'AWS::KMS::Key': 'ResourceProvider', 'AWS::Kinesis::Stream': 'ResourceProvider', 'AWS::Kinesis::StreamConsumer': 'ResourceProvider', 'AWS::KinesisFirehose::DeliveryStream': 'ResourceProvider', 'AWS::Lambda::Alias': 'ResourceProvider', 'AWS::Logs::LogGroup': 'ResourceProvider', 'AWS::Logs::LogStream': 'ResourceProvider', 'AWS::Logs::SubscriptionFilter': 'ResourceProvider', 'AWS::OpenSearchService::Domain': 'ResourceProvider', 'AWS::RDS::DBCluster': 'ResourceProvider', 'AWS::Redshift::Cluster': 'ResourceProvider', 'AWS::Route53::HealthCheck': 'ResourceProvider', 'AWS::Route53::RecordSet': 'ResourceProvider', 'AWS::S3::Bucket': 'ResourceProvider', 'AWS::S3::BucketPolicy': 'ResourceProvider', 'AWS::SNS::Topic': 'ResourceProvider', 'AWS::SQS::Queue': 'ResourceProvider', 'AWS::SQS::QueuePolicy': 'ResourceProvider', 'AWS::Scheduler::Schedule': 'ResourceProvider', 'AWS::Scheduler::ScheduleGroup': 'ResourceProvider', 'AWS::SecretsManager::ResourcePolicy': 'ResourceProvider', 'AWS::SecretsManager::RotationSchedule': 'ResourceProvider', 'AWS::SecretsManager::Secret': 'ResourceProvider', 'AWS::SecretsManager::SecretTargetAttachment': 'ResourceProvider', 'AWS::SSM::Parameter': 'ResourceProvider', 'AWS::SSM::MaintenanceWindow': 'ResourceProvider', 'AWS::SSM::MaintenanceWindowTarget': 'ResourceProvider', 'AWS::SSM::MaintenanceWindowTask': 'ResourceProvider', 'AWS::SSM::PatchBaseline': 'ResourceProvider', 'AWS::StepFunctions::Activity': 'ResourceProvider', 'AWS::StepFunctions::StateMachine': 'ResourceProvider'}
...
def resolve_resource_parameters(account_id_: str, region_name_: str, stack_name: str, resource_definition: ResourceDefinition, resources: dict[str, ResourceDefinition], resource_id: str, func_details: FuncDetailsValue) -> dict | None:
    ...
    return params
LEGACY_ACTION_MAP = {'Add': 'create', 'Remove': 'delete'}
