...
import transformers
from transformers import AutoConfig, AutoTokenizer, FlaxAutoModelForSequenceClassification, HfArgumentParser, PretrainedConfig, TrainingArguments, is_tensorboard_available
...
class ModelArguments:
    ...
    use_slow_tokenizer: Optional[bool] = field(default=False, metadata={'help': 'If passed, will use a slow tokenizer (not backed by the 🤗 Tokenizers library).'})
