...
from paddle.distributed.auto_parallel.static.cost.comm_op_cost import AllreduceSumOpCost, IdentityOpCost
from paddle.distributed.fleet.meta_optimizers.common import OP_ROLE_KEY, OpRole
from paddle.framework import core
from paddle.utils import unique_name
from ..completion import get_phi_spmd_rule
from ..cost import MatmulGradOpCost, MatmulOpCost, MatmulV2GradOpCost, MatmulV2OpCost, MulGradOpCost, MulOpCost, build_comm_costs_from_descs, build_comm_desc_from_dist_op, build_comp_costs_from_descs, build_comp_desc_from_dist_op, build_dp_costs
from ..dist_attribute import OperatorDistAttr
from ..process_group import new_process_group
from ..utils import _get_comm_group, _get_corresponding_rank, compute_compatible_and_update_dim_mapping, compute_compatible_dims_mapping, get_dist_tensor_spec, is_dim_replicate, is_dim_shard, is_valid_list_index, set_dist_op_desc_original_id
from .common import DistributedOperatorImpl, DistributedOperatorImplContainer, ParallelMode, copy_op_without_infer_shape, gradient_synchronization, is_parameter_related, register_distributed_operator_impl, register_distributed_operator_impl_container, set_comm_op_dist_attr_for_program, update_op_dims_mapping
...
class DistributedMatmulImpl2(DistributedOperatorImpl):
    ...
    def backward(ctx, *args, **kwargs):
        if False:
            print('Hello World!')
        _right_operand_parameter_matmul_backward(ctx, *args, **kwargs)
register_distributed_operator_impl('matmul', DistributedMatmulImpl0('column_parallel'))
register_distributed_operator_impl('matmul', DistributedMatmulImpl1('row_parallel'))
register_distributed_operator_impl('matmul', DistributedMatmulImpl2('replicate_parallel'))
...
class DistributedMatmulV2Impl2(DistributedOperatorImpl):
    ...
    def backward(ctx, *args, **kwargs):
        if False:
            print('Hello World!')
        _right_operand_parameter_matmul_backward(ctx, *args, **kwargs)
register_distributed_operator_impl('matmul_v2', DistributedMatmulV2Impl0('column_parallel'))
register_distributed_operator_impl('matmul_v2', DistributedMatmulV2Impl1('row_parallel'))
register_distributed_operator_impl('matmul_v2', DistributedMatmulV2Impl2('replicate_parallel'))
    ...
    def backward(ctx, *args, **kwargs):
        if False:
            while True:
                i = 10
        _right_operand_parameter_matmul_backward(ctx, *args, **kwargs)
register_distributed_operator_impl('mul', DistributedMulImpl0('column_parallel'))
register_distributed_operator_impl('mul', DistributedMulImpl1('row_parallel'))
register_distributed_operator_impl('mul', DistributedMulImpl2('replicate_parallel'))