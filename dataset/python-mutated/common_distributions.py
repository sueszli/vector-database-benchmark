...
uniform_params = [{'low': 1, 'high': 10.0, 'size': (3, 5)}, {'low': [1, 2], 'high': 3, 'size': None}, {'low': 20, 'high': 20.1, 'size': 1000}]
...
beta_params = [{'a': 1.0, 'b': 3.0}, {'a': 3.0, 'b': 3.0}, {'a': 3.0, 'b': 1.0}, {'a': [1.0, 3.0, 5.0, 6.0, 9.0], 'b': 7.0}, {'a': 5.0, 'b': [1.0, 5.0, 8.0, 1.0, 3.0]}, {'a': [8.0, 6.0, 2.0, 4.0, 7.0], 'b': [3.0, 1.0, 2.0, 8.0, 1.0]}]
...
standard_normal_params = [{'size': None}, {'size': (1, 2, 3)}, {'size': 3}, {'size': (1000, 1000)}, {'size': (3, 3)}, {'size': ()}]
...
gamma_params = [{'shape': 0.5, 'scale': 0.5}, {'shape': 1.0, 'scale': 0.5}, {'shape': 3.0, 'scale': 0.5}, {'shape': 0.5, 'scale': 1.0}, {'shape': 1.0, 'scale': 1.0}, {'shape': 3.0, 'scale': 1.0}, {'shape': 0.5, 'scale': 3.0}, {'shape': 1.0, 'scale': 3.0}, {'shape': 3.0, 'scale': 3.0}]
...
binomial_params = [{'n': 2, 'p': 0.5}, {'n': 5, 'p': 0.5}, {'n': 10, 'p': 0.5}, {'n': 2, 'p': 0.1}, {'n': 5, 'p': 0.1}, {'n': 10, 'p': 0.1}, {'n': 2, 'p': 1.0}, {'n': 2, 'p': 1.0}, {'n': 2, 'p': 1.0}]
...
geometric_params = [{'p': 0.5}, {'p': 0.1}, {'p': 1.0}, {'p': [0.1, 0.5]}]
...
hypergeometric_params = [{'ngood': 5, 'nbad': 5, 'nsample': 5}, {'ngood': 10, 'nbad': 10, 'nsample': 10}, {'ngood': 100, 'nbad': 2, 'nsample': 10}, {'ngood': [0, 5, 8], 'nbad': [5, 0, 3], 'nsample': [2, 1, 8]}, {'ngood': [1, 4, 2, 7, 6], 'nbad': 5.0, 'nsample': [2, 7, 4, 6, 5]}]
...
power_params = [{'a': 0.5}, {'a': 1}, {'a': 5}, {'a': [0.8, 0.7, 1, 2, 5]}]
...
logseries_params = [{'p': 0.5}, {'p': 0.1}, {'p': 0.9}, {'p': [0.8, 0.7]}]
...
class Logseries:
    ...
    def test_geometric_ks(self):
        ...
        if not isinstance(self.p, float):
            self.skipTest('Statistical checks only for scalar `p`')
        self.check_ks(0.05)(p=self.p, size=2000)
chisquare_params = [{'df': 1.0}, {'df': 3.0}, {'df': 10.0}, {'df': [2, 5, 8]}]
...
f_params = [{'dfnum': 1.0, 'dfden': 3.0}, {'dfnum': 3.0, 'dfden': 3.0}, {'dfnum': 3.0, 'dfden': 1.0}, {'dfnum': [1.0, 3.0, 3.0], 'dfden': [3.0, 3.0, 1.0]}]
