...
from samcli.lib.iac.plugins_interfaces import SamCliContext, SamCliProject, Stack, DictSectionItem
GENERIC_CFN_TEMPLATE = {'Resources': {'Lambda': {'Type': 'AWS::Serverless::Function'}}, 'Parameters': {'Param1': {'Type': 'String', 'Default': 'foo'}}, 'OtherMapping': {}, 'OtherKey': 'other'}
