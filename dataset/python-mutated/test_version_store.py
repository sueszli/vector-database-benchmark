...
TPL_VERSION = {'_id': ObjectId('5a2ffdf817f7041a4ff1aa82'), 'base_version_id': ObjectId('5a2ffd5917f70412ca78d80a'), 'append_count': 0, 'dtype_metadata': {'index': ['index'], 'columns': ['A', 'B', 'C', 'D']}, 'segment_count': 1, 'symbol': 'SYM_E', 'up_to': 3, 'metadata': None, 'shape': [-1], 'version': 6, 'type': 'pandasdf', 'append_size': 0}
