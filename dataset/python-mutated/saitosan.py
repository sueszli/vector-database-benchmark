...
class SaitosanIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.saitosan.net/bview.html?id=10031846', 'info_dict': {'id': '10031846', 'ext': 'mp4', 'title': '井下原 和弥', 'uploader': '井下原 和弥', 'thumbnail': 'http://111.171.196.85:8088/921f916f-7f55-4c97-b92e-5d9d0fef8f5f/thumb', 'is_live': True}, 'params': {'skip_download': True}, 'skip': 'Broadcasts are ephemeral'}, {'url': 'http://www.saitosan.net/bview.html?id=10031795', 'info_dict': {'id': '10031795', 'ext': 'mp4', 'title': '橋本', 'uploader': '橋本', 'thumbnail': 'http://111.171.196.85:8088/1a3933e1-a01a-483b-8931-af15f37f8082/thumb', 'is_live': True}, 'params': {'skip_download': True}, 'skip': 'Broadcasts are ephemeral'}]
