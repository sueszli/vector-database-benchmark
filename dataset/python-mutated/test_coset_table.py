...
def test_modified_methods():
    ...
    assert C.P == [[identity, identity, None, a_0 ** (-1)], [identity, identity, a_0, None], [identity, identity, None, None]]
    ...
    assert C.P == [[identity, identity, None, a_0 ** (-1)], [identity, identity, a_0, None], [identity, identity, None, identity], [None, None, identity, None]]
    C.modified_scan(0, x ** (-1) * y ** (-1) * x * y * x, C._grp.generators[1])
    assert C.table == [[1, 2, None, 1], [2, 0, 0, None], [0, 1, None, 3], [3, 3, 2, None]]
    assert C.P == [[identity, identity, None, a_0 ** (-1)], [identity, identity, a_0, None], [identity, identity, None, identity], [a_1, a_1 ** (-1), identity, None]]
    C.modified_scan(2, (x * y) ** 2, C._grp.identity)
    assert C.table == [[1, 2, 3, 1], [2, 0, 0, None], [0, 1, None, 3], [3, 3, 2, 0]]
    assert C.P == [[identity, identity, a_1 ** (-1), a_0 ** (-1)], [identity, identity, a_0, None], [identity, identity, None, identity], [a_1, a_1 ** (-1), identity, a_1]]
    C.modified_define(2, y)
    assert C.table == [[1, 2, 3, 1], [2, 0, 0, None], [0, 1, 4, 3], [3, 3, 2, 0], [None, None, None, 2]]
    assert C.P == [[identity, identity, a_1 ** (-1), a_0 ** (-1)], [identity, identity, a_0, None], [identity, identity, identity, identity], [a_1, a_1 ** (-1), identity, a_1], [None, None, None, identity]]
    C.modified_scan(0, y ** 5, C._grp.identity)
    assert C.table == [[1, 2, 3, 1], [2, 0, 0, 4], [0, 1, 4, 3], [3, 3, 2, 0], [None, None, 1, 2]]
    assert C.P == [[identity, identity, a_1 ** (-1), a_0 ** (-1)], [identity, identity, a_0, a_0 * a_1 ** (-1)], [identity, identity, identity, identity], [a_1, a_1 ** (-1), identity, a_1], [None, None, a_1 * a_0 ** (-1), identity]]
    C.modified_scan(1, (x * y) ** 2, C._grp.identity)
    assert C.table == [[1, 2, 3, 1], [2, 0, 0, 4], [0, 1, 4, 3], [3, 3, 2, 0], [4, 4, 1, 2]]
    assert C.P == [[identity, identity, a_1 ** (-1), a_0 ** (-1)], [identity, identity, a_0, a_0 * a_1 ** (-1)], [identity, identity, identity, identity], [a_1, a_1 ** (-1), identity, a_1], [a_0 * a_1 ** (-1), a_1 * a_0 ** (-1), a_1 * a_0 ** (-1), identity]]
    f = FpGroup(F, [x ** 3, y ** 3, x ** (-1) * y ** (-1) * x * y])
