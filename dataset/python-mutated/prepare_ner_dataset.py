...
DATASET_MAPPING = {'ar_aqmar': process_ar_aqmar, 'bn_daffodil': process_bn_daffodil, 'da_ddt': process_da_ddt, 'de_germeval2014': process_de_germeval2014, 'en_conllpp': process_en_conllpp, 'en_worldwide-4class': process_en_worldwide_4class, 'en_worldwide-8class': process_en_worldwide_8class, 'fa_arman': process_fa_arman, 'fi_turku': process_turku, 'hi_hiner': process_hiner, 'hi_hinercollapsed': process_hinercollapsed, 'hi_ijc': process_ijc, 'hu_nytk': process_nytk, 'hu_combined': process_hu_combined, 'hy_armtdp': process_armtdp, 'it_fbk': process_it_fbk, 'ja_gsd': process_ja_gsd, 'kk_kazNERD': process_kk_kazNERD, 'mr_l3cube': process_mr_l3cube, 'my_ucsy': process_my_ucsy, 'pl_nkjp': process_pl_nkjp, 'sd_siner': process_sd_siner, 'sv_suc3licensed': process_sv_suc3licensed, 'sv_suc3shuffle': process_sv_suc3shuffle, 'tr_starlang': process_starlang, 'th_lst20': process_lst20, 'th_nner22': process_nner22}
