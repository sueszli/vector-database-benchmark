...
from sentry.issues.grouptype import NoiseConfig, PerformanceNPlusOneAPICallsGroupType, PerformanceNPlusOneGroupType
...
FEATURES = {'organizations:performance-n-plus-one-api-calls-detector': True}
