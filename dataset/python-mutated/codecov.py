...
CODECOV_REPORT_URL = 'https://api.codecov.io/api/v2/{service}/{owner_username}/repos/{repo_name}/file_report/{path}'
...
class CodecovIntegrationError(Enum):
    ...
    MISSING_CODECOV = 'Codecov access can only be enabled if the organization has a Codecov integration.'
