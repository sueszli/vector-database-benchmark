...
dcgmMetricParameterMap = {'02_gpuUtility': [('GPUTL', 'GPUTL'), ('GRACT', 'GRACT')], '03_smUtility': [('SMACT', 'SMACT'), ('SMOCC', 'SMOCC')], '04_memUtility': [('FB_USED_RATIO', 'FB_USED_RATIO'), ('DRAMA', 'DRAMA')], '05_txUtility': [('NVLTX', 'NVLTX'), ('NVLRX', 'NVLRX'), ('PCITX', 'PCITX'), ('PCIRX', 'PCIRX')], '06_calUtility': [('FP32A', 'FP32A'), ('FP16A', 'FP16A'), ('TENSO', 'TENSO')]}
...
FILEORGANIZEFORM = [FILEORGANIZEFORM_BYRANK, FILEORGANIZEFORM_BYTRAINER, FILEORGANIZEFORM_BYOTHER]
...
if __name__ == '__main__':
    ...
    args = {'dataPath': '.', 'groupSize': 1, 'displaySize': 1, 'gpuPerTrainer': 8, 'organizeForm': FILEORGANIZEFORM_BYOTHER}
    test_FileReader(args)
    args = {'dataPath': '.', 'groupSize': 1, 'displaySize': 1, 'gpuPerTrainer': 8, 'organizeForm': FILEORGANIZEFORM_BYTRAINER}
    test_FileReader(args)
    args = {'dataPath': './res', 'groupSize': 1, 'displaySize': 1, 'gpuPerTrainer': 8, 'organizeForm': FILEORGANIZEFORM_BYTRAINER}
    test_FileReader(args)
    args = {'dataPath': '.', 'groupSize': '', 'displaySize': 1, 'gpuPerTrainer': 8, 'organizeForm': FILEORGANIZEFORM_BYTRAINER}
    test_FileReader(args)