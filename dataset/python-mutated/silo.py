...
from typing import Any, Callable, Dict, Iterable, List, Literal, MutableMapping, MutableSet, Sequence, Set, Tuple, Type, cast
...
_DEFAULT_TEST_REGIONS = (Region('us', 1, 'http://us.testserver', RegionCategory.MULTI_TENANT), Region('eu', 2, 'http://eu.testserver', RegionCategory.MULTI_TENANT), Region('acme-single-tenant', 3, 'acme.my.sentry.io', RegionCategory.SINGLE_TENANT))
