...
class TestMixedPrecision(FSDPTest):
    ...
    EXPECTED_CAST_DTYPES = {SubtestKey(True, True, True): SubtestResult('cast_root_cast_child_no_root_params'), SubtestKey(True, True, False): SubtestResult('cast_root_cast_child_root_params', model_dtype=torch.float32, c1_dtype=torch.float32), SubtestKey(True, False, True): SubtestResult('cast_root_no_cast_child_no_root_params'), SubtestKey(True, False, False): SubtestResult('cast_root_no_cast_child_root_params', model_dtype=torch.float32, c1_dtype=torch.float32), SubtestKey(False, True, True): SubtestResult('no_cast_root_cast_child_no_root_params', model_dtype=torch.float32), SubtestKey(False, True, False): SubtestResult('no_cast_root_cast_child_root_params', model_dtype=torch.float32, c1_dtype=torch.float32), SubtestKey(False, False, True): SubtestResult('no_cast_root_no_cast_child_no_root_params', model_dtype=torch.float32, c1_dtype=torch.float32, c2_dtype=None), SubtestKey(False, False, False): SubtestResult('no_cast_root_no_cast_child_root_params', model_dtype=torch.float32, c1_dtype=torch.float32, c2_dtype=torch.float32)}
