...
from ..utils import extract_attributes, float_or_none, get_element_html_by_class, int_or_none, merge_dicts, parse_age_limit, remove_end, str_or_none, traverse_obj, unescapeHTML, unified_timestamp, update_url_query, url_or_none

class BravoTVIE(AdobePassIE):
    _VALID_URL = 'https?://(?:www\\.)?(?P<site>bravotv|oxygen)\\.com/(?:[^/]+/)+(?P<id>[^/?#]+)'
    _TESTS = [{'url': 'https://www.bravotv.com/top-chef/season-16/episode-15/videos/the-top-chef-season-16-winner-is', 'info_dict': {'id': '3923059', 'ext': 'mp4', 'title': 'The Top Chef Season 16 Winner Is...', 'description': 'Find out who takes the title of Top Chef!', 'upload_date': '20190314', 'timestamp': 1552591860, 'season_number': 16, 'episode_number': 15, 'series': 'Top Chef', 'episode': 'The Top Chef Season 16 Winner Is...', 'duration': 190.357, 'season': 'Season 16', 'thumbnail': 're:^https://.+\\.jpg'}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.bravotv.com/top-chef/season-20/episode-1/london-calling', 'info_dict': {'id': '9000234570', 'ext': 'mp4', 'title': 'London Calling', 'description': 'md5:5af95a8cbac1856bd10e7562f86bb759', 'upload_date': '20230310', 'timestamp': 1678410000, 'season_number': 20, 'episode_number': 1, 'series': 'Top Chef', 'episode': 'London Calling', 'duration': 3266.03, 'season': 'Season 20', 'chapters': 'count:7', 'thumbnail': 're:^https://.+\\.jpg', 'age_limit': 14}, 'params': {'skip_download': 'm3u8'}, 'skip': 'This video requires AdobePass MSO credentials'}, {'url': 'https://www.oxygen.com/in-ice-cold-blood/season-1/closing-night', 'info_dict': {'id': '3692045', 'ext': 'mp4', 'title': 'Closing Night', 'description': 'md5:3170065c5c2f19548d72a4cbc254af63', 'upload_date': '20180401', 'timestamp': 1522623600, 'season_number': 1, 'episode_number': 1, 'series': 'In Ice Cold Blood', 'episode': 'Closing Night', 'duration': 2629.051, 'season': 'Season 1', 'chapters': 'count:6', 'thumbnail': 're:^https://.+\\.jpg', 'age_limit': 14}, 'params': {'skip_download': 'm3u8'}, 'skip': 'This video requires AdobePass MSO credentials'}, {'url': 'https://www.oxygen.com/in-ice-cold-blood/season-2/episode-16/videos/handling-the-horwitz-house-after-the-murder-season-2', 'info_dict': {'id': '3974019', 'ext': 'mp4', 'title': "'Handling The Horwitz House After The Murder (Season 2, Episode 16)", 'description': 'md5:f9d638dd6946a1c1c0533a9c6100eae5', 'upload_date': '20190617', 'timestamp': 1560790800, 'season_number': 2, 'episode_number': 16, 'series': 'In Ice Cold Blood', 'episode': "'Handling The Horwitz House After The Murder (Season 2, Episode 16)", 'duration': 68.235, 'season': 'Season 2', 'thumbnail': 're:^https://.+\\.jpg', 'age_limit': 14}, 'params': {'skip_download': 'm3u8'}}, {'url': 'https://www.bravotv.com/below-deck/season-3/ep-14-reunion-part-1', 'only_matching': True}]
