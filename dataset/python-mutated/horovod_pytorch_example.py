...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-workers', type=int, default=2, help='Number of Ray workers to use for training.')
    ...
    kwargs = {'data_dir': args.data_dir, 'seed': args.seed, 'use_cuda': use_cuda, 'batch_size': args.batch_size, 'use_adasum': args.use_adasum if args.use_adasum else False, 'lr': args.lr, 'momentum': args.momentum, 'num_epochs': args.num_epochs, 'log_interval': args.log_interval}
