...
(feedback_models, opportunity_models, story_models, suggestion_models) = models.Registry.import_models([models.Names.FEEDBACK, models.Names.OPPORTUNITY, models.Names.STORY, models.Names.SUGGESTION])
...
class OpportunityServicesIntegrationTest(test_utils.GenericTestBase):
    ...
    suggestion_change: Dict[str, str] = {'cmd': exp_domain.CMD_ADD_WRITTEN_TRANSLATION, 'state_name': 'Introduction', 'content_id': 'content_0', 'language_code': 'hi', 'content_html': '', 'translation_html': '<p>This is translated html.</p>', 'data_format': 'html'}
...
class OpportunityUpdateOnAcceeptingSuggestionUnitTest(test_utils.GenericTestBase):
