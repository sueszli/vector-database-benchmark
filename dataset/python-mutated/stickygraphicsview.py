import sys
import math
from AnyQt.QtCore import Qt, QRectF, QEvent, QCoreApplication, QObject, QPointF, QRect
from AnyQt.QtGui import QBrush, QPalette, QTransform, QPolygonF
from AnyQt.QtWidgets import QGraphicsView, QGraphicsScene, QWidget, QVBoxLayout, QSizePolicy, QScrollBar, QGraphicsDropShadowEffect
from orangewidget.utils.overlay import OverlayWidget
__all__ = ['StickyGraphicsView']
