...
class ScheduledActionsOperations:
    ...
    def list(self, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.ScheduledAction']:
        ...
        def prepare_request(next_link=None):
            if False:
                print('Hello World!')
            if not next_link:
                request = build_list_request(filter=filter, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def list_by_scope(self, scope: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.ScheduledAction']:
        if False:
            i = 10
            return i + 15
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_list_by_scope_request(scope=scope, filter=filter, api_version=api_version, template_url=self.list_by_scope.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    @overload
    async def create_or_update(self, name: str, scheduled_action: _models.ScheduledAction, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ScheduledAction:
    ...
    @overload
    async def create_or_update(self, name: str, scheduled_action: IO, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ScheduledAction:
        """Create or update a private scheduled action.
    ...
    async def create_or_update(self, name: str, scheduled_action: Union[_models.ScheduledAction, IO], if_match: Optional[str]=None, **kwargs: Any) -> _models.ScheduledAction:
        """Create or update a private scheduled action.
        ...
        request = build_create_or_update_request(name=name, if_match=if_match, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get(self, name: str, **kwargs: Any) -> _models.ScheduledAction:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.ScheduledAction] = kwargs.pop('cls', None)
        request = build_get_request(name=name, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete(self, name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(name=name, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update_by_scope(self, scope: str, name: str, scheduled_action: _models.ScheduledAction, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ScheduledAction:
    ...
    @overload
    async def create_or_update_by_scope(self, scope: str, name: str, scheduled_action: IO, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ScheduledAction:
        """Create or update a shared scheduled action within the given scope.
    ...
    @distributed_trace_async
    async def create_or_update_by_scope(self, scope: str, name: str, scheduled_action: Union[_models.ScheduledAction, IO], if_match: Optional[str]=None, **kwargs: Any) -> _models.ScheduledAction:
        """Create or update a shared scheduled action within the given scope.
        ...
        if isinstance(scheduled_action, (IOBase, bytes)):
            ...
            _json = self._serialize.body(scheduled_action, 'ScheduledAction')
        request = build_create_or_update_by_scope_request(scope=scope, name=name, if_match=if_match, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def get_by_scope(self, scope: str, name: str, **kwargs: Any) -> _models.ScheduledAction:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.ScheduledAction] = kwargs.pop('cls', None)
        request = build_get_by_scope_request(scope=scope, name=name, api_version=api_version, template_url=self.get_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete_by_scope(self, scope: str, name: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_by_scope_request(scope=scope, name=name, api_version=api_version, template_url=self.delete_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def run(self, name: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_run_request(name=name, api_version=api_version, template_url=self.run.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def run_by_scope(self, scope: str, name: str, **kwargs: Any) -> None:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_run_by_scope_request(scope=scope, name=name, api_version=api_version, template_url=self.run_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def check_name_availability(self, check_name_availability_request: _models.CheckNameAvailabilityRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
    ...
    @overload
    async def check_name_availability(self, check_name_availability_request: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
        """Checks availability and correctness of the name for a scheduled action.
    ...
    @distributed_trace_async
    async def check_name_availability(self, check_name_availability_request: Union[_models.CheckNameAvailabilityRequest, IO], **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
        """Checks availability and correctness of the name for a scheduled action.
        ...
        request = build_check_name_availability_request(api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.check_name_availability.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def check_name_availability_by_scope(self, scope: str, check_name_availability_request: _models.CheckNameAvailabilityRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
    ...
    @overload
    async def check_name_availability_by_scope(self, scope: str, check_name_availability_request: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
        """Checks availability and correctness of the name for a scheduled action within the given scope.
    ...
    @distributed_trace_async
    async def check_name_availability_by_scope(self, scope: str, check_name_availability_request: Union[_models.CheckNameAvailabilityRequest, IO], **kwargs: Any) -> _models.CheckNameAvailabilityResponse:
        """Checks availability and correctness of the name for a scheduled action within the given scope.
        ...
        if isinstance(check_name_availability_request, (IOBase, bytes)):
            ...
            _json = self._serialize.body(check_name_availability_request, 'CheckNameAvailabilityRequest')
        request = build_check_name_availability_by_scope_request(scope=scope, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.check_name_availability_by_scope.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
