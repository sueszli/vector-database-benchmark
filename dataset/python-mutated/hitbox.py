...
class HitboxLiveIE(HitboxIE):
    ...
    _TESTS = [{'url': 'http://www.hitbox.tv/dimak', 'info_dict': {'id': 'dimak', 'ext': 'mp4', 'description': 'md5:c9f80fa4410bc588d7faa40003fc7d0e', 'timestamp': int, 'upload_date': compat_str, 'title': compat_str, 'uploader': 'Dimak'}, 'params': {'skip_download': True}}, {'url': 'https://www.smashcast.tv/dimak', 'only_matching': True}]
