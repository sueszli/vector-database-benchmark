...
DECISION_TRANSFORMER_PRETRAINED_CONFIG_ARCHIVE_MAP = {'edbeeching/decision-transformer-gym-hopper-medium': 'https://huggingface.co/edbeeching/decision-transformer-gym-hopper-medium/resolve/main/config.json'}
