...
ObjectDetectionEvalMetrics = collections.namedtuple('ObjectDetectionEvalMetrics', ['average_precisions', 'mean_ap', 'precisions', 'recalls', 'corlocs', 'mean_corloc'])
...
ObjectDetectionEvaluationState = collections.namedtuple('ObjectDetectionEvaluationState', ['num_gt_instances_per_class', 'scores_per_class', 'tp_fp_labels_per_class', 'num_gt_imgs_per_class', 'num_images_correctly_detected_per_class'])
