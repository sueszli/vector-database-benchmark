...
if cupyx.scipy._scipy_available:
    import scipy.linalg
requires_scipy_linalg_backend = unittest.skip('scipy.linalg backend feature has not been released')

@testing.parameterize(*testing.product({'shape': [(1, 1), (2, 2), (3, 3), (5, 5), (1, 5), (5, 1), (2, 5), (5, 2)]}))
@testing.fix_random()
...
@testing.parameterize(*testing.product({'shape': [(1, 1), (2, 2), (3, 3), (5, 5), (1, 5), (5, 1), (2, 5), (5, 2)], 'permute_l': [False, True]}))
@testing.fix_random()
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'trans': [0, 1, 2], 'shapes': [((4, 4), (4,)), ((5, 5), (5, 2))]}))
@testing.fix_random()
@testing.with_requires('scipy')
