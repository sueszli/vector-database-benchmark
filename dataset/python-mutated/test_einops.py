...
import warnings
flag_to_bool = {'': False, '0': False, '1': True}
...
rearrangement_patterns = [testcase('b c h w -> b (c h w)', dict(c=20), (10, 20, 30, 40), [(), (10,), (10, 10, 10), (10, 21, 30, 40), [1, 20, 1, 1, 1]]), testcase('b c (h1 h2) (w1 w2) -> b (c h2 w2) h1 w1', dict(h2=2, w2=2), (10, 20, 30, 40), [(), (1, 1, 1, 1), (1, 10, 3), ()]), testcase('b ... c -> c b ...', dict(b=10), (10, 20, 30), [(), (10,), (5, 10)])]
reduction_patterns = rearrangement_patterns + [testcase('b c h w -> b ()', dict(b=10), (10, 20, 30, 40), [(10,), (10, 20, 30)]), testcase('b c (h1 h2) (w1 w2) -> b c h1 w1', dict(h1=15, h2=2, w2=2), (10, 20, 30, 40), [(10, 20, 31, 40)]), testcase('b ... c -> b', dict(b=10), (10, 20, 30, 40), [(10,), (11, 10)])]
equivalent_reduction_patterns = [('a b c d e -> ', ' ... ->  '), ('a b c d e -> (e a)', 'a ... e -> (e a)'), ('a b c d e -> d (a e)', ' a b c d e ... -> d (a e) '), ('a b c d e -> (a b)', ' ... c d e  -> (...) ')]
equivalent_rearrange_patterns = [('a b c d e -> (a b) c d e', 'a b ... -> (a b) ... '), ('a b c d e -> a b (c d) e', '... c d e -> ... (c d) e'), ('a b c d e -> a b c d e', '... -> ... '), ('a b c d e -> (a b c d e)', '... ->  (...)'), ('a b c d e -> b (c d e) a', 'a b ... -> b (...) a'), ('a b c d e -> b (a c d) e', 'a b ... e -> b (a ...) e')]
identity_patterns = ['...->...', 'a b c d e-> a b c d e', 'a b c d e ...-> ... a b c d e', 'a b c d e ...-> a ... b c d e', '... a b c d e -> ... a b c d e', 'a ... e-> a ... e', 'a ... -> a ... ', 'a ... c d e -> a (...) c d e']
test_cases_repeat_anonymous = [('a b c d -> c a d b', dict()), ('a b c d -> (c 2 d a b)', dict(a=1, c=4, d=6)), ('1 b c d -> (d copy 1) 3 b c ', dict(copy=3)), ('1 ...  -> 3 ... ', dict()), ('() ... d -> 1 (copy1 d copy2) ... ', dict(copy1=2, copy2=3)), ('1 b c d -> (1 1) (1 b) 2 c 3 d (1 1)', dict())]
repeat_test_cases = [('a b c -> c a b', dict()), ('a b c -> (c copy a b)', dict(copy=2, a=2, b=3, c=5)), ('a b c -> (a copy) b c ', dict(copy=1)), ('a b c -> (c a) (copy1 b copy2)', dict(a=2, copy1=1, copy2=2)), ('a ...  -> a ... copy', dict(copy=4)), ('... c -> ... (copy1 c copy2)', dict(copy1=1, copy2=2)), ('...  -> ... ', dict()), (' ...  -> copy1 ... copy2 ', dict(copy1=2, copy2=3)), ('a b c  -> copy1 a copy2 b c () ', dict(copy1=2, copy2=1))]
