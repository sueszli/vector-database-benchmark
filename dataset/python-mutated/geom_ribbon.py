...
class geom_ribbon(geom):
    ...
    DEFAULT_AES = {'alpha': 1, 'color': 'none', 'fill': '#333333', 'linetype': 'solid', 'size': 0.5, 'where': True}
    REQUIRED_AES = {'x', 'ymax', 'ymin'}
    DEFAULT_PARAMS = {'stat': 'identity', 'position': 'identity', 'outline_type': 'both', 'na_rm': False}
