...
contains_map = {Numeric: {'x', 'y', 's1', 'num_with_inf', 'integers', 'integers_nan', 'bool_01', 'bool_01_with_nan', 'inf_only', 'nullable_int'}, Text: {'str', 'str_cat', 'str_num', 'str_date', 'str_date2', 'str_yes_no', 'str_yes_no_mixed', 'str_yes_no_nan', 'str_true_false', 'str_true_false_none', 'str_true_false_nan', 'id', 'catnum', 'date_str', 's2'}, Categorical: {'cat'}, Boolean: {'bool_tf', 'bool_tf_with_nan', 'booleans_type', 'booleans_type_nan'}, DateTime: {'somedate'}, Unsupported: {'empty', 'list', 'mixed', 'dict', 'tuple'}}
...
inference_map = {'x': Numeric, 'y': Numeric, 's1': Numeric, 'num_with_inf': Numeric, 'integers': Numeric, 'integers_nan': Numeric, 'bool_01': Numeric, 'bool_01_with_nan': Numeric, 'id': Text, 'str_cat': Categorical, 'str_num': Numeric, 'str_date': DateTime, 'str_date2': DateTime, 's2': Categorical, 'date_str': DateTime, 'str': Text, 'cat': Categorical, 'bool_tf': Boolean, 'bool_tf_with_nan': Boolean, 'booleans_type': Boolean, 'booleans_type_nan': Boolean, 'str_yes_no': Boolean, 'str_yes_no_mixed': Boolean, 'str_yes_no_nan': Boolean, 'str_true_false': Boolean, 'str_true_false_none': Boolean, 'str_true_false_nan': Boolean, 'somedate': DateTime, 'empty': Unsupported, 'list': Unsupported, 'mixed': Unsupported, 'dict': Unsupported, 'tuple': Unsupported, 'inf_only': Numeric, 'nullable_int': Numeric, 'catnum': Numeric}
...
def test_inference(name, series, inference_type, typeset, difference):
    ...
    assert result, message
convert_map = [(Categorical2, Numeric2, {'integers', 'inf_only', 'integers_nan', 's1', 'bool_01', 'bool_01_with_nan', 'nullable_int'}), (Boolean2, Text2, {'str_yes_no', 'str_yes_no_mixed', 'str_yes_no_nan', 'str_true_false', 'str_true_false_nan', 'str_true_false_none'}), (Categorical2, Text2, {'str_cat', 's2'}), (Numeric2, Text2, {'str_num', 'catnum'}), (DateTime2, Text2, {'str_date', 'str_date2', 'date_str'})]
