...
from sslyze.scanner.models import AllScanCommandsAttempts, get_scan_command_attempt_cls, ServerConnectivityStatusEnum, ServerScanStatusEnum
from sslyze.scanner.scan_command_attempt import ScanCommandAttempt
from sslyze.server_connectivity import ServerConnectivityInfo, ServerTlsProbingResult, ClientAuthRequirementEnum, TlsVersionEnum
from sslyze.server_setting import ServerNetworkConfiguration, ServerNetworkLocation, HttpProxySettings
fake = Faker()
