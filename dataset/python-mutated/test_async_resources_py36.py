...
async def test_init_and_shutdown_ordering():
    ...
    class Container(containers.DeclarativeContainer):
        resource1 = providers.Resource(_resource, name='r1', delay=0.03)
        resource2 = providers.Resource(_resource, name='r2', delay=0.02, r1=resource1)
        resource3 = providers.Resource(_resource, name='r3', delay=0.01, r2=resource2)
    container = Container()
...
async def test_shutdown_circular_dependencies_breaker():
    ...
    class Container(containers.DeclarativeContainer):
        resource1 = providers.Resource(_resource, name='r1')
        resource2 = providers.Resource(_resource, name='r2', r1=resource1)
        resource3 = providers.Resource(_resource, name='r3', r2=resource2)
    container = Container()
    await container.init_resources()
...
async def test_shutdown_sync_and_async_ordering():
    ...
    class Container(containers.DeclarativeContainer):
        resource1 = providers.Resource(_sync_resource, name='r1')
        resource2 = providers.Resource(_sync_resource, name='r2', r1=resource1)
        resource3 = providers.Resource(_async_resource, name='r3', r2=resource2)
    container = Container()
    await container.init_resources()
    assert initialized_resources == ['r1', 'r2', 'r3']
    assert shutdown_resources == []
