...
import anyio
import pytest
from prefect.utilities.asyncutils import GatherIncomplete, LazySemaphore, add_event_loop_shutdown_callback, create_gather_task_group, gather, in_async_main_thread, in_async_worker_thread, is_async_fn, is_async_gen_fn, run_async_from_worker_thread, run_async_in_new_loop, run_sync_in_interruptible_worker_thread, run_sync_in_worker_thread, sync_compatible
...
class SyncCompatibleClass:
    ...
    async def instance_method(self, x, y, z=3):
        ...
        return x + y + z
SYNC_COMPAT_TEST_CASES = [sync_compatible_fn, SyncCompatibleClass.static_method, SyncCompatibleClass.class_method, SyncCompatibleClass().instance_method]
