...
from transformers import WEIGHTS_NAME, AdamW, BertConfig, BertForSequenceClassification, BertTokenizer, get_linear_schedule_with_warmup
...
MODEL_CLASSES = {'bert': (BertConfig, BertForSequenceClassification, BertTokenizer), 'masked_bert': (MaskedBertConfig, MaskedBertForSequenceClassification, BertTokenizer)}
