...
class FilepupNet(SimpleDownloader):
    ...
    __version__ = '0.08'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?filepup\\.net/files/\\w+'
    ...
    NAME_PATTERN = '>(?P<N>.+?)</h1>'
    SIZE_PATTERN = 'class="fa fa-archive"></i> \\((?P<S>[\\d.,]+) (?P<U>[\\w^_]+)'
    OFFLINE_PATTERN = '>This file has been deleted'
    LINK_FREE_PATTERN = "(http://www\\.filepup\\.net/get/.+?)\\'"
