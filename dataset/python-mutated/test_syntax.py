...
from rich.syntax import ANSISyntaxTheme, Color, Console, PygmentsSyntaxTheme, Syntax, _SyntaxHighlightRange
...
skip_windows_permission_error = pytest.mark.skipif(sys.platform == 'win32', reason='permissions error on Windows')
...
if __name__ == '__main__':
    syntax = Panel.fit(Syntax(CODE, lexer='python', line_numbers=True, line_range=(2, 10), theme='foo', code_width=60, word_wrap=True), padding=0)
