...
class ComponentCurrentBillingFeaturesOperations:
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.ApplicationInsightsComponentBillingFeatures:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, billing_features_properties: _models.ApplicationInsightsComponentBillingFeatures, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentBillingFeatures:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, billing_features_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentBillingFeatures:
        """Update current billing features for an Application Insights component.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, resource_name: str, billing_features_properties: Union[_models.ApplicationInsightsComponentBillingFeatures, IO], **kwargs: Any) -> _models.ApplicationInsightsComponentBillingFeatures:
        """Update current billing features for an Application Insights component.
