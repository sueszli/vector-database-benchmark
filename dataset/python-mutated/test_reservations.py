...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.ReservationsRestTransport, 'rest')])
...
def test_reservations_client_get_transport_class():
    ...
    available_transports = [transports.ReservationsRestTransport]
    assert transport in available_transports
    transport = ReservationsClient.get_transport_class('rest')
    assert transport == transports.ReservationsRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(ReservationsClient, transports.ReservationsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(ReservationsClient, transports.ReservationsRestTransport, 'rest', 'true'), (ReservationsClient, transports.ReservationsRestTransport, 'rest', 'false')])
@mock.patch.object(ReservationsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(ReservationsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(ReservationsClient, transports.ReservationsRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('request_type', [compute.AggregatedListReservationsRequest, dict])
def test_aggregated_list_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.ReservationAggregatedList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value', unreachables=['unreachables_value'])
...
def test_aggregated_list_rest_interceptors(null_interceptor):
    if False:
        print('Hello World!')
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_aggregated_list') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_aggregated_list') as pre:
        ...
        req.return_value._content = compute.ReservationAggregatedList.to_json(compute.ReservationAggregatedList())
...
def test_aggregated_list_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.aggregated_list(compute.AggregatedListReservationsRequest(), project='project_value')
...
def test_aggregated_list_rest_pager(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.ReservationAggregatedList(items={'a': compute.ReservationsScopedList(), 'b': compute.ReservationsScopedList(), 'c': compute.ReservationsScopedList()}, next_page_token='abc'), compute.ReservationAggregatedList(items={}, next_page_token='def'), compute.ReservationAggregatedList(items={'g': compute.ReservationsScopedList()}, next_page_token='ghi'), compute.ReservationAggregatedList(items={'h': compute.ReservationsScopedList(), 'i': compute.ReservationsScopedList()}))
...
def test_delete_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('project', 'reservation', 'zone'))
...
def test_delete_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_delete') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_delete') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_rest_bad_request(transport: str='rest', request_type=compute.DeleteReservationRequest):
    if False:
        return 10
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'reservation': 'sample3'}
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', zone='zone_value', reservation='reservation_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value')
...
def test_get_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Reservation(commitment='commitment_value', creation_timestamp='creation_timestamp_value', description='description_value', id=205, kind='kind_value', name='name_value', satisfies_pzs=True, self_link='self_link_value', specific_reservation_required=True, status='status_value', zone='zone_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_get') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value')
...
@pytest.mark.parametrize('request_type', [compute.GetIamPolicyReservationRequest, dict])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_get_iam_policy') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_get_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/reservations/{resource}/getIamPolicy' % client.transport._host, args[1])
...
def test_get_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get_iam_policy(compute.GetIamPolicyReservationRequest(), project='project_value', zone='zone_value', resource='resource_value')
...
def test_insert_rest(request_type):
    ...
    for (field, value) in request_init['reservation_resource'].items():
        result = None
        is_repeated = False
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('project', 'reservationResource', 'zone'))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_insert') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_bad_request(transport: str='rest', request_type=compute.InsertReservationRequest):
    if False:
        print('Hello World!')
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2'}
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', zone='zone_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertReservationRequest(), project='project_value', zone='zone_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertReservationRequest(), project='project_value', zone='zone_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
...
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.ReservationList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_list') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.ReservationList.to_json(compute.ReservationList())
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListReservationsRequest(), project='project_value', zone='zone_value')
...
def test_resize_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['reservations_resize_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_resize_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('project', 'reservation', 'reservationsResizeRequestResource', 'zone'))
...
def test_resize_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_resize') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_resize') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_resize_rest_bad_request(transport: str='rest', request_type=compute.ResizeReservationRequest):
    if False:
        return 10
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'reservation': 'sample3'}
...
def test_resize_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'reservation': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', reservation='reservation_value', reservations_resize_request_resource=compute.ReservationsResizeRequest(specific_sku_count=1920))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/reservations/{reservation}/resize' % client.transport._host, args[1])
...
def test_resize_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.resize(compute.ResizeReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value', reservations_resize_request_resource=compute.ReservationsResizeRequest(specific_sku_count=1920))
...
def test_resize_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.resize_unary(compute.ResizeReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value', reservations_resize_request_resource=compute.ReservationsResizeRequest(specific_sku_count=1920))
...
@pytest.mark.parametrize('request_type', [compute.SetIamPolicyReservationRequest, dict])
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_set_iam_policy') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_set_iam_policy') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/reservations/{resource}/setIamPolicy' % client.transport._host, args[1])
...
def test_set_iam_policy_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.set_iam_policy(compute.SetIamPolicyReservationRequest(), project='project_value', zone='zone_value', resource='resource_value', zone_set_policy_request_resource=compute.ZoneSetPolicyRequest(bindings=[compute.Binding(binding_id='binding_id_value')]))
...
@pytest.mark.parametrize('request_type', [compute.TestIamPermissionsReservationRequest, dict])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_test_iam_permissions') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_test_iam_permissions') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/reservations/{resource}/testIamPermissions' % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.test_iam_permissions(compute.TestIamPermissionsReservationRequest(), project='project_value', zone='zone_value', resource='resource_value', test_permissions_request_resource=compute.TestPermissionsRequest(permissions=['permissions_value']))
...
def test_update_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('paths', 'requestId', 'updateMask')) & set(('project', 'reservation', 'reservationResource', 'zone'))
...
def test_update_rest_interceptors(null_interceptor):
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ReservationsRestInterceptor())
    client = ReservationsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ReservationsRestInterceptor, 'post_update') as post, mock.patch.object(transports.ReservationsRestInterceptor, 'pre_update') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_bad_request(transport: str='rest', request_type=compute.UpdateReservationRequest):
    if False:
        return 10
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'reservation': 'sample3'}
...
def test_update_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'zone': 'sample2', 'reservation': 'sample3'}
        mock_args = dict(project='project_value', zone='zone_value', reservation='reservation_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_update_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update(compute.UpdateReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
...
def test_update_unary_rest_bad_request(transport: str='rest', request_type=compute.UpdateReservationRequest):
    if False:
        for i in range(10):
            print('nop')
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_unary(compute.UpdateReservationRequest(), project='project_value', zone='zone_value', reservation='reservation_value', reservation_resource=compute.Reservation(commitment='commitment_value'))
...
def test_credentials_transport_error():
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = ReservationsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.ReservationsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = ReservationsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = ReservationsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_reservations_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.reservations.transports.ReservationsTransport.__init__') as Transport:
        ...
        transport = transports.ReservationsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('aggregated_list', 'delete', 'get', 'get_iam_policy', 'insert', 'list', 'resize', 'set_iam_policy', 'test_iam_permissions', 'update')
...
def test_reservations_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.reservations.transports.ReservationsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.ReservationsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_reservations_host_no_port(transport_name):
    if False:
        print('Hello World!')
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_reservations_host_with_port(transport_name):
    if False:
        return 10
    client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_reservations_client_transport_session_collision(transport_name):
    ...
    client1 = ReservationsClient(credentials=creds1, transport=transport_name)
    client2 = ReservationsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ReservationsTransport, '_prep_wrapped_messages') as prep:
        client = ReservationsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(ReservationsClient, transports.ReservationsRestTransport)])
