...
class DefaultTestRenderer(TestRenderer):
    ...
    SUMMARY_PAGE_TEST_STATUS_TO_COLOR_DICT: typing.Dict[TestStatus, Color] = {TestStatus.SKIP: HexColor('A8D5E2'), TestStatus.ERROR: HexColor('#FF9B42'), TestStatus.FAILURE: HexColor('#FF9B42'), TestStatus.SUCCESS: HexColor('#1A936F'), TestStatus.EXPECTED_FAILURE: HexColor('#FF9B42'), TestStatus.UNEXPECTED_SUCCESS: HexColor('#88D498')}
