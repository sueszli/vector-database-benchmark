...
from ..utils import clean_html, determine_ext, dict_get, extract_attributes, ExtractorError, float_or_none, int_or_none, parse_duration, str_or_none, try_get, unified_strdate, url_or_none, urljoin

class XHamsterIE(InfoExtractor):
    _DOMAINS = '(?:xhamster\\.(?:com|one|desi)|xhms\\.pro|xhamster\\d+\\.com|xhday\\.com|xhvid\\.com)'
    _VALID_URL = '(?x)\n                    https?://\n                        (?:[^/?#]+\\.)?%s/\n                        (?:\n                            movies/(?P<id>[\\dA-Za-z]+)/(?P<display_id>[^/]*)\\.html|\n                            videos/(?P<display_id_2>[^/]*)-(?P<id_2>[\\dA-Za-z]+)\n                        )\n                    ' % _DOMAINS
    _TESTS = [{'url': 'https://xhamster.com/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'md5': '34e1ab926db5dc2750fed9e1f34304bb', 'info_dict': {'id': '1509445', 'display_id': 'femaleagent-shy-beauty-takes-the-bait', 'ext': 'mp4', 'title': 'FemaleAgent Shy beauty takes the bait', 'timestamp': 1350194821, 'upload_date': '20121014', 'uploader': 'Ruseful2011', 'uploader_id': 'ruseful2011', 'duration': 893, 'age_limit': 18}}, {'url': 'https://xhamster.com/videos/britney-spears-sexy-booty-2221348?hd=', 'info_dict': {'id': '2221348', 'display_id': 'britney-spears-sexy-booty', 'ext': 'mp4', 'title': 'Britney Spears  Sexy Booty', 'timestamp': 1379123460, 'upload_date': '20130914', 'uploader': 'jojo747400', 'duration': 200, 'age_limit': 18}, 'params': {'skip_download': True}}, {'url': 'http://xhamster.com/movies/5667973/.html', 'info_dict': {'id': '5667973', 'ext': 'mp4', 'title': '....', 'timestamp': 1454948101, 'upload_date': '20160208', 'uploader': 'parejafree', 'uploader_id': 'parejafree', 'duration': 72, 'age_limit': 18}, 'params': {'skip_download': True}}, {'url': 'https://m.xhamster.com/videos/cute-teen-jacqueline-solo-masturbation-8559111', 'only_matching': True}, {'url': 'https://xhamster.com/movies/2272726/amber_slayed_by_the_knight.html', 'only_matching': True}, {'url': 'https://it.xhamster.com/movies/7263980/la_mia_vicina.html', 'only_matching': True}, {'url': 'https://pt.xhamster.com/videos/euro-pedal-pumping-7937821', 'only_matching': True}, {'url': 'https://xhamster.one/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'only_matching': True}, {'url': 'https://xhamster.desi/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'only_matching': True}, {'url': 'https://xhamster2.com/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'only_matching': True}, {'url': 'https://xhamster11.com/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'only_matching': True}, {'url': 'https://xhamster26.com/videos/femaleagent-shy-beauty-takes-the-bait-1509445', 'only_matching': True}, {'url': 'http://xhamster.com/movies/1509445/femaleagent_shy_beauty_takes_the_bait.html', 'only_matching': True}, {'url': 'http://xhamster.com/movies/2221348/britney_spears_sexy_booty.html?hd', 'only_matching': True}, {'url': 'http://de.xhamster.com/videos/skinny-girl-fucks-herself-hard-in-the-forest-xhnBJZx', 'only_matching': True}, {'url': 'https://xhday.com/videos/strapless-threesome-xhh7yVf', 'only_matching': True}, {'url': 'https://xhvid.com/videos/lk-mm-xhc6wn6', 'only_matching': True}]
...
class XHamsterEmbedIE(InfoExtractor):
    _VALID_URL = 'https?://(?:[^/?#]+\\.)?%s/xembed\\.php\\?video=(?P<id>\\d+)' % XHamsterIE._DOMAINS
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>(?:https?:)?//(?:www\\.)?xhamster\\.com/xembed\\.php\\?video=\\d+)\\1']
    _TEST = {'url': 'http://xhamster.com/xembed.php?video=3328539', 'info_dict': {'id': '3328539', 'ext': 'mp4', 'title': 'Pen Masturbation', 'timestamp': 1406581861, 'upload_date': '20140728', 'uploader': 'ManyakisArt', 'duration': 5, 'age_limit': 18}}
...
class XHamsterUserIE(InfoExtractor):
    _VALID_URL = f'https?://(?:[^/?#]+\\.)?{XHamsterIE._DOMAINS}/(?:(?P<user>users)|creators)/(?P<id>[^/?#&]+)'
    _TESTS = [{'url': 'https://xhamster.com/users/netvideogirls/videos', 'info_dict': {'id': 'netvideogirls'}, 'playlist_mincount': 267}, {'url': 'https://xhamster.com/users/firatkaan/videos', 'info_dict': {'id': 'firatkaan'}, 'playlist_mincount': 1}, {'url': 'https://xhamster.com/creators/squirt-orgasm-69', 'info_dict': {'id': 'squirt-orgasm-69'}, 'playlist_mincount': 150}, {'url': 'https://xhday.com/users/mobhunter', 'only_matching': True}, {'url': 'https://xhvid.com/users/pelushe21', 'only_matching': True}]
