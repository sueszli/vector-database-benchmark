...
from tests.integration_tests.superset_test_custom_template_processors import CustomPrestoTemplateProcessor
...
CACHE_CONFIG = {'CACHE_TYPE': 'RedisCache', 'CACHE_DEFAULT_TIMEOUT': int(timedelta(minutes=1).total_seconds()), 'CACHE_KEY_PREFIX': 'superset_cache', 'CACHE_REDIS_URL': f'redis://{REDIS_HOST}:{REDIS_PORT}/{REDIS_CACHE_DB}'}
DATA_CACHE_CONFIG = {**CACHE_CONFIG, 'CACHE_DEFAULT_TIMEOUT': int(timedelta(seconds=30).total_seconds()), 'CACHE_KEY_PREFIX': 'superset_data_cache'}
FILTER_STATE_CACHE_CONFIG = {'CACHE_TYPE': 'SimpleCache', 'CACHE_THRESHOLD': math.inf, 'CACHE_DEFAULT_TIMEOUT': int(timedelta(minutes=10).total_seconds())}
EXPLORE_FORM_DATA_CACHE_CONFIG = {'CACHE_TYPE': 'SimpleCache', 'CACHE_THRESHOLD': math.inf, 'CACHE_DEFAULT_TIMEOUT': int(timedelta(minutes=10).total_seconds())}
...
CUSTOM_TEMPLATE_PROCESSORS = {CustomPrestoTemplateProcessor.engine: CustomPrestoTemplateProcessor}
