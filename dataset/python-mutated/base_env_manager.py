...
from ding.utils import ENV_MANAGER_REGISTRY, import_module, one_time_warning, make_key_as_identifier, WatchDog, remove_illegal_item
...
class BaseEnvManager(object):
    ...
    def default_config(cls: type) -> EasyDict:
        ...
        return cfg
    config = dict(episode_num=float('inf'), max_retry=1, retry_type='reset', auto_reset=True, step_timeout=None, reset_timeout=None, retry_waiting_time=0.1)
...
class BaseEnvManagerV2(BaseEnvManager):
    ...
    .. note::
        For more details about new task pipeline, please refer to the system document of DI-engine         (`system en link <../03_system/index.html>`_).
