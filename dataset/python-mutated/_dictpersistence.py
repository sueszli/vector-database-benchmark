...
class DictPersistence(BasePersistence[Dict[Any, Any], Dict[Any, Any], Dict[Any, Any]]):
    ...
    """
    __slots__ = ('_user_data', '_chat_data', '_bot_data', '_callback_data', '_conversations', '_user_data_json', '_chat_data_json', '_bot_data_json', '_callback_data_json', '_conversations_json')
