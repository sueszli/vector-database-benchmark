...
from routersploit.core.exploit.printer import print_table, print_success, print_status, print_error, color_blue, color_green, color_red
from routersploit.core.exploit.utils import lookup_vendor
