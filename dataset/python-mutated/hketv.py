...
from ..utils import clean_html, ExtractorError, int_or_none, merge_dicts, parse_count, str_or_none, try_get, unified_strdate, urlencode_postdata, urljoin
...
class HKETVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.hkedcity.net/etv/resource/2932360618', 'md5': 'f193712f5f7abb208ddef3c5ea6ed0b7', 'info_dict': {'id': '2932360618', 'ext': 'mp4', 'title': '喜閱一生(共享閱讀樂) (中、英文字幕可供選擇)', 'description': 'md5:d5286d05219ef50e0613311cbe96e560', 'upload_date': '20181024', 'duration': 900, 'subtitles': 'count:2'}, 'skip': 'Geo restricted to HK'}, {'url': 'https://www.hkedcity.net/etv/resource/972641418', 'md5': '1ed494c1c6cf7866a8290edad9b07dc9', 'info_dict': {'id': '972641418', 'ext': 'mp4', 'title': '衣冠楚楚 (天使系列之一)', 'description': 'md5:10bb3d659421e74f58e5db5691627b0f', 'upload_date': '20070109', 'duration': 907, 'subtitles': {}}, 'params': {'geo_verification_proxy': '<HK proxy here>'}, 'skip': 'Geo restricted to HK'}]
    _CC_LANGS = {'中文（繁體中文）': 'zh-Hant', '中文（简体中文）': 'zh-Hans', 'English': 'en', 'Bahasa Indonesia': 'id', 'हिन्दी': 'hi', 'नेपाली': 'ne', 'Tagalog': 'tl', 'ไทย': 'th', 'اردو': 'ur'}
    _FORMAT_HEIGHTS = {'SD': 360, 'HD': 720}
