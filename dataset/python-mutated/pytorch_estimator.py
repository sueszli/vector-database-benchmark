...
if __name__ == '__main__':
    ...
    if args.cluster_mode == 'local':
        ...
        if args.cluster_mode == 'yarn-client':
            ...
            init_orca_context(cluster_mode='yarn-cluster', cores=args.cores, num_nodes=args.num_nodes, memory=args.memory)
        ...
        init_orca_context(cluster_mode='k8s', master=args.k8s_master, container_image=args.container_image, num_nodes=args.num_nodes, cores=args.cores)
