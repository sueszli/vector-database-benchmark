...
from fairseq.models.wav2vec import ConvFeatureExtractionModel, Wav2Vec2Config, TransformerEncoder
...
class Data2VecAudioConfig(Wav2Vec2Config):
    ...
    ema_transformer_only: bool = field(default=True, metadata={'help': 'whether to momentum update only the transformer'})
    ema_layers_only: bool = field(default=True, metadata={'help': 'whether to momentum update only the transformer layers'})
