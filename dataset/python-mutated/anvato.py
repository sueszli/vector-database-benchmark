...
from ..utils import bytes_to_intlist, determine_ext, int_or_none, intlist_to_bytes, join_nonempty, smuggle_url, strip_jsonp, traverse_obj, unescapeHTML, unsmuggle_url
...
class AnvatoIE(InfoExtractor):
    ...
    _TOKEN_GENERATORS = {'GXvEgwyJeWem8KCYXfeoHWknwP48Mboj': _generate_nfl_token}
