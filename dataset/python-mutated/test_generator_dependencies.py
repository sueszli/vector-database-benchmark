...
@pytest.mark.parametrize('dependency_fixture', ['generator_dependency', 'async_generator_dependency'])
async def test_generator_dependency_websocket(request: FixtureRequest, dependency_fixture: str, cleanup_mock: MagicMock, exception_mock: MagicMock, finally_mock: MagicMock) -> None:
    dependency = request.getfixturevalue(dependency_fixture)
