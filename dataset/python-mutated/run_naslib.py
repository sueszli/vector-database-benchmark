...
def run(args: argparse.Namespace) -> None:
    ...
    for filename in [study_json_filename, solvers_filename, problems_filename]:
        with open(filename, 'w'):
            pass
    searchspace_datasets = ['nasbench201 cifar10', 'nasbench201 cifar100', 'nasbench201 ImageNet16-120']
    for searchspace_dataset in searchspace_datasets:
        python_command = f'benchmarks/naslib/problem.py {searchspace_dataset}'
        cmd = f'{kurobako_cmd} problem command python3 {python_command}| tee -a {problems_filename}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sampler-kwargs-list', type=str, default='{} {\\"multivariate\\":true\\,\\"constant_liar\\":true}')
