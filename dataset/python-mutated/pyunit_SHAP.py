                ...
                if col not in train_df.columns:
                    ...
                    if contr_df.loc[row_in_contr, col] != 0:
                        if val_eq(test_df.loc[ts, col_name], train_df.loc[tr, col_name]):
                            ...
                            assert False
                        if not val_eq(test_df.loc[ts, col_name], cat) and (not (cat == 'missing(NA)' and (pd.isna(test_df.loc[ts, col_name]) or pd.isna(train_df.loc[tr, col_name])))) and (not val_eq(train_df.loc[tr, col_name], cat)):
...
TESTS = [test_drf_binomial_compact, test_drf_regression_original, test_xrt_binomial_original, test_xrt_regression_compact, test_gbm_binomial_compact, test_gbm_regression_original, test_xgboost_binomial_original, test_xgboost_regression_compact, test_glm_binomial_compact, test_glm_regression_original, test_glm_not_standardized_binomial_original, test_glm_not_standardized_regression_original, test_glm_not_regularized_binomial_compact, test_glm_not_regularized_regression_compact, test_deeplearning_5hidden_tanh_regression_original, test_deeplearning_5hidden_tanh_regression_compact, test_deeplearning_5hidden_tanh_binomial_original, test_deeplearning_5hidden_tanh_binomial_compact, test_deeplearning_5hidden_tanh_with_dropout_regression_original, test_deeplearning_5hidden_tanh_with_dropout_regression_compact, test_deeplearning_5hidden_tanh_with_dropout_binomial_original, test_deeplearning_5hidden_tanh_with_dropout_binomial_compact, test_deeplearning_5hidden_relu_regression_original, test_deeplearning_5hidden_relu_regression_compact, test_deeplearning_5hidden_relu_binomial_original, test_deeplearning_5hidden_relu_binomial_compact, test_deeplearning_5hidden_relu_with_dropout_regression_original, test_deeplearning_5hidden_relu_with_dropout_regression_compact, test_deeplearning_5hidden_relu_with_dropout_binomial_original, test_deeplearning_5hidden_relu_with_dropout_binomial_compact, test_deeplearning_5hidden_maxout_regression_original, test_deeplearning_5hidden_maxout_regression_compact, test_deeplearning_5hidden_maxout_binomial_original, test_deeplearning_5hidden_maxout_binomial_compact, test_deeplearning_5hidden_maxout_with_dropout_regression_original, test_deeplearning_5hidden_maxout_with_dropout_regression_compact, test_deeplearning_5hidden_maxout_with_dropout_binomial_original, test_deeplearning_5hidden_maxout_with_dropout_binomial_compact, test_se_gaussian_linear_models_exact_original, test_se_gaussian_linear_models_exact_compact, test_se_all_models_with_default_config_binomial_original, test_se_all_models_with_default_config_binomial_compact, test_se_all_models_with_default_config_binomial_with_logit_transform_original, test_se_all_models_with_default_config_binomial_with_logit_transform_compact, test_se_all_models_with_default_config_regression_original, test_se_all_models_with_default_config_regression_compact]
