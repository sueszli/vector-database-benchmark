...
DEFAULT_ENV_VARS = {'PL_DISABLE_FORK': '1'}
ENV_VARS_TO_PROPAGATE = {COPY_DIRECTORY_CHECKPOINTS_INSTEAD_OF_MOVING_ENV, RAY_CHDIR_TO_TRIAL_DIR, 'TUNE_CHECKPOINT_CLOUD_RETRY_NUM', 'TUNE_CHECKPOINT_CLOUD_RETRY_WAIT_TIME_S', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY', 'AWS_SECURITY_TOKEN', 'AWS_SESSION_TOKEN'}
