...
SPAN_PERFORMANCE_COLUMNS: Dict[str, SpanPerformanceColumn] = {'count': SpanPerformanceColumn(['count()', 'sumArray(spans_exclusive_time)'], ['count()', 'sumArray(spans_exclusive_time)'], ['count', 'sum']), 'avgOccurrence': SpanPerformanceColumn(['count()', 'count_unique(id)', 'equation|count() / count_unique(id)', 'sumArray(spans_exclusive_time)'], ['equation[0]', 'sumArray(spans_exclusive_time)'], ['count', 'sum']), 'sumExclusiveTime': SpanPerformanceColumn(['sumArray(spans_exclusive_time)'], ['sumArray(spans_exclusive_time)'], ['sum']), 'p50ExclusiveTime': SpanPerformanceColumn(['percentileArray(spans_exclusive_time, 0.50)'], ['percentileArray(spans_exclusive_time, 0.50)'], ['max']), 'p75ExclusiveTime': SpanPerformanceColumn(['percentileArray(spans_exclusive_time, 0.75)'], ['percentileArray(spans_exclusive_time, 0.75)'], ['max']), 'p95ExclusiveTime': SpanPerformanceColumn(['percentileArray(spans_exclusive_time, 0.95)'], ['percentileArray(spans_exclusive_time, 0.95)'], ['max']), 'p99ExclusiveTime': SpanPerformanceColumn(['percentileArray(spans_exclusive_time, 0.99)'], ['percentileArray(spans_exclusive_time, 0.99)'], ['max'])}
...
class SpansPerformanceSerializer(serializers.Serializer):
    ...
    spanOp = serializers.ListField(child=serializers.CharField(), required=False, allow_null=True, max_length=5)
    excludeSpanOp = serializers.ListField(child=serializers.CharField(), required=False, allow_null=True, max_length=5)
    spanGroup = serializers.ListField(child=serializers.CharField(), required=False, allow_null=True, max_length=4)
