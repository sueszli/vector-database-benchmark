...
import pendulum
import pytest
from dagster import AssetIn, AssetKey, DagsterEventType, DailyPartitionsDefinition, DimensionPartitionMapping, DynamicPartitionsDefinition, EventRecordsFilter, IdentityPartitionMapping, IOManager, MultiPartitionKey, StaticPartitionsDefinition, asset, define_asset_job, materialize, repository
...
def test_tags_multi_dimensional_partitions():
    ...
    with instance_for_test() as instance:
        ...
        assert len(materializations) == 1
multipartitions_def = MultiPartitionsDefinition({'date': DailyPartitionsDefinition(start_date='2015-01-01'), 'static': StaticPartitionsDefinition(['a', 'b', 'c', 'd'])})
