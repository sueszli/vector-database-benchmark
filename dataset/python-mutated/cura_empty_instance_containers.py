...
ALL_EMPTY_CONTAINER_ID_SET = {EMPTY_CONTAINER_ID, EMPTY_DEFINITION_CHANGES_CONTAINER_ID, EMPTY_VARIANT_CONTAINER_ID, EMPTY_MATERIAL_CONTAINER_ID, EMPTY_QUALITY_CONTAINER_ID, EMPTY_QUALITY_CHANGES_CONTAINER_ID, EMPTY_INTENT_CONTAINER_ID}
...
__all__ = ['EMPTY_CONTAINER_ID', 'empty_container', 'EMPTY_DEFINITION_CHANGES_CONTAINER_ID', 'empty_definition_changes_container', 'EMPTY_VARIANT_CONTAINER_ID', 'empty_variant_container', 'EMPTY_MATERIAL_CONTAINER_ID', 'empty_material_container', 'EMPTY_QUALITY_CHANGES_CONTAINER_ID', 'empty_quality_changes_container', 'EMPTY_QUALITY_CONTAINER_ID', 'empty_quality_container', 'ALL_EMPTY_CONTAINER_ID_SET', 'isEmptyContainer', 'EMPTY_INTENT_CONTAINER_ID', 'empty_intent_container']