import pytest
from scripts.check_for_inconsistent_pandas_namespace import check_for_inconsistent_pandas_namespace
BAD_FILE_0 = 'from pandas import Categorical\ncat_0 = Categorical()\ncat_1 = pd.Categorical()'
BAD_FILE_1 = 'from pandas import Categorical\ncat_0 = pd.Categorical()\ncat_1 = Categorical()'
BAD_FILE_2 = 'from pandas import Categorical\ncat_0 = pandas.Categorical()\ncat_1 = Categorical()'
