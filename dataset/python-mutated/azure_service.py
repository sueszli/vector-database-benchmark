...
__protobuf__ = proto.module(package='google.cloud.gkemulticloud.v1', manifest={'CreateAzureClusterRequest', 'UpdateAzureClusterRequest', 'GetAzureClusterRequest', 'ListAzureClustersRequest', 'ListAzureClustersResponse', 'DeleteAzureClusterRequest', 'CreateAzureNodePoolRequest', 'UpdateAzureNodePoolRequest', 'GetAzureNodePoolRequest', 'ListAzureNodePoolsRequest', 'ListAzureNodePoolsResponse', 'DeleteAzureNodePoolRequest', 'GetAzureServerConfigRequest', 'CreateAzureClientRequest', 'GetAzureClientRequest', 'ListAzureClientsRequest', 'ListAzureClientsResponse', 'DeleteAzureClientRequest', 'GenerateAzureAccessTokenRequest', 'GenerateAzureAccessTokenResponse'})
...
class CreateAzureClusterRequest(proto.Message):
    ...
    azure_cluster: azure_resources.AzureCluster = proto.Field(proto.MESSAGE, number=2, message=azure_resources.AzureCluster)
    azure_cluster_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateAzureClusterRequest(proto.Message):
    ...
    """
    azure_cluster: azure_resources.AzureCluster = proto.Field(proto.MESSAGE, number=1, message=azure_resources.AzureCluster)
...
class ListAzureClustersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    azure_clusters: MutableSequence[azure_resources.AzureCluster] = proto.RepeatedField(proto.MESSAGE, number=1, message=azure_resources.AzureCluster)
...
class CreateAzureNodePoolRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    azure_node_pool: azure_resources.AzureNodePool = proto.Field(proto.MESSAGE, number=2, message=azure_resources.AzureNodePool)
    azure_node_pool_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateAzureNodePoolRequest(proto.Message):
    ...
    """
    azure_node_pool: azure_resources.AzureNodePool = proto.Field(proto.MESSAGE, number=1, message=azure_resources.AzureNodePool)
    validate_only: bool = proto.Field(proto.BOOL, number=2)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    azure_node_pools: MutableSequence[azure_resources.AzureNodePool] = proto.RepeatedField(proto.MESSAGE, number=1, message=azure_resources.AzureNodePool)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class GetAzureServerConfigRequest(proto.Message):
    """GetAzureServerConfigRequest gets the server config of GKE
    cluster on Azure.
...
class CreateAzureClientRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    azure_client: azure_resources.AzureClient = proto.Field(proto.MESSAGE, number=2, message=azure_resources.AzureClient)
    azure_client_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=3)
...
class ListAzureClientsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    azure_clients: MutableSequence[azure_resources.AzureClient] = proto.RepeatedField(proto.MESSAGE, number=1, message=azure_resources.AzureClient)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class GenerateAzureAccessTokenRequest(proto.Message):
    ...
    Attributes:
        azure_cluster (str):
            ...
            for more details on Google Cloud resource names.
    """
    azure_cluster: str = proto.Field(proto.STRING, number=1)
...
class GenerateAzureAccessTokenResponse(proto.Message):
    ...
    expiration_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
