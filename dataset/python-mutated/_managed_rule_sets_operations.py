...
class ManagedRuleSetsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable['_models.ManagedRuleSetDefinition']:
        if False:
            return 10
        'Lists all available managed rule sets.\n\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: An iterator like instance of either ManagedRuleSetDefinition or the result of\n         cls(response)\n        :rtype:\n         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cdn.models.ManagedRuleSetDefinition]\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
        ...
        async def extract_data(pipeline_response):
            deserialized = self._deserialize('ManagedRuleSetDefinitionList', pipeline_response)
