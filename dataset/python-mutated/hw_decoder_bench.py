...
parser.add_argument('-n', dest='gpu_num', help='Number of GPUs used starting from device_id', default=1, type=int)
parser.add_argument('-g', dest='device', choices=['gpu', 'cpu'], help='device to use', default='gpu', type=str)
...
parser.add_argument('-p', dest='pipeline', choices=['decoder', 'rn50', 'efficientnet_inference', 'vit'], help='pipeline to test', default='decoder', type=str)
