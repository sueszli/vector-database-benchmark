...
from typing import TYPE_CHECKING, AbstractSet, Dict, FrozenSet, NamedTuple, Optional, Sequence, Set, Tuple, cast
import dagster._check as check
from dagster._core.definitions.events import AssetKey, AssetKeyPartitionKey
from dagster._serdes.serdes import NamedTupleSerializer, UnpackContext, UnpackedValue, WhitelistMap, whitelist_for_serdes
...
@whitelist_for_serdes
class TextRuleEvaluationData(AutoMaterializeRuleEvaluationData, NamedTuple('_TextRuleEvaluationData', [('text', str)])):
    pass

@whitelist_for_serdes
class ParentUpdatedRuleEvaluationData(AutoMaterializeRuleEvaluationData, NamedTuple('_ParentUpdatedRuleEvaluationData', [('updated_asset_keys', FrozenSet[AssetKey]), ('will_update_asset_keys', FrozenSet[AssetKey])])):
    pass

@whitelist_for_serdes
class WaitingOnAssetsRuleEvaluationData(AutoMaterializeRuleEvaluationData, NamedTuple('_WaitingOnParentRuleEvaluationData', [('waiting_on_asset_keys', FrozenSet[AssetKey])])):
    pass
...
class AutoMaterializeAssetEvaluation(NamedTuple):
    ...
    """
    asset_key: AssetKey
    partition_subsets_by_condition: Sequence[Tuple['AutoMaterializeRuleEvaluation', Optional[SerializedPartitionsSubset]]]
    num_requested: int
    num_skipped: int
    num_discarded: int
    run_ids: Set[str] = set()
