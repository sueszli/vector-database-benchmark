...
from ..utils import determine_ext, extract_attributes, ExtractorError, int_or_none, parse_qs, smuggle_url, unescapeHTML, unsmuggle_url
...
class GlomexIE(GlomexBaseIE):
    ...
    _TESTS = [{'url': 'https://video.glomex.com/sport/v-cb24uwg77hgh-nach-2-0-sieg-guardiola-mit-mancity-vor-naechstem-titel', 'md5': 'cec33a943c4240c9cb33abea8c26242e', 'info_dict': {'id': 'v-cb24uwg77hgh', 'ext': 'mp4', 'title': 'md5:38a90cedcfadd72982c81acf13556e0c', 'description': 'md5:1ea6b6caff1443fcbbba159e432eedb8', 'duration': 29600, 'timestamp': 1619895017, 'upload_date': '20210501'}}]
