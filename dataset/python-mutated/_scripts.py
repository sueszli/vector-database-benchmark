...
class ScriptsProxy(object):
    ...
    async def get_stored_procedure(self, sproc: Union[str, Dict[str, Any]], **kwargs: Any) -> Dict[str, Any]:
        ...
        return await self.client_connection.ReadStoredProcedure(sproc_link=self._get_resource_link(sproc, ScriptType.StoredProcedure), options=request_options, **kwargs)
    ...
    async def create_stored_procedure(self, body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.CreateStoredProcedure(collection_link=self.container_link, sproc=body, options=request_options, **kwargs)

    @distributed_trace_async
    async def replace_stored_procedure(self, sproc: Union[str, Dict[str, Any]], body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.ReplaceStoredProcedure(sproc_link=self._get_resource_link(sproc, ScriptType.StoredProcedure), sproc=body, options=request_options, **kwargs)
    ...
    async def delete_stored_procedure(self, sproc: Union[str, Dict[str, Any]], **kwargs: Any) -> None:
        ...
        """
        request_options = _build_options(kwargs)
        await self.client_connection.DeleteStoredProcedure(sproc_link=self._get_resource_link(sproc, ScriptType.StoredProcedure), options=request_options, **kwargs)

    @distributed_trace_async
    async def execute_stored_procedure(self, sproc: Union[str, Dict[str, Any]], **kwargs: Any) -> Dict[str, Any]:
        ...
        if partition_key is not None:
            request_options['partitionKey'] = _CosmosClientConnection._return_undefined_or_empty_partition_key(await self.container_proxy.is_system_key) if partition_key == NonePartitionKeyValue else partition_key
        ...
        parameters = kwargs.pop('parameters', None)
        return await self.client_connection.ExecuteStoredProcedure(sproc_link=self._get_resource_link(sproc, ScriptType.StoredProcedure), params=parameters, options=request_options, **kwargs)
    ...
    async def get_trigger(self, trigger: Union[str, Dict[str, Any]], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.ReadTrigger(trigger_link=self._get_resource_link(trigger, ScriptType.Trigger), options=request_options, **kwargs)
    ...
    async def create_trigger(self, body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.CreateTrigger(collection_link=self.container_link, trigger=body, options=request_options, **kwargs)

    @distributed_trace_async
    async def replace_trigger(self, trigger: Union[str, Dict[str, Any]], body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.ReplaceTrigger(trigger_link=self._get_resource_link(trigger, ScriptType.Trigger), trigger=body, options=request_options, **kwargs)
    ...
    async def delete_trigger(self, trigger: Union[str, Dict[str, Any]], **kwargs: Any) -> None:
        ...
        """
        request_options = _build_options(kwargs)
        await self.client_connection.DeleteTrigger(trigger_link=self._get_resource_link(trigger, ScriptType.Trigger), options=request_options, **kwargs)
    ...
    async def get_user_defined_function(self, udf: Union[str, Dict[str, Any]], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.ReadUserDefinedFunction(udf_link=self._get_resource_link(udf, ScriptType.UserDefinedFunction), options=request_options, **kwargs)
    ...
    async def create_user_defined_function(self, body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.CreateUserDefinedFunction(collection_link=self.container_link, udf=body, options=request_options, **kwargs)

    @distributed_trace_async
    async def replace_user_defined_function(self, udf: Union[str, Dict[str, Any]], body: Dict[str, Any], **kwargs: Any) -> Dict[str, Any]:
        ...
        """
        request_options = _build_options(kwargs)
        return await self.client_connection.ReplaceUserDefinedFunction(udf_link=self._get_resource_link(udf, ScriptType.UserDefinedFunction), udf=body, options=request_options, **kwargs)
    ...
    async def delete_user_defined_function(self, udf: Union[str, Dict[str, Any]], **kwargs: Any) -> None:
        ...
        """
        request_options = _build_options(kwargs)
        await self.client_connection.DeleteUserDefinedFunction(udf_link=self._get_resource_link(udf, ScriptType.UserDefinedFunction), options=request_options, **kwargs)