...
from sentry.api.endpoints.organization_profiling_functions import TOP_FUNCTIONS_LIMIT, get_rollup_from_range
...
PROFILING_FEATURES = {'organizations:profiling-global-suspect-functions': True}
