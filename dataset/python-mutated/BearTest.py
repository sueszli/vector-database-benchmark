...
from coalib.bears.Bear import Bear, Debugger, _setting_is_enabled, _is_debugged, _is_profiled
...
class aspectsTestBear(Bear, aspects={'detect': [CommitMessage.Shortlog.ColonExistence], 'fix': [CommitMessage.Shortlog.TrailingPeriod]}, languages=['Python', 'C#']):
    pass

class aspectsDetectOnlyTestBear(Bear, aspects={'detect': [CommitMessage.Shortlog.ColonExistence]}, languages=['Python']):
    pass

class aspectsFixOnlyTestBear(Bear, aspects={'fix': [CommitMessage.Shortlog.TrailingPeriod]}, languages=['Python']):
    pass
