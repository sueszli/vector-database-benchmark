...
from .generators.extraction_distribution_model_flow25 import Generator as Generator
...
@MODELS.register_module(Tasks.human_image_generation, module_name=Models.human_image_generation)
