...
from ray.train.lightning._lightning_utils import RayDataModule, RayDDPStrategy, RayDeepSpeedStrategy, RayFSDPStrategy, RayLightningEnvironment, RayModelCheckpoint, import_lightning, prepare_trainer
...
pl = import_lightning()
LIGHTNING_CONFIG_BUILDER_DEPRECATION_MESSAGE = 'The LightningConfigBuilder will be hard deprecated in Ray 2.8. Use `ray.train.TorchTrainer` instead. See https://docs.ray.io/en/releases-2.7.0/train/getting-started-pytorch-lightning.html#lightningtrainer-migration-guide for more details.'
...
class LightningConfigBuilder:
    ...
    def build(self) -> Dict['str', Any]:
        ...
        return config_dict
LIGHTNING_TRAINER_DEPRECATION_MESSAGE = 'The LightningTrainer is hard deprecated in Ray 2.8. Use `ray.train.TorchTrainer` instead. See https://docs.ray.io/en/releases-2.7.0/train/getting-started-pytorch-lightning.html#lightningtrainer-migration-guide for more details.'
