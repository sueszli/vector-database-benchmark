...
CONST_RECORD_ALIGN = np.array([(1, 2, 3, 3735928559, 8), (4, 5, 6, 3203391149, 10)], dtype=np.dtype(dtype=[('a', np.uint8), ('b', np.uint8), ('x', np.uint8), ('y', np.uint32), ('z', np.uint8)], align=True))
