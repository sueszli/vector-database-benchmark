...
settings = {'standardize_tracks': False, 'standardize_artists': False, 'standardize_releases': False, 'translate_artist_names': True, 'artist_locales': ['en'], 'translate_artist_names_script_exception': False}
