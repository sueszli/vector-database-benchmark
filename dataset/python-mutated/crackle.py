...
from ..utils import determine_ext, float_or_none, int_or_none, orderedSet, parse_age_limit, parse_duration, url_or_none, ExtractorError

class CrackleIE(InfoExtractor):
    _VALID_URL = '(?:crackle:|https?://(?:(?:www|m)\\.)?(?:sony)?crackle\\.com/(?:playlist/\\d+/|(?:[^/]+/)+))(?P<id>\\d+)'
    _TESTS = [{'url': 'https://www.crackle.com/thanksgiving/2510064', 'info_dict': {'id': '2510064', 'ext': 'mp4', 'title': 'Touch Football', 'description': 'md5:cfbb513cf5de41e8b56d7ab756cff4df', 'duration': 1398, 'view_count': int, 'average_rating': 0, 'age_limit': 17, 'genre': 'Comedy', 'creator': 'Daniel Powell', 'artist': 'Chris Elliott, Amy Sedaris', 'release_year': 2016, 'series': 'Thanksgiving', 'episode': 'Touch Football', 'season_number': 1, 'episode_number': 1}, 'params': {'skip_download': True}, 'expected_warnings': ['Trying with a list of known countries']}, {'url': 'https://www.sonycrackle.com/thanksgiving/2510064', 'only_matching': True}]
    _MEDIA_FILE_SLOTS = {'360p.mp4': {'width': 640, 'height': 360}, '480p.mp4': {'width': 768, 'height': 432}, '480p_1mbps.mp4': {'width': 852, 'height': 480}}
