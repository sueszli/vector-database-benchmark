...
PACKAGE_NAME_LIST = ['ansible', 'awscli', 'b2', 'beancount', 'beets', 'black', 'cactus', 'chert', 'cloudtoken', 'coala', 'cookiecutter', 'cython', 'datasette', 'diffoscope', 'doc2dash', 'doitlive', 'gdbgui', 'gns3-gui', 'grow', 'guake', 'gunicorn', 'howdoi', 'httpie', 'hyde', 'ipython', 'isort', 'zest-releaser', 'kaggle', 'kibitzr', 'klaus', 'kolibri', 'lektor', 'localstack', 'mackup', 'magic-wormhole', 'mayan-edms', 'mkdocs', 'mycli', 'nikola', 'nox', 'pelican', 'platformio', 'ppci', 'prosopopee', 'ptpython', 'pycowsay', 'pylint', 'retext', 'robotframework', 'shell-functools', 'speedtest-cli', 'sphinx', 'sqlmap', 'streamlink', 'taguette', 'term2048', 'tox-ini-fmt', 'visidata', 'vulture', 'weblate', 'youtube-dl', 'zeo']
