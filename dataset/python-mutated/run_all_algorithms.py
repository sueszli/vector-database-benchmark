...
if __name__ == '__main__':
    ...
    recommender_class_list = [Random, TopPop, GlobalEffects, SLIMElasticNetRecommender, UserKNNCFRecommender, IALSRecommender, MatrixFactorization_BPR_Cython, MatrixFactorization_FunkSVD_Cython, MatrixFactorization_AsySVD_Cython, EASE_R_Recommender, ItemKNNCFRecommender, P3alphaRecommender, SLIM_BPR_Cython, RP3betaRecommender, PureSVDRecommender, NMFRecommender, UserKNNCBFRecommender, ItemKNNCBFRecommender, UserKNN_CFCBF_Hybrid_Recommender, ItemKNN_CFCBF_Hybrid_Recommender, LightFMCFRecommender, LightFMUserHybridRecommender, LightFMItemHybridRecommender]
    evaluator = EvaluatorHoldout(URM_test, [5, 20], exclude_seen=True)
    earlystopping_keywargs = {'validation_every_n': 5, 'stop_on_validation': True, 'evaluator_object': EvaluatorHoldout(URM_validation, [20], exclude_seen=True), 'lower_validations_allowed': 5, 'validation_metric': 'MAP'}
