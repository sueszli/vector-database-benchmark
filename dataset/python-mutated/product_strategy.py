...
class PutAwayStrategy(models.Model):
    ...
    fixed_location_ids = fields.One2many('stock.fixed.putaway.strat', 'putaway_id', 'Fixed Locations Per Product Category', copy=True, help='When the method is fixed, this location will be used to store the products')
