...
if __name__ == '__main__':
    ...
    if args.streaming:
        benchmark.run_fn('streaming-ingest', run_ingest_streaming, args.dataset_size_gb, args.num_workers, args.use_gpu, args.early_stop)
    else:
        benchmark.run_fn('bulk-ingest', run_ingest_bulk, args.dataset_size_gb, args.num_workers)
