...
__all__ = ['TranslationAndMat3x3', 'TranslationAndMat3x3ArrayLike', 'TranslationAndMat3x3Batch', 'TranslationAndMat3x3Like', 'TranslationAndMat3x3Type']
...
class TranslationAndMat3x3(TranslationAndMat3x3Ext):
    ...
    **Datatype**: Representation of an affine transform via a 3x3 affine matrix paired with a translation.
    ...
    mat3x3: datatypes.Mat3x3 | None = field(default=None, converter=_translation_and_mat3x3__mat3x3__special_field_converter_override)
TranslationAndMat3x3Like = TranslationAndMat3x3
TranslationAndMat3x3ArrayLike = Union[TranslationAndMat3x3, Sequence[TranslationAndMat3x3Like]]
