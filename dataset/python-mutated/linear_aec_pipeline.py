...
@PIPELINES.register_module(Tasks.acoustic_echo_cancellation, module_name=Pipelines.speech_dfsmn_aec_psm_16k)
class LinearAECPipeline(Pipeline):
    """AEC Inference Pipeline only support 16000 sample rate.
