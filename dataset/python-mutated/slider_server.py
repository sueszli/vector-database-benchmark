...
plot_figure = figure(title='Slider', height=450, width=600, tools='save,reset', toolbar_location='below')
plot_figure.line('x', 'y', line_width=3, source=source)
slider = Slider(start=0.1, end=10, value=1, step=0.1, title='Change Frequency')
