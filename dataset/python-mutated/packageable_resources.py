...
from samcli.lib.package.utils import copy_to_temp_dir, is_ecr_url, is_local_file, is_path_value_valid, is_s3_protocol_url, is_zip_file, resource_not_packageable, upload_local_artifacts, upload_local_image_artifacts
from samcli.lib.utils import graphql_api
from samcli.lib.utils.packagetype import IMAGE, ZIP
from samcli.lib.utils.resources import AWS_APIGATEWAY_RESTAPI, AWS_APIGATEWAY_V2_API, AWS_APPSYNC_FUNCTIONCONFIGURATION, AWS_APPSYNC_GRAPHQLSCHEMA, AWS_APPSYNC_RESOLVER, AWS_CLOUDFORMATION_MODULEVERSION, AWS_CLOUDFORMATION_RESOURCEVERSION, AWS_ECR_REPOSITORY, AWS_ELASTICBEANSTALK_APPLICATIONVERSION, AWS_GLUE_JOB, AWS_LAMBDA_FUNCTION, AWS_LAMBDA_LAYERVERSION, AWS_SERVERLESS_API, AWS_SERVERLESS_FUNCTION, AWS_SERVERLESS_GRAPHQLAPI, AWS_SERVERLESS_HTTPAPI, AWS_SERVERLESS_LAYERVERSION, AWS_SERVERLESS_STATEMACHINE, AWS_SERVERLESSREPO_APPLICATION, AWS_STEPFUNCTIONS_STATEMACHINE, METADATA_WITH_LOCAL_PATHS, RESOURCES_WITH_IMAGE_COMPONENT, RESOURCES_WITH_LOCAL_PATHS
    ...
    def export(self, resource_id: str, resource_dict: Optional[Dict], parent_dir: str):
        ...
        for (property_path, property_value) in paths_values:
            ...
            try:
                ...
                if temp_dir:
                    shutil.rmtree(temp_dir)
RESOURCES_EXPORT_LIST = [ServerlessFunctionResource, ServerlessFunctionImageResource, ServerlessApiResource, ServerlessHttpApiResource, ServerlessStateMachineResource, GraphQLSchemaResource, AppSyncResolverRequestTemplateResource, AppSyncResolverResponseTemplateResource, AppSyncResolverCodeResource, AppSyncFunctionConfigurationRequestTemplateResource, AppSyncFunctionConfigurationResponseTemplateResource, AppSyncFunctionConfigurationCodeResource, ApiGatewayRestApiResource, ApiGatewayV2Resource, StepFunctionsStateMachineResource, LambdaFunctionResource, LambdaFunctionImageResource, ElasticBeanstalkApplicationVersion, ServerlessLayerVersionResource, LambdaLayerVersionResource, GlueJobCommandScriptLocationResource, CloudFormationModuleVersionModulePackage, CloudFormationResourceVersionSchemaHandlerPackage, ECRResource, GraphQLApiSchemaResource, GraphQLApiCodeResource]
