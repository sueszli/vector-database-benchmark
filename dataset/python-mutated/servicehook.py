...
from sentry.db.models import ArrayField, BaseManager, BoundedPositiveIntegerField, FlexibleForeignKey, Model, region_silo_only_model, sane_repr
from sentry.db.models.fields.bounded import BoundedBigIntegerField
from sentry.db.models.fields.hybrid_cloud_foreign_key import HybridCloudForeignKey
from sentry.services.hybrid_cloud.app import app_service
SERVICE_HOOK_EVENTS = ['event.alert', 'event.created']
...
class ServiceHook(Model):
    ...
    installation_id = HybridCloudForeignKey('sentry.SentryAppInstallation', null=True, on_delete='CASCADE')
