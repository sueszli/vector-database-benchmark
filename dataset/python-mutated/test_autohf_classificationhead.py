from utils import get_toy_data_regression, get_toy_data_binclassification, get_toy_data_multiclassclassification, get_automl_settings
import sys
import pytest
import os
import shutil
data_list = ['get_toy_data_regression', 'get_toy_data_binclassification', 'get_toy_data_multiclassclassification']
model_path_list = ['textattack/bert-base-uncased-STS-B', 'textattack/bert-base-uncased-SST-2', 'textattack/bert-base-uncased-MNLI']
