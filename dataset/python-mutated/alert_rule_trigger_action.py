...
from sentry.incidents.logic import InvalidTriggerActionError, create_alert_rule_trigger_action, update_alert_rule_trigger_action
from sentry.incidents.models import AlertRuleTriggerAction
from sentry.incidents.serializers import ACTION_TARGET_TYPE_TO_STRING, STRING_TO_ACTION_TARGET_TYPE, STRING_TO_ACTION_TYPE
...
class AlertRuleTriggerActionSerializer(CamelSnakeModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'type', 'target_type', 'target_identifier', 'integration', 'sentry_app', 'sentry_app_config', 'sentry_app_installation_uuid']
        extra_kwargs = {'target_identifier': {'required': True}, 'target_display': {'required': False}, 'integration': {'required': False, 'allow_null': True}, 'sentry_app': {'required': False, 'allow_null': True}, 'sentry_app_config': {'required': False, 'allow_null': True}, 'sentry_app_installation_uuid': {'required': False, 'allow_null': True}}
