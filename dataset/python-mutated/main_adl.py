...
optimizer = optim.SGD([{'params': [param]} for param in net.parameters()], lr=args.lr, momentum=0.9, weight_decay=0.0005)
...
tensorboard_dir = os.path.join(os.getenv('ADAPTDL_TENSORBOARD_LOGDIR', '/adaptdl/tensorboard'), os.getenv('NNI_TRIAL_JOB_ID', 'cifar-adaptdl'))
