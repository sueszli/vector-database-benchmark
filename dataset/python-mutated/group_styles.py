...
class GroupStyles:
    ...
    def __initiate_values(self):
        ...
        self.__end_list = ['mi<mk<sect-close', 'mi<mk<sect-start', 'mi<mk<tabl-start', 'mi<mk<fldbk-end_', 'mi<mk<fldbkstart', 'mi<mk<close_cell', 'mi<tg<item_end__', 'mi<mk<foot___clo', 'mi<mk<footnt-ope', 'mi<mk<header-beg', 'mi<mk<header-end', 'mi<mk<head___clo', 'mi<tg<item_end__', 'mi<tg<item_end__', 'mi<mk<list_start']
