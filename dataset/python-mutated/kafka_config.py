...
SUPPORTED_KAFKA_CONFIGURATION = ('bootstrap.servers', 'compression.type', 'message.max.bytes', 'sasl.mechanism', 'sasl.username', 'sasl.password', 'security.protocol', 'socket.timeout.ms', 'ssl.ca.location', 'ssl.ca.certificate.stores', 'ssl.certificate.location', 'ssl.certificate.pem', 'ssl.cipher.suites', 'ssl.crl.location', 'ssl.curves.list', 'ssl.endpoint.identification.algorithm', 'ssl.key.location', 'ssl.key.password', 'ssl.key.pem', 'ssl.keystore.location', 'ssl.keystore.password', 'ssl.sigalgs.list')
