...
class _LinearBase(state.HasState):
    ...
    limits = traitlets.List(traitlets.List(traitlets.CFloat(), allow_none=True), allow_none=True).tag(output=True)
    fit_intercept = traitlets.CBool(True)
    coef_ = traitlets.Union([traitlets.List(traitlets.CFloat()), traitlets.List(traitlets.List(traitlets.CFloat()))]).tag(output=True)
    intercept_ = traitlets.Union([traitlets.CFloat(), traitlets.List(traitlets.CFloat())]).tag(output=True)
