...
from .StatementBasesGenerated import StatementLocalsDictOperationSetBase, StatementSetLocalsBase, StatementSetLocalsDictionaryBase
...
class ExpressionLocalsVariableRefOrFallback(ChildHavingFallbackMixin, ExpressionBase):
    ...
    may_raise_access = python_version >= 768
...
class StatementLocalsDictOperationDel(StatementBase):
    ...
    __slots__ = ('variable', 'variable_version', 'previous_trace', 'locals_scope', 'tolerant')
    may_raise_del = python_version >= 768
...
class StatementSetLocalsDictionary(StatementSetLocalsMixin, StatementSetLocalsDictionaryBase):
