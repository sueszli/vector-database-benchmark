...
import proto
__protobuf__ = proto.module(package='google.cloud.resourcemanager.v3', manifest={'Purpose', 'TagKey', 'ListTagKeysRequest', 'ListTagKeysResponse', 'GetTagKeyRequest', 'GetNamespacedTagKeyRequest', 'CreateTagKeyRequest', 'CreateTagKeyMetadata', 'UpdateTagKeyRequest', 'UpdateTagKeyMetadata', 'DeleteTagKeyRequest', 'DeleteTagKeyMetadata'})

class Purpose(proto.Enum):
    """A purpose for each policy engine requiring such an
...
class TagKey(proto.Message):
    ...
    short_name: str = proto.Field(proto.STRING, number=3)
    namespaced_name: str = proto.Field(proto.STRING, number=4)
    ...
    purpose: 'Purpose' = proto.Field(proto.ENUM, number=11, enum='Purpose')
    purpose_data: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=12)

class ListTagKeysRequest(proto.Message):
    """The request message for listing all TagKeys under a parent
    resource.
...
class ListTagKeysResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    tag_keys: MutableSequence['TagKey'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TagKey')
...
class GetNamespacedTagKeyRequest(proto.Message):
    """The request message for getting a TagKey by its namespaced
    name.
...
class CreateTagKeyRequest(proto.Message):
    ...
    """
    tag_key: 'TagKey' = proto.Field(proto.MESSAGE, number=1, message='TagKey')
