...
import sys
import grpc
from apache_beam.portability.api.org.apache.beam.model.fn_execution.v1.beam_fn_api_pb2 import StartWorkerRequest
from apache_beam.portability.api.org.apache.beam.model.fn_execution.v1.beam_fn_api_pb2_grpc import BeamFnExternalWorkerPoolStub
from apache_beam.portability.api.org.apache.beam.model.fn_execution.v1.beam_provision_api_pb2 import GetProvisionInfoRequest
from apache_beam.portability.api.org.apache.beam.model.fn_execution.v1.beam_provision_api_pb2_grpc import ProvisionServiceStub
from apache_beam.portability.api.org.apache.beam.model.pipeline.v1.endpoints_pb2 import ApiServiceDescriptor
...
if __name__ == '__main__':
    ...
    parser.add_argument('--semi_persist_dir', default='/tmp', help='Local semi-persistent directory (optional).')
    ...
    if 'PYTHON_LOOPBACK_SERVER_ADDRESS' in os.environ:
        ...
        with grpc.insecure_channel(os.environ['PYTHON_LOOPBACK_SERVER_ADDRESS']) as channel:
            ...
            request = StartWorkerRequest(worker_id=worker_id, provision_endpoint=ApiServiceDescriptor(url=provision_endpoint), params=params)
        ...
        os.environ['LOGGING_API_SERVICE_DESCRIPTOR'] = text_format.MessageToString(ApiServiceDescriptor(url=logging_endpoint))
        os.environ['CONTROL_API_SERVICE_DESCRIPTOR'] = text_format.MessageToString(ApiServiceDescriptor(url=control_endpoint))
        env = dict(os.environ)
