...
from ...utils import checkout_add_promo_code, checkout_complete, checkout_create, checkout_delivery_method_update, checkout_dummy_payment_create, raw_checkout_add_promo_code
...
def prepare_voucher(e2e_staff_api_client, channel_id, voucher_code, voucher_discount_type, voucher_discount_value, voucher_type, products):
    if False:
        print('Hello World!')
    input = {'code': voucher_code, 'discountValueType': voucher_discount_type, 'type': voucher_type, 'usageLimit': 1, 'singleUse': False, 'products': products, 'applyOncePerCustomer': True}
...
@pytest.mark.e2e
def test_checkout_with_voucher_limit_per_customer_CORE_0910(e2e_not_logged_api_client, e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_checkouts):
    if False:
        print('Hello World!')
    ...
    (voucher_code, voucher_id, voucher_discount_value) = prepare_voucher(e2e_staff_api_client, channel_id, voucher_code='FIXED', voucher_discount_type='FIXED', voucher_discount_value=10, voucher_type='SPECIFIC_PRODUCT', products=product_id)
