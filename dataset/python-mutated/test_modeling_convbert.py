...
if is_torch_available():
    import torch
    from transformers import MODEL_FOR_QUESTION_ANSWERING_MAPPING, ConvBertForMaskedLM, ConvBertForMultipleChoice, ConvBertForQuestionAnswering, ConvBertForSequenceClassification, ConvBertForTokenClassification, ConvBertModel
...
class ConvBertModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (ConvBertModel, ConvBertForMaskedLM, ConvBertForMultipleChoice, ConvBertForQuestionAnswering, ConvBertForSequenceClassification, ConvBertForTokenClassification) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': ConvBertModel, 'fill-mask': ConvBertForMaskedLM, 'question-answering': ConvBertForQuestionAnswering, 'text-classification': ConvBertForSequenceClassification, 'token-classification': ConvBertForTokenClassification, 'zero-shot': ConvBertForSequenceClassification} if is_torch_available() else {}
    test_pruning = False
