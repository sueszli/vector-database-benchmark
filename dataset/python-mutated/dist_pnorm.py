...
from ..utils import _get_comm_group, _get_corresponding_rank, compute_compatible_dim_mapping, is_dim_replicate, is_dim_shard, set_dist_op_desc_original_id
...
register_distributed_operator_impl('p_norm', DistributedPNormImpl0('data_parallel'))