...
from scapy.fields import ByteEnumField, ByteField, Field, FieldListField, FlagsField, IntField, IPField, ShortField, StrEnumField, StrField, StrFixedLenField, XIntField
...
from scapy.volatile import RandBin, RandByte, RandField, RandIP, RandInt, RandNum, RandNumExpo
...
class BOOTP(Packet):
    name = 'BOOTP'
    fields_desc = [ByteEnumField('op', 1, {1: 'BOOTREQUEST', 2: 'BOOTREPLY'}), ByteEnumField('htype', 1, HARDWARE_TYPES), ByteField('hlen', 6), ByteField('hops', 0), XIntField('xid', 0), ShortField('secs', 0), FlagsField('flags', 0, 16, '???????????????B'), IPField('ciaddr', '0.0.0.0'), IPField('yiaddr', '0.0.0.0'), IPField('siaddr', '0.0.0.0'), IPField('giaddr', '0.0.0.0'), _BOOTP_chaddr('chaddr', b'', length=16), StrFixedLenField('sname', b'', length=64), StrFixedLenField('file', b'', length=128), StrEnumField('options', b'', {dhcpmagic: 'DHCP magic'})]
