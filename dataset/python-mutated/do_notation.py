...
_INVALID_DO_NOTATION_SOURCE: Final = 'Invalid type supplied in do-notation: expected "{0}", got "{1}"'
_LITERAL_GENERATOR_EXPR_REQUIRED: Final = 'Literal generator expression is required, not a variable or function call'
_IF_CONDITIONS_ARE_NOT_ALLOWED: Final = 'Using "if" conditions inside a generator is not allowed'
