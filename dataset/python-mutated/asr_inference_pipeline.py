...
from modelscope.utils.audio.audio_utils import extract_pcm_from_wav, generate_scp_from_url, load_bytes_from_url, update_local_model
...
@PIPELINES.register_module(Tasks.auto_speech_recognition, module_name=Pipelines.asr_inference)
