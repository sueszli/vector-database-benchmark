...
class WindowNameConfig(Config):
    ...
    keys = []
    mouse = []
    fake_screens = [Screen(top=bar.Bar([widget.WindowName()], 24), x=0, y=0, width=900, height=480), Screen(top=bar.Bar([widget.WindowName(for_current_screen=True)], 24), x=0, y=480, width=900, height=480)]
    screens = []
