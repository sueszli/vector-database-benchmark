...
class InitCommand(Command):
    ...
    options = [option('name', None, 'Name of the package.', flag=False), option('description', None, 'Description of the package.', flag=False), option('author', None, 'Author name of the package.', flag=False), option('python', None, 'Compatible Python versions.', flag=False), option('dependency', None, 'Package to require, with an optional version constraint, e.g. requests:^2.10.0 or requests=2.11.1.', flag=False, multiple=True), option('dev-dependency', None, 'Package to require for development, with an optional version constraint, e.g. requests:^2.10.0 or requests=2.11.1.', flag=False, multiple=True), option('license', 'l', 'License of the package.', flag=False)]
    help = 'The <c1>init</c1> command creates a basic <comment>pyproject.toml</> file in the current directory.\n'
