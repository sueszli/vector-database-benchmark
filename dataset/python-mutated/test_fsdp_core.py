...
from torch.distributed.fsdp.fully_sharded_data_parallel import BackwardPrefetch, FullyShardedDataParallel as FSDP, ShardingStrategy
from torch.distributed.fsdp.wrap import ModuleWrapPolicy
from torch.distributed.utils import _p_assert
from torch.testing._internal.common_distributed import skip_if_lt_x_gpu
from torch.testing._internal.common_fsdp import AlwaysWrapNestedWrappedModule, CUDAInitMode, DummyDDP, FSDPInitMode, FSDPTest, MixtureOfExperts, NestedWrappedModule, NestedWrappedModuleWithDelay, subtest_name, TransformerWithSharedParams
...
test_name_mapping = {str(CPUOffload(offload_params=True)): 'offload_true', str(CPUOffload(offload_params=False)): 'offload_false', str(ShardingStrategy.SHARD_GRAD_OP): 'shard_grad_op', str(ShardingStrategy.NO_SHARD): 'no_shard'}
