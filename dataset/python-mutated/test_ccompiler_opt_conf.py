...
arch_compilers = dict(x86=('gcc', 'clang', 'icc', 'iccw', 'msvc'), x64=('gcc', 'clang', 'icc', 'iccw', 'msvc'), ppc64=('gcc', 'clang'), ppc64le=('gcc', 'clang'), armhf=('gcc', 'clang'), aarch64=('gcc', 'clang'), narch=('gcc',))
