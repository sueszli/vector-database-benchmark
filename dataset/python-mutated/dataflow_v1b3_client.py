...
class DataflowV1b3(base_api.BaseApiClient):
    ...
    class ProjectsJobsService(base_api.BaseApiService):
        ...
        def Aggregated(self, request, global_params=None):
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Aggregated.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.jobs.aggregated', ordered_params=['projectId'], path_params=['projectId'], query_params=['filter', 'location', 'pageSize', 'pageToken', 'view'], relative_path='v1b3/projects/{projectId}/jobs:aggregated', request_field='', request_type_name='DataflowProjectsJobsAggregatedRequest', response_type_name='ListJobsResponse', supports_download=False)
        ...
        def List(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.jobs.list', ordered_params=['projectId'], path_params=['projectId'], query_params=['filter', 'location', 'pageSize', 'pageToken', 'view'], relative_path='v1b3/projects/{projectId}/jobs', request_field='', request_type_name='DataflowProjectsJobsListRequest', response_type_name='ListJobsResponse', supports_download=False)
    ...
    class ProjectsLocationsFlexTemplatesService(base_api.BaseApiService):
        ...
        def Launch(self, request, global_params=None):
            ...
            return self._RunMethod(config, request, global_params=global_params)
        Launch.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.flexTemplates.launch', ordered_params=['projectId', 'location'], path_params=['location', 'projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/locations/{location}/flexTemplates:launch', request_field='launchFlexTemplateRequest', request_type_name='DataflowProjectsLocationsFlexTemplatesLaunchRequest', response_type_name='LaunchFlexTemplateResponse', supports_download=False)
    ...
    class ProjectsLocationsJobsDebugService(base_api.BaseApiService):
        ...
        def GetConfig(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('GetConfig')
            return self._RunMethod(config, request, global_params=global_params)
        GetConfig.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.jobs.debug.getConfig', ordered_params=['projectId', 'location', 'jobId'], path_params=['jobId', 'location', 'projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/debug/getConfig', request_field='getDebugConfigRequest', request_type_name='DataflowProjectsLocationsJobsDebugGetConfigRequest', response_type_name='GetDebugConfigResponse', supports_download=False)
        ...
        def SendCapture(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('SendCapture')
            return self._RunMethod(config, request, global_params=global_params)
        SendCapture.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.jobs.debug.sendCapture', ordered_params=['projectId', 'location', 'jobId'], path_params=['jobId', 'location', 'projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/debug/sendCapture', request_field='sendDebugCaptureRequest', request_type_name='DataflowProjectsLocationsJobsDebugSendCaptureRequest', response_type_name='SendDebugCaptureResponse', supports_download=False)
    ...
    class ProjectsLocationsJobsService(base_api.BaseApiService):
        ...
        def Create(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('Create')
            return self._RunMethod(config, request, global_params=global_params)
        Create.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.jobs.create', ordered_params=['projectId', 'location'], path_params=['location', 'projectId'], query_params=['replaceJobId', 'view'], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs', request_field='job', request_type_name='DataflowProjectsLocationsJobsCreateRequest', response_type_name='Job', supports_download=False)
        ...
        def Get(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.locations.jobs.get', ordered_params=['projectId', 'location', 'jobId'], path_params=['jobId', 'location', 'projectId'], query_params=['view'], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}', request_field='', request_type_name='DataflowProjectsLocationsJobsGetRequest', response_type_name='Job', supports_download=False)
        ...
        def GetMetrics(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('GetMetrics')
            return self._RunMethod(config, request, global_params=global_params)
        GetMetrics.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.locations.jobs.getMetrics', ordered_params=['projectId', 'location', 'jobId'], path_params=['jobId', 'location', 'projectId'], query_params=['startTime'], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}/metrics', request_field='', request_type_name='DataflowProjectsLocationsJobsGetMetricsRequest', response_type_name='JobMetrics', supports_download=False)
        ...
        def List(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('List')
            return self._RunMethod(config, request, global_params=global_params)
        List.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.locations.jobs.list', ordered_params=['projectId', 'location'], path_params=['location', 'projectId'], query_params=['filter', 'pageSize', 'pageToken', 'view'], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs', request_field='', request_type_name='DataflowProjectsLocationsJobsListRequest', response_type_name='ListJobsResponse', supports_download=False)
        ...
        def Snapshot(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('Snapshot')
            return self._RunMethod(config, request, global_params=global_params)
        Snapshot.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.jobs.snapshot', ordered_params=['projectId', 'location', 'jobId'], path_params=['jobId', 'location', 'projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/locations/{location}/jobs/{jobId}:snapshot', request_field='snapshotJobRequest', request_type_name='DataflowProjectsLocationsJobsSnapshotRequest', response_type_name='Snapshot', supports_download=False)
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def WorkerMessages(self, request, global_params=None):
            ...
            return self._RunMethod(config, request, global_params=global_params)
        WorkerMessages.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.locations.workerMessages', ordered_params=['projectId', 'location'], path_params=['location', 'projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/locations/{location}/WorkerMessages', request_field='sendWorkerMessagesRequest', request_type_name='DataflowProjectsLocationsWorkerMessagesRequest', response_type_name='SendWorkerMessagesResponse', supports_download=False)
    ...
    class ProjectsSnapshotsService(base_api.BaseApiService):
        ...
        def Get(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('Get')
            return self._RunMethod(config, request, global_params=global_params)
        Get.method_config = lambda : base_api.ApiMethodInfo(http_method='GET', method_id='dataflow.projects.snapshots.get', ordered_params=['projectId', 'snapshotId'], path_params=['projectId', 'snapshotId'], query_params=['location'], relative_path='v1b3/projects/{projectId}/snapshots/{snapshotId}', request_field='', request_type_name='DataflowProjectsSnapshotsGetRequest', response_type_name='Snapshot', supports_download=False)
    ...
    class ProjectsService(base_api.BaseApiService):
        ...
        def DeleteSnapshots(self, request, global_params=None):
            ...
            return self._RunMethod(config, request, global_params=global_params)
        DeleteSnapshots.method_config = lambda : base_api.ApiMethodInfo(http_method='DELETE', method_id='dataflow.projects.deleteSnapshots', ordered_params=['projectId'], path_params=['projectId'], query_params=['location', 'snapshotId'], relative_path='v1b3/projects/{projectId}/snapshots', request_field='', request_type_name='DataflowProjectsDeleteSnapshotsRequest', response_type_name='DeleteSnapshotResponse', supports_download=False)
        ...
        def WorkerMessages(self, request, global_params=None):
            ...
            config = self.GetMethodConfig('WorkerMessages')
            return self._RunMethod(config, request, global_params=global_params)
        WorkerMessages.method_config = lambda : base_api.ApiMethodInfo(http_method='POST', method_id='dataflow.projects.workerMessages', ordered_params=['projectId'], path_params=['projectId'], query_params=[], relative_path='v1b3/projects/{projectId}/WorkerMessages', request_field='sendWorkerMessagesRequest', request_type_name='DataflowProjectsWorkerMessagesRequest', response_type_name='SendWorkerMessagesResponse', supports_download=False)