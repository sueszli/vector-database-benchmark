...
from ..utils import dict_get, ExtractorError, strip_or_none, traverse_obj, try_get
...
class RCTIPlusSeriesIE(RCTIPlusBaseIE):
    ...
    _TESTS = [{'url': 'https://www.rctiplus.com/programs/829/putri-untuk-pangeran', 'playlist_mincount': 1019, 'info_dict': {'id': '829', 'title': 'Putri Untuk Pangeran', 'description': 'md5:aca7b54d05bd95a67d4f4613cc1d622d', 'age_limit': 2, 'cast': ['Verrel Bramasta', 'Ranty Maria', 'Riza Syah', 'Ivan Fadilla', 'Nicole Parham', 'Dll', 'Aviv Elham'], 'display_id': 'putri-untuk-pangeran', 'tag': 'count:18'}}, {'url': 'https://www.rctiplus.com/programs/615/inews-pagi', 'playlist_mincount': 388, 'info_dict': {'id': '615', 'title': 'iNews Pagi', 'description': 'md5:f18ee3d4643cfb41c358e5a9b693ee04', 'age_limit': 2, 'tag': 'count:11', 'display_id': 'inews-pagi'}}]
    _AGE_RATINGS = {'S-SU': 2, 'SU': 2, 'P': 2, 'A': 7, 'R': 13, 'R-R/1': 17, 'D': 18}
...
class RCTIPlusTVIE(RCTIPlusBaseIE):
    ...
    _TESTS = [{'url': 'https://www.rctiplus.com/tv/rcti', 'info_dict': {'id': 'v_lt1', 'title': 'RCTI', 'ext': 'mp4', 'timestamp': 1546344000, 'upload_date': '20190101'}, 'params': {'skip_download': True}}, {'url': 'https://www.rctiplus.com/live-event', 'only_matching': True}, {'url': 'https://www.rctiplus.com/missed-event', 'only_matching': True}]
