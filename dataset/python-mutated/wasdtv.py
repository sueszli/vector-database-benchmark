...
from ..utils import ExtractorError, int_or_none, parse_iso8601, traverse_obj, try_get
...
class WASDTVStreamIE(WASDTVBaseIE):
    ...
    _TESTS = [{'url': 'https://wasd.tv/24_7', 'info_dict': {'id': '559738', 'ext': 'mp4', 'title': 'Live 24/7 Music', 'description': '24&#x2F;7 Music', 'timestamp': int, 'upload_date': 're:^\\d{8}$', 'is_live': True, 'view_count': int}}]
...
class WASDTVRecordIE(WASDTVBaseIE):
    ...
    _TESTS = [{'url': 'https://wasd.tv/spacemita/videos?record=907755', 'md5': 'c9899dd85be4cc997816ff9f9ca516ce', 'info_dict': {'id': '906825', 'ext': 'mp4', 'title': 'Музыкальный', 'description': 'md5:f510388d929ff60ae61d4c3cab3137cc', 'timestamp': 1645812079, 'upload_date': '20220225', 'thumbnail': 're:^https?://.+\\.jpg', 'is_live': False, 'view_count': int}}, {'url': 'https://wasd.tv/spacemita?record=907755', 'only_matching': True}]
...
class WASDTVClipIE(WASDTVBaseIE):
    ...
    _TESTS = [{'url': 'https://wasd.tv/spacemita/clips?clip=26804', 'md5': '818885e720143d7a4e776ff66fcff148', 'info_dict': {'id': '26804', 'ext': 'mp4', 'title': 'Пуш флексит на голове стримера', 'timestamp': 1646682908, 'upload_date': '20220307', 'thumbnail': 're:^https?://.+\\.jpg', 'view_count': int}}]
