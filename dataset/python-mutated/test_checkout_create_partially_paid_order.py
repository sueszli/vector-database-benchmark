...
from .utils import checkout_create, checkout_delivery_method_update, raw_checkout_complete
...
@pytest.mark.e2e
def test_should_be_able_to_create_partially_paid_order_core_0112(e2e_staff_api_client, e2e_not_logged_api_client, e2e_app_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_checkouts, permission_manage_payments):
    if False:
        while True:
            i = 10
    permissions = [permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_orders, permission_manage_checkouts, permission_manage_payments]
    ...
    checkout_data = checkout_create(e2e_not_logged_api_client, lines, channel_slug, email='testEmail@saleor.io', set_default_billing_address=True, set_default_shipping_address=True)
    ...
    create_transaction(e2e_app_api_client, checkout_id, transaction_name='CreditCard', message='Charged', psp_reference='PSP-ref123', available_actions=['REFUND', 'CANCEL'], amount=1)
