...
from modelscope.models.cv.video_single_object_tracking.config.ostrack import cfg
from modelscope.models.cv.video_single_object_tracking.tracker import OSTrack, ProContEXT
from modelscope.models.cv.video_single_object_tracking.utils.utils import check_box, timestamp_format
...
@PIPELINES.register_module(Tasks.video_single_object_tracking, module_name=Pipelines.video_single_object_tracking_procontext)
@PIPELINES.register_module(Tasks.video_single_object_tracking, module_name=Pipelines.video_single_object_tracking)
