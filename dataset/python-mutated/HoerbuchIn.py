...
class HoerbuchIn(BaseDecrypter):
    ...
    __version__ = '0.68'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?hoerbuch\\.us/(wp/horbucher/\\d+/|tp/out\\.php\\?.+|protection/folder_\\d+\\.html)'
    ...
    protection = re.compile('https?://(?:www\\.)?hoerbuch\\.us/protection/folder_\\d+.html')
    uploaded = re.compile('https?://(?:www\\.)?hoerbuch\\.us/protection/uploaded/(\\w+)\\.html')
    hoster_links = re.compile('https?://(?:www\\.)?hoerbuch\\.us/wp/goto/Download/\\d+/')
