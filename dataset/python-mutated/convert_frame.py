...
from torch.fx.experimental.symbolic_shapes import ConstraintViolationError, GuardOnDataDependentSymNode
...
from .bytecode_transformation import check_inst_exn_tab_entries_valid, Instruction, is_generator, propagate_inst_exn_table_entries, transform_code_object
from .cache_size import CacheSizeRelevantForFrame, compute_cache_size, exceeds_cache_size_limit, is_recompilation
from .eval_frame import always_optimize_code_objects, skip_code, TorchPatcher
from .exc import augment_exc_message, BackendCompilerFailed, format_error_msg, InternalTorchDynamoError, TorchRuntimeError, UncapturedHigherOrderOpError, unimplemented, Unsupported
from .guards import CheckFunctionManager, get_and_maybe_log_recompilation_reason, GuardedCode
from .hooks import Hooks
from .output_graph import OutputGraph
from .replay_record import ExecutionRecord
from .symbolic_convert import InstructionTranslator, SpeculationLog
from .types import BytecodeHook
from .utils import CleanupManager, CompilationMetrics, counters, cprofile_wrapper, dynamo_timed, format_bytecode, frame_phase_timing, gen_record_file_name, increment_frame, is_namedtuple, istype, LazyString, orig_code_map, reset_graph_break_dup_checker, setup_compile_debug, troubleshooting_url, write_record_to_file
