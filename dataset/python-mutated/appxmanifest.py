...
APPX_DATA = dict(Name='PythonSoftwareFoundation.Python.{}'.format(VER_DOT), Version='{}.{}.{}.0'.format(VER_MAJOR, VER_MINOR, VER_FIELD3), Publisher=os.getenv('APPX_DATA_PUBLISHER', 'CN=4975D53F-AA7E-49A5-8B49-EA4FDC1BB66B'), DisplayName='Python {}'.format(VER_DOT), Description='The Python {} runtime and console.'.format(VER_DOT))
APPX_PLATFORM_DATA = dict(_keys=('ProcessorArchitecture',), win32=('x86',), amd64=('x64',), arm32=('arm',), arm64=('arm64',))
PYTHON_VE_DATA = dict(DisplayName='Python {}'.format(VER_DOT), Description='Python interactive console', Square150x150Logo='_resources/pythonx150.png', Square44x44Logo='_resources/pythonx44.png', BackgroundColor='transparent')
PYTHONW_VE_DATA = dict(DisplayName='Python {} (Windowed)'.format(VER_DOT), Description='Python windowed app launcher', Square150x150Logo='_resources/pythonwx150.png', Square44x44Logo='_resources/pythonwx44.png', BackgroundColor='transparent', AppListEntry='none')
PIP_VE_DATA = dict(DisplayName='pip (Python {})'.format(VER_DOT), Description='pip package manager for Python {}'.format(VER_DOT), Square150x150Logo='_resources/pythonx150.png', Square44x44Logo='_resources/pythonx44.png', BackgroundColor='transparent', AppListEntry='none')
IDLE_VE_DATA = dict(DisplayName='IDLE (Python {})'.format(VER_DOT), Description='IDLE editor for Python {}'.format(VER_DOT), Square150x150Logo='_resources/idlex150.png', Square44x44Logo='_resources/idlex44.png', BackgroundColor='transparent')
PY_PNG = '_resources/py.png'
APPXMANIFEST_NS = {'': 'http://schemas.microsoft.com/appx/manifest/foundation/windows10', 'm': 'http://schemas.microsoft.com/appx/manifest/foundation/windows10', 'uap': 'http://schemas.microsoft.com/appx/manifest/uap/windows10', 'rescap': 'http://schemas.microsoft.com/appx/manifest/foundation/windows10/restrictedcapabilities', 'rescap4': 'http://schemas.microsoft.com/appx/manifest/foundation/windows10/restrictedcapabilities/4', 'desktop4': 'http://schemas.microsoft.com/appx/manifest/desktop/windows10/4', 'desktop6': 'http://schemas.microsoft.com/appx/manifest/desktop/windows10/6', 'uap3': 'http://schemas.microsoft.com/appx/manifest/uap/windows10/3', 'uap4': 'http://schemas.microsoft.com/appx/manifest/uap/windows10/4', 'uap5': 'http://schemas.microsoft.com/appx/manifest/uap/windows10/5'}
