...
from wagtail.test.testapp.models import Advert, DraftStateModel, FullFeaturedSnippet, ModeratedModel, RevisableChildModel, RevisableModel, SnippetChooserModel, VariousOnDeleteModel
...
class TestBreadcrumbs(AdminTemplateTestUtils, BaseSnippetViewSetTests):
    model = FullFeaturedSnippet
    base_breadcrumb_items = AdminTemplateTestUtils.base_breadcrumb_items + [{'label': 'Snippets', 'url': '/admin/snippets/'}]
