...
class sfp_sociallinks(SpiderFootPlugin):
    meta = {'name': 'Social Links', 'summary': 'Queries SocialLinks.io to gather intelligence from social media platforms and dark web.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Real World'], 'dataSource': {'website': 'https://sociallinks.io/', 'model': 'COMMERCIAL_ONLY', 'references': ['https://docs.osint.rest/'], 'apiKeyInstructions': ['Visit https://sociallinks.io/', 'Register an account'], 'favIcon': 'https://static.tildacdn.com/tild6563-6633-4533-b362-663333656461/favicon.ico', 'logo': 'https://static.tildacdn.com/tild3935-6136-4330-b561-643034663032/LogoSL.svg', 'description': "Social Links provides instruments for OSINT methods that are used by the world's leading investigation and law enforcement agencies"}}
    opts = {'api_key': ''}
    optdescs = {'api_key': 'Social Links API Key'}
    results = None
