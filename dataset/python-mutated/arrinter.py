...
from ctypes import *
import unittest
__all__ = ['PAI_CONTIGUOUS', 'PAI_FORTRAN', 'PAI_ALIGNED', 'PAI_NOTSWAPPED', 'PAI_WRITEABLE', 'PAI_ARR_HAS_DESCR', 'ArrayInterface']
...
class PyArrayInterface(Structure):
    _fields_ = [('two', c_int), ('nd', c_int), ('typekind', c_char), ('itemsize', c_int), ('flags', c_int), ('shape', POINTER(Py_intptr_t)), ('strides', POINTER(Py_intptr_t)), ('data', c_void_p), ('descr', py_object)]
...
class Array(Exporter):
    _ctypes = {('u', 1): c_uint8, ('u', 2): c_uint16, ('u', 4): c_uint32, ('u', 8): c_uint64, ('i', 1): c_int8, ('i', 2): c_int16, ('i', 4): c_int32, ('i', 8): c_int64}
