...
coercions = {(int, float): float, (int, Decimal): Decimal, (date, datetime): datetime, (bool, int): int, (bool, float): float, (bool, Decimal): Decimal}
...
array_types = {int: IntArray, float: FloatArray, str: StrArray}