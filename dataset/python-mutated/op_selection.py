import itertools
from typing import TYPE_CHECKING, AbstractSet, Dict, Iterable, List, NamedTuple, Optional, Sequence, Tuple, Type, Union, cast
from dagster._core.definitions.composition import MappedInputPlaceholder
from dagster._core.definitions.dependency import DependencyDefinition, DynamicCollectDependencyDefinition, GraphNode, IDependencyDefinition, MultiDependencyDefinition, NodeHandle, NodeInvocation, NodeOutput
