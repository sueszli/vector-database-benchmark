...
_trigonometric_hyperbolic_params = chainer.testing.product({'shape': [(), (0,), (1,), (2, 0, 3), (1, 1, 1), (2, 3)], 'in_dtypes,out_dtype': math_utils.in_out_dtypes_math_functions, 'input': [-2, 0, 2], 'contiguous': [None, 'C']}) + chainer.testing.product({'shape': [(2, 3)], 'in_dtypes,out_dtype': math_utils.in_out_float_dtypes_math_functions, 'input': [1.57, 2, 3.14, float('inf'), -float('inf'), float('nan')], 'skip_backward_test': [True], 'skip_double_backward_test': [True]})
...
@chainer.testing.parameterize(*_trigonometric_hyperbolic_params)
...
class TestTan(math_utils.UnaryMathTestBase, op_utils.NumpyOpTest):
    ...
    check_backward_options = {'atol': 3e-05}
...
@op_utils.op_test(['native:0', 'cuda:0'])
@chainer.testing.parameterize(*_make_inverse_trig_params('arcsin'))
...
@op_utils.op_test(['native:0', 'cuda:0'])
@chainer.testing.parameterize(*_make_inverse_trig_params('arccos'))
...
@op_utils.op_test(['native:0', 'cuda:0'])
@chainer.testing.parameterize(*chainer.testing.product({'in_shapes': math_utils.shapes_combination_binary, 'in_dtypes,out_dtype': dtype_utils.make_same_in_out_dtypes(2, chainerx.testing.float_dtypes), 'input_lhs': [1], 'input_rhs': [2], 'skip_backward_test': [True], 'skip_double_backward_test': [True]}) + chainer.testing.product({'in_shapes': [((2, 3), (2, 3))], 'in_dtypes,out_dtype': dtype_utils.make_same_in_out_dtypes(2, chainerx.testing.float_dtypes), 'input_lhs': [-3, -0.75, 0.75, 3], 'input_rhs': [-3, -0.75, 0.75, 3]}) + chainer.testing.product({'in_shapes': [((2, 3), (2, 3))], 'in_dtypes,out_dtype': math_utils.in_out_dtypes_math_binary_functions, 'input_lhs': [-1.0], 'input_rhs': [-1.0]}) + chainer.testing.product({'in_shapes': [((2, 3), (2, 3))], 'in_dtypes,out_dtype': dtype_utils.make_same_in_out_dtypes(2, chainerx.testing.float_dtypes), 'input_lhs': ['random', float('inf'), -float('inf'), float('nan'), +0.0, -0.0], 'input_rhs': ['random', float('inf'), -float('inf'), float('nan'), +0.0, -0.0], 'skip_backward_test': [True], 'skip_double_backward_test': [True]}))
...
@op_utils.op_test(['native:0', 'cuda:0'])
@chainer.testing.parameterize(*_make_inverse_trig_params('arcsinh'))
...
@op_utils.op_test(['native:0', 'cuda:0'])
@chainer.testing.parameterize(*_make_inverse_trig_params('arccosh'))
