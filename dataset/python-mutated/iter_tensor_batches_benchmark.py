...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-size-gb', choices=[1, 10], type=int, default=1, help='The data size to use for the dataset.')
    parser.add_argument('--block-size-mb', type=int, default=128, help='The data size to use for the dataset.')
