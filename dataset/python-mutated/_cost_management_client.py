...
class CostManagementClient:
    ...
    def __init__(self, credential: 'AsyncTokenCredential', base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        if False:
            return 10
        ...
        self.generate_cost_details_report = GenerateCostDetailsReportOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.scheduled_actions = ScheduledActionsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.benefit_recommendations = BenefitRecommendationsOperations(self._client, self._config, self._serialize, self._deserialize)
        self.benefit_utilization_summaries = BenefitUtilizationSummariesOperations(self._client, self._config, self._serialize, self._deserialize)
