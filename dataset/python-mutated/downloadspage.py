...
from tribler.gui.defs import BUTTON_TYPE_CONFIRM, BUTTON_TYPE_NORMAL, DOWNLOADS_FILTER_ACTIVE, DOWNLOADS_FILTER_ALL, DOWNLOADS_FILTER_CHANNELS, DOWNLOADS_FILTER_COMPLETED, DOWNLOADS_FILTER_DEFINITION, DOWNLOADS_FILTER_DOWNLOADING, DOWNLOADS_FILTER_INACTIVE
...
REFRESH_DOWNLOADS_SOON_INTERVAL_MSEC = 10
REFRESH_DOWNLOADS_UI_CHANGE_INTERVAL_MSEC = 2000
REFRESH_DOWNLOADS_BACKGROUND_INTERVAL_MSEC = 5000
button_name2filter = {'downloads_all_button': DOWNLOADS_FILTER_ALL, 'downloads_downloading_button': DOWNLOADS_FILTER_DOWNLOADING, 'downloads_completed_button': DOWNLOADS_FILTER_COMPLETED, 'downloads_active_button': DOWNLOADS_FILTER_ACTIVE, 'downloads_inactive_button': DOWNLOADS_FILTER_INACTIVE, 'downloads_channels_button': DOWNLOADS_FILTER_CHANNELS}
