...
plot_figure = figure(title='Range Slider', height=450, width=600, tools='save,reset', toolbar_location='below')
...
def slider_change(attr, old, new):
    if False:
        i = 10
        return i + 15
    slider_value = range_slider.value
    ...
    source.data = dict(year=filtered_df.Year, population=filtered_df.Population, marriagep1000=filtered_df.Marriages_per_1000, divorcep1000=filtered_df.Divorces_per_1000)
