...
class EASubscriptionListMigrationDateOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`ea_subscription_list_migration_date` attribute.
    """
    models = _models
    ...
    async def post(self, **kwargs: Any) -> _models.EASubscriptionMigrationDate:
        ...
        request = build_post_request(subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.post.metadata['url'], headers=_headers, params=_params)
