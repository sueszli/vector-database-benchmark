...
from wagtail.blocks.migrations.operations import RenameStreamChildrenOperation, RenameStructChildrenOperation
from wagtail.blocks.migrations.utils import InvalidBlockDefError, apply_changes_to_raw_data
...
class BadDataMigrationTestCase(TestCase, MigrationTestMixin):
    ...
    default_operation_and_block_path = [(RenameStructChildrenOperation(old_name='char1', new_name='renamed1'), 'invalid_name1')]
