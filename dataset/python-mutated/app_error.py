...
app.layout = html.Div([html.Div([html.P(id='output', children=['Button not clicked'])]), html.Button(id='button', children='Run Job!'), html.Div(id='output-status'), html.Div(id='output1'), html.Div(id='output2'), html.Div(id='output3'), html.Button('multi-output', id='multi-output')])
