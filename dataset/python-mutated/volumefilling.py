...
class St(bt.Strategy):
    params = (('stakeperc', 10.0), ('opbreak', 10))
    ...
    def next(self):
        ...
        if self.doop == 0:
            if not self.position.size:
                ...
                self.close()
        self.doop += 1
FILLERS = {'FixedSize': bt.broker.fillers.FixedSize, 'FixedBarPerc': bt.broker.fillers.FixedBarPerc, 'BarPointPerc': bt.broker.fillers.BarPointPerc}
