...
from transformers import BartTokenizer, BartTokenizerFast, DataProcessor, PreTrainedTokenizer, RobertaTokenizer, RobertaTokenizerFast, XLMRobertaTokenizer, is_tf_available, is_torch_available
...
def hans_convert_examples_to_features(examples: List[InputExample], label_list: List[str], max_length: int, tokenizer: PreTrainedTokenizer):
    ...
    return features
hans_tasks_num_labels = {'hans': 3}
hans_processors = {'hans': HansProcessor}