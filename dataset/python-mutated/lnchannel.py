...
from typing import Optional, Dict, List, Tuple, NamedTuple, Set, Callable, Iterable, Sequence, TYPE_CHECKING, Iterator, Union, Mapping
import time
import threading
...
class PeerState(IntEnum):
    ...
    BAD = 3
cs = ChannelState
state_transitions = [(cs.PREOPENING, cs.OPENING), (cs.OPENING, cs.FUNDED), (cs.FUNDED, cs.OPEN), (cs.OPENING, cs.SHUTDOWN), (cs.FUNDED, cs.SHUTDOWN), (cs.OPEN, cs.SHUTDOWN), (cs.SHUTDOWN, cs.SHUTDOWN), (cs.SHUTDOWN, cs.CLOSING), (cs.CLOSING, cs.CLOSING), (cs.OPENING, cs.FORCE_CLOSING), (cs.FUNDED, cs.FORCE_CLOSING), (cs.OPEN, cs.FORCE_CLOSING), (cs.SHUTDOWN, cs.FORCE_CLOSING), (cs.CLOSING, cs.FORCE_CLOSING), (cs.REQUESTED_FCLOSE, cs.FORCE_CLOSING), (cs.OPENING, cs.REQUESTED_FCLOSE), (cs.FUNDED, cs.REQUESTED_FCLOSE), (cs.OPEN, cs.REQUESTED_FCLOSE), (cs.SHUTDOWN, cs.REQUESTED_FCLOSE), (cs.CLOSING, cs.REQUESTED_FCLOSE), (cs.REQUESTED_FCLOSE, cs.REQUESTED_FCLOSE), (cs.OPENING, cs.CLOSED), (cs.FUNDED, cs.CLOSED), (cs.OPEN, cs.CLOSED), (cs.SHUTDOWN, cs.CLOSED), (cs.CLOSING, cs.CLOSED), (cs.REQUESTED_FCLOSE, cs.CLOSED), (cs.WE_ARE_TOXIC, cs.CLOSED), (cs.OPENING, cs.WE_ARE_TOXIC), (cs.FUNDED, cs.WE_ARE_TOXIC), (cs.OPEN, cs.WE_ARE_TOXIC), (cs.SHUTDOWN, cs.WE_ARE_TOXIC), (cs.REQUESTED_FCLOSE, cs.WE_ARE_TOXIC), (cs.FORCE_CLOSING, cs.FORCE_CLOSING), (cs.FORCE_CLOSING, cs.CLOSED), (cs.FORCE_CLOSING, cs.REDEEMED), (cs.CLOSED, cs.REDEEMED), (cs.OPENING, cs.REDEEMED), (cs.PREOPENING, cs.REDEEMED)]
del cs
