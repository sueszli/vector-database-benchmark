...
class RRTStarDubins(RRTStar):
    ...
    def __init__(self, start, goal, obstacle_list, rand_area, goal_sample_rate=10, max_iter=200, connect_circle_dist=50.0, robot_radius=0.0):
        if False:
            print('Hello World!')
    ...
    def calc_new_cost(self, from_node, to_node):
        if False:
            while True:
                i = 10
        (_, _, _, _, course_lengths) = dubins_path_planner.plan_dubins_path(from_node.x, from_node.y, from_node.yaw, to_node.x, to_node.y, to_node.yaw, self.curvature)
