...
class Exploit(HTTPClient):
    __info__ = {'name': 'Zyxel Eir D1000 WiFi Password Disclosure', 'description': 'Module exploits WiFi Password Disclosure vulnerability in Zyxel/Eir D1000 devices. If the target is vulnerable it allows to read WiFi password.', 'authors': ('Xiphos http://www.xiphosresearch.com/', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://github.com/XiphosResearch/exploits/tree/master/tr-06fail',), 'devices': ('Zyxel EIR D1000',)}
