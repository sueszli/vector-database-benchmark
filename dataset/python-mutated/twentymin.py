...
class TwentyMinutenIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+src=(["\\\'])(?P<url>(?:(?:https?:)?//)?(?:www\\.)?20min\\.ch/videoplayer/videoplayer.html\\?.*?\\bvideoId@\\d+.*?)\\1']
    _TESTS = [{'url': 'http://www.20min.ch/videotv/?vid=469148&cid=2', 'md5': 'e7264320db31eed8c38364150c12496e', 'info_dict': {'id': '469148', 'ext': 'mp4', 'title': '85 000 Franken für 15 perfekte Minuten', 'thumbnail': 're:https?://.*\\.jpg$'}}, {'url': 'http://www.20min.ch/videoplayer/videoplayer.html?params=client@twentyDE|videoId@523629', 'info_dict': {'id': '523629', 'ext': 'mp4', 'title': 'So kommen Sie bei Eis und Schnee sicher an', 'description': 'md5:117c212f64b25e3d95747e5276863f7d', 'thumbnail': 're:https?://.*\\.jpg$'}, 'params': {'skip_download': True}}, {'url': 'http://www.20min.ch/videotv/?cid=44&vid=468738', 'only_matching': True}]
