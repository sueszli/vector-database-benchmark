...
class Config:
    ...
    SOUND_PATHS_DICT = {'goal': os.path.join(rootdir, 'resources/audios/goal.wav'), 'hit': os.path.join(rootdir, 'resources/audios/hit.wav')}
    FONT_PATHS_DICT = {'default20': {'name': os.path.join(rootdir.replace('pingpong', 'base'), 'resources/fonts/MaiandraGD.ttf'), 'size': 20}, 'default30': {'name': os.path.join(rootdir.replace('pingpong', 'base'), 'resources/fonts/MaiandraGD.ttf'), 'size': 30}, 'default50': {'name': os.path.join(rootdir.replace('pingpong', 'base'), 'resources/fonts/MaiandraGD.ttf'), 'size': 50}}
    IMAGE_PATHS_DICT = {'ball': os.path.join(rootdir, 'resources/images/ball.png'), 'racket': os.path.join(rootdir, 'resources/images/racket.png')}
'乒乓球小游戏'
