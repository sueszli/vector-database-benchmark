...
class ExplorationImprovementsHandler(base.BaseHandler[ExplorationImprovementsHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'POST': {'task_entries': {'schema': {'type': 'list', 'items': {'type': 'object_dict', 'validation_method': domain_objects_validator.validate_task_entries}}}}}
...
class ExplorationImprovementsHistoryHandler(base.BaseHandler[Dict[str, str], ExplorationImprovementsHistoryHandlerNormalizedRequestDict]):
