...
class TopicEditorStoryHandler(base.BaseHandler[TopicEditorStoryHandlerNormalizedPayloadDict, TopicEditorStoryHandlerNormalizedRequestDict]):
...
class EditableSubtopicPageDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'topic_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}, 'subtopic_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}}
    HANDLER_ARGS_SCHEMAS: Dict[str, Dict[str, str]] = {'GET': {}}
...
class EditableTopicDataHandler(base.BaseHandler[EditableTopicDataHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'topic_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {}, 'PUT': {'version': {'schema': {'type': 'int'}}, 'commit_message': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_COMMIT_MESSAGE_LENGTH}]}}, 'topic_and_subtopic_page_change_dicts': {'schema': {'type': 'list', 'items': {'type': 'object_dict', 'object_class': topic_domain.TopicChange}}}}, 'DELETE': {}}
...
class TopicPublishSendMailHandler(base.BaseHandler[TopicPublishSendMailHandlerNormalizedPayloadDict, Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'topic_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}}
    HANDLER_ARGS_SCHEMAS = {'PUT': {'topic_name': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_CHARS_IN_TOPIC_NAME}]}}}}
...
class TopicNameHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'topic_name': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_CHARS_IN_TOPIC_NAME}]}}}
    HANDLER_ARGS_SCHEMAS: Dict[str, Dict[str, str]] = {'GET': {}}
