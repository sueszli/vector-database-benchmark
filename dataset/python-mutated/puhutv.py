...
class PuhuTVIE(InfoExtractor):
    ...
    IE_NAME = 'puhutv'
    _TESTS = [{'url': 'https://puhutv.com/sut-kardesler-izle', 'md5': 'a347470371d56e1585d1b2c8dab01c96', 'info_dict': {'id': '5085', 'display_id': 'sut-kardesler', 'ext': 'mp4', 'title': 'Süt Kardeşler', 'description': 'md5:ca09da25b7e57cbb5a9280d6e48d17aa', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 4832.44, 'creator': 'Arzu Film', 'timestamp': 1561062602, 'upload_date': '20190620', 'release_year': 1976, 'view_count': int, 'tags': list}}, {'url': 'https://puhutv.com/jet-sosyete-1-bolum-izle', 'only_matching': True}, {'url': 'https://puhutv.com/dip-1-bolum-izle', 'only_matching': True}]
    _SUBTITLE_LANGS = {'English': 'en', 'Deutsch': 'de', 'عربى': 'ar'}
...
class PuhuTVSerieIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://puhutv.com/deniz-yildizi-detay', 'info_dict': {'title': 'Deniz Yıldızı', 'id': 'deniz-yildizi'}, 'playlist_mincount': 205}, {'url': 'https://puhutv.com/kaybedenler-kulubu-detay', 'only_matching': True}]
