...
class AccountAddressCreate(AddressMetadataMixin, ModelMutation, I18nMixin):
    ...
    class Arguments:
        ...
        type = AddressTypeEnum(required=False, description="A type of address. If provided, the new address will be automatically assigned as the customer's default address of that type.")
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.CUSTOMER_UPDATED, description='A customer account was updated.'), WebhookEventInfo(type=WebhookEventAsyncType.ADDRESS_CREATED, description='An address was created.')]
