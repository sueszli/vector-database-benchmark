...
Exp = TypeVar('Exp', Spanned[CommandArg], Spanned[CommandContext], Commands, Spanned[PythonContext])
...
class CompletionContextParser:
    ...
    used_tokens = {'STRING'}
    paren_pairs = (('DOLLAR_LPAREN', 'RPAREN'), ('BANG_LPAREN', 'RPAREN'), ('ATDOLLAR_LPAREN', 'RPAREN'), ('DOLLAR_LBRACKET', 'RBRACKET'), ('BANG_LBRACKET', 'RBRACKET'), ('AT_LPAREN', 'RPAREN'))
    ...
    multi_tokens = {'SEMI', 'NEWLINE', 'PIPE', 'AND', 'OR'}
    used_tokens |= multi_tokens
    io_redir_tokens = {'LT', 'GT', 'RSHIFT', 'IOREDIRECT'}
