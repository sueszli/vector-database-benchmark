...
class VoicyIE(VoicyBaseIE):
    ...
    _TESTS = [{'url': 'https://voicy.jp/channel/1253/122754', 'info_dict': {'id': '122754', 'title': '1/21(木)声日記：ついに原稿終わった！！', 'uploader': 'ちょまど@ ITエンジニアなオタク', 'uploader_id': '7339'}, 'playlist_mincount': 9}]
...
class VoicyChannelIE(VoicyBaseIE):
    ...
    _TESTS = [{'url': 'https://voicy.jp/channel/1253/', 'info_dict': {'id': '7339', 'title': 'ゆるふわ日常ラジオ #ちょまラジ', 'uploader': 'ちょまど@ ITエンジニアなオタク', 'uploader_id': '7339'}, 'playlist_mincount': 54}]
