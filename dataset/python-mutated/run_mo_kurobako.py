...
if __name__ == '__main__':
    ...
    parser.add_argument('--path-to-create-study', type=str, default='benchmarks/kurobako/mo_create_study.py')
    ...
    parser.add_argument('--sampler-list', type=str, default='RandomSampler TPESampler NSGAIISampler')
    parser.add_argument('--sampler-kwargs-list', type=str, default='{} {\\"multivariate\\":true\\,\\"constant_liar\\":true} {\\"population_size\\":20}')
