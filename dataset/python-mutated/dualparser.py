...
class DualCommentNode(DualNodeBase[augeasparser.AugeasCommentNode, apacheparser.ApacheCommentNode]):
...
class DualDirectiveNode(DualNodeBase[augeasparser.AugeasDirectiveNode, apacheparser.ApacheDirectiveNode]):
...
class DualBlockNode(DualNodeBase[augeasparser.AugeasBlockNode, apacheparser.ApacheBlockNode]):
