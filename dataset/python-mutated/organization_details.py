...
from sentry.api.serializers.models.organization import BaseOrganizationSerializer, TrustedRelaySerializer
from sentry.constants import ACCOUNT_RATE_LIMIT_DEFAULT, AI_SUGGESTED_SOLUTION, ALERTS_MEMBER_WRITE_DEFAULT, ATTACHMENTS_ROLE_DEFAULT, DEBUG_FILES_ROLE_DEFAULT, EVENTS_MEMBER_ADMIN_DEFAULT, GITHUB_COMMENT_BOT_DEFAULT, JOIN_REQUESTS_DEFAULT, LEGACY_RATE_LIMIT_OPTIONS, PROJECT_RATE_LIMIT_DEFAULT, REQUIRE_SCRUB_DATA_DEFAULT, REQUIRE_SCRUB_DEFAULTS_DEFAULT, REQUIRE_SCRUB_IP_ADDRESS_DEFAULT, SAFE_FIELDS_DEFAULT, SCRAPE_JAVASCRIPT_DEFAULT, SENSITIVE_FIELDS_DEFAULT
from sentry.datascrubbing import validate_pii_config_update, validate_pii_selectors
from sentry.integrations.utils.codecov import has_codecov_integration
from sentry.lang.native.utils import STORE_CRASH_REPORTS_DEFAULT, STORE_CRASH_REPORTS_MAX, convert_crashreport_count
...
from sentry.services.hybrid_cloud.organization.model import RpcOrganization, RpcOrganizationDeleteResponse, RpcOrganizationDeleteState
from sentry.services.hybrid_cloud.user.serial import serialize_generic_user
from sentry.services.organization.provisioning import OrganizationSlugCollisionException, organization_provisioning_service
...
ORG_OPTIONS = (('projectRateLimit', 'sentry:project-rate-limit', int, PROJECT_RATE_LIMIT_DEFAULT), ('accountRateLimit', 'sentry:account-rate-limit', int, ACCOUNT_RATE_LIMIT_DEFAULT), ('dataScrubber', 'sentry:require_scrub_data', bool, REQUIRE_SCRUB_DATA_DEFAULT), ('sensitiveFields', 'sentry:sensitive_fields', list, SENSITIVE_FIELDS_DEFAULT), ('safeFields', 'sentry:safe_fields', list, SAFE_FIELDS_DEFAULT), ('scrapeJavaScript', 'sentry:scrape_javascript', bool, SCRAPE_JAVASCRIPT_DEFAULT), ('dataScrubberDefaults', 'sentry:require_scrub_defaults', bool, REQUIRE_SCRUB_DEFAULTS_DEFAULT), ('storeCrashReports', 'sentry:store_crash_reports', convert_crashreport_count, STORE_CRASH_REPORTS_DEFAULT), ('attachmentsRole', 'sentry:attachments_role', str, ATTACHMENTS_ROLE_DEFAULT), ('debugFilesRole', 'sentry:debug_files_role', str, DEBUG_FILES_ROLE_DEFAULT), ('eventsMemberAdmin', 'sentry:events_member_admin', bool, EVENTS_MEMBER_ADMIN_DEFAULT), ('alertsMemberWrite', 'sentry:alerts_member_write', bool, ALERTS_MEMBER_WRITE_DEFAULT), ('scrubIPAddresses', 'sentry:require_scrub_ip_address', bool, REQUIRE_SCRUB_IP_ADDRESS_DEFAULT), ('relayPiiConfig', 'sentry:relay_pii_config', str, None), ('allowJoinRequests', 'sentry:join_requests', bool, JOIN_REQUESTS_DEFAULT), ('apdexThreshold', 'sentry:apdex_threshold', int, None), ('aiSuggestedSolution', 'sentry:ai_suggested_solution', bool, AI_SUGGESTED_SOLUTION), ('githubPRBot', 'sentry:github_pr_bot', bool, GITHUB_COMMENT_BOT_DEFAULT), ('githubOpenPRBot', 'sentry:github_open_pr_bot', bool, GITHUB_COMMENT_BOT_DEFAULT), ('githubNudgeInvite', 'sentry:github_nudge_invite', bool, GITHUB_COMMENT_BOT_DEFAULT))
...
class OrganizationSerializer(BaseOrganizationSerializer):
    ...
    avatarType = serializers.ChoiceField(choices=(('upload', 'upload'), ('letter_avatar', 'letter_avatar')), required=False, allow_null=True)
    ...
    storeCrashReports = serializers.IntegerField(min_value=-1, max_value=STORE_CRASH_REPORTS_MAX, required=False)
