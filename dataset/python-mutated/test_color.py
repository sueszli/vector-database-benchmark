...
class TestRandomColor:
    ...
    num_samples = 1000
    seed = 4761
    hsv_color_pattern: Pattern = re.compile('hsv\\((?P<h>\\d|[1-9]\\d|[1-3]\\d{2}), (?P<s>\\d|[1-9]\\d|100), (?P<v>\\d|[1-9]\\d|100)\\)')
    hsl_color_pattern: Pattern = re.compile('hsl\\((?P<h>\\d|[1-9]\\d|[1-3]\\d{2}), (?P<s>\\d|[1-9]\\d|[1-3]\\d{2}), (?P<l>\\d|[1-9]\\d|[1-3]\\d{2})\\)')
    rgb_color_pattern: Pattern = re.compile('rgb\\((?P<r>\\d|[1-9]\\d|[1-3]\\d{2}), (?P<g>\\d|[1-9]\\d|[1-3]\\d{2}), (?P<b>\\d|[1-9]\\d|[1-3]\\d{2})\\)')
    hex_color_pattern: Pattern = re.compile('#[0-9a-f]{6}')
