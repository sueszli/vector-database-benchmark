...
if __name__ == '__main__':
    pretty_names = {'PPC64': 'IBM/POWER big-endian', 'PPC64LE': 'IBM/POWER little-endian', 'S390X': 'IBM/ZSYSTEM(S390X)', 'ARMHF': 'ARMv7/A32', 'AARCH64': 'ARMv8/A64', 'ICC': 'Intel Compiler', 'MSVC': 'Microsoft Visual C/C++'}
    ...
    with open(path.join(gen_path, 'compilers-diff.inc'), 'w') as fd:
        fd.write(f'.. generated via {__file__}\n\n')
        for (arch, cc_names) in (('x86', ('clang', 'ICC', 'MSVC')), ('PPC64', ('clang',)), ('PPC64LE', ('clang',)), ('ARMHF', ('clang',)), ('AARCH64', ('clang',)), ('S390X', ('clang',))):
