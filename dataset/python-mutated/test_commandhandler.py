...
from tests.auxil.build_messages import make_command_message, make_command_update, make_message_update
...
class TestCommandHandler(BaseTest):
    ...
    async def test_basic(self, app, command):
        ...
        assert not is_match(handler, make_message_update(bot=app.bot, message=None, caption='caption'))
