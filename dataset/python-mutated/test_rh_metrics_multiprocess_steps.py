...
MESSAGE_PROCESSOR = MessageProcessor(get_ingest_config(UseCaseKey.RELEASE_HEALTH, IndexerStorage.POSTGRES))
...
counter_payload: dict[str, Any] = {'name': SessionMRI.RAW_SESSION.value, 'tags': {'environment': 'production', 'session.status': 'init'}, 'timestamp': ts, 'type': b'c', 'value': 1.0, 'org_id': 1, 'project_id': 3, 'retention_days': 90}
distribution_payload: dict[str, Any] = {'name': SessionMRI.RAW_DURATION.value, 'tags': {'environment': 'production', 'session.status': 'healthy'}, 'timestamp': ts, 'type': b'd', 'value': [4, 5, 6], 'org_id': 1, 'project_id': 3, 'retention_days': 90}
set_payload: dict[str, Any] = {'name': SessionMRI.RAW_ERROR.value, 'tags': {'environment': 'production', 'session.status': 'errored'}, 'timestamp': ts, 'type': b's', 'value': [3], 'org_id': 1, 'project_id': 3, 'retention_days': 90}
...
invalid_payloads = [({'name': SessionMRI.RAW_ERROR.value, 'tags': {'environment': 'production' * 21, 'session.status': 'errored'}, 'timestamp': ts, 'type': 's', 'value': [3], 'org_id': 1, 'project_id': 3, 'retention_days': 90}, 'invalid_tags', True), ({'name': SessionMRI.RAW_ERROR.value * 21, 'tags': {'environment': 'production', 'session.status': 'errored'}, 'timestamp': ts, 'type': 's', 'value': [3], 'org_id': 1, 'project_id': 3, 'retention_days': 90}, 'invalid_metric_name', True), (b'invalid_json_payload', 'invalid_json', False)]
