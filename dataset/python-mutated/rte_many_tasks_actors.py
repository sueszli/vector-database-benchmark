...
if __name__ == '__main__':
    ...
    for i in range(NUM_TASK_ITERATIONS):
        ...
        new_time = time.time()
        update_progress({'phase': 'Tasks', 'iteration': i + 1, 'iteration_time': new_time - previous_time, 'absolute_time': new_time, 'elapsed_time': new_time - start_time})
    ...
    for i in range(NUM_ACTOR_ITERATIONS):
        ...
        new_time = time.time()
        update_progress({'phase': 'Actors', 'iteration': i + 1, 'iteration_time': new_time - previous_time, 'absolute_time': new_time, 'elapsed_time': new_time - start_time})
        previous_time = new_time
    print('PASSED')