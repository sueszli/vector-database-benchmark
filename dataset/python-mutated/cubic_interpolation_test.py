...
class CubicInterpolationTest(tf.test.TestCase, parameterized.TestCase):
    optimized_for_tpu_and_boundary_condition_type_test_cases = [{'testcase_name': 'default_interpolation_clamped', 'optimize_for_tpu': False, 'boundary_condition_type': cubic.BoundaryConditionType.CLAMPED}, {'testcase_name': 'one_hot_interpolation_clamped', 'optimize_for_tpu': True, 'boundary_condition_type': cubic.BoundaryConditionType.CLAMPED}, {'testcase_name': 'default_interpolation_fixed_first_derivative', 'optimize_for_tpu': False, 'boundary_condition_type': cubic.BoundaryConditionType.FIXED_FIRST_DERIVATIVE}, {'testcase_name': 'one_hot_interpolation_fixed_first_derivative', 'optimize_for_tpu': True, 'boundary_condition_type': cubic.BoundaryConditionType.FIXED_FIRST_DERIVATIVE}]
