...
def main():
    ...
    response = client.shares.begin_refresh(device_name='testedgedevice', name='smbshare', resource_group_name='GroupForEdgeAutomation').result()
    print(response)
