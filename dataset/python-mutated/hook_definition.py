...
class HookDefinition(NamedTuple('_HookDefinition', [('name', PublicAttr[str]), ('hook_fn', PublicAttr[Callable]), ('required_resource_keys', PublicAttr[AbstractSet[str]]), ('decorated_fn', PublicAttr[Optional[Callable]])]), RequiresResources):
