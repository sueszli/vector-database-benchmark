...
from haystack.nodes.doc_language_classifier import LangdetectDocumentLanguageClassifier, TransformersDocumentLanguageClassifier
LANGUAGES_TO_ROUTE = ['en', 'es', 'it']
DOCUMENTS = [Document(content='My name is Matteo and I live in Rome'), Document(content='Mi chiamo Matteo e vivo a Roma'), Document(content='Mi nombre es Matteo y vivo en Roma')]
