...
from google.cloud.filestore_v1.services.cloud_filestore_manager import CloudFilestoreManagerAsyncClient, CloudFilestoreManagerClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(CloudFilestoreManagerClient, 'grpc'), (CloudFilestoreManagerAsyncClient, 'grpc_asyncio'), (CloudFilestoreManagerClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.CloudFilestoreManagerGrpcTransport, 'grpc'), (transports.CloudFilestoreManagerGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.CloudFilestoreManagerRestTransport, 'rest')])
...
def test_cloud_filestore_manager_client_get_transport_class():
    ...
    available_transports = [transports.CloudFilestoreManagerGrpcTransport, transports.CloudFilestoreManagerRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(CloudFilestoreManagerClient, transports.CloudFilestoreManagerGrpcTransport, 'grpc'), (CloudFilestoreManagerAsyncClient, transports.CloudFilestoreManagerGrpcAsyncIOTransport, 'grpc_asyncio'), (CloudFilestoreManagerClient, transports.CloudFilestoreManagerRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(CloudFilestoreManagerClient, transports.CloudFilestoreManagerGrpcTransport, 'grpc', grpc_helpers), (CloudFilestoreManagerAsyncClient, transports.CloudFilestoreManagerGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async), (CloudFilestoreManagerClient, transports.CloudFilestoreManagerRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(CloudFilestoreManagerClient, transports.CloudFilestoreManagerGrpcTransport, 'grpc', grpc_helpers), (CloudFilestoreManagerAsyncClient, transports.CloudFilestoreManagerGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
def test_cloud_filestore_manager_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel') as create_channel:
        ...
        client = client_class(client_options=options, transport=transport_name)
        create_channel.assert_called_with('file.googleapis.com:443', credentials=file_creds, credentials_file=None, quota_project_id=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=None, default_host='file.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])

@pytest.mark.parametrize('request_type', [cloud_filestore_service.ListInstancesRequest, dict])
def test_list_instances(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_instances), '__call__') as call:
        call.return_value = cloud_filestore_service.ListInstancesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
async def test_list_instances_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.ListInstancesRequest):
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_instances), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.ListInstancesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value']))
...
async def test_list_instances_field_headers_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = cloud_filestore_service.ListInstancesRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_instances), '__call__') as call:
...
def test_list_instances_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_instances(cloud_filestore_service.ListInstancesRequest(), parent='parent_value')
...
async def test_list_instances_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_instances(cloud_filestore_service.ListInstancesRequest(), parent='parent_value')

def test_list_instances_pager(transport_name: str='grpc'):
    if False:
        i = 10
        return i + 15
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_instances), '__call__') as call:
        call.side_effect = (cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance(), cloud_filestore_service.Instance(), cloud_filestore_service.Instance()], next_page_token='abc'), cloud_filestore_service.ListInstancesResponse(instances=[], next_page_token='def'), cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance()], next_page_token='ghi'), cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance(), cloud_filestore_service.Instance()]), RuntimeError)
        metadata = ()
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.GetInstanceRequest, dict])
def test_get_instance(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_instance), '__call__') as call:
        call.return_value = cloud_filestore_service.Instance(name='name_value', description='description_value', state=cloud_filestore_service.Instance.State.CREATING, status_message='status_message_value', tier=cloud_filestore_service.Instance.Tier.STANDARD, etag='etag_value', satisfies_pzi=True, kms_key_name='kms_key_name_value', suspension_reasons=[cloud_filestore_service.Instance.SuspensionReason.KMS_KEY_ISSUE])
...
async def test_get_instance_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.GetInstanceRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_instance), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.Instance(name='name_value', description='description_value', state=cloud_filestore_service.Instance.State.CREATING, status_message='status_message_value', tier=cloud_filestore_service.Instance.Tier.STANDARD, etag='etag_value', satisfies_pzi=True, kms_key_name='kms_key_name_value', suspension_reasons=[cloud_filestore_service.Instance.SuspensionReason.KMS_KEY_ISSUE]))
...
def test_get_instance_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_instance(cloud_filestore_service.GetInstanceRequest(), name='name_value')
...
async def test_get_instance_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_instance(cloud_filestore_service.GetInstanceRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.CreateInstanceRequest, dict])
...
def test_create_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.create_instance), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_instance(parent='parent_value', instance=cloud_filestore_service.Instance(name='name_value'), instance_id='instance_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_instance_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_instance(cloud_filestore_service.CreateInstanceRequest(), parent='parent_value', instance=cloud_filestore_service.Instance(name='name_value'), instance_id='instance_id_value')
...
async def test_create_instance_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_instance), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_instance(parent='parent_value', instance=cloud_filestore_service.Instance(name='name_value'), instance_id='instance_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_instance_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_instance(cloud_filestore_service.CreateInstanceRequest(), parent='parent_value', instance=cloud_filestore_service.Instance(name='name_value'), instance_id='instance_id_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.UpdateInstanceRequest, dict])
...
def test_update_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.update_instance), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_instance(instance=cloud_filestore_service.Instance(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].instance
        mock_val = cloud_filestore_service.Instance(name='name_value')
...
def test_update_instance_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_instance(cloud_filestore_service.UpdateInstanceRequest(), instance=cloud_filestore_service.Instance(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_instance_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_instance), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_instance(instance=cloud_filestore_service.Instance(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].instance
        mock_val = cloud_filestore_service.Instance(name='name_value')
...
async def test_update_instance_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_instance(cloud_filestore_service.UpdateInstanceRequest(), instance=cloud_filestore_service.Instance(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))

@pytest.mark.parametrize('request_type', [cloud_filestore_service.RestoreInstanceRequest, dict])
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.RevertInstanceRequest, dict])
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.DeleteInstanceRequest, dict])
...
def test_delete_instance_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_instance(cloud_filestore_service.DeleteInstanceRequest(), name='name_value')
...
async def test_delete_instance_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_instance(cloud_filestore_service.DeleteInstanceRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.ListSnapshotsRequest, dict])
def test_list_snapshots(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_snapshots), '__call__') as call:
        call.return_value = cloud_filestore_service.ListSnapshotsResponse(next_page_token='next_page_token_value')
...
async def test_list_snapshots_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.ListSnapshotsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_snapshots), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.ListSnapshotsResponse(next_page_token='next_page_token_value'))
...
def test_list_snapshots_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_snapshots(cloud_filestore_service.ListSnapshotsRequest(), parent='parent_value')
...
async def test_list_snapshots_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_snapshots(cloud_filestore_service.ListSnapshotsRequest(), parent='parent_value')
...
def test_list_snapshots_pager(transport_name: str='grpc'):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_snapshots), '__call__') as call:
        call.side_effect = (cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot()], next_page_token='abc'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[], next_page_token='def'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot()], next_page_token='ghi'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot()]), RuntimeError)
        metadata = ()
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', ''),)),)
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.GetSnapshotRequest, dict])
def test_get_snapshot(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_snapshot), '__call__') as call:
        call.return_value = cloud_filestore_service.Snapshot(name='name_value', description='description_value', state=cloud_filestore_service.Snapshot.State.CREATING, filesystem_used_bytes=2267)
...
async def test_get_snapshot_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.GetSnapshotRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_snapshot), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.Snapshot(name='name_value', description='description_value', state=cloud_filestore_service.Snapshot.State.CREATING, filesystem_used_bytes=2267))
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.CreateSnapshotRequest, dict])
...
def test_create_snapshot_flattened():
    ...
    with mock.patch.object(type(client.transport.create_snapshot), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_snapshot(parent='parent_value', snapshot=cloud_filestore_service.Snapshot(name='name_value'), snapshot_id='snapshot_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_snapshot_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_snapshot(cloud_filestore_service.CreateSnapshotRequest(), parent='parent_value', snapshot=cloud_filestore_service.Snapshot(name='name_value'), snapshot_id='snapshot_id_value')
...
async def test_create_snapshot_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_snapshot), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_snapshot(parent='parent_value', snapshot=cloud_filestore_service.Snapshot(name='name_value'), snapshot_id='snapshot_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_snapshot_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_snapshot(cloud_filestore_service.CreateSnapshotRequest(), parent='parent_value', snapshot=cloud_filestore_service.Snapshot(name='name_value'), snapshot_id='snapshot_id_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.DeleteSnapshotRequest, dict])
...
def test_delete_snapshot_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_snapshot(cloud_filestore_service.DeleteSnapshotRequest(), name='name_value')
...
async def test_delete_snapshot_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_snapshot(cloud_filestore_service.DeleteSnapshotRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.UpdateSnapshotRequest, dict])
...
def test_update_snapshot_flattened():
    ...
    with mock.patch.object(type(client.transport.update_snapshot), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_snapshot(snapshot=cloud_filestore_service.Snapshot(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].snapshot
        mock_val = cloud_filestore_service.Snapshot(name='name_value')
...
def test_update_snapshot_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_snapshot(cloud_filestore_service.UpdateSnapshotRequest(), snapshot=cloud_filestore_service.Snapshot(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_snapshot_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_snapshot), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_snapshot(snapshot=cloud_filestore_service.Snapshot(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].snapshot
        mock_val = cloud_filestore_service.Snapshot(name='name_value')
...
async def test_update_snapshot_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_snapshot(cloud_filestore_service.UpdateSnapshotRequest(), snapshot=cloud_filestore_service.Snapshot(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))

@pytest.mark.parametrize('request_type', [cloud_filestore_service.ListBackupsRequest, dict])
def test_list_backups(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_backups), '__call__') as call:
        call.return_value = cloud_filestore_service.ListBackupsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
async def test_list_backups_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.ListBackupsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_backups), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.ListBackupsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value']))
...
def test_list_backups_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_backups(cloud_filestore_service.ListBackupsRequest(), parent='parent_value')
...
async def test_list_backups_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_backups(cloud_filestore_service.ListBackupsRequest(), parent='parent_value')
...
def test_list_backups_pager(transport_name: str='grpc'):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_backups), '__call__') as call:
        call.side_effect = (cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup(), cloud_filestore_service.Backup(), cloud_filestore_service.Backup()], next_page_token='abc'), cloud_filestore_service.ListBackupsResponse(backups=[], next_page_token='def'), cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup()], next_page_token='ghi'), cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup(), cloud_filestore_service.Backup()]), RuntimeError)
        metadata = ()
        metadata = tuple(metadata) + (gapic_v1.routing_header.to_grpc_metadata((('parent', ''),)),)
...
@pytest.mark.parametrize('request_type', [cloud_filestore_service.GetBackupRequest, dict])
def test_get_backup(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_backup), '__call__') as call:
        call.return_value = cloud_filestore_service.Backup(name='name_value', description='description_value', state=cloud_filestore_service.Backup.State.CREATING, capacity_gb=1142, storage_bytes=1403, source_instance='source_instance_value', source_file_share='source_file_share_value', source_instance_tier=cloud_filestore_service.Instance.Tier.STANDARD, download_bytes=1502, satisfies_pzi=True, kms_key='kms_key_value')
...
async def test_get_backup_async(transport: str='grpc_asyncio', request_type=cloud_filestore_service.GetBackupRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_backup), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(cloud_filestore_service.Backup(name='name_value', description='description_value', state=cloud_filestore_service.Backup.State.CREATING, capacity_gb=1142, storage_bytes=1403, source_instance='source_instance_value', source_file_share='source_file_share_value', source_instance_tier=cloud_filestore_service.Instance.Tier.STANDARD, download_bytes=1502, satisfies_pzi=True, kms_key='kms_key_value'))
...
def test_get_backup_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_backup(cloud_filestore_service.GetBackupRequest(), name='name_value')
...
async def test_get_backup_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_backup(cloud_filestore_service.GetBackupRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.CreateBackupRequest, dict])
...
def test_create_backup_flattened():
    ...
    with mock.patch.object(type(client.transport.create_backup), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.create_backup(parent='parent_value', backup=cloud_filestore_service.Backup(name='name_value'), backup_id='backup_id_value')
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
def test_create_backup_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_backup(cloud_filestore_service.CreateBackupRequest(), parent='parent_value', backup=cloud_filestore_service.Backup(name='name_value'), backup_id='backup_id_value')
...
async def test_create_backup_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_backup), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_backup(parent='parent_value', backup=cloud_filestore_service.Backup(name='name_value'), backup_id='backup_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_backup_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_backup(cloud_filestore_service.CreateBackupRequest(), parent='parent_value', backup=cloud_filestore_service.Backup(name='name_value'), backup_id='backup_id_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.DeleteBackupRequest, dict])
...
def test_delete_backup_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_backup(cloud_filestore_service.DeleteBackupRequest(), name='name_value')
...
async def test_delete_backup_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_backup(cloud_filestore_service.DeleteBackupRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [cloud_filestore_service.UpdateBackupRequest, dict])
...
def test_update_backup_flattened():
    ...
    with mock.patch.object(type(client.transport.update_backup), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        client.update_backup(backup=cloud_filestore_service.Backup(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].backup
        mock_val = cloud_filestore_service.Backup(name='name_value')
...
def test_update_backup_flattened_error():
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.update_backup(cloud_filestore_service.UpdateBackupRequest(), backup=cloud_filestore_service.Backup(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_update_backup_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_backup), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_backup(backup=cloud_filestore_service.Backup(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].backup
        mock_val = cloud_filestore_service.Backup(name='name_value')
...
async def test_update_backup_flattened_error_async():
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_backup(cloud_filestore_service.UpdateBackupRequest(), backup=cloud_filestore_service.Backup(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
def test_list_instances_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.ListInstancesResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
...
def test_list_instances_rest_interceptors(null_interceptor):
    if False:
        for i in range(10):
            print('nop')
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_list_instances') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_list_instances') as pre:
        ...
        req.return_value._content = cloud_filestore_service.ListInstancesResponse.to_json(cloud_filestore_service.ListInstancesResponse())
        request = cloud_filestore_service.ListInstancesRequest()
...
def test_list_instances_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.ListInstancesRequest):
    if False:
        return 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'parent': 'projects/sample1/locations/sample2'}
...
def test_list_instances_rest_pager(transport: str='rest'):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance(), cloud_filestore_service.Instance(), cloud_filestore_service.Instance()], next_page_token='abc'), cloud_filestore_service.ListInstancesResponse(instances=[], next_page_token='def'), cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance()], next_page_token='ghi'), cloud_filestore_service.ListInstancesResponse(instances=[cloud_filestore_service.Instance(), cloud_filestore_service.Instance()]))
...
def test_get_instance_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.Instance(name='name_value', description='description_value', state=cloud_filestore_service.Instance.State.CREATING, status_message='status_message_value', tier=cloud_filestore_service.Instance.Tier.STANDARD, etag='etag_value', satisfies_pzi=True, kms_key_name='kms_key_name_value', suspension_reasons=[cloud_filestore_service.Instance.SuspensionReason.KMS_KEY_ISSUE])
        response_value = Response()
        response_value.status_code = 200
...
def test_get_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_get_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_get_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_filestore_service.Instance.to_json(cloud_filestore_service.Instance())
        request = cloud_filestore_service.GetInstanceRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
...
def test_get_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.GetInstanceRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_create_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_create_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.CreateInstanceRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2'}
        mock_args = dict(parent='parent_value', instance=cloud_filestore_service.Instance(name='name_value'), instance_id='instance_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_update_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_update_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_update_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.UpdateInstanceRequest):
    if False:
        print('Hello World!')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'instance': {'name': 'projects/sample1/locations/sample2/instances/sample3'}}
...
def test_update_instance_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(instance=cloud_filestore_service.Instance(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_restore_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('name', 'fileShare'))
...
def test_restore_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_restore_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_restore_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        pre.return_value = (request, metadata)
        post.return_value = operations_pb2.Operation()
        client.restore_instance(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_restore_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.RestoreInstanceRequest):
    if False:
        print('Hello World!')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/locations/sample2/instances/sample3'}
...
def test_revert_instance_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(()) & set(('name', 'targetSnapshotId'))
...
def test_revert_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_revert_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_revert_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        pre.return_value = (request, metadata)
        post.return_value = operations_pb2.Operation()
        client.revert_instance(request, metadata=[('key', 'val'), ('cephalopod', 'squid')])
        pre.assert_called_once()
        post.assert_called_once()

def test_revert_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.RevertInstanceRequest):
    if False:
        for i in range(10):
            print('nop')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_delete_instance_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_delete_instance') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_delete_instance') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_instance_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.DeleteInstanceRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_snapshots_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.ListSnapshotsResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_snapshots_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_list_snapshots') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_list_snapshots') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_filestore_service.ListSnapshotsResponse.to_json(cloud_filestore_service.ListSnapshotsResponse())
        request = cloud_filestore_service.ListSnapshotsRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
...
def test_list_snapshots_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.ListSnapshotsRequest):
    if False:
        i = 10
        return i + 15
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_snapshots_rest_pager(transport: str='rest'):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot()], next_page_token='abc'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[], next_page_token='def'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot()], next_page_token='ghi'), cloud_filestore_service.ListSnapshotsResponse(snapshots=[cloud_filestore_service.Snapshot(), cloud_filestore_service.Snapshot()]))
        response = response + response
...
def test_get_snapshot_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.Snapshot(name='name_value', description='description_value', state=cloud_filestore_service.Snapshot.State.CREATING, filesystem_used_bytes=2267)
        response_value = Response()
        response_value.status_code = 200
...
def test_get_snapshot_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_get_snapshot') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_get_snapshot') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_filestore_service.Snapshot.to_json(cloud_filestore_service.Snapshot())
        request = cloud_filestore_service.GetSnapshotRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
...
def test_get_snapshot_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.GetSnapshotRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_snapshot_rest(request_type):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'parent': 'projects/sample1/locations/sample2/instances/sample3'}
    request_init['snapshot'] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'filesystem_used_bytes': 2267}
...
def test_create_snapshot_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('snapshotId',)) & set(('parent', 'snapshotId', 'snapshot'))
...
def test_create_snapshot_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_create_snapshot') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_create_snapshot') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_snapshot_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.CreateSnapshotRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2/instances/sample3'}
        mock_args = dict(parent='parent_value', snapshot=cloud_filestore_service.Snapshot(name='name_value'), snapshot_id='snapshot_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_delete_snapshot_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_delete_snapshot') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_delete_snapshot') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_snapshot_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.DeleteSnapshotRequest):
    if False:
        print('Hello World!')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/locations/sample2/instances/sample3/snapshots/sample4'}
...
def test_update_snapshot_rest(request_type):
    ...
    request_init['snapshot'] = {'name': 'projects/sample1/locations/sample2/instances/sample3/snapshots/sample4', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'filesystem_used_bytes': 2267}
...
def test_update_snapshot_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_update_snapshot') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_update_snapshot') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_snapshot_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.UpdateSnapshotRequest):
    if False:
        print('Hello World!')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'snapshot': {'name': 'projects/sample1/locations/sample2/instances/sample3/snapshots/sample4'}}
...
def test_update_snapshot_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(snapshot=cloud_filestore_service.Snapshot(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_list_backups_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.ListBackupsResponse(next_page_token='next_page_token_value', unreachable=['unreachable_value'])
        response_value = Response()
        response_value.status_code = 200
...
def test_list_backups_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_list_backups') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_list_backups') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_filestore_service.ListBackupsResponse.to_json(cloud_filestore_service.ListBackupsResponse())
        request = cloud_filestore_service.ListBackupsRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
...
def test_list_backups_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.ListBackupsRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_list_backups_rest_pager(transport: str='rest'):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup(), cloud_filestore_service.Backup(), cloud_filestore_service.Backup()], next_page_token='abc'), cloud_filestore_service.ListBackupsResponse(backups=[], next_page_token='def'), cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup()], next_page_token='ghi'), cloud_filestore_service.ListBackupsResponse(backups=[cloud_filestore_service.Backup(), cloud_filestore_service.Backup()]))
        response = response + response
...
def test_get_backup_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = cloud_filestore_service.Backup(name='name_value', description='description_value', state=cloud_filestore_service.Backup.State.CREATING, capacity_gb=1142, storage_bytes=1403, source_instance='source_instance_value', source_file_share='source_file_share_value', source_instance_tier=cloud_filestore_service.Instance.Tier.STANDARD, download_bytes=1502, satisfies_pzi=True, kms_key='kms_key_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_backup_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_get_backup') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_get_backup') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_filestore_service.Backup.to_json(cloud_filestore_service.Backup())
        request = cloud_filestore_service.GetBackupRequest()
        metadata = [('key', 'val'), ('cephalopod', 'squid')]
        pre.return_value = (request, metadata)
...
def test_get_backup_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.GetBackupRequest):
    if False:
        print('Hello World!')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'name': 'projects/sample1/locations/sample2/backups/sample3'}
...
def test_create_backup_rest(request_type):
    ...
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init['backup'] = {'name': 'name_value', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'capacity_gb': 1142, 'storage_bytes': 1403, 'source_instance': 'source_instance_value', 'source_file_share': 'source_file_share_value', 'source_instance_tier': 1, 'download_bytes': 1502, 'satisfies_pzs': {'value': True}, 'satisfies_pzi': True, 'kms_key': 'kms_key_value'}
...
def test_create_backup_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('backupId',)) & set(('parent', 'backup', 'backupId'))
...
def test_create_backup_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_create_backup') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_create_backup') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_backup_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.CreateBackupRequest):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_create_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = operations_pb2.Operation(name='operations/spam')
        sample_request = {'parent': 'projects/sample1/locations/sample2'}
        mock_args = dict(parent='parent_value', backup=cloud_filestore_service.Backup(name='name_value'), backup_id='backup_id_value')
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_delete_backup_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_delete_backup') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_delete_backup') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_backup_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.DeleteBackupRequest):
    if False:
        for i in range(10):
            print('nop')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_update_backup_rest(request_type):
    ...
    request_init['backup'] = {'name': 'projects/sample1/locations/sample2/backups/sample3', 'description': 'description_value', 'state': 1, 'create_time': {'seconds': 751, 'nanos': 543}, 'labels': {}, 'capacity_gb': 1142, 'storage_bytes': 1403, 'source_instance': 'source_instance_value', 'source_file_share': 'source_file_share_value', 'source_instance_tier': 1, 'download_bytes': 1502, 'satisfies_pzs': {'value': True}, 'satisfies_pzi': True, 'kms_key': 'kms_key_value'}
...
def test_update_backup_rest_interceptors(null_interceptor):
    ...
    transport = transports.CloudFilestoreManagerRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.CloudFilestoreManagerRestInterceptor())
    client = CloudFilestoreManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'post_update_backup') as post, mock.patch.object(transports.CloudFilestoreManagerRestInterceptor, 'pre_update_backup') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_backup_rest_bad_request(transport: str='rest', request_type=cloud_filestore_service.UpdateBackupRequest):
    if False:
        return 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'backup': {'name': 'projects/sample1/locations/sample2/backups/sample3'}}
...
def test_update_backup_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(backup=cloud_filestore_service.Backup(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        json_return_value = json_format.MessageToJson(return_value)
...
def test_credentials_transport_error():
    if False:
        while True:
            i = 10
    transport = transports.CloudFilestoreManagerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.CloudFilestoreManagerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CloudFilestoreManagerClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.CloudFilestoreManagerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = CloudFilestoreManagerClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.CloudFilestoreManagerGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = CloudFilestoreManagerClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.CloudFilestoreManagerGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.CloudFilestoreManagerGrpcTransport, transports.CloudFilestoreManagerGrpcAsyncIOTransport, transports.CloudFilestoreManagerRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = CloudFilestoreManagerClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_cloud_filestore_manager_base_transport():
    ...
    with mock.patch('google.cloud.filestore_v1.services.cloud_filestore_manager.transports.CloudFilestoreManagerTransport.__init__') as Transport:
        ...
        transport = transports.CloudFilestoreManagerTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_instances', 'get_instance', 'create_instance', 'update_instance', 'restore_instance', 'revert_instance', 'delete_instance', 'list_snapshots', 'get_snapshot', 'create_snapshot', 'delete_snapshot', 'update_snapshot', 'list_backups', 'get_backup', 'create_backup', 'delete_backup', 'update_backup', 'get_location', 'list_locations', 'get_operation', 'cancel_operation', 'delete_operation', 'list_operations')
...
def test_cloud_filestore_manager_base_transport_with_credentials_file():
    if False:
        return 10
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.filestore_v1.services.cloud_filestore_manager.transports.CloudFilestoreManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CloudFilestoreManagerTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_cloud_filestore_manager_base_transport_with_adc():
    if False:
        while True:
            i = 10
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.filestore_v1.services.cloud_filestore_manager.transports.CloudFilestoreManagerTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.CloudFilestoreManagerGrpcTransport, grpc_helpers), (transports.CloudFilestoreManagerGrpcAsyncIOTransport, grpc_helpers_async)])
def test_cloud_filestore_manager_transport_create_channel(transport_class, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel', autospec=True) as create_channel:
        ...
        adc.return_value = (creds, None)
        transport_class(quota_project_id='octopus', scopes=['1', '2'])
        create_channel.assert_called_with('file.googleapis.com:443', credentials=creds, credentials_file=None, quota_project_id='octopus', default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=['1', '2'], default_host='file.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])
...
def test_cloud_filestore_manager_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='file.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('file.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://file.googleapis.com')
...
def test_cloud_filestore_manager_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='file.googleapis.com:8000'), transport=transport_name)
    assert client.transport._host == ('file.googleapis.com:8000' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://file.googleapis.com:8000')
...
def test_cloud_filestore_manager_client_transport_session_collision(transport_name):
    ...
    client1 = CloudFilestoreManagerClient(credentials=creds1, transport=transport_name)
    client2 = CloudFilestoreManagerClient(credentials=creds2, transport=transport_name)
...
def test_cloud_filestore_manager_grpc_transport_channel():
    ...
    transport = transports.CloudFilestoreManagerGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_cloud_filestore_manager_grpc_asyncio_transport_channel():
    ...
    transport = transports.CloudFilestoreManagerGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_cloud_filestore_manager_grpc_lro_async_client():
    if False:
        while True:
            i = 10
    client = CloudFilestoreManagerAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_snapshot_path():
    ...
    instance = 'whelk'
    snapshot = 'octopus'
    expected = 'projects/{project}/locations/{location}/instances/{instance}/snapshots/{snapshot}'.format(project=project, location=location, instance=instance, snapshot=snapshot)
...
def test_parse_snapshot_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'oyster', 'location': 'nudibranch', 'instance': 'cuttlefish', 'snapshot': 'mussel'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.CloudFilestoreManagerTransport, '_prep_wrapped_messages') as prep:
        client = CloudFilestoreManagerClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(CloudFilestoreManagerClient, transports.CloudFilestoreManagerGrpcTransport), (CloudFilestoreManagerAsyncClient, transports.CloudFilestoreManagerGrpcAsyncIOTransport)])
