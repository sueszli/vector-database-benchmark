...
from ..utils import determine_ext, ExtractorError, int_or_none, float_or_none, js_to_json, parse_iso8601, remove_end, strip_or_none, try_get

class TV2IE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?tv2\\.no/v(?:ideo)?\\d*/(?:[^?#]+/)*(?P<id>\\d+)'
    _TESTS = [{'url': 'http://www.tv2.no/v/1791207/', 'info_dict': {'id': '1791207', 'ext': 'mp4', 'title': 'Her kolliderer romsonden med asteroiden ', 'description': 'En romsonde har krasjet inn i en asteroide i verdensrommet. Kollisjonen skjedde klokken 01:14 natt til tirsdag 27. september norsk tid. \n\nNasa kaller det sitt første forsøk på planetforsvar.', 'timestamp': 1664238190, 'upload_date': '20220927', 'duration': 146, 'thumbnail': 're:^https://.*$', 'view_count': int, 'categories': list}}, {'url': 'http://www.tv2.no/v2/916509', 'only_matching': True}, {'url': 'https://www.tv2.no/video/nyhetene/her-kolliderer-romsonden-med-asteroiden/1791207/', 'only_matching': True}]
    _PROTOCOLS = ('HLS', 'DASH')
    _GEO_COUNTRIES = ['NO']
...
class TV2ArticleIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?tv2\\.no/(?!v(?:ideo)?\\d*/)[^?#]+/(?P<id>\\d+)'
    _TESTS = [{'url': 'https://www.tv2.no/underholdning/forraeder/katarina-flatland-angrer-etter-forraeder-exit/15095188/', 'info_dict': {'id': '15095188', 'title': 'Katarina Flatland angrer etter Forræder-exit', 'description': 'SANDEFJORD (TV 2): Katarina Flatland (33) måtte følge i sine fars fotspor, da hun ble forvist fra Forræder.'}, 'playlist_count': 2}, {'url': 'http://www.tv2.no/a/6930542', 'only_matching': True}]
...
class KatsomoIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.mtv.fi/sarja/mtv-uutiset-live-33001002003/lahden-pelicans-teki-kovan-ratkaisun-ville-nieminen-pihalle-1181321', 'info_dict': {'id': '1181321', 'ext': 'mp4', 'title': 'Lahden Pelicans teki kovan ratkaisun – Ville Nieminen pihalle', 'description': 'Päätöksen teki Pelicansin hallitus.', 'timestamp': 1575116484, 'upload_date': '20191130', 'duration': 37.12, 'view_count': int, 'categories': list}, 'params': {'skip_download': True}}, {'url': 'http://www.katsomo.fi/#!/jakso/33001005/studio55-fi/658521/jukka-kuoppamaki-tekee-yha-lauluja-vaikka-lentokoneessa', 'only_matching': True}, {'url': 'https://www.mtvuutiset.fi/video/prog1311159', 'only_matching': True}, {'url': 'https://www.katsomo.fi/#!/jakso/1311159', 'only_matching': True}]
