...
class LnkGoIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.lnkgo.lt/visi-video/aktualai-pratesimas/ziurek-putka-trys-klausimai', 'info_dict': {'id': '10809', 'ext': 'mp4', 'title': "Put'ka: Trys Klausimai", 'upload_date': '20161216', 'description': 'Seniai matytas Put’ka užduoda tris klausimėlius. Pabandykime surasti atsakymus.', 'age_limit': 18, 'duration': 117, 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1481904000}, 'params': {'skip_download': True}}, {'url': 'http://lnkgo.alfa.lt/visi-video/aktualai-pratesimas/ziurek-nerdas-taiso-kompiuteri-2', 'info_dict': {'id': '10467', 'ext': 'mp4', 'title': 'Nėrdas: Kompiuterio Valymas', 'upload_date': '20150113', 'description': 'md5:7352d113a242a808676ff17e69db6a69', 'age_limit': 18, 'duration': 346, 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1421164800}, 'params': {'skip_download': True}}, {'url': 'https://lnk.lt/video/neigalieji-tv-bokste/37413', 'only_matching': True}]
    _AGE_LIMITS = {'N-7': 7, 'N-14': 14, 'S': 18}
...
class LnkIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://lnk.lt/zinios/79791', 'info_dict': {'id': '79791', 'ext': 'mp4', 'title': 'LNK.lt: Viešintų gyventojai sukilo prieš radijo bangų siųstuvą', 'description': 'Svarbiausios naujienos trumpai, LNK žinios ir Info dienos pokalbiai.', 'view_count': int, 'duration': 233, 'upload_date': '20191123', 'thumbnail': 're:^https?://.*\\.jpg$', 'episode_number': 13431, 'series': 'Naujausi žinių reportažai', 'episode': 'Episode 13431'}, 'params': {'skip_download': True}}, {'url': 'https://lnk.lt/istorijos-trumpai/152546', 'info_dict': {'id': '152546', 'ext': 'mp4', 'title': 'Radžio koncertas gaisre ', 'description': 'md5:0666b5b85cb9fc7c1238dec96f71faba', 'view_count': int, 'duration': 54, 'upload_date': '20220105', 'thumbnail': 're:^https?://.*\\.jpg$', 'episode_number': 1036, 'series': 'Istorijos trumpai', 'episode': 'Episode 1036'}, 'params': {'skip_download': True}}, {'url': 'https://lnk.lt/gyvunu-pasaulis/151549', 'info_dict': {'id': '151549', 'ext': 'mp4', 'title': 'Gyvūnų pasaulis', 'description': '', 'view_count': int, 'duration': 1264, 'upload_date': '20220108', 'thumbnail': 're:^https?://.*\\.jpg$', 'episode_number': 16, 'series': 'Gyvūnų pasaulis', 'episode': 'Episode 16'}, 'params': {'skip_download': True}}]
