...
import proto
__protobuf__ = proto.module(package='google.cloud.bigquery.datapolicies.v1', manifest={'CreateDataPolicyRequest', 'UpdateDataPolicyRequest', 'RenameDataPolicyRequest', 'DeleteDataPolicyRequest', 'GetDataPolicyRequest', 'ListDataPoliciesRequest', 'ListDataPoliciesResponse', 'DataPolicy', 'DataMaskingPolicy'})
...
class CreateDataPolicyRequest(proto.Message):
    ...
    data_policy: 'DataPolicy' = proto.Field(proto.MESSAGE, number=2, message='DataPolicy')
...
class UpdateDataPolicyRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            allowed.
    """
    data_policy: 'DataPolicy' = proto.Field(proto.MESSAGE, number=1, message='DataPolicy')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)

class RenameDataPolicyRequest(proto.Message):
    ...
    new_data_policy_id: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    data_policies: MutableSequence['DataPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataPolicy')
...
class DataPolicy(proto.Message):
    ...
    class DataPolicyType(proto.Enum):
        ...
        COLUMN_LEVEL_SECURITY_POLICY = 3
        DATA_MASKING_POLICY = 2
    policy_tag: str = proto.Field(proto.STRING, number=4, oneof='matching_label')
    data_masking_policy: 'DataMaskingPolicy' = proto.Field(proto.MESSAGE, number=5, oneof='policy', message='DataMaskingPolicy')
    name: str = proto.Field(proto.STRING, number=1)
    data_policy_type: DataPolicyType = proto.Field(proto.ENUM, number=2, enum=DataPolicyType)
    data_policy_id: str = proto.Field(proto.STRING, number=3)

class DataMaskingPolicy(proto.Message):
    """The data masking policy that is used to specify data masking
    rule.
    ...
    class PredefinedExpression(proto.Enum):
        ...
        EMAIL_MASK = 12
        DATE_YEAR_MASK = 13
    predefined_expression: PredefinedExpression = proto.Field(proto.ENUM, number=1, oneof='masking_expression', enum=PredefinedExpression)
    routine: str = proto.Field(proto.STRING, number=3, oneof='masking_expression')
