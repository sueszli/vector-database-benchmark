...
for (database, formats, entry, length, checksum) in [('nuccore', ['fasta', 'gb'], 'X52960', 248, 'Ktxz0HgMlhQmrKTuZpOxPZJ6zGU'), ('nucleotide', ['fasta', 'gb'], '6273291', 902, 'bLhlq4mEFJOoS9PieOx4nhGnjAQ'), ('protein', ['fasta', 'gbwithparts'], '16130152', 367, 'fCjcjMFeGIrilHAn6h+yju267lg')]:
    ...
    def funct(d, f, e, l, c):
        ...
        return method
    setattr(EntrezTests, f'test_{database}_{entry}', funct(database, formats, entry, length, checksum))
    del funct
