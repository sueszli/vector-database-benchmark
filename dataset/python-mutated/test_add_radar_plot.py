...
class TestAddRadarPlot(TestCase):
    ...
    def test_add_orderedlist_of_radar_plots(self):
        ...
        layout.add(OrderedList().add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT))
    ...
    def test_add_unorderedlist_of_radar_plots(self):
        ...
        layout.add(UnorderedList().add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT))
    ...
    def test_add_table_of_radar_plots(self):
        ...
        layout.add(FlexibleColumnWidthTable(number_of_columns=2, number_of_rows=2).add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT).add(TestAddRadarPlot.RADAR_PLOT))
