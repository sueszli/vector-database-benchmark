...
EXAMPLES: dict[str, Any] = {'arkit_scenes': {'build_args': []}, 'structure_from_motion': {'build_args': ['--dataset=colmap_fiat', '--resize=800x600']}, 'dicom_mri': {'build_args': []}, 'human_pose_tracking': {'build_args': []}, 'plots': {'build_args': []}, 'detect_and_track_objects': {'build_args': []}, 'dna': {'build_args': []}}
