...
secrets_manager_inputs = {'fields': [{'id': 'aws_access_key', 'label': _('AWS Access Key'), 'type': 'string'}, {'id': 'aws_secret_key', 'label': _('AWS Secret Key'), 'type': 'string', 'secret': True}], 'metadata': [{'id': 'region_name', 'label': _('AWS Secrets Manager Region'), 'type': 'string', 'help_text': _('Region which the secrets manager is located')}, {'id': 'secret_name', 'label': _('AWS Secret Name'), 'type': 'string'}], 'required': ['aws_access_key', 'aws_secret_key', 'region_name', 'secret_name']}
