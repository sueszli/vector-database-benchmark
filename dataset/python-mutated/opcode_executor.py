...
from ...utils import ENV_MIN_GRAPH_SIZE, BreakGraphError, FallbackError, InnerError, OrderedSet, SotUndefinedVar, log, log_do
from ..custom_code import CustomCode
from ..instruction_utils import Instruction, Space, analysis_inputs, analysis_used_names_with_space, calc_stack_effect, get_instructions
from ..instruction_utils.opcode_info import JumpDirection, PopJumpCond
from .dispatch_functions import operator_BAD, operator_exception_match, operator_in, operator_is_none, operator_is_not_none, operator_not_in
from .dispatcher import Dispatcher
from .function_graph import FunctionGraph
from .instr_flag import CALL_FUNCTION_EX_FLAG as CFE, FORMAT_VALUE_FLAG as FV, MAKE_FUNCTION_FLAG as MF
from .pycode_generator import PyCodeGen
from .tracker import CellTracker, ConstTracker, DanglingTracker, DummyTracker, LocalTracker
from .variable_stack import VariableStack
from .variables import BuiltinVariable, CellVariable, ConstantVariable, ContainerVariable, DictVariable, GlobalVariable, ListVariable, MethodVariable, NullVariable, SequenceIterVariable, SliceVariable, TensorVariable, TupleVariable, UserDefinedFunctionVariable, VariableBase, VariableFactory
SUPPORT_COMPARE_OP = {'>': operator.gt, '<': operator.lt, '>=': operator.ge, '<=': operator.le, '==': operator.eq, '!=': operator.ne, 'is not': operator.is_not, 'is': operator.is_, 'in': operator_in, 'not in': operator_not_in, 'exception match': operator_exception_match, 'BAD': operator_BAD}
...
class OpcodeExecutorBase:
    ...
    POP_JUMP_FORWARD_IF_NOT_NONE = pop_jump_if_op_wrapper([operator_is_not_none])
