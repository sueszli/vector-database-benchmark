...
from mycroft.util import resolve_resource_file, curate_cache, create_file, get_temp_path, get_cache_directory, read_stripped_lines, read_dict
test_config = {'data_dir': join(dirname(__file__), 'datadir'), 'cache_dir': tempfile.gettempdir()}
