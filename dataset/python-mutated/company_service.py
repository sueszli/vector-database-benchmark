...
__protobuf__ = proto.module(package='google.cloud.talent.v4beta1', manifest={'CreateCompanyRequest', 'GetCompanyRequest', 'UpdateCompanyRequest', 'DeleteCompanyRequest', 'ListCompaniesRequest', 'ListCompaniesResponse'})
...
class CreateCompanyRequest(proto.Message):
    ...
    company: gct_company.Company = proto.Field(proto.MESSAGE, number=2, message=gct_company.Company)
...
class UpdateCompanyRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            supported.
    """
    company: gct_company.Company = proto.Field(proto.MESSAGE, number=1, message=gct_company.Company)
...
class ListCompaniesRequest(proto.Message):
    ...
    require_open_jobs: bool = proto.Field(proto.BOOL, number=4)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    companies: MutableSequence[gct_company.Company] = proto.RepeatedField(proto.MESSAGE, number=1, message=gct_company.Company)
