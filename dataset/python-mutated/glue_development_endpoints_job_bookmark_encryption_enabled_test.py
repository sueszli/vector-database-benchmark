...
class Test_glue_development_endpoints_job_bookmark_encryption_enabled:
    ...
    def test_glue_no_endpoints(self):
        ...
        with mock.patch('prowler.providers.aws.services.glue.glue_service.Glue', glue_client):
            from prowler.providers.aws.services.glue.glue_development_endpoints_job_bookmark_encryption_enabled.glue_development_endpoints_job_bookmark_encryption_enabled import glue_development_endpoints_job_bookmark_encryption_enabled
    ...
    def test_glue_encrypted_endpoint(self):
        ...
        with mock.patch('prowler.providers.aws.services.glue.glue_service.Glue', glue_client):
            ...
            assert search('has Job Bookmark encryption enabled with key', result[0].status_extended)
    ...
    def test_glue_unencrypted_endpoint(self):
        ...
        with mock.patch('prowler.providers.aws.services.glue.glue_service.Glue', glue_client):
            ...
            assert search('does not have Job Bookmark encryption enabled', result[0].status_extended)
            assert result[0].resource_id == 'test'
            assert result[0].resource_arn == 'arn_test'
