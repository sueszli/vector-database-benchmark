...
EXPECTED_ENTS = [[{'text': 'Barack Obama', 'type': 'PERSON', 'start_char': 0, 'end_char': 12}, {'text': 'Hawaii', 'type': 'GPE', 'start_char': 25, 'end_char': 31}], [{'text': '2008', 'type': 'DATE', 'start_char': 28, 'end_char': 32}], [{'text': 'Obama', 'type': 'PERSON', 'start_char': 0, 'end_char': 5}, {'text': 'Harvard', 'type': 'ORG', 'start_char': 15, 'end_char': 22}]]
...
class TestNERProcessor:
    ...
    def test_ents(self, processed_doc):
        ...
        for (doc, expected) in zip(processed_doc, EXPECTED_ENTS):
            check_entities_equal(doc, expected)
EXPECTED_MULTI_ENTS = [{'text': 'John Bauer', 'type': 'PERSON', 'start_char': 0, 'end_char': 10}, {'text': 'Stanford', 'type': 'ORG', 'start_char': 20, 'end_char': 28}, {'text': 'hip arthritis', 'type': 'DISEASE', 'start_char': 37, 'end_char': 50}, {'text': 'Chris Manning', 'type': 'PERSON', 'start_char': 66, 'end_char': 79}]
EXPECTED_MULTI_NER = [[('O', 'B-PERSON'), ('O', 'E-PERSON'), ('O', 'O'), ('O', 'O'), ('O', 'S-ORG'), ('O', 'O'), ('O', 'O'), ('B-DISEASE', 'O'), ('E-DISEASE', 'O'), ('O', 'O')], [('O', 'O'), ('O', 'O'), ('O', 'O'), ('O', 'B-PERSON'), ('O', 'E-PERSON')]]
