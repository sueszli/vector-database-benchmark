...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common_lexicon.BaseLexiconDNSAuthenticatorTest):
    ...
    def setUp(self):
        ...
        dns_test_common.write({'sakuracloud_api_token': API_TOKEN, 'sakuracloud_api_secret': API_SECRET}, path)
        self.config = mock.MagicMock(sakuracloud_credentials=path, sakuracloud_propagation_seconds=0)
