...
class MoveToNextLine(CanvasOperator):
    ...
    def invoke(self, canvas_stream_processor: 'CanvasStreamProcessor', operands: typing.List[AnyPDFType]=[], event_listeners: typing.List['EventListener']=[]) -> None:
        ...
        assert move_text_position_op, 'Operator Td must be defined for operator T* to function.'
        canvas = canvas_stream_processor.get_canvas()
        move_text_position_op.invoke(canvas_stream_processor, [bDecimal(0), -canvas.graphics_state.leading], event_listeners)