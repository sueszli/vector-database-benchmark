...
from sentry.models.artifactbundle import ArtifactBundle, ArtifactBundleArchive, DebugIdArtifactBundle, ReleaseArtifactBundle, SourceFileType
from sentry.models.project import Project
from sentry.models.release import Release
from sentry.models.releasefile import ARTIFACT_INDEX_FILENAME, ARTIFACT_INDEX_TYPE, ReleaseArchive, ReleaseFile
...
NO_DEBUG_ID_SDKS = {'sentry.javascript.capacitor', 'sentry.javascript.wasm', 'sentry.javascript.cordova', 'sentry.javascript.nextjs', 'sentry.javascript.sveltekit'}
...
class ScrapingResultFailure(TypedDict):
    ...
    reason: Literal['not_found', 'disabled', 'invalid_host', 'permission_denied', 'timeout', 'download_error', 'other']
    details: Optional[str]

class SourceMapScrapingProcessResult(TypedDict):
    source_file: Optional[Union[ScrapingResultSuccess, ScrapingResultNotAttempted, ScrapingResultFailure]]
    source_map: Optional[Union[ScrapingResultSuccess, ScrapingResultNotAttempted, ScrapingResultFailure]]
