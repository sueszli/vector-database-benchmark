...
from google.cloud.discoveryengine_v1alpha.services.site_search_engine_service import SiteSearchEngineServiceAsyncClient, SiteSearchEngineServiceClient, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(SiteSearchEngineServiceClient, 'grpc'), (SiteSearchEngineServiceAsyncClient, 'grpc_asyncio'), (SiteSearchEngineServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.SiteSearchEngineServiceGrpcTransport, 'grpc'), (transports.SiteSearchEngineServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.SiteSearchEngineServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class', [SiteSearchEngineServiceClient, SiteSearchEngineServiceAsyncClient])
@mock.patch.object(SiteSearchEngineServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(SiteSearchEngineServiceClient))
@mock.patch.object(SiteSearchEngineServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(SiteSearchEngineServiceAsyncClient))
...
def test_site_search_engine_service_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.site_search_engine_service.transports.SiteSearchEngineServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = SiteSearchEngineServiceClient(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(SiteSearchEngineServiceClient, transports.SiteSearchEngineServiceGrpcTransport, 'grpc', grpc_helpers), (SiteSearchEngineServiceAsyncClient, transports.SiteSearchEngineServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
@pytest.mark.parametrize('request_type', [site_search_engine_service.RecrawlUrisRequest, dict])
def test_recrawl_uris(request_type, transport: str='grpc'):
    if False:
        i = 10
        return i + 15
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_recrawl_uris_empty_call():
    if False:
        while True:
            i = 10
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.recrawl_uris), '__call__') as call:
        client.recrawl_uris()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
async def test_recrawl_uris_async(transport: str='grpc_asyncio', request_type=site_search_engine_service.RecrawlUrisRequest):
    client = SiteSearchEngineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.recrawl_uris), '__call__') as call:
...
def test_recrawl_uris_field_headers():
    if False:
        return 10
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials())
    ...
    assert ('x-goog-request-params', 'site_search_engine=site_search_engine_value') in kw['metadata']

@pytest.mark.asyncio
async def test_recrawl_uris_field_headers_async():
    client = SiteSearchEngineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = site_search_engine_service.RecrawlUrisRequest()
    request.site_search_engine = 'site_search_engine_value'
    with mock.patch.object(type(client.transport.recrawl_uris), '__call__') as call:
...
def test_recrawl_uris_rest(request_type):
    if False:
        for i in range(10):
            print('nop')
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_recrawl_uris_rest_interceptors(null_interceptor):
    if False:
        return 10
    transport = transports.SiteSearchEngineServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.SiteSearchEngineServiceRestInterceptor())
    client = SiteSearchEngineServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, 'post_recrawl_uris') as post, mock.patch.object(transports.SiteSearchEngineServiceRestInterceptor, 'pre_recrawl_uris') as pre:
...
def test_recrawl_uris_rest_bad_request(transport: str='rest', request_type=site_search_engine_service.RecrawlUrisRequest):
    if False:
        i = 10
        return i + 15
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
...
def test_credentials_transport_error():
    if False:
        print('Hello World!')
    transport = transports.SiteSearchEngineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.SiteSearchEngineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = SiteSearchEngineServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.SiteSearchEngineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = SiteSearchEngineServiceClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = SiteSearchEngineServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.SiteSearchEngineServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = SiteSearchEngineServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.SiteSearchEngineServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.SiteSearchEngineServiceGrpcTransport, transports.SiteSearchEngineServiceGrpcAsyncIOTransport, transports.SiteSearchEngineServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        i = 10
        return i + 15
    transport = SiteSearchEngineServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        return 10
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.SiteSearchEngineServiceGrpcTransport)
...
def test_site_search_engine_service_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.SiteSearchEngineServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_site_search_engine_service_base_transport():
    ...
    with mock.patch('google.cloud.discoveryengine_v1alpha.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport.__init__') as Transport:
        ...
        transport = transports.SiteSearchEngineServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('recrawl_uris', 'get_operation', 'list_operations')
...
def test_site_search_engine_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.discoveryengine_v1alpha.services.site_search_engine_service.transports.SiteSearchEngineServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.SiteSearchEngineServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.SiteSearchEngineServiceGrpcTransport, grpc_helpers), (transports.SiteSearchEngineServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
@pytest.mark.parametrize('transport_class', [transports.SiteSearchEngineServiceGrpcTransport, transports.SiteSearchEngineServiceGrpcAsyncIOTransport])
def test_site_search_engine_service_grpc_transport_client_cert_source_for_mtls(transport_class):
    if False:
        while True:
            i = 10
...
def test_site_search_engine_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.SiteSearchEngineServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_site_search_engine_service_host_no_port(transport_name):
    if False:
        return 10
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='discoveryengine.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('discoveryengine.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://discoveryengine.googleapis.com')
...
def test_site_search_engine_service_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='discoveryengine.googleapis.com:8000'), transport=transport_name)
...
def test_site_search_engine_service_client_transport_session_collision(transport_name):
    ...
    client1 = SiteSearchEngineServiceClient(credentials=creds1, transport=transport_name)
    client2 = SiteSearchEngineServiceClient(credentials=creds2, transport=transport_name)
...
def test_site_search_engine_service_grpc_transport_channel():
    ...
    transport = transports.SiteSearchEngineServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_site_search_engine_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.SiteSearchEngineServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.SiteSearchEngineServiceGrpcTransport, transports.SiteSearchEngineServiceGrpcAsyncIOTransport])
def test_site_search_engine_service_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        print('Hello World!')
...
def test_site_search_engine_service_grpc_lro_async_client():
    if False:
        print('Hello World!')
    client = SiteSearchEngineServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.SiteSearchEngineServiceTransport, '_prep_wrapped_messages') as prep:
        client = SiteSearchEngineServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(SiteSearchEngineServiceClient, transports.SiteSearchEngineServiceGrpcTransport), (SiteSearchEngineServiceAsyncClient, transports.SiteSearchEngineServiceGrpcAsyncIOTransport)])
