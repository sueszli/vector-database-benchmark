...
_field_option_as_arrow_metadata = partial(_option_as_arrow_metadata, prefix=BEAM_FIELD_OPTION_KEY_PREFIX)
_schema_option_as_arrow_metadata = partial(_option_as_arrow_metadata, prefix=BEAM_SCHEMA_OPTION_KEY_PREFIX)
...
_ARROW_PRIMITIVE_MAPPING = [(schema_pb2.BYTE, pa.int8()), (schema_pb2.INT16, pa.int16()), (schema_pb2.INT32, pa.int32()), (schema_pb2.INT64, pa.int64()), (schema_pb2.FLOAT, pa.float32()), (schema_pb2.DOUBLE, pa.float64()), (schema_pb2.BOOLEAN, pa.bool_()), (schema_pb2.STRING, pa.string()), (schema_pb2.BYTES, pa.binary())]
ATOMIC_TYPE_TO_PYARROW = {beam: arrow for (beam, arrow) in _ARROW_PRIMITIVE_MAPPING}
