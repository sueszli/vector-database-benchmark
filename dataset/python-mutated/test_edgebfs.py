...
class TestEdgeBFS:
    ...
    def test_digraph_orientation_original(self):
        ...
        x_ = [(0, 1, FORWARD), (1, 0, FORWARD), (2, 0, FORWARD), (2, 1, FORWARD), (3, 1, FORWARD)]
        assert x == x_
    ...
    def test_digraph_rev(self):
        ...
        x_ = [(1, 0, REVERSE), (2, 0, REVERSE), (0, 1, REVERSE), (2, 1, REVERSE), (3, 1, REVERSE)]
        assert x == x_
    ...
    def test_multidigraph_rev(self):
        ...
        G = nx.MultiDiGraph(self.edges)
        x = list(nx.edge_bfs(G, self.nodes, orientation='reverse'))
        x_ = [(1, 0, 0, REVERSE), (1, 0, 1, REVERSE), (2, 0, 0, REVERSE), (0, 1, 0, REVERSE), (2, 1, 0, REVERSE), (3, 1, 0, REVERSE)]
        assert x == x_
    ...
    def test_digraph_ignore(self):
        ...
        x_ = [(0, 1, FORWARD), (1, 0, REVERSE), (2, 0, REVERSE), (2, 1, REVERSE), (3, 1, REVERSE)]
        assert x == x_
    ...
    def test_multidigraph_ignore(self):
        ...
        G = nx.MultiDiGraph(self.edges)
        x = list(nx.edge_bfs(G, self.nodes, orientation='ignore'))
        x_ = [(0, 1, 0, FORWARD), (1, 0, 0, REVERSE), (1, 0, 1, REVERSE), (2, 0, 0, REVERSE), (2, 1, 0, REVERSE), (3, 1, 0, REVERSE)]
        assert x == x_