...
from sentry.issues.grouptype import PerformanceConsecutiveHTTPQueriesGroupType, PerformanceNPlusOneGroupType, PerformanceSlowDBQueryGroupType
from sentry.testutils.cases import TestCase
from sentry.testutils.helpers import override_options
from sentry.testutils.performance_issues.event_generators import get_event
from sentry.testutils.silo import no_silo_test, region_silo_test
from sentry.utils.performance_issues.base import DETECTOR_TYPE_TO_GROUP_TYPE, DetectorType, total_span_time
from sentry.utils.performance_issues.detectors.n_plus_one_db_span_detector import NPlusOneDBSpanDetector
from sentry.utils.performance_issues.performance_detection import EventPerformanceProblem, _detect_performance_problems, detect_performance_problems, get_detection_settings
from sentry.utils.performance_issues.performance_problem import PerformanceProblem
BASE_DETECTOR_OPTIONS = {'performance.issues.n_plus_one_db.problem-creation': 1.0, 'performance.issues.n_plus_one_db_ext.problem-creation': 1.0}
BASE_DETECTOR_OPTIONS_OFF = {'performance.issues.n_plus_one_db.problem-creation': 0.0, 'performance.issues.n_plus_one_db_ext.problem-creation': 0.0}
