...
from qiskit.circuit import Qubit, Clbit, ClassicalRegister, ControlFlowOp, IfElseOp, WhileLoopOp, SwitchCaseOp, ForLoopOp, Parameter
...
_SEMANTIC_EQ_CONTROL_FLOW = {IfElseOp: _condition_op_eq, WhileLoopOp: _condition_op_eq, SwitchCaseOp: _switch_case_eq, ForLoopOp: _for_loop_eq}
