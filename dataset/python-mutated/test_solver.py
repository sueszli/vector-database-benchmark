...
from tests.repositories.test_legacy_repository import MockRepository as MockLegacyRepository
...
DEFAULT_SOURCE_REF = VCSDependency('poetry', 'git', 'git@github.com:python-poetry/poetry.git').branch or 'HEAD'
