...
class DPTModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_depth_estimation(self):
        ...
        expected_slice = torch.tensor([[6.3199, 6.3629, 6.4148], [6.385, 6.3615, 6.4166], [6.3519, 6.3176, 6.3575]]).to(torch_device)
    ...
    def test_inference_semantic_segmentation(self):
        ...
        expected_slice = torch.tensor([[4.048, 4.242, 4.436], [4.3124, 4.5693, 4.8261], [4.5768, 4.8965, 5.2163]]).to(torch_device)
