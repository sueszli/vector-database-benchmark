...
driver_stats_source = PostgreSQLSource(name='driver_hourly_stats_source', query='SELECT * FROM feast_driver_hourly_stats', timestamp_field='event_timestamp', created_timestamp_column='created')
driver_stats_fv = FeatureView(name='driver_hourly_stats', entities=[driver], ttl=timedelta(days=1), schema=[Field(name='conv_rate', dtype=Float32), Field(name='acc_rate', dtype=Float32), Field(name='avg_daily_trips', dtype=Int64)], online=True, source=driver_stats_source, tags={'team': 'driver_performance'})
...
driver_stats_fresh_fv = FeatureView(name='driver_hourly_stats_fresh', entities=[driver], ttl=timedelta(days=1), schema=[Field(name='conv_rate', dtype=Float32), Field(name='acc_rate', dtype=Float32), Field(name='avg_daily_trips', dtype=Int64)], online=True, source=driver_stats_push_source, tags={'team': 'driver_performance'})
