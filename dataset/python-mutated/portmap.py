...
class DUMP_Reply(Packet):
    ...
    fields_desc = [IntField('value_follows', 0), PacketListField('mappings', [], Map_Entry, next_cls_cb=lambda pkt, lst, cur, remain: Map_Entry if pkt.value_follows == 1 and (len(lst) == 0 or cur.value_follows == 1) and (len(remain) > 4) else None)]
