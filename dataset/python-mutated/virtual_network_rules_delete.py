...
def main():
    ...
    response = client.virtual_network_rules.delete(resource_group_name='contosorg', account_name='contosoadla', virtual_network_rule_name='test_virtual_network_rules_name')
    print(response)
