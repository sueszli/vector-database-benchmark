...
from scapy.fields import Field, BitEnumField, BitField, ByteEnumField, ShortEnumField, ByteField, IntField, LongField, ConditionalField, FieldLenField, BitFieldLenField, FieldListField, IPField, MACField, PacketListField, ShortField, StrLenField, StrField, XBitField, XByteField, XIntField, XLongField, ThreeBytesField, SignedLongField, SignedIntField, MultipleTypeField
...
class IE_SourceInterface(IE_Base):
    ...
    ie_type = 20
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 4), BitEnumField('interface', 'Access', 4, SourceInterface), ExtraDataField('extra_data')]
...
class IE_GateStatus(IE_Base):
    name = 'IE Gate Status'
    ie_type = 25
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 4), BitEnumField('ul', 'OPEN', 2, GateStatus), BitEnumField('dl', 'OPEN', 2, GateStatus), ExtraDataField('extra_data')]

class IE_MBR(IE_Base):
    name = 'IE MBR'
    ie_type = 26
    fields_desc = IE_Base.fields_desc + [Int40Field('ul', 0), Int40Field('dl', 0), ExtraDataField('extra_data')]
...
class IE_QERCorrelationId(IE_Base):
    ...
    ie_type = 28
    fields_desc = IE_Base.fields_desc + [IntField('id', 0), ExtraDataField('extra_data')]

class IE_Precedence(IE_Base):
    name = 'IE Precedence'
    ie_type = 29
    fields_desc = IE_Base.fields_desc + [IntField('precedence', 0), ExtraDataField('extra_data')]

class IE_TransportLevelMarking(IE_Base):
    name = 'IE Transport Level Marking'
    ie_type = 30
    fields_desc = IE_Base.fields_desc + [XByteField('tos', 0), XByteField('traffic_class', 0), ExtraDataField('extra_data')]
...
class IE_TimeThreshold(IE_Base):
    ...
    ie_type = 32
    fields_desc = IE_Base.fields_desc + [IntField('threshold', 0), ExtraDataField('extra_data')]

class IE_MonitoringTime(IE_Base):
    name = 'IE Monitoring Time'
    ie_type = 33
    fields_desc = IE_Base.fields_desc + [IntField('time_value', 0), ExtraDataField('extra_data')]
...
class IE_ReportingTriggers(IE_Base):
    ...
    ie_type = 37
    fields_desc = IE_Base.fields_desc + [BitField('linked_usage_reporting', 0, 1), BitField('dropped_dl_traffic_threshold', 0, 1), BitField('stop_of_traffic', 0, 1), BitField('start_of_traffic', 0, 1), BitField('quota_holding_time', 0, 1), BitField('time_threshold', 0, 1), BitField('volume_threshold', 0, 1), BitField('periodic_reporting', 0, 1), XBitField('spare', 0, 2), BitField('event_quota', 0, 1), BitField('event_threshold', 0, 1), BitField('mac_addresses_reporting', 0, 1), BitField('envelope_closure', 0, 1), BitField('time_quota', 0, 1), BitField('volume_quota', 0, 1), ExtraDataField('extra_data')]

class IE_RedirectInformation(IE_Base):
    name = 'IE Redirect Information'
    ie_type = 38
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 4), BitEnumField('type', 'IPv4 address', 4, RedirectAddressType), FieldLenField('address_length', None, length_of='address'), StrLenField('address', '', length_from=lambda pkt: pkt.address_length), ExtraDataField('extra_data')]

class IE_ReportType(IE_Base):
    name = 'IE Report Type'
    ie_type = 39
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 4), BitField('UPIR', 0, 1), BitField('ERIR', 0, 1), BitField('USAR', 0, 1), BitField('DLDR', 0, 1), ExtraDataField('extra_data')]
...
class IE_DestinationInterface(IE_Base):
    ...
    ie_type = 42
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 4), BitEnumField('interface', 'Access', 4, DestinationInterface), ExtraDataField('extra_data')]

class IE_UPFunctionFeatures(IE_Base):
    name = 'IE UP Function Features'
    ie_type = 43
    default_length = 2
    fields_desc = IE_Base.fields_desc + [ConditionalField(BitField('TREU', None, 1), lambda x: x.length > 0), ConditionalField(BitField('HEEU', None, 1), lambda x: x.length > 0), ConditionalField(BitField('PFDM', None, 1), lambda x: x.length > 0), ConditionalField(BitField('FTUP', None, 1), lambda x: x.length > 0), ConditionalField(BitField('TRST', None, 1), lambda x: x.length > 0), ConditionalField(BitField('DLBD', None, 1), lambda x: x.length > 0), ConditionalField(BitField('DDND', None, 1), lambda x: x.length > 0), ConditionalField(BitField('BUCP', None, 1), lambda x: x.length > 0), ConditionalField(BitField('spare', None, 1), lambda x: x.length > 1), ConditionalField(BitField('PFDE', None, 1), lambda x: x.length > 1), ConditionalField(BitField('FRRT', None, 1), lambda x: x.length > 1), ConditionalField(BitField('TRACE', None, 1), lambda x: x.length > 1), ConditionalField(BitField('QUOAC', None, 1), lambda x: x.length > 1), ConditionalField(BitField('UDBC', None, 1), lambda x: x.length > 1), ConditionalField(BitField('PDIU', None, 1), lambda x: x.length > 1), ConditionalField(BitField('EMPU', None, 1), lambda x: x.length > 1), ExtraDataField('extra_data')]

class IE_ApplyAction(IE_Base):
    name = 'IE Apply Action'
    ie_type = 44
    fields_desc = IE_Base.fields_desc + [XBitField('spare', None, 3), BitField('DUPL', 0, 1), BitField('NOCP', 0, 1), BitField('BUFF', 0, 1), BitField('FORW', 0, 1), BitField('DROP', 0, 1), ExtraDataField('extra_data')]

class IE_DownlinkDataServiceInformation(IE_Base):
    name = 'IE Downlink Data Service Information'
    ie_type = 45
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', None, 6), BitField('QFII', 0, 1), BitField('PPI', 0, 1), ConditionalField(XBitField('spare_2', None, 2), lambda x: x.PPI == 1), ConditionalField(XBitField('ppi_val', None, 6), lambda x: x.PPI == 1), ConditionalField(XBitField('spare_3', None, 2), lambda x: x.QFII == 1), ConditionalField(XBitField('qfi_val', None, 6), lambda x: x.QFII == 1), ExtraDataField('extra_data')]

class IE_DownlinkDataNotificationDelay(IE_Base):
    name = 'IE Downlink Data Notification Delay'
    ie_type = 46
    fields_desc = IE_Base.fields_desc + [ByteField('delay', 0), ExtraDataField('extra_data')]

class IE_DLBufferingDuration(IE_Base):
    name = 'IE DL Buffering Duration'
    ie_type = 47
    fields_desc = IE_Base.fields_desc + [BitEnumField('timer_unit', '2 seconds', 3, TimerUnit), BitField('timer_value', 0, 5), ExtraDataField('extra_data')]

class IE_DLBufferingSuggestedPacketCount(IE_Base):
    name = 'IE DL Buffering Suggested Packet Count'
    ie_type = 48
    fields_desc = IE_Base.fields_desc + [MultipleTypeField([(ByteField('count', 0), (lambda x: x.length == 1, lambda x, val: x.length == 1 or (x.length is None and val < 256))), (ShortField('count', 0), (lambda x: x.length == 2, lambda x, val: x.length == 1 or (x.length is None and val >= 256)))], ByteField('count', 0))]

class IE_PFCPSMReqFlags(IE_Base):
    name = 'IE PFCPSMReq-Flags'
    ie_type = 49
    fields_desc = IE_Base.fields_desc + [XBitField('spare', None, 5), BitField('QUARR', 0, 1), BitField('SNDEM', 0, 1), BitField('DROBU', 0, 1), ExtraDataField('extra_data')]

class IE_PFCPSRRspFlags(IE_Base):
    name = 'IE PFCPSRRsp-Flags'
    ie_type = 50
    fields_desc = IE_Base.fields_desc + [XBitField('spare', None, 7), BitField('DROBU', 0, 1), ExtraDataField('extra_data')]

class IE_SequenceNumber(IE_Base):
    name = 'IE Sequence Number'
    ie_type = 52
    fields_desc = IE_Base.fields_desc + [IntField('number', 0)]

class IE_Metric(IE_Base):
    name = 'IE Metric'
    ie_type = 53
    fields_desc = IE_Base.fields_desc + [ByteField('metric', 0)]
...
class IE_DurationMeasurement(IE_Base):
    ...
    ie_type = 67
    fields_desc = IE_Base.fields_desc + [IntField('duration', 0), ExtraDataField('extra_data')]

class IE_TimeOfFirstPacket(IE_Base):
    name = 'IE Time of First Packet'
    ie_type = 69
    fields_desc = IE_Base.fields_desc + [IntField('timestamp', 0), ExtraDataField('extra_data')]
...
class IE_DroppedDLTrafficThreshold(IE_Base):
    ...
    ie_type = 72
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 6), BitField('DLBY', 0, 1), BitField('DLPA', 0, 1), ConditionalField(LongField('packet_count', 0), lambda x: x.DLPA == 1), ConditionalField(LongField('byte_count', 0), lambda x: x.DLBY == 1), ExtraDataField('extra_data')]
...
class IE_TimeQuota(IE_Base):
    name = 'IE Time Quota'
    ie_type = 74
    fields_desc = IE_Base.fields_desc + [IntField('quota', 0), ExtraDataField('extra_data')]
...
class IE_FlowInformation(IE_Base):
    ...
    ie_type = 92
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 5), BitEnumField('direction', 'Unspecified', 3, FlowDirection), FieldLenField('flow_length', None, length_of='flow'), StrLenField('flow', '', length_from=lambda x: x.flow_length), ExtraDataField('extra_data')]

class IE_UE_IP_Address(IE_Base):
    name = 'IE UE IP Address'
    ie_type = 93
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 5), BitField('SD', 0, 1), BitField('V4', 0, 1), BitField('V6', 0, 1), ConditionalField(IPField('ipv4', 0), lambda x: x.V4 == 1), ConditionalField(IP6Field('ipv6', 0), lambda x: x.V6 == 1), ExtraDataField('extra_data')]

class IE_PacketRate(IE_Base):
    name = 'IE Packet Rate'
    ie_type = 94
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', 0, 6), BitField('DLPR', 0, 1), BitField('ULPR', 0, 1), ConditionalField(BitField('spare_2', 0, 5), lambda x: x.ULPR == 1), ConditionalField(BitEnumField('ul_time_unit', 'minute', 3, TimeUnit), lambda x: x.ULPR == 1), ConditionalField(ShortField('ul_max_packet_rate', 0), lambda x: x.ULPR == 1), ConditionalField(BitField('spare_3', 0, 5), lambda x: x.DLPR == 1), ConditionalField(BitEnumField('dl_time_unit', 'minute', 3, TimeUnit), lambda x: x.DLPR == 1), ConditionalField(ShortField('dl_max_packet_rate', 0), lambda x: x.DLPR == 1), ExtraDataField('extra_data')]

class IE_OuterHeaderRemoval(IE_Base):
    name = 'IE Outer Header Removal'
    ie_type = 95
    fields_desc = IE_Base.fields_desc + [ByteEnumField('header', None, OuterHeaderRemovalDescription), ConditionalField(XBitField('spare', None, 7), lambda x: x.length is not None and x.length > 1), ConditionalField(BitField('pdu_session_container', None, 1), lambda x: x.length is not None and x.length > 1), ExtraDataField('extra_data')]
...
class IE_DLFlowLevelMarking(IE_Base):
    ...
    ie_type = 97
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', 0, 6), BitField('SCI', 0, 1), BitField('TTC', 0, 1), ConditionalField(ByteField('traffic_class', 0), lambda x: x.TTC), ConditionalField(ByteField('traffic_class_mask', 0), lambda x: x.TTC), ConditionalField(ByteField('service_class_indicator', 0), lambda x: x.SCI), ConditionalField(ByteField('spare_2', 0), lambda x: x.SCI), ExtraDataField('extra_data')]
...
class IE_RQI(IE_Base):
    name = 'IE RQI'
    ie_type = 123
    fields_desc = IE_Base.fields_desc + [XBitField('spare', None, 7), BitField('RQI', 0, 1), ExtraDataField('extra_data')]

class IE_QFI(IE_Base):
    name = 'IE QFI'
    ie_type = 124
    fields_desc = IE_Base.fields_desc + [XBitField('spare', None, 2), BitField('QFI', 0, 6), ExtraDataField('extra_data')]

class IE_QueryURRReference(IE_Base):
    name = 'IE Query URR Reference'
    ie_type = 125
    fields_desc = IE_Base.fields_desc + [IntField('reference', 0), ExtraDataField('extra_data')]

class IE_AdditionalUsageReportsInformation(IE_Base):
    name = 'IE Additional Usage Reports Information'
    ie_type = 126
    fields_desc = IE_Base.fields_desc + [BitField('AURI', 0, 1), BitField('reports', 0, 15), ExtraDataField('extra_data')]
...
class IE_C_TAG(IE_Base):
    name = 'IE C-TAG'
    ie_type = 134
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', 0, 5), BitField('VID', 0, 1), BitField('DEI', 0, 1), BitField('PCP', 0, 1), ConditionalField(BitField('cvid_value_hi', 0, 4), lambda x: x.VID == 1), ConditionalField(BitField('spare_2', 0, 4), lambda x: x.VID == 0), ConditionalField(BitField('dei_flag', 0, 1), lambda x: x.DEI == 1), ConditionalField(BitField('spare_3', 0, 1), lambda x: x.DEI == 0), ConditionalField(BitField('pcp_value', 0, 3), lambda x: x.PCP == 1), ConditionalField(BitField('spare_4', 0, 3), lambda x: x.PCP == 0), ConditionalField(ByteField('cvid_value_low', 0), lambda x: x.VID == 1), ConditionalField(ByteField('spare_5', 0), lambda x: x.VID == 0), ExtraDataField('extra_data')]

class IE_S_TAG(IE_Base):
    name = 'IE S-TAG'
    ie_type = 135
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', 0, 5), BitField('VID', 0, 1), BitField('DEI', 0, 1), BitField('PCP', 0, 1), ConditionalField(BitField('svid_value_hi', 0, 4), lambda x: x.VID == 1), ConditionalField(BitField('spare_2', 0, 4), lambda x: x.VID == 0), ConditionalField(BitField('dei_flag', 0, 1), lambda x: x.DEI == 1), ConditionalField(BitField('spare_3', 0, 1), lambda x: x.DEI == 0), ConditionalField(BitField('pcp_value', 0, 3), lambda x: x.PCP == 1), ConditionalField(BitField('spare_4', 0, 3), lambda x: x.PCP == 0), ConditionalField(ByteField('svid_value_low', 0), lambda x: x.VID == 1), ConditionalField(ByteField('spare_5', 0), lambda x: x.VID == 0), ExtraDataField('extra_data')]

class IE_Ethertype(IE_Base):
    name = 'IE Ethertype'
    ie_type = 136
    fields_desc = IE_Base.fields_desc + [ShortField('type', 0), ExtraDataField('extra_data')]

class IE_Proxying(IE_Base):
    name = 'IE Proxying'
    ie_type = 137
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 6), BitField('INS', 0, 1), BitField('ARP', 0, 1), ExtraDataField('extra_data')]
...
class IE_EthernetFilterProperties(IE_Base):
    ...
    ie_type = 139
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 7), BitField('BIDE', 0, 1), ExtraDataField('extra_data')]

class IE_SuggestedBufferingPacketsCount(IE_Base):
    name = 'IE Suggested Buffering Packets Count'
    ie_type = 140
    fields_desc = IE_Base.fields_desc + [ByteField('count', 0), ExtraDataField('extra_data')]
...
class IE_EthernetPDUSessionInformation(IE_Base):
    ...
    ie_type = 142
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 7), BitField('ETHI', 0, 1), ExtraDataField('extra_data')]

class IE_MACAddressesDetected(IE_Base):
    name = 'IE MAC Addresses Detected'
    ie_type = 144
    fields_desc = IE_Base.fields_desc + [FieldLenField('num_macs', None, count_of='macs', fmt='B'), FieldListField('macs', None, MACField('mac', 0), count_from=lambda x: x.num_macs), ExtraDataField('extra_data')]
...
class IE_EventQuota(IE_Base):
    name = 'IE Event Quota'
    ie_type = 148
    fields_desc = IE_Base.fields_desc + [IntField('event_quota', 0), ExtraDataField('extra_data')]

class IE_EventThreshold(IE_Base):
    name = 'IE Event Threshold'
    ie_type = 149
    fields_desc = IE_Base.fields_desc + [IntField('event_threshold', 0), ExtraDataField('extra_data')]

class IE_SubsequentEventQuota(IE_Base):
    name = 'IE Subsequent Event Quota'
    ie_type = 150
    fields_desc = IE_Base.fields_desc + [IntField('subsequent_event_quota', 0), ExtraDataField('extra_data')]

class IE_SubsequentEventThreshold(IE_Base):
    name = 'IE Subsequent Event Threshold'
    ie_type = 151
    fields_desc = IE_Base.fields_desc + [IntField('subsequent_event_threshold', 0), ExtraDataField('extra_data')]

class IE_TraceInformation(IE_Base):
    name = 'IE Trace Information'
    ie_type = 152
    fields_desc = IE_Base.fields_desc + [BitField('mcc_digit_2', 0, 4), BitField('mcc_digit_1', 0, 4), BitField('mnc_digit_3', 0, 4), BitField('mcc_digit_3', 0, 4), BitField('mnc_digit_2', 0, 4), BitField('mnc_digit_1', 0, 4), ThreeBytesField('trace_id', 0), FieldLenField('triggering_events_length', None, length_of='triggering_events', fmt='B'), StrLenField('triggering_events', '', length_from=lambda x: x.triggering_events_length), ByteField('session_trace_depth', 0), FieldLenField('list_of_interfaces_length', None, length_of='list_of_interfaces', fmt='B'), StrLenField('list_of_interfaces', '', length_from=lambda x: x.list_of_interfaces_length), FieldLenField('ip_address_length', None, length_of='ip_address', fmt='B'), StrLenField('ip_address', '', length_from=lambda x: x.ip_address_length), ExtraDataField('extra_data')]
...
class IE_AveragingWindow(IE_Base):
    ...
    ie_type = 157
    fields_desc = IE_Base.fields_desc + [IntField('averaging_window', 0), ExtraDataField('extra_data')]

class IE_PagingPolicyIndicator(IE_Base):
    name = 'IE Paging Policy Indicator'
    ie_type = 158
    fields_desc = IE_Base.fields_desc + [XBitField('spare', 0, 5), BitField('ppi', 0, 3), ExtraDataField('extra_data')]
...
class IE_3GPP_InterfaceType(IE_Base):
    ...
    ie_type = 160
    fields_desc = IE_Base.fields_desc + [XBitField('spare_1', 0, 2), BitEnumField('interface_type', 'S1-U', 6, InterfaceType), ExtraDataField('extra_data')]

class IE_EnterpriseSpecific(IE_Base):
    name = 'Enterpise Specific'
    ie_type = None
    fields_desc = IE_Base.fields_desc + [ShortEnumField('enterprise_id', None, IANA_ENTERPRISE_NUMBERS), StrLenField('data', '', length_from=lambda x: x.length - 2)]
