...
def main():
    ...
    response = client.resource_guards.get_delete_protected_item_requests_objects(resource_group_name='SampleResourceGroup', resource_guards_name='swaggerExample')
