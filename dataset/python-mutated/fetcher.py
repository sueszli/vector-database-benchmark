...
from megengine.utils.http_download import CHUNK_SIZE, HTTP_CONNECTION_TIMEOUT, HTTPDownloadError
...
pattern = re.compile('^(?:[a-z0-9](?:[a-z0-9-_]{0,61}[a-z0-9])?\\.)+[a-z0-9][a-z0-9-_]{0,61}[a-z]$')
