...
@testing.parameterize(*testing.product_dict([{'cover_all': False, 'outsize': (4, 2)}, {'cover_all': True, 'outsize': (3, 1)}, {'cover_all': False, 'outsize': None, 'expected_outsize': (4, 2)}, {'cover_all': True, 'outsize': None, 'expected_outsize': (3, 1)}, {'cover_all': False, 'outsize': (5, 2)}, {'cover_all': True, 'outsize': (4, 2)}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
...
@testing.parameterize(*testing.product_dict([{'insize': (2, 1), 'outsize': (4, 2), 'ksize': 2, 'pad': 0}, {'insize': (4, 5), 'outsize': (4, 6), 'ksize': 2, 'pad': 2}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}]))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'h': [5], 'k': [3], 's': [3], 'p': [0], 'cover_all': [True, False]}))
...
@testing.parameterize(*testing.product({'dtype': [numpy.float16, numpy.float32, numpy.float64], 'h': [5], 'k': [3], 's': [3], 'p': [0]}))
