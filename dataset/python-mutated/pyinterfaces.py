...
try:
    from cudaops_ailut import ailut_cbackward, ailut_cforward, lut_cbackward, lut_cforward
except ImportError:
    CUR_DIR = osp.abspath(osp.dirname(__file__))
    cudaops_ailut = load(name='cudaops_ailut', sources=[osp.join(CUR_DIR, 'Ailut', 'csrc/ailut_transform.cpp'), osp.join(CUR_DIR, 'Ailut', 'csrc/ailut_transform_cpu.cpp'), osp.join(CUR_DIR, 'Ailut', 'csrc/ailut_transform_cuda.cu')], verbose=True)
    from cudaops_ailut import ailut_cbackward, ailut_cforward, lut_cbackward, lut_cforward
