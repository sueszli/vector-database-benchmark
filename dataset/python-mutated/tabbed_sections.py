...
START_TABBED_SECTION_REGEX = re.compile('^\\{start_tabs\\}$')
END_TABBED_SECTION_REGEX = re.compile('^\\{end_tabs\\}$')
TAB_CONTENT_REGEX = re.compile('^\\{tab\\|([^}]+)\\}$')
...
TAB_SECTION_LABELS = {'desktop-web': 'Desktop/Web', 'ios': 'iOS', 'android': 'Android', 'mac': 'macOS', 'windows': 'Windows', 'linux': 'Linux', 'python': 'Python', 'js': 'JavaScript', 'curl': 'curl', 'zulip-send': 'zulip-send', 'web': 'Web', 'desktop': 'Desktop', 'mobile': 'Mobile', 'mm-default': 'Default installation', 'mm-cloud': 'Cloud instance', 'mm-docker': 'Docker', 'mm-gitlab-omnibus': 'GitLab Omnibus', 'mm-self-hosting-cloud-export': 'Self hosting (cloud export)', 'require-invitations': 'Require invitations', 'allow-anyone-to-join': 'Allow anyone to join', 'restrict-by-email-domain': 'Restrict by email domain', 'zoom': 'Zoom', 'jitsi-meet': 'Jitsi Meet', 'bigbluebutton': 'BigBlueButton', 'disable': 'Disabled', 'chrome': 'Chrome', 'firefox': 'Firefox', 'desktop-app': 'Desktop app', 'system-proxy-settings': 'System proxy settings', 'custom-proxy-settings': 'Custom proxy settings', 'stream': 'From a stream view', 'not-stream': 'From other views', 'via-recent-conversations': 'Via recent conversations', 'via-inbox-view': 'Via inbox view', 'via-left-sidebar': 'Via left sidebar', 'instructions-for-all-platforms': 'Instructions for all platforms', 'public-streams': 'Public streams', 'private-streams': 'Private streams', 'web-public-streams': 'Web-public streams', 'via-user-card': 'Via user card', 'via-user-profile': 'Via user profile', 'via-organization-settings': 'Via organization settings', 'via-personal-settings': 'Via personal settings', 'via-stream-settings': 'Via stream settings', 'default-subdomain': 'Default subdomain', 'custom-subdomain': 'Custom subdomain', 'zulip-cloud': 'Zulip Cloud', 'self-hosting': 'Self hosting', 'okta': 'Okta', 'onelogin': 'OneLogin', 'azuread': 'AzureAD', 'keycloak': 'Keycloak', 'auth0': 'Auth0', 'logged-in': 'If you are logged in', 'logged-out': 'If you are logged out', 'user': 'User', 'bot': 'Bot', 'on-sign-up': 'On sign-up', 'via-paste': 'Via paste', 'via-drag-and-drop': 'Via drag-and-drop', 'via-markdown': 'Via Markdown', 'via-compose-box-buttons': 'Via compose box buttons', 'stream-compose': 'Compose to a stream', 'dm-compose': 'Compose a DM', 'v6': 'Zulip Server 6.0+', 'v4': 'Zulip Server 4.0+'}
