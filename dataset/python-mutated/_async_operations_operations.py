...
class AsyncOperationsOperations:
    ...
    async def asyc_operations(self, operation_id: str, **kwargs: Any) -> None:
        ...
        request = build_asyc_operations_request(operation_id=operation_id, template_url=self.asyc_operations.metadata['url'])
    ...
    asyc_operations.metadata = {'url': '/registrymanagement/v1.0/operations/{operationId}'}