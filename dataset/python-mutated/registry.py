...
generate_registry_entry = define_asset_job(name='generate_registry_entry', selection=registry_entry_inclusive, partitions_def=registry_entry.metadata_partitions_def)
