...
def generate(path):
    ...
    debug('Generating ServerRoomMonitoringV2.substitutions')
    write_if_changed(os.path.join(path, 'source', 'Kits', 'ServerRoomMonitoringV2', 'ServerRoomMonitoringV2.substitutions'), make_substitutions())
