...
from sentry.search.events.fields import ColumnArg, Combinator, InvalidFunctionArgument, NumberRange, NumericColumn, SnQLFunction, TimestampArg, with_default
...
COLUMNS = [Column(alias='project.id', column='project_id', kind=Kind.INTEGER), Column(alias='project_id', column='project_id', kind=Kind.INTEGER), Column(alias='transaction', column='transaction_name', kind=Kind.STRING), Column(alias='timestamp', column='timestamp', kind=Kind.DATE), Column(alias='_fingerprint', column='fingerprint', kind=Kind.INTEGER), Column(alias='function', column='name', kind=Kind.STRING), Column(alias='package', column='package', kind=Kind.STRING), Column(alias='is_application', column='is_application', kind=Kind.INTEGER), Column(alias='platform.name', column='platform', kind=Kind.STRING), Column(alias='environment', column='environment', kind=Kind.STRING), Column(alias='release', column='release', kind=Kind.STRING), Column(alias='function.duration', column='percentiles', kind=Kind.DURATION, unit=Duration.NANOSECOND)]
COLUMN_MAP = {column.alias: column for column in COLUMNS}
AGG_STATE_COLUMNS = ['count', 'percentiles', 'avg', 'sum', 'min', 'max']
...
class ProfileFunctionsDatasetConfig(DatasetConfig):
    non_nullable_keys = {'project.id', 'project_id', 'transaction', 'timestamp', '_fingerprint', 'function', 'package', 'is_application', 'platform.name'}
