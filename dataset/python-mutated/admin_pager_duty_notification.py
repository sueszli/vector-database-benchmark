...
class AdminPagerDutyNotification(object):
    """NOTE: This class is auto generated by the swagger code generator program.

    Do not edit the class manually.
    """
    '\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    '
    swagger_types = {'recipients_email': 'list[str]'}
    attribute_map = {'recipients_email': 'recipients_email'}

    def __init__(self, recipients_email=None):
        if False:
            print('Hello World!')
        'AdminPagerDutyNotification - a model defined in Swagger'
    ...
    def to_dict(self):
        ...
        for (attr, _) in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AdminPagerDutyNotification, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdminPagerDutyNotification):
            return False
