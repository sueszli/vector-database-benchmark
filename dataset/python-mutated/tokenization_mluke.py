...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'studio-ousia/mluke-base': 'https://huggingface.co/studio-ousia/mluke-base/resolve/main/vocab.json'}, 'merges_file': {'studio-ousia/mluke-base': 'https://huggingface.co/studio-ousia/mluke-base/resolve/main/merges.txt'}, 'entity_vocab_file': {'studio-ousia/mluke-base': 'https://huggingface.co/studio-ousia/mluke-base/resolve/main/entity_vocab.json'}}
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {'studio-ousia/mluke-base': 512}
