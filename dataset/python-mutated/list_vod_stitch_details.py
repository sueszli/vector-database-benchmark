...
Example usage:
    python list_vod_stitch_details.py --project_id <project-id>         --location <location> --session_id <session-id>
"""
import argparse
from google.cloud.video.stitcher_v1.services.video_stitcher_service import pagers, VideoStitcherServiceClient

def list_vod_stitch_details(project_id: str, location: str, session_id: str) -> pagers.ListVodStitchDetailsPager:
    if False:
        return 10
