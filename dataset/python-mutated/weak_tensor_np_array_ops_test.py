...
_all_types = [np.int32, np.int64, np.float32, np.float64, np.complex128]
_NP_TO_TF = dtypes._NP_TO_TF
_NP_to_TF_result_inferred_types = {np.dtype(np.int32): dtypes.int32, np.dtype(np.int64): dtypes.int32, np.dtype(np.float32): dtypes.float32, np.dtype(np.float64): dtypes.float32, np.dtype(np.complex128): dtypes.complex128, dtypes.int32: dtypes.int32, dtypes.int64: dtypes.int32, dtypes.float32: dtypes.float32, dtypes.float64: dtypes.float32, dtypes.complex128: dtypes.complex128}
