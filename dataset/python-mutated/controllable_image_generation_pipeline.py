...
from modelscope.preprocessors.cv.controllable_image_generation import ControllableImageGenerationPreprocessor
...
@PIPELINES.register_module(Tasks.controllable_image_generation, module_name=Pipelines.controllable_image_generation)
