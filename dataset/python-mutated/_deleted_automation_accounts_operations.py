...
class DeletedAutomationAccountsOperations:
    ...
    async def list_by_subscription(self, **kwargs: Any) -> _models.DeletedAutomationAccountListResult:
        ...
        api_version: Literal['2022-01-31'] = kwargs.pop('api_version', _params.pop('api-version', '2022-01-31'))
        ...
        return deserialized
    list_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Automation/deletedAutomationAccounts'}