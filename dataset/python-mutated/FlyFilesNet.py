...
class FlyFilesNet(SimpleDownloader):
    ...
    __version__ = '0.15'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?flyfiles\\.net/.+'
    ...
    __license__ = 'GPLv3'
    __authors__ = []
    SESSION_PATTERN = 'flyfiles\\.net/(.*)/.*'
    NAME_PATTERN = 'flyfiles\\.net/.*/(.*)'
    ...
    def process(self, pyfile):
        ...
        if parsed_url == '#downlink|' or parsed_url == '#downlink|#':
            self.log_warning(self._('Could not get the download URL. Please wait 10 minutes'))
