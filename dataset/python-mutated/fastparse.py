...
from mypy.types import AnyType, CallableArgument, CallableType, EllipsisType, Instance, ProperType, RawExpressionType, TupleType, Type, TypeList, TypeOfAny, UnboundType, UnionType, UnpackType
...
TYPE_IGNORE_PATTERN: Final = re.compile('[^#]*#\\s*type:\\s*ignore\\s*(.*)')
...
class ASTConverter:
    ...
    def translate_type_comment(self, n: ast3.stmt | ast3.arg, type_comment: str | None) -> ProperType | None:
        ...
        if type_comment is None:
            ...
            return typ
    op_map: Final[dict[type[AST], str]] = {ast3.Add: '+', ast3.Sub: '-', ast3.Mult: '*', ast3.MatMult: '@', ast3.Div: '/', ast3.Mod: '%', ast3.Pow: '**', ast3.LShift: '<<', ast3.RShift: '>>', ast3.BitOr: '|', ast3.BitXor: '^', ast3.BitAnd: '&', ast3.FloorDiv: '//'}
    ...
    def from_operator(self, op: ast3.operator) -> str:
        ...
        if op_name is None:
            ...
            return op_name
    comp_op_map: Final[dict[type[AST], str]] = {ast3.Gt: '>', ast3.Lt: '<', ast3.Eq: '==', ast3.GtE: '>=', ast3.LtE: '<=', ast3.NotEq: '!=', ast3.Is: 'is', ast3.IsNot: 'is not', ast3.In: 'in', ast3.NotIn: 'not in'}
