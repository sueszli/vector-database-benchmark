...
class sfp_openphish(SpiderFootPlugin):
    ...
    def retrieveBlacklist(self):
        ...
        res = self.sf.fetchUrl('https://www.openphish.com/feed.txt', timeout=10, useragent=self.opts['_useragent'])
        if res['code'] != '200':
