...
from qutebrowser.api import hook, config, message, interceptor, apitypes, qtutils
...
_RESOURCE_TYPE_STRINGS = {ResourceType.main_frame: 'main_frame', ResourceType.sub_frame: 'sub_frame', ResourceType.stylesheet: 'stylesheet', ResourceType.script: 'script', ResourceType.image: 'image', ResourceType.font_resource: 'font', ResourceType.sub_resource: 'sub_frame', ResourceType.object: 'object', ResourceType.media: 'media', ResourceType.worker: 'other', ResourceType.shared_worker: 'other', ResourceType.prefetch: 'other', ResourceType.favicon: 'image', ResourceType.xhr: 'xhr', ResourceType.ping: 'ping', ResourceType.service_worker: 'other', ResourceType.csp_report: 'csp_report', ResourceType.plugin_resource: 'other', ResourceType.preload_main_frame: 'other', ResourceType.preload_sub_frame: 'other', ResourceType.websocket: 'websocket', ResourceType.unknown: 'other', None: ''}
