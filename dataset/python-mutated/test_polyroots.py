...
from sympy.polys.polyroots import root_factors, roots_linear, roots_quadratic, roots_cubic, roots_quartic, roots_quintic, roots_cyclotomic, roots_binomial, preprocess_roots, roots
