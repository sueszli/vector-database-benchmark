...
class EmbeduploadCom(BaseDecrypter):
    ...
    __version__ = '0.08'
    __status__ = 'testing'
    __pattern__ = 'http://(?:www\\.)?embedupload\\.com/\\?d=.+'
    __config__ = [('enabled', 'bool', 'Activated', True), ('use_premium', 'bool', 'Use premium account if available', True), ('folder_per_package', 'Default;Yes;No', 'Create folder for each package', 'Default'), ('preferedHoster', 'str', 'Prefered hoster list (bar-separated)', 'embedupload'), ('ignoredHoster', 'str', 'Ignored hoster list (bar-separated)', '')]
    __description__ = 'EmbedUpload.com decrypter plugin'
    __license__ = 'GPLv3'
    __authors__ = [('zoidberg', 'zoidberg@mujmail.cz')]
    LINK_PATTERN = '<div id="(.+?)".*?>\\s*<a href="(.+?)" target="_blank" (?:class="DownloadNow"|style="color:red")>'
