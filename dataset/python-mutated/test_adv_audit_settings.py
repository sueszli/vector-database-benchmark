...
def configure_loader_modules(tmp_path):
    ...
    return {win_lgpo: {'__opts__': {'cachedir': cachedir}, '__salt__': {'file.copy': win_file.copy, 'file.file_exists': win_file.file_exists, 'file.makedirs': win_file.makedirs_, 'file.remove': win_file.remove, 'file.write': win_file.write}, '__utils__': {'auditpol.get_auditpol_dump': auditpol.get_auditpol_dump, 'auditpol.set_setting': auditpol.set_setting}}, auditpol: {'__context__': {}}, win_file: {'__utils__': {'dacl.set_perms': win_dacl.set_perms}}}
