...
class HTMLForm:
    ...
    """
    type2class = {'text': TextControl, 'password': PasswordControl, 'hidden': HiddenControl, 'textarea': TextareaControl, 'isindex': IsindexControl, 'file': FileControl, 'button': IgnoreControl, 'buttonbutton': IgnoreControl, 'reset': IgnoreControl, 'resetbutton': IgnoreControl, 'submit': SubmitControl, 'submitbutton': SubmitButtonControl, 'image': ImageControl, 'radio': RadioControl, 'checkbox': CheckboxControl, 'select': SelectControl}
