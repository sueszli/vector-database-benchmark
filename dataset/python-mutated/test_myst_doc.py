...
parser.add_argument('--path', help='path to the jupytext-compatible file')
parser.add_argument('--find-recursively', action='store_true', help='if true, will attempt to find path recursively in cwd')
parser.add_argument('--no-postprocess', action='store_true', help='if true, will not postprocess the notebook')
