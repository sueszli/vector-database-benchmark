...
from PyQt5.QtCore import QCoreApplication, QDir, QObject, QRect, QSize, QStringListModel, QTimer, QUrl, Qt, pyqtSignal, pyqtSlot
from PyQt5.QtGui import QDesktopServices, QFontDatabase, QIcon, QKeyEvent, QKeySequence, QPixmap
from PyQt5.QtWidgets import QAction, QApplication, QCompleter, QFileDialog, QLineEdit, QListWidget, QMainWindow, QShortcut, QStyledItemDelegate, QSystemTrayIcon, QTreeWidget
...
from tribler.core.utilities.rest_utils import FILE_SCHEME, MAGNET_SCHEME, scheme_from_url, url_is_valid_file, url_to_path
...
from tribler.gui.defs import BUTTON_TYPE_CONFIRM, BUTTON_TYPE_NORMAL, CATEGORY_SELECTOR_FOR_POPULAR_ITEMS, DARWIN, PAGE_CHANNEL_CONTENTS, PAGE_DISCOVERED, PAGE_DISCOVERING, PAGE_DOWNLOADS, PAGE_LOADING, PAGE_POPULAR, PAGE_SEARCH_RESULTS, PAGE_SETTINGS, PAGE_TRUST, PAGE_TRUST_GRAPH_PAGE, SHUTDOWN_WAITING_PERIOD
...
from tribler.gui.utilities import connect, create_api_key, disconnect, format_api_key, get_font_path, get_gui_setting, get_image_path, get_ui_file_path, is_dir_writable, set_api_key, show_message_box, tr
