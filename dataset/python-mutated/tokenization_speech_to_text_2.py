...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'facebook/s2t-wav2vec2-large-en-de': 'https://huggingface.co/facebook/s2t-wav2vec2-large-en-de/resolve/main/vocab.json'}, 'tokenizer_config_file': {'facebook/s2t-wav2vec2-large-en-de': 'https://huggingface.co/facebook/s2t-wav2vec2-large-en-de/resolve/main/tokenizer_config.json'}, 'merges_file': {'facebook/s2t-wav2vec2-large-en-de': 'https://huggingface.co/facebook/s2t-wav2vec2-large-en-de/resolve/main/merges.txt'}}
BPE_TOKEN_MERGES = '</w>'
BPE_TOKEN_VOCAB = '@@ '
