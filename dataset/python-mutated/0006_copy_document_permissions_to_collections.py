...
class Migration(migrations.Migration):
    dependencies = [('wagtailcore', '0026_group_collection_permission'), ('wagtaildocs', '0005_document_collection')]
    operations = [migrations.RunPython(copy_document_permissions_to_collections, remove_document_permissions_from_collections)]