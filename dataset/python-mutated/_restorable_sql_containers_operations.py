...
def build_list_request(location: str, instance_id: str, subscription_id: str, *, restorable_sql_database_rid: Optional[str]=None, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableSqlContainers')
...
class RestorableSqlContainersOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, restorable_sql_database_rid: Optional[str]=None, start_time: Optional[str]=None, end_time: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableSqlContainerGetResult']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(location=location, instance_id=instance_id, subscription_id=self._config.subscription_id, restorable_sql_database_rid=restorable_sql_database_rid, start_time=start_time, end_time=end_time, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
