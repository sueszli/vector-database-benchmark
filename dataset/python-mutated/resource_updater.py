...
class _Resources(namedtuple('_Resources', ['cpu', 'gpu', 'memory', 'object_store_memory', 'extra_cpu', 'extra_gpu', 'extra_memory', 'extra_object_store_memory', 'custom_resources', 'extra_custom_resources', 'has_placement_group'])):
