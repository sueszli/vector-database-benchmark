...
class build_man(Command):
    ...
    user_options = []
    see_also = {'create': ('delete', 'prune', 'check', 'patterns', 'placeholders', 'compression', 'rcreate'), 'recreate': ('patterns', 'placeholders', 'compression'), 'list': ('info', 'diff', 'prune', 'patterns', 'rlist'), 'info': ('list', 'diff', 'rinfo'), 'rcreate': ('rdelete', 'rlist', 'check', 'benchmark-cpu', 'key-import', 'key-export', 'key-change-passphrase'), 'key-import': ('key-export',), 'key-export': ('key-import',), 'mount': ('umount', 'extract'), 'umount': ('mount',), 'extract': ('mount',), 'delete': ('compact', 'rdelete'), 'prune': ('compact',)}
    rst_prelude = textwrap.dedent('\n    .. role:: ref(title)\n\n    .. |project_name| replace:: Borg\n\n    ')
    usage_group = {'break-lock': 'lock', 'with-lock': 'lock', 'key_change-passphrase': 'key', 'key_change-location': 'key', 'key_export': 'key', 'key_import': 'key', 'export-tar': 'tar', 'import-tar': 'tar', 'benchmark_crud': 'benchmark', 'benchmark_cpu': 'benchmark', 'umount': 'mount'}
