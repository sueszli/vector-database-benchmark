...
query_birth_names = {'extras': {'where': '', 'time_grain_sqla': 'P1D'}, 'columns': ['name'], 'metrics': [{'label': 'sum__num'}], 'orderby': [('sum__num', False)], 'row_limit': 100, 'granularity': 'ds', 'time_range': '100 years ago : now', 'timeseries_limit': 0, 'timeseries_limit_metric': None, 'order_desc': True, 'filters': [{'col': 'gender', 'op': '==', 'val': 'boy'}, {'col': 'num', 'op': 'IS NOT NULL'}, {'col': 'name', 'op': 'NOT IN', 'val': ['<NULL>', '"abc"']}], 'having': '', 'where': ''}
QUERY_OBJECTS: dict[str, dict[str, object]] = {'birth_names': query_birth_names, 'birth_names:include_time': {'groupby': [DTTM_ALIAS, 'name']}, 'birth_names:orderby_dup_alias': {'metrics': [{'expressionType': 'SIMPLE', 'column': {'column_name': 'num_girls', 'type': 'BIGINT(20)'}, 'aggregate': 'SUM', 'label': 'num_girls'}, {'expressionType': 'SIMPLE', 'column': {'column_name': 'num_boys', 'type': 'BIGINT(20)'}, 'aggregate': 'SUM', 'label': 'num_boys'}], 'orderby': [[{'expressionType': 'SIMPLE', 'column': {'column_name': 'num_girls', 'type': 'BIGINT(20)'}, 'aggregate': 'SUM', 'label': 'SUM(num_girls)'}, False], [{'expressionType': 'SIMPLE', 'column': {'column_name': 'num_boys', 'type': 'BIGINT(20)'}, 'aggregate': 'AVG', 'label': 'AVG(num_boys)'}, False], [{'expressionType': 'SQL', 'sqlExpression': 'MAX(CASE WHEN num_boys > 0 THEN 1 ELSE 0 END)', 'label': 'MAX(CASE WHEN...'}, True]]}, 'birth_names:only_orderby_has_metric': {'metrics': []}}
ANNOTATION_LAYERS = {AnnotationType.FORMULA: {'annotationType': 'FORMULA', 'color': '#ff7f44', 'hideLine': False, 'name': 'my formula', 'opacity': '', 'overrides': {'time_range': None}, 'show': True, 'showMarkers': False, 'sourceType': '', 'style': 'solid', 'value': '3+x', 'width': 5}, AnnotationType.EVENT: {'name': 'my event', 'annotationType': 'EVENT', 'sourceType': 'NATIVE', 'color': '#e04355', 'opacity': '', 'style': 'solid', 'width': 5, 'showMarkers': False, 'hideLine': False, 'value': 1, 'overrides': {'time_range': None}, 'show': True, 'titleColumn': '', 'descriptionColumns': [], 'timeColumn': '', 'intervalEndColumn': ''}, AnnotationType.INTERVAL: {'name': 'my interval', 'annotationType': 'INTERVAL', 'sourceType': 'NATIVE', 'color': '#e04355', 'opacity': '', 'style': 'solid', 'width': 1, 'showMarkers': False, 'hideLine': False, 'value': 1, 'overrides': {'time_range': None}, 'show': True, 'titleColumn': '', 'descriptionColumns': [], 'timeColumn': '', 'intervalEndColumn': ''}, AnnotationType.TIME_SERIES: {'annotationType': 'TIME_SERIES', 'color': None, 'descriptionColumns': [], 'hideLine': False, 'intervalEndColumn': '', 'name': 'my line', 'opacity': '', 'overrides': {'time_range': None}, 'show': True, 'showMarkers': False, 'sourceType': 'line', 'style': 'dashed', 'timeColumn': '', 'titleColumn': '', 'value': 837, 'width': 5}}
POSTPROCESSING_OPERATIONS = {'birth_names': [{'operation': 'aggregate', 'options': {'groupby': ['name'], 'aggregates': {'q1': {'operator': 'percentile', 'column': 'sum__num', 'options': {'q': 25, 'interpolation': 'lower'}}, 'median': {'operator': 'median', 'column': 'sum__num'}}}}, {'operation': 'sort', 'options': {'by': ['q1', 'name'], 'ascending': [False, True]}}]}
