...
class TubiTvIE(InfoExtractor):
    ...
    _GEO_COUNTRIES = ['US']
    _TESTS = [{'url': 'https://tubitv.com/movies/383676/tracker', 'md5': '566fa0f76870302d11af0de89511d3f0', 'info_dict': {'id': '383676', 'ext': 'mp4', 'title': 'Tracker', 'description': 'md5:ff320baf43d0ad2655e538c1d5cd9706', 'uploader_id': 'f866e2677ea2f0dff719788e4f7f9195', 'release_year': 2010, 'thumbnail': 're:^https?://.+\\.(jpe?g|png)$', 'duration': 6122}}, {'url': 'http://tubitv.com/video/283829/the_comedian_at_the_friday', 'md5': '43ac06be9326f41912dc64ccf7a80320', 'info_dict': {'id': '283829', 'ext': 'mp4', 'title': 'The Comedian at The Friday', 'description': 'A stand up comedian is forced to look at the decisions in his life while on a one week trip to the west coast.', 'uploader_id': 'bc168bee0d18dd1cb3b86c68706ab434'}, 'skip': 'Content Unavailable'}, {'url': 'http://tubitv.com/tv-shows/321886/s01_e01_on_nom_stories', 'only_matching': True}, {'url': 'https://tubitv.com/movies/560057/penitentiary?start=true', 'info_dict': {'id': '560057', 'ext': 'mp4', 'title': 'Penitentiary', 'description': 'md5:8d2fc793a93cc1575ff426fdcb8dd3f9', 'uploader_id': 'd8fed30d4f24fcb22ec294421b9defc2', 'release_year': 1979}, 'skip': 'Content Unavailable'}]
    _UNPLAYABLE_FORMATS = ('hlsv6_widevine', 'hlsv6_widevine_nonclearlead', 'hlsv6_playready_psshv0', 'hlsv6_fairplay', 'dash_widevine', 'dash_widevine_nonclearlead')
...
class TubiTvShowIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://tubitv.com/series/3936/the-joy-of-painting-with-bob-ross?start=true', 'playlist_mincount': 390, 'info_dict': {'id': 'the-joy-of-painting-with-bob-ross'}}]
