...
from dagster._core.definitions.asset_check_evaluation import AssetCheckEvaluation, AssetCheckEvaluationTargetMaterializationData
from dagster._core.definitions.asset_check_spec import AssetCheckSeverity
from dagster._core.definitions.events import AssetKey, CoercibleToAssetKey, MetadataValue, RawMetadataValue, normalize_metadata
from dagster._core.errors import DagsterInvariantViolationError
if TYPE_CHECKING:
    from dagster._core.execution.context.compute import StepExecutionContext

@experimental
class AssetCheckResult(NamedTuple('_AssetCheckResult', [('passed', PublicAttr[bool]), ('asset_key', PublicAttr[Optional[AssetKey]]), ('check_name', PublicAttr[Optional[str]]), ('metadata', PublicAttr[Mapping[str, MetadataValue]]), ('severity', PublicAttr[AssetCheckSeverity])])):
