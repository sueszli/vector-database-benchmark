...
class alloydbCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'batch_create_instances': ('parent', 'requests', 'request_id'), 'create_backup': ('parent', 'backup_id', 'backup', 'request_id', 'validate_only'), 'create_cluster': ('parent', 'cluster_id', 'cluster', 'request_id', 'validate_only'), 'create_instance': ('parent', 'instance_id', 'instance', 'request_id', 'validate_only'), 'create_secondary_cluster': ('parent', 'cluster_id', 'cluster', 'request_id', 'validate_only'), 'create_secondary_instance': ('parent', 'instance_id', 'instance', 'request_id', 'validate_only'), 'create_user': ('parent', 'user_id', 'user', 'request_id', 'validate_only'), 'delete_backup': ('name', 'request_id', 'validate_only', 'etag'), 'delete_cluster': ('name', 'request_id', 'etag', 'validate_only', 'force'), 'delete_instance': ('name', 'request_id', 'etag', 'validate_only'), 'delete_user': ('name', 'request_id', 'validate_only'), 'failover_instance': ('name', 'request_id', 'validate_only'), 'generate_client_certificate': ('parent', 'request_id', 'cert_duration', 'public_key', 'use_metadata_exchange'), 'get_backup': ('name',), 'get_cluster': ('name', 'view'), 'get_connection_info': ('parent', 'request_id'), 'get_instance': ('name', 'view'), 'get_user': ('name',), 'inject_fault': ('fault_type', 'name', 'request_id', 'validate_only'), 'list_backups': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_clusters': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_instances': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_supported_database_flags': ('parent', 'page_size', 'page_token'), 'list_users': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'promote_cluster': ('name', 'request_id', 'etag', 'validate_only'), 'restart_instance': ('name', 'request_id', 'validate_only'), 'restore_cluster': ('parent', 'cluster_id', 'cluster', 'backup_source', 'continuous_backup_source', 'request_id', 'validate_only'), 'update_backup': ('backup', 'update_mask', 'request_id', 'validate_only', 'allow_missing'), 'update_cluster': ('cluster', 'update_mask', 'request_id', 'validate_only', 'allow_missing'), 'update_instance': ('instance', 'update_mask', 'request_id', 'validate_only', 'allow_missing'), 'update_user': ('user', 'update_mask', 'request_id', 'validate_only', 'allow_missing')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=alloydbCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
