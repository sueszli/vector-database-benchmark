...
@MODELS.register_module(Tasks.speech_language_recognition, module_name=Models.campplus_lre)
class LanguageRecognitionCAMPPlus(TorchModel):
    """A speech language recognition model using the CAM++ architecture as the backbone.
    Args:
