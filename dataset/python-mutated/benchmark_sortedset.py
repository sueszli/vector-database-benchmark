...
for (name, kind) in kinds.items():
    impls['add'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'add', 'limit': 1000000}
limit('add', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['update_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'update', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['update_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'update', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['update_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'update', 'limit': 1000000}
limit('update_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['update_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'update', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['union_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'union', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['union_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'union', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['union_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'union', 'limit': 1000000}
limit('union_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['union_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'union', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['remove'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'remove', 'limit': 1000000}
limit('remove', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['difference_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['difference_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['difference_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference', 'limit': 1000000}
limit('difference_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['difference_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['difference_update_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference_update', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['difference_update_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference_update', 'limit': 1000000}
for (name, kind) in kinds.items():
    impls['difference_update_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference_update', 'limit': 1000000}
limit('difference_update_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['difference_update_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'difference_update', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['intersection_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection', 'limit': 1000000}
limit('intersection_tiny', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection', 'limit': 1000000}
limit('intersection_small', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection', 'limit': 1000000}
limit('intersection_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['intersection_update_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection_update', 'limit': 1000000}
limit('intersection_update_tiny', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_update_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection_update', 'limit': 1000000}
limit('intersection_update_small', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_update_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection_update', 'limit': 1000000}
limit('intersection_update_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['intersection_update_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'intersection_update', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['symmetric_difference_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference', 'limit': 1000000}
limit('symmetric_difference_tiny', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference', 'limit': 1000000}
limit('symmetric_difference_small', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference', 'limit': 1000000}
limit('symmetric_difference_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['symmetric_difference_update_tiny'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference_update', 'limit': 1000000}
limit('symmetric_difference_update_tiny', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_update_small'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference_update', 'limit': 1000000}
limit('symmetric_difference_update_small', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_update_medium'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference_update', 'limit': 1000000}
limit('symmetric_difference_update_medium', 'B-Tree', 10000)
for (name, kind) in kinds.items():
    impls['symmetric_difference_update_large'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'symmetric_difference_update', 'limit': 1000000}
...
for (name, kind) in kinds.items():
    impls['pop'][name] = {'setup': fill_values, 'ctor': kind, 'func': 'pop', 'limit': 1000000}
for (name, kind) in kinds.items():
