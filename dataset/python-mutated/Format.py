...
Align = get_named_tuple('align', {'default': '', 'left': '<', 'right': '>', 'center': '^', 'right_sign': '='})
Group = get_named_tuple('group', {'no': '', 'yes': ','})
Padding = get_named_tuple('padding', {'no': '', 'yes': '0'})
Prefix = get_named_tuple('prefix', {'yocto': 10 ** (-24), 'zepto': 10 ** (-21), 'atto': 10 ** (-18), 'femto': 10 ** (-15), 'pico': 10 ** (-12), 'nano': 10 ** (-9), 'micro': 10 ** (-6), 'milli': 10 ** (-3), 'none': None, 'kilo': 10 ** 3, 'mega': 10 ** 6, 'giga': 10 ** 9, 'tera': 10 ** 12, 'peta': 10 ** 15, 'exa': 10 ** 18, 'zetta': 10 ** 21, 'yotta': 10 ** 24})
Scheme = get_named_tuple('scheme', {'default': '', 'decimal': 'r', 'decimal_integer': 'd', 'decimal_or_exponent': 'g', 'decimal_si_prefix': 's', 'exponent': 'e', 'fixed': 'f', 'percentage': '%', 'percentage_rounded': 'p', 'binary': 'b', 'octal': 'o', 'lower_case_hex': 'x', 'upper_case_hex': 'X', 'unicode': 'c'})
Sign = get_named_tuple('sign', {'default': '', 'negative': '-', 'positive': '+', 'parantheses': '(', 'space': ' '})
