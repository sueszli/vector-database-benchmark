...
def build_list_request(location: str, instance_id: str, subscription_id: str, *, restore_location: Optional[str]=None, restore_timestamp_in_utc: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        return 10
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGremlinResources')
    ...
    if restore_timestamp_in_utc is not None:
        _params['restoreTimestampInUtc'] = _SERIALIZER.query('restore_timestamp_in_utc', restore_timestamp_in_utc, 'str')
...
class RestorableGremlinResourcesOperations:
    ...
    @distributed_trace
    def list(self, location: str, instance_id: str, restore_location: Optional[str]=None, restore_timestamp_in_utc: Optional[str]=None, **kwargs: Any) -> Iterable['_models.RestorableGremlinResourcesGetResult']:
        if False:
            print('Hello World!')
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(location=location, instance_id=instance_id, subscription_id=self._config.subscription_id, restore_location=restore_location, restore_timestamp_in_utc=restore_timestamp_in_utc, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DocumentDB/locations/{location}/restorableDatabaseAccounts/{instanceId}/restorableGremlinResources'}