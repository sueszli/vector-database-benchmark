...
class sfp_dehashed(SpiderFootPlugin):
    meta = {'name': 'Dehashed', 'summary': 'Gather breach data from Dehashed API.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Leaks, Dumps and Breaches'], 'dataSource': {'website': 'https://www.dehashed.com/', 'model': 'COMMERCIAL_ONLY', 'references': ['https://www.dehashed.com/docs'], 'apiKeyInstructions': ['Visit https://www.dehashed.com/registerRegister a free account', 'Visit https://www.dehashed.com/profile', "Your API key is listed under 'API Key'"], 'favIcon': 'https://www.dehashed.com/assets/img/favicon.ico', 'logo': 'https://www.dehashed.com/assets/img/logo.png', 'description': 'Have you been compromised? DeHashed provides free deep-web scans and protection against credential leaks. A modern personal asset search engine created for security analysts, journalists, security companies, and everyday people to help secure accounts and provide insight on compromised assets. Free breach alerts & breach notifications.'}}
    opts = {'api_key_username': '', 'api_key': '', 'per_page': 10000, 'max_pages': 2, 'pause': 1}
    optdescs = {'api_key_username': 'Dehashed username.', 'api_key': 'Dehashed API key.', 'per_page': 'Maximum number of results per page.(Max: 10000)', 'max_pages': 'Maximum number of pages to fetch(Max: 10 pages)', 'pause': 'Number of seconds to wait between each API call.'}
    results = None
    errorState = False
