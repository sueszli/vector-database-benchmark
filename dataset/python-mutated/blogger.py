...
class BloggerIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+src=["\'](?P<url>(?:https?:)?//(?:www\\.)?blogger\\.com/video\\.g\\?token=[^"\']+)["\']']
    _TESTS = [{'url': 'https://www.blogger.com/video.g?token=AD6v5dzEe9hfcARr5Hlq1WTkYy6t-fXH3BBahVhGvVHe5szdEUBEloSEDSTA8-b111089KbfWuBvTN7fnbxMtymsHhXAXwVvyzHH4Qch2cfLQdGxKQrrEuFpC1amSl_9GuLWODjPgw', 'md5': 'f1bc19b6ea1b0fd1d81e84ca9ec467ac', 'info_dict': {'id': 'BLOGGER-video-3c740e3a49197e16-796', 'title': 'BLOGGER-video-3c740e3a49197e16-796', 'ext': 'mp4', 'thumbnail': 're:^https?://.*', 'duration': 76.068}}]
