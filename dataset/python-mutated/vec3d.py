...
if TYPE_CHECKING:
    ...
    Vec3DLike = Any
Vec3DArrayLike = Union[Vec3D, Sequence[Vec3DLike], npt.NDArray[Any], npt.ArrayLike, Sequence[Sequence[float]], Sequence[float]]
...
class Vec3DType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            print('Hello World!')
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 3), self._TYPE_NAME)
