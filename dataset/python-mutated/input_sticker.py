...
class InputSticker(TelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, sticker: Union[InputFile, str], emoji_list: List[str], mask_position: Optional[MaskPosition]=None, keywords: Optional[List[str]]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(sticker=sticker, emoji_list=emoji_list, mask_position=mask_position, keywords=keywords, **__pydantic_kwargs)