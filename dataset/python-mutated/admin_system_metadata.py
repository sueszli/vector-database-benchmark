...
class AdminSystemMetadata(object):
    ...
    swagger_types = {'execution_cluster': 'str', 'namespace': 'str'}
    attribute_map = {'execution_cluster': 'execution_cluster', 'namespace': 'namespace'}

    def __init__(self, execution_cluster=None, namespace=None):
        if False:
            while True:
                i = 10
        'AdminSystemMetadata - a model defined in Swagger'
