...
class NGUPolicy(Policy):
    ...
    Config:
        ...
        == ==================== ======== ============== ======================================== =======================
    """
    config = dict(type='ngu', cuda=False, on_policy=False, priority=True, priority_IS_weight=True, discount_factor=0.997, nstep=5, burnin_step=20, learn_unroll_len=80, learn=dict(update_per_collect=1, batch_size=64, learning_rate=0.0001, target_update_theta=0.001, value_rescale=True, ignore_done=False), collect=dict(n_sample=32, traj_len_inf=True, env_num=None), eval=dict(env_num=None), other=dict(eps=dict(type='exp', start=0.95, end=0.05, decay=10000), replay_buffer=dict(replay_buffer_size=10000)))
