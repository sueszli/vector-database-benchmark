...
class FilecloudIo(SimpleDownloader):
    ...
    __version__ = '0.17'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?(?:filecloud\\.io|ifile\\.it|mihd\\.net)/(?P<ID>\\w+)'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('zoidberg', 'zoidberg@mujmail.cz'), ('stickell', 'l.stickell@yahoo.it'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
    INFO_PATTERN = '<i class="fa fa-file-archive-o fa-fw"></i>&nbsp;(?P<N>.*?) \\[(?P<S>[\\d.,]+) (?P<U>[\\w^_]+)\\]<'
    OFFLINE_PATTERN = '>The file at this URL was either removed or did not exist in the first place<'
    TEMP_OFFLINE_PATTERN = 'l10n\\.FILES__WARNING'
