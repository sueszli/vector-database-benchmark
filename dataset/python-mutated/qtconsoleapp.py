...
from traitlets import Dict, Unicode, CBool, Any
...
qt_flags.update(boolean_flag('banner', 'JupyterQtConsoleApp.display_banner', 'Display a banner upon starting the QtConsole.', "Don't display a banner upon starting the QtConsole."))
qt_flags.update(app_flags)
flags.update(qt_flags)
aliases = dict(base_aliases)
qt_aliases = dict(style='JupyterWidget.syntax_style', stylesheet='JupyterQtConsoleApp.stylesheet', editor='JupyterWidget.editor', paging='ConsoleWidget.paging')
...
class JupyterQtConsoleApp(JupyterApp, JupyterConsoleApp):
    ...
    display_banner = CBool(True, config=True, help='Whether to display a banner upon starting the QtConsole.')
