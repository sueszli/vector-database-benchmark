...
class MaxPooling3D(BasePooling):
    ...
    def __init__(self, pool_size=(2, 2, 2), strides=None, padding='valid', data_format=None, name=None, **kwargs):
        if False:
            for i in range(10):
                print('nop')
        super().__init__(pool_size, strides, pool_dimensions=3, pool_mode='max', padding=padding, data_format=data_format, name=name, **kwargs)