...
def main(cfg, seed=0, max_iterations=int(10000000000.0)):
    if False:
        print('Hello World!')
    cfg = compile_config(cfg, BaseEnvManager, D4PGPolicy, BaseLearner, SampleSerialCollector, InteractionSerialEvaluator, AdvancedReplayBuffer, MujocoEnv, save_cfg=True)
