...
from modelscope.models.cv.video_super_resolution import MSRResNetLiteModel, RealBasicVSRNetForVideoSR
...
@PIPELINES.register_module(Tasks.video_super_resolution, module_name=Pipelines.video_super_resolution)
