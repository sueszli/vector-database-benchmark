...
class Payload(PerlReverseTCP):
    __info__ = {'name': 'Perl Reverse TCP One-Liner', 'description': 'Creates interactive tcp reverse shell by using perl one-liner.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',)}
