...
class TestAdminWorkflowExecutionGetDataResponse(unittest.TestCase):
    """AdminWorkflowExecutionGetDataResponse unit test stubs"""
    ...
    def testAdminWorkflowExecutionGetDataResponse(self):
        if False:
            return 10
