...
class EmailMessageDataSet(AbstractVersionedDataset[Message, Message]):
    ...
    def _describe(self) -> Dict[str, Any]:
        if False:
            print('Hello World!')
        return {'filepath': self._filepath, 'protocol': self._protocol, 'load_args': self._load_args, 'parser_args': self._parser_args, 'save_args': self._save_args, 'generator_args': self._generator_args, 'version': self._version}
