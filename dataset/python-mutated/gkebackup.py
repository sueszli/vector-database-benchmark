...
__protobuf__ = proto.module(package='google.cloud.gkebackup.v1', manifest={'OperationMetadata', 'CreateBackupPlanRequest', 'ListBackupPlansRequest', 'ListBackupPlansResponse', 'GetBackupPlanRequest', 'UpdateBackupPlanRequest', 'DeleteBackupPlanRequest', 'CreateBackupRequest', 'ListBackupsRequest', 'ListBackupsResponse', 'GetBackupRequest', 'UpdateBackupRequest', 'DeleteBackupRequest', 'ListVolumeBackupsRequest', 'ListVolumeBackupsResponse', 'GetVolumeBackupRequest', 'CreateRestorePlanRequest', 'ListRestorePlansRequest', 'ListRestorePlansResponse', 'GetRestorePlanRequest', 'UpdateRestorePlanRequest', 'DeleteRestorePlanRequest', 'CreateRestoreRequest', 'ListRestoresRequest', 'ListRestoresResponse', 'GetRestoreRequest', 'UpdateRestoreRequest', 'DeleteRestoreRequest', 'ListVolumeRestoresRequest', 'ListVolumeRestoresResponse', 'GetVolumeRestoreRequest'})
...
class CreateBackupPlanRequest(proto.Message):
    ...
    backup_plan: gcg_backup_plan.BackupPlan = proto.Field(proto.MESSAGE, number=2, message=gcg_backup_plan.BackupPlan)
    backup_plan_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    backup_plans: MutableSequence[gcg_backup_plan.BackupPlan] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcg_backup_plan.BackupPlan)
...
class UpdateBackupPlanRequest(proto.Message):
    ...
    """
    backup_plan: gcg_backup_plan.BackupPlan = proto.Field(proto.MESSAGE, number=1, message=gcg_backup_plan.BackupPlan)
...
class CreateBackupRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    backup: gcg_backup.Backup = proto.Field(proto.MESSAGE, number=2, message=gcg_backup.Backup)
...
class ListBackupsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    backups: MutableSequence[gcg_backup.Backup] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcg_backup.Backup)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateBackupRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            Backup.
    """
    backup: gcg_backup.Backup = proto.Field(proto.MESSAGE, number=1, message=gcg_backup.Backup)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class ListVolumeBackupsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    volume_backups: MutableSequence[volume.VolumeBackup] = proto.RepeatedField(proto.MESSAGE, number=1, message=volume.VolumeBackup)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateRestorePlanRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    restore_plan: gcg_restore_plan.RestorePlan = proto.Field(proto.MESSAGE, number=2, message=gcg_restore_plan.RestorePlan)
    restore_plan_id: str = proto.Field(proto.STRING, number=3)
...
class ListRestorePlansResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    restore_plans: MutableSequence[gcg_restore_plan.RestorePlan] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcg_restore_plan.RestorePlan)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class UpdateRestorePlanRequest(proto.Message):
    ...
    """
    restore_plan: gcg_restore_plan.RestorePlan = proto.Field(proto.MESSAGE, number=1, message=gcg_restore_plan.RestorePlan)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class CreateRestoreRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    restore: gcg_restore.Restore = proto.Field(proto.MESSAGE, number=2, message=gcg_restore.Restore)
    restore_id: str = proto.Field(proto.STRING, number=3)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    restores: MutableSequence[gcg_restore.Restore] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcg_restore.Restore)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class UpdateRestoreRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            target Restore.
    """
    restore: gcg_restore.Restore = proto.Field(proto.MESSAGE, number=1, message=gcg_restore.Restore)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class ListVolumeRestoresResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    volume_restores: MutableSequence[volume.VolumeRestore] = proto.RepeatedField(proto.MESSAGE, number=1, message=volume.VolumeRestore)
    next_page_token: str = proto.Field(proto.STRING, number=2)
