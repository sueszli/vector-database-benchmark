...
class Exploit(SNMPClient):
    __info__ = {'name': 'Thomson TWG849 Info Disclosure', 'description': 'Module exploits Thomson TWG849 information disclosure vulnerability which allows reading sensitive information.', 'authors': ('Sebastian Perez', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://packetstormsecurity.com/files/133631/Thomson-CableHome-Gateway-DWG849-Information-Disclosure.html',), 'devices': ('Thomson TWG849',)}
