...
from modelscope.models.cv.video_instance_segmentation.video_knet import KNetTrack
...
@PIPELINES.register_module(Tasks.video_instance_segmentation, module_name=Pipelines.video_instance_segmentation)
