...
class Cycle(ProjectBaseModel):
    ...
    owned_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='owned_by_cycle')
...
class CycleIssue(ProjectBaseModel):
    ...
    Cycle Issues
    """
    issue = models.OneToOneField('db.Issue', on_delete=models.CASCADE, related_name='issue_cycle')
...
class CycleFavorite(ProjectBaseModel):
    ...
    """
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='cycle_favorites')
    cycle = models.ForeignKey('db.Cycle', on_delete=models.CASCADE, related_name='cycle_favorites')
