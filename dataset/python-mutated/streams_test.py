...
from source_tiktok_marketing.streams import AdGroupsReports, Ads, AdsAudienceReports, AdsReports, Advertisers, AdvertisersAudienceReports, AdvertisersReports, BasicReports, CampaignsReports, Daily, Hourly, Lifetime, ReportGranularity
START_DATE = '2020-01-01'
END_DATE = '2020-03-01'
CONFIG = {'access_token': 'access_token', 'secret': 'secret', 'authenticator': None, 'start_date': START_DATE, 'end_date': END_DATE, 'app_id': 1234, 'advertiser_id': 0, 'include_deleted': True}
CONFIG_SANDBOX = {'access_token': 'access_token', 'secret': 'secret', 'authenticator': None, 'start_date': START_DATE, 'end_date': END_DATE, 'app_id': 1234, 'advertiser_id': 2000}
