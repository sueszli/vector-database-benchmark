...
def create_custom_instances_no_helper(project_id: str, zone: str, instance_name: str, core_count: int, memory: int) -> list[compute_v1.Instance]:
    if False:
        return 10
