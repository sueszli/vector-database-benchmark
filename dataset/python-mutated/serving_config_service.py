...
__protobuf__ = proto.module(package='google.cloud.retail.v2', manifest={'CreateServingConfigRequest', 'UpdateServingConfigRequest', 'DeleteServingConfigRequest', 'GetServingConfigRequest', 'ListServingConfigsRequest', 'ListServingConfigsResponse', 'AddControlRequest', 'RemoveControlRequest'})
...
class CreateServingConfigRequest(proto.Message):
    ...
    serving_config: gcr_serving_config.ServingConfig = proto.Field(proto.MESSAGE, number=2, message=gcr_serving_config.ServingConfig)
    serving_config_id: str = proto.Field(proto.STRING, number=3)
...
class UpdateServingConfigRequest(proto.Message):
    ...
    """
    serving_config: gcr_serving_config.ServingConfig = proto.Field(proto.MESSAGE, number=1, message=gcr_serving_config.ServingConfig)
...
class ListServingConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    serving_configs: MutableSequence[gcr_serving_config.ServingConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcr_serving_config.ServingConfig)
...
class AddControlRequest(proto.Message):
    ...
    """
    serving_config: str = proto.Field(proto.STRING, number=1)
    control_id: str = proto.Field(proto.STRING, number=2)
