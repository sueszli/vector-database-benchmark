...
class RaiseLoadIgnoredTest(fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
...
class SingleCyclePlusAttributeTest(fixtures.MappedTest, testing.AssertsExecutionResults, AssertsUOW):
...
class SingleCycleM2MTest(fixtures.MappedTest, testing.AssertsExecutionResults, AssertsUOW):
...
class EagerDefaultsSettingTest(testing.AssertsExecutionResults, fixtures.TestBase):
    __backend__ = True
