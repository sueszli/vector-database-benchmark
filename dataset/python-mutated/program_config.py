...
from paddle.base.framework import IrGraph, IrNode, Operator, OpProtoHolder, convert_np_dtype_to_dtype_
...
class OpConfig:
    ...
    def __repr__(self):
        ...
        return log_str
_OP_WITHOUT_KERNEL_SET = {'feed', 'fetch', 'recurrent', 'go', 'conditional_block', 'static_pylayer', 'while', 'send', 'recv', 'listen_and_serv', 'fl_listen_and_serv', 'ncclInit', 'select', 'checkpoint_notify', 'gen_bkcl_id', 'c_gen_bkcl_id', 'gen_nccl_id', 'c_gen_nccl_id', 'c_comm_init', 'c_sync_calc_stream', 'c_sync_comm_stream', 'queue_generator', 'dequeue', 'enqueue', 'heter_listen_and_serv', 'c_wait_comm', 'c_wait_compute', 'copy_cross_scope'}
