...
__all__ = ['Palette', 'IndexedPalette', 'DiscretePalette', 'LimitedDiscretePalette', 'DiscretePalettes', 'DefaultDiscretePalette', 'DefaultDiscretePaletteName', 'HuePalette', 'DefaultRGBColors', 'Dark2Colors', 'Glasbey', 'ContinuousPalette', 'ContinuousPalettes', 'BinnedContinuousPalette', 'DefaultContinuousPalette', 'DefaultContinuousPaletteName', 'ColorIcon', 'get_default_curve_colors', 'patch_variable_colors', 'NAN_COLOR']
...
class Palette:
    ...
    """
    Flags = Enum('PaletteFlags', dict(NoFlags=0, ColorBlindSafe=1, Diverging=2, Discrete=4), type=int, qualname='Palette.Flags')
