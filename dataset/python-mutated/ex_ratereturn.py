...
plt.imshow(residcorr, cmap=plt.cm.jet, interpolation='nearest', extent=(0, 30, 0, 30), vmin=-1.0, vmax=1.0)
plt.colorbar()
normcolor = (0, 1)
fig = plt.figure()
...
plot_corr(residcorr, xnames=ticksym, title='Correlation Residuals', normcolor=normcolor, ax=ax3)
