...
class PropertiesProvider(mimesis.BaseProvider):
    ...
    OS_WEIGHTED_POOLS: Dict[str, WeightedPool] = {'Desktop': (['Windows', 'Mac OS X', 'Linux', 'Chrome OS'], [18, 16, 7, 1]), 'Mobile': (['iOS', 'Android'], [1, 1]), 'Tablet': (['iOS', 'Android'], [1, 1])}
    BROWSER_WEIGHTED_POOLS: Dict[str, WeightedPool] = {'Windows': (['Chrome', 'Firefox', 'Opera', 'Microsoft Edge', 'Internet Explorer'], [12, 4, 2, 1, 1]), 'Mac OS X': (['Chrome', 'Firefox', 'Opera', 'Safari'], [4, 2, 1, 2]), 'Linux': (['Chrome', 'Firefox', 'Opera'], [3, 3, 1]), 'Chrome OS': (['Chrome'], [1]), 'iOS': (['Mobile Safari', 'Chrome iOS', 'Firefox iOS'], [8, 1, 1]), 'Android': (['Chrome', 'Android Mobile', 'Samsung Internet', 'Firefox'], [5, 3, 3, 1])}
    INDUSTRY_POOL = ([Industry.TECHNOLOGY, Industry.HEALTHCARE, Industry.FINANCE, Industry.EDUCATION, Industry.ENTERTAINMENT, Industry.RETAIL, Industry.TRAVEL, Industry.FOOD, Industry.REAL_ESTATE, Industry.OTHER], [3, 1, 1, 2, 2, 1, 2, 2, 1, 3])
