...
ADD_MUL_LOGICAL_TYPES = ['aten::add', 'aten::add_', 'aten::sub', 'aten::sub_', 'aten::subtract', 'aten::subtract_', 'aten::mul', 'aten::mul_', 'aten::div', 'aten::div_', 'aten::multiply', 'aten::multiply_', 'aten::divide', 'aten::divide_', 'aten::addcmul', 'aten::addcmul_', 'aten::addcdiv', 'aten::addcdiv_', 'aten::logical_xor', 'aten::logical_xor_', 'aten::logical_and', 'aten::logical_and_', 'aten::logical_or', 'aten::logical_or_']
CAT_TYPE = 'aten::cat'
logger = logging.getLogger('Shape_Dependency')
RESHAPE_OPS = [CAT_TYPE, 'aten::view', 'aten::reshape', 'aten::flatten', 'aten::mean', 'aten::expand_as', 'aten::pixel_shuffle']
