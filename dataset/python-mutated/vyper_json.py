...
TRANSLATE_MAP = {'abi': 'abi', 'ast': 'ast_dict', 'devdoc': 'devdoc', 'evm.methodIdentifiers': 'method_identifiers', 'evm.bytecode.object': 'bytecode', 'evm.bytecode.opcodes': 'opcodes', 'evm.deployedBytecode.object': 'bytecode_runtime', 'evm.deployedBytecode.opcodes': 'opcodes_runtime', 'evm.deployedBytecode.sourceMap': 'source_map', 'evm.deployedBytecode.sourceMapFull': 'source_map_full', 'interface': 'interface', 'ir': 'ir_dict', 'ir_runtime': 'ir_runtime_dict', 'metadata': 'metadata', 'layout': 'layout', 'userdoc': 'userdoc'}
