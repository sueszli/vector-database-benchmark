...
if is_tf_available():
    ...
    from transformers import TF_DPR_CONTEXT_ENCODER_PRETRAINED_MODEL_ARCHIVE_LIST, TF_DPR_QUESTION_ENCODER_PRETRAINED_MODEL_ARCHIVE_LIST, TF_DPR_READER_PRETRAINED_MODEL_ARCHIVE_LIST, BertConfig, DPRConfig, TFDPRContextEncoder, TFDPRQuestionEncoder, TFDPRReader
...
class TFDPRModelTester:
    ...
    def create_and_check_dpr_context_encoder(self, config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            print('Hello World!')
    ...
    def create_and_check_dpr_question_encoder(self, config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            while True:
                i = 10
    ...
    def create_and_check_dpr_reader(self, config, input_ids, token_type_ids, input_mask, sequence_labels, token_labels, choice_labels):
        if False:
            print('Hello World!')
...
class TFDPRModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        ...
        input_ids = tf.constant([[101, 7592, 1010, 2003, 2026, 3899, 10140, 1029, 102]])
        output = model(input_ids)[0]
        expected_slice = tf.constant([[0.03236253, 0.12753335, 0.16818509, 0.00279786, 0.3896933, 0.24264945, 0.2178971, -0.02335227, -0.08481959, -0.14324117]])
        self.assertTrue(numpy.allclose(output[:, :10].numpy(), expected_slice.numpy(), atol=0.0001))