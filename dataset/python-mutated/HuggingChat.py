...
class HuggingChat(AsyncGeneratorProvider):
    ...
    @classmethod
    async def create_async_generator(cls, model: str, messages: Messages, stream: bool=True, proxy: str=None, cookies: dict=None, **kwargs) -> AsyncResult:
        ...
        async with ClientSession(cookies=cookies, headers=headers) as session:
            ...
            send = {'id': str(uuid.uuid4()), 'inputs': format_prompt(messages), 'is_retry': False, 'response_id': str(uuid.uuid4()), 'web_search': False}
