...
@pytest.mark.parametrize('failing_node_names,expected_pattern', [(['node1_A'], 'No nodes ran.'), (['node2'], '(node1_A,node1_B|node1_B,node1_A)'), (['node3_A'], '(node3_A,node3_B|node3_B,node3_A)'), (['node4_A'], '(node3_A,node3_B|node3_B,node3_A)'), (['node3_A', 'node4_A'], '(node3_A,node3_B|node3_B,node3_A)'), (['node2', 'node4_A'], '(node1_A,node1_B|node1_B,node1_A)')])
