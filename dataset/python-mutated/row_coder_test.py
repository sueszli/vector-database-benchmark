...
class RowCoderTest(unittest.TestCase):
    JON_SNOW = Person(name='Jon Snow', age=np.int32(23), address=None, aliases=['crow', 'wildling'], knows_javascript=False, payload=None, custom_metadata={}, favorite_time=Timestamp.from_rfc3339('2016-03-18T23:22:59.123456Z'))
    PEOPLE = [JON_SNOW, Person('Daenerys Targaryen', np.int32(25), 'Westeros', ['Mother of Dragons'], False, None, {'dragons': 3}, Timestamp.from_rfc3339('1970-04-26T17:46:40Z')), Person('Michael Bluth', np.int32(30), None, [], True, b"I've made a huge mistake", {}, Timestamp.from_rfc3339('2020-08-12T15:51:00.032Z'))]
