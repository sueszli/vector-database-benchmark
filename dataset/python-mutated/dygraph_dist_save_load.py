...
if __name__ == '__main__':
    ...
    parser.add_argument('--strategy', required=False, choices=['dp', 'sharding_stage2'])
    ...
    parser.add_argument('--test_case', required=False, choices=['dp:dp', 'dp:sharding_stage2', 'sharding_stage2:dp', 'sharding_stage2:sharding_stage2'])
