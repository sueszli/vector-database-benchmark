...
if is_torch_available():
    import torch
    from transformers import RealmEmbedder, RealmForOpenQA, RealmKnowledgeAugEncoder, RealmReader, RealmRetriever, RealmScorer, RealmTokenizer
...
class RealmModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (RealmEmbedder, RealmKnowledgeAugEncoder) if is_torch_available() else ()
