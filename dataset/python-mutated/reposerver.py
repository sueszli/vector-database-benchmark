...
channel_parser.add_argument('-d', '--directory', type=str, default=os.getcwd(), help='Root directory for serving.')
channel_parser.add_argument('-n', '--name', type=str, default=None, help='Unique name of the channel used in URL')
channel_parser.add_argument('-a', '--auth', default=None, type=str, help='auth method (none, basic, token, or bearer)')
channel_parser.add_argument('--sign', action='store_true', help='Sign repodata (note: run generate_gpg_keys.sh before)')
channel_parser.add_argument('--token', type=str, default=None, help='Use token as API Key')
channel_parser.add_argument('--bearer', type=str, default=None, help='Use bearer token as API Key')
channel_parser.add_argument('--user', type=str, default=None, help='Use token as API Key')
channel_parser.add_argument('--password', type=str, default=None, help='Use token as API Key')
