...
from ..utils import bool_or_none, ExtractorError, dict_get, float_or_none, int_or_none, str_or_none, traverse_obj, try_get, url_or_none, urljoin

class GettrBaseIE(InfoExtractor):
    _BASE_REGEX = 'https?://(www\\.)?gettr\\.com/'
...
class GettrIE(GettrBaseIE):
    _VALID_URL = GettrBaseIE._BASE_REGEX + 'post/(?P<id>[a-z0-9]+)'
    _TESTS = [{'url': 'https://www.gettr.com/post/pcf6uv838f', 'info_dict': {'id': 'pcf6uv838f', 'title': 'md5:9086a646bbd06c41c4fe8e52b3c93454', 'description': 'md5:be0577f1e4caadc06de4a002da2bf287', 'ext': 'mp4', 'uploader': 'EpochTV', 'uploader_id': 'epochtv', 'upload_date': '20210927', 'thumbnail': 're:^https?://.+/out\\.jpg', 'timestamp': 1632782451.058, 'duration': 58.5585, 'tags': ['hornofafrica', 'explorations']}}, {'url': 'https://gettr.com/post/p4iahp', 'info_dict': {'id': 'p4iahp', 'title': 'md5:b03c07883db6fbc1aab88877a6c3b149', 'description': 'md5:741b7419d991c403196ed2ea7749a39d', 'ext': 'mp4', 'uploader': 'Neues Forum Freiheit', 'uploader_id': 'nf_freiheit', 'upload_date': '20210718', 'thumbnail': 're:^https?://.+/out\\.jpg', 'timestamp': 1626594455.017, 'duration': 23, 'tags': 'count:12'}}, {'url': 'https://gettr.com/post/pxn5b743a9', 'only_matching': True}, {'url': 'https://gettr.com/post/pxtiiz5ca2', 'only_matching': True}, {'url': 'https://gettr.com/post/pxlu8p3b13', 'only_matching': True}, {'url': 'https://gettr.com/post/pv6wp9e24c', 'only_matching': True, 'add_ie': ['Youtube']}]
...
class GettrStreamingIE(GettrBaseIE):
    _VALID_URL = GettrBaseIE._BASE_REGEX + 'streaming/(?P<id>[a-z0-9]+)'
    _TESTS = [{'url': 'https://gettr.com/streaming/psoiulc122', 'info_dict': {'id': 'psoiulc122', 'ext': 'mp4', 'description': 'md5:56bca4b8f48f1743d9fd03d49c723017', 'view_count': int, 'uploader': 'Corona Investigative Committee', 'uploader_id': 'coronacommittee', 'duration': 5180.184, 'thumbnail': 're:^https?://.+', 'title': 'Day 1: Opening Session of the Grand Jury Proceeding', 'timestamp': 1644080997.164, 'upload_date': '20220205'}}, {'url': 'https://gettr.com/streaming/psfmeefcc1', 'info_dict': {'id': 'psfmeefcc1', 'ext': 'mp4', 'title': 'Session 90: "The Virus Of Power"', 'view_count': int, 'uploader_id': 'coronacommittee', 'description': 'md5:98986acdf656aa836bf36f9c9704c65b', 'uploader': 'Corona Investigative Committee', 'thumbnail': 're:^https?://.+', 'duration': 21872.507, 'timestamp': 1643976662.858, 'upload_date': '20220204'}}]
