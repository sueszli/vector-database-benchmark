...
if __name__ == '__main__':
    ...
    try:
        ...
        print("You need Cython to rebuild URH's device extensions. You can get it e.g. with python3 -m pip install cython.", file=sys.stderr)
        sys.exit(1)
    (dev_extensions, dev_extras) = get_device_extensions_and_extras(library_dirs=library_directories, include_dirs=include_directories)
    setup(name='urh', ext_modules=cythonize(dev_extensions, force=True, compile_time_env=dev_extras, compiler_directives=COMPILER_DIRECTIVES))