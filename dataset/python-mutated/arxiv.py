...
arxiv_id = re.compile('(?<!\\d)(\\d{4}\\.\\d{5})(?!\\d)')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--mode', default='top100', choices=['top', 'ids', 'dirs'], help='Where to extract code from. top: current 100 arxiv papers (-m top int for any other number of papers), id: specific arxiv ids.                               Usage: `python arxiv.py -m ids id001 [id002 ...]`, dirs: a folder full of .tar.gz files. Usage: `python arxiv.py -m dirs directory [dir2 ...]`')
    ...
    parser.add_argument('-d', '--demacro', dest='demacro', action='store_true', help='Deprecated - Use de-macro (Slows down extraction, may but improves quality). Install https://www.ctan.org/pkg/de-macro')
