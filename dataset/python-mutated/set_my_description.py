...
class SetMyDescription(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, description: Optional[str]=None, language_code: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(description=description, language_code=language_code, **__pydantic_kwargs)