...
class Authorization(proto.Message):
    ...
    service_account_email: str = proto.Field(proto.STRING, number=2)
    oauth_client_id: str = proto.Field(proto.STRING, number=3)
...
class CreateDeploymentRequest(proto.Message):
    ...
    deployment: 'Deployment' = proto.Field(proto.MESSAGE, number=3, message='Deployment')
...
class ReplaceDeploymentRequest(proto.Message):
    ...
    Attributes:
        deployment (google.cloud.gsuiteaddons_v1.types.Deployment):
            ...
            replace.
    """
    deployment: 'Deployment' = proto.Field(proto.MESSAGE, number=2, message='Deployment')
...
class ListDeploymentsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    deployments: MutableSequence['Deployment'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Deployment')
...
class InstallStatus(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    installed: wrappers_pb2.BoolValue = proto.Field(proto.MESSAGE, number=2, message=wrappers_pb2.BoolValue)
...
class Deployment(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    oauth_scopes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    add_ons: 'AddOns' = proto.Field(proto.MESSAGE, number=3, message='AddOns')
...
class AddOns(proto.Message):
    ...
    Attributes:
        ...
        http_options (google.apps.script.type.types.HttpOptions):
            ...
            endpoints
    """
    common: script_manifest.CommonAddOnManifest = proto.Field(proto.MESSAGE, number=1, message=script_manifest.CommonAddOnManifest)
    gmail: gmail_addon_manifest.GmailAddOnManifest = proto.Field(proto.MESSAGE, number=2, message=gmail_addon_manifest.GmailAddOnManifest)
    drive: drive_addon_manifest.DriveAddOnManifest = proto.Field(proto.MESSAGE, number=5, message=drive_addon_manifest.DriveAddOnManifest)
    calendar: calendar_addon_manifest.CalendarAddOnManifest = proto.Field(proto.MESSAGE, number=6, message=calendar_addon_manifest.CalendarAddOnManifest)
    docs: docs_addon_manifest.DocsAddOnManifest = proto.Field(proto.MESSAGE, number=7, message=docs_addon_manifest.DocsAddOnManifest)
    sheets: sheets_addon_manifest.SheetsAddOnManifest = proto.Field(proto.MESSAGE, number=8, message=sheets_addon_manifest.SheetsAddOnManifest)
    slides: slides_addon_manifest.SlidesAddOnManifest = proto.Field(proto.MESSAGE, number=10, message=slides_addon_manifest.SlidesAddOnManifest)
    http_options: script_manifest.HttpOptions = proto.Field(proto.MESSAGE, number=15, message=script_manifest.HttpOptions)
