...
@testing.parameterize({'links': [chainer.links.Linear(3, 2)], 'statistics': {'min': lambda x: backend.get_array_module(x).min(x)}, 'report_params': True, 'report_grads': True, 'prefix': None, 'expect': 4}, {'links': [chainer.links.Linear(3, 2)], 'statistics': {'min': lambda x: backend.get_array_module(x).min(x)}, 'report_params': False, 'report_grads': True, 'prefix': 'test', 'expect': 2}, {'links': [chainer.links.Linear(3, 2)], 'statistics': {'min': lambda x: backend.get_array_module(x).min(x)}, 'report_params': True, 'report_grads': False, 'prefix': None, 'expect': 2}, {'links': [chainer.links.Linear(3, 2)], 'statistics': {'min': lambda x: backend.get_array_module(x).min(x)}, 'report_params': False, 'report_grads': False, 'prefix': 'test', 'expect': 0}, {'links': [chainer.links.Linear(3, 2)], 'statistics': extensions.ParameterStatistics.default_statistics, 'report_params': True, 'report_grads': True, 'prefix': None, 'expect': 36}, {'links': [chainer.links.Linear(3, 2)], 'statistics': extensions.ParameterStatistics.default_statistics, 'report_params': True, 'report_grads': False, 'prefix': 'test', 'expect': 24}, {'links': [chainer.links.Linear(3, 2)], 'statistics': extensions.ParameterStatistics.default_statistics, 'report_params': False, 'report_grads': True, 'prefix': None, 'expect': 12}, {'links': [chainer.links.Linear(3, 2)], 'statistics': extensions.ParameterStatistics.default_statistics, 'report_params': False, 'report_grads': False, 'prefix': 'test', 'expect': 0})
...
@testing.parameterize({'links': [chainer.links.Linear(3, 2)], 'statistics': {'one': lambda x: 1.0}, 'report_params': True, 'report_grads': True, 'prefix': 'test', 'expect': 1.0})
class TestParameterStatisticsCustomFunction(TestParameterStatisticsBase, unittest.TestCase):
