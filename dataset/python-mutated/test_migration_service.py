...
from google.cloud.bigquery_migration_v2.types import migration_entities, migration_error_details, migration_metrics, migration_service, translation_config
...
@pytest.mark.parametrize('client_class,transport_name', [(MigrationServiceClient, 'grpc'), (MigrationServiceAsyncClient, 'grpc_asyncio')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.MigrationServiceGrpcTransport, 'grpc'), (transports.MigrationServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
def test_migration_service_client_get_transport_class():
    ...
    available_transports = [transports.MigrationServiceGrpcTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(MigrationServiceClient, transports.MigrationServiceGrpcTransport, 'grpc'), (MigrationServiceAsyncClient, transports.MigrationServiceGrpcAsyncIOTransport, 'grpc_asyncio')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(MigrationServiceClient, transports.MigrationServiceGrpcTransport, 'grpc', grpc_helpers), (MigrationServiceAsyncClient, transports.MigrationServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_migration_service_client_client_options_from_dict():
    if False:
        print('Hello World!')
    with mock.patch('google.cloud.bigquery_migration_v2.services.migration_service.transports.MigrationServiceGrpcTransport.__init__') as grpc_transport:
...
def test_migration_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel') as create_channel:
        ...
        client = client_class(client_options=options, transport=transport_name)
        create_channel.assert_called_with('bigquerymigration.googleapis.com:443', credentials=file_creds, credentials_file=None, quota_project_id=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=None, default_host='bigquerymigration.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])

@pytest.mark.parametrize('request_type', [migration_service.CreateMigrationWorkflowRequest, dict])
def test_create_migration_workflow(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_migration_workflow), '__call__') as call:
        call.return_value = migration_entities.MigrationWorkflow(name='name_value', display_name='display_name_value', state=migration_entities.MigrationWorkflow.State.DRAFT)
...
async def test_create_migration_workflow_async(transport: str='grpc_asyncio', request_type=migration_service.CreateMigrationWorkflowRequest):
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_migration_workflow), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(migration_entities.MigrationWorkflow(name='name_value', display_name='display_name_value', state=migration_entities.MigrationWorkflow.State.DRAFT))
...
async def test_create_migration_workflow_field_headers_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = migration_service.CreateMigrationWorkflowRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_migration_workflow), '__call__') as call:
...
def test_create_migration_workflow_flattened():
    ...
    with mock.patch.object(type(client.transport.create_migration_workflow), '__call__') as call:
        call.return_value = migration_entities.MigrationWorkflow()
        client.create_migration_workflow(parent='parent_value', migration_workflow=migration_entities.MigrationWorkflow(name='name_value'))
        assert len(call.mock_calls) == 1
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
...
def test_create_migration_workflow_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.create_migration_workflow(migration_service.CreateMigrationWorkflowRequest(), parent='parent_value', migration_workflow=migration_entities.MigrationWorkflow(name='name_value'))
...
async def test_create_migration_workflow_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_migration_workflow), '__call__') as call:
        call.return_value = migration_entities.MigrationWorkflow()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(migration_entities.MigrationWorkflow())
        response = await client.create_migration_workflow(parent='parent_value', migration_workflow=migration_entities.MigrationWorkflow(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_migration_workflow_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_migration_workflow(migration_service.CreateMigrationWorkflowRequest(), parent='parent_value', migration_workflow=migration_entities.MigrationWorkflow(name='name_value'))

@pytest.mark.parametrize('request_type', [migration_service.GetMigrationWorkflowRequest, dict])
...
def test_get_migration_workflow_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_migration_workflow(migration_service.GetMigrationWorkflowRequest(), name='name_value')
...
async def test_get_migration_workflow_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_migration_workflow(migration_service.GetMigrationWorkflowRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [migration_service.ListMigrationWorkflowsRequest, dict])
def test_list_migration_workflows(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_migration_workflows), '__call__') as call:
        call.return_value = migration_service.ListMigrationWorkflowsResponse(next_page_token='next_page_token_value')
...
async def test_list_migration_workflows_async(transport: str='grpc_asyncio', request_type=migration_service.ListMigrationWorkflowsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_migration_workflows), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(migration_service.ListMigrationWorkflowsResponse(next_page_token='next_page_token_value'))
...
def test_list_migration_workflows_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_migration_workflows(migration_service.ListMigrationWorkflowsRequest(), parent='parent_value')
...
@pytest.mark.parametrize('request_type', [migration_service.DeleteMigrationWorkflowRequest, dict])
...
def test_delete_migration_workflow_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.delete_migration_workflow(migration_service.DeleteMigrationWorkflowRequest(), name='name_value')
...
async def test_delete_migration_workflow_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_migration_workflow(migration_service.DeleteMigrationWorkflowRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [migration_service.StartMigrationWorkflowRequest, dict])
...
def test_start_migration_workflow_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.start_migration_workflow(migration_service.StartMigrationWorkflowRequest(), name='name_value')
...
async def test_start_migration_workflow_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.start_migration_workflow(migration_service.StartMigrationWorkflowRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [migration_service.GetMigrationSubtaskRequest, dict])
def test_get_migration_subtask(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_migration_subtask), '__call__') as call:
        call.return_value = migration_entities.MigrationSubtask(name='name_value', task_id='task_id_value', type_='type__value', state=migration_entities.MigrationSubtask.State.ACTIVE, resource_error_count=2169)
...
async def test_get_migration_subtask_async(transport: str='grpc_asyncio', request_type=migration_service.GetMigrationSubtaskRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_migration_subtask), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(migration_entities.MigrationSubtask(name='name_value', task_id='task_id_value', type_='type__value', state=migration_entities.MigrationSubtask.State.ACTIVE, resource_error_count=2169))
...
def test_get_migration_subtask_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.get_migration_subtask(migration_service.GetMigrationSubtaskRequest(), name='name_value')
...
async def test_get_migration_subtask_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_migration_subtask(migration_service.GetMigrationSubtaskRequest(), name='name_value')

@pytest.mark.parametrize('request_type', [migration_service.ListMigrationSubtasksRequest, dict])
def test_list_migration_subtasks(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_migration_subtasks), '__call__') as call:
        call.return_value = migration_service.ListMigrationSubtasksResponse(next_page_token='next_page_token_value')
...
async def test_list_migration_subtasks_async(transport: str='grpc_asyncio', request_type=migration_service.ListMigrationSubtasksRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_migration_subtasks), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(migration_service.ListMigrationSubtasksResponse(next_page_token='next_page_token_value'))
...
def test_list_migration_subtasks_flattened_error():
    ...
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client.list_migration_subtasks(migration_service.ListMigrationSubtasksRequest(), parent='parent_value')
...
async def test_list_migration_subtasks_flattened_error_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_migration_subtasks(migration_service.ListMigrationSubtasksRequest(), parent='parent_value')
...
def test_credentials_transport_error():
    if False:
        print('Hello World!')
    transport = transports.MigrationServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.MigrationServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MigrationServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.MigrationServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.MigrationServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = MigrationServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.MigrationServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    if False:
        i = 10
        return i + 15
    transport = MigrationServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_migration_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery_migration_v2.services.migration_service.transports.MigrationServiceTransport.__init__') as Transport:
        ...
        transport = transports.MigrationServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('create_migration_workflow', 'get_migration_workflow', 'list_migration_workflows', 'delete_migration_workflow', 'start_migration_workflow', 'get_migration_subtask', 'list_migration_subtasks')
...
def test_migration_service_base_transport_with_credentials_file():
    if False:
        return 10
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery_migration_v2.services.migration_service.transports.MigrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MigrationServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
        load_creds.assert_called_once_with('credentials.json', scopes=None, default_scopes=('https://www.googleapis.com/auth/cloud-platform',), quota_project_id='octopus')

def test_migration_service_base_transport_with_adc():
    if False:
        print('Hello World!')
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery_migration_v2.services.migration_service.transports.MigrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.MigrationServiceGrpcTransport, grpc_helpers), (transports.MigrationServiceGrpcAsyncIOTransport, grpc_helpers_async)])
def test_migration_service_transport_create_channel(transport_class, grpc_helpers):
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch.object(grpc_helpers, 'create_channel', autospec=True) as create_channel:
        ...
        adc.return_value = (creds, None)
        transport_class(quota_project_id='octopus', scopes=['1', '2'])
        create_channel.assert_called_with('bigquerymigration.googleapis.com:443', credentials=creds, credentials_file=None, quota_project_id='octopus', default_scopes=('https://www.googleapis.com/auth/cloud-platform',), scopes=['1', '2'], default_host='bigquerymigration.googleapis.com', ssl_credentials=None, options=[('grpc.max_send_message_length', -1), ('grpc.max_receive_message_length', -1)])
...
def test_migration_service_host_no_port(transport_name):
    if False:
        while True:
            i = 10
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='bigquerymigration.googleapis.com'), transport=transport_name)
    assert client.transport._host == 'bigquerymigration.googleapis.com:443'
...
def test_migration_service_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='bigquerymigration.googleapis.com:8000'), transport=transport_name)
...
def test_migration_service_grpc_transport_channel():
    ...
    transport = transports.MigrationServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_migration_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.MigrationServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_parse_migration_subtask_path():
    if False:
        for i in range(10):
            print('nop')
    expected = {'project': 'oyster', 'location': 'nudibranch', 'workflow': 'cuttlefish', 'subtask': 'mussel'}
...
def test_parse_migration_workflow_path():
    if False:
        return 10
    expected = {'project': 'abalone', 'location': 'squid', 'workflow': 'clam'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.MigrationServiceTransport, '_prep_wrapped_messages') as prep:
        client = MigrationServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = MigrationServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(MigrationServiceClient, transports.MigrationServiceGrpcTransport), (MigrationServiceAsyncClient, transports.MigrationServiceGrpcAsyncIOTransport)])
