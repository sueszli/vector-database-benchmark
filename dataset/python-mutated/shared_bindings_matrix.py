...
SUPPORTED_PORTS = ['atmel-samd', 'broadcom', 'cxd56', 'espressif', 'litex', 'mimxrt10xx', 'nrf', 'raspberrypi', 'silabs', 'stm']
ALIASES_BY_BOARD = {'circuitplayground_express': ['circuitplayground_express_4h', 'circuitplayground_express_digikey_pycon2019'], 'pybadge': ['edgebadge'], 'pyportal': ['pyportal_pynt'], 'gemma_m0': ['gemma_m0_pycon2018']}
ALIASES_BRAND_NAMES = {'circuitplayground_express_4h': 'Adafruit Circuit Playground Express 4-H', 'circuitplayground_express_digikey_pycon2019': 'Circuit Playground Express Digi-Key PyCon 2019', 'edgebadge': 'Adafruit EdgeBadge', 'pyportal_pynt': 'Adafruit PyPortal Pynt', 'gemma_m0_pycon2018': 'Adafruit Gemma M0 PyCon 2018'}
ADDITIONAL_MODULES = {'_asyncio': 'MICROPY_PY_ASYNCIO', 'adafruit_bus_device': 'CIRCUITPY_BUSDEVICE', 'adafruit_pixelbuf': 'CIRCUITPY_PIXELBUF', 'array': 'CIRCUITPY_ARRAY', 'builtins': 'CIRCUITPY', 'builtins.pow3': 'CIRCUITPY_BUILTINS_POW3', 'busio.SPI': 'CIRCUITPY_BUSIO_SPI', 'busio.UART': 'CIRCUITPY_BUSIO_UART', 'collections': 'CIRCUITPY_COLLECTIONS', 'fontio': 'CIRCUITPY_DISPLAYIO', 'io': 'CIRCUITPY_IO', 'keypad.KeyMatrix': 'CIRCUITPY_KEYPAD_KEYMATRIX', 'keypad.Keys': 'CIRCUITPY_KEYPAD_KEYS', 'keypad.ShiftRegisterKeys': 'CIRCUITPY_KEYPAD_SHIFTREGISTERKEYS', 'os.getenv': 'CIRCUITPY_OS_GETENV', 'select': 'MICROPY_PY_SELECT_SELECT', 'sys': 'CIRCUITPY_SYS', 'terminalio': 'CIRCUITPY_DISPLAYIO', 'usb': 'CIRCUITPY_USB_HOST'}
