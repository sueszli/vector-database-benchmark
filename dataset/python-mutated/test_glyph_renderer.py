...
from bokeh.models import ColorBar, ColumnDataSource, GeoJSONDataSource, Image, ImageRGBA, ImageStack, IndexFilter, Line, MultiLine, Patch, Scatter, Text, WebDataSource, WeightedStackColorMapper
