import graphene
from django.db.models import BooleanField, Count, DateTimeField, ExpressionWrapper, F, IntegerField, Min, OuterRef, Q, QuerySet, Subquery
from django.db.models.expressions import Window
from django.db.models.functions import Coalesce, DenseRank
from ...product.models import Category, CollectionChannelListing, Product, ProductChannelListing
...
class ProductOrder(ChannelSortInputObjectType):
    attribute_id = graphene.Argument(graphene.ID, description="Sort product by the selected attribute's values.\nNote: this doesn't take translations into account yet.")
    field = graphene.Argument(ProductOrderField, description='Sort products by the selected field.')
