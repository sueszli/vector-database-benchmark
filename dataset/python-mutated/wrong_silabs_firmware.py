...
from homeassistant.components.homeassistant_sky_connect import hardware as skyconnect_hardware
from homeassistant.components.homeassistant_yellow import RADIO_DEVICE as YELLOW_RADIO_DEVICE, hardware as yellow_hardware
...
class HardwareType(enum.StrEnum):
    ...
    YELLOW = 'yellow'
    OTHER = 'other'
DISABLE_MULTIPAN_URL = {HardwareType.YELLOW: 'https://yellow.home-assistant.io/guides/disable-multiprotocol/#flash-the-silicon-labs-radio-firmware', HardwareType.SKYCONNECT: 'https://skyconnect.home-assistant.io/procedures/disable-multiprotocol/#step-flash-the-silicon-labs-radio-firmware', HardwareType.OTHER: None}
