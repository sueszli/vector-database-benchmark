...
if is_torch_available():
    import torch
    from transformers import MPT_PRETRAINED_MODEL_ARCHIVE_LIST, AutoTokenizer, MptForCausalLM, MptForQuestionAnswering, MptForSequenceClassification, MptForTokenClassification, MptModel
...
class MptModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (MptModel, MptForCausalLM, MptForSequenceClassification, MptForTokenClassification, MptForQuestionAnswering) if is_torch_available() else ()
    ...
    pipeline_model_mapping = {'feature-extraction': MptModel, 'question-answering': MptForQuestionAnswering, 'text-classification': MptForSequenceClassification, 'text-generation': MptForCausalLM, 'token-classification': MptForTokenClassification, 'zero-shot': MptForSequenceClassification} if is_torch_available() else {}
