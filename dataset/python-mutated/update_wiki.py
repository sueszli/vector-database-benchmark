...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--wiki-dir', required=True, type=Path, help='Directory of the wiki repo')
    arg_parser.add_argument('--hist-line-dir', required=True, type=Path, help='Directory with history lines')
    arg_parser.add_argument('--manifest-dir', required=True, type=Path, help='Directory with manifest files')
