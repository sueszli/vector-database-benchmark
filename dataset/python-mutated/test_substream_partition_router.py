...
@pytest.mark.parametrize('test_name, parent_stream_request_parameters, expected_req_params, expected_headers, expected_body_json, expected_body_data', [('test_request_option_in_request_param', [RequestOption(inject_into=RequestOptionType.request_parameter, parameters={}, field_name='first_stream'), RequestOption(inject_into=RequestOptionType.request_parameter, parameters={}, field_name='second_stream')], {'first_stream': '1234', 'second_stream': '4567'}, {}, {}, {}), ('test_request_option_in_header', [RequestOption(inject_into=RequestOptionType.header, parameters={}, field_name='first_stream'), RequestOption(inject_into=RequestOptionType.header, parameters={}, field_name='second_stream')], {}, {'first_stream': '1234', 'second_stream': '4567'}, {}, {}), ('test_request_option_in_param_and_header', [RequestOption(inject_into=RequestOptionType.request_parameter, parameters={}, field_name='first_stream'), RequestOption(inject_into=RequestOptionType.header, parameters={}, field_name='second_stream')], {'first_stream': '1234'}, {'second_stream': '4567'}, {}, {}), ('test_request_option_in_body_json', [RequestOption(inject_into=RequestOptionType.body_json, parameters={}, field_name='first_stream'), RequestOption(inject_into=RequestOptionType.body_json, parameters={}, field_name='second_stream')], {}, {}, {'first_stream': '1234', 'second_stream': '4567'}, {}), ('test_request_option_in_body_data', [RequestOption(inject_into=RequestOptionType.body_data, parameters={}, field_name='first_stream'), RequestOption(inject_into=RequestOptionType.body_data, parameters={}, field_name='second_stream')], {}, {}, {}, {'first_stream': '1234', 'second_stream': '4567'})])
def test_request_option(test_name, parent_stream_request_parameters, expected_req_params, expected_headers, expected_body_json, expected_body_data):
    if False:
        print('Hello World!')
    partition_router = SubstreamPartitionRouter(parent_stream_configs=[ParentStreamConfig(stream=MockStream(parent_slices, data_first_parent_slice + data_second_parent_slice, 'first_stream'), parent_key='id', partition_field='first_stream_id', parameters={}, config={}, request_option=parent_stream_request_parameters[0]), ParentStreamConfig(stream=MockStream(second_parent_stream_slice, more_records, 'second_stream'), parent_key='id', partition_field='second_stream_id', parameters={}, config={}, request_option=parent_stream_request_parameters[1])], parameters={}, config={})
...
def test_given_record_is_airbyte_message_when_stream_slices_then_use_record_data():
    if False:
        return 10
    parent_slice = {}
    partition_router = SubstreamPartitionRouter(parent_stream_configs=[ParentStreamConfig(stream=MockStream([parent_slice], [AirbyteMessage(type=Type.RECORD, record=AirbyteRecordMessage(data={'id': 'record value'}, emitted_at=0, stream='stream'))], 'first_stream'), parent_key='id', partition_field='partition_field', parameters={}, config={})], parameters={}, config={})
...
def test_given_record_is_record_object_when_stream_slices_then_use_record_data():
    if False:
        return 10
    parent_slice = {}
    partition_router = SubstreamPartitionRouter(parent_stream_configs=[ParentStreamConfig(stream=MockStream([parent_slice], [Record({'id': 'record value'}, {})], 'first_stream'), parent_key='id', partition_field='partition_field', parameters={}, config={})], parameters={}, config={})
    slices = list(partition_router.stream_slices())
    assert slices == [{'partition_field': 'record value', 'parent_slice': parent_slice}]