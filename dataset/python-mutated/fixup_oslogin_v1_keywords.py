...
class osloginCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_ssh_public_key': ('parent', 'ssh_public_key'), 'delete_posix_account': ('name',), 'delete_ssh_public_key': ('name',), 'get_login_profile': ('name', 'project_id', 'system_id'), 'get_ssh_public_key': ('name',), 'import_ssh_public_key': ('parent', 'ssh_public_key', 'project_id'), 'update_ssh_public_key': ('name', 'ssh_public_key', 'update_mask')}
