from sqlalchemy import BINARY, Column, ForeignKey, Integer, String, Text, text, Index, DateTime, LargeBinary, SmallInteger, desc
...
class TwStan(Base):
    ...
    __table_args__ = (Index(u'IX_tw_Stany', u'st_TowId', u'st_MagId', unique=True), Index(u'IX_tw_Stany_1', u'st_TowId', u'st_MagId', u'st_Stan', u'st_StanRez'))
...
class TwNarzutTw(Base):
    ...
    __table_args__ = (Index(u'IX_tw_NarzutTw', u'ct_IdCena', u'ct_IdNarzut', u'ct_Kolejnosc', unique=True),)
...
class DokDokument(Base):
    ...
    __table_args__ = (Index(u'IX_dok__Dokument_5', u'dok_Id', u'dok_NrPelny', u'dok_DoDokNrPelny', u'dok_OdbiorcaAdreshId'), Index(u'IX_dok__Dokument_2', u'dok_Typ', u'dok_MagId', u'dok_Nr', u'dok_NrRoz', u'dok_DataWyst'), Index(u'IX_dok__Dokument', u'dok_DoDokId', u'dok_Typ', u'dok_Podtyp'), Index(u'IX_dok__Dokument_4', u'dok_Typ', u'dok_Podtyp', u'dok_NrPelnyOryg', u'dok_PlatnikId'))
...
class DokPozycja(Base):
    ...
    __table_args__ = (Index(u'IX_dok_Pozycja_4', u'ob_Id', u'ob_DokHanId', u'ob_DokMagId', u'ob_Ilosc', u'ob_CenaNetto', u'ob_CenaBrutto', u'ob_WartNetto', u'ob_WartBrutto'),)
