...
class LyndaIE(LyndaBaseIE):
    ...
    _TIMECODE_REGEX = '\\[(?P<timecode>\\d+:\\d+:\\d+[\\.,]\\d+)\\]'
    _TESTS = [{'url': 'https://www.lynda.com/Bootstrap-tutorials/Using-exercise-files/110885/114408-4.html', 'info_dict': {'id': '114408', 'ext': 'mp4', 'title': 'Using the exercise files', 'duration': 68}}, {'url': 'https://www.lynda.com/player/embed/133770?tr=foo=1;bar=g;fizz=rt&fs=0', 'only_matching': True}, {'url': 'https://educourse.ga/Bootstrap-tutorials/Using-exercise-files/110885/114408-4.html', 'only_matching': True}, {'url': 'https://www.lynda.com/de/Graphic-Design-tutorials/Willkommen-Grundlagen-guten-Gestaltung/393570/393572-4.html', 'only_matching': True}, {'url': 'https://www.lynda.com/ASP-NET-tutorials/What-you-should-know/5034180/2811512-4.html', 'only_matching': True}]
...
class LyndaCourseIE(LyndaBaseIE):
    ...
    _TESTS = [{'url': 'https://www.lynda.com/Graphic-Design-tutorials/Grundlagen-guten-Gestaltung/393570-2.html', 'only_matching': True}, {'url': 'https://www.lynda.com/de/Graphic-Design-tutorials/Grundlagen-guten-Gestaltung/393570-2.html', 'only_matching': True}]
