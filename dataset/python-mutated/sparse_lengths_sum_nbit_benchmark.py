...
if __name__ == '__main__':
    ...
    parser.add_argument('--average_len', type=int, default=27, help='Sparse feature average lengths, default is 27')
    ...
    benchmark_sparse_lengths_sum(args.embedding_size, args.embedding_dim, args.average_len, args.batch_size, args.iteration, args.flush_cache, args.bit_rate)