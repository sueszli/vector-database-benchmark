...
def main():
    ...
    client.virtual_machine_scale_set_vms.begin_deallocate(resource_group_name='rgcompute', vm_scale_set_name='aaaaaaaaaaaaaaaaaaaaaaaa', instance_id='aaaaaa').result()
