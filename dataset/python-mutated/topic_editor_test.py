...
class TopicEditorTests(BaseTopicEditorControllerTests, test_utils.EmailTestBase):
...
class TopicPublishSendMailHandlerTests(BaseTopicEditorControllerTests, test_utils.EmailTestBase):
