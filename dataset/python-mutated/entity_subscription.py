...
from typing import TYPE_CHECKING, Any, Dict, List, Mapping, MutableMapping, Optional, Sequence, Tuple, Type, TypedDict, Union
...
from sentry.sentry_metrics.utils import MetricIndexNotFound, resolve, resolve_tag_key, resolve_tag_value, resolve_tag_values, reverse_resolve_tag_value
...
QUERY_TYPE_CONDITIONS: Mapping[SnubaQuery.Type, str] = {SnubaQuery.Type.ERROR: 'event.type:error', SnubaQuery.Type.PERFORMANCE: 'event.type:transaction'}
ENTITY_TIME_COLUMNS: Mapping[EntityKey, str] = {EntityKey.Events: 'timestamp', EntityKey.Sessions: 'started', EntityKey.Transactions: 'finish_ts', EntityKey.GenericMetricsCounters: 'timestamp', EntityKey.GenericMetricsDistributions: 'timestamp', EntityKey.GenericMetricsSets: 'timestamp', EntityKey.MetricsCounters: 'timestamp', EntityKey.MetricsSets: 'timestamp'}
CRASH_RATE_ALERT_AGGREGATE_RE = '^percentage\\([ ]*(sessions_crashed|users_crashed)[ ]*\\,[ ]*(sessions|users)[ ]*\\)'
ALERT_BLOCKED_FIELDS = {'start', 'end', 'last_seen()', 'time', 'timestamp', 'timestamp.to_hour', 'timestamp.to_day'}
...
EntitySubscription = Union[EventsEntitySubscription, MetricsCountersEntitySubscription, MetricsSetsEntitySubscription, PerformanceTransactionsEntitySubscription, PerformanceMetricsEntitySubscription, SessionsEntitySubscription]
