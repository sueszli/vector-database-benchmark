...
import pytest
from sklearn.utils._param_validation import Interval, InvalidParameterError, generate_invalid_param_val, generate_valid_param, make_constraint
...
PARAM_VALIDATION_CLASS_WRAPPER_LIST = [('sklearn.cluster.affinity_propagation', 'sklearn.cluster.AffinityPropagation'), ('sklearn.cluster.dbscan', 'sklearn.cluster.DBSCAN'), ('sklearn.cluster.k_means', 'sklearn.cluster.KMeans'), ('sklearn.cluster.mean_shift', 'sklearn.cluster.MeanShift'), ('sklearn.cluster.spectral_clustering', 'sklearn.cluster.SpectralClustering'), ('sklearn.covariance.graphical_lasso', 'sklearn.covariance.GraphicalLasso'), ('sklearn.covariance.ledoit_wolf', 'sklearn.covariance.LedoitWolf'), ('sklearn.covariance.oas', 'sklearn.covariance.OAS'), ('sklearn.decomposition.dict_learning', 'sklearn.decomposition.DictionaryLearning'), ('sklearn.decomposition.fastica', 'sklearn.decomposition.FastICA'), ('sklearn.decomposition.non_negative_factorization', 'sklearn.decomposition.NMF'), ('sklearn.preprocessing.maxabs_scale', 'sklearn.preprocessing.MaxAbsScaler'), ('sklearn.preprocessing.minmax_scale', 'sklearn.preprocessing.MinMaxScaler'), ('sklearn.preprocessing.power_transform', 'sklearn.preprocessing.PowerTransformer'), ('sklearn.preprocessing.quantile_transform', 'sklearn.preprocessing.QuantileTransformer'), ('sklearn.preprocessing.robust_scale', 'sklearn.preprocessing.RobustScaler')]
