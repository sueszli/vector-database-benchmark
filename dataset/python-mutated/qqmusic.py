...
from ..utils import clean_html, ExtractorError, strip_jsonp, unescapeHTML

class QQMusicIE(InfoExtractor):
    IE_NAME = 'qqmusic'
    IE_DESC = 'QQ音乐'
    _VALID_URL = 'https?://y\\.qq\\.com/n/yqq/song/(?P<id>[0-9A-Za-z]+)\\.html'
    _TESTS = [{'url': 'https://y.qq.com/n/yqq/song/004295Et37taLD.html', 'md5': '5f1e6cea39e182857da7ffc5ef5e6bb8', 'info_dict': {'id': '004295Et37taLD', 'ext': 'mp3', 'title': '可惜没如果', 'release_date': '20141227', 'creator': '林俊杰', 'description': 'md5:d85afb3051952ecc50a1ee8a286d1eac', 'thumbnail': 're:^https?://.*\\.jpg$'}}, {'note': 'There is no mp3-320 version of this song.', 'url': 'https://y.qq.com/n/yqq/song/004MsGEo3DdNxV.html', 'md5': 'fa3926f0c585cda0af8fa4f796482e3e', 'info_dict': {'id': '004MsGEo3DdNxV', 'ext': 'mp3', 'title': '如果', 'release_date': '20050626', 'creator': '李季美', 'description': 'md5:46857d5ed62bc4ba84607a805dccf437', 'thumbnail': 're:^https?://.*\\.jpg$'}}, {'note': 'lyrics not in .lrc format', 'url': 'https://y.qq.com/n/yqq/song/001JyApY11tIp6.html', 'info_dict': {'id': '001JyApY11tIp6', 'ext': 'mp3', 'title': 'Shadows Over Transylvania', 'release_date': '19970225', 'creator': 'Dark Funeral', 'description': 'md5:c9b20210587cbcd6836a1c597bab4525', 'thumbnail': 're:^https?://.*\\.jpg$'}, 'params': {'skip_download': True}}]
    _FORMATS = {'mp3-320': {'prefix': 'M800', 'ext': 'mp3', 'preference': 40, 'abr': 320}, 'mp3-128': {'prefix': 'M500', 'ext': 'mp3', 'preference': 30, 'abr': 128}, 'm4a': {'prefix': 'C200', 'ext': 'm4a', 'preference': 10}}
...
class QQMusicSingerIE(QQPlaylistBaseIE):
    ...
    _TEST = {'url': 'https://y.qq.com/n/yqq/singer/001BLpXF2DyJe2.html', 'info_dict': {'id': '001BLpXF2DyJe2', 'title': '林俊杰', 'description': 'md5:870ec08f7d8547c29c93010899103751'}, 'playlist_mincount': 12}
...
class QQMusicAlbumIE(QQPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'https://y.qq.com/n/yqq/album/000gXCTb2AhRR1.html', 'info_dict': {'id': '000gXCTb2AhRR1', 'title': '我们都是这样长大的', 'description': 'md5:179c5dce203a5931970d306aa9607ea6'}, 'playlist_count': 4}, {'url': 'https://y.qq.com/n/yqq/album/002Y5a3b3AlCu3.html', 'info_dict': {'id': '002Y5a3b3AlCu3', 'title': '그리고...', 'description': 'md5:a48823755615508a95080e81b51ba729'}, 'playlist_count': 8}]
...
class QQMusicToplistIE(QQPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'https://y.qq.com/n/yqq/toplist/123.html', 'info_dict': {'id': '123', 'title': '美国iTunes榜', 'description': 'md5:89db2335fdbb10678dee2d43fe9aba08'}, 'playlist_count': 100}, {'url': 'https://y.qq.com/n/yqq/toplist/3.html', 'info_dict': {'id': '3', 'title': '巅峰榜·欧美', 'description': 'md5:5a600d42c01696b26b71f8c4d43407da'}, 'playlist_count': 100}, {'url': 'https://y.qq.com/n/yqq/toplist/106.html', 'info_dict': {'id': '106', 'title': '韩国Mnet榜', 'description': 'md5:cb84b325215e1d21708c615cac82a6e7'}, 'playlist_count': 50}]
...
class QQMusicPlaylistIE(QQPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://y.qq.com/n/yqq/playlist/3462654915.html', 'info_dict': {'id': '3462654915', 'title': '韩国5月新歌精选下旬', 'description': 'md5:d2c9d758a96b9888cf4fe82f603121d4'}, 'playlist_count': 40, 'skip': 'playlist gone'}, {'url': 'https://y.qq.com/n/yqq/playlist/1374105607.html', 'info_dict': {'id': '1374105607', 'title': '易入人心的华语民谣', 'description': '民谣的歌曲易于传唱、、歌词朗朗伤口、旋律简单温馨。属于那种才入耳孔。却上心头的感觉。没有太多的复杂情绪。简单而直接地表达乐者的情绪，就是这样的简单才易入人心。'}, 'playlist_count': 20}]
