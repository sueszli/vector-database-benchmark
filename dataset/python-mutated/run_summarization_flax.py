...
import transformers
from transformers import CONFIG_MAPPING, FLAX_MODEL_FOR_SEQ_TO_SEQ_CAUSAL_LM_MAPPING, AutoConfig, AutoTokenizer, FlaxAutoModelForSeq2SeqLM, HfArgumentParser, is_tensorboard_available
...
class DataTrainingArguments:
    ...
    num_beams: Optional[int] = field(default=1, metadata={'help': 'Number of beams to use for evaluation. This argument will be passed to `model.generate`, which is used during evaluation.'})
