...
class LEBitEnumField(LEBitField, _EnumField):
    ...
    def __init__(self, name, default, size, enum):
        ...
        self.rev = size < 0
        self.size = abs(size)
ETHERCAT_TYPE_12_CIRCULATING_FRAME = {0: 'FRAME-NOT-CIRCULATING', 1: 'FRAME-CIRCULATED-ONCE'}
ETHERCAT_TYPE_12_NEXT_FRAME = {0: 'LAST-TYPE12-PDU', 1: 'TYPE12-PDU-FOLLOWS'}
...
class EtherCatType12DLPDU(Packet):
    ...
    PHYSICAL_ADDRESSING_DESC = [ByteField('idx', 0), LEShortField('adp', 0), LEShortField('ado', 0), LEBitFieldLenField('len', None, 11, count_of='data'), LEBitField('_reserved', 0, 3), LEBitEnumField('c', 0, 1, ETHERCAT_TYPE_12_CIRCULATING_FRAME), LEBitEnumField('next', None, 1, ETHERCAT_TYPE_12_NEXT_FRAME), LEShortField('irq', 0), FieldListField('data', [], ByteField('', 0), count_from=lambda pkt: pkt.len), LEShortField('wkc', 0)]
...
class EtherCatAPRD(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 1)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPRD(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 4)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatBRD(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 7)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLRD(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 10)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatAPWR(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 2)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPWR(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 5)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC

class EtherCatBWR(EtherCatType12DLPDU):
    """
    BWR - Broadcast read (IEC 61158-5-12, sec. 5.4.2.4 tab. 20 / p. 39)
    """
    fields_desc = [ByteField('_cmd', 8)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLWR(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 11)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatAPRW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 3)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPRW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 6)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatBRW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 9)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLRW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 12)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatARMW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 13)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFRMW(EtherCatType12DLPDU):
    ...
    """
    fields_desc = [ByteField('_cmd', 14)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCat(Packet):
    ...
    fields_desc = [LEBitField('length', 0, 11), LEBitField('_reserved', 0, 1), LEBitField('type', 0, 4)]
    ETHERCAT_TYPE12_DLPDU_TYPES = {1: EtherCatAPRD, 4: EtherCatFPRD, 7: EtherCatBRD, 10: EtherCatLRD, 2: EtherCatAPWR, 5: EtherCatFPWR, 8: EtherCatBWR, 11: EtherCatLWR, 3: EtherCatAPRW, 6: EtherCatFPRW, 9: EtherCatBRW, 12: EtherCatLRW, 13: EtherCatARMW, 14: EtherCatFRMW}
    ...
    def guess_payload_class(self, payload):
        ...
        try:
            ...
            log_runtime.error('{}.guess_payload_class() - unknown or invalid DLPDU type'.format(self.__class__.__name__))
            return Packet.guess_payload_class(self, payload)
bind_layers(Ether, EtherCat, type=34980)
bind_layers(Dot1Q, EtherCat, type=34980)
bind_layers(EtherCat, EtherCatAPRD, type=1)
bind_layers(EtherCat, EtherCatFPRD, type=1)
bind_layers(EtherCat, EtherCatBRD, type=1)
bind_layers(EtherCat, EtherCatLRD, type=1)
bind_layers(EtherCat, EtherCatAPWR, type=1)
bind_layers(EtherCat, EtherCatFPWR, type=1)
bind_layers(EtherCat, EtherCatBWR, type=1)
bind_layers(EtherCat, EtherCatLWR, type=1)
bind_layers(EtherCat, EtherCatAPRW, type=1)
bind_layers(EtherCat, EtherCatFPRW, type=1)
bind_layers(EtherCat, EtherCatBRW, type=1)
bind_layers(EtherCat, EtherCatLRW, type=1)
bind_layers(EtherCat, EtherCatARMW, type=1)
bind_layers(EtherCat, EtherCatFRMW, type=1)