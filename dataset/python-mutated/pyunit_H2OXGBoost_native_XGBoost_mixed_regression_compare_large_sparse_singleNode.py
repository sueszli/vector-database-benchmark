...
def comparison_test_dense():
    ...
    if len(ret.nodes) == 1:
        ...
        pyunit_utils.summarizeResult_regression(h2oPredictD, nativePred, h2oTrainTimeD, nativeTrainTime, h2oPredictTimeD, nativeScoreTime, tolerance=testTol)
    else:
