...
_decorator_black_list = ['with_unsupported_dtypes', 'with_supported_dtypes', 'with_unsupported_devices', 'with_supported_devices', 'with_unsupported_device_and_dtypes', 'with_supported_device_and_dtypes']
type_mapping = {}
