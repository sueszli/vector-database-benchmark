...
class MirrativIE(MirrativBaseIE):
    ...
    TESTS = [{'url': 'https://mirrativ.com/live/UQomuS7EMgHoxRHjEhNiHw', 'info_dict': {'id': 'UQomuS7EMgHoxRHjEhNiHw', 'title': 'ねむいぃ、。『参加型』🔰jcが初めてやるCOD✨初見さん大歓迎💗', 'is_live': True, 'description': 'md5:bfcd8f77f2fab24c3c672e5620f3f16e', 'thumbnail': 're:https?://.+', 'uploader': '# あ ち ゅ 。💡', 'uploader_id': '118572165', 'duration': None, 'view_count': 1241, 'release_timestamp': 1646229192, 'timestamp': 1646229167, 'was_live': False}, 'skip': 'livestream'}, {'url': 'https://mirrativ.com/live/POxyuG1KmW2982lqlDTuPw', 'only_matching': True}]
...
class MirrativUserIE(MirrativBaseIE):
    ...
    _TESTS = [{'url': 'https://www.mirrativ.com/user/110943130', 'note': 'multiple archives available', 'only_matching': True}]
