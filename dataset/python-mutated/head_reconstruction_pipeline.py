...
from modelscope.models.cv.face_reconstruction.models.facelandmark.large_base_lmks_infer import LargeBaseLmkInfer
from modelscope.models.cv.face_reconstruction.utils import POS, align_for_lm, draw_line, enlarged_bbox, extract_5p, image_warp_grid1, load_lm3d, mesh_to_string, read_obj, resize_n_crop_img, resize_on_long_side, spread_flow, write_obj
from modelscope.models.cv.head_reconstruction.models.head_segmentation import HeadSegmentor
from modelscope.models.cv.head_reconstruction.models.tex_processor import TexProcesser
from modelscope.models.cv.skin_retouching.retinaface.predict_single import Model
...
@PIPELINES.register_module(Tasks.head_reconstruction, module_name=Pipelines.head_reconstruction)
