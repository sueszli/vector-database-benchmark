...
from sqlalchemy.sql.sqltypes import DATETIME, BigInteger, Boolean, Date, DateTime, Enum, Integer, LargeBinary, SmallInteger, String, Text, Time
import warehouse.db
from warehouse.cli.db import db
from warehouse.utils.db.types import TZDateTime
SQLALCHEMY_TO_DBML = {Boolean: 'boolean', Date: 'date', DateTime: 'datetime', Integer: 'int', String: 'varchar', SmallInteger: 'int', LargeBinary: 'binary', Enum: 'enum', Time: 'time', Text: 'text', ForeignKey: 'foreign_key', BigInteger: 'bigint', DATETIME: 'datetime', UUID: 'varchar', INET: 'varchar', JSONB: 'text', CITEXT: 'text', TZDateTime: 'datetime', ARRAY: '"string[]"', TIMESTAMP: 'datetime'}
