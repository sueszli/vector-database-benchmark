...
class my_top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        parser.add_argument('-N', '--nsamples', type=eng_float, help='number of samples to collect [default=+inf]')
        parser.add_argument('file_name', metavar='FILE-NAME', help='Output file path')
