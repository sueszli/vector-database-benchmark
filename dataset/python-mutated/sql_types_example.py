...
from pyspark.sql.types import DataType, NullType, AtomicType, IntegralType, NumericType, FractionalType, StringType, BinaryType, BooleanType, DateType, TimestampType, DecimalType, DoubleType, FloatType, ByteType, IntegerType, LongType, ShortType, ArrayType, MapType, StructField, StructType
...
if __name__ == '__main__':
    spark = SparkSession.builder.appName('Python Spark SQL Types example').config('spark.some.config.option', 'some-value').getOrCreate()
