...
from paddle.distributed.auto_parallel.static.dist_attribute import OperatorDistAttr
from paddle.distributed.auto_parallel.static.process_group import get_world_process_group
from paddle.distributed.auto_parallel.static.utils import naive_set_dist_op_attr_for_program_by_mesh_and_mapping, set_var_dist_attr
from paddle.distributed.fleet.meta_optimizers.common import OP_ROLE_KEY, OpRole
from paddle.framework import core
from paddle.static.amp.bf16.amp_utils import AutoMixedPrecisionListsBF16, _is_in_fp32_varnames
from paddle.static.amp.fp16_utils import AutoMixedPrecisionLists, _is_in_black_varnames, _keep_fp32_input, _keep_fp32_output, _rename_arg, _valid_types, find_op_index, find_true_post_op, find_true_prev_op
from paddle.utils import unique_name
from ..auto_parallel.process_mesh import ProcessMesh
from ..auto_parallel.static.utils import is_backward_op, is_forward_op, is_loss_grad_op, is_loss_op, is_optimize_op
from .pass_base import PassBase, register_pass
world_process_group = get_world_process_group()
__amp_skip_ops__ = ['create_py_reader', 'create_double_buffer_reader', 'cast', 'while']
