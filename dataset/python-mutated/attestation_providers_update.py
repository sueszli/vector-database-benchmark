...
def main():
    ...
    response = client.attestation_providers.update(resource_group_name='MyResourceGroup', provider_name='myattestationprovider', update_params={'tags': {'Property1': 'Value1', 'Property2': 'Value2', 'Property3': 'Value3'}})
    print(response)
