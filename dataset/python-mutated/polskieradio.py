...
from ..utils import ExtractorError, InAdvancePagedList, determine_ext, extract_attributes, int_or_none, js_to_json, parse_iso8601, strip_or_none, traverse_obj, unescapeHTML, unified_timestamp, url_or_none, urljoin
...
class PolskieRadioLegacyIE(PolskieRadioBaseExtractor):
    ...
    _TESTS = [{'url': 'https://www.polskieradio.pl/8/2382/Artykul/2534482,Zagarysci-Poezja-jak-spoiwo', 'info_dict': {'id': '2534482', 'title': 'Żagaryści. Poezja jak spoiwo', 'description': 'md5:f18d95d5dcba747a09b635e21a4c0695'}, 'playlist': [{'md5': 'd07559829f61d5a93a75755987ded760', 'info_dict': {'id': '2516679', 'ext': 'mp3', 'title': 'md5:c6e1234e0b747ad883cb91b7ad06b98c', 'timestamp': 1592654400, 'upload_date': '20200620', 'duration': 1430, 'thumbnail': 're:^https?://static\\.prsa\\.pl/images/.*\\.jpg$'}}]}, {'url': 'https://www.polskieradio.pl/10/6071/Artykul/2610977,Poglos-29-pazdziernika-godz-2301', 'info_dict': {'id': '2610977', 'ext': 'mp3', 'title': 'Pogłos 29 października godz. 23:01'}}, {'url': 'https://polskieradio24.pl/130/4503/Artykul/2621876,Narusza-nasza-suwerennosc-Publicysci-o-uzaleznieniu-funduszy-UE-od-praworzadnosci', 'only_matching': True}]
...
class PolskieRadioIE(PolskieRadioBaseExtractor):
    ...
    _TESTS = [{'url': 'https://jedynka.polskieradio.pl/artykul/1587943', 'info_dict': {'id': '1587943', 'title': 'Prof. Andrzej Nowak: o historii nie da się myśleć beznamiętnie', 'description': 'md5:12f954edbf3120c5e7075e17bf9fc5c5'}, 'playlist': [{'md5': '2984ee6ce9046d91fc233bc1a864a09a', 'info_dict': {'id': '7a85d429-5356-4def-a347-925e4ae7406b', 'ext': 'mp3', 'title': 'md5:d4623290d4ac983bf924061c75c23a0d'}}]}, {'url': 'https://trojka.polskieradio.pl/artykul/2589163,Czy-wciaz-otrzymujemy-zdjecia-z-sond-Voyager', 'info_dict': {'id': '2589163', 'title': 'Czy wciąż otrzymujemy zdjęcia z sond Voyager?', 'description': 'md5:cf1a7f348d63a2db9c0d7a63d1669473'}, 'playlist': [{'info_dict': {'id': '2577880', 'ext': 'mp3', 'title': 'md5:a57d10a0c02abd34dd675cb33707ad5a', 'duration': 321}}]}, {'url': 'https://radiokierowcow.pl/artykul/2694529', 'info_dict': {'id': '2694529', 'title': 'Zielona fala reliktem przeszłości?', 'description': 'md5:f20a9a7ed9cb58916c54add94eae3bc0'}, 'playlist_count': 3}, {'url': 'https://trojka.polskieradio.pl/artykul/1632955', 'only_matching': True}, {'url': 'https://trojka.polskieradio.pl/artykul/1634903', 'only_matching': True}, {'url': 'https://jedynka.polskieradio.pl/artykul/3042436,Polityka-wschodnia-ojca-i-syna-Wladyslawa-Lokietka-i-Kazimierza-Wielkiego', 'only_matching': True}]
...
class PolskieRadioAuditionIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://jedynka.polskieradio.pl/audycje/5102', 'info_dict': {'id': '5102', 'title': 'Historia żywa', 'thumbnail': 're:https://static\\.prsa\\.pl/images/.+'}, 'playlist_mincount': 38}, {'url': 'https://jedynka.polskieradio.pl/audycje/5769', 'info_dict': {'id': '5769', 'title': 'AgroFakty', 'thumbnail': 're:https://static\\.prsa\\.pl/images/.+'}, 'playlist_mincount': 269}, {'url': 'https://trojka.polskieradio.pl/audycja/8906', 'info_dict': {'id': '8906', 'title': 'Trójka budzi', 'thumbnail': 're:https://static\\.prsa\\.pl/images/.+'}, 'playlist_mincount': 722}, {'url': 'https://trojka.polskieradio.pl/audycja/305', 'info_dict': {'id': '305', 'title': 'Co w mowie piszczy?', 'thumbnail': 're:https://static\\.prsa\\.pl/images/.+'}, 'playlist_count': 1523}]
...
class PolskieRadioCategoryIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.polskieradio.pl/37,RedakcjaKatolicka/4143,Kierunek-Krakow', 'info_dict': {'id': '4143', 'title': 'Kierunek Kraków'}, 'playlist_mincount': 61}, {'url': 'http://www.polskieradio.pl/10,czworka/214,muzyka', 'info_dict': {'id': '214', 'title': 'Muzyka'}, 'playlist_mincount': 61}, {'url': 'https://www.polskieradio.pl/8/2385', 'info_dict': {'id': '2385', 'title': 'Droga przez mąkę'}, 'playlist_mincount': 111}, {'url': 'https://www.polskieradio.pl/10/4930', 'info_dict': {'id': '4930', 'title': 'Teraz K-pop!'}, 'playlist_mincount': 392}, {'url': 'https://www.polskieradio.pl/8,dwojka/7376,nowa-mowa', 'info_dict': {'id': '7376', 'title': 'Nowa mowa'}, 'playlist_mincount': 244}, {'url': 'https://www.polskieradio.pl/Krzysztof-Dziuba/Tag175458', 'info_dict': {'id': '175458', 'title': 'Krzysztof Dziuba'}, 'playlist_mincount': 420}, {'url': 'http://www.polskieradio.pl/8,Dwojka/196,Publicystyka', 'only_matching': True}]
...
class PolskieRadioPlayerIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://player.polskieradio.pl/anteny/trojka', 'info_dict': {'id': '3', 'ext': 'm4a', 'title': 'Trójka'}, 'params': {'format': 'bestaudio', 'skip_download': 'endless stream'}}]
...
class PolskieRadioPodcastListIE(PolskieRadioPodcastBaseExtractor):
    ...
    _TESTS = [{'url': 'https://podcasty.polskieradio.pl/podcast/8/', 'info_dict': {'id': '8', 'title': 'Śniadanie w Trójce', 'description': 'md5:57abcc27bc4c6a6b25baa3061975b9ef', 'uploader': 'Beata Michniewicz'}, 'playlist_mincount': 714}]
    _PAGE_SIZE = 10
