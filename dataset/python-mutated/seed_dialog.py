...
from PyQt5.QtWidgets import QVBoxLayout, QCheckBox, QHBoxLayout, QLineEdit, QLabel, QCompleter, QDialog, QStyledItemDelegate, QScrollArea, QWidget, QPushButton
from electrum.i18n import _
from electrum.mnemonic import Mnemonic, seed_type
from electrum import old_mnemonic
from electrum import slip39
from .util import Buttons, OkButton, WWLabel, ButtonsTextEdit, icon_path, EnterButton, CloseButton, WindowModalDialog, ColorScheme, ChoicesLayout, font_height
from .qrtextedit import ShowQRTextEdit, ScanQRTextEdit
from .completion_text_edit import CompletionTextEdit
if TYPE_CHECKING:
    from electrum.simple_config import SimpleConfig
MSG_PASSPHRASE_WARN_ISSUE4566 = _('Warning') + ': ' + _('You have multiple consecutive whitespaces or leading/trailing whitespaces in your passphrase.') + ' ' + _('This is discouraged.') + ' ' + _('Due to a bug, old versions of Electrum will NOT be creating the same wallet as newer versions or other software.')
