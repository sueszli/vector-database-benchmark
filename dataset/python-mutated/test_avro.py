...
expected = [{'name': random.choice(['fred', 'wilma', 'barney', 'betty']), 'number': random.randint(0, 100)} for _ in range(1000)]
schema = {'doc': 'Descr', 'name': 'Random', 'namespace': 'test', 'type': 'record', 'fields': [{'name': 'name', 'type': 'string'}, {'name': 'number', 'type': 'int'}]}
