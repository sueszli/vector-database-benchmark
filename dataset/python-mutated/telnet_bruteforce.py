...
class Exploit(TelnetClient):
    __info__ = {'name': 'Telnet Bruteforce', 'description': 'Module performs bruteforce attack against Telnet service. If valid credentials are found, they are displayed to the user.', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'devices': ('Multiple devices',)}
