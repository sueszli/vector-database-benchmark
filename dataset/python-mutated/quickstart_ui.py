...
TUTORIALS = {'api/0.8': Tutorial(filename='api/0.8', description='0.8 API Notebooks', url='api/0.8'), 'hello-syft': Tutorial(filename='tutorials/hello-syft', description='Hello Syft', url='tutorials/hello-syft'), 'data-engineer': Tutorial(filename='tutorials/data-engineer', description='Data Engineer', url='tutorials/data-engineer'), 'data-owner': Tutorial(filename='tutorials/data-owner', description='Data Owner', url='tutorials/data-owner'), 'data-scientist': Tutorial(filename='tutorials/data-scientist', description='Data Scientist', url='tutorials/data-scientist'), 'pandas-cookbook': Tutorial(filename='tutorials/pandas-cookbook', description='Pandas Cookbook', url='tutorials/pandas-cookbook')}
