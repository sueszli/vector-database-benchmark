...
from ..utils import ExtractorError, NO_DEFAULT, remove_start

class OdaTVIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?odatv\\.com/(?:mob|vid)_video\\.php\\?.*\\bid=(?P<id>[^&]+)'
    _TESTS = [{'url': 'http://odatv.com/vid_video.php?id=8E388', 'md5': 'dc61d052f205c9bf2da3545691485154', 'info_dict': {'id': '8E388', 'ext': 'mp4', 'title': 'Artık Davutoğlu ile devam edemeyiz'}}, {'url': 'http://odatv.com/mob_video.php?id=8E388', 'only_matching': True}, {'url': 'http://odatv.com/mob_video.php?id=8E900', 'only_matching': True}]
