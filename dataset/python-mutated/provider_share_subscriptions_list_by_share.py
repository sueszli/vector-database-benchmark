...
def main():
    ...
    response = client.provider_share_subscriptions.list_by_share(resource_group_name='SampleResourceGroup', account_name='Account1', share_name='Share1')
