...
ERROR_PREFIX = 'lsattr:'
ATTRIBUTES = {'B': 'compressed_file', 'Z': 'compressed_dirty_file', 'X': 'compression_raw_access', 's': 'secure_deletion', 'u': 'undelete', 'S': 'synchronous_updates', 'D': 'synchronous_directory_updates', 'i': 'immutable', 'a': 'append_only', 'd': 'no_dump', 'A': 'no_atime', 'c': 'compression_requested', 'E': 'encrypted', 'j': 'journaled_data', 'I': 'indexed_directory', 't': 'no_tailmerging', 'T': 'top_of_directory_hierarchies', 'e': 'extents', 'C': 'no_cow', 'F': 'casefold', 'N': 'inline_data', 'P': 'project_hierarchy', 'V': 'verity'}
