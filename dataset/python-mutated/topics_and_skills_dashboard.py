...
class TopicsAndSkillsDashboardPage(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class TopicsAndSkillsDashboardPageDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class CategorizedAndUntriagedSkillsDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
...
class SkillsDashboardPageDataHandler(base.BaseHandler[SkillsDashboardPageDataHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Provides data for the user's skills dashboard page."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'classroom_name': {'schema': {'type': 'basestring'}}, 'next_cursor': {'schema': {'type': 'basestring'}, 'default_value': None}, 'keywords': {'schema': {'type': 'list', 'items': {'type': 'basestring'}}}, 'num_skills_to_fetch': {'schema': {'type': 'int', 'validators': [{'id': 'is_at_least', 'min_value': 1}]}}, 'sort': {'schema': {'type': 'basestring'}, 'choices': constants.TOPIC_SKILL_DASHBOARD_SORT_OPTIONS}, 'status': {'schema': {'type': 'basestring'}, 'choices': constants.SKILL_STATUS_OPTIONS}}}
...
class NewTopicHandler(base.BaseHandler[NewTopicHandlerNormalizedPayloadDict, NewTopicHandlerNormalizedRequestDict]):
    """Creates a new topic."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'name': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': android_validation_constants.MAX_CHARS_IN_TOPIC_NAME}, {'id': 'is_nonempty'}]}}, 'url_fragment': constants.SCHEMA_FOR_TOPIC_URL_FRAGMENTS, 'description': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': android_validation_constants.MAX_CHARS_IN_TOPIC_DESCRIPTION}]}}, 'filename': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': '[-\\w]+[.]\\w+'}]}}, 'thumbnailBgColor': {'schema': {'type': 'basestring', 'choices': constants.ALLOWED_THUMBNAIL_BG_COLORS['topic']}}, 'image': {'schema': {'type': 'basestring'}}, 'page_title_fragment': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': constants.MAX_CHARS_IN_PAGE_TITLE_FRAGMENT_FOR_WEB}, {'id': 'has_length_at_least', 'min_value': constants.MIN_CHARS_IN_PAGE_TITLE_FRAGMENT_FOR_WEB}]}}}}
...
class NewSkillHandler(base.BaseHandler[NewSkillHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Creates a new skill."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'description': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': android_validation_constants.MAX_CHARS_IN_SKILL_DESCRIPTION}]}}, 'linked_topic_ids': {'schema': {'type': 'list', 'items': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}}, 'explanation_dict': {'schema': {'type': 'object_dict', 'object_class': state_domain.SubtitledHtml}}, 'rubrics': {'schema': {'type': 'list', 'items': {'type': 'object_dict', 'object_class': skill_domain.Rubric}}}, 'files': {'schema': {'type': 'object_dict', 'validation_method': domain_objects_validator.validate_suggestion_images}}}}
...
class MergeSkillHandler(base.BaseHandler[MergeSkillHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Handles merging of the skills."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'old_skill_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}, 'new_skill_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.ENTITY_ID_REGEX}]}}}}
...
class TopicIdToDiagnosticTestSkillIdsHandler(base.BaseHandler[Dict[str, str], TopicIdToDiagnosticTestSkillIdsHandlerNormalizedRequestDict]):
    """Handler class to get topic ID to diagnostic test skill IDs dict."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'comma_separated_topic_ids': {'schema': {'type': 'object_dict', 'validation_method': normalize_comma_separated_topic_ids}}}}
