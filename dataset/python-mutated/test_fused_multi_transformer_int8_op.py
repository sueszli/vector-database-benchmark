...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpGenCacheKVFp16(TestFusedMultiTransformerInt8Op):
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpPostLayerNormFp16(TestFusedMultiTransformerInt8Op):
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpCacheKVPostLayerNorm(TestFusedMultiTransformerInt8Op):
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpCacheKVPostLayerNormFp16(TestFusedMultiTransformerInt8Op):
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpGenCacheKVPostLayerNorm(TestFusedMultiTransformerInt8Op):
...
@unittest.skipIf(not core.is_compiled_with_cuda() or get_cuda_version() < 11020 or paddle.device.cuda.get_device_capability()[0] < 8, 'FusedMultiTransformerInt8 requires CUDA >= 11.2 and CUDA_ARCH >= 8')
class TestFusedMultiTransformerInt8OpGenCacheKVPostLayerNormFp16(TestFusedMultiTransformerInt8Op):
