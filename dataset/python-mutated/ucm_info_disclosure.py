...
class Exploit(UDPClient):
    __info__ = {'name': 'Cisco UCM Info Disclosure', 'description': 'Module exploits information disclosure vulnerability in Cisco UCM devices. If the target is vulnerable it is possible to read sensitive information through TFTP service.', 'authors': ('Daniel Svartman <danielsvartman[at]gmail.com', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/30237/', 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2013-7030'), 'devices': ('Cisco UCM',)}
