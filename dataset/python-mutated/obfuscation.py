...
from graphql import GraphQLError, GraphQLInterfaceType, GraphQLObjectType, GraphQLSchema, get_default_backend, get_named_type
from graphql.language.ast import Field, FragmentDefinition, FragmentSpread, InlineFragment, OperationDefinition
...
GraphQLNode = Union[Field, FragmentDefinition, FragmentSpread, InlineFragment, OperationDefinition]
MASK = '***'
