...
@pytest.mark.parametrize('client_class,transport_name', [(DomainMappingsClient, 'grpc'), (DomainMappingsAsyncClient, 'grpc_asyncio'), (DomainMappingsClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.DomainMappingsGrpcTransport, 'grpc'), (transports.DomainMappingsGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.DomainMappingsRestTransport, 'rest')])
...
def test_domain_mappings_client_get_transport_class():
    ...
    available_transports = [transports.DomainMappingsGrpcTransport, transports.DomainMappingsRestTransport]
    assert transport in available_transports
    transport = DomainMappingsClient.get_transport_class('grpc')
    assert transport == transports.DomainMappingsGrpcTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(DomainMappingsClient, transports.DomainMappingsGrpcTransport, 'grpc'), (DomainMappingsAsyncClient, transports.DomainMappingsGrpcAsyncIOTransport, 'grpc_asyncio'), (DomainMappingsClient, transports.DomainMappingsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(DomainMappingsClient, transports.DomainMappingsGrpcTransport, 'grpc', grpc_helpers), (DomainMappingsAsyncClient, transports.DomainMappingsGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_list_domain_mappings(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_domain_mappings), '__call__') as call:
        call.return_value = appengine.ListDomainMappingsResponse(next_page_token='next_page_token_value')
...
async def test_list_domain_mappings_async(transport: str='grpc_asyncio', request_type=appengine.ListDomainMappingsRequest):
    client = DomainMappingsAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_domain_mappings), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(appengine.ListDomainMappingsResponse(next_page_token='next_page_token_value'))
...
def test_list_domain_mappings_pager(transport_name: str='grpc'):
    if False:
        while True:
            i = 10
    client = DomainMappingsClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_domain_mappings), '__call__') as call:
        call.side_effect = (appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping(), domain_mapping.DomainMapping(), domain_mapping.DomainMapping()], next_page_token='abc'), appengine.ListDomainMappingsResponse(domain_mappings=[], next_page_token='def'), appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping()], next_page_token='ghi'), appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping(), domain_mapping.DomainMapping()]), RuntimeError)
        metadata = ()
...
def test_get_domain_mapping(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.get_domain_mapping), '__call__') as call:
        call.return_value = domain_mapping.DomainMapping(name='name_value', id='id_value')
...
async def test_get_domain_mapping_async(transport: str='grpc_asyncio', request_type=appengine.GetDomainMappingRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_domain_mapping), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(domain_mapping.DomainMapping(name='name_value', id='id_value'))
...
def test_list_domain_mappings_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = appengine.ListDomainMappingsResponse(next_page_token='next_page_token_value')
...
def test_list_domain_mappings_rest_interceptors(null_interceptor):
    if False:
        i = 10
        return i + 15
    transport = transports.DomainMappingsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DomainMappingsRestInterceptor())
    client = DomainMappingsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.DomainMappingsRestInterceptor, 'post_list_domain_mappings') as post, mock.patch.object(transports.DomainMappingsRestInterceptor, 'pre_list_domain_mappings') as pre:
...
def test_list_domain_mappings_rest_pager(transport: str='rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        response = (appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping(), domain_mapping.DomainMapping(), domain_mapping.DomainMapping()], next_page_token='abc'), appengine.ListDomainMappingsResponse(domain_mappings=[], next_page_token='def'), appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping()], next_page_token='ghi'), appengine.ListDomainMappingsResponse(domain_mappings=[domain_mapping.DomainMapping(), domain_mapping.DomainMapping()]))
...
def test_get_domain_mapping_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = domain_mapping.DomainMapping(name='name_value', id='id_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_get_domain_mapping_rest_interceptors(null_interceptor):
    ...
    transport = transports.DomainMappingsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DomainMappingsRestInterceptor())
    client = DomainMappingsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.DomainMappingsRestInterceptor, 'post_get_domain_mapping') as post, mock.patch.object(transports.DomainMappingsRestInterceptor, 'pre_get_domain_mapping') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_domain_mapping_rest(request_type):
    ...
    for (field, value) in request_init['domain_mapping'].items():
        result = None
        is_repeated = False
...
def test_create_domain_mapping_rest_interceptors(null_interceptor):
    ...
    transport = transports.DomainMappingsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DomainMappingsRestInterceptor())
    client = DomainMappingsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.DomainMappingsRestInterceptor, 'post_create_domain_mapping') as post, mock.patch.object(transports.DomainMappingsRestInterceptor, 'pre_create_domain_mapping') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_domain_mapping_rest_interceptors(null_interceptor):
    ...
    transport = transports.DomainMappingsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DomainMappingsRestInterceptor())
    client = DomainMappingsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.DomainMappingsRestInterceptor, 'post_update_domain_mapping') as post, mock.patch.object(transports.DomainMappingsRestInterceptor, 'pre_update_domain_mapping') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_domain_mapping_rest_interceptors(null_interceptor):
    ...
    transport = transports.DomainMappingsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.DomainMappingsRestInterceptor())
    client = DomainMappingsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(operation.Operation, '_set_result_from_operation'), mock.patch.object(transports.DomainMappingsRestInterceptor, 'post_delete_domain_mapping') as post, mock.patch.object(transports.DomainMappingsRestInterceptor, 'pre_delete_domain_mapping') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        for i in range(10):
            print('nop')
    transport = transports.DomainMappingsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DomainMappingsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.DomainMappingsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DomainMappingsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.DomainMappingsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.DomainMappingsGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = DomainMappingsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.DomainMappingsGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.DomainMappingsGrpcTransport, transports.DomainMappingsGrpcAsyncIOTransport, transports.DomainMappingsRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = DomainMappingsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_domain_mappings_base_transport():
    ...
    with mock.patch('google.cloud.appengine_admin_v1.services.domain_mappings.transports.DomainMappingsTransport.__init__') as Transport:
        ...
        transport = transports.DomainMappingsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_domain_mappings', 'get_domain_mapping', 'create_domain_mapping', 'update_domain_mapping', 'delete_domain_mapping')
...
def test_domain_mappings_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.appengine_admin_v1.services.domain_mappings.transports.DomainMappingsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.DomainMappingsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.DomainMappingsGrpcTransport, grpc_helpers), (transports.DomainMappingsGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_domain_mappings_host_no_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = DomainMappingsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='appengine.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('appengine.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://appengine.googleapis.com')
...
def test_domain_mappings_host_with_port(transport_name):
    if False:
        print('Hello World!')
    client = DomainMappingsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='appengine.googleapis.com:8000'), transport=transport_name)
...
def test_domain_mappings_client_transport_session_collision(transport_name):
    ...
    client1 = DomainMappingsClient(credentials=creds1, transport=transport_name)
    client2 = DomainMappingsClient(credentials=creds2, transport=transport_name)
...
def test_domain_mappings_grpc_transport_channel():
    ...
    transport = transports.DomainMappingsGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_domain_mappings_grpc_asyncio_transport_channel():
    ...
    transport = transports.DomainMappingsGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_domain_mappings_grpc_lro_async_client():
    if False:
        print('Hello World!')
    client = DomainMappingsAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
    transport = client.transport
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.DomainMappingsTransport, '_prep_wrapped_messages') as prep:
        client = DomainMappingsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(DomainMappingsClient, transports.DomainMappingsGrpcTransport), (DomainMappingsAsyncClient, transports.DomainMappingsGrpcAsyncIOTransport)])
