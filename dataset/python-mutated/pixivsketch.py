...
class PixivSketchUserIE(PixivSketchBaseIE):
    ...
    _TESTS = [{'url': 'https://sketch.pixiv.net/@nuhutya', 'only_matching': True}, {'url': 'https://sketch.pixiv.net/@namahyou', 'only_matching': True}, {'url': 'https://sketch.pixiv.net/@8aki', 'only_matching': True}]
