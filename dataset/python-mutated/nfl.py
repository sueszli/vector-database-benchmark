...
class NFLBaseIE(InfoExtractor):
    ...
    _VIDEO_CONFIG_REGEX = '<script[^>]+id="[^"]*video-config-[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12}[^"]*"[^>]*>\\s*({.+});?\\s*</script>'
    _ANVATO_PREFIX = 'anvato:GXvEgwyJeWem8KCYXfeoHWknwP48Mboj:'
    _CLIENT_DATA = {'clientKey': '4cFUW6DmwJpzT9L7LrG3qRAcABG5s04g', 'clientSecret': 'CZuvCL49d9OwfGsR', 'deviceId': str(uuid.uuid4()), 'deviceInfo': base64.b64encode(json.dumps({'model': 'desktop', 'version': 'Chrome', 'osName': 'Windows', 'osVersion': '10.0'}, separators=(',', ':')).encode()).decode(), 'networkType': 'other', 'nflClaimGroupsToAdd': [], 'nflClaimGroupsToRemove': []}
    _ACCOUNT_INFO = {}
    _API_KEY = None
    _TOKEN = None
    _TOKEN_EXPIRY = 0
...
class NFLIE(NFLBaseIE):
    IE_NAME = 'nfl.com'
    _VALID_URL = NFLBaseIE._VALID_URL_BASE + '(?:videos?|listen|audio)/(?P<id>[^/#?&]+)'
    _TESTS = [{'url': 'https://www.nfl.com/videos/baker-mayfield-s-game-changing-plays-from-3-td-game-week-14', 'info_dict': {'id': '899441', 'ext': 'mp4', 'title': "Baker Mayfield's game-changing plays from 3-TD game Week 14", 'description': 'md5:85e05a3cc163f8c344340f220521136d', 'upload_date': '20201215', 'timestamp': 1608009755, 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'NFL', 'tags': 'count:6', 'duration': 157, 'categories': 'count:3'}}, {'url': 'https://www.chiefs.com/listen/patrick-mahomes-travis-kelce-react-to-win-over-dolphins-the-breakdown', 'md5': '6886b32c24b463038c760ceb55a34566', 'info_dict': {'id': 'd87e8790-3e14-11eb-8ceb-ff05c2867f99', 'ext': 'mp3', 'title': 'Patrick Mahomes, Travis Kelce React to Win Over Dolphins | The Breakdown', 'description': 'md5:12ada8ee70e6762658c30e223e095075'}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'https://www.buffalobills.com/video/buffalo-bills-military-recognition-week-14', 'only_matching': True}, {'url': 'https://www.raiders.com/audio/instant-reactions-raiders-week-14-loss-to-indianapolis-colts-espn-jason-fitz', 'only_matching': True}]
...
class NFLPlusReplayIE(NFLBaseIE):
    ...
    _TESTS = [{'url': 'https://www.nfl.com/plus/games/giants-at-vikings-2022-post-1/1572108', 'info_dict': {'id': '1572108', 'ext': 'mp4', 'title': 'New York Giants at Minnesota Vikings', 'description': 'New York Giants play the Minnesota Vikings at U.S. Bank Stadium on January 15, 2023', 'uploader': 'NFL', 'upload_date': '20230116', 'timestamp': 1673864520, 'duration': 7157, 'categories': ['Game Highlights'], 'tags': ['Minnesota Vikings', 'New York Giants', 'Minnesota Vikings vs. New York Giants'], 'thumbnail': 're:^https?://.*\\.jpg'}, 'params': {'skip_download': 'm3u8'}}, {'note': 'Subscription required', 'url': 'https://www.nfl.com/plus/games/giants-at-vikings-2022-post-1', 'playlist_count': 4, 'info_dict': {'id': 'giants-at-vikings-2022-post-1'}}, {'note': 'Subscription required', 'url': 'https://www.nfl.com/plus/games/giants-at-patriots-2011-pre-4', 'playlist_count': 2, 'info_dict': {'id': 'giants-at-patriots-2011-pre-4'}}, {'note': 'Subscription required', 'url': 'https://www.nfl.com/plus/games/giants-at-patriots-2011-pre-4', 'info_dict': {'id': '950701', 'ext': 'mp4', 'title': 'Giants @ Patriots', 'description': 'Giants at Patriots on September 01, 2011', 'uploader': 'NFL', 'upload_date': '20210724', 'timestamp': 1627085874, 'duration': 1532, 'categories': ['Game Highlights'], 'tags': ['play-by-play'], 'thumbnail': 're:^https?://.*\\.jpg'}, 'params': {'skip_download': 'm3u8', 'extractor_args': {'nflplusreplay': {'type': ['condensed_game']}}}}]
    _REPLAY_TYPES = {'full_game': 'Full Game', 'full_game_spanish': 'Full Game - Spanish', 'condensed_game': 'Condensed Game', 'all_22': 'All-22'}
...
class NFLPlusEpisodeIE(NFLBaseIE):
    ...
    _TESTS = [{'note': 'Subscription required', 'url': 'https://www.nfl.com/plus/episodes/kurt-s-qb-insider-conference-championships', 'info_dict': {'id': '1576832', 'ext': 'mp4', 'title': 'Conference Championships', 'description': 'md5:944f7fab56f7a37430bf8473f5473857', 'uploader': 'NFL', 'upload_date': '20230127', 'timestamp': 1674782760, 'duration': 730, 'categories': ['Analysis'], 'tags': ['Cincinnati Bengals at Kansas City Chiefs (2022-POST-3)'], 'thumbnail': 're:^https?://.*\\.jpg'}, 'params': {'skip_download': 'm3u8'}}]
