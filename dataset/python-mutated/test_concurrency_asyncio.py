...
from prefect.concurrency.asyncio import _acquire_concurrency_slots, _release_concurrency_slots, concurrency, rate_limit
...
async def test_concurrency_orchestrates_api(concurrency_limit: ConcurrencyLimitV2):
    ...
    async def resource_heavy():
        ...
        async with concurrency('test', occupy=1):
            executed = True
    assert not executed
    with mock.patch('prefect.concurrency.asyncio._acquire_concurrency_slots', wraps=_acquire_concurrency_slots) as acquire_spy:
        with mock.patch('prefect.concurrency.asyncio._release_concurrency_slots', wraps=_release_concurrency_slots) as release_spy:
...
async def test_concurrency_can_be_used_within_a_flow(concurrency_limit: ConcurrencyLimitV2):
    executed = False
...
async def test_concurrency_emits_events(concurrency_limit: ConcurrencyLimitV2, other_concurrency_limit: ConcurrencyLimitV2, asserting_events_worker: EventsWorker, reset_worker_events):
    executed = False
...
async def test_rate_limit_orchestrates_api(concurrency_limit_with_decay: ConcurrencyLimitV2):
    executed = False
...
async def test_rate_limit_can_be_used_within_a_flow(concurrency_limit_with_decay: ConcurrencyLimitV2):
    executed = False
...
async def test_rate_limit_emits_events(concurrency_limit_with_decay: ConcurrencyLimitV2, other_concurrency_limit_with_decay: ConcurrencyLimitV2, asserting_events_worker: EventsWorker, reset_worker_events):
