...
def get_sign(dt):
    ...
    return zodiac_sign
_VALID_SIGNS = ['capricorn', 'aquarius', 'pisces', 'aries', 'taurus', 'gemini', 'cancer', 'leo', 'virgo', 'libra', 'scorpio', 'sagittarius']
_CONST_TO_SIGNS = {'capricornus': 'capricorn', 'scorpius': 'scorpio'}
_ZODIAC = ((1900, 'rat'), (1901, 'ox'), (1902, 'tiger'), (1903, 'rabbit'), (1904, 'dragon'), (1905, 'snake'), (1906, 'horse'), (1907, 'goat'), (1908, 'monkey'), (1909, 'rooster'), (1910, 'dog'), (1911, 'pig'))
