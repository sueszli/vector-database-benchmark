...
@attr.s
class Validated:
    a = attr.ib(type=List[C], validator=attr.validators.deep_iterable(attr.validators.instance_of(C), attr.validators.instance_of(list)))
    aa = attr.ib(type=Tuple[C], validator=attr.validators.deep_iterable(attr.validators.instance_of(C), attr.validators.instance_of(tuple)))
    b = attr.ib(type=List[C], validator=attr.validators.deep_iterable(attr.validators.instance_of(C)))
    c = attr.ib(type=Dict[C, D], validator=attr.validators.deep_mapping(attr.validators.instance_of(C), attr.validators.instance_of(D), attr.validators.instance_of(dict)))
    d = attr.ib(type=Dict[C, D], validator=attr.validators.deep_mapping(attr.validators.instance_of(C), attr.validators.instance_of(D)))
    e: str = attr.ib(validator=attr.validators.matches_re(re.compile('foo')))
    f: str = attr.ib(validator=attr.validators.matches_re('foo', flags=42, func=re.search))
    ...
    k: int | str | C = attr.ib(validator=attrs.validators.instance_of((int, C, str)))
    l: Any = attr.ib(validator=attr.validators.not_(attr.validators.in_('abc')))
    m: Any = attr.ib(validator=attr.validators.not_(attr.validators.in_('abc'), exc_types=ValueError))
    n: Any = attr.ib(validator=attr.validators.not_(attr.validators.in_('abc'), exc_types=(ValueError,)))
    o: Any = attr.ib(validator=attr.validators.not_(attr.validators.in_('abc'), msg='spam'))
    p: Any = attr.ib(validator=attr.validators.not_(attr.validators.in_('abc'), msg=None))
    q: Any = attr.ib(validator=attrs.validators.optional(attrs.validators.instance_of(C)))
    r: Any = attr.ib(validator=attrs.validators.optional([attrs.validators.instance_of(C)]))
    s: Any = attr.ib(validator=attrs.validators.optional((attrs.validators.instance_of(C),)))
...
class ValidatedSetter2:
    ...
    d: int = attrs.field(on_setattr=[attrs.setters.convert, attrs.setters.validate])
    e: bool = attrs.field(on_setattr=attrs.setters.pipe(attrs.setters.convert, attrs.setters.validate))
