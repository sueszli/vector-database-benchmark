...
if __name__ == '__main__':
    ...
    request_option = prompt_select(title='> Please key in your options: ', values=[('1', HTML('<style fg="cyan">Input test results</style>')), ('2', HTML('<style fg="cyan">Ask for todos</style>')), ('3', HTML('<style fg="cyan">Discuss with PentestGPT</style>')), ('4', HTML('<style fg="cyan">Exit</style>'))])
