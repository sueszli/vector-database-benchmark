...
class MonadThreeCol(MonadTall):
    ...
    client.
    """
    defaults = [('main_centered', True, 'Place the main pane at the center of the screen'), ('new_client_position', 'top', 'Place new windows:  after_current - after the active window. before_current - before the active window, top - at the top of the stack, bottom - at the bottom of the stack,')]
