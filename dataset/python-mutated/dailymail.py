...
from ..utils import int_or_none, determine_protocol, try_get, unescapeHTML

class DailyMailIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?dailymail\\.co\\.uk/(?:video/[^/]+/video-|embed/video/)(?P<id>[0-9]+)'
    _EMBED_REGEX = ['<iframe\\b[^>]+\\bsrc=["\\\'](?P<url>(?:https?:)?//(?:www\\.)?dailymail\\.co\\.uk/embed/video/\\d+\\.html)']
    _TESTS = [{'url': 'http://www.dailymail.co.uk/video/tvshowbiz/video-1295863/The-Mountain-appears-sparkling-water-ad-Heavy-Bubbles.html', 'md5': 'f6129624562251f628296c3a9ffde124', 'info_dict': {'id': '1295863', 'ext': 'mp4', 'title': "The Mountain appears in sparkling water ad for 'Heavy Bubbles'", 'description': 'md5:a93d74b6da172dd5dc4d973e0b766a84'}}, {'url': 'http://www.dailymail.co.uk/embed/video/1295863.html', 'only_matching': True}]
