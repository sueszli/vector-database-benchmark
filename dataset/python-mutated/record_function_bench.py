...
def prepare_resnet50_jit(bench_args):
    ...
    return (inputs, model)
MODELS = {'resnet50_jit': prepare_resnet50_jit, 'lstm_jit': prepare_lstm_jit}
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Benchmark RecordFunction overhead for ResNet and LSTM models')
    parser.add_argument('--models', nargs='*', default=['lstm_jit'], help='What model to run: ' + str(MODELS.keys()))
