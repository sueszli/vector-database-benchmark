...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-rep', '-r', type=int, default=5, help='Number of repetition to average on.')
    parser.add_argument('--name', '-n', type=str, default='', help="Name to save the results with. This can be used to compare different branches with '-c'.")
    parser.add_argument('--compare', '-c', action='append', help='Loads the results from a benchmark saved previously with a name given as the present argument value. This allows comparing the results across different versions of joblib.')
