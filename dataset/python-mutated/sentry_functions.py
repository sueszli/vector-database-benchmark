...
TASK_OPTIONS = {'queue': 'app_platform', 'default_retry_delay': 60 * 5, 'max_retries': 3}

@instrumented_task('sentry.tasks.sentry_functions.send_sentry_function_webhook', acks_late=True, silo_mode=SiloMode.REGION, **TASK_OPTIONS)
@retry
