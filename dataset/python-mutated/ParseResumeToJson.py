...
class ParseResume:
    ...
    def get_JSON(self) -> dict:
        ...
        resume_dictionary = {'unique_id': generate_unique_id(), 'resume_data': self.resume_data, 'clean_data': self.clean_data, 'entities': self.entities, 'extracted_keywords': self.key_words, 'keyterms': self.keyterms, 'name': self.name, 'experience': self.experience, 'emails': self.emails, 'phones': self.phones, 'years': self.years, 'bi_grams': str(self.bi_grams), 'tri_grams': str(self.tri_grams), 'pos_frequencies': self.pos_frequencies}
