...
if torch.cuda.is_available() and hasattr(torch.cuda, 'amp') and hasattr(torch.cuda.amp, 'autocast') and torch.cuda.is_bf16_supported():
...
if not hasattr(torch.nn.functional, 'scaled_dot_product_attention'):
    logger.warning('torch version does not support flash attention. You will get significantly faster' + ' inference speed by upgrade torch to newest version / nightly.')
