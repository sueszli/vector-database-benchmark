...
class MBartEnroIntegrationTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            for i in range(10):
                print('nop')
        cls.tokenizer: MBartTokenizer = MBartTokenizer.from_pretrained(cls.checkpoint_name, src_lang='en_XX', tgt_lang='ro_RO')
        cls.pad_token_id = 1
        return cls
    ...
    def test_tokenizer_translation(self):
        ...
        self.assertEqual(nested_simplify(inputs), {'input_ids': [[62, 3034, 2, 250004]], 'attention_mask': [[1, 1, 1, 1]], 'forced_bos_token_id': 250001})