...
class ImmutableDict(Case):
    ...
    def cython():
        ...
        return immutabledict
    IMPLEMENTATIONS = {'python': python.__func__, 'c': c.__func__, 'cython': cython.__func__}
...
class IdentitySet(Case):
    ...
    IMPLEMENTATIONS = {'set': set_fn.__func__, 'python': python.__func__, 'cython': cython.__func__}
    NUMBER = 10
...
class OrderedSet(IdentitySet):
    ...
    def ordered_lib():
        ...
        return OrderedSet
    IMPLEMENTATIONS = {'set': set_fn.__func__, 'python': python.__func__, 'cython': cython.__func__, 'ordsetlib': ordered_lib.__func__}
