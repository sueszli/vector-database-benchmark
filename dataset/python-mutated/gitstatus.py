...
class GitStatus(MultiPromptField):
    ...
    fragments = ('.branch', '.ahead', '.behind', '.operations', '{RESET}|', '.staged', '.conflicts', '.changed', '.deleted', '.untracked', '.stash_count', '.lines_added', '.lines_removed', '.clean')
    hidden = ('.lines_added', '.lines_removed')
