...
class CuraConan(ConanFile):
    ...
    options = {'enterprise': ['True', 'False', 'true', 'false'], 'staging': ['True', 'False', 'true', 'false'], 'devtools': [True, False], 'cloud_api_version': 'ANY', 'display_name': 'ANY', 'cura_debug_mode': [True, False], 'internal': [True, False], 'enable_i18n': [True, False]}
    default_options = {'enterprise': 'False', 'staging': 'False', 'devtools': False, 'cloud_api_version': '1', 'display_name': 'UltiMaker Cura', 'cura_debug_mode': False, 'internal': False, 'enable_i18n': False}
