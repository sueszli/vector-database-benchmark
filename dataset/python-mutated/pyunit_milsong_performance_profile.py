...
def glrm_subset():
    ...
    for ind in range(num_runs):
        acs_model = H2OGeneralizedLowRankEstimator(k=10, transform='STANDARDIZE', loss='Quadratic', multi_loss='Categorical', model_id='clients_core_glrm', regularization_x='L2', regularization_y='L1', gamma_x=0.2, gamma_y=0.5, init='SVD', max_iterations=1000, seed=seeds[ind % len(seeds)])
