...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0045_add_timestamp_index')]
    operations = [migrations.AddField(model_name='team', name='event_names', field=django.contrib.postgres.fields.jsonb.JSONField(default=list)), migrations.AddField(model_name='team', name='event_properties', field=django.contrib.postgres.fields.jsonb.JSONField(default=list)), migrations.RunPython(migrate_event_names_and_properties, noop, elidable=True)]