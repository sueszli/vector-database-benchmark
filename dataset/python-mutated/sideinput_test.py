...
python -m apache_beam.testing.load_tests.sideinput_test     --test-pipeline-options="
...
./gradlew -PloadTest.args="
    ...
    --input_options='{
      "num_records": 300,
      "key_size": 5,
      "value_size": 15}'" -PloadTest.mainClass=apache_beam.testing.load_tests.sideinput_test -Prunner=DirectRunner :sdks:python:apache_beam:testing:load_tests:run
"""
import logging
...
class SideInputTest(LoadTest):
    SIDE_INPUT_TYPES = {'iter': beam.pvalue.AsIter, 'list': beam.pvalue.AsList, 'dict': beam.pvalue.AsDict}
