...
from tribler.core.components.torrent_checker.torrent_checker.dataclasses import HEALTH_FRESHNESS_SECONDS, HealthInfo, TrackerResponse
from tribler.core.components.torrent_checker.torrent_checker.torrentchecker_session import FakeBep33DHTSession, FakeDHTSession, TrackerSession, UdpSocketManager, create_tracker_session
from tribler.core.components.torrent_checker.torrent_checker.tracker_manager import MAX_TRACKER_FAILURES, TrackerManager
from tribler.core.components.torrent_checker.torrent_checker.utils import aggregate_responses_for_infohash, filter_non_exceptions, gather_coros
...
TRACKER_SELECTION_INTERVAL = 1
TORRENT_SELECTION_INTERVAL = 120
USER_CHANNEL_TORRENT_SELECTION_INTERVAL = 10 * 60
MIN_TORRENT_CHECK_INTERVAL = 900
TORRENT_CHECK_RETRY_INTERVAL = 30
MAX_TORRENTS_CHECKED_PER_SESSION = 50
TORRENT_SELECTION_POOL_SIZE = 2
USER_CHANNEL_TORRENT_SELECTION_POOL_SIZE = 5
TORRENTS_CHECKED_RETURN_SIZE = 240
