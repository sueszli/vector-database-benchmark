...
if __name__ == '__main__':
    ...
    for index in range(len(URMs_train)):
        ...
        SVD_recommenders[index].URM_train = URMs_train[index]
    ...
    def BO_func(alpha):
        ...
        recommenders = []
        for index in range(len(URMs_train)):
            recommender = GeneralizedMergedHybridRecommender(URM_train=URMs_train[index], recommenders=[IALS_recommenders[index], SVD_recommenders[index]], verbose=False)
