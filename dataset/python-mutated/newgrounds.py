...
from ..utils import clean_html, extract_attributes, get_element_by_id, int_or_none, parse_count, parse_duration, unified_timestamp, OnDemandPagedList, try_get

class NewgroundsIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?newgrounds\\.com/(?:audio/listen|portal/view)/(?P<id>\\d+)(?:/format/flash)?'
    _TESTS = [{'url': 'https://www.newgrounds.com/audio/listen/549479', 'md5': 'fe6033d297591288fa1c1f780386f07a', 'info_dict': {'id': '549479', 'ext': 'mp3', 'title': 'B7 - BusMode', 'uploader': 'Burn7', 'timestamp': 1378878540, 'upload_date': '20130911', 'duration': 143, 'view_count': int, 'description': 'md5:b8b3c2958875189f07d8e313462e8c4f'}}, {'url': 'https://www.newgrounds.com/portal/view/1', 'md5': 'fbfb40e2dc765a7e830cb251d370d981', 'info_dict': {'id': '1', 'ext': 'mp4', 'title': 'Scrotum 1', 'uploader': 'Brian-Beaton', 'timestamp': 955064100, 'upload_date': '20000406', 'view_count': int, 'description': 'Scrotum plays "catch."', 'age_limit': 17}}, {'url': 'http://www.newgrounds.com/portal/view/689400', 'info_dict': {'id': '689400', 'ext': 'mp4', 'title': 'ZTV News Episode 8', 'uploader': 'ZONE-SAMA', 'timestamp': 1487965140, 'upload_date': '20170224', 'view_count': int, 'description': 'md5:aff9b330ec2e78ed93b1ad6d017accc6', 'age_limit': 17}, 'params': {'skip_download': True}}, {'url': 'https://www.newgrounds.com/portal/view/297383', 'md5': '2c11f5fd8cb6b433a63c89ba3141436c', 'info_dict': {'id': '297383', 'ext': 'mp4', 'title': 'Metal Gear Awesome', 'uploader': 'Egoraptor', 'timestamp': 1140663240, 'upload_date': '20060223', 'view_count': int, 'description': 'md5:9246c181614e23754571995104da92e0', 'age_limit': 13}}, {'url': 'https://www.newgrounds.com/portal/view/297383/format/flash', 'md5': '5d05585a9a0caca059f5abfbd3865524', 'info_dict': {'id': '297383', 'ext': 'swf', 'title': 'Metal Gear Awesome', 'description': 'Metal Gear Awesome', 'uploader': 'Egoraptor', 'upload_date': '20060223', 'timestamp': 1140663240, 'age_limit': 13}}]
    _AGE_LIMIT = {'e': 0, 't': 13, 'm': 17, 'a': 18}
...
class NewgroundsPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.newgrounds.com/collection/cats', 'info_dict': {'id': 'cats', 'title': 'Cats'}, 'playlist_mincount': 45}, {'url': 'https://www.newgrounds.com/collection/dogs', 'info_dict': {'id': 'dogs', 'title': 'Dogs'}, 'playlist_mincount': 26}, {'url': 'http://www.newgrounds.com/audio/search/title/cats', 'only_matching': True}]
...
class NewgroundsUserIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://burn7.newgrounds.com/audio', 'info_dict': {'id': 'burn7'}, 'playlist_mincount': 150}, {'url': 'https://burn7.newgrounds.com/movies', 'info_dict': {'id': 'burn7'}, 'playlist_mincount': 2}, {'url': 'https://brian-beaton.newgrounds.com/movies', 'info_dict': {'id': 'brian-beaton'}, 'playlist_mincount': 10}]
    _PAGE_SIZE = 30
