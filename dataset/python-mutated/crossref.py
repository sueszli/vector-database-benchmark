...
about = {'website': 'https://www.crossref.org/', 'wikidata_id': 'Q5188229', 'official_api_documentation': 'https://api.crossref.org', 'use_official_api': False, 'require_api_key': False, 'results': 'JSON'}
