...
from frappe.utils import cstr, parse_addr, split_emails, strip_html, time_diff_in_seconds, validate_email_address
...
class Communication(Document, CommunicationEmailMixin):
    ...
    if TYPE_CHECKING:
        ...
        delivery_status: DF.Literal['', 'Sent', 'Bounced', 'Opened', 'Marked As Spam', 'Rejected', 'Delayed', 'Soft-Bounced', 'Clicked', 'Recipient Unsubscribed', 'Error', 'Expired', 'Sending', 'Read']
