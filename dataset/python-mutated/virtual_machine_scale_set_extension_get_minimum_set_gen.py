...
def main():
    ...
    response = client.virtual_machine_scale_set_extensions.get(resource_group_name='rgcompute', vm_scale_set_name='a', vmss_extension_name='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa')
    print(response)
