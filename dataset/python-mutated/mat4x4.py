...
if TYPE_CHECKING:
    ...
    Mat4x4Like = Any
Mat4x4ArrayLike = Union[Mat4x4, Sequence[Mat4x4Like]]
...
class Mat4x4Type(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            while True:
                i = 10
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 16), self._TYPE_NAME)
