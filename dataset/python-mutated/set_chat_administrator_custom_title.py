...
class SetChatAdministratorCustomTitle(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], user_id: int, custom_title: str, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(chat_id=chat_id, user_id=user_id, custom_title=custom_title, **__pydantic_kwargs)