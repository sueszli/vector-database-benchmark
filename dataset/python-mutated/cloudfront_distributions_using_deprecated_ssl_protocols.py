...
from prowler.providers.aws.services.cloudfront.cloudfront_service import OriginsSSLProtocols
        ...
        for distribution in cloudfront_client.distributions.values():
            ...
            for origin in distribution.origins:
                if 'CustomOriginConfig' in origin:
                    for ssl_protocol in origin['CustomOriginConfig']['OriginSslProtocols']['Items']:
                        if ssl_protocol in (OriginsSSLProtocols.SSLv3.value, OriginsSSLProtocols.TLSv1.value, OriginsSSLProtocols.TLSv1_1.value):
