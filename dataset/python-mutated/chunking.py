...
file_extension_splitters = {'.txt': lambda **kwargs: get_langchain_splitter('.txt', kwargs), '.md': lambda **kwargs: get_langchain_splitter('.md', kwargs), '.html': lambda **kwargs: get_langchain_splitter('.html', kwargs), '.htm': lambda **kwargs: get_langchain_splitter('.htm', kwargs), '.pdf': lambda **kwargs: get_langchain_splitter('.pdf', kwargs), '.ppt': lambda **kwargs: get_langchain_splitter('.ppt', kwargs), '.pptx': lambda **kwargs: get_langchain_splitter('.pptx', kwargs), '.doc': lambda **kwargs: get_langchain_splitter('.doc', kwargs), '.docx': lambda **kwargs: get_langchain_splitter('.docx', kwargs), '.xls': lambda **kwargs: get_langchain_splitter('.xls', kwargs), '.xlsx': lambda **kwargs: get_langchain_splitter('.xlsx', kwargs), '.py': lambda **kwargs: get_langchain_splitter('.py', kwargs)}
