...
if is_flax_available():
    ...
    from transformers.models.blenderbot_small.modeling_flax_blenderbot_small import FlaxBlenderbotSmallForConditionalGeneration, FlaxBlenderbotSmallModel, shift_tokens_right
...
class BlenderbotHeadTests(unittest.TestCase):
    ...
    def _get_config_and_data(self):
        ...
        config = BlenderbotSmallConfig(vocab_size=self.vocab_size, d_model=24, encoder_layers=2, decoder_layers=2, encoder_attention_heads=2, decoder_attention_heads=2, encoder_ffn_dim=32, decoder_ffn_dim=32, max_position_embeddings=48, eos_token_id=2, pad_token_id=1, bos_token_id=0)
    ...
    def test_lm_uneven_forward(self):
        if False:
            i = 10
            return i + 15
        config = BlenderbotSmallConfig(vocab_size=self.vocab_size, d_model=14, encoder_layers=2, decoder_layers=2, encoder_attention_heads=2, decoder_attention_heads=2, encoder_ffn_dim=8, decoder_ffn_dim=8, max_position_embeddings=48)
        lm_model = FlaxBlenderbotSmallForConditionalGeneration(config)
...
class FlaxBlenderbotSmallModelTest(FlaxModelTesterMixin, unittest.TestCase, FlaxGenerationTesterMixin):
    ...
    all_model_classes = (FlaxBlenderbotSmallModel, FlaxBlenderbotSmallForConditionalGeneration) if is_flax_available() else ()
