...
line_width = 2
marker_size = 4
xaxis_args = {'showline': True, 'mirror': True, 'linewidth': 1.5}
yaxis_args = {'showline': True, 'mirror': True, 'linewidth': 1.5}
layout_args = {'autosize': True, 'template': 'plotly_white', 'margin': go.layout.Margin(l=0, r=10, b=0, t=10, pad=0), 'font': dict(size=10), 'title': dict(font=dict(size=12)), 'hovermode': 'x unified'}
