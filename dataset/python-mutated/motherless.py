...
class MotherlessIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://motherless.com/EE97006', 'md5': 'cb5e7438f7a3c4e886b7bccc1292a3bc', 'info_dict': {'id': 'EE97006', 'ext': 'mp4', 'title': 'Dogging blond Brit getting glazed (comp)', 'categories': ['UK', 'slag', 'whore', 'dogging', 'cunt', 'cumhound', 'big tits', 'Pearl Necklace'], 'upload_date': '20230519', 'uploader_id': 'deathbird', 'thumbnail': 're:https?://.*\\.jpg', 'age_limit': 18, 'comment_count': int, 'view_count': int, 'like_count': int}, 'params': {'nocheckcertificate': True}}, {'url': 'http://motherless.com/532291B', 'md5': 'bc59a6b47d1f958e61fbd38a4d31b131', 'info_dict': {'id': '532291B', 'ext': 'mp4', 'title': 'Amazing girl playing the omegle game, PERFECT!', 'categories': ['Amateur', 'webcam', 'omegle', 'pink', 'young', 'masturbate', 'teen', 'game', 'hairy'], 'upload_date': '20140622', 'uploader_id': 'Sulivana7x', 'thumbnail': 're:https?://.*\\.jpg', 'age_limit': 18}, 'skip': '404'}, {'url': 'http://motherless.com/g/cosplay/633979F', 'md5': '0b2a43f447a49c3e649c93ad1fafa4a0', 'info_dict': {'id': '633979F', 'ext': 'mp4', 'title': 'Turtlette', 'categories': ['superheroine heroine superher'], 'upload_date': '20140827', 'uploader_id': 'shade0230', 'thumbnail': 're:https?://.*\\.jpg', 'age_limit': 18, 'like_count': int, 'comment_count': int, 'view_count': int}, 'params': {'nocheckcertificate': True}}, {'url': 'http://motherless.com/8B4BBC1', 'info_dict': {'id': '8B4BBC1', 'ext': 'mp4', 'title': 'VIDEO00441.mp4', 'categories': [], 'upload_date': '20160214', 'uploader_id': 'NMWildGirl', 'thumbnail': 're:https?://.*\\.jpg', 'age_limit': 18, 'like_count': int, 'comment_count': int, 'view_count': int}, 'params': {'nocheckcertificate': True}}, {'url': 'https://motherless.com/3C3E2CF', 'info_dict': {'id': '3C3E2CF', 'ext': 'mp4', 'title': 'a/ Hot Teens', 'categories': list, 'upload_date': '20210104', 'uploader_id': 'anonymous', 'thumbnail': 're:https?://.*\\.jpg', 'age_limit': 18, 'like_count': int, 'comment_count': int, 'view_count': int}, 'params': {'nocheckcertificate': True}}]
...
class MotherlessGroupIE(MotherlessPaginatedIE):
    ...
    _TESTS = [{'url': 'http://motherless.com/gv/movie_scenes', 'info_dict': {'id': 'movie_scenes', 'title': 'Movie Scenes'}, 'playlist_mincount': 540}, {'url': 'http://motherless.com/g/sex_must_be_funny', 'info_dict': {'id': 'sex_must_be_funny', 'title': 'Sex must be funny'}, 'playlist_count': 0}, {'url': 'https://motherless.com/gv/beautiful_cock', 'info_dict': {'id': 'beautiful_cock', 'title': 'Beautiful Cock'}, 'playlist_mincount': 2040}]
...
class MotherlessGalleryIE(MotherlessPaginatedIE):
    ...
    _TESTS = [{'url': 'https://motherless.com/GV338999F', 'info_dict': {'id': '338999F', 'title': 'Random'}, 'playlist_mincount': 190}, {'url': 'https://motherless.com/GVABD6213', 'info_dict': {'id': 'ABD6213', 'title': 'Cuties'}, 'playlist_mincount': 2}, {'url': 'https://motherless.com/GVBCF7622', 'info_dict': {'id': 'BCF7622', 'title': 'Vintage'}, 'playlist_count': 0}, {'url': 'https://motherless.com/G035DE2F', 'info_dict': {'id': '035DE2F', 'title': 'General'}, 'playlist_mincount': 420}]
