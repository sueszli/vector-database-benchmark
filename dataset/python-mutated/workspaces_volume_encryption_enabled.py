...
from prowler.providers.aws.services.workspaces.workspaces_client import workspaces_client
...
class workspaces_volume_encryption_enabled(Check):
    ...
    def execute(self):
        ...
        for workspace in workspaces_client.workspaces:
            ...
            if not workspace.root_volume_encryption_enabled and (not workspace.user_volume_encryption_enabled):
                report.status = 'FAIL'
