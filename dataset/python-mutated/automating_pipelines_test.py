...
from docs_snippets.guides.dagster.automating_pipelines.config_schedule import configurable_job

def test_configurable_job_schedule():
    if False:
        print('Hello World!')
    context = build_schedule_context(scheduled_execution_time=datetime.datetime(2023, 1, 1))
