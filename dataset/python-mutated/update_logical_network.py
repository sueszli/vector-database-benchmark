...
def main():
    ...
    response = client.logical_networks.begin_update(resource_group_name='test-rg', logical_network_name='test-lnet', logical_networks={'tags': {'additionalProperties': 'sample'}}).result()
    print(response)
