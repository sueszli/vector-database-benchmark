...
async def test_search_catalogs_async(transport: str='grpc_asyncio', request_type=private_catalog.SearchCatalogsRequest):
    client = PrivateCatalogAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.search_catalogs), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(private_catalog.SearchCatalogsResponse(next_page_token='next_page_token_value'))
...
async def test_search_products_async(transport: str='grpc_asyncio', request_type=private_catalog.SearchProductsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.search_products), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(private_catalog.SearchProductsResponse(next_page_token='next_page_token_value'))
...
async def test_search_versions_async(transport: str='grpc_asyncio', request_type=private_catalog.SearchVersionsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.search_versions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(private_catalog.SearchVersionsResponse(next_page_token='next_page_token_value'))
...
async def test_transport_close_async():
    client = PrivateCatalogAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
