...
import fsspec
import pandas as pd
from kedro.io.core import PROTOCOL_DELIMITER, AbstractVersionedDataset, Version, get_filepath_str, get_protocol_and_path
...
class FeatherDataSet(AbstractVersionedDataset[pd.DataFrame, pd.DataFrame]):
    ...
    def _describe(self) -> Dict[str, Any]:
        if False:
            return 10
        return {'filepath': self._filepath, 'protocol': self._protocol, 'load_args': self._load_args, 'version': self._version}
    ...
    def _load(self) -> pd.DataFrame:
        ...
        return pd.read_feather(load_path, storage_options=self._storage_options, **self._load_args)
