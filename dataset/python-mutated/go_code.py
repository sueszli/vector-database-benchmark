...
from kitty.cli import CompletionSpec, GoOption, go_options_for_seq, parse_option_spec, serialize_as_go_string
...
def generate_completions_for_kitty() -> None:
    ...
    print('}')
json_field_types: Dict[str, str] = {'bool': 'bool', 'str': 'escaped_string', 'list.str': '[]escaped_string', 'dict.str': 'map[escaped_string]escaped_string', 'float': 'float64', 'int': 'int', 'scroll_amount': 'any', 'spacing': 'any', 'colors': 'any'}
