...
DBUS_RET = {'ListSnapshots': [[42, 1, 0, 1457006571, 0, 'Some description', '', {'userdata1': 'userval1', 'salt_jid': '20160607130930720112'}], [43, 2, 42, 1457006572, 0, 'Blah Blah', '', {'userdata2': 'userval2', 'salt_jid': '20160607130930720112'}]], 'ListConfigs': [['root', '/', {'SUBVOLUME': '/', 'NUMBER_MIN_AGE': '1800', 'TIMELINE_LIMIT_YEARLY': '4-10', 'NUMBER_LIMIT_IMPORTANT': '10', 'FSTYPE': 'btrfs', 'TIMELINE_LIMIT_MONTHLY': '4-10', 'ALLOW_GROUPS': '', 'EMPTY_PRE_POST_MIN_AGE': '1800', 'EMPTY_PRE_POST_CLEANUP': 'yes', 'BACKGROUND_COMPARISON': 'yes', 'TIMELINE_LIMIT_HOURLY': '4-10', 'ALLOW_USERS': '', 'TIMELINE_LIMIT_WEEKLY': '0', 'TIMELINE_CREATE': 'no', 'NUMBER_CLEANUP': 'yes', 'TIMELINE_CLEANUP': 'yes', 'SPACE_LIMIT': '0.5', 'NUMBER_LIMIT': '10', 'TIMELINE_MIN_AGE': '1800', 'TIMELINE_LIMIT_DAILY': '4-10', 'SYNC_ACL': 'no', 'QGROUP': '1/0'}]], 'GetFiles': [['/root/.viminfo', 8], ['/tmp/foo', 52], ['/tmp/foo2', 1], ['/tmp/foo3', 2], ['/var/log/snapper.log', 8], ['/var/cache/salt/minion/extmods/modules/snapper.py', 8], ['/var/cache/salt/minion/extmods/modules/snapper.pyc', 8]]}
FILE_CONTENT = {'/tmp/foo': {'pre': 'dummy text', 'post': 'another foobar'}, '/tmp/foo2': {'post': 'another foobar'}}
MODULE_RET = {'SNAPSHOTS': [{'userdata': {'userdata1': 'userval1', 'salt_jid': '20160607130930720112'}, 'description': 'Some description', 'timestamp': 1457006571, 'cleanup': '', 'user': 'root', 'type': 'pre', 'id': 42}, {'pre': 42, 'userdata': {'userdata2': 'userval2', 'salt_jid': '20160607130930720112'}, 'description': 'Blah Blah', 'timestamp': 1457006572, 'cleanup': '', 'user': 'root', 'type': 'post', 'id': 43}], 'LISTCONFIGS': {'root': {'SUBVOLUME': '/', 'NUMBER_MIN_AGE': '1800', 'TIMELINE_LIMIT_YEARLY': '4-10', 'NUMBER_LIMIT_IMPORTANT': '10', 'FSTYPE': 'btrfs', 'TIMELINE_LIMIT_MONTHLY': '4-10', 'ALLOW_GROUPS': '', 'EMPTY_PRE_POST_MIN_AGE': '1800', 'EMPTY_PRE_POST_CLEANUP': 'yes', 'BACKGROUND_COMPARISON': 'yes', 'TIMELINE_LIMIT_HOURLY': '4-10', 'ALLOW_USERS': '', 'TIMELINE_LIMIT_WEEKLY': '0', 'TIMELINE_CREATE': 'no', 'NUMBER_CLEANUP': 'yes', 'TIMELINE_CLEANUP': 'yes', 'SPACE_LIMIT': '0.5', 'NUMBER_LIMIT': '10', 'TIMELINE_MIN_AGE': '1800', 'TIMELINE_LIMIT_DAILY': '4-10', 'SYNC_ACL': 'no', 'QGROUP': '1/0'}}, 'GETFILES': {'/root/.viminfo': {'status': ['modified']}, '/tmp/foo': {'status': ['type changed', 'permission changed', 'owner changed']}, '/tmp/foo2': {'status': ['created']}, '/tmp/foo3': {'status': ['deleted']}, '/var/log/snapper.log': {'status': ['modified']}, '/var/cache/salt/minion/extmods/modules/snapper.py': {'status': ['modified']}, '/var/cache/salt/minion/extmods/modules/snapper.pyc': {'status': ['modified']}}, 'DIFF': {'/tmp/foo': {'comment': 'text file changed', 'diff': '--- /.snapshots/55/snapshot/tmp/foo\n+++ /tmp/foo\n@@ -1 +1 @@\n-dummy text+another foobar'}, '/tmp/foo2': {'comment': 'text file created', 'diff': '--- /.snapshots/55/snapshot/tmp/foo2\n+++ /tmp/foo2\n@@ -0,0 +1 @@\n+another foobar'}, '/tmp/foo26': {'comment': 'text file created', 'diff': '--- /.snapshots/55/snapshot/tmp/foo2 \n+++ /tmp/foo2 \n@@ -1,0 +1,1 @@\n+another foobar'}, '/tmp/foo3': {'comment': 'binary file changed', 'old_sha256_digest': 'e61f8b762d83f3b4aeb3689564b0ffbe54fa731a69a1e208dc9440ce0f69d19b', 'new_sha256_digest': 'f18f971f1517449208a66589085ddd3723f7f6cefb56c141e3d97ae49e1d87fa'}}}
...
class SnapperTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test__is_text_file(self, tempfile):
        ...
        with salt.utils.files.fopen(tempfile, 'wb') as wfh:
            wfh.write(b'C\x07\xd6\x13\xe5_\x99D\xeb\xd7v\xc1\x96p\x84\xd2{a\x03++\r\xcd/\xdb\x98\xda\xf7H\xf8\xfb-\x95\xa9}|^\t\xddx\x1c\x18s\x1bZ\x86\x8a(S\xe4')
