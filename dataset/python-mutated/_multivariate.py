...
_doc_random_state = 'seed : {None, int, np.random.RandomState, np.random.Generator}, optional\n    Used for drawing random variates.\n    If `seed` is `None`, the `~np.random.RandomState` singleton is used.\n    If `seed` is an int, a new ``RandomState`` instance is used, seeded\n    with seed.\n    If `seed` is already a ``RandomState`` or ``Generator`` instance,\n    then that object is used.\n    Default is `None`.\n'
...
_matnorm_doc_default_callparams = 'mean : array_like, optional\n    Mean of the distribution (default: `None`)\nrowcov : array_like, optional\n    Among-row covariance matrix of the distribution (default: `1`)\ncolcov : array_like, optional\n    Among-column covariance matrix of the distribution (default: `1`)\n'
...
_matnorm_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
matnorm_docdict_params = {'_matnorm_doc_default_callparams': _matnorm_doc_default_callparams, '_matnorm_doc_callparams_note': _matnorm_doc_callparams_note, '_doc_random_state': _doc_random_state}
matnorm_docdict_noparams = {'_matnorm_doc_default_callparams': _matnorm_doc_frozen_callparams, '_matnorm_doc_callparams_note': _matnorm_doc_frozen_callparams_note, '_doc_random_state': _doc_random_state}
...
_dirichlet_doc_default_callparams = 'alpha : array_like\n    The concentration parameters. The number of entries determines the\n    dimensionality of the distribution.\n'
_dirichlet_doc_frozen_callparams = ''
_dirichlet_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
dirichlet_docdict_params = {'_dirichlet_doc_default_callparams': _dirichlet_doc_default_callparams, '_doc_random_state': _doc_random_state}
dirichlet_docdict_noparams = {'_dirichlet_doc_default_callparams': _dirichlet_doc_frozen_callparams, '_doc_random_state': _doc_random_state}
...
_wishart_doc_default_callparams = 'df : int\n    Degrees of freedom, must be greater than or equal to dimension of the\n    scale matrix\nscale : array_like\n    Symmetric positive definite scale matrix of the distribution\n'
_wishart_doc_callparams_note = ''
_wishart_doc_frozen_callparams = ''
_wishart_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
wishart_docdict_params = {'_doc_default_callparams': _wishart_doc_default_callparams, '_doc_callparams_note': _wishart_doc_callparams_note, '_doc_random_state': _doc_random_state}
wishart_docdict_noparams = {'_doc_default_callparams': _wishart_doc_frozen_callparams, '_doc_callparams_note': _wishart_doc_frozen_callparams_note, '_doc_random_state': _doc_random_state}
...
for name in ['logpdf', 'pdf', 'mean', 'mode', 'var', 'rvs']:
    ...
    method_frozen.__doc__ = doccer.docformat(method.__doc__, wishart_docdict_noparams)
    method.__doc__ = doccer.docformat(method.__doc__, wishart_docdict_params)
_multinomial_doc_default_callparams = 'n : int\n    Number of trials\np : array_like\n    Probability of a trial falling into each category; should sum to 1\n'
_multinomial_doc_callparams_note = '`n` should be a nonnegative integer. Each element of `p` should be in the\ninterval :math:`[0,1]` and the elements should sum to 1. If they do not sum to\n1, the last element of the `p` array is not used and is replaced with the\nremaining probability left over from the earlier elements.\n'
_multinomial_doc_frozen_callparams = ''
_multinomial_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
multinomial_docdict_params = {'_doc_default_callparams': _multinomial_doc_default_callparams, '_doc_callparams_note': _multinomial_doc_callparams_note, '_doc_random_state': _doc_random_state}
multinomial_docdict_noparams = {'_doc_default_callparams': _multinomial_doc_frozen_callparams, '_doc_callparams_note': _multinomial_doc_frozen_callparams_note, '_doc_random_state': _doc_random_state}
...
_mhg_doc_default_callparams = 'm : array_like\n    The number of each type of object in the population.\n    That is, :math:`m[i]` is the number of objects of\n    type :math:`i`.\nn : array_like\n    The number of samples taken from the population.\n'
_mhg_doc_callparams_note = '`m` must be an array of positive integers. If the quantile\n:math:`i` contains values out of the range :math:`[0, m_i]`\nwhere :math:`m_i` is the number of objects of type :math:`i`\nin the population or if the parameters are inconsistent with one\nanother (e.g. ``x.sum() != n``), methods return the appropriate\nvalue (e.g. ``0`` for ``pmf``). If `m` or `n` contain negative\nvalues, the result will contain ``nan`` there.\n'
_mhg_doc_frozen_callparams = ''
_mhg_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
mhg_docdict_params = {'_doc_default_callparams': _mhg_doc_default_callparams, '_doc_callparams_note': _mhg_doc_callparams_note, '_doc_random_state': _doc_random_state}
mhg_docdict_noparams = {'_doc_default_callparams': _mhg_doc_frozen_callparams, '_doc_callparams_note': _mhg_doc_frozen_callparams_note, '_doc_random_state': _doc_random_state}
...
_ctab_doc_row_col = 'row : array_like\n    Sum of table entries in each row.\ncol : array_like\n    Sum of table entries in each column.'
_ctab_doc_x = 'x : array-like\n   Two-dimensional table of non-negative integers, or a\n   multi-dimensional array with the last two dimensions\n   corresponding with the tables.'
_ctab_doc_row_col_note = 'The row and column vectors must be one-dimensional, not empty,\nand each sum up to the same value. They cannot contain negative\nor noninteger entries.'
_ctab_doc_mean_params = f'\nParameters\n----------\n{_ctab_doc_row_col}'
_ctab_doc_row_col_note_frozen = 'See class definition for a detailed description of parameters.'
_ctab_docdict = {'_doc_random_state': _doc_random_state, '_doc_row_col': _ctab_doc_row_col, '_doc_x': _ctab_doc_x, '_doc_mean_params': _ctab_doc_mean_params, '_doc_row_col_note': _ctab_doc_row_col_note}
_ctab_docdict_frozen = _ctab_docdict.copy()
_ctab_docdict_frozen.update({'_doc_row_col': '', '_doc_mean_params': '', '_doc_row_col_note': _ctab_doc_row_col_note_frozen})
...
def _sample_uniform_direction(dim, size, random_state):
    ...
    return samples
_dirichlet_mn_doc_default_callparams = 'alpha : array_like\n    The concentration parameters. The number of entries along the last axis\n    determines the dimensionality of the distribution. Each entry must be\n    strictly positive.\nn : int or array_like\n    The number of trials. Each element must be a strictly positive integer.\n'
_dirichlet_mn_doc_frozen_callparams = ''
_dirichlet_mn_doc_frozen_callparams_note = 'See class definition for a detailed description of parameters.'
dirichlet_mn_docdict_params = {'_dirichlet_mn_doc_default_callparams': _dirichlet_mn_doc_default_callparams, '_doc_random_state': _doc_random_state}
dirichlet_mn_docdict_noparams = {'_dirichlet_mn_doc_default_callparams': _dirichlet_mn_doc_frozen_callparams, '_doc_random_state': _doc_random_state}
