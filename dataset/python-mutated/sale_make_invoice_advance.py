...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    advance_payment_method = fields.Selection([('delivered', 'Invoiceable lines'), ('all', 'Invoiceable lines (deduct down payments)'), ('percentage', 'Down payment (percentage)'), ('fixed', 'Down payment (fixed amount)')], string='What do you want to invoice?', default=_get_advance_payment_method, required=True)
    ...
    deposit_account_id = fields.Many2one('account.account', string='Income Account', domain=[('deprecated', '=', False)], help='Account used for deposits', default=_default_deposit_account_id)
