...
try:
    ...
    ScipModel = Generic
STATUS_MAP = {'optimal': s.OPTIMAL, 'timelimit': s.OPTIMAL_INACCURATE, 'gaplimit': s.OPTIMAL_INACCURATE, 'nodelimit': s.OPTIMAL_INACCURATE, 'totalnodelimit': s.OPTIMAL_INACCURATE, 'bestsollimit': s.USER_LIMIT, 'infeasible': s.INFEASIBLE, 'unbounded': s.UNBOUNDED, 'inforunbd': s.INFEASIBLE_OR_UNBOUNDED, 'userinterrupt': s.SOLVER_ERROR, 'memlimit': s.SOLVER_ERROR, 'sollimit': s.SOLVER_ERROR, 'stallnodelimit': s.SOLVER_ERROR, 'restartlimit': s.SOLVER_ERROR, 'unknown': s.SOLVER_ERROR}
