...
class ActiveBluetoothProcessorCoordinator(Generic[_T], PassiveBluetoothProcessorCoordinator[_T]):
    ...
    async def _async_poll(self) -> None:
        ...
        try:
            ...
            if self.last_poll_successful:
                self.logger.error('%s: Bluetooth error whilst polling: %s', self.address, str(exc))
