...
from ..utils import clean_html, clean_podcast_url, ExtractorError, int_or_none, str_or_none, try_get, url_or_none

class StitcherBaseIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://(?:www\\.)?stitcher\\.com/(?:podcast|show)/'
...
class StitcherIE(StitcherBaseIE):
    _VALID_URL = StitcherBaseIE._VALID_URL_BASE + '(?:[^/]+/)+e(?:pisode)?/(?:[^/#?&]+-)?(?P<id>\\d+)'
    _TESTS = [{'url': 'http://www.stitcher.com/podcast/the-talking-machines/e/40789481?autoplay=true', 'md5': 'e9635098e0da10b21a0e2b85585530f6', 'info_dict': {'id': '40789481', 'ext': 'mp3', 'title': 'Machine Learning Mastery and Cancer Clusters', 'description': 'md5:547adb4081864be114ae3831b4c2b42f', 'duration': 1604, 'thumbnail': 're:^https?://.*\\.jpg', 'upload_date': '20151008', 'timestamp': 1444285800, 'series': 'Talking Machines'}}, {'url': 'http://www.stitcher.com/podcast/panoply/vulture-tv/e/the-rare-hourlong-comedy-plus-40846275?autoplay=true', 'info_dict': {'id': '40846275', 'display_id': 'the-rare-hourlong-comedy-plus', 'ext': 'mp3', 'title': "The CW's 'Crazy Ex-Girlfriend'", 'description': 'md5:04f1e2f98eb3f5cbb094cea0f9e19b17', 'duration': 2235, 'thumbnail': 're:^https?://.*\\.jpg'}, 'params': {'skip_download': True}, 'skip': 'Page Not Found'}, {'url': 'http://www.stitcher.com/podcast/marketplace-on-stitcher/e/40910226?autoplay=true', 'only_matching': True}, {'url': 'http://www.stitcher.com/podcast/panoply/getting-in/e/episode-2a-how-many-extracurriculars-should-i-have-40876278?autoplay=true', 'only_matching': True}, {'url': 'https://www.stitcher.com/show/threedom/episode/circles-on-a-stick-200212584', 'only_matching': True}]
...
class StitcherShowIE(StitcherBaseIE):
    _VALID_URL = StitcherBaseIE._VALID_URL_BASE + '(?P<id>[^/#?&]+)/?(?:[?#&]|$)'
    _TESTS = [{'url': 'http://www.stitcher.com/podcast/the-talking-machines', 'info_dict': {'id': 'the-talking-machines', 'title': 'Talking Machines', 'description': 'md5:831f0995e40f26c10231af39cf1ebf0b'}, 'playlist_mincount': 106}, {'url': 'https://www.stitcher.com/show/the-talking-machines', 'only_matching': True}]
