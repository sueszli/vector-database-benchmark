...
from catalyst.contrib.utils.torch import outer_init
...
class LamaPooling(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: torch.Tensor=None) -> torch.Tensor:
        ...
        return x
__all__ = ['TemporalLastPooling', 'TemporalAvgPooling', 'TemporalMaxPooling', 'TemporalDropLastWrapper', 'TemporalAttentionPooling', 'TemporalConcatPooling', 'LamaPooling']