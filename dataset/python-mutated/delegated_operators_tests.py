...
from fiftyone.factory import DelegatedOperationPagingParams, SortDirection, SortByField
from fiftyone.operators.delegated import DelegatedOperationService
from fiftyone.operators.executor import ExecutionContext, ExecutionResult, ExecutionRunState, ExecutionProgress
...
@patch('fiftyone.operators.registry.OperatorRegistry.operator_exists', return_value=True)
@patch('fiftyone.operators.registry.OperatorRegistry.get_operator', return_value=MockOperator())
