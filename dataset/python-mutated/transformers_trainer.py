...
try:
    ...
    from ray.train.huggingface.transformers._transformers_utils import TrainReportCallback, process_datasets, wrap_transformers_trainer
...
TRANSFORMERS_TRAINER_DEPRECATION_MESSAGE = 'The TransformersTransformers will be hard deprecated in Ray 2.8. Use TorchTrainer instead. See https://docs.ray.io/en/releases-2.7.0/train/getting-started-transformers.html#transformerstrainer-migration-guide for more details.'
...
class TransformersTrainer(TorchTrainer):
    ...
    documentation <https://huggingface.co/docs/transformers/main/en/main_classes/trainer#transformers.TrainingArguments>`__.
