...
from Orange.widgets.data.owfeatureconstructor import DiscreteDescriptor, ContinuousDescriptor, StringDescriptor, construct_variables, OWFeatureConstructor, FeatureEditor, DiscreteFeatureEditor, FeatureConstructorHandler, DateTimeDescriptor, StringFeatureEditor
from Orange.widgets.data.owfeatureconstructor import freevars, validate_exp, FeatureFunc
