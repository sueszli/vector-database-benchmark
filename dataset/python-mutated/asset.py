...
__all__ = ['AssetViewSet', 'AssetTaskCreateApi', 'AssetsTaskCreateApi', 'AssetFilterSet']
...
class AssetFilterSet(BaseFilterSet):
    ...
    domain_enabled = django_filters.BooleanFilter(field_name='platform__domain_enabled', lookup_expr='exact')
    ping_enabled = django_filters.BooleanFilter(field_name='platform__automation__ping_enabled', lookup_expr='exact')
    gather_facts_enabled = django_filters.BooleanFilter(field_name='platform__automation__gather_facts_enabled', lookup_expr='exact')
    change_secret_enabled = django_filters.BooleanFilter(field_name='platform__automation__change_secret_enabled', lookup_expr='exact')
    push_account_enabled = django_filters.BooleanFilter(field_name='platform__automation__push_account_enabled', lookup_expr='exact')
    verify_account_enabled = django_filters.BooleanFilter(field_name='platform__automation__verify_account_enabled', lookup_expr='exact')
    gather_accounts_enabled = django_filters.BooleanFilter(field_name='platform__automation__gather_accounts_enabled', lookup_expr='exact')

    class Meta:
        model = Asset
        fields = ['id', 'name', 'address', 'is_active', 'labels', 'type', 'category', 'platform']
...
class AssetViewSet(SuggestionMixin, NodeFilterMixin, OrgBulkModelViewSet):
    ...
    serializer_classes = (('default', serializers.AssetSerializer), ('platform', serializers.PlatformSerializer), ('suggestion', serializers.MiniAssetSerializer), ('gateways', serializers.GatewaySerializer))
    rbac_perms = (('match', 'assets.match_asset'), ('platform', 'assets.view_platform'), ('gateways', 'assets.view_gateway'), ('spec_info', 'assets.view_asset'), ('gathered_info', 'assets.view_asset'), ('sync_platform_protocols', 'assets.change_asset'))
    extra_filter_backends = [LabelFilterBackend, IpInFilterBackend, NodeFilterBackend, AttrRulesFilterBackend]
