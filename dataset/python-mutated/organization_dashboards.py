...
MAX_RETRIES = 10
DUPLICATE_TITLE_PATTERN = '(.*) copy(?:$|\\s(\\d+))'

class OrganizationDashboardsPermission(OrganizationPermission):
    scope_map = {'GET': ['org:read', 'org:write', 'org:admin'], 'POST': ['org:read', 'org:write', 'org:admin'], 'PUT': ['org:read', 'org:write', 'org:admin'], 'DELETE': ['org:read', 'org:write', 'org:admin']}
