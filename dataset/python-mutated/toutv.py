...
class TouTvIE(RadioCanadaIE):
    ...
    _TESTS = [{'url': 'http://ici.tou.tv/garfield-tout-court/S2015E17', 'info_dict': {'id': '122017', 'ext': 'mp4', 'title': 'Saison 2015 Épisode 17', 'description': 'La photo de famille 2', 'upload_date': '20100717'}, 'params': {'skip_download': True}, 'skip': '404 Not Found'}, {'url': 'http://ici.tou.tv/hackers', 'only_matching': True}, {'url': 'https://ici.tou.tv/l-age-adulte/S01C501', 'only_matching': True}]
