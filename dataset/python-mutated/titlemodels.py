...
class Title(models.Model):
    editable_fields = ['title', 'slug', 'redirect', 'page_title', 'menu_title', 'meta_description', 'has_url_overwrite']
    ...
    meta_description = models.TextField(_('description'), blank=True, null=True, help_text=_('The text displayed in search engines.'))
