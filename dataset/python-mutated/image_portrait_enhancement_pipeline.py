...
from modelscope.models.cv.image_portrait_enhancement.align_faces import get_reference_facial_points, warp_and_crop_face
...
@PIPELINES.register_module(Tasks.image_portrait_enhancement, module_name=Pipelines.image_portrait_enhancement)
