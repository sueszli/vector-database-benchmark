...
from ..utils import clean_html, get_element_by_class, get_elements_by_class, join_nonempty, traverse_obj, unified_timestamp, urljoin

class CamFMShowIE(InfoExtractor):
    _VALID_URL = 'https://(?:www\\.)?camfm\\.co\\.uk/shows/(?P<id>[^/]+)'
    _TESTS = [{'playlist_mincount': 5, 'url': 'https://camfm.co.uk/shows/soul-mining/', 'info_dict': {'id': 'soul-mining', 'thumbnail': 'md5:6a873091f92c936f23bdcce80f75e66a', 'title': 'Soul Mining', 'description': 'Telling the stories of jazz, funk and soul from all corners of the world.'}}]
