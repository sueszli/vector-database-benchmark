...
class TestModulatedDeformableConvOp(OpTest):
    ...
    def setUp(self):
        ...
        self.inputs = {'Input': OpTest.np_dtype_to_base_dtype(input), 'Offset': OpTest.np_dtype_to_base_dtype(offset), 'Filter': OpTest.np_dtype_to_base_dtype(filter)}
    ...
    def test_check_grad(self):
        if False:
            return 10
        self.check_grad(['Input', 'Offset', 'Filter'], 'Output', max_relative_error=0.05)

    def test_check_grad_no_filter(self):
        if False:
            while True:
                i = 10
        self.check_grad(['Input', 'Offset'], 'Output', max_relative_error=0.1, no_grad_set={'Filter'})
