...
class ThermalZone(base.ThreadPoolText):
    ...
    defaults = [('update_interval', 2.0, 'Update interval'), ('zone', '/sys/class/thermal/thermal_zone0/temp', 'Thermal zone'), ('format', '{temp}°C', 'Display format'), ('format_crit', '{temp}°C CRIT!', 'Critical display format'), ('hidden', False, 'Set True to only show if critical value reached'), ('fgcolor_crit', 'ff0000', 'Font color on critical values'), ('fgcolor_high', 'ffaa00', 'Font color on high values'), ('fgcolor_normal', 'ffffff', 'Font color on normal values'), ('crit', 70, 'Critical temperature level'), ('high', 50, 'High themperature level')]
