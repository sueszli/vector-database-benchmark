...
from ..utils import xpath_text, parse_duration, ExtractorError

class EyedoTVIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?eyedo\\.tv/[^/]+/(?:#!/)?Live/Detail/(?P<id>[0-9]+)'
    _TEST = {'url': 'https://www.eyedo.tv/en-US/#!/Live/Detail/16301', 'md5': 'ba14f17995cdfc20c36ba40e21bf73f7', 'info_dict': {'id': '16301', 'ext': 'mp4', 'title': "Journée du conseil scientifique de l'Afnic 2015", 'description': 'md5:4abe07293b2f73efc6e1c37028d58c98', 'uploader': 'Afnic Live', 'uploader_id': '8023'}}
