...
from ..utils import get_element_by_id, clean_html, ExtractorError, InAdvancePagedList, remove_start

class KuwoBaseIE(InfoExtractor):
    _FORMATS = [{'format': 'ape', 'ext': 'ape', 'preference': 100}, {'format': 'mp3-320', 'ext': 'mp3', 'br': '320kmp3', 'abr': 320, 'preference': 80}, {'format': 'mp3-192', 'ext': 'mp3', 'br': '192kmp3', 'abr': 192, 'preference': 70}, {'format': 'mp3-128', 'ext': 'mp3', 'br': '128kmp3', 'abr': 128, 'preference': 60}, {'format': 'wma', 'ext': 'wma', 'preference': 20}, {'format': 'aac', 'ext': 'aac', 'abr': 48, 'preference': 10}]
...
class KuwoAlbumIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.kuwo.cn/album/502294/', 'info_dict': {'id': '502294', 'title': 'Made\xa0Series\xa0《M》', 'description': 'md5:d463f0d8a0ff3c3ea3d6ed7452a9483f'}, 'playlist_count': 2}
...
class KuwoChartIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://yinyue.kuwo.cn/billboard_香港中文龙虎榜.htm', 'info_dict': {'id': '香港中文龙虎榜'}, 'playlist_mincount': 7}
...
class KuwoSingerIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.kuwo.cn/mingxing/bruno+mars/', 'info_dict': {'id': 'bruno+mars', 'title': 'Bruno\xa0Mars'}, 'playlist_mincount': 329}, {'url': 'http://www.kuwo.cn/mingxing/Ali/music.htm', 'info_dict': {'id': 'Ali', 'title': 'Ali'}, 'playlist_mincount': 95, 'skip': 'Regularly stalls travis build'}]
    PAGE_SIZE = 15
...
class KuwoCategoryIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://yinyue.kuwo.cn/yy/cinfo_86375.htm', 'info_dict': {'id': '86375', 'title': '八十年代精选', 'description': '这些都是属于八十年代的回忆！'}, 'playlist_mincount': 24}
...
class KuwoMvIE(KuwoBaseIE):
    ...
    _TEST = {'url': 'http://www.kuwo.cn/mv/6480076/', 'info_dict': {'id': '6480076', 'ext': 'mp4', 'title': 'My HouseMV', 'creator': '2PM'}, 'params': {'format': 'mv'}}
    _FORMATS = KuwoBaseIE._FORMATS + [{'format': 'mkv', 'ext': 'mkv', 'preference': 250}, {'format': 'mp4', 'ext': 'mp4', 'preference': 200}]
