...
from sentry.db.models import ArrayField, FlexibleForeignKey, Model, region_silo_only_model, sane_repr
...
class OrgAuthTokenReplica(Model):
    ...
    created_by_id = HybridCloudForeignKey('sentry.User', null=True, blank=True, on_delete='set_null')
