...
from Orange.widgets.utils.filedialogs import RecentPathsWComboMixin, RecentPath, stored_recent_paths_prepend
...
class OWDistanceFile(widget.OWWidget, RecentPathsWComboMixin):
    ...
    class Error(widget.OWWidget.Error):
        ...
        non_square_matrix = Msg('Matrix is not square. Reformat the file and use the File widget to read it.')
