...
keras.utils.get_file(os.path.join(os.getcwd(), 'data.tar.gz'), 'https://data.keithito.com/data/speech/LJSpeech-1.1.tar.bz2', extract=True, archive_format='tar', cache_dir='.')
...
learning_rate = CustomSchedule(init_lr=1e-05, lr_after_warmup=0.001, final_lr=1e-05, warmup_epochs=15, decay_epochs=85, steps_per_epoch=len(ds))
