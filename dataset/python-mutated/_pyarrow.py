...
def _to_string_dtype(df, dtype_check, index_check, string_dtype):
    ...
    return df
to_pyarrow_string = partial(_to_string_dtype, dtype_check=is_object_string_dtype, index_check=is_object_string_index, string_dtype='pyarrow')
to_object_string = partial(_to_string_dtype, dtype_check=is_pyarrow_string_dtype, index_check=is_pyarrow_string_index, string_dtype=object)
