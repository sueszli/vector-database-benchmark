...
class EagerTest(_fixtures.FixtureTest, testing.AssertsCompiledSQL):
    ...
    _pathing_runs = [('lazyload', 'lazyload', 'lazyload', 15), ('selectinload', 'lazyload', 'lazyload', 12), ('selectinload', 'selectinload', 'lazyload', 8), ('joinedload', 'selectinload', 'lazyload', 7), ('lazyload', 'lazyload', 'selectinload', 12), ('selectinload', 'selectinload', 'selectinload', 4), ('selectinload', 'selectinload', 'joinedload', 3)]
...
class SelfRefInheritanceAliasedTest(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    __dialect__ = 'default'
...
class SingleInhSubclassTest(fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
...
class MissingForeignTest(fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
...
class M2OWDegradeTest(fixtures.DeclarativeMappedTest, testing.AssertsExecutionResults):
