...
class TestSchedulerModule:
    test_merged_scheduler_config = dict(schedule_flag=False, schedule_mode='reduce', factor=0.05, change_range=[-1, 1], threshold=0.0001, optimize_mode='min', patience=1, cooldown=0)
