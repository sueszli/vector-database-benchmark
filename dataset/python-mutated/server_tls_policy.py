...
__protobuf__ = proto.module(package='google.cloud.networksecurity.v1', manifest={'ServerTlsPolicy', 'ListServerTlsPoliciesRequest', 'ListServerTlsPoliciesResponse', 'GetServerTlsPolicyRequest', 'CreateServerTlsPolicyRequest', 'UpdateServerTlsPolicyRequest', 'DeleteServerTlsPolicyRequest'})

class ServerTlsPolicy(proto.Message):
    """ServerTlsPolicy is a resource that specifies how a server
    ...
    class MTLSPolicy(proto.Message):
        ...
        """
        client_validation_ca: MutableSequence[tls.ValidationCA] = proto.RepeatedField(proto.MESSAGE, number=1, message=tls.ValidationCA)
    ...
    allow_open: bool = proto.Field(proto.BOOL, number=6)
    server_certificate: tls.CertificateProvider = proto.Field(proto.MESSAGE, number=7, message=tls.CertificateProvider)
    mtls_policy: MTLSPolicy = proto.Field(proto.MESSAGE, number=8, message=MTLSPolicy)
...
class ListServerTlsPoliciesResponse(proto.Message):
    ...
    Attributes:
        server_tls_policies (MutableSequence[google.cloud.network_security_v1.types.ServerTlsPolicy]):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    server_tls_policies: MutableSequence['ServerTlsPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ServerTlsPolicy')
...
class CreateServerTlsPolicyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    server_tls_policy_id: str = proto.Field(proto.STRING, number=2)
    server_tls_policy: 'ServerTlsPolicy' = proto.Field(proto.MESSAGE, number=3, message='ServerTlsPolicy')
...
class UpdateServerTlsPolicyRequest(proto.Message):
    ...
    server_tls_policy: 'ServerTlsPolicy' = proto.Field(proto.MESSAGE, number=2, message='ServerTlsPolicy')
