...
from google.cloud.compute_v1.services.firewalls import FirewallsClient, pagers, transports
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.FirewallsRestTransport, 'rest')])
...
def test_firewalls_client_get_transport_class():
    ...
    available_transports = [transports.FirewallsRestTransport]
    assert transport in available_transports
    transport = FirewallsClient.get_transport_class('rest')
    assert transport == transports.FirewallsRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(FirewallsClient, transports.FirewallsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(FirewallsClient, transports.FirewallsRestTransport, 'rest', 'true'), (FirewallsClient, transports.FirewallsRestTransport, 'rest', 'false')])
@mock.patch.object(FirewallsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(FirewallsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(FirewallsClient, transports.FirewallsRestTransport, 'rest', None)])
def test_firewalls_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    if False:
        return 10
...
def test_delete_rest(request_type):
    if False:
        i = 10
        return i + 15
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_delete_rest_unset_required_fields():
    if False:
        for i in range(10):
            print('nop')
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_delete_rest_interceptors(null_interceptor):
    if False:
        while True:
            i = 10
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_delete') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_delete') as pre:
...
def test_delete_rest_bad_request(transport: str='rest', request_type=compute.DeleteFirewallRequest):
    if False:
        print('Hello World!')
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'firewall': 'sample2'}
    request = request_type(**request_init)
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewalls/{firewall}' % client.transport._host, args[1])
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteFirewallRequest(), project='project_value', firewall='firewall_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteFirewallRequest(), project='project_value', firewall='firewall_value')
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_get') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetFirewallRequest(), project='project_value', firewall='firewall_value')
...
def test_insert_rest(request_type):
    ...
    test_field = compute.InsertFirewallRequest.meta.fields['firewall_resource']
    ...
    for (field, value) in request_init['firewall_resource'].items():
        result = None
        is_repeated = False
    ...
    for subfield_to_delete in subfields_not_in_runtime:
        ...
        if subfield:
            if field_repeated:
                for i in range(0, len(request_init['firewall_resource'][field])):
                    del request_init['firewall_resource'][field][i][subfield]
            else:
                del request_init['firewall_resource'][field][subfield]
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation(client_operation_id='client_operation_id_value', creation_timestamp='creation_timestamp_value', description='description_value', end_time='end_time_value', http_error_message='http_error_message_value', http_error_status_code=2374, id=205, insert_time='insert_time_value', kind='kind_value', name='name_value', operation_group_id='operation_group_id_value', operation_type='operation_type_value', progress=885, region='region_value', self_link='self_link_value', start_time='start_time_value', status=compute.Operation.Status.DONE, status_message='status_message_value', target_id=947, target_link='target_link_value', user='user_value', zone='zone_value')
        response_value = Response()
...
def test_insert_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('firewallResource', 'project'))
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_insert') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
        ...
        assert len(req.mock_calls) == 1
        (_, args, _) = req.mock_calls[0]
        assert path_template.validate('%s/compute/v1/projects/{project}/global/firewalls' % client.transport._host, args[1])
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertFirewallRequest(), project='project_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertFirewallRequest(), project='project_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_list_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.FirewallList(id='id_value', kind='kind_value', next_page_token='next_page_token_value', self_link='self_link_value')
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.FirewallList.pb(return_value)
        json_return_value = json_format.MessageToJson(return_value)
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_list') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListFirewallsRequest(), project='project_value')
...
def test_list_rest_pager(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (compute.FirewallList(items=[compute.Firewall(), compute.Firewall(), compute.Firewall()], next_page_token='abc'), compute.FirewallList(items=[], next_page_token='def'), compute.FirewallList(items=[compute.Firewall()], next_page_token='ghi'), compute.FirewallList(items=[compute.Firewall(), compute.Firewall()]))
...
def test_patch_rest(request_type):
    ...
    request_init = {'project': 'sample1', 'firewall': 'sample2'}
    request_init['firewall_resource'] = {'allowed': [{'I_p_protocol': 'I_p_protocol_value', 'ports': ['ports_value1', 'ports_value2']}], 'creation_timestamp': 'creation_timestamp_value', 'denied': [{'I_p_protocol': 'I_p_protocol_value', 'ports': ['ports_value1', 'ports_value2']}], 'description': 'description_value', 'destination_ranges': ['destination_ranges_value1', 'destination_ranges_value2'], 'direction': 'direction_value', 'disabled': True, 'id': 205, 'kind': 'kind_value', 'log_config': {'enable': True, 'metadata': 'metadata_value'}, 'name': 'name_value', 'network': 'network_value', 'priority': 898, 'self_link': 'self_link_value', 'source_ranges': ['source_ranges_value1', 'source_ranges_value2'], 'source_service_accounts': ['source_service_accounts_value1', 'source_service_accounts_value2'], 'source_tags': ['source_tags_value1', 'source_tags_value2'], 'target_service_accounts': ['target_service_accounts_value1', 'target_service_accounts_value2'], 'target_tags': ['target_tags_value1', 'target_tags_value2']}
    test_field = compute.PatchFirewallRequest.meta.fields['firewall_resource']
...
def test_patch_rest_unset_required_fields():
    ...
    assert set(unset_fields) == set(('requestId',)) & set(('firewall', 'firewallResource', 'project'))
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_patch') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'firewall': 'sample2'}
        mock_args = dict(project='project_value', firewall='firewall_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchFirewallRequest(), project='project_value', firewall='firewall_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchFirewallRequest(), project='project_value', firewall='firewall_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_update_rest(request_type):
    ...
    request_init = {'project': 'sample1', 'firewall': 'sample2'}
    request_init['firewall_resource'] = {'allowed': [{'I_p_protocol': 'I_p_protocol_value', 'ports': ['ports_value1', 'ports_value2']}], 'creation_timestamp': 'creation_timestamp_value', 'denied': [{'I_p_protocol': 'I_p_protocol_value', 'ports': ['ports_value1', 'ports_value2']}], 'description': 'description_value', 'destination_ranges': ['destination_ranges_value1', 'destination_ranges_value2'], 'direction': 'direction_value', 'disabled': True, 'id': 205, 'kind': 'kind_value', 'log_config': {'enable': True, 'metadata': 'metadata_value'}, 'name': 'name_value', 'network': 'network_value', 'priority': 898, 'self_link': 'self_link_value', 'source_ranges': ['source_ranges_value1', 'source_ranges_value2'], 'source_service_accounts': ['source_service_accounts_value1', 'source_service_accounts_value2'], 'source_tags': ['source_tags_value1', 'source_tags_value2'], 'target_service_accounts': ['target_service_accounts_value1', 'target_service_accounts_value2'], 'target_tags': ['target_tags_value1', 'target_tags_value2']}
    test_field = compute.UpdateFirewallRequest.meta.fields['firewall_resource']
...
def test_update_rest_interceptors(null_interceptor):
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.FirewallsRestInterceptor())
    client = FirewallsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.FirewallsRestInterceptor, 'post_update') as post, mock.patch.object(transports.FirewallsRestInterceptor, 'pre_update') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update(compute.UpdateFirewallRequest(), project='project_value', firewall='firewall_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_update_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_unary(compute.UpdateFirewallRequest(), project='project_value', firewall='firewall_value', firewall_resource=compute.Firewall(allowed=[compute.Allowed(I_p_protocol='I_p_protocol_value')]))
...
def test_credentials_transport_error():
    ...
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = FirewallsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = FirewallsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.FirewallsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = FirewallsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_kind(transport_name):
    if False:
        for i in range(10):
            print('nop')
    transport = FirewallsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_firewalls_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.FirewallsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_firewalls_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.firewalls.transports.FirewallsTransport.__init__') as Transport:
        ...
        transport = transports.FirewallsTransport(credentials=ga_credentials.AnonymousCredentials())
...
def test_firewalls_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.firewalls.transports.FirewallsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.FirewallsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_firewalls_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.FirewallsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_firewalls_host_no_port(transport_name):
    if False:
        print('Hello World!')
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_firewalls_host_with_port(transport_name):
    if False:
        i = 10
        return i + 15
    client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
@pytest.mark.parametrize('transport_name', ['rest'])
def test_firewalls_client_transport_session_collision(transport_name):
    if False:
        print('Hello World!')
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = FirewallsClient(credentials=creds1, transport=transport_name)
    client2 = FirewallsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.FirewallsTransport, '_prep_wrapped_messages') as prep:
        client = FirewallsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(FirewallsClient, transports.FirewallsRestTransport)])
