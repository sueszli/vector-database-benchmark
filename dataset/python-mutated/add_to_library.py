...
class AddToLibraryAction(InterfaceAction):
    name = 'Add To Library'
    action_spec = (_('Add books to library'), 'add_book.png', _('Add books to your calibre library from the connected device'), ())
    ...
    def add_books_to_library(self, *args):
        if False:
            return 10
        self.gui.iactions['Add Books'].add_books_from_device(self.gui.current_view())