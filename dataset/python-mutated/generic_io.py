...
IO_CLASS_MAP = {SinkType.BIGQUERY: {'class_name': 'BigQuery'}, SinkType.CLICKHOUSE: {'class_name': 'ClickHouse'}, SinkType.DUCKDB: {'class_name': 'DuckDB'}, SinkType.MYSQL: {'class_name': 'MySQL'}, SinkType.MSSQL: {'class_name': 'MSSQL'}}
