...
class LogFactory:
    ...
    PRIMARY_COLORS = {'DEBUG': 'bold,black,bg_white', 'INFO': 'black,bg_white', 'WARNING': 'red,bg_yellow', 'ERROR': 'bold,white,bg_red', 'CRITICAL': 'bold,white,bg_black'}
    SECONDARY_COLORS = {'badge': {'DEBUG': 'bold,white,bg_cyan', 'INFO': 'bold,white,bg_green', 'WARNING': 'bold,white,bg_yellow', 'ERROR': 'bold,white,bg_red', 'CRITICAL': 'bold,white,bg_black'}, 'exc': {'ERROR': 'bold,black,bg_white', 'CRITICAL': 'bold,black,bg_white'}}
