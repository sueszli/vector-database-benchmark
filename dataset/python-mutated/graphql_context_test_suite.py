...
from dagster._core.workspace.load_target import GrpcServerTarget, ModuleTarget, PythonFileTarget, WorkspaceFileTarget
...
ReadonlyGraphQLContextTestMatrix = make_graphql_context_test_suite(context_variants=GraphQLContextVariant.all_readonly_variants())
NonLaunchableGraphQLContextTestMatrix = make_graphql_context_test_suite(context_variants=GraphQLContextVariant.all_non_launchable_variants())
ExecutingGraphQLContextTestMatrix = make_graphql_context_test_suite(context_variants=GraphQLContextVariant.all_executing_variants())
all_repos_loadable_target = LoadableTargetOrigin(executable_path=sys.executable, python_file=file_relative_path(__file__, 'cross_repo_asset_deps.py'))
AllRepositoryGraphQLContextTestMatrix = make_graphql_context_test_suite(context_variants=GraphQLContextVariant.all_executing_variants(target=all_repos_loadable_target, location_name='cross_asset_repos'))