...
from ..utils import ExtractorError, int_or_none, strip_or_none, str_or_none, traverse_obj, unified_timestamp
...
class KakaoIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://tv.kakao.com/channel/2671005/cliplink/301965083', 'md5': '702b2fbdeb51ad82f5c904e8c0766340', 'info_dict': {'id': '301965083', 'ext': 'mp4', 'title': '乃木坂46 バナナマン 「3期生紹介コーナーが始動！顔高低差GPも！」 『乃木坂工事中』', 'description': '', 'uploader_id': '2671005', 'uploader': '그랑그랑이', 'timestamp': 1488160199, 'upload_date': '20170227', 'like_count': int, 'thumbnail': 're:http://.+/thumb\\.png', 'tags': ['乃木坂'], 'view_count': int, 'duration': 1503, 'comment_count': int}}, {'url': 'http://tv.kakao.com/channel/2653210/cliplink/300103180', 'md5': 'a8917742069a4dd442516b86e7d66529', 'info_dict': {'id': '300103180', 'ext': 'mp4', 'description': '러블리즈 - Destiny (나의 지구) (Lovelyz - Destiny)\r\n\r\n[쇼! 음악중심] 20160611, 507회', 'title': '러블리즈 - Destiny (나의 지구) (Lovelyz - Destiny)', 'uploader_id': '2653210', 'uploader': '쇼! 음악중심', 'timestamp': 1485684628, 'upload_date': '20170129', 'like_count': int, 'thumbnail': 're:http://.+/thumb\\.png', 'tags': 'count:28', 'view_count': int, 'duration': 184, 'comment_count': int}}, {'url': 'https://tv.kakao.com/channel/3643855/cliplink/412069491', 'only_matching': True}]
