...
from samcli.lib.utils.resource_trigger import CodeResourceTrigger, DefinitionCodeTrigger, LambdaImageCodeTrigger, LambdaLayerCodeTrigger, LambdaZipCodeTrigger
