...
class SetGameScore(TelegramMethod[Union[Message, bool]]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, user_id: int, score: int, force: Optional[bool]=None, disable_edit_message: Optional[bool]=None, chat_id: Optional[int]=None, message_id: Optional[int]=None, inline_message_id: Optional[str]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                i = 10
                return i + 15
            super().__init__(user_id=user_id, score=score, force=force, disable_edit_message=disable_edit_message, chat_id=chat_id, message_id=message_id, inline_message_id=inline_message_id, **__pydantic_kwargs)