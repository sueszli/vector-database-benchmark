...
import jinja2
import yaml
sys.path.append(str(pathlib.Path(__file__).parents[3].joinpath('operators/generator')))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--api_prim_yaml_path', type=str, help='Primitive API yaml file..')
    parser.add_argument('--api_phi_yaml_path', type=str, help='Parsed ops yaml file.')
    parser.add_argument('--api_phi_legacy_yaml_path', type=str, help='Parsed ops yaml file.')
    parser.add_argument('--api_compat_yaml_path', type=str, help='Ops args compat yaml file.')
    parser.add_argument('--api_version_yaml_path', type=str, help='Ops version yaml file.')
    parser.add_argument('--template_path', type=str, help='JinJa2 template file Path.')
    parser.add_argument('--output_path', type=str, help='Output path.')
    args = parser.parse_args()
    generate(args.api_prim_yaml_path, args.api_phi_yaml_path, args.api_phi_legacy_yaml_path, args.api_compat_yaml_path, args.api_version_yaml_path, args.template_path, args.output_path)