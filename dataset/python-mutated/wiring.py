...
from typing import Optional, Iterable, Iterator, Callable, Any, Tuple, Dict, Generic, TypeVar, Type, Union, Set, cast
...
if sys.version_info[:2] == (3, 5):
    warnings.warn('Dependency Injector will drop support of Python 3.5 after Jan 1st of 2022. This does not mean that there will be any immediate breaking changes, but tests will no longer be executed on Python 3.5, and bugs will not be addressed.', category=DeprecationWarning)
__all__ = ('wire', 'unwire', 'inject', 'as_int', 'as_float', 'as_', 'required', 'invariant', 'provided', 'Provide', 'Provider', 'Closing', 'register_loader_containers', 'unregister_loader_containers', 'install_loader', 'uninstall_loader', 'is_loader_installed')
T = TypeVar('T')
...
class PatchedCallable:
    __slots__ = ('patched', 'original', 'reference_injections', 'injections', 'reference_closing', 'closing')
...
from ._cwiring import _async_inject
