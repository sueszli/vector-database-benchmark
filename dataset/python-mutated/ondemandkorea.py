...
from ..utils import ExtractorError, OnDemandPagedList, float_or_none, int_or_none, join_nonempty, parse_age_limit, parse_qs, unified_strdate, url_or_none
from ..utils.traversal import traverse_obj

class OnDemandKoreaIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?ondemandkorea\\.com/(?:en/)?player/vod/[a-z0-9-]+\\?(?:[^#]+&)?contentId=(?P<id>\\d+)'
    _GEO_COUNTRIES = ['US', 'CA']
    _TESTS = [{'url': 'https://www.ondemandkorea.com/player/vod/ask-us-anything?contentId=686471', 'md5': 'e2ff77255d989e3135bde0c5889fbce8', 'info_dict': {'id': '686471', 'ext': 'mp4', 'title': 'Ask Us Anything: Jung Sung-ho, Park Seul-gi, Kim Bo-min, Yang Seung-won', 'thumbnail': 're:^https?://.*\\.(jpg|jpeg|png)', 'duration': 5486.955, 'release_date': '20220924', 'series': 'Ask Us Anything', 'series_id': 11790, 'episode_number': 351, 'episode': 'Jung Sung-ho, Park Seul-gi, Kim Bo-min, Yang Seung-won'}}, {'url': 'https://www.ondemandkorea.com/player/vod/breakup-probation-a-week?contentId=1595796', 'md5': '57266c720006962be7ff415b24775caa', 'info_dict': {'id': '1595796', 'ext': 'mp4', 'title': 'Breakup Probation, A Week: E08', 'thumbnail': 're:^https?://.*\\.(jpg|jpeg|png)', 'duration': 1586.0, 'release_date': '20231001', 'series': 'Breakup Probation, A Week', 'series_id': 22912, 'episode_number': 8, 'episode': 'E08'}}, {'url': 'https://www.ondemandkorea.com/player/vod/the-outlaws?contentId=369531', 'md5': 'fa5523b87aa1f6d74fc622a97f2b47cd', 'info_dict': {'id': '369531', 'ext': 'mp4', 'release_date': '20220519', 'duration': 7267.0, 'title': 'The Outlaws: Main Movie', 'thumbnail': 're:^https?://.*\\.(jpg|jpeg|png)', 'age_limit': 18}}, {'url': 'https://www.ondemandkorea.com/en/player/vod/capture-the-moment-how-is-that-possible?contentId=1605006', 'only_matching': True}]
...
class OnDemandKoreaProgramIE(InfoExtractor):
    ...
    _GEO_COUNTRIES = ['US', 'CA']
    _TESTS = [{'url': 'https://www.ondemandkorea.com/player/vod/uskn-news', 'info_dict': {'id': 'uskn-news'}, 'playlist_mincount': 755}, {'url': 'https://www.ondemandkorea.com/en/player/vod/the-land', 'info_dict': {'id': 'the-land'}, 'playlist_count': 52}]
    _PAGE_SIZE = 100
