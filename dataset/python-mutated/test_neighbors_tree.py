...
from sklearn.neighbors._ball_tree import BallTree, kernel_norm
...
from sklearn.neighbors._ball_tree import simultaneous_sort as simultaneous_sort_bt
...
from sklearn.neighbors._kd_tree import simultaneous_sort as simultaneous_sort_kdt
from sklearn.utils import check_random_state
rng = np.random.RandomState(42)
V_mahalanobis = rng.rand(3, 3)
V_mahalanobis = np.dot(V_mahalanobis, V_mahalanobis.T)
DIMENSION = 3
METRICS = {'euclidean': {}, 'manhattan': {}, 'minkowski': dict(p=3), 'chebyshev': {}, 'seuclidean': dict(V=rng.random_sample(DIMENSION)), 'mahalanobis': dict(V=V_mahalanobis)}
