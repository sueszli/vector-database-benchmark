...
from flet_core.types import AnimationValue, BorderRadiusValue, OffsetValue, PaddingValue, ResponsiveNumber, RotateValue, ScaleValue, TextAlign, TextAlignString
try:
    from typing import Literal
except ImportError:
    from typing_extensions import Literal
KeyboardTypeString = Literal[None, 'text', 'multiline', 'number', 'phone', 'datetime', 'email', 'url', 'visiblePassword', 'name', 'streetAddress', 'none']
