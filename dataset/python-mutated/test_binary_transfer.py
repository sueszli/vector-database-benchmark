...
EXAMPLE_INPUT = [{'layer_id': 'a', 'accessor': 'getPosition', 'np_data': np.array([1, 2, 3], dtype='int64'), 'dtype': 'int64', 'size': (3,)}, {'layer_id': 'a', 'accessor': 'getFillColor', 'np_data': np.stack([[11, 22, 33], [44, 55, 0], [255, 20.0, 0]]), 'dtype': 'float64', 'size': (3, 3)}, {'layer_id': 'a', 'accessor': 'getRadius', 'np_data': np.array([0, 0, 1], dtype='uint32'), 'dtype': 'uint32', 'size': (3,)}, {'layer_id': 'b', 'accessor': 'getPosition', 'np_data': np.array([0, 0, 1], dtype='uint32'), 'dtype': 'uint32', 'size': (3,)}, {'layer_id': 'b', 'accessor': 'getRadius', 'np_data': np.stack([[11, 22, 33], [44, 55, 0], [255, 20.0, 0]]), 'dtype': 'float64', 'size': (3, 3)}]
EXPECTED_OUTPUT = {'a': {'length': 3, 'attributes': {'getPosition': {'value': memoryview(np.array([1, 2, 3])), 'dtype': 'int64', 'size': 1}, 'getFillColor': {'value': memoryview(np.stack([[11, 22, 33], [44, 55, 0], [255, 20.0, 0]])), 'dtype': 'float64', 'size': 3}, 'getRadius': {'value': memoryview(np.array([0, 0, 1], dtype='uint32')), 'dtype': 'uint32', 'size': 1}}}, 'b': {'length': 3, 'attributes': {'getPosition': {'value': memoryview(np.array([0, 0, 1], dtype='uint32')), 'dtype': 'uint32', 'size': 1}, 'getRadius': {'value': memoryview(np.stack([[11, 22, 33], [44, 55, 0], [255, 20.0, 0]])), 'dtype': 'float64', 'size': 3}}}}
