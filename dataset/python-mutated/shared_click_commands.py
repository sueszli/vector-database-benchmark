import pathlib
import click
DEFAULT_SETTINGS_FILE = str(pathlib.Path('~/auto-gpt/default_agent_settings.yml').expanduser())

@click.command()
@click.option('--settings-file', type=click.Path(), default=DEFAULT_SETTINGS_FILE)
