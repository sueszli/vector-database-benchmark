...
LICENSE_EXPIRED_MESSAGE = 'Subscription expired.\nContact us (https://www.redhat.com/contact) for subscription extension information.'
LICENSE_NON_EXISTANT_MESSAGE = 'No subscription.\nContact us (https://www.redhat.com/contact) for subscription information.'
LICENSE_MESSAGE = '%(new_count)d instances have been automated, system is subscribed for %(instance_count)d.\nContact us (https://www.redhat.com/contact) for upgrade information.'
DEMO_LICENSE_MESSAGE = 'Demo mode free subscription count exceeded. Current automated instances are %(new_count)d, demo mode allows %(instance_count)d.\nContact us (https://www.redhat.com/contact) for subscription information.'
