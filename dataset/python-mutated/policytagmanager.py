...
class Taxonomy(proto.Message):
    ...
    class Service(proto.Message):
        ...
        """
        name: common.ManagingSystem = proto.Field(proto.ENUM, number=1, enum=common.ManagingSystem)
        identity: str = proto.Field(proto.STRING, number=2)
    ...
    policy_tag_count: int = proto.Field(proto.INT32, number=4)
    taxonomy_timestamps: timestamps.SystemTimestamps = proto.Field(proto.MESSAGE, number=5, message=timestamps.SystemTimestamps)
    activated_policy_types: MutableSequence[PolicyType] = proto.RepeatedField(proto.ENUM, number=6, enum=PolicyType)
    service: Service = proto.Field(proto.MESSAGE, number=7, message=Service)
...
class PolicyTag(proto.Message):
    ...
    display_name: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    parent_policy_tag: str = proto.Field(proto.STRING, number=4)
    child_policy_tags: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class CreateTaxonomyRequest(proto.Message):
    ...
    taxonomy: 'Taxonomy' = proto.Field(proto.MESSAGE, number=2, message='Taxonomy')
...
class UpdateTaxonomyRequest(proto.Message):
    ...
    """
    taxonomy: 'Taxonomy' = proto.Field(proto.MESSAGE, number=1, message='Taxonomy')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    taxonomies: MutableSequence['Taxonomy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Taxonomy')
...
class CreatePolicyTagRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    policy_tag: 'PolicyTag' = proto.Field(proto.MESSAGE, number=2, message='PolicyTag')
...
class UpdatePolicyTagRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            (https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#fieldmask).
    """
    policy_tag: 'PolicyTag' = proto.Field(proto.MESSAGE, number=1, message='PolicyTag')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    policy_tags: MutableSequence['PolicyTag'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PolicyTag')
    next_page_token: str = proto.Field(proto.STRING, number=2)
