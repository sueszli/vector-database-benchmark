...
class TestAssembleWorksheet(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.conditional_format('A1:A12', {'type': 'data_bar', 'min_value': 5, 'mid_value': 52, 'max_value': 90, 'min_type': 'num', 'mid_type': 'percentile', 'max_type': 'percent', 'bar_color': '#8DB4E3'})
