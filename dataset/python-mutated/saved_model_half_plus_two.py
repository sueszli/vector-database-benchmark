...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='/tmp/saved_model_half_plus_two', help='Directory where to output SavedModel.')
    parser.add_argument('--output_dir_tf2', type=str, default='/tmp/saved_model_half_plus_two_tf2', help='Directory where to output TF2 SavedModel.')
    parser.add_argument('--output_dir_pbtxt', type=str, default='/tmp/saved_model_half_plus_two_pbtxt', help='Directory where to output the text format of SavedModel.')
    parser.add_argument('--output_dir_main_op', type=str, default='/tmp/saved_model_half_plus_two_main_op', help='Directory where to output the SavedModel with a main op.')
    parser.add_argument('--output_dir_tflite', type=str, default='/tmp/saved_model_half_plus_two_tflite', help='Directory where to output model in TensorFlow Lite format.')
    parser.add_argument('--output_dir_mlmd', type=str, default='/tmp/saved_model_half_plus_two_mlmd', help='Directory where to output the SavedModel with ML Metadata.')
    parser.add_argument('--output_dir_tflite_with_sigdef', type=str, default='/tmp/saved_model_half_plus_two_tflite_with_sigdef', help='Directory where to output model with signature def in TensorFlow Lite format.')
    parser.add_argument('--device', type=str, default='cpu', help="Force model to run on 'cpu', 'mkl', or 'gpu'")
