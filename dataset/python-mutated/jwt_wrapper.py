...
_VERIFY_OPTIONS: dict[str, Any] = {f'verify_{key}': True for key in _VERIFY_KEYS} | {'require': []}
...
unverified_hs256_token_decode = lru_cache(maxsize=JWT_TOKEN_CACHE_SIZE)(partial(_jwt.decode_payload, key='', algorithms=['HS256'], options=_NO_VERIFY_OPTIONS))
