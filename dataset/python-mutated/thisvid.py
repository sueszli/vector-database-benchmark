...
class ThisVidIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://thisvid.com/videos/sitting-on-ball-tight-jeans/', 'md5': '839becb572995687e11a69dc4358a386', 'info_dict': {'id': '3533241', 'ext': 'mp4', 'title': 'Sitting on ball tight jeans', 'description': 'md5:372353bb995883d1b65fddf507489acd', 'thumbnail': 're:https?://\\w+\\.thisvid\\.com/(?:[^/]+/)+3533241/preview\\.jpg', 'uploader_id': '150629', 'uploader': 'jeanslevisjeans', 'display_id': 'sitting-on-ball-tight-jeans', 'age_limit': 18}}, {'url': 'https://thisvid.com/embed/3533241/', 'md5': '839becb572995687e11a69dc4358a386', 'info_dict': {'id': '3533241', 'ext': 'mp4', 'title': 'Sitting on ball tight jeans', 'thumbnail': 're:https?://\\w+\\.thisvid\\.com/(?:[^/]+/)+3533241/preview\\.jpg', 'uploader_id': '150629', 'uploader': 'jeanslevisjeans', 'display_id': 'sitting-on-ball-tight-jeans', 'age_limit': 18}}]
...
class ThisVidMemberIE(ThisVidPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'https://thisvid.com/members/2140501/', 'info_dict': {'id': '2140501', 'title': "Rafflesia's Profile"}, 'playlist_mincount': 16}, {'url': 'https://thisvid.com/members/2140501/favourite_videos/', 'info_dict': {'id': '2140501', 'title': "Rafflesia's Favourite Videos"}, 'playlist_mincount': 15}, {'url': 'https://thisvid.com/members/636468/public_videos/', 'info_dict': {'id': '636468', 'title': "Happymouth's Public Videos"}, 'playlist_mincount': 196}]
