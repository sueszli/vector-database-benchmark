...
from modelscope.models.cv.action_recognition import BaseVideoModel, PatchShiftTransformer
...
@PIPELINES.register_module(Tasks.action_recognition, module_name=Pipelines.action_recognition)
...
@PIPELINES.register_module(Tasks.action_recognition, module_name=Pipelines.pst_action_recognition)
