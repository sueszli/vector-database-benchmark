...
from organisations.permissions.models import UserOrganisationPermission, UserPermissionGroupOrganisationPermission
...
from .rbac_wrapper import RolePermissionData, get_roles_permission_data_for_environment, get_roles_permission_data_for_organisation, get_roles_permission_data_for_project
if typing.TYPE_CHECKING:
    from environments.models import Environment
    from users.models import FFAdminUser
UserPermissionType = typing.Union[UserProjectPermission, UserEnvironmentPermission, UserOrganisationPermission]
GroupPermissionQs = QuerySet[typing.Union[UserPermissionGroupProjectPermission, UserPermissionGroupEnvironmentPermission, UserPermissionGroupOrganisationPermission]]
...
class PermissionData:
    ...
    roles: typing.List['RolePermissionData' if 'RolePermissionData' in globals() else typing.Any]
