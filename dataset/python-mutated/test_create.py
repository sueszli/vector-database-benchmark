...
env_file_requires_pip_install_path_with_whitespaces = __this_dir__ / 'env-requires-pip-install-with-spaces.yaml'
env_files = [env_file_requires_pip_install_path, env_file_requires_pip_install_path_with_whitespaces]
...
def test_create_with_multiple_files(tmp_home, tmp_root_prefix, tmpdir):
    ...
    assert names == {'a', 'b'}
multichannel_config = {'channels': ['conda-forge'], 'custom_multichannels': {'conda-forge2': ['conda-forge']}}
