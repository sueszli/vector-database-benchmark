...
from ..utils import _get_comm_group, _get_corresponding_rank, compute_compatible_dim_mapping, get_dist_tensor_spec, is_prim_op, set_dist_op_desc_original_id
from .common import DistributedOperatorImpl, DistributedOperatorImplContainer, get_default_distributed_operator_impl, gradient_synchronization, is_parameter_related, register_distributed_operator_impl, register_distributed_operator_impl_container, update_op_dims_mapping
__op_not_need_param_init__ = ['while', 'cond']
__op_has_shape_attr__ = ['fill_constant_batch_size_like', 'fill_constant', 'expand_v2']
...
register_distributed_operator_impl('default', DistributedDefaultImpl0('replicate_parallel'))