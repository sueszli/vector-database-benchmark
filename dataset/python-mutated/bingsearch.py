...
class SearchBing:
    ...
    async def do_search(self) -> None:
        headers = {'Host': self.hostname, 'Cookie': 'SRCHHPGUSR=ADLT=DEMOTE&NRSLT=50', 'Accept-Language': 'en-us,en', 'User-agent': Core.get_user_agent()}
    ...
    async def do_search_api(self) -> None:
        ...
        params = {'q': self.word, 'count': str(self.limit), 'offset': '0', 'mkt': 'en-us', 'safesearch': 'Off'}
    ...
    async def do_search_vhost(self) -> None:
        headers = {'Host': self.hostname, 'Cookie': 'mkt=en-US;ui=en-US;SRCHHPGUSR=NEWWND=0&ADLT=DEMOTE&NRSLT=50', 'Accept-Language': 'en-us,en', 'User-agent': Core.get_user_agent()}
