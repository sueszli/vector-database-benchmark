...
class TuneInBaseIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://(?:www\\.)?tunein\\.com'
...
class TuneInStationIE(TuneInBaseIE):
    _VALID_URL = TuneInBaseIE._VALID_URL_BASE + '(?:/radio/[^?#]+-|/embed/player/)(?P<id>s\\d+)'
    _EMBED_REGEX = ['<iframe[^>]+src=["\\\'](?P<url>(?:https?://)?tunein\\.com/embed/player/s\\d+)']
    _TESTS = [{'url': 'https://tunein.com/radio/Jazz24-885-s34682/', 'info_dict': {'id': 's34682', 'title': 're:^Jazz24', 'description': 'md5:d6d0b89063fd68d529fa7058ee98619b', 'thumbnail': 're:^https?://[^?&]+/s34682', 'location': 'Seattle-Tacoma, US', 'ext': 'mp3', 'live_status': 'is_live'}, 'params': {'skip_download': True}}, {'url': 'https://tunein.com/embed/player/s6404/', 'only_matching': True}, {'url': 'https://tunein.com/radio/BBC-Radio-1-988-s24939/', 'info_dict': {'id': 's24939', 'title': 're:^BBC Radio 1', 'description': 'md5:f3f75f7423398d87119043c26e7bfb84', 'thumbnail': 're:^https?://[^?&]+/s24939', 'location': 'London, UK', 'ext': 'mp3', 'live_status': 'is_live'}, 'params': {'skip_download': True}}]
...
class TuneInPodcastIE(TuneInBaseIE):
    _VALID_URL = TuneInBaseIE._VALID_URL_BASE + '/(?:podcasts/[^?#]+-|embed/player/)(?P<id>p\\d+)/?(?:#|$)'
    _EMBED_REGEX = ['<iframe[^>]+src=["\\\'](?P<url>(?:https?://)?tunein\\.com/embed/player/p\\d+)']
    _TESTS = [{'url': 'https://tunein.com/podcasts/Technology-Podcasts/Artificial-Intelligence-p1153019', 'info_dict': {'id': 'p1153019', 'title': 'Lex Fridman Podcast', 'description': 'md5:bedc4e5f1c94f7dec6e4317b5654b00d'}, 'playlist_mincount': 200}, {'url': 'https://tunein.com/embed/player/p191660/', 'only_matching': True}, {'url': 'https://tunein.com/podcasts/World-News/BBC-News-p14/', 'info_dict': {'id': 'p14', 'title': 'BBC News', 'description': 'md5:1218e575eeaff75f48ed978261fa2068'}, 'playlist_mincount': 200}]
    _PAGE_SIZE = 30
...
class TuneInPodcastEpisodeIE(TuneInBaseIE):
    _VALID_URL = TuneInBaseIE._VALID_URL_BASE + '/podcasts/(?:[^?&]+-)?(?P<podcast_id>p\\d+)/?\\?topicId=(?P<id>\\w\\d+)'
    _TESTS = [{'url': 'https://tunein.com/podcasts/Technology-Podcasts/Artificial-Intelligence-p1153019/?topicId=236404354', 'info_dict': {'id': 't236404354', 'title': '#351 – MrBeast: Future of YouTube, Twitter, TikTok, and Instagram', 'description': 'md5:e1734db6f525e472c0c290d124a2ad77', 'thumbnail': 're:^https?://[^?&]+/p1153019', 'timestamp': 1673458571, 'upload_date': '20230111', 'series_id': 'p1153019', 'series': 'Lex Fridman Podcast', 'ext': 'mp3'}}]
...
class TuneInShortenerIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://tun.in/ser7s', 'info_dict': {'id': 's34682', 'title': 're:^Jazz24', 'description': 'md5:d6d0b89063fd68d529fa7058ee98619b', 'thumbnail': 're:^https?://[^?&]+/s34682', 'location': 'Seattle-Tacoma, US', 'ext': 'mp3', 'live_status': 'is_live'}, 'params': {'skip_download': True}}
