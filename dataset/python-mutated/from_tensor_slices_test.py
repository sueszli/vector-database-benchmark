...
class FromTensorSlicesRandomAccessTest(test_base.DatasetTestBase, parameterized.TestCase):
...
class FromTensorSlicesCheckpointTest(checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
