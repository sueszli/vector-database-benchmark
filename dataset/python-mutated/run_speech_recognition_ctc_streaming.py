...
import transformers
from transformers import AutoConfig, AutoFeatureExtractor, AutoModelForCTC, AutoProcessor, AutoTokenizer, HfArgumentParser, Trainer, TrainerCallback, TrainingArguments, Wav2Vec2Processor, set_seed
...
class DataTrainingArguments:
    ...
    eval_split_name: str = field(default='test', metadata={'help': "The name of the training data set split to use (via the datasets library). Defaults to 'test'"})
    ...
    shuffle_buffer_size: Optional[int] = field(default=500, metadata={'help': 'The number of streamed examples to download before shuffling them. The large the buffer, the closer it is to real offline shuffling.'})
