...
if __name__ == '__main__':
    ...
    InstallPanda(destdir=destdir, prefix=options.prefix, outputdir=options.outputdir, python_versions=ReadPythonVersionInfoFile())
