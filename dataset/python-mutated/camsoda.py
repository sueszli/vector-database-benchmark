...
class CamsodaIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.camsoda.com/lizzhopf', 'info_dict': {'id': 'lizzhopf', 'ext': 'mp4', 'title': 'lizzhopf (lizzhopf) Nude on Cam. Free Live Sex Chat Room - CamSoda', 'description': str, 'is_live': True, 'age_limit': 18}, 'skip': 'Room is offline'}]
