...
class DependencyStructureSnapshot(NamedTuple('_DependencyStructureSnapshot', [('node_invocation_snaps', Sequence['NodeInvocationSnap'])])):
...
class InputHandle(NamedTuple('_InputHandle', [('node_def_name', str), ('node_name', str), ('input_name', str)])):
...
class InputDependencySnap(NamedTuple('_InputDependencySnap', [('input_name', str), ('upstream_output_snaps', Sequence[OutputHandleSnap]), ('is_dynamic_collect', bool)])):
...
@whitelist_for_serdes(storage_name='SolidInvocationSnap', storage_field_names={'node_name': 'solid_name', 'node_def_name': 'solid_def_name'})
class NodeInvocationSnap(NamedTuple('_NodeInvocationSnap', [('node_name', str), ('node_def_name', str), ('tags', Mapping[str, str]), ('input_dep_snaps', Sequence[InputDependencySnap]), ('is_dynamic_mapped', bool)])):
