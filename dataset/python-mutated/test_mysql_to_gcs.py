...
SCHEMA = [{'mode': 'REQUIRED', 'name': 'some_str', 'type': 'FLOAT'}, {'mode': 'REQUIRED', 'name': 'some_num', 'type': 'TIMESTAMP'}]
...
SCHEMA_JSON = [b'[{"mode": "REQUIRED", "name": "some_str", "type": "FLOAT"}, ', b'{"mode": "REQUIRED", "name": "some_num", "type": "STRING"}]']
CUSTOM_SCHEMA_JSON = [b'[{"mode": "REQUIRED", "name": "some_str", "type": "FLOAT"}, ', b'{"mode": "REQUIRED", "name": "some_num", "type": "TIMESTAMP"}]']
try:
