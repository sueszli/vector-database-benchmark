...
class TestNumWords(PrimitiveTestBase):
    ...
    def test_general(self):
        if False:
            print('Hello World!')
        x = pd.Series(['test test test test', 'test TEST test TEST,test test test', 'and subsequent lines...'])
    ...
    def test_unicode_input(self):
        if False:
            i = 10
            return i + 15
        x = pd.Series(['Ángel Angel Ángel ángel'])
    ...
    def test_contractions(self):
        if False:
            i = 10
            return i + 15
        x = pd.Series(["can't won't don't can't aren't won't don't they'd there's"])
    ...
    def test_multiple_spaces(self):
        if False:
            while True:
                i = 10
        x = pd.Series(['    word  word            word word     .', 'This is                      \nthird line \nthird line'])
