...
class ComponentManager:
    ...
    async def start(self):
        ...
        for stage in self.sort_components():
            needing_start = [component._setup() for component in stage if not component.running]
            if needing_start:
    ...
    async def stop(self):
        ...
        for stage in stages:
            needing_stop = [component._stop() for component in stage if component.running]
            if needing_stop:
