...
MISSING_PASSWORD_RESET_CONFIG_ERROR = "Password reset emails are enabled on this homeserver due to a partial\n'email' block. However, the following required keys are missing:\n    %s\n"
DEFAULT_SUBJECTS = {'message_from_person_in_room': '[%(app)s] You have a message on %(app)s from %(person)s in the %(room)s room...', 'message_from_person': '[%(app)s] You have a message on %(app)s from %(person)s...', 'messages_from_person': '[%(app)s] You have messages on %(app)s from %(person)s...', 'messages_in_room': '[%(app)s] You have messages on %(app)s in the %(room)s room...', 'messages_in_room_and_others': '[%(app)s] You have messages on %(app)s in the %(room)s room and others...', 'messages_from_person_and_others': '[%(app)s] You have messages on %(app)s from %(person)s and others...', 'invite_from_person': '[%(app)s] %(person)s has invited you to chat on %(app)s...', 'invite_from_person_to_room': '[%(app)s] %(person)s has invited you to join the %(room)s room on %(app)s...', 'invite_from_person_to_space': '[%(app)s] %(person)s has invited you to join the %(space)s space on %(app)s...', 'password_reset': '[%(server_name)s] Password reset', 'email_validation': '[%(server_name)s] Validate your email'}
