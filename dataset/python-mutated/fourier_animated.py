...
terms_plot = figure(title='First four square-wave harmonics, individually', height=400, width=820, x_range=(-2.5, xend), y_range=(-2.5, 2.5), tools='', toolbar_location=None)
...
sum_plot = figure(title='First four square-wave harmonics, summed', height=400, width=820, x_range=(-2.5, xend), y_range=(-2.5, 2.5), tools='', toolbar_location=None)
sum_plot.line('x', 'y', color='orange', line_width=2, source=lines_source)
sum_plot.circle('xsum-circle', 'ysum-circle', radius='r', line_color='color', line_width=2, line_dash='dashing', fill_color=None, source=items_source)
sum_plot.scatter('xsum-dot', 'ysum-dot', size=5, color='color', source=items_source)
segment_view = CDSView(filter=IndexFilter([3]))
sum_plot.segment(x0='xsum-dot', y0='ysum-dot', x1=2.5, y1='ysum-dot', color='orange', source=items_source, view=segment_view)
