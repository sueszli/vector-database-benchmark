...
import pytest
from dagster import AssetKey, AssetsDefinition, DagsterInvalidDefinitionError, FreshnessPolicy, SourceAsset, asset, load_assets_from_current_module, load_assets_from_modules, load_assets_from_package_module, load_assets_from_package_name
from dagster._core.definitions.auto_materialize_policy import AutoMaterializePolicy
from dagster._core.definitions.cacheable_assets import CacheableAssetsDefinition
get_unique_asset_identifier = lambda asset: asset.op.name if isinstance(asset, AssetsDefinition) else asset.key
