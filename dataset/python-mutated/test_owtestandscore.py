...
import baycomp
from Orange.classification import MajorityLearner, LogisticRegressionLearner, RandomForestLearner
...
from Orange.widgets.evaluate.owtestandscore import OWTestAndScore, results_one_vs_rest
from Orange.widgets.settings import ClassValuesContextHandler, PerfectDomainContextHandler
