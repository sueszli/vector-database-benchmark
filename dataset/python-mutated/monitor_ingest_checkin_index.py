...
from sentry.monitors.models import CheckInStatus, Monitor, MonitorCheckIn, MonitorEnvironment, MonitorEnvironmentLimitsExceeded, MonitorEnvironmentValidationFailed, MonitorLimitsExceeded, MonitorObjectStatus
...
class MonitorIngestCheckInIndexEndpoint(MonitorIngestEndpoint):
    ...
    rate_limits = RateLimitConfig(limit_overrides={'POST': {RateLimitCategory.IP: RateLimit(40 * 60, 60), RateLimitCategory.USER: RateLimit(40 * 60, 60), RateLimitCategory.ORGANIZATION: RateLimit(40 * 60, 60)}})
