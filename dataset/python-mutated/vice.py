...
from ..utils import clean_html, ExtractorError, int_or_none, OnDemandPagedList, parse_age_limit, str_or_none, try_get
...
class ViceIE(ViceBaseIE, AdobePassIE):
    ...
    _EMBED_REGEX = ['<iframe\\b[^>]+\\bsrc=["\\\'](?P<url>(?:https?:)?//video\\.vice\\.com/[^/]+/embed/[\\da-f]{24})']
    _TESTS = [{'url': 'https://video.vice.com/en_us/video/pet-cremator/58c69e38a55424f1227dc3f7', 'info_dict': {'id': '58c69e38a55424f1227dc3f7', 'ext': 'mp4', 'title': '10 Questions You Always Wanted To Ask: Pet Cremator', 'description': 'md5:fe856caacf61fe0e74fab15ce2b07ca5', 'uploader': 'vice', 'uploader_id': '57a204088cb727dec794c67b', 'timestamp': 1489664942, 'upload_date': '20170316', 'age_limit': 14}, 'params': {'skip_download': True}}, {'url': 'https://video.vice.com/en_us/video/the-signal-from-tolva/5816510690b70e6c5fd39a56', 'info_dict': {'id': '5816510690b70e6c5fd39a56', 'ext': 'mp4', 'uploader': 'vice', 'title': 'The Signal From Tölva', 'description': 'md5:3927e3c79f9e8094606a2b3c5b5e55d5', 'uploader_id': '57a204088cb727dec794c67b', 'timestamp': 1477941983, 'upload_date': '20161031'}, 'params': {'skip_download': True}}, {'url': 'https://video.vice.com/alps/video/ulfs-wien-beruchtigste-grafitti-crew-part-1/581b12b60a0e1f4c0fb6ea2f', 'info_dict': {'id': '581b12b60a0e1f4c0fb6ea2f', 'ext': 'mp4', 'title': 'ULFs - Wien berüchtigste Grafitti Crew - Part 1', 'description': 'Zwischen Hinterzimmer-Tattoos und U-Bahnschächten erzählen uns die Ulfs, wie es ist, "süchtig nach Sachbeschädigung" zu sein.', 'uploader': 'vice', 'uploader_id': '57a204088cb727dec794c67b', 'timestamp': 1485368119, 'upload_date': '20170125', 'age_limit': 14}, 'params': {'skip_download': True}}, {'url': 'https://video.vice.com/en_us/video/pizza-show-trailer/56d8c9a54d286ed92f7f30e4', 'only_matching': True}, {'url': 'https://video.vice.com/en_us/embed/57f41d3556a0a80f54726060', 'only_matching': True}, {'url': 'https://vms.vice.com/en_us/video/preplay/58c69e38a55424f1227dc3f7', 'only_matching': True}, {'url': 'https://www.viceland.com/en_us/video/thursday-march-1-2018/5a8f2d7ff1cdb332dd446ec1', 'only_matching': True}]
...
class ViceShowIE(ViceBaseIE):
    ...
    _PAGE_SIZE = 25
    _TESTS = [{'url': 'https://video.vice.com/en_us/show/fck-thats-delicious', 'info_dict': {'id': '57a2040c8cb727dec794c901', 'title': 'F*ck, That’s Delicious', 'description': 'The life and eating habits of rap’s greatest bon vivant, Action Bronson.'}, 'playlist_mincount': 64}, {'url': 'https://www.vicetv.com/en_us/show/fck-thats-delicious', 'only_matching': True}]
