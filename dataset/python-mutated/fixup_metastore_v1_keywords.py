...
class metastoreCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'alter_metadata_resource_location': ('service', 'resource_name', 'location_uri'), 'create_backup': ('parent', 'backup_id', 'backup', 'request_id'), 'create_federation': ('parent', 'federation_id', 'federation', 'request_id'), 'create_metadata_import': ('parent', 'metadata_import_id', 'metadata_import', 'request_id'), 'create_service': ('parent', 'service_id', 'service', 'request_id'), 'delete_backup': ('name', 'request_id'), 'delete_federation': ('name', 'request_id'), 'delete_service': ('name', 'request_id'), 'export_metadata': ('service', 'destination_gcs_folder', 'request_id', 'database_dump_type'), 'get_backup': ('name',), 'get_federation': ('name',), 'get_metadata_import': ('name',), 'get_service': ('name',), 'list_backups': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_federations': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_metadata_imports': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_services': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'move_table_to_database': ('service', 'table_name', 'db_name', 'destination_db_name'), 'query_metadata': ('service', 'query'), 'restore_service': ('service', 'backup', 'restore_type', 'request_id'), 'update_federation': ('update_mask', 'federation', 'request_id'), 'update_metadata_import': ('update_mask', 'metadata_import', 'request_id'), 'update_service': ('update_mask', 'service', 'request_id')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=metastoreCallTransformer()):
    if False:
        return 10
