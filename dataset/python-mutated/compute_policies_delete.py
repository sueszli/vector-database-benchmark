...
def main():
    ...
    response = client.compute_policies.delete(resource_group_name='contosorg', account_name='contosoadla', compute_policy_name='test_policy')
    print(response)
