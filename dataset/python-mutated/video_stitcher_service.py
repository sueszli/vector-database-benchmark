...
class CreateCdnKeyRequest(proto.Message):
    ...
    cdn_key: gcvs_cdn_keys.CdnKey = proto.Field(proto.MESSAGE, number=2, message=gcvs_cdn_keys.CdnKey)
    cdn_key_id: str = proto.Field(proto.STRING, number=3)
...
class ListCdnKeysResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    cdn_keys: MutableSequence[gcvs_cdn_keys.CdnKey] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcvs_cdn_keys.CdnKey)
...
class UpdateCdnKeyRequest(proto.Message):
    ...
    """
    cdn_key: gcvs_cdn_keys.CdnKey = proto.Field(proto.MESSAGE, number=1, message=gcvs_cdn_keys.CdnKey)
...
class CreateVodSessionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    vod_session: sessions.VodSession = proto.Field(proto.MESSAGE, number=2, message=sessions.VodSession)
...
class ListVodStitchDetailsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    vod_stitch_details: MutableSequence[stitch_details.VodStitchDetail] = proto.RepeatedField(proto.MESSAGE, number=1, message=stitch_details.VodStitchDetail)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    vod_ad_tag_details: MutableSequence[ad_tag_details.VodAdTagDetail] = proto.RepeatedField(proto.MESSAGE, number=1, message=ad_tag_details.VodAdTagDetail)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    live_ad_tag_details: MutableSequence[ad_tag_details.LiveAdTagDetail] = proto.RepeatedField(proto.MESSAGE, number=1, message=ad_tag_details.LiveAdTagDetail)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateSlateRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    slate_id: str = proto.Field(proto.STRING, number=2)
    slate: gcvs_slates.Slate = proto.Field(proto.MESSAGE, number=3, message=gcvs_slates.Slate)
...
class ListSlatesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    slates: MutableSequence[gcvs_slates.Slate] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcvs_slates.Slate)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class UpdateSlateRequest(proto.Message):
    ...
    """
    slate: gcvs_slates.Slate = proto.Field(proto.MESSAGE, number=1, message=gcvs_slates.Slate)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
...
class CreateLiveSessionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    live_session: sessions.LiveSession = proto.Field(proto.MESSAGE, number=2, message=sessions.LiveSession)
...
class CreateLiveConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    live_config_id: str = proto.Field(proto.STRING, number=2)
    live_config: gcvs_live_configs.LiveConfig = proto.Field(proto.MESSAGE, number=3, message=gcvs_live_configs.LiveConfig)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class ListLiveConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    live_configs: MutableSequence[gcvs_live_configs.LiveConfig] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcvs_live_configs.LiveConfig)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
