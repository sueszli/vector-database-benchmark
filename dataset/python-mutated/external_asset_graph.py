...
from typing import TYPE_CHECKING, AbstractSet, Dict, Iterable, List, Mapping, Optional, Sequence, Set, Tuple
...
if TYPE_CHECKING:
    from dagster._core.host_representation.external_data import ExternalAssetCheck, ExternalAssetNode
