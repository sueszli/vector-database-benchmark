...
class MurrtubeIE(InfoExtractor):
    ...
    _TEST = {'url': 'https://murrtube.net/videos/inferno-x-skyler-148b6f2a-fdcc-4902-affe-9c0f41aaaca0', 'md5': '169f494812d9a90914b42978e73aa690', 'info_dict': {'id': '148b6f2a-fdcc-4902-affe-9c0f41aaaca0', 'ext': 'mp4', 'title': 'Inferno X Skyler', 'description': 'Humping a very good slutty sheppy (roomate)', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 284, 'uploader': 'Inferno Wolf', 'age_limit': 18, 'comment_count': int, 'view_count': int, 'like_count': int, 'tags': ['hump', 'breed', 'Fursuit', 'murrsuit', 'bareback']}}
...
class MurrtubeUserIE(MurrtubeIE):
    ...
    _TEST = {'url': 'https://murrtube.net/stormy', 'info_dict': {'id': 'stormy'}, 'playlist_mincount': 27}
    _PAGE_SIZE = 10
