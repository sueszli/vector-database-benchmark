...
from tests.lib.wheel import File, _default, make_metadata_file, make_wheel, make_wheel_metadata_file, message_from_dict
...
default_make_metadata = partial(make_metadata_file, name='simple', value=_default, version='0.1.0', updates=_default, body=_default)
...
default_make_wheel_metadata = partial(make_wheel_metadata_file, name='simple', version='0.1.0', value=_default, tags=tags, updates=_default)
