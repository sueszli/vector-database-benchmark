...
argument_parser.add_argument('--root', type=pathlib.Path, default=pathlib.Path(__file__).absolute().parent.parent.parent, help='Root path for aws-doc-sdk-examples. Default ../../ assumes running this script from its location in tools.')
argument_parser.add_argument('channel', help='Toolchain channel to use for Rust code examples.')
argument_parser.add_argument('--dry-run', dest='dry_run', action='store_true', default=False, help="Don't write updated files.")
argument_parser.add_argument('--verbose', action='store_true', default=False, help='Write verbose logging')
