...
from ...operations._afd_profiles_operations import build_check_endpoint_name_availability_request, build_check_host_name_availability_request, build_list_resource_usage_request, build_upgrade_request, build_validate_secret_request
...
class AFDProfilesOperations:
    ...
    @overload
    async def check_endpoint_name_availability(self, resource_group_name: str, profile_name: str, check_endpoint_name_availability_input: _models.CheckEndpointNameAvailabilityInput, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckEndpointNameAvailabilityOutput:
    ...
    @overload
    async def check_endpoint_name_availability(self, resource_group_name: str, profile_name: str, check_endpoint_name_availability_input: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckEndpointNameAvailabilityOutput:
        """Check the availability of an afdx endpoint name, and return the globally unique endpoint host
        name.
    ...
    async def check_endpoint_name_availability(self, resource_group_name: str, profile_name: str, check_endpoint_name_availability_input: Union[_models.CheckEndpointNameAvailabilityInput, IO], **kwargs: Any) -> _models.CheckEndpointNameAvailabilityOutput:
        """Check the availability of an afdx endpoint name, and return the globally unique endpoint host
        name.
        ...
        return deserialized
    check_endpoint_name_availability.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/checkEndpointNameAvailability'}

    @distributed_trace
    def list_resource_usage(self, resource_group_name: str, profile_name: str, **kwargs: Any) -> AsyncIterable['_models.Usage']:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    async def check_host_name_availability(self, resource_group_name: str, profile_name: str, check_host_name_availability_input: _models.CheckHostNameAvailabilityInput, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityOutput:
    ...
    @overload
    async def check_host_name_availability(self, resource_group_name: str, profile_name: str, check_host_name_availability_input: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.CheckNameAvailabilityOutput:
        """Validates the custom domain mapping to ensure it maps to the correct Azure Front Door endpoint
        in DNS.
    ...
    @distributed_trace_async
    async def check_host_name_availability(self, resource_group_name: str, profile_name: str, check_host_name_availability_input: Union[_models.CheckHostNameAvailabilityInput, IO], **kwargs: Any) -> _models.CheckNameAvailabilityOutput:
        """Validates the custom domain mapping to ensure it maps to the correct Azure Front Door endpoint
        in DNS.
    ...
    @overload
    async def validate_secret(self, resource_group_name: str, profile_name: str, validate_secret_input: _models.ValidateSecretInput, *, content_type: str='application/json', **kwargs: Any) -> _models.ValidateSecretOutput:
    ...
    @overload
    async def validate_secret(self, resource_group_name: str, profile_name: str, validate_secret_input: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ValidateSecretOutput:
        """Validate a Secret in the profile.
    ...
    @distributed_trace_async
    async def validate_secret(self, resource_group_name: str, profile_name: str, validate_secret_input: Union[_models.ValidateSecretInput, IO], **kwargs: Any) -> _models.ValidateSecretOutput:
        """Validate a Secret in the profile.
        ...
        request = build_validate_secret_request(resource_group_name=resource_group_name, profile_name=profile_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate_secret.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    validate_secret.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/validateSecret'}

    async def _upgrade_initial(self, resource_group_name: str, profile_name: str, profile_upgrade_parameters: Union[_models.ProfileUpgradeParameters, IO], **kwargs: Any) -> _models.Profile:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        ...
        request = build_upgrade_request(resource_group_name=resource_group_name, profile_name=profile_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self._upgrade_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def begin_upgrade(self, resource_group_name: str, profile_name: str, profile_upgrade_parameters: _models.ProfileUpgradeParameters, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.Profile]:
    ...
    @overload
    async def begin_upgrade(self, resource_group_name: str, profile_name: str, profile_upgrade_parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.Profile]:
        """Upgrade a profile from Standard_AzureFrontDoor to Premium_AzureFrontDoor.
    ...
    @distributed_trace_async
    async def begin_upgrade(self, resource_group_name: str, profile_name: str, profile_upgrade_parameters: Union[_models.ProfileUpgradeParameters, IO], **kwargs: Any) -> AsyncLROPoller[_models.Profile]:
        """Upgrade a profile from Standard_AzureFrontDoor to Premium_AzureFrontDoor.
        ...
        if cont_token is None:
            raw_result = await self._upgrade_initial(resource_group_name=resource_group_name, profile_name=profile_name, profile_upgrade_parameters=profile_upgrade_parameters, api_version=api_version, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
