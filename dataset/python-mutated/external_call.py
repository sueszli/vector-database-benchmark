...
from vyper.codegen.core import _freshname, calculate_type_for_external_return, check_assign, check_external_call, dummy_node_for_type, eval_once_check, get_type_for_exact_size, make_setter, needs_clamp, unwrap_location, wrap_value_for_external_return
