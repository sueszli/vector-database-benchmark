...
class VVVVIDIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://(?:www\\.)?vvvvid\\.it/(?:#!)?(?:show|anime|film|series)/'
    _VALID_URL = '%s(?P<show_id>\\d+)/[^/]+/(?P<season_id>\\d+)/(?P<id>[0-9]+)' % _VALID_URL_BASE
    _TESTS = [{'url': 'https://www.vvvvid.it/#!show/434/perche-dovrei-guardarlo-di-dario-moccia/437/489048/ping-pong', 'md5': 'b8d3cecc2e981adc3835adf07f6df91b', 'info_dict': {'id': '489048', 'ext': 'mp4', 'title': 'Ping Pong', 'duration': 239, 'series': '"Perché dovrei guardarlo?" di Dario Moccia', 'season_id': '437', 'episode': 'Ping Pong', 'episode_number': 1, 'episode_id': '3334', 'view_count': int, 'like_count': int, 'repost_count': int}, 'params': {'skip_download': True}}, {'url': 'https://www.vvvvid.it/#!show/376/death-note-live-action/377/482493/episodio-01', 'md5': '33e0edfba720ad73a8782157fdebc648', 'info_dict': {'id': '482493', 'ext': 'mp4', 'title': 'Episodio 01'}, 'params': {'skip_download': True}}, {'url': 'https://www.vvvvid.it/show/404/one-punch-man/406/486683/trailer', 'md5': '33e0edfba720ad73a8782157fdebc648', 'info_dict': {'id': 'RzmFKUDOUgw', 'ext': 'mp4', 'title': 'Trailer', 'upload_date': '20150906', 'description': 'md5:a5e802558d35247fee285875328c0b80', 'uploader_id': 'BandaiVisual', 'uploader': 'BANDAI NAMCO Arts Channel'}, 'params': {'skip_download': True}}, {'url': 'https://www.vvvvid.it/show/683/made-in-abyss/1542/693786/nanachi', 'info_dict': {'id': '693786', 'ext': 'mp4', 'title': 'Nanachi'}, 'params': {'skip_download': True, 'format': 'mp4'}}, {'url': 'https://www.vvvvid.it/show/434/perche-dovrei-guardarlo-di-dario-moccia/437/489048', 'only_matching': True}]
    _conn_id = None
...
class VVVVIDShowIE(VVVVIDIE):
    _VALID_URL = '(?P<base_url>%s(?P<id>\\d+)(?:/(?P<show_title>[^/?&#]+))?)/?(?:[?#&]|$)' % VVVVIDIE._VALID_URL_BASE
    _TESTS = [{'url': 'https://www.vvvvid.it/show/156/psyco-pass', 'info_dict': {'id': '156', 'title': 'Psycho-Pass', 'description': 'md5:94d572c0bd85894b193b8aebc9a3a806'}, 'playlist_count': 46}, {'url': 'https://www.vvvvid.it/show/156', 'only_matching': True}]
