...
from modelscope.models.multi_modal.video_synthesis.autoencoder import AutoencoderKL
from modelscope.models.multi_modal.video_synthesis.diffusion import GaussianDiffusion, beta_schedule
