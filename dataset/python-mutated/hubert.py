...
class HubertConfig(FairseqDataclass):
    ...
    conv_feature_layers: str = field(default='[(512,10,5)] + [(512,3,2)] * 4 + [(512,2,2)] * 2', metadata={'help': 'string describing convolutional feature extraction layers in form of a python list that contains [(dim, kernel_size, stride), ...]'})
    ...
    mask_other: float = field(default=0, metadata={'help': 'secondary mask argument (used for more complex distributions), see help in compute_mask_indicesh'})
    ...
    conv_pos_batch_norm: bool = field(default=False, metadata={'help': 'use batch norm instead of weight norm in conv_pos (for bf16 models)'})
