...
async def test_remove_branch():
    ...
    async with App().run_test() as pilot:
        await pilot.app.mount(Container(Container(Container(Container(Container(Static()))))), Static(), Container(Container(Container(Container(Container(Static()))))))
...
async def test_widget_remove_order():
    ...
    async with App().run_test() as pilot:
        await pilot.app.mount(Removable(Removable(Removable(id='grandchild'), id='child'), id='parent'))
