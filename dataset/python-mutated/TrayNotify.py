...
try:
    ...
    from PyQt5.QtWidgets import QApplication, QHBoxLayout, QPushButton, QStyle, QSystemTrayIcon, QWidget
except ImportError:
    from PySide2.QtCore import QTimer
    from PySide2.QtWidgets import QApplication, QHBoxLayout, QPushButton, QStyle, QSystemTrayIcon, QWidget
