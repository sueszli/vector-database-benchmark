...
CSV_LINTER = str(pathlib.Path(__file__).absolute().parent.parent.parent.parent / 'tools/linter/adapters/no_merge_conflict_csv_linter.py')
...
if __name__ == '__main__':
    ...
    suites = {'aot_inductor_huggingface', 'inductor_huggingface', 'inductor_huggingface_dynamic', 'aot_inductor_timm', 'inductor_timm', 'inductor_timm_dynamic', 'aot_inductor_torchbench', 'inductor_torchbench', 'inductor_torchbench_dynamic'}
