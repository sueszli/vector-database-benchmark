...
DATA_FORMAT = 'TEXT'
INPUT_PATHS = ['gs://path/to/input/file.json', 'gs://path/to/input/file2.json', 'gs://path/to/input/file3.json']
PREDICTION_PATH = 'gs://path/to/output/predictions.json'
BATCH_PREDICTION_JOB_ID = 'test-batch-prediction-job-id'
PROJECT_ID = 'test-project-id'
REGION = 'test-region'
DATAFLOW_OPTIONS = {'project': 'my-gcp-project', 'zone': 'us-central1-f', 'stagingLocation': 'gs://bucket/tmp/dataflow/staging/'}
MODEL_URI = 'gs://path/to/model/model'
MODEL_NAME = 'test-model-name'
VERSION_NAME = 'test-version-name'
DAG_DEFAULT_ARGS = {'project_id': PROJECT_ID, 'region': REGION, 'model_name': MODEL_NAME, 'version_name': VERSION_NAME, 'dataflow_default_options': DATAFLOW_OPTIONS}
