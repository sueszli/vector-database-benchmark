...
if __name__ == '__main__':
    ...
    job_id = run(raw_data_dir=args.raw_data_dir, raw_labels_dir=args.raw_labels_dir, train_data_dir=args.train_data_dir, eval_data_dir=args.eval_data_dir, train_eval_split=[80, 20], beam_args=beam_args)
