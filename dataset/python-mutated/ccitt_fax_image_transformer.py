...
class CCITTFaxImageTransformer(Transformer):
    ...
    def can_be_transformed(self, object: typing.Union[io.BufferedIOBase, io.RawIOBase, io.BytesIO, AnyPDFType]) -> bool:
        ...
        return isinstance(object, Stream) and object.get('Type', None) in ['XObject', None] and (object.get('Subtype', None) == 'Image') and ('Filter' in object) and (object['Filter'] == 'CCITTFaxDecode' or (isinstance(object['Filter'], list) and object['Filter'][0] == 'CCITTFaxDecode'))
    ...
    def transform(self, object_to_transform: typing.Union[io.BufferedIOBase, io.RawIOBase, AnyPDFType], parent_object: typing.Any, context: typing.Optional[ReadTransformerState]=None, event_listeners: typing.List[EventListener]=[]) -> typing.Any:
        ...
        try:
            ...
            logger.debug('Unable to read ccitt fax image. Constructing empty image of same dimensions.')
