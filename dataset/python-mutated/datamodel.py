...
for (_, module, _) in pkgutil.iter_modules(dedupe.variables.__path__, 'dedupe.variables.'):
    __import__(module)
if TYPE_CHECKING:
    from typing import Generator, Iterable, Sequence
    from dedupe._typing import Comparator, RecordDict, RecordDictPair, VariableDefinition
