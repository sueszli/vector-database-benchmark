...
class SmoothlyBrokenPowerLaw1D(Fittable1DModel):
    ...
    delta = Parameter(default=1, min=0.001, description='Smoothness Parameter')
...
class Schechter1D(Fittable1DModel):
    ...
    """
    phi_star = Parameter(default=1.0, description='Normalization factor in units of number density')
