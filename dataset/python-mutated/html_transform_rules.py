...
from calibre.gui2.css_transform_rules import RulesWidget as RulesWidgetBase, Tester as TesterBase
from calibre.gui2.tag_mapper import RuleEditDialog as RuleEditDialogBase, RuleItem as RuleItemBase, Rules as RulesBase, RulesDialog as RulesDialogBase
...
if __name__ == '__main__':
    ...
    app = Application([])
    d = RulesDialog()
    d.rules = [{'match_type': 'xpath', 'query': '//h:h2', 'actions': [{'type': 'remove'}]}]
    d.exec()
