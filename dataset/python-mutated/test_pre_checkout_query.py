...
class TestPreCheckoutQuery:
    ...
    def test_answer_alias(self):
        if False:
            print('Hello World!')
        pre_checkout_query = PreCheckoutQuery(id='id', from_user=User(id=42, is_bot=False, first_name='name'), currency='currency', total_amount=123, invoice_payload='payload')
