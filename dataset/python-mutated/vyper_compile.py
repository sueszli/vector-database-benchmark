...
from vyper.compiler.settings import VYPER_TRACEBACK_LIMIT, OptimizationLevel, Settings, _set_debug_mode
...
combined_json_outputs = ['bytecode', 'bytecode_runtime', 'blueprint_bytecode', 'abi', 'layout', 'source_map', 'method_identifiers', 'userdoc', 'devdoc']
