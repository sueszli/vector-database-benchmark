...
class Config:
    ...
    FPS = 30
    FPS_GAMING = 50
    FONT_PATHS_DICT = {'default20': {'name': os.path.join(rootdir.replace('breakoutclone', 'base'), 'resources/fonts/MaiandraGD.ttf'), 'size': 20}, 'default30': {'name': os.path.join(rootdir.replace('breakoutclone', 'base'), 'resources/fonts/MaiandraGD.ttf'), 'size': 30}}
    BGM_PATH = os.path.join(rootdir, 'resources/audios/bgm.mp3')
    SOUND_PATHS_DICT = {'hit': os.path.join(rootdir, 'resources/audios/hit.wav')}
