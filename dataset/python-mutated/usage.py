...
from wagtail.admin.ui.tables.pages import PageStatusColumn, PageTable, PageTitleColumn, ParentPageColumn
...
class ContentTypeUseView(BaseListingView):
    ...
    page_kwarg = 'p'
    paginate_by = 50
    columns = [PageTitleColumn('title', classname='title', label=_('Title')), ParentPageColumn('parent', label=_('Parent')), DateColumn('latest_revision_created_at', label=_('Updated'), width='12%'), Column('type', label=_('Type'), accessor='page_type_display_name', width='12%'), PageStatusColumn('status', label=_('Status'), width='12%')]
