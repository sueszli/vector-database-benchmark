...
from ..utils import determine_ext, determine_protocol, parse_duration, int_or_none

class Lecture2GoIE(InfoExtractor):
    _VALID_URL = 'https?://lecture2go\\.uni-hamburg\\.de/veranstaltungen/-/v/(?P<id>\\d+)'
    _TEST = {'url': 'https://lecture2go.uni-hamburg.de/veranstaltungen/-/v/17473', 'md5': 'ac02b570883020d208d405d5a3fd2f7f', 'info_dict': {'id': '17473', 'ext': 'mp4', 'title': '2 - Endliche Automaten und reguläre Sprachen', 'creator': 'Frank Heitmann', 'duration': 5220}, 'params': {'skip_download': True}}
