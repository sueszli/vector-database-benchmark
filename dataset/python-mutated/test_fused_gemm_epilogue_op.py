...
@skip_check_grad_ci(reason='no grap op')
@unittest.skipIf(not core.is_compiled_with_cuda(), 'core is not compiled with CUDA')
class TestFuseGemmEpilogueOpReluMMFP32MultiDimX(TestFuseGemmEpilogueOpReluMMFP16MultiDimX):
...
@skip_check_grad_ci(reason='no grap op')
@unittest.skipIf(not core.is_compiled_with_cuda(), 'core is not compiled with CUDA')
class TestFuseGemmEpilogueOpReluMMFP64MultiDimX(TestFuseGemmEpilogueOpReluMMFP16MultiDimX):
...
@skip_check_grad_ci(reason='no grap op')
@unittest.skipIf(not core.is_compiled_with_cuda(), 'core is not compiled with CUDA')
class TestFuseGemmEpilogueOpReluMTMFP32MultiDimX(TestFuseGemmEpilogueOpReluMTMFP16MultiDimX):
...
@skip_check_grad_ci(reason='no grap op')
@unittest.skipIf(not core.is_compiled_with_cuda(), 'core is not compiled with CUDA')
class TestFuseGemmEpilogueOpReluMTMFP64MultiDimX(TestFuseGemmEpilogueOpReluMTMFP16MultiDimX):
...
@unittest.skipIf(not is_fused_gemm_epilogue_supported(), 'fused_gemm_epilogue is only supported when CUDA version >= 11.6')
