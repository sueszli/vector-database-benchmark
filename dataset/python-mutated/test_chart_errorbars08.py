...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        if False:
            print('Hello World!')
        self.set_filename('chart_errorbars08.xlsx')
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$1:$A$5', 'values': '=Sheet1!$B$1:$B$5', 'y_error_bars': {'type': 'custom', 'plus_values': [1], 'minus_values': [2]}})
