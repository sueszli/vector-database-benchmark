...
class MultiHeadAttentionTest(testing.TestCase, parameterized.TestCase):
    ...
    @parameterized.named_parameters(('4d_inputs_1freebatch_mask2', (3, 4), (3, 2), (4, 2), (2,)), ('4d_inputs_1freebatch_mask3', (3, 4), (3, 2), (3, 4, 2), (2,)), ('4d_inputs_1freebatch_mask4', (3, 4), (3, 2), (3, 2, 4, 2), (2,)), ('4d_inputs_2d_attention', (3, 4), (3, 2), (3, 4, 3, 2), (1, 2)), ('5d_inputs_2d_attention', (5, 3, 4), (5, 3, 2), (3, 4, 3, 2), (2, 3)), ('5d_inputs_2d_attention_fullmask', (5, 3, 4), (5, 3, 2), (5, 3, 4, 3, 2), (2, 3)))
    ...
    @parameterized.named_parameters(('without_key_same_proj', (4, 8), (2, 8), None, None), ('with_key_same_proj', (4, 8), (2, 8), (2, 3), None), ('wihtout_key_different_proj', (4, 8), (2, 8), None, (3, 4)), ('with_key_different_proj', (4, 8), (2, 8), (2, 3), (1, 5)), ('high_dim_same_proj', (4, 2, 3, 8), (1, 1, 5, 8), (1, 1, 5, 2), None), ('high_dim_different_proj', (4, 2, 3, 8), (1, 1, 5, 8), (1, 1, 5, 2), (3, 2)))
    def test_compute_output_shape(self, query_dims, value_dims, key_dims, output_shape):
        ...
        layer = layers.MultiHeadAttention(num_heads=2, key_dim=2, value_dim=2, output_shape=output_shape)
        batch_size = 7
    ...
    @parameterized.named_parameters(('query_value_dim_mismatch', (2, 4, 8), (2, 2, 7), 2), ('key_value_dim_mismatch', (2, 4, 8), (2, 2, 8), (2, 1, 7)), ('key_value_dim_mismatch_high_dim', (2, 4, 2, 3, 8), (2, 1, 1, 5, 8), (2, 1, 15, 5, 2)))
    ...
    def test_initializer(self):
        if False:
            for i in range(10):
                print('nop')
        layer = layers.MultiHeadAttention(num_heads=12, key_dim=64, kernel_initializer=initializers.TruncatedNormal(stddev=0.02))
