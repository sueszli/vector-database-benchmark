...
from prowler.providers.aws.services.cloudformation.cloudformation_service import CloudFormation
from prowler.providers.common.models import Audit_Metadata
AWS_REGION = 'eu-west-1'
dummy_template = {'AWSTemplateFormatVersion': '2010-09-09', 'Description': 'Stack 1', 'Resources': {'EC2Instance1': {'Type': 'AWS::EC2::Instance', 'Properties': {'ImageId': 'EXAMPLE_AMI_ID', 'KeyName': 'dummy', 'InstanceType': 't2.micro', 'Tags': [{'Key': 'Description', 'Value': 'Test tag'}, {'Key': 'Name', 'Value': 'Name tag for tests'}]}}}}
