...
SEG_STRUCT = [('>L', 'number'), ('>B', 'flags'), ('>B', 'retention_flags'), ('>B', 'page_assoc'), ('>L', 'data_length')]
...
JBIG2Segment = Dict[str, Union[bool, int, bytes, JBIG2SegmentFlags, JBIG2RetentionFlags]]
