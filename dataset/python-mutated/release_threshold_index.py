...
class ReleaseThresholdIndexGETValidator(serializers.Serializer):
    environment = serializers.ListField(required=False, allow_empty=True, child=serializers.CharField())
    project = serializers.ListField(required=True, allow_empty=False, child=serializers.IntegerField())
