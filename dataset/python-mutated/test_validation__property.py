...
from bokeh.core.properties import Angle, AngleSpec, Bool, Color, ColorSpec, ColumnData, Complex, DashPattern, Date, Datetime, Dict, DistanceSpec, Either, Enum, Float, FontSize, FontSizeSpec, Instance, Int, Interval, List, MarkerType, MinMaxBounds, NumberSpec, Percent, Regex, Seq, Size, SizeSpec, String, StringSpec, Tuple
...
SPECS = (AngleSpec, ColorSpec, DistanceSpec, FontSizeSpec, NumberSpec, SizeSpec, StringSpec)
