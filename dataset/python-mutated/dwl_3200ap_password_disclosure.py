...
class Exploit(HTTPClient):
    __info__ = {'name': 'D-Link DWL-3200AP Password Disclosure', 'description': 'Exploits D-Link DWL3200 access points weak cookie value.', 'authors': ('pws', 'Josh Abraham <sinisterpatrician[at]google.com>'), 'references': ('https://www.exploit-db.com/exploits/34206/',), 'devices': ('D-Link DWL-3200AP',)}
