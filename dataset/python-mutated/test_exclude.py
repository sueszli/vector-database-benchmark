...
CANDIDATE_NAMES = ['/foo/bar/baz/a.py', 'bar/baz', 'bar/baz/foo/a.py', 'bar/baz/foo/b.py', 'bar/baz/foo/c.py', 'bar/baz/qux/foo/a.py', 'bar/foo/baz/bar.go', 'bar/foo/foo.py', 'baz.go', 'baz.java', 'baz.py', 'baz/foo', 'foo', 'foo.go', 'foo.java', 'foo.py', 'foo/bar.go', 'foo/bar.java', 'foo/bar.py']
...
EQUIVALENT_PATTERNS = ['baz/qux', '/baz/qux', 'baz/qux/', '/baz/qux/', '**/baz/qux', 'baz/qux/**', '**/baz/qux/**']
