...
from ..utils import determine_ext, float_or_none, int_or_none, smuggle_url, try_get, unsmuggle_url, ExtractorError
...
class LimelightMediaIE(LimelightBaseIE):
    ...
    _TESTS = [{'url': 'http://link.videoplatform.limelight.com/media/?mediaId=3ffd040b522b4485b6d84effc750cd86', 'info_dict': {'id': '3ffd040b522b4485b6d84effc750cd86', 'ext': 'mp4', 'title': 'HaP and the HB Prince Trailer', 'description': 'md5:8005b944181778e313d95c1237ddb640', 'thumbnail': 're:^https?://.*\\.jpeg$', 'duration': 144.23}, 'params': {'skip_download': True}}, {'url': 'limelight:media:a3e00274d4564ec4a9b29b9466432335', 'md5': '2fa3bad9ac321e23860ca23bc2c69e3d', 'info_dict': {'id': 'a3e00274d4564ec4a9b29b9466432335', 'ext': 'mp4', 'title': '3Play Media Overview Video', 'thumbnail': 're:^https?://.*\\.jpeg$', 'duration': 78.101, 'subtitles': 'mincount:1'}}, {'url': 'https://assets.delvenetworks.com/player/loader.swf?mediaId=8018a574f08d416e95ceaccae4ba0452', 'only_matching': True}]
