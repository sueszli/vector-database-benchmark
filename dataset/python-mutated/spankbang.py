...
from ..utils import determine_ext, ExtractorError, merge_dicts, parse_duration, parse_resolution, str_to_int, url_or_none, urlencode_postdata, urljoin

class SpankBangIE(InfoExtractor):
    _VALID_URL = '(?x)\n                    https?://\n                        (?:[^/]+\\.)?spankbang\\.com/\n                        (?:\n                            (?P<id>[\\da-z]+)/(?:video|play|embed)\\b|\n                            [\\da-z]+-(?P<id_2>[\\da-z]+)/playlist/[^/?#&]+\n                        )\n                    '
    _TESTS = [{'url': 'https://spankbang.com/56b3d/video/the+slut+maker+hmv', 'md5': '2D13903DE4ECC7895B5D55930741650A', 'info_dict': {'id': '56b3d', 'ext': 'mp4', 'title': 'The Slut Maker HMV', 'description': 'Girls getting converted into cock slaves.', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'Mindself', 'uploader_id': 'mindself', 'timestamp': 1617109572, 'upload_date': '20210330', 'age_limit': 18}}, {'url': 'http://spankbang.com/1vt0/video/solvane+gangbang', 'only_matching': True}, {'url': 'http://spankbang.com/lklg/video/sex+with+anyone+wedding+edition+2', 'only_matching': True}, {'url': 'http://m.spankbang.com/1o2de/video/can+t+remember+her+name', 'only_matching': True}, {'url': 'https://spankbang.com/1vwqx/video/jade+kush+solo+4k', 'only_matching': True}, {'url': 'https://m.spankbang.com/3vvn/play/fantasy+solo/480p/', 'only_matching': True}, {'url': 'https://m.spankbang.com/3vvn/play', 'only_matching': True}, {'url': 'https://spankbang.com/2y3td/embed/', 'only_matching': True}, {'url': 'https://spankbang.com/2v7ik-7ecbgu/playlist/latina+booty', 'only_matching': True}]
...
class SpankBangPlaylistIE(InfoExtractor):
    ...
    _TEST = {'url': 'https://spankbang.com/ug0k/playlist/big+ass+titties', 'info_dict': {'id': 'ug0k', 'title': 'Big Ass Titties'}, 'playlist_mincount': 40}
