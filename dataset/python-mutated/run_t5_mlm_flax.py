...
from transformers import CONFIG_MAPPING, FLAX_MODEL_FOR_MASKED_LM_MAPPING, AutoTokenizer, BatchEncoding, FlaxT5ForConditionalGeneration, HfArgumentParser, PreTrainedTokenizerBase, T5Config, is_tensorboard_available, set_seed
...
class DataTrainingArguments:
    ...
    mlm_probability: float = field(default=0.15, metadata={'help': 'Ratio of tokens to mask for span masked language modeling loss'})
    mean_noise_span_length: float = field(default=3.0, metadata={'help': 'Mean span length of masked tokens'})
