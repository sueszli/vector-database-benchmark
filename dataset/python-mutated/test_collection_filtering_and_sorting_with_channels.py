...
@pytest.mark.parametrize('sort_by', [{'field': 'AVAILABILITY', 'direction': 'ASC'}, {'field': 'PUBLISHED_AT', 'direction': 'DESC'}])
...
@pytest.mark.parametrize(('sort_by', 'collections_order'), [({'field': 'AVAILABILITY', 'direction': 'ASC'}, ['Collection2', 'Collection3', 'Collection4', 'Collection1']), ({'field': 'AVAILABILITY', 'direction': 'DESC'}, ['Collection1', 'Collection4', 'Collection3', 'Collection2']), ({'field': 'PUBLISHED_AT', 'direction': 'ASC'}, ['Collection4', 'Collection3', 'Collection1', 'Collection2']), ({'field': 'PUBLISHED_AT', 'direction': 'DESC'}, ['Collection2', 'Collection1', 'Collection3', 'Collection4'])])
...
@pytest.mark.parametrize(('sort_by', 'collections_order'), [({'field': 'AVAILABILITY', 'direction': 'ASC'}, ['Collection1', 'Collection3', 'Collection5', 'Collection2']), ({'field': 'AVAILABILITY', 'direction': 'DESC'}, ['Collection2', 'Collection5', 'Collection3', 'Collection1']), ({'field': 'PUBLISHED_AT', 'direction': 'ASC'}, ['Collection5', 'Collection3', 'Collection1', 'Collection2']), ({'field': 'PUBLISHED_AT', 'direction': 'DESC'}, ['Collection2', 'Collection1', 'Collection3', 'Collection5'])])
...
@pytest.mark.parametrize('sort_by', [{'field': 'AVAILABILITY', 'direction': 'ASC'}, {'field': 'PUBLISHED_AT', 'direction': 'ASC'}])
...
@pytest.mark.parametrize('sort_by', [{'field': 'AVAILABILITY', 'direction': 'DESC'}, {'field': 'PUBLISHED_AT', 'direction': 'DESC'}])
...
def test_collections_with_filtering_without_channel(staff_api_client, permission_manage_products):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize(('filter_by', 'collections_count'), [({'published': 'PUBLISHED'}, 1), ({'published': 'HIDDEN'}, 3), ({'slugs': ['collection1']}, 1), ({'slugs': ['collection2', 'collection3']}, 2), ({'slugs': []}, 4)])
def test_collections_with_filtering_with_channel_USD(filter_by, collections_count, staff_api_client, permission_manage_products, collections_for_sorting_with_channels, channel_USD):
    if False:
        i = 10
        return i + 15
...
@pytest.mark.parametrize(('filter_by', 'collections_count'), [({'published': 'PUBLISHED'}, 1), ({'published': 'HIDDEN'}, 3)])
def test_collections_with_filtering_with_channel_PLN(filter_by, collections_count, staff_api_client, permission_manage_products, collections_for_sorting_with_channels, channel_PLN):
    if False:
        for i in range(10):
            print('nop')
...
@pytest.mark.parametrize('filter_by', [{'published': 'PUBLISHED'}, {'published': 'HIDDEN'}, {'slugs': ['collection1']}])
def test_collections_with_filtering_and_not_existing_channel(filter_by, staff_api_client, permission_manage_products, collections_for_sorting_with_channels, channel_USD):
    if False:
        print('Hello World!')
...
def test_collections_where_by_ids(api_client, collection_list, channel_USD):
    if False:
        while True:
            i = 10
    ids = [graphene.Node.to_global_id('Collection', collection.pk) for collection in collection_list[:2]]
    ...
    assert returned_slugs == {collection_list[0].slug, collection_list[1].slug}
