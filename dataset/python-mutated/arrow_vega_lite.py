...
_CHANNELS = {'x', 'y', 'x2', 'y2', 'xError', 'yError2', 'xError', 'yError2', 'longitude', 'latitude', 'color', 'opacity', 'fillOpacity', 'strokeOpacity', 'strokeWidth', 'size', 'shape', 'text', 'tooltip', 'href', 'key', 'order', 'detail', 'facet', 'row', 'column'}