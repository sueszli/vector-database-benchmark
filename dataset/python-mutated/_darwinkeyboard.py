...
class KeyMap(object):
    non_layout_keys = dict(((vk, normalize_name(name)) for (vk, name) in {36: 'return', 48: 'tab', 49: 'space', 51: 'delete', 53: 'escape', 55: 'command', 56: 'shift', 57: 'capslock', 58: 'option', 59: 'control', 60: 'right shift', 61: 'right option', 62: 'right control', 63: 'function', 64: 'f17', 72: 'volume up', 73: 'volume down', 74: 'mute', 79: 'f18', 80: 'f19', 90: 'f20', 96: 'f5', 97: 'f6', 98: 'f7', 99: 'f3', 100: 'f8', 101: 'f9', 103: 'f11', 105: 'f13', 106: 'f16', 107: 'f14', 109: 'f10', 111: 'f12', 113: 'f15', 114: 'help', 115: 'home', 116: 'page up', 117: 'forward delete', 118: 'f4', 119: 'end', 120: 'f2', 121: 'page down', 122: 'f1', 123: 'left', 124: 'right', 125: 'down', 126: 'up'}.items()))
