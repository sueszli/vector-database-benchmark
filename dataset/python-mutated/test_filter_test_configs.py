...
import yaml
from filter_test_configs import filter, get_labels, mark_unstable_jobs, parse_reenabled_issues, perform_misc_tasks, PREFIX, remove_disabled_jobs, set_periodic_modes, SUPPORTED_PERIODICAL_MODES, VALID_TEST_CONFIG_LABELS
MOCKED_DISABLED_UNSTABLE_JOBS = {'pull / mock-platform-1': ['pytorchbot', '1', 'https://github.com/pytorch/pytorch/issues/1', 'pull', 'mock-platform-1', ''], 'trunk / mock-platform-2 / build': ['pytorchbot', '2', 'https://github.com/pytorch/pytorch/issues/2', 'trunk', 'mock-platform-2', 'build'], 'periodic / mock-platform-3 / test': ['pytorchbot', '3', 'https://github.com/pytorch/pytorch/issues/3', 'periodic', 'mock-platform-3', 'test'], 'pull / mock-platform-4 / build-and-test': ['pytorchbot', '4', 'https://github.com/pytorch/pytorch/issues/4', 'pull', 'mock-platform-4', 'build-and-test'], 'trunk / mock-platform-5 / test (backward_compat)': ['pytorchbot', '5', 'https://github.com/pytorch/pytorch/issues/5', 'trunk', 'mock-platform-5', 'test (backward_compat)'], 'periodic / mock-platform-6 / build-and-test (default)': ['pytorchbot', '6', 'https://github.com/pytorch/pytorch/issues/6', 'periodic', 'mock-platform-6', 'build-and-test (default)'], 'pull / mock-platform-7 / test [invalid syntax]': ['pytorchbot', '7', 'https://github.com/pytorch/pytorch/issues/7', 'pull', 'mock-platform-7', 'test [invalid syntax]'], 'trunk / mock-platform-8 / build (dynamo)': ['pytorchbot', '8', 'https://github.com/pytorch/pytorch/issues/8', 'trunk', 'mock-platform-8', 'build (dynamo)'], 'linux-binary-libtorch-cxx11-abi / libtorch-cpu-shared-with-deps-cxx11-abi-test / test': ['pytorchbot', '9', 'https://github.com/pytorch/pytorch/issues/9', 'linux-binary-libtorch-cxx11-abi', 'libtorch-cpu-shared-with-deps-cxx11-abi-test', 'test'], 'linux-binary-manywheel / manywheel-py3_8-cuda11_8-build': ['pytorchbot', '10', 'https://github.com/pytorch/pytorch/issues/10', 'linux-binary-manywheel', 'manywheel-py3_8-cuda11_8-build', ''], 'inductor / cuda12.1-py3.10-gcc9-sm86 / test (inductor)': ['pytorchbot', '107079', 'https://github.com/pytorch/pytorch/issues/107079', 'inductor', 'cuda12.1-py3.10-gcc9-sm86', 'test (inductor)'], 'inductor / cuda12.1-py3.10-gcc9-sm86 / test (inductor_huggingface)': ['pytorchbot', '109153', 'https://github.com/pytorch/pytorch/issues/109153', 'inductor', 'cuda12.1-py3.10-gcc9-sm86', 'test (inductor_huggingface)'], 'inductor / cuda12.1-py3.10-gcc9-sm86 / test (inductor_huggingface_dynamic)': ['pytorchbot', '109154', 'https://github.com/pytorch/pytorch/issues/109154', 'inductor', 'cuda12.1-py3.10-gcc9-sm86', 'test (inductor_huggingface_dynamic)']}
MOCKED_PR_INFO = {'url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338', 'repository_url': 'https://api.github.com/repos/pytorch/pytorch', 'labels_url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338/labels{/name}', 'comments_url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338/comments', 'events_url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338/events', 'html_url': 'https://github.com/pytorch/pytorch/pull/10338', 'id': 348543815, 'node_id': 'MDExOlB1bGxSZXF1ZXN0MjA2ODcwMTUy', 'number': 10338, 'title': 'Add matrix_rank', 'user': {'login': 'vishwakftw', 'id': 23639302, 'node_id': 'MDQ6VXNlcjIzNjM5MzAy', 'avatar_url': 'https://avatars.githubusercontent.com/u/23639302?v=4', 'gravatar_id': '', 'url': 'https://api.github.com/users/vishwakftw', 'html_url': 'https://github.com/vishwakftw', 'followers_url': 'https://api.github.com/users/vishwakftw/followers', 'following_url': 'https://api.github.com/users/vishwakftw/following{/other_user}', 'gists_url': 'https://api.github.com/users/vishwakftw/gists{/gist_id}', 'starred_url': 'https://api.github.com/users/vishwakftw/starred{/owner}{/repo}', 'subscriptions_url': 'https://api.github.com/users/vishwakftw/subscriptions', 'organizations_url': 'https://api.github.com/users/vishwakftw/orgs', 'repos_url': 'https://api.github.com/users/vishwakftw/repos', 'events_url': 'https://api.github.com/users/vishwakftw/events{/privacy}', 'received_events_url': 'https://api.github.com/users/vishwakftw/received_events', 'type': 'User', 'site_admin': False}, 'labels': [{'id': 1392590051, 'node_id': 'MDU6TGFiZWwxMzkyNTkwMDUx', 'url': 'https://api.github.com/repos/pytorch/pytorch/labels/open%20source', 'name': 'open source', 'color': 'ededed', 'default': False, 'description': None}, {'id': 1392590051, 'node_id': 'MDU6TGFiZWwxMzkyNTkwMDUx', 'url': 'https://api.github.com/repos/pytorch/pytorch/labels/open%20source', 'name': 'foo', 'color': 'ededed', 'default': False, 'description': None}, {'id': 1392590051, 'node_id': 'MDU6TGFiZWwxMzkyNTkwMDUx', 'url': 'https://api.github.com/repos/pytorch/pytorch/labels/open%20source', 'name': '', 'color': 'ededed', 'default': False, 'description': None}], 'state': 'closed', 'locked': False, 'assignee': None, 'assignees': [], 'milestone': None, 'comments': 9, 'created_at': '2018-08-08T01:39:20Z', 'updated_at': '2019-06-24T21:05:45Z', 'closed_at': '2018-08-23T01:58:38Z', 'author_association': 'CONTRIBUTOR', 'active_lock_reason': None, 'draft': False, 'pull_request': {'url': 'https://api.github.com/repos/pytorch/pytorch/pulls/10338', 'html_url': 'https://github.com/pytorch/pytorch/pull/10338', 'diff_url': 'https://github.com/pytorch/pytorch/pull/10338.diff', 'patch_url': 'https://github.com/pytorch/pytorch/pull/10338.patch', 'merged_at': None}, 'body': '- Similar functionality as NumPy\r\n- Added doc string\r\n- Added tests\r\n\r\ncc: @SsnL \r\n\r\nCloses #10292 ', 'closed_by': {'login': 'vishwakftw', 'id': 23639302, 'node_id': 'MDQ6VXNlcjIzNjM5MzAy', 'avatar_url': 'https://avatars.githubusercontent.com/u/23639302?v=4', 'gravatar_id': '', 'url': 'https://api.github.com/users/vishwakftw', 'html_url': 'https://github.com/vishwakftw', 'followers_url': 'https://api.github.com/users/vishwakftw/followers', 'following_url': 'https://api.github.com/users/vishwakftw/following{/other_user}', 'gists_url': 'https://api.github.com/users/vishwakftw/gists{/gist_id}', 'starred_url': 'https://api.github.com/users/vishwakftw/starred{/owner}{/repo}', 'subscriptions_url': 'https://api.github.com/users/vishwakftw/subscriptions', 'organizations_url': 'https://api.github.com/users/vishwakftw/orgs', 'repos_url': 'https://api.github.com/users/vishwakftw/repos', 'events_url': 'https://api.github.com/users/vishwakftw/events{/privacy}', 'received_events_url': 'https://api.github.com/users/vishwakftw/received_events', 'type': 'User', 'site_admin': False}, 'reactions': {'url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338/reactions', 'total_count': 2, '+1': 2, '-1': 0, 'laugh': 0, 'hooray': 0, 'confused': 0, 'heart': 0, 'rocket': 0, 'eyes': 0}, 'timeline_url': 'https://api.github.com/repos/pytorch/pytorch/issues/10338/timeline', 'performed_via_github_app': None, 'state_reason': None}
