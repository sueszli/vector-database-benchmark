...
_CONFIG_MAP: Dict[check.TypeOrTupleOfTypes, ConfigType] = {BuiltinEnum.ANY: ConfigAnyInstance, BuiltinEnum.BOOL: ConfigBoolInstance, BuiltinEnum.FLOAT: ConfigFloatInstance, BuiltinEnum.INT: ConfigIntInstance, BuiltinEnum.STRING: ConfigStringInstance}
_CONFIG_MAP_BY_NAME: Dict[str, ConfigType] = {'Any': ConfigAnyInstance, 'Bool': ConfigBoolInstance, 'Float': ConfigFloatInstance, 'Int': ConfigIntInstance, 'String': ConfigStringInstance}
