...
class Exploit(HTTPClient):
    __info__ = {'name': '3Com OfficeConnect Info Disclosure', 'description': 'Exploits 3Com OfficeConnect information disclosure vulnerability. If the target is vulnerable it is possible to read sensitive information.', 'authors': ('Luca Carettoni <luca.carettoni[at]ikkisoft.com>', 'iDefense', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('http://old.sebug.net/paper/Exploits-Archives/2009-exploits/0902-exploits/LC-2008-05.txt', 'http://seclists.org/vulnwatch/2005/q1/42'), 'devices': ('3Com OfficeConnect',)}
