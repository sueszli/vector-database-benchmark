...
from terminal.serializers import AppletHostSerializer, AppletHostDeploymentSerializer, AppletHostStartupSerializer
...
class AppletHostViewSet(JMSBulkModelViewSet):
    ...
    rbac_perms = {'generate_accounts': 'terminal.change_applethost'}
...
class AppletHostDeploymentViewSet(viewsets.ModelViewSet):
    ...
    rbac_perms = (('applets', 'terminal.view_AppletHostDeployment'),)
