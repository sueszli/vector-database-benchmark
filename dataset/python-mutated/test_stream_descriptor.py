...
class TestRecoverOldStreamDescriptors(AsyncioTestCase):
    ...
    async def test_old_key_sort_sd_blob(self):
        ...
        sd_bytes = b'{"stream_name": "4f62616d6120446f6e6b65792d322e73746c", "blobs": [{"length": 1153488, "blob_num": 0, "blob_hash": "9fa32a249ce3f2d4e46b78599800f368b72f2a7f22b81df443c7f6bdbef496bd61b4c0079c73d79c8bb9be9a6bf86592", "iv": "0bf348867244019c9e22196339016ea6"}, {"length": 0, "blob_num": 1, "iv": "9f36abae16955463919b07ed530a3d18"}], "stream_type": "lbryfile", "key": "a03742b87628aa7228e48f1dcd207e48", "suggested_file_name": "4f62616d6120446f6e6b65792d322e73746c", "stream_hash": "b43f4b1379780caf60d20aa06ac38fb144df61e514ebfa97537018ba73bce8fe37ae712f473ff0ba0be0eef44e160207"}'
        ...
        descriptor = await StreamDescriptor.from_stream_descriptor_blob(loop, blob_manager.blob_dir, blob)
    ...
    async def test_decode_corrupt_blob_raises_proper_exception_and_deletes_corrupt_file(self):
        ...
        with self.assertRaises(InvalidStreamDescriptorError):
            await StreamDescriptor.from_stream_descriptor_blob(loop, tmp_dir, blob)
