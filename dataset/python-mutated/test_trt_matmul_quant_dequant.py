...
class TensorRTMatMulQuantDequantDims4TransposeXDynamicTest(TensorRTMatMulQuantDequantDims3DynamicTest):
...
class TensorRTMatMulQuantDequantDims4TransposeYDynamicTest(TensorRTMatMulQuantDequantDims3DynamicTest):
...
class TensorRTMatMulQuantDequantDims4TransposeXYDynamicTest(TensorRTMatMulQuantDequantDims3DynamicTest):
