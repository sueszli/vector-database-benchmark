...
import numpy
from ..core import get_remote_file, load_lib, Dict, resource_dirs, string_types, binary_type, IS_PYPY, get_platform, InternetNotAllowedError
TEST_NUMPY_NO_STRIDES = False
FNAME_PER_PLATFORM = {'osx32': 'libfreeimage-3.16.0-osx10.6.dylib', 'osx64': 'libfreeimage-3.16.0-osx10.6.dylib', 'win32': 'FreeImage-3.15.4-win32.dll', 'win64': 'FreeImage-3.15.1-win64.dll', 'linux32': 'libfreeimage-3.16.0-linux32.so', 'linux64': 'libfreeimage-3.16.0-linux64.so'}
...
GREY_PALETTE = numpy.arange(0, 16777216, 65793, dtype=numpy.uint32)
