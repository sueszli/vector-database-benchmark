...
def build_query_by_pipeline_run_request(resource_group_name: str, factory_name: str, run_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        for i in range(10):
            print('nop')
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/pipelineruns/{runId}/queryActivityruns')
    path_format_arguments = {'subscriptionId': _SERIALIZER.url('subscription_id', subscription_id, 'str'), 'resourceGroupName': _SERIALIZER.url('resource_group_name', resource_group_name, 'str', max_length=90, min_length=1, pattern='^[-\\w\\._\\(\\)]+$'), 'factoryName': _SERIALIZER.url('factory_name', factory_name, 'str', max_length=63, min_length=3, pattern='^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'), 'runId': _SERIALIZER.url('run_id', run_id, 'str')}
...
class ActivityRunsOperations:
    ...
    @overload
    def query_by_pipeline_run(self, resource_group_name: str, factory_name: str, run_id: str, filter_parameters: _models.RunFilterParameters, *, content_type: str='application/json', **kwargs: Any) -> _models.ActivityRunsQueryResponse:
        if False:
            while True:
                i = 10
    ...
    @overload
    def query_by_pipeline_run(self, resource_group_name: str, factory_name: str, run_id: str, filter_parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ActivityRunsQueryResponse:
        if False:
            for i in range(10):
                print('nop')
    ...
    @distributed_trace
    def query_by_pipeline_run(self, resource_group_name: str, factory_name: str, run_id: str, filter_parameters: Union[_models.RunFilterParameters, IO], **kwargs: Any) -> _models.ActivityRunsQueryResponse:
        if False:
            return 10
