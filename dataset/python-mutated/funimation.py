...
from ..utils import ExtractorError, determine_ext, int_or_none, join_nonempty, js_to_json, make_archive_id, orderedSet, qualities, str_or_none, traverse_obj, try_get, urlencode_postdata
...
class FunimationPageIE(FunimationBaseIE):
    ...
    _TESTS = [{'url': 'https://www.funimation.com/shows/attack-on-titan-junior-high/broadcast-dub-preview/', 'info_dict': {'id': '210050', 'ext': 'mp4', 'title': 'Broadcast Dub Preview'}, 'params': {'skip_download': 'm3u8'}, 'add_ie': ['Funimation']}, {'url': 'https://www.funimation.com/shows/hacksign/role-play/', 'only_matching': True}, {'url': 'https://www.funimation.com/en/shows/hacksign/role-play/', 'only_matching': True}, {'url': 'https://www.funimationnow.uk/shows/puzzle-dragons-x/drop-impact/simulcast/', 'only_matching': True}, {'url': 'https://www.funimation.com/v/a-certain-scientific-railgun/super-powered-level-5', 'only_matching': True}]
...
class FunimationIE(FunimationBaseIE):
    ...
    _TESTS = [{'url': 'https://www.funimation.com/player/210051', 'info_dict': {'id': '210050', 'display_id': 'broadcast-dub-preview', 'ext': 'mp4', 'title': 'Broadcast Dub Preview', 'thumbnail': 're:https?://.*\\.(?:jpg|png)', 'episode': 'Broadcast Dub Preview', 'episode_id': '210050', 'season': 'Extras', 'season_id': '166038', 'season_number': 99, 'series': 'Attack on Titan: Junior High', 'description': '', 'duration': 155}, 'params': {'skip_download': 'm3u8'}}, {'note': 'player_id should be extracted with the relevent compat-opt', 'url': 'https://www.funimation.com/player/210051', 'info_dict': {'id': '210051', 'display_id': 'broadcast-dub-preview', 'ext': 'mp4', 'title': 'Broadcast Dub Preview', 'thumbnail': 're:https?://.*\\.(?:jpg|png)', 'episode': 'Broadcast Dub Preview', 'episode_id': '210050', 'season': 'Extras', 'season_id': '166038', 'season_number': 99, 'series': 'Attack on Titan: Junior High', 'description': '', 'duration': 155}, 'params': {'skip_download': 'm3u8', 'compat_opts': ['seperate-video-versions']}}]
...
class FunimationShowIE(FunimationBaseIE):
    ...
    _TESTS = [{'url': 'https://www.funimation.com/en/shows/sk8-the-infinity', 'info_dict': {'id': 1315000, 'title': 'SK8 the Infinity'}, 'playlist_count': 13, 'params': {'skip_download': True}}, {'url': 'https://www.funimation.com/shows/ouran-high-school-host-club/', 'info_dict': {'id': 39643, 'title': 'Ouran High School Host Club'}, 'playlist_count': 26, 'params': {'skip_download': True}}]
