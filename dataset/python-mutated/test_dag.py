...
from airflow.exceptions import AirflowException, DuplicateTaskIdFound, ParamValidationError, RemovedInAirflow3Warning
from airflow.models.baseoperator import BaseOperator
from airflow.models.dag import DAG, DagModel, DagOwnerAttributes, DagTag, dag as dag_decorator, get_dataset_triggered_next_run_info
...
class TestDagDecorator:
    DEFAULT_ARGS = {'owner': 'test', 'depends_on_past': True, 'start_date': timezone.utcnow(), 'retries': 1, 'retry_delay': timedelta(minutes=1)}
