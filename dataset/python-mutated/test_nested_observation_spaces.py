...
TUPLE_SPACE = spaces.Tuple([spaces.Box(low=-100, high=100, shape=(3,)), spaces.Tuple((spaces.Box(low=0, high=1, shape=(10, 10, 3)), spaces.Box(low=0, high=1, shape=(10, 10, 3)))), spaces.Discrete(5)])
...
PLAYER_SPACE = spaces.Dict({'location': spaces.Box(-100, 100, shape=(2,)), 'items': Repeated(ITEM_SPACE, max_len=MAX_ITEMS), 'effects': Repeated(EFFECT_SPACE, max_len=MAX_EFFECTS), 'status': spaces.Box(-1, 1, shape=(10,))})
