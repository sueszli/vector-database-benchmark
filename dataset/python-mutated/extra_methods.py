...
TYPE_EXTRA_METHODS = {'Checkout': extra_checkout_actions, 'Collection': extra_collection_actions, 'Fulfillment': extra_fulfillment_actions, 'GiftCard': extra_gift_card_actions, 'Channel': extra_channel_actions, 'Order': extra_order_actions, 'Product': extra_product_actions, 'ProductVariant': extra_variant_actions, 'ShippingZone': extra_shipping_zone_actions, 'Shop': extra_shop_actions, 'TransactionItem': extra_transaction_item_actions, 'User': extra_user_actions, 'Warehouse': extra_warehouse_actions, 'Voucher': extra_voucher_actions}
TYPE_EXTRA_PREFETCH = {'Product': Product.objects.prefetched_for_webhook, 'ProductVariant': ProductVariant.objects.prefetched_for_webhook}