...
class AudioClassificationConfig(FairseqDataclass):
    model_path: str = field(default=MISSING, metadata={'help': 'path to wav2vec 2.0 model'})
    ...
    conv_feature_layers: Optional[str] = field(default=None, metadata={'help': 'string describing convolutional feature extraction layers in form of a python list that contains [(dim, kernel_size, stride), ...]'})
