...
class DebugInfo:
    ...
    async def get_cli_text(self) -> str:
        ...
        for section in (self._get_system_metadata_section(), self._get_os_variables_section(), await self._get_red_vars_section()):
            parts.append('')
    ...
    async def _get_red_vars_section(self) -> DebugInfoSection:
        ...
        if instance_name is None:
            return DebugInfoSection('Red variables', f'Metadata file: {data_manager.config_file}')
        ...
        return DebugInfoSection('Red variables', '\n'.join(parts))