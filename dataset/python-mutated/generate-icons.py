...
class Converter(object):
    converters = {'appstore': {'directory_name': 'ios', 'sizes': [('App store high resolution', '{}-appstore-1024.png', 1024), ('App store normal resolution', '{}-appstore-512.png', 512), ('iPhone (iOS 7)', '{}-60.png', 120), ('iPhone @2 (iOS 7)', '{}-60@2x.png', 120), ('iPad (iOS 7)', '{}-76.png', 76), ('iPad @2 (iOS 7)', '{}-60@2x.png', 152), ('iPhone (iOS >= 6.1)', '{}-57.png', 57), ('iPhone @2 (iOS >= 6.1)', '{}-57@2x.png', 114), ('iPad (iOS >= 6.1)', '{}-72.png', 72), ('iPad @2 (iOS >= 6.1)', '{}-72@2x.png', 114), ('iTunes Artwork (ad-hoc)', 'iTunesArtwork', 512), ('iTunes Artwork @2 (ad-hoc)', 'iTunesArtwork@2x', 1024)]}, 'playstore': {'directory_name': 'android', 'sizes': [('Google Play icon', '{}-googleplay-512.png', 512), ('Launcher icon MDPI', '{}-48.png', 48), ('Launcher icon HDPI', '{}-72.png', 72), ('Launcher icon XHDPI', '{}-96.png', 96), ('Launcher icon XXHDPI', '{}-144.png', 48), ('Launcher icon XXXHDPI', '{}-192.png', 192)]}, 'amazonstore': {'directory_name': 'amazon', 'sizes': [('Small icon', '{}-114.png', 114), ('Large icon', '{}-512.png', 512)]}}
