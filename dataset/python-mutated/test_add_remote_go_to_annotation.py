...
class TestAddRemoteGoToAnnotation(TestCase):
    ...
    def test_add_remote_go_to_annotation(self):
        ...
        pdf.get_page(0).add_annotation(RemoteGoToAnnotation(bounding_box=Rectangle(w / Decimal(2) - Decimal(32), h / Decimal(2) - Decimal(32), Decimal(64), Decimal(64)), uri='https://www.borbpdf.com'))
