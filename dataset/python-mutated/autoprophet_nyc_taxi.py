...
if __name__ == '__main__':
    ...
    parser.add_argument('--cpus_per_trial', type=int, default=1, help='Int. Number of cpus for each trial')
    parser.add_argument('--n_sampling', type=int, default=32, help='Number of times to sample from the search_space.')
    ...
    print('Autoprophet improve the mse by', str((nonauto_searched_mse - auto_searched_mse) / nonauto_searched_mse * 100), '%')
