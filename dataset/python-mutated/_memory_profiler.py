...
import logging
from typing import Any, cast, DefaultDict, Dict, Iterator, List, Optional, Set, Tuple, Union
from typing_extensions import Literal
import torch
from torch._C import FunctionSchema
from torch._C._autograd import _ProfilerResult
from torch._C._profiler import _EventType, _ExtraFields_Allocation, _ExtraFields_TorchOp, _ProfilerEvent, _TensorMetadata, RecordScope
...
_CATEGORY_TO_COLORS = {Category.PARAMETER: 'darkgreen', Category.OPTIMIZER_STATE: 'goldenrod', Category.INPUT: 'black', Category.TEMPORARY: 'mediumpurple', Category.ACTIVATION: 'red', Category.GRADIENT: 'mediumblue', Category.AUTOGRAD_DETAIL: 'royalblue', None: 'grey'}
