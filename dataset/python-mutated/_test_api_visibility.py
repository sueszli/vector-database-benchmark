...
import unittest
import turicreate
MODULES = ['aws', 'clustering', 'data_structures', 'graph_analytics', 'data_matching', 'recommender']
CLUSTER = ['kmeans', 'dbscan']
RECOMMENDERS = ['popularity_recommender', 'item_similarity_recommender', 'factorization_recommender', 'ranking_factorization_recommender', 'item_content_recommender']
ANOMALY_DETECTION = ['local_outlier_factor', 'moving_zscore', 'bayesian_changepoints']
DATA_MATCHING = ['autotagger', 'deduplication', 'nearest_neighbor_deduplication', 'nearest_neighbor_autotagger', 'record_linker', 'similarity_search']
DATA_STRUCTURES = ['SFrame', 'SArray', 'Graph', 'Vertex', 'Edge']
GRAPH_ANALYTICS = ['connected_components', 'graph_coloring', 'kcore', 'load_sgraph', 'pagerank', 'triangle_counting', 'shortest_path']
