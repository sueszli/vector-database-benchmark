...
class RestoreStateData:
    ...
    async def async_get_instance(cls, hass: HomeAssistant) -> RestoreStateData:
        ...
        report('restore_state.RestoreStateData.async_get_instance is deprecated, and not intended to be called by custom components; Pleaserefactor your code to use RestoreEntity instead; restore_state.async_get(hass) can be used in the meantime')
    ...
    async def async_load(self) -> None:
        ...
        if stored_states is None:
            ...
            self.last_states = {item['state']['entity_id']: StoredState.from_dict(item) for item in stored_states if valid_entity_id(item['state']['entity_id'])}
    ...
    async def async_dump_states(self) -> None:
        ...
        try:
            await self.store.async_save([stored_state.as_dict() for stored_state in self.async_get_stored_states()])
        except HomeAssistantError as exc:
...
class RestoreEntity(Entity):
    ...
    async def async_internal_will_remove_from_hass(self) -> None:
        ...
        async_get(self.hass).async_restore_entity_removed(self.entity_id, self.extra_restore_state_data)
