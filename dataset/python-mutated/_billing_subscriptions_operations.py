...
class BillingSubscriptionsOperations:
    ...
    def get(self, billing_account_name: str, **kwargs: Any) -> _models.BillingSubscription:
        ...
        return deserialized
    get.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}'}
    ...
    def update(self, billing_account_name: str, parameters: Union[_models.BillingSubscription, IO], **kwargs: Any) -> _models.BillingSubscription:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    update.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}'}
    ...
    def _move_initial(self, billing_account_name: str, parameters: Union[_models.TransferBillingSubscriptionRequestProperties, IO], **kwargs: Any) -> Optional[_models.BillingSubscription]:
        ...
        return deserialized
    _move_initial.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/move'}
    ...
    begin_move.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/move'}
    ...
    def validate_move(self, billing_account_name: str, parameters: Union[_models.TransferBillingSubscriptionRequestProperties, IO], **kwargs: Any) -> _models.ValidateSubscriptionTransferEligibilityResult:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    validate_move.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/validateMoveEligibility'}