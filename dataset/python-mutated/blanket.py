...
from typing import Any, Callable, NamedTuple, Optional, Type, Union, Dict, overload
import flask
import ckan.plugins as p
from ckan.authz import get_local_functions
__all__ = ['helpers', 'auth_functions', 'actions', 'blueprints', 'cli', 'validators', 'config_declarations']
...
def _declaration_implementation(subject: Subject) -> Callable[..., None]:
    ...
    return func
_mapping: Dict[Blanket, Mapping] = {Blanket.helpers: Mapping(_module_extractor('helpers'), 'get_helpers', p.ITemplateHelpers, _dict_implementation), Blanket.auth_functions: Mapping(_module_extractor('logic.auth'), 'get_auth_functions', p.IAuthFunctions, _dict_implementation), Blanket.actions: Mapping(_module_extractor('logic.action'), 'get_actions', p.IActions, _dict_implementation), Blanket.blueprints: Mapping(_module_extractor('views'), 'get_blueprint', p.IBlueprint, _blueprint_implementation), Blanket.cli: Mapping(_module_extractor('cli'), 'get_commands', p.IClick, _list_implementation), Blanket.validators: Mapping(_module_extractor('logic.validators'), 'get_validators', p.IValidators, _dict_implementation), Blanket.config_declarations: Mapping(_declaration_file_extractor, 'declare_config_options', p.IConfigDeclaration, _declaration_implementation)}
