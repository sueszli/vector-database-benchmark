...
def build_expand_request(resource_group_name: str, host_pool_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/expandMsixImage')
...
class MsixImagesOperations:
    ...
    @overload
    def expand(self, resource_group_name: str, host_pool_name: str, msix_image_uri: _models.MSIXImageURI, *, content_type: str='application/json', **kwargs: Any) -> Iterable['_models.ExpandMsixImage']:
        if False:
            return 10
    ...
    @overload
    def expand(self, resource_group_name: str, host_pool_name: str, msix_image_uri: IO, *, content_type: str='application/json', **kwargs: Any) -> Iterable['_models.ExpandMsixImage']:
        if False:
            while True:
                i = 10
    ...
    @distributed_trace
    def expand(self, resource_group_name: str, host_pool_name: str, msix_image_uri: Union[_models.MSIXImageURI, IO], **kwargs: Any) -> Iterable['_models.ExpandMsixImage']:
        if False:
            i = 10
            return i + 15
        ...
        def prepare_request(next_link=None):
            if False:
                return 10
            if not next_link:
                request = build_expand_request(resource_group_name=resource_group_name, host_pool_name=host_pool_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.expand.metadata['url'], headers=_headers, params=_params)
