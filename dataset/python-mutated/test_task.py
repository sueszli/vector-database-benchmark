...
from apps.wasm.task import WasmTask, WasmTaskBuilder, WasmTaskDefinition, WasmTaskOptions, WasmTaskTypeInfo
...
TEST_TASK_DEFINITION_DICT = {'type': 'wasm', 'name': 'wasm', 'bid': 1, 'budget': 0.5, 'timeout': '00:10:00', 'subtask_timeout': '00:10:00', 'options': {'js_name': 'test.js', 'wasm_name': 'test.wasm', 'input_dir': '/input/dir', 'output_dir': '/output/dir', 'subtasks': {'subtask1': {'exec_args': ['arg1', 'arg2'], 'output_file_paths': ['file1', 'file2']}, 'subtask2': {'exec_args': ['arg3', 'arg4'], 'output_file_paths': ['file3', 'file4']}}}}
