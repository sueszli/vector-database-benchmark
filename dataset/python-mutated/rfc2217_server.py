...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='RFC 2217 Serial to Network (TCP/IP) redirector.', epilog='NOTE: no security measures are implemented. Anyone can remotely connect\nto this service over the network.\n\nOnly one connection at once is supported. When the connection is terminated\nit waits for the next connect.\n')
    parser.add_argument('SERIALPORT')
    parser.add_argument('-p', '--localport', type=int, help='local TCP port, default: %(default)s', metavar='TCPPORT', default=2217)
