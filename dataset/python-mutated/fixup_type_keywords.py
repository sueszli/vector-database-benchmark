...
class typeCallTransformer(cst.CSTTransformer):
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=typeCallTransformer()):
    if False:
        print('Hello World!')
