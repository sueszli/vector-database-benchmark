...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-root', default='/tmp/imagenet-1gb-data', type=str, help='Raw images directory.')
    parser.add_argument('--mosaic-data-root', default=None, type=str, help='Output directory path for mosaic.')
    parser.add_argument('--parquet-data-root', default=None, type=str, help='Output directory path for parquet.')
    parser.add_argument('--max-mb-per-file', default=64, type=int)
    ...
    if args.parquet_data_root is not None:
        ...
        preprocess_parquet(args.data_root, args.parquet_data_root, target_partition_size=args.max_mb_per_file * 1024 * 1024)