...
from ..utils import parse_duration, int_or_none, strip_or_none, traverse_obj, url_or_none

class NuvidIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www|m)\\.nuvid\\.com/video/(?P<id>[0-9]+)'
    _TESTS = [{'url': 'https://www.nuvid.com/video/6513023/italian-babe', 'md5': '772d2f8288f3d3c5c45f7a41761c7844', 'info_dict': {'id': '6513023', 'ext': 'mp4', 'title': 'italian babe', 'duration': 321.0, 'age_limit': 18, 'thumbnail': 're:https?://.+\\.jpg'}}, {'url': 'https://m.nuvid.com/video/6523263', 'md5': 'ebd22ce8e47e1d9a4d0756a15c67da52', 'info_dict': {'id': '6523263', 'ext': 'mp4', 'title': 'Slut brunette college student anal dorm', 'duration': 421.0, 'age_limit': 18, 'thumbnail': 're:https?://.+\\.jpg', 'thumbnails': list}}, {'url': 'http://m.nuvid.com/video/6415801/', 'md5': '638d5ececb138d5753593f751ae3f697', 'info_dict': {'id': '6415801', 'ext': 'mp4', 'title': 'My best friend wanted to fuck my wife for a long time', 'duration': 1882, 'age_limit': 18, 'thumbnail': 're:https?://.+\\.jpg'}}]
