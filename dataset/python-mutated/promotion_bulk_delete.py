...
class PromotionBulkDelete(ModelBulkDeleteMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of promotion IDs to delete.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.PROMOTION_DELETED, description='A promotion was deleted.')]
