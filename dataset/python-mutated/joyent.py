...
from salt.exceptions import SaltCloudExecutionFailure, SaltCloudExecutionTimeout, SaltCloudNotFound, SaltCloudSystemExit
try:
...
JOYENT_LOCATIONS = {'us-east-1': 'North Virginia, USA', 'us-west-1': 'Bay Area, California, USA', 'us-sw-1': 'Las Vegas, Nevada, USA', 'eu-ams-1': 'Amsterdam, Netherlands'}
DEFAULT_LOCATION = 'us-east-1'
POLL_ALL_LOCATIONS = True
VALID_RESPONSE_CODES = [http.client.OK, http.client.ACCEPTED, http.client.CREATED, http.client.NO_CONTENT]
