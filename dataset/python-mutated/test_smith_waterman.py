...
@pytest.mark.parametrize('left, right, expected', [('AGACTAGTTAC', 'CGAGACGT', 26)])
...
@pytest.mark.parametrize('left, right, expected', [('CGATATCAG', 'TGACGSTGC', 0), ('AGACTAGTTAC', 'TGACGSTGC', 1), ('AGACTAGTTAC', 'CGAGACGT', 0)])
