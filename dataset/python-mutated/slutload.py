...
class SlutloadIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.slutload.com/video/virginie-baisee-en-cam/TD73btpBqSxc/', 'md5': '868309628ba00fd488cf516a113fd717', 'info_dict': {'id': 'TD73btpBqSxc', 'ext': 'mp4', 'title': 'virginie baisee en cam', 'age_limit': 18, 'thumbnail': 're:https?://.*?\\.jpg'}}, {'url': 'http://mobile.slutload.com/video/masturbation-solo/fviFLmc6kzJ/', 'only_matching': True}, {'url': 'http://www.slutload.com/embed_player/TD73btpBqSxc/', 'only_matching': True}, {'url': 'http://www.slutload.com/watch/TD73btpBqSxc/Virginie-Baisee-En-Cam.html', 'only_matching': True}]
