...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    """
    type: Literal[BotCommandScopeType.ALL_CHAT_ADMINISTRATORS] = BotCommandScopeType.ALL_CHAT_ADMINISTRATORS
    'Scope type, must be *all_chat_administrators*'
    if TYPE_CHECKING:

        def __init__(__pydantic__self__, *, type: Literal[BotCommandScopeType.ALL_CHAT_ADMINISTRATORS]=BotCommandScopeType.ALL_CHAT_ADMINISTRATORS, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
