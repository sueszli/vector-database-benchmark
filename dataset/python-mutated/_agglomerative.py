...
class AgglomerativeClustering(ClusterMixin, BaseEstimator):
    ...
    array([1, 1, 1, 0, 0, 0])
    """
    _parameter_constraints: dict = {'n_clusters': [Interval(Integral, 1, None, closed='left'), None], 'affinity': [Hidden(StrOptions({'deprecated'})), StrOptions(set(_VALID_METRICS) | {'precomputed'}), callable], 'metric': [StrOptions(set(_VALID_METRICS) | {'precomputed'}), callable, None], 'memory': [str, HasMethods('cache'), None], 'connectivity': ['array-like', callable, None], 'compute_full_tree': [StrOptions({'auto'}), 'boolean'], 'linkage': [StrOptions(set(_TREE_BUILDERS.keys()))], 'distance_threshold': [Interval(Real, 0, None, closed='left'), None], 'compute_distances': ['boolean']}
