...
from modelscope.models.cv.image_editing import MutualSelfAttentionControl, regiter_attention_editor_diffusers
...
@PIPELINES.register_module(Tasks.image_editing, module_name=Pipelines.image_editing)
