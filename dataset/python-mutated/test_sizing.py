...
base_props = dict(columns=[{'id': '_', 'name': ['_', '_', '_']}, {'id': 'a', 'name': ['A-----------------VERY LONG', 'A-----------------VERY LONG', 'A-----------------VERY LONG']}, {'id': 'b', 'name': ['A-----------------VERY LONG', 'A-----------------VERY LONG', 'B-----------------VERY LONG']}, {'id': 'c', 'name': ['A-----------------VERY LONG---', 'B-----------------VERY LONG---------', 'C-----------------VERY LONG------------------']}], data=[{'_': 0, 'a': 85, 'b': 601, 'c': 891}, {'_': 0, 'a': 967, 'b': 189, 'c': 514}, {'_': 0, 'a': 398, 'b': 262, 'c': 743}, {'_': 0, 'a': 89, 'b': 560, 'c': 582}, {'_': 0, 'a': 809, 'b': 591, 'c': 511}], style_table=dict(width=500, minWidth=500, maxWidth=500, paddingBottom=10), style_cell=dict(width='25%', minWidth='25%', maxWidth='25%'))
