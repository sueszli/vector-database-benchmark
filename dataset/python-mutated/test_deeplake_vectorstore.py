...
from deeplake.constants import DEFAULT_VECTORSTORE_TENSORS, DEFAULT_VECTORSTORE_DISTANCE_METRIC
from deeplake.constants import MB
from deeplake.util.exceptions import IncorrectEmbeddingShapeError, TensorDoesNotExistError, DatasetHandlerError, EmbeddingTensorPopError
from deeplake.core.index_maintenance import METRIC_TO_INDEX_METRIC
from deeplake.core.vectorstore.vector_search import dataset as dataset_utils
from deeplake.cli.auth import login, logout
from click.testing import CliRunner
EMBEDDING_DIM = 100
NUMBER_OF_DATA = 10
(texts, embeddings, ids, metadatas, images) = utils.create_data(number_of_data=NUMBER_OF_DATA, embedding_dim=EMBEDDING_DIM)
query_embedding = np.random.uniform(low=-10, high=10, size=EMBEDDING_DIM).astype(np.float32)
