...
from litestar.utils.warnings import warn_implicit_sync_to_thread, warn_sync_to_thread_with_async_callable, warn_sync_to_thread_with_generator
__all__ = ('Provide',)
if TYPE_CHECKING:
...
class Provide:
    ...
    __slots__ = ('dependency', 'has_sync_callable', 'has_class_dependency', 'signature_model', 'sync_to_thread', 'use_cache', 'value')
