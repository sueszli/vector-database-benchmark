...
class FeedForward(torch.nn.Module, FromParams):
    ...
    def __init__(self, input_dim: int, num_layers: int, hidden_dims: Union[int, List[int]], activations: Union[Activation, List[Activation]], dropout: Union[float, List[float]]=0.0) -> None:
        if False:
            return 10
        super().__init__()
