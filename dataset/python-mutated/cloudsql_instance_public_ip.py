...
class cloudsql_instance_public_ip(Check):
    ...
    def execute(self) -> Check_Report_GCP:
        ...
        for instance in cloudsql_client.instances:
            ...
            report.status = 'PASS'
            report.status_extended = f'Database Instance {instance.name} does not have a public IP.'
            if instance.public_ip:
                report.status = 'FAIL'
                report.status_extended = f'Database Instance {instance.name} has a public IP.'
