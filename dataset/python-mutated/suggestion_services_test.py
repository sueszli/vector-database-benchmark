...
(suggestion_models, feedback_models, opportunity_models, user_models) = models.Registry.import_models([models.Names.SUGGESTION, models.Names.FEEDBACK, models.Names.OPPORTUNITY, models.Names.USER])

class SuggestionServicesUnitTests(test_utils.GenericTestBase):
    """Test the functions in suggestion_services."""
    score_category: str = suggestion_models.SCORE_TYPE_CONTENT + suggestion_models.SCORE_CATEGORY_DELIMITER + 'Algebra'
    target_id: str = 'exp1'
    target_id_2: str = 'exp2'
    target_id_3: str = 'exp3'
    target_version_at_submission: int = 1
    change: Dict[str, Union[str, Dict[str, str]]] = {'cmd': exp_domain.CMD_EDIT_STATE_PROPERTY, 'property_name': exp_domain.STATE_PROPERTY_CONTENT, 'state_name': 'state_1', 'new_value': {'content_id': 'content_0', 'html': 'new suggestion content'}}
    ...
    explorations = [MockExploration('exp1', {'state_1': {}, 'state_2': {}}), MockExploration('exp2', {'state_1': {}, 'state_2': {}}), MockExploration('exp3', {'state_1': {}, 'state_2': {}})]
...
class SuggestionGetServicesUnitTests(test_utils.GenericTestBase):
    ...
    target_id_3: str = 'exp3'
    target_version_at_submission: int = 1
    change: Dict[str, str] = {'cmd': exp_domain.CMD_EDIT_STATE_PROPERTY, 'property_name': exp_domain.STATE_PROPERTY_CONTENT, 'state_name': 'state_1', 'new_value': 'new suggestion content'}
    ...
    add_translation_change_dict: Dict[str, str] = {'cmd': exp_domain.CMD_ADD_WRITTEN_TRANSLATION, 'state_name': 'state_1', 'content_id': 'content_0', 'language_code': 'hi', 'content_html': '<p>State name: state_1, Content id: content_0</p>', 'translation_html': '<p>This is translated html.</p>', 'data_format': 'html'}
