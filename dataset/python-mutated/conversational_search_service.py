...
__protobuf__ = proto.module(package='google.cloud.discoveryengine.v1beta', manifest={'ConverseConversationRequest', 'ConverseConversationResponse', 'CreateConversationRequest', 'UpdateConversationRequest', 'DeleteConversationRequest', 'GetConversationRequest', 'ListConversationsRequest', 'ListConversationsResponse'})
...
class ConverseConversationRequest(proto.Message):
    ...
    query: gcd_conversation.TextInput = proto.Field(proto.MESSAGE, number=2, message=gcd_conversation.TextInput)
    serving_config: str = proto.Field(proto.STRING, number=3)
    conversation: gcd_conversation.Conversation = proto.Field(proto.MESSAGE, number=5, message=gcd_conversation.Conversation)
    safe_search: bool = proto.Field(proto.BOOL, number=6)
    user_labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=7)
    summary_spec: search_service.SearchRequest.ContentSearchSpec.SummarySpec = proto.Field(proto.MESSAGE, number=8, message=search_service.SearchRequest.ContentSearchSpec.SummarySpec)
...
class ConverseConversationResponse(proto.Message):
    ...
    Attributes:
        ...
        search_results (MutableSequence[google.cloud.discoveryengine_v1beta.types.SearchResponse.SearchResult]):
            Search Results.
    """
    reply: gcd_conversation.Reply = proto.Field(proto.MESSAGE, number=1, message=gcd_conversation.Reply)
    conversation: gcd_conversation.Conversation = proto.Field(proto.MESSAGE, number=2, message=gcd_conversation.Conversation)
    related_questions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    search_results: MutableSequence[search_service.SearchResponse.SearchResult] = proto.RepeatedField(proto.MESSAGE, number=3, message=search_service.SearchResponse.SearchResult)
...
class UpdateConversationRequest(proto.Message):
    ...
    """
    conversation: gcd_conversation.Conversation = proto.Field(proto.MESSAGE, number=1, message=gcd_conversation.Conversation)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    conversations: MutableSequence[gcd_conversation.Conversation] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_conversation.Conversation)
