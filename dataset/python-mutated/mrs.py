...
about = {'website': 'https://matrixrooms.info', 'wikidata_id': None, 'official_api_documentation': 'https://gitlab.com/etke.cc/mrs/api/-/blob/main/openapi.yml?ref_type=heads', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
paging = True
