...
__protobuf__ = proto.module(package='google.cloud.talent.v4beta1', manifest={'JobView', 'CreateJobRequest', 'GetJobRequest', 'UpdateJobRequest', 'DeleteJobRequest', 'BatchDeleteJobsRequest', 'ListJobsRequest', 'ListJobsResponse', 'SearchJobsRequest', 'SearchJobsResponse', 'BatchCreateJobsRequest', 'BatchUpdateJobsRequest', 'JobOperationResult'})
...
class CreateJobRequest(proto.Message):
    ...
    job: gct_job.Job = proto.Field(proto.MESSAGE, number=2, message=gct_job.Job)
...
class UpdateJobRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            are supported.
    """
    job: gct_job.Job = proto.Field(proto.MESSAGE, number=1, message=gct_job.Job)
...
class ListJobsRequest(proto.Message):
    ...
    job_view: 'JobView' = proto.Field(proto.ENUM, number=5, enum='JobView')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    jobs: MutableSequence[gct_job.Job] = proto.RepeatedField(proto.MESSAGE, number=1, message=gct_job.Job)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    metadata: common.ResponseMetadata = proto.Field(proto.MESSAGE, number=3, message=common.ResponseMetadata)
...
class SearchJobsRequest(proto.Message):
    ...
    class SearchMode(proto.Enum):
        """A string-represented enumeration of the job search mode. The
    ...
    class CustomRankingInfo(proto.Message):
        ...
        class ImportanceLevel(proto.Enum):
            ...
            HIGH = 5
            EXTREME = 6
        importance_level: 'SearchJobsRequest.CustomRankingInfo.ImportanceLevel' = proto.Field(proto.ENUM, number=1, enum='SearchJobsRequest.CustomRankingInfo.ImportanceLevel')
        ranking_expression: str = proto.Field(proto.STRING, number=2)
    parent: str = proto.Field(proto.STRING, number=1)
    search_mode: SearchMode = proto.Field(proto.ENUM, number=2, enum=SearchMode)
    request_metadata: common.RequestMetadata = proto.Field(proto.MESSAGE, number=3, message=common.RequestMetadata)
    job_query: filters.JobQuery = proto.Field(proto.MESSAGE, number=4, message=filters.JobQuery)
    enable_broadening: bool = proto.Field(proto.BOOL, number=5)
    require_precise_result_size: bool = proto.Field(proto.BOOL, number=6)
    histogram_queries: MutableSequence[histogram.HistogramQuery] = proto.RepeatedField(proto.MESSAGE, number=7, message=histogram.HistogramQuery)
    job_view: 'JobView' = proto.Field(proto.ENUM, number=8, enum='JobView')
    offset: int = proto.Field(proto.INT32, number=9)
    page_size: int = proto.Field(proto.INT32, number=10)
    page_token: str = proto.Field(proto.STRING, number=11)
    order_by: str = proto.Field(proto.STRING, number=12)
    diversification_level: DiversificationLevel = proto.Field(proto.ENUM, number=13, enum=DiversificationLevel)
    custom_ranking_info: CustomRankingInfo = proto.Field(proto.MESSAGE, number=14, message=CustomRankingInfo)
    disable_keyword_match: bool = proto.Field(proto.BOOL, number=16)
    keyword_match_mode: KeywordMatchMode = proto.Field(proto.ENUM, number=18, enum=KeywordMatchMode)
...
class SearchJobsResponse(proto.Message):
    ...
    class MatchingJob(proto.Message):
        ...
        """
        job: gct_job.Job = proto.Field(proto.MESSAGE, number=1, message=gct_job.Job)
        job_summary: str = proto.Field(proto.STRING, number=2)
        job_title_snippet: str = proto.Field(proto.STRING, number=3)
        search_text_snippet: str = proto.Field(proto.STRING, number=4)
        commute_info: 'SearchJobsResponse.CommuteInfo' = proto.Field(proto.MESSAGE, number=5, message='SearchJobsResponse.CommuteInfo')
    ...
    class CommuteInfo(proto.Message):
        ...
        """
        job_location: common.Location = proto.Field(proto.MESSAGE, number=1, message=common.Location)
        travel_duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=2, message=duration_pb2.Duration)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    matching_jobs: MutableSequence[MatchingJob] = proto.RepeatedField(proto.MESSAGE, number=1, message=MatchingJob)
    histogram_query_results: MutableSequence[histogram.HistogramQueryResult] = proto.RepeatedField(proto.MESSAGE, number=2, message=histogram.HistogramQueryResult)
    next_page_token: str = proto.Field(proto.STRING, number=3)
    location_filters: MutableSequence[common.Location] = proto.RepeatedField(proto.MESSAGE, number=4, message=common.Location)
    estimated_total_size: int = proto.Field(proto.INT32, number=5)
    total_size: int = proto.Field(proto.INT32, number=6)
    metadata: common.ResponseMetadata = proto.Field(proto.MESSAGE, number=7, message=common.ResponseMetadata)
    broadened_query_jobs_count: int = proto.Field(proto.INT32, number=8)
    spell_correction: common.SpellingCorrection = proto.Field(proto.MESSAGE, number=9, message=common.SpellingCorrection)
...
class BatchCreateJobsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    jobs: MutableSequence[gct_job.Job] = proto.RepeatedField(proto.MESSAGE, number=2, message=gct_job.Job)
...
class JobOperationResult(proto.Message):
    ...
    job_results: MutableSequence[JobResult] = proto.RepeatedField(proto.MESSAGE, number=1, message=JobResult)
