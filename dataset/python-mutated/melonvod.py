...
class MelonVODIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://vod.melon.com/video/detail2.htm?mvId=50158734', 'info_dict': {'id': '50158734', 'ext': 'mp4', 'title': "Jessica 'Wonderland' MV Making Film", 'thumbnail': 're:^https?://.*\\.jpg$', 'artist': 'Jessica (제시카)', 'upload_date': '20161212', 'duration': 203}, 'params': {'skip_download': 'm3u8 download'}}
