...
class Migration(migrations.Migration):
    dependencies = [('virtualization', '0031_virtualmachine_site_device')]
    operations = [migrations.RunPython(code=update_virtualmachines_site, reverse_code=migrations.RunPython.noop)]