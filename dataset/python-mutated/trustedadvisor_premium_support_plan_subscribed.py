...
from prowler.providers.aws.services.trustedadvisor.trustedadvisor_client import trustedadvisor_client
...
class trustedadvisor_premium_support_plan_subscribed(Check):
    ...
    def execute(self):
        ...
        if trustedadvisor_client.audit_config.get('verify_premium_support_plans', True):
            ...
            report.status = 'FAIL'
            report.status_extended = "Amazon Web Services Premium Support Plan isn't subscribed."
            ...
            if trustedadvisor_client.premium_support.enabled:
                report.status = 'PASS'
                report.status_extended = 'Amazon Web Services Premium Support Plan is subscribed.'
