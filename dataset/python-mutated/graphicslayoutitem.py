...
from AnyQt.QtWidgets import QGraphicsItem, QGraphicsLayoutItem, QSizePolicy, QGraphicsScale, QWIDGETSIZE_MAX
__all__ = ['SimpleLayoutItem', 'scaled']
...
class SimpleLayoutItem(QGraphicsLayoutItem):
    ...
    """
    __slots__ = ('__anchorThis', '__anchorItem', 'item', '__resizeContents', '__aspectMode', '__transform', '__scale')
