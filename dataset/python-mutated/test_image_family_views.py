...
from google.cloud.compute_v1.services.image_family_views import ImageFamilyViewsClient, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(ImageFamilyViewsClient, 'rest')])
def test_image_family_views_client_from_service_account_info(client_class, transport_name):
    if False:
        while True:
            i = 10
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.ImageFamilyViewsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_name', [(ImageFamilyViewsClient, 'rest')])
def test_image_family_views_client_from_service_account_file(client_class, transport_name):
    if False:
        i = 10
        return i + 15
    creds = ga_credentials.AnonymousCredentials()
...
def test_image_family_views_client_get_transport_class():
    ...
    available_transports = [transports.ImageFamilyViewsRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(ImageFamilyViewsClient, transports.ImageFamilyViewsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(ImageFamilyViewsClient, transports.ImageFamilyViewsRestTransport, 'rest', 'true'), (ImageFamilyViewsClient, transports.ImageFamilyViewsRestTransport, 'rest', 'false')])
@mock.patch.object(ImageFamilyViewsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(ImageFamilyViewsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(ImageFamilyViewsClient, transports.ImageFamilyViewsRestTransport, 'rest', None)])
def test_image_family_views_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    if False:
        return 10
...
@pytest.mark.parametrize('request_type', [compute.GetImageFamilyViewRequest, dict])
def test_get_rest(request_type):
    if False:
        return 10
    client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
...
def test_get_rest_interceptors(null_interceptor):
    if False:
        i = 10
        return i + 15
    transport = transports.ImageFamilyViewsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.ImageFamilyViewsRestInterceptor())
    client = ImageFamilyViewsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.ImageFamilyViewsRestInterceptor, 'post_get') as post, mock.patch.object(transports.ImageFamilyViewsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = compute.GetImageFamilyViewRequest.pb(compute.GetImageFamilyViewRequest())
        transcode.return_value = {'method': 'post', 'uri': 'my_uri', 'body': pb_message, 'query_params': pb_message}
        req.return_value = Response()
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = compute.ImageFamilyView.to_json(compute.ImageFamilyView())
...
def test_get_rest_bad_request(transport: str='rest', request_type=compute.GetImageFamilyViewRequest):
    if False:
        for i in range(10):
            print('nop')
    client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request_init = {'project': 'sample1', 'zone': 'sample2', 'family': 'sample3'}
    request = request_type(**request_init)
...
def test_get_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', zone='zone_value', family='family_value')
        ...
        assert path_template.validate('%s/compute/v1/projects/{project}/zones/{zone}/imageFamilyViews/{family}' % client.transport._host, args[1])
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetImageFamilyViewRequest(), project='project_value', zone='zone_value', family='family_value')
...
def test_credentials_transport_error():
    ...
    transport = transports.ImageFamilyViewsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = ImageFamilyViewsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.ImageFamilyViewsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = ImageFamilyViewsClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = ImageFamilyViewsClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.ImageFamilyViewsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = ImageFamilyViewsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
@pytest.mark.parametrize('transport_class', [transports.ImageFamilyViewsRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        for i in range(10):
            print('nop')
    transport = ImageFamilyViewsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_image_family_views_base_transport_error():
    ...
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.ImageFamilyViewsTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_image_family_views_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.image_family_views.transports.ImageFamilyViewsTransport.__init__') as Transport:
        ...
        transport = transports.ImageFamilyViewsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('get',)
...
def test_image_family_views_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.image_family_views.transports.ImageFamilyViewsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.ImageFamilyViewsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_image_family_views_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.ImageFamilyViewsRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_image_family_views_host_no_port(transport_name):
    if False:
        print('Hello World!')
    client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_image_family_views_host_with_port(transport_name):
    if False:
        return 10
    client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_image_family_views_client_transport_session_collision(transport_name):
    ...
    client1 = ImageFamilyViewsClient(credentials=creds1, transport=transport_name)
    client2 = ImageFamilyViewsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.ImageFamilyViewsTransport, '_prep_wrapped_messages') as prep:
        client = ImageFamilyViewsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(ImageFamilyViewsClient, transports.ImageFamilyViewsRestTransport)])
