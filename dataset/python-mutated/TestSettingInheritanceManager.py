...
setting_property_dict = {'setting_1': {}, 'setting_2': {'state': InstanceState.User, 'enabled': False}, 'setting_3': {'state': InstanceState.User, 'enabled': True}, 'setting_4': {'state': InstanceState.User, 'enabled': True, 'value': 12}, 'setting_5': {'state': InstanceState.User, 'enabled': True, 'value': setting_function}}
