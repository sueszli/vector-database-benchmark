...
@PIPELINES.register_module(Tasks.speaker_diarization_dialogue_detection, module_name=Pipelines.speaker_diarization_dialogue_detection)
class SpeakerDiarizationDialogueDetectionPipeline(Pipeline):
    """The inference pipeline for Speaker Diarization Dialogue Detection Task.
