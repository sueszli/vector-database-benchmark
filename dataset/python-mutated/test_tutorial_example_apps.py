...
from docs.examples.contrib.sqlalchemy.plugins.tutorial import full_app_no_plugins, full_app_with_init_plugin, full_app_with_plugin, full_app_with_serialization_plugin, full_app_with_session_di
from sqlalchemy.ext.asyncio import create_async_engine
from litestar import Litestar
from litestar.testing import TestClient

@pytest.fixture(params=[full_app_no_plugins, full_app_with_init_plugin, full_app_with_plugin, full_app_with_serialization_plugin, full_app_with_session_di])
