...
@testing.parameterize(*testing.product_dict([{'dtype': numpy.float16, 'forward_options': {'rtol': 0.003, 'atol': 0.003}, 'backward_options': {'rtol': 0.1, 'atol': 0.1}}, {'dtype': numpy.float32, 'forward_options': {}, 'backward_options': {'rtol': 0.1, 'atol': 0.1}}, {'dtype': numpy.float64, 'forward_options': {}, 'backward_options': {'rtol': 0.1, 'atol': 0.1}}], [{'reduce': 'no'}, {'reduce': 'mean'}], [{'norm': 'L1'}, {'norm': 'L2'}], [{'label_dtype': numpy.int8}, {'label_dtype': numpy.int16}, {'label_dtype': numpy.int32}, {'label_dtype': numpy.int64}]))
