...
class Exploit(HTTPClient):
    __info__ = {'name': 'Asus B1M Projector RCE', 'description': 'Module exploits Asus B1M Projector Remote Code Execution vulnerability which allows executing command on operating system level with root privileges.', 'authors': ('Hacker House <www.myhackerhouse.com>', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.myhackerhouse.com/asus-b1m-projector-remote-root-0day/',), 'devices': ('Asus B1M Projector',)}
