...
from scipy.optimize._trustregion_constr.qp_subproblem import eqp_kktfact, projected_cg, box_intersections, sphere_intersections, box_sphere_intersections, modified_dogleg
