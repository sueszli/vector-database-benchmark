...
from sentry.notifications.notifications.strategies.owner_recipient_strategy import OwnerRecipientStrategy
...
provider_types = {'first_party': 'integrations', 'plugin': 'plugins', 'sentry_app': 'sentry-apps'}
