...
DOWNTOWN_BOUNDING_BOX = [-122.43135291617365, 37.766492914983864, -122.38706428091974, 37.80583561830737]
...
arc_layer = pdk.Layer('ArcLayer', data=df, get_width='S000 * 2', get_source_position=['lng_h', 'lat_h'], get_target_position=['lng_w', 'lat_w'], get_tilt=15, get_source_color=RED_RGB, get_target_color=GREEN_RGB, pickable=True, auto_highlight=True)
