...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0412_customprofilefield_display_in_profile_summary')]
    operations = [migrations.RunPython(set_presence_enabled_false_if_user_status_away, reverse_code=set_userstatus_away_if_presence_enabled_false, elidable=True)]