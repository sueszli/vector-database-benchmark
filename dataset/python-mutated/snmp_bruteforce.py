...
class Exploit(SNMPClient):
    __info__ = {'name': 'SNMP Bruteforce', 'description': 'Module performs bruteforce attack against SNMP service. If valid community string is found, it is displayed to the user', 'authors': ('Marcin Bury <marcin[at]threat9.com>',), 'devices': ('Multiple devices',)}
