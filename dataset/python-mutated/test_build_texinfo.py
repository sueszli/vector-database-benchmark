...
TEXINFO_WARNINGS = ENV_WARNINGS + "%(root)s/index.rst:\\d+: WARNING: unknown option: '&option'\n%(root)s/index.rst:\\d+: WARNING: citation not found: missing\n%(root)s/index.rst:\\d+: WARNING: a suitable image for texinfo builder not found: foo.\\*\n%(root)s/index.rst:\\d+: WARNING: a suitable image for texinfo builder not found: \\['application/pdf', 'image/svg\\+xml'\\] \\(svgimg.\\*\\)\n"
