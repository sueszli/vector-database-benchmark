...
class sfp_searchcode(SpiderFootPlugin):
    meta = {'name': 'searchcode', 'summary': 'Search searchcode for code repositories mentioning the target domain.', 'flags': [], 'useCases': ['Investigate', 'Footprint', 'Passive'], 'categories': ['Search Engines'], 'dataSource': {'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://searchcode.com/api/'], 'website': 'https://searchcode.com/', 'logo': 'https://searchcode.com/static/small_logo.png', 'description': 'Simple, comprehensive code search.'}}
    opts = {'max_pages': 10, 'dns_resolve': True}
