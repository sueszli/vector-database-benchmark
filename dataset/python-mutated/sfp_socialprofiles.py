...
sites = {'Facebook': ['"{name}"+site:facebook.com', ['[ \\\'"](https?://[a-z\\.]*facebook.[a-z\\.]+/[^/"\\\'<> ]+/?)[\\\'"]', '(https?%3a%2f%2f[a-z\\.]*facebook.[a-z\\.]+%2f[^\\/"\\\'<> ]+/?)']], 'Google+': ['"{name}"+site:plus.google.com', ['[ \\\'"](https?://plus.google.[a-z\\.]+/\\d+[^"\\\'<>\\/ ]+)[\\\'"]', '(https?%3a%2f%2fplus.google.[a-z\\.]+%2f\\d+[^\\/"\\\'<> ]+)']], 'LinkedIn': ['"{name}"+site:linkedin.com', ['["\\\' ](https?://[a-z\\.]*linkedin.[a-z\\.]+/[^\\?"\\\'<> ]+)[\\\'"]', '(https?%3a%2f%2f[a-z\\.]*linkedin.[a-z\\.]+%2f[^\\?"\\\'<> ]+)']]}

class sfp_socialprofiles(SpiderFootPlugin):
    meta = {'name': 'Social Media Profile Finder', 'summary': 'Tries to discover the social media profiles for human names identified.', 'flags': ['slow', 'apikey'], 'useCases': ['Footprint', 'Passive'], 'categories': ['Social Media'], 'dataSource': {'website': 'https://developers.google.com/custom-search', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://developers.google.com/custom-search/v1', 'https://developers.google.com/custom-search/docs/overview', 'https://cse.google.com/cse'], 'apiKeyInstructions': ['If using Google:', 'Visit https://developers.google.com/custom-search/v1/introduction', 'Register a free Google account', "Click on 'Get A Key'", 'Connect a Project', "The API Key will be listed under 'YOUR API KEY'", 'If using Bing:', 'Visit https://azure.microsoft.com/en-in/services/cognitive-services/bing-web-search-api/', 'Register a free account', 'Select on Bing Custom Search', "The API keys are listed under 'Key1' and 'Key2' (both should work)"], 'favIcon': 'https://www.gstatic.com/devrel-devsite/prod/v2210deb8920cd4a55bd580441aa58e7853afc04b39a9d9ac4198e1cd7fbe04ef/developers/images/favicon.png', 'logo': 'https://www.gstatic.com/devrel-devsite/prod/v2210deb8920cd4a55bd580441aa58e7853afc04b39a9d9ac4198e1cd7fbe04ef/developers/images/favicon.png', 'description': 'Google Custom Search enables you to create a search engine for your website, your blog, or a collection of websites. You can configure your engine to search both web pages and images. You can fine-tune the ranking, add your own promotions and customize the look and feel of the search results. You can monetize the search by connecting your engine to your Google AdSense account.'}}
    opts = {'count': 20, 'method': 'bing', 'tighten': True, 'bing_api_key': '', 'google_api_key': '', 'google_cse_id': '013611106330597893267:tfgl3wxdtbp'}
    optdescs = {'count': 'Number of bing search engine results of identified profiles to iterate through.', 'method': "Search engine to use: 'google' or 'bing'.", 'tighten': 'Tighten results by expecting to find the keyword of the target domain mentioned in the social media profile page results?', 'bing_api_key': 'Bing API Key for social media profile search.', 'google_api_key': 'Google API Key for social media profile search.', 'google_cse_id': 'Google Custom Search Engine ID.'}
    keywords = None
    results = None
    errorState = False
