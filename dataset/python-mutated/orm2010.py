...
class Grunt(Employee):
    ...
    employer = relationship('Boss', backref='employees', primaryjoin=Boss.id == employer_id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--profile', action='store_true', help='run shorter test suite w/ cprofilng')
    parser.add_argument('--dump', action='store_true', help='dump full call profile (implies --profile)')
    parser.add_argument('--runsnake', action='store_true', help='invoke runsnakerun (implies --profile)')
    parser.add_argument('--factor', type=int, default=10, help='scale factor, a multiple of how many records to work with.  defaults to 10')
