...
list_order_items_payload_data = {'payload': {'OrderItems': [{'ProductInfo': {'NumberOfItems': '1'}, 'IsGift': 'false', 'BuyerInfo': {}, 'QuantityShipped': 0, 'IsTransparency': False, 'QuantityOrdered': 1, 'ASIN': 'AKDDKDKD', 'SellerSKU': 'AAA-VPx3-AMZ', 'Title': 'Example product', 'OrderItemId': '88888888888'}], 'AmazonOrderId': '111-0000000-2222222'}}
