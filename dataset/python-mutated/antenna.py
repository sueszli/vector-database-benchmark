...
class AntennaGrWatchIE(AntennaBaseIE):
    ...
    _TESTS = [{'url': 'https://www.ant1news.gr/watch/1506168/ant1-news-09112021-stis-18-45', 'md5': 'c472d9dd7cd233c63aff2ea42201cda6', 'info_dict': {'id': '1506168', 'ext': 'mp4', 'title': 'md5:0ad00fa66ecf8aa233d26ab0dba7514a', 'description': 'md5:18665af715a6dcfeac1d6153a44f16b0', 'thumbnail': 're:https://ant1media\\.azureedge\\.net/imgHandler/\\d+/26d46bf6-8158-4f02-b197-7096c714b2de\\.jpg'}}, {'url': 'https://www.antenna.gr/watch/1643812/oi-prodotes-epeisodio-01', 'md5': '8f6f7dd3b1dba4d835ba990e25f31243', 'info_dict': {'id': '1643812', 'ext': 'mp4', 'format_id': 'mp4', 'title': 'ΟΙ ΠΡΟΔΟΤΕΣ – ΕΠΕΙΣΟΔΙΟ 01', 'thumbnail': 're:https://ant1media\\.azureedge\\.net/imgHandler/\\d+/b3d63096-e72d-43c4-87a0-00d4363d242f\\.jpg'}}]
...
class Ant1NewsGrEmbedIE(AntennaBaseIE):
    ...
    _BASE_PLAYER_URL_RE = '(?:https?:)?//(?:[a-zA-Z0-9\\-]+\\.)?(?:antenna|ant1news)\\.gr/templates/pages/player'
    _VALID_URL = f'{_BASE_PLAYER_URL_RE}\\?([^#]+&)?cid=(?P<id>[^#&]+)'
    _EMBED_REGEX = [f"""<iframe[^>]+?src=(?P<_q1>["\\'])(?P<url>{_BASE_PLAYER_URL_RE}\\?(?:(?!(?P=_q1)).)+)(?P=_q1)"""]
    _API_PATH = '/news/templates/data/jsonPlayer'
    _TESTS = [{'url': 'https://www.antenna.gr/templates/pages/player?cid=3f_li_c_az_jw_y_u=&w=670&h=377', 'md5': 'dfc58c3a11a5a9aad2ba316ed447def3', 'info_dict': {'id': '3f_li_c_az_jw_y_u=', 'ext': 'mp4', 'title': 'md5:a30c93332455f53e1e84ae0724f0adf7', 'thumbnail': 'https://ant1media.azureedge.net/imgHandler/640/bbe31201-3f09-4a4e-87f5-8ad2159fffe2.jpg'}}]
