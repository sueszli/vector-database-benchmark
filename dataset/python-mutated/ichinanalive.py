...
class IchinanaLiveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://17.live/live/3773096', 'info_dict': {'id': '3773096', 'title': '萠珈☕🤡🍫moka', 'is_live': True, 'uploader': '萠珈☕🤡🍫moka', 'uploader_id': '3773096', 'like_count': 366, 'view_count': 18121, 'timestamp': 1630569012}, 'skip': 'running as of writing, but may be ended as of testing'}, {'note': 'nothing except language differs', 'url': 'https://17.live/ja/live/3773096', 'only_matching': True}]
...
class IchinanaLiveClipIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://17.live/profile/r/1789280/clip/1bHQSK8KUieruFXaCH4A4upCzlN', 'info_dict': {'id': '1bHQSK8KUieruFXaCH4A4upCzlN', 'title': 'マチコ先生🦋Class💋', 'description': 'マチ戦隊\u3000第一次\u3000バスターコール\n総額200万coin！\n動画制作@うぉーかー🌱Walker🎫', 'uploader_id': '1789280'}}, {'url': 'https://17.live/ja/profile/r/1789280/clip/1bHQSK8KUieruFXaCH4A4upCzlN', 'only_matching': True}]
