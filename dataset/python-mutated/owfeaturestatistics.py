...
from AnyQt.QtCore import Qt, QSize, QRectF, QModelIndex, pyqtSlot, QItemSelection, QItemSelectionRange, QItemSelectionModel
from AnyQt.QtGui import QPainter, QColor, QPalette
from AnyQt.QtWidgets import QStyledItemDelegate, QGraphicsScene, QTableView, QHeaderView, QStyle, QStyleOptionViewItem
import Orange.statistics.util as ut
from Orange.data import Table, StringVariable, DiscreteVariable, ContinuousVariable, TimeVariable, Domain, Variable
...
class FeatureStatisticsTableModel(AbstractSortTableModel):
    ...
    COLOR_FOR_ROLE = {CLASS_VAR: QColor(160, 160, 160), META: QColor(220, 220, 200), ATTRIBUTE: QColor(255, 255, 255)}
    HIDDEN_VAR_TYPES = (StringVariable,)

    class Columns(IntEnum):
        (ICON, NAME, DISTRIBUTION, CENTER, MODE, MEDIAN, DISPERSION, MIN, MAX, MISSING) = range(10)
