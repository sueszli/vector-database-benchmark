...
class SelectDateWidgetTest(WidgetTest):
    ...
    def test_render_datetime(self):
        if False:
            for i in range(10):
                print('nop')
        self.assertHTMLEqual(self.widget.render('mydate', date(2010, 4, 15)), self.widget.render('mydate', '2010-04-15'))
    ...
    def test_l10n(self):
        ...
        self.assertEqual(w.value_from_datadict({'date_year': '0001', 'date_month': '8', 'date_day': '13'}, {}, 'date'), '13-08-0001')
    ...
    def test_custom_input_format(self):
        ...
        with translation.override(None):
            for (values, expected_value) in ((('0001', '8', '13'), '13.08.0001'), (('1899', '7', '11'), '11.07.1899'), (('2009', '3', '7'), '07.03.2009')):
                with self.subTest(values=values):
                    data = {'field_%s' % field: value for (field, value) in zip(('year', 'month', 'day'), values)}
                    self.assertEqual(w.value_from_datadict(data, {}, 'field'), expected_value)
                    expected_dict = {field: int(value) for (field, value) in zip(('year', 'month', 'day'), values)}
    ...
    def test_format_value(self):
        if False:
            for i in range(10):
                print('nop')
        valid_formats = ['2000-1-1', '2000-10-15', '2000-01-01', '2000-01-0', '2000-0-01', '2000-0-0', '0-01-01', '0-01-0', '0-0-01', '0-0-0']
    ...
    def test_value_from_datadict(self):
        if False:
            i = 10
            return i + 15
        tests = [(('2000', '12', '1'), '2000-12-01'), (('', '12', '1'), '0-12-1'), (('2000', '', '1'), '2000-0-1'), (('2000', '12', ''), '2000-12-0'), (('', '', '', ''), None), ((None, '12', '1'), None), (('2000', None, '1'), None), (('2000', '12', None), None), ((str(sys.maxsize + 1), '12', '1'), '0-0-0')]
