...
class RazerNostromo(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Nostromo-event-kbd')
    USB_VID = 5426
    USB_PID = 273
    DEDICATED_MACRO_KEYS = True
    METHODS = ['get_device_type_keypad', 'keypad_get_profile_led_red', 'keypad_set_profile_led_red', 'keypad_get_profile_led_green', 'keypad_set_profile_led_green', 'keypad_get_profile_led_blue', 'keypad_set_profile_led_blue', 'get_macros', 'delete_macro', 'add_macro', 'keypad_get_mode_modifier', 'keypad_set_mode_modifier']
...
class RazerTartarus(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Tartarus(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 513
    DEDICATED_MACRO_KEYS = True
...
class RazerTartarusChroma(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Tartarus_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 520
    DEDICATED_MACRO_KEYS = True
...
class RazerOrbweaver(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Orbweaver(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 275
    DEDICATED_MACRO_KEYS = True
...
class RazerBlackWidowUltimate2012(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_BlackWidow_Ultimate_2012(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 269
    DEDICATED_MACRO_KEYS = True
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'set_macro_mode', 'get_macro_mode', 'get_macro_effect', 'set_macro_effect', 'bw_set_pulsate', 'bw_set_static', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidowStealth(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_BlackWidow(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 283
    DEDICATED_MACRO_KEYS = True
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'set_macro_mode', 'get_macro_mode', 'get_macro_effect', 'set_macro_effect', 'bw_set_pulsate', 'bw_set_static', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidowUltimate2013(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_BlackWidow_Ultimate(_2013)?(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 282
    DEDICATED_MACRO_KEYS = True
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'set_macro_mode', 'get_macro_mode', 'get_macro_effect', 'set_macro_effect', 'bw_set_pulsate', 'bw_set_static', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidowTournamentEdition2014(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Razer_BlackWidow_Tournament_Edition(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 284
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'set_macro_mode', 'get_macro_mode', 'get_macro_effect', 'set_macro_effect', 'bw_set_pulsate', 'bw_set_static', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidowV3ProWired(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Razer_BlackWidow_V3_Pro(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 602
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour', 'set_charge_effect', 'set_charge_colour', 'get_battery', 'is_charging', 'set_low_battery_threshold']
...
class RazerBlackWidowChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 515
    HAS_MATRIX = True
    DEDICATED_MACRO_KEYS = True
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_ripple_effect', 'set_ripple_effect_random_colour']
...
class RazerBlackWidowChromaV2(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Chroma_V2(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 545
    HAS_MATRIX = True
    DEDICATED_MACRO_KEYS = True
...
class RazerBlackWidowChromaTournamentEdition(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Tournament_Edition_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 521
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macros', 'delete_macro', 'add_macro', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour']
...
class RazerBlackWidowXChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_X_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 534
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerHuntsmanV2(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Huntsman_V2(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 620
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerHuntsmanV2Analog(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Huntsman_V2_Analog(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 614
    HAS_MATRIX = True
    MATRIX_DIMS = [8, 22]
...
class RazerHuntsmanMiniAnalog(_RazerDeviceBrightnessSuspend):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Huntsman_Mini_Analog(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 642
    HAS_MATRIX = True
    MATRIX_DIMS = [5, 15]
...
class RazerBlackWidowXTournamentEditionChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_X_Tournament_Edition_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 538
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerBladeStealth(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Blade_Stealth(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 517
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour', 'get_logo_active', 'set_logo_active']
...
class RazerBladeProLate2016(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Blade_Pro(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 528
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerBladeLate2016(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Blade(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 548
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 16]
...
class RazerBlackWidowUltimate2016(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Ultimate_2016(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 532
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_ripple_effect']
...
class RazerBlackWidowXUltimate(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_X_Ultimate(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 535
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerOrnataChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Ornata_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 542
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerOrnataV2(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Ornata_V2(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 605
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
...
class RazerOrnataV3X(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Ornata_V3_X(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 660
    HAS_MATRIX = True
    MATRIX_DIMS = [1, 1]
    METHODS = ['get_device_type_keyboard', 'set_static_effect', 'set_spectrum_effect', 'set_none_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerHuntsmanElite(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Huntsman_Elite(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 550
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerHuntsmanTournamentEdition(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Huntsman_Tournament_Edition_00000000001A(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 579
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerBlackWidowElite(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Elite(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 552
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerHuntsman(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Huntsman(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 551
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerBlackWidowV3(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_V3(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 590
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
...
class RazerBlackWidowV3TK(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_V3_Tenkeyless(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 2596
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
...
class RazerBlackWidowV3MiniHyperspeed(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_V3_Mini(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 600
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
    MATRIX_DIMS = [5, 16]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour', 'get_battery', 'is_charging']
...
class RazerCynosaChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Cynosa_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 554
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerCynosaChromaPro(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Cynosa_Chroma_Pro(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 556
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect']
...
class RazerCynosaV2(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Cynosa_V2(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 606
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerCynosaLite(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Cynosa_Lite(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 575
    METHODS = ['get_device_type_keyboard', 'set_static_effect', 'set_spectrum_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidowLite(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow_Lite(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 565
    METHODS = ['get_device_type_keyboard', 'set_static_effect', 'set_none_effect', 'set_breath_single_effect', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerBlackWidow2019(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*BlackWidow(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 577
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerOrnata(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Ornata(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 543
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
    MATRIX_DIMS = [6, 22]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_single_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'set_breath_single_effect', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour']
...
class RazerAnansi(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Anansi(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 271
    DEDICATED_MACRO_KEYS = True
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_static_effect', 'set_spectrum_effect', 'set_none_effect']
...
class RazerDeathStalkerExpert(_MacroKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_DeathStalker(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 514
    METHODS = ['get_device_type_keyboard', 'get_game_mode', 'set_game_mode', 'set_macro_mode', 'get_macro_mode', 'get_macro_effect', 'set_macro_effect', 'bw_set_pulsate', 'bw_set_static', 'get_macros', 'delete_macro', 'add_macro']
...
class RazerDeathStalkerChroma(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*DeathStalker_Chroma(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 516
    HAS_MATRIX = True
    DEDICATED_MACRO_KEYS = True
...
class RazerDeathStalkerV2(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*DeathStalker_V2(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 661
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerDeathStalkerV2ProWired(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*DSV2_Pro_000000000000-event-kbd')
    USB_VID = 5426
    USB_PID = 658
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 22]
...
class RazerBladePro2017FullHD(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Blade_ProFullHD(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 559
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 25]
...
class RazerBlade2018Base(_MacroKeyboard):
    ...
    USB_VID = 5426
    USB_PID = 571
    METHODS = ['get_device_type_keyboard', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect']
    DEVICE_IMAGE = 'https://assets.razerzone.com/eeimages/support/products/1418/1418_blade_2018__base.png'
...
class RazerBlade2019Adv(_RippleKeyboard):
    ...
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 16]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect', 'set_ripple_effect', 'set_ripple_effect_random_colour']
...
class RazerBladeEarly2020Base(_MacroKeyboard):
    ...
    USB_VID = 5426
    USB_PID = 597
    METHODS = ['get_device_type_keyboard', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect']
...
class RazerBladeProEarly2020(_RippleKeyboard):
    ...
    HAS_MATRIX = True
    MATRIX_DIMS = [6, 16]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_custom_effect', 'set_key_row', 'set_ripple_effect', 'set_ripple_effect_random_colour']
...
class RazerHuntsmanMini(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Huntsman_Mini_00000000001A(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 599
    HAS_MATRIX = True
    WAVE_DIRS = (0, 1)
...
class RazerBlackWidowV4Pro(_RippleKeyboard):
    ...
    """
    EVENT_FILE_REGEX = re.compile('.*Razer_Razer_BlackWidow_V4_Pro(-if01)?-event-kbd')
    USB_VID = 5426
    USB_PID = 653
    HAS_MATRIX = True
    WAVE_DIRS = (1, 2)
    MATRIX_DIMS = [8, 23]
    POLL_RATES = [125, 250, 500, 1000, 2000, 4000, 8000]
    METHODS = ['get_device_type_keyboard', 'set_wave_effect', 'set_wheel_effect', 'set_static_effect', 'set_spectrum_effect', 'set_reactive_effect', 'set_none_effect', 'set_breath_random_effect', 'set_breath_single_effect', 'set_breath_dual_effect', 'set_custom_effect', 'set_key_row', 'get_game_mode', 'set_game_mode', 'get_macro_mode', 'set_macro_mode', 'get_macro_effect', 'set_macro_effect', 'get_macros', 'delete_macro', 'add_macro', 'set_starlight_random_effect', 'set_starlight_single_effect', 'set_starlight_dual_effect', 'get_poll_rate', 'set_poll_rate', 'get_supported_poll_rates', 'set_ripple_effect', 'set_ripple_effect_random_colour']
