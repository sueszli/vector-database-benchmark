...
def create_job_with_animated_overlay(project_id: str, location: str, input_uri: str, overlay_image_uri: str, output_uri: str) -> transcoder_v1.types.resources.Job:
    if False:
        return 10
...
if __name__ == '__main__':
    ...
    create_job_with_animated_overlay(args.project_id, args.location, args.input_uri, args.overlay_image_uri, args.output_uri)