...
class CrmTeam(models.Model):
    _inherit = 'crm.team'
    use_quotations = fields.Boolean('Quotations', default=True, help='Check this box to manage quotations in this sales team.')
    use_invoices = fields.Boolean('Invoices', help='Check this box to manage invoices in this sales team.')
    invoiced = fields.Integer(compute='_compute_invoiced', string='Invoiced This Month', readonly=True, help='Invoice revenue for the current month. This is the amount the sales team has invoiced this month. It is used to compute the progression ratio of the current and target revenue on the kanban view.')
    invoiced_target = fields.Integer(string='Invoice Target', help='Target of invoice revenue for the current month. This is the amount the sales team estimates to be able to invoice this month.')
    sales_to_invoice_amount = fields.Integer(compute='_compute_sales_to_invoice_amount', string='Amount of sales to invoice', readonly=True)
