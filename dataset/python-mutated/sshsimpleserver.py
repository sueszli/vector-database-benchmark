...
PRIMES = {2048: [(2, int(''))], 4096: [(2, int(''))]}
...
class ExampleSession:
    ...
    def closed(self):
        if False:
            ...
            return i + 15
        pass
components.registerAdapter(ExampleSession, ExampleAvatar, session.ISession, session.ISessionSetEnv)
