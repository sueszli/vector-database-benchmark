...
from ray._private.arrow_serialization import _align_bit_offset, _bytes_for_bits, _copy_bitpacked_buffer_if_needed, _copy_buffer_if_needed, _copy_normal_buffer_if_needed, _copy_offsets_buffer_if_needed
from ray._private.utils import _get_pyarrow_version
from ray.data.extensions.tensor_extension import ArrowTensorArray, ArrowVariableShapedTensorArray
...
pytest_custom_serialization_arrays = [(lazy_fixture('null_array'), 1.0), (lazy_fixture('int_array'), 0.1), (lazy_fixture('int_array_with_nulls'), 0.1), (lazy_fixture('float_array'), 0.1), (lazy_fixture('boolean_array'), 0.8), (lazy_fixture('string_array'), 0.1), (lazy_fixture('large_string_array'), 0.1), (lazy_fixture('binary_array'), 0.1), (lazy_fixture('fixed_size_binary_array'), 0.1), (lazy_fixture('large_binary_array'), 0.1), (lazy_fixture('list_array'), 0.1), (lazy_fixture('large_list_array'), 0.1), (lazy_fixture('fixed_size_list_array'), 0.1), (lazy_fixture('map_array'), 0.1), (lazy_fixture('struct_array'), 0.1), (lazy_fixture('sparse_union_array'), 0.1), (lazy_fixture('dense_union_array'), 0.1), (lazy_fixture('dictionary_array'), 0.1), (lazy_fixture('tensor_array'), 0.1), (lazy_fixture('boolean_tensor_array'), 0.25), (lazy_fixture('variable_shaped_tensor_array'), 0.1), (lazy_fixture('boolean_variable_shaped_tensor_array'), 0.25), (lazy_fixture('list_of_struct_array'), 0.1), (lazy_fixture('list_of_empty_struct_array'), 0.1), (lazy_fixture('complex_nested_array'), 0.1)]
