...
tf.flags.DEFINE_string('skip_thoughts_vocab', None, 'Path to vocabulary file containing a list of newline-separated words where the word id is the corresponding 0-based index in the file.')
