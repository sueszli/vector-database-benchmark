...
import pytest
from google.cloud.dataplex_v1.services.dataplex_service import DataplexServiceAsyncClient, DataplexServiceClient, pagers, transports
...
@pytest.mark.asyncio
async def test_create_lake_async(transport: str='grpc_asyncio', request_type=service.CreateLakeRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_lake), '__call__') as call:
...
async def test_create_lake_field_headers_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = service.CreateLakeRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_lake), '__call__') as call:
...
async def test_create_lake_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_lake), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_lake(parent='parent_value', lake=resources.Lake(name='name_value'), lake_id='lake_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_lake_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_lake(service.CreateLakeRequest(), parent='parent_value', lake=resources.Lake(name='name_value'), lake_id='lake_id_value')
...
@pytest.mark.asyncio
async def test_update_lake_async(transport: str='grpc_asyncio', request_type=service.UpdateLakeRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.update_lake), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_update_lake_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_lake), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_lake(lake=resources.Lake(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].lake
        mock_val = resources.Lake(name='name_value')
...
async def test_update_lake_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_lake(service.UpdateLakeRequest(), lake=resources.Lake(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
@pytest.mark.asyncio
async def test_delete_lake_async(transport: str='grpc_asyncio', request_type=service.DeleteLakeRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.delete_lake), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_delete_lake_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_lake(service.DeleteLakeRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_list_lakes_async(transport: str='grpc_asyncio', request_type=service.ListLakesRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_lakes), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListLakesResponse(next_page_token='next_page_token_value', unreachable_locations=['unreachable_locations_value']))
...
async def test_list_lakes_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_lakes), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListLakesResponse())
...
async def test_list_lakes_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_lakes(service.ListLakesRequest(), parent='parent_value')
...
async def test_list_lakes_async_pager():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_lakes), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListLakesResponse(lakes=[resources.Lake(), resources.Lake(), resources.Lake()], next_page_token='abc'), service.ListLakesResponse(lakes=[], next_page_token='def'), service.ListLakesResponse(lakes=[resources.Lake()], next_page_token='ghi'), service.ListLakesResponse(lakes=[resources.Lake(), resources.Lake()]), RuntimeError)
...
@pytest.mark.asyncio
async def test_get_lake_async(transport: str='grpc_asyncio', request_type=service.GetLakeRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.get_lake), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Lake(name='name_value', display_name='display_name_value', uid='uid_value', description='description_value', state=resources.State.ACTIVE, service_account='service_account_value'))
...
async def test_get_lake_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_lake(service.GetLakeRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_list_lake_actions_async(transport: str='grpc_asyncio', request_type=service.ListLakeActionsRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_lake_actions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListActionsResponse(next_page_token='next_page_token_value'))
...
async def test_list_lake_actions_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_lake_actions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListActionsResponse())
...
async def test_list_lake_actions_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_lake_actions(service.ListLakeActionsRequest(), parent='parent_value')
...
async def test_list_lake_actions_async_pager():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_lake_actions), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListActionsResponse(actions=[resources.Action(), resources.Action(), resources.Action()], next_page_token='abc'), service.ListActionsResponse(actions=[], next_page_token='def'), service.ListActionsResponse(actions=[resources.Action()], next_page_token='ghi'), service.ListActionsResponse(actions=[resources.Action(), resources.Action()]), RuntimeError)
...
@pytest.mark.asyncio
async def test_create_zone_async(transport: str='grpc_asyncio', request_type=service.CreateZoneRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_zone), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_create_zone_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_zone), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_zone(parent='parent_value', zone=resources.Zone(name='name_value'), zone_id='zone_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_zone_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_zone(service.CreateZoneRequest(), parent='parent_value', zone=resources.Zone(name='name_value'), zone_id='zone_id_value')
...
@pytest.mark.asyncio
async def test_update_zone_async(transport: str='grpc_asyncio', request_type=service.UpdateZoneRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.update_zone), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_update_zone_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_zone), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_zone(zone=resources.Zone(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].zone
        mock_val = resources.Zone(name='name_value')
...
async def test_update_zone_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_zone(service.UpdateZoneRequest(), zone=resources.Zone(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
@pytest.mark.asyncio
async def test_delete_zone_async(transport: str='grpc_asyncio', request_type=service.DeleteZoneRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.delete_zone), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_delete_zone_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_zone(service.DeleteZoneRequest(), name='name_value')
...
async def test_list_zones_async(transport: str='grpc_asyncio', request_type=service.ListZonesRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_zones), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListZonesResponse(next_page_token='next_page_token_value'))
...
async def test_get_zone_async(transport: str='grpc_asyncio', request_type=service.GetZoneRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_zone), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Zone(name='name_value', display_name='display_name_value', uid='uid_value', description='description_value', state=resources.State.ACTIVE, type_=resources.Zone.Type.RAW))
...
@pytest.mark.asyncio
async def test_list_zone_actions_async(transport: str='grpc_asyncio', request_type=service.ListZoneActionsRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_zone_actions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListActionsResponse(next_page_token='next_page_token_value'))
...
async def test_list_zone_actions_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_zone_actions(service.ListZoneActionsRequest(), parent='parent_value')
...
async def test_list_zone_actions_async_pager():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_zone_actions), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListActionsResponse(actions=[resources.Action(), resources.Action(), resources.Action()], next_page_token='abc'), service.ListActionsResponse(actions=[], next_page_token='def'), service.ListActionsResponse(actions=[resources.Action()], next_page_token='ghi'), service.ListActionsResponse(actions=[resources.Action(), resources.Action()]), RuntimeError)
...
@pytest.mark.asyncio
async def test_update_asset_async(transport: str='grpc_asyncio', request_type=service.UpdateAssetRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.update_asset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_update_asset_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_asset), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_asset(asset=resources.Asset(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].asset
        mock_val = resources.Asset(name='name_value')
...
async def test_update_asset_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_asset(service.UpdateAssetRequest(), asset=resources.Asset(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_list_assets_async(transport: str='grpc_asyncio', request_type=service.ListAssetsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_assets), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListAssetsResponse(next_page_token='next_page_token_value'))
...
async def test_get_asset_async(transport: str='grpc_asyncio', request_type=service.GetAssetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_asset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(resources.Asset(name='name_value', display_name='display_name_value', uid='uid_value', description='description_value', state=resources.State.ACTIVE))
...
@pytest.mark.asyncio
async def test_list_asset_actions_async(transport: str='grpc_asyncio', request_type=service.ListAssetActionsRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_asset_actions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListActionsResponse(next_page_token='next_page_token_value'))
...
async def test_list_asset_actions_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_asset_actions(service.ListAssetActionsRequest(), parent='parent_value')
...
async def test_list_asset_actions_async_pager():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_asset_actions), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (service.ListActionsResponse(actions=[resources.Action(), resources.Action(), resources.Action()], next_page_token='abc'), service.ListActionsResponse(actions=[], next_page_token='def'), service.ListActionsResponse(actions=[resources.Action()], next_page_token='ghi'), service.ListActionsResponse(actions=[resources.Action(), resources.Action()]), RuntimeError)
...
@pytest.mark.asyncio
async def test_create_task_async(transport: str='grpc_asyncio', request_type=service.CreateTaskRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_task), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_create_task_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_task(service.CreateTaskRequest(), parent='parent_value', task=tasks.Task(name='name_value'), task_id='task_id_value')
...
@pytest.mark.asyncio
async def test_update_task_async(transport: str='grpc_asyncio', request_type=service.UpdateTaskRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.update_task), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_update_task_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_task(service.UpdateTaskRequest(), task=tasks.Task(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
@pytest.mark.asyncio
async def test_delete_task_async(transport: str='grpc_asyncio', request_type=service.DeleteTaskRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.delete_task), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_delete_task_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_task(service.DeleteTaskRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_list_tasks_async(transport: str='grpc_asyncio', request_type=service.ListTasksRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_tasks), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListTasksResponse(next_page_token='next_page_token_value', unreachable_locations=['unreachable_locations_value']))
...
async def test_list_tasks_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_tasks(service.ListTasksRequest(), parent='parent_value')
...
@pytest.mark.asyncio
async def test_get_task_async(transport: str='grpc_asyncio', request_type=service.GetTaskRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.get_task), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(tasks.Task(name='name_value', uid='uid_value', description='description_value', display_name='display_name_value', state=resources.State.ACTIVE))
...
async def test_get_task_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_task(service.GetTaskRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_list_jobs_async(transport: str='grpc_asyncio', request_type=service.ListJobsRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_jobs), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListJobsResponse(next_page_token='next_page_token_value'))
...
async def test_list_jobs_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_jobs), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListJobsResponse())
...
async def test_list_jobs_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_jobs(service.ListJobsRequest(), parent='parent_value')
...
@pytest.mark.asyncio
async def test_run_task_async(transport: str='grpc_asyncio', request_type=service.RunTaskRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.run_task), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.RunTaskResponse())
...
async def test_run_task_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.run_task(service.RunTaskRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_get_job_async(transport: str='grpc_asyncio', request_type=service.GetJobRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.get_job), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(tasks.Job(name='name_value', uid='uid_value', state=tasks.Job.State.RUNNING, retry_count=1214, service=tasks.Job.Service.DATAPROC, service_job='service_job_value', message='message_value', trigger=tasks.Job.Trigger.TASK_CONFIG))
...
async def test_get_job_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_job(service.GetJobRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_cancel_job_async(transport: str='grpc_asyncio', request_type=service.CancelJobRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.cancel_job), '__call__') as call:
...
async def test_cancel_job_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.cancel_job(service.CancelJobRequest(), name='name_value')
...
async def test_create_environment_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_environment), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_environment(parent='parent_value', environment=analyze.Environment(name='name_value'), environment_id='environment_id_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_environment_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_environment(service.CreateEnvironmentRequest(), parent='parent_value', environment=analyze.Environment(name='name_value'), environment_id='environment_id_value')
...
@pytest.mark.asyncio
async def test_update_environment_async(transport: str='grpc_asyncio', request_type=service.UpdateEnvironmentRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.update_environment), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
...
async def test_update_environment_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_environment), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.update_environment(environment=analyze.Environment(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].environment
        mock_val = analyze.Environment(name='name_value')
...
async def test_update_environment_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_environment(service.UpdateEnvironmentRequest(), environment=analyze.Environment(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_delete_environment_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_environment(service.DeleteEnvironmentRequest(), name='name_value')
...
async def test_list_environments_async(transport: str='grpc_asyncio', request_type=service.ListEnvironmentsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_environments), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListEnvironmentsResponse(next_page_token='next_page_token_value'))
...
async def test_list_environments_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_environments(service.ListEnvironmentsRequest(), parent='parent_value')
...
async def test_get_environment_async(transport: str='grpc_asyncio', request_type=service.GetEnvironmentRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_environment), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(analyze.Environment(name='name_value', display_name='display_name_value', uid='uid_value', description='description_value', state=resources.State.ACTIVE))
...
async def test_get_environment_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_environment(service.GetEnvironmentRequest(), name='name_value')
...
@pytest.mark.asyncio
async def test_list_sessions_async(transport: str='grpc_asyncio', request_type=service.ListSessionsRequest):
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_sessions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListSessionsResponse(next_page_token='next_page_token_value'))
...
async def test_list_sessions_field_headers_async():
    ...
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_sessions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListSessionsResponse())
...
async def test_list_sessions_flattened_error_async():
    client = DataplexServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_sessions(service.ListSessionsRequest(), parent='parent_value')
