...
@pytest.mark.parametrize('fn, exp', [(C.async_class, 31), (C.sync_class, 31), (C.async_static, 'one-three'), (C.sync_static, 'one-three'), (C().async_instance, 13), (C().sync_instance, 13), (async_callable, 'three-one'), (sync_callable, 'three-one'), (async_partial, 'why-three-and-one'), (sync_partial, 'why-three-and-one')])
