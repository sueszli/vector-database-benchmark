...
from .const import DOMAIN, OAUTH2_AUTHORIZE, OAUTH2_CLIENTID, OAUTH2_CLIENTSECRET, OAUTH2_TOKEN
...
class OndiloOauth2Implementation(LocalOAuth2Implementation):
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        ...
        super().__init__(hass, DOMAIN, OAUTH2_CLIENTID, OAUTH2_CLIENTSECRET, OAUTH2_AUTHORIZE, OAUTH2_TOKEN)
