...
__protobuf__ = proto.module(package='google.cloud.discoveryengine.v1alpha', manifest={'CreateDataStoreRequest', 'GetDataStoreRequest', 'CreateDataStoreMetadata', 'ListDataStoresRequest', 'ListDataStoresResponse', 'DeleteDataStoreRequest', 'UpdateDataStoreRequest', 'DeleteDataStoreMetadata'})
...
class CreateDataStoreRequest(proto.Message):
    ...
    data_store: gcd_data_store.DataStore = proto.Field(proto.MESSAGE, number=2, message=gcd_data_store.DataStore)
    data_store_id: str = proto.Field(proto.STRING, number=3)
    create_advanced_site_search: bool = proto.Field(proto.BOOL, number=4)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    data_stores: MutableSequence[gcd_data_store.DataStore] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcd_data_store.DataStore)
...
class UpdateDataStoreRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            INVALID_ARGUMENT error is returned.
    """
    data_store: gcd_data_store.DataStore = proto.Field(proto.MESSAGE, number=1, message=gcd_data_store.DataStore)
