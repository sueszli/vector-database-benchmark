...
from typing import TYPE_CHECKING, Any, List, Mapping, NamedTuple, Optional, Sequence, Set, Union, cast
...
@whitelist_for_serdes
class AddDynamicPartitionsRequest(NamedTuple('_AddDynamicPartitionsRequest', [('partitions_def_name', str), ('partition_keys', Sequence[str])])):
...
@whitelist_for_serdes
class DeleteDynamicPartitionsRequest(NamedTuple('_AddDynamicPartitionsRequest', [('partitions_def_name', str), ('partition_keys', Sequence[str])])):
...
@whitelist_for_serdes
class RunRequest(NamedTuple('_RunRequest', [('run_key', PublicAttr[Optional[str]]), ('run_config', PublicAttr[Mapping[str, Any]]), ('tags', PublicAttr[Mapping[str, str]]), ('job_name', PublicAttr[Optional[str]]), ('asset_selection', PublicAttr[Optional[Sequence[AssetKey]]]), ('stale_assets_only', PublicAttr[bool]), ('partition_key', PublicAttr[Optional[str]])])):
...
@whitelist_for_serdes(storage_name='PipelineRunReaction', storage_field_names={'dagster_run': 'pipeline_run'})
class DagsterRunReaction(NamedTuple('_DagsterRunReaction', [('dagster_run', Optional[DagsterRun]), ('error', Optional[SerializableErrorInfo]), ('run_status', Optional[DagsterRunStatus])])):
...
@experimental_param(param='asset_events', additional_warn_text='Runless asset events are experimental')
class SensorResult(NamedTuple('_SensorResult', [('run_requests', Optional[Sequence[RunRequest]]), ('skip_reason', Optional[SkipReason]), ('cursor', Optional[str]), ('dynamic_partitions_requests', Optional[Sequence[Union[DeleteDynamicPartitionsRequest, AddDynamicPartitionsRequest]]]), ('asset_events', List[Union[AssetObservation, AssetMaterialization, AssetCheckEvaluation]])])):
