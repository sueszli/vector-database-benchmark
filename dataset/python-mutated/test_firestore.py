...
from tests.providers.google.cloud.utils.base_gcp_mock import GCP_PROJECT_ID_HOOK_UNIT_TEST, mock_base_gcp_hook_default_project_id, mock_base_gcp_hook_no_default_project_id
EXPORT_DOCUMENT_BODY = {'outputUriPrefix': 'gs://test-bucket/test-namespace/', 'collectionIds': ['test-collection']}
