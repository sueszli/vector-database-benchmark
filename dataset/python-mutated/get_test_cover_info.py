...
type_dict_paddle_to_str = {paddle.bool: 'bool', paddle.uint8: 'uint8', paddle.int8: 'int8', paddle.int16: 'int16', paddle.int32: 'int32', paddle.int64: 'int64', paddle.float16: 'float16', paddle.bfloat16: 'bfloat16', paddle.float32: 'float32', paddle.float64: 'float64', paddle.complex128: 'complex128', paddle.complex64: 'complex64'}
type_dict_paddle_to_numpy = {paddle.bool: np.bool_, paddle.uint8: np.uint8, paddle.int8: np.int8, paddle.int16: np.int16, paddle.int32: np.int32, paddle.int64: np.int64, paddle.bfloat16: np.uint16, paddle.float16: np.float16, paddle.float32: np.float32, paddle.float64: np.float64, paddle.complex128: np.complex128, paddle.complex64: np.complex64}
type_dict_str_to_paddle = {'uint8': paddle.uint8, 'int8': paddle.int8, 'int16': paddle.int16, 'int32': paddle.int32, 'int64': paddle.int64, 'bfloat16': paddle.bfloat16, 'float16': paddle.float16, 'float32': paddle.float32, 'float64': paddle.float64, 'bool': paddle.bool, 'complex64': paddle.complex64, 'complex128': paddle.complex128}
type_dict_str_to_numpy = {'uint8': np.uint8, 'int8': np.int8, 'int16': np.int16, 'int32': np.int32, 'int64': np.int64, 'bfloat16': np.uint16, 'float16': np.float16, 'float32': np.float32, 'float64': np.float64, 'bool': np.bool_, 'complex64': np.complex64, 'complex128': np.complex128}
xpu_test_op_white_list = []
xpu_test_device_type_white_list = ['xpu1_float64']
xpu_test_op_type_white_list = ['dropout_float16', 'dropout_grad_float16', 'grad_add_float32', 'lamb_float16', 'lars_momentum_float32', 'resnet_unit', 'resnet_unit_grad', 'c_embedding_float32', 'c_sync_comm_stream_float32', 'c_sync_calc_stream_float32', 'reshape2_bool', 'reshape2_grad_bool']
