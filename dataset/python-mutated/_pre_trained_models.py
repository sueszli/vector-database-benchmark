...
IMAGE_MODELS = {'resnet-50': ResNetImageClassifier, 'squeezenet_v1.1': SqueezeNetImageClassifierV1_1}
...
class DarkNetObjectDetectorModel(ObjectDetectorBasePreTrainedModel):
    ...
    def get_model_path(self):
        ...
        return model_path
OBJECT_DETECTION_BASE_MODELS = {'darknet': DarkNetObjectDetectorBase, 'darknet_mlmodel': DarkNetObjectDetectorModel}
