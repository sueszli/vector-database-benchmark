...
from modelscope.models.cv.image_to_image_translation.model_translation import UNet
...
@PIPELINES.register_module(Tasks.image_to_image_translation, module_name=Pipelines.image2image_translation)
