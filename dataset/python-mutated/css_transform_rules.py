from qt.core import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QComboBox, QLineEdit, QPushButton, QSize, pyqtSignal, QMenu, QDialogButtonBox, QTextCursor
from calibre.ebooks.css_transform_rules import validate_rule, safe_parser, compile_rules, transform_sheet, ACTION_MAP, MATCH_TYPE_MAP, export_rules, import_rules
from calibre.gui2 import error_dialog, elided_text, choose_save_file, choose_files
from calibre.gui2.tag_mapper import RuleEdit as RE, RuleEditDialog as RuleEditDialogBase, Rules as RulesBase, RulesDialog as RulesDialogBase, RuleItem as RuleItemBase, SaveLoadMixin
...
if __name__ == '__main__':
    ...
    app = Application([])
    d = RulesDialog()
    d.rules = [{'property': 'color', 'match_type': '*', 'query': '', 'action': 'change', 'action_data': 'green'}]
    d.exec()
