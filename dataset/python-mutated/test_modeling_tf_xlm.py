...
if is_tf_available():
    ...
    from transformers import TF_XLM_PRETRAINED_MODEL_ARCHIVE_LIST, TFXLMForMultipleChoice, TFXLMForQuestionAnsweringSimple, TFXLMForSequenceClassification, TFXLMForTokenClassification, TFXLMModel, TFXLMWithLMHeadModel, XLMConfig
...
class TFXLMModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': TFXLMModel, 'fill-mask': TFXLMWithLMHeadModel, 'question-answering': TFXLMForQuestionAnsweringSimple, 'text-classification': TFXLMForSequenceClassification, 'text-generation': TFXLMWithLMHeadModel, 'token-classification': TFXLMForTokenClassification, 'zero-shot': TFXLMForSequenceClassification} if is_tf_available() else {}
