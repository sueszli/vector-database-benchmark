...
class GRAPHITEWhiteboxPyTorch(EvasionAttack):
    ...
    | Original github link: https://github.com/ryan-feng/GRAPHITE
    """
    attack_params = EvasionAttack.attack_params + ['net_size', 'min_tr', 'num_xforms', 'step_size', 'steps', 'first_steps', 'patch_removal_size', 'patch_removal_interval', 'num_patches_to_remove', 'rand_start_epsilon_range', 'rotation_range', 'dist_range', 'gamma_range', 'crop_percent_range', 'off_x_range', 'off_y_range', 'blur_kernels', 'batch_size']
