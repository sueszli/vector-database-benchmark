...
class OrganizationDomainSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'domain', 'is_verified', 'verified_at', 'verification_challenge', 'jit_provisioning_enabled', 'sso_enforcement', 'has_saml', 'saml_entity_id', 'saml_acs_url', 'saml_x509_cert')
        extra_kwargs = {'verified_at': {'read_only': True}, 'verification_challenge': {'read_only': True}, 'is_verified': {'read_only': True}, 'has_saml': {'read_only': True}}
