...
SWIN_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/swin-tiny-patch4-window7-224': 'https://huggingface.co/microsoft/swin-tiny-patch4-window7-224/resolve/main/config.json'}
