...
import yaml
import jsonschema
from ray._private.runtime_env.validation import parse_and_validate_excludes, parse_and_validate_working_dir, parse_and_validate_conda, parse_and_validate_pip, parse_and_validate_env_vars, parse_and_validate_py_modules
...
test_env_1 = os.path.join(os.path.dirname(__file__), 'test_runtime_env_validation_1_schema.json')
test_env_2 = os.path.join(os.path.dirname(__file__), 'test_runtime_env_validation_2_schema.json')
test_env_invalid_path = os.path.join(os.path.dirname(__file__), 'test_runtime_env_validation_non_existent.json')
test_env_bad_json = os.path.join(os.path.dirname(__file__), 'test_runtime_env_validation_bad_2_schema.json')

@pytest.mark.parametrize('set_runtime_env_plugin_schemas', [schemas_dir, f'{test_env_1},{test_env_2}', f'{test_env_bad_json},{test_env_1},{test_env_2}', f'{test_env_invalid_path},{test_env_1},{test_env_2}'], indirect=True)
