...
from dagster import Array, BoolSource, Field, Noneable, Permissive, Shape, StringSource, _check as check
...
SHARED_ECS_SCHEMA = {'env_vars': Field([StringSource], is_required=False, description='List of environment variable names to include in the ECS task. Each can be of the form KEY=VALUE or just KEY (in which case the value will be pulled from the current process)'), 'run_resources': Field(Permissive({'cpu': Field(str, is_required=False, description='The CPU override to use for the launched task.'), 'memory': Field(str, is_required=False, description='The memory override to use for the launched task.'), 'ephemeral_storage': Field(int, is_required=False, description='The ephemeral storage, in GiB, to use for the launched task.')})), 'run_ecs_tags': Field(Array({'key': Field(StringSource, is_required=True), 'value': Field(StringSource, is_required=False)}), is_required=False, description='Additional tags to apply to the launched ECS task.')}
SHARED_TASK_DEFINITION_FIELDS = {'execution_role_arn': Field(StringSource, is_required=False, description='ARN of the task execution role for the ECS container and Fargate agent to make AWS API calls on your behalf. See https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_execution_IAM_role.html. '), 'task_role_arn': Field(StringSource, is_required=False, description='ARN of the IAM role for launched tasks. See https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-iam-roles.html. '), 'runtime_platform': Field(Shape({'cpuArchitecture': Field(StringSource, is_required=False), 'operatingSystemFamily': Field(StringSource, is_required=False)}), is_required=False, description='The operating system that the task definition is running on. See https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ecs.html#ECS.Client.register_task_definition for the available options.'), 'volumes': Field(Array(Permissive({'name': Field(StringSource, is_required=False)})), is_required=False, description='List of data volume definitions for the task. See https://docs.aws.amazon.com/AmazonECS/latest/developerguide/efs-volumes.html for the full list of available options.'), 'mount_points': Field(Array(Shape({'sourceVolume': Field(StringSource, is_required=False), 'containerPath': Field(StringSource, is_required=False), 'readOnly': Field(BoolSource, is_required=False)})), is_required=False, description='Mount points for data volumes in the main container of the task. See https://docs.aws.amazon.com/AmazonECS/latest/developerguide/efs-volumes.html for more information.'), 'repository_credentials': Field(StringSource, is_required=False, description='The arn of the secret to authenticate into your private container registry. This does not apply if you are leveraging ECR for your images, see https://docs.aws.amazon.com/AmazonECS/latest/userguide/private-auth.html.')}
ECS_CONTAINER_CONTEXT_SCHEMA = {'secrets': Field(Noneable(Array(Shape({'name': StringSource, 'valueFrom': StringSource}))), is_required=False, description='An array of AWS Secrets Manager secrets. These secrets will be mounted as environment variables in the container. See https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_Secret.html.'), 'secrets_tags': Field(Noneable(Array(StringSource)), is_required=False, description='AWS Secrets Manager secrets with these tags will be mounted as environment variables in the container.'), 'task_definition_arn': Field(StringSource, is_required=False, description='ARN of the task definition to use to launch the container.'), 'container_name': Field(StringSource, is_required=False, description='Name of the container in the task definition to use to run Dagster code.'), 'server_resources': Field(Permissive({'cpu': Field(str, is_required=False, description='The CPU override to use for the launched task.'), 'memory': Field(str, is_required=False, description='The memory override to use for the launched task.'), 'ephemeral_storage': Field(int, is_required=False, description='The ephemeral storage, in GiB, to use for the launched task.')})), 'server_sidecar_containers': Field(Array(Permissive({})), is_required=False, description='Additional sidecar containers to include in code server task definitions.'), 'server_ecs_tags': Field(Array({'key': Field(StringSource, is_required=True), 'value': Field(StringSource, is_required=False)}), is_required=False, description='Additional tags to apply to the launched ECS task for a code server.'), 'run_sidecar_containers': Field(Array(Permissive({})), is_required=False, description='Additional sidecar containers to include in run task definitions.'), **SHARED_TASK_DEFINITION_FIELDS, **SHARED_ECS_SCHEMA}

class EcsContainerContext(NamedTuple('_EcsContainerContext', [('secrets', Sequence[Any]), ('secrets_tags', Sequence[str]), ('env_vars', Sequence[str]), ('task_definition_arn', Optional[str]), ('container_name', Optional[str]), ('server_resources', Mapping[str, Any]), ('run_resources', Mapping[str, Any]), ('task_role_arn', Optional[str]), ('execution_role_arn', Optional[str]), ('runtime_platform', Mapping[str, Any]), ('mount_points', Sequence[Mapping[str, Any]]), ('volumes', Sequence[Mapping[str, Any]]), ('server_sidecar_containers', Sequence[Mapping[str, Any]]), ('run_sidecar_containers', Sequence[Mapping[str, Any]]), ('server_ecs_tags', Sequence[Mapping[str, Optional[str]]]), ('run_ecs_tags', Sequence[Mapping[str, Optional[str]]]), ('repository_credentials', Optional[str])])):
