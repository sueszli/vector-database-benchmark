...
from picard.formats import id3, open_
...
class MP3Test(CommonId3Tests.Id3TestCase):
    ...
    expected_info = {'length': 156, '~channels': '2', '~sample_rate': '44100'}
...
class TTATest(CommonId3Tests.Id3TestCase):
    testfile = 'test.tta'
    supports_ratings = True
    expected_info = {'length': 82, '~sample_rate': '44100'}
    unexpected_info = ['~video']

class DSFTest(CommonId3Tests.Id3TestCase):
    testfile = 'test.dsf'
    supports_ratings = True
    expected_info = {'length': 10, '~channels': '2', '~sample_rate': '5644800', '~bitrate': '11289.6', '~bits_per_sample': '1'}
    unexpected_info = ['~video']
if id3.DSDIFFFile:
    ...
    class DSDIFFDSTTest(CommonId3Tests.Id3TestCase):
        ...
        supports_ratings = True
        expected_info = {'length': 0, '~channels': '2', '~sample_rate': '5644800', '~bits_per_sample': '1'}
        unexpected_info = ['~video']

class AIFFTest(CommonId3Tests.Id3TestCase):
    testfile = 'test.aiff'
    supports_ratings = False
    expected_info = {'length': 82, '~channels': '2', '~sample_rate': '44100', '~bitrate': '1411.2'}
    unexpected_info = ['~video']
