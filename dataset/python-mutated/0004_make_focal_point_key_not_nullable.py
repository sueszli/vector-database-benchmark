...
class Migration(migrations.Migration):
    dependencies = [('wagtailimages', '0003_fix_focal_point_fields')]
    operations = [migrations.RunPython(remove_duplicate_renditions, reverse_remove_duplicate_renditions), migrations.AlterField(model_name='rendition', name='focal_point_key', field=models.CharField(blank=True, default='', max_length=18, editable=False))]