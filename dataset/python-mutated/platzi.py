...
from ..utils import clean_html, ExtractorError, int_or_none, str_or_none, try_get, url_or_none, urlencode_postdata, urljoin
...
class PlatziIE(PlatziBaseIE):
    ...
    _TESTS = [{'url': 'https://platzi.com/clases/1311-next-js/12074-creando-nuestra-primera-pagina/', 'md5': '8f56448241005b561c10f11a595b37e3', 'info_dict': {'id': '12074', 'ext': 'mp4', 'title': 'Creando nuestra primera página', 'description': 'md5:4c866e45034fc76412fbf6e60ae008bc', 'duration': 420}, 'skip': 'Requires platzi account credentials'}, {'url': 'https://courses.platzi.com/classes/1367-communication-codestream/13430-background/', 'info_dict': {'id': '13430', 'ext': 'mp4', 'title': 'Background', 'description': 'md5:49c83c09404b15e6e71defaf87f6b305', 'duration': 360}, 'skip': 'Requires platzi account credentials', 'params': {'skip_download': True}}]
...
class PlatziCourseIE(PlatziBaseIE):
    _VALID_URL = '(?x)\n                    https?://\n                        (?:\n                            platzi\\.com/clases|           # es version\n                            courses\\.platzi\\.com/classes  # en version\n                        )/(?P<id>[^/?\\#&]+)\n                    '
    _TESTS = [{'url': 'https://platzi.com/clases/next-js/', 'info_dict': {'id': '1311', 'title': 'Curso de Next.js'}, 'playlist_count': 22}, {'url': 'https://courses.platzi.com/classes/communication-codestream/', 'info_dict': {'id': '1367', 'title': 'Codestream Course'}, 'playlist_count': 14}]
