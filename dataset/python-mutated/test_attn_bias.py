...
import numpy as np
import paddle
from paddle.incubate.nn.attn_bias import BlockDiagonalCausalMask, BlockDiagonalCausalWithOffsetPaddedKeysMask, BlockDiagonalMask, LowerTriangularMask, LowerTriangularMaskWithTensorBias, PaddedSeqLenInfo, SeqLenInfo
