...
def inspect_string_with_exclusion_dict(project: str, content_string: str, exclusion_list: List[str]=['example@example.com']) -> None:
    if False:
        while True:
            i = 10
    ...
    rule_set = [{'info_types': info_types_to_locate, 'rules': [{'exclusion_rule': {'dictionary': {'word_list': {'words': exclusion_list}}, 'matching_type': google.cloud.dlp_v2.MatchingType.MATCHING_TYPE_FULL_MATCH}}]}]
