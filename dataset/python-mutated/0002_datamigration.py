...
visualizers = {'Yara': {'disabled': False, 'description': 'Visualize information about yara matches', 'python_module': 'yara.Yara', 'analyzers': ['Yara'], 'connectors': [], 'params': {}, 'secrets': {}}}
...
class Migration(migrations.Migration):
    dependencies = [('visualizers_manager', '0001_initial'), ('analyzers_manager', '0004_datamigration'), ('connectors_manager', '0004_datamigration')]
