...
sum_configs = op_bench.cross_product_configs(R=[64, 256], V=[32, 512], dim=[0, 1], contiguous=[True, False], device=['cpu', 'cuda'], tags=['short']) + op_bench.cross_product_configs(R=[1024, 8192], V=[512, 1024], dim=[0, 1], contiguous=[True, False], device=['cpu', 'cuda'], tags=['long'])
