...
from ydata_profiling.model.pandas.correlations_pandas import pandas_pearson_compute, pandas_spearman_compute
from ydata_profiling.model.spark.correlations_spark import spark_pearson_compute, spark_spearman_compute
