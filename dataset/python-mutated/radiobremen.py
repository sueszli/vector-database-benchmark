...
class RadioBremenIE(InfoExtractor):
    ...
    IE_NAME = 'radiobremen'
    _TEST = {'url': 'http://www.radiobremen.de/mediathek/?id=141876', 'info_dict': {'id': '141876', 'ext': 'mp4', 'duration': 178, 'width': 512, 'title': 'Druck auf Patrick Öztürk', 'thumbnail': 're:https?://.*\\.jpg$', 'description': 'Gegen den SPD-Bürgerschaftsabgeordneten Patrick Öztürk wird wegen Beihilfe zum gewerbsmäßigen Betrug ermittelt. Am Donnerstagabend sollte er dem Vorstand des SPD-Unterbezirks Bremerhaven dazu Rede und Antwort stehen.'}}
