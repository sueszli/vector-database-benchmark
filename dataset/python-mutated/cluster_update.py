...
def main():
    ...
    response = client.clusters.begin_update(resource_group_name='TestGroup', cluster_name='testcluster', parameters={'properties': {'administratorLoginPassword': 'newpassword', 'coordinatorVCores': 16, 'nodeCount': 4, 'nodeVCores': 16}}).result()
    print(response)
