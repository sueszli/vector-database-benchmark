...
class SkipRev(BaseAddon):
    ...
    __version__ = '0.38'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('mode', 'Auto;Manual', 'Choose recovery archives to skip', 'Auto'), ('revtokeep', 'int', 'Number of recovery archives to keep for package', 0)]
