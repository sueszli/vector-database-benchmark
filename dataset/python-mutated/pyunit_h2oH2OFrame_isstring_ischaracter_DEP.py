...
def h2o_H2OFrame_isstring():
    ...
    assert sum(clist) == col_num, 'h2o.H2OFrame.isstring() command is not working.'
    clist2 = newFrame.ischaracter()
    assert_is_type(clist2, list)
    assert sum(clist2) == col_num, 'h2o.H2OFrame.ischaracter() command is not working.'
