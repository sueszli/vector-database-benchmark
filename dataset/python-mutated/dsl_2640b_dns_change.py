...
class Exploit(HTTPClient):
    __info__ = {'name': 'D-Link DSL-2640B DNS Change', 'description': 'Module exploits D-Link DSL-2640B dns change vulnerability. If the target is vulnerable it is possible to change dns settings.', 'authors': ('Todor Donev <todor.doven[at]gmail.com>', 'Marcin Bury <marcin[at]threat9.com>'), 'references': ('https://www.exploit-db.com/exploits/36105/', 'https://github.com/jh00nbr/Routerhunter-2.0'), 'devices': ('D-Link DSL-2640B',)}
