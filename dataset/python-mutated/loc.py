...
about = {'website': 'https://www.loc.gov/pictures/', 'wikidata_id': 'Q131454', 'official_api_documentation': 'https://www.loc.gov/api', 'use_official_api': True, 'require_api_key': False, 'results': 'JSON'}
categories = ['images']
paging = True
endpoint = 'photos'
