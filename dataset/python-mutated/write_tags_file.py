...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--short-image-name', required=True, help='Short image name to write tags for')
    arg_parser.add_argument('--tags-dir', required=True, type=Path, help='Directory to save tags file')
