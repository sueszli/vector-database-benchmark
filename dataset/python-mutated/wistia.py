...
from ..utils import ExtractorError, determine_ext, float_or_none, int_or_none, parse_qs, traverse_obj, try_get, update_url_query, urlhandle_detect_ext

class WistiaBaseIE(InfoExtractor):
    _VALID_ID_REGEX = '(?P<id>[a-z0-9]{10})'
    _VALID_URL_BASE = 'https?://(?:\\w+\\.)?wistia\\.(?:net|com)/(?:embed/)?'
...
class WistiaPlaylistIE(WistiaBaseIE):
    _VALID_URL = '%splaylists/%s' % (WistiaBaseIE._VALID_URL_BASE, WistiaBaseIE._VALID_ID_REGEX)
    _TEST = {'url': 'https://fast.wistia.net/embed/playlists/aodt9etokc', 'info_dict': {'id': 'aodt9etokc'}, 'playlist_count': 3}
...
class WistiaChannelIE(WistiaBaseIE):
    _VALID_URL = '(?:wistiachannel:|%schannel/)%s' % (WistiaBaseIE._VALID_URL_BASE, WistiaBaseIE._VALID_ID_REGEX)
    _TESTS = [{'url': 'https://fast.wistia.net/embed/channel/yvyvu7wjbg?wchannelid=yvyvu7wjbg', 'info_dict': {'id': 'yvyvu7wjbg', 'title': 'Copysmith Tutorials and Education!', 'description': 'Learn all things Copysmith via short and informative videos!'}, 'playlist_mincount': 7, 'expected_warnings': ['falling back to webpage']}, {'url': 'https://fast.wistia.net/embed/channel/3802iirk0l', 'info_dict': {'id': '3802iirk0l', 'title': 'The Roof'}, 'playlist_mincount': 20}, {'url': 'https://fast.wistia.net/embed/channel/3802iirk0l?wchannelid=3802iirk0l&wmediaid=sp5dqjzw3n', 'info_dict': {'id': 'sp5dqjzw3n', 'ext': 'mp4', 'title': 'The Roof S2: The Modern CRO', 'thumbnail': 'https://embed-ssl.wistia.com/deliveries/dadfa9233eaa505d5e0c85c23ff70741.png', 'duration': 86.487, 'description': 'A sales leader on The Roof? Man, they really must be letting anyone up here this season.\n', 'timestamp': 1619790290, 'upload_date': '20210430'}, 'params': {'noplaylist': True, 'skip_download': True}}]
    _WEBPAGE_TESTS = [{'url': 'https://www.profitwell.com/recur/boxed-out', 'info_dict': {'id': '6jyvmqz6zs', 'title': 'Boxed Out', 'description': 'md5:14a8a93a1dbe236718e6a59f8c8c7bae'}, 'playlist_mincount': 30}, {'url': 'https://360learning.com/studio/onboarding-joei/', 'info_dict': {'id': 'z874k93n2o', 'title': 'Onboarding Joei.', 'description': 'Coming to you weekly starting Feb 19th.'}, 'playlist_mincount': 20}, {'url': 'https://amplitude.com/amplify-sessions?amp%5Bwmediaid%5D=pz0m0l0if3&amp%5Bwvideo%5D=pz0m0l0if3&wchannelid=emyjmwjf79&wmediaid=i8um783bdt', 'info_dict': {'id': 'pz0m0l0if3', 'title': 'A Framework for Improving Product Team Performance', 'ext': 'mp4', 'timestamp': 1653935275, 'upload_date': '20220530', 'description': 'Learn how to help your company improve and achieve your product related goals.', 'duration': 1854.39, 'thumbnail': 'https://embed-ssl.wistia.com/deliveries/12fd19e56413d9d6f04e2185c16a6f8854e25226.png'}, 'params': {'noplaylist': True, 'skip_download': True}}]
