...
class WorkuploadCom(SimpleDownloader):
    ...
    __version__ = '0.02'
    __status__ = 'testing'
    __pattern__ = 'https?://workupload\\.com/(?:file|start)/(?P<ID>\\w+)'
    ...
    INFO_PATTERN = '<td>Filename:\\xa0</td><td [^>]+>(?P<N>.+?)</td></tr><tr><td>Filesize:\\xa0</td><td>(?P<S>\\d+) \\((?P<U>[\\w^_]+)\\)</td></tr><tr><td>Checksum:\\xa0</td><td [^>]+>(?P<D>\\w+) \\((?P<H>\\w+)\\)<'
    URL_REPLACEMENTS = [(__pattern__ + '.*', 'https://workupload.com/file/\\g<ID>')]
