...
if __name__ == '__main__':
    app = LightningApp(RootHPOFlow(script_path=str(Path(__file__).parent / 'pl_script.py'), data_dir='data/hymenoptera_data_version_0', total_trials=6, simultaneous_trials=2))