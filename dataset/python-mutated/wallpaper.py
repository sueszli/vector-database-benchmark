...
class Wallpaper(base._TextBox):
    defaults = [('directory', '~/Pictures/wallpapers/', 'Wallpaper Directory'), ('wallpaper', None, 'Wallpaper'), ('wallpaper_command', ['feh', '--bg-fill'], 'Wallpaper command. If None, thewallpaper will be painted without the use of a helper.'), ('random_selection', False, 'If set, use random initial wallpaper and randomly cycle through the wallpapers.'), ('label', None, 'Use a fixed label instead of image name.'), ('option', 'fill', "How to fit the wallpaper when wallpaper_command isNone. None, 'fill' or 'stretch'.")]
