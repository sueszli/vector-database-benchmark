...
class WebTestsOperations:
    ...
    async def get(self, resource_group_name: str, web_test_name: str, **kwargs: Any) -> _models.WebTest:
        ...
        request = build_get_request(resource_group_name=resource_group_name, web_test_name=web_test_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, web_test_name: str, web_test_definition: _models.WebTest, *, content_type: str='application/json', **kwargs: Any) -> _models.WebTest:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, web_test_name: str, web_test_definition: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.WebTest:
        """Creates or updates an Application Insights web test definition.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, web_test_name: str, web_test_definition: Union[_models.WebTest, IO], **kwargs: Any) -> _models.WebTest:
        """Creates or updates an Application Insights web test definition.
        ...
        request = build_create_or_update_request(resource_group_name=resource_group_name, web_test_name=web_test_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_tags(self, resource_group_name: str, web_test_name: str, web_test_tags: _models.TagsResource, *, content_type: str='application/json', **kwargs: Any) -> _models.WebTest:
    ...
    @overload
    async def update_tags(self, resource_group_name: str, web_test_name: str, web_test_tags: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.WebTest:
        """Updates the tags associated with an Application Insights web test.
    ...
    @distributed_trace_async
    async def update_tags(self, resource_group_name: str, web_test_name: str, web_test_tags: Union[_models.TagsResource, IO], **kwargs: Any) -> _models.WebTest:
        """Updates the tags associated with an Application Insights web test.
        ...
        request = build_update_tags_request(resource_group_name=resource_group_name, web_test_name=web_test_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_tags.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def delete(self, resource_group_name: str, web_test_name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, web_test_name=web_test_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_by_component(self, component_name: str, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.WebTest']:
        if False:
            for i in range(10):
                print('nop')
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_by_component_request(component_name=component_name, resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_by_component.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
