...
class TestAsyncAssistants:
    ...
    async def test_method_create(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.create(model='string')
        assert_matches_type(Assistant, assistant, path=['response'])

    @parametrize
    async def test_method_create_with_all_params(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.create(model='string', description='string', file_ids=['string', 'string', 'string'], instructions='string', metadata={}, name='string', tools=[{'type': 'code_interpreter'}, {'type': 'code_interpreter'}, {'type': 'code_interpreter'}])
        assert_matches_type(Assistant, assistant, path=['response'])

    @parametrize
    async def test_raw_response_create(self, client: AsyncOpenAI) -> None:
        response = await client.beta.assistants.with_raw_response.create(model='string')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        assistant = response.parse()
        assert_matches_type(Assistant, assistant, path=['response'])
    ...
    async def test_method_retrieve(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.retrieve('string')
        assert_matches_type(Assistant, assistant, path=['response'])

    @parametrize
    async def test_raw_response_retrieve(self, client: AsyncOpenAI) -> None:
        response = await client.beta.assistants.with_raw_response.retrieve('string')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        assistant = response.parse()
        assert_matches_type(Assistant, assistant, path=['response'])
    ...
    async def test_method_update(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.update('string')
        assert_matches_type(Assistant, assistant, path=['response'])

    @parametrize
    async def test_method_update_with_all_params(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.update('string', description='string', file_ids=['string', 'string', 'string'], instructions='string', metadata={}, model='string', name='string', tools=[{'type': 'code_interpreter'}, {'type': 'code_interpreter'}, {'type': 'code_interpreter'}])
        assert_matches_type(Assistant, assistant, path=['response'])

    @parametrize
    async def test_raw_response_update(self, client: AsyncOpenAI) -> None:
        response = await client.beta.assistants.with_raw_response.update('string')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        assistant = response.parse()
        assert_matches_type(Assistant, assistant, path=['response'])
    ...
    async def test_method_list_with_all_params(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.list(after='string', before='string', limit=0, order='asc')
        assert_matches_type(AsyncCursorPage[Assistant], assistant, path=['response'])
    ...
    async def test_method_delete(self, client: AsyncOpenAI) -> None:
        assistant = await client.beta.assistants.delete('string')
        assert_matches_type(AssistantDeleted, assistant, path=['response'])

    @parametrize
    async def test_raw_response_delete(self, client: AsyncOpenAI) -> None:
        response = await client.beta.assistants.with_raw_response.delete('string')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        assistant = response.parse()
        assert_matches_type(AssistantDeleted, assistant, path=['response'])