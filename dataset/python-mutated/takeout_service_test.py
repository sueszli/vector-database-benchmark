...
class TakeoutServiceFullUserUnitTests(test_utils.GenericTestBase):
    ...
    USER_1_WEEKLY_CREATOR_STATS_LIST: Final = [{'2019-05-21': {'average_ratings': 4.0, 'total_plays': 5}}, {'2019-05-28': {'average_ratings': 4.95, 'total_plays': 10}}]
    EXPLORATION_IDS: Final = ['exp_1']
    EXPLORATION_IDS_2: Final = ['exp_2']
    STORY_IDS: Final = ['12', '22', '32']
    STORY_IDS_2: Final = ['42', '52', '62']
    ...
    CONTRIBUTION_DATES: Final = [datetime.date.fromtimestamp(1616173836), datetime.date.fromtimestamp(1616173837)]
    FIRST_CONTRIBUTION_DATE: Final = datetime.datetime(2021, 5, 20)
    LAST_CONTRIBUTION_DATE: Final = datetime.datetime(2022, 5, 20)
    PROFILE_PICTURE_DATA_PNG: Final = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAGCAIAAACAbBMhAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAAEnQAABJ0Ad5mH3gAAAAySURBVBhXY/iPDYBEV6xY0draCuFDAEgUKMTAANUEUYFuAkQFihIIGwigosiG/P//HwD5HmjphyAmJQAAAABJRU5ErkJggg%3D%3D'
    PROFILE_PICTURE_DATA_WEBP: Final = 'data:image/webp;base64,UklGRlIAAABXRUJQVlA4IEYAAADQAQCdASoHAAYAAgA0JaQAAv%2B5x9YuAAD%2B%2B0nD9oP5zmavp/Nyl8%2Bf/REL9weER482Ugrc/6dmq28Kx1pj/se/CsMAAAAA'
