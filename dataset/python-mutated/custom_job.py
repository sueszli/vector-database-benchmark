...
from airflow.providers.google.cloud.links.vertex_ai import VertexAIModelLink, VertexAITrainingLink, VertexAITrainingPipelinesLink
...
class CreateCustomContainerTrainingJobOperator(CustomTrainingJobBaseOperator):
    ...
    """
    template_fields = ('region', 'command', 'parent_model', 'dataset_id', 'impersonation_chain')
...
class CreateCustomPythonPackageTrainingJobOperator(CustomTrainingJobBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields = ('parent_model', 'region', 'dataset_id', 'impersonation_chain')
    operator_extra_links = (VertexAIModelLink(), VertexAITrainingLink())
...
class CreateCustomTrainingJobOperator(CustomTrainingJobBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields = ('region', 'script_path', 'parent_model', 'requirements', 'dataset_id', 'impersonation_chain')
    operator_extra_links = (VertexAIModelLink(), VertexAITrainingLink())
...
class ListCustomTrainingJobOperator(GoogleCloudBaseOperator):
    ...
    operator_extra_links = [VertexAITrainingPipelinesLink()]
