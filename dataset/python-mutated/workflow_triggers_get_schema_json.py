...
def main():
    ...
    response = client.workflow_triggers.get_schema_json(resource_group_name='testResourceGroup', name='test-name', workflow_name='testWorkflow', trigger_name='testTrigger')
    print(response)
