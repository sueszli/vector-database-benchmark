...
flags.DEFINE_integer('num_episodes_per_iteration', 1000, 'Number of training eepisodes for each iteration.')
...
flags.DEFINE_integer('update_target_network_every', 400, 'Number of steps between DQN target network updates.')
