...
class ProductVariantBulkDelete(ModelBulkDeleteMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=False, description='List of product variant IDs to delete.')
        skus = NonNullList(graphene.String, required=False, description='List of product variant SKUs to delete.' + ADDED_IN_38)
