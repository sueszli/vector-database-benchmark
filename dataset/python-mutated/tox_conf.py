...
class ToxConfig(SphinxDirective):
    name = 'conf'
    has_content = True
    option_spec: Final[ClassVar[dict[str, Any]]] = {'keys': unchanged_required, 'version_added': unchanged, 'version_changed': unchanged, 'default': unchanged, 'constant': flag, 'ref_suffix': unchanged}
