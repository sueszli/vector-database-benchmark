...
from google.cloud.iap_v1.services.identity_aware_proxy_o_auth_service import IdentityAwareProxyOAuthServiceAsyncClient, IdentityAwareProxyOAuthServiceClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(IdentityAwareProxyOAuthServiceClient, 'grpc'), (IdentityAwareProxyOAuthServiceAsyncClient, 'grpc_asyncio'), (IdentityAwareProxyOAuthServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.IdentityAwareProxyOAuthServiceGrpcTransport, 'grpc'), (transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.IdentityAwareProxyOAuthServiceRestTransport, 'rest')])
...
def test_identity_aware_proxy_o_auth_service_client_get_transport_class():
    ...
    available_transports = [transports.IdentityAwareProxyOAuthServiceGrpcTransport, transports.IdentityAwareProxyOAuthServiceRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceGrpcTransport, 'grpc', grpc_helpers), (IdentityAwareProxyOAuthServiceAsyncClient, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async), (IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceRestTransport, 'rest', None)])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceGrpcTransport, 'grpc', grpc_helpers), (IdentityAwareProxyOAuthServiceAsyncClient, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
async def test_list_brands_async(transport: str='grpc_asyncio', request_type=service.ListBrandsRequest):
    client = IdentityAwareProxyOAuthServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.list_brands), '__call__') as call:
...
def test_list_brands_field_headers():
    if False:
        print('Hello World!')
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials())
...
async def test_list_brands_field_headers_async():
    client = IdentityAwareProxyOAuthServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = service.ListBrandsRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.list_brands), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListBrandsResponse())
...
def test_create_brand(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_brand), '__call__') as call:
        call.return_value = service.Brand(name='name_value', support_email='support_email_value', application_title='application_title_value', org_internal_only=True)
...
async def test_create_brand_async(transport: str='grpc_asyncio', request_type=service.CreateBrandRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.create_brand), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.Brand(name='name_value', support_email='support_email_value', application_title='application_title_value', org_internal_only=True))
...
@pytest.mark.parametrize('request_type', [service.CreateIdentityAwareProxyClientRequest, dict])
def test_create_identity_aware_proxy_client(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.create_identity_aware_proxy_client), '__call__') as call:
        call.return_value = service.IdentityAwareProxyClient(name='name_value', secret='secret_value', display_name='display_name_value')
...
async def test_create_identity_aware_proxy_client_async(transport: str='grpc_asyncio', request_type=service.CreateIdentityAwareProxyClientRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.create_identity_aware_proxy_client), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.IdentityAwareProxyClient(name='name_value', secret='secret_value', display_name='display_name_value'))
...
@pytest.mark.parametrize('request_type', [service.ListIdentityAwareProxyClientsRequest, dict])
def test_list_identity_aware_proxy_clients(request_type, transport: str='grpc'):
    ...
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), '__call__') as call:
        call.return_value = service.ListIdentityAwareProxyClientsResponse(next_page_token='next_page_token_value')
...
async def test_list_identity_aware_proxy_clients_async(transport: str='grpc_asyncio', request_type=service.ListIdentityAwareProxyClientsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(service.ListIdentityAwareProxyClientsResponse(next_page_token='next_page_token_value'))
...
def test_list_identity_aware_proxy_clients_pager(transport_name: str='grpc'):
    if False:
        print('Hello World!')
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials, transport=transport_name)
    with mock.patch.object(type(client.transport.list_identity_aware_proxy_clients), '__call__') as call:
        call.side_effect = (service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient()], next_page_token='abc'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[], next_page_token='def'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient()], next_page_token='ghi'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient()]), RuntimeError)
        metadata = ()
...
@pytest.mark.parametrize('request_type', [service.GetIdentityAwareProxyClientRequest, dict])
...
@pytest.mark.parametrize('request_type', [service.ResetIdentityAwareProxyClientSecretRequest, dict])
...
@pytest.mark.parametrize('request_type', [service.DeleteIdentityAwareProxyClientRequest, dict])
...
def test_list_brands_rest_interceptors(null_interceptor):
    if False:
        for i in range(10):
            print('nop')
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_list_brands') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_list_brands') as pre:
...
def test_create_brand_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.Brand(name='name_value', support_email='support_email_value', application_title='application_title_value', org_internal_only=True)
        response_value = Response()
        response_value.status_code = 200
...
def test_create_brand_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_create_brand') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_create_brand') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_brand_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_get_brand') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_get_brand') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_identity_aware_proxy_client_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.IdentityAwareProxyClient(name='name_value', secret='secret_value', display_name='display_name_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_create_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_create_identity_aware_proxy_client') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_create_identity_aware_proxy_client') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_identity_aware_proxy_clients_rest(request_type):
    ...
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = service.ListIdentityAwareProxyClientsResponse(next_page_token='next_page_token_value')
        response_value = Response()
        response_value.status_code = 200
...
def test_list_identity_aware_proxy_clients_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_list_identity_aware_proxy_clients') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_list_identity_aware_proxy_clients') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_identity_aware_proxy_clients_rest_pager(transport: str='rest'):
    ...
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with mock.patch.object(Session, 'request') as req:
        response = (service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient()], next_page_token='abc'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[], next_page_token='def'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient()], next_page_token='ghi'), service.ListIdentityAwareProxyClientsResponse(identity_aware_proxy_clients=[service.IdentityAwareProxyClient(), service.IdentityAwareProxyClient()]))
...
def test_get_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_get_identity_aware_proxy_client') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_get_identity_aware_proxy_client') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_reset_identity_aware_proxy_client_secret_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'post_reset_identity_aware_proxy_client_secret') as post, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_reset_identity_aware_proxy_client_secret') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_identity_aware_proxy_client_rest_interceptors(null_interceptor):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.IdentityAwareProxyOAuthServiceRestInterceptor())
    client = IdentityAwareProxyOAuthServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.IdentityAwareProxyOAuthServiceRestInterceptor, 'pre_delete_identity_aware_proxy_client') as pre:
        pre.assert_not_called()
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.IdentityAwareProxyOAuthServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.IdentityAwareProxyOAuthServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = IdentityAwareProxyOAuthServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.IdentityAwareProxyOAuthServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    options = client_options.ClientOptions()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = IdentityAwareProxyOAuthServiceClient(client_options=options, transport=transport)
    options = mock.Mock()
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
    ...
    transport = transports.IdentityAwareProxyOAuthServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = IdentityAwareProxyOAuthServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.IdentityAwareProxyOAuthServiceGrpcTransport, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, transports.IdentityAwareProxyOAuthServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = IdentityAwareProxyOAuthServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_transport_grpc_default():
    if False:
        return 10
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials())
    assert isinstance(client.transport, transports.IdentityAwareProxyOAuthServiceGrpcTransport)

def test_identity_aware_proxy_o_auth_service_base_transport_error():
    if False:
        print('Hello World!')
    with pytest.raises(core_exceptions.DuplicateCredentialArgs):
        transport = transports.IdentityAwareProxyOAuthServiceTransport(credentials=ga_credentials.AnonymousCredentials(), credentials_file='credentials.json')
...
def test_identity_aware_proxy_o_auth_service_base_transport():
    ...
    with mock.patch('google.cloud.iap_v1.services.identity_aware_proxy_o_auth_service.transports.IdentityAwareProxyOAuthServiceTransport.__init__') as Transport:
        ...
        transport = transports.IdentityAwareProxyOAuthServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('list_brands', 'create_brand', 'get_brand', 'create_identity_aware_proxy_client', 'list_identity_aware_proxy_clients', 'get_identity_aware_proxy_client', 'reset_identity_aware_proxy_client_secret', 'delete_identity_aware_proxy_client')
...
def test_identity_aware_proxy_o_auth_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.iap_v1.services.identity_aware_proxy_o_auth_service.transports.IdentityAwareProxyOAuthServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.IdentityAwareProxyOAuthServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.IdentityAwareProxyOAuthServiceGrpcTransport, grpc_helpers), (transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_identity_aware_proxy_o_auth_service_host_no_port(transport_name):
    if False:
        while True:
            i = 10
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='iap.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('iap.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://iap.googleapis.com')
...
def test_identity_aware_proxy_o_auth_service_host_with_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='iap.googleapis.com:8000'), transport=transport_name)
...
def test_identity_aware_proxy_o_auth_service_client_transport_session_collision(transport_name):
    ...
    client1 = IdentityAwareProxyOAuthServiceClient(credentials=creds1, transport=transport_name)
    client2 = IdentityAwareProxyOAuthServiceClient(credentials=creds2, transport=transport_name)
...
def test_identity_aware_proxy_o_auth_service_grpc_transport_channel():
    ...
    transport = transports.IdentityAwareProxyOAuthServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_identity_aware_proxy_o_auth_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.IdentityAwareProxyOAuthServiceTransport, '_prep_wrapped_messages') as prep:
        client = IdentityAwareProxyOAuthServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = IdentityAwareProxyOAuthServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(IdentityAwareProxyOAuthServiceClient, transports.IdentityAwareProxyOAuthServiceGrpcTransport), (IdentityAwareProxyOAuthServiceAsyncClient, transports.IdentityAwareProxyOAuthServiceGrpcAsyncIOTransport)])
