...
from urh.simulator.ActionItem import ActionItem, GotoActionItem, TriggerCommandActionItem, SleepActionItem, CounterActionItem
...
class SimulatorScene(QGraphicsScene):
    ...
    model_to_scene_class_mapping = {SimulatorRule: RuleItem, SimulatorRuleCondition: RuleConditionItem, SimulatorGotoAction: GotoActionItem, SimulatorTriggerCommandAction: TriggerCommandActionItem, SimulatorCounterAction: CounterActionItem, SimulatorSleepAction: SleepActionItem, SimulatorMessage: MessageItem, SimulatorProtocolLabel: LabelItem}
