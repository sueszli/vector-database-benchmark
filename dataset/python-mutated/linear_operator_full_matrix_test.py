...
class SquareLinearOperatorFullMatrixTest(linear_operator_test_util.SquareLinearOperatorDerivedClassTest):
...
@test_util.run_all_in_graph_and_eager_modes
class SquareLinearOperatorFullMatrixSymmetricPositiveDefiniteTest(linear_operator_test_util.SquareLinearOperatorDerivedClassTest):
    """Most tests done in the base class LinearOperatorDerivedClassTest.
...
@test_util.run_all_in_graph_and_eager_modes
class NonSquareLinearOperatorFullMatrixTest(linear_operator_test_util.NonSquareLinearOperatorDerivedClassTest):
    """Most tests done in the base class LinearOperatorDerivedClassTest."""
...
if __name__ == '__main__':
    ...
    linear_operator_test_util.add_tests(SquareLinearOperatorFullMatrixSymmetricPositiveDefiniteTest)
    test.main()