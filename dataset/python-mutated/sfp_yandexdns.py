...
class sfp_yandexdns(SpiderFootPlugin):
    meta = {'name': 'Yandex DNS', 'summary': 'Check if a host would be blocked by Yandex DNS.', 'flags': [], 'useCases': ['Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'https://yandex.com/', 'model': 'FREE_NOAUTH_UNLIMITED', 'references': ['https://tech.yandex.com/', 'https://dns.yandex.com/advanced/'], 'favIcon': 'https://yastatic.net/iconostasis/_/tToKamh-mh5XlViKpgiJRQgjz1Q.png', 'logo': 'https://yastatic.net/iconostasis/_/tToKamh-mh5XlViKpgiJRQgjz1Q.png', 'description': 'Yandex.DNS is a free, recursive DNS service. Yandex.DNS\' servers are located in Russia, CIS countries, and Western Europe.In "Basic" mode, there is no traffic filtering. In "Safe" mode, protection from infected and fraudulent sites is provided. "Family" mode enables protection from dangerous sites and blocks sites with adult content.'}}
    opts = {}
    optdescs = {}
    results = None
    checks = {'213.180.193.250': 'Yandex - Infected', '93.158.134.250': 'Yandex - Adult'}
