...
from xarray.coding.times import _encode_datetime_with_cftime, _numpy_to_netcdf_timeunit, _should_cftime_be_used, cftime_to_nptime, decode_cf_datetime, encode_cf_datetime, to_timedelta_unboxed
from xarray.coding.variables import SerializationWarning
from xarray.conventions import _update_bounds_attributes, cf_encoder
from xarray.core.common import contains_cftime_datetimes
from xarray.testing import assert_equal, assert_identical
from xarray.tests import FirstElementAccessibleArray, arm_xfail, assert_array_equal, assert_no_warnings, has_cftime, requires_cftime, requires_dask
_NON_STANDARD_CALENDARS_SET = {'noleap', '365_day', '360_day', 'julian', 'all_leap', '366_day'}
_ALL_CALENDARS = sorted(_NON_STANDARD_CALENDARS_SET.union(coding.times._STANDARD_CALENDARS))
_NON_STANDARD_CALENDARS = sorted(_NON_STANDARD_CALENDARS_SET)
_STANDARD_CALENDARS = sorted(coding.times._STANDARD_CALENDARS)
_CF_DATETIME_NUM_DATES_UNITS = [(np.arange(10), 'days since 2000-01-01'), (np.arange(10).astype('float64'), 'days since 2000-01-01'), (np.arange(10).astype('float32'), 'days since 2000-01-01'), (np.arange(10).reshape(2, 5), 'days since 2000-01-01'), (12300 + np.arange(5), 'hours since 1680-01-01 00:00:00'), (12300 + np.arange(5), 'hour since 1680-01-01  00:00:00'), (12300 + np.arange(5), 'Hour  since 1680-01-01 00:00:00'), (12300 + np.arange(5), ' Hour  since  1680-01-01 00:00:00 '), (10, 'days since 2000-01-01'), ([10], 'daYs  since 2000-01-01'), ([[10]], 'days since 2000-01-01'), ([10, 10], 'days since 2000-01-01'), (np.array(10), 'days since 2000-01-01'), (0, 'days since 1000-01-01'), ([0], 'days since 1000-01-01'), ([[0]], 'days since 1000-01-01'), (np.arange(2), 'days since 1000-01-01'), (np.arange(0, 100000, 20000), 'days since 1900-01-01'), (np.arange(0, 100000, 20000), 'days since 1-01-01'), (17093352.0, 'hours since 1-1-1 00:00:0.0'), ([0.5, 1.5], 'hours since 1900-01-01T00:00:00'), (0, 'milliseconds since 2000-01-01T00:00:00'), (0, 'microseconds since 2000-01-01T00:00:00'), (np.int32(788961600), 'seconds since 1981-01-01'), (12300 + np.arange(5), 'hour since 1680-01-01 00:00:00.500000'), (164375, 'days since 1850-01-01 00:00:00'), (164374.5, 'days since 1850-01-01 00:00:00'), ([164374.5, 168360.5], 'days since 1850-01-01 00:00:00')]
_CF_DATETIME_TESTS = [num_dates_units + (calendar,) for (num_dates_units, calendar) in product(_CF_DATETIME_NUM_DATES_UNITS, _STANDARD_CALENDARS)]
...
FREQUENCIES_TO_ENCODING_UNITS = {'N': 'nanoseconds', 'U': 'microseconds', 'L': 'milliseconds', 'S': 'seconds', 'T': 'minutes', 'H': 'hours', 'D': 'days'}
...
def test_infer_datetime_units_with_NaT(dates, expected) -> None:
    if False:
        print('Hello World!')
    assert expected == coding.times.infer_datetime_units(dates)
_CFTIME_DATETIME_UNITS_TESTS = [([(1900, 1, 1), (1900, 1, 1)], 'days since 1900-01-01 00:00:00.000000'), ([(1900, 1, 1), (1900, 1, 2), (1900, 1, 2, 0, 0, 1)], 'seconds since 1900-01-01 00:00:00.000000'), ([(1900, 1, 1), (1900, 1, 8), (1900, 1, 16)], 'days since 1900-01-01 00:00:00.000000')]
