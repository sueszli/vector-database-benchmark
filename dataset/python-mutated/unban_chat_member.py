...
class UnbanChatMember(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], user_id: int, only_if_banned: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                return 10
            super().__init__(chat_id=chat_id, user_id=user_id, only_if_banned=only_if_banned, **__pydantic_kwargs)