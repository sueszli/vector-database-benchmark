...
from modelscope.models.cv.indoor_layout_estimation.networks.misc.fourier import fourier, fourier_gray
...
@PIPELINES.register_module(Tasks.indoor_layout_estimation, module_name=Pipelines.indoor_layout_estimation)
class IndoorLayoutEstimationPipeline(Pipeline):
    ...
    def postprocess(self, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        outputs = {OutputKeys.LAYOUT: layout_image}
        return outputs