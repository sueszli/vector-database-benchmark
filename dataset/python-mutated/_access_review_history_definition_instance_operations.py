...
def build_generate_download_uri_request(history_definition_id: str, instance_id: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri')
    path_format_arguments = {'subscriptionId': _SERIALIZER.url('subscription_id', subscription_id, 'str'), 'historyDefinitionId': _SERIALIZER.url('history_definition_id', history_definition_id, 'str'), 'instanceId': _SERIALIZER.url('instance_id', instance_id, 'str')}
...
class AccessReviewHistoryDefinitionInstanceOperations:
    ...
    @distributed_trace
    def generate_download_uri(self, history_definition_id: str, instance_id: str, **kwargs: Any) -> _models.AccessReviewHistoryInstance:
        if False:
            while True:
                i = 10
        ...
        request = build_generate_download_uri_request(history_definition_id=history_definition_id, instance_id=instance_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.generate_download_uri.metadata['url'], headers=_headers, params=_params)
        ...
        return deserialized
    generate_download_uri.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri'}