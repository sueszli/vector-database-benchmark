...
UNISPEECH_SAT_PRETRAINED_CONFIG_ARCHIVE_MAP = {'microsoft/unispeech-sat-base-100h-libri-ft': 'https://huggingface.co/microsoft/unispeech-sat-base-100h-libri-ft/resolve/main/config.json'}
