...
class CharlieRoseIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://charlierose.com/videos/27996', 'md5': 'fda41d49e67d4ce7c2411fd2c4702e09', 'info_dict': {'id': '27996', 'ext': 'mp4', 'title': 'Remembering Zaha Hadid', 'thumbnail': 're:^https?://.*\\.jpg\\?\\d+', 'description': 'We revisit past conversations with Zaha Hadid, in memory of the world renowned Iraqi architect.', 'subtitles': {'en': [{'ext': 'vtt'}]}}}, {'url': 'https://charlierose.com/videos/27996', 'only_matching': True}, {'url': 'https://charlierose.com/episodes/30887?autoplay=true', 'only_matching': True}]
