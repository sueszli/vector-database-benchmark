...
class TestFakeChannelWiseDequantizeMaxAbsOpTwoScalesFloat16(TestFakeChannelWiseDequantizeMaxAbsOpTwoScales):
...
class TestFakeChannelWiseDequantizeMaxAbsOpOneScale1(TestFakeChannelWiseDequantizeMaxAbsOpOneScale):
...
class TestFakeChannelWiseDequantizeMaxAbsOpOneScaleFloat16(TestFakeChannelWiseDequantizeMaxAbsOpOneScale):
...
class TestFakeChannelWiseDequantizeMaxAbsOpOneScale1Float16(TestFakeChannelWiseDequantizeMaxAbsOpOneScale1):
