...
@pytest.mark.e2e
def test_order_products_on_percentage_sale_CORE_1003(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_orders):
    if False:
        for i in range(10):
            print('nop')
    ...
    (product_id, product_variant_id, product_variant_price) = prepare_product(e2e_staff_api_client, warehouse_id, channel_id, variant_price='11.99')
    (sale_id, sale_discount_value) = prepare_sale_for_product(e2e_staff_api_client, channel_id, product_id, sale_discount_type='PERCENTAGE', sale_discount_value=30)
