...
from .utils import load_breast_cancer, load_digits, load_iris, load_linnerud, make_ranking, make_synthetic_regression, sklearn_multiclass_custom_objective, softmax
decreasing_generator = itertools.count(0, -1)
task_to_model_factory = {'ranking': lgb.LGBMRanker, 'binary-classification': lgb.LGBMClassifier, 'multiclass-classification': lgb.LGBMClassifier, 'regression': lgb.LGBMRegressor}
