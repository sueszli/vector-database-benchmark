...
from PyQt5.QtGui import QMouseEvent, QCursor, QPainter, QPalette, QBrush
...
from feeluown.gui.components import LineSongLabel, MediaButtons, LyricButton, WatchButton, LikeButton, MVButton, VolumeSlider, SongSourceTag
