...
class RayWenderlichCourseIE(InfoExtractor):
    _VALID_URL = '(?x)\n                    https?://\n                        (?:\n                            videos\\.raywenderlich\\.com/courses|\n                            (?:www\\.)?raywenderlich\\.com\n                        )/\n                        (?P<id>[^/]+)\n                    '
    _TEST = {'url': 'https://www.raywenderlich.com/3530-testing-in-ios', 'info_dict': {'title': 'Testing in iOS', 'id': '3530-testing-in-ios'}, 'params': {'noplaylist': False}, 'playlist_count': 29}
