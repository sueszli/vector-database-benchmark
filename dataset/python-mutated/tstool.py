...
if __name__ == '__main__':
    ...
    taskkill_parser.add_argument('-name', action='store', help='Specifies process name (ImageName). Internally it willexecute tasklist to retrieve PID by ImageName.')
    ...
    shutdown_parser = subparsers.add_parser('shutdown', help='Remote shutdown, affects ALL sessions and logged-in users!', description='Send Remote Shutdown event. Affects ALL sessions and logged-in users!')
