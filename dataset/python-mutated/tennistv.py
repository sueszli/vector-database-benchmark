...
class TennisTVIE(InfoExtractor):
    ...
    _HEADERS = {'origin': 'https://www.tennistv.com', 'referer': 'https://www.tennistv.com/', 'content-Type': 'application/x-www-form-urlencoded'}
