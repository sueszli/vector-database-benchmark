...
from modelscope.msdatasets.dataset_cls.custom_datasets.builder import CUSTOM_DATASETS
from modelscope.utils.constant import Tasks
from . import sampler
DATASET_STRUCTURE = {'train': {'annotation': 'anno/train.json', 'images': 'keyf_240p', 'feat': 'feat'}, 'test': {'annotation': 'anno/test.json', 'images': 'keyf_240p', 'feat': 'feat'}}
