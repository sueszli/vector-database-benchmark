...
from Orange.widgets.unsupervised.owdistances import OWDistances, DistanceRunner, MetricDefs, Cosine, Mahalanobis, Jaccard, MetricDef, ManhattanNormalized, EuclideanNormalized, Manhattan, Spearman, Pearson, Hamming, SpearmanAbsolute, PearsonAbsolute, Euclidean
