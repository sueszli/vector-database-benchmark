...
from ..utils import int_or_none, js_to_json, mimetype2ext, ExtractorError

class ImgurIE(InfoExtractor):
    _VALID_URL = 'https?://(?:i\\.)?imgur\\.com/(?!(?:a|gallery|(?:t(?:opic)?|r)/[^/]+)/)(?P<id>[a-zA-Z0-9]+)'
    _TESTS = [{'url': 'https://i.imgur.com/A61SaA1.gifv', 'info_dict': {'id': 'A61SaA1', 'ext': 'mp4', 'title': 're:Imgur GIF$|MRW gifv is up and running without any bugs$'}}, {'url': 'https://imgur.com/A61SaA1', 'only_matching': True}, {'url': 'https://i.imgur.com/crGpqCV.mp4', 'only_matching': True}, {'url': 'https://i.imgur.com/jxBXAMC.gifv', 'only_matching': True}]
...
class ImgurGalleryIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://imgur.com/gallery/Q95ko', 'info_dict': {'id': 'Q95ko', 'title': 'Adding faces make every GIF better'}, 'playlist_count': 25}, {'url': 'http://imgur.com/topic/Aww/ll5Vk', 'only_matching': True}, {'url': 'https://imgur.com/gallery/YcAQlkx', 'info_dict': {'id': 'YcAQlkx', 'ext': 'mp4', 'title': 'Classic Steve Carell gif...cracks me up everytime....damn the repost downvotes....'}}, {'url': 'http://imgur.com/topic/Funny/N8rOudd', 'only_matching': True}, {'url': 'http://imgur.com/r/aww/VQcQPhM', 'only_matching': True}]
...
class ImgurAlbumIE(ImgurGalleryIE):
    ...
    _TESTS = [{'url': 'http://imgur.com/a/j6Orj', 'info_dict': {'id': 'j6Orj', 'title': 'A Literary Analysis of "Star Wars: The Force Awakens"'}, 'playlist_count': 12}]