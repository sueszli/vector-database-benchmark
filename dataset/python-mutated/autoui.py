...
def _FindExistingControl(m, paramspec):
    ...
    for suffix in suffixes:
        ...
        if ctrl:
            return ctrl
_simpleParSpecFields = ['key', 'label', 'style', 'length', 'group']
_allParSpecFields = _simpleParSpecFields + ['default1', 'default2', 'default3', 'default4', 'minnorm1', 'minnorm2', 'minnorm3', 'minnorm4', 'maxnorm1', 'maxnorm2', 'maxnorm3', 'maxnorm4', 'minlimit1', 'minlimit2', 'minlimit3', 'minlimit4', 'maxlimit1', 'maxlimit2', 'maxlimit3', 'maxlimit4', 'options', 'tags']
