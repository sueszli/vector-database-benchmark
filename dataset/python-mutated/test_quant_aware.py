...
train_parameters = {'input_size': [3, 224, 224], 'input_mean': [0.485, 0.456, 0.406], 'input_std': [0.229, 0.224, 0.225], 'learning_strategy': {'name': 'piecewise_decay', 'batch_size': 256, 'epochs': [10, 16, 30], 'steps': [0.1, 0.01, 0.001, 0.0001]}}
