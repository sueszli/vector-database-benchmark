...
class LocalformerModel(Model):
    ...
    def __init__(self, d_feat: int=20, d_model: int=64, batch_size: int=2048, nhead: int=2, num_layers: int=2, dropout: float=0, n_epochs=100, lr=0.0001, metric='', early_stop=5, loss='mse', optimizer='adam', reg=0.001, n_jobs=10, GPU=0, seed=None, **kwargs):
        if False:
            for i in range(10):
                print('nop')
...
class Transformer(nn.Module):
    ...
    def __init__(self, d_feat=6, d_model=8, nhead=4, num_layers=2, dropout=0.5, device=None):
        ...
        self.rnn = nn.GRU(input_size=d_model, hidden_size=d_model, num_layers=num_layers, batch_first=False, dropout=dropout)
