...
_JUPYTER_LANGUAGES = ['R', 'bash', 'sh', 'python', 'python2', 'python3', 'coconut', 'javascript', 'js', 'perl', 'html', 'latex', 'markdown', 'pypy', 'ruby', 'script', 'svg', 'matlab', 'octave', 'idl', 'robotframework', 'sas', 'spark', 'sql', 'cython', 'haskell', 'tcl', 'gnuplot', 'wolfram language']
_SCRIPT_EXTENSIONS = {'.py': {'language': 'python', 'comment': '#'}, '.coco': {'language': 'coconut', 'comment': '#'}, '.R': {'language': 'R', 'comment': '#'}, '.r': {'language': 'R', 'comment': '#'}, '.jl': {'language': 'julia', 'comment': '#'}, '.cpp': {'language': 'c++', 'comment': '//'}, '.ss': {'language': 'scheme', 'comment': ';;'}, '.clj': {'language': 'clojure', 'comment': ';;'}, '.scm': {'language': 'scheme', 'comment': ';;'}, '.sh': {'language': 'bash', 'comment': '#'}, '.ps1': {'language': 'powershell', 'comment': '#'}, '.q': {'language': 'q', 'comment': '/'}, '.m': {'language': 'matlab', 'comment': '%'}, '.wolfram': {'language': 'wolfram language', 'comment': '(*', 'comment_suffix': '*)'}, '.pro': {'language': 'idl', 'comment': ';'}, '.js': {'language': 'javascript', 'comment': '//'}, '.ts': {'language': 'typescript', 'comment': '//'}, '.scala': {'language': 'scala', 'comment': '//'}, '.rs': {'language': 'rust', 'comment': '//'}, '.robot': {'language': 'robotframework', 'comment': '#'}, '.resource': {'language': 'robotframework', 'comment': '#'}, '.cs': {'language': 'csharp', 'comment': '//'}, '.fsx': {'language': 'fsharp', 'comment': '//'}, '.fs': {'language': 'fsharp', 'comment': '//'}, '.sos': {'language': 'sos', 'comment': '#'}, '.java': {'language': 'java', 'comment': '//'}, '.groovy': {'language': 'groovy', 'comment': '//'}, '.sage': {'language': 'sage', 'comment': '#'}, '.ml': {'language': 'ocaml', 'comment': '(*', 'comment_suffix': '*)'}, '.hs': {'language': 'haskell', 'comment': '--'}, '.tcl': {'language': 'tcl', 'comment': '#'}, '.mac': {'language': 'maxima', 'comment': '/*', 'comment_suffix': '*/'}, '.gp': {'language': 'gnuplot', 'comment': '#'}, '.do': {'language': 'stata', 'comment': '//'}, '.sas': {'language': 'sas', 'comment': '/*', 'comment_suffix': '*/'}}
_COMMENT_CHARS = [_SCRIPT_EXTENSIONS[ext]['comment'] for ext in _SCRIPT_EXTENSIONS if _SCRIPT_EXTENSIONS[ext]['comment'] != '#']
