...
from ...utils import load_nist_ccm_vectors, load_nist_vectors, load_vectors_from_file, raises_unsupported_algorithm
...
@pytest.mark.skipif(not _aead_supported(ChaCha20Poly1305), reason='Does not support ChaCha20Poly1305')
...
@pytest.mark.skipif(not _aead_supported(AESCCM), reason='Does not support AESCCM')
class TestAESCCM:
...
@pytest.mark.skipif(not _aead_supported(AESOCB3), reason='Does not support AESOCB3')
class TestAESOCB3:
...
@pytest.mark.skipif(not _aead_supported(AESSIV), reason='Does not support AESSIV')
class TestAESSIV:
