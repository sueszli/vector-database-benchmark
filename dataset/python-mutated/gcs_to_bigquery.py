...
from google.cloud.bigquery import DEFAULT_RETRY, CopyJob, ExternalConfig, ExtractJob, LoadJob, QueryJob, SchemaField, UnknownJob
...
class GCSToBigQueryOperator(BaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('bucket', 'source_objects', 'schema_object', 'schema_object_bucket', 'destination_project_dataset_table', 'impersonation_chain', 'src_fmt_configs')
