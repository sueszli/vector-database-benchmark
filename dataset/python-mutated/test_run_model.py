...
from robot.running import Break, Continue, Error, For, If, IfBranch, Keyword, Return, ResourceFile, TestCase, TestDefaults, TestSuite, Try, TryBranch, Var, While
...
class TestSuiteFromSources(unittest.TestCase):
    path = Path(os.getenv('TEMPDIR') or tempfile.gettempdir(), 'test_run_model.robot')
