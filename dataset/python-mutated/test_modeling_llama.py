...
from transformers.testing_utils import require_flash_attn, require_torch, require_torch_accelerator, require_torch_gpu, slow, torch_device
...
if is_torch_available():
    import torch
    from transformers import CodeLlamaTokenizer, LlamaForCausalLM, LlamaForSequenceClassification, LlamaModel, LlamaTokenizer
...
class LlamaModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline_model_mapping = {'feature-extraction': LlamaModel, 'text-classification': LlamaForSequenceClassification, 'text-generation': LlamaForCausalLM, 'zero-shot': LlamaForSequenceClassification} if is_torch_available() else {}
