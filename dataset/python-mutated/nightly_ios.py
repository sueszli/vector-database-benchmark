...
BUILD_CONFIGS = [IOSNightlyJob('x86_64'), IOSNightlyJob('arm64')]
BUILD_CONFIGS_FULL_JIT = [IOSNightlyJob('x86_64', is_full_jit=True), IOSNightlyJob('arm64', is_full_jit=True)]
WORKFLOW_DATA = BUILD_CONFIGS + BUILD_CONFIGS_FULL_JIT + [IOSNightlyJob('binary', is_full_jit=False, is_upload=True), IOSNightlyJob('binary', is_full_jit=True, is_upload=True)]
