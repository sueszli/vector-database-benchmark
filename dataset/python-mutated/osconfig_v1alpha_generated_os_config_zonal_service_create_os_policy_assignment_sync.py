...
def sample_create_os_policy_assignment():
    ...
    request = osconfig_v1alpha.CreateOSPolicyAssignmentRequest(parent='parent_value', os_policy_assignment=os_policy_assignment, os_policy_assignment_id='os_policy_assignment_id_value')
