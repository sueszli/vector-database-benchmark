...
from modelscope.utils.nlp.space.utils_dst import tracking_and_print_dialog_states
...
class DialogStateTrackingTest(unittest.TestCase):
    ...
    def test_run_by_direct_model_download(self):
        ...
        pipelines = [DialogStateTrackingPipeline(model=model, preprocessor=preprocessor), pipeline(task=Tasks.task_oriented_conversation, model=model, preprocessor=preprocessor)]
    ...
    def test_run_with_model_from_modelhub(self):
        ...
        pipelines = [DialogStateTrackingPipeline(model=model, preprocessor=preprocessor), pipeline(task=self.task, model=model, preprocessor=preprocessor)]
        tracking_and_print_dialog_states(self.test_case, pipelines)
