...
from ...operations._alert_processing_rules_operations import build_create_or_update_request, build_delete_request, build_get_by_name_request, build_list_by_resource_group_request, build_list_by_subscription_request, build_update_request
...
class AlertProcessingRulesOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.AlertProcessingRule']:
        if False:
            return 10
    ...
    async def get_by_name(self, resource_group_name: str, alert_processing_rule_name: str, **kwargs: Any) -> _models.AlertProcessingRule:
        ...
        request = build_get_by_name_request(resource_group_name=resource_group_name, alert_processing_rule_name=alert_processing_rule_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_by_name.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
        ...
        return deserialized
    get_by_name.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{alertProcessingRuleName}'}

    @overload
    async def create_or_update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule: _models.AlertProcessingRule, *, content_type: str='application/json', **kwargs: Any) -> _models.AlertProcessingRule:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AlertProcessingRule:
        """Create or update an alert processing rule.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule: Union[_models.AlertProcessingRule, IO], **kwargs: Any) -> _models.AlertProcessingRule:
        """Create or update an alert processing rule.
        ...
        if cls:
            return cls(pipeline_response, deserialized, response_headers)
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{alertProcessingRuleName}'}

    @distributed_trace_async
    async def delete(self, resource_group_name: str, alert_processing_rule_name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, alert_processing_rule_name=alert_processing_rule_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{alertProcessingRuleName}'}

    @overload
    async def update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule_patch: _models.PatchObject, *, content_type: str='application/json', **kwargs: Any) -> _models.AlertProcessingRule:
    ...
    @overload
    async def update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule_patch: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AlertProcessingRule:
        """Enable, disable, or update tags for an alert processing rule.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, alert_processing_rule_name: str, alert_processing_rule_patch: Union[_models.PatchObject, IO], **kwargs: Any) -> _models.AlertProcessingRule:
        """Enable, disable, or update tags for an alert processing rule.
        ...
        if cls:
            return cls(pipeline_response, deserialized, response_headers)
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AlertsManagement/actionRules/{alertProcessingRuleName}'}