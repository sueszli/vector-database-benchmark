...
class GoogleDisplayVideo360GetSDFDownloadOperationSensor(BaseSensorOperator):
    ...
    """
    template_fields: Sequence[str] = ('operation_name', 'impersonation_chain')

    def __init__(self, operation_name: str, api_version: str='v1', gcp_conn_id: str='google_cloud_default', delegate_to: str | None=None, mode: str='reschedule', poke_interval: int=60 * 5, impersonation_chain: str | Sequence[str] | None=None, *args, **kwargs) -> None:
        if False:
            print('Hello World!')
    ...
    def poke(self, context: Context) -> bool:
        if False:
            return 10
        hook = GoogleDisplayVideo360Hook(gcp_conn_id=self.gcp_conn_id, delegate_to=self.delegate_to, api_version=self.api_version, impersonation_chain=self.impersonation_chain)
...
class GoogleDisplayVideo360RunQuerySensor(BaseSensorOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('query_id', 'report_id', 'impersonation_chain')

    def __init__(self, *, query_id: str, report_id: str, api_version: str='v2', gcp_conn_id: str='google_cloud_default', delegate_to: str | None=None, impersonation_chain: str | Sequence[str] | None=None, **kwargs) -> None:
        if False:
            print('Hello World!')
