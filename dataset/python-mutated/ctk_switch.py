...
class CTkSwitch(CTkBaseClass):
    ...
    def _set_scaling(self, *args, **kwargs):
        ...
        self._canvas.configure(width=self._apply_widget_scaling(self._switch_width), height=self._apply_widget_scaling(self._switch_height))
