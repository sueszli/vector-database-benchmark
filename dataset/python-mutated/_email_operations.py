...
def build_create_sign_in_url_request(resource_group_name: str, resource_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        return 10
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/createEmailSignInUrl')
...
class EmailOperations:
    ...
    @distributed_trace
    def create_sign_in_url(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.CreateEmailSignInUrlResponse:
        if False:
            for i in range(10):
                print('nop')
        ...
        request = build_create_sign_in_url_request(resource_group_name=resource_group_name, resource_name=resource_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.create_sign_in_url.metadata['url'], headers=_headers, params=_params)
