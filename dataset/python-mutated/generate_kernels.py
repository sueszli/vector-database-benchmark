...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='generate_kernels', description='Generate the mem-eff kernels template instantiations')
    parser.add_argument('-o', '--output_dir', required=False, help='Where to generate the kernels  will default to <ATen/native/transformers/cuda/mem_eff_attention/kernels/> ')
