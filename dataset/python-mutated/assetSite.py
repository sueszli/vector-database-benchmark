...
logger = get_logger()
base_search_fields = {'site': fields.String(required=False, description='站点URL'), 'hostname': fields.String(description='主机名'), 'ip': fields.String(description='ip'), 'title': fields.String(description='标题'), 'http_server': fields.String(description='Web servers'), 'headers': fields.String(description='headers'), 'finger.name': fields.String(description='指纹'), 'status': fields.Integer(description='状态码'), 'favicon.hash': fields.Integer(description='favicon hash'), 'task_id': fields.String(description='任务 ID'), 'scope_id': fields.String(description='范围 ID'), 'update_date__dgt': fields.String(description='更新时间大于'), 'update_date__dlt': fields.String(description='更新时间小于'), 'tag': fields.String(description='标签列表')}
site_search_fields = base_search_fields.copy()
base_search_fields.update(base_query_fields)
add_site_fields = ns.model('addAssetSite', {'site': fields.String(required=True, description='站点'), 'scope_id': fields.String(required=True, description='资产组范围ID'), 'policy_id': fields.String(description='策略 ID')})
...
delete_asset_site_fields = ns.model('deleteAssetSite', {'_id': fields.List(fields.String(required=True, description='站点 _id'))})
...
add_asset_site_tag_fields = ns.model('AddAssetSiteTagFields', {'tag': fields.String(required=True, description='添加站点标签'), '_id': fields.String(description='资产站点ID', required=True)})
...
delete_asset_site_tag_fields = ns.model('delete_asset_site_tag_fields', {'tag': fields.String(required=True, description='删除资产站点标签'), '_id': fields.String(description='资产站点ID', required=True)})
