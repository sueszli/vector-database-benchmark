...
@OpTestTool.skip_if(core.is_compiled_with_cuda(), 'CUDA required dygraph so oneDNN UT must be skipped')
...
class TestExpandV2ExpandShapesTensor2OneDNNOp(TestExpandV2ExpandShapesTensor1OneDNNOp):
