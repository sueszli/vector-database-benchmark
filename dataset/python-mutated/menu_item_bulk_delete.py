...
class MenuItemBulkDelete(ModelBulkDeleteMutation):
    ...
    class Arguments:
        ids = NonNullList(graphene.ID, required=True, description='List of menu item IDs to delete.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.MENU_ITEM_DELETED, description='A menu item was deleted.')]
