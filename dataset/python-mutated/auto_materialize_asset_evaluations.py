...
from dagster._core.definitions.auto_materialize_rule_evaluation import AutoMaterializeDecisionType, AutoMaterializeRuleEvaluation, AutoMaterializeRuleEvaluationData, ParentUpdatedRuleEvaluationData, TextRuleEvaluationData, WaitingOnAssetsRuleEvaluationData
...
class GrapheneAutoMaterializeRuleEvaluationData(graphene.Union):
    ...
    class Meta:
        types = (GrapheneTextRuleEvaluationData, GrapheneParentMaterializedRuleEvaluationData, GrapheneWaitingOnKeysRuleEvaluationData)
...
class GrapheneAutoMaterializeAssetEvaluationRecordsOrError(graphene.Union):
    ...
    class Meta:
        types = (GrapheneAutoMaterializeAssetEvaluationRecords, GrapheneAutoMaterializeAssetEvaluationNeedsMigrationError)
