...
__protobuf__ = proto.module(package='google.ai.generativelanguage.v1beta3', manifest={'CreatePermissionRequest', 'GetPermissionRequest', 'ListPermissionsRequest', 'ListPermissionsResponse', 'UpdatePermissionRequest', 'DeletePermissionRequest', 'TransferOwnershipRequest', 'TransferOwnershipResponse'})
...
class CreatePermissionRequest(proto.Message):
    ...
    permission: gag_permission.Permission = proto.Field(proto.MESSAGE, number=2, message=gag_permission.Permission)
...
class ListPermissionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    permissions: MutableSequence[gag_permission.Permission] = proto.RepeatedField(proto.MESSAGE, number=1, message=gag_permission.Permission)
...
class UpdatePermissionRequest(proto.Message):
    ...
    """
    permission: gag_permission.Permission = proto.Field(proto.MESSAGE, number=1, message=gag_permission.Permission)
...
class TransferOwnershipRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    email_address: str = proto.Field(proto.STRING, number=2)
