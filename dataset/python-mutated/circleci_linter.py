...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='circleci consistency linter', fromfile_prefix_chars='@')
    parser.add_argument('--config-yml', required=True, help='location of config.yml')
    parser.add_argument('--regen-script-working-dir', required=True, help='this script will chdir to this argument before running --regen-script')
    parser.add_argument('--regen-script', required=True, help='location of the config generation script, relative to --regen-script-working-dir')
    ...
    for lint_message in run_check(args.regen_script_working_dir, args.regen_script, args.config_yml):
