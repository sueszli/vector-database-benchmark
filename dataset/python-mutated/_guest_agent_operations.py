...
def build_create_request(resource_uri: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default')
...
class GuestAgentOperations:
    ...
    def _create_initial(self, resource_uri: str, body: Optional[Union[_models.GuestAgent, IO]]=None, **kwargs: Any) -> _models.GuestAgent:
        ...
        return deserialized
    _create_initial.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default'}
    ...
    begin_create.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default'}
    ...
    def get(self, resource_uri: str, **kwargs: Any) -> _models.GuestAgent:
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    get.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default'}
    ...
    _delete_initial.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default'}
    ...
    def begin_delete(self, resource_uri: str, **kwargs: Any) -> LROPoller[None]:
        ...
        if cont_token:
            return LROPoller.from_continuation_token(polling_method=polling_method, continuation_token=cont_token, client=self._client, deserialization_callback=get_long_running_output)
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    begin_delete.metadata = {'url': '/{resourceUri}/providers/Microsoft.AzureStackHCI/virtualMachineInstances/default/guestAgents/default'}