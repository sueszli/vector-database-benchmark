...
def execute_global_registration(source, target, source_fpfh, target_fpfh, voxel_size):
    ...
    result = o3d.pipelines.registration.registration_ransac_based_on_feature_matching(source, target, source_fpfh, target_fpfh, True, distance_threshold, o3d.pipelines.registration.TransformationEstimationPointToPoint(False), 3, [o3d.pipelines.registration.CorrespondenceCheckerBasedOnEdgeLength(0.9), o3d.pipelines.registration.CorrespondenceCheckerBasedOnDistance(distance_threshold)], o3d.pipelines.registration.RANSACConvergenceCriteria(100000, 0.999))
    return result
    ...
    for s in range(n_ply_files):
        for t in range(s + 1, n_ply_files):
            ...
            if not success:
                ...
                alignment.append((s, t, n_ply_files, np.linalg.inv(result.transformation)))
