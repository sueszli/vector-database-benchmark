...
_ReaderIOResultLikeType = TypeVar('_ReaderIOResultLikeType', bound='ReaderIOResultLikeN')

class ReaderIOResultLikeN(reader_result.ReaderResultLikeN[_FirstType, _SecondType, _ThirdType], ioresult.IOResultLikeN[_FirstType, _SecondType, _ThirdType]):
    """
...
class ReaderIOResultBasedN(ReaderIOResultLikeN[_FirstType, _SecondType, _ThirdType], reader.CallableReader3[_FirstType, _SecondType, _ThirdType, 'IOResult[_FirstType, _SecondType]', _ThirdType], Lawful['ReaderIOResultBasedN[_FirstType, _SecondType, _ThirdType]']):
    """
