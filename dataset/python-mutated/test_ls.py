...
FS_STRUCTURE = {'README.md': 'content', 'model/script.py': 'content', 'model/train.py': 'content', '.gitignore': 'content'}
DVC_STRUCTURE = {'structure.xml': 'content', 'data/subcontent/data.xml': 'content', 'data/subcontent/statistics/data.csv': 'content', 'model/people.csv': 'content'}
