...
class MenuCreateInput(graphene.InputObjectType):
    ...
    slug = graphene.String(description='Slug of the menu. Will be generated if not provided.', required=False)
...
class MenuCreate(ModelMutation):
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.MENU_CREATED, description='A menu was created.')]
