...
class ReplyKeyboardMarkup(MutableTelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, keyboard: List[List[KeyboardButton]], is_persistent: Optional[bool]=None, resize_keyboard: Optional[bool]=None, one_time_keyboard: Optional[bool]=None, input_field_placeholder: Optional[str]=None, selective: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(keyboard=keyboard, is_persistent=is_persistent, resize_keyboard=resize_keyboard, one_time_keyboard=one_time_keyboard, input_field_placeholder=input_field_placeholder, selective=selective, **__pydantic_kwargs)