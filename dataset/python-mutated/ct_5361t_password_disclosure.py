...
class Exploit(HTTPClient):
    __info__ = {'name': 'Comtrend CT 5361T Password Disclosure', 'description': 'WiFi router Comtrend CT 5361T suffers from a Password Disclosure Vulnerability', 'authors': ('TUNISIAN CYBER',), 'references': ('https://packetstormsecurity.com/files/126129/Comtrend-CT-5361T-Password-Disclosure.html',), 'devices': ('Comtrend CT 5361T (more likely CT 536X)',)}
