...
if version.parse(tf.version.VERSION) >= version.parse('2.4'):
    ...
    gelu = _gelu
    gelu_new = _gelu_new
ACT2FN = {'gelu': gelu, 'gelu_10': gelu_10, 'gelu_fast': gelu_fast, 'gelu_new': gelu_new, 'glu': glu, 'mish': mish, 'quick_gelu': quick_gelu, 'relu': tf.keras.activations.relu, 'sigmoid': tf.keras.activations.sigmoid, 'silu': tf.keras.activations.swish, 'swish': tf.keras.activations.swish, 'tanh': tf.keras.activations.tanh}
