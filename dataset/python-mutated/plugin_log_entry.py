...
class PluginLogEntryViewSet(StructuredViewSetMixin, mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    permission_classes = [IsAuthenticated, ProjectMembershipNecessaryPermissions, PluginsAccessLevelPermission, PluginOwnershipPermission, TeamMemberAccessPermission]
