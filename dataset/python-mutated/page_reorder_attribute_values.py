...
class PageReorderAttributeValues(BaseReorderAttributeValuesMutation):
    page = graphene.Field(Page, description='Page from which attribute values are reordered.')
    ...
    class Arguments:
        page_id = graphene.Argument(graphene.ID, required=True, description='ID of a page.')
