...
from mypy.expandtype import expand_type, expand_type_by_instance, freshen_all_functions_type_vars, freshen_function_type_vars
...
from mypy.subtypes import find_member, is_equivalent, is_same_type, is_subtype, non_method_protocol_members
from mypy.traverser import has_await_expression
from mypy.type_visitor import TypeTranslator
from mypy.typeanal import check_for_explicit_any, fix_instance, has_any_from_unimported_type, instantiate_type_alias, make_optional_type, set_any_tvars, validate_instance
from mypy.typeops import callable_type, custom_special_method, erase_to_union_or_bound, false_only, fixup_partial_type, function_type, get_all_type_vars, get_type_vars, is_literal_type_like, make_simplified_union, simple_literal_type, true_only, try_expanding_sum_type_to_union, try_getting_str_literals, tuple_fallback
from mypy.types import LITERAL_TYPE_NAMES, TUPLE_LIKE_INSTANCE_NAMES, AnyType, CallableType, DeletedType, ErasedType, ExtraAttrs, FunctionLike, Instance, LiteralType, LiteralValue, NoneType, Overloaded, Parameters, ParamSpecFlavor, ParamSpecType, PartialType, ProperType, TupleType, Type, TypeAliasType, TypedDictType, TypeOfAny, TypeType, TypeVarLikeType, TypeVarTupleType, TypeVarType, UnboundType, UninhabitedType, UnionType, UnpackType, find_unpack_in_list, flatten_nested_tuples, flatten_nested_unions, get_proper_type, get_proper_types, has_recursive_types, is_named_instance, remove_dups, split_with_prefix_and_suffix
from mypy.types_utils import is_generic_instance, is_overlapping_none, is_self_type_like, remove_optional
from mypy.typestate import type_state
from mypy.typevars import fill_typevars
from mypy.util import split_module_names
from mypy.visitor import ExpressionVisitor
ArgChecker: _TypeAlias = Callable[[Type, Type, ArgKind, Type, int, int, CallableType, Optional[Type], Context, Context], None]
MAX_UNIONS: Final = 5
OVERLAPPING_TYPES_ALLOWLIST: Final = ['builtins.set', 'builtins.frozenset', 'typing.KeysView', 'typing.ItemsView', 'builtins._dict_keys', 'builtins._dict_items', '_collections_abc.dict_keys', '_collections_abc.dict_items']
OVERLAPPING_BYTES_ALLOWLIST: Final = {'builtins.bytes', 'builtins.bytearray', 'builtins.memoryview'}
...
class ExpressionChecker(ExpressionVisitor[Type]):
    ...
    def get_partial_self_var(self, expr: MemberExpr) -> Var | None:
        ...
        if isinstance(sym.node, Var) and isinstance(sym.node.type, PartialType):
            return sym.node
        return None
    item_args: ClassVar[dict[str, list[str]]] = {'builtins.list': ['append'], 'builtins.set': ['add', 'discard']}
    container_args: ClassVar[dict[str, dict[str, list[str]]]] = {'builtins.list': {'extend': ['builtins.list']}, 'builtins.dict': {'update': ['builtins.dict']}, 'collections.OrderedDict': {'update': ['builtins.dict']}, 'builtins.set': {'update': ['builtins.set', 'builtins.list']}}
