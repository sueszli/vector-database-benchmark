...
from modelscope.models.cv.face_attribute_recognition import FaceAttributeRecognition
...
@PIPELINES.register_module(Tasks.face_attribute_recognition, module_name=Pipelines.face_attribute_recognition)
class FaceAttributeRecognitionPipeline(FaceProcessingBasePipeline):
    ...
    def __init__(self, model: str, **kwargs):
        ...
        fairface = FaceAttributeRecognition(model_path=ckpt_path, device=device)
