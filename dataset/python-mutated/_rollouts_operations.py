...
from ...operations._rollouts_operations import build_cancel_request, build_create_or_update_request, build_delete_request, build_get_request, build_list_request, build_restart_request
...
class RolloutsOperations:
    ...
    async def _create_or_update_initial(self, resource_group_name: str, rollout_name: str, rollout_request: Optional[Union[_models.RolloutRequest, IO]]=None, **kwargs: Any) -> _models.RolloutRequest:
        ...
        return deserialized
    _create_or_update_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeploymentManager/rollouts/{rolloutName}'}

    @overload
    async def begin_create_or_update(self, resource_group_name: str, rollout_name: str, rollout_request: Optional[_models.RolloutRequest]=None, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.RolloutRequest]:
    ...
    @overload
    async def begin_create_or_update(self, resource_group_name: str, rollout_name: str, rollout_request: Optional[IO]=None, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.RolloutRequest]:
        """Creates or updates a rollout.
    ...
    async def begin_create_or_update(self, resource_group_name: str, rollout_name: str, rollout_request: Optional[Union[_models.RolloutRequest, IO]]=None, **kwargs: Any) -> AsyncLROPoller[_models.RolloutRequest]:
        """Creates or updates a rollout.
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_initial(resource_group_name=resource_group_name, rollout_name=rollout_name, rollout_request=rollout_request, api_version=api_version, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
    ...
    begin_create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeploymentManager/rollouts/{rolloutName}'}

    @distributed_trace_async
    async def get(self, resource_group_name: str, rollout_name: str, retry_attempt: Optional[int]=None, **kwargs: Any) -> _models.Rollout:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, rollout_name=rollout_name, subscription_id=self._config.subscription_id, retry_attempt=retry_attempt, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, rollout_name: str, **kwargs: Any) -> None:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, rollout_name=rollout_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    async def cancel(self, resource_group_name: str, rollout_name: str, **kwargs: Any) -> _models.Rollout:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_cancel_request(resource_group_name=resource_group_name, rollout_name=rollout_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.cancel.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def restart(self, resource_group_name: str, rollout_name: str, skip_succeeded: Optional[bool]=None, **kwargs: Any) -> _models.Rollout:
        ...
        api_version = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls = kwargs.pop('cls', None)
        request = build_restart_request(resource_group_name=resource_group_name, rollout_name=rollout_name, subscription_id=self._config.subscription_id, skip_succeeded=skip_succeeded, api_version=api_version, template_url=self.restart.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
