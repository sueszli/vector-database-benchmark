from azure.core.pipeline.transport import AsyncHttpResponse as PipelineTransportAsyncHttpResponse, AsyncHttpTransport, AioHttpTransport, HttpRequest, AioHttpTransportResponse
...
async def test_multipart_send(http_request):
    ...
    request.set_multipart_mixed(req0, req1, policies=[RequestPolicy()], boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525')
...
async def test_multipart_send_with_context(http_request):
    ...
    req1 = http_request('DELETE', '/container1/blob1')
    request = http_request('POST', 'http://account.blob.core.windows.net/?comp=batch')
    request.set_multipart_mixed(req0, req1, policies=[header_policy, RequestPolicy()], boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525', headers={'Accept': 'application/json'})
    async with AsyncPipeline(transport) as pipeline:
        await pipeline.run(request)
...
async def test_multipart_send_with_multiple_changesets(http_request):
    ...
    changeset1.set_multipart_mixed(http_request('DELETE', '/container0/blob0'), http_request('DELETE', '/container1/blob1'), boundary='changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    changeset2 = http_request('', '')
    changeset2.set_multipart_mixed(http_request('DELETE', '/container2/blob2'), http_request('DELETE', '/container3/blob3'), boundary='changeset_8b9e487e-a353-4dcb-a6f4-0688191e0314')
    request = http_request('POST', 'http://account.blob.core.windows.net/?comp=batch')
    request.set_multipart_mixed(changeset1, changeset2, boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    async with AsyncPipeline(transport) as pipeline:
        await pipeline.run(request)
...
async def test_multipart_send_with_combination_changeset_first(http_request):
    transport = MockAsyncHttpTransport()
    changeset = http_request('', '')
    changeset.set_multipart_mixed(http_request('DELETE', '/container0/blob0'), http_request('DELETE', '/container1/blob1'), boundary='changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    request = http_request('POST', 'http://account.blob.core.windows.net/?comp=batch')
    request.set_multipart_mixed(changeset, http_request('DELETE', '/container2/blob2'), boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    async with AsyncPipeline(transport) as pipeline:
        await pipeline.run(request)
    assert request.body == b'--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: multipart/mixed; boundary=changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 0\r\n\r\nDELETE /container0/blob0 HTTP/1.1\r\n\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 1\r\n\r\nDELETE /container1/blob1 HTTP/1.1\r\n\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 2\r\n\r\nDELETE /container2/blob2 HTTP/1.1\r\n\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n'
...
async def test_multipart_send_with_combination_changeset_last(http_request):
    transport = MockAsyncHttpTransport()
    changeset = http_request('', '')
    changeset.set_multipart_mixed(http_request('DELETE', '/container1/blob1'), http_request('DELETE', '/container2/blob2'), boundary='changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    request = http_request('POST', 'http://account.blob.core.windows.net/?comp=batch')
    request.set_multipart_mixed(http_request('DELETE', '/container0/blob0'), changeset, boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    async with AsyncPipeline(transport) as pipeline:
        await pipeline.run(request)
    assert request.body == b'--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 0\r\n\r\nDELETE /container0/blob0 HTTP/1.1\r\n\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: multipart/mixed; boundary=changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 1\r\n\r\nDELETE /container1/blob1 HTTP/1.1\r\n\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 2\r\n\r\nDELETE /container2/blob2 HTTP/1.1\r\n\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n'
...
async def test_multipart_send_with_combination_changeset_middle(http_request):
    transport = MockAsyncHttpTransport()
    changeset = http_request('', '')
    changeset.set_multipart_mixed(http_request('DELETE', '/container1/blob1'), boundary='changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    request = http_request('POST', 'http://account.blob.core.windows.net/?comp=batch')
    request.set_multipart_mixed(http_request('DELETE', '/container0/blob0'), changeset, http_request('DELETE', '/container2/blob2'), boundary='batch_357de4f7-6d0b-4e02-8cd2-6361411a9525')
    async with AsyncPipeline(transport) as pipeline:
        await pipeline.run(request)
    assert request.body == b'--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 0\r\n\r\nDELETE /container0/blob0 HTTP/1.1\r\n\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: multipart/mixed; boundary=changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 1\r\n\r\nDELETE /container1/blob1 HTTP/1.1\r\n\r\n\r\n--changeset_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525\r\nContent-Type: application/http\r\nContent-Transfer-Encoding: binary\r\nContent-ID: 2\r\n\r\nDELETE /container2/blob2 HTTP/1.1\r\n\r\n\r\n--batch_357de4f7-6d0b-4e02-8cd2-6361411a9525--\r\n'
