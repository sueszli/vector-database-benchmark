...
if __name__ == '__main__':
    ...
    app = pg.mkQApp()
    pts = [(0, 0), (10, 0), (10, 10), (20, 10), (20, 20), (25, 20), (25, 25), (20, 25), (20, 20), (10, 17), (5, 25), (9, 30), (6, 15), (15, 12.5), (0, 5)]
    num_pts = len(pts)
    edges = [(i, (i + 1) % num_pts) for i in range(num_pts)]
    pts += [(21, 21), (24, 21), (24, 24), (21, 24)]
    edges += [(num_pts, num_pts + 1), (num_pts + 1, num_pts + 2), (num_pts + 2, num_pts + 3), (num_pts + 3, num_pts)]
