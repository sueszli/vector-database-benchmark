...
from ..utils import ExtractorError, int_or_none, join_nonempty, str_or_none, strftime_or_none, traverse_obj, unified_strdate, url_or_none, urljoin, variadic
...
class NetEaseMusicIE(NetEaseMusicBaseIE):
    ...
    _TESTS = [{'url': 'https://music.163.com/#/song?id=548648087', 'info_dict': {'id': '548648087', 'ext': 'mp3', 'title': '戒烟 (Live)', 'creator': '李荣浩 / 朱正廷 / 陈立农 / 尤长靖 / ONER灵超 / ONER木子洋 / 杨非同 / 陆定昊', 'timestamp': 1522944000, 'upload_date': '20180405', 'description': 'md5:3650af9ee22c87e8637cb2dde22a765c', 'subtitles': {'lyrics': [{'ext': 'lrc'}]}, 'duration': 256, 'thumbnail': 're:^http.*\\.jpg', 'album': '偶像练习生 表演曲目合集', 'average_rating': int, 'album_artist': '偶像练习生'}}, {'note': 'No lyrics.', 'url': 'http://music.163.com/song?id=17241424', 'info_dict': {'id': '17241424', 'ext': 'mp3', 'title': 'Opus 28', 'creator': "Dustin O'Halloran", 'upload_date': '20080211', 'timestamp': 1202745600, 'duration': 263, 'thumbnail': 're:^http.*\\.jpg', 'album': 'Piano Solos Vol. 2', 'album_artist': "Dustin O'Halloran", 'average_rating': int}}, {'url': 'https://y.music.163.com/m/song?app_version=8.8.45&id=95670&uct2=sKnvS4+0YStsWkqsPhFijw%3D%3D&dlt=0846', 'md5': '95826c73ea50b1c288b22180ec9e754d', 'info_dict': {'id': '95670', 'ext': 'mp3', 'title': '国际歌', 'creator': '马备', 'upload_date': '19911130', 'timestamp': 691516800, 'description': 'md5:1ba2f911a2b0aa398479f595224f2141', 'subtitles': {'lyrics': [{'ext': 'lrc'}]}, 'duration': 268, 'alt_title': '伴唱:现代人乐队 合唱:总政歌舞团', 'thumbnail': 're:^http.*\\.jpg', 'average_rating': int, 'album': '红色摇滚', 'album_artist': '侯牧人'}}, {'url': 'http://music.163.com/#/song?id=32102397', 'md5': '3e909614ce09b1ccef4a3eb205441190', 'info_dict': {'id': '32102397', 'ext': 'mp3', 'title': 'Bad Blood', 'creator': 'Taylor Swift / Kendrick Lamar', 'upload_date': '20150516', 'timestamp': 1431792000, 'description': 'md5:21535156efb73d6d1c355f95616e285a', 'subtitles': {'lyrics': [{'ext': 'lrc'}]}, 'duration': 199, 'thumbnail': 're:^http.*\\.jpg', 'album': 'Bad Blood', 'average_rating': int, 'album_artist': 'Taylor Swift'}, 'skip': 'Blocked outside Mainland China'}, {'note': 'Has translated name.', 'url': 'http://music.163.com/#/song?id=22735043', 'info_dict': {'id': '22735043', 'ext': 'mp3', 'title': '소원을 말해봐 (Genie)', 'creator': '少女时代', 'upload_date': '20100127', 'timestamp': 1264608000, 'description': 'md5:03d1ffebec3139aa4bafe302369269c5', 'subtitles': {'lyrics': [{'ext': 'lrc'}]}, 'duration': 229, 'alt_title': '说出愿望吧(Genie)', 'thumbnail': 're:^http.*\\.jpg', 'average_rating': int, 'album': 'Oh!', 'album_artist': '少女时代'}, 'skip': 'Blocked outside Mainland China'}]
...
class NetEaseMusicAlbumIE(NetEaseMusicBaseIE):
    ...
    _TESTS = [{'url': 'https://music.163.com/#/album?id=133153666', 'info_dict': {'id': '133153666', 'title': '桃几的翻唱', 'upload_date': '20210913', 'description': '桃几2021年翻唱合集', 'thumbnail': 're:^http.*\\.jpg'}, 'playlist_mincount': 13}, {'url': 'http://music.163.com/#/album?id=220780', 'info_dict': {'id': '220780', 'title': "B'Day", 'upload_date': '20060904', 'description': 'md5:71a74e1d8f392d88cf1bbe48879ad0b0', 'thumbnail': 're:^http.*\\.jpg'}, 'playlist_count': 23}]
...
class NetEaseMusicListIE(NetEaseMusicBaseIE):
    ...
    _TESTS = [{'url': 'http://music.163.com/#/playlist?id=79177352', 'info_dict': {'id': '79177352', 'title': 'Billboard 2007 Top 100', 'description': 'md5:12fd0819cab2965b9583ace0f8b7b022', 'tags': ['欧美'], 'uploader': '浑然破灭', 'uploader_id': '67549805', 'timestamp': int, 'upload_date': 're:\\d{8}'}, 'playlist_mincount': 95}, {'note': 'Toplist/Charts sample', 'url': 'https://music.163.com/#/discover/toplist?id=60198', 'info_dict': {'id': '60198', 'title': 're:美国Billboard榜 [0-9]{4}-[0-9]{2}-[0-9]{2}', 'description': '美国Billboard排行榜', 'tags': ['流行', '欧美', '榜单'], 'uploader': 'Billboard公告牌', 'uploader_id': '48171', 'timestamp': int, 'upload_date': 're:\\d{8}'}, 'playlist_count': 100}, {'note': 'Toplist/Charts sample', 'url': 'http://music.163.com/#/discover/toplist?id=3733003', 'info_dict': {'id': '3733003', 'title': 're:韩国Melon排行榜周榜 [0-9]{4}-[0-9]{2}-[0-9]{2}', 'description': 'md5:73ec782a612711cadc7872d9c1e134fc'}, 'playlist_count': 50, 'skip': 'Blocked outside Mainland China'}]
...
class NetEaseMusicMvIE(NetEaseMusicBaseIE):
    ...
    _TESTS = [{'url': 'https://music.163.com/#/mv?id=10958064', 'info_dict': {'id': '10958064', 'ext': 'mp4', 'title': '交换余生', 'description': 'md5:e845872cff28820642a2b02eda428fea', 'creator': '林俊杰', 'upload_date': '20200916', 'thumbnail': 're:http.*\\.jpg', 'duration': 364, 'view_count': int, 'like_count': int, 'comment_count': int}}, {'url': 'http://music.163.com/#/mv?id=415350', 'info_dict': {'id': '415350', 'ext': 'mp4', 'title': '이럴거면 그러지말지', 'description': '白雅言自作曲唱甜蜜爱情', 'creator': '白娥娟', 'upload_date': '20150520', 'thumbnail': 're:http.*\\.jpg', 'duration': 216, 'view_count': int, 'like_count': int, 'comment_count': int}}]
...
class NetEaseMusicProgramIE(NetEaseMusicBaseIE):
    ...
    _TESTS = [{'url': 'http://music.163.com/#/program?id=10109055', 'info_dict': {'id': '32593346', 'ext': 'mp3', 'title': '不丹足球背后的故事', 'description': '喜马拉雅人的足球梦 ...', 'creator': '大话西藏', 'timestamp': 1434179287, 'upload_date': '20150613', 'thumbnail': 're:http.*\\.jpg', 'duration': 900}}, {'note': 'This program has accompanying songs.', 'url': 'http://music.163.com/#/program?id=10141022', 'info_dict': {'id': '10141022', 'title': '滚滚电台的有声节目', 'description': 'md5:8d594db46cc3e6509107ede70a4aaa3b', 'creator': '滚滚电台ORZ', 'timestamp': 1434450733, 'upload_date': '20150616', 'thumbnail': 're:http.*\\.jpg'}, 'playlist_count': 4}, {'note': 'This program has accompanying songs.', 'url': 'http://music.163.com/#/program?id=10141022', 'info_dict': {'id': '32647209', 'ext': 'mp3', 'title': '滚滚电台的有声节目', 'description': 'md5:8d594db46cc3e6509107ede70a4aaa3b', 'creator': '滚滚电台ORZ', 'timestamp': 1434450733, 'upload_date': '20150616', 'thumbnail': 're:http.*\\.jpg', 'duration': 1104}, 'params': {'noplaylist': True}}]
...
class NetEaseMusicDjRadioIE(NetEaseMusicBaseIE):
    ...
    _TEST = {'url': 'http://music.163.com/#/djradio?id=42', 'info_dict': {'id': '42', 'title': '声音蔓延', 'description': 'md5:c7381ebd7989f9f367668a5aee7d5f08'}, 'playlist_mincount': 40}
    _PAGE_SIZE = 1000
