...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        if False:
            print('Hello World!')
        self.set_filename('chart_stock02.xlsx')
        self.ignore_elements = {'xl/charts/chart1.xml': ['<c:formatCode'], 'xl/workbook.xml': ['<fileVersion', '<calcPr'], 'xl/worksheets/sheet1.xml': ['<sheetView', '<selection activeCell', '</sheetView']}
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$1:$A$5', 'values': '=Sheet1!$D$1:$D$5', 'y2_axis': 1})
