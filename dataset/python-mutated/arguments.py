...
from .unset import _deprecated_is_unset
if TYPE_CHECKING:
    from strawberry.custom_scalar import ScalarDefinition, ScalarWrapper
    from strawberry.schema.config import StrawberryConfig
    from strawberry.type import StrawberryType
DEPRECATED_NAMES: Dict[str, str] = {'UNSET': 'importing `UNSET` from `strawberry.arguments` is deprecated, import instead from `strawberry` or from `strawberry.unset`', 'is_unset': '`is_unset` is deprecated use `value is UNSET` instead'}
...
__all__ = ['StrawberryArgument', 'StrawberryArgumentAnnotation', 'UNSET', 'argument', 'is_unset']