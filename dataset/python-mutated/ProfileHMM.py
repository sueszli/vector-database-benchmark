...
if __name__ == '__main__':
    ...
    parser.add_argument('--prior-scale', default=1.0, type=float, help='Prior scale parameter (all parameters).')
    ...
    parser.add_argument('--pin-mem', default=False, action='store_true', help='Use pin_memory for faster GPU transfer.')
