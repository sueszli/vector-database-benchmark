...
try:
    ...
    warnings.warn('pytorch_quantization module not found, quantization will not be available')
    quant_nn = None
    import contextlib
    ...
    def switch_on_quantization(do_quantization=False):
        ...
        try:
            ...
            pass
from .common import SequentialSqueezeAndExcitation, SequentialSqueezeAndExcitationTRT, LayerBuilder, StochasticDepthResidual, Flatten
from .model import Model, ModelParams, ModelArch, OptimizerParams, create_entrypoint, EntryPoint
...
effnet_b0_layers = EffNetArch(block=original_mbconv, stem_channels=32, feature_channels=1280, kernel=[3, 3, 5, 3, 5, 5, 3], stride=[1, 2, 2, 2, 1, 2, 1], num_repeat=[1, 2, 2, 3, 3, 4, 1], expansion=[1, 6, 6, 6, 6, 6, 6], channels=[16, 24, 40, 80, 112, 192, 320], default_image_size=224)
...
urls = {'efficientnet-b0': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_b0_pyt_amp/versions/20.12.0/files/nvidia_efficientnet-b0_210412.pth', 'efficientnet-b4': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_b4_pyt_amp/versions/20.12.0/files/nvidia_efficientnet-b4_210412.pth', 'efficientnet-widese-b0': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_widese_b0_pyt_amp/versions/20.12.0/files/nvidia_efficientnet-widese-b0_210412.pth', 'efficientnet-widese-b4': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_widese_b4_pyt_amp/versions/20.12.0/files/nvidia_efficientnet-widese-b4_210412.pth', 'efficientnet-quant-b0': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_b0_pyt_qat_ckpt_fp32/versions/21.03.0/files/nvidia-efficientnet-quant-b0-130421.pth', 'efficientnet-quant-b4': 'https://api.ngc.nvidia.com/v2/models/nvidia/efficientnet_b4_pyt_qat_ckpt_fp32/versions/21.03.0/files/nvidia-efficientnet-quant-b4-130421.pth'}
