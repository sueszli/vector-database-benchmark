...
DIRECT_MESSAGE_EVENT_FIELDS = ['attachments', 'created_at', 'dm_conversation_id', 'event_type', 'id', 'participant_ids', 'referenced_tweets', 'sender_id', 'text']
...
class DirectMessageEvent(HashableID, DataMapping):
    ...
    * ``referenced_tweets`` - If a Tweet URL is found in the text field, the ID
    ...
    """
    __slots__ = ('data', 'id', 'event_type', 'attachments', 'created_at', 'dm_conversation_id', 'participant_ids', 'referenced_tweets', 'sender_id', 'text')
