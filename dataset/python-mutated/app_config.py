...
class AppConfig:
    ...
    socket_io_js_transports: List[Literal['websocket', 'polling']] = field(default_factory=lambda : ['websocket', 'polling'])
    quasar_config: Dict = field(default_factory=lambda : {'brand': {'primary': '#5898d4'}, 'loadingBar': {'color': 'primary', 'skipHijack': False}})
