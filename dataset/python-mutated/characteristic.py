...
PROPERTY_MASKS = {2 ** n: prop for (n, prop) in enumerate(('broadcast', 'read', 'write-without-response', 'write', 'notify', 'indicate', 'authenticated-signed-writes', 'extended-properties', 'reliable-writes', 'writable-auxiliaries'))}
