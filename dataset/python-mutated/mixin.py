...
from .celery.utils import create_or_update_celery_periodic_tasks, disable_celery_periodic_task, delete_celery_periodic_task
__all__ = ['PeriodTaskModelMixin', 'PeriodTaskSerializerMixin']
...
class PeriodTaskModelMixin(models.Model):
    ...
    interval = models.IntegerField(default=24, null=True, blank=True, verbose_name=_('Cycle perform'))
    crontab = models.CharField(null=True, blank=True, max_length=128, verbose_name=_('Regularly perform'))
...
class PeriodTaskSerializerMixin(serializers.Serializer):
    ...
    interval = serializers.IntegerField(default=24, allow_null=True, required=False, label=_('Interval'))
    INTERVAL_MAX = 65535
    INTERVAL_MIN = 1
