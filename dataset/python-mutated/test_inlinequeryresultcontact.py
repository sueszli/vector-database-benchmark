import pytest
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, InlineQueryResultContact, InlineQueryResultVoice, InputTextMessageContent
...
class TestInlineQueryResultContactWithoutRequest(TestInlineQueryResultContactBase):
    ...
    def test_expected_values(self, inline_query_result_contact):
        ...
        assert inline_query_result_contact.input_message_content.to_dict() == self.input_message_content.to_dict()
    ...
    def test_to_dict(self, inline_query_result_contact):
        ...
        assert inline_query_result_contact_dict['phone_number'] == inline_query_result_contact.phone_number
        assert inline_query_result_contact_dict['first_name'] == inline_query_result_contact.first_name
        assert inline_query_result_contact_dict['last_name'] == inline_query_result_contact.last_name
        assert inline_query_result_contact_dict['thumbnail_url'] == inline_query_result_contact.thumbnail_url
        assert inline_query_result_contact_dict['thumbnail_width'] == inline_query_result_contact.thumbnail_width
        assert inline_query_result_contact_dict['thumbnail_height'] == inline_query_result_contact.thumbnail_height
        assert inline_query_result_contact_dict['input_message_content'] == inline_query_result_contact.input_message_content.to_dict()
        assert inline_query_result_contact_dict['reply_markup'] == inline_query_result_contact.reply_markup.to_dict()
