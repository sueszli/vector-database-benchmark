...
CSI300_GBDT_TASK = {'model': GBDT_MODEL, 'dataset': get_dataset_config(train=('2020-05-01', '2020-06-01'), valid=('2020-06-01', '2020-07-01'), test=('2020-07-01', '2020-08-01'), handler_kwargs={'start_time': '2020-05-01', 'end_time': '2020-08-01', 'fit_start_time': '<dataset.kwargs.segments.train.0>', 'fit_end_time': '<dataset.kwargs.segments.train.1>', 'instruments': CSI300_MARKET})}
