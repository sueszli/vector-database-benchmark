...
from airflow.providers.google.cloud.operators.dataplex import DataplexCreateAssetOperator, DataplexCreateLakeOperator, DataplexCreateOrUpdateDataQualityScanOperator, DataplexCreateTaskOperator, DataplexCreateZoneOperator, DataplexDeleteAssetOperator, DataplexDeleteDataQualityScanOperator, DataplexDeleteLakeOperator, DataplexDeleteTaskOperator, DataplexDeleteZoneOperator, DataplexGetDataQualityScanResultOperator, DataplexGetTaskOperator, DataplexListTasksOperator, DataplexRunDataQualityScanOperator
...
LAKE_ID = 'lake-id'
BODY = {'body': 'test'}
BODY_LAKE = {'display_name': 'test_display_name', 'labels': [], 'description': 'test_description', 'metastore': {'service': ''}}
