...
from litestar._kwargs.dependencies import Dependency, create_dependency_batches, resolve_dependency
from litestar._kwargs.extractors import body_extractor, cookies_extractor, create_connection_value_extractor, create_data_extractor, headers_extractor, parse_connection_headers, parse_connection_query_params, query_extractor, request_extractor, scope_extractor, socket_extractor, state_extractor
from litestar._kwargs.parameter_definition import ParameterDefinition, create_parameter_definition, merge_parameter_sets
...
class KwargsModel:
    ...
    """
    __slots__ = ('dependency_batches', 'expected_cookie_params', 'expected_data_dto', 'expected_form_data', 'expected_header_params', 'expected_msgpack_data', 'expected_path_params', 'expected_query_params', 'expected_reserved_kwargs', 'extractors', 'has_kwargs', 'is_data_optional', 'sequence_query_parameter_names')
