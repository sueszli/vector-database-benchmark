...
class CreateDeliveryVehicleRequest(proto.Message):
    ...
    Attributes:
        ...
        delivery_vehicle (google.maps.fleetengine_delivery_v1.types.DeliveryVehicle):
            ...
            error is returned.
    """
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    delivery_vehicle_id: str = proto.Field(proto.STRING, number=4)
    delivery_vehicle: mfd_delivery_vehicles.DeliveryVehicle = proto.Field(proto.MESSAGE, number=5, message=mfd_delivery_vehicles.DeliveryVehicle)
...
class ListDeliveryVehiclesRequest(proto.Message):
    ...
    filter: str = proto.Field(proto.STRING, number=6)
    viewport: ggt_viewport.Viewport = proto.Field(proto.MESSAGE, number=7, message=ggt_viewport.Viewport)
...
class ListDeliveryVehiclesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    delivery_vehicles: MutableSequence[mfd_delivery_vehicles.DeliveryVehicle] = proto.RepeatedField(proto.MESSAGE, number=1, message=mfd_delivery_vehicles.DeliveryVehicle)
...
class UpdateDeliveryVehicleRequest(proto.Message):
    ...
    """
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    delivery_vehicle: mfd_delivery_vehicles.DeliveryVehicle = proto.Field(proto.MESSAGE, number=3, message=mfd_delivery_vehicles.DeliveryVehicle)
...
class BatchCreateTasksRequest(proto.Message):
    ...
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    requests: MutableSequence['CreateTaskRequest'] = proto.RepeatedField(proto.MESSAGE, number=4, message='CreateTaskRequest')
...
class BatchCreateTasksResponse(proto.Message):
    ...
    Attributes:
        tasks (MutableSequence[google.maps.fleetengine_delivery_v1.types.Task]):
            The created Tasks.
    """
    tasks: MutableSequence[mfd_tasks.Task] = proto.RepeatedField(proto.MESSAGE, number=1, message=mfd_tasks.Task)
...
class CreateTaskRequest(proto.Message):
    ...
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    task_id: str = proto.Field(proto.STRING, number=5)
    task: mfd_tasks.Task = proto.Field(proto.MESSAGE, number=4, message=mfd_tasks.Task)
...
class SearchTasksRequest(proto.Message):
    """Deprecated: Issue ``GetTaskTrackingInfoRequest``\\ s to
    ...
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    parent: str = proto.Field(proto.STRING, number=3)
    tracking_id: str = proto.Field(proto.STRING, number=4)
...
class SearchTasksResponse(proto.Message):
    """The ``SearchTasks`` response. It contains the set of Tasks that meet
...
class UpdateTaskRequest(proto.Message):
    ...
    """
    header: mfd_header.DeliveryRequestHeader = proto.Field(proto.MESSAGE, number=1, message=mfd_header.DeliveryRequestHeader)
    task: mfd_tasks.Task = proto.Field(proto.MESSAGE, number=3, message=mfd_tasks.Task)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=4, message=field_mask_pb2.FieldMask)
...
class ListTasksResponse(proto.Message):
    """The ``ListTasks`` response that contains the set of Tasks that meet
