...
from ..utils import ExtractorError, int_or_none, float_or_none, try_get

class YandexMusicBaseIE(InfoExtractor):
    _VALID_URL_BASE = 'https?://music\\.yandex\\.(?P<tld>ru|kz|ua|by|com)'
...
class YandexMusicTrackIE(YandexMusicBaseIE):
    ...
    _VALID_URL = '%s/album/(?P<album_id>\\d+)/track/(?P<id>\\d+)' % YandexMusicBaseIE._VALID_URL_BASE
    _TESTS = [{'url': 'http://music.yandex.ru/album/540508/track/4878838', 'md5': 'dec8b661f12027ceaba33318787fff76', 'info_dict': {'id': '4878838', 'ext': 'mp3', 'title': 'md5:c63e19341fdbe84e43425a30bc777856', 'filesize': int, 'duration': 193.04, 'track': 'md5:210508c6ffdfd67a493a6c378f22c3ff', 'album': 'md5:cd04fb13c4efeafdfa0a6a6aca36d01a', 'album_artist': 'md5:5f54c35462c07952df33d97cfb5fc200', 'artist': 'md5:e6fd86621825f14dc0b25db3acd68160', 'release_year': 2009}}, {'url': 'http://music.yandex.ru/album/3840501/track/705105', 'md5': '82a54e9e787301dd45aba093cf6e58c0', 'info_dict': {'id': '705105', 'ext': 'mp3', 'title': 'md5:f86d4a9188279860a83000277024c1a6', 'filesize': int, 'duration': 239.27, 'track': 'md5:40f887f0666ba1aa10b835aca44807d1', 'album': 'md5:624f5224b14f5c88a8e812fd7fbf1873', 'album_artist': 'md5:dd35f2af4e8927100cbe6f5e62e1fb12', 'artist': 'md5:dd35f2af4e8927100cbe6f5e62e1fb12', 'release_year': 2016, 'genre': 'pop', 'disc_number': 2, 'track_number': 9}}, {'url': 'http://music.yandex.com/album/540508/track/4878838', 'only_matching': True}]
...
class YandexMusicAlbumIE(YandexMusicPlaylistBaseIE):
    ...
    _VALID_URL = '%s/album/(?P<id>\\d+)' % YandexMusicBaseIE._VALID_URL_BASE
    _TESTS = [{'url': 'http://music.yandex.ru/album/540508', 'info_dict': {'id': '540508', 'title': 'md5:7ed1c3567f28d14be9f61179116f5571'}, 'playlist_count': 50}, {'url': 'https://music.yandex.ru/album/3840501', 'info_dict': {'id': '3840501', 'title': 'md5:36733472cdaa7dcb1fd9473f7da8e50f'}, 'playlist_count': 33}, {'url': 'https://music.yandex.ru/album/9091882', 'info_dict': {'id': '9091882', 'title': 'ТЕД на русском'}, 'playlist_count': 187}]
...
class YandexMusicPlaylistIE(YandexMusicPlaylistBaseIE):
    ...
    _VALID_URL = '%s/users/(?P<user>[^/]+)/playlists/(?P<id>\\d+)' % YandexMusicBaseIE._VALID_URL_BASE
    _TESTS = [{'url': 'http://music.yandex.ru/users/music.partners/playlists/1245', 'info_dict': {'id': '1245', 'title': 'md5:841559b3fe2b998eca88d0d2e22a3097', 'description': 'md5:3b9f27b0efbe53f2ee1e844d07155cc9'}, 'playlist_count': 5}, {'url': 'https://music.yandex.ru/users/ya.playlist/playlists/1036', 'only_matching': True}, {'url': 'https://music.yandex.ru/users/mesiaz/playlists/1364', 'info_dict': {'id': '1364', 'title': 'md5:b3b400f997d3f878a13ae0699653f7db'}, 'playlist_mincount': 437}]
...
class YandexMusicArtistTracksIE(YandexMusicArtistBaseIE):
    ...
    _VALID_URL = '%s/artist/(?P<id>\\d+)/tracks' % YandexMusicBaseIE._VALID_URL_BASE
    _TESTS = [{'url': 'https://music.yandex.ru/artist/617526/tracks', 'info_dict': {'id': '617526', 'title': 'md5:131aef29d45fd5a965ca613e708c040b'}, 'playlist_count': 507}]
    _ARTIST_SORT = ''
    _ARTIST_WHAT = 'tracks'
...
class YandexMusicArtistAlbumsIE(YandexMusicArtistBaseIE):
    ...
    _VALID_URL = '%s/artist/(?P<id>\\d+)/albums' % YandexMusicBaseIE._VALID_URL_BASE
    _TESTS = [{'url': 'https://music.yandex.ru/artist/617526/albums', 'info_dict': {'id': '617526', 'title': 'md5:55dc58d5c85699b7fb41ee926700236c'}, 'playlist_count': 8}]
    _ARTIST_SORT = 'year'
    _ARTIST_WHAT = 'albums'
