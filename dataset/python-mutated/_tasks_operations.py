...
class TasksOperations:
    ...
    @distributed_trace
    def list(self, group_name: str, service_name: str, project_name: str, task_type: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.ProjectTask']:
        if False:
            print('Hello World!')
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_request(group_name=group_name, service_name=service_name, project_name=project_name, subscription_id=self._config.subscription_id, task_type=task_type, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: _models.ProjectTask, *, content_type: str='application/json', **kwargs: Any) -> _models.ProjectTask:
    ...
    @overload
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ProjectTask:
        """Create or update task.
    ...
    async def create_or_update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: Union[_models.ProjectTask, IO], **kwargs: Any) -> _models.ProjectTask:
        """Create or update task.
    ...
    @distributed_trace_async
    async def get(self, group_name: str, service_name: str, project_name: str, task_name: str, expand: Optional[str]=None, **kwargs: Any) -> _models.ProjectTask:
        ...
        api_version: Literal['2022-03-30-preview'] = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.ProjectTask] = kwargs.pop('cls', None)
        request = build_get_request(group_name=group_name, service_name=service_name, project_name=project_name, task_name=task_name, subscription_id=self._config.subscription_id, expand=expand, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace_async
    async def delete(self, group_name: str, service_name: str, project_name: str, task_name: str, delete_running_tasks: Optional[bool]=None, **kwargs: Any) -> None:
        """Delete task.
    ...
    @overload
    async def update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: _models.ProjectTask, *, content_type: str='application/json', **kwargs: Any) -> _models.ProjectTask:
        """Create or update task.
    ...
    @overload
    async def update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ProjectTask:
        """Create or update task.
    ...
    @distributed_trace_async
    async def update(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: Union[_models.ProjectTask, IO], **kwargs: Any) -> _models.ProjectTask:
        """Create or update task.
    ...
    @distributed_trace_async
    async def cancel(self, group_name: str, service_name: str, project_name: str, task_name: str, **kwargs: Any) -> _models.ProjectTask:
        """Cancel a task.
        ...
        api_version: Literal['2022-03-30-preview'] = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.ProjectTask] = kwargs.pop('cls', None)
        request = build_cancel_request(group_name=group_name, service_name=service_name, project_name=project_name, task_name=task_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.cancel.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @overload
    async def command(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: _models.CommandProperties, *, content_type: str='application/json', **kwargs: Any) -> _models.CommandProperties:
    ...
    @overload
    async def command(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.CommandProperties:
        """Execute a command on a task.
    ...
    @distributed_trace_async
    async def command(self, group_name: str, service_name: str, project_name: str, task_name: str, parameters: Union[_models.CommandProperties, IO], **kwargs: Any) -> _models.CommandProperties:
        """Execute a command on a task.
        ...
        request = build_command_request(group_name=group_name, service_name=service_name, project_name=project_name, task_name=task_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.command.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
