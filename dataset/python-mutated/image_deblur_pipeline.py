...
@PIPELINES.register_module(Tasks.image_deblurring, module_name=Pipelines.image_deblur)
class ImageDeblurPipeline(Pipeline):
    ...
    def __init__(self, model: Union[NAFNetForImageDeblur, str], preprocessor: Optional[ImageDeblurPreprocessor]=None, **kwargs):
        if False:
            while True:
                i = 10
