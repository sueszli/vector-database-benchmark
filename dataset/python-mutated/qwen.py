...
def qwen_attention_forward(self, hidden_states: Optional[Tuple[torch.FloatTensor]], rotary_pos_emb_list: Optional[List[torch.Tensor]]=None, registered_causal_mask: Optional[torch.Tensor]=None, layer_past: Optional[Tuple[torch.Tensor]]=None, attention_mask: Optional[torch.FloatTensor]=None, head_mask: Optional[torch.FloatTensor]=None, encoder_hidden_states: Optional[torch.Tensor]=None, encoder_attention_mask: Optional[torch.FloatTensor]=None, output_attentions: Optional[bool]=False, use_cache: Optional[bool]=False):
    ...
    if self.use_flash_attn and flash_attn_unpadded_func is not None and (not self.is_fp32) and query.is_cuda:
        ...
        if registered_causal_mask is None and self.use_flash_attn and (flash_attn_unpadded_func is not None) and (not self.is_fp32) and (not query.is_cuda):
