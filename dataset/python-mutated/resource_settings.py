...
import proto
__protobuf__ = proto.module(package='google.cloud.resourcesettings.v1', manifest={'SettingView', 'Setting', 'SettingMetadata', 'Value', 'ListSettingsRequest', 'ListSettingsResponse', 'GetSettingRequest', 'UpdateSettingRequest'})
...
class Setting(proto.Message):
    ...
    metadata: 'SettingMetadata' = proto.Field(proto.MESSAGE, number=7, message='SettingMetadata')
    local_value: 'Value' = proto.Field(proto.MESSAGE, number=8, message='Value')
    effective_value: 'Value' = proto.Field(proto.MESSAGE, number=9, message='Value')
    etag: str = proto.Field(proto.STRING, number=10)

class SettingMetadata(proto.Message):
    """Metadata about a setting which is not editable by the end
    user.
    ...
    read_only: bool = proto.Field(proto.BOOL, number=3)
    data_type: DataType = proto.Field(proto.ENUM, number=4, enum=DataType)
    default_value: 'Value' = proto.Field(proto.MESSAGE, number=5, message='Value')
...
class Value(proto.Message):
    ...
    class StringSet(proto.Message):
        """A string set value that can hold a set of strings. The
    ...
    boolean_value: bool = proto.Field(proto.BOOL, number=1, oneof='value')
    string_value: str = proto.Field(proto.STRING, number=2, oneof='value')
    string_set_value: StringSet = proto.Field(proto.MESSAGE, number=3, oneof='value', message=StringSet)
    enum_value: EnumValue = proto.Field(proto.MESSAGE, number=4, oneof='value', message=EnumValue)
...
class ListSettingsRequest(proto.Message):
    ...
    view: 'SettingView' = proto.Field(proto.ENUM, number=4, enum='SettingView')
...
class ListSettingsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    settings: MutableSequence['Setting'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Setting')
...
class GetSettingRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: 'SettingView' = proto.Field(proto.ENUM, number=2, enum='SettingView')
...
class UpdateSettingRequest(proto.Message):
    ...
    Attributes:
        setting (google.cloud.resourcesettings_v1.types.Setting):
            ...
            field requirements.
    """
    setting: 'Setting' = proto.Field(proto.MESSAGE, number=1, message='Setting')
