...
class DataProtectionOperations:
    ...
    @overload
    async def check_feature_support(self, location: str, parameters: _models.FeatureValidationRequestBase, *, content_type: str='application/json', **kwargs: Any) -> _models.FeatureValidationResponseBase:
    ...
    @overload
    async def check_feature_support(self, location: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.FeatureValidationResponseBase:
        """Validates if a feature is supported.
    ...
    async def check_feature_support(self, location: str, parameters: Union[_models.FeatureValidationRequestBase, IO], **kwargs: Any) -> _models.FeatureValidationResponseBase:
        """Validates if a feature is supported.
        ...
        request = build_check_feature_support_request(location=location, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.check_feature_support.metadata['url'], headers=_headers, params=_params)
