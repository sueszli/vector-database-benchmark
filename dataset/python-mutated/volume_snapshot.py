...
import proto
__protobuf__ = proto.module(package='google.cloud.baremetalsolution.v2', manifest={'VolumeSnapshot', 'GetVolumeSnapshotRequest', 'ListVolumeSnapshotsRequest', 'ListVolumeSnapshotsResponse', 'DeleteVolumeSnapshotRequest', 'CreateVolumeSnapshotRequest', 'RestoreVolumeSnapshotRequest'})
...
class VolumeSnapshot(proto.Message):
    ...
    id: str = proto.Field(proto.STRING, number=6)
    ...
    type_: SnapshotType = proto.Field(proto.ENUM, number=7, enum=SnapshotType)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    volume_snapshots: MutableSequence['VolumeSnapshot'] = proto.RepeatedField(proto.MESSAGE, number=1, message='VolumeSnapshot')
...
class CreateVolumeSnapshotRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    volume_snapshot: 'VolumeSnapshot' = proto.Field(proto.MESSAGE, number=2, message='VolumeSnapshot')
...
class RestoreVolumeSnapshotRequest(proto.Message):
    ...
    """
    volume_snapshot: str = proto.Field(proto.STRING, number=1)
