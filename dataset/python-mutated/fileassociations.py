...
from qtpy.QtWidgets import QApplication, QDialog, QDialogButtonBox, QHBoxLayout, QLabel, QLineEdit, QListWidget, QListWidgetItem, QPushButton, QVBoxLayout, QWidget
from spyder.config.base import _
from spyder.utils.encoding import is_text_file
from spyder.utils.programs import get_application_icon, get_installed_applications, parse_linux_desktop_entry
...
class FileAssociationsWidget(QWidget):
    ...
    _EXTENSIONS_LIST_REGEX = '(?:(?:\\*{1,1}|\\w+)\\.\\w+)(?:,(?:\\*{1,1}|\\w+)\\.\\w+){0,20}'
