...
NW_MATRIX = {('A', 'A'): 10, ('G', 'G'): 7, ('C', 'C'): 9, ('T', 'T'): 8, ('A', 'G'): -1, ('A', 'C'): -3, ('A', 'T'): -4, ('G', 'C'): -5, ('G', 'T'): -3, ('C', 'T'): 0}

@pytest.mark.parametrize('left, right, expected', [('AGACTAGTTAC', 'CGAGACGT', 16)])
...
@pytest.mark.parametrize('left, right, expected', [('CGATATCAG', 'TGACGSTGC', -5), ('AGACTAGTTAC', 'TGACGSTGC', -7), ('AGACTAGTTAC', 'CGAGACGT', -15)])
