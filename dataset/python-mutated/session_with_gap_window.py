...
if __name__ == '__main__':
    ...
    ds = data_stream.assign_timestamps_and_watermarks(watermark_strategy).key_by(lambda x: x[0], key_type=Types.STRING()).window(EventTimeSessionWindows.with_gap(Time.milliseconds(5))).process(CountWindowProcessFunction(), Types.TUPLE([Types.STRING(), Types.INT(), Types.INT(), Types.INT()]))
