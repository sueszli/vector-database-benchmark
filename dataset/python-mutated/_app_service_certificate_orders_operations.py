...
from ...operations._app_service_certificate_orders_operations import build_create_or_update_certificate_request, build_create_or_update_request, build_delete_certificate_request, build_delete_request, build_get_certificate_request, build_get_request, build_list_by_resource_group_request, build_list_certificates_request, build_list_request, build_reissue_request, build_renew_request, build_resend_email_request, build_resend_request_emails_request, build_retrieve_certificate_actions_request, build_retrieve_certificate_email_history_request, build_retrieve_site_seal_request, build_update_certificate_request, build_update_request, build_validate_purchase_information_request, build_verify_domain_ownership_request
...
class AppServiceCertificateOrdersOperations:
    ...
    @overload
    async def validate_purchase_information(self, app_service_certificate_order: _models.AppServiceCertificateOrder, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def validate_purchase_information(self, app_service_certificate_order: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Validate information for a certificate order.
    ...
    async def validate_purchase_information(self, app_service_certificate_order: Union[_models.AppServiceCertificateOrder, IO], **kwargs: Any) -> None:
        """Validate information for a certificate order.
        ...
        request = build_validate_purchase_information_request(subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.validate_purchase_information.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.AppServiceCertificateOrder']:
        if False:
            i = 10
            return i + 15
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, certificate_order_name: str, **kwargs: Any) -> _models.AppServiceCertificateOrder:
        ...
        request = build_get_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def _create_or_update_initial(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: Union[_models.AppServiceCertificateOrder, IO], **kwargs: Any) -> _models.AppServiceCertificateOrder:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        ...
        request = build_create_or_update_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self._create_or_update_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def begin_create_or_update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: _models.AppServiceCertificateOrder, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateOrder]:
    ...
    @overload
    async def begin_create_or_update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateOrder]:
        """Create or update a certificate purchase order.
    ...
    @distributed_trace_async
    async def begin_create_or_update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: Union[_models.AppServiceCertificateOrder, IO], **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateOrder]:
        """Create or update a certificate purchase order.
    ...
    async def delete(self, resource_group_name: str, certificate_order_name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: _models.AppServiceCertificateOrderPatchResource, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServiceCertificateOrder:
        """Create or update a certificate purchase order.
    ...
    @overload
    async def update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServiceCertificateOrder:
        """Create or update a certificate purchase order.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, certificate_order_name: str, certificate_distinguished_name: Union[_models.AppServiceCertificateOrderPatchResource, IO], **kwargs: Any) -> _models.AppServiceCertificateOrder:
        """Create or update a certificate purchase order.
        ...
        request = build_update_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_certificates(self, resource_group_name: str, certificate_order_name: str, **kwargs: Any) -> AsyncIterable['_models.AppServiceCertificateResource']:
        if False:
            for i in range(10):
                print('nop')
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_certificates_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_certificates.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    @distributed_trace_async
    async def get_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, **kwargs: Any) -> _models.AppServiceCertificateResource:
        ...
        request = build_get_certificate_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_certificate.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def _create_or_update_certificate_initial(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: Union[_models.AppServiceCertificateResource, IO], **kwargs: Any) -> _models.AppServiceCertificateResource:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        ...
        request = build_create_or_update_certificate_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self._create_or_update_certificate_initial.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def begin_create_or_update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: _models.AppServiceCertificateResource, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateResource]:
    ...
    @overload
    async def begin_create_or_update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateResource]:
        """Creates or updates a certificate and associates with key vault secret.
    ...
    @distributed_trace_async
    async def begin_create_or_update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: Union[_models.AppServiceCertificateResource, IO], **kwargs: Any) -> AsyncLROPoller[_models.AppServiceCertificateResource]:
        """Creates or updates a certificate and associates with key vault secret.
    ...
    @distributed_trace_async
    async def delete_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_certificate_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete_certificate.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: _models.AppServiceCertificatePatchResource, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServiceCertificateResource:
        """Creates or updates a certificate and associates with key vault secret.
    ...
    @overload
    async def update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServiceCertificateResource:
        """Creates or updates a certificate and associates with key vault secret.
    ...
    @distributed_trace_async
    async def update_certificate(self, resource_group_name: str, certificate_order_name: str, name: str, key_vault_certificate: Union[_models.AppServiceCertificatePatchResource, IO], **kwargs: Any) -> _models.AppServiceCertificateResource:
        """Creates or updates a certificate and associates with key vault secret.
        ...
        request = build_update_certificate_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_certificate.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def reissue(self, resource_group_name: str, certificate_order_name: str, reissue_certificate_order_request: _models.ReissueCertificateOrderRequest, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def reissue(self, resource_group_name: str, certificate_order_name: str, reissue_certificate_order_request: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Reissue an existing certificate order.
    ...
    @distributed_trace_async
    async def reissue(self, resource_group_name: str, certificate_order_name: str, reissue_certificate_order_request: Union[_models.ReissueCertificateOrderRequest, IO], **kwargs: Any) -> None:
        """Reissue an existing certificate order.
    ...
    @overload
    async def renew(self, resource_group_name: str, certificate_order_name: str, renew_certificate_order_request: _models.RenewCertificateOrderRequest, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def renew(self, resource_group_name: str, certificate_order_name: str, renew_certificate_order_request: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Renew an existing certificate order.
    ...
    @distributed_trace_async
    async def renew(self, resource_group_name: str, certificate_order_name: str, renew_certificate_order_request: Union[_models.RenewCertificateOrderRequest, IO], **kwargs: Any) -> None:
        """Renew an existing certificate order.
        ...
        request = build_renew_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.renew.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def resend_email(self, resource_group_name: str, certificate_order_name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_resend_email_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.resend_email.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def resend_request_emails(self, resource_group_name: str, certificate_order_name: str, name_identifier: _models.NameIdentifier, *, content_type: str='application/json', **kwargs: Any) -> None:
    ...
    @overload
    async def resend_request_emails(self, resource_group_name: str, certificate_order_name: str, name_identifier: IO, *, content_type: str='application/json', **kwargs: Any) -> None:
        """Verify domain ownership for this certificate order.
    ...
    @distributed_trace_async
    async def resend_request_emails(self, resource_group_name: str, certificate_order_name: str, name_identifier: Union[_models.NameIdentifier, IO], **kwargs: Any) -> None:
        """Verify domain ownership for this certificate order.
        ...
        request = build_resend_request_emails_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.resend_request_emails.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def retrieve_site_seal(self, resource_group_name: str, certificate_order_name: str, site_seal_request: _models.SiteSealRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.SiteSeal:
        """Verify domain ownership for this certificate order.
    ...
    @overload
    async def retrieve_site_seal(self, resource_group_name: str, certificate_order_name: str, site_seal_request: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.SiteSeal:
        """Verify domain ownership for this certificate order.
    ...
    @distributed_trace_async
    async def retrieve_site_seal(self, resource_group_name: str, certificate_order_name: str, site_seal_request: Union[_models.SiteSealRequest, IO], **kwargs: Any) -> _models.SiteSeal:
        """Verify domain ownership for this certificate order.
        ...
        request = build_retrieve_site_seal_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.retrieve_site_seal.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def verify_domain_ownership(self, resource_group_name: str, certificate_order_name: str, **kwargs: Any) -> None:
        """Verify domain ownership for this certificate order.
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_verify_domain_ownership_request(resource_group_name=resource_group_name, certificate_order_name=certificate_order_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.verify_domain_ownership.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def retrieve_certificate_actions(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.CertificateOrderAction]:
        ...
        request = build_retrieve_certificate_actions_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.retrieve_certificate_actions.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def retrieve_certificate_email_history(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.CertificateEmail]:
        ...
        request = build_retrieve_certificate_email_history_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.retrieve_certificate_email_history.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
