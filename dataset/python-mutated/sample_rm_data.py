...
attributes = ['message_id', 'parent_id', 'text', 'role', 'lang', 'review_count', 'rank', 'synthetic', 'model_name', 'emojis']
            ...
            for (convo, replies) in all_convo:
                if len(replies) > 1:
                    ...
                    if 'rank' not in replies[0]:
                        ...
                        RM_dataset.append({'prompt': prefix['prompt'], 'history': prefix['history'], 'pos': pos_reply, 'neg_replies': neg_replies})
