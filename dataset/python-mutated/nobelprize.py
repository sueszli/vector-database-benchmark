...
from ..utils import js_to_json, mimetype2ext, determine_ext, update_url_query, get_element_by_attribute, int_or_none

class NobelPrizeIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?nobelprize\\.org/mediaplayer.*?\\bid=(?P<id>\\d+)'
    _TEST = {'url': 'http://www.nobelprize.org/mediaplayer/?id=2636', 'md5': '04c81e5714bb36cc4e2232fee1d8157f', 'info_dict': {'id': '2636', 'ext': 'mp4', 'title': 'Announcement of the 2016 Nobel Prize in Physics', 'description': 'md5:05beba57f4f5a4bbd4cf2ef28fcff739'}}
