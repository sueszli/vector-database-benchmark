...
BASIC_METADATA = {'no_meta': (None, None), 'content_no_meta': ('text/plain', None), 'no_content_meta': (None, {'userkey': 'UserValue'}), 'isolation': ('text/plain', {'content-type': 'text/css'}), 'multiple': ('text/plain', {'userkey1': 'UserValue1', 'userkey2': 'UserValue2'}), 'complex': ('text/plain', {'utf8-data': '刺身/means sashimi', 'with-weird-chars': 'Space and !@#<>:/-+=&%'})}
BASIC_RANGE_INFO = {'from_beg': (0, 16), 'exceed_end': (0, 10 * 1024 ** 3), 'middle': (5, 10), 'end': (None, -5), 'till_end': (5, None)}
BASIC_DATA = [('empty_prefix', {}), ('missing_files', {'missing': None}), ('3_small_files', {'empty_file': 0, 'kb_file': 1024, 'mb_file': 1024 ** 2, 'missing_file': None}), ('long_path', {'/'.join('x' * 300): 1024, '/'.join('y' * 10): 32, 'x/x/x': None}), ('prefix', {'prefix': 32, 'prefixprefix': 33, 'prefix/prefix': 34, 'prefix/prefix/prefix': None}), ('samefile', {'prefix': 42, 'x': 43, 'empty_file': 1, 'xx': None}), ('crazypath', {'crazy spaces': 34, '\x01ÿ': 64, '刺身/means sashimi': 33, 'crazy-!.$%@2_()"\'': 100, ' /cra._:zy/\x01\x02/p a t h/$this/!!is()': 1000, 'crazy missing :(': None})]
BIG_DATA = [('5gb_file', {'5gb_file': 5 * 1024 ** 3}), ('3000_files', {str(i): i for i in range(3000)})]
...
FAKE_RUN_DATA = [('HelloFlow/56', {'one_a': 512, 'one_b': 1024, 'two_c': 8192})]
