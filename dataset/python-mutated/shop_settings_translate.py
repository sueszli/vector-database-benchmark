...
class ShopSettingsTranslate(BaseMutation):
    ...
    class Arguments:
        ...
        input = ShopSettingsTranslationInput(description='Fields required to update shop settings translations.', required=True)
    ...
    @classmethod
    def perform_mutation(cls, _root, info: ResolveInfo, /, input, language_code):
        if False:
            while True:
                i = 10
