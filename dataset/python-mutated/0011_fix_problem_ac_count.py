...
class Migration(migrations.Migration):
    dependencies = [('problem', '0010_problem_spj_compile_ok'), ('submission', '0009_delete_user_output')]
    operations = [migrations.RunPython(fix_problem_count_bugs, reverse_code=migrations.RunPython.noop)]