...
from AnyQt.QtWidgets import QGraphicsItem, QGraphicsEllipseItem, QGraphicsTextItem, QGraphicsLineItem, QGraphicsScene, QGraphicsView, QStyle, QSizePolicy, QFormLayout
from AnyQt.QtCore import Qt, QRectF, QSize, QPointF, QLineF, QTimer, pyqtSignal, pyqtProperty
...
class TextTreeNode(QGraphicsTextItem, GraphNode):
    ...
    def backgroundBrush(self):
        ...
        return QBrush(brush)
    backgroundBrush = pyqtProperty('QBrush', fget=backgroundBrush, fset=setBackgroundBrush, doc='Background brush')
