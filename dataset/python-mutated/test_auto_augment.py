...
run_aug_shape_supporting_cases = ((run_aug_shape[i % 3],) + params for (i, params) in enumerate(itertools.product(('cpu', 'gpu'), (True, False), (True, False), (None, 0), (True, False))))
run_aug_no_translation_cases = itertools.product(('reduced_image_net',), ('cpu', 'gpu'), (True, False), (False,), (None, 0), (False,))
