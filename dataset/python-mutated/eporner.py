...
from ..utils import encode_base_n, ExtractorError, int_or_none, merge_dicts, parse_duration, str_to_int, url_or_none

class EpornerIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?eporner\\.com/(?:(?:hd-porn|embed)/|video-)(?P<id>\\w+)(?:/(?P<display_id>[\\w-]+))?'
    _TESTS = [{'url': 'http://www.eporner.com/hd-porn/95008/Infamous-Tiffany-Teen-Strip-Tease-Video/', 'md5': '39d486f046212d8e1b911c52ab4691f8', 'info_dict': {'id': 'qlDUmNsj6VS', 'display_id': 'Infamous-Tiffany-Teen-Strip-Tease-Video', 'ext': 'mp4', 'title': 'Infamous Tiffany Teen Strip Tease Video', 'description': 'md5:764f39abf932daafa37485eb46efa152', 'timestamp': 1232520922, 'upload_date': '20090121', 'duration': 1838, 'view_count': int, 'age_limit': 18}, 'params': {'proxy': '127.0.0.1:8118'}}, {'url': 'http://www.eporner.com/hd-porn/3YRUtzMcWn0/Star-Wars-XXX-Parody/', 'only_matching': True}, {'url': 'http://www.eporner.com/hd-porn/3YRUtzMcWn0', 'only_matching': True}, {'url': 'http://www.eporner.com/embed/3YRUtzMcWn0', 'only_matching': True}, {'url': 'https://www.eporner.com/video-FJsA19J3Y3H/one-of-the-greats/', 'only_matching': True}]
