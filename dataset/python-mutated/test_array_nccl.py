...
_2d_mappings = [{0: [(slice(8), slice(None, None))], 1: [(slice(8, None), slice(None, None))]}, {0: [(slice(8), slice(4)), (slice(8), slice(4, None))], 1: [(slice(8, None), slice(None, None))]}]
_3d_mappings = [{0: [(slice(4), slice(None, None), slice(None, None))], 1: [(slice(4, None), slice(None, None), slice(None, None, None))]}, {0: [(slice(4), slice(4), slice(None, None)), (slice(4), slice(4, None), slice(None, None))], 1: [(slice(4, None), slice(None, None), slice(None, None, None))]}]
index_map_only_1 = {1: [(slice(None),)]}
...
class TestDistributedArray2Devices(_TestDistributedArray):
    ...
    def test_random_binary_operations(self):
        if False:
            print('Hello World!')
        pytest.skip('TODO')
index_map_dim2 = {0: [(slice(10), slice(10)), (slice(10), slice(6, None))], 1: [(slice(6, None), slice(None, None, 2)), (slice(6, None), slice(1, None, 4)), (slice(6, None), slice(3, None, 4))], 3: [(slice(6, None, 3), slice(None, None, 3))]}
index_map_dim2_2 = {0: [(slice(None, None, 2), slice(None, None, 2))], 2: [(slice(None, None, 2), slice(1, 6, 2)), (slice(None, None, 2), slice(3, 10, 2))], 3: [(slice(None, None, 2), slice(5, None, 2)), slice(1, None, 2)]}
index_map_dim3 = {0: [slice(4)], 1: [(slice(4, None), slice(None, 7))], 2: [(slice(4, None), 7)], 3: [(slice(4, None), slice(None), 1)]}
index_map_dim3_2 = {1: [(slice(1, None, 2), 0), (slice(1, None, 2), slice(1, None), 3)], 2: [(slice(1, None, 2), slice(1, None), slice(None, 3))], 3: [slice(None, None, 2)]}
shape_and_chunks_4_dev = [(shape_dim2, index_map_dim2), (shape_dim3, index_map_dim3)]
