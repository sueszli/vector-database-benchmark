...
def main():
    ...
    response = client.addons.begin_create_or_update(device_name='testedgedevice', role_name='KubernetesRole', addon_name='arcName', resource_group_name='GroupForEdgeAutomation', addon={'kind': 'ArcForKubernetes', 'properties': {'resourceGroupName': 'GroupForEdgeAutomation', 'resourceLocation': 'EastUS', 'resourceName': 'testedgedevice', 'subscriptionId': '4385cf00-2d3a-425a-832f-f4285b1c9dce'}}).result()
    print(response)
