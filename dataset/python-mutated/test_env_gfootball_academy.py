...
cfg_keeper = EasyDict(dict(env_name='academy_3_vs_1_with_keeper', agent_num=3, obs_dim=26))
cfg_counter = EasyDict(dict(env_name='academy_counterattack_hard', agent_num=4, obs_dim=34))
