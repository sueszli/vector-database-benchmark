...
class CS_API:
    ...
    """
    MODEL_ENDPOINTS = {'V1': {'list_speakers': 'https://app.coqui.ai/api/v2/speakers', 'synthesize': 'https://app.coqui.ai/api/v2/samples', 'list_voices': 'https://app.coqui.ai/api/v2/voices'}, 'XTTS': {'list_speakers': 'https://app.coqui.ai/api/v2/speakers', 'synthesize': 'https://app.coqui.ai/api/v2/samples/xtts/render/', 'list_voices': 'https://app.coqui.ai/api/v2/voices/xtts'}}
