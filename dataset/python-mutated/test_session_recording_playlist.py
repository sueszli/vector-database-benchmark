...
from posthog.settings import OBJECT_STORAGE_ENDPOINT, OBJECT_STORAGE_ACCESS_KEY_ID, OBJECT_STORAGE_SECRET_ACCESS_KEY, OBJECT_STORAGE_BUCKET
TEST_BUCKET = 'test_storage_bucket-ee.TestSessionRecordingPlaylist'

@override_settings(OBJECT_STORAGE_SESSION_RECORDING_BLOB_INGESTION_FOLDER=TEST_BUCKET, OBJECT_STORAGE_SESSION_RECORDING_LTS_FOLDER=f'{TEST_BUCKET}_lts')
