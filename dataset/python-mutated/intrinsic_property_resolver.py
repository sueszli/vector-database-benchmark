...
from samcli.lib.intrinsic_resolver.invalid_intrinsic_validation import verify_all_list_intrinsic_type, verify_in_bounds, verify_intrinsic_type_bool, verify_intrinsic_type_dict, verify_intrinsic_type_int, verify_intrinsic_type_list, verify_intrinsic_type_str, verify_non_null, verify_number_arguments
...
class IntrinsicResolver:
    ...
    SUPPORTED_INTRINSIC_FUNCTIONS = [FN_JOIN, FN_SPLIT, FN_SUB, FN_SELECT, FN_BASE64, FN_FIND_IN_MAP, FN_TRANSFORM, FN_GET_AZS, REF, FN_GET_ATT, FN_IMPORT_VALUE]
    FN_AND = 'Fn::And'
    FN_OR = 'Fn::Or'
    FN_IF = 'Fn::If'
    FN_EQUALS = 'Fn::Equals'
