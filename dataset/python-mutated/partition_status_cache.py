...
import pendulum
from dagster import AssetKey, DagsterEventType, DagsterInstance, DagsterRunStatus, EventRecordsFilter, _check as check
from dagster._core.definitions.multi_dimensional_partitions import MultiPartitionKey, MultiPartitionsDefinition
from dagster._core.definitions.partition import DynamicPartitionsDefinition, PartitionsDefinition, PartitionsSubset, StaticPartitionsDefinition
from dagster._core.definitions.time_window_partitions import TimeWindowPartitionsDefinition
from dagster._core.instance import DynamicPartitionsStore
from dagster._core.storage.dagster_run import FINISHED_STATUSES, RunsFilter
from dagster._core.storage.tags import MULTIDIMENSIONAL_PARTITION_PREFIX, get_dimension_from_partition_tag
from dagster._serdes import whitelist_for_serdes
from dagster._serdes.errors import DeserializationError
from dagster._serdes.serdes import deserialize_value
if TYPE_CHECKING:
    from dagster._core.storage.event_log.base import AssetRecord
CACHEABLE_PARTITION_TYPES = (TimeWindowPartitionsDefinition, MultiPartitionsDefinition, StaticPartitionsDefinition, DynamicPartitionsDefinition)
...
class AssetStatusCacheValue(NamedTuple('_AssetPartitionsStatusCacheValue', [('latest_storage_id', int), ('partitions_def_id', Optional[str]), ('serialized_materialized_partition_subset', Optional[str]), ('serialized_failed_partition_subset', Optional[str]), ('serialized_in_progress_partition_subset', Optional[str]), ('earliest_in_progress_materialization_event_id', Optional[int])])):
