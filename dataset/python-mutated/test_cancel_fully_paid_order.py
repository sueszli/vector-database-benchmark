...
@pytest.mark.e2e
def test_cancel_fully_paid_order_CORE_0206(e2e_staff_api_client, e2e_app_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_payments):
    if False:
        while True:
            i = 10
    ...
    create_transaction(e2e_app_api_client, order_id, transaction_name='CreditCard', message='Charged', psp_reference='PSP-ref123', available_actions=['REFUND', 'CANCEL'], amount=order_total)
