...
import proto
__protobuf__ = proto.module(package='google.cloud.orchestration.airflow.service.v1beta1', manifest={'ListImageVersionsRequest', 'ListImageVersionsResponse', 'ImageVersion'})
...
class ListImageVersionsRequest(proto.Message):
    ...
    include_past_releases: bool = proto.Field(proto.BOOL, number=4)
...
class ListImageVersionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    image_versions: MutableSequence['ImageVersion'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ImageVersion')
...
class ImageVersion(proto.Message):
    ...
    """
    image_version_id: str = proto.Field(proto.STRING, number=1)
    is_default: bool = proto.Field(proto.BOOL, number=2)
    supported_python_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    release_date: date_pb2.Date = proto.Field(proto.MESSAGE, number=4, message=date_pb2.Date)
    creation_disabled: bool = proto.Field(proto.BOOL, number=5)
    upgrade_disabled: bool = proto.Field(proto.BOOL, number=6)
