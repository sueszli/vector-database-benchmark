...
@markers.snapshot.skip_snapshot_verify(condition=is_legacy_provider, paths=['$..tracingConfiguration'])
@markers.snapshot.skip_snapshot_verify(condition=is_not_legacy_provider, paths=['$..loggingConfiguration', '$..tracingConfiguration', '$..SdkHttpMetadata', '$..SdkResponseMetadata'])
