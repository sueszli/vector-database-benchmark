...
METADRIVE_DEFAULT_CONFIG = dict(start_seed=0, environment_num=10, decision_repeat=20, block_dist_config=PGBlockDistConfig, map=3, random_lane_width=False, random_lane_num=False, map_config={BaseMap.GENERATE_TYPE: MapGenerateMethod.BIG_BLOCK_NUM, BaseMap.GENERATE_CONFIG: None, BaseMap.LANE_WIDTH: 3.5, BaseMap.LANE_NUM: 3, 'exit_length': 50}, traffic_density=0.1, need_inverse_traffic=False, traffic_mode=TrafficMode.Trigger, random_traffic=False, traffic_vehicle_config=dict(show_navi_mark=False, show_dest_mark=False, enable_reverse=False, show_lidar=False, show_lane_line_detector=False, show_side_detector=False), accident_prob=0.0, use_AI_protector=False, save_level=0.5, is_multi_agent=False, vehicle_config=dict(spawn_lane_index=(FirstPGBlock.NODE_1, FirstPGBlock.NODE_2, 0)), random_spawn_lane_index=True, target_vehicle_configs={DEFAULT_AGENT: dict(use_special_color=True, spawn_lane_index=(FirstPGBlock.NODE_1, FirstPGBlock.NODE_2, 0))}, success_reward=10.0, out_of_road_penalty=5.0, crash_vehicle_penalty=5.0, crash_object_penalty=5.0, driving_reward=1.0, speed_reward=0.1, use_lateral_reward=False, crash_vehicle_cost=1.0, crash_object_cost=1.0, out_of_road_cost=1.0, out_of_route_done=False, on_screen=False, show_bird_view=False)
