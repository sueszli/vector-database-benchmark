...
import proto
__protobuf__ = proto.module(package='google.shopping.merchant.inventories.v1beta', manifest={'RegionalInventory', 'ListRegionalInventoriesRequest', 'ListRegionalInventoriesResponse', 'InsertRegionalInventoryRequest', 'DeleteRegionalInventoryRequest'})
...
class RegionalInventory(proto.Message):
    ...
    region: str = proto.Field(proto.STRING, number=3)
    ...
    custom_attributes: MutableSequence[types.CustomAttribute] = proto.RepeatedField(proto.MESSAGE, number=8, message=types.CustomAttribute)
...
class ListRegionalInventoriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    regional_inventories: MutableSequence['RegionalInventory'] = proto.RepeatedField(proto.MESSAGE, number=1, message='RegionalInventory')
...
class InsertRegionalInventoryRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    regional_inventory: 'RegionalInventory' = proto.Field(proto.MESSAGE, number=2, message='RegionalInventory')
