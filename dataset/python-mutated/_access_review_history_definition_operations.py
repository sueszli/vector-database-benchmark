...
class AccessReviewHistoryDefinitionOperations:
    ...
    def create(self, history_definition_id: str, properties: Union[_models.AccessReviewHistoryDefinitionProperties, IO], **kwargs: Any) -> _models.AccessReviewHistoryDefinition:
        ...
        return deserialized
    create.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}'}
    ...
    delete_by_id.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}'}