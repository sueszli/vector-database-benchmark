...
A = AOp('A')
B = BOp('B')
_tests = [(b, Dagger(Avec)), (Dagger(b), Avec), (k, Avec), (Dagger(k), Dagger(Avec)), (A, Amat), (Dagger(A), Dagger(Amat)), (OuterProduct(k, b), Avec * Avec.H), (TensorProduct(A, B), matrix_tensor_product(Amat, Bmat)), (A ** 2, Amat ** 2), (A * B + 2 * A, Amat * Bmat + 2 * Amat), (Commutator(A, B), Amat * Bmat - Bmat * Amat), (AntiCommutator(A, B), Amat * Bmat + Bmat * Amat), (InnerProduct(b, k), (Avec.H * Avec)[0])]
