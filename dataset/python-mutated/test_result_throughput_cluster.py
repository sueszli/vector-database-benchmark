...
def main():
    ...
    trial_length_s = 100
    max_runtime = 130
    timed_tune_run(name='result throughput cluster', num_samples=num_samples, results_per_second=results_per_second, trial_length_s=trial_length_s, max_runtime=max_runtime)
