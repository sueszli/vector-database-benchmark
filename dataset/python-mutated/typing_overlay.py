...
import abc
from typing import Dict as _Dict, Optional as _Optional, Tuple as _Tuple, Type as _Type
...
_unsupported_members = {'LiteralString': (3, 11), 'Required': (3, 11), 'NotRequired': (3, 11), 'TypeVarTuple': (3, 11), 'Unpack': (3, 11)}
typing_overlay = {'Annotated': (_builder('Annotated', Annotated), (3, 9)), 'Any': (overlay.drop_module(build_any), None), 'Callable': (_builder('Callable', Callable), None), 'Concatenate': (_builder('Concatenate', Concatenate), None), 'final': (FinalDecorator.make, (3, 8)), 'Final': (_builder('Final', Final), (3, 8)), 'ForwardRef': (ForwardRef, None), 'Generic': (_builder('Generic', Generic), None), 'Literal': (_builder('Literal', Literal), (3, 8)), 'Match': (get_re_builder('Match'), None), 'NamedTuple': (named_tuple.NamedTupleClassBuilder, None), 'Never': (overlay.drop_module(build_never), (3, 11)), 'NewType': (overlay.add_name('NewType', NewType.make), None), 'NoReturn': (overlay.drop_module(build_never), None), 'Optional': (_builder('Optional', Optional), None), 'ParamSpec': (ParamSpec.make, (3, 10)), 'Pattern': (get_re_builder('Pattern'), None), 'Self': (_builder_from_name('Self'), (3, 11)), 'Tuple': (_builder('Tuple', Tuple), None), 'TypeGuard': (_builder_from_name('TypeGuard'), (3, 10)), 'TypeVar': (TypeVar.make, None), 'TypedDict': (overlay.drop_module(typed_dict.TypedDictBuilder), (3, 8)), 'Union': (overlay.drop_module(Union), None), 'TYPE_CHECKING': (overlay.drop_module(build_typechecking), None), 'assert_never': (_builder_from_name('assert_never'), (3, 11)), 'assert_type': (overlay.add_name('assert_type', special_builtins.AssertType.make_alias), (3, 11)), 'cast': (overlay.add_name('cast', Cast.make), None), 'clear_overloads': (_builder_from_name('clear_overloads'), (3, 11)), 'dataclass_transform': (overlay.add_name('dataclass_transform', DataclassTransformBuilder.make), (3, 11)), 'get_overloads': (_builder_from_name('get_overloads'), (3, 11)), 'is_typeddict': (overlay.add_name('is_typeddict', typed_dict.IsTypedDict.make), (3, 10)), 'overload': (overlay.add_name('overload', Overload.make), None), 'override': (_builder_from_name('override'), (3, 12)), 'reveal_type': (overlay.add_name('reveal_type', special_builtins.RevealType.make_alias), (3, 11)), **{k: (overlay.add_name(k, overlay_utils.not_supported_yet), v) for (k, v) in _unsupported_members.items()}}