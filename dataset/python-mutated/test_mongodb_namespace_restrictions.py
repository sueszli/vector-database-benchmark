...
import decimal
RECORD_COUNT = {}
coll_name_1 = 'Collection_name_with_120_characters_01234567890123456789012345678901234567890123456789012345678901234567890123'
coll_name_2 = 'Collection_name_with_120_characters_12345678901234567890123456789012345678901234567890123456789012345678901234'
...
class MongoDBNameSpanceRestrictions(unittest.TestCase):
    ...
    def expected_check_streams(self):
        if False:
            return 10
        return {f'simple_db-{coll_name_1}', f'simple_db-{coll_name_2}'}

    def expected_pks(self):
        if False:
            while True:
                i = 10
        return {coll_name_1: {'_id'}, coll_name_2: {'_id'}}

    def expected_row_counts(self):
        if False:
            while True:
                i = 10
        return {coll_name_1: 50, coll_name_2: 100}
