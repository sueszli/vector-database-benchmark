...
class TestClientResponseError:
    request_info: Any = client.RequestInfo(url='http://example.com', method='GET', headers={}, real_url='http://example.com')
...
class TestClientConnectorError:
    connection_key: Any = client_reqrep.ConnectionKey(host='example.com', port=8080, is_ssl=False, ssl=None, proxy=None, proxy_auth=None, proxy_headers_hash=None)
