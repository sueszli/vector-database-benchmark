...
OLD_CLASS_NAMES = ['AngularAxis', 'Annotation', 'Annotations', 'Bar', 'Box', 'ColorBar', 'Contour', 'Contours', 'Data', 'ErrorX', 'ErrorY', 'ErrorZ', 'Figure', 'Font', 'Frame', 'Frames', 'Heatmap', 'Histogram', 'Histogram2d', 'Histogram2dContour', 'Layout', 'Legend', 'Line', 'Margin', 'Marker', 'RadialAxis', 'Scatter', 'Scatter3d', 'Scene', 'Stream', 'Surface', 'Trace', 'XAxis', 'XBins', 'YAxis', 'YBins', 'ZAxis']
