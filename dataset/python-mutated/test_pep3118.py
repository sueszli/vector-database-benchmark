...
native_types = [(c_char, '<c', (), c_char), (c_byte, '<b', (), c_byte), (c_ubyte, '<B', (), c_ubyte), (c_short, '<' + s_short, (), c_short), (c_ushort, '<' + s_ushort, (), c_ushort), (c_int, '<' + s_int, (), c_int), (c_uint, '<' + s_uint, (), c_uint), (c_long, '<' + s_long, (), c_long), (c_ulong, '<' + s_ulong, (), c_ulong), (c_longlong, '<' + s_longlong, (), c_longlong), (c_ulonglong, '<' + s_ulonglong, (), c_ulonglong), (c_float, '<f', (), c_float), (c_double, '<d', (), c_double), (c_longdouble, '<' + s_longdouble, (), c_longdouble), (c_bool, '<' + s_bool, (), c_bool), (py_object, '<O', (), py_object), (POINTER(c_byte), '&<b', (), POINTER(c_byte)), (POINTER(POINTER(c_long)), '&&<' + s_long, (), POINTER(POINTER(c_long))), (c_double * 4, '<d', (4,), c_double), (c_float * 4 * 3 * 2, '<f', (2, 3, 4), c_float), (POINTER(c_short) * 2, '&<' + s_short, (2,), POINTER(c_short)), (POINTER(c_short) * 2 * 3, '&<' + s_short, (3, 2), POINTER(c_short)), (POINTER(c_short * 2), '&(2)<' + s_short, (), POINTER(c_short)), (Point, 'T{<l:x:<l:y:}'.replace('l', s_long), (), Point), (PackedPoint, 'B', (), PackedPoint), (Point2, 'T{<l:x:<l:y:}'.replace('l', s_long), (), Point2), (EmptyStruct, 'T{}', (), EmptyStruct), (aUnion, 'B', (), aUnion), (StructWithArrays, 'T{(2,3)<l:x:(4)T{<l:x:<l:y:}:y:}'.replace('l', s_long), (), StructWithArrays), (StructWithArrays * 3, 'T{(2,3)<l:x:(4)T{<l:x:<l:y:}:y:}'.replace('l', s_long), (3,), StructWithArrays), (Incomplete, 'B', (), Incomplete), (POINTER(Incomplete), '&B', (), POINTER(Incomplete)), (Complete, 'T{<l:a:}'.replace('l', s_long), (), Complete), (POINTER(Complete), '&B', (), POINTER(Complete)), (CFUNCTYPE(None), 'X{}', (), CFUNCTYPE(None))]
...
class LEPoint(LittleEndianStructure):
    _fields_ = [('x', c_long), ('y', c_long)]
endian_types = [(BEPoint, 'T{>l:x:>l:y:}'.replace('l', s_long), (), BEPoint), (LEPoint, 'T{<l:x:<l:y:}'.replace('l', s_long), (), LEPoint), (POINTER(BEPoint), '&T{>l:x:>l:y:}'.replace('l', s_long), (), POINTER(BEPoint)), (POINTER(LEPoint), '&T{<l:x:<l:y:}'.replace('l', s_long), (), POINTER(LEPoint))]
