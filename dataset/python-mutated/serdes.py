...
from typing import AbstractSet, Any, Callable, Dict, FrozenSet, Generic, List, Mapping, NamedTuple, Optional, Sequence, Set, Tuple, Type, Union, cast, overload
...
JsonSerializableValue: TypeAlias = Union[Sequence['JsonSerializableValue'], Mapping[str, 'JsonSerializableValue'], str, int, float, bool, None]
PackableValue: TypeAlias = Union[Sequence['PackableValue'], Mapping[str, 'PackableValue'], str, int, float, bool, None, NamedTuple, Set['PackableValue'], FrozenSet['PackableValue'], Enum]
UnpackedValue: TypeAlias = Union[Sequence['UnpackedValue'], Mapping[str, 'UnpackedValue'], str, int, float, bool, None, NamedTuple, Set['PackableValue'], FrozenSet['PackableValue'], Enum, 'UnknownSerdesValue']
