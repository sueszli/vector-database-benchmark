...
class AutodetectorTests(BaseAutodetectorTests):
    ...
    author_name_db_default = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, db_default='Ada Lovelace'))])
    author_name_check_constraint = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200))], {'constraints': [models.CheckConstraint(check=models.Q(name__contains='Bob'), name='name_contains_bob')]})
    author_dates_of_birth_auto_now = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('date_of_birth', models.DateField(auto_now=True)), ('date_time_of_birth', models.DateTimeField(auto_now=True)), ('time_of_birth', models.TimeField(auto_now=True))])
    author_dates_of_birth_auto_now_add = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('date_of_birth', models.DateField(auto_now_add=True)), ('date_time_of_birth', models.DateTimeField(auto_now_add=True)), ('time_of_birth', models.TimeField(auto_now_add=True))])
    author_name_deconstructible_1 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject()))])
    author_name_deconstructible_2 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject()))])
    author_name_deconstructible_3 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=models.IntegerField()))])
    author_name_deconstructible_4 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=models.IntegerField()))])
    author_name_deconstructible_list_1 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=[DeconstructibleObject(), 123]))])
    author_name_deconstructible_list_2 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=[DeconstructibleObject(), 123]))])
    author_name_deconstructible_list_3 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=[DeconstructibleObject(), 999]))])
    author_name_deconstructible_tuple_1 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=(DeconstructibleObject(), 123)))])
    author_name_deconstructible_tuple_2 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=(DeconstructibleObject(), 123)))])
    author_name_deconstructible_tuple_3 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=(DeconstructibleObject(), 999)))])
    author_name_deconstructible_dict_1 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default={'item': DeconstructibleObject(), 'otheritem': 123}))])
    author_name_deconstructible_dict_2 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default={'item': DeconstructibleObject(), 'otheritem': 123}))])
    author_name_deconstructible_dict_3 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default={'item': DeconstructibleObject(), 'otheritem': 999}))])
    author_name_nested_deconstructible_1 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2')), a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c')))))])
    author_name_nested_deconstructible_2 = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2')), a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c')))))])
    author_name_nested_deconstructible_changed_arg = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2-changed')), a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c')))))])
    author_name_nested_deconstructible_extra_arg = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2')), None, a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c')))))])
    author_name_nested_deconstructible_changed_kwarg = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2')), a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c-changed')))))])
    author_name_nested_deconstructible_extra_kwarg = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200, default=DeconstructibleObject(DeconstructibleObject(1), (DeconstructibleObject('t1'), DeconstructibleObject('t2')), a=DeconstructibleObject('A'), b=DeconstructibleObject(B=DeconstructibleObject('c')), c=None)))])
    author_custom_pk = ModelState('testapp', 'Author', [('pk_field', models.IntegerField(primary_key=True))])
    author_with_biography_non_blank = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField()), ('biography', models.TextField())])
    author_with_biography_blank = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(blank=True)), ('biography', models.TextField(blank=True))])
    author_with_book = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('book', models.ForeignKey('otherapp.Book', models.CASCADE))])
    author_with_book_order_wrt = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('book', models.ForeignKey('otherapp.Book', models.CASCADE))], options={'order_with_respect_to': 'book'})
    author_renamed_with_book = ModelState('testapp', 'Writer', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('book', models.ForeignKey('otherapp.Book', models.CASCADE))])
    ...
    author_with_publisher = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('publisher', models.ForeignKey('testapp.Publisher', models.CASCADE))])
    author_with_user = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('user', models.ForeignKey('auth.User', models.CASCADE))])
    author_with_custom_user = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=200)), ('user', models.ForeignKey('thirdapp.CustomUser', models.CASCADE))])
    ...
    author_unmanaged_custom_pk = ModelState('testapp', 'Author', [('pk_field', models.IntegerField(primary_key=True))])
    author_with_m2m = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('publishers', models.ManyToManyField('testapp.Publisher'))])
    author_with_m2m_blank = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('publishers', models.ManyToManyField('testapp.Publisher', blank=True))])
    ...
    author_with_renamed_m2m_through = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('publishers', models.ManyToManyField('testapp.Publisher', through='testapp.Deal'))])
    author_with_former_m2m = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True)), ('publishers', models.CharField(max_length=100))])
    author_with_options = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True))], {'permissions': [('can_hire', 'Can hire')], 'verbose_name': 'Authi'})
    author_with_db_table_comment = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True))], {'db_table_comment': 'Table comment'})
    author_with_db_table_options = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True))], {'db_table': 'author_one'})
    author_with_new_db_table_options = ModelState('testapp', 'Author', [('id', models.AutoField(primary_key=True))], {'db_table': 'author_two'})
    author_renamed_with_db_table_options = ModelState('testapp', 'NewAuthor', [('id', models.AutoField(primary_key=True))], {'db_table': 'author_one'})
    author_renamed_with_new_db_table_options = ModelState('testapp', 'NewAuthor', [('id', models.AutoField(primary_key=True))], {'db_table': 'author_three'})
    contract = ModelState('testapp', 'Contract', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('publisher', models.ForeignKey('testapp.Publisher', models.CASCADE))])
    contract_renamed = ModelState('testapp', 'Deal', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('publisher', models.ForeignKey('testapp.Publisher', models.CASCADE))])
    publisher = ModelState('testapp', 'Publisher', [('id', models.AutoField(primary_key=True)), ('name', models.CharField(max_length=100))])
    publisher_with_author = ModelState('testapp', 'Publisher', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('name', models.CharField(max_length=100))])
    publisher_with_aardvark_author = ModelState('testapp', 'Publisher', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Aardvark', models.CASCADE)), ('name', models.CharField(max_length=100))])
    publisher_with_book = ModelState('testapp', 'Publisher', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('otherapp.Book', models.CASCADE)), ('name', models.CharField(max_length=100))])
    other_pony = ModelState('otherapp', 'Pony', [('id', models.AutoField(primary_key=True))])
    other_pony_food = ModelState('otherapp', 'Pony', [('id', models.AutoField(primary_key=True))], managers=[('food_qs', FoodQuerySet.as_manager()), ('food_mgr', FoodManager('a', 'b')), ('food_mgr_kwargs', FoodManager('x', 'y', 3, 4))])
    other_stable = ModelState('otherapp', 'Stable', [('id', models.AutoField(primary_key=True))])
    third_thing = ModelState('thirdapp', 'Thing', [('id', models.AutoField(primary_key=True))])
    book = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))])
    book_proxy_fk = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('thirdapp.AuthorProxy', models.CASCADE)), ('title', models.CharField(max_length=200))])
    book_proxy_proxy_fk = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.AAuthorProxyProxy', models.CASCADE))])
    book_migrations_fk = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('migrations.UnmigratedModel', models.CASCADE)), ('title', models.CharField(max_length=200))])
    book_with_no_author_fk = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.IntegerField()), ('title', models.CharField(max_length=200))])
    book_with_no_author = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('title', models.CharField(max_length=200))])
    book_with_author_renamed = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Writer', models.CASCADE)), ('title', models.CharField(max_length=200))])
    book_with_field_and_author_renamed = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('writer', models.ForeignKey('testapp.Writer', models.CASCADE)), ('title', models.CharField(max_length=200))])
    ...
    book_indexes = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'indexes': [models.Index(fields=['author', 'title'], name='book_title_author_idx')]})
    book_unordered_indexes = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'indexes': [models.Index(fields=['title', 'author'], name='book_author_title_idx')]})
    book_unique_together = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'unique_together': {('author', 'title')}})
    book_unique_together_2 = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'unique_together': {('title', 'author')}})
    book_unique_together_3 = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('newfield', models.IntegerField()), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'unique_together': {('title', 'newfield')}})
    book_unique_together_4 = ModelState('otherapp', 'Book', [('id', models.AutoField(primary_key=True)), ('newfield2', models.IntegerField()), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('title', models.CharField(max_length=200))], {'unique_together': {('title', 'newfield2')}})
    attribution = ModelState('otherapp', 'Attribution', [('id', models.AutoField(primary_key=True)), ('author', models.ForeignKey('testapp.Author', models.CASCADE)), ('book', models.ForeignKey('otherapp.Book', models.CASCADE))])
    edition = ModelState('thirdapp', 'Edition', [('id', models.AutoField(primary_key=True)), ('book', models.ForeignKey('otherapp.Book', models.CASCADE))])
    ...
    aardvark_pk_fk_author = ModelState('testapp', 'Aardvark', [('id', models.OneToOneField('testapp.Author', models.CASCADE, primary_key=True))])
    knight = ModelState('eggs', 'Knight', [('id', models.AutoField(primary_key=True))])
    rabbit = ModelState('eggs', 'Rabbit', [('id', models.AutoField(primary_key=True)), ('knight', models.ForeignKey('eggs.Knight', models.CASCADE)), ('parent', models.ForeignKey('eggs.Rabbit', models.CASCADE))], {'unique_together': {('parent', 'knight')}, 'indexes': [models.Index(fields=['parent', 'knight'], name='rabbit_circular_fk_index')]})
