...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_hidden_layers', type=int, default=1, help='Number of epochs to train for.')
    ...
    if not torch.cuda.is_available():
        ...
        train_linear(num_workers=1, num_hidden_layers=args.num_hidden_layers, use_auto_transfer=True, epochs=args.epochs)
    torch.cuda.empty_cache()
    train_linear(num_workers=1, num_hidden_layers=args.num_hidden_layers, use_auto_transfer=False, epochs=args.epochs)
    ray.shutdown()