...
class CreateAnnotationRequest(proto.Message):
    ...
    annotation: api_entities.Annotation = proto.Field(proto.MESSAGE, number=2, message=api_entities.Annotation)
...
class CreateCollectorRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    collector_id: str = proto.Field(proto.STRING, number=2)
    collector: api_entities.Collector = proto.Field(proto.MESSAGE, number=3, message=api_entities.Collector)
    request_id: str = proto.Field(proto.STRING, number=4)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    collectors: MutableSequence[api_entities.Collector] = proto.RepeatedField(proto.MESSAGE, number=1, message=api_entities.Collector)
...
class UpdateCollectorRequest(proto.Message):
    ...
    collector: api_entities.Collector = proto.Field(proto.MESSAGE, number=2, message=api_entities.Collector)
