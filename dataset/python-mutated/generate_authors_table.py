...
if __name__ == '__main__':
    (core_devs, emeritus, contributor_experience_team, emeritus_contributor_experience_team, comm_team, emeritus_comm_team, documentation_team) = get_contributors()
    ...
    with open(REPO_FOLDER / 'doc' / 'contributor_experience_team_emeritus.rst', 'w+', encoding='utf-8') as rst_file:
