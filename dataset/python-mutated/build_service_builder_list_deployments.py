...
def main():
    ...
    response = client.build_service_builder.list_deployments(resource_group_name='myResourceGroup', service_name='myservice', build_service_name='default', builder_name='default')
    print(response)
