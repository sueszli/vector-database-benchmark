...
TEST_OAS30_BASE_PATH_SERVER_VAR_FILE_YAML = os.path.join(PARENT_DIR, '../../files/openapi-basepath-server-variable.yaml')
TEST_OAS30_BASE_PATH_SERVER_URL_FILE_YAML = os.path.join(PARENT_DIR, '../../files/openapi-basepath-url.yaml')
TEST_IMPORT_REST_API_FILE = os.path.join(PARENT_DIR, '../../files/pets.json')
TEST_IMPORT_OPEN_API_GLOBAL_API_KEY_AUTHORIZER = os.path.join(PARENT_DIR, '../../files/openapi.spec.global-auth.json')
OAS_30_CIRCULAR_REF = os.path.join(PARENT_DIR, '../../files/openapi.spec.circular-ref.json')
OAS_30_CIRCULAR_REF_WITH_REQUEST_BODY = os.path.join(PARENT_DIR, '../../files/openapi.spec.circular-ref-with-request-body.json')
