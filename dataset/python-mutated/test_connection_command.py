...
class TestCliListConnections:
    parser = cli_parser.get_parser()
    EXPECTED_CONS = [('airflow_db', 'mysql'), ('google_cloud_default', 'google_cloud_platform'), ('http_default', 'http'), ('local_mysql', 'mysql'), ('mongo_default', 'mongo'), ('mssql_default', 'mssql'), ('mysql_default', 'mysql'), ('pinot_broker_default', 'pinot'), ('postgres_default', 'postgres'), ('presto_default', 'presto'), ('sqlite_default', 'sqlite'), ('trino_default', 'trino'), ('vertica_default', 'vertica')]
...
TEST_JSON = json.dumps({'conn_type': 'postgres', 'login': 'airflow', 'password': 'airflow', 'host': 'host', 'port': 5432, 'schema': 'airflow', 'description': 'new0-json description'})
