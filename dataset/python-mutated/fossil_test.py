...
test_cases = {'EXTRA      new-file': RepoStats(new=1), 'EDITED     modified-file': RepoStats(changed=1), 'CONFLICT   conflicted-file': RepoStats(conflicted=1), 'ADDED      added-file': RepoStats(staged=1)}
