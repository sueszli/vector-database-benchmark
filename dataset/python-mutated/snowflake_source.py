...
snowflake_type_code_map = {0: 'NUMBER', 1: 'DOUBLE', 2: 'VARCHAR', 3: 'DATE', 4: 'TIMESTAMP', 6: 'TIMESTAMP_LTZ', 7: 'TIMESTAMP_TZ', 8: 'TIMESTAMP_NTZ', 11: 'BINARY', 13: 'BOOLEAN'}
snowflake_unsupported_map = {5: 'VARIANT -- Try converting to VARCHAR', 9: 'OBJECT -- Try converting to VARCHAR', 10: 'ARRAY -- Try converting to VARCHAR', 12: 'TIME -- Try converting to VARCHAR'}
python_int_to_snowflake_type_map = {'int64': 'NUMBER64', 'int32': 'NUMBER32', 'int16': 'NUMBER32', 'int8': 'NUMBER32'}
