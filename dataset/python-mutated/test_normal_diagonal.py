...
def test_initialization_int():
    ...
    for func in funcs:
        y = func(x)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'means', 0.0, False, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'means', 0.3, False, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'means', 1.0, True, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'means', 1.0, False, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'covs', 0.0, False, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'covs', 0.3, False, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'covs', 1.0, True, torch.int64)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'covs', 1.0, False, torch.int64)
    x = numpy.array(x, dtype=numpy.int32)
    for func in funcs[2:]:
        y = func(x)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'means', 0.0, False, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'means', 0.3, False, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'means', 1.0, True, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'means', 1.0, False, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'covs', 0.0, False, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'covs', 0.3, False, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'covs', 1.0, True, torch.int32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'covs', 1.0, False, torch.int32)
...
def test_initialization_float():
    ...
    for func in funcs:
        y = func(x)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'means', 0.0, False, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'means', 0.3, False, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'means', 1.0, True, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'means', 1.0, False, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'covs', 0.0, False, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'covs', 0.3, False, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'covs', 1.0, True, torch.float32)
        _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'covs', 1.0, False, torch.float32)
    y = numpy.array(x, dtype=numpy.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'means', 0.0, False, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'means', 0.3, False, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'means', 1.0, True, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'means', 1.0, False, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.0, frozen=False), y, 'covs', 0.0, False, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=0.3, frozen=False), y, 'covs', 0.3, False, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=True), y, 'covs', 1.0, True, torch.float64)
    _test_initialization(Normal(y, y, covariance_type='diag', inertia=1.0, frozen=False), y, 'covs', 1.0, False, torch.float64)
...
def test_sample(means, covs):
    ...
    assert_array_almost_equal(X, [[1.3705, -1.562, 0.4217], [1.321, 4.3979, 1.2369], [1.079, -0.0496, 2.3184], [0.943, 5.2119, 0.8146], [1.2368, 0.0444, 2.5477]], 3)
...
def test_probability(X, means, covs):
    ...
    d2 = Normal(numpy.array(m, dtype=numpy.float64), numpy.array(c, dtype=numpy.float64), covariance_type='diag')
    ...
    d2 = Normal(numpy.array(means, dtype=numpy.float64), numpy.array(covs, dtype=numpy.float64), covariance_type='diag')
    _test_predictions(x, y, d1.probability(x), torch.float32)
    _test_predictions(x, y, d2.probability(x), torch.float64)
    (m, c) = ([1, 2, 4], [2, 1, 3])
    ...
    d1 = Normal(m, c, covariance_type='diag')
    d2 = Normal(numpy.array(m, dtype=numpy.int32), numpy.array(c, dtype=numpy.int32), covariance_type='diag')
    _test_predictions(x, y, d1.probability(x), torch.float32)
    ...
    _test_predictions(x, y, d1.probability(x), torch.float32)
    _test_predictions(x, y, d2.probability(x), torch.float64)
    y = [0.02004972, 0.01346142, 0.05173831, 0.0001438069, 4.410233e-06, 2.273481e-15, 0.002059388]
    d1 = Normal(means, covs, covariance_type='diag')
    d2 = Normal(numpy.array(means, dtype=numpy.float64), numpy.array(covs, dtype=numpy.float64), covariance_type='diag')
    _test_predictions(X, y, d1.probability(X), torch.float32)
    _test_predictions(X, y, d2.probability(X), torch.float64)
...
def test_probability_raises(X, means, covs):
    if False:
        i = 10
        return i + 15
    _test_raises(Normal(means, covs, covariance_type='diag'), 'probability', X, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal([VALID_VALUE], [VALID_VALUE], covariance_type='diag'), 'probability', X, min_value=MIN_VALUE, max_value=MAX_VALUE)
...
def test_log_probability(X, means, covs):
    ...
    d2 = Normal(numpy.array(p, dtype=numpy.float64), numpy.array(p, dtype=numpy.float64), covariance_type='diag')
    ...
    x_torch = torch.tensor(numpy.array(X))
    y = [-3.90954, -4.307928, -2.961557, -8.84704, -12.331584, -33.717472, -6.185347]
    d2 = Normal(numpy.array(means, dtype=numpy.float64), numpy.array(covs, dtype=numpy.float64), covariance_type='diag')
...
def test_log_probability_raises(X, means, covs):
    if False:
        print('Hello World!')
    _test_raises(Normal(means, covs, covariance_type='diag'), 'log_probability', X, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal([VALID_VALUE], [VALID_VALUE], covariance_type='diag'), 'log_probability', X, min_value=MIN_VALUE, max_value=MAX_VALUE)
...
def test_summarize_raises(X, w, means, covs):
    if False:
        for i in range(10):
            print('nop')
    _test_raises(Normal(means, covs, covariance_type='diag'), 'summarize', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal(covariance_type='diag'), 'summarize', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal([VALID_VALUE], [VALID_VALUE], covariance_type='diag'), 'summarize', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
...
def test_fit_raises(X, w, means):
    if False:
        return 10
    _test_raises(Normal(means, covariance_type='diag'), 'fit', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal(covariance_type='diag'), 'fit', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
    _test_raises(Normal([VALID_VALUE], covariance_type='diag'), 'fit', X, w=w, min_value=MIN_VALUE, max_value=MAX_VALUE)
...
def test_masked_probability(means, covs, X, X_masked):
    ...
    y = [0.02798962, 0.04825954, 1.0, 0.0001438069, 0.2043614, 2.27348e-15, 0.009462826]
...
def test_masked_log_probability(means, covs, X, X_masked):
    if False:
        while True:
            i = 10
    X = torch.tensor(numpy.array(X))
    y = [-3.90954, -4.307928, -2.961557, -8.847039, -12.331583, -33.717464, -6.185347]
    d = Normal(means, covs, covariance_type='diag')
    mask = torch.ones_like(X).type(torch.bool)
    X_ = torch.masked.MaskedTensor(X, mask=mask)
    assert_array_almost_equal(y, d.log_probability(X_)._masked_data)
    y = [-3.575922, -3.031162, 0.0, -8.847039, -1.587865, -33.717464, -4.660384]
