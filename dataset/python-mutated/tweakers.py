...
from ..utils import int_or_none, determine_ext, mimetype2ext

class TweakersIE(InfoExtractor):
    _VALID_URL = 'https?://tweakers\\.net/video/(?P<id>\\d+)'
    _TEST = {'url': 'https://tweakers.net/video/9926/new-nintendo-3ds-xl-op-alle-fronten-beter.html', 'md5': 'fe73e417c093a788e0160c4025f88b15', 'info_dict': {'id': '9926', 'ext': 'mp4', 'title': 'New Nintendo 3DS XL - Op alle fronten beter', 'description': 'md5:3789b21fed9c0219e9bcaacd43fab280', 'thumbnail': 're:^https?://.*\\.jpe?g$', 'duration': 386, 'uploader_id': 's7JeEm'}}
