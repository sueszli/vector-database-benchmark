...
class OrderedList(List):
    ...
    def _get_bullet_layout_element(self, item_index: int, item: LayoutElement) -> LayoutElement:
        ...
        try:
            ...
            pass
        return ChunkOfText(text=str(item_index + 1) + '.', font_size=font_size or Decimal(12), padding_right=Decimal(12), font_color=font_color or HexColor('000000'), horizontal_alignment=Alignment.RIGHT)