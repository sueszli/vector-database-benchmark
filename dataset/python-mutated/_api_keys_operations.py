...
from ...operations._api_keys_operations import build_create_request, build_delete_request, build_get_request, build_list_request
T = TypeVar('T')
...
class APIKeysOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> AsyncIterable['_models.ApplicationInsightsComponentAPIKey']:
        if False:
            for i in range(10):
                print('nop')
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, api_key_properties: _models.APIKeyRequest, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentAPIKey:
    ...
    @overload
    async def create(self, resource_group_name: str, resource_name: str, api_key_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentAPIKey:
        """Create an API Key of an Application Insights component.
    ...
    async def create(self, resource_group_name: str, resource_name: str, api_key_properties: Union[_models.APIKeyRequest, IO], **kwargs: Any) -> _models.ApplicationInsightsComponentAPIKey:
        """Create an API Key of an Application Insights component.
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, resource_name: str, key_id: str, **kwargs: Any) -> _models.ApplicationInsightsComponentAPIKey:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[_models.ApplicationInsightsComponentAPIKey] = kwargs.pop('cls', None)
        request = build_delete_request(resource_group_name=resource_group_name, resource_name=resource_name, key_id=key_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, key_id: str, **kwargs: Any) -> _models.ApplicationInsightsComponentAPIKey:
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2015-05-01'))
        cls: ClsType[_models.ApplicationInsightsComponentAPIKey] = kwargs.pop('cls', None)
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, key_id=key_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
