...
if __name__ == '__main__':
    ...
    parser.add_argument('--develop_logs_dir', type=str, required=True, help='Specify the benchmark result directory of develop branch.')
    parser.add_argument('--pr_logs_dir', type=str, required=True, help='Specify the benchmark result directory of PR branch.')
    parser.add_argument('--api_info_file', type=str, required=False, help='Specify the api info to run benchmark test.')
