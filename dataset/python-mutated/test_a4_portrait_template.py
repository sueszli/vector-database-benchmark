...
class TestA4PortraitTemplate(TestCase):
    ...
    def test_add_barchart(self):
        if False:
            print('Hello World!')
        A4PortraitTemplate().add_barchart(xs=[10, 20, 30, 40], labels=['lorem', 'ipsum', 'dolor', 'sit'], y_label='word frequency').save(self.get_first_output_file())
    ...
    def test_add_h1(self):
        if False:
            while True:
                i = 10
        random.seed(0)
        A4PortraitTemplate().add_h1(Lipsum.generate_lipsum_text(1)).save(self.get_second_output_file())
    ...
    def test_add_h2(self):
        if False:
            ...
            return i + 15
        random.seed(0)
        A4PortraitTemplate().add_h2(Lipsum.generate_lipsum_text(1)).save(self.get_third_output_file())
    ...
    def test_add_h3(self):
        if False:
            for i in range(10):
                print('nop')
        random.seed(0)
        A4PortraitTemplate().add_h3(Lipsum.generate_lipsum_text(1)).save(self.get_fourth_output_file())
    ...
    def test_add_h4(self):
        if False:
            print('Hello World!')
        random.seed(0)
        A4PortraitTemplate().add_h4(Lipsum.generate_lipsum_text(1)).save(self.get_fifth_output_file())
    ...
    def test_add_h5(self):
        if False:
            ...
            return i + 15
        random.seed(0)
        A4PortraitTemplate().add_h5(Lipsum.generate_lipsum_text(1)).save(self.get_sixth_output_file())
    ...
    def test_add_h6(self):
        if False:
            print('Hello World!')
        random.seed(0)
        A4PortraitTemplate().add_h6(Lipsum.generate_lipsum_text(1)).save(self.get_seventh_output_file())
    ...
    def test_add_image(self):
        if False:
            i = 10
            return i + 15
        A4PortraitTemplate().add_image('https://images.unsplash.com/photo-1497436072909-60f360e1d4b1').save(self.get_eight_output_file())
    ...
    def test_linechart(self):
        if False:
            while True:
                i = 10
        A4PortraitTemplate().add_linechart(xs=[[i for i in range(0, 360)]], ys=[[math.sin(math.radians(i)) for i in range(0, 360)]], labels=['sin(x)'], x_label='x', y_label='y').save(self.get_nineth_output_file())
    ...
    def test_add_map_of_europe(self):
        if False:
            return 10
        A4PortraitTemplate().add_map_of_europe(marked_countries=['Poland']).save(self.get_tenth_output_file())
    ...
    def test_add_map_of_the_contiguous_united_states(self):
        if False:
            return 10
        A4PortraitTemplate().add_map_of_the_contiguous_united_states(marked_states=['Texas']).save(self.get_eleventh_output_file())
    ...
    def test_add_map_of_the_united_states(self):
        if False:
            for i in range(10):
                print('nop')
        A4PortraitTemplate().add_map_of_the_united_states(marked_states=['Texas']).save(self.get_twelfth_output_file())
    ...
    def test_add_map_of_the_world(self):
        if False:
            print('Hello World!')
        A4PortraitTemplate().add_map_of_the_world(marked_countries=['Spain']).save(self.get_thirteenth_output_file())
    ...
    def test_add_ordered_list(self):
        if False:
            print('Hello World!')
        random.seed(0)
        A4PortraitTemplate().add_ordered_list([Lipsum.generate_lipsum_text(1), Lipsum.generate_lipsum_text(2), Lipsum.generate_lipsum_text(1), Lipsum.generate_lipsum_text(2), Lipsum.generate_lipsum_text(1)]).save(self.get_fourteenth_output_file())
    ...
    def test_add_piechart(self):
        if False:
            i = 10
            return i + 15
        A4PortraitTemplate().add_piechart(xs=[10, 20, 30, 40], labels=['lorem', 'ipsum', 'dolor', 'sit']).save(self.get_sixteenth_output_file())
    ...
    def test_add_qr_code(self):
        if False:
            while True:
                i = 10
        A4PortraitTemplate().add_qr_code('https://www.borbpdf.com/').save(self.get_seventeenth_output_file())
    ...
    def test_add_quote(self):
        if False:
            while True:
                i = 10
        A4PortraitTemplate().add_quote(quote_author='Robert Frost', quote_text='Two roads diverged in a wood, and I, I took the one less travelled by, and that has made all the difference.').save(self.get_eighteenth_output_file())
    ...
    def test_add_table(self):
        if False:
            print('Hello World!')
        A4PortraitTemplate().add_table(tabular_data=[['', 'Lorem', 'Ipsum', 'Dolor'], [2001, 0, 1, 20], [2002, 1, 34, 34]]).save(self.get_nineteenth_output_file())
    ...
    def test_add_text(self):
        if False:
            while True:
                i = 10
        random.seed(0)
        A4PortraitTemplate().add_text(Lipsum.generate_lipsum_text(3)).add_text(Lipsum.generate_lipsum_text(3)).save(self.get_twentieth_output_file())
    ...
    def test_add_unordered_list(self):
        if False:
            for i in range(10):
                print('nop')
        random.seed(0)
        A4PortraitTemplate().add_ordered_list([Lipsum.generate_lipsum_text(1), Lipsum.generate_lipsum_text(2), Lipsum.generate_lipsum_text(1), Lipsum.generate_lipsum_text(2), Lipsum.generate_lipsum_text(1)]).save(self.get_umpteenth_output_file(21))
