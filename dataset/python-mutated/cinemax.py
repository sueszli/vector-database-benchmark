...
class CinemaxIE(HBOBaseIE):
    ...
    _TESTS = [{'url': 'https://www.cinemax.com/warrior/video/s1-ep-1-recap-20126903', 'md5': '82e0734bba8aa7ef526c9dd00cf35a05', 'info_dict': {'id': '20126903', 'ext': 'mp4', 'title': 'S1 Ep 1: Recap'}, 'expected_warnings': ['Unknown MIME type application/mp4 in DASH manifest']}, {'url': 'https://www.cinemax.com/warrior/video/s1-ep-1-recap-20126903.embed', 'only_matching': True}]
