...
class Exploit(HTTPClient):
    __info__ = {'name': 'D-Link DGS-1510 Add User', 'description': 'D-Link DGS-1510-28XMP, DGS-1510-28X, DGS-1510-52X, DGS-1510-52, DGS-1510-28P, DGS-1510-28 and DGS-1510-20 Websmart devices with firmware before 1.31.B003 allow attackers to conduct Unauthenticated Information Disclosure attacks via unspecified vectors.', 'authors': ('Varang Amin', 'Dino Causevic'), 'references': ('https://www.exploit-db.com/exploits/41662/',), 'devices': ('D-Link DGS-1510-28XMP', 'D-Link DGS-1510-28X', 'D-Link DGS-1510-52X', 'D-Link DGS-1510-52', 'D-Link DGS-1510-28P', 'D-Link DGS-1510-28', 'D-Link DGS-1510-20')}
