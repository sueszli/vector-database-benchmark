...
class lifesciencesCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'run_pipeline': ('pipeline', 'parent', 'labels', 'pub_sub_topic')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=lifesciencesCallTransformer()):
    if False:
        for i in range(10):
            print('nop')
