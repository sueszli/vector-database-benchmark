...
def main():
    ...
    response = client.operations.get(region_id='westus2', referer='https://management.azure.com/', operation_id='d030bb3f-7d53-11e9-8e09-9a86872085ff')
    print(response)
