...
def main():
    ...
    response = client.build_service_builder.get(resource_group_name='myResourceGroup', service_name='myservice', build_service_name='default', builder_name='mybuilder')
    print(response)
