...
from trashcli.put.jobs import JobStatus, NeedsMoreAttempts, Succeeded, JobExecutor
from trashcli.put.my_logger import LogData, MyLogger
from trashcli.put.suffix import Suffix

class TrashinfoData(NamedTuple('TrashinfoData', [('basename', str), ('content', str), ('info_dir_path', str)])):
    pass

class TrashedFile(NamedTuple('TrashedFile', [('trashinfo_path', str)])):
