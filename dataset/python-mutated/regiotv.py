...
class RegioTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.regio-tv.de/video/395808.html', 'info_dict': {'id': '395808', 'ext': 'mp4', 'title': 'Wir in Ludwigsburg', 'description': 'Mit unseren zuckersüßen Adventskindern, außerdem besuchen wir die Abendsterne!'}}, {'url': 'http://www.regio-tv.de/video/395808', 'only_matching': True}]
