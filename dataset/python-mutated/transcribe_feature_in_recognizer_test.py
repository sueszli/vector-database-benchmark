...
def test_transcribe_feature_in_recognizer(capsys: pytest.CaptureFixture, request: pytest.FixtureRequest) -> None:
    if False:
        while True:
            i = 10
    ...
    response = transcribe_feature_in_recognizer.transcribe_feature_in_recognizer(project_id, recognizer_id, os.path.join(_RESOURCES, 'audio.wav'))
