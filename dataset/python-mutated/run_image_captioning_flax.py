...
import transformers
from transformers import AutoImageProcessor, AutoTokenizer, FlaxVisionEncoderDecoderModel, HfArgumentParser, is_tensorboard_available
...
class DataTrainingArguments:
    ...
    data_dir: Optional[str] = field(default=None, metadata={'help': 'The data directory of the dataset to use (via the datasets library).'})
    image_column: Optional[str] = field(default=None, metadata={'help': 'The name of the column in the datasets containing the full image file paths.'})
    caption_column: Optional[str] = field(default=None, metadata={'help': 'The name of the column in the datasets containing the image captions.'})
    ...
    test_file: Optional[str] = field(default=None, metadata={'help': 'An optional input predict data file to do prediction on (a text file).'})
...
image_captioning_name_mapping = {'image_caption_dataset.py': ('image_path', 'caption')}
