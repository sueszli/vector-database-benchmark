...
@parameterized.parameterized_class([{'onnx_backend': verification.OnnxBackend.ONNX_RUNTIME_CPU}], class_name_func=lambda cls, idx, input_dicts: f"{cls.__name__}_{input_dicts['onnx_backend'].name}")
