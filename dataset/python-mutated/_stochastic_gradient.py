...
from ._sgd_fast import EpsilonInsensitive, Hinge, Huber, Log, ModifiedHuber, SquaredEpsilonInsensitive, SquaredHinge, SquaredLoss, _plain_sgd32, _plain_sgd64
...
class BaseSGDRegressor(RegressorMixin, BaseSGD):
    loss_functions = {'squared_error': (SquaredLoss,), 'huber': (Huber, DEFAULT_EPSILON), 'epsilon_insensitive': (EpsilonInsensitive, DEFAULT_EPSILON), 'squared_epsilon_insensitive': (SquaredEpsilonInsensitive, DEFAULT_EPSILON)}
