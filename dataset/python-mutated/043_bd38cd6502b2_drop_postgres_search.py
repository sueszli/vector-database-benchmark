...
def downgrade():
    if False:
        for i in range(10):
            print('nop')
    op.create_table('package_search', sa.Column('package_id', sa.UnicodeText, sa.ForeignKey('package.id'), primary_key=True), sa.Column('search_vector', sa.dialects.postgresql.TSVECTOR))