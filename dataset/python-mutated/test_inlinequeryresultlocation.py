import pytest
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, InlineQueryResultLocation, InlineQueryResultVoice, InputTextMessageContent
...
class TestInlineQueryResultLocationWithoutRequest(TestInlineQueryResultLocationBase):
    ...
    def test_expected_values(self, inline_query_result_location):
        ...
        assert inline_query_result_location.input_message_content.to_dict() == self.input_message_content.to_dict()
    ...
    def test_to_dict(self, inline_query_result_location):
        ...
        assert inline_query_result_location_dict['latitude'] == inline_query_result_location.latitude
        assert inline_query_result_location_dict['longitude'] == inline_query_result_location.longitude
        assert inline_query_result_location_dict['title'] == inline_query_result_location.title
        assert inline_query_result_location_dict['live_period'] == inline_query_result_location.live_period
        assert inline_query_result_location_dict['thumbnail_url'] == inline_query_result_location.thumbnail_url
        assert inline_query_result_location_dict['thumbnail_width'] == inline_query_result_location.thumbnail_width
        assert inline_query_result_location_dict['thumbnail_height'] == inline_query_result_location.thumbnail_height
        assert inline_query_result_location_dict['input_message_content'] == inline_query_result_location.input_message_content.to_dict()
        assert inline_query_result_location_dict['reply_markup'] == inline_query_result_location.reply_markup.to_dict()
        assert inline_query_result_location_dict['horizontal_accuracy'] == inline_query_result_location.horizontal_accuracy
        assert inline_query_result_location_dict['heading'] == inline_query_result_location.heading
        assert inline_query_result_location_dict['proximity_alert_radius'] == inline_query_result_location.proximity_alert_radius
