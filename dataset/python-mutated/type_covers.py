...
from pyhap.const import CATEGORY_DOOR, CATEGORY_GARAGE_DOOR_OPENER, CATEGORY_WINDOW, CATEGORY_WINDOW_COVERING
from pyhap.service import Service
from homeassistant.components.cover import ATTR_CURRENT_POSITION, ATTR_CURRENT_TILT_POSITION, ATTR_POSITION, ATTR_TILT_POSITION, DOMAIN, CoverEntityFeature
from homeassistant.const import ATTR_ENTITY_ID, ATTR_SUPPORTED_FEATURES, SERVICE_CLOSE_COVER, SERVICE_OPEN_COVER, SERVICE_SET_COVER_POSITION, SERVICE_SET_COVER_TILT_POSITION, SERVICE_STOP_COVER, STATE_CLOSED, STATE_CLOSING, STATE_ON, STATE_OPEN, STATE_OPENING
from homeassistant.core import State, callback
from homeassistant.helpers.event import EventStateChangedData, async_track_state_change_event
from homeassistant.helpers.typing import EventType
from .accessories import TYPES, HomeAccessory
from .const import ATTR_OBSTRUCTION_DETECTED, CHAR_CURRENT_DOOR_STATE, CHAR_CURRENT_POSITION, CHAR_CURRENT_TILT_ANGLE, CHAR_HOLD_POSITION, CHAR_OBSTRUCTION_DETECTED, CHAR_POSITION_STATE, CHAR_TARGET_DOOR_STATE, CHAR_TARGET_POSITION, CHAR_TARGET_TILT_ANGLE, CONF_LINKED_OBSTRUCTION_SENSOR, HK_DOOR_CLOSED, HK_DOOR_CLOSING, HK_DOOR_OPEN, HK_DOOR_OPENING, HK_POSITION_GOING_TO_MAX, HK_POSITION_GOING_TO_MIN, HK_POSITION_STOPPED, PROP_MAX_VALUE, PROP_MIN_VALUE, SERV_DOOR, SERV_GARAGE_DOOR_OPENER, SERV_WINDOW, SERV_WINDOW_COVERING
DOOR_CURRENT_HASS_TO_HK = {STATE_OPEN: HK_DOOR_OPEN, STATE_CLOSED: HK_DOOR_CLOSED, STATE_OPENING: HK_DOOR_OPENING, STATE_CLOSING: HK_DOOR_CLOSING}
DOOR_TARGET_HASS_TO_HK = {STATE_OPEN: HK_DOOR_OPEN, STATE_CLOSED: HK_DOOR_CLOSED, STATE_OPENING: HK_DOOR_OPEN, STATE_CLOSING: HK_DOOR_CLOSED}
...
class GarageDoorOpener(HomeAccessory):
    ...
    async def run(self) -> None:
        ...
        """
        if self.linked_obstruction_sensor:
            self._subscriptions.append(async_track_state_change_event(self.hass, [self.linked_obstruction_sensor], self._async_update_obstruction_event))
        await super().run()
