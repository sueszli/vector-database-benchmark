import os
import numpy as np
from legacy_test.test_collective_api_base import TestCollectiveAPIRunnerBase, dump_output, runtime_main
import paddle
...
class TestCollectiveGlobalGatherAPI(TestCollectiveAPIRunnerBase):
    ...
    def get_model(self, main_prog, startup_program, rank, indata=None):
        ...
        with base.program_guard(main_prog, startup_program):
            ...
            global_expert_count = paddle.static.data(name='global_expert_count', shape=[tot_expert], dtype='int64')
    ...
    def run_trainer(self, args):
        ...
        (global_expert_count,) = exe.run(tmp_main_prog, feed={'local_expert_count': local_expert_count}, fetch_list=[global_expert_count.name])
        ...
        if args['static_mode']:
            ...
            out = exe.run(train_prog, feed={'local_expert_count': local_expert_count, 'global_expert_count': global_expert_count, 'local_input_buf': local_input_buf}, fetch_list=fetch_list)
        dump_output(out)
