...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dry-run', action='store_true', help='Do not write scripts, just report them to stdout')
    parser.add_argument('-v', '--verbose', action='count', default=0, help='Increase verbosity of logging')
    parsed = parser.parse_args()
    log_level = {0: logging.WARNING, 1: logging.INFO, 2: logging.DEBUG}.get(parsed.verbose, logging.DEBUG)
