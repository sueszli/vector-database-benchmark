...
from typing import TYPE_CHECKING, AbstractSet, Dict, Iterator, List, Mapping, Optional, Sequence, Tuple, Union, cast
import dagster._seven as seven
from dagster import AssetKey, DagsterEventType, DagsterInstance, EventRecordsFilter, MultiPartitionKey, MultiPartitionsDefinition, _check as check
from dagster._core.definitions.data_time import CachingDataTimeResolver
from dagster._core.definitions.external_asset_graph import ExternalAssetGraph
from dagster._core.definitions.multi_dimensional_partitions import MultiPartitionsSubset
from dagster._core.definitions.partition import CachingDynamicPartitionsLoader, DefaultPartitionsSubset, PartitionsDefinition, PartitionsSubset
from dagster._core.definitions.time_window_partitions import BaseTimeWindowPartitionsSubset, PartitionRangeStatus, TimeWindowPartitionsDefinition, TimeWindowPartitionsSubset, fetch_flattened_time_window_ranges
...
from dagster._core.storage.partition_status_cache import build_failed_and_in_progress_partition_subset, get_and_update_asset_status_cache_value, get_materialized_multipartitions, get_validated_partition_keys, is_cacheable_partition_type
...
if TYPE_CHECKING:
    ...
    from ..schema.pipelines.pipeline import GrapheneAsset, GrapheneDefaultPartitionStatuses, GrapheneMultiPartitionStatuses, GrapheneTimePartitionStatuses
