...
def upgrade():
    if False:
        print('Hello World!')
    op.add_column('environment_images', sa.Column('stored_in_registry', sa.Boolean(), server_default='True', nullable=False))
    op.add_column('jupyter_images', sa.Column('stored_in_registry', sa.Boolean(), server_default='True', nullable=False))
