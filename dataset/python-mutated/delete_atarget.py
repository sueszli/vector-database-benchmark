...
def main():
    ...
    client.targets.delete(resource_group_name='exampleRG', parent_provider_namespace='Microsoft.Compute', parent_resource_type='virtualMachines', parent_resource_name='exampleVM', target_name='Microsoft-Agent')
