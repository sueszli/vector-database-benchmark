...
from orangewidget.utils.visual_settings_dlg import KeyType, ValueType, SettingsType, FontList
...
class Updater:
    ...
    (FONT_FAMILY_LABEL, SIZE_LABEL, IS_ITALIC_LABEL) = ('Font family', 'Font size', 'Italic')
    (WIDTH_LABEL, ALPHA_LABEL, STYLE_LABEL, ANTIALIAS_LABEL) = ('Width', 'Opacity', 'Style', 'Antialias')
    LINE_STYLES = {'Solid line': Qt.SolidLine, 'Dash line': Qt.DashLine, 'Dot line': Qt.DotLine, 'Dash dot line': Qt.DashDotLine, 'Dash dot dot line': Qt.DashDotDotLine}
...
class CommonParameterSetter:
    ...
    TITLE_LABEL = 'Title'
    LINE_LABEL = 'Lines'
    FONT_FAMILY_SETTING = None
    FONT_SETTING = None
    LINE_SETTING: SettingsType = {Updater.WIDTH_LABEL: (range(1, 15), 1), Updater.ALPHA_LABEL: (range(0, 255, 5), 255), Updater.STYLE_LABEL: (list(Updater.LINE_STYLES), Updater.DEFAULT_LINE_STYLE), Updater.ANTIALIAS_LABEL: (None, False)}
