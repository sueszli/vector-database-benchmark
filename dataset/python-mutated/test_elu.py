...
@testing.parameterize(*testing.product({'shape': [(3, 2), ()], 'dtype': [numpy.float16, numpy.float32, numpy.float64], 'alpha_range': [(-2.0, 0.0), 0.0, (0.0, 2.0)]}))
@testing.fix_random()
...
class TestELU(testing.FunctionTestCase):
    ...
    def setUp(self):
        ...
        if self.dtype == numpy.float16:
            ...
            self.check_double_backward_options.update({'atol': 0.0005, 'rtol': 0.005})
