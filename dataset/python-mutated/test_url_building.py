...
URL_FOR_ARGS3 = dict(arg1='v1', _anchor='anchor', _scheme='http', _server=f'{test_host}:{test_port}', _external=True)
URL_FOR_VALUE3 = f'http://{test_host}:{test_port}/myurl?arg1=v1#anchor'
URL_FOR_ARGS4 = dict(arg1='v1', _anchor='anchor', _external=True, _server=f'http://{test_host}:{test_port}')
...
COMPLEX_PARAM_URL = '/<foo:int>/<four_letter_string:[A-z]{4}>/<two_letter_string:[A-z]{2}>/<normal_string>/<some_number:float>'
PASSING_KWARGS = {'foo': 4, 'four_letter_string': 'woof', 'two_letter_string': 'ba', 'normal_string': 'normal', 'some_number': '1.001'}
