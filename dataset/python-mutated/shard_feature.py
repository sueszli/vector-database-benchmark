...
if __name__ == '__main__':
    shard = Shard('data/feat/feat_how2_s3d', 'data/how2/raw_caption_dedup.bert-base-uncased', 'data/feat/feat_how2_s3d_shard_small', ['data/how2/how2_s3d_train.lst', 'data/how2/how2_s3d_val.lst'])
    shard()