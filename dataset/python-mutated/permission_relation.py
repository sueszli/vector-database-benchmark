...
__all__ = ['AssetPermissionUserRelationSerializer', 'AssetPermissionUserGroupRelationSerializer', 'AssetPermissionAssetRelationSerializer', 'AssetPermissionNodeRelationSerializer', 'AssetPermissionAllAssetSerializer', 'AssetPermissionAllUserSerializer']
...
class AssetPermissionUserGroupRelationSerializer(RelationMixin, serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'usergroup', 'usergroup_display']
