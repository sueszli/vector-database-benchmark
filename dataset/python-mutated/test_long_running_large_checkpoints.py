...
def main(smoke_test: bool=False):
    ...
    timed_tune_run(name='long running large checkpoints', num_samples=num_samples, results_per_second=results_per_second, trial_length_s=trial_length_s, max_runtime=max_runtime, checkpoint_freq_s=900, checkpoint_size_b=int(0.75 * 1000 ** 3), keep_checkpoints_num=2, resources_per_trial={'cpu': 1}, callbacks=[callback], storage_path='/mnt/cluster_storage')
