...
from posthog.schema import QueryTiming, SessionsTimelineQuery, TrendsQuery, LifecycleQuery, WebTopClicksQuery, WebOverviewQuery, PersonsQuery, EventsQuery, WebStatsTableQuery, HogQLQuery, InsightPersonsQuery, DashboardFilter
from posthog.utils import generate_cache_key, get_safe_cache
QUERY_CACHE_WRITE_COUNTER = Counter('posthog_query_cache_write_total', 'When a query result was persisted in the cache.', labelnames=[LABEL_TEAM_ID])
QUERY_CACHE_HIT_COUNTER = Counter('posthog_query_cache_hit_total', 'Whether we could fetch the query from the cache or not.', labelnames=[LABEL_TEAM_ID, 'cache_hit'])
DataT = TypeVar('DataT')
...
RunnableQueryNode = Union[HogQLQuery, TrendsQuery, LifecycleQuery, InsightPersonsQuery, EventsQuery, PersonsQuery, SessionsTimelineQuery, WebOverviewQuery, WebTopClicksQuery, WebStatsTableQuery]
