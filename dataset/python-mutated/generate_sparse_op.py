...
import yaml
from filters import assert_dense_or_sr, cartesian_prod_mapping, find_optinal_inputs_name, get_infer_var_type_func, to_composite_grad_opmaker_name, to_input_name, to_int_array_tensor_name, to_int_array_tensors_name, to_op_attr_type, to_opmaker_name, to_opmaker_name_cstr, to_pascal_case, to_scalar_tensor_name, to_variable_names
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ops_yaml_path', type=str, help='parsed sparse ops yaml file.')
    parser.add_argument('--backward_ops_yaml_path', type=str, help='parsed backward sparse ops yaml file.')
    ...
    main(args.ops_yaml_path, args.backward_ops_yaml_path, args.output_op_path, args.output_arg_map_path)