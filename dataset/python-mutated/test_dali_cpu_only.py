...
video_files = [os.path.join(get_dali_extra_path(), 'db', 'video', 'vfr', 'test_1.mp4'), os.path.join(get_dali_extra_path(), 'db', 'video', 'vfr', 'test_2.mp4')]
batch_size = 2
