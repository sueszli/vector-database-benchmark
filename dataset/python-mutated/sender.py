...
class Sender(threading.Thread):
    ...
    """
    DEFAULT_CONFIG = {'max_request_size': 1048576, 'acks': 1, 'retries': 0, 'request_timeout_ms': 30000, 'guarantee_message_order': False, 'client_id': 'kafka-python-' + __version__, 'api_version': (0, 8, 0)}
