...
from transformers import WEIGHTS_NAME, AdamW, BertConfig, BertTokenizer, RobertaConfig, RobertaTokenizer, get_linear_schedule_with_warmup
...
MODEL_CLASSES = {'bert': (BertConfig, DeeBertForSequenceClassification, BertTokenizer), 'roberta': (RobertaConfig, DeeRobertaForSequenceClassification, RobertaTokenizer)}
