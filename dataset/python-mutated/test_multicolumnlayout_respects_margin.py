...
class TestMultiColumnLayoutRespectsMargin(TestCase):
    ...
    def test_document_with_margin_top_0(self):
        ...
        layout.add(self.get_test_header(test_description='This test creates a PDF with paragraphs with margin_top 0.'))
        for i in range(0, 8):
    ...
    def test_document_with_margin_top_10(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test creates a PDF with paragraphs with margin_top 10.'))
        for i in range(0, 8):
    ...
    def test_document_with_margin_top_15(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test creates a PDF with paragraphs with margin_top 15.'))
        for i in range(0, 8):
    ...
    def test_document_with_margin_top_20(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test creates a PDF with paragraphs with margin_top 20.'))
        for i in range(0, 8):
