...
dict_for_declare_part = {'conv_kind_name': 'DefaultConv2dFprop', 'epi_part': '${epi_func}< ${element_c}, ${epilogue_vector_length}, ${element_accum}, ${element_epilogue}>'}
cba_kernel_no_alpha = SubstituteTemplate(CommonCutlassConvKernelDeclare, dict_for_declare_part) + '\n  typename ImplicitGemm::Arguments arguments{\n      problem_size,\n      {(cutlass::half_t *)(input), {ic, ic * iw, ic * iw * ih}},\n      {(cutlass::half_t *)(weight), {kc, kc * kw, kc * kw * kh}},\n      {(cutlass::half_t *)(bias), {0, 0, 0}},\n      {(cutlass::half_t *)(output), {oc, oc * ow, oc * ow * oh}},\n      {1.f, 1.f}};\n' + CommonCutlassConvKernelExecute
cba_kernel_alpha = cba_kernel_no_alpha.replace('{1.f, 1.f}', '{1.f, 1.f, alpha}').replace('typename ImplicitG', 'float alpha = params.alpha; typename ImplicitG')
...
class CbaAct(enum.Enum):
    ...
    LeakyRelu = 4
    Sigmoid = 5
SupportedAct = [CbaAct.Identity, CbaAct.Relu, CbaAct.Silu, CbaAct.LeakyRelu, CbaAct.Sigmoid]
ActTag = {SupportedAct[0]: 'cutlass::epilogue::thread::LinearCombination', SupportedAct[1]: 'cutlass::epilogue::thread::LinearCombinationRelu', SupportedAct[2]: 'cutlass::epilogue::thread::LinearCombinationSilu', SupportedAct[3]: 'cutlass::epilogue::thread::LinearCombinationLeakyRelu', SupportedAct[4]: 'cutlass::epilogue::thread::LinearCombinationSigmoid'}
UnderScoreName = {SupportedAct[0]: 'conv2d_bias', SupportedAct[1]: 'conv2d_bias_relu', SupportedAct[2]: 'conv2d_bias_silu', SupportedAct[3]: 'conv2d_bias_leaky_relu', SupportedAct[4]: 'conv2d_bias_sigmoid'}
CamelName = {SupportedAct[0]: 'Conv2dBias', SupportedAct[1]: 'Conv2dBiasRelu', SupportedAct[2]: 'Conv2dBiasSilu', SupportedAct[3]: 'Conv2dBiasLeakyRelu', SupportedAct[4]: 'Conv2dBiasSigmoid'}
...
if __name__ == '__main__':
    ...
    all_code += GenerateFunctionForPhi(sm_versions, SupportedAct, UnderScoreName, CamelName)
    all_code += CommonTail
