...
class Folder(proto.Message):
    ...
    delete_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
...
class ListFoldersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    folders: MutableSequence['Folder'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Folder')
...
class CreateFolderRequest(proto.Message):
    ...
    """
    folder: 'Folder' = proto.Field(proto.MESSAGE, number=2, message='Folder')
...
class UpdateFolderRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            can be updated.
    """
    folder: 'Folder' = proto.Field(proto.MESSAGE, number=1, message='Folder')
...
class MoveFolderMetadata(proto.Message):
    ...
    """
    display_name: str = proto.Field(proto.STRING, number=1)
    source_parent: str = proto.Field(proto.STRING, number=2)
    destination_parent: str = proto.Field(proto.STRING, number=3)
