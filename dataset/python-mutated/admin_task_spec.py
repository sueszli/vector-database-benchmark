...
class AdminTaskSpec(object):
    ...
    swagger_types = {'template': 'CoreTaskTemplate', 'description': 'AdminDescriptionEntity'}
    attribute_map = {'template': 'template', 'description': 'description'}

    def __init__(self, template=None, description=None):
        if False:
            i = 10
            return i + 15
        'AdminTaskSpec - a model defined in Swagger'
        self._template = None
