...
from google.cloud.retail import GcsSource, ImportErrorsConfig, ImportProductsRequest, ProductInputConfig
...
upload_data_to_bq_table(product_dataset, product_table, product_resource_file, product_schema)
