from ctypes import WinDLL, Structure, POINTER, create_string_buffer, cast, c_void_p, WinError, byref
from ctypes.wintypes import DWORD, LPCWSTR, HANDLE
from psutil import disk_usage

class NETRESOURCE(Structure):
    _fields_ = (('dwScope', DWORD), ('dwType', DWORD), ('dwDisplayType', DWORD), ('dwUsage', DWORD), ('lpLocalName', LPCWSTR), ('lpRemoteName', LPCWSTR), ('lpComment', LPCWSTR), ('lpProvider', LPCWSTR))
...
RESOURCE_RECENT = 4
RESOURCE_CONTEXT = 5
SCOPE_TEXT = {RESOURCE_CONNECTED: 'connected', RESOURCE_GLOBALNET: 'global', RESOURCE_REMEMBERED: 'remembered', RESOURCE_RECENT: 'recent', RESOURCE_CONTEXT: 'context'}
RESOURCETYPE_ANY = 0
RESOURCETYPE_DISK = 1
RESOURCETYPE_PRINT = 2
RESOURCETYPE_TEXT = {RESOURCETYPE_ANY: 'any', RESOURCETYPE_DISK: 'disk', RESOURCETYPE_PRINT: 'print'}
...
RESOURCEUSAGE_TEXT = {RESOURCEUSAGE_CONNECTABLE: 'connectable', RESOURCEUSAGE_CONTAINER: 'container', RESOURCEUSAGE_NOLOCALDEVICE: 'nolocaldevice', RESOURCEUSAGE_SIBLING: 'sibling', RESOURCEUSAGE_ATTACHED: 'attached'}
...
RESOURCEDISPLAYTYPE_TEXT = {RESOURCEDISPLAYTYPE_GENERIC: 'generic', RESOURCEDISPLAYTYPE_DOMAIN: 'domain', RESOURCEDISPLAYTYPE_SERVER: 'server', RESOURCEDISPLAYTYPE_SHARE: 'share', RESOURCEDISPLAYTYPE_FILE: 'file', RESOURCEDISPLAYTYPE_GROUP: 'group', RESOURCEDISPLAYTYPE_NETWORK: 'network', RESOURCEDISPLAYTYPE_ROOT: 'root', RESOURCEDISPLAYTYPE_SHAREADMIN: 'shareadmin', RESOURCEDISPLAYTYPE_DIRECTORY: 'dir', RESOURCEDISPLAYTYPE_TREE: 'tree'}
ERROR_NO_MORE_ITEMS = 259
ERROR_EXTENDED = 1208
mpr = WinDLL('mpr', use_last_error=True)
WNetEnumResource = mpr.WNetEnumResourceW
WNetEnumResource.restype = DWORD
WNetEnumResource.argtypes = (HANDLE, PDWORD, PVOID, PDWORD)
WNetOpenEnum = mpr.WNetOpenEnumW
WNetOpenEnum.restype = DWORD
WNetOpenEnum.argtypes = (DWORD, DWORD, DWORD, PNETRESOURCE, PHANDLE)
