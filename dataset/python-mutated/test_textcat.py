...
from spacy.pipeline.textcat import single_label_bow_config, single_label_cnn_config, single_label_default_config
from spacy.pipeline.textcat_multilabel import multi_label_bow_config, multi_label_cnn_config, multi_label_default_config
...
TRAIN_DATA_SINGLE_LABEL = [("I'm so happy.", {'cats': {'POSITIVE': 1.0, 'NEGATIVE': 0.0}}), ("I'm so angry", {'cats': {'POSITIVE': 0.0, 'NEGATIVE': 1.0}})]
TRAIN_DATA_MULTI_LABEL = [("I'm angry and confused", {'cats': {'ANGRY': 1.0, 'CONFUSED': 1.0, 'HAPPY': 0.0}}), ("I'm confused but happy", {'cats': {'ANGRY': 0.0, 'CONFUSED': 1.0, 'HAPPY': 1.0}})]
