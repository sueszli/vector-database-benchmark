...
from homeassistant.components.media_player import ATTR_INPUT_SOURCE, ATTR_INPUT_SOURCE_LIST, ATTR_MEDIA_VOLUME_LEVEL, ATTR_MEDIA_VOLUME_MUTED, DOMAIN, SERVICE_SELECT_SOURCE, MediaPlayerEntityFeature
from homeassistant.const import ATTR_ENTITY_ID, ATTR_SUPPORTED_FEATURES, SERVICE_MEDIA_PAUSE, SERVICE_MEDIA_PLAY, SERVICE_MEDIA_PLAY_PAUSE, SERVICE_MEDIA_STOP, SERVICE_TURN_OFF, SERVICE_TURN_ON, SERVICE_VOLUME_DOWN, SERVICE_VOLUME_MUTE, SERVICE_VOLUME_SET, SERVICE_VOLUME_UP, STATE_OFF, STATE_PAUSED, STATE_PLAYING, STATE_STANDBY, STATE_UNKNOWN
from homeassistant.core import State, callback
from .accessories import TYPES, HomeAccessory
from .const import ATTR_KEY_NAME, CATEGORY_RECEIVER, CHAR_ACTIVE, CHAR_MUTE, CHAR_NAME, CHAR_ON, CHAR_VOLUME, CHAR_VOLUME_CONTROL_TYPE, CHAR_VOLUME_SELECTOR, CONF_FEATURE_LIST, EVENT_HOMEKIT_TV_REMOTE_KEY_PRESSED, FEATURE_ON_OFF, FEATURE_PLAY_PAUSE, FEATURE_PLAY_STOP, FEATURE_TOGGLE_MUTE, KEY_PLAY_PAUSE, SERV_SWITCH, SERV_TELEVISION_SPEAKER
...
MODE_FRIENDLY_NAME = {FEATURE_ON_OFF: 'Power', FEATURE_PLAY_PAUSE: 'Play-Pause', FEATURE_PLAY_STOP: 'Play-Stop', FEATURE_TOGGLE_MUTE: 'Mute'}
