...
class GameJoltUserIE(GameJoltPostListBaseIE):
    ...
    _TESTS = [{'url': 'https://gamejolt.com/@BlazikenSuperStar', 'playlist_mincount': 1, 'info_dict': {'id': '6116784', 'title': 'S. Blaze', 'description': 'md5:5ba7fbbb549e8ea2545aafbfe22eb03a'}, 'params': {'ignore_no_formats_error': True}, 'expected_warnings': ['skipping format', 'No video formats found', 'Requested format is not available']}]
...
class GameJoltGameIE(GameJoltPostListBaseIE):
    ...
    _TESTS = [{'url': 'https://gamejolt.com/games/Friday4Fun/655124', 'playlist_mincount': 2, 'info_dict': {'id': '655124', 'title': "Friday Night Funkin': Friday 4 Fun", 'description': 'md5:576a7dd87912a2dcf33c50d2bd3966d3'}, 'params': {'ignore_no_formats_error': True}, 'expected_warnings': ['skipping format', 'No video formats found', 'Requested format is not available']}]
...
class GameJoltGameSoundtrackIE(GameJoltBaseIE):
    ...
    _TESTS = [{'url': 'https://gamejolt.com/get/soundtrack?foo=bar&game=657899', 'info_dict': {'id': '657899', 'title': "Friday Night Funkin': Vs Oswald", 'n_entries': None}, 'playlist': [{'info_dict': {'id': '184434', 'ext': 'mp3', 'title': "Gettin' Lucky (Menu Music)", 'url': 're:^https://.+vs-oswald-menu-music\\.mp3$', 'release_timestamp': 1635190816, 'release_date': '20211025', 'n_entries': 3}}, {'info_dict': {'id': '184435', 'ext': 'mp3', 'title': "Rabbit's Luck (Extended Version)", 'url': 're:^https://.+rabbit-s-luck--full-version-\\.mp3$', 'release_timestamp': 1635190841, 'release_date': '20211025', 'n_entries': 3}}, {'info_dict': {'id': '185228', 'ext': 'mp3', 'title': 'Last Straw', 'url': 're:^https://.+last-straw\\.mp3$', 'release_timestamp': 1635881104, 'release_date': '20211102', 'n_entries': 3}}]}]
...
class GameJoltCommunityIE(GameJoltPostListBaseIE):
    ...
    _TESTS = [{'url': 'https://gamejolt.com/c/fnf/videos', 'playlist_mincount': 50, 'info_dict': {'id': 'fnf/videos', 'title': "Friday Night Funkin' - Videos", 'description': 'md5:6d8c06f27460f7d35c1554757ffe53c8'}, 'params': {'playlistend': 50, 'ignore_no_formats_error': True}, 'expected_warnings': ['skipping format', 'No video formats found', 'Requested format is not available']}, {'url': 'https://gamejolt.com/c/youtubers', 'playlist_mincount': 50, 'info_dict': {'id': 'youtubers/featured', 'title': 'Youtubers - featured', 'description': 'md5:53e5582c93dcc467ab597bfca4db17d4'}, 'params': {'playlistend': 50, 'ignore_no_formats_error': True}, 'expected_warnings': ['skipping format', 'No video formats found', 'Requested format is not available']}]
...
class GameJoltSearchIE(GameJoltPostListBaseIE):
    ...
    _URL_FORMATS = {'users': 'https://gamejolt.com/@{username}', 'communities': 'https://gamejolt.com/c/{path}', 'games': 'https://gamejolt.com/games/{slug}/{id}'}
    _TESTS = [{'url': 'https://gamejolt.com/search?foo=bar&q=%23fnf', 'playlist_mincount': 50, 'info_dict': {'id': '#fnf', 'title': '#fnf'}, 'params': {'playlistend': 50, 'ignore_no_formats_error': True}, 'expected_warnings': ['skipping format', 'No video formats found', 'Requested format is not available']}, {'url': 'https://gamejolt.com/search/communities?q=cookie%20run', 'playlist_mincount': 10, 'info_dict': {'id': 'cookie run', 'title': 'cookie run'}}, {'url': 'https://gamejolt.com/search/users?q=mlp', 'playlist_mincount': 278, 'info_dict': {'id': 'mlp', 'title': 'mlp'}}, {'url': 'https://gamejolt.com/search/games?q=roblox', 'playlist_mincount': 688, 'info_dict': {'id': 'roblox', 'title': 'roblox'}}]
