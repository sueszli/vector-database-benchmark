...
class LearningRateScheduler(Registrable):
    ...
    def from_params(cls, optimizer: torch.optim.Optimizer, params: Params):
        ...
        return LearningRateScheduler.by_name(scheduler)(optimizer, **params.as_dict())
Registrable._registry[LearningRateScheduler] = {'step': torch.optim.lr_scheduler.StepLR, 'multi_step': torch.optim.lr_scheduler.MultiStepLR, 'exponential': torch.optim.lr_scheduler.ExponentialLR, 'reduce_on_plateau': torch.optim.lr_scheduler.ReduceLROnPlateau}