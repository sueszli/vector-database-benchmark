...
class PopulateStoryNodeJobTests(job_test_utils.JobTestBase):
    ...
    story_contents_dict_1 = {'nodes': [{'id': 'node_1', 'title': 'title_1', 'description': 'description_1', 'thumbnail_filename': 'thumbnail_filename_1.svg', 'thumbnail_bg_color': '#F8BF74', 'thumbnail_size_in_bytes': None, 'destination_node_ids': [], 'acquired_skill_ids': [], 'prerequisite_skill_ids': [], 'outline': 'outline', 'outline_is_finalized': True, 'exploration_id': 'exp_id_1'}, {'id': 'node_2', 'title': 'title_2', 'description': 'description_2', 'thumbnail_filename': 'thumbnail_filename_2.svg', 'thumbnail_bg_color': '#F8FF74', 'thumbnail_size_in_bytes': None, 'destination_node_ids': [], 'acquired_skill_ids': [], 'prerequisite_skill_ids': [], 'outline': 'outline', 'outline_is_finalized': True, 'exploration_id': 'exp_id_2'}], 'initial_node_id': 'node_1', 'next_node_id': 'node_3'}
    story_contents_dict_2 = {'nodes': [{'id': 'node_11', 'title': 'title_11', 'description': 'description_11', 'thumbnail_filename': 'thumbnail_filename_11.svg', 'thumbnail_bg_color': '#F8BF74', 'thumbnail_size_in_bytes': None, 'destination_node_ids': [], 'acquired_skill_ids': [], 'prerequisite_skill_ids': [], 'outline': 'outline', 'outline_is_finalized': True, 'exploration_id': 'exp_id_11'}], 'initial_node_id': 'node_11', 'next_node_id': 'node_22'}
