...
class WipeoutServiceDeleteAppFeedbackReportModelsTests(test_utils.GenericTestBase):
    ...
    USER_2_EMAIL: Final = 'some-other@email.com'
    USER_2_USERNAME: Final = 'username2'
    REPORT_SUBMITTED_TIMESTAMP_1: Final = datetime.datetime.fromtimestamp(1615151836)
    REPORT_SUBMITTED_TIMESTAMP_2: Final = datetime.datetime.fromtimestamp(1615199836)
    TICKET_CREATION_TIMESTAMP: Final = datetime.datetime.fromtimestamp(1616173836)
    PLATFORM_ANDROID: Final = 'android'
    REPORT_ID_1: Final = '%s.%s.%s' % (PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP_1.second, 'randomInteger123')
    REPORT_ID_2: Final = '%s.%s.%s' % (PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP_2.second, 'randomInteger321')
    REPORT_ID_3: Final = '%s.%s.%s' % (PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP_2.second, 'differentInt')
    TICKET_ID: Final = '%s.%s.%s' % ('random_hash', TICKET_CREATION_TIMESTAMP.second, '16CharString1234')
    ...
    ANDROID_REPORT_INFO: Final = {'user_feedback_other_text_input': 'add an admin', 'event_logs': ['event1', 'event2'], 'logcat_logs': ['logcat1', 'logcat2'], 'package_version_code': 1, 'language_locale_code': 'en', 'entry_point_info': {'entry_point_name': 'crash'}, 'text_size': 'MEDIUM_TEXT_SIZE', 'only_allows_wifi_download_and_update': True, 'automatically_update_topics': False, 'is_curriculum_admin': False}
...
class WipeoutServiceVerifyDeleteCollectionModelsTests(test_utils.GenericTestBase):
    """Provides testing of the verification part of wipeout service."""
    USER_1_EMAIL: Final = 'some@email.com'
    USER_1_USERNAME: Final = 'username1'
    COL_1_ID: Final = 'col_1_id'
...
class WipeoutServiceVerifyDeleteExplorationModelsTests(test_utils.GenericTestBase):
    """Provides testing of the verification part of wipeout service."""
    USER_1_EMAIL: Final = 'some@email.com'
    USER_1_USERNAME: Final = 'username1'
    EXP_1_ID: Final = 'exp_1_id'
...
class WipeoutServiceVerifyDeleteImprovementsModelsTests(test_utils.GenericTestBase):
    """Provides testing of the verification part of wipeout service."""
    USER_1_EMAIL: Final = 'some@email.com'
    USER_1_USERNAME: Final = 'username1'
    USER_2_EMAIL: Final = 'some-other@email.com'
...
class WipeoutServiceDeletePinnedOpportunitiesModelsTest(test_utils.GenericTestBase):
    """Provides testing of the deletion part of wipeout service."""
...
class WipeoutServiceVerifyDeleteSuggestionModelsTests(test_utils.GenericTestBase):
    """Provides testing of the verification part of wipeout service."""
    USER_1_EMAIL: Final = 'some@email.com'
    USER_1_USERNAME: Final = 'username1'
    USER_2_EMAIL: Final = 'some-other@email.com'
...
class WipeoutServiceVerifyProfilePictureIsDeletedTests(test_utils.GenericTestBase):
