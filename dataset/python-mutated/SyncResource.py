...
from mage_ai.data_preparation.sync import GIT_ACCESS_TOKEN_SECRET_NAME, GIT_SSH_PRIVATE_KEY_SECRET_NAME, GIT_SSH_PUBLIC_KEY_SECRET_NAME, GitConfig, UserGitConfig
