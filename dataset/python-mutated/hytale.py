...
class HytaleIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://hytale.com/news/2021/07/summer-2021-development-update', 'info_dict': {'id': 'summer-2021-development-update', 'title': 'Summer 2021 Development Update'}, 'playlist_count': 4, 'playlist': [{'md5': '0854ebe347d233ee19b86ab7b2ead610', 'info_dict': {'id': 'ed51a2609d21bad6e14145c37c334999', 'ext': 'mp4', 'title': 'Avatar Personalization', 'thumbnail': 're:https://videodelivery\\.net/\\w+/thumbnails/thumbnail\\.jpg'}}]}, {'url': 'https://www.hytale.com/news/2019/11/hytale-graphics-update', 'info_dict': {'id': 'hytale-graphics-update', 'title': 'Hytale graphics update'}, 'playlist_count': 2}]
