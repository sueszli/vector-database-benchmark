...
from mage_ai.data_preparation.models.triggers import Trigger, add_or_update_trigger_for_pipeline_and_persist, remove_trigger
from mage_ai.orchestration.db import db_connection, safe_db_query
from mage_ai.orchestration.db.models.schedules import EventMatcher, PipelineSchedule, pipeline_schedule_event_matcher_association_table
...
PipelineScheduleResource.register_collective_loader('tag_associations', load=__load_tag_associations, select=__select_tag_associations)