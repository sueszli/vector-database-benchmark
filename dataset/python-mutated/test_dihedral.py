...
from qiskit.circuit.library import IGate, XGate, YGate, ZGate, TGate, TdgGate, SGate, SdgGate, CXGate, CZGate, CSGate, CSdgGate, SwapGate, CCZGate
...
from qiskit.synthesis.cnotdihedral import synth_cnotdihedral_general, synth_cnotdihedral_full, synth_cnotdihedral_two_qubits
