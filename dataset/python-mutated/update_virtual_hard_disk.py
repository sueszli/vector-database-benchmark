...
def main():
    ...
    response = client.virtual_hard_disks.begin_update(resource_group_name='test-rg', virtual_hard_disk_name='test-vhd', virtual_hard_disks={'tags': {'additionalProperties': 'sample'}}).result()
    print(response)
