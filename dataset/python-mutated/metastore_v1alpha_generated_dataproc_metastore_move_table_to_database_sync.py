...
def sample_move_table_to_database():
    ...
    request = metastore_v1alpha.MoveTableToDatabaseRequest(service='service_value', table_name='table_name_value', db_name='db_name_value', destination_db_name='destination_db_name_value')
