...
class _WithInitNoFlag(BaseContainer, SupportsKind1['_WithInitNoFlag', _ValueType], mappable.Mappable1[_ValueType]):
    """Does not have any ways to be constructed."""

    def map(self, function: Callable[[_ValueType], _NewValueType]) -> '_WithInitNoFlag[_NewValueType]':
        if False:
            while True:
                i = 10
