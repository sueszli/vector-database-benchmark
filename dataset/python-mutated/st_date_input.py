...
st.write('Value 6:', v6)
v7 = st.date_input('Label hidden', datetime(2019, 7, 6, 21, 15), label_visibility='hidden')
st.write('Value 7:', v7)
v8 = st.date_input('Label collapsed', datetime(2019, 7, 6, 21, 15), label_visibility='collapsed')
st.write('Value 8:', v8)
v9 = st.date_input('Single date with format', date(1970, 1, 1), format='MM-DD-YYYY')
st.write('Value 9:', v9)
v10 = st.date_input('Range, two dates with format', [date(2019, 7, 6), date(2019, 7, 8)], format='MM/DD/YYYY')
...
if runtime.exists():
    ...
    st.date_input('Single date with callback', date(1970, 1, 1), min_value=date(1970, 1, 1), key='date_input_12', on_change=on_change)
...
v14 = st.date_input('Value from state', value=None, key='date_input_14')
