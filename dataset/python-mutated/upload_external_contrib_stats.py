...
FILTER_OUT_USERS = {'pytorchmergebot', 'facebook-github-bot', 'pytorch-bot[bot]', 'pytorchbot', 'pytorchupdatebot', 'dependabot[bot]'}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--startDate', type=datetime.date.fromisoformat, required=True, help='the first date to upload data for in any valid ISO 8601 format format (eg. YYYY-MM-DD).')
    parser.add_argument('--length', type=int, required=False, help='the number of days to upload data for. Default is 1.', default=1)
    parser.add_argument('--period-length', type=int, required=False, help='the number of days to group data for. Default is 1.', default=1)
