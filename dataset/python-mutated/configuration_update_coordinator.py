...
def main():
    ...
    response = client.configurations.begin_update_on_coordinator(resource_group_name='TestResourceGroup', cluster_name='testcluster', configuration_name='array_nulls', parameters={'properties': {'value': 'on'}}).result()
    print(response)
