...
EXPECTED_SORTED_DATA_SINGLE_VALUE_ASC = [{'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Blue'}, {'name': 'Gray'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'A'}]}], 'name': "['Blue', 'Gray'] Apple - A (1)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Blue'}, {'name': 'Gray'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'A'}]}], 'name': "['Blue', 'Gray'] Orange - A (1)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Blue'}, {'name': 'Red'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'A'}]}], 'name': "['Blue', 'Red'] Apple - A (0)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Blue'}, {'name': 'Red'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'A'}]}], 'name': "['Blue', 'Red'] Orange - A (0)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Pink'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'ab'}]}], 'name': "['Pink'] Apple - ab (2)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Pink'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'ab'}]}], 'name': "['Pink'] Orange - ab (2)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Pink'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'b'}]}], 'name': "['Pink'] Apple - b (3)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Pink'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'b'}]}], 'name': "['Pink'] Orange - b (3)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Green'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'y'}]}], 'name': "['Green'] Apple - y (4)"}}, {'node': {'attributes': [{'attribute': {'slug': 'colors'}, 'values': [{'name': 'Green'}]}, {'attribute': {'slug': 'trademark'}, 'values': [{'name': 'y'}]}], 'name': "['Green'] Orange - y (4)"}}, {'node': {'attributes': [{'attribute': {'slug': 'dummy'}, 'values': []}], 'name': 'Another Dummy but first in ASC and has no attribute value'}}, {'node': {'attributes': [{'attribute': {'slug': 'dummy'}, 'values': [{'name': 'Oopsie'}]}], 'name': 'Oopsie Dummy'}}]
