...
from rich.progress import BarColumn, DownloadColumn, FileSizeColumn, MofNCompleteColumn, Progress, RenderableColumn, SpinnerColumn, Task, TaskID, TaskProgressColumn, TextColumn, TimeElapsedColumn, TimeRemainingColumn, TotalFileSizeColumn, TransferSpeedColumn, _TrackThread, track
...
def test_progress_max_refresh() -> None:
    ...
    print(repr(result))
    assert result == '\x1b[?25l\r\x1b[2Kstart\r\x1b[2Kstart\r\x1b[2Ktick 1\r\x1b[2Ktick 1\r\x1b[2Ktick 3\r\x1b[2Ktick 3\r\x1b[2Ktick 5\r\x1b[2Ktick 5\n\x1b[?25h'
