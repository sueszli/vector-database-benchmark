...
class ParlviewIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://parlview.aph.gov.au/mediaPlayer.php?videoID=542661', 'info_dict': {'id': '542661', 'ext': 'mp4', 'title': "Australia's Family Law System [Part 2]", 'duration': 5799, 'description': 'md5:7099883b391619dbae435891ca871a62', 'timestamp': 1621430700, 'upload_date': '20210519', 'uploader': 'Joint Committee'}, 'params': {'skip_download': True}}, {'url': 'https://parlview.aph.gov.au/mediaPlayer.php?videoID=539936', 'only_matching': True}]
