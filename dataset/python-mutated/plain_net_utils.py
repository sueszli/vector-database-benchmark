...
from . import basic_blocks, super_blocks, super_res_idwexkx, super_res_k1kxk1, super_res_kxkx
...
_all_netblocks_dict_ = super_res_kxkx.register_netblocks_dict(_all_netblocks_dict_)
_all_netblocks_dict_ = super_res_k1kxk1.register_netblocks_dict(_all_netblocks_dict_)
_all_netblocks_dict_ = super_res_idwexkx.register_netblocks_dict(_all_netblocks_dict_)