...
from ..utils import ExtractorError, clean_html, float_or_none, get_element_by_attribute, get_element_by_class, int_or_none, js_to_json, traverse_obj, url_or_none

class AmazonStoreIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?amazon\\.(?:[a-z]{2,3})(?:\\.[a-z]{2})?/(?:[^/]+/)?(?:dp|gp/product)/(?P<id>[^/&#$?]+)'
    _TESTS = [{'url': 'https://www.amazon.co.uk/dp/B098XNCHLD/', 'info_dict': {'id': 'B098XNCHLD', 'title': str}, 'playlist_mincount': 1, 'playlist': [{'info_dict': {'id': 'A1F83G8C2ARO7P', 'ext': 'mp4', 'title': 'mcdodo usb c cable 100W 5a', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 34}}], 'expected_warnings': ['Unable to extract data']}, {'url': 'https://www.amazon.in/Sony-WH-1000XM4-Cancelling-Headphones-Bluetooth/dp/B0863TXGM3', 'info_dict': {'id': 'B0863TXGM3', 'title': str}, 'playlist_mincount': 4, 'expected_warnings': ['Unable to extract data']}, {'url': 'https://www.amazon.com/dp/B0845NXCXF/', 'info_dict': {'id': 'B0845NXCXF', 'title': str}, 'playlist-mincount': 1, 'expected_warnings': ['Unable to extract data']}, {'url': 'https://www.amazon.es/Samsung-Smartphone-s-AMOLED-Quad-c%C3%A1mara-espa%C3%B1ola/dp/B08WX337PQ', 'info_dict': {'id': 'B08WX337PQ', 'title': str}, 'playlist_mincount': 1, 'expected_warnings': ['Unable to extract data']}]
...
class AmazonReviewsIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.amazon.com/gp/customer-reviews/R10VE9VUSY19L3/ref=cm_cr_arp_d_rvw_ttl', 'info_dict': {'id': 'R10VE9VUSY19L3', 'ext': 'mp4', 'title': 'Get squad #Suspicious', 'description': 'md5:7012695052f440a1e064e402d87e0afb', 'uploader': 'Kimberly Cronkright', 'average_rating': 1.0, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'expected_warnings': ['Review body was not found in webpage']}, {'url': 'https://www.amazon.com/gp/customer-reviews/R10VE9VUSY19L3/ref=cm_cr_arp_d_rvw_ttl?language=es_US', 'info_dict': {'id': 'R10VE9VUSY19L3', 'ext': 'mp4', 'title': 'Get squad #Suspicious', 'description': 'md5:7012695052f440a1e064e402d87e0afb', 'uploader': 'Kimberly Cronkright', 'average_rating': 1.0, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'expected_warnings': ['Review body was not found in webpage']}, {'url': 'https://www.amazon.in/gp/customer-reviews/RV1CO8JN5VGXV/', 'info_dict': {'id': 'RV1CO8JN5VGXV', 'ext': 'mp4', 'title': 'Not sure about its durability', 'description': 'md5:1a252c106357f0a3109ebf37d2e87494', 'uploader': 'Shoaib Gulzar', 'average_rating': 2.0, 'thumbnail': 're:^https?://.*\\.jpg$'}, 'expected_warnings': ['Review body was not found in webpage']}]
