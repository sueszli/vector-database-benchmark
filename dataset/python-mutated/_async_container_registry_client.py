...
from .._container_registry_client import _return_response_headers, _return_response_and_headers, _return_response
...
from .._models import RepositoryProperties, ArtifactManifestProperties, ArtifactTagProperties, GetManifestResult, DigestValidationError
...
class ContainerRegistryClient(ContainerRegistryBaseClient):
    ...
    async def get_repository_properties(self, repository: str, **kwargs) -> RepositoryProperties:
        ...
        """
        return RepositoryProperties._from_generated(await self._client.container_registry.get_properties(repository, **kwargs))
    ...
    @distributed_trace_async
    async def get_manifest_properties(self, repository: str, tag_or_digest: str, **kwargs) -> ArtifactManifestProperties:
        ...
        manifest_properties = await self._client.container_registry.get_manifest_properties(repository, tag_or_digest, **kwargs)
    ...
    @overload
    async def update_repository_properties(self, repository: str, properties: RepositoryProperties, **kwargs: Any) -> RepositoryProperties:
    ...
    @overload
    async def update_repository_properties(self, repository: str, *, can_delete: Optional[bool]=None, can_list: Optional[bool]=None, can_read: Optional[bool]=None, can_write: Optional[bool]=None, **kwargs: Any) -> RepositoryProperties:
        """Set the permission properties of a repository.
    ...
    @distributed_trace_async
    async def update_repository_properties(self, *args: Union[str, RepositoryProperties], **kwargs) -> RepositoryProperties:
        ...
        return RepositoryProperties._from_generated(await self._client.container_registry.update_properties(repository, value=properties._to_generated(), **kwargs))

    @overload
    async def update_manifest_properties(self, repository: str, tag_or_digest: str, properties: ArtifactManifestProperties, **kwargs: Any) -> ArtifactManifestProperties:
    ...
    @overload
    async def update_manifest_properties(self, repository: str, tag_or_digest: str, *, can_delete: Optional[bool]=None, can_list: Optional[bool]=None, can_read: Optional[bool]=None, can_write: Optional[bool]=None, **kwargs: Any) -> ArtifactManifestProperties:
        """Set the permission properties for a manifest.
    ...
    @distributed_trace_async
    async def update_manifest_properties(self, *args: Union[str, ArtifactManifestProperties], **kwargs) -> ArtifactManifestProperties:
        repository = str(args[0])
        ...
        if _is_tag(tag_or_digest):
            tag_or_digest = await self._get_digest_from_tag(repository, tag_or_digest)
        manifest_properties = await self._client.container_registry.update_manifest_properties(repository, tag_or_digest, value=properties._to_generated(), **kwargs)
        return ArtifactManifestProperties._from_generated(manifest_properties.manifest, repository_name=repository, registry=self._endpoint)

    @overload
    async def update_tag_properties(self, repository: str, tag: str, properties: ArtifactTagProperties, **kwargs: Any) -> ArtifactTagProperties:
    ...
    @overload
    async def update_tag_properties(self, repository: str, tag: str, *, can_delete: Optional[bool]=None, can_list: Optional[bool]=None, can_read: Optional[bool]=None, can_write: Optional[bool]=None, **kwargs: Any) -> ArtifactTagProperties:
        """Set the permission properties for a tag.
    ...
    async def update_tag_properties(self, *args: Union[str, ArtifactTagProperties], **kwargs) -> ArtifactTagProperties:
        ...
        properties.can_read = kwargs.pop('can_read', properties.can_read)
        properties.can_write = kwargs.pop('can_write', properties.can_write)
        tag_attributes = await self._client.container_registry.update_tag_attributes(repository, tag, value=properties._to_generated(), **kwargs)
        return ArtifactTagProperties._from_generated(tag_attributes.tag, repository_name=repository)

    @distributed_trace_async
    async def set_manifest(self, repository: str, manifest: Union[JSON, IO[bytes]], *, tag: Optional[str]=None, media_type: str=OCI_IMAGE_MANIFEST, **kwargs) -> str:
        ...
        try:
            ...
            response_headers = await self._client.container_registry.create_manifest(name=repository, reference=tag_or_digest, payload=data, content_type=media_type, cls=_return_response_headers, **kwargs)
    ...
    async def get_manifest(self, repository: str, tag_or_digest: str, **kwargs) -> GetManifestResult:
        ...
        :raises ValueError: If the content-length header is missing or invalid in response, or the manifest size is
            bigger than 4MB.
        """
        response = cast(PipelineResponse, await self._client.container_registry.get_manifest(name=repository, reference=tag_or_digest, accept=SUPPORTED_MANIFEST_MEDIA_TYPES, cls=_return_response, **kwargs))
    ...
    async def upload_blob(self, repository: str, data: IO[bytes], **kwargs) -> Tuple[str, int]:
        ...
        """
        try:
            start_upload_response_headers = cast(Dict[str, str], await self._client.container_registry_blob.start_upload(repository, cls=_return_response_headers, **kwargs))
            (digest, location, blob_size) = await self._upload_blob_chunk(start_upload_response_headers['Location'], data, **kwargs)
            complete_upload_response_headers = cast(Dict[str, str], await self._client.container_registry_blob.complete_upload(digest=digest, next_link=location, cls=_return_response_headers, **kwargs))
    ...
    async def _upload_blob_chunk(self, location: str, data: IO[bytes], **kwargs) -> Tuple[str, str, int]:
        ...
        while len(buffer) > 0:
            try:
                ...
                response_headers = cast(Dict[str, str], await self._client.container_registry_blob.upload_chunk(location, buffer_stream, cls=_return_response_headers, **kwargs))
    ...
    async def download_blob(self, repository: str, digest: str, **kwargs) -> AsyncDownloadBlobStream:
        ...
        (first_chunk, headers) = cast(Tuple[PipelineResponse, Dict[str, str]], await self._client.container_registry_blob.get_chunk(repository, digest, range_header=f'bytes=0-{end_range}', cls=_return_response_and_headers, **kwargs))
        blob_size = _get_blob_size(headers)
        return AsyncDownloadBlobStream(response=first_chunk, digest=digest, get_next=functools.partial(self._client.container_registry_blob.get_chunk, name=repository, digest=digest, cls=_return_response_and_headers, **kwargs), blob_size=blob_size, downloaded=int(headers['Content-Length']), chunk_size=DEFAULT_CHUNK_SIZE)
