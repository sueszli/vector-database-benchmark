...
class InboxIssue(ProjectBaseModel):
    inbox = models.ForeignKey('db.Inbox', related_name='issue_inbox', on_delete=models.CASCADE)
    issue = models.ForeignKey('db.Issue', related_name='issue_inbox', on_delete=models.CASCADE)
    status = models.IntegerField(choices=((-2, 'Pending'), (-1, 'Rejected'), (0, 'Snoozed'), (1, 'Accepted'), (2, 'Duplicate')), default=-2)
    snoozed_till = models.DateTimeField(null=True)
    duplicate_to = models.ForeignKey('db.Issue', related_name='inbox_duplicate', on_delete=models.SET_NULL, null=True)
