...
EXAMPLE_VALIDATION_SPECIFICATION = [{'name': 'name', 'allow_empty': False}, {'name': 'description', 'allow_empty': False, 'optional': True}, {'name': 'availableMemoryMb', 'custom_validation': _int_greater_than_zero, 'optional': True}, {'name': 'labels', 'optional': True, 'type': 'dict'}, {'name': 'an_union', 'type': 'union', 'fields': [{'name': 'variant_1', 'regexp': '^.+$'}, {'name': 'variant_2', 'regexp': '^.+$', 'api_version': 'v1beta2'}, {'name': 'variant_3', 'type': 'dict', 'fields': [{'name': 'url', 'regexp': '^.+$'}]}, {'name': 'variant_4'}]}]
