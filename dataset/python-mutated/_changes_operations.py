...
class ChangesOperations:
    ...
    list_changes_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ChangeAnalysis/changes'}
    ...
    def list_changes_by_subscription(self, start_time: datetime.datetime, end_time: datetime.datetime, skip_token: Optional[str]=None, **kwargs) -> AsyncIterable['_models.ChangeList']:
        ...
        async def get_next(next_link=None):
            ...
            return pipeline_response
        return AsyncItemPaged(get_next, extract_data)
    list_changes_by_subscription.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ChangeAnalysis/changes'}