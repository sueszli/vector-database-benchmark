...
ArrayCreatorRecord = collections.namedtuple('ArrayCreatorRecord', ['array_fun', 'etype', 'pbfield'])
float_arrays = [ArrayCreatorRecord(NumpyArrayF32, xla_data_pb2.F32, operator.attrgetter('f32s')), ArrayCreatorRecord(NumpyArrayF64, xla_data_pb2.F64, operator.attrgetter('f64s'))]
int_arrays = [ArrayCreatorRecord(NumpyArrayS32, xla_data_pb2.S32, operator.attrgetter('s32s')), ArrayCreatorRecord(NumpyArrayS64, xla_data_pb2.S64, operator.attrgetter('f64s'))]
