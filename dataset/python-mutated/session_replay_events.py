...
from posthog.hogql.database.models import Table, StringDatabaseField, DateTimeDatabaseField, IntegerDatabaseField, LazyJoin, FieldTraverser, DatabaseField, LazyTable, FieldOrTable
from posthog.hogql.database.schema.person_distinct_ids import PersonDistinctIdsTable, join_with_person_distinct_ids_table
from posthog.schema import HogQLQueryModifiers
SESSION_REPLAY_EVENTS_COMMON_FIELDS: Dict[str, FieldOrTable] = {'session_id': StringDatabaseField(name='session_id'), 'team_id': IntegerDatabaseField(name='team_id'), 'distinct_id': StringDatabaseField(name='distinct_id'), 'min_first_timestamp': DateTimeDatabaseField(name='min_first_timestamp'), 'max_last_timestamp': DateTimeDatabaseField(name='max_last_timestamp'), 'first_url': DatabaseField(name='first_url'), 'click_count': IntegerDatabaseField(name='click_count'), 'keypress_count': IntegerDatabaseField(name='keypress_count'), 'mouse_activity_count': IntegerDatabaseField(name='mouse_activity_count'), 'active_milliseconds': IntegerDatabaseField(name='active_milliseconds'), 'console_log_count': IntegerDatabaseField(name='console_log_count'), 'console_warn_count': IntegerDatabaseField(name='console_warn_count'), 'console_error_count': IntegerDatabaseField(name='console_error_count'), 'size': IntegerDatabaseField(name='size'), 'event_count': IntegerDatabaseField(name='event_count'), 'message_count': IntegerDatabaseField(name='message_count'), 'pdi': LazyJoin(from_field='distinct_id', join_table=PersonDistinctIdsTable(), join_function=join_with_person_distinct_ids_table), 'person': FieldTraverser(chain=['pdi', 'person']), 'person_id': FieldTraverser(chain=['pdi', 'person_id'])}

class RawSessionReplayEventsTable(Table):
    fields: Dict[str, FieldOrTable] = {**SESSION_REPLAY_EVENTS_COMMON_FIELDS, 'min_first_timestamp': DateTimeDatabaseField(name='min_first_timestamp'), 'max_last_timestamp': DateTimeDatabaseField(name='max_last_timestamp'), 'first_url': DatabaseField(name='first_url')}
...
class SessionReplayEventsTable(LazyTable):
    fields: Dict[str, FieldOrTable] = {**SESSION_REPLAY_EVENTS_COMMON_FIELDS, 'start_time': DateTimeDatabaseField(name='start_time'), 'end_time': DateTimeDatabaseField(name='end_time'), 'first_url': StringDatabaseField(name='first_url')}
