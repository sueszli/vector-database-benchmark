...
Example usage:
    python create_job_with_embedded_captions.py --project_id <project-id> --location <location>       --input_video_uri <uri> --input_captions_uri <uri> --output_uri <uri>
"""
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_captions_uri', help='Uri of the input captions file in the Cloud Storage bucket.', required=True)
    ...
    create_job_with_embedded_captions(args.project_id, args.location, args.input_video_uri, args.input_captions_uri, args.output_uri)