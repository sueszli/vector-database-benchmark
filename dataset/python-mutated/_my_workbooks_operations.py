...
class MyWorkbooksOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, category: Union[str, _models.CategoryType], tags: Optional[List[str]]=None, can_fetch_content: Optional[bool]=None, **kwargs: Any) -> AsyncIterable['_models.MyWorkbook']:
        if False:
            print('Hello World!')
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_by_resource_group_request(resource_group_name=resource_group_name, subscription_id=self._config.subscription_id, category=category, tags=tags, can_fetch_content=can_fetch_content, api_version=api_version, template_url=self.list_by_resource_group.metadata['url'], headers=_headers, params=_params)
    ...
    list_by_resource_group.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/myWorkbooks'}

    @distributed_trace
    def list_by_subscription(self, category: Union[str, _models.CategoryType], tags: Optional[List[str]]=None, can_fetch_content: Optional[bool]=None, **kwargs: Any) -> AsyncIterable['_models.MyWorkbook']:
        if False:
            i = 10
            return i + 15
    ...
    async def get(self, resource_group_name: str, resource_name: str, **kwargs: Any) -> _models.MyWorkbook:
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/myWorkbooks/{resourceName}'}
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/myWorkbooks/{resourceName}'}

    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: _models.MyWorkbook, *, content_type: str='application/json', **kwargs: Any) -> _models.MyWorkbook:
    ...
    @overload
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.MyWorkbook:
        """Create a new private workbook.
    ...
    @distributed_trace_async
    async def create_or_update(self, resource_group_name: str, resource_name: str, workbook_properties: Union[_models.MyWorkbook, IO], **kwargs: Any) -> _models.MyWorkbook:
        """Create a new private workbook.
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/myWorkbooks/{resourceName}'}

    @overload
    async def update(self, resource_group_name: str, resource_name: str, workbook_properties: _models.MyWorkbook, *, content_type: str='application/json', **kwargs: Any) -> _models.MyWorkbook:
    ...
    @overload
    async def update(self, resource_group_name: str, resource_name: str, workbook_properties: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.MyWorkbook:
        """Updates a private workbook that has already been added.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, resource_name: str, workbook_properties: Union[_models.MyWorkbook, IO], **kwargs: Any) -> _models.MyWorkbook:
        """Updates a private workbook that has already been added.
        ...
        if cls:
            return cls(pipeline_response, deserialized, {})
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/myWorkbooks/{resourceName}'}