...
class MioMioIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.miomio.tv/watch/cc88912/', 'info_dict': {'id': '88912', 'ext': 'flv', 'title': '【SKY】字幕 铠武昭和VS平成 假面骑士大战FEAT战队 魔星字幕组 字幕', 'duration': 5923}, 'skip': 'Unable to load videos'}, {'url': 'http://www.miomio.tv/watch/cc184024/', 'info_dict': {'id': '43729', 'title': '《动漫同人插画绘制》'}, 'playlist_mincount': 86, 'skip': 'Unable to load videos'}, {'url': 'http://www.miomio.tv/watch/cc173113/', 'info_dict': {'id': '173113', 'title': 'The New Macbook 2015 上手试玩与简评'}, 'playlist_mincount': 2, 'skip': 'Unable to load videos'}, {'url': 'http://www.miomio.tv/watch/cc273997/', 'md5': '0b27a4b4495055d826813f8c3a6b2070', 'info_dict': {'id': '273997', 'ext': 'mp4', 'title': 'マツコの知らない世界【劇的進化SP！ビニール傘＆冷凍食品2016】 1_2 - 16 05 31'}, 'skip': 'Unable to load videos'}]
