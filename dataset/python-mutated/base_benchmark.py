...
import keras
FLAGS = flags.FLAGS
flags.DEFINE_string('benchmark_name', None, 'The name of benchmark to run. If None, all benchmarks in the file will be run.')
flags.DEFINE_integer('num_samples', 1000, 'Number of input data samples.')
flags.DEFINE_integer('batch_size', 20, 'Batch size of data.')
flags.DEFINE_bool('jit_compile', True, 'If True, the benchmark will run with XLA compilation.')
