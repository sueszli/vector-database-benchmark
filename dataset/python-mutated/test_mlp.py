...
from sklearn.datasets import load_digits, load_iris, make_multilabel_classification, make_regression
...
classification_datasets = [(X_digits_multi, y_digits_multi), (X_digits_binary, y_digits_binary)]
