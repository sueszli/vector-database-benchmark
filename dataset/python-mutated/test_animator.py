...
async def test_animator():
    ...
    expected = SimpleAnimation(animate_test, 'foo', 0.0, duration=10.0, start_value=0.0, end_value=100.0, final_value=100.0, easing=EASING[DEFAULT_EASING])
