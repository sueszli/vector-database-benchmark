...
URI_CONNECTION = pytest.param('postgres://my-login:my-pass@my-host:5432/my-schema?param1=val1&param2=val2', id='uri-connection')
JSON_CONNECTION = pytest.param(json.dumps({'conn_type': 'postgres', 'login': 'my-login', 'password': 'my-pass', 'host': 'my-host', 'port': 5432, 'schema': 'my-schema', 'extra': {'param1': 'val1', 'param2': 'val2'}}), id='json-connection')
