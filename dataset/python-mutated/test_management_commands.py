...
from wagtail.models import Collection, Page, PageLogEntry, Revision, Task, Workflow, WorkflowTask
from wagtail.signals import page_published, page_unpublished, published, unpublished
from wagtail.test.testapp.models import DraftStateModel, EventPage, FullFeaturedSnippet, PurgeRevisionsProtectedTestModel, SecretPage, SimplePage
...
class TestPurgeRevisionsCommandForPagesWithNonPagesOnly(TestPurgeRevisionsCommandForPages):
...
class TestPurgeRevisionsCommandForSnippetsWithNonPagesOnly(TestPurgeRevisionsCommandForSnippets):
    base_options = {'non_pages': True}

class TestPurgeRevisionsCommandForSnippetsWithPagesOnly(TestPurgeRevisionsCommandForSnippets):
    base_options = {'pages': True}
