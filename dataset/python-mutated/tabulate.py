...
LATEX_ESCAPE_RULES = {'&': '\\&', '%': '\\%', '$': '\\$', '#': '\\#', '_': '\\_', '^': '\\^{}', '{': '\\{', '}': '\\}', '~': '\\textasciitilde{}', '\\': '\\textbackslash{}', '<': '\\ensuremath{<}', '>': '\\ensuremath{>}'}
...
_ansi_color_reset_code = '\x1b[0m'
_float_with_thousands_separators = re.compile('^(([+-]?[0-9]{1,3})(?:,([0-9]{3}))*)?(?(1)\\.[0-9]*|\\.[0-9]+)?$')
