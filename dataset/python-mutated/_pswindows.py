...
if PY3:
    ...
    enum = None
__extra__all__ = ['win_service_iter', 'win_service_get', 'ABOVE_NORMAL_PRIORITY_CLASS', 'BELOW_NORMAL_PRIORITY_CLASS', 'HIGH_PRIORITY_CLASS', 'IDLE_PRIORITY_CLASS', 'NORMAL_PRIORITY_CLASS', 'REALTIME_PRIORITY_CLASS', 'IOPRIO_VERYLOW', 'IOPRIO_LOW', 'IOPRIO_NORMAL', 'IOPRIO_HIGH', 'CONN_DELETE_TCB', 'AF_LINK']
