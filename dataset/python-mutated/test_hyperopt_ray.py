...
HYPEROPT_CONFIG = {'parameters': {'trainer.learning_rate': {'space': 'loguniform', 'lower': 0.001, 'upper': 0.1}, 'combiner.num_fc_layers': {'space': 'randint', 'lower': 0, 'upper': 2}, 'utterance.encoder.norm': {'space': 'grid_search', 'values': ['layer', 'batch']}, 'utterance.encoder.fc_layers': {'space': 'choice', 'categories': [[{'output_size': 16}, {'output_size': 8}], [{'output_size': 16}], [{'output_size': 8}]]}}, 'goal': 'minimize'}
SCENARIOS = [{'executor': {'type': 'ray'}, 'search_alg': {'type': 'variant_generator'}}, {'executor': {'type': 'ray', 'num_samples': 2}, 'search_alg': {'type': 'variant_generator'}}, {'executor': {'type': 'ray', 'num_samples': 3, 'scheduler': {'type': 'hb_bohb', 'time_attr': 'training_iteration', 'reduction_factor': 4}}, 'search_alg': {'type': 'bohb'}}]
