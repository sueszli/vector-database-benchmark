...
class TVAIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://videos.tva.ca/details/_5596811470001', 'info_dict': {'id': '5596811470001', 'ext': 'mp4', 'title': "Un extrait de l'épisode du dimanche 8 octobre 2017 !", 'uploader_id': '5481942443001', 'upload_date': '20171003', 'timestamp': 1507064617}, 'params': {'skip_download': True}, 'skip': 'HTTP Error 404: Not Found'}, {'url': 'https://video.tva.ca/details/_5596811470001', 'only_matching': True}]
...
class QubIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.qub.ca/tvaplus/tva/alerte-amber/saison-1/episode-01-1000036619', 'md5': '949490fd0e7aee11d0543777611fbd53', 'info_dict': {'id': '6084352463001', 'ext': 'mp4', 'title': 'Épisode 01', 'uploader_id': '5481942443001', 'upload_date': '20190907', 'timestamp': 1567899756, 'description': 'md5:9c0d7fbb90939420c651fd977df90145'}}, {'url': 'https://www.qub.ca/tele/video/lcn-ca-vous-regarde-rev-30s-ap369664-1009357943', 'only_matching': True}]
