...
import kconfiglib
import os
OPT_SETTINGS = ['CONFIG_ESP_ERR_TO_NAME_LOOKUP', 'CONFIG_ESP_CONSOLE_', 'CONFIG_CONSOLE_UART_', 'CONFIG_ESP_SYSTEM_PANIC_', 'CONFIG_ESP32S2_PANIC_', 'COMPILER_OPTIMIZATION_', 'CONFIG_ESP32S3_DEBUG_OCDAWARE', 'CONFIG_FREERTOS_ASSERT_', 'CONFIG_FREERTOS_DEBUG_OCDAWARE', 'CONFIG_FREERTOS_TASK_FUNCTION_WRAPPER', 'CONFIG_HAL_ASSERTION_', 'CONFIG_LWIP_ESP_LWIP_ASSERT', 'CONFIG_OPTIMIZATION_ASSERTION_LEVEL', 'CONFIG_OPTIMIZATION_ASSERTIONS_', 'CONFIG_HAL_DEFAULT_ASSERTION_LEVEL', 'CONFIG_BOOTLOADER_LOG_LEVEL', 'LOG_DEFAULT_LEVEL']
TARGET_SETTINGS = ['CONFIG_IDF_TARGET', 'CONFIG_IDF_FIRMWARE_CHIP_ID', 'CONFIG_BOOTLOADER_OFFSET_IN_FLASH', 'CONFIG_ESP_SLEEP_POWER_DOWN_FLASH', 'CONFIG_ESP_SYSTEM_SINGLE_CORE_MODE', 'CONFIG_ESP_SYSTEM_MEMPROT_', 'CONFIG_ESP_MAIN_TASK_AFFINITY', 'CONFIG_ESP_WIFI_EXTERNAL_COEXIST_ENABLE', 'CONFIG_FREERTOS_UNICORE', 'CONFIG_FREERTOS_TICK_SUPPORT_CORETIMER', 'CONFIG_FREERTOS_CORETIMER_0', 'CONFIG_FREERTOS_CORETIMER_1', 'CONFIG_FREERTOS_SYSTICK_USES_CCOUNT', 'CONFIG_FREERTOS_OPTIMIZED_SCHEDULER', 'CONFIG_MBEDTLS_HARDWARE_GCM', 'CONFIG_ESP_SYSTEM_PD_FLASH', 'CONFIG_EXTERNAL_COEX_ENABLE', 'CONFIG_SDK_TOOLPREFIX', 'CONFIG_TOOLPREFIX', 'ESP_SLEEP_GPIO_RESET_WORKAROUND', 'CONFIG_ESP_PHY_ENABLE_USB', 'CONFIG_BT_SOC_SUPPORT_5_0', 'CONFIG_NIMBLE_PINNED_TO_CORE', 'CONFIG_BT_NIMBLE_PINNED_TO_CORE', 'CONFIG_BT_CTRL_PINNED_TO_CORE', 'CONFIG_SPIRAM_SPEED_2', 'CONFIG_SPIRAM_BANKSWITCH_ENABLE']
BOARD_SETTINGS = ['CONFIG_LWIP_LOCAL_HOSTNAME']
FLASH_SIZE_SETTINGS = ['CONFIG_ESPTOOLPY_FLASHSIZE', 'CONFIG_PARTITION_TABLE_CUSTOM_FILENAME', 'CONFIG_PARTITION_TABLE_FILENAME']
FLASH_MODE_SETTINGS = ['CONFIG_ESPTOOLPY_FLASHMODE_', 'CONFIG_ESPTOOLPY_OCT_FLASH', 'CONFIG_ESPTOOLPY_FLASH_SAMBLE_MODE_']
FLASH_FREQ_SETTINGS = ['CONFIG_ESPTOOLPY_FLASHFREQ_']
