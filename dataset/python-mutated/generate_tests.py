...
from torch.testing._internal.optests import aot_autograd_check, autograd_registration_check, fake_check
...
ALL_TEST_UTILS = {'test_schema': safe_schema_check, 'test_autograd_registration': safe_autograd_registration_check, 'test_faketensor': safe_fake_check, 'test_aot_dispatch_static': functools.partial(safe_aot_autograd_check, dynamic=False), 'test_aot_dispatch_dynamic': functools.partial(safe_aot_autograd_check, dynamic=True)}
GDOC = 'https://docs.google.com/document/d/1Pj5HRZvdOq3xpFpbEjUZp2hBovhy7Wnxw14m6lF2154/edit'
DEFAULT_TEST_UTILS = ['test_schema', 'test_autograd_registration', 'test_faketensor', 'test_aot_dispatch_static', 'test_aot_dispatch_dynamic']
...
VERSION = 1
DESCRIPTION = f'This is a dict containing failures for tests autogenerated by generate_opcheck_tests. For more details, please see {GDOC}'
