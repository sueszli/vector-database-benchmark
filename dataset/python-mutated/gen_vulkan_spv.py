...
typeIdMapping = {'image[123]D\\b': 'VK_DESCRIPTOR_TYPE_STORAGE_IMAGE', 'sampler[123]D\\b': 'VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER', '\\bbuffer\\b': 'VK_DESCRIPTOR_TYPE_STORAGE_BUFFER', '\\buniform\\b': 'VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER'}
storageTypeToEnum = {'TEXTURE_2D': 'api::StorageType::TEXTURE_2D', 'TEXTURE_3D': 'api::StorageType::TEXTURE_3D', 'BUFFER': 'api::StorageType::BUFFER', '': 'api::StorageType::UNKNOWN'}
