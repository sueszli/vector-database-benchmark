"""Generate models in testdata for use in tests.
...
TESTDATA_PATH = flags.DEFINE_string('path', None, help='Path to testdata directory.')
MODEL_NAME = flags.DEFINE_string('model_name', None, help='Name of model to generate.')
...
class SimpleModel(module.Module):
    ...
    def test_add(self, x, y):
        if False:
            return 10
        return x + y
TEST_MODELS = {'simple-model': SimpleModel, 'data-structure-model': DataStructureModel}
