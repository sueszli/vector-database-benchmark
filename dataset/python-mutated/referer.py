...
import warnings
from typing import TYPE_CHECKING, Any, AsyncIterable, Dict, Iterable, Optional, Tuple, Type, Union, cast
...
LOCAL_SCHEMES: Tuple[str, ...] = ('about', 'blob', 'data', 'filesystem')
...
_policy_classes: Dict[str, Type[ReferrerPolicy]] = {p.name: p for p in (NoReferrerPolicy, NoReferrerWhenDowngradePolicy, SameOriginPolicy, OriginPolicy, StrictOriginPolicy, OriginWhenCrossOriginPolicy, StrictOriginWhenCrossOriginPolicy, UnsafeUrlPolicy, DefaultReferrerPolicy)}
