...
ls = fou.lazy_import('label_studio_sdk', callback=lambda : fou.ensure_import('label_studio_sdk>=0.0.13'))
brush = fou.lazy_import('label_studio_converter.brush', callback=lambda : fou.ensure_import('label_studio_converter.brush'))
...
def _get_label_ids(label):
    ...
    return ids
_LABEL_TYPES = {'classification': dict(parent_tag='Choices', child_tag='Choice', label=fol.Classification, tag_kwargs={'choice': 'single-radio'}), 'classifications': dict(parent_tag='Choices', child_tag='Choice', label=fol.Classification, tag_kwargs={'choice': 'multiple'}), 'detections': dict(parent_tag='RectangleLabels', child_tag='Label', label=fol.Detection), 'instances': dict(parent_tag='BrushLabels', child_tag='Label', label=fol.Detection), 'polylines': dict(parent_tag='PolygonLabels', child_tag='Label', label=fol.Polyline), 'keypoints': dict(parent_tag='KeyPointLabels', child_tag='Label', label=fol.Keypoint), 'segmentation': dict(parent_tag='BrushLabels', child_tag='Label', label=fol.Segmentation), 'scalar': dict(parent_tag='Number', child_tag=None, label=fol.Regression)}
