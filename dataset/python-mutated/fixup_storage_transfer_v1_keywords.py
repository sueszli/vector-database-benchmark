...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=storage_transferCallTransformer()):
    if False:
        print('Hello World!')
