...
MONGODB_SEEDLIST_URI = 'srv://celeryuser:celerypassword@dns-seedlist-host.example.com/celerydatabase'
MONGODB_BACKEND_HOST = ['mongo1.example.com:27017', 'mongo2.example.com:27017', 'mongo3.example.com:27017']
...
class test_MongoBackend:
    ...
    sanitized_replica_set_url = 'mongodb://uuuu:**@hostname.dom/,hostname.dom/database?replicaSet=rs'
...
@pytest.mark.parametrize('serializer,encoded_into', [('bson', int), ('json', str), ('pickle', Binary), ('msgpack', Binary), ('yaml', str)])
...
SUCCESS_RESULT_TEST_DATA = [{'result': 'A simple string', 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': 100, 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': 9.2, 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': {'foo': 'simple result'}, 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': ['a', 'b'], 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': False, 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': None, 'serializers': ['bson', 'pickle', 'yaml', 'json', 'msgpack']}, {'result': datetime.datetime(2000, 1, 1, 0, 0, 0, 0), 'serializers': ['bson', 'pickle', 'yaml']}, {'result': datetime.datetime(2000, 1, 1, 0, 0, 0, 0, tzinfo=ZoneInfo('UTC')), 'serializers': ['pickle', 'yaml']}, {'result': _MyTestClass('Hi!'), 'serializers': ['pickle']}]
