...
class RXXGate(Gate):
    ...
    **Examples:**
    ...
    def _define(self):
        ...
        rules = [(HGate(), [q[0]], []), (HGate(), [q[1]], []), (CXGate(), [q[0], q[1]], []), (RZGate(theta), [q[1]], []), (CXGate(), [q[0], q[1]], []), (HGate(), [q[1]], []), (HGate(), [q[0]], [])]
    ...
    def __array__(self, dtype=None):
        ...
        return numpy.array([[cos, 0, 0, -isin], [0, cos, -isin, 0], [0, -isin, cos, 0], [-isin, 0, 0, cos]], dtype=dtype)
