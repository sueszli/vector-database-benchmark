...
class CatboostRegressor(BaseRegressionModel):
    ...
    def fit(self, data_dictionary: Dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        model = CatBoostRegressor(allow_writing_files=True, train_dir=Path(dk.data_path), **self.model_training_parameters)
        model.fit(X=train_data, eval_set=test_data, init_model=init_model, log_cout=sys.stdout, log_cerr=sys.stderr)
        return model