...
_TRINO_TO_PA_TYPE_MAP = {'null': pa.null(), 'boolean': pa.bool_(), 'date': pa.date32(), 'tinyint': pa.int8(), 'smallint': pa.int16(), 'integer': pa.int32(), 'bigint': pa.int64(), 'double': pa.float64(), 'binary': pa.binary(), 'char': pa.string()}
