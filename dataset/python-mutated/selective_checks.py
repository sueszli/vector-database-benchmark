...
from airflow_breeze.global_constants import ALL_PYTHON_MAJOR_MINOR_VERSIONS, APACHE_AIRFLOW_GITHUB_REPOSITORY, COMMITTERS, CURRENT_KUBERNETES_VERSIONS, CURRENT_MSSQL_VERSIONS, CURRENT_MYSQL_VERSIONS, CURRENT_POSTGRES_VERSIONS, CURRENT_PYTHON_MAJOR_MINOR_VERSIONS, DEFAULT_KUBERNETES_VERSION, DEFAULT_MSSQL_VERSION, DEFAULT_MYSQL_VERSION, DEFAULT_POSTGRES_VERSION, DEFAULT_PYTHON_MAJOR_MINOR_VERSION, HELM_VERSION, KIND_VERSION, RUNS_ON_PUBLIC_RUNNER, RUNS_ON_SELF_HOSTED_RUNNER, SELF_HOSTED_RUNNERS_CPU_COUNT, GithubEvents, SelectiveUnitTestTypes, all_helm_test_packages, all_selective_test_types
...
from airflow_breeze.utils.path_utils import AIRFLOW_PROVIDERS_ROOT, AIRFLOW_SOURCES_ROOT, DOCS_DIR, SYSTEM_TESTS_PROVIDERS_ROOT, TESTS_PROVIDERS_ROOT
...
ALL_CI_SELECTIVE_TEST_TYPES = 'API Always BranchExternalPython BranchPythonVenv CLI Core ExternalPython Operators Other PlainAsserts Providers[-amazon,google] Providers[amazon] Providers[google] PythonVenv Serialization WWW'
...
CI_FILE_GROUP_MATCHES = HashableDict({FileGroupForCi.ENVIRONMENT_FILES: ['^.github/workflows', '^dev/breeze', '^dev/.*\\.py$', '^Dockerfile', '^scripts', '^setup.py', '^setup.cfg', '^generated/provider_dependencies.json$'], FileGroupForCi.PYTHON_PRODUCTION_FILES: ['^airflow/.*\\.py', '^setup.py'], FileGroupForCi.JAVASCRIPT_PRODUCTION_FILES: ['^airflow/.*\\.[jt]sx?', '^airflow/.*\\.lock'], FileGroupForCi.API_TEST_FILES: ['^airflow/api/', '^airflow/api_connexion/'], FileGroupForCi.API_CODEGEN_FILES: ['^airflow/api_connexion/openapi/v1\\.yaml', '^clients/gen'], FileGroupForCi.HELM_FILES: ['^chart', '^airflow/kubernetes', '^tests/kubernetes', '^helm_tests'], FileGroupForCi.SETUP_FILES: ['^pyproject.toml', '^setup.cfg', '^setup.py', '^generated/provider_dependencies.json$'], FileGroupForCi.DOC_FILES: ['^docs', '^\\.github/SECURITY\\.rst$', '^airflow/.*\\.py$', '^chart', '^providers', '^tests/system', '^CHANGELOG\\.txt', '^airflow/config_templates/config\\.yml', '^chart/RELEASE_NOTES\\.txt', '^chart/values\\.schema\\.json', '^chart/values\\.json'], FileGroupForCi.WWW_FILES: ['^airflow/www/.*\\.ts[x]?$', '^airflow/www/.*\\.js[x]?$', '^airflow/www/[^/]+\\.json$', '^airflow/www/.*\\.lock$'], FileGroupForCi.KUBERNETES_FILES: ['^chart', '^kubernetes_tests', '^airflow/providers/cncf/kubernetes/', '^tests/providers/cncf/kubernetes/', '^tests/system/providers/cncf/kubernetes/'], FileGroupForCi.ALL_PYTHON_FILES: ['.*\\.py$'], FileGroupForCi.ALL_AIRFLOW_PYTHON_FILES: ['.*\\.py$'], FileGroupForCi.ALL_PROVIDERS_PYTHON_FILES: ['^airflow/providers/.*\\.py$', '^tests/providers/.*\\.py$', '^tests/system/providers/.*\\.py$'], FileGroupForCi.ALL_DOCS_PYTHON_FILES: ['^docs/.*\\.py$'], FileGroupForCi.ALL_DEV_PYTHON_FILES: ['^dev/.*\\.py$'], FileGroupForCi.ALL_SOURCE_FILES: ['^.pre-commit-config.yaml$', '^airflow', '^chart', '^tests', '^kubernetes_tests'], FileGroupForCi.SYSTEM_TEST_FILES: ['^tests/system/'], FileGroupForCi.ALWAYS_TESTS_FILES: ['^tests/always/'], FileGroupForCi.ALL_PROVIDER_YAML_FILES: ['.*/provider\\.yaml$']})
CI_FILE_GROUP_EXCLUDES = HashableDict({FileGroupForCi.ALL_AIRFLOW_PYTHON_FILES: ['^.*/.*_vendor/.*', '^airflow/migrations/.*', '^airflow/providers/.*', '^dev/.*', '^docs/.*', '^provider_packages/.*', '^tests/providers/.*', '^tests/system/providers/.*', '^tests/dags/test_imports.py']})
TEST_TYPE_MATCHES = HashableDict({SelectiveUnitTestTypes.API: ['^airflow/api', '^airflow/api_connexion', '^tests/api', '^tests/api_connexion'], SelectiveUnitTestTypes.CLI: ['^airflow/cli', '^tests/cli'], SelectiveUnitTestTypes.OPERATORS: ['^airflow/operators', '^tests/operators'], SelectiveUnitTestTypes.PROVIDERS: ['^airflow/providers/', '^tests/system/providers/', '^tests/providers/'], SelectiveUnitTestTypes.PYTHON_VENV: ['^tests/operators/test_python.py'], SelectiveUnitTestTypes.BRANCH_PYTHON_VENV: ['^tests/operators/test_python.py'], SelectiveUnitTestTypes.WWW: ['^airflow/www', '^tests/www']})
