...
from megengine.core.tensor.dtype import _builtin_quant_dtypes, convert_from_qint1, convert_from_qint4, convert_from_qint8, convert_from_quint4, convert_from_quint8, convert_to_qint1, convert_to_qint4, convert_to_qint8, convert_to_quint4, convert_to_quint8, get_scale, get_zero_point, is_quantize, qint1, qint4, qint8, quint4, quint8
