...
import inspect
import re
from spyder_kernels.utils.lazymodules import bs4, FakeObject, numpy as np, pandas as pd, PIL
...
def globalsfilter(input_dict, check_all=False, filters=None, exclude_private=None, exclude_capitalized=None, exclude_uppercase=None, exclude_unsupported=None, excluded_names=None, exclude_callables_and_modules=None, filter_on=True):
    ...
    return output_dict
REMOTE_SETTINGS = ('check_all', 'exclude_private', 'exclude_uppercase', 'exclude_capitalized', 'exclude_unsupported', 'excluded_names', 'minmax', 'show_callable_attributes', 'show_special_attributes', 'exclude_callables_and_modules', 'filter_on')
