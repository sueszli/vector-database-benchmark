...
from .operations import CreationSupportedOperations, MarketplaceAgreementsOperations, MonitoredSubscriptionsOperations, MonitorsOperations, Operations, SingleSignOnConfigurationsOperations, TagRulesOperations
if TYPE_CHECKING:
...
class MicrosoftDatadogClient:
    ...
    def __init__(self, credential: 'AsyncTokenCredential', subscription_id: str, base_url: str='https://management.azure.com', **kwargs: Any) -> None:
        ...
        self.creation_supported = CreationSupportedOperations(self._client, self._config, self._serialize, self._deserialize)
        ...
        self.monitored_subscriptions = MonitoredSubscriptionsOperations(self._client, self._config, self._serialize, self._deserialize)
