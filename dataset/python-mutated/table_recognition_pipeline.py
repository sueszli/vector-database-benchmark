...
from modelscope.pipelines.cv.ocr_utils.table_process import bbox_decode, bbox_post_process, gbox_decode, gbox_post_process, get_affine_transform, group_bbox_by_gbox, nms
...
@PIPELINES.register_module(Tasks.table_recognition, module_name=Pipelines.table_recognition)
