...
class WarehouseUpdate(WarehouseMixin, ModelWithExtRefMutation):
    ...
    class Arguments:
        ...
        input = WarehouseUpdateInput(required=True, description='Fields required to update warehouse.')
        external_reference = graphene.String(required=False, description='External reference of a warehouse.' + ADDED_IN_316)
