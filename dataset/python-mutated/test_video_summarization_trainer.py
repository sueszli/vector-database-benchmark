...
from modelscope.msdatasets.dataset_cls.custom_datasets import VideoSummarizationDataset
...
class VideoSummarizationTrainerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dataset_train = VideoSummarizationDataset('train', self.config.dataset, self.cache_path)
        self.dataset_val = VideoSummarizationDataset('test', self.config.dataset, self.cache_path)
