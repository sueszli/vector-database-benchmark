...
class CreateServiceRequest(proto.Message):
    ...
    service_id: str = proto.Field(proto.STRING, number=3)
    service: gm_service.Service = proto.Field(proto.MESSAGE, number=2, message=gm_service.Service)
...
class ListServicesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    services: MutableSequence[gm_service.Service] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_service.Service)
...
class UpdateServiceRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            use for the update.
    """
    service: gm_service.Service = proto.Field(proto.MESSAGE, number=1, message=gm_service.Service)
...
class CreateServiceLevelObjectiveRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    service_level_objective_id: str = proto.Field(proto.STRING, number=3)
    service_level_objective: gm_service.ServiceLevelObjective = proto.Field(proto.MESSAGE, number=2, message=gm_service.ServiceLevelObjective)
...
class GetServiceLevelObjectiveRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    view: gm_service.ServiceLevelObjective.View = proto.Field(proto.ENUM, number=2, enum=gm_service.ServiceLevelObjective.View)
...
class ListServiceLevelObjectivesRequest(proto.Message):
    ...
    page_size: int = proto.Field(proto.INT32, number=3)
    page_token: str = proto.Field(proto.STRING, number=4)
    view: gm_service.ServiceLevelObjective.View = proto.Field(proto.ENUM, number=5, enum=gm_service.ServiceLevelObjective.View)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    service_level_objectives: MutableSequence[gm_service.ServiceLevelObjective] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_service.ServiceLevelObjective)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class UpdateServiceLevelObjectiveRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            use for the update.
    """
    service_level_objective: gm_service.ServiceLevelObjective = proto.Field(proto.MESSAGE, number=1, message=gm_service.ServiceLevelObjective)
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
