...
class Test_opensearch_service_domains_audit_logging_enabled:
    ...
    def test_no_domains(self):
        ...
        with mock.patch('prowler.providers.aws.services.opensearch.opensearch_service.OpenSearchService', opensearch_client):
            from prowler.providers.aws.services.opensearch.opensearch_service_domains_audit_logging_enabled.opensearch_service_domains_audit_logging_enabled import opensearch_service_domains_audit_logging_enabled
    ...
    def test_logging_AUDIT_LOGS_enabled(self):
        ...
        opensearch_client.opensearch_domains.append(OpenSearchDomain(name=domain_name, region=AWS_REGION, arn=domain_arn))
        opensearch_client.opensearch_domains[0].logging = []
        opensearch_client.opensearch_domains[0].logging.append(PublishingLoggingOption(name='AUDIT_LOGS', enabled=True))
        with mock.patch('prowler.providers.aws.services.opensearch.opensearch_service.OpenSearchService', opensearch_client):
            from prowler.providers.aws.services.opensearch.opensearch_service_domains_audit_logging_enabled.opensearch_service_domains_audit_logging_enabled import opensearch_service_domains_audit_logging_enabled
            check = opensearch_service_domains_audit_logging_enabled()
            result = check.execute()
