...
class CCCPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://media.ccc.de/c/30c3', 'info_dict': {'title': '30C3', 'id': '30c3'}, 'playlist_count': 135}, {'url': 'https://media.ccc.de/c/DS2023', 'info_dict': {'title': 'Datenspuren 2023', 'id': 'DS2023'}, 'playlist_count': 37}]
