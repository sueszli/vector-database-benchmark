...
from tests.test_downloader_handlers import Http11MockServerTestCase, Http11ProxyTestCase, Https11CustomCiphers, Https11TestCase, UriResource
...
class Https2WrongHostnameTestCase(Https2TestCase):
    tls_log_message = 'SSL connection certificate: issuer "/C=XW/ST=XW/L=The Internet/O=Scrapy/CN=www.example.com/emailAddress=test@example.com", subject "/C=XW/ST=XW/L=The Internet/O=Scrapy/CN=www.example.com/emailAddress=test@example.com"'
...
class Http2MockServerTestCase(Http11MockServerTestCase):
    ...
    settings_dict = {'DOWNLOAD_HANDLERS': {'https': 'scrapy.core.downloader.handlers.http2.H2DownloadHandler'}}
