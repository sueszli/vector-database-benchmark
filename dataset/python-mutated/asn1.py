...
from typing import Any, AnyStr, Dict, Generic, List, Optional, Tuple, Type, Union, cast, TYPE_CHECKING
...
class ASN1_Class_UNIVERSAL(ASN1_Class):
    ...
    SEQUENCE = cast(ASN1Tag, 16 | 32)
    SET = cast(ASN1Tag, 17 | 32)
    NUMERIC_STRING = cast(ASN1Tag, 18)
    PRINTABLE_STRING = cast(ASN1Tag, 19)
    T61_STRING = cast(ASN1Tag, 20)
    ...
    ISO646_STRING = cast(ASN1Tag, 26)
    GENERAL_STRING = cast(ASN1Tag, 27)
    UNIVERSAL_STRING = cast(ASN1Tag, 28)
    CHAR_STRING = cast(ASN1Tag, 29)
    BMP_STRING = cast(ASN1Tag, 30)
    IPADDRESS = cast(ASN1Tag, 0 | 64)
    COUNTER32 = cast(ASN1Tag, 1 | 64)
    GAUGE32 = cast(ASN1Tag, 2 | 64)
    TIME_TICKS = cast(ASN1Tag, 3 | 64)
