...
WORKFLOW_DATA = [MacOsJob('10_15', is_build=True), MacOsJob('10_13', is_build=True), MacOsJob('10_13', is_build=False, is_test=True), MacOsJob('10_13', is_build=True, is_test=True, extra_props=tuple({'lite_interpreter': True}.items()))]
