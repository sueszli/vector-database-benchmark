...
@testing.parameterize(*testing.product({'x_dtype': [numpy.float16, numpy.float32, numpy.float64], 'W_dtype': [numpy.float32], 'use_static_graph': [True, False]}))
...
@testing.parameterize(*testing.product({'x_dtype': [numpy.float32], 'W_dtype': [numpy.float32]}))
...
@testing.parameterize(*testing.product({'x_dtype': [numpy.float16, numpy.float32, numpy.float64], 'use_static_graph': [True, False], 'use_gamma': [True, False], 'use_beta': [True, False]}))
