...
import unittest
import numpy as np
from dygraph_to_static_utils_new import Dy2StTestBase, compare_legacy_with_pir, test_ast_only
...
train_parameters = {'learning_strategy': {'name': 'cosine_decay', 'batch_size': BATCH_SIZE, 'epochs': [40, 80, 100], 'steps': [0.1, 0.01, 0.001, 0.0001]}, 'lr': 0.0125, 'total_images': 6149, 'momentum_rate': 0.9, 'l2_decay': 0.00012, 'num_epochs': 1}
