...
from fairseq.data import AppendTokenDataset, Dictionary, IdDataset, LMContextWindowDataset, MonolingualDataset, NestedDictionaryDataset, NumelDataset, PadDataset, PrependTokenDataset, SpeechDLMDataset, StripTokenDataset, TokenBlockDataset, TruncatedDictionary, data_utils
...
class SpeechDLMConfig(FairseqDataclass):
    ...
    channels: Optional[str] = field(default=None, metadata={'help': 'comma-separated list of channels to load e.g., "unitA,unitB"(default: load all possible channels in the data path)'})
    channel_weights: Optional[str] = field(default=None, metadata={'help': 'comma-separated list of weights for different losses(default: None, which means all losses are treated equally)'})
    ...
    next_unit_prediction: str = field(default='False', metadata={'help': "Perform Next Unit Prediction, expected str input ('True' or 'False')"})
    edge_unit_prediction: str = field(default='True', metadata={'help': "Perform Edge Unit Prediction, expected str input ('True' or 'False')"})
    duration_prediction: str = field(default='True', metadata={'help': "Perform Duration Prediction, expected str input ('True' or 'False')"})
    delayed_duration_target: str = field(default='True', metadata={'help': "Perform Delayed Duration Prediction, expected str input ('True' or 'False')(default: 'True')"})
    max_target_durations: Optional[int] = field(default=256, metadata={'help': 'max duration considered (cut off to this value)'})
