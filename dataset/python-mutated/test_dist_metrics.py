...
from sklearn.metrics._dist_metrics import BOOL_METRICS, DistanceMetric32, DistanceMetric64
...
X_bool = (X64 < 0.3).astype(np.float64)
Y_bool = (Y64 < 0.7).astype(np.float64)
[X_bool_mmap, Y_bool_mmap] = create_memmap_backed_data([X_bool, Y_bool])
V = rng.random_sample((d, d))
VI = np.dot(V, V.T)
METRICS_DEFAULT_PARAMS = [('euclidean', {}), ('cityblock', {}), ('minkowski', dict(p=(0.5, 1, 1.5, 2, 3))), ('chebyshev', {}), ('seuclidean', dict(V=(rng.random_sample(d),))), ('mahalanobis', dict(VI=(VI,))), ('hamming', {}), ('canberra', {}), ('braycurtis', {}), ('minkowski', dict(p=(0.5, 1, 1.5, 3), w=(rng.random_sample(d),)))]
