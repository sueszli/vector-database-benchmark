...
import proto
__protobuf__ = proto.module(package='google.cloud.dialogflow.cx.v3', manifest={'GetSecuritySettingsRequest', 'UpdateSecuritySettingsRequest', 'ListSecuritySettingsRequest', 'ListSecuritySettingsResponse', 'CreateSecuritySettingsRequest', 'DeleteSecuritySettingsRequest', 'SecuritySettings'})
...
class UpdateSecuritySettingsRequest(proto.Message):
    ...
    """
    security_settings: 'SecuritySettings' = proto.Field(proto.MESSAGE, number=1, message='SecuritySettings')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    security_settings: MutableSequence['SecuritySettings'] = proto.RepeatedField(proto.MESSAGE, number=1, message='SecuritySettings')
...
class CreateSecuritySettingsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    security_settings: 'SecuritySettings' = proto.Field(proto.MESSAGE, number=2, message='SecuritySettings')
...
class SecuritySettings(proto.Message):
    """Represents the settings related to security issues, such as
    ...
    class PurgeDataType(proto.Enum):
        """Type of data we purge after retention settings triggers
        purge.
    ...
    class AudioExportSettings(proto.Message):
        ...
        class AudioFormat(proto.Enum):
            ...
            MP3 = 2
            OGG = 3
        gcs_bucket: str = proto.Field(proto.STRING, number=1)
        audio_export_pattern: str = proto.Field(proto.STRING, number=2)
        enable_audio_redaction: bool = proto.Field(proto.BOOL, number=3)
        audio_format: 'SecuritySettings.AudioExportSettings.AudioFormat' = proto.Field(proto.ENUM, number=4, enum='SecuritySettings.AudioExportSettings.AudioFormat')
    ...
    class InsightsExportSettings(proto.Message):
        ...
        Attributes:
            enable_insights_export (bool):
                ...
                analyzers.
        """
        enable_insights_export: bool = proto.Field(proto.BOOL, number=1)
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    redaction_strategy: RedactionStrategy = proto.Field(proto.ENUM, number=3, enum=RedactionStrategy)
    redaction_scope: RedactionScope = proto.Field(proto.ENUM, number=4, enum=RedactionScope)
    inspect_template: str = proto.Field(proto.STRING, number=9)
    deidentify_template: str = proto.Field(proto.STRING, number=17)
    retention_window_days: int = proto.Field(proto.INT32, number=6, oneof='data_retention')
    retention_strategy: RetentionStrategy = proto.Field(proto.ENUM, number=7, oneof='data_retention', enum=RetentionStrategy)
    purge_data_types: MutableSequence[PurgeDataType] = proto.RepeatedField(proto.ENUM, number=8, enum=PurgeDataType)
    audio_export_settings: AudioExportSettings = proto.Field(proto.MESSAGE, number=12, message=AudioExportSettings)
    insights_export_settings: InsightsExportSettings = proto.Field(proto.MESSAGE, number=13, message=InsightsExportSettings)
