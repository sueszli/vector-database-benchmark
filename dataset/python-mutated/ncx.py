...
tag_fieldname_map = {1: ['pos', 0], 2: ['len', 0], 3: ['noffs', 0], 4: ['hlvl', 0], 5: ['koffs', 0], 6: ['pos_fid', 0], 21: ['parent', 0], 22: ['child1', 0], 23: ['childn', 0], 69: ['image_index', 0], 70: ['desc_offset', 0], 71: ['author_offset', 0], 72: ['image_caption_offset', 0], 73: ['image_attr_offset', 0]}
default_entry = {'pos': -1, 'len': 0, 'noffs': -1, 'text': 'Unknown Text', 'hlvl': -1, 'kind': 'Unknown Class', 'pos_fid': None, 'parent': -1, 'child1': -1, 'childn': -1, 'description': None, 'author': None, 'image_caption': None, 'image_attribution': None}
