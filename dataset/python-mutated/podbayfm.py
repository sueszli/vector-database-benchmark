...
class PodbayFMIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://podbay.fm/p/behind-the-bastards/e/1647338400', 'md5': '98b41285dcf7989d105a4ed0404054cf', 'info_dict': {'id': '1647338400', 'title': 'Part One: Kissinger', 'ext': 'mp3', 'thumbnail': 're:^https?://.*\\.jpg', 'timestamp': 1647338400, 'duration': 5001, 'upload_date': '20220315'}}]
...
class PodbayFMChannelIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://podbay.fm/p/behind-the-bastards', 'info_dict': {'id': 'behind-the-bastards', 'title': 'Behind the Bastards'}}]
    _PAGE_SIZE = 10
