...
COMMON_PYTEST_OPTIONS = ['--cov=.', '--cov-append', '--cov-report=xml', '-n', 'auto', '--showlocals', '-vv', '--ignore=tests/mypy', '--ignore=tests/pyright', '--ignore=tests/cli', '--ignore=tests/experimental/pydantic']
INTEGRATIONS = ['asgi', 'aiohttp', 'chalice', 'channels', 'django', 'fastapi', 'flask', 'quart', 'sanic', 'starlite', 'pydantic']
