...
if is_torch_available():
    import torch
    from transformers import Wav2Vec2ConformerForAudioFrameClassification, Wav2Vec2ConformerForCTC, Wav2Vec2ConformerForPreTraining, Wav2Vec2ConformerForSequenceClassification, Wav2Vec2ConformerForXVector, Wav2Vec2ConformerModel, Wav2Vec2FeatureExtractor, Wav2Vec2Processor
    from transformers.models.wav2vec2_conformer.modeling_wav2vec2_conformer import Wav2Vec2ConformerGumbelVectorQuantizer, _compute_mask_indices, _sample_negative_indices
...
class Wav2Vec2ConformerModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (Wav2Vec2ConformerForCTC, Wav2Vec2ConformerModel, Wav2Vec2ConformerForSequenceClassification, Wav2Vec2ConformerForPreTraining, Wav2Vec2ConformerForAudioFrameClassification, Wav2Vec2ConformerForXVector) if is_torch_available() else ()
    pipeline_model_mapping = {'audio-classification': Wav2Vec2ConformerForSequenceClassification, 'automatic-speech-recognition': Wav2Vec2ConformerForCTC, 'feature-extraction': Wav2Vec2ConformerModel} if is_torch_available() else {}
    test_pruning = False
