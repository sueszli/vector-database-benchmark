...
class StockPickingWave(models.Model):
    ...
    _order = 'name desc'
    name = fields.Char(string='Picking Wave Name', default='/', copy=False, required=True, help='Name of the picking wave')
    user_id = fields.Many2one('res.users', string='Responsible', track_visibility='onchange', help='Person responsible for this wave')
    picking_ids = fields.One2many('stock.picking', 'wave_id', string='Pickings', help='List of picking associated to this wave')
    state = fields.Selection([('draft', 'Draft'), ('in_progress', 'Running'), ('done', 'Done'), ('cancel', 'Cancelled')], default='draft', copy=False, track_visibility='onchange', required=True)
...
class StockPicking(models.Model):
    ...
    wave_id = fields.Many2one('stock.picking.wave', string='Picking Wave', states={'done': [('readonly', True)], 'cancel': [('readonly', True)]}, help='Picking wave associated to this picking')