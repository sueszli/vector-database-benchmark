...
class MwaveIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://mwave.interest.me/mnettv/videodetail.m?searchVideoDetailVO.clip_id=168859', 'info_dict': {'id': '168859', 'ext': 'flv', 'title': '[M COUNTDOWN] SISTAR - SHAKE IT', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'M COUNTDOWN', 'duration': 206, 'view_count': int}}, {'url': 'http://mwave.interest.me/en/mnettv/videodetail.m?searchVideoDetailVO.clip_id=176199', 'only_matching': True}]
...
class MwaveMeetGreetIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://mwave.interest.me/meetgreet/view/256', 'info_dict': {'id': '173294', 'ext': 'flv', 'title': '[MEET&GREET] Park BoRam', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'Mwave', 'duration': 3634, 'view_count': int}}, {'url': 'http://mwave.interest.me/en/meetgreet/view/256', 'only_matching': True}]
