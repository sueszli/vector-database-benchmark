...
try:
    ...
    if 'bdist_wheel' in sys.argv:
        print("[setup.py] ERROR: You must install setuptools package using pip tool to be able to create a wheel package. Type 'pip install setuptools'.")
        sys.exit(1)
EXECUTABLES_NOEXT = ['cefclient', 'cefsimple', 'ceftests', 'subprocess']
