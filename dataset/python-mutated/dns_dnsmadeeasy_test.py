...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common_lexicon.BaseLexiconDNSAuthenticatorTest):
    ...
    def setUp(self):
        ...
        dns_test_common.write({'dnsmadeeasy_api_key': API_KEY, 'dnsmadeeasy_secret_key': SECRET_KEY}, path)
        self.config = mock.MagicMock(dnsmadeeasy_credentials=path, dnsmadeeasy_propagation_seconds=0)
