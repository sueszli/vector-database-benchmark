...
from darts.ad.scorers import ExponentialNLLScorer, GammaNLLScorer, GaussianNLLScorer, KMeansScorer, LaplaceNLLScorer
...
list_NonFittableAnomalyScorer = [Norm(), Difference(), GaussianNLLScorer(), ExponentialNLLScorer(), PoissonNLLScorer(), LaplaceNLLScorer(), CauchyNLLScorer(), GammaNLLScorer()]
list_FittableAnomalyScorer = [PyODScorer(model=KNN()), KMeansScorer(), WassersteinScorer()]
list_NLLScorer = [GaussianNLLScorer(), ExponentialNLLScorer(), PoissonNLLScorer(), LaplaceNLLScorer(), CauchyNLLScorer(), GammaNLLScorer()]
