...
from nuitka.Options import getShallIncludeDataDirs, getShallIncludeDataFiles, getShallIncludePackageData, getShallNotIncludeDataFilePatterns, isOnefileMode, isStandaloneMode, shallMakeModule
from nuitka.OutputDirectories import getStandaloneDirectoryPath
from nuitka.Tracing import options_logger
from nuitka.utils.FileOperations import containsPathElements, copyFileWithPermissions, getFileContents, getFileList, getFilenameExtension, getFileSize, isFilenameBelowPath, isRelativePath, makePath, openTextFile, relpath, resolveShellPatternToFilenames
...
default_ignored_suffixes = ('.py', '.pyw', '.pyc', '.pyo', '.pyi', '.so', '.pyd', '.dll', '.dylib')
default_ignored_suffixes += getSharedLibrarySuffixes()
default_ignored_dirs = ('__pycache__', 'site-packages', 'vendor-packages')
