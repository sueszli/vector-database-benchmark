...
@serve.deployment(ray_actor_options={'num_gpus': 1}, autoscaling_config={'min_replicas': 0, 'max_replicas': 2})
class DistilBertModel:
    ...
    def __init__(self):
        if False:
            while True:
                i = 10
        self.classifier = pipeline('sentiment-analysis', model='distilbert-base-uncased', framework='pt', device=torch.device('cuda:0'))
