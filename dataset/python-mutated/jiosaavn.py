...
from ..utils import js_to_json, url_or_none, urlencode_postdata, urljoin
...
class JioSaavnSongIE(JioSaavnBaseIE):
    ...
    _TESTS = [{'url': 'https://www.jiosaavn.com/song/leja-re/OQsEfQFVUXk', 'md5': '7b1f70de088ede3a152ea34aece4df42', 'info_dict': {'id': 'OQsEfQFVUXk', 'ext': 'mp3', 'title': 'Leja Re', 'album': 'Leja Re', 'thumbnail': 'https://c.saavncdn.com/258/Leja-Re-Hindi-2018-20181124024539-500x500.jpg'}}, {'url': 'https://www.saavn.com/s/song/hindi/Saathiya/O-Humdum-Suniyo-Re/KAMiazoCblU', 'only_matching': True}]
...
class JioSaavnAlbumIE(JioSaavnBaseIE):
    ...
    _TESTS = [{'url': 'https://www.jiosaavn.com/album/96/buIOjYZDrNA_', 'info_dict': {'id': 'buIOjYZDrNA_', 'title': '96'}, 'playlist_count': 10}]
