...
class NameAndGoals(PromptStrategy):
    ...
    def build_prompt(self, user_objective: str='', **kwargs) -> ChatPrompt:
        ...
        prompt = ChatPrompt(messages=[system_message, user_message], functions=[self._create_agent_function], tokens_used=0)
        return prompt
