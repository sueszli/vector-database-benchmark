...
from sslyze.plugins.plugin_base import ScanCommandResult, ScanCommandCliConnector, ScanCommandImplementation, ScanCommandExtraArgument, ScanJob, ScanCommandWrongUsageError, ScanJobResult
