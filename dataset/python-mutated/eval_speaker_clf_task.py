...
Usage:
    ...
    PYTHONPATH='.' python examples/wav2vec/eval_speaker_clf_task.py             --data /fsx/androstj/exps/lid_voxlingua/infer/atj_xlsr2_100pct_300M_mean_fast_upd_100k_new.npz             --task cls --merge mean_logit
"""
import numpy as np
import sklearn
...
if __name__ == '__main__':
    ...
    if args.task in ['cls', 'cls_voxlingua']:
        ...
        print(f'| acc = {acc:.2f}% -- err = {100 - acc:.2f}% -- correct={correct!r} total={total!r}')
        print(f'| acc 0to5 = {acc_5:.2f}% -- err = {100 - acc_5:.2f}% -- c_5={c_5!r} t_5={t_5!r}')
        print(f'| acc 5to20 = {acc_20:.2f}% -- err = {100 - acc_20:.2f}% -- c_20={c_20!r} t_20={t_20!r}')
    if args.task == 'veri':
        ...
        if args.compress_method == 'pca':
            ...
            print(f'| apply PCA with n_comp={n_comp!r}')
