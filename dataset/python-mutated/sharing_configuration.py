...
class SharingConfiguration(models.Model):
    ...
    recording: models.ForeignKey = models.ForeignKey('SessionRecording', related_name='sharing_configurations', on_delete=models.CASCADE, to_field='session_id', null=True, blank=True)
    created_at: models.DateTimeField = models.DateTimeField(auto_now_add=True, blank=True)
    enabled: models.BooleanField = models.BooleanField(default=False)
    access_token: models.CharField = models.CharField(max_length=400, null=True, blank=True, default=get_default_access_token, unique=True)
