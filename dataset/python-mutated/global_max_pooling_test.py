...
class GlobalMaxPoolingBasicTest(testing.TestCase, parameterized.TestCase):
    ...
    def test_global_max_pooling1d(self, data_format, keepdims, input_shape, output_shape):
        if False:
            for i in range(10):
                print('nop')
        self.run_layer_test(layers.GlobalMaxPooling1D, init_kwargs={'data_format': data_format, 'keepdims': keepdims}, input_shape=input_shape, expected_output_shape=output_shape, expected_num_trainable_weights=0, expected_num_non_trainable_weights=0, expected_num_losses=0, supports_masking=False)
    ...
    def test_global_max_pooling2d(self, data_format, keepdims, input_shape, output_shape):
        if False:
            while True:
                i = 10
        self.run_layer_test(layers.GlobalMaxPooling2D, init_kwargs={'data_format': data_format, 'keepdims': keepdims}, input_shape=input_shape, expected_output_shape=output_shape, expected_num_trainable_weights=0, expected_num_non_trainable_weights=0, expected_num_losses=0, supports_masking=False)
    ...
    def test_global_max_pooling3d(self, data_format, keepdims, input_shape, output_shape):
        if False:
            i = 10
            return i + 15
        self.run_layer_test(layers.GlobalMaxPooling3D, init_kwargs={'data_format': data_format, 'keepdims': keepdims}, input_shape=input_shape, expected_output_shape=output_shape, expected_num_trainable_weights=0, expected_num_non_trainable_weights=0, expected_num_losses=0, supports_masking=False)
...
class GlobalMaxPoolingCorrectnessTest(testing.TestCase, parameterized.TestCase):
    ...
    def test_global_max_pooling1d(self, data_format, keepdims):
        ...
        layer = layers.GlobalMaxPooling1D(data_format=data_format, keepdims=keepdims)
    ...
    def test_global_max_pooling2d(self, data_format, keepdims):
        ...
        layer = layers.GlobalMaxPooling2D(data_format=data_format, keepdims=keepdims)
        outputs = layer(inputs)
    ...
    def test_global_max_pooling3d(self, data_format, keepdims):
        ...
        layer = layers.GlobalMaxPooling3D(data_format=data_format, keepdims=keepdims)
        outputs = layer(inputs)
