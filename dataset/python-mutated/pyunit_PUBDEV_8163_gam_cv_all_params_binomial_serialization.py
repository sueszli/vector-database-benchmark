...
def test_gam_model_predict():
    ...
    h2o_model = H2OGeneralizedAdditiveEstimator(family='binomial', gam_columns=['C11'], scale=[0.0001], nfolds=nfold, keep_cross_validation_models=True, keep_cross_validation_predictions=True, keep_cross_validation_fold_assignment=True, fold_assignment='random')
