...
__opts__ = {'stateconf_end_marker': '#\\s*-+\\s*end of state config\\s*-+', 'stateconf_start_state': '.start', 'stateconf_goal_state': '.goal', 'stateconf_state_func': 'stateconf.set'}
...
REQUISITES = ('require', 'require_in', 'watch', 'watch_in', 'use', 'use_in', 'listen', 'listen_in', 'onchanges', 'onchanges_in', 'onfail', 'onfail_in')
