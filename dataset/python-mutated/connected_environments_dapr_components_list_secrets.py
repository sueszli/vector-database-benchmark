...
def main():
    ...
    response = client.connected_environments_dapr_components.list_secrets(resource_group_name='examplerg', connected_environment_name='myenvironment', component_name='reddog')
    print(response)
