...
@keras_export(['keras.initializers.RandomNormal', 'keras.initializers.random_normal'])
...
@keras_export(['keras.initializers.TruncatedNormal', 'keras.initializers.truncated_normal'])
...
@keras_export(['keras.initializers.RandomUniform', 'keras.initializers.random_uniform'])
...
@keras_export(['keras.initializers.VarianceScaling', 'keras.initializers.variance_scaling'])
...
@keras_export(['keras.initializers.GlorotUniform', 'keras.initializers.glorot_uniform'])
...
@keras_export(['keras.initializers.GlorotNormal', 'keras.initializers.glorot_normal'])
...
@keras_export(['keras.initializers.LecunNormal', 'keras.initializers.lecun_normal'])
...
@keras_export(['keras.initializers.LecunUniform', 'keras.initializers.lecun_uniform'])
