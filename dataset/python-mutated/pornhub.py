...
from ..utils import NO_DEFAULT, ExtractorError, clean_html, determine_ext, format_field, int_or_none, merge_dicts, orderedSet, remove_quotes, remove_start, str_to_int, update_url_query, url_or_none, urlencode_postdata

class PornHubBaseIE(InfoExtractor):
    _NETRC_MACHINE = 'pornhub'
    _PORNHUB_HOST_RE = '(?:(?P<host>pornhub(?:premium)?\\.(?:com|net|org))|pornhubvybmsymdol4iibwgwtkpwmeyd6luq2gxajgjzfjvotyt5zhyd\\.onion)'
...
class PornHubIE(PornHubBaseIE):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=["\\\'](?P<url>(?:https?:)?//(?:www\\.)?pornhub(?:premium)?\\.(?:com|net|org)/embed/[\\da-z]+)']
    _TESTS = [{'url': 'http://www.pornhub.com/view_video.php?viewkey=648719015', 'md5': 'a6391306d050e4547f62b3f485dd9ba9', 'info_dict': {'id': '648719015', 'ext': 'mp4', 'title': 'Seductive Indian beauty strips down and fingers her pink pussy', 'uploader': 'Babes', 'upload_date': '20130628', 'timestamp': 1372447216, 'duration': 361, 'view_count': int, 'like_count': int, 'dislike_count': int, 'comment_count': int, 'age_limit': 18, 'tags': list, 'categories': list, 'cast': list}}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=1331683002', 'info_dict': {'id': '1331683002', 'ext': 'mp4', 'title': '重庆婷婷女王足交', 'upload_date': '20150213', 'timestamp': 1423804862, 'duration': 1753, 'view_count': int, 'like_count': int, 'dislike_count': int, 'comment_count': int, 'age_limit': 18, 'tags': list, 'categories': list}, 'params': {'skip_download': True}, 'skip': 'Video has been flagged for verification in accordance with our trust and safety policy'}, {'url': 'https://www.pornhub.com/view_video.php?viewkey=ph5af5fef7c2aa7', 'info_dict': {'id': 'ph5af5fef7c2aa7', 'ext': 'mp4', 'title': 'BFFS - Cute Teen Girls Share Cock On the Floor', 'uploader': 'BFFs', 'duration': 622, 'view_count': int, 'like_count': int, 'dislike_count': int, 'comment_count': int, 'age_limit': 18, 'tags': list, 'categories': list, 'subtitles': {'en': [{'ext': 'srt'}]}}, 'params': {'skip_download': True}, 'skip': 'This video has been disabled'}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=ph601dc30bae19a', 'info_dict': {'id': 'ph601dc30bae19a', 'uploader': 'Projekt Melody', 'uploader_id': 'projekt-melody', 'upload_date': '20210205', 'title': '"Welcome to My Pussy Mansion" - CB Stream (02/03/21)', 'thumbnail': 're:https?://.+'}}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=ph557bbb6676d2d', 'only_matching': True}, {'url': 'http://fr.pornhub.com/view_video.php?viewkey=ph55ca2f9760862', 'only_matching': True}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=788152859', 'only_matching': True}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=ph572716d15a111', 'only_matching': True}, {'url': 'http://www.pornhub.com/view_video.php?viewkey=ph56fd731fce6b7', 'only_matching': True}, {'url': 'https://www.thumbzilla.com/video/ph56c6114abd99a/horny-girlfriend-sex', 'only_matching': True}, {'url': 'http://www.pornhub.com/video/show?viewkey=648719015', 'only_matching': True}, {'url': 'https://www.pornhub.net/view_video.php?viewkey=203640933', 'only_matching': True}, {'url': 'https://www.pornhub.org/view_video.php?viewkey=203640933', 'only_matching': True}, {'url': 'https://www.pornhubpremium.com/view_video.php?viewkey=ph5e4acdae54a82', 'only_matching': True}, {'url': 'https://www.pornhub.com/view_video.php?viewkey=ph5f75b0f4b18e3', 'only_matching': True}, {'url': 'https://www.pornhubpremium.com/view_video.php?viewkey=ph5f75b0f4b18e3', 'only_matching': True}, {'url': 'https://www.pornhub.com/view_video.php?viewkey=ph5a9813bfa7156', 'only_matching': True}, {'url': 'http://pornhubvybmsymdol4iibwgwtkpwmeyd6luq2gxajgjzfjvotyt5zhyd.onion/view_video.php?viewkey=ph5a9813bfa7156', 'only_matching': True}]
...
class PornHubUserIE(PornHubPlaylistBaseIE):
    _VALID_URL = '(?P<url>https?://(?:[^/]+\\.)?%s/(?:(?:user|channel)s|model|pornstar)/(?P<id>[^/?#&]+))(?:[?#&]|/(?!videos)|$)' % PornHubBaseIE._PORNHUB_HOST_RE
    _TESTS = [{'url': 'https://www.pornhub.com/model/zoe_ph', 'playlist_mincount': 118}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious', 'info_dict': {'id': 'liz-vicious'}, 'playlist_mincount': 118}, {'url': 'https://www.pornhub.com/users/russianveet69', 'only_matching': True}, {'url': 'https://www.pornhub.com/channels/povd', 'only_matching': True}, {'url': 'https://www.pornhub.com/model/zoe_ph?abc=1', 'only_matching': True}, {'url': 'https://www.pornhubpremium.com/pornstar/sienna-west', 'only_matching': True}, {'url': 'https://www.pornhubpremium.com/pornstar/lily-labeau', 'only_matching': True}, {'url': 'https://pornhubvybmsymdol4iibwgwtkpwmeyd6luq2gxajgjzfjvotyt5zhyd.onion/model/zoe_ph', 'only_matching': True}]
...
class PornHubPagedVideoListIE(PornHubPagedPlaylistBaseIE):
    _VALID_URL = 'https?://(?:[^/]+\\.)?%s/(?!playlist/)(?P<id>(?:[^/]+/)*[^/?#&]+)' % PornHubBaseIE._PORNHUB_HOST_RE
    _TESTS = [{'url': 'https://www.pornhub.com/model/zoe_ph/videos', 'only_matching': True}, {'url': 'http://www.pornhub.com/users/rushandlia/videos', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/jenny-blighe/videos', 'info_dict': {'id': 'pornstar/jenny-blighe/videos'}, 'playlist_mincount': 149}, {'url': 'https://www.pornhub.com/pornstar/jenny-blighe/videos?page=3', 'info_dict': {'id': 'pornstar/jenny-blighe/videos'}, 'playlist_mincount': 40}, {'url': 'https://www.pornhub.com/channels/povd/videos', 'info_dict': {'id': 'channels/povd/videos'}, 'playlist_mincount': 293}, {'url': 'https://www.pornhub.com/channels/povd/videos?o=ra', 'only_matching': True}, {'url': 'https://www.pornhub.com/channels/povd/videos?o=da', 'only_matching': True}, {'url': 'https://www.pornhub.com/channels/povd/videos?o=vi', 'only_matching': True}, {'url': 'http://www.pornhub.com/users/zoe_ph/videos/public', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos?o=mv', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos?o=tr', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos?o=lg', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos?o=cm', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos/paid', 'only_matching': True}, {'url': 'https://www.pornhub.com/pornstar/liz-vicious/videos/fanonly', 'only_matching': True}, {'url': 'https://www.pornhub.com/video', 'only_matching': True}, {'url': 'https://www.pornhub.com/video?page=3', 'only_matching': True}, {'url': 'https://www.pornhub.com/video/search?search=123', 'only_matching': True}, {'url': 'https://www.pornhub.com/categories/teen', 'only_matching': True}, {'url': 'https://www.pornhub.com/categories/teen?page=3', 'only_matching': True}, {'url': 'https://www.pornhub.com/hd', 'only_matching': True}, {'url': 'https://www.pornhub.com/hd?page=3', 'only_matching': True}, {'url': 'https://www.pornhub.com/described-video', 'only_matching': True}, {'url': 'https://www.pornhub.com/described-video?page=2', 'only_matching': True}, {'url': 'https://www.pornhub.com/video/incategories/60fps-1/hd-porn', 'only_matching': True}, {'url': 'https://pornhubvybmsymdol4iibwgwtkpwmeyd6luq2gxajgjzfjvotyt5zhyd.onion/model/zoe_ph/videos', 'only_matching': True}]
...
class PornHubUserVideosUploadIE(PornHubPagedPlaylistBaseIE):
    _VALID_URL = '(?P<url>https?://(?:[^/]+\\.)?%s/(?:(?:user|channel)s|model|pornstar)/(?P<id>[^/]+)/videos/upload)' % PornHubBaseIE._PORNHUB_HOST_RE
    _TESTS = [{'url': 'https://www.pornhub.com/pornstar/jenny-blighe/videos/upload', 'info_dict': {'id': 'jenny-blighe'}, 'playlist_mincount': 129}, {'url': 'https://www.pornhub.com/model/zoe_ph/videos/upload', 'only_matching': True}, {'url': 'http://pornhubvybmsymdol4iibwgwtkpwmeyd6luq2gxajgjzfjvotyt5zhyd.onion/pornstar/jenny-blighe/videos/upload', 'only_matching': True}]

class PornHubPlaylistIE(PornHubPlaylistBaseIE):
    _VALID_URL = '(?P<url>https?://(?:[^/]+\\.)?%s/playlist/(?P<id>[^/?#&]+))' % PornHubBaseIE._PORNHUB_HOST_RE
    _TESTS = [{'url': 'https://www.pornhub.com/playlist/44121572', 'info_dict': {'id': '44121572'}, 'playlist_count': 77}, {'url': 'https://www.pornhub.com/playlist/4667351', 'only_matching': True}, {'url': 'https://de.pornhub.com/playlist/4667351', 'only_matching': True}, {'url': 'https://de.pornhub.com/playlist/4667351?page=2', 'only_matching': True}]
