...
AVAILABLE_COMMANDS: List[click.Command] = [list_commands._list, get_commands.get, import_commands._import, init_commands.init, generate_commands.generate, apply_commands.apply]
