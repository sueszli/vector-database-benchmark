...
class MyTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        if False:
            print('Hello World!')
        fixtures = {'proc_pid_numa_maps': ('fixtures/linux-proc/pid_numa_maps', 'fixtures/linux-proc/pid_numa_maps.json')}
    ...
    def test_proc_pid_numa_maps(self):
        ...
        self.assertEqual(jc.parsers.proc_pid_numa_maps.parse(self.f_in['proc_pid_numa_maps'], quiet=True), self.f_json['proc_pid_numa_maps'])
