...
class AnalyticsItemsOperations:
    ...
    async def list(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], scope: Optional[Union[str, _models.ItemScope]]=None, type: Union[str, _models.ItemTypeParameter]='none', include_content: Optional[bool]=None, **kwargs: Any) -> List[_models.ApplicationInsightsComponentAnalyticsItem]:
    ...
    @distributed_trace_async
    async def get(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], id: Optional[str]=None, name: Optional[str]=None, **kwargs: Any) -> _models.ApplicationInsightsComponentAnalyticsItem:
        ...
        request = build_get_request(resource_group_name=resource_group_name, resource_name=resource_name, scope_path=scope_path, subscription_id=self._config.subscription_id, id=id, name=name, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def put(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], item_properties: _models.ApplicationInsightsComponentAnalyticsItem, override_item: Optional[bool]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentAnalyticsItem:
    ...
    @overload
    async def put(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], item_properties: IO, override_item: Optional[bool]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.ApplicationInsightsComponentAnalyticsItem:
        """Adds or Updates a specific Analytics Item within an Application Insights component.
    ...
    @distributed_trace_async
    async def put(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], item_properties: Union[_models.ApplicationInsightsComponentAnalyticsItem, IO], override_item: Optional[bool]=None, **kwargs: Any) -> _models.ApplicationInsightsComponentAnalyticsItem:
        """Adds or Updates a specific Analytics Item within an Application Insights component.
    ...
    @distributed_trace_async
    async def delete(self, resource_group_name: str, resource_name: str, scope_path: Union[str, _models.ItemScopePath], id: Optional[str]=None, name: Optional[str]=None, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, resource_name=resource_name, scope_path=scope_path, subscription_id=self._config.subscription_id, id=id, name=name, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
