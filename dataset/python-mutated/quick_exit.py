...
class QuickExit(base._TextBox):
    ...
    """
    defaults = [('default_text', '[ shutdown ]', 'The text displayed on the button.'), ('countdown_format', '[ {} seconds ]', 'The text displayed when counting down.'), ('timer_interval', 1, 'The countdown interval.'), ('countdown_start', 5, 'The number to count down from.')]
