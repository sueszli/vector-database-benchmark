...
class ListMigrationJobsRequest(proto.Message):
    """Retrieves a list of all migration jobs in a given project and
    location.
...
class ListMigrationJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    migration_jobs: MutableSequence[clouddms_resources.MigrationJob] = proto.RepeatedField(proto.MESSAGE, number=1, message=clouddms_resources.MigrationJob)
...
class CreateMigrationJobRequest(proto.Message):
    """Request message to create a new Database Migration Service
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    migration_job_id: str = proto.Field(proto.STRING, number=2)
    migration_job: clouddms_resources.MigrationJob = proto.Field(proto.MESSAGE, number=3, message=clouddms_resources.MigrationJob)
...
class UpdateMigrationJobRequest(proto.Message):
    ...
    migration_job: clouddms_resources.MigrationJob = proto.Field(proto.MESSAGE, number=2, message=clouddms_resources.MigrationJob)
...
class StartMigrationJobRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    skip_validation: bool = proto.Field(proto.BOOL, number=2)
...
class GenerateSshScriptRequest(proto.Message):
    ...
    Attributes:
        ...
        vm_port (int):
            ...
            host.
    """
    migration_job: str = proto.Field(proto.STRING, number=1)
    vm: str = proto.Field(proto.STRING, number=2)
    vm_creation_config: 'VmCreationConfig' = proto.Field(proto.MESSAGE, number=100, oneof='vm_config', message='VmCreationConfig')
    vm_selection_config: 'VmSelectionConfig' = proto.Field(proto.MESSAGE, number=101, oneof='vm_config', message='VmSelectionConfig')
    vm_port: int = proto.Field(proto.INT32, number=3)
...
class VmCreationConfig(proto.Message):
    ...
    Attributes:
        ...
        subnet (str):
            ...
            in.
    """
    vm_machine_type: str = proto.Field(proto.STRING, number=1)
    vm_zone: str = proto.Field(proto.STRING, number=2)
    subnet: str = proto.Field(proto.STRING, number=3)
...
class VmSelectionConfig(proto.Message):
    ...
    Attributes:
        vm_zone (str):
            ...
            VM is located.
    """
    vm_zone: str = proto.Field(proto.STRING, number=1)
...
class SshScript(proto.Message):
    ...
    """
    script: str = proto.Field(proto.STRING, number=1)
...
class GenerateTcpProxyScriptRequest(proto.Message):
    ...
    vm_machine_type: str = proto.Field(proto.STRING, number=3)
    vm_zone: str = proto.Field(proto.STRING, number=4)
    vm_subnet: str = proto.Field(proto.STRING, number=5)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    connection_profiles: MutableSequence[clouddms_resources.ConnectionProfile] = proto.RepeatedField(proto.MESSAGE, number=1, message=clouddms_resources.ConnectionProfile)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateConnectionProfileRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    connection_profile_id: str = proto.Field(proto.STRING, number=2)
    connection_profile: clouddms_resources.ConnectionProfile = proto.Field(proto.MESSAGE, number=3, message=clouddms_resources.ConnectionProfile)
    request_id: str = proto.Field(proto.STRING, number=4)
    validate_only: bool = proto.Field(proto.BOOL, number=5)
    skip_validation: bool = proto.Field(proto.BOOL, number=6)
...
class UpdateConnectionProfileRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    connection_profile: clouddms_resources.ConnectionProfile = proto.Field(proto.MESSAGE, number=2, message=clouddms_resources.ConnectionProfile)
    request_id: str = proto.Field(proto.STRING, number=3)
    validate_only: bool = proto.Field(proto.BOOL, number=4)
    skip_validation: bool = proto.Field(proto.BOOL, number=5)
...
class CreatePrivateConnectionRequest(proto.Message):
    """Request message to create a new private connection in the
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    private_connection_id: str = proto.Field(proto.STRING, number=2)
    private_connection: clouddms_resources.PrivateConnection = proto.Field(proto.MESSAGE, number=3, message=clouddms_resources.PrivateConnection)
    request_id: str = proto.Field(proto.STRING, number=4)
    skip_validation: bool = proto.Field(proto.BOOL, number=5)

class ListPrivateConnectionsRequest(proto.Message):
    """Request message to retrieve a list of private connections in
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    private_connections: MutableSequence[clouddms_resources.PrivateConnection] = proto.RepeatedField(proto.MESSAGE, number=1, message=clouddms_resources.PrivateConnection)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class ListConversionWorkspacesRequest(proto.Message):
    """Retrieve a list of all conversion workspaces in a given
...
class ListConversionWorkspacesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    conversion_workspaces: MutableSequence[conversionworkspace_resources.ConversionWorkspace] = proto.RepeatedField(proto.MESSAGE, number=1, message=conversionworkspace_resources.ConversionWorkspace)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateConversionWorkspaceRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    conversion_workspace_id: str = proto.Field(proto.STRING, number=2)
    conversion_workspace: conversionworkspace_resources.ConversionWorkspace = proto.Field(proto.MESSAGE, number=3, message=conversionworkspace_resources.ConversionWorkspace)
    request_id: str = proto.Field(proto.STRING, number=4)
...
class UpdateConversionWorkspaceRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    conversion_workspace: conversionworkspace_resources.ConversionWorkspace = proto.Field(proto.MESSAGE, number=2, message=conversionworkspace_resources.ConversionWorkspace)
    request_id: str = proto.Field(proto.STRING, number=3)
...
class CommitConversionWorkspaceRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    commit_name: str = proto.Field(proto.STRING, number=2)
...
class ApplyConversionWorkspaceRequest(proto.Message):
    ...
    dry_run: bool = proto.Field(proto.BOOL, number=3)
    auto_commit: bool = proto.Field(proto.BOOL, number=4)
    connection_profile: str = proto.Field(proto.STRING, number=100, oneof='destination')

class ListMappingRulesRequest(proto.Message):
    """Retrieve a list of all mapping rules in a given conversion
    workspace.
...
class ListMappingRulesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    mapping_rules: MutableSequence[conversionworkspace_resources.MappingRule] = proto.RepeatedField(proto.MESSAGE, number=1, message=conversionworkspace_resources.MappingRule)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SeedConversionWorkspaceRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    auto_commit: bool = proto.Field(proto.BOOL, number=2)
    source_connection_profile: str = proto.Field(proto.STRING, number=100, oneof='seed_from')
    destination_connection_profile: str = proto.Field(proto.STRING, number=101, oneof='seed_from')
...
class ConvertConversionWorkspaceRequest(proto.Message):
    ...
    convert_full_path: bool = proto.Field(proto.BOOL, number=6)
...
class ImportMappingRulesRequest(proto.Message):
    ...
    class RulesFile(proto.Message):
        ...
        """
        rules_source_filename: str = proto.Field(proto.STRING, number=1)
        rules_content: str = proto.Field(proto.STRING, number=2)
    parent: str = proto.Field(proto.STRING, number=1)
    rules_format: conversionworkspace_resources.ImportRulesFileFormat = proto.Field(proto.ENUM, number=2, enum=conversionworkspace_resources.ImportRulesFileFormat)
    rules_files: MutableSequence[RulesFile] = proto.RepeatedField(proto.MESSAGE, number=3, message=RulesFile)
    auto_commit: bool = proto.Field(proto.BOOL, number=6)
...
class DescribeDatabaseEntitiesRequest(proto.Message):
    ...
    class DBTreeType(proto.Enum):
        ...
        DRAFT_TREE = 2
        DESTINATION_TREE = 3
    conversion_workspace: str = proto.Field(proto.STRING, number=1)
    page_size: int = proto.Field(proto.INT32, number=3)
    page_token: str = proto.Field(proto.STRING, number=4)
    tree: DBTreeType = proto.Field(proto.ENUM, number=6, enum=DBTreeType)
    uncommitted: bool = proto.Field(proto.BOOL, number=11)
    commit_id: str = proto.Field(proto.STRING, number=12)
    filter: str = proto.Field(proto.STRING, number=13)
    view: 'DatabaseEntityView' = proto.Field(proto.ENUM, number=14, enum='DatabaseEntityView')
...
class DescribeDatabaseEntitiesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    database_entities: MutableSequence[conversionworkspace_resources.DatabaseEntity] = proto.RepeatedField(proto.MESSAGE, number=1, message=conversionworkspace_resources.DatabaseEntity)
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class SearchBackgroundJobsRequest(proto.Message):
    ...
    """
    conversion_workspace: str = proto.Field(proto.STRING, number=1)
    return_most_recent_per_job_type: bool = proto.Field(proto.BOOL, number=2)
    max_size: int = proto.Field(proto.INT32, number=3)
    completed_until_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
...
class SearchBackgroundJobsResponse(proto.Message):
    ...
    Attributes:
        jobs (MutableSequence[google.cloud.clouddms_v1.types.BackgroundJobLogEntry]):
            ...
            rules.
    """
    jobs: MutableSequence[conversionworkspace_resources.BackgroundJobLogEntry] = proto.RepeatedField(proto.MESSAGE, number=1, message=conversionworkspace_resources.BackgroundJobLogEntry)

class DescribeConversionWorkspaceRevisionsRequest(proto.Message):
    """Request message for 'DescribeConversionWorkspaceRevisions'
    request.
    ...
    """
    conversion_workspace: str = proto.Field(proto.STRING, number=1)
    commit_id: str = proto.Field(proto.STRING, number=2)

class DescribeConversionWorkspaceRevisionsResponse(proto.Message):
    """Response message for 'DescribeConversionWorkspaceRevisions'
    request.
    ...
    """
    revisions: MutableSequence[conversionworkspace_resources.ConversionWorkspace] = proto.RepeatedField(proto.MESSAGE, number=1, message=conversionworkspace_resources.ConversionWorkspace)
...
class CreateMappingRuleRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    mapping_rule_id: str = proto.Field(proto.STRING, number=2)
    mapping_rule: conversionworkspace_resources.MappingRule = proto.Field(proto.MESSAGE, number=3, message=conversionworkspace_resources.MappingRule)
    request_id: str = proto.Field(proto.STRING, number=4)
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    static_ips: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
    next_page_token: str = proto.Field(proto.STRING, number=2)
