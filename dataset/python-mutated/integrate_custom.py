...
if __name__ == '__main__':
    parser = ConfigParser()
    parser.add('--config', is_config_file=True, help='YAML config file path. Please refer to default_config.yml as a reference. It overrides the default config file, but will be overridden by other command line inputs.')
    ...
    parser.add('--path_npz', help='path to the npz file that stores voxel block grid.', default='vbg.npz')
    ...
    vbg = integrate(depth_file_names, color_file_names, intrinsic, extrinsics, config)
