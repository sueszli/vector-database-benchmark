import unittest
from robot.variables import contains_variable, is_variable, is_assign, is_scalar_variable, is_scalar_assign, is_list_variable, is_list_assign, is_dict_variable, is_dict_assign, search_variable
SCALARS = ['${var}', '${  v A  R }']
LISTS = ['@{var}', '@{  v A  R }']
DICTS = ['&{var}', '&{  v A  R }']
NOKS = ['', 'nothing', '$not', '${not', '@not', '&{not', '${not}[oops', '%{not}', '*{not}', '\\${var}', '\\\\\\${var}', 42, None, ['${var}']]
NOK_ASSIGNS = NOKS + ['${${internal}}', '@{${internal}}', '&{${internal}}']
