...
class SafeTPlugin(HW_PluginBase):
    ...
    @runs_in_hwd_thread
    def get_client(self, keystore, force_pair=True, *, devices=None, allow_user_interaction=True) -> Optional['SafeTClient']:
        if False:
            while True:
                i = 10
