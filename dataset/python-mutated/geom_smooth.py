...
class geom_smooth(geom):
    ...
    legend_fill_ratio : float (default: 0.5)
        ...
        in the range [0, 1].
    """
    DEFAULT_AES = {'alpha': 0.4, 'color': 'black', 'fill': '#999999', 'linetype': 'solid', 'size': 1, 'ymin': None, 'ymax': None}
    REQUIRED_AES = {'x', 'y'}
    DEFAULT_PARAMS = {'stat': 'smooth', 'position': 'identity', 'na_rm': False, 'legend_fill_ratio': 0.5}
