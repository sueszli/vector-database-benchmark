...
class ProgressWindow_Ui(QWidget):
    ...
    def __init__(self, persepolis_setting):
        ...
        self.progress_tabWidget.setTabText(self.progress_tabWidget.indexOf(self.information_tab), QCoreApplication.translate('progress_ui_tr', 'Download Information'))
        ...
        self.progress_tabWidget.setTabText(self.progress_tabWidget.indexOf(self.options_tab), QCoreApplication.translate('progress_ui_tr', 'Download Options'))
