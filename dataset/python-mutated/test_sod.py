...
class TestSOD(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(self.clf, 'alpha') and self.clf.alpha is not None
        assert hasattr(self.clf, 'ref_set') and self.clf.ref_set is not None
        assert hasattr(self.clf, 'n_neighbors') and self.clf.n_neighbors is not None
