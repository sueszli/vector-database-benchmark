...
X = pd.DataFrame([['Minas Graes', 2.068, 2.07, 1.58], ['Minas Graes', 2.068, 2.074, 1.602], ['Minas Graes', 2.09, 2.09, 1.613], ['Minas Graes', 2.097, 2.093, 1.613], ['Minas Graes', 2.117, 2.125, 1.663], ['Minas Graes', 2.14, 2.146, 1.681], ['Matto Grosso', 2.045, 2.054, 1.58], ['Matto Grosso', 2.076, 2.088, 1.602], ['Matto Grosso', 2.09, 2.093, 1.643], ['Matto Grosso', 2.111, 2.114, 1.643], ['Santa Cruz', 2.093, 2.098, 1.653], ['Santa Cruz', 2.1, 2.106, 1.623], ['Santa Cruz', 2.104, 2.101, 1.653]], columns=['Loc', 'Basal', 'Occ', 'Max'])
