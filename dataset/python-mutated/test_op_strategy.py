...
from torch.distributed._tensor.ops.basic_strategy import EinsumDims, gen_einsum_strategies
from torch.distributed._tensor.placement_types import _Partial, DTensorSpec, Replicate, Shard, TensorMeta
