...
logger = get_logger()
base_search_fields = {'name': fields.String(required=False, description='任务名'), 'keyword': fields.String(description='关键字'), 'status': fields.String(description='状态')}
base_search_fields.update(base_query_fields)
add_github_scheduler_fields = ns.model('AddGithubScheduler', {'name': fields.String(required=True, description='任务名'), 'keyword': fields.String(required=True, description='关键字'), 'cron': fields.String(required=True, description='Cron 表达式')})
...
delete_github_scheduler_fields = ns.model('deleteGithubScheduler', {'_id': fields.List(fields.String(description='Github 监控任务ID列表'))})
...
update_github_scheduler_fields = ns.model('updateGithubScheduler', {'_id': fields.String(required=True, description='Github 监控任务ID'), 'name': fields.String(required=False, description='任务名'), 'keyword': fields.String(required=False, description='关键字'), 'cron': fields.String(required=False, description='Cron 表达式')})
...
recover_github_scheduler_fields = ns.model('recoverGithubScheduler', {'_id': fields.List(fields.String(required=True, description='Github 监控任务ID'))})
...
stop_github_scheduler_fields = ns.model('stopGithubScheduler', {'_id': fields.List(fields.String(required=True, description='Github 监控任务ID'))})
