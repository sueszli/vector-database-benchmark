...
DATASOURCES_RESPONSE = {'datasources': [{'id': 't_datasource_id', 'name': 'test_datasource', 'columns': [{'name': 'string_attribute', 'type': 'String', 'nullable': False, 'normalized_name': 'string_attribute'}, {'name': 'number_attribute', 'type': 'Int32', 'nullable': False, 'normalized_name': 'number_attribute'}, {'name': 'date_attribute', 'type': 'DateTime', 'nullable': False, 'normalized_name': 'date_attribute'}]}]}
PIPES_RESPONSE = {'pipes': [{'id': 't_pipe_id', 'name': 'test_pipe', 'endpoint': 't_endpoint_id', 'type': 'endpoint'}]}
SCHEMA_RESPONSE = {'meta': [{'name': 'string_attribute', 'type': 'String'}, {'name': 'number_attribute', 'type': 'Int32'}, {'name': 'date_attribute', 'type': 'DateTime'}]}
QUERY_RESPONSE = {**SCHEMA_RESPONSE, 'data': [{'string_attribute': 'hello world', 'number_attribute': 123, 'date_attribute': '2023-01-01 00:00:03.001000'}], 'rows': 1, 'statistics': {'elapsed': 0.011556914, 'rows_read': 87919, 'bytes_read': 17397219}}
