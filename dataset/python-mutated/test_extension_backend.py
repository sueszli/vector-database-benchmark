...
try:
    from extension_backends.extension_codegen_backend import ExtensionScheduling, ExtensionWrapperCodegen
except ImportError:
    from .extension_backends.extension_codegen_backend import ExtensionScheduling, ExtensionWrapperCodegen
from torch._C import FileCheck
from torch._inductor import metrics
from torch._inductor.codegen.common import get_scheduling_for_device, get_wrapper_codegen_for_device, register_backend_for_device
