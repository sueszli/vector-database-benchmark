...
def main():
    ...
    response = client.network_interfaces.begin_update(resource_group_name='test-rg', network_interface_name='test-nic', network_interfaces={'tags': {'additionalProperties': 'sample'}}).result()
    print(response)
