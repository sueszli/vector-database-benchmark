...
TOGGLE_EVENT = {'started': events.promotion_started_event, 'ended': events.promotion_ended_event}
...
class PromotionUpdate(ModelMutation):
    ...
    class Arguments:
        ...
        input = PromotionUpdateInput(description='Fields required to update a promotion.', required=True)
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.PROMOTION_UPDATED, description='A promotion was updated.'), WebhookEventInfo(type=WebhookEventAsyncType.PROMOTION_STARTED, description='Optionally called if promotion was started.'), WebhookEventInfo(type=WebhookEventAsyncType.PROMOTION_ENDED, description='Optionally called if promotion was ended.')]
