...
if __name__ == '__main__':
    parse = argparse.ArgumentParser(description='Convert Pascal VOC dataset to YOLO format')
    parse.add_argument('--dataset_dir', help='Dataset directory', type=str, required=True)
