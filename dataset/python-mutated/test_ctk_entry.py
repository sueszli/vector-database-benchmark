...
entry_1.configure(width=300, height=35, corner_radius=1000, border_width=4, bg_color='green', fg_color=('red', 'yellow'), border_color='blue', text_color=('brown', 'green'), placeholder_text_color='blue', textvariable=txt_var, placeholder_text='new_placholder', font=('Times New Roman', -8, 'bold'), state='normal', insertborderwidth=5, insertwidth=10, justify='right', show='+')
