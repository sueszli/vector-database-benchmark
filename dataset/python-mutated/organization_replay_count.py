...
MAX_REPLAY_COUNT = 51
MAX_VALS_PROVIDED = {'issue.id': 25, 'transaction': 25, 'replay_id': 100}
FILTER_HAS_A_REPLAY = "AND !replayId:''"

class ReplayDataSourceValidator(serializers.Serializer):
    data_source = serializers.ChoiceField(choices=(Dataset.Discover.value, Dataset.IssuePlatform.value), default=Dataset.Discover.value)
