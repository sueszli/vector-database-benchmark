...
MODELS = fixturesloader.FixturesLoader().load_models(fixtures_pack=FIXTURES_PACK, fixtures_dict=TEST_MODELS)
ACTION_1 = MODELS['actions']['a1.yaml']
ACTION_2 = MODELS['actions']['a2.yaml']
RUNNER = MODELS['runners']['testrunner1.yaml']
CHAIN_1_PATH = fixturesloader.FixturesLoader().get_fixture_file_path_abs(FIXTURES_PACK, 'actionchains', 'chain_with_notifications.yaml')
PACKS = [TEST_PACK_PATH, CORE_PACK_PATH]
MOCK_NOTIFY = {'on-complete': {'routes': ['hubot']}}
