...
from ..utils import ExtractorError, float_or_none, int_or_none, merge_dicts, multipart_encode, parse_duration, random_birthday, traverse_obj, try_call, try_get, urljoin
...
class CDAIE(InfoExtractor):
    ...
    _API_HEADERS = {'Accept': 'application/vnd.cda.public+json'}
    ...
    _TESTS = [{'url': 'http://www.cda.pl/video/5749950c', 'md5': '6f844bf51b15f31fae165365707ae970', 'info_dict': {'id': '5749950c', 'ext': 'mp4', 'height': 720, 'title': 'Oto dlaczego przed zakrętem należy zwolnić.', 'description': 'md5:269ccd135d550da90d1662651fcb9772', 'thumbnail': 're:^https?://.*\\.jpg$', 'average_rating': float, 'duration': 39, 'age_limit': 0, 'upload_date': '20160221', 'timestamp': 1456078244}}, {'url': 'http://www.cda.pl/video/57413289', 'md5': 'a88828770a8310fc00be6c95faf7f4d5', 'info_dict': {'id': '57413289', 'ext': 'mp4', 'title': 'Lądowanie na lotnisku na Maderze', 'description': 'md5:60d76b71186dcce4e0ba6d4bbdb13e1a', 'thumbnail': 're:^https?://.*\\.jpg$', 'uploader': 'crash404', 'view_count': int, 'average_rating': float, 'duration': 137, 'age_limit': 0}}, {'url': 'http://www.cda.pl/video/1273454c4', 'info_dict': {'id': '1273454c4', 'ext': 'mp4', 'title': 'Bronson (2008) napisy HD 1080p', 'description': 'md5:1b6cb18508daf2dc4e0fa4db77fec24c', 'height': 1080, 'uploader': 'boniek61', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 5554, 'age_limit': 18, 'view_count': int, 'average_rating': float}}, {'url': 'http://ebd.cda.pl/0x0/5749950c', 'only_matching': True}]
