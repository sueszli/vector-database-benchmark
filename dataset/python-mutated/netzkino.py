...
class NetzkinoIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.netzkino.de/#!/scifikino/rakete-zum-mond', 'md5': '92a3f8b76f8d7220acce5377ea5d4873', 'info_dict': {'id': 'rakete-zum-mond', 'ext': 'mp4', 'title': 'Rakete zum Mond – Jules Verne', 'description': 'md5:f0a8024479618ddbfa450ff48ffa6c60', 'upload_date': '20120813', 'thumbnail': 're:https?://.*\\.jpg$', 'timestamp': 1344858571, 'age_limit': 12}, 'params': {'skip_download': 'Download only works from Germany'}}, {'url': 'https://www.netzkino.de/#!/filme/dr-jekyll-mrs-hyde-2', 'md5': 'c7728b2dadd04ff6727814847a51ef03', 'info_dict': {'id': 'dr-jekyll-mrs-hyde-2', 'ext': 'mp4', 'title': 'Dr. Jekyll & Mrs. Hyde 2', 'description': 'md5:c2e9626ebd02de0a794b95407045d186', 'upload_date': '20190130', 'thumbnail': 're:https?://.*\\.jpg$', 'timestamp': 1548849437, 'age_limit': 18}, 'params': {'skip_download': 'Download only works from Germany'}}]
