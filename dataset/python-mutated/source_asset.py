from typing import TYPE_CHECKING, AbstractSet, Any, Callable, Dict, Iterator, Mapping, Optional, cast
from typing_extensions import TypeAlias
import dagster._check as check
from dagster._annotations import PublicAttr, experimental_param, public
from dagster._core.decorator_utils import get_function_params
from dagster._core.definitions.data_version import DATA_VERSION_TAG, DataVersion, DataVersionsByPartition
from dagster._core.definitions.events import AssetKey, AssetObservation, CoercibleToAssetKey
from dagster._core.definitions.metadata import ArbitraryMetadataMapping, MetadataMapping, normalize_metadata
from dagster._core.definitions.op_definition import OpDefinition
from dagster._core.definitions.partition import PartitionsDefinition
from dagster._core.definitions.resource_annotation import get_resource_args
from dagster._core.definitions.resource_definition import ResourceDefinition
from dagster._core.definitions.resource_requirement import ResourceAddable, ResourceRequirement, SourceAssetIOManagerRequirement, ensure_requirements_satisfied, get_resource_key_conflicts
from dagster._core.definitions.utils import DEFAULT_GROUP_NAME, DEFAULT_IO_MANAGER_KEY, validate_group_name
from dagster._core.errors import DagsterInvalidDefinitionError, DagsterInvalidInvocationError, DagsterInvalidObservationError
if TYPE_CHECKING:
