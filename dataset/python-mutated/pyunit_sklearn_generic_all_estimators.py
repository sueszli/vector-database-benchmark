...
failing = ['H2OAggregatorEstimator', 'H2OCoxProportionalHazardsEstimator', 'H2OGenericEstimator', 'H2OStackedEnsembleEstimator', 'H2OTargetEncoderEstimator', 'H2OWord2vecEstimator', 'H2OUpliftRandomForestEstimator', 'H2ODecisionTreeEstimator', 'H2OAdaBoostEstimator']
estimators = [cls for (name, cls) in inspect.getmembers(h2o.sklearn, inspect.isclass) if name.endswith('Estimator') and name not in ['H2OAutoMLEstimator'] + failing]
