...
if __name__ == '__main__':
    ...
    parser.add_argument('--repo', type=str, help='Name of repository', default='gradio')
    args = parser.parse_args()
    new_space = download_artifact(args.owner, args.repo, args.run_id, args.artifact_name, args.gh_token)
    print(new_space)