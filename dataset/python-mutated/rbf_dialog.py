...
from PyQt5.QtWidgets import QCheckBox, QLabel, QVBoxLayout, QGridLayout, QWidget, QPushButton, QHBoxLayout, QComboBox
...
class DSCancelDialog(_BaseRBFDialog):
    help_text = _('Cancel an unconfirmed transaction by replacing it with a higher-fee transaction that spends back to your wallet.')
