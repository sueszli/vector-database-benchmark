...
from airflow.exceptions import AirflowException, AirflowProviderDeprecationWarning, AirflowTaskTimeout, TaskDeferred
from airflow.models import DAG, DagBag
from airflow.providers.google.cloud.links.dataproc import DATAPROC_CLUSTER_LINK_DEPRECATED, DATAPROC_JOB_LINK_DEPRECATED, DataprocClusterLink, DataprocJobLink, DataprocWorkflowLink
from airflow.providers.google.cloud.operators.dataproc import ClusterGenerator, DataprocCreateBatchOperator, DataprocCreateClusterOperator, DataprocCreateWorkflowTemplateOperator, DataprocDeleteBatchOperator, DataprocDeleteClusterOperator, DataprocGetBatchOperator, DataprocInstantiateInlineWorkflowTemplateOperator, DataprocInstantiateWorkflowTemplateOperator, DataprocLink, DataprocListBatchesOperator, DataprocScaleClusterOperator, DataprocSubmitHadoopJobOperator, DataprocSubmitHiveJobOperator, DataprocSubmitJobOperator, DataprocSubmitPigJobOperator, DataprocSubmitPySparkJobOperator, DataprocSubmitSparkJobOperator, DataprocSubmitSparkSqlJobOperator, DataprocUpdateClusterOperator
from airflow.providers.google.cloud.triggers.dataproc import DataprocBatchTrigger, DataprocClusterTrigger, DataprocDeleteClusterTrigger, DataprocSubmitTrigger, DataprocWorkflowTrigger
...
CONFIG = {'gce_cluster_config': {'zone_uri': 'https://www.googleapis.com/compute/v1/projects/project_id/zones/zone', 'metadata': {'metadata': 'data'}, 'network_uri': 'network_uri', 'subnetwork_uri': 'subnetwork_uri', 'internal_ip_only': True, 'tags': ['tags'], 'service_account': 'service_account', 'service_account_scopes': ['service_account_scopes']}, 'master_config': {'num_instances': 2, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/master_machine_type', 'disk_config': {'boot_disk_type': 'master_disk_type', 'boot_disk_size_gb': 128}, 'image_uri': 'https://www.googleapis.com/compute/beta/projects/custom_image_project_id/global/images/custom_image'}, 'worker_config': {'num_instances': 2, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/worker_machine_type', 'disk_config': {'boot_disk_type': 'worker_disk_type', 'boot_disk_size_gb': 256}, 'image_uri': 'https://www.googleapis.com/compute/beta/projects/custom_image_project_id/global/images/custom_image'}, 'secondary_worker_config': {'num_instances': 4, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/worker_machine_type', 'disk_config': {'boot_disk_type': 'worker_disk_type', 'boot_disk_size_gb': 256}, 'is_preemptible': True, 'preemptibility': 'SPOT'}, 'software_config': {'properties': {'properties': 'data'}, 'optional_components': ['optional_components']}, 'lifecycle_config': {'idle_delete_ttl': {'seconds': 60}, 'auto_delete_time': '2019-09-12T00:00:00.000000Z'}, 'encryption_config': {'gce_pd_kms_key_name': 'customer_managed_key'}, 'autoscaling_config': {'policy_uri': 'autoscaling_policy'}, 'config_bucket': 'storage_bucket', 'initialization_actions': [{'executable_file': 'init_actions_uris', 'execution_timeout': {'seconds': 600}}], 'endpoint_config': {}}
VIRTUAL_CLUSTER_CONFIG = {'kubernetes_cluster_config': {'gke_cluster_config': {'gke_cluster_target': 'projects/project_id/locations/region/clusters/gke_cluster_name', 'node_pool_target': [{'node_pool': 'projects/project_id/locations/region/clusters/gke_cluster_name/nodePools/dp', 'roles': ['DEFAULT']}]}, 'kubernetes_software_config': {'component_version': {'SPARK': b'3'}}}, 'staging_bucket': 'test-staging-bucket'}
CONFIG_WITH_CUSTOM_IMAGE_FAMILY = {'gce_cluster_config': {'zone_uri': 'https://www.googleapis.com/compute/v1/projects/project_id/zones/zone', 'metadata': {'metadata': 'data'}, 'network_uri': 'network_uri', 'subnetwork_uri': 'subnetwork_uri', 'internal_ip_only': True, 'tags': ['tags'], 'service_account': 'service_account', 'service_account_scopes': ['service_account_scopes']}, 'master_config': {'num_instances': 2, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/master_machine_type', 'disk_config': {'boot_disk_type': 'master_disk_type', 'boot_disk_size_gb': 128}, 'image_uri': 'https://www.googleapis.com/compute/beta/projects/custom_image_project_id/global/images/family/custom_image_family'}, 'worker_config': {'num_instances': 2, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/worker_machine_type', 'disk_config': {'boot_disk_type': 'worker_disk_type', 'boot_disk_size_gb': 256}, 'image_uri': 'https://www.googleapis.com/compute/beta/projects/custom_image_project_id/global/images/family/custom_image_family'}, 'secondary_worker_config': {'num_instances': 4, 'machine_type_uri': 'projects/project_id/zones/zone/machineTypes/worker_machine_type', 'disk_config': {'boot_disk_type': 'worker_disk_type', 'boot_disk_size_gb': 256}, 'is_preemptible': True, 'preemptibility': 'SPOT'}, 'software_config': {'properties': {'properties': 'data'}, 'optional_components': ['optional_components']}, 'lifecycle_config': {'idle_delete_ttl': {'seconds': 60}, 'auto_delete_time': '2019-09-12T00:00:00.000000Z'}, 'encryption_config': {'gce_pd_kms_key_name': 'customer_managed_key'}, 'autoscaling_config': {'policy_uri': 'autoscaling_policy'}, 'config_bucket': 'storage_bucket', 'initialization_actions': [{'executable_file': 'init_actions_uris', 'execution_timeout': {'seconds': 600}}], 'endpoint_config': {'enable_http_port_access': True}}
...
WORKFLOW_TEMPLATE = {'id': WORKFLOW_NAME, 'placement': {'managed_cluster': {'cluster_name': CLUSTER_NAME, 'config': CLUSTER}}, 'jobs': [{'step_id': 'pig_job_1', 'pig_job': {}}]}
TEST_DAG_ID = 'test-dataproc-operators'
DEFAULT_DATE = datetime(2020, 1, 1)
TEST_JOB_ID = 'test-job'
TEST_WORKFLOW_ID = 'test-workflow'
DATAPROC_JOB_LINK_EXPECTED = f'https://console.cloud.google.com/dataproc/jobs/{TEST_JOB_ID}?region={GCP_REGION}&project={GCP_PROJECT}'
DATAPROC_CLUSTER_LINK_EXPECTED = f'https://console.cloud.google.com/dataproc/clusters/{CLUSTER_NAME}/monitoring?region={GCP_REGION}&project={GCP_PROJECT}'
DATAPROC_WORKFLOW_LINK_EXPECTED = f'https://console.cloud.google.com/dataproc/workflows/instances/{GCP_REGION}/{TEST_WORKFLOW_ID}?project={GCP_PROJECT}'
DATAPROC_JOB_CONF_EXPECTED = {'resource': TEST_JOB_ID, 'region': GCP_REGION, 'project_id': GCP_PROJECT, 'url': DATAPROC_JOB_LINK_DEPRECATED}
DATAPROC_JOB_EXPECTED = {'job_id': TEST_JOB_ID, 'region': GCP_REGION, 'project_id': GCP_PROJECT}
DATAPROC_CLUSTER_CONF_EXPECTED = {'resource': CLUSTER_NAME, 'region': GCP_REGION, 'project_id': GCP_PROJECT, 'url': DATAPROC_CLUSTER_LINK_DEPRECATED}
DATAPROC_CLUSTER_EXPECTED = {'cluster_id': CLUSTER_NAME, 'region': GCP_REGION, 'project_id': GCP_PROJECT}
DATAPROC_WORKFLOW_EXPECTED = {'workflow_id': TEST_WORKFLOW_ID, 'region': GCP_REGION, 'project_id': GCP_PROJECT}
BATCH_ID = 'test-batch-id'
BATCH = {'spark_batch': {'jar_file_uris': ['file:///usr/lib/spark/examples/jars/spark-examples.jar'], 'main_class': 'org.apache.spark.examples.SparkPi'}}
...
class TestDataProcHiveOperator:
    ...
    job_id = 'uuid_id'
    job_name = 'simple'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'hive_job': {'query_list': {'queries': [query]}, 'script_variables': variables}}
...
class TestDataProcPigOperator:
    ...
    job_id = 'uuid_id'
    job_name = 'simple'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'pig_job': {'query_list': {'queries': [query]}, 'script_variables': variables}}
...
class TestDataProcSparkSqlOperator:
    ...
    job_name = 'simple'
    job_id = 'uuid_id'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'spark_sql_job': {'query_list': {'queries': [query]}, 'script_variables': variables}}
    other_project_job = {'reference': {'project_id': 'other-project', 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'spark_sql_job': {'query_list': {'queries': [query]}, 'script_variables': variables}}
...
class TestDataProcSparkOperator(DataprocJobTestBase):
    ...
    job_name = 'simple'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{TEST_JOB_ID}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'spark_job': {'jar_file_uris': jars, 'main_class': main_class}}
...
class TestDataProcHadoopOperator:
    ...
    job_name = 'simple'
    job_id = 'uuid_id'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'hadoop_job': {'main_jar_file_uri': jar, 'args': args}}
...
class TestDataProcPySparkOperator:
    ...
    job_id = 'uuid_id'
    job_name = 'simple'
    job = {'reference': {'project_id': GCP_PROJECT, 'job_id': f'{job_name}_{job_id}'}, 'placement': {'cluster_name': 'cluster-1'}, 'labels': {'airflow-version': AIRFLOW_VERSION}, 'pyspark_job': {'main_python_file_uri': uri}}
