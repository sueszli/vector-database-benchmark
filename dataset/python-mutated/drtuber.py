...
from ..utils import int_or_none, NO_DEFAULT, parse_duration, str_to_int

class DrTuberIE(InfoExtractor):
    _VALID_URL = 'https?://(?:(?:www|m)\\.)?drtuber\\.com/(?:video|embed)/(?P<id>\\d+)(?:/(?P<display_id>[\\w-]+))?'
    _EMBED_REGEX = ['<iframe[^>]+?src=["\\\'](?P<url>(?:https?:)?//(?:www\\.)?drtuber\\.com/embed/\\d+)']
    _TESTS = [{'url': 'http://www.drtuber.com/video/1740434/hot-perky-blonde-naked-golf', 'md5': '93e680cf2536ad0dfb7e74d94a89facd', 'info_dict': {'id': '1740434', 'display_id': 'hot-perky-blonde-naked-golf', 'ext': 'mp4', 'title': 'hot perky blonde naked golf', 'like_count': int, 'comment_count': int, 'categories': ['Babe', 'Blonde', 'Erotic', 'Outdoor', 'Softcore', 'Solo'], 'thumbnail': 're:https?://.*\\.jpg$', 'age_limit': 18}}, {'url': 'http://www.drtuber.com/embed/489939', 'only_matching': True}, {'url': 'http://m.drtuber.com/video/3893529/lingerie-blowjob-from-beautiful-teen', 'only_matching': True}]
