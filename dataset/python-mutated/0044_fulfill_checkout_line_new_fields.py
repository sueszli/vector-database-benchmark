...
class Migration(migrations.Migration):
    dependencies = [('checkout', '0043_add_token_old_id_created_at_to_checkout_line')]
    operations = [CryptoExtension(), migrations.RunPython(set_checkout_line_token_old_id_and_created_at, migrations.RunPython.noop)]