...
if is_tf_available():
    ...
    from transformers import TFDebertaV2ForMaskedLM, TFDebertaV2ForMultipleChoice, TFDebertaV2ForQuestionAnswering, TFDebertaV2ForSequenceClassification, TFDebertaV2ForTokenClassification, TFDebertaV2Model
...
class TFDebertaModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFDebertaV2Model, TFDebertaV2ForMaskedLM, TFDebertaV2ForQuestionAnswering, TFDebertaV2ForMultipleChoice, TFDebertaV2ForSequenceClassification, TFDebertaV2ForTokenClassification) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFDebertaV2Model, 'fill-mask': TFDebertaV2ForMaskedLM, 'question-answering': TFDebertaV2ForQuestionAnswering, 'text-classification': TFDebertaV2ForSequenceClassification, 'token-classification': TFDebertaV2ForTokenClassification, 'zero-shot': TFDebertaV2ForSequenceClassification} if is_tf_available() else {}
...
class TFDeBERTaV2ModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        ...
        expected_slice = tf.constant([[[0.2356, 0.1948, 0.0369], [-0.1063, 0.3586, -0.5152], [-0.6399, -0.0259, -0.2525]]])
