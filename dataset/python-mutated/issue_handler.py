...
from homeassistant.helpers.issue_registry import async_delete_issue, async_get as async_get_issue_registry
...
class ConfirmRepairFlow(RepairsFlow):
    ...
    async def async_step_confirm(self, user_input: dict[str, str] | None=None) -> data_entry_flow.FlowResult:
        ...
        return self.async_show_form(step_id='confirm', data_schema=vol.Schema({}), description_placeholders=description_placeholders)
