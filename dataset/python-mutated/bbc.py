...
from ..utils import ExtractorError, OnDemandPagedList, clean_html, dict_get, float_or_none, get_element_by_class, int_or_none, join_nonempty, js_to_json, parse_duration, parse_iso8601, parse_qs, strip_or_none, traverse_obj, try_get, unescapeHTML, unified_timestamp, url_or_none, urlencode_postdata, urljoin

class BBCCoUkIE(InfoExtractor):
    IE_NAME = 'bbc.co.uk'
    IE_DESC = 'BBC iPlayer'
    _ID_REGEX = '(?:[pbml][\\da-z]{7}|w[\\da-z]{7,14})'
    _VALID_URL = '(?x)\n                    https?://\n                        (?:www\\.)?bbc\\.co\\.uk/\n                        (?:\n                            programmes/(?!articles/)|\n                            iplayer(?:/[^/]+)?/(?:episode/|playlist/)|\n                            music/(?:clips|audiovideo/popular)[/#]|\n                            radio/player/|\n                            events/[^/]+/play/[^/]+/\n                        )\n                        (?P<id>%s)(?!/(?:episodes|broadcasts|clips))\n                    ' % _ID_REGEX
    _EMBED_REGEX = ['setPlaylist\\("(?P<url>https?://www\\.bbc\\.co\\.uk/iplayer/[^/]+/[\\da-z]{8})"\\)']
    _LOGIN_URL = 'https://account.bbc.com/signin'
    _NETRC_MACHINE = 'bbc'
    _MEDIA_SELECTOR_URL_TEMPL = 'https://open.live.bbc.co.uk/mediaselector/6/select/version/2.0/mediaset/%s/vpid/%s'
    _MEDIA_SETS = ['iptv-all', 'pc']
    _EMP_PLAYLIST_NS = 'http://bbc.co.uk/2008/emp/playlist'
    _TESTS = [{'url': 'http://www.bbc.co.uk/programmes/b039g8p7', 'info_dict': {'id': 'b039d07m', 'ext': 'flv', 'title': 'Kaleidoscope, Leonard Cohen', 'description': 'The Canadian poet and songwriter reflects on his musical career.'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.co.uk/iplayer/episode/b00yng5w/The_Man_in_Black_Series_3_The_Printed_Name/', 'info_dict': {'id': 'b00yng1d', 'ext': 'flv', 'title': 'The Man in Black: Series 3: The Printed Name', 'description': "Mark Gatiss introduces Nicholas Pierpan's chilling tale of a writer's devilish pact with a mysterious man. Stars Ewan Bailey.", 'duration': 1800}, 'params': {'skip_download': True}, 'skip': 'Episode is no longer available on BBC iPlayer Radio'}, {'url': 'http://www.bbc.co.uk/iplayer/episode/b03vhd1f/The_Voice_UK_Series_3_Blind_Auditions_5/', 'info_dict': {'id': 'b00yng1d', 'ext': 'flv', 'title': 'The Voice UK: Series 3: Blind Auditions 5', 'description': 'Emma Willis and Marvin Humes present the fifth set of blind auditions in the singing competition, as the coaches continue to build their teams based on voice alone.', 'duration': 5100}, 'params': {'skip_download': True}, 'skip': 'Currently BBC iPlayer TV programmes are available to play in the UK only'}, {'url': 'http://www.bbc.co.uk/iplayer/episode/p026c7jt/tomorrows-worlds-the-unearthly-history-of-science-fiction-2-invasion', 'info_dict': {'id': 'b03k3pb7', 'ext': 'flv', 'title': "Tomorrow's Worlds: The Unearthly History of Science Fiction", 'description': '2. Invasion', 'duration': 3600}, 'params': {'skip_download': True}, 'skip': 'Currently BBC iPlayer TV programmes are available to play in the UK only'}, {'url': 'http://www.bbc.co.uk/programmes/b04v20dw', 'info_dict': {'id': 'b04v209v', 'ext': 'flv', 'title': 'Pete Tong, The Essential New Tune Special', 'description': "Pete has a very special mix - all of 2014's Essential New Tunes!", 'duration': 10800}, 'params': {'skip_download': True}, 'skip': 'Episode is no longer available on BBC iPlayer Radio'}, {'url': 'http://www.bbc.co.uk/music/clips/p022h44b', 'note': 'Audio', 'info_dict': {'id': 'p022h44j', 'ext': 'flv', 'title': 'BBC Proms Music Guides, Rachmaninov: Symphonic Dances', 'description': "In this Proms Music Guide, Andrew McGregor looks at Rachmaninov's Symphonic Dances.", 'duration': 227}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.co.uk/music/clips/p025c0zz', 'note': 'Video', 'info_dict': {'id': 'p025c103', 'ext': 'flv', 'title': 'Reading and Leeds Festival, 2014, Rae Morris - Closer (Live on BBC Three)', 'description': 'Rae Morris performs Closer for BBC Three at Reading 2014', 'duration': 226}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.co.uk/iplayer/episode/b054fn09/ad/natural-world-20152016-2-super-powered-owls', 'info_dict': {'id': 'p02n76xf', 'ext': 'flv', 'title': 'Natural World, 2015-2016: 2. Super Powered Owls', 'description': 'md5:e4db5c937d0e95a7c6b5e654d429183d', 'duration': 3540}, 'params': {'skip_download': True}, 'skip': 'geolocation'}, {'url': 'http://www.bbc.co.uk/iplayer/episode/b05zmgwn/royal-academy-summer-exhibition', 'info_dict': {'id': 'b05zmgw1', 'ext': 'flv', 'description': 'Kirsty Wark and Morgan Quaintance visit the Royal Academy as it prepares for its annual artistic extravaganza, meeting people who have come together to make the show unique.', 'title': 'Royal Academy Summer Exhibition', 'duration': 3540}, 'params': {'skip_download': True}, 'skip': 'geolocation'}, {'url': 'http://www.bbc.co.uk/programmes/b06rkn85', 'info_dict': {'id': 'b06rkms3', 'ext': 'flv', 'title': "Best of the Mini-Mixes 2015: Part 3, Annie Mac's Friday Night - BBC Radio 1", 'description': "Annie has part three in the Best of the Mini-Mixes 2015, plus the year's Most Played!"}, 'params': {'skip_download': True}, 'skip': "Now it's really geo-restricted"}, {'url': 'http://www.bbc.co.uk/programmes/p028bfkf/player', 'info_dict': {'id': 'p028bfkj', 'ext': 'flv', 'title': 'Extract from BBC documentary Look Stranger - Giant Leeks and Magic Brews', 'description': 'Extract from BBC documentary Look Stranger - Giant Leeks and Magic Brews'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.co.uk/iplayer/playlist/p01dvks4', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/music/clips#p02frcc3', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/iplayer/cbeebies/episode/b0480276/bing-14-atchoo', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/radio/player/p03cchwf', 'only_matching': True}, {'url': 'https://www.bbc.co.uk/music/audiovideo/popular#p055bc55', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/programmes/w3csv1y9', 'only_matching': True}, {'url': 'https://www.bbc.co.uk/programmes/m00005xn', 'only_matching': True}, {'url': 'https://www.bbc.co.uk/programmes/w172w4dww1jqt5s', 'only_matching': True}]
...
class BBCIE(BBCCoUkIE):
    ...
    _MEDIA_SETS = ['pc', 'mobile-tablet-main']
    _TESTS = [{'url': 'http://www.bbc.com/news/world-europe-32668511', 'info_dict': {'id': 'world-europe-32668511', 'title': 'Russia stages massive WW2 parade', 'description': 'md5:00ff61976f6081841f759a08bf78cc9c'}, 'playlist_count': 2}, {'url': 'http://www.bbc.com/news/business-28299555', 'info_dict': {'id': 'business-28299555', 'title': 'Farnborough Airshow: Video highlights', 'description': 'BBC reports and video highlights at the Farnborough Airshow.'}, 'playlist_count': 9, 'skip': 'Save time'}, {'url': 'http://www.bbc.co.uk/blogs/adamcurtis/entries/3662a707-0af9-3149-963f-47bea720b460', 'info_dict': {'id': '3662a707-0af9-3149-963f-47bea720b460', 'title': 'BUGGER'}, 'playlist_count': 18}, {'url': 'http://www.bbc.com/news/world-europe-32041533', 'info_dict': {'id': 'p02mprgb', 'ext': 'mp4', 'title': 'Aerial footage showed the site of the crash in the Alps - courtesy BFM TV', 'description': 'md5:2868290467291b37feda7863f7a83f54', 'duration': 47, 'timestamp': 1427219242, 'upload_date': '20150324'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/turkce/haberler/2015/06/150615_telabyad_kentin_cogu', 'info_dict': {'id': '150615_telabyad_kentin_cogu', 'ext': 'mp4', 'title': "YPG: Tel Abyad'ın tamamı kontrolümüzde", 'description': 'md5:33a4805a855c9baf7115fcbde57e7025', 'timestamp': 1434397334, 'upload_date': '20150615'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/mundo/video_fotos/2015/06/150619_video_honduras_militares_hospitales_corrupcion_aw', 'info_dict': {'id': '150619_video_honduras_militares_hospitales_corrupcion_aw', 'ext': 'mp4', 'title': 'Honduras militariza sus hospitales por nuevo escándalo de corrupción', 'description': 'md5:1525f17448c4ee262b64b8f0c9ce66c8', 'timestamp': 1434713142, 'upload_date': '20150619'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/news/video_and_audio/must_see/33376376', 'info_dict': {'id': 'p02w6qjc', 'ext': 'mp4', 'title': 'Judge Mindy Glazer: "I\'m sorry to see you here... I always wondered what happened to you"', 'duration': 56, 'description': 'Judge Mindy Glazer: "I\'m sorry to see you here... I always wondered what happened to you"'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/travel/story/20150625-sri-lankas-spicy-secret', 'info_dict': {'id': 'p02q6gc4', 'ext': 'flv', 'title': 'Sri Lanka’s spicy secret', 'description': 'As a new train line to Jaffna opens up the country’s north, travellers can experience a truly distinct slice of Tamil culture.', 'timestamp': 1437674293, 'upload_date': '20150723'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/autos/story/20130513-hyundais-rock-star', 'info_dict': {'id': 'p018zqqg', 'ext': 'mp4', 'title': 'Hyundai Santa Fe Sport: Rock star', 'description': 'md5:b042a26142c4154a6e472933cf20793d', 'timestamp': 1415867444, 'upload_date': '20141113'}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.co.uk/sport/live/olympics/36895975', 'info_dict': {'id': 'p041vhd0', 'ext': 'mp4', 'title': "Nigeria v Japan - Men's First Round", 'description': 'Live coverage of the first round from Group B at the Amazonia Arena.', 'duration': 7980, 'uploader': 'BBC Sport', 'uploader_id': 'bbc_sport'}, 'params': {'skip_download': True}, 'skip': 'Georestricted to UK'}, {'url': 'http://www.bbc.com/sport/0/football/33653409', 'info_dict': {'id': 'p02xycnp', 'ext': 'mp4', 'title': 'Transfers: Cristiano Ronaldo to Man Utd, Arsenal to spend?', 'description': "BBC Sport's David Ornstein has the latest transfer gossip, including rumours of a Manchester United return for Cristiano Ronaldo.", 'duration': 140}, 'params': {'skip_download': True}}, {'url': 'http://www.bbc.com/sport/0/football/34475836', 'info_dict': {'id': '34475836', 'title': 'Jurgen Klopp: Furious football from a witty and winning coach', 'description': 'Fast-paced football, wit, wisdom and a ready smile - why Liverpool fans should come to love new boss Jurgen Klopp.'}, 'playlist_count': 3}, {'url': 'http://www.bbc.co.uk/schoolreport/35744779', 'info_dict': {'id': '35744779', 'title': 'School which breaks down barriers in Jerusalem'}, 'playlist_count': 1}, {'url': 'http://www.bbc.com/weather/features/33601775', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/news/science-environment-33661876', 'info_dict': {'id': 'p02xzws1', 'ext': 'mp4', 'title': "Pluto may have 'nitrogen glaciers'", 'description': 'md5:6a95b593f528d7a5f2605221bc56912f', 'thumbnail': 're:https?://.+/.+\\.jpg', 'timestamp': 1437785037, 'upload_date': '20150725'}}, {'url': 'https://www.bbc.com/news/av/world-europe-59468682', 'info_dict': {'id': 'p0b71qth', 'ext': 'mp4', 'title': 'Why France is making this woman a national hero', 'description': 'md5:7affdfab80e9c3a1f976230a1ff4d5e4', 'thumbnail': 're:https?://.+/.+\\.jpg', 'timestamp': 1638230731, 'upload_date': '20211130'}}, {'url': 'http://www.bbc.co.uk/sport/rowing/35908187', 'only_matching': True}, {'url': 'https://www.bbc.co.uk/bbcthree/clip/73d0bbd0-abc3-4cea-b3c0-cdae21905eb1', 'info_dict': {'id': 'p06556y7', 'ext': 'mp4', 'title': 'Things Not To Say to people that live on council estates', 'description': "From being labelled a 'chav', to the presumption that they're 'scroungers', people who live on council estates encounter all kinds of prejudices and false assumptions about themselves, their families, and their lifestyles. Here, eight people discuss the common statements, misconceptions, and clichés that they're tired of hearing.", 'duration': 360, 'thumbnail': 're:https?://.+/.+\\.jpg'}}, {'url': 'https://www.bbc.co.uk/radio/play/b0b9z4yl', 'info_dict': {'id': 'b0b9z4vz', 'ext': 'mp4', 'title': 'Prom 6: An American in Paris and Turangalila', 'description': 'md5:51cf7d6f5c8553f197e58203bc78dff8', 'uploader': 'Radio 3', 'uploader_id': 'bbc_radio_three'}}, {'url': 'http://www.bbc.co.uk/learningenglish/chinese/features/lingohack/ep-181227', 'info_dict': {'id': 'p06w9tws', 'ext': 'mp4', 'title': 'md5:2fabf12a726603193a2879a055f72514', 'description': 'Learn English words and phrases from this story'}, 'add_ie': [BBCCoUkIE.ie_key()]}, {'url': 'https://www.bbc.com/reel/video/p07c6sb6/how-positive-thinking-is-harming-your-happiness', 'info_dict': {'id': 'p07c6sb9', 'ext': 'mp4', 'title': 'How positive thinking is harming your happiness', 'alt_title': 'The downsides of positive thinking', 'description': 'md5:fad74b31da60d83b8265954ee42d85b4', 'duration': 235, 'thumbnail': 're:https?://.+/p07c9dsr.jpg', 'upload_date': '20190604', 'categories': ['Psychology']}}, {'url': 'https://www.bbc.co.uk/sounds/play/m001q78b', 'info_dict': {'id': 'm001q789', 'ext': 'mp4', 'title': 'The Night Tracks Mix - Music for the darkling hour', 'thumbnail': 'https://ichef.bbci.co.uk/images/ic/raw/p0c00hym.jpg', 'chapters': 'count:8', 'description': 'md5:815fb51cbdaa270040aab8145b3f1d67', 'uploader': 'Radio 3', 'duration': 1800, 'uploader_id': 'bbc_radio_three'}}, {'url': 'https://www.bbcnewsd73hkzno2ini43t4gblxvycyac5aw4gnv7t2rccijh7745uqd.onion/news/av/world-europe-63208576', 'only_matching': True}, {'url': 'https://www.bbcweb3hytmzhn5d532owbu6oqadra5z3ar726vq5kgwwn6aucdccrad.onion/sport/av/football/63195681', 'only_matching': True}]
...
class BBCCoUkIPlayerPlaylistBaseIE(InfoExtractor):
    _VALID_URL_TMPL = 'https?://(?:www\\.)?bbc\\.co\\.uk/iplayer/%%s/(?P<id>%s)' % BBCCoUkIE._ID_REGEX
...
class BBCCoUkIPlayerEpisodesIE(BBCCoUkIPlayerPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://www.bbc.co.uk/iplayer/episodes/b05rcz9v', 'info_dict': {'id': 'b05rcz9v', 'title': 'The Disappearance', 'description': 'md5:58eb101aee3116bad4da05f91179c0cb'}, 'playlist_mincount': 8}, {'url': 'https://www.bbc.co.uk/iplayer/episodes/b094m5t9/doctor-foster', 'info_dict': {'id': 'b094m5t9', 'title': 'Doctor Foster', 'description': 'md5:5aa9195fad900e8e14b52acd765a9fd6'}, 'playlist_mincount': 10}, {'url': 'https://www.bbc.co.uk/iplayer/episodes/b094m5t9/doctor-foster?seriesId=b094m6nv', 'info_dict': {'id': 'b094m5t9', 'title': 'Doctor Foster', 'description': 'md5:5aa9195fad900e8e14b52acd765a9fd6'}, 'playlist_mincount': 5}, {'url': 'https://www.bbc.co.uk/iplayer/episodes/m0004c4v/beechgrove', 'info_dict': {'id': 'm0004c4v', 'title': 'Beechgrove', 'description': 'Gardening show that celebrates Scottish horticulture and growing conditions.'}, 'playlist_mincount': 37}, {'url': 'https://www.bbc.co.uk/iplayer/episodes/m0004c4v/beechgrove?page=2', 'info_dict': {'id': 'm0004c4v', 'title': 'Beechgrove', 'description': 'Gardening show that celebrates Scottish horticulture and growing conditions.'}, 'playlist_mincount': 1}]
    _PAGE_SIZE = 100
...
class BBCCoUkIPlayerGroupIE(BBCCoUkIPlayerPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://www.bbc.co.uk/iplayer/group/p02tcc32', 'info_dict': {'id': 'p02tcc32', 'title': 'Bohemian Icons', 'description': 'md5:683e901041b2fe9ba596f2ab04c4dbe7'}, 'playlist_mincount': 10}, {'url': 'https://www.bbc.co.uk/iplayer/group/p081d7j7', 'info_dict': {'id': 'p081d7j7', 'title': 'Music in Scotland', 'description': 'Perfomances in Scotland and programmes featuring Scottish acts.'}, 'playlist_mincount': 47}, {'url': 'https://www.bbc.co.uk/iplayer/group/p081d7j7?page=2', 'info_dict': {'id': 'p081d7j7', 'title': 'Music in Scotland', 'description': 'Perfomances in Scotland and programmes featuring Scottish acts.'}, 'playlist_mincount': 11}]
    _PAGE_SIZE = 200
...
class BBCCoUkPlaylistIE(BBCCoUkPlaylistBaseIE):
    ...
    _TESTS = [{'url': 'http://www.bbc.co.uk/programmes/b05rcz9v/clips', 'info_dict': {'id': 'b05rcz9v', 'title': 'The Disappearance - Clips - BBC Four', 'description': 'French thriller serial about a missing teenager.'}, 'playlist_mincount': 7}, {'url': 'http://www.bbc.co.uk/programmes/b00mfl7n/clips?page=1', 'info_dict': {'id': 'b00mfl7n', 'title': 'Frozen Planet - Clips - BBC One', 'description': 'md5:65dcbf591ae628dafe32aa6c4a4a0d8c'}, 'playlist_mincount': 24}, {'url': 'http://www.bbc.co.uk/programmes/b00mfl7n/clips', 'info_dict': {'id': 'b00mfl7n', 'title': 'Frozen Planet - Clips - BBC One', 'description': 'md5:65dcbf591ae628dafe32aa6c4a4a0d8c'}, 'playlist_mincount': 142}, {'url': 'http://www.bbc.co.uk/programmes/b05rcz9v/broadcasts/2016/06', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/programmes/b05rcz9v/clips', 'only_matching': True}, {'url': 'http://www.bbc.co.uk/programmes/b055jkys/episodes/player', 'only_matching': True}]
