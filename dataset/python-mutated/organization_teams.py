...
class OrganizationTeamsPermission(OrganizationPermission):
    scope_map = {'GET': ['org:read', 'org:write', 'org:admin'], 'POST': ['org:write', 'org:admin', 'team:write'], 'PUT': ['org:write', 'org:admin', 'team:write'], 'DELETE': ['org:admin', 'team:write']}
...
class TeamPostSerializer(serializers.Serializer):
    slug = SentrySlugField(help_text='Uniquely identifies a team and is used for the interface. If not\n        provided, it is automatically generated from the name.', max_length=50, required=False, allow_null=True)
    name = serializers.CharField(help_text='**`[DEPRECATED]`** The name for the team. If not provided, it is\n        automatically generated from the slug', max_length=64, required=False, allow_null=True, allow_blank=True)
