...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Utility to generate Caffe2 benchmark models.')
    ...
    parser.add_argument('--init-net', '--init_net', help='Output initialization net.', default='init_net.pb')
    parser.add_argument('--predict-net', '--predict_net', help='Output prediction net.', default='predict_net.pb')
    parser.add_argument('--benchmark-name', '--benchmark_name', help='Name of the benchmark network', default='benchmark')
    parser.add_argument('--input-name', '--input_name', help='Name of the input blob.', default='data')
    parser.add_argument('--output-name', '--output_name', help='Name of the output blob.', default='output')
    parser.add_argument('--instances', help='Number of instances to run the operator.', default='1')
