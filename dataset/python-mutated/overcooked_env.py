...
class OvercookEnv(BaseEnv):
    config = EasyDict(dict(env_name='cramped_room', horizon=400, concat_obs=False, action_mask=True, shape_reward=True))
...
class OvercookGameEnv(BaseEnv):
    config = EasyDict(dict(env_name='cramped_room', horizon=400, concat_obs=False, action_mask=False, shape_reward=True))
