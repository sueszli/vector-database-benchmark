...
class WorkstationCluster(proto.Message):
    ...
    class PrivateClusterConfig(proto.Message):
        ...
        """
        enable_private_endpoint: bool = proto.Field(proto.BOOL, number=1)
        cluster_hostname: str = proto.Field(proto.STRING, number=2)
        service_attachment_uri: str = proto.Field(proto.STRING, number=3)
        allowed_projects: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    ...
    reconciling: bool = proto.Field(proto.BOOL, number=4)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=15)
    ...
    etag: str = proto.Field(proto.STRING, number=9)
    network: str = proto.Field(proto.STRING, number=10)
    subnetwork: str = proto.Field(proto.STRING, number=11)
    control_plane_ip: str = proto.Field(proto.STRING, number=16)
    private_cluster_config: PrivateClusterConfig = proto.Field(proto.MESSAGE, number=12, message=PrivateClusterConfig)
    degraded: bool = proto.Field(proto.BOOL, number=13)
    conditions: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=14, message=status_pb2.Status)
...
class WorkstationConfig(proto.Message):
    ...
    class Host(proto.Message):
        ...
        class GceInstance(proto.Message):
            ...
            class GceShieldedInstanceConfig(proto.Message):
                ...
                enable_vtpm: bool = proto.Field(proto.BOOL, number=2)
                enable_integrity_monitoring: bool = proto.Field(proto.BOOL, number=3)
            ...
            class GceConfidentialInstanceConfig(proto.Message):
                ...
                """
                enable_confidential_compute: bool = proto.Field(proto.BOOL, number=1)
            ...
            class Accelerator(proto.Message):
                ...
                count: int = proto.Field(proto.INT32, number=2)
            machine_type: str = proto.Field(proto.STRING, number=1)
            service_account: str = proto.Field(proto.STRING, number=2)
            service_account_scopes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
            tags: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
            pool_size: int = proto.Field(proto.INT32, number=5)
            pooled_instances: int = proto.Field(proto.INT32, number=12)
            disable_public_ip_addresses: bool = proto.Field(proto.BOOL, number=6)
            enable_nested_virtualization: bool = proto.Field(proto.BOOL, number=7)
            shielded_instance_config: 'WorkstationConfig.Host.GceInstance.GceShieldedInstanceConfig' = proto.Field(proto.MESSAGE, number=8, message='WorkstationConfig.Host.GceInstance.GceShieldedInstanceConfig')
            confidential_instance_config: 'WorkstationConfig.Host.GceInstance.GceConfidentialInstanceConfig' = proto.Field(proto.MESSAGE, number=10, message='WorkstationConfig.Host.GceInstance.GceConfidentialInstanceConfig')
            boot_disk_size_gb: int = proto.Field(proto.INT32, number=9)
            accelerators: MutableSequence['WorkstationConfig.Host.GceInstance.Accelerator'] = proto.RepeatedField(proto.MESSAGE, number=11, message='WorkstationConfig.Host.GceInstance.Accelerator')
        gce_instance: 'WorkstationConfig.Host.GceInstance' = proto.Field(proto.MESSAGE, number=1, oneof='config', message='WorkstationConfig.Host.GceInstance')
    ...
    class PersistentDirectory(proto.Message):
        ...
        class GceRegionalPersistentDisk(proto.Message):
            ...
            class ReclaimPolicy(proto.Enum):
                """Value representing what should happen to the disk after the
                ...
                DELETE = 1
                RETAIN = 2
            size_gb: int = proto.Field(proto.INT32, number=1)
            fs_type: str = proto.Field(proto.STRING, number=2)
            disk_type: str = proto.Field(proto.STRING, number=3)
            source_snapshot: str = proto.Field(proto.STRING, number=5)
            reclaim_policy: 'WorkstationConfig.PersistentDirectory.GceRegionalPersistentDisk.ReclaimPolicy' = proto.Field(proto.ENUM, number=4, enum='WorkstationConfig.PersistentDirectory.GceRegionalPersistentDisk.ReclaimPolicy')
        gce_pd: 'WorkstationConfig.PersistentDirectory.GceRegionalPersistentDisk' = proto.Field(proto.MESSAGE, number=2, oneof='directory_type', message='WorkstationConfig.PersistentDirectory.GceRegionalPersistentDisk')
        mount_path: str = proto.Field(proto.STRING, number=1)
    ...
    class EphemeralDirectory(proto.Message):
        ...
        class GcePersistentDisk(proto.Message):
            """An EphemeralDirectory is backed by a Compute Engine
            persistent disk.
            ...
            Attributes:
                ...
                read_only (bool):
                    ...
                    must be set.
            """
            disk_type: str = proto.Field(proto.STRING, number=1)
            source_snapshot: str = proto.Field(proto.STRING, number=2)
            source_image: str = proto.Field(proto.STRING, number=3)
            read_only: bool = proto.Field(proto.BOOL, number=4)
        gce_pd: 'WorkstationConfig.EphemeralDirectory.GcePersistentDisk' = proto.Field(proto.MESSAGE, number=3, oneof='directory_type', message='WorkstationConfig.EphemeralDirectory.GcePersistentDisk')
        mount_path: str = proto.Field(proto.STRING, number=1)
    ...
    class Container(proto.Message):
        ...
        """
        image: str = proto.Field(proto.STRING, number=1)
        command: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        args: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
        env: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=4)
        working_dir: str = proto.Field(proto.STRING, number=5)
        run_as_user: int = proto.Field(proto.INT32, number=6)
    ...
    class CustomerEncryptionKey(proto.Message):
        ...
        """
        kms_key: str = proto.Field(proto.STRING, number=1)
        kms_key_service_account: str = proto.Field(proto.STRING, number=2)
    ...
    reconciling: bool = proto.Field(proto.BOOL, number=4)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=18)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    delete_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    etag: str = proto.Field(proto.STRING, number=9)
    idle_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=10, message=duration_pb2.Duration)
    running_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=11, message=duration_pb2.Duration)
    host: Host = proto.Field(proto.MESSAGE, number=12, message=Host)
    persistent_directories: MutableSequence[PersistentDirectory] = proto.RepeatedField(proto.MESSAGE, number=13, message=PersistentDirectory)
    ephemeral_directories: MutableSequence[EphemeralDirectory] = proto.RepeatedField(proto.MESSAGE, number=22, message=EphemeralDirectory)
    container: Container = proto.Field(proto.MESSAGE, number=14, message=Container)
    encryption_key: CustomerEncryptionKey = proto.Field(proto.MESSAGE, number=17, message=CustomerEncryptionKey)
    readiness_checks: MutableSequence[ReadinessCheck] = proto.RepeatedField(proto.MESSAGE, number=19, message=ReadinessCheck)
    replica_zones: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=23)
    degraded: bool = proto.Field(proto.BOOL, number=15)
    conditions: MutableSequence[status_pb2.Status] = proto.RepeatedField(proto.MESSAGE, number=16, message=status_pb2.Status)
    enable_audit_agent: bool = proto.Field(proto.BOOL, number=20)

class Workstation(proto.Message):
    """A single instance of a developer workstation with its own
    persistent storage.
    ...
    reconciling: bool = proto.Field(proto.BOOL, number=4)
    annotations: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=5)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=13)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=14, message=timestamp_pb2.Timestamp)
    delete_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=8, message=timestamp_pb2.Timestamp)
    etag: str = proto.Field(proto.STRING, number=9)
    state: State = proto.Field(proto.ENUM, number=10, enum=State)
    host: str = proto.Field(proto.STRING, number=11)
    env: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=12)
...
class ListWorkstationClustersResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    workstation_clusters: MutableSequence['WorkstationCluster'] = proto.RepeatedField(proto.MESSAGE, number=1, message='WorkstationCluster')
...
class CreateWorkstationClusterRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    workstation_cluster_id: str = proto.Field(proto.STRING, number=2)
    workstation_cluster: 'WorkstationCluster' = proto.Field(proto.MESSAGE, number=3, message='WorkstationCluster')
...
class UpdateWorkstationClusterRequest(proto.Message):
    ...
    """
    workstation_cluster: 'WorkstationCluster' = proto.Field(proto.MESSAGE, number=1, message='WorkstationCluster')
...
class DeleteWorkstationClusterRequest(proto.Message):
    ...
    force: bool = proto.Field(proto.BOOL, number=4)
...
class ListWorkstationConfigsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    workstation_configs: MutableSequence['WorkstationConfig'] = proto.RepeatedField(proto.MESSAGE, number=1, message='WorkstationConfig')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateWorkstationConfigRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    workstation_config_id: str = proto.Field(proto.STRING, number=2)
    workstation_config: 'WorkstationConfig' = proto.Field(proto.MESSAGE, number=3, message='WorkstationConfig')
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateWorkstationConfigRequest(proto.Message):
    ...
    """
    workstation_config: 'WorkstationConfig' = proto.Field(proto.MESSAGE, number=1, message='WorkstationConfig')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    validate_only: bool = proto.Field(proto.BOOL, number=3)
    allow_missing: bool = proto.Field(proto.BOOL, number=4)
...
class ListWorkstationsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    workstations: MutableSequence['Workstation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Workstation')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateWorkstationRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    workstation_id: str = proto.Field(proto.STRING, number=2)
    workstation: 'Workstation' = proto.Field(proto.MESSAGE, number=3, message='Workstation')
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateWorkstationRequest(proto.Message):
    ...
    Attributes:
        ...
        allow_missing (bool):
            ...
            situation, update_mask is ignored.
    """
    workstation: 'Workstation' = proto.Field(proto.MESSAGE, number=1, message='Workstation')
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=2, message=field_mask_pb2.FieldMask)
    validate_only: bool = proto.Field(proto.BOOL, number=3)
    allow_missing: bool = proto.Field(proto.BOOL, number=4)
...
class GenerateAccessTokenRequest(proto.Message):
    ...
    """
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, oneof='expiration', message=timestamp_pb2.Timestamp)
    ttl: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, oneof='expiration', message=duration_pb2.Duration)
    workstation: str = proto.Field(proto.STRING, number=1)
...
class GenerateAccessTokenResponse(proto.Message):
    ...
    Attributes:
        ...
        expire_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            expire.
    """
    access_token: str = proto.Field(proto.STRING, number=1)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=2, message=timestamp_pb2.Timestamp)
