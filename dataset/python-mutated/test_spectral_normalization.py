...
_inject_backend_tests = testing.inject_backend_tests(['test_weight_is_parameter', 'test_in_recomputing', 'test_deleted', 'test_u_updated_in_train', 'test_u_not_updated_in_test', 'test_serialization'], testing.product({'use_ideep': ['always', 'never']}) + testing.product({'use_cuda': [True]}) + testing.product({'use_chainerx': [True], 'chainerx_device': ['native:0', 'cuda:0']}))

@testing.parameterize(*testing.product({'use_gamma': [True, False]}))
...
@testing.parameterize(*testing.product({'lazy_init': [True, False], 'use_gamma': [True, False]}))
@_inject_backend_tests
...
@testing.parameterize(*testing.product({'use_gamma': [True, False], 'lazy_init': [True, False], 'link': [L.Convolution1D, L.Deconvolution1D]}))
@_inject_backend_tests
...
@testing.parameterize(*testing.product({'use_gamma': [True, False], 'lazy_init': [True, False], 'link': [L.Convolution2D, L.Deconvolution2D]}))
@_inject_backend_tests
...
@testing.parameterize(*testing.product({'use_gamma': [True, False], 'lazy_init': [True, False], 'link': [L.Convolution3D, L.Deconvolution3D]}))
@_inject_backend_tests
