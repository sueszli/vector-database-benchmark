...
def test_header():
    ...
    assert header.checksum == 2390948277
    ...
    assert header.executable_offset == 4096
    ...
    assert header.image_file_location_oat_checksum == 3671057043
    assert header.image_file_location_oat_data_begin == 1902809088
