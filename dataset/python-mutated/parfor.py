...
def fill_parallel_impl(return_type, arr, val):
    ...
    if arr.ndim == 1:
        ...
        def fill_1(in_arr, val):
            ...
            return None
    return fill_1
replace_functions_ndarray = {'fill': fill_parallel_impl}
...
replace_functions_checkers_map = {('argmin', 'numpy'): checker_impl('argmin_checker', argmin_checker), ('argmax', 'numpy'): checker_impl('argmax_checker', argmax_checker), ('min', 'numpy'): checker_impl('min_checker', min_checker), ('max', 'numpy'): checker_impl('max_checker', max_checker), ('amin', 'numpy'): checker_impl('min_checker', min_checker), ('amax', 'numpy'): checker_impl('max_checker', max_checker)}
...
_RedVarInfo = make_dataclass('_RedVarInfo', ['init_val', 'reduce_nodes', 'redop'], frozen=True)
