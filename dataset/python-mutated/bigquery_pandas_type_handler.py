...
from dagster_gcp.bigquery.io_manager import BigQueryClient, BigQueryIOManager, build_bigquery_io_manager
    ...
    def supported_types(self):
        if False:
            for i in range(10):
                print('nop')
        return [pd.DataFrame]
bigquery_pandas_io_manager = build_bigquery_io_manager([BigQueryPandasTypeHandler()], default_load_type=pd.DataFrame)
