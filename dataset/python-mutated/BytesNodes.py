...
"""
from .BuiltinOperationNodeBasesGenerated import ExpressionBytesOperationCapitalizeBase, ExpressionBytesOperationCenter2Base, ExpressionBytesOperationCenter3Base, ExpressionBytesOperationCount2Base, ExpressionBytesOperationCount3Base, ExpressionBytesOperationCount4Base, ExpressionBytesOperationDecode1Base, ExpressionBytesOperationDecode2Base, ExpressionBytesOperationDecode3Base, ExpressionBytesOperationEndswith2Base, ExpressionBytesOperationEndswith3Base, ExpressionBytesOperationEndswith4Base, ExpressionBytesOperationExpandtabs1Base, ExpressionBytesOperationExpandtabs2Base, ExpressionBytesOperationFind2Base, ExpressionBytesOperationFind3Base, ExpressionBytesOperationFind4Base, ExpressionBytesOperationIndex2Base, ExpressionBytesOperationIndex3Base, ExpressionBytesOperationIndex4Base, ExpressionBytesOperationIsalnumBase, ExpressionBytesOperationIsalphaBase, ExpressionBytesOperationIsdigitBase, ExpressionBytesOperationIslowerBase, ExpressionBytesOperationIsspaceBase, ExpressionBytesOperationIstitleBase, ExpressionBytesOperationIsupperBase, ExpressionBytesOperationJoinBase, ExpressionBytesOperationLjust2Base, ExpressionBytesOperationLjust3Base, ExpressionBytesOperationLowerBase, ExpressionBytesOperationLstrip1Base, ExpressionBytesOperationLstrip2Base, ExpressionBytesOperationPartitionBase, ExpressionBytesOperationReplace3Base, ExpressionBytesOperationReplace4Base, ExpressionBytesOperationRfind2Base, ExpressionBytesOperationRfind3Base, ExpressionBytesOperationRfind4Base, ExpressionBytesOperationRindex2Base, ExpressionBytesOperationRindex3Base, ExpressionBytesOperationRindex4Base, ExpressionBytesOperationRjust2Base, ExpressionBytesOperationRjust3Base, ExpressionBytesOperationRpartitionBase, ExpressionBytesOperationRsplit1Base, ExpressionBytesOperationRsplit2Base, ExpressionBytesOperationRsplit3Base, ExpressionBytesOperationRstrip1Base, ExpressionBytesOperationRstrip2Base, ExpressionBytesOperationSplit1Base, ExpressionBytesOperationSplit2Base, ExpressionBytesOperationSplit3Base, ExpressionBytesOperationSplitlines1Base, ExpressionBytesOperationSplitlines2Base, ExpressionBytesOperationStartswith2Base, ExpressionBytesOperationStartswith3Base, ExpressionBytesOperationStartswith4Base, ExpressionBytesOperationStrip1Base, ExpressionBytesOperationStrip2Base, ExpressionBytesOperationSwapcaseBase, ExpressionBytesOperationTitleBase, ExpressionBytesOperationTranslate2Base, ExpressionBytesOperationTranslate3Base, ExpressionBytesOperationUpperBase, ExpressionBytesOperationZfillBase
...
def getBytesOperationClasses():
    ...
    return (cls for (kind, cls) in NodeCheckMetaClass.kinds.items() if kind.startswith('EXPRESSION_BYTES_OPERATION_'))
...
def makeExpressionBytesOperationSplit3(bytes_arg, sep, maxsplit, source_ref):
    ...
    return ExpressionBytesOperationSplit3(bytes_arg=bytes_arg, sep=sep, maxsplit=maxsplit, source_ref=source_ref)
...
def makeExpressionBytesOperationRsplit3(bytes_arg, sep, maxsplit, source_ref):
    ...
    if sep is None:
        sep = makeConstantRefNode(constant=None, source_ref=source_ref)
    return ExpressionBytesOperationRsplit3(bytes_arg=bytes_arg, sep=sep, maxsplit=maxsplit, source_ref=source_ref)
...
class ExpressionBytesOperationDecode1(ExpressionBytesOperationDecodeMixin, ExpressionBytesOperationDecode1Base):
    kind = 'EXPRESSION_BYTES_OPERATION_DECODE1'

class ExpressionBytesOperationDecode2(ExpressionBytesOperationDecodeMixin, ExpressionBytesOperationDecode2Base):
...
def makeExpressionBytesOperationDecode3(bytes_arg, encoding, errors, source_ref):
    ...
    return ExpressionBytesOperationDecode3(bytes_arg=bytes_arg, encoding=encoding, errors=errors, source_ref=source_ref)

class ExpressionBytesOperationDecode3(ExpressionBytesOperationDecodeMixin, ExpressionBytesOperationDecode3Base):
