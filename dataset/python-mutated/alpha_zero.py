...
class Config(collections.namedtuple('Config', ['game', 'path', 'learning_rate', 'weight_decay', 'train_batch_size', 'replay_buffer_size', 'replay_buffer_reuse', 'max_steps', 'checkpoint_freq', 'actors', 'evaluators', 'evaluation_window', 'eval_levels', 'uct_c', 'max_simulations', 'policy_alpha', 'policy_epsilon', 'temperature', 'temperature_drop', 'nn_model', 'nn_width', 'nn_depth', 'observation_shape', 'output_size', 'quiet'])):
