...
with DAG(DAG_ID, start_date=datetime(2021, 1, 1), schedule='@once', catchup=False, tags=['example', 'gcs']) as dag:
    ...
    [create_bucket, create_temp_sheets_connection_task] >> create_spreadsheet >> upload_sheet_to_gcs >> upload_gcs_to_sheet >> [delete_bucket, delete_temp_sheets_connection_task]
