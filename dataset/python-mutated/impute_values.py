...
from mage_ai.data_cleaner.column_types.constants import CATEGORICAL_TYPES, NUMBER_TYPES, STRING_TYPES, ColumnType
...
class ImputeValues(BaseRule):
    RULESET = (CategoricalImputeSubRule, DateTimeImputeSubRule, ListImputeSubRule, NumericalImputeSubRule, StringImputeSubRule)
    ROW_KEPT_LB = 0.7
