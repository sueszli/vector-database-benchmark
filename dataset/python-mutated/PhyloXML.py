...
class Events(PhyloElement):
    ...
    """
    ok_type = {'transfer', 'fusion', 'speciation_or_duplication', 'other', 'mixed', 'unassigned'}
...
class Property(PhyloElement):
    ...
    """
    re_ref = re.compile('[a-zA-Z0-9_]+:[a-zA-Z0-9_\\.\\-\\s]+')
    ok_applies_to = {'phylogeny', 'clade', 'node', 'annotation', 'parent_branch', 'other'}
    ok_datatype = {'xsd:string', 'xsd:boolean', 'xsd:decimal', 'xsd:float', 'xsd:double', 'xsd:duration', 'xsd:dateTime', 'xsd:time', 'xsd:date', 'xsd:gYearMonth', 'xsd:gYear', 'xsd:gMonthDay', 'xsd:gDay', 'xsd:gMonth', 'xsd:hexBinary', 'xsd:base64Binary', 'xsd:anyURI', 'xsd:normalizedString', 'xsd:token', 'xsd:integer', 'xsd:nonPositiveInteger', 'xsd:negativeInteger', 'xsd:long', 'xsd:int', 'xsd:short', 'xsd:byte', 'xsd:nonNegativeInteger', 'xsd:unsignedLong', 'xsd:unsignedInt', 'xsd:unsignedShort', 'xsd:unsignedByte', 'xsd:positiveInteger'}
...
class SequenceRelation(PhyloElement):
    ...
    """
    ok_type = {'orthology', 'one_to_one_orthology', 'super_orthology', 'paralogy', 'ultra_paralogy', 'xenology', 'unknown', 'other'}
