...
__protobuf__ = proto.module(package='google.cloud.scheduler.v1', manifest={'ListJobsRequest', 'ListJobsResponse', 'GetJobRequest', 'CreateJobRequest', 'UpdateJobRequest', 'DeleteJobRequest', 'PauseJobRequest', 'ResumeJobRequest', 'RunJobRequest'})
...
class ListJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    jobs: MutableSequence[gcs_job.Job] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcs_job.Job)
...
class CreateJobRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    job: gcs_job.Job = proto.Field(proto.MESSAGE, number=2, message=gcs_job.Job)
...
class UpdateJobRequest(proto.Message):
    ...
    """
    job: gcs_job.Job = proto.Field(proto.MESSAGE, number=1, message=gcs_job.Job)
