...
import pytest
from connexion.decorators.parameter import AsyncParameterDecorator, SyncParameterDecorator, pythonic
...
@pytest.mark.skipif(sys.version_info < (3, 8), reason='AsyncMock only available from 3.8.')
