...
from nuitka.PythonVersions import isPythonValidCLongLongValue, isPythonValidCLongValue, python_version, sizeof_clonglong
from nuitka.Serialization import BlobData, BuiltinAnonValue, BuiltinGenericAliasValue, BuiltinSpecialValue, BuiltinUnionTypeValue, ConstantStreamReader
...
def scanConstFiles(build_dir):
    ...
    return result
_match_attribute_names = re.compile('[a-zA-Z_][a-zA-Z0-9_]*$')
