...
TEST_FIXTURES = {'enforcements': ['enforcement1.yaml', 'enforcement2.yaml', 'enforcement3.yaml']}

class RuleEnforcementControllerTestCase(FunctionalTest, APIControllerWithIncludeAndExcludeFilterTestCase):
