...
from modelscope.models.multi_modal.guided_diffusion.script import create_diffusion
...
@PIPELINES.register_module(Tasks.text_to_image_synthesis, module_name=Pipelines.disco_guided_diffusion)
