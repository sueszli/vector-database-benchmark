...
class WriteAccessAllowed(TelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, from_request: Optional[bool]=None, web_app_name: Optional[str]=None, from_attachment_menu: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                i = 10
                return i + 15
            super().__init__(from_request=from_request, web_app_name=web_app_name, from_attachment_menu=from_attachment_menu, **__pydantic_kwargs)