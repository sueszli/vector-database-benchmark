...
from doitlive.version_control import get_current_git_branch, get_current_hg_bookmark, get_current_hg_branch, get_current_hg_id, get_current_vcs_branch
env = os.environ
THEMES = OrderedDict([('default', '{user.cyan.bold}@{hostname.blue}:{dir.green} $'), ('sorin', '{cwd.blue} {vcs_branch.cyan} {r_angle.red}{r_angle.yellow}{r_angle.green}'), ('stev', '{cwd.blue} {vcs_branch.cyan} {r_angle.green}'), ('damoekri', '{dir.cyan} {r_angle.green}'), ('smiley', '{vcs_branch.blue.paren}{dir.white.bold} {TTY.GREEN}ツ{TTY.RESET}'), ('nicolauj', '{r_angle.white}'), ('steeef', '{user.red} at {hostname.yellow} in {cwd.green} {vcs_branch.cyan.paren}\n$'), ('redhat', '[{user}@{hostname} {dir}]$'), ('redhat_color', '[{user.red.bold}@{hostname.red} {dir.blue}]$'), ('walters', '{user}@{hostname.underlined}>'), ('walters_color', '{user.cyan.bold}@{hostname.blue.underlined}>'), ('minimal', '{dir} {vcs_branch.square} »'), ('minimal_color', '{dir.cyan} {vcs_branch.blue.square} »'), ('osx', '{hostname}:{dir} {user}$'), ('osx_color', '{hostname.blue}:{dir.green} {user.cyan}$'), ('pws', '{TTY.BOLD}+{TTY.YELLOW}{now:%I:%M}{TTY.RESET}%'), ('robbyrussell', '{r_arrow.red} {dir.cyan} {vcs_branch.red.paren.git}'), ('giddie', '{user.magenta}@{hostname.yellow}|{cwd.green} on {vcs_branch.magenta}\n{TTY.BLUE}±{TTY.RESET}'), ('deadsimple', '$')])
