...
class SeriesWithExtras:
    ...
    def __init__(self, series: EventsNode | ActionsNode, is_previous_period_series: Optional[bool], overriden_query: Optional[TrendsQuery], aggregate_values: Optional[bool]):
        if False:
            i = 10
            return i + 15
        self.series = series
