...
from ..utils import clean_html, extract_attributes, ExtractorError, float_or_none, get_element_by_class, int_or_none, srt_subtitles_timecode, strip_or_none, mimetype2ext, try_get, urlencode_postdata, urljoin
...
class LinkedInLearningIE(LinkedInLearningBaseIE):
    ...
    _TEST = {'url': 'https://www.linkedin.com/learning/programming-foundations-fundamentals/welcome?autoplay=true', 'md5': 'a1d74422ff0d5e66a792deb996693167', 'info_dict': {'id': '90426', 'ext': 'mp4', 'title': 'Welcome', 'timestamp': 1430396150.82, 'upload_date': '20150430'}}
...
class LinkedInLearningCourseIE(LinkedInLearningBaseIE):
    ...
    _TEST = {'url': 'https://www.linkedin.com/learning/programming-foundations-fundamentals', 'info_dict': {'id': 'programming-foundations-fundamentals', 'title': 'Programming Foundations: Fundamentals', 'description': 'md5:76e580b017694eb89dc8e8923fff5c86'}, 'playlist_mincount': 61}
