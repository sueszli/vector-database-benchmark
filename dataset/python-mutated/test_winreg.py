...
test_data = [('Int Value', 45, REG_DWORD), ('Qword Value', 1234605616436508552, REG_QWORD), ('String Val', 'A string value', REG_SZ), ('StringExpand', 'The path is %path%', REG_EXPAND_SZ), ('Multi-string', ['Lots', 'of', 'string', 'values'], REG_MULTI_SZ), ('Multi-nul', ['', '', '', ''], REG_MULTI_SZ), ('Raw Data', b'binary\x00data', REG_BINARY), ('Big String', 'x' * (2 ** 14 - 1), REG_SZ), ('Big Binary', b'x' * 2 ** 14, REG_BINARY), ('Japanese 日本', '日本語', REG_SZ)]
