...
from localstack.services.cloudformation.deployment_utils import generate_default_name, select_parameters
...
from localstack.utils.common import cp_r, is_base64, is_zip_file, mkdir, new_tmp_dir, rm_rf, save_file, select_attributes, to_bytes
