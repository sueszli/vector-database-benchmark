...
class PyTorchDistributed(LightningWork):
    ...
    def run(self, world_size: int, node_rank: int, global_rank: str, local_rank: int):
        if False:
            return 10
        ...
        for step in range(1000):
            ...
            loss.backward()
            optimizer.step()
app = LightningApp(PyTorchSpawnMultiNode(PyTorchDistributed, num_nodes=2, cloud_compute=CloudCompute('gpu-fast-multi')))