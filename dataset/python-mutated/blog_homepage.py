...
MAX_POSTS_TO_RECOMMEND_AT_END_OF_BLOG_POST: Final = feconf.MAX_POSTS_TO_RECOMMEND_AT_END_OF_BLOG_POST
...
class BlogHomepageDataHandler(base.BaseHandler[Dict[str, str], BlogHomepageDataHandlerNormalizedRequestDict]):
    """Provides blog cards data and default tags data for the blog homepage."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'offset': {'schema': {'type': 'basestring'}}}}
...
class BlogPostDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'blog_post_url': {'schema': {'type': 'basestring', 'validators': [{'id': 'has_length_at_most', 'max_value': MAX_CHARS_IN_BLOG_POST_URL}, {'id': 'has_length_at_least', 'min_value': constants.BLOG_POST_ID_LENGTH}]}}}
...
class AuthorsPageHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'author_username': {'schema': {'type': 'basestring'}}}
    HANDLER_ARGS_SCHEMAS = {'GET': {'offset': {'schema': {'type': 'basestring'}}}}
...
class BlogPostSearchHandler(base.BaseHandler[Dict[str, str], BlogPostSearchHandlerNormalizedRequestDict]):
    """Provides blog cards for blog search page based on query provided and
    applied tag filters.
    """
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'q': {'schema': {'type': 'basestring'}, 'default_value': ''}, 'tags': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_search_query_string'}, {'id': 'is_regex_matched', 'regex_pattern': '[\\-\\w+()"\\s]*'}]}, 'default_value': ''}, 'offset': {'schema': {'type': 'int'}, 'default_value': None}}}
