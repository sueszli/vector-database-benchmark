...
_WEB_CONFIG_CONTENT = '<?xml version="1.0" encoding="UTF-8" ?>\n<!--Generated by Certbot-->\n<configuration>\n  <system.webServer>\n      <staticContent>\n          <remove fileExtension="."/>\n          <mimeMap fileExtension="." mimeType="text/plain" />\n      </staticContent>\n  </system.webServer>\n</configuration>\n'
_WEB_CONFIG_SHA256SUMS = ['20c5ca1bd58fa8ad5f07a2f1be8b7cbb707c20fcb607a8fc8db9393952846a97', '8d31383d3a079d2098a9d0c0921f4ab87e708b9868dc3f314d54094c2fe70336']

class Authenticator(common.Plugin, interfaces.Authenticator):
    """Webroot Authenticator."""
    description = 'Saves the necessary validation files to a .well-known/acme-challenge/ directory within the nominated webroot path. A seperate HTTP server must be running and serving files from the webroot path. HTTP challenge only (wildcards not supported).'
    MORE_INFO = 'Authenticator plugin that performs http-01 challenge by saving\nnecessary validation resources to appropriate paths on the file\nsystem. It expects that there is some other HTTP server configured\nto serve all files under specified web root ({0}).'
