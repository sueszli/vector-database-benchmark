...
p = figure(height=400, x_axis_label='hp', y_axis_label='mpg', background_fill_color='#fafafa', tools='', toolbar_location=None, title='Kernel density estimation plot of HP vs MPG')
