...
from zipline.data.resample import MinuteResampleSessionBarReader, ReindexMinuteBarReader, ReindexSessionBarReader
...
class AssetDispatchSessionBarTestCase(WithBcolzEquityDailyBarReader, WithBcolzFutureMinuteBarReader, WithTradingSessions, ZiplineTestCase):
...
class AssetDispatchMinuteBarTestCase(WithBcolzEquityMinuteBarReader, WithBcolzFutureMinuteBarReader, ZiplineTestCase):
    TRADING_CALENDAR_STRS = ('us_futures', 'NYSE')
    TRADING_CALENDAR_PRIMARY_CAL = 'us_futures'
    ASSET_FINDER_EQUITY_SIDS = (1, 2, 3)
