...
class WebOfStoriesIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.webofstories.com/play/hans.bethe/71', 'md5': '373e4dd915f60cfe3116322642ddf364', 'info_dict': {'id': '4536', 'ext': 'mp4', 'title': 'The temperature of the sun', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'Hans Bethe talks about calculating the temperature of the sun', 'duration': 238}}, {'url': 'http://www.webofstories.com/play/55908', 'md5': '2985a698e1fe3211022422c4b5ed962c', 'info_dict': {'id': '55908', 'ext': 'mp4', 'title': 'The story of Gemmata obscuriglobus', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'Planctomycete talks about The story of Gemmata obscuriglobus', 'duration': 169}, 'skip': 'notfound'}, {'url': 'http://www.webofstories.com/play/54215?o=MS', 'info_dict': {'id': '54215', 'ext': 'mp4', 'title': '"A Leg to Stand On"', 'thumbnail': 're:^https?://.*\\.jpg$', 'description': 'Oliver Sacks talks about the death and resurrection of a limb', 'duration': 97}, 'params': {'skip_download': True}}]
...
class WebOfStoriesPlaylistIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.webofstories.com/playAll/donald.knuth', 'info_dict': {'id': 'donald.knuth', 'title': 'Donald Knuth (Scientist)'}, 'playlist_mincount': 97}
