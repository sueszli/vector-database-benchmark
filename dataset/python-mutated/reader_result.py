...
class ReaderResultLikeN(reader.ReaderLike3[_FirstType, _SecondType, _ThirdType], result.ResultLikeN[_FirstType, _SecondType, _ThirdType]):
    """
    ...
    @abstractmethod
    def bind_context_result(self: _ReaderResultLikeType, function: Callable[[_FirstType], ReaderResult[_UpdatedType, _SecondType, _ThirdType]]) -> KindN[_ReaderResultLikeType, _UpdatedType, _SecondType, _ThirdType]:
        if False:
            while True:
                i = 10
...
class ReaderResultBasedN(ReaderResultLikeN[_FirstType, _SecondType, _ThirdType], reader.CallableReader3[_FirstType, _SecondType, _ThirdType, 'Result[_FirstType, _SecondType]', _ThirdType], Lawful['ReaderResultBasedN[_FirstType, _SecondType, _ThirdType]']):
    """
    ...
    """
    __slots__ = ()
    _laws: ClassVar[Sequence[Law]] = (Law2(_LawSpec.purity_law), Law2(_LawSpec.asking_law))
