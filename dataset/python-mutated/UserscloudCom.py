...
class UserscloudCom(XFSDownloader):
    ...
    __version__ = '0.11'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?userscloud\\.com/(?P<ID>\\w{12})'
    ...
    INFO_PATTERN = '<a href="https://userscloud.com/.+?" target="_blank">(?P<N>.+?) - (?P<S>[\\d.,]+) (?P<U>[\\w^_]+)</a>'
    OFFLINE_PATTERN = 'The file you are trying to download is no longer available'
    LINK_FREE_PATTERN = '<a href="(https://\\w+\\.usercdn\\.com.+?)"'
    URL_REPLACEMENTS = [(__pattern__ + '.*', 'https://userscloud.com/\\g<ID>')]
