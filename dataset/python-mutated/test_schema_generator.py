...
import tempfile
import pytest
from airbyte_cdk.models import AirbyteCatalog, AirbyteMessage, AirbyteRecordMessage, AirbyteStream, ConfiguredAirbyteCatalog, ConfiguredAirbyteStream, DestinationSyncMode, SyncMode, Type
