...
import json
from ibis.backends.base.sql.ddl import AlterTable, BaseDDL, CreateTable, CreateTableWithSchema, DropFunction, format_partition, format_schema, format_tblproperties
