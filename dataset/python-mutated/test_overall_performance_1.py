...
schema_registry.add('field_3_schema', {'field_31': {'contains': 0, 'empty': False}, 'field_32': {'default': [None, None, None], 'items': [{'type': 'integer'}, {'type': 'string'}, {'type': ['integer', 'string']}], 'schema': {'nullable': True}}})
