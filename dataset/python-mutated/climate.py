...
from homeassistant.components.climate import PRESET_ECO, ClimateEntity, ClimateEntityFeature, HVACMode
...
STE_TO_HA_HVAC = {'AUTOMATIC': HVACMode.AUTO, 'MANUAL MODE': HVACMode.HEAT, 'STANDBY': HVACMode.AUTO, 'DAY MODE': HVACMode.AUTO, 'SETBACK MODE': HVACMode.AUTO, 'DHW': HVACMode.OFF, 'EMERGENCY OPERATION': HVACMode.AUTO}
STE_TO_HA_PRESET = {'STANDBY': PRESET_ECO, 'DAY MODE': PRESET_DAY, 'SETBACK MODE': PRESET_SETBACK, 'EMERGENCY OPERATION': PRESET_EMERGENCY}
HA_TO_STE_HVAC = {HVACMode.AUTO: 'AUTOMATIC', HVACMode.HEAT: 'MANUAL MODE', HVACMode.OFF: 'DHW'}
