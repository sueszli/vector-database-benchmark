import pytest
from vyper.exceptions import InvalidLiteral, InvalidType, OverflowException, StructureException, UnexpectedNodeType
...
TYPES = {AddressT(): 'address', BoolT(): 'bool', BYTES32_T: 'bytes32', DecimalT(): 'decimal', INT128_T: 'int128', UINT256_T: 'uint256', BytesT: 'Bytes[1]', StringT: 'String[1]'}
VALID_LITERALS = {AddressT(): ['0x6B175474E89094C44Da98b954EedeAC495271d0F'], BoolT(): ['True', 'False'], BYTES32_T: ['0x6b175474e89094c44da98b954eedeac495271d0f4da98b954eedeac495271d0f', '0x6B175474E89094C44DA98B954EEDEAC495271D0F4DA98B954EEDEAC495271D0F'], DecimalT(): ['-1.666', '3.31337', '8008135.0', '1.2345678901'], INT128_T: ['-1', '0', '12', '42'], UINT256_T: ['0', '12', '42'], BytesT: ["b''", "b'this is thirty three bytes long!!'", "b'\\xbe\\xef'"], StringT: ["''", "'hello'", "'this is thirty three chars long!!'", "'-42'"]}
INVALID_LITERALS = ['None', '115792089237316195423570985008687907853269984665640564039457584007913129639936', '115792089237316195423570985008687907853269984665640564039457584007913129639935.1']
ALL_LITERALS = [x for v in VALID_LITERALS.values() for x in v] + INVALID_LITERALS
INVALID_NODES = ['self.{}', '[{}]', '({},)', '{}()', '{}(foo)', '{}.foo', 'public({})', '-{}', '{}[1]', 'self.{}[1]']
