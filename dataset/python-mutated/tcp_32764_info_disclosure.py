...
class Exploit(TCPClient):
    ...
    def get_config(self):
        if False:
            i = 10
            return i + 15
        headers = struct.pack(self.endianness + 'III', 1399016781, 1, 1)
