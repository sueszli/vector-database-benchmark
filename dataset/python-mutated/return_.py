...
from vyper.codegen.core import calculate_type_for_external_return, check_assign, dummy_node_for_type, get_type_for_exact_size, make_setter, needs_clamp, wrap_value_for_external_return
