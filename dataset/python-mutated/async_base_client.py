...
from .async_internal_utils import _files_to_data, _request_with_session
from .async_slack_response import AsyncSlackResponse
from .deprecation import show_deprecation_warning_if_any
from .internal_utils import convert_bool_to_0_or_1, _build_req_args, _get_url, get_user_agent
...
class AsyncBaseClient:
    ...
    async def api_call(self, api_method: str, *, http_verb: str='POST', files: Optional[dict]=None, data: Union[dict, FormData]=None, params: Optional[dict]=None, json: Optional[dict]=None, headers: Optional[dict]=None, auth: Optional[dict]=None) -> AsyncSlackResponse:
        ...
        return await self._send(http_verb=http_verb, api_url=api_url, req_args=req_args)
    ...
    async def _request(self, *, http_verb, api_url, req_args) -> Dict[str, Any]:
        ...
        """
        return await _request_with_session(current_session=self.session, timeout=self.timeout, logger=self._logger, http_verb=http_verb, api_url=api_url, req_args=req_args, retry_handlers=self.retry_handlers)