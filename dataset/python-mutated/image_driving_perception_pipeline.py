...
from modelscope.models.cv.image_driving_perception import ImageDrivingPerceptionPreprocessor, driving_area_mask, lane_line_mask, non_max_suppression, scale_coords, split_for_trace_model
...
@PIPELINES.register_module(Tasks.image_driving_perception, module_name=Pipelines.yolopv2_image_driving_percetion_bdd100k)
