...
class rds_instance_deprecated_engine_version(Check):
    ...
    def execute(self):
        ...
        for db_instance in rds_client.db_instances:
            ...
            if hasattr(rds_client.db_engines.get(db_instance.region, {}).get(db_instance.engine, {}), 'engine_versions') and db_instance.engine_version in rds_client.db_engines[db_instance.region][db_instance.engine].engine_versions:
                report.status = 'PASS'
