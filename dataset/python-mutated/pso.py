...
class CMEModule:
    ...
    def on_login(self, context, connection):
        ...
        try:
            ...
            resp = connection.ldapConnection.search(searchFilter=searchFilter, attributes=self.pso_fields, sizeLimit=0)
