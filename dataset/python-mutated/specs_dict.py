...
_MISSING_KEYS_FROM_SPEC = 'The data dict does not match the model specs. Keys {} are in the data dict but not on the given spec dict, and exact_match is set to True'
_MISSING_KEYS_FROM_DATA = 'The data dict does not match the model specs. Keys {} are in the spec dict but not on the data dict. Data keys are {}'
_TYPE_MISMATCH = 'The data does not match the spec. The data element {} has type {} (expected type {}).'
