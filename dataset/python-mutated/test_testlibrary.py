...
import sys
import unittest
from robot.running.testlibraries import TestLibrary, _ClassLibrary, _ModuleLibrary, _DynamicLibrary
from robot.utils.asserts import assert_equal, assert_false, assert_none, assert_not_equal, assert_not_none, assert_true, assert_raises, assert_raises_with_msg
from robot.utils import normalize
from robot.errors import DataError
from classes import NameLibrary, DocLibrary, ArgInfoLibrary, GetattrLibrary, SynonymLibrary, __file__ as classes_source
default_keywords = [('no operation', ()), ('log', ('msg',)), ('L O G', ('msg', 'warning')), ('fail', ()), ('  f  a  i  l  ', ('msg',))]
example_keywords = [('Log', ('msg',)), ('log many', ()), ('logmany', ('msg',)), ('L O G M A N Y', ('m1', 'm2', 'm3', 'm4', 'm5')), ('equals', ('1', '1')), ('equals', ('1', '2', 'failed'))]
