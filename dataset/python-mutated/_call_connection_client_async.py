...
class CallConnectionClient:
    ...
    async def get_participant(self, target_participant: 'CommunicationIdentifier', **kwargs) -> 'CallParticipant':
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        participant = await self._call_connection_client.get_participant(self._call_connection_id, target_participant.raw_id, **kwargs)
    ...
    @distributed_trace_async
    async def add_participant(self, target_participant: 'CommunicationIdentifier', *, invitation_timeout: Optional[int]=None, operation_context: Optional[str]=None, sip_headers: Optional[Dict[str, str]]=None, voip_headers: Optional[Dict[str, str]]=None, source_caller_id_number: Optional['PhoneNumberIdentifier']=None, source_display_name: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> AddParticipantResult:
        ...
        process_repeatability_first_sent(kwargs)
        response = await self._call_connection_client.add_participant(self._call_connection_id, add_participant_request, **kwargs)
        return AddParticipantResult._from_generated(response)

    @distributed_trace_async
    async def remove_participant(self, target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> RemoveParticipantResult:
        ...
        process_repeatability_first_sent(kwargs)
        response = await self._call_connection_client.remove_participant(self._call_connection_id, remove_participant_request, **kwargs)
        return RemoveParticipantResult._from_generated(response)

    @distributed_trace_async
    async def play_media(self, play_source: Union[MediaSources, List[MediaSources]], play_to: Union[Literal['all'], List['CommunicationIdentifier']]='all', *, loop: bool=False, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> None:
    ...
    @distributed_trace_async
    async def play_media_to_all(self, play_source: Union['FileSource', List['FileSource']], *, loop: bool=False, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> None:
        ...
        await self.play_media(play_source=play_source, loop=loop, operation_context=operation_context, callback_url=callback_url, **kwargs)

    @distributed_trace_async
    async def start_recognizing_media(self, input_type: Union[str, 'RecognizeInputType'], target_participant: 'CommunicationIdentifier', *, initial_silence_timeout: Optional[int]=None, play_prompt: Optional[Union[MediaSources, List[MediaSources]]]=None, interrupt_call_media_operation: bool=False, operation_context: Optional[str]=None, interrupt_prompt: bool=False, dtmf_inter_tone_timeout: Optional[int]=None, dtmf_max_tones_to_collect: Optional[str]=None, dtmf_stop_tones: Optional[List[str or 'DtmfTone']]=None, choices: Optional[List['Choice']]=None, end_silence_timeout_in_ms: Optional[int]=None, speech_recognition_model_endpoint_id: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> None:
        ...
        recognize_request = RecognizeRequest(recognize_input_type=input_type, play_prompt=play_source_single._to_generated() if play_source_single else None, interrupt_call_media_operation=interrupt_call_media_operation, operation_context=operation_context, recognize_options=options, callback_uri=callback_url, **kwargs)
        await self._call_media_client.recognize(self._call_connection_id, recognize_request)
    ...
    @distributed_trace_async
    async def start_continuous_dtmf_recognition(self, target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, **kwargs) -> None:
        ...
        await self._call_media_client.start_continuous_dtmf_recognition(self._call_connection_id, continuous_dtmf_recognition_request, **kwargs)

    @distributed_trace_async
    async def stop_continuous_dtmf_recognition(self, target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> None:
        ...
        await self._call_media_client.stop_continuous_dtmf_recognition(self._call_connection_id, continuous_dtmf_recognition_request, **kwargs)

    @distributed_trace_async
    async def send_dtmf(self, tones: List[Union[str, 'DtmfTone']], target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> None:
        ...
        await self._call_media_client.send_dtmf(self._call_connection_id, send_dtmf_request, **kwargs)

    @distributed_trace_async
    async def mute_participants(self, target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, **kwargs) -> MuteParticipantsResult:
        ...
        process_repeatability_first_sent(kwargs)
        response = await self._call_connection_client.mute(self._call_connection_id, mute_participants_request, **kwargs)
        return MuteParticipantsResult._from_generated(response)

    @distributed_trace_async
    async def cancel_add_participant(self, invitation_id: str, *, operation_context: Optional[str]=None, callback_url: Optional[str]=None, **kwargs) -> CancelAddParticipantResult:
        ...
        process_repeatability_first_sent(kwargs)
        response = await self._call_connection_client.cancel_add_participant(self._call_connection_id, cancel_add_participant_request, **kwargs)
        return CancelAddParticipantResult._from_generated(response)

    @distributed_trace_async
    async def start_hold_music(self, target_participant: 'CommunicationIdentifier', play_source: MediaSources, *, loop: bool=True, operation_context: Optional[str]=None, **kwargs) -> None:
    ...
    @distributed_trace_async
    async def stop_hold_music(self, target_participant: 'CommunicationIdentifier', *, operation_context: Optional[str]=None, **kwargs) -> None:
