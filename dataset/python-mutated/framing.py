...
__all__ = ('FramerBase', 'NewlineFramer', 'BinaryFramer', 'BitcoinFramer', 'OversizedPayloadError', 'BadChecksumError', 'BadMagicError')
    ...
    async def receive_message(self):
        ...
        while True:
            ...
            if npos == -1:
                ...
                raise MemoryError(f'dropping message over {self.max_size:,d} bytes and re-synchronizing')
