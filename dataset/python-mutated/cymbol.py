...
gcc_compiler_path = pwndbg.gdblib.config.add_param('gcc-compiler-path', '', 'path to the gcc/g++ toolchain for generating imported symbols', param_class=gdb.PARAM_OPTIONAL_FILENAME)
cymbol_editor = pwndbg.gdblib.config.add_param('cymbol-editor', '', 'path to the editor for editing custom structures', param_class=gdb.PARAM_OPTIONAL_FILENAME)
