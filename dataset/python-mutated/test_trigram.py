...
try:
    from django.contrib.postgres.search import TrigramDistance, TrigramSimilarity, TrigramStrictWordDistance, TrigramStrictWordSimilarity, TrigramWordDistance, TrigramWordSimilarity
except ImportError:
    pass
