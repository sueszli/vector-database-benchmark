...
from searx.exceptions import SearxXPathSyntaxException, SearxEngineXPathException, SearxEngineAPIException, SearxEngineAccessDeniedException
from searx import searx_parent_dir, settings
from searx.engines import engines
errors_per_engines = {}

class ErrorContext:
    __slots__ = ('filename', 'function', 'line_no', 'code', 'exception_classname', 'log_message', 'log_parameters', 'secondary')
