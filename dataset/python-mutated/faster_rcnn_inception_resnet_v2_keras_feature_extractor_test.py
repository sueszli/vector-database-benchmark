...
class FasterRcnnInceptionResnetV2KerasFeatureExtractorTest(tf.test.TestCase):
    ...
    def _build_feature_extractor(self, first_stage_features_stride):
        if False:
            return 10
        return frcnn_inc_res.FasterRCNNInceptionResnetV2KerasFeatureExtractor(is_training=False, first_stage_features_stride=first_stage_features_stride, batch_norm_trainable=False, weight_decay=0.0)
    ...
    def test_extract_proposal_features_returns_expected_size(self):
        ...
        rpn_feature_map = feature_extractor.get_proposal_feature_extractor_model(name='TestScope')(preprocessed_inputs)
    ...
    def test_extract_proposal_features_dies_with_incorrect_rank_inputs(self):
        ...
        with self.assertRaises(ValueError):
            feature_extractor.get_proposal_feature_extractor_model(name='TestScope')(preprocessed_inputs)
    ...
    def test_extract_box_classifier_features_returns_expected_size(self):
        ...
        model = feature_extractor.get_box_classifier_feature_extractor_model(name='TestScope')
