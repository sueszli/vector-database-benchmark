...
class TIME_ZONE_INFORMATION(_SimpleStruct):
    _fields_ = [('bias', int), ('standard_name', str), ('standard_start', SYSTEMTIME), ('standard_bias', int), ('daylight_name', str), ('daylight_start', SYSTEMTIME), ('daylight_bias', int)]

class DYNAMIC_TIME_ZONE_INFORMATION(_SimpleStruct):
    _fields_ = TIME_ZONE_INFORMATION._fields_ + [('key_name', str), ('dynamic_daylight_time_disabled', bool)]
...
class TimeZoneInfo(datetime.tzinfo):
    ...
    1
    """
    tzRegKey = 'SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Time Zones'
