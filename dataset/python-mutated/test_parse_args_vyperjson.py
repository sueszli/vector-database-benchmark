...
INPUT_JSON = {'language': 'Vyper', 'sources': {'contracts/foo.vy': {'content': FOO_CODE}, 'contracts/bar.vy': {'content': BAR_CODE}}, 'interfaces': {'contracts/ibar.json': {'abi': BAR_ABI}}, 'settings': {'outputSelection': {'*': ['*']}}}
