...
def find_source_pcd_folder_path(dataset_name):
    ...
    return dataset_name
valid_dataset_list = ['2011_09_26_drive_0009', '2011_09_30_drive_0018', '2011_09_30_drive_0027', '2011_09_30_drive_0028', '2011_10_03_drive_0027', '2011_10_03_drive_0034']
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_name', type=str, default='2011_09_30_drive_0028', help='Kitti city sequence name [Example: "2011_09_26_drive_0009"].')
    parser.add_argument('--print_available_datasets', action='store_true', help='visualize ray casting every 100 frames')
    parser.add_argument('--voxel_size', type=float, default=0.05, help='voxel size of the pointcloud.')
    parser.add_argument('--start_index', type=int, default=0, help='start index of the dataset frame.')
    parser.add_argument('--end_index', type=int, default=1000, help='maximum end index of the dataset frame.')
    ...
    if not args.dataset_name in valid_dataset_list:
        raise RuntimeError('Dataset not present, kindly try with a different dataset. \nRun with --print_available_datasets, to get the list of available datasets.')
    ...
    source_folder = join(download_dataset_path, find_source_pcd_folder_path(args.dataset_name))
    print('Source raw kitti lidar data: ', source_folder)
    preprocess_and_save(source_folder, destination_path, args.voxel_size, args.start_index, args.end_index)
    print('Data fetching completed. Output pointcloud frames: ', destination_path)