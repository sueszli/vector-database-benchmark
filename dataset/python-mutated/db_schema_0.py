...
import json
import logging
from sqlalchemy import Boolean, Column, DateTime, ForeignKey, Index, Integer, String, Text, distinct
...
class States(Base):
    ...
    created = Column(DateTime(timezone=True), default=dt_util.utcnow)
    __table_args__ = (Index('states__state_changes', 'last_changed', 'last_updated', 'entity_id'), Index('states__significant_changes', 'domain', 'last_updated', 'entity_id'))
