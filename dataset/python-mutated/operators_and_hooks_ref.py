...
option_tag = click.option('--tag', multiple=True, help='If passed, displays integrations that have a matching tag')
option_header_separator = click.option('--header-separator', default=DEFAULT_HEADER_SEPARATOR, show_default=True)
