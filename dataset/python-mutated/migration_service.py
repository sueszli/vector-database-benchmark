...
class CreateMigrationWorkflowRequest(proto.Message):
    ...
    migration_workflow: migration_entities.MigrationWorkflow = proto.Field(proto.MESSAGE, number=2, message=migration_entities.MigrationWorkflow)
...
class ListMigrationWorkflowsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    migration_workflows: MutableSequence[migration_entities.MigrationWorkflow] = proto.RepeatedField(proto.MESSAGE, number=1, message=migration_entities.MigrationWorkflow)
...
class ListMigrationSubtasksResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    migration_subtasks: MutableSequence[migration_entities.MigrationSubtask] = proto.RepeatedField(proto.MESSAGE, number=1, message=migration_entities.MigrationSubtask)
    next_page_token: str = proto.Field(proto.STRING, number=2)
