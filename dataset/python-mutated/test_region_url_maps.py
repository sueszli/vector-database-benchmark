...
from google.cloud.compute_v1.services.region_url_maps import RegionUrlMapsClient, pagers, transports
...
@pytest.mark.parametrize('client_class,transport_name', [(RegionUrlMapsClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.RegionUrlMapsRestTransport, 'rest')])
...
def test_region_url_maps_client_get_transport_class():
    ...
    available_transports = [transports.RegionUrlMapsRestTransport]
    assert transport in available_transports
    transport = RegionUrlMapsClient.get_transport_class('rest')
    assert transport == transports.RegionUrlMapsRestTransport

@pytest.mark.parametrize('client_class,transport_class,transport_name', [(RegionUrlMapsClient, transports.RegionUrlMapsRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(RegionUrlMapsClient, transports.RegionUrlMapsRestTransport, 'rest', 'true'), (RegionUrlMapsClient, transports.RegionUrlMapsRestTransport, 'rest', 'false')])
@mock.patch.object(RegionUrlMapsClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(RegionUrlMapsClient))
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(RegionUrlMapsClient, transports.RegionUrlMapsRestTransport, 'rest', None)])
...
def test_delete_rest_interceptors(null_interceptor):
    if False:
        return 10
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_delete') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_delete') as pre:
...
def test_delete_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', region='region_value', url_map='url_map_value')
...
def test_delete_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete(compute.DeleteRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value')
...
def test_delete_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.delete_unary(compute.DeleteRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value')
...
def test_get_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_get') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_get') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.get(compute.GetRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value')
...
def test_insert_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_insert') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_insert') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_insert_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        mock_args = dict(project='project_value', region='region_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_insert_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert(compute.InsertRegionUrlMapRequest(), project='project_value', region='region_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_insert_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.insert_unary(compute.InsertRegionUrlMapRequest(), project='project_value', region='region_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_list_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_list') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_list') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.list(compute.ListRegionUrlMapsRequest(), project='project_value', region='region_value')
...
def test_patch_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_patch') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_patch') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_patch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.Operation()
        sample_request = {'project': 'sample1', 'region': 'sample2', 'url_map': 'sample3'}
        mock_args = dict(project='project_value', region='region_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.Operation.pb(return_value)
...
def test_patch_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch(compute.PatchRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_patch_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.patch_unary(compute.PatchRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_update_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_update') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_update') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update(compute.UpdateRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_update_unary_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.update_unary(compute.UpdateRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value', url_map_resource=compute.UrlMap(creation_timestamp='creation_timestamp_value'))
...
def test_validate_rest(request_type):
    ...
    runtime_nested_fields = [(field.name, nested_field.name) for field in get_message_fields(test_field) for nested_field in get_message_fields(field)]
    subfields_not_in_runtime = []
    for (field, value) in request_init['region_url_maps_validate_request_resource'].items():
        result = None
        is_repeated = False
        if isinstance(value, list) and len(value):
            is_repeated = True
...
def test_validate_rest_interceptors(null_interceptor):
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.RegionUrlMapsRestInterceptor())
    client = RegionUrlMapsClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'post_validate') as post, mock.patch.object(transports.RegionUrlMapsRestInterceptor, 'pre_validate') as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_validate_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = compute.UrlMapsValidateResponse()
        sample_request = {'project': 'sample1', 'region': 'sample2', 'url_map': 'sample3'}
        mock_args = dict(project='project_value', region='region_value', url_map='url_map_value', region_url_maps_validate_request_resource=compute.RegionUrlMapsValidateRequest(resource=compute.UrlMap(creation_timestamp='creation_timestamp_value')))
        mock_args.update(sample_request)
        response_value = Response()
        response_value.status_code = 200
        return_value = compute.UrlMapsValidateResponse.pb(return_value)
...
def test_validate_rest_flattened_error(transport: str='rest'):
    ...
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    with pytest.raises(ValueError):
        client.validate(compute.ValidateRegionUrlMapRequest(), project='project_value', region='region_value', url_map='url_map_value', region_url_maps_validate_request_resource=compute.RegionUrlMapsValidateRequest(resource=compute.UrlMap(creation_timestamp='creation_timestamp_value')))
...
def test_credentials_transport_error():
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = RegionUrlMapsClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    transport = transports.RegionUrlMapsRestTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = RegionUrlMapsClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_kind(transport_name):
    if False:
        return 10
    transport = RegionUrlMapsClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_region_url_maps_base_transport():
    ...
    with mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport.__init__') as Transport:
        ...
        transport = transports.RegionUrlMapsTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('delete', 'get', 'insert', 'list', 'patch', 'update', 'validate')
...
def test_region_url_maps_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.compute_v1.services.region_url_maps.transports.RegionUrlMapsTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.RegionUrlMapsTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
def test_region_url_maps_host_no_port(transport_name):
    if False:
        for i in range(10):
            print('nop')
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('compute.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://compute.googleapis.com')
...
def test_region_url_maps_host_with_port(transport_name):
    if False:
        while True:
            i = 10
    client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='compute.googleapis.com:8000'), transport=transport_name)
...
def test_region_url_maps_client_transport_session_collision(transport_name):
    ...
    client1 = RegionUrlMapsClient(credentials=creds1, transport=transport_name)
    client2 = RegionUrlMapsClient(credentials=creds2, transport=transport_name)
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.RegionUrlMapsTransport, '_prep_wrapped_messages') as prep:
        client = RegionUrlMapsClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
@pytest.mark.parametrize('client_class,transport_class', [(RegionUrlMapsClient, transports.RegionUrlMapsRestTransport)])
