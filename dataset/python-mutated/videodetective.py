...
class VideoDetectiveIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.videodetective.com/movies/kick-ass-2/194487', 'info_dict': {'id': '194487', 'ext': 'mp4', 'title': 'Kick-Ass 2', 'description': 'md5:c189d5b7280400630a1d3dd17eaa8d8a'}, 'params': {'skip_download': True}}
