...
__protobuf__ = proto.module(package='google.cloud.dialogflow.cx.v3', manifest={'TransitionRouteGroup', 'ListTransitionRouteGroupsRequest', 'ListTransitionRouteGroupsResponse', 'GetTransitionRouteGroupRequest', 'CreateTransitionRouteGroupRequest', 'UpdateTransitionRouteGroupRequest', 'DeleteTransitionRouteGroupRequest'})
...
class TransitionRouteGroup(proto.Message):
    ...
    transition_routes: MutableSequence[page.TransitionRoute] = proto.RepeatedField(proto.MESSAGE, number=5, message=page.TransitionRoute)
...
class ListTransitionRouteGroupsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    transition_route_groups: MutableSequence['TransitionRouteGroup'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TransitionRouteGroup')
...
class CreateTransitionRouteGroupRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    transition_route_group: 'TransitionRouteGroup' = proto.Field(proto.MESSAGE, number=2, message='TransitionRouteGroup')
...
class UpdateTransitionRouteGroupRequest(proto.Message):
    ...
    Attributes:
        ...
        language_code (str):
            ...
            before they can be used.
    """
    transition_route_group: 'TransitionRouteGroup' = proto.Field(proto.MESSAGE, number=1, message='TransitionRouteGroup')
