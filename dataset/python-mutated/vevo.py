...
class VevoPlaylistIE(VevoBaseIE):
    ...
    _TESTS = [{'url': 'http://www.vevo.com/watch/genre/rock', 'info_dict': {'id': 'rock', 'title': 'Rock'}, 'playlist_count': 20}, {'url': 'http://www.vevo.com/watch/genre/rock?index=0', 'only_matching': True}]
