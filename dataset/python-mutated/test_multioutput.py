...
from sklearn.datasets import load_linnerud, make_classification, make_multilabel_classification, make_regression
...
from sklearn.linear_model import Lasso, LinearRegression, LogisticRegression, OrthogonalMatchingPursuit, PassiveAggressiveClassifier, Ridge, SGDClassifier, SGDRegressor
...
from sklearn.utils._testing import assert_almost_equal, assert_array_almost_equal, assert_array_equal
from sklearn.utils.fixes import BSR_CONTAINERS, COO_CONTAINERS, CSC_CONTAINERS, CSR_CONTAINERS, DOK_CONTAINERS, LIL_CONTAINERS
