...
def measure_time(t):
    ...
    return _
pyunit_utils.run_tests([test_tweedie_p_and_phi_estimation_1p2_phi_2_no_link_power_est, test_tweedie_p_and_phi_estimation_1_8_no_link_power_est, test_tweedie_p_and_phi_estimation_2p1_disp2_est])