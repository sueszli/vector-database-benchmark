...
def _path2list(path: Union[str, Sequence[str]], s3_client: 'S3Client', s3_additional_kwargs: Optional[Dict[str, Any]], last_modified_begin: Optional[datetime.datetime]=None, last_modified_end: Optional[datetime.datetime]=None, suffix: Union[str, List[str], None]=None, ignore_suffix: Union[str, List[str], None]=None, ignore_empty: bool=False) -> List[str]:
    if False:
        for i in range(10):
            print('nop')
    ...
    if isinstance(path, str):
        paths: List[str] = [path for paths in _list_objects(path=path, s3_client=s3_client, suffix=_suffix, ignore_suffix=_ignore_suffix, last_modified_begin=last_modified_begin, last_modified_end=last_modified_end, ignore_empty=ignore_empty, s3_additional_kwargs=s3_additional_kwargs) for path in paths]
        _logger.debug('Listed %s paths', len(paths))
    elif isinstance(path, list):
        if last_modified_begin or last_modified_end:
            raise exceptions.InvalidArgumentCombination('Specify a list of files or (last_modified_begin and last_modified_end)')
...
def _validate_datetimes(last_modified_begin: Optional[datetime.datetime]=None, last_modified_end: Optional[datetime.datetime]=None) -> None:
    if False:
        while True:
            i = 10
...
def _list_objects(path: str, s3_client: 'S3Client', delimiter: Optional[str]=None, s3_additional_kwargs: Optional[Dict[str, Any]]=None, suffix: Union[str, List[str], None]=None, ignore_suffix: Union[str, List[str], None]=None, last_modified_begin: Optional[datetime.datetime]=None, last_modified_end: Optional[datetime.datetime]=None, ignore_empty: bool=False) -> Iterator[List[str]]:
    ...
    return _list_objects_paginate(bucket=bucket, pattern=pattern, prefix=prefix, s3_client=s3_client, delimiter=delimiter, suffix=suffix, ignore_suffix=ignore_suffix, last_modified_begin=last_modified_begin, last_modified_end=last_modified_end, ignore_empty=ignore_empty, s3_additional_kwargs=s3_additional_kwargs)

@engine.dispatch_on_engine
def _list_objects_paginate(bucket: str, pattern: str, prefix: str, s3_client: 'S3Client', delimiter: Optional[str], s3_additional_kwargs: Optional[Dict[str, Any]], suffix: Union[List[str], None], ignore_suffix: Union[List[str], None], last_modified_begin: Optional[datetime.datetime], last_modified_end: Optional[datetime.datetime], ignore_empty: bool) -> Iterator[List[str]]:
    if False:
        i = 10
        return i + 15
    ...
    if s3_additional_kwargs:
        extra_kwargs = _fs.get_botocore_valid_kwargs(function_name='list_objects_v2', s3_additional_kwargs=s3_additional_kwargs)
        extra_kwargs['PaginationConfig'] = s3_additional_kwargs['PaginationConfig'] if 'PaginationConfig' in s3_additional_kwargs else default_pagination
...
def does_object_exist(path: str, s3_additional_kwargs: Optional[Dict[str, Any]]=None, boto3_session: Optional[boto3.Session]=None, version_id: Optional[str]=None) -> bool:
    if False:
        return 10
...
def list_directories(path: str, chunked: bool=False, s3_additional_kwargs: Optional[Dict[str, Any]]=None, boto3_session: Optional[boto3.Session]=None) -> Union[List[str], Iterator[List[str]]]:
    if False:
        while True:
            i = 10
    ...
    s3_client = _utils.client(service_name='s3', session=boto3_session)
    result_iterator = _list_objects(path=path, delimiter='/', s3_client=s3_client, s3_additional_kwargs=s3_additional_kwargs)
    if chunked:
        return result_iterator
    return [path for paths in result_iterator for path in paths]

@_utils.validate_distributed_kwargs(unsupported_kwargs=['boto3_session', 's3_additional_kwargs'])
def list_objects(path: str, suffix: Union[str, List[str], None]=None, ignore_suffix: Union[str, List[str], None]=None, last_modified_begin: Optional[datetime.datetime]=None, last_modified_end: Optional[datetime.datetime]=None, ignore_empty: bool=False, chunked: bool=False, s3_additional_kwargs: Optional[Dict[str, Any]]=None, boto3_session: Optional[boto3.Session]=None) -> Union[List[str], Iterator[List[str]]]:
    if False:
        while True:
            i = 10
    ...
    result_iterator = _list_objects(path=path, suffix=suffix, ignore_suffix=list(ignore_suffix_acc), last_modified_begin=last_modified_begin, last_modified_end=last_modified_end, ignore_empty=ignore_empty, s3_client=s3_client, s3_additional_kwargs=s3_additional_kwargs)
    if chunked:
        return result_iterator
    return [path for paths in result_iterator for path in paths]
