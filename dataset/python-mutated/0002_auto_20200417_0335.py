...
class Migration(migrations.Migration):
    ...
    operations = [migrations.AddField(model_name='pluginconfiguration', name='identifier', field=models.CharField(default='default', max_length=128)), migrations.AlterField(model_name='pluginconfiguration', name='name', field=models.CharField(max_length=128, blank=True, null=True)), migrations.RunPython(update_identifier_field), migrations.AlterField(model_name='pluginconfiguration', name='identifier', field=models.CharField(max_length=128, unique=True), preserve_default=False)]