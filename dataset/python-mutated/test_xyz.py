...
class TestRgbToXyz(BaseTester):
    ...
    def test_unit(self, device, dtype):
        if False:
            i = 10
            return i + 15
        data = torch.tensor([[[[0.9637, 0.0586, 0.647, 0.6212, 0.9622], [0.8293, 0.4858, 0.8953, 0.2607, 0.325], [0.5314, 0.4189, 0.8388, 0.8065, 0.2211], [0.9682, 0.2928, 0.4118, 0.2533, 0.0455]], [[0.6936, 0.3457, 0.9466, 0.9937, 0.2692], [0.7485, 0.732, 0.8323, 0.6889, 0.4831], [0.1865, 0.7439, 0.1366, 0.8858, 0.2077], [0.6227, 0.614, 0.3936, 0.5024, 0.4157]], [[0.6477, 0.9269, 0.7531, 0.7349, 0.9485], [0.4264, 0.8539, 0.983, 0.2269, 0.1138], [0.3988, 0.1605, 0.622, 0.0546, 0.1106], [0.2128, 0.5673, 0.0781, 0.1431, 0.331]]]], device=device, dtype=dtype)
