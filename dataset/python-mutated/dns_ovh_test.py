...
class AuthenticatorTest(test_util.TempDirTestCase, dns_test_common_lexicon.BaseLexiconDNSAuthenticatorTest):
    ...
    def setUp(self):
        ...
        credentials = {'ovh_endpoint': ENDPOINT, 'ovh_application_key': APPLICATION_KEY, 'ovh_application_secret': APPLICATION_SECRET, 'ovh_consumer_key': CONSUMER_KEY}
        dns_test_common.write(credentials, path)
        self.config = mock.MagicMock(ovh_credentials=path, ovh_propagation_seconds=0)
