...
@testing.parameterize(*testing.product_dict([{'dtype': numpy.float16, 'forward_options': {'rtol': 0.001, 'atol': 0.001}, 'backward_options': {'rtol': 0.03, 'atol': 0.03}, 'double_backward_options': {'rtol': 0.5, 'atol': 0.5}}, {'dtype': numpy.float32, 'forward_options': {'rtol': 0.0001, 'atol': 0.0001}, 'backward_options': {'rtol': 0.0001, 'atol': 0.0001}, 'double_backward_options': {'rtol': 0.0001, 'atol': 0.0001}}, {'dtype': numpy.float64, 'forward_options': {'rtol': 0.0001, 'atol': 0.0001}, 'backward_options': {'rtol': 0.0001, 'atol': 0.0001}, 'double_backward_options': {'rtol': 0.0001, 'atol': 0.0001}}], [{'reduce': 'half_squared_sum'}, {'reduce': 'no'}]))
