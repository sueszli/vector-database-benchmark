...
__protobuf__ = proto.module(package='google.api.apikeys.v2', manifest={'CreateKeyRequest', 'ListKeysRequest', 'ListKeysResponse', 'GetKeyRequest', 'GetKeyStringRequest', 'GetKeyStringResponse', 'UpdateKeyRequest', 'DeleteKeyRequest', 'UndeleteKeyRequest', 'LookupKeyRequest', 'LookupKeyResponse'})
...
class CreateKeyRequest(proto.Message):
    ...
    key: resources.Key = proto.Field(proto.MESSAGE, number=2, message=resources.Key)
    key_id: str = proto.Field(proto.STRING, number=3)
...
class ListKeysRequest(proto.Message):
    ...
    show_deleted: bool = proto.Field(proto.BOOL, number=6)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    keys: MutableSequence[resources.Key] = proto.RepeatedField(proto.MESSAGE, number=1, message=resources.Key)
...
class GetKeyStringResponse(proto.Message):
    ...
    """
    key_string: str = proto.Field(proto.STRING, number=1)
...
class UpdateKeyRequest(proto.Message):
    ...
    """
    key: resources.Key = proto.Field(proto.MESSAGE, number=1, message=resources.Key)
