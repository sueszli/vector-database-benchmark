...
class GLPNImageProcessingTester(unittest.TestCase):
    ...
    def prepare_image_inputs(self, equal_resolution=False, numpify=False, torchify=False):
        if False:
            for i in range(10):
                print('nop')
        return prepare_image_inputs(batch_size=self.batch_size, num_channels=self.num_channels, min_resolution=self.min_resolution, max_resolution=self.max_resolution, size_divisor=self.size_divisor, equal_resolution=equal_resolution, numpify=numpify, torchify=torchify)
