...
from Orange.widgets.utils.annotated_data import create_annotated_table, create_groups_table, ANNOTATED_DATA_FEATURE_NAME, lazy_annotated_table, lazy_groups_table, domain_with_annotation_column
