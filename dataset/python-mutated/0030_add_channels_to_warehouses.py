...
class Migration(migrations.Migration):
    dependencies = [('warehouse', '0029_warehouse_channels')]
    operations = [migrations.RunPython(add_relations_between_existing_channels_and_warehouses, migrations.RunPython.noop)]