...
class OWLogisticRegression(OWBaseLearner):
    ...
    description = 'The logistic regression classification algorithm with LASSO (L1) or ridge (L2) regularization.'
    ...
    C_s = list(chain(range(1000, 200, -50), range(200, 100, -10), range(100, 20, -5), range(20, 0, -1), [x / 10 for x in range(9, 2, -1)], [x / 100 for x in range(20, 2, -1)], [x / 1000 for x in range(20, 0, -1)]))
    strength_C = C_s[61]
    dual = False
    tol = 0.0001
    fit_intercept = True
