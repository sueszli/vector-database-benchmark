...
class SSLv2ClientHello(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 1, _sslv2_handshake_type), _TLSVersionField('version', 2, _tls_version), FieldLenField('cipherslen', None, fmt='!H', length_of='ciphers'), FieldLenField('sidlen', None, fmt='!H', length_of='sid'), FieldLenField('challengelen', None, fmt='!H', length_of='challenge'), XStrLenField('sid', b'', length_from=lambda pkt: pkt.sidlen), _SSLv2CipherSuitesField('ciphers', [SSL_CK_DES_192_EDE3_CBC_WITH_MD5], _tls_cipher_suites, length_from=lambda pkt: pkt.cipherslen), XStrLenField('challenge', b'', length_from=lambda pkt: pkt.challengelen)]
...
class SSLv2ServerHello(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 4, _sslv2_handshake_type), ByteField('sid_hit', 0), ByteEnumField('certtype', 1, {1: 'x509_cert'}), _TLSVersionField('version', 2, _tls_version), FieldLenField('certlen', None, fmt='!H', length_of='cert'), FieldLenField('cipherslen', None, fmt='!H', length_of='ciphers'), FieldLenField('connection_idlen', None, fmt='!H', length_of='connection_id'), _SSLv2CertDataField('cert', b'', length_from=lambda pkt: pkt.certlen), _SSLv2CipherSuitesField('ciphers', [], _tls_cipher_suites, length_from=lambda pkt: pkt.cipherslen), XStrLenField('connection_id', b'', length_from=lambda pkt: pkt.connection_idlen)]
...
class SSLv2ClientMasterKey(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 2, _sslv2_handshake_type), _SSLv2CipherSuiteField('cipher', None, _tls_cipher_suites), FieldLenField('clearkeylen', None, fmt='!H', length_of='clearkey'), FieldLenField('encryptedkeylen', None, fmt='!H', length_of='encryptedkey'), FieldLenField('keyarglen', None, fmt='!H', length_of='keyarg'), XStrLenField('clearkey', '', length_from=lambda pkt: pkt.clearkeylen), _SSLv2EncryptedKeyField('encryptedkey', '', length_from=lambda pkt: pkt.encryptedkeylen), XStrLenField('keyarg', '', length_from=lambda pkt: pkt.keyarglen)]
