...
from samcli.lib.build.build_graph import BuildGraph, FunctionBuildDefinition, LayerBuildDefinition, AbstractBuildDefinition, DEFAULT_DEPENDENCIES_DIR
from samcli.lib.build.exceptions import MissingBuildMethodException
LOG = logging.getLogger(__name__)
FunctionOrLayerBuildDefinition = TypeVar('FunctionOrLayerBuildDefinition', FunctionBuildDefinition, LayerBuildDefinition)
...
class CachedOrIncrementalBuildStrategyWrapper(BuildStrategy):
    ...
    """
    SUPPORTED_RUNTIME_PREFIXES: Set[str] = {'python', 'ruby', 'nodejs'}
