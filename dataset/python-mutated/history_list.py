...
from electrum.util import block_explorer_URL, profiler, TxMinedInfo, OrderedDictWithIndex, timestamp_to_datetime, Satoshis, Fiat, format_time
from electrum.logging import get_logger, Logger
from electrum.simple_config import SimpleConfig
from .custom_model import CustomNode, CustomModel
from .util import read_QIcon, MONOSPACE_FONT, Buttons, CancelButton, OkButton, filename_field, AcceptFileDragDrop, WindowModalDialog, CloseButton, webopen, WWLabel
from .my_treeview import MyTreeView
if TYPE_CHECKING:
    from electrum.wallet import Abstract_Wallet
    from .main_window import ElectrumWindow
_logger = get_logger(__name__)
TX_ICONS = ['unconfirmed.png', 'warning.png', 'offline_tx.png', 'offline_tx.png', 'clock1.png', 'clock2.png', 'clock3.png', 'clock4.png', 'clock5.png', 'confirmed.png']
...
class HistoryList(MyTreeView, AcceptFileDragDrop):
    ...
    class Columns(MyTreeView.BaseColumnsEnum):
        ...
        TXID = enum.auto()
        SHORT_ID = enum.auto()
    filter_columns = [Columns.STATUS, Columns.DESCRIPTION, Columns.AMOUNT, Columns.TXID, Columns.SHORT_ID]
