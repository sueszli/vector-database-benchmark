...
class traceCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'get_trace': ('project_id', 'trace_id'), 'list_traces': ('project_id', 'view', 'page_size', 'page_token', 'start_time', 'end_time', 'filter', 'order_by'), 'patch_traces': ('project_id', 'traces')}
