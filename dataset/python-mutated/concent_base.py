...
class ConcentTestPlaybook(NodeTestPlaybook):
    ...
    def check_concent_logs(output_queue: 'queue.Queue', outgoing: bool=False, additional_fail_triggers: typing.Optional[list]=None, awaited_messages: typing.Optional[list]=None) -> typing.Tuple[typing.Optional[bool], typing.Optional[typing.Match]]:
        ...
        return (None, None)
    initial_steps = NodeTestPlaybook.initial_steps + (partial(NodeTestPlaybook.step_enable_concent, node_id=NodeId.provider), partial(NodeTestPlaybook.step_ensure_concent_on, node_id=NodeId.provider), partial(NodeTestPlaybook.step_enable_concent, node_id=NodeId.requestor), partial(NodeTestPlaybook.step_ensure_concent_on, node_id=NodeId.requestor), partial(step_clear_output, node_id=NodeId.requestor), partial(step_clear_output, node_id=NodeId.provider))