...
class MediciIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://www.medici.tv/#!/daniel-harding-frans-helmerson-verbier-festival-music-camp', 'md5': '004c21bb0a57248085b6ff3fec72719d', 'info_dict': {'id': '3059', 'ext': 'flv', 'title': 'Daniel Harding conducts the Verbier Festival Music Camp – With Frans Helmerson', 'description': 'md5:322a1e952bafb725174fd8c1a8212f58', 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20170408'}}
