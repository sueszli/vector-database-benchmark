...
from sentry.models.grouphistory import GroupHistoryStatus, record_group_history, record_group_history_from_activity_type
...
pre_save.connect(validate_release_empty_version, sender=Release, dispatch_uid='validate_release_empty_version', weak=False)
