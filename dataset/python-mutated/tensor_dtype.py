...
if tf:
    numpy_to_tf_dtype_dict = {np.bool_: tf.bool, np.uint8: tf.uint8, np.int8: tf.int8, np.int16: tf.int16, np.int32: tf.int32, np.int64: tf.int64, np.float16: tf.float16, np.float32: tf.float32, np.float64: tf.float64, np.complex64: tf.complex64, np.complex128: tf.complex128}
else:
