...
class SkillMasteryDataHandler(base.BaseHandler[SkillMasteryDataHandlerNormalizedPayloadDict, SkillMasteryDataHandlerNormalizedRequestDict]):
    """A handler that handles fetching and updating the degrees of user
    skill mastery.
    """
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'selected_skill_ids': {'schema': {'type': 'custom', 'obj_type': 'JsonEncodedInString'}}}, 'PUT': {'mastery_change_per_skill': {'schema': {'type': 'variable_keys_dict', 'keys': {'schema': {'type': 'basestring'}}, 'values': {'schema': {'type': 'float'}}}}}}
...
class SubtopicMasteryDataHandler(base.BaseHandler[Dict[str, str], SubtopicMasteryDataHandlerNormalizedRequestDict]):
    """A handler that handles fetching user subtopic mastery for a topic."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'GET': {'selected_topic_ids': {'schema': {'type': 'custom', 'obj_type': 'JsonEncodedInString'}}}}
