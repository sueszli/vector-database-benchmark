...
from ..cost import EmbeddingGradOpCost, EmbeddingOpCost, build_comm_costs_from_descs, build_comm_desc_from_dist_op, build_comp_costs_from_descs, build_comp_desc_from_dist_op, build_dp_costs
from ..dist_attribute import OperatorDistAttr
from ..process_group import new_process_group
from ..utils import _get_comm_group, _get_corresponding_rank, _get_idx_in_axis, compute_compatible_and_update_dim_mapping, get_dist_tensor_spec, is_dim_replicate, is_dim_shard, set_var_dist_attr
from .common import DistributedOperatorImpl, DistributedOperatorImplContainer, ParallelMode, get_default_distributed_operator_impl, gradient_synchronization, infer_shape, naive_copy_op_dist_attr_for_program, register_distributed_operator_impl, register_distributed_operator_impl_container, update_op_dims_mapping
...
class DistributedEmbedding(DistributedOperatorImplContainer):
    ...
    def mapping_to_dist_operator_impl(dist_op, original_op_dist_attr):
        ...
        return reverted
register_distributed_operator_impl_container(DistributedEmbedding('lookup_table_v2'))
register_distributed_operator_impl_container(DistributedEmbedding('c_embedding'))
register_distributed_operator_impl_container(DistributedEmbedding('lookup_table'))
...
register_distributed_operator_impl('lookup_table_v2', DistributedEmbeddingImpl('row_parallel'))
register_distributed_operator_impl('c_embedding', DistributedEmbeddingImpl('row_parallel'))
register_distributed_operator_impl('lookup_table', DistributedEmbeddingImpl('row_parallel'))