...
watcher_configs = [{'type': 'MockWatcher1', 'index': 'index1'}, {'type': 'MockWatcher2', 'index': 'index2'}, {'type': 'MockWatcher3', 'index': 'index3'}]
...
auditor_configs = [{'type': 'MockAuditor1', 'index': 'index1', 'support_auditor_indexes': [], 'support_watcher_indexes': ['index2']}, {'type': 'MockAuditor2', 'index': 'index2', 'support_auditor_indexes': [], 'support_watcher_indexes': []}, {'type': 'MockAuditor3', 'index': 'index3', 'support_auditor_indexes': [], 'support_watcher_indexes': ['index2']}, {'type': 'MockAuditor4', 'index': 'index3', 'support_auditor_indexes': [], 'support_watcher_indexes': []}]
for config in auditor_configs:
    auditor = type(config['type'], (MockAuditor,), {'index': config['index'], 'support_auditor_indexes': config['support_auditor_indexes'], 'support_watcher_indexes': config['support_watcher_indexes']})
