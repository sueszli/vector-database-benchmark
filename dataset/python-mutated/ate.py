...
class Solver(object):
    ...
    def compute_gradients(self, params, payoff_matrices):
        ...
        if self.cheap:
            return cheap_gradients(self.random, *params, payoff_matrices, self.num_players, self.p, self.proj_grad)
        else:
            return gradients(*params, payoff_matrices, self.num_players, self.p, self.proj_grad)
...
def cheap_gradients(random, dist, y, payoff_matrices, num_players, p=1, proj_grad=True):
    if False:
        print('Hello World!')
