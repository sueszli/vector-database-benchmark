...
class SGEJobTask(luigi.Task):
    ...
    job_name_format = luigi.Parameter(significant=False, default=None, description='A string that can be formatted with class variables to name the job with qsub.')
