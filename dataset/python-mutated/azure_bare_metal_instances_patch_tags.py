...
def main():
    ...
    response = client.azure_bare_metal_instances.update(resource_group_name='myResourceGroup', azure_bare_metal_instance_name='myABMInstance', tags_parameter={'tags': {'testkey': 'testvalue'}})
    print(response)
