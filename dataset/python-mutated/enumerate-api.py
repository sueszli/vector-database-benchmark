...
parser.add_argument('--file-path', '-fp', type=str, default=None, help='Path to the root directory. If not provided, assumed to be bethe import location of statsmodels.')
parser.add_argument('--out-file', '-of', type=str, default=None, help='Name of output json file. Default is statsmodels-{version}-api.json')
