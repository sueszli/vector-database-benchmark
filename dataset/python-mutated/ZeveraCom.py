...
class ZeveraCom(MultiDownloader):
    ...
    __version__ = '0.39'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)zevera\\.com/(getFiles\\.ashx|Members/download\\.ashx)\\?.*ourl=.+'
    ...
    __license__ = 'GPLv3'
    __authors__ = [('zoidberg', 'zoidberg@mujmail.cz'), ('Walter Purcaro', 'vuolter@gmail.com'), ('GammaC0de', 'nitzo2001[AT]yahoo[DOT]com')]
