...
def build_get_request(resource_group_name: str, service_name: str, notification_name: Union[str, _models.NotificationName], subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        print('Hello World!')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
    _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
    api_version: str = kwargs.pop('api_version', _params.pop('api-version', '2022-08-01'))
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/notifications/{notificationName}')
...
def build_create_or_update_request(resource_group_name: str, service_name: str, notification_name: Union[str, _models.NotificationName], subscription_id: str, *, if_match: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
...
class NotificationOperations:
    ...
    @distributed_trace
    def list_by_service(self, resource_group_name: str, service_name: str, top: Optional[int]=None, skip: Optional[int]=None, **kwargs: Any) -> Iterable['_models.NotificationContract']:
        if False:
            while True:
                i = 10
    ...
    @distributed_trace
    def get(self, resource_group_name: str, service_name: str, notification_name: Union[str, _models.NotificationName], **kwargs: Any) -> _models.NotificationContract:
        if False:
            i = 10
            return i + 15
        ...
        request = build_get_request(resource_group_name=resource_group_name, service_name=service_name, notification_name=notification_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def create_or_update(self, resource_group_name: str, service_name: str, notification_name: Union[str, _models.NotificationName], if_match: Optional[str]=None, **kwargs: Any) -> _models.NotificationContract:
        if False:
            i = 10
            return i + 15
        ...
        api_version: str = kwargs.pop('api_version', _params.pop('api-version', self._config.api_version))
        cls: ClsType[_models.NotificationContract] = kwargs.pop('cls', None)
        request = build_create_or_update_request(resource_group_name=resource_group_name, service_name=service_name, notification_name=notification_name, subscription_id=self._config.subscription_id, if_match=if_match, api_version=api_version, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=_stream, **kwargs)
