...
import pytest
from airflow.providers.amazon.aws.operators.appflow import AppflowBaseOperator, AppflowRecordsShortCircuitOperator, AppflowRunAfterOperator, AppflowRunBeforeOperator, AppflowRunDailyOperator, AppflowRunFullOperator, AppflowRunOperator
...
SOURCE = 'salesforce'
DUMP_COMMON_ARGS = {'aws_conn_id': CONN_ID, 'task_id': TASK_ID, 'source': SOURCE, 'flow_name': FLOW_NAME, 'poll_interval': 0}
AppflowBaseOperator.UPDATE_PROPAGATION_TIME = 0
