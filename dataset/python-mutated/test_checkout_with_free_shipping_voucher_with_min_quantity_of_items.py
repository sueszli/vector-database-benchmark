...
def prepare_free_shipping_voucher(e2e_staff_api_client, channel_id, voucher_code, voucher_discount_type, voucher_discount_value, voucher_type, min_product_quantity):
    if False:
        print('Hello World!')
    input = {'code': voucher_code, 'discountValueType': voucher_discount_type, 'type': voucher_type, 'minCheckoutItemsQuantity': min_product_quantity}
...
@pytest.mark.e2e
def test_checkout_use_free_shipping_voucher_with_min_quantity_of_items_0906(e2e_not_logged_api_client, e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_shipping, permission_manage_product_types_and_attributes, permission_manage_discounts):
    if False:
        for i in range(10):
            print('nop')
    ...
    voucher_code = prepare_free_shipping_voucher(e2e_staff_api_client, channel_id, voucher_code='FREESHIPPING', voucher_discount_type='PERCENTAGE', voucher_discount_value=100, voucher_type='SHIPPING', min_product_quantity=2)
