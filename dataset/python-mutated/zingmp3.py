...
class ZingMp3BaseIE(InfoExtractor):
    _VALID_URL_TMPL = 'https?://(?:mp3\\.zing|zingmp3)\\.vn/(?P<type>(?:%s))/[^/?#]+/(?P<id>\\w+)(?:\\.html|\\?)'
    _GEO_COUNTRIES = ['VN']
    _DOMAIN = 'https://zingmp3.vn'
    _PER_PAGE = 50
    _API_SLUGS = {'bai-hat': '/api/v2/page/get/song', 'embed': '/api/v2/page/get/song', 'video-clip': '/api/v2/page/get/video', 'lyric': '/api/v2/lyric/get/lyric', 'song-streaming': '/api/v2/song/get/streaming', 'playlist': '/api/v2/page/get/playlist', 'album': '/api/v2/page/get/playlist', 'zing-chart': '/api/v2/page/get/chart-home', 'zing-chart-tuan': '/api/v2/page/get/week-chart', 'moi-phat-hanh': '/api/v2/page/get/newrelease-chart', 'the-loai-video': '/api/v2/video/get/list', 'info-artist': '/api/v2/page/get/artist', 'user-list-song': '/api/v2/song/get/list', 'user-list-video': '/api/v2/video/get/list', 'hub': '/api/v2/page/get/hub-detail'}
...
class ZingMp3ChartHomeIE(ZingMp3BaseIE):
    ...
    _TESTS = [{'url': 'https://zingmp3.vn/zing-chart', 'info_dict': {'id': 'zing-chart'}, 'playlist_mincount': 100}, {'url': 'https://zingmp3.vn/moi-phat-hanh', 'info_dict': {'id': 'moi-phat-hanh'}, 'playlist_mincount': 100}]
