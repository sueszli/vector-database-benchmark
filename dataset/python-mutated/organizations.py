...
import factory
import faker
from warehouse.organizations.models import Organization, OrganizationApplication, OrganizationInvitation, OrganizationNameCatalog, OrganizationProject, OrganizationRole, OrganizationRoleType, OrganizationStripeCustomer, OrganizationStripeSubscription, Team, TeamProjectRole, TeamProjectRoleType, TeamRole, TeamRoleType
...
class OrganizationApplicationFactory(WarehouseFactory):
    ...
    submitted = factory.Faker('date_time_between_dates', datetime_start=datetime.datetime(2020, 1, 1), datetime_end=datetime.datetime(2022, 1, 1))
...
class OrganizationFactory(WarehouseFactory):
    ...
    def _create(cls, model_class, *args, **kwargs):
        ...
        OrganizationNameCatalogFactory.create(normalized_name=organization.normalized_name, organization_id=organization.id)
        return organization
    id = factory.Faker('uuid4', cast_to=None)
    name = factory.Faker('pystr', max_chars=12)
    display_name = factory.Faker('word')
    ...
    is_active = True
    is_approved = None
    created = factory.Faker('date_time_between_dates', datetime_start=datetime.datetime(2020, 1, 1), datetime_end=datetime.datetime(2022, 1, 1))
    date_approved = None
