...
import socket
import sys
from ctypes import CDLL, POINTER, Structure, c_char_p, c_int, c_ubyte, c_uint8, c_uint32, c_ushort, c_void_p, cast, pointer
...
if sys.platform.startswith('freebsd') or sys.platform == 'darwin':
    _sockaddrCommon: List[Tuple[str, Any]] = [('sin_len', c_uint8), ('sin_family', c_uint8)]
else:
    _sockaddrCommon: List[Tuple[str, Any]] = [('sin_family', c_ushort)]
...
ifaddrs._fields_ = [('ifa_next', ifaddrs_p), ('ifa_name', c_char_p), ('ifa_flags', c_uint32), ('ifa_addr', POINTER(sockaddr)), ('ifa_netmask', POINTER(sockaddr)), ('ifa_dstaddr', POINTER(sockaddr)), ('ifa_data', c_void_p)]
