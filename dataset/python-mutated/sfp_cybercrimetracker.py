...
class sfp_cybercrimetracker(SpiderFootPlugin):
    ...
    def producedEvents(self):
        if False:
            print('Hello World!')
        return ['BLACKLISTED_IPADDR', 'BLACKLISTED_INTERNET_NAME', 'BLACKLISTED_AFFILIATE_IPADDR', 'BLACKLISTED_AFFILIATE_INTERNET_NAME', 'BLACKLISTED_COHOST', 'MALICIOUS_IPADDR', 'MALICIOUS_INTERNET_NAME', 'MALICIOUS_AFFILIATE_IPADDR', 'MALICIOUS_AFFILIATE_INTERNET_NAME', 'MALICIOUS_COHOST']
    ...
    def retrieveBlacklist(self):
        ...
        res = self.sf.fetchUrl('https://cybercrime-tracker.net/all.php', timeout=10, useragent=self.opts['_useragent'])
        if res['code'] != '200':
