...
branch_labels = None
depends_on = None
stateful_tables = ['license', 'package', 'package_revision', 'package_tag', 'package_tag_revision', 'package_extra', 'package_extra_revision', 'package_resource', 'package_resource_revision', 'revision']
