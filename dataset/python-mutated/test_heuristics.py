...
try:
    ...
    from tools.testing.target_determination.determinator import AggregatedHeuristics, get_test_prioritizations, TestPrioritizations
...
class TestParsePrevTests(HeuristicsTestMixin):
    ...
    lastfailed_with_multiple_tests_per_file = {'test/test_car.py::TestCar::test_num[17]': True, 'test/test_car.py::TestBar::test_num[25]': True, 'test/test_far.py::TestFar::test_fun_copy[17]': True, 'test/test_bar.py::TestBar::test_fun_copy[25]': True}
