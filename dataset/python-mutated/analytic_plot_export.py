...
row_mapping = {'state__name': 'State', 'state__group': 'State Group', 'labels__id': 'Label', 'assignees__id': 'Assignee Name', 'start_date': 'Start Date', 'target_date': 'Due Date', 'completed_at': 'Completed At', 'created_at': 'Created At', 'issue_count': 'Issue Count', 'priority': 'Priority', 'estimate': 'Estimate', 'issue_cycle__cycle_id': 'Cycle', 'issue_module__module_id': 'Module'}
