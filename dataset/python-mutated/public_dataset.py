...
DATASET_NAME = {'network_traffic': ['2018%02d.agr' % i for i in range(1, 13)] + ['2019%02d.agr' % i for i in range(1, 13)], 'AIOps': ['machine_usage.tar.gz'], 'fsi': ['individual_stocks_5yr.zip'], 'nyc_taxi': ['nyc_taxi.csv'], 'uci_electricity': ['LD2011_2014.txt.zip'], 'uci_electricity_wide': ['LD2011_2014.txt.zip']}
BASE_URL = {'network_traffic': [f'http://mawi.wide.ad.jp/~agurim/dataset/{val[:-4]}/{val}' for val in DATASET_NAME['network_traffic']], 'AIOps': ['http://clusterdata2018pubcn.oss-cn-beijing.aliyuncs.com/machine_usage.tar.gz'], 'fsi': ['https://github.com/CNuge/kaggle-code/raw/master/stock_data/individual_stocks_5yr.zip'], 'nyc_taxi': ['https://raw.githubusercontent.com/numenta/NAB/v1.0/data/realKnownCause/nyc_taxi.csv'], 'uci_electricity': ['https://archive.ics.uci.edu/ml/machine-learning-databases/00321/LD2011_2014.txt.zip'], 'uci_electricity_wide': ['https://archive.ics.uci.edu/ml/machine-learning-databases/00321/LD2011_2014.txt.zip'], 'tsinghua_electricity': None}
