...
class CreateCMSPageForm(AddPageForm):
    ...
    content = forms.CharField(label=_('Content'), widget=text_widget, required=False, help_text=_('Optional. If supplied, will be automatically added within a new text plugin.'))

    class Media:
        js = ('cms/js/widgets/wizard.pagetypeselect.js',)
