...
class XPUTestConv2DOp_NHWC(XPUOpTestWrapper):
    ...
    class TestConv2DOp_AsyPadding_NHWC(XPUTestConv2DOp_v2.TestConv2DOp_AsyPadding):
...
for stype in ['float32']:
    ...
    create_test_class(globals(), XPUTestConv2DOp_NHWC, stype, ignore_device_version=[core.XPUVersion.XPU1])
