...
def main():
    ...
    response = client.monitored_subscriptions.begin_update(resource_group_name='myResourceGroup', monitor_name='myMonitor', configuration_name='default').result()
    print(response)
