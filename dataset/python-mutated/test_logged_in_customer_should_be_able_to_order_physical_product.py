...
@pytest.mark.e2e
def test_process_checkout_with_physical_product_CORE_0103(e2e_staff_api_client, e2e_logged_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_checkouts):
    if False:
        print('Hello World!')
    ...
    checkout_data = checkout_create(e2e_logged_api_client, lines, channel_slug, email=None, set_default_billing_address=True, set_default_shipping_address=True)
