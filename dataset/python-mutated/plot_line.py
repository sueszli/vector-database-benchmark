...
if __name__ == '__main__':
    parser = OptionParser()
    parser.add_option('-c', '--code', dest='code', help='-c 300141 #using code to find security')
    parser.add_option('-n', '--name', dest='name', help='-n  和顺电气 #using code to find security')
