...
class ListAppConnectionsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    app_connections: MutableSequence['AppConnection'] = proto.RepeatedField(proto.MESSAGE, number=1, message='AppConnection')
...
class CreateAppConnectionRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    app_connection_id: str = proto.Field(proto.STRING, number=2)
    app_connection: 'AppConnection' = proto.Field(proto.MESSAGE, number=3, message='AppConnection')
...
class UpdateAppConnectionRequest(proto.Message):
    ...
    app_connection: 'AppConnection' = proto.Field(proto.MESSAGE, number=2, message='AppConnection')
...
class ResolveAppConnectionsRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    app_connector_id: str = proto.Field(proto.STRING, number=2)
...
class ResolveAppConnectionsResponse(proto.Message):
    ...
    class AppConnectionDetails(proto.Message):
        ...
        """
        app_connection: 'AppConnection' = proto.Field(proto.MESSAGE, number=1, message='AppConnection')
        recent_mig_vms: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    app_connection_details: MutableSequence[AppConnectionDetails] = proto.RepeatedField(proto.MESSAGE, number=1, message=AppConnectionDetails)
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)

class AppConnection(proto.Message):
    """A BeyondCorp AppConnection resource represents a BeyondCorp
    ...
    class ApplicationEndpoint(proto.Message):
        ...
        Attributes:
            ...
            port (int):
                ...
                endpoint.
        """
        host: str = proto.Field(proto.STRING, number=1)
        port: int = proto.Field(proto.INT32, number=2)

    class Gateway(proto.Message):
        """Gateway represents a user facing component that serves as an
        ...
        class Type(proto.Enum):
            ...
            TYPE_UNSPECIFIED = 0
            GCP_REGIONAL_MIG = 1
        type_: 'AppConnection.Gateway.Type' = proto.Field(proto.ENUM, number=2, enum='AppConnection.Gateway.Type')
        uri: str = proto.Field(proto.STRING, number=3)
        ingress_port: int = proto.Field(proto.INT32, number=4)
        app_gateway: str = proto.Field(proto.STRING, number=5)
    name: str = proto.Field(proto.STRING, number=1)
    ...
    uid: str = proto.Field(proto.STRING, number=6)
    type_: Type = proto.Field(proto.ENUM, number=7, enum=Type)
    application_endpoint: ApplicationEndpoint = proto.Field(proto.MESSAGE, number=8, message=ApplicationEndpoint)
    connectors: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=9)
    state: State = proto.Field(proto.ENUM, number=10, enum=State)
    gateway: Gateway = proto.Field(proto.MESSAGE, number=11, message=Gateway)
