...
TEST_PACKAGE1 = PackageInfo(package='test_package', package_or_url='test_package_url', pip_args=[], include_apps=True, include_dependencies=False, apps=['testapp'], app_paths=[Path('/usr/bin')], apps_of_dependencies=['dep1'], app_paths_of_dependencies={'dep1': [Path('bin')]}, package_version='0.1.2')
TEST_PACKAGE2 = PackageInfo(package='inj_package', package_or_url='inj_package_url', pip_args=['-e'], include_apps=True, include_dependencies=False, apps=['injapp'], app_paths=[Path('/usr/bin')], apps_of_dependencies=['dep2'], app_paths_of_dependencies={'dep2': [Path('bin')]}, package_version='6.7.8')
