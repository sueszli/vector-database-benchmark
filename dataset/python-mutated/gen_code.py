aubiodefvalue = {'buf_size': 'Py_default_vector_length', 'win_s': 'Py_default_vector_length', 'size': 'Py_default_vector_length', 'hop_size': 'Py_default_vector_length / 2', 'hop_s': 'Py_default_vector_length / 2', 'samplerate': 'Py_aubio_default_samplerate', 'n_filters': '40', 'n_coeffs': '13', 'nelems': '10', 'flow': '0.', 'fhig': '1.', 'ilow': '0.', 'ihig': '1.', 'thrs': '0.5', 'ratio': '0.5', 'method': '"default"', 'uri': '"none"', 'transpose': '0.'}
member_types = {'name': 'type', 'char_t*': 'T_STRING', 'uint_t': 'T_INT', 'smpl_t': 'AUBIO_NPY_SMPL'}
pyfromtype_fn = {'smpl_t': 'PyFloat_FromDouble', 'uint_t': 'PyLong_FromLong', 'fvec_t*': 'PyAubio_CFvecToArray', 'fmat_t*': 'PyAubio_CFmatToArray'}
pytoaubio_fn = {'fvec_t*': 'PyAubio_ArrayToCFvec', 'cvec_t*': 'PyAubio_PyCvecToCCvec'}
newfromtype_fn = {'fvec_t*': 'new_py_fvec', 'fmat_t*': 'new_py_fmat', 'cvec_t*': 'new_py_cvec'}
delfromtype_fn = {'fvec_t*': 'Py_DECREF', 'fmat_t*': 'Py_DECREF', 'cvec_t*': 'Py_DECREF'}
param_init = {'char_t*': 'NULL', 'uint_t': '0', 'sint_t': 0, 'smpl_t': 0.0, 'lsmp_t': 0.0}
pyargparse_chars = {'smpl_t': 'f', 'uint_t': 'I', 'sint_t': 'I', 'char_t*': 's', 'fmat_t*': 'O', 'fvec_t*': 'O', 'cvec_t*': 'O'}
objoutsize = {'onset': '1', 'pitch': '1', 'notes': '3', 'wavetable': 'self->hop_size', 'sampler': 'self->hop_size', 'mfcc': 'self->n_coeffs', 'specdesc': '1', 'tempo': '1', 'filterbank': 'self->n_filters', 'tss': 'self->buf_size', 'pitchshift': 'self->hop_size', 'dct': 'self->size'}
objinputsize = {'mfcc': 'self->buf_size / 2 + 1', 'notes': 'self->hop_size', 'onset': 'self->hop_size', 'pitch': 'self->hop_size', 'sampler': 'self->hop_size', 'specdesc': 'self->buf_size / 2 + 1', 'tempo': 'self->hop_size', 'wavetable': 'self->hop_size', 'tss': 'self->buf_size / 2 + 1', 'pitchshift': 'self->hop_size'}
