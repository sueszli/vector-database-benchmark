...
class Migration(migrations.Migration):
    dependencies = [('features', '0017_auto_20200607_1005')]
    operations = [migrations.RunPython(migrate_feature_segments_forward, reverse_code=migrate_feature_segments_reverse)]