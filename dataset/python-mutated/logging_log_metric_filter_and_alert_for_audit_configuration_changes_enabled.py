...
class logging_log_metric_filter_and_alert_for_audit_configuration_changes_enabled(Check):
    ...
    def execute(self) -> Check_Report_GCP:
        ...
        for metric in logging_client.metrics:
            if 'protoPayload.methodName="SetIamPolicy" AND protoPayload.serviceData.policyDelta.auditConfigDeltas:*' in metric.filter:
