...
class SendChatAction(TelegramMethod[bool]):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, chat_id: Union[int, str], action: str, message_thread_id: Optional[int]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                while True:
                    i = 10
            super().__init__(chat_id=chat_id, action=action, message_thread_id=message_thread_id, **__pydantic_kwargs)