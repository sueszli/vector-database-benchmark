...
possible_log_types = ('Version', 'Error Log', 'Scheduled Job Log', 'Event Sync Log', 'Event Update Log', 'Access Log', 'View Log', 'Activity Log', 'Energy Point Log', 'Notification Log', 'Email Queue', 'DocShare', 'Document Follow', 'Console Log')
