...
MANIFOLD_ALGORITHMS = {'lle': LocallyLinearEmbedding(method='standard', eigen_solver='auto'), 'ltsa': LocallyLinearEmbedding(method='ltsa', eigen_solver='auto'), 'hessian': LocallyLinearEmbedding(method='hessian', eigen_solver='auto'), 'modified': LocallyLinearEmbedding(method='modified', eigen_solver='auto'), 'isomap': Isomap(), 'mds': MDS(), 'spectral': SpectralEmbedding(), 'tsne': TSNE(init='pca')}
MANIFOLD_NAMES = {'lle': 'Locally Linear Embedding', 'ltsa': 'LTSA LLE', 'hessian': 'Hessian LLE', 'modified': 'Modified LLE', 'isomap': 'Isomap', 'mds': 'MDS', 'spectral': 'Spectral Embedding', 'tsne': 't-SNE'}
