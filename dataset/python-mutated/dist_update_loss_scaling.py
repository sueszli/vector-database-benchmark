...
register_distributed_operator_impl_container(DistributedUpdateLossScaling('update_loss_scaling'))
...
register_distributed_operator_impl('update_loss_scaling', DistributedUpdateLossScalingImpl('update_loss_scaling'))