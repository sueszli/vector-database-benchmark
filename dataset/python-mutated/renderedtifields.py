...
from sqlalchemy import Column, ForeignKeyConstraint, Integer, PrimaryKeyConstraint, delete, exists, select, text
...
class RenderedTaskInstanceFields(Base):
    ...
    task_instance = relationship('TaskInstance', lazy='joined', back_populates='rendered_task_instance_fields')
