...
class SimulatorExpressionParser(QObject):
    ...
    op_formula = {ast.Add: op.add, ast.Sub: op.sub, ast.Mult: op.mul, ast.Div: op.truediv, ast.BitOr: op.or_, ast.BitXor: op.xor, ast.BitAnd: op.and_, ast.LShift: op.lshift, ast.RShift: op.rshift, ast.Invert: op.invert}
    op_cond = {ast.And: None, ast.Or: None, ast.Not: op.not_, ast.Eq: op.eq, ast.NotEq: op.ne, ast.Lt: op.lt, ast.LtE: op.le, ast.Gt: op.gt, ast.GtE: op.ge}
    operators = {}
