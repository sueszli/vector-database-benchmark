...
def convert_mit_csv_to_json(class_file_path, train_csv_path, val_csv_path, test_csv_path, video_dir_path, dst_json_path):
    if False:
        return 10
...
if __name__ == '__main__':
    ...
    parser.add_argument('dir_path', default=None, type=Path, help='Directory path including moments_categories.txt, trainingSet.csv, validationSet.csv, (testingSet.csv (optional))')
    ...
    convert_mit_csv_to_json(class_file_path, train_csv_path, val_csv_path, test_csv_path, args.video_path, args.dst_path)