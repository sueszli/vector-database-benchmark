...
class gke_backupCallTransformer(cst.CSTTransformer):
    CTRL_PARAMS: Tuple[str] = ('retry', 'timeout', 'metadata')
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'create_backup': ('parent', 'backup', 'backup_id'), 'create_backup_plan': ('parent', 'backup_plan', 'backup_plan_id'), 'create_restore': ('parent', 'restore', 'restore_id'), 'create_restore_plan': ('parent', 'restore_plan', 'restore_plan_id'), 'delete_backup': ('name', 'etag', 'force'), 'delete_backup_plan': ('name', 'etag'), 'delete_restore': ('name', 'etag', 'force'), 'delete_restore_plan': ('name', 'etag', 'force'), 'get_backup': ('name',), 'get_backup_plan': ('name',), 'get_restore': ('name',), 'get_restore_plan': ('name',), 'get_volume_backup': ('name',), 'get_volume_restore': ('name',), 'list_backup_plans': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_backups': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_restore_plans': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_restores': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_volume_backups': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'list_volume_restores': ('parent', 'page_size', 'page_token', 'filter', 'order_by'), 'update_backup': ('backup', 'update_mask'), 'update_backup_plan': ('backup_plan', 'update_mask'), 'update_restore': ('restore', 'update_mask'), 'update_restore_plan': ('restore_plan', 'update_mask')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=gke_backupCallTransformer()):
    if False:
        print('Hello World!')
