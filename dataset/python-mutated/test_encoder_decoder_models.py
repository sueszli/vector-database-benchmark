...
PEFT_ENCODER_DECODER_MODELS_TO_TEST = ['ybelkada/tiny-random-T5ForConditionalGeneration-calibrated', 'hf-internal-testing/tiny-random-BartForConditionalGeneration']
