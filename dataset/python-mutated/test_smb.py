...
TBE = '{}:0:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX:AC8E657F83DF82BEEA5D43BDAF7800CC:[U          ]:LCT-507C14C7:'
IPV6_ENABLED = bool(salt.utils.network.ip_addrs6(include_loopback=True))

@pytest.mark.skipif(not salt.utils.smb.HAS_SMBPROTOCOL, reason='"smbprotocol" needs to be installed.')
