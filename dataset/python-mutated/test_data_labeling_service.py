...
import pytest
from google.cloud.datalabeling_v1beta1.services.data_labeling_service import DataLabelingServiceAsyncClient, DataLabelingServiceClient, pagers, transports
...
async def test_create_dataset_async(transport: str='grpc_asyncio', request_type=data_labeling_service.CreateDatasetRequest):
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', blocking_resources=['blocking_resources_value'], data_item_count=1584))
...
async def test_create_dataset_field_headers_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = data_labeling_service.CreateDatasetRequest()
    request.parent = 'parent_value'
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
...
async def test_create_dataset_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_dataset), '__call__') as call:
        call.return_value = gcd_dataset.Dataset()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_dataset.Dataset())
        response = await client.create_dataset(parent='parent_value', dataset=gcd_dataset.Dataset(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_dataset_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_dataset(data_labeling_service.CreateDatasetRequest(), parent='parent_value', dataset=gcd_dataset.Dataset(name='name_value'))
...
async def test_get_dataset_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetDatasetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_dataset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dataset.Dataset(name='name_value', display_name='display_name_value', description='description_value', blocking_resources=['blocking_resources_value'], data_item_count=1584))
...
async def test_get_dataset_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_dataset(data_labeling_service.GetDatasetRequest(), name='name_value')
...
async def test_list_datasets_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListDatasetsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_datasets), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListDatasetsResponse(next_page_token='next_page_token_value'))
...
async def test_list_datasets_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_datasets), '__call__') as call:
        call.return_value = data_labeling_service.ListDatasetsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListDatasetsResponse())
        response = await client.list_datasets(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_datasets_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_datasets(data_labeling_service.ListDatasetsRequest(), parent='parent_value', filter='filter_value')
...
async def test_delete_dataset_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_dataset(data_labeling_service.DeleteDatasetRequest(), name='name_value')
...
async def test_import_data_flattened_async():
    ...
    with mock.patch.object(type(client.transport.import_data), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.import_data(name='name_value', input_config=dataset.InputConfig(text_metadata=dataset.TextMetadata(language_code='language_code_value')))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_import_data_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.import_data(data_labeling_service.ImportDataRequest(), name='name_value', input_config=dataset.InputConfig(text_metadata=dataset.TextMetadata(language_code='language_code_value')))
...
async def test_export_data_flattened_async():
    ...
    with mock.patch.object(type(client.transport.export_data), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.export_data(name='name_value', annotated_dataset='annotated_dataset_value', filter='filter_value', output_config=dataset.OutputConfig(gcs_destination=dataset.GcsDestination(output_uri='output_uri_value')))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].name
        mock_val = 'name_value'
...
async def test_export_data_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.export_data(data_labeling_service.ExportDataRequest(), name='name_value', annotated_dataset='annotated_dataset_value', filter='filter_value', output_config=dataset.OutputConfig(gcs_destination=dataset.GcsDestination(output_uri='output_uri_value')))
...
async def test_get_data_item_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetDataItemRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_data_item), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dataset.DataItem(name='name_value'))
...
async def test_get_data_item_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_data_item(data_labeling_service.GetDataItemRequest(), name='name_value')
...
async def test_list_data_items_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListDataItemsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_data_items), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListDataItemsResponse(next_page_token='next_page_token_value'))
...
async def test_list_data_items_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_data_items), '__call__') as call:
        call.return_value = data_labeling_service.ListDataItemsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListDataItemsResponse())
        response = await client.list_data_items(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_data_items_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_data_items(data_labeling_service.ListDataItemsRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_data_items_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_data_items), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListDataItemsResponse(data_items=[dataset.DataItem(), dataset.DataItem(), dataset.DataItem()], next_page_token='abc'), data_labeling_service.ListDataItemsResponse(data_items=[], next_page_token='def'), data_labeling_service.ListDataItemsResponse(data_items=[dataset.DataItem()], next_page_token='ghi'), data_labeling_service.ListDataItemsResponse(data_items=[dataset.DataItem(), dataset.DataItem()]), RuntimeError)
...
async def test_get_annotated_dataset_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetAnnotatedDatasetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_annotated_dataset), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dataset.AnnotatedDataset(name='name_value', display_name='display_name_value', description='description_value', annotation_source=annotation.AnnotationSource.OPERATOR, annotation_type=annotation.AnnotationType.IMAGE_CLASSIFICATION_ANNOTATION, example_count=1396, completed_example_count=2448, blocking_resources=['blocking_resources_value']))
...
async def test_get_annotated_dataset_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_annotated_dataset(data_labeling_service.GetAnnotatedDatasetRequest(), name='name_value')
...
async def test_list_annotated_datasets_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListAnnotatedDatasetsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_annotated_datasets), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotatedDatasetsResponse(next_page_token='next_page_token_value'))
...
async def test_list_annotated_datasets_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_annotated_datasets), '__call__') as call:
        call.return_value = data_labeling_service.ListAnnotatedDatasetsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotatedDatasetsResponse())
        response = await client.list_annotated_datasets(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_annotated_datasets_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_annotated_datasets(data_labeling_service.ListAnnotatedDatasetsRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_annotated_datasets_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_annotated_datasets), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListAnnotatedDatasetsResponse(annotated_datasets=[dataset.AnnotatedDataset(), dataset.AnnotatedDataset(), dataset.AnnotatedDataset()], next_page_token='abc'), data_labeling_service.ListAnnotatedDatasetsResponse(annotated_datasets=[], next_page_token='def'), data_labeling_service.ListAnnotatedDatasetsResponse(annotated_datasets=[dataset.AnnotatedDataset()], next_page_token='ghi'), data_labeling_service.ListAnnotatedDatasetsResponse(annotated_datasets=[dataset.AnnotatedDataset(), dataset.AnnotatedDataset()]), RuntimeError)
...
async def test_label_image_flattened_async():
    ...
    with mock.patch.object(type(client.transport.label_image), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.label_image(parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelImageRequest.Feature.CLASSIFICATION)
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_label_image_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.label_image(data_labeling_service.LabelImageRequest(), parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelImageRequest.Feature.CLASSIFICATION)
...
async def test_label_video_flattened_async():
    ...
    with mock.patch.object(type(client.transport.label_video), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.label_video(parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelVideoRequest.Feature.CLASSIFICATION)
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_label_video_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.label_video(data_labeling_service.LabelVideoRequest(), parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelVideoRequest.Feature.CLASSIFICATION)
...
async def test_label_text_flattened_async():
    ...
    with mock.patch.object(type(client.transport.label_text), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.label_text(parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelTextRequest.Feature.TEXT_CLASSIFICATION)
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_label_text_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.label_text(data_labeling_service.LabelTextRequest(), parent='parent_value', basic_config=human_annotation_config.HumanAnnotationConfig(instruction='instruction_value'), feature=data_labeling_service.LabelTextRequest.Feature.TEXT_CLASSIFICATION)
...
async def test_get_example_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetExampleRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_example), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(dataset.Example(name='name_value'))
...
async def test_get_example_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_example(data_labeling_service.GetExampleRequest(), name='name_value', filter='filter_value')
...
async def test_list_examples_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListExamplesRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_examples), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListExamplesResponse(next_page_token='next_page_token_value'))
...
async def test_list_examples_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_examples), '__call__') as call:
        call.return_value = data_labeling_service.ListExamplesResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListExamplesResponse())
        response = await client.list_examples(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_examples_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_examples(data_labeling_service.ListExamplesRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_examples_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_examples), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListExamplesResponse(examples=[dataset.Example(), dataset.Example(), dataset.Example()], next_page_token='abc'), data_labeling_service.ListExamplesResponse(examples=[], next_page_token='def'), data_labeling_service.ListExamplesResponse(examples=[dataset.Example()], next_page_token='ghi'), data_labeling_service.ListExamplesResponse(examples=[dataset.Example(), dataset.Example()]), RuntimeError)
...
async def test_create_annotation_spec_set_async(transport: str='grpc_asyncio', request_type=data_labeling_service.CreateAnnotationSpecSetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.create_annotation_spec_set), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_annotation_spec_set.AnnotationSpecSet(name='name_value', display_name='display_name_value', description='description_value', blocking_resources=['blocking_resources_value']))
...
async def test_create_annotation_spec_set_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_annotation_spec_set), '__call__') as call:
        call.return_value = gcd_annotation_spec_set.AnnotationSpecSet()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_annotation_spec_set.AnnotationSpecSet())
        response = await client.create_annotation_spec_set(parent='parent_value', annotation_spec_set=gcd_annotation_spec_set.AnnotationSpecSet(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_annotation_spec_set_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_annotation_spec_set(data_labeling_service.CreateAnnotationSpecSetRequest(), parent='parent_value', annotation_spec_set=gcd_annotation_spec_set.AnnotationSpecSet(name='name_value'))
...
async def test_get_annotation_spec_set_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetAnnotationSpecSetRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_annotation_spec_set), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(annotation_spec_set.AnnotationSpecSet(name='name_value', display_name='display_name_value', description='description_value', blocking_resources=['blocking_resources_value']))
...
async def test_get_annotation_spec_set_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_annotation_spec_set(data_labeling_service.GetAnnotationSpecSetRequest(), name='name_value')
...
async def test_list_annotation_spec_sets_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListAnnotationSpecSetsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_annotation_spec_sets), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotationSpecSetsResponse(next_page_token='next_page_token_value'))
...
async def test_list_annotation_spec_sets_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_annotation_spec_sets), '__call__') as call:
        call.return_value = data_labeling_service.ListAnnotationSpecSetsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListAnnotationSpecSetsResponse())
        response = await client.list_annotation_spec_sets(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_annotation_spec_sets_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_annotation_spec_sets(data_labeling_service.ListAnnotationSpecSetsRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_annotation_spec_sets_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_annotation_spec_sets), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListAnnotationSpecSetsResponse(annotation_spec_sets=[annotation_spec_set.AnnotationSpecSet(), annotation_spec_set.AnnotationSpecSet(), annotation_spec_set.AnnotationSpecSet()], next_page_token='abc'), data_labeling_service.ListAnnotationSpecSetsResponse(annotation_spec_sets=[], next_page_token='def'), data_labeling_service.ListAnnotationSpecSetsResponse(annotation_spec_sets=[annotation_spec_set.AnnotationSpecSet()], next_page_token='ghi'), data_labeling_service.ListAnnotationSpecSetsResponse(annotation_spec_sets=[annotation_spec_set.AnnotationSpecSet(), annotation_spec_set.AnnotationSpecSet()]), RuntimeError)
        ...
        async for response in async_pager:
            responses.append(response)
        assert len(responses) == 6
        assert all((isinstance(i, annotation_spec_set.AnnotationSpecSet) for i in responses))
...
async def test_delete_annotation_spec_set_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_annotation_spec_set(data_labeling_service.DeleteAnnotationSpecSetRequest(), name='name_value')
...
async def test_create_instruction_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_instruction), '__call__') as call:
        call.return_value = operations_pb2.Operation(name='operations/op')
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(operations_pb2.Operation(name='operations/spam'))
        response = await client.create_instruction(parent='parent_value', instruction=gcd_instruction.Instruction(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_instruction_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_instruction(data_labeling_service.CreateInstructionRequest(), parent='parent_value', instruction=gcd_instruction.Instruction(name='name_value'))
...
async def test_get_instruction_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetInstructionRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_instruction), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(instruction.Instruction(name='name_value', display_name='display_name_value', description='description_value', data_type=dataset.DataType.IMAGE, blocking_resources=['blocking_resources_value']))
...
async def test_get_instruction_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_instruction(data_labeling_service.GetInstructionRequest(), name='name_value')
...
async def test_list_instructions_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListInstructionsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_instructions), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListInstructionsResponse(next_page_token='next_page_token_value'))
...
async def test_list_instructions_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_instructions), '__call__') as call:
        call.return_value = data_labeling_service.ListInstructionsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListInstructionsResponse())
        response = await client.list_instructions(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_instructions_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_instructions(data_labeling_service.ListInstructionsRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_instructions_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_instructions), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListInstructionsResponse(instructions=[instruction.Instruction(), instruction.Instruction(), instruction.Instruction()], next_page_token='abc'), data_labeling_service.ListInstructionsResponse(instructions=[], next_page_token='def'), data_labeling_service.ListInstructionsResponse(instructions=[instruction.Instruction()], next_page_token='ghi'), data_labeling_service.ListInstructionsResponse(instructions=[instruction.Instruction(), instruction.Instruction()]), RuntimeError)
...
async def test_delete_instruction_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_instruction(data_labeling_service.DeleteInstructionRequest(), name='name_value')
...
async def test_get_evaluation_async(transport: str='grpc_asyncio', request_type=data_labeling_service.GetEvaluationRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.get_evaluation), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(evaluation.Evaluation(name='name_value', annotation_type=annotation.AnnotationType.IMAGE_CLASSIFICATION_ANNOTATION, evaluated_item_count=2129))
...
async def test_get_evaluation_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_evaluation(data_labeling_service.GetEvaluationRequest(), name='name_value')
...
async def test_search_evaluations_async(transport: str='grpc_asyncio', request_type=data_labeling_service.SearchEvaluationsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.search_evaluations), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.SearchEvaluationsResponse(next_page_token='next_page_token_value'))
...
async def test_search_evaluations_flattened_async():
    ...
    with mock.patch.object(type(client.transport.search_evaluations), '__call__') as call:
        call.return_value = data_labeling_service.SearchEvaluationsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.SearchEvaluationsResponse())
        response = await client.search_evaluations(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_search_evaluations_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.search_evaluations(data_labeling_service.SearchEvaluationsRequest(), parent='parent_value', filter='filter_value')
...
async def test_search_evaluations_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.search_evaluations), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.SearchEvaluationsResponse(evaluations=[evaluation.Evaluation(), evaluation.Evaluation(), evaluation.Evaluation()], next_page_token='abc'), data_labeling_service.SearchEvaluationsResponse(evaluations=[], next_page_token='def'), data_labeling_service.SearchEvaluationsResponse(evaluations=[evaluation.Evaluation()], next_page_token='ghi'), data_labeling_service.SearchEvaluationsResponse(evaluations=[evaluation.Evaluation(), evaluation.Evaluation()]), RuntimeError)
...
async def test_search_example_comparisons_async(transport: str='grpc_asyncio', request_type=data_labeling_service.SearchExampleComparisonsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.search_example_comparisons), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.SearchExampleComparisonsResponse(next_page_token='next_page_token_value'))
...
async def test_search_example_comparisons_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.search_example_comparisons(data_labeling_service.SearchExampleComparisonsRequest(), parent='parent_value')
...
async def test_search_example_comparisons_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.search_example_comparisons), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.SearchExampleComparisonsResponse(example_comparisons=[data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison(), data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison(), data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison()], next_page_token='abc'), data_labeling_service.SearchExampleComparisonsResponse(example_comparisons=[], next_page_token='def'), data_labeling_service.SearchExampleComparisonsResponse(example_comparisons=[data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison()], next_page_token='ghi'), data_labeling_service.SearchExampleComparisonsResponse(example_comparisons=[data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison(), data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison()]), RuntimeError)
        ...
        async for response in async_pager:
            responses.append(response)
        assert len(responses) == 6
        assert all((isinstance(i, data_labeling_service.SearchExampleComparisonsResponse.ExampleComparison) for i in responses))
...
async def test_create_evaluation_job_flattened_async():
    ...
    with mock.patch.object(type(client.transport.create_evaluation_job), '__call__') as call:
        call.return_value = evaluation_job.EvaluationJob()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(evaluation_job.EvaluationJob())
        response = await client.create_evaluation_job(parent='parent_value', job=evaluation_job.EvaluationJob(name='name_value'))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_create_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.create_evaluation_job(data_labeling_service.CreateEvaluationJobRequest(), parent='parent_value', job=evaluation_job.EvaluationJob(name='name_value'))
...
async def test_update_evaluation_job_flattened_async():
    ...
    with mock.patch.object(type(client.transport.update_evaluation_job), '__call__') as call:
        call.return_value = gcd_evaluation_job.EvaluationJob()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(gcd_evaluation_job.EvaluationJob())
        response = await client.update_evaluation_job(evaluation_job=gcd_evaluation_job.EvaluationJob(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].evaluation_job
        mock_val = gcd_evaluation_job.EvaluationJob(name='name_value')
...
async def test_update_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.update_evaluation_job(data_labeling_service.UpdateEvaluationJobRequest(), evaluation_job=gcd_evaluation_job.EvaluationJob(name='name_value'), update_mask=field_mask_pb2.FieldMask(paths=['paths_value']))
...
async def test_get_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.get_evaluation_job(data_labeling_service.GetEvaluationJobRequest(), name='name_value')
...
async def test_pause_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.pause_evaluation_job(data_labeling_service.PauseEvaluationJobRequest(), name='name_value')
...
async def test_resume_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.resume_evaluation_job(data_labeling_service.ResumeEvaluationJobRequest(), name='name_value')
...
async def test_delete_evaluation_job_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.delete_evaluation_job(data_labeling_service.DeleteEvaluationJobRequest(), name='name_value')
...
async def test_list_evaluation_jobs_async(transport: str='grpc_asyncio', request_type=data_labeling_service.ListEvaluationJobsRequest):
    ...
    request = request_type()
    with mock.patch.object(type(client.transport.list_evaluation_jobs), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListEvaluationJobsResponse(next_page_token='next_page_token_value'))
...
async def test_list_evaluation_jobs_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_evaluation_jobs), '__call__') as call:
        call.return_value = data_labeling_service.ListEvaluationJobsResponse()
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(data_labeling_service.ListEvaluationJobsResponse())
        response = await client.list_evaluation_jobs(parent='parent_value', filter='filter_value')
        assert len(call.mock_calls)
        (_, args, _) = call.mock_calls[0]
        arg = args[0].parent
        mock_val = 'parent_value'
...
async def test_list_evaluation_jobs_flattened_error_async():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        await client.list_evaluation_jobs(data_labeling_service.ListEvaluationJobsRequest(), parent='parent_value', filter='filter_value')
...
async def test_list_evaluation_jobs_async_pager():
    client = DataLabelingServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials)
    with mock.patch.object(type(client.transport.list_evaluation_jobs), '__call__', new_callable=mock.AsyncMock) as call:
        call.side_effect = (data_labeling_service.ListEvaluationJobsResponse(evaluation_jobs=[evaluation_job.EvaluationJob(), evaluation_job.EvaluationJob(), evaluation_job.EvaluationJob()], next_page_token='abc'), data_labeling_service.ListEvaluationJobsResponse(evaluation_jobs=[], next_page_token='def'), data_labeling_service.ListEvaluationJobsResponse(evaluation_jobs=[evaluation_job.EvaluationJob()], next_page_token='ghi'), data_labeling_service.ListEvaluationJobsResponse(evaluation_jobs=[evaluation_job.EvaluationJob(), evaluation_job.EvaluationJob()]), RuntimeError)
