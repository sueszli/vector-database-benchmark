...
class OutLayer(nn.Module):
    ...
    def __init__(self, n_units=256, num_anchors=2):
        ...
        self.rnn_combine = TransformerEncoder_out(num_anchors * n_units, n_units)
    ...
    def forward(self, input):
        ...
        output = self.rnn_combine(output)
...
class TransformerDetector(nn.Module):
    ...
    def __init__(self, frame_dim=512, anchor_dim=192, hidden_dim=256, max_seq_len=500):
        if False:
            print('Hello World!')
...
@MODELS.register_module(Tasks.speaker_diarization, module_name=Models.scl_sd_xvector)
