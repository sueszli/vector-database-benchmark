...
class Tacotron2CriterionConfig(FairseqDataclass):
    bce_pos_weight: float = field(default=1.0, metadata={'help': 'weight of positive examples for BCE loss'})
    use_guided_attention_loss: bool = field(default=False, metadata={'help': 'use guided attention loss'})
    guided_attention_loss_sigma: float = field(default=0.4, metadata={'help': 'weight of positive examples for BCE loss'})
