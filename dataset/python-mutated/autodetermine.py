...
class AutoDetermine(typesystem.Field):
    errors = {'not_an_object': 'Must be an object.', 'not_openapi_or_swagger': "Must include either an 'openapi' property or a 'swagger' property.", 'both_openapi_and_swagger': "May not include both an 'openapi' property and a 'swagger' property."}
