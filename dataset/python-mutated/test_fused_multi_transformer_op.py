...
class TestFusedMultiTransformerOpGenCacheRotaryFP16(TestFusedMultiTransformerOp):
...
class TestFusedMultiTransformerOpCacheKVPostLayerNormFp16(TestFusedMultiTransformerOp):
...
class TestFusedMultiTransformerOpGenCacheKVPostLayerNorm(TestFusedMultiTransformerOp):
...
class TestFusedMultiTransformerOpGenCacheKVPostLayerNormFp16(TestFusedMultiTransformerOp):
...
class TestFusedMultiTransformerOpVariableNormTransformer1(TestFusedMultiTransformerOp):
...
class TestFusedMultiTransformerOpVariableNormTransformer2(TestFusedMultiTransformerOp):
