...
class ConversationModel(proto.Message):
    ...
    datasets: MutableSequence['InputDataset'] = proto.RepeatedField(proto.MESSAGE, number=4, message='InputDataset')
    state: State = proto.Field(proto.ENUM, number=7, enum=State)
    language_code: str = proto.Field(proto.STRING, number=19)
    article_suggestion_model_metadata: 'ArticleSuggestionModelMetadata' = proto.Field(proto.MESSAGE, number=8, oneof='model_metadata', message='ArticleSuggestionModelMetadata')
    smart_reply_model_metadata: 'SmartReplyModelMetadata' = proto.Field(proto.MESSAGE, number=9, oneof='model_metadata', message='SmartReplyModelMetadata')
...
class ConversationModelEvaluation(proto.Message):
    ...
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    evaluation_config: 'EvaluationConfig' = proto.Field(proto.MESSAGE, number=6, message='EvaluationConfig')
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    smart_reply_metrics: 'SmartReplyMetrics' = proto.Field(proto.MESSAGE, number=5, oneof='metrics', message='SmartReplyMetrics')
    raw_human_eval_template_csv: str = proto.Field(proto.STRING, number=8)
...
class EvaluationConfig(proto.Message):
    ...
    class SmartReplyConfig(proto.Message):
        ...
        Attributes:
            ...
            max_result_count (int):
                ...
                results to evaluate.
        """
        allowlist_document: str = proto.Field(proto.STRING, number=1)
        max_result_count: int = proto.Field(proto.INT32, number=2)
    ...
    class SmartComposeConfig(proto.Message):
        ...
        allowlist_document: str = proto.Field(proto.STRING, number=1)
        max_result_count: int = proto.Field(proto.INT32, number=2)
    datasets: MutableSequence['InputDataset'] = proto.RepeatedField(proto.MESSAGE, number=3, message='InputDataset')
    smart_reply_config: SmartReplyConfig = proto.Field(proto.MESSAGE, number=2, oneof='model_specific_config', message=SmartReplyConfig)
    smart_compose_config: SmartComposeConfig = proto.Field(proto.MESSAGE, number=4, oneof='model_specific_config', message=SmartComposeConfig)
...
class ArticleSuggestionModelMetadata(proto.Message):
    ...
    """
    training_model_type: 'ConversationModel.ModelType' = proto.Field(proto.ENUM, number=3, enum='ConversationModel.ModelType')
...
class SmartReplyModelMetadata(proto.Message):
    ...
    Attributes:
        training_model_type (google.cloud.dialogflow_v2.types.ConversationModel.ModelType):
            ...
            model_type is used.
    """
    training_model_type: 'ConversationModel.ModelType' = proto.Field(proto.ENUM, number=6, enum='ConversationModel.ModelType')
...
class SmartReplyMetrics(proto.Message):
    ...
    class TopNMetrics(proto.Message):
        """Evaluation metrics when retrieving ``n`` smart replies with the
        model.
        ...
        """
        n: int = proto.Field(proto.INT32, number=1)
        recall: float = proto.Field(proto.FLOAT, number=2)
    allowlist_coverage: float = proto.Field(proto.FLOAT, number=1)
    top_n_metrics: MutableSequence[TopNMetrics] = proto.RepeatedField(proto.MESSAGE, number=2, message=TopNMetrics)
    conversation_count: int = proto.Field(proto.INT64, number=3)
...
class CreateConversationModelRequest(proto.Message):
    ...
    conversation_model: 'ConversationModel' = proto.Field(proto.MESSAGE, number=2, message='ConversationModel')
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    conversation_models: MutableSequence['ConversationModel'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ConversationModel')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    conversation_model_evaluations: MutableSequence['ConversationModelEvaluation'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ConversationModelEvaluation')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class CreateConversationModelEvaluationRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    conversation_model_evaluation: 'ConversationModelEvaluation' = proto.Field(proto.MESSAGE, number=2, message='ConversationModelEvaluation')
...
class CreateConversationModelOperationMetadata(proto.Message):
    ...
    class State(proto.Enum):
        ...
        CANCELLING = 5
        TRAINING = 6
    conversation_model: str = proto.Field(proto.STRING, number=1)
...
class CreateConversationModelEvaluationOperationMetadata(proto.Message):
    ...
    class State(proto.Enum):
        ...
        SUCCEEDED = 4
        FAILED = 5
    conversation_model_evaluation: str = proto.Field(proto.STRING, number=1)
    conversation_model: str = proto.Field(proto.STRING, number=4)
    state: State = proto.Field(proto.ENUM, number=2, enum=State)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
