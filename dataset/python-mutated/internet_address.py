...
internet_address: AdvancedDataType = AdvancedDataType(verbose_name='internet address', description='represents both an ip and cidr range', valid_data_types=['int'], translate_filter=cidr_translate_filter_func, translate_type=cidr_func)