...
class Migration(migrations.Migration):
    dependencies = [('submission', '0009_delete_user_output'), ('problem', '0010_problem_spj_compile_ok')]
    operations = [migrations.RunPython(fix_rejudge_bugs, reverse_code=migrations.RunPython.noop)]