import logging
from redash.query_runner import TYPE_FLOAT, TYPE_INTEGER, TYPE_STRING, BaseQueryRunner, register
...
try:
    ...
    enabled = False
TYPES_MAP = {str: TYPE_STRING, int: TYPE_INTEGER, float: TYPE_FLOAT}
