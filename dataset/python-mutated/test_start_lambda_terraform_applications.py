...
class TestLocalStartLambdaTerraformApplicationWithoutBuild(StartLambdaTerraformApplicationIntegBase):
    ...
    functions = ['s3_lambda_function', 'aws_lambda_function.s3_lambda', 'root_lambda', 'aws_lambda_function.root_lambda', 'level1_lambda_function', 'module.level1_lambda.aws_lambda_function.this', 'level2_lambda_function', 'module.level1_lambda.module.level2_lambda.aws_lambda_function.this']
...
@skipIf(not RUN_BY_CANARY and (not CI_OVERRIDE), 'Skip Terraform test cases unless running in CI')
@parameterized_class(('should_apply_first',), [(False,), (True,)])
class TestLocalStartLambdaTerraformApplicationWithLayersWithoutBuild(StartLambdaTerraformApplicationIntegBase):
    ...
    def setUp(self):
        ...
        self.url = 'http://127.0.0.1:{}'.format(self.port)
        self.lambda_client = boto3.client('lambda', endpoint_url=self.url, region_name='us-east-1', use_ssl=False, verify=False, config=Config(signature_version=UNSIGNED, read_timeout=120, retries={'max_attempts': 0}))
    functions = [('module.function44.aws_lambda_function.this', 'hello world 44'), ('module.function33.aws_lambda_function.this', 'hello world 33'), ('module.function8.aws_lambda_function.this[0]', 'hello world 8'), ('module.function9.aws_lambda_function.this[0]', 'hello world 9'), ('aws_lambda_function.function1', 'hello world 1'), ('aws_lambda_function.function2', 'hello world 2'), ('aws_lambda_function.function3', 'hello world 3'), ('aws_lambda_function.function4', 'hello world 4'), ('module.function5[0].aws_lambda_function.this[0]', 'hello world 5'), ('aws_lambda_function.function6', 'hello world 6'), ('aws_lambda_function.function7', 'hello world 7')]
...
@skipIf(not RUN_BY_CANARY or ((IS_WINDOWS and RUNNING_ON_CI) and (not CI_OVERRIDE)), 'Skip local start-lambda terraform applications tests on windows when running in CI unless overridden')
class TestLocalStartLambdaTerraformApplicationWithLocalImageUri(StartLambdaTerraformApplicationIntegBase):
    ...
    template_path = None
    hook_name = 'terraform'
    functions = ['module.image_lambda2.aws_lambda_function.this[0]', 'image_lambda2', 'image_lambda_function', 'aws_lambda_function.image_lambda']
