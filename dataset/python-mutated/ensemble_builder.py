...
class _EnsembleSpec(collections.namedtuple('_EnsembleSpec', ['name', 'ensemble', 'architecture', 'subnetwork_builders', 'subnetwork_specs', 'predictions', 'step', 'variables', 'loss', 'adanet_loss', 'train_op', 'eval_metrics', 'export_outputs'])):
...
class _SubnetworkSpec(collections.namedtuple('_SubnetworkSpec', ['name', 'subnetwork', 'builder', 'predictions', 'step', 'variables', 'loss', 'train_op', 'eval_metrics', 'asset_dir'])):
