...
class Migration(migrations.Migration):
    dependencies = [('warehouse', '0015_alter_stock_quantity')]
    operations = [migrations.AddField(model_name='stock', name='quantity_allocated', field=models.IntegerField(default=0)), migrations.RunPython(assign_quantity_allocated_to_stocks, migrations.RunPython.noop)]