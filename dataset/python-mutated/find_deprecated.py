...
if __name__ == '__main__':
    ...
    if DATA_JSON:
        ...
        LAST_TIME_MINOR = datetime.fromisoformat(DATA_JSON['releases'][f'{LAST_MINOR}.0'][0]['upload_time'])
    for (since_version, deprecations) in collection.grouped.items():
        if DATA_JSON and LAST_TIME_MINOR:
            try:
                release_minor_datetime = datetime.fromisoformat(DATA_JSON['releases'][f'{since_version}.0'][0]['upload_time'])
