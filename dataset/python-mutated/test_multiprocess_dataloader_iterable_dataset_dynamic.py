...
import unittest
import numpy as np
from test_multiprocess_dataloader_iterable_dataset_static import BATCH_SIZE, CLASS_NUM, EPOCH_NUM, IMAGE_SIZE, SAMPLE_NUM, RandomBatchedDataset, RandomDataset, prepare_places
import paddle
