...
from fairseq.models.speech_to_speech.s2s_conformer_unity import multitask_text_transformer_decoder_arch
from fairseq.models.speech_to_speech.s2s_transformer import base_multitask_text_transformer_decoder_arch, s2spect_architecture_base
