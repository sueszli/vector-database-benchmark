...
__protobuf__ = proto.module(package='google.cloud.dataproc.v1', manifest={'CreateBatchRequest', 'GetBatchRequest', 'ListBatchesRequest', 'ListBatchesResponse', 'DeleteBatchRequest', 'Batch', 'PySparkBatch', 'SparkBatch', 'SparkRBatch', 'SparkSqlBatch'})
...
class CreateBatchRequest(proto.Message):
    ...
    batch: 'Batch' = proto.Field(proto.MESSAGE, number=2, message='Batch')
    batch_id: str = proto.Field(proto.STRING, number=3)
    request_id: str = proto.Field(proto.STRING, number=4)

class GetBatchRequest(proto.Message):
    """A request to get the resource representation for a batch
    workload.
...
class ListBatchesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    batches: MutableSequence['Batch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Batch')
...
class Batch(proto.Message):
    ...
    class StateHistory(proto.Message):
        ...
        """
        state: 'Batch.State' = proto.Field(proto.ENUM, number=1, enum='Batch.State')
        state_message: str = proto.Field(proto.STRING, number=2)
        state_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    name: str = proto.Field(proto.STRING, number=1)
    uuid: str = proto.Field(proto.STRING, number=2)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    pyspark_batch: 'PySparkBatch' = proto.Field(proto.MESSAGE, number=4, oneof='batch_config', message='PySparkBatch')
    spark_batch: 'SparkBatch' = proto.Field(proto.MESSAGE, number=5, oneof='batch_config', message='SparkBatch')
    spark_r_batch: 'SparkRBatch' = proto.Field(proto.MESSAGE, number=6, oneof='batch_config', message='SparkRBatch')
    spark_sql_batch: 'SparkSqlBatch' = proto.Field(proto.MESSAGE, number=7, oneof='batch_config', message='SparkSqlBatch')
    runtime_info: shared.RuntimeInfo = proto.Field(proto.MESSAGE, number=8, message=shared.RuntimeInfo)
    state: State = proto.Field(proto.ENUM, number=9, enum=State)
    state_message: str = proto.Field(proto.STRING, number=10)
    state_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=11, message=timestamp_pb2.Timestamp)
    creator: str = proto.Field(proto.STRING, number=12)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=13)
    runtime_config: shared.RuntimeConfig = proto.Field(proto.MESSAGE, number=14, message=shared.RuntimeConfig)
    environment_config: shared.EnvironmentConfig = proto.Field(proto.MESSAGE, number=15, message=shared.EnvironmentConfig)
    operation: str = proto.Field(proto.STRING, number=16)
    state_history: MutableSequence[StateHistory] = proto.RepeatedField(proto.MESSAGE, number=17, message=StateHistory)
...
class PySparkBatch(proto.Message):
    ...
    """
    main_python_file_uri: str = proto.Field(proto.STRING, number=1)
    args: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    python_file_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    jar_file_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    file_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    archive_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
...
class SparkBatch(proto.Message):
    ...
    Attributes:
        ...
        archive_uris (MutableSequence[str]):
            ...
            ``.jar``, ``.tar``, ``.tar.gz``, ``.tgz``, and ``.zip``.
    """
    main_jar_file_uri: str = proto.Field(proto.STRING, number=1, oneof='driver')
    main_class: str = proto.Field(proto.STRING, number=2, oneof='driver')
...
class SparkRBatch(proto.Message):
    ...
    Attributes:
        ...
        archive_uris (MutableSequence[str]):
            ...
            ``.jar``, ``.tar``, ``.tar.gz``, ``.tgz``, and ``.zip``.
    """
    main_r_file_uri: str = proto.Field(proto.STRING, number=1)
    args: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    file_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    archive_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
...
class SparkSqlBatch(proto.Message):
    ...
    """
    query_file_uri: str = proto.Field(proto.STRING, number=1)
    query_variables: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
    jar_file_uris: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
