...
class LogMarker(BaseAddon):
    ...
    __version__ = '0.08'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('mark_hour', 'bool', 'Mark hours', True), ('mark_day', 'bool', 'Mark days', True)]
    ...
    def activated(self):
        if False:
            print('Hello World!')
        self.periodical.start(timedelta(hours=1).total_seconds() - 1, delay=seconds.to_nexthour(strict=True) - 1)
