...
from salt.exceptions import SaltCloudConfigError, SaltCloudExecutionFailure, SaltCloudExecutionTimeout, SaltCloudNotFound, SaltCloudSystemExit
from salt.utils.versions import Version
try:
    import profitbricks
    from profitbricks.client import LAN, NIC, Datacenter, FirewallRule, IPBlock, LoadBalancer, PBError, PBNotFoundError, ProfitBricksService, Server, Volume
