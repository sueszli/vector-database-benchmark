...
class YinYueTaiIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://v.yinyuetai.com/video/2322376', 'md5': '6e3abe28d38e3a54b591f9f040595ce0', 'info_dict': {'id': '2322376', 'ext': 'mp4', 'title': '少女时代_PARTY_Music Video Teaser', 'creator': '少女时代', 'duration': 25, 'thumbnail': 're:^https?://.*\\.jpg$'}}, {'url': 'http://v.yinyuetai.com/video/h5/2322376', 'only_matching': True}]
