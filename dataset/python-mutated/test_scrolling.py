...
base_props = dict(id='table', columns=[{'name': i, 'id': i} for i in df.columns], row_selectable='single', row_deletable=True, data=df.to_dict('records'), editable=True, fixed_rows={'headers': True, 'data': 1}, style_cell=dict(width=150), style_table=dict(width=500))
