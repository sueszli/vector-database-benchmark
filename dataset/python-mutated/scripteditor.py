...
from picard.config import BoolOption, Option, SettingConfigSection, TextOption, get_config
from picard.const import DEFAULT_COPY_TEXT, DEFAULT_NAMING_PRESET_ID, DEFAULT_SCRIPT_NAME, PICARD_URLS
from picard.file import File
from picard.metadata import Metadata
from picard.script import ScriptError, ScriptParser, get_file_naming_script, get_file_naming_script_presets
from picard.script.serializer import FileNamingScript, ScriptImportExportError
from picard.util import get_base_title, icontheme, iter_files_from_objects, unique_numbered_title, webbrowser2
...
from picard.ui.options.scripting import OptionsCheckError, ScriptCheckError
...
class ScriptEditorDialog(PicardDialog, SingletonDialog):
    ...
    options = [BoolOption('persist', 'script_editor_show_documentation', False), Option('setting', SCRIPTS_LIST_KEY, {}), TextOption('setting', SELECTED_SCRIPT_KEY, '')]
