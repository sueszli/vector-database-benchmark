...
class ContentDownloader(object):
    ...
    async def download_streaming(self, source_location: str, offset: int, length: int, **kwargs: Any) -> HttpResponse:
        ...
        pipeline_response: PipelineResponse = await self._call_recording_client._client._pipeline.run(request, stream=True, **kwargs)
    ...
    async def delete_recording(self, recording_location: str, **kwargs: Any) -> None:
        ...
        pipeline_response: PipelineResponse = await self._call_recording_client.await_client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
