...
p5 = figure(x_range=(1, 1000), width=800, height=300, toolbar_location=None, tools='', title='Viridis256 with linear_cmap, low/high = 200/800 = pink/grey')
cmap = linear_cmap('x', palette='Viridis256', low=200, high=800, low_color='pink', high_color='darkgrey')
