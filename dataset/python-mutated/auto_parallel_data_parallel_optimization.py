...
from paddle.distributed.auto_parallel.static.dist_attribute import OperatorDistAttr, TensorDistAttr
from paddle.distributed.auto_parallel.static.operators.common import is_data_parallel_reduce_op, is_data_parallel_scale_op
from paddle.distributed.auto_parallel.static.utils import find_higher_order_backward_op, get_var_numel, insert_dependencies_for_vars, is_forward_op, is_loss_grad_op, is_optimize_op, ring_id_to_process_group
from paddle.distributed.fleet.meta_optimizers.common import OP_ROLE_KEY, OpRole
from paddle.static import default_main_program
from paddle.utils import unique_name
from .pass_base import PassBase, PassType, register_pass
__rescale_grad_supported_opts__ = ['lars_momentum', 'sparse_momentum', 'dgc_momentum', 'momentum', 'merge_momentum']
