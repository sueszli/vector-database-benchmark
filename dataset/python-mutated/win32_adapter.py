...
class WNDCLASS(ctypes.Structure):
    _fields_ = [('style', ctypes.c_uint), ('lpfnWndProc', LPFN_WNDPROC), ('cbClsExtra', ctypes.c_int), ('cbWndExtra', ctypes.c_int), ('hInstance', HANDLE), ('hIcon', HANDLE), ('hCursor', HANDLE), ('hbrBackground', HANDLE), ('lpszMenuName', ctypes.c_char_p), ('lpszClassName', ctypes.c_char_p)]

class MENUITEMINFO(ctypes.Structure):
    _fields_ = [('cbSize', ctypes.c_uint), ('fMask', ctypes.c_uint), ('fType', ctypes.c_uint), ('fState', ctypes.c_uint), ('wID', ctypes.c_uint), ('hSubMenu', HANDLE), ('hbmpChecked', HANDLE), ('hbmpUnchecked', HANDLE), ('dwItemData', ctypes.c_void_p), ('dwTypeData', ctypes.c_char_p), ('cch', ctypes.c_uint), ('hbmpItem', HANDLE)]

class NOTIFYICONDATA(ctypes.Structure):
    _fields_ = [('cbSize', ctypes.c_uint), ('hWnd', HANDLE), ('uID', ctypes.c_uint), ('uFlags', ctypes.c_uint), ('uCallbackMessage', ctypes.c_uint), ('hIcon', HANDLE), ('szTip', ctypes.c_char * SZTIP_MAX_LENGTH), ('dwState', ctypes.c_uint), ('dwStateMask', ctypes.c_uint), ('szInfo', ctypes.c_char * 256), ('uTimeout', ctypes.c_uint), ('szInfoTitle', ctypes.c_char * 64), ('dwInfoFlags', ctypes.c_uint), ('guidItem', ctypes.c_char * 16)]
