...
__all__ = ['ClassDescription', 'ClassDescriptionArrayLike', 'ClassDescriptionBatch', 'ClassDescriptionLike', 'ClassDescriptionType']
...
class ClassDescription(ClassDescriptionExt):
    ...
    **Datatype**: The description of a semantic Class.
    ...
    """
    info: datatypes.AnnotationInfo = field(converter=ClassDescriptionExt.info__field_converter_override)
    keypoint_annotations: list[datatypes.AnnotationInfo] = field(converter=ClassDescriptionExt.keypoint_annotations__field_converter_override)
    keypoint_connections: list[datatypes.KeypointPair] = field(converter=ClassDescriptionExt.keypoint_connections__field_converter_override)
if TYPE_CHECKING:
    ClassDescriptionLike = Union[ClassDescription, datatypes.AnnotationInfoLike]
else:
    ClassDescriptionLike = Any
ClassDescriptionArrayLike = Union[ClassDescription, Sequence[ClassDescriptionLike]]
...
class ClassDescriptionType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            i = 10
            return i + 15
        pa.ExtensionType.__init__(self, pa.struct([pa.field('info', pa.struct([pa.field('id', pa.uint16(), nullable=False, metadata={}), pa.field('label', pa.utf8(), nullable=True, metadata={}), pa.field('color', pa.uint32(), nullable=True, metadata={})]), nullable=False, metadata={}), pa.field('keypoint_annotations', pa.list_(pa.field('item', pa.struct([pa.field('id', pa.uint16(), nullable=False, metadata={}), pa.field('label', pa.utf8(), nullable=True, metadata={}), pa.field('color', pa.uint32(), nullable=True, metadata={})]), nullable=False, metadata={})), nullable=False, metadata={}), pa.field('keypoint_connections', pa.list_(pa.field('item', pa.struct([pa.field('keypoint0', pa.uint16(), nullable=False, metadata={}), pa.field('keypoint1', pa.uint16(), nullable=False, metadata={})]), nullable=False, metadata={})), nullable=False, metadata={})]), self._TYPE_NAME)
