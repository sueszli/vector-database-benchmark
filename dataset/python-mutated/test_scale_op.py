...
class TestScaleOpScaleVariable(OpTest):
    ...
    def setUp(self):
        ...
        self.init_dtype_type()
        self.scale = -2.3
        self.inputs = {'X': np.random.random((10, 10)).astype(self.dtype), 'ScaleTensor': np.array([self.scale]).astype('float64')}
        self.attrs = {}
...
class TestScaleDoubleGradCheck(unittest.TestCase):
    ...
    def func(self, place):
        ...
        gradient_checker.double_grad_check_for_dygraph(self.scale_wrapper, [data], out, x_init=[data_arr], place=place)
...
class TestScaleTripleGradCheck(unittest.TestCase):
    ...
    def func(self, place):
        ...
        gradient_checker.triple_grad_check_for_dygraph(self.scale_wrapper, [data], out, x_init=[data_arr], place=place)
