...
AUGMENTATION_DEFAULT_OPERATIONS = [RandomHorizontalFlipConfig(), RandomRotateConfig()]
...
class ImageInputFeatureConfigMixin(BaseMarshmallowConfig):
    ...
    encoder: BaseEncoderConfig = EncoderDataclassField(MODEL_ECD, feature_type=IMAGE, default='stacked_cnn')
    augmentation: List[BaseAugmentationConfig] = AugmentationDataclassField(feature_type=IMAGE, default=False, default_augmentations=AUGMENTATION_DEFAULT_OPERATIONS, description='Augmentation operation configuration.')
