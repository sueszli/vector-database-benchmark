...
def _max_pool(name, tuple_fn, ndims, return_indices):
    ...
    def symbolic_fn(g, input, kernel_size, stride, padding, dilation, ceil_mode):
        ...
        if return_indices:
            ...
            return r
    return symbolic_fn
max_pool1d_with_indices = _onnx_symbolic('aten::max_pool1d_with_indices')(_max_pool('max_pool1d_with_indices', torch.nn.modules.utils._single, 1, return_indices=True))
max_pool2d_with_indices = _onnx_symbolic('aten::max_pool2d_with_indices')(_max_pool('max_pool2d_with_indices', torch.nn.modules.utils._pair, 2, return_indices=True))
max_pool3d_with_indices = _onnx_symbolic('aten::max_pool3d_with_indices')(_max_pool('max_pool3d_with_indices', torch.nn.modules.utils._triple, 3, return_indices=True))
