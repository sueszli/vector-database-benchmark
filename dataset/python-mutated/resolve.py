...
class DebugResolveCommand(InitCommand):
    ...
    options = [option('extras', 'E', 'Extras to activate for the dependency.', flag=False, multiple=True), option('python', None, 'Python version(s) to use for resolution.', flag=False), option('tree', None, 'Display the dependency tree.'), option('install', None, 'Show what would be installed for the current system.')]
