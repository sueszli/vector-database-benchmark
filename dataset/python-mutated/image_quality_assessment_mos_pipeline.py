...
from modelscope.models.cv.image_quality_assessment_mos import ImageQualityAssessmentMos
from modelscope.outputs import OutputKeys
from modelscope.pipelines.base import Input, Pipeline
from modelscope.pipelines.builder import PIPELINES
from modelscope.preprocessors import LoadImage
from modelscope.preprocessors.cv import ImageQualityAssessmentMosPreprocessor as MosPreprocessor
from modelscope.utils.constant import Tasks
from modelscope.utils.logger import get_logger
logger = get_logger()

@PIPELINES.register_module(Tasks.image_quality_assessment_mos, module_name=Pipelines.image_quality_assessment_mos)
class ImageQualityAssessmentMosPipeline(Pipeline):
    """ Image Quality Assessment MOS Pipeline which will return mean option score for the input image.
        ...
        >>> assessment_predictor = pipeline(Tasks.image_quality_assessment_mos,             model='damo/cv_resnet_image-quality-assessment-mos_youtubeUGC')
