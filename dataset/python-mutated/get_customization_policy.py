...
def main():
    ...
    response = client.customization_policies.get(region_id='myResourceGroup', pc_name='myPrivateCloud', customization_policy_name='Linux1')
    print(response)
