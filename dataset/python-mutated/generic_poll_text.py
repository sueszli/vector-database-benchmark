...
class GenPollText(base.ThreadPoolText):
    ...
    defaults = [('func', None, 'Poll Function')]
...
class GenPollUrl(base.ThreadPoolText):
    ...
    defaults: list[tuple[str, Any, str]] = [('url', None, 'Url'), ('data', None, 'Post Data'), ('parse', None, 'Parse Function'), ('json', True, 'Is Json?'), ('user_agent', 'Qtile', 'Set the user agent'), ('headers', {}, 'Extra Headers'), ('xml', False, 'Is XML?')]
...
class GenPollCommand(base.ThreadPoolText):
    ...
    defaults = [('update_interval', 60, 'update time in seconds'), ('cmd', None, 'command line as a string or list of arguments to execute'), ('shell', False, 'run command through shell to enable piping and shell expansion')]
