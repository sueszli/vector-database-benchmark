...
from esphome.const import CONF_INPUT, CONF_MODE, CONF_NUMBER, CONF_OPEN_DRAIN, CONF_OUTPUT, CONF_PULLDOWN, CONF_PULLUP, CONF_IGNORE_STRAPPING_WARNING
...
gpio_output_pin_schema = _schema_creator({CONF_OUTPUT: True})
gpio_input_pin_schema = _schema_creator({CONF_INPUT: True})
gpio_input_pullup_pin_schema = _schema_creator({CONF_INPUT: True, CONF_PULLUP: True})
internal_gpio_output_pin_schema = _schema_creator({CONF_OUTPUT: True}, internal=True)
internal_gpio_output_pin_number = _internal_number_creator({CONF_OUTPUT: True})
internal_gpio_input_pin_schema = _schema_creator({CONF_INPUT: True}, internal=True)
internal_gpio_input_pin_number = _internal_number_creator({CONF_INPUT: True})
internal_gpio_input_pullup_pin_schema = _schema_creator({CONF_INPUT: True, CONF_PULLUP: True}, internal=True)
internal_gpio_input_pullup_pin_number = _internal_number_creator({CONF_INPUT: True, CONF_PULLUP: True})
