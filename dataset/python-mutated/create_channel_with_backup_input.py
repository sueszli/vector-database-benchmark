"""Google Cloud Live Stream sample for creating a channel with a backup input.
    ...
    "streaming" operation.
Example usage:
    python create_channel_with_backup_input.py --project_id <project-id>         --location <location> --channel_id <channel-id>         --primary_input_id <primary-input-id>         --backup_input_id <backup-input-id> --output_uri <uri>
"""
import argparse
...
def create_channel_with_backup_input(project_id: str, location: str, channel_id: str, primary_input_id: str, backup_input_id: str, output_uri: str) -> live_stream_v1.types.Channel:
    if False:
        while True:
            i = 10
    ...
    primary_input = f'projects/{project_id}/locations/{location}/inputs/{primary_input_id}'
    backup_input = f'projects/{project_id}/locations/{location}/inputs/{backup_input_id}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--primary_input_id', help='The user-defined primary input ID.', required=True)
    parser.add_argument('--backup_input_id', help='The user-defined backup input ID.', required=True)
    ...
    create_channel_with_backup_input(args.project_id, args.location, args.channel_id, args.primary_input_id, args.backup_input_id, args.output_uri)