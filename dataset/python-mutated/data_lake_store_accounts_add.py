...
def main():
    ...
    response = client.data_lake_store_accounts.add(resource_group_name='contosorg', account_name='contosoadla', data_lake_store_account_name='test_adls_account')
    print(response)
