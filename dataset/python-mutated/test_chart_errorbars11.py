...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def setUp(self):
        ...
        self.ignore_elements = {'xl/charts/chart1.xml': ['<c:ptCount', '<c:pt', '<c:v', '</c:pt>']}
    ...
    def test_create_file(self):
        ...
        chart.add_series({'categories': '=Sheet1!$A$1:$A$5', 'values': '=Sheet1!$B$1:$B$5', 'y_error_bars': {'type': 'custom', 'plus_values': '=Sheet1!$A$1', 'minus_values': '=Sheet1!$B$1:$B$3'}})
