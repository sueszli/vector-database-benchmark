...
parser.add_argument('--allow-opengl-toggle', action='store_true', help='Allow on-the-fly change of OpenGL setting. This may cause unwanted side effects.\n    ')
parser.add_argument('--iterations', default=float('inf'), type=float, help='Number of iterations to run before exiting')
...
splitter.show()
interactor = ptree.Interactor(parent=params, nest=False, runOptions=ptree.RunOptions.ON_CHANGED)
