...
from torch.distributed._tensor import distribute_tensor, init_device_mesh, Replicate, Shard, zeros
...
ONE_D_TO_ONE_D_PLACEMENTS = [([Replicate()], [Shard(0)]), ([Shard(0)], [Replicate()])]
TWO_D_PLACEMENTS = [[Replicate(), Replicate()], [Replicate(), Shard(0)], [Shard(0), Replicate()], [Shard(0), Shard(0)]]
