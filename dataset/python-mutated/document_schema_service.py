...
__protobuf__ = proto.module(package='google.cloud.contentwarehouse.v1', manifest={'CreateDocumentSchemaRequest', 'GetDocumentSchemaRequest', 'UpdateDocumentSchemaRequest', 'DeleteDocumentSchemaRequest', 'ListDocumentSchemasRequest', 'ListDocumentSchemasResponse'})
...
class CreateDocumentSchemaRequest(proto.Message):
    ...
    document_schema: gcc_document_schema.DocumentSchema = proto.Field(proto.MESSAGE, number=2, message=gcc_document_schema.DocumentSchema)
...
class ListDocumentSchemasResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    document_schemas: MutableSequence[gcc_document_schema.DocumentSchema] = proto.RepeatedField(proto.MESSAGE, number=1, message=gcc_document_schema.DocumentSchema)
