...
class FeedbackUpdatesHandler(base.BaseHandler[FeedbackUpdatesHandlerNormalizedPayloadDict, Dict[str, str]]):
    """Provides data for the user's feedback updates page."""
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {'POST': {'paginated_threads_list': {'schema': {'type': 'list', 'items': {'type': 'list', 'items': {'type': 'basestring'}}}, 'default_value': []}}}
...
class FeedbackThreadHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    GET_HANDLER_ERROR_RETURN_TYPE = feconf.HANDLER_TYPE_JSON
    URL_PATH_ARGS_SCHEMAS = {'thread_id': {'schema': {'type': 'basestring', 'validators': [{'id': 'is_regex_matched', 'regex_pattern': constants.VALID_THREAD_ID_REGEX}]}}}
