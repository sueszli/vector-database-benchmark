...
os.environ['PATH'] = '/c/Users/build/megengine_dev_tools/7za' + os.environ['PATH']
config = {}
config['cu112'] = {'version': '11.2.0', 'driver': '460.89', 'cudnn_name': 'cudnn-8.2.1.32-hae0fe6e_0.tar.bz2'}
config['cu118'] = {'version': '11.8.0', 'driver': '522.06', 'cudnn_name': ''}
config['cu114'] = {'version': '11.4.0', 'driver': '471.11', 'cudnn_name': 'cudnn-8.2.1.32-hae0fe6e_0.tar.bz2'}
config['cu110'] = {'version': '11.1.0', 'driver': '456.43', 'cudnn_name': 'cudnn-8.0.5.39-h36d860d_1.tar.bz2'}
config['cu101'] = {'version': '10.1.105', 'driver': '418.96', 'cudnn_name': 'cudnn-7.6.5.32-h36d860d_1.tar.bz2'}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sdk_name', type=str, default='cu112', help='cudatoolkit version')
