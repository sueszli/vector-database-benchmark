...
class ExecutePatchJobRequest(proto.Message):
    ...
    instance_filter: 'PatchInstanceFilter' = proto.Field(proto.MESSAGE, number=7, message='PatchInstanceFilter')
    patch_config: 'PatchConfig' = proto.Field(proto.MESSAGE, number=4, message='PatchConfig')
    duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=5, message=duration_pb2.Duration)
    dry_run: bool = proto.Field(proto.BOOL, number=6)
    display_name: str = proto.Field(proto.STRING, number=8)
    rollout: 'PatchRollout' = proto.Field(proto.MESSAGE, number=9, message='PatchRollout')
...
class ListPatchJobInstanceDetailsRequest(proto.Message):
    """Request to list details for all instances that are part of a
    patch job.
...
class ListPatchJobInstanceDetailsResponse(proto.Message):
    """A response message for listing the instances details for a
    patch job.
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    patch_job_instance_details: MutableSequence['PatchJobInstanceDetails'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PatchJobInstanceDetails')
...
class PatchJobInstanceDetails(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    instance_system_id: str = proto.Field(proto.STRING, number=2)
    state: 'Instance.PatchState' = proto.Field(proto.ENUM, number=3, enum='Instance.PatchState')
    failure_reason: str = proto.Field(proto.STRING, number=4)
    attempt_count: int = proto.Field(proto.INT64, number=5)
...
class ListPatchJobsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    patch_jobs: MutableSequence['PatchJob'] = proto.RepeatedField(proto.MESSAGE, number=1, message='PatchJob')
    next_page_token: str = proto.Field(proto.STRING, number=2)

class PatchJob(proto.Message):
    """A high level representation of a patch job that is either in
    ...
    class InstanceDetailsSummary(proto.Message):
        ...
        """
        pending_instance_count: int = proto.Field(proto.INT64, number=1)
        inactive_instance_count: int = proto.Field(proto.INT64, number=2)
        notified_instance_count: int = proto.Field(proto.INT64, number=3)
        started_instance_count: int = proto.Field(proto.INT64, number=4)
        downloading_patches_instance_count: int = proto.Field(proto.INT64, number=5)
        applying_patches_instance_count: int = proto.Field(proto.INT64, number=6)
        rebooting_instance_count: int = proto.Field(proto.INT64, number=7)
        succeeded_instance_count: int = proto.Field(proto.INT64, number=8)
        succeeded_reboot_required_instance_count: int = proto.Field(proto.INT64, number=9)
        failed_instance_count: int = proto.Field(proto.INT64, number=10)
        acked_instance_count: int = proto.Field(proto.INT64, number=11)
        timed_out_instance_count: int = proto.Field(proto.INT64, number=12)
        pre_patch_step_instance_count: int = proto.Field(proto.INT64, number=13)
        post_patch_step_instance_count: int = proto.Field(proto.INT64, number=14)
        no_agent_detected_instance_count: int = proto.Field(proto.INT64, number=15)
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=14)
    description: str = proto.Field(proto.STRING, number=2)
    ...
    instance_filter: 'PatchInstanceFilter' = proto.Field(proto.MESSAGE, number=13, message='PatchInstanceFilter')
    patch_config: 'PatchConfig' = proto.Field(proto.MESSAGE, number=7, message='PatchConfig')
    duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=8, message=duration_pb2.Duration)
    instance_details_summary: InstanceDetailsSummary = proto.Field(proto.MESSAGE, number=9, message=InstanceDetailsSummary)
    dry_run: bool = proto.Field(proto.BOOL, number=10)
    error_message: str = proto.Field(proto.STRING, number=11)
    percent_complete: float = proto.Field(proto.DOUBLE, number=12)
    patch_deployment: str = proto.Field(proto.STRING, number=15)
    rollout: 'PatchRollout' = proto.Field(proto.MESSAGE, number=16, message='PatchRollout')

class PatchConfig(proto.Message):
    """Patch configuration specifications. Contains details on how
    ...
    class RebootConfig(proto.Enum):
        ...
        ALWAYS = 2
        NEVER = 3
    reboot_config: RebootConfig = proto.Field(proto.ENUM, number=1, enum=RebootConfig)
    apt: 'AptSettings' = proto.Field(proto.MESSAGE, number=3, message='AptSettings')
    yum: 'YumSettings' = proto.Field(proto.MESSAGE, number=4, message='YumSettings')
    goo: 'GooSettings' = proto.Field(proto.MESSAGE, number=5, message='GooSettings')
    zypper: 'ZypperSettings' = proto.Field(proto.MESSAGE, number=6, message='ZypperSettings')
    windows_update: 'WindowsUpdateSettings' = proto.Field(proto.MESSAGE, number=7, message='WindowsUpdateSettings')
    pre_step: 'ExecStep' = proto.Field(proto.MESSAGE, number=8, message='ExecStep')
    post_step: 'ExecStep' = proto.Field(proto.MESSAGE, number=9, message='ExecStep')
    mig_instances_allowed: bool = proto.Field(proto.BOOL, number=10)
...
class AptSettings(proto.Message):
    ...
    excludes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    exclusive_packages: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)

class YumSettings(proto.Message):
    """Yum patching is performed by executing ``yum update``. Additional
    ...
    Attributes:
        ...
        exclusive_packages (MutableSequence[str]):
            ...
            fields.
    """
    security: bool = proto.Field(proto.BOOL, number=1)
    minimal: bool = proto.Field(proto.BOOL, number=2)
    excludes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    exclusive_packages: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
...
class ZypperSettings(proto.Message):
    ...
    """
    with_optional: bool = proto.Field(proto.BOOL, number=1)
    with_update: bool = proto.Field(proto.BOOL, number=2)
    categories: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    severities: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    excludes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    exclusive_patches: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
...
class WindowsUpdateSettings(proto.Message):
    ...
    class Classification(proto.Enum):
        ...
        UPDATE_ROLLUP = 8
        UPDATE = 9
    classifications: MutableSequence[Classification] = proto.RepeatedField(proto.ENUM, number=1, enum=Classification)
    excludes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    exclusive_patches: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class ExecStep(proto.Message):
    ...
    """
    linux_exec_step_config: 'ExecStepConfig' = proto.Field(proto.MESSAGE, number=1, message='ExecStepConfig')
    windows_exec_step_config: 'ExecStepConfig' = proto.Field(proto.MESSAGE, number=2, message='ExecStepConfig')
...
class ExecStepConfig(proto.Message):
    ...
    class Interpreter(proto.Enum):
        ...
        SHELL = 1
        POWERSHELL = 2
    local_path: str = proto.Field(proto.STRING, number=1, oneof='executable')
    gcs_object: 'GcsObject' = proto.Field(proto.MESSAGE, number=2, oneof='executable', message='GcsObject')
    allowed_success_codes: MutableSequence[int] = proto.RepeatedField(proto.INT32, number=3)
    interpreter: Interpreter = proto.Field(proto.ENUM, number=4, enum=Interpreter)
...
class GcsObject(proto.Message):
    ...
    generation_number: int = proto.Field(proto.INT64, number=3)
...
class PatchInstanceFilter(proto.Message):
    ...
    all_: bool = proto.Field(proto.BOOL, number=1)
    group_labels: MutableSequence[GroupLabel] = proto.RepeatedField(proto.MESSAGE, number=2, message=GroupLabel)
    zones: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
    instances: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    instance_name_prefixes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class PatchRollout(proto.Message):
    ...
    class Mode(proto.Enum):
        ...
        ZONE_BY_ZONE = 1
        CONCURRENT_ZONES = 2
    mode: Mode = proto.Field(proto.ENUM, number=1, enum=Mode)
    disruption_budget: osconfig_common.FixedOrPercent = proto.Field(proto.MESSAGE, number=2, message=osconfig_common.FixedOrPercent)
