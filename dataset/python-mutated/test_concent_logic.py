...
@mock.patch('golem.task.tasksession.TaskSession._check_task_header', return_value=True)
...
@mock.patch('golem.task.tasksession.TaskSession.verify_owners', return_value=True)
...
@mock.patch('golem.ranking.manager.database_manager.get_provider_efficiency', mock.Mock(return_value=0.0))
@mock.patch('golem.ranking.manager.database_manager.get_provider_efficacy', mock.Mock(return_value=_fake_get_efficacy()))
@mock.patch('golem.task.tasksession.TaskSession.send', side_effect=lambda msg: msg._fake_sign())
