...
rasterio = fou.lazy_import('rasterio', callback=lambda : fou.ensure_package('rasterio'))
...
class GeoTIFFDatasetImporter(foud.LabeledImageDatasetImporter, foud.ImportPathsMixin):
