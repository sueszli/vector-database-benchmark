...
class Migration(migrations.Migration):
    dependencies = [('features', '0027_merge_20210215_1059')]
    operations = [migrations.RunPython(create_or_update_feature_state_values_for_feature_segments, reverse_code=reverse)]