...
from samcli.lib.iac.plugins_interfaces import Asset, DictSection, DictSectionItem, IaCPluginInterface, ImageAsset, LookupPath, S3Asset, SamCliContext, SamCliProject, Stack
...
from samcli.lib.utils.resources import AWS_LAMBDA_FUNCTION, AWS_LAMBDA_LAYERVERSION, AWS_SERVERLESS_FUNCTION, AWS_SERVERLESS_LAYERVERSION, METADATA_WITH_LOCAL_PATHS, NESTED_STACKS_RESOURCES, RESOURCES_WITH_IMAGE_COMPONENT, RESOURCES_WITH_LOCAL_PATHS
...
BASE_DIR_RESOURCES = [AWS_SERVERLESS_FUNCTION, AWS_LAMBDA_FUNCTION, AWS_SERVERLESS_LAYERVERSION, AWS_LAMBDA_LAYERVERSION]
