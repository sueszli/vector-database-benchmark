...
from ray.util.scheduling_strategies import NodeAffinitySchedulingStrategy, PlacementGroupSchedulingStrategy, NodeLabelSchedulingStrategy
...
remote_args_error_string = f"""The @ray.remote decorator must be applied either with no arguments and no parentheses, for example '@ray.remote', or it must be applied using some of the arguments in the list {list(valid_options.keys())}, for example '@ray.remote(num_returns=2, resources={{"CustomResource": 1}})'."""
