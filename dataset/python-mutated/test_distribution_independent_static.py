...
@param.param_cls((param.TEST_CASE_NAME, 'base', 'reinterpreted_batch_rank', 'alpha', 'beta'), [('base_beta', paddle.distribution.Beta, 1, np.random.rand(1, 2), np.random.rand(1, 2))])
