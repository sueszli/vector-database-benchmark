...
from ..utils import parse_duration, int_or_none, qualities, determine_ext

class SunPornoIE(InfoExtractor):
    _VALID_URL = 'https?://(?:(?:www\\.)?sunporno\\.com/videos|embeds\\.sunporno\\.com/embed)/(?P<id>\\d+)'
    _TESTS = [{'url': 'http://www.sunporno.com/videos/807778/', 'md5': '507887e29033502f29dba69affeebfc9', 'info_dict': {'id': '807778', 'ext': 'mp4', 'title': 'md5:0a400058e8105d39e35c35e7c5184164', 'description': 'md5:a31241990e1bd3a64e72ae99afb325fb', 'thumbnail': 're:^https?://.*\\.jpg$', 'duration': 302, 'age_limit': 18}}, {'url': 'http://embeds.sunporno.com/embed/807778', 'only_matching': True}]
