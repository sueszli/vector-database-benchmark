...
from samcli.lib.sync.flows.layer_sync_flow import LayerSyncFlow, FunctionLayerReferenceSync, LayerSyncFlowSkipBuildDirectory, LayerSyncFlowSkipBuildZipFile, get_latest_layer_version
from samcli.lib.sync.sync_flow import SyncFlow, ApiCallTypes
from samcli.lib.utils.hash import str_checksum

@parameterized_class('build_artifacts', [(None,), (Mock(),)])
