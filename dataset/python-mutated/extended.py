...
class ExtendedBinomial(Binomial):
    ...
    total_count]``.
    """
    arg_constraints = {'total_count': constraints.integer, 'probs': constraints.unit_interval, 'logits': constraints.real}
...
class ExtendedBetaBinomial(BetaBinomial):
    ...
    ``[0, total_count]``.
    """
    arg_constraints = {'concentration1': constraints.positive, 'concentration0': constraints.positive, 'total_count': constraints.integer}
    support = constraints.integer
