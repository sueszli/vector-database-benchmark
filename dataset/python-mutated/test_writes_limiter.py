...
from sentry.sentry_metrics.configuration import PERFORMANCE_PG_NAMESPACE, RELEASE_HEALTH_PG_NAMESPACE, UseCaseKey
...
WRITES_LIMITERS = {RELEASE_HEALTH_PG_NAMESPACE: WritesLimiter(RELEASE_HEALTH_PG_NAMESPACE, **{}), PERFORMANCE_PG_NAMESPACE: WritesLimiter(PERFORMANCE_PG_NAMESPACE, **{})}

def get_writes_limiter(namespace: str):
    if False:
        return 10
    return WRITES_LIMITERS[namespace]
MOCK_METRIC_PATH_MAPPING = {UseCaseID.TRANSACTIONS: UseCaseKey.PERFORMANCE, UseCaseID.SPANS: UseCaseKey.PERFORMANCE, UseCaseID.ESCALATING_ISSUES: UseCaseKey.PERFORMANCE, UseCaseID.CUSTOM: UseCaseKey.PERFORMANCE}
MOCK_REVERSE_METRIC_PATH_MAPPING = {UseCaseKey.RELEASE_HEALTH: UseCaseID.SESSIONS, UseCaseKey.PERFORMANCE: UseCaseID.TRANSACTIONS}
MOCK_USE_CASE_ID_WRITES_LIMIT_QUOTA_OPTIONS = {UseCaseID.TRANSACTIONS: 'sentry-metrics.writes-limiter.limits.transactions', UseCaseID.SPANS: 'sentry-metrics.writes-limiter.limits.uc1', UseCaseID.ESCALATING_ISSUES: 'sentry-metrics.writes-limiter.limits.uc2'}
