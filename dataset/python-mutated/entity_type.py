...
class EntityType(proto.Message):
    ...
    class Entity(proto.Message):
        ...
        synonyms: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    name: str = proto.Field(proto.STRING, number=1)
    display_name: str = proto.Field(proto.STRING, number=2)
    kind: Kind = proto.Field(proto.ENUM, number=3, enum=Kind)
    auto_expansion_mode: AutoExpansionMode = proto.Field(proto.ENUM, number=4, enum=AutoExpansionMode)
    entities: MutableSequence[Entity] = proto.RepeatedField(proto.MESSAGE, number=6, message=Entity)
    enable_fuzzy_extraction: bool = proto.Field(proto.BOOL, number=7)
...
class ListEntityTypesRequest(proto.Message):
    ...
    language_code: str = proto.Field(proto.STRING, number=2)
...
class ListEntityTypesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    entity_types: MutableSequence['EntityType'] = proto.RepeatedField(proto.MESSAGE, number=1, message='EntityType')
...
class CreateEntityTypeRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    entity_type: 'EntityType' = proto.Field(proto.MESSAGE, number=2, message='EntityType')
...
class UpdateEntityTypeRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            get updated.
    """
    entity_type: 'EntityType' = proto.Field(proto.MESSAGE, number=1, message='EntityType')
    language_code: str = proto.Field(proto.STRING, number=2)
...
class BatchUpdateEntityTypesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    entity_type_batch_uri: str = proto.Field(proto.STRING, number=2, oneof='entity_type_batch')
    entity_type_batch_inline: 'EntityTypeBatch' = proto.Field(proto.MESSAGE, number=3, oneof='entity_type_batch', message='EntityTypeBatch')
...
class BatchDeleteEntityTypesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    entity_type_names: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
...
class BatchCreateEntitiesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    entities: MutableSequence['EntityType.Entity'] = proto.RepeatedField(proto.MESSAGE, number=2, message='EntityType.Entity')
    language_code: str = proto.Field(proto.STRING, number=3)
...
class BatchDeleteEntitiesRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    entity_values: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    language_code: str = proto.Field(proto.STRING, number=3)

class EntityTypeBatch(proto.Message):
    """This message is a wrapper around a collection of entity
    types.
