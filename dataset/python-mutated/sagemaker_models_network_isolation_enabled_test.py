...
class Test_sagemaker_models_network_isolation_enabled:
    ...
    def test_no_models(self):
        ...
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_network_isolation_enabled.sagemaker_models_network_isolation_enabled import sagemaker_models_network_isolation_enabled
    ...
    def test_instance_network_isolation_enabled(self):
        ...
        sagemaker_client = mock.MagicMock
        sagemaker_client.sagemaker_models = []
        sagemaker_client.sagemaker_models.append(Model(name=test_notebook_instance, arn=notebook_instance_arn, region=AWS_REGION, network_isolation=True))
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_network_isolation_enabled.sagemaker_models_network_isolation_enabled import sagemaker_models_network_isolation_enabled
            check = sagemaker_models_network_isolation_enabled()
            result = check.execute()
    ...
    def test_instance_network_isolation_disabled(self):
        ...
        sagemaker_client = mock.MagicMock
        sagemaker_client.sagemaker_models = []
        sagemaker_client.sagemaker_models.append(Model(name=test_notebook_instance, arn=notebook_instance_arn, region=AWS_REGION, network_isolation=False))
        with mock.patch('prowler.providers.aws.services.sagemaker.sagemaker_service.SageMaker', sagemaker_client):
            from prowler.providers.aws.services.sagemaker.sagemaker_models_network_isolation_enabled.sagemaker_models_network_isolation_enabled import sagemaker_models_network_isolation_enabled
            check = sagemaker_models_network_isolation_enabled()
            result = check.execute()
