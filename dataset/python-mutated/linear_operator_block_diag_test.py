...
class SquareLinearOperatorBlockDiagTest(linear_operator_test_util.SquareLinearOperatorDerivedClassTest):
...
@test_util.run_all_in_graph_and_eager_modes
class NonSquareLinearOperatorBlockDiagTest(linear_operator_test_util.NonSquareLinearOperatorDerivedClassTest):
    """Most tests done in the base class LinearOperatorDerivedClassTest."""
