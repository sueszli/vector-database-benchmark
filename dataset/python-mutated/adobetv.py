...
from ..utils import float_or_none, int_or_none, ISO639Utils, join_nonempty, OnDemandPagedList, parse_duration, str_or_none, str_to_int, unified_strdate
...
class AdobeTVEmbedIE(AdobeTVBaseIE):
    ...
    _TEST = {'url': 'https://tv.adobe.com/embed/22/4153', 'md5': 'c8c0461bf04d54574fc2b4d07ac6783a', 'info_dict': {'id': '4153', 'ext': 'flv', 'title': 'Creating Graphics Optimized for BlackBerry', 'description': 'md5:eac6e8dced38bdaae51cd94447927459', 'thumbnail': 're:https?://.*\\.jpg$', 'upload_date': '20091109', 'duration': 377, 'view_count': int}}
...
class AdobeTVIE(AdobeTVBaseIE):
    ...
    _TEST = {'url': 'http://tv.adobe.com/watch/the-complete-picture-with-julieanne-kost/quick-tip-how-to-draw-a-circle-around-an-object-in-photoshop/', 'md5': '9bc5727bcdd55251f35ad311ca74fa1e', 'info_dict': {'id': '10981', 'ext': 'mp4', 'title': 'Quick Tip - How to Draw a Circle Around an Object in Photoshop', 'description': 'md5:99ec318dc909d7ba2a1f2b038f7d2311', 'thumbnail': 're:https?://.*\\.jpg$', 'upload_date': '20110914', 'duration': 60, 'view_count': int}}
...
class AdobeTVShowIE(AdobeTVPlaylistBaseIE):
    ...
    _TEST = {'url': 'http://tv.adobe.com/show/the-complete-picture-with-julieanne-kost', 'info_dict': {'id': '36', 'title': 'The Complete Picture with Julieanne Kost', 'description': 'md5:fa50867102dcd1aa0ddf2ab039311b27'}, 'playlist_mincount': 136}
    _RESOURCE = 'episode'
...
class AdobeTVChannelIE(AdobeTVPlaylistBaseIE):
    ...
    _TEST = {'url': 'http://tv.adobe.com/channel/development', 'info_dict': {'id': 'development'}, 'playlist_mincount': 96}
    _RESOURCE = 'show'
...
class AdobeTVVideoIE(AdobeTVBaseIE):
    ...
    _EMBED_REGEX = ['<iframe[^>]+src=[\\\'"](?P<url>(?:https?:)?//video\\.tv\\.adobe\\.com/v/\\d+[^"]+)[\\\'"]']
    _TEST = {'url': 'https://video.tv.adobe.com/v/2456/', 'md5': '43662b577c018ad707a63766462b1e87', 'info_dict': {'id': '2456', 'ext': 'mp4', 'title': 'New experience with Acrobat DC', 'description': 'New experience with Acrobat DC', 'duration': 248.667}}
