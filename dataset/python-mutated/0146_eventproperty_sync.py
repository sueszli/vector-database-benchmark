...
ATTRIBUTES = ('event_names', 'event_names_with_usage', 'event_properties', 'event_properties_with_usage', 'event_properties_numerical')
...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0145_eventdefinition_propertydefinition')]
    operations = [migrations.RunPython(sync_team_event_names_and_properties, migrations.RunPython.noop, elidable=True)]