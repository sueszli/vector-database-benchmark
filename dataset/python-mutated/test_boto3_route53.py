...
LIST_RESOURCE_RECORD_SETS_RETURN = {'IsTruncated': True, 'MaxItems': '100', 'NextRecordName': 'blog3.saltstack.furniture.', 'NextRecordType': 'CNAME', 'ResourceRecordSets': [{'Name': 'blog.saltstack.furniture.', 'ResourceRecords': [{'Value': '127.0.0.1'}], 'TTL': 60, 'Type': 'A'}, {'Name': 'blog2.saltstack.furniture.', 'ResourceRecords': [{'Value': '127.0.0.1'}], 'TTL': 60, 'Type': 'A'}]}
