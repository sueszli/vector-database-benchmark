...
class Migration(migrations.Migration):
    dependencies = [('posthog', '0259_backfill_team_recording_domains')]
    operations = [migrations.AddField(model_name='personalapikey', name='secure_value', field=models.CharField(editable=False, max_length=300, null=True, unique=True)), migrations.AlterField(model_name='personalapikey', name='value', field=models.CharField(blank=True, editable=False, max_length=50, null=True, unique=True)), migrations.RunPython(hash_all_keys, migrations.RunPython.noop, elidable=True)]