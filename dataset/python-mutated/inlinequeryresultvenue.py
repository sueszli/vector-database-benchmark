...
class InlineQueryResultVenue(InlineQueryResult):
    ...
    """
    __slots__ = ('longitude', 'reply_markup', 'google_place_type', 'thumbnail_width', 'thumbnail_height', 'title', 'address', 'foursquare_id', 'foursquare_type', 'google_place_id', 'input_message_content', 'latitude', 'thumbnail_url')

    def __init__(self, id: str, latitude: float, longitude: float, title: str, address: str, foursquare_id: Optional[str]=None, foursquare_type: Optional[str]=None, reply_markup: Optional[InlineKeyboardMarkup]=None, input_message_content: Optional['InputMessageContent']=None, google_place_id: Optional[str]=None, google_place_type: Optional[str]=None, thumbnail_url: Optional[str]=None, thumbnail_width: Optional[int]=None, thumbnail_height: Optional[int]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            i = 10
            return i + 15
