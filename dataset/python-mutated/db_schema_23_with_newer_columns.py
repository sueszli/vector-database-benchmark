...
ALL_TABLES = [TABLE_STATES, TABLE_STATES_META, TABLE_EVENTS, TABLE_EVENT_TYPES, TABLE_RECORDER_RUNS, TABLE_SCHEMA_CHANGES, TABLE_STATISTICS, TABLE_STATISTICS_META, TABLE_STATISTICS_RUNS, TABLE_STATISTICS_SHORT_TERM]
...
class States(Base):
    ...
    __table_args__ = (Index('ix_states_entity_id_last_updated', 'entity_id', 'last_updated'), Index(STATES_CONTEXT_ID_BIN_INDEX, 'context_id_bin', mysql_length=CONTEXT_ID_BIN_MAX_LENGTH, mariadb_length=CONTEXT_ID_BIN_MAX_LENGTH), {'mysql_default_charset': 'utf8mb4', 'mysql_collate': 'utf8mb4_unicode_ci'})
    ...
    last_updated_ts = Column(TIMESTAMP_TYPE, default=time.time)
