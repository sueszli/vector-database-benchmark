...
from scripts.node_integration_tests.playbooks.test_config_base import NodeId, make_node_config_from_env
if typing.TYPE_CHECKING:
    from scripts.node_integration_tests.playbooks.test_config_base import NodeConfig
