...
class DashboardCollaboratorSerializer(serializers.ModelSerializer, UserPermissionsSerializerMixin):
    ...
    class Meta:
        ...
        fields = ['id', 'dashboard_id', 'user', 'level', 'added_at', 'updated_at', 'user_uuid']
...
class DashboardCollaboratorViewSet(StructuredViewSetMixin, mixins.ListModelMixin, mixins.CreateModelMixin, mixins.DestroyModelMixin, viewsets.GenericViewSet):
