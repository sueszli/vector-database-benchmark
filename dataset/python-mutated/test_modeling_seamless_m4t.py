...
if is_torch_available():
    import torch
    from transformers import SeamlessM4TForSpeechToSpeech, SeamlessM4TForSpeechToText, SeamlessM4TForTextToSpeech, SeamlessM4TForTextToText, SeamlessM4TModel
    from transformers.models.seamless_m4t.modeling_seamless_m4t import SEAMLESS_M4T_PRETRAINED_MODEL_ARCHIVE_LIST
...
class SeamlessM4TModelWithSpeechInputTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (SeamlessM4TModel, SeamlessM4TForSpeechToSpeech, SeamlessM4TForSpeechToText) if is_torch_available() else ()
...
class SeamlessM4TModelWithTextInputTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    test_headmasking = False
    test_torchscript = False
    all_model_classes = (SeamlessM4TModel, SeamlessM4TForTextToSpeech, SeamlessM4TForTextToText) if is_torch_available() else ()
