...
valid_binary_operators = [_ast.Add, _ast.Sub, _ast.Mult, ast.MatMult, _ast.Pow, _ast.Div, _ast.FloorDiv, _ast.BitAnd, _ast.BitOr, _ast.BitXor, _ast.Mod, _ast.RShift, _ast.LShift]
valid_compare_operators = [_ast.Lt, _ast.LtE, _ast.Gt, _ast.GtE, _ast.Eq, _ast.NotEq, _ast.IsNot, _ast.Is, _ast.In]
...
opmap = {_ast.Add: '+', _ast.Sub: '-', _ast.Mult: '*', _ast.Pow: '**', _ast.Div: '/', _ast.FloorDiv: '//', _ast.BitAnd: '&', _ast.BitOr: '|', _ast.BitXor: '^', _ast.Mod: '%'}
...
class ExpressionString(ast.NodeVisitor):
    ...
    def visit_BinOp(self, node):
        ...
        try:
            ...
            self.indent -= 1
    op_translate = {ast.Lt: '<', ast.LtE: '<=', ast.Gt: '>', ast.GtE: '>=', ast.Eq: '==', ast.NotEq: '!=', ast.IsNot: 'is not', ast.Is: 'is', ast.In: 'in'}
