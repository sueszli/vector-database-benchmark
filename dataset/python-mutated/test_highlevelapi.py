...
class TestHighLevelApi(unittest.TestCase):
    ...
    def test_object_prediction(self):
        ...
        object_annotation1 = ObjectPrediction(bbox=bbox, category_id=category_id, category_name=category_name, shift_amount=shift_amount, full_shape=full_shape)
        object_annotation2 = ObjectPrediction.from_coco_annotation_dict(annotation_dict={'bbox': coco_bbox, 'category_id': category_id, 'segmentation': []}, category_name=category_name, full_shape=full_shape, shift_amount=shift_amount)
        object_annotation3 = ObjectPrediction.from_coco_bbox(bbox=coco_bbox, category_id=category_id, category_name=category_name, full_shape=full_shape, shift_amount=shift_amount)
