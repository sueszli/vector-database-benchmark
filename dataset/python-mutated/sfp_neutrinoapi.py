...
class sfp_neutrinoapi(SpiderFootPlugin):
    meta = {'name': 'NeutrinoAPI', 'summary': 'Search NeutrinoAPI for phone location information, IP address information, and host reputation.', 'flags': ['apikey'], 'useCases': ['Footprint', 'Investigate', 'Passive'], 'categories': ['Reputation Systems'], 'dataSource': {'website': 'https://www.neutrinoapi.com/', 'model': 'FREE_AUTH_LIMITED', 'references': ['https://www.neutrinoapi.com/api/api-basics/', 'https://www.neutrinoapi.com/api/phone-validate/', 'https://www.neutrinoapi.com/api/ip-info/', 'https://www.neutrinoapi.com/api/ip-blocklist/', 'https://www.neutrinoapi.com/api/host-reputation/'], 'apiKeyInstructions': ['Visit https://www.neutrinoapi.com/', 'Sign up for a free account', "Click on 'My Account'", "The API key is listed under 'Master Key'"], 'favIcon': 'https://www.neutrinoapi.com/favicon.png', 'logo': 'https://www.neutrinoapi.com/favicon.png', 'description': 'Neutrino API - The general-purpose API - Build smarter applications.'}}
    opts = {'user_id': '', 'api_key': '', 'timeout': 30}
    optdescs = {'user_id': 'NeutrinoAPI user ID.', 'api_key': 'NeutrinoAPI API key.', 'timeout': 'Query timeout, in seconds.'}
    results = None
    errorState = False
