...
@serve.deployment(user_config={'factor': 3}, ray_actor_options={'num_cpus': 0.1, 'runtime_env': {'env_vars': {'override_factor': '-2'}}})
class Multiplier:
...
@serve.deployment(user_config={'increment': 2}, ray_actor_options={'num_cpus': 0.1, 'runtime_env': {'env_vars': {'override_increment': '-2'}}})
class Adder:
