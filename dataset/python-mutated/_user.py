...
class SystemUser(OrgModelMixin, OldBaseUser):
    LOGIN_AUTO = 'auto'
    LOGIN_MANUAL = 'manual'
    LOGIN_MODE_CHOICES = ((LOGIN_AUTO, _('Automatic managed')), (LOGIN_MANUAL, _('Manually input')))
    ...
    class Meta:
        ...
        permissions = [('match_systemuser', _('Can match system user'))]

class AdminUser(OrgModelMixin, OldBaseUser):
    """
    A privileged user that ansible can use it to push system user and so on
    """
    BECOME_METHOD_CHOICES = (('sudo', 'sudo'), ('su', 'su'))
