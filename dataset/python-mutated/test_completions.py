...
class TestAsyncCompletions:
    ...
    async def test_method_create_overload_1(self, client: AsyncOpenAI) -> None:
        completion = await client.chat.completions.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo')
        assert_matches_type(ChatCompletion, completion, path=['response'])

    @parametrize
    async def test_method_create_with_all_params_overload_1(self, client: AsyncOpenAI) -> None:
        completion = await client.chat.completions.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo', frequency_penalty=-2, function_call='none', functions=[{'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}], logit_bias={'foo': 0}, max_tokens=0, n=1, presence_penalty=-2, response_format={'type': 'json_object'}, seed=-9223372036854776000, stop='string', stream=False, temperature=1, tool_choice='none', tools=[{'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}, {'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}, {'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}], top_p=1, user='user-1234')
        assert_matches_type(ChatCompletion, completion, path=['response'])

    @parametrize
    async def test_raw_response_create_overload_1(self, client: AsyncOpenAI) -> None:
        response = await client.chat.completions.with_raw_response.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo')
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        completion = response.parse()
        assert_matches_type(ChatCompletion, completion, path=['response'])
    ...
    async def test_method_create_overload_2(self, client: AsyncOpenAI) -> None:
        await client.chat.completions.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo', stream=True)

    @parametrize
    async def test_method_create_with_all_params_overload_2(self, client: AsyncOpenAI) -> None:
        await client.chat.completions.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo', stream=True, frequency_penalty=-2, function_call='none', functions=[{'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}], logit_bias={'foo': 0}, max_tokens=0, n=1, presence_penalty=-2, response_format={'type': 'json_object'}, seed=-9223372036854776000, stop='string', temperature=1, tool_choice='none', tools=[{'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}, {'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}, {'type': 'function', 'function': {'description': 'string', 'name': 'string', 'parameters': {'foo': 'bar'}}}], top_p=1, user='user-1234')

    @parametrize
    async def test_raw_response_create_overload_2(self, client: AsyncOpenAI) -> None:
        response = await client.chat.completions.with_raw_response.create(messages=[{'content': 'string', 'role': 'system'}], model='gpt-3.5-turbo', stream=True)
        assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
        response.parse()