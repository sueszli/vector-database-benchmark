...
class Migration(migrations.Migration):
    ...
    operations = [migrations.AddField(model_name='page', name='is_page_type', field=models.BooleanField(default=False)), migrations.CreateModel(name='PageType', fields=[], options={'default_permissions': [], 'proxy': True}, bases=('cms.page',)), migrations.RunPython(migrate_to_page_types, migrations.RunPython.noop)]