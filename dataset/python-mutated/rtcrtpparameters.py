...
class RTCRtpCapabilities:
    ...
    headerExtensions: List[RTCRtpHeaderExtensionCapability] = field(default_factory=list)
...
class RTCRtpParameters:
    ...
    headerExtensions: List[RTCRtpHeaderExtensionParameters] = field(default_factory=list)
