...
class Config:
    ...
    FONT_PATHS_DICT = {'default_15': {'name': os.path.join(rootdir.replace('sokoban', 'base'), 'resources/fonts/simkai.ttf'), 'size': 15}, 'default_30': {'name': os.path.join(rootdir.replace('sokoban', 'base'), 'resources/fonts/simkai.ttf'), 'size': 30}, 'default_50': {'name': os.path.join(rootdir.replace('sokoban', 'base'), 'resources/fonts/simkai.ttf'), 'size': 50}}
    IMAGE_PATHS_DICT = {'box': os.path.join(rootdir, 'resources/images/box.png'), 'player': os.path.join(rootdir, 'resources/images/player.png'), 'target': os.path.join(rootdir, 'resources/images/target.png'), 'wall': os.path.join(rootdir, 'resources/images/wall.png')}
'游戏地图'
