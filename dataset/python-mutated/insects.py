...
class Insects(base.RemoteDataset):
    ...
    """
    variant_sizes = {'abrupt_balanced': (52848, 16419025), 'abrupt_imbalanced': (355275, 110043637), 'gradual_balanced': (24150, 7503750), 'gradual_imbalanced': (143323, 44371501), 'incremental-abrupt_balanced': (79986, 24849436), 'incremental-abrupt_imbalanced': (452044, 140004225), 'incremental-reoccurring_balanced': (79986, 24849092), 'incremental-reoccurring_imbalanced': (452044, 140004230), 'incremental_balanced': (57018, 17713574), 'incremental_imbalanced': (452044, 140004218), 'out-of-control': (905145, 277777854)}
