...
def upgrade():
    ...
    if skip_based_on_legacy_engine_version(op, __name__):
        return
    op.create_index('idx_member_continuity_id', 'member_revision', ['continuity_id'])
    op.create_index('idx_package_tag_continuity_id', 'package_tag_revision', ['continuity_id'])
    op.create_index('idx_package_continuity_id', 'package_revision', ['continuity_id'])
    op.create_index('idx_package_extra_continuity_id', 'package_extra_revision', ['continuity_id'])
