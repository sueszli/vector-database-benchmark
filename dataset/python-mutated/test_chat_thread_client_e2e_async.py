...
class TestChatThreadClientAsync(AzureRecordedTestCase):
    ...
    async def _send_message(self):
        ...
        create_message_result = await self.chat_thread_client.send_message(content, sender_display_name=sender_display_name)
    ...
    async def test_list_read_receipts(self):
        async with self.chat_client:
            ...
            async with self.chat_thread_client:
                ...
                message_result_new_user = await chat_thread_client_new_user.send_message('content', sender_display_name='sender_display_name')
