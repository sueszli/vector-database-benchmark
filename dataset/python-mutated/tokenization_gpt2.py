...
PRETRAINED_VOCAB_ARCHIVE_MAP = {'gpt2': '.pytorch_pretrained_bert/gpt2-vocab.json', 'roberta': '.pytorch_pretrained_bert/roberta-vocab.json'}
PRETRAINED_MERGES_ARCHIVE_MAP = {'gpt2': '.pytorch_pretrained_bert/gpt2-merges.txt', 'roberta': '.pytorch_pretrained_bert/roberta-merges.txt'}
