...
(app_feedback_report_models, exp_models, suggestion_models, user_models) = models.Registry.import_models([models.Names.APP_FEEDBACK_REPORT, models.Names.EXPLORATION, models.Names.SUGGESTION, models.Names.USER])
...
class CronMailReviewersContributorDashboardSuggestionsHandlerTests(test_utils.GenericTestBase):
    target_id = 'exp1'
    language_code = 'en'
...
class CronMailAdminContributorDashboardBottlenecksHandlerTests(test_utils.GenericTestBase):
    target_id = 'exp1'
...
class CronMailChapterPublicationsNotificationsHandlerTests(test_utils.GenericTestBase):
