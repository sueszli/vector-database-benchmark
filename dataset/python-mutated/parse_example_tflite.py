"""Exports a simple graph with parse example with a string feature.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='/tmp/parse_example_tflite', help='Directory where to output model in TensorFlow Lite format.')
