...
def main():
    ...
    response = client.replicas.begin_create(resource_group_name='myResourceGroup', config_store_name='contoso', replica_name='myReplicaEus', replica_creation_parameters={'location': 'eastus'}).result()
    print(response)
