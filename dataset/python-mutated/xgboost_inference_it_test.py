...
try:
    ...
    xgboost = None
EXPECTED_OUTPUT_SINGLE_BATCHES = ['0,[1 1 1 0 0 0 0 1 2 0 0 2 0 2 1 2 2 2 2 0 0 0 0 2 2 0 2 2 2 1]']
EXPECTED_OUTPUT_MULTIPLE_BATCHES = ['0,[1]', '1,[1]', '2,[1]', '3,[0]', '4,[0]', '5,[0]', '6,[0]', '7,[1]', '8,[2]', '9,[0]', '10,[0]', '11,[2]', '12,[0]', '13,[2]', '14,[1]', '15,[2]', '16,[2]', '17,[2]', '18,[2]', '19,[0]', '20,[0]', '21,[0]', '22,[0]', '23,[2]', '24,[2]', '25,[0]', '26,[2]', '27,[2]', '28,[2]', '29,[1]']
...
@unittest.skipIf(os.getenv('FORCE_XGBOOST_IT') is None and xgboost is None, 'Missing dependencies. Test depends on xgboost and datatable')
