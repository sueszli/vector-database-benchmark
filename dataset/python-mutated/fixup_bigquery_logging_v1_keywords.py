...
class bigquery_loggingCallTransformer(cst.CSTTransformer):
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=bigquery_loggingCallTransformer()):
    if False:
        print('Hello World!')
