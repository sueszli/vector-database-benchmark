...
class HSEShowIE(HSEShowBaseInfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.hse.de/dpl/c/tv-shows/505350', 'info_dict': {'id': '505350', 'ext': 'mp4', 'title': 'Pfeffinger Mode & Accessoires', 'timestamp': 1638810000, 'upload_date': '20211206', 'channel': 'HSE24', 'uploader': 'Arina Pirayesh'}, 'params': {'skip_download': 'm3u8'}}]
...
class HSEProductIE(HSEShowBaseInfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.hse.de/dpl/p/product/408630', 'info_dict': {'id': '408630', 'ext': 'mp4', 'title': 'Hose im Ponte-Mix', 'uploader': 'Judith Williams'}, 'params': {'skip_download': 'm3u8'}}]
