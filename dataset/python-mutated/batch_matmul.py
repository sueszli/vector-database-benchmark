...
import os
op_attributes = {'B': int(os.environ['B']) if 'B' in os.environ else 6, 'N': int(os.environ['N']) if 'N' in os.environ else 1024, 'K': int(os.environ['K']) if 'K' in os.environ else 64, 'M': int(os.environ['M']) if 'M' in os.environ else 4096, 'P': os.environ['P'] if 'P' in os.environ else 'NN'}
