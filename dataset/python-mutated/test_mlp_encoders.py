...
class TestMLPEncoders(unittest.TestCase):
    ...
    def test_mlp_encoders(self):
        ...
        for permutation in itertools.product(inputs_dims_configs, list_of_hidden_layer_dims, hidden_layer_activations, hidden_layer_use_layernorms, output_activations, output_dims, hidden_use_biases, output_use_biases):
            (inputs_dims, hidden_layer_dims, hidden_layer_activation, hidden_layer_use_layernorm, output_activation, output_dim, hidden_use_bias, output_use_bias) = permutation
            ...
            config = MLPEncoderConfig(input_dims=inputs_dims, hidden_layer_dims=hidden_layer_dims, hidden_layer_activation=hidden_layer_activation, hidden_layer_use_layernorm=hidden_layer_use_layernorm, hidden_layer_use_bias=hidden_use_bias, output_layer_dim=output_dim, output_layer_activation=output_activation, output_layer_use_bias=output_use_bias)
