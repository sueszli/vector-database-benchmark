...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0438_add_web_mark_read_on_scroll_policy_setting')]
    operations = [migrations.RunPython(fix_invalid_emails, reverse_code=migrations.RunPython.noop, elidable=True)]