...
class TestEventDefinitionEnterpriseAPI(APIBaseTest):
    ...
    EXPECTED_EVENT_DEFINITIONS: List[Dict[str, Any]] = [{'name': 'purchase', 'verified': None}, {'name': 'entered_free_trial', 'verified': True}, {'name': 'watched_movie', 'verified': True}, {'name': '$pageview', 'verified': None}]
