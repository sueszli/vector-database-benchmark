...
import requests
pas_inputs = {'fields': [{'id': 'url', 'label': _('Centrify Tenant URL'), 'type': 'string', 'help_text': _('Centrify Tenant URL'), 'format': 'url'}, {'id': 'client_id', 'label': _('Centrify API User'), 'type': 'string', 'help_text': _('Centrify API User, having necessary permissions as mentioned in support doc')}, {'id': 'client_password', 'label': _('Centrify API Password'), 'type': 'string', 'help_text': _('Password of Centrify API User with necessary permissions'), 'secret': True}, {'id': 'oauth_application_id', 'label': _('OAuth2 Application ID'), 'type': 'string', 'help_text': _("Application ID of the configured OAuth2 Client (defaults to 'awx')"), 'default': 'awx'}, {'id': 'oauth_scope', 'label': _('OAuth2 Scope'), 'type': 'string', 'help_text': _("Scope of the configured OAuth2 Client (defaults to 'awx')"), 'default': 'awx'}], 'metadata': [{'id': 'account-name', 'label': _('Account Name'), 'type': 'string', 'help_text': _('Local system account or Domain account name enrolled in Centrify Vault. eg. (root or DOMAIN/Administrator)')}, {'id': 'system-name', 'label': _('System Name'), 'type': 'string', 'help_text': _('Machine Name enrolled with in Centrify Portal')}], 'required': ['url', 'account-name', 'system-name', 'client_id', 'client_password']}
