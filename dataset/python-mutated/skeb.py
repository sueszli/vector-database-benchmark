...
class SkebIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://skeb.jp/@riiru_wm/works/10', 'info_dict': {'id': '466853', 'title': '内容はおまかせします！ by 姫ノ森りぃる@一周年', 'descripion': 'md5:1ec50901efc3437cfbfe3790468d532d', 'uploader': '姫ノ森りぃる@一周年', 'uploader_id': 'riiru_wm', 'age_limit': 0, 'tags': [], 'url': 're:https://skeb.+', 'thumbnail': 're:https://skeb.+', 'subtitles': {'jpn': [{'url': 're:https://skeb.+', 'ext': 'vtt'}]}, 'width': 720, 'height': 405, 'duration': 313, 'fps': 30, 'ext': 'mp4'}}, {'url': 'https://skeb.jp/@furukawa_nob/works/3', 'info_dict': {'id': '489408', 'title': 'いつもお世話になってお... by 古川ノブ@音楽とVlo...', 'descripion': 'md5:5adc2e41d06d33b558bf7b1faeb7b9c2', 'uploader': '古川ノブ@音楽とVlogのVtuber', 'uploader_id': 'furukawa_nob', 'age_limit': 0, 'tags': ['よろしく', '大丈夫', 'お願い', 'でした', '是非', 'O', 'バー', '遊び', 'おはよう', 'オーバ', 'ボイス'], 'url': 're:https://skeb.+', 'thumbnail': 're:https://skeb.+', 'subtitles': {'jpn': [{'url': 're:https://skeb.+', 'ext': 'vtt'}]}, 'duration': 98, 'ext': 'mp3', 'vcodec': 'none', 'abr': 128}}, {'url': 'https://skeb.jp/@mollowmollow/works/6', 'info_dict': {'id': '6', 'title': 'ヒロ。\n\n私のキャラク... by 諸々', 'descripion': 'md5:aa6cbf2ba320b50bce219632de195f07', '_type': 'playlist', 'entries': [{'id': '486430', 'title': 'ヒロ。\n\n私のキャラク... by 諸々', 'descripion': 'md5:aa6cbf2ba320b50bce219632de195f07'}, {'id': '486431', 'title': 'ヒロ。\n\n私のキャラク... by 諸々'}]}}]
