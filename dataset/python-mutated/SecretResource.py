...
from mage_ai.data_preparation.shared.secrets import create_secret, get_valid_secrets_for_repo
from mage_ai.data_preparation.sync import GIT_ACCESS_TOKEN_SECRET_NAME, GIT_SSH_PRIVATE_KEY_SECRET_NAME, GIT_SSH_PUBLIC_KEY_SECRET_NAME, GitConfig
from mage_ai.orchestration.constants import Entity
from mage_ai.orchestration.db import safe_db_query
from mage_ai.orchestration.db.models.secrets import Secret
from mage_ai.settings.repo import get_repo_path
from mage_ai.shared.hash import extract
ALLOWED_PAYLOAD_KEYS = ['name', 'value', 'entity', 'pipeline_uuid']
