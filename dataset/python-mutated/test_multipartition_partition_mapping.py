...
import pytest
from dagster import AllPartitionMapping, AssetExecutionContext, AssetKey, DagsterInstance, DailyPartitionsDefinition, DynamicPartitionsDefinition, IdentityPartitionMapping, MultiPartitionKey, MultiPartitionsDefinition, SpecificPartitionsPartitionMapping, StaticPartitionMapping, StaticPartitionsDefinition, TimeWindowPartitionMapping, WeeklyPartitionsDefinition, asset, materialize, multi_asset
from dagster._check import CheckError
from dagster._core.definitions.asset_dep import AssetDep
from dagster._core.definitions.asset_spec import AssetSpec
from dagster._core.definitions.partition import DefaultPartitionsSubset
from dagster._core.definitions.partition_key_range import PartitionKeyRange
from dagster._core.definitions.partition_mapping import DimensionPartitionMapping, MultiPartitionMapping, MultiToSingleDimensionPartitionMapping
...
static_multipartitions_def = MultiPartitionsDefinition({'abc': static_partitions_def, '123': StaticPartitionsDefinition(['1', '2', '3'])})
daily_partitions_def = DailyPartitionsDefinition('2023-01-01')
weekly_multipartitions_def = MultiPartitionsDefinition({'week': WeeklyPartitionsDefinition('2023-01-01'), 'ab': StaticPartitionsDefinition(['a', 'b'])})
...
upstream_and_downstream_tests = [(MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'weekly': WeeklyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='abc', partition_mapping=IdentityPartitionMapping()), 'daily': DimensionPartitionMapping(dimension_name='weekly', partition_mapping=TimeWindowPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('a', '2023-01-01'), ('a', '2023-01-02'), ('a', '2023-01-03'), ('a', '2023-01-04'), ('a', '2023-01-05'), ('a', '2023-01-06'), ('a', '2023-01-07')]], [MultiPartitionKey({'abc': 'a', 'weekly': '2023-01-01'})]), (MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'weekly': WeeklyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='abc', partition_mapping=IdentityPartitionMapping()), 'daily': DimensionPartitionMapping(dimension_name='weekly', partition_mapping=TimeWindowPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('a', '2023-01-01'), ('a', '2023-01-02'), ('a', '2023-01-03'), ('a', '2023-01-04'), ('a', '2023-01-05'), ('a', '2023-01-06'), ('a', '2023-01-07'), ('b', '2023-01-08'), ('b', '2023-01-09'), ('b', '2023-01-10'), ('b', '2023-01-11'), ('b', '2023-01-12'), ('b', '2023-01-13'), ('b', '2023-01-14')]], [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('a', '2023-01-01'), ('b', '2023-01-08')]]), (MultiPartitionsDefinition({'123': StaticPartitionsDefinition(['1', '2', '3']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'daily': DimensionPartitionMapping(dimension_name='daily', partition_mapping=IdentityPartitionMapping())}), [MultiPartitionKey({'123': values[0], 'daily': values[1]}) for values in [('1', '2023-01-01'), ('2', '2023-01-01'), ('3', '2023-01-01'), ('1', '2023-01-02'), ('2', '2023-01-02'), ('3', '2023-01-02')]], [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('a', '2023-01-01'), ('b', '2023-01-01'), ('c', '2023-01-01'), ('a', '2023-01-02'), ('b', '2023-01-02'), ('c', '2023-01-02')]]), (MultiPartitionsDefinition({'12': StaticPartitionsDefinition(['1', '2']), 'xy': StaticPartitionsDefinition(['x', 'y'])}), MultiPartitionsDefinition({'ab': StaticPartitionsDefinition(['a', 'b']), '01': StaticPartitionsDefinition(['0', '1'])}), MultiPartitionMapping({}), [MultiPartitionKey({'12': values[0], 'xy': values[1]}) for values in [('1', 'x'), ('2', 'y'), ('1', 'y'), ('2', 'x')]], [MultiPartitionKey({'ab': values[0], '01': values[1]}) for values in [('a', '0'), ('a', '1'), ('b', '0'), ('b', '1')]])]
upstream_only_tests = [(MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'weekly': WeeklyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'123': StaticPartitionsDefinition(['1', '2', '3']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='123', partition_mapping=SpecificPartitionsPartitionMapping(['c'])), 'weekly': DimensionPartitionMapping(dimension_name='daily', partition_mapping=TimeWindowPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('c', '2023-01-01')]], [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('1', '2023-01-01'), ('3', '2023-01-02')]]), (MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'weekly': WeeklyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'123': StaticPartitionsDefinition(['1', '2', '3']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='123', partition_mapping=SpecificPartitionsPartitionMapping(['c'])), 'weekly': DimensionPartitionMapping(dimension_name='daily', partition_mapping=TimeWindowPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('c', '2023-01-01'), ('c', '2023-01-08')]], [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('1', '2023-01-01'), ('1', '2023-01-02'), ('1', '2023-01-03'), ('1', '2023-01-04'), ('1', '2023-01-05'), ('1', '2023-01-06'), ('1', '2023-01-07'), ('3', '2023-01-08'), ('3', '2023-01-09'), ('3', '2023-01-10'), ('3', '2023-01-11'), ('3', '2023-01-12'), ('3', '2023-01-13'), ('3', '2023-01-14')]]), (MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'123': StaticPartitionsDefinition(['1', '2', '3']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='123', partition_mapping=AllPartitionMapping()), 'daily': DimensionPartitionMapping(dimension_name='daily', partition_mapping=IdentityPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('a', '2023-01-01'), ('b', '2023-01-01'), ('c', '2023-01-01')]], [MultiPartitionKey({'123': values[0], 'daily': values[1]}) for values in [('1', '2023-01-01')]])]
downstream_only_tests = [(MultiPartitionsDefinition({'abc': StaticPartitionsDefinition(['a', 'b', 'c']), 'weekly': WeeklyPartitionsDefinition('2023-01-01')}), MultiPartitionsDefinition({'123': StaticPartitionsDefinition(['1', '2', '3']), 'daily': DailyPartitionsDefinition('2023-01-01')}), MultiPartitionMapping({'abc': DimensionPartitionMapping(dimension_name='123', partition_mapping=StaticPartitionMapping({'a': '1', 'b': '2', 'c': '3'})), 'weekly': DimensionPartitionMapping(dimension_name='daily', partition_mapping=TimeWindowPartitionMapping())}), [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('c', '2023-01-01'), ('a', '2023-01-08')]], [MultiPartitionKey({'abc': values[0], 'daily': values[1]}) for values in [('3', '2023-01-01'), ('3', '2023-01-02'), ('3', '2023-01-03'), ('3', '2023-01-04'), ('3', '2023-01-05'), ('3', '2023-01-06'), ('3', '2023-01-07'), ('1', '2023-01-08'), ('1', '2023-01-09'), ('1', '2023-01-10'), ('1', '2023-01-11'), ('1', '2023-01-12'), ('1', '2023-01-13'), ('1', '2023-01-14')]])]
