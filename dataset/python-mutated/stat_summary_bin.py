...
class stat_summary_bin(stat):
    ...
    REQUIRED_AES = {'x', 'y'}
    DEFAULT_PARAMS = {'geom': 'pointrange', 'position': 'identity', 'na_rm': False, 'bins': 30, 'breaks': None, 'binwidth': None, 'boundary': None, 'fun_data': None, 'fun_y': None, 'fun_ymin': None, 'fun_ymax': None, 'fun_args': None, 'random_state': None}
