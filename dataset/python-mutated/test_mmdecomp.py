...
from torch.testing._internal.common_utils import IS_WINDOWS, parametrize, run_tests, TEST_CUDA
from torch.utils._triton import has_triton
default_atol = {torch.float16: 0.001, torch.bfloat16: float('infinity'), torch.float32: 1e-05}
default_rtol = {torch.float16: 0.001, torch.bfloat16: float('infinity'), torch.float32: 1.3e-06}
