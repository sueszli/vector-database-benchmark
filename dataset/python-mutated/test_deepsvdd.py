...
class TestDeepSVDD(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.clf = DeepSVDD(epochs=10, hidden_neurons=[64, 32], contamination=self.contamination, random_state=2021)
        self.clf_ae = DeepSVDD(epochs=5, use_ae=True, output_activation='relu', hidden_neurons=[16, 8, 4], contamination=self.contamination, preprocessing=False)
