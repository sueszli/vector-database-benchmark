...
class TestLoadSqueezeNetModel(unittest.TestCase):
    ...
    def apply_test(self):
        ...
        self.executor.load_paddle_model(self.model_dir, self.target, False, 'squeezenet')
        end1 = time.time()
