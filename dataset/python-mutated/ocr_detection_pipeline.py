...
from .ocr_utils import SegLinkDetector, boxes_from_bitmap, cal_width, combine_segments_python, decode_segments_links_python, nms_python, polygons_from_bitmap, rboxes_to_polygons
...
tf.app.flags.DEFINE_float('node_threshold', 0.4, 'Confidence threshold for nodes')
tf.app.flags.DEFINE_float('link_threshold', 0.6, 'Confidence threshold for links')

@PIPELINES.register_module(Tasks.ocr_detection, module_name=Pipelines.ocr_detection)
