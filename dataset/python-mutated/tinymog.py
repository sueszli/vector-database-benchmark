...
class TinyMog(SingleStageDetector):
    ...
    def __init__(self, backbone, neck, bbox_head, train_cfg=None, test_cfg=None, pretrained=None):
        if False:
            print('Hello World!')
        super(TinyMog, self).__init__(backbone, neck, bbox_head, train_cfg, test_cfg, pretrained)
    ...
    def simple_test(self, img, img_metas, rescale=False, repeat_head=1, output_kps_var=0, output_results=1):
        if False:
            return 10
