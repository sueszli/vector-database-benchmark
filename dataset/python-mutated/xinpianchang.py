...
class XinpianchangIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.xinpianchang.com/a11766551', 'info_dict': {'id': 'a11766551', 'ext': 'mp4', 'title': '北京2022冬奥会闭幕式再见短片-冰墩墩下班了', 'description': 'md5:4a730c10639a82190fabe921c0fa4b87', 'duration': 151, 'thumbnail': 're:^https?://oss-xpc0\\.xpccdn\\.com.+/assets/', 'uploader': '正时文创', 'uploader_id': 10357277, 'categories': ['宣传片', '国家城市', '广告', '其他'], 'keywords': ['北京冬奥会', '冰墩墩', '再见', '告别', '冰墩墩哭了', '感动', '闭幕式', '熄火']}}, {'url': 'https://www.xinpianchang.com/a11762904', 'info_dict': {'id': 'a11762904', 'ext': 'mp4', 'title': '冬奥会决胜时刻《法国派出三只鸡？》', 'description': 'md5:55cb139ef8f48f0c877932d1f196df8b', 'duration': 136, 'thumbnail': 're:^https?://oss-xpc0\\.xpccdn\\.com.+/assets/', 'uploader': '精品动画', 'uploader_id': 10858927, 'categories': ['动画', '三维CG'], 'keywords': ['France Télévisions', '法国3台', '蠢萌', '冬奥会']}}, {'url': 'https://www.xinpianchang.com/a11779743?from=IndexPick&part=%E7%BC%96%E8%BE%91%E7%B2%BE%E9%80%89&index=2', 'only_matching': True}]
