...
from os_win.constants import HOST_SHUTDOWN_ACTION_SAVE, HOST_SHUTDOWN_ACTION_SHUTDOWN, HYPERV_VM_STATE_SUSPENDED, HYPERV_VM_STATE_ENABLED, HYPERV_VM_STATE_DISABLED
...
from golem.docker.hypervisor.hyperv import HyperVHypervisor, Events, MESSAGES, EVENTS
