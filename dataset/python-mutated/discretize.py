...
__all__ = ['EqualFreq', 'EqualWidth', 'EntropyMDL', 'DomainDiscretizer', 'decimal_binnings', 'time_binnings', 'short_time_units', 'BinDefinition']
...
short_time_units = dict(seconds='sec', minutes='min', hours='hrs', weeks='wks', months='mon', years='yrs', second='sec', minute='min', month='mon')
