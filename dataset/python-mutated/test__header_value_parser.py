...
class TestParser(TestParserMixin, TestEmailBase):
    ...
    rfc_atext_chars = string.ascii_letters + string.digits + "!#$%&'*+-/=?^_`{}|~"
    rfc_dtext_chars = rfc_printable_ascii.translate(str.maketrans('', '', '\\[]'))
...
class Test_parse_mime_version(TestParserMixin, TestEmailBase):
    ...
    mime_version_params = {'rfc_2045_1': ('1.0', '1.0', '1.0', 1, 0, []), 'RFC_2045_2': ('1.0 (produced by MetaSend Vx.x)', '1.0 (produced by MetaSend Vx.x)', '1.0 ', 1, 0, []), 'RFC_2045_3': ('(produced by MetaSend Vx.x) 1.0', '(produced by MetaSend Vx.x) 1.0', ' 1.0', 1, 0, []), 'RFC_2045_4': ('1.(produced by MetaSend Vx.x)0', '1.(produced by MetaSend Vx.x)0', '1. 0', 1, 0, []), 'empty': ('', '', '', None, None, [errors.HeaderMissingRequiredValue])}
