...
class ColPropWAliasJoinedToBaseTest(AssertsCompiledSQL, fixtures.DeclarativeMappedTest):
    """test #6762"""
    __dialect__ = 'default'
...
class CorrelateExceptWPolyAdaptTest(fixtures.DeclarativeMappedTest, testing.AssertsCompiledSQL):
    run_create_tables = run_deletes = None
...
class PolyIntoSelfReferentialTest(fixtures.DeclarativeMappedTest, AssertsExecutionResults):
    """test for #9715"""
...
@testing.combinations(('single',), ('joined',), id_='s', argnames='inheritance_type')
