...
class TestDot11ManagementBeaconFrames(unittest.TestCase):
    ...
    def test_09(self):
        ...
        frame_body = b":@\xcb&\x00\x00\x00\x00d\x00\x01\x05\x00\nfreebsd-ap\x01\x08\x8c\x12\x98$\xb0H`l\x03\x01$\x05\x04\x00\x01\x00\x00\x07*US $\x01\x11(\x01\x11,\x01\x110\x01\x114\x01\x178\x01\x17<\x01\x17@\x01\x17\x95\x01\x1e\x99\x01\x1e\x9d\x01\x1e\xa1\x01\x1e\xa5\x01\x1e \x01\x00\xdd\x18\x00P\xf2\x02\x01\x01\x00\x00\x03\xa4\x00\x00'\xa4\x00\x00BC^\x00b2/\x00"
    ...
    def test_10(self):
        ...
        self.management_beacon.set_timestamp(9756277976800118119)
        self.assertEqual(self.management_beacon.get_timestamp(), 9756277976800118119)
    ...
    def test_16(self):
        ...
        self.assertEqual(self.management_beacon.get_vendor_specific(), [(b'\x00P\xf2', b"\x02\x01\x01\x00\x00\x03\xa4\x00\x00'\xa4\x00\x00BC^\x00b2/\x00")])
        self.management_beacon.add_vendor_specific(b'\x00\x00@', b'\x04\x04\x04\x04\x04\x04')
        self.assertEqual(self.management_beacon.get_vendor_specific(), [(b'\x00P\xf2', b"\x02\x01\x01\x00\x00\x03\xa4\x00\x00'\xa4\x00\x00BC^\x00b2/\x00"), (b'\x00\x00@', b'\x04\x04\x04\x04\x04\x04')])
