...
import proto
__protobuf__ = proto.module(package='google.cloud.netapp.v1', manifest={'ListActiveDirectoriesRequest', 'ListActiveDirectoriesResponse', 'GetActiveDirectoryRequest', 'CreateActiveDirectoryRequest', 'UpdateActiveDirectoryRequest', 'DeleteActiveDirectoryRequest', 'ActiveDirectory'})

class ListActiveDirectoriesRequest(proto.Message):
    """ListActiveDirectoriesRequest for requesting multiple active
    directories.
...
class ListActiveDirectoriesResponse(proto.Message):
    """ListActiveDirectoriesResponse contains all the active
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    active_directories: MutableSequence['ActiveDirectory'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ActiveDirectory')
...
class CreateActiveDirectoryRequest(proto.Message):
    """CreateActiveDirectoryRequest for creating an active
    directory.
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    active_directory: 'ActiveDirectory' = proto.Field(proto.MESSAGE, number=2, message='ActiveDirectory')
    active_directory_id: str = proto.Field(proto.STRING, number=3)

class UpdateActiveDirectoryRequest(proto.Message):
    """UpdateActiveDirectoryRequest for updating an active
    directory.
...
class DeleteActiveDirectoryRequest(proto.Message):
    """DeleteActiveDirectoryRequest for deleting a single active
    directory.
...
class ActiveDirectory(proto.Message):
    """ActiveDirectory is the public representation of the active
    directory config.
    ...
    domain: str = proto.Field(proto.STRING, number=4)
    site: str = proto.Field(proto.STRING, number=5)
    dns: str = proto.Field(proto.STRING, number=6)
    net_bios_prefix: str = proto.Field(proto.STRING, number=7)
    organizational_unit: str = proto.Field(proto.STRING, number=8)
    aes_encryption: bool = proto.Field(proto.BOOL, number=9)
    username: str = proto.Field(proto.STRING, number=10)
    password: str = proto.Field(proto.STRING, number=11)
    backup_operators: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=12)
    security_operators: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=13)
    kdc_hostname: str = proto.Field(proto.STRING, number=14)
    kdc_ip: str = proto.Field(proto.STRING, number=15)
    nfs_users_with_ldap: bool = proto.Field(proto.BOOL, number=16)
    description: str = proto.Field(proto.STRING, number=17)
    ldap_signing: bool = proto.Field(proto.BOOL, number=18)
    encrypt_dc_connections: bool = proto.Field(proto.BOOL, number=19)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=20)
    state_details: str = proto.Field(proto.STRING, number=21)
