...
DEBUG_LEVEL = 0
PATH_TO_PROWLER = '{0}/integrations/prowler'.format(WAZUH_PATH)
TEMPLATE_CHECK = '\n{{\n  "integration": "prowler",\n  "prowler": {0}\n}}\n'
...
FIELD_REMAP = {'Profile': 'aws_profile', 'Control': 'control', 'Account Number': 'aws_account_id', 'Level': 'level', 'Account Alias': 'aws_account_alias', 'Timestamp': 'timestamp', 'Region': 'region', 'Control ID': 'control_id', 'Status': 'status', 'Scored': 'scored', 'Message': 'message'}
