...
BASE_URL_SPEC = f'https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v{DEFAULT_KUBERNETES_VERSION}-standalone-strict'
crd_lookup = {'keda.sh/v1alpha1::ScaledObject': 'https://raw.githubusercontent.com/kedacore/keda/v2.0.0/config/crd/bases/keda.sh_scaledobjects.yaml', 'networking.k8s.io/v1beta1::Ingress': 'https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.21.0/ingress-networking-v1beta1.json'}
