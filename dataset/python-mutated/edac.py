...
class EDACPolicy(SACPolicy):
    """
       ...
       Config:
           ...
           == ====================  ========    =============  ================================= =======================
    """
    config = dict(type='edac', cuda=False, on_policy=False, multi_agent=False, priority=False, priority_IS_weight=False, random_collect_size=10000, model=dict(ensemble_num=10, actor_head_hidden_size=256, critic_head_hidden_size=256), learn=dict(multi_gpu=False, update_per_collect=1, batch_size=256, learning_rate_q=0.0003, learning_rate_policy=0.0003, learning_rate_value=0.0003, learning_rate_alpha=0.0003, target_theta=0.005, discount_factor=0.99, alpha=1, auto_alpha=True, log_space=True, ignore_done=False, init_w=0.003, min_q_weight=1.0, with_q_entropy=False, eta=0.1), collect=dict(unroll_len=1), eval=dict(), other=dict(replay_buffer=dict(replay_buffer_size=1000000)))
