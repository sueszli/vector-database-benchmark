...
def main():
    ...
    response = client.storages.begin_delete(resource_group_name='myResourceGroup', service_name='myservice', storage_name='mystorage').result()
    print(response)
