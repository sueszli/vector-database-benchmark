...
SPEECH_TO_TEXT_PRETRAINED_CONFIG_ARCHIVE_MAP = {'facebook/s2t-small-librispeech-asr': 'https://huggingface.co/facebook/s2t-small-librispeech-asr/resolve/main/config.json'}
