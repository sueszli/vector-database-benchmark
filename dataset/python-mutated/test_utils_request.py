...
from scrapy.utils.request import _deprecated_fingerprint_cache, _fingerprint_cache, _request_fingerprint_as_bytes, fingerprint, request_authenticate, request_fingerprint, request_httprepr, request_to_curl
