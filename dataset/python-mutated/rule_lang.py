...
class RuleValidation:
    REQUIRE_REGEX = re.compile("'(.*)' is a required property")
    PATTERN_KEYS = {'match', 'taint', 'pattern', 'pattern-either', 'pattern-regex', 'patterns', 'pattern-sinks', 'pattern-sources', 'join', 'postprocessor-patterns', 'request', 'response'}
