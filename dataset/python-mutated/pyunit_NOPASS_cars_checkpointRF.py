...
def cars_checkpoint():
    ...
    model1 = H2ORandomForestEstimator(ntrees=ntrees1, max_depth=max_depth1, min_rows=min_rows1, score_each_iteration=True, seed=1234)
    ...
    model2 = H2ORandomForestEstimator(ntrees=ntrees2, max_depth=max_depth2, min_rows=min_rows2, score_each_iteration=True, checkpoint=restored_model._id, seed=1234)
    ...
    model3 = H2ORandomForestEstimator(ntrees=ntrees3, max_depth=max_depth3, min_rows=min_rows3, score_each_iteration=True, checkpoint=restored_model._id, seed=1234)
    ...
    model4 = H2ORandomForestEstimator(ntrees=ntrees2, max_depth=max_depth2, min_rows=min_rows2, score_each_iteration=True, seed=1234)
