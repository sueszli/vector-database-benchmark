...
from ....vouchers.utils import create_voucher, create_voucher_channel_listing, get_voucher, voucher_delete
...
def prepare_voucher(e2e_staff_api_client, channel_id, voucher_code, voucher_discount_type, voucher_discount_value, voucher_type):
    if False:
        for i in range(10):
            print('nop')
    input = {'addCodes': voucher_code, 'discountValueType': voucher_discount_type, 'type': voucher_type}
...
@pytest.mark.e2e
def test_checkout_unable_to_use_deleted_voucher_CORE_0923(e2e_staff_api_client, e2e_not_logged_api_client, permission_manage_channels, permission_manage_shipping, permission_manage_products, permission_manage_product_types_and_attributes, permission_manage_discounts, permission_manage_checkouts):
    if False:
        while True:
            i = 10
    ...
    (voucher_id, voucher_code) = prepare_voucher(e2e_staff_api_client, channel_id, voucher_code='FIXED_VOUCHER', voucher_discount_type='FIXED', voucher_discount_value=10, voucher_type='ENTIRE_ORDER')
