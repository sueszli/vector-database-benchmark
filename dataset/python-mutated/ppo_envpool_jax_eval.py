...
if __name__ == '__main__':
    ...
    model_path = hf_hub_download(repo_id='vwxyzjn/Pong-v5-ppo_atari_envpool_xla_jax_scan-seed1', filename='ppo_atari_envpool_xla_jax_scan.cleanrl_model')
    evaluate(model_path, make_env, 'Pong-v5', eval_episodes=10, run_name=f'eval', Model=(Network, Actor, Critic), capture_video=False)