...
from ..utils import InAdvancePagedList, clean_html, determine_ext, float_or_none, int_or_none, join_nonempty, make_archive_id, mimetype2ext, orderedSet, remove_end, smuggle_url, strip_jsonp, try_call, unescapeHTML, unified_strdate, unsmuggle_url, url_or_none
...
class ORFRadioIE(InfoExtractor):
    IE_NAME = 'orf:radio'
    STATION_INFO = {'fm4': ('fm4', 'fm4', 'orffm4'), 'noe': ('noe', 'oe2n', 'orfnoe'), 'wien': ('wie', 'oe2w', 'orfwie'), 'burgenland': ('bgl', 'oe2b', 'orfbgl'), 'ooe': ('ooe', 'oe2o', 'orfooe'), 'steiermark': ('stm', 'oe2st', 'orfstm'), 'kaernten': ('ktn', 'oe2k', 'orfktn'), 'salzburg': ('sbg', 'oe2s', 'orfsbg'), 'tirol': ('tir', 'oe2t', 'orftir'), 'vorarlberg': ('vbg', 'oe2v', 'orfvbg'), 'oe3': ('oe3', 'oe3', 'orfoe3'), 'oe1': ('oe1', 'oe1', 'orfoe1')}
...
class ORFPodcastIE(InfoExtractor):
    IE_NAME = 'orf:podcast'
    _STATION_RE = '|'.join(map(re.escape, ('bgl', 'fm4', 'ktn', 'noe', 'oe1', 'oe3', 'ooe', 'sbg', 'stm', 'tir', 'tv', 'vbg', 'wie')))
    _VALID_URL = f'https?://sound\\.orf\\.at/podcast/(?P<station>{_STATION_RE})/(?P<show>[\\w-]+)/(?P<id>[\\w-]+)'
    _TESTS = [{'url': 'https://sound.orf.at/podcast/oe3/fruehstueck-bei-mir/nicolas-stockhammer-15102023', 'md5': '526a5700e03d271a1505386a8721ab9b', 'info_dict': {'id': 'nicolas-stockhammer-15102023', 'ext': 'mp3', 'title': 'Nicolas Stockhammer (15.10.2023)', 'duration': 3396.0, 'series': 'Frühstück bei mir'}, 'skip': 'ORF podcasts are only available for a limited time'}]
...
class ORFIPTVIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://iptv.orf.at/stories/2275236/', 'md5': 'c8b22af4718a4b4af58342529453e3e5', 'info_dict': {'id': '350612', 'ext': 'flv', 'title': 'Weitere Evakuierungen um Vulkan Calbuco', 'description': 'md5:d689c959bdbcf04efeddedbf2299d633', 'duration': 68.197, 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20150425'}}
...
class ORFFM4StoryIE(InfoExtractor):
    ...
    _TEST = {'url': 'http://fm4.orf.at/stories/2865738/', 'playlist': [{'md5': 'e1c2c706c45c7b34cf478bbf409907ca', 'info_dict': {'id': '547792', 'ext': 'flv', 'title': 'Manu Delago und Inner Tongue live', 'description': 'Manu Delago und Inner Tongue haben bei der FM4 Soundpark Session live alles gegeben. Hier gibt es Fotos und die gesamte Session als Video.', 'duration': 1748.52, 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20170913'}}, {'md5': 'c6dd2179731f86f4f55a7b49899d515f', 'info_dict': {'id': '547798', 'ext': 'flv', 'title': 'Manu Delago und Inner Tongue live (2)', 'duration': 1504.08, 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20170913', 'description': 'Manu Delago und Inner Tongue haben bei der FM4 Soundpark Session live alles gegeben. Hier gibt es Fotos und die gesamte Session als Video.'}}]}
