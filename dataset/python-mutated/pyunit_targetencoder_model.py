...
pu.run_tests([test_target_encoding_full_scenario, test_target_encoded_frame_does_not_contain_fold_column, test_original_features_are_kept_by_default, test_original_features_can_be_automatically_removed_from_result_frame])