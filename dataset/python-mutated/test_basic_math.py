...
@testing.parameterize(*testing.product({'in_shapes': [((3, 2),) * 3, ((),) * 3, ((1, 3), (), (2, 1, 2, 1)), ((), (2, 1, 2), (3, 1)), ((3, 1), (1, 1), (2,))], 'dtype': [numpy.float16, numpy.float32, numpy.float64]}))
@backend.inject_backend_tests(['test_forward', 'test_backward', 'test_double_backward'], testing.product({'use_cuda': [False], 'use_ideep': ['never', 'always']}) + testing.product({'use_cuda': [True], 'use_cudnn': ['never', 'always']}))
...
@testing.parameterize(*testing.product_dict([{'left_const': False, 'right_const': False}, {'left_const': True, 'right_const': False}, {'left_const': False, 'right_const': True}], [{'dtype': numpy.float16}, {'dtype': numpy.float32}, {'dtype': numpy.float64}], [{'x_shape': (3, 2), 'y_shape': (2, 4), 'z_shape': (3, 4)}, {'x_shape': (2, 3, 2), 'y_shape': (2, 2, 4), 'z_shape': (2, 3, 4)}, {'x_shape': (2, 1, 3, 4), 'y_shape': (2, 4, 2), 'z_shape': (2, 2, 3, 2)}, {'x_shape': (5, 3, 2), 'y_shape': (2,), 'z_shape': (5, 3)}, {'x_shape': (2,), 'y_shape': (5, 2, 4), 'z_shape': (5, 4)}, {'x_shape': (2, 3, 2), 'y_shape': (2, 4), 'z_shape': (2, 3, 4)}, {'x_shape': (3,), 'y_shape': (3,), 'z_shape': ()}]))
@unittest.skipUnless(sys.version_info >= (3, 5), 'Only for Python3.5 or higher')
...
@testing.parameterize({'x_shape': (), 'y_shape': ()}, {'x_shape': (3, 2), 'y_shape': ()}, {'x_shape': (), 'y_shape': (2, 4)}, {'x_shape': (2, 3), 'y_shape': (2, 3)}, {'x_shape': (2,), 'y_shape': (1,)})
@unittest.skipUnless(sys.version_info >= (3, 5), 'Only for Python3.5 or higher')
