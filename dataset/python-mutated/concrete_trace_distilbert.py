...
traced_model = concrete_trace(model, dummy_input, autowrap_leaf_class={torch.finfo: ((), False), modeling_outputs.SequenceClassifierOutput: ((), False), **ConcreteTracer.default_autowrap_leaf_class})
with torch.no_grad():
