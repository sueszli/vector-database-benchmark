...
from ....account.utils import can_user_manage_group_channels, can_user_manage_group_permissions, get_not_manageable_permissions_after_group_deleting
...
class PermissionGroupDelete(ModelDeleteMutation):
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.PERMISSION_GROUP_DELETED)]
