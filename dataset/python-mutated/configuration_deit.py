...
DEIT_PRETRAINED_CONFIG_ARCHIVE_MAP = {'facebook/deit-base-distilled-patch16-224': 'https://huggingface.co/facebook/deit-base-patch16-224/resolve/main/config.json'}
