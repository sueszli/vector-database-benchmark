...
class ConversationProfile(proto.Message):
    ...
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=11, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=12, message=timestamp_pb2.Timestamp)
    automated_agent_config: 'AutomatedAgentConfig' = proto.Field(proto.MESSAGE, number=3, message='AutomatedAgentConfig')
    human_agent_assistant_config: 'HumanAgentAssistantConfig' = proto.Field(proto.MESSAGE, number=4, message='HumanAgentAssistantConfig')
    human_agent_handoff_config: 'HumanAgentHandoffConfig' = proto.Field(proto.MESSAGE, number=5, message='HumanAgentHandoffConfig')
    notification_config: 'NotificationConfig' = proto.Field(proto.MESSAGE, number=6, message='NotificationConfig')
    logging_config: 'LoggingConfig' = proto.Field(proto.MESSAGE, number=7, message='LoggingConfig')
    new_message_event_notification_config: 'NotificationConfig' = proto.Field(proto.MESSAGE, number=8, message='NotificationConfig')
    stt_config: audio_config.SpeechToTextConfig = proto.Field(proto.MESSAGE, number=9, message=audio_config.SpeechToTextConfig)
    language_code: str = proto.Field(proto.STRING, number=10)
    time_zone: str = proto.Field(proto.STRING, number=14)
    security_settings: str = proto.Field(proto.STRING, number=13)
    tts_config: audio_config.SynthesizeSpeechConfig = proto.Field(proto.MESSAGE, number=18, message=audio_config.SynthesizeSpeechConfig)
...
class ListConversationProfilesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    conversation_profiles: MutableSequence['ConversationProfile'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ConversationProfile')
...
class CreateConversationProfileRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    conversation_profile: 'ConversationProfile' = proto.Field(proto.MESSAGE, number=2, message='ConversationProfile')
...
class UpdateConversationProfileRequest(proto.Message):
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            update.
    """
    conversation_profile: 'ConversationProfile' = proto.Field(proto.MESSAGE, number=1, message='ConversationProfile')
...
class AutomatedAgentConfig(proto.Message):
    ...
    Attributes:
        ...
        session_ttl (google.protobuf.duration_pb2.Duration):
            ...
            day.
    """
    agent: str = proto.Field(proto.STRING, number=1)
    session_ttl: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, message=duration_pb2.Duration)
...
class HumanAgentAssistantConfig(proto.Message):
    ...
    class SuggestionTriggerSettings(proto.Message):
        ...
        """
        no_smalltalk: bool = proto.Field(proto.BOOL, number=1)
        only_end_user: bool = proto.Field(proto.BOOL, number=2)
    ...
    class SuggestionFeatureConfig(proto.Message):
        ...
        """
        suggestion_feature: 'SuggestionFeature' = proto.Field(proto.MESSAGE, number=5, message='SuggestionFeature')
        enable_event_based_suggestion: bool = proto.Field(proto.BOOL, number=3)
        disable_agent_query_logging: bool = proto.Field(proto.BOOL, number=14)
        suggestion_trigger_settings: 'HumanAgentAssistantConfig.SuggestionTriggerSettings' = proto.Field(proto.MESSAGE, number=10, message='HumanAgentAssistantConfig.SuggestionTriggerSettings')
        query_config: 'HumanAgentAssistantConfig.SuggestionQueryConfig' = proto.Field(proto.MESSAGE, number=6, message='HumanAgentAssistantConfig.SuggestionQueryConfig')
        conversation_model_config: 'HumanAgentAssistantConfig.ConversationModelConfig' = proto.Field(proto.MESSAGE, number=7, message='HumanAgentAssistantConfig.ConversationModelConfig')
        conversation_process_config: 'HumanAgentAssistantConfig.ConversationProcessConfig' = proto.Field(proto.MESSAGE, number=8, message='HumanAgentAssistantConfig.ConversationProcessConfig')
    ...
    class SuggestionConfig(proto.Message):
        ...
        Attributes:
            ...
            group_suggestion_responses (bool):
                ...
                StreamingAnalyzeContentResponse.
        """
        feature_configs: MutableSequence['HumanAgentAssistantConfig.SuggestionFeatureConfig'] = proto.RepeatedField(proto.MESSAGE, number=2, message='HumanAgentAssistantConfig.SuggestionFeatureConfig')
        group_suggestion_responses: bool = proto.Field(proto.BOOL, number=3)
    ...
    class SuggestionQueryConfig(proto.Message):
        ...
        class KnowledgeBaseQuerySource(proto.Message):
            ...
            """
            knowledge_bases: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        ...
        class DocumentQuerySource(proto.Message):
            ...
            """
            documents: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        ...
        class DialogflowQuerySource(proto.Message):
            ...
            class HumanAgentSideConfig(proto.Message):
                ...
                agent: str = proto.Field(proto.STRING, number=1)
            agent: str = proto.Field(proto.STRING, number=1)
            human_agent_side_config: 'HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig' = proto.Field(proto.MESSAGE, number=3, message='HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig')
        ...
        class ContextFilterSettings(proto.Message):
            ...
            Attributes:
                ...
                drop_ivr_messages (bool):
                    ...
                    are dropped.
            """
            drop_handoff_messages: bool = proto.Field(proto.BOOL, number=1)
            drop_virtual_agent_messages: bool = proto.Field(proto.BOOL, number=2)
            drop_ivr_messages: bool = proto.Field(proto.BOOL, number=3)
        knowledge_base_query_source: 'HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource' = proto.Field(proto.MESSAGE, number=1, oneof='query_source', message='HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource')
        document_query_source: 'HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource' = proto.Field(proto.MESSAGE, number=2, oneof='query_source', message='HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource')
        dialogflow_query_source: 'HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource' = proto.Field(proto.MESSAGE, number=3, oneof='query_source', message='HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource')
        max_results: int = proto.Field(proto.INT32, number=4)
        confidence_threshold: float = proto.Field(proto.FLOAT, number=5)
        context_filter_settings: 'HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings' = proto.Field(proto.MESSAGE, number=7, message='HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings')
    ...
    class ConversationModelConfig(proto.Message):
        ...
        baseline_model_version: str = proto.Field(proto.STRING, number=8)
    ...
    class ConversationProcessConfig(proto.Message):
        ...
        """
        recent_sentences_count: int = proto.Field(proto.INT32, number=2)

    class MessageAnalysisConfig(proto.Message):
        """Configuration for analyses to run on each conversation
        message.
        ...
        """
        enable_entity_extraction: bool = proto.Field(proto.BOOL, number=2)
        enable_sentiment_analysis: bool = proto.Field(proto.BOOL, number=3)
    notification_config: 'NotificationConfig' = proto.Field(proto.MESSAGE, number=2, message='NotificationConfig')
    human_agent_suggestion_config: SuggestionConfig = proto.Field(proto.MESSAGE, number=3, message=SuggestionConfig)
    end_user_suggestion_config: SuggestionConfig = proto.Field(proto.MESSAGE, number=4, message=SuggestionConfig)
    message_analysis_config: MessageAnalysisConfig = proto.Field(proto.MESSAGE, number=5, message=MessageAnalysisConfig)

class HumanAgentHandoffConfig(proto.Message):
    """Defines the hand off to a live agent, typically on which
    ...
    class LivePersonConfig(proto.Message):
        ...
        """
        account_number: str = proto.Field(proto.STRING, number=1)
    ...
    class SalesforceLiveAgentConfig(proto.Message):
        ...
        """
        organization_id: str = proto.Field(proto.STRING, number=1)
        deployment_id: str = proto.Field(proto.STRING, number=2)
        button_id: str = proto.Field(proto.STRING, number=3)
        endpoint_domain: str = proto.Field(proto.STRING, number=4)
    live_person_config: LivePersonConfig = proto.Field(proto.MESSAGE, number=1, oneof='agent_service', message=LivePersonConfig)
    salesforce_live_agent_config: SalesforceLiveAgentConfig = proto.Field(proto.MESSAGE, number=2, oneof='agent_service', message=SalesforceLiveAgentConfig)
...
class NotificationConfig(proto.Message):
    ...
    message_format: MessageFormat = proto.Field(proto.ENUM, number=2, enum=MessageFormat)
...
class LoggingConfig(proto.Message):
    ...
    Attributes:
        enable_stackdriver_logging (bool):
            ...
            protos.
    """
    enable_stackdriver_logging: bool = proto.Field(proto.BOOL, number=3)
...
class SetSuggestionFeatureConfigRequest(proto.Message):
    ...
    Attributes:
        ...
        suggestion_feature_config (google.cloud.dialogflow_v2.types.HumanAgentAssistantConfig.SuggestionFeatureConfig):
            ...
            add or update.
    """
    conversation_profile: str = proto.Field(proto.STRING, number=1)
    participant_role: participant.Participant.Role = proto.Field(proto.ENUM, number=2, enum=participant.Participant.Role)
    suggestion_feature_config: 'HumanAgentAssistantConfig.SuggestionFeatureConfig' = proto.Field(proto.MESSAGE, number=3, message='HumanAgentAssistantConfig.SuggestionFeatureConfig')
...
class ClearSuggestionFeatureConfigRequest(proto.Message):
    ...
    conversation_profile: str = proto.Field(proto.STRING, number=1)
    participant_role: participant.Participant.Role = proto.Field(proto.ENUM, number=2, enum=participant.Participant.Role)
    suggestion_feature_type: 'SuggestionFeature.Type' = proto.Field(proto.ENUM, number=3, enum='SuggestionFeature.Type')
