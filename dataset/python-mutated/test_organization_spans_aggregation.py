...
MOCK_SNUBA_RESPONSE = {'data': [{'transaction_id': '80fe542aea4945ffbe612646987ee449', 'count': 71, 'spans': [['root_1', 1, 'parent_1', 'e238e6c2e2466b07', 'e238e6c2e2466b07', 'api/0/foo', 'other', '2023-09-13 17:12:19', 100, 1000, 1000], ['B1', 0, 'root_1', 'B', 'B', 'connect', 'db', '2023-09-13 17:12:19', 150, 50, 50.0], ['C1', 0, 'root_1', 'C', 'C', 'resolve_conditions', 'discover.endpoint', '2023-09-13 17:12:19', 155, 0, 10.0], ['D1', 0, 'C1', 'D', 'D', 'resolve_orderby', 'discover.snql', '2023-09-13 17:12:19', 157, 0, 20.0], ['E1', 0, 'C1', NULL_GROUP, 'E', 'resolve_columns', 'discover.snql', '2023-09-13 17:12:19', 157, 0, 20.0]]}, {'transaction_id': '86b21833d1854d9b811000b91e7fccfa', 'count': 71, 'spans': [['root_2', 1, 'parent_2', 'e238e6c2e2466b07', 'e238e6c2e2466b07', 'bind_organization_context', 'other', '2023-09-13 17:12:39', 100, 700, 0.0], ['B2', 0, 'root_2', 'B', 'B', 'connect', 'db', '2023-09-13 17:12:39', 110, 10, 30.0], ['C2', 0, 'root_2', 'C', 'C', 'resolve_conditions', 'discover.endpoint', '2023-09-13 17:12:39', 115, 0, 40.0], ['D2', 0, 'C2', 'D', 'D', 'resolve_orderby', 'discover.snql', '2023-09-13 17:12:39', 150, 0, 10.0], ['D2-duplicate', 0, 'C2', 'D', 'D', 'resolve_orderby', 'discover.snql', '2023-09-13 17:12:40', 155, 0, 20.0], ['E2', 0, 'C2', NULL_GROUP, 'E', 'resolve_columns', 'discover.snql', '2023-09-13 17:12:39', 157, 0, 20.0]]}]}

class OrganizationSpansAggregationTest(APITestCase, SnubaTestCase):
    url_name = 'sentry-api-0-organization-spans-aggregation'
    FEATURES = ['organizations:starfish-aggregate-span-waterfall', 'organizations:performance-view']
