...
vd.theme_option('disp_canvas_charset', ''.join((chr(10240 + i) for i in range(256))), 'charset to render 2x4 blocks on canvas')
...
vd.addGlobals({'Canvas': Canvas, 'Plotter': Plotter, 'BoundingBox': BoundingBox, 'Box': Box, 'Point': Point})
