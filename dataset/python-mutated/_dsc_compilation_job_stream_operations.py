...
class DscCompilationJobStreamOperations:
    ...
    async def list_by_job(self, resource_group_name: str, automation_account_name: str, job_id: str, **kwargs: Any) -> _models.JobStreamListResult:
        ...
        request = build_list_by_job_request(resource_group_name=resource_group_name, automation_account_name=automation_account_name, job_id=job_id, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_by_job.metadata['url'], headers=_headers, params=_params)
