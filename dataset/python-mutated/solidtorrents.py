...
from searx.utils import extract_text, eval_xpath, eval_xpath_getindex, eval_xpath_list, get_torrent_size
about = {'website': 'https://www.solidtorrents.to/', 'wikidata_id': None, 'official_api_documentation': None, 'use_official_api': False, 'require_api_key': False, 'results': 'HTML'}
categories = ['files']
paging = True
