...
USER_DATA = {'dag_tester': ('dag_acl_tester', {'first_name': 'dag_test', 'last_name': 'dag_test', 'email': 'dag_test@fab.org', 'password': 'dag_test'}), 'dag_faker': ('dag_acl_faker', {'first_name': 'dag_faker', 'last_name': 'dag_faker', 'email': 'dag_fake@fab.org', 'password': 'dag_faker'}), 'dag_read_only': ('dag_acl_read_only', {'first_name': 'dag_read_only', 'last_name': 'dag_read_only', 'email': 'dag_read_only@fab.org', 'password': 'dag_read_only'}), 'all_dag_user': ('all_dag_role', {'first_name': 'all_dag_user', 'last_name': 'all_dag_user', 'email': 'all_dag_user@fab.org', 'password': 'all_dag_user'})}
...
RENDERED_TEMPLATES_URL = f'rendered-templates?task_id=runme_0&dag_id=example_bash_operator&execution_date={urllib.parse.quote_plus(str(DEFAULT_DATE))}'
TASK_URL = f'task?task_id=runme_0&dag_id=example_bash_operator&execution_date={urllib.parse.quote_plus(str(DEFAULT_DATE))}'
XCOM_URL = f'xcom?task_id=runme_0&dag_id=example_bash_operator&execution_date={urllib.parse.quote_plus(str(DEFAULT_DATE))}'
...
LOG_URL = f'log?task_id=runme_0&dag_id=example_bash_operator&execution_date={urllib.parse.quote_plus(str(DEFAULT_DATE))}'
...
GET_LOGS_WITH_METADATA_URL = f'get_logs_with_metadata?task_id=runme_0&dag_id=example_bash_operator&execution_date={urllib.parse.quote_plus(str(DEFAULT_DATE))}&try_number=1&metadata=null'
