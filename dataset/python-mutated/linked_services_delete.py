...
def main():
    ...
    response = client.linked_services.delete(resource_group_name='exampleResourceGroup', factory_name='exampleFactoryName', linked_service_name='exampleLinkedService')
    print(response)
