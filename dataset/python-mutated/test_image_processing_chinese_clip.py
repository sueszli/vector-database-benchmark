...
class ChineseCLIPImageProcessingTester(unittest.TestCase):
    ...
    def __init__(self, parent, batch_size=7, num_channels=3, image_size=18, min_resolution=30, max_resolution=400, do_resize=True, size=None, do_center_crop=True, crop_size=None, do_normalize=True, image_mean=[0.48145466, 0.4578275, 0.40821073], image_std=[0.26862954, 0.26130258, 0.27577711], do_convert_rgb=True):
        if False:
            print('Hello World!')
    ...
    def prepare_image_processor_dict(self):
        if False:
            print('Hello World!')
        return {'do_resize': self.do_resize, 'size': self.size, 'do_center_crop': self.do_center_crop, 'crop_size': self.crop_size, 'do_normalize': self.do_normalize, 'image_mean': self.image_mean, 'image_std': self.image_std, 'do_convert_rgb': self.do_convert_rgb}
...
class ChineseCLIPImageProcessingTest(ImageProcessingTestMixin, unittest.TestCase):
    ...
    @unittest.skip("ChineseCLIPImageProcessor doesn't treat 4 channel PIL and numpy consistently yet")
...
class ChineseCLIPImageProcessingTestFourChannels(ImageProcessingTestMixin, unittest.TestCase):
    ...
    @unittest.skip('ChineseCLIPImageProcessor does not support 4 channels yet')
