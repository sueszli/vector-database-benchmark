...
from cura.Settings.cura_empty_instance_containers import empty_definition_changes_container, empty_variant_container, empty_material_container, empty_quality_container, empty_quality_changes_container, empty_intent_container
...
class MachineManager(QObject):
    ...
    activeStackValueChanged = pyqtSignal()
    activeStackValidationChanged = pyqtSignal()
    stacksValidationChanged = pyqtSignal()
    numberExtrudersEnabledChanged = pyqtSignal()
    blurSettings = pyqtSignal()
    outputDevicesChanged = pyqtSignal()
    currentConfigurationChanged = pyqtSignal()
    printerConnectedStatusChanged = pyqtSignal()
