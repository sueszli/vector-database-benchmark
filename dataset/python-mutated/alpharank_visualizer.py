...
try:
    ...
    logging.info("If your tests failed with the error 'ImportError: No module named functools_lru_cache', this is a known bug in matplotlib and there is a workaround (run sudo apt install python-backports.functools-lru-cache. See: https://github.com/matplotlib/matplotlib/issues/9344.")
    raise e
