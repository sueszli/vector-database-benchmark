...
class AdminProjectDomainAttributes(object):
    ...
    swagger_types = {'project': 'str', 'domain': 'str', 'matching_attributes': 'AdminMatchingAttributes'}
    attribute_map = {'project': 'project', 'domain': 'domain', 'matching_attributes': 'matching_attributes'}

    def __init__(self, project=None, domain=None, matching_attributes=None):
        if False:
            print('Hello World!')
        'AdminProjectDomainAttributes - a model defined in Swagger'
        self._project = None
        self._domain = None
