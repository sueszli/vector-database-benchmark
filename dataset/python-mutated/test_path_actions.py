...
from conda.common.path import get_bin_directory_short_path, get_python_noarch_target_path, get_python_short_path, get_python_site_packages_short_path, parse_entry_point_def, pyc_path, win_path_ok
