...
e1.data = 'e2'
session.commit()
assert session.query(Example.id, Example.version_id, Example.is_current_version, Example.calc_is_current_version, Example.data).order_by(Example.id, Example.version_id).all() == [(1, 1, False, False, 'e1'), (1, 2, True, True, 'e2')]
...
class Parent(Base):
    ...
    __table_args__ = (ForeignKeyConstraint(['child_id', 'child_version_id'], ['child.id', 'child.version_id']),)
...
assert session.query(Child.id, Child.version_id, Child.is_current_version, Child.calc_is_current_version, Child.data).order_by(Child.id, Child.version_id).all() == [(1, 1, False, False, 'c1'), (1, 2, True, True, 'c2')]