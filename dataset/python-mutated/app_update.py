...
class AppUpdate(ModelMutation):
    ...
    class Arguments:
        ...
        input = AppInput(required=True, description='Fields required to update an existing app.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.APP_UPDATED, description='An app was updated.')]
    ...
    def clean_input(cls, info, instance, data, **kwargs):
        ...
        if not requestor_is_superuser(requestor) and (not can_manage_app(requestor, instance)):
