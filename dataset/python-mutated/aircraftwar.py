...
class Config:
    ...
    SOUND_PATHS_DICT = {'boom': os.path.join(rootdir, 'resources/audios/boom.wav'), 'shot': os.path.join(rootdir, 'resources/audios/shot.ogg')}
    BGM_PATH = os.path.join(rootdir, 'resources/audios/Cool Space Music.mp3')
    IMAGE_PATHS_DICT = {'asteroid': os.path.join(rootdir, 'resources/images/asteroid.png'), 'bg_big': os.path.join(rootdir, 'resources/images/bg_big.png'), 'bullet': os.path.join(rootdir, 'resources/images/bullet.png'), 'seamless_space': os.path.join(rootdir, 'resources/images/seamless_space.png'), 'ship': os.path.join(rootdir, 'resources/images/ship.png'), 'ship_exploded': os.path.join(rootdir, 'resources/images/ship_exploded.png'), 'space3': os.path.join(rootdir, 'resources/images/space3.jpg')}
    FONT_PATHS_DICT = {'default_s': {'name': os.path.join(rootdir.replace('aircraftwar', 'base'), 'resources/fonts/simkai.ttf'), 'size': 20}, 'default_l': {'name': os.path.join(rootdir.replace('aircraftwar', 'base'), 'resources/fonts/simkai.ttf'), 'size': 50}}
'飞机大战'
