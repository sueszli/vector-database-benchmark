...
def main():
    ...
    parser.add_argument('-c', '--classes', action='store_true', dest='show_classes', help='Display classes')
    parser.add_argument('-f', '--fields', action='store_true', dest='show_fields', help='Display Fields')
    parser.add_argument('-m', '--methods', action='store_true', dest='show_methods', help='Display Methods')
    parser.add_argument('-s', '--strings', action='store_true', dest='show_strings', help='Display Strings')
    parser.add_argument('-t', '--types', action='store_true', dest='show_types', help='Display Types')
    parser.add_argument('-p', '--prototypes', action='store_true', dest='show_prototypes', help='Display Prototypes')
    parser.add_argument('-M', '--map', action='store_true', dest='show_map', help='Display Map')
