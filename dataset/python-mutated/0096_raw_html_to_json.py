...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(convert_products_html_to_json), migrations.RunPython(sanitize_descriptions_json), migrations.AlterField(model_name='product', name='description_json', field=SanitizedJSONField(blank=True, default=dict, sanitizer=clean_draft_js)), migrations.AlterField(model_name='producttranslation', name='description_json', field=SanitizedJSONField(blank=True, default=dict, sanitizer=clean_draft_js))]