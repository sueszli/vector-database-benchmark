...
import proto
__protobuf__ = proto.module(package='google.cloud.baremetalsolution.v2', manifest={'OSImage', 'ListOSImagesRequest', 'ListOSImagesResponse'})
...
class OSImage(proto.Message):
    ...
    code: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    applicable_instance_types: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
    supported_network_templates: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
...
class ListOSImagesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    os_images: MutableSequence['OSImage'] = proto.RepeatedField(proto.MESSAGE, number=1, message='OSImage')
