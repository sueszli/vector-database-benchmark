...
class KPCRScan(common.AbstractWindowsCommand):
    ...
    meta_info = dict(author='Bradley Schatz', copyright='Copyright (c) 2010 Bradley Schatz', contact='bradley@schatzforensic.com.au', license='GNU General Public License 2.0', url='http://www.schatzforensic.com.au/', os='WIN_32_VISTA_SP0', version='1.0')
