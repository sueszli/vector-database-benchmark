...
BROADCAST_PUBKEY = b'\xbe\x0e\xb0@\xad\xad~\xd7\xe3\xca\x96*k\x7f\x0b*\x96++\xb0{\x95+n~\xfdF\xc8\x88\xff\x06\x93cr\xb3\xcb@\xc8Y\xd5n\x98|\xec\x90$\xf2E\xf9\xbbyh:\x99"\xaf\xa2-\xc9os:\xb6\x88'
P2P_SEEDS = [('0.seeds.testnet.golem.network', 40102), ('0.seeds.testnet.golem.network', 40104), ('1.seeds.testnet.golem.network', 40102), ('1.seeds.testnet.golem.network', 40104), ('2.seeds.testnet.golem.network', 40102), ('2.seeds.testnet.golem.network', 40104), ('seeds.test.golem.network', 40102), ('seeds.test.golem.network', 40104)]
PROTOCOL_CONST.POSTFIX = '-' + TESTNET
PROTOCOL_CONST.patch_protocol_id(value=PROTOCOL_CONST.NUM)
APP_MANAGER_CONFIG_FILES = [os.path.join('apps', 'registered.ini'), os.path.join('apps', 'registered_test.ini')]
CONCENT_SUPPORTED_APPS = ('blender', 'blender_nvgpu')
TASK_API_ENVS = [DOCKER_CPU_ENV_ID, DOCKER_GPU_ENV_ID]