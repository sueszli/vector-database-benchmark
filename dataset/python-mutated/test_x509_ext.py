...
from cryptography.x509 import DNSName, NameConstraints, SubjectAlternativeName, ocsp
from cryptography.x509.extensions import ExtensionType, _key_identifier_from_public_key
...
class TestNameConstraintsExtension:
    ...
    def test_public_bytes(self):
        ...
        assert ext.public_bytes() == b'0)\xa0\x0f0\r\x82\x0bzombo.local\xa1\x160\x14\xa4\x120\x101\x0e0\x0c\x06\x03U\x04\x03\x0c\x05zombo'
...
class TestCRLDistributionPoints:
    ...
    def test_public_bytes(self):
        ...
        assert ext.public_bytes() == b"0'0%\xa0\x10\xa0\x0e\x86\x0cftp://domain\x81\x02\x05`\xa2\r\x86\x0buri://thing"
