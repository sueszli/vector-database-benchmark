...
AVAILABLE_PRIORITIES = [('0', 'Normal'), ('1', 'Low'), ('2', 'High'), ('3', 'Very High')]
...
class Stage(models.Model):
    ...
    team_id = fields.Many2one('crm.team', string='Team', ondelete='set null', help='Specific team that uses this stage. Other teams will not be able to see or use this stage.')
