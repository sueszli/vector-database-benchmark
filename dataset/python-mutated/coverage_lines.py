...
if __name__ == '__main__':
    ...
    if actual < expected:
        print('expected >= {} %, actual {} %, failed'.format(round(expected * 100, 1), round(actual * 100, 1)))
        sys.exit(1)
    print('expected >= {} %, actual {} %, passed'.format(round(expected * 100, 1), round(actual * 100, 1)))