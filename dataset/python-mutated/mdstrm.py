...
@pluginmatcher(re.compile('https://(?:www\\.)?latina\\.pe/tvenvivo'))
@pluginmatcher(re.compile('https://saltillo\\.multimedios\\.com/video'))
@pluginmatcher(re.compile('https://mdstrm\\.com/live-stream/\\w+'))
class MDStrm(Plugin):
