...
class FletAppManager:
    ...
    async def start(self):
        ...
        if not self.__evict_sessions_task:
            ...
            self.__evict_sessions_task = asyncio.create_task(self.__evict_expired_sessions())
            self.__evict_oauth_states_task = asyncio.create_task(self.__evict_expired_oauth_states())
    ...
    async def delete_session(self, session_id: str):
        ...
        if page is not None:
            ...
            try:
                ...
                logger.error(f'Error deleting expired session: {e} {traceback.format_exc()}')
