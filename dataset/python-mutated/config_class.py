...
from typing import TYPE_CHECKING, Any, Dict, Mapping, NamedTuple, Optional, Type, TypeVar, Union, overload
...
class ConfigurableClassData(NamedTuple('_ConfigurableClassData', [('module_name', str), ('class_name', str), ('config_yaml', str)])):
