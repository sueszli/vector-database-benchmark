...
@testing.parameterize(*testing.product_dict([{'dtype': numpy.float16, 'forward_options': {'rtol': 0.01, 'atol': 0.01}, 'backward_options': {'rtol': 0.01, 'atol': 0.01}, 'double_backward_options': {'rtol': 0.3, 'atol': 0.3}}, {'dtype': numpy.float32, 'forward_options': {'rtol': 0.01}, 'backward_options': {'rtol': 0.01, 'atol': 0.001}, 'double_backward_options': {'rtol': 0.01, 'atol': 0.001}}, {'dtype': numpy.float64, 'forward_options': {'rtol': 0.01}, 'backward_options': {'rtol': 0.01, 'atol': 0.001}, 'double_backward_options': {'rtol': 0.01, 'atol': 0.001}}], testing.product({'batchsize': [5, 10], 'input_dim': [2, 3], 'margin': [1, 2], 'reduce': ['mean', 'no'], 'label_dtype': [numpy.int32, numpy.int64]})))
