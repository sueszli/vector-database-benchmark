...
class Migration(migrations.Migration):
    dependencies = [('order', '0081_auto_20200406_0456'), ('warehouse', '0006_auto_20200228_0519')]
    operations = [migrations.AlterModelOptions(name='stock', options={'ordering': ('pk',)}), migrations.CreateModel(name='Allocation', fields=[('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')), ('quantity_allocated', models.PositiveIntegerField(default=0)), ('order_line', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allocations', to='order.OrderLine')), ('stock', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allocations', to='warehouse.Stock'))], options={'ordering': ('pk',), 'unique_together': {('order_line', 'stock')}}), migrations.RunPython(create_allocations), migrations.RemoveField(model_name='stock', name='quantity_allocated')]