...
args = [['dizoo.classic_control.cartpole.config.cartpole_ppo_config', 'ppo'], ['dizoo.classic_control.cartpole.config.cartpole_a2c_config', 'a2c'], ['dizoo.classic_control.cartpole.config.cartpole_c51_config', 'c51']]
