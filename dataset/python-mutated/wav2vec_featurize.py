...
if __name__ == '__main__':
    ...
    for split in args.split:
        writer = EmbeddingDatasetWriter(input_root=args.input, output_root=args.output, split=split, model_fname=args.model, gpu=args.gpu, extension=args.ext, use_feat=args.use_feat)
        print(writer)
