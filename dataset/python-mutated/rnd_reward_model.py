...
class RndRewardModel(BaseRewardModel):
    ...
    Config:
        ...
        == ====================  =====  =============  =======================================  =======================
    """
    config = dict(type='rnd', intrinsic_reward_type='add', learning_rate=0.001, batch_size=64, hidden_size_list=[64, 64, 128], update_per_collect=100, obs_norm=True, obs_norm_clamp_min=-1, obs_norm_clamp_max=1, intrinsic_reward_weight=0.01, extrinsic_reward_norm=True, extrinsic_reward_norm_max=1)
