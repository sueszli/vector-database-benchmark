...
@parameterized_class(('template_path',), [('/testdata/start_api/template.yaml',), ('/testdata/start_api/nested-templates/template-parent.yaml',), ('/testdata/start_api/cdk/template_cdk.yaml',)])
...
@parameterized_class(('template_path',), [('/testdata/start_api/template.yaml',), ('/testdata/start_api/cdk/template_cdk.yaml',)])
...
@parameterized_class(('template_path',), [('/testdata/start_api/template-http-api.yaml',), ('/testdata/start_api/nested-templates/template-http-api-parent.yaml',)])
...
@parameterized_class(('template_path',), [('/testdata/start_api/cfn-http-api-with-normal-and-default-routes.yaml',), ('/testdata/start_api/nested-templates/cfn-http-api-with-normal-and-default-routes-parent.yaml',)])
...
@parameterized_class(('template_path',), [('/testdata/start_api/cfn-http-api-and-rest-api-gateways.yaml',), ('/testdata/start_api/nested-templates/cfn-http-api-and-rest-api-gateways-parent.yaml',)])
...
@parameterized_class(('template_path',), [('/testdata/start_api/template.yaml',), ('/testdata/start_api/nested-templates/template-parent.yaml',)])
class TestServiceWithCustomInvokeImages(StartApiIntegBaseClass):
    ...
    """
    invoke_image = ['amazon/aws-sam-cli-emulation-image-python3.9', 'HelloWorldFunction=public.ecr.aws/sam/emulation-python3.9']
