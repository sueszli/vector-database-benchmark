...
from google.cloud.retail_v2.services.prediction_service import PredictionServiceAsyncClient, PredictionServiceClient, transports
from google.cloud.retail_v2.types import common, prediction_service, product, promotion, user_event
...
@pytest.mark.parametrize('client_class,transport_name', [(PredictionServiceClient, 'grpc'), (PredictionServiceAsyncClient, 'grpc_asyncio'), (PredictionServiceClient, 'rest')])
...
@pytest.mark.parametrize('transport_class,transport_name', [(transports.PredictionServiceGrpcTransport, 'grpc'), (transports.PredictionServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (transports.PredictionServiceRestTransport, 'rest')])
...
def test_prediction_service_client_get_transport_class():
    ...
    available_transports = [transports.PredictionServiceGrpcTransport, transports.PredictionServiceRestTransport]
...
@pytest.mark.parametrize('client_class,transport_class,transport_name', [(PredictionServiceClient, transports.PredictionServiceGrpcTransport, 'grpc'), (PredictionServiceAsyncClient, transports.PredictionServiceGrpcAsyncIOTransport, 'grpc_asyncio'), (PredictionServiceClient, transports.PredictionServiceRestTransport, 'rest')])
...
@pytest.mark.parametrize('client_class,transport_class,transport_name,use_client_cert_env', [(PredictionServiceClient, transports.PredictionServiceGrpcTransport, 'grpc', 'true'), (PredictionServiceAsyncClient, transports.PredictionServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'true'), (PredictionServiceClient, transports.PredictionServiceGrpcTransport, 'grpc', 'false'), (PredictionServiceAsyncClient, transports.PredictionServiceGrpcAsyncIOTransport, 'grpc_asyncio', 'false'), (PredictionServiceClient, transports.PredictionServiceRestTransport, 'rest', 'true'), (PredictionServiceClient, transports.PredictionServiceRestTransport, 'rest', 'false')])
@mock.patch.object(PredictionServiceClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PredictionServiceClient))
@mock.patch.object(PredictionServiceAsyncClient, 'DEFAULT_ENDPOINT', modify_default_endpoint(PredictionServiceAsyncClient))
...
def test_prediction_service_client_client_options_from_dict():
    ...
    with mock.patch('google.cloud.retail_v2.services.prediction_service.transports.PredictionServiceGrpcTransport.__init__') as grpc_transport:
        ...
        client = PredictionServiceClient(client_options={'api_endpoint': 'squid.clam.whelk'})
        grpc_transport.assert_called_once_with(credentials=None, credentials_file=None, host='squid.clam.whelk', scopes=None, client_cert_source_for_mtls=None, quota_project_id=None, client_info=transports.base.DEFAULT_CLIENT_INFO, always_use_jwt_access=True, api_audience=None)

@pytest.mark.parametrize('client_class,transport_class,transport_name,grpc_helpers', [(PredictionServiceClient, transports.PredictionServiceGrpcTransport, 'grpc', grpc_helpers), (PredictionServiceAsyncClient, transports.PredictionServiceGrpcAsyncIOTransport, 'grpc_asyncio', grpc_helpers_async)])
...
def test_predict(request_type, transport: str='grpc'):
    if False:
        while True:
            i = 10
    client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.predict), '__call__') as call:
        call.return_value = prediction_service.PredictResponse(attribution_token='attribution_token_value', missing_ids=['missing_ids_value'], validate_only=True)
...
def test_predict_empty_call():
    if False:
        print('Hello World!')
    client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc')
    with mock.patch.object(type(client.transport.predict), '__call__') as call:
        client.predict()
        call.assert_called()
        (_, args, _) = call.mock_calls[0]
...
async def test_predict_async(transport: str='grpc_asyncio', request_type=prediction_service.PredictRequest):
    client = PredictionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    request = request_type()
    with mock.patch.object(type(client.transport.predict), '__call__') as call:
        call.return_value = grpc_helpers_async.FakeUnaryUnaryCall(prediction_service.PredictResponse(attribution_token='attribution_token_value', missing_ids=['missing_ids_value'], validate_only=True))
...
async def test_predict_field_headers_async():
    client = PredictionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials())
    request = prediction_service.PredictRequest()
    request.placement = 'placement_value'
    with mock.patch.object(type(client.transport.predict), '__call__') as call:
...
def test_predict_rest(request_type):
    if False:
        print('Hello World!')
    client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport='rest')
    request_init = {'placement': 'projects/sample1/locations/sample2/catalogs/sample3/placements/sample4'}
    request = request_type(**request_init)
    with mock.patch.object(type(client.transport._session), 'request') as req:
        return_value = prediction_service.PredictResponse(attribution_token='attribution_token_value', missing_ids=['missing_ids_value'], validate_only=True)
...
def test_predict_rest_interceptors(null_interceptor):
    if False:
        print('Hello World!')
    transport = transports.PredictionServiceRestTransport(credentials=ga_credentials.AnonymousCredentials(), interceptor=None if null_interceptor else transports.PredictionServiceRestInterceptor())
    client = PredictionServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), 'request') as req, mock.patch.object(path_template, 'transcode') as transcode, mock.patch.object(transports.PredictionServiceRestInterceptor, 'post_predict') as post, mock.patch.object(transports.PredictionServiceRestInterceptor, 'pre_predict') as pre:
...
def test_credentials_transport_error():
    if False:
        return 10
    transport = transports.PredictionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), transport=transport)
    transport = transports.PredictionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionServiceClient(client_options={'credentials_file': 'credentials.json'}, transport=transport)
    transport = transports.PredictionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    ...
    options.api_key = 'api_key'
    with pytest.raises(ValueError):
        client = PredictionServiceClient(client_options=options, credentials=ga_credentials.AnonymousCredentials())
    transport = transports.PredictionServiceGrpcTransport(credentials=ga_credentials.AnonymousCredentials())
    with pytest.raises(ValueError):
        client = PredictionServiceClient(client_options={'scopes': ['1', '2']}, transport=transport)
...
def test_transport_get_channel():
    ...
    assert channel
    transport = transports.PredictionServiceGrpcAsyncIOTransport(credentials=ga_credentials.AnonymousCredentials())
    channel = transport.grpc_channel
    assert channel

@pytest.mark.parametrize('transport_class', [transports.PredictionServiceGrpcTransport, transports.PredictionServiceGrpcAsyncIOTransport, transports.PredictionServiceRestTransport])
...
def test_transport_kind(transport_name):
    if False:
        while True:
            i = 10
    transport = PredictionServiceClient.get_transport_class(transport_name)(credentials=ga_credentials.AnonymousCredentials())
...
def test_prediction_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2.services.prediction_service.transports.PredictionServiceTransport.__init__') as Transport:
        ...
        transport = transports.PredictionServiceTransport(credentials=ga_credentials.AnonymousCredentials())
    methods = ('predict', 'get_operation', 'list_operations')
...
def test_prediction_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2.services.prediction_service.transports.PredictionServiceTransport._prep_wrapped_messages') as Transport:
        ...
        transport = transports.PredictionServiceTransport(credentials_file='credentials.json', quota_project_id='octopus')
...
@pytest.mark.parametrize('transport_class,grpc_helpers', [(transports.PredictionServiceGrpcTransport, grpc_helpers), (transports.PredictionServiceGrpcAsyncIOTransport, grpc_helpers_async)])
...
def test_prediction_service_http_transport_client_cert_source_for_mtls():
    ...
    with mock.patch('google.auth.transport.requests.AuthorizedSession.configure_mtls_channel') as mock_configure_mtls_channel:
        transports.PredictionServiceRestTransport(credentials=cred, client_cert_source_for_mtls=client_cert_source_callback)
...
def test_prediction_service_host_no_port(transport_name):
    if False:
        return 10
    client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='retail.googleapis.com'), transport=transport_name)
    assert client.transport._host == ('retail.googleapis.com:443' if transport_name in ['grpc', 'grpc_asyncio'] else 'https://retail.googleapis.com')
...
def test_prediction_service_host_with_port(transport_name):
    if False:
        return 10
    client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_options=client_options.ClientOptions(api_endpoint='retail.googleapis.com:8000'), transport=transport_name)
...
def test_prediction_service_client_transport_session_collision(transport_name):
    ...
    client1 = PredictionServiceClient(credentials=creds1, transport=transport_name)
    client2 = PredictionServiceClient(credentials=creds2, transport=transport_name)
...
def test_prediction_service_grpc_transport_channel():
    ...
    transport = transports.PredictionServiceGrpcTransport(host='squid.clam.whelk', channel=channel)
...
def test_prediction_service_grpc_asyncio_transport_channel():
    ...
    transport = transports.PredictionServiceGrpcAsyncIOTransport(host='squid.clam.whelk', channel=channel)
    assert transport.grpc_channel == channel
    assert transport._host == 'squid.clam.whelk:443'
    assert transport._ssl_channel_credentials == None

@pytest.mark.parametrize('transport_class', [transports.PredictionServiceGrpcTransport, transports.PredictionServiceGrpcAsyncIOTransport])
def test_prediction_service_transport_channel_mtls_with_client_cert_source(transport_class):
    if False:
        return 10
...
def test_parse_product_path():
    if False:
        i = 10
        return i + 15
    expected = {'project': 'nudibranch', 'location': 'cuttlefish', 'catalog': 'mussel', 'branch': 'winkle', 'product': 'nautilus'}
...
def test_client_with_default_client_info():
    ...
    with mock.patch.object(transports.PredictionServiceTransport, '_prep_wrapped_messages') as prep:
        client = PredictionServiceClient(credentials=ga_credentials.AnonymousCredentials(), client_info=client_info)
...
async def test_transport_close_async():
    client = PredictionServiceAsyncClient(credentials=ga_credentials.AnonymousCredentials(), transport='grpc_asyncio')
...
@pytest.mark.parametrize('client_class,transport_class', [(PredictionServiceClient, transports.PredictionServiceGrpcTransport), (PredictionServiceAsyncClient, transports.PredictionServiceGrpcAsyncIOTransport)])
