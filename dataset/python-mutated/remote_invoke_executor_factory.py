...
from samcli.lib.remote_invoke.lambda_invoke_executors import DefaultConvertToJSON, LambdaInvokeExecutor, LambdaInvokeWithResponseStreamExecutor, LambdaResponseConverter, LambdaStreamResponseConverter, _is_function_invoke_mode_response_stream
from samcli.lib.remote_invoke.remote_invoke_executors import RemoteInvokeConsumer, RemoteInvokeExecutor, RemoteInvokeLogOutput, RemoteInvokeOutputFormat, RemoteInvokeResponse, ResponseObjectToJsonStringMapper
from samcli.lib.remote_invoke.sqs_invoke_executors import SqsSendMessageExecutor
from samcli.lib.remote_invoke.stepfunctions_invoke_executors import SfnDescribeExecutionResponseConverter, StepFunctionsStartExecutionExecutor
...
class RemoteInvokeExecutorFactory:
    ...
    REMOTE_INVOKE_EXECUTOR_MAPPING: Dict[str, Callable[['RemoteInvokeExecutorFactory', CloudFormationResourceSummary, RemoteInvokeOutputFormat, RemoteInvokeConsumer[RemoteInvokeResponse], RemoteInvokeConsumer[RemoteInvokeLogOutput]], RemoteInvokeExecutor]] = {AWS_LAMBDA_FUNCTION: _create_lambda_boto_executor, AWS_STEPFUNCTIONS_STATEMACHINE: _create_stepfunctions_boto_executor, AWS_SQS_QUEUE: _create_sqs_boto_executor, AWS_KINESIS_STREAM: _create_kinesis_boto_executor}