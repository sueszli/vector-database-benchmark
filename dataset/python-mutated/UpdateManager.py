...
class UpdateManager(BaseAddon):
    ...
    __version__ = '1.21'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('checkinterval', 'int', 'Check interval in hours', 6), ('autorestart', 'bool', 'Auto-restart pyLoad when required', True), ('checkonstart', 'bool', 'Check for updates on startup', True), ('checkperiod', 'bool', 'Check for updates periodically', True), ('reloadplugins', 'bool', 'Monitor plugin code changes in debug mode', True), ('nodebugupdate', 'bool', "Don't update plugins in debug mode", False)]
    __description__ = 'Check for updates'
    __license__ = 'GPLv3'
    __authors__ = [('Walter Purcaro', 'vuolter@gmail.com')]
    _VERSION = re.compile('\\s*__version__\\s*=\\s*("|\\\')([\\d.]+)\\1', re.M)
    SERVER_URL = 'https://raw.githubusercontent.com/pyload/updates/master/plugins.txt'
    MIN_CHECK_INTERVAL = timedelta(hours=3).total_seconds()
