...
from typing import TYPE_CHECKING, AbstractSet, Callable, Dict, FrozenSet, Generic, Hashable, Iterable, List, Mapping, MutableSet, NamedTuple, Optional, Sequence, Set, Tuple, TypeVar
...
class OpSelectionData(NamedTuple('_OpSelectionData', [('op_selection', Sequence[str]), ('resolved_op_selection', AbstractSet[str]), ('parent_job_def', 'JobDefinition')])):
...
class AssetSelectionData(NamedTuple('_AssetSelectionData', [('asset_selection', AbstractSet[AssetKey]), ('asset_check_selection', Optional[AbstractSet[AssetCheckKey]]), ('parent_job_def', 'JobDefinition')])):
