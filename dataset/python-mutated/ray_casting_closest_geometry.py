...
if __name__ == '__main__':
    cube = o3d.t.geometry.TriangleMesh.from_legacy(o3d.geometry.TriangleMesh.create_box().translate([-1.2, -1.2, 0]))
    sphere = o3d.t.geometry.TriangleMesh.from_legacy(o3d.geometry.TriangleMesh.create_sphere(0.5).translate([0.7, 0.8, 0]))
    ...
    print('Visualizing sdf and closest geometry at each point for a cube and sphere ...')
