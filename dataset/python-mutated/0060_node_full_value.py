...
class Migration(migrations.Migration):
    dependencies = [('assets', '0059_auto_20201027_1905')]
    operations = [migrations.AddField(model_name='node', name='full_value', field=models.CharField(default='', max_length=4096, verbose_name='Full value')), migrations.RunPython(migrate_nodes_value_with_slash), migrations.RunPython(migrate_nodes_full_value)]