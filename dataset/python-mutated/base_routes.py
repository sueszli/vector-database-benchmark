...
from robyn import Request, Response, Robyn, WebSocket, jsonify, serve_file, serve_html, WebSocketConnector
...
async def async_dict_get():
    return {'status_code': 200, 'description': 'async dict get', 'type': 'text', 'headers': {'async': 'dict'}}
...
async def async_dict_const_get():
    return {'status_code': 200, 'description': 'async dict const get', 'type': 'text', 'headers': {'async_const': 'dict'}}
...
async def async_octet_response_get():
    return Response(status_code=200, headers={'Content-Type': 'application/octet-stream'}, description='async octet response')
...
@app.get('/307')
async def redirect():
    return {'status_code': 307, 'description': '', 'type': 'text', 'headers': {'Location': 'redirect_route'}}
...
async def async_dict_post():
    return {'status_code': 200, 'description': 'async dict post', 'type': 'text', 'headers': {'async': 'dict'}}
...
async def async_dict_put():
    return {'status_code': 200, 'description': 'async dict put', 'type': 'text', 'headers': {'async': 'dict'}}
...
async def async_dict_delete():
    return {'status_code': 200, 'description': 'async dict delete', 'type': 'text', 'headers': {'async': 'dict'}}
...
async def async_dict_patch():
    return {'status_code': 200, 'description': 'async dict patch', 'type': 'text', 'headers': {'async': 'dict'}}
