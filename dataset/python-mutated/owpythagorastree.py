...
from Orange.widgets.visualize.pythagorastreeviewer import PythagorasTreeViewer, SquareGraphicsItem, ContinuousTreeNode
from Orange.widgets.visualize.utils.owlegend import AnchorableGraphicsView, Anchorable, OWDiscreteLegend, OWContinuousLegend
from Orange.widgets.visualize.utils.scene import UpdateItemsOnSelectGraphicsScene
...
from Orange.widgets.visualize.utils.view import PannableGraphicsView, ZoomableGraphicsView, PreventDefaultWheelEvent
...
class OWPythagorasTree(OWWidget):
    ...
    LEGEND_OPTIONS = {'corner': Anchorable.BOTTOM_RIGHT, 'offset': (10, 10)}
...
class TreeGraphicsView(PannableGraphicsView, ZoomableGraphicsView, AnchorableGraphicsView, PreventDefaultWheelEvent):
