import pytest
import cupy
from cupy.testing import assert_allclose, assert_array_equal as assert_equal, assert_array_almost_equal as assert_almost_equal, assert_array_equal, assert_array_almost_equal
