...
async def test_write_payload_chunked(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
...
async def test_write_payload_chunked_multiple(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
    await msg.write(b'data1')
    await msg.write(b'data2')
...
async def test_write_payload_chunked_filter(protocol: Any, transport: Any, loop: Any) -> None:
    write = transport.write = mock.Mock()
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
...
async def test_write_payload_chunked_filter_mutiple_chunks(protocol: Any, transport: Any, loop: Any) -> None:
    write = transport.write = mock.Mock()
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
    await msg.write(b'da')
...
async def test_write_payload_deflate_compression(protocol: Any, transport: Any, loop: Any) -> None:
...
async def test_write_payload_deflate_and_chunked(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.enable_compression('deflate')
    msg.enable_chunking()
    await msg.write(b'da')
...
async def test_write_payload_bytes_memoryview(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
...
async def test_write_payload_short_ints_memoryview(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
...
async def test_write_payload_2d_shape_memoryview(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.enable_chunking()
...
async def test_write_payload_slicing_long_memoryview(buf: Any, protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
    msg.length = 4
    mv = memoryview(b'ABCDEF')
    payload = mv.cast('c', [3, 2])
...
async def test_write_eof_calls_callback(protocol: Any, transport: Any, loop: Any) -> None:
    on_chunk_sent = make_mocked_coro()
    msg = http.StreamWriter(protocol, loop, on_chunk_sent=on_chunk_sent)
    chunk = b'1'
...
async def test_write_to_closing_transport(protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
...
async def test_write_to_closed_transport(protocol: Any, transport: Any, loop: Any) -> None:
...
async def test_write_headers_prevents_injection(protocol: Any, transport: Any, loop: Any) -> None:
    msg = http.StreamWriter(protocol, loop)
