...
INCLUDE_EXTENSIONS = {'bat', 'c', 'cpp', 'css', 'csv', 'gitignore', 'gitattributes', 'html', 'in', 'ini', 'js', 'md', 'py', 'pyx', 'qss', 'R', 'rst', 'sh', 'txt', 'xml', 'yml'}
EXCLUDE_PATHS = ['/tests?/(?!(tests?_|__init__|fixture))', '/mathjax/', '^\\.github/ISSUE_TEMPLATE\\.md$', '^spyder/defaults/.*\\.ini$', '^CHANGELOG.md$']
