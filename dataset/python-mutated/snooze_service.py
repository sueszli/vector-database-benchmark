...
__protobuf__ = proto.module(package='google.monitoring.v3', manifest={'CreateSnoozeRequest', 'ListSnoozesRequest', 'ListSnoozesResponse', 'GetSnoozeRequest', 'UpdateSnoozeRequest'})

class CreateSnoozeRequest(proto.Message):
    """The message definition for creating a ``Snooze``. Users must provide
    ...
    snooze: gm_snooze.Snooze = proto.Field(proto.MESSAGE, number=2, message=gm_snooze.Snooze)

class ListSnoozesRequest(proto.Message):
    """The message definition for listing ``Snooze``\\ s associated with the
...
class ListSnoozesResponse(proto.Message):
    """The results of a successful ``ListSnoozes`` call, containing the
    matching ``Snooze``\\ s.
    ...
    def raw_page(self):
        if False:
            for i in range(10):
                print('nop')
        return self
    snoozes: MutableSequence[gm_snooze.Snooze] = proto.RepeatedField(proto.MESSAGE, number=1, message=gm_snooze.Snooze)
    next_page_token: str = proto.Field(proto.STRING, number=2)

class GetSnoozeRequest(proto.Message):
    """The message definition for retrieving a ``Snooze``. Users must
...
class UpdateSnoozeRequest(proto.Message):
    """The message definition for updating a ``Snooze``. The field,
    ...
    Attributes:
        ...
        update_mask (google.protobuf.field_mask_pb2.FieldMask):
            ...
            can be updated.
    """
    snooze: gm_snooze.Snooze = proto.Field(proto.MESSAGE, number=1, message=gm_snooze.Snooze)
