...
from localstack.services.lambda_.invocation.executor_endpoint import INVOCATION_PORT, ExecutorEndpoint
from localstack.services.lambda_.invocation.lambda_models import IMAGE_MAPPING, FunctionVersion
from localstack.services.lambda_.invocation.runtime_executor import LambdaRuntimeException, RuntimeExecutor
from localstack.services.lambda_.lambda_utils import HINT_LOG
from localstack.services.lambda_.networking import get_all_container_networks_for_lambda, get_main_endpoint_from_container
from localstack.services.lambda_.packages import lambda_runtime_package
from localstack.utils.container_networking import get_main_container_name
from localstack.utils.container_utils.container_client import ContainerConfiguration, DockerNotAvailable, DockerPlatform, NoSuchContainer, NoSuchImage, PortMappings, VolumeBind, VolumeMappings
...
ARCHITECTURE_PLATFORM_MAPPING: dict[Architecture, DockerPlatform] = dict({Architecture.x86_64: DockerPlatform.linux_amd64, Architecture.arm64: DockerPlatform.linux_arm64})
