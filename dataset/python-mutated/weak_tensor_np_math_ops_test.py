...
_NP_to_TF_result_inferred_types = {np.dtype(np.int32): dtypes.int32, np.dtype(np.int64): dtypes.int32, np.dtype(np.float32): dtypes.float32, np.dtype(np.float64): dtypes.float32, np.dtype(np.complex128): dtypes.complex128}
