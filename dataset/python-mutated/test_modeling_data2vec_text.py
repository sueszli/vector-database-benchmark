...
if is_torch_available():
    import torch
    from transformers import Data2VecTextForCausalLM, Data2VecTextForMaskedLM, Data2VecTextForMultipleChoice, Data2VecTextForQuestionAnswering, Data2VecTextForSequenceClassification, Data2VecTextForTokenClassification, Data2VecTextModel
    from transformers.models.data2vec.modeling_data2vec_text import DATA2VEC_TEXT_PRETRAINED_MODEL_ARCHIVE_LIST, Data2VecTextForTextEmbeddings, create_position_ids_from_input_ids
...
class Data2VecTextModelTest(ModelTesterMixin, GenerationTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (Data2VecTextForCausalLM, Data2VecTextForMaskedLM, Data2VecTextModel, Data2VecTextForSequenceClassification, Data2VecTextForTokenClassification, Data2VecTextForMultipleChoice, Data2VecTextForQuestionAnswering) if is_torch_available() else ()
    all_generative_model_classes = (Data2VecTextForCausalLM,) if is_torch_available() else ()
    pipeline_model_mapping = {'feature-extraction': Data2VecTextModel, 'fill-mask': Data2VecTextForMaskedLM, 'question-answering': Data2VecTextForQuestionAnswering, 'text-classification': Data2VecTextForSequenceClassification, 'text-generation': Data2VecTextForCausalLM, 'token-classification': Data2VecTextForTokenClassification, 'zero-shot': Data2VecTextForSequenceClassification} if is_torch_available() else {}
