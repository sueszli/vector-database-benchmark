...
ax = fig.add_axes([0, 0, 1, 1], frameon=False, aspect=1, xlim=(0 - 5, 100 + 10), ylim=(-10, 80 + 5), xticks=[], yticks=[])
box = mpatches.FancyBboxPatch((0, 0), 100, 83, mpatches.BoxStyle('Round', pad=0, rounding_size=2), linewidth=1.0, facecolor='0.9', edgecolor='black')
ax.add_artist(box)
box = mpatches.FancyBboxPatch((0, 0), 100, 75, mpatches.BoxStyle('Round', pad=0, rounding_size=0), linewidth=1.0, facecolor='white', edgecolor='black')
ax.add_artist(box)
box = mpatches.Rectangle((5, 5), 45, 30, zorder=10, linewidth=1.0, facecolor='white', edgecolor='black')
ax.add_artist(box)
box = mpatches.Rectangle((5, 40), 45, 30, zorder=10, linewidth=1.0, facecolor='white', edgecolor='black')
ax.add_artist(box)
box = mpatches.Rectangle((55, 5), 40, 65, zorder=10, linewidth=1.0, facecolor='white', edgecolor='black')
ax.add_artist(box)
...
int_arrow((0, -5), (100, -5))
ax.text(50, -5, 'figure width', backgroundcolor='white', zorder=30, ha='center', va='center', size='x-small')
int_arrow((105, 0), (105, 75))
ax.text(105, 75 / 2, 'figure height', backgroundcolor='white', zorder=30, rotation='vertical', ha='center', va='center', size='x-small')
int_arrow((55, 62.5), (95, 62.5))
ax.text(75, 62.5, 'axes width', backgroundcolor='white', zorder=30, ha='center', va='center', size='x-small')
int_arrow((62.5, 5), (62.5, 70))
ax.text(62.5, 35, 'axes height', backgroundcolor='white', zorder=30, rotation='vertical', ha='center', va='center', size='x-small')
