...
from zerver.models import Realm, RealmUserDefault, Service, Subscription, UserProfile, get_bot_services, get_realm, get_stream, get_user, is_cross_realm_bot_email
...
def _check_string(var_name: str, val: str) -> Optional[str]:
    ...
    return None
stripe_sample_config_options = [WebhookIntegration('stripe', ['financial'], display_name='Stripe', config_options=[('Stripe API key', 'stripe_api_key', _check_string)])]
