...
class CrooksAndLiarsIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<(?:iframe[^>]+src|param[^>]+value)=(["\\\'])(?P<url>(?:https?:)?//embed\\.crooksandliars\\.com/(?:embed|v)/.+?)\\1']
    _TESTS = [{'url': 'https://embed.crooksandliars.com/embed/8RUoRhRi', 'info_dict': {'id': '8RUoRhRi', 'ext': 'mp4', 'title': 'Fox & Friends Says Protecting Atheists From Discrimination Is Anti-Christian!', 'description': 'md5:e1a46ad1650e3a5ec7196d432799127f', 'thumbnail': 're:^https?://.*\\.jpg', 'timestamp': 1428207000, 'upload_date': '20150405', 'uploader': 'Heather', 'duration': 236}}, {'url': 'http://embed.crooksandliars.com/v/MTE3MjUtMzQ2MzA', 'only_matching': True}]
