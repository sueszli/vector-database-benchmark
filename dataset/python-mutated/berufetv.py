...
class BerufeTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://web.arbeitsagentur.de/berufetv/studienberufe/wirtschaftswissenschaften/wirtschaftswissenschaften-volkswirtschaft/film;filmId=DvKC3DUpMKvUZ_6fEnfg3u', 'md5': '041b6432ec8e6838f84a5c30f31cc795', 'info_dict': {'id': 'DvKC3DUpMKvUZ_6fEnfg3u', 'ext': 'mp4', 'title': 'Volkswirtschaftslehre', 'description': 'md5:6bd87d0c63163480a6489a37526ee1c1', 'categories': ['Studien&shy;beruf'], 'tags': ['Studienfilm'], 'duration': 602.44, 'thumbnail': 're:^https://asset-out-cdn\\.video-cdn\\.net/private/videos/DvKC3DUpMKvUZ_6fEnfg3u/thumbnails/793063\\?quality=thumbnail&__token__=[^\\s]+$'}}]
