...
class Instance(proto.Message):
    ...
    location_id: str = proto.Field(proto.STRING, number=4)
    alternative_location_id: str = proto.Field(proto.STRING, number=5)
    redis_version: str = proto.Field(proto.STRING, number=7)
    reserved_ip_range: str = proto.Field(proto.STRING, number=9)
    secondary_ip_range: str = proto.Field(proto.STRING, number=30)
    host: str = proto.Field(proto.STRING, number=10)
    port: int = proto.Field(proto.INT32, number=11)
    current_location_id: str = proto.Field(proto.STRING, number=12)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=13, message=timestamp_pb2.Timestamp)
    state: State = proto.Field(proto.ENUM, number=14, enum=State)
    status_message: str = proto.Field(proto.STRING, number=15)
    redis_configs: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=16)
    tier: Tier = proto.Field(proto.ENUM, number=17, enum=Tier)
    memory_size_gb: int = proto.Field(proto.INT32, number=18)
    authorized_network: str = proto.Field(proto.STRING, number=20)
    persistence_iam_identity: str = proto.Field(proto.STRING, number=21)
    connect_mode: ConnectMode = proto.Field(proto.ENUM, number=22, enum=ConnectMode)
    auth_enabled: bool = proto.Field(proto.BOOL, number=23)
    server_ca_certs: MutableSequence['TlsCertificate'] = proto.RepeatedField(proto.MESSAGE, number=25, message='TlsCertificate')
    transit_encryption_mode: TransitEncryptionMode = proto.Field(proto.ENUM, number=26, enum=TransitEncryptionMode)
    maintenance_policy: 'MaintenancePolicy' = proto.Field(proto.MESSAGE, number=27, message='MaintenancePolicy')
    maintenance_schedule: 'MaintenanceSchedule' = proto.Field(proto.MESSAGE, number=28, message='MaintenanceSchedule')
    replica_count: int = proto.Field(proto.INT32, number=31)
    nodes: MutableSequence['NodeInfo'] = proto.RepeatedField(proto.MESSAGE, number=32, message='NodeInfo')
    read_endpoint: str = proto.Field(proto.STRING, number=33)
    read_endpoint_port: int = proto.Field(proto.INT32, number=34)
    read_replicas_mode: ReadReplicasMode = proto.Field(proto.ENUM, number=35, enum=ReadReplicasMode)
    customer_managed_key: str = proto.Field(proto.STRING, number=36)
    persistence_config: 'PersistenceConfig' = proto.Field(proto.MESSAGE, number=37, message='PersistenceConfig')
    suspension_reasons: MutableSequence[SuspensionReason] = proto.RepeatedField(proto.ENUM, number=38, enum=SuspensionReason)
    maintenance_version: str = proto.Field(proto.STRING, number=39)
    available_maintenance_versions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=40)
...
class PersistenceConfig(proto.Message):
    ...
    class SnapshotPeriod(proto.Enum):
        ...
        TWELVE_HOURS = 5
        TWENTY_FOUR_HOURS = 6
    persistence_mode: PersistenceMode = proto.Field(proto.ENUM, number=1, enum=PersistenceMode)
    rdb_snapshot_period: SnapshotPeriod = proto.Field(proto.ENUM, number=2, enum=SnapshotPeriod)
    rdb_next_snapshot_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    rdb_snapshot_start_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
...
class RescheduleMaintenanceRequest(proto.Message):
    ...
    class RescheduleType(proto.Enum):
        ...
        SPECIFIC_TIME = 3
    name: str = proto.Field(proto.STRING, number=1)
    reschedule_type: RescheduleType = proto.Field(proto.ENUM, number=2, enum=RescheduleType)
    schedule_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
...
class MaintenancePolicy(proto.Message):
    ...
    weekly_maintenance_window: MutableSequence['WeeklyMaintenanceWindow'] = proto.RepeatedField(proto.MESSAGE, number=4, message='WeeklyMaintenanceWindow')
...
class WeeklyMaintenanceWindow(proto.Message):
    ...
    """
    day: dayofweek_pb2.DayOfWeek = proto.Field(proto.ENUM, number=1, enum=dayofweek_pb2.DayOfWeek)
    start_time: timeofday_pb2.TimeOfDay = proto.Field(proto.MESSAGE, number=2, message=timeofday_pb2.TimeOfDay)
    duration: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, message=duration_pb2.Duration)
...
class MaintenanceSchedule(proto.Message):
    ...
    can_reschedule: bool = proto.Field(proto.BOOL, number=3)
    schedule_deadline_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=5, message=timestamp_pb2.Timestamp)
...
class ListInstancesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    instances: MutableSequence['Instance'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Instance')
...
class InstanceAuthString(proto.Message):
    ...
    """
    auth_string: str = proto.Field(proto.STRING, number=1)
...
class CreateInstanceRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    instance_id: str = proto.Field(proto.STRING, number=2)
    instance: 'Instance' = proto.Field(proto.MESSAGE, number=3, message='Instance')
...
class UpdateInstanceRequest(proto.Message):
    ...
    instance: 'Instance' = proto.Field(proto.MESSAGE, number=2, message='Instance')
...
class UpgradeInstanceRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    redis_version: str = proto.Field(proto.STRING, number=2)
...
class ImportInstanceRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    input_config: 'InputConfig' = proto.Field(proto.MESSAGE, number=3, message='InputConfig')
...
class ExportInstanceRequest(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    output_config: 'OutputConfig' = proto.Field(proto.MESSAGE, number=3, message='OutputConfig')
...
class FailoverInstanceRequest(proto.Message):
    ...
    class DataProtectionMode(proto.Enum):
        """Specifies different modes of operation in relation to the
        data retention.
        ...
        FORCE_DATA_LOSS = 2
    name: str = proto.Field(proto.STRING, number=1)
    data_protection_mode: DataProtectionMode = proto.Field(proto.ENUM, number=2, enum=DataProtectionMode)
...
class TlsCertificate(proto.Message):
    ...
    """
    serial_number: str = proto.Field(proto.STRING, number=1)
    cert: str = proto.Field(proto.STRING, number=2)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    expire_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    sha1_fingerprint: str = proto.Field(proto.STRING, number=5)
