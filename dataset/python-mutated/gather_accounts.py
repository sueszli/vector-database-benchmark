...
__all__ = ['GatherAccountsAutomationViewSet', 'GatherAccountsExecutionViewSet', 'GatheredAccountViewSet']
...
class GatherAccountsExecutionViewSet(AutomationExecutionViewSet):
    rbac_perms = (('list', 'accounts.view_gatheraccountsexecution'), ('retrieve', 'accounts.view_gatheraccountsexecution'), ('create', 'accounts.add_gatheraccountsexecution'))
...
class GatheredAccountViewSet(OrgBulkModelViewSet):
    ...
    serializer_classes = {'default': serializers.GatheredAccountSerializer}
    rbac_perms = {'sync_accounts': 'assets.add_gatheredaccount'}
