...
SERVER_STARTUP_STRING = '!bash ppython -c ' + '"import builtins; ' + "builtins.clusterMode = 'server';" + 'builtins.clusterServerPort = %s;' + 'builtins.clusterSyncFlag = %d;' + "builtins.clusterDaemonClient = '%s';" + 'builtins.clusterDaemonPort = %d;from direct.directbase.DirectStart import *; run()"'
