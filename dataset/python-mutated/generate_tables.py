...
tool_infos = [ToolInfo('Brick Daemon', 'brickd'), ToolInfo('Brick Viewer', 'brickv'), ToolInfo('Brick Flash', 'brick_flash'), ToolInfo('Brick Logger', 'brick_logger')]
...
bindings_infos = [BindingsInfo(display_name={'en': 'C/C++', 'de': 'C/C++'}, url_part='c', software_doc_suffix='C', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False), MiscDoc('API_Bindings_{suffix}_iOS', 'api_bindings_{suffix}_ios', {'en': 'Usage (iOS)', 'de': 'Benutzung (iOS)'}, False, False)], tutorial={'en': 'https://www.cprogramming.com/', 'de': 'https://www.cprogramming.com/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'C/C++ for Microcontrollers', 'de': u'C/C++ für Mikrocontroller'}, url_part='uc', software_doc_suffix='uC', is_programming_language=True, is_released=True, has_authentication_example=False, has_download=True, misc_docs=[MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False), MiscDoc('API_Bindings_{suffix}_HAL_Arduino', 'api_bindings_{suffix}_hal_arduino', {'en': 'HAL Arduino', 'de': 'HAL Arduino'}, True, True), MiscDoc('API_Bindings_{suffix}_HAL_Arduino_ESP32', 'api_bindings_{suffix}_hal_arduino_esp32', {'en': 'HAL Arduino ESP32', 'de': 'HAL Arduino ESP32'}, True, True), MiscDoc('API_Bindings_{suffix}_HAL_Arduino_ESP32_Brick', 'api_bindings_{suffix}_hal_arduino_esp32_brick', {'en': 'HAL Arduino ESP32 Brick', 'de': 'HAL Arduino ESP32 Brick'}, True, True), MiscDoc('API_Bindings_{suffix}_HAL_Arduino_ESP32_Ethernet_Brick', 'api_bindings_{suffix}_hal_arduino_esp32_ethernet_brick', {'en': 'HAL Arduino ESP32 Ethernet Brick', 'de': 'HAL Arduino ESP32 Ethernet Brick'}, True, True), MiscDoc('API_Bindings_{suffix}_HAL_Linux', 'api_bindings_{suffix}_hal_linux', {'en': 'HAL Linux', 'de': 'HAL Linux'}, True, True), MiscDoc('API_Bindings_{suffix}_HAL_Raspberry_Pi', 'api_bindings_{suffix}_hal_raspberry_pi', {'en': 'HAL Raspberry Pi', 'de': 'HAL Raspberry Pi'}, True, True)], tutorial={'en': 'https://www.cprogramming.com/', 'de': 'https://www.cprogramming.com/'}, is_hardware_supported=lambda device_info: device_info.has_comcu), BindingsInfo(display_name={'en': 'C#', 'de': 'C#'}, url_part='csharp', software_doc_suffix='CSharp', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False), MiscDoc('API_Bindings_{suffix}_Windows_Phone', 'api_bindings_{suffix}_windows_phone', {'en': 'Usage (Windows Phone)', 'de': 'Benutzung (Win Phone)'}, False, False)], tutorial={'en': 'https://csharp.net-tutorials.com/', 'de': 'https://csharp.net-tutorials.com/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Delphi/Lazarus', 'de': 'Delphi/Lazarus'}, url_part='delphi', software_doc_suffix='Delphi', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'http://www.delphibasics.co.uk/', 'de': 'https://www.delphi-treff.de/tutorials/grundlagen-tutorials/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Go', 'de': 'Go'}, url_part='go', software_doc_suffix='Go', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'https://tour.golang.org', 'de': 'https://tour.golang.org'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Java', 'de': 'Java'}, url_part='java', software_doc_suffix='Java', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False), MiscDoc('API_Bindings_{suffix}_Android', 'api_bindings_{suffix}_android', {'en': 'Usage (Android)', 'de': 'Benutzung (Android)'}, False, False)], tutorial={'en': 'https://docs.oracle.com/javase/tutorial/', 'de': 'https://docs.oracle.com/javase/tutorial/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'JavaScript', 'de': 'JavaScript'}, url_part='javascript', software_doc_suffix='JavaScript', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'LabVIEW', 'de': 'LabVIEW'}, url_part='labview', software_doc_suffix='LabVIEW', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Mathematica', 'de': 'Mathematica'}, url_part='mathematica', software_doc_suffix='Mathematica', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'MATLAB/Octave', 'de': 'MATLAB/Octave'}, url_part='matlab', software_doc_suffix='MATLAB', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'MQTT', 'de': 'MQTT'}, url_part='mqtt', software_doc_suffix='MQTT', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'openHAB', 'de': 'openHAB'}, url_part='openhab', software_doc_suffix='openHAB', is_programming_language=True, is_released=True, has_authentication_example=False, has_download=False, misc_docs=[MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: device_info.has_openhab), BindingsInfo(display_name={'en': 'Perl', 'de': 'Perl'}, url_part='perl', software_doc_suffix='Perl', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'PHP', 'de': 'PHP'}, url_part='php', software_doc_suffix='PHP', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'https://www.php.net/manual/en/getting-started.php', 'de': 'https://www.php.net/manual/de/getting-started.php'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Python', 'de': 'Python'}, url_part='python', software_doc_suffix='Python', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'https://www.python.org/about/gettingstarted/', 'de': 'https://www.python.org/about/gettingstarted/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Ruby', 'de': 'Ruby'}, url_part='ruby', software_doc_suffix='Ruby', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'https://www.ruby-lang.org/en/documentation/quickstart/', 'de': 'https://www.ruby-lang.org/de/documentation/quickstart/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Rust', 'de': 'Rust'}, url_part='rust', software_doc_suffix='Rust', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'https://doc.rust-lang.org/tutorial.html', 'de': 'https://doc.rust-lang.org/tutorial.html'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Shell', 'de': 'Shell'}, url_part='shell', software_doc_suffix='Shell', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Visual Basic .NET', 'de': 'Visual Basic .NET'}, url_part='vbnet', software_doc_suffix='VBNET', is_programming_language=True, is_released=True, has_authentication_example=True, has_download=True, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'http://howtostartprogramming.com/vb-net/', 'de': 'http://howtostartprogramming.com/vb-net/'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'TCP/IP', 'de': 'TCP/IP'}, url_part='tcpip', software_doc_suffix='TCPIP', is_programming_language=False, is_released=True, has_authentication_example=False, has_download=False, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True), BindingsInfo(display_name={'en': 'Modbus', 'de': 'Modbus'}, url_part='modbus', software_doc_suffix='Modbus', is_programming_language=False, is_released=True, has_authentication_example=False, has_download=False, misc_docs=[MiscDoc('IPConnection_{suffix}', 'ip_connection_{suffix}', {'en': 'IP Connection', 'de': 'IP Connection'}, True, True), MiscDoc('API_Bindings_{suffix}', 'api_bindings_{suffix}', {'en': 'Usage', 'de': 'Benutzung'}, False, False)], tutorial={'en': 'FIXME', 'de': 'FIXME'}, is_hardware_supported=lambda device_info: True)]
extension_infos = [DeviceInfo(None, 'Extension', 'Chibi Extension', 'Chibi', 'chibi_extension', 'Chibi_Extension', None, 'chibi-extension', None, False, False, True, True, True, False, None, {'en': 'Wireless Chibi connection between stacks', 'de': 'Drahtlose Chibi Verbindung zwischen Stapeln'}), DeviceInfo(None, 'Extension', 'Ethernet Extension', 'Ethernet', 'ethernet_extension', 'Ethernet_Extension', None, 'ethernet-extension', None, False, False, True, True, False, False, None, {'en': 'Cable based Ethernet connection between stack and PC', 'de': 'Kabelgebundene Ethernet Verbindung zwischen Stapel und PC'}), DeviceInfo(None, 'Extension', 'RS485 Extension', 'RS485', 'rs485_extension', 'RS485_Extension', None, 'rs485-extension', None, False, False, True, True, False, False, None, {'en': 'Cable based RS485 connection between stacks', 'de': 'Kabelgebundene RS485 Verbindung zwischen Stapeln'}), DeviceInfo(None, 'Extension', 'WIFI Extension', 'WIFI', 'wifi_extension', 'WIFI_Extension', None, 'wifi-extension', None, False, False, True, True, False, False, None, {'en': 'Wireless Wi-Fi connection between stack and PC', 'de': 'Drahtlose WLAN Verbindung zwischen Stapel und PC'}), DeviceInfo(None, 'Extension', 'WIFI Extension 2.0', 'WIFI 2.0', 'wifi_v2_extension', 'WIFI_V2_Extension', None, 'wifi-v2-extension', 'wifi_v2', False, False, True, True, False, False, None, {'en': 'Wireless Wi-Fi connection between stack and PC', 'de': 'Drahtlose WLAN Verbindung zwischen Stapel und PC'})]
power_supply_infos = [DeviceInfo(None, 'PowerSupply', 'Step-Down Power Supply', 'Step-Down', 'step_down_power_supply', 'Step_Down', None, 'step-down-powersupply', None, False, False, True, True, False, False, None, {'en': 'Powers a stack of Bricks with 5V', 'de': 'Versorgt einen Stapel von Bricks mit 5V'}), DeviceInfo(None, 'PowerSupply', 'ESP32 Power Supply', 'ESP32', 'esp32_power_supply', 'ESP32', None, 'esp32-power-supply', None, False, False, True, True, False, False, None, {'en': 'Powers a ESP32 Brick or ESP32 Ethernet Brick with 5V', 'de': 'Versorgt einen ESP32 Brick oder ESP32 Ethernet Brick mit 5V'})]
KitInfo = namedtuple('KitInfo', 'display_name url_part prefix released')
kit_infos = [KitInfo({'en': 'Starter Kit: Blinkenlights', 'de': 'Starterkit: Blinkenlights'}, 'blinkenlights', 'starter_kit_', True), KitInfo({'en': 'Starter Kit: Camera Slider', 'de': 'Starterkit: Kameraschlitten'}, 'camera_slider', 'starter_kit_', True), KitInfo({'en': 'Tabletop Weather Station', 'de': 'Tisch-Wetterstation'}, 'tabletop_weather_station', '', True), KitInfo({'en': 'Starter Kit: Weather Station', 'de': 'Starterkit: Wetterstation'}, 'weather_station', 'starter_kit_', True)]
