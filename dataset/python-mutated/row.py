...
class Row(BlockContext, metaclass=ComponentMeta):
    ...
    def __init__(self, *, variant: Literal['default', 'panel', 'compact']='default', visible: bool=True, elem_id: str | None=None, elem_classes: list[str] | str | None=None, render: bool=True, equal_height: bool=True):
        if False:
            return 10
    ...
    @staticmethod
    def update(visible: bool | None=None):
        if False:
            for i in range(10):
                print('nop')
