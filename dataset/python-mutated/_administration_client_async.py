...
from .._models import AttestationSigner, AttestationToken, AttestationPolicyCertificateResult, AttestationPolicyResult
...
class AttestationAdministrationClient(object):
    ...
    * :py:func:`remove_policy_management_certificate`
    ...
    async def get_policy(self, attestation_type: Union[str, AttestationType], **kwargs: Any) -> AttestationGetPolicyResult:
    ...
    @distributed_trace_async
    async def set_policy(self, attestation_type: Union[str, AttestationType], attestation_policy: str, **kwargs: Any) -> AttestationPolicyModificationResult:
    ...
    @distributed_trace_async
    async def reset_policy(self, attestation_type: Union[str, AttestationType], **kwargs: Any) -> AttestationPolicyModificationResult:
    ...
    @distributed_trace_async
    async def get_policy_management_certificates(self, **kwargs: Any) -> AttestationGetPolicyManagementCertificatesResult:
    ...
    @distributed_trace_async
    async def add_policy_management_certificate(self, *args: str, **kwargs: Any) -> AttestationPolicyManagementCertificateResult:
    ...
    @distributed_trace_async
    async def remove_policy_management_certificate(self, *args: str, **kwargs: Any) -> AttestationPolicyManagementCertificateResult:
