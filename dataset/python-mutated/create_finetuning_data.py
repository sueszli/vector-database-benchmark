...
FLAGS = flags.FLAGS
flags.DEFINE_enum('fine_tuning_task_type', 'classification', ['classification', 'squad'], 'The name of the BERT fine tuning task for which data will be generated..')
flags.DEFINE_string('input_data_dir', None, 'The input data dir. Should contain the .tsv files (or other data files) for the task.')
flags.DEFINE_enum('classification_task_name', 'MNLI', ['COLA', 'MNLI', 'MRPC', 'XNLI'], 'The name of the task to train BERT classifier.')
...
flags.DEFINE_string('train_data_output_path', None, 'The path in which generated training input data will be written as tf records.')
flags.DEFINE_string('eval_data_output_path', None, 'The path in which generated training input data will be written as tf records.')
