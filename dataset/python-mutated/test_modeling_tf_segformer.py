...
class TFSegformerModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    all_model_classes = (TFSegformerModel, TFSegformerForImageClassification, TFSegformerForSemanticSegmentation) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFSegformerModel, 'image-classification': TFSegformerForImageClassification} if is_tf_available() else {}
