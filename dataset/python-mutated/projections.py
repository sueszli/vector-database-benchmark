...
_PROJ_NAME_CODE = [('ZenithalPerspective', 'AZP'), ('SlantZenithalPerspective', 'SZP'), ('Gnomonic', 'TAN'), ('Stereographic', 'STG'), ('SlantOrthographic', 'SIN'), ('ZenithalEquidistant', 'ARC'), ('ZenithalEqualArea', 'ZEA'), ('Airy', 'AIR'), ('CylindricalPerspective', 'CYP'), ('CylindricalEqualArea', 'CEA'), ('PlateCarree', 'CAR'), ('Mercator', 'MER'), ('SansonFlamsteed', 'SFL'), ('Parabolic', 'PAR'), ('Molleweide', 'MOL'), ('HammerAitoff', 'AIT'), ('ConicPerspective', 'COP'), ('ConicEqualArea', 'COE'), ('ConicEquidistant', 'COD'), ('ConicOrthomorphic', 'COO'), ('BonneEqualArea', 'BON'), ('Polyconic', 'PCO'), ('TangentialSphericalCube', 'TSC'), ('COBEQuadSphericalCube', 'CSC'), ('QuadSphericalCube', 'QSC'), ('HEALPix', 'HPX'), ('HEALPixPolar', 'XPH')]
_NOT_SUPPORTED_PROJ_CODES = ['ZPN']
_PROJ_NAME_CODE_MAP = dict(_PROJ_NAME_CODE)
projcodes = [code for (_, code) in _PROJ_NAME_CODE]
__all__ = ['Projection', 'Pix2SkyProjection', 'Sky2PixProjection', 'Zenithal', 'Cylindrical', 'PseudoCylindrical', 'Conic', 'PseudoConic', 'QuadCube', 'HEALPix', 'AffineTransformation2D', 'projcodes']
...
class Pix2Sky_ZenithalPerspective(Pix2SkyProjection, Zenithal):
    ...
    """
    mu = _ParameterDS(default=0.0, description='Distance from point of projection to center of sphere')
    gamma = _ParameterDS(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='Look angle γ in degrees (Default = 0°)')
...
class Pix2Sky_SlantZenithalPerspective(Pix2SkyProjection, Zenithal):
    ...
    """
    mu = _ParameterDS(default=0.0, description='Distance from point of projection to center of sphere')
    phi0 = _ParameterDS(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='The longitude φ₀ of the reference point in degrees (Default=0°)')
    theta0 = _ParameterDS(default=90.0, getter=_to_orig_unit, setter=_to_radian, description='The latitude θ₀ of the reference point, in degrees (Default=0°)')
...
class Sky2Pix_SlantZenithalPerspective(Sky2PixProjection, Zenithal):
    ...
    """
    mu = _ParameterDS(default=0.0, description='Distance from point of projection to center of sphere')
    phi0 = _ParameterDS(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='The longitude φ₀ of the reference point in degrees')
    theta0 = _ParameterDS(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='The latitude θ₀ of the reference point, in degrees')
...
class Sky2Pix_BonneEqualArea(Sky2PixProjection, PseudoConic):
    ...
    """
    _separable = True
    theta1 = _ParameterDS(default=0.0, getter=_to_orig_unit, setter=_to_radian, description='Bonne conformal latitude, in degrees')
