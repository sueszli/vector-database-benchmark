...
COLOR_MAP = {'PAGE': 'purple4', 'LINE': 'lime green', 'WORD': 'burlywood4', 'TABLE': 'turquoise3', 'CELL': 'salmon3', 'KEY_VALUE_SET': 'cornflower blue', 'SELECTION_ELEMENT': 'orange2'}
FILTER_MAP = {'TEXT': ['PAGE', 'LINE', 'WORD'], 'TABLES': ['PAGE', 'TABLE', 'CELL', 'WORD'], 'FORMS': ['PAGE', 'KEY_VALUE_SET', 'WORD', 'SELECTION_ELEMENT']}
