...
class TrtConvertInverse(TrtLayerAutoScanTest):
    ...
    def sample_program_configs(self):
        ...
        ops_config = [{'op_type': 'inverse', 'op_inputs': {'Input': ['input_data']}, 'op_outputs': {'Output': ['output_data']}, 'op_attrs': {}}]
    ...
    def sample_predictor_configs(self, program_config) -> (paddle_infer.Config, List[int], float):
        ...
        def generate_dynamic_shape(attrs):
            ...
            self.dynamic_shape.max_input_shape = {'input_data': [64, 64]}
            self.dynamic_shape.opt_input_shape = {'input_data': [32, 32]}
