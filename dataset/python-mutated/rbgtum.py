...
class RbgTumIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://live.rbg.tum.de/w/cpp/22128', 'md5': '53a5e7b3e07128e33bbf36687fe1c08f', 'info_dict': {'id': 'cpp/22128', 'ext': 'mp4', 'title': 'Lecture: October 18. 2022', 'series': 'Concepts of C++ programming (IN2377)'}}, {'url': 'https://live.rbg.tum.de/w/I2DL/12349/PRES', 'md5': '36c584272179f3e56b0db5d880639cba', 'info_dict': {'id': 'I2DL/12349/PRES', 'ext': 'mp4', 'title': 'Lecture 3: Introduction to Neural Networks', 'series': 'Introduction to Deep Learning (IN2346)'}}, {'url': 'https://live.rbg.tum.de/w/fvv-info/16130/CAM', 'md5': 'e04189d92ff2f56aedf5cede65d37aad', 'info_dict': {'id': 'fvv-info/16130/CAM', 'ext': 'mp4', 'title': 'Fachschaftsvollversammlung', 'series': 'Fachschaftsvollversammlung Informatik'}}, {'url': 'https://tum.live/w/linalginfo/27102', 'only_matching': True}]
...
class RbgTumCourseIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://live.rbg.tum.de/old/course/2022/S/fpv', 'info_dict': {'title': 'Funktionale Programmierung und Verifikation (IN0003)', 'id': '2022/S/fpv'}, 'params': {'noplaylist': False}, 'playlist_count': 13}, {'url': 'https://live.rbg.tum.de/old/course/2022/W/set', 'info_dict': {'title': 'SET FSMPIC', 'id': '2022/W/set'}, 'params': {'noplaylist': False}, 'playlist_count': 6}, {'url': 'https://tum.live/old/course/2023/S/linalginfo', 'only_matching': True}]
