...
@pluginmatcher(re.compile('https?://(?:[\\w-]+\\.)*(?:tv5monde|tivi5mondeplus)\\.com/'))
class TV5Monde(Plugin):
    _URL_API = 'https://api.tv5monde.com/player/asset/{asset}/resolve'
    _MAP_STREAMTYPES = {'application/x-mpegURL': HLSStream.parse_variant_playlist, 'application/dash+xml': DASHStream.parse_manifest, 'video/mp4': lambda *args: {'vod': HTTPStream(*args)}}
