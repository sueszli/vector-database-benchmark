...
(DOCKER_IMAGE_BASIC, DOCKER_REQUIREMENT_BASE) = gen_docker_image('pytorch-linux-xenial-py3.7-gcc5.4')
(DOCKER_IMAGE_CUDA_10_2, DOCKER_REQUIREMENT_CUDA_10_2) = gen_docker_image('pytorch-linux-xenial-cuda10.2-cudnn7-py3-gcc7')
(DOCKER_IMAGE_GCC7, DOCKER_REQUIREMENT_GCC7) = gen_docker_image('pytorch-linux-xenial-py3.7-gcc7')
