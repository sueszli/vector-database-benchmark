...
class SampleCodeValidator(ast.NodeVisitor):
    ...
    """
    _whitelisted_nodes = (ast.Expression, ast.Call, ast.Attribute, ast.Name, ast.Load, ast.keyword, ast.Num, ast.Str, ast.Bytes, ast.List, ast.Tuple, ast.Set, ast.Dict, ast.NameConstant)
