...
from .detectors.n_plus_one_db_span_detector import NPlusOneDBSpanDetector, NPlusOneDBSpanDetectorExtended
...
INTEGRATIONS_OF_INTEREST = ['django', 'flask', 'sqlalchemy', 'Mongo', 'Postgres', 'Mysql', 'Prisma', 'GraphQL']
SDKS_OF_INTEREST = ['sentry.javascript.node']
