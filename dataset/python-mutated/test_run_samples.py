...
TIMEOUT_SAMPLES = {'azure-eventgrid': {'consume_cloud_events_from_storage_queue.py': 10}, 'azure-eventhub': {'receive_batch_with_checkpoint.py': 10, 'recv.py': 10, 'recv_track_last_enqueued_event_prop.py': 10, 'recv_with_checkpoint_by_event_count.py': 10, 'recv_with_checkpoint_by_time_interval.py': 10, 'recv_with_checkpoint_store.py': 10, 'recv_with_custom_starting_position.py': 10, 'sample_code_eventhub.py': 10, 'receive_batch_with_checkpoint_async.py': 10, 'recv_async.py': 10, 'recv_track_last_enqueued_event_prop_async.py': 10, 'recv_with_checkpoint_by_event_count_async.py': 10, 'recv_with_checkpoint_by_time_interval_async.py': 10, 'recv_with_checkpoint_store_async.py': 10, 'recv_with_custom_starting_position_async.py': 10, 'sample_code_eventhub_async.py': 10, 'send_and_receive_amqp_annotated_message.py': 10, 'send_and_receive_amqp_annotated_message_async.py': 10}, 'azure-eventhub-checkpointstoreblob': {'receive_events_using_checkpoint_store.py': 10, 'receive_events_using_checkpoint_store_storage_api_version.py': 10}, 'azure-eventhub-checkpointstoreblob-aio': {'receive_events_using_checkpoint_store_async.py': 10, 'receive_events_using_checkpoint_store_storage_api_version_async.py': 10}, 'azure-servicebus': {'failure_and_recovery.py': 10, 'receive_iterator_queue.py': 10, 'sample_code_servicebus.py': 30, 'session_pool_receive.py': 20, 'receive_iterator_queue_async.py': 10, 'sample_code_servicebus_async.py': 30, 'session_pool_receive_async.py': 20}}
IGNORED_SAMPLES = {'azure-ai-ml': ['ml_samples_authentication_sovereign_cloud.py'], 'azure-eventgrid': ['__init__.py', 'consume_cloud_events_from_eventhub.py', 'consume_eventgrid_events_from_service_bus_queue.py', 'sample_publish_events_to_a_topic_using_sas_credential.py', 'sample_publish_events_to_a_topic_using_sas_credential_async.py'], 'azure-eventhub': ['client_identity_authentication.py', 'connection_to_custom_endpoint_address.py', 'proxy.py', 'connection_to_custom_endpoint_address_async.py', 'iot_hub_connection_string_receive_async.py', 'proxy_async.py', 'send_stream.py'], 'azure-eventhub-checkpointstoretable': ['receive_events_using_checkpoint_store.py'], 'azure-servicebus': ['connection_to_custom_endpoint_address.py', 'mgmt_queue.py', 'mgmt_rule.py', 'mgmt_subscription.py', 'mgmt_topic.py', 'proxy.py', 'receive_deferred_message_queue.py', 'connection_to_custom_endpoint_address_async.py', 'mgmt_queue_async.py', 'mgmt_rule_async.py', 'mgmt_subscription_async.py', 'mgmt_topic_async.py', 'proxy_async.py', 'receive_deferred_message_queue_async.py'], 'azure-communication-chat': ['chat_client_sample_async.py', 'chat_client_sample.py', 'chat_thread_client_sample_async.py', 'chat_thread_client_sample.py'], 'azure-communication-phonenumbers': ['purchase_phone_number_sample_async.py', 'purchase_phone_number_sample.py', 'release_phone_number_sample_async.py', 'release_phone_number_sample.py'], 'azure-ai-translation-document': ['sample_list_document_statuses_with_filters_async.py', 'sample_list_translations_with_filters_async.py', 'sample_list_document_statuses_with_filters.py', 'sample_list_translations_with_filters.py', 'sample_translation_with_custom_model.py', 'sample_translation_with_custom_model_async.py', 'sample_begin_translation_with_filters.py', 'sample_begin_translation_with_filters_async.py'], 'azure-ai-language-questionanswering': ['sample_export_import_project.py', 'sample_export_import_project_async.py'], 'azure-ai-textanalytics': ['sample_analyze_healthcare_entities_with_cancellation.py', 'sample_analyze_healthcare_entities_with_cancellation_async.py', 'sample_abstract_summary.py', 'sample_abstract_summary_async.py']}
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Install Dependencies, Install Packages, Test Azure Packages' Samples, Called from DevOps YAML Pipeline")
    parser.add_argument('-t', '--target', dest='target_package', help='The target package directory on disk. The target module passed to run mypy will be <target_package>/azure.', required=True)
    args = parser.parse_args()
    service_dir = os.path.join('sdk', args.target_package)
    target_dir = os.path.join(root_dir, service_dir)
    if compare_python_version(MINIMUM_TESTED_PYTHON_VERSION):
        logging.info('User opted to run samples, and python version is greater than minimum supported.')
