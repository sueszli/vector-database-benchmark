...
from praw.models.reddit.modmail import ModmailObject
...
class DocumentationChecker:
    ...
    exceptions = {ModmailObject}
    HAS_CODE_BLOCK = re.compile('\\.\\. code-block::')
    HAS_ATTRIBUTE_TABLE = re.compile('Attribute[ ]+Description')
