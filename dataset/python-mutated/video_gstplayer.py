...
try:
    ...
    handle_win_lib_import_error('VideoGstplayer', 'gst', 'kivy.lib.gstplayer._gstplayer')
    raise
...
Logger.info('VideoGstplayer: Using Gstreamer {}'.format('.'.join(map(str, get_gst_version()))))
