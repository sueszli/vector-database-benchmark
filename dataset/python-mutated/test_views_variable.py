...
from tests.test_utils.www import _check_last_log, check_content_in_response, check_content_not_in_response, client_with_login
pytestmark = pytest.mark.db_test
VARIABLE = {'key': 'test_key', 'val': 'text_val', 'description': 'test_description', 'is_encrypted': True}
