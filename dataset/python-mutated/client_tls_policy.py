...
__protobuf__ = proto.module(package='google.cloud.networksecurity.v1', manifest={'ClientTlsPolicy', 'ListClientTlsPoliciesRequest', 'ListClientTlsPoliciesResponse', 'GetClientTlsPolicyRequest', 'CreateClientTlsPolicyRequest', 'UpdateClientTlsPolicyRequest', 'DeleteClientTlsPolicyRequest'})
...
class ClientTlsPolicy(proto.Message):
    ...
    sni: str = proto.Field(proto.STRING, number=6)
    client_certificate: tls.CertificateProvider = proto.Field(proto.MESSAGE, number=7, message=tls.CertificateProvider)
    server_validation_ca: MutableSequence[tls.ValidationCA] = proto.RepeatedField(proto.MESSAGE, number=8, message=tls.ValidationCA)
...
class ListClientTlsPoliciesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    client_tls_policies: MutableSequence['ClientTlsPolicy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='ClientTlsPolicy')
...
class CreateClientTlsPolicyRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    client_tls_policy_id: str = proto.Field(proto.STRING, number=2)
    client_tls_policy: 'ClientTlsPolicy' = proto.Field(proto.MESSAGE, number=3, message='ClientTlsPolicy')
...
class UpdateClientTlsPolicyRequest(proto.Message):
    ...
    client_tls_policy: 'ClientTlsPolicy' = proto.Field(proto.MESSAGE, number=2, message='ClientTlsPolicy')
