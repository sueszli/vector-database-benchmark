...
from featuretools import AggregationFeature, EntitySet, Feature, Timedelta, calculate_feature_matrix
...
from featuretools.primitives import And, Count, CumSum, EqualScalar, GreaterThanEqualToScalar, GreaterThanScalar, LessThanEqualToScalar, LessThanScalar, Mean, Min, Mode, Negate, NMostCommon, NotEqualScalar, NumTrue, Sum, TimeSinceLast, Trend
