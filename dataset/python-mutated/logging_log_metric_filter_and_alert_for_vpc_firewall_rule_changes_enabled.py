...
class logging_log_metric_filter_and_alert_for_vpc_firewall_rule_changes_enabled(Check):
    ...
    def execute(self) -> Check_Report_GCP:
        ...
        for metric in logging_client.metrics:
            if 'resource.type="gce_firewall_rule" AND (protoPayload.methodName:"compute.firewalls.patch" OR protoPayload.methodName:"compute.firewalls.insert" OR protoPayload.methodName:"compute.firewalls.delete")' in metric.filter:
