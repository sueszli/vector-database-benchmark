...
Object = console = setTimeout = loop = logger = arguments = None
undefined = 'UNDEFINED'
reprs = json.dumps
...
class ComponentJS:
    ...
    def __create_reaction_ob(self, reaction_func, name, mode, connection_strings):
        ...
        return reaction
OK_MAGICS = ('__attributes__', '__properties__', '__actions__', '__emitters__', '__reactions__', '__jsmodule__', '__init__', '__enter__', '__exit__', '__proxy_properties__')
...
del mc
assert JS_LOOP.count('._scheduled_call_to_iter') > 2
if __name__ == '__main__':
    ...
    print(toprint)
    print('-' * 80)
    print(len(toprint), 'of', len(JS_EVENT), 'bytes in total')
    print('-' * 80)
