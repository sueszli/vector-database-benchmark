...
def copy_featured_products_to_homepade_collection(apps, schema_editor):
    ...
    homepage_products = list(Product.objects.filter(Q(available_on__lte=today) | Q(available_on__isnull=True), is_published=True, is_featured=True))
...
class Migration(migrations.Migration):
    dependencies = [('product', '0066_auto_20180803_0528'), ('site', '0017_auto_20180803_0528')]
    operations = [migrations.AddField(model_name='sitesettings', name='homepage_collection', field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='product.Collection')), migrations.RunPython(copy_featured_products_to_homepade_collection, lambda app, schema_editor: None)]