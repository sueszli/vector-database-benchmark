...
class TestConversationApp(AzureRecordedTestCase):
    ...
    def test_conversation_app(self, recorded_test, conversation_creds):
        ...
        with client:
            ...
            result = client.analyze_conversation(task={'kind': 'Conversation', 'analysisInput': {'conversationItem': {'participantId': '1', 'id': '1', 'modality': 'text', 'language': 'en', 'text': query}, 'isLoggingEnabled': False}, 'parameters': {'projectName': conversation_creds['conv_project_name'], 'deploymentName': conversation_creds['conv_deployment_name'], 'verbose': True}})
