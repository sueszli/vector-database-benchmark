...
import torch
import torch.cuda
from torch.autograd import _disable_profiler_legacy, _enable_profiler_legacy, DeviceType, ProfilerConfig, ProfilerState
from torch.autograd.profiler_util import _filter_name, _filter_stack_entry, _rewrite_name, EventList, FunctionEvent, MEMORY_EVENT_NAME
__all__ = ['profile']
