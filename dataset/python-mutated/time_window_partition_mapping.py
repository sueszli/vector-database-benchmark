...
from dagster._core.definitions.time_window_partitions import BaseTimeWindowPartitionsSubset, TimeWindow, TimeWindowPartitionsDefinition, TimeWindowPartitionsSubset
...
class TimeWindowPartitionMapping(PartitionMapping, NamedTuple('_TimeWindowPartitionMapping', [('start_offset', PublicAttr[int]), ('end_offset', PublicAttr[int]), ('allow_nonexistent_upstream_partitions', PublicAttr[bool])])):
