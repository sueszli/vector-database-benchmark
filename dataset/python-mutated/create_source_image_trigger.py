...
def main():
    ...
    response = client.triggers.begin_create_or_update(resource_group_name='myResourceGroup', image_template_name='myImageTemplate', trigger_name='source', parameters={'properties': {'kind': 'SourceImage'}}).result()
    print(response)
