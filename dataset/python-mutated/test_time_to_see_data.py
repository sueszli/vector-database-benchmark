...
from posthog.models.query_metrics.sql import CREATE_METRICS_QUERY_LOG, CREATE_METRICS_TIME_TO_SEE, DROP_METRICS_QUERY_LOG, DROP_METRICS_TIME_TO_SEE_TABLE
