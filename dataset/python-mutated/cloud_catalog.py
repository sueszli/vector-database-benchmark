...
import proto
__protobuf__ = proto.module(package='google.cloud.billing.v1', manifest={'Service', 'Sku', 'Category', 'PricingInfo', 'PricingExpression', 'AggregationInfo', 'GeoTaxonomy', 'ListServicesRequest', 'ListServicesResponse', 'ListSkusRequest', 'ListSkusResponse'})
...
class Service(proto.Message):
    ...
    service_id: str = proto.Field(proto.STRING, number=2)
    display_name: str = proto.Field(proto.STRING, number=3)
    business_entity_name: str = proto.Field(proto.STRING, number=4)
...
class Sku(proto.Message):
    ...
    """
    name: str = proto.Field(proto.STRING, number=1)
    sku_id: str = proto.Field(proto.STRING, number=2)
    description: str = proto.Field(proto.STRING, number=3)
    category: 'Category' = proto.Field(proto.MESSAGE, number=4, message='Category')
    service_regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    pricing_info: MutableSequence['PricingInfo'] = proto.RepeatedField(proto.MESSAGE, number=6, message='PricingInfo')
    service_provider_name: str = proto.Field(proto.STRING, number=7)
    geo_taxonomy: 'GeoTaxonomy' = proto.Field(proto.MESSAGE, number=8, message='GeoTaxonomy')
...
class Category(proto.Message):
    ...
    Attributes:
        ...
        usage_type (str):
            ...
            "Commit1Yr" etc.
    """
    service_display_name: str = proto.Field(proto.STRING, number=1)
    resource_family: str = proto.Field(proto.STRING, number=2)
    resource_group: str = proto.Field(proto.STRING, number=3)
    usage_type: str = proto.Field(proto.STRING, number=4)
...
class PricingInfo(proto.Message):
    ...
    """
    effective_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=1, message=timestamp_pb2.Timestamp)
    summary: str = proto.Field(proto.STRING, number=2)
    pricing_expression: 'PricingExpression' = proto.Field(proto.MESSAGE, number=3, message='PricingExpression')
    aggregation_info: 'AggregationInfo' = proto.Field(proto.MESSAGE, number=4, message='AggregationInfo')
    currency_conversion_rate: float = proto.Field(proto.DOUBLE, number=5)
...
class PricingExpression(proto.Message):
    ...
    class TierRate(proto.Message):
        ...
        """
        start_usage_amount: float = proto.Field(proto.DOUBLE, number=1)
        unit_price: money_pb2.Money = proto.Field(proto.MESSAGE, number=2, message=money_pb2.Money)
    usage_unit: str = proto.Field(proto.STRING, number=1)
    display_quantity: float = proto.Field(proto.DOUBLE, number=2)
    tiered_rates: MutableSequence[TierRate] = proto.RepeatedField(proto.MESSAGE, number=3, message=TierRate)
    usage_unit_description: str = proto.Field(proto.STRING, number=4)
    base_unit: str = proto.Field(proto.STRING, number=5)
    base_unit_description: str = proto.Field(proto.STRING, number=6)
    base_unit_conversion_factor: float = proto.Field(proto.DOUBLE, number=7)
...
class AggregationInfo(proto.Message):
    ...
    class AggregationInterval(proto.Enum):
        ...
        DAILY = 1
        MONTHLY = 2
    aggregation_level: AggregationLevel = proto.Field(proto.ENUM, number=1, enum=AggregationLevel)
    aggregation_interval: AggregationInterval = proto.Field(proto.ENUM, number=2, enum=AggregationInterval)
    aggregation_count: int = proto.Field(proto.INT32, number=3)
...
class GeoTaxonomy(proto.Message):
    ...
    regions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    services: MutableSequence['Service'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Service')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    skus: MutableSequence['Sku'] = proto.RepeatedField(proto.MESSAGE, number=1, message='Sku')
    next_page_token: str = proto.Field(proto.STRING, number=2)
