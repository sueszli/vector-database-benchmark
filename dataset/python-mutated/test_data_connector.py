...
from lightning.pytorch.trainer.connectors.data_connector import _check_dataloader_iterable, _DataHookSelector, _DataLoaderSource, _worker_check, warning_cache
...
@pytest.mark.parametrize('hook_name', ('on_before_batch_transfer', 'transfer_batch_to_device', 'on_after_batch_transfer'))
