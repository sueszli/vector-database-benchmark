...
from ..utils import float_or_none, jwt_encode_hs256, try_get, ExtractorError

class ATVAtIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?atv\\.at/tv/(?:[^/]+/){2,3}(?P<id>.*)'
    _TESTS = [{'url': 'https://www.atv.at/tv/bauer-sucht-frau/staffel-18/bauer-sucht-frau/bauer-sucht-frau-staffel-18-folge-3-die-hofwochen', 'md5': '3c3b4aaca9f63e32b35e04a9c2515903', 'info_dict': {'id': 'v-ce9cgn1e70n5-1', 'ext': 'mp4', 'title': 'Bauer sucht Frau - Staffel 18 Folge 3 - Die Hofwochen'}}, {'url': 'https://www.atv.at/tv/bauer-sucht-frau/staffel-18/episode-01/bauer-sucht-frau-staffel-18-vorstellungsfolge-1', 'only_matching': True}]
    _ACCESS_ID = 'x_atv'
