...
class TestSolution(unittest.TestCase):
    ...
    def test_find_busiest_period(self):
        ...
        data = [Data(3, 2, EventType.EXIT), Data(1, 2, EventType.ENTER), Data(3, 1, EventType.ENTER), Data(7, 3, EventType.ENTER), Data(9, 2, EventType.EXIT), Data(8, 2, EventType.EXIT)]
