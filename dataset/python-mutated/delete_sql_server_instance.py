...
def main():
    ...
    response = client.sql_server_instances.begin_delete(resource_group_name='testrg', sql_server_instance_name='testsqlServerInstance').result()
    print(response)
