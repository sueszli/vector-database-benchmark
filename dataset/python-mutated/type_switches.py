...
from homeassistant.components.vacuum import DOMAIN as VACUUM_DOMAIN, SERVICE_RETURN_TO_BASE, SERVICE_START, STATE_CLEANING, VacuumEntityFeature
from homeassistant.const import ATTR_ENTITY_ID, ATTR_SUPPORTED_FEATURES, CONF_TYPE, SERVICE_TURN_OFF, SERVICE_TURN_ON, STATE_ON
...
class ValveInfo(NamedTuple):
    ...
    category: int
    valve_type: int
VALVE_TYPE: dict[str, ValveInfo] = {TYPE_FAUCET: ValveInfo(CATEGORY_FAUCET, 3), TYPE_SHOWER: ValveInfo(CATEGORY_SHOWER_HEAD, 2), TYPE_SPRINKLER: ValveInfo(CATEGORY_SPRINKLER, 1), TYPE_VALVE: ValveInfo(CATEGORY_FAUCET, 0)}
