def combineperkey_side_inputs_dict(test=None):
    ...
    with beam.Pipeline() as pipeline:
        ...
        bounded_total = pipeline | 'Create plant counts' >> beam.Create([('🥕', 3), ('🥕', 2), ('🍆', 1), ('🍅', 4), ('🍅', 5), ('🍅', 3)]) | 'Bounded sum' >> beam.CombinePerKey(bounded_sum, data_range=beam.pvalue.AsDict(data_range)) | beam.Map(print)
        if test:
            test(bounded_total)
