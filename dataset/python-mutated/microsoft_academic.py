...
about = {'website': 'https://academic.microsoft.com', 'wikidata_id': 'Q28136779', 'official_api_documentation': 'http://ma-graph.org/', 'use_official_api': False, 'require_api_key': False, 'results': 'JSON'}
categories = ['images']
paging = True
