...
class RTLSDR(Device):
    ...
    DEVICE_METHODS.update({Device.Command.SET_RF_GAIN.name: 'set_tuner_gain', Device.Command.SET_RF_GAIN.name + '_get_allowed_values': 'get_tuner_gains', Device.Command.SET_BANDWIDTH.name: 'set_tuner_bandwidth', Device.Command.SET_FREQUENCY_CORRECTION.name: 'set_freq_correction', Device.Command.SET_DIRECT_SAMPLING_MODE.name: 'set_direct_sampling', Device.Command.SET_BIAS_TEE_ENABLED.name: 'set_bias_tee'})
    DATA_TYPE = np.int8
