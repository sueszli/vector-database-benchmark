...
class TestSamLayerProvider(TestCase):
    TEMPLATE = {'Resources': {'ServerlessLayer': {'Type': 'AWS::Serverless::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'ContentUri': 'PyLayer/', 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8'}}, 'LambdaLayer': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': 'PyLayer/', 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8'}}, 'LambdaLayerWithCustomId': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': 'PyLayer/', 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8', 'SamResourceId': 'LambdaLayerWithCustomId-x'}}, 'CDKLambdaLayer': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': {'S3Bucket': 'bucket', 'S3Key': 'key'}, 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8', 'aws:cdk:path': 'stack/CDKLambdaLayer-x/Resource', 'aws:asset:path': 'PyLayer/', 'aws:asset:property': 'Content'}}, 'ServerlessLayerNoBuild': {'Type': 'AWS::Serverless::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'ContentUri': 'PyLayer/', 'CompatibleRuntimes': ['python3.8', 'python3.9']}}, 'LambdaLayerNoBuild': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': 'PyLayer/', 'CompatibleRuntimes': ['python3.8', 'python3.9']}}, 'ServerlessLayerS3Content': {'Type': 'AWS::Serverless::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'ContentUri': 's3://dummy-bucket/my-layer.zip', 'CompatibleRuntimes': ['python3.8', 'python3.9']}}, 'LambdaLayerS3Content': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': {'S3Bucket': 'dummy-bucket', 'S3Key': 'layer.zip'}, 'CompatibleRuntimes': ['python3.8', 'python3.9']}}, 'SamFunc': {'Type': 'AWS::Serverless::Function', 'Properties': {'CodeUri': 's3://bucket/key', 'Runtime': 'nodejs4.3', 'Handler': 'index.handler'}}, 'ChildStack': {'Type': 'AWS::Serverless::Application', 'Properties': {'Location': './child.yaml'}}}}
    CHILD_TEMPLATE = {'Resources': {'SamLayerInChild': {'Type': 'AWS::Serverless::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'ContentUri': 'PyLayer', 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8'}}, 'CDKLambdaLayerInChild': {'Type': 'AWS::Lambda::LayerVersion', 'Properties': {'LayerName': 'Layer1', 'Content': {'S3Bucket': 'bucket', 'S3Key': 'key'}, 'CompatibleRuntimes': ['python3.8', 'python3.9']}, 'Metadata': {'BuildMethod': 'python3.8', 'aws:cdk:path': 'stack/CDKLambdaLayerInChild-x/Resource', 'aws:asset:path': 'PyLayer/', 'aws:asset:property': 'Content'}}}}
