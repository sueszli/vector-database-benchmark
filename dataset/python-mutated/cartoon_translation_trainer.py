...
from modelscope.models.cv.cartoon import CartoonModel, all_file, simple_superpixel, tf_data_loader, write_batch_image
...
if version.parse(tf.__version__) < version.parse('2'):
    ...
    logger.info(f'TensorFlow version {_tf_version} found, TF2.x is not supported by CartoonTranslationTrainer.')

@TRAINERS.register_module(module_name='cartoon-translation')
