...
class Exploit(HTTPClient):
    __info__ = {'name': 'Netgear DGN2200 RCE', 'description': 'Exploits Netgear DGN2200 RCE vulnerability in the ping.cgi script.', 'authors': ('SivertPL', 'Josh Abraham <sinisterpatrician[at]google.com>'), 'references': ('https://www.exploit-db.com/exploits/41394/', 'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-6077'), 'devices': ('Netgear DGN2200v1', 'Netgear DGN2200v2', 'Netgear DGN2200v3', 'Netgear DGN2200v4')}
