...
def main():
    ...
    response = client.deployments.begin_delete(resource_group_name='myResourceGroup', service_name='myservice', app_name='myapp', deployment_name='mydeployment').result()
    print(response)
