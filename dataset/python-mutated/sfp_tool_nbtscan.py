...
class sfp_tool_nbtscan(SpiderFootPlugin):
    meta = {'name': 'Tool - nbtscan', 'summary': "Scans for open NETBIOS nameservers on your target's network.", 'flags': ['tool', 'slow'], 'useCases': ['Footprint', 'Investigate'], 'categories': ['Crawling and Scanning'], 'toolDetails': {'name': 'nbtscan', 'description': 'nbtscan is a tool that scans for open NETBIOS nameservers on a local or remote TCP/IP network, and this is a first step in finding of open shares. It is based on the functionality of the standard Windows tool nbtstat, but it operates on a range of addresses instead of just one.', 'website': 'http://www.unixwiz.net/tools/nbtscan.html', 'repository': 'http://www.unixwiz.net/tools/nbtscan.html'}}
    opts = {'nbtscan_path': '', 'netblockscan': True, 'netblockscanmax': 24}
    optdescs = {'nbtscan_path': 'The path to your nbtscan binary', 'netblockscan': 'Scan all IPs within identified owned netblocks?', 'netblockscanmax': 'Maximum netblock/subnet size to scan IPs within (CIDR value, 24 = /24, 16 = /16, etc.)'}
    results = None
    errorState = False
