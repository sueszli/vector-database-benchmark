...
@testing.parameterize(*testing.product({'delta_v': [0.5], 'delta_d': [5], 'alpha': [1], 'beta': [1], 'gamma': [0.001], 'norm': [1], 'result_l_dist': [6.0776708], 'result_l_var': [64.0], 'result_l_reg': [0.03419368]}) + testing.product({'delta_v': [3], 'delta_d': [10], 'alpha': [0.1], 'beta': [0.1], 'gamma': [0.1], 'max_n_clusters': [2], 'norm': [2], 'result_l_dist': [0.0], 'result_l_var': [26.56423595], 'result_l_reg': [1.55665027]}))
