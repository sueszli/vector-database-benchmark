...
@PIPELINES.register_module(Tasks.image_object_detection, module_name=Pipelines.tbs_detection)
class TBSDetectionPipeline(Pipeline):
    ...
    ```
    """
    _defaults = {'class_names': ['positive'], 'model_image_size': (416, 416, 3), 'confidence': 0.5, 'iou': 0.3}
