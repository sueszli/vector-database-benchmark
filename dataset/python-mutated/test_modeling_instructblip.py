...
import numpy as np
import requests
from transformers import CONFIG_MAPPING, InstructBlipConfig, InstructBlipProcessor, InstructBlipQFormerConfig, InstructBlipVisionConfig
from transformers.testing_utils import require_accelerate, require_bitsandbytes, require_torch, require_vision, slow, torch_device
