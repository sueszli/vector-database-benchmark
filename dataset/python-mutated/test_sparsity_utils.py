import logging
import torch
from torch.ao.pruning.sparsifier.utils import fqn_to_module, get_arg_info_from_tensor_fqn, module_to_fqn
from torch.testing._internal.common_quantization import ConvBnReLUModel, ConvModel, FunctionalLinear, LinearAddModel, ManualEmbeddingBagLinear, SingleLayerLinearModel, TwoLayerLinearModel
from torch.testing._internal.common_utils import TestCase
logging.basicConfig(format='%(asctime)s - %(name)s - %(levelname)s - %(message)s', level=logging.INFO)
model_list = [ConvModel, SingleLayerLinearModel, TwoLayerLinearModel, LinearAddModel, ConvBnReLUModel, ManualEmbeddingBagLinear, FunctionalLinear]
