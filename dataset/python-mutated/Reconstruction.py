...
from modelscope.models.cv.human_reconstruction.models.detectors import FasterRCNN
from modelscope.models.cv.human_reconstruction.models.human_segmenter import human_segmenter
from modelscope.models.cv.human_reconstruction.models.networks import define_G
from modelscope.models.cv.human_reconstruction.models.PixToMesh import Pixto3DNet
from modelscope.models.cv.human_reconstruction.utils import create_grid
from modelscope.utils.constant import ModelFile, Tasks
from modelscope.utils.logger import get_logger
logger = get_logger()

@MODELS.register_module(Tasks.human_reconstruction, module_name=Models.human_reconstruction)
