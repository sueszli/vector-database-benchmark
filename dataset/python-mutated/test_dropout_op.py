...
@unittest.skipIf(not core.is_compiled_with_cuda() or not core.op_support_gpu('dropout'), 'core is not compiled with CUDA or core is not support dropout')
@skip_check_grad_ci(reason='For inference, check_grad is not required.')
...
@param.parameterized_class(('name', 'x', 'p', 'is_test', 'mode', 'seed', 'dtype', 'places'), (('fp32', np.ones(100000), 0.3, False, 'upscale_in_train', 1002, 'float32', places), ('bfp16', np.ones(100000), 0.3, False, 'upscale_in_train', 1002, 'bfloat16', places), ('fp64', np.ones(100000), 0.7, False, 'upscale_in_train', 9999, 'float64', places), ('is_test=True', np.ones(100000), 0.5, True, 'upscale_in_train', 1002, 'float32', places), ('p=1.0', np.ones(100000), 1.0, True, 'upscale_in_train', 1002, 'float32', places), ('p=1.0,dtype=bfp16', np.ones(100000), 1.0, True, 'upscale_in_train', 1002, 'bfloat16', places), ('p=1.0,test=False', np.ones(100000), 1.0, False, 'upscale_in_train', 1002, 'float32', places), ('p=1.0,test=False,dtype=bfp16', np.ones(100000), 1.0, False, 'upscale_in_train', 1002, 'bfloat16', places), ('p=0.0', np.ones(100000), 0, True, 'upscale_in_train', 1002, 'float32', places), ('p=0.0,dtype=bfp16', np.ones(100000), 0, True, 'upscale_in_train', 1002, 'bfloat16', places), ('downgrade_train', np.ones(100000), 0.5, False, 'downscale_in_infer', 1002, 'float32', places), ('downgrade_train,dtype=bfp16', np.ones(100000), 0.5, False, 'downscale_in_infer', 1002, 'bfloat16', places), ('fp32_cpu', np.ones(100000), 0.6, False, 'upscale_in_train', 9899, 'float64', [paddle.CPUPlace()]), ('fp64_cpu', np.ones(100000), 0.6, False, 'upscale_in_train', 9899, 'float64', [paddle.CPUPlace()]), ('downgrade_train_cpu', np.ones(100000), 0.5, False, 'downscale_in_infer', 1002, 'float32', [paddle.CPUPlace()])))
