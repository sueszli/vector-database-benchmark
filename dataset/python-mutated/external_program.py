...
class ExternalProgramTask(luigi.Task):
    ...
    stream_for_searching_tracking_url = luigi.parameter.ChoiceParameter(var_type=str, choices=['none', 'stdout', 'stderr'], default='none', significant=False, positional=False, visibility=ParameterVisibility.HIDDEN, description='Stream for searching tracking URL')
    ...
    tracking_url_pattern = luigi.OptionalParameter(default=None, significant=False, positional=False, visibility=ParameterVisibility.HIDDEN, description='Regex pattern used for searching URL in the logs of the external program')
...
class ExternalPythonProgramTask(ExternalProgramTask):
    ...
    """
    virtualenv = luigi.OptionalParameter(default=None, positional=False, description='path to the virtualenv directory to use. It should point to the directory containing the ``bin/activate`` file used for enabling the virtualenv.')
    extra_pythonpath = luigi.OptionalParameter(default=None, positional=False, description='extend the search path for modules by prepending this value to the ``PYTHONPATH`` environment variable.')
