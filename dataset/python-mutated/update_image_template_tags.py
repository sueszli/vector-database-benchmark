...
def main():
    ...
    response = client.virtual_machine_image_templates.begin_update(resource_group_name='myResourceGroup', image_template_name='myImageTemplate', parameters={'tags': {'new-tag': 'new-value'}}).result()
    print(response)
