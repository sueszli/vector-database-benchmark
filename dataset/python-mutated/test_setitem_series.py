...
class DiffFramesSetItemSeriesTests(DiffFramesSetItemSeriesMixin, PandasOnSparkTestCase, SQLTestUtils):
    pass
if __name__ == '__main__':
    import unittest
    from pyspark.pandas.tests.diff_frames_ops.test_setitem_series import *
    try:
        import xmlrunner
