...
from transformers.testing_utils import require_pytesseract, require_sentencepiece, require_tokenizers, require_torch, slow
...
class LayoutXLMProcessorTest(unittest.TestCase):
    ...
    def test_overflowing_tokens(self):
        ...
        def preprocess_data(examples):
            ...
            encoded_inputs = processor(images, words, boxes=boxes, word_labels=word_labels, max_length=512, padding='max_length', truncation=True, return_overflowing_tokens=True, stride=50, return_offsets_mapping=True, return_tensors='pt')
...
class LayoutXLMProcessorIntegrationTests(unittest.TestCase):
    ...
    def test_processor_case_1(self):
        ...
        for tokenizer in tokenizers:
            ...
            self.assertListEqual(actual_keys, expected_keys)
            self.assertAlmostEqual(input_feat_extract['pixel_values'].sum(), input_processor['image'].sum(), delta=0.01)
            expected_decoding = "<s> 7 ITC Limited REPORT AND ACCOUNTS 2013 ITC’s Brands: An Asset for the Nation The consumer needs and aspirations they fulfil, the benefit they generate for millions across ITC’s value chains, the future-ready capabilities that support them, and the value that they create for the country, have made ITC’s brands national assets, adding to India’s competitiveness. It is ITC’s aspiration to be the No 1 FMCG player in the country, driven by its new FMCG businesses. A recent Nielsen report has highlighted that ITC's new FMCG businesses are the fastest growing among the top consumer goods companies operating in India. ITC takes justifiable pride that, along with generating economic value, these celebrated Indian brands also drive the creation of larger societal capital through the virtuous cycle of sustainable and inclusive growth. DI WILLS * ; LOVE DELIGHTFULLY SOFT SKIN? aia Ans Source: https://www.industrydocuments.ucsf.edu/docs/snbx0223</s><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad><pad>"
