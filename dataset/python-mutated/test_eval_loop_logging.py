...
inputs1 = ([{'value': torch.tensor(2), 'performance': {'log:1': torch.tensor(0), 'log2': torch.tensor(3), 'log3': torch.tensor(7)}, 'extra': {'log3': torch.tensor(7)}}, {'different value': torch.tensor(1.5), 'tes:t': {'no_log1': torch.tensor(6), 'no_log2': torch.tensor(1)}}], RunningStage.TESTING.value)
expected1 = '\n────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\n       Test metric             DataLoader 0             DataLoader 1\n────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\n     different value                                         1.5\n       extra:log3                    7\n    performance:log2                 3\n    performance:log3                 7\n    performance:log:1                0\n      tes:t:no_log1                                           6\n      tes:t:no_log2                                           1\n          value                      2\n────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\n'
inputs2 = ([{f"a {'really ' * 11}long metric name": torch.tensor(5)}, {f"a {'really ' * 11}long metric name": torch.tensor([[6]])}], RunningStage.VALIDATING.value)
