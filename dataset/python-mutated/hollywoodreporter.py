...
from ..utils import ExtractorError, OnDemandPagedList, extract_attributes, get_element_by_class, get_element_html_by_class

class HollywoodReporterIE(InfoExtractor):
    _VALID_URL = 'https?://(?:www\\.)?hollywoodreporter\\.com/video/(?P<id>[\\w-]+)'
    _TESTS = [{'url': 'https://www.hollywoodreporter.com/video/chris-pine-michelle-rodriguez-dungeons-dragons-cast-directors-on-what-it-took-to-make-film-sxsw-2023/', 'info_dict': {'id': 'zH4jZaR5', 'ext': 'mp4', 'title': 'md5:a9a1c073770a32f178955997712c4bd9', 'description': "The cast and directors of 'Dungeons & Dragons: Honor Among Thieves' talk about their new film.", 'thumbnail': 'https://cdn.jwplayer.com/v2/media/zH4jZaR5/poster.jpg?width=720', 'upload_date': '20230312', 'timestamp': 1678586423, 'duration': 242.0}, 'params': {'skip_download': 'm3u8'}}]
...
class HollywoodReporterPlaylistIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.hollywoodreporter.com/vcategory/heat-vision-breakdown-57822/', 'playlist_mincount': 109, 'info_dict': {'id': '57822', 'title': 'heat-vision-breakdown'}}]
