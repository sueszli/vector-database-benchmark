...
@unittest.skipIf(paddle.inference.get_trt_compile_version() < (8, 5, 1), 'Quantization axis is consistent with Paddle after TRT 8.5.2.')
class TestExplicitQuantizationConv2d(TestExplicitQuantizationLayer, unittest.TestCase):
...
@unittest.skipIf(paddle.inference.get_trt_compile_version() < (8, 5, 1), 'Quantization axis is consistent with Paddle after TRT 8.5.2.')
class TestExplicitQuantizationMatmul(TestExplicitQuantizationLayer, unittest.TestCase):
