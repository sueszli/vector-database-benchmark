...
DY2ST_PRIM_CINN_GT = [11.086677551269531, 10.357963562011719, 10.33290958404541, 10.270476341247559, 10.230023384094238, 10.196759223937988, 10.153482437133789, 10.098485946655273, 10.119072914123535, 9.993000984191895]
...
class TestBert(unittest.TestCase):
    ...
    def test_prim_cinn(self):
        if False:
            return 10
        dy2st_prim_cinn = train(to_static=True, enable_prim=True, enable_cinn=True)
        np.testing.assert_allclose(dy2st_prim_cinn, DY2ST_PRIM_CINN_GT, rtol=1e-05)
