...
class TestAssembleWorksheet(unittest.TestCase):
    ...
    def test_assemble_xml_file(self):
        ...
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'begins with', 'value': 'b', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'begins with', 'value': 'bc', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'ends with', 'value': 'z', 'format': None})
        worksheet.conditional_format('A1:A4', {'type': 'text', 'criteria': 'ends with', 'value': 'yz', 'format': None})
