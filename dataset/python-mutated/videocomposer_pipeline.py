...
from modelscope.models.multi_modal.videocomposer.data.transforms import CenterCropV3, random_resize
from modelscope.models.multi_modal.videocomposer.ops.random_mask import make_irregular_mask, make_rectangle_mask, make_uncrop
...
@PIPELINES.register_module(Tasks.text_to_video_synthesis, module_name=Pipelines.videocomposer)
