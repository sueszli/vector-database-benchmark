...
class StreamCz(SimpleDownloader):
    ...
    __version__ = '0.41'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?stream\\.cz/[^/]+/(?P<EP>\\d+).+'
    __config__ = [('enabled', 'bool', 'Activated', True), ('quality', '144p;240p;360p;480p;720p;1080p', 'Quality', '720p'), ('container', 'mp4;webm', 'Container', 'mp4')]
