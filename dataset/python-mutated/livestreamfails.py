...
class LivestreamfailsIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://livestreamfails.com/clip/139200', 'md5': '8a03aea1a46e94a05af6410337463102', 'info_dict': {'id': '139200', 'ext': 'mp4', 'display_id': 'ConcernedLitigiousSalmonPeteZaroll-O8yo9W2L8OZEKhV2', 'title': 'Streamer jumps off a trampoline at full speed', 'creator': 'paradeev1ch', 'thumbnail': 're:^https?://.+', 'timestamp': 1656271785, 'upload_date': '20220626'}}, {'url': 'https://livestreamfails.com/post/139200', 'only_matching': True}]
