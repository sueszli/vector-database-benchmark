...
def update_input(project_id: str, location: str, input_id: str) -> live_stream_v1.types.Input:
    if False:
        for i in range(10):
            print('nop')
    ...
    input = live_stream_v1.types.Input(name=name, preprocessing_config=live_stream_v1.types.PreprocessingConfig(crop=live_stream_v1.types.PreprocessingConfig.Crop(top_pixels=5, bottom_pixels=5)))
...
if __name__ == '__main__':
    ...
    update_input(args.project_id, args.location, args.input_id)