...
class GenerationIntegrationTestsMixin:
    framework_dependent_parameters = {'AutoModelForCausalLM': None, 'AutoModelForSpeechSeq2Seq': None, 'AutoModelForSeq2SeqLM': None, 'AutoModelForVision2Seq': None, 'LogitsProcessorList': None, 'MinLengthLogitsProcessor': None, 'create_tensor_fn': None, 'floats_tensor': None, 'return_tensors': None, 'set_seed': None}
