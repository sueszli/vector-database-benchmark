...
class HellingerDistanceCriterion(SplitCriterion):
    ...
    def compute_hellinger(dist):
        ...
        hellinger = (math.sqrt(left_branch_negative / total_negative) - math.sqrt(left_branch_positive / total_positive)) ** 2 + (math.sqrt(right_branch_negative / total_negative) - math.sqrt(right_branch_positive / total_positive)) ** 2
