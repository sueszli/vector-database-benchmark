...
_SETTINGS = {'recaptcha.site_key': 'site_key_value', 'recaptcha.secret_key': 'secret_key_value'}
_REQUEST = pretend.stub(http=requests.Session(), registry=pretend.stub(settings=_SETTINGS))
