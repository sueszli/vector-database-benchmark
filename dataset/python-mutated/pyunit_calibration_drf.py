...
def calibration_test():
    ...
    model = H2ORandomForestEstimator(ntrees=100, distribution='bernoulli', min_rows=10, max_depth=5, weights_column='Weights', calibrate_model=True, calibration_frame=calib)
