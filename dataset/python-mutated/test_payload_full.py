...
from sentry.models.artifactbundle import ArtifactBundle, DebugIdArtifactBundle, ProjectArtifactBundle, SourceFileType
...
REAL_RESOLVING_EVENT_DATA = {'platform': 'cocoa', 'debug_meta': {'images': [{'type': 'apple', 'arch': 'x86_64', 'uuid': '502fc0a5-1ec1-3e47-9998-684fa139dca7', 'image_vmaddr': '0x0000000100000000', 'image_size': 4096, 'image_addr': '0x0000000100000000', 'name': 'Foo.app/Contents/Foo'}], 'sdk_info': {'dsym_type': 'macho', 'sdk_name': 'macOS', 'version_major': 10, 'version_minor': 12, 'version_patchlevel': 4}}, 'exception': {'values': [{'stacktrace': {'frames': [{'platform': 'foobar', 'function': 'hi'}, {'function': 'unknown', 'instruction_addr': '0x0000000100000fa0'}]}, 'type': 'Fail', 'value': 'fail'}]}, 'timestamp': iso_format(before_now(seconds=1))}
