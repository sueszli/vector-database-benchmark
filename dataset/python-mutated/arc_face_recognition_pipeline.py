...
from modelscope.models.cv.face_recognition.torchkit.backbone.arcface_backbone import _iresnet
...
@PIPELINES.register_module(Tasks.face_recognition, module_name=Pipelines.arc_face_recognition)
