...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_SoftLabel_1D(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_1D(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_SoftLabel_2D(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_SoftLabel_2D_Axis2(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_SoftLabel_2D_Axis3(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_SoftLabel_2D_Axis4(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_2D(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_2D_Axis2(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_2D_Axis3(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_2D_Axis4(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_Ignore(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_Ignore_Axis(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOp_NotWithSoftmax_HardLabel_2D_Ignore_Axis3(TestSoftmaxWithCrossEntropyOp):
...
class TestSoftmaxWithCrossEntropyOpNoCudnnFp16Axis1(TestSoftmaxWithCrossEntropyOpNoCudnnFp16):
...
class TestSoftmaxWithCrossEntropyOpNoCudnnFp16Axis2(TestSoftmaxWithCrossEntropyOpNoCudnnFp16):
...
class TestSoftmaxWithCrossEntropyOpNoCudnnFp16Axis3(TestSoftmaxWithCrossEntropyOpNoCudnnFp16):
...
class TestSoftmaxWithCrossEntropyOpIgnoreIndexNoCudnnAxis1(TestSoftmaxWithCrossEntropyOp3):
...
class TestSoftmaxWithCrossEntropyOpIgnoreIndexNoCudnnAxis2(TestSoftmaxWithCrossEntropyOp3):
...
class TestSoftmaxWithCrossEntropyOpIgnoreIndexNoCudnnAxis3(TestSoftmaxWithCrossEntropyOp3):
...
class TestSoftmaxWithCrossEntropyOpIgnoreIndexNoCudnnAxis4(TestSoftmaxWithCrossEntropyOp3):
