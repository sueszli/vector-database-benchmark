...
from ..framework import OpProtoHolder, Variable, convert_np_dtype_to_dtype_, core, in_dygraph_mode
...
_two_dollar_pattern_ = re.compile('\\$\\$([^\\$]+)\\$\\$')
_single_dollar_pattern_ = re.compile('\\$([^\\$]+)\\$')
_two_bang_pattern_ = re.compile('!!([^!]+)!!')
