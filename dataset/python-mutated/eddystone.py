...
EDDYSTONE_UUID = 65194
EDDYSTONE_URL_SCHEMES = {0: b'http://www.', 1: b'https://www.', 2: b'http://', 3: b'https://'}
EDDYSTONE_URL_TABLE = {0: b'.com/', 1: b'.org/', 2: b'.edu/', 3: b'.net/', 4: b'.info/', 5: b'.biz/', 6: b'.gov/', 7: b'.com', 8: b'.org', 9: b'.edu', 10: b'.net', 11: b'.info', 12: b'.biz', 13: b'.gov'}
...
class Eddystone_Frame(Packet, LowEnergyBeaconHelper):
    ...
    fields_desc = [BitField('type', None, 4), BitField('reserved', 0, 4)]
...
class Eddystone_UID(Packet):
    ...
    """
    name = 'Eddystone UID'
    fields_desc = [SignedByteField('tx_power', 0), StrFixedLenField('namespace', None, 10), StrFixedLenField('instance', None, 6), StrFixedLenField('reserved', None, 2)]
...
class Eddystone_URL(Packet):
    ...
    """
    name = 'Eddystone URL'
    fields_desc = [SignedByteField('tx_power', 0), ByteEnumField('url_scheme', 0, EDDYSTONE_URL_SCHEMES), EddystoneURLField('url', None)]
...
class Eddystone_TLM(Packet):
    ...
    """
    name = 'Eddystone TLM'
    fields_desc = [ByteEnumField('version', None, {0: 'unencrypted', 1: 'encrypted'})]
...
class Eddystone_TLM_Unencrypted(Packet):
    ...
    fields_desc = [ShortField('batt_mv', 0), FixedPointField('temperature', -128, 16, 8), IntField('adv_cnt', None), IntField('sec_cnt', None)]
...
class Eddystone_TLM_Encrypted(Packet):
    ...
    fields_desc = [StrFixedLenField('etlm', None, 12), StrFixedLenField('salt', None, 2), StrFixedLenField('mic', None, 2)]
...
class Eddystone_EID(Packet):
    ...
    """
    name = 'Eddystone EID'
    fields_desc = [SignedByteField('tx_power', 0), StrFixedLenField('eid', None, 8)]
