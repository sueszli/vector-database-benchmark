...
def main():
    ...
    response = client.targets.list(resource_group_name='exampleRG', parent_provider_namespace='Microsoft.Compute', parent_resource_type='virtualMachines', parent_resource_name='exampleVM')
