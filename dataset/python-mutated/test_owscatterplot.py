...
from Orange.widgets.visualize.owscatterplot import OWScatterPlot, ScatterPlotVizRank, OWScatterPlotGraph
from Orange.widgets.visualize.utils.widget import MAX_COLORS
from Orange.widgets.widget import AttributeList

class TestOWScatterPlot(WidgetTest, ProjectionWidgetTestMixin, WidgetOutputsTestMixin):
