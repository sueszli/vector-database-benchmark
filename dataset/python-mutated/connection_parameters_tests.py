...
_ALL_PUBLIC_PARAMETERS_PROPERTIES = tuple((attr for attr in vars(connection.Parameters) if not attr.startswith('_') and issubclass(type(getattr(connection.Parameters, attr)), property)))
