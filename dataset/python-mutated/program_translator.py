...
from paddle.base.dygraph.base import _to_static_mode_guard_, param_guard, switch_to_static_graph
from paddle.base.unique_name import UniqueNameGenerator, guard as UniqueNameGuard
from paddle.framework import in_dynamic_mode, use_pir_api
from paddle.nn.layer import layers
from paddle.utils import flatten, gast
from . import error, logging_utils
from .ast_transformer import DygraphToStaticAst
from .function_spec import FunctionSpec, _hash_spec_names, get_buffers, get_parameters
from .origin_info import attach_origin_info, create_and_update_origin_info_map, update_op_callstack_with_origin_info
...
from .utils import ALREADY_D2S, NO_SHAPE_VAR_TYPE, ast_to_func, backend_guard, func_to_source_code, input_specs_compatible, is_paddle_func, make_hashable, prim_or_cinn_is_enabled, type_name, unwrap
if TYPE_CHECKING:
...
class CacheKey:
    ...
    """
    __slots__ = ['function_spec', 'input_args_with_spec', 'input_kwargs_with_spec', 'class_instance', 'kwargs', '_spec_names_id', '_pir_flags']
...
class SymbolicStaticFunction(StaticFunction):
    ...
    concrete_program_specify_input_spec = raise_error_template('concrete_program_specify_input_spec')
    get_concrete_program = raise_error_template('get_concrete_program')
    get_concrete_program_with_cache_key = raise_error_template('get_concrete_program_with_cache_key')
...
class ConcreteProgram:
    __slots__ = ['inputs', 'outputs', 'main_program', 'startup_program', 'parameters', 'function', 'name_generator', 'kwargs']
...
class FallbackProgramLayer:
    __slots__ = ['_instance', '_dy_func', 'training', '_cuda_graph_capture_mode', '_cuda_graph_pool_id']
