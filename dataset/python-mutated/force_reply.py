...
class ForceReply(MutableTelegramObject):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, force_reply: Literal[True]=True, input_field_placeholder: Optional[str]=None, selective: Optional[bool]=None, **__pydantic_kwargs: Any) -> None:
            if False:
                for i in range(10):
                    print('nop')
            super().__init__(force_reply=force_reply, input_field_placeholder=input_field_placeholder, selective=selective, **__pydantic_kwargs)