...
class SourceControlSyncJobStreamsOperations:
    ...
    @distributed_trace
    def list_by_sync_job(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, filter: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.SourceControlSyncJobStream']:
        if False:
            print('Hello World!')
    ...
    async def get(self, resource_group_name: str, automation_account_name: str, source_control_name: str, source_control_sync_job_id: str, stream_id: str, **kwargs: Any) -> _models.SourceControlSyncJobStreamById:
