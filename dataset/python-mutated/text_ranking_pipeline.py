...
from modelscope.preprocessors import Preprocessor, TextRankingTransformersPreprocessor
from modelscope.utils.constant import ModelFile, Tasks
__all__ = ['TextRankingPipeline']

@PIPELINES.register_module(Tasks.text_ranking, module_name=Pipelines.text_ranking)
