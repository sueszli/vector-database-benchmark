...
from modelscope.models.cv.motion_generation import ClassifierFreeSampleModel, create_model, load_model_wo_clip
...
@PIPELINES.register_module(Tasks.motion_generation, module_name=Pipelines.motion_generattion)
