...
class Migration(migrations.Migration):
    dependencies = [('zerver', '0429_user_topic_case_insensitive_unique_toghether')]
    operations = [migrations.RunPython(fix_audit_log_objects_for_group_based_stream_settings, reverse_code=migrations.RunPython.noop, elidable=True)]