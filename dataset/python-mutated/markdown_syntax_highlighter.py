...
class MarkdownHighlighter(QSyntaxHighlighter):
    MARKDOWN_KEYS_REGEX = {'Bold': re.compile('(?<!\\\\)(?P<delim>\\*\\*)(?P<text>.+?)(?P=delim)'), 'Italic': re.compile('(?<![\\*\\\\])(?P<delim>\\*)(?!\\*)(?P<text>([^\\*]{2,}?|[^\\*]))(?<![\\*\\\\])(?P=delim)'), 'BoldItalic': re.compile('(?<!\\\\)(?P<delim>\\*\\*\\*)(?P<text>([^\\*]{2,}?|[^\\*]))(?<!\\\\)(?P=delim)'), 'uBold': re.compile('(?<!\\\\)(?P<delim>__)(?P<text>.+?)(?P=delim)'), 'uItalic': re.compile('(?<![_\\\\])(?P<delim>_)(?!_)(?P<text>([^_]{2,}?|[^_]))(?<![_\\\\])(?P=delim)'), 'uBoldItalic': re.compile('(?<!\\\\)(?P<delim>___)(?P<text>([^_]{2,}?|[^_]))(?<!\\\\)(?P=delim)'), 'Link': re.compile('(?<![!\\\\]])\\[.*?(?<!\\\\)\\](\\[.+?(?<!\\\\)\\]|\\(.+?(?<!\\\\)\\))'), 'Image': re.compile('(?<!\\\\)!\\[.*?(?<!\\\\)\\](\\[.+?(?<!\\\\)\\]|\\(.+?(?<!\\\\)\\))'), 'LinkRef': re.compile('(?u)^\\s*\\[.*?\\]:\\s*[^\\s].*'), 'Header': re.compile('^#{1,6}.*'), 'UnorderedList': re.compile('(?u)^\\s*(\\*|\\+|-)[ \\t]\\s*'), 'UnorderedListStar': re.compile('(?u)^\\s*\\*[ \\t]\\s*'), 'OrderedList': re.compile('(?u)^\\s*\\d+\\.[ \\t]\\s*'), 'BlockQuote': re.compile('^[ ]{0,3}>+[ \\t]?'), 'CodeBlock': re.compile('^([ ]{4,}|[ ]*\\t).*'), 'CodeSpan': re.compile('(?<!\\\\)(?P<delim>`+).+?(?P=delim)'), 'HeaderLine': re.compile('(?u)^(-|=)+\\s*$'), 'HR': re.compile('(?u)^(\\s*(\\*|-|_)\\s*){3,}$'), 'Html': re.compile('(?u)</?[^/\\s].*?(?<!\\\\)>'), 'Entity': re.compile('&([A-z]{2,7}|#\\d{1,7}|#x[\\dA-Fa-f]{1,6});')}
    key_theme_maps = {'Bold': 'bold', 'Italic': 'emphasis', 'BoldItalic': 'boldemphasis', 'uBold': 'bold', 'uItalic': 'emphasis', 'uBoldItalic': 'boldemphasis', 'Link': 'link', 'Image': 'image', 'LinkRef': 'link', 'Header': 'header', 'HeaderLine': 'header', 'CodeBlock': 'codeblock', 'UnorderedList': 'unorderedlist', 'UnorderedListStar': 'unorderedlist', 'OrderedList': 'orderedlist', 'BlockQuote': 'blockquote', 'CodeSpan': 'codespan', 'HR': 'line', 'Html': 'html', 'Entity': 'entity'}
    light_theme = {'bold': {'font-weight': 'bold'}, 'emphasis': {'font-style': 'italic'}, 'boldemphasis': {'font-weight': 'bold', 'font-style': 'italic'}, 'link': {'color': light_link_color.name(), 'font-weight': 'normal', 'font-style': 'normal'}, 'image': {'color': '#cb4b16', 'font-weight': 'normal', 'font-style': 'normal'}, 'header': {'color': '#2aa198', 'font-weight': 'bold', 'font-style': 'normal'}, 'unorderedlist': {'color': 'red', 'font-weight': 'normal', 'font-style': 'normal'}, 'orderedlist': {'color': 'red', 'font-weight': 'normal', 'font-style': 'normal'}, 'blockquote': {'color': 'red', 'font-weight': 'bold', 'font-style': 'normal'}, 'codespan': {'color': '#ff5800', 'font-weight': 'normal', 'font-style': 'normal'}, 'codeblock': {'color': '#ff5800', 'font-weight': 'normal', 'font-style': 'normal'}, 'line': {'color': '#2aa198', 'font-weight': 'normal', 'font-style': 'normal'}, 'html': {'color': '#c000c0', 'font-weight': 'normal', 'font-style': 'normal'}, 'entity': {'color': '#006496'}}
    dark_theme = {'bold': {'font-weight': 'bold'}, 'emphasis': {'font-style': 'italic'}, 'boldemphasis': {'font-weight': 'bold', 'font-style': 'italic'}, 'link': {'color': dark_link_color.name(), 'font-weight': 'normal', 'font-style': 'normal'}, 'image': {'color': '#cb4b16', 'font-weight': 'normal', 'font-style': 'normal'}, 'header': {'color': '#2aa198', 'font-weight': 'bold', 'font-style': 'normal'}, 'unorderedlist': {'color': 'yellow', 'font-weight': 'normal', 'font-style': 'normal'}, 'orderedlist': {'color': 'yellow', 'font-weight': 'normal', 'font-style': 'normal'}, 'blockquote': {'color': 'yellow', 'font-weight': 'bold', 'font-style': 'normal'}, 'codespan': {'color': '#90ee90', 'font-weight': 'normal', 'font-style': 'normal'}, 'codeblock': {'color': '#ff9900', 'font-weight': 'normal', 'font-style': 'normal'}, 'line': {'color': '#2aa198', 'font-weight': 'normal', 'font-style': 'normal'}, 'html': {'color': '#f653a6', 'font-weight': 'normal', 'font-style': 'normal'}, 'entity': {'color': '#ff82ac'}}
