...
from tests.snuba.api.endpoints.test_organization_events_facets_performance import BaseOrganizationEventsFacetsPerformanceEndpointTest

@region_silo_test
class OrganizationEventsFacetsPerformanceHistogramEndpointTest(BaseOrganizationEventsFacetsPerformanceEndpointTest):
    feature_list = ('organizations:discover-basic', 'organizations:global-views', 'organizations:performance-view')
