...
@patch('sentry.notifications.notifications.missing_members_nudge.MissingMembersNudgeNotification.send')
@patch('sentry.tasks.invite_missing_org_members.send_nudge_email')
