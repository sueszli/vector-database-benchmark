...
@MODELS.register_module(Tasks.product_segmentation, module_name=Models.product_segmentation)
class F3NetForProductSegmentation(TorchModel):
    ...
    def forward(self, x):
        ...
        return pred_result
(mean, std) = (np.array([[[124.55, 118.9, 102.94]]]), np.array([[[56.77, 55.97, 57.5]]]))
