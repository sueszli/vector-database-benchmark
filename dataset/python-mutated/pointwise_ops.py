...
for_each_ops = [aten._foreach_addcmul_.Scalar, aten._foreach_addcdiv_.ScalarList, aten._foreach_div_.ScalarList, aten._foreach_lerp_.Scalar, aten._foreach_maximum_.List, aten._foreach_mul_.Scalar, aten._foreach_neg_.default, aten._foreach_neg.default, aten._foreach_reciprocal_.default, aten._foreach_sub_.Scalar, aten._foreach_sqrt.default, aten._foreach_sqrt_.default]
for_each_linearity_ops = [aten._foreach_add_.Scalar, aten._foreach_add.List, aten._foreach_add_.List]
