...
class Exploit(HTTPClient):
    ...
    def run(self):
        ...
        response = self.http_request(method='POST', path='/getcfg.php', data=data)
        if response is None:
            return
