...
class XPUTestDiagV2Op(XPUOpTestWrapper):
    ...
    class TestDiagV2API(unittest.TestCase):
        ...
        def setUp(self):
            ...
            self.input_np3 = np.random.randint(-10, 10, size=100).astype(self.dtype)
            ...
            self.input_np4 = np.random.random(size=(2000, 2000)).astype(self.dtype)
            ...
            self.input_np6 = np.random.random(size=(2000, 1500)).astype(self.dtype)
        ...
        def run_static(self, use_gpu=False):
            ...
            if self.dtype == np.float16:
                return
            np.random.seed(1024)
            x = paddle.static.data(name='input', shape=[10, 10], dtype=self.dtype)
            x2 = paddle.static.data(name='input2', shape=[100], dtype=self.dtype)
            x3 = paddle.static.data(name='input3', shape=[100], dtype=self.dtype)
            x4 = paddle.static.data(name='input4', shape=[2000, 2000], dtype=self.dtype)
            x5 = paddle.static.data(name='input5', shape=[2000], dtype=self.dtype)
            x6 = paddle.static.data(name='input6', shape=[2000, 1500], dtype=self.dtype)
