...
class ProfileOutput(enum.Enum):
    ...
    TOTAL_SHARED_MEMORY_SIZE_OVER_TIME_GRAPH: str = 'total_shared_memory_size_over_time_graph'
...
class AnalyzeArguments:
    ...
    saved_state_arguments: PysaSavedStateArguments = field(default_factory=PysaSavedStateArguments)
