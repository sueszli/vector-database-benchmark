...
class Migration(migrations.Migration):
    dependencies = [('core', '0002_managedfile'), ('extras', '0090_objectchange_index_request_id')]
    operations = [migrations.CreateModel(name='ReportModule', fields=[], options={'proxy': True, 'indexes': [], 'constraints': []}, bases=(extras.models.mixins.PythonModuleMixin, 'core.managedfile', models.Model)), migrations.CreateModel(name='ScriptModule', fields=[], options={'proxy': True, 'indexes': [], 'constraints': []}, bases=(extras.models.mixins.PythonModuleMixin, 'core.managedfile', models.Model)), migrations.RunPython(code=replicate_scripts, reverse_code=migrations.RunPython.noop), migrations.RunPython(code=replicate_reports, reverse_code=migrations.RunPython.noop)]