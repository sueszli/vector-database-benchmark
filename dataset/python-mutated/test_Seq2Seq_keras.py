...
class TestSeq2Seq(TestCase):
    ...
    def test_seq2seq_fit_predict_evaluate(self):
        ...
        model = model_creator(config={'input_feature_num': 10, 'output_feature_num': 2, 'future_seq_len': test_data[-1].shape[1], 'lstm_hidden_dim': 32})
    ...
    def test_seq2seq_save_load(self):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir_file:
            ...
            import keras
            restore_model = keras.models.load_model(tmp_dir_file, custom_objects={'LSTMSeq2Seq': LSTMSeq2Seq})
        ...
        temp_LSTMSeq2Seq = LSTMSeq2Seq(input_feature_num=10, output_feature_num=2, future_seq_len=test_data[-1].shape[1], lstm_hidden_dim=32).__class__
