...
from torch._numpy import array, bool_, complex128, complex64, float32, float64, inf, int16, int32, int64, uint8
...
weaks = (True, 1, 2.0, 3j)
non_weaks = (tnp.asarray(True), tnp.uint8(1), tnp.int8(1), tnp.int32(1), tnp.int64(1), tnp.float32(1), tnp.float64(1), tnp.complex64(1), tnp.complex128(1))
if HAVE_NUMPY:
    dtypes = (None, _np.bool_, _np.uint8, _np.int8, _np.int32, _np.int64, _np.float32, _np.float64, _np.complex64, _np.complex128)
else:
    dtypes = (None,)
corners = {'true_divide': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'divide': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'arctan2': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'copysign': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'heaviside': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'ldexp': ['bool_', 'uint8', 'int8', 'int16', 'int32', 'int64'], 'power': ['uint8'], 'nextafter': ['float32']}
