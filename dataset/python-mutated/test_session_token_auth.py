...
config = {'instance_api_url': instance_api_url, 'username': username, 'password': password, 'session_token': session_token, 'header': header, 'session_token_response_key': session_token_response_key, 'login_url': login_url, 'validate_session_url': validate_session_url}
config_session_token = {'instance_api_url': instance_api_url, 'username': '', 'password': '', 'session_token': session_token, 'header': header, 'session_token_response_key': session_token_response_key, 'login_url': login_url, 'validate_session_url': validate_session_url}
config_username_password = {'instance_api_url': instance_api_url, 'username': username, 'password': password, 'session_token': '', 'header': header, 'session_token_response_key': session_token_response_key, 'login_url': login_url, 'validate_session_url': validate_session_url}
