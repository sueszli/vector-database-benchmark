...
class BaseViewRestriction(models.Model):
    ...
    GROUPS = 'groups'
    LOGIN = 'login'
    RESTRICTION_CHOICES = ((NONE, _('Public')), (LOGIN, _('Private, accessible to logged-in users')), (PASSWORD, _('Private, accessible with the following password')), (GROUPS, _('Private, accessible to users in specific groups')))
