...
class AlbumForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {'band': AutocompleteSelect(Album._meta.get_field('band'), admin.site, attrs={'class': 'my-class'}), 'featuring': AutocompleteSelect(Album._meta.get_field('featuring'), admin.site)}
...
class VideoStreamForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {'release_event': AutocompleteSelect(VideoStream._meta.get_field('release_event'), admin.site)}
