...
class TestBroadcastToOp(OpTest):
    ...
    def build_cinn_program(self, target):
        ...
        out = builder.broadcast_to(x, out_shape=self.case['d_shape'], broadcast_axes=self.case['broadcast_axes'])
        prog = builder.build()
...
class TestBroadcastToAllOne(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.inputs = [{'x_shape': [1], 'd_shape': [1, 2], 'broadcast_axes': [1]}, {'x_shape': [5, 3], 'd_shape': [4, 5, 3], 'broadcast_axes': [1, 2]}, {'x_shape': [4, 5, 3], 'd_shape': [6, 4, 5, 3], 'broadcast_axes': [1, 2, 3]}, {'x_shape': [5, 4, 3, 2], 'd_shape': [6, 5, 4, 3, 2], 'broadcast_axes': [1, 2, 3, 4]}, {'x_shape': [16, 8, 4, 2, 1], 'd_shape': [32, 16, 8, 4, 2, 1], 'broadcast_axes': [1, 2, 3, 4, 5]}]
...
class TestBroadcastToAllTwo(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.class_name = 'TestBroadcastToOpCase'
        self.cls = TestBroadcastToOp
        self.inputs = [{'x_shape': [5, 3], 'd_shape': [4, 5, 3], 'broadcast_axes': [1, 2]}]
        self.dtypes = [{'x_dtype': 'bool'}, {'x_dtype': 'int32'}, {'x_dtype': 'int64'}, {'x_dtype': 'float16'}, {'x_dtype': 'float32'}, {'x_dtype': 'float64'}]
        self.attrs = []
...
class TestBroadcastToOpNoAxesAllOne(TestCaseHelper):
    ...
    def init_attrs(self):
        ...
        self.inputs = [{'x_shape': [1], 'd_shape': [1, 2]}, {'x_shape': [6], 'd_shape': [4, 5, 6]}, {'x_shape': [1, 1, 1], 'd_shape': [4, 5, 3]}, {'x_shape': [1, 1, 3], 'd_shape': [4, 5, 3]}, {'x_shape': [4, 1, 3], 'd_shape': [4, 5, 3]}, {'x_shape': [64, 2], 'd_shape': [64, 2]}, {'x_shape': [64, 32, 16], 'd_shape': [128, 64, 32, 16]}, {'x_shape': [64, 32, 16, 8], 'd_shape': [128, 64, 32, 16, 8]}]
        self.dtypes = [{'x_dtype': 'float32'}]
        self.attrs = []
