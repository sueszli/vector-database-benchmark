...
class VersionUpgrade49to410(VersionUpgrade):
    ...
    """
    _renamed_profiles = {'twotrees_bluer': 'two_trees_bluer', 'twotrees_bluer_extruder_0': 'two_trees_base_extruder_0', 'twotrees_bluer_extruder_1': 'two_trees_base_extruder_0'}
    _quality_changes_to_two_trees_base = {'twotrees_bluer_extruder_0', 'twotrees_bluer_extruder_1', 'twotrees_bluer'}
    _default_variants = {'twotrees_bluer_extruder_0': 'two_trees_bluer_0.4', 'twotrees_bluer_extruder_1': 'two_trees_bluer_0.4'}
    _two_trees_bluer_quality_type_conversion = {'high': 'ultra', 'normal': 'super', 'fast': 'standard', 'draft': 'standard', 'extra_fast': 'low', 'coarse': 'draft', 'extra_coarse': 'draft'}
    _two_trees_quality_per_material = {'generic_abs_175': {'high': 'two_trees_0.4_ABS_super', 'normal': 'two_trees_0.4_ABS_super', 'fast': 'two_trees_0.4_ABS_super', 'draft': 'two_trees_0.4_ABS_standard', 'extra_fast': 'two_trees_0.4_ABS_low', 'coarse': 'two_trees_0.4_ABS_low', 'extra_coarse': 'two_trees_0.4_ABS_low'}, 'generic_petg_175': {'high': 'two_trees_0.4_PETG_super', 'normal': 'two_trees_0.4_PETG_super', 'fast': 'two_trees_0.4_PETG_super', 'draft': 'two_trees_0.4_PETG_standard', 'extra_fast': 'two_trees_0.4_PETG_low', 'coarse': 'two_trees_0.4_PETG_low', 'extra_coarse': 'two_trees_0.4_PETG_low'}, 'generic_pla_175': {'high': 'two_trees_0.4_PLA_super', 'normal': 'two_trees_0.4_PLA_super', 'fast': 'two_trees_0.4_PLA_super', 'draft': 'two_trees_0.4_PLA_standard', 'extra_fast': 'two_trees_0.4_PLA_low', 'coarse': 'two_trees_0.4_PLA_low', 'extra_coarse': 'two_trees_0.4_PLA_low'}, 'generic_tpu_175': {'high': 'two_trees_0.4_TPU_super', 'normal': 'two_trees_0.4_TPU_super', 'fast': 'two_trees_0.4_TPU_super', 'draft': 'two_trees_0.4_TPU_standard', 'extra_fast': 'two_trees_0.4_TPU_standard', 'coarse': 'two_trees_0.4_TPU_standard', 'extra_coarse': 'two_trees_0.4_TPU_standard'}, 'empty_material': {'high': 'two_trees_global_super', 'normal': 'two_trees_global_super', 'fast': 'two_trees_global_super', 'draft': 'two_trees_global_standard', 'extra_fast': 'two_trees_global_low', 'coarse': 'two_trees_global_low', 'extra_coarse': 'two_trees_global_low'}}
    _deltacomb_quality_type_conversion = {'a': 'D005', 'b': 'D010', 'c': 'D015', 'd': 'D020', 'e': 'D030', 'f': 'D045', 'g': 'D060'}
