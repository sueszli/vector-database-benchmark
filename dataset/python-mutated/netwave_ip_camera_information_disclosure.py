...
class Exploit(HTTPClient):
    __info__ = {'name': 'Netwave IP Camera Information Disclosure', 'description': 'This exploit will try to retrieve WPA password and ddns host name, Also it would try to read memory leak in order to find username and password', 'authors': ('spiritnull', 'renos stoikos <rstoikos[at]gmail.com>'), 'references': ('https://www.exploit-db.com/exploits/41236/',), 'devices': ('Netwave IP Camera',)}
