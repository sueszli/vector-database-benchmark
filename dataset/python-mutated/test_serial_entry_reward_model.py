...
from ding.entry import serial_pipeline, collect_demo_data, serial_pipeline_reward_model_offpolicy, serial_pipeline_reward_model_onpolicy
cfg = [{'type': 'pdeil', 'alpha': 0.5, 'discrete_action': False}, {'type': 'gail', 'input_size': 5, 'hidden_size': 64, 'batch_size': 64}, {'type': 'pwil', 's_size': 4, 'a_size': 2, 'sample_size': 500}, {'type': 'red', 'sample_size': 5000, 'input_size': 5, 'hidden_size': 64, 'update_per_collect': 200, 'batch_size': 128}]
