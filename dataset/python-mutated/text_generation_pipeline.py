...
from modelscope.outputs import ModelOutputBase, OutputKeys, TokenGeneratorOutput
...
__all__ = ['TextGenerationPipeline', 'TextGenerationT5Pipeline', 'ChatGLM6bTextGenerationPipeline', 'ChatGLM6bV2TextGenerationPipeline', 'QWenChatPipeline', 'QWenTextGenerationPipeline', 'SeqGPTPipeline', 'Llama2TaskPipeline']

@PIPELINES.register_module(Tasks.text_generation, module_name=Pipelines.text_generation)
...
@PIPELINES.register_module(Tasks.text2text_generation, module_name=Pipelines.translation_en_to_de)
@PIPELINES.register_module(Tasks.text2text_generation, module_name=Pipelines.translation_en_to_ro)
@PIPELINES.register_module(Tasks.text2text_generation, module_name=Pipelines.translation_en_to_fr)
@PIPELINES.register_module(Tasks.text2text_generation, module_name=Pipelines.text2text_generation)
...
@PIPELINES.register_module(group_key=Tasks.chat, module_name='chatglm6b-text-generation')
...
@PIPELINES.register_module(group_key=Tasks.chat, module_name='chatglm2_6b-text-generation')
...
@PIPELINES.register_module(group_key=Tasks.text_generation, module_name='qwen-text-generation')
...
@PIPELINES.register_module(group_key=Tasks.text_generation, module_name='seqgpt')
...
@PIPELINES.register_module(Tasks.chat, module_name=Pipelines.llama2_text_generation_chat_pipeline)
