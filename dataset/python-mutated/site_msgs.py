...
from ..serializers import SiteMessageSerializer, SiteMessageIdsSerializer, SiteMessageSendSerializer
from ..site_msg import SiteMessageUtil
__all__ = ('SiteMessageViewSet',)

class SiteMessageViewSet(ListModelMixin, RetrieveModelMixin, JMSGenericViewSet):
    permission_classes = (IsValidUser,)
    serializer_classes = {'default': SiteMessageSerializer, 'mark_as_read': SiteMessageIdsSerializer, 'send': SiteMessageSendSerializer}
