...
class LayoutLMv3ModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (LayoutLMv3Model, LayoutLMv3ForSequenceClassification, LayoutLMv3ForTokenClassification, LayoutLMv3ForQuestionAnswering) if is_torch_available() else ()
    pipeline_model_mapping = {'document-question-answering': LayoutLMv3ForQuestionAnswering, 'feature-extraction': LayoutLMv3Model} if is_torch_available() else {}
