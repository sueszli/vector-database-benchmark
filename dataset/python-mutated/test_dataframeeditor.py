...
from pandas import __version__ as pandas_version, DataFrame, date_range, read_csv, concat, Index, RangeIndex, MultiIndex, CategoricalIndex, Series
import pytest
...
from spyder.plugins.variableexplorer.widgets.dataframeeditor import DataFrameEditor, DataFrameModel
