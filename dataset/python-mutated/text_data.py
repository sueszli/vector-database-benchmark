...
from deepchecks.nlp.input_validations import ColumnTypes, validate_length_and_calculate_column_types, validate_length_and_type_numpy_array, validate_modify_label, validate_raw_text, validate_tokenized_text
...
class TextData:
    ...
    _tokenized_text: t.Optional[t.Sequence[t.Sequence[str]]] = None
    ...
    _original_text_index: t.Optional[t.Sequence[int]] = None
