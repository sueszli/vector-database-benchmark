...
import proto
__protobuf__ = proto.module(package='google.shopping.merchant.inventories.v1beta', manifest={'LocalInventory', 'ListLocalInventoriesRequest', 'ListLocalInventoriesResponse', 'InsertLocalInventoryRequest', 'DeleteLocalInventoryRequest'})

class LocalInventory(proto.Message):
    """Local inventory information for the product. Represents in-store
    ...
    account: int = proto.Field(proto.INT64, number=2)
    store_code: str = proto.Field(proto.STRING, number=3)
    price: types.Price = proto.Field(proto.MESSAGE, number=4, message=types.Price)
    sale_price: types.Price = proto.Field(proto.MESSAGE, number=5, message=types.Price)
    sale_price_effective_date: interval_pb2.Interval = proto.Field(proto.MESSAGE, number=6, message=interval_pb2.Interval)
    availability: str = proto.Field(proto.STRING, number=7, optional=True)
    ...
    pickup_sla: str = proto.Field(proto.STRING, number=10, optional=True)
    instore_product_location: str = proto.Field(proto.STRING, number=11, optional=True)
    custom_attributes: MutableSequence[types.CustomAttribute] = proto.RepeatedField(proto.MESSAGE, number=12, message=types.CustomAttribute)
...
class ListLocalInventoriesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    local_inventories: MutableSequence['LocalInventory'] = proto.RepeatedField(proto.MESSAGE, number=1, message='LocalInventory')
...
class InsertLocalInventoryRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    local_inventory: 'LocalInventory' = proto.Field(proto.MESSAGE, number=2, message='LocalInventory')
