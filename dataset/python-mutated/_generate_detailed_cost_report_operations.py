...
class GenerateDetailedCostReportOperations:
    ...
    async def _create_operation_initial(self, scope: str, parameters: Union[_models.GenerateDetailedCostReportDefinition, IO], **kwargs: Any) -> Optional[_models.GenerateDetailedCostReportOperationResult]:
        ...
        if response.status_code not in [200, 202]:
            ...
            error = self._deserialize.failsafe_deserialize(_models.GenerateDetailedCostReportErrorResponse, pipeline_response)
        ...
        return deserialized
    _create_operation_initial.metadata = {'url': '/{scope}/providers/Microsoft.CostManagement/generateDetailedCostReport'}

    @overload
    async def begin_create_operation(self, scope: str, parameters: _models.GenerateDetailedCostReportDefinition, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.GenerateDetailedCostReportOperationResult]:
    ...
    @overload
    async def begin_create_operation(self, scope: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.GenerateDetailedCostReportOperationResult]:
        """Generates the detailed cost report for provided date range, billing period(only enterprise
        customers) or Invoice ID asynchronously at a certain scope. Call returns a 202 with header
        Azure-Consumption-AsyncOperation providing a link to the operation created. A call on the
        operation will provide the status and if the operation is completed the blob file where
    ...
    async def begin_create_operation(self, scope: str, parameters: Union[_models.GenerateDetailedCostReportDefinition, IO], **kwargs: Any) -> AsyncLROPoller[_models.GenerateDetailedCostReportOperationResult]:
        """Generates the detailed cost report for provided date range, billing period(only enterprise
        customers) or Invoice ID asynchronously at a certain scope. Call returns a 202 with header
        Azure-Consumption-AsyncOperation providing a link to the operation created. A call on the
        operation will provide the status and if the operation is completed the blob file where
