...
class Migration(migrations.Migration):
    dependencies = [('discount', '0046_promotion_discount_indexes')]
    operations = [migrations.RunPython(run_migration, migrations.RunPython.noop), migrations.RunPython(update_discounted_prices, reverse_code=migrations.RunPython.noop)]