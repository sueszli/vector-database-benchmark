...
ignore_fallback_warnings = pytest.mark.filterwarnings('ignore', category=FallbackWarning)
...
@testing.parameterize({'func': 'min', 'shape': (3, 4), 'args': (), 'kwargs': {'axis': 0}}, {'func': 'argmin', 'shape': (3, 4), 'args': (), 'kwargs': {}}, {'func': 'roots', 'shape': (3,), 'args': (), 'kwargs': {}}, {'func': 'resize', 'shape': (2, 6), 'args': ((6, 2),), 'kwargs': {}}, {'func': 'resize', 'shape': (3, 4), 'args': ((4, 9),), 'kwargs': {}}, {'func': 'delete', 'shape': (5, 4), 'args': (1, 0), 'kwargs': {}}, {'func': 'append', 'shape': (2, 3), 'args': ([[7, 8, 9]],), 'kwargs': {'axis': 0}}, {'func': 'asarray_chkfinite', 'shape': (2, 4), 'args': (), 'kwargs': {'dtype': numpy.float64}})
@ignore_fallback_warnings
...
@testing.parameterize({'func': 'min', 'shape': (3, 4), 'args': (), 'kwargs': {'axis': 0}, 'numpy_version': None}, {'func': 'argmin', 'shape': (3, 4), 'args': (), 'kwargs': {}, 'numpy_version': (1, 10, 0)}, {'func': 'arccos', 'shape': (2, 3), 'args': (), 'kwargs': {}, 'numpy_version': None}, {'func': 'fabs', 'shape': (2, 3), 'args': (), 'kwargs': {}, 'numpy_version': None}, {'func': 'nancumsum', 'shape': (5, 3), 'args': (), 'kwargs': {'axis': 1}, 'numpy_version': (1, 12, 0)}, {'func': 'nanpercentile', 'shape': (3, 4), 'args': (50,), 'kwargs': {'axis': 0}, 'numpy_version': None})
@ignore_fallback_warnings
...
@testing.parameterize({'object': 'ndarray'}, {'object': 'ndarray.__add__'}, {'object': 'vectorize'}, {'object': 'linalg.eig'})
...
@testing.parameterize({'func': 'min', 'shape': (5,), 'args': (), 'kwargs': {}}, {'func': 'argmax', 'shape': (5, 3), 'args': (), 'kwargs': {'axis': 0}}, {'func': 'ptp', 'shape': (3, 3), 'args': (), 'kwargs': {'axis': 1}}, {'func': 'compress', 'shape': (3, 2), 'args': ([False, True],), 'kwargs': {'axis': 0}})
...
@testing.parameterize({'func': '__eq__', 'shape': (3, 4)}, {'func': '__ne__', 'shape': (3, 1)}, {'func': '__gt__', 'shape': (4,)}, {'func': '__lt__', 'shape': (1, 1)}, {'func': '__ge__', 'shape': (1, 2)}, {'func': '__le__', 'shape': (1,)})
...
@testing.parameterize({'func': '__str__', 'shape': (5, 6)}, {'func': '__repr__', 'shape': (3, 4)}, {'func': '__int__', 'shape': ()}, {'func': '__float__', 'shape': ()}, {'func': '__len__', 'shape': (3, 3)}, {'func': '__bool__', 'shape': ()})
...
@testing.parameterize({'func': '__abs__', 'shape': (5, 6), 'dtype': numpy.float32}, {'func': '__copy__', 'shape': (3, 4), 'dtype': numpy.float32}, {'func': '__neg__', 'shape': (3, 3), 'dtype': numpy.float32}, {'func': '__invert__', 'shape': (2, 4), 'dtype': numpy.int32})
...
@testing.parameterize({'func': '__add__', 'shape': (3, 4), 'dtype': numpy.float32}, {'func': '__sub__', 'shape': (2, 2), 'dtype': numpy.float32}, {'func': '__mul__', 'shape': (5, 6), 'dtype': numpy.float32}, {'func': '__mod__', 'shape': (3, 4), 'dtype': numpy.float32}, {'func': '__iadd__', 'shape': (1,), 'dtype': numpy.float32}, {'func': '__imul__', 'shape': (1, 1), 'dtype': numpy.float32}, {'func': '__and__', 'shape': (3, 3), 'dtype': numpy.int32}, {'func': '__ipow__', 'shape': (4, 5), 'dtype': numpy.int32}, {'func': '__xor__', 'shape': (4, 4), 'dtype': numpy.int32}, {'func': '__lshift__', 'shape': (2,), 'dtype': numpy.int32}, {'func': '__irshift__', 'shape': (3, 2), 'dtype': numpy.int32})
