...
from azure.communication.jobrouter.models import ExceptionPolicy, ExceptionRule, QueueLengthExceptionTrigger, WaitTimeExceptionTrigger, ReclassifyExceptionAction, ManualReclassifyExceptionAction, CancelExceptionAction, RoundRobinMode, DistributionPolicy, RouterQueue, ClassificationPolicy
...
exception_actions = [CancelExceptionAction()]
        ...
        async with router_client:
            for trigger in exception_triggers:
                for action in updated_exception_actions:
                    ...
                    exception_policy: ExceptionPolicy = ExceptionPolicy(name=ep_identifier, exception_rules=exception_rules)
        ...
        async with router_client:
            for trigger in exception_triggers:
                for action in updated_exception_actions:
                    exception_rules = [ExceptionRule(id='fakeExceptionRuleId', trigger=trigger, actions=[action])]
                    exception_policy: ExceptionPolicy = ExceptionPolicy(name=ep_identifier, exception_rules=exception_rules)
                    exception_policy: ExceptionPolicy = await router_client.upsert_exception_policy(ep_identifier, exception_policy)
                    self.exception_policy_ids[self._testMethodName] = [ep_identifier]
                    assert exception_policy is not None
                    ExceptionPolicyValidator.validate_exception_policy(exception_policy, identifier=ep_identifier, name=ep_identifier, exception_rules=exception_rules)
        ...
        async with router_client:
            for trigger in exception_triggers:
                for action in updated_exception_actions:
                    ...
                    ExceptionPolicyValidator.validate_exception_policy(exception_policy, identifier=ep_identifier, name=ep_identifier, exception_rules=exception_rules)
                    updated_exception_rules = [ExceptionRule(id='fakeExceptionRuleId2', trigger=trigger, actions=[action])]
                    exception_policy = await router_client.upsert_exception_policy(ep_identifier, name=ep_identifier, exception_rules=updated_exception_rules)
                    assert exception_policy is not None
                    ExceptionPolicyValidator.validate_exception_policy(exception_policy, identifier=ep_identifier, name=ep_identifier, exception_rules=updated_exception_rules)
            ...
            for trigger in exception_triggers:
                for action in updated_exception_actions:
                    for identifier in ep_identifiers:
                        exception_rules = [ExceptionRule(id='fakeExceptionRuleId', trigger=trigger, actions=[action])]
                        exception_policy: ExceptionPolicy = ExceptionPolicy(name=identifier, exception_rules=exception_rules)
