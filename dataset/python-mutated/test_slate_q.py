...
from rllib_slate_q.env.recommender_system_envs_with_recsim import InterestEvolutionRecSimEnv
import ray
...
class TestSlateQ(unittest.TestCase):
    ...
    def test_slateq_compilation(self):
        ...
        config = slateq.SlateQConfig().environment(env=InterestEvolutionRecSimEnv).training(num_steps_sampled_before_learning_starts=1000)
        num_iterations = 1
