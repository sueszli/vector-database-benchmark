...
from nuitka.code_generation.BinaryOperationHelperDefinitions import getSpecializedBinaryOperations, parseTypesFromHelper
from nuitka.code_generation.c_types.CTypePyObjectPointers import make_list_constant_direct_threshold, make_list_constant_hinted_threshold
from nuitka.code_generation.CallCodes import getQuickCallCode, getQuickMethodCallCode, getQuickMethodDescriptorCallCode, getQuickMixedCallCode, getTemplateCodeDeclaredFunction, max_quick_call
from nuitka.code_generation.ComparisonHelperDefinitions import getSpecializedComparisonOperations
from nuitka.code_generation.ImportCodes import getImportModuleHardCodeName
from nuitka.HardImportRegistry import hard_modules, hard_modules_non_stdlib, hard_modules_version
...
from .Common import formatArgs, getMethodVariations, python2_dict_methods, python2_list_methods, python2_str_methods, python2_unicode_methods, python3_bytes_methods, python3_dict_methods, python3_list_methods, python3_str_methods, withFileOpenedAndAutoFormatted, writeLine
from .CTypeDescriptions import bytes_desc, c_bool_desc, c_digit_desc, c_float_desc, c_long_desc, dict_desc, float_desc, int_desc, list_desc, long_desc, n_bool_desc, object_desc, set_desc, str_desc, tuple_desc, unicode_desc
...
class AlternativeIntOrClong(AlternativeTypeBase):
    pass
types = (int_desc, str_desc, unicode_desc, float_desc, tuple_desc, list_desc, set_desc, dict_desc, bytes_desc, long_desc, c_long_desc, c_digit_desc, c_float_desc, c_bool_desc, n_bool_desc, object_desc)
...
def findTypeFromCodeName(code_name):
    ...
    for candidate in types:
        if candidate.getHelperCodeName() == code_name:
            return candidate
op_slot_codes = set()
reversed_args_compare_op_codes = {'LE': 'GE', 'LT': 'GT', 'EQ': 'EQ', 'NE': 'NE', 'GT': 'LT', 'GE': 'LE'}
...
def _makeHelperBuiltinTypeAttributes(type_prefix, type_name, python2_methods, python3_methods, emit_c, emit_h):
    ...
    if not python2_methods or not python3_methods:
        emit_c('#endif')
generate_builtin_type_operations = [('tshape_dict', dict_desc, nuitka.specs.BuiltinDictOperationSpecs, ('pop', 'popitem', 'setdefault')), ('tshape_list', list_desc, nuitka.specs.BuiltinListOperationSpecs, ('pop',)), ('tshape_str', str_desc, nuitka.specs.BuiltinStrOperationSpecs, ('strip', 'rstrip', 'lstrip', 'partition', 'rpartition', 'find', 'rfind', 'index', 'rindex', 'capitalize', 'upper', 'lower', 'swapcase', 'title', 'isalnum', 'isalpha', 'isdigit', 'islower', 'isupper', 'isspace', 'istitle', 'split', 'rsplit', 'startswith', 'endswith', 'replace', 'encode', 'decode', 'count', 'expandtabs', 'translate', 'ljust', 'rjust', 'center', 'zfill', 'splitlines')), ('tshape_unicode', unicode_desc, nuitka.specs.BuiltinUnicodeOperationSpecs, ('strip', 'rstrip', 'lstrip', 'find', 'rfind', 'index', 'rindex', 'capitalize', 'upper', 'lower', 'swapcase', 'title', 'isalnum', 'isalpha', 'isdigit', 'islower', 'isupper', 'isspace', 'istitle', 'split', 'rsplit', 'startswith', 'endswith', 'replace', 'encode', 'count', 'expandtabs', 'translate', 'ljust', 'rjust', 'center', 'zfill', 'splitlines')), ('tshape_bytes', bytes_desc, nuitka.specs.BuiltinBytesOperationSpecs, ('capitalize', 'center', 'count', 'decode', 'endswith', 'expandtabs', 'find', 'index', 'isalnum', 'isalpha', 'isdigit', 'islower', 'isspace', 'istitle', 'isupper', 'join', 'ljust', 'lower', 'lstrip', 'partition', 'replace', 'rfind', 'rindex', 'rjust', 'rpartition', 'rsplit', 'rstrip', 'split', 'splitlines', 'startswith', 'strip', 'swapcase', 'title', 'translate', 'upper', 'zfill'))]
