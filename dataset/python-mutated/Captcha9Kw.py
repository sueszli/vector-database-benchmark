...
class Captcha9Kw(BaseAddon):
    ...
    __version__ = '0.44'
    __status__ = 'testing'
    __config__ = [('enabled', 'bool', 'Activated', False), ('check_client', 'bool', "Don't use if client is connected", True), ('confirm', 'bool', 'Confirm Captcha (cost +6 credits)', False), ('captchaperhour', 'int', 'Captcha per hour', '9999'), ('captchapermin', 'int', 'Captcha per minute', '9999'), ('prio', 'int', 'Priority (max 10)(cost +0 -> +10 credits)', '0'), ('queue', 'int', 'Max. Queue (max 999)', '50'), ('hoster_options', 'str', 'Hoster options (format pluginname;prio 1;selfsolve 1;confirm 1;timeout 900|...)', ''), ('selfsolve', 'bool', 'Selfsolve (manually solve your captcha in your 9kw client if active)', False), ('solve_interactive', 'bool', 'Solve interactive captcha (cost 30 credits)', True), ('passkey', 'password', 'API key', ''), ('timeout', 'int', 'Timeout in seconds (min 60, max 3999)', '900')]
    __description__ = 'Send captchas to 9kw.eu'
    __license__ = 'GPLv3'
    __authors__ = [('RaNaN', 'RaNaN@pyload.net'), ('Walter Purcaro', 'vuolter@gmail.com'), ('GammaC0de', 'nitzo2001[AT]yahho[DOT]com')]
    API_URL = 'https://www.9kw.eu/index.cgi'
    INTERACTIVE_TYPES = {'ReCaptcha': 'recaptchav2', 'HCaptcha': 'hcaptcha'}
