...
ArgMax = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.argmax, kwargs_to_update={'dimension': 'axis'})))
ArgMin = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.argmin, kwargs_to_update={'dimension': 'axis'})))
...
Atan2 = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': 'float16'}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.atan2)))
ConcatV2 = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.concat))
Conj = to_ivy_arrays_and_back(with_supported_dtypes({'2.13.0 and below': ('complex64', 'complex128', 'variant')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.conj, kwargs_to_update={'input': 'x'})))
...
Einsum = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('bfloat16', 'complex128 ', 'complex64', 'float64', 'float32', 'float16', 'int64', 'int32')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.general_functions.einsum)))
Identity = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.general_functions.identity))
IdentityN = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.general_functions.identity_n))
Igamma = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('float64', 'float32', 'half')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.igamma)))
LeakyRelu = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('bfloat16', 'float16', 'float32', 'float64')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.nn.leaky_relu)))
LessEqual = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.less_equal)))
Log1p = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.math.log1p))
LogSoftmax = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('bfloat16', 'float32', 'float64')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.log_softmax)))
...
Max = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.reduce_max, kwargs_to_update={'input': 'input_tensor', 'keep_dims': 'keepdims'})))
MaxPool3D = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('float32',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.nn.max_pool3d)))
Maximum = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.maximum)))
Mean = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.math.reduce_mean, kwargs_to_update={'input': 'input_tensor', 'keep_dims': 'keepdims'}))
Min = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.reduce_min, kwargs_to_update={'input': 'input_tensor', 'keep_dims': 'keepdims'})))
...
RealDiv = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('complex', 'bfloat16', 'float16', 'float64', 'float32')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.general_functions.realdiv)))
Reciprocal = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.math.reciprocal))
Relu = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex', 'float16')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.nn.relu)))
Relu6 = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('complex', 'float16')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.nn.relu6)))
Reshape = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.general_functions.reshape))
...
Sigmoid = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.keras.activations.sigmoid))
...
Softmax = to_ivy_arrays_and_back(with_unsupported_dtypes({'2.14.0 and below': ('float16',)}, 'tensorflow')(map_raw_ops_alias(tf_frontend.nn.softmax)))
Split = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.split, kwargs_to_update={'num_split': 'num_or_size_splits'}))
SquaredDifference = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('complex', 'bfloat16', 'float16', 'float64', 'float32', 'int32', 'int64')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.squared_difference)))
Squeeze = to_ivy_arrays_and_back(map_raw_ops_alias(tf_frontend.general_functions.squeeze))
...
Zeta = to_ivy_arrays_and_back(with_supported_dtypes({'2.14.0 and below': ('float32', 'float64')}, 'tensorflow')(map_raw_ops_alias(tf_frontend.math.zeta)))
