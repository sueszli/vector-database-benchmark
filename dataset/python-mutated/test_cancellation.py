...
import anyio
import pytest
from prefect._internal.concurrency.cancellation import AlarmCancelScope, AsyncCancelScope, CancelledError, WatcherThreadCancelScope, cancel_async_after, cancel_async_at, cancel_sync_after, cancel_sync_at, get_deadline, shield
...
@pytest.mark.parametrize('cls', [AlarmCancelScope, WatcherThreadCancelScope, AsyncCancelScope])
