...
BASE_MODEL = 'class BaseModel(Model):\n    class Meta:\n        database = database\n'
UNKNOWN_FIELD = 'class UnknownField(object):\n    def __init__(self, *_, **__): pass\n'
DATABASE_ALIASES = {CockroachDatabase: ['cockroach', 'cockroachdb', 'crdb'], MySQLDatabase: ['mysql', 'mysqldb'], PostgresqlDatabase: ['postgres', 'postgresql'], SqliteDatabase: ['sqlite', 'sqlite3']}
