...
class AppServicePlansOperations:
    ...
    def list(self, detailed: Optional[bool]=None, **kwargs: Any) -> AsyncIterable['_models.AppServicePlan']:
        ...
        def prepare_request(next_link=None):
            if False:
                ...
                return i + 15
            if not next_link:
                request = build_list_request(subscription_id=self._config.subscription_id, detailed=detailed, api_version=api_version, template_url=self.list.metadata['url'], headers=_headers, params=_params)
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable['_models.AppServicePlan']:
        if False:
            return 10
    ...
    async def get(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.AppServicePlan:
        ...
        :rtype: ~azure.mgmt.web.v2021_01_15.models.AppServicePlan
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def _create_or_update_initial(self, resource_group_name: str, name: str, app_service_plan: Union[_models.AppServicePlan, IO], **kwargs: Any) -> _models.AppServicePlan:
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
    ...
    @overload
    async def begin_create_or_update(self, resource_group_name: str, name: str, app_service_plan: _models.AppServicePlan, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServicePlan]:
        ...
        :type app_service_plan: ~azure.mgmt.web.v2021_01_15.models.AppServicePlan
    ...
    @overload
    async def begin_create_or_update(self, resource_group_name: str, name: str, app_service_plan: IO, *, content_type: str='application/json', **kwargs: Any) -> AsyncLROPoller[_models.AppServicePlan]:
        """Creates or updates an App Service Plan.
    ...
    @distributed_trace_async
    async def begin_create_or_update(self, resource_group_name: str, name: str, app_service_plan: Union[_models.AppServicePlan, IO], **kwargs: Any) -> AsyncLROPoller[_models.AppServicePlan]:
        """Creates or updates an App Service Plan.
        ...
        :param app_service_plan: Details of the App Service plan. Is either a AppServicePlan type or a
         IO type. Required.
        :type app_service_plan: ~azure.mgmt.web.v2021_01_15.models.AppServicePlan or IO
        ...
        if cont_token is None:
            raw_result = await self._create_or_update_initial(resource_group_name=resource_group_name, name=name, app_service_plan=app_service_plan, api_version=api_version, content_type=content_type, cls=lambda x, y, z: x, headers=_headers, params=_params, **kwargs)
    ...
    async def delete(self, resource_group_name: str, name: str, **kwargs: Any) -> None:
        ...
        request = build_delete_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update(self, resource_group_name: str, name: str, app_service_plan: _models.AppServicePlanPatchResource, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServicePlan:
        """Creates or updates an App Service Plan.
        ...
        :type name: str
        :param app_service_plan: Details of the App Service plan. Required.
        :type app_service_plan: ~azure.mgmt.web.v2021_01_15.models.AppServicePlanPatchResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def update(self, resource_group_name: str, name: str, app_service_plan: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.AppServicePlan:
        """Creates or updates an App Service Plan.
    ...
    @distributed_trace_async
    async def update(self, resource_group_name: str, name: str, app_service_plan: Union[_models.AppServicePlanPatchResource, IO], **kwargs: Any) -> _models.AppServicePlan:
        """Creates or updates an App Service Plan.
        ...
        :type app_service_plan: ~azure.mgmt.web.v2021_01_15.models.AppServicePlanPatchResource or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def list_capabilities(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.Capability]:
        ...
        :rtype: list[~azure.mgmt.web.v2021_01_15.models.Capability]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_list_capabilities_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_capabilities.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_hybrid_connection(self, resource_group_name: str, name: str, namespace_name: str, relay_name: str, **kwargs: Any) -> _models.HybridConnection:
        ...
        request = build_get_hybrid_connection_request(resource_group_name=resource_group_name, name=name, namespace_name=namespace_name, relay_name=relay_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_hybrid_connection.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def delete_hybrid_connection(self, resource_group_name: str, name: str, namespace_name: str, relay_name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_hybrid_connection_request(resource_group_name=resource_group_name, name=name, namespace_name=namespace_name, relay_name=relay_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete_hybrid_connection.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def list_hybrid_connection_keys(self, resource_group_name: str, name: str, namespace_name: str, relay_name: str, **kwargs: Any) -> _models.HybridConnectionKey:
        ...
        :rtype: ~azure.mgmt.web.v2021_01_15.models.HybridConnectionKey
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_list_hybrid_connection_keys_request(resource_group_name=resource_group_name, name=name, namespace_name=namespace_name, relay_name=relay_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_hybrid_connection_keys.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_web_apps_by_hybrid_connection(self, resource_group_name: str, name: str, namespace_name: str, relay_name: str, **kwargs: Any) -> AsyncIterable[str]:
        if False:
            while True:
                i = 10
    ...
    @distributed_trace_async
    async def get_hybrid_connection_plan_limit(self, resource_group_name: str, name: str, **kwargs: Any) -> _models.HybridConnectionLimits:
        ...
        :rtype: ~azure.mgmt.web.v2021_01_15.models.HybridConnectionLimits
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_get_hybrid_connection_plan_limit_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_hybrid_connection_plan_limit.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_hybrid_connections(self, resource_group_name: str, name: str, **kwargs: Any) -> AsyncIterable['_models.HybridConnection']:
        if False:
            for i in range(10):
                print('nop')
        'Retrieve all Hybrid Connections in use in an App Service plan.\n\n        Retrieve all Hybrid Connections in use in an App Service plan.\n\n        :param resource_group_name: Name of the resource group to which the resource belongs. Required.\n        :type resource_group_name: str\n        :param name: Name of the App Service plan. Required.\n        :type name: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: An iterator like instance of either HybridConnection or the result of cls(response)\n        :rtype:\n         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.web.v2021_01_15.models.HybridConnection]\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '
        _headers = kwargs.pop('headers', {}) or {}
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_hybrid_connections_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_hybrid_connections.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    @distributed_trace_async
    async def restart_web_apps(self, resource_group_name: str, name: str, soft_restart: Optional[bool]=None, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_restart_web_apps_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, soft_restart=soft_restart, api_version=api_version, template_url=self.restart_web_apps.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace
    def list_web_apps(self, resource_group_name: str, name: str, skip_token: Optional[str]=None, filter: Optional[str]=None, top: Optional[str]=None, **kwargs: Any) -> AsyncIterable['_models.Site']:
        if False:
            return 10
        ...
        def prepare_request(next_link=None):
            if False:
                while True:
                    i = 10
            if not next_link:
                request = build_list_web_apps_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, skip_token=skip_token, filter=filter, top=top, api_version=api_version, template_url=self.list_web_apps.metadata['url'], headers=_headers, params=_params)
                request = _convert_request(request)
                request.url = self._client.format_url(request.url)
            else:
                _parsed_next_link = urllib.parse.urlparse(next_link)
    ...
    async def get_server_farm_skus(self, resource_group_name: str, name: str, **kwargs: Any) -> JSON:
        ...
        request = build_get_server_farm_skus_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_server_farm_skus.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def list_vnets(self, resource_group_name: str, name: str, **kwargs: Any) -> List[_models.VnetInfo]:
        ...
        :rtype: list[~azure.mgmt.web.v2021_01_15.models.VnetInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_list_vnets_request(resource_group_name=resource_group_name, name=name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_vnets.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_vnet_from_server_farm(self, resource_group_name: str, name: str, vnet_name: str, **kwargs: Any) -> _models.VnetInfo:
        ...
        :rtype: ~azure.mgmt.web.v2021_01_15.models.VnetInfo
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 409: ResourceExistsError, 304: ResourceNotModifiedError, 404: lambda response: ResourceNotFoundError(response=response, error_format=ARMErrorFormat)}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[_models.VnetInfo] = kwargs.pop('cls', None)
        request = build_get_vnet_from_server_farm_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_vnet_from_server_farm.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_vnet_gateway(self, resource_group_name: str, name: str, vnet_name: str, gateway_name: str, **kwargs: Any) -> _models.VnetGateway:
        ...
        :rtype: ~azure.mgmt.web.v2021_01_15.models.VnetGateway
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_get_vnet_gateway_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, gateway_name=gateway_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_vnet_gateway.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_vnet_gateway(self, resource_group_name: str, name: str, vnet_name: str, gateway_name: str, connection_envelope: _models.VnetGateway, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetGateway:
        ...
        :type connection_envelope: ~azure.mgmt.web.v2021_01_15.models.VnetGateway
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    async def update_vnet_gateway(self, resource_group_name: str, name: str, vnet_name: str, gateway_name: str, connection_envelope: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetGateway:
        """Update a Virtual Network gateway.
    ...
    @distributed_trace_async
    async def update_vnet_gateway(self, resource_group_name: str, name: str, vnet_name: str, gateway_name: str, connection_envelope: Union[_models.VnetGateway, IO], **kwargs: Any) -> _models.VnetGateway:
        """Update a Virtual Network gateway.
        ...
        :param connection_envelope: Definition of the gateway. Is either a VnetGateway type or a IO
         type. Required.
        :type connection_envelope: ~azure.mgmt.web.v2021_01_15.models.VnetGateway or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        request = build_update_vnet_gateway_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, gateway_name=gateway_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_vnet_gateway.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def list_routes_for_vnet(self, resource_group_name: str, name: str, vnet_name: str, **kwargs: Any) -> List[_models.VnetRoute]:
        ...
        :rtype: list[~azure.mgmt.web.v2021_01_15.models.VnetRoute]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError, 304: ResourceNotModifiedError}
        error_map.update(kwargs.pop('error_map', {}) or {})
        ...
        request = build_list_routes_for_vnet_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.list_routes_for_vnet.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @distributed_trace_async
    async def get_route_for_vnet(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, **kwargs: Any) -> List[_models.VnetRoute]:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[List[_models.VnetRoute]] = kwargs.pop('cls', None)
        request = build_get_route_for_vnet_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, route_name=route_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.get_route_for_vnet.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def create_or_update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: _models.VnetRoute, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetRoute:
        ...
        :type route: ~azure.mgmt.web.v2021_01_15.models.VnetRoute
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: VnetRoute or the result of cls(response)
        :rtype: ~azure.mgmt.web.v2021_01_15.models.VnetRoute
        :raises ~azure.core.exceptions.HttpResponseError:
        """

    @overload
    async def create_or_update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetRoute:
        """Create or update a Virtual Network route in an App Service plan.
    ...
    @distributed_trace_async
    async def create_or_update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: Union[_models.VnetRoute, IO], **kwargs: Any) -> _models.VnetRoute:
        """Create or update a Virtual Network route in an App Service plan.
        ...
        :param route: Definition of the Virtual Network route. Is either a VnetRoute type or a IO type.
         Required.
        :type route: ~azure.mgmt.web.v2021_01_15.models.VnetRoute or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {401: ClientAuthenticationError, 409: ResourceExistsError, 304: ResourceNotModifiedError, 400: lambda response: HttpResponseError(response=response, error_format=ARMErrorFormat), 404: lambda response: ResourceNotFoundError(response=response, error_format=ARMErrorFormat)}
        error_map.update(kwargs.pop('error_map', {}) or {})
        _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
        _params = case_insensitive_dict(kwargs.pop('params', {}) or {})
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
    ...
    @distributed_trace_async
    async def delete_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_delete_vnet_route_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, route_name=route_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete_vnet_route.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    @overload
    async def update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: _models.VnetRoute, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetRoute:
        """Create or update a Virtual Network route in an App Service plan.
    ...
    @overload
    async def update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.VnetRoute:
        """Create or update a Virtual Network route in an App Service plan.
    ...
    @distributed_trace_async
    async def update_vnet_route(self, resource_group_name: str, name: str, vnet_name: str, route_name: str, route: Union[_models.VnetRoute, IO], **kwargs: Any) -> _models.VnetRoute:
        """Create or update a Virtual Network route in an App Service plan.
        ...
        if isinstance(route, (IO, bytes)):
            ...
            _json = self._serialize.body(route, 'VnetRoute')
        request = build_update_vnet_route_request(resource_group_name=resource_group_name, name=name, vnet_name=vnet_name, route_name=route_name, subscription_id=self._config.subscription_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.update_vnet_route.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
    ...
    async def reboot_worker(self, resource_group_name: str, name: str, worker_name: str, **kwargs: Any) -> None:
        ...
        api_version: Literal['2021-01-15'] = kwargs.pop('api_version', _params.pop('api-version', '2021-01-15'))
        cls: ClsType[None] = kwargs.pop('cls', None)
        request = build_reboot_worker_request(resource_group_name=resource_group_name, name=name, worker_name=worker_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.reboot_worker.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
