...
class AndroidfilehostCom(SimpleDownloader):
    ...
    __version__ = '0.07'
    __status__ = 'testing'
    __pattern__ = 'https?://(?:www\\.)?androidfilehost\\.com/\\?fid=\\d+'
    ...
    NAME_PATTERN = 'name="filename" id="filename" value="(?P<N>.*?)" />'
    SIZE_PATTERN = '<span class="file-attr-value">(?P<S>[\\d.,]+)(?P<U>[\\w^_]+)<br><span class="file-attr-label">Size</span></span>'
    HASHSUM_PATTERN = '<span class="file-attr-value">(?P<D>.*?)<br><span class="file-attr-label">(?P<H>MD5)</span></span>'
    OFFLINE_PATTERN = '404 not found'
    TEMP_OFFLINE_PATTERN = '[^\\w](503\\s|[Mm]aint(e|ai)nance|[Tt]emp([.-]|orarily))'
    WAIT_PATTERN = 'users must wait <strong>(\\d+) secs'
