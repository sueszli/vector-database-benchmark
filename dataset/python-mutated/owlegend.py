...
import numpy as np
from AnyQt.QtWidgets import QGraphicsWidget, QGraphicsItem, QGraphicsRectItem, QGraphicsEllipseItem, QGraphicsTextItem, QGraphicsLinearLayout, QGraphicsView, QApplication
