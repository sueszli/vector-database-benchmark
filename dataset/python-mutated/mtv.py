...
from ..utils import ExtractorError, RegexNotFoundError, find_xpath_attr, fix_xml_ampersands, float_or_none, int_or_none, join_nonempty, strip_or_none, timeconvert, try_get, unescapeHTML, update_url_query, url_basename, xpath_text
...
class MTVServicesEmbeddedIE(MTVServicesInfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>(?:https?:)?//media\\.mtvnservices\\.com/embed/.+?)\\1']
    _TEST = {'url': 'http://media.mtvnservices.com/embed/mgid:uma:video:mtv.com:1043906/cp~vid%3D1043906%26uri%3Dmgid%3Auma%3Avideo%3Amtv.com%3A1043906', 'md5': 'cb349b21a7897164cede95bd7bf3fbb9', 'info_dict': {'id': '1043906', 'ext': 'mp4', 'title': "Peter Dinklage Sums Up 'Game Of Thrones' In 45 Seconds", 'description': '"Sexy sexy sexy, stabby stabby stabby, beautiful language," says Peter Dinklage as he tries summarizing "Game of Thrones" in under a minute.', 'timestamp': 1400126400, 'upload_date': '20140515'}}
...
class MTVVideoIE(MTVServicesInfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.mtv.com/videos/misc/853555/ours-vh1-storytellers.jhtml', 'md5': '850f3f143316b1e71fa56a4edfd6e0f8', 'info_dict': {'id': '853555', 'ext': 'mp4', 'title': 'Taylor Swift - "Ours (VH1 Storytellers)"', 'description': 'Album: Taylor Swift performs "Ours" for VH1 Storytellers at Harvey Mudd College.', 'timestamp': 1352610000, 'upload_date': '20121111'}}]
...
class MTVDEIE(MTVServicesInfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.mtv.de/musik/videoclips/2gpnv7/Traum', 'info_dict': {'id': 'd5d472bc-f5b7-11e5-bffd-a4badb20dab5', 'ext': 'mp4', 'title': 'Traum', 'description': 'Traum'}, 'params': {'skip_download': True}, 'skip': 'Blocked at Travis CI'}, {'url': 'http://www.mtv.de/folgen/6b1ylu/teen-mom-2-enthuellungen-S5-F1', 'info_dict': {'id': '1e5a878b-31c5-11e7-a442-0e40cf2fc285', 'ext': 'mp4', 'title': 'Teen Mom 2', 'description': 'md5:dc65e357ef7e1085ed53e9e9d83146a7'}, 'params': {'skip_download': True}, 'skip': 'Blocked at Travis CI'}, {'url': 'http://www.mtv.de/news/glolix/77491-mtv-movies-spotlight--pixels--teil-3', 'info_dict': {'id': 'local_playlist-4e760566473c4c8c5344', 'ext': 'mp4', 'title': 'Article_mtv-movies-spotlight-pixels-teil-3_short-clips_part1', 'description': 'MTV Movies Supercut'}, 'params': {'skip_download': True}, 'skip': 'Das Video kann zur Zeit nicht abgespielt werden.'}]
    _GEO_COUNTRIES = ['DE']
    _FEED_URL = 'http://feeds.mtvnservices.com/od/feed/intl-mrss-player-feed'
...
class MTVItaliaProgrammaIE(MTVItaliaIE):
    ...
    _TESTS = [{'url': 'http://www.mtv.it/programmi/s2rppv/mario-una-serie-di-maccio-capatonda', 'info_dict': {'id': 'a6f155bc-8220-4640-aa43-9b95f64ffa3d', 'title': 'Mario - Una Serie Di Maccio Capatonda', 'description': 'md5:72fbffe1f77ccf4e90757dd4e3216153'}, 'playlist_count': 2, 'params': {'skip_download': True}}, {'url': 'http://www.mtv.it/programmi/d9ncjf/mario-una-serie-di-maccio-capatonda-S2', 'info_dict': {'id': '4deeb5d8-f272-490c-bde2-ff8d261c6dd1', 'title': 'Mario - Una Serie Di Maccio Capatonda - Stagione 2'}, 'playlist_count': 34, 'params': {'skip_download': True}}, {'url': 'http://www.mtv.it/playlist/sexy-videos/ilctal', 'info_dict': {'id': 'dee8f9ee-756d-493b-bf37-16d1d2783359', 'title': 'Sexy Videos'}, 'playlist_mincount': 145, 'params': {'skip_download': True}}]
    _GEO_COUNTRIES = ['IT']
