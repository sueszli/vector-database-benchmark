...
configcommand = os.environ.get('SDL_CONFIG', 'sdl2-config')
...
if os.environ.get('SDK_VERSION', None) is None:
    ...
    emcc_cflags = ['-DBUILD_STATIC', f'-I{SDKROOT}/devices/emsdk/usr/include/SDL2', f'-I{SDKROOT}/emsdk/upstream/emscripten/cache/sysroot/include/freetype2', f'-Wno-unreachable-code-fallthrough {EMCC_CFLAGS}']
