...
from modelscope.models.cv.human3d_animation import gen_skeleton_bvh, read_obj, write_obj
...
@PIPELINES.register_module(Tasks.human3d_animation, module_name=Pipelines.human3d_animation)
