...
if __name__ == '__main__':
    '\n    Usage:\n        python pp_parallel_adaptor.py --src_mp xxx --src_path xxx --method           adapt_model/peek_model --dst_path xxx --sharding xxx --segment_method xxx --transformer_layer_num xxx\n\n    for the meaning of a specific arg, please use:\n        python  pp_parallel_adaptor.py  -h\n    '
    main()