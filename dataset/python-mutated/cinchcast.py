...
class CinchcastIE(InfoExtractor):
    ...
    _EMBED_REGEX = ['<iframe[^>]+?src=(["\\\'])(?P<url>https?://player\\.cinchcast\\.com/.+?)\\1']
    _TESTS = [{'url': 'http://player.cinchcast.com/?show_id=5258197&platformId=1&assetType=single', 'info_dict': {'id': '5258197', 'ext': 'mp3', 'title': 'Train Your Brain to Up Your Game with Coach Mandy', 'upload_date': '20130816'}}, {'url': 'http://player.cinchcast.com/?platformId=1&#038;assetType=single&#038;assetId=7141703', 'only_matching': True}]
