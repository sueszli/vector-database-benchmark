...
__protobuf__ = proto.module(package='maps.fleetengine.v1', manifest={'CreateTripRequest', 'GetTripRequest', 'ReportBillableTripRequest', 'UpdateTripRequest', 'SearchTripsRequest', 'SearchTripsResponse'})
...
class CreateTripRequest(proto.Message):
    ...
    trip_id: str = proto.Field(proto.STRING, number=5)
    trip: mf_trips.Trip = proto.Field(proto.MESSAGE, number=4, message=mf_trips.Trip)
...
class GetTripRequest(proto.Message):
    ...
    view: mf_trips.TripView = proto.Field(proto.ENUM, number=11, enum=mf_trips.TripView)
    current_route_segment_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=6, message=timestamp_pb2.Timestamp)
    remaining_waypoints_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=7, message=timestamp_pb2.Timestamp)
    route_format_type: fleetengine.PolylineFormatType = proto.Field(proto.ENUM, number=8, enum=fleetengine.PolylineFormatType)
    current_route_segment_traffic_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=9, message=timestamp_pb2.Timestamp)
    remaining_waypoints_route_version: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=10, message=timestamp_pb2.Timestamp)
...
class ReportBillableTripRequest(proto.Message):
    ...
    country_code: str = proto.Field(proto.STRING, number=3)
    platform: mf_trips.BillingPlatformIdentifier = proto.Field(proto.ENUM, number=5, enum=mf_trips.BillingPlatformIdentifier)
    related_ids: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=6)
    solution_type: SolutionType = proto.Field(proto.ENUM, number=7, enum=SolutionType)
...
class SearchTripsRequest(proto.Message):
    ...
    active_trips_only: bool = proto.Field(proto.BOOL, number=5)
    page_size: int = proto.Field(proto.INT32, number=6)
    page_token: str = proto.Field(proto.STRING, number=7)
    minimum_staleness: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=8, message=duration_pb2.Duration)
...
class SearchTripsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    trips: MutableSequence[mf_trips.Trip] = proto.RepeatedField(proto.MESSAGE, number=1, message=mf_trips.Trip)
