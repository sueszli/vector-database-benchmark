...
import yaml
from filters import assert_dense_or_sr, cartesian_prod_mapping, delete_last_underline, find_optinal_inputs_name, get_infer_var_type_func, to_composite_grad_opmaker_name, to_input_name, to_int_array_tensor_name, to_int_array_tensors_name, to_op_attr_type, to_opmaker_name, to_opmaker_name_cstr, to_pascal_case, to_scalar_tensor_name, to_variable_names
from jinja2 import Environment, FileSystemLoader, StrictUndefined
from parse_utils import to_named_dict
from tests_utils import is_base_op, is_composite_op, is_initializer_list, is_only_composite_op, is_scalar, is_vec, supports_inplace, supports_no_need_buffer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ops_yaml_path', type=str, help='parsed ops yaml file.')
    parser.add_argument('--backward_yaml_path', type=str, help='parsed backward ops yaml file.')
    ...
    parser.add_argument('--output_op_path', type=str, nargs='+', help='path to save generated operators.')
