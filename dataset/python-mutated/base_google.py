...
from airflow.providers.google.cloud.utils.credentials_provider import _get_scopes, _get_target_principal_and_delegates, get_credentials_and_project_id
from airflow.providers.google.common.consts import CLIENT_INFO
from airflow.utils.process_utils import patch_environ
if TYPE_CHECKING:
    from google.api_core.gapic_v1.client_info import ClientInfo
log = logging.getLogger(__name__)
INVALID_KEYS = ['DefaultRequestsPerMinutePerProject', 'DefaultRequestsPerMinutePerUser', 'RequestsPerMinutePerProject', 'Resource has been exhausted (e.g. check quota).']
INVALID_REASONS = ['userRateLimitExceeded']
