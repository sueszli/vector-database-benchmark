...
class fleetengine_deliveryCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {'batch_create_tasks': ('parent', 'requests', 'header'), 'create_delivery_vehicle': ('parent', 'delivery_vehicle_id', 'delivery_vehicle', 'header'), 'create_task': ('parent', 'task_id', 'task', 'header'), 'get_delivery_vehicle': ('name', 'header'), 'get_task': ('name', 'header'), 'get_task_tracking_info': ('name', 'header'), 'list_delivery_vehicles': ('parent', 'header', 'page_size', 'page_token', 'filter', 'viewport'), 'list_tasks': ('parent', 'header', 'page_size', 'page_token', 'filter'), 'search_tasks': ('parent', 'tracking_id', 'header', 'page_size', 'page_token'), 'update_delivery_vehicle': ('delivery_vehicle', 'update_mask', 'header'), 'update_task': ('task', 'update_mask', 'header')}
...
def fix_files(in_dir: pathlib.Path, out_dir: pathlib.Path, *, transformer=fleetengine_deliveryCallTransformer()):
    if False:
        print('Hello World!')
