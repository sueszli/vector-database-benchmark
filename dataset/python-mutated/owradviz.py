...
from Orange.widgets.utils.plot.owplotgui import VariableSelectionModel, variables_selection
...
class OWRadviz(OWAnchorProjectionWidget):
    ...
    class Warning(OWAnchorProjectionWidget.Warning):
        removed_vars = widget.Msg('Categorical variables with more than two values are not shown.')
