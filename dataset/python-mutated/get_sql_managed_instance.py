...
def main():
    ...
    response = client.sql_managed_instances.get(resource_group_name='testrg', sql_managed_instance_name='testsqlManagedInstance')
    print(response)
