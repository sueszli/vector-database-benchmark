...
if is_tf_available():
    ...
    from transformers import TFEfficientFormerForImageClassification, TFEfficientFormerForImageClassificationWithTeacher, TFEfficientFormerModel
    from transformers.models.efficientformer.modeling_tf_efficientformer import TF_EFFICIENTFORMER_PRETRAINED_MODEL_ARCHIVE_LIST
...
class TFEfficientFormerModelTest(TFModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    """
    all_model_classes = (TFEfficientFormerModel, TFEfficientFormerForImageClassificationWithTeacher, TFEfficientFormerForImageClassification) if is_tf_available() else ()
    pipeline_model_mapping = {'feature-extraction': TFEfficientFormerModel, 'image-classification': (TFEfficientFormerForImageClassification, TFEfficientFormerForImageClassificationWithTeacher)} if is_tf_available() else {}
    fx_compatible = False
    test_pruning = False
