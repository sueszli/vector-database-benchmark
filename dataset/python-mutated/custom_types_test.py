...
import os
import typing
from dagster import DagsterType, Failure, Field, OpExecutionContext, String, check_dagster_type, dagster_type_loader, job, op
...
if typing.TYPE_CHECKING:
    ...
    LessSimpleDataFrame = DagsterType(name='LessSimpleDataFrame', description='A more sophisticated data frame that type checks its structure.', type_check_fn=less_simple_data_frame_type_check, loader=less_simple_data_frame_loader)
...
if __name__ == '__main__':
    custom_type_job.execute_in_process(run_config={'ops': {'sort_by_calories': {'inputs': {'cereals': {'csv_path': 'cereal.csv'}}}}})
