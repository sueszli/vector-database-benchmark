...
parser.add_argument('mode', type=str, default='check', help='Either check or schedule the xfdesktop leak check.', choices=['check', 'schedule'])
...
if args.mode == 'check':
    ...
    CHECKS = 10
    CHECK_INTERVAL = 15
    MEMORY_THRESHOLD = 120000000
    CPU_THRESHOLD = 1
    MAX_MEMORY_THRESHOLD = 250000000
    try:
