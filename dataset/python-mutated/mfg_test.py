...
import pyspiel
FLAGS = flags.FLAGS
flags.DEFINE_integer('get_all_states_depth_limit', 10, 'Depth limit of getting all the states (-1 for unlimited)')
flags.DEFINE_integer('rl_env_simulations', 10, 'Number of simulations for the RL environment tests')
