...
def build_list_by_factory_request(resource_group_name: str, factory_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/linkedservices')
...
def build_create_or_update_request(resource_group_name: str, factory_name: str, linked_service_name: str, subscription_id: str, *, if_match: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        for i in range(10):
            print('nop')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
    ...
    accept = _headers.pop('Accept', 'application/json')
    _url = kwargs.pop('template_url', '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataFactory/factories/{factoryName}/linkedservices/{linkedServiceName}')
    path_format_arguments = {'subscriptionId': _SERIALIZER.url('subscription_id', subscription_id, 'str'), 'resourceGroupName': _SERIALIZER.url('resource_group_name', resource_group_name, 'str', max_length=90, min_length=1, pattern='^[-\\w\\._\\(\\)]+$'), 'factoryName': _SERIALIZER.url('factory_name', factory_name, 'str', max_length=63, min_length=3, pattern='^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$'), 'linkedServiceName': _SERIALIZER.url('linked_service_name', linked_service_name, 'str', max_length=260, min_length=1, pattern='^[A-Za-z0-9_][^<>*#.%&:\\\\+?/]*$')}
    _url: str = _format_url_section(_url, **path_format_arguments)
    _params['api-version'] = _SERIALIZER.query('api_version', api_version, 'str')
...
def build_get_request(resource_group_name: str, factory_name: str, linked_service_name: str, subscription_id: str, *, if_none_match: Optional[str]=None, **kwargs: Any) -> HttpRequest:
    if False:
        i = 10
        return i + 15
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
...
def build_delete_request(resource_group_name: str, factory_name: str, linked_service_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        for i in range(10):
            print('nop')
    _headers = case_insensitive_dict(kwargs.pop('headers', {}) or {})
...
class LinkedServicesOperations:
    ...
    @distributed_trace
    def list_by_factory(self, resource_group_name: str, factory_name: str, **kwargs: Any) -> Iterable['_models.LinkedServiceResource']:
        if False:
            return 10
    ...
    @overload
    def create_or_update(self, resource_group_name: str, factory_name: str, linked_service_name: str, linked_service: _models.LinkedServiceResource, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.LinkedServiceResource:
        if False:
            i = 10
            return i + 15
    ...
    @overload
    def create_or_update(self, resource_group_name: str, factory_name: str, linked_service_name: str, linked_service: IO, if_match: Optional[str]=None, *, content_type: str='application/json', **kwargs: Any) -> _models.LinkedServiceResource:
        if False:
            return 10
        'Creates or updates a linked service.\n\n        :param resource_group_name: The resource group name. Required.\n        :type resource_group_name: str\n        :param factory_name: The factory name. Required.\n        :type factory_name: str\n        :param linked_service_name: The linked service name. Required.\n        :type linked_service_name: str\n        :param linked_service: Linked service resource definition. Required.\n        :type linked_service: IO\n        :param if_match: ETag of the linkedService entity.  Should only be specified for update, for\n         which it should match existing entity or can be * for unconditional update. Default value is\n         None.\n        :type if_match: str\n        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.\n         Default value is "application/json".\n        :paramtype content_type: str\n        :keyword callable cls: A custom type or function that will be passed the direct response\n        :return: LinkedServiceResource or the result of cls(response)\n        :rtype: ~azure.mgmt.datafactory.models.LinkedServiceResource\n        :raises ~azure.core.exceptions.HttpResponseError:\n        '

    @distributed_trace
    def create_or_update(self, resource_group_name: str, factory_name: str, linked_service_name: str, linked_service: Union[_models.LinkedServiceResource, IO], if_match: Optional[str]=None, **kwargs: Any) -> _models.LinkedServiceResource:
        if False:
            print('Hello World!')
        ...
        request = build_create_or_update_request(resource_group_name=resource_group_name, factory_name=factory_name, linked_service_name=linked_service_name, subscription_id=self._config.subscription_id, if_match=if_match, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.create_or_update.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace
    def get(self, resource_group_name: str, factory_name: str, linked_service_name: str, if_none_match: Optional[str]=None, **kwargs: Any) -> Optional[_models.LinkedServiceResource]:
        if False:
            while True:
                i = 10
        ...
        request = build_get_request(resource_group_name=resource_group_name, factory_name=factory_name, linked_service_name=linked_service_name, subscription_id=self._config.subscription_id, if_none_match=if_none_match, api_version=api_version, template_url=self.get.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
    ...
    @distributed_trace
    def delete(self, resource_group_name: str, factory_name: str, linked_service_name: str, **kwargs: Any) -> None:
        if False:
            i = 10
            return i + 15
        ...
        request = build_delete_request(resource_group_name=resource_group_name, factory_name=factory_name, linked_service_name=linked_service_name, subscription_id=self._config.subscription_id, api_version=api_version, template_url=self.delete.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        pipeline_response: PipelineResponse = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
