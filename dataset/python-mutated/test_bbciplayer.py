...
class TestPluginCanHandleUrlBBCiPlayer(PluginCanHandleUrl):
    ...
    should_match = ['http://www.bbc.co.uk/iplayer/episode/b00ymh67/madagascar-1-island-of-marvels', 'http://www.bbc.co.uk/iplayer/live/bbcone']
    should_not_match = ['http://www.bbc.co.uk/iplayer/']
