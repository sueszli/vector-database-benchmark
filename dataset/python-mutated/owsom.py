...
import numpy as np
from AnyQt.QtCore import Qt, QRectF, pyqtSignal as Signal, QObject, QThread, pyqtSlot as Slot
from AnyQt.QtGui import QTransform, QPen, QBrush, QColor, QPainter, QPainterPath, QKeyEvent
from AnyQt.QtWidgets import QGraphicsView, QGraphicsScene, QGraphicsItem, QGraphicsRectItem, QGraphicsItemGroup, QSizePolicy, QGraphicsPathItem
...
from Orange.widgets.utils.annotated_data import add_columns, group_values, ANNOTATED_DATA_SIGNAL_NAME, ANNOTATED_DATA_FEATURE_NAME
from Orange.widgets.utils.colorpalettes import BinnedContinuousPalette, LimitedDiscretePalette, DiscretePalette
...
class SomView(QGraphicsView):
    (SelectionSet, SelectionNewGroup, SelectionAddToGroup, SelectionRemove) = range(4)
...
class OWSOM(OWWidget):
    ...
    OptControls = namedtuple('OptControls', ('shape', 'auto_dim', 'spin_x', 'spin_y', 'initialization', 'start'))
    ...
    class Warning(OWWidget.Warning):
        ...
        missing_colors = Msg("Some data instances have undefined value of '{}'.")
        no_defined_colors = Msg("'{}' has no defined values.")
        missing_values = Msg('{}')
