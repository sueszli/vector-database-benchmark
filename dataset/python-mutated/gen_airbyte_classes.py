...
CHECK_MAPPING = {'str': "check.str_param({}, '{}')", 'int': "check.int_param({}, '{}')", 'float': "check.float_param({}, '{}')", 'bool': "check.bool_param({}, '{}')"}
...
SOURCE_OUT_FILE = os.path.abspath(file_relative_path(__file__, '../python_modules/libraries/dagster-airbyte/dagster_airbyte/managed/generated/sources.py'))
DEST_OUT_FILE = os.path.abspath(file_relative_path(__file__, '../python_modules/libraries/dagster-airbyte/dagster_airbyte/managed/generated/destinations.py'))
