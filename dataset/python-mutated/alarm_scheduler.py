...
COMPARISON_OPS = {'GreaterThanOrEqualToThreshold': lambda value, threshold: value >= threshold, 'GreaterThanThreshold': lambda value, threshold: value > threshold, 'LessThanThreshold': lambda value, threshold: value < threshold, 'LessThanOrEqualToThreshold': lambda value, threshold: value <= threshold}
