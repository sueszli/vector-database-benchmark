...
class SingleNodePattern:
    ...
    def pattern(a):
        if False:
            print('Hello World!')
        return torch.neg(a)
    test_cases = [TestCase(False, False, 1), TestCase(True, False, 0), TestCase(False, True, 1), TestCase(True, True, 0)]
...
class SimplePattern:
    ...
    test_cases = [TestCase(False, False, 3), TestCase(True, False, 0), TestCase(False, True, 2), TestCase(True, True, 0)]
...
class SimpleFullGraphMatching:
    ...
    def pattern(x):
        ...
        a = torch.neg(x)
        return torch.add(a, a)
    test_cases = [TestCase(False, False, 1), TestCase(True, False, 1), TestCase(False, True, 1), TestCase(True, True, 1)]
...
class DiamondShapePatternTestCase:
    ...
    def pattern(a):
        ...
        out = left + right
        return out
    test_cases = [TestCase(False, False, 1), TestCase(True, False, 1), TestCase(False, True, 0), TestCase(True, True, 0)]
...
class NonFullyContainedMatches:
    ...
    test_cases = [TestCase(False, False, 1), TestCase(True, False, 0), TestCase(False, True, 1)]
...
class ChainRepeatedPattern:
    ...
    test_cases = [TestCase(False, False, 3, remove_overlapping_matches=False), TestCase(False, False, 2, remove_overlapping_matches=True), TestCase(True, False, 1), TestCase(False, True, 1), TestCase(True, True, 0)]
...
class MultipleOutputsWithoutDependency:
    ...
    def pattern(a):
        ...
        c = a.sum()
        return (b, c)
    test_cases = [TestCase(False, False, 1), TestCase(True, False, 0), TestCase(False, True, 0), TestCase(True, True, 0)]
...
class MultipleOutputsMultipleOverlappingMatches:
    ...
    def pattern(a):
        ...
        c = a.sum()
        return (a, b, c)
    test_cases = [TestCase(False, False, 4, remove_overlapping_matches=False), TestCase(False, False, 1, remove_overlapping_matches=True)]
...
class MultipleOutputsMultipleNonOverlappingMatches:
    ...
    def pattern(a):
        ...
        c = a.sum()
        return (b, c)
    test_cases = [TestCase(False, False, 1)]
...
class MultipleOutputsIdenticalAnchor:
    ...
    def pattern(a):
        ...
        b1 = a.sigmoid()
        return (b, b1)
    test_cases = [TestCase(True, False, 1), TestCase(False, True, 0)]
...
class MultiOutputWithWithInvalidMatches:
    ...
    test_cases = [TestCase(False, False, 0), TestCase(True, False, 0), TestCase(False, True, 0)]
...
class NoAnchorFound:
    ...
    def pattern(a):
        ...
        b1 = a.relu()
        return b1
    test_cases = [TestCase(False, False, 0), TestCase(True, False, 0), TestCase(False, True, 0), TestCase(True, True, 0)]
