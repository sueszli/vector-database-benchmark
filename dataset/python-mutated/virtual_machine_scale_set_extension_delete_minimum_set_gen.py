...
def main():
    ...
    client.virtual_machine_scale_set_extensions.begin_delete(resource_group_name='rgcompute', vm_scale_set_name='aaaa', vmss_extension_name='aaaaaaaaaaaaaaaaaaaaaaa').result()
