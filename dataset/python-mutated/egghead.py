...
class EggheadCourseIE(EggheadBaseIE):
    ...
    _TESTS = [{'url': 'https://egghead.io/courses/professor-frisby-introduces-composable-functional-javascript', 'playlist_count': 29, 'info_dict': {'id': '432655', 'title': 'Professor Frisby Introduces Composable Functional JavaScript', 'description': "re:(?s)^This course teaches the ubiquitous.*You'll start composing functionality before you know it.$"}}, {'url': 'https://app.egghead.io/playlists/professor-frisby-introduces-composable-functional-javascript', 'only_matching': True}]
...
class EggheadLessonIE(EggheadBaseIE):
    ...
    _TESTS = [{'url': 'https://egghead.io/lessons/javascript-linear-data-flow-with-container-style-types-box', 'info_dict': {'id': '1196', 'display_id': 'javascript-linear-data-flow-with-container-style-types-box', 'ext': 'mp4', 'title': 'Create linear data flow with container style types (Box)', 'description': 'md5:9aa2cdb6f9878ed4c39ec09e85a8150e', 'thumbnail': 're:^https?:.*\\.jpg$', 'timestamp': 1481296768, 'upload_date': '20161209', 'duration': 304, 'view_count': 0, 'tags': 'count:2'}, 'params': {'skip_download': True}}, {'url': 'https://egghead.io/api/v1/lessons/react-add-redux-to-a-react-application', 'only_matching': True}, {'url': 'https://app.egghead.io/lessons/javascript-linear-data-flow-with-container-style-types-box', 'only_matching': True}]
