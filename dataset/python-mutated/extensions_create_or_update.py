...
def main():
    ...
    response = client.extensions.create_or_update(resource_group_name='examples-rg', farm_beats_resource_name='examples-farmbeatsResourceName', extension_id='provider.extension')
    print(response)
