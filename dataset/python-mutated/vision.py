...
from google.cloud.vision_v1 import AnnotateImageRequest, Image, Product, ProductSet, ReferenceImage
...
class CloudVisionCreateProductSetOperator(GoogleCloudBaseOperator):
    ...
    """
    template_fields: Sequence[str] = ('location', 'project_id', 'product_set_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionCreateProductOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('location', 'project_id', 'product_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionImageAnnotateOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('request', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionCreateReferenceImageOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('location', 'reference_image', 'product_id', 'reference_image_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionDeleteReferenceImageOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('location', 'product_id', 'reference_image_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionAddProductToProductSetOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('location', 'product_set_id', 'product_id', 'project_id', 'gcp_conn_id', 'impersonation_chain')
...
class CloudVisionDetectTextOperator(GoogleCloudBaseOperator):
    ...
    :param impersonation_chain: Optional service account to impersonate using short-term
        ...
        account from the list granting this role to the originating account (templated).
    """
    template_fields: Sequence[str] = ('image', 'max_results', 'timeout', 'gcp_conn_id', 'impersonation_chain')
