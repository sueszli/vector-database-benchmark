...
if __name__ == '__main__':
    ...
    parser.add_argument('--interval-s', required=False, type=int, default=1, help='Address to use to connect to Ray')
    parser.add_argument('--total-steps', required=False, type=int, default=3, help='Password for connecting to Redis')
    (args, _) = parser.parse_known_args()
    ray.init()
    step_actor = StepActor.remote(interval_s=args.interval_s, total_steps=args.total_steps)
