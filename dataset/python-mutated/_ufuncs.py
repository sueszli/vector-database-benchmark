...
from ._normalizations import ArrayLike, ArrayLikeOrScalar, CastingModes, DTypeLike, normalizer, NotImplementedType, OutArray
...
def _ufunc_postprocess(result, out, casting):
    ...
    return result
_binary = [name for name in dir(_binary_ufuncs_impl) if not name.startswith('_') and name not in ['torch', 'matmul', 'divmod', 'ldexp']]
NEP50_FUNCS = ('add', 'subtract', 'multiply', 'floor_divide', 'true_divide', 'divide', 'remainder', 'bitwise_and', 'bitwise_or', 'bitwise_xor', 'bitwise_left_shift', 'bitwise_right_shift', 'hypot', 'arctan2', 'logaddexp', 'logaddexp2', 'heaviside', 'copysign', 'fmax', 'minimum', 'fmin', 'maximum', 'fmod', 'gcd', 'lcm', 'pow')
...
_fp_unary = ['arccos', 'arccosh', 'arcsin', 'arcsinh', 'arctan', 'arctanh', 'cbrt', 'cos', 'cosh', 'deg2rad', 'degrees', 'exp', 'exp2', 'expm1', 'log', 'log10', 'log1p', 'log2', 'rad2deg', 'radians', 'reciprocal', 'sin', 'sinh', 'sqrt', 'square', 'tan', 'tanh', 'trunc']
