...
from sentry.middleware.integrations.classifications import IntegrationClassification, PluginClassification
...
class PluginClassifiationTest(BaseClassificationTestCase):
    ...
    plugin_paths = ['/plugins/github/installations/webhook/', '/plugins/github/organizations/1/webhook/', '/plugins/bitbucket/organizations/1/webhook/']
