...
def create_job_with_set_number_images_spritesheet(project_id: str, location: str, input_uri: str, output_uri: str) -> transcoder_v1.types.resources.Job:
    if False:
        for i in range(10):
            print('nop')
...
if __name__ == '__main__':
    ...
    create_job_with_set_number_images_spritesheet(args.project_id, args.location, args.input_uri, args.output_uri)