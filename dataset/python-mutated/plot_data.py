...
try:
    ...
    raise SystemExit(1)
datatype_lookup = {'complex64': numpy.complex64, 'float32': numpy.float32, 'uint32': numpy.uint32, 'int32': numpy.int32, 'uint16': numpy.uint16, 'int16': numpy.int16, 'uint8': numpy.uint8, 'int8': numpy.int8}
