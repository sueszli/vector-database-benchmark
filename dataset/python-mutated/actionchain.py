...
class ActionChain(object):
    schema = {'title': 'ActionChain', 'description': 'A chain of sequentially executed actions.', 'type': 'object', 'properties': {'chain': {'description': 'The chain.', 'type': 'array', 'items': [Node.schema], 'required': True}, 'default': {'type': 'string', 'description': 'name of the action to be executed.'}, 'vars': {'description': '', 'type': 'object', 'patternProperties': {'^\\w+$': {}}}}, 'additionalProperties': False}
