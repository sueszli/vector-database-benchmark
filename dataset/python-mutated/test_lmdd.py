...
class TestCOF(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert hasattr(self.clf, 'dis_measure_') and self.clf.dis_measure_ is not None
        assert hasattr(self.clf, 'n_iter_') and self.clf.n_iter_ is not None
        assert hasattr(self.clf, 'random_state_') and self.clf.random_state_ is not None
