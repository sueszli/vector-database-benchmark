...
class sfp_filemeta(SpiderFootPlugin):
    meta = {'name': 'File Metadata Extractor', 'summary': 'Extracts meta data from documents and images.', 'flags': [], 'useCases': ['Footprint'], 'categories': ['Content Analysis']}
    opts = {'fileexts': ['docx', 'pptx', 'pdf', 'jpg', 'jpeg', 'tiff', 'tif'], 'timeout': 300}
    optdescs = {'fileexts': 'File extensions of files you want to analyze the meta data of (only PDF, DOCX, XLSX and PPTX are supported.)', 'timeout': 'Download timeout for files, in seconds.'}
    results = None
