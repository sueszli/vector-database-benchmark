...
from ..utils import determine_ext, ExtractorError, int_or_none, unified_strdate
...
class RadioCanadaIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://ici.radio-canada.ca/widgets/mediaconsole/medianet/7184272', 'info_dict': {'id': '7184272', 'ext': 'mp4', 'title': 'Le parcours du tireur capté sur vidéo', 'description': "Images des caméras de surveillance fournies par la GRC montrant le parcours du tireur d'Ottawa", 'upload_date': '20141023'}, 'params': {'skip_download': True}}, {'url': 'http://ici.radio-canada.ca/widgets/mediaconsole/medianet/7754998/', 'info_dict': {'id': '7754998', 'ext': 'mp4', 'title': 'letelejournal22h', 'description': 'INTEGRALE WEB 22H-TJ', 'upload_date': '20170720'}, 'params': {'skip_download': True}}, {'url': 'radiocanada:toutv:140872', 'info_dict': {'id': '140872', 'title': 'Épisode 1', 'series': 'District 31'}, 'only_matching': True}]
    _GEO_COUNTRIES = ['CA']
    _access_token = None
    _claims = None
...
class RadioCanadaAudioVideoIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://ici.radio-canada.ca/audio-video/media-7527184/barack-obama-au-vietnam', 'info_dict': {'id': '7527184', 'ext': 'mp4', 'title': 'Barack Obama au Vietnam', 'description': "Les États-Unis lèvent l'embargo sur la vente d'armes qui datait de la guerre du Vietnam", 'upload_date': '20160523'}, 'params': {'skip_download': True}}, {'url': 'https://ici.radio-canada.ca/info/videos/media-7527184/barack-obama-au-vietnam', 'only_matching': True}]
