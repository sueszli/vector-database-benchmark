...
from warehouse.email import send_added_as_team_member_email, send_removed_as_team_collaborator_email, send_removed_as_team_member_email, send_role_changed_as_team_collaborator_email, send_team_collaborator_removed_email, send_team_collaborator_role_changed_email, send_team_deleted_email, send_team_member_added_email, send_team_member_removed_email
from warehouse.events.tags import EventTag
from warehouse.manage.forms import ChangeTeamProjectRoleForm, CreateTeamRoleForm, SaveTeamForm
from warehouse.manage.views import organization_managers, organization_members, organization_owners, user_projects
from warehouse.organizations import IOrganizationService
from warehouse.organizations.models import Team, TeamProjectRole, TeamProjectRoleType, TeamRoleType
...
@view_defaults(route_name='manage.team.settings', context=Team, renderer='manage/team/settings.html', uses_session=True, require_active_organization=True, require_csrf=True, require_methods=False, permission='manage:team', has_translations=True, require_reauth=True)
...
@view_defaults(route_name='manage.team.projects', context=Team, renderer='manage/team/projects.html', uses_session=True, require_active_organization=True, require_csrf=True, require_methods=False, permission='manage:team', has_translations=True, require_reauth=True)
...
@view_defaults(route_name='manage.team.roles', context=Team, renderer='manage/team/roles.html', uses_session=True, require_active_organization=True, require_csrf=True, require_methods=False, permission='manage:team', has_translations=True, require_reauth=True)
