...
from ..utils import determine_ext, ExtractorError, float_or_none, int_or_none, parse_qs, unsmuggle_url, update_url_query, xpath_with_ns, mimetype2ext, find_xpath_attr, traverse_obj, update_url, urlhandle_detect_ext
...
class ThePlatformIE(ThePlatformBaseIE, AdobePassIE):
    ...
    _EMBED_REGEX = ['(?x)\n            <meta\\s+\n                property=(["\'])(?:og:video(?::(?:secure_)?url)?|twitter:player)\\1\\s+\n                content=(["\'])(?P<url>https?://player\\.theplatform\\.com/p/.+?)\\2', '(?s)<(?:iframe|script)[^>]+src=(["\\\'])(?P<url>(?:https?:)?//player\\.theplatform\\.com/p/.+?)\\1']
    _TESTS = [{'url': 'http://link.theplatform.com/s/dJ5BDC/e9I_cZgTgIPd/meta.smil?format=smil&Tracking=true&mbr=true', 'info_dict': {'id': 'e9I_cZgTgIPd', 'ext': 'flv', 'title': "Blackberry's big, bold Z30", 'description': "The Z30 is Blackberry's biggest, baddest mobile messaging device yet.", 'duration': 247, 'timestamp': 1383239700, 'upload_date': '20131031', 'uploader': 'CBSI-NEW'}, 'params': {'skip_download': True}, 'skip': '404 Not Found'}, {'url': 'http://link.theplatform.com/s/kYEXFC/22d_qsQ6MIRT', 'info_dict': {'id': '22d_qsQ6MIRT', 'ext': 'flv', 'description': 'md5:ac330c9258c04f9d7512cf26b9595409', 'title': 'Tesla Model S: A second step towards a cleaner motoring future', 'timestamp': 1426176191, 'upload_date': '20150312', 'uploader': 'CBSI-NEW'}, 'params': {'skip_download': True}, 'skip': 'CNet no longer uses ThePlatform'}, {'url': 'https://player.theplatform.com/p/D6x-PC/pulse_preview/embed/select/media/yMBg9E8KFxZD', 'info_dict': {'id': 'yMBg9E8KFxZD', 'ext': 'mp4', 'description': 'md5:644ad9188d655b742f942bf2e06b002d', 'title': 'HIGHLIGHTS: USA bag first ever series Cup win', 'uploader': 'EGSM'}, 'skip': 'Dead link'}, {'url': 'http://player.theplatform.com/p/NnzsPC/widget/select/media/4Y0TlYUr_ZT7', 'only_matching': True}, {'url': 'http://player.theplatform.com/p/2E2eJC/nbcNewsOffsite?guid=tdy_or_siri_150701', 'md5': 'fb96bb3d85118930a5b055783a3bd992', 'info_dict': {'id': 'tdy_or_siri_150701', 'ext': 'mp4', 'title': 'iPhone Siri’s sassy response to a math question has people talking', 'description': 'md5:a565d1deadd5086f3331d57298ec6333', 'duration': 83.0, 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1435752600, 'upload_date': '20150701', 'uploader': 'NBCU-NEWS'}, 'skip': 'Error: Player PID "nbcNewsOffsite" is disabled'}, {'url': 'http://player.theplatform.com/p/NnzsPC/onsite_universal/select/media/guid/2410887629/2928790?fwsitesection=nbc_the_blacklist_video_library&autoPlay=true&carouselID=137781', 'only_matching': True}]
...
class ThePlatformFeedIE(ThePlatformBaseIE):
    ...
    _TESTS = [{'url': 'http://feed.theplatform.com/f/7wvmTC/msnbc_video-p-test?form=json&pretty=true&range=-40&byGuid=n_hardball_5biden_140207', 'md5': '6e32495b5073ab414471b615c5ded394', 'info_dict': {'id': 'n_hardball_5biden_140207', 'ext': 'mp4', 'title': 'The Biden factor: will Joe run in 2016?', 'description': 'Could Vice President Joe Biden be preparing a 2016 campaign? Mark Halperin and Sam Stein weigh in.', 'thumbnail': 're:^https?://.*\\.jpg$', 'upload_date': '20140208', 'timestamp': 1391824260, 'duration': 467.0, 'categories': ['MSNBC/Issues/Democrats', 'MSNBC/Issues/Elections/Election 2016'], 'uploader': 'NBCU-NEWS'}}, {'url': 'http://feed.theplatform.com/f/2E2eJC/nnd_NBCNews?byGuid=nn_netcast_180306.Copy.01', 'only_matching': True}]
