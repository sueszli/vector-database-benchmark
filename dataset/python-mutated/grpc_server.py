...
from feast.protos.feast.serving.GrpcServer_pb2 import PushResponse, WriteToOnlineStoreResponse
from feast.protos.feast.serving.GrpcServer_pb2_grpc import GrpcFeatureServerServicer, add_GrpcFeatureServerServicer_to_server
from feast.protos.feast.serving.ServingService_pb2 import GetOnlineFeaturesRequest, GetOnlineFeaturesResponse
