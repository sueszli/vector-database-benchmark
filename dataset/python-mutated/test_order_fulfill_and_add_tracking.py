...
from .utils import draft_order_complete, draft_order_create, draft_order_update, mark_order_paid, order_add_tracking, order_fulfill, order_lines_create, order_query
...
@pytest.mark.e2e
def test_order_fulfill_and_add_tracking_CORE_0219(e2e_staff_api_client, permission_manage_products, permission_manage_channels, permission_manage_product_types_and_attributes, permission_manage_shipping, permission_manage_orders, permission_manage_settings):
    if False:
        for i in range(10):
            print('nop')
    ...
    data = order_add_tracking(e2e_staff_api_client, fulfillment_id, tracking_number)
