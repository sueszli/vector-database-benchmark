...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def test_create_file(self):
        ...
        worksheet.add_table('B3:K6', {'total_row': 1, 'columns': [{'total_string': 'Total'}, {}, {'total_function': 'average'}, {'total_function': 'count'}, {'total_function': 'count_nums'}, {'total_function': 'max'}, {'total_function': 'min'}, {'total_function': 'sum'}, {'total_function': 'std_dev'}, {'total_function': '=SUM([Column10])', 'formula': 'SUM(Table1[[#This Row],[Column1]:[Column3]])', 'format': xformat}]})
        workbook.close()
