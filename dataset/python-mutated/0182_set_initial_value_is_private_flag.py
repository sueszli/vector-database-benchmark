...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [('zerver', '0181_userprofile_change_emojiset')]
    operations = [migrations.RunPython(set_initial_value_of_is_private_flag, reverse_code=migrations.RunPython.noop, elidable=True)]