...
import proto
__protobuf__ = proto.module(package='google.cloud.networkservices.v1', manifest={'HttpRoute', 'ListHttpRoutesRequest', 'ListHttpRoutesResponse', 'GetHttpRouteRequest', 'CreateHttpRouteRequest', 'UpdateHttpRouteRequest', 'DeleteHttpRouteRequest'})

class HttpRoute(proto.Message):
    """HttpRoute is the resource defining how HTTP traffic should be
    ...
    class HeaderMatch(proto.Message):
        """Specifies how to select a route rule based on HTTP request
        headers.
        ...
        class IntegerRange(proto.Message):
            ...
            """
            start: int = proto.Field(proto.INT32, number=1)
            end: int = proto.Field(proto.INT32, number=2)
        exact_match: str = proto.Field(proto.STRING, number=2, oneof='MatchType')
        regex_match: str = proto.Field(proto.STRING, number=3, oneof='MatchType')
        prefix_match: str = proto.Field(proto.STRING, number=4, oneof='MatchType')
        present_match: bool = proto.Field(proto.BOOL, number=5, oneof='MatchType')
        suffix_match: str = proto.Field(proto.STRING, number=6, oneof='MatchType')
        range_match: 'HttpRoute.HeaderMatch.IntegerRange' = proto.Field(proto.MESSAGE, number=7, oneof='MatchType', message='HttpRoute.HeaderMatch.IntegerRange')
        header: str = proto.Field(proto.STRING, number=1)
        invert_match: bool = proto.Field(proto.BOOL, number=8)
    ...
    class QueryParameterMatch(proto.Message):
        ...
        exact_match: str = proto.Field(proto.STRING, number=2, oneof='MatchType')
        regex_match: str = proto.Field(proto.STRING, number=3, oneof='MatchType')
        present_match: bool = proto.Field(proto.BOOL, number=4, oneof='MatchType')
        query_parameter: str = proto.Field(proto.STRING, number=1)

    class RouteMatch(proto.Message):
        """RouteMatch defines specifications used to match requests. If
        ...
        Attributes:
            ...
            query_parameters (MutableSequence[google.cloud.network_services_v1.types.HttpRoute.QueryParameterMatch]):
                ...
                matched.
        """
        full_path_match: str = proto.Field(proto.STRING, number=1, oneof='PathMatch')
        ...
        ignore_case: bool = proto.Field(proto.BOOL, number=4)
        headers: MutableSequence['HttpRoute.HeaderMatch'] = proto.RepeatedField(proto.MESSAGE, number=5, message='HttpRoute.HeaderMatch')
        query_parameters: MutableSequence['HttpRoute.QueryParameterMatch'] = proto.RepeatedField(proto.MESSAGE, number=6, message='HttpRoute.QueryParameterMatch')

    class Destination(proto.Message):
        """Specifications of a destination to which the request should
        be routed to.
        ...
        weight: int = proto.Field(proto.INT32, number=2)
    ...
    class Redirect(proto.Message):
        ...
        class ResponseCode(proto.Enum):
            ...
            TEMPORARY_REDIRECT = 4
            PERMANENT_REDIRECT = 5
        host_redirect: str = proto.Field(proto.STRING, number=1)
        path_redirect: str = proto.Field(proto.STRING, number=2)
        prefix_rewrite: str = proto.Field(proto.STRING, number=3)
        response_code: 'HttpRoute.Redirect.ResponseCode' = proto.Field(proto.ENUM, number=4, enum='HttpRoute.Redirect.ResponseCode')
        https_redirect: bool = proto.Field(proto.BOOL, number=5)
        strip_query: bool = proto.Field(proto.BOOL, number=6)
        port_redirect: int = proto.Field(proto.INT32, number=7)
    ...
    class FaultInjectionPolicy(proto.Message):
        ...
        class Delay(proto.Message):
            """Specification of how client requests are delayed as part of
            ...
            """
            fixed_delay: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=1, message=duration_pb2.Duration)
            percentage: int = proto.Field(proto.INT32, number=2)

        class Abort(proto.Message):
            """Specification of how client requests are aborted as part of
            fault injection before being sent to a destination.
            ...
            Attributes:
                ...
                percentage (int):
                    ...
                    The value must be between [0, 100]
            """
            http_status: int = proto.Field(proto.INT32, number=1)
            percentage: int = proto.Field(proto.INT32, number=2)
        delay: 'HttpRoute.FaultInjectionPolicy.Delay' = proto.Field(proto.MESSAGE, number=1, message='HttpRoute.FaultInjectionPolicy.Delay')
        abort: 'HttpRoute.FaultInjectionPolicy.Abort' = proto.Field(proto.MESSAGE, number=2, message='HttpRoute.FaultInjectionPolicy.Abort')

    class HeaderModifier(proto.Message):
        """The specification for modifying HTTP header in HTTP request
        and HTTP response.
        ...
        """
        set: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=1)
        add: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=2)
        remove: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)

    class URLRewrite(proto.Message):
        """The specification for modifying the URL of the request, prior
        ...
        """
        path_prefix_rewrite: str = proto.Field(proto.STRING, number=1)
        host_rewrite: str = proto.Field(proto.STRING, number=2)
    ...
    class RetryPolicy(proto.Message):
        ...
        Attributes:
            ...
            per_try_timeout (google.protobuf.duration_pb2.Duration):
                ...
                attempt.
        """
        retry_conditions: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        num_retries: int = proto.Field(proto.INT32, number=2)
        per_try_timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=3, message=duration_pb2.Duration)

    class RequestMirrorPolicy(proto.Message):
        """Specifies the policy on how requests are shadowed to a
        ...
        Attributes:
            destination (google.cloud.network_services_v1.types.HttpRoute.Destination):
                ...
                ignored.
        """
        destination: 'HttpRoute.Destination' = proto.Field(proto.MESSAGE, number=1, message='HttpRoute.Destination')

    class CorsPolicy(proto.Message):
        """The Specification for allowing client side cross-origin
        requests.
        ...
        """
        allow_origins: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=1)
        allow_origin_regexes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
        allow_methods: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
        allow_headers: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=4)
        expose_headers: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
        max_age: str = proto.Field(proto.STRING, number=6)
        allow_credentials: bool = proto.Field(proto.BOOL, number=7)
        disabled: bool = proto.Field(proto.BOOL, number=8)

    class RouteAction(proto.Message):
        """The specifications for routing traffic and applying
        associated policies.
        ...
        """
        destinations: MutableSequence['HttpRoute.Destination'] = proto.RepeatedField(proto.MESSAGE, number=1, message='HttpRoute.Destination')
        redirect: 'HttpRoute.Redirect' = proto.Field(proto.MESSAGE, number=2, message='HttpRoute.Redirect')
        fault_injection_policy: 'HttpRoute.FaultInjectionPolicy' = proto.Field(proto.MESSAGE, number=4, message='HttpRoute.FaultInjectionPolicy')
        request_header_modifier: 'HttpRoute.HeaderModifier' = proto.Field(proto.MESSAGE, number=5, message='HttpRoute.HeaderModifier')
        response_header_modifier: 'HttpRoute.HeaderModifier' = proto.Field(proto.MESSAGE, number=6, message='HttpRoute.HeaderModifier')
        url_rewrite: 'HttpRoute.URLRewrite' = proto.Field(proto.MESSAGE, number=7, message='HttpRoute.URLRewrite')
        timeout: duration_pb2.Duration = proto.Field(proto.MESSAGE, number=8, message=duration_pb2.Duration)
        retry_policy: 'HttpRoute.RetryPolicy' = proto.Field(proto.MESSAGE, number=9, message='HttpRoute.RetryPolicy')
        request_mirror_policy: 'HttpRoute.RequestMirrorPolicy' = proto.Field(proto.MESSAGE, number=10, message='HttpRoute.RequestMirrorPolicy')
        cors_policy: 'HttpRoute.CorsPolicy' = proto.Field(proto.MESSAGE, number=11, message='HttpRoute.CorsPolicy')

    class RouteRule(proto.Message):
        """Specifies how to match traffic and how to route traffic when
        traffic is matched.
        ...
        Attributes:
            ...
            action (google.cloud.network_services_v1.types.HttpRoute.RouteAction):
                ...
                matched traffic.
        """
        matches: MutableSequence['HttpRoute.RouteMatch'] = proto.RepeatedField(proto.MESSAGE, number=1, message='HttpRoute.RouteMatch')
        action: 'HttpRoute.RouteAction' = proto.Field(proto.MESSAGE, number=2, message='HttpRoute.RouteAction')
    name: str = proto.Field(proto.STRING, number=1)
    self_link: str = proto.Field(proto.STRING, number=11)
    ...
    hostnames: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=5)
    meshes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=8)
    gateways: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=9)
    labels: MutableMapping[str, str] = proto.MapField(proto.STRING, proto.STRING, number=10)
    rules: MutableSequence[RouteRule] = proto.RepeatedField(proto.MESSAGE, number=6, message=RouteRule)
...
class ListHttpRoutesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    http_routes: MutableSequence['HttpRoute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='HttpRoute')
...
class CreateHttpRouteRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    http_route_id: str = proto.Field(proto.STRING, number=2)
    http_route: 'HttpRoute' = proto.Field(proto.MESSAGE, number=3, message='HttpRoute')
...
class UpdateHttpRouteRequest(proto.Message):
    ...
    http_route: 'HttpRoute' = proto.Field(proto.MESSAGE, number=2, message='HttpRoute')
