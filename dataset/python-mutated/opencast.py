...
from ..utils import determine_ext, ExtractorError, int_or_none, parse_iso8601, traverse_obj, variadic
...
class OpencastBaseIE(InfoExtractor):
    ...
    _UUID_RE = '[\\da-fA-F]{8}-[\\da-fA-F]{4}-[\\da-fA-F]{4}-[\\da-fA-F]{4}-[\\da-fA-F]{12}'
...
class OpencastIE(OpencastBaseIE):
    ...
    _TESTS = [{'url': 'https://oc-video1.ruhr-uni-bochum.de/paella/ui/watch.html?id=ed063cd5-72c8-46b5-a60a-569243edcea8', 'md5': '554c8e99a90f7be7e874619fcf2a3bc9', 'info_dict': {'id': 'ed063cd5-72c8-46b5-a60a-569243edcea8', 'ext': 'mp4', 'title': '11 - Kryptographie - 24.11.2015', 'thumbnail': 're:^https?://.*\\.jpg$', 'timestamp': 1606208400, 'upload_date': '20201124', 'season_id': 'cf68a4a1-36b1-4a53-a6ba-61af5705a0d0', 'series': 'Kryptographie - WiSe 15/16', 'creator': 'Alexander May'}}]
...
class OpencastPlaylistIE(OpencastBaseIE):
    ...
    _TESTS = [{'url': 'https://oc-video1.ruhr-uni-bochum.de/engage/ui/index.html?epFrom=cf68a4a1-36b1-4a53-a6ba-61af5705a0d0', 'info_dict': {'id': 'cf68a4a1-36b1-4a53-a6ba-61af5705a0d0', 'title': 'Kryptographie - WiSe 15/16'}, 'playlist_mincount': 29}, {'url': 'https://oc-video1.ruhr-uni-bochum.de/ltitools/index.html?subtool=series&series=cf68a4a1-36b1-4a53-a6ba-61af5705a0d0&lng=de', 'info_dict': {'id': 'cf68a4a1-36b1-4a53-a6ba-61af5705a0d0', 'title': 'Kryptographie - WiSe 15/16'}, 'playlist_mincount': 29}, {'url': 'https://electures.uni-muenster.de/engage/ui/index.html?e=1&p=1&epFrom=39391d10-a711-4d23-b21d-afd2ed7d758c', 'info_dict': {'id': '39391d10-a711-4d23-b21d-afd2ed7d758c', 'title': '021670 Theologische Themen bei Hans Blumenberg WiSe 2017/18'}, 'playlist_mincount': 13}]
