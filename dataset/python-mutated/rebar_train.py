...
try:
    ...
    xrange = range
gfile = tf.gfile
tf.app.flags.DEFINE_string('working_dir', '/tmp/rebar', 'Directory where to save data, write logs, etc.')
tf.app.flags.DEFINE_string('hparams', '', 'Comma separated list of name=value pairs.')
tf.app.flags.DEFINE_integer('eval_freq', 20, 'How often to run the evaluation step.')
