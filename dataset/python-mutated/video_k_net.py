...
from .track.quasi_dense_embed_tracker import QuasiDenseEmbedTracker, build_tracker
...
@MODELS.register_module(Tasks.video_panoptic_segmentation, module_name=Models.video_panoptic_segmentation)
