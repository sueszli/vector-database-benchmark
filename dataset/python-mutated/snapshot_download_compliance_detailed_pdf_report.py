...
def main():
    ...
    response = client.snapshot.begin_download(report_name='testReportName', snapshot_name='testSnapshotName', parameters={'downloadType': 'ComplianceDetailedPdfReport', 'offerGuid': '00000000-0000-0000-0000-000000000000', 'reportCreatorTenantId': '00000000-0000-0000-0000-000000000000'}).result()
    print(response)
