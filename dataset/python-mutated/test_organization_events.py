...
from sentry.testutils.cases import APITestCase, PerformanceIssueTestCase, ProfilesSnubaTestCase, SnubaTestCase
...
@region_silo_test
class OrganizationEventsProfileFunctionsDatasetEndpointTest(OrganizationEventsEndpointTestBase, ProfilesSnubaTestCase):
...
@region_silo_test
class OrganizationEventsIssuePlatformDatasetEndpointTest(OrganizationEventsEndpointTestBase, SearchIssueTestMixin, PerformanceIssueTestCase):
