...
class ActionStep(models.Model):
    ...
    text_matching: models.CharField = models.CharField(max_length=400, choices=STRING_MATCHING, null=True, blank=True)
    href: models.CharField = models.CharField(max_length=65535, null=True, blank=True)
    href_matching: models.CharField = models.CharField(max_length=400, choices=STRING_MATCHING, null=True, blank=True)
    ...
    url_matching: models.CharField = models.CharField(max_length=400, choices=STRING_MATCHING, default=CONTAINS, null=True, blank=True)
...
def action_step_saved(sender, instance: ActionStep, created, **kwargs):
    ...
    get_client().publish('reload-action', json.dumps({'teamId': instance.action.team_id, 'actionId': instance.action.id}))
