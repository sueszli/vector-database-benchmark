...
class Migration(migrations.Migration):
    dependencies = [('assets', '0097_auto_20220426_1558'), ('applications', '0020_auto_20220316_2028')]
    operations = [migrations.RunPython(migrate_database_to_asset), migrations.RunPython(migrate_cloud_to_asset), migrations.RunPython(migrate_to_nodes), migrations.RunPython(migrate_ori_host_to_devices)]