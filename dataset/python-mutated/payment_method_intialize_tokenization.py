...
class PaymentMethodInitializeTokenization(BaseMutation):
    ...
    class Arguments:
        id = graphene.String(required=True, description='The identifier of the payment gateway app to initialize payment method tokenization.')
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventSyncType.PAYMENT_METHOD_INITIALIZE_TOKENIZATION_SESSION, description='The customer requested to tokenize payment method.')]
