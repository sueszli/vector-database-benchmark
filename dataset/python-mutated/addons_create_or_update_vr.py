...
def main():
    ...
    response = client.addons.begin_create_or_update(resource_group_name='group1', private_cloud_name='cloud1', addon_name='vr', addon={'properties': {'addonType': 'VR', 'vrsCount': 1}}).result()
    print(response)
