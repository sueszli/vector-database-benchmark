...
from modelscope.models.cv.pedestrian_attribute_recognition.model import PedestrainAttribute
...
@PIPELINES.register_module(Tasks.pedestrian_attribute_recognition, module_name=Pipelines.pedestrian_attribute_recognition)
