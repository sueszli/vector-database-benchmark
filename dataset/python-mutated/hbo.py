...
from ..utils import xpath_text, xpath_element, int_or_none, parse_duration, urljoin

class HBOBaseIE(InfoExtractor):
    _FORMATS_INFO = {'pro7': {'width': 1280, 'height': 720}, '1920': {'width': 1280, 'height': 720}, 'pro6': {'width': 768, 'height': 432}, '640': {'width': 768, 'height': 432}, 'pro5': {'width': 640, 'height': 360}, 'highwifi': {'width': 640, 'height': 360}, 'high3g': {'width': 640, 'height': 360}, 'medwifi': {'width': 400, 'height': 224}, 'med3g': {'width': 400, 'height': 224}}
...
class HBOIE(HBOBaseIE):
    ...
    _TEST = {'url': 'https://www.hbo.com/video/game-of-thrones/seasons/season-8/videos/trailer', 'md5': '8126210656f433c452a21367f9ad85b3', 'info_dict': {'id': '22113301', 'ext': 'mp4', 'title': 'Game of Thrones - Trailer'}, 'expected_warnings': ['Unknown MIME type application/mp4 in DASH manifest']}
