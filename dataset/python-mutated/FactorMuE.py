...
if __name__ == '__main__':
    ...
    parser.add_argument('--test', action='store_true', default=False, help='Run with generated example dataset.')
    parser.add_argument('--small', action='store_true', default=False, help='Run with small example dataset.')
    ...
    parser.add_argument('-a', '--alphabet', default='amino-acid', help='Alphabet (amino-acid OR dna OR ATGC ...).')
    parser.add_argument('-zdim', '--z-dim', default=2, type=int, help='z space dimension.')
    parser.add_argument('-b', '--batch-size', default=10, type=int, help='Batch size.')
    parser.add_argument('-M', '--latent-seq-length', default=None, type=int, help='Latent sequence length.')
    parser.add_argument('-idfac', '--indel-factor', default=False, action='store_true', help='Indel parameters depend on latent variable.')
    parser.add_argument('-zdist', '--z-prior', default='Normal', help='Latent prior distribution (normal or Laplace).')
    parser.add_argument('-ard', '--ARD-prior', default=False, action='store_true', help='Use automatic relevance detection prior.')
    parser.add_argument('--no-substitution-matrix', default=False, action='store_true', help='Do not use substitution matrix.')
    parser.add_argument('-D', '--latent-alphabet', default=None, type=int, help='Latent alphabet length.')
    parser.add_argument('--include-stop', default=False, action='store_true', help='Include stop symbol at the end of each sequence.')
    parser.add_argument('--indel-prior-scale', default=1.0, type=float, help='Indel prior scale parameter ' + '(when indel-factor=False).')
    parser.add_argument('--indel-prior-bias', default=10.0, type=float, help='Indel prior bias parameter.')
    parser.add_argument('--inverse-temp-prior', default=100.0, type=float, help='Inverse temperature prior mean.')
    parser.add_argument('--weights-prior-scale', default=1.0, type=float, help='Factor parameter prior scale.')
    parser.add_argument('--offset-prior-scale', default=1.0, type=float, help='Offset parameter prior scale.')
    parser.add_argument('--substitution-prior-scale', default=10.0, type=float, help='Substitution matrix prior scale.')
    parser.add_argument('-lr', '--learning-rate', default=0.001, type=float, help='Learning rate for Adam optimizer.')
    parser.add_argument('--milestones', default='[]', type=str, help='Milestones for multistage learning rate.')
    parser.add_argument('--learning-gamma', default=0.5, type=float, help='Gamma parameter for multistage learning rate.')
    parser.add_argument('-e', '--n-epochs', default=10, type=int, help='Number of epochs of training.')
    parser.add_argument('--anneal', default=0.0, type=float, help='Number of epochs to anneal beta over.')
    parser.add_argument('--no-plots', default=False, action='store_true', help='Make plots.')
    parser.add_argument('--no-save', default=False, action='store_true', help='Do not save plots and results.')
    parser.add_argument('-outf', '--out-folder', default='.', help='Folder to save plots.')
    parser.add_argument('--split', default=0.2, type=float, help='Fraction of dataset to holdout for testing')
    ...
    parser.add_argument('--cpu-data', default=False, action='store_true', help='Keep data on CPU (for large datasets).')
    parser.add_argument('--pin-mem', default=False, action='store_true', help='Use pin_memory for faster CPU to GPU transfer.')
