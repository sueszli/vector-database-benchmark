...
class ConcatenateCheckpointTest(checkpoint_test_base.CheckpointTestBase, parameterized.TestCase):
...
class ConcatenateRandomAccessTest(test_base.DatasetTestBase, parameterized.TestCase):
