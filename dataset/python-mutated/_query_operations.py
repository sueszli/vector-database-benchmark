...
class QueryOperations:
    ...
    @overload
    async def usage(self, scope: str, parameters: _models.QueryDefinition, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.QueryResult]:
    ...
    @overload
    async def usage(self, scope: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> Optional[_models.QueryResult]:
        """Query the usage data for scope defined.
    ...
    async def usage(self, scope: str, parameters: Union[_models.QueryDefinition, IO], **kwargs: Any) -> Optional[_models.QueryResult]:
        """Query the usage data for scope defined.
        ...
        request = build_usage_request(scope=scope, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.usage.metadata['url'], headers=_headers, params=_params)
    ...
    @overload
    async def usage_by_external_cloud_provider_type(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: _models.QueryDefinition, *, content_type: str='application/json', **kwargs: Any) -> _models.QueryResult:
    ...
    @overload
    async def usage_by_external_cloud_provider_type(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: IO, *, content_type: str='application/json', **kwargs: Any) -> _models.QueryResult:
        """Query the usage data for external cloud provider type defined.
    ...
    @distributed_trace_async
    async def usage_by_external_cloud_provider_type(self, external_cloud_provider_type: Union[str, _models.ExternalCloudProviderType], external_cloud_provider_id: str, parameters: Union[_models.QueryDefinition, IO], **kwargs: Any) -> _models.QueryResult:
        """Query the usage data for external cloud provider type defined.
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, 'QueryDefinition')
        request = build_usage_by_external_cloud_provider_type_request(external_cloud_provider_type=external_cloud_provider_type, external_cloud_provider_id=external_cloud_provider_id, api_version=api_version, content_type=content_type, json=_json, content=_content, template_url=self.usage_by_external_cloud_provider_type.metadata['url'], headers=_headers, params=_params)
        request = _convert_request(request)
        request.url = self._client.format_url(request.url)
        _stream = False
        pipeline_response: PipelineResponse = await self._client._pipeline.run(request, stream=_stream, **kwargs)
