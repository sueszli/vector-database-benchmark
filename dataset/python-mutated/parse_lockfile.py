...
OLD_LOCKFILE_PARSERS = {'cargo.lock': parse_cargo}
NEW_LOCKFILE_PARSERS: Dict[str, Callable[[Path, Optional[Path]], Tuple[List[FoundDependency], List[DependencyParserError]]]] = {'requirements.txt': parse_requirements, 'requirements3.txt': parse_requirements, 'maven_dep_tree.txt': parse_pom_tree, 'yarn.lock': parse_yarn, 'gradle.lockfile': parse_gradle, 'pipfile.lock': parse_pipfile, 'package-lock.json': parse_package_lock, 'gemfile.lock': parse_gemfile, 'poetry.lock': parse_poetry, 'go.mod': parse_go_mod, 'pnpm-lock.yaml': parse_pnpm, 'composer.lock': parse_composer_lock, 'packages.lock.json': parse_packages_lock_c_sharp, 'pubspec.lock': parse_pubspec_lock}
LOCKFILE_TO_MANIFEST: Dict[str, Optional[str]] = {'Pipfile.lock': 'Pipfile', 'poetry.lock': 'pyproject.toml', 'requirements.txt': 'requirements.in', 'requirements3.txt': 'requirements.in', 'package-lock.json': 'package.json', 'yarn.lock': 'package.json', 'composer.lock': 'composer.json', 'Gemfile.lock': None, 'go.mod': None, 'Cargo.lock': None, 'maven_dep_tree.txt': None, 'gradle.lockfile': 'build.gradle', 'pnpm-lock.yaml': None, 'packages.lock.json': None, 'pubspec.lock': 'pubspec.yaml'}
