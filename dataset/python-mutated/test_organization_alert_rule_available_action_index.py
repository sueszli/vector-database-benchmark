...
from sentry.incidents.endpoints.organization_alert_rule_available_action_index import build_action_response
...
SERVICES = [{'type': 'service', 'integration_key': 'PND4F9', 'service_id': '123', 'service_name': 'hellboi'}]
METADATA = {'api_key': '1234-ABCD', 'base_url': 'https://api.opsgenie.com/', 'domain_name': 'test-app.app.opsgenie.com'}
