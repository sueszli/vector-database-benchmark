...
def build_generate_download_uri_request(scope: str, history_definition_id: str, instance_id: str, **kwargs: Any) -> HttpRequest:
    if False:
        while True:
            i = 10
    ...
    _url = kwargs.pop('template_url', '/{scope}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri')
    path_format_arguments = {'scope': _SERIALIZER.url('scope', scope, 'str'), 'historyDefinitionId': _SERIALIZER.url('history_definition_id', history_definition_id, 'str'), 'instanceId': _SERIALIZER.url('instance_id', instance_id, 'str')}
...
class ScopeAccessReviewHistoryDefinitionInstanceOperations:
    ...
    @distributed_trace
    def generate_download_uri(self, scope: str, history_definition_id: str, instance_id: str, **kwargs: Any) -> _models.AccessReviewHistoryInstance:
        if False:
            i = 10
            return i + 15
        ...
        request = build_generate_download_uri_request(scope=scope, history_definition_id=history_definition_id, instance_id=instance_id, api_version=api_version, template_url=self.generate_download_uri.metadata['url'], headers=_headers, params=_params)
        ...
        return deserialized
    generate_download_uri.metadata = {'url': '/{scope}/providers/Microsoft.Authorization/accessReviewHistoryDefinitions/{historyDefinitionId}/instances/{instanceId}/generateDownloadUri'}