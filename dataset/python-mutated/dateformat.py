...
from django.utils.timezone import _datetime_ambiguous_or_imaginary, get_default_timezone, is_naive, make_aware
from django.utils.translation import gettext as _
re_formatchars = _lazy_re_compile('(?<!\\\\)([aAbcdDeEfFgGhHiIjlLmMnNoOPrsStTUuwWyYzZ])')
re_escaped = _lazy_re_compile('\\\\(.)')
