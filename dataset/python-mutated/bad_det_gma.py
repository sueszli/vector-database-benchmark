...
class BadDetGlobalMisclassificationAttack(PoisoningAttackObjectDetector):
    ...
    | Paper link: https://arxiv.org/abs/2205.14497
    """
    attack_params = PoisoningAttackObjectDetector.attack_params + ['backdoor', 'class_target', 'percent_poison', 'channels_first', 'verbose']
    _estimator_requirements = ()

    def __init__(self, backdoor: PoisoningAttackBackdoor, class_target: int=1, percent_poison: float=0.3, channels_first: bool=False, verbose: bool=False) -> None:
        if False:
            for i in range(10):
                print('nop')
