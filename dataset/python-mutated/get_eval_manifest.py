...
if __name__ == '__main__':
    ...
    parser.add_argument('--generation-root', help='output directory for generate_waveform.py')
    parser.add_argument('--audio-manifest', help='used to determine the original utterance ID and text')
    parser.add_argument('--output-path', help='path to output evaluation spec file')
    parser.add_argument('--use-resynthesized-target', action='store_true', help='use resynthesized reference instead of the original audio')
    parser.add_argument('--eval-target', action='store_true', help='evaluate reference instead of model prediction')
