...
BLOCK_FACTORS_KP1 = {'CPIAUCSL': ['global', 'test1'], 'UNRATE': ['global', 'test2'], 'PAYEMS': ['global', 'test2'], 'RSAFS': ['global', 'test1', 'test2'], 'TTLCONS': ['global', 'test1'], 'TCU': ['global', 'test2'], 'GDPC1': ['global', 'test1', 'test2'], 'ULCNFB': ['global']}
