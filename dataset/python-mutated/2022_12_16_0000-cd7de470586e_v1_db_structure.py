...
def upgrade() -> None:
    ...
    op.create_table('api_client', sa.Column('id', UUID(as_uuid=True), default=uuid.uuid4, server_default=sa.text('gen_random_uuid()')), sa.Column('api_key', sa.String(512), nullable=False), sa.Column('description', sa.String(256), nullable=False), sa.Column('admin_email', sa.String(256), nullable=True), sa.Column('enabled', sa.Boolean, default=True, nullable=False), sa.PrimaryKeyConstraint('id'))
    op.create_index(op.f('ix_api_client_api_key'), 'api_client', ['api_key'], unique=True)
    op.create_table('person', sa.Column('id', UUID(as_uuid=True), default=uuid.uuid4, server_default=sa.text('gen_random_uuid()')), sa.Column('username', sa.String(128), nullable=False), sa.Column('display_name', sa.String(256), nullable=False), sa.Column('created_date', sa.DateTime(), nullable=False, server_default=sa.func.current_timestamp()), sa.Column('api_client_id', UUID(as_uuid=True), nullable=False), sa.PrimaryKeyConstraint('id'), sa.ForeignKeyConstraint(['api_client_id'], ['api_client.id']))
    op.create_index(op.f('ix_person_username'), 'person', ['api_client_id', 'username'], unique=True)
    op.create_table('person_stats', sa.Column('person_id', UUID(as_uuid=True)), sa.Column('leader_score', sa.Integer, default=0, nullable=False), sa.Column('modified_date', sa.DateTime(), nullable=False, server_default=sa.func.current_timestamp()), sa.Column('reactions', sa.Integer, default=0, nullable=False), sa.Column('posts', sa.Integer, default=0, nullable=False), sa.Column('upvotes', sa.Integer, default=0, nullable=False), sa.Column('downvotes', sa.Integer, default=0, nullable=False), sa.Column('work_reward', sa.Integer, default=0, nullable=False), sa.Column('compare_wins', sa.Integer, default=0, nullable=False), sa.Column('compare_losses', sa.Integer, default=0, nullable=False), sa.PrimaryKeyConstraint('person_id'), sa.ForeignKeyConstraint(['person_id'], ['person.id']))
    op.create_table('work_package', sa.Column('id', UUID(as_uuid=True), default=uuid.uuid4, server_default=sa.text('gen_random_uuid()')), sa.Column('created_date', sa.DateTime(), nullable=False, server_default=sa.func.current_timestamp()), sa.Column('expiry_date', sa.DateTime(), nullable=True), sa.Column('person_id', UUID(as_uuid=True), nullable=True), sa.Column('payload_type', sa.String(200), nullable=False), sa.Column('payload', JSONB(astext_type=sa.Text()), nullable=False), sa.Column('api_client_id', UUID(as_uuid=True), nullable=False), sa.PrimaryKeyConstraint('id'), sa.ForeignKeyConstraint(['person_id'], ['person.id']), sa.ForeignKeyConstraint(['api_client_id'], ['api_client.id']))
    op.create_index(op.f('ix_work_package_person_id'), 'work_package', ['person_id'], unique=False)
    op.create_table('post', sa.Column('id', UUID(as_uuid=True), default=uuid.uuid4, server_default=sa.text('gen_random_uuid()')), sa.Column('parent_id', UUID(as_uuid=True), nullable=True), sa.Column('thread_id', UUID(as_uuid=True), nullable=False), sa.Column('workpackage_id', UUID(as_uuid=True), nullable=True), sa.Column('person_id', UUID(as_uuid=True), nullable=True), sa.Column('api_client_id', UUID(as_uuid=True), nullable=False), sa.Column('role', sa.String(128), nullable=False), sa.Column('frontend_post_id', sa.String(200), nullable=False), sa.Column('created_date', sa.DateTime(), nullable=False, server_default=sa.func.current_timestamp()), sa.Column('payload_type', sa.String(200), nullable=False), sa.Column('payload', JSONB(astext_type=sa.Text()), nullable=True), sa.PrimaryKeyConstraint('id'), sa.ForeignKeyConstraint(['person_id'], ['person.id']), sa.ForeignKeyConstraint(['api_client_id'], ['api_client.id']))
    ...
    op.create_table('post_reaction', sa.Column('post_id', UUID(as_uuid=True), nullable=False), sa.Column('person_id', UUID(as_uuid=True), nullable=False), sa.Column('created_date', sa.DateTime(), nullable=False, server_default=sa.func.current_timestamp()), sa.Column('payload_type', sa.String(200), nullable=False), sa.Column('payload', JSONB(astext_type=sa.Text()), nullable=False), sa.Column('api_client_id', UUID(as_uuid=True), nullable=False), sa.PrimaryKeyConstraint('post_id', 'person_id'), sa.ForeignKeyConstraint(['post_id'], ['post.id']), sa.ForeignKeyConstraint(['person_id'], ['person.id']), sa.ForeignKeyConstraint(['api_client_id'], ['api_client.id']))
