...
FromUserVerifyKeyPartitionKey = PartitionKey(key='from_user_verify_key', type_=SyftVerifyKey)
ToUserVerifyKeyPartitionKey = PartitionKey(key='to_user_verify_key', type_=SyftVerifyKey)
...
class NotificationStash(BaseUIDStoreStash):
    ...
    settings: PartitionSettings = PartitionSettings(name=Notification.__canonical_name__, object_type=Notification)
