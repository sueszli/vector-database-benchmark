...
class TestDictPersistence:
    ...
    async def test_invalid_json_string_given(self):
        ...
        with pytest.raises(TypeError, match='bot_data'):
            DictPersistence(bot_data_json=bad_bot_data)
        for bad_callback_data in [bad_callback_data_1, bad_callback_data_2, bad_callback_data_3, bad_callback_data_4, bad_callback_data_5]:
            with pytest.raises(TypeError, match='callback_data'):
                DictPersistence(callback_data_json=bad_callback_data)
        with pytest.raises(TypeError, match='conversations'):
            DictPersistence(conversations_json=bad_conversations)

    async def test_good_json_input(self, user_data_json, chat_data_json, bot_data_json, conversations_json, callback_data_json):
        dict_persistence = DictPersistence(user_data_json=user_data_json, chat_data_json=chat_data_json, bot_data_json=bot_data_json, conversations_json=conversations_json, callback_data_json=callback_data_json)
    ...
    async def test_dict_outputs(self, user_data, user_data_json, chat_data, chat_data_json, bot_data, bot_data_json, callback_data_json, conversations, conversations_json):
        dict_persistence = DictPersistence(user_data_json=user_data_json, chat_data_json=chat_data_json, bot_data_json=bot_data_json, callback_data_json=callback_data_json, conversations_json=conversations_json)
    ...
    async def test_json_outputs(self, user_data_json, chat_data_json, bot_data_json, callback_data_json, conversations_json):
        dict_persistence = DictPersistence(user_data_json=user_data_json, chat_data_json=chat_data_json, bot_data_json=bot_data_json, callback_data_json=callback_data_json, conversations_json=conversations_json)
    ...
    async def test_updating(self, user_data_json, chat_data_json, bot_data_json, callback_data, callback_data_json, conversations, conversations_json):
        dict_persistence = DictPersistence(user_data_json=user_data_json, chat_data_json=chat_data_json, bot_data_json=bot_data_json, callback_data_json=callback_data_json, conversations_json=conversations_json)
        user_data = await dict_persistence.get_user_data()
        ...
        assert dict_persistence.conversations_json == DictPersistence._encode_conversations_to_json(conversations)
        ...
        assert dict_persistence.conversations_json == DictPersistence._encode_conversations_to_json({'name1': {(123, 123): 5}})

    async def test_no_data_on_init(self, bot_data, user_data, chat_data, conversations, callback_data):
        dict_persistence = DictPersistence()
    ...
    async def test_no_json_dumping_if_data_did_not_change(self, bot_data, user_data, chat_data, conversations, callback_data, monkeypatch):
        dict_persistence = DictPersistence()
        await dict_persistence.update_bot_data(bot_data)
        await dict_persistence.update_user_data(12345, user_data[12345])
        await dict_persistence.update_chat_data(-12345, chat_data[-12345])
        ...
        assert dict_persistence.bot_data_json == json.dumps(bot_data)
        assert dict_persistence.conversations_json == DictPersistence._encode_conversations_to_json({'name': {(1, 1): 'new_state'}})
        assert dict_persistence.callback_data_json == json.dumps(callback_data)
        flag = False
