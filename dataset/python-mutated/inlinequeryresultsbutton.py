...
class InlineQueryResultsButton(TelegramObject):
    ...
    def __init__(self, text: str, web_app: Optional[WebAppInfo]=None, start_parameter: Optional[str]=None, *, api_kwargs: Optional[JSONDict]=None):
        if False:
            i = 10
            return i + 15
    ...
    MIN_START_PARAMETER_LENGTH: Final[int] = constants.InlineQueryResultsButtonLimit.MIN_START_PARAMETER_LENGTH
