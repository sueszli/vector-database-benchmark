...
class TestCompareXLSXFiles(ExcelComparisonTest):
    ...
    def test_create_file(self):
        ...
        worksheet.add_table('B3:F9', {'total_row': True, 'columns': [{'header': 'Column1', 'total_string': 'Total'}, {'header': "Column'", 'total_function': 'sum'}, {'header': 'Column#', 'total_function': 'sum'}, {'header': 'Column[', 'total_function': 'sum'}, {'header': 'Column]', 'total_function': 'sum'}]})
        workbook.close()
