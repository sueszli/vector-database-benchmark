...
class TestYolov5DetectionModel(unittest.TestCase):
    ...
    def test_load_model(self):
        ...
        yolov5_detection_model = Yolov5DetectionModel(model_path=Yolov5TestConstants.YOLOV5N_MODEL_PATH, confidence_threshold=CONFIDENCE_THRESHOLD, device=MODEL_DEVICE, category_remapping=None, load_at_init=True)
    ...
    def test_set_model(self):
        ...
        yolov5_detection_model = Yolov5DetectionModel(model=yolo_model, confidence_threshold=CONFIDENCE_THRESHOLD, device=MODEL_DEVICE, category_remapping=None, load_at_init=True)
        self.assertNotEqual(yolov5_detection_model.model, None)
    ...
    def test_perform_inference(self):
        ...
        from sahi.models.yolov5 import Yolov5DetectionModel
        download_yolov5n_model()
        yolov5_detection_model = Yolov5DetectionModel(model_path=Yolov5TestConstants.YOLOV5N_MODEL_PATH, confidence_threshold=CONFIDENCE_THRESHOLD, device=MODEL_DEVICE, category_remapping=None, load_at_init=True, image_size=IMAGE_SIZE)
