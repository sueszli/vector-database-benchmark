...
__all__ = ['MFAChallengeSerializer', 'MFASelectTypeSerializer', 'PasswordVerifySerializer', 'ResetPasswordCodeSerializer']

class ResetPasswordCodeSerializer(serializers.Serializer):
    form_type = serializers.ChoiceField(choices=[('sms', _('SMS')), ('email', _('Email'))], default='email')
