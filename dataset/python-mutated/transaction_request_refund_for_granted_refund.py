...
class TransactionRequestRefundForGrantedRefund(BaseMutation):
    ...
    class Arguments:
        ...
        granted_refund_id = graphene.ID(required=True, description='The ID of the granted refund.')

    class Meta:
        description = 'Request a refund for payment transaction based on granted refund.' + ADDED_IN_315 + PREVIEW_FEATURE
