...
class ec2_instance_older_than_specific_days(Check):
    ...
    def execute(self):
        if False:
            return 10
        findings = []
        max_ec2_instance_age_in_days = ec2_client.audit_config.get('max_ec2_instance_age_in_days', 180)
        for instance in ec2_client.instances:
            ...
            if instance.state == 'running':
                time_since_launch = datetime.now().replace(tzinfo=timezone.utc) - instance.launch_time
