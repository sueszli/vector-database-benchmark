...
if TYPE_CHECKING:
    ...
    Vec4DLike = Any
Vec4DArrayLike = Union[Vec4D, Sequence[Vec4DLike], npt.NDArray[Any], npt.ArrayLike, Sequence[Sequence[float]], Sequence[float]]
...
class Vec4DType(BaseExtensionType):
    ...
    def __init__(self) -> None:
        if False:
            i = 10
            return i + 15
        pa.ExtensionType.__init__(self, pa.list_(pa.field('item', pa.float32(), nullable=False, metadata={}), 4), self._TYPE_NAME)
