...
pi = np.pi
tf_export.tf_export('experimental.numpy.pi', v1=[]).export_constant(__name__, 'pi')
e = np.e
tf_export.tf_export('experimental.numpy.e', v1=[]).export_constant(__name__, 'e')
inf = np.inf
tf_export.tf_export('experimental.numpy.inf', v1=[]).export_constant(__name__, 'inf')
...
_tf_float_types = [dtypes.bfloat16, dtypes.float16, dtypes.float32, dtypes.float64]
...
nansum = tf_export.tf_export('experimental.numpy.nansum', v1=[])(_make_nan_reduction('nansum', np_array_ops.sum, 0))
nanprod = tf_export.tf_export('experimental.numpy.nanprod', v1=[])(_make_nan_reduction('nanprod', np_array_ops.prod, 1))
