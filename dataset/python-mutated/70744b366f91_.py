...
def upgrade():
    if False:
        while True:
            i = 10
    op.create_index(op.f('ix_environment_images_project_uuid'), 'environment_images', ['project_uuid'], unique=False)
    op.create_index(op.f('ix_environment_images_tag'), 'environment_images', ['tag'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_environment_images_project_uuid'), table_name='environment_images')