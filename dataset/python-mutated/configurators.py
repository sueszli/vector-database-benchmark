...
from localstack.utils.container_utils.container_client import ContainerClient, ContainerConfiguration, VolumeBind, VolumeMappings
...
class EntryPointMountConfigurator:
    ...
    """
    entry_point_glob = '/opt/code/localstack/.venv/lib/python3.*/site-packages/*.dist-info/entry_points.txt'
    localstack_community_entry_points = '/opt/code/localstack/localstack_core.egg-info/entry_points.txt'
