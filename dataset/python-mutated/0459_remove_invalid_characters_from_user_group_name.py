...
class Migration(migrations.Migration):
    atomic = False
    dependencies = [('zerver', '0458_realmauditlog_modified_user_group')]
    operations = [migrations.RunPython(remove_invalid_characters_from_user_group_name, elidable=True, reverse_code=migrations.RunPython.noop)]