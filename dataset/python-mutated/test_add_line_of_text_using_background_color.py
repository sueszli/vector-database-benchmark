...
class TestAddLineOfTextUsingBackgroundColor(TestCase):
    ...
    def test_add_lineoftext_using_background_color_001(self):
        ...
        layout.add(self.get_test_header(test_description='This test adds a LineOfText to the PDF with background_color 023047'))
    ...
    def test_add_lineoftext_using_background_color_002(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds a LineOfText to the PDF with background_color FFB703'))
    ...
    def test_add_lineoftext_using_background_color_003(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds a LineOfText to the PDF with background_color FB8500'))
    ...
    def test_add_lineoftext_using_background_color_004(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds a LineOfText to the PDF with background_color 219EBC'))
    ...
    def test_add_lineoftext_using_background_color_005(self):
        ...
        pdf.add_page(page)
        layout = SingleColumnLayout(page)
        layout.add(self.get_test_header(test_description='This test adds a LineOfText to the PDF with background_color 8ECAE6'))
