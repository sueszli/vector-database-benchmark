...
class DataTaxonomy(proto.Message):
    """DataTaxonomy represents a set of hierarchical DataAttributes
    ...
    attribute_count: int = proto.Field(proto.INT32, number=9)
    etag: str = proto.Field(proto.STRING, number=10)
    class_count: int = proto.Field(proto.INT32, number=11)
...
class DataAttribute(proto.Message):
    ...
    parent_id: str = proto.Field(proto.STRING, number=8)
    attribute_count: int = proto.Field(proto.INT32, number=9)
    etag: str = proto.Field(proto.STRING, number=10)
    resource_access_spec: security.ResourceAccessSpec = proto.Field(proto.MESSAGE, number=100, message=security.ResourceAccessSpec)
    data_access_spec: security.DataAccessSpec = proto.Field(proto.MESSAGE, number=101, message=security.DataAccessSpec)

class DataAttributeBinding(proto.Message):
    """DataAttributeBinding represents binding of attributes to
    ...
    class Path(proto.Message):
        """Represents a subresource of the given resource, and
        ...
        """
        name: str = proto.Field(proto.STRING, number=1)
        attributes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=2)
    name: str = proto.Field(proto.STRING, number=1)
    uid: str = proto.Field(proto.STRING, number=2)
    create_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=3, message=timestamp_pb2.Timestamp)
    update_time: timestamp_pb2.Timestamp = proto.Field(proto.MESSAGE, number=4, message=timestamp_pb2.Timestamp)
    ...
    resource: str = proto.Field(proto.STRING, number=100, oneof='resource_reference')
    attributes: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=110)
    paths: MutableSequence[Path] = proto.RepeatedField(proto.MESSAGE, number=120, message=Path)
...
class CreateDataTaxonomyRequest(proto.Message):
    ...
    data_taxonomy_id: str = proto.Field(proto.STRING, number=2)
    data_taxonomy: 'DataTaxonomy' = proto.Field(proto.MESSAGE, number=3, message='DataTaxonomy')
...
class UpdateDataTaxonomyRequest(proto.Message):
    ...
    data_taxonomy: 'DataTaxonomy' = proto.Field(proto.MESSAGE, number=2, message='DataTaxonomy')
    ...
    def raw_page(self):
        if False:
            while True:
                i = 10
        return self
    data_taxonomies: MutableSequence['DataTaxonomy'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataTaxonomy')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable_locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateDataAttributeRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    data_attribute_id: str = proto.Field(proto.STRING, number=2)
    data_attribute: 'DataAttribute' = proto.Field(proto.MESSAGE, number=3, message='DataAttribute')
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateDataAttributeRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    data_attribute: 'DataAttribute' = proto.Field(proto.MESSAGE, number=2, message='DataAttribute')
    validate_only: bool = proto.Field(proto.BOOL, number=3)
...
class ListDataAttributesResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    data_attributes: MutableSequence['DataAttribute'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataAttribute')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable_locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
...
class CreateDataAttributeBindingRequest(proto.Message):
    ...
    """
    parent: str = proto.Field(proto.STRING, number=1)
    data_attribute_binding_id: str = proto.Field(proto.STRING, number=2)
    data_attribute_binding: 'DataAttributeBinding' = proto.Field(proto.MESSAGE, number=3, message='DataAttributeBinding')
    validate_only: bool = proto.Field(proto.BOOL, number=4)
...
class UpdateDataAttributeBindingRequest(proto.Message):
    ...
    """
    update_mask: field_mask_pb2.FieldMask = proto.Field(proto.MESSAGE, number=1, message=field_mask_pb2.FieldMask)
    data_attribute_binding: 'DataAttributeBinding' = proto.Field(proto.MESSAGE, number=2, message='DataAttributeBinding')
    validate_only: bool = proto.Field(proto.BOOL, number=3)
...
class ListDataAttributeBindingsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            ...
            return i + 15
        return self
    data_attribute_bindings: MutableSequence['DataAttributeBinding'] = proto.RepeatedField(proto.MESSAGE, number=1, message='DataAttributeBinding')
    next_page_token: str = proto.Field(proto.STRING, number=2)
    unreachable_locations: MutableSequence[str] = proto.RepeatedField(proto.STRING, number=3)
