...
"""
import struct
from scapy.fields import BitEnumField, BitField, DestField, DestIP6Field, ShortField
from scapy.packet import Packet, bind_layers, bind_bottom_up
from scapy.compat import orb
from scapy.layers.inet import UDP
from scapy.layers.dns import DNSCompressedPacket, DNS_am, DNS
...
class LLMNRQuery(DNSCompressedPacket):
    ...
    qd = []
    fields_desc = [ShortField('id', 0), BitField('qr', 0, 1), BitEnumField('opcode', 0, 4, {0: 'QUERY'}), BitField('c', 0, 1), BitField('tc', 0, 1), BitField('t', 0, 1), BitField('z', 0, 4)] + DNS.fields_desc[-9:]
