...
from ..utils._metadata_requests import MetadataRouter, MethodMapping, _raise_for_params, get_routing_for_object
from ..utils._param_validation import Interval, StrOptions, validate_params
from ..utils.extmath import safe_sparse_dot
from ..utils.metadata_routing import _routing_enabled, process_routing
from ..utils.parallel import Parallel, delayed
from ..utils.validation import _check_sample_weight, check_consistent_length, check_is_fitted, check_random_state, column_or_1d, has_fit_parameter
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    """
    _parameter_constraints: dict = {**LinearModelCV._parameter_constraints}
    _parameter_constraints.pop('precompute')
    _parameter_constraints.pop('positive')
    path = staticmethod(lasso_path)
