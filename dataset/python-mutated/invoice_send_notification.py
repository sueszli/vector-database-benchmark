...
class InvoiceSendNotification(ModelMutation):
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.INVOICE_SENT, description='A notification for invoice send'), WebhookEventInfo(type=WebhookEventAsyncType.NOTIFY_USER, description='A notification for invoice send')]
