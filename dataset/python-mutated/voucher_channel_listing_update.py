...
class VoucherChannelListingAddInput(BaseInputObjectType):
    ...
    min_amount_spent = PositiveDecimal(description='Min purchase amount required to apply the voucher.')

    class Meta:
        doc_category = DOC_CATEGORY_DISCOUNTS

class VoucherChannelListingInput(BaseInputObjectType):
    add_channels = NonNullList(VoucherChannelListingAddInput, description='List of channels to which the voucher should be assigned.', required=False)
    remove_channels = NonNullList(graphene.ID, description='List of channels from which the voucher should be unassigned.', required=False)
...
class VoucherChannelListingUpdate(BaseChannelListingMutation):
    ...
    class Arguments:
        ...
        input = VoucherChannelListingInput(required=True, description='Fields required to update voucher channel listings.')
