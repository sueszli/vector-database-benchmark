...
def main():
    ...
    client.session_hosts.delete(resource_group_name='resourceGroup1', host_pool_name='hostPool1', session_host_name='sessionHost1.microsoft.com')
