...
class ConfirmAccount(BaseMutation):
    ...
    class Arguments:
        token = graphene.String(description='A one-time token required to confirm the account.', required=True)
        email = graphene.String(description='E-mail of the user performing account confirmation.', required=True)
    ...
    class Meta:
        ...
        webhook_events_info = [WebhookEventInfo(type=WebhookEventAsyncType.ACCOUNT_CONFIRMED, description='Account was confirmed.')]
