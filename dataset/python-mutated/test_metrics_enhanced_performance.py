...
from sentry.snuba.metrics import MAX_POINTS, MetricConditionField, MetricField, MetricGroupByField, MetricOrderByField, MetricsQuery
from sentry.snuba.metrics.datasource import get_custom_measurements, get_series
from sentry.snuba.metrics.naming_layer import TransactionMetricKey, TransactionMRI, TransactionStatusTagValue, TransactionTagsKey
from sentry.snuba.metrics.query_builder import QueryDefinition
from sentry.testutils.cases import BaseMetricsLayerTestCase, MetricsEnhancedPerformanceTestCase, TestCase
...
class GetCustomMeasurementsTestCase(MetricsEnhancedPerformanceTestCase):
    METRIC_STRINGS = ['d:transactions/measurements.something_custom@millisecond', 'd:transactions/measurements.something_else@byte']
