...
from ..compat import compat_str, compat_urllib_parse_urlencode, compat_urllib_parse_unquote
from .openload import PhantomJSwrapper
from ..utils import clean_html, decode_packed_codes, ExtractorError, float_or_none, format_field, get_element_by_id, get_element_by_attribute, int_or_none, js_to_json, ohdave_rsa_encrypt, parse_age_limit, parse_duration, parse_iso8601, parse_resolution, qualities, remove_start, str_or_none, traverse_obj, urljoin
...
class IqiyiIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://www.iqiyi.com/v_19rrojlavg.html', 'info_dict': {'id': '9c1fb1b99d192b21c559e5a1a2cb3c73', 'ext': 'mp4', 'title': '美国德州空中惊现奇异云团 酷似UFO'}}, {'url': 'http://www.iqiyi.com/v_19rrhnnclk.html', 'md5': 'b7dc800a4004b1b57749d9abae0472da', 'info_dict': {'id': 'e3f585b550a280af23c98b6cb2be19fb', 'ext': 'mp4', 'title': 're:^(?:名侦探柯南 国语版：第752集 迫近灰原秘密的黑影 下篇|名偵探柯南 國語版：第752集 迫近灰原秘密的黑影 下篇)$'}, 'skip': 'Geo-restricted to China'}, {'url': 'http://www.iqiyi.com/w_19rt6o8t9p.html', 'only_matching': True}, {'url': 'http://www.iqiyi.com/a_19rrhbc6kt.html', 'only_matching': True}, {'url': 'http://yule.iqiyi.com/pcb.html', 'info_dict': {'id': '4a0af228fddb55ec96398a364248ed7f', 'ext': 'mp4', 'title': '第2017-04-21期 女艺人频遭极端粉丝骚扰'}}, {'url': 'http://www.iqiyi.com/v_19rrny4w8w.html', 'info_dict': {'id': 'f3cf468b39dddb30d676f89a91200dc1', 'ext': 'mp4', 'title': '泰坦尼克号'}, 'skip': 'Geo-restricted to China'}, {'url': 'http://www.iqiyi.com/a_19rrhb8ce1.html', 'info_dict': {'id': '202918101', 'title': '灌篮高手 国语版'}, 'playlist_count': 101}, {'url': 'http://www.pps.tv/w_19rrbav0ph.html', 'only_matching': True}]
    _FORMATS_MAP = {'96': 1, '1': 2, '2': 3, '21': 4, '4': 5, '17': 5, '5': 6, '18': 7}
...
class IqAlbumIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'https://www.iq.com/album/one-piece-1999-1bk9icvr331', 'info_dict': {'id': '1bk9icvr331', 'title': 'One Piece', 'description': 'Subtitle available on Sunday 4PM（GMT+8）.'}, 'playlist_mincount': 238}, {'url': 'https://www.iq.com/album/九龙城寨-2021-22yjnij099k', 'info_dict': {'ext': 'mp4', 'id': '22yjnij099k', 'title': '九龙城寨', 'description': 'md5:8a09f50b8ba0db4dc69bc7c844228044', 'duration': 5000, 'timestamp': 1641911371, 'upload_date': '20220111', 'series': '九龙城寨', 'cast': ['Shi Yan Neng', 'Yu Lang', 'Peter  lv', 'Sun Zi Jun', 'Yang Xiao Bo'], 'age_limit': 13, 'average_rating': float}, 'expected_warnings': ['format is restricted']}]
