...
flags.DEFINE_boolean('faces_only', True, 'If True, generates bounding boxes for pet faces.  Otherwise generates bounding boxes (as well as segmentations for full pet bodies).  Note that in the latter case, the resulting files are much larger.')
flags.DEFINE_string('mask_type', 'png', 'How to represent instance segmentation masks. Options are "png" or "numerical".')
