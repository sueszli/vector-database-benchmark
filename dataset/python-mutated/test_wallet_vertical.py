...
from electrum.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text, Abstract_Wallet, CannotBumpFee
from electrum.util import bfh, NotEnoughFunds, UnrelatedTransactionException, UserFacingException
from electrum.transaction import TxOutput, Transaction, PartialTransaction, PartialTxOutput, PartialTxInput, tx_from_any, TxOutpoint
...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    async def test_electrum_seed_segwit(self, mock_save_db):
        ...
        self.assertEqual('zprvAabC4ncjU4qVMNbpYZ5G4XqmKJoJN3EA4TVCodaPwyvEatrZpVYmWVHfKwS1fdq2uCdPyCmbjAjQ5FzeqHFSGv9KUmUFptTMAcyKzHiUM6Q', ks.get_lightning_xprv(None))
    ...
    async def test_electrum_seed_segwit_passphrase(self, mock_save_db):
        ...
        self.assertEqual('zprvAaoTFrze53KLvVYL8yL5H4sxoBFto98dgfTxFxcBepBPaEWStxpsdYqvNGxskGMTgX11bUtPiVj3aCe2jXFkAJQMi9RmksGBgFVwFM85Gir', ks.get_lightning_xprv(None))
    ...
    async def test_electrum_seed_2fa_legacy_pre27(self, mock_save_db):
        ...
        (long_user_id, short_id) = trustedcoin.get_user_id({'x1': {'xpub': xpub1}, 'x2': {'xpub': xpub2}})
    ...
    async def test_bip32_extended_version_bytes(self, mock_save_db):
        ...
        self.assertEqual('0df68c16e522eea9c1d8e090cfb2139c3b3a2abed78cbcb3e20be2c29185d3b8df4e8ce4e52a1206a688aeb88bfee249585b41a7444673d1f16c0d45755fa8b9', bip32_seed.hex())
    ...
    async def test_slip39_basic_2of5_bip49_p2sh_segwit(self, mock_save_db):
        ...
        """
        mnemonics = ['hobo romp academic axis august founder knife legal recover alien expect emphasis loan kitchen involve teacher capture rebuild trial numb spider forward ladle lying voter typical security quantity hawk legs idle leaves gasoline', 'hobo romp academic agency ancestor industry argue sister scene midst graduate profile numb paid headset airport daisy flame express scene usual welcome quick silent downtown oral critical step remove says rhythm venture aunt']
        encrypted_seed = slip39.recover_ems(mnemonics)
        root_seed = encrypted_seed.decrypt('TREZOR')
        ks = keystore.from_bip43_rootseed(root_seed, "m/49'/0'/0'")
        self.assertTrue(isinstance(ks, keystore.BIP32_KeyStore))
    ...
    async def test_slip39_groups_128bit_bip84_native_segwit(self, mock_save_db):
        ...
        """
        mnemonics = ['eraser senior beard romp adorn nuclear spill corner cradle style ancient family general leader ambition exchange unusual garlic promise voice', 'eraser senior ceramic snake clay various huge numb argue hesitate auction category timber browser greatest hanger petition script leaf pickup', 'eraser senior ceramic shaft dynamic become junior wrist silver peasant force math alto coal amazing segment yelp velvet image paces', 'eraser senior ceramic round column hawk trust auction smug shame alive greatest sheriff living perfect corner chest sled fumes adequate']
        encrypted_seed = slip39.recover_ems(mnemonics)
        root_seed = encrypted_seed.decrypt('TREZOR')
        ks = keystore.from_bip43_rootseed(root_seed, "m/84'/0'/0'")
        self.assertTrue(isinstance(ks, keystore.BIP32_KeyStore))
...
class TestWalletSending(ElectrumTestCase):
    ...
    async def test_sending_between_p2sh_2of3_and_uncompressed_p2pkh(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('blast uniform dragon fiscal ensure vast young utility dinosaur abandon rookie sure', '', True), keystore.from_xpub('tpubD6NzVbkrYhZ4YTPEgwk4zzr8wyo7pXGmbbVUnfYNtx6SgAMF5q3LN3Kch58P9hxGNsTmP7Dn49nnrmpE6upoRb1Xojg12FGLuLHkVpVtS44'), keystore.from_xpub('tpubD6NzVbkrYhZ4XJzYkhsCbDCcZRmDAKSD7bXi9mdCni7acVt45fxbTVZyU6jRGh29ULKTjoapkfFsSJvQHitcVKbQgzgkkYsAmaovcro7Mhf')], '2of3', gap_limit=2, config=self.config)
        wallet1b = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('cycle rocket west magnet parrot shuffle foot correct salt library feed song', '', True), keystore.from_xpub('tpubD6NzVbkrYhZ4YTPEgwk4zzr8wyo7pXGmbbVUnfYNtx6SgAMF5q3LN3Kch58P9hxGNsTmP7Dn49nnrmpE6upoRb1Xojg12FGLuLHkVpVtS44'), keystore.from_xpub('tpubD6NzVbkrYhZ4YARFMEZPckrqJkw59GZD1PXtQnw14ukvWDofR7Z1HMeSCxfYEZVvg4VdZ8zGok5VxHwdrLqew5cMdQntWc5mT7mh1CSgrnX')], '2of3', gap_limit=2, config=self.config)
        ...
        self.assertEqual('pkh(045f7ba332df2a7b4f5d13f246e307c9174cfa9b8b05f3b83410a3c23ef8958d610be285963d67c7bc1feb082f168fa9877c25999963ff8b56b242a852b23e25ed)', tx.inputs()[0].script_descriptor.to_string_no_checksum())
    ...
    async def test_sending_between_p2wsh_2of3_and_p2wsh_p2sh_2of2(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('bitter grass shiver impose acquire brush forget axis eager alone wine silver', '', True), keystore.from_xpub('Vpub5fcdcgEwTJmbmqAktuK8Kyq92fMf7sWkcP6oqAii2tG47dNbfkGEGUbfS9NuZaRywLkHE6EmUksrqo32ZL3ouLN1HTar6oRiHpDzKMAF1tf'), keystore.from_xpub('Vpub5fjkKyYnvSS4wBuakWTkNvZDaBM2vQ1MeXWq368VJHNr2eT8efqhpmZ6UUkb7s2dwCXv2Vuggjdhk4vZVyiAQTwUftvff73XcUGq2NQmWra')], '2of3', gap_limit=2, config=self.config)
        wallet1b = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('snow nest raise royal more walk demise rotate smooth spirit canyon gun', '', True), keystore.from_xpub('Vpub5fjkKyYnvSS4wBuakWTkNvZDaBM2vQ1MeXWq368VJHNr2eT8efqhpmZ6UUkb7s2dwCXv2Vuggjdhk4vZVyiAQTwUftvff73XcUGq2NQmWra'), keystore.from_xpub('Vpub5gSKXzxK7FeKQedu2q1z9oJWxqvX72AArW3HSWpEhc8othDH8xMDu28gr7gf17sp492BuJod8Tn7anjvJrKpETwqnQqX7CS8fcYyUtedEMk')], '2of3', gap_limit=2, config=self.config)
        wallet2a = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xprv('Uprv9CvELvByqm8k2dpecJVjgLMX1z5DufEjY4fBC5YvdGF5WjGCa7GVJJ2fYni1tyuF7Hw83E6W2ZBjAhaFLZv2ri3rEsubkCd5avg4EHKoDBN'), keystore.from_xpub('Upub5Qb8ik4Cnu8g97KLXKgVXHqY6tH8emQvqtBncjSKsyfTZuorPtTZgX7ovKKZHuuVGBVd1MTTBkWez1XXt2weN1sWBz6SfgRPQYEkNgz81QF')], '2of2', gap_limit=2, config=self.config)
        wallet2b = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xprv('Uprv9BbnKEXJxXaNvdEsRJ9VA9toYrSeFJh5UfGBpM2iKe8Uh7UhrM9K8ioL53s8gvCoGfirHHaqpABDAE7VUNw8LNU1DMJKVoWyeNKu9XcDC19'), keystore.from_xpub('Upub5RuakRisg8h3F7u7iL2k3UJFa1uiK7xauHamzTxYBbn4PXbM7eajr6M9Q2VCr6cVGhfhqWQqxnABvtSATuVM1xzxk4nA189jJwzaMn1QX7V')], '2of2', gap_limit=2, config=self.config)
    ...
    async def test_sending_between_p2sh_1of2_and_p2wpkh_p2sh(self, mock_save_db):
        wallet1a = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('phone guilt ancient scan defy gasp off rotate approve ill word exchange', '', True), keystore.from_xpub('tpubD6NzVbkrYhZ4YPZ3ntVjqSCxiUUv2jikrUBU73Q3iJ7Y8iR41oYf991L5fanv7ciHjbjokdK2bjYqg1BzEUDxucU9qM5WRdBiY738wmgLP4')], '1of2', gap_limit=2, config=self.config)
        wallet2 = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('uprv91HGbrNZTK4x8u22nbdYGzEuWPxjaHMREUi7CNhY64KsG5ZGnVM99uCa16EMSfrnaPTFxjbRdBZ2WiBkokoM8anzAy3Vpc52o88WPkitnxi'), gap_limit=2, config=self.config)
    ...
    async def test_rbf(self, mock_save_db):
        ...
        class TmpConfig(tempfile.TemporaryDirectory):
        ...
        for simulate_moving_txs in (False, True):
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2pkh_when_there_is_a_change_address', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2pkh_when_there_is_a_change_address(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2wpkh_when_there_is_a_change_address', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2wpkh_when_there_is_a_change_address(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2pkh_when_there_are_two_ismine_outs_one_change_one_recv', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2pkh_when_there_are_two_ismine_outs_one_change_one_recv(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_when_user_sends_max', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_when_user_sends_max(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_when_new_inputs_need_to_be_added', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_when_new_inputs_need_to_be_added(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2wpkh_when_there_is_only_a_single_output_and_that_is_a_change_address', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2wpkh_when_there_is_only_a_single_output_and_that_is_a_change_address(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
            ...
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_when_not_all_inputs_are_ismine_subcase_some_outputs_are_ismine_but_not_all', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_when_not_all_inputs_are_ismine_subcase_some_outputs_are_ismine_but_not_all(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_when_not_all_inputs_are_ismine_subcase_all_outputs_are_ismine', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_when_not_all_inputs_are_ismine_subcase_all_outputs_are_ismine(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2wpkh_decrease_payment', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2wpkh_decrease_payment(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
                with self.subTest(msg='_bump_fee_p2wpkh_decrease_payment_batch', simulate_moving_txs=simulate_moving_txs):
                    await self._bump_fee_p2wpkh_decrease_payment_batch(simulate_moving_txs=simulate_moving_txs, config=config)
            with TmpConfig() as config:
    ...
    async def _bump_fee_p2pkh_when_there_is_a_change_address(self, *, simulate_moving_txs, config):
        wallet = self.create_standard_wallet_from_seed('fold object utility erase deputy output stadium feed stereo usage modify bean', config=config)
    ...
    async def _bump_fee_p2pkh_when_there_are_two_ismine_outs_one_change_one_recv(self, *, simulate_moving_txs, config):
        ...
        """
        wallet = self.create_standard_wallet_from_seed('amazing vapor slab rib chat cousin east float plug baby session weird', config=config)
    ...
    async def _bump_fee_p2wpkh_decrease_payment(self, *, simulate_moving_txs, config):
        wallet = self.create_standard_wallet_from_seed('leader company camera enlist crash sleep insane aware anger hole hammer label', config=config)
        ...
        wallet.adb.receive_tx_callback(orig_rbf_tx, TX_HEIGHT_UNCONFIRMED)
        tx = wallet.bump_fee(tx=tx_from_any(orig_rbf_tx.serialize()), new_fee_rate=60, decrease_payment=True)
        tx.locktime = 1936085
        tx.version = 2
        if simulate_moving_txs:
            partial_tx = tx.serialize_as_bytes().hex()
    ...
    async def _bump_fee_p2wpkh_insane_high_target_fee(self, *, config):
        ...
        with self.assertRaises(CannotBumpFee):
            tx = wallet.bump_fee(tx=tx_from_any(orig_rbf_tx.serialize()), new_fee_rate=99999, decrease_payment=True)
        with self.assertRaises(CannotBumpFee):
            tx = wallet.bump_fee(tx=tx_from_any(orig_rbf_tx.serialize()), new_fee_rate=99999, decrease_payment=False)
        tx = wallet.bump_fee(tx=tx_from_any(orig_rbf_tx.serialize()), new_fee_rate=60, decrease_payment=True)
        tx.locktime = 1936085
        tx.version = 2
    ...
    async def _bump_fee_p2wpkh_when_there_is_a_change_address(self, *, simulate_moving_txs, config):
        wallet = self.create_standard_wallet_from_seed('frost repair depend effort salon ring foam oak cancel receive save usage', config=config)
    ...
    async def _bump_fee_when_not_all_inputs_are_ismine_subcase_some_outputs_are_ismine_but_not_all(self, *, simulate_moving_txs, config):
        ...
        wallet = self.create_standard_wallet_from_seed('mix total present junior leader live state athlete mistake crack wall valve', config=config)
            ...
            def blockchain(self):
                ...
                class BlockchainMock:
                    ...
                    def is_tip_stale(self):
                        ...
                        return True
                return BlockchainMock()
        wallet = self.create_standard_wallet_from_seed('faint orbit extend hope moon head mercy still debate sick cotton path', config=config, gap_limit=4)
        wallet.network = NetworkMock()
    ...
    async def _bump_fee_when_new_inputs_need_to_be_added(self, *, simulate_moving_txs, config):
        ...
        self.assertEqual((0, 5000000, 0), wallet.get_balance())
        tx = wallet.bump_fee(tx=tx_from_any(tx.serialize()), new_fee_rate=70.0)
        tx.locktime = 1325500
        tx.version = 1
        if simulate_moving_txs:
        ...
        wallet.adb.receive_tx_callback(tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 4990300, 0), wallet.get_balance())
    ...
    async def _rbf_batching(self, *, simulate_moving_txs, config):
        ...
        self.assertEqual('ba87313e2b3b42f1cc478843d4d53c72d6e06f6c66ac8cfbe2a59cdac2fd532d', tx_copy.wtxid())
        wallet.adb.receive_tx_callback(tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 7495000, 0), wallet.get_balance())
        funding_tx2 = Transaction('')
        funding_txid2 = funding_tx2.txid()
        self.assertEqual('c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a', funding_txid2)
        wallet.adb.receive_tx_callback(funding_tx2, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 12495000, 0), wallet.get_balance())
        outputs = [PartialTxOutput.from_address_and_value('tb1qy6xmdj96v5dzt3j08hgc05yk3kltqsnmw4r6ry', 2500000)]
        coins = wallet.get_spendable_coins(domain=None)
        ...
        wallet.adb.receive_tx_callback(tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 9980000, 0), wallet.get_balance())
        outputs = [PartialTxOutput.from_address_and_value('2NCVwbmEpvaXKHpXUGJfJr9iB5vtRN3vcut', 6000000)]
        coins = wallet.get_spendable_coins(domain=None)
        tx = wallet.make_unsigned_transaction(coins=coins, outputs=outputs, fee=100000)
        tx.set_rbf(True)
        tx.locktime = 1325499
        tx.version = 1
        if simulate_moving_txs:
        ...
        wallet.adb.receive_tx_callback(tx, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 3900000, 0), wallet.get_balance())
    ...
    async def test_rbf_batching__cannot_batch_as_would_need_to_use_ismine_outputs_of_basetx(self):
        ...
        """
        wallet = self.create_standard_wallet_from_seed('cause carbon luggage air humble mistake melt paper supreme sense gravity void', config=self.config)
        ...
        outputs = [PartialTxOutput.from_address_and_value('tb1qkfn0fude7z789uys2u7sf80kd4805zpvs3na0h', 90000)]
    ...
    async def test_rbf_batching__merge_duplicate_outputs(self):
        ...
        wallet = self.create_standard_wallet_from_seed('response era cable net spike again observe dumb wage wonder sail tortoise', config=self.config)
        wallet.config.WALLET_BATCH_RBF = True
        ...
        outputs1 = [PartialTxOutput.from_address_and_value(dest_addr, 200000)]
        coins = wallet.get_spendable_coins(domain=None)
        ...
        self.assertEqual((0, 298000, 0), wallet.get_balance())
        wallet.config.WALLET_MERGE_DUPLICATE_OUTPUTS = True
        outputs2 = [PartialTxOutput.from_address_and_value(dest_addr, 100000)]
        coins = wallet.get_spendable_coins(domain=None)
        ...
        self.assertEqual((0, 197000, 0), wallet.get_balance())
        wallet.adb.receive_tx_callback(tx1, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 298000, 0), wallet.get_balance())
    ...
    async def test_coinjoin_between_two_p2wpkh_electrum_seeds(self, mock_save_db):
        wallet1 = WalletIntegrityHelper.create_standard_wallet(keystore.from_seed('humor argue expand gain goat shiver remove morning security casual leopard degree', ''), gap_limit=2, config=self.config)
        wallet2 = WalletIntegrityHelper.create_standard_wallet(keystore.from_seed('couple fade lift useless text thank badge act august roof drastic violin', ''), gap_limit=2, config=self.config)
        ...
        outputs = [PartialTxOutput.from_address_and_value('tb1qhye4wfp26kn0l7ynpn5a4hvt539xc3zf0n76t3', 10000000)]
        ...
        outputs = [PartialTxOutput.from_address_and_value('tb1qufnj5k2rrsnpjq7fg6d2pq3q9um6skdyyehw5m', 10000000)]
        ...
        tx = tx_from_any(tx2.serialize_as_bytes().hex())
        self.assertTrue(tx.is_complete())
        self.assertTrue(tx.is_segwit())
    ...
    async def test_standard_wallet_cannot_sign_multisig_input_even_if_cosigner(self, mock_save_db):
        ...
        (see issue #5948)
        """
        wallet_2of2 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xpub('Vpub5gqF73Wpbp9ThwEgZKHLjBDthsatXjajYvrN8CVnkdBYeTR1M1sfZFQqQ5wpKHGhnwKhzgMhaWrtgKG2LthCzxjd653KqKVUAw7UrwYnbKQ'), keystore.from_xpub('Vpub5gSKXzxK7FeKNi2WPNW9iuA48SbJRZvKFBwtgucpegMWPdohQPeK2DoR6XFtC7BBLsHhfWDAPKaiecqJ7jTzYSfeg5YATowmPcgCWxARabT')], '2of2', gap_limit=2, config=self.config)
        ...
        outputs = [PartialTxOutput.from_address_and_value('tb1qfrlx5pza9vmez6vpx7swt8yp0nmgz3qa7jjkuf', 100000)]
    ...
    async def test_dscancel(self, mock_save_db):
        ...
        for simulate_moving_txs in (False, True):
            with self.subTest(msg='_dscancel_when_all_outputs_are_ismine', simulate_moving_txs=simulate_moving_txs):
                await self._dscancel_when_all_outputs_are_ismine(simulate_moving_txs=simulate_moving_txs, config=config)
            with self.subTest(msg='_dscancel_p2wpkh_when_there_is_a_change_address', simulate_moving_txs=simulate_moving_txs):
                await self._dscancel_p2wpkh_when_there_is_a_change_address(simulate_moving_txs=simulate_moving_txs, config=config)
            with self.subTest(msg='_dscancel_when_user_sends_max', simulate_moving_txs=simulate_moving_txs):
                await self._dscancel_when_user_sends_max(simulate_moving_txs=simulate_moving_txs, config=config)
            with self.subTest(msg='_dscancel_when_not_all_inputs_are_ismine', simulate_moving_txs=simulate_moving_txs):
                await self._dscancel_when_not_all_inputs_are_ismine(simulate_moving_txs=simulate_moving_txs, config=config)
    ...
    async def test_wallet_history_chain_of_unsigned_transactions(self, mock_save_db):
        wallet = self.create_standard_wallet_from_seed('cross end slow expose giraffe fuel track awake turtle capital ranch pulp', config=self.config, gap_limit=3)
        ...
        self.assertEqual('bf08206effded4126a95fbed375cedc0452b5e16a5d2025ac645dfae81addbe4:0', coins[0].prevout.to_str())
    ...
    async def test_imported_wallet_usechange_off(self, mock_save_db):
        wallet = restore_wallet_from_text('p2wpkh:cVcwSp488C8Riguq55Tuktgi6TpzuyLdDwUxkBDBz3yzV7FW4af2 p2wpkh:cPWyoPvnv2hiyyxbhMkhX3gPEENzB6DqoP9bbR8SDTg5njK5SL9n', path='if_this_exists_mocking_failed_648151893', config=self.config)['wallet']
    ...
    async def test_get_spendable_coins(self, mock_save_db):
        wallet = self.create_standard_wallet_from_seed('frost repair depend effort salon ring foam oak cancel receive save usage', config=self.config)
        funding_tx1 = Transaction('')
        funding_txid1 = funding_tx1.txid()
        self.assertEqual('52e669a20a26c8b3df5b41e5e6309b18bcde8e1ad7ea17a18f63b6dc6c8becc0', funding_txid1)
        wallet.adb.receive_tx_callback(funding_tx1, TX_HEIGHT_UNCONFIRMED)
        ...
        self.assertEqual('c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a', funding_txid2)
        wallet.adb.receive_tx_callback(funding_tx2, TX_HEIGHT_UNCONFIRMED)
        self.assertEqual((0, 15000000, 0), wallet.get_balance())
        self.assertEqual({'c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a:1', '52e669a20a26c8b3df5b41e5e6309b18bcde8e1ad7ea17a18f63b6dc6c8becc0:1'}, {txi.prevout.to_str() for txi in wallet.get_spendable_coins()})
        self.assertEqual({'52e669a20a26c8b3df5b41e5e6309b18bcde8e1ad7ea17a18f63b6dc6c8becc0:1'}, {txi.prevout.to_str() for txi in wallet.get_spendable_coins(['tb1q6n99dl96mx8mfh90m3tn5awk5mllkzdh25dw7z'])})
        wallet.set_frozen_state_of_addresses(['tb1q6n99dl96mx8mfh90m3tn5awk5mllkzdh25dw7z'], freeze=True)
        self.assertEqual({'c36a6e1cd54df108e69574f70bc9b88dc13beddc70cfad9feb7f8f6593255d4a:1'}, {txi.prevout.to_str() for txi in wallet.get_spendable_coins()})
    ...
    async def test_export_psbt_with_xpubs__multisig(self, mock_save_db):
        ...
        """
        wallet = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xpub('Vpub5n73Y3mMpc5vXFt3EUzvWjLdTrsDw3X4ksZ7GxZHi8yrGc4zBEyd77VzKaC21A4FmGqDMKwcVKFpmLUSzFM6LG84HjMfcLcbvyM1oGj5LGd'), keystore.from_xpub('Vpub5gDjDJrhnjJRXQwyhugFGx8u9B88wQ2ZkDNPoTVtYzPvu2ykP75yVhVzqnJYukhiqZ8X5FpULWYEXTs3Ve3A1Zo2hgson1Q9qPzz8uxL63m')], '2of2', gap_limit=2, config=self.config)
        ...
        self.assertEqual({'022c4338968f87a09b0fefd0aaac36f1b983bab237565d521944c60fdc48275049': ('9559fbd1', 'm/9999h/0/0'), '03cf9a6ac058d36a6dc325b19715a2223c6416e1cef13bc047a99bded8c99463ca': ('015148ee', 'm/0/0')}, tx.inputs()[0].to_json()['bip32_paths'])
        ...
        self.assertEqual({'tpubD6NzVbkrYhZ4WW1saJM1hDjGz1rm5swdKwbhcsx9hW5VVXDdbnt6GbXEQVXQq97dYsvGVeMEw5Ge2Zx4QGBy6W5KXahih4aTRs5hLqgy9c9': ('015148ee', 'm'), 'tpubD9MoDeHnEQnU5EMgt9mc4yKU6SURbfq2ooMToY5GH95B8Li1CEsuo9dBKXM2sdjuDGq4KCXLuigss3y22fZULzVrfVuZDxEN55Sp6CcU9DK': ('9559fbd1', 'm/9999h')}, tx.to_json()['xpubs'])
        ...
        self.assertEqual({}, tx.to_json()['xpubs'])
        self.assertEqual({'022c4338968f87a09b0fefd0aaac36f1b983bab237565d521944c60fdc48275049': ('9559fbd1', 'm/9999h/0/0'), '03cf9a6ac058d36a6dc325b19715a2223c6416e1cef13bc047a99bded8c99463ca': ('30cf1be5', 'm/48h/1h/0h/2h/0/0')}, tx.inputs()[0].to_json()['bip32_paths'])
        ...
        await tx.prepare_for_export_for_hardware_device(wallet)
        self.assertEqual({'tpubDFF7YPCSGHZy55HkQj6HJkXCR8DWbKKXpTYBH38fSHf6VuoEzNmZQZdAoKEVy36S8zXkbGeV4XQU6vaRXGsQfgptFYPR4HSpAenqkY7J7Lg': ('30cf1be5', 'm/48h/1h/0h/2h'), 'tpubD9MoDeHnEQnU5EMgt9mc4yKU6SURbfq2ooMToY5GH95B8Li1CEsuo9dBKXM2sdjuDGq4KCXLuigss3y22fZULzVrfVuZDxEN55Sp6CcU9DK': ('9559fbd1', 'm/9999h')}, tx.to_json()['xpubs'])
    ...
    async def test_export_psbt_with_xpubs__singlesig(self, mock_save_db):
        ...
        self.assertEqual({}, tx.to_json()['xpubs'])
        self.assertEqual({'029e65093d22877cbfcc27cb754c58d144ec96635af1fcc63e5a7b90b23bb6acb8': ('30cf1be5', 'm/84h/1h/0h/0/0')}, tx.inputs()[0].to_json()['bip32_paths'])
    ...
    async def test_export_psbt__rm_witness_utxo_from_non_segwit_input(self, mock_save_db):
        ...
        """
        wallet1a = WalletIntegrityHelper.create_multisig_wallet([keystore.from_bip43_rootseed(keystore.bip39_to_seed('income sample useless art skate lucky fold field bargain course hope chest', ''), 'm/45h/0', xtype='standard'), keystore.from_xpub('tpubDC1y33c2iTcxCBFva3zxbQxUnbzBT1TPVrwLgwVHtqSnVRx2pbJsrHzNYmXnKEnrNqyKk9BERrpSatqVu4JHV4K4hepFQdqnMojA5NVKxcF')], '2of2', gap_limit=2, config=self.config)
        wallet1a.get_keystores()[1].add_key_origin(derivation_prefix='m/45h/0', root_fingerprint='25750cf7')
        wallet1b = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xpub('tpubDAKtPDG6fezcwhB7rNJ9NVEWwGokNzowW3AaMVYFTS4WKoBTNESS1NpntWYDq2uABVYM1xa5cVmu8LD2xKYipMRVLy1VjBQeVe6pixJeBgr'), keystore.from_xpub('tpubDC1y33c2iTcxCBFva3zxbQxUnbzBT1TPVrwLgwVHtqSnVRx2pbJsrHzNYmXnKEnrNqyKk9BERrpSatqVu4JHV4K4hepFQdqnMojA5NVKxcF')], '2of2', gap_limit=2, config=self.config)
        ...
        wallet1b_offline = WalletIntegrityHelper.create_multisig_wallet([keystore.from_bip43_rootseed(keystore.bip39_to_seed('wear wasp subject october amount essay maximum monkey excuse plastic ginger donor', ''), 'm/45h/0', xtype='standard'), keystore.from_xpub('tpubDAKtPDG6fezcwhB7rNJ9NVEWwGokNzowW3AaMVYFTS4WKoBTNESS1NpntWYDq2uABVYM1xa5cVmu8LD2xKYipMRVLy1VjBQeVe6pixJeBgr')], '2of2', gap_limit=2, config=self.config)
        ...
        outputs = [PartialTxOutput.from_address_and_value('tb1qgacvp0zvgtk3etggjayuezrc2mkql8veshv4xw', 200000)]
...
class TestWalletOfflineSigning(ElectrumTestCase):
    ...
    async def test_sending_offline_old_electrum_seed_online_mpk(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_seed('alone body father children lead goodbye phone twist exist grass kick join', '', False), gap_limit=4, config=self.config)
        wallet_online = WalletIntegrityHelper.create_standard_wallet(keystore.from_master_key('cd805ed20aec61c7a8b409c121c6ba60a9221f46d20edbc2be83ebd91460e97937cd7d782e77c1cb08364c6bc1c98bc040fdad53f22f29f7d3a85c8e51f9c875'), gap_limit=4, config=self.config)
    ...
    async def test_sending_offline_xprv_online_xpub_p2pkh(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('tprv8gfKwjuAaqtHgqxMh1tosAQ28XvBMkcY5NeFRA3pZMpz6MR4H4YZ3MJM4fvNPnRKeXR1Td2vQGgjorNXfo94WvT5CYDsPAqjHxSn436G1Eu'), gap_limit=4, config=self.config)
        wallet_online = WalletIntegrityHelper.create_standard_wallet(keystore.from_xpub('tpubDDMN69wQjDZxaJz9afZQGa48hZS7X5oSegF2hg67yddNvqfpuTN9DqvDEp7YyVf7AzXnqBqHdLhzTAStHvsoMDDb8WoJQzNrcHgDJHVYgQF'), gap_limit=4, config=self.config)
    ...
    async def test_sending_offline_xprv_online_xpub_p2wpkh_p2sh(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('uprv8zHHrMQMQ26utWwNJ5MK2SXpB9hbmy7pbPaneii69xT8cZTyFpxQFxkknGWKP8dxBTZhzy7yP6cCnLrRCQjzJDk3G61SjZpxhFQuB2NR8a5'), gap_limit=4, config=self.config)
        wallet_online = WalletIntegrityHelper.create_standard_wallet(keystore.from_xpub('upub5DGeFrwFEPfD711qQ6tKPaUYjBY6BRqfxcWPT77hiHz7VMo7oNGeom5EdXoKXEazePyoN3ueJMqHBfp3MwmsaD8k9dFHoa8KGeVXev7Pbg2'), gap_limit=4, config=self.config)
        funding_tx = Transaction('')
        funding_txid = funding_tx.txid()
        self.assertEqual('98574bc5f6e75769eb0c93d41453cc1dfbd15c14e63cc3c42f37cdbd08858762', funding_txid)
        wallet_online.adb.receive_tx_callback(funding_tx, TX_HEIGHT_UNCONFIRMED)
    ...
    async def test_sending_offline_xprv_online_xpub_p2wpkh(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('vprv9K9hbuA23Bidgj1KRSHUZMa59jJLeZBpXPVn4RP7sBLArNhZxJjw4AX7aQmVTErDt4YFC11ptMLjbwxgrsH8GLQ1cx77KggWeVPeDBjr9xM'), gap_limit=4, config=self.config)
        wallet_online = WalletIntegrityHelper.create_standard_wallet(keystore.from_xpub('vpub5Y941QgusZGvuD5nXTpUvVWohm8q41uftcRNronjRWs9jB2iVr4BbxqbRfAoQjWHgJtDCQEXChgfsPbEuBnidtkFztZSD3zDKTrtwXa2LCa'), gap_limit=4, config=self.config)
        funding_tx = Transaction('')
        funding_txid = funding_tx.txid()
        self.assertEqual('98574bc5f6e75769eb0c93d41453cc1dfbd15c14e63cc3c42f37cdbd08858762', funding_txid)
        wallet_online.adb.receive_tx_callback(funding_tx, TX_HEIGHT_UNCONFIRMED)
    ...
    async def test_offline_signing_beyond_gap_limit(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('vprv9K9hbuA23Bidgj1KRSHUZMa59jJLeZBpXPVn4RP7sBLArNhZxJjw4AX7aQmVTErDt4YFC11ptMLjbwxgrsH8GLQ1cx77KggWeVPeDBjr9xM'), gap_limit=1, config=self.config)
        wallet_online = WalletIntegrityHelper.create_standard_wallet(keystore.from_xpub('vpub5Y941QgusZGvuD5nXTpUvVWohm8q41uftcRNronjRWs9jB2iVr4BbxqbRfAoQjWHgJtDCQEXChgfsPbEuBnidtkFztZSD3zDKTrtwXa2LCa'), gap_limit=4, config=self.config)
        funding_tx = Transaction('')
        funding_txid = funding_tx.txid()
        self.assertEqual('98574bc5f6e75769eb0c93d41453cc1dfbd15c14e63cc3c42f37cdbd08858762', funding_txid)
    ...
    async def test_signing_where_offline_ks_does_not_have_keyorigin_but_psbt_contains_it(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('vprv9KXDgRXYp3WCozCS3bMehASe2cJhY28DihCZ3KuyiTTjngopkfRC9QkH1SUREyCvnV7TSD6EgEHTTYa5yod7ZveBhVReEU1uDgfVASFqLNw'), gap_limit=4, config=self.config)
    ...
    @mock.patch.object(wallet.Abstract_Wallet, 'save_db')
    async def test_sending_offline_wif_online_addr_p2pkh(self, mock_save_db):
        ...
        tx_copy = tx_from_any(partial_tx)
        self.assertTrue(wallet_online.is_mine(wallet_online.adb.get_txin_address(tx_copy.inputs()[0])))
        self.assertEqual(None, tx_copy.txid())
        self.assertEqual(tx.txid(), tx_copy.txid())
        tx = wallet_offline.sign_transaction(tx_copy, password=None)
        self.assertTrue(tx.is_complete())
        self.assertFalse(tx.is_segwit())
    ...
    async def test_sending_offline_wif_online_addr_p2wpkh_p2sh(self, mock_save_db):
        ...
        self.assertEqual(tx.txid(), tx_copy.txid())
        tx = wallet_offline.sign_transaction(tx_copy, password=None)
        self.assertEqual('sh(wpkh(03845818239fe468a9e7c7ae1a3d3653a8333f89ff316a771a3acf6854b4d8c6db))', tx.inputs()[0].script_descriptor.to_string_no_checksum())
        self.assertTrue(tx.is_complete())
        self.assertTrue(tx.is_segwit())
    ...
    @mock.patch.object(wallet.Abstract_Wallet, 'save_db')
    async def test_sending_offline_xprv_online_addr_p2pkh(self, mock_save_db):
        wallet_offline = WalletIntegrityHelper.create_standard_wallet(keystore.from_xprv('tprv8gfKwjuAaqtHgqxMh1tosAQ28XvBMkcY5NeFRA3pZMpz6MR4H4YZ3MJM4fvNPnRKeXR1Td2vQGgjorNXfo94WvT5CYDsPAqjHxSn436G1Eu'), gap_limit=4, config=self.config)
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
        wallet_online.import_address('mg2jk6S5WGDhUPA8mLSxDLWpUoQnX1zzoG')
        funding_tx = Transaction('')
        ...
        self.assertEqual(tx.txid(), tx_copy.txid())
        tx = wallet_offline.sign_transaction(tx_copy, password=None)
        self.assertEqual('pkh([233d2ae4]tpubDDMN69wQjDZxaJz9afZQGa48hZS7X5oSegF2hg67yddNvqfpuTN9DqvDEp7YyVf7AzXnqBqHdLhzTAStHvsoMDDb8WoJQzNrcHgDJHVYgQF/0/1)', tx.inputs()[0].script_descriptor.to_string_no_checksum())
        self.assertTrue(tx.is_complete())
        self.assertFalse(tx.is_segwit())
        self.assertEqual('e56da664631b8c666c6df38ec80c954c4ac3c4f56f040faf0070e4681e937fc4', tx.txid())
        self.assertEqual('e56da664631b8c666c6df38ec80c954c4ac3c4f56f040faf0070e4681e937fc4', tx.wtxid())
    ...
    async def test_sending_offline_hd_multisig_online_addr_p2sh(self, mock_save_db):
        wallet_offline1 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('blast uniform dragon fiscal ensure vast young utility dinosaur abandon rookie sure', '', True), keystore.from_xpub('tpubD6NzVbkrYhZ4YTPEgwk4zzr8wyo7pXGmbbVUnfYNtx6SgAMF5q3LN3Kch58P9hxGNsTmP7Dn49nnrmpE6upoRb1Xojg12FGLuLHkVpVtS44'), keystore.from_xpub('tpubD6NzVbkrYhZ4XJzYkhsCbDCcZRmDAKSD7bXi9mdCni7acVt45fxbTVZyU6jRGh29ULKTjoapkfFsSJvQHitcVKbQgzgkkYsAmaovcro7Mhf')], '2of3', gap_limit=2, config=self.config)
        wallet_offline2 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('cycle rocket west magnet parrot shuffle foot correct salt library feed song', '', True), keystore.from_xpub('tpubD6NzVbkrYhZ4YTPEgwk4zzr8wyo7pXGmbbVUnfYNtx6SgAMF5q3LN3Kch58P9hxGNsTmP7Dn49nnrmpE6upoRb1Xojg12FGLuLHkVpVtS44'), keystore.from_xpub('tpubD6NzVbkrYhZ4YARFMEZPckrqJkw59GZD1PXtQnw14ukvWDofR7Z1HMeSCxfYEZVvg4VdZ8zGok5VxHwdrLqew5cMdQntWc5mT7mh1CSgrnX')], '2of3', gap_limit=2, config=self.config)
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
    ...
    async def test_sending_offline_hd_multisig_online_addr_p2wsh_p2sh(self, mock_save_db):
        wallet_offline1 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xprv('Uprv9CvELvByqm8k2dpecJVjgLMX1z5DufEjY4fBC5YvdGF5WjGCa7GVJJ2fYni1tyuF7Hw83E6W2ZBjAhaFLZv2ri3rEsubkCd5avg4EHKoDBN'), keystore.from_xpub('Upub5Qb8ik4Cnu8g97KLXKgVXHqY6tH8emQvqtBncjSKsyfTZuorPtTZgX7ovKKZHuuVGBVd1MTTBkWez1XXt2weN1sWBz6SfgRPQYEkNgz81QF')], '2of2', gap_limit=2, config=self.config)
        wallet_offline2 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_xprv('Uprv9BbnKEXJxXaNvdEsRJ9VA9toYrSeFJh5UfGBpM2iKe8Uh7UhrM9K8ioL53s8gvCoGfirHHaqpABDAE7VUNw8LNU1DMJKVoWyeNKu9XcDC19'), keystore.from_xpub('Upub5RuakRisg8h3F7u7iL2k3UJFa1uiK7xauHamzTxYBbn4PXbM7eajr6M9Q2VCr6cVGhfhqWQqxnABvtSATuVM1xzxk4nA189jJwzaMn1QX7V')], '2of2', gap_limit=2, config=self.config)
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
    ...
    async def test_sending_offline_hd_multisig_online_addr_p2wsh(self, mock_save_db):
        wallet_offline1 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('bitter grass shiver impose acquire brush forget axis eager alone wine silver', '', True), keystore.from_xpub('Vpub5fcdcgEwTJmbmqAktuK8Kyq92fMf7sWkcP6oqAii2tG47dNbfkGEGUbfS9NuZaRywLkHE6EmUksrqo32ZL3ouLN1HTar6oRiHpDzKMAF1tf'), keystore.from_xpub('Vpub5fjkKyYnvSS4wBuakWTkNvZDaBM2vQ1MeXWq368VJHNr2eT8efqhpmZ6UUkb7s2dwCXv2Vuggjdhk4vZVyiAQTwUftvff73XcUGq2NQmWra')], '2of3', gap_limit=2, config=self.config)
        wallet_offline2 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('snow nest raise royal more walk demise rotate smooth spirit canyon gun', '', True), keystore.from_xpub('Vpub5fjkKyYnvSS4wBuakWTkNvZDaBM2vQ1MeXWq368VJHNr2eT8efqhpmZ6UUkb7s2dwCXv2Vuggjdhk4vZVyiAQTwUftvff73XcUGq2NQmWra'), keystore.from_xpub('Vpub5gSKXzxK7FeKQedu2q1z9oJWxqvX72AArW3HSWpEhc8othDH8xMDu28gr7gf17sp492BuJod8Tn7anjvJrKpETwqnQqX7CS8fcYyUtedEMk')], '2of3', gap_limit=2, config=self.config)
        wallet_online = WalletIntegrityHelper.create_imported_wallet(privkeys=False, config=self.config)
...
class TestWalletCreationChecks(ElectrumTestCase):
    ...
    async def test_heterogeneous_xpub_types_in_multisig(self, mock_save_db):
        ...
        with self.assertRaises(Exception) as ctx3:
            w1 = WalletIntegrityHelper.create_multisig_wallet([keystore.from_seed('cycle rocket west magnet parrot shuffle foot correct salt library feed song', '', True), keystore.from_seed('bitter grass shiver impose acquire brush forget axis eager alone wine silver', '', True)], '2of2', gap_limit=2, config=self.config)
...
class TestWalletHistory_EvilGapLimit(ElectrumTestCase):
    TESTNET = True
    transactions = {'511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4': '', 'fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f': '', '268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656': ''}
    ...
    async def test_restoring_wallet_txorder1(self, mock_save_db):
        ...
        w.adb.receive_history_callback('tb1qgh5c088he4d559wl0hw27hrdeg8p2z96pefn4q', [('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)], {})
        w.synchronize()
        w.adb.receive_history_callback('tb1qm0ejr6g964zt2jux5te7m9ds43n28hdsdz9ull', [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)], {})
        w.synchronize()
        w.adb.receive_history_callback('tb1qj4pnq958k89zcem3342lhcgyz0rnmhkzl6x0cl', [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917)], {})
        w.synchronize()
        w.adb.receive_history_callback('tb1q3pyjwpm8wxgvquak240mprfhaydmkawcsl25je', [('511a35e240f4c8855de4c548dad932d03611a37e94e9203fdb6fc79911fe1dd4', 1316912)], {})
        w.synchronize()
        w.adb.receive_history_callback('tb1qr0qjp99ygawul0eylxfqmt7alygye22mj33vej', [('fde0b68938709c4979827caa576e9455ded148537fdb798fd05680da64dc1b4f', 1316917), ('268fce617aaaa4847835c2212b984d7b7741fdab65de22813288341819bc5656', 1316917)], {})
        w.synchronize()
        self.assertEqual(9999788, sum(w.get_balance()))

class TestWalletHistory_DoubleSpend(ElectrumTestCase):
    TESTNET = True
    transactions = {'a3849040f82705151ba12a4389310b58a17b78025d81116a3338595bdefa1625': '', '0e2182ead6660790290371516cb0b80afa8baebd30dad42b5e58a24ceea17f1c': '', '2c9aa33d9c8ec649f9bfb84af027a5414b760be5231fe9eca4a95b9eb3f8a017': ''}
    ...
    async def test_restoring_wallet_without_manual_delete(self, mock_save_db):
        w = restore_wallet_from_text('small rapid pattern language comic denial donate extend tide fever burden barrel', path='if_this_exists_mocking_failed_648151893', gap_limit=5, config=self.config)['wallet']
        for txid in self.transactions:
            tx = Transaction(self.transactions[txid])
            w.adb.add_transaction(tx)
...
class TestImportedWallet(ElectrumTestCase):
    ...
    async def test_importing_and_deleting_addresses(self, mock_save_db):
        w = restore_wallet_from_text('tb1q7648a2pm2se425lvun0g3vlf4ahmflcthegz63', path='if_this_exists_mocking_failed_648151893', config=self.config)['wallet']
        ...
        self.assertEqual(2, len(w.db.transactions))
        self.assertEqual({'54de13f7ee4853dc1a281c0e7132efb95330f7ceebc1dbce76fdf34c28028f14', '314385a9f24457098de9fe5cb3893cc408b9f66085268457b82050c988c97908'}, set(w.db.transactions))
        self.assertEqual(0, sum(w.get_balance()))
