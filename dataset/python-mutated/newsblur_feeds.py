...
class Feeds(View):
    ...
    def get(self, request):
        ...
        data = {'feeds': feeds_count, 'subscriptions': subscriptions_count, 'profiles': MSocialProfile.objects._collection.count(), 'social_subscriptions': MSocialSubscription.objects._collection.count()}
        chart_name = 'feeds'
        chart_type = 'counter'
        formatted_data = {}
