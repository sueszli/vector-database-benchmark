...
from modelscope.models.cv.video_object_segmentation.inference_core import InferenceCore
...
@PIPELINES.register_module(Tasks.video_object_segmentation, module_name=Pipelines.video_object_segmentation)
