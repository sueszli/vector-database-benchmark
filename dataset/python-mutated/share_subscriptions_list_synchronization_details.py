...
def main():
    ...
    response = client.share_subscriptions.list_synchronization_details(resource_group_name='SampleResourceGroup', account_name='Account1', share_subscription_name='ShareSub1', share_subscription_synchronization={'synchronizationId': '7d0536a6-3fa5-43de-b152-3d07c4f6b2bb'})
