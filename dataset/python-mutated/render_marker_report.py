...
$ MARKER_REPORT_PATH='./target/marker-report.json'     CODEOWNERS_PATH=./CODEOWNERS     TEMPLATE_PATH=./.github/bot_templates/MARKER_REPORT_ISSUE.md.j2     OUTPUT_PATH=./target/MARKER_REPORT_ISSUE.md     GITHUB_REPO=localstack/localstack     COMMIT_SHA=e62e04509d0f950af3027c0f6df4e18c7385c630     python scripts/render_marker_report.py
"""
import dataclasses
import datetime
import json
