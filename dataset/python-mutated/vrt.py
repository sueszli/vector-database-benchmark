...
from ..utils import ExtractorError, clean_html, extract_attributes, float_or_none, get_element_by_class, get_element_html_by_class, int_or_none, join_nonempty, jwt_encode_hs256, make_archive_id, parse_age_limit, parse_iso8601, str_or_none, strip_or_none, traverse_obj, url_or_none, urlencode_postdata

class VRTBaseIE(GigyaBaseIE):
    _GEO_BYPASS = False
    _PLAYER_INFO = {'platform': 'desktop', 'app': {'type': 'browser', 'name': 'Chrome'}, 'device': 'undefined (undefined)', 'os': {'name': 'Windows', 'version': 'x86_64'}, 'player': {'name': 'VRT web player', 'version': '2.7.4-prod-2023-04-19T06:05:45'}}
...
class KetnetIE(VRTBaseIE):
    ...
    _TESTS = [{'url': 'https://www.ketnet.be/kijken/m/meisjes/6/meisjes-s6a5', 'info_dict': {'id': 'pbs-pub-39f8351c-a0a0-43e6-8394-205d597d6162$vid-5e306921-a9aa-4fa9-9f39-5b82c8f1028e', 'ext': 'mp4', 'title': 'Meisjes', 'episode': 'Reeks 6: Week 5', 'season': 'Reeks 6', 'series': 'Meisjes', 'timestamp': 1685251800, 'upload_date': '20230528'}, 'params': {'skip_download': 'm3u8'}}]
...
class DagelijkseKostIE(VRTBaseIE):
    ...
    _TESTS = [{'url': 'https://dagelijksekost.een.be/gerechten/hachis-parmentier-met-witloof', 'info_dict': {'id': 'md-ast-27a4d1ff-7d7b-425e-b84f-a4d227f592fa', 'ext': 'mp4', 'title': 'Hachis parmentier met witloof', 'description': 'md5:9960478392d87f63567b5b117688cdc5', 'display_id': 'hachis-parmentier-met-witloof'}, 'params': {'skip_download': 'm3u8'}}]
