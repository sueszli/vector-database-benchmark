...
__all__ = ['TranslationRotationScale3D', 'TranslationRotationScale3DArrayLike', 'TranslationRotationScale3DBatch', 'TranslationRotationScale3DLike', 'TranslationRotationScale3DType']

def _translation_rotation_scale3d__rotation__special_field_converter_override(x: datatypes.Rotation3DLike | None) -> datatypes.Rotation3D | None:
    if False:
        return 10
    if x is None:
        return None
...
def _translation_rotation_scale3d__scale__special_field_converter_override(x: datatypes.Scale3DLike | None) -> datatypes.Scale3D | None:
    if False:
        for i in range(10):
            print('nop')
    if x is None:
...
class TranslationRotationScale3D(TranslationRotationScale3DExt):
    ...
    translation: datatypes.Vec3D | None = field(default=None, converter=TranslationRotationScale3DExt.translation__field_converter_override)
    rotation: datatypes.Rotation3D | None = field(default=None, converter=_translation_rotation_scale3d__rotation__special_field_converter_override)
...
TranslationRotationScale3DArrayLike = Union[TranslationRotationScale3D, Sequence[TranslationRotationScale3DLike]]
