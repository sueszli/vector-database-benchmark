...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text("Hi! My name is Doctor Botter. I will hold a more complex conversation with you. Why don't you tell me something about yourself?", reply_markup=markup)
    return CHOOSING
...
async def received_information(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(f'Neat! Just so you know, this is what you already told me:{facts_to_str(user_data)}You can tell me more, or change your opinion on something.', reply_markup=markup)
    return CHOOSING
...
async def done(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if 'choice' in user_data:
        del user_data['choice']
    await update.message.reply_text(f'I learned these facts about you: {facts_to_str(user_data)}Until next time!', reply_markup=ReplyKeyboardRemove())
    user_data.clear()
