...
class LocationStateChangeEvent(NamedTuple('_LocationStateChangeEvent', [('event_type', LocationStateChangeEventType), ('location_name', str), ('message', str), ('server_id', Optional[str])])):
