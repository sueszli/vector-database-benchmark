...
@testing.parameterize(*testing.product({'output': [None, numpy.float64, 'f', float, 'empty'], 'order': [0, 1, 2, 3, 4, 5], 'mode': ['constant', 'nearest', 'mirror'] + scipy16_modes, 'cval': [1.0], 'prefilter': [True]}))
...
@testing.parameterize(*testing.product({'order': [0, 1, 2, 3, 4, 5], 'mode': ['constant', 'nearest', 'mirror'] + scipy16_modes}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'matrix_shape': [(2,), (2, 2), (2, 3), (3, 3)], 'offset': [0.3, [-1.3, 1.3]], 'output_shape': [None], 'output': [None, numpy.float64, 'empty'], 'order': [0, 1, 2, 3, 4, 5], 'mode': legacy_modes + scipy16_modes, 'cval': [1.0], 'prefilter': [False, True]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'output': [None, numpy.float32, 'empty'], 'output_shape': [None, 10], 'order': [0, 1], 'mode': ['constant', 'nearest'], 'shape': [(100, 100), (10, 20), (10, 10, 10), (10, 20, 30)], 'theta': [0, 90, 180, 270]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'angle': [-10, 1000], 'axes': [(1, 0)], 'reshape': [False, True], 'output': [None, numpy.float64, 'empty'], 'order': [0, 1], 'mode': legacy_modes, 'cval': [1.0], 'prefilter': [True]}) + testing.product({'angle': [-15], 'axes': [(1, 0)], 'reshape': [False], 'output': [None], 'order': [0, 1, 3], 'mode': legacy_modes + scipy16_modes, 'cval': [1.0], 'prefilter': [True]}))
@testing.with_requires('scipy')
class TestRotate:
    _multiprocess_can_split = True
...
@testing.parameterize({'axes': (-1, -2)}, {'axes': (0, 1)}, {'axes': (2, 0)}, {'axes': (-2, 2)})
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'shift': [0.1, -10, (5, -5)], 'output': [None, numpy.float64, 'empty'], 'order': [0, 1, 3], 'mode': legacy_modes + scipy16_modes, 'cval': [1.0], 'prefilter': [True]}) + testing.product({'shift': [0.1], 'output': [None, numpy.float64, 'empty'], 'order': [0, 1, 3], 'mode': ['constant'], 'cval': [cupy.nan, cupy.inf, -cupy.inf], 'prefilter': [True]}))
@testing.with_requires('scipy')
class TestShift:
    _multiprocess_can_split = True
...
@testing.parameterize(*testing.product({'output': [None, numpy.float64, numpy.int32, 'empty'], 'order': [0, 1], 'mode': ['constant', 'nearest'], 'cval': [cupy.nan, cupy.inf, -cupy.inf]}))
...
@testing.parameterize(*testing.product({'zoom': [0.1, 10, (0.1, 10)], 'output': [None, numpy.float64, 'empty'], 'order': [0, 1], 'mode': legacy_modes, 'cval': [1.0], 'prefilter': [True]}))
@testing.with_requires('scipy')
class TestZoom:
    _multiprocess_can_split = True
...
@testing.parameterize(*testing.product({'shape': [(2, 3), (4, 4)], 'zoom': [(1, 1), (3, 5), (8, 2), (8, 8)], 'mode': ['nearest', 'reflect', 'mirror', 'grid-wrap', 'grid-constant']}))
...
@testing.parameterize(*testing.product({'shape': [(5, 5, 2)], 'zoom': [(2, 2, 0.5)], 'mode': legacy_modes + scipy16_modes, 'order': [0, 1, 2, 3, 4, 5], 'grid_mode': [False, True]}))
...
@testing.parameterize({'zoom': 3}, {'zoom': 0.3})
@testing.with_requires('opencv-python')
...
@testing.parameterize(*testing.product({'mode': ['mirror', 'grid-wrap', 'reflect'], 'order': [0, 1, 2, 3, 4, 5], 'dtype': [numpy.uint8, numpy.float64], 'output': [numpy.float64, numpy.float32], 'axis': [0, 1, 2, -1]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'mode': ['mirror', 'grid-wrap', 'reflect'], 'order': [0, 1, 2, 3, 4, 5], 'dtype': [numpy.uint8, numpy.float64], 'output': [numpy.float64, numpy.float32]}))
@testing.with_requires('scipy')
...
@testing.parameterize(*testing.product({'mode': ['mirror', 'wrap', 'reflect'], 'order': [2, 3, 4, 5], 'dtype': [numpy.complex64, numpy.complex128], 'output': [numpy.complex64, numpy.complex128]}))
@testing.with_requires('scipy')
