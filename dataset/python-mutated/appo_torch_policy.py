...
from ray.rllib.algorithms.impala.impala_torch_policy import make_time_major, VTraceOptimizer
from ray.rllib.evaluation.episode import Episode
from ray.rllib.evaluation.postprocessing import compute_bootstrap_value, compute_gae_for_sample_batch, Postprocessing
...
from ray.rllib.policy.torch_mixins import EntropyCoeffSchedule, LearningRateSchedule, KLCoeffMixin, ValueNetworkMixin, TargetNetworkMixin
...
class APPOTorchPolicy(VTraceOptimizer, LearningRateSchedule, EntropyCoeffSchedule, KLCoeffMixin, ValueNetworkMixin, TargetNetworkMixin, TorchPolicyV2):
