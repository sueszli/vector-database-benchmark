...
try:
    ...
    msg = 'import eigen_tensor_avoid_stl_array FAILED, while import pybind11_tests.eigen_tensor succeeded. Please ensure that test_eigen_tensor.cpp & eigen_tensor_avoid_stl_array.cpp are built together (or both are not built if Eigen is not available).'
