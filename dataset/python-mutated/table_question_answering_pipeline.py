...
from modelscope.preprocessors.nlp.space_T_cn.fields.struct import Constant, SQLQuery
from modelscope.utils.constant import ModelFile, Tasks
from modelscope.utils.logger import get_logger
logger = get_logger()
__all__ = ['TableQuestionAnsweringPipeline']

@PIPELINES.register_module(Tasks.table_question_answering, module_name=Pipelines.table_question_answering_pipeline)
