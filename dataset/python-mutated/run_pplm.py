...
PPLM_BOW_DISCRIM = 3
SMALL_CONST = 1e-15
BIG_CONST = 10000000000.0
BAG_OF_WORDS_ARCHIVE_MAP = {'legal': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/legal.txt', 'military': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/military.txt', 'politics': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/politics.txt', 'religion': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/religion.txt', 'science': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/science.txt', 'space': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/space.txt', 'technology': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/bow/technology.txt'}
DISCRIMINATOR_MODELS_PARAMS = {'clickbait': {'url': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/discriminators/clickbait_classifier_head.pt', 'class_size': 2, 'embed_size': 1024, 'class_vocab': {'non_clickbait': 0, 'clickbait': 1}, 'default_class': 1, 'pretrained_model': 'gpt2-medium'}, 'sentiment': {'url': 'https://s3.amazonaws.com/models.huggingface.co/bert/pplm/discriminators/SST_classifier_head.pt', 'class_size': 5, 'embed_size': 1024, 'class_vocab': {'very_positive': 2, 'very_negative': 3}, 'default_class': 3, 'pretrained_model': 'gpt2-medium'}}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_model', '-M', type=str, default='gpt2-medium', help='pretrained model name or path to local checkpoint')
    ...
    parser.add_argument('--bag_of_words', '-B', type=str, default=None, help='Bags of words used for PPLM-BoW. Either a BOW id (see list in code) or a filepath. Multiple BoWs separated by ;')
    parser.add_argument('--discrim', '-D', type=str, default=None, choices=('clickbait', 'sentiment', 'toxicity', 'generic'), help='Discriminator to use')
