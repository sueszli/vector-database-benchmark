...
class TestXdna(unittest.TestCase):
    sample_data = {'sample-a': {'file': 'Xdna/sample-a.xdna', 'name': 'Sample', 'id': 'Sample', 'description': 'Sample sequence A', 'length': 1000, 'molecule_type': 'DNA', 'topology': 'linear', 'features': [{'type': 'promoter', 'start': 49, 'end': 150, 'strand': 1, 'label': 'FeatureA'}, {'type': 'misc_binding', 'start': 499, 'end': 700, 'strand': -1, 'label': 'FeatureB'}]}, 'sample-b': {'file': 'Xdna/sample-b.xdna', 'name': 'Sample', 'id': 'Sample', 'description': 'Sample sequence B', 'length': 1000, 'molecule_type': 'DNA', 'topology': 'circular', 'features': [{'type': 'rep_origin', 'start': 160, 'end': 241, 'strand': 1, 'label': 'FeatureA'}, {'type': 'terminator', 'start': 399, 'end': 750, 'strand': -1, 'label': 'FeatureB'}]}, 'sample-c': {'file': 'Xdna/sample-c.xprt', 'name': 'Sample', 'id': 'Sample', 'description': 'Sample Sequence C', 'length': 1000, 'molecule_type': 'protein', 'topology': 'linear', 'features': [{'type': 'misc_feature', 'start': 10, 'end': 11, 'strand': 1, 'label': 'S11'}, {'type': 'misc_binding', 'start': 164, 'end': 195, 'strand': 1, 'label': 'RIP1'}]}}
