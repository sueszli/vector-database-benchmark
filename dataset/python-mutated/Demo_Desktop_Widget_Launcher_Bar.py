...
launcher_buttons = {sg.SYMBOL_DOWN_ARROWHEAD: None, 'PSG Main': sg.main, 'Word': 'C:\\Program Files\\Microsoft Office\\root\\Office16\\WINWORD.EXE', excel_icon: 'C:\\Program Files\\Microsoft Office\\root\\Office16\\excel.EXE', 'Notepad++': 'C:\\Program Files\\NotePad++\\notepad++.exe', sg.EMOJI_BASE64_HAPPY_IDEA: sg.main_sdk_help, 'All Elements': 'C:\\Python\\PycharmProjects\\PSG\\DemoPrograms\\Demo_All_Elements.py', 'Exit': None}
