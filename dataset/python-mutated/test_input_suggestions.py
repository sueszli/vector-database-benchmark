...
@pytest.mark.parametrize(('suggestion', 'truncate_at'), [('.......', 3), ('hey there', 3), ('Olá, tudo bem?', 3), ('áàóãõñç', 2), (string.punctuation, 3), (string.punctuation[::-1], 5), (string.punctuation[::3], 5)])
