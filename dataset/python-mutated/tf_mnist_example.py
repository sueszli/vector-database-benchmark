...
if __name__ == '__main__':
    ...
    tuner = tune.Tuner(MNISTTrainable, tune_config=tune.TuneConfig(metric='test_loss', mode='min'), run_config=train.RunConfig(stop={'training_iteration': 5 if args.smoke_test else 50}, verbose=1), param_space={'hiddens': tune.grid_search([32, 64, 128])})
    results = tuner.fit()
