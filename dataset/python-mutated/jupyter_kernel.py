...
class XonshKernel:
    ...
    language_info = {'name': 'xonsh', 'version': version, 'pygments_lexer': 'xonsh', 'codemirror_mode': 'shell', 'mimetype': 'text/x-sh', 'file_extension': '.xsh'}
...
if __name__ == '__main__':
    setup(shell_type='jupyter', env={'PAGER': 'cat'}, aliases={'less': 'cat'}, xontribs=['coreutils'], threadable_predictors={'git': predict_true, 'man': predict_true})
