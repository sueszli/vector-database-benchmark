...
DATA = {'wrangledDataset': {'id': DATAPREP_JOB_RECIPE_ID}, 'overrides': {'execution': 'dataflow', 'profiler': False, 'writesettings': [{'path': PATH_TO_OUTOUT_FILE, 'action': 'create', 'format': 'csv', 'compression': 'none', 'header': False, 'asSingleFile': False}]}}
