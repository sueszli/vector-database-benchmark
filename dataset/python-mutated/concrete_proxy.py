...
from .utils import _orig_tuple, _orig_list, _orig_type, _orig_isinstance, _orig_getattr, _orig_range, _orig_dict, _orig_len, _orig_index, _orig_bool, _orig_slice, _orig_set, map_recursive
...
class ConcreteProxy(Proxy):
    ...
    """
    jump_opnames = ('JUMP_IF_FALSE_OR_POP', 'JUMP_IF_TRUE_OR_POP', 'POP_JUMP_IF_FALSE', 'POP_JUMP_IF_TRUE', 'JUMP_IF_NOT_EXC_MATCH')
    ...
    op_dict_merge = dis.opmap.get('DICT_MERGE', None)
