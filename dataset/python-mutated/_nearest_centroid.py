...
class NearestCentroid(ClassifierMixin, BaseEstimator):
    ...
    _parameter_constraints: dict = {'metric': [StrOptions(_valid_metrics, deprecated=_valid_metrics - {'manhattan', 'euclidean'}), callable], 'shrink_threshold': [Interval(Real, 0, None, closed='neither'), None]}
