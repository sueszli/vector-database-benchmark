...
from sslyze.mozilla_tls_profile.mozilla_config_checker import MozillaTlsConfigurationEnum, SCAN_COMMANDS_NEEDED_BY_MOZILLA_CHECKER
...
_STARTTLS_PROTOCOL_DICT = {'smtp': ProtocolWithOpportunisticTlsEnum.SMTP, 'xmpp': ProtocolWithOpportunisticTlsEnum.XMPP, 'xmpp_server': ProtocolWithOpportunisticTlsEnum.XMPP_SERVER, 'pop3': ProtocolWithOpportunisticTlsEnum.POP3, 'imap': ProtocolWithOpportunisticTlsEnum.IMAP, 'ftp': ProtocolWithOpportunisticTlsEnum.FTP, 'ldap': ProtocolWithOpportunisticTlsEnum.LDAP, 'rdp': ProtocolWithOpportunisticTlsEnum.RDP, 'postgres': ProtocolWithOpportunisticTlsEnum.POSTGRES}
