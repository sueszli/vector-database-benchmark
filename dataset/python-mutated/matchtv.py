...
class MatchTVIE(InfoExtractor):
    ...
    _TESTS = [{'url': 'http://matchtv.ru/#live-player', 'info_dict': {'id': 'matchtv-live', 'ext': 'flv', 'title': 're:^Матч ТВ - Прямой эфир \\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}$', 'is_live': True}, 'params': {'skip_download': True}}, {'url': 'http://matchtv.ru/on-air/', 'only_matching': True}]
