...
if __name__ == '__main__':
    ...
    parser.add_argument('--main_data', type=str, required=True, help='Path to root data directory')
    parser.add_argument('--resolution', type=str, required=True, choices=['4K', '1080p', '720p', '540p'])
    parser.add_argument('--format', type=str, choices=['png', 'jpg'])
    parser.add_argument('-q', type=str, help='quality to use for compression [2-31] for jpg and [0-9] for png')
    parser.add_argument('--transcoded', action='store_true', help='Use transcoded videos instead of original split video')
    parser.add_argument('--quiet', action='store_true', help='Suppress ffmpeg output')
    parser.add_argument('--codec', type=str, default=None, choices=['h264', 'hevc'], help='codec of transcoded video to use')
    parser.add_argument('--crf', type=str, default=None, help='crf value of transcoded video to use')
    parser.add_argument('--keyint', type=str, default=None, help='keyframe interval of transcoded video to use')
