...
class CuriosityStreamIE(CuriosityStreamBaseIE):
    ...
    _TESTS = [{'url': 'http://app.curiositystream.com/video/2', 'info_dict': {'id': '2', 'ext': 'mp4', 'title': 'How Did You Develop The Internet?', 'description': "Vint Cerf, Google's Chief Internet Evangelist, describes how he and Bob Kahn created the internet.", 'channel': 'Curiosity Stream', 'categories': ['Technology', 'Interview'], 'average_rating': float, 'series_id': '2', 'thumbnail': 're:https://img.curiositystream.com/.+\\.jpg', 'tags': [], 'duration': 158}, 'params': {'skip_download': True}}]
...
class CuriosityStreamCollectionsIE(CuriosityStreamCollectionBaseIE):
    ...
    _TESTS = [{'url': 'https://curiositystream.com/collections/86', 'info_dict': {'id': '86', 'title': 'Staff Picks', 'description': 'Wondering where to start? Here are a few of our favorite series and films... from our couch to yours.'}, 'playlist_mincount': 7}, {'url': 'https://curiositystream.com/collections/36', 'only_matching': True}]
...
class CuriosityStreamSeriesIE(CuriosityStreamCollectionBaseIE):
    ...
    _TESTS = [{'url': 'https://curiositystream.com/series/2', 'info_dict': {'id': '2', 'title': 'Curious Minds: The Internet', 'description': 'How is the internet shaping our lives in the 21st Century?'}, 'playlist_mincount': 16}, {'url': 'https://curiositystream.com/collection/2', 'only_matching': True}]