...
import proto
__protobuf__ = proto.module(package='google.cloud.resourcemanager.v3', manifest={'TagBinding', 'CreateTagBindingMetadata', 'CreateTagBindingRequest', 'DeleteTagBindingMetadata', 'DeleteTagBindingRequest', 'ListTagBindingsRequest', 'ListTagBindingsResponse', 'ListEffectiveTagsRequest', 'ListEffectiveTagsResponse', 'EffectiveTag'})
...
class TagBinding(proto.Message):
    ...
    tag_value: str = proto.Field(proto.STRING, number=3)
    tag_value_namespaced_name: str = proto.Field(proto.STRING, number=4)
...
class CreateTagBindingRequest(proto.Message):
    ...
    """
    tag_binding: 'TagBinding' = proto.Field(proto.MESSAGE, number=1, message='TagBinding')
...
class ListTagBindingsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            return 10
        return self
    tag_bindings: MutableSequence['TagBinding'] = proto.RepeatedField(proto.MESSAGE, number=1, message='TagBinding')
...
class ListEffectiveTagsResponse(proto.Message):
    ...
    def raw_page(self):
        if False:
            print('Hello World!')
        return self
    effective_tags: MutableSequence['EffectiveTag'] = proto.RepeatedField(proto.MESSAGE, number=1, message='EffectiveTag')
    next_page_token: str = proto.Field(proto.STRING, number=2)
...
class EffectiveTag(proto.Message):
    ...
    """
    tag_value: str = proto.Field(proto.STRING, number=1)
    namespaced_tag_value: str = proto.Field(proto.STRING, number=2)
    tag_key: str = proto.Field(proto.STRING, number=3)
    namespaced_tag_key: str = proto.Field(proto.STRING, number=4)
    tag_key_parent_name: str = proto.Field(proto.STRING, number=6)
    inherited: bool = proto.Field(proto.BOOL, number=5)
