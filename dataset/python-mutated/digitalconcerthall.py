...
class DigitalConcertHallIE(InfoExtractor):
    ...
    _TESTS = [{'note': 'Playlist with only one video', 'url': 'https://www.digitalconcerthall.com/en/concert/53201', 'info_dict': {'id': '53201-1', 'ext': 'mp4', 'composer': 'Kurt Weill', 'title': '[Magic Night]', 'thumbnail': 're:^https?://images.digitalconcerthall.com/cms/thumbnails.*\\.jpg$', 'upload_date': '20210624', 'timestamp': 1624548600, 'duration': 2798, 'album_artist': 'Members of the Berliner Philharmoniker / Simon Rössler'}, 'params': {'skip_download': 'm3u8'}}, {'note': 'Concert with several works and an interview', 'url': 'https://www.digitalconcerthall.com/en/concert/53785', 'info_dict': {'id': '53785', 'album_artist': 'Berliner Philharmoniker / Kirill Petrenko', 'title': 'Kirill Petrenko conducts Mendelssohn and Shostakovich'}, 'params': {'skip_download': 'm3u8'}, 'playlist_count': 3}, {'url': 'https://www.digitalconcerthall.com/en/film/388', 'info_dict': {'id': '388', 'ext': 'mp4', 'title': 'The Berliner Philharmoniker and Frank Peter Zimmermann', 'description': 'md5:cfe25a7044fa4be13743e5089b5b5eb2', 'thumbnail': 're:^https?://images.digitalconcerthall.com/cms/thumbnails.*\\.jpg$', 'upload_date': '20220714', 'timestamp': 1657785600, 'album_artist': 'Frank Peter Zimmermann / Benedikt von Bernstorff / Jakob von Bernstorff'}, 'params': {'skip_download': 'm3u8'}}]
