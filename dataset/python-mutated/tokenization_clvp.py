...
PRETRAINED_VOCAB_FILES_MAP = {'vocab_file': {'clvp_dev': 'https://huggingface.co/susnato/clvp_dev/blob/main/vocab.json'}, 'merges_file': {'clvp_dev': 'https://huggingface.co/susnato/clvp_dev/blob/main/merges.txt'}}
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {'clvp_dev': 1024}
