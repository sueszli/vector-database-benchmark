...
class FooResource(pulumi.ComponentResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: Optional[FooResourceArgs]=None, opts: Optional[pulumi.ResourceOptions]=None):
        if False:
            for i in range(10):
                print('nop')
    ...
    def _internal_init(__self__, resource_name: str, opts: Optional[pulumi.ResourceOptions]=None, foo: Optional[pulumi.Input['Resource']]=None, __props__=None):
        ...
        super(FooResource, __self__).__init__('foo::FooResource', resource_name, __props__, opts, remote=True)
