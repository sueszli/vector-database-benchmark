...
class PorticoDocumentationSpider(BaseDocumentationSpider):
    ...
    start_urls = ['http://localhost:9981/hello/', 'http://localhost:9981/history/', 'http://localhost:9981/plans/', 'http://localhost:9981/team/', 'http://localhost:9981/apps/', 'http://localhost:9981/integrations/', 'http://localhost:9981/policies/terms', 'http://localhost:9981/policies/privacy', 'http://localhost:9981/features/', 'http://localhost:9981/why-zulip/', 'http://localhost:9981/for/open-source/', 'http://localhost:9981/for/business/', 'http://localhost:9981/for/communities/', 'http://localhost:9981/for/research/', 'http://localhost:9981/security/']
    deny_domains: List[str] = []