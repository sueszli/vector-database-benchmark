...
from posthog.permissions import ProjectMembershipNecessaryPermissions, SharingTokenPermission, TeamMemberAccessPermission
from posthog.session_recordings.models.session_recording_event import SessionRecordingViewed
from posthog.session_recordings.queries.session_recording_list_from_replay_summary import SessionRecordingListFromReplaySummary, SessionIdEventsQuery
...
SNAPSHOT_SOURCE_REQUESTED = Counter('session_snapshots_requested_counter', 'When calling the API and providing a concrete snapshot type to load.', labelnames=['source'])
...
class SessionRecordingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'distinct_id', 'viewed', 'recording_duration', 'active_seconds', 'inactive_seconds', 'start_time', 'end_time', 'click_count', 'keypress_count', 'mouse_activity_count', 'console_log_count', 'console_warn_count', 'console_error_count', 'start_url', 'person', 'storage']
        read_only_fields = ['id', 'distinct_id', 'viewed', 'recording_duration', 'active_seconds', 'inactive_seconds', 'start_time', 'end_time', 'click_count', 'keypress_count', 'mouse_activity_count', 'console_log_count', 'console_warn_count', 'console_error_count', 'start_url', 'storage']
