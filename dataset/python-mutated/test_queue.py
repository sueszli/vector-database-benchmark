...
async def verify_fn(_task_id: TaskId, _subtask_id: SubtaskId) -> VerifyResult:
...
class TestVerify:
    ...
    async def test_re_queue(self):
        ...
        async def verify_awaiting(_task_id: TaskId, _subtask_id: SubtaskId) -> VerifyResult:
        ...
        self.queue._queue.put.assert_called_with(TASK_ID, SUBTASK_ID, priority=None)
