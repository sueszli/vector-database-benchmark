...
severities = {'error': LintSeverity.ERROR, 'warning': LintSeverity.WARNING}
...
def clang_search_dirs() -> List[str]:
    ...
    return search_paths
include_args = []
include_dir = ['/usr/lib/llvm-11/include/openmp', get_python_include_dir(), os.path.join(PYTORCH_ROOT, 'third_party/pybind11/include')] + clang_search_dirs()
