...
async def test_continuation_token(client, lro_poller, deserialization_callback):
    ...
    new_poller = AsyncLROPoller.from_continuation_token(continuation_token=token, polling_method=AsyncLROBasePolling(0), client=client._client, deserialization_callback=deserialization_callback)
