...
class LinearOperatorZerosTest(linear_operator_test_util.SquareLinearOperatorDerivedClassTest):
...
@test_util.run_all_in_graph_and_eager_modes
class LinearOperatorZerosNotSquareTest(linear_operator_test_util.NonSquareLinearOperatorDerivedClassTest):
