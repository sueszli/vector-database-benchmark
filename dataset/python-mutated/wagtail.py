...
class UpdateModulePaths(Command):
    ...
    REPLACEMENTS = [(re.compile('\\bwagtail\\.wagtailcore\\b'), 'wagtail'), (re.compile('\\bwagtail\\.wagtailadmin\\b'), 'wagtail.admin'), (re.compile('\\bwagtail\\.wagtaildocs\\b'), 'wagtail.documents'), (re.compile('\\bwagtail\\.wagtailembeds\\b'), 'wagtail.embeds'), (re.compile('\\bwagtail\\.wagtailimages\\b'), 'wagtail.images'), (re.compile('\\bwagtail\\.wagtailsearch\\b'), 'wagtail.search'), (re.compile('\\bwagtail\\.wagtailsites\\b'), 'wagtail.sites'), (re.compile('\\bwagtail\\.wagtailsnippets\\b'), 'wagtail.snippets'), (re.compile('\\bwagtail\\.wagtailusers\\b'), 'wagtail.users'), (re.compile('\\bwagtail\\.wagtailforms\\b'), 'wagtail.contrib.forms'), (re.compile('\\bwagtail\\.wagtailredirects\\b'), 'wagtail.contrib.redirects'), (re.compile('\\bwagtail\\.contrib\\.wagtailfrontendcache\\b'), 'wagtail.contrib.frontend_cache'), (re.compile('\\bwagtail\\.contrib\\.wagtailroutablepage\\b'), 'wagtail.contrib.routable_page'), (re.compile('\\bwagtail\\.contrib\\.wagtailsearchpromotions\\b'), 'wagtail.contrib.search_promotions'), (re.compile('\\bwagtail\\.contrib\\.wagtailsitemaps\\b'), 'wagtail.contrib.sitemaps'), (re.compile('\\bwagtail\\.contrib\\.wagtailstyleguide\\b'), 'wagtail.contrib.styleguide'), (re.compile('\\bwagtail\\.tests\\b'), 'wagtail.test'), (re.compile('\\bwagtail\\.core\\.utils\\b'), 'wagtail.coreutils'), (re.compile('\\bwagtail\\.core\\b'), 'wagtail'), (re.compile('\\bwagtail\\.admin\\.edit_handlers\\b'), 'wagtail.admin.panels'), (re.compile('\\bwagtail\\.contrib\\.forms\\.edit_handlers\\b'), 'wagtail.contrib.forms.panels')]
...
COMMANDS = {'start': CreateProject(), 'updatemodulepaths': UpdateModulePaths(), '--version': Version()}
