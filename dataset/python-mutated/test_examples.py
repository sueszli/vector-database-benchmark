...
collatz_file = str(Path(__file__).parent.parent.parent.joinpath('examples', 'wasm', 'collatz', 'collatz.wasm'))
if_check_file = str(Path(__file__).parent.parent.parent.joinpath('examples', 'wasm', 'if_check', 'if_check.wasm'))
