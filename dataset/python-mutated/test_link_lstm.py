...
@testing.parameterize(*testing.product_dict([{'in_size': 10, 'out_size': 10}, {'in_size': 10, 'out_size': 40}], [{'input_none': False}, {'input_none': True, 'input_omit': True}, {'input_none': True, 'input_omit': False}], [{'input_variable': False}, {'input_variable': True}]))
