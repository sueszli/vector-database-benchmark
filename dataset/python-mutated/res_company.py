...
class Company(models.Model):
    ...
    font = fields.Many2one('res.font', string='Font', default=lambda self: self._get_font(), domain=[('mode', 'in', ('Normal', 'Regular', 'all', 'Book'))], help='Set the font into the report header, it will be used as default font in the RML reports of the user company')
