...
if __name__ == '__main__':
    ...
    analyze_labels_file_parser = subparsers.add_parser('labels_file', help=analyze_labels_file.__doc__)
    analyze_labels_file_parser.add_argument('path')
    analyze_explicit_content_parser = subparsers.add_parser('explicit_content', help=analyze_explicit_content.__doc__)
    ...
    transcribe_speech_parser = subparsers.add_parser('transcribe', help=speech_transcription.__doc__)
    transcribe_speech_parser.add_argument('path')
    detect_text_parser = subparsers.add_parser('text_gcs', help=video_detect_text_gcs.__doc__)
    detect_text_parser.add_argument('path')
    detect_text_file_parser = subparsers.add_parser('text_file', help=video_detect_text.__doc__)
    detect_text_file_parser.add_argument('path')
    tack_objects_parser = subparsers.add_parser('objects_gcs', help=track_objects_gcs.__doc__)
    tack_objects_parser.add_argument('path')
    tack_objects_file_parser = subparsers.add_parser('objects_file', help=track_objects.__doc__)
