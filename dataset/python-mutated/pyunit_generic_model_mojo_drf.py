...
def mojo_model_test_regression():
    if False:
        return 10
    test(['Origin', 'Dest'], 'Distance', compare_output, 'Model Summary: ', 'ModelMetricsRegression: drf', 'ModelMetricsRegressionGeneric: generic')

def mojo_model_test_binomial():
    if False:
        print('Hello World!')
    test(['Origin', 'Dest'], 'IsDepDelayed', compare_output, 'Model Summary: ', 'ModelMetricsBinomial: drf', 'ModelMetricsBinomialGeneric: generic')

def mojo_model_test_multinomial():
    if False:
        for i in range(10):
            print('nop')
    test(['Origin', 'Distance'], 'Dest', compare_output, 'Model Summary: ', 'ModelMetricsMultinomial: drf', 'ModelMetricsMultinomialGeneric: generic')
