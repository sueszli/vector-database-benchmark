...
from xonsh.ansi_colors import ansi_color_style, ansi_color_style_names, ansi_partial_color_format
from xonsh.base_shell import BaseShell
from xonsh.built_ins import XSH
from xonsh.events import events
from xonsh.lazyasd import LazyObject, lazyobject
from xonsh.lazyimps import pyghooks, pygments, winutils
from xonsh.platform import ON_CYGWIN, ON_DARWIN, ON_MSYS, ON_POSIX, ON_WINDOWS, os_environ
from xonsh.prompt.base import multiline_prompt
from xonsh.tools import carriage_return, columnize, ends_with_colon_token, print_exception, to_bool
if tp.TYPE_CHECKING:
...
_RL_STATE_DONE = 16777216
_RL_STATE_ISEARCH = 128
...
DEDENT_TOKENS = LazyObject(lambda : frozenset(['raise', 'return', 'pass', 'break', 'continue']), globals(), 'DEDENT_TOKENS')
