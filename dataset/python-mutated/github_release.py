...
def table(version):
    ...
    out = ' '.join(table)
    return out
descriptions = OrderedDict([('source', 'The SymPy source installer.'), ('wheel', 'A wheel of the package.'), ('html', 'Html documentation. This is the same as\nthe <a href="https://docs.sympy.org/latest/index.html">online documentation</a>.'), ('pdf', 'Pdf version of the <a href="https://docs.sympy.org/latest/index.html"> html documentation</a>.')])
...
def release_files(version):
    ...
    return paths
tarball_name_types = {'source-orig', 'source-orig-notar', 'source', 'wheel', 'html', 'html-nozip', 'pdf-orig', 'pdf'}
