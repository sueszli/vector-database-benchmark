...
from snuba_sdk import Column, Direction, Entity, Function, Granularity, Limit, OrderBy, Query, Request
...
from sentry.utils.snuba import get_snuba_translators, infer_project_ids_from_related_models, nest_groups, raw_snql_query
...
OUTCOMES_CATEGORY_CONDITION = ['category', 'IN', DataCategory.error_categories()]
TOTAL_RECEIVED_OUTCOMES = [outcomes.Outcome.ACCEPTED, outcomes.Outcome.FILTERED, outcomes.Outcome.RATE_LIMITED]
...
class SnubaTSDB(BaseTSDB):
    ...
    """
    project_filter_model_query_settings = {model: SnubaModelQuerySettings(Dataset.Outcomes, 'project_id', 'quantity', [['reason', '=', reason], ['outcome', 'IN', TOTAL_RECEIVED_OUTCOMES], OUTCOMES_CATEGORY_CONDITION]) for (reason, model) in FILTER_STAT_KEYS_TO_VALUES.items()}
    outcomes_partial_query_settings = {TSDBModel.organization_total_received: SnubaModelQuerySettings(Dataset.Outcomes, 'org_id', 'quantity', [['outcome', 'IN', TOTAL_RECEIVED_OUTCOMES], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.organization_total_rejected: SnubaModelQuerySettings(Dataset.Outcomes, 'org_id', 'quantity', [['outcome', '=', outcomes.Outcome.RATE_LIMITED], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.organization_total_blacklisted: SnubaModelQuerySettings(Dataset.Outcomes, 'org_id', 'quantity', [['outcome', '=', outcomes.Outcome.FILTERED], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.project_total_received: SnubaModelQuerySettings(Dataset.Outcomes, 'project_id', 'quantity', [['outcome', 'IN', TOTAL_RECEIVED_OUTCOMES], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.project_total_rejected: SnubaModelQuerySettings(Dataset.Outcomes, 'project_id', 'quantity', [['outcome', '=', outcomes.Outcome.RATE_LIMITED], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.project_total_blacklisted: SnubaModelQuerySettings(Dataset.Outcomes, 'project_id', 'quantity', [['outcome', '=', outcomes.Outcome.FILTERED], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.key_total_received: SnubaModelQuerySettings(Dataset.Outcomes, 'key_id', 'quantity', [['outcome', 'IN', TOTAL_RECEIVED_OUTCOMES], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.key_total_rejected: SnubaModelQuerySettings(Dataset.Outcomes, 'key_id', 'quantity', [['outcome', '=', outcomes.Outcome.RATE_LIMITED], OUTCOMES_CATEGORY_CONDITION]), TSDBModel.key_total_blacklisted: SnubaModelQuerySettings(Dataset.Outcomes, 'key_id', 'quantity', [['outcome', '=', outcomes.Outcome.FILTERED], OUTCOMES_CATEGORY_CONDITION])}
    non_outcomes_snql_query_settings = {TSDBModel.project: SnubaModelQuerySettings(Dataset.Events, 'project_id', None, []), TSDBModel.group: SnubaModelQuerySettings(Dataset.Events, 'group_id', None, []), TSDBModel.release: SnubaModelQuerySettings(Dataset.Events, 'tags[sentry:release]', None, []), TSDBModel.users_affected_by_group: SnubaModelQuerySettings(Dataset.Events, 'group_id', 'tags[sentry:user]', []), TSDBModel.users_affected_by_project: SnubaModelQuerySettings(Dataset.Events, 'project_id', 'tags[sentry:user]', []), TSDBModel.frequent_environments_by_group: SnubaModelQuerySettings(Dataset.Events, 'group_id', 'environment', []), TSDBModel.frequent_releases_by_group: SnubaModelQuerySettings(Dataset.Events, 'group_id', 'tags[sentry:release]', []), TSDBModel.frequent_issues_by_project: SnubaModelQuerySettings(Dataset.Events, 'project_id', 'group_id', []), TSDBModel.group_generic: SnubaModelQuerySettings(Dataset.IssuePlatform, 'group_id', None, [], None), TSDBModel.users_affected_by_generic_group: SnubaModelQuerySettings(Dataset.IssuePlatform, 'group_id', 'tags[sentry:user]', [], None)}
    model_query_settings = dict(itertools.chain(project_filter_model_query_settings.items(), outcomes_partial_query_settings.items(), non_outcomes_snql_query_settings.items()))
